...
Sequence, $S$};
\node (instrSymEx)   [process, below of=instr, yshift=-2*\blockvdist, xshift=-\blockhdist] {Sym. Ex.\\\ISA semantics};
\node (irSymEx)   [process, below of=irseq, yshift=-0.5cm] {Sym. Ex.\\IR sema.};
...
\draw[->]     (irseq) -- (irSymEx);
\draw[->]     (instrSymEx) -- node {Summary\\$sum_{\ISA}$} (proofGen);
