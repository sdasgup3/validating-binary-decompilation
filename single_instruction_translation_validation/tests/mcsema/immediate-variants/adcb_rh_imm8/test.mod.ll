...
define %struct.Memory* @routine_adcb_rh_imm8(%struct.State* noalias dereferenceable(3376), i64, %struct.Memory* noalias) #19 {
block_530:
  ...
  %13 = add i64 %12, 3
  store i64 %13, i64* %PC
  %14 = call %struct.Memory* @_ZN12_GLOBAL__N_1L3ADCI3RnWIhE2RnIhE2InIhEEEP6MemoryS8_R5StateT_T0_T1_(%struct.Memory* %2, %struct.State* %0, i8* %AH, i64 %11, i64 10)
...
entry:
  ...
  %call = call %struct.Memory* @routine_adcb_rh_imm8(%struct.State* %state, i64 0, %struct.Memory* %mem)
  ret i32 0
}