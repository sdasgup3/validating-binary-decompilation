...
define i32 @sub_cmpq_r64_imm32(%struct.State*, i64, i64) {
block_4003e0:
  ...
  store i64 %11, i64* %PC
  %12 = sub i64 %9, 119
  %13 = icmp ult i64 %9, 119
  %14 = zext i1 %13 to i8
  %15 = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 2, i32 1
  store i8 %14, i8* %15, align 1
  %16 = trunc i64 %12 to i32
  %17 = and i32 %16, 255
  %18 = call i32 @my.ctpop.i32(i32 %17) #14
...
entry:
  ...
  %call = call i32 @sub_cmpq_r64_imm32(%struct.State* %state, i64 0, i64 0)
  ret i32 0
}