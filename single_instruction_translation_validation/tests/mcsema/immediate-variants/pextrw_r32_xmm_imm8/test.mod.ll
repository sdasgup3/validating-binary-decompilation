...
define i32 @sub_pextrw_r32_xmm_imm8(%struct.State*, i64, i64) {
block_4003e0:
  ...
  %14 = add i64 %13, 5
  store i64 %14, i64* %PC
  %15 = bitcast <2 x i64>* %3 to %struct.uint16v8_t*
  %16 = bitcast <2 x i64>* %3 to i8*
  call void @my.lifetime.start(i64 16, i8* nonnull %16) #14
  %17 = bitcast i8* %12 to <2 x i64>*
  %18 = load <2 x i64>, <2 x i64>* %17, align 1
  store <2 x i64> %18, <2 x i64>* %3, align 16
  %19 = getelementptr inbounds %struct.uint16v8_t, %struct.uint16v8_t* %15, i64 0, i32 0, i64 7
  %20 = load i16, i16* %19, align 2
  %21 = zext i16 %20 to i64
  store i64 %21, i64* %RBX, align 8
  call void @my.lifetime.end(i64 16, i8* nonnull %16) #14
  %22 = load i64, i64* %PC
  %23 = add i64 %22, 1
  store i64 %23, i64* %PC
...
entry:
  ...
  %call = call i32 @sub_pextrw_r32_xmm_imm8(%struct.State* %state, i64 0, i64 0)
  ret i32 0
}