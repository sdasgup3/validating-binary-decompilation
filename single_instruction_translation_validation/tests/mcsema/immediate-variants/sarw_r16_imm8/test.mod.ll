...
define internal %struct.Memory* @_ZN12_GLOBAL__N_1L3SARI3RnWItE2RnItE2InItEEEP6MemoryS8_R5StateT_T0_T1_(%struct.Memory* readnone, %struct.State* nocapture dereferenceable(3376), i16* nocapture, i64, i64) #0 {
...
; <label>:34:                                     ; preds = %30, %18, %10
  ...
  %43 = tail call i32 @my.ctpop.i32(i32 %42) #22
...
define %struct.Memory* @routine_sarw_r16_imm8(%struct.State* noalias dereferenceable(3376), i64, %struct.Memory* noalias) #19 {
block_530:
  ...
  %12 = add i64 %11, 4
  store i64 %12, i64* %PC
  %13 = call %struct.Memory* @_ZN12_GLOBAL__N_1L3SARI3RnWItE2RnItE2InItEEEP6MemoryS8_R5StateT_T0_T1_(%struct.Memory* %2, %struct.State* %0, i16* %BX, i64 %10, i64 10)
  %14 = load i64, i64* %PC
  %15 = add i64 %14, 1
  store i64 %15, i64* %PC
...
entry:
  ...
  %call = call %struct.Memory* @routine_sarw_r16_imm8(%struct.State* %state, i64 0, %struct.Memory* %mem)
  ret i32 0
}