...
define internal %struct.Memory* @_ZN12_GLOBAL__N_1L4SHLDI3RnWItE2RnItES4_2InItEEEP6MemoryS8_R5StateT_T0_T1_T2_(%struct.Memory* readnone, %struct.State* nocapture dereferenceable(3376), i16* nocapture, i64, i64, i64) #0 {
...
; <label>:20:                                     ; preds = %11
  ...
  %38 = tail call i32 @my.ctpop.i32(i32 %37) #22
...
define %struct.Memory* @routine_shldw_r16_r16_imm8(%struct.State* noalias dereferenceable(3376), i64, %struct.Memory* noalias) #19 {
block_530:
  ...
  %17 = add i64 %16, 5
  store i64 %17, i64* %PC
  %18 = call %struct.Memory* @_ZN12_GLOBAL__N_1L4SHLDI3RnWItE2RnItES4_2InItEEEP6MemoryS8_R5StateT_T0_T1_T2_(%struct.Memory* %2, %struct.State* %0, i16* %BX, i64 %13, i64 %15, i64 10)
...
entry:
  ...
  %call = call %struct.Memory* @routine_shldw_r16_r16_imm8(%struct.State* %state, i64 0, %struct.Memory* %mem)
  ret i32 0
}