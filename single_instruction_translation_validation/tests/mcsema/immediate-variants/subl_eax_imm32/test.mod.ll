...
define i32 @sub_subl_eax_imm32(%struct.State*, i64, i64) {
block_4003e0:
  ...
  %15 = icmp ult i32 %12, 119
  %16 = zext i1 %15 to i8
  %17 = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 2, i32 1
  store i8 %16, i8* %17, align 1
  %18 = and i32 %13, 255
  %19 = call i32 @my.ctpop.i32(i32 %18) #14
...
entry:
  ...
  %call = call i32 @sub_subl_eax_imm32(%struct.State* %state, i64 0, i64 0)
  ret i32 0
}
