...
define i32 @sub_vcmpps_ymm_ymm_ymm_imm8(%struct.State*, i64, i64) {
block_4003e0:
  ...
  %18 = add i64 %17, 5
  store i64 %18, i64* %PC
  %19 = bitcast %struct.float32v8_t* %3 to i8*
  ...
  %20 = bitcast %struct.float32v8_t* %4 to i8*
  ...
  %23 = call %struct.Memory* @__remill_error(%struct.State* nonnull dereferenceable(3376) %0, i64 %22, %struct.Memory* %2) #15
...
entry:
  ...
  %call = call i32 @sub_vcmpps_ymm_ymm_ymm_imm8(%struct.State* %state, i64 0, i64 0)
  ret i32 0
}