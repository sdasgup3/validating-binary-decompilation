...
define internal %struct.Memory* @_ZN12_GLOBAL__N_1L5CMPSDI3VnWI8vec256_tE2VnI8vec128_tES6_EEP6MemoryS8_R5StateT_T0_T1_2InIhE(%struct.Memory*, %struct.State* dereferenceable(3376), i8* nocapture, i8* nocapture readonly, i8* nocapture readonly, i64) #0 {
...
; <label>:80:                                     ; preds = %79, %78, %75, %73, %70, %68, %66, %64, %63, %61, %59, %57, %55, %53, %50, %47, %44, %42, %40, %38, %36, %35, %33, %31, %29, %26, %23, %20, %17, %17
  ...
  store <2 x i64> zeroinitializer, <2 x i64>* %84, align 1
  %85 = getelementptr inbounds i8, i8* %2, i64 24
  %86 = bitcast i8* %85 to i64*
  store i64 0, i64* %86, align 1
  br label %87

; <label>:87:                                     ; preds = %80, %13
  %88 = phi %struct.Memory* [ %16, %13 ], [ %0, %80 ]
  ret %struct.Memory* %88
}

define %struct.Memory* @routine_vcmpsd_xmm_xmm_xmm_imm8(%struct.State* noalias dereferenceable(3376), i64, %struct.Memory* noalias) #19 {
block_530:
  ...
  %16 = add i64 %15, 5
  store i64 %16, i64* %PC
  %17 = call %struct.Memory* @_ZN12_GLOBAL__N_1L5CMPSDI3VnWI8vec256_tE2VnI8vec128_tES6_EEP6MemoryS8_R5StateT_T0_T1_2InIhE(%struct.Memory* %2, %struct.State* %0, i8* %12, i8* %13, i8* %14, i64 10)
  %18 = load i64, i64* %PC
  %19 = add i64 %18, 1
  store i64 %19, i64* %PC
...
entry:
  ...
  %call = call %struct.Memory* @routine_vcmpsd_xmm_xmm_xmm_imm8(%struct.State* %state, i64 0, %struct.Memory* %mem)
  ret i32 0
}