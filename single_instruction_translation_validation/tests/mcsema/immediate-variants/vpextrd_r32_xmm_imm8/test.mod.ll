...
define i32 @sub_vpextrd_r32_xmm_imm8(%struct.State*, i64, i64) {
block_4003e0:
  ...
  %14 = add i64 %13, 6
  store i64 %14, i64* %PC
  %15 = bitcast <2 x i64>* %3 to %struct.int32v4_t*
  ...
  %19 = getelementptr inbounds %struct.int32v4_t, %struct.int32v4_t* %15, i64 0, i32 0, i64 3
...
entry:
  ...
  %call = call i32 @sub_vpextrd_r32_xmm_imm8(%struct.State* %state, i64 0, i64 0)
  ret i32 0
}