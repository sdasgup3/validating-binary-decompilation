...
define i32 @sub_vpsrldq_ymm_ymm_imm8(%struct.State*, i64, i64) {
block_4003e0:
  ...
  %16 = bitcast i8* %11 to <16 x i8>*
  store <16 x i8> zeroinitializer, <16 x i8>* %16, align 1
  %17 = getelementptr inbounds i8, i8* %11, i64 16
  %18 = bitcast i8* %17 to <16 x i8>*
  store <16 x i8> zeroinitializer, <16 x i8>* %18, align 1
...
entry:
  ...
  %call = call i32 @sub_vpsrldq_ymm_ymm_imm8(%struct.State* %state, i64 0, i64 0)
  ret i32 0
}