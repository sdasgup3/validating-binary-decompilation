...
define internal %struct.Memory* @_ZN12_GLOBAL__N_1L3ADCI3MnWItE2MnItE2InItEEEP6MemoryS8_R5StateT_T0_T1_(%struct.Memory*, %struct.State* nocapture dereferenceable(3376), i64, i64, i64) #0 {
...
define %struct.Memory* @routine_adcw_m16_imm16(%struct.State* noalias dereferenceable(3376), i64, %struct.Memory* noalias) #19 {
block_530:
  ...
  %14 = add i64 %13, 5
  store i64 %14, i64* %PC
  %15 = call %struct.Memory* @_ZN12_GLOBAL__N_1L3ADCI3MnWItE2MnItE2InItEEEP6MemoryS8_R5StateT_T0_T1_(%struct.Memory* %2, %struct.State* %0, i64 %10, i64 %12, i64 10)
...
entry:
  ...
  %call = call %struct.Memory* @routine_adcw_m16_imm16(%struct.State* %state, i64 0, %struct.Memory* %mem)
  ret i32 0
}