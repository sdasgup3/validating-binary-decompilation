...
define i32 @sub_addq_m64_r64(%struct.State*, i64, i64) {
block_4003e0:
  ...
  store i64 %21, i64* %22
  %23 = icmp ult i64 %21, %20
  %24 = icmp ult i64 %21, %16
  %25 = or i1 %23, %24
  %26 = zext i1 %25 to i8
  ...
  %29 = and i32 %28, 255
  %30 = call i32 @my.ctpop.i32(i32 %29) #14
...
entry:
  ...
  %call = call i32 @sub_addq_m64_r64(%struct.State* %state, i64 0, i64 0)
  ret i32 0
}