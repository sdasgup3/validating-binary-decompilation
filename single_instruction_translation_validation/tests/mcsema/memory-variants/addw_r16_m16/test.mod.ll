...
define i32 @sub_addw_r16_m16(%struct.State*, i64, i64) {
block_4003e0:
  ...
  %19 = load i16, i16* %18
  %20 = add i16 %19, %12
  store i16 %20, i16* %BX, align 2
  %21 = icmp ult i16 %20, %12
  %22 = icmp ult i16 %20, %19
  %23 = or i1 %21, %22
  %24 = zext i1 %23 to i8
...
entry:
  ...
  %call = call i32 @sub_addw_r16_m16(%struct.State* %state, i64 0, i64 0)
  ret i32 0
}