...
define i32 @sub_cmovnlew_r16_m16(%struct.State*, i64, i64) {
block_4003e0:
  ...
  %26 = xor i1 %25, true
  %27 = and i1 %18, %26
  %28 = inttoptr i64 %13 to i16*
  %29 = load i16, i16* %28
  %30 = load i16, i16* %BX, align 2
...
entry:
  ...
  %call = call i32 @sub_cmovnlew_r16_m16(%struct.State* %state, i64 0, i64 0)
  ret i32 0
}