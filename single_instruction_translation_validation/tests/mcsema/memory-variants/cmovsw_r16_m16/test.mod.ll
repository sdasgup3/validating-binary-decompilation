...
define i32 @sub_cmovsw_r16_m16(%struct.State*, i64, i64) {
block_4003e0:
  ...
  %18 = icmp ne i8 %17, 0
  %19 = inttoptr i64 %13 to i16*
  %20 = load i16, i16* %19
  %21 = load i16, i16* %BX, align 2
...
entry:
  ...
  %call = call i32 @sub_cmovsw_r16_m16(%struct.State* %state, i64 0, i64 0)
  ret i32 0
}