...
define i32 @sub_cmpxchgq_m64_r64(%struct.State*, i64, i64) {
block_4003e0:
  ...
  call void @my.lifetime.start(i64 8, i8* nonnull %21) #14
  %22 = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 1, i32 0, i32 0
  %23 = load i64, i64* %22, align 8
  store i64 %23, i64* %3, align 8
  %24 = call %struct.Memory* @__remill_compare_exchange_memory_64(%struct.Memory* %13, i64 %15, i64* nonnull dereferenceable(8) %3, i64 %18) #15
  ...
  call void @my.lifetime.end(i64 8, i8* nonnull %21) #14
  %57 = call %struct.Memory* @__remill_atomic_end(%struct.Memory* %24)
  %58 = load i64, i64* %PC
  %59 = add i64 %58, 1
  store i64 %59, i64* %PC
...
entry:
  ...
  %call = call i32 @sub_cmpxchgq_m64_r64(%struct.State* %state, i64 0, i64 0)
  ret i32 0
}