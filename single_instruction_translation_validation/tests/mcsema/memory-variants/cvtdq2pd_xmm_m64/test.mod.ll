...
define i32 @sub_cvtdq2pd_xmm_m64(%struct.State*, i64, i64) {
block_4003e0:
  ...
  store double %20, double* %22, align 1
  %23 = getelementptr inbounds i8, i8* %11, i64 8
  %24 = bitcast i8* %23 to double*
  store double %21, double* %24, align 1
  %25 = load i64, i64* %PC
  %26 = add i64 %25, 1
  store i64 %26, i64* %PC
...
entry:
  ...
  %call = call i32 @sub_cvtdq2pd_xmm_m64(%struct.State* %state, i64 0, i64 0)
  ret i32 0
}