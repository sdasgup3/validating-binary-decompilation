...
define i32 @sub_cvtsd2sil_r32_m64(%struct.State*, i64, i64) {
block_4003e0:
  ...
  %18 = call double @my.nearbyint.f64(double %17) #14
...
entry:
  ...
  %call = call i32 @sub_cvtsd2sil_r32_m64(%struct.State* %state, i64 0, i64 0)
  ret i32 0
}