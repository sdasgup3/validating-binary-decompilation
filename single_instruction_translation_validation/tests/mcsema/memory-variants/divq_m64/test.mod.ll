...
define i32 @sub_divq_m64(%struct.State*, i64, i64) {
block_4003e0:
...
_ZN12_GLOBAL__N_1L9DIVrdxraxI2MnImEEEP6MemoryS4_R5StateT_.exit: ; preds = %31, %27
...
entry:
  ...
  %call = call i32 @sub_divq_m64(%struct.State* %state, i64 0, i64 0)
  ret i32 0
}