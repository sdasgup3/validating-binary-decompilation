...
define i32 @sub_divw_m16(%struct.State*, i64, i64) {
block_4003e0:
...
; <label>:33:                                     ; preds = %block_4003e0
  ...
  store i16 %34, i16* %14, align 2
  store i16 %36, i16* %18, align 2
...
entry:
  ...
  %call = call i32 @sub_divw_m16(%struct.State* %state, i64 0, i64 0)
  ret i32 0
}