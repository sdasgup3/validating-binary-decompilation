...
define internal %struct.Memory* @_ZN12_GLOBAL__N_1L6IDIVaxI2MnIhEEEP6MemoryS4_R5StateT_(%struct.Memory*, %struct.State* dereferenceable(3376), i64) #0 {
...
define %struct.Memory* @routine_idivb_m8(%struct.State* noalias dereferenceable(3376), i64, %struct.Memory* noalias) #19 {
block_530:
  ...
  %12 = add i64 %11, 3
  store i64 %12, i64* %PC
  %13 = call %struct.Memory* @_ZN12_GLOBAL__N_1L6IDIVaxI2MnIhEEEP6MemoryS4_R5StateT_(%struct.Memory* %2, %struct.State* %0, i64 %10)
  %14 = load i64, i64* %PC
  %15 = add i64 %14, 1
  store i64 %15, i64* %PC
...
entry:
  ...
  %call = call %struct.Memory* @routine_idivb_m8(%struct.State* %state, i64 0, %struct.Memory* %mem)
  ret i32 0
}