...
define i32 @sub_idivl_m32(%struct.State*, i64, i64) {
block_4003e0:
...
_ZN12_GLOBAL__N_1L10IDIVedxeaxI2MnIjEEEP6MemoryS4_R5StateT_.exit: ; preds = %34, %30
...
entry:
  ...
  %call = call i32 @sub_idivl_m32(%struct.State* %state, i64 0, i64 0)
  ret i32 0
}