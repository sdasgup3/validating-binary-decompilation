...
define i32 @sub_imulb_m8(%struct.State*, i64, i64) {
block_4003e0:
  ...
  %18 = load i8, i8* %17
  %19 = sext i8 %16 to i16
  %20 = sext i8 %18 to i16
  %21 = mul  i16 %20, %19
  %22 = trunc i16 %21 to i8
  store i8 %22, i8* %15, align 1
  %23 = getelementptr inbounds %struct.anon.2, %struct.anon.2* %14, i64 0, i32 1
  %24 = lshr i16 %21, 8
  %25 = trunc i16 %24 to i8
  store i8 %25, i8* %23, align 1
  %26 = shl i16 %21, 8
  %27 = ashr exact i16 %26, 8
  %28 = icmp ne i16 %27, %21
  %29 = zext i1 %28 to i8
  %30 = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 2, i32 1
  store i8 %29, i8* %30, align 1
  %31 = and i16 %21, 255
  %32 = zext i16 %31 to i32
  %33 = call i32 @my.ctpop.i32(i32 %32) #14
...
entry:
  ...
  %call = call i32 @sub_imulb_m8(%struct.State* %state, i64 0, i64 0)
  ret i32 0
}