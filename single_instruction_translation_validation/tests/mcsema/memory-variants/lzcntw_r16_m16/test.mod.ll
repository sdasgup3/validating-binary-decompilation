...
define i32 @sub_lzcntw_r16_m16(%struct.State*, i64, i64) {
block_4003e0:
  ...
  %19 = call i32 @my.ctlz.i32(i32 %18, i1 true) #14
  %20 = add   i32 %19, 65520
...
entry:
  ...
  %call = call i32 @sub_lzcntw_r16_m16(%struct.State* %state, i64 0, i64 0)
  ret i32 0
}