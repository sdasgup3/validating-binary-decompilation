...
define i32 @sub_movlps_xmm_m64(%struct.State*, i64, i64) {
block_4003e0:
  ...
  store float %17, float* %23, align 1
  %24 = getelementptr inbounds i8, i8* %11, i64 4
  %25 = bitcast i8* %24 to float*
  store float %19, float* %25, align 1
...
entry:
  ...
  %call = call i32 @sub_movlps_xmm_m64(%struct.State* %state, i64 0, i64 0)
  ret i32 0
}