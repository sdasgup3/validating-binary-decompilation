...
define i32 @sub_paddusb_xmm_m128(%struct.State*, i64, i64) {
block_4003e0:
  %3 = alloca <2 x i64>, align 16
  %4 = alloca <2 x i64>, align 16
  %5 = alloca %struct.uint8v16_t, align 1
...
entry:
  ...
  %call = call i32 @sub_paddusb_xmm_m128(%struct.State* %state, i64 0, i64 0)
  ret i32 0
}