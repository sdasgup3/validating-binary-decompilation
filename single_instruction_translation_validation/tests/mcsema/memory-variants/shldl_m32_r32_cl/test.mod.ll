...
define internal %struct.Memory* @_ZN12_GLOBAL__N_1L4SHLDI3MnWIjE2MnIjE2RnIjES6_EEP6MemoryS8_R5StateT_T0_T1_T2_(%struct.Memory*, %struct.State* nocapture dereferenceable(3376), i64, i64, i64, i64) #0 {
...
; <label>:12:                                     ; preds = %6
  ...
  %29 = and i32 %21, 255
  %30 = tail call i32 @my.ctpop.i32(i32 %29) #22
...
define %struct.Memory* @routine_shldl_m32_r32_cl(%struct.State* noalias dereferenceable(3376), i64, %struct.Memory* noalias) #19 {
block_530:
  ...
  %25 = add i64 %24, 4
  store i64 %25, i64* %PC
  %26 = call %struct.Memory* @_ZN12_GLOBAL__N_1L4SHLDI3MnWIjE2MnIjE2RnIjES6_EEP6MemoryS8_R5StateT_T0_T1_T2_(%struct.Memory* %2, %struct.State* %0, i64 %17, i64 %19, i64 %21, i64 %23)
...
entry:
  ...
  %call = call %struct.Memory* @routine_shldl_m32_r32_cl(%struct.State* %state, i64 0, %struct.Memory* %mem)
  ret i32 0
}