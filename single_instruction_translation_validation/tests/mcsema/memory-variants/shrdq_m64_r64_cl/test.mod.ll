...
define internal %struct.Memory* @_ZN12_GLOBAL__N_1L4SHRDI3MnWImE2MnImE2RnImES6_EEP6MemoryS8_R5StateT_T0_T1_T2_(%struct.Memory*, %struct.State* nocapture dereferenceable(3376), i64, i64, i64, i64) #0 {
...
define %struct.Memory* @routine_shrdq_m64_r64_cl(%struct.State* noalias dereferenceable(3376), i64, %struct.Memory* noalias) #19 {
block_530:
  ...
  %24 = add i64 %23, 5
  store i64 %24, i64* %PC
  %25 = call %struct.Memory* @_ZN12_GLOBAL__N_1L4SHRDI3MnWImE2MnImE2RnImES6_EEP6MemoryS8_R5StateT_T0_T1_T2_(%struct.Memory* %2, %struct.State* %0, i64 %17, i64 %19, i64 %20, i64 %22)
...
entry:
  ...
  %call = call %struct.Memory* @routine_shrdq_m64_r64_cl(%struct.State* %state, i64 0, %struct.Memory* %mem)
  ret i32 0
}