...
define internal %struct.Memory* @_ZN12_GLOBAL__N_1L4SHRDI3MnWItE2MnItE2RnItE2InItEEEP6MemorySA_R5StateT_T0_T1_T2_(%struct.Memory*, %struct.State* nocapture dereferenceable(3376), i64, i64, i64, i64) #0 {
...
define %struct.Memory* @routine_shrdw_m16_r16_imm8(%struct.State* noalias dereferenceable(3376), i64, %struct.Memory* noalias) #19 {
block_530:
  ...
  %19 = add i64 %18, 6
  store i64 %19, i64* %PC
  %20 = call %struct.Memory* @_ZN12_GLOBAL__N_1L4SHRDI3MnWItE2MnItE2RnItE2InItEEEP6MemorySA_R5StateT_T0_T1_T2_(%struct.Memory* %2, %struct.State* %0, i64 %13, i64 %15, i64 %17, i64 10)
...
entry:
  ...
  %call = call %struct.Memory* @routine_shrdw_m16_r16_imm8(%struct.State* %state, i64 0, %struct.Memory* %mem)
  ret i32 0
}