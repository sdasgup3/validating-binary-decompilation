...
define i32 @sub_shrw_m16_cl(%struct.State*, i64, i64) {
block_4003e0:
  ...
  switch i5 %25, label %32 [
    i5 0, label %_ZN12_GLOBAL__N_1L3SHRI3MnWItE2MnItE2RnItEEEP6MemoryS8_R5StateT_T0_T1_.exit
    i5 1, label %26
  ]
...
; <label>:49:                                     ; preds = %46, %34, %26
  %50 = phi i8 [ 0, %34 ], [ 0, %46 ], [ 0, %26 ]
  %51 = phi i16 [ %45, %34 ], [ 0, %46 ], [ %31, %26 ]
  %52 = phi i8 [ %40, %34 ], [ %48, %46 ], [ %28, %26 ]
  %53 = phi i8 [ %42, %34 ], [ %48, %46 ], [ %30, %26 ]
  %54 = inttoptr i64 %14 to i16*
  store i16 %51, i16* %54
  ...
  %59 = call i32 @my.ctpop.i32(i32 %58) #14
  ...
  br label %_ZN12_GLOBAL__N_1L3SHRI3MnWItE2MnItE2RnItEEEP6MemoryS8_R5StateT_T0_T1_.exit

_ZN12_GLOBAL__N_1L3SHRI3MnWItE2MnItE2RnItEEEP6MemoryS8_R5StateT_T0_T1_.exit: ; preds = %49, %block_4003e0
  %69 = phi %struct.Memory* [ %2, %49 ], [ %2, %block_4003e0 ]
  %70 = load i64, i64* %PC
  %71 = add i64 %70, 1
  store i64 %71, i64* %PC
...
entry:
  ...
  %call = call i32 @sub_shrw_m16_cl(%struct.State* %state, i64 0, i64 0)
  ret i32 0
}