...
define i32 @sub_tzcntl_r32_m32(%struct.State*, i64, i64) {
block_4003e0:
  ...
  %17 = load i32, i32* %16
  %18 = call i32 @my.cttz.i32(i32 %17, i1 false) #14
...
entry:
  ...
  %call = call i32 @sub_tzcntl_r32_m32(%struct.State* %state, i64 0, i64 0)
  ret i32 0
}