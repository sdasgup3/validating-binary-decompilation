...
define i32 @sub_tzcntq_r64_m64(%struct.State*, i64, i64) {
block_4003e0:
  ...
  %17 = load i64, i64* %16
  %18 = call i64 @my.cttz.i64(i64 %17, i1 false) #14
...
entry:
  ...
  %call = call i32 @sub_tzcntq_r64_m64(%struct.State* %state, i64 0, i64 0)
  ret i32 0
}