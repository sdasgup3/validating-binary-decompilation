...
define i32 @sub_tzcntw_r16_m16(%struct.State*, i64, i64) {
block_4003e0:
  ...
  %19 = call i32 @my.cttz.i32(i32 %18, i1 true) #14
  ...
  %31 = select i1 %29, i16 16, i16 %20
  store i16 %31, i16* %BX, align 2
  %32 = load i64, i64* %PC
  %33 = add i64 %32, 1
  store i64 %33, i64* %PC
...
entry:
  ...
  %call = call i32 @sub_tzcntw_r16_m16(%struct.State* %state, i64 0, i64 0)
  ret i32 0
}