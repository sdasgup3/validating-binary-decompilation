...
define i32 @sub_unpckhpd_xmm_m128(%struct.State*, i64, i64) {
block_4003e0:
  ...
  store double %19, double* %25, align 1
  %26 = load i64, i64* %PC
  %27 = add i64 %26, 1
  store i64 %27, i64* %PC
...
entry:
  ...
  %call = call i32 @sub_unpckhpd_xmm_m128(%struct.State* %state, i64 0, i64 0)
  ret i32 0
}