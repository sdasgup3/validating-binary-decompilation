...
define i32 @sub_vaddsd_xmm_xmm_m64(%struct.State*, i64, i64) {
block_4003e0:
  ...
  store double %26, double* %27, align 1
  ...
  store <2 x double> zeroinitializer, <2 x double>* %31, align 1
  %32 = load i64, i64* %PC
  %33 = add i64 %32, 1
  store i64 %33, i64* %PC
...
entry:
  ...
  %call = call i32 @sub_vaddsd_xmm_xmm_m64(%struct.State* %state, i64 0, i64 0)
  ret i32 0
}