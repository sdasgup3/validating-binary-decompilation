...
define i32 @sub_vandnpd_xmm_xmm_m128(%struct.State*, i64, i64) {
block_4003e0:
  ...
  store <2 x i64> zeroinitializer, <2 x i64>* %32, align 1
  %33 = load i64, i64* %PC
  %34 = add i64 %33, 1
  store i64 %34, i64* %PC
...
entry:
  ...
  %call = call i32 @sub_vandnpd_xmm_xmm_m128(%struct.State* %state, i64 0, i64 0)
  ret i32 0
}