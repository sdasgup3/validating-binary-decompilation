...
define i32 @sub_vcmppd_xmm_xmm_m128_imm8(%struct.State*, i64, i64) {
block_4003e0:
  ...
  store i64 %32, i64* %35, align 1
  %36 = getelementptr inbounds i8, i8* %13, i64 16
  %37 = bitcast i8* %36 to <2 x i64>*
  store <2 x i64> zeroinitializer, <2 x i64>* %37, align 1
  %38 = load i64, i64* %PC
  %39 = add i64 %38, 1
  store i64 %39, i64* %PC
...
entry:
  ...
  %call = call i32 @sub_vcmppd_xmm_xmm_m128_imm8(%struct.State* %state, i64 0, i64 0)
  ret i32 0
}