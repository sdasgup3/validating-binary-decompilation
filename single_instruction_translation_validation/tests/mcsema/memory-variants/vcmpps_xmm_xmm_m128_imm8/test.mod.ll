...
define i32 @sub_vcmpps_xmm_xmm_m128_imm8(%struct.State*, i64, i64) {
block_4003e0:
  ...
  store <4 x i32> zeroinitializer, <4 x i32>* %60, align 1
  %61 = load i64, i64* %PC
  %62 = add i64 %61, 1
  store i64 %62, i64* %PC
...
entry:
  ...
  %call = call i32 @sub_vcmpps_xmm_xmm_m128_imm8(%struct.State* %state, i64 0, i64 0)
  ret i32 0
}