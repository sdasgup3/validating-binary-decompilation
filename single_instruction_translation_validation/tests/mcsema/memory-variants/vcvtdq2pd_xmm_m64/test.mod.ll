...
define i32 @sub_vcvtdq2pd_xmm_m64(%struct.State*, i64, i64) {
block_4003e0:
  ...
  store <2 x i64> zeroinitializer, <2 x i64>* %26, align 1
  %27 = load i64, i64* %PC
  %28 = add i64 %27, 1
  store i64 %28, i64* %PC
...
entry:
  ...
  %call = call i32 @sub_vcvtdq2pd_xmm_m64(%struct.State* %state, i64 0, i64 0)
  ret i32 0
}