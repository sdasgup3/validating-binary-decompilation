...
define i32 @sub_vcvtps2pd_xmm_m64(%struct.State*, i64, i64) {
block_4003e0:
  ...
  store <2 x double> %22, <2 x double>* %23, align 1
  %24 = getelementptr inbounds i8, i8* %11, i64 16
  %25 = bitcast i8* %24 to <2 x i64>*
  store <2 x i64> zeroinitializer, <2 x i64>* %25, align 1
  %26 = load i64, i64* %PC
  %27 = add i64 %26, 1
  store i64 %27, i64* %PC
...
entry:
  ...
  %call = call i32 @sub_vcvtps2pd_xmm_m64(%struct.State* %state, i64 0, i64 0)
  ret i32 0
}