...
define i32 @sub_vcvtsi2ssl_xmm_xmm_m32(%struct.State*, i64, i64) {
block_4003e0:
  ...
  store <4 x float> zeroinitializer, <4 x float>* %38, align 1
  %39 = load i64, i64* %PC
  %40 = add i64 %39, 1
  store i64 %40, i64* %PC
...
entry:
  ...
  %call = call i32 @sub_vcvtsi2ssl_xmm_xmm_m32(%struct.State* %state, i64 0, i64 0)
  ret i32 0
}