...
define i32 @sub_vcvttps2dq_ymm_m256(%struct.State*, i64, i64) {
block_4003e0:
  ...
  %52 = call <4 x float> @my.trunc.v4f32(<4 x float> %51) #14
  ...
  %63 = call <4 x float> @my.trunc.v4f32(<4 x float> %62) #14
...
entry:
  ...
  %call = call i32 @sub_vcvttps2dq_ymm_m256(%struct.State* %state, i64 0, i64 0)
  ret i32 0
}