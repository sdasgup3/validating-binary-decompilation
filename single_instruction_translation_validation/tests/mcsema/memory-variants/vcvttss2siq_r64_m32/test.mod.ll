...
define i32 @sub_vcvttss2siq_r64_m32(%struct.State*, i64, i64) {
block_4003e0:
  ...
  %18 = call float @my.trunc.f32(float %17) #14
...
entry:
  ...
  %call = call i32 @sub_vcvttss2siq_r64_m32(%struct.State* %state, i64 0, i64 0)
  ret i32 0
}