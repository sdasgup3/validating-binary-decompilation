...
define i32 @sub_vdivpd_xmm_xmm_m128(%struct.State*, i64, i64) {
block_4003e0:
  ...
  %28 = fdiv <2 x double> %20, %27
  %29 = bitcast i8* %13 to <2 x double>*
  store <2 x double> %28, <2 x double>* %29, align 1
...
entry:
  ...
  %call = call i32 @sub_vdivpd_xmm_xmm_m128(%struct.State* %state, i64 0, i64 0)
  ret i32 0
}