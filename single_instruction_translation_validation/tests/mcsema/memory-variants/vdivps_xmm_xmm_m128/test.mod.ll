...
define i32 @sub_vdivps_xmm_xmm_m128(%struct.State*, i64, i64) {
block_4003e0:
  ...
  store <4 x float> zeroinitializer, <4 x float>* %42, align 1
  %43 = load i64, i64* %PC
  %44 = add i64 %43, 1
  store i64 %44, i64* %PC
...
entry:
  ...
  %call = call i32 @sub_vdivps_xmm_xmm_m128(%struct.State* %state, i64 0, i64 0)
  ret i32 0
}