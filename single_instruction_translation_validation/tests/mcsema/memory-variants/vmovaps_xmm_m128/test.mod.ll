...
define i32 @sub_vmovaps_xmm_m128(%struct.State*, i64, i64) {
block_4003e0:
  ...
  store float %19, float* %28, align 1
  %29 = getelementptr inbounds i8, i8* %11, i64 8
  %30 = bitcast i8* %29 to float*
  store float %22, float* %30, align 1
  %31 = getelementptr inbounds i8, i8* %11, i64 12
  %32 = bitcast i8* %31 to float*
  store float %25, float* %32, align 1
  %33 = getelementptr inbounds i8, i8* %11, i64 16
  %34 = bitcast i8* %33 to <4 x float>*
  store <4 x float> zeroinitializer, <4 x float>* %34, align 1
  %35 = load i64, i64* %PC
  %36 = add i64 %35, 1
  store i64 %36, i64* %PC
...
entry:
  ...
  %call = call i32 @sub_vmovaps_xmm_m128(%struct.State* %state, i64 0, i64 0)
  ret i32 0
}