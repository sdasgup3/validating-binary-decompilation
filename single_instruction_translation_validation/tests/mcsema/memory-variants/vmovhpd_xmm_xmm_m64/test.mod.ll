...
define i32 @sub_vmovhpd_xmm_xmm_m64(%struct.State*, i64, i64) {
block_4003e0:
  ...
  store double %22, double* %25, align 1
...
entry:
  ...
  %call = call i32 @sub_vmovhpd_xmm_xmm_m64(%struct.State* %state, i64 0, i64 0)
  ret i32 0
}