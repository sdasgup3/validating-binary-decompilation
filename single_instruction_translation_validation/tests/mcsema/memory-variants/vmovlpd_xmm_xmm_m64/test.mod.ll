...
define i32 @sub_vmovlpd_xmm_xmm_m64(%struct.State*, i64, i64) {
block_4003e0:
  ...
  store i64 %21, i64* %26, align 1
  %27 = getelementptr inbounds i8, i8* %13, i64 16
  %28 = bitcast i8* %27 to <2 x double>*
  store <2 x double> zeroinitializer, <2 x double>* %28, align 1
  %29 = load i64, i64* %PC
  %30 = add i64 %29, 1
  store i64 %30, i64* %PC
...
entry:
  ...
  %call = call i32 @sub_vmovlpd_xmm_xmm_m64(%struct.State* %state, i64 0, i64 0)
  ret i32 0
}