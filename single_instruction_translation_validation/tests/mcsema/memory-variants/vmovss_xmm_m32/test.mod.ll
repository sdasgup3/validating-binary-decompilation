...
define i32 @sub_vmovss_xmm_m32(%struct.State*, i64, i64) {
block_4003e0:
  ...
  store <4 x float> zeroinitializer, <4 x float>* %20, align 1
...
entry:
  ...
  %call = call i32 @sub_vmovss_xmm_m32(%struct.State* %state, i64 0, i64 0)
  ret i32 0
}