...
define i32 @sub_vpandn_xmm_xmm_m128(%struct.State*, i64, i64) {
block_4003e0:
  ...
  store i32 %40, i32* %50, align 1
  %51 = getelementptr inbounds i8, i8* %13, i64 8
  %52 = bitcast i8* %51 to i32*
  store i32 %43, i32* %52, align 1
  ...
  store <4 x i32> zeroinitializer, <4 x i32>* %56, align 1
  %57 = load i64, i64* %PC
  %58 = add i64 %57, 1
  store i64 %58, i64* %PC
...
entry:
  ...
  %call = call i32 @sub_vpandn_xmm_xmm_m128(%struct.State* %state, i64 0, i64 0)
  ret i32 0
}