...
define i32 @sub_vpandn_ymm_ymm_m256(%struct.State*, i64, i64) {
block_4003e0:
  ...
  store <4 x i32> %51, <4 x i32>* %58, align 1
...
entry:
  ...
  %call = call i32 @sub_vpandn_ymm_ymm_m256(%struct.State* %state, i64 0, i64 0)
  ret i32 0
}