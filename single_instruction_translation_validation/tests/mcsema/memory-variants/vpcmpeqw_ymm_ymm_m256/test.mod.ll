...
define i32 @sub_vpcmpeqw_ymm_ymm_m256(%struct.State*, i64, i64) {
block_4003e0:
...
entry:
  ...
  %call = call i32 @sub_vpcmpeqw_ymm_ymm_m256(%struct.State* %state, i64 0, i64 0)
  ret i32 0
}