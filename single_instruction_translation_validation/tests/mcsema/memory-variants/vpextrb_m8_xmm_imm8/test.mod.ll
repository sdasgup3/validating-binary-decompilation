...
define i32 @sub_vpextrb_m8_xmm_imm8(%struct.State*, i64, i64) {
block_4003e0:
  ...
  call void @my.lifetime.start(i64 16, i8* nonnull %18) #14
  ...
  store i8 %22, i8* %23
  call void @my.lifetime.end(i64 16, i8* nonnull %18) #14
  %24 = load i64, i64* %PC
  %25 = add i64 %24, 1
  store i64 %25, i64* %PC
...
entry:
  ...
  %call = call i32 @sub_vpextrb_m8_xmm_imm8(%struct.State* %state, i64 0, i64 0)
  ret i32 0
}