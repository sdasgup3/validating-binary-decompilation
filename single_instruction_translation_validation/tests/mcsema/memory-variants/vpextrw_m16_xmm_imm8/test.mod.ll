...
define i32 @sub_vpextrw_m16_xmm_imm8(%struct.State*, i64, i64) {
block_4003e0:
  ...
  %16 = add i64 %15, 7
  store i64 %16, i64* %PC
  %17 = bitcast <2 x i64>* %3 to %struct.uint16v8_t*
  ...
  %21 = getelementptr inbounds %struct.uint16v8_t, %struct.uint16v8_t* %17, i64 0, i32 0, i64 0
...
entry:
  ...
  %call = call i32 @sub_vpextrw_m16_xmm_imm8(%struct.State* %state, i64 0, i64 0)
  ret i32 0
}