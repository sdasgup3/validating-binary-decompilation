...
define i32 @sub_vpsrlq_xmm_xmm_m128(%struct.State*, i64, i64) {
block_4003e0:
...
_ZN12_GLOBAL__N_1L7PSRLQ_VI3VnWI8vec256_tE2VnI8vec128_tE3MVnIS5_EEEP6MemorySA_R5StateT_T0_T1_.exit: ; preds = %22, %block_4003e0
  ...
  store i64 %30, i64* %34, align 1
  %35 = getelementptr inbounds i8, i8* %13, i64 16
  %36 = bitcast i8* %35 to <2 x i64>*
  store <2 x i64> zeroinitializer, <2 x i64>* %36, align 1
  %37 = load i64, i64* %PC
  %38 = add i64 %37, 1
  store i64 %38, i64* %PC
...
entry:
  ...
  %call = call i32 @sub_vpsrlq_xmm_xmm_m128(%struct.State* %state, i64 0, i64 0)
  ret i32 0
}