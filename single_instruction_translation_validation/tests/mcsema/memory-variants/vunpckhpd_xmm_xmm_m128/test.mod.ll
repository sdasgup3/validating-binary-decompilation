...
define i32 @sub_vunpckhpd_xmm_xmm_m128(%struct.State*, i64, i64) {
block_4003e0:
  ...
  store double %21, double* %27, align 1
...
entry:
  ...
  %call = call i32 @sub_vunpckhpd_xmm_xmm_m128(%struct.State* %state, i64 0, i64 0)
  ret i32 0
}