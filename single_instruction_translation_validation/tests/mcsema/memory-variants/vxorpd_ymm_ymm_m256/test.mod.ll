...
define i32 @sub_vxorpd_ymm_ymm_m256(%struct.State*, i64, i64) {
block_4003e0:
  ...
  store <2 x i64> %37, <2 x i64>* %41, align 1
...
entry:
  ...
  %call = call i32 @sub_vxorpd_ymm_ymm_m256(%struct.State* %state, i64 0, i64 0)
  ret i32 0
}