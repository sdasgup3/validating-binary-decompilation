...
define i32 @sub_xaddl_m32_r32(%struct.State*, i64, i64) {
block_4003e0:
  ...
  %23 = call %struct.Memory* @__remill_fetch_and_add_32(%struct.Memory* %13, i64 %15, i32* nonnull dereferenceable(4) %3) #15
...
entry:
  ...
  %call = call i32 @sub_xaddl_m32_r32(%struct.State* %state, i64 0, i64 0)
  ret i32 0
}