...
define i32 @sub_xaddq_m64_r64(%struct.State*, i64, i64) {
block_4003e0:
  ...
  %22 = call %struct.Memory* @__remill_fetch_and_add_64(%struct.Memory* %13, i64 %15, i64* nonnull dereferenceable(8) %3) #15
  ...
  %57 = call %struct.Memory* @__remill_atomic_end(%struct.Memory* %22)
  %58 = load i64, i64* %PC
  %59 = add i64 %58, 1
  store i64 %59, i64* %PC
...
entry:
  ...
  %call = call i32 @sub_xaddq_m64_r64(%struct.State* %state, i64 0, i64 0)
  ret i32 0
}