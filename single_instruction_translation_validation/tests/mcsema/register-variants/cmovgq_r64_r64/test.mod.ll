...
define i32 @sub_cmovgq_r64_r64(%struct.State*, i64, i64) {
block_530:
  ...
  %25 = xor i1 %24, true
  %26 = and i1 %17, %25
  %27 = load i64, i64* %RBX, align 8
  %28 = select i1 %26, i64 %12, i64 %27
  store i64 %28, i64* %RBX, align 8
  %29 = load i64, i64* %PC
  %30 = add i64 %29, 1
  store i64 %30, i64* %PC
...
entry:
  ...
  %call = call i32 @sub_cmovgq_r64_r64(%struct.State* %state, i64 0, i64 0)
  ret i32 0
}