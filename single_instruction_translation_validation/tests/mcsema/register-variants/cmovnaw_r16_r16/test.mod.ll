...
define i32 @sub_cmovnaw_r16_r16(%struct.State*, i64, i64) {
block_530:
  ...
  %20 = or i8 %19, %17
  %21 = icmp ne i8 %20, 0
  %22 = load i16, i16* %BX, align 2
  %23 = select i1 %21, i16 %12, i16 %22
  store i16 %23, i16* %BX, align 2
  %24 = load i64, i64* %PC
  %25 = add i64 %24, 1
  store i64 %25, i64* %PC
...
entry:
  ...
  %call = call i32 @sub_cmovnaw_r16_r16(%struct.State* %state, i64 0, i64 0)
  ret i32 0
}