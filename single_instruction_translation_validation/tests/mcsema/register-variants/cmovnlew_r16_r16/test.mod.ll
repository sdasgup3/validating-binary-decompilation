...
define i32 @sub_cmovnlew_r16_r16(%struct.State*, i64, i64) {
block_530:
  ...
  %26 = xor i1 %25, true
  %27 = and i1 %18, %26
  %28 = load i16, i16* %BX, align 2
  %29 = select i1 %27, i16 %12, i16 %28
  store i16 %29, i16* %BX, align 2
  %30 = load i64, i64* %PC
  %31 = add i64 %30, 1
  store i64 %31, i64* %PC
...
entry:
  ...
  %call = call i32 @sub_cmovnlew_r16_r16(%struct.State* %state, i64 0, i64 0)
  ret i32 0
}