...
define i32 @sub_cmovnlw_r16_r16(%struct.State*, i64, i64) {
block_530:
  ...
  %24 = select i1 %22, i16 %23, i16 %12
  store i16 %24, i16* %BX, align 2
  %25 = load i64, i64* %PC
  %26 = add i64 %25, 1
  store i64 %26, i64* %PC
...
entry:
  ...
  %call = call i32 @sub_cmovnlw_r16_r16(%struct.State* %state, i64 0, i64 0)
  ret i32 0
}