...
define i32 @sub_lzcntl_r32_r32(%struct.State*, i64, i64) {
block_530:
  ...
  %15 = add i64 %14, 4
  store i64 %15, i64* %PC
  %16 = call i32 @my.ctlz.i32(i32 %12, i1 false) #14
...
entry:
  ...
  %call = call i32 @sub_lzcntl_r32_r32(%struct.State* %state, i64 0, i64 0)
  ret i32 0
}