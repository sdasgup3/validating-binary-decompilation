...
define i32 @sub_lzcntw_r16_r16(%struct.State*, i64, i64) {
block_530:
  ...
  %17 = and i32 %16, 65535
  %18 = call i32 @my.ctlz.i32(i32 %17, i1 true) #14
  %19 = add   i32 %18, 65520
...
entry:
  ...
  %call = call i32 @sub_lzcntw_r16_r16(%struct.State* %state, i64 0, i64 0)
  ret i32 0
}