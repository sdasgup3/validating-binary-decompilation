...
define i32 @sub_mulps_xmm_xmm(%struct.State*, i64, i64) {
block_530:
  ...
  %25 = shufflevector <2 x float> %16, <2 x float> %19, <4 x i32> <i32 0, i32 1, i32 2, i32 3>
  %26 = shufflevector <2 x float> %21, <2 x float> %24, <4 x i32> <i32 0, i32 1, i32 2, i32 3>
  %27 = fmul <4 x float> %25, %26
  %28 = bitcast i8* %10 to <4 x float>*
...
entry:
  ...
  %call = call i32 @sub_mulps_xmm_xmm(%struct.State* %state, i64 0, i64 0)
  ret i32 0
}