...
define i32 @sub_pcmpgtq_xmm_xmm(%struct.State*, i64, i64) {
block_530:
  ...
  %25 = icmp sgt i64 %16, %21
  %26 = sext i1 %25 to i64
  %27 = icmp sgt i64 %19, %24
...
entry:
  ...
  %call = call i32 @sub_pcmpgtq_xmm_xmm(%struct.State* %state, i64 0, i64 0)
  ret i32 0
}