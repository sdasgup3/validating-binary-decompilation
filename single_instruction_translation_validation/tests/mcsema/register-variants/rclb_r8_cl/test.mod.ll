...
define i32 @sub_rclb_r8_cl(%struct.State*, i64, i64) {
block_530:
...
; <label>:24:                                     ; preds = %block_530
  ...
  br label %_ZN12_GLOBAL__N_1L3RCLI3RnWIhE2RnIhES4_EEP6MemoryS6_R5StateT_T0_T1_.exit

; <label>:51:                                     ; preds = %block_530
  store i8 %14, i8* %BL, align 1
  br label %_ZN12_GLOBAL__N_1L3RCLI3RnWIhE2RnIhES4_EEP6MemoryS6_R5StateT_T0_T1_.exit

_ZN12_GLOBAL__N_1L3RCLI3RnWIhE2RnIhES4_EEP6MemoryS6_R5StateT_T0_T1_.exit: ; preds = %51, %24
  %52 = load i64, i64* %PC
  %53 = add i64 %52, 1
  store i64 %53, i64* %PC
...
entry:
  ...
  %call = call i32 @sub_rclb_r8_cl(%struct.State* %state, i64 0, i64 0)
  ret i32 0
}