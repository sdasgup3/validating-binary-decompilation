...
define i32 @sub_rclw_r16_one(%struct.State*, i64, i64) {
block_530:
...
entry:
  ...
  %call = call i32 @sub_rclw_r16_one(%struct.State* %state, i64 0, i64 0)
  ret i32 0
}