...
define i32 @sub_rorw_r16_cl(%struct.State*, i64, i64) {
block_530:
...
; <label>:22:                                     ; preds = %block_530
  ...
  br label %_ZN12_GLOBAL__N_1L3RORI3RnWItE2RnItES4_EEP6MemoryS6_R5StateT_T0_T1_.exit

; <label>:40:                                     ; preds = %block_530
  store i16 %13, i16* %BX, align 2
  br label %_ZN12_GLOBAL__N_1L3RORI3RnWItE2RnItES4_EEP6MemoryS6_R5StateT_T0_T1_.exit

_ZN12_GLOBAL__N_1L3RORI3RnWItE2RnItES4_EEP6MemoryS6_R5StateT_T0_T1_.exit: ; preds = %40, %22
  %41 = load i64, i64* %PC
  %42 = add i64 %41, 1
  store i64 %42, i64* %PC
...
entry:
  ...
  %call = call i32 @sub_rorw_r16_cl(%struct.State* %state, i64 0, i64 0)
  ret i32 0
}