...
define i32 @sub_sarw_r16_cl(%struct.State*, i64, i64) {
block_530:
...
; <label>:46:                                     ; preds = %42, %30, %22
  ...
  %55 = call i32 @my.ctpop.i32(i32 %54) #14
...
entry:
  ...
  %call = call i32 @sub_sarw_r16_cl(%struct.State* %state, i64 0, i64 0)
  ret i32 0
}