...
define %struct.Memory* @routine_setb_rh(%struct.State* noalias dereferenceable(3376), i64, %struct.Memory* noalias) #19 {
block_530:
  ...
  %11 = add i64 %10, 3
  store i64 %11, i64* %PC
  %12 = call %struct.Memory* @_ZN12_GLOBAL__N_1L4SETBI3RnWIhEEEP6MemoryS4_R5StateT_(%struct.Memory* %2, %struct.State* %0, i8* %AH)
  %13 = load i64, i64* %PC
  %14 = add i64 %13, 1
  store i64 %14, i64* %PC
...
entry:
  ...
  %call = call %struct.Memory* @routine_setb_rh(%struct.State* %state, i64 0, %struct.Memory* %mem)
  ret i32 0
}