...
define %struct.Memory* @routine_sete_r8(%struct.State* noalias dereferenceable(3376), i64, %struct.Memory* noalias) #19 {
block_530:
...
entry:
  ...
  %call = call %struct.Memory* @routine_sete_r8(%struct.State* %state, i64 0, %struct.Memory* %mem)
  ret i32 0
}