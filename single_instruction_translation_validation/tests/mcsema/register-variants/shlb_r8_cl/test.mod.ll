...
define i32 @sub_shlb_r8_cl(%struct.State*, i64, i64) {
block_530:
...
entry:
  ...
  %call = call i32 @sub_shlb_r8_cl(%struct.State* %state, i64 0, i64 0)
  ret i32 0
}