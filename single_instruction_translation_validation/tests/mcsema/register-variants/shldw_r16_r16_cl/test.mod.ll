...
define internal %struct.Memory* @_ZN12_GLOBAL__N_1L4SHLDI3RnWItE2RnItES4_S4_EEP6MemoryS6_R5StateT_T0_T1_T2_(%struct.Memory* readnone, %struct.State* nocapture dereferenceable(3376), i16* nocapture, i64, i64, i64) #0 {
...
define %struct.Memory* @routine_shldw_r16_r16_cl(%struct.State* noalias dereferenceable(3376), i64, %struct.Memory* noalias) #19 {
block_530:
  ...
  %23 = add i64 %22, 4
  store i64 %23, i64* %PC
  %24 = call %struct.Memory* @_ZN12_GLOBAL__N_1L4SHLDI3RnWItE2RnItES4_S4_EEP6MemoryS6_R5StateT_T0_T1_T2_(%struct.Memory* %2, %struct.State* %0, i16* %BX, i64 %17, i64 %19, i64 %21)
...
entry:
  ...
  %call = call %struct.Memory* @routine_shldw_r16_r16_cl(%struct.State* %state, i64 0, %struct.Memory* %mem)
  ret i32 0
}