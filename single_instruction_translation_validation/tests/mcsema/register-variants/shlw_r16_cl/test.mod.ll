...
define i32 @sub_shlw_r16_cl(%struct.State*, i64, i64) {
block_530:
...
; <label>:38:                                     ; preds = %29, %27, %22
  ...
  %47 = call i32 @my.ctpop.i32(i32 %46) #14
...
entry:
  ...
  %call = call i32 @sub_shlw_r16_cl(%struct.State* %state, i64 0, i64 0)
  ret i32 0
}