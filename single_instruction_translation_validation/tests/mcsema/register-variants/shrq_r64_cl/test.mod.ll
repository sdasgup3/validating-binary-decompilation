...
define i32 @sub_shrq_r64_cl(%struct.State*, i64, i64) {
block_530:
...
_ZN12_GLOBAL__N_1L3SHRI3RnWImE2RnImES4_EEP6MemoryS6_R5StateT_T0_T1_.exit: ; preds = %28, %block_530
  %49 = load i64, i64* %PC
  %50 = add i64 %49, 1
  store i64 %50, i64* %PC
...
entry:
  ...
  %call = call i32 @sub_shrq_r64_cl(%struct.State* %state, i64 0, i64 0)
  ret i32 0
}