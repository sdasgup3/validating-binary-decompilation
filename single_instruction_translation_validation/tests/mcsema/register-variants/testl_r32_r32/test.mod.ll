...
define %struct.Memory* @routine_testl_r32_r32(%struct.State* noalias dereferenceable(3376), i64, %struct.Memory* noalias) #19 {
block_530:
  ...
  %17 = add i64 %16, 2
  store i64 %17, i64* %PC
  %18 = call %struct.Memory* @_ZN12_GLOBAL__N_1L4TESTI2RnIjES2_EEP6MemoryS4_R5StateT_T0_(%struct.Memory* %2, %struct.State* %0, i64 %13, i64 %15)
...
entry:
  ...
  %call = call %struct.Memory* @routine_testl_r32_r32(%struct.State* %state, i64 0, %struct.Memory* %mem)
  ret i32 0
}