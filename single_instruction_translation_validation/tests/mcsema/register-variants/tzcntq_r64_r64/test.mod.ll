...
define i32 @sub_tzcntq_r64_r64(%struct.State*, i64, i64) {
block_530:
  ...
  %14 = add i64 %13, 5
  store i64 %14, i64* %PC
  %15 = call i64 @my.cttz.i64(i64 %12, i1 false) #14
...
entry:
  ...
  %call = call i32 @sub_tzcntq_r64_r64(%struct.State* %state, i64 0, i64 0)
  ret i32 0
}