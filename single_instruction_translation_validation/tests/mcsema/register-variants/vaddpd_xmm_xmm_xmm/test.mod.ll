...
define i32 @sub_vaddpd_xmm_xmm_xmm(%struct.State*, i64, i64) {
block_530:
  ...
  %16 = add i64 %15, 4
  store i64 %16, i64* %PC
  %17 = bitcast i8* %13 to <2 x double>*
  ...
  %22 = bitcast i8* %12 to <2 x double>*
  store <2 x double> %21, <2 x double>* %22, align 1
  %23 = getelementptr inbounds i8, i8* %12, i64 16
  %24 = bitcast i8* %23 to <2 x double>*
  store <2 x double> zeroinitializer, <2 x double>* %24, align 1
  %25 = load i64, i64* %PC
  %26 = add i64 %25, 1
  store i64 %26, i64* %PC
...
entry:
  ...
  %call = call i32 @sub_vaddpd_xmm_xmm_xmm(%struct.State* %state, i64 0, i64 0)
  ret i32 0
}