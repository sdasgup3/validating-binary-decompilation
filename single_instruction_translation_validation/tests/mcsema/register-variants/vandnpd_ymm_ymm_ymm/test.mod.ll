...
define i32 @sub_vandnpd_ymm_ymm_ymm(%struct.State*, i64, i64) {
block_530:
  ...
  %27 = xor <2 x i64> %23, <i64 -1, i64 -1>
  %28 = and <2 x i64> %18, %27
  %29 = xor <2 x i64> %26, <i64 -1, i64 -1>
...
entry:
  ...
  %call = call i32 @sub_vandnpd_ymm_ymm_ymm(%struct.State* %state, i64 0, i64 0)
  ret i32 0
}