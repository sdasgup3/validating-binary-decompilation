...
define i32 @sub_vandnps_ymm_ymm_ymm(%struct.State*, i64, i64) {
block_530:
  ...
  %28 = and <4 x i32> %18, %27
  %29 = xor <4 x i32> %26, <i32 -1, i32 -1, i32 -1, i32 -1>
  %30 = and <4 x i32> %21, %29
  %31 = bitcast i8* %12 to <4 x i32>*
...
entry:
  ...
  %call = call i32 @sub_vandnps_ymm_ymm_ymm(%struct.State* %state, i64 0, i64 0)
  ret i32 0
}