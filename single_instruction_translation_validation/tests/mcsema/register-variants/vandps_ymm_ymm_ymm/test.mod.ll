...
define i32 @sub_vandps_ymm_ymm_ymm(%struct.State*, i64, i64) {
block_530:
  ...
  %27 = and <4 x i32> %23, %18
  %28 = and <4 x i32> %26, %21
...
entry:
  ...
  %call = call i32 @sub_vandps_ymm_ymm_ymm(%struct.State* %state, i64 0, i64 0)
  ret i32 0
}