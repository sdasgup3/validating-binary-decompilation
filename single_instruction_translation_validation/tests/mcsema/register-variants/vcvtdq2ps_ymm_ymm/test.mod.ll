...
define i32 @sub_vcvtdq2ps_ymm_ymm(%struct.State*, i64, i64) {
block_530:
  ...
  store <4 x float> %18, <4 x float>* %23, align 1
...
entry:
  ...
  %call = call i32 @sub_vcvtdq2ps_ymm_ymm(%struct.State* %state, i64 0, i64 0)
  ret i32 0
}