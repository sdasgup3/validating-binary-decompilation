...
define i32 @sub_vcvtpd2ps_xmm_xmm(%struct.State*, i64, i64) {
block_530:
  ...
  store float %20, float* %23, align 1
...
entry:
  ...
  %call = call i32 @sub_vcvtpd2ps_xmm_xmm(%struct.State* %state, i64 0, i64 0)
  ret i32 0
}