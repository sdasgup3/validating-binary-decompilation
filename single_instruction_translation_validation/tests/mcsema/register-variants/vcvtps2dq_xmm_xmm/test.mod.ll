...
define i32 @sub_vcvtps2dq_xmm_xmm(%struct.State*, i64, i64) {
block_530:
  ...
  %27 = call <4 x float> @my.nearbyint.v4f32(<4 x float> %26) #14
...
entry:
  ...
  %call = call i32 @sub_vcvtps2dq_xmm_xmm(%struct.State* %state, i64 0, i64 0)
  ret i32 0
}