...
define i32 @sub_vcvtsd2sil_r32_xmm(%struct.State*, i64, i64) {
block_530:
  ...
  %16 = call double @my.nearbyint.f64(double %15) #14
  %17 = call double @my.fabs.f64(double %16) #14
...
entry:
  ...
  %call = call i32 @sub_vcvtsd2sil_r32_xmm(%struct.State* %state, i64 0, i64 0)
  ret i32 0
}