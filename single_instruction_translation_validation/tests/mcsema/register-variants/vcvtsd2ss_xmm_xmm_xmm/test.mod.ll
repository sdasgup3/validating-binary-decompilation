...
define i32 @sub_vcvtsd2ss_xmm_xmm_xmm(%struct.State*, i64, i64) {
block_530:
  ...
  %32 = extractelement <2 x i32> %21, i32 1
  %33 = getelementptr inbounds i8, i8* %12, i64 12
...
entry:
  ...
  %call = call i32 @sub_vcvtsd2ss_xmm_xmm_xmm(%struct.State* %state, i64 0, i64 0)
  ret i32 0
}