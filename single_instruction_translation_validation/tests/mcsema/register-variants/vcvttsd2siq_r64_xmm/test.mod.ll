...
define i32 @sub_vcvttsd2siq_r64_xmm(%struct.State*, i64, i64) {
block_530:
  ...
  %16 = call double @my.trunc.f64(double %15) #14
...
entry:
  ...
  %call = call i32 @sub_vcvttsd2siq_r64_xmm(%struct.State* %state, i64 0, i64 0)
  ret i32 0
}