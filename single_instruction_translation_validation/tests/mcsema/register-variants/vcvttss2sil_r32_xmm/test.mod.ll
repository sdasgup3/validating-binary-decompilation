...
define i32 @sub_vcvttss2sil_r32_xmm(%struct.State*, i64, i64) {
block_530:
  ...
  %17 = call float @my.trunc.f32(float %16) #14
...
entry:
  ...
  %call = call i32 @sub_vcvttss2sil_r32_xmm(%struct.State* %state, i64 0, i64 0)
  ret i32 0
}