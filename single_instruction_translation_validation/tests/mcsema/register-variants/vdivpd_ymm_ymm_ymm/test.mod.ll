...
define i32 @sub_vdivpd_ymm_ymm_ymm(%struct.State*, i64, i64) {
block_530:
  ...
  %27 = fdiv <2 x double> %18, %23
  %28 = fdiv <2 x double> %21, %26
  %29 = bitcast i8* %12 to <2 x double>*
  store <2 x double> %27, <2 x double>* %29, align 1
  %30 = getelementptr inbounds i8, i8* %12, i64 16
  %31 = bitcast i8* %30 to <2 x double>*
  store <2 x double> %28, <2 x double>* %31, align 1
  %32 = load i64, i64* %PC
  %33 = add i64 %32, 1
  store i64 %33, i64* %PC
...
entry:
  ...
  %call = call i32 @sub_vdivpd_ymm_ymm_ymm(%struct.State* %state, i64 0, i64 0)
  ret i32 0
}