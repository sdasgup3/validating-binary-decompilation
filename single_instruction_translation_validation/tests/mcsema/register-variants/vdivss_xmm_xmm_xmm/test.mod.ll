...
define i32 @sub_vdivss_xmm_xmm_xmm(%struct.State*, i64, i64) {
block_530:
  ...
  %26 = fdiv float %24, %25
  %27 = bitcast i8* %12 to float*
  store float %26, float* %27, align 1
  %28 = bitcast <2 x float> %18 to <2 x i32>
  %29 = extractelement <2 x i32> %28, i32 1
  %30 = getelementptr inbounds i8, i8* %12, i64 4
  %31 = bitcast i8* %30 to i32*
  store i32 %29, i32* %31, align 1
  %32 = extractelement <2 x i32> %21, i32 0
  %33 = getelementptr inbounds i8, i8* %12, i64 8
  %34 = bitcast i8* %33 to i32*
  store i32 %32, i32* %34, align 1
  %35 = extractelement <2 x i32> %21, i32 1
  %36 = getelementptr inbounds i8, i8* %12, i64 12
  %37 = bitcast i8* %36 to i32*
  store i32 %35, i32* %37, align 1
  %38 = getelementptr inbounds i8, i8* %12, i64 16
  %39 = bitcast i8* %38 to <4 x float>*
  store <4 x float> zeroinitializer, <4 x float>* %39, align 1
  %40 = load i64, i64* %PC
  %41 = add i64 %40, 1
  store i64 %41, i64* %PC
...
entry:
  ...
  %call = call i32 @sub_vdivss_xmm_xmm_xmm(%struct.State* %state, i64 0, i64 0)
  ret i32 0
}