...
define i32 @sub_vmovaps_ymm_ymm(%struct.State*, i64, i64) {
block_530:
  ...
  %19 = bitcast i8* %10 to <4 x i32>*
  store <4 x i32> %15, <4 x i32>* %19, align 1
  %20 = getelementptr inbounds i8, i8* %10, i64 16
  %21 = bitcast i8* %20 to <4 x i32>*
  store <4 x i32> %18, <4 x i32>* %21, align 1
  %22 = load i64, i64* %PC
  %23 = add i64 %22, 1
  store i64 %23, i64* %PC
...
entry:
  ...
  %call = call i32 @sub_vmovaps_ymm_ymm(%struct.State* %state, i64 0, i64 0)
  ret i32 0
}