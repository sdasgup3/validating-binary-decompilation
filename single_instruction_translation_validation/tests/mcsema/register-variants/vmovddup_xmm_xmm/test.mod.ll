...
define i32 @sub_vmovddup_xmm_xmm(%struct.State*, i64, i64) {
block_530:
  ...
  store i64 %15, i64* %18, align 1
  %19 = getelementptr inbounds i8, i8* %10, i64 16
  %20 = bitcast i8* %19 to <2 x double>*
  store <2 x double> zeroinitializer, <2 x double>* %20, align 1
  %21 = load i64, i64* %PC
  %22 = add i64 %21, 1
  store i64 %22, i64* %PC
...
entry:
  ...
  %call = call i32 @sub_vmovddup_xmm_xmm(%struct.State* %state, i64 0, i64 0)
  ret i32 0
}