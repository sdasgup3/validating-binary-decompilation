...
define i32 @sub_vmovq_xmm_r64(%struct.State*, i64, i64) {
block_530:
  ...
  store <2 x i64> zeroinitializer, <2 x i64>* %17, align 1
...
entry:
  ...
  %call = call i32 @sub_vmovq_xmm_r64(%struct.State* %state, i64 0, i64 0)
  ret i32 0
}