...
define i32 @sub_vmovupd_ymm_ymm(%struct.State*, i64, i64) {
block_530:
  ...
  store <2 x i64> %15, <2 x i64>* %19, align 1
...
entry:
  ...
  %call = call i32 @sub_vmovupd_ymm_ymm(%struct.State* %state, i64 0, i64 0)
  ret i32 0
}