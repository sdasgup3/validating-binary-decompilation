...
define i32 @sub_vmulsd_xmm_xmm_xmm(%struct.State*, i64, i64) {
block_530:
  ...
  store <2 x double> zeroinitializer, <2 x double>* %29, align 1
  %30 = load i64, i64* %PC
  %31 = add i64 %30, 1
  store i64 %31, i64* %PC
...
entry:
  ...
  %call = call i32 @sub_vmulsd_xmm_xmm_xmm(%struct.State* %state, i64 0, i64 0)
  ret i32 0
}