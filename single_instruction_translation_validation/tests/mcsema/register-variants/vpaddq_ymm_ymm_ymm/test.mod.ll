...
define i32 @sub_vpaddq_ymm_ymm_ymm(%struct.State*, i64, i64) {
block_530:
  ...
  %27 = add <2 x i64> %23, %18
  %28 = add <2 x i64> %26, %21
  %29 = bitcast i8* %12 to <2 x i64>*
  store <2 x i64> %27, <2 x i64>* %29, align 1
...
entry:
  ...
  %call = call i32 @sub_vpaddq_ymm_ymm_ymm(%struct.State* %state, i64 0, i64 0)
  ret i32 0
}