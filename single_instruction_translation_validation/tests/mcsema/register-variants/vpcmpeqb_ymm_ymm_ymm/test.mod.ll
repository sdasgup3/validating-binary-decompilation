...
define i32 @sub_vpcmpeqb_ymm_ymm_ymm(%struct.State*, i64, i64) {
block_530:
  ...
  store <16 x i8> %34, <16 x i8>* %37, align 1
...
entry:
  ...
  %call = call i32 @sub_vpcmpeqb_ymm_ymm_ymm(%struct.State* %state, i64 0, i64 0)
  ret i32 0
}