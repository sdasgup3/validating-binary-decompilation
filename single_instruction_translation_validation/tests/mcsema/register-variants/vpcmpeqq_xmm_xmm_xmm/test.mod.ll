...
define i32 @sub_vpcmpeqq_xmm_xmm_xmm(%struct.State*, i64, i64) {
block_530:
  ...
  %27 = icmp eq i64 %18, %23
  %28 = sext i1 %27 to i64
  %29 = icmp eq i64 %21, %26
  ...
  store <2 x i64> zeroinitializer, <2 x i64>* %35, align 1
  %36 = load i64, i64* %PC
  %37 = add i64 %36, 1
  store i64 %37, i64* %PC
...
entry:
  ...
  %call = call i32 @sub_vpcmpeqq_xmm_xmm_xmm(%struct.State* %state, i64 0, i64 0)
  ret i32 0
}