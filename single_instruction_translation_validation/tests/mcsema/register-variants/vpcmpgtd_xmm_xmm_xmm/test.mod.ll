...
define i32 @sub_vpcmpgtd_xmm_xmm_xmm(%struct.State*, i64, i64) {
block_530:
...
entry:
  ...
  %call = call i32 @sub_vpcmpgtd_xmm_xmm_xmm(%struct.State* %state, i64 0, i64 0)
  ret i32 0
}