...
define i32 @sub_vpcmpgtq_xmm_xmm_xmm(%struct.State*, i64, i64) {
block_530:
  ...
  %27 = icmp sgt i64 %18, %23
  %28 = sext i1 %27 to i64
  %29 = icmp sgt i64 %21, %26
...
entry:
  ...
  %call = call i32 @sub_vpcmpgtq_xmm_xmm_xmm(%struct.State* %state, i64 0, i64 0)
  ret i32 0
}