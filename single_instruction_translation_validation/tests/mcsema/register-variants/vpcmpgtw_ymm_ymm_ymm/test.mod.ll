...
define i32 @sub_vpcmpgtw_ymm_ymm_ymm(%struct.State*, i64, i64) {
block_530:
  %3 = alloca %struct.uint16v16_t, align 16
  %4 = alloca %struct.uint16v16_t, align 16
  ...
  %18 = add i64 %17, 4
  store i64 %18, i64* %PC
  %19 = bitcast %struct.uint16v16_t* %3 to i8*
  ...
  %20 = bitcast %struct.uint16v16_t* %4 to i8*
  ...
  %21 = bitcast %struct.uint16v16_t* %3 to <8 x i16>*
  %22 = load <8 x i16>, <8 x i16>* %21, align 16
  %23 = bitcast %struct.uint16v16_t* %4 to <8 x i16>*
  %24 = load <8 x i16>, <8 x i16>* %23, align 16
  %25 = icmp sgt <8 x i16> %22, %24
  %26 = sext <8 x i1> %25 to <8 x i16>
  %27 = getelementptr inbounds %struct.uint16v16_t, %struct.uint16v16_t* %3, i64 0, i32 0, i64 8
  %28 = getelementptr inbounds %struct.uint16v16_t, %struct.uint16v16_t* %4, i64 0, i32 0, i64 8
  %29 = bitcast i16* %27 to <8 x i16>*
  %30 = load <8 x i16>, <8 x i16>* %29, align 16
  %31 = bitcast i16* %28 to <8 x i16>*
  %32 = load <8 x i16>, <8 x i16>* %31, align 16
  %33 = icmp sgt <8 x i16> %30, %32
  %34 = sext <8 x i1> %33 to <8 x i16>
  %35 = bitcast i8* %14 to <8 x i16>*
  store <8 x i16> %26, <8 x i16>* %35, align 1
  %36 = getelementptr inbounds i8, i8* %14, i64 16
  %37 = bitcast i8* %36 to <8 x i16>*
  store <8 x i16> %34, <8 x i16>* %37, align 1
...
entry:
  ...
  %call = call i32 @sub_vpcmpgtw_ymm_ymm_ymm(%struct.State* %state, i64 0, i64 0)
  ret i32 0
}