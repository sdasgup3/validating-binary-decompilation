...
define i32 @sub_vpsubd_xmm_xmm_xmm(%struct.State*, i64, i64) {
block_530:
  ...
  store <4 x i32> zeroinitializer, <4 x i32>* %47, align 1
  %48 = load i64, i64* %PC
  %49 = add i64 %48, 1
  store i64 %49, i64* %PC
...
entry:
  ...
  %call = call i32 @sub_vpsubd_xmm_xmm_xmm(%struct.State* %state, i64 0, i64 0)
  ret i32 0
}