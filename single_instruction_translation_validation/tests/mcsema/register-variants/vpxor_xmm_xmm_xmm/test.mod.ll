...
define i32 @sub_vpxor_xmm_xmm_xmm(%struct.State*, i64, i64) {
block_530:
  ...
  store <4 x i32> zeroinitializer, <4 x i32>* %43, align 1
  %44 = load i64, i64* %PC
  %45 = add i64 %44, 1
  store i64 %45, i64* %PC
...
entry:
  ...
  %call = call i32 @sub_vpxor_xmm_xmm_xmm(%struct.State* %state, i64 0, i64 0)
  ret i32 0
}