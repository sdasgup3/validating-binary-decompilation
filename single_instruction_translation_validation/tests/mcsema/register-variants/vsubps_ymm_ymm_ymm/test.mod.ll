...
define i32 @sub_vsubps_ymm_ymm_ymm(%struct.State*, i64, i64) {
block_530:
  ...
  %27 = fsub <4 x float> %18, %23
  %28 = fsub <4 x float> %21, %26
  %29 = bitcast i8* %12 to <4 x float>*
  store <4 x float> %27, <4 x float>* %29, align 1
  %30 = getelementptr inbounds i8, i8* %12, i64 16
  %31 = bitcast i8* %30 to <4 x float>*
  store <4 x float> %28, <4 x float>* %31, align 1
  %32 = load i64, i64* %PC
  %33 = add i64 %32, 1
  store i64 %33, i64* %PC
...
entry:
  ...
  %call = call i32 @sub_vsubps_ymm_ymm_ymm(%struct.State* %state, i64 0, i64 0)
  ret i32 0
}