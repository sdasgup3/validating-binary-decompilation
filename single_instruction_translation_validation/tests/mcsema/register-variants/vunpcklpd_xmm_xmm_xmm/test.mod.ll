...
define i32 @sub_vunpcklpd_xmm_xmm_xmm(%struct.State*, i64, i64) {
block_530:
  ...
  store i64 %18, i64* %21, align 1
  %22 = getelementptr inbounds i8, i8* %12, i64 8
  %23 = bitcast i8* %22 to i64*
  store i64 %20, i64* %23, align 1
  %24 = getelementptr inbounds i8, i8* %12, i64 16
  %25 = bitcast i8* %24 to <2 x double>*
  store <2 x double> zeroinitializer, <2 x double>* %25, align 1
  %26 = load i64, i64* %PC
  %27 = add i64 %26, 1
  store i64 %27, i64* %PC
...
entry:
  ...
  %call = call i32 @sub_vunpcklpd_xmm_xmm_xmm(%struct.State* %state, i64 0, i64 0)
  ret i32 0
}