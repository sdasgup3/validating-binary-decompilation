...
define i32 @sub_vunpcklps_xmm_xmm_xmm(%struct.State*, i64, i64) {
block_530:
  ...
  store <4 x float> zeroinitializer, <4 x float>* %33, align 1
  %34 = load i64, i64* %PC
  %35 = add i64 %34, 1
  store i64 %35, i64* %PC
...
entry:
  ...
  %call = call i32 @sub_vunpcklps_xmm_xmm_xmm(%struct.State* %state, i64 0, i64 0)
  ret i32 0
}