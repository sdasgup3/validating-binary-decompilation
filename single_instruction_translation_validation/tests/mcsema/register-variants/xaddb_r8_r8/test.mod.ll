...
define i32 @sub_xaddb_r8_r8(%struct.State*, i64, i64) {
block_530:
  ...
  %20 = add i64 %19, 3
  store i64 %20, i64* %PC
  %21 = load i8, i8* %BL, align 1
  %22 = add i8 %21, %17
  store i8 %22, i8* %BL, align 1
...
entry:
  ...
  %call = call i32 @sub_xaddb_r8_r8(%struct.State* %state, i64 0, i64 0)
  ret i32 0
}