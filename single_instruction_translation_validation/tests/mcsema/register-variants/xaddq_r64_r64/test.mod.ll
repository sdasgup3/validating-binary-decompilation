...
define i32 @sub_xaddq_r64_r64(%struct.State*, i64, i64) {
block_530:
  ...
  %51 = call %struct.Memory* @__remill_atomic_end(%struct.Memory* %12)
  %52 = load i64, i64* %PC
  %53 = add i64 %52, 1
  store i64 %53, i64* %PC
...
entry:
  ...
  %call = call i32 @sub_xaddq_r64_r64(%struct.State* %state, i64 0, i64 0)
  ret i32 0
}