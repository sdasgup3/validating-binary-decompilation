...
; +-------------------------------------------------------------------------+
;
; Input	SHA256 : 485DF389D775FE9B65E1FE318E5DC53B7F0077DCB948C65B82A045C29A14C936
; Input	MD5    : 101E7D7A31D52C4F728EE645F826E969
; Input	CRC32  : C6885587

; File Name   :	/home/sdasgup3/Github/validating-binary-decompilation/tests/binary_search/binary_search
...
binary_search	proc near		; CODE XREF: main+44p
...
loc_6E0:				; CODE XREF: binary_search+8Ej
		mov	eax, [rbp+var_8]
		sub	eax, [rbp+var_C]
		mov	edx, eax
		shr	edx, 1Fh
...
loc_719:				; CODE XREF: binary_search+52j
		mov	eax, [rbp+var_4]
		cdqe
		lea	rdx, ds:0[rax*4]
		mov	rax, [rbp+var_18]
...
loc_73F:				; CODE XREF: binary_search+72j
		mov	eax, [rbp+var_4]
		sub	eax, 1
		mov	[rbp+var_8], eax

loc_748:				; CODE XREF: binary_search+1Ej
					; binary_search+7Dj
		mov	eax, [rbp+var_C]
		cmp	eax, [rbp+var_8]
		jl	short loc_6E0
...
loc_755:				; CODE XREF: binary_search+57j
		pop	rbp
		retn
binary_search	endp
...
locret_7B4:				; CODE XREF: main+56j
		leave
		retn
main		endp
...
loc_800:				; CODE XREF: __libc_csu_init+54j
		mov	rdx, r13
		mov	rsi, r14
		mov	edi, r15d
...
loc_816:				; CODE XREF: __libc_csu_init+34j
		add	rsp, 8
		pop	rbx
		pop	rbp
		pop	r12
