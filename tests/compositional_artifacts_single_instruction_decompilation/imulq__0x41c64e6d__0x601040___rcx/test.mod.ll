...
define %struct.Memory* @routine_imulq__0x41c64e6d__0x601040___rcx(%struct.State*  dereferenceable(3376), i64, %struct.Memory* ) #19 {
block_400488:
  ...
  %10 = add i64 %9, 12
  store i64 %10, i64* %PC
  %11 = call %struct.Memory* @_ZN12_GLOBAL__N_1L4IMULI3RnWImE2MnImE2InImEEEP6MemoryS8_R5StateT_T0_T1_(%struct.Memory* %2, %struct.State* %0, i64* %RCX, i64 ptrtoint (i64 ()* @__gmon_start__ to i64), i64 1103515245)
