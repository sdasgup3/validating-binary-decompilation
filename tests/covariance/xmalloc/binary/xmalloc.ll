...
define hidden i8* @xmalloc(i64) #0 {
  ...
  %6 = call i32 @posix_memalign(i8** %3, i64 32, i64 %5) #4
...
; <label>:12:                                     ; preds = %9, %1
  ...
  %14 = call i32 (%struct._IO_FILE*, i8*, ...) @fprintf(%struct._IO_FILE* %13, i8* getelementptr inbounds ([51 x i8], [51 x i8]* @.str.1, i32 0, i32 0))
