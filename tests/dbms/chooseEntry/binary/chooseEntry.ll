...
define %struct.IndexEntry* @chooseEntry(%struct.IndexNode*, %struct.IndexEntry*) #0 {
  ...
  %10 = getelementptr inbounds %struct.IndexNode, %struct.IndexNode* %9, i32 0, i32 1
  %11 = load %struct.IndexEntry*, %struct.IndexEntry** %10, align 8
  store %struct.IndexEntry* %11, %struct.IndexEntry** %5, align 8
  %12 = load %struct.IndexEntry*, %struct.IndexEntry** %5, align 8
  %13 = load %struct.IndexEntry*, %struct.IndexEntry** %4, align 8
  %14 = call float @penalty(%struct.IndexEntry* byval align 8 %12, %struct.IndexEntry* byval align 8 %13)
  store float %14, float* %7, align 4
  %15 = load %struct.IndexEntry*, %struct.IndexEntry** %5, align 8
  %16 = getelementptr inbounds %struct.IndexEntry, %struct.IndexEntry* %15, i32 0, i32 2
  %17 = load %struct.IndexEntry*, %struct.IndexEntry** %16, align 8
  store %struct.IndexEntry* %17, %struct.IndexEntry** %6, align 8
  br label %18

; <label>:18:                                     ; preds = %32, %2
  %19 = load %struct.IndexEntry*, %struct.IndexEntry** %6, align 8
  %20 = icmp ne %struct.IndexEntry* %19, null
  br i1 %20, label %21, label %36

; <label>:21:                                     ; preds = %18
  %22 = load %struct.IndexEntry*, %struct.IndexEntry** %6, align 8
  %23 = load %struct.IndexEntry*, %struct.IndexEntry** %4, align 8
  %24 = call float @penalty(%struct.IndexEntry* byval align 8 %22, %struct.IndexEntry* byval align 8 %23)
...
; <label>:28:                                     ; preds = %21
  %29 = load %struct.IndexEntry*, %struct.IndexEntry** %6, align 8
  store %struct.IndexEntry* %29, %struct.IndexEntry** %5, align 8
...
; <label>:32:                                     ; preds = %31
  %33 = load %struct.IndexEntry*, %struct.IndexEntry** %6, align 8
  %34 = getelementptr inbounds %struct.IndexEntry, %struct.IndexEntry* %33, i32 0, i32 2
  %35 = load %struct.IndexEntry*, %struct.IndexEntry** %34, align 8
  store %struct.IndexEntry* %35, %struct.IndexEntry** %6, align 8
  br label %18

; <label>:36:                                     ; preds = %18
  %37 = load %struct.IndexEntry*, %struct.IndexEntry** %5, align 8
  ret %struct.IndexEntry* %37
}
