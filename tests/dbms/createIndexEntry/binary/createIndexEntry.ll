...
; <label>:6:                                      ; preds = %0
  call void @errorMessage(i8* getelementptr inbounds ([19 x i8], [19 x i8]* @.str.65, i32 0, i32 0), i8 signext 0)
