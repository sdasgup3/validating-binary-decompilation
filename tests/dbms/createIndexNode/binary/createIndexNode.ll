...
; Function Attrs: noinline nounwind optnone uwtable
define %struct.IndexNode* @createIndexNode(i64) #1 {
...
; <label>:6:                                      ; preds = %1
  call void @errorMessage(i8* getelementptr inbounds ([24 x i8], [24 x i8]* @.str.49, i32 0, i32 0), i8 signext 0)
  call void @errorMessage(i8* getelementptr inbounds ([16 x i8], [16 x i8]* @createIndexNode.name, i32 0, i32 0), i8 signext 1)
  store %struct.IndexNode* null, %struct.IndexNode** %3, align 8
  br label %18

; <label>:7:                                      ; preds = %1
  %8 = call noalias i8* @malloc(i64 16) #2
...
; <label>:12:                                     ; preds = %7
  call void @errorMessage(i8* getelementptr inbounds ([19 x i8], [19 x i8]* @.str.1.50, i32 0, i32 0), i8 signext 0)
  call void @errorMessage(i8* getelementptr inbounds ([16 x i8], [16 x i8]* @createIndexNode.name, i32 0, i32 0), i8 signext 1)
  br label %17
