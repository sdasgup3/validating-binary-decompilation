...
define void @flushErrorMessage() #2 {
  %1 = call i64 @strlen(i8* getelementptr inbounds ([1024 x i8], [1024 x i8]* @errorBuffer, i32 0, i32 0)) #3
  %2 = icmp ugt i64 %1, 0
  br i1 %2, label %3, label %8

; <label>:3:                                      ; preds = %0
  %4 = load %struct._IO_FILE*, %struct._IO_FILE** @stderr, align 8
  %5 = call i32 (%struct._IO_FILE*, i8*, ...) @fprintf(%struct._IO_FILE* %4, i8* getelementptr inbounds ([4 x i8], [4 x i8]* @.str.6.46, i32 0, i32 0), i8* getelementptr inbounds ([1024 x i8], [1024 x i8]* @errorBuffer, i32 0, i32 0))
