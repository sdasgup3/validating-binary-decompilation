...
define i64 @getDeleteCommand(%struct._IO_FILE*, %struct.IndexKey*, %struct.DataAttribute**) #0 {
...
; <label>:52:                                     ; preds = %49, %46
  call void @errorMessage(i8* getelementptr inbounds ([18 x i8], [18 x i8]* @.str.8, i32 0, i32 0), i8 signext 0)
...
; <label>:136:                                    ; preds = %133
  call void @errorMessage(i8* getelementptr inbounds ([28 x i8], [28 x i8]* @.str.1.9, i32 0, i32 0), i8 signext 0)
  call void @errorMessage(i8* getelementptr inbounds ([17 x i8], [17 x i8]* @getDeleteCommand.name, i32 0, i32 0), i8 signext 1)
...
; <label>:140:                                    ; preds = %137
  call void @errorMessage(i8* getelementptr inbounds ([20 x i8], [20 x i8]* @.str.2.10, i32 0, i32 0), i8 signext 0)
  call void @errorMessage(i8* getelementptr inbounds ([17 x i8], [17 x i8]* @getDeleteCommand.name, i32 0, i32 0), i8 signext 1)
...
; <label>:154:                                    ; preds = %149
  call void @errorMessage(i8* getelementptr inbounds ([19 x i8], [19 x i8]* @.str.3.11, i32 0, i32 0), i8 signext 0)
  call void @errorMessage(i8* getelementptr inbounds ([17 x i8], [17 x i8]* @getDeleteCommand.name, i32 0, i32 0), i8 signext 1)
...
; <label>:177:                                    ; preds = %174
  call void @errorMessage(i8* getelementptr inbounds ([32 x i8], [32 x i8]* @.str.4.12, i32 0, i32 0), i8 signext 0)
  call void @errorMessage(i8* getelementptr inbounds ([17 x i8], [17 x i8]* @getDeleteCommand.name, i32 0, i32 0), i8 signext 1)
  store i64 4, i64* %4, align 8
  br label %200
