; ModuleID = 'getNextCommandCode.bc'
...
; Function Attrs: noinline nounwind optnone uwtable
define i64 @getNextCommandCode(%struct._IO_FILE*, i32*) #0 {
  ...
  %8 = call i64 @getInt(%struct._IO_FILE* %7, i64* %6)
...
; <label>:31:                                     ; preds = %26
  call void @errorMessage(i8* getelementptr inbounds ([21 x i8], [21 x i8]* @.str.101, i32 0, i32 0), i8 signext 0)
...
; <label>:50:                                     ; preds = %47
  call void @errorMessage(i8* getelementptr inbounds ([42 x i8], [42 x i8]* @.str.1.102, i32 0, i32 0), i8 signext 0)
  call void @errorMessage(i8* getelementptr inbounds ([19 x i8], [19 x i8]* @getNextCommandCode.name, i32 0, i32 0), i8 signext 1)
