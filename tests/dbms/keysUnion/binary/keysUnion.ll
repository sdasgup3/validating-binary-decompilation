...
; Function Attrs: noinline nounwind optnone uwtable
define void @keysUnion(%struct.IndexEntry*, %struct.IndexKey*) #1 {
  ...
  %5 = load %struct.IndexKey*, %struct.IndexKey** %4, align 8
  %6 = load %struct.IndexEntry*, %struct.IndexEntry** %3, align 8
  %7 = getelementptr inbounds %struct.IndexEntry, %struct.IndexEntry* %6, i32 0, i32 1
  %8 = bitcast %struct.IndexKey* %5 to i8*
  %9 = bitcast %struct.IndexKey* %7 to i8*
  call void @llvm.memcpy.p0i8.p0i8.i64(i8* %8, i8* %9, i64 32, i32 4, i1 false)
  %10 = load %struct.IndexEntry*, %struct.IndexEntry** %3, align 8
  %11 = getelementptr inbounds %struct.IndexEntry, %struct.IndexEntry* %10, i32 0, i32 2
...
; <label>:16:                                     ; preds = %13
  ...
  %18 = getelementptr inbounds %struct.IndexEntry, %struct.IndexEntry* %17, i32 0, i32 1
  %19 = load %struct.IndexKey*, %struct.IndexKey** %4, align 8
  %20 = load %struct.IndexKey*, %struct.IndexKey** %4, align 8
  call void @keyUnion(%struct.IndexKey* %18, %struct.IndexKey* %19, %struct.IndexKey* %20)
  br label %21

; <label>:21:                                     ; preds = %16
  %22 = load %struct.IndexEntry*, %struct.IndexEntry** %3, align 8
  %23 = getelementptr inbounds %struct.IndexEntry, %struct.IndexEntry* %22, i32 0, i32 2
  %24 = load %struct.IndexEntry*, %struct.IndexEntry** %23, align 8
  store %struct.IndexEntry* %24, %struct.IndexEntry** %3, align 8
  br label %13
