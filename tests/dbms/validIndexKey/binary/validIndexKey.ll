...
; Function Attrs: noinline nounwind optnone uwtable
define signext i8 @validIndexKey(%struct.IndexKey*) #0 {
  ...
  %5 = getelementptr inbounds %struct.IndexKey, %struct.IndexKey* %4, i32 0, i32 0
  %6 = getelementptr inbounds %struct.IndexPoint, %struct.IndexPoint* %5, i32 0, i32 0
  %7 = load float, float* %6, align 4
  %8 = load %struct.IndexKey*, %struct.IndexKey** %2, align 8
  %9 = getelementptr inbounds %struct.IndexKey, %struct.IndexKey* %8, i32 0, i32 1
  %10 = getelementptr inbounds %struct.IndexPoint, %struct.IndexPoint* %9, i32 0, i32 0
  %11 = load float, float* %10, align 4
  %12 = fcmp oge float %7, %11
  br i1 %12, label %13, label %14

; <label>:13:                                     ; preds = %1
  call void @errorMessage(i8* getelementptr inbounds ([18 x i8], [18 x i8]* @.str.123, i32 0, i32 0), i8 signext 0)
  call void @errorMessage(i8* getelementptr inbounds ([14 x i8], [14 x i8]* @validIndexKey.name, i32 0, i32 0), i8 signext 1)
  store i8 0, i8* %3, align 1
  br label %50

; <label>:14:                                     ; preds = %1
  %15 = load %struct.IndexKey*, %struct.IndexKey** %2, align 8
  %16 = getelementptr inbounds %struct.IndexKey, %struct.IndexKey* %15, i32 0, i32 0
  %17 = getelementptr inbounds %struct.IndexPoint, %struct.IndexPoint* %16, i32 0, i32 1
  %18 = load float, float* %17, align 4
  %19 = load %struct.IndexKey*, %struct.IndexKey** %2, align 8
  %20 = getelementptr inbounds %struct.IndexKey, %struct.IndexKey* %19, i32 0, i32 1
...
; <label>:24:                                     ; preds = %14
  call void @errorMessage(i8* getelementptr inbounds ([18 x i8], [18 x i8]* @.str.1.124, i32 0, i32 0), i8 signext 0)
  call void @errorMessage(i8* getelementptr inbounds ([14 x i8], [14 x i8]* @validIndexKey.name, i32 0, i32 0), i8 signext 1)
  store i8 0, i8* %3, align 1
  br label %49

; <label>:25:                                     ; preds = %14
  %26 = load %struct.IndexKey*, %struct.IndexKey** %2, align 8
  %27 = getelementptr inbounds %struct.IndexKey, %struct.IndexKey* %26, i32 0, i32 0
  %28 = getelementptr inbounds %struct.IndexPoint, %struct.IndexPoint* %27, i32 0, i32 2
  %29 = load float, float* %28, align 4
  %30 = load %struct.IndexKey*, %struct.IndexKey** %2, align 8
  %31 = getelementptr inbounds %struct.IndexKey, %struct.IndexKey* %30, i32 0, i32 1
  %32 = getelementptr inbounds %struct.IndexPoint, %struct.IndexPoint* %31, i32 0, i32 2
  %33 = load float, float* %32, align 4
  %34 = fcmp oge float %29, %33
  br i1 %34, label %35, label %36

; <label>:35:                                     ; preds = %25
  call void @errorMessage(i8* getelementptr inbounds ([18 x i8], [18 x i8]* @.str.2.125, i32 0, i32 0), i8 signext 0)
  call void @errorMessage(i8* getelementptr inbounds ([14 x i8], [14 x i8]* @validIndexKey.name, i32 0, i32 0), i8 signext 1)
  store i8 0, i8* %3, align 1
  br label %48

; <label>:36:                                     ; preds = %25
  %37 = load %struct.IndexKey*, %struct.IndexKey** %2, align 8
  %38 = getelementptr inbounds %struct.IndexKey, %struct.IndexKey* %37, i32 0, i32 0
  %39 = getelementptr inbounds %struct.IndexPoint, %struct.IndexPoint* %38, i32 0, i32 3
  %40 = load float, float* %39, align 4
  %41 = load %struct.IndexKey*, %struct.IndexKey** %2, align 8
  %42 = getelementptr inbounds %struct.IndexKey, %struct.IndexKey* %41, i32 0, i32 1
  %43 = getelementptr inbounds %struct.IndexPoint, %struct.IndexPoint* %42, i32 0, i32 3
  %44 = load float, float* %43, align 4
  %45 = fcmp oge float %40, %44
  br i1 %45, label %46, label %47

; <label>:46:                                     ; preds = %36
  call void @errorMessage(i8* getelementptr inbounds ([18 x i8], [18 x i8]* @.str.3.126, i32 0, i32 0), i8 signext 0)
  call void @errorMessage(i8* getelementptr inbounds ([14 x i8], [14 x i8]* @validIndexKey.name, i32 0, i32 0), i8 signext 1)
  store i8 0, i8* %3, align 1
  br label %47
