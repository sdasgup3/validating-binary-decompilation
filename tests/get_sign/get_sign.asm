...
; +-------------------------------------------------------------------------+
;
; Input	SHA256 : 73DCD99E1786543DF05D145E31AF5FAC9EA22CFFB1A8F6449C98578E967890C3
; Input	MD5    : 6CB05D705DA4E6BCACBFEC050BCEDDB1
; Input	CRC32  : 169C5F1F

; File Name   :	/home/sdasgup3/Github/validating-binary-decompilation/tests/get_sign/get_sign
...
; Attributes: bp-based frame
		...
		public get_sign
get_sign	proc near		; CODE XREF: main+9p
...
loc_674:				; CODE XREF: get_sign+Bj
		mov	eax, 0

loc_679:				; CODE XREF: get_sign+12j
		pop	rbp
		retn
get_sign	endp
...
loc_6D0:				; CODE XREF: __libc_csu_init+54j
		mov	rdx, r13
		mov	rsi, r14
		mov	edi, r15d
...
loc_6E6:				; CODE XREF: __libc_csu_init+34j
		add	rsp, 8
		pop	rbx
		pop	rbp
		pop	r12
