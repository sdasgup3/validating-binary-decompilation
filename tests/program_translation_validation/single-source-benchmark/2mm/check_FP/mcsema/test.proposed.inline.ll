...
@G_0x3bc__rip__4198964_ = global %G_0x3bc__rip__4198964__type zeroinitializer
@G_0x438__rip__4198832_ = global %G_0x438__rip__4198832__type zeroinitializer
@G_0x602080 = global %G_0x602080_type zeroinitializer
@G__0x40163a = global %G__0x40163a_type zeroinitializer
...
entry:
  ...
  %76 = load double, double* bitcast (%G_0x438__rip__4198832__type* @G_0x438__rip__4198832_ to double*)
...
block_.L_4011ca:                                  ; preds = %block_.L_4012aa, %entry
...
block_4011d6:                                     ; preds = %block_.L_4011ca
...
block_.L_4011dd:                                  ; preds = %block_.L_401297, %block_4011d6
...
block_4011e9:                                     ; preds = %block_.L_4011dd
  ...
  %710 = load float, float* bitcast (%G_0x3bc__rip__4198964__type* @G_0x3bc__rip__4198964_ to float*)
  %711 = load float, float* inttoptr (i64 add (i64 ptrtoint (%G_0x3bc__rip__4198964__type* @G_0x3bc__rip__4198964_ to i64), i64 4) to float*)
  %712 = load float, float* inttoptr (i64 add (i64 ptrtoint (%G_0x3bc__rip__4198964__type* @G_0x3bc__rip__4198964_ to i64), i64 8) to float*)
  %713 = load float, float* inttoptr (i64 add (i64 ptrtoint (%G_0x3bc__rip__4198964__type* @G_0x3bc__rip__4198964_ to i64), i64 12) to float*)
...
; <label>:818:                                    ; preds = %810
  ...
  %821 = call %struct.Memory* @__remill_error(%struct.State* nonnull dereferenceable(3376) %0, i64 %820, %struct.Memory* %loadMem_401242)
  br label %routine_ucomisd_MINUS0x30__rbp____xmm0.exit

; <label>:822:                                    ; preds = %block_4011e9
...
routine_ucomisd_MINUS0x30__rbp____xmm0.exit:      ; preds = %818, %835
  %839 = phi %struct.Memory* [ %821, %818 ], [ %loadMem_401242, %835 ]
...
block_40124d:                                     ; preds = %routine_ucomisd_MINUS0x30__rbp____xmm0.exit
  ...
  store i64 ptrtoint (%G__0x40163a_type* @G__0x40163a to i64), i64* %RSI.i, align 8
  ...
  store %struct.Memory* %loadMem1_40127e, %struct.Memory** %MEMORY
  %loadMem2_40127e = load %struct.Memory*, %struct.Memory** %MEMORY
  %loadPC_40127e = load i64, i64* %3
  %1018 = call %struct.Memory* @__remill_function_call(%struct.State* %0, i64 ptrtoint (i64 (i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64)* @fprintf to i64), %struct.Memory* %loadMem2_40127e)
...
block_.L_401292:                                  ; preds = %routine_ucomisd_MINUS0x30__rbp____xmm0.exit
...
block_.L_401297:                                  ; preds = %block_.L_401292
...
block_.L_4012a5:                                  ; preds = %block_.L_4011dd
...
block_.L_4012aa:                                  ; preds = %block_.L_4012a5
...
block_.L_4012b8:                                  ; preds = %block_.L_4011ca
...
block_.L_4012bf:                                  ; preds = %block_.L_4012b8, %block_40124d
  ...
  ret %struct.Memory* %loadMem_4012c7
}
...
define %struct.Memory* @routine_movq__0x40163a___rsi(%struct.State* dereferenceable(3376), i64, %struct.Memory*) {
block_400478:
  %3 = getelementptr inbounds %struct.State, %struct.State* %0, i32 0, i32 6
  %4 = getelementptr inbounds %struct.GPR, %struct.GPR* %3, i32 0, i32 33
  %5 = getelementptr inbounds %struct.Reg, %struct.Reg* %4, i32 0, i32 0
  ...
  %10 = add i64 %9, 10
  store i64 %10, i64* %PC
  store i64 ptrtoint (%G__0x40163a_type* @G__0x40163a to i64), i64* %RSI, align 8
  ret %struct.Memory* %2
}
