...
declare %struct.Memory* @sub_4013c0.print_element(%struct.State* dereferenceable(3376), i64, %struct.Memory*) local_unnamed_addr
...
entry:
  ...
  %call2_40130e = tail call %struct.Memory* @sub_400640.malloc_plt(%struct.State* %0, i64 %82, %struct.Memory* %2)
...
block_.L_40132f:                                  ; preds = %block_.L_401385, %entry
  %131 = phi i64 [ %.pre, %entry ], [ %361, %block_.L_401385 ]
  %MEMORY.0 = phi %struct.Memory* [ %call2_40130e, %entry ], [ %call2_401391, %block_.L_401385 ]
  ...
  br i1 %167, label %block_40133b, label %block_.L_4013a7

block_40133b:                                     ; preds = %block_.L_40132f
  %169 = add i64 %132, -24
  %170 = add i64 %168, 7
...
block_.L_401342:                                  ; preds = %block_40134e, %block_40133b
  %172 = phi i64 [ %.pre9, %block_40133b ], [ %313, %block_40134e ]
  %MEMORY.1 = phi %struct.Memory* [ %MEMORY.0, %block_40133b ], [ %call2_401372, %block_40134e ]
  ...
  br i1 %208, label %block_40134e, label %block_.L_401385

block_40134e:                                     ; preds = %block_.L_401342
  %210 = add i64 %173, -16
  %211 = add i64 %209, 4
  ...
  %call2_401372 = tail call %struct.Memory* @sub_4013c0.print_element(%struct.State* nonnull %0, i64 %277, %struct.Memory* %MEMORY.1)
...
block_.L_401385:                                  ; preds = %block_.L_401342
  %314 = add i64 %173, -32
  %315 = add i64 %209, 4
  ...
  %call2_401391 = tail call %struct.Memory* @sub_400610.fputs_plt(%struct.State* nonnull %0, i64 %319, %struct.Memory* %MEMORY.1)
...
block_.L_4013a7:                                  ; preds = %block_.L_40132f
  %362 = add i64 %132, -32
  %363 = add i64 %168, 4
  ...
  %call2_4013ab = tail call %struct.Memory* @sub_4005f0.free_plt(%struct.State* nonnull %0, i64 %366, %struct.Memory* %MEMORY.0)
  ...
  ret %struct.Memory* %call2_4013ab
}
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_jge_.L_4013a7(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i8* nocapture %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_jge_.L_401385(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i8* nocapture %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 2, i32 9
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_jmpq_.L_401342(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
