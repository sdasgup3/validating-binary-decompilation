...
block_.L_40130f:                                  ; preds = %block_.L_401365, %entry
  %125 = phi i64 [ %.pre, %entry ], [ %356, %block_.L_401365 ]
  %MEMORY.0 = phi %struct.Memory* [ %81, %entry ], [ %318, %block_.L_401365 ]
...
block_.L_401322:                                  ; preds = %block_40132e, %block_40131b
  %166 = phi i64 [ %.pre1, %block_40131b ], [ %307, %block_40132e ]
...
block_40132e:                                     ; preds = %block_.L_401322
  ...
  %call2_401352 = tail call %struct.Memory* @sub_4013a0.print_element(%struct.State* %0, i64 %271, %struct.Memory* %MEMORY.1)
