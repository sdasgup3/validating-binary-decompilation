; ModuleID = '/tmp/tmpde4905qz-query.ll'
...
entry:
  ...
  br i1 %var_2_16834, label %block_40134b.preheader, label %block_.L_4013b7

block_40134b.preheader:                           ; preds = %entry
  br label %block_40134b

block_40134b:                                     ; preds = %block_40134b.preheader, %block_.L_401395
  %var_2_1741 = phi i64 [ %var_2_133, %block_.L_401395 ], [ %var_2_13318, %block_40134b.preheader ]
  %MEMORY.035 = phi %struct.Memory* [ %var_2_325, %block_.L_401395 ], [ %var_2_87, %block_40134b.preheader ]
  ...
  br i1 %var_2_20917, label %block_40135e.preheader, label %block_.L_401395

block_40135e.preheader:                           ; preds = %block_40134b
  br label %block_40135e

block_40135e:                                     ; preds = %block_40135e.preheader, %block_40135e
  br label %block_40135e

block_.L_401395:                                  ; preds = %block_40134b
  ...
  br i1 %var_2_168, label %block_40134b, label %block_.L_4013b7.loopexit

block_.L_4013b7.loopexit:                         ; preds = %block_.L_401395
  br label %block_.L_4013b7

block_.L_4013b7:                                  ; preds = %block_.L_4013b7.loopexit, %entry
  %MEMORY.0.lcssa = phi %struct.Memory* [ %var_2_87, %entry ], [ %var_2_325, %block_.L_4013b7.loopexit ]
