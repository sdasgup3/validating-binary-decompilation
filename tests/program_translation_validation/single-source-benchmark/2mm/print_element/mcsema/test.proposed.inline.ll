...
define %struct.Memory* @print_element(%struct.State* noalias, i64, %struct.Memory* noalias) #2 {
entry:
  ...
  store %struct.Memory* %loadMem_40142a, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_401505, %struct.Memory** %MEMORY
  ...
  ret %struct.Memory* %loadMem_40154a
}
