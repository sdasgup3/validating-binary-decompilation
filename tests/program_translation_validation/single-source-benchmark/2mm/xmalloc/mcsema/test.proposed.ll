...
@G__0x401637= global %G__0x401637_type <{ [8 x i8] c"\00\00\00\00\00\00\00\00" }>
...
block_.L_400913:
  ...
  ; Code: movq $0x401637, %rsi	 RIP: 400913	 Bytes: 10
  %loadMem_400913 = load %struct.Memory*, %struct.Memory** %MEMORY
  %call_400913 = call %struct.Memory* @routine_movq__0x401637___rsi(%struct.State* %0, i64  0, %struct.Memory* %loadMem_400913)
...
define %struct.Memory* @routine_movq__0x401637___rsi(%struct.State*  dereferenceable(3376), i64, %struct.Memory* ) #19 alwaysinline {
block_400488:
  %3 = getelementptr inbounds %struct.State, %struct.State* %0, i32 0, i32 6
  %4 = getelementptr inbounds %struct.GPR, %struct.GPR* %3, i32 0, i32 33
  %5 = getelementptr inbounds %struct.Reg, %struct.Reg* %4, i32 0, i32 0
  ...
  %10 = add i64 %9, 10
  store i64 %10, i64* %PC
  %11 = call %struct.Memory* @_ZN12_GLOBAL__N_1L3MOVI3RnWImE2InImEEEP6MemoryS6_R5StateT_T0_(%struct.Memory* %2, %struct.State* %0, i64* %RSI, i64 ptrtoint( %G__0x401637_type* @G__0x401637 to i64))
  ret %struct.Memory* %11
}
