...
%G_0x3ac__rip__4199428__type = type <{ [16 x i8] }>
%G_0x428__rip__4199296__type = type <{ [16 x i8] }>
%G_0x602080_type = type <{ [8 x i8] }>
%G__0x4017fa_type = type <{ [8 x i8] }>
...
@G_0x3ac__rip__4199428_ = global %G_0x3ac__rip__4199428__type zeroinitializer
@G_0x428__rip__4199296_ = global %G_0x428__rip__4199296__type zeroinitializer
@G_0x602080 = global %G_0x602080_type zeroinitializer
@G__0x4017fa = global %G__0x4017fa_type zeroinitializer
...
entry:
  ...
  %76 = load double, double* bitcast (%G_0x428__rip__4199296__type* @G_0x428__rip__4199296_ to double*)
  ...
  store i32 %91, i32* %95
  store %struct.Memory* %loadMem_401380, %struct.Memory** %MEMORY
...
block_.L_40139a:                                  ; preds = %block_.L_40147a, %entry
  ...
  %loadBr_4013a0 = load i8, i8* %BRANCH_TAKEN
  %cmpBr_4013a0 = icmp eq i8 %loadBr_4013a0, 1
  br i1 %cmpBr_4013a0, label %block_.L_401488, label %block_4013a6

block_4013a6:                                     ; preds = %block_.L_40139a
  ...
  br label %block_.L_4013ad

block_.L_4013ad:                                  ; preds = %block_.L_401467, %block_4013a6
  ...
  br i1 %cmpBr_4013b3, label %block_.L_401475, label %block_4013b9

block_4013b9:                                     ; preds = %block_.L_4013ad
  ...
  %710 = load float, float* bitcast (%G_0x3ac__rip__4199428__type* @G_0x3ac__rip__4199428_ to float*)
  %711 = load float, float* inttoptr (i64 add (i64 ptrtoint (%G_0x3ac__rip__4199428__type* @G_0x3ac__rip__4199428_ to i64), i64 4) to float*)
  %712 = load float, float* inttoptr (i64 add (i64 ptrtoint (%G_0x3ac__rip__4199428__type* @G_0x3ac__rip__4199428_ to i64), i64 8) to float*)
  %713 = load float, float* inttoptr (i64 add (i64 ptrtoint (%G_0x3ac__rip__4199428__type* @G_0x3ac__rip__4199428_ to i64), i64 12) to float*)
...
; <label>:818:                                    ; preds = %810
  ...
  %821 = call %struct.Memory* @__remill_error(%struct.State* nonnull dereferenceable(3376) %0, i64 %820, %struct.Memory* %loadMem_401412)
  br label %routine_ucomisd_MINUS0x30__rbp____xmm0.exit

; <label>:822:                                    ; preds = %block_4013b9
...
routine_ucomisd_MINUS0x30__rbp____xmm0.exit:      ; preds = %818, %835
  %839 = phi %struct.Memory* [ %821, %818 ], [ %loadMem_401412, %835 ]
  ...
  %loadBr_401417 = load i8, i8* %BRANCH_TAKEN
  %cmpBr_401417 = icmp eq i8 %loadBr_401417, 1
  br i1 %cmpBr_401417, label %block_.L_401462, label %block_40141d

block_40141d:                                     ; preds = %routine_ucomisd_MINUS0x30__rbp____xmm0.exit
  ...
  store i64 ptrtoint (%G__0x4017fa_type* @G__0x4017fa to i64), i64* %RSI.i, align 8
  ...
  %loadMem1_40144e = load %struct.Memory*, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem1_40144e, %struct.Memory** %MEMORY
  %loadMem2_40144e = load %struct.Memory*, %struct.Memory** %MEMORY
  %loadPC_40144e = load i64, i64* %3
  %1018 = call %struct.Memory* @__remill_function_call(%struct.State* %0, i64 ptrtoint (i64 (i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64)* @fprintf to i64), %struct.Memory* %loadMem2_40144e)
  ...
  br label %block_.L_40148f

block_.L_401462:                                  ; preds = %routine_ucomisd_MINUS0x30__rbp____xmm0.exit
...
block_.L_401475:                                  ; preds = %block_.L_4013ad
...
block_.L_40147a:                                  ; preds = %block_.L_401475
...
block_.L_401488:                                  ; preds = %block_.L_40139a
...
block_.L_40148f:                                  ; preds = %block_.L_401488, %block_40141d
  ...
  ret %struct.Memory* %loadMem_401497
}
...
block_400478:
  ...
  %9 = load i64, i64* %PC
  %10 = ptrtoint %G_0x428__rip__4199296__type* @G_0x428__rip__4199296_ to i64
  %11 = load i64, i64* %PC
  %12 = add i64 %11, 8
  store i64 %12, i64* %PC
...
define %struct.Memory* @routine_jge_.L_401488(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i8* %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) {
block_400478:
  %3 = getelementptr inbounds %struct.State, %struct.State* %0, i32 0, i32 6
  %4 = getelementptr inbounds %struct.GPR, %struct.GPR* %3, i32 0, i32 33
  %5 = getelementptr inbounds %struct.Reg, %struct.Reg* %4, i32 0, i32 0
...
define %struct.Memory* @routine_jge_.L_401475(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i8* %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) {
block_400478:
  %3 = getelementptr inbounds %struct.State, %struct.State* %0, i32 0, i32 6
  %4 = getelementptr inbounds %struct.GPR, %struct.GPR* %3, i32 0, i32 33
  %5 = getelementptr inbounds %struct.Reg, %struct.Reg* %4, i32 0, i32 0
...
block_400478:
  ...
  %9 = load i64, i64* %PC
  %10 = ptrtoint %G_0x3ac__rip__4199428__type* @G_0x3ac__rip__4199428_ to i64
  %11 = load i64, i64* %PC
  %12 = add i64 %11, 7
  store i64 %12, i64* %PC
...
define %struct.Memory* @routine_jbe_.L_401462(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i8* %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) {
block_400478:
  %3 = getelementptr inbounds %struct.State, %struct.State* %0, i32 0, i32 6
  %4 = getelementptr inbounds %struct.GPR, %struct.GPR* %3, i32 0, i32 33
  %5 = getelementptr inbounds %struct.Reg, %struct.Reg* %4, i32 0, i32 0
...
define %struct.Memory* @routine_movq__0x4017fa___rsi(%struct.State* dereferenceable(3376), i64, %struct.Memory*) {
block_400478:
  %3 = getelementptr inbounds %struct.State, %struct.State* %0, i32 0, i32 6
  %4 = getelementptr inbounds %struct.GPR, %struct.GPR* %3, i32 0, i32 33
  %5 = getelementptr inbounds %struct.Reg, %struct.Reg* %4, i32 0, i32 0
  ...
  %10 = add i64 %9, 10
  store i64 %10, i64* %PC
  store i64 ptrtoint (%G__0x4017fa_type* @G__0x4017fa to i64), i64* %RSI, align 8
  ret %struct.Memory* %2
}
...
define %struct.Memory* @routine_jmpq_.L_40148f(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i64 %rel_off1, i64 %rel_off2) {
block_400478:
  %3 = getelementptr inbounds %struct.State, %struct.State* %0, i32 0, i32 6
  %4 = getelementptr inbounds %struct.GPR, %struct.GPR* %3, i32 0, i32 33
  %5 = getelementptr inbounds %struct.Reg, %struct.Reg* %4, i32 0, i32 0
...
define %struct.Memory* @routine_jmpq_.L_4013ad(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i64 %rel_off1, i64 %rel_off2) {
block_400478:
  %3 = getelementptr inbounds %struct.State, %struct.State* %0, i32 0, i32 6
  %4 = getelementptr inbounds %struct.GPR, %struct.GPR* %3, i32 0, i32 33
  %5 = getelementptr inbounds %struct.Reg, %struct.Reg* %4, i32 0, i32 0
