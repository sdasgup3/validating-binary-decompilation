...
block_4013b9:                                     ; preds = %block_.L_4013ad
  ...
  %710 = load float, float* bitcast (%G_0x3ac__rip__type* @G_0x3ac__rip_ to float*)
  %711 = load float, float* inttoptr (i64 add (i64 ptrtoint (%G_0x3ac__rip__type* @G_0x3ac__rip_ to i64), i64 4) to float*)
  %712 = load float, float* inttoptr (i64 add (i64 ptrtoint (%G_0x3ac__rip__type* @G_0x3ac__rip_ to i64), i64 8) to float*)
  %713 = load float, float* inttoptr (i64 add (i64 ptrtoint (%G_0x3ac__rip__type* @G_0x3ac__rip_ to i64), i64 12) to float*)
...
block_400478:
  ...
  %9 = load i64, i64* %PC
  %10 = ptrtoint %G_0x3ac__rip__type* @G_0x3ac__rip_ to i64
  %11 = load i64, i64* %PC
  %12 = add i64 %11, 7
  store i64 %12, i64* %PC
