...
@G_0x428__rip__4199296_ = local_unnamed_addr global %G_0x428__rip__4199296__type zeroinitializer
...
entry:
  ...
  %42 = load i64, i64* bitcast (%G_0x428__rip__4199296__type* @G_0x428__rip__4199296_ to i64*), align 8
...
block_.L_40139a:                                  ; preds = %block_.L_401475, %entry
  %95 = phi i64 [ %.pre, %entry ], [ %457, %block_.L_401475 ]
  %MEMORY.0 = phi %struct.Memory* [ %2, %entry ], [ %MEMORY.1, %block_.L_401475 ]
  ...
  br i1 %131, label %block_4013a6, label %block_.L_401488
...
block_.L_4013ad:                                  ; preds = %block_.L_401462, %block_4013a6
  %136 = phi i64 [ %.pre3, %block_4013a6 ], [ %427, %block_.L_401462 ]
  %MEMORY.1 = phi %struct.Memory* [ %MEMORY.0, %block_4013a6 ], [ %336, %block_.L_401462 ]
  ...
  br i1 %172, label %block_4013b9, label %block_.L_401475
...
block_4013b9:                                     ; preds = %block_.L_4013ad
  ...
  %285 = load i32, i32* bitcast (%G_0x3ac__rip__4199428__type* @G_0x3ac__rip__4199428_ to i32*), align 8
  %286 = load i32, i32* inttoptr (i64 add (i64 ptrtoint (%G_0x3ac__rip__4199428__type* @G_0x3ac__rip__4199428_ to i64), i64 4) to i32*), align 4
  %287 = load i32, i32* inttoptr (i64 add (i64 ptrtoint (%G_0x3ac__rip__4199428__type* @G_0x3ac__rip__4199428_ to i64), i64 8) to i32*), align 8
  %288 = load i32, i32* inttoptr (i64 add (i64 ptrtoint (%G_0x3ac__rip__4199428__type* @G_0x3ac__rip__4199428_ to i64), i64 12) to i32*), align 4
...
routine_ucomisd_MINUS0x30__rbp____xmm0.exit:      ; preds = %334, %322
  ...
  br i1 %340, label %block_.L_401462, label %block_40141d
...
block_.L_40148f:                                  ; preds = %block_.L_401488, %block_40141d
  %461 = phi i64 [ %.pre5, %block_.L_401488 ], [ %396, %block_40141d ]
  %MEMORY.2 = phi %struct.Memory* [ %MEMORY.0, %block_.L_401488 ], [ %383, %block_40141d ]
...
block_400478:
  ...
  %5 = load i64, i64* bitcast (%G_0x428__rip__4199296__type* @G_0x428__rip__4199296_ to i64*), align 8
...
define %struct.Memory* @routine_jge_.L_401488(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i8* %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
...
define %struct.Memory* @routine_jge_.L_401475(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i8* %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 2, i32 9
...
define %struct.Memory* @routine_movaps_0x3ac__rip____xmm1(%struct.State* dereferenceable(3376), i64, %struct.Memory*) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  ...
  %6 = add i64 %5, 7
  store i64 %6, i64* %PC, align 8
  %7 = load i32, i32* bitcast (%G_0x3ac__rip__4199428__type* @G_0x3ac__rip__4199428_ to i32*), align 8
  %8 = load i32, i32* inttoptr (i64 add (i64 ptrtoint (%G_0x3ac__rip__4199428__type* @G_0x3ac__rip__4199428_ to i64), i64 4) to i32*), align 4
  %9 = load i32, i32* inttoptr (i64 add (i64 ptrtoint (%G_0x3ac__rip__4199428__type* @G_0x3ac__rip__4199428_ to i64), i64 8) to i32*), align 8
  %10 = load i32, i32* inttoptr (i64 add (i64 ptrtoint (%G_0x3ac__rip__4199428__type* @G_0x3ac__rip__4199428_ to i64), i64 12) to i32*), align 4
...
define %struct.Memory* @routine_jbe_.L_401462(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i8* %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
...
define %struct.Memory* @routine_movq__0x4017fa___rsi(%struct.State* dereferenceable(3376), i64, %struct.Memory*) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
...
define %struct.Memory* @routine_jmpq_.L_40148f(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
...
define %struct.Memory* @routine_jmpq_.L_401467(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
...
define %struct.Memory* @routine_jmpq_.L_4013ad(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
...
define %struct.Memory* @routine_jmpq_.L_40139a(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
