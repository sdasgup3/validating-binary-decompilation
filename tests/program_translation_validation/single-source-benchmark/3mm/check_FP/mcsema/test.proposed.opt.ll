...
block_.L_40139a:                                  ; preds = %block_.L_401475, %entry
  %96 = phi i64 [ %.pre, %entry ], [ %465, %block_.L_401475 ]
  ...
  br i1 %132, label %block_4013a6, label %block_.L_401488
...
block_.L_4013ad:                                  ; preds = %block_.L_401462, %block_4013a6
  %137 = phi i64 [ %.pre3, %block_4013a6 ], [ %434, %block_.L_401462 ]
  %MEMORY.1 = phi %struct.Memory* [ %MEMORY.0, %block_4013a6 ], [ %340, %block_.L_401462 ]
  ...
  br i1 %173, label %block_4013b9, label %block_.L_401475
...
block_4013b9:                                     ; preds = %block_.L_4013ad
  ...
  %288 = load i32, i32* bitcast (%G_0x3ac__rip__type* @G_0x3ac__rip_ to i32*), align 8
  %289 = load i32, i32* inttoptr (i64 add (i64 ptrtoint (%G_0x3ac__rip__type* @G_0x3ac__rip_ to i64), i64 4) to i32*), align 4
  %290 = load i32, i32* inttoptr (i64 add (i64 ptrtoint (%G_0x3ac__rip__type* @G_0x3ac__rip_ to i64), i64 8) to i32*), align 8
  %291 = load i32, i32* inttoptr (i64 add (i64 ptrtoint (%G_0x3ac__rip__type* @G_0x3ac__rip_ to i64), i64 12) to i32*), align 4
...
routine_ucomisd_MINUS0x30__rbp____xmm0.exit:      ; preds = %338, %326
  ...
  br i1 %344, label %block_.L_401462, label %block_40141d
...
block_.L_40148f:                                  ; preds = %block_.L_401488, %block_40141d
  %469 = phi i64 [ %.pre5, %block_.L_401488 ], [ %402, %block_40141d ]
  %MEMORY.2 = phi %struct.Memory* [ %MEMORY.0, %block_.L_401488 ], [ %389, %block_40141d ]
...
block_400478:
  ...
  %6 = add i64 %5, 7
  store i64 %6, i64* %PC, align 8
  %7 = load i32, i32* bitcast (%G_0x3ac__rip__type* @G_0x3ac__rip_ to i32*), align 8
  %8 = load i32, i32* inttoptr (i64 add (i64 ptrtoint (%G_0x3ac__rip__type* @G_0x3ac__rip_ to i64), i64 4) to i32*), align 4
  %9 = load i32, i32* inttoptr (i64 add (i64 ptrtoint (%G_0x3ac__rip__type* @G_0x3ac__rip_ to i64), i64 8) to i32*), align 8
  %10 = load i32, i32* inttoptr (i64 add (i64 ptrtoint (%G_0x3ac__rip__type* @G_0x3ac__rip_ to i64), i64 12) to i32*), align 4
