...
entry:
  ...
  %call2_400a7a = tail call %struct.Memory* @sub_400db0.kernel_3mm(%struct.State* %0, i64 %350, %struct.Memory* %call2_400a2c)
  ...
  %call2_400ac8 = tail call %struct.Memory* @sub_401090.kernel_3mm_StrictFP(%struct.State* %0, i64 %443, %struct.Memory* %call2_400a7a)
  ...
  %call2_400adb = tail call %struct.Memory* @sub_401370.check_FP(%struct.State* %0, i64 %468, %struct.Memory* %call2_400ac8)
  ...
  br i1 %480, label %block_400ae9, label %block_.L_400af5
...
block_.L_400af5:                                  ; preds = %entry
  ...
  %call2_400aff = tail call %struct.Memory* @sub_4014a0.print_array(%struct.State* %0, i64 %505, %struct.Memory* %call2_400adb)
  ...
  %521 = tail call %struct.Memory* @__remill_function_call(%struct.State* %0, i64 ptrtoint (i64 (i64)* @free to i64), %struct.Memory* %call2_400aff)
  ...
  %533 = tail call %struct.Memory* @__remill_function_call(%struct.State* %0, i64 ptrtoint (i64 (i64)* @free to i64), %struct.Memory* %521)
  ...
  %545 = tail call %struct.Memory* @__remill_function_call(%struct.State* %0, i64 ptrtoint (i64 (i64)* @free to i64), %struct.Memory* %533)
  ...
  %557 = tail call %struct.Memory* @__remill_function_call(%struct.State* %0, i64 ptrtoint (i64 (i64)* @free to i64), %struct.Memory* %545)
  ...
  %569 = tail call %struct.Memory* @__remill_function_call(%struct.State* %0, i64 ptrtoint (i64 (i64)* @free to i64), %struct.Memory* %557)
  ...
  %581 = tail call %struct.Memory* @__remill_function_call(%struct.State* %0, i64 ptrtoint (i64 (i64)* @free to i64), %struct.Memory* %569)
  ...
  %593 = tail call %struct.Memory* @__remill_function_call(%struct.State* %0, i64 ptrtoint (i64 (i64)* @free to i64), %struct.Memory* %581)
  ...
  %605 = tail call %struct.Memory* @__remill_function_call(%struct.State* %0, i64 ptrtoint (i64 (i64)* @free to i64), %struct.Memory* %593)
...
block_.L_400b6b:                                  ; preds = %block_.L_400af5, %block_400ae9
  %611 = phi i64 [ %.pre, %block_.L_400af5 ], [ %490, %block_400ae9 ]
  %MEMORY.0 = phi %struct.Memory* [ %605, %block_.L_400af5 ], [ %call2_400adb, %block_400ae9 ]
