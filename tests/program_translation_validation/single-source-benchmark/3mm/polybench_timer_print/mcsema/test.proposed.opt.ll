...
@G__0x4017c0 = global %G__0x4017c0_type zeroinitializer
...
entry:
  ...
  store i64 ptrtoint (%G__0x4017c0_type* @G__0x4017c0 to i64), i64* %RDI.i, align 8
...
define %struct.Memory* @routine_movq__0x4017c0___rdi(%struct.State* dereferenceable(3376), i64, %struct.Memory*) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  ...
  store i64 ptrtoint (%G__0x4017c0_type* @G__0x4017c0 to i64), i64* %RDI, align 8
  ret %struct.Memory* %2
}
