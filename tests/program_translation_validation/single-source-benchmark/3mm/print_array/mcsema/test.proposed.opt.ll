...
declare %struct.Memory* @sub_401590.print_element(%struct.State* noalias dereferenceable(3376), i64, %struct.Memory* noalias readnone returned) local_unnamed_addr
...
block_.L_4014ff:                                  ; preds = %block_.L_401555, %entry
  %132 = phi i64 [ %.pre, %entry ], [ %363, %block_.L_401555 ]
  %MEMORY.0 = phi %struct.Memory* [ %87, %entry ], [ %325, %block_.L_401555 ]
  ...
  br i1 %168, label %block_40150b, label %block_.L_401577
...
block_.L_401512:                                  ; preds = %block_40151e, %block_40150b
  %173 = phi i64 [ %314, %block_40151e ], [ %.pre9, %block_40150b ]
  ...
  br i1 %209, label %block_40151e, label %block_.L_401555
...
block_40151e:                                     ; preds = %block_.L_401512
  ...
  %call2_401542 = tail call %struct.Memory* @sub_401590.print_element(%struct.State* nonnull %0, i64 %278, %struct.Memory* %MEMORY.0)
