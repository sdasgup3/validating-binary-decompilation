...
entry:
  ...
  store i64 %75, i64* %RDI.i102, align 8
  %76 = add i64 %60, -3746
  %77 = add i64 %60, 17
  ...
  %81 = tail call %struct.Memory* @__remill_function_call(%struct.State* %0, i64 ptrtoint (i64 (i64)* @malloc to i64), %struct.Memory* %2)
  %82 = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 1, i32 0
  %RAX.i95 = getelementptr inbounds %union.anon, %union.anon* %82, i64 0, i32 0
  %83 = load i64, i64* %RBP.i, align 8
  %84 = add i64 %83, -32
  %85 = load i64, i64* %RAX.i95, align 8
  ...
  store i64 %94, i64* %RAX.i95, align 8
  %95 = add i64 %89, -8
  %96 = add i64 %91, 7
  ...
  store i64 %100, i64* %RSI.i108, align 8
  %101 = lshr i32 %98, 28
  ...
  store i64 %114, i64* %RDX.i111, align 8
  %115 = add i64 %114, %94
  %116 = add i64 %91, 17
  ...
  %EAX.i74 = bitcast %union.anon* %82 to i32*
...
block_.L_4014df:                                  ; preds = %block_.L_401535, %entry
  %125 = phi i64 [ %.pre, %entry ], [ %357, %block_.L_401535 ]
  %MEMORY.0 = phi %struct.Memory* [ %81, %entry ], [ %319, %block_.L_401535 ]
  ...
  store i64 %131, i64* %RAX.i95, align 8
  %132 = add i64 %126, -4
  %133 = add i64 %125, 6
  ...
  %161 = xor i1 %160, %158
  %.v = select i1 %161, i64 12, i64 120
  %162 = add i64 %125, %.v
  store i64 %162, i64* %3, align 8
  br i1 %161, label %block_4014eb, label %block_.L_401557
...
block_.L_4014f2:                                  ; preds = %block_4014fe, %block_4014eb
  %166 = phi i64 [ %.pre1, %block_4014eb ], [ %308, %block_4014fe ]
  ...
  store i64 %172, i64* %RAX.i95, align 8
  %173 = add i64 %167, -8
  %174 = add i64 %166, 6
  ...
  %202 = xor i1 %201, %199
  %.v2 = select i1 %202, i64 12, i64 67
  %203 = add i64 %166, %.v2
  store i64 %203, i64* %3, align 8
  br i1 %202, label %block_4014fe, label %block_.L_401535
...
block_4014fe:                                     ; preds = %block_.L_4014f2
  ...
  store i64 %207, i64* %RAX.i95, align 8
  %208 = add i64 %167, -20
  %209 = add i64 %203, 8
  ...
  %215 = and i64 %214, 1
  %216 = add i64 %213, %207
  store i64 %216, i64* %RAX.i95, align 8
  ...
  %242 = load i32, i32* %170, align 4
  %243 = sext i32 %242 to i64
  store i64 %243, i64* %RCX.i58, align 8
  ...
  store i64 %253, i64* %RDX.i111, align 8
  %254 = lshr i32 %251, 28
  ...
  store i64 %271, i64* %RSI.i108, align 8
  store i64 %253, i64* %RDI.i102, align 8
  %272 = add i64 %203, 114
  %273 = add i64 %203, 41
  ...
  %call2_401522 = tail call %struct.Memory* @sub_401570.print_element(%struct.State* %0, i64 %272, %struct.Memory* %MEMORY.1)
  ...
  store i64 %284, i64* %RAX.i95, align 8
...
block_.L_401535:                                  ; preds = %block_.L_4014f2
  ...
  store i64 %312, i64* %RDI.i102, align 8
  %313 = load i64, i64* bitcast (%G_0x602080_type* @G_0x602080 to i64*), align 8
  store i64 %313, i64* %RSI.i108, align 8
  %314 = add i64 %203, -3925
  %315 = add i64 %203, 17
  ...
  %319 = tail call %struct.Memory* @__remill_function_call(%struct.State* %0, i64 ptrtoint (i64 (i64, i64)* @fputs to i64), %struct.Memory* %MEMORY.1)
  %320 = load i64, i64* %RBP.i, align 8
  %321 = add i64 %320, -36
  %322 = load i32, i32* %EAX.i74, align 4
  ...
  store i64 %333, i64* %RAX.i95, align 8
