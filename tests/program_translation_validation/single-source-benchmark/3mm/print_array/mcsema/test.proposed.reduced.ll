; ModuleID = '/tmp/tmpy8188v07-query.ll'
...
entry:
  ...
  br i1 %var_2_16834, label %block_40151b.preheader, label %block_.L_401587

block_40151b.preheader:                           ; preds = %entry
  br label %block_40151b

block_40151b:                                     ; preds = %block_40151b.preheader, %block_.L_401565
  %var_2_1741 = phi i64 [ %var_2_133, %block_.L_401565 ], [ %var_2_13318, %block_40151b.preheader ]
  %MEMORY.035 = phi %struct.Memory* [ %var_2_325, %block_.L_401565 ], [ %var_2_87, %block_40151b.preheader ]
  ...
  br i1 %var_2_20917, label %block_40152e.preheader, label %block_.L_401565

block_40152e.preheader:                           ; preds = %block_40151b
  br label %block_40152e

block_40152e:                                     ; preds = %block_40152e.preheader, %block_40152e
  br label %block_40152e

block_.L_401565:                                  ; preds = %block_40151b
  ...
  br i1 %var_2_168, label %block_40151b, label %block_.L_401587.loopexit

block_.L_401587.loopexit:                         ; preds = %block_.L_401565
  br label %block_.L_401587

block_.L_401587:                                  ; preds = %block_.L_401587.loopexit, %entry
  %MEMORY.0.lcssa = phi %struct.Memory* [ %var_2_87, %entry ], [ %var_2_325, %block_.L_401587.loopexit ]
