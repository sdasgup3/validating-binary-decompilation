...
entry:
  ...
  store %struct.Memory* %loadMem_401605, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_401626, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_401662, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_401678, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_40167b, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_4016c3, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_4016cd, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_401707, %struct.Memory** %MEMORY
  ...
  ret %struct.Memory* %loadMem_40173a
}
