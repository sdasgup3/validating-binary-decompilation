...
entry:
  ...
  store %struct.Memory* %loadMem_401659, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_4016ec, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_401702, %struct.Memory** %MEMORY
  ...
  ret %struct.Memory* %loadMem_40174a
}
