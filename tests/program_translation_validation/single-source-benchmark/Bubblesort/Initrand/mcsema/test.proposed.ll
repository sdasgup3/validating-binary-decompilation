...
entry:
  ...
  ; Code: movq $0x12403, 0x60f238	 RIP: 400514	 Bytes: 12
  %loadMem_400514 = load %struct.Memory*, %struct.Memory** %MEMORY
  %call_400514 = call %struct.Memory* @routine_movq__0x12403__0x60f238(%struct.State* %0, i64  0, %struct.Memory* %loadMem_400514)
