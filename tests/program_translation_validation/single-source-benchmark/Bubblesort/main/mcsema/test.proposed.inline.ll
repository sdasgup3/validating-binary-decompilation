...
declare %struct.Memory* @sub_400670.Bubble(%struct.State* noalias dereferenceable(3376), i64, %struct.Memory* noalias readnone returned)
...
block_.L_4007b6:                                  ; preds = %block_4007c0, %entry
...
block_4007c0:                                     ; preds = %block_.L_4007b6
  ...
  store %struct.Memory* %loadMem1_4007c3, %struct.Memory** %MEMORY
  %loadMem2_4007c3 = load %struct.Memory*, %struct.Memory** %MEMORY
  %loadPC_4007c3 = load i64, i64* %3
  %call2_4007c3 = call %struct.Memory* @sub_400670.Bubble(%struct.State* %0, i64 %loadPC_4007c3, %struct.Memory* %loadMem2_4007c3)
...
block_.L_4007d6:                                  ; preds = %block_.L_4007b6
  ...
  ret %struct.Memory* %loadMem_4007dd
}
