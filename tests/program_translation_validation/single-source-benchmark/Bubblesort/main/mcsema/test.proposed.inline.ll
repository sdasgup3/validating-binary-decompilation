...
declare %struct.Memory* @sub_400650.Bubble(%struct.State* noalias dereferenceable(3376), i64, %struct.Memory* noalias readnone returned)
...
block_.L_400796:                                  ; preds = %block_4007a0, %entry
  ...
  %loadBr_40079a = load i8, i8* %BRANCH_TAKEN
  %cmpBr_40079a = icmp eq i8 %loadBr_40079a, 1
  br i1 %cmpBr_40079a, label %block_.L_4007b6, label %block_4007a0

block_4007a0:                                     ; preds = %block_.L_400796
  ...
  %loadMem1_4007a3 = load %struct.Memory*, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem1_4007a3, %struct.Memory** %MEMORY
  %loadMem2_4007a3 = load %struct.Memory*, %struct.Memory** %MEMORY
  %loadPC_4007a3 = load i64, i64* %3
  %call2_4007a3 = call %struct.Memory* @sub_400650.Bubble(%struct.State* %0, i64 %loadPC_4007a3, %struct.Memory* %loadMem2_4007a3)
  store %struct.Memory* %call2_4007a3, %struct.Memory** %MEMORY
...
block_.L_4007b6:                                  ; preds = %block_.L_400796
  ...
  ret %struct.Memory* %loadMem_4007bd
}
...
define %struct.Memory* @routine_jge_.L_4007b6(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i8* %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) {
block_400478:
  %3 = getelementptr inbounds %struct.State, %struct.State* %0, i32 0, i32 6
  %4 = getelementptr inbounds %struct.GPR, %struct.GPR* %3, i32 0, i32 33
  %5 = getelementptr inbounds %struct.Reg, %struct.Reg* %4, i32 0, i32 0
