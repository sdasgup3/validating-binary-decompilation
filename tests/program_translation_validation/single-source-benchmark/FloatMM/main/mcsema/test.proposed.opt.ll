...
block_.L_4007b6:                                  ; preds = %block_4007c3, %entry
  %48 = phi i64 [ %.pre, %entry ], [ %117, %block_4007c3 ]
  %MEMORY.0 = phi %struct.Memory* [ %2, %entry ], [ %call2_4007c6, %block_4007c3 ]
  ...
  br i1 %76, label %block_4007c3, label %block_.L_4007d9
...
block_4007c3:                                     ; preds = %block_.L_4007b6
  ...
  %call2_4007c6 = tail call %struct.Memory* @sub_400690.Mm(%struct.State* %0, i64 %81, %struct.Memory* %MEMORY.0)
...
define %struct.Memory* @routine_cmpl__0x1388__MINUS0x8__rbp_(%struct.State* dereferenceable(3376), i64, %struct.Memory*) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %RBP = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 15, i32 0, i32 0
  %3 = load i64, i64* %RBP, align 8
...
define %struct.Memory* @routine_jge_.L_4007d9(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i8* %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
