...
block_.L_4007d6:                                  ; preds = %block_4007e3, %entry
  %48 = phi i64 [ %.pre, %entry ], [ %117, %block_4007e3 ]
  %MEMORY.0 = phi %struct.Memory* [ %2, %entry ], [ %call2_4007e6, %block_4007e3 ]
...
block_4007e3:                                     ; preds = %block_.L_4007d6
  ...
  %call2_4007e6 = tail call %struct.Memory* @sub_4006b0.Mm(%struct.State* nonnull %0, i64 %81, %struct.Memory* %MEMORY.0)
