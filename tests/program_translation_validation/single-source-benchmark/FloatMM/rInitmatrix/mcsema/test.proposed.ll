...
; Data Access Globals
%G_0x2e9__rip__4195723__type = type <{ [16 x i8] }>
@G_0x2e9__rip__4195723_= global %G_0x2e9__rip__4195723__type <{ [16 x i8] c"\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00" }>
...
block_40057e:
  ...
  ; Code: movss 0x2e9(%rip), %xmm0	 RIP: 400583	 Bytes: 8
  %loadMem_400583 = load %struct.Memory*, %struct.Memory** %MEMORY
  %call_400583 = call %struct.Memory* @routine_movss_0x2e9__rip____xmm0(%struct.State* %0, i64  0, %struct.Memory* %loadMem_400583)
  ...
  ; Code: cvtsi2ssl %ecx, %xmm1	 RIP: 4005ac	 Bytes: 4
  %loadMem_4005ac = load %struct.Memory*, %struct.Memory** %MEMORY
  %call_4005ac = call %struct.Memory* @routine_cvtsi2ssl__ecx___xmm1(%struct.State* %0, i64  0, %struct.Memory* %loadMem_4005ac)
  store %struct.Memory* %call_4005ac, %struct.Memory** %MEMORY

  ; Code: divss %xmm0, %xmm1	 RIP: 4005b0	 Bytes: 4
  %loadMem_4005b0 = load %struct.Memory*, %struct.Memory** %MEMORY
  %call_4005b0 = call %struct.Memory* @routine_divss__xmm0___xmm1(%struct.State* %0, i64  0, %struct.Memory* %loadMem_4005b0)
  ...
  ; Code: imulq $0xa4, %rdi, %rdi	 RIP: 4005bc	 Bytes: 7
  %loadMem_4005bc = load %struct.Memory*, %struct.Memory** %MEMORY
  %call_4005bc = call %struct.Memory* @routine_imulq__0xa4___rdi___rdi(%struct.State* %0, i64  0, %struct.Memory* %loadMem_4005bc)
  ...
  ; Code: movss %xmm1, (%rsi,%rdi,4)	 RIP: 4005ca	 Bytes: 5
  %loadMem_4005ca = load %struct.Memory*, %struct.Memory** %MEMORY
  %call_4005ca = call %struct.Memory* @routine_movss__xmm1____rsi__rdi_4_(%struct.State* %0, i64  0, %struct.Memory* %loadMem_4005ca)
...
block_400478:
  ...
  %9 = load i64, i64* %PC
  %10 = ptrtoint %G_0x2e9__rip__4195723__type* @G_0x2e9__rip__4195723_ to i64
  %11 = load i64, i64* %PC
  %12 = add i64 %11, 8
  store i64 %12, i64* %PC
