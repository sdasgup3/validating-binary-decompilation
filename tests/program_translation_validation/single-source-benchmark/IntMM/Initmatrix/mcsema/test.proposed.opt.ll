...
block_.L_400593:                                  ; preds = %block_.L_4005fb, %entry
  %52 = phi i64 [ %.pre, %entry ], [ %317, %block_.L_4005fb ]
  %MEMORY.0 = phi %struct.Memory* [ %2, %entry ], [ %MEMORY.1, %block_.L_4005fb ]
  ...
  br i1 %.demorgan, label %block_40059d, label %block_.L_40060e
...
block_.L_4005a4:                                  ; preds = %routine_idivl__ecx.exit, %block_40059d
  %85 = phi i64 [ %.pre4, %block_40059d ], [ %287, %routine_idivl__ecx.exit ]
  %MEMORY.1 = phi %struct.Memory* [ %MEMORY.0, %block_40059d ], [ %162, %routine_idivl__ecx.exit ]
  ...
  %113 = xor i1 %112, %110
  %.demorgan7 = or i1 %103, %113
  %.v = select i1 %.demorgan7, i64 10, i64 87
  %114 = add i64 %85, %.v
  store i64 %114, i64* %3, align 8
  br i1 %.demorgan7, label %block_4005ae, label %block_.L_4005fb
...
block_4005ae:                                     ; preds = %block_.L_4005a4
  ...
  %call2_4005ae = tail call %struct.Memory* @sub_400540.Rand(%struct.State* nonnull %0, i64 %115, %struct.Memory* %MEMORY.1)
  %120 = load i64, i64* %3, align 8
  store i64 120, i64* %RCX.i67, align 8
  %121 = load i64, i64* %RBP.i, align 8
  %122 = add i64 %121, -12
  %123 = load i32, i32* %EAX.i64, align 4
  %124 = add i64 %120, 8
  ...
  store i64 %132, i64* %RAX.i61, align 8
  %133 = add i64 %128, 6
  ...
  %139 = load i32, i32* %EDX.i, align 4
  %140 = zext i32 %139 to i64
  %141 = load i64, i64* %3, align 8
  store i64 %140, i64* %RAX.i61, align 8
  %142 = sext i32 %139 to i64
  %143 = lshr i64 %142, 32
  store i64 %143, i64* %51, align 8
  %144 = load i32, i32* %ECX.i48, align 4
  %145 = add i64 %141, 5
...
routine_idivl__ecx.exit:                          ; preds = %155, %153
  ...
  store i64 %166, i64* %RAX.i61, align 8
  ...
  store i64 %250, i64* %RDI.i80, align 8
  %251 = shl nsw i64 %250, 2
  %252 = add i64 %251, %219
  %253 = load i32, i32* %ECX.i48, align 4
  %254 = add i64 %160, 36
  ...
  store i64 %263, i64* %RAX.i61, align 8
...
block_.L_4005fb:                                  ; preds = %block_.L_4005a4
  ...
  store i64 %293, i64* %RAX.i61, align 8
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_jg_.L_40060e(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i8* nocapture %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_jg_.L_4005fb(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i8* nocapture %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 2, i32 7
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_jmpq_.L_400600(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
