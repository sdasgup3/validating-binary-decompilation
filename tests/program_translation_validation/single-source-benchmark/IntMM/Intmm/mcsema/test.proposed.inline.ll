...
block_.L_4006d5:                                  ; preds = %block_.L_400749, %entry
...
block_.L_400749:                                  ; preds = %block_.L_400744
...
block_.L_400757:                                  ; preds = %block_.L_4006d5
  ...
  store i64 4196452, i64* %RDI.i, align 8
  ...
  store i64 6328992, i64* %RAX.i33, align 8
  ...
  store %struct.Memory* %loadMem1_40078c, %struct.Memory** %MEMORY
  %loadMem2_40078c = load %struct.Memory*, %struct.Memory** %MEMORY
  %loadPC_40078c = load i64, i64* %3
  %1015 = call %struct.Memory* @__remill_function_call(%struct.State* %0, i64 ptrtoint (i64 (i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64)* @printf to i64), %struct.Memory* %loadMem2_40078c)
  ...
  ret %struct.Memory* %loadMem_400799
}
