...
declare %struct.Memory* @sub_400680.Intmm(%struct.State* noalias dereferenceable(3376), i64, %struct.Memory* noalias readnone returned) local_unnamed_addr
...
block_.L_400796:                                  ; preds = %block_4007a0, %entry
  %48 = phi i64 [ %.pre, %entry ], [ %118, %block_4007a0 ]
  %MEMORY.0 = phi %struct.Memory* [ %2, %entry ], [ %call2_4007a3, %block_4007a0 ]
  ...
  br i1 %76, label %block_4007a0, label %block_.L_4007b6
...
block_4007a0:                                     ; preds = %block_.L_400796
  ...
  %call2_4007a3 = tail call %struct.Memory* @sub_400680.Intmm(%struct.State* %0, i64 %81, %struct.Memory* %MEMORY.0)
...
define %struct.Memory* @routine_jge_.L_4007b6(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i8* %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
...
define %struct.Memory* @routine_callq_.Intmm(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
