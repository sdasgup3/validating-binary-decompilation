...
declare %struct.Memory* @sub_4006b0.Intmm(%struct.State* noalias dereferenceable(3376), i64, %struct.Memory* noalias readnone returned) local_unnamed_addr
...
block_.L_4007c6:                                  ; preds = %block_4007d0, %entry
  %48 = phi i64 [ %117, %block_4007d0 ], [ %.pre, %entry ]
  ...
  br i1 %76, label %block_4007d0, label %block_.L_4007e6
...
block_4007d0:                                     ; preds = %block_.L_4007c6
  ...
  %call2_4007d3 = tail call %struct.Memory* @sub_4006b0.Intmm(%struct.State* nonnull %0, i64 %81, %struct.Memory* %2)
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_jge_.L_4007e6(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i8* nocapture %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
