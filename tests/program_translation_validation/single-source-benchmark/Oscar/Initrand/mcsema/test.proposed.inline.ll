...
define %struct.Memory* @Initrand(%struct.State* noalias, i64, %struct.Memory* noalias) #2 {
entry:
  ...
  store i64 74755, i64* bitcast (%G_0x610238_type* @G_0x610238 to i64*)
  ...
  ret %struct.Memory* %loadMem_400531
}
...
define %struct.Memory* @routine_movq__0x12403__0x610238(%struct.State* dereferenceable(3376), i64, %struct.Memory*) {
block_400488:
  %3 = getelementptr inbounds %struct.State, %struct.State* %0, i32 0, i32 6
  %4 = getelementptr inbounds %struct.GPR, %struct.GPR* %3, i32 0, i32 33
  %5 = getelementptr inbounds %struct.Reg, %struct.Reg* %4, i32 0, i32 0
