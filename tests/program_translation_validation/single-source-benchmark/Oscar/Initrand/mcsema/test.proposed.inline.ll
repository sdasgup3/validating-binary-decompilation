...
define %struct.Memory* @Initrand(%struct.State* noalias, i64, %struct.Memory* noalias) #1 {
entry:
  ...
  store i64 74755, i64* inttoptr (i64 6357560 to i64*)
  ...
  ret %struct.Memory* %loadMem_400521
}
