...
@G_0x610238= global %G_0x610238_type <{ [8 x i8] c"\00\00\00\00\00\00\00\00" }>
...
entry:
  ...
  ; Code: movq $0x12403, 0x610238	 RIP: 4004f4	 Bytes: 12
  %loadMem_4004f4 = load %struct.Memory*, %struct.Memory** %MEMORY
  %call_4004f4 = call %struct.Memory* @routine_movq__0x12403__0x610238(%struct.State* %0, i64  0, %struct.Memory* %loadMem_4004f4)
...
block_400478:
  ...
  %7 = add i64 %6, 12
  store i64 %7, i64* %PC
  %8 = call %struct.Memory* @_ZN12_GLOBAL__N_1L3MOVI3MnWImE2InImEEEP6MemoryS6_R5StateT_T0_(%struct.Memory* %2, %struct.State* %0, i64 ptrtoint( %G_0x610238_type* @G_0x610238 to i64), i64 74755)
  ret %struct.Memory* %8
}
