...
entry:
  ...
  store i64 74755, i64* inttoptr (i64 6357560 to i64*), align 8
  %11 = add i64 %10, 16
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_movq__0x12403__0x610238(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned) local_unnamed_addr #1 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
