...
define %struct.Memory* @Min0(%struct.State* noalias, i64, %struct.Memory* noalias readnone returned) local_unnamed_addr #1 {
entry:
  ...
  %ESI.i24 = bitcast %union.anon* %16 to i32*
  %17 = load i64, i64* %RBP.i, align 8
  %18 = add i64 %17, -12
  %19 = load i32, i32* %ESI.i24, align 4
...
block_.L_400671:                                  ; preds = %entry
  ...
  store i64 %76, i64* %RAX.i9, align 8
  %77 = add i64 %23, -4
  %78 = add i64 %66, 6
...
block_.L_400677:                                  ; preds = %block_.L_400671, %block_400666
  %80 = phi i64 [ %.pre, %block_.L_400671 ], [ %74, %block_400666 ]
...
define %struct.Memory* @routine_cmpl_MINUS0xc__rbp____esi(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned) local_unnamed_addr #3 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 9, i32 0
  %ESI = bitcast %union.anon* %3 to i32*
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_jmpq_.L_400677(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
