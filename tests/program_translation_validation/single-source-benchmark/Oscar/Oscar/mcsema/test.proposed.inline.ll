...
block_400d0c:                                     ; preds = %block_.L_400cff
  ...
  %320 = load float, float* bitcast (%G_0x1ad__rip__type* @G_0x1ad__rip_ to float*)
  ...
  %337 = load float, float* bitcast (%G_0x1a9__rip__type* @G_0x1a9__rip_ to float*)
...
block_400478:
  ...
  %9 = load i64, i64* %PC
  %10 = ptrtoint %G_0x1ad__rip__type* @G_0x1ad__rip_ to i64
  %11 = load i64, i64* %PC
  %12 = add i64 %11, 8
  store i64 %12, i64* %PC
