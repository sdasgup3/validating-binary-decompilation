...
block_400dbd:                                     ; preds = %block_.L_400db3
  ...
  %282 = load i32, i32* inttoptr (i64 add (i64 ptrtoint (%G_0x114__rip__type* @G_0x114__rip_ to i64), i64 76) to i32*), align 4
