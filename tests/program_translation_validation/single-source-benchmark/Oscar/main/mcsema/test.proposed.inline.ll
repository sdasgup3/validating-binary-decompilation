...
declare %struct.Memory* @sub_400cd0.Oscar(%struct.State* noalias dereferenceable(3376), i64, %struct.Memory* noalias readnone returned)
...
block_.L_400e36:                                  ; preds = %block_400e40, %entry
  ...
  br i1 %cmpBr_400e3a, label %block_.L_400e53, label %block_400e40

block_400e40:                                     ; preds = %block_.L_400e36
  ...
  %call2_400e40 = call %struct.Memory* @sub_400cd0.Oscar(%struct.State* %0, i64 %loadPC_400e40, %struct.Memory* %loadMem2_400e40)
...
block_.L_400e53:                                  ; preds = %block_.L_400e36
  ...
  ret %struct.Memory* %loadMem_400e5a
}
...
define %struct.Memory* @routine_jge_.L_400e53(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i8* %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) {
block_400478:
  %3 = getelementptr inbounds %struct.State, %struct.State* %0, i32 0, i32 6
  %4 = getelementptr inbounds %struct.GPR, %struct.GPR* %3, i32 0, i32 33
  %5 = getelementptr inbounds %struct.Reg, %struct.Reg* %4, i32 0, i32 0
