...
declare %struct.Memory* @sub_400ce0.Oscar(%struct.State* dereferenceable(3376), i64, %struct.Memory*) local_unnamed_addr
...
block_.L_400e46:                                  ; preds = %block_400e50, %entry
  %48 = phi i64 [ %.pre, %entry ], [ %114, %block_400e50 ]
  %MEMORY.0 = phi %struct.Memory* [ %2, %entry ], [ %call2_400e50, %block_400e50 ]
  ...
  br i1 %76, label %block_400e50, label %block_.L_400e63
...
block_400e50:                                     ; preds = %block_.L_400e46
  ...
  %call2_400e50 = tail call %struct.Memory* @sub_400ce0.Oscar(%struct.State* nonnull %0, i64 %78, %struct.Memory* %MEMORY.0)
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_jge_.L_400e63(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i8* nocapture %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_callq_.Oscar(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
