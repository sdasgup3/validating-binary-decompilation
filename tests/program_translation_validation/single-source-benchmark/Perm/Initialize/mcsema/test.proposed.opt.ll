...
define %struct.Memory* @Initialize(%struct.State* noalias, i64, %struct.Memory* noalias) local_unnamed_addr #1 {
entry:
...
block_.L_40058b:                                  ; preds = %block_400595, %entry
  %20 = phi i64 [ %112, %block_400595 ], [ %.pre, %entry ]
  ...
  br i1 %.demorgan, label %block_400595, label %block_.L_4005b4

block_400595:                                     ; preds = %block_.L_40058b
  %50 = add i64 %49, 3
...
block_.L_4005b4:                                  ; preds = %block_.L_40058b
  %113 = add i64 %49, 1
...
define %struct.Memory* @routine_jg_.L_4005b4(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i8* %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
...
define %struct.Memory* @routine_movl__eax__0x616750___rcx_4_(%struct.State* dereferenceable(3376), i64, %struct.Memory*) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
...
define %struct.Memory* @routine_jmpq_.L_40058b(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
