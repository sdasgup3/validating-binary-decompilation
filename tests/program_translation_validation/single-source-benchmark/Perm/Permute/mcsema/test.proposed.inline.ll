...
declare %struct.Memory* @sub_4005e0.Permute(%struct.State* dereferenceable(3376), i64, %struct.Memory*)

declare %struct.Memory* @sub_400570.Swap(%struct.State* dereferenceable(3376), i64, %struct.Memory*)
