...
entry:
  ...
  ; Code: movq %rsi, -0x10(%rbp)	 RIP: 400558	 Bytes: 4
  %loadMem_400558 = load %struct.Memory*, %struct.Memory** %MEMORY
  %call_400558 = call %struct.Memory* @routine_movq__rsi__MINUS0x10__rbp_(%struct.State* %0, i64  0, %struct.Memory* %loadMem_400558)
  store %struct.Memory* %call_400558, %struct.Memory** %MEMORY

  ; Code: movq -0x8(%rbp), %rsi	 RIP: 40055c	 Bytes: 4
  %loadMem_40055c = load %struct.Memory*, %struct.Memory** %MEMORY
  %call_40055c = call %struct.Memory* @routine_movq_MINUS0x8__rbp____rsi(%struct.State* %0, i64  0, %struct.Memory* %loadMem_40055c)
  store %struct.Memory* %call_40055c, %struct.Memory** %MEMORY

  ; Code: movl (%rsi), %eax	 RIP: 400560	 Bytes: 2
  %loadMem_400560 = load %struct.Memory*, %struct.Memory** %MEMORY
  %call_400560 = call %struct.Memory* @routine_movl___rsi____eax(%struct.State* %0, i64  0, %struct.Memory* %loadMem_400560)
  store %struct.Memory* %call_400560, %struct.Memory** %MEMORY

  ; Code: movl %eax, -0x14(%rbp)	 RIP: 400562	 Bytes: 3
  %loadMem_400562 = load %struct.Memory*, %struct.Memory** %MEMORY
  %call_400562 = call %struct.Memory* @routine_movl__eax__MINUS0x14__rbp_(%struct.State* %0, i64  0, %struct.Memory* %loadMem_400562)
  store %struct.Memory* %call_400562, %struct.Memory** %MEMORY

  ; Code: movq -0x10(%rbp), %rsi	 RIP: 400565	 Bytes: 4
  %loadMem_400565 = load %struct.Memory*, %struct.Memory** %MEMORY
  %call_400565 = call %struct.Memory* @routine_movq_MINUS0x10__rbp____rsi(%struct.State* %0, i64  0, %struct.Memory* %loadMem_400565)
  store %struct.Memory* %call_400565, %struct.Memory** %MEMORY

  ; Code: movl (%rsi), %eax	 RIP: 400569	 Bytes: 2
  %loadMem_400569 = load %struct.Memory*, %struct.Memory** %MEMORY
  %call_400569 = call %struct.Memory* @routine_movl___rsi____eax(%struct.State* %0, i64  0, %struct.Memory* %loadMem_400569)
  store %struct.Memory* %call_400569, %struct.Memory** %MEMORY

  ; Code: movq -0x8(%rbp), %rsi	 RIP: 40056b	 Bytes: 4
  %loadMem_40056b = load %struct.Memory*, %struct.Memory** %MEMORY
  %call_40056b = call %struct.Memory* @routine_movq_MINUS0x8__rbp____rsi(%struct.State* %0, i64  0, %struct.Memory* %loadMem_40056b)
  store %struct.Memory* %call_40056b, %struct.Memory** %MEMORY

  ; Code: movl %eax, (%rsi)	 RIP: 40056f	 Bytes: 2
  %loadMem_40056f = load %struct.Memory*, %struct.Memory** %MEMORY
  %call_40056f = call %struct.Memory* @routine_movl__eax____rsi_(%struct.State* %0, i64  0, %struct.Memory* %loadMem_40056f)
  store %struct.Memory* %call_40056f, %struct.Memory** %MEMORY

  ; Code: movl -0x14(%rbp), %eax	 RIP: 400571	 Bytes: 3
  %loadMem_400571 = load %struct.Memory*, %struct.Memory** %MEMORY
  %call_400571 = call %struct.Memory* @routine_movl_MINUS0x14__rbp____eax(%struct.State* %0, i64  0, %struct.Memory* %loadMem_400571)
  store %struct.Memory* %call_400571, %struct.Memory** %MEMORY

  ; Code: movq -0x10(%rbp), %rsi	 RIP: 400574	 Bytes: 4
  %loadMem_400574 = load %struct.Memory*, %struct.Memory** %MEMORY
  %call_400574 = call %struct.Memory* @routine_movq_MINUS0x10__rbp____rsi(%struct.State* %0, i64  0, %struct.Memory* %loadMem_400574)
  store %struct.Memory* %call_400574, %struct.Memory** %MEMORY

  ; Code: movl %eax, (%rsi)	 RIP: 400578	 Bytes: 2
  %loadMem_400578 = load %struct.Memory*, %struct.Memory** %MEMORY
  %call_400578 = call %struct.Memory* @routine_movl__eax____rsi_(%struct.State* %0, i64  0, %struct.Memory* %loadMem_400578)
