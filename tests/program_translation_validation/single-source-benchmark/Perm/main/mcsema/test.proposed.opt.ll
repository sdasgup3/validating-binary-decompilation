...
declare %struct.Memory* @sub_4006b0.Perm(%struct.State* noalias dereferenceable(3376), i64, %struct.Memory* noalias readnone returned) local_unnamed_addr
...
block_.L_400756:                                  ; preds = %block_400760, %entry
  %48 = phi i64 [ %114, %block_400760 ], [ %.pre, %entry ]
...
block_400760:                                     ; preds = %block_.L_400756
  ...
  %call2_400760 = tail call %struct.Memory* @sub_4006b0.Perm(%struct.State* nonnull %0, i64 %78, %struct.Memory* %2)
