...
declare %struct.Memory* @sub_400690.Perm(%struct.State* noalias dereferenceable(3376), i64, %struct.Memory* noalias readnone returned) local_unnamed_addr
...
block_.L_400736:                                  ; preds = %block_400740, %entry
  %48 = phi i64 [ %.pre, %entry ], [ %115, %block_400740 ]
  %MEMORY.0 = phi %struct.Memory* [ %2, %entry ], [ %call2_400740, %block_400740 ]
  ...
  br i1 %76, label %block_400740, label %block_.L_400753

block_400740:                                     ; preds = %block_.L_400736
  %78 = add i64 %77, -176
  %79 = add i64 %77, 5
  ...
  %call2_400740 = tail call %struct.Memory* @sub_400690.Perm(%struct.State* %0, i64 %78, %struct.Memory* %MEMORY.0)
...
block_.L_400753:                                  ; preds = %block_.L_400736
  store i64 0, i64* %RAX.i13, align 8
  %116 = load i64, i64* %RSP.i26, align 8
  %117 = add i64 %116, 16
  store i64 %117, i64* %RSP.i26, align 8
...
define %struct.Memory* @routine_jge_.L_400753(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i8* %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
...
define %struct.Memory* @routine_callq_.Perm(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
