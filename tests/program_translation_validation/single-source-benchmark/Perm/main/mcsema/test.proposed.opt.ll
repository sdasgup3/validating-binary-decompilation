...
declare %struct.Memory* @sub_4006c0.Perm(%struct.State* noalias dereferenceable(3376), i64, %struct.Memory* noalias readnone returned) local_unnamed_addr
...
block_.L_400766:                                  ; preds = %block_400770, %entry
  %48 = phi i64 [ %114, %block_400770 ], [ %.pre, %entry ]
  ...
  br i1 %76, label %block_400770, label %block_.L_400783

block_400770:                                     ; preds = %block_.L_400766
  %78 = add i64 %77, -176
  %79 = add i64 %77, 5
  ...
  %call2_400770 = tail call %struct.Memory* @sub_4006c0.Perm(%struct.State* nonnull %0, i64 %78, %struct.Memory* %2)
...
block_.L_400783:                                  ; preds = %block_.L_400766
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_jge_.L_400783(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i8* nocapture %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_jmpq_.L_400766(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
