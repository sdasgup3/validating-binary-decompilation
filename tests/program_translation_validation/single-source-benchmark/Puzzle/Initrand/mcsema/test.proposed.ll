...
@G_0x610238= global %G_0x610238_type <{ [4 x i8] c"\00\00\00\00" }>
...
entry:
  ...
  ; Code: movq $0x12403, 0x610238	 RIP: 400524	 Bytes: 12
  %loadMem_400524 = load %struct.Memory*, %struct.Memory** %MEMORY
  %call_400524 = call %struct.Memory* @routine_movq__0x12403__0x610238(%struct.State* %0, i64  0, %struct.Memory* %loadMem_400524)
