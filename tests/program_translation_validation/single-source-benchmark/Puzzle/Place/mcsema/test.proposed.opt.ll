...
define %struct.Memory* @Place(%struct.State* noalias, i64, %struct.Memory* noalias) local_unnamed_addr #1 {
entry:
...
block_.L_4005f1:                                  ; preds = %block_.L_40063c, %entry
  %34 = phi i64 [ %196, %block_.L_40063c ], [ %.pre, %entry ]
  ...
  br i1 %.demorgan, label %block_400605, label %block_.L_40064f
...
block_400605:                                     ; preds = %block_.L_4005f1
  ...
  store i64 %84, i64* %RAX.i101, align 8
  ...
  %.v5 = select i1 %121, i64 55, i64 35
  %125 = add i64 %77, %.v5
  store i64 %125, i64* %3, align 8
  br i1 %121, label %block_.L_40063c, label %block_400628
...
block_.L_40063c:                                  ; preds = %block_400628, %block_400605
  %165 = phi i64 [ %.pre2, %block_400628 ], [ %35, %block_400605 ]
  %166 = phi i64 [ %.pre1, %block_400628 ], [ %125, %block_400605 ]
  %167 = add i64 %165, -16
  %168 = add i64 %166, 8
...
block_.L_40067e:                                  ; preds = %block_.L_4006a8, %block_.L_40064f
  %256 = phi i64 [ %340, %block_.L_4006a8 ], [ %.pre3, %block_.L_40064f ]
  ...
  %285 = xor i1 %284, %282
  %.demorgan6 = or i1 %275, %285
  %.v7 = select i1 %.demorgan6, i64 13, i64 61
  %286 = add i64 %256, %.v7
  store i64 %286, i64* %3, align 8
  br i1 %.demorgan6, label %block_40068b, label %block_.L_4006bb
...
block_40068b:                                     ; preds = %block_.L_40067e
  ...
  store i8 0, i8* %33, align 1
  %.v8 = select i1 %300, i64 18, i64 29
  %304 = add i64 %286, %.v8
  store i64 %304, i64* %3, align 8
  br i1 %300, label %block_40069d, label %block_.L_4006a8
...
block_.L_4006c2:                                  ; preds = %block_.L_4006bb, %block_40069d
  %344 = phi i64 [ %.pre4, %block_.L_4006bb ], [ %312, %block_40069d ]
...
define %struct.Memory* @routine_jg_.L_40064f(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i8* %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
...
define %struct.Memory* @routine_je_.L_40063c(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i8* %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 2, i32 7
...
define %struct.Memory* @routine_movl__0x1__0x60df50___rcx_4_(%struct.State* dereferenceable(3376), i64, %struct.Memory*) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %RCX = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 5, i32 0, i32 0
  %3 = load i64, i64* %RCX, align 8
...
define %struct.Memory* @routine_jg_.L_4006bb(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i8* %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 2, i32 7
...
define %struct.Memory* @routine_cmpl__0x0__0x60df50___rax_4_(%struct.State* dereferenceable(3376), i64, %struct.Memory*) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %RAX = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 1, i32 0, i32 0
  %3 = load i64, i64* %RAX, align 8
...
define %struct.Memory* @routine_jne_.L_4006a8(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i8* %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 2, i32 7
...
define %struct.Memory* @routine_jmpq_.L_4006c2(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
...
define %struct.Memory* @routine_jmpq_.L_4006ad(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
...
define %struct.Memory* @routine_jmpq_.L_40067e(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
