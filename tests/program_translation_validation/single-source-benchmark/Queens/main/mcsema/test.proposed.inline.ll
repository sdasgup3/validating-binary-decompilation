...
declare %struct.Memory* @sub_4007b0.Queens(%struct.State* noalias dereferenceable(3376), i64, %struct.Memory* noalias readnone returned)
...
block_.L_400826:                                  ; preds = %block_400830, %entry
  ...
  br i1 %cmpBr_40082a, label %block_.L_400846, label %block_400830

block_400830:                                     ; preds = %block_.L_400826
  ...
  %call2_400833 = call %struct.Memory* @sub_4007b0.Queens(%struct.State* %0, i64 %loadPC_400833, %struct.Memory* %loadMem2_400833)
...
block_.L_400846:                                  ; preds = %block_.L_400826
  ...
  ret %struct.Memory* %loadMem_40084d
}
...
define %struct.Memory* @routine_jge_.L_400846(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i8* %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) {
block_400478:
  %3 = getelementptr inbounds %struct.State, %struct.State* %0, i32 0, i32 6
  %4 = getelementptr inbounds %struct.GPR, %struct.GPR* %3, i32 0, i32 33
  %5 = getelementptr inbounds %struct.Reg, %struct.Reg* %4, i32 0, i32 0
