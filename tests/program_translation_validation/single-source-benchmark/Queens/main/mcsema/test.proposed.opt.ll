...
declare %struct.Memory* @sub_4007b0.Queens(%struct.State* noalias dereferenceable(3376), i64, %struct.Memory* noalias readnone returned) local_unnamed_addr
...
block_400830:                                     ; preds = %block_.L_400826
  ...
  %call2_400833 = tail call %struct.Memory* @sub_4007b0.Queens(%struct.State* %0, i64 %81, %struct.Memory* %MEMORY.0)
...
define %struct.Memory* @routine_callq_.Queens(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
