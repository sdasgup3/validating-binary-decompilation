...
declare %struct.Memory* @sub_4007d0.Queens(%struct.State* noalias dereferenceable(3376), i64, %struct.Memory* noalias) local_unnamed_addr
...
block_400850:                                     ; preds = %block_.L_400846
  ...
  %call2_400853 = tail call %struct.Memory* @sub_4007d0.Queens(%struct.State* nonnull %0, i64 %81, %struct.Memory* %MEMORY.0)
