...
declare %struct.Memory* @sub_4007e0.Queens(%struct.State* noalias dereferenceable(3376), i64, %struct.Memory* noalias readnone returned) local_unnamed_addr
...
block_400860:                                     ; preds = %block_.L_400856
  ...
  %call2_400863 = tail call %struct.Memory* @sub_4007e0.Queens(%struct.State* nonnull %0, i64 %81, %struct.Memory* %2)
