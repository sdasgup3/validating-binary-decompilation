...
block_.L_40057a:                                  ; preds = %block_.L_40062b, %entry
  %51 = phi i64 [ %.pre, %entry ], [ %296, %block_.L_40062b ]
...
routine_idivq__rdi.exit:                          ; preds = %131, %129
  ...
  %188 = load i32, i32* bitcast (%G_0x61677c_type* @G_0x61677c to i32*), align 8
  %189 = sub i32 %186, %188
  ...
  br i1 %215, label %block_.L_4005fc, label %block_4005e5

block_4005e5:                                     ; preds = %routine_idivq__rdi.exit
  store i32 %224, i32* bitcast (%G_0x61677c_type* @G_0x61677c to i32*), align 8
  %227 = add i64 %216, 70
  br label %block_.L_40062b

block_.L_4005fc:                                  ; preds = %routine_idivq__rdi.exit
  %228 = load i32, i32* bitcast (%G_0x615b14_type* @G_0x615b14 to i32*), align 8
  %229 = sub i32 %224, %228
  ...
  br i1 %254, label %block_400614, label %block_.L_400626
...
block_400614:                                     ; preds = %block_.L_4005fc
  ...
  store i32 %263, i32* bitcast (%G_0x615b14_type* @G_0x615b14 to i32*), align 8
  br label %block_.L_400626

block_.L_400626:                                  ; preds = %block_.L_4005fc, %block_400614
  %266 = phi i64 [ %265, %block_400614 ], [ %255, %block_.L_4005fc ]
  %267 = add i64 %266, 5
  br label %block_.L_40062b

block_.L_40062b:                                  ; preds = %block_.L_400626, %block_4005e5
  %.sink = phi i64 [ %267, %block_.L_400626 ], [ %227, %block_4005e5 ]
  %268 = add i64 %.sink, 8
