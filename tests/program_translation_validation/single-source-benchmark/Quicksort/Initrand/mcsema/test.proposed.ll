...
entry:
  ...
  ; Code: movq $0x12403, 0x60f238	 RIP: 400524	 Bytes: 12
  %loadMem_400524 = load %struct.Memory*, %struct.Memory** %MEMORY
  %call_400524 = call %struct.Memory* @routine_movq__0x12403__0x60f238(%struct.State* %0, i64  0, %struct.Memory* %loadMem_400524)
