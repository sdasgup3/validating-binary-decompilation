...
block_.L_4007d1:                                  ; preds = %block_4007bd, %entry
  ...
  store i64 ptrtoint (%G__0x4008d4_type* @G__0x4008d4 to i64), i64* %RDI.i30, align 8
  ...
  %297 = call %struct.Memory* @__remill_function_call(%struct.State* %0, i64 ptrtoint (i64 (i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64)* @printf to i64), %struct.Memory* %loadMem2_4007dd)
...
block_.L_4007e5:                                  ; preds = %block_.L_4007d1, %block_4007bd
  ...
  store i64 ptrtoint (%G__0x4008e6_type* @G__0x4008e6 to i64), i64* %RDI.i, align 8
  ...
  %435 = call %struct.Memory* @__remill_function_call(%struct.State* %0, i64 ptrtoint (i64 (i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64)* @printf to i64), %struct.Memory* %loadMem2_400801)
  ...
  ret %struct.Memory* %loadMem_40080e
}
...
define %struct.Memory* @routine_movq__0x4008e6___rdi(%struct.State* dereferenceable(3376), i64, %struct.Memory*) {
block_400478:
  %3 = getelementptr inbounds %struct.State, %struct.State* %0, i32 0, i32 6
  %4 = getelementptr inbounds %struct.GPR, %struct.GPR* %3, i32 0, i32 33
  %5 = getelementptr inbounds %struct.Reg, %struct.Reg* %4, i32 0, i32 0
