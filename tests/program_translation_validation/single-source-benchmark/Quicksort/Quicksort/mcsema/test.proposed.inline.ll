...
; <label>:350:                                    ; preds = %entry
  ...
  %353 = call %struct.Memory* @__remill_error(%struct.State* nonnull dereferenceable(3376) %0, i64 %352, %struct.Memory* %loadMem_400686)
...
routine_idivl__esi.exit:                          ; preds = %350, %354
  %366 = phi %struct.Memory* [ %353, %350 ], [ %loadMem_400686, %354 ]
...
block_.L_400691:                                  ; preds = %block_.L_400734, %routine_idivl__esi.exit
...
block_.L_400696:                                  ; preds = %block_4006aa, %block_.L_400691
...
block_4006aa:                                     ; preds = %block_.L_400696
...
block_.L_4006b8:                                  ; preds = %block_.L_400696
...
block_.L_4006bd:                                  ; preds = %block_4006d1, %block_.L_4006b8
...
block_4006d1:                                     ; preds = %block_.L_4006bd
...
block_.L_4006df:                                  ; preds = %block_.L_4006bd
...
block_4006eb:                                     ; preds = %block_.L_4006df
...
block_.L_40072f:                                  ; preds = %block_4006eb, %block_.L_4006df
...
block_.L_400734:                                  ; preds = %block_.L_40072f
...
block_400740:                                     ; preds = %block_.L_400734
...
block_.L_40075b:                                  ; preds = %block_40074c, %block_400740
...
block_400767:                                     ; preds = %block_.L_40075b
...
block_.L_400776:                                  ; preds = %block_400767, %block_.L_40075b
  ...
  ret %struct.Memory* %loadMem_40077b
}
...
define %struct.Memory* @routine_movl___rdi__rcx_4____eax(%struct.State* dereferenceable(3376), i64, %struct.Memory*) {
block_400478:
  %3 = getelementptr inbounds %struct.State, %struct.State* %0, i32 0, i32 6
  %4 = getelementptr inbounds %struct.GPR, %struct.GPR* %3, i32 0, i32 33
  %5 = getelementptr inbounds %struct.Reg, %struct.Reg* %4, i32 0, i32 0
