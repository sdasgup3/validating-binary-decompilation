...
declare %struct.Memory* @sub_4007a0.Quick(%struct.State* dereferenceable(3376), i64, %struct.Memory*) local_unnamed_addr
...
block_.L_400846:                                  ; preds = %block_400850, %entry
  %48 = phi i64 [ %.pre, %entry ], [ %117, %block_400850 ]
  %MEMORY.0 = phi %struct.Memory* [ %2, %entry ], [ %call2_400853, %block_400850 ]
  ...
  br i1 %76, label %block_400850, label %block_.L_400866
...
block_400850:                                     ; preds = %block_.L_400846
  ...
  %call2_400853 = tail call %struct.Memory* @sub_4007a0.Quick(%struct.State* nonnull %0, i64 %81, %struct.Memory* %MEMORY.0)
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_jge_.L_400866(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i8* nocapture %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
