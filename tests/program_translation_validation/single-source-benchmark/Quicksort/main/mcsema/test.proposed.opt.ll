...
declare %struct.Memory* @sub_4007a0.Quick(%struct.State* noalias dereferenceable(3376), i64, %struct.Memory* noalias readnone returned) local_unnamed_addr
...
block_.L_400846:                                  ; preds = %block_400850, %entry
  %48 = phi i64 [ %117, %block_400850 ], [ %.pre, %entry ]
...
block_400850:                                     ; preds = %block_.L_400846
  ...
  %call2_400853 = tail call %struct.Memory* @sub_4007a0.Quick(%struct.State* nonnull %0, i64 %81, %struct.Memory* %2)
