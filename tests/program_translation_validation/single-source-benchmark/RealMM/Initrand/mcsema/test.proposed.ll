...
@G_0x612eb8= global %G_0x612eb8_type <{ [8 x i8] c"\00\00\00\00\00\00\00\00" }>
...
entry:
  ...
  ; Code: .Initrand:	 RIP: 4004f0	 Bytes: 0
  ...
  ; Code: movq $0x12403, 0x612eb8	 RIP: 4004f4	 Bytes: 12
  %loadMem_4004f4 = load %struct.Memory*, %struct.Memory** %MEMORY
  %call_4004f4 = call %struct.Memory* @routine_movq__0x12403__0x612eb8(%struct.State* %0, i64  0, %struct.Memory* %loadMem_4004f4)
  store %struct.Memory* %call_4004f4, %struct.Memory** %MEMORY

  ; Code: popq %rbp	 RIP: 400500	 Bytes: 1
  %loadMem_400500 = load %struct.Memory*, %struct.Memory** %MEMORY
  %call_400500 = call %struct.Memory* @routine_popq__rbp(%struct.State* %0, i64  0, %struct.Memory* %loadMem_400500)
  store %struct.Memory* %call_400500, %struct.Memory** %MEMORY

  ; Code: retq	 RIP: 400501	 Bytes: 1
  %loadMem_400501 = load %struct.Memory*, %struct.Memory** %MEMORY
  %call_400501 = call %struct.Memory* @routine_retq(%struct.State* %0, i64  0, %struct.Memory* %loadMem_400501)
  store %struct.Memory* %call_400501, %struct.Memory** %MEMORY

  ret %struct.Memory* %call_400501
}
...
define %struct.Memory* @routine_movq__0x12403__0x612eb8(%struct.State*  dereferenceable(3376), i64, %struct.Memory* ) #19 {
block_400478:
  %3 = getelementptr inbounds %struct.State, %struct.State* %0, i32 0, i32 6
  %4 = getelementptr inbounds %struct.GPR, %struct.GPR* %3, i32 0, i32 33
  %5 = getelementptr inbounds %struct.Reg, %struct.Reg* %4, i32 0, i32 0
  ...
  %7 = add i64 %6, 12
  store i64 %7, i64* %PC
  %8 = call %struct.Memory* @_ZN12_GLOBAL__N_1L3MOVI3MnWImE2InImEEEP6MemoryS6_R5StateT_T0_(%struct.Memory* %2, %struct.State* %0, i64 ptrtoint( %G_0x612eb8_type* @G_0x612eb8 to i64), i64 74755)
  ret %struct.Memory* %8
}
