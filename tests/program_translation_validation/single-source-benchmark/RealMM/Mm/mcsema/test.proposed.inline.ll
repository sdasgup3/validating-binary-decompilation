...
@G__0x400890 = global %G__0x400890_type zeroinitializer
...
block_.L_400777:                                  ; preds = %block_.L_4006f5
  ...
  store i64 ptrtoint (%G__0x400890_type* @G__0x400890 to i64), i64* %RDI.i, align 8
  ...
  store %struct.Memory* %loadMem1_4007ae, %struct.Memory** %MEMORY
  %loadMem2_4007ae = load %struct.Memory*, %struct.Memory** %MEMORY
  %loadPC_4007ae = load i64, i64* %3
  %1017 = call %struct.Memory* @__remill_function_call(%struct.State* %0, i64 ptrtoint (i64 (i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64)* @printf to i64), %struct.Memory* %loadMem2_4007ae)
  ...
  ret %struct.Memory* %loadMem_4007bb
}
...
define %struct.Memory* @routine_movq__0x400890___rdi(%struct.State* dereferenceable(3376), i64, %struct.Memory*) {
block_400488:
  %3 = getelementptr inbounds %struct.State, %struct.State* %0, i32 0, i32 6
  %4 = getelementptr inbounds %struct.GPR, %struct.GPR* %3, i32 0, i32 33
  %5 = getelementptr inbounds %struct.Reg, %struct.Reg* %4, i32 0, i32 0
  ...
  %10 = add i64 %9, 10
  store i64 %10, i64* %PC
  store i64 ptrtoint (%G__0x400890_type* @G__0x400890 to i64), i64* %RDI, align 8
  ret %struct.Memory* %2
}
