...
block_.L_4007a6:                                  ; preds = %block_4007b0, %entry
  ...
  %loadBr_4007aa = load i8, i8* %BRANCH_TAKEN
  %cmpBr_4007aa = icmp eq i8 %loadBr_4007aa, 1
  br i1 %cmpBr_4007aa, label %block_.L_4007c6, label %block_4007b0

block_4007b0:                                     ; preds = %block_.L_4007a6
  ...
  %loadMem1_4007b3 = load %struct.Memory*, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem1_4007b3, %struct.Memory** %MEMORY
  %loadMem2_4007b3 = load %struct.Memory*, %struct.Memory** %MEMORY
  %loadPC_4007b3 = load i64, i64* %3
  %call2_4007b3 = call %struct.Memory* @sub_400690.Mm(%struct.State* %0, i64 %loadPC_4007b3, %struct.Memory* %loadMem2_4007b3)
  store %struct.Memory* %call2_4007b3, %struct.Memory** %MEMORY
...
block_.L_4007c6:                                  ; preds = %block_.L_4007a6
  ...
  ret %struct.Memory* %loadMem_4007cd
}
...
define %struct.Memory* @routine_jge_.L_4007c6(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i8* %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) {
block_400478:
  %3 = getelementptr inbounds %struct.State, %struct.State* %0, i32 0, i32 6
  %4 = getelementptr inbounds %struct.GPR, %struct.GPR* %3, i32 0, i32 33
  %5 = getelementptr inbounds %struct.Reg, %struct.Reg* %4, i32 0, i32 0
