...
declare %struct.Memory* @sub_4006b0.Mm(%struct.State* dereferenceable(3376), i64, %struct.Memory*) local_unnamed_addr
...
block_.L_4007c6:                                  ; preds = %block_4007d0, %entry
  %48 = phi i64 [ %.pre, %entry ], [ %117, %block_4007d0 ]
  %MEMORY.0 = phi %struct.Memory* [ %2, %entry ], [ %call2_4007d3, %block_4007d0 ]
...
block_4007d0:                                     ; preds = %block_.L_4007c6
  ...
  %call2_4007d3 = tail call %struct.Memory* @sub_4006b0.Mm(%struct.State* nonnull %0, i64 %81, %struct.Memory* %MEMORY.0)
