...
block_.L_4007d6:                                  ; preds = %block_4007e0, %entry
  %48 = phi i64 [ %117, %block_4007e0 ], [ %.pre, %entry ]
  ...
  br i1 %76, label %block_4007e0, label %block_.L_4007f6
...
block_4007e0:                                     ; preds = %block_.L_4007d6
  ...
  %call2_4007e3 = tail call %struct.Memory* @sub_4006c0.Mm(%struct.State* nonnull %0, i64 %81, %struct.Memory* %2)
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_jge_.L_4007f6(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i8* nocapture %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
