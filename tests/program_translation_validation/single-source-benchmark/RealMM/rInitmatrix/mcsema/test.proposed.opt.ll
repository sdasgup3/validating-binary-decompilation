...
@G_0x2cd__rip_ = local_unnamed_addr global %G_0x2cd__rip__type zeroinitializer
...
entry:
  ...
  %59 = bitcast [32 x %union.VectorReg]* %48 to double*
...
block_.L_400563:                                  ; preds = %block_.L_4005dd, %entry
  %60 = phi i64 [ %.pre, %entry ], [ %332, %block_.L_4005dd ]
...
block_.L_400574:                                  ; preds = %routine_idivl__ecx.exit, %block_40056d
  %93 = phi i64 [ %.pre1, %block_40056d ], [ %301, %routine_idivl__ecx.exit ]
  %MEMORY.1 = phi %struct.Memory* [ %MEMORY.0, %block_40056d ], [ %173, %routine_idivl__ecx.exit ]
...
block_40057e:                                     ; preds = %block_.L_400574
  ...
  %call2_40057e = tail call %struct.Memory* @sub_400510.Rand(%struct.State* %0, i64 %123, %struct.Memory* %MEMORY.1)
  %128 = load i64, i64* %PC.i, align 8
  %129 = load i64, i64* bitcast (%G_0x2cd__rip__type* @G_0x2cd__rip_ to i64*), align 8
  %130 = getelementptr inbounds [32 x %union.VectorReg], [32 x %union.VectorReg]* %48, i64 0, i64 0, i32 0, i32 0, i32 0, i64 0
  ...
  %132 = add i64 %131, -12
  %133 = load i32, i32* %EAX.i67, align 4
  %134 = add i64 %128, 16
  ...
  store i64 %142, i64* %RAX.i64, align 8
  %143 = add i64 %138, 6
  store i64 %143, i64* %PC.i, align 8
  %144 = load i32, i32* %140, align 4
  %145 = zext i32 %144 to i64
  store i64 %145, i64* %RDX.i, align 8
  %146 = add i64 %136, -24
  %147 = add i64 %138, 9
  ...
  store i64 %150, i64* %RAX.i64, align 8
  %152 = sext i32 %149 to i64
  %153 = lshr i64 %152, 32
  store i64 %153, i64* %54, align 8
  %154 = load i32, i32* %ECX.i51, align 4
  %155 = add i64 %151, 5
...
; <label>:164:                                    ; preds = %block_40057e
  %165 = tail call %struct.Memory* @__remill_error(%struct.State* nonnull dereferenceable(3376) %0, i64 %155, %struct.Memory* %call2_40057e)
  %.pre2 = load i32, i32* %EAX.i67, align 4
  %.pre3 = load i64, i64* %PC.i, align 8
  br label %routine_idivl__ecx.exit

; <label>:166:                                    ; preds = %block_40057e
  %167 = srem i64 %159, %157
  %168 = and i64 %160, 4294967295
  store i64 %168, i64* %55, align 8
  %169 = and i64 %167, 4294967295
  store i64 %169, i64* %56, align 8
...
routine_idivl__ecx.exit:                          ; preds = %166, %164
  %171 = phi i64 [ %.pre3, %164 ], [ %155, %166 ]
  %172 = phi i32 [ %.pre2, %164 ], [ %170, %166 ]
  %173 = phi %struct.Memory* [ %165, %164 ], [ %call2_40057e, %166 ]
  ...
  %220 = load double, double* %59, align 1
  %221 = fdiv double %219, %220
  store double %221, double* %58, align 1
  %222 = add i64 %189, -8
  %223 = add i64 %171, 23
...
block_.L_4005dd:                                  ; preds = %block_.L_400574
  ...
  store i64 %307, i64* %RAX.i64, align 8
...
block_.L_4005f0:                                  ; preds = %block_.L_400563
  %333 = load i64, i64* %RSP.i53, align 8
  %334 = add i64 %333, 32
  store i64 %334, i64* %RSP.i53, align 8
  %335 = icmp ugt i64 %333, -33
...
block_400478:
  ...
  %5 = load i64, i64* bitcast (%G_0x2cd__rip__type* @G_0x2cd__rip_ to i64*), align 8
