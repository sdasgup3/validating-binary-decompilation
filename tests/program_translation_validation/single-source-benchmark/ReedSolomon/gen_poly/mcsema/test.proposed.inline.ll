...
block_.L_4007d1:                                  ; preds = %routine_idivl__esi.exit, %entry
...
block_4007db:                                     ; preds = %block_.L_4007d1
...
block_.L_4007f3:                                  ; preds = %block_.L_40087f, %block_4007db
...
block_4007fd:                                     ; preds = %block_.L_4007f3
...
; <label>:608:                                    ; preds = %block_40080f
  %609 = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %610 = load i64, i64* %609, align 8
  %611 = call %struct.Memory* @__remill_error(%struct.State* nonnull dereferenceable(3376) %0, i64 %610, %struct.Memory* %loadMem_400843)
  br label %routine_idivl__esi.exit106

; <label>:612:                                    ; preds = %block_40080f
...
routine_idivl__esi.exit106:                       ; preds = %608, %612
  %624 = phi %struct.Memory* [ %611, %608 ], [ %loadMem_400843, %612 ]
...
block_.L_40085f:                                  ; preds = %block_4007fd
...
block_.L_40087a:                                  ; preds = %block_.L_40085f, %routine_idivl__esi.exit106
...
block_.L_40087f:                                  ; preds = %block_.L_40087a
...
block_.L_40088d:                                  ; preds = %block_.L_4007f3
...
; <label>:1096:                                   ; preds = %block_.L_40088d
  %1097 = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %1098 = load i64, i64* %1097, align 8
  %1099 = call %struct.Memory* @__remill_error(%struct.State* nonnull dereferenceable(3376) %0, i64 %1098, %struct.Memory* %loadMem_4008ad)
  br label %routine_idivl__esi.exit

; <label>:1100:                                   ; preds = %block_.L_40088d
...
routine_idivl__esi.exit:                          ; preds = %1096, %1100
  %1112 = phi %struct.Memory* [ %1099, %1096 ], [ %loadMem_4008ad, %1100 ]
...
block_.L_4008ce:                                  ; preds = %block_.L_4007d1
...
block_.L_4008d5:                                  ; preds = %block_4008df, %block_.L_4008ce
...
block_.L_40090b:                                  ; preds = %block_.L_4008d5
  ...
  ret %struct.Memory* %loadMem_40090c
}
