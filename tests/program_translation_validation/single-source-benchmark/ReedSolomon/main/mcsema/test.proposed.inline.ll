...
declare %struct.Memory* @sub_400410.random_plt(%struct.State* dereferenceable(3376), i64, %struct.Memory*)

declare %struct.Memory* @sub_401870.rsenc_204(%struct.State* dereferenceable(3376), i64, %struct.Memory*)

declare %struct.Memory* @sub_400510.rsdec_204(%struct.State* dereferenceable(3376), i64, %struct.Memory*)
