...
block_.L_40052a:                                  ; preds = %block_400534, %block_.L_400523
  %59 = phi i64 [ %164, %block_400534 ], [ %.pre, %block_.L_400523 ]
...
block_.L_400568:                                  ; preds = %block_400572, %block_.L_400561
  %166 = phi i64 [ %258, %block_400572 ], [ %.pre1, %block_.L_400561 ]
  ...
  %195 = xor i1 %194, %192
  %.v6 = select i1 %195, i64 10, i64 44
  %196 = add i64 %166, %.v6
  store i64 %196, i64* %3, align 8
  br i1 %195, label %block_400572, label %block_.L_400594
...
block_400572:                                     ; preds = %block_.L_400568
  ...
  store i64 %200, i64* %RAX.i149, align 8
  %201 = icmp ugt i32 %198, -17
  ...
  store i64 %234, i64* %RAX.i149, align 8
...
block_.L_40059b:                                  ; preds = %block_4005a8, %block_.L_400594
  %260 = phi i64 [ %364, %block_4005a8 ], [ %.pre2, %block_.L_400594 ]
  ...
  %289 = xor i1 %288, %286
  %.v7 = select i1 %289, i64 13, i64 55
  %290 = add i64 %260, %.v7
  store i64 %290, i64* %3, align 8
  br i1 %289, label %block_4005a8, label %block_.L_4005d2
...
block_4005a8:                                     ; preds = %block_.L_40059b
  ...
  store i64 %297, i64* %RCX.i146, align 8
  %298 = add i64 %297, %294
  %299 = add i64 %290, 12
  ...
  store i64 %302, i64* %RDX.i142, align 8
  %303 = add i64 %290, 15
...
block_.L_4005d9:                                  ; preds = %block_4005e6, %block_.L_4005d2
  %366 = phi i64 [ %450, %block_4005e6 ], [ %.pre3, %block_.L_4005d2 ]
  ...
  %395 = xor i1 %394, %392
  %.v8 = select i1 %395, i64 13, i64 57
  %396 = add i64 %366, %.v8
  store i64 %396, i64* %3, align 8
  br i1 %395, label %block_4005e6, label %block_.L_400612
...
block_.L_400612:                                  ; preds = %block_.L_4005d9
  ...
  %call2_400612 = tail call %struct.Memory* @sub_400910.decode_rs(%struct.State* %0, i64 %451, %struct.Memory* %MEMORY.0)
...
block_.L_40061e:                                  ; preds = %block_40062b, %block_.L_400612
  %461 = phi i64 [ %565, %block_40062b ], [ %.pre4, %block_.L_400612 ]
  ...
  %490 = xor i1 %489, %487
  %.v9 = select i1 %490, i64 13, i64 56
  %491 = add i64 %461, %.v9
  store i64 %491, i64* %3, align 8
  br i1 %490, label %block_40062b, label %block_.L_400656
...
block_40062b:                                     ; preds = %block_.L_40061e
  ...
  store i64 %527, i64* %RCX.i146, align 8
  %528 = add i64 %491, 26
