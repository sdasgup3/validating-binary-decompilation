; ModuleID = '/tmp/tmpdmjci_9g-query.ll'
...
entry:
  ...
  br i1 %var_2_35, label %block_40189e, label %block_.L_4018b3

block_40189e:                                     ; preds = %entry
  %var_2_28 = load i64, i64* %var_2_3, align 8
  %var_2_40 = add i64 %var_2_28, -4608
  %call2_40189e = tail call %struct.Memory* @sub_400690.generate_gf(%struct.State* nonnull %0, i64 %var_2_40, %struct.Memory* %2)
  %var_2_45 = load i64, i64* %var_2_3, align 8
  %var_2_46 = add i64 %var_2_45, -4291
  %call2_4018a3 = tail call %struct.Memory* @sub_4007e0.gen_poly(%struct.State* nonnull %0, i64 %var_2_46, %struct.Memory* %call2_40189e)
...
block_.L_4018b3:                                  ; preds = %block_40189e, %entry
  ...
  %var_2_6233 = inttoptr i64 %var_2_55 to i32*
  %var_2_6334 = load i32, i32* %var_2_6233, align 4
  %var_2_6435 = add i32 %var_2_6334, -51
  %var_2_7936 = lshr i32 %var_2_6435, 31
  %var_2_8137 = lshr i32 %var_2_6334, 31
  %var_2_8238 = xor i32 %var_2_7936, %var_2_8137
  %var_2_8339 = add nuw nsw i32 %var_2_8238, %var_2_8137
  %var_2_8440 = icmp eq i32 %var_2_8339, 2
  %var_2_8641 = icmp ne i32 %var_2_7936, 0
  %var_2_8742 = xor i1 %var_2_8641, %var_2_8440
  br i1 %var_2_8742, label %block_4018c4.preheader, label %block_.L_4018e1

block_4018c4.preheader:                           ; preds = %block_.L_4018b3
  br label %block_4018c4

block_4018c4:                                     ; preds = %block_4018c4.preheader, %block_4018c4
  %var_2_6343 = phi i32 [ %var_2_63, %block_4018c4 ], [ %var_2_6334, %block_4018c4.preheader ]
  %var_2_91 = sext i32 %var_2_6343 to i64
  %var_2_92 = shl nsw i64 %var_2_91, 2
  %var_2_93 = add nsw i64 %var_2_92, 6307024
  %var_2_95 = inttoptr i64 %var_2_93 to i32*
  store i32 0, i32* %var_2_95, align 4
  ...
  br i1 %var_2_87, label %block_4018c4, label %block_.L_4018e1.loopexit

block_.L_4018e1.loopexit:                         ; preds = %block_4018c4
  br label %block_.L_4018e1

block_.L_4018e1:                                  ; preds = %block_.L_4018e1.loopexit, %block_.L_4018b3
  %var_2_13519 = phi i32 [ %var_2_6334, %block_.L_4018b3 ], [ %var_2_63, %block_.L_4018e1.loopexit ]
  %var_2_13116 = phi i64 [ %var_2_54, %block_.L_4018b3 ], [ %var_2_59, %block_.L_4018e1.loopexit ]
  %var_2_129 = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 7, i32 0
  %.pre11 = load i64, i64* %var_2_3, align 8
  %var_2_13620 = add i32 %var_2_13519, -188
  %var_2_15121 = lshr i32 %var_2_13620, 31
  %var_2_15322 = lshr i32 %var_2_13519, 31
  %var_2_15423 = xor i32 %var_2_15121, %var_2_15322
  %var_2_15524 = add nuw nsw i32 %var_2_15423, %var_2_15322
  %var_2_15625 = icmp eq i32 %var_2_15524, 2
  %var_2_15826 = icmp ne i32 %var_2_15121, 0
  %var_2_15927 = xor i1 %var_2_15826, %var_2_15625
  br i1 %var_2_15927, label %block_4018f5.preheader, label %block_.L_40191f

block_4018f5.preheader:                           ; preds = %block_.L_4018e1
  br label %block_4018f5

block_4018f5:                                     ; preds = %block_4018f5.preheader, %block_4018f5
  %var_2_13529 = phi i32 [ %var_2_135, %block_4018f5 ], [ %var_2_13519, %block_4018f5.preheader ]
  %var_2_13128 = phi i64 [ %var_2_131, %block_4018f5 ], [ %var_2_13116, %block_4018f5.preheader ]
  %var_2_161 = add i64 %var_2_13128, -16
  %var_2_163 = inttoptr i64 %var_2_161 to i64*
  %var_2_164 = load i64, i64* %var_2_163, align 8
  %var_2_167 = sext i32 %var_2_13529 to i64
  %var_2_168 = add i64 %var_2_164, %var_2_167
  %var_2_170 = inttoptr i64 %var_2_168 to i8*
  %var_2_171 = load i8, i8* %var_2_170, align 1
  %var_2_175 = add i32 %var_2_13529, 51
  %var_2_198 = sext i32 %var_2_175 to i64
  %var_2_199 = shl nsw i64 %var_2_198, 2
  %var_2_200 = add nsw i64 %var_2_199, 6307024
  %var_2_201 = zext i8 %var_2_171 to i32
  %var_2_203 = inttoptr i64 %var_2_200 to i32*
  store i32 %var_2_201, i32* %var_2_203, align 4
  %var_2_131 = load i64, i64* %RBP.i, align 8
  %var_2_132 = add i64 %var_2_131, -20
  %var_2_134 = inttoptr i64 %var_2_132 to i32*
  %var_2_135 = load i32, i32* %var_2_134, align 4
  %var_2_136 = add i32 %var_2_135, -188
  %var_2_151 = lshr i32 %var_2_136, 31
  %var_2_153 = lshr i32 %var_2_135, 31
  %var_2_154 = xor i32 %var_2_151, %var_2_153
  %var_2_155 = add nuw nsw i32 %var_2_154, %var_2_153
  %var_2_156 = icmp eq i32 %var_2_155, 2
  %var_2_158 = icmp ne i32 %var_2_151, 0
  %var_2_159 = xor i1 %var_2_158, %var_2_156
  br i1 %var_2_159, label %block_4018f5, label %block_.L_4018e8.block_.L_40191f_crit_edge

block_.L_4018e8.block_.L_40191f_crit_edge:        ; preds = %block_4018f5
  %var_2_234 = load i64, i64* %var_2_3, align 8
  %var_2_235.le = add i64 %var_2_234, -50
  br label %block_.L_40191f

block_.L_40191f:                                  ; preds = %block_.L_4018e8.block_.L_40191f_crit_edge, %block_.L_4018e1
  %var_2_130.lcssa = phi i64 [ %var_2_235.le, %block_.L_4018e8.block_.L_40191f_crit_edge ], [ %.pre11, %block_.L_4018e1 ]
  %var_2_236 = add i64 %var_2_130.lcssa, 200
  %call2_40191f = tail call %struct.Memory* @sub_4019b0.encode_rs(%struct.State* nonnull %0, i64 %var_2_236, %struct.Memory* %MEMORY.0)
  %var_2_241 = load i64, i64* %RBP.i, align 8
  %var_2_242 = add i64 %var_2_241, -20
  %DL.i56 = bitcast %union.anon* %var_2_129 to i8*
  %var_2_250 = inttoptr i64 %var_2_242 to i32*
  %var_2_251 = load i32, i32* %var_2_250, align 4
  %var_2_252 = add i32 %var_2_251, -188
  %var_2_267 = lshr i32 %var_2_252, 31
  %var_2_269 = lshr i32 %var_2_251, 31
  %var_2_270 = xor i32 %var_2_267, %var_2_269
  %var_2_271 = add nuw nsw i32 %var_2_270, %var_2_269
  %var_2_272 = icmp eq i32 %var_2_271, 2
  %var_2_274 = icmp ne i32 %var_2_267, 0
  %var_2_275 = xor i1 %var_2_274, %var_2_272
  br i1 %var_2_275, label %block_.L_40192b.us.preheader, label %block_.L_40195c

block_.L_40192b.us.preheader:                     ; preds = %block_.L_40191f
  br label %block_.L_40192b.us

block_.L_40192b.us:                               ; preds = %block_.L_40192b.us.preheader, %block_.L_40192b.us
  br label %block_.L_40192b.us

block_.L_40195c:                                  ; preds = %block_.L_40191f
  %RCX.i27 = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 5, i32 0, i32 0
  %var_2_3375 = add i32 %var_2_251, -16
  %var_2_3526 = lshr i32 %var_2_3375, 31
  %var_2_3558 = xor i32 %var_2_3526, %var_2_269
  %var_2_3569 = add nuw nsw i32 %var_2_3558, %var_2_269
  %var_2_35710 = icmp eq i32 %var_2_3569, 2
  %var_2_35911 = icmp ne i32 %var_2_3526, 0
  %var_2_36012 = xor i1 %var_2_35911, %var_2_35710
  br i1 %var_2_36012, label %block_40196d.preheader, label %block_.L_40199b

block_40196d.preheader:                           ; preds = %block_.L_40195c
  br label %block_40196d

block_40196d:                                     ; preds = %block_40196d.preheader, %block_40196d
  %var_2_33615 = phi i32 [ %var_2_336, %block_40196d ], [ %var_2_251, %block_40196d.preheader ]
  %var_2_33514 = phi i32* [ %var_2_335, %block_40196d ], [ %var_2_250, %block_40196d.preheader ]
  %var_2_33213 = phi i64 [ %var_2_332, %block_40196d ], [ %var_2_241, %block_40196d.preheader ]
  %var_2_364 = sext i32 %var_2_33615 to i64
  %var_2_365 = shl nsw i64 %var_2_364, 2
  %var_2_366 = add nsw i64 %var_2_365, 6307984
  %var_2_368 = inttoptr i64 %var_2_366 to i32*
  %var_2_369 = load i32, i32* %var_2_368, align 4
  %var_2_370 = zext i32 %var_2_369 to i64
  store i64 %var_2_370, i64* %RCX.i27, align 8
  %var_2_371 = trunc i32 %var_2_369 to i8
  store i8 %var_2_371, i8* %DL.i56, align 1
  %var_2_372 = add i64 %var_2_33213, -8
  %var_2_374 = inttoptr i64 %var_2_372 to i64*
  %var_2_375 = load i64, i64* %var_2_374, align 8
  %var_2_377 = load i32, i32* %var_2_33514, align 4
  %var_2_378 = add i32 %var_2_377, 188
  %var_2_401 = sext i32 %var_2_378 to i64
  %var_2_402 = add i64 %var_2_401, %var_2_375
  %var_2_404 = inttoptr i64 %var_2_402 to i8*
  store i8 %var_2_371, i8* %var_2_404, align 1
  %var_2_332 = load i64, i64* %RBP.i, align 8
  %var_2_333 = add i64 %var_2_332, -20
  %var_2_335 = inttoptr i64 %var_2_333 to i32*
  %var_2_336 = load i32, i32* %var_2_335, align 4
  %var_2_337 = add i32 %var_2_336, -16
  %var_2_352 = lshr i32 %var_2_337, 31
  %var_2_354 = lshr i32 %var_2_336, 31
  %var_2_355 = xor i32 %var_2_352, %var_2_354
  %var_2_356 = add nuw nsw i32 %var_2_355, %var_2_354
  %var_2_357 = icmp eq i32 %var_2_356, 2
  %var_2_359 = icmp ne i32 %var_2_352, 0
  %var_2_360 = xor i1 %var_2_359, %var_2_357
  br i1 %var_2_360, label %block_40196d, label %block_.L_40199b.loopexit

block_.L_40199b.loopexit:                         ; preds = %block_40196d
  br label %block_.L_40199b

block_.L_40199b:                                  ; preds = %block_.L_40199b.loopexit, %block_.L_40195c
