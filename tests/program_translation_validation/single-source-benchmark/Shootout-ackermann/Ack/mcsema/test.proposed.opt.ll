...
block_.L_400556:                                  ; preds = %entry
  ...
  store i8 0, i8* %39, align 1
  %.v2 = select i1 %110, i64 10, i64 36
  %114 = add i64 %67, %.v2
  store i64 %114, i64* %3, align 8
  br i1 %110, label %block_400560, label %block_.L_40057a
...
block_400560:                                     ; preds = %block_.L_400556
  ...
  %RAX.i43 = getelementptr inbounds %union.anon, %union.anon* %115, i64 0, i32 0
  %116 = add i64 %114, 8
  ...
  %EAX.i38 = bitcast %union.anon* %115 to i32*
  ...
  %call2_40056d = tail call %struct.Memory* @sub_400530.Ack(%struct.State* %0, i64 %140, %struct.Memory* %2)
  %145 = load i64, i64* %RBP.i, align 8
  %146 = add i64 %145, -4
  %147 = load i32, i32* %EAX.i38, align 4
...
block_.L_40057a:                                  ; preds = %block_.L_400556
  %153 = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 1, i32 0
  %RAX.i30 = getelementptr inbounds %union.anon, %union.anon* %153, i64 0, i32 0
  %154 = add i64 %114, 3
  store i64 %154, i64* %PC.i, align 8
  %155 = load i32, i32* %56, align 4
  %156 = add i32 %155, -1
  %157 = zext i32 %156 to i64
  store i64 %157, i64* %RAX.i30, align 8
  ...
  store i64 %184, i64* %RSI.i19, align 8
  %EAX.i16 = bitcast %union.anon* %153 to i32*
  %205 = add i64 %52, -16
  %206 = add i64 %114, 20
  store i64 %206, i64* %PC.i, align 8
  %207 = inttoptr i64 %205 to i32*
  store i32 %156, i32* %207, align 4
  ...
  %call2_40058e = tail call %struct.Memory* @sub_400530.Ack(%struct.State* %0, i64 %209, %struct.Memory* %2)
  ...
  store i64 %220, i64* %RDI.i25, align 8
  %221 = load i32, i32* %EAX.i16, align 4
  %222 = zext i32 %221 to i64
  store i64 %222, i64* %RSI.i19, align 8
  %223 = add i64 %216, -99
  %224 = add i64 %216, 10
  ...
  %call2_400598 = tail call %struct.Memory* @sub_400530.Ack(%struct.State* %0, i64 %223, %struct.Memory* %call2_40058e)
  %228 = load i64, i64* %RBP.i, align 8
  %229 = add i64 %228, -4
  %230 = load i32, i32* %EAX.i16, align 4
...
block_.L_4005a0:                                  ; preds = %block_.L_40057a, %block_400560, %block_400548
  ...
  %234 = phi i64 [ %.pre, %block_.L_40057a ], [ %152, %block_400560 ], [ %100, %block_400548 ]
  ...
  store i64 %240, i64* %RAX.i.pre-phi, align 8
  %241 = load i64, i64* %RSP.i69, align 8
  %242 = add i64 %241, 16
  store i64 %242, i64* %RSP.i69, align 8
  %243 = icmp ugt i64 %241, -17
...
define %struct.Memory* @routine_jne_.L_400556(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i8* %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
...
define %struct.Memory* @routine_jmpq_.L_4005a0(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
...
define %struct.Memory* @routine_jne_.L_40057a(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i8* %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 2, i32 7
