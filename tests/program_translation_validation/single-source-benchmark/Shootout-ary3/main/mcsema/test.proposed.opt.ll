...
entry:
  ...
  br i1 %73, label %block_4005e0, label %block_.L_4005f5
...
block_.L_4005f5:                                  ; preds = %entry
  ...
  %110 = add i64 %109, 5
  %.pre4 = getelementptr inbounds %union.anon, %union.anon* %42, i64 0, i32 0
  br label %block_.L_400602

block_.L_400602:                                  ; preds = %block_.L_4005f5, %block_4005e0
  %storemerge = phi i64 [ %105, %block_4005e0 ], [ %110, %block_.L_4005f5 ]
  %RDI.i156.pre-phi = phi i64* [ %RDI.i184, %block_4005e0 ], [ %.pre4, %block_.L_4005f5 ]
  %EAX.i159.pre-phi = phi i32* [ %EAX.i177, %block_4005e0 ], [ %EAX.i171, %block_.L_4005f5 ]
  %MEMORY.0 = phi %struct.Memory* [ %97, %block_4005e0 ], [ %2, %block_.L_4005f5 ]
  ...
  %132 = tail call %struct.Memory* @__remill_function_call(%struct.State* %0, i64 ptrtoint (i64 (i64, i64)* @calloc to i64), %struct.Memory* %MEMORY.0)
  ...
  %151 = tail call %struct.Memory* @__remill_function_call(%struct.State* %0, i64 ptrtoint (i64 (i64, i64)* @calloc to i64), %struct.Memory* %132)
...
block_.L_400637:                                  ; preds = %block_400643, %block_.L_400602
  %163 = phi i64 [ %268, %block_400643 ], [ %.pre, %block_.L_400602 ]
  ...
  %199 = xor i1 %198, %196
  %.v5 = select i1 %199, i64 12, i64 43
  %200 = add i64 %163, %.v5
  store i64 %200, i64* %3, align 8
  br i1 %199, label %block_400643, label %block_.L_400662

block_400643:                                     ; preds = %block_.L_400637
  %201 = add i64 %200, 3
...
block_.L_400662:                                  ; preds = %block_.L_400637
  %269 = add i64 %164, -28
  %270 = add i64 %200, 7
  ...
  br label %block_.L_400669

block_.L_400669:                                  ; preds = %block_.L_4006b0, %block_.L_400662
  %272 = phi i64 [ %463, %block_.L_4006b0 ], [ %.pre1, %block_.L_400662 ]
  ...
  %300 = xor i1 %299, %297
  %.v6 = select i1 %300, i64 13, i64 90
  %301 = add i64 %272, %.v6
  store i64 %301, i64* %3, align 8
  br i1 %300, label %block_400676, label %block_.L_4006c3

block_400676:                                     ; preds = %block_.L_400669
  %302 = add i64 %273, -20
  %303 = add i64 %301, 3
  ...
  br label %block_.L_40067f

block_.L_40067f:                                  ; preds = %block_400689, %block_400676
  %331 = phi i64 [ %433, %block_400689 ], [ %.pre2, %block_400676 ]
  ...
  %.v7 = select i1 %346, i64 49, i64 10
  %347 = add i64 %331, %.v7
  store i64 %347, i64* %3, align 8
  br i1 %346, label %block_.L_4006b0, label %block_400689

block_400689:                                     ; preds = %block_.L_40067f
  %348 = add i64 %332, -40
  %349 = add i64 %347, 4
  ...
  store i64 %360, i64* %RDX.i115, align 8
  %361 = add i64 %332, -48
  %362 = add i64 %347, 15
  ...
  store i64 %374, i64* %RDX.i115, align 8
...
block_.L_4006b0:                                  ; preds = %block_.L_40067f
  %434 = add i64 %332, -28
  %435 = add i64 %347, 8
...
block_.L_4006c3:                                  ; preds = %block_.L_400669
  store i64 ptrtoint (%G__0x400794_type* @G__0x400794 to i64), i64* %RDI.i156.pre-phi, align 8
  %464 = add i64 %273, -48
  %465 = add i64 %301, 14
  ...
  %512 = tail call %struct.Memory* @__remill_function_call(%struct.State* %0, i64 ptrtoint (i64 (i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64)* @printf to i64), %struct.Memory* %151)
  ...
  %529 = tail call %struct.Memory* @__remill_function_call(%struct.State* %0, i64 ptrtoint (i64 (i64)* @free to i64), %struct.Memory* %512)
  ...
  %541 = tail call %struct.Memory* @__remill_function_call(%struct.State* %0, i64 ptrtoint (i64 (i64)* @free to i64), %struct.Memory* %529)
...
define %struct.Memory* @routine_jne_.L_4005f5(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i8* %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
...
define %struct.Memory* @routine_jmpq_.L_400602(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
...
define %struct.Memory* @routine_movl__0x16e360___eax(%struct.State* dereferenceable(3376), i64, %struct.Memory*) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %RAX = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 1, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
...
define %struct.Memory* @routine_jge_.L_400662(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i8* %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
...
define %struct.Memory* @routine_jmpq_.L_400637(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
...
define %struct.Memory* @routine_cmpl__0x3e8__MINUS0x1c__rbp_(%struct.State* dereferenceable(3376), i64, %struct.Memory*) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %RBP = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 15, i32 0, i32 0
  %3 = load i64, i64* %RBP, align 8
...
define %struct.Memory* @routine_jl_.L_4006b0(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i8* %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 2, i32 9
...
define %struct.Memory* @routine_jmpq_.L_40067f(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
...
define %struct.Memory* @routine_jmpq_.L_400669(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
...
define %struct.Memory* @routine_movq__0x400794___rdi(%struct.State* dereferenceable(3376), i64, %struct.Memory*) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %RDI = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 11, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
...
define %struct.Memory* @routine_movl___rax__rdx_4____edx(%struct.State* dereferenceable(3376), i64, %struct.Memory*) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %RAX = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 1, i32 0, i32 0
  %RDX = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 7, i32 0, i32 0
