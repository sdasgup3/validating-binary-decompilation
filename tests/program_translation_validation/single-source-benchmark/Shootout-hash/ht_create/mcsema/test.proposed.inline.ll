...
declare %struct.Memory* @sub_400660.malloc_plt(%struct.State* dereferenceable(3376), i64, %struct.Memory*)

declare %struct.Memory* @sub_400640.calloc_plt(%struct.State* dereferenceable(3376), i64, %struct.Memory*)
