...
block_.L_400885:                                  ; preds = %block_40089e, %entry
  %64 = phi i64 [ %134, %block_40089e ], [ %.pre, %entry ]
  ...
  br i1 %82, label %block_40089e, label %block_.L_4008ac
...
block_.L_4008ac:                                  ; preds = %block_.L_400885
  ...
  store i64 %144, i64* %RAX.i90, align 8
  %145 = add i64 %65, -16
  %146 = add i64 %106, 25
  store i64 %146, i64* %3, align 8
  %147 = inttoptr i64 %145 to i64*
  %148 = load i64, i64* %147, align 8
  store i64 %148, i64* %RCX.i88, align 8
  %149 = add i64 %106, 27
  ...
  %166 = tail call %struct.Memory* @__remill_function_call(%struct.State* nonnull %0, i64 ptrtoint (i64 (i64, i64)* @calloc to i64), %struct.Memory* %57)
