; ModuleID = '/tmp/tmp3dorq6ur-query.ll'
...
define %struct.Memory* @ht_create(%struct.State* noalias, i64, %struct.Memory* noalias) local_unnamed_addr #1 {
entry:
  ...
  store i64 40, i64* %RCX.i88, align 8
  %var_2_57 = tail call %struct.Memory* @__remill_function_call(%struct.State* %0, i64 ptrtoint (i64 (i64)* @malloc to i64), %struct.Memory* %2)
  %.pre = load i64, i64* %var_2_3, align 8
  %var_2_65.pre = load i64, i64* %RBP.i, align 8
  %var_2_66 = add i64 %var_2_65.pre, -8
  %var_2_68 = inttoptr i64 %var_2_66 to i32*
  %var_2_76 = add i64 %var_2_65.pre, -4
  %var_2_78 = inttoptr i64 %var_2_76 to i32*
  br label %block_.L_400885

block_.L_400885:                                  ; preds = %block_40089e, %entry
  %var_2_64 = phi i64 [ %var_2_134, %block_40089e ], [ %.pre, %entry ]
  %var_2_69 = load i32, i32* %var_2_68, align 4
  %var_2_70 = sext i32 %var_2_69 to i64
  %var_2_71 = shl nsw i64 %var_2_70, 3
  %var_2_72 = add nsw i64 %var_2_71, 6299776
  %var_2_74 = inttoptr i64 %var_2_72 to i64*
  %var_2_75 = load i64, i64* %var_2_74, align 8
  store i64 %var_2_75, i64* %RAX.i90, align 8
  %var_2_79 = load i32, i32* %var_2_78, align 4
  %var_2_80 = sext i32 %var_2_79 to i64
  %var_2_81 = sub i64 %var_2_75, %var_2_80
  %var_2_82 = icmp ult i64 %var_2_75, %var_2_80
  %var_2_83 = zext i1 %var_2_82 to i8
  store i8 %var_2_83, i8* %var_2_14, align 1
  %var_2_84 = trunc i64 %var_2_81 to i32
  ...
  %var_2_90 = xor i64 %var_2_80, %var_2_75
  %var_2_91 = xor i64 %var_2_90, %var_2_81
  %var_2_92 = lshr i64 %var_2_91, 4
  %var_2_93 = trunc i64 %var_2_92 to i8
  %var_2_94 = and i8 %var_2_93, 1
  store i8 %var_2_94, i8* %var_2_27, align 1
  %var_2_95 = icmp eq i64 %var_2_81, 0
  %var_2_96 = zext i1 %var_2_95 to i8
  store i8 %var_2_96, i8* %var_2_30, align 1
  %var_2_97 = lshr i64 %var_2_81, 63
  %var_2_98 = trunc i64 %var_2_97 to i8
  store i8 %var_2_98, i8* %var_2_33, align 1
  %var_2_99 = lshr i64 %var_2_75, 63
  %var_2_100 = lshr i64 %var_2_80, 63
  %var_2_101 = xor i64 %var_2_100, %var_2_99
  %var_2_102 = xor i64 %var_2_97, %var_2_99
  %var_2_103 = add nuw nsw i64 %var_2_102, %var_2_101
  %var_2_104 = icmp eq i64 %var_2_103, 2
  %var_2_105 = zext i1 %var_2_104 to i8
  store i8 %var_2_105, i8* %var_2_39, align 1
  %.v = select i1 %var_2_82, i64 25, i64 39
  %var_2_106 = add i64 %.v, %var_2_64
  store i64 %var_2_106, i64* %var_2_3, align 8
  br i1 %var_2_82, label %block_40089e, label %block_.L_4008ac

block_40089e:                                     ; preds = %block_.L_400885
  %var_2_132 = add i64 %var_2_106, 9
  store i64 %var_2_132, i64* %var_2_3, align 8
  %var_2_134 = add i64 %var_2_106, -25
  br label %block_.L_400885

block_.L_4008ac:                                  ; preds = %block_.L_400885
  store i64 8, i64* %RAX.i90, align 8
  %var_2_135 = add i64 %var_2_106, 11
  store i64 %var_2_135, i64* %var_2_3, align 8
  %var_2_136 = load i32, i32* %var_2_68, align 4
  %var_2_137 = sext i32 %var_2_136 to i64
  %var_2_138 = shl nsw i64 %var_2_137, 3
  %var_2_139 = add nsw i64 %var_2_138, 6299776
  %var_2_140 = add i64 %var_2_106, 19
  store i64 %var_2_140, i64* %var_2_3, align 8
  %var_2_141 = inttoptr i64 %var_2_139 to i64*
  %var_2_142 = load i64, i64* %var_2_141, align 8
  store i64 %var_2_142, i64* %RCX.i88, align 8
  %var_2_143 = trunc i64 %var_2_142 to i32
  %var_2_144 = and i64 %var_2_142, 4294967295
  store i64 %var_2_144, i64* %RAX.i90, align 8
  %var_2_145 = add i64 %var_2_65.pre, -16
  %var_2_146 = add i64 %var_2_106, 25
  store i64 %var_2_146, i64* %var_2_3, align 8
  %var_4_3 = inttoptr i64 %var_2_145 to i32**
  %var_2_1481 = load i32*, i32** %var_4_3, align 8
  %var_2_149 = add i64 %var_2_106, 27
  store i64 %var_2_149, i64* %var_2_3, align 8
  store i32 %var_2_143, i32* %var_2_1481, align 4
  %var_2_166 = tail call %struct.Memory* @__remill_function_call(%struct.State* nonnull %0, i64 ptrtoint (i64 (i64, i64)* @calloc to i64), %struct.Memory* %var_2_57)
  ret %struct.Memory* %var_2_166
}
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_movq_0x602080___rax_8____rax(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %RAX = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 1, i32 0, i32 0
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_jae_.L_4008ac(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i8* nocapture %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_jmpq_.L_400885(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_movq_0x602080___rcx_8____rcx(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %RCX = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 5, i32 0, i32 0
  %3 = load i64, i64* %RCX, align 8
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_movslq___rcx____rdi(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %RCX = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 5, i32 0, i32 0
  %RDI = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 11, i32 0, i32 0
