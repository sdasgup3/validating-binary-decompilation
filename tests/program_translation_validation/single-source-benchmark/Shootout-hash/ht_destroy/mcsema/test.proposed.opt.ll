...
block_.L_4008d3:                                  ; preds = %block_.L_400932, %entry
  %48 = phi i64 [ %.pre, %entry ], [ %197, %block_.L_400932 ]
...
block_.L_400945:                                  ; preds = %block_.L_4008d3
  ...
  %203 = tail call %struct.Memory* @__remill_function_call(%struct.State* %0, i64 ptrtoint (i64 (i64)* @free to i64), %struct.Memory* %MEMORY.0)
  ...
  %215 = tail call %struct.Memory* @__remill_function_call(%struct.State* %0, i64 ptrtoint (i64 (i64)* @free to i64), %struct.Memory* %203)
