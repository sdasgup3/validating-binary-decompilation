; ModuleID = '/tmp/tmp7jnbwgnv-query.ll'
...
entry:
  ...
  %var_2_60 = add i64 %var_2_52, 352
  %call2_400b18 = tail call %struct.Memory* @sub_400c70.ht_hashcode(%struct.State* %0, i64 %var_2_60, %struct.Memory* %2)
  %var_2_65 = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 1, i32 0
  %EAX.i107 = bitcast %union.anon* %var_2_65 to i32*
  br label %block_.L_400b3c

block_.L_400b3c:                                  ; preds = %block_400b47, %entry
  %MEMORY.0 = phi %struct.Memory* [ %call2_400b18, %entry ], [ %var_2_131, %block_400b47 ]
  %var_2_101 = load i64, i64* %RBP.i, align 8
  %var_2_102 = add i64 %var_2_101, -48
  %var_2_104 = inttoptr i64 %var_2_102 to i64*
  %var_2_105 = load i64, i64* %var_2_104, align 8
  %var_2_112 = icmp eq i64 %var_2_105, 0
  br i1 %var_2_112, label %block_.L_400b86, label %block_400b47

block_400b47:                                     ; preds = %block_.L_400b3c
  %var_2_131 = tail call %struct.Memory* @__remill_function_call(%struct.State* nonnull %0, i64 ptrtoint (i64 (i64, i64)* @strcmp to i64), %struct.Memory* %MEMORY.0)
  %var_2_132 = load i32, i32* %EAX.i107, align 4
  %var_2_139 = icmp eq i32 %var_2_132, 0
  br i1 %var_2_139, label %block_.L_400bd5.loopexit, label %block_.L_400b3c

block_.L_400b86:                                  ; preds = %block_.L_400b3c
  %var_2_203 = add i64 %var_2_101, -40
  %var_2_204 = load i64, i64* %var_2_3, align 8
  %var_2_206 = inttoptr i64 %var_2_203 to i64*
  %var_2_207 = load i64, i64* %var_2_206, align 8
  %var_2_214 = icmp eq i64 %var_2_207, 0
  %.v = select i1 %var_2_214, i64 37, i64 11
  %var_2_218 = add i64 %.v, %var_2_204
  %.sink = select i1 %var_2_214, i64 -1016, i64 -990
  %var_2_246 = add i64 %var_2_218, %.sink
  %call2_400bbc = tail call %struct.Memory* @sub_4007c0.ht_node_create(%struct.State* nonnull %0, i64 %var_2_246, %struct.Memory* %MEMORY.0)
  br label %block_.L_400bd5

block_.L_400bd5.loopexit:                         ; preds = %block_400b47
  br label %block_.L_400bd5

block_.L_400bd5:                                  ; preds = %block_.L_400bd5.loopexit, %block_.L_400b86
  %MEMORY.1 = phi %struct.Memory* [ %call2_400bbc, %block_.L_400b86 ], [ %var_2_131, %block_.L_400bd5.loopexit ]
