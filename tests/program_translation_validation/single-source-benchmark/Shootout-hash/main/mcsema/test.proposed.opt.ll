...
block_.L_4009d2:                                  ; preds = %block_4009de, %block_.L_4009b9
  %150 = phi i64 [ %.pre, %block_.L_4009b9 ], [ %269, %block_4009de ]
...
block_.L_400a20:                                  ; preds = %block_.L_4009d2
  ...
  %271 = load i32, i32* %159, align 4
  %272 = zext i32 %271 to i64
  store i64 %272, i64* %RAX.i145, align 8
  %273 = add i64 %187, 6
  store i64 %273, i64* %PC.i, align 8
  store i32 %271, i32* %154, align 4
  %.pre1 = load i64, i64* %PC.i, align 8
  br label %block_.L_400a26

block_.L_400a26:                                  ; preds = %block_.L_400a6b, %block_.L_400a20
  %274 = phi i64 [ %.pre1, %block_.L_400a20 ], [ %394, %block_.L_400a6b ]
...
block_400a30:                                     ; preds = %block_.L_400a26
  ...
  %301 = tail call %struct.Memory* @__remill_function_call(%struct.State* %0, i64 ptrtoint (i64 (i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64)* @sprintf to i64), %struct.Memory* %MEMORY.2)
  %302 = load i64, i64* %RBP.i, align 8
  %303 = add i64 %302, -64
  %304 = load i64, i64* %PC.i, align 8
  store i64 %303, i64* %RSI.i165, align 8
  %305 = add i64 %302, -72
  %306 = add i64 %304, 8
  store i64 %306, i64* %PC.i, align 8
  %307 = inttoptr i64 %305 to i64*
  %308 = load i64, i64* %307, align 8
  store i64 %308, i64* %RDI.i132.pre-phi, align 8
  %309 = add i64 %302, -88
  %310 = load i32, i32* %EAX.i135.pre-phi, align 4
  %311 = add i64 %304, 11
  ...
  %call2_400a53 = tail call %struct.Memory* @sub_400b90.ht_find(%struct.State* %0, i64 %314, %struct.Memory* %301)
  %319 = load i64, i64* %RAX.i145, align 8
  ...
  store i8 0, i8* %38, align 1
  %.v7 = select i1 %327, i64 19, i64 10
  %331 = add i64 %320, %.v7
  store i64 %331, i64* %3, align 8
  br i1 %327, label %block_.L_400a6b, label %block_400a62
...
block_400a62:                                     ; preds = %block_400a30
  ...
  store i64 %338, i64* %RAX.i145, align 8
...
block_.L_400a6b:                                  ; preds = %block_400a62, %block_400a30
  %362 = phi i64 [ %.pre2, %block_400a62 ], [ %331, %block_400a30 ]
...
block_.L_400a7e:                                  ; preds = %block_.L_400a26
  ...
  store i64 %398, i64* %RDI.i132.pre-phi, align 8
  %399 = add i64 %291, -446
  %400 = add i64 %291, 9
  ...
  %call2_400a82 = tail call %struct.Memory* @sub_4008c0.ht_destroy(%struct.State* %0, i64 %399, %struct.Memory* %MEMORY.2)
  ...
  store i64 %410, i64* %RSI.i165, align 8
  store i8 0, i8* %AL.i109, align 1
  %411 = add i64 %404, -1175
  %412 = add i64 %404, 20
  ...
  %416 = tail call %struct.Memory* @__remill_function_call(%struct.State* %0, i64 ptrtoint (i64 (i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64)* @printf to i64), %struct.Memory* %call2_400a82)
  ...
  %419 = add i64 %418, -92
  %420 = load i32, i32* %EAX.i135.pre-phi, align 4
  %421 = add i64 %417, 5
  store i64 %421, i64* %PC.i, align 8
  %422 = inttoptr i64 %419 to i32*
  store i32 %420, i32* %422, align 4
  %423 = load i32, i32* %ESI.i9, align 4
  %424 = zext i32 %423 to i64
  %425 = load i64, i64* %PC.i, align 8
  store i64 %424, i64* %RAX.i145, align 8
  %426 = load i64, i64* %RSP.i11, align 8
  %427 = add i64 %426, 96
  store i64 %427, i64* %RSP.i11, align 8
  %428 = icmp ugt i64 %426, -97
