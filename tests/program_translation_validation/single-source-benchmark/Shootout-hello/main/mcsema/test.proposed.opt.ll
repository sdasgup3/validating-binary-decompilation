...
entry:
  ...
  %49 = tail call %struct.Memory* @__remill_function_call(%struct.State* %0, i64 ptrtoint (i64 (i64)* @puts to i64), %struct.Memory* %2)
  ...
  %RAX.i = getelementptr inbounds %union.anon, %union.anon* %52, i64 0, i32 0
