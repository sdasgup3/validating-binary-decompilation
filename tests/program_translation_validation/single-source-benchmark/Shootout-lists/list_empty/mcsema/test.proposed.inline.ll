...
define %struct.Memory* @list_empty(%struct.State* noalias, i64, %struct.Memory* noalias) #2 {
entry:
  ...
  %PC.i10 = bitcast %union.anon* %113 to i64*
  ...
  %CL.i9 = getelementptr inbounds %struct.anon.2, %struct.anon.2* %147, i32 0, i32 0
  ...
  %CL.i7 = getelementptr inbounds %struct.anon.2, %struct.anon.2* %158, i32 0, i32 0
  %159 = load i8, i8* %CL.i7
  %160 = zext i8 %159 to i64
  %161 = load i64, i64* %PC.i6
  %162 = add i64 %161, 3
  store i64 %162, i64* %PC.i6
  %163 = and i64 1, %160
  %164 = trunc i64 %163 to i8
  store i8 %164, i8* %CL.i7, align 1
  ...
  %CL.i = getelementptr inbounds %struct.anon.2, %struct.anon.2* %185, i32 0, i32 0
  ...
  ret %struct.Memory* %loadMem_400786
}
