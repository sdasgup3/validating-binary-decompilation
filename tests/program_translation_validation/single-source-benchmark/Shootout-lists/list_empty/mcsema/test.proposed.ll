...
define %struct.Memory* @list_empty(%struct.State* noalias , i64, %struct.Memory* noalias) alwaysinline  {
entry:
  ...
  ; Code: .list_empty:	 RIP: 400730	 Bytes: 0
  ...
  ; Code: movq %rdi, -0x8(%rbp)	 RIP: 400738	 Bytes: 4
  %loadMem_400738 = load %struct.Memory*, %struct.Memory** %MEMORY
  %call_400738 = call %struct.Memory* @routine_movq__rdi__MINUS0x8__rbp_(%struct.State* %0, i64  0, %struct.Memory* %loadMem_400738)
  store %struct.Memory* %call_400738, %struct.Memory** %MEMORY

  ; Code: movq -0x8(%rbp), %rdi	 RIP: 40073c	 Bytes: 4
  %loadMem_40073c = load %struct.Memory*, %struct.Memory** %MEMORY
  %call_40073c = call %struct.Memory* @routine_movq_MINUS0x8__rbp____rdi(%struct.State* %0, i64  0, %struct.Memory* %loadMem_40073c)
  store %struct.Memory* %call_40073c, %struct.Memory** %MEMORY

  ; Code: callq .list_length	 RIP: 400740	 Bytes: 5
  %loadMem1_400740 = load %struct.Memory*, %struct.Memory** %MEMORY
  %call1_400740 = call %struct.Memory* @routine_callq_.list_length(%struct.State* %0, i64  0, %struct.Memory* %loadMem1_400740, i64 32, i64 5, i64 5)
  ...
  %call2_400740 = call %struct.Memory* @sub_400760.list_length(%struct.State* %0, i64  %loadPC_400740, %struct.Memory* %loadMem2_400740)
  store %struct.Memory* %call2_400740, %struct.Memory** %MEMORY

  ; Code: cmpl $0x0, %eax	 RIP: 400745	 Bytes: 3
  %loadMem_400745 = load %struct.Memory*, %struct.Memory** %MEMORY
  %call_400745 = call %struct.Memory* @routine_cmpl__0x0___eax(%struct.State* %0, i64  0, %struct.Memory* %loadMem_400745)
  store %struct.Memory* %call_400745, %struct.Memory** %MEMORY

  ; Code: sete %cl	 RIP: 400748	 Bytes: 3
  %loadMem_400748 = load %struct.Memory*, %struct.Memory** %MEMORY
  %call_400748 = call %struct.Memory* @routine_sete__cl(%struct.State* %0, i64  0, %struct.Memory* %loadMem_400748)
  store %struct.Memory* %call_400748, %struct.Memory** %MEMORY

  ; Code: andb $0x1, %cl	 RIP: 40074b	 Bytes: 3
  %loadMem_40074b = load %struct.Memory*, %struct.Memory** %MEMORY
  %call_40074b = call %struct.Memory* @routine_andb__0x1___cl(%struct.State* %0, i64  0, %struct.Memory* %loadMem_40074b)
  store %struct.Memory* %call_40074b, %struct.Memory** %MEMORY

  ; Code: movzbl %cl, %eax	 RIP: 40074e	 Bytes: 3
  %loadMem_40074e = load %struct.Memory*, %struct.Memory** %MEMORY
  %call_40074e = call %struct.Memory* @routine_movzbl__cl___eax(%struct.State* %0, i64  0, %struct.Memory* %loadMem_40074e)
  store %struct.Memory* %call_40074e, %struct.Memory** %MEMORY

  ; Code: addq $0x10, %rsp	 RIP: 400751	 Bytes: 4
  %loadMem_400751 = load %struct.Memory*, %struct.Memory** %MEMORY
  %call_400751 = call %struct.Memory* @routine_addq__0x10___rsp(%struct.State* %0, i64  0, %struct.Memory* %loadMem_400751)
  store %struct.Memory* %call_400751, %struct.Memory** %MEMORY

  ; Code: popq %rbp	 RIP: 400755	 Bytes: 1
  %loadMem_400755 = load %struct.Memory*, %struct.Memory** %MEMORY
  %call_400755 = call %struct.Memory* @routine_popq__rbp(%struct.State* %0, i64  0, %struct.Memory* %loadMem_400755)
  store %struct.Memory* %call_400755, %struct.Memory** %MEMORY

  ; Code: retq	 RIP: 400756	 Bytes: 1
  %loadMem_400756 = load %struct.Memory*, %struct.Memory** %MEMORY
  %call_400756 = call %struct.Memory* @routine_retq(%struct.State* %0, i64  0, %struct.Memory* %loadMem_400756)
  store %struct.Memory* %call_400756, %struct.Memory** %MEMORY

  ret %struct.Memory* %call_400756
}
