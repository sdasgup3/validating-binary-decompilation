...
define %struct.Memory* @list_length(%struct.State* noalias, i64, %struct.Memory* noalias) local_unnamed_addr #0 {
entry:
...
define %struct.Memory* @routine_movl___rdi____eax(%struct.State* dereferenceable(3376), i64, %struct.Memory*) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
