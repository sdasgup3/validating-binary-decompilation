...
entry:
  ...
  %103 = call %struct.Memory* @__remill_function_call(%struct.State* %0, i64 ptrtoint (i64 (i64)* @malloc to i64), %struct.Memory* %loadMem2_400a3f)
  ...
  ret %struct.Memory* %loadMem_400a73
}
