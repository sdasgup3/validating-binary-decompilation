...
define %struct.Memory* @list_pop_tail(%struct.State* noalias, i64, %struct.Memory* noalias readnone returned) local_unnamed_addr #1 {
entry:
  ...
  %call2_400700 = tail call %struct.Memory* @sub_400770.list_empty(%struct.State* %0, i64 %49, %struct.Memory* %2)
  ...
  br i1 %62, label %block_.L_40071b, label %block_40070e

block_40070e:                                     ; preds = %entry
...
block_.L_40075e:                                  ; preds = %block_.L_40071b, %block_40070e
  %RAX.i.pre-phi = phi i64* [ %RAX.i53, %block_.L_40071b ], [ %.pre1, %block_40070e ]
  %167 = phi i64 [ %.pre, %block_.L_40071b ], [ %72, %block_40070e ]
  ...
  ret %struct.Memory* %call2_400700
}
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_je_.L_40071b(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i8* nocapture %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_jmpq_.L_40075e(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
