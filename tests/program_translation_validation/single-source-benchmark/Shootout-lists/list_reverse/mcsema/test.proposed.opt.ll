...
define %struct.Memory* @list_reverse(%struct.State* noalias, i64, %struct.Memory* noalias) local_unnamed_addr #1 {
entry:
...
block_.L_400d10:                                  ; preds = %block_.L_400d10, %entry
  %30 = phi i64 [ %115, %block_.L_400d10 ], [ %.pre1, %entry ]
  %31 = phi i64 [ %80, %block_.L_400d10 ], [ %.pre, %entry ]
  %32 = add i64 %31, -24
  %33 = add i64 %30, 4
  ...
  br i1 %104, label %block_400d4e, label %block_.L_400d10
...
define %struct.Memory* @routine_jne_.L_400d10(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i8* %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
