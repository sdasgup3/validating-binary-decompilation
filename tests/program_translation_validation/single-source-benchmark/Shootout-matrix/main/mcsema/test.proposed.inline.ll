...
block_400830:                                     ; preds = %entry
  ...
  store %struct.Memory* %loadMem1_400838, %struct.Memory** %MEMORY
  %loadMem2_400838 = load %struct.Memory*, %struct.Memory** %MEMORY
  %loadPC_400838 = load i64, i64* %3
  %208 = call %struct.Memory* @__remill_function_call(%struct.State* %0, i64 ptrtoint (i64 (i64)* @atoi to i64), %struct.Memory* %loadMem2_400838)
...
block_.L_400852:                                  ; preds = %block_.L_400845, %block_400830
  ...
  store %struct.Memory* %loadMem1_400873, %struct.Memory** %MEMORY
...
block_.L_4008cd:                                  ; preds = %block_.L_400895
  ...
  store i64 ptrtoint (%G__0x4009c4_type* @G__0x4009c4 to i64), i64* %RDI.i60, align 8
  ...
  %980 = call %struct.Memory* @__remill_function_call(%struct.State* %0, i64 ptrtoint (i64 (i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64)* @printf to i64), %struct.Memory* %loadMem2_400904)
