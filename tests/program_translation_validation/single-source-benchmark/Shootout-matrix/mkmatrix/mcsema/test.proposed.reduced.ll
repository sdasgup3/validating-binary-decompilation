; ModuleID = '/tmp/tmpjklki43e-query.ll'
...
define %struct.Memory* @mkmatrix(%struct.State* noalias, i64, %struct.Memory* noalias returned) local_unnamed_addr #1 {
entry:
  %RBP.i = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 15, i32 0, i32 0
  %var_2_82 = tail call %struct.Memory* @__remill_function_call(%struct.State* %0, i64 ptrtoint (i64 (i64)* @malloc to i64), %struct.Memory* %2)
  %var_2_951 = load i64, i64* %RBP.i, align 8
  %var_2_962 = add i64 %var_2_951, -12
  %var_2_983 = inttoptr i64 %var_2_962 to i32*
  %var_2_994 = load i32, i32* %var_2_983, align 4
  %var_2_1015 = add i64 %var_2_951, -4
  %var_2_1036 = inttoptr i64 %var_2_1015 to i32*
  %var_2_1047 = load i32, i32* %var_2_1036, align 4
  %var_2_1058 = sub i32 %var_2_994, %var_2_1047
  %var_2_1209 = lshr i32 %var_2_1058, 31
  %var_2_12210 = lshr i32 %var_2_994, 31
  %var_2_12311 = lshr i32 %var_2_1047, 31
  %var_2_12412 = xor i32 %var_2_12311, %var_2_12210
  %var_2_12513 = xor i32 %var_2_1209, %var_2_12210
  %var_2_12614 = add nuw nsw i32 %var_2_12513, %var_2_12412
  %var_2_12715 = icmp eq i32 %var_2_12614, 2
  %var_2_12916 = icmp ne i32 %var_2_1209, 0
  %var_2_13017 = xor i1 %var_2_12916, %var_2_12715
  br i1 %var_2_13017, label %block_40062c.preheader, label %block_.L_40069a

block_40062c.preheader:                           ; preds = %entry
  br label %block_40062c

block_40062c:                                     ; preds = %block_40062c.preheader, %block_40062c.block_.L_400620.loopexit.split_crit_edge
  %MEMORY.018 = phi %struct.Memory* [ %var_2_155, %block_40062c.block_.L_400620.loopexit.split_crit_edge ], [ %var_2_82, %block_40062c.preheader ]
  %var_2_155 = tail call %struct.Memory* @__remill_function_call(%struct.State* nonnull %0, i64 ptrtoint (i64 (i64)* @malloc to i64), %struct.Memory* %MEMORY.018)
  %var_2_178 = load i64, i64* %RBP.i, align 8
  %var_2_179 = add i64 %var_2_178, -16
  %var_2_181 = inttoptr i64 %var_2_179 to i32*
  %var_2_182 = load i32, i32* %var_2_181, align 4
  %var_2_184 = add i64 %var_2_178, -8
  %var_2_186 = inttoptr i64 %var_2_184 to i32*
  %var_2_187 = load i32, i32* %var_2_186, align 4
  %var_2_188 = sub i32 %var_2_182, %var_2_187
  %var_2_203 = lshr i32 %var_2_188, 31
  %var_2_205 = lshr i32 %var_2_182, 31
  %var_2_206 = lshr i32 %var_2_187, 31
  %var_2_207 = xor i32 %var_2_206, %var_2_205
  %var_2_208 = xor i32 %var_2_203, %var_2_205
  %var_2_209 = add nuw nsw i32 %var_2_208, %var_2_207
  %var_2_210 = icmp eq i32 %var_2_209, 2
  %var_2_212 = icmp ne i32 %var_2_203, 0
  %var_2_213 = xor i1 %var_2_212, %var_2_210
  br i1 %var_2_213, label %block_.L_40064f.preheader, label %block_40062c.block_.L_400620.loopexit.split_crit_edge

block_.L_40064f.preheader:                        ; preds = %block_40062c
  br label %block_.L_40064f

block_40062c.block_.L_400620.loopexit.split_crit_edge: ; preds = %block_40062c
  %var_2_96 = add i64 %var_2_178, -12
  %var_2_98 = inttoptr i64 %var_2_96 to i32*
  %var_2_99 = load i32, i32* %var_2_98, align 4
  %var_2_101 = add i64 %var_2_178, -4
  %var_2_103 = inttoptr i64 %var_2_101 to i32*
  %var_2_104 = load i32, i32* %var_2_103, align 4
  %var_2_105 = sub i32 %var_2_99, %var_2_104
  %var_2_120 = lshr i32 %var_2_105, 31
  %var_2_122 = lshr i32 %var_2_99, 31
  %var_2_123 = lshr i32 %var_2_104, 31
  %var_2_124 = xor i32 %var_2_123, %var_2_122
  %var_2_125 = xor i32 %var_2_120, %var_2_122
  %var_2_126 = add nuw nsw i32 %var_2_125, %var_2_124
  %var_2_127 = icmp eq i32 %var_2_126, 2
  %var_2_129 = icmp ne i32 %var_2_120, 0
  %var_2_130 = xor i1 %var_2_129, %var_2_127
  br i1 %var_2_130, label %block_40062c, label %block_.L_40069a.loopexit

block_.L_40064f:                                  ; preds = %block_.L_40064f.preheader, %block_.L_40064f
  br label %block_.L_40064f

block_.L_40069a.loopexit:                         ; preds = %block_40062c.block_.L_400620.loopexit.split_crit_edge
  br label %block_.L_40069a

block_.L_40069a:                                  ; preds = %block_.L_40069a.loopexit, %entry
...
; Function Attrs: alwaysinline norecurse nounwind
define %struct.Memory* @routine_jmpq_.L_40068c(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
...
; Function Attrs: alwaysinline norecurse nounwind
define %struct.Memory* @routine_jmpq_.L_400620(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
