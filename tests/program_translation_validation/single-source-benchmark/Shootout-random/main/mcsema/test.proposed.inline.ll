...
@G__0x4006d8 = global %G__0x4006d8_type zeroinitializer
...
block_.L_400572:                                  ; preds = %block_.L_400565, %block_400550
  ...
  br label %block_.L_40057b

block_.L_40057b:                                  ; preds = %block_40058f, %block_.L_400572
  ...
  %loadBr_400589 = load i8, i8* %BRANCH_TAKEN
  %cmpBr_400589 = icmp eq i8 %loadBr_400589, 1
  br i1 %cmpBr_400589, label %block_.L_4005a6, label %block_40058f

block_40058f:                                     ; preds = %block_.L_40057b
  ...
  %call2_400597 = call %struct.Memory* @sub_4005e0.gen_random(%struct.State* %0, i64 %loadPC_400597, %struct.Memory* %loadMem2_400597)
...
block_.L_4005a6:                                  ; preds = %block_.L_40057b
  ...
  %call2_4005ae = call %struct.Memory* @sub_4005e0.gen_random(%struct.State* %0, i64 %loadPC_4005ae, %struct.Memory* %loadMem2_4005ae)
  ...
  store i64 ptrtoint (%G__0x4006d8_type* @G__0x4006d8 to i64), i64* %RDI.i, align 8
  ...
  %577 = call %struct.Memory* @__remill_function_call(%struct.State* %0, i64 ptrtoint (i64 (i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64)* @printf to i64), %struct.Memory* %loadMem2_4005bf)
...
define %struct.Memory* @routine_je_.L_4005a6(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i8* %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) {
block_400478:
  %3 = getelementptr inbounds %struct.State, %struct.State* %0, i32 0, i32 6
  %4 = getelementptr inbounds %struct.GPR, %struct.GPR* %3, i32 0, i32 33
  %5 = getelementptr inbounds %struct.Reg, %struct.Reg* %4, i32 0, i32 0
...
define %struct.Memory* @routine_jmpq_.L_40057b(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i64 %rel_off1, i64 %rel_off2) {
block_400478:
  %3 = getelementptr inbounds %struct.State, %struct.State* %0, i32 0, i32 6
  %4 = getelementptr inbounds %struct.GPR, %struct.GPR* %3, i32 0, i32 33
  %5 = getelementptr inbounds %struct.Reg, %struct.Reg* %4, i32 0, i32 0
...
define %struct.Memory* @routine_movq__0x4006d8___rdi(%struct.State* dereferenceable(3376), i64, %struct.Memory*) {
block_400478:
  %3 = getelementptr inbounds %struct.State, %struct.State* %0, i32 0, i32 6
  %4 = getelementptr inbounds %struct.GPR, %struct.GPR* %3, i32 0, i32 33
  %5 = getelementptr inbounds %struct.Reg, %struct.Reg* %4, i32 0, i32 0
  ...
  %10 = add i64 %9, 10
  store i64 %10, i64* %PC
  store i64 ptrtoint (%G__0x4006d8_type* @G__0x4006d8 to i64), i64* %RDI, align 8
  ret %struct.Memory* %2
}
