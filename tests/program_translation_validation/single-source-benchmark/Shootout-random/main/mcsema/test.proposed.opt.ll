...
entry:
  ...
  %RAX.i51 = getelementptr inbounds %union.anon, %union.anon* %84, i64 0, i32 0
...
block_400550:                                     ; preds = %entry
  ...
  store i64 %88, i64* %RAX.i51, align 8
  %RDI.i61 = getelementptr inbounds %union.anon, %union.anon* %43, i64 0, i32 0
  %89 = add i64 %88, 8
  %90 = add i64 %83, 8
  store i64 %90, i64* %PC.i, align 8
  %91 = inttoptr i64 %89 to i64*
  %92 = load i64, i64* %91, align 8
  store i64 %92, i64* %RDI.i61, align 8
  %93 = add i64 %83, -288
  %94 = add i64 %83, 13
  ...
  %EAX.i54 = bitcast %union.anon* %84 to i32*
  %99 = load i64, i64* %RBP.i, align 8
  %100 = load i32, i32* %EAX.i54, align 4
...
block_.L_400565:                                  ; preds = %entry
  ...
  %EAX.i48 = bitcast %union.anon* %84 to i32*
  br label %block_.L_400572

block_.L_400572:                                  ; preds = %block_.L_400565, %block_400550
  %.sink8 = phi i64 [ %102, %block_.L_400565 ], [ %101, %block_400550 ]
  %.sink6.in = phi i64 [ %56, %block_.L_400565 ], [ %99, %block_400550 ]
  %.sink = phi i32 [ 400000000, %block_.L_400565 ], [ %100, %block_400550 ]
  %.sink4 = phi i64 [ 5, %block_.L_400565 ], [ 18, %block_400550 ]
  %EAX.i39.pre-phi = phi i32* [ %EAX.i48, %block_.L_400565 ], [ %EAX.i54, %block_400550 ]
  %MEMORY.0 = phi %struct.Memory* [ %2, %block_.L_400565 ], [ %98, %block_400550 ]
  %.sink6 = add i64 %.sink6.in, -24
  %103 = add i64 %.sink8, 3
  ...
  store i64 %113, i64* %RAX.i51, align 8
  ...
  %137 = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 5, i32 0
  %RCX.i34 = getelementptr inbounds %union.anon, %union.anon* %137, i64 0, i32 0
  %ECX.i28 = bitcast %union.anon* %137 to i32*
  %138 = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 1, i64 0
...
block_.L_40057b:                                  ; preds = %block_40058f, %block_.L_400572
  %141 = phi i64 [ %.pre, %block_.L_400572 ], [ %179, %block_40058f ]
  %MEMORY.1 = phi %struct.Memory* [ %MEMORY.0, %block_.L_400572 ], [ %call2_400597, %block_40058f ]
  ...
  store i64 %149, i64* %RCX.i34, align 8
  %150 = add i64 %141, 11
  store i64 %150, i64* %PC.i, align 8
  store i32 %148, i32* %145, align 4
  %151 = load i32, i32* %EAX.i39.pre-phi, align 4
  ...
  %.v9 = select i1 %158, i64 32, i64 9
  %162 = add i64 %152, %.v9
  %163 = add i64 %162, 8
  store i64 %163, i64* %PC.i, align 8
  br i1 %158, label %block_.L_4005a6, label %block_40058f

block_40058f:                                     ; preds = %block_.L_40057b
  %164 = load i64, i64* inttoptr (i64 add (i64 ptrtoint (%G_0x131__rip__type* @G_0x131__rip_ to i64), i64 105) to i64*), align 8
  %165 = getelementptr inbounds %union.VectorReg, %union.VectorReg* %138, i64 0, i32 0, i32 0, i32 0, i64 0
  ...
  %call2_400597 = tail call %struct.Memory* @sub_4005e0.gen_random(%struct.State* %0, i64 %166, %struct.Memory* %MEMORY.1)
  %171 = load i64, i64* %RBP.i, align 8
  %172 = add i64 %171, -32
  %173 = load i64, i64* %PC.i, align 8
  %174 = add i64 %173, 5
  store i64 %174, i64* %PC.i, align 8
  %175 = getelementptr inbounds %union.VectorReg, %union.VectorReg* %138, i64 0, i32 0, i32 0, i32 0, i64 0
...
block_.L_4005a6:                                  ; preds = %block_.L_40057b
  %180 = load i64, i64* inttoptr (i64 add (i64 ptrtoint (%G_0x11a__rip__type* @G_0x11a__rip_ to i64), i64 82) to i64*), align 8
  %181 = getelementptr inbounds %union.VectorReg, %union.VectorReg* %138, i64 0, i32 0, i32 0, i32 0, i64 0
  ...
  %call2_4005ae = tail call %struct.Memory* @sub_4005e0.gen_random(%struct.State* %0, i64 %182, %struct.Memory* %MEMORY.1)
  ...
  %193 = tail call %struct.Memory* @__remill_function_call(%struct.State* %0, i64 ptrtoint (i64 (i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64)* @printf to i64), %struct.Memory* %call2_4005ae)
  %194 = load i64, i64* %PC.i, align 8
  store i64 0, i64* %RCX.i34, align 8
  %195 = load i64, i64* %RBP.i, align 8
  %196 = add i64 %195, -36
  %197 = load i32, i32* %EAX.i39.pre-phi, align 4
  %198 = add i64 %194, 5
  store i64 %198, i64* %PC.i, align 8
  %199 = inttoptr i64 %196 to i32*
  store i32 %197, i32* %199, align 4
  %200 = load i32, i32* %ECX.i28, align 4
  %201 = zext i32 %200 to i64
  %202 = load i64, i64* %PC.i, align 8
  store i64 %201, i64* %RAX.i51, align 8
  %203 = load i64, i64* %RSP.i11, align 8
  %204 = add i64 %203, 48
  store i64 %204, i64* %RSP.i11, align 8
...
define %struct.Memory* @routine_movl__0x17d78400___eax(%struct.State* dereferenceable(3376), i64, %struct.Memory*) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %RAX = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 1, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
...
define %struct.Memory* @routine_je_.L_4005a6(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i8* %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 2, i32 7
...
define %struct.Memory* @routine_movsd_0x131__rip____xmm0(%struct.State* dereferenceable(3376), i64, %struct.Memory*) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, 8
...
define %struct.Memory* @routine_callq_.gen_random(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
...
define %struct.Memory* @routine_jmpq_.L_40057b(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
...
define %struct.Memory* @routine_movsd_0x11a__rip____xmm0(%struct.State* dereferenceable(3376), i64, %struct.Memory*) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, 8
...
define %struct.Memory* @routine_movq__0x4006d8___rdi(%struct.State* dereferenceable(3376), i64, %struct.Memory*) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %RDI = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 11, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
