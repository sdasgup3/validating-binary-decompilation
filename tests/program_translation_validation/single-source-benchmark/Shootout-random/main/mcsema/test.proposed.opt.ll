...
block_.L_40057b:                                  ; preds = %block_40058f, %block_.L_400572
  %141 = phi i64 [ %.pre, %block_.L_400572 ], [ %178, %block_40058f ]
...
block_.L_4005a6:                                  ; preds = %block_.L_40057b
  %179 = load i64, i64* inttoptr (i64 add (i64 ptrtoint (%G_0x11a__rip__type* @G_0x11a__rip_ to i64), i64 82) to i64*), align 8
  %180 = getelementptr inbounds %union.VectorReg, %union.VectorReg* %138, i64 0, i32 0, i32 0, i32 0, i64 0
  ...
  %call2_4005ae = tail call %struct.Memory* @sub_4005e0.gen_random(%struct.State* %0, i64 %181, %struct.Memory* %MEMORY.1)
  ...
  %192 = tail call %struct.Memory* @__remill_function_call(%struct.State* %0, i64 ptrtoint (i64 (i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64)* @printf to i64), %struct.Memory* %call2_4005ae)
  %193 = load i64, i64* %3, align 8
  store i64 0, i64* %RCX.i34, align 8
  %194 = load i64, i64* %RBP.i, align 8
  %195 = add i64 %194, -36
  %196 = load i32, i32* %EAX.i39.pre-phi, align 4
  %197 = add i64 %193, 5
  store i64 %197, i64* %3, align 8
  %198 = inttoptr i64 %195 to i32*
  store i32 %196, i32* %198, align 4
  %199 = load i32, i32* %ECX.i28, align 4
