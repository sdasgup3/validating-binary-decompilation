...
declare %struct.Memory* @sub_400580.Makenull(%struct.State* noalias dereferenceable(3376), i64, %struct.Memory* noalias readnone returned)

declare %struct.Memory* @sub_400600.Push(%struct.State* noalias dereferenceable(3376), i64, %struct.Memory* noalias readnone returned)
...
entry:
  ...
  %loadMem1_4006c1 = load %struct.Memory*, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem1_4006c1, %struct.Memory** %MEMORY
  %loadMem2_4006c1 = load %struct.Memory*, %struct.Memory** %MEMORY
  %loadPC_4006c1 = load i64, i64* %3
  %call2_4006c1 = call %struct.Memory* @sub_400580.Makenull(%struct.State* %0, i64 %loadPC_4006c1, %struct.Memory* %loadMem2_4006c1)
  store %struct.Memory* %call2_4006c1, %struct.Memory** %MEMORY
...
block_.L_4006cc:                                  ; preds = %block_4006d6, %entry
  ...
  br i1 %cmpBr_4006d0, label %block_.L_4006ef, label %block_4006d6

block_4006d6:                                     ; preds = %block_.L_4006cc
  ...
  store %struct.Memory* %loadMem1_4006dc, %struct.Memory** %MEMORY
  %loadMem2_4006dc = load %struct.Memory*, %struct.Memory** %MEMORY
  %loadPC_4006dc = load i64, i64* %3
  %call2_4006dc = call %struct.Memory* @sub_400600.Push(%struct.State* %0, i64 %loadPC_4006dc, %struct.Memory* %loadMem2_4006dc)
...
block_.L_4006ef:                                  ; preds = %block_.L_4006cc
  ...
  ret %struct.Memory* %loadMem_4006f4
}
...
define %struct.Memory* @routine_jl_.L_4006ef(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i8* %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) {
block_400478:
  %3 = getelementptr inbounds %struct.State, %struct.State* %0, i32 0, i32 6
  %4 = getelementptr inbounds %struct.GPR, %struct.GPR* %3, i32 0, i32 33
  %5 = getelementptr inbounds %struct.Reg, %struct.Reg* %4, i32 0, i32 0
