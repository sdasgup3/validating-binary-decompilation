...
declare %struct.Memory* @sub_4005a0.Makenull(%struct.State* noalias dereferenceable(3376), i64, %struct.Memory* noalias) local_unnamed_addr

declare %struct.Memory* @sub_400620.Push(%struct.State* noalias dereferenceable(3376), i64, %struct.Memory* noalias) local_unnamed_addr
...
entry:
  ...
  %call2_4006e1 = tail call %struct.Memory* @sub_4005a0.Makenull(%struct.State* %0, i64 %59, %struct.Memory* %2)
...
block_.L_4006ec:                                  ; preds = %block_4006f6, %entry
  %74 = phi i64 [ %.pre, %entry ], [ %149, %block_4006f6 ]
  %MEMORY.0 = phi %struct.Memory* [ %call2_4006e1, %entry ], [ %call2_4006fc, %block_4006f6 ]
  ...
  br i1 %102, label %block_.L_40070f, label %block_4006f6
...
block_4006f6:                                     ; preds = %block_.L_4006ec
  ...
  %call2_4006fc = tail call %struct.Memory* @sub_400620.Push(%struct.State* nonnull %0, i64 %112, %struct.Memory* %MEMORY.0)
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_jl_.L_40070f(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i8* nocapture %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
