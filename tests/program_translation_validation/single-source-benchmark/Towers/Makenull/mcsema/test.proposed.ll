...
entry:
  ...
  ; Code: .Makenull:	 RIP: 400580	 Bytes: 0
  ...
  ; Code: movslq -0x4(%rbp), %rax	 RIP: 400587	 Bytes: 4
  %loadMem_400587 = load %struct.Memory*, %struct.Memory** %MEMORY
  %call_400587 = call %struct.Memory* @routine_movslq_MINUS0x4__rbp____rax(%struct.State* %0, i64  0, %struct.Memory* %loadMem_400587)
  store %struct.Memory* %call_400587, %struct.Memory** %MEMORY

  ; Code: movl $0x0, 0x6181d0(,%rax,4)	 RIP: 40058b	 Bytes: 11
  %loadMem_40058b = load %struct.Memory*, %struct.Memory** %MEMORY
  %call_40058b = call %struct.Memory* @routine_movl__0x0__0x6181d0___rax_4_(%struct.State* %0, i64  0, %struct.Memory* %loadMem_40058b)
