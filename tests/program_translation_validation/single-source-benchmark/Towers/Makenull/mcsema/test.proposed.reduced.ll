; ModuleID = '/tmp/tmp0vbzhiwq-query.ll'
...
define %struct.Memory* @Makenull(%struct.State* noalias nocapture readonly, i64, %struct.Memory* noalias readnone returned) local_unnamed_addr #0 {
entry:
  %RBP.i = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 15, i32 0, i32 0
  %var_2_16 = load i64, i64* %RBP.i, align 8
  %var_2_17 = add i64 %var_2_16, -4
  %var_2_20 = inttoptr i64 %var_2_17 to i32*
  %var_2_21 = load i32, i32* %var_2_20, align 4
  %var_2_22 = sext i32 %var_2_21 to i64
  %var_2_23 = shl nsw i64 %var_2_22, 2
  %var_2_24 = add nsw i64 %var_2_23, 6390224
  %var_2_26 = inttoptr i64 %var_2_24 to i32*
