...
declare %struct.Memory* @sub_400880.Towers(%struct.State* noalias dereferenceable(3376), i64, %struct.Memory* noalias) local_unnamed_addr
...
block_.L_400966:                                  ; preds = %block_400970, %entry
  %48 = phi i64 [ %.pre, %entry ], [ %114, %block_400970 ]
  %MEMORY.0 = phi %struct.Memory* [ %2, %entry ], [ %call2_400970, %block_400970 ]
  ...
  br i1 %76, label %block_400970, label %block_.L_400983
...
block_400970:                                     ; preds = %block_.L_400966
  ...
  %call2_400970 = tail call %struct.Memory* @sub_400880.Towers(%struct.State* nonnull %0, i64 %78, %struct.Memory* %MEMORY.0)
...
block_.L_400983:                                  ; preds = %block_.L_400966
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_jge_.L_400983(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i8* nocapture %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_callq_.Towers(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
