...
declare %struct.Memory* @sub_400860.Towers(%struct.State* noalias dereferenceable(3376), i64, %struct.Memory* noalias readnone returned) local_unnamed_addr
...
block_.L_400946:                                  ; preds = %block_400950, %entry
  %48 = phi i64 [ %.pre, %entry ], [ %115, %block_400950 ]
  %MEMORY.0 = phi %struct.Memory* [ %2, %entry ], [ %call2_400950, %block_400950 ]
  ...
  br i1 %76, label %block_400950, label %block_.L_400963

block_400950:                                     ; preds = %block_.L_400946
  %78 = add i64 %77, -240
  %79 = add i64 %77, 5
  ...
  %call2_400950 = tail call %struct.Memory* @sub_400860.Towers(%struct.State* %0, i64 %78, %struct.Memory* %MEMORY.0)
...
block_.L_400963:                                  ; preds = %block_.L_400946
...
define %struct.Memory* @routine_jge_.L_400963(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i8* %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
...
define %struct.Memory* @routine_callq_.Towers(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
...
define %struct.Memory* @routine_jmpq_.L_400946(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
