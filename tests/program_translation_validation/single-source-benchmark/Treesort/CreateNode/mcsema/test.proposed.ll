...
define %struct.Memory* @CreateNode(%struct.State* noalias , i64, %struct.Memory* noalias) alwaysinline  {
entry:
  ...
  ; Code: .CreateNode:	 RIP: 4006a0	 Bytes: 0
  ...
  ; Code: movl $0x18, %eax	 RIP: 4006a8	 Bytes: 5
  %loadMem_4006a8 = load %struct.Memory*, %struct.Memory** %MEMORY
  %call_4006a8 = call %struct.Memory* @routine_movl__0x18___eax(%struct.State* %0, i64  0, %struct.Memory* %loadMem_4006a8)
  store %struct.Memory* %call_4006a8, %struct.Memory** %MEMORY

  ; Code: movl %eax, %ecx	 RIP: 4006ad	 Bytes: 2
  %loadMem_4006ad = load %struct.Memory*, %struct.Memory** %MEMORY
  %call_4006ad = call %struct.Memory* @routine_movl__eax___ecx(%struct.State* %0, i64  0, %struct.Memory* %loadMem_4006ad)
  store %struct.Memory* %call_4006ad, %struct.Memory** %MEMORY

  ; Code: movq %rdi, -0x8(%rbp)	 RIP: 4006af	 Bytes: 4
  %loadMem_4006af = load %struct.Memory*, %struct.Memory** %MEMORY
  %call_4006af = call %struct.Memory* @routine_movq__rdi__MINUS0x8__rbp_(%struct.State* %0, i64  0, %struct.Memory* %loadMem_4006af)
  store %struct.Memory* %call_4006af, %struct.Memory** %MEMORY

  ; Code: movl %esi, -0xc(%rbp)	 RIP: 4006b3	 Bytes: 3
  %loadMem_4006b3 = load %struct.Memory*, %struct.Memory** %MEMORY
  %call_4006b3 = call %struct.Memory* @routine_movl__esi__MINUS0xc__rbp_(%struct.State* %0, i64  0, %struct.Memory* %loadMem_4006b3)
  store %struct.Memory* %call_4006b3, %struct.Memory** %MEMORY

  ; Code: movq %rcx, %rdi	 RIP: 4006b6	 Bytes: 3
  %loadMem_4006b6 = load %struct.Memory*, %struct.Memory** %MEMORY
  %call_4006b6 = call %struct.Memory* @routine_movq__rcx___rdi(%struct.State* %0, i64  0, %struct.Memory* %loadMem_4006b6)
  store %struct.Memory* %call_4006b6, %struct.Memory** %MEMORY

  ; Code: callq .malloc_plt	 RIP: 4006b9	 Bytes: 5
  %loadMem1_4006b9 = load %struct.Memory*, %struct.Memory** %MEMORY
  %call1_4006b9 = call %struct.Memory* @routine_callq_.malloc_plt(%struct.State* %0, i64  0, %struct.Memory* %loadMem1_4006b9, i64 -633, i64 5, i64 5)
  ...
  %call2_4006b9 = call %struct.Memory* @ext_malloc(%struct.State* %0, i64  %loadPC_4006b9, %struct.Memory* %loadMem2_4006b9)
  store %struct.Memory* %call2_4006b9, %struct.Memory** %MEMORY

  ; Code: movq -0x8(%rbp), %rcx	 RIP: 4006be	 Bytes: 4
  %loadMem_4006be = load %struct.Memory*, %struct.Memory** %MEMORY
  %call_4006be = call %struct.Memory* @routine_movq_MINUS0x8__rbp____rcx(%struct.State* %0, i64  0, %struct.Memory* %loadMem_4006be)
  store %struct.Memory* %call_4006be, %struct.Memory** %MEMORY

  ; Code: movq %rax, (%rcx)	 RIP: 4006c2	 Bytes: 3
  %loadMem_4006c2 = load %struct.Memory*, %struct.Memory** %MEMORY
  %call_4006c2 = call %struct.Memory* @routine_movq__rax____rcx_(%struct.State* %0, i64  0, %struct.Memory* %loadMem_4006c2)
  store %struct.Memory* %call_4006c2, %struct.Memory** %MEMORY

  ; Code: movq -0x8(%rbp), %rax	 RIP: 4006c5	 Bytes: 4
  %loadMem_4006c5 = load %struct.Memory*, %struct.Memory** %MEMORY
  %call_4006c5 = call %struct.Memory* @routine_movq_MINUS0x8__rbp____rax(%struct.State* %0, i64  0, %struct.Memory* %loadMem_4006c5)
  store %struct.Memory* %call_4006c5, %struct.Memory** %MEMORY

  ; Code: movq (%rax), %rax	 RIP: 4006c9	 Bytes: 3
  %loadMem_4006c9 = load %struct.Memory*, %struct.Memory** %MEMORY
  %call_4006c9 = call %struct.Memory* @routine_movq___rax____rax(%struct.State* %0, i64  0, %struct.Memory* %loadMem_4006c9)
  store %struct.Memory* %call_4006c9, %struct.Memory** %MEMORY

  ; Code: movq $0x0, (%rax)	 RIP: 4006cc	 Bytes: 7
  %loadMem_4006cc = load %struct.Memory*, %struct.Memory** %MEMORY
  %call_4006cc = call %struct.Memory* @routine_movq__0x0____rax_(%struct.State* %0, i64  0, %struct.Memory* %loadMem_4006cc)
  store %struct.Memory* %call_4006cc, %struct.Memory** %MEMORY

  ; Code: movq -0x8(%rbp), %rax	 RIP: 4006d3	 Bytes: 4
  %loadMem_4006d3 = load %struct.Memory*, %struct.Memory** %MEMORY
  %call_4006d3 = call %struct.Memory* @routine_movq_MINUS0x8__rbp____rax(%struct.State* %0, i64  0, %struct.Memory* %loadMem_4006d3)
  store %struct.Memory* %call_4006d3, %struct.Memory** %MEMORY

  ; Code: movq (%rax), %rax	 RIP: 4006d7	 Bytes: 3
  %loadMem_4006d7 = load %struct.Memory*, %struct.Memory** %MEMORY
  %call_4006d7 = call %struct.Memory* @routine_movq___rax____rax(%struct.State* %0, i64  0, %struct.Memory* %loadMem_4006d7)
  store %struct.Memory* %call_4006d7, %struct.Memory** %MEMORY

  ; Code: movq $0x0, 0x8(%rax)	 RIP: 4006da	 Bytes: 8
  %loadMem_4006da = load %struct.Memory*, %struct.Memory** %MEMORY
  %call_4006da = call %struct.Memory* @routine_movq__0x0__0x8__rax_(%struct.State* %0, i64  0, %struct.Memory* %loadMem_4006da)
  store %struct.Memory* %call_4006da, %struct.Memory** %MEMORY

  ; Code: movl -0xc(%rbp), %esi	 RIP: 4006e2	 Bytes: 3
  %loadMem_4006e2 = load %struct.Memory*, %struct.Memory** %MEMORY
  %call_4006e2 = call %struct.Memory* @routine_movl_MINUS0xc__rbp____esi(%struct.State* %0, i64  0, %struct.Memory* %loadMem_4006e2)
  store %struct.Memory* %call_4006e2, %struct.Memory** %MEMORY

  ; Code: movq -0x8(%rbp), %rax	 RIP: 4006e5	 Bytes: 4
  %loadMem_4006e5 = load %struct.Memory*, %struct.Memory** %MEMORY
  %call_4006e5 = call %struct.Memory* @routine_movq_MINUS0x8__rbp____rax(%struct.State* %0, i64  0, %struct.Memory* %loadMem_4006e5)
  store %struct.Memory* %call_4006e5, %struct.Memory** %MEMORY

  ; Code: movq (%rax), %rax	 RIP: 4006e9	 Bytes: 3
  %loadMem_4006e9 = load %struct.Memory*, %struct.Memory** %MEMORY
  %call_4006e9 = call %struct.Memory* @routine_movq___rax____rax(%struct.State* %0, i64  0, %struct.Memory* %loadMem_4006e9)
  store %struct.Memory* %call_4006e9, %struct.Memory** %MEMORY

  ; Code: movl %esi, 0x10(%rax)	 RIP: 4006ec	 Bytes: 3
  %loadMem_4006ec = load %struct.Memory*, %struct.Memory** %MEMORY
  %call_4006ec = call %struct.Memory* @routine_movl__esi__0x10__rax_(%struct.State* %0, i64  0, %struct.Memory* %loadMem_4006ec)
...
define %struct.Memory* @routine_movl__esi__0x10__rax_(%struct.State*  dereferenceable(3376), i64, %struct.Memory* ) #19 {
block_400478:
  %3 = getelementptr inbounds %struct.State, %struct.State* %0, i32 0, i32 6
  %4 = getelementptr inbounds %struct.GPR, %struct.GPR* %3, i32 0, i32 33
  %5 = getelementptr inbounds %struct.Reg, %struct.Reg* %4, i32 0, i32 0
