...
block_.L_4008fa:                                  ; preds = %block_400907, %entry
  %80 = phi i64 [ %.pre, %entry ], [ %157, %block_400907 ]
...
block_.L_40092d:                                  ; preds = %block_.L_4008fa
  ...
  store i64 %163, i64* %RAX.i75, align 8
  ...
  %196 = tail call %struct.Memory* @__remill_function_call(%struct.State* %0, i64 ptrtoint (i64 (i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64)* @printf to i64), %struct.Memory* %MEMORY.0)
  %197 = load i64, i64* %PC.i, align 8
  %198 = load i64, i64* bitcast (%G_0x6181d8_type* @G_0x6181d8 to i64*), align 8
  store i64 %198, i64* %RDI.i80, align 8
  %199 = load i64, i64* %RBP.i, align 8
  %200 = add i64 %199, -12
  %201 = load i32, i32* %EAX.i39, align 4
  %202 = add i64 %197, 11
  ...
  %call2_400959 = tail call %struct.Memory* @sub_4007b0.Checktree(%struct.State* %0, i64 %205, %struct.Memory* %196)
...
block_400967:                                     ; preds = %block_.L_40092d
  ...
  %227 = tail call %struct.Memory* @__remill_function_call(%struct.State* %0, i64 ptrtoint (i64 (i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64)* @printf to i64), %struct.Memory* %call2_400959)
  %228 = load i64, i64* %RBP.i, align 8
  %229 = add i64 %228, -16
  %230 = load i32, i32* %EAX.i39, align 4
...
block_.L_40097b:                                  ; preds = %block_.L_40092d, %block_400967
  %234 = phi i64 [ %221, %block_.L_40092d ], [ %.pre1, %block_400967 ]
  %MEMORY.1 = phi %struct.Memory* [ %call2_400959, %block_.L_40092d ], [ %227, %block_400967 ]
  %235 = load i64, i64* %RSP.i8, align 8
  %236 = add i64 %235, 16
  store i64 %236, i64* %RSP.i8, align 8
  %237 = icmp ugt i64 %235, -17
