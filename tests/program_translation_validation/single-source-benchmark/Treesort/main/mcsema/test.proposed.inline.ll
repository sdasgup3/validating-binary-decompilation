...
declare %struct.Memory* @sub_4008a0.Trees(%struct.State* noalias dereferenceable(3376), i64, %struct.Memory* noalias readnone returned)
...
block_.L_4009a6:                                  ; preds = %block_4009b0, %entry
  ...
  br i1 %cmpBr_4009aa, label %block_.L_4009c6, label %block_4009b0
...
block_4009b0:                                     ; preds = %block_.L_4009a6
  ...
  %call2_4009b3 = call %struct.Memory* @sub_4008a0.Trees(%struct.State* %0, i64 %loadPC_4009b3, %struct.Memory* %loadMem2_4009b3)
...
block_.L_4009c6:                                  ; preds = %block_.L_4009a6
  ...
  ret %struct.Memory* %loadMem_4009cd
}
...
define %struct.Memory* @routine_jge_.L_4009c6(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i8* %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) {
block_400478:
  %3 = getelementptr inbounds %struct.State, %struct.State* %0, i32 0, i32 6
  %4 = getelementptr inbounds %struct.GPR, %struct.GPR* %3, i32 0, i32 33
  %5 = getelementptr inbounds %struct.Reg, %struct.Reg* %4, i32 0, i32 0
