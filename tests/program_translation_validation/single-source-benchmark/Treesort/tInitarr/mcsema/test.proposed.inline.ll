...
declare %struct.Memory* @sub_400550.Initrand(%struct.State* dereferenceable(3376), i64, %struct.Memory*)

declare %struct.Memory* @sub_400570.Rand(%struct.State* dereferenceable(3376), i64, %struct.Memory*)

; Function Attrs: alwaysinline
define %struct.Memory* @tInitarr(%struct.State* noalias, i64, %struct.Memory* noalias) #1 {
entry:
