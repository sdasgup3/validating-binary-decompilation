...
@G_0x440__rip__4198736_ = global %G_0x440__rip__4198736__type zeroinitializer
...
entry:
  ...
  %76 = load double, double* bitcast (%G_0x440__rip__4198736__type* @G_0x440__rip__4198736_ to double*)
...
block_.L_401167:                                  ; preds = %block_.L_401247, %entry
...
block_.L_40117a:                                  ; preds = %block_.L_401234, %block_401173
...
block_401186:                                     ; preds = %block_.L_40117a
  ...
  %694 = load float, float* bitcast (%G_0x3cf__rip__4198865__type* @G_0x3cf__rip__4198865_ to float*)
  %695 = load float, float* inttoptr (i64 add (i64 ptrtoint (%G_0x3cf__rip__4198865__type* @G_0x3cf__rip__4198865_ to i64), i64 4) to float*)
  %696 = load float, float* inttoptr (i64 add (i64 ptrtoint (%G_0x3cf__rip__4198865__type* @G_0x3cf__rip__4198865_ to i64), i64 8) to float*)
  %697 = load float, float* inttoptr (i64 add (i64 ptrtoint (%G_0x3cf__rip__4198865__type* @G_0x3cf__rip__4198865_ to i64), i64 12) to float*)
...
; <label>:802:                                    ; preds = %794
  ...
  %805 = call %struct.Memory* @__remill_error(%struct.State* nonnull dereferenceable(3376) %0, i64 %804, %struct.Memory* %loadMem_4011df)
  br label %routine_ucomisd_MINUS0x28__rbp____xmm0.exit

; <label>:806:                                    ; preds = %block_401186
...
routine_ucomisd_MINUS0x28__rbp____xmm0.exit:      ; preds = %802, %819
  %823 = phi %struct.Memory* [ %805, %802 ], [ %loadMem_4011df, %819 ]
...
block_4011ea:                                     ; preds = %routine_ucomisd_MINUS0x28__rbp____xmm0.exit
  ...
  store i64 ptrtoint (%G__0x4015ea_type* @G__0x4015ea to i64), i64* %RSI.i, align 8
  ...
  store %struct.Memory* %loadMem1_40121b, %struct.Memory** %MEMORY
  %loadMem2_40121b = load %struct.Memory*, %struct.Memory** %MEMORY
  %loadPC_40121b = load i64, i64* %3
  %1002 = call %struct.Memory* @__remill_function_call(%struct.State* %0, i64 ptrtoint (i64 (i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64)* @fprintf to i64), %struct.Memory* %loadMem2_40121b)
...
block_.L_401234:                                  ; preds = %block_.L_40122f
...
block_.L_40125c:                                  ; preds = %block_.L_401255, %block_4011ea
  ...
  ret %struct.Memory* %loadMem_401264
}
...
define %struct.Memory* @routine_movaps_0x3cf__rip____xmm1(%struct.State* dereferenceable(3376), i64, %struct.Memory*) {
block_400478:
  %3 = getelementptr inbounds %struct.State, %struct.State* %0, i32 0, i32 6
  %4 = getelementptr inbounds %struct.GPR, %struct.GPR* %3, i32 0, i32 33
  %5 = getelementptr inbounds %struct.Reg, %struct.Reg* %4, i32 0, i32 0
...
define %struct.Memory* @routine_movq__0x4015ea___rsi(%struct.State* dereferenceable(3376), i64, %struct.Memory*) {
block_400478:
  %3 = getelementptr inbounds %struct.State, %struct.State* %0, i32 0, i32 6
  %4 = getelementptr inbounds %struct.GPR, %struct.GPR* %3, i32 0, i32 33
  %5 = getelementptr inbounds %struct.Reg, %struct.Reg* %4, i32 0, i32 0
