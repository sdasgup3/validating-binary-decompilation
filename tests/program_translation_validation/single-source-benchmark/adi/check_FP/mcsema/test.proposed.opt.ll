...
block_.L_401197:                                  ; preds = %block_.L_401272, %entry
  %95 = phi i64 [ %.pre, %entry ], [ %464, %block_.L_401272 ]
  %MEMORY.0 = phi %struct.Memory* [ %2, %entry ], [ %MEMORY.1, %block_.L_401272 ]
  ...
  br i1 %131, label %block_4011a3, label %block_.L_401285

block_4011a3:                                     ; preds = %block_.L_401197
  %133 = add i64 %96, -32
  %134 = add i64 %132, 7
  ...
  br label %block_.L_4011aa

block_.L_4011aa:                                  ; preds = %block_.L_40125f, %block_4011a3
  %136 = phi i64 [ %.pre29, %block_4011a3 ], [ %434, %block_.L_40125f ]
  %MEMORY.1 = phi %struct.Memory* [ %MEMORY.0, %block_4011a3 ], [ %343, %block_.L_40125f ]
  ...
  br i1 %172, label %block_4011b6, label %block_.L_401272

block_4011b6:                                     ; preds = %block_.L_4011aa
  %174 = add i64 %137, -16
  %175 = add i64 %173, 4
  ...
  %286 = add i64 %276, add (i64 ptrtoint (%G_0x3cf__rip__type* @G_0x3cf__rip_ to i64), i64 10)
  %287 = add i64 %276, 17
  store i64 %287, i64* %3, align 8
  %288 = inttoptr i64 %286 to i32*
  %289 = load i32, i32* %288, align 4
  %290 = add i64 %276, add (i64 ptrtoint (%G_0x3cf__rip__type* @G_0x3cf__rip_ to i64), i64 14)
  %291 = inttoptr i64 %290 to i32*
  %292 = load i32, i32* %291, align 4
  %293 = add i64 %276, add (i64 ptrtoint (%G_0x3cf__rip__type* @G_0x3cf__rip_ to i64), i64 18)
  %294 = inttoptr i64 %293 to i32*
  %295 = load i32, i32* %294, align 4
  %296 = add i64 %276, add (i64 ptrtoint (%G_0x3cf__rip__type* @G_0x3cf__rip_ to i64), i64 22)
...
routine_ucomisd_MINUS0x28__rbp____xmm0.exit:      ; preds = %341, %329
  ...
  br i1 %347, label %block_.L_40125f, label %block_40121a

block_40121a:                                     ; preds = %routine_ucomisd_MINUS0x28__rbp____xmm0.exit
  store i64 ptrtoint (%G__0x40161a_type* @G__0x40161a to i64), i64* %RSI.i143, align 8
...
block_.L_40125f:                                  ; preds = %routine_ucomisd_MINUS0x28__rbp____xmm0.exit
...
block_.L_401272:                                  ; preds = %block_.L_4011aa
  %435 = add i64 %137, -28
  %436 = add i64 %173, 8
...
block_.L_401285:                                  ; preds = %block_.L_401197
  %465 = add i64 %96, -4
  %466 = add i64 %132, 7
...
block_.L_40128c:                                  ; preds = %block_.L_401285, %block_40121a
  %468 = phi i64 [ %.pre31, %block_.L_401285 ], [ %403, %block_40121a ]
  %MEMORY.2 = phi %struct.Memory* [ %MEMORY.0, %block_.L_401285 ], [ %390, %block_40121a ]
