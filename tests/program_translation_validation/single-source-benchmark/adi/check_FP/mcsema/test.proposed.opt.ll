...
block_.L_401187:                                  ; preds = %block_.L_401262, %entry
  %95 = phi i64 [ %.pre, %entry ], [ %464, %block_.L_401262 ]
...
block_.L_40119a:                                  ; preds = %block_.L_40124f, %block_401193
  %136 = phi i64 [ %.pre29, %block_401193 ], [ %434, %block_.L_40124f ]
...
block_40120a:                                     ; preds = %routine_ucomisd_MINUS0x28__rbp____xmm0.exit
  store i64 4199946, i64* %RSI.i143, align 8
...
block_.L_40127c:                                  ; preds = %block_.L_401275, %block_40120a
  %468 = phi i64 [ %.pre31, %block_.L_401275 ], [ %403, %block_40120a ]
  %MEMORY.2 = phi %struct.Memory* [ %MEMORY.0, %block_.L_401275 ], [ %390, %block_40120a ]
