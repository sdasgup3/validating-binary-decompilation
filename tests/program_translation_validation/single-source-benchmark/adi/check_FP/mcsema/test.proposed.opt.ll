...
@G__0x4015ea = global %G__0x4015ea_type zeroinitializer
...
block_.L_401167:                                  ; preds = %block_.L_401242, %entry
  %89 = phi i64 [ %.pre, %entry ], [ %458, %block_.L_401242 ]
  %MEMORY.0 = phi %struct.Memory* [ %2, %entry ], [ %MEMORY.1, %block_.L_401242 ]
  ...
  br i1 %125, label %block_401173, label %block_.L_401255

block_401173:                                     ; preds = %block_.L_401167
  %127 = add i64 %90, -32
  %128 = add i64 %126, 7
...
block_.L_40117a:                                  ; preds = %block_.L_40122f, %block_401173
  %130 = phi i64 [ %.pre3, %block_401173 ], [ %427, %block_.L_40122f ]
  %MEMORY.1 = phi %struct.Memory* [ %MEMORY.0, %block_401173 ], [ %333, %block_.L_40122f ]
  ...
  br i1 %166, label %block_401186, label %block_.L_401242
...
block_401186:                                     ; preds = %block_.L_40117a
  ...
  %281 = load i32, i32* bitcast (%G_0x3cf__rip__type* @G_0x3cf__rip_ to i32*), align 8
  %282 = load i32, i32* inttoptr (i64 add (i64 ptrtoint (%G_0x3cf__rip__type* @G_0x3cf__rip_ to i64), i64 4) to i32*), align 4
  %283 = load i32, i32* inttoptr (i64 add (i64 ptrtoint (%G_0x3cf__rip__type* @G_0x3cf__rip_ to i64), i64 8) to i32*), align 8
  %284 = load i32, i32* inttoptr (i64 add (i64 ptrtoint (%G_0x3cf__rip__type* @G_0x3cf__rip_ to i64), i64 12) to i32*), align 4
...
routine_ucomisd_MINUS0x28__rbp____xmm0.exit:      ; preds = %331, %319
  ...
  br i1 %337, label %block_.L_40122f, label %block_4011ea

block_4011ea:                                     ; preds = %routine_ucomisd_MINUS0x28__rbp____xmm0.exit
  store i64 ptrtoint (%G__0x4015ea_type* @G__0x4015ea to i64), i64* %RSI.i143, align 8
  ...
  br label %block_.L_40125c

block_.L_40122f:                                  ; preds = %routine_ucomisd_MINUS0x28__rbp____xmm0.exit
...
block_.L_401242:                                  ; preds = %block_.L_40117a
  %428 = add i64 %131, -28
  %429 = add i64 %167, 8
...
block_.L_401255:                                  ; preds = %block_.L_401167
  %459 = add i64 %90, -4
  %460 = add i64 %126, 7
...
block_.L_40125c:                                  ; preds = %block_.L_401255, %block_4011ea
  %462 = phi i64 [ %.pre5, %block_.L_401255 ], [ %395, %block_4011ea ]
  %MEMORY.2 = phi %struct.Memory* [ %MEMORY.0, %block_.L_401255 ], [ %382, %block_4011ea ]
...
define %struct.Memory* @routine_jge_.L_401255(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i8* %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
...
define %struct.Memory* @routine_jge_.L_401242(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i8* %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 2, i32 9
...
define %struct.Memory* @routine_movaps_0x3cf__rip____xmm1(%struct.State* dereferenceable(3376), i64, %struct.Memory*) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  ...
  %6 = add i64 %5, 7
  store i64 %6, i64* %PC, align 8
  %7 = load i32, i32* bitcast (%G_0x3cf__rip__type* @G_0x3cf__rip_ to i32*), align 8
  %8 = load i32, i32* inttoptr (i64 add (i64 ptrtoint (%G_0x3cf__rip__type* @G_0x3cf__rip_ to i64), i64 4) to i32*), align 4
  %9 = load i32, i32* inttoptr (i64 add (i64 ptrtoint (%G_0x3cf__rip__type* @G_0x3cf__rip_ to i64), i64 8) to i32*), align 8
  %10 = load i32, i32* inttoptr (i64 add (i64 ptrtoint (%G_0x3cf__rip__type* @G_0x3cf__rip_ to i64), i64 12) to i32*), align 4
...
define %struct.Memory* @routine_jbe_.L_40122f(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i8* %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
...
define %struct.Memory* @routine_movq__0x4015ea___rsi(%struct.State* dereferenceable(3376), i64, %struct.Memory*) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %RSI = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 9, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, 10
  store i64 %4, i64* %PC, align 8
  store i64 ptrtoint (%G__0x4015ea_type* @G__0x4015ea to i64), i64* %RSI, align 8
  ret %struct.Memory* %2
}
...
define %struct.Memory* @routine_jmpq_.L_40125c(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
...
define %struct.Memory* @routine_jmpq_.L_401234(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
...
define %struct.Memory* @routine_jmpq_.L_40117a(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
...
define %struct.Memory* @routine_jmpq_.L_401247(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
...
define %struct.Memory* @routine_jmpq_.L_401167(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
