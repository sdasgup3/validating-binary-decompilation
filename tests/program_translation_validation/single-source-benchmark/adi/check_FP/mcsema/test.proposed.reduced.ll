; ModuleID = '/tmp/tmpzzeh62k6-query.ll'
source_filename = "llvm-link"
target datalayout = "e-m:e-i64:64-f80:128-n8:16:32:64-S128"
target triple = "x86_64-pc-linux-gnu-elf"

%__bss_start_type = type <{ [8 x i8] }>
%G_0x3cf__rip__type = type <{ [16 x i8] }>
%G_0x440__rip__type = type <{ [8 x i8] }>
%G_0x602080_type = type <{ [8 x i8] }>
%G__0x40161a_type = type <{ [8 x i8] }>
...
@G__0x40161a = global %G__0x40161a_type zeroinitializer
...
entry:
  ...
  %var_2_42 = add i64 %var_2_10, add (i64 ptrtoint (%G_0x440__rip__type* @G_0x440__rip_ to i64), i64 7)
  ...
  br i1 %var_2_13121, label %block_4011a3.preheader, label %block_.L_40128c

block_4011a3.preheader:                           ; preds = %entry
  br label %block_4011a3

block_.L_401197.loopexit.loopexit:                ; preds = %routine_ucomisd_MINUS0x28__rbp____xmm0.exit.block_.L_4011aa_crit_edge
  br label %block_.L_401197.loopexit

block_.L_401197.loopexit:                         ; preds = %block_.L_401197.loopexit.loopexit, %block_4011a3
  %var_2_137.lcssa = phi i64 [ %var_2_13711, %block_4011a3 ], [ %var_2_137.pre, %block_.L_401197.loopexit.loopexit ]
  %MEMORY.1.lcssa = phi %struct.Memory* [ %MEMORY.022, %block_4011a3 ], [ %var_2_343, %block_.L_401197.loopexit.loopexit ]
  %var_2_146.lcssa = phi i32 [ %var_2_14628, %block_4011a3 ], [ %var_2_146, %block_.L_401197.loopexit.loopexit ]
  %var_2_165.lcssa = phi i32 [ %var_2_16532, %block_4011a3 ], [ %var_2_165, %block_.L_401197.loopexit.loopexit ]
  ...
  br i1 %var_2_131, label %block_4011a3, label %block_.L_40128c.loopexit17

block_4011a3:                                     ; preds = %block_4011a3.preheader, %block_.L_401197.loopexit
  %var_2_13711 = phi i64 [ %var_2_137.lcssa, %block_.L_401197.loopexit ], [ %var_2_965, %block_4011a3.preheader ]
  %MEMORY.022 = phi %struct.Memory* [ %MEMORY.1.lcssa, %block_.L_401197.loopexit ], [ %2, %block_4011a3.preheader ]
  ...
  br i1 %var_2_17238, label %block_4011b6.preheader, label %block_.L_401197.loopexit

block_4011b6.preheader:                           ; preds = %block_4011a3
  br label %block_4011b6

block_4011b6:                                     ; preds = %block_4011b6.preheader, %routine_ucomisd_MINUS0x28__rbp____xmm0.exit.block_.L_4011aa_crit_edge
  %MEMORY.140 = phi %struct.Memory* [ %var_2_343, %routine_ucomisd_MINUS0x28__rbp____xmm0.exit.block_.L_4011aa_crit_edge ], [ %MEMORY.022, %block_4011b6.preheader ]
  %var_2_13739 = phi i64 [ %var_2_137.pre, %routine_ucomisd_MINUS0x28__rbp____xmm0.exit.block_.L_4011aa_crit_edge ], [ %var_2_13711, %block_4011b6.preheader ]
  %var_2_275 = add i64 %var_2_13739, -48
  %var_2_276 = load i64, i64* %var_2_3, align 8
  %var_4_3 = inttoptr i64 %var_2_275 to double*
  %var_2_2792 = load double, double* %var_4_3, align 8
  %var_2_280 = add i64 %var_2_13739, -56
  %var_2_283 = inttoptr i64 %var_2_280 to double*
  %var_2_284 = load double, double* %var_2_283, align 8
  %var_2_285 = fsub double %var_2_2792, %var_2_284
  store double %var_2_285, double* %var_2_46, align 1
  store i64 0, i64* %var_2_48, align 1
  %var_2_286 = add i64 %var_2_276, add (i64 ptrtoint (%G_0x3cf__rip__type* @G_0x3cf__rip_ to i64), i64 10)
  %var_2_287 = add i64 %var_2_276, 17
  store i64 %var_2_287, i64* %var_2_3, align 8
  %var_2_288 = inttoptr i64 %var_2_286 to i32*
  %var_2_289 = load i32, i32* %var_2_288, align 4
  %var_2_290 = add i64 %var_2_276, add (i64 ptrtoint (%G_0x3cf__rip__type* @G_0x3cf__rip_ to i64), i64 14)
  %var_2_291 = inttoptr i64 %var_2_290 to i32*
  %var_2_292 = load i32, i32* %var_2_291, align 4
  %var_2_293 = add i64 %var_2_276, add (i64 ptrtoint (%G_0x3cf__rip__type* @G_0x3cf__rip_ to i64), i64 18)
  %var_2_294 = inttoptr i64 %var_2_293 to i32*
  %var_2_295 = load i32, i32* %var_2_294, align 4
  %var_2_296 = add i64 %var_2_276, add (i64 ptrtoint (%G_0x3cf__rip__type* @G_0x3cf__rip_ to i64), i64 22)
  %var_2_297 = inttoptr i64 %var_2_296 to i32*
  %var_2_298 = load i32, i32* %var_2_297, align 4
  store i32 %var_2_289, i32* %var_2_81, align 1
  store i32 %var_2_292, i32* %var_2_83, align 1
  store i32 %var_2_295, i32* %var_2_85, align 1
  store i32 %var_2_298, i32* %var_2_87, align 1
  %var_2_310 = add i64 %var_2_13739, -64
  %var_4_4 = inttoptr i64 %var_2_310 to double*
  %var_2_3143 = load double, double* %var_4_4, align 8
  %var_2_315 = add i64 %var_2_13739, -40
  %var_2_316 = add i64 %var_2_276, 27
  %var_2_318 = inttoptr i64 %var_2_315 to double*
  %var_2_319 = load double, double* %var_2_318, align 8
  %var_2_320 = fcmp uno double %var_2_3143, %var_2_319
  br i1 %var_2_320, label %var_2_321, label %routine_ucomisd_MINUS0x28__rbp____xmm0.exit

var_2_321:                                        ; preds = %block_4011b6
  %var_2_322 = fadd double %var_2_3143, %var_2_319
  %var_2_323 = bitcast double %var_2_322 to i64
  %var_2_324 = and i64 %var_2_323, 9221120237041090560
  %var_2_325 = icmp eq i64 %var_2_324, 9218868437227405312
  %var_2_326 = and i64 %var_2_323, 2251799813685247
  %var_2_327 = icmp ne i64 %var_2_326, 0
  %var_2_328 = and i1 %var_2_325, %var_2_327
  br i1 %var_2_328, label %var_2_329, label %routine_ucomisd_MINUS0x28__rbp____xmm0.exit

var_2_329:                                        ; preds = %var_2_321
  %var_2_330 = tail call %struct.Memory* @__remill_error(%struct.State* nonnull dereferenceable(3376) %0, i64 %var_2_316, %struct.Memory* %MEMORY.140)
  br label %routine_ucomisd_MINUS0x28__rbp____xmm0.exit

routine_ucomisd_MINUS0x28__rbp____xmm0.exit:      ; preds = %var_2_329, %var_2_321, %block_4011b6
  %var_2_343 = phi %struct.Memory* [ %var_2_330, %var_2_329 ], [ %MEMORY.140, %var_2_321 ], [ %MEMORY.140, %block_4011b6 ]
  %var_2_344 = load i8, i8* %var_2_14, align 1
  %var_2_345 = load i8, i8* %var_2_30, align 1
  %var_2_346 = or i8 %var_2_345, %var_2_344
  %var_2_347 = icmp eq i8 %var_2_346, 0
  br i1 %var_2_347, label %block_.L_40128c.loopexit, label %routine_ucomisd_MINUS0x28__rbp____xmm0.exit.block_.L_4011aa_crit_edge

routine_ucomisd_MINUS0x28__rbp____xmm0.exit.block_.L_4011aa_crit_edge: ; preds = %routine_ucomisd_MINUS0x28__rbp____xmm0.exit
  ...
  br i1 %var_2_172, label %block_4011b6, label %block_.L_401197.loopexit.loopexit

block_.L_40128c.loopexit:                         ; preds = %routine_ucomisd_MINUS0x28__rbp____xmm0.exit
  br label %block_.L_40128c

block_.L_40128c.loopexit17:                       ; preds = %block_.L_401197.loopexit
  br label %block_.L_40128c

block_.L_40128c:                                  ; preds = %block_.L_40128c.loopexit17, %block_.L_40128c.loopexit, %entry
...
; Function Attrs: alwaysinline norecurse nounwind
define %struct.Memory* @routine_jge_.L_401285(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i8* nocapture %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
...
; Function Attrs: alwaysinline norecurse nounwind
define %struct.Memory* @routine_jge_.L_401272(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i8* nocapture %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 2, i32 9
...
; Function Attrs: alwaysinline norecurse nounwind
define %struct.Memory* @routine_movaps_0x3cf__rip____xmm1(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 1, i64 1
  %4 = bitcast %union.VectorReg* %3 to i8*
  %5 = load i64, i64* %PC, align 8
  %6 = add i64 %5, ptrtoint (%G_0x3cf__rip__type* @G_0x3cf__rip_ to i64)
  %7 = add i64 %5, 7
  store i64 %7, i64* %PC, align 8
  %8 = inttoptr i64 %6 to i32*
  %9 = load i32, i32* %8, align 4
  %10 = add i64 %5, add (i64 ptrtoint (%G_0x3cf__rip__type* @G_0x3cf__rip_ to i64), i64 4)
  %11 = inttoptr i64 %10 to i32*
  %12 = load i32, i32* %11, align 4
  %13 = add i64 %5, add (i64 ptrtoint (%G_0x3cf__rip__type* @G_0x3cf__rip_ to i64), i64 8)
  %14 = inttoptr i64 %13 to i32*
  %15 = load i32, i32* %14, align 4
  %16 = add i64 %5, add (i64 ptrtoint (%G_0x3cf__rip__type* @G_0x3cf__rip_ to i64), i64 12)
...
; Function Attrs: alwaysinline norecurse nounwind
define %struct.Memory* @routine_jbe_.L_40125f(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i8* nocapture %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
...
; Function Attrs: alwaysinline norecurse nounwind
define %struct.Memory* @routine_movq__0x40161a___rsi(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %RSI = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 9, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  ...
  store i64 ptrtoint (%G__0x40161a_type* @G__0x40161a to i64), i64* %RSI, align 8
  ret %struct.Memory* %2
}
...
; Function Attrs: alwaysinline norecurse nounwind
define %struct.Memory* @routine_jmpq_.L_40128c(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
...
; Function Attrs: alwaysinline norecurse nounwind
define %struct.Memory* @routine_jmpq_.L_401264(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
...
; Function Attrs: alwaysinline norecurse nounwind
define %struct.Memory* @routine_jmpq_.L_4011aa(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
...
; Function Attrs: alwaysinline norecurse nounwind
define %struct.Memory* @routine_jmpq_.L_401277(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
...
; Function Attrs: alwaysinline norecurse nounwind
define %struct.Memory* @routine_jmpq_.L_401197(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
