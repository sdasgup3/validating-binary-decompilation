...
@G_0xad7__rip_ = global %G_0xad7__rip__type zeroinitializer
...
block_400a99:                                     ; preds = %block_.L_400a8d
  ...
  %287 = load double, double* bitcast (%G_0xad7__rip__type* @G_0xad7__rip_ to double*)
  ...
  %300 = load double, double* bitcast (%G_0xad7__rip__type* @G_0xad7__rip_ to double*)
  ...
  %313 = load double, double* bitcast (%G_0xad7__rip__type* @G_0xad7__rip_ to double*)
...
block_400478:
  ...
  %9 = load i64, i64* %PC
  %10 = ptrtoint %G_0xad7__rip__type* @G_0xad7__rip_ to i64
  %11 = load i64, i64* %PC
  %12 = add i64 %11, 8
  store i64 %12, i64* %PC
