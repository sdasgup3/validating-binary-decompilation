...
declare %struct.Memory* @sub_400b90.kernel_adi(%struct.State* noalias dereferenceable(3376), i64, %struct.Memory* noalias readnone returned) local_unnamed_addr
...
entry:
  ...
  %call2_40099c = tail call %struct.Memory* @sub_400a60.init_array(%struct.State* %0, i64 %136, %struct.Memory* %call2_400984)
  ...
  %call2_4009b3 = tail call %struct.Memory* @sub_400b90.kernel_adi(%struct.State* %0, i64 %165, %struct.Memory* %call2_40099c)
  ...
  %call2_4009c7 = tail call %struct.Memory* @sub_400a60.init_array(%struct.State* %0, i64 %189, %struct.Memory* %call2_4009b3)
  ...
  %call2_4009de = tail call %struct.Memory* @sub_400b90.kernel_adi(%struct.State* %0, i64 %218, %struct.Memory* %call2_4009c7)
  ...
  %call2_4009ee = tail call %struct.Memory* @sub_401140.check_FP(%struct.State* %0, i64 %238, %struct.Memory* %call2_4009de)
  ...
  br i1 %250, label %block_4009fc, label %block_.L_400a08
...
block_.L_400a08:                                  ; preds = %entry
  ...
  %call2_400a0f = tail call %struct.Memory* @sub_401270.print_array(%struct.State* %0, i64 %270, %struct.Memory* %call2_4009ee)
  ...
  %286 = tail call %struct.Memory* @__remill_function_call(%struct.State* %0, i64 ptrtoint (i64 (i64)* @free to i64), %struct.Memory* %call2_400a0f)
  ...
  %298 = tail call %struct.Memory* @__remill_function_call(%struct.State* %0, i64 ptrtoint (i64 (i64)* @free to i64), %struct.Memory* %286)
  ...
  %310 = tail call %struct.Memory* @__remill_function_call(%struct.State* %0, i64 ptrtoint (i64 (i64)* @free to i64), %struct.Memory* %298)
  ...
  %322 = tail call %struct.Memory* @__remill_function_call(%struct.State* %0, i64 ptrtoint (i64 (i64)* @free to i64), %struct.Memory* %310)
...
block_.L_400a4b:                                  ; preds = %block_.L_400a08, %block_4009fc
  %328 = phi i64 [ %.pre, %block_.L_400a08 ], [ %260, %block_4009fc ]
  %MEMORY.0 = phi %struct.Memory* [ %322, %block_.L_400a08 ], [ %call2_4009ee, %block_4009fc ]
...
define %struct.Memory* @routine_movl__0x32__MINUS0x18__rbp_(%struct.State* dereferenceable(3376), i64, %struct.Memory*) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %RBP = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 15, i32 0, i32 0
  %3 = load i64, i64* %RBP, align 8
...
define %struct.Memory* @routine_callq_.kernel_adi(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
...
define %struct.Memory* @routine_jne_.L_400a08(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i8* %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
...
define %struct.Memory* @routine_jmpq_.L_400a4b(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
