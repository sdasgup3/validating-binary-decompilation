...
block_.L_4012ac:                                  ; preds = %block_.L_401302, %entry
  %123 = phi i64 [ %.pre, %entry ], [ %357, %block_.L_401302 ]
  %MEMORY.0 = phi %struct.Memory* [ %79, %entry ], [ %318, %block_.L_401302 ]
  ...
  br i1 %159, label %block_4012b8, label %block_.L_401324
...
block_.L_4012bf:                                  ; preds = %block_4012cb, %block_4012b8
  %164 = phi i64 [ %.pre1, %block_4012b8 ], [ %307, %block_4012cb ]
  ...
  br i1 %200, label %block_4012cb, label %block_.L_401302
...
block_4012cb:                                     ; preds = %block_.L_4012bf
  ...
  %call2_4012ef = tail call %struct.Memory* @sub_401340.print_element(%struct.State* %0, i64 %270, %struct.Memory* %MEMORY.1)
