...
block_.L_4012ac:                                  ; preds = %block_.L_401302, %entry
  %117 = phi i64 [ %.pre, %entry ], [ %348, %block_.L_401302 ]
  %MEMORY.0 = phi %struct.Memory* [ %73, %entry ], [ %310, %block_.L_401302 ]
...
block_.L_4012bf:                                  ; preds = %block_4012cb, %block_4012b8
  %158 = phi i64 [ %.pre1, %block_4012b8 ], [ %299, %block_4012cb ]
...
block_4012cb:                                     ; preds = %block_.L_4012bf
  ...
  %call2_4012ef = tail call %struct.Memory* @sub_401340.print_element(%struct.State* %0, i64 %263, %struct.Memory* %MEMORY.1)
