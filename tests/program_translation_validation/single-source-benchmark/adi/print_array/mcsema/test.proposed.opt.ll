...
declare %struct.Memory* @sub_401370.print_element(%struct.State* noalias dereferenceable(3376), i64, %struct.Memory* noalias readnone returned) local_unnamed_addr
...
block_.L_4012dc:                                  ; preds = %block_.L_401332, %entry
  %124 = phi i64 [ %.pre, %entry ], [ %355, %block_.L_401332 ]
  %MEMORY.0 = phi %struct.Memory* [ %79, %entry ], [ %317, %block_.L_401332 ]
  ...
  br i1 %160, label %block_4012e8, label %block_.L_401354

block_4012e8:                                     ; preds = %block_.L_4012dc
  %162 = add i64 %125, -24
  %163 = add i64 %161, 7
...
block_.L_4012ef:                                  ; preds = %block_4012fb, %block_4012e8
  %165 = phi i64 [ %306, %block_4012fb ], [ %.pre9, %block_4012e8 ]
  ...
  br i1 %201, label %block_4012fb, label %block_.L_401332
...
block_4012fb:                                     ; preds = %block_.L_4012ef
  ...
  %call2_40131f = tail call %struct.Memory* @sub_401370.print_element(%struct.State* nonnull %0, i64 %270, %struct.Memory* %MEMORY.0)
...
block_.L_401332:                                  ; preds = %block_.L_4012ef
  %307 = add i64 %166, -32
  %308 = add i64 %202, 4
...
block_.L_401354:                                  ; preds = %block_.L_4012dc
  %356 = add i64 %125, -32
  %357 = add i64 %161, 4
