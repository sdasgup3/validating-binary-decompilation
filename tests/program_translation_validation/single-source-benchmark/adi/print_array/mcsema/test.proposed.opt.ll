...
declare %struct.Memory* @sub_401360.print_element(%struct.State* dereferenceable(3376), i64, %struct.Memory*) local_unnamed_addr
...
entry:
  ...
  %call2_4012ab = tail call %struct.Memory* @sub_400640.malloc_plt(%struct.State* %0, i64 %74, %struct.Memory* %2)
...
block_.L_4012cc:                                  ; preds = %block_.L_401322, %entry
  %123 = phi i64 [ %.pre, %entry ], [ %353, %block_.L_401322 ]
  %MEMORY.0 = phi %struct.Memory* [ %call2_4012ab, %entry ], [ %call2_40132e, %block_.L_401322 ]
  ...
  br i1 %159, label %block_4012d8, label %block_.L_401344

block_4012d8:                                     ; preds = %block_.L_4012cc
  %161 = add i64 %124, -24
  %162 = add i64 %160, 7
...
block_.L_4012df:                                  ; preds = %block_4012eb, %block_4012d8
  %164 = phi i64 [ %.pre9, %block_4012d8 ], [ %305, %block_4012eb ]
  %MEMORY.1 = phi %struct.Memory* [ %MEMORY.0, %block_4012d8 ], [ %call2_40130f, %block_4012eb ]
  ...
  br i1 %200, label %block_4012eb, label %block_.L_401322

block_4012eb:                                     ; preds = %block_.L_4012df
  %202 = add i64 %165, -16
  %203 = add i64 %201, 4
  ...
  %call2_40130f = tail call %struct.Memory* @sub_401360.print_element(%struct.State* nonnull %0, i64 %269, %struct.Memory* %MEMORY.1)
...
block_.L_401322:                                  ; preds = %block_.L_4012df
  %306 = add i64 %165, -32
  %307 = add i64 %201, 4
  ...
  %call2_40132e = tail call %struct.Memory* @sub_400610.fputs_plt(%struct.State* nonnull %0, i64 %311, %struct.Memory* %MEMORY.1)
...
block_.L_401344:                                  ; preds = %block_.L_4012cc
  %354 = add i64 %124, -32
  %355 = add i64 %160, 4
  ...
  %call2_401348 = tail call %struct.Memory* @sub_4005f0.free_plt(%struct.State* nonnull %0, i64 %358, %struct.Memory* %MEMORY.0)
  ...
  ret %struct.Memory* %call2_401348
}
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_jge_.L_401344(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i8* nocapture %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_jge_.L_401322(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i8* nocapture %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 2, i32 9
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_jmpq_.L_4012cc(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
