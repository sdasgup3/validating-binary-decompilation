...
block_.L_4012cc:                                  ; preds = %block_.L_401322, %entry
  %124 = phi i64 [ %.pre, %entry ], [ %355, %block_.L_401322 ]
  %MEMORY.0 = phi %struct.Memory* [ %79, %entry ], [ %317, %block_.L_401322 ]
  ...
  br i1 %160, label %block_4012d8, label %block_.L_401344
...
block_.L_4012df:                                  ; preds = %block_4012eb, %block_4012d8
  %165 = phi i64 [ %306, %block_4012eb ], [ %.pre9, %block_4012d8 ]
  ...
  br i1 %201, label %block_4012eb, label %block_.L_401322
...
block_4012eb:                                     ; preds = %block_.L_4012df
  ...
  %call2_40130f = tail call %struct.Memory* @sub_401360.print_element(%struct.State* nonnull %0, i64 %270, %struct.Memory* %MEMORY.0)
