; ModuleID = '/tmp/tmp433rc2j_-query.ll'
...
entry:
  ...
  br i1 %var_2_16034, label %block_4012e8.preheader, label %block_.L_401354

block_4012e8.preheader:                           ; preds = %entry
  br label %block_4012e8

block_4012e8:                                     ; preds = %block_4012e8.preheader, %block_.L_401332
  %var_2_175 = phi i32 [ %var_2_134, %block_.L_401332 ], [ %var_2_13424, %block_4012e8.preheader ]
  %var_2_1661 = phi i64 [ %var_2_125, %block_.L_401332 ], [ %var_2_12518, %block_4012e8.preheader ]
  %MEMORY.035 = phi %struct.Memory* [ %var_2_317, %block_.L_401332 ], [ %var_2_79, %block_4012e8.preheader ]
  ...
  br i1 %var_2_20117, label %block_4012fb.preheader, label %block_.L_401332

block_4012fb.preheader:                           ; preds = %block_4012e8
  br label %block_4012fb

block_4012fb:                                     ; preds = %block_4012fb.preheader, %block_4012fb
  br label %block_4012fb

block_.L_401332:                                  ; preds = %block_4012e8
  ...
  br i1 %var_2_160, label %block_4012e8, label %block_.L_401354.loopexit

block_.L_401354.loopexit:                         ; preds = %block_.L_401332
  br label %block_.L_401354

block_.L_401354:                                  ; preds = %block_.L_401354.loopexit, %entry
  %MEMORY.0.lcssa = phi %struct.Memory* [ %var_2_79, %entry ], [ %var_2_317, %block_.L_401354.loopexit ]
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_jge_.L_401354(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i8* nocapture %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_jge_.L_401332(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i8* nocapture %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 2, i32 9
