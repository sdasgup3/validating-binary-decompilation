...
; <label>:546:                                    ; preds = %538
  ...
  %549 = call %struct.Memory* @__remill_error(%struct.State* nonnull dereferenceable(3376) %0, i64 %548, %struct.Memory* %loadMem_400eb6)
  br label %routine_ucomisd_MINUS0x28__rbp____xmm0.exit

; <label>:550:                                    ; preds = %block_400e73
...
routine_ucomisd_MINUS0x28__rbp____xmm0.exit:      ; preds = %546, %563
  %567 = phi %struct.Memory* [ %549, %546 ], [ %loadMem_400eb6, %563 ]
...
block_400ec1:                                     ; preds = %routine_ucomisd_MINUS0x28__rbp____xmm0.exit
  ...
  store i64 4199018, i64* %RSI.i, align 8
  ...
  %712 = call %struct.Memory* @__remill_function_call(%struct.State* %0, i64 ptrtoint (i64 (i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64)* @fprintf to i64), %struct.Memory* %loadMem2_400eea)
