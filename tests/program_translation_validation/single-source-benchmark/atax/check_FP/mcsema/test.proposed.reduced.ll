; ModuleID = '/tmp/tmpvar0b0bk-query.ll'
...
block_.L_400e77:                                  ; preds = %routine_ucomisd_MINUS0x28__rbp____xmm0.exit, %entry
  ...
  br i1 %var_2_131, label %block_400e83, label %block_.L_400f28
...
routine_ucomisd_MINUS0x28__rbp____xmm0.exit:      ; preds = %var_2_222, %var_2_214, %block_400e83
  ...
  br i1 %var_2_240, label %block_.L_400f28, label %block_.L_400e77

block_.L_400f28:                                  ; preds = %routine_ucomisd_MINUS0x28__rbp____xmm0.exit, %block_.L_400e77
