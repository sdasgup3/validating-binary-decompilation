; ModuleID = '/tmp/tmp3dxug1a8-query.ll'
...
entry:
  ...
  %var_2_42 = add i64 %var_2_10, add (i64 ptrtoint (%G_0x3c0__rip__type* @G_0x3c0__rip_ to i64), i64 7)
...
block_.L_400e77:                                  ; preds = %routine_ucomisd_MINUS0x28__rbp____xmm0.exit, %entry
  ...
  br i1 %var_2_131, label %block_400e83, label %block_.L_400f28.loopexit
...
routine_ucomisd_MINUS0x28__rbp____xmm0.exit:      ; preds = %var_2_222, %var_2_214, %block_400e83
  %var_2_236 = phi %struct.Memory* [ %var_2_223, %var_2_222 ], [ %MEMORY.0, %var_2_214 ], [ %MEMORY.0, %block_400e83 ]
  ...
  br i1 %var_2_240, label %block_400ed1, label %block_.L_400e77
...
block_.L_400f28.loopexit:                         ; preds = %block_.L_400e77
  br label %block_.L_400f28

block_.L_400f28:                                  ; preds = %block_.L_400f28.loopexit, %block_400ed1
  %MEMORY.1 = phi %struct.Memory* [ %var_2_273, %block_400ed1 ], [ %MEMORY.0, %block_.L_400f28.loopexit ]
