...
entry:
  ...
  %130 = call %struct.Memory* @__remill_function_call(%struct.State* %0, i64 ptrtoint (i64 (i64, i64)* @calloc to i64), %struct.Memory* %loadMem2_40074a)
...
block_.L_400793:                                  ; preds = %block_.L_400762
  ...
  store %struct.Memory* %loadMem1_40079a, %struct.Memory** %MEMORY
  %loadMem2_40079a = load %struct.Memory*, %struct.Memory** %MEMORY
  %loadPC_40079a = load i64, i64* %3
  %511 = call %struct.Memory* @__remill_function_call(%struct.State* %0, i64 ptrtoint (i64 (i64)* @free to i64), %struct.Memory* %loadMem2_40079a)
  ...
  ret %struct.Memory* %loadMem_4007a4
}
