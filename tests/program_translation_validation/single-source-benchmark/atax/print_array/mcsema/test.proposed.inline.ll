...
entry:
  ...
  store %struct.Memory* %loadMem1_400f5b, %struct.Memory** %MEMORY
  %loadMem2_400f5b = load %struct.Memory*, %struct.Memory** %MEMORY
  %loadPC_400f5b = load i64, i64* %3
  %216 = call %struct.Memory* @__remill_function_call(%struct.State* %0, i64 ptrtoint (i64 (i64)* @malloc to i64), %struct.Memory* %loadMem2_400f5b)
...
block_.L_400f7c:                                  ; preds = %block_400f88, %entry
...
block_400f88:                                     ; preds = %block_.L_400f7c
...
block_.L_400fb4:                                  ; preds = %block_.L_400f7c
  ...
  store %struct.Memory* %loadMem1_400fc0, %struct.Memory** %MEMORY
  %loadMem2_400fc0 = load %struct.Memory*, %struct.Memory** %MEMORY
  %loadPC_400fc0 = load i64, i64* %3
  %682 = call %struct.Memory* @__remill_function_call(%struct.State* %0, i64 ptrtoint (i64 (i64, i64)* @fputs to i64), %struct.Memory* %loadMem2_400fc0)
  ...
  %728 = call %struct.Memory* @__remill_function_call(%struct.State* %0, i64 ptrtoint (i64 (i64)* @free to i64), %struct.Memory* %loadMem2_400fcc)
  ...
  ret %struct.Memory* %loadMem_400fd6
}
