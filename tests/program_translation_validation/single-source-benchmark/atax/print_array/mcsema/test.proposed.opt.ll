...
declare %struct.Memory* @sub_400fd0.print_element(%struct.State* noalias dereferenceable(3376), i64, %struct.Memory* noalias) local_unnamed_addr
...
entry:
  ...
  %call2_400f4b = tail call %struct.Memory* @sub_400640.malloc_plt(%struct.State* %0, i64 %74, %struct.Memory* %2)
...
block_.L_400f6c:                                  ; preds = %block_400f78, %entry
  %123 = phi i64 [ %.pre, %entry ], [ %230, %block_400f78 ]
  %MEMORY.0 = phi %struct.Memory* [ %call2_400f4b, %entry ], [ %call2_400f91, %block_400f78 ]
...
block_400f78:                                     ; preds = %block_.L_400f6c
  ...
  %call2_400f91 = tail call %struct.Memory* @sub_400fd0.print_element(%struct.State* nonnull %0, i64 %194, %struct.Memory* %MEMORY.0)
...
block_.L_400fa4:                                  ; preds = %block_.L_400f6c
  ...
  %call2_400fb0 = tail call %struct.Memory* @sub_400610.fputs_plt(%struct.State* nonnull %0, i64 %236, %struct.Memory* %MEMORY.0)
  ...
  %call2_400fbc = tail call %struct.Memory* @sub_4005f0.free_plt(%struct.State* nonnull %0, i64 %252, %struct.Memory* %call2_400fb0)
  ...
  ret %struct.Memory* %call2_400fbc
}
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_jge_.L_400fa4(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i8* nocapture %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_jmpq_.L_400f6c(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
