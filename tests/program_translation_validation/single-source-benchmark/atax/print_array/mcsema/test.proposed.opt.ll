...
block_.L_400f3c:                                  ; preds = %block_400f48, %entry
  %117 = phi i64 [ %.pre, %entry ], [ %225, %block_400f48 ]
  %MEMORY.0 = phi %struct.Memory* [ %73, %entry ], [ %call2_400f61, %block_400f48 ]
  ...
  br i1 %153, label %block_400f48, label %block_.L_400f74
...
block_400f48:                                     ; preds = %block_.L_400f3c
  ...
  %call2_400f61 = tail call %struct.Memory* @sub_400fa0.print_element(%struct.State* %0, i64 %189, %struct.Memory* %MEMORY.0)
