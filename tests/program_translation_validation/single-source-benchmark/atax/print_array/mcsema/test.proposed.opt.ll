...
declare %struct.Memory* @sub_400fe0.print_element(%struct.State* noalias dereferenceable(3376), i64, %struct.Memory* noalias readnone returned) local_unnamed_addr
...
block_.L_400f7c:                                  ; preds = %block_400f88, %entry
  %124 = phi i64 [ %231, %block_400f88 ], [ %.pre, %entry ]
  ...
  br i1 %160, label %block_400f88, label %block_.L_400fb4
...
block_400f88:                                     ; preds = %block_.L_400f7c
  ...
  %call2_400fa1 = tail call %struct.Memory* @sub_400fe0.print_element(%struct.State* nonnull %0, i64 %195, %struct.Memory* %79)
