...
block_.L_400f6c:                                  ; preds = %block_400f78, %entry
  %124 = phi i64 [ %231, %block_400f78 ], [ %.pre, %entry ]
  ...
  br i1 %160, label %block_400f78, label %block_.L_400fa4
...
block_400f78:                                     ; preds = %block_.L_400f6c
  ...
  %call2_400f91 = tail call %struct.Memory* @sub_400fd0.print_element(%struct.State* nonnull %0, i64 %195, %struct.Memory* %79)
