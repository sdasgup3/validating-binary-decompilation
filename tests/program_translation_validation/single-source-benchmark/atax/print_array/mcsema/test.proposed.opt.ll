...
declare %struct.Memory* @sub_400fa0.print_element(%struct.State* noalias dereferenceable(3376), i64, %struct.Memory* noalias readnone returned) local_unnamed_addr
...
block_.L_400f3c:                                  ; preds = %block_400f48, %entry
  %123 = phi i64 [ %.pre, %entry ], [ %232, %block_400f48 ]
  %MEMORY.0 = phi %struct.Memory* [ %79, %entry ], [ %call2_400f61, %block_400f48 ]
  ...
  br i1 %159, label %block_400f48, label %block_.L_400f74

block_400f48:                                     ; preds = %block_.L_400f3c
  %161 = add i64 %124, -16
  %162 = add i64 %160, 4
  ...
  %call2_400f61 = tail call %struct.Memory* @sub_400fa0.print_element(%struct.State* %0, i64 %195, %struct.Memory* %MEMORY.0)
...
block_.L_400f74:                                  ; preds = %block_.L_400f3c
  %233 = add i64 %124, -32
  %234 = add i64 %160, 4
...
define %struct.Memory* @routine_jge_.L_400f74(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i8* %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
