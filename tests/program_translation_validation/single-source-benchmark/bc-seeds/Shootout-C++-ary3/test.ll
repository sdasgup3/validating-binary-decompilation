; ModuleID = 'Shootout-C++-ary3/test.bc'
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_ary3.cpp, i8* null }]
...
define internal void @_GLOBAL__sub_I_ary3.cpp() #0 section ".text.startup" {
entry:
...
invoke.cont10:                                    ; preds = %for.body
  store i32 %add, i32* %call11, align 4
  br label %for.inc
...
lpad9:                                            ; preds = %invoke.cont39, %invoke.cont37, %invoke.cont35, %invoke.cont33, %invoke.cont31, %for.end30, %invoke.cont20, %for.body18, %for.body
...
invoke.cont20:                                    ; preds = %for.body18
  ...
  %call24 = invoke dereferenceable(4) i32* @_ZNSt6vectorIiSaIiEEixEm(%"class.std::vector"* %y, i64 %conv22)
          to label %invoke.cont23 unwind label %lpad9

invoke.cont23:                                    ; preds = %invoke.cont20
  %25 = load i32, i32* %call24, align 4
  %add25 = add nsw i32 %25, %23
  store i32 %add25, i32* %call24, align 4
  br label %for.inc26

for.inc26:                                        ; preds = %invoke.cont23
...
for.end30:                                        ; preds = %for.cond12
  %call32 = invoke dereferenceable(4) i32* @_ZNSt6vectorIiSaIiEEixEm(%"class.std::vector"* %y, i64 0)
          to label %invoke.cont31 unwind label %lpad9

invoke.cont31:                                    ; preds = %for.end30
  %28 = load i32, i32* %call32, align 4
  %call34 = invoke dereferenceable(272) %"class.std::basic_ostream"* @_ZNSolsEi(%"class.std::basic_ostream"* @_ZSt4cout, i32 %28)
          to label %invoke.cont33 unwind label %lpad9

invoke.cont33:                                    ; preds = %invoke.cont31
  %call36 = invoke dereferenceable(272) %"class.std::basic_ostream"* @_ZStlsISt11char_traitsIcEERSt13basic_ostreamIcT_ES5_PKc(%"class.std::basic_ostream"* dereferenceable(272) %call34, i8* getelementptr inbounds ([2 x i8], [2 x i8]* @.str, i32 0, i32 0))
          to label %invoke.cont35 unwind label %lpad9

invoke.cont35:                                    ; preds = %invoke.cont33
  %call38 = invoke dereferenceable(4) i32* @_ZNSt6vectorIiSaIiEE4backEv(%"class.std::vector"* %y)
          to label %invoke.cont37 unwind label %lpad9

invoke.cont37:                                    ; preds = %invoke.cont35
  %29 = load i32, i32* %call38, align 4
  %call40 = invoke dereferenceable(272) %"class.std::basic_ostream"* @_ZNSolsEi(%"class.std::basic_ostream"* %call36, i32 %29)
...
invoke.cont45:                                    ; preds = %lpad9
  br label %ehcleanup

ehcleanup:                                        ; preds = %invoke.cont45, %lpad43, %lpad5
