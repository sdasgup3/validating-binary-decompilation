; ModuleID = 'Shootout-C++-fibo/test.bc'
...
if.else:                                          ; preds = %entry
  ...
  %sub = sub i64 %1, 2
  %call = call i64 @_Z3fibm(i64 %sub)
  %2 = load i64, i64* %n.addr, align 8
  %sub1 = sub i64 %2, 1
  %call2 = call i64 @_Z3fibm(i64 %sub1)
...
cond.end:                                         ; preds = %cond.false, %cond.true
  ...
  %call1 = call i64 @_Z3fibm(i64 %conv)
  %call2 = call dereferenceable(272) %"class.std::basic_ostream"* @_ZNSolsEm(%"class.std::basic_ostream"* @_ZSt4cout, i64 %call1)
