; ModuleID = 'Shootout-C++-hash2/test.bc'
...
entry:
  ...
  %k = alloca %"struct.__gnu_cxx::_Hashtable_iterator", align 8
  %ref.tmp15 = alloca %"struct.__gnu_cxx::_Hashtable_iterator", align 8
  %ref.tmp37 = alloca i8*, align 8
  %ref.tmp44 = alloca i8*, align 8
  %ref.tmp51 = alloca i8*, align 8
  %ref.tmp58 = alloca i8*, align 8
...
cond.end:                                         ; preds = %cond.false, %cond.true
  ...
  call void @_ZN9__gnu_cxx8hash_mapIPKciNS_4hashIS2_EE5eqstrSaIiEEC2Ev(%"class.__gnu_cxx::hash_map"* %hash1)
  invoke void @_ZN9__gnu_cxx8hash_mapIPKciNS_4hashIS2_EE5eqstrSaIiEEC2Ev(%"class.__gnu_cxx::hash_map"* %hash2)
...
for.cond:                                         ; preds = %for.inc, %invoke.cont
  ...
  %cmp1 = icmp slt i32 %3, 10000
  br i1 %cmp1, label %for.body, label %for.end

for.body:                                         ; preds = %for.cond
  %arraydecay = getelementptr inbounds [16 x i8], [16 x i8]* %buf, i32 0, i32 0
  %4 = load i32, i32* %i, align 4
  %call2 = call i32 (i8*, i8*, ...) @sprintf(i8* %arraydecay, i8* getelementptr inbounds ([7 x i8], [7 x i8]* @.str, i32 0, i32 0), i32 %4) #2
  ...
  %call7 = invoke dereferenceable(4) i32* @_ZN9__gnu_cxx8hash_mapIPKciNS_4hashIS2_EE5eqstrSaIiEEixERKS2_(%"class.__gnu_cxx::hash_map"* %hash1, i8** dereferenceable(8) %ref.tmp)
          to label %invoke.cont6 unwind label %lpad5

invoke.cont6:                                     ; preds = %for.body
  store i32 %5, i32* %call7, align 4
  br label %for.inc
...
lpad:                                             ; preds = %invoke.cont63, %cond.end
  %7 = landingpad { i8*, i32 }
          cleanup
...
lpad5:                                            ; preds = %invoke.cont61, %invoke.cont59, %invoke.cont56, %invoke.cont54, %invoke.cont52, %invoke.cont49, %invoke.cont47, %invoke.cont45, %invoke.cont42, %invoke.cont40, %invoke.cont38, %for.end36, %for.inc30, %invoke.cont25, %invoke.cont23, %invoke.cont21, %for.body20, %invoke.cont16, %for.cond14, %for.body11, %for.body
  ...
  invoke void @_ZN9__gnu_cxx8hash_mapIPKciNS_4hashIS2_EE5eqstrSaIiEED2Ev(%"class.__gnu_cxx::hash_map"* %hash2)
...
for.body11:                                       ; preds = %for.cond9
  %call13 = invoke { %"struct.__gnu_cxx::_Hashtable_node"*, %"class.__gnu_cxx::hashtable"* } @_ZN9__gnu_cxx8hash_mapIPKciNS_4hashIS2_EE5eqstrSaIiEE5beginEv(%"class.__gnu_cxx::hash_map"* %hash1)
          to label %invoke.cont12 unwind label %lpad5

invoke.cont12:                                    ; preds = %for.body11
  %15 = bitcast %"struct.__gnu_cxx::_Hashtable_iterator"* %k to { %"struct.__gnu_cxx::_Hashtable_node"*, %"class.__gnu_cxx::hashtable"* }*
  %16 = getelementptr inbounds { %"struct.__gnu_cxx::_Hashtable_node"*, %"class.__gnu_cxx::hashtable"* }, { %"struct.__gnu_cxx::_Hashtable_node"*, %"class.__gnu_cxx::hashtable"* }* %15, i32 0, i32 0
  %17 = extractvalue { %"struct.__gnu_cxx::_Hashtable_node"*, %"class.__gnu_cxx::hashtable"* } %call13, 0
  store %"struct.__gnu_cxx::_Hashtable_node"* %17, %"struct.__gnu_cxx::_Hashtable_node"** %16, align 8
  %18 = getelementptr inbounds { %"struct.__gnu_cxx::_Hashtable_node"*, %"class.__gnu_cxx::hashtable"* }, { %"struct.__gnu_cxx::_Hashtable_node"*, %"class.__gnu_cxx::hashtable"* }* %15, i32 0, i32 1
  %19 = extractvalue { %"struct.__gnu_cxx::_Hashtable_node"*, %"class.__gnu_cxx::hashtable"* } %call13, 1
  store %"class.__gnu_cxx::hashtable"* %19, %"class.__gnu_cxx::hashtable"** %18, align 8
  br label %for.cond14

for.cond14:                                       ; preds = %invoke.cont31, %invoke.cont12
  %call17 = invoke { %"struct.__gnu_cxx::_Hashtable_node"*, %"class.__gnu_cxx::hashtable"* } @_ZN9__gnu_cxx8hash_mapIPKciNS_4hashIS2_EE5eqstrSaIiEE3endEv(%"class.__gnu_cxx::hash_map"* %hash1)
          to label %invoke.cont16 unwind label %lpad5

invoke.cont16:                                    ; preds = %for.cond14
  %20 = bitcast %"struct.__gnu_cxx::_Hashtable_iterator"* %ref.tmp15 to { %"struct.__gnu_cxx::_Hashtable_node"*, %"class.__gnu_cxx::hashtable"* }*
  %21 = getelementptr inbounds { %"struct.__gnu_cxx::_Hashtable_node"*, %"class.__gnu_cxx::hashtable"* }, { %"struct.__gnu_cxx::_Hashtable_node"*, %"class.__gnu_cxx::hashtable"* }* %20, i32 0, i32 0
  %22 = extractvalue { %"struct.__gnu_cxx::_Hashtable_node"*, %"class.__gnu_cxx::hashtable"* } %call17, 0
  store %"struct.__gnu_cxx::_Hashtable_node"* %22, %"struct.__gnu_cxx::_Hashtable_node"** %21, align 8
  %23 = getelementptr inbounds { %"struct.__gnu_cxx::_Hashtable_node"*, %"class.__gnu_cxx::hashtable"* }, { %"struct.__gnu_cxx::_Hashtable_node"*, %"class.__gnu_cxx::hashtable"* }* %20, i32 0, i32 1
  %24 = extractvalue { %"struct.__gnu_cxx::_Hashtable_node"*, %"class.__gnu_cxx::hashtable"* } %call17, 1
  store %"class.__gnu_cxx::hashtable"* %24, %"class.__gnu_cxx::hashtable"** %23, align 8
  %call19 = invoke zeroext i1 @_ZNK9__gnu_cxx19_Hashtable_iteratorISt4pairIKPKciES3_NS_4hashIS3_EESt10_Select1stIS5_E5eqstrSaIiEEneERKSC_(%"struct.__gnu_cxx::_Hashtable_iterator"* %k, %"struct.__gnu_cxx::_Hashtable_iterator"* dereferenceable(16) %ref.tmp15)
          to label %invoke.cont18 unwind label %lpad5

invoke.cont18:                                    ; preds = %invoke.cont16
  br i1 %call19, label %for.body20, label %for.end33

for.body20:                                       ; preds = %invoke.cont18
  %call22 = invoke dereferenceable(16) %"struct.std::pair"* @_ZNK9__gnu_cxx19_Hashtable_iteratorISt4pairIKPKciES3_NS_4hashIS3_EESt10_Select1stIS5_E5eqstrSaIiEEdeEv(%"struct.__gnu_cxx::_Hashtable_iterator"* %k)
          to label %invoke.cont21 unwind label %lpad5

invoke.cont21:                                    ; preds = %for.body20
  %first = getelementptr inbounds %"struct.std::pair", %"struct.std::pair"* %call22, i32 0, i32 0
  %call24 = invoke dereferenceable(4) i32* @_ZN9__gnu_cxx8hash_mapIPKciNS_4hashIS2_EE5eqstrSaIiEEixERKS2_(%"class.__gnu_cxx::hash_map"* %hash1, i8** dereferenceable(8) %first)
          to label %invoke.cont23 unwind label %lpad5

invoke.cont23:                                    ; preds = %invoke.cont21
  %25 = load i32, i32* %call24, align 4
  %call26 = invoke dereferenceable(16) %"struct.std::pair"* @_ZNK9__gnu_cxx19_Hashtable_iteratorISt4pairIKPKciES3_NS_4hashIS3_EESt10_Select1stIS5_E5eqstrSaIiEEdeEv(%"struct.__gnu_cxx::_Hashtable_iterator"* %k)
          to label %invoke.cont25 unwind label %lpad5

invoke.cont25:                                    ; preds = %invoke.cont23
  %first27 = getelementptr inbounds %"struct.std::pair", %"struct.std::pair"* %call26, i32 0, i32 0
  %call29 = invoke dereferenceable(4) i32* @_ZN9__gnu_cxx8hash_mapIPKciNS_4hashIS2_EE5eqstrSaIiEEixERKS2_(%"class.__gnu_cxx::hash_map"* %hash2, i8** dereferenceable(8) %first27)
          to label %invoke.cont28 unwind label %lpad5

invoke.cont28:                                    ; preds = %invoke.cont25
  %26 = load i32, i32* %call29, align 4
  %add = add nsw i32 %26, %25
  store i32 %add, i32* %call29, align 4
  br label %for.inc30

for.inc30:                                        ; preds = %invoke.cont28
  %call32 = invoke dereferenceable(16) %"struct.__gnu_cxx::_Hashtable_iterator"* @_ZN9__gnu_cxx19_Hashtable_iteratorISt4pairIKPKciES3_NS_4hashIS3_EESt10_Select1stIS5_E5eqstrSaIiEEppEv(%"struct.__gnu_cxx::_Hashtable_iterator"* %k)
          to label %invoke.cont31 unwind label %lpad5

invoke.cont31:                                    ; preds = %for.inc30
  br label %for.cond14

for.end33:                                        ; preds = %invoke.cont18
  br label %for.inc34

for.inc34:                                        ; preds = %for.end33
  %27 = load i32, i32* %i8, align 4
  %inc35 = add nsw i32 %27, 1
  store i32 %inc35, i32* %i8, align 4
  br label %for.cond9

for.end36:                                        ; preds = %for.cond9
  store i8* getelementptr inbounds ([6 x i8], [6 x i8]* @.str.1, i32 0, i32 0), i8** %ref.tmp37, align 8
  %call39 = invoke dereferenceable(4) i32* @_ZN9__gnu_cxx8hash_mapIPKciNS_4hashIS2_EE5eqstrSaIiEEixERKS2_(%"class.__gnu_cxx::hash_map"* %hash1, i8** dereferenceable(8) %ref.tmp37)
          to label %invoke.cont38 unwind label %lpad5

invoke.cont38:                                    ; preds = %for.end36
  %28 = load i32, i32* %call39, align 4
  %call41 = invoke dereferenceable(272) %"class.std::basic_ostream"* @_ZNSolsEi(%"class.std::basic_ostream"* @_ZSt4cout, i32 %28)
...
invoke.cont42:                                    ; preds = %invoke.cont40
  store i8* getelementptr inbounds ([9 x i8], [9 x i8]* @.str.3, i32 0, i32 0), i8** %ref.tmp44, align 8
  %call46 = invoke dereferenceable(4) i32* @_ZN9__gnu_cxx8hash_mapIPKciNS_4hashIS2_EE5eqstrSaIiEEixERKS2_(%"class.__gnu_cxx::hash_map"* %hash1, i8** dereferenceable(8) %ref.tmp44)
          to label %invoke.cont45 unwind label %lpad5

invoke.cont45:                                    ; preds = %invoke.cont42
  %29 = load i32, i32* %call46, align 4
  %call48 = invoke dereferenceable(272) %"class.std::basic_ostream"* @_ZNSolsEi(%"class.std::basic_ostream"* %call43, i32 %29)
          to label %invoke.cont47 unwind label %lpad5

invoke.cont47:                                    ; preds = %invoke.cont45
  %call50 = invoke dereferenceable(272) %"class.std::basic_ostream"* @_ZStlsISt11char_traitsIcEERSt13basic_ostreamIcT_ES5_PKc(%"class.std::basic_ostream"* dereferenceable(272) %call48, i8* getelementptr inbounds ([2 x i8], [2 x i8]* @.str.2, i32 0, i32 0))
          to label %invoke.cont49 unwind label %lpad5

invoke.cont49:                                    ; preds = %invoke.cont47
  store i8* getelementptr inbounds ([6 x i8], [6 x i8]* @.str.1, i32 0, i32 0), i8** %ref.tmp51, align 8
  %call53 = invoke dereferenceable(4) i32* @_ZN9__gnu_cxx8hash_mapIPKciNS_4hashIS2_EE5eqstrSaIiEEixERKS2_(%"class.__gnu_cxx::hash_map"* %hash2, i8** dereferenceable(8) %ref.tmp51)
          to label %invoke.cont52 unwind label %lpad5

invoke.cont52:                                    ; preds = %invoke.cont49
  %30 = load i32, i32* %call53, align 4
  %call55 = invoke dereferenceable(272) %"class.std::basic_ostream"* @_ZNSolsEi(%"class.std::basic_ostream"* %call50, i32 %30)
          to label %invoke.cont54 unwind label %lpad5

invoke.cont54:                                    ; preds = %invoke.cont52
  %call57 = invoke dereferenceable(272) %"class.std::basic_ostream"* @_ZStlsISt11char_traitsIcEERSt13basic_ostreamIcT_ES5_PKc(%"class.std::basic_ostream"* dereferenceable(272) %call55, i8* getelementptr inbounds ([2 x i8], [2 x i8]* @.str.2, i32 0, i32 0))
          to label %invoke.cont56 unwind label %lpad5

invoke.cont56:                                    ; preds = %invoke.cont54
  store i8* getelementptr inbounds ([9 x i8], [9 x i8]* @.str.3, i32 0, i32 0), i8** %ref.tmp58, align 8
  %call60 = invoke dereferenceable(4) i32* @_ZN9__gnu_cxx8hash_mapIPKciNS_4hashIS2_EE5eqstrSaIiEEixERKS2_(%"class.__gnu_cxx::hash_map"* %hash2, i8** dereferenceable(8) %ref.tmp58)
          to label %invoke.cont59 unwind label %lpad5

invoke.cont59:                                    ; preds = %invoke.cont56
  %31 = load i32, i32* %call60, align 4
  %call62 = invoke dereferenceable(272) %"class.std::basic_ostream"* @_ZNSolsEi(%"class.std::basic_ostream"* %call57, i32 %31)
...
invoke.cont65:                                    ; preds = %invoke.cont63
  call void @_ZN9__gnu_cxx8hash_mapIPKciNS_4hashIS2_EE5eqstrSaIiEED2Ev(%"class.__gnu_cxx::hash_map"* %hash1)
  %32 = load i32, i32* %retval, align 4
  ret i32 %32

invoke.cont66:                                    ; preds = %lpad5
  br label %ehcleanup

ehcleanup:                                        ; preds = %invoke.cont66, %lpad
  invoke void @_ZN9__gnu_cxx8hash_mapIPKciNS_4hashIS2_EE5eqstrSaIiEED2Ev(%"class.__gnu_cxx::hash_map"* %hash1)
          to label %invoke.cont67 unwind label %terminate.lpad

invoke.cont67:                                    ; preds = %ehcleanup
  br label %eh.resume

eh.resume:                                        ; preds = %invoke.cont67
...
; Function Attrs: noinline uwtable
define linkonce_odr { %"struct.__gnu_cxx::_Hashtable_node"*, %"class.__gnu_cxx::hashtable"* } @_ZN9__gnu_cxx8hash_mapIPKciNS_4hashIS2_EE5eqstrSaIiEE5beginEv(%"class.__gnu_cxx::hash_map"* %this) #0 comdat align 2 {
entry:
  %retval = alloca %"struct.__gnu_cxx::_Hashtable_iterator", align 8
  %this.addr = alloca %"class.__gnu_cxx::hash_map"*, align 8
  store %"class.__gnu_cxx::hash_map"* %this, %"class.__gnu_cxx::hash_map"** %this.addr, align 8
  %this1 = load %"class.__gnu_cxx::hash_map"*, %"class.__gnu_cxx::hash_map"** %this.addr, align 8
  %_M_ht = getelementptr inbounds %"class.__gnu_cxx::hash_map", %"class.__gnu_cxx::hash_map"* %this1, i32 0, i32 0
  %call = call { %"struct.__gnu_cxx::_Hashtable_node"*, %"class.__gnu_cxx::hashtable"* } @_ZN9__gnu_cxx9hashtableISt4pairIKPKciES3_NS_4hashIS3_EESt10_Select1stIS5_E5eqstrSaIiEE5beginEv(%"class.__gnu_cxx::hashtable"* %_M_ht)
  %0 = bitcast %"struct.__gnu_cxx::_Hashtable_iterator"* %retval to { %"struct.__gnu_cxx::_Hashtable_node"*, %"class.__gnu_cxx::hashtable"* }*
  %1 = getelementptr inbounds { %"struct.__gnu_cxx::_Hashtable_node"*, %"class.__gnu_cxx::hashtable"* }, { %"struct.__gnu_cxx::_Hashtable_node"*, %"class.__gnu_cxx::hashtable"* }* %0, i32 0, i32 0
  %2 = extractvalue { %"struct.__gnu_cxx::_Hashtable_node"*, %"class.__gnu_cxx::hashtable"* } %call, 0
  store %"struct.__gnu_cxx::_Hashtable_node"* %2, %"struct.__gnu_cxx::_Hashtable_node"** %1, align 8
  %3 = getelementptr inbounds { %"struct.__gnu_cxx::_Hashtable_node"*, %"class.__gnu_cxx::hashtable"* }, { %"struct.__gnu_cxx::_Hashtable_node"*, %"class.__gnu_cxx::hashtable"* }* %0, i32 0, i32 1
  %4 = extractvalue { %"struct.__gnu_cxx::_Hashtable_node"*, %"class.__gnu_cxx::hashtable"* } %call, 1
  store %"class.__gnu_cxx::hashtable"* %4, %"class.__gnu_cxx::hashtable"** %3, align 8
  %5 = bitcast %"struct.__gnu_cxx::_Hashtable_iterator"* %retval to { %"struct.__gnu_cxx::_Hashtable_node"*, %"class.__gnu_cxx::hashtable"* }*
...
; Function Attrs: noinline uwtable
define linkonce_odr { %"struct.__gnu_cxx::_Hashtable_node"*, %"class.__gnu_cxx::hashtable"* } @_ZN9__gnu_cxx8hash_mapIPKciNS_4hashIS2_EE5eqstrSaIiEE3endEv(%"class.__gnu_cxx::hash_map"* %this) #0 comdat align 2 {
entry:
  %retval = alloca %"struct.__gnu_cxx::_Hashtable_iterator", align 8
  %this.addr = alloca %"class.__gnu_cxx::hash_map"*, align 8
  store %"class.__gnu_cxx::hash_map"* %this, %"class.__gnu_cxx::hash_map"** %this.addr, align 8
  %this1 = load %"class.__gnu_cxx::hash_map"*, %"class.__gnu_cxx::hash_map"** %this.addr, align 8
  %_M_ht = getelementptr inbounds %"class.__gnu_cxx::hash_map", %"class.__gnu_cxx::hash_map"* %this1, i32 0, i32 0
  %call = call { %"struct.__gnu_cxx::_Hashtable_node"*, %"class.__gnu_cxx::hashtable"* } @_ZN9__gnu_cxx9hashtableISt4pairIKPKciES3_NS_4hashIS3_EESt10_Select1stIS5_E5eqstrSaIiEE3endEv(%"class.__gnu_cxx::hashtable"* %_M_ht)
  %0 = bitcast %"struct.__gnu_cxx::_Hashtable_iterator"* %retval to { %"struct.__gnu_cxx::_Hashtable_node"*, %"class.__gnu_cxx::hashtable"* }*
  %1 = getelementptr inbounds { %"struct.__gnu_cxx::_Hashtable_node"*, %"class.__gnu_cxx::hashtable"* }, { %"struct.__gnu_cxx::_Hashtable_node"*, %"class.__gnu_cxx::hashtable"* }* %0, i32 0, i32 0
  %2 = extractvalue { %"struct.__gnu_cxx::_Hashtable_node"*, %"class.__gnu_cxx::hashtable"* } %call, 0
  store %"struct.__gnu_cxx::_Hashtable_node"* %2, %"struct.__gnu_cxx::_Hashtable_node"** %1, align 8
...
define linkonce_odr zeroext i1 @_ZNK9__gnu_cxx19_Hashtable_iteratorISt4pairIKPKciES3_NS_4hashIS3_EESt10_Select1stIS5_E5eqstrSaIiEEneERKSC_(%"struct.__gnu_cxx::_Hashtable_iterator"* %this, %"struct.__gnu_cxx::_Hashtable_iterator"* dereferenceable(16) %__it) #6 comdat align 2 {
entry:
  %this.addr = alloca %"struct.__gnu_cxx::_Hashtable_iterator"*, align 8
  %__it.addr = alloca %"struct.__gnu_cxx::_Hashtable_iterator"*, align 8
  store %"struct.__gnu_cxx::_Hashtable_iterator"* %this, %"struct.__gnu_cxx::_Hashtable_iterator"** %this.addr, align 8
  store %"struct.__gnu_cxx::_Hashtable_iterator"* %__it, %"struct.__gnu_cxx::_Hashtable_iterator"** %__it.addr, align 8
  %this1 = load %"struct.__gnu_cxx::_Hashtable_iterator"*, %"struct.__gnu_cxx::_Hashtable_iterator"** %this.addr, align 8
  %_M_cur = getelementptr inbounds %"struct.__gnu_cxx::_Hashtable_iterator", %"struct.__gnu_cxx::_Hashtable_iterator"* %this1, i32 0, i32 0
  %0 = load %"struct.__gnu_cxx::_Hashtable_node"*, %"struct.__gnu_cxx::_Hashtable_node"** %_M_cur, align 8
  %1 = load %"struct.__gnu_cxx::_Hashtable_iterator"*, %"struct.__gnu_cxx::_Hashtable_iterator"** %__it.addr, align 8
  %_M_cur2 = getelementptr inbounds %"struct.__gnu_cxx::_Hashtable_iterator", %"struct.__gnu_cxx::_Hashtable_iterator"* %1, i32 0, i32 0
  %2 = load %"struct.__gnu_cxx::_Hashtable_node"*, %"struct.__gnu_cxx::_Hashtable_node"** %_M_cur2, align 8
  %cmp = icmp ne %"struct.__gnu_cxx::_Hashtable_node"* %0, %2
  ret i1 %cmp
}

; Function Attrs: noinline nounwind uwtable
define linkonce_odr dereferenceable(16) %"struct.std::pair"* @_ZNK9__gnu_cxx19_Hashtable_iteratorISt4pairIKPKciES3_NS_4hashIS3_EESt10_Select1stIS5_E5eqstrSaIiEEdeEv(%"struct.__gnu_cxx::_Hashtable_iterator"* %this) #6 comdat align 2 {
entry:
  %this.addr = alloca %"struct.__gnu_cxx::_Hashtable_iterator"*, align 8
  store %"struct.__gnu_cxx::_Hashtable_iterator"* %this, %"struct.__gnu_cxx::_Hashtable_iterator"** %this.addr, align 8
  %this1 = load %"struct.__gnu_cxx::_Hashtable_iterator"*, %"struct.__gnu_cxx::_Hashtable_iterator"** %this.addr, align 8
  %_M_cur = getelementptr inbounds %"struct.__gnu_cxx::_Hashtable_iterator", %"struct.__gnu_cxx::_Hashtable_iterator"* %this1, i32 0, i32 0
  %0 = load %"struct.__gnu_cxx::_Hashtable_node"*, %"struct.__gnu_cxx::_Hashtable_node"** %_M_cur, align 8
  %_M_val = getelementptr inbounds %"struct.__gnu_cxx::_Hashtable_node", %"struct.__gnu_cxx::_Hashtable_node"* %0, i32 0, i32 1
  ret %"struct.std::pair"* %_M_val
}

; Function Attrs: noinline uwtable
define linkonce_odr dereferenceable(16) %"struct.__gnu_cxx::_Hashtable_iterator"* @_ZN9__gnu_cxx19_Hashtable_iteratorISt4pairIKPKciES3_NS_4hashIS3_EESt10_Select1stIS5_E5eqstrSaIiEEppEv(%"struct.__gnu_cxx::_Hashtable_iterator"* %this) #0 comdat align 2 {
entry:
  %this.addr = alloca %"struct.__gnu_cxx::_Hashtable_iterator"*, align 8
  %__old = alloca %"struct.__gnu_cxx::_Hashtable_node"*, align 8
  %__bucket = alloca i64, align 8
  store %"struct.__gnu_cxx::_Hashtable_iterator"* %this, %"struct.__gnu_cxx::_Hashtable_iterator"** %this.addr, align 8
  %this1 = load %"struct.__gnu_cxx::_Hashtable_iterator"*, %"struct.__gnu_cxx::_Hashtable_iterator"** %this.addr, align 8
  %_M_cur = getelementptr inbounds %"struct.__gnu_cxx::_Hashtable_iterator", %"struct.__gnu_cxx::_Hashtable_iterator"* %this1, i32 0, i32 0
  %0 = load %"struct.__gnu_cxx::_Hashtable_node"*, %"struct.__gnu_cxx::_Hashtable_node"** %_M_cur, align 8
  store %"struct.__gnu_cxx::_Hashtable_node"* %0, %"struct.__gnu_cxx::_Hashtable_node"** %__old, align 8
  %_M_cur2 = getelementptr inbounds %"struct.__gnu_cxx::_Hashtable_iterator", %"struct.__gnu_cxx::_Hashtable_iterator"* %this1, i32 0, i32 0
  %1 = load %"struct.__gnu_cxx::_Hashtable_node"*, %"struct.__gnu_cxx::_Hashtable_node"** %_M_cur2, align 8
  %_M_next = getelementptr inbounds %"struct.__gnu_cxx::_Hashtable_node", %"struct.__gnu_cxx::_Hashtable_node"* %1, i32 0, i32 0
  %2 = load %"struct.__gnu_cxx::_Hashtable_node"*, %"struct.__gnu_cxx::_Hashtable_node"** %_M_next, align 8
  %_M_cur3 = getelementptr inbounds %"struct.__gnu_cxx::_Hashtable_iterator", %"struct.__gnu_cxx::_Hashtable_iterator"* %this1, i32 0, i32 0
  store %"struct.__gnu_cxx::_Hashtable_node"* %2, %"struct.__gnu_cxx::_Hashtable_node"** %_M_cur3, align 8
  %_M_cur4 = getelementptr inbounds %"struct.__gnu_cxx::_Hashtable_iterator", %"struct.__gnu_cxx::_Hashtable_iterator"* %this1, i32 0, i32 0
  %3 = load %"struct.__gnu_cxx::_Hashtable_node"*, %"struct.__gnu_cxx::_Hashtable_node"** %_M_cur4, align 8
  %tobool = icmp ne %"struct.__gnu_cxx::_Hashtable_node"* %3, null
  br i1 %tobool, label %if.end, label %if.then

if.then:                                          ; preds = %entry
  %_M_ht = getelementptr inbounds %"struct.__gnu_cxx::_Hashtable_iterator", %"struct.__gnu_cxx::_Hashtable_iterator"* %this1, i32 0, i32 1
  %4 = load %"class.__gnu_cxx::hashtable"*, %"class.__gnu_cxx::hashtable"** %_M_ht, align 8
  %5 = load %"struct.__gnu_cxx::_Hashtable_node"*, %"struct.__gnu_cxx::_Hashtable_node"** %__old, align 8
  %_M_val = getelementptr inbounds %"struct.__gnu_cxx::_Hashtable_node", %"struct.__gnu_cxx::_Hashtable_node"* %5, i32 0, i32 1
  %call = call i64 @_ZNK9__gnu_cxx9hashtableISt4pairIKPKciES3_NS_4hashIS3_EESt10_Select1stIS5_E5eqstrSaIiEE10_M_bkt_numERKS5_(%"class.__gnu_cxx::hashtable"* %4, %"struct.std::pair"* dereferenceable(16) %_M_val)
  store i64 %call, i64* %__bucket, align 8
  br label %while.cond

while.cond:                                       ; preds = %while.body, %if.then
  %_M_cur5 = getelementptr inbounds %"struct.__gnu_cxx::_Hashtable_iterator", %"struct.__gnu_cxx::_Hashtable_iterator"* %this1, i32 0, i32 0
  %6 = load %"struct.__gnu_cxx::_Hashtable_node"*, %"struct.__gnu_cxx::_Hashtable_node"** %_M_cur5, align 8
  %tobool6 = icmp ne %"struct.__gnu_cxx::_Hashtable_node"* %6, null
...
land.rhs:                                         ; preds = %while.cond
  ...
  %_M_ht7 = getelementptr inbounds %"struct.__gnu_cxx::_Hashtable_iterator", %"struct.__gnu_cxx::_Hashtable_iterator"* %this1, i32 0, i32 1
  %8 = load %"class.__gnu_cxx::hashtable"*, %"class.__gnu_cxx::hashtable"** %_M_ht7, align 8
  %_M_buckets = getelementptr inbounds %"class.__gnu_cxx::hashtable", %"class.__gnu_cxx::hashtable"* %8, i32 0, i32 4
  %call8 = call i64 @_ZNKSt6vectorIPN9__gnu_cxx15_Hashtable_nodeISt4pairIKPKciEEESaIS8_EE4sizeEv(%"class.std::vector"* %_M_buckets)
  %cmp = icmp ult i64 %inc, %call8
  br label %land.end
...
while.body:                                       ; preds = %land.end
  %_M_ht9 = getelementptr inbounds %"struct.__gnu_cxx::_Hashtable_iterator", %"struct.__gnu_cxx::_Hashtable_iterator"* %this1, i32 0, i32 1
  %10 = load %"class.__gnu_cxx::hashtable"*, %"class.__gnu_cxx::hashtable"** %_M_ht9, align 8
  %_M_buckets10 = getelementptr inbounds %"class.__gnu_cxx::hashtable", %"class.__gnu_cxx::hashtable"* %10, i32 0, i32 4
  %11 = load i64, i64* %__bucket, align 8
  %call11 = call dereferenceable(8) %"struct.__gnu_cxx::_Hashtable_node"** @_ZNSt6vectorIPN9__gnu_cxx15_Hashtable_nodeISt4pairIKPKciEEESaIS8_EEixEm(%"class.std::vector"* %_M_buckets10, i64 %11)
  %12 = load %"struct.__gnu_cxx::_Hashtable_node"*, %"struct.__gnu_cxx::_Hashtable_node"** %call11, align 8
  %_M_cur12 = getelementptr inbounds %"struct.__gnu_cxx::_Hashtable_iterator", %"struct.__gnu_cxx::_Hashtable_iterator"* %this1, i32 0, i32 0
  store %"struct.__gnu_cxx::_Hashtable_node"* %12, %"struct.__gnu_cxx::_Hashtable_node"** %_M_cur12, align 8
  br label %while.cond
...
if.end:                                           ; preds = %while.end, %entry
  ret %"struct.__gnu_cxx::_Hashtable_iterator"* %this1
}
...
; Function Attrs: noinline nounwind uwtable
define linkonce_odr i64 @_ZNKSt6vectorIPN9__gnu_cxx15_Hashtable_nodeISt4pairIKPKciEEESaIS8_EE4sizeEv(%"class.std::vector"* %this) #6 comdat align 2 {
entry:
...
; Function Attrs: noinline nounwind uwtable
define linkonce_odr dereferenceable(8) %"struct.__gnu_cxx::_Hashtable_node"** @_ZNSt6vectorIPN9__gnu_cxx15_Hashtable_nodeISt4pairIKPKciEEESaIS8_EEixEm(%"class.std::vector"* %this, i64 %__n) #6 comdat align 2 {
entry:
  %this.addr = alloca %"class.std::vector"*, align 8
...
; Function Attrs: noinline nounwind uwtable
define linkonce_odr dereferenceable(8) i8** @_ZNKSt10_Select1stISt4pairIKPKciEEclERKS4_(%"class.std::ios_base::Init"* %this, %"struct.std::pair"* dereferenceable(16) %__x) #6 comdat align 2 {
entry:
...
; Function Attrs: noinline nounwind uwtable
define linkonce_odr i64 @_ZN9__gnu_cxx17__stl_hash_stringEPKc(i8* %__s) #6 comdat {
entry:
  %__s.addr = alloca i8*, align 8
...
; Function Attrs: noinline uwtable
define linkonce_odr { %"struct.__gnu_cxx::_Hashtable_node"*, %"class.__gnu_cxx::hashtable"* } @_ZN9__gnu_cxx9hashtableISt4pairIKPKciES3_NS_4hashIS3_EESt10_Select1stIS5_E5eqstrSaIiEE3endEv(%"class.__gnu_cxx::hashtable"* %this) #0 comdat align 2 {
entry:
  %retval = alloca %"struct.__gnu_cxx::_Hashtable_iterator", align 8
  %this.addr = alloca %"class.__gnu_cxx::hashtable"*, align 8
  store %"class.__gnu_cxx::hashtable"* %this, %"class.__gnu_cxx::hashtable"** %this.addr, align 8
  %this1 = load %"class.__gnu_cxx::hashtable"*, %"class.__gnu_cxx::hashtable"** %this.addr, align 8
  call void @_ZN9__gnu_cxx19_Hashtable_iteratorISt4pairIKPKciES3_NS_4hashIS3_EESt10_Select1stIS5_E5eqstrSaIiEEC2EPNS_15_Hashtable_nodeIS5_EEPNS_9hashtableIS5_S3_S7_S9_SA_SB_EE(%"struct.__gnu_cxx::_Hashtable_iterator"* %retval, %"struct.__gnu_cxx::_Hashtable_node"* null, %"class.__gnu_cxx::hashtable"* %this1)
  %0 = bitcast %"struct.__gnu_cxx::_Hashtable_iterator"* %retval to { %"struct.__gnu_cxx::_Hashtable_node"*, %"class.__gnu_cxx::hashtable"* }*
  %1 = load { %"struct.__gnu_cxx::_Hashtable_node"*, %"class.__gnu_cxx::hashtable"* }, { %"struct.__gnu_cxx::_Hashtable_node"*, %"class.__gnu_cxx::hashtable"* }* %0, align 8
  ret { %"struct.__gnu_cxx::_Hashtable_node"*, %"class.__gnu_cxx::hashtable"* } %1
}

; Function Attrs: noinline nounwind uwtable
define linkonce_odr void @_ZN9__gnu_cxx19_Hashtable_iteratorISt4pairIKPKciES3_NS_4hashIS3_EESt10_Select1stIS5_E5eqstrSaIiEEC2EPNS_15_Hashtable_nodeIS5_EEPNS_9hashtableIS5_S3_S7_S9_SA_SB_EE(%"struct.__gnu_cxx::_Hashtable_iterator"* %this, %"struct.__gnu_cxx::_Hashtable_node"* %__n, %"class.__gnu_cxx::hashtable"* %__tab) unnamed_addr #6 comdat align 2 {
entry:
  %this.addr = alloca %"struct.__gnu_cxx::_Hashtable_iterator"*, align 8
  %__n.addr = alloca %"struct.__gnu_cxx::_Hashtable_node"*, align 8
  %__tab.addr = alloca %"class.__gnu_cxx::hashtable"*, align 8
  store %"struct.__gnu_cxx::_Hashtable_iterator"* %this, %"struct.__gnu_cxx::_Hashtable_iterator"** %this.addr, align 8
  store %"struct.__gnu_cxx::_Hashtable_node"* %__n, %"struct.__gnu_cxx::_Hashtable_node"** %__n.addr, align 8
  store %"class.__gnu_cxx::hashtable"* %__tab, %"class.__gnu_cxx::hashtable"** %__tab.addr, align 8
  %this1 = load %"struct.__gnu_cxx::_Hashtable_iterator"*, %"struct.__gnu_cxx::_Hashtable_iterator"** %this.addr, align 8
  %_M_cur = getelementptr inbounds %"struct.__gnu_cxx::_Hashtable_iterator", %"struct.__gnu_cxx::_Hashtable_iterator"* %this1, i32 0, i32 0
  %0 = load %"struct.__gnu_cxx::_Hashtable_node"*, %"struct.__gnu_cxx::_Hashtable_node"** %__n.addr, align 8
  store %"struct.__gnu_cxx::_Hashtable_node"* %0, %"struct.__gnu_cxx::_Hashtable_node"** %_M_cur, align 8
  %_M_ht = getelementptr inbounds %"struct.__gnu_cxx::_Hashtable_iterator", %"struct.__gnu_cxx::_Hashtable_iterator"* %this1, i32 0, i32 1
  %1 = load %"class.__gnu_cxx::hashtable"*, %"class.__gnu_cxx::hashtable"** %__tab.addr, align 8
  store %"class.__gnu_cxx::hashtable"* %1, %"class.__gnu_cxx::hashtable"** %_M_ht, align 8
  ret void
}

; Function Attrs: noinline uwtable
define linkonce_odr { %"struct.__gnu_cxx::_Hashtable_node"*, %"class.__gnu_cxx::hashtable"* } @_ZN9__gnu_cxx9hashtableISt4pairIKPKciES3_NS_4hashIS3_EESt10_Select1stIS5_E5eqstrSaIiEE5beginEv(%"class.__gnu_cxx::hashtable"* %this) #0 comdat align 2 {
entry:
  %retval = alloca %"struct.__gnu_cxx::_Hashtable_iterator", align 8
  %this.addr = alloca %"class.__gnu_cxx::hashtable"*, align 8
...
for.body:                                         ; preds = %for.cond
  ...
  %call3 = call dereferenceable(8) %"struct.__gnu_cxx::_Hashtable_node"** @_ZNSt6vectorIPN9__gnu_cxx15_Hashtable_nodeISt4pairIKPKciEEESaIS8_EEixEm(%"class.std::vector"* %_M_buckets2, i64 %1)
  %2 = load %"struct.__gnu_cxx::_Hashtable_node"*, %"struct.__gnu_cxx::_Hashtable_node"** %call3, align 8
  %tobool = icmp ne %"struct.__gnu_cxx::_Hashtable_node"* %2, null
...
if.then:                                          ; preds = %for.body
  ...
  %call5 = call dereferenceable(8) %"struct.__gnu_cxx::_Hashtable_node"** @_ZNSt6vectorIPN9__gnu_cxx15_Hashtable_nodeISt4pairIKPKciEEESaIS8_EEixEm(%"class.std::vector"* %_M_buckets4, i64 %3)
  %4 = load %"struct.__gnu_cxx::_Hashtable_node"*, %"struct.__gnu_cxx::_Hashtable_node"** %call5, align 8
  call void @_ZN9__gnu_cxx19_Hashtable_iteratorISt4pairIKPKciES3_NS_4hashIS3_EESt10_Select1stIS5_E5eqstrSaIiEEC2EPNS_15_Hashtable_nodeIS5_EEPNS_9hashtableIS5_S3_S7_S9_SA_SB_EE(%"struct.__gnu_cxx::_Hashtable_iterator"* %retval, %"struct.__gnu_cxx::_Hashtable_node"* %4, %"class.__gnu_cxx::hashtable"* %this1)
  br label %return
...
for.end:                                          ; preds = %for.cond
  %call6 = call { %"struct.__gnu_cxx::_Hashtable_node"*, %"class.__gnu_cxx::hashtable"* } @_ZN9__gnu_cxx9hashtableISt4pairIKPKciES3_NS_4hashIS3_EESt10_Select1stIS5_E5eqstrSaIiEE3endEv(%"class.__gnu_cxx::hashtable"* %this1)
  %6 = bitcast %"struct.__gnu_cxx::_Hashtable_iterator"* %retval to { %"struct.__gnu_cxx::_Hashtable_node"*, %"class.__gnu_cxx::hashtable"* }*
  %7 = getelementptr inbounds { %"struct.__gnu_cxx::_Hashtable_node"*, %"class.__gnu_cxx::hashtable"* }, { %"struct.__gnu_cxx::_Hashtable_node"*, %"class.__gnu_cxx::hashtable"* }* %6, i32 0, i32 0
  %8 = extractvalue { %"struct.__gnu_cxx::_Hashtable_node"*, %"class.__gnu_cxx::hashtable"* } %call6, 0
  store %"struct.__gnu_cxx::_Hashtable_node"* %8, %"struct.__gnu_cxx::_Hashtable_node"** %7, align 8
  %9 = getelementptr inbounds { %"struct.__gnu_cxx::_Hashtable_node"*, %"class.__gnu_cxx::hashtable"* }, { %"struct.__gnu_cxx::_Hashtable_node"*, %"class.__gnu_cxx::hashtable"* }* %6, i32 0, i32 1
  %10 = extractvalue { %"struct.__gnu_cxx::_Hashtable_node"*, %"class.__gnu_cxx::hashtable"* } %call6, 1
  store %"class.__gnu_cxx::hashtable"* %10, %"class.__gnu_cxx::hashtable"** %9, align 8
  br label %return

return:                                           ; preds = %for.end, %if.then
  %11 = bitcast %"struct.__gnu_cxx::_Hashtable_iterator"* %retval to { %"struct.__gnu_cxx::_Hashtable_node"*, %"class.__gnu_cxx::hashtable"* }*
  %12 = load { %"struct.__gnu_cxx::_Hashtable_node"*, %"class.__gnu_cxx::hashtable"* }, { %"struct.__gnu_cxx::_Hashtable_node"*, %"class.__gnu_cxx::hashtable"* }* %11, align 8
  ret { %"struct.__gnu_cxx::_Hashtable_node"*, %"class.__gnu_cxx::hashtable"* } %12
}
...
; Function Attrs: noinline nounwind uwtable
define linkonce_odr void @_ZNSaIN9__gnu_cxx15_Hashtable_nodeISt4pairIKPKciEEEED2Ev(%"class.std::ios_base::Init"* %this) unnamed_addr #6 comdat align 2 {
entry:
  %this.addr = alloca %"class.std::ios_base::Init"*, align 8
  store %"class.std::ios_base::Init"* %this, %"class.std::ios_base::Init"** %this.addr, align 8
  %this1 = load %"class.std::ios_base::Init"*, %"class.std::ios_base::Init"** %this.addr, align 8
...
; Function Attrs: noinline nounwind uwtable
define linkonce_odr void @_ZN9__gnu_cxx13new_allocatorINS_15_Hashtable_nodeISt4pairIKPKciEEEED2Ev(%"class.std::ios_base::Init"* %this) unnamed_addr #6 comdat align 2 {
entry:
  %this.addr = alloca %"class.std::ios_base::Init"*, align 8
  store %"class.std::ios_base::Init"* %this, %"class.std::ios_base::Init"** %this.addr, align 8
  %this1 = load %"class.std::ios_base::Init"*, %"class.std::ios_base::Init"** %this.addr, align 8
...
; Function Attrs: noinline nounwind uwtable
define linkonce_odr dereferenceable(1) %"class.std::ios_base::Init"* @_ZNSt12_Vector_baseIPN9__gnu_cxx15_Hashtable_nodeISt4pairIKPKciEEESaIS8_EE19_M_get_Tp_allocatorEv(%"struct.std::_Vector_base"* %this) #6 comdat align 2 {
entry:
...
; Function Attrs: noinline nounwind uwtable
define linkonce_odr void @_ZNSaIPN9__gnu_cxx15_Hashtable_nodeISt4pairIKPKciEEEED2Ev(%"class.std::ios_base::Init"* %this) unnamed_addr #6 comdat align 2 {
entry:
  %this.addr = alloca %"class.std::ios_base::Init"*, align 8
  store %"class.std::ios_base::Init"* %this, %"class.std::ios_base::Init"** %this.addr, align 8
  %this1 = load %"class.std::ios_base::Init"*, %"class.std::ios_base::Init"** %this.addr, align 8
...
; Function Attrs: noinline nounwind uwtable
define linkonce_odr void @_ZN9__gnu_cxx13new_allocatorIPNS_15_Hashtable_nodeISt4pairIKPKciEEEED2Ev(%"class.std::ios_base::Init"* %this) unnamed_addr #6 comdat align 2 {
entry:
  %this.addr = alloca %"class.std::ios_base::Init"*, align 8
  store %"class.std::ios_base::Init"* %this, %"class.std::ios_base::Init"** %this.addr, align 8
  %this1 = load %"class.std::ios_base::Init"*, %"class.std::ios_base::Init"** %this.addr, align 8
...
; Function Attrs: noinline nounwind uwtable
define linkonce_odr void @_ZN9__gnu_cxx13new_allocatorIPNS_15_Hashtable_nodeISt4pairIKPKciEEEE10deallocateEPS8_m(%"class.std::ios_base::Init"* %this, %"struct.__gnu_cxx::_Hashtable_node"** %__p, i64) #6 comdat align 2 {
entry:
  %this.addr = alloca %"class.std::ios_base::Init"*, align 8
  %__p.addr = alloca %"struct.__gnu_cxx::_Hashtable_node"**, align 8
...
; Function Attrs: noinline nounwind uwtable
define linkonce_odr void @_ZNSt12_Destroy_auxILb1EE9__destroyIPPN9__gnu_cxx15_Hashtable_nodeISt4pairIKPKciEEEEEvT_SC_(%"struct.__gnu_cxx::_Hashtable_node"**, %"struct.__gnu_cxx::_Hashtable_node"**) #6 comdat align 2 {
entry:
...
; Function Attrs: noinline nounwind uwtable
define linkonce_odr void @_ZNK9__gnu_cxx9hashtableISt4pairIKPKciES3_NS_4hashIS3_EESt10_Select1stIS5_E5eqstrSaIiEE13get_allocatorEv(%"class.std::ios_base::Init"* noalias sret %agg.result, %"class.__gnu_cxx::hashtable"* %this) #6 comdat align 2 {
entry:
  %this.addr = alloca %"class.__gnu_cxx::hashtable"*, align 8
  store %"class.__gnu_cxx::hashtable"* %this, %"class.__gnu_cxx::hashtable"** %this.addr, align 8
  %this1 = load %"class.__gnu_cxx::hashtable"*, %"class.__gnu_cxx::hashtable"** %this.addr, align 8
...
; Function Attrs: noinline nounwind uwtable
define linkonce_odr void @_ZN9__gnu_cxx13new_allocatorISt4pairIKPKciEE7destroyEPS5_(%"class.std::ios_base::Init"* %this, %"struct.std::pair"* %__p) #6 comdat align 2 {
entry:
  %this.addr = alloca %"class.std::ios_base::Init"*, align 8
...
; Function Attrs: noinline nounwind uwtable
define linkonce_odr void @_ZNSaISt4pairIKPKciEED2Ev(%"class.std::ios_base::Init"* %this) unnamed_addr #6 comdat align 2 {
entry:
  %this.addr = alloca %"class.std::ios_base::Init"*, align 8
  store %"class.std::ios_base::Init"* %this, %"class.std::ios_base::Init"** %this.addr, align 8
  %this1 = load %"class.std::ios_base::Init"*, %"class.std::ios_base::Init"** %this.addr, align 8
...
; Function Attrs: noinline nounwind uwtable
define linkonce_odr void @_ZN9__gnu_cxx13new_allocatorINS_15_Hashtable_nodeISt4pairIKPKciEEEE10deallocateEPS7_m(%"class.std::ios_base::Init"* %this, %"struct.__gnu_cxx::_Hashtable_node"* %__p, i64) #6 comdat align 2 {
entry:
  %this.addr = alloca %"class.std::ios_base::Init"*, align 8
  %__p.addr = alloca %"struct.__gnu_cxx::_Hashtable_node"*, align 8
  %.addr = alloca i64, align 8
...
; Function Attrs: noinline nounwind uwtable
define linkonce_odr void @_ZN9__gnu_cxx13new_allocatorISt4pairIKPKciEED2Ev(%"class.std::ios_base::Init"* %this) unnamed_addr #6 comdat align 2 {
entry:
  %this.addr = alloca %"class.std::ios_base::Init"*, align 8
  store %"class.std::ios_base::Init"* %this, %"class.std::ios_base::Init"** %this.addr, align 8
  %this1 = load %"class.std::ios_base::Init"*, %"class.std::ios_base::Init"** %this.addr, align 8
...
; Function Attrs: noinline nounwind uwtable
define linkonce_odr void @_ZNSaISt4pairIKPKciEEC2IN9__gnu_cxx15_Hashtable_nodeIS3_EEEERKSaIT_E(%"class.std::ios_base::Init"* %this, %"class.std::ios_base::Init"* dereferenceable(1)) unnamed_addr #6 comdat align 2 {
entry:
  %this.addr = alloca %"class.std::ios_base::Init"*, align 8
  %.addr = alloca %"class.std::ios_base::Init"*, align 8
  store %"class.std::ios_base::Init"* %this, %"class.std::ios_base::Init"** %this.addr, align 8
...
; Function Attrs: noinline nounwind uwtable
define linkonce_odr void @_ZN9__gnu_cxx13new_allocatorISt4pairIKPKciEEC2Ev(%"class.std::ios_base::Init"* %this) unnamed_addr #6 comdat align 2 {
entry:
  %this.addr = alloca %"class.std::ios_base::Init"*, align 8
  store %"class.std::ios_base::Init"* %this, %"class.std::ios_base::Init"** %this.addr, align 8
  %this1 = load %"class.std::ios_base::Init"*, %"class.std::ios_base::Init"** %this.addr, align 8
...
; Function Attrs: noinline nounwind uwtable
define linkonce_odr void @_ZNSt4pairIKPKciEC2ERS2_RKi(%"struct.std::pair"* %this, i8** dereferenceable(8) %__a, i32* dereferenceable(4) %__b) unnamed_addr #6 comdat align 2 {
entry:
...
; Function Attrs: noinline nounwind uwtable
define linkonce_odr dereferenceable(8) i8** @_ZNKSt10_Select1stISt4pairIKPKciEEclERS4_(%"class.std::ios_base::Init"* %this, %"struct.std::pair"* dereferenceable(16) %__x) #6 comdat align 2 {
entry:
  %this.addr = alloca %"class.std::ios_base::Init"*, align 8
  %__x.addr = alloca %"struct.std::pair"*, align 8
  store %"class.std::ios_base::Init"* %this, %"class.std::ios_base::Init"** %this.addr, align 8
...
; Function Attrs: noinline nounwind uwtable
define linkonce_odr zeroext i1 @_ZNK5eqstrclEPKcS1_(%"class.std::ios_base::Init"* %this, i8* %s1, i8* %s2) #6 comdat align 2 {
entry:
  %this.addr = alloca %"class.std::ios_base::Init"*, align 8
...
; Function Attrs: noinline nounwind uwtable
define linkonce_odr void @_ZN9__gnu_cxx13new_allocatorISt4pairIKPKciEE9constructEPS5_RKS5_(%"class.std::ios_base::Init"* %this, %"struct.std::pair"* %__p, %"struct.std::pair"* dereferenceable(16) %__val) #6 comdat align 2 {
entry:
  %this.addr = alloca %"class.std::ios_base::Init"*, align 8
  %__p.addr = alloca %"struct.std::pair"*, align 8
...
; Function Attrs: noinline nounwind uwtable
define linkonce_odr i64 @_ZNK9__gnu_cxx13new_allocatorINS_15_Hashtable_nodeISt4pairIKPKciEEEE8max_sizeEv(%"class.std::ios_base::Init"* %this) #6 comdat align 2 {
entry:
  %this.addr = alloca %"class.std::ios_base::Init"*, align 8
  store %"class.std::ios_base::Init"* %this, %"class.std::ios_base::Init"** %this.addr, align 8
  %this1 = load %"class.std::ios_base::Init"*, %"class.std::ios_base::Init"** %this.addr, align 8
...
; Function Attrs: noinline nounwind uwtable
define linkonce_odr void @_ZNKSt12_Vector_baseIPN9__gnu_cxx15_Hashtable_nodeISt4pairIKPKciEEESaIS8_EE13get_allocatorEv(%"class.std::ios_base::Init"* noalias sret %agg.result, %"struct.std::_Vector_base"* %this) #6 comdat align 2 {
entry:
  %this.addr = alloca %"struct.std::_Vector_base"*, align 8
  store %"struct.std::_Vector_base"* %this, %"struct.std::_Vector_base"** %this.addr, align 8
  %this1 = load %"struct.std::_Vector_base"*, %"struct.std::_Vector_base"** %this.addr, align 8
...
; Function Attrs: noinline nounwind uwtable
define linkonce_odr void @_ZNSt12__alloc_swapISaIPN9__gnu_cxx15_Hashtable_nodeISt4pairIKPKciEEEELb1EE8_S_do_itERS9_SB_(%"class.std::ios_base::Init"* dereferenceable(1), %"class.std::ios_base::Init"* dereferenceable(1)) #6 comdat align 2 {
entry:
  %.addr = alloca %"class.std::ios_base::Init"*, align 8
...
; Function Attrs: noinline nounwind uwtable
define linkonce_odr void @_ZSt4swapIPPN9__gnu_cxx15_Hashtable_nodeISt4pairIKPKciEEEEvRT_SB_(%"struct.__gnu_cxx::_Hashtable_node"*** dereferenceable(8) %__a, %"struct.__gnu_cxx::_Hashtable_node"*** dereferenceable(8) %__b) #6 comdat {
entry:
...
; Function Attrs: noinline nounwind uwtable
define linkonce_odr %"struct.__gnu_cxx::_Hashtable_node"** @_ZSt12__niter_baseIPPN9__gnu_cxx15_Hashtable_nodeISt4pairIKPKciEEEET_SA_(%"struct.__gnu_cxx::_Hashtable_node"** %__it) #6 comdat {
entry:
...
; Function Attrs: noinline nounwind uwtable
define linkonce_odr i64 @_ZNK9__gnu_cxx13new_allocatorIPNS_15_Hashtable_nodeISt4pairIKPKciEEEE8max_sizeEv(%"class.std::ios_base::Init"* %this) #6 comdat align 2 {
entry:
  %this.addr = alloca %"class.std::ios_base::Init"*, align 8
  store %"class.std::ios_base::Init"* %this, %"class.std::ios_base::Init"** %this.addr, align 8
  %this1 = load %"class.std::ios_base::Init"*, %"class.std::ios_base::Init"** %this.addr, align 8
...
; Function Attrs: noinline nounwind uwtable
define linkonce_odr void @_ZNSaIPN9__gnu_cxx15_Hashtable_nodeISt4pairIKPKciEEEEC2ERKS8_(%"class.std::ios_base::Init"* %this, %"class.std::ios_base::Init"* dereferenceable(1) %__a) unnamed_addr #6 comdat align 2 {
entry:
  %this.addr = alloca %"class.std::ios_base::Init"*, align 8
  %__a.addr = alloca %"class.std::ios_base::Init"*, align 8
  store %"class.std::ios_base::Init"* %this, %"class.std::ios_base::Init"** %this.addr, align 8
...
; Function Attrs: noinline nounwind uwtable
define linkonce_odr void @_ZN9__gnu_cxx13new_allocatorIPNS_15_Hashtable_nodeISt4pairIKPKciEEEEC2ERKS9_(%"class.std::ios_base::Init"* %this, %"class.std::ios_base::Init"* dereferenceable(1)) unnamed_addr #6 comdat align 2 {
entry:
  %this.addr = alloca %"class.std::ios_base::Init"*, align 8
  %.addr = alloca %"class.std::ios_base::Init"*, align 8
  store %"class.std::ios_base::Init"* %this, %"class.std::ios_base::Init"** %this.addr, align 8
...
; Function Attrs: noinline nounwind uwtable
define linkonce_odr dereferenceable(1) %"class.std::ios_base::Init"* @_ZNKSt12_Vector_baseIPN9__gnu_cxx15_Hashtable_nodeISt4pairIKPKciEEESaIS8_EE19_M_get_Tp_allocatorEv(%"struct.std::_Vector_base"* %this) #6 comdat align 2 {
entry:
  %this.addr = alloca %"struct.std::_Vector_base"*, align 8
  store %"struct.std::_Vector_base"* %this, %"struct.std::_Vector_base"** %this.addr, align 8
  %this1 = load %"struct.std::_Vector_base"*, %"struct.std::_Vector_base"** %this.addr, align 8
...
; Function Attrs: noinline nounwind uwtable
define linkonce_odr i64* @_ZN9__gnu_cxx21_Hashtable_prime_listImE17_S_get_prime_listEv() #6 comdat align 2 {
entry:
...
; Function Attrs: noinline nounwind uwtable
define linkonce_odr zeroext i1 @_ZNK9__gnu_cxx5__ops14_Iter_less_valclIPKmS3_EEbT_RT0_(%"class.std::ios_base::Init"* %this, i64* %__it, i64* dereferenceable(8) %__val) #6 comdat align 2 {
entry:
  %this.addr = alloca %"class.std::ios_base::Init"*, align 8
...
; Function Attrs: noinline nounwind uwtable
define linkonce_odr void @_ZSt19__iterator_categoryIPKmENSt15iterator_traitsIT_E17iterator_categoryERKS3_(i64** dereferenceable(8)) #6 comdat {
entry:
  %retval = alloca %"class.std::ios_base::Init", align 1
  %.addr = alloca i64**, align 8
  store i64** %0, i64*** %.addr, align 8
...
; Function Attrs: noinline nounwind uwtable
define linkonce_odr void @_ZSt9__advanceIPKmlEvRT_T0_St26random_access_iterator_tag(i64** dereferenceable(8) %__i, i64 %__n) #6 comdat {
entry:
...
; Function Attrs: noinline nounwind uwtable
define linkonce_odr i64 @_ZSt10__distanceIPKmENSt15iterator_traitsIT_E15difference_typeES3_S3_St26random_access_iterator_tag(i64* %__first, i64* %__last) #6 comdat {
entry:
  %0 = alloca %"class.std::ios_base::Init", align 1
  %__first.addr = alloca i64*, align 8
  %__last.addr = alloca i64*, align 8
...
; Function Attrs: noinline nounwind uwtable
define linkonce_odr void @_ZN9__gnu_cxx5__ops14_Iter_less_valC2Ev(%"class.std::ios_base::Init"* %this) unnamed_addr #6 comdat align 2 {
entry:
  %this.addr = alloca %"class.std::ios_base::Init"*, align 8
  store %"class.std::ios_base::Init"* %this, %"class.std::ios_base::Init"** %this.addr, align 8
  %this1 = load %"class.std::ios_base::Init"*, %"class.std::ios_base::Init"** %this.addr, align 8
...
; Function Attrs: noinline nounwind uwtable
define linkonce_odr void @_ZNSaISt4pairIKPKciEEC2Ev(%"class.std::ios_base::Init"* %this) unnamed_addr #6 comdat align 2 {
entry:
  %this.addr = alloca %"class.std::ios_base::Init"*, align 8
  store %"class.std::ios_base::Init"* %this, %"class.std::ios_base::Init"** %this.addr, align 8
  %this1 = load %"class.std::ios_base::Init"*, %"class.std::ios_base::Init"** %this.addr, align 8
...
; Function Attrs: noinline nounwind uwtable
define linkonce_odr void @_ZNSaIN9__gnu_cxx15_Hashtable_nodeISt4pairIKPKciEEEEC2IS5_EERKSaIT_E(%"class.std::ios_base::Init"* %this, %"class.std::ios_base::Init"* dereferenceable(1)) unnamed_addr #6 comdat align 2 {
entry:
  %this.addr = alloca %"class.std::ios_base::Init"*, align 8
  %.addr = alloca %"class.std::ios_base::Init"*, align 8
  store %"class.std::ios_base::Init"* %this, %"class.std::ios_base::Init"** %this.addr, align 8
...
; Function Attrs: noinline nounwind uwtable
define linkonce_odr void @_ZNSaIPN9__gnu_cxx15_Hashtable_nodeISt4pairIKPKciEEEEC2IS5_EERKSaIT_E(%"class.std::ios_base::Init"* %this, %"class.std::ios_base::Init"* dereferenceable(1)) unnamed_addr #6 comdat align 2 {
entry:
  %this.addr = alloca %"class.std::ios_base::Init"*, align 8
  %.addr = alloca %"class.std::ios_base::Init"*, align 8
  store %"class.std::ios_base::Init"* %this, %"class.std::ios_base::Init"** %this.addr, align 8
...
if.then:                                          ; preds = %entry
  call void @_ZSt20__throw_length_errorPKc(i8* getelementptr inbounds ([16 x i8], [16 x i8]* @.str.4, i32 0, i32 0)) #14
  unreachable
...
if.else44:                                        ; preds = %if.then
  ...
  %call45 = call i64 @_ZNKSt6vectorIPN9__gnu_cxx15_Hashtable_nodeISt4pairIKPKciEEESaIS8_EE12_M_check_lenEmS4_(%"class.std::vector"* %this1, i64 %46, i8* getelementptr inbounds ([23 x i8], [23 x i8]* @.str.5, i32 0, i32 0))
...
; Function Attrs: noinline nounwind uwtable
define linkonce_odr dereferenceable(8) %"struct.__gnu_cxx::_Hashtable_node"*** @_ZNK9__gnu_cxx17__normal_iteratorIPPNS_15_Hashtable_nodeISt4pairIKPKciEEESt6vectorIS8_SaIS8_EEE4baseEv(%"class.__gnu_cxx::__normal_iterator"* %this) #6 comdat align 2 {
entry:
...
; Function Attrs: noinline nounwind uwtable
define linkonce_odr %"struct.__gnu_cxx::_Hashtable_node"** @_ZSt12__miter_baseIPPN9__gnu_cxx15_Hashtable_nodeISt4pairIKPKciEEEET_SA_(%"struct.__gnu_cxx::_Hashtable_node"** %__it) #6 comdat {
entry:
  %__it.addr = alloca %"struct.__gnu_cxx::_Hashtable_node"**, align 8
  store %"struct.__gnu_cxx::_Hashtable_node"** %__it, %"struct.__gnu_cxx::_Hashtable_node"*** %__it.addr, align 8
  %0 = load %"struct.__gnu_cxx::_Hashtable_node"**, %"struct.__gnu_cxx::_Hashtable_node"*** %__it.addr, align 8
...
; Function Attrs: noinline nounwind uwtable
define linkonce_odr void @_ZN9__gnu_cxx17__normal_iteratorIPPNS_15_Hashtable_nodeISt4pairIKPKciEEESt6vectorIS8_SaIS8_EEEC2ERKS9_(%"class.__gnu_cxx::__normal_iterator"* %this, %"struct.__gnu_cxx::_Hashtable_node"*** dereferenceable(8) %__i) unnamed_addr #6 comdat align 2 {
entry:
  %this.addr = alloca %"class.__gnu_cxx::__normal_iterator"*, align 8
...
; Function Attrs: noinline nounwind uwtable
define linkonce_odr i64 @_ZN9__gnu_cxx14__alloc_traitsISaIPNS_15_Hashtable_nodeISt4pairIKPKciEEEEE8max_sizeERKS9_(%"class.std::ios_base::Init"* dereferenceable(1) %__a) #6 comdat align 2 {
entry:
  %__a.addr = alloca %"class.std::ios_base::Init"*, align 8
  store %"class.std::ios_base::Init"* %__a, %"class.std::ios_base::Init"** %__a.addr, align 8
  %0 = load %"class.std::ios_base::Init"*, %"class.std::ios_base::Init"** %__a.addr, align 8
...
; Function Attrs: noinline nounwind uwtable
define linkonce_odr i64 @_ZNKSt6vectorIPN9__gnu_cxx15_Hashtable_nodeISt4pairIKPKciEEESaIS8_EE8capacityEv(%"class.std::vector"* %this) #6 comdat align 2 {
entry:
  %this.addr = alloca %"class.std::vector"*, align 8
  store %"class.std::vector"* %this, %"class.std::vector"** %this.addr, align 8
  %this1 = load %"class.std::vector"*, %"class.std::vector"** %this.addr, align 8
...
; Function Attrs: noinline nounwind uwtable
define linkonce_odr void @_ZN9__gnu_cxx13new_allocatorIPNS_15_Hashtable_nodeISt4pairIKPKciEEEEC2Ev(%"class.std::ios_base::Init"* %this) unnamed_addr #6 comdat align 2 {
entry:
  %this.addr = alloca %"class.std::ios_base::Init"*, align 8
  store %"class.std::ios_base::Init"* %this, %"class.std::ios_base::Init"** %this.addr, align 8
  %this1 = load %"class.std::ios_base::Init"*, %"class.std::ios_base::Init"** %this.addr, align 8
...
; Function Attrs: noinline nounwind uwtable
define linkonce_odr void @_ZN9__gnu_cxx13new_allocatorINS_15_Hashtable_nodeISt4pairIKPKciEEEEC2Ev(%"class.std::ios_base::Init"* %this) unnamed_addr #6 comdat align 2 {
entry:
  %this.addr = alloca %"class.std::ios_base::Init"*, align 8
  store %"class.std::ios_base::Init"* %this, %"class.std::ios_base::Init"** %this.addr, align 8
  %this1 = load %"class.std::ios_base::Init"*, %"class.std::ios_base::Init"** %this.addr, align 8
