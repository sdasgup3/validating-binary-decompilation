; ModuleID = 'Shootout-C++-heapsort/Shootout-C++-heapsort.bc'
...
; Function Attrs: noinline nounwind uwtable
define void @_Z8heapsortiPd(i32 %n, double* %ra) #3 {
entry:
...
for.body:                                         ; preds = %for.cond
  %call3 = call double @_Z10gen_randomd(double 1.000000e+00)
...
for.end:                                          ; preds = %for.cond
  ...
  call void @_Z8heapsortiPd(i32 %10, double* %11)
  ...
  %call7 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([7 x i8], [7 x i8]* @.str, i32 0, i32 0), double %14)
