; ModuleID = 'Shootout-C++-random/test.bc'
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_random.cpp, i8* null }]
@_ZStL8__ioinit = internal global %"class.std::ios_base::Init" zeroinitializer, align 1
@__dso_handle = external global i8
@_ZSt4cout = external global %"class.std::basic_ostream", align 8
@_ZZ10gen_randomdE4last = linkonce_odr global i64 42, comdat, align 8

; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_random.cpp() #0 section ".text.startup" {
entry:
...
while.body:                                       ; preds = %while.cond
  %call1 = call double @_Z10gen_randomd(double 1.000000e+02)
...
while.end:                                        ; preds = %while.cond
  ...
  %call2 = call i64 @_ZNSt8ios_base9precisionEl(%"class.std::ios_base"* %5, i64 9)
  ...
  %6 = bitcast i8* %vbase.offset.ptr4 to i64*
  %vbase.offset5 = load i64, i64* %6, align 8
  %add.ptr6 = getelementptr inbounds i8, i8* bitcast (%"class.std::basic_ostream"* @_ZSt4cout to i8*), i64 %vbase.offset5
  %7 = bitcast i8* %add.ptr6 to %"class.std::ios_base"*
  %call7 = call i32 @_ZNSt8ios_base4setfESt13_Ios_Fmtflags(%"class.std::ios_base"* %7, i32 4)
  %8 = load double, double* %result, align 8
  %call8 = call dereferenceable(272) %"class.std::basic_ostream"* @_ZNSolsEd(%"class.std::basic_ostream"* @_ZSt4cout, double %8)
...
define linkonce_odr double @_Z10gen_randomd(double %max) #5 comdat {
entry:
  %max.addr = alloca double, align 8
  store double %max, double* %max.addr, align 8
  %0 = load i64, i64* @_ZZ10gen_randomdE4last, align 8
  %mul = mul nsw i64 %0, 3877
  %add = add nsw i64 %mul, 29573
  %rem = srem i64 %add, 139968
  store i64 %rem, i64* @_ZZ10gen_randomdE4last, align 8
...
; Function Attrs: noinline nounwind uwtable
define linkonce_odr i64 @_ZNSt8ios_base9precisionEl(%"class.std::ios_base"* %this, i64 %__prec) #5 comdat align 2 {
entry:
