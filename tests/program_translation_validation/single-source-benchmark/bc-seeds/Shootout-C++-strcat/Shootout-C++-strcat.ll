; ModuleID = 'Shootout-C++-strcat/Shootout-C++-strcat.bc'
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_strcat.cpp, i8* null }]
...
define internal void @_GLOBAL__sub_I_strcat.cpp() #0 section ".text.startup" {
entry:
...
cond.end:                                         ; preds = %cond.false, %cond.true
  ...
  invoke void @_ZNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEE7reserveEm(%"class.std::__cxx11::basic_string"* %str, i64 %3)
          to label %invoke.cont unwind label %lpad

invoke.cont:                                      ; preds = %cond.end
  store i64 6, i64* %newLength, align 8
...
for.body:                                         ; preds = %for.cond
  %6 = load i64, i64* %newLength, align 8
...
if.then:                                          ; preds = %for.body
  ...
  invoke void @_ZNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEE7reserveEm(%"class.std::__cxx11::basic_string"* %str, i64 %9)
          to label %invoke.cont3 unwind label %lpad

invoke.cont3:                                     ; preds = %if.then
  br label %if.end

lpad:                                             ; preds = %invoke.cont8, %invoke.cont6, %for.end, %if.end, %if.then, %cond.end
...
if.end:                                           ; preds = %invoke.cont3, %for.body
  %call5 = invoke dereferenceable(32) %"class.std::__cxx11::basic_string"* @_ZNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEEpLEPKc(%"class.std::__cxx11::basic_string"* %str, i8* getelementptr inbounds ([7 x i8], [7 x i8]* @.str, i32 0, i32 0))
          to label %invoke.cont4 unwind label %lpad

invoke.cont4:                                     ; preds = %if.end
  %13 = load i64, i64* %newLength, align 8
  %add = add i64 %13, 6
  store i64 %add, i64* %newLength, align 8
  br label %for.inc
...
for.end:                                          ; preds = %for.cond
  %call7 = invoke i64 @_ZNKSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEE6lengthEv(%"class.std::__cxx11::basic_string"* %str)
          to label %invoke.cont6 unwind label %lpad

invoke.cont6:                                     ; preds = %for.end
  %call9 = invoke dereferenceable(272) %"class.std::basic_ostream"* @_ZNSolsEm(%"class.std::basic_ostream"* @_ZSt4cout, i64 %call7)
