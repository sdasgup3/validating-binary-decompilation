; ModuleID = 'floyd-warshall/floyd-warshall.bc'
...
entry:
  ...
  %path_StrictFP = alloca [1024 x [1024 x double]]*, align 8
  ...
  store [1024 x [1024 x double]]* %1, [1024 x [1024 x double]]** %path_StrictFP, align 8
  %2 = load i32, i32* %n, align 4
  %3 = load [1024 x [1024 x double]]*, [1024 x [1024 x double]]** %path, align 8
  %arraydecay = getelementptr inbounds [1024 x [1024 x double]], [1024 x [1024 x double]]* %3, i32 0, i32 0
  call void @init_array(i32 %2, [1024 x double]* %arraydecay)
  %4 = load i32, i32* %n, align 4
  %5 = load [1024 x [1024 x double]]*, [1024 x [1024 x double]]** %path, align 8
  %arraydecay2 = getelementptr inbounds [1024 x [1024 x double]], [1024 x [1024 x double]]* %5, i32 0, i32 0
  call void @kernel_floyd_warshall(i32 %4, [1024 x double]* %arraydecay2)
  %6 = load i32, i32* %n, align 4
  %7 = load [1024 x [1024 x double]]*, [1024 x [1024 x double]]** %path_StrictFP, align 8
  %arraydecay3 = getelementptr inbounds [1024 x [1024 x double]], [1024 x [1024 x double]]* %7, i32 0, i32 0
  call void @init_array(i32 %6, [1024 x double]* %arraydecay3)
  %8 = load i32, i32* %n, align 4
  %9 = load [1024 x [1024 x double]]*, [1024 x [1024 x double]]** %path_StrictFP, align 8
  %arraydecay4 = getelementptr inbounds [1024 x [1024 x double]], [1024 x [1024 x double]]* %9, i32 0, i32 0
  call void @kernel_floyd_warshall_StrictFP(i32 %8, [1024 x double]* %arraydecay4)
  %10 = load i32, i32* %n, align 4
  %11 = load [1024 x [1024 x double]]*, [1024 x [1024 x double]]** %path, align 8
  %arraydecay5 = getelementptr inbounds [1024 x [1024 x double]], [1024 x [1024 x double]]* %11, i32 0, i32 0
  %12 = load [1024 x [1024 x double]]*, [1024 x [1024 x double]]** %path_StrictFP, align 8
  %arraydecay6 = getelementptr inbounds [1024 x [1024 x double]], [1024 x [1024 x double]]* %12, i32 0, i32 0
  %call7 = call i32 @check_FP(i32 %10, [1024 x double]* %arraydecay5, [1024 x double]* %arraydecay6)
...
if.end:                                           ; preds = %entry
  ...
  %14 = load [1024 x [1024 x double]]*, [1024 x [1024 x double]]** %path_StrictFP, align 8
  %arraydecay8 = getelementptr inbounds [1024 x [1024 x double]], [1024 x [1024 x double]]* %14, i32 0, i32 0
  call void @print_array(i32 %13, [1024 x double]* %arraydecay8)
  %15 = load [1024 x [1024 x double]]*, [1024 x [1024 x double]]** %path, align 8
  %16 = bitcast [1024 x [1024 x double]]* %15 to i8*
  call void @free(i8* %16) #5
  %17 = load [1024 x [1024 x double]]*, [1024 x [1024 x double]]** %path_StrictFP, align 8
...
for.body3:                                        ; preds = %for.cond1
  ...
  %7 = load [1024 x double]*, [1024 x double]** %path.addr, align 8
  %8 = load i32, i32* %i, align 4
...
for.body6:                                        ; preds = %for.cond4
  %6 = load [1024 x double]*, [1024 x double]** %path.addr, align 8
  ...
  %10 = load [1024 x double]*, [1024 x double]** %path.addr, align 8
  %11 = load i32, i32* %i, align 4
  ...
  %14 = load [1024 x double]*, [1024 x double]** %path.addr, align 8
...
cond.true:                                        ; preds = %for.body6
  %18 = load [1024 x double]*, [1024 x double]** %path.addr, align 8
  %19 = load i32, i32* %i, align 4
  %idxprom18 = sext i32 %19 to i64
  %arrayidx19 = getelementptr inbounds [1024 x double], [1024 x double]* %18, i64 %idxprom18
...
cond.false:                                       ; preds = %for.body6
  %22 = load [1024 x double]*, [1024 x double]** %path.addr, align 8
  %23 = load i32, i32* %i, align 4
  %idxprom22 = sext i32 %23 to i64
  %arrayidx23 = getelementptr inbounds [1024 x double], [1024 x double]* %22, i64 %idxprom22
  ...
  %26 = load [1024 x double]*, [1024 x double]** %path.addr, align 8
  %27 = load i32, i32* %k, align 4
  %idxprom26 = sext i32 %27 to i64
  %arrayidx27 = getelementptr inbounds [1024 x double], [1024 x double]* %26, i64 %idxprom26
  %28 = load i32, i32* %j, align 4
  %idxprom28 = sext i32 %28 to i64
  %arrayidx29 = getelementptr inbounds [1024 x double], [1024 x double]* %arrayidx27, i64 0, i64 %idxprom28
...
cond.end:                                         ; preds = %cond.false, %cond.true
  ...
  %30 = load [1024 x double]*, [1024 x double]** %path.addr, align 8
  %31 = load i32, i32* %i, align 4
  %idxprom31 = sext i32 %31 to i64
  %arrayidx32 = getelementptr inbounds [1024 x double], [1024 x double]* %30, i64 %idxprom31
...
; Function Attrs: noinline nounwind uwtable
define internal void @kernel_floyd_warshall_StrictFP(i32 %n, [1024 x double]* %path) #0 {
entry:
  %n.addr = alloca i32, align 4
  %path.addr = alloca [1024 x double]*, align 8
  %i = alloca i32, align 4
