...
entry:
  ...
  %7 = load [1024 x [1024 x double]]*, [1024 x [1024 x double]]** %C, align 8
  %arraydecay = getelementptr inbounds [1024 x [1024 x double]], [1024 x [1024 x double]]* %7, i32 0, i32 0
  %8 = load [1024 x [1024 x double]]*, [1024 x [1024 x double]]** %C_StrictFP, align 8
  ...
  call void @init_array(i32 %4, i32 %5, i32 %6, double* %alpha, double* %beta, [1024 x double]* %arraydecay, [1024 x double]* %arraydecay4, [1024 x double]* %arraydecay5, [1024 x double]* %arraydecay6)
  %11 = load i32, i32* %ni, align 4
  %12 = load i32, i32* %nj, align 4
  %13 = load i32, i32* %nk, align 4
  %14 = load double, double* %alpha, align 8
  %15 = load double, double* %beta, align 8
  ...
  %17 = load [1024 x [1024 x double]]*, [1024 x [1024 x double]]** %A, align 8
  ...
  %arraydecay9 = getelementptr inbounds [1024 x [1024 x double]], [1024 x [1024 x double]]* %18, i32 0, i32 0
  call void @kernel_gemm(i32 %11, i32 %12, i32 %13, double %14, double %15, [1024 x double]* %arraydecay7, [1024 x double]* %arraydecay8, [1024 x double]* %arraydecay9)
  ...
  %arraydecay10 = getelementptr inbounds [1024 x [1024 x double]], [1024 x [1024 x double]]* %24, i32 0, i32 0
  %25 = load [1024 x [1024 x double]]*, [1024 x [1024 x double]]** %A, align 8
  %arraydecay11 = getelementptr inbounds [1024 x [1024 x double]], [1024 x [1024 x double]]* %25, i32 0, i32 0
  %26 = load [1024 x [1024 x double]]*, [1024 x [1024 x double]]** %B, align 8
  %arraydecay12 = getelementptr inbounds [1024 x [1024 x double]], [1024 x [1024 x double]]* %26, i32 0, i32 0
  call void @kernel_gemm_StrictFP(i32 %19, i32 %20, i32 %21, double %22, double %23, [1024 x double]* %arraydecay10, [1024 x double]* %arraydecay11, [1024 x double]* %arraydecay12)
  %27 = load i32, i32* %ni, align 4
  %28 = load i32, i32* %nk, align 4
  %29 = load [1024 x [1024 x double]]*, [1024 x [1024 x double]]** %C, align 8
  %arraydecay13 = getelementptr inbounds [1024 x [1024 x double]], [1024 x [1024 x double]]* %29, i32 0, i32 0
  %30 = load [1024 x [1024 x double]]*, [1024 x [1024 x double]]** %C_StrictFP, align 8
  %arraydecay14 = getelementptr inbounds [1024 x [1024 x double]], [1024 x [1024 x double]]* %30, i32 0, i32 0
  %call15 = call i32 @check_FP(i32 %27, i32 %28, [1024 x double]* %arraydecay13, [1024 x double]* %arraydecay14)
...
if.end:                                           ; preds = %entry
  ...
  %32 = load i32, i32* %nj, align 4
  %33 = load [1024 x [1024 x double]]*, [1024 x [1024 x double]]** %C_StrictFP, align 8
  %arraydecay16 = getelementptr inbounds [1024 x [1024 x double]], [1024 x [1024 x double]]* %33, i32 0, i32 0
  call void @print_array(i32 %31, i32 %32, [1024 x double]* %arraydecay16)
  %34 = load [1024 x [1024 x double]]*, [1024 x [1024 x double]]** %C, align 8
  %35 = bitcast [1024 x [1024 x double]]* %34 to i8*
  call void @free(i8* %35) #5
  %36 = load [1024 x [1024 x double]]*, [1024 x [1024 x double]]** %C_StrictFP, align 8
  %37 = bitcast [1024 x [1024 x double]]* %36 to i8*
  call void @free(i8* %37) #5
  %38 = load [1024 x [1024 x double]]*, [1024 x [1024 x double]]** %A, align 8
  %39 = bitcast [1024 x [1024 x double]]* %38 to i8*
  call void @free(i8* %39) #5
  %40 = load [1024 x [1024 x double]]*, [1024 x [1024 x double]]** %B, align 8
...
; Function Attrs: noinline nounwind uwtable
define internal void @init_array(i32 %ni, i32 %nj, i32 %nk, double* %alpha, double* %beta, [1024 x double]* %C, [1024 x double]* %C_StrictFP, [1024 x double]* %A, [1024 x double]* %B) #0 {
entry:
...
for.cond15:                                       ; preds = %for.inc35, %for.end14
  %17 = load i32, i32* %i, align 4
  %18 = load i32, i32* %ni.addr, align 4
  %cmp16 = icmp slt i32 %17, %18
  br i1 %cmp16, label %for.body18, label %for.end37
...
for.cond42:                                       ; preds = %for.inc55, %for.body41
...
for.body45:                                       ; preds = %for.cond42
  ...
  %conv46 = sitofp i32 %33 to double
  %34 = load i32, i32* %j, align 4
  %conv47 = sitofp i32 %34 to double
  %mul48 = fmul double %conv46, %conv47
  %35 = load i32, i32* %ni.addr, align 4
  %conv49 = sitofp i32 %35 to double
  %div50 = fdiv double %mul48, %conv49
  %36 = load [1024 x double]*, [1024 x double]** %B.addr, align 8
  %37 = load i32, i32* %i, align 4
  %idxprom51 = sext i32 %37 to i64
  %arrayidx52 = getelementptr inbounds [1024 x double], [1024 x double]* %36, i64 %idxprom51
  ...
  store double %div50, double* %arrayidx54, align 8
  br label %for.inc55
...
for.body8:                                        ; preds = %for.cond6
  ...
  %arrayidx10 = getelementptr inbounds [1024 x double], [1024 x double]* %12, i64 %idxprom9
  ...
  %20 = load [1024 x double]*, [1024 x double]** %C.addr, align 8
  %21 = load i32, i32* %i, align 4
...
; Function Attrs: noinline nounwind uwtable
define internal void @kernel_gemm_StrictFP(i32 %ni, i32 %nj, i32 %nk, double %alpha, double %beta, [1024 x double]* %C, [1024 x double]* %A, [1024 x double]* %B) #0 {
entry:
  %ni.addr = alloca i32, align 4
  %nj.addr = alloca i32, align 4
  %nk.addr = alloca i32, align 4
...
; Function Attrs: noinline nounwind uwtable
define internal i32 @check_FP(i32 %ni, i32 %nk, [1024 x double]* %A, [1024 x double]* %B) #0 {
entry:
  %retval = alloca i32, align 4
  %ni.addr = alloca i32, align 4
  %nk.addr = alloca i32, align 4
