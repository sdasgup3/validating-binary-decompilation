...
entry:
  ...
  %x1_StrictFP = alloca [4000 x double]*, align 8
  %x2_StrictFP = alloca [4000 x double]*, align 8
  ...
  store [4000 x double]* %3, [4000 x double]** %x1_StrictFP, align 8
  %call4 = call i8* @polybench_alloc_data(i64 4000, i32 8)
  %4 = bitcast i8* %call4 to [4000 x double]*
  store [4000 x double]* %4, [4000 x double]** %x2_StrictFP, align 8
  %call5 = call i8* @polybench_alloc_data(i64 4000, i32 8)
  %5 = bitcast i8* %call5 to [4000 x double]*
  store [4000 x double]* %5, [4000 x double]** %y_1, align 8
  %call6 = call i8* @polybench_alloc_data(i64 4000, i32 8)
  %6 = bitcast i8* %call6 to [4000 x double]*
  store [4000 x double]* %6, [4000 x double]** %y_2, align 8
  %7 = load i32, i32* %n, align 4
  %8 = load [4000 x double]*, [4000 x double]** %x1, align 8
  %arraydecay = getelementptr inbounds [4000 x double], [4000 x double]* %8, i32 0, i32 0
  %9 = load [4000 x double]*, [4000 x double]** %x2, align 8
  %arraydecay7 = getelementptr inbounds [4000 x double], [4000 x double]* %9, i32 0, i32 0
  %10 = load [4000 x double]*, [4000 x double]** %x1_StrictFP, align 8
  %arraydecay8 = getelementptr inbounds [4000 x double], [4000 x double]* %10, i32 0, i32 0
  %11 = load [4000 x double]*, [4000 x double]** %x2_StrictFP, align 8
  %arraydecay9 = getelementptr inbounds [4000 x double], [4000 x double]* %11, i32 0, i32 0
  %12 = load [4000 x double]*, [4000 x double]** %y_1, align 8
  %arraydecay10 = getelementptr inbounds [4000 x double], [4000 x double]* %12, i32 0, i32 0
  %13 = load [4000 x double]*, [4000 x double]** %y_2, align 8
  ...
  call void @init_array(i32 %7, double* %arraydecay, double* %arraydecay7, double* %arraydecay8, double* %arraydecay9, double* %arraydecay10, double* %arraydecay11, [4000 x double]* %arraydecay12)
  %15 = load i32, i32* %n, align 4
  %16 = load [4000 x double]*, [4000 x double]** %x1, align 8
  %arraydecay13 = getelementptr inbounds [4000 x double], [4000 x double]* %16, i32 0, i32 0
  %17 = load [4000 x double]*, [4000 x double]** %x2, align 8
  %arraydecay14 = getelementptr inbounds [4000 x double], [4000 x double]* %17, i32 0, i32 0
  %18 = load [4000 x double]*, [4000 x double]** %y_1, align 8
  %arraydecay15 = getelementptr inbounds [4000 x double], [4000 x double]* %18, i32 0, i32 0
  %19 = load [4000 x double]*, [4000 x double]** %y_2, align 8
  ...
  %arraydecay17 = getelementptr inbounds [4000 x [4000 x double]], [4000 x [4000 x double]]* %20, i32 0, i32 0
  call void @kernel_mvt(i32 %15, double* %arraydecay13, double* %arraydecay14, double* %arraydecay15, double* %arraydecay16, [4000 x double]* %arraydecay17)
  %21 = load i32, i32* %n, align 4
  %22 = load [4000 x double]*, [4000 x double]** %x1_StrictFP, align 8
  %arraydecay18 = getelementptr inbounds [4000 x double], [4000 x double]* %22, i32 0, i32 0
  %23 = load [4000 x double]*, [4000 x double]** %x2_StrictFP, align 8
  %arraydecay19 = getelementptr inbounds [4000 x double], [4000 x double]* %23, i32 0, i32 0
  %24 = load [4000 x double]*, [4000 x double]** %y_1, align 8
  %arraydecay20 = getelementptr inbounds [4000 x double], [4000 x double]* %24, i32 0, i32 0
  %25 = load [4000 x double]*, [4000 x double]** %y_2, align 8
  ...
  %arraydecay22 = getelementptr inbounds [4000 x [4000 x double]], [4000 x [4000 x double]]* %26, i32 0, i32 0
  call void @kernel_mvt_StrictFP(i32 %21, double* %arraydecay18, double* %arraydecay19, double* %arraydecay20, double* %arraydecay21, [4000 x double]* %arraydecay22)
  %27 = load i32, i32* %n, align 4
  %28 = load [4000 x double]*, [4000 x double]** %x1, align 8
  %arraydecay23 = getelementptr inbounds [4000 x double], [4000 x double]* %28, i32 0, i32 0
  %29 = load [4000 x double]*, [4000 x double]** %x1_StrictFP, align 8
  %arraydecay24 = getelementptr inbounds [4000 x double], [4000 x double]* %29, i32 0, i32 0
  %call25 = call i32 @check_FP(i32 %27, double* %arraydecay23, double* %arraydecay24)
...
if.end:                                           ; preds = %entry
  ...
  %31 = load [4000 x double]*, [4000 x double]** %x2, align 8
  %arraydecay26 = getelementptr inbounds [4000 x double], [4000 x double]* %31, i32 0, i32 0
  %32 = load [4000 x double]*, [4000 x double]** %x2_StrictFP, align 8
  %arraydecay27 = getelementptr inbounds [4000 x double], [4000 x double]* %32, i32 0, i32 0
  %call28 = call i32 @check_FP(i32 %30, double* %arraydecay26, double* %arraydecay27)
...
if.end31:                                         ; preds = %if.end
  ...
  %34 = load [4000 x double]*, [4000 x double]** %x1_StrictFP, align 8
  %arraydecay32 = getelementptr inbounds [4000 x double], [4000 x double]* %34, i32 0, i32 0
  %35 = load [4000 x double]*, [4000 x double]** %x2_StrictFP, align 8
  %arraydecay33 = getelementptr inbounds [4000 x double], [4000 x double]* %35, i32 0, i32 0
  call void @print_array(i32 %33, double* %arraydecay32, double* %arraydecay33)
  ...
  %38 = load [4000 x double]*, [4000 x double]** %x1, align 8
  %39 = bitcast [4000 x double]* %38 to i8*
  call void @free(i8* %39) #5
  %40 = load [4000 x double]*, [4000 x double]** %x2, align 8
  %41 = bitcast [4000 x double]* %40 to i8*
  call void @free(i8* %41) #5
  %42 = load [4000 x double]*, [4000 x double]** %x1_StrictFP, align 8
  %43 = bitcast [4000 x double]* %42 to i8*
  call void @free(i8* %43) #5
  %44 = load [4000 x double]*, [4000 x double]** %x2_StrictFP, align 8
  %45 = bitcast [4000 x double]* %44 to i8*
  call void @free(i8* %45) #5
  %46 = load [4000 x double]*, [4000 x double]** %y_1, align 8
  %47 = bitcast [4000 x double]* %46 to i8*
  call void @free(i8* %47) #5
  %48 = load [4000 x double]*, [4000 x double]** %y_2, align 8
...
; Function Attrs: noinline nounwind uwtable
define internal void @init_array(i32 %n, double* %x1, double* %x2, double* %x1_StrictFP, double* %x2_StrictFP, double* %y_1, double* %y_2, [4000 x double]* %A) #0 {
entry:
  %n.addr = alloca i32, align 4
  %x1.addr = alloca double*, align 8
  %x2.addr = alloca double*, align 8
  %x1_StrictFP.addr = alloca double*, align 8
  %x2_StrictFP.addr = alloca double*, align 8
  ...
  store double* %x1_StrictFP, double** %x1_StrictFP.addr, align 8
  store double* %x2_StrictFP, double** %x2_StrictFP.addr, align 8
...
for.body:                                         ; preds = %for.cond
  ...
  %6 = load double*, double** %x1_StrictFP.addr, align 8
  ...
  %add18 = fadd double %conv17, 4.000000e+00
  %19 = load i32, i32* %n.addr, align 4
  %conv19 = sitofp i32 %19 to double
  %div20 = fdiv double %add18, %conv19
...
for.body26:                                       ; preds = %for.cond23
  ...
  %mul = fmul double %conv27, %conv28
  %div29 = fdiv double %mul, 4.000000e+03
  %26 = load [4000 x double]*, [4000 x double]** %A.addr, align 8
  %27 = load i32, i32* %i, align 4
  %idxprom30 = sext i32 %27 to i64
  %arrayidx31 = getelementptr inbounds [4000 x double], [4000 x double]* %26, i64 %idxprom30
...
; Function Attrs: noinline nounwind uwtable
define internal void @kernel_mvt_StrictFP(i32 %n, double* %x1, double* %x2, double* %y_1, double* %y_2, [4000 x double]* %A) #0 {
entry:
  %n.addr = alloca i32, align 4
  %x1.addr = alloca double*, align 8
  %x2.addr = alloca double*, align 8
