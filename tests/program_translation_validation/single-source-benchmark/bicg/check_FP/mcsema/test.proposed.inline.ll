...
@G_0x450__rip__4198016_ = global %G_0x450__rip__4198016__type zeroinitializer
...
entry:
  ...
  %76 = load double, double* bitcast (%G_0x450__rip__4198016__type* @G_0x450__rip__4198016_ to double*)
...
block_.L_400e97:                                  ; preds = %block_.L_400f33, %entry
...
block_400ea3:                                     ; preds = %block_.L_400e97
  ...
  %428 = load float, float* bitcast (%G_0x408__rip__4198104__type* @G_0x408__rip__4198104_ to float*)
  %429 = load float, float* inttoptr (i64 add (i64 ptrtoint (%G_0x408__rip__4198104__type* @G_0x408__rip__4198104_ to i64), i64 4) to float*)
  %430 = load float, float* inttoptr (i64 add (i64 ptrtoint (%G_0x408__rip__4198104__type* @G_0x408__rip__4198104_ to i64), i64 8) to float*)
  %431 = load float, float* inttoptr (i64 add (i64 ptrtoint (%G_0x408__rip__4198104__type* @G_0x408__rip__4198104_ to i64), i64 12) to float*)
...
; <label>:536:                                    ; preds = %528
  ...
  %539 = call %struct.Memory* @__remill_error(%struct.State* nonnull dereferenceable(3376) %0, i64 %538, %struct.Memory* %loadMem_400ee6)
  br label %routine_ucomisd_MINUS0x28__rbp____xmm0.exit

; <label>:540:                                    ; preds = %block_400ea3
...
routine_ucomisd_MINUS0x28__rbp____xmm0.exit:      ; preds = %536, %553
  %557 = phi %struct.Memory* [ %539, %536 ], [ %loadMem_400ee6, %553 ]
...
block_400ef1:                                     ; preds = %routine_ucomisd_MINUS0x28__rbp____xmm0.exit
  ...
  store %struct.Memory* %loadMem1_400f1a, %struct.Memory** %MEMORY
  %loadMem2_400f1a = load %struct.Memory*, %struct.Memory** %MEMORY
  %loadPC_400f1a = load i64, i64* %3
  %702 = call %struct.Memory* @__remill_function_call(%struct.State* %0, i64 ptrtoint (i64 (i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64)* @fprintf to i64), %struct.Memory* %loadMem2_400f1a)
...
block_.L_400f33:                                  ; preds = %block_.L_400f2e
...
block_.L_400f48:                                  ; preds = %block_.L_400f41, %block_400ef1
  ...
  ret %struct.Memory* %loadMem_400f50
}
...
define %struct.Memory* @routine_movsd_0x450__rip____xmm0(%struct.State* dereferenceable(3376), i64, %struct.Memory*) {
block_400478:
  %3 = getelementptr inbounds %struct.State, %struct.State* %0, i32 0, i32 6
  %4 = getelementptr inbounds %struct.GPR, %struct.GPR* %3, i32 0, i32 33
  %5 = getelementptr inbounds %struct.Reg, %struct.Reg* %4, i32 0, i32 0
...
define %struct.Memory* @routine_movaps_0x408__rip____xmm1(%struct.State* dereferenceable(3376), i64, %struct.Memory*) {
block_400478:
  %3 = getelementptr inbounds %struct.State, %struct.State* %0, i32 0, i32 6
  %4 = getelementptr inbounds %struct.GPR, %struct.GPR* %3, i32 0, i32 33
  %5 = getelementptr inbounds %struct.Reg, %struct.Reg* %4, i32 0, i32 0
