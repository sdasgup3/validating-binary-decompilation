...
@G_0x408__rip__4198104_= global %G_0x408__rip__4198104__type <{ [16 x i8] c"\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00" }>
%G_0x450__rip__4198016__type = type <{ [16 x i8] }>
@G_0x450__rip__4198016_= global %G_0x450__rip__4198016__type <{ [16 x i8] c"\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00" }>
...
entry:
  ...
  ; Code: movsd 0x450(%rip), %xmm0	 RIP: 400e78	 Bytes: 8
  %loadMem_400e78 = load %struct.Memory*, %struct.Memory** %MEMORY
  %call_400e78 = call %struct.Memory* @routine_movsd_0x450__rip____xmm0(%struct.State* %0, i64  0, %struct.Memory* %loadMem_400e78)
...
block_400ea3:
  ...
  ; Code: movaps 0x408(%rip), %xmm1	 RIP: 400ed1	 Bytes: 7
  %loadMem_400ed1 = load %struct.Memory*, %struct.Memory** %MEMORY
  %call_400ed1 = call %struct.Memory* @routine_movaps_0x408__rip____xmm1(%struct.State* %0, i64  0, %struct.Memory* %loadMem_400ed1)
...
block_400ef1:
  ; Code: movq $0x40132a, %rsi	 RIP: 400ef1	 Bytes: 10
  %loadMem_400ef1 = load %struct.Memory*, %struct.Memory** %MEMORY
  %call_400ef1 = call %struct.Memory* @routine_movq__0x40132a___rsi(%struct.State* %0, i64  0, %struct.Memory* %loadMem_400ef1)
  ...
  %call1_400f1a = call %struct.Memory* @routine_callq_.fprintf_plt(%struct.State* %0, i64  0, %struct.Memory* %loadMem1_400f1a, i64 -2330, i64 5, i64 5)
...
block_400478:
  ...
  %9 = load i64, i64* %PC
  %10 = ptrtoint %G_0x450__rip__4198016__type* @G_0x450__rip__4198016_ to i64
  %11 = load i64, i64* %PC
  %12 = add i64 %11, 8
  store i64 %12, i64* %PC
...
define %struct.Memory* @routine_jge_.L_400f41(%struct.State*  dereferenceable(3376), i64, %struct.Memory*, i8* %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) {
block_400478:
  %3 = getelementptr inbounds %struct.State, %struct.State* %0, i32 0, i32 6
  %4 = getelementptr inbounds %struct.GPR, %struct.GPR* %3, i32 0, i32 33
  %5 = getelementptr inbounds %struct.Reg, %struct.Reg* %4, i32 0, i32 0
...
block_400478:
  ...
  %9 = load i64, i64* %PC
  %10 = ptrtoint %G_0x408__rip__4198104__type* @G_0x408__rip__4198104_ to i64
  %11 = load i64, i64* %PC
  %12 = add i64 %11, 7
  store i64 %12, i64* %PC
...
define %struct.Memory* @routine_jbe_.L_400f2e(%struct.State*  dereferenceable(3376), i64, %struct.Memory*, i8* %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) {
block_400478:
  %3 = getelementptr inbounds %struct.State, %struct.State* %0, i32 0, i32 6
  %4 = getelementptr inbounds %struct.GPR, %struct.GPR* %3, i32 0, i32 33
  %5 = getelementptr inbounds %struct.Reg, %struct.Reg* %4, i32 0, i32 0
