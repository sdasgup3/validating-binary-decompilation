...
block_.L_400ec7:                                  ; preds = %block_.L_400f5e, %entry
  %95 = phi i64 [ %.pre, %entry ], [ %316, %block_.L_400f5e ]
  %MEMORY.0 = phi %struct.Memory* [ %2, %entry ], [ %236, %block_.L_400f5e ]
  ...
  br i1 %131, label %block_400ed3, label %block_.L_400f71

block_400ed3:                                     ; preds = %block_.L_400ec7
  %133 = add i64 %96, -16
  %134 = add i64 %132, 4
...
routine_ucomisd_MINUS0x28__rbp____xmm0.exit:      ; preds = %234, %222
  ...
  br i1 %240, label %block_.L_400f5e, label %block_400f21

block_400f21:                                     ; preds = %routine_ucomisd_MINUS0x28__rbp____xmm0.exit
  store i64 4199258, i64* %RSI.i102, align 8
  ...
  %call2_400f4a = tail call %struct.Memory* @sub_400630.fprintf_plt(%struct.State* nonnull %0, i64 %268, %struct.Memory* %236)
...
block_.L_400f5e:                                  ; preds = %routine_ucomisd_MINUS0x28__rbp____xmm0.exit
...
block_.L_400f71:                                  ; preds = %block_.L_400ec7
  %317 = add i64 %96, -4
  %318 = add i64 %132, 7
...
block_.L_400f78:                                  ; preds = %block_.L_400f71, %block_400f21
  %320 = phi i64 [ %.pre22, %block_.L_400f71 ], [ %285, %block_400f21 ]
  %MEMORY.1 = phi %struct.Memory* [ %MEMORY.0, %block_.L_400f71 ], [ %call2_400f4a, %block_400f21 ]
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_jge_.L_400f71(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i8* nocapture %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_jbe_.L_400f5e(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i8* nocapture %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
...
block_400488:
  ...
  store i64 4199258, i64* %RSI, align 8
  ret %struct.Memory* %2
}
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_jmpq_.L_400f78(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_jmpq_.L_400f63(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_jmpq_.L_400ec7(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
