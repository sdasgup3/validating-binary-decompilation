; ModuleID = '/tmp/tmp820yb_74-query.ll'
...
block_.L_400ed7:                                  ; preds = %routine_ucomisd_MINUS0x28__rbp____xmm0.exit, %entry
  ...
  br i1 %var_2_131, label %block_400ee3, label %block_.L_400f88
...
routine_ucomisd_MINUS0x28__rbp____xmm0.exit:      ; preds = %var_2_222, %var_2_214, %block_400ee3
  ...
  br i1 %var_2_240, label %block_.L_400f88, label %block_.L_400ed7

block_.L_400f88:                                  ; preds = %routine_ucomisd_MINUS0x28__rbp____xmm0.exit, %block_.L_400ed7
