...
define %struct.Memory* @kernel_bicg_StrictFP(%struct.State* noalias, i64, %struct.Memory* noalias) local_unnamed_addr #1 {
entry:
...
block_.L_400d59:                                  ; preds = %block_400d65, %entry
  %77 = phi i64 [ %159, %block_400d65 ], [ %.pre, %entry ]
  ...
  br i1 %113, label %block_400d65, label %block_.L_400d83
...
block_.L_400d83:                                  ; preds = %block_.L_400d59
  %160 = add i64 %114, 7
...
block_.L_400d8a:                                  ; preds = %block_.L_400e53, %block_.L_400d83
  %167 = phi i64 [ %486, %block_.L_400e53 ], [ %.pre1, %block_.L_400d83 ]
  ...
  br i1 %203, label %block_400d96, label %block_.L_400e66
...
block_400d96:                                     ; preds = %block_.L_400d8a
  ...
  br label %block_.L_400dad

block_.L_400dad:                                  ; preds = %block_400db9, %block_400d96
  %223 = phi i64 [ %456, %block_400db9 ], [ %.pre2, %block_400d96 ]
  ...
  br i1 %259, label %block_400db9, label %block_.L_400e53

block_400db9:                                     ; preds = %block_.L_400dad
  %261 = add i64 %224, -24
  %262 = add i64 %260, 4
...
block_.L_400e53:                                  ; preds = %block_.L_400dad
  %457 = add i64 %224, -44
  %458 = add i64 %260, 8
...
block_.L_400e66:                                  ; preds = %block_.L_400d8a
  %487 = add i64 %204, 1
...
define %struct.Memory* @routine_jmpq_.L_400d59(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
...
define %struct.Memory* @routine_jge_.L_400e53(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i8* %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 2, i32 9
...
define %struct.Memory* @routine_jmpq_.L_400dad(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
