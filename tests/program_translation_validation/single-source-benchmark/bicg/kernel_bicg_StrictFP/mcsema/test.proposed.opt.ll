...
block_.L_400d59:                                  ; preds = %block_400d65, %entry
  %77 = phi i64 [ %160, %block_400d65 ], [ %.pre, %entry ]
...
block_.L_400d8a:                                  ; preds = %block_.L_400e53, %block_.L_400d83
  %168 = phi i64 [ %503, %block_.L_400e53 ], [ %.pre1, %block_.L_400d83 ]
  ...
  br i1 %204, label %block_400d96, label %block_.L_400e66
...
block_.L_400dad:                                  ; preds = %block_400db9, %block_400d96
  %224 = phi i64 [ %472, %block_400db9 ], [ %.pre2, %block_400d96 ]
  ...
  br i1 %260, label %block_400db9, label %block_.L_400e53
