...
block_.L_400fc3:                                  ; preds = %block_.L_400fbd, %block_400fb2
  ...
  %437 = call %struct.Memory* @__remill_function_call(%struct.State* %0, i64 ptrtoint (i64 (i64)* @malloc to i64), %struct.Memory* %loadMem2_400fd5)
...
block_.L_40102e:                                  ; preds = %block_.L_400ff6
  ...
  %934 = load i64, i64* inttoptr (i64 6299776 to i64*)
  ...
  %949 = call %struct.Memory* @__remill_function_call(%struct.State* %0, i64 ptrtoint (i64 (i64, i64)* @fputs to i64), %struct.Memory* %loadMem2_401046)
...
block_.L_40108d:                                  ; preds = %block_.L_401055
  ...
  %1355 = load i64, i64* inttoptr (i64 6299776 to i64*)
  ...
  %1370 = call %struct.Memory* @__remill_function_call(%struct.State* %0, i64 ptrtoint (i64 (i64, i64)* @fputs to i64), %struct.Memory* %loadMem2_4010a5)
  ...
  %1416 = call %struct.Memory* @__remill_function_call(%struct.State* %0, i64 ptrtoint (i64 (i64)* @free to i64), %struct.Memory* %loadMem2_4010b1)
