...
@G__0x4012f7 = global %G__0x4012f7_type zeroinitializer
...
block_.L_4008d3:                                  ; preds = %block_4008c9, %entry
  ...
  store i64 ptrtoint (%G__0x4012f7_type* @G__0x4012f7 to i64), i64* %RSI.i45, align 8
...
define %struct.Memory* @routine_movq__0x4012f7___rsi(%struct.State* dereferenceable(3376), i64, %struct.Memory*) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %RSI = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 9, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, 10
  store i64 %4, i64* %PC, align 8
  store i64 ptrtoint (%G__0x4012f7_type* @G__0x4012f7 to i64), i64* %RSI, align 8
  ret %struct.Memory* %2
}
