...
@G_0x430__rip__4198096_ = global %G_0x430__rip__4198096__type zeroinitializer
...
entry:
  ...
  %76 = load double, double* bitcast (%G_0x430__rip__4198096__type* @G_0x430__rip__4198096_ to double*)
...
block_.L_400ee7:                                  ; preds = %block_.L_400fc7, %entry
...
block_.L_400efa:                                  ; preds = %block_.L_400fb4, %block_400ef3
...
block_400f06:                                     ; preds = %block_.L_400efa
  ...
  %694 = load float, float* bitcast (%G_0x3bf__rip__4198225__type* @G_0x3bf__rip__4198225_ to float*)
  %695 = load float, float* inttoptr (i64 add (i64 ptrtoint (%G_0x3bf__rip__4198225__type* @G_0x3bf__rip__4198225_ to i64), i64 4) to float*)
  %696 = load float, float* inttoptr (i64 add (i64 ptrtoint (%G_0x3bf__rip__4198225__type* @G_0x3bf__rip__4198225_ to i64), i64 8) to float*)
  %697 = load float, float* inttoptr (i64 add (i64 ptrtoint (%G_0x3bf__rip__4198225__type* @G_0x3bf__rip__4198225_ to i64), i64 12) to float*)
...
; <label>:802:                                    ; preds = %794
  ...
  %805 = call %struct.Memory* @__remill_error(%struct.State* nonnull dereferenceable(3376) %0, i64 %804, %struct.Memory* %loadMem_400f5f)
  br label %routine_ucomisd_MINUS0x28__rbp____xmm0.exit

; <label>:806:                                    ; preds = %block_400f06
...
routine_ucomisd_MINUS0x28__rbp____xmm0.exit:      ; preds = %802, %819
  %823 = phi %struct.Memory* [ %805, %802 ], [ %loadMem_400f5f, %819 ]
...
block_400f6a:                                     ; preds = %routine_ucomisd_MINUS0x28__rbp____xmm0.exit
  ...
  %1002 = call %struct.Memory* @__remill_function_call(%struct.State* %0, i64 ptrtoint (i64 (i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64)* @fprintf to i64), %struct.Memory* %loadMem2_400f9b)
...
block_.L_400fb4:                                  ; preds = %block_.L_400faf
...
block_.L_400fc7:                                  ; preds = %block_.L_400fc2
...
block_.L_400fdc:                                  ; preds = %block_.L_400fd5, %block_400f6a
  ...
  ret %struct.Memory* %loadMem_400fe4
}
