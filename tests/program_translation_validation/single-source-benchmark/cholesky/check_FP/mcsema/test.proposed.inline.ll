...
block_.L_400f27:                                  ; preds = %block_.L_401007, %entry
...
block_.L_400f3a:                                  ; preds = %block_.L_400ff4, %block_400f33
...
; <label>:812:                                    ; preds = %804
  ...
  %815 = call %struct.Memory* @__remill_error(%struct.State* nonnull dereferenceable(3376) %0, i64 %814, %struct.Memory* %loadMem_400f9f)
  br label %routine_ucomisd_MINUS0x28__rbp____xmm0.exit

; <label>:816:                                    ; preds = %block_400f46
...
routine_ucomisd_MINUS0x28__rbp____xmm0.exit:      ; preds = %812, %829
  %833 = phi %struct.Memory* [ %815, %812 ], [ %loadMem_400f9f, %829 ]
...
block_400faa:                                     ; preds = %routine_ucomisd_MINUS0x28__rbp____xmm0.exit
  ...
  store i64 4199322, i64* %RSI.i, align 8
  ...
  store %struct.Memory* %loadMem1_400fdb, %struct.Memory** %MEMORY
  %loadMem2_400fdb = load %struct.Memory*, %struct.Memory** %MEMORY
  %loadPC_400fdb = load i64, i64* %3
  %1012 = call %struct.Memory* @__remill_function_call(%struct.State* %0, i64 ptrtoint (i64 (i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64)* @fprintf to i64), %struct.Memory* %loadMem2_400fdb)
...
block_.L_400ff4:                                  ; preds = %block_.L_400fef
...
block_.L_401007:                                  ; preds = %block_.L_401002
...
block_.L_40101c:                                  ; preds = %block_.L_401015, %block_400faa
  ...
  ret %struct.Memory* %loadMem_401024
}
