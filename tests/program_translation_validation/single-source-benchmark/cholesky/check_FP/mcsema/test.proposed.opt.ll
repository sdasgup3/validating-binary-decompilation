...
declare %struct.Memory* @sub_400690.fprintf_plt(%struct.State* noalias dereferenceable(3376), i64, %struct.Memory* noalias readnone returned) local_unnamed_addr
...
block_.L_400f27:                                  ; preds = %block_.L_401002, %entry
  %95 = phi i64 [ %.pre, %entry ], [ %463, %block_.L_401002 ]
...
block_.L_400f3a:                                  ; preds = %block_.L_400fef, %block_400f33
  %136 = phi i64 [ %.pre29, %block_400f33 ], [ %433, %block_.L_400fef ]
...
block_400faa:                                     ; preds = %routine_ucomisd_MINUS0x28__rbp____xmm0.exit
  store i64 4199322, i64* %RSI.i141, align 8
  ...
  %call2_400fdb = tail call %struct.Memory* @sub_400690.fprintf_plt(%struct.State* nonnull %0, i64 %385, %struct.Memory* %343)
...
block_.L_40101c:                                  ; preds = %block_.L_401015, %block_400faa
  %467 = phi i64 [ %.pre31, %block_.L_401015 ], [ %402, %block_400faa ]
  %MEMORY.2 = phi %struct.Memory* [ %MEMORY.0, %block_.L_401015 ], [ %call2_400fdb, %block_400faa ]
