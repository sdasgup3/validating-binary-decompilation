...
block_.L_400f27:                                  ; preds = %block_.L_401002, %entry
  %95 = phi i64 [ %.pre, %entry ], [ %464, %block_.L_401002 ]
  %MEMORY.0 = phi %struct.Memory* [ %2, %entry ], [ %MEMORY.1, %block_.L_401002 ]
  ...
  br i1 %131, label %block_400f33, label %block_.L_401015
...
block_.L_400f3a:                                  ; preds = %block_.L_400fef, %block_400f33
  %136 = phi i64 [ %.pre29, %block_400f33 ], [ %434, %block_.L_400fef ]
  %MEMORY.1 = phi %struct.Memory* [ %MEMORY.0, %block_400f33 ], [ %343, %block_.L_400fef ]
  ...
  br i1 %172, label %block_400f46, label %block_.L_401002
...
routine_ucomisd_MINUS0x28__rbp____xmm0.exit:      ; preds = %341, %329
  ...
  br i1 %347, label %block_.L_400fef, label %block_400faa

block_400faa:                                     ; preds = %routine_ucomisd_MINUS0x28__rbp____xmm0.exit
  store i64 4199322, i64* %RSI.i143, align 8
...
block_.L_400fef:                                  ; preds = %routine_ucomisd_MINUS0x28__rbp____xmm0.exit
...
block_.L_401002:                                  ; preds = %block_.L_400f3a
  %435 = add i64 %137, -28
  %436 = add i64 %173, 8
...
block_.L_401015:                                  ; preds = %block_.L_400f27
  %465 = add i64 %96, -4
  %466 = add i64 %132, 7
...
block_.L_40101c:                                  ; preds = %block_.L_401015, %block_400faa
  %468 = phi i64 [ %.pre31, %block_.L_401015 ], [ %403, %block_400faa ]
  %MEMORY.2 = phi %struct.Memory* [ %MEMORY.0, %block_.L_401015 ], [ %390, %block_400faa ]
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_jge_.L_401015(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i8* nocapture %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_jge_.L_401002(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i8* nocapture %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 2, i32 9
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_jbe_.L_400fef(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i8* nocapture %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
...
block_400488:
  ...
  store i64 4199322, i64* %RSI, align 8
  ret %struct.Memory* %2
}
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_jmpq_.L_401007(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
