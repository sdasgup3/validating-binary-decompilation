; ModuleID = '/tmp/tmps310xef7-query.ll'
...
entry:
  ...
  %var_2_42 = add i64 %var_2_10, add (i64 ptrtoint (%G_0x430__rip__type* @G_0x430__rip_ to i64), i64 7)
  ...
  br i1 %var_2_13121, label %block_400f43.preheader, label %block_.L_40102c
...
block_.L_400f37.loopexit:                         ; preds = %block_.L_400f37.loopexit.loopexit, %block_400f43
  ...
  %MEMORY.1.lcssa = phi %struct.Memory* [ %MEMORY.022, %block_400f43 ], [ %var_2_343, %block_.L_400f37.loopexit.loopexit ]
  ...
  br i1 %var_2_131, label %block_400f43, label %block_.L_40102c.loopexit17
...
block_400f56:                                     ; preds = %block_400f56.preheader, %routine_ucomisd_MINUS0x28__rbp____xmm0.exit.block_.L_400f4a_crit_edge
  %MEMORY.140 = phi %struct.Memory* [ %var_2_343, %routine_ucomisd_MINUS0x28__rbp____xmm0.exit.block_.L_400f4a_crit_edge ], [ %MEMORY.022, %block_400f56.preheader ]
...
routine_ucomisd_MINUS0x28__rbp____xmm0.exit:      ; preds = %var_2_329, %var_2_321, %block_400f56
  %var_2_343 = phi %struct.Memory* [ %var_2_330, %var_2_329 ], [ %MEMORY.140, %var_2_321 ], [ %MEMORY.140, %block_400f56 ]
  ...
  br i1 %var_2_347, label %block_.L_40102c.loopexit, label %routine_ucomisd_MINUS0x28__rbp____xmm0.exit.block_.L_400f4a_crit_edge
...
block_.L_40102c.loopexit:                         ; preds = %routine_ucomisd_MINUS0x28__rbp____xmm0.exit
  br label %block_.L_40102c

block_.L_40102c.loopexit17:                       ; preds = %block_.L_400f37.loopexit
  br label %block_.L_40102c

block_.L_40102c:                                  ; preds = %block_.L_40102c.loopexit17, %block_.L_40102c.loopexit, %entry
