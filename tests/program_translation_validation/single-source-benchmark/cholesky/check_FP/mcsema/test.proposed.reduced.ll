; ModuleID = '/tmp/tmp195fgwor-query.ll'
...
entry:
  ...
  br i1 %var_2_13122, label %block_400f43.preheader, label %block_.L_40102c
...
block_.L_400f37.loopexit:                         ; preds = %block_.L_400f37.loopexit.loopexit, %block_400f43
  ...
  %MEMORY.1.lcssa = phi %struct.Memory* [ %MEMORY.023, %block_400f43 ], [ %var_2_343, %block_.L_400f37.loopexit.loopexit ]
  ...
  br i1 %var_2_131, label %block_400f43, label %block_.L_40102c.loopexit
...
block_400f56:                                     ; preds = %block_400f56.preheader, %routine_ucomisd_MINUS0x28__rbp____xmm0.exit.block_.L_400f4a_crit_edge
  %MEMORY.136 = phi %struct.Memory* [ %var_2_343, %routine_ucomisd_MINUS0x28__rbp____xmm0.exit.block_.L_400f4a_crit_edge ], [ %MEMORY.023, %block_400f56.preheader ]
...
routine_ucomisd_MINUS0x28__rbp____xmm0.exit:      ; preds = %var_2_329, %var_2_321, %block_400f56
  %var_2_343 = phi %struct.Memory* [ %var_2_330, %var_2_329 ], [ %MEMORY.136, %var_2_321 ], [ %MEMORY.136, %block_400f56 ]
  ...
  br i1 %var_2_347, label %block_400fba, label %routine_ucomisd_MINUS0x28__rbp____xmm0.exit.block_.L_400f4a_crit_edge
...
block_.L_40102c.loopexit:                         ; preds = %block_.L_400f37.loopexit
  br label %block_.L_40102c

block_.L_40102c:                                  ; preds = %block_.L_40102c.loopexit, %block_400fba, %entry
  %MEMORY.2 = phi %struct.Memory* [ %var_2_390, %block_400fba ], [ %2, %entry ], [ %MEMORY.1.lcssa, %block_.L_40102c.loopexit ]
