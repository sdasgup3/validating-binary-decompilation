...
%G_0x71e__rip__type = type <{ [8 x i8] }>
...
@G_0x71e__rip_ = global %G_0x71e__rip__type zeroinitializer
...
block_.L_400b3a:                                  ; preds = %block_.L_400cd5, %entry
...
block_400b46:                                     ; preds = %block_.L_400b3a
...
block_.L_400b75:                                  ; preds = %block_400b86, %block_400b46
...
block_400b86:                                     ; preds = %block_.L_400b75
...
block_.L_400bd2:                                  ; preds = %block_.L_400b75
  ...
  %1005 = load double, double* bitcast (%G_0x71e__rip__type* @G_0x71e__rip_ to double*)
  ...
  store %struct.Memory* %loadMem1_400be7, %struct.Memory** %MEMORY
...
block_.L_400c0b:                                  ; preds = %block_.L_400c98, %block_.L_400bd2
...
block_.L_400c3b:                                  ; preds = %block_400c4c, %block_400c17
...
block_400c4c:                                     ; preds = %block_.L_400c3b
...
block_.L_400c98:                                  ; preds = %block_.L_400c3b
...
block_.L_400cd0:                                  ; preds = %block_.L_400c0b
...
block_.L_400cd5:                                  ; preds = %block_.L_400cd0
...
block_.L_400ce3:                                  ; preds = %block_.L_400b3a
  ...
  ret %struct.Memory* %loadMem_400ce8
}
...
define %struct.Memory* @routine_movsd_0x71e__rip____xmm0(%struct.State* dereferenceable(3376), i64, %struct.Memory*) {
block_400478:
  %3 = getelementptr inbounds %struct.State, %struct.State* %0, i32 0, i32 6
  %4 = getelementptr inbounds %struct.GPR, %struct.GPR* %3, i32 0, i32 33
  %5 = getelementptr inbounds %struct.Reg, %struct.Reg* %4, i32 0, i32 0
  ...
  %9 = load i64, i64* %PC
  %10 = ptrtoint %G_0x71e__rip__type* @G_0x71e__rip_ to i64
  %11 = load i64, i64* %PC
  %12 = add i64 %11, 8
  store i64 %12, i64* %PC
