...
@G_0x71e__rip__4197338_ = local_unnamed_addr global %G_0x71e__rip__4197338__type zeroinitializer
...
block_.L_400b3a:                                  ; preds = %block_.L_400cd0, %entry
  %78 = phi i64 [ %.pre, %entry ], [ %797, %block_.L_400cd0 ]
  %MEMORY.0 = phi %struct.Memory* [ %2, %entry ], [ %call2_400be7, %block_.L_400cd0 ]
  ...
  br i1 %114, label %block_400b46, label %block_.L_400ce3
...
block_.L_400b75:                                  ; preds = %block_400b86, %block_400b46
  %172 = phi i64 [ %341, %block_400b86 ], [ %.pre1, %block_400b46 ]
  ...
  br i1 %.demorgan, label %block_400b86, label %block_.L_400bd2
...
block_.L_400bd2:                                  ; preds = %block_.L_400b75
  %342 = load i64, i64* bitcast (%G_0x71e__rip__4197338__type* @G_0x71e__rip__4197338_ to i64*), align 8
  ...
  %call2_400be7 = tail call %struct.Memory* @ext_sqrt(%struct.State* %0, i64 %359, %struct.Memory* %MEMORY.0)
...
block_.L_400c0b:                                  ; preds = %block_.L_400c98, %block_.L_400bd2
  %417 = phi i64 [ %767, %block_.L_400c98 ], [ %.pre2, %block_.L_400bd2 ]
  ...
  br i1 %453, label %block_400c17, label %block_.L_400cd0
...
block_.L_400c3b:                                  ; preds = %block_400c4c, %block_400c17
  %508 = phi i64 [ %678, %block_400c4c ], [ %.pre3, %block_400c17 ]
  ...
  store double 0.000000e+00, double* %65, align 1
  br i1 %.demorgan6, label %block_400c4c, label %block_.L_400c98
...
define %struct.Memory* @routine_jge_.L_400ce3(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i8* %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
...
define %struct.Memory* @routine_jg_.L_400bd2(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i8* %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
...
define %struct.Memory* @routine_jmpq_.L_400b75(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
...
define %struct.Memory* @routine_movsd_0x71e__rip____xmm0(%struct.State* dereferenceable(3376), i64, %struct.Memory*) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, 8
  store i64 %4, i64* %PC, align 8
  %5 = load i64, i64* bitcast (%G_0x71e__rip__4197338__type* @G_0x71e__rip__4197338_ to i64*), align 8
...
define %struct.Memory* @routine_jg_.L_400c98(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i8* %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 2, i32 7
...
define %struct.Memory* @routine_jmpq_.L_400c3b(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
...
define %struct.Memory* @routine_jmpq_.L_400cd5(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
...
define %struct.Memory* @routine_jmpq_.L_400b3a(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
