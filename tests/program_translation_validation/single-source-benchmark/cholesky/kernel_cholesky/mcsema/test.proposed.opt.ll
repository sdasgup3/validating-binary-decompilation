...
define %struct.Memory* @kernel_cholesky(%struct.State* noalias, i64, %struct.Memory* noalias readnone) local_unnamed_addr #1 {
entry:
...
block_.L_400b7a:                                  ; preds = %block_.L_400d0e, %entry
  %80 = phi i64 [ %802, %block_.L_400d0e ], [ %.pre, %entry ]
...
block_.L_400c10:                                  ; preds = %block_.L_400bb3
  ...
  %call2_400c25 = tail call %struct.Memory* @sub_4006d0.sqrt_plt(%struct.State* nonnull %0, i64 %362, %struct.Memory* %2)
