...
@G_0x54e__rip_ = global %G_0x54e__rip__type zeroinitializer
...
block_.L_400da2:                                  ; preds = %block_.L_400d45
  ...
  %1005 = load double, double* bitcast (%G_0x54e__rip__type* @G_0x54e__rip_ to double*)
...
block_400478:
  ...
  %9 = load i64, i64* %PC
  %10 = ptrtoint %G_0x54e__rip__type* @G_0x54e__rip_ to i64
  %11 = load i64, i64* %PC
  %12 = add i64 %11, 8
  store i64 %12, i64* %PC
