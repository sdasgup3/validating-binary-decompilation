...
block_.L_40102c:                                  ; preds = %block_.L_401082, %entry
  %117 = phi i64 [ %.pre, %entry ], [ %349, %block_.L_401082 ]
  %MEMORY.0 = phi %struct.Memory* [ %73, %entry ], [ %311, %block_.L_401082 ]
  ...
  br i1 %153, label %block_401038, label %block_.L_4010a4
...
block_.L_40103f:                                  ; preds = %block_40104b, %block_401038
  %158 = phi i64 [ %.pre1, %block_401038 ], [ %300, %block_40104b ]
  %MEMORY.1 = phi %struct.Memory* [ %MEMORY.0, %block_401038 ], [ %call2_40106f, %block_40104b ]
  ...
  br i1 %194, label %block_40104b, label %block_.L_401082
...
block_40104b:                                     ; preds = %block_.L_40103f
  ...
  %call2_40106f = tail call %struct.Memory* @sub_4010c0.print_element(%struct.State* %0, i64 %264, %struct.Memory* %MEMORY.1)
...
define %struct.Memory* @routine_jge_.L_4010a4(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i8* %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
...
define %struct.Memory* @routine_jge_.L_401082(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i8* %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 2, i32 9
...
define %struct.Memory* @routine_jmpq_.L_40102c(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
