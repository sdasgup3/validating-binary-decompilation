...
block_.L_40102c:                                  ; preds = %block_.L_401082, %entry
  %117 = phi i64 [ %.pre, %entry ], [ %348, %block_.L_401082 ]
  %MEMORY.0 = phi %struct.Memory* [ %73, %entry ], [ %310, %block_.L_401082 ]
...
block_.L_40103f:                                  ; preds = %block_40104b, %block_401038
  %158 = phi i64 [ %.pre1, %block_401038 ], [ %299, %block_40104b ]
...
block_40104b:                                     ; preds = %block_.L_40103f
  ...
  %call2_40106f = tail call %struct.Memory* @sub_4010c0.print_element(%struct.State* %0, i64 %263, %struct.Memory* %MEMORY.1)
