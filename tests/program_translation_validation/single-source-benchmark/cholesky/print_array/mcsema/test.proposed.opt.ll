...
block_.L_40102c:                                  ; preds = %block_.L_401082, %entry
  %123 = phi i64 [ %.pre, %entry ], [ %357, %block_.L_401082 ]
  %MEMORY.0 = phi %struct.Memory* [ %79, %entry ], [ %318, %block_.L_401082 ]
  ...
  br i1 %159, label %block_401038, label %block_.L_4010a4
...
block_.L_40103f:                                  ; preds = %block_40104b, %block_401038
  %164 = phi i64 [ %.pre1, %block_401038 ], [ %307, %block_40104b ]
  ...
  br i1 %200, label %block_40104b, label %block_.L_401082
...
block_40104b:                                     ; preds = %block_.L_40103f
  ...
  %call2_40106f = tail call %struct.Memory* @sub_4010c0.print_element(%struct.State* %0, i64 %270, %struct.Memory* %MEMORY.1)
