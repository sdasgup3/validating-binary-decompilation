; ModuleID = '/tmp/tmp0e0hdnqo-query.ll'
...
entry:
  ...
  br i1 %var_2_16034, label %block_401088.preheader, label %block_.L_4010f4

block_401088.preheader:                           ; preds = %entry
  br label %block_401088

block_401088:                                     ; preds = %block_401088.preheader, %block_.L_4010d2
  %var_2_175 = phi i32 [ %var_2_134, %block_.L_4010d2 ], [ %var_2_13424, %block_401088.preheader ]
  %var_2_1661 = phi i64 [ %var_2_125, %block_.L_4010d2 ], [ %var_2_12518, %block_401088.preheader ]
  %MEMORY.035 = phi %struct.Memory* [ %var_2_317, %block_.L_4010d2 ], [ %var_2_79, %block_401088.preheader ]
  ...
  br i1 %var_2_20117, label %block_40109b.preheader, label %block_.L_4010d2
...
block_.L_4010d2:                                  ; preds = %block_401088
  %var_2_317 = tail call %struct.Memory* @__remill_function_call(%struct.State* nonnull %0, i64 ptrtoint (i64 (i64, i64)* @fputs to i64), %struct.Memory* %MEMORY.035)
  ...
  br i1 %var_2_160, label %block_401088, label %block_.L_4010f4.loopexit

block_.L_4010f4.loopexit:                         ; preds = %block_.L_4010d2
  br label %block_.L_4010f4

block_.L_4010f4:                                  ; preds = %block_.L_4010f4.loopexit, %entry
  %MEMORY.0.lcssa = phi %struct.Memory* [ %var_2_79, %entry ], [ %var_2_317, %block_.L_4010f4.loopexit ]
  %var_2_365 = tail call %struct.Memory* @__remill_function_call(%struct.State* nonnull %0, i64 ptrtoint (i64 (i64)* @free to i64), %struct.Memory* %MEMORY.0.lcssa)
  ret %struct.Memory* %var_2_365
}
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_jge_.L_4010d2(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i8* nocapture %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 2, i32 9
