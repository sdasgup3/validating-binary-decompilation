; ModuleID = '/home/sdasgup3/Github/validating-binary-decompilation/tests/program_translation_validation/single-source-benchmark/bc-seeds/cholesky/cholesky.bc'
...
entry:
  ...
  %A_StrictFP = alloca [1024 x [1024 x double]]*, align 8
  ...
  store [1024 x [1024 x double]]* %2, [1024 x [1024 x double]]** %A_StrictFP, align 8
  %3 = load i32, i32* %n, align 4
  %4 = load [1024 x double]*, [1024 x double]** %p, align 8
  %arraydecay = getelementptr inbounds [1024 x double], [1024 x double]* %4, i32 0, i32 0
  ...
  %6 = load [1024 x [1024 x double]]*, [1024 x [1024 x double]]** %A_StrictFP, align 8
  %arraydecay4 = getelementptr inbounds [1024 x [1024 x double]], [1024 x [1024 x double]]* %6, i32 0, i32 0
  call void @init_array(i32 %3, double* %arraydecay, [1024 x double]* %arraydecay3, [1024 x double]* %arraydecay4)
  %7 = load i32, i32* %n, align 4
  %8 = load [1024 x double]*, [1024 x double]** %p, align 8
  %arraydecay5 = getelementptr inbounds [1024 x double], [1024 x double]* %8, i32 0, i32 0
  ...
  call void @kernel_cholesky(i32 %7, double* %arraydecay5, [1024 x double]* %arraydecay6)
  %10 = load i32, i32* %n, align 4
  %11 = load [1024 x double]*, [1024 x double]** %p, align 8
  %arraydecay7 = getelementptr inbounds [1024 x double], [1024 x double]* %11, i32 0, i32 0
  %12 = load [1024 x [1024 x double]]*, [1024 x [1024 x double]]** %A_StrictFP, align 8
  %arraydecay8 = getelementptr inbounds [1024 x [1024 x double]], [1024 x [1024 x double]]* %12, i32 0, i32 0
  call void @kernel_cholesky_StrictFP(i32 %10, double* %arraydecay7, [1024 x double]* %arraydecay8)
  %13 = load i32, i32* %n, align 4
  %14 = load [1024 x [1024 x double]]*, [1024 x [1024 x double]]** %A, align 8
  %arraydecay9 = getelementptr inbounds [1024 x [1024 x double]], [1024 x [1024 x double]]* %14, i32 0, i32 0
  %15 = load [1024 x [1024 x double]]*, [1024 x [1024 x double]]** %A_StrictFP, align 8
  %arraydecay10 = getelementptr inbounds [1024 x [1024 x double]], [1024 x [1024 x double]]* %15, i32 0, i32 0
  %call11 = call i32 @check_FP(i32 %13, [1024 x double]* %arraydecay9, [1024 x double]* %arraydecay10)
...
if.end:                                           ; preds = %entry
  ...
  %17 = load [1024 x [1024 x double]]*, [1024 x [1024 x double]]** %A_StrictFP, align 8
  %arraydecay12 = getelementptr inbounds [1024 x [1024 x double]], [1024 x [1024 x double]]* %17, i32 0, i32 0
  call void @print_array(i32 %16, [1024 x double]* %arraydecay12)
  %18 = load [1024 x [1024 x double]]*, [1024 x [1024 x double]]** %A, align 8
  %19 = bitcast [1024 x [1024 x double]]* %18 to i8*
  call void @free(i8* %19) #5
  %20 = load [1024 x [1024 x double]]*, [1024 x [1024 x double]]** %A_StrictFP, align 8
  %21 = bitcast [1024 x [1024 x double]]* %20 to i8*
  call void @free(i8* %21) #5
  %22 = load [1024 x double]*, [1024 x double]** %p, align 8
  %23 = bitcast [1024 x double]* %22 to i8*
...
; Function Attrs: noinline nounwind uwtable
define internal void @init_array(i32 %n, double* %p, [1024 x double]* %A, [1024 x double]* %A_StrictFP) #0 {
entry:
  %n.addr = alloca i32, align 4
  %p.addr = alloca double*, align 8
  %A.addr = alloca [1024 x double]*, align 8
  %A_StrictFP.addr = alloca [1024 x double]*, align 8
  %i = alloca i32, align 4
  %j = alloca i32, align 4
  store i32 %n, i32* %n.addr, align 4
  store double* %p, double** %p.addr, align 8
  store [1024 x double]* %A, [1024 x double]** %A.addr, align 8
  store [1024 x double]* %A_StrictFP, [1024 x double]** %A_StrictFP.addr, align 8
  store i32 0, i32* %i, align 4
  br label %for.cond
...
for.body4:                                        ; preds = %for.cond1
  ...
  %arrayidx8 = getelementptr inbounds [1024 x double], [1024 x double]* %10, i64 %idxprom7
  ...
  %13 = load [1024 x double]*, [1024 x double]** %A_StrictFP.addr, align 8
  %14 = load i32, i32* %i, align 4
  %idxprom11 = sext i32 %14 to i64
  %arrayidx12 = getelementptr inbounds [1024 x double], [1024 x double]* %13, i64 %idxprom11
  %15 = load i32, i32* %j, align 4
  %idxprom13 = sext i32 %15 to i64
  %arrayidx14 = getelementptr inbounds [1024 x double], [1024 x double]* %arrayidx12, i64 0, i64 %idxprom13
  store double %conv6, double* %arrayidx14, align 8
  br label %for.inc
...
for.body:                                         ; preds = %for.cond
  %2 = load [1024 x double]*, [1024 x double]** %A.addr, align 8
  %3 = load i32, i32* %i, align 4
  %idxprom = sext i32 %3 to i64
  %arrayidx = getelementptr inbounds [1024 x double], [1024 x double]* %2, i64 %idxprom
  %4 = load i32, i32* %i, align 4
  %idxprom1 = sext i32 %4 to i64
  %arrayidx2 = getelementptr inbounds [1024 x double], [1024 x double]* %arrayidx, i64 0, i64 %idxprom1
...
for.body6:                                        ; preds = %for.cond3
  ...
  %arrayidx12 = getelementptr inbounds [1024 x double], [1024 x double]* %14, i64 %idxprom11
  %16 = load i32, i32* %j, align 4
...
for.cond19:                                       ; preds = %for.inc52, %for.end
...
for.cond27:                                       ; preds = %for.inc42, %for.body22
...
for.body31:                                       ; preds = %for.cond27
  ...
  %32 = load [1024 x double]*, [1024 x double]** %A.addr, align 8
  ...
  %arrayidx35 = getelementptr inbounds [1024 x double], [1024 x double]* %arrayidx33, i64 0, i64 %idxprom34
  %35 = load double, double* %arrayidx35, align 8
  %36 = load [1024 x double]*, [1024 x double]** %A.addr, align 8
  %37 = load i32, i32* %i, align 4
  %idxprom36 = sext i32 %37 to i64
  %arrayidx37 = getelementptr inbounds [1024 x double], [1024 x double]* %36, i64 %idxprom36
  %38 = load i32, i32* %k, align 4
  %idxprom38 = sext i32 %38 to i64
  %arrayidx39 = getelementptr inbounds [1024 x double], [1024 x double]* %arrayidx37, i64 0, i64 %idxprom38
...
for.end44:                                        ; preds = %for.cond27
  ...
  %arrayidx46 = getelementptr inbounds double, double* %42, i64 %idxprom45
  %44 = load double, double* %arrayidx46, align 8
  %mul47 = fmul double %41, %44
  %45 = load [1024 x double]*, [1024 x double]** %A.addr, align 8
  %46 = load i32, i32* %j, align 4
  %idxprom48 = sext i32 %46 to i64
  %arrayidx49 = getelementptr inbounds [1024 x double], [1024 x double]* %45, i64 %idxprom48
...
; Function Attrs: noinline nounwind uwtable
define internal void @kernel_cholesky_StrictFP(i32 %n, double* %p, [1024 x double]* %A) #0 {
entry:
  %n.addr = alloca i32, align 4
  %p.addr = alloca double*, align 8
  %A.addr = alloca [1024 x double]*, align 8
