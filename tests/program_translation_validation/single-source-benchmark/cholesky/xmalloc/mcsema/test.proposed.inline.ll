...
entry:
  ...
  store %struct.Memory* %loadMem1_400956, %struct.Memory** %MEMORY
...
block_.L_400973:                                  ; preds = %block_400969, %entry
  ...
  store i64 4199271, i64* %RSI.i, align 8
  ...
  %294 = load i64, i64* inttoptr (i64 6299776 to i64*)
...
block_.L_400999:                                  ; preds = %block_.L_400973, %block_400969
  ...
  ret %struct.Memory* %loadMem_4009a2
}
...
define %struct.Memory* @routine_movq__0x401367___rsi(%struct.State* dereferenceable(3376), i64, %struct.Memory*) {
block_400488:
  %3 = getelementptr inbounds %struct.State, %struct.State* %0, i32 0, i32 6
  %4 = getelementptr inbounds %struct.GPR, %struct.GPR* %3, i32 0, i32 33
  %5 = getelementptr inbounds %struct.Reg, %struct.Reg* %4, i32 0, i32 0
  ...
  %10 = add i64 %9, 10
  store i64 %10, i64* %PC
  store i64 4199271, i64* %RSI, align 8
  ret %struct.Memory* %2
}
