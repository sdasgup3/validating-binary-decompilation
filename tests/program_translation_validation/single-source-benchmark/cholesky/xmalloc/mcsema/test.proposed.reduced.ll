; ModuleID = '/tmp/tmpvdakz6ku-query.ll'
...
entry:
  ...
  br i1 %var_2_81, label %block_.L_400983, label %block_400979
...
block_400979:                                     ; preds = %entry
  ...
  br i1 %var_2_95, label %block_.L_4009a9, label %block_.L_400983
...
block_.L_4009a9:                                  ; preds = %block_.L_400983, %block_400979
  %var_2_121 = phi i64 [ %.pre2, %block_.L_400983 ], [ %var_2_99, %block_400979 ]
  %var_2_122 = phi i64 [ %.pre, %block_.L_400983 ], [ %var_2_69, %block_400979 ]
  %MEMORY.1 = phi %struct.Memory* [ %var_2_120, %block_.L_400983 ], [ %var_2_62, %block_400979 ]
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_movq__0x401377___rsi(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %RSI = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 9, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
