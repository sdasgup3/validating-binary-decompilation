...
block_400917:                                     ; preds = %entry
  ...
  store %struct.Memory* %loadMem1_40093c, %struct.Memory** %MEMORY
  %loadMem2_40093c = load %struct.Memory*, %struct.Memory** %MEMORY
  %loadPC_40093c = load i64, i64* %3
  %270 = call %struct.Memory* @__remill_function_call(%struct.State* %0, i64 ptrtoint (i64 (i64)* @free to i64), %struct.Memory* %loadMem2_40093c)
  ...
  %312 = call %struct.Memory* @__remill_function_call(%struct.State* %0, i64 ptrtoint (i64 (i64)* @free to i64), %struct.Memory* %loadMem2_400948)
...
block_.L_40094d:                                  ; preds = %block_400917, %entry
  ...
  ret %struct.Memory* %loadMem_400952
}
