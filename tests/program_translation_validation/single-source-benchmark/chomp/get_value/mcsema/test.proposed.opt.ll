...
entry:
  ...
  %45 = load i64, i64* bitcast (%G_0x602058_type* @G_0x602058 to i64*), align 8
...
block_.L_400978:                                  ; preds = %block_.L_4009a0, %entry
  %52 = phi i64 [ %.pre, %entry ], [ %134, %block_.L_4009a0 ]
  %MEMORY.0 = phi %struct.Memory* [ %2, %entry ], [ %call2_400984, %block_.L_4009a0 ]
  ...
  %call2_400984 = tail call %struct.Memory* @sub_4007b0.equal_data(%struct.State* %0, i64 %66, %struct.Memory* %MEMORY.0)
  ...
  %85 = add i64 %84, -16
  br i1 %82, label %block_.L_4009a0, label %block_40099b

block_40099b:                                     ; preds = %block_.L_400978
  %86 = add i64 %83, 26
  ...
  %93 = load i64, i64* %RSP.i45, align 8
  %94 = add i64 %93, 16
  store i64 %94, i64* %RSP.i45, align 8
  ...
  ret %struct.Memory* %call2_400984

block_.L_4009a0:                                  ; preds = %block_.L_400978
  %125 = add i64 %83, 4
...
define %struct.Memory* @routine_jne_.L_4009a0(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i8* %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
...
define %struct.Memory* @routine_jmpq_.L_4009b1(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
...
define %struct.Memory* @routine_jmpq_.L_400978(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
...
define %struct.Memory* @routine_movl___rax____eax(%struct.State* dereferenceable(3376), i64, %struct.Memory*) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %RAX = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 1, i32 0, i32 0
