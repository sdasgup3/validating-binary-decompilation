; ModuleID = '/tmp/tmpr4ovlno0-query.ll'
...
entry:
  ...
  %var_2_38 = tail call %struct.Memory* @__remill_function_call(%struct.State* %0, i64 ptrtoint (i64 (i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64)* @printf to i64), %struct.Memory* %2)
  %var_2_57 = tail call %struct.Memory* @__remill_function_call(%struct.State* %0, i64 ptrtoint (i64 (i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64)* @printf to i64), %struct.Memory* %var_2_38)
  %var_2_75 = tail call %struct.Memory* @__remill_function_call(%struct.State* %0, i64 ptrtoint (i64 (i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64)* @printf to i64), %struct.Memory* %var_2_57)
  %var_2_93 = tail call %struct.Memory* @__remill_function_call(%struct.State* %0, i64 ptrtoint (i64 (i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64)* @printf to i64), %struct.Memory* %var_2_75)
  %var_2_146 = load i8, i8* %var_2_15, align 1
  %cmpBr_40138b = icmp eq i8 %var_2_146, 1
  br i1 %cmpBr_40138b, label %block_.L_4013be, label %block_.L_401727

block_.L_4013be:                                  ; preds = %entry
  %var_2_223 = tail call %struct.Memory* @__remill_function_call(%struct.State* nonnull %0, i64 ptrtoint (i64 (i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64)* @printf to i64), %struct.Memory* %var_2_93)
  %var_2_236 = tail call %struct.Memory* @__remill_function_call(%struct.State* nonnull %0, i64 ptrtoint (i64 (i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64)* @__isoc99_scanf to i64), %struct.Memory* %var_2_223)
  %var_2_249 = tail call %struct.Memory* @__remill_function_call(%struct.State* nonnull %0, i64 ptrtoint (i64 (i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64)* @printf to i64), %struct.Memory* %var_2_236)
  %var_2_262 = tail call %struct.Memory* @__remill_function_call(%struct.State* nonnull %0, i64 ptrtoint (i64 (i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64)* @__isoc99_scanf to i64), %struct.Memory* %var_2_249)
  %var_2_275 = tail call %struct.Memory* @__remill_function_call(%struct.State* nonnull %0, i64 ptrtoint (i64 (i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64)* @printf to i64), %struct.Memory* %var_2_262)
  %var_2_289 = tail call %struct.Memory* @__remill_function_call(%struct.State* nonnull %0, i64 ptrtoint (i64 (i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64)* @__isoc99_scanf to i64), %struct.Memory* %var_2_275)
  %.pre22 = load i32, i32* bitcast (%G_0x60206c_type* @G_0x60206c to i32*), align 8
  %var_2_3001 = load i64, i64* %RBP.i, align 8
  %var_2_3012 = add i64 %var_2_3001, -16
  %var_2_3033 = inttoptr i64 %var_2_3012 to i32*
  %var_2_3044 = load i32, i32* %var_2_3033, align 4
  %var_2_3055 = sub i32 %.pre22, %var_2_3044
  %var_2_3186 = icmp eq i32 %var_2_3055, 0
  %var_2_3207 = lshr i32 %var_2_3055, 31
  %var_2_3228 = lshr i32 %.pre22, 31
  %var_2_3239 = lshr i32 %var_2_3044, 31
  %var_2_32410 = xor i32 %var_2_3239, %var_2_3228
  %var_2_32511 = xor i32 %var_2_3207, %var_2_3228
  %var_2_32612 = add nuw nsw i32 %var_2_32511, %var_2_32410
  %var_2_32713 = icmp eq i32 %var_2_32612, 2
  %var_2_32914 = icmp ne i32 %var_2_3207, 0
  %var_2_33015 = xor i1 %var_2_32914, %var_2_32713
  %.demorgan16 = or i1 %var_2_3186, %var_2_33015
  br i1 %.demorgan16, label %block_40145e.preheader, label %block_.L_401727

block_40145e.preheader:                           ; preds = %block_.L_4013be
  br label %block_40145e

block_40145e:                                     ; preds = %block_40145e.preheader, %block_40145e
  %MEMORY.017 = phi %struct.Memory* [ %call2_401507, %block_40145e ], [ %var_2_289, %block_40145e.preheader ]
  %var_2_433 = tail call %struct.Memory* @__remill_function_call(%struct.State* nonnull %0, i64 ptrtoint (i64 (i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64)* @printf to i64), %struct.Memory* %MEMORY.017)
  %var_2_444 = load i64, i64* %var_2_3, align 8
  %var_2_445 = add i64 %var_2_444, -3002
  %call2_4014fa = tail call %struct.Memory* @sub_400940.dump_play(%struct.State* nonnull %0, i64 %var_2_445, %struct.Memory* %var_2_433)
  %var_2_450 = load i64, i64* %var_2_3, align 8
  %var_2_452 = add i64 %var_2_450, -3087
  %call2_401507 = tail call %struct.Memory* @sub_4008f0.dump_list(%struct.State* nonnull %0, i64 %var_2_452, %struct.Memory* %call2_4014fa)
  %var_2_458 = load i32, i32* bitcast (%G_0x60206c_type* @G_0x60206c to i32*), align 8
  %var_2_459 = add i32 %var_2_458, 1
  %var_2_300 = load i64, i64* %RBP.i, align 8
  %var_2_301 = add i64 %var_2_300, -16
  %var_2_303 = inttoptr i64 %var_2_301 to i32*
  %var_2_304 = load i32, i32* %var_2_303, align 4
  %var_2_305 = sub i32 %var_2_459, %var_2_304
  %var_2_318 = icmp eq i32 %var_2_305, 0
  %var_2_320 = lshr i32 %var_2_305, 31
  %var_2_322 = lshr i32 %var_2_459, 31
  %var_2_323 = lshr i32 %var_2_304, 31
  %var_2_324 = xor i32 %var_2_323, %var_2_322
  %var_2_325 = xor i32 %var_2_320, %var_2_322
  %var_2_326 = add nuw nsw i32 %var_2_325, %var_2_324
  %var_2_327 = icmp eq i32 %var_2_326, 2
  %var_2_329 = icmp ne i32 %var_2_320, 0
  %var_2_330 = xor i1 %var_2_329, %var_2_327
  %.demorgan = or i1 %var_2_318, %var_2_330
  br i1 %.demorgan, label %block_40145e, label %block_.L_401727.loopexit

block_.L_401727.loopexit:                         ; preds = %block_40145e
  br label %block_.L_401727

block_.L_401727:                                  ; preds = %block_.L_401727.loopexit, %block_.L_4013be, %entry
  %MEMORY.5 = phi %struct.Memory* [ %var_2_93, %entry ], [ %var_2_289, %block_.L_4013be ], [ %call2_401507, %block_.L_401727.loopexit ]
