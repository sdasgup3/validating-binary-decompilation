...
declare %struct.Memory* @sub_400990.get_value(%struct.State* dereferenceable(3376), i64, %struct.Memory*)

declare %struct.Memory* @sub_400b80.in_wanted(%struct.State* dereferenceable(3376), i64, %struct.Memory*)
