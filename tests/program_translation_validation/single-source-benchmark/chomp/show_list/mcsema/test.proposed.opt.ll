...
declare %struct.Memory* @sub_400a70.show_move(%struct.State* noalias dereferenceable(3376), i64, %struct.Memory* noalias) local_unnamed_addr
...
block_.L_400abc:                                  ; preds = %block_400ac7, %entry
  %44 = phi i64 [ %.pre, %entry ], [ %83, %block_400ac7 ]
  %MEMORY.0 = phi %struct.Memory* [ %2, %entry ], [ %call2_400ace, %block_400ac7 ]
...
block_400ac7:                                     ; preds = %block_.L_400abc
  ...
  %call2_400ace = tail call %struct.Memory* @sub_400a70.show_move(%struct.State* nonnull %0, i64 %66, %struct.Memory* %MEMORY.0)
