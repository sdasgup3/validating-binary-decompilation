...
entry:
  ...
  %call2_400a5f = tail call %struct.Memory* @sub_4009c0.show_data(%struct.State* %0, i64 %65, %struct.Memory* %53)
  %70 = load i64, i64* %PC.i, align 8
  store i64 ptrtoint (%G__0x4018b0_type* @G__0x4018b0 to i64), i64* %RDI.i27, align 8
  ...
  %76 = tail call %struct.Memory* @__remill_function_call(%struct.State* %0, i64 ptrtoint (i64 (i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64)* @printf to i64), %struct.Memory* %call2_400a5f)
  ...
  %83 = load i64, i64* %RSP.i8, align 8
  %84 = load i64, i64* %PC.i, align 8
  %85 = add i64 %83, 16
  store i64 %85, i64* %RSP.i8, align 8
...
define %struct.Memory* @routine_movq__0x4018b0___rdi(%struct.State* dereferenceable(3376), i64, %struct.Memory*) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %RDI = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 11, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
