...
block_.L_401027:                                  ; preds = %block_.L_401108, %entry
  %95 = phi i64 [ %.pre, %entry ], [ %461, %block_.L_401108 ]
  %MEMORY.0 = phi %struct.Memory* [ %2, %entry ], [ %MEMORY.1, %block_.L_401108 ]
  ...
  br i1 %131, label %block_401033, label %block_.L_40111b
...
block_.L_40103a:                                  ; preds = %block_.L_4010f5, %block_401033
  %136 = phi i64 [ %.pre28, %block_401033 ], [ %431, %block_.L_4010f5 ]
  %MEMORY.1 = phi %struct.Memory* [ %MEMORY.0, %block_401033 ], [ %341, %block_.L_4010f5 ]
  ...
  br i1 %172, label %block_401046, label %block_.L_401108
...
routine_ucomisd_MINUS0x28__rbp____xmm0.exit:      ; preds = %339, %327
  ...
  br i1 %345, label %block_.L_4010f5, label %block_4010b0

block_4010b0:                                     ; preds = %routine_ucomisd_MINUS0x28__rbp____xmm0.exit
  store i64 4199594, i64* %RSI.i141, align 8
  ...
  %call2_4010e1 = tail call %struct.Memory* @sub_400690.fprintf_plt(%struct.State* nonnull %0, i64 %383, %struct.Memory* %341)
...
block_.L_401122:                                  ; preds = %block_.L_40111b, %block_4010b0
  %465 = phi i64 [ %.pre30, %block_.L_40111b ], [ %400, %block_4010b0 ]
  %MEMORY.2 = phi %struct.Memory* [ %MEMORY.0, %block_.L_40111b ], [ %call2_4010e1, %block_4010b0 ]
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_jge_.L_401108(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i8* nocapture %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 2, i32 9
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_jbe_.L_4010f5(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i8* nocapture %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_movq__0x4014aa___rsi(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %RSI = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 9, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_jmpq_.L_401122(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_jmpq_.L_40110d(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
