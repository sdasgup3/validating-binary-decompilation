...
entry:
  ...
  %42 = add i64 %10, add (i64 ptrtoint (%G_0x448__rip__type* @G_0x448__rip_ to i64), i64 7)
  %43 = add i64 %10, 15
...
block_.L_401037:                                  ; preds = %block_.L_401118, %entry
  %95 = phi i64 [ %.pre, %entry ], [ %462, %block_.L_401118 ]
  %MEMORY.0 = phi %struct.Memory* [ %2, %entry ], [ %MEMORY.1, %block_.L_401118 ]
  ...
  br i1 %131, label %block_401043, label %block_.L_40112b
...
block_.L_40104a:                                  ; preds = %block_.L_401105, %block_401043
  %136 = phi i64 [ %.pre28, %block_401043 ], [ %432, %block_.L_401105 ]
  %MEMORY.1 = phi %struct.Memory* [ %MEMORY.0, %block_401043 ], [ %341, %block_.L_401105 ]
  ...
  br i1 %172, label %block_401056, label %block_.L_401118
...
routine_ucomisd_MINUS0x28__rbp____xmm0.exit:      ; preds = %339, %327
  ...
  br i1 %345, label %block_.L_401105, label %block_4010c0

block_4010c0:                                     ; preds = %routine_ucomisd_MINUS0x28__rbp____xmm0.exit
  store i64 ptrtoint (%G__0x4014ba_type* @G__0x4014ba to i64), i64* %RSI.i143, align 8
...
block_.L_401132:                                  ; preds = %block_.L_40112b, %block_4010c0
  %466 = phi i64 [ %.pre30, %block_.L_40112b ], [ %401, %block_4010c0 ]
  %MEMORY.2 = phi %struct.Memory* [ %MEMORY.0, %block_.L_40112b ], [ %388, %block_4010c0 ]
