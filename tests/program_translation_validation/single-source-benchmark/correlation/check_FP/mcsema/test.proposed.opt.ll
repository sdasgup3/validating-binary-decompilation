...
block_.L_401027:                                  ; preds = %block_.L_401108, %entry
  %95 = phi i64 [ %.pre, %entry ], [ %462, %block_.L_401108 ]
...
block_.L_40103a:                                  ; preds = %block_.L_4010f5, %block_401033
  %136 = phi i64 [ %.pre28, %block_401033 ], [ %432, %block_.L_4010f5 ]
...
block_4010b0:                                     ; preds = %routine_ucomisd_MINUS0x28__rbp____xmm0.exit
  store i64 4199594, i64* %RSI.i143, align 8
...
block_.L_401122:                                  ; preds = %block_.L_40111b, %block_4010b0
  %466 = phi i64 [ %.pre30, %block_.L_40111b ], [ %401, %block_4010b0 ]
  %MEMORY.2 = phi %struct.Memory* [ %MEMORY.0, %block_.L_40111b ], [ %388, %block_4010b0 ]
