...
@G_0x448__rip__4198368_ = local_unnamed_addr global %G_0x448__rip__4198368__type zeroinitializer
...
entry:
  ...
  %42 = load i64, i64* bitcast (%G_0x448__rip__4198368__type* @G_0x448__rip__4198368_ to i64*), align 8
...
block_.L_400ff7:                                  ; preds = %block_.L_4010d8, %entry
  %88 = phi i64 [ %.pre, %entry ], [ %448, %block_.L_4010d8 ]
  %MEMORY.0 = phi %struct.Memory* [ %2, %entry ], [ %MEMORY.1, %block_.L_4010d8 ]
  ...
  br i1 %124, label %block_401003, label %block_.L_4010eb
...
block_.L_40100a:                                  ; preds = %block_.L_4010c5, %block_401003
  %129 = phi i64 [ %.pre3, %block_401003 ], [ %418, %block_.L_4010c5 ]
  %MEMORY.1 = phi %struct.Memory* [ %MEMORY.0, %block_401003 ], [ %327, %block_.L_4010c5 ]
  ...
  br i1 %165, label %block_401016, label %block_.L_4010d8
...
block_401016:                                     ; preds = %block_.L_40100a
  ...
  %276 = load i32, i32* bitcast (%G_0x3c9__rip__4198503__type* @G_0x3c9__rip__4198503_ to i32*), align 8
  %277 = load i32, i32* inttoptr (i64 add (i64 ptrtoint (%G_0x3c9__rip__4198503__type* @G_0x3c9__rip__4198503_ to i64), i64 4) to i32*), align 4
  %278 = load i32, i32* inttoptr (i64 add (i64 ptrtoint (%G_0x3c9__rip__4198503__type* @G_0x3c9__rip__4198503_ to i64), i64 8) to i32*), align 8
  %279 = load i32, i32* inttoptr (i64 add (i64 ptrtoint (%G_0x3c9__rip__4198503__type* @G_0x3c9__rip__4198503_ to i64), i64 12) to i32*), align 4
...
routine_ucomisd_MINUS0x28__rbp____xmm0.exit:      ; preds = %325, %313
  ...
  br i1 %331, label %block_.L_4010c5, label %block_401080

block_401080:                                     ; preds = %routine_ucomisd_MINUS0x28__rbp____xmm0.exit
  store i64 ptrtoint (%G__0x40147a_type* @G__0x40147a to i64), i64* %RSI.i143, align 8
...
block_.L_4010f2:                                  ; preds = %block_.L_4010eb, %block_401080
  %452 = phi i64 [ %.pre5, %block_.L_4010eb ], [ %387, %block_401080 ]
  %MEMORY.2 = phi %struct.Memory* [ %MEMORY.0, %block_.L_4010eb ], [ %374, %block_401080 ]
...
define %struct.Memory* @routine_movsd_0x448__rip____xmm0(%struct.State* dereferenceable(3376), i64, %struct.Memory*) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, 8
  store i64 %4, i64* %PC, align 8
  %5 = load i64, i64* bitcast (%G_0x448__rip__4198368__type* @G_0x448__rip__4198368_ to i64*), align 8
...
define %struct.Memory* @routine_jge_.L_4010eb(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i8* %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
...
define %struct.Memory* @routine_jge_.L_4010d8(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i8* %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 2, i32 9
...
block_400478:
  ...
  %6 = add i64 %5, 7
  store i64 %6, i64* %PC, align 8
  %7 = load i32, i32* bitcast (%G_0x3c9__rip__4198503__type* @G_0x3c9__rip__4198503_ to i32*), align 8
  %8 = load i32, i32* inttoptr (i64 add (i64 ptrtoint (%G_0x3c9__rip__4198503__type* @G_0x3c9__rip__4198503_ to i64), i64 4) to i32*), align 4
  %9 = load i32, i32* inttoptr (i64 add (i64 ptrtoint (%G_0x3c9__rip__4198503__type* @G_0x3c9__rip__4198503_ to i64), i64 8) to i32*), align 8
  %10 = load i32, i32* inttoptr (i64 add (i64 ptrtoint (%G_0x3c9__rip__4198503__type* @G_0x3c9__rip__4198503_ to i64), i64 12) to i32*), align 4
...
define %struct.Memory* @routine_jbe_.L_4010c5(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i8* %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
...
define %struct.Memory* @routine_movq__0x40147a___rsi(%struct.State* dereferenceable(3376), i64, %struct.Memory*) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %RSI = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 9, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
...
define %struct.Memory* @routine_jmpq_.L_4010f2(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
...
define %struct.Memory* @routine_jmpq_.L_4010ca(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
...
define %struct.Memory* @routine_jmpq_.L_40100a(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
...
define %struct.Memory* @routine_jmpq_.L_400ff7(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
