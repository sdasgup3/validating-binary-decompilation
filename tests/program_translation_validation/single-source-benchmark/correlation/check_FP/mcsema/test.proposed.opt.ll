...
@G_0x448__rip_ = local_unnamed_addr global %G_0x448__rip__type zeroinitializer
...
entry:
  ...
  %42 = load i64, i64* bitcast (%G_0x448__rip__type* @G_0x448__rip_ to i64*), align 8
...
block_.L_400ff7:                                  ; preds = %block_.L_4010d8, %entry
  %89 = phi i64 [ %.pre, %entry ], [ %456, %block_.L_4010d8 ]
  ...
  br i1 %125, label %block_401003, label %block_.L_4010eb
...
block_.L_40100a:                                  ; preds = %block_.L_4010c5, %block_401003
  %130 = phi i64 [ %.pre3, %block_401003 ], [ %425, %block_.L_4010c5 ]
  %MEMORY.1 = phi %struct.Memory* [ %MEMORY.0, %block_401003 ], [ %331, %block_.L_4010c5 ]
  ...
  br i1 %166, label %block_401016, label %block_.L_4010d8
...
routine_ucomisd_MINUS0x28__rbp____xmm0.exit:      ; preds = %329, %317
  ...
  br i1 %335, label %block_.L_4010c5, label %block_401080
...
block_.L_4010f2:                                  ; preds = %block_.L_4010eb, %block_401080
  %460 = phi i64 [ %.pre5, %block_.L_4010eb ], [ %393, %block_401080 ]
  %MEMORY.2 = phi %struct.Memory* [ %MEMORY.0, %block_.L_4010eb ], [ %380, %block_401080 ]
...
block_400478:
  ...
  %5 = load i64, i64* bitcast (%G_0x448__rip__type* @G_0x448__rip_ to i64*), align 8
