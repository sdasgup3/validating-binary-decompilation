; ModuleID = '/tmp/tmpp8ms6gn8-query.ll'
...
entry:
  ...
  %var_2_42 = add i64 %var_2_10, add (i64 ptrtoint (%G_0x448__rip__type* @G_0x448__rip_ to i64), i64 7)
  ...
  br i1 %var_2_13121, label %block_401043.preheader, label %block_.L_401132

block_401043.preheader:                           ; preds = %entry
  br label %block_401043

block_.L_401037.loopexit.loopexit:                ; preds = %routine_ucomisd_MINUS0x28__rbp____xmm0.exit.block_.L_40104a_crit_edge
  br label %block_.L_401037.loopexit

block_.L_401037.loopexit:                         ; preds = %block_.L_401037.loopexit.loopexit, %block_401043
  %var_2_137.lcssa = phi i64 [ %var_2_13711, %block_401043 ], [ %var_2_137.pre, %block_.L_401037.loopexit.loopexit ]
  %MEMORY.1.lcssa = phi %struct.Memory* [ %MEMORY.022, %block_401043 ], [ %var_2_341, %block_.L_401037.loopexit.loopexit ]
  %var_2_146.lcssa = phi i32 [ %var_2_14628, %block_401043 ], [ %var_2_146, %block_.L_401037.loopexit.loopexit ]
  %var_2_165.lcssa = phi i32 [ %var_2_16532, %block_401043 ], [ %var_2_165, %block_.L_401037.loopexit.loopexit ]
  ...
  br i1 %var_2_131, label %block_401043, label %block_.L_401132.loopexit17

block_401043:                                     ; preds = %block_401043.preheader, %block_.L_401037.loopexit
  %var_2_13711 = phi i64 [ %var_2_137.lcssa, %block_.L_401037.loopexit ], [ %var_2_965, %block_401043.preheader ]
  %MEMORY.022 = phi %struct.Memory* [ %MEMORY.1.lcssa, %block_.L_401037.loopexit ], [ %2, %block_401043.preheader ]
  ...
  br i1 %var_2_17238, label %block_401056.preheader, label %block_.L_401037.loopexit

block_401056.preheader:                           ; preds = %block_401043
  br label %block_401056

block_401056:                                     ; preds = %block_401056.preheader, %routine_ucomisd_MINUS0x28__rbp____xmm0.exit.block_.L_40104a_crit_edge
  %MEMORY.140 = phi %struct.Memory* [ %var_2_341, %routine_ucomisd_MINUS0x28__rbp____xmm0.exit.block_.L_40104a_crit_edge ], [ %MEMORY.022, %block_401056.preheader ]
  %var_2_13739 = phi i64 [ %var_2_137.pre, %routine_ucomisd_MINUS0x28__rbp____xmm0.exit.block_.L_40104a_crit_edge ], [ %var_2_13711, %block_401056.preheader ]
...
routine_ucomisd_MINUS0x28__rbp____xmm0.exit:      ; preds = %var_2_327, %var_2_319, %block_401056
  %var_2_341 = phi %struct.Memory* [ %var_2_328, %var_2_327 ], [ %MEMORY.140, %var_2_319 ], [ %MEMORY.140, %block_401056 ]
  ...
  br i1 %var_2_345, label %block_.L_401132.loopexit, label %routine_ucomisd_MINUS0x28__rbp____xmm0.exit.block_.L_40104a_crit_edge

routine_ucomisd_MINUS0x28__rbp____xmm0.exit.block_.L_40104a_crit_edge: ; preds = %routine_ucomisd_MINUS0x28__rbp____xmm0.exit
  ...
  br i1 %var_2_172, label %block_401056, label %block_.L_401037.loopexit.loopexit

block_.L_401132.loopexit:                         ; preds = %routine_ucomisd_MINUS0x28__rbp____xmm0.exit
  br label %block_.L_401132

block_.L_401132.loopexit17:                       ; preds = %block_.L_401037.loopexit
  br label %block_.L_401132

block_.L_401132:                                  ; preds = %block_.L_401132.loopexit17, %block_.L_401132.loopexit, %entry
...
; Function Attrs: alwaysinline norecurse nounwind
define %struct.Memory* @routine_jge_.L_401118(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i8* nocapture %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 2, i32 9
...
; Function Attrs: alwaysinline norecurse nounwind
define %struct.Memory* @routine_jbe_.L_401105(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i8* nocapture %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
...
; Function Attrs: alwaysinline norecurse nounwind
define %struct.Memory* @routine_movq__0x4014ba___rsi(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %RSI = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 9, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
...
; Function Attrs: alwaysinline norecurse nounwind
define %struct.Memory* @routine_jmpq_.L_401132(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
...
; Function Attrs: alwaysinline norecurse nounwind
define %struct.Memory* @routine_jmpq_.L_40110a(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
...
; Function Attrs: alwaysinline norecurse nounwind
define %struct.Memory* @routine_jmpq_.L_40104a(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
...
; Function Attrs: alwaysinline norecurse nounwind
define %struct.Memory* @routine_jmpq_.L_401037(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
