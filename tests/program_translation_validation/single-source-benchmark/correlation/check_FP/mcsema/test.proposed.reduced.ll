; ModuleID = '/tmp/tmpth5ayt6l-query.ll'
...
entry:
  ...
  br i1 %var_2_13122, label %block_401043.preheader, label %block_.L_401132
...
block_.L_401037.loopexit:                         ; preds = %block_.L_401037.loopexit.loopexit, %block_401043
  %var_2_137.lcssa = phi i64 [ %var_2_1379, %block_401043 ], [ %var_2_137.pre, %block_.L_401037.loopexit.loopexit ]
  %MEMORY.1.lcssa = phi %struct.Memory* [ %MEMORY.023, %block_401043 ], [ %var_2_341, %block_.L_401037.loopexit.loopexit ]
  %var_2_146.lcssa = phi i32 [ %var_2_14624, %block_401043 ], [ %var_2_146, %block_.L_401037.loopexit.loopexit ]
  %var_2_165.lcssa = phi i32 [ %var_2_16528, %block_401043 ], [ %var_2_165, %block_.L_401037.loopexit.loopexit ]
  ...
  br i1 %var_2_131, label %block_401043, label %block_.L_401132.loopexit

block_401043:                                     ; preds = %block_401043.preheader, %block_.L_401037.loopexit
  %var_2_1379 = phi i64 [ %var_2_137.lcssa, %block_.L_401037.loopexit ], [ %var_2_966, %block_401043.preheader ]
  %MEMORY.023 = phi %struct.Memory* [ %MEMORY.1.lcssa, %block_.L_401037.loopexit ], [ %2, %block_401043.preheader ]
  ...
  br i1 %var_2_17234, label %block_401056.preheader, label %block_.L_401037.loopexit
...
block_401056:                                     ; preds = %block_401056.preheader, %routine_ucomisd_MINUS0x28__rbp____xmm0.exit.block_.L_40104a_crit_edge
  %MEMORY.136 = phi %struct.Memory* [ %var_2_341, %routine_ucomisd_MINUS0x28__rbp____xmm0.exit.block_.L_40104a_crit_edge ], [ %MEMORY.023, %block_401056.preheader ]
  %var_2_13735 = phi i64 [ %var_2_137.pre, %routine_ucomisd_MINUS0x28__rbp____xmm0.exit.block_.L_40104a_crit_edge ], [ %var_2_1379, %block_401056.preheader ]
...
routine_ucomisd_MINUS0x28__rbp____xmm0.exit:      ; preds = %var_2_327, %var_2_319, %block_401056
  %var_2_341 = phi %struct.Memory* [ %var_2_328, %var_2_327 ], [ %MEMORY.136, %var_2_319 ], [ %MEMORY.136, %block_401056 ]
  ...
  br i1 %var_2_345, label %block_4010c0, label %routine_ucomisd_MINUS0x28__rbp____xmm0.exit.block_.L_40104a_crit_edge
...
block_.L_401132.loopexit:                         ; preds = %block_.L_401037.loopexit
  br label %block_.L_401132

block_.L_401132:                                  ; preds = %block_.L_401132.loopexit, %block_4010c0, %entry
  %MEMORY.2 = phi %struct.Memory* [ %var_2_388, %block_4010c0 ], [ %2, %entry ], [ %MEMORY.1.lcssa, %block_.L_401132.loopexit ]
