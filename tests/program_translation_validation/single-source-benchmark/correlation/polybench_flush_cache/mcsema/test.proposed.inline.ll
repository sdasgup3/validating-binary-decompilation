...
declare %struct.Memory* @sub_400680.calloc_plt(%struct.State* dereferenceable(3376), i64, %struct.Memory*)

declare %struct.Memory* @sub_400650.free_plt(%struct.State* dereferenceable(3376), i64, %struct.Memory*)

; Function Attrs: alwaysinline
define %struct.Memory* @polybench_flush_cache(%struct.State* noalias, i64, %struct.Memory* noalias) #1 {
entry:
