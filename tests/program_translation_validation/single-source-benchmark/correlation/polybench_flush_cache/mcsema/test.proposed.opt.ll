...
block_.L_400812:                                  ; preds = %block_40081e, %entry
  %78 = phi i64 [ %167, %block_40081e ], [ %.pre, %entry ]
  ...
  br i1 %114, label %block_40081e, label %block_.L_400843

block_40081e:                                     ; preds = %block_.L_400812
  %120 = add i64 %115, 8
...
block_.L_400843:                                  ; preds = %block_.L_400812
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_jge_.L_400843(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i8* nocapture %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_jmpq_.L_400812(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
