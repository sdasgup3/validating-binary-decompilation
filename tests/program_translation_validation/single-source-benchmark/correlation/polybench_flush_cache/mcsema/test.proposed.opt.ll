...
entry:
  ...
  br label %block_.L_4007c2

block_.L_4007c2:                                  ; preds = %block_4007ce, %entry
  %84 = phi i64 [ %172, %block_4007ce ], [ %.pre, %entry ]
  ...
  br i1 %120, label %block_4007ce, label %block_.L_4007f3

block_4007ce:                                     ; preds = %block_.L_4007c2
  %126 = add i64 %121, 8
...
block_.L_4007f3:                                  ; preds = %block_.L_4007c2
...
define %struct.Memory* @routine_jmpq_.L_4007c2(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
