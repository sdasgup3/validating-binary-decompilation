...
declare %struct.Memory* @sub_400790.polybench_flush_cache(%struct.State* noalias dereferenceable(3376), i64, %struct.Memory* noalias readnone returned)
...
entry:
  ...
  %loadMem1_400814 = load %struct.Memory*, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem1_400814, %struct.Memory** %MEMORY
  %loadMem2_400814 = load %struct.Memory*, %struct.Memory** %MEMORY
  %loadPC_400814 = load i64, i64* %3
  %call2_400814 = call %struct.Memory* @sub_400790.polybench_flush_cache(%struct.State* %0, i64 %loadPC_400814, %struct.Memory* %loadMem2_400814)
  store %struct.Memory* %call2_400814, %struct.Memory** %MEMORY
  ...
  ret %struct.Memory* %loadMem_40081a
}
