...
entry:
  ...
  store i64 4199536, i64* %RDI.i, align 8
  ...
  store %struct.Memory* %loadMem1_4008d6, %struct.Memory** %MEMORY
  %loadMem2_4008d6 = load %struct.Memory*, %struct.Memory** %MEMORY
  %loadPC_4008d6 = load i64, i64* %3
  %129 = call %struct.Memory* @__remill_function_call(%struct.State* %0, i64 ptrtoint (i64 (i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64)* @printf to i64), %struct.Memory* %loadMem2_4008d6)
  ...
  ret %struct.Memory* %loadMem_4008e3
}
...
define %struct.Memory* @routine_movq__0x401470___rdi(%struct.State* dereferenceable(3376), i64, %struct.Memory*) {
block_400488:
  %3 = getelementptr inbounds %struct.State, %struct.State* %0, i32 0, i32 6
  %4 = getelementptr inbounds %struct.GPR, %struct.GPR* %3, i32 0, i32 33
  %5 = getelementptr inbounds %struct.Reg, %struct.Reg* %4, i32 0, i32 0
  ...
  %10 = add i64 %9, 10
  store i64 %10, i64* %PC
  store i64 4199536, i64* %RDI, align 8
  ret %struct.Memory* %2
}
