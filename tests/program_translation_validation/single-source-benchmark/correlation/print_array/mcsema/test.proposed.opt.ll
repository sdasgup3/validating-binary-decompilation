...
declare %struct.Memory* @sub_4011d0.print_element(%struct.State* noalias dereferenceable(3376), i64, %struct.Memory* noalias readnone returned) local_unnamed_addr
...
block_.L_40113c:                                  ; preds = %block_.L_401195, %entry
  %117 = phi i64 [ %.pre, %entry ], [ %347, %block_.L_401195 ]
  %MEMORY.0 = phi %struct.Memory* [ %73, %entry ], [ %309, %block_.L_401195 ]
  ...
  br i1 %153, label %block_401148, label %block_.L_4011b7

block_401148:                                     ; preds = %block_.L_40113c
  %155 = add i64 %118, -24
  %156 = add i64 %154, 7
...
block_.L_40114f:                                  ; preds = %block_40115b, %block_401148
  %158 = phi i64 [ %.pre1, %block_401148 ], [ %298, %block_40115b ]
  %MEMORY.1 = phi %struct.Memory* [ %MEMORY.0, %block_401148 ], [ %call2_401182, %block_40115b ]
  ...
  br i1 %194, label %block_40115b, label %block_.L_401195

block_40115b:                                     ; preds = %block_.L_40114f
  %196 = add i64 %159, -16
  %197 = add i64 %195, 4
  ...
  %call2_401182 = tail call %struct.Memory* @sub_4011d0.print_element(%struct.State* %0, i64 %262, %struct.Memory* %MEMORY.1)
...
block_.L_401195:                                  ; preds = %block_.L_40114f
  %299 = add i64 %159, -32
  %300 = add i64 %195, 4
...
block_.L_4011b7:                                  ; preds = %block_.L_40113c
  %348 = add i64 %118, -32
  %349 = add i64 %154, 4
...
define %struct.Memory* @routine_jge_.L_4011b7(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i8* %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
...
define %struct.Memory* @routine_jge_.L_401195(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i8* %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 2, i32 9
...
define %struct.Memory* @routine_jmpq_.L_40114f(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
...
define %struct.Memory* @routine_jmpq_.L_40113c(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
