...
entry:
  ...
  br i1 %81, label %block_.L_400983, label %block_400979
...
block_400979:                                     ; preds = %entry
  ...
  br i1 %95, label %block_.L_4009a9, label %block_.L_400983

block_.L_400983:                                  ; preds = %block_400979, %entry
  %100 = phi i64 [ %99, %block_400979 ], [ %85, %entry ]
  store i64 ptrtoint (%G__0x401487_type* @G__0x401487 to i64), i64* %RSI.i45, align 8
...
block_.L_4009a9:                                  ; preds = %block_.L_400983, %block_400979
  %121 = phi i64 [ %.pre2, %block_.L_400983 ], [ %99, %block_400979 ]
  %122 = phi i64 [ %.pre, %block_.L_400983 ], [ %69, %block_400979 ]
  %MEMORY.1 = phi %struct.Memory* [ %120, %block_.L_400983 ], [ %62, %block_400979 ]
  %123 = add i64 %122, -16
  %124 = add i64 %121, 4
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_je_.L_400983(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i8* nocapture %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_je_.L_4009a9(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i8* nocapture %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 2, i32 7
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_movq__0x401487___rsi(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %RSI = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 9, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
