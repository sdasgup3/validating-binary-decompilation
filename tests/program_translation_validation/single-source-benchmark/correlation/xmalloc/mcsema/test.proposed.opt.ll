...
declare %struct.Memory* @sub_4006c0.posix_memalign_plt(%struct.State* noalias dereferenceable(3376), i64, %struct.Memory* noalias readnone returned) local_unnamed_addr
...
declare %struct.Memory* @sub_4006b0.exit_plt(%struct.State* noalias dereferenceable(3376), i64, %struct.Memory* noalias readnone returned) local_unnamed_addr
...
entry:
  ...
  %call2_400956 = tail call %struct.Memory* @sub_4006c0.posix_memalign_plt(%struct.State* %0, i64 %57, %struct.Memory* %2)
  ...
  br i1 %80, label %block_.L_400973, label %block_400969
...
block_400969:                                     ; preds = %entry
  ...
  br i1 %94, label %block_.L_400999, label %block_.L_400973

block_.L_400973:                                  ; preds = %block_400969, %entry
  %99 = phi i64 [ %98, %block_400969 ], [ %84, %entry ]
  store i64 4199543, i64* %RSI.i37, align 8
  ...
  %call2_400987 = tail call %struct.Memory* @sub_400690.fprintf_plt(%struct.State* nonnull %0, i64 %101, %struct.Memory* %call2_400956)
  ...
  %call2_400994 = tail call %struct.Memory* @sub_4006b0.exit_plt(%struct.State* nonnull %0, i64 %113, %struct.Memory* %call2_400987)
  %.pre = load i64, i64* %RBP.i, align 8
  %.pre2 = load i64, i64* %3, align 8
  br label %block_.L_400999

block_.L_400999:                                  ; preds = %block_.L_400973, %block_400969
  %118 = phi i64 [ %.pre2, %block_.L_400973 ], [ %98, %block_400969 ]
  %119 = phi i64 [ %.pre, %block_.L_400973 ], [ %68, %block_400969 ]
  %MEMORY.1 = phi %struct.Memory* [ %call2_400994, %block_.L_400973 ], [ %call2_400956, %block_400969 ]
  %120 = add i64 %119, -16
  %121 = add i64 %118, 4
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_je_.L_400973(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i8* nocapture %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_je_.L_400999(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i8* nocapture %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 2, i32 7
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_movq__0x401477___rsi(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %RSI = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 9, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, 10
  store i64 %4, i64* %PC, align 8
  store i64 4199543, i64* %RSI, align 8
  ret %struct.Memory* %2
}
