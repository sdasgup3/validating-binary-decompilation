...
block_.L_400da7:                                  ; preds = %block_.L_400e8d, %entry
...
block_.L_400dba:                                  ; preds = %block_.L_400e7a, %block_400db3
...
; <label>:828:                                    ; preds = %820
  ...
  %831 = call %struct.Memory* @__remill_error(%struct.State* nonnull dereferenceable(3376) %0, i64 %830, %struct.Memory* %loadMem_400e25)
  br label %routine_ucomisd_MINUS0x28__rbp____xmm0.exit

; <label>:832:                                    ; preds = %block_400dc6
...
routine_ucomisd_MINUS0x28__rbp____xmm0.exit:      ; preds = %828, %845
  %849 = phi %struct.Memory* [ %831, %828 ], [ %loadMem_400e25, %845 ]
...
block_400e30:                                     ; preds = %routine_ucomisd_MINUS0x28__rbp____xmm0.exit
  ...
  store i64 4198938, i64* %RSI.i, align 8
  ...
  %1028 = call %struct.Memory* @__remill_function_call(%struct.State* %0, i64 ptrtoint (i64 (i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64)* @fprintf to i64), %struct.Memory* %loadMem2_400e61)
...
block_.L_400e7a:                                  ; preds = %block_.L_400e75
...
block_.L_400e8d:                                  ; preds = %block_.L_400e88
...
block_.L_400ea2:                                  ; preds = %block_.L_400e9b, %block_400e30
  ...
  ret %struct.Memory* %loadMem_400eaa
}
...
define %struct.Memory* @routine_movq__0x40121a___rsi(%struct.State* dereferenceable(3376), i64, %struct.Memory*) {
block_400488:
  %3 = getelementptr inbounds %struct.State, %struct.State* %0, i32 0, i32 6
  %4 = getelementptr inbounds %struct.GPR, %struct.GPR* %3, i32 0, i32 33
  %5 = getelementptr inbounds %struct.Reg, %struct.Reg* %4, i32 0, i32 0
