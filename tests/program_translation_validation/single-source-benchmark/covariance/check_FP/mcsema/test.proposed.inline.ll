...
@G_0x438__rip__4197728_ = global %G_0x438__rip__4197728__type zeroinitializer
...
entry:
  ...
  %76 = load double, double* bitcast (%G_0x438__rip__4197728__type* @G_0x438__rip__4197728_ to double*)
...
block_.L_400d77:                                  ; preds = %block_.L_400e5d, %entry
...
block_.L_400d8a:                                  ; preds = %block_.L_400e4a, %block_400d83
...
block_400d96:                                     ; preds = %block_.L_400d8a
  ...
  %710 = load float, float* bitcast (%G_0x3b9__rip__4197863__type* @G_0x3b9__rip__4197863_ to float*)
  %711 = load float, float* inttoptr (i64 add (i64 ptrtoint (%G_0x3b9__rip__4197863__type* @G_0x3b9__rip__4197863_ to i64), i64 4) to float*)
  %712 = load float, float* inttoptr (i64 add (i64 ptrtoint (%G_0x3b9__rip__4197863__type* @G_0x3b9__rip__4197863_ to i64), i64 8) to float*)
  %713 = load float, float* inttoptr (i64 add (i64 ptrtoint (%G_0x3b9__rip__4197863__type* @G_0x3b9__rip__4197863_ to i64), i64 12) to float*)
...
; <label>:818:                                    ; preds = %810
  ...
  %821 = call %struct.Memory* @__remill_error(%struct.State* nonnull dereferenceable(3376) %0, i64 %820, %struct.Memory* %loadMem_400df5)
  br label %routine_ucomisd_MINUS0x28__rbp____xmm0.exit

; <label>:822:                                    ; preds = %block_400d96
...
routine_ucomisd_MINUS0x28__rbp____xmm0.exit:      ; preds = %818, %835
  %839 = phi %struct.Memory* [ %821, %818 ], [ %loadMem_400df5, %835 ]
...
block_400e00:                                     ; preds = %routine_ucomisd_MINUS0x28__rbp____xmm0.exit
  ...
  store i64 ptrtoint (%G__0x4011ea_type* @G__0x4011ea to i64), i64* %RSI.i, align 8
  ...
  store %struct.Memory* %loadMem1_400e31, %struct.Memory** %MEMORY
  %loadMem2_400e31 = load %struct.Memory*, %struct.Memory** %MEMORY
  %loadPC_400e31 = load i64, i64* %3
  %1018 = call %struct.Memory* @__remill_function_call(%struct.State* %0, i64 ptrtoint (i64 (i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64)* @fprintf to i64), %struct.Memory* %loadMem2_400e31)
...
block_.L_400e5d:                                  ; preds = %block_.L_400e58
...
block_400478:
  ...
  %9 = load i64, i64* %PC
  %10 = ptrtoint %G_0x438__rip__4197728__type* @G_0x438__rip__4197728_ to i64
  %11 = load i64, i64* %PC
  %12 = add i64 %11, 8
  store i64 %12, i64* %PC
...
block_400478:
  ...
  %9 = load i64, i64* %PC
  %10 = ptrtoint %G_0x3b9__rip__4197863__type* @G_0x3b9__rip__4197863_ to i64
  %11 = load i64, i64* %PC
  %12 = add i64 %11, 7
  store i64 %12, i64* %PC
...
define %struct.Memory* @routine_movq__0x4011ea___rsi(%struct.State* dereferenceable(3376), i64, %struct.Memory*) {
block_400478:
  %3 = getelementptr inbounds %struct.State, %struct.State* %0, i32 0, i32 6
  %4 = getelementptr inbounds %struct.GPR, %struct.GPR* %3, i32 0, i32 33
  %5 = getelementptr inbounds %struct.Reg, %struct.Reg* %4, i32 0, i32 0
