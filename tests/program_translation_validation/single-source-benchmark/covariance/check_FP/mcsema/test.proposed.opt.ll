...
declare %struct.Memory* @sub_400630.fprintf_plt(%struct.State* noalias dereferenceable(3376), i64, %struct.Memory* noalias readnone returned) local_unnamed_addr
...
block_.L_400da7:                                  ; preds = %block_.L_400e88, %entry
  %95 = phi i64 [ %.pre, %entry ], [ %461, %block_.L_400e88 ]
...
block_.L_400dba:                                  ; preds = %block_.L_400e75, %block_400db3
  %136 = phi i64 [ %.pre28, %block_400db3 ], [ %431, %block_.L_400e75 ]
...
block_400dc6:                                     ; preds = %block_.L_400dba
  ...
  store i64 %226, i64* %RAX.i130, align 8
  %227 = add i64 %221, -28
  %228 = add i64 %223, 8
  ...
  store i64 %232, i64* %RCX.i111, align 8
  %233 = lshr i64 %232, 63
  %234 = add i64 %232, %226
  ...
  store i64 %263, i64* %RCX.i111, align 8
...
block_400e30:                                     ; preds = %routine_ucomisd_MINUS0x28__rbp____xmm0.exit
  store i64 4198938, i64* %RSI.i141, align 8
  ...
  store i64 %353, i64* %RDX.i138, align 8
  %354 = add i64 %348, -32
  %355 = add i64 %346, 24
  ...
  store i64 %358, i64* %RCX.i111, align 8
  %359 = add i64 %348, -48
  %360 = add i64 %346, 29
  ...
  %call2_400e61 = tail call %struct.Memory* @sub_400630.fprintf_plt(%struct.State* nonnull %0, i64 %383, %struct.Memory* %341)
  ...
  %394 = add i64 %393, -68
  %395 = load i32, i32* %EAX.i127, align 4
...
block_.L_400e75:                                  ; preds = %routine_ucomisd_MINUS0x28__rbp____xmm0.exit
  ...
  store i64 %407, i64* %RAX.i130, align 8
...
block_.L_400e88:                                  ; preds = %block_.L_400dba
  ...
  store i64 %437, i64* %RAX.i130, align 8
...
block_.L_400ea2:                                  ; preds = %block_.L_400e9b, %block_400e30
  %465 = phi i64 [ %.pre30, %block_.L_400e9b ], [ %400, %block_400e30 ]
  %MEMORY.2 = phi %struct.Memory* [ %MEMORY.0, %block_.L_400e9b ], [ %call2_400e61, %block_400e30 ]
  ...
  store i64 %471, i64* %RAX.i130, align 8
  %472 = load i64, i64* %6, align 8
  %473 = add i64 %472, 80
  store i64 %473, i64* %6, align 8
  %474 = icmp ugt i64 %472, -81
