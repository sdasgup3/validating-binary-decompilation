...
block_.L_400db7:                                  ; preds = %block_.L_400e98, %entry
  %95 = phi i64 [ %.pre, %entry ], [ %462, %block_.L_400e98 ]
  %MEMORY.0 = phi %struct.Memory* [ %2, %entry ], [ %MEMORY.1, %block_.L_400e98 ]
  ...
  br i1 %131, label %block_400dc3, label %block_.L_400eab

block_400dc3:                                     ; preds = %block_.L_400db7
  %133 = add i64 %96, -32
  %134 = add i64 %132, 7
...
block_.L_400dca:                                  ; preds = %block_.L_400e85, %block_400dc3
  %136 = phi i64 [ %.pre28, %block_400dc3 ], [ %432, %block_.L_400e85 ]
  %MEMORY.1 = phi %struct.Memory* [ %MEMORY.0, %block_400dc3 ], [ %341, %block_.L_400e85 ]
  ...
  br i1 %172, label %block_400dd6, label %block_.L_400e98

block_400dd6:                                     ; preds = %block_.L_400dca
  %174 = add i64 %137, -16
  %175 = add i64 %173, 4
  ...
  %284 = add i64 %274, add (i64 ptrtoint (%G_0x3b9__rip__type* @G_0x3b9__rip_ to i64), i64 10)
  %285 = add i64 %274, 17
  store i64 %285, i64* %3, align 8
  %286 = inttoptr i64 %284 to i32*
  %287 = load i32, i32* %286, align 4
  %288 = add i64 %274, add (i64 ptrtoint (%G_0x3b9__rip__type* @G_0x3b9__rip_ to i64), i64 14)
  %289 = inttoptr i64 %288 to i32*
  %290 = load i32, i32* %289, align 4
  %291 = add i64 %274, add (i64 ptrtoint (%G_0x3b9__rip__type* @G_0x3b9__rip_ to i64), i64 18)
  %292 = inttoptr i64 %291 to i32*
  %293 = load i32, i32* %292, align 4
  %294 = add i64 %274, add (i64 ptrtoint (%G_0x3b9__rip__type* @G_0x3b9__rip_ to i64), i64 22)
...
routine_ucomisd_MINUS0x28__rbp____xmm0.exit:      ; preds = %339, %327
  ...
  br i1 %345, label %block_.L_400e85, label %block_400e40

block_400e40:                                     ; preds = %routine_ucomisd_MINUS0x28__rbp____xmm0.exit
  store i64 ptrtoint (%G__0x40122a_type* @G__0x40122a to i64), i64* %RSI.i143, align 8
...
block_.L_400e85:                                  ; preds = %routine_ucomisd_MINUS0x28__rbp____xmm0.exit
...
block_.L_400e98:                                  ; preds = %block_.L_400dca
  %433 = add i64 %137, -28
  %434 = add i64 %173, 8
...
block_.L_400eab:                                  ; preds = %block_.L_400db7
  %463 = add i64 %96, -4
  %464 = add i64 %132, 7
...
block_.L_400eb2:                                  ; preds = %block_.L_400eab, %block_400e40
  %466 = phi i64 [ %.pre30, %block_.L_400eab ], [ %401, %block_400e40 ]
  %MEMORY.2 = phi %struct.Memory* [ %MEMORY.0, %block_.L_400eab ], [ %388, %block_400e40 ]
