...
%G_0x3b9__rip__4197863__type = type <{ [16 x i8] }>
%G_0x438__rip__4197728__type = type <{ [16 x i8] }>
...
@G_0x3b9__rip__4197863_ = global %G_0x3b9__rip__4197863__type zeroinitializer
@G_0x438__rip__4197728_ = local_unnamed_addr global %G_0x438__rip__4197728__type zeroinitializer
@G_0x602080 = local_unnamed_addr global %G_0x602080_type zeroinitializer
@G__0x4011ea = global %G__0x4011ea_type zeroinitializer
...
entry:
  ...
  %42 = load i64, i64* bitcast (%G_0x438__rip__4197728__type* @G_0x438__rip__4197728_ to i64*), align 8
...
block_.L_400d77:                                  ; preds = %block_.L_400e58, %entry
  %88 = phi i64 [ %.pre, %entry ], [ %448, %block_.L_400e58 ]
  %MEMORY.0 = phi %struct.Memory* [ %2, %entry ], [ %MEMORY.1, %block_.L_400e58 ]
  ...
  br i1 %124, label %block_400d83, label %block_.L_400e6b
...
block_.L_400d8a:                                  ; preds = %block_.L_400e45, %block_400d83
  %129 = phi i64 [ %.pre3, %block_400d83 ], [ %418, %block_.L_400e45 ]
  %MEMORY.1 = phi %struct.Memory* [ %MEMORY.0, %block_400d83 ], [ %327, %block_.L_400e45 ]
  ...
  br i1 %165, label %block_400d96, label %block_.L_400e58
...
block_400d96:                                     ; preds = %block_.L_400d8a
  ...
  %276 = load i32, i32* bitcast (%G_0x3b9__rip__4197863__type* @G_0x3b9__rip__4197863_ to i32*), align 8
  %277 = load i32, i32* inttoptr (i64 add (i64 ptrtoint (%G_0x3b9__rip__4197863__type* @G_0x3b9__rip__4197863_ to i64), i64 4) to i32*), align 4
  %278 = load i32, i32* inttoptr (i64 add (i64 ptrtoint (%G_0x3b9__rip__4197863__type* @G_0x3b9__rip__4197863_ to i64), i64 8) to i32*), align 8
  %279 = load i32, i32* inttoptr (i64 add (i64 ptrtoint (%G_0x3b9__rip__4197863__type* @G_0x3b9__rip__4197863_ to i64), i64 12) to i32*), align 4
...
routine_ucomisd_MINUS0x28__rbp____xmm0.exit:      ; preds = %325, %313
  ...
  br i1 %331, label %block_.L_400e45, label %block_400e00

block_400e00:                                     ; preds = %routine_ucomisd_MINUS0x28__rbp____xmm0.exit
  store i64 ptrtoint (%G__0x4011ea_type* @G__0x4011ea to i64), i64* %RSI.i143, align 8
...
block_.L_400e45:                                  ; preds = %routine_ucomisd_MINUS0x28__rbp____xmm0.exit
...
block_.L_400e58:                                  ; preds = %block_.L_400d8a
  %419 = add i64 %130, -28
  %420 = add i64 %166, 8
...
block_.L_400e6b:                                  ; preds = %block_.L_400d77
  %449 = add i64 %89, -4
  %450 = add i64 %125, 7
...
block_.L_400e72:                                  ; preds = %block_.L_400e6b, %block_400e00
  %452 = phi i64 [ %.pre5, %block_.L_400e6b ], [ %387, %block_400e00 ]
  %MEMORY.2 = phi %struct.Memory* [ %MEMORY.0, %block_.L_400e6b ], [ %374, %block_400e00 ]
...
define %struct.Memory* @routine_movsd_0x438__rip____xmm0(%struct.State* dereferenceable(3376), i64, %struct.Memory*) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, 8
  store i64 %4, i64* %PC, align 8
  %5 = load i64, i64* bitcast (%G_0x438__rip__4197728__type* @G_0x438__rip__4197728_ to i64*), align 8
...
define %struct.Memory* @routine_jge_.L_400e6b(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i8* %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
...
define %struct.Memory* @routine_jge_.L_400e58(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i8* %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 2, i32 9
...
define %struct.Memory* @routine_movaps_0x3b9__rip____xmm1(%struct.State* dereferenceable(3376), i64, %struct.Memory*) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  ...
  %6 = add i64 %5, 7
  store i64 %6, i64* %PC, align 8
  %7 = load i32, i32* bitcast (%G_0x3b9__rip__4197863__type* @G_0x3b9__rip__4197863_ to i32*), align 8
  %8 = load i32, i32* inttoptr (i64 add (i64 ptrtoint (%G_0x3b9__rip__4197863__type* @G_0x3b9__rip__4197863_ to i64), i64 4) to i32*), align 4
  %9 = load i32, i32* inttoptr (i64 add (i64 ptrtoint (%G_0x3b9__rip__4197863__type* @G_0x3b9__rip__4197863_ to i64), i64 8) to i32*), align 8
  %10 = load i32, i32* inttoptr (i64 add (i64 ptrtoint (%G_0x3b9__rip__4197863__type* @G_0x3b9__rip__4197863_ to i64), i64 12) to i32*), align 4
...
define %struct.Memory* @routine_jbe_.L_400e45(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i8* %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
...
define %struct.Memory* @routine_movq__0x4011ea___rsi(%struct.State* dereferenceable(3376), i64, %struct.Memory*) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %RSI = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 9, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, 10
  store i64 %4, i64* %PC, align 8
  store i64 ptrtoint (%G__0x4011ea_type* @G__0x4011ea to i64), i64* %RSI, align 8
  ret %struct.Memory* %2
}
...
define %struct.Memory* @routine_jmpq_.L_400e4a(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
...
define %struct.Memory* @routine_jmpq_.L_400d8a(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
...
define %struct.Memory* @routine_jmpq_.L_400e5d(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
...
define %struct.Memory* @routine_jmpq_.L_400d77(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
