...
block_.L_400da7:                                  ; preds = %block_.L_400e88, %entry
  %95 = phi i64 [ %.pre, %entry ], [ %462, %block_.L_400e88 ]
  %MEMORY.0 = phi %struct.Memory* [ %2, %entry ], [ %MEMORY.1, %block_.L_400e88 ]
  ...
  br i1 %131, label %block_400db3, label %block_.L_400e9b

block_400db3:                                     ; preds = %block_.L_400da7
  %133 = add i64 %96, -32
  %134 = add i64 %132, 7
...
block_.L_400dba:                                  ; preds = %block_.L_400e75, %block_400db3
  %136 = phi i64 [ %.pre28, %block_400db3 ], [ %432, %block_.L_400e75 ]
  %MEMORY.1 = phi %struct.Memory* [ %MEMORY.0, %block_400db3 ], [ %341, %block_.L_400e75 ]
  ...
  br i1 %172, label %block_400dc6, label %block_.L_400e88

block_400dc6:                                     ; preds = %block_.L_400dba
  %174 = add i64 %137, -16
  %175 = add i64 %173, 4
...
routine_ucomisd_MINUS0x28__rbp____xmm0.exit:      ; preds = %339, %327
  ...
  br i1 %345, label %block_.L_400e75, label %block_400e30

block_400e30:                                     ; preds = %routine_ucomisd_MINUS0x28__rbp____xmm0.exit
  store i64 4198938, i64* %RSI.i143, align 8
  %RDI.i = getelementptr inbounds %union.anon, %union.anon* %50, i64 0, i32 0
  %347 = load i64, i64* inttoptr (i64 6299776 to i64*), align 128
...
block_.L_400e75:                                  ; preds = %routine_ucomisd_MINUS0x28__rbp____xmm0.exit
...
block_.L_400e88:                                  ; preds = %block_.L_400dba
  %433 = add i64 %137, -28
  %434 = add i64 %173, 8
...
block_.L_400e9b:                                  ; preds = %block_.L_400da7
  %463 = add i64 %96, -4
  %464 = add i64 %132, 7
...
block_.L_400ea2:                                  ; preds = %block_.L_400e9b, %block_400e30
  %466 = phi i64 [ %.pre30, %block_.L_400e9b ], [ %401, %block_400e30 ]
  %MEMORY.2 = phi %struct.Memory* [ %MEMORY.0, %block_.L_400e9b ], [ %388, %block_400e30 ]
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_jge_.L_400e9b(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i8* nocapture %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_jge_.L_400e88(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i8* nocapture %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 2, i32 9
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_jbe_.L_400e75(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i8* nocapture %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_movq__0x40121a___rsi(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %RSI = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 9, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  ...
  store i64 4198938, i64* %RSI, align 8
  ret %struct.Memory* %2
}
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_jmpq_.L_400ea2(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_jmpq_.L_400e7a(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_jmpq_.L_400dba(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_jmpq_.L_400e8d(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
