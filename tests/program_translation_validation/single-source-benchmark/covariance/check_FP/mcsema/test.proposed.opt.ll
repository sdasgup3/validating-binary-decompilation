...
@G_0x438__rip_ = local_unnamed_addr global %G_0x438__rip__type zeroinitializer
...
entry:
  ...
  %42 = load i64, i64* bitcast (%G_0x438__rip__type* @G_0x438__rip_ to i64*), align 8
...
block_.L_400d77:                                  ; preds = %block_.L_400e58, %entry
  %89 = phi i64 [ %.pre, %entry ], [ %456, %block_.L_400e58 ]
  ...
  br i1 %125, label %block_400d83, label %block_.L_400e6b
...
block_.L_400d8a:                                  ; preds = %block_.L_400e45, %block_400d83
  %130 = phi i64 [ %.pre3, %block_400d83 ], [ %425, %block_.L_400e45 ]
  %MEMORY.1 = phi %struct.Memory* [ %MEMORY.0, %block_400d83 ], [ %331, %block_.L_400e45 ]
  ...
  br i1 %166, label %block_400d96, label %block_.L_400e58
...
block_400d96:                                     ; preds = %block_.L_400d8a
  ...
  %279 = load i32, i32* bitcast (%G_0x3b9__rip__type* @G_0x3b9__rip_ to i32*), align 8
  %280 = load i32, i32* inttoptr (i64 add (i64 ptrtoint (%G_0x3b9__rip__type* @G_0x3b9__rip_ to i64), i64 4) to i32*), align 4
  %281 = load i32, i32* inttoptr (i64 add (i64 ptrtoint (%G_0x3b9__rip__type* @G_0x3b9__rip_ to i64), i64 8) to i32*), align 8
  %282 = load i32, i32* inttoptr (i64 add (i64 ptrtoint (%G_0x3b9__rip__type* @G_0x3b9__rip_ to i64), i64 12) to i32*), align 4
...
routine_ucomisd_MINUS0x28__rbp____xmm0.exit:      ; preds = %329, %317
  ...
  br i1 %335, label %block_.L_400e45, label %block_400e00
...
block_.L_400e72:                                  ; preds = %block_.L_400e6b, %block_400e00
  %460 = phi i64 [ %.pre5, %block_.L_400e6b ], [ %393, %block_400e00 ]
  %MEMORY.2 = phi %struct.Memory* [ %MEMORY.0, %block_.L_400e6b ], [ %380, %block_400e00 ]
...
block_400478:
  ...
  %5 = load i64, i64* bitcast (%G_0x438__rip__type* @G_0x438__rip_ to i64*), align 8
...
block_400478:
  ...
  %6 = add i64 %5, 7
  store i64 %6, i64* %PC, align 8
  %7 = load i32, i32* bitcast (%G_0x3b9__rip__type* @G_0x3b9__rip_ to i32*), align 8
  %8 = load i32, i32* inttoptr (i64 add (i64 ptrtoint (%G_0x3b9__rip__type* @G_0x3b9__rip_ to i64), i64 4) to i32*), align 4
  %9 = load i32, i32* inttoptr (i64 add (i64 ptrtoint (%G_0x3b9__rip__type* @G_0x3b9__rip_ to i64), i64 8) to i32*), align 8
  %10 = load i32, i32* inttoptr (i64 add (i64 ptrtoint (%G_0x3b9__rip__type* @G_0x3b9__rip_ to i64), i64 12) to i32*), align 4
