; ModuleID = '/tmp/tmp1tsug6hz-query.ll'
...
entry:
  ...
  br i1 %var_2_13122, label %block_400dc3.preheader, label %block_.L_400eb2
...
block_.L_400db7.loopexit:                         ; preds = %block_.L_400db7.loopexit.loopexit, %block_400dc3
  %var_2_137.lcssa = phi i64 [ %var_2_1379, %block_400dc3 ], [ %var_2_137.pre, %block_.L_400db7.loopexit.loopexit ]
  %MEMORY.1.lcssa = phi %struct.Memory* [ %MEMORY.023, %block_400dc3 ], [ %var_2_341, %block_.L_400db7.loopexit.loopexit ]
  %var_2_146.lcssa = phi i32 [ %var_2_14624, %block_400dc3 ], [ %var_2_146, %block_.L_400db7.loopexit.loopexit ]
  %var_2_165.lcssa = phi i32 [ %var_2_16528, %block_400dc3 ], [ %var_2_165, %block_.L_400db7.loopexit.loopexit ]
  ...
  br i1 %var_2_131, label %block_400dc3, label %block_.L_400eb2.loopexit

block_400dc3:                                     ; preds = %block_400dc3.preheader, %block_.L_400db7.loopexit
  %var_2_1379 = phi i64 [ %var_2_137.lcssa, %block_.L_400db7.loopexit ], [ %var_2_966, %block_400dc3.preheader ]
  %MEMORY.023 = phi %struct.Memory* [ %MEMORY.1.lcssa, %block_.L_400db7.loopexit ], [ %2, %block_400dc3.preheader ]
  ...
  br i1 %var_2_17234, label %block_400dd6.preheader, label %block_.L_400db7.loopexit
...
block_400dd6:                                     ; preds = %block_400dd6.preheader, %routine_ucomisd_MINUS0x28__rbp____xmm0.exit.block_.L_400dca_crit_edge
  %MEMORY.136 = phi %struct.Memory* [ %var_2_341, %routine_ucomisd_MINUS0x28__rbp____xmm0.exit.block_.L_400dca_crit_edge ], [ %MEMORY.023, %block_400dd6.preheader ]
  %var_2_13735 = phi i64 [ %var_2_137.pre, %routine_ucomisd_MINUS0x28__rbp____xmm0.exit.block_.L_400dca_crit_edge ], [ %var_2_1379, %block_400dd6.preheader ]
...
routine_ucomisd_MINUS0x28__rbp____xmm0.exit:      ; preds = %var_2_327, %var_2_319, %block_400dd6
  %var_2_341 = phi %struct.Memory* [ %var_2_328, %var_2_327 ], [ %MEMORY.136, %var_2_319 ], [ %MEMORY.136, %block_400dd6 ]
  ...
  br i1 %var_2_345, label %block_400e40, label %routine_ucomisd_MINUS0x28__rbp____xmm0.exit.block_.L_400dca_crit_edge
...
block_.L_400eb2.loopexit:                         ; preds = %block_.L_400db7.loopexit
  br label %block_.L_400eb2

block_.L_400eb2:                                  ; preds = %block_.L_400eb2.loopexit, %block_400e40, %entry
  %MEMORY.2 = phi %struct.Memory* [ %var_2_388, %block_400e40 ], [ %2, %entry ], [ %MEMORY.1.lcssa, %block_.L_400eb2.loopexit ]
