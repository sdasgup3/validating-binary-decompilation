...
declare %struct.Memory* @sub_400b40.kernel_covariance(%struct.State* dereferenceable(3376), i64, %struct.Memory*)

declare %struct.Memory* @sub_400d80.check_FP(%struct.State* dereferenceable(3376), i64, %struct.Memory*)

declare %struct.Memory* @sub_400eb0.print_array(%struct.State* dereferenceable(3376), i64, %struct.Memory*)
