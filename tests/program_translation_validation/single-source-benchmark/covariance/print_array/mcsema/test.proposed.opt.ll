...
block_.L_400eec:                                  ; preds = %block_.L_400f45, %entry
  %124 = phi i64 [ %.pre, %entry ], [ %354, %block_.L_400f45 ]
  %MEMORY.0 = phi %struct.Memory* [ %79, %entry ], [ %316, %block_.L_400f45 ]
  ...
  br i1 %160, label %block_400ef8, label %block_.L_400f67
...
block_.L_400eff:                                  ; preds = %block_400f0b, %block_400ef8
  %165 = phi i64 [ %305, %block_400f0b ], [ %.pre8, %block_400ef8 ]
  ...
  br i1 %201, label %block_400f0b, label %block_.L_400f45
...
block_400f0b:                                     ; preds = %block_.L_400eff
  ...
  %call2_400f32 = tail call %struct.Memory* @sub_400f80.print_element(%struct.State* nonnull %0, i64 %269, %struct.Memory* %MEMORY.0)
