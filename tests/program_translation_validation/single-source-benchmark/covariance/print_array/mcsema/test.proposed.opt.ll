...
block_.L_400ebc:                                  ; preds = %block_.L_400f15, %entry
  %123 = phi i64 [ %.pre, %entry ], [ %356, %block_.L_400f15 ]
  %MEMORY.0 = phi %struct.Memory* [ %79, %entry ], [ %317, %block_.L_400f15 ]
  ...
  br i1 %159, label %block_400ec8, label %block_.L_400f37
...
block_.L_400ecf:                                  ; preds = %block_400edb, %block_400ec8
  %164 = phi i64 [ %.pre1, %block_400ec8 ], [ %306, %block_400edb ]
  ...
  br i1 %200, label %block_400edb, label %block_.L_400f15
...
block_400edb:                                     ; preds = %block_.L_400ecf
  ...
  %call2_400f02 = tail call %struct.Memory* @sub_400f50.print_element(%struct.State* %0, i64 %269, %struct.Memory* %MEMORY.1)
