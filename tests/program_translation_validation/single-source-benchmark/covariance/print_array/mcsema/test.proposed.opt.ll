...
declare %struct.Memory* @sub_400f90.print_element(%struct.State* noalias dereferenceable(3376), i64, %struct.Memory* noalias readnone returned) local_unnamed_addr
...
block_.L_400efc:                                  ; preds = %block_.L_400f55, %entry
  %124 = phi i64 [ %.pre, %entry ], [ %354, %block_.L_400f55 ]
  %MEMORY.0 = phi %struct.Memory* [ %79, %entry ], [ %316, %block_.L_400f55 ]
  ...
  br i1 %160, label %block_400f08, label %block_.L_400f77

block_400f08:                                     ; preds = %block_.L_400efc
  %162 = add i64 %125, -24
  %163 = add i64 %161, 7
...
block_.L_400f0f:                                  ; preds = %block_400f1b, %block_400f08
  %165 = phi i64 [ %305, %block_400f1b ], [ %.pre8, %block_400f08 ]
  ...
  br i1 %201, label %block_400f1b, label %block_.L_400f55

block_400f1b:                                     ; preds = %block_.L_400f0f
  %203 = add i64 %166, -16
  %204 = add i64 %202, 4
  ...
  %call2_400f42 = tail call %struct.Memory* @sub_400f90.print_element(%struct.State* nonnull %0, i64 %269, %struct.Memory* %MEMORY.0)
...
block_.L_400f55:                                  ; preds = %block_.L_400f0f
  %306 = add i64 %166, -32
  %307 = add i64 %202, 4
...
block_.L_400f77:                                  ; preds = %block_.L_400efc
  %355 = add i64 %125, -32
  %356 = add i64 %161, 4
