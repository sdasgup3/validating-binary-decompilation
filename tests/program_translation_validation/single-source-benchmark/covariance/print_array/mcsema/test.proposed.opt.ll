...
declare %struct.Memory* @sub_400f80.print_element(%struct.State* dereferenceable(3376), i64, %struct.Memory*) local_unnamed_addr
...
entry:
  ...
  %call2_400ecb = tail call %struct.Memory* @sub_400640.malloc_plt(%struct.State* %0, i64 %74, %struct.Memory* %2)
...
block_.L_400eec:                                  ; preds = %block_.L_400f45, %entry
  %123 = phi i64 [ %.pre, %entry ], [ %352, %block_.L_400f45 ]
  %MEMORY.0 = phi %struct.Memory* [ %call2_400ecb, %entry ], [ %call2_400f51, %block_.L_400f45 ]
  ...
  br i1 %159, label %block_400ef8, label %block_.L_400f67
...
block_.L_400eff:                                  ; preds = %block_400f0b, %block_400ef8
  %164 = phi i64 [ %.pre8, %block_400ef8 ], [ %304, %block_400f0b ]
  %MEMORY.1 = phi %struct.Memory* [ %MEMORY.0, %block_400ef8 ], [ %call2_400f32, %block_400f0b ]
  ...
  br i1 %200, label %block_400f0b, label %block_.L_400f45

block_400f0b:                                     ; preds = %block_.L_400eff
  %202 = add i64 %165, -16
  %203 = add i64 %201, 4
  ...
  %call2_400f32 = tail call %struct.Memory* @sub_400f80.print_element(%struct.State* nonnull %0, i64 %268, %struct.Memory* %MEMORY.1)
...
block_.L_400f45:                                  ; preds = %block_.L_400eff
  %305 = add i64 %165, -32
  %306 = add i64 %201, 4
  ...
  %call2_400f51 = tail call %struct.Memory* @sub_400610.fputs_plt(%struct.State* nonnull %0, i64 %310, %struct.Memory* %MEMORY.1)
...
block_.L_400f67:                                  ; preds = %block_.L_400eec
  %353 = add i64 %124, -32
  %354 = add i64 %160, 4
  ...
  %call2_400f6b = tail call %struct.Memory* @sub_4005f0.free_plt(%struct.State* nonnull %0, i64 %357, %struct.Memory* %MEMORY.0)
  ...
  ret %struct.Memory* %call2_400f6b
}
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_jge_.L_400f67(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i8* nocapture %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_jge_.L_400f45(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i8* nocapture %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 2, i32 9
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_jmpq_.L_400eff(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
