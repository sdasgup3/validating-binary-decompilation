...
declare %struct.Memory* @sub_400f50.print_element(%struct.State* noalias dereferenceable(3376), i64, %struct.Memory* noalias readnone returned) local_unnamed_addr
...
block_.L_400ebc:                                  ; preds = %block_.L_400f15, %entry
  %117 = phi i64 [ %.pre, %entry ], [ %348, %block_.L_400f15 ]
  %MEMORY.0 = phi %struct.Memory* [ %73, %entry ], [ %310, %block_.L_400f15 ]
  ...
  br i1 %153, label %block_400ec8, label %block_.L_400f37
...
block_.L_400ecf:                                  ; preds = %block_400edb, %block_400ec8
  %158 = phi i64 [ %.pre1, %block_400ec8 ], [ %299, %block_400edb ]
  %MEMORY.1 = phi %struct.Memory* [ %MEMORY.0, %block_400ec8 ], [ %call2_400f02, %block_400edb ]
  ...
  br i1 %194, label %block_400edb, label %block_.L_400f15

block_400edb:                                     ; preds = %block_.L_400ecf
  %196 = add i64 %159, -16
  %197 = add i64 %195, 4
  ...
  %call2_400f02 = tail call %struct.Memory* @sub_400f50.print_element(%struct.State* %0, i64 %263, %struct.Memory* %MEMORY.1)
...
block_.L_400f15:                                  ; preds = %block_.L_400ecf
  %300 = add i64 %159, -32
  %301 = add i64 %195, 4
...
block_.L_400f37:                                  ; preds = %block_.L_400ebc
  %349 = add i64 %118, -32
  %350 = add i64 %154, 4
...
define %struct.Memory* @routine_jge_.L_400f15(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i8* %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 2, i32 9
...
define %struct.Memory* @routine_jmpq_.L_400ecf(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
...
define %struct.Memory* @routine_jmpq_.L_400ebc(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
