; ModuleID = '/tmp/tmprl856chm-query.ll'
...
entry:
  ...
  br i1 %var_2_16034, label %block_400f08.preheader, label %block_.L_400f77

block_400f08.preheader:                           ; preds = %entry
  br label %block_400f08

block_400f08:                                     ; preds = %block_400f08.preheader, %block_.L_400f55
  %var_2_175 = phi i32 [ %var_2_134, %block_.L_400f55 ], [ %var_2_13424, %block_400f08.preheader ]
  %var_2_1661 = phi i64 [ %var_2_125, %block_.L_400f55 ], [ %var_2_12518, %block_400f08.preheader ]
  %MEMORY.035 = phi %struct.Memory* [ %var_2_316, %block_.L_400f55 ], [ %var_2_79, %block_400f08.preheader ]
  ...
  br i1 %var_2_20117, label %block_400f1b.preheader, label %block_.L_400f55

block_400f1b.preheader:                           ; preds = %block_400f08
  br label %block_400f1b

block_400f1b:                                     ; preds = %block_400f1b.preheader, %block_400f1b
  br label %block_400f1b

block_.L_400f55:                                  ; preds = %block_400f08
  ...
  br i1 %var_2_160, label %block_400f08, label %block_.L_400f77.loopexit

block_.L_400f77.loopexit:                         ; preds = %block_.L_400f55
  br label %block_.L_400f77

block_.L_400f77:                                  ; preds = %block_.L_400f77.loopexit, %entry
  %MEMORY.0.lcssa = phi %struct.Memory* [ %var_2_79, %entry ], [ %var_2_316, %block_.L_400f77.loopexit ]
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_jge_.L_400f77(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i8* nocapture %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_jge_.L_400f55(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i8* nocapture %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 2, i32 9
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_jmpq_.L_400f0f(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_jmpq_.L_400efc(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
