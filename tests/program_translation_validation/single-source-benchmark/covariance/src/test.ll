; ModuleID = '/home/sdasgup3/Github/validating-binary-decompilation/tests/program_translation_validation/single-source-benchmark/bc-seeds/covariance/covariance.bc'
...
entry:
  ...
  call void @kernel_covariance(i32 %7, i32 %8, double %9, [1000 x double]* %arraydecay4, [1000 x double]* %arraydecay5, double* %arraydecay6)
  %13 = load i32, i32* %m, align 4
  %14 = load i32, i32* %n, align 4
  %15 = load [1000 x [1000 x double]]*, [1000 x [1000 x double]]** %data, align 8
  %arraydecay7 = getelementptr inbounds [1000 x [1000 x double]], [1000 x [1000 x double]]* %15, i32 0, i32 0
  call void @init_array(i32 %13, i32 %14, double* %float_n, [1000 x double]* %arraydecay7)
  %16 = load i32, i32* %m, align 4
  %17 = load i32, i32* %n, align 4
  %18 = load double, double* %float_n, align 8
  %19 = load [1000 x [1000 x double]]*, [1000 x [1000 x double]]** %data, align 8
  %arraydecay8 = getelementptr inbounds [1000 x [1000 x double]], [1000 x [1000 x double]]* %19, i32 0, i32 0
  %20 = load [1000 x [1000 x double]]*, [1000 x [1000 x double]]** %symmat_StrictFP, align 8
  %arraydecay9 = getelementptr inbounds [1000 x [1000 x double]], [1000 x [1000 x double]]* %20, i32 0, i32 0
  %21 = load [1000 x double]*, [1000 x double]** %mean, align 8
  %arraydecay10 = getelementptr inbounds [1000 x double], [1000 x double]* %21, i32 0, i32 0
  call void @kernel_covariance(i32 %16, i32 %17, double %18, [1000 x double]* %arraydecay8, [1000 x double]* %arraydecay9, double* %arraydecay10)
  %22 = load i32, i32* %m, align 4
  %23 = load [1000 x [1000 x double]]*, [1000 x [1000 x double]]** %symmat, align 8
  %arraydecay11 = getelementptr inbounds [1000 x [1000 x double]], [1000 x [1000 x double]]* %23, i32 0, i32 0
  %24 = load [1000 x [1000 x double]]*, [1000 x [1000 x double]]** %symmat_StrictFP, align 8
  %arraydecay12 = getelementptr inbounds [1000 x [1000 x double]], [1000 x [1000 x double]]* %24, i32 0, i32 0
  %call13 = call i32 @check_FP(i32 %22, [1000 x double]* %arraydecay11, [1000 x double]* %arraydecay12)
...
if.end:                                           ; preds = %entry
  ...
  %26 = load [1000 x [1000 x double]]*, [1000 x [1000 x double]]** %symmat_StrictFP, align 8
  %arraydecay14 = getelementptr inbounds [1000 x [1000 x double]], [1000 x [1000 x double]]* %26, i32 0, i32 0
  call void @print_array(i32 %25, [1000 x double]* %arraydecay14)
  %27 = load [1000 x [1000 x double]]*, [1000 x [1000 x double]]** %data, align 8
  %28 = bitcast [1000 x [1000 x double]]* %27 to i8*
  call void @free(i8* %28) #5
  %29 = load [1000 x [1000 x double]]*, [1000 x [1000 x double]]** %symmat, align 8
  %30 = bitcast [1000 x [1000 x double]]* %29 to i8*
  call void @free(i8* %30) #5
  %31 = load [1000 x [1000 x double]]*, [1000 x [1000 x double]]** %symmat_StrictFP, align 8
  %32 = bitcast [1000 x [1000 x double]]* %31 to i8*
  call void @free(i8* %32) #5
  %33 = load [1000 x double]*, [1000 x double]** %mean, align 8
  %34 = bitcast [1000 x double]* %33 to i8*
...
for.body3:                                        ; preds = %for.cond1
  ...
  %5 = load [1000 x double]*, [1000 x double]** %data.addr, align 8
  %6 = load i32, i32* %i, align 4
  %idxprom = sext i32 %6 to i64
  %arrayidx = getelementptr inbounds [1000 x double], [1000 x double]* %5, i64 %idxprom
...
for.body20:                                       ; preds = %for.cond18
  ...
  %26 = load [1000 x double]*, [1000 x double]** %data.addr, align 8
  %27 = load i32, i32* %i, align 4
  %idxprom23 = sext i32 %27 to i64
  %arrayidx24 = getelementptr inbounds [1000 x double], [1000 x double]* %26, i64 %idxprom23
...
for.cond33:                                       ; preds = %for.inc73, %for.end32
  ...
  br i1 %cmp34, label %for.body35, label %for.end75
...
for.body38:                                       ; preds = %for.cond36
  %37 = load [1000 x double]*, [1000 x double]** %symmat.addr, align 8
  %38 = load i32, i32* %j1, align 4
  %idxprom39 = sext i32 %38 to i64
  %arrayidx40 = getelementptr inbounds [1000 x double], [1000 x double]* %37, i64 %idxprom39
...
for.body45:                                       ; preds = %for.cond43
  %42 = load [1000 x double]*, [1000 x double]** %data.addr, align 8
  %43 = load i32, i32* %i, align 4
  %idxprom46 = sext i32 %43 to i64
  %arrayidx47 = getelementptr inbounds [1000 x double], [1000 x double]* %42, i64 %idxprom46
  ...
  %46 = load [1000 x double]*, [1000 x double]** %data.addr, align 8
  %47 = load i32, i32* %i, align 4
  %idxprom50 = sext i32 %47 to i64
  %arrayidx51 = getelementptr inbounds [1000 x double], [1000 x double]* %46, i64 %idxprom50
  ...
  %50 = load [1000 x double]*, [1000 x double]** %symmat.addr, align 8
  %51 = load i32, i32* %j1, align 4
  %idxprom54 = sext i32 %51 to i64
  %arrayidx55 = getelementptr inbounds [1000 x double], [1000 x double]* %50, i64 %idxprom54
...
for.end61:                                        ; preds = %for.cond43
  %55 = load [1000 x double]*, [1000 x double]** %symmat.addr, align 8
  %56 = load i32, i32* %j1, align 4
  %idxprom62 = sext i32 %56 to i64
  %arrayidx63 = getelementptr inbounds [1000 x double], [1000 x double]* %55, i64 %idxprom62
  %57 = load i32, i32* %j2, align 4
  %idxprom64 = sext i32 %57 to i64
  %arrayidx65 = getelementptr inbounds [1000 x double], [1000 x double]* %arrayidx63, i64 0, i64 %idxprom64
  %58 = load double, double* %arrayidx65, align 8
  %59 = load [1000 x double]*, [1000 x double]** %symmat.addr, align 8
  %60 = load i32, i32* %j2, align 4
  %idxprom66 = sext i32 %60 to i64
  %arrayidx67 = getelementptr inbounds [1000 x double], [1000 x double]* %59, i64 %idxprom66
  %61 = load i32, i32* %j1, align 4
  %idxprom68 = sext i32 %61 to i64
  %arrayidx69 = getelementptr inbounds [1000 x double], [1000 x double]* %arrayidx67, i64 0, i64 %idxprom68
