...
; Function Attrs: noinline nounwind optnone uwtable
define void @closeFiles(%struct._IO_FILE*, %struct._IO_FILE*, %struct._IO_FILE*) #0 {
...
; <label>:13:                                     ; preds = %3
  call void @errorMessage(i8* getelementptr inbounds ([25 x i8], [25 x i8]* @.str.70, i32 0, i32 0), i8 signext 0)
...
; <label>:20:                                     ; preds = %14
  call void @errorMessage(i8* getelementptr inbounds ([26 x i8], [26 x i8]* @.str.1.71, i32 0, i32 0), i8 signext 0)
  call void @errorMessage(i8* getelementptr inbounds ([11 x i8], [11 x i8]* @closeFiles.name, i32 0, i32 0), i8 signext 1)
  br label %21
...
; <label>:27:                                     ; preds = %21
  call void @errorMessage(i8* getelementptr inbounds ([26 x i8], [26 x i8]* @.str.2.72, i32 0, i32 0), i8 signext 0)
  call void @errorMessage(i8* getelementptr inbounds ([11 x i8], [11 x i8]* @closeFiles.name, i32 0, i32 0), i8 signext 1)
  br label %28
