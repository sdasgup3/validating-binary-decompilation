...
define void @deleteDataObject(%struct.DataObject*) #1 {
...
; <label>:29:                                     ; preds = %25
  %30 = load %struct.DataObject*, %struct.DataObject** %2, align 8
  %31 = getelementptr inbounds %struct.DataObject, %struct.DataObject* %30, i32 0, i32 1
  %32 = load %struct.DataObjectAttribute*, %struct.DataObjectAttribute** %31, align 8
  %33 = load i64, i64* %3, align 8
  %34 = getelementptr inbounds %struct.DataObjectAttribute, %struct.DataObjectAttribute* %32, i64 %33
  %35 = getelementptr inbounds %struct.DataObjectAttribute, %struct.DataObjectAttribute* %34, i32 0, i32 0
  %36 = bitcast %union.anon.2* %35 to i8**
  %37 = load i8*, i8** %36, align 8
  %38 = icmp ne i8* %37, null
  br i1 %38, label %39, label %48

; <label>:39:                                     ; preds = %29
  %40 = load %struct.DataObject*, %struct.DataObject** %2, align 8
  ...
  %44 = getelementptr inbounds %struct.DataObjectAttribute, %struct.DataObjectAttribute* %42, i64 %43
  %45 = getelementptr inbounds %struct.DataObjectAttribute, %struct.DataObjectAttribute* %44, i32 0, i32 0
  %46 = bitcast %union.anon.2* %45 to i8**
...
; <label>:52:                                     ; preds = %25
  %53 = load %struct.DataObject*, %struct.DataObject** %2, align 8
  ...
  %56 = bitcast %struct.DataObjectAttribute* %55 to i8*
  call void @free(i8* %56) #2
  %57 = load %struct.DataObject*, %struct.DataObject** %2, align 8
  %58 = bitcast %struct.DataObject* %57 to i8*
