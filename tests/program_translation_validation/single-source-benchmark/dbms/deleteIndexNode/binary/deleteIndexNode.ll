...
define void @deleteIndexNode(%struct.IndexNode*) #0 {
  ...
  %6 = getelementptr inbounds %struct.IndexNode, %struct.IndexNode* %5, i32 0, i32 1
  %7 = load %struct.IndexEntry*, %struct.IndexEntry** %6, align 8
  store %struct.IndexEntry* %7, %struct.IndexEntry** %3, align 8
  br label %8

; <label>:8:                                      ; preds = %11, %1
  %9 = load %struct.IndexEntry*, %struct.IndexEntry** %3, align 8
  %10 = icmp ne %struct.IndexEntry* %9, null
  br i1 %10, label %11, label %20

; <label>:11:                                     ; preds = %8
  %12 = load %struct.IndexEntry*, %struct.IndexEntry** %3, align 8
  %13 = getelementptr inbounds %struct.IndexEntry, %struct.IndexEntry* %12, i32 0, i32 2
  %14 = load %struct.IndexEntry*, %struct.IndexEntry** %13, align 8
  store %struct.IndexEntry* %14, %struct.IndexEntry** %4, align 8
  %15 = load %struct.IndexEntry*, %struct.IndexEntry** %3, align 8
  %16 = load %struct.IndexNode*, %struct.IndexNode** %2, align 8
  %17 = getelementptr inbounds %struct.IndexNode, %struct.IndexNode* %16, i32 0, i32 0
  %18 = load i64, i64* %17, align 8
  call void @deleteIndexEntry(%struct.IndexEntry* %15, i64 %18)
  %19 = load %struct.IndexEntry*, %struct.IndexEntry** %4, align 8
  store %struct.IndexEntry* %19, %struct.IndexEntry** %3, align 8
  br label %8

; <label>:20:                                     ; preds = %8
  %21 = load %struct.IndexNode*, %struct.IndexNode** %2, align 8
  %22 = bitcast %struct.IndexNode* %21 to i8*
