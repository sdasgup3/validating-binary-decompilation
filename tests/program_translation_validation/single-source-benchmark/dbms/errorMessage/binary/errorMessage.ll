...
define void @errorMessage(i8*, i8 signext) #3 {
  %3 = alloca i8*, align 8
  %4 = alloca i8, align 1
...
; <label>:13:                                     ; preds = %9
  ...
  %15 = call i32 (%struct._IO_FILE*, i8*, ...) @fprintf(%struct._IO_FILE* %14, i8* getelementptr inbounds ([46 x i8], [46 x i8]* @.str.40, i32 0, i32 0))
  %16 = load %struct._IO_FILE*, %struct._IO_FILE** @stderr, align 8
  %17 = load i8*, i8** %3, align 8
  %18 = call i32 (%struct._IO_FILE*, i8*, ...) @fprintf(%struct._IO_FILE* %16, i8* getelementptr inbounds ([17 x i8], [17 x i8]* @.str.1.41, i32 0, i32 0), i8* %17)
  br label %22

; <label>:19:                                     ; preds = %9
  %20 = load i8*, i8** %3, align 8
  %21 = call i8* @strcpy(i8* getelementptr inbounds ([1024 x i8], [1024 x i8]* @errorBuffer, i32 0, i32 0), i8* %20) #5
  br label %22
...
; <label>:23:                                     ; preds = %2
  %24 = call i64 @strlen(i8* getelementptr inbounds ([1024 x i8], [1024 x i8]* @errorBuffer, i32 0, i32 0)) #4
...
; <label>:29:                                     ; preds = %23
  ...
  %31 = call i32 (%struct._IO_FILE*, i8*, ...) @fprintf(%struct._IO_FILE* %30, i8* getelementptr inbounds ([37 x i8], [37 x i8]* @.str.2.42, i32 0, i32 0))
  %32 = load %struct._IO_FILE*, %struct._IO_FILE** @stderr, align 8
  %33 = load i8*, i8** %3, align 8
  %34 = call i32 (%struct._IO_FILE*, i8*, ...) @fprintf(%struct._IO_FILE* %32, i8* getelementptr inbounds ([21 x i8], [21 x i8]* @.str.3.43, i32 0, i32 0), i8* %33, i8* getelementptr inbounds ([1024 x i8], [1024 x i8]* @errorBuffer, i32 0, i32 0))
  call void @errorMessage(i8* getelementptr inbounds ([12 x i8], [12 x i8]* @.str.4.44, i32 0, i32 0), i8 signext 0)
  br label %45

; <label>:35:                                     ; preds = %23
  %36 = getelementptr inbounds [1024 x i8], [1024 x i8]* %5, i32 0, i32 0
  %37 = load i8*, i8** %3, align 8
  %38 = call i8* @strcpy(i8* %36, i8* %37) #5
  %39 = getelementptr inbounds [1024 x i8], [1024 x i8]* %5, i32 0, i32 0
  %40 = call i8* @strcat(i8* %39, i8* getelementptr inbounds ([3 x i8], [3 x i8]* @.str.5.45, i32 0, i32 0)) #5
  %41 = getelementptr inbounds [1024 x i8], [1024 x i8]* %5, i32 0, i32 0
  %42 = call i8* @strcat(i8* %41, i8* getelementptr inbounds ([1024 x i8], [1024 x i8]* @errorBuffer, i32 0, i32 0)) #5
  %43 = getelementptr inbounds [1024 x i8], [1024 x i8]* %5, i32 0, i32 0
  %44 = call i8* @strcpy(i8* getelementptr inbounds ([1024 x i8], [1024 x i8]* @errorBuffer, i32 0, i32 0), i8* %43) #5
  br label %45
