...
define void @flushOutputBuffer() #1 {
  %1 = call i64 @strlen(i8* getelementptr inbounds ([88967 x i8], [88967 x i8]* @outputBuffer, i32 0, i32 0)) #3
  %2 = icmp ugt i64 %1, 0
  br i1 %2, label %3, label %8

; <label>:3:                                      ; preds = %0
  %4 = load %struct._IO_FILE*, %struct._IO_FILE** @outputFile, align 8
  %5 = call i32 (%struct._IO_FILE*, i8*, ...) @fprintf(%struct._IO_FILE* %4, i8* getelementptr inbounds ([3 x i8], [3 x i8]* @.str.3.16, i32 0, i32 0), i8* getelementptr inbounds ([88967 x i8], [88967 x i8]* @outputBuffer, i32 0, i32 0))
