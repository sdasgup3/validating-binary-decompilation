...
define i64 @getFloat(%struct._IO_FILE*, float*) #1 {
...
; <label>:12:                                     ; preds = %2
  ...
  %14 = call double @strtod(i8* %13, i8** %6) #4
...
; <label>:29:                                     ; preds = %25
  ...
  store float 0xC7EFFFFFE0000000, float* %30, align 4
  store i64 3, i64* %7, align 8
  br label %48

; <label>:31:                                     ; preds = %25, %21, %12
  %32 = load float*, float** %4, align 8
  %33 = load float, float* %32, align 4
  %34 = fpext float %33 to double
  %35 = fcmp olt double %34, 0xC7EFFFFFE091FF3D
  br i1 %35, label %36, label %38

; <label>:36:                                     ; preds = %31
  %37 = load float*, float** %4, align 8
  store float 0xC7EFFFFFE0000000, float* %37, align 4
...
; <label>:38:                                     ; preds = %31
  ...
  %42 = fcmp ogt double %41, 0x47EFFFFFE091FF3D
...
; <label>:49:                                     ; preds = %2
  ...
  store float 0xC7EFFFFFE0000000, float* %50, align 4
