...
define i64 @getInitCommand(%struct._IO_FILE*, i64*) #0 {
  ...
  %8 = call i64 @getInt(%struct._IO_FILE* %6, i64* %7)
...
; <label>:15:                                     ; preds = %11
  call void @errorMessage(i8* getelementptr inbounds ([22 x i8], [22 x i8]* @.str.32, i32 0, i32 0), i8 signext 0)
...
; <label>:21:                                     ; preds = %18
  call void @errorMessage(i8* getelementptr inbounds ([28 x i8], [28 x i8]* @.str.1.33, i32 0, i32 0), i8 signext 0)
  call void @errorMessage(i8* getelementptr inbounds ([15 x i8], [15 x i8]* @getInitCommand.name, i32 0, i32 0), i8 signext 1)
...
; <label>:29:                                     ; preds = %26
  call void @errorMessage(i8* getelementptr inbounds ([41 x i8], [41 x i8]* @.str.2.34, i32 0, i32 0), i8 signext 0)
  call void @errorMessage(i8* getelementptr inbounds ([15 x i8], [15 x i8]* @getInitCommand.name, i32 0, i32 0), i8 signext 1)
