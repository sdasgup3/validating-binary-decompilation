...
declare i64 @getFloat(%struct._IO_FILE*, float*) #0

; Function Attrs: noinline nounwind optnone uwtable
declare void @errorMessage(i8*, i8 signext) #0

; Function Attrs: noinline nounwind optnone uwtable
define i64 @getKeyAttribute(%struct._IO_FILE*, float*) #0 {
  ...
  %8 = call i64 @getFloat(%struct._IO_FILE* %6, float* %7)
