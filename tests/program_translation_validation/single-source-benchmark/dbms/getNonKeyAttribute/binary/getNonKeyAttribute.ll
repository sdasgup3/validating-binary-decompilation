; ModuleID = 'getNonKeyAttribute.bc'
...
define i64 @getNonKeyAttribute(%struct._IO_FILE*, i8**) #2 {
  ...
  %8 = call i8* @getString(%struct._IO_FILE* %7)
...
; <label>:22:                                     ; preds = %13
  call void @errorMessage(i8* getelementptr inbounds ([19 x i8], [19 x i8]* @.str.37, i32 0, i32 0), i8 signext 0)
  call void @errorMessage(i8* getelementptr inbounds ([19 x i8], [19 x i8]* @getNonKeyAttribute.name, i32 0, i32 0), i8 signext 1)
