...
; Function Attrs: noinline nounwind optnone uwtable
define float @penalty(%struct.IndexEntry* byval align 8, %struct.IndexEntry* byval align 8) #0 {
  ...
  %7 = call float @volume(%struct.IndexKey* byval align 8 %4)
  %8 = getelementptr inbounds %struct.IndexEntry, %struct.IndexEntry* %0, i32 0, i32 1
  %9 = call float @volume(%struct.IndexKey* byval align 8 %8)
  %10 = fsub float %7, %9
