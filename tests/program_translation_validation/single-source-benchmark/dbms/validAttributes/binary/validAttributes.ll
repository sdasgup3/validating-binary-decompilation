...
; Function Attrs: noinline nounwind optnone uwtable
define signext i8 @validAttributes(%struct.DataAttribute*) #0 {
  %2 = alloca i8, align 1
...
; <label>:19:                                     ; preds = %14, %9
  call void @errorMessage(i8* getelementptr inbounds ([23 x i8], [23 x i8]* @.str.4.129, i32 0, i32 0), i8 signext 0)
...
; <label>:30:                                     ; preds = %25
  ...
  %34 = bitcast %union.anon.2* %33 to float*
...
; <label>:38:                                     ; preds = %30
  ...
  %42 = bitcast %union.anon.2* %41 to float*
...
; <label>:46:                                     ; preds = %38, %30
  call void @errorMessage(i8* getelementptr inbounds ([23 x i8], [23 x i8]* @.str.5.130, i32 0, i32 0), i8 signext 0)
  call void @errorMessage(i8* getelementptr inbounds ([16 x i8], [16 x i8]* @validAttributes.name, i32 0, i32 0), i8 signext 1)
  store i8 0, i8* %2, align 1
  br label %64
...
; <label>:48:                                     ; preds = %25, %20
  ...
  %52 = bitcast %union.anon.2* %51 to i8**
  %53 = load i8*, i8** %52, align 8
  %54 = icmp eq i8* %53, null
  br i1 %54, label %55, label %56

; <label>:55:                                     ; preds = %48
  call void @errorMessage(i8* getelementptr inbounds ([26 x i8], [26 x i8]* @.str.6.131, i32 0, i32 0), i8 signext 0)
  call void @errorMessage(i8* getelementptr inbounds ([16 x i8], [16 x i8]* @validAttributes.name, i32 0, i32 0), i8 signext 1)
  store i8 0, i8* %2, align 1
  br label %64
