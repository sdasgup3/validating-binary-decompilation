; ModuleID = '/tmp/tmptxx71s2c-query.ll'
...
entry:
  ...
  %var_2_93 = tail call %struct.Memory* @__remill_function_call(%struct.State* %0, i64 ptrtoint (i64 (i64)* @malloc to i64), %struct.Memory* %2)
  %var_2_13936 = load i64, i64* %RBP.i, align 8
  %var_2_14037 = add i64 %var_2_13936, -28
  %var_2_14238 = inttoptr i64 %var_2_14037 to i32*
  %var_2_14339 = load i32, i32* %var_2_14238, align 4
  %var_2_14540 = add i64 %var_2_13936, -4
  %var_2_14741 = inttoptr i64 %var_2_14540 to i32*
  %var_2_14842 = load i32, i32* %var_2_14741, align 4
  %var_2_14943 = sub i32 %var_2_14339, %var_2_14842
  %var_2_16444 = lshr i32 %var_2_14943, 31
  %var_2_16645 = lshr i32 %var_2_14339, 31
  %var_2_16746 = lshr i32 %var_2_14842, 31
  %var_2_16847 = xor i32 %var_2_16746, %var_2_16645
  %var_2_16948 = xor i32 %var_2_16444, %var_2_16645
  %var_2_17049 = add nuw nsw i32 %var_2_16948, %var_2_16847
  %var_2_17150 = icmp eq i32 %var_2_17049, 2
  %var_2_17351 = icmp ne i32 %var_2_16444, 0
  %var_2_17452 = xor i1 %var_2_17351, %var_2_17150
  br i1 %var_2_17452, label %block_40115e.preheader, label %block_.L_4011fb

block_40115e.preheader:                           ; preds = %entry
  br label %block_40115e

block_40115e:                                     ; preds = %block_40115e.preheader, %block_.L_4011d9
  %var_2_2211 = phi i64 [ %var_2_139, %block_.L_4011d9 ], [ %var_2_13936, %block_40115e.preheader ]
  %MEMORY.053 = phi %struct.Memory* [ %var_2_436, %block_.L_4011d9 ], [ %var_2_93, %block_40115e.preheader ]
  %var_2_18119 = add i64 %var_2_2211, -32
  %var_2_18320 = inttoptr i64 %var_2_18119 to i32*
  %var_2_18421 = load i32, i32* %var_2_18320, align 4
  %var_2_18622 = add i64 %var_2_2211, -8
  %var_2_18823 = inttoptr i64 %var_2_18622 to i32*
  %var_2_18924 = load i32, i32* %var_2_18823, align 4
  ...
  %var_2_20929 = xor i32 %var_2_20828, %var_2_20727
  ...
  br i1 %var_2_21534, label %block_401171.preheader, label %block_.L_4011d9

block_401171.preheader:                           ; preds = %block_40115e
  %var_2_2222 = add i64 %var_2_2211, -36
  %var_2_2243 = inttoptr i64 %var_2_2222 to i32*
  %var_2_2254 = load i32, i32* %var_2_2243, align 4
  %var_2_2275 = add i64 %var_2_2211, -12
  %var_2_2296 = inttoptr i64 %var_2_2275 to i32*
  %var_2_2307 = load i32, i32* %var_2_2296, align 4
  %var_2_2318 = sub i32 %var_2_2254, %var_2_2307
  %var_2_2469 = lshr i32 %var_2_2318, 31
  %var_2_24810 = lshr i32 %var_2_2254, 31
  %var_2_24911 = lshr i32 %var_2_2307, 31
  %var_2_25012 = xor i32 %var_2_24911, %var_2_24810
  %var_2_25113 = xor i32 %var_2_2469, %var_2_24810
  %var_2_25214 = add nuw nsw i32 %var_2_25113, %var_2_25012
  %var_2_25315 = icmp eq i32 %var_2_25214, 2
  %var_2_25516 = icmp ne i32 %var_2_2469, 0
  %var_2_25617 = xor i1 %var_2_25516, %var_2_25315
  br i1 %var_2_25617, label %block_401184.us.preheader, label %block_401171.preheader9

block_401171.preheader9:                          ; preds = %block_401171.preheader
  br label %block_401171

block_401184.us.preheader:                        ; preds = %block_401171.preheader
  br label %block_401184.us

block_401184.us:                                  ; preds = %block_401184.us.preheader, %block_401184.us
  br label %block_401184.us

block_401171:                                     ; preds = %block_401171.preheader9, %block_401171
  br label %block_401171

block_.L_4011d9:                                  ; preds = %block_40115e
  %var_2_436 = tail call %struct.Memory* @__remill_function_call(%struct.State* nonnull %0, i64 ptrtoint (i64 (i64, i64)* @fputs to i64), %struct.Memory* %MEMORY.053)
  %var_2_139 = load i64, i64* %RBP.i, align 8
  %var_2_140 = add i64 %var_2_139, -28
  ...
  br i1 %var_2_174, label %block_40115e, label %block_.L_4011fb.loopexit

block_.L_4011fb.loopexit:                         ; preds = %block_.L_4011d9
  br label %block_.L_4011fb

block_.L_4011fb:                                  ; preds = %block_.L_4011fb.loopexit, %entry
...
; Function Attrs: alwaysinline norecurse nounwind
define %struct.Memory* @routine_jge_.L_4011fb(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i8* nocapture %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
...
; Function Attrs: alwaysinline norecurse nounwind
define %struct.Memory* @routine_jge_.L_4011d9(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i8* nocapture %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 2, i32 9
...
; Function Attrs: alwaysinline norecurse nounwind
define %struct.Memory* @routine_jge_.L_4011c6(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i8* nocapture %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 2, i32 9
...
; Function Attrs: alwaysinline norecurse nounwind
define %struct.Memory* @routine_jmpq_.L_4011cb(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
...
; Function Attrs: alwaysinline norecurse nounwind
define %struct.Memory* @routine_jmpq_.L_401165(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
...
; Function Attrs: alwaysinline norecurse nounwind
define %struct.Memory* @routine_jmpq_.L_401152(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
