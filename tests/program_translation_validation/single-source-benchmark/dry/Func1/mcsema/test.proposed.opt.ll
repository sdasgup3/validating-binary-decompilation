...
entry:
  ...
  br i1 %77, label %block_.L_400ba8, label %block_400b9c
...
block_.L_400baf:                                  ; preds = %block_.L_400ba8, %block_400b9c
  %97 = phi i64 [ %.pre, %block_.L_400ba8 ], [ %96, %block_400b9c ]
...
define %struct.Memory* @routine_je_.L_400ba8(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i8* %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
...
define %struct.Memory* @routine_jmpq_.L_400baf(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
