...
block_.L_400937:                                  ; preds = %block_.L_400979, %entry
  %55 = phi i64 [ %.pre, %entry ], [ %186, %block_.L_400979 ]
...
block_400941:                                     ; preds = %block_.L_400937
  ...
  %call2_40095e = tail call %struct.Memory* @sub_400b70.Func1(%struct.State* %0, i64 %134, %struct.Memory* %MEMORY.0)
  ...
  %.v5 = select i1 %146, i64 9, i64 22
  %150 = add i64 %140, %.v5
  store i64 %150, i64* %3, align 8
  br i1 %146, label %block_40096c, label %block_.L_400979
...
block_40096c:                                     ; preds = %block_400941
  ...
  store i64 %162, i64* %RAX.i88, align 8
...
block_.L_400979:                                  ; preds = %block_400941, %block_40096c
  %185 = phi i64 [ %.pre1, %block_40096c ], [ %150, %block_400941 ]
  %186 = add i64 %185, -66
...
block_.L_40097e:                                  ; preds = %block_.L_400937
  ...
  store i64 %192, i64* %RAX.i88, align 8
  ...
  %217 = xor i1 %216, %214
  %.v6 = select i1 %217, i64 33, i64 13
  %218 = add i64 %84, %.v6
  store i64 %218, i64* %3, align 8
  br i1 %217, label %block_.L_40099f, label %block_40098b
...
block_40098b:                                     ; preds = %block_.L_40097e
  ...
  store i64 %222, i64* %RAX.i88, align 8
...
block_.L_40099f:                                  ; preds = %block_40098b, %block_400998, %block_.L_40097e
  %250 = phi i64 [ %.pre3, %block_400998 ], [ %248, %block_40098b ], [ %218, %block_.L_40097e ]
  %251 = phi i64 [ %.pre2, %block_400998 ], [ %56, %block_40098b ], [ %56, %block_.L_40097e ]
  %252 = add i64 %251, -29
  %253 = add i64 %250, 4
  ...
  store i64 %257, i64* %RAX.i88, align 8
  ...
  %.v9 = select i1 %272, i64 13, i64 25
  %281 = add i64 %250, %.v9
  store i64 %281, i64* %3, align 8
  br i1 %272, label %block_4009ac, label %block_.L_4009b8
...
block_.L_4009b8:                                  ; preds = %block_.L_40099f
  ...
  %300 = tail call %struct.Memory* @__remill_function_call(%struct.State* %0, i64 ptrtoint (i64 (i64, i64)* @strcmp to i64), %struct.Memory* %MEMORY.0)
  ...
  %313 = or i1 %308, %312
  %.v10 = select i1 %313, i64 30, i64 9
  %314 = add i64 %302, %.v10
  store i64 %314, i64* %3, align 8
  %315 = load i64, i64* %RBP.i, align 8
  br i1 %313, label %block_.L_4009e3, label %block_4009ce
...
block_4009ce:                                     ; preds = %block_.L_4009b8
  ...
  store i64 %321, i64* %RAX.i88, align 8
...
block_.L_4009ea:                                  ; preds = %block_.L_4009e3, %block_4009ce, %block_4009ac
  %353 = phi i64 [ %.pre4, %block_.L_4009e3 ], [ %349, %block_4009ce ], [ %286, %block_4009ac ]
  %MEMORY.3 = phi %struct.Memory* [ %300, %block_.L_4009e3 ], [ %300, %block_4009ce ], [ %MEMORY.0, %block_4009ac ]
  ...
  store i64 %359, i64* %RAX.i88, align 8
