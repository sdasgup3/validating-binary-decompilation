...
entry:
  ...
  br i1 %48, label %block_400d6a, label %block_.L_400d76

block_400d6a:                                     ; preds = %entry
...
block_.L_400d76:                                  ; preds = %entry
  store i32 0, i32* %63, align 4
  %.pre = load i64, i64* %3, align 8
  br label %block_.L_400d7d

block_.L_400d7d:                                  ; preds = %block_.L_400d76, %block_400d6a
  %66 = phi i64 [ %.pre, %block_.L_400d76 ], [ %65, %block_400d6a ]
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_jmpq_.L_400d7d(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
