...
entry:
  ...
  br i1 %48, label %block_400d3a, label %block_.L_400d46

block_400d3a:                                     ; preds = %entry
...
block_.L_400d46:                                  ; preds = %entry
  store i32 0, i32* %63, align 4
  %.pre = load i64, i64* %PC.i, align 8
  br label %block_.L_400d4d

block_.L_400d4d:                                  ; preds = %block_.L_400d46, %block_400d3a
  %66 = phi i64 [ %.pre, %block_.L_400d46 ], [ %65, %block_400d3a ]
...
define %struct.Memory* @routine_jne_.L_400d46(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i8* %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
...
define %struct.Memory* @routine_jmpq_.L_400d4d(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
