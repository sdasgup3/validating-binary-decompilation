...
define %struct.Memory* @Proc5(%struct.State* noalias, i64, %struct.Memory* noalias) #1 {
entry:
  ...
  store i8 65, i8* inttoptr (i64 6299744 to i8*)
  ...
  store i32 0, i32* inttoptr (i64 6310384 to i32*)
  ...
  ret %struct.Memory* %loadMem_4008fb
}
