...
declare %struct.Memory* @sub_400600.Proc0(%struct.State* noalias dereferenceable(3376), i64, %struct.Memory* noalias readnone returned) local_unnamed_addr
...
entry:
  ...
  %call2_4005df = tail call %struct.Memory* @sub_400600.Proc0(%struct.State* %0, i64 %44, %struct.Memory* %2)
  ...
  %61 = add i64 %60, 16
  store i64 %61, i64* %RSP.i16, align 8
