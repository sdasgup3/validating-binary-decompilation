...
@G_0x1e1__rip_ = local_unnamed_addr global %G_0x1e1__rip__type zeroinitializer
...
entry:
  ...
  %142 = bitcast %union.VectorReg* %131 to <2 x i32>*
  ...
  %145 = bitcast [32 x %union.VectorReg]* %119 to i32*
  %146 = getelementptr inbounds i8, i8* %120, i64 4
  %147 = bitcast i8* %146 to i32*
  %148 = bitcast i64* %122 to i32*
  %149 = getelementptr inbounds i8, i8* %120, i64 12
  %150 = bitcast i8* %149 to i32*
  %151 = bitcast [32 x %union.VectorReg]* %119 to <2 x float>*
  %152 = bitcast [32 x %union.VectorReg]* %119 to <2 x i32>*
  %153 = bitcast i64* %122 to <2 x i32>*
  %154 = bitcast [32 x %union.VectorReg]* %119 to float*
  %.pre = load i64, i64* %PC.i, align 8
  br label %block_.L_400681

block_.L_400681:                                  ; preds = %block_40068f, %entry
  %155 = phi i64 [ %.pre, %entry ], [ %348, %block_40068f ]
  %MEMORY.0 = phi %struct.Memory* [ %107, %entry ], [ %288, %block_40068f ]
  ...
  %161 = add i64 %160, -2048
  %162 = icmp ult i64 %160, 2048
  ...
  %184 = xor i1 %183, %181
  %.v = select i1 %184, i64 14, i64 169
  %185 = add i64 %155, %.v
  store i64 %185, i64* %3, align 8
  br i1 %184, label %block_40068f, label %block_.L_40072a

block_40068f:                                     ; preds = %block_.L_400681
  %186 = load i64, i64* bitcast (%G_0x1e1__rip__type* @G_0x1e1__rip_ to i64*), align 8
  %187 = getelementptr inbounds [32 x %union.VectorReg], [32 x %union.VectorReg]* %119, i64 0, i64 0, i32 0, i32 0, i32 0, i64 0
  store i64 %186, i64* %187, align 1
  store double 0.000000e+00, double* %123, align 1
  %188 = getelementptr inbounds %union.VectorReg, %union.VectorReg* %124, i64 0, i32 0, i32 0, i32 0, i64 0
  store i64 %186, i64* %188, align 1
  store double 0.000000e+00, double* %127, align 1
  %189 = getelementptr inbounds %union.VectorReg, %union.VectorReg* %128, i64 0, i32 0, i32 0, i32 0, i64 0
  store i64 %186, i64* %189, align 1
  ...
  %192 = sub i64 2048, %191
  store i64 %192, i64* %RCX.i123, align 8
  %193 = icmp ugt i64 %191, 2048
  ...
  %213 = load <2 x i32>, <2 x i32>* %133, align 1
  %214 = load <2 x i32>, <2 x i32>* %135, align 1
  %215 = sitofp i64 %192 to float
  store float %215, float* %136, align 1
  %216 = extractelement <2 x i32> %213, i32 1
  store i32 %216, i32* %138, align 1
  %217 = extractelement <2 x i32> %214, i32 0
  store i32 %217, i32* %139, align 1
  %218 = extractelement <2 x i32> %214, i32 1
  store i32 %218, i32* %141, align 1
  %219 = add i64 %156, -64
  %220 = add i64 %185, 45
  store i64 %220, i64* %PC.i, align 8
  %221 = inttoptr i64 %219 to i64*
  store i64 %186, i64* %221, align 8
  %222 = load i64, i64* %PC.i, align 8
  %223 = load <2 x i32>, <2 x i32>* %142, align 1
  %224 = load <2 x i32>, <2 x i32>* %144, align 1
  %225 = extractelement <2 x i32> %223, i32 0
  store i32 %225, i32* %145, align 1
  %226 = extractelement <2 x i32> %223, i32 1
  store i32 %226, i32* %147, align 1
  %227 = extractelement <2 x i32> %224, i32 0
  store i32 %227, i32* %148, align 1
  %228 = extractelement <2 x i32> %224, i32 1
  store i32 %228, i32* %150, align 1
  %229 = load i64, i64* %RBP.i, align 8
  %230 = add i64 %229, -72
  %231 = add i64 %222, 8
  store i64 %231, i64* %PC.i, align 8
  %232 = getelementptr inbounds %union.VectorReg, %union.VectorReg* %128, i64 0, i32 0, i32 0, i32 0, i64 0
  ...
  %239 = getelementptr inbounds %union.VectorReg, %union.VectorReg* %124, i64 0, i32 0, i32 0, i32 0, i64 0
  ...
  %248 = tail call %struct.Memory* @__remill_function_call(%struct.State* %0, i64 ptrtoint (i64 (i64)* @cosf to i64), %struct.Memory* %MEMORY.0)
  %249 = load i64, i64* %PC.i, align 8
  %250 = load <2 x float>, <2 x float>* %151, align 1
  %251 = extractelement <2 x float> %250, i32 0
  %252 = fpext float %251 to double
  store double %252, double* %121, align 1
  ...
  store double %258, double* %125, align 1
  ...
  store i64 %266, i64* %RDX.i148, align 8
  %267 = shl i64 %266, 3
  %268 = add i64 %267, %262
  %269 = add i64 %249, 26
  ...
  store i64 %276, i64* %RCX.i123, align 8
  %277 = load <2 x i32>, <2 x i32>* %152, align 1
  %278 = load <2 x i32>, <2 x i32>* %153, align 1
  %279 = sitofp i64 %276 to float
  store float %279, float* %154, align 1
  %280 = extractelement <2 x i32> %277, i32 1
  store i32 %280, i32* %147, align 1
  %281 = extractelement <2 x i32> %278, i32 0
  store i32 %281, i32* %148, align 1
  %282 = extractelement <2 x i32> %278, i32 1
  store i32 %282, i32* %150, align 1
  %283 = add i64 %273, -520
  %284 = add i64 %273, 14
  ...
  %288 = tail call %struct.Memory* @__remill_function_call(%struct.State* %0, i64 ptrtoint (i64 (i64)* @sinf to i64), %struct.Memory* %248)
  %289 = load i64, i64* %PC.i, align 8
  %290 = load <2 x float>, <2 x float>* %151, align 1
  %291 = extractelement <2 x float> %290, i32 0
  %292 = fpext float %291 to double
  store double %292, double* %121, align 1
  ...
  store double %298, double* %125, align 1
  store i64 0, i64* %126, align 1
  %299 = add i64 %293, -64
  %300 = add i64 %289, 18
  ...
  store double %303, double* %121, align 1
  ...
  %322 = add i64 %321, 1
  store i64 %322, i64* %RAX.i86, align 8
...
block_.L_40072a:                                  ; preds = %block_.L_400681
  ...
  store i64 %356, i64* %RSI.i178, align 8
  %357 = add i64 %185, 54
  %358 = add i64 %185, 13
  ...
  %call2_400732 = tail call %struct.Memory* @sub_400760.double_array_divs_variable(%struct.State* %0, i64 %357, %struct.Memory* %MEMORY.0)
  ...
  store i64 %367, i64* %RSI.i178, align 8
  %368 = add i64 %362, 18
  store i64 %368, i64* %PC.i, align 8
  %369 = inttoptr i64 %367 to i64*
  %370 = load i64, i64* %369, align 8
  %371 = getelementptr inbounds [32 x %union.VectorReg], [32 x %union.VectorReg]* %119, i64 0, i64 0, i32 0, i32 0, i32 0, i64 0
  ...
  %377 = tail call %struct.Memory* @__remill_function_call(%struct.State* %0, i64 ptrtoint (i64 (i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64)* @printf to i64), %struct.Memory* %call2_400732)
  ...
  %380 = add i64 %379, -84
  %381 = load i32, i32* %EAX.i122, align 4
  %382 = add i64 %378, 5
...
block_400478:
  ...
  %4 = add i64 %3, 8
  store i64 %4, i64* %PC, align 8
  %5 = load i64, i64* bitcast (%G_0x1e1__rip__type* @G_0x1e1__rip_ to i64*), align 8
