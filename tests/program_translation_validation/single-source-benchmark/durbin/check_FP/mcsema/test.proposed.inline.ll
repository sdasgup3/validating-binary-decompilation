...
entry:
  ...
  %76 = load double, double* bitcast (%G_0x220__rip__type* @G_0x220__rip_ to double*)
...
block_401173:                                     ; preds = %block_.L_401167
  ...
  %428 = load float, float* bitcast (%G_0x1d8__rip__type* @G_0x1d8__rip_ to float*)
  %429 = load float, float* inttoptr (i64 add (i64 ptrtoint (%G_0x1d8__rip__type* @G_0x1d8__rip_ to i64), i64 4) to float*)
  %430 = load float, float* inttoptr (i64 add (i64 ptrtoint (%G_0x1d8__rip__type* @G_0x1d8__rip_ to i64), i64 8) to float*)
  %431 = load float, float* inttoptr (i64 add (i64 ptrtoint (%G_0x1d8__rip__type* @G_0x1d8__rip_ to i64), i64 12) to float*)
