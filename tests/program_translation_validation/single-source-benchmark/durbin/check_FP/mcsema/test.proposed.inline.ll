...
block_.L_401187:                                  ; preds = %block_.L_401223, %entry
...
; <label>:546:                                    ; preds = %538
  ...
  %549 = call %struct.Memory* @__remill_error(%struct.State* nonnull dereferenceable(3376) %0, i64 %548, %struct.Memory* %loadMem_4011d6)
  br label %routine_ucomisd_MINUS0x28__rbp____xmm0.exit

; <label>:550:                                    ; preds = %block_401193
...
routine_ucomisd_MINUS0x28__rbp____xmm0.exit:      ; preds = %546, %563
  %567 = phi %struct.Memory* [ %549, %546 ], [ %loadMem_4011d6, %563 ]
...
block_4011e1:                                     ; preds = %routine_ucomisd_MINUS0x28__rbp____xmm0.exit
  ...
  store i64 4199410, i64* %RSI.i, align 8
  ...
  %712 = call %struct.Memory* @__remill_function_call(%struct.State* %0, i64 ptrtoint (i64 (i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64)* @fprintf to i64), %struct.Memory* %loadMem2_40120a)
...
block_.L_401223:                                  ; preds = %block_.L_40121e
...
block_.L_401238:                                  ; preds = %block_.L_401231, %block_4011e1
  ...
  ret %struct.Memory* %loadMem_401240
}
...
define %struct.Memory* @routine_movq__0x4013f2___rsi(%struct.State* dereferenceable(3376), i64, %struct.Memory*) {
block_400488:
  %3 = getelementptr inbounds %struct.State, %struct.State* %0, i32 0, i32 6
  %4 = getelementptr inbounds %struct.GPR, %struct.GPR* %3, i32 0, i32 33
  %5 = getelementptr inbounds %struct.Reg, %struct.Reg* %4, i32 0, i32 0
