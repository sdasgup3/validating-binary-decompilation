...
block_.L_401187:                                  ; preds = %block_.L_40121e, %entry
  %95 = phi i64 [ %.pre, %entry ], [ %317, %block_.L_40121e ]
...
block_4011e1:                                     ; preds = %routine_ucomisd_MINUS0x28__rbp____xmm0.exit
  store i64 4199410, i64* %RSI.i104, align 8
...
block_.L_401238:                                  ; preds = %block_.L_401231, %block_4011e1
  %321 = phi i64 [ %.pre22, %block_.L_401231 ], [ %286, %block_4011e1 ]
  %MEMORY.1 = phi %struct.Memory* [ %MEMORY.0, %block_.L_401231 ], [ %273, %block_4011e1 ]
