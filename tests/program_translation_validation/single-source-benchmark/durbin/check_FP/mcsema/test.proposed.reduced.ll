; ModuleID = '/tmp/tmp4yf1xys8-query.ll'
...
entry:
  ...
  %var_2_42 = add i64 %var_2_10, add (i64 ptrtoint (%G_0x220__rip__type* @G_0x220__rip_ to i64), i64 7)
...
block_.L_401197:                                  ; preds = %routine_ucomisd_MINUS0x28__rbp____xmm0.exit, %entry
  ...
  br i1 %var_2_131, label %block_4011a3, label %block_.L_401248.loopexit
...
block_4011a3:                                     ; preds = %block_.L_401197
  ...
  %var_2_179 = add i64 %var_2_169, add (i64 ptrtoint (%G_0x1d8__rip__type* @G_0x1d8__rip_ to i64), i64 10)
  ...
  %var_2_183 = add i64 %var_2_169, add (i64 ptrtoint (%G_0x1d8__rip__type* @G_0x1d8__rip_ to i64), i64 14)
  %var_2_184 = inttoptr i64 %var_2_183 to i32*
  %var_2_185 = load i32, i32* %var_2_184, align 4
  %var_2_186 = add i64 %var_2_169, add (i64 ptrtoint (%G_0x1d8__rip__type* @G_0x1d8__rip_ to i64), i64 18)
  %var_2_187 = inttoptr i64 %var_2_186 to i32*
  %var_2_188 = load i32, i32* %var_2_187, align 4
  %var_2_189 = add i64 %var_2_169, add (i64 ptrtoint (%G_0x1d8__rip__type* @G_0x1d8__rip_ to i64), i64 22)
...
routine_ucomisd_MINUS0x28__rbp____xmm0.exit:      ; preds = %var_2_222, %var_2_214, %block_4011a3
  %var_2_236 = phi %struct.Memory* [ %var_2_223, %var_2_222 ], [ %MEMORY.0, %var_2_214 ], [ %MEMORY.0, %block_4011a3 ]
  ...
  br i1 %var_2_240, label %block_4011f1, label %block_.L_401197
...
block_.L_401248.loopexit:                         ; preds = %block_.L_401197
  br label %block_.L_401248

block_.L_401248:                                  ; preds = %block_.L_401248.loopexit, %block_4011f1
  %MEMORY.1 = phi %struct.Memory* [ %var_2_273, %block_4011f1 ], [ %MEMORY.0, %block_.L_401248.loopexit ]
