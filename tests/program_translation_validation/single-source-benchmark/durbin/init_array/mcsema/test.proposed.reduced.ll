; ModuleID = '/tmp/tmpo6txj7r2-query.ll'
...
entry:
  ...
  %var_2_65 = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 1, i64 1, i32 0, i32 0, i32 0, i64 0
  %.pre = load i64, i64* %var_2_3, align 8
  %var_2_72.pre = load i64, i64* %RBP.i, align 8
  br label %block_.L_400aa2

block_.L_400aa2:                                  ; preds = %block_.L_400b95.split, %entry
  %var_2_131 = phi i64 [ %var_2_72.pre, %entry ], [ %var_2_275, %block_.L_400b95.split ]
  %var_2_71 = phi i64 [ %.pre, %entry ], [ %var_2_489, %block_.L_400b95.split ]
  %MEMORY.0 = phi %struct.Memory* [ %2, %entry ], [ %var_2_252, %block_.L_400b95.split ]
  %var_2_73 = add i64 %var_2_131, -52
  %var_2_75 = inttoptr i64 %var_2_73 to i32*
  %var_2_76 = load i32, i32* %var_2_75, align 4
  %var_2_78 = add i64 %var_2_131, -4
  ...
  %.v11 = select i1 %var_2_107, i64 12, i64 262
  %var_2_108 = add i64 %.v11, %var_2_71
  br i1 %var_2_107, label %block_400aae, label %block_.L_400ba8

block_400aae:                                     ; preds = %block_.L_400aa2
  %var_2_109 = add i64 %var_2_108, ptrtoint (%G_0x8d2__rip__type* @G_0x8d2__rip_ to i64)
  ...
  store i64 %var_2_112, i64* %var_2_60, align 1
  %var_2_113 = add i64 %var_2_108, add (i64 ptrtoint (%G_0x8d2__rip__type* @G_0x8d2__rip_ to i64), i64 8)
  %var_2_114 = add i64 %var_2_108, 16
  store i64 %var_2_114, i64* %var_2_3, align 8
  %var_2_115 = inttoptr i64 %var_2_113 to i64*
  %var_2_116 = load i64, i64* %var_2_115, align 8
  store i64 %var_2_116, i64* %var_2_65, align 1
  %var_2_136 = load i32, i32* %var_2_75, align 4
  %var_2_137 = add i32 %var_2_136, 1
  %var_2_138 = zext i32 %var_2_137 to i64
  %var_2_160 = sext i32 %var_2_137 to i64
  %var_2_161 = and i64 %var_2_160, -4294967296
  %var_2_165 = load i32, i32* %var_2_80, align 4
  %var_2_166 = sext i32 %var_2_165 to i64
  %var_2_168 = or i64 %var_2_161, %var_2_138
  %var_2_169 = sdiv i64 %var_2_168, %var_2_166
  %var_2_170 = shl i64 %var_2_169, 32
  %var_2_171 = ashr exact i64 %var_2_170, 32
  %var_2_172 = icmp eq i64 %var_2_169, %var_2_171
  br i1 %var_2_172, label %routine_idivl_MINUS0x4__rbp_.exit132, label %var_2_173

var_2_173:                                        ; preds = %block_400aae
  %var_2_163 = add i64 %var_2_108, 28
  %var_2_174 = tail call %struct.Memory* @__remill_error(%struct.State* nonnull dereferenceable(3376) %0, i64 %var_2_163, %struct.Memory* %MEMORY.0)
  %var_2_200.pre = load i64, i64* %RBP.i, align 8
  br label %routine_idivl_MINUS0x4__rbp_.exit132

routine_idivl_MINUS0x4__rbp_.exit132:             ; preds = %block_400aae, %var_2_173
  %var_2_200 = phi i64 [ %var_2_200.pre, %var_2_173 ], [ %var_2_131, %block_400aae ]
  %var_2_183 = phi %struct.Memory* [ %var_2_174, %var_2_173 ], [ %MEMORY.0, %block_400aae ]
  %var_2_201 = add i64 %var_2_200, -52
  ...
  %var_2_229 = sext i32 %var_2_206 to i64
  %var_2_230 = and i64 %var_2_229, -4294967296
  %var_2_231 = add i64 %var_2_200, -4
  %var_2_233 = inttoptr i64 %var_2_231 to i32*
  %var_2_234 = load i32, i32* %var_2_233, align 4
  %var_2_235 = sext i32 %var_2_234 to i64
  %var_2_237 = or i64 %var_2_230, %var_2_207
  %var_2_238 = sdiv i64 %var_2_237, %var_2_235
  %var_2_239 = shl i64 %var_2_238, 32
  %var_2_240 = ashr exact i64 %var_2_239, 32
  %var_2_241 = icmp eq i64 %var_2_238, %var_2_240
  br i1 %var_2_241, label %routine_idivl_MINUS0x4__rbp_.exit, label %var_2_242

var_2_242:                                        ; preds = %routine_idivl_MINUS0x4__rbp_.exit132
  %var_2_202 = load i64, i64* %var_2_3, align 8
  %var_2_232 = add i64 %var_2_202, 10
  %var_2_243 = tail call %struct.Memory* @__remill_error(%struct.State* nonnull dereferenceable(3376) %0, i64 %var_2_232, %struct.Memory* %var_2_183)
  %var_2_275.pre = load i64, i64* %RBP.i, align 8
  br label %routine_idivl_MINUS0x4__rbp_.exit

routine_idivl_MINUS0x4__rbp_.exit:                ; preds = %routine_idivl_MINUS0x4__rbp_.exit132, %var_2_242
  %var_2_275 = phi i64 [ %var_2_275.pre, %var_2_242 ], [ %var_2_200, %routine_idivl_MINUS0x4__rbp_.exit132 ]
  %var_2_252 = phi %struct.Memory* [ %var_2_243, %var_2_242 ], [ %var_2_183, %routine_idivl_MINUS0x4__rbp_.exit132 ]
  %var_2_276 = add i64 %var_2_275, -56
  %var_2_278 = inttoptr i64 %var_2_276 to i32*
  %var_2_279 = load i32, i32* %var_2_278, align 4
  %var_2_281 = add i64 %var_2_275, -4
  %var_2_283 = inttoptr i64 %var_2_281 to i32*
  %var_2_284 = load i32, i32* %var_2_283, align 4
  %var_2_285 = sub i32 %var_2_279, %var_2_284
  %var_2_300 = lshr i32 %var_2_285, 31
  %var_2_302 = lshr i32 %var_2_279, 31
  %var_2_303 = lshr i32 %var_2_284, 31
  %var_2_304 = xor i32 %var_2_303, %var_2_302
  %var_2_305 = xor i32 %var_2_300, %var_2_302
  %var_2_306 = add nuw nsw i32 %var_2_305, %var_2_304
  %var_2_307 = icmp eq i32 %var_2_306, 2
  %var_2_309 = icmp ne i32 %var_2_300, 0
  %var_2_310 = xor i1 %var_2_309, %var_2_307
  br i1 %var_2_310, label %block_.L_400b17.preheader, label %block_.L_400b95.split

block_.L_400b17.preheader:                        ; preds = %routine_idivl_MINUS0x4__rbp_.exit
  br label %block_.L_400b17

block_.L_400b17:                                  ; preds = %block_.L_400b17.preheader, %block_.L_400b17
  br label %block_.L_400b17

block_.L_400b95.split:                            ; preds = %routine_idivl_MINUS0x4__rbp_.exit
  %var_2_488 = load i64, i64* %var_2_3, align 8
  %var_2_489 = add i64 %var_2_488, -257
  br label %block_.L_400aa2
