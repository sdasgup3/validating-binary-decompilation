...
declare %struct.Memory* @sub_400ba0.kernel_durbin(%struct.State* dereferenceable(3376), i64, %struct.Memory*) local_unnamed_addr

declare %struct.Memory* @sub_400e80.kernel_durbin_StrictFP(%struct.State* dereferenceable(3376), i64, %struct.Memory*) local_unnamed_addr

declare %struct.Memory* @sub_401160.check_FP(%struct.State* dereferenceable(3376), i64, %struct.Memory*) local_unnamed_addr

declare %struct.Memory* @sub_401250.print_array(%struct.State* dereferenceable(3376), i64, %struct.Memory*) local_unnamed_addr
