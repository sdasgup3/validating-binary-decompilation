...
block_401272:                                     ; preds = %block_.L_401266
  ...
  store i64 4199402, i64* %RSI.i61, align 8
  ...
  %286 = call %struct.Memory* @__remill_function_call(%struct.State* %0, i64 ptrtoint (i64 (i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64)* @fprintf to i64), %struct.Memory* %loadMem2_401293)
...
; <label>:412:                                    ; preds = %block_401272
  %413 = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %414 = load i64, i64* %413, align 8
  %415 = call %struct.Memory* @__remill_error(%struct.State* nonnull dereferenceable(3376) %0, i64 %414, %struct.Memory* %loadMem_4012af)
  br label %routine_idivl__r8d.exit

; <label>:416:                                    ; preds = %block_401272
...
routine_idivl__r8d.exit:                          ; preds = %412, %416
  %428 = phi %struct.Memory* [ %415, %412 ], [ %loadMem_4012af, %416 ]
...
block_4012bb:                                     ; preds = %routine_idivl__r8d.exit
  ...
  %490 = load i64, i64* inttoptr (i64 6299744 to i64*)
  ...
  %514 = call %struct.Memory* @__remill_function_call(%struct.State* %0, i64 ptrtoint (i64 (i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64)* @fprintf to i64), %struct.Memory* %loadMem2_4012cf)
