...
block_.L_401246:                                  ; preds = %block_.L_4012b7, %entry
  %62 = phi i64 [ %.pre, %entry ], [ %222, %block_.L_4012b7 ]
  ...
  store i64 %68, i64* %RAX.i67, align 8
  %69 = add i64 %63, -4
  %70 = add i64 %62, 6
  ...
  %97 = icmp ne i8 %89, 0
  %98 = xor i1 %97, %95
  %.v = select i1 %98, i64 12, i64 132
  %99 = add i64 %62, %.v
  store i64 %99, i64* %3, align 8
  br i1 %98, label %block_401252, label %block_.L_4012ca

block_401252:                                     ; preds = %block_.L_401246
  store i64 ptrtoint (%G__0x4013ca_type* @G__0x4013ca to i64), i64* %RSI.i72, align 8
  %100 = load i64, i64* bitcast (%G_0x602060_type* @G_0x602060 to i64*), align 8
  store i64 %100, i64* %RDI.i59, align 8
  %101 = add i64 %63, -16
  %102 = add i64 %99, 22
  ...
  store i64 %107, i64* %RCX.i53, align 8
  ...
  %119 = tail call %struct.Memory* @__remill_function_call(%struct.State* %0, i64 ptrtoint (i64 (i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64)* @fprintf to i64), %struct.Memory* %MEMORY.0)
...
routine_idivl__r8d.exit:                          ; preds = %160, %158
  %165 = phi i64 [ %.pre2, %158 ], [ %149, %160 ]
  %166 = phi i32 [ %.pre1, %158 ], [ %164, %160 ]
  ...
  store i8 0, i8* %38, align 1
  %.v4 = select i1 %173, i64 9, i64 37
  %177 = add i64 %165, %.v4
  store i64 %177, i64* %3, align 8
  br i1 %173, label %block_40129b, label %block_.L_4012b7
...
block_40129b:                                     ; preds = %routine_idivl__r8d.exit
  ...
  %184 = tail call %struct.Memory* @__remill_function_call(%struct.State* %0, i64 ptrtoint (i64 (i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64)* @fprintf to i64), %struct.Memory* %167)
...
block_.L_4012b7:                                  ; preds = %routine_idivl__r8d.exit, %block_40129b
  %191 = phi i64 [ %177, %routine_idivl__r8d.exit ], [ %.pre3, %block_40129b ]
  %MEMORY.1 = phi %struct.Memory* [ %167, %routine_idivl__r8d.exit ], [ %184, %block_40129b ]
