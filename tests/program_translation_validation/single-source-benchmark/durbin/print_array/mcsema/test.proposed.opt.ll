...
entry:
  ...
  %R8D.i42 = bitcast %union.anon* %59 to i32*
  %60 = getelementptr inbounds %union.anon, %union.anon* %59, i64 0, i32 0
  %EDX.i33 = bitcast %union.anon* %58 to i32*
...
block_.L_401246:                                  ; preds = %block_.L_4012b7, %entry
  %66 = phi i64 [ %.pre, %entry ], [ %227, %block_.L_4012b7 ]
  %MEMORY.0 = phi %struct.Memory* [ %2, %entry ], [ %MEMORY.1, %block_.L_4012b7 ]
  ...
  store i64 %72, i64* %RAX.i67, align 8
  %73 = add i64 %67, -4
  %74 = add i64 %66, 6
  ...
  %101 = icmp ne i8 %93, 0
  %102 = xor i1 %101, %99
  %.v = select i1 %102, i64 12, i64 132
  %103 = add i64 %66, %.v
  store i64 %103, i64* %3, align 8
  br i1 %102, label %block_401252, label %block_.L_4012ca

block_401252:                                     ; preds = %block_.L_401246
  store i64 ptrtoint (%G__0x4013ca_type* @G__0x4013ca to i64), i64* %RSI.i72, align 8
  %104 = load i64, i64* bitcast (%G_0x602060_type* @G_0x602060 to i64*), align 8
  store i64 %104, i64* %RDI.i59, align 8
  %105 = add i64 %67, -16
  %106 = add i64 %103, 22
  store i64 %106, i64* %PC.i, align 8
  %107 = inttoptr i64 %105 to i64*
  %108 = load i64, i64* %107, align 8
  store i64 %108, i64* %RAX.i67, align 8
  %109 = add i64 %103, 26
  store i64 %109, i64* %PC.i, align 8
  %110 = load i32, i32* %70, align 4
  %111 = sext i32 %110 to i64
  store i64 %111, i64* %RCX.i53, align 8
  ...
  %117 = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 1, i64 0, i32 0, i32 0, i32 0, i64 0
  store i64 %116, i64* %117, align 1
  store double 0.000000e+00, double* %57, align 1
  store i8 1, i8* %AL.i49, align 1
  %118 = add i64 %103, -3282
  %119 = add i64 %103, 38
  ...
  %123 = tail call %struct.Memory* @__remill_function_call(%struct.State* %0, i64 ptrtoint (i64 (i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64)* @fprintf to i64), %struct.Memory* %MEMORY.0)
...
; <label>:162:                                    ; preds = %block_401252
  %163 = tail call %struct.Memory* @__remill_error(%struct.State* nonnull dereferenceable(3376) %0, i64 %153, %struct.Memory* %123)
  %.pre1 = load i32, i32* %EDX.i33, align 4
  %.pre2 = load i64, i64* %PC.i, align 8
  br label %routine_idivl__r8d.exit

; <label>:164:                                    ; preds = %block_401252
...
routine_idivl__r8d.exit:                          ; preds = %164, %162
  %169 = phi i64 [ %.pre2, %162 ], [ %153, %164 ]
  %170 = phi i32 [ %.pre1, %162 ], [ %168, %164 ]
  %171 = phi %struct.Memory* [ %163, %162 ], [ %123, %164 ]
  store i8 0, i8* %14, align 1
  %172 = and i32 %170, 255
  ...
  store i8 0, i8* %38, align 1
  %.v4 = select i1 %177, i64 9, i64 37
  %181 = add i64 %169, %.v4
  store i64 %181, i64* %3, align 8
  br i1 %177, label %block_40129b, label %block_.L_4012b7

block_40129b:                                     ; preds = %routine_idivl__r8d.exit
  store i64 ptrtoint (%G__0x401395_type* @G__0x401395 to i64), i64* %RSI.i72, align 8
  %182 = load i64, i64* bitcast (%G_0x602060_type* @G_0x602060 to i64*), align 8
  store i64 %182, i64* %RDI.i59, align 8
  store i8 0, i8* %AL.i49, align 1
  %183 = add i64 %181, -3355
  %184 = add i64 %181, 25
  ...
  %188 = tail call %struct.Memory* @__remill_function_call(%struct.State* %0, i64 ptrtoint (i64 (i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64)* @fprintf to i64), %struct.Memory* %171)
  %189 = load i64, i64* %RBP.i, align 8
  %190 = add i64 %189, -32
  %191 = load i32, i32* %EAX.i64, align 4
...
block_.L_4012b7:                                  ; preds = %routine_idivl__r8d.exit, %block_40129b
  %195 = phi i64 [ %181, %routine_idivl__r8d.exit ], [ %.pre3, %block_40129b ]
  %MEMORY.1 = phi %struct.Memory* [ %171, %routine_idivl__r8d.exit ], [ %188, %block_40129b ]
  ...
  store i64 %202, i64* %RAX.i67, align 8
...
block_.L_4012ca:                                  ; preds = %block_.L_401246
  %228 = load i64, i64* %RSP.i17, align 8
  %229 = add i64 %228, 32
  store i64 %229, i64* %RSP.i17, align 8
...
define %struct.Memory* @routine_jge_.L_4012ca(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i8* %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
...
define %struct.Memory* @routine_movq__0x4013ca___rsi(%struct.State* dereferenceable(3376), i64, %struct.Memory*) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %RSI = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 9, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
...
define %struct.Memory* @routine_jne_.L_4012b7(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i8* %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
...
define %struct.Memory* @routine_movq__0x401395___rsi(%struct.State* dereferenceable(3376), i64, %struct.Memory*) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %RSI = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 9, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
...
define %struct.Memory* @routine_jmpq_.L_4012bc(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
...
define %struct.Memory* @routine_jmpq_.L_401246(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
