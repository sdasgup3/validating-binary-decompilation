...
block_.L_400843:                                  ; preds = %block_400839, %entry
  ...
  store i64 ptrtoint (%G__0x401397_type* @G__0x401397 to i64), i64* %RSI.i, align 8
...
define %struct.Memory* @routine_movq__0x401397___rsi(%struct.State* dereferenceable(3376), i64, %struct.Memory*) {
block_400478:
  %3 = getelementptr inbounds %struct.State, %struct.State* %0, i32 0, i32 6
  %4 = getelementptr inbounds %struct.GPR, %struct.GPR* %3, i32 0, i32 33
  %5 = getelementptr inbounds %struct.Reg, %struct.Reg* %4, i32 0, i32 0
