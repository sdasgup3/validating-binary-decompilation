...
entry:
  ...
  %loadMem1_4006ba = load %struct.Memory*, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem1_4006ba, %struct.Memory** %MEMORY
  %loadMem2_4006ba = load %struct.Memory*, %struct.Memory** %MEMORY
  %loadPC_4006ba = load i64, i64* %3
  %130 = call %struct.Memory* @__remill_function_call(%struct.State* %0, i64 ptrtoint (i64 (i64, i64)* @calloc to i64), %struct.Memory* %loadMem2_4006ba)
...
block_.L_4006d2:                                  ; preds = %block_4006de, %entry
  ...
  %loadBr_4006d8 = load i8, i8* %BRANCH_TAKEN
  %cmpBr_4006d8 = icmp eq i8 %loadBr_4006d8, 1
  br i1 %cmpBr_4006d8, label %block_.L_400703, label %block_4006de

block_4006de:                                     ; preds = %block_.L_4006d2
...
block_.L_400703:                                  ; preds = %block_.L_4006d2
  ...
  %511 = call %struct.Memory* @__remill_function_call(%struct.State* %0, i64 ptrtoint (i64 (i64)* @free to i64), %struct.Memory* %loadMem2_40070a)
...
define %struct.Memory* @routine_jmpq_.L_4006d2(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i64 %rel_off1, i64 %rel_off2) {
block_400478:
  %3 = getelementptr inbounds %struct.State, %struct.State* %0, i32 0, i32 6
  %4 = getelementptr inbounds %struct.GPR, %struct.GPR* %3, i32 0, i32 33
  %5 = getelementptr inbounds %struct.Reg, %struct.Reg* %4, i32 0, i32 0
