...
define %struct.Memory* @rtclock(%struct.State* noalias, i64, %struct.Memory* noalias) #2 {
entry:
  ...
  %XMM0.i = bitcast %union.VectorReg* %35 to %union.vec128_t*
  %36 = bitcast %"class.std::bitset"* %YMM0.i to i8*
  %37 = bitcast %"class.std::bitset"* %YMM0.i to i8*
  %38 = bitcast %union.vec128_t* %XMM0.i to i8*
  %39 = load i64, i64* %PC.i4
  %40 = add i64 %39, 3
  store i64 %40, i64* %PC.i4
  ...
  %PC.i2 = bitcast %union.anon* %68 to i64*
  ...
  %PC.i1 = bitcast %union.anon* %81 to i64*
  %82 = load i64, i64* %PC.i1
  %83 = add i64 %82, 1
  store i64 %83, i64* %PC.i1
