...
define %struct.Memory* @execute(%struct.State* noalias, i64, %struct.Memory* noalias) #2 {
entry:
  ...
  %71 = load i32, i32* bitcast (%G_0x602134_type* @G_0x602134 to i32*)
  %72 = add i32 %71, %70
  %73 = zext i32 %72 to i64
  store i64 %73, i64* %RDI.i, align 8
  %74 = icmp ult i32 %72, %70
  ...
  %PC.i4 = bitcast %union.anon* %107 to i64*
  ...
  %113 = load i64, i64* %PC.i4
  %114 = add i64 %113, 7
  store i64 %114, i64* %PC.i4
  store i32 %111, i32* bitcast (%G_0x602134_type* @G_0x602134 to i32*)
  ...
  ret %struct.Memory* %loadMem_400539
}
...
define %struct.Memory* @routine_addl_0x602134___edi(%struct.State* dereferenceable(3376), i64, %struct.Memory*) {
block_400488:
  %3 = getelementptr inbounds %struct.State, %struct.State* %0, i32 0, i32 6
  %4 = getelementptr inbounds %struct.GPR, %struct.GPR* %3, i32 0, i32 33
  %5 = getelementptr inbounds %struct.Reg, %struct.Reg* %4, i32 0, i32 0
  ...
  %13 = load i32, i32* bitcast (%G_0x602134_type* @G_0x602134 to i32*)
  %14 = add i32 %13, %12
  %15 = zext i32 %14 to i64
...
define %struct.Memory* @routine_movl__edi__0x602134(%struct.State* dereferenceable(3376), i64, %struct.Memory*) {
block_400488:
  %3 = getelementptr inbounds %struct.State, %struct.State* %0, i32 0, i32 6
  %4 = getelementptr inbounds %struct.GPR, %struct.GPR* %3, i32 0, i32 33
  %5 = getelementptr inbounds %struct.Reg, %struct.Reg* %4, i32 0, i32 0
  ...
  %12 = add i64 %11, 7
  store i64 %12, i64* %PC
  store i32 %9, i32* bitcast (%G_0x602134_type* @G_0x602134 to i32*)
  ret %struct.Memory* %2
}
