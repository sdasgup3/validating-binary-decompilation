...
define %struct.Memory* @initCombList(%struct.State* noalias, i64, %struct.Memory* noalias) local_unnamed_addr #1 {
entry:
...
block_.L_4008a2:                                  ; preds = %block_4008ae, %entry
  %33 = phi i64 [ %141, %block_4008ae ], [ %.pre, %entry ]
  ...
  br i1 %69, label %block_4008ae, label %block_.L_4008d2
...
define %struct.Memory* @routine_jge_.L_4008d2(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i8* %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
