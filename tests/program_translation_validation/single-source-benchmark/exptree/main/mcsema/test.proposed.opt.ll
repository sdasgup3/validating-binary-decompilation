...
declare %struct.Memory* @sub_401150.getInput(%struct.State* dereferenceable(3376), i64, %struct.Memory*) local_unnamed_addr

declare %struct.Memory* @sub_4012c0.search(%struct.State* dereferenceable(3376), i64, %struct.Memory*) local_unnamed_addr
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_callq_.getInput(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
