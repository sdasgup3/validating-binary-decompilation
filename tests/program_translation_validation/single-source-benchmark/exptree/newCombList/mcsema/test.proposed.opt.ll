...
@G__0x4013dd = global %G__0x4013dd_type zeroinitializer
...
define %struct.Memory* @newCombList(%struct.State* noalias, i64, %struct.Memory* noalias) local_unnamed_addr #1 {
entry:
  ...
  store i64 12, i64* %RAX.i28, align 8
  ...
  store i64 12, i64* %RSI.i37, align 8
  ...
  br i1 %76, label %entry.block_.L_400814_crit_edge, label %block_40080a

entry.block_.L_400814_crit_edge:                  ; preds = %entry
  %.pre = load i64, i64* %6, align 8
  br label %block_.L_400814

block_40080a:                                     ; preds = %entry
  %81 = add i64 %80, 4
...
block_.L_400814:                                  ; preds = %entry.block_.L_400814_crit_edge, %block_40080a
  %114 = phi i64 [ %113, %block_40080a ], [ %.pre, %entry.block_.L_400814_crit_edge ]
  %115 = phi i64 [ %112, %block_40080a ], [ %80, %entry.block_.L_400814_crit_edge ]
  store i64 ptrtoint (%G__0x4013dd_type* @G__0x4013dd to i64), i64* %RSI.i37, align 8
...
define %struct.Memory* @routine_movq__0x4013dd___rsi(%struct.State* dereferenceable(3376), i64, %struct.Memory*) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %RSI = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 9, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, 10
  store i64 %4, i64* %PC, align 8
  store i64 ptrtoint (%G__0x4013dd_type* @G__0x4013dd to i64), i64* %RSI, align 8
  ret %struct.Memory* %2
}
