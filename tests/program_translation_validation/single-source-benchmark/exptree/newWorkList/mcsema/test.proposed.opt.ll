...
define %struct.Memory* @newWorkList(%struct.State* noalias, i64, %struct.Memory* noalias) local_unnamed_addr #1 {
entry:
  ...
  %RAX.i28 = getelementptr inbounds %union.anon, %union.anon* %39, i64 0, i32 0
  store i64 4, i64* %RAX.i28, align 8
  %EAX.i36 = bitcast %union.anon* %39 to i32*
  %RSI.i37 = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 9, i32 0, i32 0
  store i64 4, i64* %RSI.i37, align 8
  ...
  %57 = tail call %struct.Memory* @__remill_function_call(%struct.State* %0, i64 ptrtoint (i64 (i64, i64)* @calloc to i64), %struct.Memory* %2)
  %58 = load i64, i64* %RBP.i, align 8
  %59 = add i64 %58, -16
  %60 = load i64, i64* %RAX.i28, align 8
  ...
  br i1 %76, label %entry.block_.L_4007b4_crit_edge, label %block_4007aa

entry.block_.L_4007b4_crit_edge:                  ; preds = %entry
  %.pre = load i64, i64* %6, align 8
  br label %block_.L_4007b4
...
block_.L_4007b4:                                  ; preds = %entry.block_.L_4007b4_crit_edge, %block_4007aa
  %114 = phi i64 [ %113, %block_4007aa ], [ %.pre, %entry.block_.L_4007b4_crit_edge ]
  %115 = phi i64 [ %112, %block_4007aa ], [ %80, %entry.block_.L_4007b4_crit_edge ]
  store i64 ptrtoint (%G__0x4013c0_type* @G__0x4013c0 to i64), i64* %RSI.i37, align 8
  %116 = load i64, i64* bitcast (%G_0x6020a0_type* @G_0x6020a0 to i64*), align 8
  store i64 %116, i64* %RDI.i31, align 8
  ...
  %121 = tail call %struct.Memory* @__remill_function_call(%struct.State* %0, i64 ptrtoint (i64 (i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64)* @fprintf to i64), %struct.Memory* %57)
  %122 = load i64, i64* %3, align 8
  store i64 1, i64* %RDI.i31, align 8
  %123 = load i64, i64* %RBP.i, align 8
  %124 = add i64 %123, -20
  %125 = load i32, i32* %EAX.i36, align 4
  %126 = add i64 %122, 8
  ...
  %134 = tail call %struct.Memory* @__remill_function_call(%struct.State* %0, i64 ptrtoint (i64 (i64)* @exit to i64), %struct.Memory* %121)
...
define %struct.Memory* @routine_je_.L_4007b4(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i8* %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
...
define %struct.Memory* @routine_movq__0x4013c0___rsi(%struct.State* dereferenceable(3376), i64, %struct.Memory*) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %RSI = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 9, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, 10
  store i64 %4, i64* %PC, align 8
  store i64 ptrtoint (%G__0x4013c0_type* @G__0x4013c0 to i64), i64* %RSI, align 8
  ret %struct.Memory* %2
}

define %struct.Memory* @routine_movq_0x6020a0___rdi(%struct.State* dereferenceable(3376), i64, %struct.Memory*) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %RDI = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 11, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
