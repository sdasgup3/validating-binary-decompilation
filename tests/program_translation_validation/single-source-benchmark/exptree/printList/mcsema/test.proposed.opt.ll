...
block_.L_400c29:                                  ; preds = %block_.L_400c6f, %entry
  %63 = phi i64 [ %.pre, %entry ], [ %204, %block_.L_400c6f ]
...
block_.L_400c7d:                                  ; preds = %block_.L_400c29
  ...
  %210 = tail call %struct.Memory* @__remill_function_call(%struct.State* %0, i64 ptrtoint (i64 (i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64)* @printf to i64), %struct.Memory* %MEMORY.0)
  %211 = load i64, i64* %RBP.i, align 8
  %212 = add i64 %211, -28
  %213 = load i32, i32* %EAX.i55, align 4
  %214 = load i64, i64* %PC.i, align 8
  %215 = add i64 %214, 3
  store i64 %215, i64* %PC.i, align 8
  %216 = inttoptr i64 %212 to i32*
  store i32 %213, i32* %216, align 4
  %217 = load i64, i64* %RSP.i8, align 8
  %218 = load i64, i64* %PC.i, align 8
  %219 = add i64 %217, 32
  store i64 %219, i64* %RSP.i8, align 8
