...
@G_0x801__rip__4197975_ = global %G_0x801__rip__4197975__type zeroinitializer
@G_0x8db__rip__4197765_ = global %G_0x8db__rip__4197765__type zeroinitializer
@G_0x9a3__rip__4197565_ = global %G_0x9a3__rip__4197565__type zeroinitializer
...
block_.L_400c48:                                  ; preds = %block_.L_400f31, %entry
...
block_.L_400c96:                                  ; preds = %block_.L_400d49, %block_.L_400c8f
...
block_400cb5:                                     ; preds = %block_.L_400ca9
  ...
  %725 = load double, double* bitcast (%G_0x9a3__rip__4197565__type* @G_0x9a3__rip__4197565_ to double*)
...
block_.L_400d49:                                  ; preds = %block_.L_400d44
...
block_.L_400d5e:                                  ; preds = %block_.L_400e11, %block_.L_400d57
...
block_400d7d:                                     ; preds = %block_.L_400d71
  ...
  %1796 = load double, double* bitcast (%G_0x8db__rip__4197765__type* @G_0x8db__rip__4197765_ to double*)
...
block_.L_400e11:                                  ; preds = %block_.L_400e0c
...
block_.L_400e26:                                  ; preds = %block_.L_400f1e, %block_.L_400e1f
...
block_400e4f:                                     ; preds = %block_.L_400e3e
  ...
  %2977 = load double, double* bitcast (%G_0x801__rip__4197975__type* @G_0x801__rip__4197975_ to double*)
...
block_.L_400f1e:                                  ; preds = %block_.L_400f19
...
block_.L_400f31:                                  ; preds = %block_.L_400f2c
...
block_.L_400f3f:                                  ; preds = %block_.L_400c48
  ...
  ret %struct.Memory* %loadMem_400f40
}
...
block_400478:
  ...
  %9 = load i64, i64* %PC
  %10 = ptrtoint %G_0x9a3__rip__4197565__type* @G_0x9a3__rip__4197565_ to i64
  %11 = load i64, i64* %PC
  %12 = add i64 %11, 8
  store i64 %12, i64* %PC
...
block_400478:
  ...
  %8 = bitcast %"class.std::bitset"* %YMM0 to i8*
  %9 = load i64, i64* %PC
  %10 = ptrtoint %G_0x8db__rip__4197765__type* @G_0x8db__rip__4197765_ to i64
  %11 = load i64, i64* %PC
  %12 = add i64 %11, 8
  store i64 %12, i64* %PC
  %13 = inttoptr i64 %10 to double*
...
block_400478:
  ...
  %8 = bitcast %"class.std::bitset"* %YMM0 to i8*
  %9 = load i64, i64* %PC
  %10 = ptrtoint %G_0x801__rip__4197975__type* @G_0x801__rip__4197975_ to i64
  %11 = load i64, i64* %PC
  %12 = add i64 %11, 8
  store i64 %12, i64* %PC
  %13 = inttoptr i64 %10 to double*
