...
block_400cb5:                                     ; preds = %block_.L_400ca9
  ...
  %725 = load double, double* bitcast (%G_0x9a3__rip__type* @G_0x9a3__rip_ to double*)
...
block_400d7d:                                     ; preds = %block_.L_400d71
  ...
  %1796 = load double, double* bitcast (%G_0x8db__rip__type* @G_0x8db__rip_ to double*)
...
block_400e4f:                                     ; preds = %block_.L_400e3e
  ...
  %2977 = load double, double* bitcast (%G_0x801__rip__type* @G_0x801__rip_ to double*)
