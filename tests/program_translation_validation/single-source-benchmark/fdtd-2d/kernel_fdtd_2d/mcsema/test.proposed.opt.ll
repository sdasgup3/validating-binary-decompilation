...
block_.L_400c48:                                  ; preds = %block_.L_400f2c, %entry
  %81 = phi i64 [ %1393, %block_.L_400f2c ], [ %.pre, %entry ]
...
block_.L_400c96:                                  ; preds = %block_.L_400d44, %block_.L_400c8f
  %221 = phi i64 [ %555, %block_.L_400d44 ], [ %.pre2, %block_.L_400c8f ]
...
block_.L_400ca9:                                  ; preds = %block_400cb5, %block_400ca2
  %262 = phi i64 [ %525, %block_400cb5 ], [ %.pre3, %block_400ca2 ]
...
block_.L_400d5e:                                  ; preds = %block_.L_400e0c, %block_.L_400d57
  %557 = phi i64 [ %908, %block_.L_400e0c ], [ %.pre4, %block_.L_400d57 ]
  ...
  br i1 %593, label %block_400d6a, label %block_.L_400e1f
...
block_.L_400d71:                                  ; preds = %block_400d7d, %block_400d6a
  %598 = phi i64 [ %878, %block_400d7d ], [ %.pre5, %block_400d6a ]
  ...
  br i1 %634, label %block_400d7d, label %block_.L_400e0c

block_400d7d:                                     ; preds = %block_.L_400d71
  %636 = load i64, i64* bitcast (%G_0x8db__rip__4197765__type* @G_0x8db__rip__4197765_ to i64*), align 8
...
block_.L_400e26:                                  ; preds = %block_.L_400f19, %block_.L_400e1f
  %910 = phi i64 [ %1363, %block_.L_400f19 ], [ %.pre6, %block_.L_400e1f ]
  ...
  br i1 %948, label %block_400e37, label %block_.L_400f2c
...
block_.L_400e3e:                                  ; preds = %block_400e4f, %block_400e37
  %953 = phi i64 [ %1333, %block_400e4f ], [ %.pre7, %block_400e37 ]
  ...
  br i1 %991, label %block_400e4f, label %block_.L_400f19

block_400e4f:                                     ; preds = %block_.L_400e3e
  %993 = load i64, i64* bitcast (%G_0x801__rip__4197975__type* @G_0x801__rip__4197975_ to i64*), align 8
