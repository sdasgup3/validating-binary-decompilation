...
@G_0x5ab__rip_ = local_unnamed_addr global %G_0x5ab__rip__type zeroinitializer
@G_0x673__rip_ = local_unnamed_addr global %G_0x673__rip__type zeroinitializer
...
block_.L_400f78:                                  ; preds = %block_.L_40125c, %entry
  %81 = phi i64 [ %1402, %block_.L_40125c ], [ %.pre, %entry ]
...
block_.L_400f8b:                                  ; preds = %block_400f97, %block_400f84
  %122 = phi i64 [ %218, %block_400f97 ], [ %.pre1, %block_400f84 ]
...
block_.L_400fc6:                                  ; preds = %block_.L_401074, %block_.L_400fbf
  %222 = phi i64 [ %558, %block_.L_401074 ], [ %.pre2, %block_.L_400fbf ]
  ...
  br i1 %258, label %block_400fd2, label %block_.L_401087
...
block_.L_400fd9:                                  ; preds = %block_400fe5, %block_400fd2
  %263 = phi i64 [ %527, %block_400fe5 ], [ %.pre3, %block_400fd2 ]
  ...
  br i1 %299, label %block_400fe5, label %block_.L_401074

block_400fe5:                                     ; preds = %block_.L_400fd9
  %301 = load i64, i64* bitcast (%G_0x673__rip__type* @G_0x673__rip_ to i64*), align 8
...
block_.L_40108e:                                  ; preds = %block_.L_40113c, %block_.L_401087
  %560 = phi i64 [ %913, %block_.L_40113c ], [ %.pre4, %block_.L_401087 ]
  ...
  br i1 %596, label %block_40109a, label %block_.L_40114f
...
block_.L_4010a1:                                  ; preds = %block_4010ad, %block_40109a
  %601 = phi i64 [ %882, %block_4010ad ], [ %.pre5, %block_40109a ]
  ...
  br i1 %637, label %block_4010ad, label %block_.L_40113c

block_4010ad:                                     ; preds = %block_.L_4010a1
  %639 = load i64, i64* bitcast (%G_0x5ab__rip__type* @G_0x5ab__rip_ to i64*), align 8
...
block_.L_401156:                                  ; preds = %block_.L_401249, %block_.L_40114f
  %915 = phi i64 [ %1371, %block_.L_401249 ], [ %.pre6, %block_.L_40114f ]
  ...
  br i1 %953, label %block_401167, label %block_.L_40125c
...
block_.L_40116e:                                  ; preds = %block_40117f, %block_401167
  %958 = phi i64 [ %1340, %block_40117f ], [ %.pre7, %block_401167 ]
  ...
  br i1 %996, label %block_40117f, label %block_.L_401249

block_40117f:                                     ; preds = %block_.L_40116e
  %998 = load i64, i64* bitcast (%G_0x4d1__rip__type* @G_0x4d1__rip_ to i64*), align 8
...
block_400478:
  ...
  %5 = load i64, i64* bitcast (%G_0x673__rip__type* @G_0x673__rip_ to i64*), align 8
...
block_400478:
  ...
  %4 = add i64 %3, 8
  store i64 %4, i64* %PC, align 8
  %5 = load i64, i64* bitcast (%G_0x5ab__rip__type* @G_0x5ab__rip_ to i64*), align 8
  %6 = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 1, i64 0, i32 0, i32 0, i32 0, i64 0
  store i64 %5, i64* %6, align 1
  %7 = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 1, i64 0, i32 0, i32 0, i32 0, i64 1
  %8 = bitcast i64* %7 to double*
