...
block_.L_400f78:                                  ; preds = %block_.L_40125c, %entry
  %81 = phi i64 [ %1377, %block_.L_40125c ], [ %.pre, %entry ]
...
block_.L_400fc6:                                  ; preds = %block_.L_401074, %block_.L_400fbf
  %221 = phi i64 [ %550, %block_.L_401074 ], [ %.pre2, %block_.L_400fbf ]
...
block_.L_400fd9:                                  ; preds = %block_400fe5, %block_400fd2
  %262 = phi i64 [ %520, %block_400fe5 ], [ %.pre3, %block_400fd2 ]
...
block_.L_40108e:                                  ; preds = %block_.L_40113c, %block_.L_401087
  %552 = phi i64 [ %903, %block_.L_40113c ], [ %.pre4, %block_.L_401087 ]
  ...
  br i1 %588, label %block_40109a, label %block_.L_40114f
...
block_.L_4010a1:                                  ; preds = %block_4010ad, %block_40109a
  %593 = phi i64 [ %873, %block_4010ad ], [ %.pre5, %block_40109a ]
  ...
  br i1 %629, label %block_4010ad, label %block_.L_40113c

block_4010ad:                                     ; preds = %block_.L_4010a1
  %631 = load i64, i64* bitcast (%G_0x5ab__rip__4198581__type* @G_0x5ab__rip__4198581_ to i64*), align 8
...
block_.L_401156:                                  ; preds = %block_.L_401249, %block_.L_40114f
  %905 = phi i64 [ %1347, %block_.L_401249 ], [ %.pre6, %block_.L_40114f ]
  ...
  br i1 %943, label %block_401167, label %block_.L_40125c
...
block_.L_40116e:                                  ; preds = %block_40117f, %block_401167
  %948 = phi i64 [ %1317, %block_40117f ], [ %.pre7, %block_401167 ]
  ...
  br i1 %986, label %block_40117f, label %block_.L_401249

block_40117f:                                     ; preds = %block_.L_40116e
  %988 = load i64, i64* bitcast (%G_0x4d1__rip__4198791__type* @G_0x4d1__rip__4198791_ to i64*), align 8
