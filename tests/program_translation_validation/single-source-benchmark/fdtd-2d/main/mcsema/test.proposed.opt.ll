...
entry:
  ...
  %call2_400a12 = tail call %struct.Memory* @sub_400c20.kernel_fdtd_2d(%struct.State* %0, i64 %237, %struct.Memory* %call2_4009f0)
  ...
  store i64 %248, i64* %RDI.i255, align 8
  %249 = add i64 %242, -24
  %250 = add i64 %244, 6
  ...
  store i64 %253, i64* %RSI.i263, align 8
  %254 = add i64 %242, -28
  %255 = add i64 %244, 9
  ...
  %call2_400a34 = tail call %struct.Memory* @sub_400ad0.init_array(%struct.State* %0, i64 %279, %struct.Memory* %call2_400a12)
  ...
  store i64 %290, i64* %RDI.i255, align 8
  %291 = add i64 %284, -24
  %292 = add i64 %286, 6
  ...
  store i64 %295, i64* %RSI.i263, align 8
  %296 = add i64 %284, -28
  %297 = add i64 %286, 9
  ...
  %call2_400a56 = tail call %struct.Memory* @sub_400f50.kernel_fdtd_2d_StrictFP(%struct.State* %0, i64 %321, %struct.Memory* %call2_400a34)
  ...
  store i64 %332, i64* %RDI.i255, align 8
  %333 = add i64 %326, -28
  %334 = add i64 %328, 6
  ...
  %call2_400a6d = tail call %struct.Memory* @sub_401280.print_array(%struct.State* %0, i64 %350, %struct.Memory* %call2_400a56)
  ...
  store i64 %360, i64* %RAX.i25, align 8
  store i64 %360, i64* %RDI.i255, align 8
  %361 = add i64 %357, -1202
  %362 = add i64 %357, 12
  ...
  %366 = tail call %struct.Memory* @__remill_function_call(%struct.State* %0, i64 ptrtoint (i64 (i64)* @free to i64), %struct.Memory* %call2_400a6d)
  ...
  store i64 %372, i64* %RAX.i25, align 8
  store i64 %372, i64* %RDI.i255, align 8
  %373 = add i64 %369, -1214
  %374 = add i64 %369, 12
  ...
  store i64 %384, i64* %RAX.i25, align 8
  store i64 %384, i64* %RDI.i255, align 8
  %385 = add i64 %381, -1226
  %386 = add i64 %381, 12
  ...
  store i64 %396, i64* %RDI.i255, align 8
  %397 = add i64 %393, -1238
  %398 = add i64 %393, 12
  ...
  store i64 %408, i64* %RAX.i25, align 8
  store i64 %408, i64* %RDI.i255, align 8
  %409 = add i64 %405, -1250
  %410 = add i64 %405, 12
  ...
  store i64 %420, i64* %RAX.i25, align 8
  store i64 %420, i64* %RDI.i255, align 8
  %421 = add i64 %417, -1262
  %422 = add i64 %417, 12
  ...
  %426 = tail call %struct.Memory* @__remill_function_call(%struct.State* %0, i64 ptrtoint (i64 (i64)* @free to i64), %struct.Memory* %414)
  ...
  store i64 %432, i64* %RAX.i25, align 8
  store i64 %432, i64* %RDI.i255, align 8
  %433 = add i64 %429, -1274
  %434 = add i64 %429, 12
  ...
  %438 = tail call %struct.Memory* @__remill_function_call(%struct.State* %0, i64 ptrtoint (i64 (i64)* @free to i64), %struct.Memory* %426)
  %439 = load i64, i64* %PC.i, align 8
  store i64 0, i64* %RAX.i25, align 8
  %440 = load i64, i64* %RSP.i7, align 8
  %441 = add i64 %440, 96
  store i64 %441, i64* %RSP.i7, align 8
  %442 = icmp ugt i64 %440, -97
