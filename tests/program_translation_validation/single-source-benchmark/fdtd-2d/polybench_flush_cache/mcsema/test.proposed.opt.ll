...
declare %struct.Memory* @sub_400620.calloc_plt(%struct.State* noalias dereferenceable(3376), i64, %struct.Memory* noalias readnone returned) local_unnamed_addr
...
entry:
  ...
  %call2_40077a = tail call %struct.Memory* @sub_400620.calloc_plt(%struct.State* %0, i64 %49, %struct.Memory* %2)
...
block_.L_400792:                                  ; preds = %block_40079e, %entry
  %77 = phi i64 [ %166, %block_40079e ], [ %.pre, %entry ]
  ...
  br i1 %113, label %block_40079e, label %block_.L_4007c3
...
block_.L_4007c3:                                  ; preds = %block_.L_400792
  ...
  %call2_4007ca = tail call %struct.Memory* @sub_4005f0.free_plt(%struct.State* nonnull %0, i64 %167, %struct.Memory* %call2_40077a)
  ...
  ret %struct.Memory* %call2_4007ca
}
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_jge_.L_4007c3(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i8* nocapture %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_jmpq_.L_400792(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
