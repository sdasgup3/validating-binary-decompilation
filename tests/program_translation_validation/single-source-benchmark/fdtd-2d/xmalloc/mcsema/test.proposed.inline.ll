...
@G__0x4016af = global %G__0x4016af_type zeroinitializer
...
block_.L_400913:                                  ; preds = %block_400909, %entry
  ...
  store i64 ptrtoint (%G__0x4016af_type* @G__0x4016af to i64), i64* %RSI.i, align 8
...
; Function Attrs: alwaysinline
define %struct.Memory* @routine_movq__0x4016af___rsi(%struct.State* dereferenceable(3376), i64, %struct.Memory*) #2 {
block_400488:
  %3 = getelementptr inbounds %struct.State, %struct.State* %0, i32 0, i32 6
  %4 = getelementptr inbounds %struct.GPR, %struct.GPR* %3, i32 0, i32 33
  %5 = getelementptr inbounds %struct.Reg, %struct.Reg* %4, i32 0, i32 0
  ...
  %10 = add i64 %9, 10
  store i64 %10, i64* %PC
  store i64 ptrtoint (%G__0x4016af_type* @G__0x4016af to i64), i64* %RSI, align 8
  ret %struct.Memory* %2
}
