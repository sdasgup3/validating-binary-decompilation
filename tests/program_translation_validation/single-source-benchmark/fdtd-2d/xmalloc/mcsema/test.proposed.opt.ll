...
block_.L_4008d3:                                  ; preds = %block_4008c9, %entry
  ...
  store i64 ptrtoint (%G__0x40166f_type* @G__0x40166f to i64), i64* %RSI.i45, align 8
...
define %struct.Memory* @routine_movq__0x40166f___rsi(%struct.State* dereferenceable(3376), i64, %struct.Memory*) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %RSI = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 9, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
