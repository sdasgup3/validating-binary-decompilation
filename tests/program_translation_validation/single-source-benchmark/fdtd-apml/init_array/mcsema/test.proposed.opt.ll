...
entry:
  ...
  %117 = add i64 %112, add (i64 ptrtoint (%G_0x2439__rip__type* @G_0x2439__rip_ to i64), i64 4)
  %118 = add i64 %112, 12
  ...
  %126 = add i64 %112, add (i64 ptrtoint (%G_0x2439__rip__type* @G_0x2439__rip_ to i64), i64 12)
  %127 = add i64 %112, 20
...
block_.L_40109a:                                  ; preds = %block_4010a9, %entry
  %264 = phi i64 [ %389, %block_4010a9 ], [ %.pre, %entry ]
  ...
  br i1 %.demorgan, label %block_4010a9, label %block_.L_401117

block_4010a9:                                     ; preds = %block_.L_40109a
  %302 = add i64 %301, ptrtoint (%G_0x23cf__rip__type* @G_0x23cf__rip_ to i64)
  %303 = add i64 %301, 8
  ...
  store double 0.000000e+00, double* %124, align 1
  %306 = add i64 %301, add (i64 ptrtoint (%G_0x23cf__rip__type* @G_0x23cf__rip_ to i64), i64 8)
  %307 = add i64 %301, 16
...
block_.L_401121:                                  ; preds = %block_401130, %block_.L_401117
  %391 = phi i64 [ %514, %block_401130 ], [ %.pre16, %block_.L_401117 ]
...
block_401130:                                     ; preds = %block_.L_401121
  %429 = add i64 %428, ptrtoint (%G_0x2368__rip__type* @G_0x2368__rip_ to i64)
  %430 = add i64 %428, 8
  ...
  store double 0.000000e+00, double* %124, align 1
  %433 = add i64 %428, add (i64 ptrtoint (%G_0x2338__rip__type* @G_0x2338__rip_ to i64), i64 8)
  %434 = add i64 %428, 16
...
block_.L_4011ae:                                  ; preds = %block_4011bd, %block_.L_4011a4
  %516 = phi i64 [ %641, %block_4011bd ], [ %.pre17, %block_.L_4011a4 ]
...
block_4011bd:                                     ; preds = %block_.L_4011ae
  %554 = add i64 %553, ptrtoint (%G_0x22cb__rip__type* @G_0x22cb__rip_ to i64)
  %555 = add i64 %553, 8
  ...
  store double 0.000000e+00, double* %124, align 1
  %558 = add i64 %553, add (i64 ptrtoint (%G_0x22cb__rip__type* @G_0x22cb__rip_ to i64), i64 8)
  %559 = add i64 %553, 16
...
block_.L_40123b:                                  ; preds = %block_.L_40148b, %block_.L_401231
  %649 = phi i64 [ %1431, %block_.L_40148b ], [ %.pre18, %block_.L_401231 ]
  ...
  br i1 %.demorgan23, label %block_40124a, label %block_.L_4014a4
...
block_.L_401254:                                  ; preds = %block_.L_401472, %block_40124a
  %690 = phi i64 [ %1401, %block_.L_401472 ], [ %.pre19, %block_40124a ]
  ...
  br i1 %.demorgan24, label %block_401263, label %block_.L_40148b

block_401263:                                     ; preds = %block_.L_401254
  %728 = add i64 %727, ptrtoint (%G_0x21fd__rip__type* @G_0x21fd__rip_ to i64)
  %729 = add i64 %727, 8
  ...
  store double 0.000000e+00, double* %124, align 1
  %732 = add i64 %727, add (i64 ptrtoint (%G_0x21fd__rip__type* @G_0x21fd__rip_ to i64), i64 8)
  %733 = add i64 %727, 16
...
block_.L_40130b:                                  ; preds = %block_40131a, %block_401263
  %912 = phi i64 [ %1371, %block_40131a ], [ %.pre20, %block_401263 ]
...
block_40131a:                                     ; preds = %block_.L_40130b
  %950 = add i64 %949, ptrtoint (%G_0x2156__rip__type* @G_0x2156__rip_ to i64)
  %951 = add i64 %949, 8
  ...
  store double 0.000000e+00, double* %124, align 1
  %954 = add i64 %949, add (i64 ptrtoint (%G_0x2156__rip__type* @G_0x2156__rip_ to i64), i64 8)
  %955 = add i64 %949, 16
  ...
  store double 0.000000e+00, double* %133, align 1
  %958 = add i64 %949, add (i64 ptrtoint (%G_0x2156__rip__type* @G_0x2156__rip_ to i64), i64 16)
  %959 = add i64 %949, 24
...
; Function Attrs: alwaysinline nounwind
define %struct.Memory* @routine_cmpl_MINUS0x34__rbp____eax(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned) local_unnamed_addr #1 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 1, i32 0
  %EAX = bitcast %union.anon* %3 to i32*
...
; Function Attrs: alwaysinline nounwind
define %struct.Memory* @routine_imulq__0x208___rdx___rdx(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned) local_unnamed_addr #1 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %RDX = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 7, i32 0, i32 0
...
; Function Attrs: alwaysinline nounwind
define %struct.Memory* @routine_imulq__0x8408___rdx___rdx(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned) local_unnamed_addr #1 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %RDX = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 7, i32 0, i32 0
  %3 = load i64, i64* %RDX, align 8
...
; Function Attrs: alwaysinline nounwind
define %struct.Memory* @routine_addl__0x5___eax(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned) local_unnamed_addr #1 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %RAX = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 1, i32 0, i32 0
  %3 = load i64, i64* %RAX, align 8
