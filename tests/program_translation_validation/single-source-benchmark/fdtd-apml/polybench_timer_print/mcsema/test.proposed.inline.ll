...
declare %struct.Memory* @sub_400590.printf_plt(%struct.State* noalias dereferenceable(3376), i64, %struct.Memory* noalias readnone returned)
...
entry:
  ...
  store i64 4207792, i64* %RDI.i, align 8
  ...
  %83 = load double, double* inttoptr (i64 6307976 to double*)
  ...
  %101 = load double, double* inttoptr (i64 6307984 to double*)
  ...
  %loadMem1_4007d6 = load %struct.Memory*, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem1_4007d6, %struct.Memory** %MEMORY
  %loadMem2_4007d6 = load %struct.Memory*, %struct.Memory** %MEMORY
  %loadPC_4007d6 = load i64, i64* %3
  %call2_4007d6 = call %struct.Memory* @sub_400590.printf_plt(%struct.State* %0, i64 %loadPC_4007d6, %struct.Memory* %loadMem2_4007d6)
  store %struct.Memory* %call2_4007d6, %struct.Memory** %MEMORY
  ...
  ret %struct.Memory* %loadMem_4007e3
}
...
define %struct.Memory* @routine_movq__0x4034b0___rdi(%struct.State* dereferenceable(3376), i64, %struct.Memory*) {
block_400488:
  %3 = getelementptr inbounds %struct.State, %struct.State* %0, i32 0, i32 6
  %4 = getelementptr inbounds %struct.GPR, %struct.GPR* %3, i32 0, i32 33
  %5 = getelementptr inbounds %struct.Reg, %struct.Reg* %4, i32 0, i32 0
  ...
  %10 = add i64 %9, 10
  store i64 %10, i64* %PC
  store i64 4207792, i64* %RDI, align 8
  ret %struct.Memory* %2
}
...
block_400488:
  ...
  %10 = add i64 %9, 9
  store i64 %10, i64* %PC
  %11 = load double, double* inttoptr (i64 6307976 to double*)
...
block_400488:
  ...
  %17 = load double, double* inttoptr (i64 6307984 to double*)
