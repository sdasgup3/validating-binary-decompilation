...
entry:
  ...
  store double %52, double* bitcast (%G_0x604088_type* @G_0x604088 to double*)
  ...
  ret %struct.Memory* %loadMem_400773
}
...
define %struct.Memory* @routine_movsd__xmm0__0x604088(%struct.State* dereferenceable(3376), i64, %struct.Memory*) {
block_400478:
  %3 = getelementptr inbounds %struct.State, %struct.State* %0, i32 0, i32 6
  %4 = getelementptr inbounds %struct.GPR, %struct.GPR* %3, i32 0, i32 33
  %5 = getelementptr inbounds %struct.Reg, %struct.Reg* %4, i32 0, i32 0
  ...
  store double %12, double* bitcast (%G_0x604088_type* @G_0x604088 to double*)
  ret %struct.Memory* %2
}
