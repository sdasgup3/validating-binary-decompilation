...
entry:
  ...
  %call2_4007a4 = tail call %struct.Memory* @sub_400790.rtclock(%struct.State* %0, i64 %11, %struct.Memory* %2)
  ...
  store i64 %17, i64* bitcast (%G_0x604088_type* @G_0x604088 to i64*), align 8
  %18 = add i64 %15, 10
  ...
  ret %struct.Memory* %call2_4007a4
}
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_movsd__xmm0__0x604088(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned) local_unnamed_addr #1 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, 9
  ...
  store i64 %6, i64* bitcast (%G_0x604088_type* @G_0x604088 to i64*), align 8
  ret %struct.Memory* %2
}
