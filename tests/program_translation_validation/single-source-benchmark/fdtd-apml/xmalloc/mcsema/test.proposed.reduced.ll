; ModuleID = '/tmp/tmp2vg7tmd5-query.ll'
...
@G__0x4034c7 = global %G__0x4034c7_type zeroinitializer
...
entry:
  ...
  %RAX.i31 = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 1, i32 0, i32 0
  %var_2_62 = tail call %struct.Memory* @__remill_function_call(%struct.State* %0, i64 ptrtoint (i64 (i64, i64, i64)* @posix_memalign to i64), %struct.Memory* %2)
  %var_2_69 = load i64, i64* %RBP.i, align 8
  %var_2_70 = add i64 %var_2_69, -16
  %var_2_73 = inttoptr i64 %var_2_70 to i64*
  %var_2_74 = load i64, i64* %var_2_73, align 8
  %var_2_81 = icmp eq i64 %var_2_74, 0
  br i1 %var_2_81, label %block_.L_400883, label %block_400879

block_400879:                                     ; preds = %entry
  %var_2_71 = load i64, i64* %var_2_3, align 8
  %var_2_85 = add i64 %var_2_71, 11
  %var_2_86 = add i64 %var_2_69, -20
  %var_2_88 = inttoptr i64 %var_2_86 to i32*
  %var_2_89 = load i32, i32* %var_2_88, align 4
  %var_2_95 = icmp eq i32 %var_2_89, 0
  %.v3 = select i1 %var_2_95, i64 48, i64 10
  %var_2_99 = add i64 %var_2_85, %.v3
  br i1 %var_2_95, label %block_.L_4008a9, label %block_.L_400883

block_.L_400883:                                  ; preds = %block_400879, %entry
  %var_2_107 = tail call %struct.Memory* @__remill_function_call(%struct.State* nonnull %0, i64 ptrtoint (i64 (i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64)* @fprintf to i64), %struct.Memory* %var_2_62)
  %var_2_120 = tail call %struct.Memory* @__remill_function_call(%struct.State* nonnull %0, i64 ptrtoint (i64 (i64)* @exit to i64), %struct.Memory* %var_2_107)
  %.pre = load i64, i64* %RBP.i, align 8
  %.pre2 = load i64, i64* %var_2_3, align 8
  br label %block_.L_4008a9

block_.L_4008a9:                                  ; preds = %block_.L_400883, %block_400879
  %var_2_121 = phi i64 [ %.pre2, %block_.L_400883 ], [ %var_2_99, %block_400879 ]
  %var_2_122 = phi i64 [ %.pre, %block_.L_400883 ], [ %var_2_69, %block_400879 ]
  %MEMORY.1 = phi %struct.Memory* [ %var_2_120, %block_.L_400883 ], [ %var_2_62, %block_400879 ]
  %var_2_123 = add i64 %var_2_122, -16
  %var_2_124 = add i64 %var_2_121, 4
  store i64 %var_2_124, i64* %var_2_3, align 8
  %var_2_125 = inttoptr i64 %var_2_123 to i64*
  %var_2_126 = load i64, i64* %var_2_125, align 8
  store i64 %var_2_126, i64* %RAX.i31, align 8
  %var_2_154 = add i64 %var_2_121, 10
...
; Function Attrs: alwaysinline norecurse nounwind
define %struct.Memory* @routine_je_.L_400883(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i8* nocapture %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
...
; Function Attrs: alwaysinline norecurse nounwind
define %struct.Memory* @routine_je_.L_4008a9(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i8* nocapture %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 2, i32 7
...
; Function Attrs: alwaysinline norecurse nounwind
define %struct.Memory* @routine_movq__0x4034c7___rsi(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %RSI = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 9, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, 10
  store i64 %4, i64* %PC, align 8
  store i64 ptrtoint (%G__0x4034c7_type* @G__0x4034c7 to i64), i64* %RSI, align 8
  ret %struct.Memory* %2
}
