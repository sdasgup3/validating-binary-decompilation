...
define %struct.Memory* @Func3(%struct.State* noalias, i64, %struct.Memory* noalias) local_unnamed_addr #1 {
entry:
  ...
  %EDI.i19 = bitcast %union.anon* %11 to i32*
  %12 = add i64 %7, -16
  %13 = load i32, i32* %EDI.i19, align 4
  %14 = add i64 %10, 6
  ...
  %.v = select i1 %48, i64 13, i64 25
  %60 = add i64 %28, %.v
  %61 = add i64 %26, -4
  %62 = add i64 %60, 7
  store i64 %62, i64* %PC.i, align 8
  %63 = inttoptr i64 %61 to i32*
  br i1 %48, label %block_400eea, label %block_.L_400ef6

block_400eea:                                     ; preds = %entry
...
block_.L_400ef6:                                  ; preds = %entry
  store i32 0, i32* %63, align 4
  %.pre = load i64, i64* %PC.i, align 8
  br label %block_.L_400efd

block_.L_400efd:                                  ; preds = %block_.L_400ef6, %block_400eea
  %66 = phi i64 [ %.pre, %block_.L_400ef6 ], [ %65, %block_400eea ]
...
define %struct.Memory* @routine_cmpl__0x2711__MINUS0xc__rbp_(%struct.State* dereferenceable(3376), i64, %struct.Memory*) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %RBP = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 15, i32 0, i32 0
  %3 = load i64, i64* %RBP, align 8
...
define %struct.Memory* @routine_jne_.L_400ef6(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i8* %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
...
define %struct.Memory* @routine_jmpq_.L_400efd(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
