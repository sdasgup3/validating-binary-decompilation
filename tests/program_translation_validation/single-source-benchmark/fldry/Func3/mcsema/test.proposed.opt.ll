...
define %struct.Memory* @Func3(%struct.State* noalias nocapture, i64, %struct.Memory* noalias readnone returned) local_unnamed_addr #1 {
entry:
  ...
  br i1 %48, label %block_400f1a, label %block_.L_400f26

block_400f1a:                                     ; preds = %entry
...
block_.L_400f26:                                  ; preds = %entry
  store i32 0, i32* %63, align 4
  %.pre = load i64, i64* %3, align 8
  br label %block_.L_400f2d

block_.L_400f2d:                                  ; preds = %block_.L_400f26, %block_400f1a
  %66 = phi i64 [ %.pre, %block_.L_400f26 ], [ %65, %block_400f1a ]
...
define %struct.Memory* @routine_cmpl__0x2711__MINUS0xc__rbp_(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned) local_unnamed_addr #3 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %RBP = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 15, i32 0, i32 0
  %3 = load i64, i64* %RBP, align 8
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_jne_.L_400f26(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i8* nocapture %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
