...
entry:
  ...
  br i1 %48, label %block_400f2a, label %block_.L_400f36

block_400f2a:                                     ; preds = %entry
...
block_.L_400f36:                                  ; preds = %entry
  store i32 0, i32* %63, align 4
  %.pre = load i64, i64* %3, align 8
  br label %block_.L_400f3d

block_.L_400f3d:                                  ; preds = %block_.L_400f36, %block_400f2a
  %66 = phi i64 [ %.pre, %block_.L_400f36 ], [ %65, %block_400f2a ]
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_jne_.L_400f36(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i8* nocapture %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
