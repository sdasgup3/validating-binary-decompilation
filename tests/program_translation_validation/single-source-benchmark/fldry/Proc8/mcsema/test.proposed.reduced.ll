; ModuleID = '/tmp/tmppmnjbvrc-query.ll'
...
define %struct.Memory* @Proc8(%struct.State* noalias, i64, %struct.Memory* noalias returned) local_unnamed_addr #1 {
entry:
  ...
  %var_2_13 = add i64 %var_2_10, add (i64 ptrtoint (%G_0x50c__rip__type* @G_0x50c__rip_ to i64), i64 3)
  ...
  %var_2_18 = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 1, i64 2, i32 0, i32 0, i32 0, i64 0
  store i64 %var_2_16, i64* %var_2_18, align 1
  %var_2_35 = getelementptr inbounds [32 x %union.VectorReg], [32 x %union.VectorReg]* %var_2_11, i64 0, i64 0, i32 0, i32 0, i32 0, i64 0
  %var_2_64 = bitcast [32 x %union.VectorReg]* %var_2_11 to double*
  %var_2_123 = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 2, i32 1
  br label %block_.L_400bf6

block_.L_400bf6:                                  ; preds = %block_400c12, %entry
  %var_2_208 = phi i64 [ %var_2_14, %entry ], [ %var_2_331, %block_400c12 ]
  %MEMORY.0 = phi %struct.Memory* [ %2, %entry ], [ %var_2_249, %block_400c12 ]
  %var_2_209 = add i64 %var_2_208, ptrtoint (%G_0x482__rip__type* @G_0x482__rip_ to i64)
  %var_2_210 = add i64 %var_2_208, 8
  store i64 %var_2_210, i64* %var_2_3, align 8
  %var_2_211 = inttoptr i64 %var_2_209 to i64*
  %var_2_212 = load i64, i64* %var_2_211, align 8
  store i64 %var_2_212, i64* %var_2_35, align 1
  %var_2_213 = load i64, i64* %RBP.i, align 8
  %var_2_214 = add i64 %var_2_213, -56
  %var_4_3 = inttoptr i64 %var_2_214 to double*
  %var_2_2172 = load double, double* %var_4_3, align 8
  %var_2_218 = add i64 %var_2_213, -48
  %var_2_220 = bitcast i64 %var_2_212 to double
  %var_2_221 = inttoptr i64 %var_2_218 to double*
  %var_2_222 = load double, double* %var_2_221, align 8
  %var_2_223 = fadd double %var_2_220, %var_2_222
  store double %var_2_223, double* %var_2_64, align 1
  %var_2_224 = add i64 %var_2_208, 22
  %var_2_226 = fcmp uno double %var_2_223, %var_2_2172
  br i1 %var_2_226, label %var_2_227, label %routine_ucomisd__xmm1___xmm0.exit

var_2_227:                                        ; preds = %block_.L_400bf6
  %var_2_228 = fadd double %var_2_2172, %var_2_223
  %var_2_229 = bitcast double %var_2_228 to i64
  %var_2_230 = and i64 %var_2_229, 9221120237041090560
  %var_2_231 = icmp eq i64 %var_2_230, 9218868437227405312
  %var_2_232 = and i64 %var_2_229, 2251799813685247
  %var_2_233 = icmp ne i64 %var_2_232, 0
  %var_2_234 = and i1 %var_2_231, %var_2_233
  br i1 %var_2_234, label %var_2_235, label %routine_ucomisd__xmm1___xmm0.exit

var_2_235:                                        ; preds = %var_2_227
  %var_2_236 = tail call %struct.Memory* @__remill_error(%struct.State* nonnull dereferenceable(3376) %0, i64 %var_2_224, %struct.Memory* %MEMORY.0)
  %.pre5 = load i64, i64* %var_2_3, align 8
  br label %routine_ucomisd__xmm1___xmm0.exit

routine_ucomisd__xmm1___xmm0.exit:                ; preds = %block_.L_400bf6, %var_2_227, %var_2_235
  %var_2_316 = phi i64 [ %.pre5, %var_2_235 ], [ %var_2_210, %var_2_227 ], [ %var_2_210, %block_.L_400bf6 ]
  %var_2_248 = phi i64 [ %.pre5, %var_2_235 ], [ %var_2_224, %var_2_227 ], [ %var_2_224, %block_.L_400bf6 ]
  %var_2_249 = phi %struct.Memory* [ %var_2_236, %var_2_235 ], [ %MEMORY.0, %var_2_227 ], [ %MEMORY.0, %block_.L_400bf6 ]
  %var_2_250 = load i8, i8* %var_2_123, align 1
  %cmpBr_400c0c = icmp eq i8 %var_2_250, 1
  br i1 %cmpBr_400c0c, label %block_.L_400c51, label %block_400c12

block_400c12:                                     ; preds = %routine_ucomisd__xmm1___xmm0.exit
  %var_2_317 = add i64 %var_2_316, ptrtoint (%G_0x43e__rip__type* @G_0x43e__rip_ to i64)
  %var_2_318 = add i64 %var_2_316, 8
  store i64 %var_2_318, i64* %var_2_3, align 8
  %var_2_319 = inttoptr i64 %var_2_317 to i64*
  %var_2_320 = load i64, i64* %var_2_319, align 8
  store i64 %var_2_320, i64* %var_2_35, align 1
  %var_2_321 = load i64, i64* %RBP.i, align 8
  %var_2_322 = add i64 %var_2_321, -56
  %var_2_324 = bitcast i64 %var_2_320 to double
  %var_2_325 = inttoptr i64 %var_2_322 to double*
  %var_2_326 = load double, double* %var_2_325, align 8
  %var_2_327 = fadd double %var_2_324, %var_2_326
  store double %var_2_327, double* %var_2_64, align 1
  store double %var_2_327, double* %var_2_325, align 8
  %var_2_330 = load i64, i64* %var_2_3, align 8
  %var_2_331 = add i64 %var_2_330, -86
  br label %block_.L_400bf6

block_.L_400c51:                                  ; preds = %routine_ucomisd__xmm1___xmm0.exit
  %var_2_44 = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 1, i64 1, i32 0, i32 0, i32 0, i64 0
  %var_2_332 = add i64 %var_2_248, add (i64 ptrtoint (%G_0x42f__rip__type* @G_0x42f__rip_ to i64), i64 69)
  %var_2_333 = add i64 %var_2_248, 77
  store i64 %var_2_333, i64* %var_2_3, align 8
  %var_2_334 = inttoptr i64 %var_2_332 to i64*
  %var_2_335 = load i64, i64* %var_2_334, align 8
  store i64 %var_2_335, i64* %var_2_35, align 1
  %var_2_336 = add i64 %var_2_248, add (i64 ptrtoint (%G_0x41f__rip__type* @G_0x41f__rip_ to i64), i64 77)
  %var_2_337 = add i64 %var_2_248, 85
  store i64 %var_2_337, i64* %var_2_3, align 8
  %var_2_338 = inttoptr i64 %var_2_336 to i64*
  %var_2_339 = load i64, i64* %var_2_338, align 8
  store i64 %var_2_339, i64* %var_2_44, align 1
  store i64 %var_2_335, i64* bitcast (%G_0x607368_type* @G_0x607368 to i64*), align 8
