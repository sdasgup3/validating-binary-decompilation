...
declare %struct.Memory* @sub_400520.printf_plt(%struct.State* dereferenceable(3376), i64, %struct.Memory*)

declare %struct.Memory* @sub_400690.Proc0(%struct.State* dereferenceable(3376), i64, %struct.Memory*)
