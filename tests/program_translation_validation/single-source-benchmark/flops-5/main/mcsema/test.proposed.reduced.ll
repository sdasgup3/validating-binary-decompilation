; ModuleID = '/tmp/tmpog500d7z-query.ll'
...
; Matched:%var_2_343:  %var_2_343 = fdiv double %var_2_342, %var_2_341
; %var_2_402 = fdiv double %var_2_401, %var_2_400
...
%var_2_451 = load double, double* bitcast (%G_0x6012a0_type* @G_0x6012a0 to double*), align 8
...
%var_2_559 = fdiv double %var_2_558, %var_2_557
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_divsd_0x601258___xmm3(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 1, i64 3
  %4 = load i64, i64* %PC, align 8
