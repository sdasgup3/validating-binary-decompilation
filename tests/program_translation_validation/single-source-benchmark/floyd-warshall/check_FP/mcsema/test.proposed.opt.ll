...
block_.L_400d27:                                  ; preds = %block_.L_400e02, %entry
  %89 = phi i64 [ %.pre, %entry ], [ %458, %block_.L_400e02 ]
  ...
  br i1 %125, label %block_400d33, label %block_.L_400e15
...
block_.L_400d3a:                                  ; preds = %block_.L_400def, %block_400d33
  %130 = phi i64 [ %.pre3, %block_400d33 ], [ %427, %block_.L_400def ]
  %MEMORY.1 = phi %struct.Memory* [ %MEMORY.0, %block_400d33 ], [ %333, %block_.L_400def ]
  ...
  br i1 %166, label %block_400d46, label %block_.L_400e02
...
routine_ucomisd_MINUS0x28__rbp____xmm0.exit:      ; preds = %331, %319
  ...
  br i1 %337, label %block_.L_400def, label %block_400daa
...
block_.L_400e1c:                                  ; preds = %block_.L_400e15, %block_400daa
  %462 = phi i64 [ %.pre5, %block_.L_400e15 ], [ %395, %block_400daa ]
  %MEMORY.2 = phi %struct.Memory* [ %MEMORY.0, %block_.L_400e15 ], [ %382, %block_400daa ]
