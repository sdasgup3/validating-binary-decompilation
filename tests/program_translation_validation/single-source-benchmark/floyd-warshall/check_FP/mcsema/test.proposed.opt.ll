...
@G_0x428__rip__4197648_ = local_unnamed_addr global %G_0x428__rip__4197648__type zeroinitializer
...
entry:
  ...
  %42 = load i64, i64* bitcast (%G_0x428__rip__4197648__type* @G_0x428__rip__4197648_ to i64*), align 8
...
block_.L_400d27:                                  ; preds = %block_.L_400e02, %entry
  %88 = phi i64 [ %.pre, %entry ], [ %450, %block_.L_400e02 ]
  ...
  br i1 %124, label %block_400d33, label %block_.L_400e15
...
block_.L_400d3a:                                  ; preds = %block_.L_400def, %block_400d33
  %129 = phi i64 [ %.pre3, %block_400d33 ], [ %420, %block_.L_400def ]
  %MEMORY.1 = phi %struct.Memory* [ %MEMORY.0, %block_400d33 ], [ %329, %block_.L_400def ]
  ...
  br i1 %165, label %block_400d46, label %block_.L_400e02
...
block_400d46:                                     ; preds = %block_.L_400d3a
  ...
  %278 = load i32, i32* bitcast (%G_0x3af__rip__4197777__type* @G_0x3af__rip__4197777_ to i32*), align 8
  %279 = load i32, i32* inttoptr (i64 add (i64 ptrtoint (%G_0x3af__rip__4197777__type* @G_0x3af__rip__4197777_ to i64), i64 4) to i32*), align 4
  %280 = load i32, i32* inttoptr (i64 add (i64 ptrtoint (%G_0x3af__rip__4197777__type* @G_0x3af__rip__4197777_ to i64), i64 8) to i32*), align 8
  %281 = load i32, i32* inttoptr (i64 add (i64 ptrtoint (%G_0x3af__rip__4197777__type* @G_0x3af__rip__4197777_ to i64), i64 12) to i32*), align 4
...
routine_ucomisd_MINUS0x28__rbp____xmm0.exit:      ; preds = %327, %315
  ...
  br i1 %333, label %block_.L_400def, label %block_400daa

block_400daa:                                     ; preds = %routine_ucomisd_MINUS0x28__rbp____xmm0.exit
  store i64 ptrtoint (%G__0x40118a_type* @G__0x40118a to i64), i64* %RSI.i143, align 8
...
block_.L_400e1c:                                  ; preds = %block_.L_400e15, %block_400daa
  %454 = phi i64 [ %.pre5, %block_.L_400e15 ], [ %389, %block_400daa ]
  %MEMORY.2 = phi %struct.Memory* [ %MEMORY.0, %block_.L_400e15 ], [ %376, %block_400daa ]
...
block_400478:
  ...
  %5 = load i64, i64* bitcast (%G_0x428__rip__4197648__type* @G_0x428__rip__4197648_ to i64*), align 8
...
define %struct.Memory* @routine_jge_.L_400e15(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i8* %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
...
define %struct.Memory* @routine_jge_.L_400e02(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i8* %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 2, i32 9
...
block_400478:
  ...
  %6 = add i64 %5, 7
  store i64 %6, i64* %PC, align 8
  %7 = load i32, i32* bitcast (%G_0x3af__rip__4197777__type* @G_0x3af__rip__4197777_ to i32*), align 8
  %8 = load i32, i32* inttoptr (i64 add (i64 ptrtoint (%G_0x3af__rip__4197777__type* @G_0x3af__rip__4197777_ to i64), i64 4) to i32*), align 4
  %9 = load i32, i32* inttoptr (i64 add (i64 ptrtoint (%G_0x3af__rip__4197777__type* @G_0x3af__rip__4197777_ to i64), i64 8) to i32*), align 8
  %10 = load i32, i32* inttoptr (i64 add (i64 ptrtoint (%G_0x3af__rip__4197777__type* @G_0x3af__rip__4197777_ to i64), i64 12) to i32*), align 4
...
define %struct.Memory* @routine_jbe_.L_400def(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i8* %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
...
define %struct.Memory* @routine_movq__0x40118a___rsi(%struct.State* dereferenceable(3376), i64, %struct.Memory*) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %RSI = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 9, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
...
define %struct.Memory* @routine_jmpq_.L_400e1c(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
...
define %struct.Memory* @routine_jmpq_.L_400d3a(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
...
define %struct.Memory* @routine_jmpq_.L_400e07(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
...
define %struct.Memory* @routine_jmpq_.L_400d27(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
