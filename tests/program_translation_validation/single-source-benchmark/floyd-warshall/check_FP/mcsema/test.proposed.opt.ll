...
block_.L_400d57:                                  ; preds = %block_.L_400e32, %entry
  %95 = phi i64 [ %.pre, %entry ], [ %464, %block_.L_400e32 ]
...
block_.L_400d6a:                                  ; preds = %block_.L_400e1f, %block_400d63
  %136 = phi i64 [ %.pre29, %block_400d63 ], [ %434, %block_.L_400e1f ]
...
block_400dda:                                     ; preds = %routine_ucomisd_MINUS0x28__rbp____xmm0.exit
  store i64 4198842, i64* %RSI.i143, align 8
...
block_.L_400e4c:                                  ; preds = %block_.L_400e45, %block_400dda
  %468 = phi i64 [ %.pre31, %block_.L_400e45 ], [ %403, %block_400dda ]
  %MEMORY.2 = phi %struct.Memory* [ %MEMORY.0, %block_.L_400e45 ], [ %390, %block_400dda ]
