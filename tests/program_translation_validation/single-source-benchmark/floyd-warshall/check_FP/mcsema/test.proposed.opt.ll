...
block_.L_400d67:                                  ; preds = %block_.L_400e42, %entry
  %95 = phi i64 [ %.pre, %entry ], [ %464, %block_.L_400e42 ]
  %MEMORY.0 = phi %struct.Memory* [ %2, %entry ], [ %MEMORY.1, %block_.L_400e42 ]
  ...
  br i1 %131, label %block_400d73, label %block_.L_400e55
...
block_.L_400d7a:                                  ; preds = %block_.L_400e2f, %block_400d73
  %136 = phi i64 [ %.pre29, %block_400d73 ], [ %434, %block_.L_400e2f ]
  %MEMORY.1 = phi %struct.Memory* [ %MEMORY.0, %block_400d73 ], [ %343, %block_.L_400e2f ]
  ...
  br i1 %172, label %block_400d86, label %block_.L_400e42
...
routine_ucomisd_MINUS0x28__rbp____xmm0.exit:      ; preds = %341, %329
  ...
  br i1 %347, label %block_.L_400e2f, label %block_400dea

block_400dea:                                     ; preds = %routine_ucomisd_MINUS0x28__rbp____xmm0.exit
  store i64 ptrtoint (%G__0x4011ca_type* @G__0x4011ca to i64), i64* %RSI.i143, align 8
...
block_.L_400e5c:                                  ; preds = %block_.L_400e55, %block_400dea
  %468 = phi i64 [ %.pre31, %block_.L_400e55 ], [ %403, %block_400dea ]
  %MEMORY.2 = phi %struct.Memory* [ %MEMORY.0, %block_.L_400e55 ], [ %390, %block_400dea ]
