...
define %struct.Memory* @kernel_floyd_warshall(%struct.State* noalias, i64, %struct.Memory* noalias) local_unnamed_addr #1 {
entry:
...
block_.L_400a92:                                  ; preds = %block_.L_400bab, %entry
  %41 = phi i64 [ %.pre, %entry ], [ %585, %block_.L_400bab ]
  %MEMORY.0 = phi %struct.Memory* [ %2, %entry ], [ %MEMORY.1, %block_.L_400bab ]
  ...
  br i1 %77, label %block_400a9e, label %block_.L_400bbe
...
block_.L_400aa5:                                  ; preds = %block_.L_400b98, %block_400a9e
  %82 = phi i64 [ %.pre1, %block_400a9e ], [ %555, %block_.L_400b98 ]
  %MEMORY.1 = phi %struct.Memory* [ %MEMORY.0, %block_400a9e ], [ %MEMORY.2, %block_.L_400b98 ]
  ...
  br i1 %118, label %block_400ab1, label %block_.L_400bab
...
block_400ab1:                                     ; preds = %block_.L_400aa5
  ...
  br label %block_.L_400ab8

block_.L_400ab8:                                  ; preds = %block_.L_400b6d, %block_400ab1
  %123 = phi i64 [ %.pre2, %block_400ab1 ], [ %525, %block_.L_400b6d ]
  %MEMORY.2 = phi %struct.Memory* [ %MEMORY.1, %block_400ab1 ], [ %326, %block_.L_400b6d ]
  ...
  br i1 %159, label %block_400ac4, label %block_.L_400b98

block_400ac4:                                     ; preds = %block_.L_400ab8
  %161 = add i64 %124, -16
  %162 = add i64 %160, 4
...
routine_ucomisd__xmm0___xmm1.exit:                ; preds = %320, %308
  %323 = phi i8 [ %.pre5, %308 ], [ %321, %320 ]
  %324 = phi i8 [ %.pre4, %308 ], [ %322, %320 ]
  %325 = phi i64 [ %.pre3, %308 ], [ %297, %320 ]
  %326 = phi %struct.Memory* [ %309, %308 ], [ %MEMORY.2, %320 ]
  %327 = or i8 %323, %324
  %328 = icmp ne i8 %327, 0
  %.v9 = select i1 %328, i64 40, i64 6
  %329 = add i64 %325, %.v9
  ...
  br i1 %328, label %block_.L_400b38, label %block_400b16

block_400b16:                                     ; preds = %routine_ucomisd__xmm0___xmm1.exit
  %369 = add i64 %330, -24
  %370 = add i64 %329, 19
...
block_.L_400b38:                                  ; preds = %routine_ucomisd__xmm0___xmm1.exit
  %384 = add i64 %330, -28
  %385 = add i64 %329, 19
  ...
  store i64 %432, i64* %RCX.i163, align 8
  ...
  %438 = fadd double %393, %437
  store double %438, double* %34, align 1
...
block_.L_400b6d:                                  ; preds = %block_.L_400b38, %block_400b16
  %442 = phi i64 [ %.pre6, %block_.L_400b38 ], [ %383, %block_400b16 ]
  ...
  store i64 %451, i64* %RAX.i191, align 8
  %452 = add i64 %443, -20
  %453 = add i64 %442, 13
  ...
  store i64 %457, i64* %RCX.i163, align 8
  %458 = lshr i64 %456, 50
  %459 = and i64 %458, 1
  %460 = add i64 %457, %451
  ...
  store i64 %489, i64* %RCX.i163, align 8
  %490 = shl nsw i64 %489, 3
  %491 = add i64 %490, %460
  %492 = add i64 %442, 29
  store i64 %492, i64* %3, align 8
  %493 = inttoptr i64 %491 to i64*
  store i64 %447, i64* %493, align 8
  ...
  store i64 %501, i64* %RAX.i191, align 8
...
block_.L_400b98:                                  ; preds = %block_.L_400ab8
  %526 = add i64 %124, -20
  %527 = add i64 %160, 8
  ...
  store i64 %531, i64* %RAX.i191, align 8
...
block_.L_400bab:                                  ; preds = %block_.L_400aa5
  %556 = add i64 %83, -28
  %557 = add i64 %119, 8
  ...
  store i64 %561, i64* %RAX.i191, align 8
...
block_.L_400bbe:                                  ; preds = %block_.L_400a92
  %586 = add i64 %78, 1
  ...
  store i64 %590, i64* %RBP.i, align 8
...
define %struct.Memory* @routine_jge_.L_400bbe(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i8* %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
...
define %struct.Memory* @routine_jge_.L_400bab(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i8* %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 2, i32 9
...
define %struct.Memory* @routine_jge_.L_400b98(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i8* %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 2, i32 9
...
define %struct.Memory* @routine_jbe_.L_400b38(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i8* %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
...
define %struct.Memory* @routine_jmpq_.L_400b6d(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
...
define %struct.Memory* @routine_jmpq_.L_400ab8(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
...
define %struct.Memory* @routine_jmpq_.L_400b9d(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
...
define %struct.Memory* @routine_jmpq_.L_400aa5(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
...
define %struct.Memory* @routine_jmpq_.L_400bb0(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
