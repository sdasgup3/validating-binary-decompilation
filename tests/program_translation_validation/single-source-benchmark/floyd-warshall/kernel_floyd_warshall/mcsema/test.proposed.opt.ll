...
block_.L_400a92:                                  ; preds = %block_.L_400bab, %entry
  %42 = phi i64 [ %.pre, %entry ], [ %591, %block_.L_400bab ]
  ...
  br i1 %78, label %block_400a9e, label %block_.L_400bbe
...
block_.L_400aa5:                                  ; preds = %block_.L_400b98, %block_400a9e
  %83 = phi i64 [ %.pre1, %block_400a9e ], [ %560, %block_.L_400b98 ]
  ...
  br i1 %119, label %block_400ab1, label %block_.L_400bab
...
block_.L_400ab8:                                  ; preds = %block_.L_400b6d, %block_400ab1
  %124 = phi i64 [ %.pre2, %block_400ab1 ], [ %529, %block_.L_400b6d ]
  ...
  br i1 %160, label %block_400ac4, label %block_.L_400b98
...
block_.L_400b6d:                                  ; preds = %block_.L_400b38, %block_400b16
  %444 = phi i64 [ %.pre6, %block_.L_400b38 ], [ %385, %block_400b16 ]
