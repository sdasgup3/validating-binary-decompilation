...
block_.L_400bd2:                                  ; preds = %block_.L_400ceb, %entry
  %41 = phi i64 [ %.pre, %entry ], [ %585, %block_.L_400ceb ]
...
block_.L_400be5:                                  ; preds = %block_.L_400cd8, %block_400bde
  %82 = phi i64 [ %.pre1, %block_400bde ], [ %555, %block_.L_400cd8 ]
...
block_.L_400bf8:                                  ; preds = %block_.L_400cad, %block_400bf1
  %123 = phi i64 [ %.pre2, %block_400bf1 ], [ %525, %block_.L_400cad ]
  %MEMORY.2 = phi %struct.Memory* [ %MEMORY.1, %block_400bf1 ], [ %326, %block_.L_400cad ]
...
routine_ucomisd__xmm0___xmm1.exit:                ; preds = %320, %308
  ...
  br i1 %328, label %block_.L_400c78, label %block_400c56
...
block_.L_400cad:                                  ; preds = %block_.L_400c78, %block_400c56
  %442 = phi i64 [ %.pre6, %block_.L_400c78 ], [ %383, %block_400c56 ]
