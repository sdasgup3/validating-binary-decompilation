...
declare %struct.Memory* @sub_400a80.kernel_floyd_warshall(%struct.State* noalias dereferenceable(3376), i64, %struct.Memory* noalias readnone returned)

declare %struct.Memory* @sub_400bc0.kernel_floyd_warshall_StrictFP(%struct.State* noalias dereferenceable(3376), i64, %struct.Memory* noalias readnone returned)

declare %struct.Memory* @sub_400d00.check_FP(%struct.State* noalias dereferenceable(3376), i64, %struct.Memory* noalias readnone returned)

declare %struct.Memory* @sub_400e30.print_array(%struct.State* noalias dereferenceable(3376), i64, %struct.Memory* noalias readnone returned)
...
entry:
  ...
  %call2_40096f = call %struct.Memory* @sub_400a80.kernel_floyd_warshall(%struct.State* %0, i64 %loadPC_40096f, %struct.Memory* %loadMem2_40096f)
  ...
  store %struct.Memory* %loadMem1_40097b, %struct.Memory** %MEMORY
  ...
  %call2_400987 = call %struct.Memory* @sub_400bc0.kernel_floyd_warshall_StrictFP(%struct.State* %0, i64 %loadPC_400987, %struct.Memory* %loadMem2_400987)
  ...
  %call2_400997 = call %struct.Memory* @sub_400d00.check_FP(%struct.State* %0, i64 %loadPC_400997, %struct.Memory* %loadMem2_400997)
...
block_.L_4009b1:                                  ; preds = %entry
  ...
  store %struct.Memory* %loadMem1_4009b8, %struct.Memory** %MEMORY
  %loadMem2_4009b8 = load %struct.Memory*, %struct.Memory** %MEMORY
  %loadPC_4009b8 = load i64, i64* %3
  %call2_4009b8 = call %struct.Memory* @sub_400e30.print_array(%struct.State* %0, i64 %loadPC_4009b8, %struct.Memory* %loadMem2_4009b8)
  ...
  %654 = call %struct.Memory* @__remill_function_call(%struct.State* %0, i64 ptrtoint (i64 (i64)* @free to i64), %struct.Memory* %loadMem2_4009c4)
  ...
  %696 = call %struct.Memory* @__remill_function_call(%struct.State* %0, i64 ptrtoint (i64 (i64)* @free to i64), %struct.Memory* %loadMem2_4009d0)
