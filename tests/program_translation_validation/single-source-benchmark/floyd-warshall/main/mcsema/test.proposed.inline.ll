...
declare %struct.Memory* @sub_400ab0.kernel_floyd_warshall(%struct.State* noalias dereferenceable(3376), i64, %struct.Memory* noalias readnone returned)

declare %struct.Memory* @sub_400bf0.kernel_floyd_warshall_StrictFP(%struct.State* noalias dereferenceable(3376), i64, %struct.Memory* noalias readnone returned)

declare %struct.Memory* @sub_400d30.check_FP(%struct.State* noalias dereferenceable(3376), i64, %struct.Memory* noalias readnone returned)

declare %struct.Memory* @sub_400e60.print_array(%struct.State* noalias dereferenceable(3376), i64, %struct.Memory* noalias readnone returned)
...
entry:
  ...
  %call2_40099f = call %struct.Memory* @sub_400ab0.kernel_floyd_warshall(%struct.State* %0, i64 %loadPC_40099f, %struct.Memory* %loadMem2_40099f)
  ...
  store %struct.Memory* %loadMem1_4009ab, %struct.Memory** %MEMORY
  ...
  %call2_4009b7 = call %struct.Memory* @sub_400bf0.kernel_floyd_warshall_StrictFP(%struct.State* %0, i64 %loadPC_4009b7, %struct.Memory* %loadMem2_4009b7)
  ...
  %call2_4009c7 = call %struct.Memory* @sub_400d30.check_FP(%struct.State* %0, i64 %loadPC_4009c7, %struct.Memory* %loadMem2_4009c7)
...
block_.L_4009e1:                                  ; preds = %entry
  ...
  store %struct.Memory* %loadMem1_4009e8, %struct.Memory** %MEMORY
  %loadMem2_4009e8 = load %struct.Memory*, %struct.Memory** %MEMORY
  %loadPC_4009e8 = load i64, i64* %3
  %call2_4009e8 = call %struct.Memory* @sub_400e60.print_array(%struct.State* %0, i64 %loadPC_4009e8, %struct.Memory* %loadMem2_4009e8)
  ...
  %654 = call %struct.Memory* @__remill_function_call(%struct.State* %0, i64 ptrtoint (i64 (i64)* @free to i64), %struct.Memory* %loadMem2_4009f4)
  ...
  %696 = call %struct.Memory* @__remill_function_call(%struct.State* %0, i64 ptrtoint (i64 (i64)* @free to i64), %struct.Memory* %loadMem2_400a00)
...
block_.L_400a0c:                                  ; preds = %block_.L_4009e1, %block_4009d5
  ...
  ret %struct.Memory* %loadMem_400a14
}
