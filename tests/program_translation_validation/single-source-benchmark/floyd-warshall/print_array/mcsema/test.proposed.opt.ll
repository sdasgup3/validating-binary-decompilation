...
declare %struct.Memory* @sub_400f30.print_element(%struct.State* noalias dereferenceable(3376), i64, %struct.Memory* noalias readnone returned) local_unnamed_addr
...
block_.L_400e9c:                                  ; preds = %block_.L_400ef2, %entry
  %123 = phi i64 [ %353, %block_.L_400ef2 ], [ %.pre, %entry ]
...
block_.L_400eaf:                                  ; preds = %block_400ebb, %block_400ea8
  %164 = phi i64 [ %305, %block_400ebb ], [ %.pre9, %block_400ea8 ]
...
block_400ebb:                                     ; preds = %block_.L_400eaf
  ...
  %call2_400edf = tail call %struct.Memory* @sub_400f30.print_element(%struct.State* nonnull %0, i64 %269, %struct.Memory* %call2_400e7b)
...
block_.L_400ef2:                                  ; preds = %block_.L_400eaf
  ...
  %call2_400efe = tail call %struct.Memory* @sub_400610.fputs_plt(%struct.State* nonnull %0, i64 %311, %struct.Memory* %call2_400e7b)
...
block_.L_400f14:                                  ; preds = %block_.L_400e9c
  ...
  %call2_400f18 = tail call %struct.Memory* @sub_4005f0.free_plt(%struct.State* nonnull %0, i64 %358, %struct.Memory* %call2_400e7b)
