...
block_.L_400e6c:                                  ; preds = %block_.L_400ec2, %entry
  %117 = phi i64 [ %.pre, %entry ], [ %348, %block_.L_400ec2 ]
  %MEMORY.0 = phi %struct.Memory* [ %73, %entry ], [ %310, %block_.L_400ec2 ]
...
block_.L_400e7f:                                  ; preds = %block_400e8b, %block_400e78
  %158 = phi i64 [ %.pre1, %block_400e78 ], [ %299, %block_400e8b ]
...
block_400e8b:                                     ; preds = %block_.L_400e7f
  ...
  %call2_400eaf = tail call %struct.Memory* @sub_400f00.print_element(%struct.State* %0, i64 %263, %struct.Memory* %MEMORY.1)
