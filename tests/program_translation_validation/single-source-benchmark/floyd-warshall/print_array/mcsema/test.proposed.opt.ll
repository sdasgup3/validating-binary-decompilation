...
declare %struct.Memory* @sub_400f30.print_element(%struct.State* dereferenceable(3376), i64, %struct.Memory*) local_unnamed_addr
...
entry:
  ...
  %call2_400e7b = tail call %struct.Memory* @sub_400640.malloc_plt(%struct.State* %0, i64 %74, %struct.Memory* %2)
...
block_.L_400e9c:                                  ; preds = %block_.L_400ef2, %entry
  %123 = phi i64 [ %.pre, %entry ], [ %353, %block_.L_400ef2 ]
  %MEMORY.0 = phi %struct.Memory* [ %call2_400e7b, %entry ], [ %call2_400efe, %block_.L_400ef2 ]
  ...
  br i1 %159, label %block_400ea8, label %block_.L_400f14
...
block_.L_400eaf:                                  ; preds = %block_400ebb, %block_400ea8
  %164 = phi i64 [ %.pre9, %block_400ea8 ], [ %305, %block_400ebb ]
  %MEMORY.1 = phi %struct.Memory* [ %MEMORY.0, %block_400ea8 ], [ %call2_400edf, %block_400ebb ]
  ...
  br i1 %200, label %block_400ebb, label %block_.L_400ef2
...
block_400ebb:                                     ; preds = %block_.L_400eaf
  ...
  %call2_400edf = tail call %struct.Memory* @sub_400f30.print_element(%struct.State* nonnull %0, i64 %269, %struct.Memory* %MEMORY.1)
...
block_.L_400ef2:                                  ; preds = %block_.L_400eaf
  ...
  %call2_400efe = tail call %struct.Memory* @sub_400610.fputs_plt(%struct.State* nonnull %0, i64 %311, %struct.Memory* %MEMORY.1)
...
block_.L_400f14:                                  ; preds = %block_.L_400e9c
  ...
  %call2_400f18 = tail call %struct.Memory* @sub_4005f0.free_plt(%struct.State* nonnull %0, i64 %358, %struct.Memory* %MEMORY.0)
  ...
  ret %struct.Memory* %call2_400f18
}
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_jge_.L_400f14(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i8* nocapture %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_jmpq_.L_400eaf(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_jmpq_.L_400e9c(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
