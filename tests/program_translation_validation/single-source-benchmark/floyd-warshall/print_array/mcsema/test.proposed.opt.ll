...
block_.L_400e9c:                                  ; preds = %block_.L_400ef2, %entry
  %124 = phi i64 [ %.pre, %entry ], [ %355, %block_.L_400ef2 ]
  %MEMORY.0 = phi %struct.Memory* [ %79, %entry ], [ %317, %block_.L_400ef2 ]
  ...
  br i1 %160, label %block_400ea8, label %block_.L_400f14
...
block_.L_400eaf:                                  ; preds = %block_400ebb, %block_400ea8
  %165 = phi i64 [ %306, %block_400ebb ], [ %.pre9, %block_400ea8 ]
  ...
  br i1 %201, label %block_400ebb, label %block_.L_400ef2
...
block_400ebb:                                     ; preds = %block_.L_400eaf
  ...
  %call2_400edf = tail call %struct.Memory* @sub_400f30.print_element(%struct.State* nonnull %0, i64 %270, %struct.Memory* %MEMORY.0)
