...
declare %struct.Memory* @sub_400f40.print_element(%struct.State* noalias dereferenceable(3376), i64, %struct.Memory* noalias readnone returned) local_unnamed_addr
...
block_.L_400eac:                                  ; preds = %block_.L_400f02, %entry
  %124 = phi i64 [ %.pre, %entry ], [ %355, %block_.L_400f02 ]
  %MEMORY.0 = phi %struct.Memory* [ %79, %entry ], [ %317, %block_.L_400f02 ]
  ...
  br i1 %160, label %block_400eb8, label %block_.L_400f24
...
block_.L_400ebf:                                  ; preds = %block_400ecb, %block_400eb8
  %165 = phi i64 [ %306, %block_400ecb ], [ %.pre9, %block_400eb8 ]
  ...
  br i1 %201, label %block_400ecb, label %block_.L_400f02
...
block_400ecb:                                     ; preds = %block_.L_400ebf
  ...
  %call2_400eef = tail call %struct.Memory* @sub_400f40.print_element(%struct.State* nonnull %0, i64 %270, %struct.Memory* %MEMORY.0)
