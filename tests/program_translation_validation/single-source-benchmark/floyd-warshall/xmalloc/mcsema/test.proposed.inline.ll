...
@G__0x401157 = global %G__0x401157_type zeroinitializer
...
entry:
  ...
  %169 = call %struct.Memory* @__remill_function_call(%struct.State* %0, i64 ptrtoint (i64 (i64, i64, i64)* @posix_memalign to i64), %struct.Memory* %loadMem2_4008b6)
...
block_.L_4008d3:                                  ; preds = %block_4008c9, %entry
  ...
  store i64 ptrtoint (%G__0x401157_type* @G__0x401157 to i64), i64* %RSI.i, align 8
  ...
  store %struct.Memory* %loadMem1_4008e7, %struct.Memory** %MEMORY
  %loadMem2_4008e7 = load %struct.Memory*, %struct.Memory** %MEMORY
  %loadPC_4008e7 = load i64, i64* %3
  %319 = call %struct.Memory* @__remill_function_call(%struct.State* %0, i64 ptrtoint (i64 (i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64)* @fprintf to i64), %struct.Memory* %loadMem2_4008e7)
  ...
  store %struct.Memory* %loadMem1_4008f4, %struct.Memory** %MEMORY
  %loadMem2_4008f4 = load %struct.Memory*, %struct.Memory** %MEMORY
  %loadPC_4008f4 = load i64, i64* %3
  %358 = call %struct.Memory* @__remill_function_call(%struct.State* %0, i64 ptrtoint (i64 (i64)* @exit to i64), %struct.Memory* %loadMem2_4008f4)
  store %struct.Memory* %358, %struct.Memory** %MEMORY
  br label %block_.L_4008f9

block_.L_4008f9:                                  ; preds = %block_.L_4008d3, %block_4008c9
  ...
  ret %struct.Memory* %loadMem_400902
}
...
define %struct.Memory* @routine_movq__0x401157___rsi(%struct.State* dereferenceable(3376), i64, %struct.Memory*) {
block_400478:
  %3 = getelementptr inbounds %struct.State, %struct.State* %0, i32 0, i32 6
  %4 = getelementptr inbounds %struct.GPR, %struct.GPR* %3, i32 0, i32 33
  %5 = getelementptr inbounds %struct.Reg, %struct.Reg* %4, i32 0, i32 0
  ...
  %10 = add i64 %9, 10
  store i64 %10, i64* %PC
  store i64 ptrtoint (%G__0x401157_type* @G__0x401157 to i64), i64* %RSI, align 8
  ret %struct.Memory* %2
}
