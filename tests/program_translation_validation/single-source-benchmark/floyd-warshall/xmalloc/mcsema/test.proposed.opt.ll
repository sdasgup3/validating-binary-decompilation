...
block_.L_400903:                                  ; preds = %block_4008f9, %entry
  ...
  store i64 4198791, i64* %RSI.i37, align 8
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_movq__0x401187___rsi(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %RSI = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 9, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
