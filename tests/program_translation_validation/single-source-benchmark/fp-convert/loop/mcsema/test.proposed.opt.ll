...
block_.L_400540:                                  ; preds = %block_40054e, %entry
  %51 = phi i64 [ %152, %block_40054e ], [ %.pre, %entry ]
  ...
  br i1 %87, label %block_40054e, label %block_.L_400587

block_40054e:                                     ; preds = %block_.L_400540
  %89 = add i64 %52, -8
  %90 = add i64 %88, 4
...
block_.L_400587:                                  ; preds = %block_.L_400540
  %153 = add i64 %52, -40
  %154 = add i64 %88, 5
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_jge_.L_400587(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i8* nocapture %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
