...
block_.L_400eda:                                  ; preds = %block_.L_400fba, %entry
...
block_.L_400eed:                                  ; preds = %block_.L_400fa7, %block_400ee6
...
; <label>:828:                                    ; preds = %820
  ...
  %831 = call %struct.Memory* @__remill_error(%struct.State* nonnull dereferenceable(3376) %0, i64 %830, %struct.Memory* %loadMem_400f52)
  br label %routine_ucomisd_MINUS0x30__rbp____xmm0.exit

; <label>:832:                                    ; preds = %block_400ef9
...
routine_ucomisd_MINUS0x30__rbp____xmm0.exit:      ; preds = %828, %845
  %849 = phi %struct.Memory* [ %831, %828 ], [ %loadMem_400f52, %845 ]
...
block_400f5d:                                     ; preds = %routine_ucomisd_MINUS0x30__rbp____xmm0.exit
  ...
  store %struct.Memory* %loadMem1_400f8e, %struct.Memory** %MEMORY
  %loadMem2_400f8e = load %struct.Memory*, %struct.Memory** %MEMORY
  %loadPC_400f8e = load i64, i64* %3
  %1028 = call %struct.Memory* @__remill_function_call(%struct.State* %0, i64 ptrtoint (i64 (i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64)* @fprintf to i64), %struct.Memory* %loadMem2_400f8e)
...
block_.L_400fa7:                                  ; preds = %block_.L_400fa2
...
block_.L_400fba:                                  ; preds = %block_.L_400fb5
...
block_.L_400fcf:                                  ; preds = %block_.L_400fc8, %block_400f5d
  ...
  ret %struct.Memory* %loadMem_400fd7
}
...
define %struct.Memory* @routine_movq__0x40134a___rsi(%struct.State* dereferenceable(3376), i64, %struct.Memory*) {
block_400488:
  %3 = getelementptr inbounds %struct.State, %struct.State* %0, i32 0, i32 6
  %4 = getelementptr inbounds %struct.GPR, %struct.GPR* %3, i32 0, i32 33
  %5 = getelementptr inbounds %struct.Reg, %struct.Reg* %4, i32 0, i32 0
