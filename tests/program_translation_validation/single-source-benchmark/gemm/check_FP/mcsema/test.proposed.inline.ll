...
@G_0x438__rip__4198048_ = global %G_0x438__rip__4198048__type zeroinitializer
...
entry:
  ...
  %76 = load double, double* bitcast (%G_0x438__rip__4198048__type* @G_0x438__rip__4198048_ to double*)
...
block_.L_400eba:                                  ; preds = %block_.L_400f9a, %entry
...
block_.L_400ecd:                                  ; preds = %block_.L_400f87, %block_400ec6
...
block_400ed9:                                     ; preds = %block_.L_400ecd
  ...
  %710 = load float, float* bitcast (%G_0x3bc__rip__4198180__type* @G_0x3bc__rip__4198180_ to float*)
  %711 = load float, float* inttoptr (i64 add (i64 ptrtoint (%G_0x3bc__rip__4198180__type* @G_0x3bc__rip__4198180_ to i64), i64 4) to float*)
  %712 = load float, float* inttoptr (i64 add (i64 ptrtoint (%G_0x3bc__rip__4198180__type* @G_0x3bc__rip__4198180_ to i64), i64 8) to float*)
  %713 = load float, float* inttoptr (i64 add (i64 ptrtoint (%G_0x3bc__rip__4198180__type* @G_0x3bc__rip__4198180_ to i64), i64 12) to float*)
...
; <label>:818:                                    ; preds = %810
  ...
  %821 = call %struct.Memory* @__remill_error(%struct.State* nonnull dereferenceable(3376) %0, i64 %820, %struct.Memory* %loadMem_400f32)
  br label %routine_ucomisd_MINUS0x30__rbp____xmm0.exit

; <label>:822:                                    ; preds = %block_400ed9
...
routine_ucomisd_MINUS0x30__rbp____xmm0.exit:      ; preds = %818, %835
  %839 = phi %struct.Memory* [ %821, %818 ], [ %loadMem_400f32, %835 ]
...
block_400f3d:                                     ; preds = %routine_ucomisd_MINUS0x30__rbp____xmm0.exit
  ...
  %1018 = call %struct.Memory* @__remill_function_call(%struct.State* %0, i64 ptrtoint (i64 (i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64)* @fprintf to i64), %struct.Memory* %loadMem2_400f6e)
...
block_.L_400f87:                                  ; preds = %block_.L_400f82
...
block_.L_400f9a:                                  ; preds = %block_.L_400f95
...
block_.L_400faf:                                  ; preds = %block_.L_400fa8, %block_400f3d
  ...
  ret %struct.Memory* %loadMem_400fb7
}
...
define %struct.Memory* @routine_movq__0x40132a___rsi(%struct.State* dereferenceable(3376), i64, %struct.Memory*) {
block_400478:
  %3 = getelementptr inbounds %struct.State, %struct.State* %0, i32 0, i32 6
  %4 = getelementptr inbounds %struct.GPR, %struct.GPR* %3, i32 0, i32 33
  %5 = getelementptr inbounds %struct.Reg, %struct.Reg* %4, i32 0, i32 0
