...
%G_0x3bc__rip__4198180__type = type <{ [16 x i8] }>
%G_0x438__rip__4198048__type = type <{ [16 x i8] }>
...
@G_0x3bc__rip__4198180_ = global %G_0x3bc__rip__4198180__type zeroinitializer
@G_0x438__rip__4198048_ = local_unnamed_addr global %G_0x438__rip__4198048__type zeroinitializer
...
entry:
  ...
  %42 = load i64, i64* bitcast (%G_0x438__rip__4198048__type* @G_0x438__rip__4198048_ to i64*), align 8
...
block_.L_400eba:                                  ; preds = %block_.L_400f95, %entry
  %95 = phi i64 [ %.pre, %entry ], [ %457, %block_.L_400f95 ]
  ...
  br i1 %131, label %block_400ec6, label %block_.L_400fa8
...
block_.L_400ecd:                                  ; preds = %block_.L_400f82, %block_400ec6
  %136 = phi i64 [ %.pre3, %block_400ec6 ], [ %427, %block_.L_400f82 ]
  %MEMORY.1 = phi %struct.Memory* [ %MEMORY.0, %block_400ec6 ], [ %336, %block_.L_400f82 ]
  ...
  br i1 %172, label %block_400ed9, label %block_.L_400f95
...
block_400ed9:                                     ; preds = %block_.L_400ecd
  ...
  %285 = load i32, i32* bitcast (%G_0x3bc__rip__4198180__type* @G_0x3bc__rip__4198180_ to i32*), align 8
  %286 = load i32, i32* inttoptr (i64 add (i64 ptrtoint (%G_0x3bc__rip__4198180__type* @G_0x3bc__rip__4198180_ to i64), i64 4) to i32*), align 4
  %287 = load i32, i32* inttoptr (i64 add (i64 ptrtoint (%G_0x3bc__rip__4198180__type* @G_0x3bc__rip__4198180_ to i64), i64 8) to i32*), align 8
  %288 = load i32, i32* inttoptr (i64 add (i64 ptrtoint (%G_0x3bc__rip__4198180__type* @G_0x3bc__rip__4198180_ to i64), i64 12) to i32*), align 4
...
routine_ucomisd_MINUS0x30__rbp____xmm0.exit:      ; preds = %334, %322
  ...
  br i1 %340, label %block_.L_400f82, label %block_400f3d
...
block_.L_400faf:                                  ; preds = %block_.L_400fa8, %block_400f3d
  %461 = phi i64 [ %.pre5, %block_.L_400fa8 ], [ %396, %block_400f3d ]
  %MEMORY.2 = phi %struct.Memory* [ %MEMORY.0, %block_.L_400fa8 ], [ %383, %block_400f3d ]
...
block_400478:
  ...
  %5 = load i64, i64* bitcast (%G_0x438__rip__4198048__type* @G_0x438__rip__4198048_ to i64*), align 8
...
block_400478:
  ...
  %6 = add i64 %5, 7
  store i64 %6, i64* %PC, align 8
  %7 = load i32, i32* bitcast (%G_0x3bc__rip__4198180__type* @G_0x3bc__rip__4198180_ to i32*), align 8
  %8 = load i32, i32* inttoptr (i64 add (i64 ptrtoint (%G_0x3bc__rip__4198180__type* @G_0x3bc__rip__4198180_ to i64), i64 4) to i32*), align 4
  %9 = load i32, i32* inttoptr (i64 add (i64 ptrtoint (%G_0x3bc__rip__4198180__type* @G_0x3bc__rip__4198180_ to i64), i64 8) to i32*), align 8
  %10 = load i32, i32* inttoptr (i64 add (i64 ptrtoint (%G_0x3bc__rip__4198180__type* @G_0x3bc__rip__4198180_ to i64), i64 12) to i32*), align 4
