...
@G__0x40132a = global %G__0x40132a_type zeroinitializer
...
block_.L_400eba:                                  ; preds = %block_.L_400f95, %entry
  %96 = phi i64 [ %.pre, %entry ], [ %465, %block_.L_400f95 ]
  %MEMORY.0 = phi %struct.Memory* [ %2, %entry ], [ %MEMORY.1, %block_.L_400f95 ]
  ...
  br i1 %132, label %block_400ec6, label %block_.L_400fa8
...
block_.L_400ecd:                                  ; preds = %block_.L_400f82, %block_400ec6
  %137 = phi i64 [ %.pre3, %block_400ec6 ], [ %434, %block_.L_400f82 ]
  %MEMORY.1 = phi %struct.Memory* [ %MEMORY.0, %block_400ec6 ], [ %340, %block_.L_400f82 ]
  ...
  br i1 %173, label %block_400ed9, label %block_.L_400f95

block_400ed9:                                     ; preds = %block_.L_400ecd
  %175 = add i64 %138, -24
  %176 = add i64 %174, 4
...
routine_ucomisd_MINUS0x30__rbp____xmm0.exit:      ; preds = %338, %326
  ...
  br i1 %344, label %block_.L_400f82, label %block_400f3d

block_400f3d:                                     ; preds = %routine_ucomisd_MINUS0x30__rbp____xmm0.exit
  %RSI.i = getelementptr inbounds %union.anon, %union.anon* %52, i64 0, i32 0
  store i64 ptrtoint (%G__0x40132a_type* @G__0x40132a to i64), i64* %RSI.i, align 8
...
block_.L_400f82:                                  ; preds = %routine_ucomisd_MINUS0x30__rbp____xmm0.exit
...
block_.L_400f95:                                  ; preds = %block_.L_400ecd
  %435 = add i64 %138, -36
  %436 = add i64 %174, 8
...
block_.L_400fa8:                                  ; preds = %block_.L_400eba
  %466 = add i64 %97, -4
  %467 = add i64 %133, 7
...
block_.L_400faf:                                  ; preds = %block_.L_400fa8, %block_400f3d
  %469 = phi i64 [ %.pre5, %block_.L_400fa8 ], [ %402, %block_400f3d ]
  %MEMORY.2 = phi %struct.Memory* [ %MEMORY.0, %block_.L_400fa8 ], [ %389, %block_400f3d ]
...
define %struct.Memory* @routine_jge_.L_400fa8(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i8* %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
...
define %struct.Memory* @routine_jge_.L_400f95(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i8* %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 2, i32 9
...
define %struct.Memory* @routine_jbe_.L_400f82(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i8* %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
...
define %struct.Memory* @routine_movq__0x40132a___rsi(%struct.State* dereferenceable(3376), i64, %struct.Memory*) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  ...
  %4 = add i64 %3, 10
  store i64 %4, i64* %PC, align 8
  store i64 ptrtoint (%G__0x40132a_type* @G__0x40132a to i64), i64* %RSI, align 8
  ret %struct.Memory* %2
}
...
define %struct.Memory* @routine_jmpq_.L_400faf(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
...
define %struct.Memory* @routine_jmpq_.L_400f87(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
...
define %struct.Memory* @routine_jmpq_.L_400ecd(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
