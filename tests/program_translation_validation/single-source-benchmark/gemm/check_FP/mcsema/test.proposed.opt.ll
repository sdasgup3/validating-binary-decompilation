...
block_.L_400eda:                                  ; preds = %block_.L_400fb5, %entry
  %102 = phi i64 [ %.pre, %entry ], [ %470, %block_.L_400fb5 ]
...
block_.L_400eed:                                  ; preds = %block_.L_400fa2, %block_400ee6
  %143 = phi i64 [ %.pre29, %block_400ee6 ], [ %440, %block_.L_400fa2 ]
...
block_400f5d:                                     ; preds = %routine_ucomisd_MINUS0x30__rbp____xmm0.exit
  ...
  %call2_400f8e = tail call %struct.Memory* @sub_400630.fprintf_plt(%struct.State* nonnull %0, i64 %392, %struct.Memory* %350)
...
block_.L_400fcf:                                  ; preds = %block_.L_400fc8, %block_400f5d
  %474 = phi i64 [ %.pre31, %block_.L_400fc8 ], [ %409, %block_400f5d ]
  %MEMORY.2 = phi %struct.Memory* [ %MEMORY.0, %block_.L_400fc8 ], [ %call2_400f8e, %block_400f5d ]
