...
block_.L_400eea:                                  ; preds = %block_.L_400fc5, %entry
  %102 = phi i64 [ %.pre, %entry ], [ %471, %block_.L_400fc5 ]
  %MEMORY.0 = phi %struct.Memory* [ %2, %entry ], [ %MEMORY.1, %block_.L_400fc5 ]
  ...
  br i1 %138, label %block_400ef6, label %block_.L_400fd8
...
block_400ef6:                                     ; preds = %block_.L_400eea
  ...
  br label %block_.L_400efd

block_.L_400efd:                                  ; preds = %block_.L_400fb2, %block_400ef6
  %143 = phi i64 [ %.pre29, %block_400ef6 ], [ %441, %block_.L_400fb2 ]
  %MEMORY.1 = phi %struct.Memory* [ %MEMORY.0, %block_400ef6 ], [ %350, %block_.L_400fb2 ]
  ...
  br i1 %179, label %block_400f09, label %block_.L_400fc5

block_400f09:                                     ; preds = %block_.L_400efd
  %181 = add i64 %144, -24
  %182 = add i64 %180, 4
...
routine_ucomisd_MINUS0x30__rbp____xmm0.exit:      ; preds = %348, %336
  ...
  br i1 %354, label %block_.L_400fb2, label %block_400f6d
...
block_400f6d:                                     ; preds = %routine_ucomisd_MINUS0x30__rbp____xmm0.exit
  ...
  store i64 ptrtoint (%G__0x40135a_type* @G__0x40135a to i64), i64* %RSI.i, align 8
...
block_.L_400fb2:                                  ; preds = %routine_ucomisd_MINUS0x30__rbp____xmm0.exit
...
block_.L_400fc5:                                  ; preds = %block_.L_400efd
  %442 = add i64 %144, -36
  %443 = add i64 %180, 8
...
block_.L_400fd8:                                  ; preds = %block_.L_400eea
  %472 = add i64 %103, -4
  %473 = add i64 %139, 7
...
block_.L_400fdf:                                  ; preds = %block_.L_400fd8, %block_400f6d
  %475 = phi i64 [ %.pre31, %block_.L_400fd8 ], [ %410, %block_400f6d ]
  %MEMORY.2 = phi %struct.Memory* [ %MEMORY.0, %block_.L_400fd8 ], [ %397, %block_400f6d ]
