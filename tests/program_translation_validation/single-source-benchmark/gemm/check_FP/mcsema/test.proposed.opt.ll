...
block_.L_400eda:                                  ; preds = %block_.L_400fb5, %entry
  %102 = phi i64 [ %.pre, %entry ], [ %471, %block_.L_400fb5 ]
  %MEMORY.0 = phi %struct.Memory* [ %2, %entry ], [ %MEMORY.1, %block_.L_400fb5 ]
  ...
  br i1 %138, label %block_400ee6, label %block_.L_400fc8

block_400ee6:                                     ; preds = %block_.L_400eda
  %140 = add i64 %103, -40
  %141 = add i64 %139, 7
...
block_.L_400eed:                                  ; preds = %block_.L_400fa2, %block_400ee6
  %143 = phi i64 [ %.pre29, %block_400ee6 ], [ %441, %block_.L_400fa2 ]
  %MEMORY.1 = phi %struct.Memory* [ %MEMORY.0, %block_400ee6 ], [ %350, %block_.L_400fa2 ]
  ...
  br i1 %179, label %block_400ef9, label %block_.L_400fb5

block_400ef9:                                     ; preds = %block_.L_400eed
  %181 = add i64 %144, -24
  %182 = add i64 %180, 4
...
routine_ucomisd_MINUS0x30__rbp____xmm0.exit:      ; preds = %348, %336
  ...
  br i1 %354, label %block_.L_400fa2, label %block_400f5d

block_400f5d:                                     ; preds = %routine_ucomisd_MINUS0x30__rbp____xmm0.exit
  %RSI.i = getelementptr inbounds %union.anon, %union.anon* %55, i64 0, i32 0
  store i64 4199242, i64* %RSI.i, align 8
...
block_.L_400fa2:                                  ; preds = %routine_ucomisd_MINUS0x30__rbp____xmm0.exit
...
block_.L_400fb5:                                  ; preds = %block_.L_400eed
  %442 = add i64 %144, -36
  %443 = add i64 %180, 8
...
block_.L_400fc8:                                  ; preds = %block_.L_400eda
  %472 = add i64 %103, -4
  %473 = add i64 %139, 7
...
block_.L_400fcf:                                  ; preds = %block_.L_400fc8, %block_400f5d
  %475 = phi i64 [ %.pre31, %block_.L_400fc8 ], [ %410, %block_400f5d ]
  %MEMORY.2 = phi %struct.Memory* [ %MEMORY.0, %block_.L_400fc8 ], [ %397, %block_400f5d ]
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_jge_.L_400fc8(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i8* nocapture %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_jge_.L_400fb5(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i8* nocapture %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 2, i32 9
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_jbe_.L_400fa2(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i8* nocapture %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_movq__0x40134a___rsi(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  ...
  store i64 4199242, i64* %RSI, align 8
  ret %struct.Memory* %2
}
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_jmpq_.L_400eed(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_jmpq_.L_400eda(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
