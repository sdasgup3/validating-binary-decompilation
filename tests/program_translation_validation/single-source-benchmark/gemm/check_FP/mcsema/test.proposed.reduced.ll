; ModuleID = '/tmp/tmpo53iwkjg-query.ll'
...
entry:
  ...
  %var_2_1035 = load i64, i64* %RBP.i, align 8
  %var_2_1046 = add i64 %var_2_1035, -36
  %var_2_1067 = inttoptr i64 %var_2_1046 to i32*
  %var_2_1078 = load i32, i32* %var_2_1067, align 4
  %var_2_1099 = add i64 %var_2_1035, -8
  %var_2_11110 = inttoptr i64 %var_2_1099 to i32*
  %var_2_11211 = load i32, i32* %var_2_11110, align 4
  %var_2_11312 = sub i32 %var_2_1078, %var_2_11211
  %var_2_12813 = lshr i32 %var_2_11312, 31
  %var_2_13014 = lshr i32 %var_2_1078, 31
  %var_2_13115 = lshr i32 %var_2_11211, 31
  %var_2_13216 = xor i32 %var_2_13115, %var_2_13014
  %var_2_13317 = xor i32 %var_2_12813, %var_2_13014
  %var_2_13418 = add nuw nsw i32 %var_2_13317, %var_2_13216
  %var_2_13519 = icmp eq i32 %var_2_13418, 2
  %var_2_13720 = icmp ne i32 %var_2_12813, 0
  %var_2_13821 = xor i1 %var_2_13720, %var_2_13519
  br i1 %var_2_13821, label %block_400ef6.preheader, label %block_.L_400fdf
...
block_.L_400eea.loopexit:                         ; preds = %block_.L_400eea.loopexit.loopexit, %block_400ef6
  %var_2_144.lcssa = phi i64 [ %var_2_1447, %block_400ef6 ], [ %var_2_144.pre, %block_.L_400eea.loopexit.loopexit ]
  %MEMORY.1.lcssa = phi %struct.Memory* [ %MEMORY.022, %block_400ef6 ], [ %var_2_350, %block_.L_400eea.loopexit.loopexit ]
  ...
  br i1 %var_2_138, label %block_400ef6, label %block_.L_400fdf.loopexit9

block_400ef6:                                     ; preds = %block_400ef6.preheader, %block_.L_400eea.loopexit
  %var_2_1447 = phi i64 [ %var_2_144.lcssa, %block_.L_400eea.loopexit ], [ %var_2_1035, %block_400ef6.preheader ]
  %MEMORY.022 = phi %struct.Memory* [ %MEMORY.1.lcssa, %block_.L_400eea.loopexit ], [ %2, %block_400ef6.preheader ]
  %var_2_14515 = add i64 %var_2_1447, -40
  %var_2_14716 = inttoptr i64 %var_2_14515 to i32*
  %var_2_14817 = load i32, i32* %var_2_14716, align 4
  %var_2_15018 = add i64 %var_2_1447, -12
  %var_2_15219 = inttoptr i64 %var_2_15018 to i32*
  %var_2_15320 = load i32, i32* %var_2_15219, align 4
  %var_2_15421 = sub i32 %var_2_14817, %var_2_15320
  %var_2_16922 = lshr i32 %var_2_15421, 31
  %var_2_17123 = lshr i32 %var_2_14817, 31
  %var_2_17224 = lshr i32 %var_2_15320, 31
  %var_2_17325 = xor i32 %var_2_17224, %var_2_17123
  %var_2_17426 = xor i32 %var_2_16922, %var_2_17123
  %var_2_17527 = add nuw nsw i32 %var_2_17426, %var_2_17325
  %var_2_17628 = icmp eq i32 %var_2_17527, 2
  %var_2_17829 = icmp ne i32 %var_2_16922, 0
  %var_2_17930 = xor i1 %var_2_17829, %var_2_17628
  br i1 %var_2_17930, label %block_400f09.preheader, label %block_.L_400eea.loopexit
...
block_400f09:                                     ; preds = %block_400f09.preheader, %routine_ucomisd_MINUS0x30__rbp____xmm0.exit.block_.L_400efd_crit_edge
  %MEMORY.132 = phi %struct.Memory* [ %var_2_350, %routine_ucomisd_MINUS0x30__rbp____xmm0.exit.block_.L_400efd_crit_edge ], [ %MEMORY.022, %block_400f09.preheader ]
  %var_2_14431 = phi i64 [ %var_2_144.pre, %routine_ucomisd_MINUS0x30__rbp____xmm0.exit.block_.L_400efd_crit_edge ], [ %var_2_1447, %block_400f09.preheader ]
  %var_2_282 = add i64 %var_2_14431, -56
  ...
  %var_2_287 = add i64 %var_2_14431, -64
...
var_2_336:                                        ; preds = %var_2_328
  %var_2_337 = tail call %struct.Memory* @__remill_error(%struct.State* nonnull dereferenceable(3376) %0, i64 %var_2_323, %struct.Memory* %MEMORY.132)
...
routine_ucomisd_MINUS0x30__rbp____xmm0.exit:      ; preds = %var_2_336, %var_2_328, %block_400f09
  %var_2_350 = phi %struct.Memory* [ %var_2_337, %var_2_336 ], [ %MEMORY.132, %var_2_328 ], [ %MEMORY.132, %block_400f09 ]
  ...
  br i1 %var_2_354, label %block_.L_400fdf.loopexit, label %routine_ucomisd_MINUS0x30__rbp____xmm0.exit.block_.L_400efd_crit_edge
...
block_.L_400fdf.loopexit:                         ; preds = %routine_ucomisd_MINUS0x30__rbp____xmm0.exit
  br label %block_.L_400fdf

block_.L_400fdf.loopexit9:                        ; preds = %block_.L_400eea.loopexit
  br label %block_.L_400fdf

block_.L_400fdf:                                  ; preds = %block_.L_400fdf.loopexit9, %block_.L_400fdf.loopexit, %entry
...
; Function Attrs: alwaysinline
define %struct.Memory* @routine_ucomisd_MINUS0x30__rbp____xmm0(%struct.State* dereferenceable(3376), i64, %struct.Memory*) local_unnamed_addr #1 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %RBP = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 15, i32 0, i32 0
  %3 = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 1, i64 0
