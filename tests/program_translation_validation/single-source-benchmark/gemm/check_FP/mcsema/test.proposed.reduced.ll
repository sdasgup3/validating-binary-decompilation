; ModuleID = '/tmp/tmpaup_1isk-query.ll'
...
@G__0x40135a = global %G__0x40135a_type zeroinitializer
...
entry:
  ...
  %var_2_86 = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 1, i64 1
  %var_2_87 = bitcast %union.VectorReg* %var_2_86 to i8*
  %var_2_88 = bitcast %union.VectorReg* %var_2_86 to i32*
  %var_2_89 = getelementptr inbounds i8, i8* %var_2_87, i64 4
  %var_2_90 = bitcast i8* %var_2_89 to i32*
  %var_2_91 = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 1, i64 1, i32 0, i32 0, i32 0, i64 1
  %var_2_92 = bitcast i64* %var_2_91 to i32*
  %var_2_93 = getelementptr inbounds i8, i8* %var_2_87, i64 12
  %var_2_94 = bitcast i8* %var_2_93 to i32*
  %var_2_1036 = load i64, i64* %RBP.i, align 8
  %var_2_1047 = add i64 %var_2_1036, -36
  %var_2_1068 = inttoptr i64 %var_2_1047 to i32*
  %var_2_1079 = load i32, i32* %var_2_1068, align 4
  %var_2_10910 = add i64 %var_2_1036, -8
  %var_2_11111 = inttoptr i64 %var_2_10910 to i32*
  %var_2_11212 = load i32, i32* %var_2_11111, align 4
  %var_2_11313 = sub i32 %var_2_1079, %var_2_11212
  %var_2_12814 = lshr i32 %var_2_11313, 31
  %var_2_13015 = lshr i32 %var_2_1079, 31
  %var_2_13116 = lshr i32 %var_2_11212, 31
  %var_2_13217 = xor i32 %var_2_13116, %var_2_13015
  %var_2_13318 = xor i32 %var_2_12814, %var_2_13015
  %var_2_13419 = add nuw nsw i32 %var_2_13318, %var_2_13217
  %var_2_13520 = icmp eq i32 %var_2_13419, 2
  %var_2_13721 = icmp ne i32 %var_2_12814, 0
  %var_2_13822 = xor i1 %var_2_13721, %var_2_13520
  br i1 %var_2_13822, label %block_400ef6.preheader, label %block_.L_400fdf

block_400ef6.preheader:                           ; preds = %entry
  br label %block_400ef6

block_.L_400eea.loopexit.loopexit:                ; preds = %routine_ucomisd_MINUS0x30__rbp____xmm0.exit.block_.L_400efd_crit_edge
  br label %block_.L_400eea.loopexit

block_.L_400eea.loopexit:                         ; preds = %block_.L_400eea.loopexit.loopexit, %block_400ef6
  %var_2_144.lcssa = phi i64 [ %var_2_1445, %block_400ef6 ], [ %var_2_144.pre, %block_.L_400eea.loopexit.loopexit ]
  %MEMORY.1.lcssa = phi %struct.Memory* [ %MEMORY.023, %block_400ef6 ], [ %var_2_350, %block_.L_400eea.loopexit.loopexit ]
  %var_2_104 = add i64 %var_2_144.lcssa, -36
  %var_2_106 = inttoptr i64 %var_2_104 to i32*
  %var_2_107 = load i32, i32* %var_2_106, align 4
  %var_2_109 = add i64 %var_2_144.lcssa, -8
  %var_2_111 = inttoptr i64 %var_2_109 to i32*
  %var_2_112 = load i32, i32* %var_2_111, align 4
  %var_2_113 = sub i32 %var_2_107, %var_2_112
  %var_2_128 = lshr i32 %var_2_113, 31
  %var_2_130 = lshr i32 %var_2_107, 31
  %var_2_131 = lshr i32 %var_2_112, 31
  %var_2_132 = xor i32 %var_2_131, %var_2_130
  %var_2_133 = xor i32 %var_2_128, %var_2_130
  %var_2_134 = add nuw nsw i32 %var_2_133, %var_2_132
  %var_2_135 = icmp eq i32 %var_2_134, 2
  %var_2_137 = icmp ne i32 %var_2_128, 0
  %var_2_138 = xor i1 %var_2_137, %var_2_135
  br i1 %var_2_138, label %block_400ef6, label %block_.L_400fdf.loopexit

block_400ef6:                                     ; preds = %block_400ef6.preheader, %block_.L_400eea.loopexit
  %var_2_1445 = phi i64 [ %var_2_144.lcssa, %block_.L_400eea.loopexit ], [ %var_2_1036, %block_400ef6.preheader ]
  %MEMORY.023 = phi %struct.Memory* [ %MEMORY.1.lcssa, %block_.L_400eea.loopexit ], [ %2, %block_400ef6.preheader ]
  %var_2_14511 = add i64 %var_2_1445, -40
  %var_2_14712 = inttoptr i64 %var_2_14511 to i32*
  %var_2_14813 = load i32, i32* %var_2_14712, align 4
  %var_2_15014 = add i64 %var_2_1445, -12
  %var_2_15215 = inttoptr i64 %var_2_15014 to i32*
  %var_2_15316 = load i32, i32* %var_2_15215, align 4
  %var_2_15417 = sub i32 %var_2_14813, %var_2_15316
  %var_2_16918 = lshr i32 %var_2_15417, 31
  %var_2_17119 = lshr i32 %var_2_14813, 31
  %var_2_17220 = lshr i32 %var_2_15316, 31
  %var_2_17321 = xor i32 %var_2_17220, %var_2_17119
  %var_2_17422 = xor i32 %var_2_16918, %var_2_17119
  %var_2_17523 = add nuw nsw i32 %var_2_17422, %var_2_17321
  %var_2_17624 = icmp eq i32 %var_2_17523, 2
  %var_2_17825 = icmp ne i32 %var_2_16918, 0
  %var_2_17926 = xor i1 %var_2_17825, %var_2_17624
  br i1 %var_2_17926, label %block_400f09.preheader, label %block_.L_400eea.loopexit

block_400f09.preheader:                           ; preds = %block_400ef6
  br label %block_400f09

block_400f09:                                     ; preds = %block_400f09.preheader, %routine_ucomisd_MINUS0x30__rbp____xmm0.exit.block_.L_400efd_crit_edge
  %MEMORY.128 = phi %struct.Memory* [ %var_2_350, %routine_ucomisd_MINUS0x30__rbp____xmm0.exit.block_.L_400efd_crit_edge ], [ %MEMORY.023, %block_400f09.preheader ]
  %var_2_14427 = phi i64 [ %var_2_144.pre, %routine_ucomisd_MINUS0x30__rbp____xmm0.exit.block_.L_400efd_crit_edge ], [ %var_2_1445, %block_400f09.preheader ]
  %var_2_282 = add i64 %var_2_14427, -56
  %var_2_283 = load i64, i64* %var_2_3, align 8
  %var_4_3 = inttoptr i64 %var_2_282 to double*
  %var_2_2862 = load double, double* %var_4_3, align 8
  %var_2_287 = add i64 %var_2_14427, -64
  %var_2_290 = inttoptr i64 %var_2_287 to double*
  %var_2_291 = load double, double* %var_2_290, align 8
  %var_2_292 = fsub double %var_2_2862, %var_2_291
  store double %var_2_292, double* %var_2_46, align 1
  store i64 0, i64* %var_2_48, align 1
  %var_2_293 = add i64 %var_2_283, add (i64 ptrtoint (%G_0x3bc__rip__type* @G_0x3bc__rip_ to i64), i64 10)
  %var_2_294 = add i64 %var_2_283, 17
  store i64 %var_2_294, i64* %var_2_3, align 8
  %var_2_295 = inttoptr i64 %var_2_293 to i32*
  %var_2_296 = load i32, i32* %var_2_295, align 4
  %var_2_297 = add i64 %var_2_283, add (i64 ptrtoint (%G_0x3bc__rip__type* @G_0x3bc__rip_ to i64), i64 14)
  %var_2_298 = inttoptr i64 %var_2_297 to i32*
  %var_2_299 = load i32, i32* %var_2_298, align 4
  %var_2_300 = add i64 %var_2_283, add (i64 ptrtoint (%G_0x3bc__rip__type* @G_0x3bc__rip_ to i64), i64 18)
  %var_2_301 = inttoptr i64 %var_2_300 to i32*
  %var_2_302 = load i32, i32* %var_2_301, align 4
  %var_2_303 = add i64 %var_2_283, add (i64 ptrtoint (%G_0x3bc__rip__type* @G_0x3bc__rip_ to i64), i64 22)
  %var_2_304 = inttoptr i64 %var_2_303 to i32*
  %var_2_305 = load i32, i32* %var_2_304, align 4
  store i32 %var_2_296, i32* %var_2_88, align 1
  store i32 %var_2_299, i32* %var_2_90, align 1
  store i32 %var_2_302, i32* %var_2_92, align 1
  store i32 %var_2_305, i32* %var_2_94, align 1
  %var_2_317 = add i64 %var_2_14427, -72
  %var_4_4 = inttoptr i64 %var_2_317 to double*
  %var_2_3213 = load double, double* %var_4_4, align 8
  %var_2_322 = add i64 %var_2_14427, -48
  %var_2_323 = add i64 %var_2_283, 27
  %var_2_325 = inttoptr i64 %var_2_322 to double*
  %var_2_326 = load double, double* %var_2_325, align 8
  %var_2_327 = fcmp uno double %var_2_3213, %var_2_326
  br i1 %var_2_327, label %var_2_328, label %routine_ucomisd_MINUS0x30__rbp____xmm0.exit

var_2_328:                                        ; preds = %block_400f09
  %var_2_329 = fadd double %var_2_3213, %var_2_326
  %var_2_330 = bitcast double %var_2_329 to i64
  %var_2_331 = and i64 %var_2_330, 9221120237041090560
  %var_2_332 = icmp eq i64 %var_2_331, 9218868437227405312
  %var_2_333 = and i64 %var_2_330, 2251799813685247
  %var_2_334 = icmp ne i64 %var_2_333, 0
  %var_2_335 = and i1 %var_2_332, %var_2_334
  br i1 %var_2_335, label %var_2_336, label %routine_ucomisd_MINUS0x30__rbp____xmm0.exit

var_2_336:                                        ; preds = %var_2_328
  %var_2_337 = tail call %struct.Memory* @__remill_error(%struct.State* nonnull dereferenceable(3376) %0, i64 %var_2_323, %struct.Memory* %MEMORY.128)
  br label %routine_ucomisd_MINUS0x30__rbp____xmm0.exit

routine_ucomisd_MINUS0x30__rbp____xmm0.exit:      ; preds = %var_2_336, %var_2_328, %block_400f09
  %var_2_350 = phi %struct.Memory* [ %var_2_337, %var_2_336 ], [ %MEMORY.128, %var_2_328 ], [ %MEMORY.128, %block_400f09 ]
  %var_2_351 = load i8, i8* %var_2_14, align 1
  %var_2_352 = load i8, i8* %var_2_30, align 1
  %var_2_353 = or i8 %var_2_352, %var_2_351
  %var_2_354 = icmp eq i8 %var_2_353, 0
  br i1 %var_2_354, label %block_400f6d, label %routine_ucomisd_MINUS0x30__rbp____xmm0.exit.block_.L_400efd_crit_edge

routine_ucomisd_MINUS0x30__rbp____xmm0.exit.block_.L_400efd_crit_edge: ; preds = %routine_ucomisd_MINUS0x30__rbp____xmm0.exit
  %var_2_144.pre = load i64, i64* %RBP.i, align 8
  %var_2_145 = add i64 %var_2_144.pre, -40
  %var_2_147 = inttoptr i64 %var_2_145 to i32*
  %var_2_148 = load i32, i32* %var_2_147, align 4
  %var_2_150 = add i64 %var_2_144.pre, -12
  %var_2_152 = inttoptr i64 %var_2_150 to i32*
  %var_2_153 = load i32, i32* %var_2_152, align 4
  %var_2_154 = sub i32 %var_2_148, %var_2_153
  %var_2_169 = lshr i32 %var_2_154, 31
  %var_2_171 = lshr i32 %var_2_148, 31
  %var_2_172 = lshr i32 %var_2_153, 31
  %var_2_173 = xor i32 %var_2_172, %var_2_171
  %var_2_174 = xor i32 %var_2_169, %var_2_171
  %var_2_175 = add nuw nsw i32 %var_2_174, %var_2_173
  %var_2_176 = icmp eq i32 %var_2_175, 2
  %var_2_178 = icmp ne i32 %var_2_169, 0
  %var_2_179 = xor i1 %var_2_178, %var_2_176
  br i1 %var_2_179, label %block_400f09, label %block_.L_400eea.loopexit.loopexit

block_400f6d:                                     ; preds = %routine_ucomisd_MINUS0x30__rbp____xmm0.exit
  %var_2_397 = tail call %struct.Memory* @__remill_function_call(%struct.State* nonnull %0, i64 ptrtoint (i64 (i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64)* @fprintf to i64), %struct.Memory* %var_2_350)
  br label %block_.L_400fdf

block_.L_400fdf.loopexit:                         ; preds = %block_.L_400eea.loopexit
  br label %block_.L_400fdf

block_.L_400fdf:                                  ; preds = %block_.L_400fdf.loopexit, %block_400f6d, %entry
  %MEMORY.2 = phi %struct.Memory* [ %var_2_397, %block_400f6d ], [ %2, %entry ], [ %MEMORY.1.lcssa, %block_.L_400fdf.loopexit ]
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_jge_.L_400fc5(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i8* nocapture %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 2, i32 9
...
block_400488:
  ...
  %5 = load i64, i64* %PC, align 8
  %6 = add i64 %5, ptrtoint (%G_0x3bc__rip__type* @G_0x3bc__rip_ to i64)
  %7 = add i64 %5, 7
  store i64 %7, i64* %PC, align 8
  %8 = inttoptr i64 %6 to i32*
  %9 = load i32, i32* %8, align 4
  %10 = add i64 %5, add (i64 ptrtoint (%G_0x3bc__rip__type* @G_0x3bc__rip_ to i64), i64 4)
  %11 = inttoptr i64 %10 to i32*
  %12 = load i32, i32* %11, align 4
  %13 = add i64 %5, add (i64 ptrtoint (%G_0x3bc__rip__type* @G_0x3bc__rip_ to i64), i64 8)
  %14 = inttoptr i64 %13 to i32*
  %15 = load i32, i32* %14, align 4
  %16 = add i64 %5, add (i64 ptrtoint (%G_0x3bc__rip__type* @G_0x3bc__rip_ to i64), i64 12)
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_jbe_.L_400fb2(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i8* nocapture %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_movq__0x40135a___rsi(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  ...
  store i64 ptrtoint (%G__0x40135a_type* @G__0x40135a to i64), i64* %RSI, align 8
  ret %struct.Memory* %2
}
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_jmpq_.L_400fdf(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_jmpq_.L_400fb7(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_jmpq_.L_400efd(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
