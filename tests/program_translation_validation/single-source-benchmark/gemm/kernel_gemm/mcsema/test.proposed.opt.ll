...
define %struct.Memory* @kernel_gemm(%struct.State* noalias, i64, %struct.Memory* noalias) local_unnamed_addr #1 {
entry:
...
block_.L_400c9a:                                  ; preds = %block_.L_400d61, %entry
  %77 = phi i64 [ %488, %block_.L_400d61 ], [ %.pre, %entry ]
  ...
  br i1 %113, label %block_400ca6, label %block_.L_400d74
...
block_.L_400cad:                                  ; preds = %block_.L_400d4e, %block_400ca6
  %118 = phi i64 [ %457, %block_.L_400d4e ], [ %.pre1, %block_400ca6 ]
  ...
  br i1 %154, label %block_400cb9, label %block_.L_400d61
...
block_.L_400ce2:                                  ; preds = %block_400cee, %block_400cb9
  %212 = phi i64 [ %426, %block_400cee ], [ %.pre2, %block_400cb9 ]
  ...
  br i1 %248, label %block_400cee, label %block_.L_400d4e
...
define %struct.Memory* @routine_jge_.L_400d74(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i8* %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
...
define %struct.Memory* @routine_jge_.L_400d61(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i8* %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 2, i32 9
...
define %struct.Memory* @routine_jmpq_.L_400d53(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
...
define %struct.Memory* @routine_jmpq_.L_400d66(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
