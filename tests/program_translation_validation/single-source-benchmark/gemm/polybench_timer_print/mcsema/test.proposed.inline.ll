...
@G__0x4012f0 = global %G__0x4012f0_type zeroinitializer
...
entry:
  ...
  store i64 ptrtoint (%G__0x4012f0_type* @G__0x4012f0 to i64), i64* %RDI.i, align 8
  ...
  %129 = call %struct.Memory* @__remill_function_call(%struct.State* %0, i64 ptrtoint (i64 (i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64)* @printf to i64), %struct.Memory* %loadMem2_400836)
  ...
  ret %struct.Memory* %loadMem_400843
}
...
define %struct.Memory* @routine_movq__0x4012f0___rdi(%struct.State* dereferenceable(3376), i64, %struct.Memory*) {
block_400478:
  %3 = getelementptr inbounds %struct.State, %struct.State* %0, i32 0, i32 6
  %4 = getelementptr inbounds %struct.GPR, %struct.GPR* %3, i32 0, i32 33
  %5 = getelementptr inbounds %struct.Reg, %struct.Reg* %4, i32 0, i32 0
  ...
  %10 = add i64 %9, 10
  store i64 %10, i64* %PC
  store i64 ptrtoint (%G__0x4012f0_type* @G__0x4012f0 to i64), i64* %RDI, align 8
  ret %struct.Memory* %2
}
