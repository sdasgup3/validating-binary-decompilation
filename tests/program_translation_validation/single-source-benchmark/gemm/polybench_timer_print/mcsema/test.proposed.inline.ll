...
@G__0x401320 = global %G__0x401320_type zeroinitializer
...
entry:
  ...
  store i64 ptrtoint (%G__0x401320_type* @G__0x401320 to i64), i64* %RDI.i, align 8
...
define %struct.Memory* @routine_movq__0x401320___rdi(%struct.State* dereferenceable(3376), i64, %struct.Memory*) {
block_400488:
  %3 = getelementptr inbounds %struct.State, %struct.State* %0, i32 0, i32 6
  %4 = getelementptr inbounds %struct.GPR, %struct.GPR* %3, i32 0, i32 33
  %5 = getelementptr inbounds %struct.Reg, %struct.Reg* %4, i32 0, i32 0
  ...
  %10 = add i64 %9, 10
  store i64 %10, i64* %PC
  store i64 ptrtoint (%G__0x401320_type* @G__0x401320 to i64), i64* %RDI, align 8
  ret %struct.Memory* %2
}
