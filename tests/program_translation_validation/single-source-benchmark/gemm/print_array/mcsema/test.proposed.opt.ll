...
block_.L_400fff:                                  ; preds = %block_.L_401055, %entry
  %125 = phi i64 [ %.pre, %entry ], [ %356, %block_.L_401055 ]
  %MEMORY.0 = phi %struct.Memory* [ %81, %entry ], [ %318, %block_.L_401055 ]
...
block_.L_401012:                                  ; preds = %block_40101e, %block_40100b
  %166 = phi i64 [ %.pre1, %block_40100b ], [ %307, %block_40101e ]
...
block_40101e:                                     ; preds = %block_.L_401012
  ...
  %call2_401042 = tail call %struct.Memory* @sub_401090.print_element(%struct.State* %0, i64 %271, %struct.Memory* %MEMORY.1)
