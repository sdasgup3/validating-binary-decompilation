...
block_.L_400fff:                                  ; preds = %block_.L_401055, %entry
  %125 = phi i64 [ %.pre, %entry ], [ %357, %block_.L_401055 ]
  %MEMORY.0 = phi %struct.Memory* [ %81, %entry ], [ %319, %block_.L_401055 ]
  ...
  br i1 %161, label %block_40100b, label %block_.L_401077
...
block_.L_401012:                                  ; preds = %block_40101e, %block_40100b
  %166 = phi i64 [ %.pre1, %block_40100b ], [ %308, %block_40101e ]
  ...
  br i1 %202, label %block_40101e, label %block_.L_401055
...
block_40101e:                                     ; preds = %block_.L_401012
  ...
  %call2_401042 = tail call %struct.Memory* @sub_401090.print_element(%struct.State* %0, i64 %272, %struct.Memory* %MEMORY.1)
