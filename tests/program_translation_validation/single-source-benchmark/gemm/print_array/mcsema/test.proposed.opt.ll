...
block_.L_400fff:                                  ; preds = %block_.L_401055, %entry
  %131 = phi i64 [ %.pre, %entry ], [ %365, %block_.L_401055 ]
  %MEMORY.0 = phi %struct.Memory* [ %87, %entry ], [ %326, %block_.L_401055 ]
  ...
  br i1 %167, label %block_40100b, label %block_.L_401077
...
block_.L_401012:                                  ; preds = %block_40101e, %block_40100b
  %172 = phi i64 [ %.pre1, %block_40100b ], [ %315, %block_40101e ]
  %MEMORY.1 = phi %struct.Memory* [ %MEMORY.0, %block_40100b ], [ %call2_401042, %block_40101e ]
  ...
  br i1 %208, label %block_40101e, label %block_.L_401055
...
block_40101e:                                     ; preds = %block_.L_401012
  ...
  %call2_401042 = tail call %struct.Memory* @sub_401090.print_element(%struct.State* %0, i64 %278, %struct.Memory* %MEMORY.1)
...
define %struct.Memory* @routine_jge_.L_401077(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i8* %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
...
define %struct.Memory* @routine_jge_.L_401055(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i8* %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 2, i32 9
...
define %struct.Memory* @routine_jmpq_.L_401012(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
...
define %struct.Memory* @routine_jmpq_.L_400fff(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
