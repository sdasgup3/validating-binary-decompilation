; ModuleID = '/tmp/tmpudz73fuu-query.ll'
...
entry:
  ...
  br i1 %var_2_16834, label %block_40103b.preheader, label %block_.L_4010a7

block_40103b.preheader:                           ; preds = %entry
  br label %block_40103b

block_40103b:                                     ; preds = %block_40103b.preheader, %block_.L_401085
  %var_2_1741 = phi i64 [ %var_2_133, %block_.L_401085 ], [ %var_2_13318, %block_40103b.preheader ]
  %MEMORY.035 = phi %struct.Memory* [ %var_2_325, %block_.L_401085 ], [ %var_2_87, %block_40103b.preheader ]
  ...
  br i1 %var_2_20917, label %block_40104e.preheader, label %block_.L_401085

block_40104e.preheader:                           ; preds = %block_40103b
  br label %block_40104e

block_40104e:                                     ; preds = %block_40104e.preheader, %block_40104e
  br label %block_40104e

block_.L_401085:                                  ; preds = %block_40103b
  ...
  br i1 %var_2_168, label %block_40103b, label %block_.L_4010a7.loopexit

block_.L_4010a7.loopexit:                         ; preds = %block_.L_401085
  br label %block_.L_4010a7

block_.L_4010a7:                                  ; preds = %block_.L_4010a7.loopexit, %entry
  %MEMORY.0.lcssa = phi %struct.Memory* [ %var_2_87, %entry ], [ %var_2_325, %block_.L_4010a7.loopexit ]
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_jge_.L_4010a7(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i8* nocapture %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
