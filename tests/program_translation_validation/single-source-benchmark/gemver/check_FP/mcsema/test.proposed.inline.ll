...
@G_0x240__rip__4199072_ = global %G_0x240__rip__4199072__type zeroinitializer
...
entry:
  ...
  %76 = load double, double* bitcast (%G_0x240__rip__4199072__type* @G_0x240__rip__4199072_ to double*)
...
block_.L_4012b7:                                  ; preds = %block_.L_401353, %entry
...
block_4012c3:                                     ; preds = %block_.L_4012b7
  ...
  %428 = load float, float* bitcast (%G_0x1f8__rip__4199160__type* @G_0x1f8__rip__4199160_ to float*)
  %429 = load float, float* inttoptr (i64 add (i64 ptrtoint (%G_0x1f8__rip__4199160__type* @G_0x1f8__rip__4199160_ to i64), i64 4) to float*)
  %430 = load float, float* inttoptr (i64 add (i64 ptrtoint (%G_0x1f8__rip__4199160__type* @G_0x1f8__rip__4199160_ to i64), i64 8) to float*)
  %431 = load float, float* inttoptr (i64 add (i64 ptrtoint (%G_0x1f8__rip__4199160__type* @G_0x1f8__rip__4199160_ to i64), i64 12) to float*)
...
; <label>:536:                                    ; preds = %528
  ...
  %539 = call %struct.Memory* @__remill_error(%struct.State* nonnull dereferenceable(3376) %0, i64 %538, %struct.Memory* %loadMem_401306)
  br label %routine_ucomisd_MINUS0x28__rbp____xmm0.exit

; <label>:540:                                    ; preds = %block_4012c3
...
routine_ucomisd_MINUS0x28__rbp____xmm0.exit:      ; preds = %536, %553
  %557 = phi %struct.Memory* [ %539, %536 ], [ %loadMem_401306, %553 ]
...
block_401311:                                     ; preds = %routine_ucomisd_MINUS0x28__rbp____xmm0.exit
  ...
  store i64 ptrtoint (%G__0x401542_type* @G__0x401542 to i64), i64* %RSI.i, align 8
  ...
  %592 = load i64, i64* bitcast (%G_0x602060_type* @G_0x602060 to i64*)
  ...
  store %struct.Memory* %loadMem1_40133a, %struct.Memory** %MEMORY
  %loadMem2_40133a = load %struct.Memory*, %struct.Memory** %MEMORY
  %loadPC_40133a = load i64, i64* %3
  %702 = call %struct.Memory* @__remill_function_call(%struct.State* %0, i64 ptrtoint (i64 (i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64)* @fprintf to i64), %struct.Memory* %loadMem2_40133a)
...
block_.L_401353:                                  ; preds = %block_.L_40134e
...
block_.L_401368:                                  ; preds = %block_.L_401361, %block_401311
  ...
  ret %struct.Memory* %loadMem_401370
}
...
define %struct.Memory* @routine_movsd_0x240__rip____xmm0(%struct.State* dereferenceable(3376), i64, %struct.Memory*) {
block_400478:
  %3 = getelementptr inbounds %struct.State, %struct.State* %0, i32 0, i32 6
  %4 = getelementptr inbounds %struct.GPR, %struct.GPR* %3, i32 0, i32 33
  %5 = getelementptr inbounds %struct.Reg, %struct.Reg* %4, i32 0, i32 0
...
define %struct.Memory* @routine_movaps_0x1f8__rip____xmm1(%struct.State* dereferenceable(3376), i64, %struct.Memory*) {
block_400478:
  %3 = getelementptr inbounds %struct.State, %struct.State* %0, i32 0, i32 6
  %4 = getelementptr inbounds %struct.GPR, %struct.GPR* %3, i32 0, i32 33
  %5 = getelementptr inbounds %struct.Reg, %struct.Reg* %4, i32 0, i32 0
...
define %struct.Memory* @routine_movq__0x401542___rsi(%struct.State* dereferenceable(3376), i64, %struct.Memory*) {
block_400478:
  %3 = getelementptr inbounds %struct.State, %struct.State* %0, i32 0, i32 6
  %4 = getelementptr inbounds %struct.GPR, %struct.GPR* %3, i32 0, i32 33
  %5 = getelementptr inbounds %struct.Reg, %struct.Reg* %4, i32 0, i32 0
