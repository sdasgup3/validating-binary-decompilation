...
block_.L_4012e7:                                  ; preds = %block_.L_40137e, %entry
  %95 = phi i64 [ %.pre, %entry ], [ %316, %block_.L_40137e ]
...
block_401341:                                     ; preds = %routine_ucomisd_MINUS0x28__rbp____xmm0.exit
  store i64 4199794, i64* %RSI.i102, align 8
  ...
  %call2_40136a = tail call %struct.Memory* @sub_4005b0.fprintf_plt(%struct.State* nonnull %0, i64 %268, %struct.Memory* %236)
...
block_.L_401398:                                  ; preds = %block_.L_401391, %block_401341
  %320 = phi i64 [ %.pre22, %block_.L_401391 ], [ %285, %block_401341 ]
  %MEMORY.1 = phi %struct.Memory* [ %MEMORY.0, %block_.L_401391 ], [ %call2_40136a, %block_401341 ]
