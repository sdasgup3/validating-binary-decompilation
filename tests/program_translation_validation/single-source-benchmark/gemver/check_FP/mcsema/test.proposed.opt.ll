...
@G_0x1f8__rip_ = global %G_0x1f8__rip__type zeroinitializer
@G_0x240__rip_ = local_unnamed_addr global %G_0x240__rip__type zeroinitializer
...
entry:
  ...
  %42 = load i64, i64* bitcast (%G_0x240__rip__type* @G_0x240__rip_ to i64*), align 8
...
block_.L_4012b7:                                  ; preds = %block_.L_40134e, %entry
  %89 = phi i64 [ %.pre, %entry ], [ %310, %block_.L_40134e ]
  %MEMORY.0 = phi %struct.Memory* [ %2, %entry ], [ %226, %block_.L_40134e ]
  ...
  br i1 %125, label %block_4012c3, label %block_.L_401361
...
block_4012c3:                                     ; preds = %block_.L_4012b7
  ...
  %174 = load i32, i32* bitcast (%G_0x1f8__rip__type* @G_0x1f8__rip_ to i32*), align 8
  %175 = load i32, i32* inttoptr (i64 add (i64 ptrtoint (%G_0x1f8__rip__type* @G_0x1f8__rip_ to i64), i64 4) to i32*), align 4
  %176 = load i32, i32* inttoptr (i64 add (i64 ptrtoint (%G_0x1f8__rip__type* @G_0x1f8__rip_ to i64), i64 8) to i32*), align 8
  %177 = load i32, i32* inttoptr (i64 add (i64 ptrtoint (%G_0x1f8__rip__type* @G_0x1f8__rip_ to i64), i64 12) to i32*), align 4
...
routine_ucomisd_MINUS0x28__rbp____xmm0.exit:      ; preds = %224, %212
  ...
  br i1 %230, label %block_.L_40134e, label %block_401311
...
block_401311:                                     ; preds = %routine_ucomisd_MINUS0x28__rbp____xmm0.exit
  ...
  %232 = load i64, i64* bitcast (%G_0x602060_type* @G_0x602060 to i64*), align 8
...
block_.L_401368:                                  ; preds = %block_.L_401361, %block_401311
  %314 = phi i64 [ %.pre3, %block_.L_401361 ], [ %278, %block_401311 ]
  %MEMORY.1 = phi %struct.Memory* [ %MEMORY.0, %block_.L_401361 ], [ %265, %block_401311 ]
...
block_400478:
  ...
  %5 = load i64, i64* bitcast (%G_0x240__rip__type* @G_0x240__rip_ to i64*), align 8
...
block_400478:
  ...
  %6 = add i64 %5, 7
  store i64 %6, i64* %PC, align 8
  %7 = load i32, i32* bitcast (%G_0x1f8__rip__type* @G_0x1f8__rip_ to i32*), align 8
  %8 = load i32, i32* inttoptr (i64 add (i64 ptrtoint (%G_0x1f8__rip__type* @G_0x1f8__rip_ to i64), i64 4) to i32*), align 4
  %9 = load i32, i32* inttoptr (i64 add (i64 ptrtoint (%G_0x1f8__rip__type* @G_0x1f8__rip_ to i64), i64 8) to i32*), align 8
  %10 = load i32, i32* inttoptr (i64 add (i64 ptrtoint (%G_0x1f8__rip__type* @G_0x1f8__rip_ to i64), i64 12) to i32*), align 4
