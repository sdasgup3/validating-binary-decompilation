...
block_.L_4012e7:                                  ; preds = %block_.L_40137e, %entry
  %95 = phi i64 [ %.pre, %entry ], [ %317, %block_.L_40137e ]
  %MEMORY.0 = phi %struct.Memory* [ %2, %entry ], [ %236, %block_.L_40137e ]
  ...
  br i1 %131, label %block_4012f3, label %block_.L_401391

block_4012f3:                                     ; preds = %block_.L_4012e7
  %133 = add i64 %96, -16
  %134 = add i64 %132, 4
...
routine_ucomisd_MINUS0x28__rbp____xmm0.exit:      ; preds = %234, %222
  ...
  br i1 %240, label %block_.L_40137e, label %block_401341

block_401341:                                     ; preds = %routine_ucomisd_MINUS0x28__rbp____xmm0.exit
  store i64 4199794, i64* %RSI.i104, align 8
  %RDI.i = getelementptr inbounds %union.anon, %union.anon* %50, i64 0, i32 0
  %242 = load i64, i64* inttoptr (i64 6299744 to i64*), align 32
...
block_.L_40137e:                                  ; preds = %routine_ucomisd_MINUS0x28__rbp____xmm0.exit
...
block_.L_401391:                                  ; preds = %block_.L_4012e7
  %318 = add i64 %96, -4
  %319 = add i64 %132, 7
...
block_.L_401398:                                  ; preds = %block_.L_401391, %block_401341
  %321 = phi i64 [ %.pre22, %block_.L_401391 ], [ %286, %block_401341 ]
  %MEMORY.1 = phi %struct.Memory* [ %MEMORY.0, %block_.L_401391 ], [ %273, %block_401341 ]
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_jge_.L_401391(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i8* nocapture %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_jbe_.L_40137e(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i8* nocapture %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_movq__0x401572___rsi(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %RSI = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 9, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  ...
  store i64 4199794, i64* %RSI, align 8
  ret %struct.Memory* %2
}
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_jmpq_.L_401398(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
