; ModuleID = '/tmp/tmpgej0a7d5-query.ll'
...
entry:
  ...
  %var_2_42 = add i64 %var_2_10, add (i64 ptrtoint (%G_0x240__rip__type* @G_0x240__rip_ to i64), i64 7)
...
block_.L_4012f7:                                  ; preds = %routine_ucomisd_MINUS0x28__rbp____xmm0.exit, %entry
  ...
  br i1 %var_2_131, label %block_401303, label %block_.L_4013a8.loopexit
...
block_401303:                                     ; preds = %block_.L_4012f7
  ...
  %var_2_179 = add i64 %var_2_169, add (i64 ptrtoint (%G_0x1f8__rip__type* @G_0x1f8__rip_ to i64), i64 10)
  ...
  %var_2_183 = add i64 %var_2_169, add (i64 ptrtoint (%G_0x1f8__rip__type* @G_0x1f8__rip_ to i64), i64 14)
  %var_2_184 = inttoptr i64 %var_2_183 to i32*
  %var_2_185 = load i32, i32* %var_2_184, align 4
  %var_2_186 = add i64 %var_2_169, add (i64 ptrtoint (%G_0x1f8__rip__type* @G_0x1f8__rip_ to i64), i64 18)
  %var_2_187 = inttoptr i64 %var_2_186 to i32*
  %var_2_188 = load i32, i32* %var_2_187, align 4
  %var_2_189 = add i64 %var_2_169, add (i64 ptrtoint (%G_0x1f8__rip__type* @G_0x1f8__rip_ to i64), i64 22)
...
routine_ucomisd_MINUS0x28__rbp____xmm0.exit:      ; preds = %var_2_222, %var_2_214, %block_401303
  %var_2_236 = phi %struct.Memory* [ %var_2_223, %var_2_222 ], [ %MEMORY.0, %var_2_214 ], [ %MEMORY.0, %block_401303 ]
  ...
  br i1 %var_2_240, label %block_401351, label %block_.L_4012f7
...
block_.L_4013a8.loopexit:                         ; preds = %block_.L_4012f7
  br label %block_.L_4013a8

block_.L_4013a8:                                  ; preds = %block_.L_4013a8.loopexit, %block_401351
  %MEMORY.1 = phi %struct.Memory* [ %var_2_273, %block_401351 ], [ %MEMORY.0, %block_.L_4013a8.loopexit ]
