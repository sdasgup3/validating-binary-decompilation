; ModuleID = '/tmp/tmp8hz2hu2x-query.ll'
...
block_.L_4012f7:                                  ; preds = %routine_ucomisd_MINUS0x28__rbp____xmm0.exit, %entry
  ...
  br i1 %var_2_131, label %block_401303, label %block_.L_4013a8
...
routine_ucomisd_MINUS0x28__rbp____xmm0.exit:      ; preds = %var_2_222, %var_2_214, %block_401303
  ...
  br i1 %var_2_240, label %block_.L_4013a8, label %block_.L_4012f7

block_.L_4013a8:                                  ; preds = %routine_ucomisd_MINUS0x28__rbp____xmm0.exit, %block_.L_4012f7
