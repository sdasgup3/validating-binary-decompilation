...
declare %struct.Memory* @sub_400da0.kernel_gemver(%struct.State* dereferenceable(3376), i64, %struct.Memory*) local_unnamed_addr

declare %struct.Memory* @sub_401030.kernel_gemver_StrictFP(%struct.State* dereferenceable(3376), i64, %struct.Memory*) local_unnamed_addr

declare %struct.Memory* @sub_4012c0.check_FP(%struct.State* dereferenceable(3376), i64, %struct.Memory*) local_unnamed_addr

declare %struct.Memory* @sub_4013b0.print_array(%struct.State* dereferenceable(3376), i64, %struct.Memory*) local_unnamed_addr
