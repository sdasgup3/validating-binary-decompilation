...
block_.L_401396:                                  ; preds = %block_.L_401407, %entry
  %62 = phi i64 [ %.pre, %entry ], [ %222, %block_.L_401407 ]
  ...
  br i1 %98, label %block_4013a2, label %block_.L_40141a
...
routine_idivl__r8d.exit:                          ; preds = %160, %158
  ...
  br i1 %173, label %block_4013eb, label %block_.L_401407
...
block_.L_401407:                                  ; preds = %routine_idivl__r8d.exit, %block_4013eb
  %191 = phi i64 [ %177, %routine_idivl__r8d.exit ], [ %.pre3, %block_4013eb ]
  %MEMORY.1 = phi %struct.Memory* [ %167, %routine_idivl__r8d.exit ], [ %184, %block_4013eb ]
