...
@G__0x401505 = global %G__0x401505_type zeroinitializer
@G__0x40153a = global %G__0x40153a_type zeroinitializer
...
block_.L_401396:                                  ; preds = %block_.L_401407, %entry
  %66 = phi i64 [ %.pre, %entry ], [ %227, %block_.L_401407 ]
  %MEMORY.0 = phi %struct.Memory* [ %2, %entry ], [ %MEMORY.1, %block_.L_401407 ]
  ...
  br i1 %102, label %block_4013a2, label %block_.L_40141a

block_4013a2:                                     ; preds = %block_.L_401396
  store i64 ptrtoint (%G__0x40153a_type* @G__0x40153a to i64), i64* %RSI.i72, align 8
...
routine_idivl__r8d.exit:                          ; preds = %164, %162
  ...
  br i1 %177, label %block_4013eb, label %block_.L_401407

block_4013eb:                                     ; preds = %routine_idivl__r8d.exit
  store i64 ptrtoint (%G__0x401505_type* @G__0x401505 to i64), i64* %RSI.i72, align 8
...
block_.L_401407:                                  ; preds = %routine_idivl__r8d.exit, %block_4013eb
  %195 = phi i64 [ %181, %routine_idivl__r8d.exit ], [ %.pre3, %block_4013eb ]
  %MEMORY.1 = phi %struct.Memory* [ %171, %routine_idivl__r8d.exit ], [ %188, %block_4013eb ]
...
block_.L_40141a:                                  ; preds = %block_.L_401396
...
define %struct.Memory* @routine_jge_.L_40141a(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i8* %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
...
define %struct.Memory* @routine_movq__0x40153a___rsi(%struct.State* dereferenceable(3376), i64, %struct.Memory*) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %RSI = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 9, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  ...
  store i64 ptrtoint (%G__0x40153a_type* @G__0x40153a to i64), i64* %RSI, align 8
  ret %struct.Memory* %2
}
...
define %struct.Memory* @routine_jne_.L_401407(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i8* %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
...
define %struct.Memory* @routine_movq__0x401505___rsi(%struct.State* dereferenceable(3376), i64, %struct.Memory*) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %RSI = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 9, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, 10
  store i64 %4, i64* %PC, align 8
  store i64 ptrtoint (%G__0x401505_type* @G__0x401505 to i64), i64* %RSI, align 8
  ret %struct.Memory* %2
}
...
define %struct.Memory* @routine_jmpq_.L_40140c(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
...
define %struct.Memory* @routine_jmpq_.L_401396(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
