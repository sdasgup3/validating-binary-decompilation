...
entry:
  ...
  %76 = load double, double* bitcast (%G_0x3c8__rip__type* @G_0x3c8__rip_ to double*)
...
block_.L_400e67:                                  ; preds = %block_.L_400f03, %entry
...
; <label>:536:                                    ; preds = %528
  ...
  %539 = call %struct.Memory* @__remill_error(%struct.State* nonnull dereferenceable(3376) %0, i64 %538, %struct.Memory* %loadMem_400eb6)
  br label %routine_ucomisd_MINUS0x28__rbp____xmm0.exit

; <label>:540:                                    ; preds = %block_400e73
...
routine_ucomisd_MINUS0x28__rbp____xmm0.exit:      ; preds = %536, %553
  %557 = phi %struct.Memory* [ %539, %536 ], [ %loadMem_400eb6, %553 ]
...
block_400ec1:                                     ; preds = %routine_ucomisd_MINUS0x28__rbp____xmm0.exit
  ...
  store i64 ptrtoint (%G__0x40126a_type* @G__0x40126a to i64), i64* %RSI.i, align 8
  ...
  store %struct.Memory* %loadMem1_400eea, %struct.Memory** %MEMORY
  %loadMem2_400eea = load %struct.Memory*, %struct.Memory** %MEMORY
  %loadPC_400eea = load i64, i64* %3
  %702 = call %struct.Memory* @__remill_function_call(%struct.State* %0, i64 ptrtoint (i64 (i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64)* @fprintf to i64), %struct.Memory* %loadMem2_400eea)
...
block_.L_400f03:                                  ; preds = %block_.L_400efe
...
block_.L_400f18:                                  ; preds = %block_.L_400f11, %block_400ec1
  ...
  ret %struct.Memory* %loadMem_400f20
}
...
define %struct.Memory* @routine_movq__0x40126a___rsi(%struct.State* dereferenceable(3376), i64, %struct.Memory*) {
block_400478:
  %3 = getelementptr inbounds %struct.State, %struct.State* %0, i32 0, i32 6
  %4 = getelementptr inbounds %struct.GPR, %struct.GPR* %3, i32 0, i32 33
  %5 = getelementptr inbounds %struct.Reg, %struct.Reg* %4, i32 0, i32 0
