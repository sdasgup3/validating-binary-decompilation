...
block_.L_400e87:                                  ; preds = %block_.L_400f23, %entry
...
; <label>:546:                                    ; preds = %538
  ...
  %549 = call %struct.Memory* @__remill_error(%struct.State* nonnull dereferenceable(3376) %0, i64 %548, %struct.Memory* %loadMem_400ed6)
  br label %routine_ucomisd_MINUS0x28__rbp____xmm0.exit

; <label>:550:                                    ; preds = %block_400e93
...
routine_ucomisd_MINUS0x28__rbp____xmm0.exit:      ; preds = %546, %563
  %567 = phi %struct.Memory* [ %549, %546 ], [ %loadMem_400ed6, %563 ]
...
block_400ee1:                                     ; preds = %routine_ucomisd_MINUS0x28__rbp____xmm0.exit
  ...
  store i64 4199050, i64* %RSI.i, align 8
  ...
  store %struct.Memory* %loadMem1_400f0a, %struct.Memory** %MEMORY
  %loadMem2_400f0a = load %struct.Memory*, %struct.Memory** %MEMORY
  %loadPC_400f0a = load i64, i64* %3
  %712 = call %struct.Memory* @__remill_function_call(%struct.State* %0, i64 ptrtoint (i64 (i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64)* @fprintf to i64), %struct.Memory* %loadMem2_400f0a)
...
block_.L_400f23:                                  ; preds = %block_.L_400f1e
...
define %struct.Memory* @routine_movq__0x40128a___rsi(%struct.State* dereferenceable(3376), i64, %struct.Memory*) {
block_400488:
  %3 = getelementptr inbounds %struct.State, %struct.State* %0, i32 0, i32 6
  %4 = getelementptr inbounds %struct.GPR, %struct.GPR* %3, i32 0, i32 33
  %5 = getelementptr inbounds %struct.Reg, %struct.Reg* %4, i32 0, i32 0
