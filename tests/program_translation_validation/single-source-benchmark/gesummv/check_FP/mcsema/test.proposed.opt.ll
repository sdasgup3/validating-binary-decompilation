...
@G_0x3c8__rip_ = local_unnamed_addr global %G_0x3c8__rip__type zeroinitializer
...
entry:
  ...
  %42 = load i64, i64* bitcast (%G_0x3c8__rip__type* @G_0x3c8__rip_ to i64*), align 8
...
block_.L_400e67:                                  ; preds = %block_.L_400efe, %entry
  %89 = phi i64 [ %.pre, %entry ], [ %310, %block_.L_400efe ]
  %MEMORY.0 = phi %struct.Memory* [ %2, %entry ], [ %226, %block_.L_400efe ]
  ...
  br i1 %125, label %block_400e73, label %block_.L_400f11
...
routine_ucomisd_MINUS0x28__rbp____xmm0.exit:      ; preds = %224, %212
  ...
  br i1 %230, label %block_.L_400efe, label %block_400ec1
...
block_.L_400f18:                                  ; preds = %block_.L_400f11, %block_400ec1
  %314 = phi i64 [ %.pre3, %block_.L_400f11 ], [ %278, %block_400ec1 ]
  %MEMORY.1 = phi %struct.Memory* [ %MEMORY.0, %block_.L_400f11 ], [ %265, %block_400ec1 ]
...
block_400478:
  ...
  %5 = load i64, i64* bitcast (%G_0x3c8__rip__type* @G_0x3c8__rip_ to i64*), align 8
