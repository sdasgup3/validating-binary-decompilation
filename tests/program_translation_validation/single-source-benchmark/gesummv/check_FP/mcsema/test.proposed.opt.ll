...
block_.L_400e87:                                  ; preds = %block_.L_400f1e, %entry
  %95 = phi i64 [ %.pre, %entry ], [ %316, %block_.L_400f1e ]
...
block_400ee1:                                     ; preds = %routine_ucomisd_MINUS0x28__rbp____xmm0.exit
  store i64 4199050, i64* %RSI.i102, align 8
  ...
  %call2_400f0a = tail call %struct.Memory* @sub_400630.fprintf_plt(%struct.State* nonnull %0, i64 %268, %struct.Memory* %236)
...
block_.L_400f38:                                  ; preds = %block_.L_400f31, %block_400ee1
  %320 = phi i64 [ %.pre22, %block_.L_400f31 ], [ %285, %block_400ee1 ]
  %MEMORY.1 = phi %struct.Memory* [ %MEMORY.0, %block_.L_400f31 ], [ %call2_400f0a, %block_400ee1 ]
