; ModuleID = '/tmp/tmpuvafxxj8-query.ll'
...
block_.L_400e97:                                  ; preds = %routine_ucomisd_MINUS0x28__rbp____xmm0.exit, %entry
  ...
  br i1 %var_2_131, label %block_400ea3, label %block_.L_400f48
...
routine_ucomisd_MINUS0x28__rbp____xmm0.exit:      ; preds = %var_2_222, %var_2_214, %block_400ea3
  ...
  br i1 %var_2_240, label %block_.L_400f48, label %block_.L_400e97

block_.L_400f48:                                  ; preds = %routine_ucomisd_MINUS0x28__rbp____xmm0.exit, %block_.L_400e97
