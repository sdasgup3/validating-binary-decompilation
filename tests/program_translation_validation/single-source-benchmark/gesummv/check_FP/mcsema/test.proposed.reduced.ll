; ModuleID = '/tmp/tmperqd81px-query.ll'
...
entry:
  ...
  %var_2_42 = add i64 %var_2_10, add (i64 ptrtoint (%G_0x3c8__rip__type* @G_0x3c8__rip_ to i64), i64 7)
...
block_.L_400e97:                                  ; preds = %routine_ucomisd_MINUS0x28__rbp____xmm0.exit, %entry
  %MEMORY.0 = phi %struct.Memory* [ %2, %entry ], [ %var_2_236, %routine_ucomisd_MINUS0x28__rbp____xmm0.exit ]
  ...
  br i1 %var_2_131, label %block_400ea3, label %block_.L_400f48.loopexit

block_400ea3:                                     ; preds = %block_.L_400e97
  %var_2_168 = add i64 %var_2_96, -48
  %var_2_169 = load i64, i64* %var_2_3, align 8
  %var_4_3 = inttoptr i64 %var_2_168 to double*
  %var_2_1722 = load double, double* %var_4_3, align 8
  %var_2_173 = add i64 %var_2_96, -56
  %var_2_176 = inttoptr i64 %var_2_173 to double*
  %var_2_177 = load double, double* %var_2_176, align 8
  %var_2_178 = fsub double %var_2_1722, %var_2_177
  store double %var_2_178, double* %var_2_46, align 1
  store i64 0, i64* %var_2_48, align 1
  %var_2_179 = add i64 %var_2_169, add (i64 ptrtoint (%G_0x378__rip__type* @G_0x378__rip_ to i64), i64 10)
  %var_2_180 = add i64 %var_2_169, 17
  store i64 %var_2_180, i64* %var_2_3, align 8
  %var_2_181 = inttoptr i64 %var_2_179 to i32*
  %var_2_182 = load i32, i32* %var_2_181, align 4
  %var_2_183 = add i64 %var_2_169, add (i64 ptrtoint (%G_0x378__rip__type* @G_0x378__rip_ to i64), i64 14)
  %var_2_184 = inttoptr i64 %var_2_183 to i32*
  %var_2_185 = load i32, i32* %var_2_184, align 4
  %var_2_186 = add i64 %var_2_169, add (i64 ptrtoint (%G_0x378__rip__type* @G_0x378__rip_ to i64), i64 18)
  %var_2_187 = inttoptr i64 %var_2_186 to i32*
  %var_2_188 = load i32, i32* %var_2_187, align 4
  %var_2_189 = add i64 %var_2_169, add (i64 ptrtoint (%G_0x378__rip__type* @G_0x378__rip_ to i64), i64 22)
  %var_2_190 = inttoptr i64 %var_2_189 to i32*
  %var_2_191 = load i32, i32* %var_2_190, align 4
  store i32 %var_2_182, i32* %var_2_81, align 1
  store i32 %var_2_185, i32* %var_2_83, align 1
  store i32 %var_2_188, i32* %var_2_85, align 1
  store i32 %var_2_191, i32* %var_2_87, align 1
  %var_2_203 = add i64 %var_2_96, -64
  %var_4_4 = inttoptr i64 %var_2_203 to double*
  %var_2_2073 = load double, double* %var_4_4, align 8
  %var_2_208 = add i64 %var_2_96, -40
  %var_2_209 = add i64 %var_2_169, 27
  %var_2_211 = inttoptr i64 %var_2_208 to double*
  %var_2_212 = load double, double* %var_2_211, align 8
  %var_2_213 = fcmp uno double %var_2_2073, %var_2_212
  br i1 %var_2_213, label %var_2_214, label %routine_ucomisd_MINUS0x28__rbp____xmm0.exit

var_2_214:                                        ; preds = %block_400ea3
  %var_2_215 = fadd double %var_2_2073, %var_2_212
  %var_2_216 = bitcast double %var_2_215 to i64
  %var_2_217 = and i64 %var_2_216, 9221120237041090560
  %var_2_218 = icmp eq i64 %var_2_217, 9218868437227405312
  %var_2_219 = and i64 %var_2_216, 2251799813685247
  %var_2_220 = icmp ne i64 %var_2_219, 0
  %var_2_221 = and i1 %var_2_218, %var_2_220
  br i1 %var_2_221, label %var_2_222, label %routine_ucomisd_MINUS0x28__rbp____xmm0.exit

var_2_222:                                        ; preds = %var_2_214
  %var_2_223 = tail call %struct.Memory* @__remill_error(%struct.State* nonnull dereferenceable(3376) %0, i64 %var_2_209, %struct.Memory* %MEMORY.0)
  br label %routine_ucomisd_MINUS0x28__rbp____xmm0.exit

routine_ucomisd_MINUS0x28__rbp____xmm0.exit:      ; preds = %var_2_222, %var_2_214, %block_400ea3
  %var_2_236 = phi %struct.Memory* [ %var_2_223, %var_2_222 ], [ %MEMORY.0, %var_2_214 ], [ %MEMORY.0, %block_400ea3 ]
  %var_2_237 = load i8, i8* %var_2_14, align 1
  %var_2_238 = load i8, i8* %var_2_30, align 1
  %var_2_239 = or i8 %var_2_238, %var_2_237
  %var_2_240 = icmp eq i8 %var_2_239, 0
  br i1 %var_2_240, label %block_400ef1, label %block_.L_400e97

block_400ef1:                                     ; preds = %routine_ucomisd_MINUS0x28__rbp____xmm0.exit
  %var_2_273 = tail call %struct.Memory* @__remill_function_call(%struct.State* nonnull %0, i64 ptrtoint (i64 (i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64)* @fprintf to i64), %struct.Memory* %var_2_236)
  br label %block_.L_400f48

block_.L_400f48.loopexit:                         ; preds = %block_.L_400e97
  br label %block_.L_400f48

block_.L_400f48:                                  ; preds = %block_.L_400f48.loopexit, %block_400ef1
  %MEMORY.1 = phi %struct.Memory* [ %var_2_273, %block_400ef1 ], [ %MEMORY.0, %block_.L_400f48.loopexit ]
