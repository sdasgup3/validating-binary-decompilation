...
define %struct.Memory* @kernel_gesummv_StrictFP(%struct.State* noalias, i64, %struct.Memory* noalias) local_unnamed_addr #1 {
entry:
...
block_.L_400d2c:                                  ; preds = %block_.L_400dfa, %entry
  %86 = phi i64 [ %472, %block_.L_400dfa ], [ %.pre, %entry ]
  ...
  br i1 %122, label %block_400d38, label %block_.L_400e3d

block_400d38:                                     ; preds = %block_.L_400d2c
...
block_.L_400d5c:                                  ; preds = %block_400d68, %block_400d38
  %157 = phi i64 [ %394, %block_400d68 ], [ %.pre1, %block_400d38 ]
  ...
  br i1 %193, label %block_400d68, label %block_.L_400dfa
...
block_.L_400dfa:                                  ; preds = %block_.L_400d5c
  %395 = add i64 %158, -16
  %396 = add i64 %194, 5
...
block_.L_400e3d:                                  ; preds = %block_.L_400d2c
  %473 = add i64 %123, 1
...
define %struct.Memory* @routine_jge_.L_400e3d(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i8* %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
...
define %struct.Memory* @routine_jge_.L_400dfa(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i8* %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 2, i32 9
...
define %struct.Memory* @routine_jmpq_.L_400d5c(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
