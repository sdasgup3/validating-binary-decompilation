...
declare %struct.Memory* @sub_400ff0.print_element(%struct.State* noalias dereferenceable(3376), i64, %struct.Memory* noalias readnone returned) local_unnamed_addr
...
block_.L_400f8c:                                  ; preds = %block_400f98, %entry
  %123 = phi i64 [ %230, %block_400f98 ], [ %.pre, %entry ]
...
block_400f98:                                     ; preds = %block_.L_400f8c
  ...
  %call2_400fb1 = tail call %struct.Memory* @sub_400ff0.print_element(%struct.State* nonnull %0, i64 %194, %struct.Memory* %call2_400f6b)
...
block_.L_400fc4:                                  ; preds = %block_.L_400f8c
  ...
  %call2_400fd0 = tail call %struct.Memory* @sub_400610.fputs_plt(%struct.State* nonnull %0, i64 %236, %struct.Memory* %call2_400f6b)
