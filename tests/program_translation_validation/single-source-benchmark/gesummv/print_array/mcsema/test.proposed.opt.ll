...
declare %struct.Memory* @sub_400ff0.print_element(%struct.State* dereferenceable(3376), i64, %struct.Memory*) local_unnamed_addr
...
entry:
  ...
  %call2_400f6b = tail call %struct.Memory* @sub_400640.malloc_plt(%struct.State* %0, i64 %74, %struct.Memory* %2)
...
block_.L_400f8c:                                  ; preds = %block_400f98, %entry
  %123 = phi i64 [ %.pre, %entry ], [ %230, %block_400f98 ]
  %MEMORY.0 = phi %struct.Memory* [ %call2_400f6b, %entry ], [ %call2_400fb1, %block_400f98 ]
  ...
  br i1 %159, label %block_400f98, label %block_.L_400fc4
...
block_400f98:                                     ; preds = %block_.L_400f8c
  ...
  %call2_400fb1 = tail call %struct.Memory* @sub_400ff0.print_element(%struct.State* nonnull %0, i64 %194, %struct.Memory* %MEMORY.0)
...
block_.L_400fc4:                                  ; preds = %block_.L_400f8c
  ...
  %call2_400fd0 = tail call %struct.Memory* @sub_400610.fputs_plt(%struct.State* nonnull %0, i64 %236, %struct.Memory* %MEMORY.0)
  ...
  %call2_400fdc = tail call %struct.Memory* @sub_4005f0.free_plt(%struct.State* nonnull %0, i64 %252, %struct.Memory* %call2_400fd0)
  ...
  ret %struct.Memory* %call2_400fdc
}
