...
declare %struct.Memory* @sub_401000.print_element(%struct.State* noalias dereferenceable(3376), i64, %struct.Memory* noalias readnone returned) local_unnamed_addr
...
block_.L_400f9c:                                  ; preds = %block_400fa8, %entry
  %124 = phi i64 [ %231, %block_400fa8 ], [ %.pre, %entry ]
  ...
  br i1 %160, label %block_400fa8, label %block_.L_400fd4
...
block_400fa8:                                     ; preds = %block_.L_400f9c
  ...
  %call2_400fc1 = tail call %struct.Memory* @sub_401000.print_element(%struct.State* nonnull %0, i64 %195, %struct.Memory* %79)
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_jge_.L_400fd4(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i8* nocapture %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_jmpq_.L_400f9c(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
