...
block_.L_400f6c:                                  ; preds = %block_400f78, %entry
  %117 = phi i64 [ %.pre, %entry ], [ %225, %block_400f78 ]
  %MEMORY.0 = phi %struct.Memory* [ %73, %entry ], [ %call2_400f91, %block_400f78 ]
  ...
  br i1 %153, label %block_400f78, label %block_.L_400fa4
...
block_400f78:                                     ; preds = %block_.L_400f6c
  ...
  %call2_400f91 = tail call %struct.Memory* @sub_400fd0.print_element(%struct.State* %0, i64 %189, %struct.Memory* %MEMORY.0)
