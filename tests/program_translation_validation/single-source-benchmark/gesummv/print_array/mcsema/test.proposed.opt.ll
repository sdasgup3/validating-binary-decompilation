...
declare %struct.Memory* @sub_400fd0.print_element(%struct.State* noalias dereferenceable(3376), i64, %struct.Memory* noalias readnone returned) local_unnamed_addr
...
block_.L_400f6c:                                  ; preds = %block_400f78, %entry
  %123 = phi i64 [ %.pre, %entry ], [ %232, %block_400f78 ]
  %MEMORY.0 = phi %struct.Memory* [ %79, %entry ], [ %call2_400f91, %block_400f78 ]
  ...
  br i1 %159, label %block_400f78, label %block_.L_400fa4
...
block_400f78:                                     ; preds = %block_.L_400f6c
  ...
  %call2_400f91 = tail call %struct.Memory* @sub_400fd0.print_element(%struct.State* %0, i64 %195, %struct.Memory* %MEMORY.0)
...
define %struct.Memory* @routine_jge_.L_400fa4(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i8* %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
...
define %struct.Memory* @routine_jmpq_.L_400f6c(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
