...
block_.L_400f8c:                                  ; preds = %block_400f98, %entry
  %124 = phi i64 [ %231, %block_400f98 ], [ %.pre, %entry ]
  ...
  br i1 %160, label %block_400f98, label %block_.L_400fc4
...
block_400f98:                                     ; preds = %block_.L_400f8c
  ...
  %call2_400fb1 = tail call %struct.Memory* @sub_400ff0.print_element(%struct.State* nonnull %0, i64 %195, %struct.Memory* %79)
