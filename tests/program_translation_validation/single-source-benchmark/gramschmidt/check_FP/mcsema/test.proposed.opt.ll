...
@G_0x458__rip_ = local_unnamed_addr global %G_0x458__rip__type zeroinitializer
...
entry:
  ...
  %42 = load i64, i64* bitcast (%G_0x458__rip__type* @G_0x458__rip_ to i64*), align 8
...
block_.L_40114a:                                  ; preds = %block_.L_401225, %entry
  %96 = phi i64 [ %.pre, %entry ], [ %465, %block_.L_401225 ]
  ...
  br i1 %132, label %block_401156, label %block_.L_401238
...
block_.L_40115d:                                  ; preds = %block_.L_401212, %block_401156
  %137 = phi i64 [ %.pre3, %block_401156 ], [ %434, %block_.L_401212 ]
  %MEMORY.1 = phi %struct.Memory* [ %MEMORY.0, %block_401156 ], [ %340, %block_.L_401212 ]
  ...
  br i1 %173, label %block_401169, label %block_.L_401225
...
block_401169:                                     ; preds = %block_.L_40115d
  ...
  %288 = load i32, i32* bitcast (%G_0x3dc__rip__type* @G_0x3dc__rip_ to i32*), align 8
  %289 = load i32, i32* inttoptr (i64 add (i64 ptrtoint (%G_0x3dc__rip__type* @G_0x3dc__rip_ to i64), i64 4) to i32*), align 4
  %290 = load i32, i32* inttoptr (i64 add (i64 ptrtoint (%G_0x3dc__rip__type* @G_0x3dc__rip_ to i64), i64 8) to i32*), align 8
  %291 = load i32, i32* inttoptr (i64 add (i64 ptrtoint (%G_0x3dc__rip__type* @G_0x3dc__rip_ to i64), i64 12) to i32*), align 4
...
routine_ucomisd_MINUS0x30__rbp____xmm0.exit:      ; preds = %338, %326
  ...
  br i1 %344, label %block_.L_401212, label %block_4011cd
...
block_.L_40123f:                                  ; preds = %block_.L_401238, %block_4011cd
  %469 = phi i64 [ %.pre5, %block_.L_401238 ], [ %402, %block_4011cd ]
  %MEMORY.2 = phi %struct.Memory* [ %MEMORY.0, %block_.L_401238 ], [ %389, %block_4011cd ]
...
block_400478:
  ...
  %5 = load i64, i64* bitcast (%G_0x458__rip__type* @G_0x458__rip_ to i64*), align 8
...
block_400478:
  ...
  %6 = add i64 %5, 7
  store i64 %6, i64* %PC, align 8
  %7 = load i32, i32* bitcast (%G_0x3dc__rip__type* @G_0x3dc__rip_ to i32*), align 8
  %8 = load i32, i32* inttoptr (i64 add (i64 ptrtoint (%G_0x3dc__rip__type* @G_0x3dc__rip_ to i64), i64 4) to i32*), align 4
  %9 = load i32, i32* inttoptr (i64 add (i64 ptrtoint (%G_0x3dc__rip__type* @G_0x3dc__rip_ to i64), i64 8) to i32*), align 8
  %10 = load i32, i32* inttoptr (i64 add (i64 ptrtoint (%G_0x3dc__rip__type* @G_0x3dc__rip_ to i64), i64 12) to i32*), align 4
