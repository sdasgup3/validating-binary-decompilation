...
declare %struct.Memory* @sub_400630.sqrt_plt(%struct.State* noalias dereferenceable(3376), i64, %struct.Memory* noalias readnone returned) local_unnamed_addr

; Function Attrs: alwaysinline
define %struct.Memory* @kernel_gramschmidt_StrictFP(%struct.State* noalias, i64, %struct.Memory* noalias readnone) local_unnamed_addr #1 {
entry:
...
block_.L_400ef1:                                  ; preds = %block_.L_401121, %entry
  %86 = phi i64 [ %1215, %block_.L_401121 ], [ %.pre, %entry ]
...
block_.L_400f60:                                  ; preds = %block_.L_400f0c
  ...
  %call2_400f65 = tail call %struct.Memory* @sub_400630.sqrt_plt(%struct.State* nonnull %0, i64 %305, %struct.Memory* %2)
