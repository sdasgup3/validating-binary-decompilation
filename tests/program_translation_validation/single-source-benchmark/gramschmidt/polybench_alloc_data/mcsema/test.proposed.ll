...
declare %struct.Memory* @sub_400860.xmalloc(%struct.State* noalias dereferenceable(3376), i64, %struct.Memory* noalias readnone returned)
...
entry:
  ...
  ; Code: .polybench_alloc_data:	 RIP: 400820	 Bytes: 0
  ...
  ; Code: movq %rdi, -0x8(%rbp)	 RIP: 400828	 Bytes: 4
  %loadMem_400828 = load %struct.Memory*, %struct.Memory** %MEMORY
  %call_400828 = call %struct.Memory* @routine_movq__rdi__MINUS0x8__rbp_(%struct.State* %0, i64  0, %struct.Memory* %loadMem_400828)
  store %struct.Memory* %call_400828, %struct.Memory** %MEMORY

  ; Code: movl %esi, -0xc(%rbp)	 RIP: 40082c	 Bytes: 3
  %loadMem_40082c = load %struct.Memory*, %struct.Memory** %MEMORY
  %call_40082c = call %struct.Memory* @routine_movl__esi__MINUS0xc__rbp_(%struct.State* %0, i64  0, %struct.Memory* %loadMem_40082c)
  store %struct.Memory* %call_40082c, %struct.Memory** %MEMORY

  ; Code: movq -0x8(%rbp), %rdi	 RIP: 40082f	 Bytes: 4
  %loadMem_40082f = load %struct.Memory*, %struct.Memory** %MEMORY
  %call_40082f = call %struct.Memory* @routine_movq_MINUS0x8__rbp____rdi(%struct.State* %0, i64  0, %struct.Memory* %loadMem_40082f)
  store %struct.Memory* %call_40082f, %struct.Memory** %MEMORY

  ; Code: movq %rdi, -0x18(%rbp)	 RIP: 400833	 Bytes: 4
  %loadMem_400833 = load %struct.Memory*, %struct.Memory** %MEMORY
  %call_400833 = call %struct.Memory* @routine_movq__rdi__MINUS0x18__rbp_(%struct.State* %0, i64  0, %struct.Memory* %loadMem_400833)
  store %struct.Memory* %call_400833, %struct.Memory** %MEMORY

  ; Code: movslq -0xc(%rbp), %rdi	 RIP: 400837	 Bytes: 4
  %loadMem_400837 = load %struct.Memory*, %struct.Memory** %MEMORY
  %call_400837 = call %struct.Memory* @routine_movslq_MINUS0xc__rbp____rdi(%struct.State* %0, i64  0, %struct.Memory* %loadMem_400837)
  store %struct.Memory* %call_400837, %struct.Memory** %MEMORY

  ; Code: imulq -0x18(%rbp), %rdi	 RIP: 40083b	 Bytes: 5
  %loadMem_40083b = load %struct.Memory*, %struct.Memory** %MEMORY
  %call_40083b = call %struct.Memory* @routine_imulq_MINUS0x18__rbp____rdi(%struct.State* %0, i64  0, %struct.Memory* %loadMem_40083b)
  store %struct.Memory* %call_40083b, %struct.Memory** %MEMORY

  ; Code: movq %rdi, -0x18(%rbp)	 RIP: 400840	 Bytes: 4
  %loadMem_400840 = load %struct.Memory*, %struct.Memory** %MEMORY
  %call_400840 = call %struct.Memory* @routine_movq__rdi__MINUS0x18__rbp_(%struct.State* %0, i64  0, %struct.Memory* %loadMem_400840)
  store %struct.Memory* %call_400840, %struct.Memory** %MEMORY

  ; Code: movq -0x18(%rbp), %rdi	 RIP: 400844	 Bytes: 4
  %loadMem_400844 = load %struct.Memory*, %struct.Memory** %MEMORY
  %call_400844 = call %struct.Memory* @routine_movq_MINUS0x18__rbp____rdi(%struct.State* %0, i64  0, %struct.Memory* %loadMem_400844)
  store %struct.Memory* %call_400844, %struct.Memory** %MEMORY

  ; Code: callq .xmalloc	 RIP: 400848	 Bytes: 5
  %loadMem1_400848 = load %struct.Memory*, %struct.Memory** %MEMORY
  %call1_400848 = call %struct.Memory* @routine_callq_.xmalloc(%struct.State* %0, i64  0, %struct.Memory* %loadMem1_400848, i64 24, i64 5, i64 5)
  ...
  %call2_400848 = call %struct.Memory* @sub_400860.xmalloc(%struct.State* %0, i64  %loadPC_400848, %struct.Memory* %loadMem2_400848)
  store %struct.Memory* %call2_400848, %struct.Memory** %MEMORY

  ; Code: movq %rax, -0x20(%rbp)	 RIP: 40084d	 Bytes: 4
  %loadMem_40084d = load %struct.Memory*, %struct.Memory** %MEMORY
  %call_40084d = call %struct.Memory* @routine_movq__rax__MINUS0x20__rbp_(%struct.State* %0, i64  0, %struct.Memory* %loadMem_40084d)
  store %struct.Memory* %call_40084d, %struct.Memory** %MEMORY

  ; Code: movq -0x20(%rbp), %rax	 RIP: 400851	 Bytes: 4
  %loadMem_400851 = load %struct.Memory*, %struct.Memory** %MEMORY
  %call_400851 = call %struct.Memory* @routine_movq_MINUS0x20__rbp____rax(%struct.State* %0, i64  0, %struct.Memory* %loadMem_400851)
  store %struct.Memory* %call_400851, %struct.Memory** %MEMORY

  ; Code: addq $0x20, %rsp	 RIP: 400855	 Bytes: 4
  %loadMem_400855 = load %struct.Memory*, %struct.Memory** %MEMORY
  %call_400855 = call %struct.Memory* @routine_addq__0x20___rsp(%struct.State* %0, i64  0, %struct.Memory* %loadMem_400855)
