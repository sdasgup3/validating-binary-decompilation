...
declare %struct.Memory* @sub_400860.xmalloc(%struct.State* noalias dereferenceable(3376), i64, %struct.Memory* noalias readnone returned) local_unnamed_addr
...
entry:
  ...
  %call2_400848 = tail call %struct.Memory* @sub_400860.xmalloc(%struct.State* %0, i64 %98, %struct.Memory* %2)
  ...
  %115 = load i64, i64* %RSP.i36, align 8
  %116 = add i64 %115, 32
  store i64 %116, i64* %RSP.i36, align 8
  ...
  ret %struct.Memory* %call2_400848
}
