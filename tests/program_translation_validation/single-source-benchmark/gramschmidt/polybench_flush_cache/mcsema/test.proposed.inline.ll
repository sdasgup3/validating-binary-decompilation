...
entry:
  ...
  %130 = call %struct.Memory* @__remill_function_call(%struct.State* %0, i64 ptrtoint (i64 (i64, i64)* @calloc to i64), %struct.Memory* %loadMem2_40071a)
...
block_.L_400763:                                  ; preds = %block_.L_400732
  ...
  %511 = call %struct.Memory* @__remill_function_call(%struct.State* %0, i64 ptrtoint (i64 (i64)* @free to i64), %struct.Memory* %loadMem2_40076a)
  ...
  ret %struct.Memory* %loadMem_400774
}
