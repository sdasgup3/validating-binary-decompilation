...
declare %struct.Memory* @sub_4005f0.calloc_plt(%struct.State* noalias dereferenceable(3376), i64, %struct.Memory* noalias readnone returned)
...
entry:
  ...
  %call2_40074a = call %struct.Memory* @sub_4005f0.calloc_plt(%struct.State* %0, i64  %loadPC_40074a, %struct.Memory* %loadMem2_40074a)
...
block_.L_400793:
  ...
  %call1_40079a = call %struct.Memory* @routine_callq_.free_plt(%struct.State* %0, i64  0, %struct.Memory* %loadMem1_40079a, i64 -458, i64 5, i64 5)
  ...
  %call2_40079a = call %struct.Memory* @sub_4005d0.free_plt(%struct.State* %0, i64  %loadPC_40079a, %struct.Memory* %loadMem2_40079a)
