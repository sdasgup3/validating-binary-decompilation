...
@G__0x4015d0 = global %G__0x4015d0_type zeroinitializer
...
entry:
  ...
  store i64 ptrtoint (%G__0x4015d0_type* @G__0x4015d0 to i64), i64* %RDI.i, align 8
  ...
  %129 = call %struct.Memory* @__remill_function_call(%struct.State* %0, i64 ptrtoint (i64 (i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64)* @printf to i64), %struct.Memory* %loadMem2_400846)
  ...
  ret %struct.Memory* %loadMem_400853
}
...
block_400488:
  ...
  %10 = add i64 %9, 10
  store i64 %10, i64* %PC
  store i64 ptrtoint (%G__0x4015d0_type* @G__0x4015d0 to i64), i64* %RDI, align 8
  ret %struct.Memory* %2
}
