...
declare %struct.Memory* @sub_4007b0.rtclock(%struct.State* noalias dereferenceable(3376), i64, %struct.Memory* noalias readnone returned)
...
entry:
  ...
  %call2_4007c4 = call %struct.Memory* @sub_4007b0.rtclock(%struct.State* %0, i64 %loadPC_4007c4, %struct.Memory* %loadMem2_4007c4)
  ...
  ret %struct.Memory* %loadMem_4007d3
}
