...
declare %struct.Memory* @sub_4007e0.rtclock(%struct.State* dereferenceable(3376), i64, %struct.Memory*)

; Function Attrs: alwaysinline
define %struct.Memory* @polybench_timer_stop(%struct.State* noalias, i64, %struct.Memory* noalias) #1 {
entry:
  ...
  store double %52, double* inttoptr (i64 6299784 to double*)
...
block_400488:
  ...
  store double %12, double* inttoptr (i64 6299784 to double*)
  ret %struct.Memory* %2
}
