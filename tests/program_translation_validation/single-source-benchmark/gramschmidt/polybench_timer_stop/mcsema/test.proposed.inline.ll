...
@G_0x602088 = global %G_0x602088_type zeroinitializer
...
declare %struct.Memory* @sub_4007f0.rtclock(%struct.State* noalias dereferenceable(3376), i64, %struct.Memory* noalias readnone returned)
...
entry:
  ...
  %call2_400804 = call %struct.Memory* @sub_4007f0.rtclock(%struct.State* %0, i64 %loadPC_400804, %struct.Memory* %loadMem2_400804)
  ...
  store double %52, double* bitcast (%G_0x602088_type* @G_0x602088 to double*)
...
define %struct.Memory* @routine_movsd__xmm0__0x602088(%struct.State* dereferenceable(3376), i64, %struct.Memory*) {
block_400488:
  %3 = getelementptr inbounds %struct.State, %struct.State* %0, i32 0, i32 6
  %4 = getelementptr inbounds %struct.GPR, %struct.GPR* %3, i32 0, i32 33
  %5 = getelementptr inbounds %struct.Reg, %struct.Reg* %4, i32 0, i32 0
  ...
  store double %12, double* bitcast (%G_0x602088_type* @G_0x602088 to double*)
  ret %struct.Memory* %2
}
