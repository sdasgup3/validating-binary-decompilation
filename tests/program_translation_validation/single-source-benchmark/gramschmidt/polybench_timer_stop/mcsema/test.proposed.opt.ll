...
declare %struct.Memory* @sub_4007f0.rtclock(%struct.State* noalias dereferenceable(3376), i64, %struct.Memory* noalias readnone returned) local_unnamed_addr
...
entry:
  ...
  %call2_400804 = tail call %struct.Memory* @sub_4007f0.rtclock(%struct.State* %0, i64 %11, %struct.Memory* %2)
  ...
  ret %struct.Memory* %call2_400804
}
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_movsd__xmm0__0x602088(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned) local_unnamed_addr #1 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, 9
