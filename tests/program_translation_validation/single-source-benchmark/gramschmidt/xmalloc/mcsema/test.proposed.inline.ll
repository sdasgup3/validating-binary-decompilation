...
@G__0x4015a7 = global %G__0x4015a7_type zeroinitializer
...
entry:
  ...
  %169 = call %struct.Memory* @__remill_function_call(%struct.State* %0, i64 ptrtoint (i64 (i64, i64, i64)* @posix_memalign to i64), %struct.Memory* %loadMem2_400886)
  ...
  br i1 %cmpBr_400893, label %block_.L_4008a3, label %block_400899

block_400899:                                     ; preds = %entry
  ...
  %loadBr_40089d = load i8, i8* %BRANCH_TAKEN
  %cmpBr_40089d = icmp eq i8 %loadBr_40089d, 1
  br i1 %cmpBr_40089d, label %block_.L_4008c9, label %block_.L_4008a3

block_.L_4008a3:                                  ; preds = %block_400899, %entry
  ...
  store i64 ptrtoint (%G__0x4015a7_type* @G__0x4015a7 to i64), i64* %RSI.i, align 8
  ...
  %319 = call %struct.Memory* @__remill_function_call(%struct.State* %0, i64 ptrtoint (i64 (i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64)* @fprintf to i64), %struct.Memory* %loadMem2_4008b7)
  ...
  %358 = call %struct.Memory* @__remill_function_call(%struct.State* %0, i64 ptrtoint (i64 (i64)* @exit to i64), %struct.Memory* %loadMem2_4008c4)
  store %struct.Memory* %358, %struct.Memory** %MEMORY
  br label %block_.L_4008c9

block_.L_4008c9:                                  ; preds = %block_.L_4008a3, %block_400899
...
define %struct.Memory* @routine_je_.L_4008a3(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i8* %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) {
block_400478:
  %3 = getelementptr inbounds %struct.State, %struct.State* %0, i32 0, i32 6
  %4 = getelementptr inbounds %struct.GPR, %struct.GPR* %3, i32 0, i32 33
  %5 = getelementptr inbounds %struct.Reg, %struct.Reg* %4, i32 0, i32 0
...
define %struct.Memory* @routine_je_.L_4008c9(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i8* %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) {
block_400478:
  %3 = getelementptr inbounds %struct.State, %struct.State* %0, i32 0, i32 6
  %4 = getelementptr inbounds %struct.GPR, %struct.GPR* %3, i32 0, i32 33
  %5 = getelementptr inbounds %struct.Reg, %struct.Reg* %4, i32 0, i32 0
...
define %struct.Memory* @routine_movq__0x4015a7___rsi(%struct.State* dereferenceable(3376), i64, %struct.Memory*) {
block_400478:
  %3 = getelementptr inbounds %struct.State, %struct.State* %0, i32 0, i32 6
  %4 = getelementptr inbounds %struct.GPR, %struct.GPR* %3, i32 0, i32 33
  %5 = getelementptr inbounds %struct.Reg, %struct.Reg* %4, i32 0, i32 0
  ...
  %10 = add i64 %9, 10
  store i64 %10, i64* %PC
  store i64 ptrtoint (%G__0x4015a7_type* @G__0x4015a7 to i64), i64* %RSI, align 8
  ret %struct.Memory* %2
}
