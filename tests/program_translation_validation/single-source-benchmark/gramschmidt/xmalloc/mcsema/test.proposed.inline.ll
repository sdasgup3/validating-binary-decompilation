...
declare %struct.Memory* @sub_400620.posix_memalign_plt(%struct.State* noalias dereferenceable(3376), i64, %struct.Memory* noalias readnone returned)
...
declare %struct.Memory* @sub_400610.exit_plt(%struct.State* noalias dereferenceable(3376), i64, %struct.Memory* noalias readnone returned)
...
entry:
  ...
  %call2_4008b6 = call %struct.Memory* @sub_400620.posix_memalign_plt(%struct.State* %0, i64 %loadPC_4008b6, %struct.Memory* %loadMem2_4008b6)
...
block_.L_4008d3:                                  ; preds = %block_4008c9, %entry
  ...
  store i64 4199879, i64* %RSI.i, align 8
  ...
  %call2_4008e7 = call %struct.Memory* @sub_400600.fprintf_plt(%struct.State* %0, i64 %loadPC_4008e7, %struct.Memory* %loadMem2_4008e7)
  ...
  %call2_4008f4 = call %struct.Memory* @sub_400610.exit_plt(%struct.State* %0, i64 %loadPC_4008f4, %struct.Memory* %loadMem2_4008f4)
...
define %struct.Memory* @routine_movq__0x4015c7___rsi(%struct.State* dereferenceable(3376), i64, %struct.Memory*) {
block_400488:
  %3 = getelementptr inbounds %struct.State, %struct.State* %0, i32 0, i32 6
  %4 = getelementptr inbounds %struct.GPR, %struct.GPR* %3, i32 0, i32 33
  %5 = getelementptr inbounds %struct.Reg, %struct.Reg* %4, i32 0, i32 0
