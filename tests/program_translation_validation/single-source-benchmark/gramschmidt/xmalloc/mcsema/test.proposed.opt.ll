...
entry:
  ...
  br i1 %81, label %block_.L_4008a3, label %block_400899
...
block_400899:                                     ; preds = %entry
  ...
  br i1 %95, label %block_.L_4008c9, label %block_.L_4008a3

block_.L_4008a3:                                  ; preds = %block_400899, %entry
  %100 = phi i64 [ %99, %block_400899 ], [ %85, %entry ]
  store i64 ptrtoint (%G__0x4015a7_type* @G__0x4015a7 to i64), i64* %RSI.i45, align 8
...
block_.L_4008c9:                                  ; preds = %block_.L_4008a3, %block_400899
  %121 = phi i64 [ %.pre1, %block_.L_4008a3 ], [ %99, %block_400899 ]
  %122 = phi i64 [ %.pre, %block_.L_4008a3 ], [ %69, %block_400899 ]
  %MEMORY.1 = phi %struct.Memory* [ %120, %block_.L_4008a3 ], [ %62, %block_400899 ]
  %123 = add i64 %122, -16
  %124 = add i64 %121, 4
...
define %struct.Memory* @routine_je_.L_4008a3(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i8* %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
...
define %struct.Memory* @routine_je_.L_4008c9(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i8* %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 2, i32 7
...
define %struct.Memory* @routine_movq__0x4015a7___rsi(%struct.State* dereferenceable(3376), i64, %struct.Memory*) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %RSI = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 9, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
