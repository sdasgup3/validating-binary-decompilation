...
entry:
  ...
  br i1 %81, label %block_.L_4008e3, label %block_4008d9
...
block_4008d9:                                     ; preds = %entry
  ...
  br i1 %95, label %block_.L_400909, label %block_.L_4008e3

block_.L_4008e3:                                  ; preds = %block_4008d9, %entry
  %100 = phi i64 [ %99, %block_4008d9 ], [ %85, %entry ]
  store i64 ptrtoint (%G__0x4015d7_type* @G__0x4015d7 to i64), i64* %RSI.i45, align 8
...
block_.L_400909:                                  ; preds = %block_.L_4008e3, %block_4008d9
  %121 = phi i64 [ %.pre2, %block_.L_4008e3 ], [ %99, %block_4008d9 ]
  %122 = phi i64 [ %.pre, %block_.L_4008e3 ], [ %69, %block_4008d9 ]
  %MEMORY.1 = phi %struct.Memory* [ %120, %block_.L_4008e3 ], [ %62, %block_4008d9 ]
  %123 = add i64 %122, -16
  %124 = add i64 %121, 4
