; ModuleID = '/tmp/tmpfcj6xq3v-query.ll'
...
@G__0x4015d7 = global %G__0x4015d7_type zeroinitializer
...
entry:
  ...
  br i1 %var_2_81, label %block_.L_4008e3, label %block_4008d9

block_4008d9:                                     ; preds = %entry
  ...
  br i1 %var_2_95, label %block_.L_400909, label %block_.L_4008e3

block_.L_4008e3:                                  ; preds = %block_4008d9, %entry
...
block_.L_400909:                                  ; preds = %block_.L_4008e3, %block_4008d9
  %var_2_121 = phi i64 [ %.pre2, %block_.L_4008e3 ], [ %var_2_99, %block_4008d9 ]
  %var_2_122 = phi i64 [ %.pre, %block_.L_4008e3 ], [ %var_2_69, %block_4008d9 ]
  %MEMORY.1 = phi %struct.Memory* [ %var_2_120, %block_.L_4008e3 ], [ %var_2_62, %block_4008d9 ]
...
; Function Attrs: alwaysinline norecurse nounwind
define %struct.Memory* @routine_je_.L_4008e3(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i8* nocapture %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
...
; Function Attrs: alwaysinline norecurse nounwind
define %struct.Memory* @routine_je_.L_400909(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i8* nocapture %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 2, i32 7
...
; Function Attrs: alwaysinline norecurse nounwind
define %struct.Memory* @routine_movq__0x4015d7___rsi(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %RSI = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 9, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, 10
  store i64 %4, i64* %PC, align 8
  store i64 ptrtoint (%G__0x4015d7_type* @G__0x4015d7 to i64), i64* %RSI, align 8
  ret %struct.Memory* %2
}
