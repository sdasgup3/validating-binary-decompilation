...
; Data Access Globals
%G_0x3b4__rip__4200940__type = type <{ [16 x i8] }>
@G_0x3b4__rip__4200940_= global %G_0x3b4__rip__4200940__type <{ [16 x i8] c"\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00" }>


define %struct.Memory* @fflop(%struct.State* noalias , i64, %struct.Memory* noalias) alwaysinline  {
entry:
  ...
  ; Code: movsd 0x3b4(%rip), %xmm0	 RIP: 4019e4	 Bytes: 8
  %loadMem_4019e4 = load %struct.Memory*, %struct.Memory** %MEMORY
  %call_4019e4 = call %struct.Memory* @routine_movsd_0x3b4__rip____xmm0(%struct.State* %0, i64  0, %struct.Memory* %loadMem_4019e4)
  store %struct.Memory* %call_4019e4, %struct.Memory** %MEMORY

  ; Code: movl %edi, -0x4(%rbp)	 RIP: 4019ec	 Bytes: 3
  %loadMem_4019ec = load %struct.Memory*, %struct.Memory** %MEMORY
  %call_4019ec = call %struct.Memory* @routine_movl__edi__MINUS0x4__rbp_(%struct.State* %0, i64  0, %struct.Memory* %loadMem_4019ec)
  store %struct.Memory* %call_4019ec, %struct.Memory** %MEMORY

  ; Code: movl %esi, -0x8(%rbp)	 RIP: 4019ef	 Bytes: 3
  %loadMem_4019ef = load %struct.Memory*, %struct.Memory** %MEMORY
  %call_4019ef = call %struct.Memory* @routine_movl__esi__MINUS0x8__rbp_(%struct.State* %0, i64  0, %struct.Memory* %loadMem_4019ef)
  store %struct.Memory* %call_4019ef, %struct.Memory** %MEMORY

  ; Code: movl %edx, -0xc(%rbp)	 RIP: 4019f2	 Bytes: 3
  %loadMem_4019f2 = load %struct.Memory*, %struct.Memory** %MEMORY
  %call_4019f2 = call %struct.Memory* @routine_movl__edx__MINUS0xc__rbp_(%struct.State* %0, i64  0, %struct.Memory* %loadMem_4019f2)
  store %struct.Memory* %call_4019f2, %struct.Memory** %MEMORY

  ; Code: movl -0xc(%rbp), %edx	 RIP: 4019f5	 Bytes: 3
  %loadMem_4019f5 = load %struct.Memory*, %struct.Memory** %MEMORY
  %call_4019f5 = call %struct.Memory* @routine_movl_MINUS0xc__rbp____edx(%struct.State* %0, i64  0, %struct.Memory* %loadMem_4019f5)
  store %struct.Memory* %call_4019f5, %struct.Memory** %MEMORY

  ; Code: subl $0x2, %edx	 RIP: 4019f8	 Bytes: 3
  %loadMem_4019f8 = load %struct.Memory*, %struct.Memory** %MEMORY
  %call_4019f8 = call %struct.Memory* @routine_subl__0x2___edx(%struct.State* %0, i64  0, %struct.Memory* %loadMem_4019f8)
  store %struct.Memory* %call_4019f8, %struct.Memory** %MEMORY

  ; Code: cvtsi2sdl %edx, %xmm1	 RIP: 4019fb	 Bytes: 4
  %loadMem_4019fb = load %struct.Memory*, %struct.Memory** %MEMORY
  %call_4019fb = call %struct.Memory* @routine_cvtsi2sdl__edx___xmm1(%struct.State* %0, i64  0, %struct.Memory* %loadMem_4019fb)
  store %struct.Memory* %call_4019fb, %struct.Memory** %MEMORY

  ; Code: movl -0x8(%rbp), %edx	 RIP: 4019ff	 Bytes: 3
  %loadMem_4019ff = load %struct.Memory*, %struct.Memory** %MEMORY
  %call_4019ff = call %struct.Memory* @routine_movl_MINUS0x8__rbp____edx(%struct.State* %0, i64  0, %struct.Memory* %loadMem_4019ff)
  store %struct.Memory* %call_4019ff, %struct.Memory** %MEMORY

  ; Code: subl $0x2, %edx	 RIP: 401a02	 Bytes: 3
  %loadMem_401a02 = load %struct.Memory*, %struct.Memory** %MEMORY
  %call_401a02 = call %struct.Memory* @routine_subl__0x2___edx(%struct.State* %0, i64  0, %struct.Memory* %loadMem_401a02)
  store %struct.Memory* %call_401a02, %struct.Memory** %MEMORY

  ; Code: cvtsi2sdl %edx, %xmm2	 RIP: 401a05	 Bytes: 4
  %loadMem_401a05 = load %struct.Memory*, %struct.Memory** %MEMORY
  %call_401a05 = call %struct.Memory* @routine_cvtsi2sdl__edx___xmm2(%struct.State* %0, i64  0, %struct.Memory* %loadMem_401a05)
  store %struct.Memory* %call_401a05, %struct.Memory** %MEMORY

  ; Code: mulsd %xmm2, %xmm1	 RIP: 401a09	 Bytes: 4
  %loadMem_401a09 = load %struct.Memory*, %struct.Memory** %MEMORY
  %call_401a09 = call %struct.Memory* @routine_mulsd__xmm2___xmm1(%struct.State* %0, i64  0, %struct.Memory* %loadMem_401a09)
  store %struct.Memory* %call_401a09, %struct.Memory** %MEMORY

  ; Code: movl -0x4(%rbp), %edx	 RIP: 401a0d	 Bytes: 3
  %loadMem_401a0d = load %struct.Memory*, %struct.Memory** %MEMORY
  %call_401a0d = call %struct.Memory* @routine_movl_MINUS0x4__rbp____edx(%struct.State* %0, i64  0, %struct.Memory* %loadMem_401a0d)
  store %struct.Memory* %call_401a0d, %struct.Memory** %MEMORY

  ; Code: subl $0x2, %edx	 RIP: 401a10	 Bytes: 3
  %loadMem_401a10 = load %struct.Memory*, %struct.Memory** %MEMORY
  %call_401a10 = call %struct.Memory* @routine_subl__0x2___edx(%struct.State* %0, i64  0, %struct.Memory* %loadMem_401a10)
  store %struct.Memory* %call_401a10, %struct.Memory** %MEMORY

  ; Code: cvtsi2sdl %edx, %xmm2	 RIP: 401a13	 Bytes: 4
  %loadMem_401a13 = load %struct.Memory*, %struct.Memory** %MEMORY
  %call_401a13 = call %struct.Memory* @routine_cvtsi2sdl__edx___xmm2(%struct.State* %0, i64  0, %struct.Memory* %loadMem_401a13)
  store %struct.Memory* %call_401a13, %struct.Memory** %MEMORY

  ; Code: mulsd %xmm2, %xmm1	 RIP: 401a17	 Bytes: 4
  %loadMem_401a17 = load %struct.Memory*, %struct.Memory** %MEMORY
  %call_401a17 = call %struct.Memory* @routine_mulsd__xmm2___xmm1(%struct.State* %0, i64  0, %struct.Memory* %loadMem_401a17)
  store %struct.Memory* %call_401a17, %struct.Memory** %MEMORY

  ; Code: mulsd %xmm0, %xmm1	 RIP: 401a1b	 Bytes: 4
  %loadMem_401a1b = load %struct.Memory*, %struct.Memory** %MEMORY
  %call_401a1b = call %struct.Memory* @routine_mulsd__xmm0___xmm1(%struct.State* %0, i64  0, %struct.Memory* %loadMem_401a1b)
  store %struct.Memory* %call_401a1b, %struct.Memory** %MEMORY

  ; Code: movaps %xmm1, %xmm0	 RIP: 401a1f	 Bytes: 3
  %loadMem_401a1f = load %struct.Memory*, %struct.Memory** %MEMORY
  %call_401a1f = call %struct.Memory* @routine_movaps__xmm1___xmm0(%struct.State* %0, i64  0, %struct.Memory* %loadMem_401a1f)
  store %struct.Memory* %call_401a1f, %struct.Memory** %MEMORY

  ; Code: popq %rbp	 RIP: 401a22	 Bytes: 1
  %loadMem_401a22 = load %struct.Memory*, %struct.Memory** %MEMORY
  %call_401a22 = call %struct.Memory* @routine_popq__rbp(%struct.State* %0, i64  0, %struct.Memory* %loadMem_401a22)
  store %struct.Memory* %call_401a22, %struct.Memory** %MEMORY

  ; Code: retq	 RIP: 401a23	 Bytes: 1
  %loadMem_401a23 = load %struct.Memory*, %struct.Memory** %MEMORY
  %call_401a23 = call %struct.Memory* @routine_retq(%struct.State* %0, i64  0, %struct.Memory* %loadMem_401a23)
  store %struct.Memory* %call_401a23, %struct.Memory** %MEMORY

  ret %struct.Memory* %call_401a23
}
...
define %struct.Memory* @routine_movsd_0x3b4__rip____xmm0(%struct.State*  dereferenceable(3376), i64, %struct.Memory* ) #19 {
block_400478:
  %3 = getelementptr inbounds %struct.State, %struct.State* %0, i32 0, i32 6
  %4 = getelementptr inbounds %struct.GPR, %struct.GPR* %3, i32 0, i32 33
  %5 = getelementptr inbounds %struct.Reg, %struct.Reg* %4, i32 0, i32 0
  ...
  %9 = load i64, i64* %PC
  %10 = ptrtoint %G_0x3b4__rip__4200940__type* @G_0x3b4__rip__4200940_ to i64
  %11 = load i64, i64* %PC
  %12 = add i64 %11, 8
  store i64 %12, i64* %PC
