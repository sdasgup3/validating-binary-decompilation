...
entry:
  ...
  %RSP.i60 = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 13, i32 0, i32 0
  %10 = load i64, i64* %PC.i, align 8
  store i64 %8, i64* %RBP.i, align 8
  %11 = add i64 %7, -56
  store i64 %11, i64* %RSP.i60, align 8
...
block_.L_400756:                                  ; preds = %block_400764, %entry
  %83 = phi i64 [ %.pre, %entry ], [ %213, %block_400764 ]
...
block_400764:                                     ; preds = %block_.L_400756
  ...
  store i64 %188, i64* %RAX.i72, align 8
...
block_.L_400798:                                  ; preds = %block_.L_400756
  ...
  %218 = load i64, i64* %RSP.i60, align 8
  %219 = add i64 %218, 48
  store i64 %219, i64* %RSP.i60, align 8
  %220 = icmp ugt i64 %218, -49
