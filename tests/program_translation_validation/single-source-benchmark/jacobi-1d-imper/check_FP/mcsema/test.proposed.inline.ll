...
entry:
  ...
  %76 = load double, double* bitcast (%G_0x3d0__rip__type* @G_0x3d0__rip_ to double*)
...
block_400bd3:                                     ; preds = %block_.L_400bc7
  ...
  %428 = load float, float* bitcast (%G_0x388__rip__type* @G_0x388__rip_ to float*)
  %429 = load float, float* inttoptr (i64 add (i64 ptrtoint (%G_0x388__rip__type* @G_0x388__rip_ to i64), i64 4) to float*)
  %430 = load float, float* inttoptr (i64 add (i64 ptrtoint (%G_0x388__rip__type* @G_0x388__rip_ to i64), i64 8) to float*)
  %431 = load float, float* inttoptr (i64 add (i64 ptrtoint (%G_0x388__rip__type* @G_0x388__rip_ to i64), i64 12) to float*)
