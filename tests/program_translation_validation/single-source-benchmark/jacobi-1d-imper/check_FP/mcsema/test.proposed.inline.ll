...
@G_0x3d0__rip__4197296_ = global %G_0x3d0__rip__4197296__type zeroinitializer
...
entry:
  ...
  %76 = load double, double* bitcast (%G_0x3d0__rip__4197296__type* @G_0x3d0__rip__4197296_ to double*)
...
block_.L_400bc7:                                  ; preds = %block_.L_400c63, %entry
...
block_400bd3:                                     ; preds = %block_.L_400bc7
  ...
  %428 = load float, float* bitcast (%G_0x388__rip__4197384__type* @G_0x388__rip__4197384_ to float*)
  %429 = load float, float* inttoptr (i64 add (i64 ptrtoint (%G_0x388__rip__4197384__type* @G_0x388__rip__4197384_ to i64), i64 4) to float*)
  %430 = load float, float* inttoptr (i64 add (i64 ptrtoint (%G_0x388__rip__4197384__type* @G_0x388__rip__4197384_ to i64), i64 8) to float*)
  %431 = load float, float* inttoptr (i64 add (i64 ptrtoint (%G_0x388__rip__4197384__type* @G_0x388__rip__4197384_ to i64), i64 12) to float*)
...
; <label>:536:                                    ; preds = %528
  ...
  %539 = call %struct.Memory* @__remill_error(%struct.State* nonnull dereferenceable(3376) %0, i64 %538, %struct.Memory* %loadMem_400c16)
  br label %routine_ucomisd_MINUS0x28__rbp____xmm0.exit

; <label>:540:                                    ; preds = %block_400bd3
...
routine_ucomisd_MINUS0x28__rbp____xmm0.exit:      ; preds = %536, %553
  %557 = phi %struct.Memory* [ %539, %536 ], [ %loadMem_400c16, %553 ]
...
block_400c21:                                     ; preds = %routine_ucomisd_MINUS0x28__rbp____xmm0.exit
  ...
  store i64 ptrtoint (%G__0x400fda_type* @G__0x400fda to i64), i64* %RSI.i, align 8
  ...
  %702 = call %struct.Memory* @__remill_function_call(%struct.State* %0, i64 ptrtoint (i64 (i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64)* @fprintf to i64), %struct.Memory* %loadMem2_400c4a)
...
block_.L_400c63:                                  ; preds = %block_.L_400c5e
...
block_.L_400c78:                                  ; preds = %block_.L_400c71, %block_400c21
  ...
  ret %struct.Memory* %loadMem_400c80
}
...
define %struct.Memory* @routine_movsd_0x3d0__rip____xmm0(%struct.State* dereferenceable(3376), i64, %struct.Memory*) {
block_400478:
  %3 = getelementptr inbounds %struct.State, %struct.State* %0, i32 0, i32 6
  %4 = getelementptr inbounds %struct.GPR, %struct.GPR* %3, i32 0, i32 33
  %5 = getelementptr inbounds %struct.Reg, %struct.Reg* %4, i32 0, i32 0
...
define %struct.Memory* @routine_movaps_0x388__rip____xmm1(%struct.State* dereferenceable(3376), i64, %struct.Memory*) {
block_400478:
  %3 = getelementptr inbounds %struct.State, %struct.State* %0, i32 0, i32 6
  %4 = getelementptr inbounds %struct.GPR, %struct.GPR* %3, i32 0, i32 33
  %5 = getelementptr inbounds %struct.Reg, %struct.Reg* %4, i32 0, i32 0
...
define %struct.Memory* @routine_movq__0x400fda___rsi(%struct.State* dereferenceable(3376), i64, %struct.Memory*) {
block_400478:
  %3 = getelementptr inbounds %struct.State, %struct.State* %0, i32 0, i32 6
  %4 = getelementptr inbounds %struct.GPR, %struct.GPR* %3, i32 0, i32 33
  %5 = getelementptr inbounds %struct.Reg, %struct.Reg* %4, i32 0, i32 0
