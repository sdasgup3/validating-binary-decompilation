...
block_.L_400be7:                                  ; preds = %block_.L_400c7e, %entry
  %95 = phi i64 [ %.pre, %entry ], [ %317, %block_.L_400c7e ]
...
block_400c41:                                     ; preds = %routine_ucomisd_MINUS0x28__rbp____xmm0.exit
  store i64 4198394, i64* %RSI.i104, align 8
...
block_.L_400c98:                                  ; preds = %block_.L_400c91, %block_400c41
  %321 = phi i64 [ %.pre22, %block_.L_400c91 ], [ %286, %block_400c41 ]
  %MEMORY.1 = phi %struct.Memory* [ %MEMORY.0, %block_.L_400c91 ], [ %273, %block_400c41 ]
