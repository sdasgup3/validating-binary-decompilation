...
@G_0x388__rip__4197384_ = global %G_0x388__rip__4197384__type zeroinitializer
@G_0x3d0__rip__4197296_ = local_unnamed_addr global %G_0x3d0__rip__4197296__type zeroinitializer
@G_0x602080 = local_unnamed_addr global %G_0x602080_type zeroinitializer
@G__0x400fda = global %G__0x400fda_type zeroinitializer
...
entry:
  ...
  %42 = load i64, i64* bitcast (%G_0x3d0__rip__4197296__type* @G_0x3d0__rip__4197296_ to i64*), align 8
...
block_.L_400bc7:                                  ; preds = %block_.L_400c5e, %entry
  %88 = phi i64 [ %.pre, %entry ], [ %303, %block_.L_400c5e ]
  %MEMORY.0 = phi %struct.Memory* [ %2, %entry ], [ %222, %block_.L_400c5e ]
  ...
  br i1 %124, label %block_400bd3, label %block_.L_400c71

block_400bd3:                                     ; preds = %block_.L_400bc7
  %126 = add i64 %89, -16
  %127 = add i64 %125, 4
  ...
  %171 = load i32, i32* bitcast (%G_0x388__rip__4197384__type* @G_0x388__rip__4197384_ to i32*), align 8
  %172 = load i32, i32* inttoptr (i64 add (i64 ptrtoint (%G_0x388__rip__4197384__type* @G_0x388__rip__4197384_ to i64), i64 4) to i32*), align 4
  %173 = load i32, i32* inttoptr (i64 add (i64 ptrtoint (%G_0x388__rip__4197384__type* @G_0x388__rip__4197384_ to i64), i64 8) to i32*), align 8
  %174 = load i32, i32* inttoptr (i64 add (i64 ptrtoint (%G_0x388__rip__4197384__type* @G_0x388__rip__4197384_ to i64), i64 12) to i32*), align 4
...
routine_ucomisd_MINUS0x28__rbp____xmm0.exit:      ; preds = %220, %208
  ...
  br i1 %226, label %block_.L_400c5e, label %block_400c21

block_400c21:                                     ; preds = %routine_ucomisd_MINUS0x28__rbp____xmm0.exit
  store i64 ptrtoint (%G__0x400fda_type* @G__0x400fda to i64), i64* %RSI.i104, align 8
...
block_.L_400c5e:                                  ; preds = %routine_ucomisd_MINUS0x28__rbp____xmm0.exit
...
block_.L_400c71:                                  ; preds = %block_.L_400bc7
  %304 = add i64 %89, -4
  %305 = add i64 %125, 7
...
block_.L_400c78:                                  ; preds = %block_.L_400c71, %block_400c21
  %307 = phi i64 [ %.pre3, %block_.L_400c71 ], [ %272, %block_400c21 ]
  %MEMORY.1 = phi %struct.Memory* [ %MEMORY.0, %block_.L_400c71 ], [ %259, %block_400c21 ]
...
define %struct.Memory* @routine_movsd_0x3d0__rip____xmm0(%struct.State* dereferenceable(3376), i64, %struct.Memory*) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, 8
  store i64 %4, i64* %PC, align 8
  %5 = load i64, i64* bitcast (%G_0x3d0__rip__4197296__type* @G_0x3d0__rip__4197296_ to i64*), align 8
...
define %struct.Memory* @routine_jge_.L_400c71(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i8* %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
...
define %struct.Memory* @routine_movaps_0x388__rip____xmm1(%struct.State* dereferenceable(3376), i64, %struct.Memory*) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  ...
  %6 = add i64 %5, 7
  store i64 %6, i64* %PC, align 8
  %7 = load i32, i32* bitcast (%G_0x388__rip__4197384__type* @G_0x388__rip__4197384_ to i32*), align 8
  %8 = load i32, i32* inttoptr (i64 add (i64 ptrtoint (%G_0x388__rip__4197384__type* @G_0x388__rip__4197384_ to i64), i64 4) to i32*), align 4
  %9 = load i32, i32* inttoptr (i64 add (i64 ptrtoint (%G_0x388__rip__4197384__type* @G_0x388__rip__4197384_ to i64), i64 8) to i32*), align 8
  %10 = load i32, i32* inttoptr (i64 add (i64 ptrtoint (%G_0x388__rip__4197384__type* @G_0x388__rip__4197384_ to i64), i64 12) to i32*), align 4
...
define %struct.Memory* @routine_jbe_.L_400c5e(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i8* %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
...
define %struct.Memory* @routine_movq__0x400fda___rsi(%struct.State* dereferenceable(3376), i64, %struct.Memory*) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %RSI = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 9, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, 10
  store i64 %4, i64* %PC, align 8
  store i64 ptrtoint (%G__0x400fda_type* @G__0x400fda to i64), i64* %RSI, align 8
  ret %struct.Memory* %2
}
...
define %struct.Memory* @routine_jmpq_.L_400c78(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
...
define %struct.Memory* @routine_jmpq_.L_400c63(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
...
define %struct.Memory* @routine_jmpq_.L_400bc7(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
