...
block_.L_400be7:                                  ; preds = %block_.L_400c7e, %entry
  %95 = phi i64 [ %.pre, %entry ], [ %316, %block_.L_400c7e ]
  %MEMORY.0 = phi %struct.Memory* [ %2, %entry ], [ %236, %block_.L_400c7e ]
  ...
  br i1 %131, label %block_400bf3, label %block_.L_400c91
...
routine_ucomisd_MINUS0x28__rbp____xmm0.exit:      ; preds = %234, %222
  ...
  br i1 %240, label %block_.L_400c7e, label %block_400c41

block_400c41:                                     ; preds = %routine_ucomisd_MINUS0x28__rbp____xmm0.exit
  store i64 4198394, i64* %RSI.i102, align 8
  ...
  %call2_400c6a = tail call %struct.Memory* @sub_400630.fprintf_plt(%struct.State* nonnull %0, i64 %268, %struct.Memory* %236)
...
block_.L_400c7e:                                  ; preds = %routine_ucomisd_MINUS0x28__rbp____xmm0.exit
...
block_.L_400c91:                                  ; preds = %block_.L_400be7
  %317 = add i64 %96, -4
  %318 = add i64 %132, 7
...
block_.L_400c98:                                  ; preds = %block_.L_400c91, %block_400c41
  %320 = phi i64 [ %.pre22, %block_.L_400c91 ], [ %285, %block_400c41 ]
  %MEMORY.1 = phi %struct.Memory* [ %MEMORY.0, %block_.L_400c91 ], [ %call2_400c6a, %block_400c41 ]
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_jbe_.L_400c7e(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i8* nocapture %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_movq__0x400ffa___rsi(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %RSI = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 9, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  ...
  store i64 4198394, i64* %RSI, align 8
  ret %struct.Memory* %2
}
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_jmpq_.L_400c98(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_jmpq_.L_400c83(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
