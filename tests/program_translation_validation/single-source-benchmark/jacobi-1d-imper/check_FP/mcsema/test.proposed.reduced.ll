; ModuleID = '/tmp/tmp41x4612g-query.ll'
...
block_.L_400bf7:                                  ; preds = %routine_ucomisd_MINUS0x28__rbp____xmm0.exit, %entry
  ...
  br i1 %var_2_131, label %block_400c03, label %block_.L_400ca8
...
routine_ucomisd_MINUS0x28__rbp____xmm0.exit:      ; preds = %var_2_222, %var_2_214, %block_400c03
  ...
  br i1 %var_2_240, label %block_.L_400ca8, label %block_.L_400bf7

block_.L_400ca8:                                  ; preds = %routine_ucomisd_MINUS0x28__rbp____xmm0.exit, %block_.L_400bf7
