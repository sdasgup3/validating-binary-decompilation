...
entry:
  ...
  %76 = load double, double* bitcast (%G_0x440__rip__type* @G_0x440__rip_ to double*)
...
block_.L_400f07:                                  ; preds = %block_.L_400fed, %entry
  ...
  br i1 %cmpBr_400f0d, label %block_.L_400ffb, label %block_400f13
...
block_.L_400f1a:                                  ; preds = %block_.L_400fda, %block_400f13
  ...
  br i1 %cmpBr_400f20, label %block_.L_400fe8, label %block_400f26
...
; <label>:818:                                    ; preds = %810
  ...
  %821 = call %struct.Memory* @__remill_error(%struct.State* nonnull dereferenceable(3376) %0, i64 %820, %struct.Memory* %loadMem_400f85)
  br label %routine_ucomisd_MINUS0x28__rbp____xmm0.exit

; <label>:822:                                    ; preds = %block_400f26
...
routine_ucomisd_MINUS0x28__rbp____xmm0.exit:      ; preds = %818, %835
  %839 = phi %struct.Memory* [ %821, %818 ], [ %loadMem_400f85, %835 ]
  ...
  br i1 %cmpBr_400f8a, label %block_.L_400fd5, label %block_400f90
...
block_400f90:                                     ; preds = %routine_ucomisd_MINUS0x28__rbp____xmm0.exit
  ...
  store i64 ptrtoint (%G__0x40138a_type* @G__0x40138a to i64), i64* %RSI.i, align 8
  ...
  %1018 = call %struct.Memory* @__remill_function_call(%struct.State* %0, i64 ptrtoint (i64 (i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64)* @fprintf to i64), %struct.Memory* %loadMem2_400fc1)
...
block_.L_400fda:                                  ; preds = %block_.L_400fd5
...
block_.L_400fed:                                  ; preds = %block_.L_400fe8
...
block_400478:
  ...
  %9 = load i64, i64* %PC
  %10 = ptrtoint %G_0x440__rip__type* @G_0x440__rip_ to i64
  %11 = load i64, i64* %PC
  %12 = add i64 %11, 8
  store i64 %12, i64* %PC
...
define %struct.Memory* @routine_jbe_.L_400fd5(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i8* %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) {
block_400478:
  %3 = getelementptr inbounds %struct.State, %struct.State* %0, i32 0, i32 6
  %4 = getelementptr inbounds %struct.GPR, %struct.GPR* %3, i32 0, i32 33
  %5 = getelementptr inbounds %struct.Reg, %struct.Reg* %4, i32 0, i32 0
...
define %struct.Memory* @routine_jmpq_.L_401002(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i64 %rel_off1, i64 %rel_off2) {
block_400478:
  %3 = getelementptr inbounds %struct.State, %struct.State* %0, i32 0, i32 6
  %4 = getelementptr inbounds %struct.GPR, %struct.GPR* %3, i32 0, i32 33
  %5 = getelementptr inbounds %struct.Reg, %struct.Reg* %4, i32 0, i32 0
...
define %struct.Memory* @routine_jmpq_.L_400f1a(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i64 %rel_off1, i64 %rel_off2) {
block_400478:
  %3 = getelementptr inbounds %struct.State, %struct.State* %0, i32 0, i32 6
  %4 = getelementptr inbounds %struct.GPR, %struct.GPR* %3, i32 0, i32 33
  %5 = getelementptr inbounds %struct.Reg, %struct.Reg* %4, i32 0, i32 0
