...
block_400fb0:                                     ; preds = %routine_ucomisd_MINUS0x28__rbp____xmm0.exit
  ...
  %call2_400fe1 = call %struct.Memory* @sub_400630.fprintf_plt(%struct.State* %0, i64 %loadPC_400fe1, %struct.Memory* %loadMem2_400fe1)
  store %struct.Memory* %call2_400fe1, %struct.Memory** %MEMORY
