...
block_.L_400f27:                                  ; preds = %block_.L_401008, %entry
  %95 = phi i64 [ %.pre, %entry ], [ %461, %block_.L_401008 ]
...
block_.L_400f3a:                                  ; preds = %block_.L_400ff5, %block_400f33
  %136 = phi i64 [ %.pre28, %block_400f33 ], [ %431, %block_.L_400ff5 ]
...
block_400fb0:                                     ; preds = %routine_ucomisd_MINUS0x28__rbp____xmm0.exit
  store i64 4199338, i64* %RSI.i141, align 8
  ...
  %call2_400fe1 = tail call %struct.Memory* @sub_400630.fprintf_plt(%struct.State* nonnull %0, i64 %383, %struct.Memory* %341)
...
block_.L_401022:                                  ; preds = %block_.L_40101b, %block_400fb0
  %465 = phi i64 [ %.pre30, %block_.L_40101b ], [ %400, %block_400fb0 ]
  %MEMORY.2 = phi %struct.Memory* [ %MEMORY.0, %block_.L_40101b ], [ %call2_400fe1, %block_400fb0 ]
