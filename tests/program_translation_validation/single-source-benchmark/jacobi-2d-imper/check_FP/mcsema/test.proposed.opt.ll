...
block_.L_400f27:                                  ; preds = %block_.L_401008, %entry
  %95 = phi i64 [ %.pre, %entry ], [ %462, %block_.L_401008 ]
  %MEMORY.0 = phi %struct.Memory* [ %2, %entry ], [ %MEMORY.1, %block_.L_401008 ]
  ...
  br i1 %131, label %block_400f33, label %block_.L_40101b

block_400f33:                                     ; preds = %block_.L_400f27
  %133 = add i64 %96, -32
  %134 = add i64 %132, 7
...
block_.L_400f3a:                                  ; preds = %block_.L_400ff5, %block_400f33
  %136 = phi i64 [ %.pre28, %block_400f33 ], [ %432, %block_.L_400ff5 ]
  %MEMORY.1 = phi %struct.Memory* [ %MEMORY.0, %block_400f33 ], [ %341, %block_.L_400ff5 ]
  ...
  br i1 %172, label %block_400f46, label %block_.L_401008
...
routine_ucomisd_MINUS0x28__rbp____xmm0.exit:      ; preds = %339, %327
  ...
  br i1 %345, label %block_.L_400ff5, label %block_400fb0

block_400fb0:                                     ; preds = %routine_ucomisd_MINUS0x28__rbp____xmm0.exit
  store i64 4199338, i64* %RSI.i143, align 8
...
block_.L_400ff5:                                  ; preds = %routine_ucomisd_MINUS0x28__rbp____xmm0.exit
...
block_.L_401008:                                  ; preds = %block_.L_400f3a
  %433 = add i64 %137, -28
  %434 = add i64 %173, 8
...
block_.L_40101b:                                  ; preds = %block_.L_400f27
  %463 = add i64 %96, -4
  %464 = add i64 %132, 7
...
block_.L_401022:                                  ; preds = %block_.L_40101b, %block_400fb0
  %466 = phi i64 [ %.pre30, %block_.L_40101b ], [ %401, %block_400fb0 ]
  %MEMORY.2 = phi %struct.Memory* [ %MEMORY.0, %block_.L_40101b ], [ %388, %block_400fb0 ]
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_jge_.L_40101b(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i8* nocapture %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_jge_.L_401008(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i8* nocapture %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 2, i32 9
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_jbe_.L_400ff5(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i8* nocapture %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_movq__0x4013aa___rsi(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %RSI = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 9, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  ...
  store i64 4199338, i64* %RSI, align 8
  ret %struct.Memory* %2
}
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_jmpq_.L_400ffa(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_jmpq_.L_400f27(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
