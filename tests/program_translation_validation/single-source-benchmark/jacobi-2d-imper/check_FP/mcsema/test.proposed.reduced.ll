; ModuleID = '/tmp/tmpiux1cmww-query.ll'
...
entry:
  ...
  br i1 %var_2_13122, label %block_400f43.preheader, label %block_.L_401032

block_400f43.preheader:                           ; preds = %entry
  br label %block_400f43

block_.L_400f37.loopexit.loopexit:                ; preds = %routine_ucomisd_MINUS0x28__rbp____xmm0.exit.block_.L_400f4a_crit_edge
  br label %block_.L_400f37.loopexit

block_.L_400f37.loopexit:                         ; preds = %block_.L_400f37.loopexit.loopexit, %block_400f43
  %var_2_137.lcssa = phi i64 [ %var_2_1379, %block_400f43 ], [ %var_2_137.pre, %block_.L_400f37.loopexit.loopexit ]
  %MEMORY.1.lcssa = phi %struct.Memory* [ %MEMORY.023, %block_400f43 ], [ %var_2_341, %block_.L_400f37.loopexit.loopexit ]
  %var_2_146.lcssa = phi i32 [ %var_2_14624, %block_400f43 ], [ %var_2_146, %block_.L_400f37.loopexit.loopexit ]
  %var_2_165.lcssa = phi i32 [ %var_2_16528, %block_400f43 ], [ %var_2_165, %block_.L_400f37.loopexit.loopexit ]
  ...
  br i1 %var_2_131, label %block_400f43, label %block_.L_401032.loopexit

block_400f43:                                     ; preds = %block_400f43.preheader, %block_.L_400f37.loopexit
  %var_2_1379 = phi i64 [ %var_2_137.lcssa, %block_.L_400f37.loopexit ], [ %var_2_966, %block_400f43.preheader ]
  %MEMORY.023 = phi %struct.Memory* [ %MEMORY.1.lcssa, %block_.L_400f37.loopexit ], [ %2, %block_400f43.preheader ]
  ...
  br i1 %var_2_17234, label %block_400f56.preheader, label %block_.L_400f37.loopexit

block_400f56.preheader:                           ; preds = %block_400f43
  br label %block_400f56

block_400f56:                                     ; preds = %block_400f56.preheader, %routine_ucomisd_MINUS0x28__rbp____xmm0.exit.block_.L_400f4a_crit_edge
  %MEMORY.136 = phi %struct.Memory* [ %var_2_341, %routine_ucomisd_MINUS0x28__rbp____xmm0.exit.block_.L_400f4a_crit_edge ], [ %MEMORY.023, %block_400f56.preheader ]
  %var_2_13735 = phi i64 [ %var_2_137.pre, %routine_ucomisd_MINUS0x28__rbp____xmm0.exit.block_.L_400f4a_crit_edge ], [ %var_2_1379, %block_400f56.preheader ]
  ...
  %var_2_284 = add i64 %var_2_274, add (i64 ptrtoint (%G_0x3c9__rip__type* @G_0x3c9__rip_ to i64), i64 10)
  ...
  %var_2_288 = add i64 %var_2_274, add (i64 ptrtoint (%G_0x3c9__rip__type* @G_0x3c9__rip_ to i64), i64 14)
  %var_2_289 = inttoptr i64 %var_2_288 to i32*
  %var_2_290 = load i32, i32* %var_2_289, align 4
  %var_2_291 = add i64 %var_2_274, add (i64 ptrtoint (%G_0x3c9__rip__type* @G_0x3c9__rip_ to i64), i64 18)
  %var_2_292 = inttoptr i64 %var_2_291 to i32*
  %var_2_293 = load i32, i32* %var_2_292, align 4
  %var_2_294 = add i64 %var_2_274, add (i64 ptrtoint (%G_0x3c9__rip__type* @G_0x3c9__rip_ to i64), i64 22)
...
routine_ucomisd_MINUS0x28__rbp____xmm0.exit:      ; preds = %var_2_327, %var_2_319, %block_400f56
  %var_2_341 = phi %struct.Memory* [ %var_2_328, %var_2_327 ], [ %MEMORY.136, %var_2_319 ], [ %MEMORY.136, %block_400f56 ]
  ...
  br i1 %var_2_345, label %block_400fc0, label %routine_ucomisd_MINUS0x28__rbp____xmm0.exit.block_.L_400f4a_crit_edge

routine_ucomisd_MINUS0x28__rbp____xmm0.exit.block_.L_400f4a_crit_edge: ; preds = %routine_ucomisd_MINUS0x28__rbp____xmm0.exit
  ...
  br i1 %var_2_172, label %block_400f56, label %block_.L_400f37.loopexit.loopexit
...
block_.L_401032.loopexit:                         ; preds = %block_.L_400f37.loopexit
  br label %block_.L_401032

block_.L_401032:                                  ; preds = %block_.L_401032.loopexit, %block_400fc0, %entry
  %MEMORY.2 = phi %struct.Memory* [ %var_2_388, %block_400fc0 ], [ %2, %entry ], [ %MEMORY.1.lcssa, %block_.L_401032.loopexit ]
