; ModuleID = '/tmp/tmp1ph4xcdr-query.ll'
...
entry:
  ...
  br i1 %var_2_13121, label %block_400f43.preheader, label %block_.L_401032
...
block_.L_400f37.loopexit:                         ; preds = %block_.L_400f37.loopexit.loopexit, %block_400f43
  %var_2_137.lcssa = phi i64 [ %var_2_13711, %block_400f43 ], [ %var_2_137.pre, %block_.L_400f37.loopexit.loopexit ]
  %MEMORY.1.lcssa = phi %struct.Memory* [ %MEMORY.022, %block_400f43 ], [ %var_2_341, %block_.L_400f37.loopexit.loopexit ]
  %var_2_146.lcssa = phi i32 [ %var_2_14628, %block_400f43 ], [ %var_2_146, %block_.L_400f37.loopexit.loopexit ]
  %var_2_165.lcssa = phi i32 [ %var_2_16532, %block_400f43 ], [ %var_2_165, %block_.L_400f37.loopexit.loopexit ]
  ...
  br i1 %var_2_131, label %block_400f43, label %block_.L_401032.loopexit17

block_400f43:                                     ; preds = %block_400f43.preheader, %block_.L_400f37.loopexit
  %var_2_13711 = phi i64 [ %var_2_137.lcssa, %block_.L_400f37.loopexit ], [ %var_2_965, %block_400f43.preheader ]
  %MEMORY.022 = phi %struct.Memory* [ %MEMORY.1.lcssa, %block_.L_400f37.loopexit ], [ %2, %block_400f43.preheader ]
  ...
  br i1 %var_2_17238, label %block_400f56.preheader, label %block_.L_400f37.loopexit
...
block_400f56:                                     ; preds = %block_400f56.preheader, %routine_ucomisd_MINUS0x28__rbp____xmm0.exit.block_.L_400f4a_crit_edge
  %MEMORY.140 = phi %struct.Memory* [ %var_2_341, %routine_ucomisd_MINUS0x28__rbp____xmm0.exit.block_.L_400f4a_crit_edge ], [ %MEMORY.022, %block_400f56.preheader ]
  %var_2_13739 = phi i64 [ %var_2_137.pre, %routine_ucomisd_MINUS0x28__rbp____xmm0.exit.block_.L_400f4a_crit_edge ], [ %var_2_13711, %block_400f56.preheader ]
...
routine_ucomisd_MINUS0x28__rbp____xmm0.exit:      ; preds = %var_2_327, %var_2_319, %block_400f56
  %var_2_341 = phi %struct.Memory* [ %var_2_328, %var_2_327 ], [ %MEMORY.140, %var_2_319 ], [ %MEMORY.140, %block_400f56 ]
  ...
  br i1 %var_2_345, label %block_.L_401032.loopexit, label %routine_ucomisd_MINUS0x28__rbp____xmm0.exit.block_.L_400f4a_crit_edge
...
block_.L_401032.loopexit:                         ; preds = %routine_ucomisd_MINUS0x28__rbp____xmm0.exit
  br label %block_.L_401032

block_.L_401032.loopexit17:                       ; preds = %block_.L_400f37.loopexit
  br label %block_.L_401032

block_.L_401032:                                  ; preds = %block_.L_401032.loopexit17, %block_.L_401032.loopexit, %entry
