...
@G_0x7ab__rip_ = local_unnamed_addr global %G_0x7ab__rip__type zeroinitializer
...
block_.L_400b39:                                  ; preds = %block_.L_400cdf, %entry
  %54 = phi i64 [ %846, %block_.L_400cdf ], [ %.pre, %entry ]
...
block_.L_400b4c:                                  ; preds = %block_.L_400c45, %block_400b45
  %95 = phi i64 [ %578, %block_.L_400c45 ], [ %.pre1, %block_400b45 ]
...
block_.L_400b64:                                  ; preds = %block_400b75, %block_400b5d
  %138 = phi i64 [ %547, %block_400b75 ], [ %.pre2, %block_400b5d ]
...
block_400b75:                                     ; preds = %block_.L_400b64
  %178 = load i64, i64* bitcast (%G_0x7ab__rip__type* @G_0x7ab__rip_ to i64*), align 8
...
block_.L_400c5f:                                  ; preds = %block_.L_400ccc, %block_.L_400c58
  %580 = phi i64 [ %815, %block_.L_400ccc ], [ %.pre3, %block_.L_400c58 ]
  ...
  br i1 %618, label %block_400c70, label %block_.L_400cdf
...
block_.L_400c77:                                  ; preds = %block_400c88, %block_400c70
  %623 = phi i64 [ %784, %block_400c88 ], [ %.pre4, %block_400c70 ]
  ...
  br i1 %661, label %block_400c88, label %block_.L_400ccc
...
block_400478:
  ...
  %5 = load i64, i64* bitcast (%G_0x7ab__rip__type* @G_0x7ab__rip_ to i64*), align 8
