...
@G__0x401380 = global %G__0x401380_type zeroinitializer
...
entry:
  ...
  store i64 ptrtoint (%G__0x401380_type* @G__0x401380 to i64), i64* %RDI.i, align 8
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_movq__0x401380___rdi(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  ...
  store i64 ptrtoint (%G__0x401380_type* @G__0x401380 to i64), i64* %RDI, align 8
  ret %struct.Memory* %2
}
