...
entry:
  ...
  %call2_40104b = call %struct.Memory* @sub_400640.malloc_plt(%struct.State* %0, i64 %loadPC_40104b, %struct.Memory* %loadMem2_40104b)
...
block_.L_4010c5:                                  ; preds = %block_.L_40107f
  ...
  %call2_4010d1 = call %struct.Memory* @sub_400610.fputs_plt(%struct.State* %0, i64 %loadPC_4010d1, %struct.Memory* %loadMem2_4010d1)
  store %struct.Memory* %call2_4010d1, %struct.Memory** %MEMORY
...
block_.L_4010e7:                                  ; preds = %block_.L_40106c
  ...
  %call2_4010eb = call %struct.Memory* @sub_4005f0.free_plt(%struct.State* %0, i64 %loadPC_4010eb, %struct.Memory* %loadMem2_4010eb)
