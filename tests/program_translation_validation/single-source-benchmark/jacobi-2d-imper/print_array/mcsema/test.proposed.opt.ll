...
block_.L_40104c:                                  ; preds = %block_.L_4010a5, %entry
  %123 = phi i64 [ %.pre, %entry ], [ %356, %block_.L_4010a5 ]
  %MEMORY.0 = phi %struct.Memory* [ %79, %entry ], [ %317, %block_.L_4010a5 ]
  ...
  br i1 %159, label %block_401058, label %block_.L_4010c7
...
block_.L_40105f:                                  ; preds = %block_40106b, %block_401058
  %164 = phi i64 [ %.pre1, %block_401058 ], [ %306, %block_40106b ]
  ...
  %200 = xor i1 %199, %197
  %.v2 = select i1 %200, i64 12, i64 70
  %201 = add i64 %164, %.v2
  store i64 %201, i64* %3, align 8
  br i1 %200, label %block_40106b, label %block_.L_4010a5
...
block_40106b:                                     ; preds = %block_.L_40105f
  ...
  store i64 %240, i64* %RCX.i89, align 8
  ...
  %246 = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 1, i64 0, i32 0, i32 0, i32 0, i64 0
  ...
  %call2_401092 = tail call %struct.Memory* @sub_4010e0.print_element(%struct.State* %0, i64 %269, %struct.Memory* %MEMORY.1)
...
block_.L_4010a5:                                  ; preds = %block_.L_40105f
  ...
  %317 = tail call %struct.Memory* @__remill_function_call(%struct.State* %0, i64 ptrtoint (i64 (i64, i64)* @fputs to i64), %struct.Memory* %MEMORY.1)
...
block_.L_4010c7:                                  ; preds = %block_.L_40104c
  ...
  store i64 %360, i64* %RDI.i108, align 8
  %361 = add i64 %160, -2823
  %362 = add i64 %160, 9
  ...
  %367 = load i64, i64* %RSP.i6, align 8
  %368 = load i64, i64* %PC.i, align 8
  %369 = add i64 %367, 48
  store i64 %369, i64* %RSP.i6, align 8
