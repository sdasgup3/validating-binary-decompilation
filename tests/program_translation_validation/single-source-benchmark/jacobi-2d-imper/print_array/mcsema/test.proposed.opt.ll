...
block_.L_40104c:                                  ; preds = %block_.L_4010a5, %entry
  %117 = phi i64 [ %.pre, %entry ], [ %347, %block_.L_4010a5 ]
  %MEMORY.0 = phi %struct.Memory* [ %73, %entry ], [ %309, %block_.L_4010a5 ]
  ...
  br i1 %153, label %block_401058, label %block_.L_4010c7
...
block_.L_40105f:                                  ; preds = %block_40106b, %block_401058
  %158 = phi i64 [ %.pre1, %block_401058 ], [ %298, %block_40106b ]
  %MEMORY.1 = phi %struct.Memory* [ %MEMORY.0, %block_401058 ], [ %call2_401092, %block_40106b ]
  ...
  br i1 %194, label %block_40106b, label %block_.L_4010a5
...
block_40106b:                                     ; preds = %block_.L_40105f
  ...
  %call2_401092 = tail call %struct.Memory* @sub_4010e0.print_element(%struct.State* %0, i64 %262, %struct.Memory* %MEMORY.1)
...
define %struct.Memory* @routine_jge_.L_4010c7(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i8* %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
...
define %struct.Memory* @routine_jge_.L_4010a5(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i8* %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 2, i32 9
...
define %struct.Memory* @routine_jmpq_.L_40105f(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
...
define %struct.Memory* @routine_jmpq_.L_40104c(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
