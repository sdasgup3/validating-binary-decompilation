...
declare %struct.Memory* @sub_401100.print_element(%struct.State* noalias dereferenceable(3376), i64, %struct.Memory* noalias readnone returned) local_unnamed_addr
...
block_.L_40106c:                                  ; preds = %block_.L_4010c5, %entry
  %123 = phi i64 [ %352, %block_.L_4010c5 ], [ %.pre, %entry ]
...
block_.L_40107f:                                  ; preds = %block_40108b, %block_401078
  %164 = phi i64 [ %304, %block_40108b ], [ %.pre8, %block_401078 ]
...
block_40108b:                                     ; preds = %block_.L_40107f
  ...
  %call2_4010b2 = tail call %struct.Memory* @sub_401100.print_element(%struct.State* nonnull %0, i64 %268, %struct.Memory* %call2_40104b)
...
block_.L_4010c5:                                  ; preds = %block_.L_40107f
  ...
  %call2_4010d1 = tail call %struct.Memory* @sub_400610.fputs_plt(%struct.State* nonnull %0, i64 %310, %struct.Memory* %call2_40104b)
...
block_.L_4010e7:                                  ; preds = %block_.L_40106c
  ...
  %call2_4010eb = tail call %struct.Memory* @sub_4005f0.free_plt(%struct.State* nonnull %0, i64 %357, %struct.Memory* %call2_40104b)
