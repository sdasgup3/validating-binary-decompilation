...
block_.L_40104c:                                  ; preds = %block_.L_4010a5, %entry
  %117 = phi i64 [ %.pre, %entry ], [ %348, %block_.L_4010a5 ]
  %MEMORY.0 = phi %struct.Memory* [ %73, %entry ], [ %310, %block_.L_4010a5 ]
...
block_.L_40105f:                                  ; preds = %block_40106b, %block_401058
  %158 = phi i64 [ %.pre1, %block_401058 ], [ %299, %block_40106b ]
...
block_40106b:                                     ; preds = %block_.L_40105f
  ...
  %call2_401092 = tail call %struct.Memory* @sub_4010e0.print_element(%struct.State* %0, i64 %263, %struct.Memory* %MEMORY.1)
