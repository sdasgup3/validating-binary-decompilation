; ModuleID = '/tmp/tmpy_frr05f-query.ll'
...
entry:
  ...
  %var_2_79 = tail call %struct.Memory* @__remill_function_call(%struct.State* %0, i64 ptrtoint (i64 (i64)* @malloc to i64), %struct.Memory* %2)
  %var_2_12518 = load i64, i64* %RBP.i, align 8
  %var_2_12619 = add i64 %var_2_12518, -20
  %var_2_12820 = inttoptr i64 %var_2_12619 to i32*
  %var_2_12921 = load i32, i32* %var_2_12820, align 4
  %var_2_13122 = add i64 %var_2_12518, -4
  %var_2_13323 = inttoptr i64 %var_2_13122 to i32*
  %var_2_13424 = load i32, i32* %var_2_13323, align 4
  %var_2_13525 = sub i32 %var_2_12921, %var_2_13424
  %var_2_15026 = lshr i32 %var_2_13525, 31
  %var_2_15227 = lshr i32 %var_2_12921, 31
  %var_2_15328 = lshr i32 %var_2_13424, 31
  %var_2_15429 = xor i32 %var_2_15328, %var_2_15227
  %var_2_15530 = xor i32 %var_2_15026, %var_2_15227
  %var_2_15631 = add nuw nsw i32 %var_2_15530, %var_2_15429
  %var_2_15732 = icmp eq i32 %var_2_15631, 2
  %var_2_15933 = icmp ne i32 %var_2_15026, 0
  %var_2_16034 = xor i1 %var_2_15933, %var_2_15732
  br i1 %var_2_16034, label %block_401088.preheader, label %block_.L_4010f7

block_401088.preheader:                           ; preds = %entry
  br label %block_401088

block_401088:                                     ; preds = %block_401088.preheader, %block_.L_4010d5
  %var_2_175 = phi i32 [ %var_2_134, %block_.L_4010d5 ], [ %var_2_13424, %block_401088.preheader ]
  %var_2_1661 = phi i64 [ %var_2_125, %block_.L_4010d5 ], [ %var_2_12518, %block_401088.preheader ]
  %MEMORY.035 = phi %struct.Memory* [ %var_2_316, %block_.L_4010d5 ], [ %var_2_79, %block_401088.preheader ]
  %var_2_1672 = add i64 %var_2_1661, -24
  %var_2_1693 = inttoptr i64 %var_2_1672 to i32*
  %var_2_1704 = load i32, i32* %var_2_1693, align 4
  %var_2_1768 = sub i32 %var_2_1704, %var_2_175
  %var_2_1919 = lshr i32 %var_2_1768, 31
  %var_2_19310 = lshr i32 %var_2_1704, 31
  %var_2_19411 = lshr i32 %var_2_175, 31
  ...
  br i1 %var_2_20117, label %block_40109b.preheader, label %block_.L_4010d5

block_40109b.preheader:                           ; preds = %block_401088
  br label %block_40109b

block_40109b:                                     ; preds = %block_40109b.preheader, %block_40109b
  br label %block_40109b

block_.L_4010d5:                                  ; preds = %block_401088
  %var_2_316 = tail call %struct.Memory* @__remill_function_call(%struct.State* nonnull %0, i64 ptrtoint (i64 (i64, i64)* @fputs to i64), %struct.Memory* %MEMORY.035)
  %var_2_125 = load i64, i64* %RBP.i, align 8
  %var_2_126 = add i64 %var_2_125, -20
  %var_2_128 = inttoptr i64 %var_2_126 to i32*
  %var_2_129 = load i32, i32* %var_2_128, align 4
  %var_2_131 = add i64 %var_2_125, -4
  %var_2_133 = inttoptr i64 %var_2_131 to i32*
  %var_2_134 = load i32, i32* %var_2_133, align 4
  %var_2_135 = sub i32 %var_2_129, %var_2_134
  %var_2_150 = lshr i32 %var_2_135, 31
  %var_2_152 = lshr i32 %var_2_129, 31
  %var_2_153 = lshr i32 %var_2_134, 31
  %var_2_154 = xor i32 %var_2_153, %var_2_152
  %var_2_155 = xor i32 %var_2_150, %var_2_152
  %var_2_156 = add nuw nsw i32 %var_2_155, %var_2_154
  %var_2_157 = icmp eq i32 %var_2_156, 2
  %var_2_159 = icmp ne i32 %var_2_150, 0
  %var_2_160 = xor i1 %var_2_159, %var_2_157
  br i1 %var_2_160, label %block_401088, label %block_.L_4010f7.loopexit

block_.L_4010f7.loopexit:                         ; preds = %block_.L_4010d5
  br label %block_.L_4010f7

block_.L_4010f7:                                  ; preds = %block_.L_4010f7.loopexit, %entry
  %MEMORY.0.lcssa = phi %struct.Memory* [ %var_2_79, %entry ], [ %var_2_316, %block_.L_4010f7.loopexit ]
  %var_2_364 = tail call %struct.Memory* @__remill_function_call(%struct.State* nonnull %0, i64 ptrtoint (i64 (i64)* @free to i64), %struct.Memory* %MEMORY.0.lcssa)
  ret %struct.Memory* %var_2_364
}
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_movb__0x0____rax__rsi_1_(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %RAX = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 1, i32 0, i32 0
  %RSI = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 9, i32 0, i32 0
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_jge_.L_4010f7(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i8* nocapture %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_jge_.L_4010d5(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i8* nocapture %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 2, i32 9
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_jmpq_.L_40108f(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_jmpq_.L_40107c(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
