...
block_.L_400903:
  ...
  ; Code: movq $0x401377, %rsi	 RIP: 400903	 Bytes: 10
  %loadMem_400903 = load %struct.Memory*, %struct.Memory** %MEMORY
  %call_400903 = call %struct.Memory* @routine_movq__0x401377___rsi(%struct.State* %0, i64  0, %struct.Memory* %loadMem_400903)
