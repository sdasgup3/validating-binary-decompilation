...
@G_0x6b1__rip_ = local_unnamed_addr global %G_0x6b1__rip__type zeroinitializer
@G_0x6be__rip_ = local_unnamed_addr global %G_0x6be__rip__type zeroinitializer
...
entry:
  ...
  %22 = load i32, i32* bitcast (%G_0x6b1__rip__type* @G_0x6b1__rip_ to i32*), align 8
  ...
  %57 = bitcast %union.VectorReg* %30 to i32*
  %58 = getelementptr inbounds i8, i8* %53, i64 4
  %59 = bitcast i8* %58 to i32*
  %60 = bitcast i64* %54 to i32*
  %61 = getelementptr inbounds i8, i8* %53, i64 12
  %62 = bitcast i8* %61 to i32*
  %63 = bitcast %union.VectorReg* %11 to float*
  %64 = bitcast i8* %15 to float*
  %65 = bitcast i64* %13 to float*
  %66 = bitcast i8* %18 to float*
  %67 = bitcast %union.VectorReg* %11 to double*
  %68 = bitcast %union.VectorReg* %11 to double*
  %69 = bitcast %union.VectorReg* %30 to double*
  ...
  %72 = bitcast %union.VectorReg* %30 to double*
  %73 = bitcast i64* %54 to double*
  %74 = bitcast i64* %13 to <2 x i32>*
  %75 = bitcast %union.VectorReg* %11 to <2 x float>*
  %76 = bitcast %union.VectorReg* %30 to float*
  %77 = bitcast i8* %58 to float*
  %78 = bitcast i64* %54 to float*
  %79 = bitcast i8* %61 to float*
...
block_.L_40282e:                                  ; preds = %block_40284a, %entry
  %84 = phi i64 [ %.pre, %entry ], [ %227, %block_40284a ]
  %MEMORY.0 = phi %struct.Memory* [ %2, %entry ], [ %119, %block_40284a ]
  ...
  %90 = bitcast %union.VectorReg* %11 to i32*
  ...
  %91 = load <2 x float>, <2 x float>* %49, align 1
  %92 = extractelement <2 x float> %91, i32 0
  %93 = fpext float %92 to double
  store double %93, double* %67, align 1
  %94 = add i64 %84, 16
  store i64 %94, i64* %PC.i, align 8
  %95 = load double, double* %69, align 1
  %96 = fcmp uno double %93, %95
  br i1 %96, label %97, label %107

; <label>:97:                                     ; preds = %block_.L_40282e
...
; <label>:105:                                    ; preds = %97
  %106 = tail call %struct.Memory* @__remill_error(%struct.State* nonnull dereferenceable(3376) %0, i64 %94, %struct.Memory* %MEMORY.0)
  %.pre1 = load i64, i64* %PC.i, align 8
  br label %routine_ucomisd__xmm0___xmm1.exit

; <label>:107:                                    ; preds = %block_.L_40282e
...
routine_ucomisd__xmm0___xmm1.exit:                ; preds = %117, %105
  %118 = phi i64 [ %.pre1, %105 ], [ %94, %117 ]
  %119 = phi %struct.Memory* [ %106, %105 ], [ %MEMORY.0, %117 ]
  %120 = load i8, i8* %70, align 1
  %121 = icmp eq i8 %120, 0
  %.v = select i1 %121, i64 100, i64 6
  %122 = add i64 %118, %.v
  store i64 %122, i64* %3, align 8
  br i1 %121, label %block_.L_4028a2, label %block_402844

block_402844:                                     ; preds = %routine_ucomisd__xmm0___xmm1.exit
  %123 = load i8, i8* %71, align 1
  %124 = icmp ne i8 %123, 0
  %.v2 = select i1 %124, i64 94, i64 6
  %125 = add i64 %122, %.v2
  store i64 %125, i64* %3, align 8
  %cmpBr_402844 = icmp eq i8 %123, 1
  br i1 %cmpBr_402844, label %block_.L_4028a2, label %block_40284a

block_40284a:                                     ; preds = %block_402844
  %126 = load double, double* bitcast (%G_0x6be__rip__type* @G_0x6be__rip_ to double*), align 8
  store double %126, double* %72, align 1
  ...
  %132 = bitcast %union.VectorReg* %11 to i32*
  ...
  %136 = bitcast i64* %13 to <2 x i32>*
  %137 = load <2 x i32>, <2 x i32>* %136, align 1
  %138 = fsub double %135, %126
  %139 = bitcast double %138 to <2 x i32>
  %140 = fptrunc double %138 to float
  store float %140, float* %63, align 1
  %141 = extractelement <2 x i32> %139, i32 1
  store i32 %141, i32* %16, align 1
  %142 = extractelement <2 x i32> %137, i32 0
  store i32 %142, i32* %17, align 1
  %143 = extractelement <2 x i32> %137, i32 1
  store i32 %143, i32* %19, align 1
  %144 = add i64 %127, -12
  %145 = add i64 %125, 30
  store i64 %145, i64* %PC.i, align 8
  %146 = load <2 x float>, <2 x float>* %49, align 1
  %147 = extractelement <2 x float> %146, i32 0
  %148 = inttoptr i64 %144 to float*
  ...
  %156 = bitcast %union.VectorReg* %11 to i32*
  ...
  %158 = load <2 x float>, <2 x float>* %75, align 1
  %159 = load <2 x i32>, <2 x i32>* %74, align 1
  %160 = load float, float* %153, align 4
  %161 = extractelement <2 x float> %158, i32 0
  %162 = fadd float %161, %160
  store float %162, float* %63, align 1
  %163 = bitcast <2 x float> %158 to <2 x i32>
  %164 = extractelement <2 x i32> %163, i32 1
  store i32 %164, i32* %16, align 1
  %165 = extractelement <2 x i32> %159, i32 0
  store i32 %165, i32* %17, align 1
  %166 = extractelement <2 x i32> %159, i32 1
  store i32 %166, i32* %19, align 1
  %167 = add i64 %151, 15
  store i64 %167, i64* %PC.i, align 8
  %168 = load <2 x float>, <2 x float>* %75, align 1
  %169 = load <2 x i32>, <2 x i32>* %74, align 1
  %170 = load float, float* %153, align 4
  %171 = extractelement <2 x float> %168, i32 0
  %172 = fadd float %171, %170
  store float %172, float* %63, align 1
  %173 = bitcast <2 x float> %168 to <2 x i32>
  %174 = extractelement <2 x i32> %173, i32 1
  store i32 %174, i32* %16, align 1
  %175 = extractelement <2 x i32> %169, i32 0
  store i32 %175, i32* %17, align 1
  %176 = extractelement <2 x i32> %169, i32 1
  store i32 %176, i32* %19, align 1
  %177 = add i64 %149, -16
  %178 = add i64 %151, 20
  store i64 %178, i64* %PC.i, align 8
  %179 = load <2 x float>, <2 x float>* %49, align 1
  ...
  %188 = bitcast %union.VectorReg* %11 to i32*
  store i32 %187, i32* %188, align 1
  store float 0.000000e+00, float* %64, align 1
  store float 0.000000e+00, float* %65, align 1
  store float 0.000000e+00, float* %66, align 1
  %189 = load <2 x float>, <2 x float>* %49, align 1
  %190 = extractelement <2 x float> %189, i32 0
  %191 = fpext float %190 to double
  %192 = load i64, i64* %13, align 1
  %193 = load double, double* %69, align 1
  %194 = fsub double %191, %193
  %195 = load i32, i32* bitcast (%G_0x690__rip__type* @G_0x690__rip_ to i32*), align 8
  %196 = load i32, i32* inttoptr (i64 add (i64 ptrtoint (%G_0x690__rip__type* @G_0x690__rip_ to i64), i64 4) to i32*), align 4
  %197 = load i32, i32* inttoptr (i64 add (i64 ptrtoint (%G_0x690__rip__type* @G_0x690__rip_ to i64), i64 8) to i32*), align 8
  %198 = load i32, i32* inttoptr (i64 add (i64 ptrtoint (%G_0x690__rip__type* @G_0x690__rip_ to i64), i64 12) to i32*), align 4
  %199 = bitcast %union.VectorReg* %30 to i32*
  store i32 %195, i32* %199, align 1
  %200 = bitcast i8* %58 to i32*
  store i32 %196, i32* %200, align 1
  %201 = bitcast i64* %54 to i32*
  store i32 %197, i32* %201, align 1
  %202 = bitcast i8* %61 to i32*
  store i32 %198, i32* %202, align 1
  %203 = bitcast double %194 to i64
  %204 = load i64, i64* %55, align 1
  %205 = load i64, i64* %56, align 1
  %206 = and i64 %204, %203
  %207 = and i64 %205, %192
  %208 = trunc i64 %206 to i32
  %209 = lshr i64 %206, 32
  %210 = trunc i64 %209 to i32
  store i32 %208, i32* %14, align 1
  store i32 %210, i32* %16, align 1
  %211 = trunc i64 %207 to i32
  store i32 %211, i32* %17, align 1
  %212 = lshr i64 %207, 32
  %213 = trunc i64 %212 to i32
  store i32 %213, i32* %19, align 1
  %214 = bitcast i64 %204 to <2 x i32>
  %215 = bitcast i64 %205 to <2 x i32>
  %216 = load double, double* %68, align 1
  %217 = fptrunc double %216 to float
  store float %217, float* %76, align 1
  %218 = extractelement <2 x i32> %214, i32 1
  store i32 %218, i32* %59, align 1
  %219 = extractelement <2 x i32> %215, i32 0
  store i32 %219, i32* %60, align 1
  %220 = extractelement <2 x i32> %215, i32 1
  store i32 %220, i32* %62, align 1
  %221 = add i64 %182, -20
  %222 = add i64 %184, 33
  store i64 %222, i64* %PC.i, align 8
  %223 = load <2 x float>, <2 x float>* %33, align 1
...
block_.L_4028a2:                                  ; preds = %block_402844, %routine_ucomisd__xmm0___xmm1.exit
  %228 = phi i64 [ %125, %block_402844 ], [ %122, %routine_ucomisd__xmm0___xmm1.exit ]
  ...
  %234 = bitcast %union.VectorReg* %30 to i32*
  ...
  %235 = load <2 x float>, <2 x float>* %33, align 1
  %236 = extractelement <2 x float> %235, i32 0
  %237 = fpext float %236 to double
  store double %237, double* %72, align 1
  %238 = add i64 %229, -4
  %239 = add i64 %228, 14
  store i64 %239, i64* %PC.i, align 8
  %240 = inttoptr i64 %238 to i32*
  %241 = load i32, i32* %240, align 4
  %242 = bitcast %union.VectorReg* %11 to i32*
  store i32 %241, i32* %242, align 1
  store float 0.000000e+00, float* %64, align 1
  store float 0.000000e+00, float* %65, align 1
  store float 0.000000e+00, float* %66, align 1
  %243 = load <2 x float>, <2 x float>* %49, align 1
  %244 = extractelement <2 x float> %243, i32 0
  %245 = fpext float %244 to double
  %246 = load i32, i32* bitcast (%G_0x665__rip__type* @G_0x665__rip_ to i32*), align 8
  %247 = load i32, i32* inttoptr (i64 add (i64 ptrtoint (%G_0x665__rip__type* @G_0x665__rip_ to i64), i64 4) to i32*), align 4
  %248 = load i32, i32* inttoptr (i64 add (i64 ptrtoint (%G_0x665__rip__type* @G_0x665__rip_ to i64), i64 8) to i32*), align 8
  %249 = load i32, i32* inttoptr (i64 add (i64 ptrtoint (%G_0x665__rip__type* @G_0x665__rip_ to i64), i64 12) to i32*), align 4
  %250 = bitcast %union.VectorReg* %20 to i32*
  store i32 %246, i32* %250, align 1
  %251 = bitcast i8* %24 to i32*
  store i32 %247, i32* %251, align 1
  %252 = bitcast i64* %26 to i32*
  store i32 %248, i32* %252, align 1
  %253 = bitcast i8* %28 to i32*
  store i32 %249, i32* %253, align 1
  %254 = bitcast double %245 to i64
  %255 = load i64, i64* %13, align 1
  %256 = getelementptr inbounds %union.VectorReg, %union.VectorReg* %20, i64 0, i32 0, i32 0, i32 0, i64 0
  %257 = load i64, i64* %256, align 1
  %258 = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 1, i64 2, i32 0, i32 0, i32 0, i64 1
  ...
  store i32 %262, i32* %14, align 1
  store i32 %264, i32* %16, align 1
  %265 = trunc i64 %261 to i32
  store i32 %265, i32* %17, align 1
  %266 = lshr i64 %261, 32
  %267 = trunc i64 %266 to i32
  store i32 %267, i32* %19, align 1
  %268 = bitcast i64* %54 to <2 x i32>*
  %269 = load <2 x i32>, <2 x i32>* %268, align 1
  %270 = load double, double* %68, align 1
  %271 = fmul double %237, %270
  %272 = bitcast double %271 to <2 x i32>
  %273 = fptrunc double %271 to float
  store float %273, float* %76, align 1
  %274 = extractelement <2 x i32> %272, i32 1
  store i32 %274, i32* %59, align 1
  %275 = extractelement <2 x i32> %269, i32 0
  store i32 %275, i32* %60, align 1
  %276 = extractelement <2 x i32> %269, i32 1
  store i32 %276, i32* %62, align 1
  %277 = add i64 %228, 38
...
block_400478:
  ...
  %6 = add i64 %5, 8
  store i64 %6, i64* %PC, align 8
  %7 = load i32, i32* bitcast (%G_0x6b1__rip__type* @G_0x6b1__rip_ to i32*), align 8
  %8 = bitcast %union.VectorReg* %3 to i32*
...
block_400478:
  ...
  %5 = load i64, i64* bitcast (%G_0x6be__rip__type* @G_0x6be__rip_ to i64*), align 8
...
block_400478:
  ...
  %6 = add i64 %5, 7
  store i64 %6, i64* %PC, align 8
  %7 = load i32, i32* bitcast (%G_0x690__rip__type* @G_0x690__rip_ to i32*), align 8
  %8 = load i32, i32* inttoptr (i64 add (i64 ptrtoint (%G_0x690__rip__type* @G_0x690__rip_ to i64), i64 4) to i32*), align 4
  %9 = load i32, i32* inttoptr (i64 add (i64 ptrtoint (%G_0x690__rip__type* @G_0x690__rip_ to i64), i64 8) to i32*), align 8
  %10 = load i32, i32* inttoptr (i64 add (i64 ptrtoint (%G_0x690__rip__type* @G_0x690__rip_ to i64), i64 12) to i32*), align 4
  %11 = bitcast %union.VectorReg* %3 to i32*
...
block_400478:
  ...
  %6 = add i64 %5, 7
  store i64 %6, i64* %PC, align 8
  %7 = load i32, i32* bitcast (%G_0x665__rip__type* @G_0x665__rip_ to i32*), align 8
  %8 = load i32, i32* inttoptr (i64 add (i64 ptrtoint (%G_0x665__rip__type* @G_0x665__rip_ to i64), i64 4) to i32*), align 4
  %9 = load i32, i32* inttoptr (i64 add (i64 ptrtoint (%G_0x665__rip__type* @G_0x665__rip_ to i64), i64 8) to i32*), align 8
  %10 = load i32, i32* inttoptr (i64 add (i64 ptrtoint (%G_0x665__rip__type* @G_0x665__rip_ to i64), i64 12) to i32*), align 4
  %11 = bitcast %union.VectorReg* %3 to i32*
  store i32 %7, i32* %11, align 1
  %12 = getelementptr inbounds i8, i8* %4, i64 4
  %13 = bitcast i8* %12 to i32*
