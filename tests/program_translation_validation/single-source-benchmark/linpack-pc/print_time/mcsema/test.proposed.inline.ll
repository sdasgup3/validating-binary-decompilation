...
define %struct.Memory* @print_time(%struct.State* noalias, i64, %struct.Memory* noalias) #2 {
entry:
  ...
  store %struct.Memory* %loadMem_4028d0, %struct.Memory** %MEMORY
  ...
  ret %struct.Memory* %loadMem_4028d8
}
