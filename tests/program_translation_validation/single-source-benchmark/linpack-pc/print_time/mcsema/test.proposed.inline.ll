...
define %struct.Memory* @print_time(%struct.State* noalias, i64, %struct.Memory* noalias) #1 {
entry:
  ...
  store %struct.Memory* %loadMem_402861, %struct.Memory** %MEMORY
  ...
  %RBP.i5 = bitcast %union.anon* %37 to i64*
  %38 = load i64, i64* %RBP.i5
  %39 = sub i64 %38, 4
  %40 = load i32, i32* %EDI.i
  %41 = zext i32 %40 to i64
  %42 = load i64, i64* %PC.i4
  %43 = add i64 %42, 3
  store i64 %43, i64* %PC.i4
  ...
  store %struct.Memory* %loadMem_402867, %struct.Memory** %MEMORY
  ...
  ret %struct.Memory* %loadMem_402868
}
