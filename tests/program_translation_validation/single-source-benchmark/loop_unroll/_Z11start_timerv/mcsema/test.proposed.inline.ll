...
entry:
  ...
  %43 = call %struct.Memory* @__remill_function_call(%struct.State* %0, i64 ptrtoint (i64 ()* @clock to i64), %struct.Memory* %loadMem2_400e04)
  ...
  store i64 %50, i64* inttoptr (i64 6406320 to i64*)
