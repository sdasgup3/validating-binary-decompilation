...
entry:
  ...
  store %struct.Memory* %loadMem1_400e04, %struct.Memory** %MEMORY
  ...
  store i64 %49, i64* inttoptr (i64 6406320 to i64*)
  ...
  ret %struct.Memory* %loadMem_400e12
}
...
define %struct.Memory* @routine_movq__rax__0x61c0b0(%struct.State* dereferenceable(3376), i64, %struct.Memory*) {
block_400488:
  %3 = getelementptr inbounds %struct.State, %struct.State* %0, i32 0, i32 6
  %4 = getelementptr inbounds %struct.GPR, %struct.GPR* %3, i32 0, i32 33
  %5 = getelementptr inbounds %struct.Reg, %struct.Reg* %4, i32 0, i32 0
  ...
  %11 = add i64 %10, 8
  store i64 %11, i64* %PC
  store i64 %9, i64* inttoptr (i64 6406320 to i64*)
  ret %struct.Memory* %2
}
