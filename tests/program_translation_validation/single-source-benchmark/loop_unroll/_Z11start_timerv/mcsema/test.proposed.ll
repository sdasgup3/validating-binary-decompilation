...
entry:
  ...
  ; Code: ._Z11start_timerv:	 RIP: 400dd0	 Bytes: 0
  ...
  ; Code: callq .clock_plt	 RIP: 400dd4	 Bytes: 5
  %loadMem1_400dd4 = load %struct.Memory*, %struct.Memory** %MEMORY
  %call1_400dd4 = call %struct.Memory* @routine_callq_.clock_plt(%struct.State* %0, i64  0, %struct.Memory* %loadMem1_400dd4, i64 -1972, i64 5, i64 5)
  ...
  %call2_400dd4 = call %struct.Memory* @ext_clock(%struct.State* %0, i64  %loadPC_400dd4, %struct.Memory* %loadMem2_400dd4)
  store %struct.Memory* %call2_400dd4, %struct.Memory** %MEMORY

  ; Code: movq %rax, 0x61c0b0	 RIP: 400dd9	 Bytes: 8
  %loadMem_400dd9 = load %struct.Memory*, %struct.Memory** %MEMORY
  %call_400dd9 = call %struct.Memory* @routine_movq__rax__0x61c0b0(%struct.State* %0, i64  0, %struct.Memory* %loadMem_400dd9)
...
block_400478:
  ...
  %11 = add i64 %10, 8
  store i64 %11, i64* %PC
  %12 = call %struct.Memory* @_ZN12_GLOBAL__N_1L3MOVI3MnWImE2RnImEEEP6MemoryS6_R5StateT_T0_(%struct.Memory* %2, %struct.State* %0, i64 ptrtoint( %G_0x61c0b0_type* @G_0x61c0b0 to i64), i64 %9)
  ret %struct.Memory* %12
}
