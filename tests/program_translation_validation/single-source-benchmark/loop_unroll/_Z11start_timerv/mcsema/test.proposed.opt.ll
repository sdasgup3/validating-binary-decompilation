...
entry:
  ...
  %call2_400e04 = tail call %struct.Memory* @sub_400650.clock_plt(%struct.State* %0, i64 %11, %struct.Memory* %2)
  %RAX.i = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 1, i32 0, i32 0
  %15 = load i64, i64* %RAX.i, align 8
  %16 = load i64, i64* %3, align 8
  store i64 %15, i64* inttoptr (i64 6406320 to i64*), align 16
  %17 = add i64 %16, 9
  ...
  ret %struct.Memory* %call2_400e04
}
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_movq__rax__0x61c0b0(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned) local_unnamed_addr #1 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  ...
  %5 = add i64 %4, 8
  store i64 %5, i64* %PC, align 8
  store i64 %3, i64* inttoptr (i64 6406320 to i64*), align 16
  ret %struct.Memory* %2
}
