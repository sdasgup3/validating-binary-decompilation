...
entry:
  ...
  store %struct.Memory* %loadMem_40c160, %struct.Memory** %MEMORY
  ...
  %loadMem_40c17b = load %struct.Memory*, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_40c17b, %struct.Memory** %MEMORY
  ...
  ret %struct.Memory* %loadMem_40c182
}
