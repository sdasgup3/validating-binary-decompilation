...
block_.L_400c82:                                  ; preds = %block_400c92, %block_.L_400c2c
  %310 = phi i64 [ %.pre3, %block_.L_400c2c ], [ %608, %block_400c92 ]
  %MEMORY.2 = phi %struct.Memory* [ %294, %block_.L_400c2c ], [ %570, %block_400c92 ]
...
block_.L_400d52:                                  ; preds = %block_400d62, %block_.L_400d4b
  %610 = phi i64 [ %718, %block_400d62 ], [ %.pre4, %block_.L_400d4b ]
  ...
  %617 = load i32, i32* bitcast (%G_0x61c0a8_type* @G_0x61c0a8 to i32*), align 8
  %618 = sub i32 %615, %617
  ...
  br i1 %643, label %block_400d62, label %block_.L_400d91

block_400d62:                                     ; preds = %block_.L_400d52
  %645 = load i64, i64* bitcast (%G_0x61c0a0_type* @G_0x61c0a0 to i64*), align 8
