...
define %struct.Memory* @_Z18complete_hash_funcIdET_S0_(%struct.State* noalias, i64, %struct.Memory* noalias) #2 {
entry:
  ...
  %RBP.i11 = bitcast %union.anon* %72 to i64*
  ...
  %75 = load i64, i64* %RBP.i11
  %76 = sub i64 %75, 8
  %77 = bitcast %union.vec128_t* %XMM0.i to i8*
  %78 = load i64, i64* %PC.i10
  %79 = add i64 %78, 5
  store i64 %79, i64* %PC.i10
  ...
  %YMM0.i = bitcast %union.VectorReg* %90 to %"class.std::bitset"*
  %91 = bitcast %"class.std::bitset"* %YMM0.i to i8*
  %92 = load i64, i64* %RBP.i9
  %93 = sub i64 %92, 8
  %94 = load i64, i64* %PC.i8
  %95 = add i64 %94, 5
  store i64 %95, i64* %PC.i8
  %96 = inttoptr i64 %93 to double*
  %97 = load double, double* %96
  %98 = bitcast i8* %91 to double*
  ...
  %PC.i7 = bitcast %union.anon* %103 to i64*
  %104 = load i64, i64* %PC.i7
  %105 = add i64 %104, 286
  %106 = load i64, i64* %PC.i7
  %107 = add i64 %106, 5
  %108 = load i64, i64* %PC.i7
  %109 = add i64 %108, 5
  store i64 %109, i64* %PC.i7
  ...
  store %struct.Memory* %loadMem1_401492, %struct.Memory** %MEMORY
  ...
  %118 = load i64, i64* %PC.i6
  %119 = add i64 %118, 281
  %120 = load i64, i64* %PC.i6
  %121 = add i64 %120, 5
  %122 = load i64, i64* %PC.i6
  %123 = add i64 %122, 5
  store i64 %123, i64* %PC.i6
  ...
  store %struct.Memory* %loadMem1_401497, %struct.Memory** %MEMORY
  ...
  ret %struct.Memory* %loadMem_4014a6
}
