...
define %struct.Memory* @_Z26test_do_loop_unroll_factorILi10EiEvPKT0_iPKc(%struct.State* noalias, i64, %struct.Memory* noalias) #1 {
entry:
  ...
  store %struct.Memory* %loadMem1_4111e3, %struct.Memory** %MEMORY
...
block_.L_411221:                                  ; preds = %block_.L_411221, %block_41121c
  ...
  store %struct.Memory* %loadMem_411221, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem1_41122c, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_41123d, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_411245, %struct.Memory** %MEMORY
...
block_.L_411261:                                  ; preds = %block_.L_411261, %block_41125c
  ...
  store %struct.Memory* %loadMem1_41126c, %struct.Memory** %MEMORY
...
block_.L_411291:                                  ; preds = %block_41128c, %block_.L_411250
  ...
  store %struct.Memory* %loadMem1_411294, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_411299, %struct.Memory** %MEMORY
...
block_.L_4112a7:                                  ; preds = %block_.L_4111ef
  ...
  store %struct.Memory* %loadMem1_4112a7, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem1_4112b0, %struct.Memory** %MEMORY
  ...
  ret %struct.Memory* %loadMem_4112ba
}
