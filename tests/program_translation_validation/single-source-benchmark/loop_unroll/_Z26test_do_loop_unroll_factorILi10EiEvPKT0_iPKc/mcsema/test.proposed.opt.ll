...
declare %struct.Memory* @sub_40c990._ZN15loop_inner_bodyILi10EiE7do_workERiPKii(%struct.State* noalias dereferenceable(3376), i64, %struct.Memory* noalias readnone returned) local_unnamed_addr
...
entry:
  ...
  %call2_4111b3 = tail call %struct.Memory* @sub_400dd0._Z11start_timerv(%struct.State* %0, i64 %58, %struct.Memory* %2)
  ...
  br label %block_.L_4111bf

block_.L_4111bf:                                  ; preds = %block_.L_411261, %entry
  %68 = phi i64 [ %.pre, %entry ], [ %445, %block_.L_411261 ]
  %MEMORY.0 = phi %struct.Memory* [ %call2_4111b3, %entry ], [ %call2_411264, %block_.L_411261 ]
  ...
  br i1 %101, label %block_4111cf, label %block_.L_411277

block_4111cf:                                     ; preds = %block_.L_4111bf
  %103 = add i64 %69, -32
  %104 = add i64 %102, 7
  ...
  br i1 %146, label %block_.L_411220, label %block_4111ec

block_4111ec:                                     ; preds = %block_4111cf
  %148 = add i64 %147, 5
  store i64 %148, i64* %3, align 8
  br label %block_.L_4111f1

block_.L_4111f1:                                  ; preds = %block_.L_4111f1, %block_4111ec
  %149 = phi i64 [ %148, %block_4111ec ], [ %234, %block_.L_4111f1 ]
  %150 = phi i64 [ %111, %block_4111ec ], [ %195, %block_.L_4111f1 ]
  %MEMORY.1 = phi %struct.Memory* [ %MEMORY.0, %block_4111ec ], [ %call2_4111fc, %block_.L_4111f1 ]
  %151 = add i64 %150, -32
  ...
  %call2_4111fc = tail call %struct.Memory* @sub_40c990._ZN15loop_inner_bodyILi10EiE7do_workERiPKii(%struct.State* %0, i64 %161, %struct.Memory* %MEMORY.1)
  ...
  br i1 %233, label %block_.L_4111f1, label %block_41121b

block_41121b:                                     ; preds = %block_.L_4111f1
  %235 = add i64 %234, 5
  store i64 %235, i64* %3, align 8
  br label %block_.L_411220

block_.L_411220:                                  ; preds = %block_41121b, %block_4111cf
  %236 = phi i64 [ %147, %block_4111cf ], [ %235, %block_41121b ]
  %237 = phi i64 [ %111, %block_4111cf ], [ %195, %block_41121b ]
  %MEMORY.2 = phi %struct.Memory* [ %MEMORY.0, %block_4111cf ], [ %call2_4111fc, %block_41121b ]
  %238 = add i64 %237, -36
  %239 = add i64 %236, 3
  ...
  br i1 %272, label %block_41122c, label %block_.L_411261

block_41122c:                                     ; preds = %block_.L_411220
  %274 = add i64 %273, 5
  store i64 %274, i64* %3, align 8
  br label %block_.L_411231

block_.L_411231:                                  ; preds = %block_.L_411231, %block_41122c
  %275 = phi i64 [ %274, %block_41122c ], [ %399, %block_.L_411231 ]
  %276 = phi i64 [ %237, %block_41122c ], [ %364, %block_.L_411231 ]
  %MEMORY.3 = phi %struct.Memory* [ %MEMORY.2, %block_41122c ], [ %call2_41123c, %block_.L_411231 ]
  %277 = add i64 %276, -8
  %278 = add i64 %275, 4
  ...
  %call2_41123c = tail call %struct.Memory* @sub_40c0d0._Z18complete_hash_funcIiET_S0_(%struct.State* %0, i64 %292, %struct.Memory* %MEMORY.3)
  ...
  br i1 %388, label %block_41125c, label %block_.L_411231

block_41125c:                                     ; preds = %block_.L_411231
  %400 = add i64 %399, 5
  store i64 %400, i64* %3, align 8
  br label %block_.L_411261

block_.L_411261:                                  ; preds = %block_.L_411220, %block_41125c
  %401 = phi i64 [ %273, %block_.L_411220 ], [ %400, %block_41125c ]
  %402 = phi i64 [ %237, %block_.L_411220 ], [ %364, %block_41125c ]
  %MEMORY.4 = phi %struct.Memory* [ %MEMORY.2, %block_.L_411220 ], [ %call2_41123c, %block_41125c ]
  %403 = add i64 %402, -32
  %404 = add i64 %401, 3
  ...
  %call2_411264 = tail call %struct.Memory* @sub_40c100._Z9check_sumIiEvT_(%struct.State* %0, i64 %408, %struct.Memory* %MEMORY.4)
...
block_.L_411277:                                  ; preds = %block_.L_4111bf
  %446 = add i64 %102, -66695
  %447 = add i64 %102, 5
  ...
  %call2_411277 = tail call %struct.Memory* @sub_400df0._Z5timerv(%struct.State* %0, i64 %446, %struct.Memory* %MEMORY.0)
  ...
  %call2_411280 = tail call %struct.Memory* @sub_400790._Z13record_resultdPKc(%struct.State* %0, i64 %457, %struct.Memory* %call2_411277)
  ...
  ret %struct.Memory* %call2_411280
}
...
define %struct.Memory* @routine_jge_.L_411277(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i8* %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
...
define %struct.Memory* @routine_cmpl__0xa___eax(%struct.State* dereferenceable(3376), i64, %struct.Memory*) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 1, i32 0
  %EAX = bitcast %union.anon* %3 to i32*
...
define %struct.Memory* @routine_jl_.L_411220(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i8* %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 2, i32 9
...
define %struct.Memory* @routine_jmpq_.L_4111f1(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
...
define %struct.Memory* @routine_callq_._ZN15loop_inner_bodyILi10EiE7do_workERiPKii(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
...
define %struct.Memory* @routine_addl__0xa___edx(%struct.State* dereferenceable(3376), i64, %struct.Memory*) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %RDX = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 7, i32 0, i32 0
...
define %struct.Memory* @routine_subl__0x9___ecx(%struct.State* dereferenceable(3376), i64, %struct.Memory*) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %RCX = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 5, i32 0, i32 0
...
define %struct.Memory* @routine_jl_.L_4111f1(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i8* %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 2, i32 9
...
define %struct.Memory* @routine_jmpq_.L_411220(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
...
define %struct.Memory* @routine_jge_.L_411261(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i8* %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 2, i32 9
...
define %struct.Memory* @routine_jmpq_.L_411231(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
...
define %struct.Memory* @routine_jne_.L_411231(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i8* %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
...
define %struct.Memory* @routine_jmpq_.L_411261(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
...
define %struct.Memory* @routine_jmpq_.L_4111bf(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
