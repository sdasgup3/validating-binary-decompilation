...
block_.L_4111bf:                                  ; preds = %block_.L_411261, %entry
  %68 = phi i64 [ %.pre, %entry ], [ %443, %block_.L_411261 ]
...
block_.L_411231:                                  ; preds = %block_.L_411231, %block_41122c
  %275 = phi i64 [ %274, %block_41122c ], [ %398, %block_.L_411231 ]
  %276 = phi i64 [ %237, %block_41122c ], [ %363, %block_.L_411231 ]
  ...
  br i1 %387, label %block_41125c, label %block_.L_411231
...
block_.L_411261:                                  ; preds = %block_.L_411220, %block_41125c
  %400 = phi i64 [ %273, %block_.L_411220 ], [ %399, %block_41125c ]
  %401 = phi i64 [ %237, %block_.L_411220 ], [ %363, %block_41125c ]
  ...
  %call2_411264 = tail call %struct.Memory* @sub_40c100._Z9check_sumIiEvT_(%struct.State* %0, i64 %407, %struct.Memory* %MEMORY.4)
...
block_.L_411277:                                  ; preds = %block_.L_4111bf
  ...
  %call2_411277 = tail call %struct.Memory* @sub_400df0._Z5timerv(%struct.State* %0, i64 %444, %struct.Memory* %MEMORY.0)
  ...
  %call2_411280 = tail call %struct.Memory* @sub_400790._Z13record_resultdPKc(%struct.State* %0, i64 %455, %struct.Memory* %call2_411277)
