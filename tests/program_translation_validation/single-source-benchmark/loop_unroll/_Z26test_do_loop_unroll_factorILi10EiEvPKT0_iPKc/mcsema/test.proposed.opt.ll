...
declare %struct.Memory* @sub_40c9c0._ZN15loop_inner_bodyILi10EiE7do_workERiPKii(%struct.State* noalias dereferenceable(3376), i64, %struct.Memory* noalias readnone returned) local_unnamed_addr
...
define %struct.Memory* @_Z26test_do_loop_unroll_factorILi10EiEvPKT0_iPKc(%struct.State* noalias, i64, %struct.Memory* noalias readnone) local_unnamed_addr #1 {
entry:
...
block_.L_411221:                                  ; preds = %block_.L_411221, %block_41121c
  %149 = phi i64 [ %234, %block_.L_411221 ], [ %148, %block_41121c ]
  %150 = phi i64 [ %195, %block_.L_411221 ], [ %111, %block_41121c ]
  %151 = add i64 %150, -32
  ...
  %call2_41122c = tail call %struct.Memory* @sub_40c9c0._ZN15loop_inner_bodyILi10EiE7do_workERiPKii(%struct.State* nonnull %0, i64 %161, %struct.Memory* %MEMORY.0)
...
block_.L_411250:                                  ; preds = %block_41124b, %block_4111ff
  %236 = phi i64 [ %235, %block_41124b ], [ %147, %block_4111ff ]
  %237 = phi i64 [ %195, %block_41124b ], [ %111, %block_4111ff ]
  %238 = add i64 %237, -36
  %239 = add i64 %236, 3
...
block_.L_411261:                                  ; preds = %block_.L_411261, %block_41125c
  %275 = phi i64 [ %398, %block_.L_411261 ], [ %274, %block_41125c ]
  %276 = phi i64 [ %363, %block_.L_411261 ], [ %237, %block_41125c ]
  %277 = add i64 %276, -8
  %278 = add i64 %275, 4
  ...
  %call2_41126c = tail call %struct.Memory* @sub_40c100._Z18complete_hash_funcIiET_S0_(%struct.State* nonnull %0, i64 %292, %struct.Memory* %MEMORY.0)
...
block_.L_411291:                                  ; preds = %block_.L_411250, %block_41128c
  ...
  %call2_411294 = tail call %struct.Memory* @sub_40c130._Z9check_sumIiEvT_(%struct.State* nonnull %0, i64 %407, %struct.Memory* %MEMORY.0)
