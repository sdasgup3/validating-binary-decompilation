...
entry:
  ...
  %call2_406603 = tail call %struct.Memory* @sub_400dd0._Z11start_timerv(%struct.State* %0, i64 %58, %struct.Memory* %2)
...
block_.L_40660f:                                  ; preds = %block_.L_4066b8, %entry
  %79 = phi i64 [ %.pre, %entry ], [ %431, %block_.L_4066b8 ]
  %MEMORY.0 = phi %struct.Memory* [ %call2_406603, %entry ], [ %call2_4066bd, %block_.L_4066b8 ]
  ...
  br i1 %112, label %block_40661f, label %block_.L_4066d0
...
block_40661f:                                     ; preds = %block_.L_40660f
  ...
  br i1 %159, label %block_.L_406671, label %block_40663d
...
block_.L_406642:                                  ; preds = %block_.L_406642, %block_40663d
  %162 = phi i64 [ %161, %block_40663d ], [ %247, %block_.L_406642 ]
  %163 = phi i64 [ %124, %block_40663d ], [ %208, %block_.L_406642 ]
  %MEMORY.1 = phi %struct.Memory* [ %MEMORY.0, %block_40663d ], [ %call2_40664d, %block_.L_406642 ]
  %164 = add i64 %163, -40
  ...
  %call2_40664d = tail call %struct.Memory* @sub_401d70._ZN15loop_inner_bodyILi11EdE7do_workERdPKdi(%struct.State* %0, i64 %174, %struct.Memory* %MEMORY.1)
  ...
  br i1 %246, label %block_.L_406642, label %block_40666c
...
block_.L_406671:                                  ; preds = %block_40666c, %block_40661f
  %249 = phi i64 [ %160, %block_40661f ], [ %248, %block_40666c ]
  %250 = phi i64 [ %124, %block_40661f ], [ %208, %block_40666c ]
  %MEMORY.2 = phi %struct.Memory* [ %MEMORY.0, %block_40661f ], [ %call2_40664d, %block_40666c ]
  %251 = add i64 %250, -44
  %252 = add i64 %249, 3
  ...
  br i1 %285, label %block_40667d, label %block_.L_4066b8
...
block_.L_406682:                                  ; preds = %block_.L_406682, %block_40667d
  %288 = phi i64 [ %287, %block_40667d ], [ %385, %block_.L_406682 ]
  %289 = phi i64 [ %250, %block_40667d ], [ %350, %block_.L_406682 ]
  %MEMORY.3 = phi %struct.Memory* [ %MEMORY.2, %block_40667d ], [ %call2_40668f, %block_.L_406682 ]
  %290 = add i64 %289, -8
  %291 = add i64 %288, 4
  ...
  %call2_40668f = tail call %struct.Memory* @sub_401480._Z18complete_hash_funcIdET_S0_(%struct.State* %0, i64 %305, %struct.Memory* %MEMORY.3)
  ...
  br i1 %374, label %block_4066b3, label %block_.L_406682
...
block_.L_4066b8:                                  ; preds = %block_.L_406671, %block_4066b3
  %387 = phi i64 [ %286, %block_.L_406671 ], [ %386, %block_4066b3 ]
  %388 = phi i64 [ %250, %block_.L_406671 ], [ %350, %block_4066b3 ]
  %MEMORY.4 = phi %struct.Memory* [ %MEMORY.2, %block_.L_406671 ], [ %call2_40668f, %block_4066b3 ]
  %389 = add i64 %388, -40
  %390 = add i64 %387, 5
  ...
  %call2_4066bd = tail call %struct.Memory* @sub_4014b0._Z9check_sumIdEvT_(%struct.State* %0, i64 %394, %struct.Memory* %MEMORY.4)
...
block_.L_4066d0:                                  ; preds = %block_.L_40660f
  ...
  %call2_4066d0 = tail call %struct.Memory* @sub_400df0._Z5timerv(%struct.State* %0, i64 %432, %struct.Memory* %MEMORY.0)
  ...
  %call2_4066d9 = tail call %struct.Memory* @sub_400790._Z13record_resultdPKc(%struct.State* %0, i64 %443, %struct.Memory* %call2_4066d0)
  ...
  ret %struct.Memory* %call2_4066d9
}
...
define %struct.Memory* @routine_jge_.L_4066d0(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i8* %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
...
define %struct.Memory* @routine_jl_.L_406671(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i8* %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 2, i32 9
...
define %struct.Memory* @routine_jmpq_.L_406642(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
...
define %struct.Memory* @routine_jl_.L_406642(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i8* %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 2, i32 9
...
define %struct.Memory* @routine_jmpq_.L_406671(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
...
define %struct.Memory* @routine_jge_.L_4066b8(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i8* %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 2, i32 9
...
define %struct.Memory* @routine_jmpq_.L_406682(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
...
define %struct.Memory* @routine_jne_.L_406682(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i8* %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
...
define %struct.Memory* @routine_jmpq_.L_4066b8(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
...
define %struct.Memory* @routine_jmpq_.L_40660f(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
