...
define %struct.Memory* @_Z26test_do_loop_unroll_factorILi11EdEvPKT0_iPKc(%struct.State* noalias, i64, %struct.Memory* noalias) local_unnamed_addr #1 {
entry:
  ...
  %call2_406633 = tail call %struct.Memory* @sub_400e00._Z11start_timerv(%struct.State* %0, i64 %58, %struct.Memory* %2)
...
block_.L_40663f:                                  ; preds = %block_.L_4066e8, %entry
  %74 = phi i64 [ %.pre, %entry ], [ %422, %block_.L_4066e8 ]
  %MEMORY.0 = phi %struct.Memory* [ %call2_406633, %entry ], [ %call2_4066ed, %block_.L_4066e8 ]
  ...
  br i1 %107, label %block_40664f, label %block_.L_406700
...
block_40664f:                                     ; preds = %block_.L_40663f
  ...
  br i1 %153, label %block_.L_4066a1, label %block_40666d
...
block_.L_406672:                                  ; preds = %block_.L_406672, %block_40666d
  %156 = phi i64 [ %155, %block_40666d ], [ %241, %block_.L_406672 ]
  %157 = phi i64 [ %118, %block_40666d ], [ %202, %block_.L_406672 ]
  %MEMORY.1 = phi %struct.Memory* [ %MEMORY.0, %block_40666d ], [ %call2_40667d, %block_.L_406672 ]
  %158 = add i64 %157, -40
  ...
  %call2_40667d = tail call %struct.Memory* @sub_401da0._ZN15loop_inner_bodyILi11EdE7do_workERdPKdi(%struct.State* nonnull %0, i64 %168, %struct.Memory* %MEMORY.1)
  ...
  br i1 %240, label %block_.L_406672, label %block_40669c
...
block_.L_4066a1:                                  ; preds = %block_40669c, %block_40664f
  %243 = phi i64 [ %154, %block_40664f ], [ %242, %block_40669c ]
  %244 = phi i64 [ %118, %block_40664f ], [ %202, %block_40669c ]
  %MEMORY.2 = phi %struct.Memory* [ %MEMORY.0, %block_40664f ], [ %call2_40667d, %block_40669c ]
  %245 = add i64 %244, -44
  %246 = add i64 %243, 3
  ...
  br i1 %279, label %block_4066ad, label %block_.L_4066e8
...
block_.L_4066b2:                                  ; preds = %block_.L_4066b2, %block_4066ad
  %282 = phi i64 [ %281, %block_4066ad ], [ %378, %block_.L_4066b2 ]
  %283 = phi i64 [ %244, %block_4066ad ], [ %343, %block_.L_4066b2 ]
  %MEMORY.3 = phi %struct.Memory* [ %MEMORY.2, %block_4066ad ], [ %call2_4066bf, %block_.L_4066b2 ]
  %284 = add i64 %283, -8
  %285 = add i64 %282, 4
  ...
  %call2_4066bf = tail call %struct.Memory* @sub_4014b0._Z18complete_hash_funcIdET_S0_(%struct.State* nonnull %0, i64 %298, %struct.Memory* %MEMORY.3)
  ...
  br i1 %367, label %block_4066e3, label %block_.L_4066b2
...
block_.L_4066e8:                                  ; preds = %block_.L_4066a1, %block_4066e3
  %380 = phi i64 [ %280, %block_.L_4066a1 ], [ %379, %block_4066e3 ]
  %381 = phi i64 [ %244, %block_.L_4066a1 ], [ %343, %block_4066e3 ]
  %MEMORY.4 = phi %struct.Memory* [ %MEMORY.2, %block_.L_4066a1 ], [ %call2_4066bf, %block_4066e3 ]
  %382 = add i64 %381, -40
  %383 = add i64 %380, 5
  ...
  %call2_4066ed = tail call %struct.Memory* @sub_4014e0._Z9check_sumIdEvT_(%struct.State* nonnull %0, i64 %386, %struct.Memory* %MEMORY.4)
...
block_.L_406700:                                  ; preds = %block_.L_40663f
  ...
  %call2_406700 = tail call %struct.Memory* @sub_400e20._Z5timerv(%struct.State* nonnull %0, i64 %423, %struct.Memory* %MEMORY.0)
  ...
  %call2_406709 = tail call %struct.Memory* @sub_4007c0._Z13record_resultdPKc(%struct.State* nonnull %0, i64 %434, %struct.Memory* %call2_406700)
  ...
  ret %struct.Memory* %call2_406709
}
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_jge_.L_406700(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i8* nocapture %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_jl_.L_4066a1(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i8* nocapture %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 2, i32 9
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_jmpq_.L_406672(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_jl_.L_406672(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i8* nocapture %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 2, i32 9
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_jmpq_.L_4066a1(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_jge_.L_4066e8(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i8* nocapture %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 2, i32 9
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_jmpq_.L_4066b2(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_jne_.L_4066b2(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i8* nocapture %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_jmpq_.L_4066e8(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_jmpq_.L_40663f(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
