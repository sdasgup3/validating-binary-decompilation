...
block_.L_40660f:                                  ; preds = %block_.L_4066b8, %entry
  %79 = phi i64 [ %.pre, %entry ], [ %427, %block_.L_4066b8 ]
...
block_.L_406682:                                  ; preds = %block_.L_406682, %block_40667d
  %288 = phi i64 [ %287, %block_40667d ], [ %383, %block_.L_406682 ]
  %289 = phi i64 [ %250, %block_40667d ], [ %348, %block_.L_406682 ]
  ...
  %call2_40668f = tail call %struct.Memory* @sub_401480._Z18complete_hash_funcIdET_S0_(%struct.State* %0, i64 %304, %struct.Memory* %MEMORY.3)
  ...
  br i1 %372, label %block_4066b3, label %block_.L_406682
...
block_.L_4066b8:                                  ; preds = %block_.L_406671, %block_4066b3
  %385 = phi i64 [ %286, %block_.L_406671 ], [ %384, %block_4066b3 ]
  %386 = phi i64 [ %250, %block_.L_406671 ], [ %348, %block_4066b3 ]
  ...
  %call2_4066bd = tail call %struct.Memory* @sub_4014b0._Z9check_sumIdEvT_(%struct.State* %0, i64 %391, %struct.Memory* %MEMORY.4)
...
block_.L_4066d0:                                  ; preds = %block_.L_40660f
  ...
  %call2_4066d0 = tail call %struct.Memory* @sub_400df0._Z5timerv(%struct.State* %0, i64 %428, %struct.Memory* %MEMORY.0)
  ...
  %call2_4066d9 = tail call %struct.Memory* @sub_400790._Z13record_resultdPKc(%struct.State* %0, i64 %439, %struct.Memory* %call2_4066d0)
