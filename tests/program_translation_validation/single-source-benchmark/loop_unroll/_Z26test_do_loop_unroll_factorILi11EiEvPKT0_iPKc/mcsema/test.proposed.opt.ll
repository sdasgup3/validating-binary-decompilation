...
entry:
  ...
  %call2_4110b3 = tail call %struct.Memory* @sub_400e10._Z11start_timerv(%struct.State* %0, i64 %58, %struct.Memory* %2)
...
block_.L_4110bf:                                  ; preds = %block_.L_411161, %entry
  %68 = phi i64 [ %.pre, %entry ], [ %443, %block_.L_411161 ]
  %MEMORY.0 = phi %struct.Memory* [ %call2_4110b3, %entry ], [ %call2_411164, %block_.L_411161 ]
  ...
  br i1 %101, label %block_4110cf, label %block_.L_411177
...
block_4110cf:                                     ; preds = %block_.L_4110bf
  ...
  br i1 %146, label %block_.L_411120, label %block_4110ec
...
block_.L_4110f1:                                  ; preds = %block_.L_4110f1, %block_4110ec
  %149 = phi i64 [ %234, %block_.L_4110f1 ], [ %148, %block_4110ec ]
  %150 = phi i64 [ %195, %block_.L_4110f1 ], [ %111, %block_4110ec ]
  %151 = add i64 %150, -32
  ...
  %call2_4110fc = tail call %struct.Memory* @sub_40c970._ZN15loop_inner_bodyILi11EiE7do_workERiPKii(%struct.State* nonnull %0, i64 %161, %struct.Memory* %MEMORY.0)
  ...
  br i1 %233, label %block_.L_4110f1, label %block_41111b
...
block_.L_411120:                                  ; preds = %block_41111b, %block_4110cf
  %236 = phi i64 [ %235, %block_41111b ], [ %147, %block_4110cf ]
  %237 = phi i64 [ %195, %block_41111b ], [ %111, %block_4110cf ]
  %238 = add i64 %237, -36
  %239 = add i64 %236, 3
  ...
  br i1 %272, label %block_41112c, label %block_.L_411161
...
block_.L_411131:                                  ; preds = %block_.L_411131, %block_41112c
  %275 = phi i64 [ %398, %block_.L_411131 ], [ %274, %block_41112c ]
  %276 = phi i64 [ %363, %block_.L_411131 ], [ %237, %block_41112c ]
  %277 = add i64 %276, -8
  %278 = add i64 %275, 4
  ...
  %call2_41113c = tail call %struct.Memory* @sub_40c110._Z18complete_hash_funcIiET_S0_(%struct.State* nonnull %0, i64 %292, %struct.Memory* %MEMORY.0)
  ...
  br i1 %387, label %block_41115c, label %block_.L_411131
...
block_.L_411161:                                  ; preds = %block_.L_411120, %block_41115c
  %400 = phi i64 [ %273, %block_.L_411120 ], [ %399, %block_41115c ]
  %401 = phi i64 [ %237, %block_.L_411120 ], [ %363, %block_41115c ]
  %402 = add i64 %401, -32
  %403 = add i64 %400, 3
  ...
  %call2_411164 = tail call %struct.Memory* @sub_40c140._Z9check_sumIiEvT_(%struct.State* nonnull %0, i64 %407, %struct.Memory* %MEMORY.0)
...
block_.L_411177:                                  ; preds = %block_.L_4110bf
  ...
  %call2_411177 = tail call %struct.Memory* @sub_400e30._Z5timerv(%struct.State* nonnull %0, i64 %444, %struct.Memory* %MEMORY.0)
  ...
  %call2_411180 = tail call %struct.Memory* @sub_4007d0._Z13record_resultdPKc(%struct.State* nonnull %0, i64 %455, %struct.Memory* %call2_411177)
