...
entry:
  ...
  %call2_411073 = tail call %struct.Memory* @sub_400dd0._Z11start_timerv(%struct.State* %0, i64 %58, %struct.Memory* %2)
...
block_.L_41107f:                                  ; preds = %block_.L_411121, %entry
  %68 = phi i64 [ %.pre, %entry ], [ %445, %block_.L_411121 ]
  %MEMORY.0 = phi %struct.Memory* [ %call2_411073, %entry ], [ %call2_411124, %block_.L_411121 ]
  ...
  br i1 %101, label %block_41108f, label %block_.L_411137
...
block_41108f:                                     ; preds = %block_.L_41107f
  ...
  br i1 %146, label %block_.L_4110e0, label %block_4110ac
...
block_.L_4110b1:                                  ; preds = %block_.L_4110b1, %block_4110ac
  %149 = phi i64 [ %148, %block_4110ac ], [ %234, %block_.L_4110b1 ]
  %150 = phi i64 [ %111, %block_4110ac ], [ %195, %block_.L_4110b1 ]
  %MEMORY.1 = phi %struct.Memory* [ %MEMORY.0, %block_4110ac ], [ %call2_4110bc, %block_.L_4110b1 ]
  %151 = add i64 %150, -32
  ...
  %call2_4110bc = tail call %struct.Memory* @sub_40c930._ZN15loop_inner_bodyILi11EiE7do_workERiPKii(%struct.State* %0, i64 %161, %struct.Memory* %MEMORY.1)
  ...
  br i1 %233, label %block_.L_4110b1, label %block_4110db
...
block_.L_4110e0:                                  ; preds = %block_4110db, %block_41108f
  %236 = phi i64 [ %147, %block_41108f ], [ %235, %block_4110db ]
  %237 = phi i64 [ %111, %block_41108f ], [ %195, %block_4110db ]
  %MEMORY.2 = phi %struct.Memory* [ %MEMORY.0, %block_41108f ], [ %call2_4110bc, %block_4110db ]
  %238 = add i64 %237, -36
  %239 = add i64 %236, 3
  ...
  br i1 %272, label %block_4110ec, label %block_.L_411121
...
block_.L_4110f1:                                  ; preds = %block_.L_4110f1, %block_4110ec
  %275 = phi i64 [ %274, %block_4110ec ], [ %399, %block_.L_4110f1 ]
  %276 = phi i64 [ %237, %block_4110ec ], [ %364, %block_.L_4110f1 ]
  %MEMORY.3 = phi %struct.Memory* [ %MEMORY.2, %block_4110ec ], [ %call2_4110fc, %block_.L_4110f1 ]
  %277 = add i64 %276, -8
  %278 = add i64 %275, 4
  ...
  %call2_4110fc = tail call %struct.Memory* @sub_40c0d0._Z18complete_hash_funcIiET_S0_(%struct.State* %0, i64 %292, %struct.Memory* %MEMORY.3)
  ...
  br i1 %388, label %block_41111c, label %block_.L_4110f1
...
block_.L_411121:                                  ; preds = %block_.L_4110e0, %block_41111c
  %401 = phi i64 [ %273, %block_.L_4110e0 ], [ %400, %block_41111c ]
  %402 = phi i64 [ %237, %block_.L_4110e0 ], [ %364, %block_41111c ]
  %MEMORY.4 = phi %struct.Memory* [ %MEMORY.2, %block_.L_4110e0 ], [ %call2_4110fc, %block_41111c ]
  %403 = add i64 %402, -32
  %404 = add i64 %401, 3
  ...
  %call2_411124 = tail call %struct.Memory* @sub_40c100._Z9check_sumIiEvT_(%struct.State* %0, i64 %408, %struct.Memory* %MEMORY.4)
...
block_.L_411137:                                  ; preds = %block_.L_41107f
  ...
  %call2_411137 = tail call %struct.Memory* @sub_400df0._Z5timerv(%struct.State* %0, i64 %446, %struct.Memory* %MEMORY.0)
  ...
  %call2_411140 = tail call %struct.Memory* @sub_400790._Z13record_resultdPKc(%struct.State* %0, i64 %457, %struct.Memory* %call2_411137)
  ...
  ret %struct.Memory* %call2_411140
}
...
define %struct.Memory* @routine_jge_.L_411137(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i8* %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
...
define %struct.Memory* @routine_jl_.L_4110e0(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i8* %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 2, i32 9
...
define %struct.Memory* @routine_jmpq_.L_4110b1(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
...
define %struct.Memory* @routine_jl_.L_4110b1(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i8* %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 2, i32 9
...
define %struct.Memory* @routine_jmpq_.L_4110e0(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
...
define %struct.Memory* @routine_jge_.L_411121(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i8* %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 2, i32 9
...
define %struct.Memory* @routine_jmpq_.L_4110f1(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
...
define %struct.Memory* @routine_jne_.L_4110f1(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i8* %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
...
define %struct.Memory* @routine_jmpq_.L_411121(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
...
define %struct.Memory* @routine_jmpq_.L_41107f(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
