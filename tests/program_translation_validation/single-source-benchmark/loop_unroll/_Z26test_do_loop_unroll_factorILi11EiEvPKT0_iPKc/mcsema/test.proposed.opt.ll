...
define %struct.Memory* @_Z26test_do_loop_unroll_factorILi11EiEvPKT0_iPKc(%struct.State* noalias, i64, %struct.Memory* noalias) local_unnamed_addr #1 {
entry:
  ...
  %call2_4110a3 = tail call %struct.Memory* @sub_400e00._Z11start_timerv(%struct.State* %0, i64 %58, %struct.Memory* %2)
...
block_.L_4110af:                                  ; preds = %block_.L_411151, %entry
  %68 = phi i64 [ %.pre, %entry ], [ %443, %block_.L_411151 ]
  %MEMORY.0 = phi %struct.Memory* [ %call2_4110a3, %entry ], [ %call2_411154, %block_.L_411151 ]
  ...
  br i1 %101, label %block_4110bf, label %block_.L_411167
...
block_4110bf:                                     ; preds = %block_.L_4110af
  ...
  br i1 %146, label %block_.L_411110, label %block_4110dc
...
block_.L_4110e1:                                  ; preds = %block_.L_4110e1, %block_4110dc
  %149 = phi i64 [ %148, %block_4110dc ], [ %234, %block_.L_4110e1 ]
  %150 = phi i64 [ %111, %block_4110dc ], [ %195, %block_.L_4110e1 ]
  %MEMORY.1 = phi %struct.Memory* [ %MEMORY.0, %block_4110dc ], [ %call2_4110ec, %block_.L_4110e1 ]
  %151 = add i64 %150, -32
  ...
  %call2_4110ec = tail call %struct.Memory* @sub_40c960._ZN15loop_inner_bodyILi11EiE7do_workERiPKii(%struct.State* nonnull %0, i64 %161, %struct.Memory* %MEMORY.1)
  ...
  br i1 %233, label %block_.L_4110e1, label %block_41110b
...
block_.L_411110:                                  ; preds = %block_41110b, %block_4110bf
  %236 = phi i64 [ %147, %block_4110bf ], [ %235, %block_41110b ]
  %237 = phi i64 [ %111, %block_4110bf ], [ %195, %block_41110b ]
  %MEMORY.2 = phi %struct.Memory* [ %MEMORY.0, %block_4110bf ], [ %call2_4110ec, %block_41110b ]
  %238 = add i64 %237, -36
  %239 = add i64 %236, 3
  ...
  br i1 %272, label %block_41111c, label %block_.L_411151
...
block_.L_411121:                                  ; preds = %block_.L_411121, %block_41111c
  %275 = phi i64 [ %274, %block_41111c ], [ %398, %block_.L_411121 ]
  %276 = phi i64 [ %237, %block_41111c ], [ %363, %block_.L_411121 ]
  %MEMORY.3 = phi %struct.Memory* [ %MEMORY.2, %block_41111c ], [ %call2_41112c, %block_.L_411121 ]
  %277 = add i64 %276, -8
  %278 = add i64 %275, 4
  ...
  %call2_41112c = tail call %struct.Memory* @sub_40c100._Z18complete_hash_funcIiET_S0_(%struct.State* nonnull %0, i64 %292, %struct.Memory* %MEMORY.3)
  ...
  br i1 %387, label %block_41114c, label %block_.L_411121
...
block_.L_411151:                                  ; preds = %block_.L_411110, %block_41114c
  %400 = phi i64 [ %273, %block_.L_411110 ], [ %399, %block_41114c ]
  %401 = phi i64 [ %237, %block_.L_411110 ], [ %363, %block_41114c ]
  %MEMORY.4 = phi %struct.Memory* [ %MEMORY.2, %block_.L_411110 ], [ %call2_41112c, %block_41114c ]
  %402 = add i64 %401, -32
  %403 = add i64 %400, 3
  ...
  %call2_411154 = tail call %struct.Memory* @sub_40c130._Z9check_sumIiEvT_(%struct.State* nonnull %0, i64 %407, %struct.Memory* %MEMORY.4)
...
block_.L_411167:                                  ; preds = %block_.L_4110af
  ...
  %call2_411167 = tail call %struct.Memory* @sub_400e20._Z5timerv(%struct.State* nonnull %0, i64 %444, %struct.Memory* %MEMORY.0)
  ...
  %call2_411170 = tail call %struct.Memory* @sub_4007c0._Z13record_resultdPKc(%struct.State* nonnull %0, i64 %455, %struct.Memory* %call2_411167)
  ...
  ret %struct.Memory* %call2_411170
}
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_jge_.L_411167(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i8* nocapture %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_jl_.L_411110(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i8* nocapture %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 2, i32 9
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_jmpq_.L_4110e1(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_jl_.L_4110e1(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i8* nocapture %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 2, i32 9
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_jmpq_.L_411110(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_jge_.L_411151(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i8* nocapture %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 2, i32 9
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_jmpq_.L_411121(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_jne_.L_411121(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i8* nocapture %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_jmpq_.L_411151(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_jmpq_.L_4110af(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
