...
define %struct.Memory* @_Z26test_do_loop_unroll_factorILi12EdEvPKT0_iPKc(%struct.State* noalias, i64, %struct.Memory* noalias) #2 {
entry:
  ...
  store i32 %93, i32* %97
  store %struct.Memory* %loadMem_4064ac, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem1_4064b3, %struct.Memory** %MEMORY
...
block_.L_4064bf:                                  ; preds = %block_.L_406568, %entry
...
block_4064cf:                                     ; preds = %block_.L_4064bf
  ...
  store %struct.Memory* %loadMem_4064d2, %struct.Memory** %MEMORY
  ...
  store i32 0, i32* %278
  store %struct.Memory* %loadMem_4064d7, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_4064de, %struct.Memory** %MEMORY
...
block_4064ed:                                     ; preds = %block_4064cf
...
block_.L_4064f2:                                  ; preds = %block_.L_4064f2, %block_4064ed
  ...
  store %struct.Memory* %loadMem_4064f6, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_4064fa, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem1_4064fd, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_406502, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_406505, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_406508, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_40650b, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_406516, %struct.Memory** %MEMORY
...
block_40651c:                                     ; preds = %block_.L_4064f2
...
block_.L_406521:                                  ; preds = %block_40651c, %block_4064cf
  ...
  store %struct.Memory* %loadMem_406524, %struct.Memory** %MEMORY
...
block_40652d:                                     ; preds = %block_.L_406521
...
block_.L_406532:                                  ; preds = %block_.L_406532, %block_40652d
  ...
  store %struct.Memory* %loadMem_406536, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem1_40653f, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_406549, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_40655a, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_40655d, %struct.Memory** %MEMORY
...
block_406563:                                     ; preds = %block_.L_406532
...
block_.L_406568:                                  ; preds = %block_406563, %block_.L_406521
  ...
  store %struct.Memory* %loadMem1_40656d, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_40657b, %struct.Memory** %MEMORY
  br label %block_.L_4064bf

block_.L_406580:                                  ; preds = %block_.L_4064bf
  ...
  store %struct.Memory* %loadMem1_406580, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem1_406589, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_40658e, %struct.Memory** %MEMORY
  ...
  ret %struct.Memory* %loadMem_406593
}
