...
define %struct.Memory* @_Z26test_do_loop_unroll_factorILi12EdEvPKT0_iPKc(%struct.State* noalias, i64, %struct.Memory* noalias) #1 {
entry:
  ...
  store %struct.Memory* %loadMem_4064d0, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem1_4064e3, %struct.Memory** %MEMORY
  ...
  store i32 0, i32* %137
  store %struct.Memory* %loadMem_4064e8, %struct.Memory** %MEMORY
  br label %block_.L_4064ef

block_.L_4064ef:                                  ; preds = %block_.L_406598, %entry
...
block_4064ff:                                     ; preds = %block_.L_4064ef
  ...
  store i32 0, i32* %278
  store %struct.Memory* %loadMem_406507, %struct.Memory** %MEMORY
...
block_40651d:                                     ; preds = %block_4064ff
  ...
  store %struct.Memory* %loadMem_40651d, %struct.Memory** %MEMORY
  br label %block_.L_406522

block_.L_406522:                                  ; preds = %block_.L_406522, %block_40651d
  ...
  store %struct.Memory* %loadMem_406522, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_40652a, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem1_40652d, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_406546, %struct.Memory** %MEMORY
...
block_40654c:                                     ; preds = %block_.L_406522
...
block_.L_406551:                                  ; preds = %block_40654c, %block_4064ff
...
block_40655d:                                     ; preds = %block_.L_406551
...
block_.L_406562:                                  ; preds = %block_.L_406562, %block_40655d
  ...
  store %struct.Memory* %loadMem_406562, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_406566, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_40656a, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem1_40656f, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_40657e, %struct.Memory** %MEMORY
...
block_406593:                                     ; preds = %block_.L_406562
...
block_.L_406598:                                  ; preds = %block_406593, %block_.L_406551
  ...
  store %struct.Memory* %loadMem1_40659d, %struct.Memory** %MEMORY
...
block_.L_4065b0:                                  ; preds = %block_.L_4064ef
  ...
  store %struct.Memory* %loadMem1_4065b0, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem1_4065b9, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_4065be, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_4065c3, %struct.Memory** %MEMORY
  ret %struct.Memory* %loadMem_4065c3
}
