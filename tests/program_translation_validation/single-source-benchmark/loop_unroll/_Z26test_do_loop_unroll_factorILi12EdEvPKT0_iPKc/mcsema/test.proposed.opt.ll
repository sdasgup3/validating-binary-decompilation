...
entry:
  ...
  %call2_4064f3 = tail call %struct.Memory* @sub_400e10._Z11start_timerv(%struct.State* %0, i64 %58, %struct.Memory* %2)
...
block_.L_4064ff:                                  ; preds = %block_.L_4065a8, %entry
  %74 = phi i64 [ %.pre, %entry ], [ %422, %block_.L_4065a8 ]
  %MEMORY.0 = phi %struct.Memory* [ %call2_4064f3, %entry ], [ %call2_4065ad, %block_.L_4065a8 ]
  ...
  br i1 %107, label %block_40650f, label %block_.L_4065c0
...
block_40650f:                                     ; preds = %block_.L_4064ff
  ...
  br i1 %153, label %block_.L_406561, label %block_40652d
...
block_.L_406532:                                  ; preds = %block_.L_406532, %block_40652d
  %156 = phi i64 [ %241, %block_.L_406532 ], [ %155, %block_40652d ]
  %157 = phi i64 [ %202, %block_.L_406532 ], [ %118, %block_40652d ]
  %158 = add i64 %157, -40
  ...
  %call2_40653d = tail call %struct.Memory* @sub_401d50._ZN15loop_inner_bodyILi12EdE7do_workERdPKdi(%struct.State* nonnull %0, i64 %168, %struct.Memory* %MEMORY.0)
  ...
  br i1 %240, label %block_.L_406532, label %block_40655c
...
block_.L_406561:                                  ; preds = %block_40655c, %block_40650f
  %243 = phi i64 [ %242, %block_40655c ], [ %154, %block_40650f ]
  %244 = phi i64 [ %202, %block_40655c ], [ %118, %block_40650f ]
  %245 = add i64 %244, -44
  %246 = add i64 %243, 3
  ...
  br i1 %279, label %block_40656d, label %block_.L_4065a8
...
block_.L_406572:                                  ; preds = %block_.L_406572, %block_40656d
  %282 = phi i64 [ %378, %block_.L_406572 ], [ %281, %block_40656d ]
  %283 = phi i64 [ %343, %block_.L_406572 ], [ %244, %block_40656d ]
  %284 = add i64 %283, -8
  %285 = add i64 %282, 4
  ...
  %call2_40657f = tail call %struct.Memory* @sub_4014c0._Z18complete_hash_funcIdET_S0_(%struct.State* nonnull %0, i64 %298, %struct.Memory* %MEMORY.0)
  ...
  br i1 %367, label %block_4065a3, label %block_.L_406572
...
block_.L_4065a8:                                  ; preds = %block_.L_406561, %block_4065a3
  %380 = phi i64 [ %280, %block_.L_406561 ], [ %379, %block_4065a3 ]
  %381 = phi i64 [ %244, %block_.L_406561 ], [ %343, %block_4065a3 ]
  %382 = add i64 %381, -40
  %383 = add i64 %380, 5
  ...
  %call2_4065ad = tail call %struct.Memory* @sub_4014f0._Z9check_sumIdEvT_(%struct.State* nonnull %0, i64 %386, %struct.Memory* %MEMORY.0)
...
block_.L_4065c0:                                  ; preds = %block_.L_4064ff
  ...
  %call2_4065c0 = tail call %struct.Memory* @sub_400e30._Z5timerv(%struct.State* nonnull %0, i64 %423, %struct.Memory* %MEMORY.0)
  ...
  %call2_4065c9 = tail call %struct.Memory* @sub_4007d0._Z13record_resultdPKc(%struct.State* nonnull %0, i64 %434, %struct.Memory* %call2_4065c0)
