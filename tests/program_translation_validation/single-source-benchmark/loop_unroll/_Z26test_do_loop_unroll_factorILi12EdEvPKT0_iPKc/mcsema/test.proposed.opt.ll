...
define %struct.Memory* @_Z26test_do_loop_unroll_factorILi12EdEvPKT0_iPKc(%struct.State* noalias, i64, %struct.Memory* noalias) local_unnamed_addr #1 {
entry:
  ...
  %call2_4064e3 = tail call %struct.Memory* @sub_400e00._Z11start_timerv(%struct.State* %0, i64 %58, %struct.Memory* %2)
...
block_.L_4064ef:                                  ; preds = %block_.L_406598, %entry
  %74 = phi i64 [ %.pre, %entry ], [ %422, %block_.L_406598 ]
  %MEMORY.0 = phi %struct.Memory* [ %call2_4064e3, %entry ], [ %call2_40659d, %block_.L_406598 ]
  ...
  br i1 %107, label %block_4064ff, label %block_.L_4065b0
...
block_4064ff:                                     ; preds = %block_.L_4064ef
  ...
  br i1 %153, label %block_.L_406551, label %block_40651d
...
block_.L_406522:                                  ; preds = %block_.L_406522, %block_40651d
  %156 = phi i64 [ %155, %block_40651d ], [ %241, %block_.L_406522 ]
  %157 = phi i64 [ %118, %block_40651d ], [ %202, %block_.L_406522 ]
  %MEMORY.1 = phi %struct.Memory* [ %MEMORY.0, %block_40651d ], [ %call2_40652d, %block_.L_406522 ]
  %158 = add i64 %157, -40
  ...
  %call2_40652d = tail call %struct.Memory* @sub_401d40._ZN15loop_inner_bodyILi12EdE7do_workERdPKdi(%struct.State* nonnull %0, i64 %168, %struct.Memory* %MEMORY.1)
  ...
  br i1 %240, label %block_.L_406522, label %block_40654c
...
block_.L_406551:                                  ; preds = %block_40654c, %block_4064ff
  %243 = phi i64 [ %154, %block_4064ff ], [ %242, %block_40654c ]
  %244 = phi i64 [ %118, %block_4064ff ], [ %202, %block_40654c ]
  %MEMORY.2 = phi %struct.Memory* [ %MEMORY.0, %block_4064ff ], [ %call2_40652d, %block_40654c ]
  %245 = add i64 %244, -44
  %246 = add i64 %243, 3
  ...
  br i1 %279, label %block_40655d, label %block_.L_406598
...
block_.L_406562:                                  ; preds = %block_.L_406562, %block_40655d
  %282 = phi i64 [ %281, %block_40655d ], [ %378, %block_.L_406562 ]
  %283 = phi i64 [ %244, %block_40655d ], [ %343, %block_.L_406562 ]
  %MEMORY.3 = phi %struct.Memory* [ %MEMORY.2, %block_40655d ], [ %call2_40656f, %block_.L_406562 ]
  %284 = add i64 %283, -8
  %285 = add i64 %282, 4
  ...
  %call2_40656f = tail call %struct.Memory* @sub_4014b0._Z18complete_hash_funcIdET_S0_(%struct.State* nonnull %0, i64 %298, %struct.Memory* %MEMORY.3)
  ...
  br i1 %367, label %block_406593, label %block_.L_406562
...
block_.L_406598:                                  ; preds = %block_.L_406551, %block_406593
  %380 = phi i64 [ %280, %block_.L_406551 ], [ %379, %block_406593 ]
  %381 = phi i64 [ %244, %block_.L_406551 ], [ %343, %block_406593 ]
  %MEMORY.4 = phi %struct.Memory* [ %MEMORY.2, %block_.L_406551 ], [ %call2_40656f, %block_406593 ]
  %382 = add i64 %381, -40
  %383 = add i64 %380, 5
  ...
  %call2_40659d = tail call %struct.Memory* @sub_4014e0._Z9check_sumIdEvT_(%struct.State* nonnull %0, i64 %386, %struct.Memory* %MEMORY.4)
...
block_.L_4065b0:                                  ; preds = %block_.L_4064ef
  ...
  %call2_4065b0 = tail call %struct.Memory* @sub_400e20._Z5timerv(%struct.State* nonnull %0, i64 %423, %struct.Memory* %MEMORY.0)
  ...
  %call2_4065b9 = tail call %struct.Memory* @sub_4007c0._Z13record_resultdPKc(%struct.State* nonnull %0, i64 %434, %struct.Memory* %call2_4065b0)
  ...
  ret %struct.Memory* %call2_4065b9
}
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_jge_.L_4065b0(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i8* nocapture %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_jl_.L_406551(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i8* nocapture %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 2, i32 9
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_jmpq_.L_406522(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_jl_.L_406522(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i8* nocapture %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 2, i32 9
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_jmpq_.L_406551(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_jge_.L_406598(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i8* nocapture %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 2, i32 9
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_jmpq_.L_406562(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_jne_.L_406562(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i8* nocapture %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_jmpq_.L_406598(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_jmpq_.L_4064ef(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
