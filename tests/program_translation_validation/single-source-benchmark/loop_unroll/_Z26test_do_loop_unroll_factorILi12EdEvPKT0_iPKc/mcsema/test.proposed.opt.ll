...
block_.L_4064bf:                                  ; preds = %block_.L_406568, %entry
  %79 = phi i64 [ %.pre, %entry ], [ %427, %block_.L_406568 ]
...
block_.L_406532:                                  ; preds = %block_.L_406532, %block_40652d
  %288 = phi i64 [ %287, %block_40652d ], [ %383, %block_.L_406532 ]
  %289 = phi i64 [ %250, %block_40652d ], [ %348, %block_.L_406532 ]
  ...
  %call2_40653f = tail call %struct.Memory* @sub_401480._Z18complete_hash_funcIdET_S0_(%struct.State* %0, i64 %304, %struct.Memory* %MEMORY.3)
  ...
  br i1 %372, label %block_406563, label %block_.L_406532
...
block_.L_406568:                                  ; preds = %block_.L_406521, %block_406563
  %385 = phi i64 [ %286, %block_.L_406521 ], [ %384, %block_406563 ]
  %386 = phi i64 [ %250, %block_.L_406521 ], [ %348, %block_406563 ]
  ...
  %call2_40656d = tail call %struct.Memory* @sub_4014b0._Z9check_sumIdEvT_(%struct.State* %0, i64 %391, %struct.Memory* %MEMORY.4)
...
block_.L_406580:                                  ; preds = %block_.L_4064bf
  ...
  %call2_406580 = tail call %struct.Memory* @sub_400df0._Z5timerv(%struct.State* %0, i64 %428, %struct.Memory* %MEMORY.0)
  ...
  %call2_406589 = tail call %struct.Memory* @sub_400790._Z13record_resultdPKc(%struct.State* %0, i64 %439, %struct.Memory* %call2_406580)
