...
entry:
  ...
  %call2_4064b3 = tail call %struct.Memory* @sub_400dd0._Z11start_timerv(%struct.State* %0, i64 %58, %struct.Memory* %2)
...
block_.L_4064bf:                                  ; preds = %block_.L_406568, %entry
  %79 = phi i64 [ %.pre, %entry ], [ %431, %block_.L_406568 ]
  %MEMORY.0 = phi %struct.Memory* [ %call2_4064b3, %entry ], [ %call2_40656d, %block_.L_406568 ]
  ...
  br i1 %112, label %block_4064cf, label %block_.L_406580
...
block_4064cf:                                     ; preds = %block_.L_4064bf
  ...
  br i1 %159, label %block_.L_406521, label %block_4064ed
...
block_.L_4064f2:                                  ; preds = %block_.L_4064f2, %block_4064ed
  %162 = phi i64 [ %161, %block_4064ed ], [ %247, %block_.L_4064f2 ]
  %163 = phi i64 [ %124, %block_4064ed ], [ %208, %block_.L_4064f2 ]
  %MEMORY.1 = phi %struct.Memory* [ %MEMORY.0, %block_4064ed ], [ %call2_4064fd, %block_.L_4064f2 ]
  %164 = add i64 %163, -40
  ...
  %call2_4064fd = tail call %struct.Memory* @sub_401d10._ZN15loop_inner_bodyILi12EdE7do_workERdPKdi(%struct.State* %0, i64 %174, %struct.Memory* %MEMORY.1)
  ...
  br i1 %246, label %block_.L_4064f2, label %block_40651c
...
block_.L_406521:                                  ; preds = %block_40651c, %block_4064cf
  %249 = phi i64 [ %160, %block_4064cf ], [ %248, %block_40651c ]
  %250 = phi i64 [ %124, %block_4064cf ], [ %208, %block_40651c ]
  %MEMORY.2 = phi %struct.Memory* [ %MEMORY.0, %block_4064cf ], [ %call2_4064fd, %block_40651c ]
  %251 = add i64 %250, -44
  %252 = add i64 %249, 3
  ...
  br i1 %285, label %block_40652d, label %block_.L_406568
...
block_.L_406532:                                  ; preds = %block_.L_406532, %block_40652d
  %288 = phi i64 [ %287, %block_40652d ], [ %385, %block_.L_406532 ]
  %289 = phi i64 [ %250, %block_40652d ], [ %350, %block_.L_406532 ]
  %MEMORY.3 = phi %struct.Memory* [ %MEMORY.2, %block_40652d ], [ %call2_40653f, %block_.L_406532 ]
  %290 = add i64 %289, -8
  %291 = add i64 %288, 4
  ...
  %call2_40653f = tail call %struct.Memory* @sub_401480._Z18complete_hash_funcIdET_S0_(%struct.State* %0, i64 %305, %struct.Memory* %MEMORY.3)
  ...
  br i1 %374, label %block_406563, label %block_.L_406532
...
block_.L_406568:                                  ; preds = %block_.L_406521, %block_406563
  %387 = phi i64 [ %286, %block_.L_406521 ], [ %386, %block_406563 ]
  %388 = phi i64 [ %250, %block_.L_406521 ], [ %350, %block_406563 ]
  %MEMORY.4 = phi %struct.Memory* [ %MEMORY.2, %block_.L_406521 ], [ %call2_40653f, %block_406563 ]
  %389 = add i64 %388, -40
  %390 = add i64 %387, 5
  ...
  %call2_40656d = tail call %struct.Memory* @sub_4014b0._Z9check_sumIdEvT_(%struct.State* %0, i64 %394, %struct.Memory* %MEMORY.4)
...
block_.L_406580:                                  ; preds = %block_.L_4064bf
  ...
  %call2_406580 = tail call %struct.Memory* @sub_400df0._Z5timerv(%struct.State* %0, i64 %432, %struct.Memory* %MEMORY.0)
  ...
  %call2_406589 = tail call %struct.Memory* @sub_400790._Z13record_resultdPKc(%struct.State* %0, i64 %443, %struct.Memory* %call2_406580)
  ...
  ret %struct.Memory* %call2_406589
}
...
define %struct.Memory* @routine_jge_.L_406580(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i8* %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
...
define %struct.Memory* @routine_jl_.L_406521(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i8* %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 2, i32 9
...
define %struct.Memory* @routine_jmpq_.L_4064f2(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
...
define %struct.Memory* @routine_jl_.L_4064f2(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i8* %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 2, i32 9
...
define %struct.Memory* @routine_jmpq_.L_406521(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
...
define %struct.Memory* @routine_jge_.L_406568(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i8* %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 2, i32 9
...
define %struct.Memory* @routine_jmpq_.L_406532(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
...
define %struct.Memory* @routine_jne_.L_406532(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i8* %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
...
define %struct.Memory* @routine_jmpq_.L_406568(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
...
define %struct.Memory* @routine_jmpq_.L_4064bf(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
