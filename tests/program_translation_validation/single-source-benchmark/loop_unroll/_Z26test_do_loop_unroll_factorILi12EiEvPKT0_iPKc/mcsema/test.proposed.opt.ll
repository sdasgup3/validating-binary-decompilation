...
entry:
  ...
  %call2_410f33 = tail call %struct.Memory* @sub_400dd0._Z11start_timerv(%struct.State* %0, i64 %58, %struct.Memory* %2)
...
block_.L_410f3f:                                  ; preds = %block_.L_410fe1, %entry
  %68 = phi i64 [ %.pre, %entry ], [ %443, %block_.L_410fe1 ]
  %MEMORY.0 = phi %struct.Memory* [ %call2_410f33, %entry ], [ %call2_410fe4, %block_.L_410fe1 ]
  ...
  br i1 %101, label %block_410f4f, label %block_.L_410ff7
...
block_410f4f:                                     ; preds = %block_.L_410f3f
  ...
  br i1 %146, label %block_.L_410fa0, label %block_410f6c
...
block_.L_410f71:                                  ; preds = %block_.L_410f71, %block_410f6c
  %149 = phi i64 [ %148, %block_410f6c ], [ %234, %block_.L_410f71 ]
  %150 = phi i64 [ %111, %block_410f6c ], [ %195, %block_.L_410f71 ]
  %MEMORY.1 = phi %struct.Memory* [ %MEMORY.0, %block_410f6c ], [ %call2_410f7c, %block_.L_410f71 ]
  %151 = add i64 %150, -32
  ...
  %call2_410f7c = tail call %struct.Memory* @sub_40c8d0._ZN15loop_inner_bodyILi12EiE7do_workERiPKii(%struct.State* %0, i64 %161, %struct.Memory* %MEMORY.1)
  ...
  br i1 %233, label %block_.L_410f71, label %block_410f9b
...
block_.L_410fa0:                                  ; preds = %block_410f9b, %block_410f4f
  %236 = phi i64 [ %147, %block_410f4f ], [ %235, %block_410f9b ]
  %237 = phi i64 [ %111, %block_410f4f ], [ %195, %block_410f9b ]
  %MEMORY.2 = phi %struct.Memory* [ %MEMORY.0, %block_410f4f ], [ %call2_410f7c, %block_410f9b ]
  %238 = add i64 %237, -36
  %239 = add i64 %236, 3
  ...
  br i1 %272, label %block_410fac, label %block_.L_410fe1
...
block_.L_410fb1:                                  ; preds = %block_.L_410fb1, %block_410fac
  %275 = phi i64 [ %274, %block_410fac ], [ %398, %block_.L_410fb1 ]
  %276 = phi i64 [ %237, %block_410fac ], [ %363, %block_.L_410fb1 ]
  %MEMORY.3 = phi %struct.Memory* [ %MEMORY.2, %block_410fac ], [ %call2_410fbc, %block_.L_410fb1 ]
  %277 = add i64 %276, -8
  %278 = add i64 %275, 4
  ...
  %call2_410fbc = tail call %struct.Memory* @sub_40c0d0._Z18complete_hash_funcIiET_S0_(%struct.State* %0, i64 %292, %struct.Memory* %MEMORY.3)
  ...
  br i1 %387, label %block_410fdc, label %block_.L_410fb1
...
block_.L_410fe1:                                  ; preds = %block_.L_410fa0, %block_410fdc
  %400 = phi i64 [ %273, %block_.L_410fa0 ], [ %399, %block_410fdc ]
  %401 = phi i64 [ %237, %block_.L_410fa0 ], [ %363, %block_410fdc ]
  %MEMORY.4 = phi %struct.Memory* [ %MEMORY.2, %block_.L_410fa0 ], [ %call2_410fbc, %block_410fdc ]
  %402 = add i64 %401, -32
  %403 = add i64 %400, 3
  ...
  %call2_410fe4 = tail call %struct.Memory* @sub_40c100._Z9check_sumIiEvT_(%struct.State* %0, i64 %407, %struct.Memory* %MEMORY.4)
...
block_.L_410ff7:                                  ; preds = %block_.L_410f3f
  ...
  %call2_410ff7 = tail call %struct.Memory* @sub_400df0._Z5timerv(%struct.State* %0, i64 %444, %struct.Memory* %MEMORY.0)
  ...
  %call2_411000 = tail call %struct.Memory* @sub_400790._Z13record_resultdPKc(%struct.State* %0, i64 %455, %struct.Memory* %call2_410ff7)
  ...
  ret %struct.Memory* %call2_411000
}
...
define %struct.Memory* @routine_jge_.L_410ff7(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i8* %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
...
define %struct.Memory* @routine_jl_.L_410fa0(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i8* %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 2, i32 9
...
define %struct.Memory* @routine_jmpq_.L_410f71(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
...
define %struct.Memory* @routine_jl_.L_410f71(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i8* %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 2, i32 9
...
define %struct.Memory* @routine_jmpq_.L_410fa0(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
...
define %struct.Memory* @routine_jge_.L_410fe1(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i8* %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 2, i32 9
...
define %struct.Memory* @routine_jmpq_.L_410fb1(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
...
define %struct.Memory* @routine_jne_.L_410fb1(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i8* %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
...
define %struct.Memory* @routine_jmpq_.L_410fe1(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
...
define %struct.Memory* @routine_jmpq_.L_410f3f(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
