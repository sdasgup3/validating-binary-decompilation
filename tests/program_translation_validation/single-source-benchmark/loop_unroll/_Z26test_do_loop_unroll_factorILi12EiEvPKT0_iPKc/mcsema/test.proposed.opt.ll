...
declare %struct.Memory* @sub_40c910._ZN15loop_inner_bodyILi12EiE7do_workERiPKii(%struct.State* noalias dereferenceable(3376), i64, %struct.Memory* noalias readnone returned) local_unnamed_addr
...
entry:
  ...
  %call2_410f73 = tail call %struct.Memory* @sub_400e10._Z11start_timerv(%struct.State* %0, i64 %58, %struct.Memory* %2)
...
block_.L_410f7f:                                  ; preds = %block_.L_411021, %entry
  %68 = phi i64 [ %.pre, %entry ], [ %443, %block_.L_411021 ]
  %MEMORY.0 = phi %struct.Memory* [ %call2_410f73, %entry ], [ %call2_411024, %block_.L_411021 ]
  ...
  br i1 %101, label %block_410f8f, label %block_.L_411037
...
block_410f8f:                                     ; preds = %block_.L_410f7f
  ...
  br i1 %146, label %block_.L_410fe0, label %block_410fac
...
block_.L_410fb1:                                  ; preds = %block_.L_410fb1, %block_410fac
  %149 = phi i64 [ %234, %block_.L_410fb1 ], [ %148, %block_410fac ]
  %150 = phi i64 [ %195, %block_.L_410fb1 ], [ %111, %block_410fac ]
  %151 = add i64 %150, -32
  ...
  %call2_410fbc = tail call %struct.Memory* @sub_40c910._ZN15loop_inner_bodyILi12EiE7do_workERiPKii(%struct.State* nonnull %0, i64 %161, %struct.Memory* %MEMORY.0)
  ...
  br i1 %233, label %block_.L_410fb1, label %block_410fdb
...
block_.L_410fe0:                                  ; preds = %block_410fdb, %block_410f8f
  %236 = phi i64 [ %235, %block_410fdb ], [ %147, %block_410f8f ]
  %237 = phi i64 [ %195, %block_410fdb ], [ %111, %block_410f8f ]
  %238 = add i64 %237, -36
  %239 = add i64 %236, 3
  ...
  br i1 %272, label %block_410fec, label %block_.L_411021
...
block_.L_410ff1:                                  ; preds = %block_.L_410ff1, %block_410fec
  %275 = phi i64 [ %398, %block_.L_410ff1 ], [ %274, %block_410fec ]
  %276 = phi i64 [ %363, %block_.L_410ff1 ], [ %237, %block_410fec ]
  %277 = add i64 %276, -8
  %278 = add i64 %275, 4
  ...
  %call2_410ffc = tail call %struct.Memory* @sub_40c110._Z18complete_hash_funcIiET_S0_(%struct.State* nonnull %0, i64 %292, %struct.Memory* %MEMORY.0)
  ...
  br i1 %387, label %block_41101c, label %block_.L_410ff1
...
block_.L_411021:                                  ; preds = %block_.L_410fe0, %block_41101c
  %400 = phi i64 [ %273, %block_.L_410fe0 ], [ %399, %block_41101c ]
  %401 = phi i64 [ %237, %block_.L_410fe0 ], [ %363, %block_41101c ]
  %402 = add i64 %401, -32
  %403 = add i64 %400, 3
  ...
  %call2_411024 = tail call %struct.Memory* @sub_40c140._Z9check_sumIiEvT_(%struct.State* nonnull %0, i64 %407, %struct.Memory* %MEMORY.0)
...
block_.L_411037:                                  ; preds = %block_.L_410f7f
  ...
  %call2_411037 = tail call %struct.Memory* @sub_400e30._Z5timerv(%struct.State* nonnull %0, i64 %444, %struct.Memory* %MEMORY.0)
  ...
  %call2_411040 = tail call %struct.Memory* @sub_4007d0._Z13record_resultdPKc(%struct.State* nonnull %0, i64 %455, %struct.Memory* %call2_411037)
