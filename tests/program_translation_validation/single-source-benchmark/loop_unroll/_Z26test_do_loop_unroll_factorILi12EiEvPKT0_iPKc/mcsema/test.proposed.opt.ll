...
define %struct.Memory* @_Z26test_do_loop_unroll_factorILi12EiEvPKT0_iPKc(%struct.State* noalias, i64, %struct.Memory* noalias readnone) local_unnamed_addr #1 {
entry:
...
block_.L_410fa1:                                  ; preds = %block_.L_410fa1, %block_410f9c
  %149 = phi i64 [ %234, %block_.L_410fa1 ], [ %148, %block_410f9c ]
  %150 = phi i64 [ %195, %block_.L_410fa1 ], [ %111, %block_410f9c ]
  %151 = add i64 %150, -32
  ...
  %call2_410fac = tail call %struct.Memory* @sub_40c900._ZN15loop_inner_bodyILi12EiE7do_workERiPKii(%struct.State* nonnull %0, i64 %161, %struct.Memory* %MEMORY.0)
...
block_.L_410fd0:                                  ; preds = %block_410fcb, %block_410f7f
  %236 = phi i64 [ %235, %block_410fcb ], [ %147, %block_410f7f ]
  %237 = phi i64 [ %195, %block_410fcb ], [ %111, %block_410f7f ]
  %238 = add i64 %237, -36
  %239 = add i64 %236, 3
...
block_.L_410fe1:                                  ; preds = %block_.L_410fe1, %block_410fdc
  %275 = phi i64 [ %398, %block_.L_410fe1 ], [ %274, %block_410fdc ]
  %276 = phi i64 [ %363, %block_.L_410fe1 ], [ %237, %block_410fdc ]
  %277 = add i64 %276, -8
  %278 = add i64 %275, 4
  ...
  %call2_410fec = tail call %struct.Memory* @sub_40c100._Z18complete_hash_funcIiET_S0_(%struct.State* nonnull %0, i64 %292, %struct.Memory* %MEMORY.0)
...
block_.L_411011:                                  ; preds = %block_.L_410fd0, %block_41100c
  ...
  %call2_411014 = tail call %struct.Memory* @sub_40c130._Z9check_sumIiEvT_(%struct.State* nonnull %0, i64 %407, %struct.Memory* %MEMORY.0)
