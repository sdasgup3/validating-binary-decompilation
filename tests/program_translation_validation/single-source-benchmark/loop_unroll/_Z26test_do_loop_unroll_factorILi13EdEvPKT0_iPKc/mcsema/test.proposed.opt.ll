...
entry:
  ...
  %call2_406363 = tail call %struct.Memory* @sub_400dd0._Z11start_timerv(%struct.State* %0, i64 %58, %struct.Memory* %2)
...
block_.L_40636f:                                  ; preds = %block_.L_406418, %entry
  %79 = phi i64 [ %.pre, %entry ], [ %427, %block_.L_406418 ]
  %MEMORY.0 = phi %struct.Memory* [ %call2_406363, %entry ], [ %call2_40641d, %block_.L_406418 ]
  ...
  br i1 %112, label %block_40637f, label %block_.L_406430

block_40637f:                                     ; preds = %block_.L_40636f
  ...
  br i1 %159, label %block_.L_4063d1, label %block_40639d

block_40639d:                                     ; preds = %block_40637f
  %161 = add i64 %160, 5
  store i64 %161, i64* %3, align 8
  br label %block_.L_4063a2

block_.L_4063a2:                                  ; preds = %block_.L_4063a2, %block_40639d
  %162 = phi i64 [ %161, %block_40639d ], [ %247, %block_.L_4063a2 ]
  %163 = phi i64 [ %124, %block_40639d ], [ %208, %block_.L_4063a2 ]
  %MEMORY.1 = phi %struct.Memory* [ %MEMORY.0, %block_40639d ], [ %call2_4063ad, %block_.L_4063a2 ]
  %164 = add i64 %163, -40
  ...
  %call2_4063ad = tail call %struct.Memory* @sub_401cb0._ZN15loop_inner_bodyILi13EdE7do_workERdPKdi(%struct.State* %0, i64 %174, %struct.Memory* %MEMORY.1)
  ...
  br i1 %246, label %block_.L_4063a2, label %block_4063cc

block_4063cc:                                     ; preds = %block_.L_4063a2
  %248 = add i64 %247, 5
  store i64 %248, i64* %3, align 8
  br label %block_.L_4063d1

block_.L_4063d1:                                  ; preds = %block_4063cc, %block_40637f
  %249 = phi i64 [ %160, %block_40637f ], [ %248, %block_4063cc ]
  %250 = phi i64 [ %124, %block_40637f ], [ %208, %block_4063cc ]
  %MEMORY.2 = phi %struct.Memory* [ %MEMORY.0, %block_40637f ], [ %call2_4063ad, %block_4063cc ]
  %251 = add i64 %250, -44
  %252 = add i64 %249, 3
  ...
  br i1 %285, label %block_4063dd, label %block_.L_406418

block_4063dd:                                     ; preds = %block_.L_4063d1
  %287 = add i64 %286, 5
  store i64 %287, i64* %3, align 8
  br label %block_.L_4063e2

block_.L_4063e2:                                  ; preds = %block_.L_4063e2, %block_4063dd
  %288 = phi i64 [ %287, %block_4063dd ], [ %383, %block_.L_4063e2 ]
  %289 = phi i64 [ %250, %block_4063dd ], [ %348, %block_.L_4063e2 ]
  %MEMORY.3 = phi %struct.Memory* [ %MEMORY.2, %block_4063dd ], [ %call2_4063ef, %block_.L_4063e2 ]
  %290 = add i64 %289, -8
  %291 = add i64 %288, 4
  ...
  %call2_4063ef = tail call %struct.Memory* @sub_401480._Z18complete_hash_funcIdET_S0_(%struct.State* %0, i64 %304, %struct.Memory* %MEMORY.3)
  ...
  br i1 %372, label %block_406413, label %block_.L_4063e2

block_406413:                                     ; preds = %block_.L_4063e2
  %384 = add i64 %383, 5
  store i64 %384, i64* %3, align 8
  br label %block_.L_406418

block_.L_406418:                                  ; preds = %block_.L_4063d1, %block_406413
  %385 = phi i64 [ %286, %block_.L_4063d1 ], [ %384, %block_406413 ]
  %386 = phi i64 [ %250, %block_.L_4063d1 ], [ %348, %block_406413 ]
  %MEMORY.4 = phi %struct.Memory* [ %MEMORY.2, %block_.L_4063d1 ], [ %call2_4063ef, %block_406413 ]
  %387 = add i64 %386, -40
  %388 = add i64 %385, 5
  ...
  %call2_40641d = tail call %struct.Memory* @sub_4014b0._Z9check_sumIdEvT_(%struct.State* %0, i64 %391, %struct.Memory* %MEMORY.4)
...
block_.L_406430:                                  ; preds = %block_.L_40636f
  %428 = add i64 %113, -22080
  %429 = add i64 %113, 5
  ...
  %call2_406430 = tail call %struct.Memory* @sub_400df0._Z5timerv(%struct.State* %0, i64 %428, %struct.Memory* %MEMORY.0)
  ...
  %call2_406439 = tail call %struct.Memory* @sub_400790._Z13record_resultdPKc(%struct.State* %0, i64 %439, %struct.Memory* %call2_406430)
  ...
  ret %struct.Memory* %call2_406439
}
...
define %struct.Memory* @routine_jge_.L_406430(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i8* %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
...
define %struct.Memory* @routine_jl_.L_4063d1(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i8* %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 2, i32 9
...
define %struct.Memory* @routine_jmpq_.L_4063a2(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
...
define %struct.Memory* @routine_jl_.L_4063a2(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i8* %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 2, i32 9
...
define %struct.Memory* @routine_jmpq_.L_4063d1(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
...
define %struct.Memory* @routine_jge_.L_406418(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i8* %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 2, i32 9
...
define %struct.Memory* @routine_jmpq_.L_4063e2(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
...
define %struct.Memory* @routine_jne_.L_4063e2(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i8* %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
...
define %struct.Memory* @routine_jmpq_.L_406418(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
...
define %struct.Memory* @routine_jmpq_.L_40636f(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
