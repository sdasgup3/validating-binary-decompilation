...
block_.L_410dff:                                  ; preds = %block_.L_410ea1, %entry
  %68 = phi i64 [ %.pre, %entry ], [ %443, %block_.L_410ea1 ]
...
block_.L_410e71:                                  ; preds = %block_.L_410e71, %block_410e6c
  %275 = phi i64 [ %274, %block_410e6c ], [ %398, %block_.L_410e71 ]
  %276 = phi i64 [ %237, %block_410e6c ], [ %363, %block_.L_410e71 ]
  ...
  br i1 %387, label %block_410e9c, label %block_.L_410e71
...
block_.L_410ea1:                                  ; preds = %block_.L_410e60, %block_410e9c
  %400 = phi i64 [ %273, %block_.L_410e60 ], [ %399, %block_410e9c ]
  %401 = phi i64 [ %237, %block_.L_410e60 ], [ %363, %block_410e9c ]
  ...
  %call2_410ea4 = tail call %struct.Memory* @sub_40c100._Z9check_sumIiEvT_(%struct.State* %0, i64 %407, %struct.Memory* %MEMORY.4)
...
block_.L_410eb7:                                  ; preds = %block_.L_410dff
  ...
  %call2_410eb7 = tail call %struct.Memory* @sub_400df0._Z5timerv(%struct.State* %0, i64 %444, %struct.Memory* %MEMORY.0)
  ...
  %call2_410ec0 = tail call %struct.Memory* @sub_400790._Z13record_resultdPKc(%struct.State* %0, i64 %455, %struct.Memory* %call2_410eb7)
