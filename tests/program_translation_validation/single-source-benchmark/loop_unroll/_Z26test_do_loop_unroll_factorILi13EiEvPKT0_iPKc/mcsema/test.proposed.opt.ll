...
define %struct.Memory* @_Z26test_do_loop_unroll_factorILi13EiEvPKT0_iPKc(%struct.State* noalias, i64, %struct.Memory* noalias readnone) local_unnamed_addr #1 {
entry:
...
block_.L_410e61:                                  ; preds = %block_.L_410e61, %block_410e5c
  %149 = phi i64 [ %234, %block_.L_410e61 ], [ %148, %block_410e5c ]
  %150 = phi i64 [ %195, %block_.L_410e61 ], [ %111, %block_410e5c ]
  %151 = add i64 %150, -32
  ...
  %call2_410e6c = tail call %struct.Memory* @sub_40c8a0._ZN15loop_inner_bodyILi13EiE7do_workERiPKii(%struct.State* nonnull %0, i64 %161, %struct.Memory* %MEMORY.0)
...
block_.L_410e90:                                  ; preds = %block_410e8b, %block_410e3f
  %236 = phi i64 [ %235, %block_410e8b ], [ %147, %block_410e3f ]
  %237 = phi i64 [ %195, %block_410e8b ], [ %111, %block_410e3f ]
  %238 = add i64 %237, -36
  %239 = add i64 %236, 3
...
block_.L_410ea1:                                  ; preds = %block_.L_410ea1, %block_410e9c
  %275 = phi i64 [ %398, %block_.L_410ea1 ], [ %274, %block_410e9c ]
  %276 = phi i64 [ %363, %block_.L_410ea1 ], [ %237, %block_410e9c ]
  %277 = add i64 %276, -8
  %278 = add i64 %275, 4
  ...
  %call2_410eac = tail call %struct.Memory* @sub_40c100._Z18complete_hash_funcIiET_S0_(%struct.State* nonnull %0, i64 %292, %struct.Memory* %MEMORY.0)
...
block_.L_410ed1:                                  ; preds = %block_.L_410e90, %block_410ecc
  ...
  %call2_410ed4 = tail call %struct.Memory* @sub_40c130._Z9check_sumIiEvT_(%struct.State* nonnull %0, i64 %407, %struct.Memory* %MEMORY.0)
