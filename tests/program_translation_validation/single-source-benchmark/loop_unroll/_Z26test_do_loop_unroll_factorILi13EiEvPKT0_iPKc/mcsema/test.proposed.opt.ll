...
entry:
  ...
  %call2_410df3 = tail call %struct.Memory* @sub_400dd0._Z11start_timerv(%struct.State* %0, i64 %58, %struct.Memory* %2)
...
block_.L_410dff:                                  ; preds = %block_.L_410ea1, %entry
  %68 = phi i64 [ %.pre, %entry ], [ %445, %block_.L_410ea1 ]
  %MEMORY.0 = phi %struct.Memory* [ %call2_410df3, %entry ], [ %call2_410ea4, %block_.L_410ea1 ]
  ...
  br i1 %101, label %block_410e0f, label %block_.L_410eb7
...
block_410e0f:                                     ; preds = %block_.L_410dff
  ...
  br i1 %146, label %block_.L_410e60, label %block_410e2c
...
block_.L_410e31:                                  ; preds = %block_.L_410e31, %block_410e2c
  %149 = phi i64 [ %148, %block_410e2c ], [ %234, %block_.L_410e31 ]
  %150 = phi i64 [ %111, %block_410e2c ], [ %195, %block_.L_410e31 ]
  %MEMORY.1 = phi %struct.Memory* [ %MEMORY.0, %block_410e2c ], [ %call2_410e3c, %block_.L_410e31 ]
  %151 = add i64 %150, -32
  ...
  %call2_410e3c = tail call %struct.Memory* @sub_40c870._ZN15loop_inner_bodyILi13EiE7do_workERiPKii(%struct.State* %0, i64 %161, %struct.Memory* %MEMORY.1)
  ...
  br i1 %233, label %block_.L_410e31, label %block_410e5b
...
block_.L_410e60:                                  ; preds = %block_410e5b, %block_410e0f
  %236 = phi i64 [ %147, %block_410e0f ], [ %235, %block_410e5b ]
  %237 = phi i64 [ %111, %block_410e0f ], [ %195, %block_410e5b ]
  %MEMORY.2 = phi %struct.Memory* [ %MEMORY.0, %block_410e0f ], [ %call2_410e3c, %block_410e5b ]
  %238 = add i64 %237, -36
  %239 = add i64 %236, 3
  ...
  br i1 %272, label %block_410e6c, label %block_.L_410ea1
...
block_.L_410e71:                                  ; preds = %block_.L_410e71, %block_410e6c
  %275 = phi i64 [ %274, %block_410e6c ], [ %399, %block_.L_410e71 ]
  %276 = phi i64 [ %237, %block_410e6c ], [ %364, %block_.L_410e71 ]
  %MEMORY.3 = phi %struct.Memory* [ %MEMORY.2, %block_410e6c ], [ %call2_410e7c, %block_.L_410e71 ]
  %277 = add i64 %276, -8
  %278 = add i64 %275, 4
  ...
  %call2_410e7c = tail call %struct.Memory* @sub_40c0d0._Z18complete_hash_funcIiET_S0_(%struct.State* %0, i64 %292, %struct.Memory* %MEMORY.3)
  ...
  br i1 %388, label %block_410e9c, label %block_.L_410e71
...
block_.L_410ea1:                                  ; preds = %block_.L_410e60, %block_410e9c
  %401 = phi i64 [ %273, %block_.L_410e60 ], [ %400, %block_410e9c ]
  %402 = phi i64 [ %237, %block_.L_410e60 ], [ %364, %block_410e9c ]
  %MEMORY.4 = phi %struct.Memory* [ %MEMORY.2, %block_.L_410e60 ], [ %call2_410e7c, %block_410e9c ]
  %403 = add i64 %402, -32
  %404 = add i64 %401, 3
  ...
  %call2_410ea4 = tail call %struct.Memory* @sub_40c100._Z9check_sumIiEvT_(%struct.State* %0, i64 %408, %struct.Memory* %MEMORY.4)
...
block_.L_410eb7:                                  ; preds = %block_.L_410dff
  ...
  %call2_410eb7 = tail call %struct.Memory* @sub_400df0._Z5timerv(%struct.State* %0, i64 %446, %struct.Memory* %MEMORY.0)
  ...
  %call2_410ec0 = tail call %struct.Memory* @sub_400790._Z13record_resultdPKc(%struct.State* %0, i64 %457, %struct.Memory* %call2_410eb7)
  ...
  ret %struct.Memory* %call2_410ec0
}
...
define %struct.Memory* @routine_jge_.L_410eb7(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i8* %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
...
define %struct.Memory* @routine_jl_.L_410e60(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i8* %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 2, i32 9
...
define %struct.Memory* @routine_jmpq_.L_410e31(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
...
define %struct.Memory* @routine_jl_.L_410e31(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i8* %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 2, i32 9
...
define %struct.Memory* @routine_jmpq_.L_410e60(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
...
define %struct.Memory* @routine_jge_.L_410ea1(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i8* %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 2, i32 9
...
define %struct.Memory* @routine_jmpq_.L_410e71(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
...
define %struct.Memory* @routine_jne_.L_410e71(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i8* %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
...
define %struct.Memory* @routine_jmpq_.L_410ea1(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
...
define %struct.Memory* @routine_jmpq_.L_410dff(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
