...
define %struct.Memory* @_Z26test_do_loop_unroll_factorILi14EdEvPKT0_iPKc(%struct.State* noalias, i64, %struct.Memory* noalias) #1 {
entry:
  ...
  store %struct.Memory* %loadMem_406231, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_40623f, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem1_406243, %struct.Memory** %MEMORY
...
block_.L_40624f:                                  ; preds = %block_.L_4062f8, %entry
...
block_40625f:                                     ; preds = %block_.L_40624f
...
block_40627d:                                     ; preds = %block_40625f
  ...
  store %struct.Memory* %loadMem_40627d, %struct.Memory** %MEMORY
  br label %block_.L_406282

block_.L_406282:                                  ; preds = %block_.L_406282, %block_40627d
  ...
  store %struct.Memory* %loadMem_406282, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_406286, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem1_40628d, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_406295, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_40629e, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_4062a1, %struct.Memory** %MEMORY
...
block_4062ac:                                     ; preds = %block_.L_406282
...
block_.L_4062b1:                                  ; preds = %block_4062ac, %block_40625f
...
block_4062bd:                                     ; preds = %block_.L_4062b1
...
block_.L_4062c2:                                  ; preds = %block_.L_4062c2, %block_4062bd
  ...
  store %struct.Memory* %loadMem_4062c6, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem1_4062cf, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_4062ea, %struct.Memory** %MEMORY
...
block_4062f3:                                     ; preds = %block_.L_4062c2
...
block_.L_4062f8:                                  ; preds = %block_4062f3, %block_.L_4062b1
  ...
  store %struct.Memory* %loadMem_4062f8, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem1_4062fd, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_406302, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_406305, %struct.Memory** %MEMORY
...
block_.L_406310:                                  ; preds = %block_.L_40624f
  ...
  store %struct.Memory* %loadMem1_406310, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem1_406319, %struct.Memory** %MEMORY
  ...
  ret %struct.Memory* %loadMem_406323
}
