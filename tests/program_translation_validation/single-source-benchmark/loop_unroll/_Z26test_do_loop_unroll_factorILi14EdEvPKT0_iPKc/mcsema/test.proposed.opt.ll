...
define %struct.Memory* @_Z26test_do_loop_unroll_factorILi14EdEvPKT0_iPKc(%struct.State* noalias, i64, %struct.Memory* noalias) local_unnamed_addr #1 {
entry:
  ...
  %call2_406213 = tail call %struct.Memory* @sub_400dd0._Z11start_timerv(%struct.State* %0, i64 %58, %struct.Memory* %2)
...
block_.L_40621f:                                  ; preds = %block_.L_4062c8, %entry
  %79 = phi i64 [ %.pre, %entry ], [ %431, %block_.L_4062c8 ]
  %MEMORY.0 = phi %struct.Memory* [ %call2_406213, %entry ], [ %call2_4062cd, %block_.L_4062c8 ]
  ...
  br i1 %112, label %block_40622f, label %block_.L_4062e0
...
block_40622f:                                     ; preds = %block_.L_40621f
  ...
  br i1 %159, label %block_.L_406281, label %block_40624d
...
block_.L_406252:                                  ; preds = %block_.L_406252, %block_40624d
  %162 = phi i64 [ %161, %block_40624d ], [ %247, %block_.L_406252 ]
  %163 = phi i64 [ %124, %block_40624d ], [ %208, %block_.L_406252 ]
  %MEMORY.1 = phi %struct.Memory* [ %MEMORY.0, %block_40624d ], [ %call2_40625d, %block_.L_406252 ]
  %164 = add i64 %163, -40
  ...
  %call2_40625d = tail call %struct.Memory* @sub_401c50._ZN15loop_inner_bodyILi14EdE7do_workERdPKdi(%struct.State* %0, i64 %174, %struct.Memory* %MEMORY.1)
  ...
  br i1 %246, label %block_.L_406252, label %block_40627c
...
block_.L_406281:                                  ; preds = %block_40627c, %block_40622f
  %249 = phi i64 [ %160, %block_40622f ], [ %248, %block_40627c ]
  %250 = phi i64 [ %124, %block_40622f ], [ %208, %block_40627c ]
  %MEMORY.2 = phi %struct.Memory* [ %MEMORY.0, %block_40622f ], [ %call2_40625d, %block_40627c ]
  %251 = add i64 %250, -44
  %252 = add i64 %249, 3
  ...
  br i1 %285, label %block_40628d, label %block_.L_4062c8
...
block_.L_406292:                                  ; preds = %block_.L_406292, %block_40628d
  %288 = phi i64 [ %287, %block_40628d ], [ %385, %block_.L_406292 ]
  %289 = phi i64 [ %250, %block_40628d ], [ %350, %block_.L_406292 ]
  %MEMORY.3 = phi %struct.Memory* [ %MEMORY.2, %block_40628d ], [ %call2_40629f, %block_.L_406292 ]
  %290 = add i64 %289, -8
  %291 = add i64 %288, 4
  ...
  %call2_40629f = tail call %struct.Memory* @sub_401480._Z18complete_hash_funcIdET_S0_(%struct.State* %0, i64 %305, %struct.Memory* %MEMORY.3)
  ...
  br i1 %374, label %block_4062c3, label %block_.L_406292
...
block_.L_4062c8:                                  ; preds = %block_.L_406281, %block_4062c3
  %387 = phi i64 [ %286, %block_.L_406281 ], [ %386, %block_4062c3 ]
  %388 = phi i64 [ %250, %block_.L_406281 ], [ %350, %block_4062c3 ]
  %MEMORY.4 = phi %struct.Memory* [ %MEMORY.2, %block_.L_406281 ], [ %call2_40629f, %block_4062c3 ]
  %389 = add i64 %388, -40
  %390 = add i64 %387, 5
  ...
  %call2_4062cd = tail call %struct.Memory* @sub_4014b0._Z9check_sumIdEvT_(%struct.State* %0, i64 %394, %struct.Memory* %MEMORY.4)
...
block_.L_4062e0:                                  ; preds = %block_.L_40621f
  ...
  %call2_4062e0 = tail call %struct.Memory* @sub_400df0._Z5timerv(%struct.State* %0, i64 %432, %struct.Memory* %MEMORY.0)
  ...
  %call2_4062e9 = tail call %struct.Memory* @sub_400790._Z13record_resultdPKc(%struct.State* %0, i64 %443, %struct.Memory* %call2_4062e0)
  ...
  ret %struct.Memory* %call2_4062e9
}
...
define %struct.Memory* @routine_jge_.L_4062e0(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i8* %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
...
define %struct.Memory* @routine_jl_.L_406281(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i8* %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 2, i32 9
...
define %struct.Memory* @routine_jmpq_.L_406252(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
...
define %struct.Memory* @routine_jl_.L_406252(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i8* %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 2, i32 9
...
define %struct.Memory* @routine_jmpq_.L_406281(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
...
define %struct.Memory* @routine_jge_.L_4062c8(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i8* %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 2, i32 9
...
define %struct.Memory* @routine_jmpq_.L_406292(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
...
define %struct.Memory* @routine_jne_.L_406292(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i8* %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
...
define %struct.Memory* @routine_jmpq_.L_4062c8(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
...
define %struct.Memory* @routine_jmpq_.L_40621f(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
