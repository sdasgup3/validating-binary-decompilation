...
block_.L_410cbf:                                  ; preds = %block_.L_410d61, %entry
  %68 = phi i64 [ %.pre, %entry ], [ %443, %block_.L_410d61 ]
...
block_.L_410d31:                                  ; preds = %block_.L_410d31, %block_410d2c
  %275 = phi i64 [ %274, %block_410d2c ], [ %398, %block_.L_410d31 ]
  %276 = phi i64 [ %237, %block_410d2c ], [ %363, %block_.L_410d31 ]
  ...
  %.v5 = select i1 %387, i64 12, i64 -31
  %398 = add i64 %365, %.v5
  store i64 %398, i64* %3, align 8
  br i1 %387, label %block_410d5c, label %block_.L_410d31
...
block_.L_410d61:                                  ; preds = %block_.L_410d20, %block_410d5c
  %400 = phi i64 [ %273, %block_.L_410d20 ], [ %399, %block_410d5c ]
  %401 = phi i64 [ %237, %block_.L_410d20 ], [ %363, %block_410d5c ]
  ...
  %call2_410d64 = tail call %struct.Memory* @sub_40c100._Z9check_sumIiEvT_(%struct.State* %0, i64 %407, %struct.Memory* %MEMORY.4)
...
block_.L_410d77:                                  ; preds = %block_.L_410cbf
  ...
  %call2_410d77 = tail call %struct.Memory* @sub_400df0._Z5timerv(%struct.State* %0, i64 %444, %struct.Memory* %MEMORY.0)
  ...
  %call2_410d80 = tail call %struct.Memory* @sub_400790._Z13record_resultdPKc(%struct.State* %0, i64 %455, %struct.Memory* %call2_410d77)
