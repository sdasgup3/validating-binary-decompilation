...
define %struct.Memory* @_Z26test_do_loop_unroll_factorILi15EdEvPKT0_iPKc(%struct.State* noalias, i64, %struct.Memory* noalias) #2 {
entry:
  ...
  store %struct.Memory* %loadMem1_406103, %struct.Memory** %MEMORY
...
block_.L_40610f:                                  ; preds = %block_.L_4061b8, %entry
  ...
  store %struct.Memory* %loadMem_406112, %struct.Memory** %MEMORY
...
block_40611f:                                     ; preds = %block_.L_40610f
  ...
  store %struct.Memory* %loadMem_406122, %struct.Memory** %MEMORY
...
block_40613d:                                     ; preds = %block_40611f
  ...
  store %struct.Memory* %loadMem_40613d, %struct.Memory** %MEMORY
  br label %block_.L_406142

block_.L_406142:                                  ; preds = %block_.L_406142, %block_40613d
  ...
  store %struct.Memory* %loadMem_406142, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_406146, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem1_40614d, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_406152, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_40615b, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_40615e, %struct.Memory** %MEMORY
...
block_40616c:                                     ; preds = %block_.L_406142
...
block_.L_406171:                                  ; preds = %block_40616c, %block_40611f
...
block_40617d:                                     ; preds = %block_.L_406171
  ...
  store %struct.Memory* %loadMem_40617d, %struct.Memory** %MEMORY
  br label %block_.L_406182

block_.L_406182:                                  ; preds = %block_.L_406182, %block_40617d
  ...
  store %struct.Memory* %loadMem1_40618f, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_406199, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_40619e, %struct.Memory** %MEMORY
...
block_4061b3:                                     ; preds = %block_.L_406182
...
block_.L_4061b8:                                  ; preds = %block_4061b3, %block_.L_406171
  ...
  store %struct.Memory* %loadMem1_4061bd, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_4061cb, %struct.Memory** %MEMORY
  br label %block_.L_40610f

block_.L_4061d0:                                  ; preds = %block_.L_40610f
  ...
  store %struct.Memory* %loadMem1_4061d0, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem1_4061d9, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_4061de, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_4061e3, %struct.Memory** %MEMORY
  ret %struct.Memory* %loadMem_4061e3
}
