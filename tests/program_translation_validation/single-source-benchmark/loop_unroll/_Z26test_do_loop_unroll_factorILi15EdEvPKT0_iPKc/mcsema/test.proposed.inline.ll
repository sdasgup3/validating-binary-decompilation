...
define %struct.Memory* @_Z26test_do_loop_unroll_factorILi15EdEvPKT0_iPKc(%struct.State* noalias, i64, %struct.Memory* noalias) #1 {
entry:
  ...
  store %struct.Memory* %loadMem1_4060f3, %struct.Memory** %MEMORY
...
block_.L_4060ff:                                  ; preds = %block_.L_4061a8, %entry
...
block_40610f:                                     ; preds = %block_.L_4060ff
...
block_40612d:                                     ; preds = %block_40610f
  ...
  store %struct.Memory* %loadMem_40612d, %struct.Memory** %MEMORY
  br label %block_.L_406132

block_.L_406132:                                  ; preds = %block_.L_406132, %block_40612d
  ...
  store %struct.Memory* %loadMem_406132, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_406136, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem1_40613d, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_406145, %struct.Memory** %MEMORY
...
block_40615c:                                     ; preds = %block_.L_406132
...
block_.L_406161:                                  ; preds = %block_40615c, %block_40610f
...
block_40616d:                                     ; preds = %block_.L_406161
...
block_.L_406172:                                  ; preds = %block_.L_406172, %block_40616d
  ...
  store %struct.Memory* %loadMem_406172, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_406176, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem1_40617f, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_40619d, %struct.Memory** %MEMORY
...
block_4061a3:                                     ; preds = %block_.L_406172
...
block_.L_4061a8:                                  ; preds = %block_4061a3, %block_.L_406161
  ...
  store %struct.Memory* %loadMem1_4061ad, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_4061bb, %struct.Memory** %MEMORY
  br label %block_.L_4060ff

block_.L_4061c0:                                  ; preds = %block_.L_4060ff
  ...
  store %struct.Memory* %loadMem1_4061c0, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem1_4061c9, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_4061d2, %struct.Memory** %MEMORY
  ...
  ret %struct.Memory* %loadMem_4061d3
}
