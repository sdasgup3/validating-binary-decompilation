...
entry:
  ...
  %call2_4060c3 = tail call %struct.Memory* @sub_400dd0._Z11start_timerv(%struct.State* %0, i64 %58, %struct.Memory* %2)
...
block_.L_4060cf:                                  ; preds = %block_.L_406178, %entry
  %79 = phi i64 [ %.pre, %entry ], [ %427, %block_.L_406178 ]
  %MEMORY.0 = phi %struct.Memory* [ %call2_4060c3, %entry ], [ %call2_40617d, %block_.L_406178 ]
  ...
  br i1 %112, label %block_4060df, label %block_.L_406190
...
block_4060df:                                     ; preds = %block_.L_4060cf
  ...
  br i1 %159, label %block_.L_406131, label %block_4060fd
...
block_.L_406102:                                  ; preds = %block_.L_406102, %block_4060fd
  %162 = phi i64 [ %161, %block_4060fd ], [ %247, %block_.L_406102 ]
  %163 = phi i64 [ %124, %block_4060fd ], [ %208, %block_.L_406102 ]
  %MEMORY.1 = phi %struct.Memory* [ %MEMORY.0, %block_4060fd ], [ %call2_40610d, %block_.L_406102 ]
  %164 = add i64 %163, -40
  ...
  %call2_40610d = tail call %struct.Memory* @sub_401bf0._ZN15loop_inner_bodyILi15EdE7do_workERdPKdi(%struct.State* %0, i64 %174, %struct.Memory* %MEMORY.1)
  ...
  br i1 %246, label %block_.L_406102, label %block_40612c
...
block_.L_406131:                                  ; preds = %block_40612c, %block_4060df
  %249 = phi i64 [ %160, %block_4060df ], [ %248, %block_40612c ]
  %250 = phi i64 [ %124, %block_4060df ], [ %208, %block_40612c ]
  %MEMORY.2 = phi %struct.Memory* [ %MEMORY.0, %block_4060df ], [ %call2_40610d, %block_40612c ]
  %251 = add i64 %250, -44
  %252 = add i64 %249, 3
  ...
  br i1 %285, label %block_40613d, label %block_.L_406178
...
block_.L_406142:                                  ; preds = %block_.L_406142, %block_40613d
  %288 = phi i64 [ %287, %block_40613d ], [ %383, %block_.L_406142 ]
  %289 = phi i64 [ %250, %block_40613d ], [ %348, %block_.L_406142 ]
  %MEMORY.3 = phi %struct.Memory* [ %MEMORY.2, %block_40613d ], [ %call2_40614f, %block_.L_406142 ]
  %290 = add i64 %289, -8
  %291 = add i64 %288, 4
  ...
  %call2_40614f = tail call %struct.Memory* @sub_401480._Z18complete_hash_funcIdET_S0_(%struct.State* %0, i64 %304, %struct.Memory* %MEMORY.3)
  ...
  br i1 %372, label %block_406173, label %block_.L_406142
...
block_.L_406178:                                  ; preds = %block_.L_406131, %block_406173
  %385 = phi i64 [ %286, %block_.L_406131 ], [ %384, %block_406173 ]
  %386 = phi i64 [ %250, %block_.L_406131 ], [ %348, %block_406173 ]
  %MEMORY.4 = phi %struct.Memory* [ %MEMORY.2, %block_.L_406131 ], [ %call2_40614f, %block_406173 ]
  %387 = add i64 %386, -40
  %388 = add i64 %385, 5
  ...
  %call2_40617d = tail call %struct.Memory* @sub_4014b0._Z9check_sumIdEvT_(%struct.State* %0, i64 %391, %struct.Memory* %MEMORY.4)
...
block_.L_406190:                                  ; preds = %block_.L_4060cf
  ...
  %call2_406190 = tail call %struct.Memory* @sub_400df0._Z5timerv(%struct.State* %0, i64 %428, %struct.Memory* %MEMORY.0)
  ...
  %call2_406199 = tail call %struct.Memory* @sub_400790._Z13record_resultdPKc(%struct.State* %0, i64 %439, %struct.Memory* %call2_406190)
  ...
  ret %struct.Memory* %call2_406199
}
...
define %struct.Memory* @routine_jge_.L_406190(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i8* %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
...
define %struct.Memory* @routine_jl_.L_406131(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i8* %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 2, i32 9
...
define %struct.Memory* @routine_jmpq_.L_406102(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
...
define %struct.Memory* @routine_jl_.L_406102(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i8* %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 2, i32 9
...
define %struct.Memory* @routine_jmpq_.L_406131(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
...
define %struct.Memory* @routine_jge_.L_406178(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i8* %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 2, i32 9
...
define %struct.Memory* @routine_jmpq_.L_406142(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
...
define %struct.Memory* @routine_jne_.L_406142(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i8* %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
...
define %struct.Memory* @routine_jmpq_.L_406178(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
...
define %struct.Memory* @routine_jmpq_.L_4060cf(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
