...
block_.L_410b7f:                                  ; preds = %block_.L_410c21, %entry
  %68 = phi i64 [ %.pre, %entry ], [ %443, %block_.L_410c21 ]
...
block_.L_410bf1:                                  ; preds = %block_.L_410bf1, %block_410bec
  %275 = phi i64 [ %274, %block_410bec ], [ %398, %block_.L_410bf1 ]
  %276 = phi i64 [ %237, %block_410bec ], [ %363, %block_.L_410bf1 ]
  ...
  br i1 %387, label %block_410c1c, label %block_.L_410bf1
...
block_.L_410c21:                                  ; preds = %block_.L_410be0, %block_410c1c
  %400 = phi i64 [ %273, %block_.L_410be0 ], [ %399, %block_410c1c ]
  %401 = phi i64 [ %237, %block_.L_410be0 ], [ %363, %block_410c1c ]
  ...
  %call2_410c24 = tail call %struct.Memory* @sub_40c100._Z9check_sumIiEvT_(%struct.State* %0, i64 %407, %struct.Memory* %MEMORY.4)
...
block_.L_410c37:                                  ; preds = %block_.L_410b7f
  ...
  %call2_410c37 = tail call %struct.Memory* @sub_400df0._Z5timerv(%struct.State* %0, i64 %444, %struct.Memory* %MEMORY.0)
  ...
  %call2_410c40 = tail call %struct.Memory* @sub_400790._Z13record_resultdPKc(%struct.State* %0, i64 %455, %struct.Memory* %call2_410c37)
