...
block_.L_405f7f:                                  ; preds = %block_.L_406028, %entry
  %79 = phi i64 [ %.pre, %entry ], [ %433, %block_.L_406028 ]
...
block_.L_405ff2:                                  ; preds = %block_.L_405ff2, %block_405fed
  %290 = phi i64 [ %289, %block_405fed ], [ %387, %block_.L_405ff2 ]
  %291 = phi i64 [ %252, %block_405fed ], [ %352, %block_.L_405ff2 ]
  ...
  %call2_405fff = tail call %struct.Memory* @sub_401480._Z18complete_hash_funcIdET_S0_(%struct.State* %0, i64 %307, %struct.Memory* %MEMORY.3)
  ...
  br i1 %376, label %block_406023, label %block_.L_405ff2
...
block_.L_406028:                                  ; preds = %block_.L_405fe1, %block_406023
  %389 = phi i64 [ %288, %block_.L_405fe1 ], [ %388, %block_406023 ]
  %390 = phi i64 [ %252, %block_.L_405fe1 ], [ %352, %block_406023 ]
  ...
  %call2_40602d = tail call %struct.Memory* @sub_4014b0._Z9check_sumIdEvT_(%struct.State* %0, i64 %396, %struct.Memory* %MEMORY.4)
...
block_.L_406040:                                  ; preds = %block_.L_405f7f
  ...
  %call2_406040 = tail call %struct.Memory* @sub_400df0._Z5timerv(%struct.State* %0, i64 %434, %struct.Memory* %MEMORY.0)
  ...
  %call2_406049 = tail call %struct.Memory* @sub_400790._Z13record_resultdPKc(%struct.State* %0, i64 %445, %struct.Memory* %call2_406040)
