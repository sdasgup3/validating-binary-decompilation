...
declare %struct.Memory* @sub_401b90._ZN15loop_inner_bodyILi16EdE7do_workERdPKdi(%struct.State* noalias dereferenceable(3376), i64, %struct.Memory* noalias readnone returned) local_unnamed_addr
...
entry:
  ...
  %call2_405f73 = tail call %struct.Memory* @sub_400dd0._Z11start_timerv(%struct.State* %0, i64 %58, %struct.Memory* %2)
...
block_.L_405f7f:                                  ; preds = %block_.L_406028, %entry
  %79 = phi i64 [ %.pre, %entry ], [ %429, %block_.L_406028 ]
  %MEMORY.0 = phi %struct.Memory* [ %call2_405f73, %entry ], [ %call2_40602d, %block_.L_406028 ]
  ...
  br i1 %112, label %block_405f8f, label %block_.L_406040
...
block_405f8f:                                     ; preds = %block_.L_405f7f
  ...
  br i1 %160, label %block_.L_405fe1, label %block_405fad
...
block_.L_405fb2:                                  ; preds = %block_.L_405fb2, %block_405fad
  %163 = phi i64 [ %162, %block_405fad ], [ %249, %block_.L_405fb2 ]
  %164 = phi i64 [ %124, %block_405fad ], [ %210, %block_.L_405fb2 ]
  %MEMORY.1 = phi %struct.Memory* [ %MEMORY.0, %block_405fad ], [ %call2_405fbd, %block_.L_405fb2 ]
  %165 = add i64 %164, -40
  ...
  %call2_405fbd = tail call %struct.Memory* @sub_401b90._ZN15loop_inner_bodyILi16EdE7do_workERdPKdi(%struct.State* %0, i64 %175, %struct.Memory* %MEMORY.1)
  ...
  br i1 %248, label %block_.L_405fb2, label %block_405fdc
...
block_.L_405fe1:                                  ; preds = %block_405fdc, %block_405f8f
  %251 = phi i64 [ %161, %block_405f8f ], [ %250, %block_405fdc ]
  %252 = phi i64 [ %124, %block_405f8f ], [ %210, %block_405fdc ]
  %MEMORY.2 = phi %struct.Memory* [ %MEMORY.0, %block_405f8f ], [ %call2_405fbd, %block_405fdc ]
  %253 = add i64 %252, -44
  %254 = add i64 %251, 3
  ...
  br i1 %287, label %block_405fed, label %block_.L_406028
...
block_.L_405ff2:                                  ; preds = %block_.L_405ff2, %block_405fed
  %290 = phi i64 [ %289, %block_405fed ], [ %385, %block_.L_405ff2 ]
  %291 = phi i64 [ %252, %block_405fed ], [ %350, %block_.L_405ff2 ]
  %MEMORY.3 = phi %struct.Memory* [ %MEMORY.2, %block_405fed ], [ %call2_405fff, %block_.L_405ff2 ]
  %292 = add i64 %291, -8
  %293 = add i64 %290, 4
  ...
  %call2_405fff = tail call %struct.Memory* @sub_401480._Z18complete_hash_funcIdET_S0_(%struct.State* %0, i64 %306, %struct.Memory* %MEMORY.3)
  ...
  br i1 %374, label %block_406023, label %block_.L_405ff2
...
block_.L_406028:                                  ; preds = %block_.L_405fe1, %block_406023
  %387 = phi i64 [ %288, %block_.L_405fe1 ], [ %386, %block_406023 ]
  %388 = phi i64 [ %252, %block_.L_405fe1 ], [ %350, %block_406023 ]
  %MEMORY.4 = phi %struct.Memory* [ %MEMORY.2, %block_.L_405fe1 ], [ %call2_405fff, %block_406023 ]
  %389 = add i64 %388, -40
  %390 = add i64 %387, 5
  ...
  %call2_40602d = tail call %struct.Memory* @sub_4014b0._Z9check_sumIdEvT_(%struct.State* %0, i64 %393, %struct.Memory* %MEMORY.4)
...
block_.L_406040:                                  ; preds = %block_.L_405f7f
  ...
  %call2_406040 = tail call %struct.Memory* @sub_400df0._Z5timerv(%struct.State* %0, i64 %430, %struct.Memory* %MEMORY.0)
  ...
  %call2_406049 = tail call %struct.Memory* @sub_400790._Z13record_resultdPKc(%struct.State* %0, i64 %441, %struct.Memory* %call2_406040)
  ...
  ret %struct.Memory* %call2_406049
}
...
define %struct.Memory* @routine_jge_.L_406040(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i8* %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
...
define %struct.Memory* @routine_jl_.L_405fe1(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i8* %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 2, i32 9
...
define %struct.Memory* @routine_jmpq_.L_405fb2(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
...
define %struct.Memory* @routine_callq_._ZN15loop_inner_bodyILi16EdE7do_workERdPKdi(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
...
define %struct.Memory* @routine_jl_.L_405fb2(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i8* %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 2, i32 9
...
define %struct.Memory* @routine_jmpq_.L_405fe1(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
...
define %struct.Memory* @routine_jge_.L_406028(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i8* %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 2, i32 9
...
define %struct.Memory* @routine_jmpq_.L_405ff2(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
...
define %struct.Memory* @routine_jne_.L_405ff2(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i8* %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
...
define %struct.Memory* @routine_jmpq_.L_406028(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
...
define %struct.Memory* @routine_jmpq_.L_405f7f(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
