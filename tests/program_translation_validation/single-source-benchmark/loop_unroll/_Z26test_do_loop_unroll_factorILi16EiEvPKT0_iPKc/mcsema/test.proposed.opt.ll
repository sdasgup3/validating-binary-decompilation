...
entry:
  ...
  %call2_410a33 = tail call %struct.Memory* @sub_400dd0._Z11start_timerv(%struct.State* %0, i64 %58, %struct.Memory* %2)
...
block_.L_410a3f:                                  ; preds = %block_.L_410ae1, %entry
  %68 = phi i64 [ %.pre, %entry ], [ %447, %block_.L_410ae1 ]
  %MEMORY.0 = phi %struct.Memory* [ %call2_410a33, %entry ], [ %call2_410ae4, %block_.L_410ae1 ]
  ...
  br i1 %101, label %block_410a4f, label %block_.L_410af7

block_410a4f:                                     ; preds = %block_.L_410a3f
  %103 = add i64 %69, -32
  %104 = add i64 %102, 7
  ...
  br i1 %147, label %block_.L_410aa0, label %block_410a6c

block_410a6c:                                     ; preds = %block_410a4f
  %149 = add i64 %148, 5
  store i64 %149, i64* %3, align 8
  br label %block_.L_410a71

block_.L_410a71:                                  ; preds = %block_.L_410a71, %block_410a6c
  %150 = phi i64 [ %149, %block_410a6c ], [ %236, %block_.L_410a71 ]
  %151 = phi i64 [ %111, %block_410a6c ], [ %197, %block_.L_410a71 ]
  %MEMORY.1 = phi %struct.Memory* [ %MEMORY.0, %block_410a6c ], [ %call2_410a7c, %block_.L_410a71 ]
  %152 = add i64 %151, -32
  ...
  %call2_410a7c = tail call %struct.Memory* @sub_40c750._ZN15loop_inner_bodyILi16EiE7do_workERiPKii(%struct.State* %0, i64 %162, %struct.Memory* %MEMORY.1)
  ...
  br i1 %235, label %block_.L_410a71, label %block_410a9b

block_410a9b:                                     ; preds = %block_.L_410a71
  %237 = add i64 %236, 5
  store i64 %237, i64* %3, align 8
  br label %block_.L_410aa0

block_.L_410aa0:                                  ; preds = %block_410a9b, %block_410a4f
  %238 = phi i64 [ %148, %block_410a4f ], [ %237, %block_410a9b ]
  %239 = phi i64 [ %111, %block_410a4f ], [ %197, %block_410a9b ]
  %MEMORY.2 = phi %struct.Memory* [ %MEMORY.0, %block_410a4f ], [ %call2_410a7c, %block_410a9b ]
  %240 = add i64 %239, -36
  %241 = add i64 %238, 3
  ...
  br i1 %274, label %block_410aac, label %block_.L_410ae1

block_410aac:                                     ; preds = %block_.L_410aa0
  %276 = add i64 %275, 5
  store i64 %276, i64* %3, align 8
  br label %block_.L_410ab1

block_.L_410ab1:                                  ; preds = %block_.L_410ab1, %block_410aac
  %277 = phi i64 [ %276, %block_410aac ], [ %401, %block_.L_410ab1 ]
  %278 = phi i64 [ %239, %block_410aac ], [ %366, %block_.L_410ab1 ]
  %MEMORY.3 = phi %struct.Memory* [ %MEMORY.2, %block_410aac ], [ %call2_410abc, %block_.L_410ab1 ]
  %279 = add i64 %278, -8
  %280 = add i64 %277, 4
  ...
  %call2_410abc = tail call %struct.Memory* @sub_40c0d0._Z18complete_hash_funcIiET_S0_(%struct.State* %0, i64 %294, %struct.Memory* %MEMORY.3)
  ...
  br i1 %390, label %block_410adc, label %block_.L_410ab1

block_410adc:                                     ; preds = %block_.L_410ab1
  %402 = add i64 %401, 5
  store i64 %402, i64* %3, align 8
  br label %block_.L_410ae1

block_.L_410ae1:                                  ; preds = %block_.L_410aa0, %block_410adc
  %403 = phi i64 [ %275, %block_.L_410aa0 ], [ %402, %block_410adc ]
  %404 = phi i64 [ %239, %block_.L_410aa0 ], [ %366, %block_410adc ]
  %MEMORY.4 = phi %struct.Memory* [ %MEMORY.2, %block_.L_410aa0 ], [ %call2_410abc, %block_410adc ]
  %405 = add i64 %404, -32
  %406 = add i64 %403, 3
  ...
  %call2_410ae4 = tail call %struct.Memory* @sub_40c100._Z9check_sumIiEvT_(%struct.State* %0, i64 %410, %struct.Memory* %MEMORY.4)
...
block_.L_410af7:                                  ; preds = %block_.L_410a3f
  %448 = add i64 %102, -64775
  %449 = add i64 %102, 5
  ...
  %call2_410af7 = tail call %struct.Memory* @sub_400df0._Z5timerv(%struct.State* %0, i64 %448, %struct.Memory* %MEMORY.0)
  ...
  %call2_410b00 = tail call %struct.Memory* @sub_400790._Z13record_resultdPKc(%struct.State* %0, i64 %459, %struct.Memory* %call2_410af7)
  ...
  ret %struct.Memory* %call2_410b00
}
...
define %struct.Memory* @routine_jge_.L_410af7(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i8* %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
...
define %struct.Memory* @routine_jl_.L_410aa0(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i8* %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 2, i32 9
...
define %struct.Memory* @routine_jmpq_.L_410a71(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
...
define %struct.Memory* @routine_subl__0xf___ecx(%struct.State* dereferenceable(3376), i64, %struct.Memory*) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %RCX = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 5, i32 0, i32 0
...
define %struct.Memory* @routine_jl_.L_410a71(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i8* %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 2, i32 9
...
define %struct.Memory* @routine_jmpq_.L_410aa0(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
...
define %struct.Memory* @routine_jge_.L_410ae1(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i8* %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 2, i32 9
...
define %struct.Memory* @routine_jmpq_.L_410ab1(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
...
define %struct.Memory* @routine_jne_.L_410ab1(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i8* %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
...
define %struct.Memory* @routine_jmpq_.L_410ae1(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
...
define %struct.Memory* @routine_jmpq_.L_410a3f(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
