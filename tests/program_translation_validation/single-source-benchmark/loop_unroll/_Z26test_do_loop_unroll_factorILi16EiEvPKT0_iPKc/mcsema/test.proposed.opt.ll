...
block_.L_410a3f:                                  ; preds = %block_.L_410ae1, %entry
  %68 = phi i64 [ %.pre, %entry ], [ %445, %block_.L_410ae1 ]
...
block_.L_410ab1:                                  ; preds = %block_.L_410ab1, %block_410aac
  %277 = phi i64 [ %276, %block_410aac ], [ %400, %block_.L_410ab1 ]
  %278 = phi i64 [ %239, %block_410aac ], [ %365, %block_.L_410ab1 ]
  ...
  br i1 %389, label %block_410adc, label %block_.L_410ab1
...
block_.L_410ae1:                                  ; preds = %block_.L_410aa0, %block_410adc
  %402 = phi i64 [ %275, %block_.L_410aa0 ], [ %401, %block_410adc ]
  %403 = phi i64 [ %239, %block_.L_410aa0 ], [ %365, %block_410adc ]
  ...
  %call2_410ae4 = tail call %struct.Memory* @sub_40c100._Z9check_sumIiEvT_(%struct.State* %0, i64 %409, %struct.Memory* %MEMORY.4)
...
block_.L_410af7:                                  ; preds = %block_.L_410a3f
  ...
  %call2_410af7 = tail call %struct.Memory* @sub_400df0._Z5timerv(%struct.State* %0, i64 %446, %struct.Memory* %MEMORY.0)
  ...
  %call2_410b00 = tail call %struct.Memory* @sub_400790._Z13record_resultdPKc(%struct.State* %0, i64 %457, %struct.Memory* %call2_410af7)
