...
define %struct.Memory* @_Z26test_do_loop_unroll_factorILi17EdEvPKT0_iPKc(%struct.State* noalias, i64, %struct.Memory* noalias) local_unnamed_addr #1 {
entry:
  ...
  %call2_405e23 = tail call %struct.Memory* @sub_400dd0._Z11start_timerv(%struct.State* %0, i64 %58, %struct.Memory* %2)
...
block_.L_405e2f:                                  ; preds = %block_.L_405ed8, %entry
  %79 = phi i64 [ %.pre, %entry ], [ %429, %block_.L_405ed8 ]
  %MEMORY.0 = phi %struct.Memory* [ %call2_405e23, %entry ], [ %call2_405edd, %block_.L_405ed8 ]
  ...
  br i1 %112, label %block_405e3f, label %block_.L_405ef0
...
block_405e3f:                                     ; preds = %block_.L_405e2f
  ...
  br i1 %160, label %block_.L_405e91, label %block_405e5d
...
block_.L_405e62:                                  ; preds = %block_.L_405e62, %block_405e5d
  %163 = phi i64 [ %162, %block_405e5d ], [ %249, %block_.L_405e62 ]
  %164 = phi i64 [ %124, %block_405e5d ], [ %210, %block_.L_405e62 ]
  %MEMORY.1 = phi %struct.Memory* [ %MEMORY.0, %block_405e5d ], [ %call2_405e6d, %block_.L_405e62 ]
  %165 = add i64 %164, -40
  ...
  %call2_405e6d = tail call %struct.Memory* @sub_401b30._ZN15loop_inner_bodyILi17EdE7do_workERdPKdi(%struct.State* %0, i64 %175, %struct.Memory* %MEMORY.1)
  ...
  br i1 %248, label %block_.L_405e62, label %block_405e8c
...
block_.L_405e91:                                  ; preds = %block_405e8c, %block_405e3f
  %251 = phi i64 [ %161, %block_405e3f ], [ %250, %block_405e8c ]
  %252 = phi i64 [ %124, %block_405e3f ], [ %210, %block_405e8c ]
  %MEMORY.2 = phi %struct.Memory* [ %MEMORY.0, %block_405e3f ], [ %call2_405e6d, %block_405e8c ]
  %253 = add i64 %252, -44
  %254 = add i64 %251, 3
  ...
  br i1 %287, label %block_405e9d, label %block_.L_405ed8
...
block_.L_405ea2:                                  ; preds = %block_.L_405ea2, %block_405e9d
  %290 = phi i64 [ %289, %block_405e9d ], [ %385, %block_.L_405ea2 ]
  %291 = phi i64 [ %252, %block_405e9d ], [ %350, %block_.L_405ea2 ]
  %MEMORY.3 = phi %struct.Memory* [ %MEMORY.2, %block_405e9d ], [ %call2_405eaf, %block_.L_405ea2 ]
  %292 = add i64 %291, -8
  %293 = add i64 %290, 4
  ...
  %call2_405eaf = tail call %struct.Memory* @sub_401480._Z18complete_hash_funcIdET_S0_(%struct.State* %0, i64 %306, %struct.Memory* %MEMORY.3)
  ...
  br i1 %374, label %block_405ed3, label %block_.L_405ea2
...
block_.L_405ed8:                                  ; preds = %block_.L_405e91, %block_405ed3
  %387 = phi i64 [ %288, %block_.L_405e91 ], [ %386, %block_405ed3 ]
  %388 = phi i64 [ %252, %block_.L_405e91 ], [ %350, %block_405ed3 ]
  %MEMORY.4 = phi %struct.Memory* [ %MEMORY.2, %block_.L_405e91 ], [ %call2_405eaf, %block_405ed3 ]
  %389 = add i64 %388, -40
  %390 = add i64 %387, 5
  ...
  %call2_405edd = tail call %struct.Memory* @sub_4014b0._Z9check_sumIdEvT_(%struct.State* %0, i64 %393, %struct.Memory* %MEMORY.4)
...
block_.L_405ef0:                                  ; preds = %block_.L_405e2f
  ...
  %call2_405ef0 = tail call %struct.Memory* @sub_400df0._Z5timerv(%struct.State* %0, i64 %430, %struct.Memory* %MEMORY.0)
  ...
  %call2_405ef9 = tail call %struct.Memory* @sub_400790._Z13record_resultdPKc(%struct.State* %0, i64 %441, %struct.Memory* %call2_405ef0)
  ...
  ret %struct.Memory* %call2_405ef9
}
...
define %struct.Memory* @routine_jge_.L_405ef0(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i8* %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
...
define %struct.Memory* @routine_jl_.L_405e91(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i8* %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 2, i32 9
...
define %struct.Memory* @routine_jmpq_.L_405e62(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
...
define %struct.Memory* @routine_jl_.L_405e62(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i8* %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 2, i32 9
...
define %struct.Memory* @routine_jmpq_.L_405e91(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
...
define %struct.Memory* @routine_jge_.L_405ed8(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i8* %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 2, i32 9
...
define %struct.Memory* @routine_jmpq_.L_405ea2(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
...
define %struct.Memory* @routine_jne_.L_405ea2(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i8* %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
...
define %struct.Memory* @routine_jmpq_.L_405ed8(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
...
define %struct.Memory* @routine_jmpq_.L_405e2f(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
