...
entry:
  ...
  %call2_405e63 = tail call %struct.Memory* @sub_400e10._Z11start_timerv(%struct.State* %0, i64 %58, %struct.Memory* %2)
...
block_.L_405e6f:                                  ; preds = %block_.L_405f18, %entry
  %74 = phi i64 [ %.pre, %entry ], [ %424, %block_.L_405f18 ]
  %MEMORY.0 = phi %struct.Memory* [ %call2_405e63, %entry ], [ %call2_405f1d, %block_.L_405f18 ]
  ...
  br i1 %107, label %block_405e7f, label %block_.L_405f30
...
block_405e7f:                                     ; preds = %block_.L_405e6f
  ...
  br i1 %154, label %block_.L_405ed1, label %block_405e9d
...
block_.L_405ea2:                                  ; preds = %block_.L_405ea2, %block_405e9d
  %157 = phi i64 [ %243, %block_.L_405ea2 ], [ %156, %block_405e9d ]
  %158 = phi i64 [ %204, %block_.L_405ea2 ], [ %118, %block_405e9d ]
  %159 = add i64 %158, -40
  ...
  %call2_405ead = tail call %struct.Memory* @sub_401b70._ZN15loop_inner_bodyILi17EdE7do_workERdPKdi(%struct.State* nonnull %0, i64 %169, %struct.Memory* %MEMORY.0)
  ...
  br i1 %242, label %block_.L_405ea2, label %block_405ecc
...
block_.L_405ed1:                                  ; preds = %block_405ecc, %block_405e7f
  %245 = phi i64 [ %244, %block_405ecc ], [ %155, %block_405e7f ]
  %246 = phi i64 [ %204, %block_405ecc ], [ %118, %block_405e7f ]
  %247 = add i64 %246, -44
  %248 = add i64 %245, 3
  ...
  br i1 %281, label %block_405edd, label %block_.L_405f18
...
block_.L_405ee2:                                  ; preds = %block_.L_405ee2, %block_405edd
  %284 = phi i64 [ %380, %block_.L_405ee2 ], [ %283, %block_405edd ]
  %285 = phi i64 [ %345, %block_.L_405ee2 ], [ %246, %block_405edd ]
  %286 = add i64 %285, -8
  %287 = add i64 %284, 4
  ...
  %call2_405eef = tail call %struct.Memory* @sub_4014c0._Z18complete_hash_funcIdET_S0_(%struct.State* nonnull %0, i64 %300, %struct.Memory* %MEMORY.0)
  ...
  br i1 %369, label %block_405f13, label %block_.L_405ee2
...
block_.L_405f18:                                  ; preds = %block_.L_405ed1, %block_405f13
  %382 = phi i64 [ %282, %block_.L_405ed1 ], [ %381, %block_405f13 ]
  %383 = phi i64 [ %246, %block_.L_405ed1 ], [ %345, %block_405f13 ]
  %384 = add i64 %383, -40
  %385 = add i64 %382, 5
  ...
  %call2_405f1d = tail call %struct.Memory* @sub_4014f0._Z9check_sumIdEvT_(%struct.State* nonnull %0, i64 %388, %struct.Memory* %MEMORY.0)
...
block_.L_405f30:                                  ; preds = %block_.L_405e6f
  ...
  %call2_405f30 = tail call %struct.Memory* @sub_400e30._Z5timerv(%struct.State* nonnull %0, i64 %425, %struct.Memory* %MEMORY.0)
  ...
  %call2_405f39 = tail call %struct.Memory* @sub_4007d0._Z13record_resultdPKc(%struct.State* nonnull %0, i64 %436, %struct.Memory* %call2_405f30)
