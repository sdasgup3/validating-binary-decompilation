...
define %struct.Memory* @_Z26test_do_loop_unroll_factorILi17EiEvPKT0_iPKc(%struct.State* noalias, i64, %struct.Memory* noalias readnone) local_unnamed_addr #1 {
entry:
  ...
  %call2_410933 = tail call %struct.Memory* @sub_400e10._Z11start_timerv(%struct.State* %0, i64 %58, %struct.Memory* %2)
...
block_.L_41093f:                                  ; preds = %block_.L_4109e1, %entry
  %68 = phi i64 [ %.pre, %entry ], [ %445, %block_.L_4109e1 ]
  %MEMORY.0 = phi %struct.Memory* [ %call2_410933, %entry ], [ %call2_4109e4, %block_.L_4109e1 ]
  ...
  br i1 %101, label %block_41094f, label %block_.L_4109f7
...
block_41094f:                                     ; preds = %block_.L_41093f
  ...
  br i1 %147, label %block_.L_4109a0, label %block_41096c
...
block_.L_410971:                                  ; preds = %block_.L_410971, %block_41096c
  %150 = phi i64 [ %236, %block_.L_410971 ], [ %149, %block_41096c ]
  %151 = phi i64 [ %197, %block_.L_410971 ], [ %111, %block_41096c ]
  %152 = add i64 %151, -32
  ...
  %call2_41097c = tail call %struct.Memory* @sub_40c730._ZN15loop_inner_bodyILi17EiE7do_workERiPKii(%struct.State* nonnull %0, i64 %162, %struct.Memory* %MEMORY.0)
  ...
  br i1 %235, label %block_.L_410971, label %block_41099b
...
block_.L_4109a0:                                  ; preds = %block_41099b, %block_41094f
  %238 = phi i64 [ %237, %block_41099b ], [ %148, %block_41094f ]
  %239 = phi i64 [ %197, %block_41099b ], [ %111, %block_41094f ]
  %240 = add i64 %239, -36
  %241 = add i64 %238, 3
  ...
  br i1 %274, label %block_4109ac, label %block_.L_4109e1
...
block_.L_4109b1:                                  ; preds = %block_.L_4109b1, %block_4109ac
  %277 = phi i64 [ %400, %block_.L_4109b1 ], [ %276, %block_4109ac ]
  %278 = phi i64 [ %365, %block_.L_4109b1 ], [ %239, %block_4109ac ]
  %279 = add i64 %278, -8
  %280 = add i64 %277, 4
  ...
  %call2_4109bc = tail call %struct.Memory* @sub_40c110._Z18complete_hash_funcIiET_S0_(%struct.State* nonnull %0, i64 %294, %struct.Memory* %MEMORY.0)
  ...
  br i1 %389, label %block_4109dc, label %block_.L_4109b1
...
block_.L_4109e1:                                  ; preds = %block_.L_4109a0, %block_4109dc
  %402 = phi i64 [ %275, %block_.L_4109a0 ], [ %401, %block_4109dc ]
  %403 = phi i64 [ %239, %block_.L_4109a0 ], [ %365, %block_4109dc ]
  %404 = add i64 %403, -32
  %405 = add i64 %402, 3
  ...
  %call2_4109e4 = tail call %struct.Memory* @sub_40c140._Z9check_sumIiEvT_(%struct.State* nonnull %0, i64 %409, %struct.Memory* %MEMORY.0)
...
block_.L_4109f7:                                  ; preds = %block_.L_41093f
  ...
  %call2_4109f7 = tail call %struct.Memory* @sub_400e30._Z5timerv(%struct.State* nonnull %0, i64 %446, %struct.Memory* %MEMORY.0)
  ...
  %call2_410a00 = tail call %struct.Memory* @sub_4007d0._Z13record_resultdPKc(%struct.State* nonnull %0, i64 %457, %struct.Memory* %call2_4109f7)
