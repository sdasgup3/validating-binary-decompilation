...
entry:
  ...
  %call2_4108f3 = tail call %struct.Memory* @sub_400dd0._Z11start_timerv(%struct.State* %0, i64 %58, %struct.Memory* %2)
...
block_.L_4108ff:                                  ; preds = %block_.L_4109a1, %entry
  %68 = phi i64 [ %.pre, %entry ], [ %447, %block_.L_4109a1 ]
  %MEMORY.0 = phi %struct.Memory* [ %call2_4108f3, %entry ], [ %call2_4109a4, %block_.L_4109a1 ]
  ...
  br i1 %101, label %block_41090f, label %block_.L_4109b7
...
block_41090f:                                     ; preds = %block_.L_4108ff
  ...
  br i1 %147, label %block_.L_410960, label %block_41092c
...
block_.L_410931:                                  ; preds = %block_.L_410931, %block_41092c
  %150 = phi i64 [ %149, %block_41092c ], [ %236, %block_.L_410931 ]
  %151 = phi i64 [ %111, %block_41092c ], [ %197, %block_.L_410931 ]
  %MEMORY.1 = phi %struct.Memory* [ %MEMORY.0, %block_41092c ], [ %call2_41093c, %block_.L_410931 ]
  %152 = add i64 %151, -32
  ...
  %call2_41093c = tail call %struct.Memory* @sub_40c6f0._ZN15loop_inner_bodyILi17EiE7do_workERiPKii(%struct.State* %0, i64 %162, %struct.Memory* %MEMORY.1)
  ...
  br i1 %235, label %block_.L_410931, label %block_41095b
...
block_.L_410960:                                  ; preds = %block_41095b, %block_41090f
  %238 = phi i64 [ %148, %block_41090f ], [ %237, %block_41095b ]
  %239 = phi i64 [ %111, %block_41090f ], [ %197, %block_41095b ]
  %MEMORY.2 = phi %struct.Memory* [ %MEMORY.0, %block_41090f ], [ %call2_41093c, %block_41095b ]
  %240 = add i64 %239, -36
  %241 = add i64 %238, 3
  ...
  br i1 %274, label %block_41096c, label %block_.L_4109a1
...
block_.L_410971:                                  ; preds = %block_.L_410971, %block_41096c
  %277 = phi i64 [ %276, %block_41096c ], [ %401, %block_.L_410971 ]
  %278 = phi i64 [ %239, %block_41096c ], [ %366, %block_.L_410971 ]
  %MEMORY.3 = phi %struct.Memory* [ %MEMORY.2, %block_41096c ], [ %call2_41097c, %block_.L_410971 ]
  %279 = add i64 %278, -8
  %280 = add i64 %277, 4
  ...
  %call2_41097c = tail call %struct.Memory* @sub_40c0d0._Z18complete_hash_funcIiET_S0_(%struct.State* %0, i64 %294, %struct.Memory* %MEMORY.3)
  ...
  br i1 %390, label %block_41099c, label %block_.L_410971
...
block_.L_4109a1:                                  ; preds = %block_.L_410960, %block_41099c
  %403 = phi i64 [ %275, %block_.L_410960 ], [ %402, %block_41099c ]
  %404 = phi i64 [ %239, %block_.L_410960 ], [ %366, %block_41099c ]
  %MEMORY.4 = phi %struct.Memory* [ %MEMORY.2, %block_.L_410960 ], [ %call2_41097c, %block_41099c ]
  %405 = add i64 %404, -32
  %406 = add i64 %403, 3
  ...
  %call2_4109a4 = tail call %struct.Memory* @sub_40c100._Z9check_sumIiEvT_(%struct.State* %0, i64 %410, %struct.Memory* %MEMORY.4)
...
block_.L_4109b7:                                  ; preds = %block_.L_4108ff
  ...
  %call2_4109b7 = tail call %struct.Memory* @sub_400df0._Z5timerv(%struct.State* %0, i64 %448, %struct.Memory* %MEMORY.0)
  ...
  %call2_4109c0 = tail call %struct.Memory* @sub_400790._Z13record_resultdPKc(%struct.State* %0, i64 %459, %struct.Memory* %call2_4109b7)
  ...
  ret %struct.Memory* %call2_4109c0
}
...
define %struct.Memory* @routine_jge_.L_4109b7(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i8* %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
...
define %struct.Memory* @routine_jl_.L_410960(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i8* %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 2, i32 9
...
define %struct.Memory* @routine_jmpq_.L_410931(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
...
define %struct.Memory* @routine_jl_.L_410931(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i8* %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 2, i32 9
...
define %struct.Memory* @routine_jmpq_.L_410960(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
...
define %struct.Memory* @routine_jge_.L_4109a1(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i8* %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 2, i32 9
...
define %struct.Memory* @routine_jmpq_.L_410971(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
...
define %struct.Memory* @routine_jne_.L_410971(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i8* %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
...
define %struct.Memory* @routine_jmpq_.L_4109a1(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
...
define %struct.Memory* @routine_jmpq_.L_4108ff(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
