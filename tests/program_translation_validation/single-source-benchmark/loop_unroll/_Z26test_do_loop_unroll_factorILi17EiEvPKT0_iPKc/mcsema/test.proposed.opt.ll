...
block_.L_4108ff:                                  ; preds = %block_.L_4109a1, %entry
  %68 = phi i64 [ %.pre, %entry ], [ %445, %block_.L_4109a1 ]
...
block_.L_410971:                                  ; preds = %block_.L_410971, %block_41096c
  %277 = phi i64 [ %276, %block_41096c ], [ %400, %block_.L_410971 ]
  %278 = phi i64 [ %239, %block_41096c ], [ %365, %block_.L_410971 ]
  ...
  br i1 %389, label %block_41099c, label %block_.L_410971
...
block_.L_4109a1:                                  ; preds = %block_.L_410960, %block_41099c
  %402 = phi i64 [ %275, %block_.L_410960 ], [ %401, %block_41099c ]
  %403 = phi i64 [ %239, %block_.L_410960 ], [ %365, %block_41099c ]
  ...
  %call2_4109a4 = tail call %struct.Memory* @sub_40c100._Z9check_sumIiEvT_(%struct.State* %0, i64 %409, %struct.Memory* %MEMORY.4)
...
block_.L_4109b7:                                  ; preds = %block_.L_4108ff
  ...
  %call2_4109b7 = tail call %struct.Memory* @sub_400df0._Z5timerv(%struct.State* %0, i64 %446, %struct.Memory* %MEMORY.0)
  ...
  %call2_4109c0 = tail call %struct.Memory* @sub_400790._Z13record_resultdPKc(%struct.State* %0, i64 %457, %struct.Memory* %call2_4109b7)
