...
define %struct.Memory* @_Z26test_do_loop_unroll_factorILi17EiEvPKT0_iPKc(%struct.State* noalias, i64, %struct.Memory* noalias) local_unnamed_addr #1 {
entry:
  ...
  %call2_410923 = tail call %struct.Memory* @sub_400e00._Z11start_timerv(%struct.State* %0, i64 %58, %struct.Memory* %2)
...
block_.L_41092f:                                  ; preds = %block_.L_4109d1, %entry
  %68 = phi i64 [ %.pre, %entry ], [ %445, %block_.L_4109d1 ]
  %MEMORY.0 = phi %struct.Memory* [ %call2_410923, %entry ], [ %call2_4109d4, %block_.L_4109d1 ]
  ...
  br i1 %101, label %block_41093f, label %block_.L_4109e7
...
block_41093f:                                     ; preds = %block_.L_41092f
  ...
  br i1 %147, label %block_.L_410990, label %block_41095c
...
block_.L_410961:                                  ; preds = %block_.L_410961, %block_41095c
  %150 = phi i64 [ %149, %block_41095c ], [ %236, %block_.L_410961 ]
  %151 = phi i64 [ %111, %block_41095c ], [ %197, %block_.L_410961 ]
  %MEMORY.1 = phi %struct.Memory* [ %MEMORY.0, %block_41095c ], [ %call2_41096c, %block_.L_410961 ]
  %152 = add i64 %151, -32
  ...
  %call2_41096c = tail call %struct.Memory* @sub_40c720._ZN15loop_inner_bodyILi17EiE7do_workERiPKii(%struct.State* nonnull %0, i64 %162, %struct.Memory* %MEMORY.1)
  ...
  br i1 %235, label %block_.L_410961, label %block_41098b
...
block_.L_410990:                                  ; preds = %block_41098b, %block_41093f
  %238 = phi i64 [ %148, %block_41093f ], [ %237, %block_41098b ]
  %239 = phi i64 [ %111, %block_41093f ], [ %197, %block_41098b ]
  %MEMORY.2 = phi %struct.Memory* [ %MEMORY.0, %block_41093f ], [ %call2_41096c, %block_41098b ]
  %240 = add i64 %239, -36
  %241 = add i64 %238, 3
  ...
  br i1 %274, label %block_41099c, label %block_.L_4109d1
...
block_.L_4109a1:                                  ; preds = %block_.L_4109a1, %block_41099c
  %277 = phi i64 [ %276, %block_41099c ], [ %400, %block_.L_4109a1 ]
  %278 = phi i64 [ %239, %block_41099c ], [ %365, %block_.L_4109a1 ]
  %MEMORY.3 = phi %struct.Memory* [ %MEMORY.2, %block_41099c ], [ %call2_4109ac, %block_.L_4109a1 ]
  %279 = add i64 %278, -8
  %280 = add i64 %277, 4
  ...
  %call2_4109ac = tail call %struct.Memory* @sub_40c100._Z18complete_hash_funcIiET_S0_(%struct.State* nonnull %0, i64 %294, %struct.Memory* %MEMORY.3)
  ...
  br i1 %389, label %block_4109cc, label %block_.L_4109a1
...
block_.L_4109d1:                                  ; preds = %block_.L_410990, %block_4109cc
  %402 = phi i64 [ %275, %block_.L_410990 ], [ %401, %block_4109cc ]
  %403 = phi i64 [ %239, %block_.L_410990 ], [ %365, %block_4109cc ]
  %MEMORY.4 = phi %struct.Memory* [ %MEMORY.2, %block_.L_410990 ], [ %call2_4109ac, %block_4109cc ]
  %404 = add i64 %403, -32
  %405 = add i64 %402, 3
  ...
  %call2_4109d4 = tail call %struct.Memory* @sub_40c130._Z9check_sumIiEvT_(%struct.State* nonnull %0, i64 %409, %struct.Memory* %MEMORY.4)
...
block_.L_4109e7:                                  ; preds = %block_.L_41092f
  ...
  %call2_4109e7 = tail call %struct.Memory* @sub_400e20._Z5timerv(%struct.State* nonnull %0, i64 %446, %struct.Memory* %MEMORY.0)
  ...
  %call2_4109f0 = tail call %struct.Memory* @sub_4007c0._Z13record_resultdPKc(%struct.State* nonnull %0, i64 %457, %struct.Memory* %call2_4109e7)
  ...
  ret %struct.Memory* %call2_4109f0
}
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_jge_.L_4109e7(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i8* nocapture %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_jl_.L_410990(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i8* nocapture %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 2, i32 9
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_jmpq_.L_410961(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_jl_.L_410961(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i8* nocapture %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 2, i32 9
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_jge_.L_4109d1(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i8* nocapture %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 2, i32 9
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_jmpq_.L_4109a1(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_jne_.L_4109a1(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i8* nocapture %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_jmpq_.L_4109d1(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_jmpq_.L_41092f(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
