...
block_.L_410961:                                  ; preds = %block_.L_410961, %block_41095c
  %150 = phi i64 [ %236, %block_.L_410961 ], [ %149, %block_41095c ]
  %151 = phi i64 [ %197, %block_.L_410961 ], [ %111, %block_41095c ]
  %152 = add i64 %151, -32
  ...
  %call2_41096c = tail call %struct.Memory* @sub_40c720._ZN15loop_inner_bodyILi17EiE7do_workERiPKii(%struct.State* nonnull %0, i64 %162, %struct.Memory* %MEMORY.0)
...
block_.L_410990:                                  ; preds = %block_41098b, %block_41093f
  %238 = phi i64 [ %237, %block_41098b ], [ %148, %block_41093f ]
  %239 = phi i64 [ %197, %block_41098b ], [ %111, %block_41093f ]
  %240 = add i64 %239, -36
  %241 = add i64 %238, 3
...
block_.L_4109a1:                                  ; preds = %block_.L_4109a1, %block_41099c
  %277 = phi i64 [ %400, %block_.L_4109a1 ], [ %276, %block_41099c ]
  %278 = phi i64 [ %365, %block_.L_4109a1 ], [ %239, %block_41099c ]
  %279 = add i64 %278, -8
  %280 = add i64 %277, 4
  ...
  %call2_4109ac = tail call %struct.Memory* @sub_40c100._Z18complete_hash_funcIiET_S0_(%struct.State* nonnull %0, i64 %294, %struct.Memory* %MEMORY.0)
...
block_.L_4109d1:                                  ; preds = %block_.L_410990, %block_4109cc
  ...
  %call2_4109d4 = tail call %struct.Memory* @sub_40c130._Z9check_sumIiEvT_(%struct.State* nonnull %0, i64 %409, %struct.Memory* %MEMORY.0)
