...
block_.L_405d42:                                  ; preds = %block_.L_405d42, %block_405d3d
  %157 = phi i64 [ %243, %block_.L_405d42 ], [ %156, %block_405d3d ]
  %158 = phi i64 [ %204, %block_.L_405d42 ], [ %118, %block_405d3d ]
  %159 = add i64 %158, -40
  ...
  %call2_405d4d = tail call %struct.Memory* @sub_401b00._ZN15loop_inner_bodyILi18EdE7do_workERdPKdi(%struct.State* nonnull %0, i64 %169, %struct.Memory* %MEMORY.0)
...
block_.L_405d71:                                  ; preds = %block_405d6c, %block_405d1f
  %245 = phi i64 [ %244, %block_405d6c ], [ %155, %block_405d1f ]
  %246 = phi i64 [ %204, %block_405d6c ], [ %118, %block_405d1f ]
  %247 = add i64 %246, -44
  %248 = add i64 %245, 3
...
block_.L_405d82:                                  ; preds = %block_.L_405d82, %block_405d7d
  %284 = phi i64 [ %380, %block_.L_405d82 ], [ %283, %block_405d7d ]
  %285 = phi i64 [ %345, %block_.L_405d82 ], [ %246, %block_405d7d ]
  %286 = add i64 %285, -8
  %287 = add i64 %284, 4
  ...
  %call2_405d8f = tail call %struct.Memory* @sub_4014b0._Z18complete_hash_funcIdET_S0_(%struct.State* nonnull %0, i64 %300, %struct.Memory* %MEMORY.0)
...
block_.L_405db8:                                  ; preds = %block_.L_405d71, %block_405db3
  ...
  %call2_405dbd = tail call %struct.Memory* @sub_4014e0._Z9check_sumIdEvT_(%struct.State* nonnull %0, i64 %388, %struct.Memory* %MEMORY.0)
