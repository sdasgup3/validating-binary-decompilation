...
define %struct.Memory* @_Z26test_do_loop_unroll_factorILi18EdEvPKT0_iPKc(%struct.State* noalias, i64, %struct.Memory* noalias) local_unnamed_addr #1 {
entry:
  ...
  %call2_405d03 = tail call %struct.Memory* @sub_400e00._Z11start_timerv(%struct.State* %0, i64 %58, %struct.Memory* %2)
...
block_.L_405d0f:                                  ; preds = %block_.L_405db8, %entry
  %74 = phi i64 [ %.pre, %entry ], [ %424, %block_.L_405db8 ]
  %MEMORY.0 = phi %struct.Memory* [ %call2_405d03, %entry ], [ %call2_405dbd, %block_.L_405db8 ]
  ...
  br i1 %107, label %block_405d1f, label %block_.L_405dd0

block_405d1f:                                     ; preds = %block_.L_405d0f
  ...
  br i1 %154, label %block_.L_405d71, label %block_405d3d

block_405d3d:                                     ; preds = %block_405d1f
  %156 = add i64 %155, 5
  store i64 %156, i64* %3, align 8
  br label %block_.L_405d42

block_.L_405d42:                                  ; preds = %block_.L_405d42, %block_405d3d
  %157 = phi i64 [ %156, %block_405d3d ], [ %243, %block_.L_405d42 ]
  %158 = phi i64 [ %118, %block_405d3d ], [ %204, %block_.L_405d42 ]
  %MEMORY.1 = phi %struct.Memory* [ %MEMORY.0, %block_405d3d ], [ %call2_405d4d, %block_.L_405d42 ]
  %159 = add i64 %158, -40
  ...
  %call2_405d4d = tail call %struct.Memory* @sub_401b00._ZN15loop_inner_bodyILi18EdE7do_workERdPKdi(%struct.State* nonnull %0, i64 %169, %struct.Memory* %MEMORY.1)
  ...
  br i1 %242, label %block_.L_405d42, label %block_405d6c

block_405d6c:                                     ; preds = %block_.L_405d42
  %244 = add i64 %243, 5
  store i64 %244, i64* %3, align 8
  br label %block_.L_405d71

block_.L_405d71:                                  ; preds = %block_405d6c, %block_405d1f
  %245 = phi i64 [ %155, %block_405d1f ], [ %244, %block_405d6c ]
  %246 = phi i64 [ %118, %block_405d1f ], [ %204, %block_405d6c ]
  %MEMORY.2 = phi %struct.Memory* [ %MEMORY.0, %block_405d1f ], [ %call2_405d4d, %block_405d6c ]
  %247 = add i64 %246, -44
  %248 = add i64 %245, 3
  ...
  br i1 %281, label %block_405d7d, label %block_.L_405db8

block_405d7d:                                     ; preds = %block_.L_405d71
  %283 = add i64 %282, 5
  store i64 %283, i64* %3, align 8
  br label %block_.L_405d82

block_.L_405d82:                                  ; preds = %block_.L_405d82, %block_405d7d
  %284 = phi i64 [ %283, %block_405d7d ], [ %380, %block_.L_405d82 ]
  %285 = phi i64 [ %246, %block_405d7d ], [ %345, %block_.L_405d82 ]
  %MEMORY.3 = phi %struct.Memory* [ %MEMORY.2, %block_405d7d ], [ %call2_405d8f, %block_.L_405d82 ]
  %286 = add i64 %285, -8
  %287 = add i64 %284, 4
  ...
  %call2_405d8f = tail call %struct.Memory* @sub_4014b0._Z18complete_hash_funcIdET_S0_(%struct.State* nonnull %0, i64 %300, %struct.Memory* %MEMORY.3)
  ...
  br i1 %369, label %block_405db3, label %block_.L_405d82

block_405db3:                                     ; preds = %block_.L_405d82
  %381 = add i64 %380, 5
  store i64 %381, i64* %3, align 8
  br label %block_.L_405db8

block_.L_405db8:                                  ; preds = %block_.L_405d71, %block_405db3
  %382 = phi i64 [ %282, %block_.L_405d71 ], [ %381, %block_405db3 ]
  %383 = phi i64 [ %246, %block_.L_405d71 ], [ %345, %block_405db3 ]
  %MEMORY.4 = phi %struct.Memory* [ %MEMORY.2, %block_.L_405d71 ], [ %call2_405d8f, %block_405db3 ]
  %384 = add i64 %383, -40
  %385 = add i64 %382, 5
  ...
  %call2_405dbd = tail call %struct.Memory* @sub_4014e0._Z9check_sumIdEvT_(%struct.State* nonnull %0, i64 %388, %struct.Memory* %MEMORY.4)
...
block_.L_405dd0:                                  ; preds = %block_.L_405d0f
  %425 = add i64 %108, -20400
  %426 = add i64 %108, 5
  ...
  %call2_405dd0 = tail call %struct.Memory* @sub_400e20._Z5timerv(%struct.State* nonnull %0, i64 %425, %struct.Memory* %MEMORY.0)
  ...
  %call2_405dd9 = tail call %struct.Memory* @sub_4007c0._Z13record_resultdPKc(%struct.State* nonnull %0, i64 %436, %struct.Memory* %call2_405dd0)
  ...
  ret %struct.Memory* %call2_405dd9
}
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_jge_.L_405dd0(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i8* nocapture %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_jl_.L_405d71(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i8* nocapture %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 2, i32 9
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_jmpq_.L_405d42(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_jl_.L_405d42(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i8* nocapture %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 2, i32 9
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_jmpq_.L_405d71(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_jge_.L_405db8(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i8* nocapture %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 2, i32 9
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_jmpq_.L_405d82(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_jne_.L_405d82(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i8* nocapture %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_jmpq_.L_405db8(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
