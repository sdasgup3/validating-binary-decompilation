...
entry:
  ...
  %call2_405cd3 = tail call %struct.Memory* @sub_400dd0._Z11start_timerv(%struct.State* %0, i64 %58, %struct.Memory* %2)
  ...
  br label %block_.L_405cdf

block_.L_405cdf:                                  ; preds = %block_.L_405d88, %entry
  %79 = phi i64 [ %.pre, %entry ], [ %433, %block_.L_405d88 ]
  %MEMORY.0 = phi %struct.Memory* [ %call2_405cd3, %entry ], [ %call2_405d8d, %block_.L_405d88 ]
  ...
  br i1 %112, label %block_405cef, label %block_.L_405da0

block_405cef:                                     ; preds = %block_.L_405cdf
  ...
  br i1 %160, label %block_.L_405d41, label %block_405d0d

block_405d0d:                                     ; preds = %block_405cef
  %162 = add i64 %161, 5
  store i64 %162, i64* %3, align 8
  br label %block_.L_405d12

block_.L_405d12:                                  ; preds = %block_.L_405d12, %block_405d0d
  %163 = phi i64 [ %162, %block_405d0d ], [ %249, %block_.L_405d12 ]
  %164 = phi i64 [ %124, %block_405d0d ], [ %210, %block_.L_405d12 ]
  %MEMORY.1 = phi %struct.Memory* [ %MEMORY.0, %block_405d0d ], [ %call2_405d1d, %block_.L_405d12 ]
  %165 = add i64 %164, -40
  ...
  %call2_405d1d = tail call %struct.Memory* @sub_401ad0._ZN15loop_inner_bodyILi18EdE7do_workERdPKdi(%struct.State* %0, i64 %175, %struct.Memory* %MEMORY.1)
  ...
  br i1 %248, label %block_.L_405d12, label %block_405d3c

block_405d3c:                                     ; preds = %block_.L_405d12
  %250 = add i64 %249, 5
  store i64 %250, i64* %3, align 8
  br label %block_.L_405d41

block_.L_405d41:                                  ; preds = %block_405d3c, %block_405cef
  %251 = phi i64 [ %161, %block_405cef ], [ %250, %block_405d3c ]
  %252 = phi i64 [ %124, %block_405cef ], [ %210, %block_405d3c ]
  %MEMORY.2 = phi %struct.Memory* [ %MEMORY.0, %block_405cef ], [ %call2_405d1d, %block_405d3c ]
  %253 = add i64 %252, -44
  %254 = add i64 %251, 3
  ...
  br i1 %287, label %block_405d4d, label %block_.L_405d88

block_405d4d:                                     ; preds = %block_.L_405d41
  %289 = add i64 %288, 5
  store i64 %289, i64* %3, align 8
  br label %block_.L_405d52

block_.L_405d52:                                  ; preds = %block_.L_405d52, %block_405d4d
  %290 = phi i64 [ %289, %block_405d4d ], [ %387, %block_.L_405d52 ]
  %291 = phi i64 [ %252, %block_405d4d ], [ %352, %block_.L_405d52 ]
  %MEMORY.3 = phi %struct.Memory* [ %MEMORY.2, %block_405d4d ], [ %call2_405d5f, %block_.L_405d52 ]
  %292 = add i64 %291, -8
  %293 = add i64 %290, 4
  ...
  %call2_405d5f = tail call %struct.Memory* @sub_401480._Z18complete_hash_funcIdET_S0_(%struct.State* %0, i64 %307, %struct.Memory* %MEMORY.3)
  ...
  br i1 %376, label %block_405d83, label %block_.L_405d52

block_405d83:                                     ; preds = %block_.L_405d52
  %388 = add i64 %387, 5
  store i64 %388, i64* %3, align 8
  br label %block_.L_405d88

block_.L_405d88:                                  ; preds = %block_.L_405d41, %block_405d83
  %389 = phi i64 [ %288, %block_.L_405d41 ], [ %388, %block_405d83 ]
  %390 = phi i64 [ %252, %block_.L_405d41 ], [ %352, %block_405d83 ]
  %MEMORY.4 = phi %struct.Memory* [ %MEMORY.2, %block_.L_405d41 ], [ %call2_405d5f, %block_405d83 ]
  %391 = add i64 %390, -40
  %392 = add i64 %389, 5
  ...
  %call2_405d8d = tail call %struct.Memory* @sub_4014b0._Z9check_sumIdEvT_(%struct.State* %0, i64 %396, %struct.Memory* %MEMORY.4)
...
block_.L_405da0:                                  ; preds = %block_.L_405cdf
  %434 = add i64 %113, -20400
  %435 = add i64 %113, 5
  ...
  %call2_405da0 = tail call %struct.Memory* @sub_400df0._Z5timerv(%struct.State* %0, i64 %434, %struct.Memory* %MEMORY.0)
  ...
  %call2_405da9 = tail call %struct.Memory* @sub_400790._Z13record_resultdPKc(%struct.State* %0, i64 %445, %struct.Memory* %call2_405da0)
  ...
  ret %struct.Memory* %call2_405da9
}
...
define %struct.Memory* @routine_jge_.L_405da0(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i8* %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
...
define %struct.Memory* @routine_jl_.L_405d41(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i8* %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 2, i32 9
...
define %struct.Memory* @routine_jmpq_.L_405d12(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
...
define %struct.Memory* @routine_jl_.L_405d12(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i8* %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 2, i32 9
...
define %struct.Memory* @routine_jmpq_.L_405d41(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
...
define %struct.Memory* @routine_jge_.L_405d88(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i8* %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 2, i32 9
...
define %struct.Memory* @routine_jmpq_.L_405d52(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
...
define %struct.Memory* @routine_jne_.L_405d52(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i8* %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
...
define %struct.Memory* @routine_jmpq_.L_405d88(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
...
define %struct.Memory* @routine_jmpq_.L_405cdf(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
