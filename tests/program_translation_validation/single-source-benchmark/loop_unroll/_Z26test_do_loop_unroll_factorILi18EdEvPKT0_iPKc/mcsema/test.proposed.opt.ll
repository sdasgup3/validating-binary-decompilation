...
block_.L_405cdf:                                  ; preds = %block_.L_405d88, %entry
  %79 = phi i64 [ %.pre, %entry ], [ %429, %block_.L_405d88 ]
...
block_.L_405d52:                                  ; preds = %block_.L_405d52, %block_405d4d
  %290 = phi i64 [ %289, %block_405d4d ], [ %385, %block_.L_405d52 ]
  %291 = phi i64 [ %252, %block_405d4d ], [ %350, %block_.L_405d52 ]
  ...
  %call2_405d5f = tail call %struct.Memory* @sub_401480._Z18complete_hash_funcIdET_S0_(%struct.State* %0, i64 %306, %struct.Memory* %MEMORY.3)
  ...
  br i1 %374, label %block_405d83, label %block_.L_405d52
...
block_.L_405d88:                                  ; preds = %block_.L_405d41, %block_405d83
  %387 = phi i64 [ %288, %block_.L_405d41 ], [ %386, %block_405d83 ]
  %388 = phi i64 [ %252, %block_.L_405d41 ], [ %350, %block_405d83 ]
  ...
  %call2_405d8d = tail call %struct.Memory* @sub_4014b0._Z9check_sumIdEvT_(%struct.State* %0, i64 %393, %struct.Memory* %MEMORY.4)
...
block_.L_405da0:                                  ; preds = %block_.L_405cdf
  ...
  %call2_405da0 = tail call %struct.Memory* @sub_400df0._Z5timerv(%struct.State* %0, i64 %430, %struct.Memory* %MEMORY.0)
  ...
  %call2_405da9 = tail call %struct.Memory* @sub_400790._Z13record_resultdPKc(%struct.State* %0, i64 %441, %struct.Memory* %call2_405da0)
