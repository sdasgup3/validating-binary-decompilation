...
declare %struct.Memory* @sub_40c6c0._ZN15loop_inner_bodyILi18EiE7do_workERiPKii(%struct.State* dereferenceable(3376), i64, %struct.Memory*)
...
define %struct.Memory* @_Z26test_do_loop_unroll_factorILi18EiEvPKT0_iPKc(%struct.State* noalias, i64, %struct.Memory* noalias) #1 {
entry:
