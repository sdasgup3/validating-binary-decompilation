...
declare %struct.Memory* @sub_40c690._ZN15loop_inner_bodyILi18EiE7do_workERiPKii(%struct.State* noalias dereferenceable(3376), i64, %struct.Memory* noalias readnone returned) local_unnamed_addr
...
entry:
  ...
  %call2_4107b3 = tail call %struct.Memory* @sub_400dd0._Z11start_timerv(%struct.State* %0, i64 %58, %struct.Memory* %2)
...
block_.L_4107bf:                                  ; preds = %block_.L_410861, %entry
  %68 = phi i64 [ %.pre, %entry ], [ %445, %block_.L_410861 ]
  %MEMORY.0 = phi %struct.Memory* [ %call2_4107b3, %entry ], [ %call2_410864, %block_.L_410861 ]
  ...
  br i1 %101, label %block_4107cf, label %block_.L_410877
...
block_4107cf:                                     ; preds = %block_.L_4107bf
  ...
  br i1 %147, label %block_.L_410820, label %block_4107ec
...
block_.L_4107f1:                                  ; preds = %block_.L_4107f1, %block_4107ec
  %150 = phi i64 [ %149, %block_4107ec ], [ %236, %block_.L_4107f1 ]
  %151 = phi i64 [ %111, %block_4107ec ], [ %197, %block_.L_4107f1 ]
  %MEMORY.1 = phi %struct.Memory* [ %MEMORY.0, %block_4107ec ], [ %call2_4107fc, %block_.L_4107f1 ]
  %152 = add i64 %151, -32
  ...
  %call2_4107fc = tail call %struct.Memory* @sub_40c690._ZN15loop_inner_bodyILi18EiE7do_workERiPKii(%struct.State* %0, i64 %162, %struct.Memory* %MEMORY.1)
  ...
  br i1 %235, label %block_.L_4107f1, label %block_41081b
...
block_.L_410820:                                  ; preds = %block_41081b, %block_4107cf
  %238 = phi i64 [ %148, %block_4107cf ], [ %237, %block_41081b ]
  %239 = phi i64 [ %111, %block_4107cf ], [ %197, %block_41081b ]
  %MEMORY.2 = phi %struct.Memory* [ %MEMORY.0, %block_4107cf ], [ %call2_4107fc, %block_41081b ]
  %240 = add i64 %239, -36
  %241 = add i64 %238, 3
  ...
  br i1 %274, label %block_41082c, label %block_.L_410861
...
block_.L_410831:                                  ; preds = %block_.L_410831, %block_41082c
  %277 = phi i64 [ %276, %block_41082c ], [ %400, %block_.L_410831 ]
  %278 = phi i64 [ %239, %block_41082c ], [ %365, %block_.L_410831 ]
  %MEMORY.3 = phi %struct.Memory* [ %MEMORY.2, %block_41082c ], [ %call2_41083c, %block_.L_410831 ]
  %279 = add i64 %278, -8
  %280 = add i64 %277, 4
  ...
  %call2_41083c = tail call %struct.Memory* @sub_40c0d0._Z18complete_hash_funcIiET_S0_(%struct.State* %0, i64 %294, %struct.Memory* %MEMORY.3)
  ...
  br i1 %389, label %block_41085c, label %block_.L_410831
...
block_.L_410861:                                  ; preds = %block_.L_410820, %block_41085c
  %402 = phi i64 [ %275, %block_.L_410820 ], [ %401, %block_41085c ]
  %403 = phi i64 [ %239, %block_.L_410820 ], [ %365, %block_41085c ]
  %MEMORY.4 = phi %struct.Memory* [ %MEMORY.2, %block_.L_410820 ], [ %call2_41083c, %block_41085c ]
  %404 = add i64 %403, -32
  %405 = add i64 %402, 3
  ...
  %call2_410864 = tail call %struct.Memory* @sub_40c100._Z9check_sumIiEvT_(%struct.State* %0, i64 %409, %struct.Memory* %MEMORY.4)
...
block_.L_410877:                                  ; preds = %block_.L_4107bf
  ...
  %call2_410877 = tail call %struct.Memory* @sub_400df0._Z5timerv(%struct.State* %0, i64 %446, %struct.Memory* %MEMORY.0)
  ...
  %call2_410880 = tail call %struct.Memory* @sub_400790._Z13record_resultdPKc(%struct.State* %0, i64 %457, %struct.Memory* %call2_410877)
  ...
  ret %struct.Memory* %call2_410880
}
...
define %struct.Memory* @routine_jge_.L_410877(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i8* %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
...
define %struct.Memory* @routine_jl_.L_410820(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i8* %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 2, i32 9
...
define %struct.Memory* @routine_jmpq_.L_4107f1(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
...
define %struct.Memory* @routine_callq_._ZN15loop_inner_bodyILi18EiE7do_workERiPKii(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
...
define %struct.Memory* @routine_jl_.L_4107f1(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i8* %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 2, i32 9
...
define %struct.Memory* @routine_jmpq_.L_410820(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
...
define %struct.Memory* @routine_jge_.L_410861(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i8* %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 2, i32 9
...
define %struct.Memory* @routine_jmpq_.L_410831(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
...
define %struct.Memory* @routine_jne_.L_410831(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i8* %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
...
define %struct.Memory* @routine_jmpq_.L_410861(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
...
define %struct.Memory* @routine_jmpq_.L_4107bf(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
