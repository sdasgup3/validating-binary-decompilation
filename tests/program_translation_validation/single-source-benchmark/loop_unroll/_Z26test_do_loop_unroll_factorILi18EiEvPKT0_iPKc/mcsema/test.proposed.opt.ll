...
declare %struct.Memory* @sub_40c6d0._ZN15loop_inner_bodyILi18EiE7do_workERiPKii(%struct.State* noalias dereferenceable(3376), i64, %struct.Memory* noalias readnone returned) local_unnamed_addr
...
define %struct.Memory* @_Z26test_do_loop_unroll_factorILi18EiEvPKT0_iPKc(%struct.State* noalias, i64, %struct.Memory* noalias readnone) local_unnamed_addr #1 {
entry:
  ...
  %call2_4107f3 = tail call %struct.Memory* @sub_400e10._Z11start_timerv(%struct.State* %0, i64 %58, %struct.Memory* %2)
...
block_.L_4107ff:                                  ; preds = %block_.L_4108a1, %entry
  %68 = phi i64 [ %.pre, %entry ], [ %445, %block_.L_4108a1 ]
  %MEMORY.0 = phi %struct.Memory* [ %call2_4107f3, %entry ], [ %call2_4108a4, %block_.L_4108a1 ]
  ...
  br i1 %101, label %block_41080f, label %block_.L_4108b7
...
block_41080f:                                     ; preds = %block_.L_4107ff
  ...
  br i1 %147, label %block_.L_410860, label %block_41082c
...
block_.L_410831:                                  ; preds = %block_.L_410831, %block_41082c
  %150 = phi i64 [ %236, %block_.L_410831 ], [ %149, %block_41082c ]
  %151 = phi i64 [ %197, %block_.L_410831 ], [ %111, %block_41082c ]
  %152 = add i64 %151, -32
  ...
  %call2_41083c = tail call %struct.Memory* @sub_40c6d0._ZN15loop_inner_bodyILi18EiE7do_workERiPKii(%struct.State* nonnull %0, i64 %162, %struct.Memory* %MEMORY.0)
  ...
  br i1 %235, label %block_.L_410831, label %block_41085b
...
block_.L_410860:                                  ; preds = %block_41085b, %block_41080f
  %238 = phi i64 [ %237, %block_41085b ], [ %148, %block_41080f ]
  %239 = phi i64 [ %197, %block_41085b ], [ %111, %block_41080f ]
  %240 = add i64 %239, -36
  %241 = add i64 %238, 3
  ...
  br i1 %274, label %block_41086c, label %block_.L_4108a1
...
block_.L_410871:                                  ; preds = %block_.L_410871, %block_41086c
  %277 = phi i64 [ %400, %block_.L_410871 ], [ %276, %block_41086c ]
  %278 = phi i64 [ %365, %block_.L_410871 ], [ %239, %block_41086c ]
  %279 = add i64 %278, -8
  %280 = add i64 %277, 4
  ...
  %call2_41087c = tail call %struct.Memory* @sub_40c110._Z18complete_hash_funcIiET_S0_(%struct.State* nonnull %0, i64 %294, %struct.Memory* %MEMORY.0)
  ...
  br i1 %389, label %block_41089c, label %block_.L_410871
...
block_.L_4108a1:                                  ; preds = %block_.L_410860, %block_41089c
  %402 = phi i64 [ %275, %block_.L_410860 ], [ %401, %block_41089c ]
  %403 = phi i64 [ %239, %block_.L_410860 ], [ %365, %block_41089c ]
  %404 = add i64 %403, -32
  %405 = add i64 %402, 3
  ...
  %call2_4108a4 = tail call %struct.Memory* @sub_40c140._Z9check_sumIiEvT_(%struct.State* nonnull %0, i64 %409, %struct.Memory* %MEMORY.0)
...
block_.L_4108b7:                                  ; preds = %block_.L_4107ff
  ...
  %call2_4108b7 = tail call %struct.Memory* @sub_400e30._Z5timerv(%struct.State* nonnull %0, i64 %446, %struct.Memory* %MEMORY.0)
  ...
  %call2_4108c0 = tail call %struct.Memory* @sub_4007d0._Z13record_resultdPKc(%struct.State* nonnull %0, i64 %457, %struct.Memory* %call2_4108b7)
