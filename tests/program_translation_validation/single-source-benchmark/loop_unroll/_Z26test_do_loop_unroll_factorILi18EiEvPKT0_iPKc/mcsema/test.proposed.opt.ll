...
block_.L_4107bf:                                  ; preds = %block_.L_410861, %entry
  %68 = phi i64 [ %.pre, %entry ], [ %447, %block_.L_410861 ]
...
block_.L_410831:                                  ; preds = %block_.L_410831, %block_41082c
  %277 = phi i64 [ %276, %block_41082c ], [ %401, %block_.L_410831 ]
  %278 = phi i64 [ %239, %block_41082c ], [ %366, %block_.L_410831 ]
  ...
  br i1 %390, label %block_41085c, label %block_.L_410831
...
block_.L_410861:                                  ; preds = %block_.L_410820, %block_41085c
  %403 = phi i64 [ %275, %block_.L_410820 ], [ %402, %block_41085c ]
  %404 = phi i64 [ %239, %block_.L_410820 ], [ %366, %block_41085c ]
  ...
  %call2_410864 = tail call %struct.Memory* @sub_40c100._Z9check_sumIiEvT_(%struct.State* %0, i64 %410, %struct.Memory* %MEMORY.4)
...
block_.L_410877:                                  ; preds = %block_.L_4107bf
  ...
  %call2_410877 = tail call %struct.Memory* @sub_400df0._Z5timerv(%struct.State* %0, i64 %448, %struct.Memory* %MEMORY.0)
  ...
  %call2_410880 = tail call %struct.Memory* @sub_400790._Z13record_resultdPKc(%struct.State* %0, i64 %459, %struct.Memory* %call2_410877)
