...
declare %struct.Memory* @sub_40c6c0._ZN15loop_inner_bodyILi18EiE7do_workERiPKii(%struct.State* noalias dereferenceable(3376), i64, %struct.Memory* noalias readnone returned) local_unnamed_addr
...
block_.L_410821:                                  ; preds = %block_.L_410821, %block_41081c
  %150 = phi i64 [ %236, %block_.L_410821 ], [ %149, %block_41081c ]
  %151 = phi i64 [ %197, %block_.L_410821 ], [ %111, %block_41081c ]
  %152 = add i64 %151, -32
  ...
  %call2_41082c = tail call %struct.Memory* @sub_40c6c0._ZN15loop_inner_bodyILi18EiE7do_workERiPKii(%struct.State* nonnull %0, i64 %162, %struct.Memory* %MEMORY.0)
...
block_.L_410850:                                  ; preds = %block_41084b, %block_4107ff
  %238 = phi i64 [ %237, %block_41084b ], [ %148, %block_4107ff ]
  %239 = phi i64 [ %197, %block_41084b ], [ %111, %block_4107ff ]
  %240 = add i64 %239, -36
  %241 = add i64 %238, 3
...
block_.L_410861:                                  ; preds = %block_.L_410861, %block_41085c
  %277 = phi i64 [ %400, %block_.L_410861 ], [ %276, %block_41085c ]
  %278 = phi i64 [ %365, %block_.L_410861 ], [ %239, %block_41085c ]
  %279 = add i64 %278, -8
  %280 = add i64 %277, 4
  ...
  %call2_41086c = tail call %struct.Memory* @sub_40c100._Z18complete_hash_funcIiET_S0_(%struct.State* nonnull %0, i64 %294, %struct.Memory* %MEMORY.0)
...
block_.L_410891:                                  ; preds = %block_.L_410850, %block_41088c
  ...
  %call2_410894 = tail call %struct.Memory* @sub_40c130._Z9check_sumIiEvT_(%struct.State* nonnull %0, i64 %409, %struct.Memory* %MEMORY.0)
