...
entry:
  ...
  %call2_405b83 = tail call %struct.Memory* @sub_400dd0._Z11start_timerv(%struct.State* %0, i64 %58, %struct.Memory* %2)
...
block_.L_405b8f:                                  ; preds = %block_.L_405c38, %entry
  %79 = phi i64 [ %.pre, %entry ], [ %429, %block_.L_405c38 ]
  %MEMORY.0 = phi %struct.Memory* [ %call2_405b83, %entry ], [ %call2_405c3d, %block_.L_405c38 ]
  ...
  br i1 %112, label %block_405b9f, label %block_.L_405c50
...
block_405b9f:                                     ; preds = %block_.L_405b8f
  ...
  br i1 %160, label %block_.L_405bf1, label %block_405bbd

block_405bbd:                                     ; preds = %block_405b9f
  %162 = add i64 %161, 5
  store i64 %162, i64* %3, align 8
  br label %block_.L_405bc2

block_.L_405bc2:                                  ; preds = %block_.L_405bc2, %block_405bbd
  %163 = phi i64 [ %162, %block_405bbd ], [ %249, %block_.L_405bc2 ]
  %164 = phi i64 [ %124, %block_405bbd ], [ %210, %block_.L_405bc2 ]
  %MEMORY.1 = phi %struct.Memory* [ %MEMORY.0, %block_405bbd ], [ %call2_405bcd, %block_.L_405bc2 ]
  %165 = add i64 %164, -40
  ...
  %call2_405bcd = tail call %struct.Memory* @sub_401a70._ZN15loop_inner_bodyILi19EdE7do_workERdPKdi(%struct.State* %0, i64 %175, %struct.Memory* %MEMORY.1)
  ...
  br i1 %248, label %block_.L_405bc2, label %block_405bec

block_405bec:                                     ; preds = %block_.L_405bc2
  %250 = add i64 %249, 5
  store i64 %250, i64* %3, align 8
  br label %block_.L_405bf1

block_.L_405bf1:                                  ; preds = %block_405bec, %block_405b9f
  %251 = phi i64 [ %161, %block_405b9f ], [ %250, %block_405bec ]
  %252 = phi i64 [ %124, %block_405b9f ], [ %210, %block_405bec ]
  %MEMORY.2 = phi %struct.Memory* [ %MEMORY.0, %block_405b9f ], [ %call2_405bcd, %block_405bec ]
  %253 = add i64 %252, -44
  %254 = add i64 %251, 3
  ...
  br i1 %287, label %block_405bfd, label %block_.L_405c38

block_405bfd:                                     ; preds = %block_.L_405bf1
  %289 = add i64 %288, 5
  store i64 %289, i64* %3, align 8
  br label %block_.L_405c02

block_.L_405c02:                                  ; preds = %block_.L_405c02, %block_405bfd
  %290 = phi i64 [ %289, %block_405bfd ], [ %385, %block_.L_405c02 ]
  %291 = phi i64 [ %252, %block_405bfd ], [ %350, %block_.L_405c02 ]
  %MEMORY.3 = phi %struct.Memory* [ %MEMORY.2, %block_405bfd ], [ %call2_405c0f, %block_.L_405c02 ]
  %292 = add i64 %291, -8
  %293 = add i64 %290, 4
  ...
  %call2_405c0f = tail call %struct.Memory* @sub_401480._Z18complete_hash_funcIdET_S0_(%struct.State* %0, i64 %306, %struct.Memory* %MEMORY.3)
  ...
  br i1 %374, label %block_405c33, label %block_.L_405c02

block_405c33:                                     ; preds = %block_.L_405c02
  %386 = add i64 %385, 5
  store i64 %386, i64* %3, align 8
  br label %block_.L_405c38

block_.L_405c38:                                  ; preds = %block_.L_405bf1, %block_405c33
  %387 = phi i64 [ %288, %block_.L_405bf1 ], [ %386, %block_405c33 ]
  %388 = phi i64 [ %252, %block_.L_405bf1 ], [ %350, %block_405c33 ]
  %MEMORY.4 = phi %struct.Memory* [ %MEMORY.2, %block_.L_405bf1 ], [ %call2_405c0f, %block_405c33 ]
  %389 = add i64 %388, -40
  %390 = add i64 %387, 5
  ...
  %call2_405c3d = tail call %struct.Memory* @sub_4014b0._Z9check_sumIdEvT_(%struct.State* %0, i64 %393, %struct.Memory* %MEMORY.4)
...
block_.L_405c50:                                  ; preds = %block_.L_405b8f
  %430 = add i64 %113, -20064
  %431 = add i64 %113, 5
  ...
  %call2_405c50 = tail call %struct.Memory* @sub_400df0._Z5timerv(%struct.State* %0, i64 %430, %struct.Memory* %MEMORY.0)
  ...
  %call2_405c59 = tail call %struct.Memory* @sub_400790._Z13record_resultdPKc(%struct.State* %0, i64 %441, %struct.Memory* %call2_405c50)
  ...
  ret %struct.Memory* %call2_405c59
}
...
define %struct.Memory* @routine_jge_.L_405c50(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i8* %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
...
define %struct.Memory* @routine_jl_.L_405bf1(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i8* %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 2, i32 9
...
define %struct.Memory* @routine_jmpq_.L_405bc2(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
...
define %struct.Memory* @routine_jl_.L_405bc2(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i8* %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 2, i32 9
...
define %struct.Memory* @routine_jmpq_.L_405bf1(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
...
define %struct.Memory* @routine_jge_.L_405c38(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i8* %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 2, i32 9
...
define %struct.Memory* @routine_jmpq_.L_405c02(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
...
define %struct.Memory* @routine_jne_.L_405c02(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i8* %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
...
define %struct.Memory* @routine_jmpq_.L_405c38(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
