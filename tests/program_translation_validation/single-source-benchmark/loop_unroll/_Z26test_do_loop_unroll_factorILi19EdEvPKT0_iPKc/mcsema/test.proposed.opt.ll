...
block_.L_405b8f:                                  ; preds = %block_.L_405c38, %entry
  %79 = phi i64 [ %.pre, %entry ], [ %433, %block_.L_405c38 ]
...
block_.L_405c02:                                  ; preds = %block_.L_405c02, %block_405bfd
  %290 = phi i64 [ %289, %block_405bfd ], [ %387, %block_.L_405c02 ]
  %291 = phi i64 [ %252, %block_405bfd ], [ %352, %block_.L_405c02 ]
  ...
  %call2_405c0f = tail call %struct.Memory* @sub_401480._Z18complete_hash_funcIdET_S0_(%struct.State* %0, i64 %307, %struct.Memory* %MEMORY.3)
  ...
  br i1 %376, label %block_405c33, label %block_.L_405c02
...
block_.L_405c38:                                  ; preds = %block_.L_405bf1, %block_405c33
  %389 = phi i64 [ %288, %block_.L_405bf1 ], [ %388, %block_405c33 ]
  %390 = phi i64 [ %252, %block_.L_405bf1 ], [ %352, %block_405c33 ]
  ...
  %call2_405c3d = tail call %struct.Memory* @sub_4014b0._Z9check_sumIdEvT_(%struct.State* %0, i64 %396, %struct.Memory* %MEMORY.4)
...
block_.L_405c50:                                  ; preds = %block_.L_405b8f
  ...
  %call2_405c50 = tail call %struct.Memory* @sub_400df0._Z5timerv(%struct.State* %0, i64 %434, %struct.Memory* %MEMORY.0)
  ...
  %call2_405c59 = tail call %struct.Memory* @sub_400790._Z13record_resultdPKc(%struct.State* %0, i64 %445, %struct.Memory* %call2_405c50)
