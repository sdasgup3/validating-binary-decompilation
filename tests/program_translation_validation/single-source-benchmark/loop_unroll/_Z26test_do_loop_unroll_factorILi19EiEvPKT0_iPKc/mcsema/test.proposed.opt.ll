...
define %struct.Memory* @_Z26test_do_loop_unroll_factorILi19EiEvPKT0_iPKc(%struct.State* noalias, i64, %struct.Memory* noalias readnone) local_unnamed_addr #1 {
entry:
  ...
  %call2_4106b3 = tail call %struct.Memory* @sub_400e10._Z11start_timerv(%struct.State* %0, i64 %58, %struct.Memory* %2)
...
block_.L_4106bf:                                  ; preds = %block_.L_410761, %entry
  %68 = phi i64 [ %.pre, %entry ], [ %445, %block_.L_410761 ]
  %MEMORY.0 = phi %struct.Memory* [ %call2_4106b3, %entry ], [ %call2_410764, %block_.L_410761 ]
  ...
  br i1 %101, label %block_4106cf, label %block_.L_410777
...
block_4106cf:                                     ; preds = %block_.L_4106bf
  ...
  br i1 %147, label %block_.L_410720, label %block_4106ec
...
block_.L_4106f1:                                  ; preds = %block_.L_4106f1, %block_4106ec
  %150 = phi i64 [ %236, %block_.L_4106f1 ], [ %149, %block_4106ec ]
  %151 = phi i64 [ %197, %block_.L_4106f1 ], [ %111, %block_4106ec ]
  %152 = add i64 %151, -32
  ...
  %call2_4106fc = tail call %struct.Memory* @sub_40c670._ZN15loop_inner_bodyILi19EiE7do_workERiPKii(%struct.State* nonnull %0, i64 %162, %struct.Memory* %MEMORY.0)
  ...
  br i1 %235, label %block_.L_4106f1, label %block_41071b
...
block_.L_410720:                                  ; preds = %block_41071b, %block_4106cf
  %238 = phi i64 [ %237, %block_41071b ], [ %148, %block_4106cf ]
  %239 = phi i64 [ %197, %block_41071b ], [ %111, %block_4106cf ]
  %240 = add i64 %239, -36
  %241 = add i64 %238, 3
  ...
  br i1 %274, label %block_41072c, label %block_.L_410761
...
block_.L_410731:                                  ; preds = %block_.L_410731, %block_41072c
  %277 = phi i64 [ %400, %block_.L_410731 ], [ %276, %block_41072c ]
  %278 = phi i64 [ %365, %block_.L_410731 ], [ %239, %block_41072c ]
  %279 = add i64 %278, -8
  %280 = add i64 %277, 4
  ...
  %call2_41073c = tail call %struct.Memory* @sub_40c110._Z18complete_hash_funcIiET_S0_(%struct.State* nonnull %0, i64 %294, %struct.Memory* %MEMORY.0)
  ...
  br i1 %389, label %block_41075c, label %block_.L_410731
...
block_.L_410761:                                  ; preds = %block_.L_410720, %block_41075c
  %402 = phi i64 [ %275, %block_.L_410720 ], [ %401, %block_41075c ]
  %403 = phi i64 [ %239, %block_.L_410720 ], [ %365, %block_41075c ]
  %404 = add i64 %403, -32
  %405 = add i64 %402, 3
  ...
  %call2_410764 = tail call %struct.Memory* @sub_40c140._Z9check_sumIiEvT_(%struct.State* nonnull %0, i64 %409, %struct.Memory* %MEMORY.0)
...
block_.L_410777:                                  ; preds = %block_.L_4106bf
  ...
  %call2_410777 = tail call %struct.Memory* @sub_400e30._Z5timerv(%struct.State* nonnull %0, i64 %446, %struct.Memory* %MEMORY.0)
  ...
  %call2_410780 = tail call %struct.Memory* @sub_4007d0._Z13record_resultdPKc(%struct.State* nonnull %0, i64 %457, %struct.Memory* %call2_410777)
