...
block_.L_41067f:                                  ; preds = %block_.L_410721, %entry
  %68 = phi i64 [ %.pre, %entry ], [ %445, %block_.L_410721 ]
...
block_.L_4106f1:                                  ; preds = %block_.L_4106f1, %block_4106ec
  %277 = phi i64 [ %276, %block_4106ec ], [ %400, %block_.L_4106f1 ]
  %278 = phi i64 [ %239, %block_4106ec ], [ %365, %block_.L_4106f1 ]
  ...
  br i1 %389, label %block_41071c, label %block_.L_4106f1
...
block_.L_410721:                                  ; preds = %block_.L_4106e0, %block_41071c
  %402 = phi i64 [ %275, %block_.L_4106e0 ], [ %401, %block_41071c ]
  %403 = phi i64 [ %239, %block_.L_4106e0 ], [ %365, %block_41071c ]
  ...
  %call2_410724 = tail call %struct.Memory* @sub_40c100._Z9check_sumIiEvT_(%struct.State* %0, i64 %409, %struct.Memory* %MEMORY.4)
...
block_.L_410737:                                  ; preds = %block_.L_41067f
  ...
  %call2_410737 = tail call %struct.Memory* @sub_400df0._Z5timerv(%struct.State* %0, i64 %446, %struct.Memory* %MEMORY.0)
  ...
  %call2_410740 = tail call %struct.Memory* @sub_400790._Z13record_resultdPKc(%struct.State* %0, i64 %457, %struct.Memory* %call2_410737)
