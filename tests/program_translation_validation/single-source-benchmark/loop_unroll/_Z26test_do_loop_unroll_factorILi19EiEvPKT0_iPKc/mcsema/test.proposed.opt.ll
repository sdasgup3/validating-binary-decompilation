...
entry:
  ...
  %call2_410673 = tail call %struct.Memory* @sub_400dd0._Z11start_timerv(%struct.State* %0, i64 %58, %struct.Memory* %2)
...
block_.L_41067f:                                  ; preds = %block_.L_410721, %entry
  %68 = phi i64 [ %.pre, %entry ], [ %447, %block_.L_410721 ]
  %MEMORY.0 = phi %struct.Memory* [ %call2_410673, %entry ], [ %call2_410724, %block_.L_410721 ]
  ...
  br i1 %101, label %block_41068f, label %block_.L_410737
...
block_41068f:                                     ; preds = %block_.L_41067f
  ...
  br i1 %147, label %block_.L_4106e0, label %block_4106ac
...
block_.L_4106b1:                                  ; preds = %block_.L_4106b1, %block_4106ac
  %150 = phi i64 [ %149, %block_4106ac ], [ %236, %block_.L_4106b1 ]
  %151 = phi i64 [ %111, %block_4106ac ], [ %197, %block_.L_4106b1 ]
  %MEMORY.1 = phi %struct.Memory* [ %MEMORY.0, %block_4106ac ], [ %call2_4106bc, %block_.L_4106b1 ]
  %152 = add i64 %151, -32
  ...
  %call2_4106bc = tail call %struct.Memory* @sub_40c630._ZN15loop_inner_bodyILi19EiE7do_workERiPKii(%struct.State* %0, i64 %162, %struct.Memory* %MEMORY.1)
  ...
  br i1 %235, label %block_.L_4106b1, label %block_4106db
...
block_.L_4106e0:                                  ; preds = %block_4106db, %block_41068f
  %238 = phi i64 [ %148, %block_41068f ], [ %237, %block_4106db ]
  %239 = phi i64 [ %111, %block_41068f ], [ %197, %block_4106db ]
  %MEMORY.2 = phi %struct.Memory* [ %MEMORY.0, %block_41068f ], [ %call2_4106bc, %block_4106db ]
  %240 = add i64 %239, -36
  %241 = add i64 %238, 3
  ...
  br i1 %274, label %block_4106ec, label %block_.L_410721
...
block_.L_4106f1:                                  ; preds = %block_.L_4106f1, %block_4106ec
  %277 = phi i64 [ %276, %block_4106ec ], [ %401, %block_.L_4106f1 ]
  %278 = phi i64 [ %239, %block_4106ec ], [ %366, %block_.L_4106f1 ]
  %MEMORY.3 = phi %struct.Memory* [ %MEMORY.2, %block_4106ec ], [ %call2_4106fc, %block_.L_4106f1 ]
  %279 = add i64 %278, -8
  %280 = add i64 %277, 4
  ...
  %call2_4106fc = tail call %struct.Memory* @sub_40c0d0._Z18complete_hash_funcIiET_S0_(%struct.State* %0, i64 %294, %struct.Memory* %MEMORY.3)
  ...
  br i1 %390, label %block_41071c, label %block_.L_4106f1
...
block_.L_410721:                                  ; preds = %block_.L_4106e0, %block_41071c
  %403 = phi i64 [ %275, %block_.L_4106e0 ], [ %402, %block_41071c ]
  %404 = phi i64 [ %239, %block_.L_4106e0 ], [ %366, %block_41071c ]
  %MEMORY.4 = phi %struct.Memory* [ %MEMORY.2, %block_.L_4106e0 ], [ %call2_4106fc, %block_41071c ]
  %405 = add i64 %404, -32
  %406 = add i64 %403, 3
  ...
  %call2_410724 = tail call %struct.Memory* @sub_40c100._Z9check_sumIiEvT_(%struct.State* %0, i64 %410, %struct.Memory* %MEMORY.4)
...
block_.L_410737:                                  ; preds = %block_.L_41067f
  ...
  %call2_410737 = tail call %struct.Memory* @sub_400df0._Z5timerv(%struct.State* %0, i64 %448, %struct.Memory* %MEMORY.0)
  ...
  %call2_410740 = tail call %struct.Memory* @sub_400790._Z13record_resultdPKc(%struct.State* %0, i64 %459, %struct.Memory* %call2_410737)
  ...
  ret %struct.Memory* %call2_410740
}
...
define %struct.Memory* @routine_jge_.L_410737(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i8* %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
...
define %struct.Memory* @routine_jl_.L_4106e0(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i8* %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 2, i32 9
...
define %struct.Memory* @routine_jmpq_.L_4106b1(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
...
define %struct.Memory* @routine_jl_.L_4106b1(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i8* %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 2, i32 9
...
define %struct.Memory* @routine_jmpq_.L_4106e0(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
...
define %struct.Memory* @routine_jge_.L_410721(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i8* %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 2, i32 9
...
define %struct.Memory* @routine_jmpq_.L_4106f1(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
...
define %struct.Memory* @routine_jne_.L_4106f1(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i8* %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
...
define %struct.Memory* @routine_jmpq_.L_410721(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
...
define %struct.Memory* @routine_jmpq_.L_41067f(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
