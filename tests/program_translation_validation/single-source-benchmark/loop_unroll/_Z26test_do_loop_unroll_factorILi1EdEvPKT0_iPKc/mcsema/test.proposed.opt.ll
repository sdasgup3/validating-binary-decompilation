...
entry:
  ...
  %call2_407313 = tail call %struct.Memory* @sub_400e10._Z11start_timerv(%struct.State* %0, i64 %58, %struct.Memory* %2)
...
block_.L_40731f:                                  ; preds = %block_.L_4073c8, %entry
  %74 = phi i64 [ %.pre, %entry ], [ %422, %block_.L_4073c8 ]
  %MEMORY.0 = phi %struct.Memory* [ %call2_407313, %entry ], [ %call2_4073cd, %block_.L_4073c8 ]
  ...
  br i1 %107, label %block_40732f, label %block_.L_4073e0
...
block_40732f:                                     ; preds = %block_.L_40731f
  ...
  br i1 %153, label %block_.L_407381, label %block_40734d
...
block_.L_407352:                                  ; preds = %block_.L_407352, %block_40734d
  %156 = phi i64 [ %241, %block_.L_407352 ], [ %155, %block_40734d ]
  %157 = phi i64 [ %203, %block_.L_407352 ], [ %118, %block_40734d ]
  %158 = add i64 %157, -40
  ...
  %call2_40735d = tail call %struct.Memory* @sub_402170._ZN15loop_inner_bodyILi1EdE7do_workERdPKdi(%struct.State* nonnull %0, i64 %168, %struct.Memory* %MEMORY.0)
  ...
  br i1 %240, label %block_.L_407352, label %block_40737c
...
block_.L_407381:                                  ; preds = %block_40737c, %block_40732f
  %243 = phi i64 [ %242, %block_40737c ], [ %154, %block_40732f ]
  %244 = phi i64 [ %203, %block_40737c ], [ %118, %block_40732f ]
  %245 = add i64 %244, -44
  %246 = add i64 %243, 3
  ...
  br i1 %279, label %block_40738d, label %block_.L_4073c8
...
block_.L_407392:                                  ; preds = %block_.L_407392, %block_40738d
  %282 = phi i64 [ %378, %block_.L_407392 ], [ %281, %block_40738d ]
  %283 = phi i64 [ %343, %block_.L_407392 ], [ %244, %block_40738d ]
  %284 = add i64 %283, -8
  %285 = add i64 %282, 4
  ...
  %call2_40739f = tail call %struct.Memory* @sub_4014c0._Z18complete_hash_funcIdET_S0_(%struct.State* nonnull %0, i64 %298, %struct.Memory* %MEMORY.0)
  ...
  br i1 %367, label %block_4073c3, label %block_.L_407392
...
block_.L_4073c8:                                  ; preds = %block_.L_407381, %block_4073c3
  %380 = phi i64 [ %280, %block_.L_407381 ], [ %379, %block_4073c3 ]
  %381 = phi i64 [ %244, %block_.L_407381 ], [ %343, %block_4073c3 ]
  %382 = add i64 %381, -40
  %383 = add i64 %380, 5
  ...
  %call2_4073cd = tail call %struct.Memory* @sub_4014f0._Z9check_sumIdEvT_(%struct.State* nonnull %0, i64 %386, %struct.Memory* %MEMORY.0)
...
block_.L_4073e0:                                  ; preds = %block_.L_40731f
  ...
  %call2_4073e0 = tail call %struct.Memory* @sub_400e30._Z5timerv(%struct.State* nonnull %0, i64 %423, %struct.Memory* %MEMORY.0)
  ...
  %call2_4073e9 = tail call %struct.Memory* @sub_4007d0._Z13record_resultdPKc(%struct.State* nonnull %0, i64 %434, %struct.Memory* %call2_4073e0)
