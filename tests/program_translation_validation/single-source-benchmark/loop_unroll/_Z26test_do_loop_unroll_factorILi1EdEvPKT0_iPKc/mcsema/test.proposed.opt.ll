...
entry:
  ...
  %call2_407303 = tail call %struct.Memory* @sub_400e00._Z11start_timerv(%struct.State* %0, i64 %58, %struct.Memory* %2)
...
block_.L_40730f:                                  ; preds = %block_.L_4073b8, %entry
  %74 = phi i64 [ %.pre, %entry ], [ %422, %block_.L_4073b8 ]
  %MEMORY.0 = phi %struct.Memory* [ %call2_407303, %entry ], [ %call2_4073bd, %block_.L_4073b8 ]
  ...
  br i1 %107, label %block_40731f, label %block_.L_4073d0
...
block_40731f:                                     ; preds = %block_.L_40730f
  ...
  br i1 %153, label %block_.L_407371, label %block_40733d
...
block_.L_407342:                                  ; preds = %block_.L_407342, %block_40733d
  %156 = phi i64 [ %155, %block_40733d ], [ %241, %block_.L_407342 ]
  %157 = phi i64 [ %118, %block_40733d ], [ %203, %block_.L_407342 ]
  %MEMORY.1 = phi %struct.Memory* [ %MEMORY.0, %block_40733d ], [ %call2_40734d, %block_.L_407342 ]
  %158 = add i64 %157, -40
  ...
  %call2_40734d = tail call %struct.Memory* @sub_402160._ZN15loop_inner_bodyILi1EdE7do_workERdPKdi(%struct.State* nonnull %0, i64 %168, %struct.Memory* %MEMORY.1)
  ...
  store i64 %209, i64* %RAX.i107, align 8
  %210 = add i64 %203, -12
  %211 = add i64 %205, 6
  ...
  br i1 %240, label %block_.L_407342, label %block_40736c
...
block_.L_407371:                                  ; preds = %block_40736c, %block_40731f
  %243 = phi i64 [ %154, %block_40731f ], [ %242, %block_40736c ]
  %244 = phi i64 [ %118, %block_40731f ], [ %203, %block_40736c ]
  %MEMORY.2 = phi %struct.Memory* [ %MEMORY.0, %block_40731f ], [ %call2_40734d, %block_40736c ]
  %245 = add i64 %244, -44
  %246 = add i64 %243, 3
  ...
  br i1 %279, label %block_40737d, label %block_.L_4073b8
...
block_.L_407382:                                  ; preds = %block_.L_407382, %block_40737d
  %282 = phi i64 [ %281, %block_40737d ], [ %378, %block_.L_407382 ]
  %283 = phi i64 [ %244, %block_40737d ], [ %343, %block_.L_407382 ]
  %MEMORY.3 = phi %struct.Memory* [ %MEMORY.2, %block_40737d ], [ %call2_40738f, %block_.L_407382 ]
  %284 = add i64 %283, -8
  %285 = add i64 %282, 4
  ...
  %call2_40738f = tail call %struct.Memory* @sub_4014b0._Z18complete_hash_funcIdET_S0_(%struct.State* nonnull %0, i64 %298, %struct.Memory* %MEMORY.3)
  ...
  br i1 %367, label %block_4073b3, label %block_.L_407382
...
block_.L_4073b8:                                  ; preds = %block_.L_407371, %block_4073b3
  %380 = phi i64 [ %280, %block_.L_407371 ], [ %379, %block_4073b3 ]
  %381 = phi i64 [ %244, %block_.L_407371 ], [ %343, %block_4073b3 ]
  %MEMORY.4 = phi %struct.Memory* [ %MEMORY.2, %block_.L_407371 ], [ %call2_40738f, %block_4073b3 ]
  %382 = add i64 %381, -40
  %383 = add i64 %380, 5
  ...
  %call2_4073bd = tail call %struct.Memory* @sub_4014e0._Z9check_sumIdEvT_(%struct.State* nonnull %0, i64 %386, %struct.Memory* %MEMORY.4)
...
block_.L_4073d0:                                  ; preds = %block_.L_40730f
  ...
  %call2_4073d0 = tail call %struct.Memory* @sub_400e20._Z5timerv(%struct.State* nonnull %0, i64 %423, %struct.Memory* %MEMORY.0)
  ...
  %call2_4073d9 = tail call %struct.Memory* @sub_4007c0._Z13record_resultdPKc(%struct.State* nonnull %0, i64 %434, %struct.Memory* %call2_4073d0)
  ...
  ret %struct.Memory* %call2_4073d9
}
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_jge_.L_4073d0(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i8* nocapture %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_jl_.L_407371(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i8* nocapture %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 2, i32 9
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_jmpq_.L_407342(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_jl_.L_407342(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i8* nocapture %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 2, i32 9
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_jmpq_.L_407371(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_jge_.L_4073b8(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i8* nocapture %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 2, i32 9
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_jmpq_.L_407382(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_jne_.L_407382(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i8* nocapture %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_jmpq_.L_4073b8(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_jmpq_.L_40730f(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
