...
block_.L_407342:                                  ; preds = %block_.L_407342, %block_40733d
  %156 = phi i64 [ %241, %block_.L_407342 ], [ %155, %block_40733d ]
  %157 = phi i64 [ %203, %block_.L_407342 ], [ %118, %block_40733d ]
  %158 = add i64 %157, -40
  ...
  %call2_40734d = tail call %struct.Memory* @sub_402160._ZN15loop_inner_bodyILi1EdE7do_workERdPKdi(%struct.State* nonnull %0, i64 %168, %struct.Memory* %MEMORY.0)
...
block_.L_407371:                                  ; preds = %block_40736c, %block_40731f
  %243 = phi i64 [ %242, %block_40736c ], [ %154, %block_40731f ]
  %244 = phi i64 [ %203, %block_40736c ], [ %118, %block_40731f ]
  %245 = add i64 %244, -44
  %246 = add i64 %243, 3
...
block_.L_407382:                                  ; preds = %block_.L_407382, %block_40737d
  %282 = phi i64 [ %378, %block_.L_407382 ], [ %281, %block_40737d ]
  %283 = phi i64 [ %343, %block_.L_407382 ], [ %244, %block_40737d ]
  %284 = add i64 %283, -8
  %285 = add i64 %282, 4
  ...
  %call2_40738f = tail call %struct.Memory* @sub_4014b0._Z18complete_hash_funcIdET_S0_(%struct.State* nonnull %0, i64 %298, %struct.Memory* %MEMORY.0)
...
block_.L_4073b8:                                  ; preds = %block_.L_407371, %block_4073b3
  ...
  %call2_4073bd = tail call %struct.Memory* @sub_4014e0._Z9check_sumIdEvT_(%struct.State* nonnull %0, i64 %386, %struct.Memory* %MEMORY.0)
