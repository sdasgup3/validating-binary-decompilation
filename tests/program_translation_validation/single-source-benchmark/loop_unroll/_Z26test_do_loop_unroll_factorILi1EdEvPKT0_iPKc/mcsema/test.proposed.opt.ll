...
block_.L_4072df:                                  ; preds = %block_.L_407388, %entry
  %79 = phi i64 [ %.pre, %entry ], [ %427, %block_.L_407388 ]
...
block_.L_407312:                                  ; preds = %block_.L_407312, %block_40730d
  %162 = phi i64 [ %161, %block_40730d ], [ %247, %block_.L_407312 ]
  %163 = phi i64 [ %124, %block_40730d ], [ %209, %block_.L_407312 ]
  ...
  store i64 %215, i64* %RAX.i107, align 8
  %216 = add i64 %209, -12
  %217 = add i64 %211, 6
  ...
  %246 = xor i1 %245, %243
  %.v2 = select i1 %246, i64 -25, i64 17
  %247 = add i64 %211, %.v2
  store i64 %247, i64* %3, align 8
  br i1 %246, label %block_.L_407312, label %block_40733c
...
block_.L_407341:                                  ; preds = %block_40733c, %block_4072ef
  %249 = phi i64 [ %160, %block_4072ef ], [ %248, %block_40733c ]
  %250 = phi i64 [ %124, %block_4072ef ], [ %209, %block_40733c ]
  ...
  %285 = xor i1 %284, %282
  %.v3 = select i1 %285, i64 12, i64 71
  %286 = add i64 %249, %.v3
  store i64 %286, i64* %3, align 8
  br i1 %285, label %block_40734d, label %block_.L_407388
...
block_.L_407352:                                  ; preds = %block_.L_407352, %block_40734d
  %288 = phi i64 [ %287, %block_40734d ], [ %383, %block_.L_407352 ]
  %289 = phi i64 [ %250, %block_40734d ], [ %348, %block_.L_407352 ]
  ...
  %call2_40735f = tail call %struct.Memory* @sub_401480._Z18complete_hash_funcIdET_S0_(%struct.State* %0, i64 %304, %struct.Memory* %MEMORY.3)
  ...
  %.v4 = select i1 %372, i64 12, i64 -37
  %383 = add i64 %350, %.v4
  store i64 %383, i64* %3, align 8
  br i1 %372, label %block_407383, label %block_.L_407352
...
block_.L_407388:                                  ; preds = %block_.L_407341, %block_407383
  %385 = phi i64 [ %286, %block_.L_407341 ], [ %384, %block_407383 ]
  %386 = phi i64 [ %250, %block_.L_407341 ], [ %348, %block_407383 ]
  ...
  %call2_40738d = tail call %struct.Memory* @sub_4014b0._Z9check_sumIdEvT_(%struct.State* %0, i64 %391, %struct.Memory* %MEMORY.4)
...
block_.L_4073a0:                                  ; preds = %block_.L_4072df
  ...
  %call2_4073a0 = tail call %struct.Memory* @sub_400df0._Z5timerv(%struct.State* %0, i64 %428, %struct.Memory* %MEMORY.0)
  ...
  %call2_4073a9 = tail call %struct.Memory* @sub_400790._Z13record_resultdPKc(%struct.State* %0, i64 %439, %struct.Memory* %call2_4073a0)
