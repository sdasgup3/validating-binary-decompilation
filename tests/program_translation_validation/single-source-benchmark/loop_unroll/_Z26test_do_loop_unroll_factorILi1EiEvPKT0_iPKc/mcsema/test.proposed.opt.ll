...
declare %struct.Memory* @sub_40ccf0._ZN15loop_inner_bodyILi1EiE7do_workERiPKii(%struct.State* noalias dereferenceable(3376), i64, %struct.Memory* noalias readnone returned) local_unnamed_addr
...
entry:
  ...
  %call2_411ca3 = tail call %struct.Memory* @sub_400dd0._Z11start_timerv(%struct.State* %0, i64 %58, %struct.Memory* %2)
  ...
  br label %block_.L_411caf

block_.L_411caf:                                  ; preds = %block_.L_411d51, %entry
  %68 = phi i64 [ %.pre, %entry ], [ %443, %block_.L_411d51 ]
  %MEMORY.0 = phi %struct.Memory* [ %call2_411ca3, %entry ], [ %call2_411d54, %block_.L_411d51 ]
  ...
  br i1 %101, label %block_411cbf, label %block_.L_411d67

block_411cbf:                                     ; preds = %block_.L_411caf
  %103 = add i64 %69, -32
  %104 = add i64 %102, 7
  ...
  %146 = xor i1 %145, %143
  %.v1 = select i1 %146, i64 67, i64 15
  %147 = add i64 %113, %.v1
  store i64 %147, i64* %3, align 8
  br i1 %146, label %block_.L_411d10, label %block_411cdc

block_411cdc:                                     ; preds = %block_411cbf
  %148 = add i64 %147, 5
  store i64 %148, i64* %3, align 8
  br label %block_.L_411ce1

block_.L_411ce1:                                  ; preds = %block_.L_411ce1, %block_411cdc
  %149 = phi i64 [ %148, %block_411cdc ], [ %234, %block_.L_411ce1 ]
  %150 = phi i64 [ %111, %block_411cdc ], [ %196, %block_.L_411ce1 ]
  %MEMORY.1 = phi %struct.Memory* [ %MEMORY.0, %block_411cdc ], [ %call2_411cec, %block_.L_411ce1 ]
  %151 = add i64 %150, -32
  ...
  %call2_411cec = tail call %struct.Memory* @sub_40ccf0._ZN15loop_inner_bodyILi1EiE7do_workERiPKii(%struct.State* %0, i64 %161, %struct.Memory* %MEMORY.1)
  ...
  %233 = xor i1 %232, %230
  %.v2 = select i1 %233, i64 -25, i64 17
  %234 = add i64 %198, %.v2
  store i64 %234, i64* %3, align 8
  br i1 %233, label %block_.L_411ce1, label %block_411d0b

block_411d0b:                                     ; preds = %block_.L_411ce1
  %235 = add i64 %234, 5
  store i64 %235, i64* %3, align 8
  br label %block_.L_411d10

block_.L_411d10:                                  ; preds = %block_411d0b, %block_411cbf
  %236 = phi i64 [ %147, %block_411cbf ], [ %235, %block_411d0b ]
  %237 = phi i64 [ %111, %block_411cbf ], [ %196, %block_411d0b ]
  %MEMORY.2 = phi %struct.Memory* [ %MEMORY.0, %block_411cbf ], [ %call2_411cec, %block_411d0b ]
  %238 = add i64 %237, -36
  %239 = add i64 %236, 3
  ...
  %272 = xor i1 %271, %269
  %.v3 = select i1 %272, i64 12, i64 65
  %273 = add i64 %236, %.v3
  store i64 %273, i64* %3, align 8
  br i1 %272, label %block_411d1c, label %block_.L_411d51

block_411d1c:                                     ; preds = %block_.L_411d10
  %274 = add i64 %273, 5
  store i64 %274, i64* %3, align 8
  br label %block_.L_411d21

block_.L_411d21:                                  ; preds = %block_.L_411d21, %block_411d1c
  %275 = phi i64 [ %274, %block_411d1c ], [ %398, %block_.L_411d21 ]
  %276 = phi i64 [ %237, %block_411d1c ], [ %363, %block_.L_411d21 ]
  %MEMORY.3 = phi %struct.Memory* [ %MEMORY.2, %block_411d1c ], [ %call2_411d2c, %block_.L_411d21 ]
  %277 = add i64 %276, -8
  %278 = add i64 %275, 4
  ...
  %call2_411d2c = tail call %struct.Memory* @sub_40c0d0._Z18complete_hash_funcIiET_S0_(%struct.State* %0, i64 %292, %struct.Memory* %MEMORY.3)
  ...
  %.v4 = select i1 %387, i64 12, i64 -31
  %398 = add i64 %365, %.v4
  store i64 %398, i64* %3, align 8
  br i1 %387, label %block_411d4c, label %block_.L_411d21

block_411d4c:                                     ; preds = %block_.L_411d21
  %399 = add i64 %398, 5
  store i64 %399, i64* %3, align 8
  br label %block_.L_411d51

block_.L_411d51:                                  ; preds = %block_.L_411d10, %block_411d4c
  %400 = phi i64 [ %273, %block_.L_411d10 ], [ %399, %block_411d4c ]
  %401 = phi i64 [ %237, %block_.L_411d10 ], [ %363, %block_411d4c ]
  %MEMORY.4 = phi %struct.Memory* [ %MEMORY.2, %block_.L_411d10 ], [ %call2_411d2c, %block_411d4c ]
  %402 = add i64 %401, -32
  %403 = add i64 %400, 3
  ...
  %call2_411d54 = tail call %struct.Memory* @sub_40c100._Z9check_sumIiEvT_(%struct.State* %0, i64 %407, %struct.Memory* %MEMORY.4)
...
block_.L_411d67:                                  ; preds = %block_.L_411caf
  ...
  %call2_411d67 = tail call %struct.Memory* @sub_400df0._Z5timerv(%struct.State* %0, i64 %444, %struct.Memory* %MEMORY.0)
  ...
  %call2_411d70 = tail call %struct.Memory* @sub_400790._Z13record_resultdPKc(%struct.State* %0, i64 %455, %struct.Memory* %call2_411d67)
  ...
  ret %struct.Memory* %call2_411d70
}
...
define %struct.Memory* @routine_jge_.L_411d67(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i8* %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
...
define %struct.Memory* @routine_jl_.L_411d10(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i8* %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 2, i32 9
...
define %struct.Memory* @routine_jmpq_.L_411ce1(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
...
define %struct.Memory* @routine_callq_._ZN15loop_inner_bodyILi1EiE7do_workERiPKii(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
...
define %struct.Memory* @routine_jl_.L_411ce1(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i8* %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 2, i32 9
...
define %struct.Memory* @routine_jmpq_.L_411d10(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
...
define %struct.Memory* @routine_jge_.L_411d51(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i8* %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 2, i32 9
...
define %struct.Memory* @routine_jmpq_.L_411d21(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
...
define %struct.Memory* @routine_jne_.L_411d21(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i8* %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
...
define %struct.Memory* @routine_jmpq_.L_411d51(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
...
define %struct.Memory* @routine_jmpq_.L_411caf(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
