...
block_.L_411caf:                                  ; preds = %block_.L_411d51, %entry
  %68 = phi i64 [ %.pre, %entry ], [ %446, %block_.L_411d51 ]
...
block_.L_411ce1:                                  ; preds = %block_.L_411ce1, %block_411cdc
  %149 = phi i64 [ %148, %block_411cdc ], [ %235, %block_.L_411ce1 ]
  %150 = phi i64 [ %111, %block_411cdc ], [ %197, %block_.L_411ce1 ]
  ...
  store i64 %208, i64* %RCX.i47, align 8
  %209 = lshr i32 %207, 31
  %210 = sub i32 %202, %207
  %211 = icmp ult i32 %202, %207
  ...
  %234 = xor i1 %233, %231
  %.v2 = select i1 %234, i64 -25, i64 17
  %235 = add i64 %199, %.v2
  store i64 %235, i64* %3, align 8
  br i1 %234, label %block_.L_411ce1, label %block_411d0b
...
block_.L_411d10:                                  ; preds = %block_411d0b, %block_411cbf
  %237 = phi i64 [ %147, %block_411cbf ], [ %236, %block_411d0b ]
  %238 = phi i64 [ %111, %block_411cbf ], [ %197, %block_411d0b ]
  ...
  store i64 %243, i64* %RAX.i105, align 8
  %244 = add i64 %238, -12
  %245 = add i64 %237, 6
  ...
  %273 = xor i1 %272, %270
  %.v3 = select i1 %273, i64 12, i64 65
  %274 = add i64 %237, %.v3
  store i64 %274, i64* %3, align 8
  br i1 %273, label %block_411d1c, label %block_.L_411d51
...
block_.L_411d21:                                  ; preds = %block_.L_411d21, %block_411d1c
  %276 = phi i64 [ %275, %block_411d1c ], [ %400, %block_.L_411d21 ]
  %277 = phi i64 [ %238, %block_411d1c ], [ %365, %block_.L_411d21 ]
  ...
  store i64 %281, i64* %RAX.i105, align 8
  %282 = add i64 %277, -36
  %283 = add i64 %276, 8
  ...
  store i64 %286, i64* %RCX.i47, align 8
  ...
  store i64 %292, i64* %RDI.i116, align 8
  %293 = add i64 %276, -23633
  %294 = add i64 %276, 16
  ...
  %call2_411d2c = tail call %struct.Memory* @sub_40c0d0._Z18complete_hash_funcIiET_S0_(%struct.State* %0, i64 %293, %struct.Memory* %MEMORY.3)
  %298 = load i64, i64* %RAX.i105, align 8
  ...
  store i64 %341, i64* %RAX.i105, align 8
  ...
  %.v4 = select i1 %389, i64 12, i64 -31
  %400 = add i64 %367, %.v4
  store i64 %400, i64* %3, align 8
  br i1 %389, label %block_411d4c, label %block_.L_411d21
...
block_.L_411d51:                                  ; preds = %block_.L_411d10, %block_411d4c
  %402 = phi i64 [ %274, %block_.L_411d10 ], [ %401, %block_411d4c ]
  %403 = phi i64 [ %238, %block_.L_411d10 ], [ %365, %block_411d4c ]
  ...
  %call2_411d54 = tail call %struct.Memory* @sub_40c100._Z9check_sumIiEvT_(%struct.State* %0, i64 %409, %struct.Memory* %MEMORY.4)
...
block_.L_411d67:                                  ; preds = %block_.L_411caf
  ...
  %call2_411d67 = tail call %struct.Memory* @sub_400df0._Z5timerv(%struct.State* %0, i64 %447, %struct.Memory* %MEMORY.0)
  ...
  store i64 %457, i64* %RDI.i116, align 8
  %458 = add i64 %454, -71132
  %459 = add i64 %454, 9
  ...
  %call2_411d70 = tail call %struct.Memory* @sub_400790._Z13record_resultdPKc(%struct.State* %0, i64 %458, %struct.Memory* %call2_411d67)
  %463 = load i64, i64* %RSP.i121, align 8
  %464 = load i64, i64* %PC.i, align 8
  %465 = add i64 %463, 48
  store i64 %465, i64* %RSP.i121, align 8
  %466 = icmp ugt i64 %463, -49
