...
entry:
  ...
  %call2_405a73 = tail call %struct.Memory* @sub_400e10._Z11start_timerv(%struct.State* %0, i64 %58, %struct.Memory* %2)
...
block_.L_405a7f:                                  ; preds = %block_.L_405b28, %entry
  %74 = phi i64 [ %.pre, %entry ], [ %424, %block_.L_405b28 ]
  %MEMORY.0 = phi %struct.Memory* [ %call2_405a73, %entry ], [ %call2_405b2d, %block_.L_405b28 ]
  ...
  br i1 %107, label %block_405a8f, label %block_.L_405b40
...
block_405a8f:                                     ; preds = %block_.L_405a7f
  ...
  br i1 %154, label %block_.L_405ae1, label %block_405aad
...
block_.L_405ab2:                                  ; preds = %block_.L_405ab2, %block_405aad
  %157 = phi i64 [ %243, %block_.L_405ab2 ], [ %156, %block_405aad ]
  %158 = phi i64 [ %204, %block_.L_405ab2 ], [ %118, %block_405aad ]
  %159 = add i64 %158, -40
  ...
  %call2_405abd = tail call %struct.Memory* @sub_401a50._ZN15loop_inner_bodyILi20EdE7do_workERdPKdi(%struct.State* nonnull %0, i64 %169, %struct.Memory* %MEMORY.0)
  ...
  br i1 %242, label %block_.L_405ab2, label %block_405adc
...
block_.L_405ae1:                                  ; preds = %block_405adc, %block_405a8f
  %245 = phi i64 [ %244, %block_405adc ], [ %155, %block_405a8f ]
  %246 = phi i64 [ %204, %block_405adc ], [ %118, %block_405a8f ]
  %247 = add i64 %246, -44
  %248 = add i64 %245, 3
  ...
  br i1 %281, label %block_405aed, label %block_.L_405b28
...
block_.L_405af2:                                  ; preds = %block_.L_405af2, %block_405aed
  %284 = phi i64 [ %380, %block_.L_405af2 ], [ %283, %block_405aed ]
  %285 = phi i64 [ %345, %block_.L_405af2 ], [ %246, %block_405aed ]
  %286 = add i64 %285, -8
  %287 = add i64 %284, 4
  ...
  %call2_405aff = tail call %struct.Memory* @sub_4014c0._Z18complete_hash_funcIdET_S0_(%struct.State* nonnull %0, i64 %300, %struct.Memory* %MEMORY.0)
  ...
  br i1 %369, label %block_405b23, label %block_.L_405af2
...
block_.L_405b28:                                  ; preds = %block_.L_405ae1, %block_405b23
  %382 = phi i64 [ %282, %block_.L_405ae1 ], [ %381, %block_405b23 ]
  %383 = phi i64 [ %246, %block_.L_405ae1 ], [ %345, %block_405b23 ]
  %384 = add i64 %383, -40
  %385 = add i64 %382, 5
  ...
  %call2_405b2d = tail call %struct.Memory* @sub_4014f0._Z9check_sumIdEvT_(%struct.State* nonnull %0, i64 %388, %struct.Memory* %MEMORY.0)
...
block_.L_405b40:                                  ; preds = %block_.L_405a7f
  ...
  %call2_405b40 = tail call %struct.Memory* @sub_400e30._Z5timerv(%struct.State* nonnull %0, i64 %425, %struct.Memory* %MEMORY.0)
  ...
  %call2_405b49 = tail call %struct.Memory* @sub_4007d0._Z13record_resultdPKc(%struct.State* nonnull %0, i64 %436, %struct.Memory* %call2_405b40)
