...
entry:
  ...
  %call2_405a33 = tail call %struct.Memory* @sub_400dd0._Z11start_timerv(%struct.State* %0, i64 %58, %struct.Memory* %2)
...
block_.L_405a3f:                                  ; preds = %block_.L_405ae8, %entry
  %79 = phi i64 [ %.pre, %entry ], [ %433, %block_.L_405ae8 ]
  %MEMORY.0 = phi %struct.Memory* [ %call2_405a33, %entry ], [ %call2_405aed, %block_.L_405ae8 ]
  ...
  br i1 %112, label %block_405a4f, label %block_.L_405b00
...
block_405a4f:                                     ; preds = %block_.L_405a3f
  ...
  br i1 %160, label %block_.L_405aa1, label %block_405a6d
...
block_.L_405a72:                                  ; preds = %block_.L_405a72, %block_405a6d
  %163 = phi i64 [ %162, %block_405a6d ], [ %249, %block_.L_405a72 ]
  %164 = phi i64 [ %124, %block_405a6d ], [ %210, %block_.L_405a72 ]
  %MEMORY.1 = phi %struct.Memory* [ %MEMORY.0, %block_405a6d ], [ %call2_405a7d, %block_.L_405a72 ]
  %165 = add i64 %164, -40
  ...
  %call2_405a7d = tail call %struct.Memory* @sub_401a10._ZN15loop_inner_bodyILi20EdE7do_workERdPKdi(%struct.State* %0, i64 %175, %struct.Memory* %MEMORY.1)
  ...
  br i1 %248, label %block_.L_405a72, label %block_405a9c
...
block_.L_405aa1:                                  ; preds = %block_405a9c, %block_405a4f
  %251 = phi i64 [ %161, %block_405a4f ], [ %250, %block_405a9c ]
  %252 = phi i64 [ %124, %block_405a4f ], [ %210, %block_405a9c ]
  %MEMORY.2 = phi %struct.Memory* [ %MEMORY.0, %block_405a4f ], [ %call2_405a7d, %block_405a9c ]
  %253 = add i64 %252, -44
  %254 = add i64 %251, 3
  ...
  br i1 %287, label %block_405aad, label %block_.L_405ae8
...
block_.L_405ab2:                                  ; preds = %block_.L_405ab2, %block_405aad
  %290 = phi i64 [ %289, %block_405aad ], [ %387, %block_.L_405ab2 ]
  %291 = phi i64 [ %252, %block_405aad ], [ %352, %block_.L_405ab2 ]
  %MEMORY.3 = phi %struct.Memory* [ %MEMORY.2, %block_405aad ], [ %call2_405abf, %block_.L_405ab2 ]
  %292 = add i64 %291, -8
  %293 = add i64 %290, 4
  ...
  %call2_405abf = tail call %struct.Memory* @sub_401480._Z18complete_hash_funcIdET_S0_(%struct.State* %0, i64 %307, %struct.Memory* %MEMORY.3)
  ...
  br i1 %376, label %block_405ae3, label %block_.L_405ab2
...
block_.L_405ae8:                                  ; preds = %block_.L_405aa1, %block_405ae3
  %389 = phi i64 [ %288, %block_.L_405aa1 ], [ %388, %block_405ae3 ]
  %390 = phi i64 [ %252, %block_.L_405aa1 ], [ %352, %block_405ae3 ]
  %MEMORY.4 = phi %struct.Memory* [ %MEMORY.2, %block_.L_405aa1 ], [ %call2_405abf, %block_405ae3 ]
  %391 = add i64 %390, -40
  %392 = add i64 %389, 5
  ...
  %call2_405aed = tail call %struct.Memory* @sub_4014b0._Z9check_sumIdEvT_(%struct.State* %0, i64 %396, %struct.Memory* %MEMORY.4)
...
block_.L_405b00:                                  ; preds = %block_.L_405a3f
  ...
  %call2_405b00 = tail call %struct.Memory* @sub_400df0._Z5timerv(%struct.State* %0, i64 %434, %struct.Memory* %MEMORY.0)
  ...
  %call2_405b09 = tail call %struct.Memory* @sub_400790._Z13record_resultdPKc(%struct.State* %0, i64 %445, %struct.Memory* %call2_405b00)
  ...
  ret %struct.Memory* %call2_405b09
}
...
define %struct.Memory* @routine_jge_.L_405b00(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i8* %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
...
define %struct.Memory* @routine_jl_.L_405aa1(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i8* %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 2, i32 9
...
define %struct.Memory* @routine_jmpq_.L_405a72(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
...
define %struct.Memory* @routine_jl_.L_405a72(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i8* %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 2, i32 9
...
define %struct.Memory* @routine_jmpq_.L_405aa1(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
...
define %struct.Memory* @routine_jge_.L_405ae8(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i8* %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 2, i32 9
...
define %struct.Memory* @routine_jmpq_.L_405ab2(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
...
define %struct.Memory* @routine_jne_.L_405ab2(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i8* %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
...
define %struct.Memory* @routine_jmpq_.L_405ae8(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
...
define %struct.Memory* @routine_jmpq_.L_405a3f(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
