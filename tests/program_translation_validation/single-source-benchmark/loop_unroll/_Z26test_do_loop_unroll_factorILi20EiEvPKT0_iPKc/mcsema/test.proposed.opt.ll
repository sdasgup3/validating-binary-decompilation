...
entry:
  ...
  %call2_410573 = tail call %struct.Memory* @sub_400e10._Z11start_timerv(%struct.State* %0, i64 %58, %struct.Memory* %2)
...
block_.L_41057f:                                  ; preds = %block_.L_410621, %entry
  %68 = phi i64 [ %.pre, %entry ], [ %445, %block_.L_410621 ]
  %MEMORY.0 = phi %struct.Memory* [ %call2_410573, %entry ], [ %call2_410624, %block_.L_410621 ]
  ...
  br i1 %101, label %block_41058f, label %block_.L_410637
...
block_41058f:                                     ; preds = %block_.L_41057f
  ...
  br i1 %147, label %block_.L_4105e0, label %block_4105ac
...
block_.L_4105b1:                                  ; preds = %block_.L_4105b1, %block_4105ac
  %150 = phi i64 [ %236, %block_.L_4105b1 ], [ %149, %block_4105ac ]
  %151 = phi i64 [ %197, %block_.L_4105b1 ], [ %111, %block_4105ac ]
  %152 = add i64 %151, -32
  ...
  %call2_4105bc = tail call %struct.Memory* @sub_40c610._ZN15loop_inner_bodyILi20EiE7do_workERiPKii(%struct.State* nonnull %0, i64 %162, %struct.Memory* %MEMORY.0)
  ...
  br i1 %235, label %block_.L_4105b1, label %block_4105db
...
block_.L_4105e0:                                  ; preds = %block_4105db, %block_41058f
  %238 = phi i64 [ %237, %block_4105db ], [ %148, %block_41058f ]
  %239 = phi i64 [ %197, %block_4105db ], [ %111, %block_41058f ]
  %240 = add i64 %239, -36
  %241 = add i64 %238, 3
  ...
  br i1 %274, label %block_4105ec, label %block_.L_410621
...
block_.L_4105f1:                                  ; preds = %block_.L_4105f1, %block_4105ec
  %277 = phi i64 [ %400, %block_.L_4105f1 ], [ %276, %block_4105ec ]
  %278 = phi i64 [ %365, %block_.L_4105f1 ], [ %239, %block_4105ec ]
  %279 = add i64 %278, -8
  %280 = add i64 %277, 4
  ...
  %call2_4105fc = tail call %struct.Memory* @sub_40c110._Z18complete_hash_funcIiET_S0_(%struct.State* nonnull %0, i64 %294, %struct.Memory* %MEMORY.0)
  ...
  br i1 %389, label %block_41061c, label %block_.L_4105f1
...
block_.L_410621:                                  ; preds = %block_.L_4105e0, %block_41061c
  %402 = phi i64 [ %275, %block_.L_4105e0 ], [ %401, %block_41061c ]
  %403 = phi i64 [ %239, %block_.L_4105e0 ], [ %365, %block_41061c ]
  %404 = add i64 %403, -32
  %405 = add i64 %402, 3
  ...
  %call2_410624 = tail call %struct.Memory* @sub_40c140._Z9check_sumIiEvT_(%struct.State* nonnull %0, i64 %409, %struct.Memory* %MEMORY.0)
...
block_.L_410637:                                  ; preds = %block_.L_41057f
  ...
  %call2_410637 = tail call %struct.Memory* @sub_400e30._Z5timerv(%struct.State* nonnull %0, i64 %446, %struct.Memory* %MEMORY.0)
  ...
  %call2_410640 = tail call %struct.Memory* @sub_4007d0._Z13record_resultdPKc(%struct.State* nonnull %0, i64 %457, %struct.Memory* %call2_410637)
