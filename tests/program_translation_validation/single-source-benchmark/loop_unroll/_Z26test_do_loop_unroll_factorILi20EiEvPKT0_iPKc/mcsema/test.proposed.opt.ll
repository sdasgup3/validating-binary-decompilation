...
entry:
  ...
  %call2_410533 = tail call %struct.Memory* @sub_400dd0._Z11start_timerv(%struct.State* %0, i64 %58, %struct.Memory* %2)
...
block_.L_41053f:                                  ; preds = %block_.L_4105e1, %entry
  %68 = phi i64 [ %.pre, %entry ], [ %447, %block_.L_4105e1 ]
  %MEMORY.0 = phi %struct.Memory* [ %call2_410533, %entry ], [ %call2_4105e4, %block_.L_4105e1 ]
  ...
  br i1 %101, label %block_41054f, label %block_.L_4105f7
...
block_41054f:                                     ; preds = %block_.L_41053f
  ...
  br i1 %147, label %block_.L_4105a0, label %block_41056c
...
block_.L_410571:                                  ; preds = %block_.L_410571, %block_41056c
  %150 = phi i64 [ %149, %block_41056c ], [ %236, %block_.L_410571 ]
  %151 = phi i64 [ %111, %block_41056c ], [ %197, %block_.L_410571 ]
  %MEMORY.1 = phi %struct.Memory* [ %MEMORY.0, %block_41056c ], [ %call2_41057c, %block_.L_410571 ]
  %152 = add i64 %151, -32
  ...
  %call2_41057c = tail call %struct.Memory* @sub_40c5d0._ZN15loop_inner_bodyILi20EiE7do_workERiPKii(%struct.State* %0, i64 %162, %struct.Memory* %MEMORY.1)
  ...
  br i1 %235, label %block_.L_410571, label %block_41059b
...
block_.L_4105a0:                                  ; preds = %block_41059b, %block_41054f
  %238 = phi i64 [ %148, %block_41054f ], [ %237, %block_41059b ]
  %239 = phi i64 [ %111, %block_41054f ], [ %197, %block_41059b ]
  %MEMORY.2 = phi %struct.Memory* [ %MEMORY.0, %block_41054f ], [ %call2_41057c, %block_41059b ]
  %240 = add i64 %239, -36
  %241 = add i64 %238, 3
  ...
  br i1 %274, label %block_4105ac, label %block_.L_4105e1
...
block_.L_4105b1:                                  ; preds = %block_.L_4105b1, %block_4105ac
  %277 = phi i64 [ %276, %block_4105ac ], [ %401, %block_.L_4105b1 ]
  %278 = phi i64 [ %239, %block_4105ac ], [ %366, %block_.L_4105b1 ]
  %MEMORY.3 = phi %struct.Memory* [ %MEMORY.2, %block_4105ac ], [ %call2_4105bc, %block_.L_4105b1 ]
  %279 = add i64 %278, -8
  %280 = add i64 %277, 4
  ...
  %call2_4105bc = tail call %struct.Memory* @sub_40c0d0._Z18complete_hash_funcIiET_S0_(%struct.State* %0, i64 %294, %struct.Memory* %MEMORY.3)
  ...
  br i1 %390, label %block_4105dc, label %block_.L_4105b1
...
block_.L_4105e1:                                  ; preds = %block_.L_4105a0, %block_4105dc
  %403 = phi i64 [ %275, %block_.L_4105a0 ], [ %402, %block_4105dc ]
  %404 = phi i64 [ %239, %block_.L_4105a0 ], [ %366, %block_4105dc ]
  %MEMORY.4 = phi %struct.Memory* [ %MEMORY.2, %block_.L_4105a0 ], [ %call2_4105bc, %block_4105dc ]
  %405 = add i64 %404, -32
  %406 = add i64 %403, 3
  ...
  %call2_4105e4 = tail call %struct.Memory* @sub_40c100._Z9check_sumIiEvT_(%struct.State* %0, i64 %410, %struct.Memory* %MEMORY.4)
...
block_.L_4105f7:                                  ; preds = %block_.L_41053f
  ...
  %call2_4105f7 = tail call %struct.Memory* @sub_400df0._Z5timerv(%struct.State* %0, i64 %448, %struct.Memory* %MEMORY.0)
  ...
  %call2_410600 = tail call %struct.Memory* @sub_400790._Z13record_resultdPKc(%struct.State* %0, i64 %459, %struct.Memory* %call2_4105f7)
  ...
  ret %struct.Memory* %call2_410600
}
...
define %struct.Memory* @routine_jge_.L_4105f7(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i8* %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
...
define %struct.Memory* @routine_jl_.L_4105a0(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i8* %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 2, i32 9
...
define %struct.Memory* @routine_jmpq_.L_410571(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
...
define %struct.Memory* @routine_jl_.L_410571(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i8* %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 2, i32 9
...
define %struct.Memory* @routine_jmpq_.L_4105a0(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
...
define %struct.Memory* @routine_jge_.L_4105e1(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i8* %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 2, i32 9
...
define %struct.Memory* @routine_jmpq_.L_4105b1(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
...
define %struct.Memory* @routine_jne_.L_4105b1(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i8* %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
...
define %struct.Memory* @routine_jmpq_.L_4105e1(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
...
define %struct.Memory* @routine_jmpq_.L_41053f(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
