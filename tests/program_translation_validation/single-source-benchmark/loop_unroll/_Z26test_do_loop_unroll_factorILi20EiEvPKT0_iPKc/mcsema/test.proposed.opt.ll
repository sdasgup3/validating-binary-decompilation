...
block_.L_41053f:                                  ; preds = %block_.L_4105e1, %entry
  %68 = phi i64 [ %.pre, %entry ], [ %445, %block_.L_4105e1 ]
...
block_.L_4105b1:                                  ; preds = %block_.L_4105b1, %block_4105ac
  %277 = phi i64 [ %276, %block_4105ac ], [ %400, %block_.L_4105b1 ]
  %278 = phi i64 [ %239, %block_4105ac ], [ %365, %block_.L_4105b1 ]
  ...
  br i1 %389, label %block_4105dc, label %block_.L_4105b1
...
block_.L_4105e1:                                  ; preds = %block_.L_4105a0, %block_4105dc
  %402 = phi i64 [ %275, %block_.L_4105a0 ], [ %401, %block_4105dc ]
  %403 = phi i64 [ %239, %block_.L_4105a0 ], [ %365, %block_4105dc ]
  ...
  %call2_4105e4 = tail call %struct.Memory* @sub_40c100._Z9check_sumIiEvT_(%struct.State* %0, i64 %409, %struct.Memory* %MEMORY.4)
...
block_.L_4105f7:                                  ; preds = %block_.L_41053f
  ...
  %call2_4105f7 = tail call %struct.Memory* @sub_400df0._Z5timerv(%struct.State* %0, i64 %446, %struct.Memory* %MEMORY.0)
  ...
  %call2_410600 = tail call %struct.Memory* @sub_400790._Z13record_resultdPKc(%struct.State* %0, i64 %457, %struct.Memory* %call2_4105f7)
