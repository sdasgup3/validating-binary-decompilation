...
block_.L_4058ef:                                  ; preds = %block_.L_405998, %entry
  %79 = phi i64 [ %.pre, %entry ], [ %429, %block_.L_405998 ]
...
block_.L_405962:                                  ; preds = %block_.L_405962, %block_40595d
  %290 = phi i64 [ %289, %block_40595d ], [ %385, %block_.L_405962 ]
  %291 = phi i64 [ %252, %block_40595d ], [ %350, %block_.L_405962 ]
  ...
  %call2_40596f = tail call %struct.Memory* @sub_401480._Z18complete_hash_funcIdET_S0_(%struct.State* %0, i64 %306, %struct.Memory* %MEMORY.3)
  ...
  br i1 %374, label %block_405993, label %block_.L_405962
...
block_.L_405998:                                  ; preds = %block_.L_405951, %block_405993
  %387 = phi i64 [ %288, %block_.L_405951 ], [ %386, %block_405993 ]
  %388 = phi i64 [ %252, %block_.L_405951 ], [ %350, %block_405993 ]
  ...
  %call2_40599d = tail call %struct.Memory* @sub_4014b0._Z9check_sumIdEvT_(%struct.State* %0, i64 %393, %struct.Memory* %MEMORY.4)
...
block_.L_4059b0:                                  ; preds = %block_.L_4058ef
  ...
  %call2_4059b0 = tail call %struct.Memory* @sub_400df0._Z5timerv(%struct.State* %0, i64 %430, %struct.Memory* %MEMORY.0)
  ...
  %call2_4059b9 = tail call %struct.Memory* @sub_400790._Z13record_resultdPKc(%struct.State* %0, i64 %441, %struct.Memory* %call2_4059b0)
