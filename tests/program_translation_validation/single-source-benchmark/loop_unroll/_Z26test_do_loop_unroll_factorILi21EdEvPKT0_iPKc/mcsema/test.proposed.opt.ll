...
entry:
  ...
  %call2_405923 = tail call %struct.Memory* @sub_400e10._Z11start_timerv(%struct.State* %0, i64 %58, %struct.Memory* %2)
...
block_.L_40592f:                                  ; preds = %block_.L_4059d8, %entry
  %74 = phi i64 [ %.pre, %entry ], [ %424, %block_.L_4059d8 ]
  %MEMORY.0 = phi %struct.Memory* [ %call2_405923, %entry ], [ %call2_4059dd, %block_.L_4059d8 ]
  ...
  br i1 %107, label %block_40593f, label %block_.L_4059f0
...
block_40593f:                                     ; preds = %block_.L_40592f
  ...
  br i1 %154, label %block_.L_405991, label %block_40595d
...
block_.L_405962:                                  ; preds = %block_.L_405962, %block_40595d
  %157 = phi i64 [ %243, %block_.L_405962 ], [ %156, %block_40595d ]
  %158 = phi i64 [ %204, %block_.L_405962 ], [ %118, %block_40595d ]
  %159 = add i64 %158, -40
  ...
  %call2_40596d = tail call %struct.Memory* @sub_4019f0._ZN15loop_inner_bodyILi21EdE7do_workERdPKdi(%struct.State* nonnull %0, i64 %169, %struct.Memory* %MEMORY.0)
  ...
  br i1 %242, label %block_.L_405962, label %block_40598c
...
block_.L_405991:                                  ; preds = %block_40598c, %block_40593f
  %245 = phi i64 [ %244, %block_40598c ], [ %155, %block_40593f ]
  %246 = phi i64 [ %204, %block_40598c ], [ %118, %block_40593f ]
  %247 = add i64 %246, -44
  %248 = add i64 %245, 3
  ...
  br i1 %281, label %block_40599d, label %block_.L_4059d8
...
block_.L_4059a2:                                  ; preds = %block_.L_4059a2, %block_40599d
  %284 = phi i64 [ %380, %block_.L_4059a2 ], [ %283, %block_40599d ]
  %285 = phi i64 [ %345, %block_.L_4059a2 ], [ %246, %block_40599d ]
  %286 = add i64 %285, -8
  %287 = add i64 %284, 4
  ...
  %call2_4059af = tail call %struct.Memory* @sub_4014c0._Z18complete_hash_funcIdET_S0_(%struct.State* nonnull %0, i64 %300, %struct.Memory* %MEMORY.0)
  ...
  br i1 %369, label %block_4059d3, label %block_.L_4059a2
...
block_.L_4059d8:                                  ; preds = %block_.L_405991, %block_4059d3
  %382 = phi i64 [ %282, %block_.L_405991 ], [ %381, %block_4059d3 ]
  %383 = phi i64 [ %246, %block_.L_405991 ], [ %345, %block_4059d3 ]
  %384 = add i64 %383, -40
  %385 = add i64 %382, 5
  ...
  %call2_4059dd = tail call %struct.Memory* @sub_4014f0._Z9check_sumIdEvT_(%struct.State* nonnull %0, i64 %388, %struct.Memory* %MEMORY.0)
...
block_.L_4059f0:                                  ; preds = %block_.L_40592f
  ...
  %call2_4059f0 = tail call %struct.Memory* @sub_400e30._Z5timerv(%struct.State* nonnull %0, i64 %425, %struct.Memory* %MEMORY.0)
  ...
  %call2_4059f9 = tail call %struct.Memory* @sub_4007d0._Z13record_resultdPKc(%struct.State* nonnull %0, i64 %436, %struct.Memory* %call2_4059f0)
