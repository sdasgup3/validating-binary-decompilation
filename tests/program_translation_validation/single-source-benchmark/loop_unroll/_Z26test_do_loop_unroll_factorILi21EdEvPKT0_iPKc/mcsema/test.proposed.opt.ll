...
define %struct.Memory* @_Z26test_do_loop_unroll_factorILi21EdEvPKT0_iPKc(%struct.State* noalias, i64, %struct.Memory* noalias) local_unnamed_addr #1 {
entry:
  ...
  %call2_405913 = tail call %struct.Memory* @sub_400e00._Z11start_timerv(%struct.State* %0, i64 %58, %struct.Memory* %2)
...
block_.L_40591f:                                  ; preds = %block_.L_4059c8, %entry
  %74 = phi i64 [ %.pre, %entry ], [ %424, %block_.L_4059c8 ]
  %MEMORY.0 = phi %struct.Memory* [ %call2_405913, %entry ], [ %call2_4059cd, %block_.L_4059c8 ]
  ...
  br i1 %107, label %block_40592f, label %block_.L_4059e0
...
block_40592f:                                     ; preds = %block_.L_40591f
  ...
  br i1 %154, label %block_.L_405981, label %block_40594d
...
block_.L_405952:                                  ; preds = %block_.L_405952, %block_40594d
  %157 = phi i64 [ %156, %block_40594d ], [ %243, %block_.L_405952 ]
  %158 = phi i64 [ %118, %block_40594d ], [ %204, %block_.L_405952 ]
  %MEMORY.1 = phi %struct.Memory* [ %MEMORY.0, %block_40594d ], [ %call2_40595d, %block_.L_405952 ]
  %159 = add i64 %158, -40
  ...
  %call2_40595d = tail call %struct.Memory* @sub_4019e0._ZN15loop_inner_bodyILi21EdE7do_workERdPKdi(%struct.State* nonnull %0, i64 %169, %struct.Memory* %MEMORY.1)
  ...
  br i1 %242, label %block_.L_405952, label %block_40597c
...
block_.L_405981:                                  ; preds = %block_40597c, %block_40592f
  %245 = phi i64 [ %155, %block_40592f ], [ %244, %block_40597c ]
  %246 = phi i64 [ %118, %block_40592f ], [ %204, %block_40597c ]
  %MEMORY.2 = phi %struct.Memory* [ %MEMORY.0, %block_40592f ], [ %call2_40595d, %block_40597c ]
  %247 = add i64 %246, -44
  %248 = add i64 %245, 3
  ...
  br i1 %281, label %block_40598d, label %block_.L_4059c8
...
block_.L_405992:                                  ; preds = %block_.L_405992, %block_40598d
  %284 = phi i64 [ %283, %block_40598d ], [ %380, %block_.L_405992 ]
  %285 = phi i64 [ %246, %block_40598d ], [ %345, %block_.L_405992 ]
  %MEMORY.3 = phi %struct.Memory* [ %MEMORY.2, %block_40598d ], [ %call2_40599f, %block_.L_405992 ]
  %286 = add i64 %285, -8
  %287 = add i64 %284, 4
  ...
  %call2_40599f = tail call %struct.Memory* @sub_4014b0._Z18complete_hash_funcIdET_S0_(%struct.State* nonnull %0, i64 %300, %struct.Memory* %MEMORY.3)
  ...
  br i1 %369, label %block_4059c3, label %block_.L_405992
...
block_.L_4059c8:                                  ; preds = %block_.L_405981, %block_4059c3
  %382 = phi i64 [ %282, %block_.L_405981 ], [ %381, %block_4059c3 ]
  %383 = phi i64 [ %246, %block_.L_405981 ], [ %345, %block_4059c3 ]
  %MEMORY.4 = phi %struct.Memory* [ %MEMORY.2, %block_.L_405981 ], [ %call2_40599f, %block_4059c3 ]
  %384 = add i64 %383, -40
  %385 = add i64 %382, 5
  ...
  %call2_4059cd = tail call %struct.Memory* @sub_4014e0._Z9check_sumIdEvT_(%struct.State* nonnull %0, i64 %388, %struct.Memory* %MEMORY.4)
...
block_.L_4059e0:                                  ; preds = %block_.L_40591f
  ...
  %call2_4059e0 = tail call %struct.Memory* @sub_400e20._Z5timerv(%struct.State* nonnull %0, i64 %425, %struct.Memory* %MEMORY.0)
  ...
  %call2_4059e9 = tail call %struct.Memory* @sub_4007c0._Z13record_resultdPKc(%struct.State* nonnull %0, i64 %436, %struct.Memory* %call2_4059e0)
  ...
  ret %struct.Memory* %call2_4059e9
}
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_jge_.L_4059e0(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i8* nocapture %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_jl_.L_405981(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i8* nocapture %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 2, i32 9
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_jmpq_.L_405952(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_jl_.L_405952(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i8* nocapture %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 2, i32 9
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_jmpq_.L_405981(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_jge_.L_4059c8(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i8* nocapture %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 2, i32 9
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_jne_.L_405992(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i8* nocapture %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_jmpq_.L_4059c8(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
