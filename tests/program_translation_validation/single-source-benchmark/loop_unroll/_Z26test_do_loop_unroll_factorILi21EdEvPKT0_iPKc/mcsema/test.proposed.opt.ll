...
entry:
  ...
  %call2_4058e3 = tail call %struct.Memory* @sub_400dd0._Z11start_timerv(%struct.State* %0, i64 %58, %struct.Memory* %2)
...
block_.L_4058ef:                                  ; preds = %block_.L_405998, %entry
  %79 = phi i64 [ %.pre, %entry ], [ %433, %block_.L_405998 ]
  %MEMORY.0 = phi %struct.Memory* [ %call2_4058e3, %entry ], [ %call2_40599d, %block_.L_405998 ]
  ...
  br i1 %112, label %block_4058ff, label %block_.L_4059b0
...
block_4058ff:                                     ; preds = %block_.L_4058ef
  ...
  br i1 %160, label %block_.L_405951, label %block_40591d
...
block_.L_405922:                                  ; preds = %block_.L_405922, %block_40591d
  %163 = phi i64 [ %162, %block_40591d ], [ %249, %block_.L_405922 ]
  %164 = phi i64 [ %124, %block_40591d ], [ %210, %block_.L_405922 ]
  %MEMORY.1 = phi %struct.Memory* [ %MEMORY.0, %block_40591d ], [ %call2_40592d, %block_.L_405922 ]
  %165 = add i64 %164, -40
  ...
  %call2_40592d = tail call %struct.Memory* @sub_4019b0._ZN15loop_inner_bodyILi21EdE7do_workERdPKdi(%struct.State* %0, i64 %175, %struct.Memory* %MEMORY.1)
  ...
  br i1 %248, label %block_.L_405922, label %block_40594c
...
block_.L_405951:                                  ; preds = %block_40594c, %block_4058ff
  %251 = phi i64 [ %161, %block_4058ff ], [ %250, %block_40594c ]
  %252 = phi i64 [ %124, %block_4058ff ], [ %210, %block_40594c ]
  %MEMORY.2 = phi %struct.Memory* [ %MEMORY.0, %block_4058ff ], [ %call2_40592d, %block_40594c ]
  %253 = add i64 %252, -44
  %254 = add i64 %251, 3
  ...
  br i1 %287, label %block_40595d, label %block_.L_405998
...
block_.L_405962:                                  ; preds = %block_.L_405962, %block_40595d
  %290 = phi i64 [ %289, %block_40595d ], [ %387, %block_.L_405962 ]
  %291 = phi i64 [ %252, %block_40595d ], [ %352, %block_.L_405962 ]
  %MEMORY.3 = phi %struct.Memory* [ %MEMORY.2, %block_40595d ], [ %call2_40596f, %block_.L_405962 ]
  %292 = add i64 %291, -8
  %293 = add i64 %290, 4
  ...
  %call2_40596f = tail call %struct.Memory* @sub_401480._Z18complete_hash_funcIdET_S0_(%struct.State* %0, i64 %307, %struct.Memory* %MEMORY.3)
  ...
  br i1 %376, label %block_405993, label %block_.L_405962
...
block_.L_405998:                                  ; preds = %block_.L_405951, %block_405993
  %389 = phi i64 [ %288, %block_.L_405951 ], [ %388, %block_405993 ]
  %390 = phi i64 [ %252, %block_.L_405951 ], [ %352, %block_405993 ]
  %MEMORY.4 = phi %struct.Memory* [ %MEMORY.2, %block_.L_405951 ], [ %call2_40596f, %block_405993 ]
  %391 = add i64 %390, -40
  %392 = add i64 %389, 5
  ...
  %call2_40599d = tail call %struct.Memory* @sub_4014b0._Z9check_sumIdEvT_(%struct.State* %0, i64 %396, %struct.Memory* %MEMORY.4)
...
block_.L_4059b0:                                  ; preds = %block_.L_4058ef
  ...
  %call2_4059b0 = tail call %struct.Memory* @sub_400df0._Z5timerv(%struct.State* %0, i64 %434, %struct.Memory* %MEMORY.0)
  ...
  %call2_4059b9 = tail call %struct.Memory* @sub_400790._Z13record_resultdPKc(%struct.State* %0, i64 %445, %struct.Memory* %call2_4059b0)
  ...
  ret %struct.Memory* %call2_4059b9
}
...
define %struct.Memory* @routine_jge_.L_4059b0(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i8* %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
...
define %struct.Memory* @routine_jl_.L_405951(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i8* %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 2, i32 9
...
define %struct.Memory* @routine_jmpq_.L_405922(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
...
define %struct.Memory* @routine_jl_.L_405922(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i8* %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 2, i32 9
...
define %struct.Memory* @routine_jmpq_.L_405951(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
...
define %struct.Memory* @routine_jge_.L_405998(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i8* %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 2, i32 9
...
define %struct.Memory* @routine_jmpq_.L_405962(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
...
define %struct.Memory* @routine_jne_.L_405962(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i8* %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
...
define %struct.Memory* @routine_jmpq_.L_405998(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
...
define %struct.Memory* @routine_jmpq_.L_4058ef(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
