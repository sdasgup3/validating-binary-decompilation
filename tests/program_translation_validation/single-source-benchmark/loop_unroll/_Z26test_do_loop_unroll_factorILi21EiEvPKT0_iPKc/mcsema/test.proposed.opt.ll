...
block_.L_4103ff:                                  ; preds = %block_.L_4104a1, %entry
  %68 = phi i64 [ %.pre, %entry ], [ %445, %block_.L_4104a1 ]
...
block_.L_410471:                                  ; preds = %block_.L_410471, %block_41046c
  %277 = phi i64 [ %276, %block_41046c ], [ %400, %block_.L_410471 ]
  %278 = phi i64 [ %239, %block_41046c ], [ %365, %block_.L_410471 ]
  ...
  br i1 %389, label %block_41049c, label %block_.L_410471
...
block_.L_4104a1:                                  ; preds = %block_.L_410460, %block_41049c
  %402 = phi i64 [ %275, %block_.L_410460 ], [ %401, %block_41049c ]
  %403 = phi i64 [ %239, %block_.L_410460 ], [ %365, %block_41049c ]
  ...
  %call2_4104a4 = tail call %struct.Memory* @sub_40c100._Z9check_sumIiEvT_(%struct.State* %0, i64 %409, %struct.Memory* %MEMORY.4)
...
block_.L_4104b7:                                  ; preds = %block_.L_4103ff
  ...
  %call2_4104b7 = tail call %struct.Memory* @sub_400df0._Z5timerv(%struct.State* %0, i64 %446, %struct.Memory* %MEMORY.0)
  ...
  %call2_4104c0 = tail call %struct.Memory* @sub_400790._Z13record_resultdPKc(%struct.State* %0, i64 %457, %struct.Memory* %call2_4104b7)
