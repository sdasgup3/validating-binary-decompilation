...
define %struct.Memory* @_Z26test_do_loop_unroll_factorILi21EiEvPKT0_iPKc(%struct.State* noalias, i64, %struct.Memory* noalias) local_unnamed_addr #1 {
entry:
  ...
  %call2_410423 = tail call %struct.Memory* @sub_400e00._Z11start_timerv(%struct.State* %0, i64 %58, %struct.Memory* %2)
...
block_.L_41042f:                                  ; preds = %block_.L_4104d1, %entry
  %68 = phi i64 [ %.pre, %entry ], [ %445, %block_.L_4104d1 ]
  %MEMORY.0 = phi %struct.Memory* [ %call2_410423, %entry ], [ %call2_4104d4, %block_.L_4104d1 ]
  ...
  br i1 %101, label %block_41043f, label %block_.L_4104e7

block_41043f:                                     ; preds = %block_.L_41042f
  %103 = add i64 %69, -32
  %104 = add i64 %102, 7
  ...
  br i1 %147, label %block_.L_410490, label %block_41045c

block_41045c:                                     ; preds = %block_41043f
  %149 = add i64 %148, 5
  store i64 %149, i64* %3, align 8
  br label %block_.L_410461

block_.L_410461:                                  ; preds = %block_.L_410461, %block_41045c
  %150 = phi i64 [ %149, %block_41045c ], [ %236, %block_.L_410461 ]
  %151 = phi i64 [ %111, %block_41045c ], [ %197, %block_.L_410461 ]
  %MEMORY.1 = phi %struct.Memory* [ %MEMORY.0, %block_41045c ], [ %call2_41046c, %block_.L_410461 ]
  %152 = add i64 %151, -32
  ...
  %call2_41046c = tail call %struct.Memory* @sub_40c5a0._ZN15loop_inner_bodyILi21EiE7do_workERiPKii(%struct.State* nonnull %0, i64 %162, %struct.Memory* %MEMORY.1)
  ...
  br i1 %235, label %block_.L_410461, label %block_41048b

block_41048b:                                     ; preds = %block_.L_410461
  %237 = add i64 %236, 5
  store i64 %237, i64* %3, align 8
  br label %block_.L_410490

block_.L_410490:                                  ; preds = %block_41048b, %block_41043f
  %238 = phi i64 [ %148, %block_41043f ], [ %237, %block_41048b ]
  %239 = phi i64 [ %111, %block_41043f ], [ %197, %block_41048b ]
  %MEMORY.2 = phi %struct.Memory* [ %MEMORY.0, %block_41043f ], [ %call2_41046c, %block_41048b ]
  %240 = add i64 %239, -36
  %241 = add i64 %238, 3
  ...
  br i1 %274, label %block_41049c, label %block_.L_4104d1

block_41049c:                                     ; preds = %block_.L_410490
  %276 = add i64 %275, 5
  store i64 %276, i64* %3, align 8
  br label %block_.L_4104a1

block_.L_4104a1:                                  ; preds = %block_.L_4104a1, %block_41049c
  %277 = phi i64 [ %276, %block_41049c ], [ %400, %block_.L_4104a1 ]
  %278 = phi i64 [ %239, %block_41049c ], [ %365, %block_.L_4104a1 ]
  %MEMORY.3 = phi %struct.Memory* [ %MEMORY.2, %block_41049c ], [ %call2_4104ac, %block_.L_4104a1 ]
  %279 = add i64 %278, -8
  %280 = add i64 %277, 4
  ...
  %call2_4104ac = tail call %struct.Memory* @sub_40c100._Z18complete_hash_funcIiET_S0_(%struct.State* nonnull %0, i64 %294, %struct.Memory* %MEMORY.3)
  ...
  br i1 %389, label %block_4104cc, label %block_.L_4104a1

block_4104cc:                                     ; preds = %block_.L_4104a1
  %401 = add i64 %400, 5
  store i64 %401, i64* %3, align 8
  br label %block_.L_4104d1

block_.L_4104d1:                                  ; preds = %block_.L_410490, %block_4104cc
  %402 = phi i64 [ %275, %block_.L_410490 ], [ %401, %block_4104cc ]
  %403 = phi i64 [ %239, %block_.L_410490 ], [ %365, %block_4104cc ]
  %MEMORY.4 = phi %struct.Memory* [ %MEMORY.2, %block_.L_410490 ], [ %call2_4104ac, %block_4104cc ]
  %404 = add i64 %403, -32
  %405 = add i64 %402, 3
  ...
  %call2_4104d4 = tail call %struct.Memory* @sub_40c130._Z9check_sumIiEvT_(%struct.State* nonnull %0, i64 %409, %struct.Memory* %MEMORY.4)
...
block_.L_4104e7:                                  ; preds = %block_.L_41042f
  %446 = add i64 %102, -63175
  %447 = add i64 %102, 5
  ...
  %call2_4104e7 = tail call %struct.Memory* @sub_400e20._Z5timerv(%struct.State* nonnull %0, i64 %446, %struct.Memory* %MEMORY.0)
  ...
  %call2_4104f0 = tail call %struct.Memory* @sub_4007c0._Z13record_resultdPKc(%struct.State* nonnull %0, i64 %457, %struct.Memory* %call2_4104e7)
  ...
  ret %struct.Memory* %call2_4104f0
}
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_jge_.L_4104e7(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i8* nocapture %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_jl_.L_410490(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i8* nocapture %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 2, i32 9
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_jmpq_.L_410461(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_jl_.L_410461(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i8* nocapture %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 2, i32 9
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_jmpq_.L_410490(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_jge_.L_4104d1(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i8* nocapture %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 2, i32 9
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_jmpq_.L_4104a1(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_jne_.L_4104a1(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i8* nocapture %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_jmpq_.L_4104d1(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_jmpq_.L_41042f(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
