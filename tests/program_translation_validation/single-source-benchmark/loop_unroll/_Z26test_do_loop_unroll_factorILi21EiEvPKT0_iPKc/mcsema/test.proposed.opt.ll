...
define %struct.Memory* @_Z26test_do_loop_unroll_factorILi21EiEvPKT0_iPKc(%struct.State* noalias, i64, %struct.Memory* noalias readnone) local_unnamed_addr #1 {
entry:
...
block_.L_410461:                                  ; preds = %block_.L_410461, %block_41045c
  %150 = phi i64 [ %236, %block_.L_410461 ], [ %149, %block_41045c ]
  %151 = phi i64 [ %197, %block_.L_410461 ], [ %111, %block_41045c ]
  %152 = add i64 %151, -32
  ...
  %call2_41046c = tail call %struct.Memory* @sub_40c5a0._ZN15loop_inner_bodyILi21EiE7do_workERiPKii(%struct.State* nonnull %0, i64 %162, %struct.Memory* %MEMORY.0)
...
block_.L_410490:                                  ; preds = %block_41048b, %block_41043f
  %238 = phi i64 [ %237, %block_41048b ], [ %148, %block_41043f ]
  %239 = phi i64 [ %197, %block_41048b ], [ %111, %block_41043f ]
  %240 = add i64 %239, -36
  %241 = add i64 %238, 3
...
block_.L_4104a1:                                  ; preds = %block_.L_4104a1, %block_41049c
  %277 = phi i64 [ %400, %block_.L_4104a1 ], [ %276, %block_41049c ]
  %278 = phi i64 [ %365, %block_.L_4104a1 ], [ %239, %block_41049c ]
  %279 = add i64 %278, -8
  %280 = add i64 %277, 4
  ...
  %call2_4104ac = tail call %struct.Memory* @sub_40c100._Z18complete_hash_funcIiET_S0_(%struct.State* nonnull %0, i64 %294, %struct.Memory* %MEMORY.0)
...
block_.L_4104d1:                                  ; preds = %block_.L_410490, %block_4104cc
  ...
  %call2_4104d4 = tail call %struct.Memory* @sub_40c130._Z9check_sumIiEvT_(%struct.State* nonnull %0, i64 %409, %struct.Memory* %MEMORY.0)
