...
entry:
  ...
  %call2_4103f3 = tail call %struct.Memory* @sub_400dd0._Z11start_timerv(%struct.State* %0, i64 %58, %struct.Memory* %2)
...
block_.L_4103ff:                                  ; preds = %block_.L_4104a1, %entry
  %68 = phi i64 [ %.pre, %entry ], [ %447, %block_.L_4104a1 ]
  %MEMORY.0 = phi %struct.Memory* [ %call2_4103f3, %entry ], [ %call2_4104a4, %block_.L_4104a1 ]
  ...
  br i1 %101, label %block_41040f, label %block_.L_4104b7

block_41040f:                                     ; preds = %block_.L_4103ff
  %103 = add i64 %69, -32
  %104 = add i64 %102, 7
  ...
  br i1 %147, label %block_.L_410460, label %block_41042c

block_41042c:                                     ; preds = %block_41040f
  %149 = add i64 %148, 5
  store i64 %149, i64* %3, align 8
  br label %block_.L_410431

block_.L_410431:                                  ; preds = %block_.L_410431, %block_41042c
  %150 = phi i64 [ %149, %block_41042c ], [ %236, %block_.L_410431 ]
  %151 = phi i64 [ %111, %block_41042c ], [ %197, %block_.L_410431 ]
  %MEMORY.1 = phi %struct.Memory* [ %MEMORY.0, %block_41042c ], [ %call2_41043c, %block_.L_410431 ]
  %152 = add i64 %151, -32
  ...
  %call2_41043c = tail call %struct.Memory* @sub_40c570._ZN15loop_inner_bodyILi21EiE7do_workERiPKii(%struct.State* %0, i64 %162, %struct.Memory* %MEMORY.1)
  ...
  br i1 %235, label %block_.L_410431, label %block_41045b

block_41045b:                                     ; preds = %block_.L_410431
  %237 = add i64 %236, 5
  store i64 %237, i64* %3, align 8
  br label %block_.L_410460

block_.L_410460:                                  ; preds = %block_41045b, %block_41040f
  %238 = phi i64 [ %148, %block_41040f ], [ %237, %block_41045b ]
  %239 = phi i64 [ %111, %block_41040f ], [ %197, %block_41045b ]
  %MEMORY.2 = phi %struct.Memory* [ %MEMORY.0, %block_41040f ], [ %call2_41043c, %block_41045b ]
  %240 = add i64 %239, -36
  %241 = add i64 %238, 3
  ...
  br i1 %274, label %block_41046c, label %block_.L_4104a1

block_41046c:                                     ; preds = %block_.L_410460
  %276 = add i64 %275, 5
  store i64 %276, i64* %3, align 8
  br label %block_.L_410471

block_.L_410471:                                  ; preds = %block_.L_410471, %block_41046c
  %277 = phi i64 [ %276, %block_41046c ], [ %401, %block_.L_410471 ]
  %278 = phi i64 [ %239, %block_41046c ], [ %366, %block_.L_410471 ]
  %MEMORY.3 = phi %struct.Memory* [ %MEMORY.2, %block_41046c ], [ %call2_41047c, %block_.L_410471 ]
  %279 = add i64 %278, -8
  %280 = add i64 %277, 4
  ...
  %call2_41047c = tail call %struct.Memory* @sub_40c0d0._Z18complete_hash_funcIiET_S0_(%struct.State* %0, i64 %294, %struct.Memory* %MEMORY.3)
  ...
  br i1 %390, label %block_41049c, label %block_.L_410471

block_41049c:                                     ; preds = %block_.L_410471
  %402 = add i64 %401, 5
  store i64 %402, i64* %3, align 8
  br label %block_.L_4104a1

block_.L_4104a1:                                  ; preds = %block_.L_410460, %block_41049c
  %403 = phi i64 [ %275, %block_.L_410460 ], [ %402, %block_41049c ]
  %404 = phi i64 [ %239, %block_.L_410460 ], [ %366, %block_41049c ]
  %MEMORY.4 = phi %struct.Memory* [ %MEMORY.2, %block_.L_410460 ], [ %call2_41047c, %block_41049c ]
  %405 = add i64 %404, -32
  %406 = add i64 %403, 3
  ...
  %call2_4104a4 = tail call %struct.Memory* @sub_40c100._Z9check_sumIiEvT_(%struct.State* %0, i64 %410, %struct.Memory* %MEMORY.4)
...
block_.L_4104b7:                                  ; preds = %block_.L_4103ff
  %448 = add i64 %102, -63175
  %449 = add i64 %102, 5
  ...
  %call2_4104b7 = tail call %struct.Memory* @sub_400df0._Z5timerv(%struct.State* %0, i64 %448, %struct.Memory* %MEMORY.0)
  ...
  %call2_4104c0 = tail call %struct.Memory* @sub_400790._Z13record_resultdPKc(%struct.State* %0, i64 %459, %struct.Memory* %call2_4104b7)
  ...
  ret %struct.Memory* %call2_4104c0
}
...
define %struct.Memory* @routine_jge_.L_4104b7(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i8* %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
...
define %struct.Memory* @routine_jl_.L_410460(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i8* %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 2, i32 9
...
define %struct.Memory* @routine_jmpq_.L_410431(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
...
define %struct.Memory* @routine_jl_.L_410431(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i8* %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 2, i32 9
...
define %struct.Memory* @routine_jmpq_.L_410460(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
...
define %struct.Memory* @routine_jge_.L_4104a1(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i8* %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 2, i32 9
...
define %struct.Memory* @routine_jmpq_.L_410471(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
...
define %struct.Memory* @routine_jne_.L_410471(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i8* %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
...
define %struct.Memory* @routine_jmpq_.L_4104a1(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
...
define %struct.Memory* @routine_jmpq_.L_4103ff(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
