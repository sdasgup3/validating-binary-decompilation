...
entry:
  ...
  %call2_410433 = tail call %struct.Memory* @sub_400e10._Z11start_timerv(%struct.State* %0, i64 %58, %struct.Memory* %2)
...
block_.L_41043f:                                  ; preds = %block_.L_4104e1, %entry
  %68 = phi i64 [ %.pre, %entry ], [ %445, %block_.L_4104e1 ]
  %MEMORY.0 = phi %struct.Memory* [ %call2_410433, %entry ], [ %call2_4104e4, %block_.L_4104e1 ]
  ...
  br i1 %101, label %block_41044f, label %block_.L_4104f7

block_41044f:                                     ; preds = %block_.L_41043f
  %103 = add i64 %69, -32
  %104 = add i64 %102, 7
  ...
  br i1 %147, label %block_.L_4104a0, label %block_41046c

block_41046c:                                     ; preds = %block_41044f
  %149 = add i64 %148, 5
  store i64 %149, i64* %3, align 8
  br label %block_.L_410471

block_.L_410471:                                  ; preds = %block_.L_410471, %block_41046c
  %150 = phi i64 [ %236, %block_.L_410471 ], [ %149, %block_41046c ]
  %151 = phi i64 [ %197, %block_.L_410471 ], [ %111, %block_41046c ]
  %152 = add i64 %151, -32
  ...
  %call2_41047c = tail call %struct.Memory* @sub_40c5b0._ZN15loop_inner_bodyILi21EiE7do_workERiPKii(%struct.State* nonnull %0, i64 %162, %struct.Memory* %MEMORY.0)
  ...
  br i1 %235, label %block_.L_410471, label %block_41049b

block_41049b:                                     ; preds = %block_.L_410471
  %237 = add i64 %236, 5
  store i64 %237, i64* %3, align 8
  br label %block_.L_4104a0

block_.L_4104a0:                                  ; preds = %block_41049b, %block_41044f
  %238 = phi i64 [ %237, %block_41049b ], [ %148, %block_41044f ]
  %239 = phi i64 [ %197, %block_41049b ], [ %111, %block_41044f ]
  %240 = add i64 %239, -36
  %241 = add i64 %238, 3
  ...
  br i1 %274, label %block_4104ac, label %block_.L_4104e1

block_4104ac:                                     ; preds = %block_.L_4104a0
  %276 = add i64 %275, 5
  store i64 %276, i64* %3, align 8
  br label %block_.L_4104b1

block_.L_4104b1:                                  ; preds = %block_.L_4104b1, %block_4104ac
  %277 = phi i64 [ %400, %block_.L_4104b1 ], [ %276, %block_4104ac ]
  %278 = phi i64 [ %365, %block_.L_4104b1 ], [ %239, %block_4104ac ]
  %279 = add i64 %278, -8
  %280 = add i64 %277, 4
  ...
  %call2_4104bc = tail call %struct.Memory* @sub_40c110._Z18complete_hash_funcIiET_S0_(%struct.State* nonnull %0, i64 %294, %struct.Memory* %MEMORY.0)
  ...
  br i1 %389, label %block_4104dc, label %block_.L_4104b1

block_4104dc:                                     ; preds = %block_.L_4104b1
  %401 = add i64 %400, 5
  store i64 %401, i64* %3, align 8
  br label %block_.L_4104e1

block_.L_4104e1:                                  ; preds = %block_.L_4104a0, %block_4104dc
  %402 = phi i64 [ %275, %block_.L_4104a0 ], [ %401, %block_4104dc ]
  %403 = phi i64 [ %239, %block_.L_4104a0 ], [ %365, %block_4104dc ]
  %404 = add i64 %403, -32
  %405 = add i64 %402, 3
  ...
  %call2_4104e4 = tail call %struct.Memory* @sub_40c140._Z9check_sumIiEvT_(%struct.State* nonnull %0, i64 %409, %struct.Memory* %MEMORY.0)
...
block_.L_4104f7:                                  ; preds = %block_.L_41043f
  ...
  %call2_4104f7 = tail call %struct.Memory* @sub_400e30._Z5timerv(%struct.State* nonnull %0, i64 %446, %struct.Memory* %MEMORY.0)
  ...
  %call2_410500 = tail call %struct.Memory* @sub_4007d0._Z13record_resultdPKc(%struct.State* nonnull %0, i64 %457, %struct.Memory* %call2_4104f7)
