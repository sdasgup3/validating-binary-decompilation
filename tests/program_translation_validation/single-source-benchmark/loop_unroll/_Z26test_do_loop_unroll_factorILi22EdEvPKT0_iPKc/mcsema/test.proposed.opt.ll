...
block_.L_405802:                                  ; preds = %block_.L_405802, %block_4057fd
  %157 = phi i64 [ %243, %block_.L_405802 ], [ %156, %block_4057fd ]
  %158 = phi i64 [ %204, %block_.L_405802 ], [ %118, %block_4057fd ]
  %159 = add i64 %158, -40
  ...
  %call2_40580d = tail call %struct.Memory* @sub_401980._ZN15loop_inner_bodyILi22EdE7do_workERdPKdi(%struct.State* nonnull %0, i64 %169, %struct.Memory* %MEMORY.0)
...
block_.L_405831:                                  ; preds = %block_40582c, %block_4057df
  %245 = phi i64 [ %244, %block_40582c ], [ %155, %block_4057df ]
  %246 = phi i64 [ %204, %block_40582c ], [ %118, %block_4057df ]
  %247 = add i64 %246, -44
  %248 = add i64 %245, 3
...
block_.L_405842:                                  ; preds = %block_.L_405842, %block_40583d
  %284 = phi i64 [ %380, %block_.L_405842 ], [ %283, %block_40583d ]
  %285 = phi i64 [ %345, %block_.L_405842 ], [ %246, %block_40583d ]
  %286 = add i64 %285, -8
  %287 = add i64 %284, 4
  ...
  %call2_40584f = tail call %struct.Memory* @sub_4014b0._Z18complete_hash_funcIdET_S0_(%struct.State* nonnull %0, i64 %300, %struct.Memory* %MEMORY.0)
...
block_.L_405878:                                  ; preds = %block_.L_405831, %block_405873
  ...
  %call2_40587d = tail call %struct.Memory* @sub_4014e0._Z9check_sumIdEvT_(%struct.State* nonnull %0, i64 %388, %struct.Memory* %MEMORY.0)
