...
define %struct.Memory* @_Z26test_do_loop_unroll_factorILi22EdEvPKT0_iPKc(%struct.State* noalias, i64, %struct.Memory* noalias) local_unnamed_addr #1 {
entry:
  ...
  %call2_4057c3 = tail call %struct.Memory* @sub_400e00._Z11start_timerv(%struct.State* %0, i64 %58, %struct.Memory* %2)
...
block_.L_4057cf:                                  ; preds = %block_.L_405878, %entry
  %74 = phi i64 [ %.pre, %entry ], [ %424, %block_.L_405878 ]
  %MEMORY.0 = phi %struct.Memory* [ %call2_4057c3, %entry ], [ %call2_40587d, %block_.L_405878 ]
  ...
  br i1 %107, label %block_4057df, label %block_.L_405890
...
block_4057df:                                     ; preds = %block_.L_4057cf
  ...
  br i1 %154, label %block_.L_405831, label %block_4057fd
...
block_.L_405802:                                  ; preds = %block_.L_405802, %block_4057fd
  %157 = phi i64 [ %156, %block_4057fd ], [ %243, %block_.L_405802 ]
  %158 = phi i64 [ %118, %block_4057fd ], [ %204, %block_.L_405802 ]
  %MEMORY.1 = phi %struct.Memory* [ %MEMORY.0, %block_4057fd ], [ %call2_40580d, %block_.L_405802 ]
  %159 = add i64 %158, -40
  ...
  %call2_40580d = tail call %struct.Memory* @sub_401980._ZN15loop_inner_bodyILi22EdE7do_workERdPKdi(%struct.State* nonnull %0, i64 %169, %struct.Memory* %MEMORY.1)
  ...
  br i1 %242, label %block_.L_405802, label %block_40582c
...
block_.L_405831:                                  ; preds = %block_40582c, %block_4057df
  %245 = phi i64 [ %155, %block_4057df ], [ %244, %block_40582c ]
  %246 = phi i64 [ %118, %block_4057df ], [ %204, %block_40582c ]
  %MEMORY.2 = phi %struct.Memory* [ %MEMORY.0, %block_4057df ], [ %call2_40580d, %block_40582c ]
  %247 = add i64 %246, -44
  %248 = add i64 %245, 3
  ...
  br i1 %281, label %block_40583d, label %block_.L_405878
...
block_.L_405842:                                  ; preds = %block_.L_405842, %block_40583d
  %284 = phi i64 [ %283, %block_40583d ], [ %380, %block_.L_405842 ]
  %285 = phi i64 [ %246, %block_40583d ], [ %345, %block_.L_405842 ]
  %MEMORY.3 = phi %struct.Memory* [ %MEMORY.2, %block_40583d ], [ %call2_40584f, %block_.L_405842 ]
  %286 = add i64 %285, -8
  %287 = add i64 %284, 4
  ...
  %call2_40584f = tail call %struct.Memory* @sub_4014b0._Z18complete_hash_funcIdET_S0_(%struct.State* nonnull %0, i64 %300, %struct.Memory* %MEMORY.3)
  ...
  br i1 %369, label %block_405873, label %block_.L_405842
...
block_.L_405878:                                  ; preds = %block_.L_405831, %block_405873
  %382 = phi i64 [ %282, %block_.L_405831 ], [ %381, %block_405873 ]
  %383 = phi i64 [ %246, %block_.L_405831 ], [ %345, %block_405873 ]
  %MEMORY.4 = phi %struct.Memory* [ %MEMORY.2, %block_.L_405831 ], [ %call2_40584f, %block_405873 ]
  %384 = add i64 %383, -40
  %385 = add i64 %382, 5
  ...
  %call2_40587d = tail call %struct.Memory* @sub_4014e0._Z9check_sumIdEvT_(%struct.State* nonnull %0, i64 %388, %struct.Memory* %MEMORY.4)
...
block_.L_405890:                                  ; preds = %block_.L_4057cf
  ...
  %call2_405890 = tail call %struct.Memory* @sub_400e20._Z5timerv(%struct.State* nonnull %0, i64 %425, %struct.Memory* %MEMORY.0)
  ...
  %call2_405899 = tail call %struct.Memory* @sub_4007c0._Z13record_resultdPKc(%struct.State* nonnull %0, i64 %436, %struct.Memory* %call2_405890)
  ...
  ret %struct.Memory* %call2_405899
}
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_jge_.L_405890(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i8* nocapture %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_jl_.L_405831(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i8* nocapture %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 2, i32 9
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_jmpq_.L_405802(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_jl_.L_405802(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i8* nocapture %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 2, i32 9
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_jmpq_.L_405831(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_jge_.L_405878(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i8* nocapture %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 2, i32 9
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_jmpq_.L_405842(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_jne_.L_405842(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i8* nocapture %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_jmpq_.L_405878(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_jmpq_.L_4057cf(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
