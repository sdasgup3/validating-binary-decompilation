...
entry:
  ...
  %call2_4057d3 = tail call %struct.Memory* @sub_400e10._Z11start_timerv(%struct.State* %0, i64 %58, %struct.Memory* %2)
...
block_.L_4057df:                                  ; preds = %block_.L_405888, %entry
  %74 = phi i64 [ %.pre, %entry ], [ %424, %block_.L_405888 ]
  %MEMORY.0 = phi %struct.Memory* [ %call2_4057d3, %entry ], [ %call2_40588d, %block_.L_405888 ]
  ...
  br i1 %107, label %block_4057ef, label %block_.L_4058a0
...
block_4057ef:                                     ; preds = %block_.L_4057df
  ...
  br i1 %154, label %block_.L_405841, label %block_40580d
...
block_.L_405812:                                  ; preds = %block_.L_405812, %block_40580d
  %157 = phi i64 [ %243, %block_.L_405812 ], [ %156, %block_40580d ]
  %158 = phi i64 [ %204, %block_.L_405812 ], [ %118, %block_40580d ]
  %159 = add i64 %158, -40
  ...
  %call2_40581d = tail call %struct.Memory* @sub_401990._ZN15loop_inner_bodyILi22EdE7do_workERdPKdi(%struct.State* nonnull %0, i64 %169, %struct.Memory* %MEMORY.0)
  ...
  br i1 %242, label %block_.L_405812, label %block_40583c
...
block_.L_405841:                                  ; preds = %block_40583c, %block_4057ef
  %245 = phi i64 [ %244, %block_40583c ], [ %155, %block_4057ef ]
  %246 = phi i64 [ %204, %block_40583c ], [ %118, %block_4057ef ]
  %247 = add i64 %246, -44
  %248 = add i64 %245, 3
  ...
  br i1 %281, label %block_40584d, label %block_.L_405888
...
block_.L_405852:                                  ; preds = %block_.L_405852, %block_40584d
  %284 = phi i64 [ %380, %block_.L_405852 ], [ %283, %block_40584d ]
  %285 = phi i64 [ %345, %block_.L_405852 ], [ %246, %block_40584d ]
  %286 = add i64 %285, -8
  %287 = add i64 %284, 4
  ...
  %call2_40585f = tail call %struct.Memory* @sub_4014c0._Z18complete_hash_funcIdET_S0_(%struct.State* nonnull %0, i64 %300, %struct.Memory* %MEMORY.0)
  ...
  br i1 %369, label %block_405883, label %block_.L_405852
...
block_.L_405888:                                  ; preds = %block_.L_405841, %block_405883
  %382 = phi i64 [ %282, %block_.L_405841 ], [ %381, %block_405883 ]
  %383 = phi i64 [ %246, %block_.L_405841 ], [ %345, %block_405883 ]
  %384 = add i64 %383, -40
  %385 = add i64 %382, 5
  ...
  %call2_40588d = tail call %struct.Memory* @sub_4014f0._Z9check_sumIdEvT_(%struct.State* nonnull %0, i64 %388, %struct.Memory* %MEMORY.0)
...
block_.L_4058a0:                                  ; preds = %block_.L_4057df
  ...
  %call2_4058a0 = tail call %struct.Memory* @sub_400e30._Z5timerv(%struct.State* nonnull %0, i64 %425, %struct.Memory* %MEMORY.0)
  ...
  %call2_4058a9 = tail call %struct.Memory* @sub_4007d0._Z13record_resultdPKc(%struct.State* nonnull %0, i64 %436, %struct.Memory* %call2_4058a0)
