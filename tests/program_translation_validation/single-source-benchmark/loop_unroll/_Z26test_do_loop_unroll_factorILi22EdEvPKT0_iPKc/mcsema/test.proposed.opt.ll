...
entry:
  ...
  %call2_405793 = tail call %struct.Memory* @sub_400dd0._Z11start_timerv(%struct.State* %0, i64 %58, %struct.Memory* %2)
...
block_.L_40579f:                                  ; preds = %block_.L_405848, %entry
  %79 = phi i64 [ %.pre, %entry ], [ %429, %block_.L_405848 ]
  %MEMORY.0 = phi %struct.Memory* [ %call2_405793, %entry ], [ %call2_40584d, %block_.L_405848 ]
  ...
  br i1 %112, label %block_4057af, label %block_.L_405860
...
block_4057af:                                     ; preds = %block_.L_40579f
  ...
  br i1 %160, label %block_.L_405801, label %block_4057cd
...
block_.L_4057d2:                                  ; preds = %block_.L_4057d2, %block_4057cd
  %163 = phi i64 [ %162, %block_4057cd ], [ %249, %block_.L_4057d2 ]
  %164 = phi i64 [ %124, %block_4057cd ], [ %210, %block_.L_4057d2 ]
  %MEMORY.1 = phi %struct.Memory* [ %MEMORY.0, %block_4057cd ], [ %call2_4057dd, %block_.L_4057d2 ]
  %165 = add i64 %164, -40
  ...
  %call2_4057dd = tail call %struct.Memory* @sub_401950._ZN15loop_inner_bodyILi22EdE7do_workERdPKdi(%struct.State* %0, i64 %175, %struct.Memory* %MEMORY.1)
  ...
  br i1 %248, label %block_.L_4057d2, label %block_4057fc
...
block_.L_405801:                                  ; preds = %block_4057fc, %block_4057af
  %251 = phi i64 [ %161, %block_4057af ], [ %250, %block_4057fc ]
  %252 = phi i64 [ %124, %block_4057af ], [ %210, %block_4057fc ]
  %MEMORY.2 = phi %struct.Memory* [ %MEMORY.0, %block_4057af ], [ %call2_4057dd, %block_4057fc ]
  %253 = add i64 %252, -44
  %254 = add i64 %251, 3
  ...
  br i1 %287, label %block_40580d, label %block_.L_405848
...
block_.L_405812:                                  ; preds = %block_.L_405812, %block_40580d
  %290 = phi i64 [ %289, %block_40580d ], [ %385, %block_.L_405812 ]
  %291 = phi i64 [ %252, %block_40580d ], [ %350, %block_.L_405812 ]
  %MEMORY.3 = phi %struct.Memory* [ %MEMORY.2, %block_40580d ], [ %call2_40581f, %block_.L_405812 ]
  %292 = add i64 %291, -8
  %293 = add i64 %290, 4
  ...
  %call2_40581f = tail call %struct.Memory* @sub_401480._Z18complete_hash_funcIdET_S0_(%struct.State* %0, i64 %306, %struct.Memory* %MEMORY.3)
  ...
  br i1 %374, label %block_405843, label %block_.L_405812
...
block_.L_405848:                                  ; preds = %block_.L_405801, %block_405843
  %387 = phi i64 [ %288, %block_.L_405801 ], [ %386, %block_405843 ]
  %388 = phi i64 [ %252, %block_.L_405801 ], [ %350, %block_405843 ]
  %MEMORY.4 = phi %struct.Memory* [ %MEMORY.2, %block_.L_405801 ], [ %call2_40581f, %block_405843 ]
  %389 = add i64 %388, -40
  %390 = add i64 %387, 5
  ...
  %call2_40584d = tail call %struct.Memory* @sub_4014b0._Z9check_sumIdEvT_(%struct.State* %0, i64 %393, %struct.Memory* %MEMORY.4)
...
block_.L_405860:                                  ; preds = %block_.L_40579f
  ...
  %call2_405860 = tail call %struct.Memory* @sub_400df0._Z5timerv(%struct.State* %0, i64 %430, %struct.Memory* %MEMORY.0)
  ...
  %call2_405869 = tail call %struct.Memory* @sub_400790._Z13record_resultdPKc(%struct.State* %0, i64 %441, %struct.Memory* %call2_405860)
  ...
  ret %struct.Memory* %call2_405869
}
...
define %struct.Memory* @routine_jge_.L_405860(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i8* %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
...
define %struct.Memory* @routine_jl_.L_405801(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i8* %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 2, i32 9
...
define %struct.Memory* @routine_jmpq_.L_4057d2(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
...
define %struct.Memory* @routine_jl_.L_4057d2(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i8* %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 2, i32 9
...
define %struct.Memory* @routine_jmpq_.L_405801(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
...
define %struct.Memory* @routine_jge_.L_405848(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i8* %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 2, i32 9
...
define %struct.Memory* @routine_jmpq_.L_405812(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
...
define %struct.Memory* @routine_jne_.L_405812(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i8* %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
...
define %struct.Memory* @routine_jmpq_.L_405848(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
...
define %struct.Memory* @routine_jmpq_.L_40579f(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
