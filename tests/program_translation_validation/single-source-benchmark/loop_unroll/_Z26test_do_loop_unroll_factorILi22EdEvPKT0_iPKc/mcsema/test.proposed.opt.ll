...
block_.L_40579f:                                  ; preds = %block_.L_405848, %entry
  %79 = phi i64 [ %.pre, %entry ], [ %433, %block_.L_405848 ]
...
block_.L_405812:                                  ; preds = %block_.L_405812, %block_40580d
  %290 = phi i64 [ %289, %block_40580d ], [ %387, %block_.L_405812 ]
  %291 = phi i64 [ %252, %block_40580d ], [ %352, %block_.L_405812 ]
  ...
  %call2_40581f = tail call %struct.Memory* @sub_401480._Z18complete_hash_funcIdET_S0_(%struct.State* %0, i64 %307, %struct.Memory* %MEMORY.3)
  ...
  br i1 %376, label %block_405843, label %block_.L_405812
...
block_.L_405848:                                  ; preds = %block_.L_405801, %block_405843
  %389 = phi i64 [ %288, %block_.L_405801 ], [ %388, %block_405843 ]
  %390 = phi i64 [ %252, %block_.L_405801 ], [ %352, %block_405843 ]
  ...
  %call2_40584d = tail call %struct.Memory* @sub_4014b0._Z9check_sumIdEvT_(%struct.State* %0, i64 %396, %struct.Memory* %MEMORY.4)
...
block_.L_405860:                                  ; preds = %block_.L_40579f
  ...
  %call2_405860 = tail call %struct.Memory* @sub_400df0._Z5timerv(%struct.State* %0, i64 %434, %struct.Memory* %MEMORY.0)
  ...
  %call2_405869 = tail call %struct.Memory* @sub_400790._Z13record_resultdPKc(%struct.State* %0, i64 %445, %struct.Memory* %call2_405860)
