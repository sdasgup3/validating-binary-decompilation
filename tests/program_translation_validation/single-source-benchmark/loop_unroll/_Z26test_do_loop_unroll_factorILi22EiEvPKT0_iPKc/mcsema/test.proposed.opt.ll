...
block_.L_4102bf:                                  ; preds = %block_.L_410361, %entry
  %68 = phi i64 [ %.pre, %entry ], [ %445, %block_.L_410361 ]
...
block_.L_410331:                                  ; preds = %block_.L_410331, %block_41032c
  %277 = phi i64 [ %276, %block_41032c ], [ %400, %block_.L_410331 ]
  %278 = phi i64 [ %239, %block_41032c ], [ %365, %block_.L_410331 ]
  ...
  %.v5 = select i1 %389, i64 12, i64 -31
  %400 = add i64 %367, %.v5
  store i64 %400, i64* %3, align 8
  br i1 %389, label %block_41035c, label %block_.L_410331
...
block_.L_410361:                                  ; preds = %block_.L_410320, %block_41035c
  %402 = phi i64 [ %275, %block_.L_410320 ], [ %401, %block_41035c ]
  %403 = phi i64 [ %239, %block_.L_410320 ], [ %365, %block_41035c ]
  ...
  %call2_410364 = tail call %struct.Memory* @sub_40c100._Z9check_sumIiEvT_(%struct.State* %0, i64 %409, %struct.Memory* %MEMORY.4)
...
block_.L_410377:                                  ; preds = %block_.L_4102bf
  ...
  %call2_410377 = tail call %struct.Memory* @sub_400df0._Z5timerv(%struct.State* %0, i64 %446, %struct.Memory* %MEMORY.0)
  ...
  %call2_410380 = tail call %struct.Memory* @sub_400790._Z13record_resultdPKc(%struct.State* %0, i64 %457, %struct.Memory* %call2_410377)
