...
entry:
  ...
  %call2_405683 = tail call %struct.Memory* @sub_400e10._Z11start_timerv(%struct.State* %0, i64 %58, %struct.Memory* %2)
...
block_.L_40568f:                                  ; preds = %block_.L_405738, %entry
  %74 = phi i64 [ %.pre, %entry ], [ %424, %block_.L_405738 ]
  %MEMORY.0 = phi %struct.Memory* [ %call2_405683, %entry ], [ %call2_40573d, %block_.L_405738 ]
  ...
  br i1 %107, label %block_40569f, label %block_.L_405750
...
block_40569f:                                     ; preds = %block_.L_40568f
  ...
  br i1 %154, label %block_.L_4056f1, label %block_4056bd
...
block_.L_4056c2:                                  ; preds = %block_.L_4056c2, %block_4056bd
  %157 = phi i64 [ %243, %block_.L_4056c2 ], [ %156, %block_4056bd ]
  %158 = phi i64 [ %204, %block_.L_4056c2 ], [ %118, %block_4056bd ]
  %159 = add i64 %158, -40
  ...
  %call2_4056cd = tail call %struct.Memory* @sub_401930._ZN15loop_inner_bodyILi23EdE7do_workERdPKdi(%struct.State* nonnull %0, i64 %169, %struct.Memory* %MEMORY.0)
  ...
  br i1 %242, label %block_.L_4056c2, label %block_4056ec
...
block_.L_4056f1:                                  ; preds = %block_4056ec, %block_40569f
  %245 = phi i64 [ %244, %block_4056ec ], [ %155, %block_40569f ]
  %246 = phi i64 [ %204, %block_4056ec ], [ %118, %block_40569f ]
  %247 = add i64 %246, -44
  %248 = add i64 %245, 3
  ...
  br i1 %281, label %block_4056fd, label %block_.L_405738
...
block_.L_405702:                                  ; preds = %block_.L_405702, %block_4056fd
  %284 = phi i64 [ %380, %block_.L_405702 ], [ %283, %block_4056fd ]
  %285 = phi i64 [ %345, %block_.L_405702 ], [ %246, %block_4056fd ]
  %286 = add i64 %285, -8
  %287 = add i64 %284, 4
  ...
  %call2_40570f = tail call %struct.Memory* @sub_4014c0._Z18complete_hash_funcIdET_S0_(%struct.State* nonnull %0, i64 %300, %struct.Memory* %MEMORY.0)
  ...
  br i1 %369, label %block_405733, label %block_.L_405702
...
block_.L_405738:                                  ; preds = %block_.L_4056f1, %block_405733
  %382 = phi i64 [ %282, %block_.L_4056f1 ], [ %381, %block_405733 ]
  %383 = phi i64 [ %246, %block_.L_4056f1 ], [ %345, %block_405733 ]
  %384 = add i64 %383, -40
  %385 = add i64 %382, 5
  ...
  %call2_40573d = tail call %struct.Memory* @sub_4014f0._Z9check_sumIdEvT_(%struct.State* nonnull %0, i64 %388, %struct.Memory* %MEMORY.0)
...
block_.L_405750:                                  ; preds = %block_.L_40568f
  ...
  %call2_405750 = tail call %struct.Memory* @sub_400e30._Z5timerv(%struct.State* nonnull %0, i64 %425, %struct.Memory* %MEMORY.0)
  ...
  %call2_405759 = tail call %struct.Memory* @sub_4007d0._Z13record_resultdPKc(%struct.State* nonnull %0, i64 %436, %struct.Memory* %call2_405750)
