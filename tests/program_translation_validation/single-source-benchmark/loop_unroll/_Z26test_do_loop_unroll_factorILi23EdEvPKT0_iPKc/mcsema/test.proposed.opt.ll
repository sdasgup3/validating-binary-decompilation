...
block_.L_4056b2:                                  ; preds = %block_.L_4056b2, %block_4056ad
  %157 = phi i64 [ %243, %block_.L_4056b2 ], [ %156, %block_4056ad ]
  %158 = phi i64 [ %204, %block_.L_4056b2 ], [ %118, %block_4056ad ]
  %159 = add i64 %158, -40
  ...
  %call2_4056bd = tail call %struct.Memory* @sub_401920._ZN15loop_inner_bodyILi23EdE7do_workERdPKdi(%struct.State* nonnull %0, i64 %169, %struct.Memory* %MEMORY.0)
...
block_.L_4056e1:                                  ; preds = %block_4056dc, %block_40568f
  %245 = phi i64 [ %244, %block_4056dc ], [ %155, %block_40568f ]
  %246 = phi i64 [ %204, %block_4056dc ], [ %118, %block_40568f ]
  %247 = add i64 %246, -44
  %248 = add i64 %245, 3
...
block_.L_4056f2:                                  ; preds = %block_.L_4056f2, %block_4056ed
  %284 = phi i64 [ %380, %block_.L_4056f2 ], [ %283, %block_4056ed ]
  %285 = phi i64 [ %345, %block_.L_4056f2 ], [ %246, %block_4056ed ]
  %286 = add i64 %285, -8
  %287 = add i64 %284, 4
  ...
  %call2_4056ff = tail call %struct.Memory* @sub_4014b0._Z18complete_hash_funcIdET_S0_(%struct.State* nonnull %0, i64 %300, %struct.Memory* %MEMORY.0)
...
block_.L_405728:                                  ; preds = %block_.L_4056e1, %block_405723
  ...
  %call2_40572d = tail call %struct.Memory* @sub_4014e0._Z9check_sumIdEvT_(%struct.State* nonnull %0, i64 %388, %struct.Memory* %MEMORY.0)
