...
entry:
  ...
  %call2_405643 = tail call %struct.Memory* @sub_400dd0._Z11start_timerv(%struct.State* %0, i64 %58, %struct.Memory* %2)
...
block_.L_40564f:                                  ; preds = %block_.L_4056f8, %entry
  %79 = phi i64 [ %.pre, %entry ], [ %433, %block_.L_4056f8 ]
  %MEMORY.0 = phi %struct.Memory* [ %call2_405643, %entry ], [ %call2_4056fd, %block_.L_4056f8 ]
  ...
  br i1 %112, label %block_40565f, label %block_.L_405710
...
block_40565f:                                     ; preds = %block_.L_40564f
  ...
  br i1 %160, label %block_.L_4056b1, label %block_40567d
...
block_.L_405682:                                  ; preds = %block_.L_405682, %block_40567d
  %163 = phi i64 [ %162, %block_40567d ], [ %249, %block_.L_405682 ]
  %164 = phi i64 [ %124, %block_40567d ], [ %210, %block_.L_405682 ]
  %MEMORY.1 = phi %struct.Memory* [ %MEMORY.0, %block_40567d ], [ %call2_40568d, %block_.L_405682 ]
  %165 = add i64 %164, -40
  ...
  %call2_40568d = tail call %struct.Memory* @sub_4018f0._ZN15loop_inner_bodyILi23EdE7do_workERdPKdi(%struct.State* %0, i64 %175, %struct.Memory* %MEMORY.1)
  ...
  br i1 %248, label %block_.L_405682, label %block_4056ac
...
block_.L_4056b1:                                  ; preds = %block_4056ac, %block_40565f
  %251 = phi i64 [ %161, %block_40565f ], [ %250, %block_4056ac ]
  %252 = phi i64 [ %124, %block_40565f ], [ %210, %block_4056ac ]
  %MEMORY.2 = phi %struct.Memory* [ %MEMORY.0, %block_40565f ], [ %call2_40568d, %block_4056ac ]
  %253 = add i64 %252, -44
  %254 = add i64 %251, 3
  ...
  br i1 %287, label %block_4056bd, label %block_.L_4056f8
...
block_.L_4056c2:                                  ; preds = %block_.L_4056c2, %block_4056bd
  %290 = phi i64 [ %289, %block_4056bd ], [ %387, %block_.L_4056c2 ]
  %291 = phi i64 [ %252, %block_4056bd ], [ %352, %block_.L_4056c2 ]
  %MEMORY.3 = phi %struct.Memory* [ %MEMORY.2, %block_4056bd ], [ %call2_4056cf, %block_.L_4056c2 ]
  %292 = add i64 %291, -8
  %293 = add i64 %290, 4
  ...
  %call2_4056cf = tail call %struct.Memory* @sub_401480._Z18complete_hash_funcIdET_S0_(%struct.State* %0, i64 %307, %struct.Memory* %MEMORY.3)
  ...
  br i1 %376, label %block_4056f3, label %block_.L_4056c2
...
block_.L_4056f8:                                  ; preds = %block_.L_4056b1, %block_4056f3
  %389 = phi i64 [ %288, %block_.L_4056b1 ], [ %388, %block_4056f3 ]
  %390 = phi i64 [ %252, %block_.L_4056b1 ], [ %352, %block_4056f3 ]
  %MEMORY.4 = phi %struct.Memory* [ %MEMORY.2, %block_.L_4056b1 ], [ %call2_4056cf, %block_4056f3 ]
  %391 = add i64 %390, -40
  %392 = add i64 %389, 5
  ...
  %call2_4056fd = tail call %struct.Memory* @sub_4014b0._Z9check_sumIdEvT_(%struct.State* %0, i64 %396, %struct.Memory* %MEMORY.4)
...
block_.L_405710:                                  ; preds = %block_.L_40564f
  ...
  %call2_405710 = tail call %struct.Memory* @sub_400df0._Z5timerv(%struct.State* %0, i64 %434, %struct.Memory* %MEMORY.0)
  ...
  %call2_405719 = tail call %struct.Memory* @sub_400790._Z13record_resultdPKc(%struct.State* %0, i64 %445, %struct.Memory* %call2_405710)
  ...
  ret %struct.Memory* %call2_405719
}
...
define %struct.Memory* @routine_jge_.L_405710(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i8* %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
...
define %struct.Memory* @routine_jl_.L_4056b1(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i8* %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 2, i32 9
...
define %struct.Memory* @routine_jmpq_.L_405682(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
...
define %struct.Memory* @routine_jl_.L_405682(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i8* %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 2, i32 9
...
define %struct.Memory* @routine_jmpq_.L_4056b1(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
...
define %struct.Memory* @routine_jge_.L_4056f8(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i8* %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 2, i32 9
...
define %struct.Memory* @routine_jmpq_.L_4056c2(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
...
define %struct.Memory* @routine_jne_.L_4056c2(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i8* %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
...
define %struct.Memory* @routine_jmpq_.L_4056f8(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
...
define %struct.Memory* @routine_jmpq_.L_40564f(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
