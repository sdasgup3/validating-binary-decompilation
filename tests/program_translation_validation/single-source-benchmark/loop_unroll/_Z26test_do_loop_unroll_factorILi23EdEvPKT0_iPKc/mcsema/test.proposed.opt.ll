...
block_.L_40564f:                                  ; preds = %block_.L_4056f8, %entry
  %79 = phi i64 [ %.pre, %entry ], [ %429, %block_.L_4056f8 ]
...
block_.L_4056c2:                                  ; preds = %block_.L_4056c2, %block_4056bd
  %290 = phi i64 [ %289, %block_4056bd ], [ %385, %block_.L_4056c2 ]
  %291 = phi i64 [ %252, %block_4056bd ], [ %350, %block_.L_4056c2 ]
  ...
  %call2_4056cf = tail call %struct.Memory* @sub_401480._Z18complete_hash_funcIdET_S0_(%struct.State* %0, i64 %306, %struct.Memory* %MEMORY.3)
  ...
  br i1 %374, label %block_4056f3, label %block_.L_4056c2
...
block_.L_4056f8:                                  ; preds = %block_.L_4056b1, %block_4056f3
  %387 = phi i64 [ %288, %block_.L_4056b1 ], [ %386, %block_4056f3 ]
  %388 = phi i64 [ %252, %block_.L_4056b1 ], [ %350, %block_4056f3 ]
  ...
  %call2_4056fd = tail call %struct.Memory* @sub_4014b0._Z9check_sumIdEvT_(%struct.State* %0, i64 %393, %struct.Memory* %MEMORY.4)
...
block_.L_405710:                                  ; preds = %block_.L_40564f
  ...
  %call2_405710 = tail call %struct.Memory* @sub_400df0._Z5timerv(%struct.State* %0, i64 %430, %struct.Memory* %MEMORY.0)
  ...
  %call2_405719 = tail call %struct.Memory* @sub_400790._Z13record_resultdPKc(%struct.State* %0, i64 %441, %struct.Memory* %call2_405710)
