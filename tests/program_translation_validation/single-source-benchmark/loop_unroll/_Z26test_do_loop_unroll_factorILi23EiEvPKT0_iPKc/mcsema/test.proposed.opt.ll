...
declare %struct.Memory* @sub_40c4e0._ZN15loop_inner_bodyILi23EiE7do_workERiPKii(%struct.State* noalias dereferenceable(3376), i64, %struct.Memory* noalias readnone returned) local_unnamed_addr
...
define %struct.Memory* @_Z26test_do_loop_unroll_factorILi23EiEvPKT0_iPKc(%struct.State* noalias, i64, %struct.Memory* noalias readnone) local_unnamed_addr #1 {
entry:
...
block_.L_4101e1:                                  ; preds = %block_.L_4101e1, %block_4101dc
  %150 = phi i64 [ %236, %block_.L_4101e1 ], [ %149, %block_4101dc ]
  %151 = phi i64 [ %197, %block_.L_4101e1 ], [ %111, %block_4101dc ]
  %152 = add i64 %151, -32
  ...
  %call2_4101ec = tail call %struct.Memory* @sub_40c4e0._ZN15loop_inner_bodyILi23EiE7do_workERiPKii(%struct.State* nonnull %0, i64 %162, %struct.Memory* %MEMORY.0)
...
block_.L_410210:                                  ; preds = %block_41020b, %block_4101bf
  %238 = phi i64 [ %237, %block_41020b ], [ %148, %block_4101bf ]
  %239 = phi i64 [ %197, %block_41020b ], [ %111, %block_4101bf ]
  %240 = add i64 %239, -36
  %241 = add i64 %238, 3
...
block_.L_410221:                                  ; preds = %block_.L_410221, %block_41021c
  %277 = phi i64 [ %400, %block_.L_410221 ], [ %276, %block_41021c ]
  %278 = phi i64 [ %365, %block_.L_410221 ], [ %239, %block_41021c ]
  %279 = add i64 %278, -8
  %280 = add i64 %277, 4
  ...
  %call2_41022c = tail call %struct.Memory* @sub_40c100._Z18complete_hash_funcIiET_S0_(%struct.State* nonnull %0, i64 %294, %struct.Memory* %MEMORY.0)
...
block_.L_410251:                                  ; preds = %block_.L_410210, %block_41024c
  ...
  %call2_410254 = tail call %struct.Memory* @sub_40c130._Z9check_sumIiEvT_(%struct.State* nonnull %0, i64 %409, %struct.Memory* %MEMORY.0)
