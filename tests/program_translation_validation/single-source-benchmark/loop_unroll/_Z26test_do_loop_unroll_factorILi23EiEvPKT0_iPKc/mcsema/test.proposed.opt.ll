...
block_.L_41017f:                                  ; preds = %block_.L_410221, %entry
  %68 = phi i64 [ %.pre, %entry ], [ %447, %block_.L_410221 ]
...
block_.L_4101f1:                                  ; preds = %block_.L_4101f1, %block_4101ec
  %277 = phi i64 [ %276, %block_4101ec ], [ %401, %block_.L_4101f1 ]
  %278 = phi i64 [ %239, %block_4101ec ], [ %366, %block_.L_4101f1 ]
  ...
  br i1 %390, label %block_41021c, label %block_.L_4101f1
...
block_.L_410221:                                  ; preds = %block_.L_4101e0, %block_41021c
  %403 = phi i64 [ %275, %block_.L_4101e0 ], [ %402, %block_41021c ]
  %404 = phi i64 [ %239, %block_.L_4101e0 ], [ %366, %block_41021c ]
  ...
  %call2_410224 = tail call %struct.Memory* @sub_40c100._Z9check_sumIiEvT_(%struct.State* %0, i64 %410, %struct.Memory* %MEMORY.4)
...
block_.L_410237:                                  ; preds = %block_.L_41017f
  ...
  %call2_410237 = tail call %struct.Memory* @sub_400df0._Z5timerv(%struct.State* %0, i64 %448, %struct.Memory* %MEMORY.0)
  ...
  %call2_410240 = tail call %struct.Memory* @sub_400790._Z13record_resultdPKc(%struct.State* %0, i64 %459, %struct.Memory* %call2_410237)
