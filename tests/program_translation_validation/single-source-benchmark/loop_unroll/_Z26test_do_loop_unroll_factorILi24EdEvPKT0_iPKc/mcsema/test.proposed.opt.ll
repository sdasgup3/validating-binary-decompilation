...
entry:
  ...
  %call2_4054f3 = tail call %struct.Memory* @sub_400dd0._Z11start_timerv(%struct.State* %0, i64 %58, %struct.Memory* %2)
...
block_.L_4054ff:                                  ; preds = %block_.L_4055a8, %entry
  %79 = phi i64 [ %.pre, %entry ], [ %429, %block_.L_4055a8 ]
  %MEMORY.0 = phi %struct.Memory* [ %call2_4054f3, %entry ], [ %call2_4055ad, %block_.L_4055a8 ]
  ...
  br i1 %112, label %block_40550f, label %block_.L_4055c0
...
block_40550f:                                     ; preds = %block_.L_4054ff
  ...
  br i1 %160, label %block_.L_405561, label %block_40552d

block_40552d:                                     ; preds = %block_40550f
  %162 = add i64 %161, 5
  store i64 %162, i64* %3, align 8
  br label %block_.L_405532

block_.L_405532:                                  ; preds = %block_.L_405532, %block_40552d
  %163 = phi i64 [ %162, %block_40552d ], [ %249, %block_.L_405532 ]
  %164 = phi i64 [ %124, %block_40552d ], [ %210, %block_.L_405532 ]
  %MEMORY.1 = phi %struct.Memory* [ %MEMORY.0, %block_40552d ], [ %call2_40553d, %block_.L_405532 ]
  %165 = add i64 %164, -40
  ...
  %call2_40553d = tail call %struct.Memory* @sub_401890._ZN15loop_inner_bodyILi24EdE7do_workERdPKdi(%struct.State* %0, i64 %175, %struct.Memory* %MEMORY.1)
  ...
  br i1 %248, label %block_.L_405532, label %block_40555c

block_40555c:                                     ; preds = %block_.L_405532
  %250 = add i64 %249, 5
  store i64 %250, i64* %3, align 8
  br label %block_.L_405561

block_.L_405561:                                  ; preds = %block_40555c, %block_40550f
  %251 = phi i64 [ %161, %block_40550f ], [ %250, %block_40555c ]
  %252 = phi i64 [ %124, %block_40550f ], [ %210, %block_40555c ]
  %MEMORY.2 = phi %struct.Memory* [ %MEMORY.0, %block_40550f ], [ %call2_40553d, %block_40555c ]
  %253 = add i64 %252, -44
  %254 = add i64 %251, 3
  ...
  br i1 %287, label %block_40556d, label %block_.L_4055a8

block_40556d:                                     ; preds = %block_.L_405561
  %289 = add i64 %288, 5
  store i64 %289, i64* %3, align 8
  br label %block_.L_405572

block_.L_405572:                                  ; preds = %block_.L_405572, %block_40556d
  %290 = phi i64 [ %289, %block_40556d ], [ %385, %block_.L_405572 ]
  %291 = phi i64 [ %252, %block_40556d ], [ %350, %block_.L_405572 ]
  %MEMORY.3 = phi %struct.Memory* [ %MEMORY.2, %block_40556d ], [ %call2_40557f, %block_.L_405572 ]
  %292 = add i64 %291, -8
  %293 = add i64 %290, 4
  ...
  %call2_40557f = tail call %struct.Memory* @sub_401480._Z18complete_hash_funcIdET_S0_(%struct.State* %0, i64 %306, %struct.Memory* %MEMORY.3)
  ...
  br i1 %374, label %block_4055a3, label %block_.L_405572

block_4055a3:                                     ; preds = %block_.L_405572
  %386 = add i64 %385, 5
  store i64 %386, i64* %3, align 8
  br label %block_.L_4055a8

block_.L_4055a8:                                  ; preds = %block_.L_405561, %block_4055a3
  %387 = phi i64 [ %288, %block_.L_405561 ], [ %386, %block_4055a3 ]
  %388 = phi i64 [ %252, %block_.L_405561 ], [ %350, %block_4055a3 ]
  %MEMORY.4 = phi %struct.Memory* [ %MEMORY.2, %block_.L_405561 ], [ %call2_40557f, %block_4055a3 ]
  %389 = add i64 %388, -40
  %390 = add i64 %387, 5
  ...
  %call2_4055ad = tail call %struct.Memory* @sub_4014b0._Z9check_sumIdEvT_(%struct.State* %0, i64 %393, %struct.Memory* %MEMORY.4)
...
block_.L_4055c0:                                  ; preds = %block_.L_4054ff
  %430 = add i64 %113, -18384
  %431 = add i64 %113, 5
  ...
  %call2_4055c0 = tail call %struct.Memory* @sub_400df0._Z5timerv(%struct.State* %0, i64 %430, %struct.Memory* %MEMORY.0)
  ...
  %call2_4055c9 = tail call %struct.Memory* @sub_400790._Z13record_resultdPKc(%struct.State* %0, i64 %441, %struct.Memory* %call2_4055c0)
  ...
  ret %struct.Memory* %call2_4055c9
}
...
define %struct.Memory* @routine_jge_.L_4055c0(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i8* %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
...
define %struct.Memory* @routine_jl_.L_405561(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i8* %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 2, i32 9
...
define %struct.Memory* @routine_jmpq_.L_405532(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
...
define %struct.Memory* @routine_jl_.L_405532(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i8* %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 2, i32 9
...
define %struct.Memory* @routine_jmpq_.L_405561(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
...
define %struct.Memory* @routine_jge_.L_4055a8(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i8* %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 2, i32 9
...
define %struct.Memory* @routine_jmpq_.L_405572(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
...
define %struct.Memory* @routine_jne_.L_405572(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i8* %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
...
define %struct.Memory* @routine_jmpq_.L_4055a8(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
...
define %struct.Memory* @routine_jmpq_.L_4054ff(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
