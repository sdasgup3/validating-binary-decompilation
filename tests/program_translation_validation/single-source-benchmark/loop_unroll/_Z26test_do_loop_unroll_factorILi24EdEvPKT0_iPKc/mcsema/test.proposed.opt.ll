...
entry:
  ...
  %call2_405533 = tail call %struct.Memory* @sub_400e10._Z11start_timerv(%struct.State* %0, i64 %58, %struct.Memory* %2)
  ...
  br label %block_.L_40553f

block_.L_40553f:                                  ; preds = %block_.L_4055e8, %entry
  %74 = phi i64 [ %.pre, %entry ], [ %424, %block_.L_4055e8 ]
  %MEMORY.0 = phi %struct.Memory* [ %call2_405533, %entry ], [ %call2_4055ed, %block_.L_4055e8 ]
  ...
  br i1 %107, label %block_40554f, label %block_.L_405600

block_40554f:                                     ; preds = %block_.L_40553f
  ...
  br i1 %154, label %block_.L_4055a1, label %block_40556d

block_40556d:                                     ; preds = %block_40554f
  %156 = add i64 %155, 5
  store i64 %156, i64* %3, align 8
  br label %block_.L_405572

block_.L_405572:                                  ; preds = %block_.L_405572, %block_40556d
  %157 = phi i64 [ %243, %block_.L_405572 ], [ %156, %block_40556d ]
  %158 = phi i64 [ %204, %block_.L_405572 ], [ %118, %block_40556d ]
  %159 = add i64 %158, -40
  ...
  %call2_40557d = tail call %struct.Memory* @sub_4018d0._ZN15loop_inner_bodyILi24EdE7do_workERdPKdi(%struct.State* nonnull %0, i64 %169, %struct.Memory* %MEMORY.0)
  ...
  br i1 %242, label %block_.L_405572, label %block_40559c

block_40559c:                                     ; preds = %block_.L_405572
  %244 = add i64 %243, 5
  store i64 %244, i64* %3, align 8
  br label %block_.L_4055a1

block_.L_4055a1:                                  ; preds = %block_40559c, %block_40554f
  %245 = phi i64 [ %244, %block_40559c ], [ %155, %block_40554f ]
  %246 = phi i64 [ %204, %block_40559c ], [ %118, %block_40554f ]
  %247 = add i64 %246, -44
  %248 = add i64 %245, 3
  ...
  br i1 %281, label %block_4055ad, label %block_.L_4055e8

block_4055ad:                                     ; preds = %block_.L_4055a1
  %283 = add i64 %282, 5
  store i64 %283, i64* %3, align 8
  br label %block_.L_4055b2

block_.L_4055b2:                                  ; preds = %block_.L_4055b2, %block_4055ad
  %284 = phi i64 [ %380, %block_.L_4055b2 ], [ %283, %block_4055ad ]
  %285 = phi i64 [ %345, %block_.L_4055b2 ], [ %246, %block_4055ad ]
  %286 = add i64 %285, -8
  %287 = add i64 %284, 4
  ...
  %call2_4055bf = tail call %struct.Memory* @sub_4014c0._Z18complete_hash_funcIdET_S0_(%struct.State* nonnull %0, i64 %300, %struct.Memory* %MEMORY.0)
  ...
  br i1 %369, label %block_4055e3, label %block_.L_4055b2

block_4055e3:                                     ; preds = %block_.L_4055b2
  %381 = add i64 %380, 5
  store i64 %381, i64* %3, align 8
  br label %block_.L_4055e8

block_.L_4055e8:                                  ; preds = %block_.L_4055a1, %block_4055e3
  %382 = phi i64 [ %282, %block_.L_4055a1 ], [ %381, %block_4055e3 ]
  %383 = phi i64 [ %246, %block_.L_4055a1 ], [ %345, %block_4055e3 ]
  %384 = add i64 %383, -40
  %385 = add i64 %382, 5
  ...
  %call2_4055ed = tail call %struct.Memory* @sub_4014f0._Z9check_sumIdEvT_(%struct.State* nonnull %0, i64 %388, %struct.Memory* %MEMORY.0)
...
block_.L_405600:                                  ; preds = %block_.L_40553f
  ...
  %call2_405600 = tail call %struct.Memory* @sub_400e30._Z5timerv(%struct.State* nonnull %0, i64 %425, %struct.Memory* %MEMORY.0)
  ...
  %call2_405609 = tail call %struct.Memory* @sub_4007d0._Z13record_resultdPKc(%struct.State* nonnull %0, i64 %436, %struct.Memory* %call2_405600)
