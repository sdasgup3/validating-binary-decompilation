...
block_.L_405562:                                  ; preds = %block_.L_405562, %block_40555d
  %157 = phi i64 [ %243, %block_.L_405562 ], [ %156, %block_40555d ]
  %158 = phi i64 [ %204, %block_.L_405562 ], [ %118, %block_40555d ]
  %159 = add i64 %158, -40
  ...
  %call2_40556d = tail call %struct.Memory* @sub_4018c0._ZN15loop_inner_bodyILi24EdE7do_workERdPKdi(%struct.State* nonnull %0, i64 %169, %struct.Memory* %MEMORY.0)
...
block_.L_405591:                                  ; preds = %block_40558c, %block_40553f
  %245 = phi i64 [ %244, %block_40558c ], [ %155, %block_40553f ]
  %246 = phi i64 [ %204, %block_40558c ], [ %118, %block_40553f ]
  %247 = add i64 %246, -44
  %248 = add i64 %245, 3
...
block_.L_4055a2:                                  ; preds = %block_.L_4055a2, %block_40559d
  %284 = phi i64 [ %380, %block_.L_4055a2 ], [ %283, %block_40559d ]
  %285 = phi i64 [ %345, %block_.L_4055a2 ], [ %246, %block_40559d ]
  %286 = add i64 %285, -8
  %287 = add i64 %284, 4
  ...
  %call2_4055af = tail call %struct.Memory* @sub_4014b0._Z18complete_hash_funcIdET_S0_(%struct.State* nonnull %0, i64 %300, %struct.Memory* %MEMORY.0)
...
block_.L_4055d8:                                  ; preds = %block_.L_405591, %block_4055d3
  ...
  %call2_4055dd = tail call %struct.Memory* @sub_4014e0._Z9check_sumIdEvT_(%struct.State* nonnull %0, i64 %388, %struct.Memory* %MEMORY.0)
