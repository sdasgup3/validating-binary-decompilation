...
define %struct.Memory* @_Z26test_do_loop_unroll_factorILi24EdEvPKT0_iPKc(%struct.State* noalias, i64, %struct.Memory* noalias) local_unnamed_addr #1 {
entry:
  ...
  %call2_405523 = tail call %struct.Memory* @sub_400e00._Z11start_timerv(%struct.State* %0, i64 %58, %struct.Memory* %2)
  ...
  br label %block_.L_40552f

block_.L_40552f:                                  ; preds = %block_.L_4055d8, %entry
  %74 = phi i64 [ %.pre, %entry ], [ %424, %block_.L_4055d8 ]
  %MEMORY.0 = phi %struct.Memory* [ %call2_405523, %entry ], [ %call2_4055dd, %block_.L_4055d8 ]
  ...
  br i1 %107, label %block_40553f, label %block_.L_4055f0

block_40553f:                                     ; preds = %block_.L_40552f
  ...
  br i1 %154, label %block_.L_405591, label %block_40555d

block_40555d:                                     ; preds = %block_40553f
  %156 = add i64 %155, 5
  store i64 %156, i64* %3, align 8
  br label %block_.L_405562

block_.L_405562:                                  ; preds = %block_.L_405562, %block_40555d
  %157 = phi i64 [ %156, %block_40555d ], [ %243, %block_.L_405562 ]
  %158 = phi i64 [ %118, %block_40555d ], [ %204, %block_.L_405562 ]
  %MEMORY.1 = phi %struct.Memory* [ %MEMORY.0, %block_40555d ], [ %call2_40556d, %block_.L_405562 ]
  %159 = add i64 %158, -40
  ...
  %call2_40556d = tail call %struct.Memory* @sub_4018c0._ZN15loop_inner_bodyILi24EdE7do_workERdPKdi(%struct.State* nonnull %0, i64 %169, %struct.Memory* %MEMORY.1)
  ...
  br i1 %242, label %block_.L_405562, label %block_40558c

block_40558c:                                     ; preds = %block_.L_405562
  %244 = add i64 %243, 5
  store i64 %244, i64* %3, align 8
  br label %block_.L_405591

block_.L_405591:                                  ; preds = %block_40558c, %block_40553f
  %245 = phi i64 [ %155, %block_40553f ], [ %244, %block_40558c ]
  %246 = phi i64 [ %118, %block_40553f ], [ %204, %block_40558c ]
  %MEMORY.2 = phi %struct.Memory* [ %MEMORY.0, %block_40553f ], [ %call2_40556d, %block_40558c ]
  %247 = add i64 %246, -44
  %248 = add i64 %245, 3
  ...
  br i1 %281, label %block_40559d, label %block_.L_4055d8

block_40559d:                                     ; preds = %block_.L_405591
  %283 = add i64 %282, 5
  store i64 %283, i64* %3, align 8
  br label %block_.L_4055a2

block_.L_4055a2:                                  ; preds = %block_.L_4055a2, %block_40559d
  %284 = phi i64 [ %283, %block_40559d ], [ %380, %block_.L_4055a2 ]
  %285 = phi i64 [ %246, %block_40559d ], [ %345, %block_.L_4055a2 ]
  %MEMORY.3 = phi %struct.Memory* [ %MEMORY.2, %block_40559d ], [ %call2_4055af, %block_.L_4055a2 ]
  %286 = add i64 %285, -8
  %287 = add i64 %284, 4
  ...
  %call2_4055af = tail call %struct.Memory* @sub_4014b0._Z18complete_hash_funcIdET_S0_(%struct.State* nonnull %0, i64 %300, %struct.Memory* %MEMORY.3)
  ...
  br i1 %369, label %block_4055d3, label %block_.L_4055a2

block_4055d3:                                     ; preds = %block_.L_4055a2
  %381 = add i64 %380, 5
  store i64 %381, i64* %3, align 8
  br label %block_.L_4055d8

block_.L_4055d8:                                  ; preds = %block_.L_405591, %block_4055d3
  %382 = phi i64 [ %282, %block_.L_405591 ], [ %381, %block_4055d3 ]
  %383 = phi i64 [ %246, %block_.L_405591 ], [ %345, %block_4055d3 ]
  %MEMORY.4 = phi %struct.Memory* [ %MEMORY.2, %block_.L_405591 ], [ %call2_4055af, %block_4055d3 ]
  %384 = add i64 %383, -40
  %385 = add i64 %382, 5
  ...
  %call2_4055dd = tail call %struct.Memory* @sub_4014e0._Z9check_sumIdEvT_(%struct.State* nonnull %0, i64 %388, %struct.Memory* %MEMORY.4)
...
block_.L_4055f0:                                  ; preds = %block_.L_40552f
  %425 = add i64 %108, -18384
  %426 = add i64 %108, 5
  ...
  %call2_4055f0 = tail call %struct.Memory* @sub_400e20._Z5timerv(%struct.State* nonnull %0, i64 %425, %struct.Memory* %MEMORY.0)
  ...
  %call2_4055f9 = tail call %struct.Memory* @sub_4007c0._Z13record_resultdPKc(%struct.State* nonnull %0, i64 %436, %struct.Memory* %call2_4055f0)
  ...
  ret %struct.Memory* %call2_4055f9
}
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_jge_.L_4055f0(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i8* nocapture %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_jl_.L_405591(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i8* nocapture %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 2, i32 9
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_jmpq_.L_405562(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_jl_.L_405562(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i8* nocapture %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 2, i32 9
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_jmpq_.L_405591(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_jge_.L_4055d8(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i8* nocapture %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 2, i32 9
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_jmpq_.L_4055a2(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_jne_.L_4055a2(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i8* nocapture %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_jmpq_.L_4055d8(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_jmpq_.L_40552f(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
