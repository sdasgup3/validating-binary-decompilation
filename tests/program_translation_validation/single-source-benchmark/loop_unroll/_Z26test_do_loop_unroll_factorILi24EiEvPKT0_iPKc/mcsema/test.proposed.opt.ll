...
declare %struct.Memory* @sub_40c450._ZN15loop_inner_bodyILi24EiE7do_workERiPKii(%struct.State* noalias dereferenceable(3376), i64, %struct.Memory* noalias readnone returned) local_unnamed_addr
...
entry:
  ...
  %RSP.i121 = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 13, i32 0, i32 0
  %10 = load i64, i64* %PC.i, align 8
  store i64 %8, i64* %RBP.i, align 8
  %11 = add i64 %7, -56
  store i64 %11, i64* %RSP.i121, align 8
  ...
  %call2_410033 = tail call %struct.Memory* @sub_400dd0._Z11start_timerv(%struct.State* %0, i64 %58, %struct.Memory* %2)
  ...
  br label %block_.L_41003f

block_.L_41003f:                                  ; preds = %block_.L_4100e1, %entry
  %68 = phi i64 [ %.pre, %entry ], [ %447, %block_.L_4100e1 ]
  %MEMORY.0 = phi %struct.Memory* [ %call2_410033, %entry ], [ %call2_4100e4, %block_.L_4100e1 ]
  ...
  br i1 %101, label %block_41004f, label %block_.L_4100f7

block_41004f:                                     ; preds = %block_.L_41003f
  %103 = add i64 %69, -32
  %104 = add i64 %102, 7
  ...
  %147 = xor i1 %146, %144
  %.v2 = select i1 %147, i64 67, i64 15
  %148 = add i64 %113, %.v2
  store i64 %148, i64* %3, align 8
  br i1 %147, label %block_.L_4100a0, label %block_41006c

block_41006c:                                     ; preds = %block_41004f
  %149 = add i64 %148, 5
  store i64 %149, i64* %3, align 8
  br label %block_.L_410071

block_.L_410071:                                  ; preds = %block_.L_410071, %block_41006c
  %150 = phi i64 [ %149, %block_41006c ], [ %236, %block_.L_410071 ]
  %151 = phi i64 [ %111, %block_41006c ], [ %197, %block_.L_410071 ]
  %MEMORY.1 = phi %struct.Memory* [ %MEMORY.0, %block_41006c ], [ %call2_41007c, %block_.L_410071 ]
  %152 = add i64 %151, -32
  ...
  %call2_41007c = tail call %struct.Memory* @sub_40c450._ZN15loop_inner_bodyILi24EiE7do_workERiPKii(%struct.State* %0, i64 %162, %struct.Memory* %MEMORY.1)
  ...
  store i64 %209, i64* %RCX.i47, align 8
  %210 = lshr i32 %208, 31
  %211 = sub i32 %202, %208
  ...
  %235 = xor i1 %234, %232
  %.v3 = select i1 %235, i64 -25, i64 17
  %236 = add i64 %199, %.v3
  store i64 %236, i64* %3, align 8
  br i1 %235, label %block_.L_410071, label %block_41009b

block_41009b:                                     ; preds = %block_.L_410071
  %237 = add i64 %236, 5
  store i64 %237, i64* %3, align 8
  br label %block_.L_4100a0

block_.L_4100a0:                                  ; preds = %block_41009b, %block_41004f
  %238 = phi i64 [ %148, %block_41004f ], [ %237, %block_41009b ]
  %239 = phi i64 [ %111, %block_41004f ], [ %197, %block_41009b ]
  %MEMORY.2 = phi %struct.Memory* [ %MEMORY.0, %block_41004f ], [ %call2_41007c, %block_41009b ]
  %240 = add i64 %239, -36
  %241 = add i64 %238, 3
  ...
  %274 = xor i1 %273, %271
  %.v4 = select i1 %274, i64 12, i64 65
  %275 = add i64 %238, %.v4
  store i64 %275, i64* %3, align 8
  br i1 %274, label %block_4100ac, label %block_.L_4100e1

block_4100ac:                                     ; preds = %block_.L_4100a0
  %276 = add i64 %275, 5
  store i64 %276, i64* %3, align 8
  br label %block_.L_4100b1

block_.L_4100b1:                                  ; preds = %block_.L_4100b1, %block_4100ac
  %277 = phi i64 [ %276, %block_4100ac ], [ %401, %block_.L_4100b1 ]
  %278 = phi i64 [ %239, %block_4100ac ], [ %366, %block_.L_4100b1 ]
  %MEMORY.3 = phi %struct.Memory* [ %MEMORY.2, %block_4100ac ], [ %call2_4100bc, %block_.L_4100b1 ]
  %279 = add i64 %278, -8
  %280 = add i64 %277, 4
  ...
  %call2_4100bc = tail call %struct.Memory* @sub_40c0d0._Z18complete_hash_funcIiET_S0_(%struct.State* %0, i64 %294, %struct.Memory* %MEMORY.3)
  ...
  store i64 %372, i64* %RAX.i105, align 8
  %373 = add i64 %366, -12
  %374 = add i64 %368, 6
  ...
  %.v5 = select i1 %390, i64 12, i64 -31
  %401 = add i64 %368, %.v5
  store i64 %401, i64* %3, align 8
  br i1 %390, label %block_4100dc, label %block_.L_4100b1

block_4100dc:                                     ; preds = %block_.L_4100b1
  %402 = add i64 %401, 5
  store i64 %402, i64* %3, align 8
  br label %block_.L_4100e1

block_.L_4100e1:                                  ; preds = %block_.L_4100a0, %block_4100dc
  %403 = phi i64 [ %275, %block_.L_4100a0 ], [ %402, %block_4100dc ]
  %404 = phi i64 [ %239, %block_.L_4100a0 ], [ %366, %block_4100dc ]
  %MEMORY.4 = phi %struct.Memory* [ %MEMORY.2, %block_.L_4100a0 ], [ %call2_4100bc, %block_4100dc ]
  %405 = add i64 %404, -32
  %406 = add i64 %403, 3
  ...
  store i64 %409, i64* %RDI.i116, align 8
  %410 = add i64 %403, -16353
  %411 = add i64 %403, 8
  ...
  %call2_4100e4 = tail call %struct.Memory* @sub_40c100._Z9check_sumIiEvT_(%struct.State* %0, i64 %410, %struct.Memory* %MEMORY.4)
  ...
  store i64 %422, i64* %RAX.i105, align 8
  ...
  %446 = load i64, i64* %PC.i, align 8
  %447 = add i64 %446, -179
  store i64 %447, i64* %3, align 8
  br label %block_.L_41003f

block_.L_4100f7:                                  ; preds = %block_.L_41003f
  %448 = add i64 %102, -62215
  %449 = add i64 %102, 5
  ...
  %call2_4100f7 = tail call %struct.Memory* @sub_400df0._Z5timerv(%struct.State* %0, i64 %448, %struct.Memory* %MEMORY.0)
  ...
  store i64 %458, i64* %RDI.i116, align 8
  %459 = add i64 %455, -63852
  %460 = add i64 %455, 9
  ...
  %call2_410100 = tail call %struct.Memory* @sub_400790._Z13record_resultdPKc(%struct.State* %0, i64 %459, %struct.Memory* %call2_4100f7)
  %464 = load i64, i64* %RSP.i121, align 8
  %465 = load i64, i64* %PC.i, align 8
  %466 = add i64 %464, 48
  store i64 %466, i64* %RSP.i121, align 8
  ...
  ret %struct.Memory* %call2_410100
}
...
define %struct.Memory* @routine_jge_.L_4100f7(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i8* %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
...
define %struct.Memory* @routine_cmpl__0x18___eax(%struct.State* dereferenceable(3376), i64, %struct.Memory*) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 1, i32 0
  %EAX = bitcast %union.anon* %3 to i32*
...
define %struct.Memory* @routine_jl_.L_4100a0(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i8* %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 2, i32 9
...
define %struct.Memory* @routine_jmpq_.L_410071(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
...
define %struct.Memory* @routine_callq_._ZN15loop_inner_bodyILi24EiE7do_workERiPKii(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
...
define %struct.Memory* @routine_addl__0x18___edx(%struct.State* dereferenceable(3376), i64, %struct.Memory*) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %RDX = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 7, i32 0, i32 0
...
define %struct.Memory* @routine_subl__0x17___ecx(%struct.State* dereferenceable(3376), i64, %struct.Memory*) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %RCX = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 5, i32 0, i32 0
...
define %struct.Memory* @routine_jl_.L_410071(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i8* %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 2, i32 9
...
define %struct.Memory* @routine_jmpq_.L_4100a0(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
...
define %struct.Memory* @routine_jge_.L_4100e1(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i8* %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 2, i32 9
...
define %struct.Memory* @routine_jmpq_.L_4100b1(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
...
define %struct.Memory* @routine_jne_.L_4100b1(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i8* %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
...
define %struct.Memory* @routine_jmpq_.L_4100e1(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
...
define %struct.Memory* @routine_jmpq_.L_41003f(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
