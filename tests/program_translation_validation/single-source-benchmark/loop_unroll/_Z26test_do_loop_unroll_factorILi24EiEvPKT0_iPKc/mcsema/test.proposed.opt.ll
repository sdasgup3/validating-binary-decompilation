...
declare %struct.Memory* @sub_40c480._ZN15loop_inner_bodyILi24EiE7do_workERiPKii(%struct.State* noalias dereferenceable(3376), i64, %struct.Memory* noalias readnone returned) local_unnamed_addr
...
define %struct.Memory* @_Z26test_do_loop_unroll_factorILi24EiEvPKT0_iPKc(%struct.State* noalias, i64, %struct.Memory* noalias readnone) local_unnamed_addr #1 {
entry:
...
block_.L_4100a1:                                  ; preds = %block_.L_4100a1, %block_41009c
  %150 = phi i64 [ %236, %block_.L_4100a1 ], [ %149, %block_41009c ]
  %151 = phi i64 [ %197, %block_.L_4100a1 ], [ %111, %block_41009c ]
  %152 = add i64 %151, -32
  ...
  %call2_4100ac = tail call %struct.Memory* @sub_40c480._ZN15loop_inner_bodyILi24EiE7do_workERiPKii(%struct.State* nonnull %0, i64 %162, %struct.Memory* %MEMORY.0)
...
block_.L_4100d0:                                  ; preds = %block_4100cb, %block_41007f
  %238 = phi i64 [ %237, %block_4100cb ], [ %148, %block_41007f ]
  %239 = phi i64 [ %197, %block_4100cb ], [ %111, %block_41007f ]
  %240 = add i64 %239, -36
  %241 = add i64 %238, 3
...
block_.L_4100e1:                                  ; preds = %block_.L_4100e1, %block_4100dc
  %277 = phi i64 [ %400, %block_.L_4100e1 ], [ %276, %block_4100dc ]
  %278 = phi i64 [ %365, %block_.L_4100e1 ], [ %239, %block_4100dc ]
  %279 = add i64 %278, -8
  %280 = add i64 %277, 4
  ...
  %call2_4100ec = tail call %struct.Memory* @sub_40c100._Z18complete_hash_funcIiET_S0_(%struct.State* nonnull %0, i64 %294, %struct.Memory* %MEMORY.0)
...
block_.L_410111:                                  ; preds = %block_.L_4100d0, %block_41010c
  ...
  %call2_410114 = tail call %struct.Memory* @sub_40c130._Z9check_sumIiEvT_(%struct.State* nonnull %0, i64 %409, %struct.Memory* %MEMORY.0)
