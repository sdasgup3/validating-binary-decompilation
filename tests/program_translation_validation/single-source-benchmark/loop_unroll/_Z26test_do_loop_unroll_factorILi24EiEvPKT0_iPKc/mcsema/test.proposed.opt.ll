...
block_.L_41003f:                                  ; preds = %block_.L_4100e1, %entry
  %68 = phi i64 [ %.pre, %entry ], [ %445, %block_.L_4100e1 ]
...
block_.L_4100b1:                                  ; preds = %block_.L_4100b1, %block_4100ac
  %277 = phi i64 [ %276, %block_4100ac ], [ %400, %block_.L_4100b1 ]
  %278 = phi i64 [ %239, %block_4100ac ], [ %365, %block_.L_4100b1 ]
  ...
  br i1 %389, label %block_4100dc, label %block_.L_4100b1
...
block_.L_4100e1:                                  ; preds = %block_.L_4100a0, %block_4100dc
  %402 = phi i64 [ %275, %block_.L_4100a0 ], [ %401, %block_4100dc ]
  %403 = phi i64 [ %239, %block_.L_4100a0 ], [ %365, %block_4100dc ]
  ...
  %call2_4100e4 = tail call %struct.Memory* @sub_40c100._Z9check_sumIiEvT_(%struct.State* %0, i64 %409, %struct.Memory* %MEMORY.4)
...
block_.L_4100f7:                                  ; preds = %block_.L_41003f
  ...
  %call2_4100f7 = tail call %struct.Memory* @sub_400df0._Z5timerv(%struct.State* %0, i64 %446, %struct.Memory* %MEMORY.0)
  ...
  %call2_410100 = tail call %struct.Memory* @sub_400790._Z13record_resultdPKc(%struct.State* %0, i64 %457, %struct.Memory* %call2_4100f7)
