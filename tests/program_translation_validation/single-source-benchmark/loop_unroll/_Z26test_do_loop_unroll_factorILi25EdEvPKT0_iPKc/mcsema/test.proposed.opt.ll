...
block_.L_4053af:                                  ; preds = %block_.L_405458, %entry
  %79 = phi i64 [ %.pre, %entry ], [ %433, %block_.L_405458 ]
...
block_.L_405422:                                  ; preds = %block_.L_405422, %block_40541d
  %290 = phi i64 [ %289, %block_40541d ], [ %387, %block_.L_405422 ]
  %291 = phi i64 [ %252, %block_40541d ], [ %352, %block_.L_405422 ]
  ...
  %call2_40542f = tail call %struct.Memory* @sub_401480._Z18complete_hash_funcIdET_S0_(%struct.State* %0, i64 %307, %struct.Memory* %MEMORY.3)
  ...
  br i1 %376, label %block_405453, label %block_.L_405422
...
block_.L_405458:                                  ; preds = %block_.L_405411, %block_405453
  %389 = phi i64 [ %288, %block_.L_405411 ], [ %388, %block_405453 ]
  %390 = phi i64 [ %252, %block_.L_405411 ], [ %352, %block_405453 ]
  ...
  %call2_40545d = tail call %struct.Memory* @sub_4014b0._Z9check_sumIdEvT_(%struct.State* %0, i64 %396, %struct.Memory* %MEMORY.4)
...
block_.L_405470:                                  ; preds = %block_.L_4053af
  ...
  %call2_405470 = tail call %struct.Memory* @sub_400df0._Z5timerv(%struct.State* %0, i64 %434, %struct.Memory* %MEMORY.0)
  ...
  %call2_405479 = tail call %struct.Memory* @sub_400790._Z13record_resultdPKc(%struct.State* %0, i64 %445, %struct.Memory* %call2_405470)
