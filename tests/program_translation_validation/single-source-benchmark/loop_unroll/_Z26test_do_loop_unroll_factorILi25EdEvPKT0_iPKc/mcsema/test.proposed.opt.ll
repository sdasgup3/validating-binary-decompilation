...
entry:
  ...
  %call2_4053a3 = tail call %struct.Memory* @sub_400dd0._Z11start_timerv(%struct.State* %0, i64 %58, %struct.Memory* %2)
...
block_.L_4053af:                                  ; preds = %block_.L_405458, %entry
  %79 = phi i64 [ %.pre, %entry ], [ %429, %block_.L_405458 ]
  %MEMORY.0 = phi %struct.Memory* [ %call2_4053a3, %entry ], [ %call2_40545d, %block_.L_405458 ]
  ...
  br i1 %112, label %block_4053bf, label %block_.L_405470
...
block_4053bf:                                     ; preds = %block_.L_4053af
  ...
  br i1 %160, label %block_.L_405411, label %block_4053dd
...
block_.L_4053e2:                                  ; preds = %block_.L_4053e2, %block_4053dd
  %163 = phi i64 [ %162, %block_4053dd ], [ %249, %block_.L_4053e2 ]
  %164 = phi i64 [ %124, %block_4053dd ], [ %210, %block_.L_4053e2 ]
  %MEMORY.1 = phi %struct.Memory* [ %MEMORY.0, %block_4053dd ], [ %call2_4053ed, %block_.L_4053e2 ]
  %165 = add i64 %164, -40
  ...
  %call2_4053ed = tail call %struct.Memory* @sub_401830._ZN15loop_inner_bodyILi25EdE7do_workERdPKdi(%struct.State* %0, i64 %175, %struct.Memory* %MEMORY.1)
  ...
  br i1 %248, label %block_.L_4053e2, label %block_40540c
...
block_.L_405411:                                  ; preds = %block_40540c, %block_4053bf
  %251 = phi i64 [ %161, %block_4053bf ], [ %250, %block_40540c ]
  %252 = phi i64 [ %124, %block_4053bf ], [ %210, %block_40540c ]
  %MEMORY.2 = phi %struct.Memory* [ %MEMORY.0, %block_4053bf ], [ %call2_4053ed, %block_40540c ]
  %253 = add i64 %252, -44
  %254 = add i64 %251, 3
  ...
  br i1 %287, label %block_40541d, label %block_.L_405458
...
block_.L_405422:                                  ; preds = %block_.L_405422, %block_40541d
  %290 = phi i64 [ %289, %block_40541d ], [ %385, %block_.L_405422 ]
  %291 = phi i64 [ %252, %block_40541d ], [ %350, %block_.L_405422 ]
  %MEMORY.3 = phi %struct.Memory* [ %MEMORY.2, %block_40541d ], [ %call2_40542f, %block_.L_405422 ]
  %292 = add i64 %291, -8
  %293 = add i64 %290, 4
  ...
  %call2_40542f = tail call %struct.Memory* @sub_401480._Z18complete_hash_funcIdET_S0_(%struct.State* %0, i64 %306, %struct.Memory* %MEMORY.3)
  ...
  br i1 %374, label %block_405453, label %block_.L_405422
...
block_.L_405458:                                  ; preds = %block_.L_405411, %block_405453
  %387 = phi i64 [ %288, %block_.L_405411 ], [ %386, %block_405453 ]
  %388 = phi i64 [ %252, %block_.L_405411 ], [ %350, %block_405453 ]
  %MEMORY.4 = phi %struct.Memory* [ %MEMORY.2, %block_.L_405411 ], [ %call2_40542f, %block_405453 ]
  %389 = add i64 %388, -40
  %390 = add i64 %387, 5
  ...
  %call2_40545d = tail call %struct.Memory* @sub_4014b0._Z9check_sumIdEvT_(%struct.State* %0, i64 %393, %struct.Memory* %MEMORY.4)
...
block_.L_405470:                                  ; preds = %block_.L_4053af
  ...
  %call2_405470 = tail call %struct.Memory* @sub_400df0._Z5timerv(%struct.State* %0, i64 %430, %struct.Memory* %MEMORY.0)
  ...
  %call2_405479 = tail call %struct.Memory* @sub_400790._Z13record_resultdPKc(%struct.State* %0, i64 %441, %struct.Memory* %call2_405470)
  ...
  ret %struct.Memory* %call2_405479
}
...
define %struct.Memory* @routine_jge_.L_405470(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i8* %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
...
define %struct.Memory* @routine_jl_.L_405411(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i8* %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 2, i32 9
...
define %struct.Memory* @routine_jmpq_.L_4053e2(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
...
define %struct.Memory* @routine_jl_.L_4053e2(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i8* %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 2, i32 9
...
define %struct.Memory* @routine_jmpq_.L_405411(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
...
define %struct.Memory* @routine_jge_.L_405458(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i8* %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 2, i32 9
...
define %struct.Memory* @routine_jmpq_.L_405422(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
...
define %struct.Memory* @routine_jne_.L_405422(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i8* %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
...
define %struct.Memory* @routine_jmpq_.L_405458(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
...
define %struct.Memory* @routine_jmpq_.L_4053af(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
