...
block_.L_405412:                                  ; preds = %block_.L_405412, %block_40540d
  %157 = phi i64 [ %243, %block_.L_405412 ], [ %156, %block_40540d ]
  %158 = phi i64 [ %204, %block_.L_405412 ], [ %118, %block_40540d ]
  %159 = add i64 %158, -40
  ...
  %call2_40541d = tail call %struct.Memory* @sub_401860._ZN15loop_inner_bodyILi25EdE7do_workERdPKdi(%struct.State* nonnull %0, i64 %169, %struct.Memory* %MEMORY.0)
...
block_.L_405441:                                  ; preds = %block_40543c, %block_4053ef
  %245 = phi i64 [ %244, %block_40543c ], [ %155, %block_4053ef ]
  %246 = phi i64 [ %204, %block_40543c ], [ %118, %block_4053ef ]
  %247 = add i64 %246, -44
  %248 = add i64 %245, 3
...
block_.L_405452:                                  ; preds = %block_.L_405452, %block_40544d
  %284 = phi i64 [ %380, %block_.L_405452 ], [ %283, %block_40544d ]
  %285 = phi i64 [ %345, %block_.L_405452 ], [ %246, %block_40544d ]
  %286 = add i64 %285, -8
  %287 = add i64 %284, 4
  ...
  %call2_40545f = tail call %struct.Memory* @sub_4014b0._Z18complete_hash_funcIdET_S0_(%struct.State* nonnull %0, i64 %300, %struct.Memory* %MEMORY.0)
...
block_.L_405488:                                  ; preds = %block_.L_405441, %block_405483
  ...
  %call2_40548d = tail call %struct.Memory* @sub_4014e0._Z9check_sumIdEvT_(%struct.State* nonnull %0, i64 %388, %struct.Memory* %MEMORY.0)
