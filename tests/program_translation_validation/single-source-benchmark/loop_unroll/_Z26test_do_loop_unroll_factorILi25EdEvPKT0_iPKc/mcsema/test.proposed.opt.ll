...
entry:
  ...
  %call2_4053e3 = tail call %struct.Memory* @sub_400e10._Z11start_timerv(%struct.State* %0, i64 %58, %struct.Memory* %2)
...
block_.L_4053ef:                                  ; preds = %block_.L_405498, %entry
  %74 = phi i64 [ %.pre, %entry ], [ %424, %block_.L_405498 ]
  %MEMORY.0 = phi %struct.Memory* [ %call2_4053e3, %entry ], [ %call2_40549d, %block_.L_405498 ]
  ...
  br i1 %107, label %block_4053ff, label %block_.L_4054b0
...
block_4053ff:                                     ; preds = %block_.L_4053ef
  ...
  br i1 %154, label %block_.L_405451, label %block_40541d
...
block_.L_405422:                                  ; preds = %block_.L_405422, %block_40541d
  %157 = phi i64 [ %243, %block_.L_405422 ], [ %156, %block_40541d ]
  %158 = phi i64 [ %204, %block_.L_405422 ], [ %118, %block_40541d ]
  %159 = add i64 %158, -40
  ...
  %call2_40542d = tail call %struct.Memory* @sub_401870._ZN15loop_inner_bodyILi25EdE7do_workERdPKdi(%struct.State* nonnull %0, i64 %169, %struct.Memory* %MEMORY.0)
  ...
  br i1 %242, label %block_.L_405422, label %block_40544c
...
block_.L_405451:                                  ; preds = %block_40544c, %block_4053ff
  %245 = phi i64 [ %244, %block_40544c ], [ %155, %block_4053ff ]
  %246 = phi i64 [ %204, %block_40544c ], [ %118, %block_4053ff ]
  %247 = add i64 %246, -44
  %248 = add i64 %245, 3
  ...
  br i1 %281, label %block_40545d, label %block_.L_405498
...
block_.L_405462:                                  ; preds = %block_.L_405462, %block_40545d
  %284 = phi i64 [ %380, %block_.L_405462 ], [ %283, %block_40545d ]
  %285 = phi i64 [ %345, %block_.L_405462 ], [ %246, %block_40545d ]
  %286 = add i64 %285, -8
  %287 = add i64 %284, 4
  ...
  %call2_40546f = tail call %struct.Memory* @sub_4014c0._Z18complete_hash_funcIdET_S0_(%struct.State* nonnull %0, i64 %300, %struct.Memory* %MEMORY.0)
  ...
  br i1 %369, label %block_405493, label %block_.L_405462
...
block_.L_405498:                                  ; preds = %block_.L_405451, %block_405493
  %382 = phi i64 [ %282, %block_.L_405451 ], [ %381, %block_405493 ]
  %383 = phi i64 [ %246, %block_.L_405451 ], [ %345, %block_405493 ]
  %384 = add i64 %383, -40
  %385 = add i64 %382, 5
  ...
  %call2_40549d = tail call %struct.Memory* @sub_4014f0._Z9check_sumIdEvT_(%struct.State* nonnull %0, i64 %388, %struct.Memory* %MEMORY.0)
...
block_.L_4054b0:                                  ; preds = %block_.L_4053ef
  ...
  %call2_4054b0 = tail call %struct.Memory* @sub_400e30._Z5timerv(%struct.State* nonnull %0, i64 %425, %struct.Memory* %MEMORY.0)
  ...
  %call2_4054b9 = tail call %struct.Memory* @sub_4007d0._Z13record_resultdPKc(%struct.State* nonnull %0, i64 %436, %struct.Memory* %call2_4054b0)
