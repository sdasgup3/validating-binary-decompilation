...
block_.L_40feff:                                  ; preds = %block_.L_40ffa1, %entry
  %68 = phi i64 [ %.pre, %entry ], [ %447, %block_.L_40ffa1 ]
...
block_.L_40ff71:                                  ; preds = %block_.L_40ff71, %block_40ff6c
  %277 = phi i64 [ %276, %block_40ff6c ], [ %401, %block_.L_40ff71 ]
  %278 = phi i64 [ %239, %block_40ff6c ], [ %366, %block_.L_40ff71 ]
  ...
  br i1 %390, label %block_40ff9c, label %block_.L_40ff71
...
block_.L_40ffa1:                                  ; preds = %block_.L_40ff60, %block_40ff9c
  %403 = phi i64 [ %275, %block_.L_40ff60 ], [ %402, %block_40ff9c ]
  %404 = phi i64 [ %239, %block_.L_40ff60 ], [ %366, %block_40ff9c ]
  ...
  %call2_40ffa4 = tail call %struct.Memory* @sub_40c100._Z9check_sumIiEvT_(%struct.State* %0, i64 %410, %struct.Memory* %MEMORY.4)
...
block_.L_40ffb7:                                  ; preds = %block_.L_40feff
  ...
  %call2_40ffb7 = tail call %struct.Memory* @sub_400df0._Z5timerv(%struct.State* %0, i64 %448, %struct.Memory* %MEMORY.0)
  ...
  %call2_40ffc0 = tail call %struct.Memory* @sub_400790._Z13record_resultdPKc(%struct.State* %0, i64 %459, %struct.Memory* %call2_40ffb7)
