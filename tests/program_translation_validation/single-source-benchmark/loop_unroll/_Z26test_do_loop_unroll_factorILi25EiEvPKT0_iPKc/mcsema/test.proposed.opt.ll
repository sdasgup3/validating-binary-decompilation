...
define %struct.Memory* @_Z26test_do_loop_unroll_factorILi25EiEvPKT0_iPKc(%struct.State* noalias, i64, %struct.Memory* noalias) local_unnamed_addr #1 {
entry:
  ...
  %call2_40fef3 = tail call %struct.Memory* @sub_400dd0._Z11start_timerv(%struct.State* %0, i64 %58, %struct.Memory* %2)
...
block_.L_40feff:                                  ; preds = %block_.L_40ffa1, %entry
  %68 = phi i64 [ %.pre, %entry ], [ %445, %block_.L_40ffa1 ]
  %MEMORY.0 = phi %struct.Memory* [ %call2_40fef3, %entry ], [ %call2_40ffa4, %block_.L_40ffa1 ]
  ...
  br i1 %101, label %block_40ff0f, label %block_.L_40ffb7
...
block_40ff0f:                                     ; preds = %block_.L_40feff
  ...
  br i1 %147, label %block_.L_40ff60, label %block_40ff2c
...
block_.L_40ff31:                                  ; preds = %block_.L_40ff31, %block_40ff2c
  %150 = phi i64 [ %149, %block_40ff2c ], [ %236, %block_.L_40ff31 ]
  %151 = phi i64 [ %111, %block_40ff2c ], [ %197, %block_.L_40ff31 ]
  %MEMORY.1 = phi %struct.Memory* [ %MEMORY.0, %block_40ff2c ], [ %call2_40ff3c, %block_.L_40ff31 ]
  %152 = add i64 %151, -32
  ...
  %call2_40ff3c = tail call %struct.Memory* @sub_40c3f0._ZN15loop_inner_bodyILi25EiE7do_workERiPKii(%struct.State* %0, i64 %162, %struct.Memory* %MEMORY.1)
  ...
  br i1 %235, label %block_.L_40ff31, label %block_40ff5b
...
block_.L_40ff60:                                  ; preds = %block_40ff5b, %block_40ff0f
  %238 = phi i64 [ %148, %block_40ff0f ], [ %237, %block_40ff5b ]
  %239 = phi i64 [ %111, %block_40ff0f ], [ %197, %block_40ff5b ]
  %MEMORY.2 = phi %struct.Memory* [ %MEMORY.0, %block_40ff0f ], [ %call2_40ff3c, %block_40ff5b ]
  %240 = add i64 %239, -36
  %241 = add i64 %238, 3
  ...
  br i1 %274, label %block_40ff6c, label %block_.L_40ffa1
...
block_.L_40ff71:                                  ; preds = %block_.L_40ff71, %block_40ff6c
  %277 = phi i64 [ %276, %block_40ff6c ], [ %400, %block_.L_40ff71 ]
  %278 = phi i64 [ %239, %block_40ff6c ], [ %365, %block_.L_40ff71 ]
  %MEMORY.3 = phi %struct.Memory* [ %MEMORY.2, %block_40ff6c ], [ %call2_40ff7c, %block_.L_40ff71 ]
  %279 = add i64 %278, -8
  %280 = add i64 %277, 4
  ...
  %call2_40ff7c = tail call %struct.Memory* @sub_40c0d0._Z18complete_hash_funcIiET_S0_(%struct.State* %0, i64 %294, %struct.Memory* %MEMORY.3)
  ...
  br i1 %389, label %block_40ff9c, label %block_.L_40ff71
...
block_.L_40ffa1:                                  ; preds = %block_.L_40ff60, %block_40ff9c
  %402 = phi i64 [ %275, %block_.L_40ff60 ], [ %401, %block_40ff9c ]
  %403 = phi i64 [ %239, %block_.L_40ff60 ], [ %365, %block_40ff9c ]
  %MEMORY.4 = phi %struct.Memory* [ %MEMORY.2, %block_.L_40ff60 ], [ %call2_40ff7c, %block_40ff9c ]
  %404 = add i64 %403, -32
  %405 = add i64 %402, 3
  ...
  %call2_40ffa4 = tail call %struct.Memory* @sub_40c100._Z9check_sumIiEvT_(%struct.State* %0, i64 %409, %struct.Memory* %MEMORY.4)
...
block_.L_40ffb7:                                  ; preds = %block_.L_40feff
  ...
  %call2_40ffb7 = tail call %struct.Memory* @sub_400df0._Z5timerv(%struct.State* %0, i64 %446, %struct.Memory* %MEMORY.0)
  ...
  %call2_40ffc0 = tail call %struct.Memory* @sub_400790._Z13record_resultdPKc(%struct.State* %0, i64 %457, %struct.Memory* %call2_40ffb7)
  ...
  ret %struct.Memory* %call2_40ffc0
}
...
define %struct.Memory* @routine_jge_.L_40ffb7(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i8* %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
...
define %struct.Memory* @routine_jl_.L_40ff60(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i8* %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 2, i32 9
...
define %struct.Memory* @routine_jmpq_.L_40ff31(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
...
define %struct.Memory* @routine_jl_.L_40ff31(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i8* %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 2, i32 9
...
define %struct.Memory* @routine_jmpq_.L_40ff60(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
...
define %struct.Memory* @routine_jge_.L_40ffa1(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i8* %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 2, i32 9
...
define %struct.Memory* @routine_jmpq_.L_40ff71(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
...
define %struct.Memory* @routine_jne_.L_40ff71(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i8* %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
...
define %struct.Memory* @routine_jmpq_.L_40ffa1(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
...
define %struct.Memory* @routine_jmpq_.L_40feff(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
