...
block_.L_40ff61:                                  ; preds = %block_.L_40ff61, %block_40ff5c
  %150 = phi i64 [ %149, %block_40ff5c ], [ %236, %block_.L_40ff61 ]
  %151 = phi i64 [ %111, %block_40ff5c ], [ %197, %block_.L_40ff61 ]
  %MEMORY.1 = phi %struct.Memory* [ %MEMORY.0, %block_40ff5c ], [ %call2_40ff6c, %block_.L_40ff61 ]
  %152 = add i64 %151, -32
  ...
  %call2_40ff6c = tail call %struct.Memory* @sub_40c420._ZN15loop_inner_bodyILi25EiE7do_workERiPKii(%struct.State* nonnull %0, i64 %162, %struct.Memory* %MEMORY.1)
...
block_.L_40ff90:                                  ; preds = %block_40ff8b, %block_40ff3f
  %238 = phi i64 [ %148, %block_40ff3f ], [ %237, %block_40ff8b ]
  %239 = phi i64 [ %111, %block_40ff3f ], [ %197, %block_40ff8b ]
  %MEMORY.2 = phi %struct.Memory* [ %MEMORY.0, %block_40ff3f ], [ %call2_40ff6c, %block_40ff8b ]
  %240 = add i64 %239, -36
  %241 = add i64 %238, 3
...
block_.L_40ffa1:                                  ; preds = %block_.L_40ffa1, %block_40ff9c
  %277 = phi i64 [ %276, %block_40ff9c ], [ %400, %block_.L_40ffa1 ]
  %278 = phi i64 [ %239, %block_40ff9c ], [ %365, %block_.L_40ffa1 ]
  %MEMORY.3 = phi %struct.Memory* [ %MEMORY.2, %block_40ff9c ], [ %call2_40ffac, %block_.L_40ffa1 ]
  %279 = add i64 %278, -8
  %280 = add i64 %277, 4
  ...
  %call2_40ffac = tail call %struct.Memory* @sub_40c100._Z18complete_hash_funcIiET_S0_(%struct.State* nonnull %0, i64 %294, %struct.Memory* %MEMORY.3)
...
block_.L_40ffd1:                                  ; preds = %block_.L_40ff90, %block_40ffcc
  ...
  %MEMORY.4 = phi %struct.Memory* [ %MEMORY.2, %block_.L_40ff90 ], [ %call2_40ffac, %block_40ffcc ]
  %404 = add i64 %403, -32
  %405 = add i64 %402, 3
  ...
  %call2_40ffd4 = tail call %struct.Memory* @sub_40c130._Z9check_sumIiEvT_(%struct.State* nonnull %0, i64 %409, %struct.Memory* %MEMORY.4)
