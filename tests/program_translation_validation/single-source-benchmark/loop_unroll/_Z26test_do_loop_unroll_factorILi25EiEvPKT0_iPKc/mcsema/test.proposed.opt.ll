...
entry:
  ...
  %call2_40ff33 = tail call %struct.Memory* @sub_400e10._Z11start_timerv(%struct.State* %0, i64 %58, %struct.Memory* %2)
...
block_.L_40ff3f:                                  ; preds = %block_.L_40ffe1, %entry
  %68 = phi i64 [ %.pre, %entry ], [ %445, %block_.L_40ffe1 ]
  %MEMORY.0 = phi %struct.Memory* [ %call2_40ff33, %entry ], [ %call2_40ffe4, %block_.L_40ffe1 ]
  ...
  br i1 %101, label %block_40ff4f, label %block_.L_40fff7
...
block_40ff4f:                                     ; preds = %block_.L_40ff3f
  ...
  br i1 %147, label %block_.L_40ffa0, label %block_40ff6c
...
block_.L_40ff71:                                  ; preds = %block_.L_40ff71, %block_40ff6c
  %150 = phi i64 [ %236, %block_.L_40ff71 ], [ %149, %block_40ff6c ]
  %151 = phi i64 [ %197, %block_.L_40ff71 ], [ %111, %block_40ff6c ]
  %152 = add i64 %151, -32
  ...
  %call2_40ff7c = tail call %struct.Memory* @sub_40c430._ZN15loop_inner_bodyILi25EiE7do_workERiPKii(%struct.State* nonnull %0, i64 %162, %struct.Memory* %MEMORY.0)
  ...
  br i1 %235, label %block_.L_40ff71, label %block_40ff9b
...
block_.L_40ffa0:                                  ; preds = %block_40ff9b, %block_40ff4f
  %238 = phi i64 [ %237, %block_40ff9b ], [ %148, %block_40ff4f ]
  %239 = phi i64 [ %197, %block_40ff9b ], [ %111, %block_40ff4f ]
  %240 = add i64 %239, -36
  %241 = add i64 %238, 3
  ...
  br i1 %274, label %block_40ffac, label %block_.L_40ffe1
...
block_.L_40ffb1:                                  ; preds = %block_.L_40ffb1, %block_40ffac
  %277 = phi i64 [ %400, %block_.L_40ffb1 ], [ %276, %block_40ffac ]
  %278 = phi i64 [ %365, %block_.L_40ffb1 ], [ %239, %block_40ffac ]
  %279 = add i64 %278, -8
  %280 = add i64 %277, 4
  ...
  %call2_40ffbc = tail call %struct.Memory* @sub_40c110._Z18complete_hash_funcIiET_S0_(%struct.State* nonnull %0, i64 %294, %struct.Memory* %MEMORY.0)
  ...
  br i1 %389, label %block_40ffdc, label %block_.L_40ffb1
...
block_.L_40ffe1:                                  ; preds = %block_.L_40ffa0, %block_40ffdc
  %402 = phi i64 [ %275, %block_.L_40ffa0 ], [ %401, %block_40ffdc ]
  %403 = phi i64 [ %239, %block_.L_40ffa0 ], [ %365, %block_40ffdc ]
  %404 = add i64 %403, -32
  %405 = add i64 %402, 3
  ...
  %call2_40ffe4 = tail call %struct.Memory* @sub_40c140._Z9check_sumIiEvT_(%struct.State* nonnull %0, i64 %409, %struct.Memory* %MEMORY.0)
...
block_.L_40fff7:                                  ; preds = %block_.L_40ff3f
  ...
  %call2_40fff7 = tail call %struct.Memory* @sub_400e30._Z5timerv(%struct.State* nonnull %0, i64 %446, %struct.Memory* %MEMORY.0)
  ...
  %call2_410000 = tail call %struct.Memory* @sub_4007d0._Z13record_resultdPKc(%struct.State* nonnull %0, i64 %457, %struct.Memory* %call2_40fff7)
