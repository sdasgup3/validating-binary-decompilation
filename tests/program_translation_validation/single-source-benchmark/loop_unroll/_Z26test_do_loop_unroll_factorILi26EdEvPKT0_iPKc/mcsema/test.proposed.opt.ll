...
entry:
  ...
  %call2_405253 = tail call %struct.Memory* @sub_400dd0._Z11start_timerv(%struct.State* %0, i64 %58, %struct.Memory* %2)
...
block_.L_40525f:                                  ; preds = %block_.L_405308, %entry
  %79 = phi i64 [ %.pre, %entry ], [ %429, %block_.L_405308 ]
  %MEMORY.0 = phi %struct.Memory* [ %call2_405253, %entry ], [ %call2_40530d, %block_.L_405308 ]
  ...
  br i1 %112, label %block_40526f, label %block_.L_405320
...
block_40526f:                                     ; preds = %block_.L_40525f
  ...
  br i1 %160, label %block_.L_4052c1, label %block_40528d
...
block_.L_405292:                                  ; preds = %block_.L_405292, %block_40528d
  %163 = phi i64 [ %162, %block_40528d ], [ %249, %block_.L_405292 ]
  %164 = phi i64 [ %124, %block_40528d ], [ %210, %block_.L_405292 ]
  %MEMORY.1 = phi %struct.Memory* [ %MEMORY.0, %block_40528d ], [ %call2_40529d, %block_.L_405292 ]
  %165 = add i64 %164, -40
  ...
  %call2_40529d = tail call %struct.Memory* @sub_4017d0._ZN15loop_inner_bodyILi26EdE7do_workERdPKdi(%struct.State* %0, i64 %175, %struct.Memory* %MEMORY.1)
  ...
  br i1 %248, label %block_.L_405292, label %block_4052bc
...
block_.L_4052c1:                                  ; preds = %block_4052bc, %block_40526f
  %251 = phi i64 [ %161, %block_40526f ], [ %250, %block_4052bc ]
  %252 = phi i64 [ %124, %block_40526f ], [ %210, %block_4052bc ]
  %MEMORY.2 = phi %struct.Memory* [ %MEMORY.0, %block_40526f ], [ %call2_40529d, %block_4052bc ]
  %253 = add i64 %252, -44
  %254 = add i64 %251, 3
  ...
  br i1 %287, label %block_4052cd, label %block_.L_405308
...
block_.L_4052d2:                                  ; preds = %block_.L_4052d2, %block_4052cd
  %290 = phi i64 [ %289, %block_4052cd ], [ %385, %block_.L_4052d2 ]
  %291 = phi i64 [ %252, %block_4052cd ], [ %350, %block_.L_4052d2 ]
  %MEMORY.3 = phi %struct.Memory* [ %MEMORY.2, %block_4052cd ], [ %call2_4052df, %block_.L_4052d2 ]
  %292 = add i64 %291, -8
  %293 = add i64 %290, 4
  ...
  %call2_4052df = tail call %struct.Memory* @sub_401480._Z18complete_hash_funcIdET_S0_(%struct.State* %0, i64 %306, %struct.Memory* %MEMORY.3)
  ...
  br i1 %374, label %block_405303, label %block_.L_4052d2
...
block_.L_405308:                                  ; preds = %block_.L_4052c1, %block_405303
  %387 = phi i64 [ %288, %block_.L_4052c1 ], [ %386, %block_405303 ]
  %388 = phi i64 [ %252, %block_.L_4052c1 ], [ %350, %block_405303 ]
  %MEMORY.4 = phi %struct.Memory* [ %MEMORY.2, %block_.L_4052c1 ], [ %call2_4052df, %block_405303 ]
  %389 = add i64 %388, -40
  %390 = add i64 %387, 5
  ...
  %call2_40530d = tail call %struct.Memory* @sub_4014b0._Z9check_sumIdEvT_(%struct.State* %0, i64 %393, %struct.Memory* %MEMORY.4)
...
block_.L_405320:                                  ; preds = %block_.L_40525f
  ...
  %call2_405320 = tail call %struct.Memory* @sub_400df0._Z5timerv(%struct.State* %0, i64 %430, %struct.Memory* %MEMORY.0)
  ...
  %call2_405329 = tail call %struct.Memory* @sub_400790._Z13record_resultdPKc(%struct.State* %0, i64 %441, %struct.Memory* %call2_405320)
  ...
  ret %struct.Memory* %call2_405329
}
...
define %struct.Memory* @routine_jge_.L_405320(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i8* %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
...
define %struct.Memory* @routine_jl_.L_4052c1(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i8* %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 2, i32 9
...
define %struct.Memory* @routine_jmpq_.L_405292(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
...
define %struct.Memory* @routine_jl_.L_405292(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i8* %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 2, i32 9
...
define %struct.Memory* @routine_jmpq_.L_4052c1(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
...
define %struct.Memory* @routine_jge_.L_405308(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i8* %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 2, i32 9
...
define %struct.Memory* @routine_jmpq_.L_4052d2(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
...
define %struct.Memory* @routine_jne_.L_4052d2(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i8* %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
...
define %struct.Memory* @routine_jmpq_.L_405308(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
...
define %struct.Memory* @routine_jmpq_.L_40525f(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
