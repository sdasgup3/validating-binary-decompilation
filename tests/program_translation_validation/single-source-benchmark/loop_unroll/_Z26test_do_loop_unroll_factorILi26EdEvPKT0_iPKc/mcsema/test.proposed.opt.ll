...
block_.L_40525f:                                  ; preds = %block_.L_405308, %entry
  %79 = phi i64 [ %.pre, %entry ], [ %433, %block_.L_405308 ]
...
block_.L_4052d2:                                  ; preds = %block_.L_4052d2, %block_4052cd
  %290 = phi i64 [ %289, %block_4052cd ], [ %387, %block_.L_4052d2 ]
  %291 = phi i64 [ %252, %block_4052cd ], [ %352, %block_.L_4052d2 ]
  ...
  %call2_4052df = tail call %struct.Memory* @sub_401480._Z18complete_hash_funcIdET_S0_(%struct.State* %0, i64 %307, %struct.Memory* %MEMORY.3)
  ...
  br i1 %376, label %block_405303, label %block_.L_4052d2
...
block_.L_405308:                                  ; preds = %block_.L_4052c1, %block_405303
  %389 = phi i64 [ %288, %block_.L_4052c1 ], [ %388, %block_405303 ]
  %390 = phi i64 [ %252, %block_.L_4052c1 ], [ %352, %block_405303 ]
  ...
  %call2_40530d = tail call %struct.Memory* @sub_4014b0._Z9check_sumIdEvT_(%struct.State* %0, i64 %396, %struct.Memory* %MEMORY.4)
...
block_.L_405320:                                  ; preds = %block_.L_40525f
  ...
  %call2_405320 = tail call %struct.Memory* @sub_400df0._Z5timerv(%struct.State* %0, i64 %434, %struct.Memory* %MEMORY.0)
  ...
  %call2_405329 = tail call %struct.Memory* @sub_400790._Z13record_resultdPKc(%struct.State* %0, i64 %445, %struct.Memory* %call2_405320)
