...
entry:
  ...
  %call2_405293 = tail call %struct.Memory* @sub_400e10._Z11start_timerv(%struct.State* %0, i64 %58, %struct.Memory* %2)
...
block_.L_40529f:                                  ; preds = %block_.L_405348, %entry
  %74 = phi i64 [ %.pre, %entry ], [ %424, %block_.L_405348 ]
  %MEMORY.0 = phi %struct.Memory* [ %call2_405293, %entry ], [ %call2_40534d, %block_.L_405348 ]
  ...
  br i1 %107, label %block_4052af, label %block_.L_405360
...
block_4052af:                                     ; preds = %block_.L_40529f
  ...
  br i1 %154, label %block_.L_405301, label %block_4052cd
...
block_.L_4052d2:                                  ; preds = %block_.L_4052d2, %block_4052cd
  %157 = phi i64 [ %243, %block_.L_4052d2 ], [ %156, %block_4052cd ]
  %158 = phi i64 [ %204, %block_.L_4052d2 ], [ %118, %block_4052cd ]
  %159 = add i64 %158, -40
  ...
  %call2_4052dd = tail call %struct.Memory* @sub_401810._ZN15loop_inner_bodyILi26EdE7do_workERdPKdi(%struct.State* nonnull %0, i64 %169, %struct.Memory* %MEMORY.0)
  ...
  br i1 %242, label %block_.L_4052d2, label %block_4052fc
...
block_.L_405301:                                  ; preds = %block_4052fc, %block_4052af
  %245 = phi i64 [ %244, %block_4052fc ], [ %155, %block_4052af ]
  %246 = phi i64 [ %204, %block_4052fc ], [ %118, %block_4052af ]
  %247 = add i64 %246, -44
  %248 = add i64 %245, 3
  ...
  br i1 %281, label %block_40530d, label %block_.L_405348
...
block_.L_405312:                                  ; preds = %block_.L_405312, %block_40530d
  %284 = phi i64 [ %380, %block_.L_405312 ], [ %283, %block_40530d ]
  %285 = phi i64 [ %345, %block_.L_405312 ], [ %246, %block_40530d ]
  %286 = add i64 %285, -8
  %287 = add i64 %284, 4
  ...
  %call2_40531f = tail call %struct.Memory* @sub_4014c0._Z18complete_hash_funcIdET_S0_(%struct.State* nonnull %0, i64 %300, %struct.Memory* %MEMORY.0)
  ...
  br i1 %369, label %block_405343, label %block_.L_405312
...
block_.L_405348:                                  ; preds = %block_.L_405301, %block_405343
  %382 = phi i64 [ %282, %block_.L_405301 ], [ %381, %block_405343 ]
  %383 = phi i64 [ %246, %block_.L_405301 ], [ %345, %block_405343 ]
  %384 = add i64 %383, -40
  %385 = add i64 %382, 5
  ...
  %call2_40534d = tail call %struct.Memory* @sub_4014f0._Z9check_sumIdEvT_(%struct.State* nonnull %0, i64 %388, %struct.Memory* %MEMORY.0)
...
block_.L_405360:                                  ; preds = %block_.L_40529f
  ...
  %call2_405360 = tail call %struct.Memory* @sub_400e30._Z5timerv(%struct.State* nonnull %0, i64 %425, %struct.Memory* %MEMORY.0)
  ...
  %call2_405369 = tail call %struct.Memory* @sub_4007d0._Z13record_resultdPKc(%struct.State* nonnull %0, i64 %436, %struct.Memory* %call2_405360)
