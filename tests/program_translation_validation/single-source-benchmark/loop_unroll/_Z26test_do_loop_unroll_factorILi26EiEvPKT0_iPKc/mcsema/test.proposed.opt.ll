...
declare %struct.Memory* @sub_40c3c0._ZN15loop_inner_bodyILi26EiE7do_workERiPKii(%struct.State* noalias dereferenceable(3376), i64, %struct.Memory* noalias readnone returned) local_unnamed_addr
...
define %struct.Memory* @_Z26test_do_loop_unroll_factorILi26EiEvPKT0_iPKc(%struct.State* noalias, i64, %struct.Memory* noalias readnone) local_unnamed_addr #1 {
entry:
...
block_.L_40fe21:                                  ; preds = %block_.L_40fe21, %block_40fe1c
  %150 = phi i64 [ %236, %block_.L_40fe21 ], [ %149, %block_40fe1c ]
  %151 = phi i64 [ %197, %block_.L_40fe21 ], [ %111, %block_40fe1c ]
  %152 = add i64 %151, -32
  ...
  %call2_40fe2c = tail call %struct.Memory* @sub_40c3c0._ZN15loop_inner_bodyILi26EiE7do_workERiPKii(%struct.State* nonnull %0, i64 %162, %struct.Memory* %MEMORY.0)
...
block_.L_40fe50:                                  ; preds = %block_40fe4b, %block_40fdff
  %238 = phi i64 [ %237, %block_40fe4b ], [ %148, %block_40fdff ]
  %239 = phi i64 [ %197, %block_40fe4b ], [ %111, %block_40fdff ]
  %240 = add i64 %239, -36
  %241 = add i64 %238, 3
...
block_.L_40fe61:                                  ; preds = %block_.L_40fe61, %block_40fe5c
  %277 = phi i64 [ %400, %block_.L_40fe61 ], [ %276, %block_40fe5c ]
  %278 = phi i64 [ %365, %block_.L_40fe61 ], [ %239, %block_40fe5c ]
  %279 = add i64 %278, -8
  %280 = add i64 %277, 4
  ...
  %call2_40fe6c = tail call %struct.Memory* @sub_40c100._Z18complete_hash_funcIiET_S0_(%struct.State* nonnull %0, i64 %294, %struct.Memory* %MEMORY.0)
...
block_.L_40fe91:                                  ; preds = %block_.L_40fe50, %block_40fe8c
  ...
  %call2_40fe94 = tail call %struct.Memory* @sub_40c130._Z9check_sumIiEvT_(%struct.State* nonnull %0, i64 %409, %struct.Memory* %MEMORY.0)
