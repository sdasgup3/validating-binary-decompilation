...
block_.L_40fdbf:                                  ; preds = %block_.L_40fe61, %entry
  %68 = phi i64 [ %.pre, %entry ], [ %445, %block_.L_40fe61 ]
...
block_.L_40fe31:                                  ; preds = %block_.L_40fe31, %block_40fe2c
  %277 = phi i64 [ %276, %block_40fe2c ], [ %400, %block_.L_40fe31 ]
  %278 = phi i64 [ %239, %block_40fe2c ], [ %365, %block_.L_40fe31 ]
  ...
  br i1 %389, label %block_40fe5c, label %block_.L_40fe31
...
block_.L_40fe61:                                  ; preds = %block_.L_40fe20, %block_40fe5c
  %402 = phi i64 [ %275, %block_.L_40fe20 ], [ %401, %block_40fe5c ]
  %403 = phi i64 [ %239, %block_.L_40fe20 ], [ %365, %block_40fe5c ]
  ...
  %call2_40fe64 = tail call %struct.Memory* @sub_40c100._Z9check_sumIiEvT_(%struct.State* %0, i64 %409, %struct.Memory* %MEMORY.4)
...
block_.L_40fe77:                                  ; preds = %block_.L_40fdbf
  ...
  %call2_40fe77 = tail call %struct.Memory* @sub_400df0._Z5timerv(%struct.State* %0, i64 %446, %struct.Memory* %MEMORY.0)
  ...
  %call2_40fe80 = tail call %struct.Memory* @sub_400790._Z13record_resultdPKc(%struct.State* %0, i64 %457, %struct.Memory* %call2_40fe77)
