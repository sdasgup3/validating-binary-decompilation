...
block_.L_405172:                                  ; preds = %block_.L_405172, %block_40516d
  %157 = phi i64 [ %243, %block_.L_405172 ], [ %156, %block_40516d ]
  %158 = phi i64 [ %204, %block_.L_405172 ], [ %118, %block_40516d ]
  %159 = add i64 %158, -40
  ...
  %call2_40517d = tail call %struct.Memory* @sub_4017a0._ZN15loop_inner_bodyILi27EdE7do_workERdPKdi(%struct.State* nonnull %0, i64 %169, %struct.Memory* %MEMORY.0)
...
block_.L_4051a1:                                  ; preds = %block_40519c, %block_40514f
  %245 = phi i64 [ %244, %block_40519c ], [ %155, %block_40514f ]
  %246 = phi i64 [ %204, %block_40519c ], [ %118, %block_40514f ]
  %247 = add i64 %246, -44
  %248 = add i64 %245, 3
...
block_.L_4051b2:                                  ; preds = %block_.L_4051b2, %block_4051ad
  %284 = phi i64 [ %380, %block_.L_4051b2 ], [ %283, %block_4051ad ]
  %285 = phi i64 [ %345, %block_.L_4051b2 ], [ %246, %block_4051ad ]
  %286 = add i64 %285, -8
  %287 = add i64 %284, 4
  ...
  %call2_4051bf = tail call %struct.Memory* @sub_4014b0._Z18complete_hash_funcIdET_S0_(%struct.State* nonnull %0, i64 %300, %struct.Memory* %MEMORY.0)
...
block_.L_4051e8:                                  ; preds = %block_.L_4051a1, %block_4051e3
  ...
  %call2_4051ed = tail call %struct.Memory* @sub_4014e0._Z9check_sumIdEvT_(%struct.State* nonnull %0, i64 %388, %struct.Memory* %MEMORY.0)
