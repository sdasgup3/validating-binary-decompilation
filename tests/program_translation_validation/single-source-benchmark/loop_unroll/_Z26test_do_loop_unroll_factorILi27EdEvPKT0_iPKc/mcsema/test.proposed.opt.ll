...
entry:
  ...
  %call2_405103 = tail call %struct.Memory* @sub_400dd0._Z11start_timerv(%struct.State* %0, i64 %58, %struct.Memory* %2)
...
block_.L_40510f:                                  ; preds = %block_.L_4051b8, %entry
  %79 = phi i64 [ %.pre, %entry ], [ %429, %block_.L_4051b8 ]
  %MEMORY.0 = phi %struct.Memory* [ %call2_405103, %entry ], [ %call2_4051bd, %block_.L_4051b8 ]
  ...
  br i1 %112, label %block_40511f, label %block_.L_4051d0

block_40511f:                                     ; preds = %block_.L_40510f
  ...
  br i1 %160, label %block_.L_405171, label %block_40513d

block_40513d:                                     ; preds = %block_40511f
  %162 = add i64 %161, 5
  store i64 %162, i64* %3, align 8
  br label %block_.L_405142

block_.L_405142:                                  ; preds = %block_.L_405142, %block_40513d
  %163 = phi i64 [ %162, %block_40513d ], [ %249, %block_.L_405142 ]
  %164 = phi i64 [ %124, %block_40513d ], [ %210, %block_.L_405142 ]
  %MEMORY.1 = phi %struct.Memory* [ %MEMORY.0, %block_40513d ], [ %call2_40514d, %block_.L_405142 ]
  %165 = add i64 %164, -40
  ...
  %call2_40514d = tail call %struct.Memory* @sub_401770._ZN15loop_inner_bodyILi27EdE7do_workERdPKdi(%struct.State* %0, i64 %175, %struct.Memory* %MEMORY.1)
  ...
  br i1 %248, label %block_.L_405142, label %block_40516c

block_40516c:                                     ; preds = %block_.L_405142
  %250 = add i64 %249, 5
  store i64 %250, i64* %3, align 8
  br label %block_.L_405171

block_.L_405171:                                  ; preds = %block_40516c, %block_40511f
  %251 = phi i64 [ %161, %block_40511f ], [ %250, %block_40516c ]
  %252 = phi i64 [ %124, %block_40511f ], [ %210, %block_40516c ]
  %MEMORY.2 = phi %struct.Memory* [ %MEMORY.0, %block_40511f ], [ %call2_40514d, %block_40516c ]
  %253 = add i64 %252, -44
  %254 = add i64 %251, 3
  ...
  br i1 %287, label %block_40517d, label %block_.L_4051b8

block_40517d:                                     ; preds = %block_.L_405171
  %289 = add i64 %288, 5
  store i64 %289, i64* %3, align 8
  br label %block_.L_405182

block_.L_405182:                                  ; preds = %block_.L_405182, %block_40517d
  %290 = phi i64 [ %289, %block_40517d ], [ %385, %block_.L_405182 ]
  %291 = phi i64 [ %252, %block_40517d ], [ %350, %block_.L_405182 ]
  %MEMORY.3 = phi %struct.Memory* [ %MEMORY.2, %block_40517d ], [ %call2_40518f, %block_.L_405182 ]
  %292 = add i64 %291, -8
  %293 = add i64 %290, 4
  ...
  %call2_40518f = tail call %struct.Memory* @sub_401480._Z18complete_hash_funcIdET_S0_(%struct.State* %0, i64 %306, %struct.Memory* %MEMORY.3)
  ...
  br i1 %374, label %block_4051b3, label %block_.L_405182

block_4051b3:                                     ; preds = %block_.L_405182
  %386 = add i64 %385, 5
  store i64 %386, i64* %3, align 8
  br label %block_.L_4051b8

block_.L_4051b8:                                  ; preds = %block_.L_405171, %block_4051b3
  %387 = phi i64 [ %288, %block_.L_405171 ], [ %386, %block_4051b3 ]
  %388 = phi i64 [ %252, %block_.L_405171 ], [ %350, %block_4051b3 ]
  %MEMORY.4 = phi %struct.Memory* [ %MEMORY.2, %block_.L_405171 ], [ %call2_40518f, %block_4051b3 ]
  %389 = add i64 %388, -40
  %390 = add i64 %387, 5
  ...
  %call2_4051bd = tail call %struct.Memory* @sub_4014b0._Z9check_sumIdEvT_(%struct.State* %0, i64 %393, %struct.Memory* %MEMORY.4)
...
block_.L_4051d0:                                  ; preds = %block_.L_40510f
  %430 = add i64 %113, -17376
  %431 = add i64 %113, 5
  ...
  %call2_4051d0 = tail call %struct.Memory* @sub_400df0._Z5timerv(%struct.State* %0, i64 %430, %struct.Memory* %MEMORY.0)
  ...
  %call2_4051d9 = tail call %struct.Memory* @sub_400790._Z13record_resultdPKc(%struct.State* %0, i64 %441, %struct.Memory* %call2_4051d0)
  ...
  ret %struct.Memory* %call2_4051d9
}
...
define %struct.Memory* @routine_jge_.L_4051d0(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i8* %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
...
define %struct.Memory* @routine_jl_.L_405171(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i8* %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 2, i32 9
...
define %struct.Memory* @routine_jl_.L_405142(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i8* %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 2, i32 9
...
define %struct.Memory* @routine_jge_.L_4051b8(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i8* %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 2, i32 9
...
define %struct.Memory* @routine_jmpq_.L_405182(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
...
define %struct.Memory* @routine_jne_.L_405182(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i8* %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
...
define %struct.Memory* @routine_jmpq_.L_4051b8(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
...
define %struct.Memory* @routine_jmpq_.L_40510f(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
