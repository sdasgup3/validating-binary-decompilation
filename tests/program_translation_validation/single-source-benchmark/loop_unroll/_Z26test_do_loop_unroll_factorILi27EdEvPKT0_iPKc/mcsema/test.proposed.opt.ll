...
define %struct.Memory* @_Z26test_do_loop_unroll_factorILi27EdEvPKT0_iPKc(%struct.State* noalias, i64, %struct.Memory* noalias) local_unnamed_addr #1 {
entry:
  ...
  %call2_405133 = tail call %struct.Memory* @sub_400e00._Z11start_timerv(%struct.State* %0, i64 %58, %struct.Memory* %2)
...
block_.L_40513f:                                  ; preds = %block_.L_4051e8, %entry
  %74 = phi i64 [ %.pre, %entry ], [ %424, %block_.L_4051e8 ]
  %MEMORY.0 = phi %struct.Memory* [ %call2_405133, %entry ], [ %call2_4051ed, %block_.L_4051e8 ]
  ...
  br i1 %107, label %block_40514f, label %block_.L_405200
...
block_40514f:                                     ; preds = %block_.L_40513f
  ...
  br i1 %154, label %block_.L_4051a1, label %block_40516d

block_40516d:                                     ; preds = %block_40514f
  %156 = add i64 %155, 5
  store i64 %156, i64* %3, align 8
  br label %block_.L_405172

block_.L_405172:                                  ; preds = %block_.L_405172, %block_40516d
  %157 = phi i64 [ %156, %block_40516d ], [ %243, %block_.L_405172 ]
  %158 = phi i64 [ %118, %block_40516d ], [ %204, %block_.L_405172 ]
  %MEMORY.1 = phi %struct.Memory* [ %MEMORY.0, %block_40516d ], [ %call2_40517d, %block_.L_405172 ]
  %159 = add i64 %158, -40
  ...
  %call2_40517d = tail call %struct.Memory* @sub_4017a0._ZN15loop_inner_bodyILi27EdE7do_workERdPKdi(%struct.State* nonnull %0, i64 %169, %struct.Memory* %MEMORY.1)
  ...
  br i1 %242, label %block_.L_405172, label %block_40519c

block_40519c:                                     ; preds = %block_.L_405172
  %244 = add i64 %243, 5
  store i64 %244, i64* %3, align 8
  br label %block_.L_4051a1

block_.L_4051a1:                                  ; preds = %block_40519c, %block_40514f
  %245 = phi i64 [ %155, %block_40514f ], [ %244, %block_40519c ]
  %246 = phi i64 [ %118, %block_40514f ], [ %204, %block_40519c ]
  %MEMORY.2 = phi %struct.Memory* [ %MEMORY.0, %block_40514f ], [ %call2_40517d, %block_40519c ]
  %247 = add i64 %246, -44
  %248 = add i64 %245, 3
  ...
  br i1 %281, label %block_4051ad, label %block_.L_4051e8

block_4051ad:                                     ; preds = %block_.L_4051a1
  %283 = add i64 %282, 5
  store i64 %283, i64* %3, align 8
  br label %block_.L_4051b2

block_.L_4051b2:                                  ; preds = %block_.L_4051b2, %block_4051ad
  %284 = phi i64 [ %283, %block_4051ad ], [ %380, %block_.L_4051b2 ]
  %285 = phi i64 [ %246, %block_4051ad ], [ %345, %block_.L_4051b2 ]
  %MEMORY.3 = phi %struct.Memory* [ %MEMORY.2, %block_4051ad ], [ %call2_4051bf, %block_.L_4051b2 ]
  %286 = add i64 %285, -8
  %287 = add i64 %284, 4
  ...
  %call2_4051bf = tail call %struct.Memory* @sub_4014b0._Z18complete_hash_funcIdET_S0_(%struct.State* nonnull %0, i64 %300, %struct.Memory* %MEMORY.3)
  ...
  br i1 %369, label %block_4051e3, label %block_.L_4051b2

block_4051e3:                                     ; preds = %block_.L_4051b2
  %381 = add i64 %380, 5
  store i64 %381, i64* %3, align 8
  br label %block_.L_4051e8

block_.L_4051e8:                                  ; preds = %block_.L_4051a1, %block_4051e3
  %382 = phi i64 [ %282, %block_.L_4051a1 ], [ %381, %block_4051e3 ]
  %383 = phi i64 [ %246, %block_.L_4051a1 ], [ %345, %block_4051e3 ]
  %MEMORY.4 = phi %struct.Memory* [ %MEMORY.2, %block_.L_4051a1 ], [ %call2_4051bf, %block_4051e3 ]
  %384 = add i64 %383, -40
  %385 = add i64 %382, 5
  ...
  %call2_4051ed = tail call %struct.Memory* @sub_4014e0._Z9check_sumIdEvT_(%struct.State* nonnull %0, i64 %388, %struct.Memory* %MEMORY.4)
...
block_.L_405200:                                  ; preds = %block_.L_40513f
  %425 = add i64 %108, -17376
  %426 = add i64 %108, 5
  ...
  %call2_405200 = tail call %struct.Memory* @sub_400e20._Z5timerv(%struct.State* nonnull %0, i64 %425, %struct.Memory* %MEMORY.0)
  ...
  %call2_405209 = tail call %struct.Memory* @sub_4007c0._Z13record_resultdPKc(%struct.State* nonnull %0, i64 %436, %struct.Memory* %call2_405200)
  ...
  ret %struct.Memory* %call2_405209
}
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_jge_.L_405200(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i8* nocapture %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_jl_.L_4051a1(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i8* nocapture %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 2, i32 9
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_jmpq_.L_405172(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_jl_.L_405172(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i8* nocapture %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 2, i32 9
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_jmpq_.L_4051a1(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_jge_.L_4051e8(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i8* nocapture %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 2, i32 9
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_jmpq_.L_4051b2(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_jne_.L_4051b2(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i8* nocapture %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_jmpq_.L_4051e8(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_jmpq_.L_40513f(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
