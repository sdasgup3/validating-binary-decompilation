...
block_.L_40fc7f:                                  ; preds = %block_.L_40fd21, %entry
  %68 = phi i64 [ %.pre, %entry ], [ %447, %block_.L_40fd21 ]
...
block_.L_40fcf1:                                  ; preds = %block_.L_40fcf1, %block_40fcec
  %277 = phi i64 [ %276, %block_40fcec ], [ %401, %block_.L_40fcf1 ]
  %278 = phi i64 [ %239, %block_40fcec ], [ %366, %block_.L_40fcf1 ]
  ...
  br i1 %390, label %block_40fd1c, label %block_.L_40fcf1
...
block_.L_40fd21:                                  ; preds = %block_.L_40fce0, %block_40fd1c
  %403 = phi i64 [ %275, %block_.L_40fce0 ], [ %402, %block_40fd1c ]
  %404 = phi i64 [ %239, %block_.L_40fce0 ], [ %366, %block_40fd1c ]
  ...
  %call2_40fd24 = tail call %struct.Memory* @sub_40c100._Z9check_sumIiEvT_(%struct.State* %0, i64 %410, %struct.Memory* %MEMORY.4)
...
block_.L_40fd37:                                  ; preds = %block_.L_40fc7f
  ...
  %call2_40fd37 = tail call %struct.Memory* @sub_400df0._Z5timerv(%struct.State* %0, i64 %448, %struct.Memory* %MEMORY.0)
  ...
  %call2_40fd40 = tail call %struct.Memory* @sub_400790._Z13record_resultdPKc(%struct.State* %0, i64 %459, %struct.Memory* %call2_40fd37)
