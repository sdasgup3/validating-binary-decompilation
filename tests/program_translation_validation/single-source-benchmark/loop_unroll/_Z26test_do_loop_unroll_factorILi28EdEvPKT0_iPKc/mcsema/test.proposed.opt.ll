...
block_.L_404fbf:                                  ; preds = %block_.L_405068, %entry
  %79 = phi i64 [ %.pre, %entry ], [ %429, %block_.L_405068 ]
...
block_.L_405032:                                  ; preds = %block_.L_405032, %block_40502d
  %290 = phi i64 [ %289, %block_40502d ], [ %385, %block_.L_405032 ]
  %291 = phi i64 [ %252, %block_40502d ], [ %350, %block_.L_405032 ]
  ...
  %call2_40503f = tail call %struct.Memory* @sub_401480._Z18complete_hash_funcIdET_S0_(%struct.State* %0, i64 %306, %struct.Memory* %MEMORY.3)
  ...
  br i1 %374, label %block_405063, label %block_.L_405032
...
block_.L_405068:                                  ; preds = %block_.L_405021, %block_405063
  %387 = phi i64 [ %288, %block_.L_405021 ], [ %386, %block_405063 ]
  %388 = phi i64 [ %252, %block_.L_405021 ], [ %350, %block_405063 ]
  ...
  %call2_40506d = tail call %struct.Memory* @sub_4014b0._Z9check_sumIdEvT_(%struct.State* %0, i64 %393, %struct.Memory* %MEMORY.4)
...
block_.L_405080:                                  ; preds = %block_.L_404fbf
  ...
  %call2_405080 = tail call %struct.Memory* @sub_400df0._Z5timerv(%struct.State* %0, i64 %430, %struct.Memory* %MEMORY.0)
  ...
  %call2_405089 = tail call %struct.Memory* @sub_400790._Z13record_resultdPKc(%struct.State* %0, i64 %441, %struct.Memory* %call2_405080)
