...
entry:
  ...
  %call2_404fb3 = tail call %struct.Memory* @sub_400dd0._Z11start_timerv(%struct.State* %0, i64 %58, %struct.Memory* %2)
...
block_.L_404fbf:                                  ; preds = %block_.L_405068, %entry
  %79 = phi i64 [ %.pre, %entry ], [ %433, %block_.L_405068 ]
  %MEMORY.0 = phi %struct.Memory* [ %call2_404fb3, %entry ], [ %call2_40506d, %block_.L_405068 ]
  ...
  br i1 %112, label %block_404fcf, label %block_.L_405080
...
block_404fcf:                                     ; preds = %block_.L_404fbf
  ...
  br i1 %160, label %block_.L_405021, label %block_404fed
...
block_.L_404ff2:                                  ; preds = %block_.L_404ff2, %block_404fed
  %163 = phi i64 [ %162, %block_404fed ], [ %249, %block_.L_404ff2 ]
  %164 = phi i64 [ %124, %block_404fed ], [ %210, %block_.L_404ff2 ]
  %MEMORY.1 = phi %struct.Memory* [ %MEMORY.0, %block_404fed ], [ %call2_404ffd, %block_.L_404ff2 ]
  %165 = add i64 %164, -40
  ...
  %call2_404ffd = tail call %struct.Memory* @sub_401710._ZN15loop_inner_bodyILi28EdE7do_workERdPKdi(%struct.State* %0, i64 %175, %struct.Memory* %MEMORY.1)
  ...
  br i1 %248, label %block_.L_404ff2, label %block_40501c
...
block_.L_405021:                                  ; preds = %block_40501c, %block_404fcf
  %251 = phi i64 [ %161, %block_404fcf ], [ %250, %block_40501c ]
  %252 = phi i64 [ %124, %block_404fcf ], [ %210, %block_40501c ]
  %MEMORY.2 = phi %struct.Memory* [ %MEMORY.0, %block_404fcf ], [ %call2_404ffd, %block_40501c ]
  %253 = add i64 %252, -44
  %254 = add i64 %251, 3
  ...
  br i1 %287, label %block_40502d, label %block_.L_405068
...
block_.L_405032:                                  ; preds = %block_.L_405032, %block_40502d
  %290 = phi i64 [ %289, %block_40502d ], [ %387, %block_.L_405032 ]
  %291 = phi i64 [ %252, %block_40502d ], [ %352, %block_.L_405032 ]
  %MEMORY.3 = phi %struct.Memory* [ %MEMORY.2, %block_40502d ], [ %call2_40503f, %block_.L_405032 ]
  %292 = add i64 %291, -8
  %293 = add i64 %290, 4
  ...
  %call2_40503f = tail call %struct.Memory* @sub_401480._Z18complete_hash_funcIdET_S0_(%struct.State* %0, i64 %307, %struct.Memory* %MEMORY.3)
  ...
  br i1 %376, label %block_405063, label %block_.L_405032
...
block_.L_405068:                                  ; preds = %block_.L_405021, %block_405063
  %389 = phi i64 [ %288, %block_.L_405021 ], [ %388, %block_405063 ]
  %390 = phi i64 [ %252, %block_.L_405021 ], [ %352, %block_405063 ]
  %MEMORY.4 = phi %struct.Memory* [ %MEMORY.2, %block_.L_405021 ], [ %call2_40503f, %block_405063 ]
  %391 = add i64 %390, -40
  %392 = add i64 %389, 5
  ...
  %call2_40506d = tail call %struct.Memory* @sub_4014b0._Z9check_sumIdEvT_(%struct.State* %0, i64 %396, %struct.Memory* %MEMORY.4)
...
block_.L_405080:                                  ; preds = %block_.L_404fbf
  ...
  %call2_405080 = tail call %struct.Memory* @sub_400df0._Z5timerv(%struct.State* %0, i64 %434, %struct.Memory* %MEMORY.0)
  ...
  %call2_405089 = tail call %struct.Memory* @sub_400790._Z13record_resultdPKc(%struct.State* %0, i64 %445, %struct.Memory* %call2_405080)
  ...
  ret %struct.Memory* %call2_405089
}
...
define %struct.Memory* @routine_jge_.L_405080(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i8* %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
...
define %struct.Memory* @routine_jl_.L_405021(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i8* %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 2, i32 9
...
define %struct.Memory* @routine_jmpq_.L_404ff2(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
...
define %struct.Memory* @routine_subl__0x1b___ecx(%struct.State* dereferenceable(3376), i64, %struct.Memory*) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %RCX = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 5, i32 0, i32 0
...
define %struct.Memory* @routine_jl_.L_404ff2(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i8* %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 2, i32 9
...
define %struct.Memory* @routine_jmpq_.L_405021(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
...
define %struct.Memory* @routine_jge_.L_405068(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i8* %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 2, i32 9
...
define %struct.Memory* @routine_jmpq_.L_405032(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
...
define %struct.Memory* @routine_jne_.L_405032(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i8* %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
...
define %struct.Memory* @routine_jmpq_.L_405068(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
...
define %struct.Memory* @routine_jmpq_.L_404fbf(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
