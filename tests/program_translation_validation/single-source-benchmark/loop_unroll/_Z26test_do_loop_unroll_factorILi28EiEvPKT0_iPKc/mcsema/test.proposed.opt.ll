...
block_.L_40fb3f:                                  ; preds = %block_.L_40fbe1, %entry
  %68 = phi i64 [ %.pre, %entry ], [ %445, %block_.L_40fbe1 ]
...
block_.L_40fbb1:                                  ; preds = %block_.L_40fbb1, %block_40fbac
  %277 = phi i64 [ %276, %block_40fbac ], [ %400, %block_.L_40fbb1 ]
  %278 = phi i64 [ %239, %block_40fbac ], [ %365, %block_.L_40fbb1 ]
  ...
  br i1 %389, label %block_40fbdc, label %block_.L_40fbb1
...
block_.L_40fbe1:                                  ; preds = %block_.L_40fba0, %block_40fbdc
  %402 = phi i64 [ %275, %block_.L_40fba0 ], [ %401, %block_40fbdc ]
  %403 = phi i64 [ %239, %block_.L_40fba0 ], [ %365, %block_40fbdc ]
  ...
  %call2_40fbe4 = tail call %struct.Memory* @sub_40c100._Z9check_sumIiEvT_(%struct.State* %0, i64 %409, %struct.Memory* %MEMORY.4)
...
block_.L_40fbf7:                                  ; preds = %block_.L_40fb3f
  ...
  %call2_40fbf7 = tail call %struct.Memory* @sub_400df0._Z5timerv(%struct.State* %0, i64 %446, %struct.Memory* %MEMORY.0)
  ...
  %call2_40fc00 = tail call %struct.Memory* @sub_400790._Z13record_resultdPKc(%struct.State* %0, i64 %457, %struct.Memory* %call2_40fbf7)
