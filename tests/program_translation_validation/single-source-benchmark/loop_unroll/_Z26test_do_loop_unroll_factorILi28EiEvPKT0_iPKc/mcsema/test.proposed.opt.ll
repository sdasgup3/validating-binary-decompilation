...
entry:
  ...
  %call2_40fb33 = tail call %struct.Memory* @sub_400dd0._Z11start_timerv(%struct.State* %0, i64 %58, %struct.Memory* %2)
...
block_.L_40fb3f:                                  ; preds = %block_.L_40fbe1, %entry
  %68 = phi i64 [ %.pre, %entry ], [ %447, %block_.L_40fbe1 ]
  %MEMORY.0 = phi %struct.Memory* [ %call2_40fb33, %entry ], [ %call2_40fbe4, %block_.L_40fbe1 ]
  ...
  br i1 %101, label %block_40fb4f, label %block_.L_40fbf7
...
block_40fb4f:                                     ; preds = %block_.L_40fb3f
  ...
  br i1 %147, label %block_.L_40fba0, label %block_40fb6c
...
block_.L_40fb71:                                  ; preds = %block_.L_40fb71, %block_40fb6c
  %150 = phi i64 [ %149, %block_40fb6c ], [ %236, %block_.L_40fb71 ]
  %151 = phi i64 [ %111, %block_40fb6c ], [ %197, %block_.L_40fb71 ]
  %MEMORY.1 = phi %struct.Memory* [ %MEMORY.0, %block_40fb6c ], [ %call2_40fb7c, %block_.L_40fb71 ]
  %152 = add i64 %151, -32
  ...
  %call2_40fb7c = tail call %struct.Memory* @sub_40c2d0._ZN15loop_inner_bodyILi28EiE7do_workERiPKii(%struct.State* %0, i64 %162, %struct.Memory* %MEMORY.1)
  ...
  br i1 %235, label %block_.L_40fb71, label %block_40fb9b
...
block_.L_40fba0:                                  ; preds = %block_40fb9b, %block_40fb4f
  %238 = phi i64 [ %148, %block_40fb4f ], [ %237, %block_40fb9b ]
  %239 = phi i64 [ %111, %block_40fb4f ], [ %197, %block_40fb9b ]
  %MEMORY.2 = phi %struct.Memory* [ %MEMORY.0, %block_40fb4f ], [ %call2_40fb7c, %block_40fb9b ]
  %240 = add i64 %239, -36
  %241 = add i64 %238, 3
  ...
  br i1 %274, label %block_40fbac, label %block_.L_40fbe1
...
block_.L_40fbb1:                                  ; preds = %block_.L_40fbb1, %block_40fbac
  %277 = phi i64 [ %276, %block_40fbac ], [ %401, %block_.L_40fbb1 ]
  %278 = phi i64 [ %239, %block_40fbac ], [ %366, %block_.L_40fbb1 ]
  %MEMORY.3 = phi %struct.Memory* [ %MEMORY.2, %block_40fbac ], [ %call2_40fbbc, %block_.L_40fbb1 ]
  %279 = add i64 %278, -8
  %280 = add i64 %277, 4
  ...
  %call2_40fbbc = tail call %struct.Memory* @sub_40c0d0._Z18complete_hash_funcIiET_S0_(%struct.State* %0, i64 %294, %struct.Memory* %MEMORY.3)
  ...
  br i1 %390, label %block_40fbdc, label %block_.L_40fbb1
...
block_.L_40fbe1:                                  ; preds = %block_.L_40fba0, %block_40fbdc
  %403 = phi i64 [ %275, %block_.L_40fba0 ], [ %402, %block_40fbdc ]
  %404 = phi i64 [ %239, %block_.L_40fba0 ], [ %366, %block_40fbdc ]
  %MEMORY.4 = phi %struct.Memory* [ %MEMORY.2, %block_.L_40fba0 ], [ %call2_40fbbc, %block_40fbdc ]
  %405 = add i64 %404, -32
  %406 = add i64 %403, 3
  ...
  %call2_40fbe4 = tail call %struct.Memory* @sub_40c100._Z9check_sumIiEvT_(%struct.State* %0, i64 %410, %struct.Memory* %MEMORY.4)
...
block_.L_40fbf7:                                  ; preds = %block_.L_40fb3f
  ...
  %call2_40fbf7 = tail call %struct.Memory* @sub_400df0._Z5timerv(%struct.State* %0, i64 %448, %struct.Memory* %MEMORY.0)
  ...
  %call2_40fc00 = tail call %struct.Memory* @sub_400790._Z13record_resultdPKc(%struct.State* %0, i64 %459, %struct.Memory* %call2_40fbf7)
  ...
  ret %struct.Memory* %call2_40fc00
}
...
define %struct.Memory* @routine_jge_.L_40fbf7(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i8* %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
...
define %struct.Memory* @routine_jl_.L_40fba0(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i8* %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 2, i32 9
...
define %struct.Memory* @routine_jmpq_.L_40fb71(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
...
define %struct.Memory* @routine_jl_.L_40fb71(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i8* %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 2, i32 9
...
define %struct.Memory* @routine_jmpq_.L_40fba0(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
...
define %struct.Memory* @routine_jge_.L_40fbe1(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i8* %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 2, i32 9
...
define %struct.Memory* @routine_jmpq_.L_40fbb1(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
...
define %struct.Memory* @routine_jne_.L_40fbb1(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i8* %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
...
define %struct.Memory* @routine_jmpq_.L_40fbe1(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
...
define %struct.Memory* @routine_jmpq_.L_40fb3f(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
