...
block_.L_404ed2:                                  ; preds = %block_.L_404ed2, %block_404ecd
  %157 = phi i64 [ %243, %block_.L_404ed2 ], [ %156, %block_404ecd ]
  %158 = phi i64 [ %204, %block_.L_404ed2 ], [ %118, %block_404ecd ]
  %159 = add i64 %158, -40
  ...
  %call2_404edd = tail call %struct.Memory* @sub_4016e0._ZN15loop_inner_bodyILi29EdE7do_workERdPKdi(%struct.State* nonnull %0, i64 %169, %struct.Memory* %MEMORY.0)
...
block_.L_404f01:                                  ; preds = %block_404efc, %block_404eaf
  %245 = phi i64 [ %244, %block_404efc ], [ %155, %block_404eaf ]
  %246 = phi i64 [ %204, %block_404efc ], [ %118, %block_404eaf ]
  %247 = add i64 %246, -44
  %248 = add i64 %245, 3
...
block_.L_404f12:                                  ; preds = %block_.L_404f12, %block_404f0d
  %284 = phi i64 [ %380, %block_.L_404f12 ], [ %283, %block_404f0d ]
  %285 = phi i64 [ %345, %block_.L_404f12 ], [ %246, %block_404f0d ]
  %286 = add i64 %285, -8
  %287 = add i64 %284, 4
  ...
  %call2_404f1f = tail call %struct.Memory* @sub_4014b0._Z18complete_hash_funcIdET_S0_(%struct.State* nonnull %0, i64 %300, %struct.Memory* %MEMORY.0)
...
block_.L_404f48:                                  ; preds = %block_.L_404f01, %block_404f43
  ...
  %call2_404f4d = tail call %struct.Memory* @sub_4014e0._Z9check_sumIdEvT_(%struct.State* nonnull %0, i64 %388, %struct.Memory* %MEMORY.0)
