...
block_.L_40f9ff:                                  ; preds = %block_.L_40faa1, %entry
  %68 = phi i64 [ %.pre, %entry ], [ %447, %block_.L_40faa1 ]
...
block_.L_40fa71:                                  ; preds = %block_.L_40fa71, %block_40fa6c
  %277 = phi i64 [ %276, %block_40fa6c ], [ %401, %block_.L_40fa71 ]
  %278 = phi i64 [ %239, %block_40fa6c ], [ %366, %block_.L_40fa71 ]
  ...
  br i1 %390, label %block_40fa9c, label %block_.L_40fa71
...
block_.L_40faa1:                                  ; preds = %block_.L_40fa60, %block_40fa9c
  %403 = phi i64 [ %275, %block_.L_40fa60 ], [ %402, %block_40fa9c ]
  %404 = phi i64 [ %239, %block_.L_40fa60 ], [ %366, %block_40fa9c ]
  ...
  %call2_40faa4 = tail call %struct.Memory* @sub_40c100._Z9check_sumIiEvT_(%struct.State* %0, i64 %410, %struct.Memory* %MEMORY.4)
...
block_.L_40fab7:                                  ; preds = %block_.L_40f9ff
  ...
  %call2_40fab7 = tail call %struct.Memory* @sub_400df0._Z5timerv(%struct.State* %0, i64 %448, %struct.Memory* %MEMORY.0)
  ...
  %call2_40fac0 = tail call %struct.Memory* @sub_400790._Z13record_resultdPKc(%struct.State* %0, i64 %459, %struct.Memory* %call2_40fab7)
