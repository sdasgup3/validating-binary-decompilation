...
declare %struct.Memory* @sub_402110._ZN15loop_inner_bodyILi2EdE7do_workERdPKdi(%struct.State* noalias dereferenceable(3376), i64, %struct.Memory* noalias readnone returned) local_unnamed_addr
...
entry:
  ...
  %call2_407203 = tail call %struct.Memory* @sub_400e10._Z11start_timerv(%struct.State* %0, i64 %58, %struct.Memory* %2)
...
block_.L_40720f:                                  ; preds = %block_.L_4072b8, %entry
  %74 = phi i64 [ %.pre, %entry ], [ %422, %block_.L_4072b8 ]
  %MEMORY.0 = phi %struct.Memory* [ %call2_407203, %entry ], [ %call2_4072bd, %block_.L_4072b8 ]
  ...
  br i1 %107, label %block_40721f, label %block_.L_4072d0
...
block_40721f:                                     ; preds = %block_.L_40720f
  ...
  br i1 %153, label %block_.L_407271, label %block_40723d

block_40723d:                                     ; preds = %block_40721f
  %155 = add i64 %154, 5
  store i64 %155, i64* %3, align 8
  br label %block_.L_407242

block_.L_407242:                                  ; preds = %block_.L_407242, %block_40723d
  %156 = phi i64 [ %241, %block_.L_407242 ], [ %155, %block_40723d ]
  %157 = phi i64 [ %202, %block_.L_407242 ], [ %118, %block_40723d ]
  %158 = add i64 %157, -40
  ...
  %call2_40724d = tail call %struct.Memory* @sub_402110._ZN15loop_inner_bodyILi2EdE7do_workERdPKdi(%struct.State* nonnull %0, i64 %168, %struct.Memory* %MEMORY.0)
  ...
  br i1 %240, label %block_.L_407242, label %block_40726c

block_40726c:                                     ; preds = %block_.L_407242
  %242 = add i64 %241, 5
  store i64 %242, i64* %3, align 8
  br label %block_.L_407271

block_.L_407271:                                  ; preds = %block_40726c, %block_40721f
  %243 = phi i64 [ %242, %block_40726c ], [ %154, %block_40721f ]
  %244 = phi i64 [ %202, %block_40726c ], [ %118, %block_40721f ]
  %245 = add i64 %244, -44
  %246 = add i64 %243, 3
  ...
  br i1 %279, label %block_40727d, label %block_.L_4072b8

block_40727d:                                     ; preds = %block_.L_407271
  %281 = add i64 %280, 5
  store i64 %281, i64* %3, align 8
  br label %block_.L_407282

block_.L_407282:                                  ; preds = %block_.L_407282, %block_40727d
  %282 = phi i64 [ %378, %block_.L_407282 ], [ %281, %block_40727d ]
  %283 = phi i64 [ %343, %block_.L_407282 ], [ %244, %block_40727d ]
  %284 = add i64 %283, -8
  %285 = add i64 %282, 4
  ...
  %call2_40728f = tail call %struct.Memory* @sub_4014c0._Z18complete_hash_funcIdET_S0_(%struct.State* nonnull %0, i64 %298, %struct.Memory* %MEMORY.0)
  ...
  br i1 %367, label %block_4072b3, label %block_.L_407282

block_4072b3:                                     ; preds = %block_.L_407282
  %379 = add i64 %378, 5
  store i64 %379, i64* %3, align 8
  br label %block_.L_4072b8

block_.L_4072b8:                                  ; preds = %block_.L_407271, %block_4072b3
  %380 = phi i64 [ %280, %block_.L_407271 ], [ %379, %block_4072b3 ]
  %381 = phi i64 [ %244, %block_.L_407271 ], [ %343, %block_4072b3 ]
  %382 = add i64 %381, -40
  %383 = add i64 %380, 5
  ...
  %call2_4072bd = tail call %struct.Memory* @sub_4014f0._Z9check_sumIdEvT_(%struct.State* nonnull %0, i64 %386, %struct.Memory* %MEMORY.0)
...
block_.L_4072d0:                                  ; preds = %block_.L_40720f
  ...
  %call2_4072d0 = tail call %struct.Memory* @sub_400e30._Z5timerv(%struct.State* nonnull %0, i64 %423, %struct.Memory* %MEMORY.0)
  ...
  %call2_4072d9 = tail call %struct.Memory* @sub_4007d0._Z13record_resultdPKc(%struct.State* nonnull %0, i64 %434, %struct.Memory* %call2_4072d0)
