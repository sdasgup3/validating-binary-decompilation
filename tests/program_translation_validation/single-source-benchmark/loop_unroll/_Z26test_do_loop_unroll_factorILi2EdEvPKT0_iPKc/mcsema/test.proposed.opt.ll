...
block_.L_4071cf:                                  ; preds = %block_.L_407278, %entry
  %79 = phi i64 [ %.pre, %entry ], [ %427, %block_.L_407278 ]
...
block_.L_407242:                                  ; preds = %block_.L_407242, %block_40723d
  %288 = phi i64 [ %287, %block_40723d ], [ %383, %block_.L_407242 ]
  %289 = phi i64 [ %250, %block_40723d ], [ %348, %block_.L_407242 ]
  ...
  %call2_40724f = tail call %struct.Memory* @sub_401480._Z18complete_hash_funcIdET_S0_(%struct.State* %0, i64 %304, %struct.Memory* %MEMORY.3)
  ...
  br i1 %372, label %block_407273, label %block_.L_407242
...
block_.L_407278:                                  ; preds = %block_.L_407231, %block_407273
  %385 = phi i64 [ %286, %block_.L_407231 ], [ %384, %block_407273 ]
  %386 = phi i64 [ %250, %block_.L_407231 ], [ %348, %block_407273 ]
  ...
  %call2_40727d = tail call %struct.Memory* @sub_4014b0._Z9check_sumIdEvT_(%struct.State* %0, i64 %391, %struct.Memory* %MEMORY.4)
...
block_.L_407290:                                  ; preds = %block_.L_4071cf
  ...
  %call2_407290 = tail call %struct.Memory* @sub_400df0._Z5timerv(%struct.State* %0, i64 %428, %struct.Memory* %MEMORY.0)
  ...
  %call2_407299 = tail call %struct.Memory* @sub_400790._Z13record_resultdPKc(%struct.State* %0, i64 %439, %struct.Memory* %call2_407290)
