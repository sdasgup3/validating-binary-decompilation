...
block_.L_411baf:                                  ; preds = %block_.L_411c51, %entry
  %68 = phi i64 [ %.pre, %entry ], [ %443, %block_.L_411c51 ]
...
block_.L_411c21:                                  ; preds = %block_.L_411c21, %block_411c1c
  %275 = phi i64 [ %274, %block_411c1c ], [ %398, %block_.L_411c21 ]
  %276 = phi i64 [ %237, %block_411c1c ], [ %363, %block_.L_411c21 ]
  ...
  br i1 %387, label %block_411c4c, label %block_.L_411c21
...
block_.L_411c51:                                  ; preds = %block_.L_411c10, %block_411c4c
  %400 = phi i64 [ %273, %block_.L_411c10 ], [ %399, %block_411c4c ]
  %401 = phi i64 [ %237, %block_.L_411c10 ], [ %363, %block_411c4c ]
  ...
  %call2_411c54 = tail call %struct.Memory* @sub_40c100._Z9check_sumIiEvT_(%struct.State* %0, i64 %407, %struct.Memory* %MEMORY.4)
...
block_.L_411c67:                                  ; preds = %block_.L_411baf
  ...
  %call2_411c67 = tail call %struct.Memory* @sub_400df0._Z5timerv(%struct.State* %0, i64 %444, %struct.Memory* %MEMORY.0)
  ...
  %call2_411c70 = tail call %struct.Memory* @sub_400790._Z13record_resultdPKc(%struct.State* %0, i64 %455, %struct.Memory* %call2_411c67)
