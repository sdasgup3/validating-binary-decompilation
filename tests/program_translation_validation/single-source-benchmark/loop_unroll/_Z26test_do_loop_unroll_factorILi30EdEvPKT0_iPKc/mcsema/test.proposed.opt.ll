...
declare %struct.Memory* @sub_401680._ZN15loop_inner_bodyILi30EdE7do_workERdPKdi(%struct.State* noalias dereferenceable(3376), i64, %struct.Memory* noalias readnone returned) local_unnamed_addr
...
block_.L_404d82:                                  ; preds = %block_.L_404d82, %block_404d7d
  %157 = phi i64 [ %243, %block_.L_404d82 ], [ %156, %block_404d7d ]
  %158 = phi i64 [ %204, %block_.L_404d82 ], [ %118, %block_404d7d ]
  %159 = add i64 %158, -40
  ...
  %call2_404d8d = tail call %struct.Memory* @sub_401680._ZN15loop_inner_bodyILi30EdE7do_workERdPKdi(%struct.State* nonnull %0, i64 %169, %struct.Memory* %MEMORY.0)
...
block_.L_404db1:                                  ; preds = %block_404dac, %block_404d5f
  %245 = phi i64 [ %244, %block_404dac ], [ %155, %block_404d5f ]
  %246 = phi i64 [ %204, %block_404dac ], [ %118, %block_404d5f ]
  %247 = add i64 %246, -44
  %248 = add i64 %245, 3
...
block_.L_404dc2:                                  ; preds = %block_.L_404dc2, %block_404dbd
  %284 = phi i64 [ %380, %block_.L_404dc2 ], [ %283, %block_404dbd ]
  %285 = phi i64 [ %345, %block_.L_404dc2 ], [ %246, %block_404dbd ]
  %286 = add i64 %285, -8
  %287 = add i64 %284, 4
  ...
  %call2_404dcf = tail call %struct.Memory* @sub_4014b0._Z18complete_hash_funcIdET_S0_(%struct.State* nonnull %0, i64 %300, %struct.Memory* %MEMORY.0)
...
block_.L_404df8:                                  ; preds = %block_.L_404db1, %block_404df3
  ...
  %call2_404dfd = tail call %struct.Memory* @sub_4014e0._Z9check_sumIdEvT_(%struct.State* nonnull %0, i64 %388, %struct.Memory* %MEMORY.0)
