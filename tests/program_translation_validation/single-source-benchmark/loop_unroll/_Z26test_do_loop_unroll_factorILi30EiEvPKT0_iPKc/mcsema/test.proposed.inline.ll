...
define %struct.Memory* @_Z26test_do_loop_unroll_factorILi30EiEvPKT0_iPKc(%struct.State* noalias, i64, %struct.Memory* noalias) #1 {
entry:
  ...
  store %struct.Memory* %loadMem1_40f8e3, %struct.Memory** %MEMORY
...
block_.L_40f8ef:                                  ; preds = %block_.L_40f991, %entry
...
block_40f8ff:                                     ; preds = %block_.L_40f8ef
  ...
  store i32 0, i32* %236
  store %struct.Memory* %loadMem_40f906, %struct.Memory** %MEMORY
...
block_40f91c:                                     ; preds = %block_40f8ff
...
block_.L_40f921:                                  ; preds = %block_.L_40f921, %block_40f91c
  ...
  store %struct.Memory* %loadMem1_40f92c, %struct.Memory** %MEMORY
...
block_40f94b:                                     ; preds = %block_.L_40f921
  ...
  store %struct.Memory* %loadMem_40f94b, %struct.Memory** %MEMORY
  br label %block_.L_40f950

block_.L_40f950:                                  ; preds = %block_40f94b, %block_40f8ff
...
block_40f95c:                                     ; preds = %block_.L_40f950
...
block_.L_40f961:                                  ; preds = %block_.L_40f961, %block_40f95c
  ...
  store %struct.Memory* %loadMem_40f965, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem1_40f96c, %struct.Memory** %MEMORY
...
block_40f98c:                                     ; preds = %block_.L_40f961
...
block_.L_40f991:                                  ; preds = %block_40f98c, %block_.L_40f950
  ...
  store %struct.Memory* %loadMem_40f99f, %struct.Memory** %MEMORY
...
block_.L_40f9a7:                                  ; preds = %block_.L_40f8ef
  ...
  store %struct.Memory* %loadMem1_40f9a7, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem1_40f9b0, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_40f9b5, %struct.Memory** %MEMORY
  ...
  ret %struct.Memory* %loadMem_40f9ba
}
