...
block_.L_40f8bf:                                  ; preds = %block_.L_40f961, %entry
  %68 = phi i64 [ %.pre, %entry ], [ %445, %block_.L_40f961 ]
...
block_.L_40f931:                                  ; preds = %block_.L_40f931, %block_40f92c
  %277 = phi i64 [ %276, %block_40f92c ], [ %400, %block_.L_40f931 ]
  %278 = phi i64 [ %239, %block_40f92c ], [ %365, %block_.L_40f931 ]
  ...
  br i1 %389, label %block_40f95c, label %block_.L_40f931
...
block_.L_40f961:                                  ; preds = %block_.L_40f920, %block_40f95c
  %402 = phi i64 [ %275, %block_.L_40f920 ], [ %401, %block_40f95c ]
  %403 = phi i64 [ %239, %block_.L_40f920 ], [ %365, %block_40f95c ]
  ...
  %call2_40f964 = tail call %struct.Memory* @sub_40c100._Z9check_sumIiEvT_(%struct.State* %0, i64 %409, %struct.Memory* %MEMORY.4)
...
block_.L_40f977:                                  ; preds = %block_.L_40f8bf
  ...
  %call2_40f977 = tail call %struct.Memory* @sub_400df0._Z5timerv(%struct.State* %0, i64 %446, %struct.Memory* %MEMORY.0)
  ...
  %call2_40f980 = tail call %struct.Memory* @sub_400790._Z13record_resultdPKc(%struct.State* %0, i64 %457, %struct.Memory* %call2_40f977)
