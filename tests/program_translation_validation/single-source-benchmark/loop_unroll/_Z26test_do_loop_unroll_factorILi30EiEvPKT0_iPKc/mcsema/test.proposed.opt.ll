...
define %struct.Memory* @_Z26test_do_loop_unroll_factorILi30EiEvPKT0_iPKc(%struct.State* noalias, i64, %struct.Memory* noalias readnone) local_unnamed_addr #1 {
entry:
...
block_.L_40f921:                                  ; preds = %block_.L_40f921, %block_40f91c
  %150 = phi i64 [ %236, %block_.L_40f921 ], [ %149, %block_40f91c ]
  %151 = phi i64 [ %197, %block_.L_40f921 ], [ %111, %block_40f91c ]
  %152 = add i64 %151, -32
  ...
  %call2_40f92c = tail call %struct.Memory* @sub_40c240._ZN15loop_inner_bodyILi30EiE7do_workERiPKii(%struct.State* nonnull %0, i64 %162, %struct.Memory* %MEMORY.0)
...
block_.L_40f950:                                  ; preds = %block_40f94b, %block_40f8ff
  %238 = phi i64 [ %237, %block_40f94b ], [ %148, %block_40f8ff ]
  %239 = phi i64 [ %197, %block_40f94b ], [ %111, %block_40f8ff ]
  %240 = add i64 %239, -36
  %241 = add i64 %238, 3
...
block_.L_40f961:                                  ; preds = %block_.L_40f961, %block_40f95c
  %277 = phi i64 [ %400, %block_.L_40f961 ], [ %276, %block_40f95c ]
  %278 = phi i64 [ %365, %block_.L_40f961 ], [ %239, %block_40f95c ]
  %279 = add i64 %278, -8
  %280 = add i64 %277, 4
  ...
  %call2_40f96c = tail call %struct.Memory* @sub_40c100._Z18complete_hash_funcIiET_S0_(%struct.State* nonnull %0, i64 %294, %struct.Memory* %MEMORY.0)
...
block_.L_40f991:                                  ; preds = %block_.L_40f950, %block_40f98c
  ...
  %call2_40f994 = tail call %struct.Memory* @sub_40c130._Z9check_sumIiEvT_(%struct.State* nonnull %0, i64 %409, %struct.Memory* %MEMORY.0)
