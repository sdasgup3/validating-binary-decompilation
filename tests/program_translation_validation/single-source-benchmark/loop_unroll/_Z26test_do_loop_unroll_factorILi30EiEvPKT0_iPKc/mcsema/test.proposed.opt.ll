...
entry:
  ...
  %call2_40f8b3 = tail call %struct.Memory* @sub_400dd0._Z11start_timerv(%struct.State* %0, i64 %58, %struct.Memory* %2)
...
block_.L_40f8bf:                                  ; preds = %block_.L_40f961, %entry
  %68 = phi i64 [ %.pre, %entry ], [ %447, %block_.L_40f961 ]
  %MEMORY.0 = phi %struct.Memory* [ %call2_40f8b3, %entry ], [ %call2_40f964, %block_.L_40f961 ]
  ...
  br i1 %101, label %block_40f8cf, label %block_.L_40f977
...
block_40f8cf:                                     ; preds = %block_.L_40f8bf
  ...
  br i1 %147, label %block_.L_40f920, label %block_40f8ec
...
block_.L_40f8f1:                                  ; preds = %block_.L_40f8f1, %block_40f8ec
  %150 = phi i64 [ %149, %block_40f8ec ], [ %236, %block_.L_40f8f1 ]
  %151 = phi i64 [ %111, %block_40f8ec ], [ %197, %block_.L_40f8f1 ]
  %MEMORY.1 = phi %struct.Memory* [ %MEMORY.0, %block_40f8ec ], [ %call2_40f8fc, %block_.L_40f8f1 ]
  %152 = add i64 %151, -32
  ...
  %call2_40f8fc = tail call %struct.Memory* @sub_40c210._ZN15loop_inner_bodyILi30EiE7do_workERiPKii(%struct.State* %0, i64 %162, %struct.Memory* %MEMORY.1)
  ...
  br i1 %235, label %block_.L_40f8f1, label %block_40f91b
...
block_.L_40f920:                                  ; preds = %block_40f91b, %block_40f8cf
  %238 = phi i64 [ %148, %block_40f8cf ], [ %237, %block_40f91b ]
  %239 = phi i64 [ %111, %block_40f8cf ], [ %197, %block_40f91b ]
  %MEMORY.2 = phi %struct.Memory* [ %MEMORY.0, %block_40f8cf ], [ %call2_40f8fc, %block_40f91b ]
  %240 = add i64 %239, -36
  %241 = add i64 %238, 3
  ...
  br i1 %274, label %block_40f92c, label %block_.L_40f961
...
block_.L_40f931:                                  ; preds = %block_.L_40f931, %block_40f92c
  %277 = phi i64 [ %276, %block_40f92c ], [ %401, %block_.L_40f931 ]
  %278 = phi i64 [ %239, %block_40f92c ], [ %366, %block_.L_40f931 ]
  %MEMORY.3 = phi %struct.Memory* [ %MEMORY.2, %block_40f92c ], [ %call2_40f93c, %block_.L_40f931 ]
  %279 = add i64 %278, -8
  %280 = add i64 %277, 4
  ...
  %call2_40f93c = tail call %struct.Memory* @sub_40c0d0._Z18complete_hash_funcIiET_S0_(%struct.State* %0, i64 %294, %struct.Memory* %MEMORY.3)
  ...
  br i1 %390, label %block_40f95c, label %block_.L_40f931
...
block_.L_40f961:                                  ; preds = %block_.L_40f920, %block_40f95c
  %403 = phi i64 [ %275, %block_.L_40f920 ], [ %402, %block_40f95c ]
  %404 = phi i64 [ %239, %block_.L_40f920 ], [ %366, %block_40f95c ]
  %MEMORY.4 = phi %struct.Memory* [ %MEMORY.2, %block_.L_40f920 ], [ %call2_40f93c, %block_40f95c ]
  %405 = add i64 %404, -32
  %406 = add i64 %403, 3
  ...
  %call2_40f964 = tail call %struct.Memory* @sub_40c100._Z9check_sumIiEvT_(%struct.State* %0, i64 %410, %struct.Memory* %MEMORY.4)
...
block_.L_40f977:                                  ; preds = %block_.L_40f8bf
  ...
  %call2_40f977 = tail call %struct.Memory* @sub_400df0._Z5timerv(%struct.State* %0, i64 %448, %struct.Memory* %MEMORY.0)
  ...
  %call2_40f980 = tail call %struct.Memory* @sub_400790._Z13record_resultdPKc(%struct.State* %0, i64 %459, %struct.Memory* %call2_40f977)
  ...
  ret %struct.Memory* %call2_40f980
}
...
define %struct.Memory* @routine_jge_.L_40f977(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i8* %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
...
define %struct.Memory* @routine_jl_.L_40f920(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i8* %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 2, i32 9
...
define %struct.Memory* @routine_jmpq_.L_40f8f1(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
...
define %struct.Memory* @routine_jl_.L_40f8f1(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i8* %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 2, i32 9
...
define %struct.Memory* @routine_jmpq_.L_40f920(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
...
define %struct.Memory* @routine_jge_.L_40f961(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i8* %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 2, i32 9
...
define %struct.Memory* @routine_jmpq_.L_40f931(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
...
define %struct.Memory* @routine_jne_.L_40f931(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i8* %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
...
define %struct.Memory* @routine_jmpq_.L_40f961(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
...
define %struct.Memory* @routine_jmpq_.L_40f8bf(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
