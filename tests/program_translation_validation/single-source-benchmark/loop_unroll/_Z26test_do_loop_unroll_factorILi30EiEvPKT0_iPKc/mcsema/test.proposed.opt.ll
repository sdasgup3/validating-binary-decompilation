...
entry:
  ...
  %call2_40f8f3 = tail call %struct.Memory* @sub_400e10._Z11start_timerv(%struct.State* %0, i64 %58, %struct.Memory* %2)
...
block_.L_40f8ff:                                  ; preds = %block_.L_40f9a1, %entry
  %68 = phi i64 [ %.pre, %entry ], [ %445, %block_.L_40f9a1 ]
  %MEMORY.0 = phi %struct.Memory* [ %call2_40f8f3, %entry ], [ %call2_40f9a4, %block_.L_40f9a1 ]
  ...
  br i1 %101, label %block_40f90f, label %block_.L_40f9b7
...
block_40f90f:                                     ; preds = %block_.L_40f8ff
  ...
  br i1 %147, label %block_.L_40f960, label %block_40f92c
...
block_.L_40f931:                                  ; preds = %block_.L_40f931, %block_40f92c
  %150 = phi i64 [ %236, %block_.L_40f931 ], [ %149, %block_40f92c ]
  %151 = phi i64 [ %197, %block_.L_40f931 ], [ %111, %block_40f92c ]
  %152 = add i64 %151, -32
  ...
  %call2_40f93c = tail call %struct.Memory* @sub_40c250._ZN15loop_inner_bodyILi30EiE7do_workERiPKii(%struct.State* nonnull %0, i64 %162, %struct.Memory* %MEMORY.0)
  ...
  br i1 %235, label %block_.L_40f931, label %block_40f95b
...
block_.L_40f960:                                  ; preds = %block_40f95b, %block_40f90f
  %238 = phi i64 [ %237, %block_40f95b ], [ %148, %block_40f90f ]
  %239 = phi i64 [ %197, %block_40f95b ], [ %111, %block_40f90f ]
  %240 = add i64 %239, -36
  %241 = add i64 %238, 3
  ...
  br i1 %274, label %block_40f96c, label %block_.L_40f9a1
...
block_.L_40f971:                                  ; preds = %block_.L_40f971, %block_40f96c
  %277 = phi i64 [ %400, %block_.L_40f971 ], [ %276, %block_40f96c ]
  %278 = phi i64 [ %365, %block_.L_40f971 ], [ %239, %block_40f96c ]
  %279 = add i64 %278, -8
  %280 = add i64 %277, 4
  ...
  %call2_40f97c = tail call %struct.Memory* @sub_40c110._Z18complete_hash_funcIiET_S0_(%struct.State* nonnull %0, i64 %294, %struct.Memory* %MEMORY.0)
  ...
  br i1 %389, label %block_40f99c, label %block_.L_40f971
...
block_.L_40f9a1:                                  ; preds = %block_.L_40f960, %block_40f99c
  %402 = phi i64 [ %275, %block_.L_40f960 ], [ %401, %block_40f99c ]
  %403 = phi i64 [ %239, %block_.L_40f960 ], [ %365, %block_40f99c ]
  %404 = add i64 %403, -32
  %405 = add i64 %402, 3
  ...
  %call2_40f9a4 = tail call %struct.Memory* @sub_40c140._Z9check_sumIiEvT_(%struct.State* nonnull %0, i64 %409, %struct.Memory* %MEMORY.0)
...
block_.L_40f9b7:                                  ; preds = %block_.L_40f8ff
  ...
  %call2_40f9b7 = tail call %struct.Memory* @sub_400e30._Z5timerv(%struct.State* nonnull %0, i64 %446, %struct.Memory* %MEMORY.0)
  ...
  %call2_40f9c0 = tail call %struct.Memory* @sub_4007d0._Z13record_resultdPKc(%struct.State* nonnull %0, i64 %457, %struct.Memory* %call2_40f9b7)
