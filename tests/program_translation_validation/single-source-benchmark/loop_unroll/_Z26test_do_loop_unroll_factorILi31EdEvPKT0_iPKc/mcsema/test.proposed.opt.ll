...
block_.L_404bcf:                                  ; preds = %block_.L_404c78, %entry
  %79 = phi i64 [ %.pre, %entry ], [ %429, %block_.L_404c78 ]
...
block_.L_404c42:                                  ; preds = %block_.L_404c42, %block_404c3d
  %290 = phi i64 [ %289, %block_404c3d ], [ %385, %block_.L_404c42 ]
  %291 = phi i64 [ %252, %block_404c3d ], [ %350, %block_.L_404c42 ]
  ...
  %call2_404c4f = tail call %struct.Memory* @sub_401480._Z18complete_hash_funcIdET_S0_(%struct.State* %0, i64 %306, %struct.Memory* %MEMORY.3)
  ...
  br i1 %374, label %block_404c73, label %block_.L_404c42
...
block_.L_404c78:                                  ; preds = %block_.L_404c31, %block_404c73
  %387 = phi i64 [ %288, %block_.L_404c31 ], [ %386, %block_404c73 ]
  %388 = phi i64 [ %252, %block_.L_404c31 ], [ %350, %block_404c73 ]
  ...
  %call2_404c7d = tail call %struct.Memory* @sub_4014b0._Z9check_sumIdEvT_(%struct.State* %0, i64 %393, %struct.Memory* %MEMORY.4)
...
block_.L_404c90:                                  ; preds = %block_.L_404bcf
  ...
  %call2_404c90 = tail call %struct.Memory* @sub_400df0._Z5timerv(%struct.State* %0, i64 %430, %struct.Memory* %MEMORY.0)
  ...
  %call2_404c99 = tail call %struct.Memory* @sub_400790._Z13record_resultdPKc(%struct.State* %0, i64 %441, %struct.Memory* %call2_404c90)
