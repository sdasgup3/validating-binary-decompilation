...
block_.L_40f77f:                                  ; preds = %block_.L_40f821, %entry
  %68 = phi i64 [ %.pre, %entry ], [ %445, %block_.L_40f821 ]
...
block_.L_40f7f1:                                  ; preds = %block_.L_40f7f1, %block_40f7ec
  %277 = phi i64 [ %276, %block_40f7ec ], [ %400, %block_.L_40f7f1 ]
  %278 = phi i64 [ %239, %block_40f7ec ], [ %365, %block_.L_40f7f1 ]
  ...
  br i1 %389, label %block_40f81c, label %block_.L_40f7f1
...
block_.L_40f821:                                  ; preds = %block_.L_40f7e0, %block_40f81c
  %402 = phi i64 [ %275, %block_.L_40f7e0 ], [ %401, %block_40f81c ]
  %403 = phi i64 [ %239, %block_.L_40f7e0 ], [ %365, %block_40f81c ]
  ...
  %call2_40f824 = tail call %struct.Memory* @sub_40c100._Z9check_sumIiEvT_(%struct.State* %0, i64 %409, %struct.Memory* %MEMORY.4)
...
block_.L_40f837:                                  ; preds = %block_.L_40f77f
  ...
  %call2_40f837 = tail call %struct.Memory* @sub_400df0._Z5timerv(%struct.State* %0, i64 %446, %struct.Memory* %MEMORY.0)
  ...
  %call2_40f840 = tail call %struct.Memory* @sub_400790._Z13record_resultdPKc(%struct.State* %0, i64 %457, %struct.Memory* %call2_40f837)
