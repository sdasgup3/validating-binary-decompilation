...
declare %struct.Memory* @sub_40c1e0._ZN15loop_inner_bodyILi31EiE7do_workERiPKii(%struct.State* noalias dereferenceable(3376), i64, %struct.Memory* noalias readnone returned) local_unnamed_addr
...
define %struct.Memory* @_Z26test_do_loop_unroll_factorILi31EiEvPKT0_iPKc(%struct.State* noalias, i64, %struct.Memory* noalias readnone) local_unnamed_addr #1 {
entry:
...
block_.L_40f7e1:                                  ; preds = %block_.L_40f7e1, %block_40f7dc
  %150 = phi i64 [ %236, %block_.L_40f7e1 ], [ %149, %block_40f7dc ]
  %151 = phi i64 [ %197, %block_.L_40f7e1 ], [ %111, %block_40f7dc ]
  %152 = add i64 %151, -32
  ...
  %call2_40f7ec = tail call %struct.Memory* @sub_40c1e0._ZN15loop_inner_bodyILi31EiE7do_workERiPKii(%struct.State* nonnull %0, i64 %162, %struct.Memory* %MEMORY.0)
...
block_.L_40f810:                                  ; preds = %block_40f80b, %block_40f7bf
  %238 = phi i64 [ %237, %block_40f80b ], [ %148, %block_40f7bf ]
  %239 = phi i64 [ %197, %block_40f80b ], [ %111, %block_40f7bf ]
  %240 = add i64 %239, -36
  %241 = add i64 %238, 3
...
block_.L_40f821:                                  ; preds = %block_.L_40f821, %block_40f81c
  %277 = phi i64 [ %400, %block_.L_40f821 ], [ %276, %block_40f81c ]
  %278 = phi i64 [ %365, %block_.L_40f821 ], [ %239, %block_40f81c ]
  %279 = add i64 %278, -8
  %280 = add i64 %277, 4
  ...
  %call2_40f82c = tail call %struct.Memory* @sub_40c100._Z18complete_hash_funcIiET_S0_(%struct.State* nonnull %0, i64 %294, %struct.Memory* %MEMORY.0)
...
block_.L_40f851:                                  ; preds = %block_.L_40f810, %block_40f84c
  ...
  %call2_40f854 = tail call %struct.Memory* @sub_40c130._Z9check_sumIiEvT_(%struct.State* nonnull %0, i64 %409, %struct.Memory* %MEMORY.0)
