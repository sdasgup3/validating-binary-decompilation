...
declare %struct.Memory* @sub_401450._ZN15loop_inner_bodyILi32EdE7do_workERdPKdi(%struct.State* noalias dereferenceable(3376), i64, %struct.Memory* noalias readnone returned) local_unnamed_addr
...
block_.L_404ae2:                                  ; preds = %block_.L_404ae2, %block_404add
  %156 = phi i64 [ %241, %block_.L_404ae2 ], [ %155, %block_404add ]
  %157 = phi i64 [ %202, %block_.L_404ae2 ], [ %118, %block_404add ]
  %158 = add i64 %157, -40
  ...
  %call2_404aed = tail call %struct.Memory* @sub_401450._ZN15loop_inner_bodyILi32EdE7do_workERdPKdi(%struct.State* nonnull %0, i64 %168, %struct.Memory* %MEMORY.0)
...
block_.L_404b11:                                  ; preds = %block_404b0c, %block_404abf
  %243 = phi i64 [ %242, %block_404b0c ], [ %154, %block_404abf ]
  %244 = phi i64 [ %202, %block_404b0c ], [ %118, %block_404abf ]
  %245 = add i64 %244, -44
  %246 = add i64 %243, 3
...
block_.L_404b22:                                  ; preds = %block_.L_404b22, %block_404b1d
  %282 = phi i64 [ %378, %block_.L_404b22 ], [ %281, %block_404b1d ]
  %283 = phi i64 [ %343, %block_.L_404b22 ], [ %244, %block_404b1d ]
  %284 = add i64 %283, -8
  %285 = add i64 %282, 4
  ...
  %call2_404b2f = tail call %struct.Memory* @sub_4014b0._Z18complete_hash_funcIdET_S0_(%struct.State* nonnull %0, i64 %298, %struct.Memory* %MEMORY.0)
...
block_.L_404b58:                                  ; preds = %block_.L_404b11, %block_404b53
  ...
  %call2_404b5d = tail call %struct.Memory* @sub_4014e0._Z9check_sumIdEvT_(%struct.State* nonnull %0, i64 %386, %struct.Memory* %MEMORY.0)
