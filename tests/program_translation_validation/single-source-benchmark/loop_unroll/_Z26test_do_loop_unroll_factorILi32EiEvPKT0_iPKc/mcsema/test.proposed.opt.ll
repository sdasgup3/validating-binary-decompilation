...
block_.L_40f63f:                                  ; preds = %block_.L_40f6e1, %entry
  %68 = phi i64 [ %.pre, %entry ], [ %445, %block_.L_40f6e1 ]
...
block_.L_40f6b1:                                  ; preds = %block_.L_40f6b1, %block_40f6ac
  %275 = phi i64 [ %274, %block_40f6ac ], [ %399, %block_.L_40f6b1 ]
  %276 = phi i64 [ %237, %block_40f6ac ], [ %364, %block_.L_40f6b1 ]
  ...
  br i1 %388, label %block_40f6dc, label %block_.L_40f6b1
...
block_.L_40f6e1:                                  ; preds = %block_.L_40f6a0, %block_40f6dc
  %401 = phi i64 [ %273, %block_.L_40f6a0 ], [ %400, %block_40f6dc ]
  %402 = phi i64 [ %237, %block_.L_40f6a0 ], [ %364, %block_40f6dc ]
  ...
  %call2_40f6e4 = tail call %struct.Memory* @sub_40c100._Z9check_sumIiEvT_(%struct.State* %0, i64 %408, %struct.Memory* %MEMORY.4)
...
block_.L_40f6f7:                                  ; preds = %block_.L_40f63f
  ...
  %call2_40f6f7 = tail call %struct.Memory* @sub_400df0._Z5timerv(%struct.State* %0, i64 %446, %struct.Memory* %MEMORY.0)
  ...
  %call2_40f700 = tail call %struct.Memory* @sub_400790._Z13record_resultdPKc(%struct.State* %0, i64 %457, %struct.Memory* %call2_40f6f7)
