...
block_.L_411a7f:                                  ; preds = %block_.L_411b21, %entry
  %68 = phi i64 [ %.pre, %entry ], [ %445, %block_.L_411b21 ]
...
block_.L_411af1:                                  ; preds = %block_.L_411af1, %block_411aec
  %275 = phi i64 [ %274, %block_411aec ], [ %399, %block_.L_411af1 ]
  %276 = phi i64 [ %237, %block_411aec ], [ %364, %block_.L_411af1 ]
  ...
  br i1 %388, label %block_411b1c, label %block_.L_411af1
...
block_.L_411b21:                                  ; preds = %block_.L_411ae0, %block_411b1c
  %401 = phi i64 [ %273, %block_.L_411ae0 ], [ %400, %block_411b1c ]
  %402 = phi i64 [ %237, %block_.L_411ae0 ], [ %364, %block_411b1c ]
  ...
  %call2_411b24 = tail call %struct.Memory* @sub_40c100._Z9check_sumIiEvT_(%struct.State* %0, i64 %408, %struct.Memory* %MEMORY.4)
...
block_.L_411b37:                                  ; preds = %block_.L_411a7f
  ...
  %call2_411b37 = tail call %struct.Memory* @sub_400df0._Z5timerv(%struct.State* %0, i64 %446, %struct.Memory* %MEMORY.0)
  ...
  %call2_411b40 = tail call %struct.Memory* @sub_400790._Z13record_resultdPKc(%struct.State* %0, i64 %457, %struct.Memory* %call2_411b37)
