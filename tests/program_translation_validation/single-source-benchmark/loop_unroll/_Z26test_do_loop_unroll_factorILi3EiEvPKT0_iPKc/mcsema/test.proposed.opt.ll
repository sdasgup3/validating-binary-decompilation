...
define %struct.Memory* @_Z26test_do_loop_unroll_factorILi3EiEvPKT0_iPKc(%struct.State* noalias, i64, %struct.Memory* noalias) local_unnamed_addr #1 {
entry:
  ...
  %call2_411a73 = tail call %struct.Memory* @sub_400dd0._Z11start_timerv(%struct.State* %0, i64 %58, %struct.Memory* %2)
...
block_.L_411a7f:                                  ; preds = %block_.L_411b21, %entry
  %68 = phi i64 [ %.pre, %entry ], [ %443, %block_.L_411b21 ]
  %MEMORY.0 = phi %struct.Memory* [ %call2_411a73, %entry ], [ %call2_411b24, %block_.L_411b21 ]
  ...
  br i1 %101, label %block_411a8f, label %block_.L_411b37

block_411a8f:                                     ; preds = %block_.L_411a7f
  %103 = add i64 %69, -32
  %104 = add i64 %102, 7
  ...
  br i1 %146, label %block_.L_411ae0, label %block_411aac

block_411aac:                                     ; preds = %block_411a8f
  %148 = add i64 %147, 5
  store i64 %148, i64* %3, align 8
  br label %block_.L_411ab1

block_.L_411ab1:                                  ; preds = %block_.L_411ab1, %block_411aac
  %149 = phi i64 [ %148, %block_411aac ], [ %234, %block_.L_411ab1 ]
  %150 = phi i64 [ %111, %block_411aac ], [ %195, %block_.L_411ab1 ]
  %MEMORY.1 = phi %struct.Memory* [ %MEMORY.0, %block_411aac ], [ %call2_411abc, %block_.L_411ab1 ]
  %151 = add i64 %150, -32
  ...
  %call2_411abc = tail call %struct.Memory* @sub_40cc30._ZN15loop_inner_bodyILi3EiE7do_workERiPKii(%struct.State* %0, i64 %161, %struct.Memory* %MEMORY.1)
  ...
  br i1 %233, label %block_.L_411ab1, label %block_411adb

block_411adb:                                     ; preds = %block_.L_411ab1
  %235 = add i64 %234, 5
  store i64 %235, i64* %3, align 8
  br label %block_.L_411ae0

block_.L_411ae0:                                  ; preds = %block_411adb, %block_411a8f
  %236 = phi i64 [ %147, %block_411a8f ], [ %235, %block_411adb ]
  %237 = phi i64 [ %111, %block_411a8f ], [ %195, %block_411adb ]
  %MEMORY.2 = phi %struct.Memory* [ %MEMORY.0, %block_411a8f ], [ %call2_411abc, %block_411adb ]
  %238 = add i64 %237, -36
  %239 = add i64 %236, 3
  ...
  br i1 %272, label %block_411aec, label %block_.L_411b21

block_411aec:                                     ; preds = %block_.L_411ae0
  %274 = add i64 %273, 5
  store i64 %274, i64* %3, align 8
  br label %block_.L_411af1

block_.L_411af1:                                  ; preds = %block_.L_411af1, %block_411aec
  %275 = phi i64 [ %274, %block_411aec ], [ %398, %block_.L_411af1 ]
  %276 = phi i64 [ %237, %block_411aec ], [ %363, %block_.L_411af1 ]
  %MEMORY.3 = phi %struct.Memory* [ %MEMORY.2, %block_411aec ], [ %call2_411afc, %block_.L_411af1 ]
  %277 = add i64 %276, -8
  %278 = add i64 %275, 4
  ...
  %call2_411afc = tail call %struct.Memory* @sub_40c0d0._Z18complete_hash_funcIiET_S0_(%struct.State* %0, i64 %292, %struct.Memory* %MEMORY.3)
  ...
  br i1 %387, label %block_411b1c, label %block_.L_411af1

block_411b1c:                                     ; preds = %block_.L_411af1
  %399 = add i64 %398, 5
  store i64 %399, i64* %3, align 8
  br label %block_.L_411b21

block_.L_411b21:                                  ; preds = %block_.L_411ae0, %block_411b1c
  %400 = phi i64 [ %273, %block_.L_411ae0 ], [ %399, %block_411b1c ]
  %401 = phi i64 [ %237, %block_.L_411ae0 ], [ %363, %block_411b1c ]
  %MEMORY.4 = phi %struct.Memory* [ %MEMORY.2, %block_.L_411ae0 ], [ %call2_411afc, %block_411b1c ]
  %402 = add i64 %401, -32
  %403 = add i64 %400, 3
  ...
  %call2_411b24 = tail call %struct.Memory* @sub_40c100._Z9check_sumIiEvT_(%struct.State* %0, i64 %407, %struct.Memory* %MEMORY.4)
...
block_.L_411b37:                                  ; preds = %block_.L_411a7f
  %444 = add i64 %102, -68935
  %445 = add i64 %102, 5
  ...
  %call2_411b37 = tail call %struct.Memory* @sub_400df0._Z5timerv(%struct.State* %0, i64 %444, %struct.Memory* %MEMORY.0)
  ...
  %call2_411b40 = tail call %struct.Memory* @sub_400790._Z13record_resultdPKc(%struct.State* %0, i64 %455, %struct.Memory* %call2_411b37)
  ...
  ret %struct.Memory* %call2_411b40
}
...
define %struct.Memory* @routine_jge_.L_411b37(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i8* %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
...
define %struct.Memory* @routine_jl_.L_411ae0(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i8* %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 2, i32 9
...
define %struct.Memory* @routine_jmpq_.L_411ab1(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
...
define %struct.Memory* @routine_jl_.L_411ab1(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i8* %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 2, i32 9
...
define %struct.Memory* @routine_jmpq_.L_411ae0(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
...
define %struct.Memory* @routine_jge_.L_411b21(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i8* %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 2, i32 9
...
define %struct.Memory* @routine_jmpq_.L_411af1(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
...
define %struct.Memory* @routine_jne_.L_411af1(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i8* %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
...
define %struct.Memory* @routine_jmpq_.L_411b21(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
...
define %struct.Memory* @routine_jmpq_.L_411a7f(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
