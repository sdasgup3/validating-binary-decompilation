...
block_.L_406f3f:                                  ; preds = %block_.L_406fe8, %entry
  %79 = phi i64 [ %.pre, %entry ], [ %431, %block_.L_406fe8 ]
...
block_.L_406fb2:                                  ; preds = %block_.L_406fb2, %block_406fad
  %288 = phi i64 [ %287, %block_406fad ], [ %385, %block_.L_406fb2 ]
  %289 = phi i64 [ %250, %block_406fad ], [ %350, %block_.L_406fb2 ]
  ...
  %call2_406fbf = tail call %struct.Memory* @sub_401480._Z18complete_hash_funcIdET_S0_(%struct.State* %0, i64 %305, %struct.Memory* %MEMORY.3)
  ...
  br i1 %374, label %block_406fe3, label %block_.L_406fb2
...
block_.L_406fe8:                                  ; preds = %block_.L_406fa1, %block_406fe3
  %387 = phi i64 [ %286, %block_.L_406fa1 ], [ %386, %block_406fe3 ]
  %388 = phi i64 [ %250, %block_.L_406fa1 ], [ %350, %block_406fe3 ]
  ...
  %call2_406fed = tail call %struct.Memory* @sub_4014b0._Z9check_sumIdEvT_(%struct.State* %0, i64 %394, %struct.Memory* %MEMORY.4)
...
block_.L_407000:                                  ; preds = %block_.L_406f3f
  ...
  %call2_407000 = tail call %struct.Memory* @sub_400df0._Z5timerv(%struct.State* %0, i64 %432, %struct.Memory* %MEMORY.0)
  ...
  %call2_407009 = tail call %struct.Memory* @sub_400790._Z13record_resultdPKc(%struct.State* %0, i64 %443, %struct.Memory* %call2_407000)
