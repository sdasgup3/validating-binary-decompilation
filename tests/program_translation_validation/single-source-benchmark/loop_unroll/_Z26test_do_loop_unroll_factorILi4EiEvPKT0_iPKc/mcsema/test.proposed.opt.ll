...
entry:
  ...
  %call2_411933 = tail call %struct.Memory* @sub_400dd0._Z11start_timerv(%struct.State* %0, i64 %58, %struct.Memory* %2)
...
block_.L_41193f:                                  ; preds = %block_.L_4119e1, %entry
  %68 = phi i64 [ %.pre, %entry ], [ %445, %block_.L_4119e1 ]
  %MEMORY.0 = phi %struct.Memory* [ %call2_411933, %entry ], [ %call2_4119e4, %block_.L_4119e1 ]
  ...
  br i1 %101, label %block_41194f, label %block_.L_4119f7

block_41194f:                                     ; preds = %block_.L_41193f
  %103 = add i64 %69, -32
  %104 = add i64 %102, 7
  ...
  br i1 %146, label %block_.L_4119a0, label %block_41196c

block_41196c:                                     ; preds = %block_41194f
  %148 = add i64 %147, 5
  store i64 %148, i64* %3, align 8
  br label %block_.L_411971

block_.L_411971:                                  ; preds = %block_.L_411971, %block_41196c
  %149 = phi i64 [ %148, %block_41196c ], [ %234, %block_.L_411971 ]
  %150 = phi i64 [ %111, %block_41196c ], [ %195, %block_.L_411971 ]
  %MEMORY.1 = phi %struct.Memory* [ %MEMORY.0, %block_41196c ], [ %call2_41197c, %block_.L_411971 ]
  %151 = add i64 %150, -32
  ...
  %call2_41197c = tail call %struct.Memory* @sub_40cbd0._ZN15loop_inner_bodyILi4EiE7do_workERiPKii(%struct.State* %0, i64 %161, %struct.Memory* %MEMORY.1)
  ...
  br i1 %233, label %block_.L_411971, label %block_41199b

block_41199b:                                     ; preds = %block_.L_411971
  %235 = add i64 %234, 5
  store i64 %235, i64* %3, align 8
  br label %block_.L_4119a0

block_.L_4119a0:                                  ; preds = %block_41199b, %block_41194f
  %236 = phi i64 [ %147, %block_41194f ], [ %235, %block_41199b ]
  %237 = phi i64 [ %111, %block_41194f ], [ %195, %block_41199b ]
  %MEMORY.2 = phi %struct.Memory* [ %MEMORY.0, %block_41194f ], [ %call2_41197c, %block_41199b ]
  %238 = add i64 %237, -36
  %239 = add i64 %236, 3
  ...
  br i1 %272, label %block_4119ac, label %block_.L_4119e1

block_4119ac:                                     ; preds = %block_.L_4119a0
  %274 = add i64 %273, 5
  store i64 %274, i64* %3, align 8
  br label %block_.L_4119b1

block_.L_4119b1:                                  ; preds = %block_.L_4119b1, %block_4119ac
  %275 = phi i64 [ %274, %block_4119ac ], [ %399, %block_.L_4119b1 ]
  %276 = phi i64 [ %237, %block_4119ac ], [ %364, %block_.L_4119b1 ]
  %MEMORY.3 = phi %struct.Memory* [ %MEMORY.2, %block_4119ac ], [ %call2_4119bc, %block_.L_4119b1 ]
  %277 = add i64 %276, -8
  %278 = add i64 %275, 4
  ...
  %call2_4119bc = tail call %struct.Memory* @sub_40c0d0._Z18complete_hash_funcIiET_S0_(%struct.State* %0, i64 %292, %struct.Memory* %MEMORY.3)
  ...
  br i1 %388, label %block_4119dc, label %block_.L_4119b1

block_4119dc:                                     ; preds = %block_.L_4119b1
  %400 = add i64 %399, 5
  store i64 %400, i64* %3, align 8
  br label %block_.L_4119e1

block_.L_4119e1:                                  ; preds = %block_.L_4119a0, %block_4119dc
  %401 = phi i64 [ %273, %block_.L_4119a0 ], [ %400, %block_4119dc ]
  %402 = phi i64 [ %237, %block_.L_4119a0 ], [ %364, %block_4119dc ]
  %MEMORY.4 = phi %struct.Memory* [ %MEMORY.2, %block_.L_4119a0 ], [ %call2_4119bc, %block_4119dc ]
  %403 = add i64 %402, -32
  %404 = add i64 %401, 3
  ...
  %call2_4119e4 = tail call %struct.Memory* @sub_40c100._Z9check_sumIiEvT_(%struct.State* %0, i64 %408, %struct.Memory* %MEMORY.4)
...
block_.L_4119f7:                                  ; preds = %block_.L_41193f
  %446 = add i64 %102, -68615
  %447 = add i64 %102, 5
  ...
  %call2_4119f7 = tail call %struct.Memory* @sub_400df0._Z5timerv(%struct.State* %0, i64 %446, %struct.Memory* %MEMORY.0)
  ...
  %call2_411a00 = tail call %struct.Memory* @sub_400790._Z13record_resultdPKc(%struct.State* %0, i64 %457, %struct.Memory* %call2_4119f7)
  ...
  ret %struct.Memory* %call2_411a00
}
...
define %struct.Memory* @routine_jge_.L_4119f7(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i8* %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
...
define %struct.Memory* @routine_jl_.L_4119a0(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i8* %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 2, i32 9
...
define %struct.Memory* @routine_jmpq_.L_411971(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
...
define %struct.Memory* @routine_jl_.L_411971(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i8* %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 2, i32 9
...
define %struct.Memory* @routine_jmpq_.L_4119a0(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
...
define %struct.Memory* @routine_jge_.L_4119e1(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i8* %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 2, i32 9
...
define %struct.Memory* @routine_jmpq_.L_4119b1(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
...
define %struct.Memory* @routine_jne_.L_4119b1(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i8* %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
...
define %struct.Memory* @routine_jmpq_.L_4119e1(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
...
define %struct.Memory* @routine_jmpq_.L_41193f(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
