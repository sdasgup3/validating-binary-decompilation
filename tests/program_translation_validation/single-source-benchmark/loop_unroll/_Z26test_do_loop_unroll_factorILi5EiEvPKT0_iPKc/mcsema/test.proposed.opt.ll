...
define %struct.Memory* @_Z26test_do_loop_unroll_factorILi5EiEvPKT0_iPKc(%struct.State* noalias, i64, %struct.Memory* noalias readnone) local_unnamed_addr #1 {
entry:
...
block_.L_411861:                                  ; preds = %block_.L_411861, %block_41185c
  %149 = phi i64 [ %234, %block_.L_411861 ], [ %148, %block_41185c ]
  %150 = phi i64 [ %195, %block_.L_411861 ], [ %111, %block_41185c ]
  %151 = add i64 %150, -32
  ...
  %call2_41186c = tail call %struct.Memory* @sub_40cba0._ZN15loop_inner_bodyILi5EiE7do_workERiPKii(%struct.State* nonnull %0, i64 %161, %struct.Memory* %MEMORY.0)
...
block_.L_411890:                                  ; preds = %block_41188b, %block_41183f
  %236 = phi i64 [ %235, %block_41188b ], [ %147, %block_41183f ]
  %237 = phi i64 [ %195, %block_41188b ], [ %111, %block_41183f ]
  %238 = add i64 %237, -36
  %239 = add i64 %236, 3
...
block_.L_4118a1:                                  ; preds = %block_.L_4118a1, %block_41189c
  %275 = phi i64 [ %398, %block_.L_4118a1 ], [ %274, %block_41189c ]
  %276 = phi i64 [ %363, %block_.L_4118a1 ], [ %237, %block_41189c ]
  %277 = add i64 %276, -8
  %278 = add i64 %275, 4
  ...
  %call2_4118ac = tail call %struct.Memory* @sub_40c100._Z18complete_hash_funcIiET_S0_(%struct.State* nonnull %0, i64 %292, %struct.Memory* %MEMORY.0)
...
block_.L_4118d1:                                  ; preds = %block_.L_411890, %block_4118cc
  ...
  %call2_4118d4 = tail call %struct.Memory* @sub_40c130._Z9check_sumIiEvT_(%struct.State* nonnull %0, i64 %407, %struct.Memory* %MEMORY.0)
