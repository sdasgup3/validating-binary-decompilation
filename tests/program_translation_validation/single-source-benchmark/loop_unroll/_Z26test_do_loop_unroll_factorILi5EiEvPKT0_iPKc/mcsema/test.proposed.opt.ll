...
block_.L_4117ff:                                  ; preds = %block_.L_4118a1, %entry
  %68 = phi i64 [ %.pre, %entry ], [ %445, %block_.L_4118a1 ]
...
block_.L_411871:                                  ; preds = %block_.L_411871, %block_41186c
  %275 = phi i64 [ %274, %block_41186c ], [ %399, %block_.L_411871 ]
  %276 = phi i64 [ %237, %block_41186c ], [ %364, %block_.L_411871 ]
  ...
  br i1 %388, label %block_41189c, label %block_.L_411871
...
block_.L_4118a1:                                  ; preds = %block_.L_411860, %block_41189c
  %401 = phi i64 [ %273, %block_.L_411860 ], [ %400, %block_41189c ]
  %402 = phi i64 [ %237, %block_.L_411860 ], [ %364, %block_41189c ]
  ...
  %call2_4118a4 = tail call %struct.Memory* @sub_40c100._Z9check_sumIiEvT_(%struct.State* %0, i64 %408, %struct.Memory* %MEMORY.4)
...
block_.L_4118b7:                                  ; preds = %block_.L_4117ff
  ...
  %call2_4118b7 = tail call %struct.Memory* @sub_400df0._Z5timerv(%struct.State* %0, i64 %446, %struct.Memory* %MEMORY.0)
  ...
  %call2_4118c0 = tail call %struct.Memory* @sub_400790._Z13record_resultdPKc(%struct.State* %0, i64 %457, %struct.Memory* %call2_4118b7)
