...
entry:
  ...
  %call2_4117f3 = tail call %struct.Memory* @sub_400dd0._Z11start_timerv(%struct.State* %0, i64 %58, %struct.Memory* %2)
...
block_.L_4117ff:                                  ; preds = %block_.L_4118a1, %entry
  %68 = phi i64 [ %.pre, %entry ], [ %443, %block_.L_4118a1 ]
  %MEMORY.0 = phi %struct.Memory* [ %call2_4117f3, %entry ], [ %call2_4118a4, %block_.L_4118a1 ]
  ...
  br i1 %101, label %block_41180f, label %block_.L_4118b7
...
block_41180f:                                     ; preds = %block_.L_4117ff
  ...
  br i1 %146, label %block_.L_411860, label %block_41182c
...
block_.L_411831:                                  ; preds = %block_.L_411831, %block_41182c
  %149 = phi i64 [ %148, %block_41182c ], [ %234, %block_.L_411831 ]
  %150 = phi i64 [ %111, %block_41182c ], [ %195, %block_.L_411831 ]
  %MEMORY.1 = phi %struct.Memory* [ %MEMORY.0, %block_41182c ], [ %call2_41183c, %block_.L_411831 ]
  %151 = add i64 %150, -32
  ...
  %call2_41183c = tail call %struct.Memory* @sub_40cb70._ZN15loop_inner_bodyILi5EiE7do_workERiPKii(%struct.State* %0, i64 %161, %struct.Memory* %MEMORY.1)
  ...
  br i1 %233, label %block_.L_411831, label %block_41185b
...
block_.L_411860:                                  ; preds = %block_41185b, %block_41180f
  %236 = phi i64 [ %147, %block_41180f ], [ %235, %block_41185b ]
  %237 = phi i64 [ %111, %block_41180f ], [ %195, %block_41185b ]
  %MEMORY.2 = phi %struct.Memory* [ %MEMORY.0, %block_41180f ], [ %call2_41183c, %block_41185b ]
  %238 = add i64 %237, -36
  %239 = add i64 %236, 3
  ...
  br i1 %272, label %block_41186c, label %block_.L_4118a1
...
block_.L_411871:                                  ; preds = %block_.L_411871, %block_41186c
  %275 = phi i64 [ %274, %block_41186c ], [ %398, %block_.L_411871 ]
  %276 = phi i64 [ %237, %block_41186c ], [ %363, %block_.L_411871 ]
  %MEMORY.3 = phi %struct.Memory* [ %MEMORY.2, %block_41186c ], [ %call2_41187c, %block_.L_411871 ]
  %277 = add i64 %276, -8
  %278 = add i64 %275, 4
  ...
  %call2_41187c = tail call %struct.Memory* @sub_40c0d0._Z18complete_hash_funcIiET_S0_(%struct.State* %0, i64 %292, %struct.Memory* %MEMORY.3)
  ...
  br i1 %387, label %block_41189c, label %block_.L_411871
...
block_.L_4118a1:                                  ; preds = %block_.L_411860, %block_41189c
  %400 = phi i64 [ %273, %block_.L_411860 ], [ %399, %block_41189c ]
  %401 = phi i64 [ %237, %block_.L_411860 ], [ %363, %block_41189c ]
  %MEMORY.4 = phi %struct.Memory* [ %MEMORY.2, %block_.L_411860 ], [ %call2_41187c, %block_41189c ]
  %402 = add i64 %401, -32
  %403 = add i64 %400, 3
  ...
  %call2_4118a4 = tail call %struct.Memory* @sub_40c100._Z9check_sumIiEvT_(%struct.State* %0, i64 %407, %struct.Memory* %MEMORY.4)
...
block_.L_4118b7:                                  ; preds = %block_.L_4117ff
  ...
  %call2_4118b7 = tail call %struct.Memory* @sub_400df0._Z5timerv(%struct.State* %0, i64 %444, %struct.Memory* %MEMORY.0)
  ...
  %call2_4118c0 = tail call %struct.Memory* @sub_400790._Z13record_resultdPKc(%struct.State* %0, i64 %455, %struct.Memory* %call2_4118b7)
  ...
  ret %struct.Memory* %call2_4118c0
}
...
define %struct.Memory* @routine_jge_.L_4118b7(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i8* %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
...
define %struct.Memory* @routine_jl_.L_411860(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i8* %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 2, i32 9
...
define %struct.Memory* @routine_jmpq_.L_411831(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
...
define %struct.Memory* @routine_jl_.L_411831(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i8* %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 2, i32 9
...
define %struct.Memory* @routine_jmpq_.L_411860(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
...
define %struct.Memory* @routine_jge_.L_4118a1(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i8* %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 2, i32 9
...
define %struct.Memory* @routine_jmpq_.L_411871(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
...
define %struct.Memory* @routine_jne_.L_411871(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i8* %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
...
define %struct.Memory* @routine_jmpq_.L_4118a1(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
...
define %struct.Memory* @routine_jmpq_.L_4117ff(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
