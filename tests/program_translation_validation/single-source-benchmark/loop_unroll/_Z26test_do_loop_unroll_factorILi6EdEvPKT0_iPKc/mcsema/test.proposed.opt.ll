...
define %struct.Memory* @_Z26test_do_loop_unroll_factorILi6EdEvPKT0_iPKc(%struct.State* noalias, i64, %struct.Memory* noalias readnone) local_unnamed_addr #1 {
entry:
...
block_.L_406d02:                                  ; preds = %block_.L_406d02, %block_406cfd
  %156 = phi i64 [ %241, %block_.L_406d02 ], [ %155, %block_406cfd ]
  %157 = phi i64 [ %202, %block_.L_406d02 ], [ %118, %block_406cfd ]
  %158 = add i64 %157, -40
  ...
  %call2_406d0d = tail call %struct.Memory* @sub_401f80._ZN15loop_inner_bodyILi6EdE7do_workERdPKdi(%struct.State* nonnull %0, i64 %168, %struct.Memory* %MEMORY.0)
...
block_.L_406d31:                                  ; preds = %block_406d2c, %block_406cdf
  %243 = phi i64 [ %242, %block_406d2c ], [ %154, %block_406cdf ]
  %244 = phi i64 [ %202, %block_406d2c ], [ %118, %block_406cdf ]
  %245 = add i64 %244, -44
  %246 = add i64 %243, 3
...
block_.L_406d42:                                  ; preds = %block_.L_406d42, %block_406d3d
  %282 = phi i64 [ %378, %block_.L_406d42 ], [ %281, %block_406d3d ]
  %283 = phi i64 [ %343, %block_.L_406d42 ], [ %244, %block_406d3d ]
  %284 = add i64 %283, -8
  %285 = add i64 %282, 4
  ...
  %call2_406d4f = tail call %struct.Memory* @sub_4014b0._Z18complete_hash_funcIdET_S0_(%struct.State* nonnull %0, i64 %298, %struct.Memory* %MEMORY.0)
...
block_.L_406d78:                                  ; preds = %block_.L_406d31, %block_406d73
  ...
  %call2_406d7d = tail call %struct.Memory* @sub_4014e0._Z9check_sumIdEvT_(%struct.State* nonnull %0, i64 %386, %struct.Memory* %MEMORY.0)
