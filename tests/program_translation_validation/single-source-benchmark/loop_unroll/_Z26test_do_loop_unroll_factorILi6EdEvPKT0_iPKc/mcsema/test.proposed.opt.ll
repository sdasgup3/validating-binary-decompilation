...
block_.L_406c9f:                                  ; preds = %block_.L_406d48, %entry
  %79 = phi i64 [ %.pre, %entry ], [ %427, %block_.L_406d48 ]
...
block_.L_406d12:                                  ; preds = %block_.L_406d12, %block_406d0d
  %288 = phi i64 [ %287, %block_406d0d ], [ %383, %block_.L_406d12 ]
  %289 = phi i64 [ %250, %block_406d0d ], [ %348, %block_.L_406d12 ]
  ...
  %call2_406d1f = tail call %struct.Memory* @sub_401480._Z18complete_hash_funcIdET_S0_(%struct.State* %0, i64 %304, %struct.Memory* %MEMORY.3)
  ...
  br i1 %372, label %block_406d43, label %block_.L_406d12
...
block_.L_406d48:                                  ; preds = %block_.L_406d01, %block_406d43
  %385 = phi i64 [ %286, %block_.L_406d01 ], [ %384, %block_406d43 ]
  %386 = phi i64 [ %250, %block_.L_406d01 ], [ %348, %block_406d43 ]
  ...
  %call2_406d4d = tail call %struct.Memory* @sub_4014b0._Z9check_sumIdEvT_(%struct.State* %0, i64 %391, %struct.Memory* %MEMORY.4)
...
block_.L_406d60:                                  ; preds = %block_.L_406c9f
  ...
  %call2_406d60 = tail call %struct.Memory* @sub_400df0._Z5timerv(%struct.State* %0, i64 %428, %struct.Memory* %MEMORY.0)
  ...
  %call2_406d69 = tail call %struct.Memory* @sub_400790._Z13record_resultdPKc(%struct.State* %0, i64 %439, %struct.Memory* %call2_406d60)
