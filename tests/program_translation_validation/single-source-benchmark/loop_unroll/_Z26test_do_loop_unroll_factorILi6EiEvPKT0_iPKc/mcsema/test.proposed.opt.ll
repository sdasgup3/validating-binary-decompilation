...
declare %struct.Memory* @sub_40cb40._ZN15loop_inner_bodyILi6EiE7do_workERiPKii(%struct.State* noalias dereferenceable(3376), i64, %struct.Memory* noalias readnone returned) local_unnamed_addr
...
block_.L_411721:                                  ; preds = %block_.L_411721, %block_41171c
  %149 = phi i64 [ %234, %block_.L_411721 ], [ %148, %block_41171c ]
  %150 = phi i64 [ %195, %block_.L_411721 ], [ %111, %block_41171c ]
  %151 = add i64 %150, -32
  ...
  %call2_41172c = tail call %struct.Memory* @sub_40cb40._ZN15loop_inner_bodyILi6EiE7do_workERiPKii(%struct.State* nonnull %0, i64 %161, %struct.Memory* %MEMORY.0)
...
block_.L_411750:                                  ; preds = %block_41174b, %block_4116ff
  %236 = phi i64 [ %235, %block_41174b ], [ %147, %block_4116ff ]
  %237 = phi i64 [ %195, %block_41174b ], [ %111, %block_4116ff ]
  %238 = add i64 %237, -36
  %239 = add i64 %236, 3
...
block_.L_411761:                                  ; preds = %block_.L_411761, %block_41175c
  %275 = phi i64 [ %398, %block_.L_411761 ], [ %274, %block_41175c ]
  %276 = phi i64 [ %363, %block_.L_411761 ], [ %237, %block_41175c ]
  %277 = add i64 %276, -8
  %278 = add i64 %275, 4
  ...
  %call2_41176c = tail call %struct.Memory* @sub_40c100._Z18complete_hash_funcIiET_S0_(%struct.State* nonnull %0, i64 %292, %struct.Memory* %MEMORY.0)
...
block_.L_411791:                                  ; preds = %block_.L_411750, %block_41178c
  ...
  %call2_411794 = tail call %struct.Memory* @sub_40c130._Z9check_sumIiEvT_(%struct.State* nonnull %0, i64 %407, %struct.Memory* %MEMORY.0)
