...
block_.L_406b4f:                                  ; preds = %block_.L_406bf8, %entry
  %79 = phi i64 [ %.pre, %entry ], [ %427, %block_.L_406bf8 ]
...
block_.L_406bc2:                                  ; preds = %block_.L_406bc2, %block_406bbd
  %288 = phi i64 [ %287, %block_406bbd ], [ %383, %block_.L_406bc2 ]
  %289 = phi i64 [ %250, %block_406bbd ], [ %348, %block_.L_406bc2 ]
  ...
  %call2_406bcf = tail call %struct.Memory* @sub_401480._Z18complete_hash_funcIdET_S0_(%struct.State* %0, i64 %304, %struct.Memory* %MEMORY.3)
  ...
  br i1 %372, label %block_406bf3, label %block_.L_406bc2
...
block_.L_406bf8:                                  ; preds = %block_.L_406bb1, %block_406bf3
  %385 = phi i64 [ %286, %block_.L_406bb1 ], [ %384, %block_406bf3 ]
  %386 = phi i64 [ %250, %block_.L_406bb1 ], [ %348, %block_406bf3 ]
  ...
  %call2_406bfd = tail call %struct.Memory* @sub_4014b0._Z9check_sumIdEvT_(%struct.State* %0, i64 %391, %struct.Memory* %MEMORY.4)
...
block_.L_406c10:                                  ; preds = %block_.L_406b4f
  ...
  %call2_406c10 = tail call %struct.Memory* @sub_400df0._Z5timerv(%struct.State* %0, i64 %428, %struct.Memory* %MEMORY.0)
  ...
  %call2_406c19 = tail call %struct.Memory* @sub_400790._Z13record_resultdPKc(%struct.State* %0, i64 %439, %struct.Memory* %call2_406c10)
