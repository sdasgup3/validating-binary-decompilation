...
entry:
  ...
  %call2_406b43 = tail call %struct.Memory* @sub_400dd0._Z11start_timerv(%struct.State* %0, i64 %58, %struct.Memory* %2)
...
block_.L_406b4f:                                  ; preds = %block_.L_406bf8, %entry
  %79 = phi i64 [ %.pre, %entry ], [ %431, %block_.L_406bf8 ]
  %MEMORY.0 = phi %struct.Memory* [ %call2_406b43, %entry ], [ %call2_406bfd, %block_.L_406bf8 ]
  ...
  br i1 %112, label %block_406b5f, label %block_.L_406c10
...
block_406b5f:                                     ; preds = %block_.L_406b4f
  ...
  br i1 %159, label %block_.L_406bb1, label %block_406b7d
...
block_.L_406b82:                                  ; preds = %block_.L_406b82, %block_406b7d
  %162 = phi i64 [ %161, %block_406b7d ], [ %247, %block_.L_406b82 ]
  %163 = phi i64 [ %124, %block_406b7d ], [ %208, %block_.L_406b82 ]
  %MEMORY.1 = phi %struct.Memory* [ %MEMORY.0, %block_406b7d ], [ %call2_406b8d, %block_.L_406b82 ]
  %164 = add i64 %163, -40
  ...
  %call2_406b8d = tail call %struct.Memory* @sub_401ef0._ZN15loop_inner_bodyILi7EdE7do_workERdPKdi(%struct.State* %0, i64 %174, %struct.Memory* %MEMORY.1)
  ...
  br i1 %246, label %block_.L_406b82, label %block_406bac
...
block_.L_406bb1:                                  ; preds = %block_406bac, %block_406b5f
  %249 = phi i64 [ %160, %block_406b5f ], [ %248, %block_406bac ]
  %250 = phi i64 [ %124, %block_406b5f ], [ %208, %block_406bac ]
  %MEMORY.2 = phi %struct.Memory* [ %MEMORY.0, %block_406b5f ], [ %call2_406b8d, %block_406bac ]
  %251 = add i64 %250, -44
  %252 = add i64 %249, 3
  ...
  br i1 %285, label %block_406bbd, label %block_.L_406bf8
...
block_.L_406bc2:                                  ; preds = %block_.L_406bc2, %block_406bbd
  %288 = phi i64 [ %287, %block_406bbd ], [ %385, %block_.L_406bc2 ]
  %289 = phi i64 [ %250, %block_406bbd ], [ %350, %block_.L_406bc2 ]
  %MEMORY.3 = phi %struct.Memory* [ %MEMORY.2, %block_406bbd ], [ %call2_406bcf, %block_.L_406bc2 ]
  %290 = add i64 %289, -8
  %291 = add i64 %288, 4
  ...
  %call2_406bcf = tail call %struct.Memory* @sub_401480._Z18complete_hash_funcIdET_S0_(%struct.State* %0, i64 %305, %struct.Memory* %MEMORY.3)
  ...
  br i1 %374, label %block_406bf3, label %block_.L_406bc2
...
block_.L_406bf8:                                  ; preds = %block_.L_406bb1, %block_406bf3
  %387 = phi i64 [ %286, %block_.L_406bb1 ], [ %386, %block_406bf3 ]
  %388 = phi i64 [ %250, %block_.L_406bb1 ], [ %350, %block_406bf3 ]
  %MEMORY.4 = phi %struct.Memory* [ %MEMORY.2, %block_.L_406bb1 ], [ %call2_406bcf, %block_406bf3 ]
  %389 = add i64 %388, -40
  %390 = add i64 %387, 5
  ...
  %call2_406bfd = tail call %struct.Memory* @sub_4014b0._Z9check_sumIdEvT_(%struct.State* %0, i64 %394, %struct.Memory* %MEMORY.4)
...
block_.L_406c10:                                  ; preds = %block_.L_406b4f
  ...
  %call2_406c10 = tail call %struct.Memory* @sub_400df0._Z5timerv(%struct.State* %0, i64 %432, %struct.Memory* %MEMORY.0)
  ...
  %call2_406c19 = tail call %struct.Memory* @sub_400790._Z13record_resultdPKc(%struct.State* %0, i64 %443, %struct.Memory* %call2_406c10)
  ...
  ret %struct.Memory* %call2_406c19
}
...
define %struct.Memory* @routine_jge_.L_406c10(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i8* %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
...
define %struct.Memory* @routine_jl_.L_406bb1(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i8* %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 2, i32 9
...
define %struct.Memory* @routine_jmpq_.L_406b82(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
...
define %struct.Memory* @routine_jl_.L_406b82(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i8* %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 2, i32 9
...
define %struct.Memory* @routine_jmpq_.L_406bb1(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
...
define %struct.Memory* @routine_jge_.L_406bf8(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i8* %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 2, i32 9
...
define %struct.Memory* @routine_jmpq_.L_406bc2(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
...
define %struct.Memory* @routine_jne_.L_406bc2(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i8* %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
...
define %struct.Memory* @routine_jmpq_.L_406bf8(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
...
define %struct.Memory* @routine_jmpq_.L_406b4f(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
