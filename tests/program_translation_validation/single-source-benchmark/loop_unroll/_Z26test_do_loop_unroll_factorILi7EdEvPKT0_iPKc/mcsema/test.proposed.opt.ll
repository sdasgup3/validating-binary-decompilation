...
entry:
  ...
  %call2_406b83 = tail call %struct.Memory* @sub_400e10._Z11start_timerv(%struct.State* %0, i64 %58, %struct.Memory* %2)
...
block_.L_406b8f:                                  ; preds = %block_.L_406c38, %entry
  %74 = phi i64 [ %.pre, %entry ], [ %422, %block_.L_406c38 ]
  %MEMORY.0 = phi %struct.Memory* [ %call2_406b83, %entry ], [ %call2_406c3d, %block_.L_406c38 ]
  ...
  br i1 %107, label %block_406b9f, label %block_.L_406c50
...
block_406b9f:                                     ; preds = %block_.L_406b8f
  ...
  br i1 %153, label %block_.L_406bf1, label %block_406bbd
...
block_.L_406bc2:                                  ; preds = %block_.L_406bc2, %block_406bbd
  %156 = phi i64 [ %241, %block_.L_406bc2 ], [ %155, %block_406bbd ]
  %157 = phi i64 [ %202, %block_.L_406bc2 ], [ %118, %block_406bbd ]
  %158 = add i64 %157, -40
  ...
  %call2_406bcd = tail call %struct.Memory* @sub_401f30._ZN15loop_inner_bodyILi7EdE7do_workERdPKdi(%struct.State* nonnull %0, i64 %168, %struct.Memory* %MEMORY.0)
  ...
  br i1 %240, label %block_.L_406bc2, label %block_406bec
...
block_.L_406bf1:                                  ; preds = %block_406bec, %block_406b9f
  %243 = phi i64 [ %242, %block_406bec ], [ %154, %block_406b9f ]
  %244 = phi i64 [ %202, %block_406bec ], [ %118, %block_406b9f ]
  %245 = add i64 %244, -44
  %246 = add i64 %243, 3
  ...
  br i1 %279, label %block_406bfd, label %block_.L_406c38
...
block_.L_406c02:                                  ; preds = %block_.L_406c02, %block_406bfd
  %282 = phi i64 [ %378, %block_.L_406c02 ], [ %281, %block_406bfd ]
  %283 = phi i64 [ %343, %block_.L_406c02 ], [ %244, %block_406bfd ]
  %284 = add i64 %283, -8
  %285 = add i64 %282, 4
  ...
  %call2_406c0f = tail call %struct.Memory* @sub_4014c0._Z18complete_hash_funcIdET_S0_(%struct.State* nonnull %0, i64 %298, %struct.Memory* %MEMORY.0)
  ...
  br i1 %367, label %block_406c33, label %block_.L_406c02
...
block_.L_406c38:                                  ; preds = %block_.L_406bf1, %block_406c33
  %380 = phi i64 [ %280, %block_.L_406bf1 ], [ %379, %block_406c33 ]
  %381 = phi i64 [ %244, %block_.L_406bf1 ], [ %343, %block_406c33 ]
  %382 = add i64 %381, -40
  %383 = add i64 %380, 5
  ...
  %call2_406c3d = tail call %struct.Memory* @sub_4014f0._Z9check_sumIdEvT_(%struct.State* nonnull %0, i64 %386, %struct.Memory* %MEMORY.0)
...
block_.L_406c50:                                  ; preds = %block_.L_406b8f
  ...
  %call2_406c50 = tail call %struct.Memory* @sub_400e30._Z5timerv(%struct.State* nonnull %0, i64 %423, %struct.Memory* %MEMORY.0)
  ...
  %call2_406c59 = tail call %struct.Memory* @sub_4007d0._Z13record_resultdPKc(%struct.State* nonnull %0, i64 %434, %struct.Memory* %call2_406c50)
