...
define %struct.Memory* @_Z26test_do_loop_unroll_factorILi7EiEvPKT0_iPKc(%struct.State* noalias, i64, %struct.Memory* noalias) #1 {
entry:
  ...
  store %struct.Memory* %loadMem_41159f, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem1_4115a3, %struct.Memory** %MEMORY
...
block_.L_4115af:                                  ; preds = %block_.L_411651, %entry
  ...
  store %struct.Memory* %loadMem_4115b2, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_4115b9, %struct.Memory** %MEMORY
...
block_4115bf:                                     ; preds = %block_.L_4115af
  ...
  store i32 0, i32* %236
  store %struct.Memory* %loadMem_4115c6, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_4115cd, %struct.Memory** %MEMORY
...
block_.L_4115e1:                                  ; preds = %block_.L_4115e1, %block_4115dc
  ...
  store %struct.Memory* %loadMem1_4115ec, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_4115fd, %struct.Memory** %MEMORY
...
block_.L_411621:                                  ; preds = %block_.L_411621, %block_41161c
  ...
  store %struct.Memory* %loadMem_41163d, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_411646, %struct.Memory** %MEMORY
...
block_41164c:                                     ; preds = %block_.L_411621
  ...
  store %struct.Memory* %loadMem_41164c, %struct.Memory** %MEMORY
  br label %block_.L_411651

block_.L_411651:                                  ; preds = %block_41164c, %block_.L_411610
  ...
  store %struct.Memory* %loadMem_411651, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem1_411654, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_411659, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_41165f, %struct.Memory** %MEMORY
...
block_.L_411667:                                  ; preds = %block_.L_4115af
  ...
  store %struct.Memory* %loadMem1_411667, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem1_411670, %struct.Memory** %MEMORY
  ...
  ret %struct.Memory* %loadMem_41167a
}
