...
declare %struct.Memory* @sub_40cab0._ZN15loop_inner_bodyILi7EiE7do_workERiPKii(%struct.State* noalias dereferenceable(3376), i64, %struct.Memory* noalias readnone returned) local_unnamed_addr
...
entry:
  ...
  %call2_411573 = tail call %struct.Memory* @sub_400dd0._Z11start_timerv(%struct.State* %0, i64 %58, %struct.Memory* %2)
...
block_.L_41157f:                                  ; preds = %block_.L_411621, %entry
  %68 = phi i64 [ %.pre, %entry ], [ %445, %block_.L_411621 ]
  %MEMORY.0 = phi %struct.Memory* [ %call2_411573, %entry ], [ %call2_411624, %block_.L_411621 ]
  ...
  br i1 %101, label %block_41158f, label %block_.L_411637

block_41158f:                                     ; preds = %block_.L_41157f
  %103 = add i64 %69, -32
  %104 = add i64 %102, 7
  ...
  br i1 %146, label %block_.L_4115e0, label %block_4115ac

block_4115ac:                                     ; preds = %block_41158f
  %148 = add i64 %147, 5
  store i64 %148, i64* %3, align 8
  br label %block_.L_4115b1

block_.L_4115b1:                                  ; preds = %block_.L_4115b1, %block_4115ac
  %149 = phi i64 [ %148, %block_4115ac ], [ %234, %block_.L_4115b1 ]
  %150 = phi i64 [ %111, %block_4115ac ], [ %195, %block_.L_4115b1 ]
  %MEMORY.1 = phi %struct.Memory* [ %MEMORY.0, %block_4115ac ], [ %call2_4115bc, %block_.L_4115b1 ]
  %151 = add i64 %150, -32
  ...
  %call2_4115bc = tail call %struct.Memory* @sub_40cab0._ZN15loop_inner_bodyILi7EiE7do_workERiPKii(%struct.State* %0, i64 %161, %struct.Memory* %MEMORY.1)
  ...
  br i1 %233, label %block_.L_4115b1, label %block_4115db

block_4115db:                                     ; preds = %block_.L_4115b1
  %235 = add i64 %234, 5
  store i64 %235, i64* %3, align 8
  br label %block_.L_4115e0

block_.L_4115e0:                                  ; preds = %block_4115db, %block_41158f
  %236 = phi i64 [ %147, %block_41158f ], [ %235, %block_4115db ]
  %237 = phi i64 [ %111, %block_41158f ], [ %195, %block_4115db ]
  %MEMORY.2 = phi %struct.Memory* [ %MEMORY.0, %block_41158f ], [ %call2_4115bc, %block_4115db ]
  %238 = add i64 %237, -36
  %239 = add i64 %236, 3
  ...
  br i1 %272, label %block_4115ec, label %block_.L_411621

block_4115ec:                                     ; preds = %block_.L_4115e0
  %274 = add i64 %273, 5
  store i64 %274, i64* %3, align 8
  br label %block_.L_4115f1

block_.L_4115f1:                                  ; preds = %block_.L_4115f1, %block_4115ec
  %275 = phi i64 [ %274, %block_4115ec ], [ %399, %block_.L_4115f1 ]
  %276 = phi i64 [ %237, %block_4115ec ], [ %364, %block_.L_4115f1 ]
  %MEMORY.3 = phi %struct.Memory* [ %MEMORY.2, %block_4115ec ], [ %call2_4115fc, %block_.L_4115f1 ]
  %277 = add i64 %276, -8
  %278 = add i64 %275, 4
  ...
  %call2_4115fc = tail call %struct.Memory* @sub_40c0d0._Z18complete_hash_funcIiET_S0_(%struct.State* %0, i64 %292, %struct.Memory* %MEMORY.3)
  ...
  br i1 %388, label %block_41161c, label %block_.L_4115f1

block_41161c:                                     ; preds = %block_.L_4115f1
  %400 = add i64 %399, 5
  store i64 %400, i64* %3, align 8
  br label %block_.L_411621

block_.L_411621:                                  ; preds = %block_.L_4115e0, %block_41161c
  %401 = phi i64 [ %273, %block_.L_4115e0 ], [ %400, %block_41161c ]
  %402 = phi i64 [ %237, %block_.L_4115e0 ], [ %364, %block_41161c ]
  %MEMORY.4 = phi %struct.Memory* [ %MEMORY.2, %block_.L_4115e0 ], [ %call2_4115fc, %block_41161c ]
  %403 = add i64 %402, -32
  %404 = add i64 %401, 3
  ...
  %call2_411624 = tail call %struct.Memory* @sub_40c100._Z9check_sumIiEvT_(%struct.State* %0, i64 %408, %struct.Memory* %MEMORY.4)
...
block_.L_411637:                                  ; preds = %block_.L_41157f
  %446 = add i64 %102, -67655
  %447 = add i64 %102, 5
  ...
  %call2_411637 = tail call %struct.Memory* @sub_400df0._Z5timerv(%struct.State* %0, i64 %446, %struct.Memory* %MEMORY.0)
  ...
  %call2_411640 = tail call %struct.Memory* @sub_400790._Z13record_resultdPKc(%struct.State* %0, i64 %457, %struct.Memory* %call2_411637)
  ...
  ret %struct.Memory* %call2_411640
}
...
define %struct.Memory* @routine_jge_.L_411637(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i8* %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
...
define %struct.Memory* @routine_jl_.L_4115e0(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i8* %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 2, i32 9
...
define %struct.Memory* @routine_jmpq_.L_4115b1(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
...
define %struct.Memory* @routine_callq_._ZN15loop_inner_bodyILi7EiE7do_workERiPKii(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
...
define %struct.Memory* @routine_addl__0x7___edx(%struct.State* dereferenceable(3376), i64, %struct.Memory*) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %RDX = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 7, i32 0, i32 0
...
define %struct.Memory* @routine_subl__0x6___ecx(%struct.State* dereferenceable(3376), i64, %struct.Memory*) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %RCX = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 5, i32 0, i32 0
...
define %struct.Memory* @routine_jl_.L_4115b1(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i8* %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 2, i32 9
...
define %struct.Memory* @routine_jmpq_.L_4115e0(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
...
define %struct.Memory* @routine_jge_.L_411621(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i8* %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 2, i32 9
...
define %struct.Memory* @routine_jmpq_.L_4115f1(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
...
define %struct.Memory* @routine_jne_.L_4115f1(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i8* %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
...
define %struct.Memory* @routine_jmpq_.L_411621(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
...
define %struct.Memory* @routine_jmpq_.L_41157f(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
