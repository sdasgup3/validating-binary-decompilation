...
block_.L_41157f:                                  ; preds = %block_.L_411621, %entry
  %68 = phi i64 [ %.pre, %entry ], [ %443, %block_.L_411621 ]
...
block_.L_4115f1:                                  ; preds = %block_.L_4115f1, %block_4115ec
  %275 = phi i64 [ %274, %block_4115ec ], [ %398, %block_.L_4115f1 ]
  %276 = phi i64 [ %237, %block_4115ec ], [ %363, %block_.L_4115f1 ]
  ...
  br i1 %387, label %block_41161c, label %block_.L_4115f1
...
block_.L_411621:                                  ; preds = %block_.L_4115e0, %block_41161c
  %400 = phi i64 [ %273, %block_.L_4115e0 ], [ %399, %block_41161c ]
  %401 = phi i64 [ %237, %block_.L_4115e0 ], [ %363, %block_41161c ]
  ...
  %call2_411624 = tail call %struct.Memory* @sub_40c100._Z9check_sumIiEvT_(%struct.State* %0, i64 %407, %struct.Memory* %MEMORY.4)
...
block_.L_411637:                                  ; preds = %block_.L_41157f
  ...
  %call2_411637 = tail call %struct.Memory* @sub_400df0._Z5timerv(%struct.State* %0, i64 %444, %struct.Memory* %MEMORY.0)
  ...
  %call2_411640 = tail call %struct.Memory* @sub_400790._Z13record_resultdPKc(%struct.State* %0, i64 %455, %struct.Memory* %call2_411637)
