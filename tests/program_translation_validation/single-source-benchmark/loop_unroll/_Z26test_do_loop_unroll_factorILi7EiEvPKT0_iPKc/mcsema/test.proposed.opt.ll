...
declare %struct.Memory* @sub_40cae0._ZN15loop_inner_bodyILi7EiE7do_workERiPKii(%struct.State* noalias dereferenceable(3376), i64, %struct.Memory* noalias readnone returned) local_unnamed_addr
...
declare %struct.Memory* @sub_40c130._Z9check_sumIiEvT_(%struct.State* noalias dereferenceable(3376), i64, %struct.Memory* noalias readnone returned) local_unnamed_addr
...
define %struct.Memory* @_Z26test_do_loop_unroll_factorILi7EiEvPKT0_iPKc(%struct.State* noalias, i64, %struct.Memory* noalias readnone) local_unnamed_addr #1 {
entry:
...
block_.L_4115e1:                                  ; preds = %block_.L_4115e1, %block_4115dc
  %149 = phi i64 [ %234, %block_.L_4115e1 ], [ %148, %block_4115dc ]
  %150 = phi i64 [ %195, %block_.L_4115e1 ], [ %111, %block_4115dc ]
  %151 = add i64 %150, -32
  ...
  %call2_4115ec = tail call %struct.Memory* @sub_40cae0._ZN15loop_inner_bodyILi7EiE7do_workERiPKii(%struct.State* nonnull %0, i64 %161, %struct.Memory* %MEMORY.0)
...
block_.L_411610:                                  ; preds = %block_41160b, %block_4115bf
  %236 = phi i64 [ %235, %block_41160b ], [ %147, %block_4115bf ]
  %237 = phi i64 [ %195, %block_41160b ], [ %111, %block_4115bf ]
  %238 = add i64 %237, -36
  %239 = add i64 %236, 3
...
block_.L_411621:                                  ; preds = %block_.L_411621, %block_41161c
  %275 = phi i64 [ %398, %block_.L_411621 ], [ %274, %block_41161c ]
  %276 = phi i64 [ %363, %block_.L_411621 ], [ %237, %block_41161c ]
  %277 = add i64 %276, -8
  %278 = add i64 %275, 4
  ...
  %call2_41162c = tail call %struct.Memory* @sub_40c100._Z18complete_hash_funcIiET_S0_(%struct.State* nonnull %0, i64 %292, %struct.Memory* %MEMORY.0)
...
block_.L_411651:                                  ; preds = %block_.L_411610, %block_41164c
  ...
  %call2_411654 = tail call %struct.Memory* @sub_40c130._Z9check_sumIiEvT_(%struct.State* nonnull %0, i64 %407, %struct.Memory* %MEMORY.0)
