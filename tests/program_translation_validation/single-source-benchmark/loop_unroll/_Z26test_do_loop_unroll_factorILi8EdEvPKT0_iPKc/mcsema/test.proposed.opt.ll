...
block_.L_4069ff:                                  ; preds = %block_.L_406aa8, %entry
  %79 = phi i64 [ %.pre, %entry ], [ %427, %block_.L_406aa8 ]
...
block_.L_406a72:                                  ; preds = %block_.L_406a72, %block_406a6d
  %288 = phi i64 [ %287, %block_406a6d ], [ %383, %block_.L_406a72 ]
  %289 = phi i64 [ %250, %block_406a6d ], [ %348, %block_.L_406a72 ]
  ...
  %call2_406a7f = tail call %struct.Memory* @sub_401480._Z18complete_hash_funcIdET_S0_(%struct.State* %0, i64 %304, %struct.Memory* %MEMORY.3)
  ...
  br i1 %372, label %block_406aa3, label %block_.L_406a72
...
block_.L_406aa8:                                  ; preds = %block_.L_406a61, %block_406aa3
  %385 = phi i64 [ %286, %block_.L_406a61 ], [ %384, %block_406aa3 ]
  %386 = phi i64 [ %250, %block_.L_406a61 ], [ %348, %block_406aa3 ]
  ...
  %call2_406aad = tail call %struct.Memory* @sub_4014b0._Z9check_sumIdEvT_(%struct.State* %0, i64 %391, %struct.Memory* %MEMORY.4)
...
block_.L_406ac0:                                  ; preds = %block_.L_4069ff
  ...
  %call2_406ac0 = tail call %struct.Memory* @sub_400df0._Z5timerv(%struct.State* %0, i64 %428, %struct.Memory* %MEMORY.0)
  ...
  %call2_406ac9 = tail call %struct.Memory* @sub_400790._Z13record_resultdPKc(%struct.State* %0, i64 %439, %struct.Memory* %call2_406ac0)
