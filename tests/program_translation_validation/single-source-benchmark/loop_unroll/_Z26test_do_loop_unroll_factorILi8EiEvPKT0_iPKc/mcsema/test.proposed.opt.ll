...
entry:
  ...
  %call2_411473 = tail call %struct.Memory* @sub_400e10._Z11start_timerv(%struct.State* %0, i64 %58, %struct.Memory* %2)
...
block_.L_41147f:                                  ; preds = %block_.L_411521, %entry
  %68 = phi i64 [ %.pre, %entry ], [ %443, %block_.L_411521 ]
  %MEMORY.0 = phi %struct.Memory* [ %call2_411473, %entry ], [ %call2_411524, %block_.L_411521 ]
  ...
  br i1 %101, label %block_41148f, label %block_.L_411537

block_41148f:                                     ; preds = %block_.L_41147f
  %103 = add i64 %69, -32
  %104 = add i64 %102, 7
  ...
  br i1 %146, label %block_.L_4114e0, label %block_4114ac

block_4114ac:                                     ; preds = %block_41148f
  %148 = add i64 %147, 5
  store i64 %148, i64* %3, align 8
  br label %block_.L_4114b1

block_.L_4114b1:                                  ; preds = %block_.L_4114b1, %block_4114ac
  %149 = phi i64 [ %234, %block_.L_4114b1 ], [ %148, %block_4114ac ]
  %150 = phi i64 [ %195, %block_.L_4114b1 ], [ %111, %block_4114ac ]
  %151 = add i64 %150, -32
  ...
  %call2_4114bc = tail call %struct.Memory* @sub_40ca90._ZN15loop_inner_bodyILi8EiE7do_workERiPKii(%struct.State* nonnull %0, i64 %161, %struct.Memory* %MEMORY.0)
  ...
  br i1 %233, label %block_.L_4114b1, label %block_4114db

block_4114db:                                     ; preds = %block_.L_4114b1
  %235 = add i64 %234, 5
  store i64 %235, i64* %3, align 8
  br label %block_.L_4114e0

block_.L_4114e0:                                  ; preds = %block_4114db, %block_41148f
  %236 = phi i64 [ %235, %block_4114db ], [ %147, %block_41148f ]
  %237 = phi i64 [ %195, %block_4114db ], [ %111, %block_41148f ]
  %238 = add i64 %237, -36
  %239 = add i64 %236, 3
  ...
  br i1 %272, label %block_4114ec, label %block_.L_411521

block_4114ec:                                     ; preds = %block_.L_4114e0
  %274 = add i64 %273, 5
  store i64 %274, i64* %3, align 8
  br label %block_.L_4114f1

block_.L_4114f1:                                  ; preds = %block_.L_4114f1, %block_4114ec
  %275 = phi i64 [ %398, %block_.L_4114f1 ], [ %274, %block_4114ec ]
  %276 = phi i64 [ %363, %block_.L_4114f1 ], [ %237, %block_4114ec ]
  %277 = add i64 %276, -8
  %278 = add i64 %275, 4
  ...
  %call2_4114fc = tail call %struct.Memory* @sub_40c110._Z18complete_hash_funcIiET_S0_(%struct.State* nonnull %0, i64 %292, %struct.Memory* %MEMORY.0)
  ...
  br i1 %387, label %block_41151c, label %block_.L_4114f1

block_41151c:                                     ; preds = %block_.L_4114f1
  %399 = add i64 %398, 5
  store i64 %399, i64* %3, align 8
  br label %block_.L_411521

block_.L_411521:                                  ; preds = %block_.L_4114e0, %block_41151c
  %400 = phi i64 [ %273, %block_.L_4114e0 ], [ %399, %block_41151c ]
  %401 = phi i64 [ %237, %block_.L_4114e0 ], [ %363, %block_41151c ]
  %402 = add i64 %401, -32
  %403 = add i64 %400, 3
  ...
  %call2_411524 = tail call %struct.Memory* @sub_40c140._Z9check_sumIiEvT_(%struct.State* nonnull %0, i64 %407, %struct.Memory* %MEMORY.0)
...
block_.L_411537:                                  ; preds = %block_.L_41147f
  ...
  %call2_411537 = tail call %struct.Memory* @sub_400e30._Z5timerv(%struct.State* nonnull %0, i64 %444, %struct.Memory* %MEMORY.0)
  ...
  %call2_411540 = tail call %struct.Memory* @sub_4007d0._Z13record_resultdPKc(%struct.State* nonnull %0, i64 %455, %struct.Memory* %call2_411537)
  ...
  ret %struct.Memory* %call2_411540
}
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_jge_.L_411537(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i8* nocapture %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_jl_.L_4114e0(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i8* nocapture %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 2, i32 9
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_jmpq_.L_4114b1(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_jl_.L_4114b1(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i8* nocapture %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 2, i32 9
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_jmpq_.L_4114e0(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_jge_.L_411521(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i8* nocapture %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 2, i32 9
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_jmpq_.L_4114f1(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_jne_.L_4114f1(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i8* nocapture %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_jmpq_.L_411521(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_jmpq_.L_41147f(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
