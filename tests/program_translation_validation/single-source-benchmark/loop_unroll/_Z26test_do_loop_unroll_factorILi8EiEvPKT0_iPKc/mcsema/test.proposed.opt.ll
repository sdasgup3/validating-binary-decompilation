...
define %struct.Memory* @_Z26test_do_loop_unroll_factorILi8EiEvPKT0_iPKc(%struct.State* noalias, i64, %struct.Memory* noalias readnone) local_unnamed_addr #1 {
entry:
...
block_.L_4114a1:                                  ; preds = %block_.L_4114a1, %block_41149c
  %149 = phi i64 [ %234, %block_.L_4114a1 ], [ %148, %block_41149c ]
  %150 = phi i64 [ %195, %block_.L_4114a1 ], [ %111, %block_41149c ]
  %151 = add i64 %150, -32
  ...
  %call2_4114ac = tail call %struct.Memory* @sub_40ca80._ZN15loop_inner_bodyILi8EiE7do_workERiPKii(%struct.State* nonnull %0, i64 %161, %struct.Memory* %MEMORY.0)
...
block_.L_4114d0:                                  ; preds = %block_4114cb, %block_41147f
  %236 = phi i64 [ %235, %block_4114cb ], [ %147, %block_41147f ]
  %237 = phi i64 [ %195, %block_4114cb ], [ %111, %block_41147f ]
  %238 = add i64 %237, -36
  %239 = add i64 %236, 3
...
block_.L_4114e1:                                  ; preds = %block_.L_4114e1, %block_4114dc
  %275 = phi i64 [ %398, %block_.L_4114e1 ], [ %274, %block_4114dc ]
  %276 = phi i64 [ %363, %block_.L_4114e1 ], [ %237, %block_4114dc ]
  %277 = add i64 %276, -8
  %278 = add i64 %275, 4
  ...
  %call2_4114ec = tail call %struct.Memory* @sub_40c100._Z18complete_hash_funcIiET_S0_(%struct.State* nonnull %0, i64 %292, %struct.Memory* %MEMORY.0)
...
block_.L_411511:                                  ; preds = %block_.L_4114d0, %block_41150c
  ...
  %call2_411514 = tail call %struct.Memory* @sub_40c130._Z9check_sumIiEvT_(%struct.State* nonnull %0, i64 %407, %struct.Memory* %MEMORY.0)
