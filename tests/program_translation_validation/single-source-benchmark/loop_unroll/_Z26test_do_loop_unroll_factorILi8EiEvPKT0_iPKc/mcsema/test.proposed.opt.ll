...
entry:
  ...
  %call2_411433 = tail call %struct.Memory* @sub_400dd0._Z11start_timerv(%struct.State* %0, i64 %58, %struct.Memory* %2)
...
block_.L_41143f:                                  ; preds = %block_.L_4114e1, %entry
  %68 = phi i64 [ %.pre, %entry ], [ %443, %block_.L_4114e1 ]
  %MEMORY.0 = phi %struct.Memory* [ %call2_411433, %entry ], [ %call2_4114e4, %block_.L_4114e1 ]
  ...
  br i1 %101, label %block_41144f, label %block_.L_4114f7

block_41144f:                                     ; preds = %block_.L_41143f
  %103 = add i64 %69, -32
  %104 = add i64 %102, 7
  ...
  br i1 %146, label %block_.L_4114a0, label %block_41146c

block_41146c:                                     ; preds = %block_41144f
  %148 = add i64 %147, 5
  store i64 %148, i64* %3, align 8
  br label %block_.L_411471

block_.L_411471:                                  ; preds = %block_.L_411471, %block_41146c
  %149 = phi i64 [ %148, %block_41146c ], [ %234, %block_.L_411471 ]
  %150 = phi i64 [ %111, %block_41146c ], [ %195, %block_.L_411471 ]
  %MEMORY.1 = phi %struct.Memory* [ %MEMORY.0, %block_41146c ], [ %call2_41147c, %block_.L_411471 ]
  %151 = add i64 %150, -32
  ...
  %call2_41147c = tail call %struct.Memory* @sub_40ca50._ZN15loop_inner_bodyILi8EiE7do_workERiPKii(%struct.State* %0, i64 %161, %struct.Memory* %MEMORY.1)
  ...
  br i1 %233, label %block_.L_411471, label %block_41149b

block_41149b:                                     ; preds = %block_.L_411471
  %235 = add i64 %234, 5
  store i64 %235, i64* %3, align 8
  br label %block_.L_4114a0

block_.L_4114a0:                                  ; preds = %block_41149b, %block_41144f
  %236 = phi i64 [ %147, %block_41144f ], [ %235, %block_41149b ]
  %237 = phi i64 [ %111, %block_41144f ], [ %195, %block_41149b ]
  %MEMORY.2 = phi %struct.Memory* [ %MEMORY.0, %block_41144f ], [ %call2_41147c, %block_41149b ]
  %238 = add i64 %237, -36
  %239 = add i64 %236, 3
  ...
  br i1 %272, label %block_4114ac, label %block_.L_4114e1

block_4114ac:                                     ; preds = %block_.L_4114a0
  %274 = add i64 %273, 5
  store i64 %274, i64* %3, align 8
  br label %block_.L_4114b1

block_.L_4114b1:                                  ; preds = %block_.L_4114b1, %block_4114ac
  %275 = phi i64 [ %274, %block_4114ac ], [ %398, %block_.L_4114b1 ]
  %276 = phi i64 [ %237, %block_4114ac ], [ %363, %block_.L_4114b1 ]
  %MEMORY.3 = phi %struct.Memory* [ %MEMORY.2, %block_4114ac ], [ %call2_4114bc, %block_.L_4114b1 ]
  %277 = add i64 %276, -8
  %278 = add i64 %275, 4
  ...
  %call2_4114bc = tail call %struct.Memory* @sub_40c0d0._Z18complete_hash_funcIiET_S0_(%struct.State* %0, i64 %292, %struct.Memory* %MEMORY.3)
  ...
  br i1 %387, label %block_4114dc, label %block_.L_4114b1

block_4114dc:                                     ; preds = %block_.L_4114b1
  %399 = add i64 %398, 5
  store i64 %399, i64* %3, align 8
  br label %block_.L_4114e1

block_.L_4114e1:                                  ; preds = %block_.L_4114a0, %block_4114dc
  %400 = phi i64 [ %273, %block_.L_4114a0 ], [ %399, %block_4114dc ]
  %401 = phi i64 [ %237, %block_.L_4114a0 ], [ %363, %block_4114dc ]
  %MEMORY.4 = phi %struct.Memory* [ %MEMORY.2, %block_.L_4114a0 ], [ %call2_4114bc, %block_4114dc ]
  %402 = add i64 %401, -32
  %403 = add i64 %400, 3
  ...
  %call2_4114e4 = tail call %struct.Memory* @sub_40c100._Z9check_sumIiEvT_(%struct.State* %0, i64 %407, %struct.Memory* %MEMORY.4)
...
block_.L_4114f7:                                  ; preds = %block_.L_41143f
  ...
  %call2_4114f7 = tail call %struct.Memory* @sub_400df0._Z5timerv(%struct.State* %0, i64 %444, %struct.Memory* %MEMORY.0)
  ...
  %call2_411500 = tail call %struct.Memory* @sub_400790._Z13record_resultdPKc(%struct.State* %0, i64 %455, %struct.Memory* %call2_4114f7)
  ...
  ret %struct.Memory* %call2_411500
}
...
define %struct.Memory* @routine_jge_.L_4114f7(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i8* %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
...
define %struct.Memory* @routine_jl_.L_4114a0(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i8* %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 2, i32 9
...
define %struct.Memory* @routine_jmpq_.L_411471(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
...
define %struct.Memory* @routine_jl_.L_411471(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i8* %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 2, i32 9
...
define %struct.Memory* @routine_jmpq_.L_4114a0(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
...
define %struct.Memory* @routine_jge_.L_4114e1(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i8* %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 2, i32 9
...
define %struct.Memory* @routine_jmpq_.L_4114b1(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
...
define %struct.Memory* @routine_jne_.L_4114b1(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i8* %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
...
define %struct.Memory* @routine_jmpq_.L_4114e1(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
...
define %struct.Memory* @routine_jmpq_.L_41143f(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
