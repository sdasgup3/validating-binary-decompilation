...
entry:
  ...
  %call2_4068e3 = tail call %struct.Memory* @sub_400e10._Z11start_timerv(%struct.State* %0, i64 %58, %struct.Memory* %2)
...
block_.L_4068ef:                                  ; preds = %block_.L_406998, %entry
  %74 = phi i64 [ %.pre, %entry ], [ %422, %block_.L_406998 ]
  %MEMORY.0 = phi %struct.Memory* [ %call2_4068e3, %entry ], [ %call2_40699d, %block_.L_406998 ]
  ...
  br i1 %107, label %block_4068ff, label %block_.L_4069b0
...
block_4068ff:                                     ; preds = %block_.L_4068ef
  ...
  br i1 %153, label %block_.L_406951, label %block_40691d
...
block_.L_406922:                                  ; preds = %block_.L_406922, %block_40691d
  %156 = phi i64 [ %241, %block_.L_406922 ], [ %155, %block_40691d ]
  %157 = phi i64 [ %202, %block_.L_406922 ], [ %118, %block_40691d ]
  %158 = add i64 %157, -40
  ...
  %call2_40692d = tail call %struct.Memory* @sub_401e70._ZN15loop_inner_bodyILi9EdE7do_workERdPKdi(%struct.State* nonnull %0, i64 %168, %struct.Memory* %MEMORY.0)
  ...
  br i1 %240, label %block_.L_406922, label %block_40694c
...
block_.L_406951:                                  ; preds = %block_40694c, %block_4068ff
  %243 = phi i64 [ %242, %block_40694c ], [ %154, %block_4068ff ]
  %244 = phi i64 [ %202, %block_40694c ], [ %118, %block_4068ff ]
  %245 = add i64 %244, -44
  %246 = add i64 %243, 3
  ...
  br i1 %279, label %block_40695d, label %block_.L_406998
...
block_.L_406962:                                  ; preds = %block_.L_406962, %block_40695d
  %282 = phi i64 [ %378, %block_.L_406962 ], [ %281, %block_40695d ]
  %283 = phi i64 [ %343, %block_.L_406962 ], [ %244, %block_40695d ]
  %284 = add i64 %283, -8
  %285 = add i64 %282, 4
  ...
  %call2_40696f = tail call %struct.Memory* @sub_4014c0._Z18complete_hash_funcIdET_S0_(%struct.State* nonnull %0, i64 %298, %struct.Memory* %MEMORY.0)
  ...
  br i1 %367, label %block_406993, label %block_.L_406962
...
block_.L_406998:                                  ; preds = %block_.L_406951, %block_406993
  %380 = phi i64 [ %280, %block_.L_406951 ], [ %379, %block_406993 ]
  %381 = phi i64 [ %244, %block_.L_406951 ], [ %343, %block_406993 ]
  %382 = add i64 %381, -40
  %383 = add i64 %380, 5
  ...
  %call2_40699d = tail call %struct.Memory* @sub_4014f0._Z9check_sumIdEvT_(%struct.State* nonnull %0, i64 %386, %struct.Memory* %MEMORY.0)
...
block_.L_4069b0:                                  ; preds = %block_.L_4068ef
  ...
  %call2_4069b0 = tail call %struct.Memory* @sub_400e30._Z5timerv(%struct.State* nonnull %0, i64 %423, %struct.Memory* %MEMORY.0)
  ...
  %call2_4069b9 = tail call %struct.Memory* @sub_4007d0._Z13record_resultdPKc(%struct.State* nonnull %0, i64 %434, %struct.Memory* %call2_4069b0)
