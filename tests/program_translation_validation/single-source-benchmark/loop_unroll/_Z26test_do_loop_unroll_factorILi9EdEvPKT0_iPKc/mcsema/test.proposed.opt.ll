...
entry:
  ...
  %call2_4068d3 = tail call %struct.Memory* @sub_400e00._Z11start_timerv(%struct.State* %0, i64 %58, %struct.Memory* %2)
...
block_.L_4068df:                                  ; preds = %block_.L_406988, %entry
  %74 = phi i64 [ %.pre, %entry ], [ %422, %block_.L_406988 ]
  %MEMORY.0 = phi %struct.Memory* [ %call2_4068d3, %entry ], [ %call2_40698d, %block_.L_406988 ]
  ...
  br i1 %107, label %block_4068ef, label %block_.L_4069a0
...
block_4068ef:                                     ; preds = %block_.L_4068df
  ...
  br i1 %153, label %block_.L_406941, label %block_40690d
...
block_.L_406912:                                  ; preds = %block_.L_406912, %block_40690d
  %156 = phi i64 [ %155, %block_40690d ], [ %241, %block_.L_406912 ]
  %157 = phi i64 [ %118, %block_40690d ], [ %202, %block_.L_406912 ]
  %MEMORY.1 = phi %struct.Memory* [ %MEMORY.0, %block_40690d ], [ %call2_40691d, %block_.L_406912 ]
  %158 = add i64 %157, -40
  ...
  %call2_40691d = tail call %struct.Memory* @sub_401e60._ZN15loop_inner_bodyILi9EdE7do_workERdPKdi(%struct.State* nonnull %0, i64 %168, %struct.Memory* %MEMORY.1)
  ...
  br i1 %240, label %block_.L_406912, label %block_40693c
...
block_.L_406941:                                  ; preds = %block_40693c, %block_4068ef
  %243 = phi i64 [ %154, %block_4068ef ], [ %242, %block_40693c ]
  %244 = phi i64 [ %118, %block_4068ef ], [ %202, %block_40693c ]
  %MEMORY.2 = phi %struct.Memory* [ %MEMORY.0, %block_4068ef ], [ %call2_40691d, %block_40693c ]
  %245 = add i64 %244, -44
  %246 = add i64 %243, 3
  ...
  br i1 %279, label %block_40694d, label %block_.L_406988
...
block_.L_406952:                                  ; preds = %block_.L_406952, %block_40694d
  %282 = phi i64 [ %281, %block_40694d ], [ %378, %block_.L_406952 ]
  %283 = phi i64 [ %244, %block_40694d ], [ %343, %block_.L_406952 ]
  %MEMORY.3 = phi %struct.Memory* [ %MEMORY.2, %block_40694d ], [ %call2_40695f, %block_.L_406952 ]
  %284 = add i64 %283, -8
  %285 = add i64 %282, 4
  ...
  %call2_40695f = tail call %struct.Memory* @sub_4014b0._Z18complete_hash_funcIdET_S0_(%struct.State* nonnull %0, i64 %298, %struct.Memory* %MEMORY.3)
  ...
  br i1 %367, label %block_406983, label %block_.L_406952
...
block_.L_406988:                                  ; preds = %block_.L_406941, %block_406983
  %380 = phi i64 [ %280, %block_.L_406941 ], [ %379, %block_406983 ]
  %381 = phi i64 [ %244, %block_.L_406941 ], [ %343, %block_406983 ]
  %MEMORY.4 = phi %struct.Memory* [ %MEMORY.2, %block_.L_406941 ], [ %call2_40695f, %block_406983 ]
  %382 = add i64 %381, -40
  %383 = add i64 %380, 5
  ...
  %call2_40698d = tail call %struct.Memory* @sub_4014e0._Z9check_sumIdEvT_(%struct.State* nonnull %0, i64 %386, %struct.Memory* %MEMORY.4)
...
block_.L_4069a0:                                  ; preds = %block_.L_4068df
  ...
  %call2_4069a0 = tail call %struct.Memory* @sub_400e20._Z5timerv(%struct.State* nonnull %0, i64 %423, %struct.Memory* %MEMORY.0)
  ...
  %call2_4069a9 = tail call %struct.Memory* @sub_4007c0._Z13record_resultdPKc(%struct.State* nonnull %0, i64 %434, %struct.Memory* %call2_4069a0)
  ...
  ret %struct.Memory* %call2_4069a9
}
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_jge_.L_4069a0(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i8* nocapture %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_jl_.L_406941(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i8* nocapture %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 2, i32 9
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_jmpq_.L_406912(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_jl_.L_406912(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i8* nocapture %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 2, i32 9
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_jmpq_.L_406941(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_jge_.L_406988(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i8* nocapture %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 2, i32 9
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_jne_.L_406952(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i8* nocapture %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_jmpq_.L_406988(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
