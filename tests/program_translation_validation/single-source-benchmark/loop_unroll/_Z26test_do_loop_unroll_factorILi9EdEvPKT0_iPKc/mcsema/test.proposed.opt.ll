...
define %struct.Memory* @_Z26test_do_loop_unroll_factorILi9EdEvPKT0_iPKc(%struct.State* noalias, i64, %struct.Memory* noalias) local_unnamed_addr #1 {
entry:
  ...
  %call2_4068a3 = tail call %struct.Memory* @sub_400dd0._Z11start_timerv(%struct.State* %0, i64 %58, %struct.Memory* %2)
...
block_.L_4068af:                                  ; preds = %block_.L_406958, %entry
  %79 = phi i64 [ %.pre, %entry ], [ %431, %block_.L_406958 ]
  %MEMORY.0 = phi %struct.Memory* [ %call2_4068a3, %entry ], [ %call2_40695d, %block_.L_406958 ]
  ...
  br i1 %112, label %block_4068bf, label %block_.L_406970
...
block_4068bf:                                     ; preds = %block_.L_4068af
  ...
  br i1 %159, label %block_.L_406911, label %block_4068dd
...
block_.L_4068e2:                                  ; preds = %block_.L_4068e2, %block_4068dd
  %162 = phi i64 [ %161, %block_4068dd ], [ %247, %block_.L_4068e2 ]
  %163 = phi i64 [ %124, %block_4068dd ], [ %208, %block_.L_4068e2 ]
  %MEMORY.1 = phi %struct.Memory* [ %MEMORY.0, %block_4068dd ], [ %call2_4068ed, %block_.L_4068e2 ]
  %164 = add i64 %163, -40
  ...
  %call2_4068ed = tail call %struct.Memory* @sub_401e30._ZN15loop_inner_bodyILi9EdE7do_workERdPKdi(%struct.State* %0, i64 %174, %struct.Memory* %MEMORY.1)
  ...
  br i1 %246, label %block_.L_4068e2, label %block_40690c
...
block_.L_406911:                                  ; preds = %block_40690c, %block_4068bf
  %249 = phi i64 [ %160, %block_4068bf ], [ %248, %block_40690c ]
  %250 = phi i64 [ %124, %block_4068bf ], [ %208, %block_40690c ]
  %MEMORY.2 = phi %struct.Memory* [ %MEMORY.0, %block_4068bf ], [ %call2_4068ed, %block_40690c ]
  %251 = add i64 %250, -44
  %252 = add i64 %249, 3
  ...
  br i1 %285, label %block_40691d, label %block_.L_406958
...
block_.L_406922:                                  ; preds = %block_.L_406922, %block_40691d
  %288 = phi i64 [ %287, %block_40691d ], [ %385, %block_.L_406922 ]
  %289 = phi i64 [ %250, %block_40691d ], [ %350, %block_.L_406922 ]
  %MEMORY.3 = phi %struct.Memory* [ %MEMORY.2, %block_40691d ], [ %call2_40692f, %block_.L_406922 ]
  %290 = add i64 %289, -8
  %291 = add i64 %288, 4
  ...
  %call2_40692f = tail call %struct.Memory* @sub_401480._Z18complete_hash_funcIdET_S0_(%struct.State* %0, i64 %305, %struct.Memory* %MEMORY.3)
  ...
  br i1 %374, label %block_406953, label %block_.L_406922
...
block_.L_406958:                                  ; preds = %block_.L_406911, %block_406953
  %387 = phi i64 [ %286, %block_.L_406911 ], [ %386, %block_406953 ]
  %388 = phi i64 [ %250, %block_.L_406911 ], [ %350, %block_406953 ]
  %MEMORY.4 = phi %struct.Memory* [ %MEMORY.2, %block_.L_406911 ], [ %call2_40692f, %block_406953 ]
  %389 = add i64 %388, -40
  %390 = add i64 %387, 5
  ...
  %call2_40695d = tail call %struct.Memory* @sub_4014b0._Z9check_sumIdEvT_(%struct.State* %0, i64 %394, %struct.Memory* %MEMORY.4)
...
block_.L_406970:                                  ; preds = %block_.L_4068af
  ...
  %call2_406970 = tail call %struct.Memory* @sub_400df0._Z5timerv(%struct.State* %0, i64 %432, %struct.Memory* %MEMORY.0)
  ...
  %call2_406979 = tail call %struct.Memory* @sub_400790._Z13record_resultdPKc(%struct.State* %0, i64 %443, %struct.Memory* %call2_406970)
  ...
  ret %struct.Memory* %call2_406979
}
...
define %struct.Memory* @routine_jge_.L_406970(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i8* %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
...
define %struct.Memory* @routine_jl_.L_406911(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i8* %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 2, i32 9
...
define %struct.Memory* @routine_jmpq_.L_4068e2(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
...
define %struct.Memory* @routine_subl__0x8___ecx(%struct.State* dereferenceable(3376), i64, %struct.Memory*) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %RCX = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 5, i32 0, i32 0
...
define %struct.Memory* @routine_jl_.L_4068e2(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i8* %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 2, i32 9
...
define %struct.Memory* @routine_jmpq_.L_406911(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
...
define %struct.Memory* @routine_jge_.L_406958(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i8* %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 2, i32 9
...
define %struct.Memory* @routine_jmpq_.L_406922(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
...
define %struct.Memory* @routine_jne_.L_406922(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i8* %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
...
define %struct.Memory* @routine_jmpq_.L_406958(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
...
define %struct.Memory* @routine_jmpq_.L_4068af(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
