...
block_.L_4068af:                                  ; preds = %block_.L_406958, %entry
  %79 = phi i64 [ %.pre, %entry ], [ %427, %block_.L_406958 ]
...
block_.L_406922:                                  ; preds = %block_.L_406922, %block_40691d
  %288 = phi i64 [ %287, %block_40691d ], [ %383, %block_.L_406922 ]
  %289 = phi i64 [ %250, %block_40691d ], [ %348, %block_.L_406922 ]
  ...
  %call2_40692f = tail call %struct.Memory* @sub_401480._Z18complete_hash_funcIdET_S0_(%struct.State* %0, i64 %304, %struct.Memory* %MEMORY.3)
  ...
  br i1 %372, label %block_406953, label %block_.L_406922
...
block_.L_406958:                                  ; preds = %block_.L_406911, %block_406953
  %385 = phi i64 [ %286, %block_.L_406911 ], [ %384, %block_406953 ]
  %386 = phi i64 [ %250, %block_.L_406911 ], [ %348, %block_406953 ]
  ...
  %call2_40695d = tail call %struct.Memory* @sub_4014b0._Z9check_sumIdEvT_(%struct.State* %0, i64 %391, %struct.Memory* %MEMORY.4)
...
block_.L_406970:                                  ; preds = %block_.L_4068af
  ...
  %call2_406970 = tail call %struct.Memory* @sub_400df0._Z5timerv(%struct.State* %0, i64 %428, %struct.Memory* %MEMORY.0)
  ...
  %call2_406979 = tail call %struct.Memory* @sub_400790._Z13record_resultdPKc(%struct.State* %0, i64 %439, %struct.Memory* %call2_406970)
