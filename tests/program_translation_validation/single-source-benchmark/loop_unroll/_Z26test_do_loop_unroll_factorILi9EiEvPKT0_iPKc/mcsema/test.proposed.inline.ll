...
define %struct.Memory* @_Z26test_do_loop_unroll_factorILi9EiEvPKT0_iPKc(%struct.State* noalias, i64, %struct.Memory* noalias) #1 {
entry:
  ...
  store %struct.Memory* %loadMem_411311, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_411314, %struct.Memory** %MEMORY
  ...
  store i64 %78, i64* %81
  store %struct.Memory* %loadMem_411318, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_41131f, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem1_411323, %struct.Memory** %MEMORY
...
block_.L_41132f:                                  ; preds = %block_.L_4113d1, %entry
...
block_41133f:                                     ; preds = %block_.L_41132f
  ...
  store i32 0, i32* %236
  store %struct.Memory* %loadMem_411346, %struct.Memory** %MEMORY
...
block_41135c:                                     ; preds = %block_41133f
  ...
  store %struct.Memory* %loadMem_41135c, %struct.Memory** %MEMORY
  br label %block_.L_411361

block_.L_411361:                                  ; preds = %block_.L_411361, %block_41135c
  ...
  store %struct.Memory* %loadMem_411361, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_411369, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem1_41136c, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_411377, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_41137d, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_411385, %struct.Memory** %MEMORY
...
block_41138b:                                     ; preds = %block_.L_411361
...
block_.L_411390:                                  ; preds = %block_41138b, %block_41133f
...
block_41139c:                                     ; preds = %block_.L_411390
...
block_.L_4113a1:                                  ; preds = %block_.L_4113a1, %block_41139c
  ...
  store %struct.Memory* %loadMem1_4113ac, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_4113b7, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_4113ba, %struct.Memory** %MEMORY
...
block_4113cc:                                     ; preds = %block_.L_4113a1
...
block_.L_4113d1:                                  ; preds = %block_4113cc, %block_.L_411390
  ...
  store %struct.Memory* %loadMem1_4113d4, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_4113d9, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_4113df, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_4113e2, %struct.Memory** %MEMORY
  br label %block_.L_41132f

block_.L_4113e7:                                  ; preds = %block_.L_41132f
  ...
  store %struct.Memory* %loadMem1_4113e7, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem1_4113f0, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_4113f9, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_4113fa, %struct.Memory** %MEMORY
  ret %struct.Memory* %loadMem_4113fa
}
