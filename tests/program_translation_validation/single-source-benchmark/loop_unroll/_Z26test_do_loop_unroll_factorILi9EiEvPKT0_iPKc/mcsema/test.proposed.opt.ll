...
entry:
  ...
  %call2_4112f3 = tail call %struct.Memory* @sub_400dd0._Z11start_timerv(%struct.State* %0, i64 %58, %struct.Memory* %2)
...
block_.L_4112ff:                                  ; preds = %block_.L_4113a1, %entry
  %68 = phi i64 [ %.pre, %entry ], [ %445, %block_.L_4113a1 ]
  %MEMORY.0 = phi %struct.Memory* [ %call2_4112f3, %entry ], [ %call2_4113a4, %block_.L_4113a1 ]
  ...
  br i1 %101, label %block_41130f, label %block_.L_4113b7
...
block_41130f:                                     ; preds = %block_.L_4112ff
  ...
  br i1 %146, label %block_.L_411360, label %block_41132c
...
block_.L_411331:                                  ; preds = %block_.L_411331, %block_41132c
  %149 = phi i64 [ %148, %block_41132c ], [ %234, %block_.L_411331 ]
  %150 = phi i64 [ %111, %block_41132c ], [ %195, %block_.L_411331 ]
  %MEMORY.1 = phi %struct.Memory* [ %MEMORY.0, %block_41132c ], [ %call2_41133c, %block_.L_411331 ]
  %151 = add i64 %150, -32
  ...
  %call2_41133c = tail call %struct.Memory* @sub_40c9f0._ZN15loop_inner_bodyILi9EiE7do_workERiPKii(%struct.State* %0, i64 %161, %struct.Memory* %MEMORY.1)
  ...
  br i1 %233, label %block_.L_411331, label %block_41135b
...
block_.L_411360:                                  ; preds = %block_41135b, %block_41130f
  %236 = phi i64 [ %147, %block_41130f ], [ %235, %block_41135b ]
  %237 = phi i64 [ %111, %block_41130f ], [ %195, %block_41135b ]
  %MEMORY.2 = phi %struct.Memory* [ %MEMORY.0, %block_41130f ], [ %call2_41133c, %block_41135b ]
  %238 = add i64 %237, -36
  %239 = add i64 %236, 3
  ...
  br i1 %272, label %block_41136c, label %block_.L_4113a1
...
block_.L_411371:                                  ; preds = %block_.L_411371, %block_41136c
  %275 = phi i64 [ %274, %block_41136c ], [ %399, %block_.L_411371 ]
  %276 = phi i64 [ %237, %block_41136c ], [ %364, %block_.L_411371 ]
  %MEMORY.3 = phi %struct.Memory* [ %MEMORY.2, %block_41136c ], [ %call2_41137c, %block_.L_411371 ]
  %277 = add i64 %276, -8
  %278 = add i64 %275, 4
  ...
  %call2_41137c = tail call %struct.Memory* @sub_40c0d0._Z18complete_hash_funcIiET_S0_(%struct.State* %0, i64 %292, %struct.Memory* %MEMORY.3)
  ...
  br i1 %388, label %block_41139c, label %block_.L_411371
...
block_.L_4113a1:                                  ; preds = %block_.L_411360, %block_41139c
  %401 = phi i64 [ %273, %block_.L_411360 ], [ %400, %block_41139c ]
  %402 = phi i64 [ %237, %block_.L_411360 ], [ %364, %block_41139c ]
  %MEMORY.4 = phi %struct.Memory* [ %MEMORY.2, %block_.L_411360 ], [ %call2_41137c, %block_41139c ]
  %403 = add i64 %402, -32
  %404 = add i64 %401, 3
  ...
  %call2_4113a4 = tail call %struct.Memory* @sub_40c100._Z9check_sumIiEvT_(%struct.State* %0, i64 %408, %struct.Memory* %MEMORY.4)
...
block_.L_4113b7:                                  ; preds = %block_.L_4112ff
  ...
  %call2_4113b7 = tail call %struct.Memory* @sub_400df0._Z5timerv(%struct.State* %0, i64 %446, %struct.Memory* %MEMORY.0)
  ...
  %call2_4113c0 = tail call %struct.Memory* @sub_400790._Z13record_resultdPKc(%struct.State* %0, i64 %457, %struct.Memory* %call2_4113b7)
  ...
  ret %struct.Memory* %call2_4113c0
}
...
define %struct.Memory* @routine_jge_.L_4113b7(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i8* %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
...
define %struct.Memory* @routine_jl_.L_411360(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i8* %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 2, i32 9
...
define %struct.Memory* @routine_jmpq_.L_411331(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
...
define %struct.Memory* @routine_jl_.L_411331(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i8* %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 2, i32 9
...
define %struct.Memory* @routine_jmpq_.L_411360(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
...
define %struct.Memory* @routine_jge_.L_4113a1(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i8* %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 2, i32 9
...
define %struct.Memory* @routine_jmpq_.L_411371(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
...
define %struct.Memory* @routine_jne_.L_411371(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i8* %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
...
define %struct.Memory* @routine_jmpq_.L_4113a1(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
...
define %struct.Memory* @routine_jmpq_.L_4112ff(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
