...
entry:
  ...
  %call2_411333 = tail call %struct.Memory* @sub_400e10._Z11start_timerv(%struct.State* %0, i64 %58, %struct.Memory* %2)
...
block_.L_41133f:                                  ; preds = %block_.L_4113e1, %entry
  %68 = phi i64 [ %.pre, %entry ], [ %443, %block_.L_4113e1 ]
  %MEMORY.0 = phi %struct.Memory* [ %call2_411333, %entry ], [ %call2_4113e4, %block_.L_4113e1 ]
  ...
  br i1 %101, label %block_41134f, label %block_.L_4113f7
...
block_41134f:                                     ; preds = %block_.L_41133f
  ...
  br i1 %146, label %block_.L_4113a0, label %block_41136c
...
block_.L_411371:                                  ; preds = %block_.L_411371, %block_41136c
  %149 = phi i64 [ %234, %block_.L_411371 ], [ %148, %block_41136c ]
  %150 = phi i64 [ %195, %block_.L_411371 ], [ %111, %block_41136c ]
  %151 = add i64 %150, -32
  ...
  %call2_41137c = tail call %struct.Memory* @sub_40ca30._ZN15loop_inner_bodyILi9EiE7do_workERiPKii(%struct.State* nonnull %0, i64 %161, %struct.Memory* %MEMORY.0)
  ...
  br i1 %233, label %block_.L_411371, label %block_41139b
...
block_.L_4113a0:                                  ; preds = %block_41139b, %block_41134f
  %236 = phi i64 [ %235, %block_41139b ], [ %147, %block_41134f ]
  %237 = phi i64 [ %195, %block_41139b ], [ %111, %block_41134f ]
  %238 = add i64 %237, -36
  %239 = add i64 %236, 3
  ...
  br i1 %272, label %block_4113ac, label %block_.L_4113e1
...
block_.L_4113b1:                                  ; preds = %block_.L_4113b1, %block_4113ac
  %275 = phi i64 [ %398, %block_.L_4113b1 ], [ %274, %block_4113ac ]
  %276 = phi i64 [ %363, %block_.L_4113b1 ], [ %237, %block_4113ac ]
  %277 = add i64 %276, -8
  %278 = add i64 %275, 4
  ...
  %call2_4113bc = tail call %struct.Memory* @sub_40c110._Z18complete_hash_funcIiET_S0_(%struct.State* nonnull %0, i64 %292, %struct.Memory* %MEMORY.0)
  ...
  br i1 %387, label %block_4113dc, label %block_.L_4113b1
...
block_.L_4113e1:                                  ; preds = %block_.L_4113a0, %block_4113dc
  %400 = phi i64 [ %273, %block_.L_4113a0 ], [ %399, %block_4113dc ]
  %401 = phi i64 [ %237, %block_.L_4113a0 ], [ %363, %block_4113dc ]
  %402 = add i64 %401, -32
  %403 = add i64 %400, 3
  ...
  %call2_4113e4 = tail call %struct.Memory* @sub_40c140._Z9check_sumIiEvT_(%struct.State* nonnull %0, i64 %407, %struct.Memory* %MEMORY.0)
...
block_.L_4113f7:                                  ; preds = %block_.L_41133f
  ...
  %call2_4113f7 = tail call %struct.Memory* @sub_400e30._Z5timerv(%struct.State* nonnull %0, i64 %444, %struct.Memory* %MEMORY.0)
  ...
  %call2_411400 = tail call %struct.Memory* @sub_4007d0._Z13record_resultdPKc(%struct.State* nonnull %0, i64 %455, %struct.Memory* %call2_4113f7)
