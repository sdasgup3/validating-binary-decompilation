...
block_.L_4112ff:                                  ; preds = %block_.L_4113a1, %entry
  %68 = phi i64 [ %.pre, %entry ], [ %443, %block_.L_4113a1 ]
...
block_.L_411371:                                  ; preds = %block_.L_411371, %block_41136c
  %275 = phi i64 [ %274, %block_41136c ], [ %398, %block_.L_411371 ]
  %276 = phi i64 [ %237, %block_41136c ], [ %363, %block_.L_411371 ]
  ...
  br i1 %387, label %block_41139c, label %block_.L_411371
...
block_.L_4113a1:                                  ; preds = %block_.L_411360, %block_41139c
  %400 = phi i64 [ %273, %block_.L_411360 ], [ %399, %block_41139c ]
  %401 = phi i64 [ %237, %block_.L_411360 ], [ %363, %block_41139c ]
  ...
  %call2_4113a4 = tail call %struct.Memory* @sub_40c100._Z9check_sumIiEvT_(%struct.State* %0, i64 %407, %struct.Memory* %MEMORY.4)
...
block_.L_4113b7:                                  ; preds = %block_.L_4112ff
  ...
  %call2_4113b7 = tail call %struct.Memory* @sub_400df0._Z5timerv(%struct.State* %0, i64 %444, %struct.Memory* %MEMORY.0)
  ...
  %call2_4113c0 = tail call %struct.Memory* @sub_400790._Z13record_resultdPKc(%struct.State* %0, i64 %455, %struct.Memory* %call2_4113b7)
