...
entry:
  ...
  %call2_40b433 = tail call %struct.Memory* @sub_400e10._Z11start_timerv(%struct.State* %0, i64 %58, %struct.Memory* %2)
...
block_.L_40b43f:                                  ; preds = %block_.L_40b4c8, %entry
  %74 = phi i64 [ %340, %block_.L_40b4c8 ], [ %.pre, %entry ]
  ...
  br i1 %107, label %block_40b44f, label %block_.L_40b4e0
...
block_.L_40b45e:                                  ; preds = %block_40b46f, %block_40b44f
  %118 = phi i64 [ %201, %block_40b46f ], [ %.pre9, %block_40b44f ]
  ...
  br i1 %156, label %block_40b46f, label %block_.L_40b48d

block_40b46f:                                     ; preds = %block_.L_40b45e
  %158 = add i64 %119, -40
  ...
  %call2_40b47a = tail call %struct.Memory* @sub_401e10._ZN15loop_inner_bodyILi10EdE7do_workERdPKdi(%struct.State* nonnull %0, i64 %166, %struct.Memory* %call2_40b433)
...
block_.L_40b48d:                                  ; preds = %block_.L_40b45e
  %202 = add i64 %157, 5
  br label %block_.L_40b492

block_.L_40b492:                                  ; preds = %block_40b49e, %block_.L_40b48d
  %203 = phi i64 [ %119, %block_.L_40b48d ], [ %.pre10, %block_40b49e ]
  %storemerge = phi i64 [ %202, %block_.L_40b48d ], [ %298, %block_40b49e ]
  %204 = add i64 %203, -44
  ...
  br i1 %238, label %block_40b49e, label %block_.L_40b4c8
...
block_40b49e:                                     ; preds = %block_.L_40b492
  ...
  %call2_40b4ab = tail call %struct.Memory* @sub_4014c0._Z18complete_hash_funcIdET_S0_(%struct.State* nonnull %0, i64 %252, %struct.Memory* %call2_40b433)
...
block_.L_40b4c8:                                  ; preds = %block_.L_40b492
  ...
  %call2_40b4cd = tail call %struct.Memory* @sub_4014f0._Z9check_sumIdEvT_(%struct.State* nonnull %0, i64 %304, %struct.Memory* %call2_40b433)
...
block_.L_40b4e0:                                  ; preds = %block_.L_40b43f
  ...
  %call2_40b4e0 = tail call %struct.Memory* @sub_400e30._Z5timerv(%struct.State* nonnull %0, i64 %341, %struct.Memory* %call2_40b433)
  ...
  %call2_40b4e9 = tail call %struct.Memory* @sub_4007d0._Z13record_resultdPKc(%struct.State* nonnull %0, i64 %352, %struct.Memory* %call2_40b4e0)
