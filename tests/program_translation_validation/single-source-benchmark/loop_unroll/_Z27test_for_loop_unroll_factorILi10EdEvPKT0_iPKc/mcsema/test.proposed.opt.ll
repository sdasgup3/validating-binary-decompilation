...
define %struct.Memory* @_Z27test_for_loop_unroll_factorILi10EdEvPKT0_iPKc(%struct.State* noalias, i64, %struct.Memory* noalias readnone) local_unnamed_addr #1 {
entry:
...
block_.L_40b42f:                                  ; preds = %block_.L_40b4b8, %entry
  %74 = phi i64 [ %340, %block_.L_40b4b8 ], [ %.pre, %entry ]
...
block_.L_40b44e:                                  ; preds = %block_40b45f, %block_40b43f
  %118 = phi i64 [ %201, %block_40b45f ], [ %.pre9, %block_40b43f ]
...
block_40b45f:                                     ; preds = %block_.L_40b44e
  ...
  %call2_40b46a = tail call %struct.Memory* @sub_401e00._ZN15loop_inner_bodyILi10EdE7do_workERdPKdi(%struct.State* nonnull %0, i64 %166, %struct.Memory* %call2_40b423)
...
block_40b48e:                                     ; preds = %block_.L_40b482
  ...
  %call2_40b49b = tail call %struct.Memory* @sub_4014b0._Z18complete_hash_funcIdET_S0_(%struct.State* nonnull %0, i64 %252, %struct.Memory* %call2_40b423)
...
block_.L_40b4b8:                                  ; preds = %block_.L_40b482
  ...
  %call2_40b4bd = tail call %struct.Memory* @sub_4014e0._Z9check_sumIdEvT_(%struct.State* nonnull %0, i64 %304, %struct.Memory* %call2_40b423)
...
block_.L_40b4d0:                                  ; preds = %block_.L_40b42f
  ...
  %call2_40b4d0 = tail call %struct.Memory* @sub_400e20._Z5timerv(%struct.State* nonnull %0, i64 %341, %struct.Memory* %call2_40b423)
