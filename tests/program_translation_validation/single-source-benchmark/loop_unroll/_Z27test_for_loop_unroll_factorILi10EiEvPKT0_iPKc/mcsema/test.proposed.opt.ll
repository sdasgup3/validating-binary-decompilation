...
block_.L_415a5f:                                  ; preds = %block_.L_415ae1, %entry
  %68 = phi i64 [ %.pre, %entry ], [ %361, %block_.L_415ae1 ]
...
block_.L_415ab1:                                  ; preds = %block_415abd, %block_.L_415aac
  %196 = phi i64 [ %195, %block_.L_415aac ], [ %319, %block_415abd ]
...
block_.L_415ae1:                                  ; preds = %block_.L_415ab1
  ...
  %call2_415ae4 = tail call %struct.Memory* @sub_40c100._Z9check_sumIiEvT_(%struct.State* %0, i64 %325, %struct.Memory* %MEMORY.2)
...
block_.L_415af7:                                  ; preds = %block_.L_415a5f
  ...
  %call2_415af7 = tail call %struct.Memory* @sub_400df0._Z5timerv(%struct.State* %0, i64 %362, %struct.Memory* %MEMORY.0)
  ...
  %call2_415b00 = tail call %struct.Memory* @sub_400790._Z13record_resultdPKc(%struct.State* %0, i64 %373, %struct.Memory* %call2_415af7)
