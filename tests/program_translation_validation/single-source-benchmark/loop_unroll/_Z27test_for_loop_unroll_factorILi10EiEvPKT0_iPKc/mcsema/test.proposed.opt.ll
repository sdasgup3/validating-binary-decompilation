...
define %struct.Memory* @_Z27test_for_loop_unroll_factorILi10EiEvPKT0_iPKc(%struct.State* noalias, i64, %struct.Memory* noalias readnone) local_unnamed_addr #1 {
entry:
...
block_.L_415a8f:                                  ; preds = %block_.L_415b11, %entry
  %68 = phi i64 [ %361, %block_.L_415b11 ], [ %.pre, %entry ]
...
block_.L_415aad:                                  ; preds = %block_415abe, %block_415a9f
  %111 = phi i64 [ %194, %block_415abe ], [ %.pre9, %block_415a9f ]
...
block_415abe:                                     ; preds = %block_.L_415aad
  ...
  %call2_415ac9 = tail call %struct.Memory* @sub_40c9c0._ZN15loop_inner_bodyILi10EiE7do_workERiPKii(%struct.State* nonnull %0, i64 %159, %struct.Memory* %call2_415a83)
...
block_415aed:                                     ; preds = %block_.L_415ae1
  ...
  %call2_415af8 = tail call %struct.Memory* @sub_40c100._Z18complete_hash_funcIiET_S0_(%struct.State* nonnull %0, i64 %246, %struct.Memory* %call2_415a83)
...
block_.L_415b11:                                  ; preds = %block_.L_415ae1
  ...
  %call2_415b14 = tail call %struct.Memory* @sub_40c130._Z9check_sumIiEvT_(%struct.State* nonnull %0, i64 %325, %struct.Memory* %call2_415a83)
...
block_.L_415b27:                                  ; preds = %block_.L_415a8f
  ...
  %call2_415b27 = tail call %struct.Memory* @sub_400e20._Z5timerv(%struct.State* nonnull %0, i64 %362, %struct.Memory* %call2_415a83)
