...
define %struct.Memory* @_Z27test_for_loop_unroll_factorILi10EiEvPKT0_iPKc(%struct.State* noalias, i64, %struct.Memory* noalias) local_unnamed_addr #1 {
entry:
  ...
  %call2_415a83 = tail call %struct.Memory* @sub_400e00._Z11start_timerv(%struct.State* %0, i64 %58, %struct.Memory* %2)
...
block_.L_415a8f:                                  ; preds = %block_.L_415b11, %entry
  %68 = phi i64 [ %.pre, %entry ], [ %361, %block_.L_415b11 ]
  %MEMORY.0 = phi %struct.Memory* [ %call2_415a83, %entry ], [ %call2_415b14, %block_.L_415b11 ]
  ...
  br i1 %101, label %block_415a9f, label %block_.L_415b27

block_415a9f:                                     ; preds = %block_.L_415a8f
  %103 = add i64 %69, -32
  %104 = add i64 %102, 7
...
block_.L_415aad:                                  ; preds = %block_415abe, %block_415a9f
  %111 = phi i64 [ %.pre9, %block_415a9f ], [ %194, %block_415abe ]
  %MEMORY.1 = phi %struct.Memory* [ %MEMORY.0, %block_415a9f ], [ %call2_415ac9, %block_415abe ]
  ...
  br i1 %149, label %block_415abe, label %block_.L_415adc

block_415abe:                                     ; preds = %block_.L_415aad
  %151 = add i64 %112, -32
  ...
  %call2_415ac9 = tail call %struct.Memory* @sub_40c9c0._ZN15loop_inner_bodyILi10EiE7do_workERiPKii(%struct.State* nonnull %0, i64 %159, %struct.Memory* %MEMORY.1)
...
block_.L_415adc:                                  ; preds = %block_.L_415aad
  %195 = add i64 %150, 5
  br label %block_.L_415ae1

block_.L_415ae1:                                  ; preds = %block_415aed, %block_.L_415adc
  %196 = phi i64 [ %112, %block_.L_415adc ], [ %.pre10, %block_415aed ]
  %storemerge = phi i64 [ %195, %block_.L_415adc ], [ %318, %block_415aed ]
  %MEMORY.2 = phi %struct.Memory* [ %MEMORY.1, %block_.L_415adc ], [ %call2_415af8, %block_415aed ]
  %197 = add i64 %196, -36
  ...
  br i1 %231, label %block_415aed, label %block_.L_415b11

block_415aed:                                     ; preds = %block_.L_415ae1
  %233 = add i64 %196, -8
  %234 = add i64 %232, 4
  ...
  %call2_415af8 = tail call %struct.Memory* @sub_40c100._Z18complete_hash_funcIiET_S0_(%struct.State* nonnull %0, i64 %246, %struct.Memory* %MEMORY.2)
...
block_.L_415b11:                                  ; preds = %block_.L_415ae1
  %320 = add i64 %196, -32
  %321 = add i64 %232, 3
  ...
  %call2_415b14 = tail call %struct.Memory* @sub_40c130._Z9check_sumIiEvT_(%struct.State* nonnull %0, i64 %325, %struct.Memory* %MEMORY.2)
...
block_.L_415b27:                                  ; preds = %block_.L_415a8f
  %362 = add i64 %102, -85255
  %363 = add i64 %102, 5
  ...
  %call2_415b27 = tail call %struct.Memory* @sub_400e20._Z5timerv(%struct.State* nonnull %0, i64 %362, %struct.Memory* %MEMORY.0)
  ...
  %call2_415b30 = tail call %struct.Memory* @sub_4007c0._Z13record_resultdPKc(%struct.State* nonnull %0, i64 %373, %struct.Memory* %call2_415b27)
  ...
  ret %struct.Memory* %call2_415b30
}
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_jge_.L_415b27(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i8* nocapture %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_jge_.L_415adc(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i8* nocapture %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 2, i32 9
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_jmpq_.L_415aad(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_jmpq_.L_415ae1(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_jge_.L_415b11(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i8* nocapture %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 2, i32 9
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_jmpq_.L_415a8f(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
