...
entry:
  ...
  %call2_415973 = tail call %struct.Memory* @sub_400e10._Z11start_timerv(%struct.State* %0, i64 %58, %struct.Memory* %2)
...
block_.L_41597f:                                  ; preds = %block_.L_415a01, %entry
  %68 = phi i64 [ %361, %block_.L_415a01 ], [ %.pre, %entry ]
  ...
  br i1 %101, label %block_41598f, label %block_.L_415a17
...
block_.L_41599d:                                  ; preds = %block_4159ae, %block_41598f
  %111 = phi i64 [ %194, %block_4159ae ], [ %.pre9, %block_41598f ]
  ...
  br i1 %149, label %block_4159ae, label %block_.L_4159cc
...
block_4159ae:                                     ; preds = %block_.L_41599d
  ...
  %call2_4159b9 = tail call %struct.Memory* @sub_40c970._ZN15loop_inner_bodyILi11EiE7do_workERiPKii(%struct.State* nonnull %0, i64 %159, %struct.Memory* %call2_415973)
...
block_.L_4159d1:                                  ; preds = %block_4159dd, %block_.L_4159cc
  %196 = phi i64 [ %112, %block_.L_4159cc ], [ %.pre10, %block_4159dd ]
  %storemerge = phi i64 [ %195, %block_.L_4159cc ], [ %318, %block_4159dd ]
  %197 = add i64 %196, -36
  ...
  br i1 %231, label %block_4159dd, label %block_.L_415a01
...
block_4159dd:                                     ; preds = %block_.L_4159d1
  ...
  %call2_4159e8 = tail call %struct.Memory* @sub_40c110._Z18complete_hash_funcIiET_S0_(%struct.State* nonnull %0, i64 %246, %struct.Memory* %call2_415973)
...
block_.L_415a01:                                  ; preds = %block_.L_4159d1
  ...
  %call2_415a04 = tail call %struct.Memory* @sub_40c140._Z9check_sumIiEvT_(%struct.State* nonnull %0, i64 %325, %struct.Memory* %call2_415973)
...
block_.L_415a17:                                  ; preds = %block_.L_41597f
  ...
  %call2_415a17 = tail call %struct.Memory* @sub_400e30._Z5timerv(%struct.State* nonnull %0, i64 %362, %struct.Memory* %call2_415973)
  ...
  %call2_415a20 = tail call %struct.Memory* @sub_4007d0._Z13record_resultdPKc(%struct.State* nonnull %0, i64 %373, %struct.Memory* %call2_415a17)
