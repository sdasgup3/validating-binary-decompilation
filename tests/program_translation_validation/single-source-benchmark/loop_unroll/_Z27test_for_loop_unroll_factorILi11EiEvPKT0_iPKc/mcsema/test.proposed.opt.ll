...
define %struct.Memory* @_Z27test_for_loop_unroll_factorILi11EiEvPKT0_iPKc(%struct.State* noalias, i64, %struct.Memory* noalias readnone) local_unnamed_addr #1 {
entry:
...
block_.L_41596f:                                  ; preds = %block_.L_4159f1, %entry
  %68 = phi i64 [ %361, %block_.L_4159f1 ], [ %.pre, %entry ]
...
block_.L_41598d:                                  ; preds = %block_41599e, %block_41597f
  %111 = phi i64 [ %194, %block_41599e ], [ %.pre9, %block_41597f ]
...
block_41599e:                                     ; preds = %block_.L_41598d
  ...
  %call2_4159a9 = tail call %struct.Memory* @sub_40c960._ZN15loop_inner_bodyILi11EiE7do_workERiPKii(%struct.State* nonnull %0, i64 %159, %struct.Memory* %call2_415963)
...
block_4159cd:                                     ; preds = %block_.L_4159c1
  ...
  %call2_4159d8 = tail call %struct.Memory* @sub_40c100._Z18complete_hash_funcIiET_S0_(%struct.State* nonnull %0, i64 %246, %struct.Memory* %call2_415963)
...
block_.L_4159f1:                                  ; preds = %block_.L_4159c1
  ...
  %call2_4159f4 = tail call %struct.Memory* @sub_40c130._Z9check_sumIiEvT_(%struct.State* nonnull %0, i64 %325, %struct.Memory* %call2_415963)
...
block_.L_415a07:                                  ; preds = %block_.L_41596f
  ...
  %call2_415a07 = tail call %struct.Memory* @sub_400e20._Z5timerv(%struct.State* nonnull %0, i64 %362, %struct.Memory* %call2_415963)
