...
entry:
  ...
  %call2_415933 = tail call %struct.Memory* @sub_400dd0._Z11start_timerv(%struct.State* %0, i64 %58, %struct.Memory* %2)
...
block_.L_41593f:                                  ; preds = %block_.L_4159c1, %entry
  %68 = phi i64 [ %.pre, %entry ], [ %361, %block_.L_4159c1 ]
  %MEMORY.0 = phi %struct.Memory* [ %call2_415933, %entry ], [ %call2_4159c4, %block_.L_4159c1 ]
  ...
  br i1 %101, label %block_41594f, label %block_.L_4159d7
...
block_.L_41595d:                                  ; preds = %block_41596e, %block_41594f
  %111 = phi i64 [ %.pre1, %block_41594f ], [ %194, %block_41596e ]
  %MEMORY.1 = phi %struct.Memory* [ %MEMORY.0, %block_41594f ], [ %call2_415979, %block_41596e ]
  ...
  br i1 %149, label %block_41596e, label %block_.L_41598c
...
block_41596e:                                     ; preds = %block_.L_41595d
  ...
  %call2_415979 = tail call %struct.Memory* @sub_40c930._ZN15loop_inner_bodyILi11EiE7do_workERiPKii(%struct.State* %0, i64 %159, %struct.Memory* %MEMORY.1)
...
block_.L_415991:                                  ; preds = %block_41599d, %block_.L_41598c
  %196 = phi i64 [ %195, %block_.L_41598c ], [ %319, %block_41599d ]
  %197 = phi i64 [ %112, %block_.L_41598c ], [ %.pre2, %block_41599d ]
  %MEMORY.2 = phi %struct.Memory* [ %MEMORY.1, %block_.L_41598c ], [ %call2_4159a8, %block_41599d ]
  %198 = add i64 %197, -36
  %199 = add i64 %196, 3
  ...
  br i1 %232, label %block_41599d, label %block_.L_4159c1
...
block_41599d:                                     ; preds = %block_.L_415991
  ...
  %call2_4159a8 = tail call %struct.Memory* @sub_40c0d0._Z18complete_hash_funcIiET_S0_(%struct.State* %0, i64 %247, %struct.Memory* %MEMORY.2)
...
block_.L_4159c1:                                  ; preds = %block_.L_415991
  ...
  %call2_4159c4 = tail call %struct.Memory* @sub_40c100._Z9check_sumIiEvT_(%struct.State* %0, i64 %325, %struct.Memory* %MEMORY.2)
...
block_.L_4159d7:                                  ; preds = %block_.L_41593f
  ...
  %call2_4159d7 = tail call %struct.Memory* @sub_400df0._Z5timerv(%struct.State* %0, i64 %362, %struct.Memory* %MEMORY.0)
  ...
  %call2_4159e0 = tail call %struct.Memory* @sub_400790._Z13record_resultdPKc(%struct.State* %0, i64 %373, %struct.Memory* %call2_4159d7)
  ...
  ret %struct.Memory* %call2_4159e0
}
...
define %struct.Memory* @routine_jge_.L_4159d7(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i8* %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
...
define %struct.Memory* @routine_jge_.L_41598c(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i8* %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 2, i32 9
...
define %struct.Memory* @routine_jmpq_.L_41595d(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
...
define %struct.Memory* @routine_jmpq_.L_415991(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
...
define %struct.Memory* @routine_jge_.L_4159c1(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i8* %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 2, i32 9
...
define %struct.Memory* @routine_jmpq_.L_41593f(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
