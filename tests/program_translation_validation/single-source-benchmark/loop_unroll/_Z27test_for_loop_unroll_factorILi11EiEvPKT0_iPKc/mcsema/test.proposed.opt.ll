...
block_.L_41593f:                                  ; preds = %block_.L_4159c1, %entry
  %68 = phi i64 [ %.pre, %entry ], [ %363, %block_.L_4159c1 ]
...
block_.L_415991:                                  ; preds = %block_41599d, %block_.L_41598c
  %196 = phi i64 [ %195, %block_.L_41598c ], [ %320, %block_41599d ]
...
block_.L_4159c1:                                  ; preds = %block_.L_415991
  ...
  %call2_4159c4 = tail call %struct.Memory* @sub_40c100._Z9check_sumIiEvT_(%struct.State* %0, i64 %326, %struct.Memory* %MEMORY.2)
...
block_.L_4159d7:                                  ; preds = %block_.L_41593f
  ...
  %call2_4159d7 = tail call %struct.Memory* @sub_400df0._Z5timerv(%struct.State* %0, i64 %364, %struct.Memory* %MEMORY.0)
  ...
  %call2_4159e0 = tail call %struct.Memory* @sub_400790._Z13record_resultdPKc(%struct.State* %0, i64 %375, %struct.Memory* %call2_4159d7)
