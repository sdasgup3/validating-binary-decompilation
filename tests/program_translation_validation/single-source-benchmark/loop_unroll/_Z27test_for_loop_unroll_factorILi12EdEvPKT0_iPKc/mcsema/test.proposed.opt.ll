...
block_.L_40b19f:                                  ; preds = %block_.L_40b228, %entry
  %79 = phi i64 [ %.pre, %entry ], [ %349, %block_.L_40b228 ]
...
block_.L_40b1f2:                                  ; preds = %block_40b1fe, %block_.L_40b1ed
  %209 = phi i64 [ %208, %block_.L_40b1ed ], [ %306, %block_40b1fe ]
...
block_40b1fe:                                     ; preds = %block_.L_40b1f2
  ...
  %call2_40b20b = tail call %struct.Memory* @sub_401480._Z18complete_hash_funcIdET_S0_(%struct.State* %0, i64 %260, %struct.Memory* %MEMORY.2)
...
block_.L_40b228:                                  ; preds = %block_.L_40b1f2
  ...
  %call2_40b22d = tail call %struct.Memory* @sub_4014b0._Z9check_sumIdEvT_(%struct.State* %0, i64 %312, %struct.Memory* %MEMORY.2)
...
block_.L_40b240:                                  ; preds = %block_.L_40b19f
  ...
  %call2_40b240 = tail call %struct.Memory* @sub_400df0._Z5timerv(%struct.State* %0, i64 %350, %struct.Memory* %MEMORY.0)
  ...
  %call2_40b249 = tail call %struct.Memory* @sub_400790._Z13record_resultdPKc(%struct.State* %0, i64 %361, %struct.Memory* %call2_40b240)
