...
define %struct.Memory* @_Z27test_for_loop_unroll_factorILi12EiEvPKT0_iPKc(%struct.State* noalias, i64, %struct.Memory* noalias) #1 {
entry:
  ...
  store %struct.Memory* %loadMem1_415843, %struct.Memory** %MEMORY
...
block_.L_41584f:                                  ; preds = %block_.L_4158d1, %entry
  ...
  store %struct.Memory* %loadMem_415859, %struct.Memory** %MEMORY
...
block_41585f:                                     ; preds = %block_.L_41584f
...
block_.L_41586d:                                  ; preds = %block_41587e, %block_41585f
...
block_41587e:                                     ; preds = %block_.L_41586d
  ...
  store %struct.Memory* %loadMem1_415889, %struct.Memory** %MEMORY
...
block_.L_41589c:                                  ; preds = %block_.L_41586d
...
block_.L_4158a1:                                  ; preds = %block_4158ad, %block_.L_41589c
...
block_4158ad:                                     ; preds = %block_.L_4158a1
  ...
  store %struct.Memory* %loadMem1_4158b8, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_4158c3, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_4158c6, %struct.Memory** %MEMORY
...
block_.L_4158d1:                                  ; preds = %block_.L_4158a1
  ...
  store %struct.Memory* %loadMem1_4158d4, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_4158df, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_4158e2, %struct.Memory** %MEMORY
  br label %block_.L_41584f

block_.L_4158e7:                                  ; preds = %block_.L_41584f
  ...
  store %struct.Memory* %loadMem1_4158e7, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem1_4158f0, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_4158f9, %struct.Memory** %MEMORY
  ...
  ret %struct.Memory* %loadMem_4158fa
}
