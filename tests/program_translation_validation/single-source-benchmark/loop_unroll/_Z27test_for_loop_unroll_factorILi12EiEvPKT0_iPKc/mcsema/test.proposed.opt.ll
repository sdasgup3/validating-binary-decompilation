...
define %struct.Memory* @_Z27test_for_loop_unroll_factorILi12EiEvPKT0_iPKc(%struct.State* noalias, i64, %struct.Memory* noalias readnone) local_unnamed_addr #1 {
entry:
...
block_.L_41584f:                                  ; preds = %block_.L_4158d1, %entry
  %68 = phi i64 [ %361, %block_.L_4158d1 ], [ %.pre, %entry ]
...
block_.L_41586d:                                  ; preds = %block_41587e, %block_41585f
  %111 = phi i64 [ %194, %block_41587e ], [ %.pre9, %block_41585f ]
...
block_41587e:                                     ; preds = %block_.L_41586d
  ...
  %call2_415889 = tail call %struct.Memory* @sub_40c900._ZN15loop_inner_bodyILi12EiE7do_workERiPKii(%struct.State* nonnull %0, i64 %159, %struct.Memory* %call2_415843)
...
block_4158ad:                                     ; preds = %block_.L_4158a1
  ...
  %call2_4158b8 = tail call %struct.Memory* @sub_40c100._Z18complete_hash_funcIiET_S0_(%struct.State* nonnull %0, i64 %246, %struct.Memory* %call2_415843)
...
block_.L_4158d1:                                  ; preds = %block_.L_4158a1
  ...
  %call2_4158d4 = tail call %struct.Memory* @sub_40c130._Z9check_sumIiEvT_(%struct.State* nonnull %0, i64 %325, %struct.Memory* %call2_415843)
...
block_.L_4158e7:                                  ; preds = %block_.L_41584f
  ...
  %call2_4158e7 = tail call %struct.Memory* @sub_400e20._Z5timerv(%struct.State* nonnull %0, i64 %362, %struct.Memory* %call2_415843)
