...
entry:
  ...
  %call2_415813 = tail call %struct.Memory* @sub_400dd0._Z11start_timerv(%struct.State* %0, i64 %58, %struct.Memory* %2)
...
block_.L_41581f:                                  ; preds = %block_.L_4158a1, %entry
  %68 = phi i64 [ %.pre, %entry ], [ %361, %block_.L_4158a1 ]
  %MEMORY.0 = phi %struct.Memory* [ %call2_415813, %entry ], [ %call2_4158a4, %block_.L_4158a1 ]
  ...
  br i1 %101, label %block_41582f, label %block_.L_4158b7
...
block_.L_41583d:                                  ; preds = %block_41584e, %block_41582f
  %111 = phi i64 [ %.pre1, %block_41582f ], [ %194, %block_41584e ]
  %MEMORY.1 = phi %struct.Memory* [ %MEMORY.0, %block_41582f ], [ %call2_415859, %block_41584e ]
  ...
  br i1 %149, label %block_41584e, label %block_.L_41586c
...
block_41584e:                                     ; preds = %block_.L_41583d
  ...
  %call2_415859 = tail call %struct.Memory* @sub_40c8d0._ZN15loop_inner_bodyILi12EiE7do_workERiPKii(%struct.State* %0, i64 %159, %struct.Memory* %MEMORY.1)
...
block_.L_415871:                                  ; preds = %block_41587d, %block_.L_41586c
  %196 = phi i64 [ %195, %block_.L_41586c ], [ %319, %block_41587d ]
  %197 = phi i64 [ %112, %block_.L_41586c ], [ %.pre2, %block_41587d ]
  %MEMORY.2 = phi %struct.Memory* [ %MEMORY.1, %block_.L_41586c ], [ %call2_415888, %block_41587d ]
  %198 = add i64 %197, -36
  %199 = add i64 %196, 3
  ...
  br i1 %232, label %block_41587d, label %block_.L_4158a1
...
block_41587d:                                     ; preds = %block_.L_415871
  ...
  %call2_415888 = tail call %struct.Memory* @sub_40c0d0._Z18complete_hash_funcIiET_S0_(%struct.State* %0, i64 %247, %struct.Memory* %MEMORY.2)
...
block_.L_4158a1:                                  ; preds = %block_.L_415871
  ...
  %call2_4158a4 = tail call %struct.Memory* @sub_40c100._Z9check_sumIiEvT_(%struct.State* %0, i64 %325, %struct.Memory* %MEMORY.2)
...
block_.L_4158b7:                                  ; preds = %block_.L_41581f
  ...
  %call2_4158b7 = tail call %struct.Memory* @sub_400df0._Z5timerv(%struct.State* %0, i64 %362, %struct.Memory* %MEMORY.0)
  ...
  %call2_4158c0 = tail call %struct.Memory* @sub_400790._Z13record_resultdPKc(%struct.State* %0, i64 %373, %struct.Memory* %call2_4158b7)
  ...
  ret %struct.Memory* %call2_4158c0
}
...
define %struct.Memory* @routine_jge_.L_4158b7(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i8* %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
...
define %struct.Memory* @routine_jge_.L_41586c(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i8* %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 2, i32 9
...
define %struct.Memory* @routine_jmpq_.L_41583d(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
...
define %struct.Memory* @routine_jmpq_.L_415871(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
...
define %struct.Memory* @routine_jge_.L_4158a1(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i8* %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 2, i32 9
...
define %struct.Memory* @routine_jmpq_.L_41581f(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
