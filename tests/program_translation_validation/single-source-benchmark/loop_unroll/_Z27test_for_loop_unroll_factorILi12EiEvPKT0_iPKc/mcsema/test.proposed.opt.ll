...
entry:
  ...
  %call2_415853 = tail call %struct.Memory* @sub_400e10._Z11start_timerv(%struct.State* %0, i64 %58, %struct.Memory* %2)
...
block_.L_41585f:                                  ; preds = %block_.L_4158e1, %entry
  %68 = phi i64 [ %361, %block_.L_4158e1 ], [ %.pre, %entry ]
  ...
  br i1 %101, label %block_41586f, label %block_.L_4158f7
...
block_.L_41587d:                                  ; preds = %block_41588e, %block_41586f
  %111 = phi i64 [ %194, %block_41588e ], [ %.pre9, %block_41586f ]
  ...
  br i1 %149, label %block_41588e, label %block_.L_4158ac
...
block_41588e:                                     ; preds = %block_.L_41587d
  ...
  %call2_415899 = tail call %struct.Memory* @sub_40c910._ZN15loop_inner_bodyILi12EiE7do_workERiPKii(%struct.State* nonnull %0, i64 %159, %struct.Memory* %call2_415853)
...
block_.L_4158b1:                                  ; preds = %block_4158bd, %block_.L_4158ac
  %196 = phi i64 [ %112, %block_.L_4158ac ], [ %.pre10, %block_4158bd ]
  %storemerge = phi i64 [ %195, %block_.L_4158ac ], [ %318, %block_4158bd ]
  %197 = add i64 %196, -36
  ...
  br i1 %231, label %block_4158bd, label %block_.L_4158e1
...
block_4158bd:                                     ; preds = %block_.L_4158b1
  ...
  %call2_4158c8 = tail call %struct.Memory* @sub_40c110._Z18complete_hash_funcIiET_S0_(%struct.State* nonnull %0, i64 %246, %struct.Memory* %call2_415853)
...
block_.L_4158e1:                                  ; preds = %block_.L_4158b1
  ...
  %call2_4158e4 = tail call %struct.Memory* @sub_40c140._Z9check_sumIiEvT_(%struct.State* nonnull %0, i64 %325, %struct.Memory* %call2_415853)
...
block_.L_4158f7:                                  ; preds = %block_.L_41585f
  ...
  %call2_4158f7 = tail call %struct.Memory* @sub_400e30._Z5timerv(%struct.State* nonnull %0, i64 %362, %struct.Memory* %call2_415853)
  ...
  %call2_415900 = tail call %struct.Memory* @sub_4007d0._Z13record_resultdPKc(%struct.State* nonnull %0, i64 %373, %struct.Memory* %call2_4158f7)
