...
block_.L_41581f:                                  ; preds = %block_.L_4158a1, %entry
  %68 = phi i64 [ %.pre, %entry ], [ %363, %block_.L_4158a1 ]
...
block_.L_415871:                                  ; preds = %block_41587d, %block_.L_41586c
  %196 = phi i64 [ %195, %block_.L_41586c ], [ %320, %block_41587d ]
...
block_.L_4158a1:                                  ; preds = %block_.L_415871
  ...
  %call2_4158a4 = tail call %struct.Memory* @sub_40c100._Z9check_sumIiEvT_(%struct.State* %0, i64 %326, %struct.Memory* %MEMORY.2)
...
block_.L_4158b7:                                  ; preds = %block_.L_41581f
  ...
  %call2_4158b7 = tail call %struct.Memory* @sub_400df0._Z5timerv(%struct.State* %0, i64 %364, %struct.Memory* %MEMORY.0)
  ...
  %call2_4158c0 = tail call %struct.Memory* @sub_400790._Z13record_resultdPKc(%struct.State* %0, i64 %375, %struct.Memory* %call2_4158b7)
