...
block_.L_40b06f:                                  ; preds = %block_.L_40b0f8, %entry
  %79 = phi i64 [ %.pre, %entry ], [ %345, %block_.L_40b0f8 ]
...
block_.L_40b0c2:                                  ; preds = %block_40b0ce, %block_.L_40b0bd
  %209 = phi i64 [ %208, %block_.L_40b0bd ], [ %304, %block_40b0ce ]
...
block_40b0ce:                                     ; preds = %block_.L_40b0c2
  ...
  %call2_40b0db = tail call %struct.Memory* @sub_401480._Z18complete_hash_funcIdET_S0_(%struct.State* %0, i64 %259, %struct.Memory* %MEMORY.2)
...
block_.L_40b0f8:                                  ; preds = %block_.L_40b0c2
  ...
  %call2_40b0fd = tail call %struct.Memory* @sub_4014b0._Z9check_sumIdEvT_(%struct.State* %0, i64 %309, %struct.Memory* %MEMORY.2)
...
block_.L_40b110:                                  ; preds = %block_.L_40b06f
  ...
  %call2_40b110 = tail call %struct.Memory* @sub_400df0._Z5timerv(%struct.State* %0, i64 %346, %struct.Memory* %MEMORY.0)
  ...
  %call2_40b119 = tail call %struct.Memory* @sub_400790._Z13record_resultdPKc(%struct.State* %0, i64 %357, %struct.Memory* %call2_40b110)
