...
define %struct.Memory* @_Z27test_for_loop_unroll_factorILi13EdEvPKT0_iPKc(%struct.State* noalias, i64, %struct.Memory* noalias readnone) local_unnamed_addr #1 {
entry:
  ...
  %call2_40b0a3 = tail call %struct.Memory* @sub_400e10._Z11start_timerv(%struct.State* %0, i64 %58, %struct.Memory* %2)
...
block_.L_40b0af:                                  ; preds = %block_.L_40b138, %entry
  %74 = phi i64 [ %340, %block_.L_40b138 ], [ %.pre, %entry ]
  ...
  br i1 %107, label %block_40b0bf, label %block_.L_40b150
...
block_.L_40b0ce:                                  ; preds = %block_40b0df, %block_40b0bf
  %118 = phi i64 [ %201, %block_40b0df ], [ %.pre9, %block_40b0bf ]
  ...
  br i1 %156, label %block_40b0df, label %block_.L_40b0fd
...
block_40b0df:                                     ; preds = %block_.L_40b0ce
  ...
  %call2_40b0ea = tail call %struct.Memory* @sub_401cf0._ZN15loop_inner_bodyILi13EdE7do_workERdPKdi(%struct.State* nonnull %0, i64 %166, %struct.Memory* %call2_40b0a3)
...
block_.L_40b102:                                  ; preds = %block_40b10e, %block_.L_40b0fd
  %203 = phi i64 [ %119, %block_.L_40b0fd ], [ %.pre10, %block_40b10e ]
  %storemerge = phi i64 [ %202, %block_.L_40b0fd ], [ %298, %block_40b10e ]
  %204 = add i64 %203, -44
  ...
  br i1 %238, label %block_40b10e, label %block_.L_40b138
...
block_40b10e:                                     ; preds = %block_.L_40b102
  ...
  %call2_40b11b = tail call %struct.Memory* @sub_4014c0._Z18complete_hash_funcIdET_S0_(%struct.State* nonnull %0, i64 %252, %struct.Memory* %call2_40b0a3)
...
block_.L_40b138:                                  ; preds = %block_.L_40b102
  ...
  %call2_40b13d = tail call %struct.Memory* @sub_4014f0._Z9check_sumIdEvT_(%struct.State* nonnull %0, i64 %304, %struct.Memory* %call2_40b0a3)
...
block_.L_40b150:                                  ; preds = %block_.L_40b0af
  ...
  %call2_40b150 = tail call %struct.Memory* @sub_400e30._Z5timerv(%struct.State* nonnull %0, i64 %341, %struct.Memory* %call2_40b0a3)
  ...
  %call2_40b159 = tail call %struct.Memory* @sub_4007d0._Z13record_resultdPKc(%struct.State* nonnull %0, i64 %352, %struct.Memory* %call2_40b150)
