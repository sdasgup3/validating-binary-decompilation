...
declare %struct.Memory* @sub_40c8a0._ZN15loop_inner_bodyILi13EiE7do_workERiPKii(%struct.State* noalias dereferenceable(3376), i64, %struct.Memory* noalias readnone returned) local_unnamed_addr
...
block_.L_41572f:                                  ; preds = %block_.L_4157b1, %entry
  %68 = phi i64 [ %361, %block_.L_4157b1 ], [ %.pre, %entry ]
...
block_.L_41574d:                                  ; preds = %block_41575e, %block_41573f
  %111 = phi i64 [ %194, %block_41575e ], [ %.pre9, %block_41573f ]
...
block_41575e:                                     ; preds = %block_.L_41574d
  ...
  %call2_415769 = tail call %struct.Memory* @sub_40c8a0._ZN15loop_inner_bodyILi13EiE7do_workERiPKii(%struct.State* nonnull %0, i64 %159, %struct.Memory* %call2_415723)
...
block_41578d:                                     ; preds = %block_.L_415781
  ...
  %call2_415798 = tail call %struct.Memory* @sub_40c100._Z18complete_hash_funcIiET_S0_(%struct.State* nonnull %0, i64 %246, %struct.Memory* %call2_415723)
...
block_.L_4157b1:                                  ; preds = %block_.L_415781
  ...
  %call2_4157b4 = tail call %struct.Memory* @sub_40c130._Z9check_sumIiEvT_(%struct.State* nonnull %0, i64 %325, %struct.Memory* %call2_415723)
...
block_.L_4157c7:                                  ; preds = %block_.L_41572f
  ...
  %call2_4157c7 = tail call %struct.Memory* @sub_400e20._Z5timerv(%struct.State* nonnull %0, i64 %362, %struct.Memory* %call2_415723)
