...
declare %struct.Memory* @sub_40c8a0._ZN15loop_inner_bodyILi13EiE7do_workERiPKii(%struct.State* dereferenceable(3376), i64, %struct.Memory*) local_unnamed_addr
...
define %struct.Memory* @_Z27test_for_loop_unroll_factorILi13EiEvPKT0_iPKc(%struct.State* noalias, i64, %struct.Memory* noalias) local_unnamed_addr #1 {
entry:
  ...
  %call2_415723 = tail call %struct.Memory* @sub_400e00._Z11start_timerv(%struct.State* %0, i64 %58, %struct.Memory* %2)
  ...
  br label %block_.L_41572f

block_.L_41572f:                                  ; preds = %block_.L_4157b1, %entry
  %68 = phi i64 [ %.pre, %entry ], [ %361, %block_.L_4157b1 ]
  %MEMORY.0 = phi %struct.Memory* [ %call2_415723, %entry ], [ %call2_4157b4, %block_.L_4157b1 ]
  ...
  br i1 %101, label %block_41573f, label %block_.L_4157c7

block_41573f:                                     ; preds = %block_.L_41572f
  %103 = add i64 %69, -32
  %104 = add i64 %102, 7
  ...
  br label %block_.L_41574d

block_.L_41574d:                                  ; preds = %block_41575e, %block_41573f
  %111 = phi i64 [ %.pre9, %block_41573f ], [ %194, %block_41575e ]
  %MEMORY.1 = phi %struct.Memory* [ %MEMORY.0, %block_41573f ], [ %call2_415769, %block_41575e ]
  ...
  br i1 %149, label %block_41575e, label %block_.L_41577c

block_41575e:                                     ; preds = %block_.L_41574d
  %151 = add i64 %112, -32
  ...
  %call2_415769 = tail call %struct.Memory* @sub_40c8a0._ZN15loop_inner_bodyILi13EiE7do_workERiPKii(%struct.State* nonnull %0, i64 %159, %struct.Memory* %MEMORY.1)
...
block_.L_41577c:                                  ; preds = %block_.L_41574d
  %195 = add i64 %150, 5
  br label %block_.L_415781

block_.L_415781:                                  ; preds = %block_41578d, %block_.L_41577c
  %196 = phi i64 [ %112, %block_.L_41577c ], [ %.pre10, %block_41578d ]
  %storemerge = phi i64 [ %195, %block_.L_41577c ], [ %318, %block_41578d ]
  %MEMORY.2 = phi %struct.Memory* [ %MEMORY.1, %block_.L_41577c ], [ %call2_415798, %block_41578d ]
  %197 = add i64 %196, -36
  ...
  br i1 %231, label %block_41578d, label %block_.L_4157b1

block_41578d:                                     ; preds = %block_.L_415781
  %233 = add i64 %196, -8
  %234 = add i64 %232, 4
  ...
  %call2_415798 = tail call %struct.Memory* @sub_40c100._Z18complete_hash_funcIiET_S0_(%struct.State* nonnull %0, i64 %246, %struct.Memory* %MEMORY.2)
...
block_.L_4157b1:                                  ; preds = %block_.L_415781
  %320 = add i64 %196, -32
  %321 = add i64 %232, 3
  ...
  %call2_4157b4 = tail call %struct.Memory* @sub_40c130._Z9check_sumIiEvT_(%struct.State* nonnull %0, i64 %325, %struct.Memory* %MEMORY.2)
...
block_.L_4157c7:                                  ; preds = %block_.L_41572f
  %362 = add i64 %102, -84391
  %363 = add i64 %102, 5
  ...
  %call2_4157c7 = tail call %struct.Memory* @sub_400e20._Z5timerv(%struct.State* nonnull %0, i64 %362, %struct.Memory* %MEMORY.0)
  ...
  %call2_4157d0 = tail call %struct.Memory* @sub_4007c0._Z13record_resultdPKc(%struct.State* nonnull %0, i64 %373, %struct.Memory* %call2_4157c7)
  ...
  ret %struct.Memory* %call2_4157d0
}
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_jge_.L_4157c7(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i8* nocapture %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_jge_.L_41577c(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i8* nocapture %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 2, i32 9
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_jmpq_.L_41574d(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_jmpq_.L_415781(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_jge_.L_4157b1(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i8* nocapture %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 2, i32 9
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_jmpq_.L_41572f(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
