...
define %struct.Memory* @_Z27test_for_loop_unroll_factorILi14EdEvPKT0_iPKc(%struct.State* noalias, i64, %struct.Memory* noalias readnone) local_unnamed_addr #1 {
entry:
...
block_.L_40af6f:                                  ; preds = %block_.L_40aff8, %entry
  %74 = phi i64 [ %340, %block_.L_40aff8 ], [ %.pre, %entry ]
...
block_.L_40af8e:                                  ; preds = %block_40af9f, %block_40af7f
  %118 = phi i64 [ %201, %block_40af9f ], [ %.pre9, %block_40af7f ]
...
block_40af9f:                                     ; preds = %block_.L_40af8e
  ...
  %call2_40afaa = tail call %struct.Memory* @sub_401c80._ZN15loop_inner_bodyILi14EdE7do_workERdPKdi(%struct.State* nonnull %0, i64 %166, %struct.Memory* %call2_40af63)
...
block_40afce:                                     ; preds = %block_.L_40afc2
  ...
  %call2_40afdb = tail call %struct.Memory* @sub_4014b0._Z18complete_hash_funcIdET_S0_(%struct.State* nonnull %0, i64 %252, %struct.Memory* %call2_40af63)
...
block_.L_40aff8:                                  ; preds = %block_.L_40afc2
  ...
  %call2_40affd = tail call %struct.Memory* @sub_4014e0._Z9check_sumIdEvT_(%struct.State* nonnull %0, i64 %304, %struct.Memory* %call2_40af63)
...
block_.L_40b010:                                  ; preds = %block_.L_40af6f
  ...
  %call2_40b010 = tail call %struct.Memory* @sub_400e20._Z5timerv(%struct.State* nonnull %0, i64 %341, %struct.Memory* %call2_40af63)
