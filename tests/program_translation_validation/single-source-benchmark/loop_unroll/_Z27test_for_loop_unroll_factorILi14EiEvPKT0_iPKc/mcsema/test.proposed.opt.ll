...
block_.L_41560f:                                  ; preds = %block_.L_415691, %entry
  %68 = phi i64 [ %361, %block_.L_415691 ], [ %.pre, %entry ]
...
block_.L_41562d:                                  ; preds = %block_41563e, %block_41561f
  %111 = phi i64 [ %194, %block_41563e ], [ %.pre9, %block_41561f ]
...
block_41563e:                                     ; preds = %block_.L_41562d
  ...
  %call2_415649 = tail call %struct.Memory* @sub_40c840._ZN15loop_inner_bodyILi14EiE7do_workERiPKii(%struct.State* nonnull %0, i64 %159, %struct.Memory* %call2_415603)
...
block_41566d:                                     ; preds = %block_.L_415661
  ...
  %call2_415678 = tail call %struct.Memory* @sub_40c100._Z18complete_hash_funcIiET_S0_(%struct.State* nonnull %0, i64 %246, %struct.Memory* %call2_415603)
...
block_.L_415691:                                  ; preds = %block_.L_415661
  ...
  %call2_415694 = tail call %struct.Memory* @sub_40c130._Z9check_sumIiEvT_(%struct.State* nonnull %0, i64 %325, %struct.Memory* %call2_415603)
...
block_.L_4156a7:                                  ; preds = %block_.L_41560f
  ...
  %call2_4156a7 = tail call %struct.Memory* @sub_400e20._Z5timerv(%struct.State* nonnull %0, i64 %362, %struct.Memory* %call2_415603)
