...
block_.L_4155df:                                  ; preds = %block_.L_415661, %entry
  %68 = phi i64 [ %.pre, %entry ], [ %361, %block_.L_415661 ]
...
block_.L_415631:                                  ; preds = %block_41563d, %block_.L_41562c
  %196 = phi i64 [ %195, %block_.L_41562c ], [ %319, %block_41563d ]
...
block_.L_415661:                                  ; preds = %block_.L_415631
  ...
  %call2_415664 = tail call %struct.Memory* @sub_40c100._Z9check_sumIiEvT_(%struct.State* %0, i64 %325, %struct.Memory* %MEMORY.2)
...
block_.L_415677:                                  ; preds = %block_.L_4155df
  ...
  %call2_415677 = tail call %struct.Memory* @sub_400df0._Z5timerv(%struct.State* %0, i64 %362, %struct.Memory* %MEMORY.0)
  ...
  %call2_415680 = tail call %struct.Memory* @sub_400790._Z13record_resultdPKc(%struct.State* %0, i64 %373, %struct.Memory* %call2_415677)
