...
define %struct.Memory* @_Z27test_for_loop_unroll_factorILi14EiEvPKT0_iPKc(%struct.State* noalias, i64, %struct.Memory* noalias readnone) local_unnamed_addr #1 {
entry:
  ...
  %call2_415613 = tail call %struct.Memory* @sub_400e10._Z11start_timerv(%struct.State* %0, i64 %58, %struct.Memory* %2)
...
block_.L_41561f:                                  ; preds = %block_.L_4156a1, %entry
  %68 = phi i64 [ %361, %block_.L_4156a1 ], [ %.pre, %entry ]
  ...
  br i1 %101, label %block_41562f, label %block_.L_4156b7

block_41562f:                                     ; preds = %block_.L_41561f
  %103 = add i64 %69, -32
  %104 = add i64 %102, 7
...
block_.L_41563d:                                  ; preds = %block_41564e, %block_41562f
  %111 = phi i64 [ %194, %block_41564e ], [ %.pre9, %block_41562f ]
  ...
  br i1 %149, label %block_41564e, label %block_.L_41566c

block_41564e:                                     ; preds = %block_.L_41563d
  %151 = add i64 %112, -32
  ...
  %call2_415659 = tail call %struct.Memory* @sub_40c850._ZN15loop_inner_bodyILi14EiE7do_workERiPKii(%struct.State* nonnull %0, i64 %159, %struct.Memory* %call2_415613)
...
block_.L_41566c:                                  ; preds = %block_.L_41563d
  %195 = add i64 %150, 5
  br label %block_.L_415671

block_.L_415671:                                  ; preds = %block_41567d, %block_.L_41566c
  %196 = phi i64 [ %112, %block_.L_41566c ], [ %.pre10, %block_41567d ]
  %storemerge = phi i64 [ %195, %block_.L_41566c ], [ %318, %block_41567d ]
  %197 = add i64 %196, -36
  ...
  br i1 %231, label %block_41567d, label %block_.L_4156a1
...
block_41567d:                                     ; preds = %block_.L_415671
  ...
  %call2_415688 = tail call %struct.Memory* @sub_40c110._Z18complete_hash_funcIiET_S0_(%struct.State* nonnull %0, i64 %246, %struct.Memory* %call2_415613)
...
block_.L_4156a1:                                  ; preds = %block_.L_415671
  ...
  %call2_4156a4 = tail call %struct.Memory* @sub_40c140._Z9check_sumIiEvT_(%struct.State* nonnull %0, i64 %325, %struct.Memory* %call2_415613)
...
block_.L_4156b7:                                  ; preds = %block_.L_41561f
  ...
  %call2_4156b7 = tail call %struct.Memory* @sub_400e30._Z5timerv(%struct.State* nonnull %0, i64 %362, %struct.Memory* %call2_415613)
  ...
  %call2_4156c0 = tail call %struct.Memory* @sub_4007d0._Z13record_resultdPKc(%struct.State* nonnull %0, i64 %373, %struct.Memory* %call2_4156b7)
