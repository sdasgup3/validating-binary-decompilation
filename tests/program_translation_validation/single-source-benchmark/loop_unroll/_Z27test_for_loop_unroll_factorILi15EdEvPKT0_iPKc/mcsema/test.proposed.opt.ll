...
define %struct.Memory* @_Z27test_for_loop_unroll_factorILi15EdEvPKT0_iPKc(%struct.State* noalias, i64, %struct.Memory* noalias) local_unnamed_addr #1 {
entry:
  ...
  %call2_40ae03 = tail call %struct.Memory* @sub_400dd0._Z11start_timerv(%struct.State* %0, i64 %58, %struct.Memory* %2)
...
block_.L_40ae0f:                                  ; preds = %block_.L_40ae98, %entry
  %79 = phi i64 [ %.pre, %entry ], [ %349, %block_.L_40ae98 ]
  %MEMORY.0 = phi %struct.Memory* [ %call2_40ae03, %entry ], [ %call2_40ae9d, %block_.L_40ae98 ]
  ...
  br i1 %112, label %block_40ae1f, label %block_.L_40aeb0
...
block_.L_40ae2e:                                  ; preds = %block_40ae3f, %block_40ae1f
  %124 = phi i64 [ %.pre1, %block_40ae1f ], [ %207, %block_40ae3f ]
  %MEMORY.1 = phi %struct.Memory* [ %MEMORY.0, %block_40ae1f ], [ %call2_40ae4a, %block_40ae3f ]
  ...
  br i1 %162, label %block_40ae3f, label %block_.L_40ae5d
...
block_40ae3f:                                     ; preds = %block_.L_40ae2e
  ...
  %call2_40ae4a = tail call %struct.Memory* @sub_401bf0._ZN15loop_inner_bodyILi15EdE7do_workERdPKdi(%struct.State* %0, i64 %172, %struct.Memory* %MEMORY.1)
...
block_.L_40ae62:                                  ; preds = %block_40ae6e, %block_.L_40ae5d
  %209 = phi i64 [ %208, %block_.L_40ae5d ], [ %306, %block_40ae6e ]
  %210 = phi i64 [ %125, %block_.L_40ae5d ], [ %.pre2, %block_40ae6e ]
  %MEMORY.2 = phi %struct.Memory* [ %MEMORY.1, %block_.L_40ae5d ], [ %call2_40ae7b, %block_40ae6e ]
  %211 = add i64 %210, -44
  %212 = add i64 %209, 3
  ...
  br i1 %245, label %block_40ae6e, label %block_.L_40ae98
...
block_40ae6e:                                     ; preds = %block_.L_40ae62
  ...
  %call2_40ae7b = tail call %struct.Memory* @sub_401480._Z18complete_hash_funcIdET_S0_(%struct.State* %0, i64 %260, %struct.Memory* %MEMORY.2)
...
block_.L_40ae98:                                  ; preds = %block_.L_40ae62
  ...
  %call2_40ae9d = tail call %struct.Memory* @sub_4014b0._Z9check_sumIdEvT_(%struct.State* %0, i64 %312, %struct.Memory* %MEMORY.2)
...
block_.L_40aeb0:                                  ; preds = %block_.L_40ae0f
  ...
  %call2_40aeb0 = tail call %struct.Memory* @sub_400df0._Z5timerv(%struct.State* %0, i64 %350, %struct.Memory* %MEMORY.0)
  ...
  %call2_40aeb9 = tail call %struct.Memory* @sub_400790._Z13record_resultdPKc(%struct.State* %0, i64 %361, %struct.Memory* %call2_40aeb0)
  ...
  ret %struct.Memory* %call2_40aeb9
}
...
define %struct.Memory* @routine_jge_.L_40aeb0(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i8* %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
...
define %struct.Memory* @routine_jge_.L_40ae5d(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i8* %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 2, i32 9
...
define %struct.Memory* @routine_jmpq_.L_40ae2e(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
...
define %struct.Memory* @routine_jmpq_.L_40ae62(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
...
define %struct.Memory* @routine_jge_.L_40ae98(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i8* %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 2, i32 9
...
define %struct.Memory* @routine_jmpq_.L_40ae0f(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
