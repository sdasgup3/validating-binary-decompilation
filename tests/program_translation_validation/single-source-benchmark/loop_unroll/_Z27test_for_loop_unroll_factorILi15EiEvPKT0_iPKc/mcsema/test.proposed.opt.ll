...
define %struct.Memory* @_Z27test_for_loop_unroll_factorILi15EiEvPKT0_iPKc(%struct.State* noalias, i64, %struct.Memory* noalias readnone) local_unnamed_addr #1 {
entry:
...
block_.L_4154ef:                                  ; preds = %block_.L_415571, %entry
  %68 = phi i64 [ %361, %block_.L_415571 ], [ %.pre, %entry ]
...
block_.L_41550d:                                  ; preds = %block_41551e, %block_4154ff
  %111 = phi i64 [ %194, %block_41551e ], [ %.pre9, %block_4154ff ]
...
block_41551e:                                     ; preds = %block_.L_41550d
  ...
  %call2_415529 = tail call %struct.Memory* @sub_40c7e0._ZN15loop_inner_bodyILi15EiE7do_workERiPKii(%struct.State* nonnull %0, i64 %159, %struct.Memory* %call2_4154e3)
...
block_41554d:                                     ; preds = %block_.L_415541
  ...
  %call2_415558 = tail call %struct.Memory* @sub_40c100._Z18complete_hash_funcIiET_S0_(%struct.State* nonnull %0, i64 %246, %struct.Memory* %call2_4154e3)
...
block_.L_415571:                                  ; preds = %block_.L_415541
  ...
  %call2_415574 = tail call %struct.Memory* @sub_40c130._Z9check_sumIiEvT_(%struct.State* nonnull %0, i64 %325, %struct.Memory* %call2_4154e3)
...
block_.L_415587:                                  ; preds = %block_.L_4154ef
  ...
  %call2_415587 = tail call %struct.Memory* @sub_400e20._Z5timerv(%struct.State* nonnull %0, i64 %362, %struct.Memory* %call2_4154e3)
