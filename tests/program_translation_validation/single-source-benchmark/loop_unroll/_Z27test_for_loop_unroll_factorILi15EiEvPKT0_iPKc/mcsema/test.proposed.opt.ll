...
entry:
  ...
  %call2_4154b3 = tail call %struct.Memory* @sub_400dd0._Z11start_timerv(%struct.State* %0, i64 %58, %struct.Memory* %2)
  ...
  br label %block_.L_4154bf

block_.L_4154bf:                                  ; preds = %block_.L_415541, %entry
  %68 = phi i64 [ %.pre, %entry ], [ %363, %block_.L_415541 ]
  %MEMORY.0 = phi %struct.Memory* [ %call2_4154b3, %entry ], [ %call2_415544, %block_.L_415541 ]
  ...
  br i1 %101, label %block_4154cf, label %block_.L_415557

block_4154cf:                                     ; preds = %block_.L_4154bf
  %103 = add i64 %69, -32
  %104 = add i64 %102, 7
  ...
  br label %block_.L_4154dd

block_.L_4154dd:                                  ; preds = %block_4154ee, %block_4154cf
  %111 = phi i64 [ %.pre1, %block_4154cf ], [ %194, %block_4154ee ]
  %MEMORY.1 = phi %struct.Memory* [ %MEMORY.0, %block_4154cf ], [ %call2_4154f9, %block_4154ee ]
  ...
  br i1 %149, label %block_4154ee, label %block_.L_41550c

block_4154ee:                                     ; preds = %block_.L_4154dd
  %151 = add i64 %112, -32
  ...
  %call2_4154f9 = tail call %struct.Memory* @sub_40c7b0._ZN15loop_inner_bodyILi15EiE7do_workERiPKii(%struct.State* %0, i64 %159, %struct.Memory* %MEMORY.1)
...
block_.L_41550c:                                  ; preds = %block_.L_4154dd
  %195 = add i64 %150, 5
  store i64 %195, i64* %3, align 8
  br label %block_.L_415511

block_.L_415511:                                  ; preds = %block_41551d, %block_.L_41550c
  %196 = phi i64 [ %195, %block_.L_41550c ], [ %320, %block_41551d ]
  %197 = phi i64 [ %112, %block_.L_41550c ], [ %.pre2, %block_41551d ]
  %MEMORY.2 = phi %struct.Memory* [ %MEMORY.1, %block_.L_41550c ], [ %call2_415528, %block_41551d ]
  %198 = add i64 %197, -36
  %199 = add i64 %196, 3
  ...
  %232 = xor i1 %231, %229
  %.v4 = select i1 %232, i64 12, i64 48
  %233 = add i64 %196, %.v4
  store i64 %233, i64* %3, align 8
  br i1 %232, label %block_41551d, label %block_.L_415541

block_41551d:                                     ; preds = %block_.L_415511
  %234 = add i64 %197, -8
  %235 = add i64 %233, 4
  ...
  %call2_415528 = tail call %struct.Memory* @sub_40c0d0._Z18complete_hash_funcIiET_S0_(%struct.State* %0, i64 %247, %struct.Memory* %MEMORY.2)
...
block_.L_415541:                                  ; preds = %block_.L_415511
  %321 = add i64 %197, -32
  %322 = add i64 %233, 3
  ...
  %call2_415544 = tail call %struct.Memory* @sub_40c100._Z9check_sumIiEvT_(%struct.State* %0, i64 %326, %struct.Memory* %MEMORY.2)
...
block_.L_415557:                                  ; preds = %block_.L_4154bf
  %364 = add i64 %102, -83815
  %365 = add i64 %102, 5
  ...
  %call2_415557 = tail call %struct.Memory* @sub_400df0._Z5timerv(%struct.State* %0, i64 %364, %struct.Memory* %MEMORY.0)
  %369 = load i64, i64* %RBP.i, align 8
  %370 = add i64 %369, -24
  %371 = load i64, i64* %PC.i, align 8
  %372 = add i64 %371, 4
  store i64 %372, i64* %PC.i, align 8
  %373 = inttoptr i64 %370 to i64*
  %374 = load i64, i64* %373, align 8
  store i64 %374, i64* %RDI.i100, align 8
  %375 = add i64 %371, -85452
  %376 = add i64 %371, 9
  ...
  %call2_415560 = tail call %struct.Memory* @sub_400790._Z13record_resultdPKc(%struct.State* %0, i64 %375, %struct.Memory* %call2_415557)
  %380 = load i64, i64* %RSP.i105, align 8
  %381 = load i64, i64* %PC.i, align 8
  %382 = add i64 %380, 48
  store i64 %382, i64* %RSP.i105, align 8
  %383 = icmp ugt i64 %380, -49
  ...
  store i64 %408, i64* %RBP.i, align 8
  ...
  ret %struct.Memory* %call2_415560
}
...
define %struct.Memory* @routine_jge_.L_415557(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i8* %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
...
define %struct.Memory* @routine_subl__0xe___ecx(%struct.State* dereferenceable(3376), i64, %struct.Memory*) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %RCX = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 5, i32 0, i32 0
...
define %struct.Memory* @routine_jge_.L_41550c(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i8* %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 2, i32 9
...
define %struct.Memory* @routine_addl__0xf___eax(%struct.State* dereferenceable(3376), i64, %struct.Memory*) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %RAX = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 1, i32 0, i32 0
...
define %struct.Memory* @routine_jmpq_.L_4154dd(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
...
define %struct.Memory* @routine_jmpq_.L_415511(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
...
define %struct.Memory* @routine_jge_.L_415541(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i8* %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 2, i32 9
...
define %struct.Memory* @routine_jmpq_.L_4154bf(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
