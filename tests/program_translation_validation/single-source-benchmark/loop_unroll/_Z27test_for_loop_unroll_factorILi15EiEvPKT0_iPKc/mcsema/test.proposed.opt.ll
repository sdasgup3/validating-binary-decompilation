...
block_.L_4154bf:                                  ; preds = %block_.L_415541, %entry
  %68 = phi i64 [ %.pre, %entry ], [ %361, %block_.L_415541 ]
...
block_.L_415511:                                  ; preds = %block_41551d, %block_.L_41550c
  %196 = phi i64 [ %195, %block_.L_41550c ], [ %319, %block_41551d ]
...
block_.L_415541:                                  ; preds = %block_.L_415511
  ...
  %call2_415544 = tail call %struct.Memory* @sub_40c100._Z9check_sumIiEvT_(%struct.State* %0, i64 %325, %struct.Memory* %MEMORY.2)
...
block_.L_415557:                                  ; preds = %block_.L_4154bf
  ...
  %call2_415557 = tail call %struct.Memory* @sub_400df0._Z5timerv(%struct.State* %0, i64 %362, %struct.Memory* %MEMORY.0)
  ...
  %call2_415560 = tail call %struct.Memory* @sub_400790._Z13record_resultdPKc(%struct.State* %0, i64 %373, %struct.Memory* %call2_415557)
