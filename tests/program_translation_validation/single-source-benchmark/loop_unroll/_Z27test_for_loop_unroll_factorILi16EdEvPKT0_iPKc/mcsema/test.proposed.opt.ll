...
entry:
  ...
  %call2_40ad13 = tail call %struct.Memory* @sub_400e10._Z11start_timerv(%struct.State* %0, i64 %58, %struct.Memory* %2)
...
block_.L_40ad1f:                                  ; preds = %block_.L_40ada8, %entry
  %74 = phi i64 [ %341, %block_.L_40ada8 ], [ %.pre, %entry ]
  ...
  br i1 %107, label %block_40ad2f, label %block_.L_40adc0

block_40ad2f:                                     ; preds = %block_.L_40ad1f
...
block_.L_40ad3e:                                  ; preds = %block_40ad4f, %block_40ad2f
  %118 = phi i64 [ %202, %block_40ad4f ], [ %.pre9, %block_40ad2f ]
  ...
  br i1 %156, label %block_40ad4f, label %block_.L_40ad6d

block_40ad4f:                                     ; preds = %block_.L_40ad3e
  %158 = add i64 %119, -40
  ...
  %call2_40ad5a = tail call %struct.Memory* @sub_401bd0._ZN15loop_inner_bodyILi16EdE7do_workERdPKdi(%struct.State* nonnull %0, i64 %166, %struct.Memory* %call2_40ad13)
...
block_.L_40ad6d:                                  ; preds = %block_.L_40ad3e
  %203 = add i64 %157, 5
  br label %block_.L_40ad72

block_.L_40ad72:                                  ; preds = %block_40ad7e, %block_.L_40ad6d
  %204 = phi i64 [ %119, %block_.L_40ad6d ], [ %.pre10, %block_40ad7e ]
  %storemerge = phi i64 [ %203, %block_.L_40ad6d ], [ %299, %block_40ad7e ]
  %205 = add i64 %204, -44
  ...
  br i1 %239, label %block_40ad7e, label %block_.L_40ada8
...
block_40ad7e:                                     ; preds = %block_.L_40ad72
  ...
  %call2_40ad8b = tail call %struct.Memory* @sub_4014c0._Z18complete_hash_funcIdET_S0_(%struct.State* nonnull %0, i64 %253, %struct.Memory* %call2_40ad13)
...
block_.L_40ada8:                                  ; preds = %block_.L_40ad72
  ...
  %call2_40adad = tail call %struct.Memory* @sub_4014f0._Z9check_sumIdEvT_(%struct.State* nonnull %0, i64 %305, %struct.Memory* %call2_40ad13)
...
block_.L_40adc0:                                  ; preds = %block_.L_40ad1f
  ...
  %call2_40adc0 = tail call %struct.Memory* @sub_400e30._Z5timerv(%struct.State* nonnull %0, i64 %342, %struct.Memory* %call2_40ad13)
  ...
  %call2_40adc9 = tail call %struct.Memory* @sub_4007d0._Z13record_resultdPKc(%struct.State* nonnull %0, i64 %353, %struct.Memory* %call2_40adc0)
