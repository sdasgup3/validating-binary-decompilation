...
define %struct.Memory* @_Z27test_for_loop_unroll_factorILi16EdEvPKT0_iPKc(%struct.State* noalias, i64, %struct.Memory* noalias readnone) local_unnamed_addr #1 {
entry:
...
block_.L_40ad0f:                                  ; preds = %block_.L_40ad98, %entry
  %74 = phi i64 [ %341, %block_.L_40ad98 ], [ %.pre, %entry ]
...
block_.L_40ad2e:                                  ; preds = %block_40ad3f, %block_40ad1f
  %118 = phi i64 [ %202, %block_40ad3f ], [ %.pre9, %block_40ad1f ]
...
block_40ad3f:                                     ; preds = %block_.L_40ad2e
  ...
  %call2_40ad4a = tail call %struct.Memory* @sub_401bc0._ZN15loop_inner_bodyILi16EdE7do_workERdPKdi(%struct.State* nonnull %0, i64 %166, %struct.Memory* %call2_40ad03)
...
block_40ad6e:                                     ; preds = %block_.L_40ad62
  ...
  %call2_40ad7b = tail call %struct.Memory* @sub_4014b0._Z18complete_hash_funcIdET_S0_(%struct.State* nonnull %0, i64 %253, %struct.Memory* %call2_40ad03)
...
block_.L_40ad98:                                  ; preds = %block_.L_40ad62
  ...
  %call2_40ad9d = tail call %struct.Memory* @sub_4014e0._Z9check_sumIdEvT_(%struct.State* nonnull %0, i64 %305, %struct.Memory* %call2_40ad03)
...
block_.L_40adb0:                                  ; preds = %block_.L_40ad0f
  ...
  %call2_40adb0 = tail call %struct.Memory* @sub_400e20._Z5timerv(%struct.State* nonnull %0, i64 %342, %struct.Memory* %call2_40ad03)
