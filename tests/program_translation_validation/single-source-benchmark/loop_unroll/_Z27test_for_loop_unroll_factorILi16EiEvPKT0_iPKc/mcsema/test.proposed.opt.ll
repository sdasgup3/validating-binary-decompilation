...
define %struct.Memory* @_Z27test_for_loop_unroll_factorILi16EiEvPKT0_iPKc(%struct.State* noalias, i64, %struct.Memory* noalias readnone) local_unnamed_addr #1 {
entry:
...
block_.L_4153cf:                                  ; preds = %block_.L_415451, %entry
  %68 = phi i64 [ %362, %block_.L_415451 ], [ %.pre, %entry ]
...
block_.L_4153ed:                                  ; preds = %block_4153fe, %block_4153df
  %111 = phi i64 [ %195, %block_4153fe ], [ %.pre9, %block_4153df ]
...
block_4153fe:                                     ; preds = %block_.L_4153ed
  ...
  %call2_415409 = tail call %struct.Memory* @sub_40c780._ZN15loop_inner_bodyILi16EiE7do_workERiPKii(%struct.State* nonnull %0, i64 %159, %struct.Memory* %call2_4153c3)
...
block_41542d:                                     ; preds = %block_.L_415421
  ...
  %call2_415438 = tail call %struct.Memory* @sub_40c100._Z18complete_hash_funcIiET_S0_(%struct.State* nonnull %0, i64 %247, %struct.Memory* %call2_4153c3)
...
block_.L_415451:                                  ; preds = %block_.L_415421
  ...
  %call2_415454 = tail call %struct.Memory* @sub_40c130._Z9check_sumIiEvT_(%struct.State* nonnull %0, i64 %326, %struct.Memory* %call2_4153c3)
...
block_.L_415467:                                  ; preds = %block_.L_4153cf
  ...
  %call2_415467 = tail call %struct.Memory* @sub_400e20._Z5timerv(%struct.State* nonnull %0, i64 %363, %struct.Memory* %call2_4153c3)
