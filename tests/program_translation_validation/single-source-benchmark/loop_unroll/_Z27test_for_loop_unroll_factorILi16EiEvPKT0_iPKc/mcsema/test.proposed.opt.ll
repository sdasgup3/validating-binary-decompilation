...
entry:
  ...
  %call2_415393 = tail call %struct.Memory* @sub_400dd0._Z11start_timerv(%struct.State* %0, i64 %58, %struct.Memory* %2)
...
block_.L_41539f:                                  ; preds = %block_.L_415421, %entry
  %68 = phi i64 [ %.pre, %entry ], [ %362, %block_.L_415421 ]
  %MEMORY.0 = phi %struct.Memory* [ %call2_415393, %entry ], [ %call2_415424, %block_.L_415421 ]
  ...
  br i1 %101, label %block_4153af, label %block_.L_415437

block_4153af:                                     ; preds = %block_.L_41539f
  %103 = add i64 %69, -32
  %104 = add i64 %102, 7
...
block_.L_4153bd:                                  ; preds = %block_4153ce, %block_4153af
  %111 = phi i64 [ %.pre1, %block_4153af ], [ %195, %block_4153ce ]
  %MEMORY.1 = phi %struct.Memory* [ %MEMORY.0, %block_4153af ], [ %call2_4153d9, %block_4153ce ]
  ...
  br i1 %149, label %block_4153ce, label %block_.L_4153ec

block_4153ce:                                     ; preds = %block_.L_4153bd
  %151 = add i64 %112, -32
  ...
  %call2_4153d9 = tail call %struct.Memory* @sub_40c750._ZN15loop_inner_bodyILi16EiE7do_workERiPKii(%struct.State* %0, i64 %159, %struct.Memory* %MEMORY.1)
...
block_.L_4153ec:                                  ; preds = %block_.L_4153bd
  %196 = add i64 %150, 5
  store i64 %196, i64* %3, align 8
  br label %block_.L_4153f1

block_.L_4153f1:                                  ; preds = %block_4153fd, %block_.L_4153ec
  %197 = phi i64 [ %196, %block_.L_4153ec ], [ %320, %block_4153fd ]
  %198 = phi i64 [ %112, %block_.L_4153ec ], [ %.pre2, %block_4153fd ]
  %MEMORY.2 = phi %struct.Memory* [ %MEMORY.1, %block_.L_4153ec ], [ %call2_415408, %block_4153fd ]
  %199 = add i64 %198, -36
  %200 = add i64 %197, 3
  ...
  br i1 %233, label %block_4153fd, label %block_.L_415421

block_4153fd:                                     ; preds = %block_.L_4153f1
  %235 = add i64 %198, -8
  %236 = add i64 %234, 4
  ...
  %call2_415408 = tail call %struct.Memory* @sub_40c0d0._Z18complete_hash_funcIiET_S0_(%struct.State* %0, i64 %248, %struct.Memory* %MEMORY.2)
...
block_.L_415421:                                  ; preds = %block_.L_4153f1
  %321 = add i64 %198, -32
  %322 = add i64 %234, 3
  ...
  %call2_415424 = tail call %struct.Memory* @sub_40c100._Z9check_sumIiEvT_(%struct.State* %0, i64 %326, %struct.Memory* %MEMORY.2)
...
block_.L_415437:                                  ; preds = %block_.L_41539f
  ...
  %call2_415437 = tail call %struct.Memory* @sub_400df0._Z5timerv(%struct.State* %0, i64 %363, %struct.Memory* %MEMORY.0)
  ...
  %call2_415440 = tail call %struct.Memory* @sub_400790._Z13record_resultdPKc(%struct.State* %0, i64 %374, %struct.Memory* %call2_415437)
  ...
  ret %struct.Memory* %call2_415440
}
...
define %struct.Memory* @routine_jge_.L_415437(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i8* %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
...
define %struct.Memory* @routine_jge_.L_4153ec(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i8* %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 2, i32 9
...
define %struct.Memory* @routine_jmpq_.L_4153bd(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
...
define %struct.Memory* @routine_jmpq_.L_4153f1(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
...
define %struct.Memory* @routine_jge_.L_415421(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i8* %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 2, i32 9
...
define %struct.Memory* @routine_jmpq_.L_41539f(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
