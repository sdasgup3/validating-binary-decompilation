...
entry:
  ...
  %call2_4153d3 = tail call %struct.Memory* @sub_400e10._Z11start_timerv(%struct.State* %0, i64 %58, %struct.Memory* %2)
...
block_.L_4153df:                                  ; preds = %block_.L_415461, %entry
  %68 = phi i64 [ %362, %block_.L_415461 ], [ %.pre, %entry ]
  ...
  br i1 %101, label %block_4153ef, label %block_.L_415477

block_4153ef:                                     ; preds = %block_.L_4153df
  %103 = add i64 %69, -32
  %104 = add i64 %102, 7
...
block_.L_4153fd:                                  ; preds = %block_41540e, %block_4153ef
  %111 = phi i64 [ %195, %block_41540e ], [ %.pre9, %block_4153ef ]
  ...
  br i1 %149, label %block_41540e, label %block_.L_41542c

block_41540e:                                     ; preds = %block_.L_4153fd
  %151 = add i64 %112, -32
  ...
  %call2_415419 = tail call %struct.Memory* @sub_40c790._ZN15loop_inner_bodyILi16EiE7do_workERiPKii(%struct.State* nonnull %0, i64 %159, %struct.Memory* %call2_4153d3)
...
block_.L_41542c:                                  ; preds = %block_.L_4153fd
  %196 = add i64 %150, 5
  br label %block_.L_415431

block_.L_415431:                                  ; preds = %block_41543d, %block_.L_41542c
  %197 = phi i64 [ %112, %block_.L_41542c ], [ %.pre10, %block_41543d ]
  %storemerge = phi i64 [ %196, %block_.L_41542c ], [ %319, %block_41543d ]
  %198 = add i64 %197, -36
  ...
  br i1 %232, label %block_41543d, label %block_.L_415461
...
block_41543d:                                     ; preds = %block_.L_415431
  ...
  %call2_415448 = tail call %struct.Memory* @sub_40c110._Z18complete_hash_funcIiET_S0_(%struct.State* nonnull %0, i64 %247, %struct.Memory* %call2_4153d3)
...
block_.L_415461:                                  ; preds = %block_.L_415431
  ...
  %call2_415464 = tail call %struct.Memory* @sub_40c140._Z9check_sumIiEvT_(%struct.State* nonnull %0, i64 %326, %struct.Memory* %call2_4153d3)
...
block_.L_415477:                                  ; preds = %block_.L_4153df
  ...
  %call2_415477 = tail call %struct.Memory* @sub_400e30._Z5timerv(%struct.State* nonnull %0, i64 %363, %struct.Memory* %call2_4153d3)
  ...
  %call2_415480 = tail call %struct.Memory* @sub_4007d0._Z13record_resultdPKc(%struct.State* nonnull %0, i64 %374, %struct.Memory* %call2_415477)
