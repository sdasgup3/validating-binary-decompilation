...
block_.L_41539f:                                  ; preds = %block_.L_415421, %entry
  %68 = phi i64 [ %.pre, %entry ], [ %364, %block_.L_415421 ]
...
block_.L_4153f1:                                  ; preds = %block_4153fd, %block_.L_4153ec
  %197 = phi i64 [ %196, %block_.L_4153ec ], [ %321, %block_4153fd ]
...
block_.L_415421:                                  ; preds = %block_.L_4153f1
  ...
  %call2_415424 = tail call %struct.Memory* @sub_40c100._Z9check_sumIiEvT_(%struct.State* %0, i64 %327, %struct.Memory* %MEMORY.2)
...
block_.L_415437:                                  ; preds = %block_.L_41539f
  ...
  %call2_415437 = tail call %struct.Memory* @sub_400df0._Z5timerv(%struct.State* %0, i64 %365, %struct.Memory* %MEMORY.0)
  ...
  %call2_415440 = tail call %struct.Memory* @sub_400790._Z13record_resultdPKc(%struct.State* %0, i64 %376, %struct.Memory* %call2_415437)
