...
declare %struct.Memory* @sub_401b70._ZN15loop_inner_bodyILi17EdE7do_workERdPKdi(%struct.State* noalias dereferenceable(3376), i64, %struct.Memory* noalias readnone returned) local_unnamed_addr
...
define %struct.Memory* @_Z27test_for_loop_unroll_factorILi17EdEvPKT0_iPKc(%struct.State* noalias, i64, %struct.Memory* noalias readnone) local_unnamed_addr #1 {
entry:
  ...
  %call2_40abe3 = tail call %struct.Memory* @sub_400e10._Z11start_timerv(%struct.State* %0, i64 %58, %struct.Memory* %2)
  ...
  br label %block_.L_40abef

block_.L_40abef:                                  ; preds = %block_.L_40ac78, %entry
  %74 = phi i64 [ %341, %block_.L_40ac78 ], [ %.pre, %entry ]
  ...
  br i1 %107, label %block_40abff, label %block_.L_40ac90

block_40abff:                                     ; preds = %block_.L_40abef
...
block_.L_40ac0e:                                  ; preds = %block_40ac1f, %block_40abff
  %118 = phi i64 [ %202, %block_40ac1f ], [ %.pre9, %block_40abff ]
  ...
  br i1 %156, label %block_40ac1f, label %block_.L_40ac3d

block_40ac1f:                                     ; preds = %block_.L_40ac0e
  %158 = add i64 %119, -40
  ...
  %call2_40ac2a = tail call %struct.Memory* @sub_401b70._ZN15loop_inner_bodyILi17EdE7do_workERdPKdi(%struct.State* nonnull %0, i64 %166, %struct.Memory* %call2_40abe3)
...
block_.L_40ac3d:                                  ; preds = %block_.L_40ac0e
  %203 = add i64 %157, 5
  br label %block_.L_40ac42

block_.L_40ac42:                                  ; preds = %block_40ac4e, %block_.L_40ac3d
  %204 = phi i64 [ %119, %block_.L_40ac3d ], [ %.pre10, %block_40ac4e ]
  %storemerge = phi i64 [ %203, %block_.L_40ac3d ], [ %299, %block_40ac4e ]
  %205 = add i64 %204, -44
  ...
  br i1 %239, label %block_40ac4e, label %block_.L_40ac78
...
block_40ac4e:                                     ; preds = %block_.L_40ac42
  ...
  %call2_40ac5b = tail call %struct.Memory* @sub_4014c0._Z18complete_hash_funcIdET_S0_(%struct.State* nonnull %0, i64 %253, %struct.Memory* %call2_40abe3)
...
block_.L_40ac78:                                  ; preds = %block_.L_40ac42
  ...
  %call2_40ac7d = tail call %struct.Memory* @sub_4014f0._Z9check_sumIdEvT_(%struct.State* nonnull %0, i64 %305, %struct.Memory* %call2_40abe3)
...
block_.L_40ac90:                                  ; preds = %block_.L_40abef
  ...
  %call2_40ac90 = tail call %struct.Memory* @sub_400e30._Z5timerv(%struct.State* nonnull %0, i64 %342, %struct.Memory* %call2_40abe3)
  ...
  %call2_40ac99 = tail call %struct.Memory* @sub_4007d0._Z13record_resultdPKc(%struct.State* nonnull %0, i64 %353, %struct.Memory* %call2_40ac90)
