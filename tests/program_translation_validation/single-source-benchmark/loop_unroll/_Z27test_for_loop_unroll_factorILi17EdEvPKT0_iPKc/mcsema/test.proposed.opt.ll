...
block_.L_40abaf:                                  ; preds = %block_.L_40ac38, %entry
  %79 = phi i64 [ %.pre, %entry ], [ %346, %block_.L_40ac38 ]
...
block_.L_40ac02:                                  ; preds = %block_40ac0e, %block_.L_40abfd
  %210 = phi i64 [ %209, %block_.L_40abfd ], [ %305, %block_40ac0e ]
...
block_40ac0e:                                     ; preds = %block_.L_40ac02
  ...
  %call2_40ac1b = tail call %struct.Memory* @sub_401480._Z18complete_hash_funcIdET_S0_(%struct.State* %0, i64 %260, %struct.Memory* %MEMORY.2)
...
block_.L_40ac38:                                  ; preds = %block_.L_40ac02
  ...
  %call2_40ac3d = tail call %struct.Memory* @sub_4014b0._Z9check_sumIdEvT_(%struct.State* %0, i64 %310, %struct.Memory* %MEMORY.2)
...
block_.L_40ac50:                                  ; preds = %block_.L_40abaf
  ...
  %call2_40ac50 = tail call %struct.Memory* @sub_400df0._Z5timerv(%struct.State* %0, i64 %347, %struct.Memory* %MEMORY.0)
  ...
  %call2_40ac59 = tail call %struct.Memory* @sub_400790._Z13record_resultdPKc(%struct.State* %0, i64 %358, %struct.Memory* %call2_40ac50)
