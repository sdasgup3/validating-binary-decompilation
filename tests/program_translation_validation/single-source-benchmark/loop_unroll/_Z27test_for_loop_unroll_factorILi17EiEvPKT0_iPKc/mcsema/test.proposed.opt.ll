...
entry:
  ...
  %call2_415273 = tail call %struct.Memory* @sub_400dd0._Z11start_timerv(%struct.State* %0, i64 %58, %struct.Memory* %2)
...
block_.L_41527f:                                  ; preds = %block_.L_415301, %entry
  %68 = phi i64 [ %.pre, %entry ], [ %362, %block_.L_415301 ]
  %MEMORY.0 = phi %struct.Memory* [ %call2_415273, %entry ], [ %call2_415304, %block_.L_415301 ]
  ...
  br i1 %101, label %block_41528f, label %block_.L_415317
...
block_.L_41529d:                                  ; preds = %block_4152ae, %block_41528f
  %111 = phi i64 [ %.pre1, %block_41528f ], [ %195, %block_4152ae ]
  %MEMORY.1 = phi %struct.Memory* [ %MEMORY.0, %block_41528f ], [ %call2_4152b9, %block_4152ae ]
  ...
  br i1 %149, label %block_4152ae, label %block_.L_4152cc
...
block_4152ae:                                     ; preds = %block_.L_41529d
  ...
  %call2_4152b9 = tail call %struct.Memory* @sub_40c6f0._ZN15loop_inner_bodyILi17EiE7do_workERiPKii(%struct.State* %0, i64 %159, %struct.Memory* %MEMORY.1)
...
block_.L_4152d1:                                  ; preds = %block_4152dd, %block_.L_4152cc
  %197 = phi i64 [ %196, %block_.L_4152cc ], [ %320, %block_4152dd ]
  %198 = phi i64 [ %112, %block_.L_4152cc ], [ %.pre2, %block_4152dd ]
  %MEMORY.2 = phi %struct.Memory* [ %MEMORY.1, %block_.L_4152cc ], [ %call2_4152e8, %block_4152dd ]
  %199 = add i64 %198, -36
  %200 = add i64 %197, 3
  ...
  br i1 %233, label %block_4152dd, label %block_.L_415301
...
block_4152dd:                                     ; preds = %block_.L_4152d1
  ...
  %call2_4152e8 = tail call %struct.Memory* @sub_40c0d0._Z18complete_hash_funcIiET_S0_(%struct.State* %0, i64 %248, %struct.Memory* %MEMORY.2)
...
block_.L_415301:                                  ; preds = %block_.L_4152d1
  ...
  %call2_415304 = tail call %struct.Memory* @sub_40c100._Z9check_sumIiEvT_(%struct.State* %0, i64 %326, %struct.Memory* %MEMORY.2)
...
block_.L_415317:                                  ; preds = %block_.L_41527f
  ...
  %call2_415317 = tail call %struct.Memory* @sub_400df0._Z5timerv(%struct.State* %0, i64 %363, %struct.Memory* %MEMORY.0)
  ...
  %call2_415320 = tail call %struct.Memory* @sub_400790._Z13record_resultdPKc(%struct.State* %0, i64 %374, %struct.Memory* %call2_415317)
  ...
  ret %struct.Memory* %call2_415320
}
...
define %struct.Memory* @routine_jge_.L_415317(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i8* %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
...
define %struct.Memory* @routine_jge_.L_4152cc(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i8* %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 2, i32 9
...
define %struct.Memory* @routine_jmpq_.L_41529d(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
...
define %struct.Memory* @routine_jmpq_.L_4152d1(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
...
define %struct.Memory* @routine_jge_.L_415301(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i8* %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 2, i32 9
...
define %struct.Memory* @routine_jmpq_.L_41527f(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
