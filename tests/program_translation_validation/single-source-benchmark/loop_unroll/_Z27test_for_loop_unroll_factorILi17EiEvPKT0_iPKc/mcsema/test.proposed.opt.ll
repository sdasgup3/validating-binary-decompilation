...
block_.L_41527f:                                  ; preds = %block_.L_415301, %entry
  %68 = phi i64 [ %.pre, %entry ], [ %364, %block_.L_415301 ]
...
block_.L_4152d1:                                  ; preds = %block_4152dd, %block_.L_4152cc
  %197 = phi i64 [ %196, %block_.L_4152cc ], [ %321, %block_4152dd ]
...
block_.L_415301:                                  ; preds = %block_.L_4152d1
  ...
  %call2_415304 = tail call %struct.Memory* @sub_40c100._Z9check_sumIiEvT_(%struct.State* %0, i64 %327, %struct.Memory* %MEMORY.2)
...
block_.L_415317:                                  ; preds = %block_.L_41527f
  ...
  %call2_415317 = tail call %struct.Memory* @sub_400df0._Z5timerv(%struct.State* %0, i64 %365, %struct.Memory* %MEMORY.0)
  ...
  %call2_415320 = tail call %struct.Memory* @sub_400790._Z13record_resultdPKc(%struct.State* %0, i64 %376, %struct.Memory* %call2_415317)
