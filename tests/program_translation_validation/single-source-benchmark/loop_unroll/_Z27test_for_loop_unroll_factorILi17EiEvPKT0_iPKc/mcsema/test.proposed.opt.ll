...
entry:
  ...
  %call2_4152b3 = tail call %struct.Memory* @sub_400e10._Z11start_timerv(%struct.State* %0, i64 %58, %struct.Memory* %2)
...
block_.L_4152bf:                                  ; preds = %block_.L_415341, %entry
  %68 = phi i64 [ %362, %block_.L_415341 ], [ %.pre, %entry ]
  ...
  br i1 %101, label %block_4152cf, label %block_.L_415357
...
block_.L_4152dd:                                  ; preds = %block_4152ee, %block_4152cf
  %111 = phi i64 [ %195, %block_4152ee ], [ %.pre9, %block_4152cf ]
  ...
  br i1 %149, label %block_4152ee, label %block_.L_41530c
...
block_4152ee:                                     ; preds = %block_.L_4152dd
  ...
  %call2_4152f9 = tail call %struct.Memory* @sub_40c730._ZN15loop_inner_bodyILi17EiE7do_workERiPKii(%struct.State* nonnull %0, i64 %159, %struct.Memory* %call2_4152b3)
...
block_.L_415311:                                  ; preds = %block_41531d, %block_.L_41530c
  %197 = phi i64 [ %112, %block_.L_41530c ], [ %.pre10, %block_41531d ]
  %storemerge = phi i64 [ %196, %block_.L_41530c ], [ %319, %block_41531d ]
  %198 = add i64 %197, -36
  ...
  br i1 %232, label %block_41531d, label %block_.L_415341
...
block_41531d:                                     ; preds = %block_.L_415311
  ...
  %call2_415328 = tail call %struct.Memory* @sub_40c110._Z18complete_hash_funcIiET_S0_(%struct.State* nonnull %0, i64 %247, %struct.Memory* %call2_4152b3)
...
block_.L_415341:                                  ; preds = %block_.L_415311
  ...
  %call2_415344 = tail call %struct.Memory* @sub_40c140._Z9check_sumIiEvT_(%struct.State* nonnull %0, i64 %326, %struct.Memory* %call2_4152b3)
...
block_.L_415357:                                  ; preds = %block_.L_4152bf
  ...
  %call2_415357 = tail call %struct.Memory* @sub_400e30._Z5timerv(%struct.State* nonnull %0, i64 %363, %struct.Memory* %call2_4152b3)
  ...
  %call2_415360 = tail call %struct.Memory* @sub_4007d0._Z13record_resultdPKc(%struct.State* nonnull %0, i64 %374, %struct.Memory* %call2_415357)
