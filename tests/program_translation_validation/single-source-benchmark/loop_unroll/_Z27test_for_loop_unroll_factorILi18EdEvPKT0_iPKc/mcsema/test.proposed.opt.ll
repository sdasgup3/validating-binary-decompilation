...
entry:
  ...
  %call2_40aa73 = tail call %struct.Memory* @sub_400dd0._Z11start_timerv(%struct.State* %0, i64 %58, %struct.Memory* %2)
...
block_.L_40aa7f:                                  ; preds = %block_.L_40ab08, %entry
  %79 = phi i64 [ %.pre, %entry ], [ %346, %block_.L_40ab08 ]
  %MEMORY.0 = phi %struct.Memory* [ %call2_40aa73, %entry ], [ %call2_40ab0d, %block_.L_40ab08 ]
  ...
  br i1 %112, label %block_40aa8f, label %block_.L_40ab20
...
block_.L_40aa9e:                                  ; preds = %block_40aaaf, %block_40aa8f
  %124 = phi i64 [ %.pre1, %block_40aa8f ], [ %208, %block_40aaaf ]
  %MEMORY.1 = phi %struct.Memory* [ %MEMORY.0, %block_40aa8f ], [ %call2_40aaba, %block_40aaaf ]
  ...
  br i1 %162, label %block_40aaaf, label %block_.L_40aacd
...
block_40aaaf:                                     ; preds = %block_.L_40aa9e
  ...
  %call2_40aaba = tail call %struct.Memory* @sub_401ad0._ZN15loop_inner_bodyILi18EdE7do_workERdPKdi(%struct.State* %0, i64 %172, %struct.Memory* %MEMORY.1)
...
block_.L_40aad2:                                  ; preds = %block_40aade, %block_.L_40aacd
  %210 = phi i64 [ %209, %block_.L_40aacd ], [ %305, %block_40aade ]
  %211 = phi i64 [ %125, %block_.L_40aacd ], [ %.pre2, %block_40aade ]
  %MEMORY.2 = phi %struct.Memory* [ %MEMORY.1, %block_.L_40aacd ], [ %call2_40aaeb, %block_40aade ]
  %212 = add i64 %211, -44
  %213 = add i64 %210, 3
  ...
  br i1 %246, label %block_40aade, label %block_.L_40ab08
...
block_40aade:                                     ; preds = %block_.L_40aad2
  ...
  %call2_40aaeb = tail call %struct.Memory* @sub_401480._Z18complete_hash_funcIdET_S0_(%struct.State* %0, i64 %260, %struct.Memory* %MEMORY.2)
...
block_.L_40ab08:                                  ; preds = %block_.L_40aad2
  ...
  %call2_40ab0d = tail call %struct.Memory* @sub_4014b0._Z9check_sumIdEvT_(%struct.State* %0, i64 %310, %struct.Memory* %MEMORY.2)
...
block_.L_40ab20:                                  ; preds = %block_.L_40aa7f
  ...
  %call2_40ab20 = tail call %struct.Memory* @sub_400df0._Z5timerv(%struct.State* %0, i64 %347, %struct.Memory* %MEMORY.0)
  ...
  %call2_40ab29 = tail call %struct.Memory* @sub_400790._Z13record_resultdPKc(%struct.State* %0, i64 %358, %struct.Memory* %call2_40ab20)
  ...
  ret %struct.Memory* %call2_40ab29
}
...
define %struct.Memory* @routine_jge_.L_40ab20(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i8* %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
...
define %struct.Memory* @routine_jge_.L_40aacd(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i8* %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 2, i32 9
...
define %struct.Memory* @routine_jmpq_.L_40aa9e(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
...
define %struct.Memory* @routine_jmpq_.L_40aad2(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
...
define %struct.Memory* @routine_jge_.L_40ab08(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i8* %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 2, i32 9
...
define %struct.Memory* @routine_jmpq_.L_40aa7f(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
