...
entry:
  ...
  %call2_415193 = tail call %struct.Memory* @sub_400e10._Z11start_timerv(%struct.State* %0, i64 %58, %struct.Memory* %2)
...
block_.L_41519f:                                  ; preds = %block_.L_415221, %entry
  %68 = phi i64 [ %362, %block_.L_415221 ], [ %.pre, %entry ]
  ...
  br i1 %101, label %block_4151af, label %block_.L_415237
...
block_.L_4151bd:                                  ; preds = %block_4151ce, %block_4151af
  %111 = phi i64 [ %195, %block_4151ce ], [ %.pre9, %block_4151af ]
  ...
  br i1 %149, label %block_4151ce, label %block_.L_4151ec
...
block_4151ce:                                     ; preds = %block_.L_4151bd
  ...
  %call2_4151d9 = tail call %struct.Memory* @sub_40c6d0._ZN15loop_inner_bodyILi18EiE7do_workERiPKii(%struct.State* nonnull %0, i64 %159, %struct.Memory* %call2_415193)
...
block_.L_4151f1:                                  ; preds = %block_4151fd, %block_.L_4151ec
  %197 = phi i64 [ %112, %block_.L_4151ec ], [ %.pre10, %block_4151fd ]
  %storemerge = phi i64 [ %196, %block_.L_4151ec ], [ %319, %block_4151fd ]
  %198 = add i64 %197, -36
  ...
  br i1 %232, label %block_4151fd, label %block_.L_415221
...
block_4151fd:                                     ; preds = %block_.L_4151f1
  ...
  %call2_415208 = tail call %struct.Memory* @sub_40c110._Z18complete_hash_funcIiET_S0_(%struct.State* nonnull %0, i64 %247, %struct.Memory* %call2_415193)
...
block_.L_415221:                                  ; preds = %block_.L_4151f1
  ...
  %call2_415224 = tail call %struct.Memory* @sub_40c140._Z9check_sumIiEvT_(%struct.State* nonnull %0, i64 %326, %struct.Memory* %call2_415193)
...
block_.L_415237:                                  ; preds = %block_.L_41519f
  ...
  %call2_415237 = tail call %struct.Memory* @sub_400e30._Z5timerv(%struct.State* nonnull %0, i64 %363, %struct.Memory* %call2_415193)
  ...
  %call2_415240 = tail call %struct.Memory* @sub_4007d0._Z13record_resultdPKc(%struct.State* nonnull %0, i64 %374, %struct.Memory* %call2_415237)
