...
define %struct.Memory* @_Z27test_for_loop_unroll_factorILi18EiEvPKT0_iPKc(%struct.State* noalias, i64, %struct.Memory* noalias) local_unnamed_addr #1 {
entry:
  ...
  %call2_415153 = tail call %struct.Memory* @sub_400dd0._Z11start_timerv(%struct.State* %0, i64 %58, %struct.Memory* %2)
...
block_.L_41515f:                                  ; preds = %block_.L_4151e1, %entry
  %68 = phi i64 [ %.pre, %entry ], [ %362, %block_.L_4151e1 ]
  %MEMORY.0 = phi %struct.Memory* [ %call2_415153, %entry ], [ %call2_4151e4, %block_.L_4151e1 ]
  ...
  br i1 %101, label %block_41516f, label %block_.L_4151f7
...
block_.L_41517d:                                  ; preds = %block_41518e, %block_41516f
  %111 = phi i64 [ %.pre1, %block_41516f ], [ %195, %block_41518e ]
  %MEMORY.1 = phi %struct.Memory* [ %MEMORY.0, %block_41516f ], [ %call2_415199, %block_41518e ]
  ...
  br i1 %149, label %block_41518e, label %block_.L_4151ac
...
block_41518e:                                     ; preds = %block_.L_41517d
  ...
  %call2_415199 = tail call %struct.Memory* @sub_40c690._ZN15loop_inner_bodyILi18EiE7do_workERiPKii(%struct.State* %0, i64 %159, %struct.Memory* %MEMORY.1)
...
block_.L_4151b1:                                  ; preds = %block_4151bd, %block_.L_4151ac
  %197 = phi i64 [ %196, %block_.L_4151ac ], [ %320, %block_4151bd ]
  %198 = phi i64 [ %112, %block_.L_4151ac ], [ %.pre2, %block_4151bd ]
  %MEMORY.2 = phi %struct.Memory* [ %MEMORY.1, %block_.L_4151ac ], [ %call2_4151c8, %block_4151bd ]
  %199 = add i64 %198, -36
  %200 = add i64 %197, 3
  ...
  br i1 %233, label %block_4151bd, label %block_.L_4151e1
...
block_4151bd:                                     ; preds = %block_.L_4151b1
  ...
  %call2_4151c8 = tail call %struct.Memory* @sub_40c0d0._Z18complete_hash_funcIiET_S0_(%struct.State* %0, i64 %248, %struct.Memory* %MEMORY.2)
...
block_.L_4151e1:                                  ; preds = %block_.L_4151b1
  ...
  %call2_4151e4 = tail call %struct.Memory* @sub_40c100._Z9check_sumIiEvT_(%struct.State* %0, i64 %326, %struct.Memory* %MEMORY.2)
...
block_.L_4151f7:                                  ; preds = %block_.L_41515f
  ...
  %call2_4151f7 = tail call %struct.Memory* @sub_400df0._Z5timerv(%struct.State* %0, i64 %363, %struct.Memory* %MEMORY.0)
  ...
  %call2_415200 = tail call %struct.Memory* @sub_400790._Z13record_resultdPKc(%struct.State* %0, i64 %374, %struct.Memory* %call2_4151f7)
  ...
  ret %struct.Memory* %call2_415200
}
...
define %struct.Memory* @routine_jge_.L_4151f7(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i8* %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
...
define %struct.Memory* @routine_jge_.L_4151ac(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i8* %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 2, i32 9
...
define %struct.Memory* @routine_addl__0x12___eax(%struct.State* dereferenceable(3376), i64, %struct.Memory*) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %RAX = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 1, i32 0, i32 0
...
define %struct.Memory* @routine_jmpq_.L_41517d(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
...
define %struct.Memory* @routine_jmpq_.L_4151b1(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
...
define %struct.Memory* @routine_jge_.L_4151e1(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i8* %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 2, i32 9
...
define %struct.Memory* @routine_jmpq_.L_41515f(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
