...
block_.L_41515f:                                  ; preds = %block_.L_4151e1, %entry
  %68 = phi i64 [ %.pre, %entry ], [ %364, %block_.L_4151e1 ]
...
block_.L_4151b1:                                  ; preds = %block_4151bd, %block_.L_4151ac
  %197 = phi i64 [ %196, %block_.L_4151ac ], [ %321, %block_4151bd ]
...
block_.L_4151e1:                                  ; preds = %block_.L_4151b1
  ...
  %call2_4151e4 = tail call %struct.Memory* @sub_40c100._Z9check_sumIiEvT_(%struct.State* %0, i64 %327, %struct.Memory* %MEMORY.2)
...
block_.L_4151f7:                                  ; preds = %block_.L_41515f
  ...
  %call2_4151f7 = tail call %struct.Memory* @sub_400df0._Z5timerv(%struct.State* %0, i64 %365, %struct.Memory* %MEMORY.0)
  ...
  %call2_415200 = tail call %struct.Memory* @sub_400790._Z13record_resultdPKc(%struct.State* %0, i64 %376, %struct.Memory* %call2_4151f7)
