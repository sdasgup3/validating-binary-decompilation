...
define %struct.Memory* @_Z27test_for_loop_unroll_factorILi18EiEvPKT0_iPKc(%struct.State* noalias, i64, %struct.Memory* noalias readnone) local_unnamed_addr #1 {
entry:
...
block_.L_41518f:                                  ; preds = %block_.L_415211, %entry
  %68 = phi i64 [ %362, %block_.L_415211 ], [ %.pre, %entry ]
...
block_.L_4151ad:                                  ; preds = %block_4151be, %block_41519f
  %111 = phi i64 [ %195, %block_4151be ], [ %.pre9, %block_41519f ]
...
block_4151be:                                     ; preds = %block_.L_4151ad
  ...
  %call2_4151c9 = tail call %struct.Memory* @sub_40c6c0._ZN15loop_inner_bodyILi18EiE7do_workERiPKii(%struct.State* nonnull %0, i64 %159, %struct.Memory* %call2_415183)
...
block_4151ed:                                     ; preds = %block_.L_4151e1
  ...
  %call2_4151f8 = tail call %struct.Memory* @sub_40c100._Z18complete_hash_funcIiET_S0_(%struct.State* nonnull %0, i64 %247, %struct.Memory* %call2_415183)
...
block_.L_415211:                                  ; preds = %block_.L_4151e1
  ...
  %call2_415214 = tail call %struct.Memory* @sub_40c130._Z9check_sumIiEvT_(%struct.State* nonnull %0, i64 %326, %struct.Memory* %call2_415183)
...
block_.L_415227:                                  ; preds = %block_.L_41518f
  ...
  %call2_415227 = tail call %struct.Memory* @sub_400e20._Z5timerv(%struct.State* nonnull %0, i64 %363, %struct.Memory* %call2_415183)
