...
block_.L_40a97f:                                  ; preds = %block_.L_40aa08, %entry
  %74 = phi i64 [ %.pre, %entry ], [ %341, %block_.L_40aa08 ]
  %MEMORY.0 = phi %struct.Memory* [ %call2_40a973, %entry ], [ %call2_40aa0d, %block_.L_40aa08 ]
...
block_.L_40a99e:                                  ; preds = %block_40a9af, %block_40a98f
  %118 = phi i64 [ %.pre9, %block_40a98f ], [ %202, %block_40a9af ]
  %MEMORY.1 = phi %struct.Memory* [ %MEMORY.0, %block_40a98f ], [ %call2_40a9ba, %block_40a9af ]
...
block_40a9af:                                     ; preds = %block_.L_40a99e
  ...
  %call2_40a9ba = tail call %struct.Memory* @sub_401aa0._ZN15loop_inner_bodyILi19EdE7do_workERdPKdi(%struct.State* nonnull %0, i64 %166, %struct.Memory* %MEMORY.1)
...
block_.L_40a9d2:                                  ; preds = %block_40a9de, %block_.L_40a9cd
  ...
  %MEMORY.2 = phi %struct.Memory* [ %MEMORY.1, %block_.L_40a9cd ], [ %call2_40a9eb, %block_40a9de ]
  %205 = add i64 %204, -44
...
block_40a9de:                                     ; preds = %block_.L_40a9d2
  ...
  %call2_40a9eb = tail call %struct.Memory* @sub_4014b0._Z18complete_hash_funcIdET_S0_(%struct.State* nonnull %0, i64 %253, %struct.Memory* %MEMORY.2)
...
block_.L_40aa08:                                  ; preds = %block_.L_40a9d2
  ...
  %call2_40aa0d = tail call %struct.Memory* @sub_4014e0._Z9check_sumIdEvT_(%struct.State* nonnull %0, i64 %305, %struct.Memory* %MEMORY.2)
...
block_.L_40aa20:                                  ; preds = %block_.L_40a97f
  ...
  %call2_40aa20 = tail call %struct.Memory* @sub_400e20._Z5timerv(%struct.State* nonnull %0, i64 %342, %struct.Memory* %MEMORY.0)
