...
entry:
  ...
  %call2_40a983 = tail call %struct.Memory* @sub_400e10._Z11start_timerv(%struct.State* %0, i64 %58, %struct.Memory* %2)
...
block_.L_40a98f:                                  ; preds = %block_.L_40aa18, %entry
  %74 = phi i64 [ %341, %block_.L_40aa18 ], [ %.pre, %entry ]
  ...
  br i1 %107, label %block_40a99f, label %block_.L_40aa30

block_40a99f:                                     ; preds = %block_.L_40a98f
...
block_.L_40a9ae:                                  ; preds = %block_40a9bf, %block_40a99f
  %118 = phi i64 [ %202, %block_40a9bf ], [ %.pre9, %block_40a99f ]
  ...
  br i1 %156, label %block_40a9bf, label %block_.L_40a9dd

block_40a9bf:                                     ; preds = %block_.L_40a9ae
  %158 = add i64 %119, -40
  ...
  %call2_40a9ca = tail call %struct.Memory* @sub_401ab0._ZN15loop_inner_bodyILi19EdE7do_workERdPKdi(%struct.State* nonnull %0, i64 %166, %struct.Memory* %call2_40a983)
...
block_.L_40a9dd:                                  ; preds = %block_.L_40a9ae
  %203 = add i64 %157, 5
  br label %block_.L_40a9e2

block_.L_40a9e2:                                  ; preds = %block_40a9ee, %block_.L_40a9dd
  %204 = phi i64 [ %119, %block_.L_40a9dd ], [ %.pre10, %block_40a9ee ]
  %storemerge = phi i64 [ %203, %block_.L_40a9dd ], [ %299, %block_40a9ee ]
  %205 = add i64 %204, -44
  ...
  br i1 %239, label %block_40a9ee, label %block_.L_40aa18
...
block_40a9ee:                                     ; preds = %block_.L_40a9e2
  ...
  %call2_40a9fb = tail call %struct.Memory* @sub_4014c0._Z18complete_hash_funcIdET_S0_(%struct.State* nonnull %0, i64 %253, %struct.Memory* %call2_40a983)
...
block_.L_40aa18:                                  ; preds = %block_.L_40a9e2
  ...
  %call2_40aa1d = tail call %struct.Memory* @sub_4014f0._Z9check_sumIdEvT_(%struct.State* nonnull %0, i64 %305, %struct.Memory* %call2_40a983)
...
block_.L_40aa30:                                  ; preds = %block_.L_40a98f
  ...
  %call2_40aa30 = tail call %struct.Memory* @sub_400e30._Z5timerv(%struct.State* nonnull %0, i64 %342, %struct.Memory* %call2_40a983)
  ...
  %call2_40aa39 = tail call %struct.Memory* @sub_4007d0._Z13record_resultdPKc(%struct.State* nonnull %0, i64 %353, %struct.Memory* %call2_40aa30)
