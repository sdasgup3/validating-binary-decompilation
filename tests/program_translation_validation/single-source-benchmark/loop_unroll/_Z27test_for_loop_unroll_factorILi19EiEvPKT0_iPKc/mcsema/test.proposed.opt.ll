...
block_.L_41503f:                                  ; preds = %block_.L_4150c1, %entry
  %68 = phi i64 [ %.pre, %entry ], [ %362, %block_.L_4150c1 ]
...
block_.L_415091:                                  ; preds = %block_41509d, %block_.L_41508c
  %197 = phi i64 [ %196, %block_.L_41508c ], [ %320, %block_41509d ]
...
block_.L_4150c1:                                  ; preds = %block_.L_415091
  ...
  %call2_4150c4 = tail call %struct.Memory* @sub_40c100._Z9check_sumIiEvT_(%struct.State* %0, i64 %326, %struct.Memory* %MEMORY.2)
...
block_.L_4150d7:                                  ; preds = %block_.L_41503f
  ...
  %call2_4150d7 = tail call %struct.Memory* @sub_400df0._Z5timerv(%struct.State* %0, i64 %363, %struct.Memory* %MEMORY.0)
  ...
  %call2_4150e0 = tail call %struct.Memory* @sub_400790._Z13record_resultdPKc(%struct.State* %0, i64 %374, %struct.Memory* %call2_4150d7)
