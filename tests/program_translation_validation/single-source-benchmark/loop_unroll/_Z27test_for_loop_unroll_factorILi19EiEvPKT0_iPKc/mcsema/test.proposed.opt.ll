...
declare %struct.Memory* @sub_40c630._ZN15loop_inner_bodyILi19EiE7do_workERiPKii(%struct.State* noalias dereferenceable(3376), i64, %struct.Memory* noalias readnone returned) local_unnamed_addr
...
entry:
  ...
  %call2_415033 = tail call %struct.Memory* @sub_400dd0._Z11start_timerv(%struct.State* %0, i64 %58, %struct.Memory* %2)
  ...
  br label %block_.L_41503f

block_.L_41503f:                                  ; preds = %block_.L_4150c1, %entry
  %68 = phi i64 [ %.pre, %entry ], [ %364, %block_.L_4150c1 ]
  %MEMORY.0 = phi %struct.Memory* [ %call2_415033, %entry ], [ %call2_4150c4, %block_.L_4150c1 ]
  ...
  br i1 %101, label %block_41504f, label %block_.L_4150d7

block_41504f:                                     ; preds = %block_.L_41503f
  %103 = add i64 %69, -32
  %104 = add i64 %102, 7
  ...
  br label %block_.L_41505d

block_.L_41505d:                                  ; preds = %block_41506e, %block_41504f
  %111 = phi i64 [ %.pre1, %block_41504f ], [ %195, %block_41506e ]
  %MEMORY.1 = phi %struct.Memory* [ %MEMORY.0, %block_41504f ], [ %call2_415079, %block_41506e ]
  ...
  br i1 %149, label %block_41506e, label %block_.L_41508c

block_41506e:                                     ; preds = %block_.L_41505d
  %151 = add i64 %112, -32
  ...
  %call2_415079 = tail call %struct.Memory* @sub_40c630._ZN15loop_inner_bodyILi19EiE7do_workERiPKii(%struct.State* %0, i64 %159, %struct.Memory* %MEMORY.1)
...
block_.L_41508c:                                  ; preds = %block_.L_41505d
  %196 = add i64 %150, 5
  store i64 %196, i64* %3, align 8
  br label %block_.L_415091

block_.L_415091:                                  ; preds = %block_41509d, %block_.L_41508c
  %197 = phi i64 [ %196, %block_.L_41508c ], [ %321, %block_41509d ]
  %198 = phi i64 [ %112, %block_.L_41508c ], [ %.pre2, %block_41509d ]
  %MEMORY.2 = phi %struct.Memory* [ %MEMORY.1, %block_.L_41508c ], [ %call2_4150a8, %block_41509d ]
  %199 = add i64 %198, -36
  %200 = add i64 %197, 3
  ...
  br i1 %233, label %block_41509d, label %block_.L_4150c1

block_41509d:                                     ; preds = %block_.L_415091
  %235 = add i64 %198, -8
  %236 = add i64 %234, 4
  ...
  %call2_4150a8 = tail call %struct.Memory* @sub_40c0d0._Z18complete_hash_funcIiET_S0_(%struct.State* %0, i64 %248, %struct.Memory* %MEMORY.2)
...
block_.L_4150c1:                                  ; preds = %block_.L_415091
  %322 = add i64 %198, -32
  %323 = add i64 %234, 3
  ...
  %call2_4150c4 = tail call %struct.Memory* @sub_40c100._Z9check_sumIiEvT_(%struct.State* %0, i64 %327, %struct.Memory* %MEMORY.2)
...
block_.L_4150d7:                                  ; preds = %block_.L_41503f
  %365 = add i64 %102, -82663
  %366 = add i64 %102, 5
  ...
  %call2_4150d7 = tail call %struct.Memory* @sub_400df0._Z5timerv(%struct.State* %0, i64 %365, %struct.Memory* %MEMORY.0)
  ...
  %call2_4150e0 = tail call %struct.Memory* @sub_400790._Z13record_resultdPKc(%struct.State* %0, i64 %376, %struct.Memory* %call2_4150d7)
  ...
  ret %struct.Memory* %call2_4150e0
}
...
define %struct.Memory* @routine_jge_.L_4150d7(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i8* %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
...
define %struct.Memory* @routine_subl__0x12___ecx(%struct.State* dereferenceable(3376), i64, %struct.Memory*) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %RCX = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 5, i32 0, i32 0
...
define %struct.Memory* @routine_jge_.L_41508c(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i8* %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 2, i32 9
...
define %struct.Memory* @routine_callq_._ZN15loop_inner_bodyILi19EiE7do_workERiPKii(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
...
define %struct.Memory* @routine_jmpq_.L_41505d(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
...
define %struct.Memory* @routine_jmpq_.L_415091(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
...
define %struct.Memory* @routine_jge_.L_4150c1(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i8* %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 2, i32 9
...
define %struct.Memory* @routine_jmpq_.L_41503f(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
