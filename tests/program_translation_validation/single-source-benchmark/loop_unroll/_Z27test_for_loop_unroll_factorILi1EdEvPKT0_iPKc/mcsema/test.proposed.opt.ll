...
entry:
  ...
  %call2_40be53 = tail call %struct.Memory* @sub_400dd0._Z11start_timerv(%struct.State* %0, i64 %58, %struct.Memory* %2)
...
block_.L_40be5f:                                  ; preds = %block_.L_40bee8, %entry
  %79 = phi i64 [ %.pre, %entry ], [ %345, %block_.L_40bee8 ]
  %MEMORY.0 = phi %struct.Memory* [ %call2_40be53, %entry ], [ %call2_40beed, %block_.L_40bee8 ]
  ...
  br i1 %112, label %block_40be6f, label %block_.L_40bf00
...
block_.L_40be7e:                                  ; preds = %block_40be8f, %block_40be6f
  %124 = phi i64 [ %.pre1, %block_40be6f ], [ %207, %block_40be8f ]
  %MEMORY.1 = phi %struct.Memory* [ %MEMORY.0, %block_40be6f ], [ %call2_40be9a, %block_40be8f ]
  ...
  store i64 %135, i64* %RCX.i74, align 8
  %136 = lshr i32 %134, 31
  %137 = sub i32 %129, %134
  %138 = icmp ult i32 %129, %134
  ...
  %160 = icmp ne i8 %153, 0
  %161 = xor i1 %160, %158
  %.v3 = select i1 %161, i64 17, i64 47
  %162 = add i64 %124, %.v3
  store i64 %162, i64* %3, align 8
  br i1 %161, label %block_40be8f, label %block_.L_40bead

block_40be8f:                                     ; preds = %block_.L_40be7e
  %163 = add i64 %125, -40
  store i64 %163, i64* %RDI.i102, align 8
  %164 = add i64 %125, -8
  %165 = add i64 %162, 8
  ...
  %169 = load i32, i32* %128, align 4
  %170 = zext i32 %169 to i64
  store i64 %170, i64* %RDX.i97, align 8
  %171 = add i64 %162, -40287
  %172 = add i64 %162, 16
  ...
  %call2_40be9a = tail call %struct.Memory* @sub_402130._ZN15loop_inner_bodyILi1EdE7do_workERdPKdi(%struct.State* %0, i64 %171, %struct.Memory* %MEMORY.1)
  ...
  store i64 %183, i64* %RAX.i91, align 8
...
block_.L_40beb2:                                  ; preds = %block_40bebe, %block_.L_40bead
  %209 = phi i64 [ %208, %block_.L_40bead ], [ %304, %block_40bebe ]
  %210 = phi i64 [ %125, %block_.L_40bead ], [ %.pre2, %block_40bebe ]
  %MEMORY.2 = phi %struct.Memory* [ %MEMORY.1, %block_.L_40bead ], [ %call2_40becb, %block_40bebe ]
  %211 = add i64 %210, -44
  %212 = add i64 %209, 3
  ...
  br i1 %245, label %block_40bebe, label %block_.L_40bee8
...
block_40bebe:                                     ; preds = %block_.L_40beb2
  ...
  %call2_40becb = tail call %struct.Memory* @sub_401480._Z18complete_hash_funcIdET_S0_(%struct.State* %0, i64 %259, %struct.Memory* %MEMORY.2)
...
block_.L_40bee8:                                  ; preds = %block_.L_40beb2
  ...
  %call2_40beed = tail call %struct.Memory* @sub_4014b0._Z9check_sumIdEvT_(%struct.State* %0, i64 %309, %struct.Memory* %MEMORY.2)
...
block_.L_40bf00:                                  ; preds = %block_.L_40be5f
  ...
  %call2_40bf00 = tail call %struct.Memory* @sub_400df0._Z5timerv(%struct.State* %0, i64 %346, %struct.Memory* %MEMORY.0)
  ...
  %call2_40bf09 = tail call %struct.Memory* @sub_400790._Z13record_resultdPKc(%struct.State* %0, i64 %357, %struct.Memory* %call2_40bf00)
  ...
  ret %struct.Memory* %call2_40bf09
}
...
define %struct.Memory* @routine_jge_.L_40bf00(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i8* %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
...
define %struct.Memory* @routine_jge_.L_40bead(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i8* %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 2, i32 9
...
define %struct.Memory* @routine_jmpq_.L_40be7e(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
...
define %struct.Memory* @routine_jmpq_.L_40beb2(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
...
define %struct.Memory* @routine_jmpq_.L_40be5f(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
