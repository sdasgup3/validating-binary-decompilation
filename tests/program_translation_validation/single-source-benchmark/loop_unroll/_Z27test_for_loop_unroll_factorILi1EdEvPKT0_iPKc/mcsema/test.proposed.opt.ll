...
entry:
  ...
  %call2_40be93 = tail call %struct.Memory* @sub_400e10._Z11start_timerv(%struct.State* %0, i64 %58, %struct.Memory* %2)
...
block_.L_40be9f:                                  ; preds = %block_.L_40bf28, %entry
  %74 = phi i64 [ %340, %block_.L_40bf28 ], [ %.pre, %entry ]
  ...
  br i1 %107, label %block_40beaf, label %block_.L_40bf40
...
block_.L_40bebe:                                  ; preds = %block_40becf, %block_40beaf
  %118 = phi i64 [ %201, %block_40becf ], [ %.pre9, %block_40beaf ]
  ...
  br i1 %155, label %block_40becf, label %block_.L_40beed
...
block_40becf:                                     ; preds = %block_.L_40bebe
  ...
  %call2_40beda = tail call %struct.Memory* @sub_402170._ZN15loop_inner_bodyILi1EdE7do_workERdPKdi(%struct.State* nonnull %0, i64 %165, %struct.Memory* %call2_40be93)
...
block_.L_40bef2:                                  ; preds = %block_40befe, %block_.L_40beed
  %203 = phi i64 [ %119, %block_.L_40beed ], [ %.pre10, %block_40befe ]
  %storemerge = phi i64 [ %202, %block_.L_40beed ], [ %298, %block_40befe ]
  %204 = add i64 %203, -44
  ...
  br i1 %238, label %block_40befe, label %block_.L_40bf28
...
block_40befe:                                     ; preds = %block_.L_40bef2
  ...
  %call2_40bf0b = tail call %struct.Memory* @sub_4014c0._Z18complete_hash_funcIdET_S0_(%struct.State* nonnull %0, i64 %252, %struct.Memory* %call2_40be93)
...
block_.L_40bf28:                                  ; preds = %block_.L_40bef2
  ...
  %call2_40bf2d = tail call %struct.Memory* @sub_4014f0._Z9check_sumIdEvT_(%struct.State* nonnull %0, i64 %304, %struct.Memory* %call2_40be93)
...
block_.L_40bf40:                                  ; preds = %block_.L_40be9f
  ...
  %call2_40bf40 = tail call %struct.Memory* @sub_400e30._Z5timerv(%struct.State* nonnull %0, i64 %341, %struct.Memory* %call2_40be93)
  ...
  %call2_40bf49 = tail call %struct.Memory* @sub_4007d0._Z13record_resultdPKc(%struct.State* nonnull %0, i64 %352, %struct.Memory* %call2_40bf40)
