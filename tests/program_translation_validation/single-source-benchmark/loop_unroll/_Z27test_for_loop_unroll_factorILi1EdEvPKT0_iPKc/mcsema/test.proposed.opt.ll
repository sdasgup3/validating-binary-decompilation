...
define %struct.Memory* @_Z27test_for_loop_unroll_factorILi1EdEvPKT0_iPKc(%struct.State* noalias, i64, %struct.Memory* noalias readnone) local_unnamed_addr #1 {
entry:
...
block_.L_40be8f:                                  ; preds = %block_.L_40bf18, %entry
  %74 = phi i64 [ %340, %block_.L_40bf18 ], [ %.pre, %entry ]
...
block_.L_40beae:                                  ; preds = %block_40bebf, %block_40be9f
  %118 = phi i64 [ %201, %block_40bebf ], [ %.pre9, %block_40be9f ]
...
block_40bebf:                                     ; preds = %block_.L_40beae
  ...
  %call2_40beca = tail call %struct.Memory* @sub_402160._ZN15loop_inner_bodyILi1EdE7do_workERdPKdi(%struct.State* nonnull %0, i64 %165, %struct.Memory* %call2_40be83)
...
block_40beee:                                     ; preds = %block_.L_40bee2
  ...
  %call2_40befb = tail call %struct.Memory* @sub_4014b0._Z18complete_hash_funcIdET_S0_(%struct.State* nonnull %0, i64 %252, %struct.Memory* %call2_40be83)
...
block_.L_40bf18:                                  ; preds = %block_.L_40bee2
  ...
  %call2_40bf1d = tail call %struct.Memory* @sub_4014e0._Z9check_sumIdEvT_(%struct.State* nonnull %0, i64 %304, %struct.Memory* %call2_40be83)
...
block_.L_40bf30:                                  ; preds = %block_.L_40be8f
  ...
  %call2_40bf30 = tail call %struct.Memory* @sub_400e20._Z5timerv(%struct.State* nonnull %0, i64 %341, %struct.Memory* %call2_40be83)
