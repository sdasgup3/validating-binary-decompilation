...
block_.L_40be5f:                                  ; preds = %block_.L_40bee8, %entry
  %79 = phi i64 [ %.pre, %entry ], [ %350, %block_.L_40bee8 ]
...
block_.L_40be7e:                                  ; preds = %block_40be8f, %block_40be6f
  %124 = phi i64 [ %.pre1, %block_40be6f ], [ %208, %block_40be8f ]
...
block_.L_40beb2:                                  ; preds = %block_40bebe, %block_.L_40bead
  %210 = phi i64 [ %209, %block_.L_40bead ], [ %307, %block_40bebe ]
  %211 = phi i64 [ %125, %block_.L_40bead ], [ %.pre2, %block_40bebe ]
  ...
  br i1 %246, label %block_40bebe, label %block_.L_40bee8
...
block_40bebe:                                     ; preds = %block_.L_40beb2
  ...
  %call2_40becb = tail call %struct.Memory* @sub_401480._Z18complete_hash_funcIdET_S0_(%struct.State* %0, i64 %261, %struct.Memory* %MEMORY.2)
...
block_.L_40bee8:                                  ; preds = %block_.L_40beb2
  ...
  %call2_40beed = tail call %struct.Memory* @sub_4014b0._Z9check_sumIdEvT_(%struct.State* %0, i64 %313, %struct.Memory* %MEMORY.2)
...
block_.L_40bf00:                                  ; preds = %block_.L_40be5f
  ...
  %call2_40bf00 = tail call %struct.Memory* @sub_400df0._Z5timerv(%struct.State* %0, i64 %351, %struct.Memory* %MEMORY.0)
  ...
  %call2_40bf09 = tail call %struct.Memory* @sub_400790._Z13record_resultdPKc(%struct.State* %0, i64 %362, %struct.Memory* %call2_40bf00)
