...
define %struct.Memory* @_Z27test_for_loop_unroll_factorILi1EiEvPKT0_iPKc(%struct.State* noalias, i64, %struct.Memory* noalias) local_unnamed_addr #1 {
entry:
  ...
  %call2_416423 = tail call %struct.Memory* @sub_400dd0._Z11start_timerv(%struct.State* %0, i64 %58, %struct.Memory* %2)
...
block_.L_41642f:                                  ; preds = %block_.L_4164b1, %entry
  %68 = phi i64 [ %.pre, %entry ], [ %361, %block_.L_4164b1 ]
  %MEMORY.0 = phi %struct.Memory* [ %call2_416423, %entry ], [ %call2_4164b4, %block_.L_4164b1 ]
  ...
  br i1 %101, label %block_41643f, label %block_.L_4164c7

block_41643f:                                     ; preds = %block_.L_41642f
  %103 = add i64 %69, -32
  %104 = add i64 %102, 7
...
block_.L_41644d:                                  ; preds = %block_41645e, %block_41643f
  %111 = phi i64 [ %.pre1, %block_41643f ], [ %194, %block_41645e ]
  %MEMORY.1 = phi %struct.Memory* [ %MEMORY.0, %block_41643f ], [ %call2_416469, %block_41645e ]
  ...
  %148 = xor i1 %147, %145
  %.v3 = select i1 %148, i64 17, i64 47
  %149 = add i64 %111, %.v3
  store i64 %149, i64* %3, align 8
  br i1 %148, label %block_41645e, label %block_.L_41647c

block_41645e:                                     ; preds = %block_.L_41644d
  %150 = add i64 %112, -32
  ...
  %call2_416469 = tail call %struct.Memory* @sub_40ccf0._ZN15loop_inner_bodyILi1EiE7do_workERiPKii(%struct.State* %0, i64 %158, %struct.Memory* %MEMORY.1)
...
block_.L_41647c:                                  ; preds = %block_.L_41644d
  %195 = add i64 %149, 5
  store i64 %195, i64* %3, align 8
  br label %block_.L_416481

block_.L_416481:                                  ; preds = %block_41648d, %block_.L_41647c
  %196 = phi i64 [ %195, %block_.L_41647c ], [ %319, %block_41648d ]
  %197 = phi i64 [ %112, %block_.L_41647c ], [ %.pre2, %block_41648d ]
  %MEMORY.2 = phi %struct.Memory* [ %MEMORY.1, %block_.L_41647c ], [ %call2_416498, %block_41648d ]
  %198 = add i64 %197, -36
  %199 = add i64 %196, 3
  ...
  br i1 %232, label %block_41648d, label %block_.L_4164b1

block_41648d:                                     ; preds = %block_.L_416481
  %234 = add i64 %197, -8
  %235 = add i64 %233, 4
  ...
  %call2_416498 = tail call %struct.Memory* @sub_40c0d0._Z18complete_hash_funcIiET_S0_(%struct.State* %0, i64 %247, %struct.Memory* %MEMORY.2)
...
block_.L_4164b1:                                  ; preds = %block_.L_416481
  %320 = add i64 %197, -32
  %321 = add i64 %233, 3
  ...
  %call2_4164b4 = tail call %struct.Memory* @sub_40c100._Z9check_sumIiEvT_(%struct.State* %0, i64 %325, %struct.Memory* %MEMORY.2)
...
block_.L_4164c7:                                  ; preds = %block_.L_41642f
  ...
  %call2_4164c7 = tail call %struct.Memory* @sub_400df0._Z5timerv(%struct.State* %0, i64 %362, %struct.Memory* %MEMORY.0)
  ...
  %call2_4164d0 = tail call %struct.Memory* @sub_400790._Z13record_resultdPKc(%struct.State* %0, i64 %373, %struct.Memory* %call2_4164c7)
  ...
  ret %struct.Memory* %call2_4164d0
}
...
define %struct.Memory* @routine_jge_.L_4164c7(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i8* %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
...
define %struct.Memory* @routine_jge_.L_41647c(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i8* %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 2, i32 9
...
define %struct.Memory* @routine_jmpq_.L_41644d(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
...
define %struct.Memory* @routine_jmpq_.L_416481(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
...
define %struct.Memory* @routine_jge_.L_4164b1(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i8* %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 2, i32 9
...
define %struct.Memory* @routine_jmpq_.L_41642f(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
