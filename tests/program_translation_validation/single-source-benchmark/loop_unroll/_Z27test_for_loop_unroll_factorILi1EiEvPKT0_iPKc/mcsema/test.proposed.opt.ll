...
block_.L_41645f:                                  ; preds = %block_.L_4164e1, %entry
  %68 = phi i64 [ %361, %block_.L_4164e1 ], [ %.pre, %entry ]
...
block_.L_41647d:                                  ; preds = %block_41648e, %block_41646f
  %111 = phi i64 [ %194, %block_41648e ], [ %.pre9, %block_41646f ]
...
block_41648e:                                     ; preds = %block_.L_41647d
  ...
  %call2_416499 = tail call %struct.Memory* @sub_40cd20._ZN15loop_inner_bodyILi1EiE7do_workERiPKii(%struct.State* nonnull %0, i64 %158, %struct.Memory* %call2_416453)
...
block_4164bd:                                     ; preds = %block_.L_4164b1
  ...
  %call2_4164c8 = tail call %struct.Memory* @sub_40c100._Z18complete_hash_funcIiET_S0_(%struct.State* nonnull %0, i64 %246, %struct.Memory* %call2_416453)
...
block_.L_4164e1:                                  ; preds = %block_.L_4164b1
  ...
  %call2_4164e4 = tail call %struct.Memory* @sub_40c130._Z9check_sumIiEvT_(%struct.State* nonnull %0, i64 %325, %struct.Memory* %call2_416453)
...
block_.L_4164f7:                                  ; preds = %block_.L_41645f
  ...
  %call2_4164f7 = tail call %struct.Memory* @sub_400e20._Z5timerv(%struct.State* nonnull %0, i64 %362, %struct.Memory* %call2_416453)
