...
define %struct.Memory* @_Z27test_for_loop_unroll_factorILi1EiEvPKT0_iPKc(%struct.State* noalias, i64, %struct.Memory* noalias readnone) local_unnamed_addr #1 {
entry:
  ...
  %call2_416463 = tail call %struct.Memory* @sub_400e10._Z11start_timerv(%struct.State* %0, i64 %58, %struct.Memory* %2)
...
block_.L_41646f:                                  ; preds = %block_.L_4164f1, %entry
  %68 = phi i64 [ %361, %block_.L_4164f1 ], [ %.pre, %entry ]
  ...
  br i1 %101, label %block_41647f, label %block_.L_416507

block_41647f:                                     ; preds = %block_.L_41646f
  %103 = add i64 %69, -32
  %104 = add i64 %102, 7
...
block_.L_41648d:                                  ; preds = %block_41649e, %block_41647f
  %111 = phi i64 [ %194, %block_41649e ], [ %.pre9, %block_41647f ]
  ...
  store i64 %122, i64* %RCX.i76, align 8
  %123 = lshr i32 %121, 31
  %124 = sub i32 %116, %121
  %125 = icmp ult i32 %116, %121
  ...
  %148 = xor i1 %147, %145
  %.v11 = select i1 %148, i64 17, i64 47
  %149 = add i64 %111, %.v11
  store i64 %149, i64* %3, align 8
  br i1 %148, label %block_41649e, label %block_.L_4164bc

block_41649e:                                     ; preds = %block_.L_41648d
  %150 = add i64 %112, -32
  store i64 %150, i64* %RDI.i100, align 8
  %151 = add i64 %112, -8
  %152 = add i64 %149, 8
  ...
  store i64 %157, i64* %RDX.i95, align 8
  %158 = add i64 %149, -38766
  %159 = add i64 %149, 16
  ...
  %call2_4164a9 = tail call %struct.Memory* @sub_40cd30._ZN15loop_inner_bodyILi1EiE7do_workERiPKii(%struct.State* nonnull %0, i64 %158, %struct.Memory* %call2_416463)
  ...
  store i64 %170, i64* %RAX.i89, align 8
...
block_.L_4164bc:                                  ; preds = %block_.L_41648d
  %195 = add i64 %149, 5
  br label %block_.L_4164c1

block_.L_4164c1:                                  ; preds = %block_4164cd, %block_.L_4164bc
  %196 = phi i64 [ %112, %block_.L_4164bc ], [ %.pre10, %block_4164cd ]
  %storemerge = phi i64 [ %195, %block_.L_4164bc ], [ %318, %block_4164cd ]
  %197 = add i64 %196, -36
  ...
  br i1 %231, label %block_4164cd, label %block_.L_4164f1

block_4164cd:                                     ; preds = %block_.L_4164c1
  %233 = add i64 %196, -8
  %234 = add i64 %232, 4
  ...
  %call2_4164d8 = tail call %struct.Memory* @sub_40c110._Z18complete_hash_funcIiET_S0_(%struct.State* nonnull %0, i64 %246, %struct.Memory* %call2_416463)
...
block_.L_4164f1:                                  ; preds = %block_.L_4164c1
  %320 = add i64 %196, -32
  %321 = add i64 %232, 3
  ...
  %call2_4164f4 = tail call %struct.Memory* @sub_40c140._Z9check_sumIiEvT_(%struct.State* nonnull %0, i64 %325, %struct.Memory* %call2_416463)
...
block_.L_416507:                                  ; preds = %block_.L_41646f
  %362 = add i64 %102, -87767
  %363 = add i64 %102, 5
  ...
  %call2_416507 = tail call %struct.Memory* @sub_400e30._Z5timerv(%struct.State* nonnull %0, i64 %362, %struct.Memory* %call2_416463)
  ...
  %call2_416510 = tail call %struct.Memory* @sub_4007d0._Z13record_resultdPKc(%struct.State* nonnull %0, i64 %373, %struct.Memory* %call2_416507)
  ...
  ret %struct.Memory* %call2_416510
}
...
; Function Attrs: alwaysinline norecurse nounwind
define %struct.Memory* @routine_jge_.L_416507(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i8* nocapture %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
...
; Function Attrs: alwaysinline norecurse nounwind
define %struct.Memory* @routine_jge_.L_4164bc(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i8* nocapture %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 2, i32 9
...
; Function Attrs: alwaysinline norecurse nounwind
define %struct.Memory* @routine_jmpq_.L_41648d(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
...
; Function Attrs: alwaysinline norecurse nounwind
define %struct.Memory* @routine_jmpq_.L_4164c1(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
...
; Function Attrs: alwaysinline norecurse nounwind
define %struct.Memory* @routine_jge_.L_4164f1(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i8* nocapture %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 2, i32 9
...
; Function Attrs: alwaysinline norecurse nounwind
define %struct.Memory* @routine_jmpq_.L_41646f(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
