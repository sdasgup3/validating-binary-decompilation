...
entry:
  ...
  %call2_414f53 = tail call %struct.Memory* @sub_400e10._Z11start_timerv(%struct.State* %0, i64 %58, %struct.Memory* %2)
...
block_.L_414f5f:                                  ; preds = %block_.L_414fe1, %entry
  %68 = phi i64 [ %362, %block_.L_414fe1 ], [ %.pre, %entry ]
  ...
  br i1 %101, label %block_414f6f, label %block_.L_414ff7
...
block_.L_414f7d:                                  ; preds = %block_414f8e, %block_414f6f
  %111 = phi i64 [ %195, %block_414f8e ], [ %.pre9, %block_414f6f ]
  ...
  br i1 %149, label %block_414f8e, label %block_.L_414fac
...
block_414f8e:                                     ; preds = %block_.L_414f7d
  ...
  %call2_414f99 = tail call %struct.Memory* @sub_40c610._ZN15loop_inner_bodyILi20EiE7do_workERiPKii(%struct.State* nonnull %0, i64 %159, %struct.Memory* %call2_414f53)
...
block_.L_414fb1:                                  ; preds = %block_414fbd, %block_.L_414fac
  %197 = phi i64 [ %112, %block_.L_414fac ], [ %.pre10, %block_414fbd ]
  %storemerge = phi i64 [ %196, %block_.L_414fac ], [ %319, %block_414fbd ]
  %198 = add i64 %197, -36
  ...
  br i1 %232, label %block_414fbd, label %block_.L_414fe1
...
block_414fbd:                                     ; preds = %block_.L_414fb1
  ...
  %call2_414fc8 = tail call %struct.Memory* @sub_40c110._Z18complete_hash_funcIiET_S0_(%struct.State* nonnull %0, i64 %247, %struct.Memory* %call2_414f53)
...
block_.L_414fe1:                                  ; preds = %block_.L_414fb1
  ...
  %call2_414fe4 = tail call %struct.Memory* @sub_40c140._Z9check_sumIiEvT_(%struct.State* nonnull %0, i64 %326, %struct.Memory* %call2_414f53)
...
block_.L_414ff7:                                  ; preds = %block_.L_414f5f
  ...
  %call2_414ff7 = tail call %struct.Memory* @sub_400e30._Z5timerv(%struct.State* nonnull %0, i64 %363, %struct.Memory* %call2_414f53)
  ...
  %call2_415000 = tail call %struct.Memory* @sub_4007d0._Z13record_resultdPKc(%struct.State* nonnull %0, i64 %374, %struct.Memory* %call2_414ff7)
