...
entry:
  ...
  %call2_414f13 = tail call %struct.Memory* @sub_400dd0._Z11start_timerv(%struct.State* %0, i64 %58, %struct.Memory* %2)
...
block_.L_414f1f:                                  ; preds = %block_.L_414fa1, %entry
  %68 = phi i64 [ %.pre, %entry ], [ %362, %block_.L_414fa1 ]
  %MEMORY.0 = phi %struct.Memory* [ %call2_414f13, %entry ], [ %call2_414fa4, %block_.L_414fa1 ]
  ...
  br i1 %101, label %block_414f2f, label %block_.L_414fb7
...
block_.L_414f3d:                                  ; preds = %block_414f4e, %block_414f2f
  %111 = phi i64 [ %.pre1, %block_414f2f ], [ %195, %block_414f4e ]
  %MEMORY.1 = phi %struct.Memory* [ %MEMORY.0, %block_414f2f ], [ %call2_414f59, %block_414f4e ]
  ...
  br i1 %149, label %block_414f4e, label %block_.L_414f6c
...
block_414f4e:                                     ; preds = %block_.L_414f3d
  ...
  %call2_414f59 = tail call %struct.Memory* @sub_40c5d0._ZN15loop_inner_bodyILi20EiE7do_workERiPKii(%struct.State* %0, i64 %159, %struct.Memory* %MEMORY.1)
...
block_.L_414f71:                                  ; preds = %block_414f7d, %block_.L_414f6c
  %197 = phi i64 [ %196, %block_.L_414f6c ], [ %320, %block_414f7d ]
  %198 = phi i64 [ %112, %block_.L_414f6c ], [ %.pre2, %block_414f7d ]
  %MEMORY.2 = phi %struct.Memory* [ %MEMORY.1, %block_.L_414f6c ], [ %call2_414f88, %block_414f7d ]
  %199 = add i64 %198, -36
  %200 = add i64 %197, 3
  ...
  br i1 %233, label %block_414f7d, label %block_.L_414fa1
...
block_414f7d:                                     ; preds = %block_.L_414f71
  ...
  %call2_414f88 = tail call %struct.Memory* @sub_40c0d0._Z18complete_hash_funcIiET_S0_(%struct.State* %0, i64 %248, %struct.Memory* %MEMORY.2)
...
block_.L_414fa1:                                  ; preds = %block_.L_414f71
  ...
  %call2_414fa4 = tail call %struct.Memory* @sub_40c100._Z9check_sumIiEvT_(%struct.State* %0, i64 %326, %struct.Memory* %MEMORY.2)
...
block_.L_414fb7:                                  ; preds = %block_.L_414f1f
  ...
  %call2_414fb7 = tail call %struct.Memory* @sub_400df0._Z5timerv(%struct.State* %0, i64 %363, %struct.Memory* %MEMORY.0)
  ...
  %call2_414fc0 = tail call %struct.Memory* @sub_400790._Z13record_resultdPKc(%struct.State* %0, i64 %374, %struct.Memory* %call2_414fb7)
  ...
  ret %struct.Memory* %call2_414fc0
}
...
define %struct.Memory* @routine_jge_.L_414fb7(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i8* %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
...
define %struct.Memory* @routine_jge_.L_414f6c(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i8* %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 2, i32 9
...
define %struct.Memory* @routine_jmpq_.L_414f3d(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
...
define %struct.Memory* @routine_jmpq_.L_414f71(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
...
define %struct.Memory* @routine_jge_.L_414fa1(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i8* %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 2, i32 9
...
define %struct.Memory* @routine_jmpq_.L_414f1f(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
