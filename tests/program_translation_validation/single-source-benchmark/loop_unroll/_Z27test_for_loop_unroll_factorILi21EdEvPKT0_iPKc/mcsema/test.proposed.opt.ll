...
block_.L_40a6ef:                                  ; preds = %block_.L_40a778, %entry
  %79 = phi i64 [ %.pre, %entry ], [ %346, %block_.L_40a778 ]
...
block_.L_40a742:                                  ; preds = %block_40a74e, %block_.L_40a73d
  %210 = phi i64 [ %209, %block_.L_40a73d ], [ %305, %block_40a74e ]
...
block_40a74e:                                     ; preds = %block_.L_40a742
  ...
  store i64 %259, i64* %116, align 1
  store double 0.000000e+00, double* %78, align 1
  %260 = add i64 %247, -37582
  %261 = add i64 %247, 18
  ...
  %call2_40a75b = tail call %struct.Memory* @sub_401480._Z18complete_hash_funcIdET_S0_(%struct.State* %0, i64 %260, %struct.Memory* %MEMORY.2)
...
block_.L_40a778:                                  ; preds = %block_.L_40a742
  ...
  store i64 %309, i64* %116, align 1
  store double 0.000000e+00, double* %78, align 1
  %310 = add i64 %247, -37576
  %311 = add i64 %247, 10
  ...
  %call2_40a77d = tail call %struct.Memory* @sub_4014b0._Z9check_sumIdEvT_(%struct.State* %0, i64 %310, %struct.Memory* %MEMORY.2)
  ...
  store i64 %322, i64* %RAX.i91, align 8
...
block_.L_40a790:                                  ; preds = %block_.L_40a6ef
  ...
  %call2_40a790 = tail call %struct.Memory* @sub_400df0._Z5timerv(%struct.State* %0, i64 %347, %struct.Memory* %MEMORY.0)
  ...
  store i64 %357, i64* %RDI.i102, align 8
  %358 = add i64 %354, -40965
  %359 = add i64 %354, 9
  ...
  %call2_40a799 = tail call %struct.Memory* @sub_400790._Z13record_resultdPKc(%struct.State* %0, i64 %358, %struct.Memory* %call2_40a790)
  %363 = load i64, i64* %6, align 8
  %364 = load i64, i64* %3, align 8
  %365 = add i64 %363, 48
  store i64 %365, i64* %6, align 8
  %366 = icmp ugt i64 %363, -49
