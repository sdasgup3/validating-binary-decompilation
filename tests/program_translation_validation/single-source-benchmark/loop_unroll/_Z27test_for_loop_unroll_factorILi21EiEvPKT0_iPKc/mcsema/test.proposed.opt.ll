...
entry:
  ...
  %call2_414e33 = tail call %struct.Memory* @sub_400e10._Z11start_timerv(%struct.State* %0, i64 %58, %struct.Memory* %2)
...
block_.L_414e3f:                                  ; preds = %block_.L_414ec1, %entry
  %68 = phi i64 [ %362, %block_.L_414ec1 ], [ %.pre, %entry ]
  ...
  br i1 %101, label %block_414e4f, label %block_.L_414ed7
...
block_.L_414e5d:                                  ; preds = %block_414e6e, %block_414e4f
  %111 = phi i64 [ %195, %block_414e6e ], [ %.pre9, %block_414e4f ]
  ...
  br i1 %149, label %block_414e6e, label %block_.L_414e8c
...
block_414e6e:                                     ; preds = %block_.L_414e5d
  ...
  %call2_414e79 = tail call %struct.Memory* @sub_40c5b0._ZN15loop_inner_bodyILi21EiE7do_workERiPKii(%struct.State* nonnull %0, i64 %159, %struct.Memory* %call2_414e33)
...
block_.L_414e91:                                  ; preds = %block_414e9d, %block_.L_414e8c
  %197 = phi i64 [ %112, %block_.L_414e8c ], [ %.pre10, %block_414e9d ]
  %storemerge = phi i64 [ %196, %block_.L_414e8c ], [ %319, %block_414e9d ]
  %198 = add i64 %197, -36
  ...
  br i1 %232, label %block_414e9d, label %block_.L_414ec1
...
block_414e9d:                                     ; preds = %block_.L_414e91
  ...
  %call2_414ea8 = tail call %struct.Memory* @sub_40c110._Z18complete_hash_funcIiET_S0_(%struct.State* nonnull %0, i64 %247, %struct.Memory* %call2_414e33)
...
block_.L_414ec1:                                  ; preds = %block_.L_414e91
  ...
  %call2_414ec4 = tail call %struct.Memory* @sub_40c140._Z9check_sumIiEvT_(%struct.State* nonnull %0, i64 %326, %struct.Memory* %call2_414e33)
...
block_.L_414ed7:                                  ; preds = %block_.L_414e3f
  ...
  %call2_414ed7 = tail call %struct.Memory* @sub_400e30._Z5timerv(%struct.State* nonnull %0, i64 %363, %struct.Memory* %call2_414e33)
  ...
  %call2_414ee0 = tail call %struct.Memory* @sub_4007d0._Z13record_resultdPKc(%struct.State* nonnull %0, i64 %374, %struct.Memory* %call2_414ed7)
