...
block_.L_414dff:                                  ; preds = %block_.L_414e81, %entry
  %68 = phi i64 [ %.pre, %entry ], [ %364, %block_.L_414e81 ]
...
block_.L_414e51:                                  ; preds = %block_414e5d, %block_.L_414e4c
  %197 = phi i64 [ %196, %block_.L_414e4c ], [ %321, %block_414e5d ]
...
block_.L_414e81:                                  ; preds = %block_.L_414e51
  ...
  %call2_414e84 = tail call %struct.Memory* @sub_40c100._Z9check_sumIiEvT_(%struct.State* %0, i64 %327, %struct.Memory* %MEMORY.2)
...
block_.L_414e97:                                  ; preds = %block_.L_414dff
  ...
  %call2_414e97 = tail call %struct.Memory* @sub_400df0._Z5timerv(%struct.State* %0, i64 %365, %struct.Memory* %MEMORY.0)
  ...
  %call2_414ea0 = tail call %struct.Memory* @sub_400790._Z13record_resultdPKc(%struct.State* %0, i64 %376, %struct.Memory* %call2_414e97)
