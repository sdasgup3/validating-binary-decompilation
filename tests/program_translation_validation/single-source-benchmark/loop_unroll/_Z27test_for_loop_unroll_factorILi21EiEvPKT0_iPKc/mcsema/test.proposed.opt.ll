...
entry:
  ...
  %call2_414df3 = tail call %struct.Memory* @sub_400dd0._Z11start_timerv(%struct.State* %0, i64 %58, %struct.Memory* %2)
...
block_.L_414dff:                                  ; preds = %block_.L_414e81, %entry
  %68 = phi i64 [ %.pre, %entry ], [ %362, %block_.L_414e81 ]
  %MEMORY.0 = phi %struct.Memory* [ %call2_414df3, %entry ], [ %call2_414e84, %block_.L_414e81 ]
  ...
  br i1 %101, label %block_414e0f, label %block_.L_414e97
...
block_.L_414e1d:                                  ; preds = %block_414e2e, %block_414e0f
  %111 = phi i64 [ %.pre1, %block_414e0f ], [ %195, %block_414e2e ]
  %MEMORY.1 = phi %struct.Memory* [ %MEMORY.0, %block_414e0f ], [ %call2_414e39, %block_414e2e ]
  ...
  br i1 %149, label %block_414e2e, label %block_.L_414e4c
...
block_414e2e:                                     ; preds = %block_.L_414e1d
  ...
  %call2_414e39 = tail call %struct.Memory* @sub_40c570._ZN15loop_inner_bodyILi21EiE7do_workERiPKii(%struct.State* %0, i64 %159, %struct.Memory* %MEMORY.1)
...
block_.L_414e51:                                  ; preds = %block_414e5d, %block_.L_414e4c
  %197 = phi i64 [ %196, %block_.L_414e4c ], [ %320, %block_414e5d ]
  %198 = phi i64 [ %112, %block_.L_414e4c ], [ %.pre2, %block_414e5d ]
  %MEMORY.2 = phi %struct.Memory* [ %MEMORY.1, %block_.L_414e4c ], [ %call2_414e68, %block_414e5d ]
  %199 = add i64 %198, -36
  %200 = add i64 %197, 3
  ...
  br i1 %233, label %block_414e5d, label %block_.L_414e81
...
block_414e5d:                                     ; preds = %block_.L_414e51
  ...
  %call2_414e68 = tail call %struct.Memory* @sub_40c0d0._Z18complete_hash_funcIiET_S0_(%struct.State* %0, i64 %248, %struct.Memory* %MEMORY.2)
...
block_.L_414e81:                                  ; preds = %block_.L_414e51
  ...
  %call2_414e84 = tail call %struct.Memory* @sub_40c100._Z9check_sumIiEvT_(%struct.State* %0, i64 %326, %struct.Memory* %MEMORY.2)
...
block_.L_414e97:                                  ; preds = %block_.L_414dff
  ...
  %call2_414e97 = tail call %struct.Memory* @sub_400df0._Z5timerv(%struct.State* %0, i64 %363, %struct.Memory* %MEMORY.0)
  ...
  %call2_414ea0 = tail call %struct.Memory* @sub_400790._Z13record_resultdPKc(%struct.State* %0, i64 %374, %struct.Memory* %call2_414e97)
  ...
  ret %struct.Memory* %call2_414ea0
}
...
define %struct.Memory* @routine_jge_.L_414e97(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i8* %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
...
define %struct.Memory* @routine_jge_.L_414e4c(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i8* %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 2, i32 9
...
define %struct.Memory* @routine_jmpq_.L_414e1d(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
...
define %struct.Memory* @routine_jmpq_.L_414e51(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
...
define %struct.Memory* @routine_jge_.L_414e81(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i8* %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 2, i32 9
...
define %struct.Memory* @routine_jmpq_.L_414dff(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
