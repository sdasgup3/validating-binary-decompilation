...
define %struct.Memory* @_Z27test_for_loop_unroll_factorILi21EiEvPKT0_iPKc(%struct.State* noalias, i64, %struct.Memory* noalias readnone) local_unnamed_addr #1 {
entry:
...
block_.L_414e2f:                                  ; preds = %block_.L_414eb1, %entry
  %68 = phi i64 [ %362, %block_.L_414eb1 ], [ %.pre, %entry ]
...
block_.L_414e4d:                                  ; preds = %block_414e5e, %block_414e3f
  %111 = phi i64 [ %195, %block_414e5e ], [ %.pre9, %block_414e3f ]
...
block_414e5e:                                     ; preds = %block_.L_414e4d
  ...
  %call2_414e69 = tail call %struct.Memory* @sub_40c5a0._ZN15loop_inner_bodyILi21EiE7do_workERiPKii(%struct.State* nonnull %0, i64 %159, %struct.Memory* %call2_414e23)
...
block_414e8d:                                     ; preds = %block_.L_414e81
  ...
  %call2_414e98 = tail call %struct.Memory* @sub_40c100._Z18complete_hash_funcIiET_S0_(%struct.State* nonnull %0, i64 %247, %struct.Memory* %call2_414e23)
...
block_.L_414eb1:                                  ; preds = %block_.L_414e81
  ...
  %call2_414eb4 = tail call %struct.Memory* @sub_40c130._Z9check_sumIiEvT_(%struct.State* nonnull %0, i64 %326, %struct.Memory* %call2_414e23)
...
block_.L_414ec7:                                  ; preds = %block_.L_414e2f
  ...
  %call2_414ec7 = tail call %struct.Memory* @sub_400e20._Z5timerv(%struct.State* nonnull %0, i64 %363, %struct.Memory* %call2_414e23)
