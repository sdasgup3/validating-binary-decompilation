...
entry:
  ...
  %call2_414cd3 = tail call %struct.Memory* @sub_400dd0._Z11start_timerv(%struct.State* %0, i64 %58, %struct.Memory* %2)
...
block_.L_414cdf:                                  ; preds = %block_.L_414d61, %entry
  %68 = phi i64 [ %.pre, %entry ], [ %362, %block_.L_414d61 ]
  %MEMORY.0 = phi %struct.Memory* [ %call2_414cd3, %entry ], [ %call2_414d64, %block_.L_414d61 ]
  ...
  br i1 %101, label %block_414cef, label %block_.L_414d77
...
block_.L_414cfd:                                  ; preds = %block_414d0e, %block_414cef
  %111 = phi i64 [ %.pre1, %block_414cef ], [ %195, %block_414d0e ]
  %MEMORY.1 = phi %struct.Memory* [ %MEMORY.0, %block_414cef ], [ %call2_414d19, %block_414d0e ]
  ...
  br i1 %149, label %block_414d0e, label %block_.L_414d2c
...
block_414d0e:                                     ; preds = %block_.L_414cfd
  ...
  %call2_414d19 = tail call %struct.Memory* @sub_40c510._ZN15loop_inner_bodyILi22EiE7do_workERiPKii(%struct.State* %0, i64 %159, %struct.Memory* %MEMORY.1)
...
block_.L_414d31:                                  ; preds = %block_414d3d, %block_.L_414d2c
  %197 = phi i64 [ %196, %block_.L_414d2c ], [ %320, %block_414d3d ]
  %198 = phi i64 [ %112, %block_.L_414d2c ], [ %.pre2, %block_414d3d ]
  %MEMORY.2 = phi %struct.Memory* [ %MEMORY.1, %block_.L_414d2c ], [ %call2_414d48, %block_414d3d ]
  %199 = add i64 %198, -36
  %200 = add i64 %197, 3
  ...
  br i1 %233, label %block_414d3d, label %block_.L_414d61
...
block_414d3d:                                     ; preds = %block_.L_414d31
  ...
  %call2_414d48 = tail call %struct.Memory* @sub_40c0d0._Z18complete_hash_funcIiET_S0_(%struct.State* %0, i64 %248, %struct.Memory* %MEMORY.2)
...
block_.L_414d61:                                  ; preds = %block_.L_414d31
  ...
  %call2_414d64 = tail call %struct.Memory* @sub_40c100._Z9check_sumIiEvT_(%struct.State* %0, i64 %326, %struct.Memory* %MEMORY.2)
...
block_.L_414d77:                                  ; preds = %block_.L_414cdf
  ...
  %call2_414d77 = tail call %struct.Memory* @sub_400df0._Z5timerv(%struct.State* %0, i64 %363, %struct.Memory* %MEMORY.0)
  ...
  %call2_414d80 = tail call %struct.Memory* @sub_400790._Z13record_resultdPKc(%struct.State* %0, i64 %374, %struct.Memory* %call2_414d77)
  ...
  ret %struct.Memory* %call2_414d80
}
...
define %struct.Memory* @routine_jge_.L_414d77(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i8* %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
...
define %struct.Memory* @routine_jge_.L_414d2c(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i8* %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 2, i32 9
...
define %struct.Memory* @routine_jmpq_.L_414cfd(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
...
define %struct.Memory* @routine_jmpq_.L_414d31(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
...
define %struct.Memory* @routine_jge_.L_414d61(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i8* %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 2, i32 9
...
define %struct.Memory* @routine_jmpq_.L_414cdf(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
