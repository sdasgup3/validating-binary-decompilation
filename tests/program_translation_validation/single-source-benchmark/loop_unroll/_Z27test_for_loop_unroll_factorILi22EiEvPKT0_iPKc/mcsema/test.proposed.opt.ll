...
block_.L_414cdf:                                  ; preds = %block_.L_414d61, %entry
  %68 = phi i64 [ %.pre, %entry ], [ %364, %block_.L_414d61 ]
...
block_.L_414d31:                                  ; preds = %block_414d3d, %block_.L_414d2c
  %197 = phi i64 [ %196, %block_.L_414d2c ], [ %321, %block_414d3d ]
...
block_.L_414d61:                                  ; preds = %block_.L_414d31
  ...
  %call2_414d64 = tail call %struct.Memory* @sub_40c100._Z9check_sumIiEvT_(%struct.State* %0, i64 %327, %struct.Memory* %MEMORY.2)
...
block_.L_414d77:                                  ; preds = %block_.L_414cdf
  ...
  %call2_414d77 = tail call %struct.Memory* @sub_400df0._Z5timerv(%struct.State* %0, i64 %365, %struct.Memory* %MEMORY.0)
  ...
  %call2_414d80 = tail call %struct.Memory* @sub_400790._Z13record_resultdPKc(%struct.State* %0, i64 %376, %struct.Memory* %call2_414d77)
