...
entry:
  ...
  %call2_414d13 = tail call %struct.Memory* @sub_400e10._Z11start_timerv(%struct.State* %0, i64 %58, %struct.Memory* %2)
...
block_.L_414d1f:                                  ; preds = %block_.L_414da1, %entry
  %68 = phi i64 [ %362, %block_.L_414da1 ], [ %.pre, %entry ]
  ...
  br i1 %101, label %block_414d2f, label %block_.L_414db7
...
block_.L_414d3d:                                  ; preds = %block_414d4e, %block_414d2f
  %111 = phi i64 [ %195, %block_414d4e ], [ %.pre9, %block_414d2f ]
  ...
  br i1 %149, label %block_414d4e, label %block_.L_414d6c
...
block_414d4e:                                     ; preds = %block_.L_414d3d
  ...
  %call2_414d59 = tail call %struct.Memory* @sub_40c550._ZN15loop_inner_bodyILi22EiE7do_workERiPKii(%struct.State* nonnull %0, i64 %159, %struct.Memory* %call2_414d13)
...
block_.L_414d71:                                  ; preds = %block_414d7d, %block_.L_414d6c
  %197 = phi i64 [ %112, %block_.L_414d6c ], [ %.pre10, %block_414d7d ]
  %storemerge = phi i64 [ %196, %block_.L_414d6c ], [ %319, %block_414d7d ]
  %198 = add i64 %197, -36
  ...
  br i1 %232, label %block_414d7d, label %block_.L_414da1
...
block_414d7d:                                     ; preds = %block_.L_414d71
  ...
  %call2_414d88 = tail call %struct.Memory* @sub_40c110._Z18complete_hash_funcIiET_S0_(%struct.State* nonnull %0, i64 %247, %struct.Memory* %call2_414d13)
...
block_.L_414da1:                                  ; preds = %block_.L_414d71
  ...
  %call2_414da4 = tail call %struct.Memory* @sub_40c140._Z9check_sumIiEvT_(%struct.State* nonnull %0, i64 %326, %struct.Memory* %call2_414d13)
...
block_.L_414db7:                                  ; preds = %block_.L_414d1f
  ...
  %call2_414db7 = tail call %struct.Memory* @sub_400e30._Z5timerv(%struct.State* nonnull %0, i64 %363, %struct.Memory* %call2_414d13)
  ...
  %call2_414dc0 = tail call %struct.Memory* @sub_4007d0._Z13record_resultdPKc(%struct.State* nonnull %0, i64 %374, %struct.Memory* %call2_414db7)
