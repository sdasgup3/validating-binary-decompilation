...
define %struct.Memory* @_Z27test_for_loop_unroll_factorILi22EiEvPKT0_iPKc(%struct.State* noalias, i64, %struct.Memory* noalias readnone) local_unnamed_addr #1 {
entry:
...
block_.L_414d0f:                                  ; preds = %block_.L_414d91, %entry
  %68 = phi i64 [ %362, %block_.L_414d91 ], [ %.pre, %entry ]
...
block_.L_414d2d:                                  ; preds = %block_414d3e, %block_414d1f
  %111 = phi i64 [ %195, %block_414d3e ], [ %.pre9, %block_414d1f ]
...
block_414d3e:                                     ; preds = %block_.L_414d2d
  ...
  %call2_414d49 = tail call %struct.Memory* @sub_40c540._ZN15loop_inner_bodyILi22EiE7do_workERiPKii(%struct.State* nonnull %0, i64 %159, %struct.Memory* %call2_414d03)
...
block_414d6d:                                     ; preds = %block_.L_414d61
  ...
  %call2_414d78 = tail call %struct.Memory* @sub_40c100._Z18complete_hash_funcIiET_S0_(%struct.State* nonnull %0, i64 %247, %struct.Memory* %call2_414d03)
...
block_.L_414d91:                                  ; preds = %block_.L_414d61
  ...
  %call2_414d94 = tail call %struct.Memory* @sub_40c130._Z9check_sumIiEvT_(%struct.State* nonnull %0, i64 %326, %struct.Memory* %call2_414d03)
...
block_.L_414da7:                                  ; preds = %block_.L_414d0f
  ...
  %call2_414da7 = tail call %struct.Memory* @sub_400e20._Z5timerv(%struct.State* nonnull %0, i64 %363, %struct.Memory* %call2_414d03)
