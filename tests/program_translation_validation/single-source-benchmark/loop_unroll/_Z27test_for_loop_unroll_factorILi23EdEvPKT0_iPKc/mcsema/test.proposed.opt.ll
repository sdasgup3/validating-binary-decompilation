...
block_.L_40a48f:                                  ; preds = %block_.L_40a518, %entry
  %79 = phi i64 [ %.pre, %entry ], [ %346, %block_.L_40a518 ]
...
block_.L_40a4e2:                                  ; preds = %block_40a4ee, %block_.L_40a4dd
  %210 = phi i64 [ %209, %block_.L_40a4dd ], [ %305, %block_40a4ee ]
...
block_40a4ee:                                     ; preds = %block_.L_40a4e2
  ...
  %call2_40a4fb = tail call %struct.Memory* @sub_401480._Z18complete_hash_funcIdET_S0_(%struct.State* %0, i64 %260, %struct.Memory* %MEMORY.2)
...
block_.L_40a518:                                  ; preds = %block_.L_40a4e2
  ...
  %call2_40a51d = tail call %struct.Memory* @sub_4014b0._Z9check_sumIdEvT_(%struct.State* %0, i64 %310, %struct.Memory* %MEMORY.2)
...
block_.L_40a530:                                  ; preds = %block_.L_40a48f
  ...
  %call2_40a530 = tail call %struct.Memory* @sub_400df0._Z5timerv(%struct.State* %0, i64 %347, %struct.Memory* %MEMORY.0)
  ...
  %call2_40a539 = tail call %struct.Memory* @sub_400790._Z13record_resultdPKc(%struct.State* %0, i64 %358, %struct.Memory* %call2_40a530)
