...
entry:
  ...
  %call2_414bb3 = tail call %struct.Memory* @sub_400dd0._Z11start_timerv(%struct.State* %0, i64 %58, %struct.Memory* %2)
...
block_.L_414bbf:                                  ; preds = %block_.L_414c41, %entry
  %68 = phi i64 [ %.pre, %entry ], [ %364, %block_.L_414c41 ]
  %MEMORY.0 = phi %struct.Memory* [ %call2_414bb3, %entry ], [ %call2_414c44, %block_.L_414c41 ]
  ...
  br i1 %101, label %block_414bcf, label %block_.L_414c57
...
block_.L_414bdd:                                  ; preds = %block_414bee, %block_414bcf
  %111 = phi i64 [ %.pre1, %block_414bcf ], [ %195, %block_414bee ]
  %MEMORY.1 = phi %struct.Memory* [ %MEMORY.0, %block_414bcf ], [ %call2_414bf9, %block_414bee ]
  ...
  br i1 %149, label %block_414bee, label %block_.L_414c0c
...
block_414bee:                                     ; preds = %block_.L_414bdd
  ...
  %call2_414bf9 = tail call %struct.Memory* @sub_40c4b0._ZN15loop_inner_bodyILi23EiE7do_workERiPKii(%struct.State* %0, i64 %159, %struct.Memory* %MEMORY.1)
...
block_.L_414c11:                                  ; preds = %block_414c1d, %block_.L_414c0c
  %197 = phi i64 [ %196, %block_.L_414c0c ], [ %321, %block_414c1d ]
  %198 = phi i64 [ %112, %block_.L_414c0c ], [ %.pre2, %block_414c1d ]
  %MEMORY.2 = phi %struct.Memory* [ %MEMORY.1, %block_.L_414c0c ], [ %call2_414c28, %block_414c1d ]
  %199 = add i64 %198, -36
  %200 = add i64 %197, 3
  ...
  br i1 %233, label %block_414c1d, label %block_.L_414c41
...
block_414c1d:                                     ; preds = %block_.L_414c11
  ...
  %call2_414c28 = tail call %struct.Memory* @sub_40c0d0._Z18complete_hash_funcIiET_S0_(%struct.State* %0, i64 %248, %struct.Memory* %MEMORY.2)
...
block_.L_414c41:                                  ; preds = %block_.L_414c11
  ...
  %call2_414c44 = tail call %struct.Memory* @sub_40c100._Z9check_sumIiEvT_(%struct.State* %0, i64 %327, %struct.Memory* %MEMORY.2)
...
block_.L_414c57:                                  ; preds = %block_.L_414bbf
  ...
  %call2_414c57 = tail call %struct.Memory* @sub_400df0._Z5timerv(%struct.State* %0, i64 %365, %struct.Memory* %MEMORY.0)
  ...
  %call2_414c60 = tail call %struct.Memory* @sub_400790._Z13record_resultdPKc(%struct.State* %0, i64 %376, %struct.Memory* %call2_414c57)
  ...
  ret %struct.Memory* %call2_414c60
}
...
define %struct.Memory* @routine_jge_.L_414c57(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i8* %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
...
define %struct.Memory* @routine_jge_.L_414c0c(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i8* %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 2, i32 9
...
define %struct.Memory* @routine_jmpq_.L_414bdd(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
...
define %struct.Memory* @routine_jmpq_.L_414c11(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
...
define %struct.Memory* @routine_jge_.L_414c41(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i8* %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 2, i32 9
...
define %struct.Memory* @routine_jmpq_.L_414bbf(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
