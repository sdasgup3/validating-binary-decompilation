...
define %struct.Memory* @_Z27test_for_loop_unroll_factorILi23EiEvPKT0_iPKc(%struct.State* noalias, i64, %struct.Memory* noalias readnone) local_unnamed_addr #1 {
entry:
...
block_.L_414bef:                                  ; preds = %block_.L_414c71, %entry
  %68 = phi i64 [ %362, %block_.L_414c71 ], [ %.pre, %entry ]
...
block_.L_414c0d:                                  ; preds = %block_414c1e, %block_414bff
  %111 = phi i64 [ %195, %block_414c1e ], [ %.pre9, %block_414bff ]
...
block_414c1e:                                     ; preds = %block_.L_414c0d
  ...
  %call2_414c29 = tail call %struct.Memory* @sub_40c4e0._ZN15loop_inner_bodyILi23EiE7do_workERiPKii(%struct.State* nonnull %0, i64 %159, %struct.Memory* %call2_414be3)
...
block_414c4d:                                     ; preds = %block_.L_414c41
  ...
  %call2_414c58 = tail call %struct.Memory* @sub_40c100._Z18complete_hash_funcIiET_S0_(%struct.State* nonnull %0, i64 %247, %struct.Memory* %call2_414be3)
...
block_.L_414c71:                                  ; preds = %block_.L_414c41
  ...
  %call2_414c74 = tail call %struct.Memory* @sub_40c130._Z9check_sumIiEvT_(%struct.State* nonnull %0, i64 %326, %struct.Memory* %call2_414be3)
...
block_.L_414c87:                                  ; preds = %block_.L_414bef
  ...
  %call2_414c87 = tail call %struct.Memory* @sub_400e20._Z5timerv(%struct.State* nonnull %0, i64 %363, %struct.Memory* %call2_414be3)
