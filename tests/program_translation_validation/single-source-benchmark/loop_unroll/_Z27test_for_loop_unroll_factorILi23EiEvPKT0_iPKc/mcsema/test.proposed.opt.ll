...
block_.L_414bbf:                                  ; preds = %block_.L_414c41, %entry
  %68 = phi i64 [ %.pre, %entry ], [ %362, %block_.L_414c41 ]
...
block_.L_414c11:                                  ; preds = %block_414c1d, %block_.L_414c0c
  %197 = phi i64 [ %196, %block_.L_414c0c ], [ %320, %block_414c1d ]
...
block_.L_414c41:                                  ; preds = %block_.L_414c11
  ...
  %call2_414c44 = tail call %struct.Memory* @sub_40c100._Z9check_sumIiEvT_(%struct.State* %0, i64 %326, %struct.Memory* %MEMORY.2)
...
block_.L_414c57:                                  ; preds = %block_.L_414bbf
  ...
  %call2_414c57 = tail call %struct.Memory* @sub_400df0._Z5timerv(%struct.State* %0, i64 %363, %struct.Memory* %MEMORY.0)
  ...
  %call2_414c60 = tail call %struct.Memory* @sub_400790._Z13record_resultdPKc(%struct.State* %0, i64 %374, %struct.Memory* %call2_414c57)
