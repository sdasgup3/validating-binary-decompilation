...
block_.L_40a35f:                                  ; preds = %block_.L_40a3e8, %entry
  %79 = phi i64 [ %.pre, %entry ], [ %346, %block_.L_40a3e8 ]
...
block_.L_40a3b2:                                  ; preds = %block_40a3be, %block_.L_40a3ad
  %210 = phi i64 [ %209, %block_.L_40a3ad ], [ %305, %block_40a3be ]
...
block_40a3be:                                     ; preds = %block_.L_40a3b2
  ...
  %call2_40a3cb = tail call %struct.Memory* @sub_401480._Z18complete_hash_funcIdET_S0_(%struct.State* %0, i64 %260, %struct.Memory* %MEMORY.2)
...
block_.L_40a3e8:                                  ; preds = %block_.L_40a3b2
  ...
  %call2_40a3ed = tail call %struct.Memory* @sub_4014b0._Z9check_sumIdEvT_(%struct.State* %0, i64 %310, %struct.Memory* %MEMORY.2)
...
block_.L_40a400:                                  ; preds = %block_.L_40a35f
  ...
  %call2_40a400 = tail call %struct.Memory* @sub_400df0._Z5timerv(%struct.State* %0, i64 %347, %struct.Memory* %MEMORY.0)
  ...
  %call2_40a409 = tail call %struct.Memory* @sub_400790._Z13record_resultdPKc(%struct.State* %0, i64 %358, %struct.Memory* %call2_40a400)
