...
block_.L_414a9f:                                  ; preds = %block_.L_414b21, %entry
  %68 = phi i64 [ %.pre, %entry ], [ %362, %block_.L_414b21 ]
...
block_.L_414af1:                                  ; preds = %block_414afd, %block_.L_414aec
  %197 = phi i64 [ %196, %block_.L_414aec ], [ %320, %block_414afd ]
...
block_.L_414b21:                                  ; preds = %block_.L_414af1
  ...
  %call2_414b24 = tail call %struct.Memory* @sub_40c100._Z9check_sumIiEvT_(%struct.State* %0, i64 %326, %struct.Memory* %MEMORY.2)
...
block_.L_414b37:                                  ; preds = %block_.L_414a9f
  ...
  %call2_414b37 = tail call %struct.Memory* @sub_400df0._Z5timerv(%struct.State* %0, i64 %363, %struct.Memory* %MEMORY.0)
  ...
  %call2_414b40 = tail call %struct.Memory* @sub_400790._Z13record_resultdPKc(%struct.State* %0, i64 %374, %struct.Memory* %call2_414b37)
