...
entry:
  ...
  %call2_414a93 = tail call %struct.Memory* @sub_400dd0._Z11start_timerv(%struct.State* %0, i64 %58, %struct.Memory* %2)
...
block_.L_414a9f:                                  ; preds = %block_.L_414b21, %entry
  %68 = phi i64 [ %.pre, %entry ], [ %364, %block_.L_414b21 ]
  %MEMORY.0 = phi %struct.Memory* [ %call2_414a93, %entry ], [ %call2_414b24, %block_.L_414b21 ]
  ...
  br i1 %101, label %block_414aaf, label %block_.L_414b37
...
block_.L_414abd:                                  ; preds = %block_414ace, %block_414aaf
  %111 = phi i64 [ %.pre1, %block_414aaf ], [ %195, %block_414ace ]
  %MEMORY.1 = phi %struct.Memory* [ %MEMORY.0, %block_414aaf ], [ %call2_414ad9, %block_414ace ]
  ...
  br i1 %149, label %block_414ace, label %block_.L_414aec
...
block_414ace:                                     ; preds = %block_.L_414abd
  ...
  %call2_414ad9 = tail call %struct.Memory* @sub_40c450._ZN15loop_inner_bodyILi24EiE7do_workERiPKii(%struct.State* %0, i64 %159, %struct.Memory* %MEMORY.1)
...
block_.L_414af1:                                  ; preds = %block_414afd, %block_.L_414aec
  %197 = phi i64 [ %196, %block_.L_414aec ], [ %321, %block_414afd ]
  %198 = phi i64 [ %112, %block_.L_414aec ], [ %.pre2, %block_414afd ]
  %MEMORY.2 = phi %struct.Memory* [ %MEMORY.1, %block_.L_414aec ], [ %call2_414b08, %block_414afd ]
  %199 = add i64 %198, -36
  %200 = add i64 %197, 3
  ...
  br i1 %233, label %block_414afd, label %block_.L_414b21
...
block_414afd:                                     ; preds = %block_.L_414af1
  ...
  %call2_414b08 = tail call %struct.Memory* @sub_40c0d0._Z18complete_hash_funcIiET_S0_(%struct.State* %0, i64 %248, %struct.Memory* %MEMORY.2)
...
block_.L_414b21:                                  ; preds = %block_.L_414af1
  ...
  %call2_414b24 = tail call %struct.Memory* @sub_40c100._Z9check_sumIiEvT_(%struct.State* %0, i64 %327, %struct.Memory* %MEMORY.2)
...
block_.L_414b37:                                  ; preds = %block_.L_414a9f
  ...
  %call2_414b37 = tail call %struct.Memory* @sub_400df0._Z5timerv(%struct.State* %0, i64 %365, %struct.Memory* %MEMORY.0)
  ...
  %call2_414b40 = tail call %struct.Memory* @sub_400790._Z13record_resultdPKc(%struct.State* %0, i64 %376, %struct.Memory* %call2_414b37)
  ...
  ret %struct.Memory* %call2_414b40
}
...
define %struct.Memory* @routine_jge_.L_414b37(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i8* %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
...
define %struct.Memory* @routine_jge_.L_414aec(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i8* %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 2, i32 9
...
define %struct.Memory* @routine_jmpq_.L_414abd(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
...
define %struct.Memory* @routine_jmpq_.L_414af1(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
...
define %struct.Memory* @routine_jge_.L_414b21(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i8* %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 2, i32 9
...
define %struct.Memory* @routine_jmpq_.L_414a9f(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
