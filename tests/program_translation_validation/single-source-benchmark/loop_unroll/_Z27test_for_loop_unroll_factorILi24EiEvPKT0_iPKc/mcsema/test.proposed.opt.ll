...
define %struct.Memory* @_Z27test_for_loop_unroll_factorILi24EiEvPKT0_iPKc(%struct.State* noalias, i64, %struct.Memory* noalias readnone) local_unnamed_addr #1 {
entry:
...
block_.L_414acf:                                  ; preds = %block_.L_414b51, %entry
  %68 = phi i64 [ %362, %block_.L_414b51 ], [ %.pre, %entry ]
...
block_.L_414aed:                                  ; preds = %block_414afe, %block_414adf
  %111 = phi i64 [ %195, %block_414afe ], [ %.pre9, %block_414adf ]
...
block_414afe:                                     ; preds = %block_.L_414aed
  ...
  %call2_414b09 = tail call %struct.Memory* @sub_40c480._ZN15loop_inner_bodyILi24EiE7do_workERiPKii(%struct.State* nonnull %0, i64 %159, %struct.Memory* %call2_414ac3)
...
block_414b2d:                                     ; preds = %block_.L_414b21
  ...
  %call2_414b38 = tail call %struct.Memory* @sub_40c100._Z18complete_hash_funcIiET_S0_(%struct.State* nonnull %0, i64 %247, %struct.Memory* %call2_414ac3)
...
block_.L_414b51:                                  ; preds = %block_.L_414b21
  ...
  %call2_414b54 = tail call %struct.Memory* @sub_40c130._Z9check_sumIiEvT_(%struct.State* nonnull %0, i64 %326, %struct.Memory* %call2_414ac3)
...
block_.L_414b67:                                  ; preds = %block_.L_414acf
  ...
  %call2_414b67 = tail call %struct.Memory* @sub_400e20._Z5timerv(%struct.State* nonnull %0, i64 %363, %struct.Memory* %call2_414ac3)
