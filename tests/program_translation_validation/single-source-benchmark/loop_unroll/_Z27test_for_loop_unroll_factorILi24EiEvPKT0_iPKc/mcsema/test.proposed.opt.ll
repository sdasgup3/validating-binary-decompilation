...
entry:
  ...
  %call2_414ad3 = tail call %struct.Memory* @sub_400e10._Z11start_timerv(%struct.State* %0, i64 %58, %struct.Memory* %2)
...
block_.L_414adf:                                  ; preds = %block_.L_414b61, %entry
  %68 = phi i64 [ %362, %block_.L_414b61 ], [ %.pre, %entry ]
  ...
  br i1 %101, label %block_414aef, label %block_.L_414b77
...
block_.L_414afd:                                  ; preds = %block_414b0e, %block_414aef
  %111 = phi i64 [ %195, %block_414b0e ], [ %.pre9, %block_414aef ]
  ...
  br i1 %149, label %block_414b0e, label %block_.L_414b2c
...
block_414b0e:                                     ; preds = %block_.L_414afd
  ...
  %call2_414b19 = tail call %struct.Memory* @sub_40c490._ZN15loop_inner_bodyILi24EiE7do_workERiPKii(%struct.State* nonnull %0, i64 %159, %struct.Memory* %call2_414ad3)
...
block_.L_414b31:                                  ; preds = %block_414b3d, %block_.L_414b2c
  %197 = phi i64 [ %112, %block_.L_414b2c ], [ %.pre10, %block_414b3d ]
  %storemerge = phi i64 [ %196, %block_.L_414b2c ], [ %319, %block_414b3d ]
  %198 = add i64 %197, -36
  ...
  br i1 %232, label %block_414b3d, label %block_.L_414b61
...
block_414b3d:                                     ; preds = %block_.L_414b31
  ...
  %call2_414b48 = tail call %struct.Memory* @sub_40c110._Z18complete_hash_funcIiET_S0_(%struct.State* nonnull %0, i64 %247, %struct.Memory* %call2_414ad3)
...
block_.L_414b61:                                  ; preds = %block_.L_414b31
  ...
  %call2_414b64 = tail call %struct.Memory* @sub_40c140._Z9check_sumIiEvT_(%struct.State* nonnull %0, i64 %326, %struct.Memory* %call2_414ad3)
...
block_.L_414b77:                                  ; preds = %block_.L_414adf
  ...
  %call2_414b77 = tail call %struct.Memory* @sub_400e30._Z5timerv(%struct.State* nonnull %0, i64 %363, %struct.Memory* %call2_414ad3)
  ...
  %call2_414b80 = tail call %struct.Memory* @sub_4007d0._Z13record_resultdPKc(%struct.State* nonnull %0, i64 %374, %struct.Memory* %call2_414b77)
