...
entry:
  ...
  %call2_40a263 = tail call %struct.Memory* @sub_400e10._Z11start_timerv(%struct.State* %0, i64 %58, %struct.Memory* %2)
  ...
  br label %block_.L_40a26f

block_.L_40a26f:                                  ; preds = %block_.L_40a2f8, %entry
  %74 = phi i64 [ %341, %block_.L_40a2f8 ], [ %.pre, %entry ]
  ...
  br i1 %107, label %block_40a27f, label %block_.L_40a310

block_40a27f:                                     ; preds = %block_.L_40a26f
...
block_.L_40a28e:                                  ; preds = %block_40a29f, %block_40a27f
  %118 = phi i64 [ %202, %block_40a29f ], [ %.pre9, %block_40a27f ]
  ...
  br i1 %156, label %block_40a29f, label %block_.L_40a2bd

block_40a29f:                                     ; preds = %block_.L_40a28e
  %158 = add i64 %119, -40
  ...
  %call2_40a2aa = tail call %struct.Memory* @sub_401870._ZN15loop_inner_bodyILi25EdE7do_workERdPKdi(%struct.State* nonnull %0, i64 %166, %struct.Memory* %call2_40a263)
...
block_.L_40a2bd:                                  ; preds = %block_.L_40a28e
  %203 = add i64 %157, 5
  br label %block_.L_40a2c2

block_.L_40a2c2:                                  ; preds = %block_40a2ce, %block_.L_40a2bd
  %204 = phi i64 [ %119, %block_.L_40a2bd ], [ %.pre10, %block_40a2ce ]
  %storemerge = phi i64 [ %203, %block_.L_40a2bd ], [ %299, %block_40a2ce ]
  %205 = add i64 %204, -44
  ...
  br i1 %239, label %block_40a2ce, label %block_.L_40a2f8
...
block_40a2ce:                                     ; preds = %block_.L_40a2c2
  ...
  %call2_40a2db = tail call %struct.Memory* @sub_4014c0._Z18complete_hash_funcIdET_S0_(%struct.State* nonnull %0, i64 %253, %struct.Memory* %call2_40a263)
...
block_.L_40a2f8:                                  ; preds = %block_.L_40a2c2
  ...
  %call2_40a2fd = tail call %struct.Memory* @sub_4014f0._Z9check_sumIdEvT_(%struct.State* nonnull %0, i64 %305, %struct.Memory* %call2_40a263)
...
block_.L_40a310:                                  ; preds = %block_.L_40a26f
  ...
  %call2_40a310 = tail call %struct.Memory* @sub_400e30._Z5timerv(%struct.State* nonnull %0, i64 %342, %struct.Memory* %call2_40a263)
  ...
  %call2_40a319 = tail call %struct.Memory* @sub_4007d0._Z13record_resultdPKc(%struct.State* nonnull %0, i64 %353, %struct.Memory* %call2_40a310)
