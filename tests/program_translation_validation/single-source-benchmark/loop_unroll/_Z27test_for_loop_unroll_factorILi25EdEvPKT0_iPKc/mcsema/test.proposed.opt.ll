...
define %struct.Memory* @_Z27test_for_loop_unroll_factorILi25EdEvPKT0_iPKc(%struct.State* noalias, i64, %struct.Memory* noalias readnone) local_unnamed_addr #1 {
entry:
...
block_.L_40a25f:                                  ; preds = %block_.L_40a2e8, %entry
  %74 = phi i64 [ %341, %block_.L_40a2e8 ], [ %.pre, %entry ]
...
block_.L_40a27e:                                  ; preds = %block_40a28f, %block_40a26f
  %118 = phi i64 [ %202, %block_40a28f ], [ %.pre9, %block_40a26f ]
...
block_40a28f:                                     ; preds = %block_.L_40a27e
  ...
  %call2_40a29a = tail call %struct.Memory* @sub_401860._ZN15loop_inner_bodyILi25EdE7do_workERdPKdi(%struct.State* nonnull %0, i64 %166, %struct.Memory* %call2_40a253)
...
block_40a2be:                                     ; preds = %block_.L_40a2b2
  ...
  %call2_40a2cb = tail call %struct.Memory* @sub_4014b0._Z18complete_hash_funcIdET_S0_(%struct.State* nonnull %0, i64 %253, %struct.Memory* %call2_40a253)
...
block_.L_40a2e8:                                  ; preds = %block_.L_40a2b2
  ...
  %call2_40a2ed = tail call %struct.Memory* @sub_4014e0._Z9check_sumIdEvT_(%struct.State* nonnull %0, i64 %305, %struct.Memory* %call2_40a253)
...
block_.L_40a300:                                  ; preds = %block_.L_40a25f
  ...
  %call2_40a300 = tail call %struct.Memory* @sub_400e20._Z5timerv(%struct.State* nonnull %0, i64 %342, %struct.Memory* %call2_40a253)
