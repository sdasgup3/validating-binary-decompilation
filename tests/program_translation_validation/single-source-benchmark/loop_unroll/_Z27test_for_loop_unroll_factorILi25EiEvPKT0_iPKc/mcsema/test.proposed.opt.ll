...
block_.L_41497f:                                  ; preds = %block_.L_414a01, %entry
  %68 = phi i64 [ %.pre, %entry ], [ %362, %block_.L_414a01 ]
...
block_.L_4149d1:                                  ; preds = %block_4149dd, %block_.L_4149cc
  %197 = phi i64 [ %196, %block_.L_4149cc ], [ %320, %block_4149dd ]
...
block_.L_414a01:                                  ; preds = %block_.L_4149d1
  ...
  %call2_414a04 = tail call %struct.Memory* @sub_40c100._Z9check_sumIiEvT_(%struct.State* %0, i64 %326, %struct.Memory* %MEMORY.2)
...
block_.L_414a17:                                  ; preds = %block_.L_41497f
  ...
  %call2_414a17 = tail call %struct.Memory* @sub_400df0._Z5timerv(%struct.State* %0, i64 %363, %struct.Memory* %MEMORY.0)
  ...
  %call2_414a20 = tail call %struct.Memory* @sub_400790._Z13record_resultdPKc(%struct.State* %0, i64 %374, %struct.Memory* %call2_414a17)
