...
declare %struct.Memory* @sub_40c420._ZN15loop_inner_bodyILi25EiE7do_workERiPKii(%struct.State* noalias dereferenceable(3376), i64, %struct.Memory* noalias readnone returned) local_unnamed_addr
...
define %struct.Memory* @_Z27test_for_loop_unroll_factorILi25EiEvPKT0_iPKc(%struct.State* noalias, i64, %struct.Memory* noalias readnone) local_unnamed_addr #1 {
entry:
...
block_.L_4149af:                                  ; preds = %block_.L_414a31, %entry
  %68 = phi i64 [ %362, %block_.L_414a31 ], [ %.pre, %entry ]
...
block_.L_4149cd:                                  ; preds = %block_4149de, %block_4149bf
  %111 = phi i64 [ %195, %block_4149de ], [ %.pre9, %block_4149bf ]
...
block_4149de:                                     ; preds = %block_.L_4149cd
  ...
  %call2_4149e9 = tail call %struct.Memory* @sub_40c420._ZN15loop_inner_bodyILi25EiE7do_workERiPKii(%struct.State* nonnull %0, i64 %159, %struct.Memory* %call2_4149a3)
...
block_414a0d:                                     ; preds = %block_.L_414a01
  ...
  %call2_414a18 = tail call %struct.Memory* @sub_40c100._Z18complete_hash_funcIiET_S0_(%struct.State* nonnull %0, i64 %247, %struct.Memory* %call2_4149a3)
...
block_.L_414a31:                                  ; preds = %block_.L_414a01
  ...
  %call2_414a34 = tail call %struct.Memory* @sub_40c130._Z9check_sumIiEvT_(%struct.State* nonnull %0, i64 %326, %struct.Memory* %call2_4149a3)
...
block_.L_414a47:                                  ; preds = %block_.L_4149af
  ...
  %call2_414a47 = tail call %struct.Memory* @sub_400e20._Z5timerv(%struct.State* nonnull %0, i64 %363, %struct.Memory* %call2_4149a3)
