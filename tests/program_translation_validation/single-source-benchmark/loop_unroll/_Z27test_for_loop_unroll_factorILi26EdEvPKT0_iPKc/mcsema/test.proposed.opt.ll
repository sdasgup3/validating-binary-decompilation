...
entry:
  ...
  %call2_40a133 = tail call %struct.Memory* @sub_400e10._Z11start_timerv(%struct.State* %0, i64 %58, %struct.Memory* %2)
...
block_.L_40a13f:                                  ; preds = %block_.L_40a1c8, %entry
  %74 = phi i64 [ %341, %block_.L_40a1c8 ], [ %.pre, %entry ]
  ...
  br i1 %107, label %block_40a14f, label %block_.L_40a1e0
...
block_.L_40a15e:                                  ; preds = %block_40a16f, %block_40a14f
  %118 = phi i64 [ %202, %block_40a16f ], [ %.pre9, %block_40a14f ]
  ...
  br i1 %156, label %block_40a16f, label %block_.L_40a18d

block_40a16f:                                     ; preds = %block_.L_40a15e
  %158 = add i64 %119, -40
  ...
  %call2_40a17a = tail call %struct.Memory* @sub_401810._ZN15loop_inner_bodyILi26EdE7do_workERdPKdi(%struct.State* nonnull %0, i64 %166, %struct.Memory* %call2_40a133)
...
block_.L_40a18d:                                  ; preds = %block_.L_40a15e
  %203 = add i64 %157, 5
  br label %block_.L_40a192

block_.L_40a192:                                  ; preds = %block_40a19e, %block_.L_40a18d
  %204 = phi i64 [ %119, %block_.L_40a18d ], [ %.pre10, %block_40a19e ]
  %storemerge = phi i64 [ %203, %block_.L_40a18d ], [ %299, %block_40a19e ]
  %205 = add i64 %204, -44
  ...
  br i1 %239, label %block_40a19e, label %block_.L_40a1c8
...
block_40a19e:                                     ; preds = %block_.L_40a192
  ...
  %call2_40a1ab = tail call %struct.Memory* @sub_4014c0._Z18complete_hash_funcIdET_S0_(%struct.State* nonnull %0, i64 %253, %struct.Memory* %call2_40a133)
...
block_.L_40a1c8:                                  ; preds = %block_.L_40a192
  ...
  %call2_40a1cd = tail call %struct.Memory* @sub_4014f0._Z9check_sumIdEvT_(%struct.State* nonnull %0, i64 %305, %struct.Memory* %call2_40a133)
...
block_.L_40a1e0:                                  ; preds = %block_.L_40a13f
  ...
  %call2_40a1e0 = tail call %struct.Memory* @sub_400e30._Z5timerv(%struct.State* nonnull %0, i64 %342, %struct.Memory* %call2_40a133)
  ...
  %call2_40a1e9 = tail call %struct.Memory* @sub_4007d0._Z13record_resultdPKc(%struct.State* nonnull %0, i64 %353, %struct.Memory* %call2_40a1e0)
