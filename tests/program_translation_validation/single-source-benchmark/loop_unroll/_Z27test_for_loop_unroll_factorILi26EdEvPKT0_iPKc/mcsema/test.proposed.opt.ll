...
define %struct.Memory* @_Z27test_for_loop_unroll_factorILi26EdEvPKT0_iPKc(%struct.State* noalias, i64, %struct.Memory* noalias readnone) local_unnamed_addr #1 {
entry:
...
block_.L_40a12f:                                  ; preds = %block_.L_40a1b8, %entry
  %74 = phi i64 [ %341, %block_.L_40a1b8 ], [ %.pre, %entry ]
...
block_.L_40a14e:                                  ; preds = %block_40a15f, %block_40a13f
  %118 = phi i64 [ %202, %block_40a15f ], [ %.pre9, %block_40a13f ]
...
block_40a15f:                                     ; preds = %block_.L_40a14e
  ...
  %call2_40a16a = tail call %struct.Memory* @sub_401800._ZN15loop_inner_bodyILi26EdE7do_workERdPKdi(%struct.State* nonnull %0, i64 %166, %struct.Memory* %call2_40a123)
...
block_40a18e:                                     ; preds = %block_.L_40a182
  ...
  %call2_40a19b = tail call %struct.Memory* @sub_4014b0._Z18complete_hash_funcIdET_S0_(%struct.State* nonnull %0, i64 %253, %struct.Memory* %call2_40a123)
...
block_.L_40a1b8:                                  ; preds = %block_.L_40a182
  ...
  %call2_40a1bd = tail call %struct.Memory* @sub_4014e0._Z9check_sumIdEvT_(%struct.State* nonnull %0, i64 %305, %struct.Memory* %call2_40a123)
...
block_.L_40a1d0:                                  ; preds = %block_.L_40a12f
  ...
  %call2_40a1d0 = tail call %struct.Memory* @sub_400e20._Z5timerv(%struct.State* nonnull %0, i64 %342, %struct.Memory* %call2_40a123)
