...
entry:
  ...
  %call2_414893 = tail call %struct.Memory* @sub_400e10._Z11start_timerv(%struct.State* %0, i64 %58, %struct.Memory* %2)
...
block_.L_41489f:                                  ; preds = %block_.L_414921, %entry
  %68 = phi i64 [ %362, %block_.L_414921 ], [ %.pre, %entry ]
  ...
  br i1 %101, label %block_4148af, label %block_.L_414937
...
block_.L_4148bd:                                  ; preds = %block_4148ce, %block_4148af
  %111 = phi i64 [ %195, %block_4148ce ], [ %.pre9, %block_4148af ]
  ...
  br i1 %149, label %block_4148ce, label %block_.L_4148ec
...
block_4148ce:                                     ; preds = %block_.L_4148bd
  ...
  %call2_4148d9 = tail call %struct.Memory* @sub_40c3d0._ZN15loop_inner_bodyILi26EiE7do_workERiPKii(%struct.State* nonnull %0, i64 %159, %struct.Memory* %call2_414893)
...
block_.L_4148f1:                                  ; preds = %block_4148fd, %block_.L_4148ec
  %197 = phi i64 [ %112, %block_.L_4148ec ], [ %.pre10, %block_4148fd ]
  %storemerge = phi i64 [ %196, %block_.L_4148ec ], [ %319, %block_4148fd ]
  %198 = add i64 %197, -36
  ...
  br i1 %232, label %block_4148fd, label %block_.L_414921
...
block_4148fd:                                     ; preds = %block_.L_4148f1
  ...
  %call2_414908 = tail call %struct.Memory* @sub_40c110._Z18complete_hash_funcIiET_S0_(%struct.State* nonnull %0, i64 %247, %struct.Memory* %call2_414893)
...
block_.L_414921:                                  ; preds = %block_.L_4148f1
  ...
  %call2_414924 = tail call %struct.Memory* @sub_40c140._Z9check_sumIiEvT_(%struct.State* nonnull %0, i64 %326, %struct.Memory* %call2_414893)
...
block_.L_414937:                                  ; preds = %block_.L_41489f
  ...
  %call2_414937 = tail call %struct.Memory* @sub_400e30._Z5timerv(%struct.State* nonnull %0, i64 %363, %struct.Memory* %call2_414893)
  ...
  %call2_414940 = tail call %struct.Memory* @sub_4007d0._Z13record_resultdPKc(%struct.State* nonnull %0, i64 %374, %struct.Memory* %call2_414937)
