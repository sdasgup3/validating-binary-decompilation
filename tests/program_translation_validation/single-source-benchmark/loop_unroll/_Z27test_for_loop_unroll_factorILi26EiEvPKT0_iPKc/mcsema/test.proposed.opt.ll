...
entry:
  ...
  %call2_414853 = tail call %struct.Memory* @sub_400dd0._Z11start_timerv(%struct.State* %0, i64 %58, %struct.Memory* %2)
...
block_.L_41485f:                                  ; preds = %block_.L_4148e1, %entry
  %68 = phi i64 [ %.pre, %entry ], [ %364, %block_.L_4148e1 ]
  %MEMORY.0 = phi %struct.Memory* [ %call2_414853, %entry ], [ %call2_4148e4, %block_.L_4148e1 ]
  ...
  br i1 %101, label %block_41486f, label %block_.L_4148f7
...
block_.L_41487d:                                  ; preds = %block_41488e, %block_41486f
  %111 = phi i64 [ %.pre1, %block_41486f ], [ %195, %block_41488e ]
  %MEMORY.1 = phi %struct.Memory* [ %MEMORY.0, %block_41486f ], [ %call2_414899, %block_41488e ]
  ...
  br i1 %149, label %block_41488e, label %block_.L_4148ac
...
block_41488e:                                     ; preds = %block_.L_41487d
  ...
  %call2_414899 = tail call %struct.Memory* @sub_40c390._ZN15loop_inner_bodyILi26EiE7do_workERiPKii(%struct.State* %0, i64 %159, %struct.Memory* %MEMORY.1)
...
block_.L_4148b1:                                  ; preds = %block_4148bd, %block_.L_4148ac
  %197 = phi i64 [ %196, %block_.L_4148ac ], [ %321, %block_4148bd ]
  %198 = phi i64 [ %112, %block_.L_4148ac ], [ %.pre2, %block_4148bd ]
  %MEMORY.2 = phi %struct.Memory* [ %MEMORY.1, %block_.L_4148ac ], [ %call2_4148c8, %block_4148bd ]
  %199 = add i64 %198, -36
  %200 = add i64 %197, 3
  ...
  br i1 %233, label %block_4148bd, label %block_.L_4148e1
...
block_4148bd:                                     ; preds = %block_.L_4148b1
  ...
  %call2_4148c8 = tail call %struct.Memory* @sub_40c0d0._Z18complete_hash_funcIiET_S0_(%struct.State* %0, i64 %248, %struct.Memory* %MEMORY.2)
...
block_.L_4148e1:                                  ; preds = %block_.L_4148b1
  ...
  %call2_4148e4 = tail call %struct.Memory* @sub_40c100._Z9check_sumIiEvT_(%struct.State* %0, i64 %327, %struct.Memory* %MEMORY.2)
...
block_.L_4148f7:                                  ; preds = %block_.L_41485f
  ...
  %call2_4148f7 = tail call %struct.Memory* @sub_400df0._Z5timerv(%struct.State* %0, i64 %365, %struct.Memory* %MEMORY.0)
  ...
  %call2_414900 = tail call %struct.Memory* @sub_400790._Z13record_resultdPKc(%struct.State* %0, i64 %376, %struct.Memory* %call2_4148f7)
  ...
  ret %struct.Memory* %call2_414900
}
...
define %struct.Memory* @routine_jge_.L_4148f7(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i8* %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
...
define %struct.Memory* @routine_jge_.L_4148ac(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i8* %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 2, i32 9
...
define %struct.Memory* @routine_jmpq_.L_41487d(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
...
define %struct.Memory* @routine_jmpq_.L_4148b1(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
...
define %struct.Memory* @routine_jge_.L_4148e1(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i8* %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 2, i32 9
...
define %struct.Memory* @routine_jmpq_.L_41485f(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
