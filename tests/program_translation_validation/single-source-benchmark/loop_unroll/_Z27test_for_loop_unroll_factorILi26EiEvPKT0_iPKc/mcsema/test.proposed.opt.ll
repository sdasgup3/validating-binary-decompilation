...
block_.L_41485f:                                  ; preds = %block_.L_4148e1, %entry
  %68 = phi i64 [ %.pre, %entry ], [ %362, %block_.L_4148e1 ]
...
block_.L_4148b1:                                  ; preds = %block_4148bd, %block_.L_4148ac
  %197 = phi i64 [ %196, %block_.L_4148ac ], [ %320, %block_4148bd ]
...
block_.L_4148e1:                                  ; preds = %block_.L_4148b1
  ...
  %call2_4148e4 = tail call %struct.Memory* @sub_40c100._Z9check_sumIiEvT_(%struct.State* %0, i64 %326, %struct.Memory* %MEMORY.2)
...
block_.L_4148f7:                                  ; preds = %block_.L_41485f
  ...
  %call2_4148f7 = tail call %struct.Memory* @sub_400df0._Z5timerv(%struct.State* %0, i64 %363, %struct.Memory* %MEMORY.0)
  ...
  %call2_414900 = tail call %struct.Memory* @sub_400790._Z13record_resultdPKc(%struct.State* %0, i64 %374, %struct.Memory* %call2_4148f7)
