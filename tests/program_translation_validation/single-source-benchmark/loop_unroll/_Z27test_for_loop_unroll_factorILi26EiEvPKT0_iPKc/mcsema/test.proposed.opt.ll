...
define %struct.Memory* @_Z27test_for_loop_unroll_factorILi26EiEvPKT0_iPKc(%struct.State* noalias, i64, %struct.Memory* noalias readnone) local_unnamed_addr #1 {
entry:
...
block_.L_41488f:                                  ; preds = %block_.L_414911, %entry
  %68 = phi i64 [ %362, %block_.L_414911 ], [ %.pre, %entry ]
...
block_.L_4148ad:                                  ; preds = %block_4148be, %block_41489f
  %111 = phi i64 [ %195, %block_4148be ], [ %.pre9, %block_41489f ]
...
block_4148be:                                     ; preds = %block_.L_4148ad
  ...
  %call2_4148c9 = tail call %struct.Memory* @sub_40c3c0._ZN15loop_inner_bodyILi26EiE7do_workERiPKii(%struct.State* nonnull %0, i64 %159, %struct.Memory* %call2_414883)
...
block_4148ed:                                     ; preds = %block_.L_4148e1
  ...
  %call2_4148f8 = tail call %struct.Memory* @sub_40c100._Z18complete_hash_funcIiET_S0_(%struct.State* nonnull %0, i64 %247, %struct.Memory* %call2_414883)
...
block_.L_414911:                                  ; preds = %block_.L_4148e1
  ...
  %call2_414914 = tail call %struct.Memory* @sub_40c130._Z9check_sumIiEvT_(%struct.State* nonnull %0, i64 %326, %struct.Memory* %call2_414883)
...
block_.L_414927:                                  ; preds = %block_.L_41488f
  ...
  %call2_414927 = tail call %struct.Memory* @sub_400e20._Z5timerv(%struct.State* nonnull %0, i64 %363, %struct.Memory* %call2_414883)
