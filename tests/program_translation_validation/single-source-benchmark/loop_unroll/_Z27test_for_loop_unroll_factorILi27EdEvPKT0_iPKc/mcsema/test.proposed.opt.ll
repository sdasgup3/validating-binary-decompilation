...
entry:
  ...
  %call2_40a003 = tail call %struct.Memory* @sub_400e10._Z11start_timerv(%struct.State* %0, i64 %58, %struct.Memory* %2)
...
block_.L_40a00f:                                  ; preds = %block_.L_40a098, %entry
  %74 = phi i64 [ %341, %block_.L_40a098 ], [ %.pre, %entry ]
  ...
  br i1 %107, label %block_40a01f, label %block_.L_40a0b0
...
block_.L_40a02e:                                  ; preds = %block_40a03f, %block_40a01f
  %118 = phi i64 [ %202, %block_40a03f ], [ %.pre9, %block_40a01f ]
  ...
  br i1 %156, label %block_40a03f, label %block_.L_40a05d
...
block_40a03f:                                     ; preds = %block_.L_40a02e
  ...
  %call2_40a04a = tail call %struct.Memory* @sub_4017b0._ZN15loop_inner_bodyILi27EdE7do_workERdPKdi(%struct.State* nonnull %0, i64 %166, %struct.Memory* %call2_40a003)
...
block_.L_40a062:                                  ; preds = %block_40a06e, %block_.L_40a05d
  %204 = phi i64 [ %119, %block_.L_40a05d ], [ %.pre10, %block_40a06e ]
  %storemerge = phi i64 [ %203, %block_.L_40a05d ], [ %299, %block_40a06e ]
  %205 = add i64 %204, -44
  ...
  br i1 %239, label %block_40a06e, label %block_.L_40a098
...
block_40a06e:                                     ; preds = %block_.L_40a062
  ...
  %call2_40a07b = tail call %struct.Memory* @sub_4014c0._Z18complete_hash_funcIdET_S0_(%struct.State* nonnull %0, i64 %253, %struct.Memory* %call2_40a003)
...
block_.L_40a098:                                  ; preds = %block_.L_40a062
  ...
  %call2_40a09d = tail call %struct.Memory* @sub_4014f0._Z9check_sumIdEvT_(%struct.State* nonnull %0, i64 %305, %struct.Memory* %call2_40a003)
...
block_.L_40a0b0:                                  ; preds = %block_.L_40a00f
  ...
  %call2_40a0b0 = tail call %struct.Memory* @sub_400e30._Z5timerv(%struct.State* nonnull %0, i64 %342, %struct.Memory* %call2_40a003)
  ...
  %call2_40a0b9 = tail call %struct.Memory* @sub_4007d0._Z13record_resultdPKc(%struct.State* nonnull %0, i64 %353, %struct.Memory* %call2_40a0b0)
