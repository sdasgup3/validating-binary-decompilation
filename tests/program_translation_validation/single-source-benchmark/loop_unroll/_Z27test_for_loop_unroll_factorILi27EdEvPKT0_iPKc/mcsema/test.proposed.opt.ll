...
define %struct.Memory* @_Z27test_for_loop_unroll_factorILi27EdEvPKT0_iPKc(%struct.State* noalias, i64, %struct.Memory* noalias readnone) local_unnamed_addr #1 {
entry:
...
block_.L_409fff:                                  ; preds = %block_.L_40a088, %entry
  %74 = phi i64 [ %341, %block_.L_40a088 ], [ %.pre, %entry ]
...
block_.L_40a01e:                                  ; preds = %block_40a02f, %block_40a00f
  %118 = phi i64 [ %202, %block_40a02f ], [ %.pre9, %block_40a00f ]
...
block_40a02f:                                     ; preds = %block_.L_40a01e
  ...
  %call2_40a03a = tail call %struct.Memory* @sub_4017a0._ZN15loop_inner_bodyILi27EdE7do_workERdPKdi(%struct.State* nonnull %0, i64 %166, %struct.Memory* %call2_409ff3)
...
block_40a05e:                                     ; preds = %block_.L_40a052
  ...
  %call2_40a06b = tail call %struct.Memory* @sub_4014b0._Z18complete_hash_funcIdET_S0_(%struct.State* nonnull %0, i64 %253, %struct.Memory* %call2_409ff3)
...
block_.L_40a088:                                  ; preds = %block_.L_40a052
  ...
  %call2_40a08d = tail call %struct.Memory* @sub_4014e0._Z9check_sumIdEvT_(%struct.State* nonnull %0, i64 %305, %struct.Memory* %call2_409ff3)
...
block_.L_40a0a0:                                  ; preds = %block_.L_409fff
  ...
  %call2_40a0a0 = tail call %struct.Memory* @sub_400e20._Z5timerv(%struct.State* nonnull %0, i64 %342, %struct.Memory* %call2_409ff3)
