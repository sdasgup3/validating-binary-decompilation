...
entry:
  ...
  %call2_414733 = tail call %struct.Memory* @sub_400dd0._Z11start_timerv(%struct.State* %0, i64 %58, %struct.Memory* %2)
...
block_.L_41473f:                                  ; preds = %block_.L_4147c1, %entry
  %68 = phi i64 [ %.pre, %entry ], [ %362, %block_.L_4147c1 ]
  %MEMORY.0 = phi %struct.Memory* [ %call2_414733, %entry ], [ %call2_4147c4, %block_.L_4147c1 ]
  ...
  br i1 %101, label %block_41474f, label %block_.L_4147d7
...
block_.L_41475d:                                  ; preds = %block_41476e, %block_41474f
  %111 = phi i64 [ %.pre1, %block_41474f ], [ %195, %block_41476e ]
  %MEMORY.1 = phi %struct.Memory* [ %MEMORY.0, %block_41474f ], [ %call2_414779, %block_41476e ]
  ...
  br i1 %149, label %block_41476e, label %block_.L_41478c
...
block_41476e:                                     ; preds = %block_.L_41475d
  ...
  %call2_414779 = tail call %struct.Memory* @sub_40c330._ZN15loop_inner_bodyILi27EiE7do_workERiPKii(%struct.State* %0, i64 %159, %struct.Memory* %MEMORY.1)
...
block_.L_414791:                                  ; preds = %block_41479d, %block_.L_41478c
  %197 = phi i64 [ %196, %block_.L_41478c ], [ %320, %block_41479d ]
  %198 = phi i64 [ %112, %block_.L_41478c ], [ %.pre2, %block_41479d ]
  %MEMORY.2 = phi %struct.Memory* [ %MEMORY.1, %block_.L_41478c ], [ %call2_4147a8, %block_41479d ]
  %199 = add i64 %198, -36
  %200 = add i64 %197, 3
  ...
  br i1 %233, label %block_41479d, label %block_.L_4147c1
...
block_41479d:                                     ; preds = %block_.L_414791
  ...
  %call2_4147a8 = tail call %struct.Memory* @sub_40c0d0._Z18complete_hash_funcIiET_S0_(%struct.State* %0, i64 %248, %struct.Memory* %MEMORY.2)
...
block_.L_4147c1:                                  ; preds = %block_.L_414791
  ...
  %call2_4147c4 = tail call %struct.Memory* @sub_40c100._Z9check_sumIiEvT_(%struct.State* %0, i64 %326, %struct.Memory* %MEMORY.2)
...
block_.L_4147d7:                                  ; preds = %block_.L_41473f
  ...
  %call2_4147d7 = tail call %struct.Memory* @sub_400df0._Z5timerv(%struct.State* %0, i64 %363, %struct.Memory* %MEMORY.0)
  ...
  %call2_4147e0 = tail call %struct.Memory* @sub_400790._Z13record_resultdPKc(%struct.State* %0, i64 %374, %struct.Memory* %call2_4147d7)
  ...
  ret %struct.Memory* %call2_4147e0
}
...
define %struct.Memory* @routine_jge_.L_4147d7(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i8* %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
...
define %struct.Memory* @routine_jge_.L_41478c(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i8* %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 2, i32 9
...
define %struct.Memory* @routine_addl__0x1b___eax(%struct.State* dereferenceable(3376), i64, %struct.Memory*) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %RAX = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 1, i32 0, i32 0
...
define %struct.Memory* @routine_jmpq_.L_41475d(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
...
define %struct.Memory* @routine_jmpq_.L_414791(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
...
define %struct.Memory* @routine_jge_.L_4147c1(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i8* %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 2, i32 9
...
define %struct.Memory* @routine_jmpq_.L_41473f(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
