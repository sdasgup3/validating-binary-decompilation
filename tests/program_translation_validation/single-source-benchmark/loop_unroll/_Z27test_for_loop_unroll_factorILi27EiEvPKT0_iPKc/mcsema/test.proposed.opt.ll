...
define %struct.Memory* @_Z27test_for_loop_unroll_factorILi27EiEvPKT0_iPKc(%struct.State* noalias, i64, %struct.Memory* noalias readnone) local_unnamed_addr #1 {
entry:
...
block_.L_41476f:                                  ; preds = %block_.L_4147f1, %entry
  %68 = phi i64 [ %362, %block_.L_4147f1 ], [ %.pre, %entry ]
...
block_.L_41478d:                                  ; preds = %block_41479e, %block_41477f
  %111 = phi i64 [ %195, %block_41479e ], [ %.pre9, %block_41477f ]
...
block_41479e:                                     ; preds = %block_.L_41478d
  ...
  %call2_4147a9 = tail call %struct.Memory* @sub_40c360._ZN15loop_inner_bodyILi27EiE7do_workERiPKii(%struct.State* nonnull %0, i64 %159, %struct.Memory* %call2_414763)
...
block_4147cd:                                     ; preds = %block_.L_4147c1
  ...
  %call2_4147d8 = tail call %struct.Memory* @sub_40c100._Z18complete_hash_funcIiET_S0_(%struct.State* nonnull %0, i64 %247, %struct.Memory* %call2_414763)
...
block_.L_4147f1:                                  ; preds = %block_.L_4147c1
  ...
  %call2_4147f4 = tail call %struct.Memory* @sub_40c130._Z9check_sumIiEvT_(%struct.State* nonnull %0, i64 %326, %struct.Memory* %call2_414763)
...
block_.L_414807:                                  ; preds = %block_.L_41476f
  ...
  %call2_414807 = tail call %struct.Memory* @sub_400e20._Z5timerv(%struct.State* nonnull %0, i64 %363, %struct.Memory* %call2_414763)
