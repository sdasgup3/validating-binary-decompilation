...
define %struct.Memory* @_Z27test_for_loop_unroll_factorILi28EdEvPKT0_iPKc(%struct.State* noalias, i64, %struct.Memory* noalias) local_unnamed_addr #1 {
entry:
  ...
  %call2_409ec3 = tail call %struct.Memory* @sub_400e00._Z11start_timerv(%struct.State* %0, i64 %58, %struct.Memory* %2)
...
block_.L_409ecf:                                  ; preds = %block_.L_409f58, %entry
  %74 = phi i64 [ %.pre, %entry ], [ %341, %block_.L_409f58 ]
  %MEMORY.0 = phi %struct.Memory* [ %call2_409ec3, %entry ], [ %call2_409f5d, %block_.L_409f58 ]
  ...
  br i1 %107, label %block_409edf, label %block_.L_409f70

block_409edf:                                     ; preds = %block_.L_409ecf
...
block_.L_409eee:                                  ; preds = %block_409eff, %block_409edf
  %118 = phi i64 [ %.pre9, %block_409edf ], [ %202, %block_409eff ]
  %MEMORY.1 = phi %struct.Memory* [ %MEMORY.0, %block_409edf ], [ %call2_409f0a, %block_409eff ]
  ...
  br i1 %156, label %block_409eff, label %block_.L_409f1d

block_409eff:                                     ; preds = %block_.L_409eee
  %158 = add i64 %119, -40
  ...
  %call2_409f0a = tail call %struct.Memory* @sub_401740._ZN15loop_inner_bodyILi28EdE7do_workERdPKdi(%struct.State* nonnull %0, i64 %166, %struct.Memory* %MEMORY.1)
...
block_.L_409f1d:                                  ; preds = %block_.L_409eee
  %203 = add i64 %157, 5
  br label %block_.L_409f22

block_.L_409f22:                                  ; preds = %block_409f2e, %block_.L_409f1d
  %204 = phi i64 [ %119, %block_.L_409f1d ], [ %.pre10, %block_409f2e ]
  %storemerge = phi i64 [ %203, %block_.L_409f1d ], [ %299, %block_409f2e ]
  %MEMORY.2 = phi %struct.Memory* [ %MEMORY.1, %block_.L_409f1d ], [ %call2_409f3b, %block_409f2e ]
  %205 = add i64 %204, -44
  ...
  br i1 %239, label %block_409f2e, label %block_.L_409f58

block_409f2e:                                     ; preds = %block_.L_409f22
  %241 = add i64 %204, -8
  %242 = add i64 %240, 4
  ...
  %call2_409f3b = tail call %struct.Memory* @sub_4014b0._Z18complete_hash_funcIdET_S0_(%struct.State* nonnull %0, i64 %253, %struct.Memory* %MEMORY.2)
...
block_.L_409f58:                                  ; preds = %block_.L_409f22
  %301 = add i64 %204, -40
  %302 = add i64 %240, 5
  ...
  %call2_409f5d = tail call %struct.Memory* @sub_4014e0._Z9check_sumIdEvT_(%struct.State* nonnull %0, i64 %305, %struct.Memory* %MEMORY.2)
...
block_.L_409f70:                                  ; preds = %block_.L_409ecf
  %342 = add i64 %108, -37200
  %343 = add i64 %108, 5
  ...
  %call2_409f70 = tail call %struct.Memory* @sub_400e20._Z5timerv(%struct.State* nonnull %0, i64 %342, %struct.Memory* %MEMORY.0)
  ...
  %call2_409f79 = tail call %struct.Memory* @sub_4007c0._Z13record_resultdPKc(%struct.State* nonnull %0, i64 %353, %struct.Memory* %call2_409f70)
  ...
  ret %struct.Memory* %call2_409f79
}
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_jge_.L_409f70(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i8* nocapture %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_jge_.L_409f1d(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i8* nocapture %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 2, i32 9
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_jmpq_.L_409eee(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_jmpq_.L_409f22(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_jge_.L_409f58(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i8* nocapture %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 2, i32 9
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_jmpq_.L_409ecf(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
