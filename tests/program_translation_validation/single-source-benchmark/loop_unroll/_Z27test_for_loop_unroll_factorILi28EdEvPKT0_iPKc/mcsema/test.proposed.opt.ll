...
entry:
  ...
  %call2_409e93 = tail call %struct.Memory* @sub_400dd0._Z11start_timerv(%struct.State* %0, i64 %58, %struct.Memory* %2)
...
block_.L_409e9f:                                  ; preds = %block_.L_409f28, %entry
  %79 = phi i64 [ %.pre, %entry ], [ %350, %block_.L_409f28 ]
  %MEMORY.0 = phi %struct.Memory* [ %call2_409e93, %entry ], [ %call2_409f2d, %block_.L_409f28 ]
  ...
  br i1 %112, label %block_409eaf, label %block_.L_409f40

block_409eaf:                                     ; preds = %block_.L_409e9f
...
block_.L_409ebe:                                  ; preds = %block_409ecf, %block_409eaf
  %124 = phi i64 [ %.pre1, %block_409eaf ], [ %208, %block_409ecf ]
  %MEMORY.1 = phi %struct.Memory* [ %MEMORY.0, %block_409eaf ], [ %call2_409eda, %block_409ecf ]
  ...
  br i1 %162, label %block_409ecf, label %block_.L_409eed

block_409ecf:                                     ; preds = %block_.L_409ebe
  %164 = add i64 %125, -40
  ...
  %call2_409eda = tail call %struct.Memory* @sub_401710._ZN15loop_inner_bodyILi28EdE7do_workERdPKdi(%struct.State* %0, i64 %172, %struct.Memory* %MEMORY.1)
...
block_.L_409eed:                                  ; preds = %block_.L_409ebe
  %209 = add i64 %163, 5
  store i64 %209, i64* %3, align 8
  br label %block_.L_409ef2

block_.L_409ef2:                                  ; preds = %block_409efe, %block_.L_409eed
  %210 = phi i64 [ %209, %block_.L_409eed ], [ %307, %block_409efe ]
  %211 = phi i64 [ %125, %block_.L_409eed ], [ %.pre2, %block_409efe ]
  %MEMORY.2 = phi %struct.Memory* [ %MEMORY.1, %block_.L_409eed ], [ %call2_409f0b, %block_409efe ]
  %212 = add i64 %211, -44
  %213 = add i64 %210, 3
  ...
  br i1 %246, label %block_409efe, label %block_.L_409f28

block_409efe:                                     ; preds = %block_.L_409ef2
  %248 = add i64 %211, -8
  %249 = add i64 %247, 4
  ...
  %call2_409f0b = tail call %struct.Memory* @sub_401480._Z18complete_hash_funcIdET_S0_(%struct.State* %0, i64 %261, %struct.Memory* %MEMORY.2)
...
block_.L_409f28:                                  ; preds = %block_.L_409ef2
  %308 = add i64 %211, -40
  %309 = add i64 %247, 5
  ...
  %call2_409f2d = tail call %struct.Memory* @sub_4014b0._Z9check_sumIdEvT_(%struct.State* %0, i64 %313, %struct.Memory* %MEMORY.2)
...
block_.L_409f40:                                  ; preds = %block_.L_409e9f
  %351 = add i64 %113, -37200
  %352 = add i64 %113, 5
  ...
  %call2_409f40 = tail call %struct.Memory* @sub_400df0._Z5timerv(%struct.State* %0, i64 %351, %struct.Memory* %MEMORY.0)
  ...
  %call2_409f49 = tail call %struct.Memory* @sub_400790._Z13record_resultdPKc(%struct.State* %0, i64 %362, %struct.Memory* %call2_409f40)
  ...
  ret %struct.Memory* %call2_409f49
}
...
define %struct.Memory* @routine_jge_.L_409f40(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i8* %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
...
define %struct.Memory* @routine_jge_.L_409eed(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i8* %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 2, i32 9
...
define %struct.Memory* @routine_addl__0x1c___eax(%struct.State* dereferenceable(3376), i64, %struct.Memory*) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %RAX = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 1, i32 0, i32 0
...
define %struct.Memory* @routine_jmpq_.L_409ebe(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
...
define %struct.Memory* @routine_jmpq_.L_409ef2(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
...
define %struct.Memory* @routine_jge_.L_409f28(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i8* %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 2, i32 9
...
define %struct.Memory* @routine_jmpq_.L_409e9f(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
