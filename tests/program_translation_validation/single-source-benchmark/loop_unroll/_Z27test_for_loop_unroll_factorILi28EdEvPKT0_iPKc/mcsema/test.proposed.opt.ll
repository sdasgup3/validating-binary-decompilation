...
entry:
  ...
  %call2_409ed3 = tail call %struct.Memory* @sub_400e10._Z11start_timerv(%struct.State* %0, i64 %58, %struct.Memory* %2)
...
block_.L_409edf:                                  ; preds = %block_.L_409f68, %entry
  %74 = phi i64 [ %341, %block_.L_409f68 ], [ %.pre, %entry ]
  ...
  br i1 %107, label %block_409eef, label %block_.L_409f80

block_409eef:                                     ; preds = %block_.L_409edf
...
block_.L_409efe:                                  ; preds = %block_409f0f, %block_409eef
  %118 = phi i64 [ %202, %block_409f0f ], [ %.pre9, %block_409eef ]
  ...
  br i1 %156, label %block_409f0f, label %block_.L_409f2d

block_409f0f:                                     ; preds = %block_.L_409efe
  %158 = add i64 %119, -40
  ...
  %call2_409f1a = tail call %struct.Memory* @sub_401750._ZN15loop_inner_bodyILi28EdE7do_workERdPKdi(%struct.State* nonnull %0, i64 %166, %struct.Memory* %call2_409ed3)
...
block_.L_409f2d:                                  ; preds = %block_.L_409efe
  %203 = add i64 %157, 5
  br label %block_.L_409f32

block_.L_409f32:                                  ; preds = %block_409f3e, %block_.L_409f2d
  %204 = phi i64 [ %119, %block_.L_409f2d ], [ %.pre10, %block_409f3e ]
  %storemerge = phi i64 [ %203, %block_.L_409f2d ], [ %299, %block_409f3e ]
  %205 = add i64 %204, -44
  ...
  br i1 %239, label %block_409f3e, label %block_.L_409f68
...
block_409f3e:                                     ; preds = %block_.L_409f32
  ...
  %call2_409f4b = tail call %struct.Memory* @sub_4014c0._Z18complete_hash_funcIdET_S0_(%struct.State* nonnull %0, i64 %253, %struct.Memory* %call2_409ed3)
...
block_.L_409f68:                                  ; preds = %block_.L_409f32
  ...
  %call2_409f6d = tail call %struct.Memory* @sub_4014f0._Z9check_sumIdEvT_(%struct.State* nonnull %0, i64 %305, %struct.Memory* %call2_409ed3)
...
block_.L_409f80:                                  ; preds = %block_.L_409edf
  ...
  %call2_409f80 = tail call %struct.Memory* @sub_400e30._Z5timerv(%struct.State* nonnull %0, i64 %342, %struct.Memory* %call2_409ed3)
  ...
  %call2_409f89 = tail call %struct.Memory* @sub_4007d0._Z13record_resultdPKc(%struct.State* nonnull %0, i64 %353, %struct.Memory* %call2_409f80)
