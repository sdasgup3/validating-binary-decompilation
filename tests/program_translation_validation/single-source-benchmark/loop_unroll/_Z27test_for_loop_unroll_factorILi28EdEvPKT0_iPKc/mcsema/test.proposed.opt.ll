...
block_.L_409e9f:                                  ; preds = %block_.L_409f28, %entry
  %79 = phi i64 [ %.pre, %entry ], [ %346, %block_.L_409f28 ]
...
block_.L_409ef2:                                  ; preds = %block_409efe, %block_.L_409eed
  %210 = phi i64 [ %209, %block_.L_409eed ], [ %305, %block_409efe ]
...
block_409efe:                                     ; preds = %block_.L_409ef2
  ...
  %call2_409f0b = tail call %struct.Memory* @sub_401480._Z18complete_hash_funcIdET_S0_(%struct.State* %0, i64 %260, %struct.Memory* %MEMORY.2)
...
block_.L_409f28:                                  ; preds = %block_.L_409ef2
  ...
  %call2_409f2d = tail call %struct.Memory* @sub_4014b0._Z9check_sumIdEvT_(%struct.State* %0, i64 %310, %struct.Memory* %MEMORY.2)
...
block_.L_409f40:                                  ; preds = %block_.L_409e9f
  ...
  %call2_409f40 = tail call %struct.Memory* @sub_400df0._Z5timerv(%struct.State* %0, i64 %347, %struct.Memory* %MEMORY.0)
  ...
  %call2_409f49 = tail call %struct.Memory* @sub_400790._Z13record_resultdPKc(%struct.State* %0, i64 %358, %struct.Memory* %call2_409f40)
