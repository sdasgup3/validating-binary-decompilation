...
entry:
  ...
  %call2_414613 = tail call %struct.Memory* @sub_400dd0._Z11start_timerv(%struct.State* %0, i64 %58, %struct.Memory* %2)
...
block_.L_41461f:                                  ; preds = %block_.L_4146a1, %entry
  %68 = phi i64 [ %.pre, %entry ], [ %364, %block_.L_4146a1 ]
  %MEMORY.0 = phi %struct.Memory* [ %call2_414613, %entry ], [ %call2_4146a4, %block_.L_4146a1 ]
  ...
  br i1 %101, label %block_41462f, label %block_.L_4146b7

block_41462f:                                     ; preds = %block_.L_41461f
  %103 = add i64 %69, -32
  %104 = add i64 %102, 7
...
block_.L_41463d:                                  ; preds = %block_41464e, %block_41462f
  %111 = phi i64 [ %.pre1, %block_41462f ], [ %195, %block_41464e ]
  %MEMORY.1 = phi %struct.Memory* [ %MEMORY.0, %block_41462f ], [ %call2_414659, %block_41464e ]
  ...
  br i1 %149, label %block_41464e, label %block_.L_41466c

block_41464e:                                     ; preds = %block_.L_41463d
  %151 = add i64 %112, -32
  ...
  %call2_414659 = tail call %struct.Memory* @sub_40c2d0._ZN15loop_inner_bodyILi28EiE7do_workERiPKii(%struct.State* %0, i64 %159, %struct.Memory* %MEMORY.1)
...
block_.L_41466c:                                  ; preds = %block_.L_41463d
  %196 = add i64 %150, 5
  store i64 %196, i64* %3, align 8
  br label %block_.L_414671

block_.L_414671:                                  ; preds = %block_41467d, %block_.L_41466c
  %197 = phi i64 [ %196, %block_.L_41466c ], [ %321, %block_41467d ]
  %198 = phi i64 [ %112, %block_.L_41466c ], [ %.pre2, %block_41467d ]
  %MEMORY.2 = phi %struct.Memory* [ %MEMORY.1, %block_.L_41466c ], [ %call2_414688, %block_41467d ]
  %199 = add i64 %198, -36
  %200 = add i64 %197, 3
  ...
  br i1 %233, label %block_41467d, label %block_.L_4146a1

block_41467d:                                     ; preds = %block_.L_414671
  %235 = add i64 %198, -8
  %236 = add i64 %234, 4
  ...
  %call2_414688 = tail call %struct.Memory* @sub_40c0d0._Z18complete_hash_funcIiET_S0_(%struct.State* %0, i64 %248, %struct.Memory* %MEMORY.2)
...
block_.L_4146a1:                                  ; preds = %block_.L_414671
  %322 = add i64 %198, -32
  %323 = add i64 %234, 3
  ...
  %call2_4146a4 = tail call %struct.Memory* @sub_40c100._Z9check_sumIiEvT_(%struct.State* %0, i64 %327, %struct.Memory* %MEMORY.2)
...
block_.L_4146b7:                                  ; preds = %block_.L_41461f
  %365 = add i64 %102, -80071
  %366 = add i64 %102, 5
  ...
  %call2_4146b7 = tail call %struct.Memory* @sub_400df0._Z5timerv(%struct.State* %0, i64 %365, %struct.Memory* %MEMORY.0)
  ...
  %call2_4146c0 = tail call %struct.Memory* @sub_400790._Z13record_resultdPKc(%struct.State* %0, i64 %376, %struct.Memory* %call2_4146b7)
  ...
  ret %struct.Memory* %call2_4146c0
}
...
define %struct.Memory* @routine_jge_.L_4146b7(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i8* %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
...
define %struct.Memory* @routine_jge_.L_41466c(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i8* %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 2, i32 9
...
define %struct.Memory* @routine_jmpq_.L_41463d(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
...
define %struct.Memory* @routine_jmpq_.L_414671(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
...
define %struct.Memory* @routine_jge_.L_4146a1(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i8* %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 2, i32 9
...
define %struct.Memory* @routine_jmpq_.L_41461f(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
