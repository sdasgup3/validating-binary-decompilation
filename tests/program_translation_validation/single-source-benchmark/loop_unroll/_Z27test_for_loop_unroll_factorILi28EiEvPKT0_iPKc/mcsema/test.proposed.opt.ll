...
block_.L_41461f:                                  ; preds = %block_.L_4146a1, %entry
  %68 = phi i64 [ %.pre, %entry ], [ %362, %block_.L_4146a1 ]
...
block_.L_414671:                                  ; preds = %block_41467d, %block_.L_41466c
  %197 = phi i64 [ %196, %block_.L_41466c ], [ %320, %block_41467d ]
...
block_.L_4146a1:                                  ; preds = %block_.L_414671
  ...
  %call2_4146a4 = tail call %struct.Memory* @sub_40c100._Z9check_sumIiEvT_(%struct.State* %0, i64 %326, %struct.Memory* %MEMORY.2)
...
block_.L_4146b7:                                  ; preds = %block_.L_41461f
  ...
  %call2_4146b7 = tail call %struct.Memory* @sub_400df0._Z5timerv(%struct.State* %0, i64 %363, %struct.Memory* %MEMORY.0)
  ...
  %call2_4146c0 = tail call %struct.Memory* @sub_400790._Z13record_resultdPKc(%struct.State* %0, i64 %374, %struct.Memory* %call2_4146b7)
