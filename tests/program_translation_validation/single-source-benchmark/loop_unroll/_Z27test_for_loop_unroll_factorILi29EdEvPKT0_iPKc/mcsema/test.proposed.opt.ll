...
entry:
  ...
  %call2_409d63 = tail call %struct.Memory* @sub_400dd0._Z11start_timerv(%struct.State* %0, i64 %58, %struct.Memory* %2)
...
block_.L_409d6f:                                  ; preds = %block_.L_409df8, %entry
  %79 = phi i64 [ %.pre, %entry ], [ %346, %block_.L_409df8 ]
  %MEMORY.0 = phi %struct.Memory* [ %call2_409d63, %entry ], [ %call2_409dfd, %block_.L_409df8 ]
  ...
  br i1 %112, label %block_409d7f, label %block_.L_409e10

block_409d7f:                                     ; preds = %block_.L_409d6f
...
block_.L_409d8e:                                  ; preds = %block_409d9f, %block_409d7f
  %124 = phi i64 [ %.pre1, %block_409d7f ], [ %208, %block_409d9f ]
  %MEMORY.1 = phi %struct.Memory* [ %MEMORY.0, %block_409d7f ], [ %call2_409daa, %block_409d9f ]
  ...
  br i1 %162, label %block_409d9f, label %block_.L_409dbd

block_409d9f:                                     ; preds = %block_.L_409d8e
  %164 = add i64 %125, -40
  ...
  %call2_409daa = tail call %struct.Memory* @sub_4016b0._ZN15loop_inner_bodyILi29EdE7do_workERdPKdi(%struct.State* %0, i64 %172, %struct.Memory* %MEMORY.1)
...
block_.L_409dbd:                                  ; preds = %block_.L_409d8e
  %209 = add i64 %163, 5
  store i64 %209, i64* %3, align 8
  br label %block_.L_409dc2

block_.L_409dc2:                                  ; preds = %block_409dce, %block_.L_409dbd
  %210 = phi i64 [ %209, %block_.L_409dbd ], [ %305, %block_409dce ]
  %211 = phi i64 [ %125, %block_.L_409dbd ], [ %.pre2, %block_409dce ]
  %MEMORY.2 = phi %struct.Memory* [ %MEMORY.1, %block_.L_409dbd ], [ %call2_409ddb, %block_409dce ]
  %212 = add i64 %211, -44
  %213 = add i64 %210, 3
  ...
  br i1 %246, label %block_409dce, label %block_.L_409df8

block_409dce:                                     ; preds = %block_.L_409dc2
  %248 = add i64 %211, -8
  %249 = add i64 %247, 4
  ...
  %call2_409ddb = tail call %struct.Memory* @sub_401480._Z18complete_hash_funcIdET_S0_(%struct.State* %0, i64 %260, %struct.Memory* %MEMORY.2)
...
block_.L_409df8:                                  ; preds = %block_.L_409dc2
  %306 = add i64 %211, -40
  %307 = add i64 %247, 5
  ...
  %call2_409dfd = tail call %struct.Memory* @sub_4014b0._Z9check_sumIdEvT_(%struct.State* %0, i64 %310, %struct.Memory* %MEMORY.2)
...
block_.L_409e10:                                  ; preds = %block_.L_409d6f
  %347 = add i64 %113, -36896
  %348 = add i64 %113, 5
  ...
  %call2_409e10 = tail call %struct.Memory* @sub_400df0._Z5timerv(%struct.State* %0, i64 %347, %struct.Memory* %MEMORY.0)
  ...
  %call2_409e19 = tail call %struct.Memory* @sub_400790._Z13record_resultdPKc(%struct.State* %0, i64 %358, %struct.Memory* %call2_409e10)
  ...
  ret %struct.Memory* %call2_409e19
}
...
define %struct.Memory* @routine_jge_.L_409e10(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i8* %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
...
define %struct.Memory* @routine_jge_.L_409dbd(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i8* %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 2, i32 9
...
define %struct.Memory* @routine_jmpq_.L_409d8e(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
...
define %struct.Memory* @routine_jmpq_.L_409dc2(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
...
define %struct.Memory* @routine_jge_.L_409df8(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i8* %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 2, i32 9
...
define %struct.Memory* @routine_jmpq_.L_409d6f(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
