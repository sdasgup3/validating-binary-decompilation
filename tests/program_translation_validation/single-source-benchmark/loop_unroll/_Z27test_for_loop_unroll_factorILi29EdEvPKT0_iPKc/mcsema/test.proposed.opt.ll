...
block_.L_409d6f:                                  ; preds = %block_.L_409df8, %entry
  %79 = phi i64 [ %.pre, %entry ], [ %350, %block_.L_409df8 ]
...
block_.L_409dc2:                                  ; preds = %block_409dce, %block_.L_409dbd
  %210 = phi i64 [ %209, %block_.L_409dbd ], [ %307, %block_409dce ]
...
block_409dce:                                     ; preds = %block_.L_409dc2
  ...
  %call2_409ddb = tail call %struct.Memory* @sub_401480._Z18complete_hash_funcIdET_S0_(%struct.State* %0, i64 %261, %struct.Memory* %MEMORY.2)
...
block_.L_409df8:                                  ; preds = %block_.L_409dc2
  ...
  %call2_409dfd = tail call %struct.Memory* @sub_4014b0._Z9check_sumIdEvT_(%struct.State* %0, i64 %313, %struct.Memory* %MEMORY.2)
...
block_.L_409e10:                                  ; preds = %block_.L_409d6f
  ...
  %call2_409e10 = tail call %struct.Memory* @sub_400df0._Z5timerv(%struct.State* %0, i64 %351, %struct.Memory* %MEMORY.0)
  ...
  %call2_409e19 = tail call %struct.Memory* @sub_400790._Z13record_resultdPKc(%struct.State* %0, i64 %362, %struct.Memory* %call2_409e10)
