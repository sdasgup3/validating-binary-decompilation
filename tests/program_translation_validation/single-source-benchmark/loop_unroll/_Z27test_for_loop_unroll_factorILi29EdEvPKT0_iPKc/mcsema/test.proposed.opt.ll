...
define %struct.Memory* @_Z27test_for_loop_unroll_factorILi29EdEvPKT0_iPKc(%struct.State* noalias, i64, %struct.Memory* noalias) local_unnamed_addr #1 {
entry:
  ...
  %call2_409d93 = tail call %struct.Memory* @sub_400e00._Z11start_timerv(%struct.State* %0, i64 %58, %struct.Memory* %2)
...
block_.L_409d9f:                                  ; preds = %block_.L_409e28, %entry
  %74 = phi i64 [ %.pre, %entry ], [ %341, %block_.L_409e28 ]
  %MEMORY.0 = phi %struct.Memory* [ %call2_409d93, %entry ], [ %call2_409e2d, %block_.L_409e28 ]
  ...
  br i1 %107, label %block_409daf, label %block_.L_409e40

block_409daf:                                     ; preds = %block_.L_409d9f
...
block_.L_409dbe:                                  ; preds = %block_409dcf, %block_409daf
  %118 = phi i64 [ %.pre9, %block_409daf ], [ %202, %block_409dcf ]
  %MEMORY.1 = phi %struct.Memory* [ %MEMORY.0, %block_409daf ], [ %call2_409dda, %block_409dcf ]
  ...
  br i1 %156, label %block_409dcf, label %block_.L_409ded

block_409dcf:                                     ; preds = %block_.L_409dbe
  %158 = add i64 %119, -40
  ...
  %call2_409dda = tail call %struct.Memory* @sub_4016e0._ZN15loop_inner_bodyILi29EdE7do_workERdPKdi(%struct.State* nonnull %0, i64 %166, %struct.Memory* %MEMORY.1)
...
block_.L_409ded:                                  ; preds = %block_.L_409dbe
  %203 = add i64 %157, 5
  br label %block_.L_409df2

block_.L_409df2:                                  ; preds = %block_409dfe, %block_.L_409ded
  %204 = phi i64 [ %119, %block_.L_409ded ], [ %.pre10, %block_409dfe ]
  %storemerge = phi i64 [ %203, %block_.L_409ded ], [ %299, %block_409dfe ]
  %MEMORY.2 = phi %struct.Memory* [ %MEMORY.1, %block_.L_409ded ], [ %call2_409e0b, %block_409dfe ]
  %205 = add i64 %204, -44
  ...
  br i1 %239, label %block_409dfe, label %block_.L_409e28
...
block_409dfe:                                     ; preds = %block_.L_409df2
  ...
  %call2_409e0b = tail call %struct.Memory* @sub_4014b0._Z18complete_hash_funcIdET_S0_(%struct.State* nonnull %0, i64 %253, %struct.Memory* %MEMORY.2)
...
block_.L_409e28:                                  ; preds = %block_.L_409df2
  %301 = add i64 %204, -40
  %302 = add i64 %240, 5
  ...
  %call2_409e2d = tail call %struct.Memory* @sub_4014e0._Z9check_sumIdEvT_(%struct.State* nonnull %0, i64 %305, %struct.Memory* %MEMORY.2)
...
block_.L_409e40:                                  ; preds = %block_.L_409d9f
  %342 = add i64 %108, -36896
  %343 = add i64 %108, 5
  ...
  %call2_409e40 = tail call %struct.Memory* @sub_400e20._Z5timerv(%struct.State* nonnull %0, i64 %342, %struct.Memory* %MEMORY.0)
  ...
  %call2_409e49 = tail call %struct.Memory* @sub_4007c0._Z13record_resultdPKc(%struct.State* nonnull %0, i64 %353, %struct.Memory* %call2_409e40)
  ...
  ret %struct.Memory* %call2_409e49
}
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_jge_.L_409e40(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i8* nocapture %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_jge_.L_409ded(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i8* nocapture %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 2, i32 9
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_jmpq_.L_409dbe(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_jmpq_.L_409df2(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_jge_.L_409e28(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i8* nocapture %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 2, i32 9
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_jmpq_.L_409d9f(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
