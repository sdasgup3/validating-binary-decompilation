...
define %struct.Memory* @_Z27test_for_loop_unroll_factorILi29EiEvPKT0_iPKc(%struct.State* noalias, i64, %struct.Memory* noalias) local_unnamed_addr #1 {
entry:
  ...
  %call2_414523 = tail call %struct.Memory* @sub_400e00._Z11start_timerv(%struct.State* %0, i64 %58, %struct.Memory* %2)
...
block_.L_41452f:                                  ; preds = %block_.L_4145b1, %entry
  %68 = phi i64 [ %.pre, %entry ], [ %362, %block_.L_4145b1 ]
  %MEMORY.0 = phi %struct.Memory* [ %call2_414523, %entry ], [ %call2_4145b4, %block_.L_4145b1 ]
  ...
  br i1 %101, label %block_41453f, label %block_.L_4145c7

block_41453f:                                     ; preds = %block_.L_41452f
  %103 = add i64 %69, -32
  %104 = add i64 %102, 7
...
block_.L_41454d:                                  ; preds = %block_41455e, %block_41453f
  %111 = phi i64 [ %.pre9, %block_41453f ], [ %195, %block_41455e ]
  %MEMORY.1 = phi %struct.Memory* [ %MEMORY.0, %block_41453f ], [ %call2_414569, %block_41455e ]
  ...
  br i1 %149, label %block_41455e, label %block_.L_41457c

block_41455e:                                     ; preds = %block_.L_41454d
  %151 = add i64 %112, -32
  ...
  %call2_414569 = tail call %struct.Memory* @sub_40c2a0._ZN15loop_inner_bodyILi29EiE7do_workERiPKii(%struct.State* nonnull %0, i64 %159, %struct.Memory* %MEMORY.1)
...
block_.L_41457c:                                  ; preds = %block_.L_41454d
  %196 = add i64 %150, 5
  br label %block_.L_414581

block_.L_414581:                                  ; preds = %block_41458d, %block_.L_41457c
  %197 = phi i64 [ %112, %block_.L_41457c ], [ %.pre10, %block_41458d ]
  %storemerge = phi i64 [ %196, %block_.L_41457c ], [ %319, %block_41458d ]
  %MEMORY.2 = phi %struct.Memory* [ %MEMORY.1, %block_.L_41457c ], [ %call2_414598, %block_41458d ]
  %198 = add i64 %197, -36
  ...
  br i1 %232, label %block_41458d, label %block_.L_4145b1

block_41458d:                                     ; preds = %block_.L_414581
  %234 = add i64 %197, -8
  %235 = add i64 %233, 4
  ...
  %call2_414598 = tail call %struct.Memory* @sub_40c100._Z18complete_hash_funcIiET_S0_(%struct.State* nonnull %0, i64 %247, %struct.Memory* %MEMORY.2)
...
block_.L_4145b1:                                  ; preds = %block_.L_414581
  %321 = add i64 %197, -32
  %322 = add i64 %233, 3
  ...
  %call2_4145b4 = tail call %struct.Memory* @sub_40c130._Z9check_sumIiEvT_(%struct.State* nonnull %0, i64 %326, %struct.Memory* %MEMORY.2)
...
block_.L_4145c7:                                  ; preds = %block_.L_41452f
  %363 = add i64 %102, -79783
  %364 = add i64 %102, 5
  ...
  %call2_4145c7 = tail call %struct.Memory* @sub_400e20._Z5timerv(%struct.State* nonnull %0, i64 %363, %struct.Memory* %MEMORY.0)
  ...
  %call2_4145d0 = tail call %struct.Memory* @sub_4007c0._Z13record_resultdPKc(%struct.State* nonnull %0, i64 %374, %struct.Memory* %call2_4145c7)
  ...
  ret %struct.Memory* %call2_4145d0
}
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_jge_.L_4145c7(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i8* nocapture %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_jge_.L_41457c(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i8* nocapture %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 2, i32 9
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_jmpq_.L_41454d(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_jmpq_.L_414581(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_jge_.L_4145b1(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i8* nocapture %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 2, i32 9
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_jmpq_.L_41452f(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
