...
block_.L_4144ff:                                  ; preds = %block_.L_414581, %entry
  %68 = phi i64 [ %.pre, %entry ], [ %364, %block_.L_414581 ]
...
block_.L_414551:                                  ; preds = %block_41455d, %block_.L_41454c
  %197 = phi i64 [ %196, %block_.L_41454c ], [ %321, %block_41455d ]
...
block_.L_414581:                                  ; preds = %block_.L_414551
  ...
  %call2_414584 = tail call %struct.Memory* @sub_40c100._Z9check_sumIiEvT_(%struct.State* %0, i64 %327, %struct.Memory* %MEMORY.2)
...
block_.L_414597:                                  ; preds = %block_.L_4144ff
  ...
  %call2_414597 = tail call %struct.Memory* @sub_400df0._Z5timerv(%struct.State* %0, i64 %365, %struct.Memory* %MEMORY.0)
  ...
  %call2_4145a0 = tail call %struct.Memory* @sub_400790._Z13record_resultdPKc(%struct.State* %0, i64 %376, %struct.Memory* %call2_414597)
