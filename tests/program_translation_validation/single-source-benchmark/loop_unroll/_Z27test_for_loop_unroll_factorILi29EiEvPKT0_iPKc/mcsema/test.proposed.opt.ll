...
define %struct.Memory* @_Z27test_for_loop_unroll_factorILi29EiEvPKT0_iPKc(%struct.State* noalias, i64, %struct.Memory* noalias readnone) local_unnamed_addr #1 {
entry:
...
block_.L_41452f:                                  ; preds = %block_.L_4145b1, %entry
  %68 = phi i64 [ %362, %block_.L_4145b1 ], [ %.pre, %entry ]
...
block_.L_41454d:                                  ; preds = %block_41455e, %block_41453f
  %111 = phi i64 [ %195, %block_41455e ], [ %.pre9, %block_41453f ]
...
block_41455e:                                     ; preds = %block_.L_41454d
  ...
  %call2_414569 = tail call %struct.Memory* @sub_40c2a0._ZN15loop_inner_bodyILi29EiE7do_workERiPKii(%struct.State* nonnull %0, i64 %159, %struct.Memory* %call2_414523)
...
block_41458d:                                     ; preds = %block_.L_414581
  ...
  %call2_414598 = tail call %struct.Memory* @sub_40c100._Z18complete_hash_funcIiET_S0_(%struct.State* nonnull %0, i64 %247, %struct.Memory* %call2_414523)
...
block_.L_4145b1:                                  ; preds = %block_.L_414581
  ...
  %call2_4145b4 = tail call %struct.Memory* @sub_40c130._Z9check_sumIiEvT_(%struct.State* nonnull %0, i64 %326, %struct.Memory* %call2_414523)
...
block_.L_4145c7:                                  ; preds = %block_.L_41452f
  ...
  %call2_4145c7 = tail call %struct.Memory* @sub_400e20._Z5timerv(%struct.State* nonnull %0, i64 %363, %struct.Memory* %call2_414523)
