...
entry:
  ...
  %call2_414533 = tail call %struct.Memory* @sub_400e10._Z11start_timerv(%struct.State* %0, i64 %58, %struct.Memory* %2)
...
block_.L_41453f:                                  ; preds = %block_.L_4145c1, %entry
  %68 = phi i64 [ %362, %block_.L_4145c1 ], [ %.pre, %entry ]
  ...
  br i1 %101, label %block_41454f, label %block_.L_4145d7

block_41454f:                                     ; preds = %block_.L_41453f
  %103 = add i64 %69, -32
  %104 = add i64 %102, 7
...
block_.L_41455d:                                  ; preds = %block_41456e, %block_41454f
  %111 = phi i64 [ %195, %block_41456e ], [ %.pre9, %block_41454f ]
  ...
  br i1 %149, label %block_41456e, label %block_.L_41458c

block_41456e:                                     ; preds = %block_.L_41455d
  %151 = add i64 %112, -32
  ...
  %call2_414579 = tail call %struct.Memory* @sub_40c2b0._ZN15loop_inner_bodyILi29EiE7do_workERiPKii(%struct.State* nonnull %0, i64 %159, %struct.Memory* %call2_414533)
...
block_.L_41458c:                                  ; preds = %block_.L_41455d
  %196 = add i64 %150, 5
  br label %block_.L_414591

block_.L_414591:                                  ; preds = %block_41459d, %block_.L_41458c
  %197 = phi i64 [ %112, %block_.L_41458c ], [ %.pre10, %block_41459d ]
  %storemerge = phi i64 [ %196, %block_.L_41458c ], [ %319, %block_41459d ]
  %198 = add i64 %197, -36
  ...
  br i1 %232, label %block_41459d, label %block_.L_4145c1
...
block_41459d:                                     ; preds = %block_.L_414591
  ...
  %call2_4145a8 = tail call %struct.Memory* @sub_40c110._Z18complete_hash_funcIiET_S0_(%struct.State* nonnull %0, i64 %247, %struct.Memory* %call2_414533)
...
block_.L_4145c1:                                  ; preds = %block_.L_414591
  ...
  %call2_4145c4 = tail call %struct.Memory* @sub_40c140._Z9check_sumIiEvT_(%struct.State* nonnull %0, i64 %326, %struct.Memory* %call2_414533)
...
block_.L_4145d7:                                  ; preds = %block_.L_41453f
  ...
  %call2_4145d7 = tail call %struct.Memory* @sub_400e30._Z5timerv(%struct.State* nonnull %0, i64 %363, %struct.Memory* %call2_414533)
  ...
  %call2_4145e0 = tail call %struct.Memory* @sub_4007d0._Z13record_resultdPKc(%struct.State* nonnull %0, i64 %374, %struct.Memory* %call2_4145d7)
