...
block_.L_40bd9f:                                  ; preds = %block_.L_40be28, %entry
  %74 = phi i64 [ %340, %block_.L_40be28 ], [ %.pre, %entry ]
...
block_.L_40bdbe:                                  ; preds = %block_40bdcf, %block_40bdaf
  %118 = phi i64 [ %201, %block_40bdcf ], [ %.pre9, %block_40bdaf ]
...
block_40bdcf:                                     ; preds = %block_.L_40bdbe
  ...
  %call2_40bdda = tail call %struct.Memory* @sub_402100._ZN15loop_inner_bodyILi2EdE7do_workERdPKdi(%struct.State* nonnull %0, i64 %166, %struct.Memory* %call2_40bd93)
...
block_40bdfe:                                     ; preds = %block_.L_40bdf2
  ...
  %call2_40be0b = tail call %struct.Memory* @sub_4014b0._Z18complete_hash_funcIdET_S0_(%struct.State* nonnull %0, i64 %252, %struct.Memory* %call2_40bd93)
...
block_.L_40be28:                                  ; preds = %block_.L_40bdf2
  ...
  %call2_40be2d = tail call %struct.Memory* @sub_4014e0._Z9check_sumIdEvT_(%struct.State* nonnull %0, i64 %304, %struct.Memory* %call2_40bd93)
...
block_.L_40be40:                                  ; preds = %block_.L_40bd9f
  ...
  %call2_40be40 = tail call %struct.Memory* @sub_400e20._Z5timerv(%struct.State* nonnull %0, i64 %341, %struct.Memory* %call2_40bd93)
