...
entry:
  ...
  %call2_40bd63 = tail call %struct.Memory* @sub_400dd0._Z11start_timerv(%struct.State* %0, i64 %58, %struct.Memory* %2)
...
block_.L_40bd6f:                                  ; preds = %block_.L_40bdf8, %entry
  %79 = phi i64 [ %.pre, %entry ], [ %349, %block_.L_40bdf8 ]
  %MEMORY.0 = phi %struct.Memory* [ %call2_40bd63, %entry ], [ %call2_40bdfd, %block_.L_40bdf8 ]
  ...
  br i1 %112, label %block_40bd7f, label %block_.L_40be10
...
block_.L_40bd8e:                                  ; preds = %block_40bd9f, %block_40bd7f
  %124 = phi i64 [ %.pre1, %block_40bd7f ], [ %207, %block_40bd9f ]
  %MEMORY.1 = phi %struct.Memory* [ %MEMORY.0, %block_40bd7f ], [ %call2_40bdaa, %block_40bd9f ]
  ...
  br i1 %162, label %block_40bd9f, label %block_.L_40bdbd
...
block_40bd9f:                                     ; preds = %block_.L_40bd8e
  ...
  %call2_40bdaa = tail call %struct.Memory* @sub_4020d0._ZN15loop_inner_bodyILi2EdE7do_workERdPKdi(%struct.State* %0, i64 %172, %struct.Memory* %MEMORY.1)
...
block_.L_40bdc2:                                  ; preds = %block_40bdce, %block_.L_40bdbd
  %209 = phi i64 [ %208, %block_.L_40bdbd ], [ %306, %block_40bdce ]
  %210 = phi i64 [ %125, %block_.L_40bdbd ], [ %.pre2, %block_40bdce ]
  %MEMORY.2 = phi %struct.Memory* [ %MEMORY.1, %block_.L_40bdbd ], [ %call2_40bddb, %block_40bdce ]
  %211 = add i64 %210, -44
  %212 = add i64 %209, 3
  ...
  br i1 %245, label %block_40bdce, label %block_.L_40bdf8
...
block_40bdce:                                     ; preds = %block_.L_40bdc2
  ...
  %call2_40bddb = tail call %struct.Memory* @sub_401480._Z18complete_hash_funcIdET_S0_(%struct.State* %0, i64 %260, %struct.Memory* %MEMORY.2)
...
block_.L_40bdf8:                                  ; preds = %block_.L_40bdc2
  ...
  %call2_40bdfd = tail call %struct.Memory* @sub_4014b0._Z9check_sumIdEvT_(%struct.State* %0, i64 %312, %struct.Memory* %MEMORY.2)
...
block_.L_40be10:                                  ; preds = %block_.L_40bd6f
  ...
  %call2_40be10 = tail call %struct.Memory* @sub_400df0._Z5timerv(%struct.State* %0, i64 %350, %struct.Memory* %MEMORY.0)
  ...
  %call2_40be19 = tail call %struct.Memory* @sub_400790._Z13record_resultdPKc(%struct.State* %0, i64 %361, %struct.Memory* %call2_40be10)
  ...
  ret %struct.Memory* %call2_40be19
}
...
define %struct.Memory* @routine_jge_.L_40be10(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i8* %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
...
define %struct.Memory* @routine_jge_.L_40bdbd(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i8* %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 2, i32 9
...
define %struct.Memory* @routine_jmpq_.L_40bd8e(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
...
define %struct.Memory* @routine_jmpq_.L_40bdc2(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
...
define %struct.Memory* @routine_jge_.L_40bdf8(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i8* %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 2, i32 9
...
define %struct.Memory* @routine_jmpq_.L_40bd6f(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
