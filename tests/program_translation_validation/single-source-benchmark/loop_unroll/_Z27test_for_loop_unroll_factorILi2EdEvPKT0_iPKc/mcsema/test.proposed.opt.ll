...
block_.L_40bd6f:                                  ; preds = %block_.L_40bdf8, %entry
  %79 = phi i64 [ %.pre, %entry ], [ %345, %block_.L_40bdf8 ]
...
block_.L_40bdc2:                                  ; preds = %block_40bdce, %block_.L_40bdbd
  %209 = phi i64 [ %208, %block_.L_40bdbd ], [ %304, %block_40bdce ]
...
block_40bdce:                                     ; preds = %block_.L_40bdc2
  ...
  %call2_40bddb = tail call %struct.Memory* @sub_401480._Z18complete_hash_funcIdET_S0_(%struct.State* %0, i64 %259, %struct.Memory* %MEMORY.2)
...
block_.L_40bdf8:                                  ; preds = %block_.L_40bdc2
  ...
  %call2_40bdfd = tail call %struct.Memory* @sub_4014b0._Z9check_sumIdEvT_(%struct.State* %0, i64 %309, %struct.Memory* %MEMORY.2)
...
block_.L_40be10:                                  ; preds = %block_.L_40bd6f
  ...
  %call2_40be10 = tail call %struct.Memory* @sub_400df0._Z5timerv(%struct.State* %0, i64 %346, %struct.Memory* %MEMORY.0)
  ...
  %call2_40be19 = tail call %struct.Memory* @sub_400790._Z13record_resultdPKc(%struct.State* %0, i64 %357, %struct.Memory* %call2_40be10)
