...
define %struct.Memory* @_Z27test_for_loop_unroll_factorILi2EiEvPKT0_iPKc(%struct.State* noalias, i64, %struct.Memory* noalias readnone) local_unnamed_addr #1 {
entry:
  ...
  %call2_416383 = tail call %struct.Memory* @sub_400e10._Z11start_timerv(%struct.State* %0, i64 %58, %struct.Memory* %2)
...
block_.L_41638f:                                  ; preds = %block_.L_416411, %entry
  %68 = phi i64 [ %361, %block_.L_416411 ], [ %.pre, %entry ]
  ...
  br i1 %101, label %block_41639f, label %block_.L_416427

block_41639f:                                     ; preds = %block_.L_41638f
  %103 = add i64 %69, -32
  %104 = add i64 %102, 7
...
block_.L_4163ad:                                  ; preds = %block_4163be, %block_41639f
  %111 = phi i64 [ %194, %block_4163be ], [ %.pre9, %block_41639f ]
  ...
  br i1 %149, label %block_4163be, label %block_.L_4163dc

block_4163be:                                     ; preds = %block_.L_4163ad
  %151 = add i64 %112, -32
  ...
  %call2_4163c9 = tail call %struct.Memory* @sub_40ccd0._ZN15loop_inner_bodyILi2EiE7do_workERiPKii(%struct.State* nonnull %0, i64 %159, %struct.Memory* %call2_416383)
...
block_.L_4163dc:                                  ; preds = %block_.L_4163ad
  %195 = add i64 %150, 5
  br label %block_.L_4163e1

block_.L_4163e1:                                  ; preds = %block_4163ed, %block_.L_4163dc
  %196 = phi i64 [ %112, %block_.L_4163dc ], [ %.pre10, %block_4163ed ]
  %storemerge = phi i64 [ %195, %block_.L_4163dc ], [ %318, %block_4163ed ]
  %197 = add i64 %196, -36
  ...
  br i1 %231, label %block_4163ed, label %block_.L_416411
...
block_4163ed:                                     ; preds = %block_.L_4163e1
  ...
  %call2_4163f8 = tail call %struct.Memory* @sub_40c110._Z18complete_hash_funcIiET_S0_(%struct.State* nonnull %0, i64 %246, %struct.Memory* %call2_416383)
...
block_.L_416411:                                  ; preds = %block_.L_4163e1
  ...
  %call2_416414 = tail call %struct.Memory* @sub_40c140._Z9check_sumIiEvT_(%struct.State* nonnull %0, i64 %325, %struct.Memory* %call2_416383)
...
block_.L_416427:                                  ; preds = %block_.L_41638f
  ...
  %call2_416427 = tail call %struct.Memory* @sub_400e30._Z5timerv(%struct.State* nonnull %0, i64 %362, %struct.Memory* %call2_416383)
  ...
  %call2_416430 = tail call %struct.Memory* @sub_4007d0._Z13record_resultdPKc(%struct.State* nonnull %0, i64 %373, %struct.Memory* %call2_416427)
