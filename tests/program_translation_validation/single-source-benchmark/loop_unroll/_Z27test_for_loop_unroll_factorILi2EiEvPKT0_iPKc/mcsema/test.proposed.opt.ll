...
define %struct.Memory* @_Z27test_for_loop_unroll_factorILi2EiEvPKT0_iPKc(%struct.State* noalias, i64, %struct.Memory* noalias) local_unnamed_addr #1 {
entry:
  ...
  %call2_416373 = tail call %struct.Memory* @sub_400e00._Z11start_timerv(%struct.State* %0, i64 %58, %struct.Memory* %2)
...
block_.L_41637f:                                  ; preds = %block_.L_416401, %entry
  %68 = phi i64 [ %.pre, %entry ], [ %361, %block_.L_416401 ]
  %MEMORY.0 = phi %struct.Memory* [ %call2_416373, %entry ], [ %call2_416404, %block_.L_416401 ]
  ...
  br i1 %101, label %block_41638f, label %block_.L_416417

block_41638f:                                     ; preds = %block_.L_41637f
  %103 = add i64 %69, -32
  %104 = add i64 %102, 7
...
block_.L_41639d:                                  ; preds = %block_4163ae, %block_41638f
  %111 = phi i64 [ %.pre9, %block_41638f ], [ %194, %block_4163ae ]
  %MEMORY.1 = phi %struct.Memory* [ %MEMORY.0, %block_41638f ], [ %call2_4163b9, %block_4163ae ]
  ...
  br i1 %149, label %block_4163ae, label %block_.L_4163cc

block_4163ae:                                     ; preds = %block_.L_41639d
  %151 = add i64 %112, -32
  ...
  %call2_4163b9 = tail call %struct.Memory* @sub_40ccc0._ZN15loop_inner_bodyILi2EiE7do_workERiPKii(%struct.State* nonnull %0, i64 %159, %struct.Memory* %MEMORY.1)
...
block_.L_4163cc:                                  ; preds = %block_.L_41639d
  %195 = add i64 %150, 5
  br label %block_.L_4163d1

block_.L_4163d1:                                  ; preds = %block_4163dd, %block_.L_4163cc
  %196 = phi i64 [ %112, %block_.L_4163cc ], [ %.pre10, %block_4163dd ]
  %storemerge = phi i64 [ %195, %block_.L_4163cc ], [ %318, %block_4163dd ]
  %MEMORY.2 = phi %struct.Memory* [ %MEMORY.1, %block_.L_4163cc ], [ %call2_4163e8, %block_4163dd ]
  %197 = add i64 %196, -36
  ...
  br i1 %231, label %block_4163dd, label %block_.L_416401

block_4163dd:                                     ; preds = %block_.L_4163d1
  %233 = add i64 %196, -8
  %234 = add i64 %232, 4
  ...
  %call2_4163e8 = tail call %struct.Memory* @sub_40c100._Z18complete_hash_funcIiET_S0_(%struct.State* nonnull %0, i64 %246, %struct.Memory* %MEMORY.2)
...
block_.L_416401:                                  ; preds = %block_.L_4163d1
  %320 = add i64 %196, -32
  %321 = add i64 %232, 3
  ...
  %call2_416404 = tail call %struct.Memory* @sub_40c130._Z9check_sumIiEvT_(%struct.State* nonnull %0, i64 %325, %struct.Memory* %MEMORY.2)
...
block_.L_416417:                                  ; preds = %block_.L_41637f
  %362 = add i64 %102, -87543
  %363 = add i64 %102, 5
  ...
  %call2_416417 = tail call %struct.Memory* @sub_400e20._Z5timerv(%struct.State* nonnull %0, i64 %362, %struct.Memory* %MEMORY.0)
  ...
  %call2_416420 = tail call %struct.Memory* @sub_4007c0._Z13record_resultdPKc(%struct.State* nonnull %0, i64 %373, %struct.Memory* %call2_416417)
  ...
  ret %struct.Memory* %call2_416420
}
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_jge_.L_416417(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i8* nocapture %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_jge_.L_4163cc(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i8* nocapture %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 2, i32 9
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_jmpq_.L_41639d(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_jmpq_.L_4163d1(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_jge_.L_416401(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i8* nocapture %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 2, i32 9
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_jmpq_.L_41637f(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
