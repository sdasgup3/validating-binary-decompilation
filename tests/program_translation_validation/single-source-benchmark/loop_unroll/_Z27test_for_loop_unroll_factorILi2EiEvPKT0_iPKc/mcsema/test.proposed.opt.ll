...
entry:
  ...
  %call2_416343 = tail call %struct.Memory* @sub_400dd0._Z11start_timerv(%struct.State* %0, i64 %58, %struct.Memory* %2)
...
block_.L_41634f:                                  ; preds = %block_.L_4163d1, %entry
  %68 = phi i64 [ %.pre, %entry ], [ %361, %block_.L_4163d1 ]
  %MEMORY.0 = phi %struct.Memory* [ %call2_416343, %entry ], [ %call2_4163d4, %block_.L_4163d1 ]
  ...
  br i1 %101, label %block_41635f, label %block_.L_4163e7

block_41635f:                                     ; preds = %block_.L_41634f
  %103 = add i64 %69, -32
  %104 = add i64 %102, 7
...
block_.L_41636d:                                  ; preds = %block_41637e, %block_41635f
  %111 = phi i64 [ %.pre1, %block_41635f ], [ %194, %block_41637e ]
  %MEMORY.1 = phi %struct.Memory* [ %MEMORY.0, %block_41635f ], [ %call2_416389, %block_41637e ]
  ...
  br i1 %149, label %block_41637e, label %block_.L_41639c

block_41637e:                                     ; preds = %block_.L_41636d
  %151 = add i64 %112, -32
  ...
  %call2_416389 = tail call %struct.Memory* @sub_40cc90._ZN15loop_inner_bodyILi2EiE7do_workERiPKii(%struct.State* %0, i64 %159, %struct.Memory* %MEMORY.1)
...
block_.L_41639c:                                  ; preds = %block_.L_41636d
  %195 = add i64 %150, 5
  store i64 %195, i64* %3, align 8
  br label %block_.L_4163a1

block_.L_4163a1:                                  ; preds = %block_4163ad, %block_.L_41639c
  %196 = phi i64 [ %195, %block_.L_41639c ], [ %319, %block_4163ad ]
  %197 = phi i64 [ %112, %block_.L_41639c ], [ %.pre2, %block_4163ad ]
  %MEMORY.2 = phi %struct.Memory* [ %MEMORY.1, %block_.L_41639c ], [ %call2_4163b8, %block_4163ad ]
  %198 = add i64 %197, -36
  %199 = add i64 %196, 3
  ...
  br i1 %232, label %block_4163ad, label %block_.L_4163d1

block_4163ad:                                     ; preds = %block_.L_4163a1
  %234 = add i64 %197, -8
  %235 = add i64 %233, 4
  ...
  %call2_4163b8 = tail call %struct.Memory* @sub_40c0d0._Z18complete_hash_funcIiET_S0_(%struct.State* %0, i64 %247, %struct.Memory* %MEMORY.2)
...
block_.L_4163d1:                                  ; preds = %block_.L_4163a1
  %320 = add i64 %197, -32
  %321 = add i64 %233, 3
  ...
  %call2_4163d4 = tail call %struct.Memory* @sub_40c100._Z9check_sumIiEvT_(%struct.State* %0, i64 %325, %struct.Memory* %MEMORY.2)
...
block_.L_4163e7:                                  ; preds = %block_.L_41634f
  ...
  %call2_4163e7 = tail call %struct.Memory* @sub_400df0._Z5timerv(%struct.State* %0, i64 %362, %struct.Memory* %MEMORY.0)
  ...
  %call2_4163f0 = tail call %struct.Memory* @sub_400790._Z13record_resultdPKc(%struct.State* %0, i64 %373, %struct.Memory* %call2_4163e7)
  ...
  ret %struct.Memory* %call2_4163f0
}
...
define %struct.Memory* @routine_jge_.L_4163e7(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i8* %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
...
define %struct.Memory* @routine_jge_.L_41639c(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i8* %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 2, i32 9
...
define %struct.Memory* @routine_jmpq_.L_41636d(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
...
define %struct.Memory* @routine_jmpq_.L_4163a1(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
...
define %struct.Memory* @routine_jge_.L_4163d1(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i8* %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 2, i32 9
...
define %struct.Memory* @routine_jmpq_.L_41634f(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
