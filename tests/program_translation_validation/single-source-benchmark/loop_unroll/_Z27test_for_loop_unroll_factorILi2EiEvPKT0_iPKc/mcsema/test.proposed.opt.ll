...
block_.L_41634f:                                  ; preds = %block_.L_4163d1, %entry
  %68 = phi i64 [ %.pre, %entry ], [ %363, %block_.L_4163d1 ]
...
block_.L_4163a1:                                  ; preds = %block_4163ad, %block_.L_41639c
  %196 = phi i64 [ %195, %block_.L_41639c ], [ %320, %block_4163ad ]
...
block_.L_4163d1:                                  ; preds = %block_.L_4163a1
  ...
  %call2_4163d4 = tail call %struct.Memory* @sub_40c100._Z9check_sumIiEvT_(%struct.State* %0, i64 %326, %struct.Memory* %MEMORY.2)
...
block_.L_4163e7:                                  ; preds = %block_.L_41634f
  ...
  %call2_4163e7 = tail call %struct.Memory* @sub_400df0._Z5timerv(%struct.State* %0, i64 %364, %struct.Memory* %MEMORY.0)
  ...
  %call2_4163f0 = tail call %struct.Memory* @sub_400790._Z13record_resultdPKc(%struct.State* %0, i64 %375, %struct.Memory* %call2_4163e7)
