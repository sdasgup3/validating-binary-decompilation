...
block_.L_41637f:                                  ; preds = %block_.L_416401, %entry
  %68 = phi i64 [ %361, %block_.L_416401 ], [ %.pre, %entry ]
...
block_.L_41639d:                                  ; preds = %block_4163ae, %block_41638f
  %111 = phi i64 [ %194, %block_4163ae ], [ %.pre9, %block_41638f ]
...
block_4163ae:                                     ; preds = %block_.L_41639d
  ...
  %call2_4163b9 = tail call %struct.Memory* @sub_40ccc0._ZN15loop_inner_bodyILi2EiE7do_workERiPKii(%struct.State* nonnull %0, i64 %159, %struct.Memory* %call2_416373)
...
block_4163dd:                                     ; preds = %block_.L_4163d1
  ...
  %call2_4163e8 = tail call %struct.Memory* @sub_40c100._Z18complete_hash_funcIiET_S0_(%struct.State* nonnull %0, i64 %246, %struct.Memory* %call2_416373)
...
block_.L_416401:                                  ; preds = %block_.L_4163d1
  ...
  %call2_416404 = tail call %struct.Memory* @sub_40c130._Z9check_sumIiEvT_(%struct.State* nonnull %0, i64 %325, %struct.Memory* %call2_416373)
...
block_.L_416417:                                  ; preds = %block_.L_41637f
  ...
  %call2_416417 = tail call %struct.Memory* @sub_400e20._Z5timerv(%struct.State* nonnull %0, i64 %362, %struct.Memory* %call2_416373)
