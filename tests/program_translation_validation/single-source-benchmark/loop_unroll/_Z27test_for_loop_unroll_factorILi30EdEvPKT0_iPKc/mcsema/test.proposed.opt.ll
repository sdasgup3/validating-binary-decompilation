...
entry:
  ...
  %call2_409c73 = tail call %struct.Memory* @sub_400e10._Z11start_timerv(%struct.State* %0, i64 %58, %struct.Memory* %2)
...
block_.L_409c7f:                                  ; preds = %block_.L_409d08, %entry
  %74 = phi i64 [ %341, %block_.L_409d08 ], [ %.pre, %entry ]
  ...
  br i1 %107, label %block_409c8f, label %block_.L_409d20
...
block_.L_409c9e:                                  ; preds = %block_409caf, %block_409c8f
  %118 = phi i64 [ %202, %block_409caf ], [ %.pre9, %block_409c8f ]
  ...
  br i1 %156, label %block_409caf, label %block_.L_409ccd
...
block_409caf:                                     ; preds = %block_.L_409c9e
  ...
  %call2_409cba = tail call %struct.Memory* @sub_401690._ZN15loop_inner_bodyILi30EdE7do_workERdPKdi(%struct.State* nonnull %0, i64 %166, %struct.Memory* %call2_409c73)
...
block_.L_409cd2:                                  ; preds = %block_409cde, %block_.L_409ccd
  %204 = phi i64 [ %119, %block_.L_409ccd ], [ %.pre10, %block_409cde ]
  %storemerge = phi i64 [ %203, %block_.L_409ccd ], [ %299, %block_409cde ]
  %205 = add i64 %204, -44
  ...
  br i1 %239, label %block_409cde, label %block_.L_409d08
...
block_409cde:                                     ; preds = %block_.L_409cd2
  ...
  %call2_409ceb = tail call %struct.Memory* @sub_4014c0._Z18complete_hash_funcIdET_S0_(%struct.State* nonnull %0, i64 %253, %struct.Memory* %call2_409c73)
...
block_.L_409d08:                                  ; preds = %block_.L_409cd2
  ...
  %call2_409d0d = tail call %struct.Memory* @sub_4014f0._Z9check_sumIdEvT_(%struct.State* nonnull %0, i64 %305, %struct.Memory* %call2_409c73)
...
block_.L_409d20:                                  ; preds = %block_.L_409c7f
  ...
  %call2_409d20 = tail call %struct.Memory* @sub_400e30._Z5timerv(%struct.State* nonnull %0, i64 %342, %struct.Memory* %call2_409c73)
  ...
  %call2_409d29 = tail call %struct.Memory* @sub_4007d0._Z13record_resultdPKc(%struct.State* nonnull %0, i64 %353, %struct.Memory* %call2_409d20)
