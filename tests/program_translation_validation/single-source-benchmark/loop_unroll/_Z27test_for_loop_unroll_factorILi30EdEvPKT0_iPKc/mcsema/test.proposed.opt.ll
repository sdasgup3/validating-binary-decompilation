...
define %struct.Memory* @_Z27test_for_loop_unroll_factorILi30EdEvPKT0_iPKc(%struct.State* noalias, i64, %struct.Memory* noalias) local_unnamed_addr #1 {
entry:
  ...
  %call2_409c63 = tail call %struct.Memory* @sub_400e00._Z11start_timerv(%struct.State* %0, i64 %58, %struct.Memory* %2)
...
block_.L_409c6f:                                  ; preds = %block_.L_409cf8, %entry
  %74 = phi i64 [ %.pre, %entry ], [ %341, %block_.L_409cf8 ]
  %MEMORY.0 = phi %struct.Memory* [ %call2_409c63, %entry ], [ %call2_409cfd, %block_.L_409cf8 ]
  ...
  br i1 %107, label %block_409c7f, label %block_.L_409d10
...
block_.L_409c8e:                                  ; preds = %block_409c9f, %block_409c7f
  %118 = phi i64 [ %.pre9, %block_409c7f ], [ %202, %block_409c9f ]
  %MEMORY.1 = phi %struct.Memory* [ %MEMORY.0, %block_409c7f ], [ %call2_409caa, %block_409c9f ]
  ...
  br i1 %156, label %block_409c9f, label %block_.L_409cbd
...
block_409c9f:                                     ; preds = %block_.L_409c8e
  ...
  %call2_409caa = tail call %struct.Memory* @sub_401680._ZN15loop_inner_bodyILi30EdE7do_workERdPKdi(%struct.State* nonnull %0, i64 %166, %struct.Memory* %MEMORY.1)
...
block_.L_409cc2:                                  ; preds = %block_409cce, %block_.L_409cbd
  %204 = phi i64 [ %119, %block_.L_409cbd ], [ %.pre10, %block_409cce ]
  %storemerge = phi i64 [ %203, %block_.L_409cbd ], [ %299, %block_409cce ]
  %MEMORY.2 = phi %struct.Memory* [ %MEMORY.1, %block_.L_409cbd ], [ %call2_409cdb, %block_409cce ]
  %205 = add i64 %204, -44
  ...
  br i1 %239, label %block_409cce, label %block_.L_409cf8
...
block_409cce:                                     ; preds = %block_.L_409cc2
  ...
  %call2_409cdb = tail call %struct.Memory* @sub_4014b0._Z18complete_hash_funcIdET_S0_(%struct.State* nonnull %0, i64 %253, %struct.Memory* %MEMORY.2)
...
block_.L_409cf8:                                  ; preds = %block_.L_409cc2
  ...
  %call2_409cfd = tail call %struct.Memory* @sub_4014e0._Z9check_sumIdEvT_(%struct.State* nonnull %0, i64 %305, %struct.Memory* %MEMORY.2)
...
block_.L_409d10:                                  ; preds = %block_.L_409c6f
  ...
  %call2_409d10 = tail call %struct.Memory* @sub_400e20._Z5timerv(%struct.State* nonnull %0, i64 %342, %struct.Memory* %MEMORY.0)
  ...
  %call2_409d19 = tail call %struct.Memory* @sub_4007c0._Z13record_resultdPKc(%struct.State* nonnull %0, i64 %353, %struct.Memory* %call2_409d10)
  ...
  ret %struct.Memory* %call2_409d19
}
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_jge_.L_409d10(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i8* nocapture %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_jge_.L_409cbd(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i8* nocapture %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 2, i32 9
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_jmpq_.L_409c8e(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_jmpq_.L_409cc2(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_jge_.L_409cf8(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i8* nocapture %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 2, i32 9
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_jmpq_.L_409c6f(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
