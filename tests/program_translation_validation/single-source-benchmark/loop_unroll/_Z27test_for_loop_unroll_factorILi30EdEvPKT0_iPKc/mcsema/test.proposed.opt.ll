...
entry:
  ...
  %call2_409c33 = tail call %struct.Memory* @sub_400dd0._Z11start_timerv(%struct.State* %0, i64 %58, %struct.Memory* %2)
...
block_.L_409c3f:                                  ; preds = %block_.L_409cc8, %entry
  %79 = phi i64 [ %.pre, %entry ], [ %346, %block_.L_409cc8 ]
  %MEMORY.0 = phi %struct.Memory* [ %call2_409c33, %entry ], [ %call2_409ccd, %block_.L_409cc8 ]
  ...
  br i1 %112, label %block_409c4f, label %block_.L_409ce0
...
block_.L_409c5e:                                  ; preds = %block_409c6f, %block_409c4f
  %124 = phi i64 [ %.pre1, %block_409c4f ], [ %208, %block_409c6f ]
  %MEMORY.1 = phi %struct.Memory* [ %MEMORY.0, %block_409c4f ], [ %call2_409c7a, %block_409c6f ]
  ...
  br i1 %162, label %block_409c6f, label %block_.L_409c8d
...
block_409c6f:                                     ; preds = %block_.L_409c5e
  ...
  %call2_409c7a = tail call %struct.Memory* @sub_401650._ZN15loop_inner_bodyILi30EdE7do_workERdPKdi(%struct.State* %0, i64 %172, %struct.Memory* %MEMORY.1)
...
block_.L_409c92:                                  ; preds = %block_409c9e, %block_.L_409c8d
  %210 = phi i64 [ %209, %block_.L_409c8d ], [ %305, %block_409c9e ]
  %211 = phi i64 [ %125, %block_.L_409c8d ], [ %.pre2, %block_409c9e ]
  %MEMORY.2 = phi %struct.Memory* [ %MEMORY.1, %block_.L_409c8d ], [ %call2_409cab, %block_409c9e ]
  %212 = add i64 %211, -44
  %213 = add i64 %210, 3
  ...
  br i1 %246, label %block_409c9e, label %block_.L_409cc8
...
block_409c9e:                                     ; preds = %block_.L_409c92
  ...
  %call2_409cab = tail call %struct.Memory* @sub_401480._Z18complete_hash_funcIdET_S0_(%struct.State* %0, i64 %260, %struct.Memory* %MEMORY.2)
...
block_.L_409cc8:                                  ; preds = %block_.L_409c92
  ...
  %call2_409ccd = tail call %struct.Memory* @sub_4014b0._Z9check_sumIdEvT_(%struct.State* %0, i64 %310, %struct.Memory* %MEMORY.2)
...
block_.L_409ce0:                                  ; preds = %block_.L_409c3f
  ...
  %call2_409ce0 = tail call %struct.Memory* @sub_400df0._Z5timerv(%struct.State* %0, i64 %347, %struct.Memory* %MEMORY.0)
  ...
  %call2_409ce9 = tail call %struct.Memory* @sub_400790._Z13record_resultdPKc(%struct.State* %0, i64 %358, %struct.Memory* %call2_409ce0)
  ...
  ret %struct.Memory* %call2_409ce9
}
...
define %struct.Memory* @routine_jge_.L_409ce0(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i8* %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
...
define %struct.Memory* @routine_jmpq_.L_409c5e(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
...
define %struct.Memory* @routine_jmpq_.L_409c92(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
...
define %struct.Memory* @routine_jge_.L_409cc8(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i8* %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 2, i32 9
