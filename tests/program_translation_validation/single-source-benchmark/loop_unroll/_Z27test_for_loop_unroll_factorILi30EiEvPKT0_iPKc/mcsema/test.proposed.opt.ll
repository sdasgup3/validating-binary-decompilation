...
declare %struct.Memory* @sub_40c250._ZN15loop_inner_bodyILi30EiE7do_workERiPKii(%struct.State* noalias dereferenceable(3376), i64, %struct.Memory* noalias readnone returned) local_unnamed_addr
...
entry:
  ...
  %call2_414413 = tail call %struct.Memory* @sub_400e10._Z11start_timerv(%struct.State* %0, i64 %58, %struct.Memory* %2)
  ...
  br label %block_.L_41441f

block_.L_41441f:                                  ; preds = %block_.L_4144a1, %entry
  %68 = phi i64 [ %362, %block_.L_4144a1 ], [ %.pre, %entry ]
  ...
  br i1 %101, label %block_41442f, label %block_.L_4144b7

block_41442f:                                     ; preds = %block_.L_41441f
  %103 = add i64 %69, -32
  %104 = add i64 %102, 7
  ...
  br label %block_.L_41443d

block_.L_41443d:                                  ; preds = %block_41444e, %block_41442f
  %111 = phi i64 [ %195, %block_41444e ], [ %.pre9, %block_41442f ]
  ...
  br i1 %149, label %block_41444e, label %block_.L_41446c

block_41444e:                                     ; preds = %block_.L_41443d
  %151 = add i64 %112, -32
  ...
  %call2_414459 = tail call %struct.Memory* @sub_40c250._ZN15loop_inner_bodyILi30EiE7do_workERiPKii(%struct.State* nonnull %0, i64 %159, %struct.Memory* %call2_414413)
...
block_.L_41446c:                                  ; preds = %block_.L_41443d
  %196 = add i64 %150, 5
  br label %block_.L_414471

block_.L_414471:                                  ; preds = %block_41447d, %block_.L_41446c
  %197 = phi i64 [ %112, %block_.L_41446c ], [ %.pre10, %block_41447d ]
  %storemerge = phi i64 [ %196, %block_.L_41446c ], [ %319, %block_41447d ]
  %198 = add i64 %197, -36
  ...
  br i1 %232, label %block_41447d, label %block_.L_4144a1
...
block_41447d:                                     ; preds = %block_.L_414471
  ...
  %call2_414488 = tail call %struct.Memory* @sub_40c110._Z18complete_hash_funcIiET_S0_(%struct.State* nonnull %0, i64 %247, %struct.Memory* %call2_414413)
...
block_.L_4144a1:                                  ; preds = %block_.L_414471
  ...
  %call2_4144a4 = tail call %struct.Memory* @sub_40c140._Z9check_sumIiEvT_(%struct.State* nonnull %0, i64 %326, %struct.Memory* %call2_414413)
...
block_.L_4144b7:                                  ; preds = %block_.L_41441f
  ...
  %call2_4144b7 = tail call %struct.Memory* @sub_400e30._Z5timerv(%struct.State* nonnull %0, i64 %363, %struct.Memory* %call2_414413)
  ...
  %call2_4144c0 = tail call %struct.Memory* @sub_4007d0._Z13record_resultdPKc(%struct.State* nonnull %0, i64 %374, %struct.Memory* %call2_4144b7)
