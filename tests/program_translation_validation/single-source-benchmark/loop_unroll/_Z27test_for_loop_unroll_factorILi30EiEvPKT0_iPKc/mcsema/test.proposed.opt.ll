...
declare %struct.Memory* @sub_40c240._ZN15loop_inner_bodyILi30EiE7do_workERiPKii(%struct.State* noalias dereferenceable(3376), i64, %struct.Memory* noalias readnone returned) local_unnamed_addr
...
define %struct.Memory* @_Z27test_for_loop_unroll_factorILi30EiEvPKT0_iPKc(%struct.State* noalias, i64, %struct.Memory* noalias readnone) local_unnamed_addr #1 {
entry:
...
block_.L_41440f:                                  ; preds = %block_.L_414491, %entry
  %68 = phi i64 [ %362, %block_.L_414491 ], [ %.pre, %entry ]
...
block_.L_41442d:                                  ; preds = %block_41443e, %block_41441f
  %111 = phi i64 [ %195, %block_41443e ], [ %.pre9, %block_41441f ]
...
block_41443e:                                     ; preds = %block_.L_41442d
  ...
  %call2_414449 = tail call %struct.Memory* @sub_40c240._ZN15loop_inner_bodyILi30EiE7do_workERiPKii(%struct.State* nonnull %0, i64 %159, %struct.Memory* %call2_414403)
...
block_41446d:                                     ; preds = %block_.L_414461
  ...
  %call2_414478 = tail call %struct.Memory* @sub_40c100._Z18complete_hash_funcIiET_S0_(%struct.State* nonnull %0, i64 %247, %struct.Memory* %call2_414403)
...
block_.L_414491:                                  ; preds = %block_.L_414461
  ...
  %call2_414494 = tail call %struct.Memory* @sub_40c130._Z9check_sumIiEvT_(%struct.State* nonnull %0, i64 %326, %struct.Memory* %call2_414403)
...
block_.L_4144a7:                                  ; preds = %block_.L_41440f
  ...
  %call2_4144a7 = tail call %struct.Memory* @sub_400e20._Z5timerv(%struct.State* nonnull %0, i64 %363, %struct.Memory* %call2_414403)
