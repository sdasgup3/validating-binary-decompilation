...
declare %struct.Memory* @sub_40c210._ZN15loop_inner_bodyILi30EiE7do_workERiPKii(%struct.State* noalias dereferenceable(3376), i64, %struct.Memory* noalias readnone returned) local_unnamed_addr
...
entry:
  ...
  %call2_4143d3 = tail call %struct.Memory* @sub_400dd0._Z11start_timerv(%struct.State* %0, i64 %58, %struct.Memory* %2)
  ...
  br label %block_.L_4143df

block_.L_4143df:                                  ; preds = %block_.L_414461, %entry
  %68 = phi i64 [ %.pre, %entry ], [ %364, %block_.L_414461 ]
  %MEMORY.0 = phi %struct.Memory* [ %call2_4143d3, %entry ], [ %call2_414464, %block_.L_414461 ]
  ...
  br i1 %101, label %block_4143ef, label %block_.L_414477

block_4143ef:                                     ; preds = %block_.L_4143df
  %103 = add i64 %69, -32
  %104 = add i64 %102, 7
  ...
  br label %block_.L_4143fd

block_.L_4143fd:                                  ; preds = %block_41440e, %block_4143ef
  %111 = phi i64 [ %.pre1, %block_4143ef ], [ %195, %block_41440e ]
  %MEMORY.1 = phi %struct.Memory* [ %MEMORY.0, %block_4143ef ], [ %call2_414419, %block_41440e ]
  ...
  br i1 %149, label %block_41440e, label %block_.L_41442c

block_41440e:                                     ; preds = %block_.L_4143fd
  %151 = add i64 %112, -32
  ...
  %call2_414419 = tail call %struct.Memory* @sub_40c210._ZN15loop_inner_bodyILi30EiE7do_workERiPKii(%struct.State* %0, i64 %159, %struct.Memory* %MEMORY.1)
...
block_.L_41442c:                                  ; preds = %block_.L_4143fd
  %196 = add i64 %150, 5
  store i64 %196, i64* %3, align 8
  br label %block_.L_414431

block_.L_414431:                                  ; preds = %block_41443d, %block_.L_41442c
  %197 = phi i64 [ %196, %block_.L_41442c ], [ %321, %block_41443d ]
  %198 = phi i64 [ %112, %block_.L_41442c ], [ %.pre2, %block_41443d ]
  %MEMORY.2 = phi %struct.Memory* [ %MEMORY.1, %block_.L_41442c ], [ %call2_414448, %block_41443d ]
  %199 = add i64 %198, -36
  %200 = add i64 %197, 3
  ...
  br i1 %233, label %block_41443d, label %block_.L_414461

block_41443d:                                     ; preds = %block_.L_414431
  %235 = add i64 %198, -8
  %236 = add i64 %234, 4
  ...
  %call2_414448 = tail call %struct.Memory* @sub_40c0d0._Z18complete_hash_funcIiET_S0_(%struct.State* %0, i64 %248, %struct.Memory* %MEMORY.2)
...
block_.L_414461:                                  ; preds = %block_.L_414431
  %322 = add i64 %198, -32
  %323 = add i64 %234, 3
  ...
  %call2_414464 = tail call %struct.Memory* @sub_40c100._Z9check_sumIiEvT_(%struct.State* %0, i64 %327, %struct.Memory* %MEMORY.2)
...
block_.L_414477:                                  ; preds = %block_.L_4143df
  %365 = add i64 %102, -79495
  %366 = add i64 %102, 5
  ...
  %call2_414477 = tail call %struct.Memory* @sub_400df0._Z5timerv(%struct.State* %0, i64 %365, %struct.Memory* %MEMORY.0)
  ...
  %call2_414480 = tail call %struct.Memory* @sub_400790._Z13record_resultdPKc(%struct.State* %0, i64 %376, %struct.Memory* %call2_414477)
  ...
  ret %struct.Memory* %call2_414480
}
...
define %struct.Memory* @routine_jge_.L_414477(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i8* %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
...
define %struct.Memory* @routine_jge_.L_41442c(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i8* %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 2, i32 9
...
define %struct.Memory* @routine_callq_._ZN15loop_inner_bodyILi30EiE7do_workERiPKii(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
...
define %struct.Memory* @routine_jmpq_.L_4143fd(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
...
define %struct.Memory* @routine_jmpq_.L_414431(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
...
define %struct.Memory* @routine_jge_.L_414461(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i8* %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 2, i32 9
...
define %struct.Memory* @routine_jmpq_.L_4143df(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
