...
block_.L_4143df:                                  ; preds = %block_.L_414461, %entry
  %68 = phi i64 [ %.pre, %entry ], [ %362, %block_.L_414461 ]
...
block_.L_414431:                                  ; preds = %block_41443d, %block_.L_41442c
  %197 = phi i64 [ %196, %block_.L_41442c ], [ %320, %block_41443d ]
...
block_.L_414461:                                  ; preds = %block_.L_414431
  ...
  %call2_414464 = tail call %struct.Memory* @sub_40c100._Z9check_sumIiEvT_(%struct.State* %0, i64 %326, %struct.Memory* %MEMORY.2)
...
block_.L_414477:                                  ; preds = %block_.L_4143df
  ...
  %call2_414477 = tail call %struct.Memory* @sub_400df0._Z5timerv(%struct.State* %0, i64 %363, %struct.Memory* %MEMORY.0)
  ...
  %call2_414480 = tail call %struct.Memory* @sub_400790._Z13record_resultdPKc(%struct.State* %0, i64 %374, %struct.Memory* %call2_414477)
