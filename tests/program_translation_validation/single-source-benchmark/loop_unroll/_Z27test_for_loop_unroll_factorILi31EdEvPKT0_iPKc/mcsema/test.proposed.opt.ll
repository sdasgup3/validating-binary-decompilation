...
declare %struct.Memory* @sub_401620._ZN15loop_inner_bodyILi31EdE7do_workERdPKdi(%struct.State* dereferenceable(3376), i64, %struct.Memory*) local_unnamed_addr
...
define %struct.Memory* @_Z27test_for_loop_unroll_factorILi31EdEvPKT0_iPKc(%struct.State* noalias, i64, %struct.Memory* noalias) local_unnamed_addr #1 {
entry:
  ...
  %call2_409b33 = tail call %struct.Memory* @sub_400e00._Z11start_timerv(%struct.State* %0, i64 %58, %struct.Memory* %2)
  ...
  br label %block_.L_409b3f

block_.L_409b3f:                                  ; preds = %block_.L_409bc8, %entry
  %74 = phi i64 [ %.pre, %entry ], [ %341, %block_.L_409bc8 ]
  %MEMORY.0 = phi %struct.Memory* [ %call2_409b33, %entry ], [ %call2_409bcd, %block_.L_409bc8 ]
  ...
  br i1 %107, label %block_409b4f, label %block_.L_409be0

block_409b4f:                                     ; preds = %block_.L_409b3f
  ...
  br label %block_.L_409b5e

block_.L_409b5e:                                  ; preds = %block_409b6f, %block_409b4f
  %118 = phi i64 [ %.pre9, %block_409b4f ], [ %202, %block_409b6f ]
  %MEMORY.1 = phi %struct.Memory* [ %MEMORY.0, %block_409b4f ], [ %call2_409b7a, %block_409b6f ]
  ...
  br i1 %156, label %block_409b6f, label %block_.L_409b8d

block_409b6f:                                     ; preds = %block_.L_409b5e
  %158 = add i64 %119, -40
  ...
  %call2_409b7a = tail call %struct.Memory* @sub_401620._ZN15loop_inner_bodyILi31EdE7do_workERdPKdi(%struct.State* nonnull %0, i64 %166, %struct.Memory* %MEMORY.1)
...
block_.L_409b8d:                                  ; preds = %block_.L_409b5e
  %203 = add i64 %157, 5
  br label %block_.L_409b92

block_.L_409b92:                                  ; preds = %block_409b9e, %block_.L_409b8d
  %204 = phi i64 [ %119, %block_.L_409b8d ], [ %.pre10, %block_409b9e ]
  %storemerge = phi i64 [ %203, %block_.L_409b8d ], [ %299, %block_409b9e ]
  %MEMORY.2 = phi %struct.Memory* [ %MEMORY.1, %block_.L_409b8d ], [ %call2_409bab, %block_409b9e ]
  %205 = add i64 %204, -44
  ...
  br i1 %239, label %block_409b9e, label %block_.L_409bc8

block_409b9e:                                     ; preds = %block_.L_409b92
  %241 = add i64 %204, -8
  %242 = add i64 %240, 4
  ...
  %call2_409bab = tail call %struct.Memory* @sub_4014b0._Z18complete_hash_funcIdET_S0_(%struct.State* nonnull %0, i64 %253, %struct.Memory* %MEMORY.2)
...
block_.L_409bc8:                                  ; preds = %block_.L_409b92
  %301 = add i64 %204, -40
  %302 = add i64 %240, 5
  ...
  %call2_409bcd = tail call %struct.Memory* @sub_4014e0._Z9check_sumIdEvT_(%struct.State* nonnull %0, i64 %305, %struct.Memory* %MEMORY.2)
...
block_.L_409be0:                                  ; preds = %block_.L_409b3f
  %342 = add i64 %108, -36288
  %343 = add i64 %108, 5
  ...
  %call2_409be0 = tail call %struct.Memory* @sub_400e20._Z5timerv(%struct.State* nonnull %0, i64 %342, %struct.Memory* %MEMORY.0)
  ...
  %call2_409be9 = tail call %struct.Memory* @sub_4007c0._Z13record_resultdPKc(%struct.State* nonnull %0, i64 %353, %struct.Memory* %call2_409be0)
  ...
  ret %struct.Memory* %call2_409be9
}
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_jge_.L_409be0(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i8* nocapture %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_jge_.L_409b8d(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i8* nocapture %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 2, i32 9
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_jmpq_.L_409b5e(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_jmpq_.L_409b92(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_jge_.L_409bc8(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i8* nocapture %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 2, i32 9
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_jmpq_.L_409b3f(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
