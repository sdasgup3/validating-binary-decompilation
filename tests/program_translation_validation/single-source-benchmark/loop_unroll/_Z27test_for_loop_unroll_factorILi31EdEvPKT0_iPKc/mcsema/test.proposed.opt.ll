...
declare %struct.Memory* @sub_4015f0._ZN15loop_inner_bodyILi31EdE7do_workERdPKdi(%struct.State* noalias dereferenceable(3376), i64, %struct.Memory* noalias readnone returned) local_unnamed_addr
...
entry:
  ...
  %call2_409b03 = tail call %struct.Memory* @sub_400dd0._Z11start_timerv(%struct.State* %0, i64 %58, %struct.Memory* %2)
  ...
  br label %block_.L_409b0f

block_.L_409b0f:                                  ; preds = %block_.L_409b98, %entry
  %79 = phi i64 [ %.pre, %entry ], [ %346, %block_.L_409b98 ]
  %MEMORY.0 = phi %struct.Memory* [ %call2_409b03, %entry ], [ %call2_409b9d, %block_.L_409b98 ]
  ...
  br i1 %112, label %block_409b1f, label %block_.L_409bb0

block_409b1f:                                     ; preds = %block_.L_409b0f
  ...
  br label %block_.L_409b2e

block_.L_409b2e:                                  ; preds = %block_409b3f, %block_409b1f
  %124 = phi i64 [ %.pre1, %block_409b1f ], [ %208, %block_409b3f ]
  %MEMORY.1 = phi %struct.Memory* [ %MEMORY.0, %block_409b1f ], [ %call2_409b4a, %block_409b3f ]
  ...
  br i1 %162, label %block_409b3f, label %block_.L_409b5d

block_409b3f:                                     ; preds = %block_.L_409b2e
  %164 = add i64 %125, -40
  ...
  %call2_409b4a = tail call %struct.Memory* @sub_4015f0._ZN15loop_inner_bodyILi31EdE7do_workERdPKdi(%struct.State* %0, i64 %172, %struct.Memory* %MEMORY.1)
...
block_.L_409b5d:                                  ; preds = %block_.L_409b2e
  %209 = add i64 %163, 5
  store i64 %209, i64* %3, align 8
  br label %block_.L_409b62

block_.L_409b62:                                  ; preds = %block_409b6e, %block_.L_409b5d
  %210 = phi i64 [ %209, %block_.L_409b5d ], [ %305, %block_409b6e ]
  %211 = phi i64 [ %125, %block_.L_409b5d ], [ %.pre2, %block_409b6e ]
  %MEMORY.2 = phi %struct.Memory* [ %MEMORY.1, %block_.L_409b5d ], [ %call2_409b7b, %block_409b6e ]
  %212 = add i64 %211, -44
  %213 = add i64 %210, 3
  ...
  br i1 %246, label %block_409b6e, label %block_.L_409b98

block_409b6e:                                     ; preds = %block_.L_409b62
  %248 = add i64 %211, -8
  %249 = add i64 %247, 4
  ...
  %call2_409b7b = tail call %struct.Memory* @sub_401480._Z18complete_hash_funcIdET_S0_(%struct.State* %0, i64 %260, %struct.Memory* %MEMORY.2)
...
block_.L_409b98:                                  ; preds = %block_.L_409b62
  %306 = add i64 %211, -40
  %307 = add i64 %247, 5
  ...
  %call2_409b9d = tail call %struct.Memory* @sub_4014b0._Z9check_sumIdEvT_(%struct.State* %0, i64 %310, %struct.Memory* %MEMORY.2)
...
block_.L_409bb0:                                  ; preds = %block_.L_409b0f
  %347 = add i64 %113, -36288
  %348 = add i64 %113, 5
  ...
  %call2_409bb0 = tail call %struct.Memory* @sub_400df0._Z5timerv(%struct.State* %0, i64 %347, %struct.Memory* %MEMORY.0)
  ...
  %call2_409bb9 = tail call %struct.Memory* @sub_400790._Z13record_resultdPKc(%struct.State* %0, i64 %358, %struct.Memory* %call2_409bb0)
  ...
  ret %struct.Memory* %call2_409bb9
}
...
define %struct.Memory* @routine_jge_.L_409bb0(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i8* %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
...
define %struct.Memory* @routine_jge_.L_409b5d(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i8* %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 2, i32 9
...
define %struct.Memory* @routine_callq_._ZN15loop_inner_bodyILi31EdE7do_workERdPKdi(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
...
define %struct.Memory* @routine_jmpq_.L_409b2e(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
...
define %struct.Memory* @routine_jmpq_.L_409b62(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
...
define %struct.Memory* @routine_jge_.L_409b98(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i8* %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 2, i32 9
...
define %struct.Memory* @routine_jmpq_.L_409b0f(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
