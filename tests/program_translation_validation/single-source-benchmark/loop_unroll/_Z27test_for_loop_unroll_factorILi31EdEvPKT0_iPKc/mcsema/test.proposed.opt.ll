...
declare %struct.Memory* @sub_401620._ZN15loop_inner_bodyILi31EdE7do_workERdPKdi(%struct.State* noalias dereferenceable(3376), i64, %struct.Memory* noalias readnone returned) local_unnamed_addr
...
define %struct.Memory* @_Z27test_for_loop_unroll_factorILi31EdEvPKT0_iPKc(%struct.State* noalias, i64, %struct.Memory* noalias readnone) local_unnamed_addr #1 {
entry:
...
block_.L_409b3f:                                  ; preds = %block_.L_409bc8, %entry
  %74 = phi i64 [ %341, %block_.L_409bc8 ], [ %.pre, %entry ]
...
block_.L_409b5e:                                  ; preds = %block_409b6f, %block_409b4f
  %118 = phi i64 [ %202, %block_409b6f ], [ %.pre9, %block_409b4f ]
...
block_409b6f:                                     ; preds = %block_.L_409b5e
  ...
  %call2_409b7a = tail call %struct.Memory* @sub_401620._ZN15loop_inner_bodyILi31EdE7do_workERdPKdi(%struct.State* nonnull %0, i64 %166, %struct.Memory* %call2_409b33)
...
block_409b9e:                                     ; preds = %block_.L_409b92
  ...
  %call2_409bab = tail call %struct.Memory* @sub_4014b0._Z18complete_hash_funcIdET_S0_(%struct.State* nonnull %0, i64 %253, %struct.Memory* %call2_409b33)
...
block_.L_409bc8:                                  ; preds = %block_.L_409b92
  ...
  %call2_409bcd = tail call %struct.Memory* @sub_4014e0._Z9check_sumIdEvT_(%struct.State* nonnull %0, i64 %305, %struct.Memory* %call2_409b33)
...
block_.L_409be0:                                  ; preds = %block_.L_409b3f
  ...
  %call2_409be0 = tail call %struct.Memory* @sub_400e20._Z5timerv(%struct.State* nonnull %0, i64 %342, %struct.Memory* %call2_409b33)
