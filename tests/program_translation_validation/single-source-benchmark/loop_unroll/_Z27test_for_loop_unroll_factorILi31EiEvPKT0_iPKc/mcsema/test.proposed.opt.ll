...
block_.L_4142bf:                                  ; preds = %block_.L_414341, %entry
  %68 = phi i64 [ %.pre, %entry ], [ %362, %block_.L_414341 ]
...
block_.L_414311:                                  ; preds = %block_41431d, %block_.L_41430c
  %197 = phi i64 [ %196, %block_.L_41430c ], [ %320, %block_41431d ]
...
block_.L_414341:                                  ; preds = %block_.L_414311
  ...
  %call2_414344 = tail call %struct.Memory* @sub_40c100._Z9check_sumIiEvT_(%struct.State* %0, i64 %326, %struct.Memory* %MEMORY.2)
...
block_.L_414357:                                  ; preds = %block_.L_4142bf
  ...
  %call2_414357 = tail call %struct.Memory* @sub_400df0._Z5timerv(%struct.State* %0, i64 %363, %struct.Memory* %MEMORY.0)
  ...
  %call2_414360 = tail call %struct.Memory* @sub_400790._Z13record_resultdPKc(%struct.State* %0, i64 %374, %struct.Memory* %call2_414357)
