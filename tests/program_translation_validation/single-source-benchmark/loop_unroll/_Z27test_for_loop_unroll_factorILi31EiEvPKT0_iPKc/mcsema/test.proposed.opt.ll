...
define %struct.Memory* @_Z27test_for_loop_unroll_factorILi31EiEvPKT0_iPKc(%struct.State* noalias, i64, %struct.Memory* noalias readnone) local_unnamed_addr #1 {
entry:
...
block_.L_4142ef:                                  ; preds = %block_.L_414371, %entry
  %68 = phi i64 [ %362, %block_.L_414371 ], [ %.pre, %entry ]
...
block_.L_41430d:                                  ; preds = %block_41431e, %block_4142ff
  %111 = phi i64 [ %195, %block_41431e ], [ %.pre9, %block_4142ff ]
...
block_41431e:                                     ; preds = %block_.L_41430d
  ...
  %call2_414329 = tail call %struct.Memory* @sub_40c1e0._ZN15loop_inner_bodyILi31EiE7do_workERiPKii(%struct.State* nonnull %0, i64 %159, %struct.Memory* %call2_4142e3)
...
block_41434d:                                     ; preds = %block_.L_414341
  ...
  %call2_414358 = tail call %struct.Memory* @sub_40c100._Z18complete_hash_funcIiET_S0_(%struct.State* nonnull %0, i64 %247, %struct.Memory* %call2_4142e3)
...
block_.L_414371:                                  ; preds = %block_.L_414341
  ...
  %call2_414374 = tail call %struct.Memory* @sub_40c130._Z9check_sumIiEvT_(%struct.State* nonnull %0, i64 %326, %struct.Memory* %call2_4142e3)
...
block_.L_414387:                                  ; preds = %block_.L_4142ef
  ...
  %call2_414387 = tail call %struct.Memory* @sub_400e20._Z5timerv(%struct.State* nonnull %0, i64 %363, %struct.Memory* %call2_4142e3)
