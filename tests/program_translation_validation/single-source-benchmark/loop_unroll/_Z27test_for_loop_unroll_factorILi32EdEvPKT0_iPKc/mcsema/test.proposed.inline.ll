...
define %struct.Memory* @_Z27test_for_loop_unroll_factorILi32EdEvPKT0_iPKc(%struct.State* noalias, i64, %struct.Memory* noalias) #2 {
entry:
  ...
  store %struct.Memory* %loadMem_4099c1, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_4099c4, %struct.Memory** %MEMORY
  ...
  store i64 %78, i64* %81
  store %struct.Memory* %loadMem_4099c8, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_4099cf, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem1_4099d3, %struct.Memory** %MEMORY
...
block_.L_4099df:                                  ; preds = %block_.L_409a68, %entry
  ...
  store %struct.Memory* %loadMem_4099df, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_4099e9, %struct.Memory** %MEMORY
...
block_4099ef:                                     ; preds = %block_.L_4099df
  ...
  store %struct.Memory* %loadMem_4099f2, %struct.Memory** %MEMORY
...
block_.L_4099fe:                                  ; preds = %block_409a0f, %block_4099ef
  ...
  store %struct.Memory* %loadMem_4099fe, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_409a01, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_409a09, %struct.Memory** %MEMORY
...
block_409a0f:                                     ; preds = %block_.L_4099fe
  ...
  store %struct.Memory* %loadMem_409a0f, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_409a17, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem1_409a1a, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_409a1f, %struct.Memory** %MEMORY
...
block_.L_409a2d:                                  ; preds = %block_.L_4099fe
  ...
  store %struct.Memory* %loadMem_409a2d, %struct.Memory** %MEMORY
  br label %block_.L_409a32

block_.L_409a32:                                  ; preds = %block_409a3e, %block_.L_409a2d
  ...
  store %struct.Memory* %loadMem_409a35, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_409a38, %struct.Memory** %MEMORY
...
block_409a3e:                                     ; preds = %block_.L_409a32
  ...
  store %struct.Memory* %loadMem1_409a4b, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_409a55, %struct.Memory** %MEMORY
...
block_.L_409a68:                                  ; preds = %block_.L_409a32
  ...
  store %struct.Memory* %loadMem1_409a6d, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_409a72, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_409a7b, %struct.Memory** %MEMORY
  br label %block_.L_4099df

block_.L_409a80:                                  ; preds = %block_.L_4099df
  ...
  store %struct.Memory* %loadMem1_409a89, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_409a92, %struct.Memory** %MEMORY
  ...
  ret %struct.Memory* %loadMem_409a93
}
...
define %struct.Memory* @routine_subl__0x1f___ecx(%struct.State* dereferenceable(3376), i64, %struct.Memory*) {
block_400478:
  %3 = getelementptr inbounds %struct.State, %struct.State* %0, i32 0, i32 6
  %4 = getelementptr inbounds %struct.GPR, %struct.GPR* %3, i32 0, i32 33
  %5 = getelementptr inbounds %struct.Reg, %struct.Reg* %4, i32 0, i32 0
