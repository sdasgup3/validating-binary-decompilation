...
entry:
  ...
  %call2_409a03 = tail call %struct.Memory* @sub_400e00._Z11start_timerv(%struct.State* %0, i64 %58, %struct.Memory* %2)
...
block_.L_409a0f:                                  ; preds = %block_.L_409a98, %entry
  %74 = phi i64 [ %.pre, %entry ], [ %340, %block_.L_409a98 ]
  %MEMORY.0 = phi %struct.Memory* [ %call2_409a03, %entry ], [ %call2_409a9d, %block_.L_409a98 ]
  ...
  br i1 %107, label %block_409a1f, label %block_.L_409ab0
...
block_.L_409a2e:                                  ; preds = %block_409a3f, %block_409a1f
  %118 = phi i64 [ %.pre9, %block_409a1f ], [ %201, %block_409a3f ]
  %MEMORY.1 = phi %struct.Memory* [ %MEMORY.0, %block_409a1f ], [ %call2_409a4a, %block_409a3f ]
  ...
  br i1 %156, label %block_409a3f, label %block_.L_409a5d
...
block_409a3f:                                     ; preds = %block_.L_409a2e
  ...
  %call2_409a4a = tail call %struct.Memory* @sub_401450._ZN15loop_inner_bodyILi32EdE7do_workERdPKdi(%struct.State* nonnull %0, i64 %166, %struct.Memory* %MEMORY.1)
...
block_.L_409a62:                                  ; preds = %block_409a6e, %block_.L_409a5d
  %203 = phi i64 [ %119, %block_.L_409a5d ], [ %.pre10, %block_409a6e ]
  %storemerge = phi i64 [ %202, %block_.L_409a5d ], [ %298, %block_409a6e ]
  %MEMORY.2 = phi %struct.Memory* [ %MEMORY.1, %block_.L_409a5d ], [ %call2_409a7b, %block_409a6e ]
  %204 = add i64 %203, -44
  ...
  br i1 %238, label %block_409a6e, label %block_.L_409a98
...
block_409a6e:                                     ; preds = %block_.L_409a62
  ...
  %call2_409a7b = tail call %struct.Memory* @sub_4014b0._Z18complete_hash_funcIdET_S0_(%struct.State* nonnull %0, i64 %252, %struct.Memory* %MEMORY.2)
...
block_.L_409a98:                                  ; preds = %block_.L_409a62
  ...
  %call2_409a9d = tail call %struct.Memory* @sub_4014e0._Z9check_sumIdEvT_(%struct.State* nonnull %0, i64 %304, %struct.Memory* %MEMORY.2)
...
block_.L_409ab0:                                  ; preds = %block_.L_409a0f
  ...
  %call2_409ab0 = tail call %struct.Memory* @sub_400e20._Z5timerv(%struct.State* nonnull %0, i64 %341, %struct.Memory* %MEMORY.0)
  ...
  %call2_409ab9 = tail call %struct.Memory* @sub_4007c0._Z13record_resultdPKc(%struct.State* nonnull %0, i64 %352, %struct.Memory* %call2_409ab0)
  ...
  ret %struct.Memory* %call2_409ab9
}
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_jge_.L_409ab0(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i8* nocapture %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_jmpq_.L_409a2e(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_jmpq_.L_409a62(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_jge_.L_409a98(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i8* nocapture %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 2, i32 9
