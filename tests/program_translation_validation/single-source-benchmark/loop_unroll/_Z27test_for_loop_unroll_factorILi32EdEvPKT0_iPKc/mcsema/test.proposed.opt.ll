...
entry:
  ...
  %call2_409a13 = tail call %struct.Memory* @sub_400e10._Z11start_timerv(%struct.State* %0, i64 %58, %struct.Memory* %2)
...
block_.L_409a1f:                                  ; preds = %block_.L_409aa8, %entry
  %74 = phi i64 [ %340, %block_.L_409aa8 ], [ %.pre, %entry ]
  ...
  br i1 %107, label %block_409a2f, label %block_.L_409ac0
...
block_.L_409a3e:                                  ; preds = %block_409a4f, %block_409a2f
  %118 = phi i64 [ %201, %block_409a4f ], [ %.pre9, %block_409a2f ]
  ...
  br i1 %156, label %block_409a4f, label %block_.L_409a6d
...
block_409a4f:                                     ; preds = %block_.L_409a3e
  ...
  %call2_409a5a = tail call %struct.Memory* @sub_401460._ZN15loop_inner_bodyILi32EdE7do_workERdPKdi(%struct.State* nonnull %0, i64 %166, %struct.Memory* %call2_409a13)
...
block_.L_409a72:                                  ; preds = %block_409a7e, %block_.L_409a6d
  %203 = phi i64 [ %119, %block_.L_409a6d ], [ %.pre10, %block_409a7e ]
  %storemerge = phi i64 [ %202, %block_.L_409a6d ], [ %298, %block_409a7e ]
  %204 = add i64 %203, -44
  ...
  br i1 %238, label %block_409a7e, label %block_.L_409aa8
...
block_409a7e:                                     ; preds = %block_.L_409a72
  ...
  %call2_409a8b = tail call %struct.Memory* @sub_4014c0._Z18complete_hash_funcIdET_S0_(%struct.State* nonnull %0, i64 %252, %struct.Memory* %call2_409a13)
...
block_.L_409aa8:                                  ; preds = %block_.L_409a72
  ...
  %call2_409aad = tail call %struct.Memory* @sub_4014f0._Z9check_sumIdEvT_(%struct.State* nonnull %0, i64 %304, %struct.Memory* %call2_409a13)
...
block_.L_409ac0:                                  ; preds = %block_.L_409a1f
  ...
  %call2_409ac0 = tail call %struct.Memory* @sub_400e30._Z5timerv(%struct.State* nonnull %0, i64 %341, %struct.Memory* %call2_409a13)
  ...
  %call2_409ac9 = tail call %struct.Memory* @sub_4007d0._Z13record_resultdPKc(%struct.State* nonnull %0, i64 %352, %struct.Memory* %call2_409ac0)
