...
block_.L_4099df:                                  ; preds = %block_.L_409a68, %entry
  %79 = phi i64 [ %.pre, %entry ], [ %349, %block_.L_409a68 ]
...
block_.L_409a32:                                  ; preds = %block_409a3e, %block_.L_409a2d
  %209 = phi i64 [ %208, %block_.L_409a2d ], [ %306, %block_409a3e ]
...
block_409a3e:                                     ; preds = %block_.L_409a32
  ...
  %call2_409a4b = tail call %struct.Memory* @sub_401480._Z18complete_hash_funcIdET_S0_(%struct.State* %0, i64 %260, %struct.Memory* %MEMORY.2)
...
block_.L_409a68:                                  ; preds = %block_.L_409a32
  ...
  %call2_409a6d = tail call %struct.Memory* @sub_4014b0._Z9check_sumIdEvT_(%struct.State* %0, i64 %312, %struct.Memory* %MEMORY.2)
...
block_.L_409a80:                                  ; preds = %block_.L_4099df
  ...
  %call2_409a80 = tail call %struct.Memory* @sub_400df0._Z5timerv(%struct.State* %0, i64 %350, %struct.Memory* %MEMORY.0)
  ...
  %call2_409a89 = tail call %struct.Memory* @sub_400790._Z13record_resultdPKc(%struct.State* %0, i64 %361, %struct.Memory* %call2_409a80)
