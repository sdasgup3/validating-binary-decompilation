...
define %struct.Memory* @_Z27test_for_loop_unroll_factorILi32EdEvPKT0_iPKc(%struct.State* noalias, i64, %struct.Memory* noalias) local_unnamed_addr #1 {
entry:
  ...
  %call2_4099d3 = tail call %struct.Memory* @sub_400dd0._Z11start_timerv(%struct.State* %0, i64 %58, %struct.Memory* %2)
...
block_.L_4099df:                                  ; preds = %block_.L_409a68, %entry
  %79 = phi i64 [ %.pre, %entry ], [ %345, %block_.L_409a68 ]
  %MEMORY.0 = phi %struct.Memory* [ %call2_4099d3, %entry ], [ %call2_409a6d, %block_.L_409a68 ]
  ...
  br i1 %112, label %block_4099ef, label %block_.L_409a80
...
block_.L_4099fe:                                  ; preds = %block_409a0f, %block_4099ef
  %124 = phi i64 [ %.pre1, %block_4099ef ], [ %207, %block_409a0f ]
  %MEMORY.1 = phi %struct.Memory* [ %MEMORY.0, %block_4099ef ], [ %call2_409a1a, %block_409a0f ]
  ...
  br i1 %162, label %block_409a0f, label %block_.L_409a2d
...
block_409a0f:                                     ; preds = %block_.L_4099fe
  ...
  %call2_409a1a = tail call %struct.Memory* @sub_401420._ZN15loop_inner_bodyILi32EdE7do_workERdPKdi(%struct.State* %0, i64 %172, %struct.Memory* %MEMORY.1)
...
block_.L_409a32:                                  ; preds = %block_409a3e, %block_.L_409a2d
  %209 = phi i64 [ %208, %block_.L_409a2d ], [ %304, %block_409a3e ]
  %210 = phi i64 [ %125, %block_.L_409a2d ], [ %.pre2, %block_409a3e ]
  %MEMORY.2 = phi %struct.Memory* [ %MEMORY.1, %block_.L_409a2d ], [ %call2_409a4b, %block_409a3e ]
  %211 = add i64 %210, -44
  %212 = add i64 %209, 3
  ...
  br i1 %245, label %block_409a3e, label %block_.L_409a68
...
block_409a3e:                                     ; preds = %block_.L_409a32
  ...
  %call2_409a4b = tail call %struct.Memory* @sub_401480._Z18complete_hash_funcIdET_S0_(%struct.State* %0, i64 %259, %struct.Memory* %MEMORY.2)
...
block_.L_409a68:                                  ; preds = %block_.L_409a32
  ...
  %call2_409a6d = tail call %struct.Memory* @sub_4014b0._Z9check_sumIdEvT_(%struct.State* %0, i64 %309, %struct.Memory* %MEMORY.2)
...
block_.L_409a80:                                  ; preds = %block_.L_4099df
  ...
  %call2_409a80 = tail call %struct.Memory* @sub_400df0._Z5timerv(%struct.State* %0, i64 %346, %struct.Memory* %MEMORY.0)
  ...
  %call2_409a89 = tail call %struct.Memory* @sub_400790._Z13record_resultdPKc(%struct.State* %0, i64 %357, %struct.Memory* %call2_409a80)
  ...
  ret %struct.Memory* %call2_409a89
}
...
define %struct.Memory* @routine_jge_.L_409a80(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i8* %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
...
define %struct.Memory* @routine_jge_.L_409a2d(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i8* %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 2, i32 9
...
define %struct.Memory* @routine_jmpq_.L_4099fe(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
...
define %struct.Memory* @routine_jmpq_.L_409a32(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
...
define %struct.Memory* @routine_jge_.L_409a68(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i8* %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 2, i32 9
...
define %struct.Memory* @routine_jmpq_.L_4099df(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
