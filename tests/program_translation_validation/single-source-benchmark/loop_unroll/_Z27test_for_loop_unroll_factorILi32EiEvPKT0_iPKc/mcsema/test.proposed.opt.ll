...
block_.L_41419f:                                  ; preds = %block_.L_414221, %entry
  %68 = phi i64 [ %.pre, %entry ], [ %361, %block_.L_414221 ]
...
block_.L_4141f1:                                  ; preds = %block_4141fd, %block_.L_4141ec
  %196 = phi i64 [ %195, %block_.L_4141ec ], [ %319, %block_4141fd ]
...
block_.L_414221:                                  ; preds = %block_.L_4141f1
  ...
  %call2_414224 = tail call %struct.Memory* @sub_40c100._Z9check_sumIiEvT_(%struct.State* %0, i64 %325, %struct.Memory* %MEMORY.2)
...
block_.L_414237:                                  ; preds = %block_.L_41419f
  ...
  %call2_414237 = tail call %struct.Memory* @sub_400df0._Z5timerv(%struct.State* %0, i64 %362, %struct.Memory* %MEMORY.0)
  ...
  %call2_414240 = tail call %struct.Memory* @sub_400790._Z13record_resultdPKc(%struct.State* %0, i64 %373, %struct.Memory* %call2_414237)
