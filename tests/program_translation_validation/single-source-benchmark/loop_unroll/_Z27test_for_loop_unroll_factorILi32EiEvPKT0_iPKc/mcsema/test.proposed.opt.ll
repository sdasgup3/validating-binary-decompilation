...
define %struct.Memory* @_Z27test_for_loop_unroll_factorILi32EiEvPKT0_iPKc(%struct.State* noalias, i64, %struct.Memory* noalias) local_unnamed_addr #1 {
entry:
  ...
  %call2_4141c3 = tail call %struct.Memory* @sub_400e00._Z11start_timerv(%struct.State* %0, i64 %58, %struct.Memory* %2)
...
block_.L_4141cf:                                  ; preds = %block_.L_414251, %entry
  %68 = phi i64 [ %.pre, %entry ], [ %361, %block_.L_414251 ]
  %MEMORY.0 = phi %struct.Memory* [ %call2_4141c3, %entry ], [ %call2_414254, %block_.L_414251 ]
  ...
  br i1 %101, label %block_4141df, label %block_.L_414267

block_4141df:                                     ; preds = %block_.L_4141cf
  %103 = add i64 %69, -32
  %104 = add i64 %102, 7
...
block_.L_4141ed:                                  ; preds = %block_4141fe, %block_4141df
  %111 = phi i64 [ %.pre9, %block_4141df ], [ %194, %block_4141fe ]
  %MEMORY.1 = phi %struct.Memory* [ %MEMORY.0, %block_4141df ], [ %call2_414209, %block_4141fe ]
  ...
  br i1 %149, label %block_4141fe, label %block_.L_41421c

block_4141fe:                                     ; preds = %block_.L_4141ed
  %151 = add i64 %112, -32
  ...
  %call2_414209 = tail call %struct.Memory* @sub_40c0a0._ZN15loop_inner_bodyILi32EiE7do_workERiPKii(%struct.State* nonnull %0, i64 %159, %struct.Memory* %MEMORY.1)
...
block_.L_41421c:                                  ; preds = %block_.L_4141ed
  %195 = add i64 %150, 5
  br label %block_.L_414221

block_.L_414221:                                  ; preds = %block_41422d, %block_.L_41421c
  %196 = phi i64 [ %112, %block_.L_41421c ], [ %.pre10, %block_41422d ]
  %storemerge = phi i64 [ %195, %block_.L_41421c ], [ %318, %block_41422d ]
  %MEMORY.2 = phi %struct.Memory* [ %MEMORY.1, %block_.L_41421c ], [ %call2_414238, %block_41422d ]
  %197 = add i64 %196, -36
  ...
  br i1 %231, label %block_41422d, label %block_.L_414251

block_41422d:                                     ; preds = %block_.L_414221
  %233 = add i64 %196, -8
  %234 = add i64 %232, 4
  ...
  %call2_414238 = tail call %struct.Memory* @sub_40c100._Z18complete_hash_funcIiET_S0_(%struct.State* nonnull %0, i64 %246, %struct.Memory* %MEMORY.2)
...
block_.L_414251:                                  ; preds = %block_.L_414221
  %320 = add i64 %196, -32
  %321 = add i64 %232, 3
  ...
  %call2_414254 = tail call %struct.Memory* @sub_40c130._Z9check_sumIiEvT_(%struct.State* nonnull %0, i64 %325, %struct.Memory* %MEMORY.2)
...
block_.L_414267:                                  ; preds = %block_.L_4141cf
  %362 = add i64 %102, -78919
  %363 = add i64 %102, 5
  ...
  %call2_414267 = tail call %struct.Memory* @sub_400e20._Z5timerv(%struct.State* nonnull %0, i64 %362, %struct.Memory* %MEMORY.0)
  ...
  %call2_414270 = tail call %struct.Memory* @sub_4007c0._Z13record_resultdPKc(%struct.State* nonnull %0, i64 %373, %struct.Memory* %call2_414267)
  ...
  ret %struct.Memory* %call2_414270
}
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_jge_.L_414267(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i8* nocapture %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_jge_.L_41421c(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i8* nocapture %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 2, i32 9
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_jmpq_.L_4141ed(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_jmpq_.L_414221(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_jge_.L_414251(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i8* nocapture %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 2, i32 9
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_jmpq_.L_4141cf(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
