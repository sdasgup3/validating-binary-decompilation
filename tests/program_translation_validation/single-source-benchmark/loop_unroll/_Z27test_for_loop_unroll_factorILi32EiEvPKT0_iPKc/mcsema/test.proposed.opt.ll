...
define %struct.Memory* @_Z27test_for_loop_unroll_factorILi32EiEvPKT0_iPKc(%struct.State* noalias, i64, %struct.Memory* noalias readnone) local_unnamed_addr #1 {
entry:
...
block_.L_4141cf:                                  ; preds = %block_.L_414251, %entry
  %68 = phi i64 [ %361, %block_.L_414251 ], [ %.pre, %entry ]
...
block_.L_4141ed:                                  ; preds = %block_4141fe, %block_4141df
  %111 = phi i64 [ %194, %block_4141fe ], [ %.pre9, %block_4141df ]
...
block_4141fe:                                     ; preds = %block_.L_4141ed
  ...
  %call2_414209 = tail call %struct.Memory* @sub_40c0a0._ZN15loop_inner_bodyILi32EiE7do_workERiPKii(%struct.State* nonnull %0, i64 %159, %struct.Memory* %call2_4141c3)
...
block_41422d:                                     ; preds = %block_.L_414221
  ...
  %call2_414238 = tail call %struct.Memory* @sub_40c100._Z18complete_hash_funcIiET_S0_(%struct.State* nonnull %0, i64 %246, %struct.Memory* %call2_4141c3)
...
block_.L_414251:                                  ; preds = %block_.L_414221
  ...
  %call2_414254 = tail call %struct.Memory* @sub_40c130._Z9check_sumIiEvT_(%struct.State* nonnull %0, i64 %325, %struct.Memory* %call2_4141c3)
...
block_.L_414267:                                  ; preds = %block_.L_4141cf
  ...
  %call2_414267 = tail call %struct.Memory* @sub_400e20._Z5timerv(%struct.State* nonnull %0, i64 %362, %struct.Memory* %call2_4141c3)
