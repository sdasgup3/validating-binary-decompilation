...
entry:
  ...
  %call2_4141d3 = tail call %struct.Memory* @sub_400e10._Z11start_timerv(%struct.State* %0, i64 %58, %struct.Memory* %2)
...
block_.L_4141df:                                  ; preds = %block_.L_414261, %entry
  %68 = phi i64 [ %361, %block_.L_414261 ], [ %.pre, %entry ]
  ...
  br i1 %101, label %block_4141ef, label %block_.L_414277

block_4141ef:                                     ; preds = %block_.L_4141df
  %103 = add i64 %69, -32
  %104 = add i64 %102, 7
...
block_.L_4141fd:                                  ; preds = %block_41420e, %block_4141ef
  %111 = phi i64 [ %194, %block_41420e ], [ %.pre9, %block_4141ef ]
  ...
  br i1 %149, label %block_41420e, label %block_.L_41422c

block_41420e:                                     ; preds = %block_.L_4141fd
  %151 = add i64 %112, -32
  ...
  %call2_414219 = tail call %struct.Memory* @sub_40c0b0._ZN15loop_inner_bodyILi32EiE7do_workERiPKii(%struct.State* nonnull %0, i64 %159, %struct.Memory* %call2_4141d3)
...
block_.L_41422c:                                  ; preds = %block_.L_4141fd
  %195 = add i64 %150, 5
  br label %block_.L_414231

block_.L_414231:                                  ; preds = %block_41423d, %block_.L_41422c
  %196 = phi i64 [ %112, %block_.L_41422c ], [ %.pre10, %block_41423d ]
  %storemerge = phi i64 [ %195, %block_.L_41422c ], [ %318, %block_41423d ]
  %197 = add i64 %196, -36
  ...
  br i1 %231, label %block_41423d, label %block_.L_414261
...
block_41423d:                                     ; preds = %block_.L_414231
  ...
  %call2_414248 = tail call %struct.Memory* @sub_40c110._Z18complete_hash_funcIiET_S0_(%struct.State* nonnull %0, i64 %246, %struct.Memory* %call2_4141d3)
...
block_.L_414261:                                  ; preds = %block_.L_414231
  ...
  %call2_414264 = tail call %struct.Memory* @sub_40c140._Z9check_sumIiEvT_(%struct.State* nonnull %0, i64 %325, %struct.Memory* %call2_4141d3)
...
block_.L_414277:                                  ; preds = %block_.L_4141df
  ...
  %call2_414277 = tail call %struct.Memory* @sub_400e30._Z5timerv(%struct.State* nonnull %0, i64 %362, %struct.Memory* %call2_4141d3)
  ...
  %call2_414280 = tail call %struct.Memory* @sub_4007d0._Z13record_resultdPKc(%struct.State* nonnull %0, i64 %373, %struct.Memory* %call2_414277)
