...
entry:
  ...
  %call2_40bc43 = tail call %struct.Memory* @sub_400dd0._Z11start_timerv(%struct.State* %0, i64 %58, %struct.Memory* %2)
...
block_.L_40bc4f:                                  ; preds = %block_.L_40bcd8, %entry
  %79 = phi i64 [ %.pre, %entry ], [ %349, %block_.L_40bcd8 ]
  %MEMORY.0 = phi %struct.Memory* [ %call2_40bc43, %entry ], [ %call2_40bcdd, %block_.L_40bcd8 ]
  ...
  br i1 %112, label %block_40bc5f, label %block_.L_40bcf0
...
block_.L_40bc6e:                                  ; preds = %block_40bc7f, %block_40bc5f
  %124 = phi i64 [ %.pre1, %block_40bc5f ], [ %207, %block_40bc7f ]
  %MEMORY.1 = phi %struct.Memory* [ %MEMORY.0, %block_40bc5f ], [ %call2_40bc8a, %block_40bc7f ]
  ...
  br i1 %162, label %block_40bc7f, label %block_.L_40bc9d
...
block_40bc7f:                                     ; preds = %block_.L_40bc6e
  ...
  %call2_40bc8a = tail call %struct.Memory* @sub_402070._ZN15loop_inner_bodyILi3EdE7do_workERdPKdi(%struct.State* %0, i64 %172, %struct.Memory* %MEMORY.1)
...
block_.L_40bca2:                                  ; preds = %block_40bcae, %block_.L_40bc9d
  %209 = phi i64 [ %208, %block_.L_40bc9d ], [ %306, %block_40bcae ]
  %210 = phi i64 [ %125, %block_.L_40bc9d ], [ %.pre2, %block_40bcae ]
  %MEMORY.2 = phi %struct.Memory* [ %MEMORY.1, %block_.L_40bc9d ], [ %call2_40bcbb, %block_40bcae ]
  %211 = add i64 %210, -44
  %212 = add i64 %209, 3
  ...
  br i1 %245, label %block_40bcae, label %block_.L_40bcd8
...
block_40bcae:                                     ; preds = %block_.L_40bca2
  ...
  %call2_40bcbb = tail call %struct.Memory* @sub_401480._Z18complete_hash_funcIdET_S0_(%struct.State* %0, i64 %260, %struct.Memory* %MEMORY.2)
...
block_.L_40bcd8:                                  ; preds = %block_.L_40bca2
  ...
  %call2_40bcdd = tail call %struct.Memory* @sub_4014b0._Z9check_sumIdEvT_(%struct.State* %0, i64 %312, %struct.Memory* %MEMORY.2)
...
block_.L_40bcf0:                                  ; preds = %block_.L_40bc4f
  ...
  %call2_40bcf0 = tail call %struct.Memory* @sub_400df0._Z5timerv(%struct.State* %0, i64 %350, %struct.Memory* %MEMORY.0)
  ...
  %call2_40bcf9 = tail call %struct.Memory* @sub_400790._Z13record_resultdPKc(%struct.State* %0, i64 %361, %struct.Memory* %call2_40bcf0)
  ...
  ret %struct.Memory* %call2_40bcf9
}
...
define %struct.Memory* @routine_jge_.L_40bcf0(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i8* %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
...
define %struct.Memory* @routine_jge_.L_40bc9d(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i8* %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 2, i32 9
...
define %struct.Memory* @routine_jmpq_.L_40bc6e(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
...
define %struct.Memory* @routine_jmpq_.L_40bca2(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
...
define %struct.Memory* @routine_jge_.L_40bcd8(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i8* %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 2, i32 9
...
define %struct.Memory* @routine_jmpq_.L_40bc4f(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
