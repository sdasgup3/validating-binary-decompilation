...
block_.L_40bc4f:                                  ; preds = %block_.L_40bcd8, %entry
  %79 = phi i64 [ %.pre, %entry ], [ %345, %block_.L_40bcd8 ]
...
block_.L_40bca2:                                  ; preds = %block_40bcae, %block_.L_40bc9d
  %209 = phi i64 [ %208, %block_.L_40bc9d ], [ %304, %block_40bcae ]
...
block_40bcae:                                     ; preds = %block_.L_40bca2
  ...
  %call2_40bcbb = tail call %struct.Memory* @sub_401480._Z18complete_hash_funcIdET_S0_(%struct.State* %0, i64 %259, %struct.Memory* %MEMORY.2)
...
block_.L_40bcd8:                                  ; preds = %block_.L_40bca2
  ...
  %call2_40bcdd = tail call %struct.Memory* @sub_4014b0._Z9check_sumIdEvT_(%struct.State* %0, i64 %309, %struct.Memory* %MEMORY.2)
...
block_.L_40bcf0:                                  ; preds = %block_.L_40bc4f
  ...
  %call2_40bcf0 = tail call %struct.Memory* @sub_400df0._Z5timerv(%struct.State* %0, i64 %346, %struct.Memory* %MEMORY.0)
  ...
  %call2_40bcf9 = tail call %struct.Memory* @sub_400790._Z13record_resultdPKc(%struct.State* %0, i64 %357, %struct.Memory* %call2_40bcf0)
