...
define %struct.Memory* @_Z27test_for_loop_unroll_factorILi3EiEvPKT0_iPKc(%struct.State* noalias, i64, %struct.Memory* noalias readnone) local_unnamed_addr #1 {
entry:
  ...
  %call2_416273 = tail call %struct.Memory* @sub_400e10._Z11start_timerv(%struct.State* %0, i64 %58, %struct.Memory* %2)
...
block_.L_41627f:                                  ; preds = %block_.L_416301, %entry
  %68 = phi i64 [ %361, %block_.L_416301 ], [ %.pre, %entry ]
  ...
  br i1 %101, label %block_41628f, label %block_.L_416317

block_41628f:                                     ; preds = %block_.L_41627f
  %103 = add i64 %69, -32
  %104 = add i64 %102, 7
...
block_.L_41629d:                                  ; preds = %block_4162ae, %block_41628f
  %111 = phi i64 [ %194, %block_4162ae ], [ %.pre9, %block_41628f ]
  ...
  br i1 %149, label %block_4162ae, label %block_.L_4162cc

block_4162ae:                                     ; preds = %block_.L_41629d
  %151 = add i64 %112, -32
  ...
  %call2_4162b9 = tail call %struct.Memory* @sub_40cc70._ZN15loop_inner_bodyILi3EiE7do_workERiPKii(%struct.State* nonnull %0, i64 %159, %struct.Memory* %call2_416273)
...
block_.L_4162cc:                                  ; preds = %block_.L_41629d
  %195 = add i64 %150, 5
  br label %block_.L_4162d1

block_.L_4162d1:                                  ; preds = %block_4162dd, %block_.L_4162cc
  %196 = phi i64 [ %112, %block_.L_4162cc ], [ %.pre10, %block_4162dd ]
  %storemerge = phi i64 [ %195, %block_.L_4162cc ], [ %318, %block_4162dd ]
  %197 = add i64 %196, -36
  ...
  br i1 %231, label %block_4162dd, label %block_.L_416301
...
block_4162dd:                                     ; preds = %block_.L_4162d1
  ...
  %call2_4162e8 = tail call %struct.Memory* @sub_40c110._Z18complete_hash_funcIiET_S0_(%struct.State* nonnull %0, i64 %246, %struct.Memory* %call2_416273)
...
block_.L_416301:                                  ; preds = %block_.L_4162d1
  ...
  %call2_416304 = tail call %struct.Memory* @sub_40c140._Z9check_sumIiEvT_(%struct.State* nonnull %0, i64 %325, %struct.Memory* %call2_416273)
...
block_.L_416317:                                  ; preds = %block_.L_41627f
  ...
  %call2_416317 = tail call %struct.Memory* @sub_400e30._Z5timerv(%struct.State* nonnull %0, i64 %362, %struct.Memory* %call2_416273)
  ...
  %call2_416320 = tail call %struct.Memory* @sub_4007d0._Z13record_resultdPKc(%struct.State* nonnull %0, i64 %373, %struct.Memory* %call2_416317)
