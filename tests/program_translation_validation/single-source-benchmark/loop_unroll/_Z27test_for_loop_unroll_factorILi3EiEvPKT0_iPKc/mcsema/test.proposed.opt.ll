...
block_.L_41626f:                                  ; preds = %block_.L_4162f1, %entry
  %68 = phi i64 [ %361, %block_.L_4162f1 ], [ %.pre, %entry ]
...
block_.L_41628d:                                  ; preds = %block_41629e, %block_41627f
  %111 = phi i64 [ %194, %block_41629e ], [ %.pre9, %block_41627f ]
...
block_41629e:                                     ; preds = %block_.L_41628d
  ...
  %call2_4162a9 = tail call %struct.Memory* @sub_40cc60._ZN15loop_inner_bodyILi3EiE7do_workERiPKii(%struct.State* nonnull %0, i64 %159, %struct.Memory* %call2_416263)
...
block_4162cd:                                     ; preds = %block_.L_4162c1
  ...
  %call2_4162d8 = tail call %struct.Memory* @sub_40c100._Z18complete_hash_funcIiET_S0_(%struct.State* nonnull %0, i64 %246, %struct.Memory* %call2_416263)
...
block_.L_4162f1:                                  ; preds = %block_.L_4162c1
  ...
  %call2_4162f4 = tail call %struct.Memory* @sub_40c130._Z9check_sumIiEvT_(%struct.State* nonnull %0, i64 %325, %struct.Memory* %call2_416263)
...
block_.L_416307:                                  ; preds = %block_.L_41626f
  ...
  %call2_416307 = tail call %struct.Memory* @sub_400e20._Z5timerv(%struct.State* nonnull %0, i64 %362, %struct.Memory* %call2_416263)
