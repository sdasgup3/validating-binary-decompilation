...
entry:
  ...
  %call2_416233 = tail call %struct.Memory* @sub_400dd0._Z11start_timerv(%struct.State* %0, i64 %58, %struct.Memory* %2)
...
block_.L_41623f:                                  ; preds = %block_.L_4162c1, %entry
  %68 = phi i64 [ %.pre, %entry ], [ %361, %block_.L_4162c1 ]
  %MEMORY.0 = phi %struct.Memory* [ %call2_416233, %entry ], [ %call2_4162c4, %block_.L_4162c1 ]
  ...
  br i1 %101, label %block_41624f, label %block_.L_4162d7

block_41624f:                                     ; preds = %block_.L_41623f
  %103 = add i64 %69, -32
  %104 = add i64 %102, 7
...
block_.L_41625d:                                  ; preds = %block_41626e, %block_41624f
  %111 = phi i64 [ %.pre1, %block_41624f ], [ %194, %block_41626e ]
  %MEMORY.1 = phi %struct.Memory* [ %MEMORY.0, %block_41624f ], [ %call2_416279, %block_41626e ]
  ...
  br i1 %149, label %block_41626e, label %block_.L_41628c

block_41626e:                                     ; preds = %block_.L_41625d
  %151 = add i64 %112, -32
  ...
  %call2_416279 = tail call %struct.Memory* @sub_40cc30._ZN15loop_inner_bodyILi3EiE7do_workERiPKii(%struct.State* %0, i64 %159, %struct.Memory* %MEMORY.1)
...
block_.L_41628c:                                  ; preds = %block_.L_41625d
  %195 = add i64 %150, 5
  store i64 %195, i64* %3, align 8
  br label %block_.L_416291

block_.L_416291:                                  ; preds = %block_41629d, %block_.L_41628c
  %196 = phi i64 [ %195, %block_.L_41628c ], [ %319, %block_41629d ]
  %197 = phi i64 [ %112, %block_.L_41628c ], [ %.pre2, %block_41629d ]
  %MEMORY.2 = phi %struct.Memory* [ %MEMORY.1, %block_.L_41628c ], [ %call2_4162a8, %block_41629d ]
  %198 = add i64 %197, -36
  %199 = add i64 %196, 3
  ...
  br i1 %232, label %block_41629d, label %block_.L_4162c1

block_41629d:                                     ; preds = %block_.L_416291
  %234 = add i64 %197, -8
  %235 = add i64 %233, 4
  ...
  %call2_4162a8 = tail call %struct.Memory* @sub_40c0d0._Z18complete_hash_funcIiET_S0_(%struct.State* %0, i64 %247, %struct.Memory* %MEMORY.2)
...
block_.L_4162c1:                                  ; preds = %block_.L_416291
  %320 = add i64 %197, -32
  %321 = add i64 %233, 3
  ...
  %call2_4162c4 = tail call %struct.Memory* @sub_40c100._Z9check_sumIiEvT_(%struct.State* %0, i64 %325, %struct.Memory* %MEMORY.2)
...
block_.L_4162d7:                                  ; preds = %block_.L_41623f
  ...
  %call2_4162d7 = tail call %struct.Memory* @sub_400df0._Z5timerv(%struct.State* %0, i64 %362, %struct.Memory* %MEMORY.0)
  ...
  %call2_4162e0 = tail call %struct.Memory* @sub_400790._Z13record_resultdPKc(%struct.State* %0, i64 %373, %struct.Memory* %call2_4162d7)
  ...
  ret %struct.Memory* %call2_4162e0
}
...
define %struct.Memory* @routine_jge_.L_4162d7(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i8* %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
...
define %struct.Memory* @routine_jge_.L_41628c(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i8* %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 2, i32 9
...
define %struct.Memory* @routine_jmpq_.L_41625d(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
...
define %struct.Memory* @routine_jmpq_.L_416291(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
...
define %struct.Memory* @routine_jge_.L_4162c1(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i8* %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 2, i32 9
...
define %struct.Memory* @routine_jmpq_.L_41623f(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
