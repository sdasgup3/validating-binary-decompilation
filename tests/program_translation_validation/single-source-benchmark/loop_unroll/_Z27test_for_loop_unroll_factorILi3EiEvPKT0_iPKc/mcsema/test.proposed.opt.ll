...
define %struct.Memory* @_Z27test_for_loop_unroll_factorILi3EiEvPKT0_iPKc(%struct.State* noalias, i64, %struct.Memory* noalias) local_unnamed_addr #1 {
entry:
  ...
  %call2_416263 = tail call %struct.Memory* @sub_400e00._Z11start_timerv(%struct.State* %0, i64 %58, %struct.Memory* %2)
...
block_.L_41626f:                                  ; preds = %block_.L_4162f1, %entry
  %68 = phi i64 [ %.pre, %entry ], [ %361, %block_.L_4162f1 ]
  %MEMORY.0 = phi %struct.Memory* [ %call2_416263, %entry ], [ %call2_4162f4, %block_.L_4162f1 ]
  ...
  br i1 %101, label %block_41627f, label %block_.L_416307

block_41627f:                                     ; preds = %block_.L_41626f
  %103 = add i64 %69, -32
  %104 = add i64 %102, 7
...
block_.L_41628d:                                  ; preds = %block_41629e, %block_41627f
  %111 = phi i64 [ %.pre9, %block_41627f ], [ %194, %block_41629e ]
  %MEMORY.1 = phi %struct.Memory* [ %MEMORY.0, %block_41627f ], [ %call2_4162a9, %block_41629e ]
  ...
  br i1 %149, label %block_41629e, label %block_.L_4162bc

block_41629e:                                     ; preds = %block_.L_41628d
  %151 = add i64 %112, -32
  ...
  %call2_4162a9 = tail call %struct.Memory* @sub_40cc60._ZN15loop_inner_bodyILi3EiE7do_workERiPKii(%struct.State* nonnull %0, i64 %159, %struct.Memory* %MEMORY.1)
...
block_.L_4162bc:                                  ; preds = %block_.L_41628d
  %195 = add i64 %150, 5
  br label %block_.L_4162c1

block_.L_4162c1:                                  ; preds = %block_4162cd, %block_.L_4162bc
  %196 = phi i64 [ %112, %block_.L_4162bc ], [ %.pre10, %block_4162cd ]
  %storemerge = phi i64 [ %195, %block_.L_4162bc ], [ %318, %block_4162cd ]
  %MEMORY.2 = phi %struct.Memory* [ %MEMORY.1, %block_.L_4162bc ], [ %call2_4162d8, %block_4162cd ]
  %197 = add i64 %196, -36
  ...
  br i1 %231, label %block_4162cd, label %block_.L_4162f1

block_4162cd:                                     ; preds = %block_.L_4162c1
  %233 = add i64 %196, -8
  %234 = add i64 %232, 4
  ...
  %call2_4162d8 = tail call %struct.Memory* @sub_40c100._Z18complete_hash_funcIiET_S0_(%struct.State* nonnull %0, i64 %246, %struct.Memory* %MEMORY.2)
...
block_.L_4162f1:                                  ; preds = %block_.L_4162c1
  %320 = add i64 %196, -32
  %321 = add i64 %232, 3
  ...
  %call2_4162f4 = tail call %struct.Memory* @sub_40c130._Z9check_sumIiEvT_(%struct.State* nonnull %0, i64 %325, %struct.Memory* %MEMORY.2)
...
block_.L_416307:                                  ; preds = %block_.L_41626f
  %362 = add i64 %102, -87271
  %363 = add i64 %102, 5
  ...
  %call2_416307 = tail call %struct.Memory* @sub_400e20._Z5timerv(%struct.State* nonnull %0, i64 %362, %struct.Memory* %MEMORY.0)
  ...
  %call2_416310 = tail call %struct.Memory* @sub_4007c0._Z13record_resultdPKc(%struct.State* nonnull %0, i64 %373, %struct.Memory* %call2_416307)
  ...
  ret %struct.Memory* %call2_416310
}
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_jge_.L_416307(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i8* nocapture %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_jge_.L_4162bc(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i8* nocapture %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 2, i32 9
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_jmpq_.L_41628d(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_jmpq_.L_4162c1(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_jge_.L_4162f1(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i8* nocapture %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 2, i32 9
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_jmpq_.L_41626f(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
