...
block_.L_41623f:                                  ; preds = %block_.L_4162c1, %entry
  %68 = phi i64 [ %.pre, %entry ], [ %363, %block_.L_4162c1 ]
...
block_.L_416291:                                  ; preds = %block_41629d, %block_.L_41628c
  %196 = phi i64 [ %195, %block_.L_41628c ], [ %320, %block_41629d ]
...
block_.L_4162c1:                                  ; preds = %block_.L_416291
  ...
  %call2_4162c4 = tail call %struct.Memory* @sub_40c100._Z9check_sumIiEvT_(%struct.State* %0, i64 %326, %struct.Memory* %MEMORY.2)
...
block_.L_4162d7:                                  ; preds = %block_.L_41623f
  ...
  %call2_4162d7 = tail call %struct.Memory* @sub_400df0._Z5timerv(%struct.State* %0, i64 %364, %struct.Memory* %MEMORY.0)
  ...
  %call2_4162e0 = tail call %struct.Memory* @sub_400790._Z13record_resultdPKc(%struct.State* %0, i64 %375, %struct.Memory* %call2_4162d7)
