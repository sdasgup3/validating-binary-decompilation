...
declare %struct.Memory* @sub_402010._ZN15loop_inner_bodyILi4EdE7do_workERdPKdi(%struct.State* noalias dereferenceable(3376), i64, %struct.Memory* noalias readnone returned) local_unnamed_addr
...
entry:
  ...
  %call2_40bb13 = tail call %struct.Memory* @sub_400dd0._Z11start_timerv(%struct.State* %0, i64 %58, %struct.Memory* %2)
  ...
  br label %block_.L_40bb1f

block_.L_40bb1f:                                  ; preds = %block_.L_40bba8, %entry
  %79 = phi i64 [ %.pre, %entry ], [ %349, %block_.L_40bba8 ]
  %MEMORY.0 = phi %struct.Memory* [ %call2_40bb13, %entry ], [ %call2_40bbad, %block_.L_40bba8 ]
  ...
  br i1 %112, label %block_40bb2f, label %block_.L_40bbc0

block_40bb2f:                                     ; preds = %block_.L_40bb1f
  ...
  br label %block_.L_40bb3e

block_.L_40bb3e:                                  ; preds = %block_40bb4f, %block_40bb2f
  %124 = phi i64 [ %.pre1, %block_40bb2f ], [ %207, %block_40bb4f ]
  %MEMORY.1 = phi %struct.Memory* [ %MEMORY.0, %block_40bb2f ], [ %call2_40bb5a, %block_40bb4f ]
  ...
  br i1 %162, label %block_40bb4f, label %block_.L_40bb6d

block_40bb4f:                                     ; preds = %block_.L_40bb3e
  %164 = add i64 %125, -40
  ...
  %call2_40bb5a = tail call %struct.Memory* @sub_402010._ZN15loop_inner_bodyILi4EdE7do_workERdPKdi(%struct.State* %0, i64 %172, %struct.Memory* %MEMORY.1)
...
block_.L_40bb6d:                                  ; preds = %block_.L_40bb3e
  %208 = add i64 %163, 5
  store i64 %208, i64* %3, align 8
  br label %block_.L_40bb72

block_.L_40bb72:                                  ; preds = %block_40bb7e, %block_.L_40bb6d
  %209 = phi i64 [ %208, %block_.L_40bb6d ], [ %306, %block_40bb7e ]
  %210 = phi i64 [ %125, %block_.L_40bb6d ], [ %.pre2, %block_40bb7e ]
  %MEMORY.2 = phi %struct.Memory* [ %MEMORY.1, %block_.L_40bb6d ], [ %call2_40bb8b, %block_40bb7e ]
  %211 = add i64 %210, -44
  %212 = add i64 %209, 3
  ...
  br i1 %245, label %block_40bb7e, label %block_.L_40bba8
...
block_40bb7e:                                     ; preds = %block_.L_40bb72
  ...
  %call2_40bb8b = tail call %struct.Memory* @sub_401480._Z18complete_hash_funcIdET_S0_(%struct.State* %0, i64 %260, %struct.Memory* %MEMORY.2)
...
block_.L_40bba8:                                  ; preds = %block_.L_40bb72
  %307 = add i64 %210, -40
  %308 = add i64 %246, 5
  ...
  %call2_40bbad = tail call %struct.Memory* @sub_4014b0._Z9check_sumIdEvT_(%struct.State* %0, i64 %312, %struct.Memory* %MEMORY.2)
...
block_.L_40bbc0:                                  ; preds = %block_.L_40bb1f
  %350 = add i64 %113, -44496
  %351 = add i64 %113, 5
  ...
  %call2_40bbc0 = tail call %struct.Memory* @sub_400df0._Z5timerv(%struct.State* %0, i64 %350, %struct.Memory* %MEMORY.0)
  ...
  %call2_40bbc9 = tail call %struct.Memory* @sub_400790._Z13record_resultdPKc(%struct.State* %0, i64 %361, %struct.Memory* %call2_40bbc0)
  ...
  ret %struct.Memory* %call2_40bbc9
}
...
define %struct.Memory* @routine_jge_.L_40bbc0(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i8* %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
...
define %struct.Memory* @routine_jge_.L_40bb6d(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i8* %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 2, i32 9
...
define %struct.Memory* @routine_callq_._ZN15loop_inner_bodyILi4EdE7do_workERdPKdi(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
...
define %struct.Memory* @routine_jmpq_.L_40bb3e(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
...
define %struct.Memory* @routine_jmpq_.L_40bb72(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
...
define %struct.Memory* @routine_jge_.L_40bba8(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i8* %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 2, i32 9
...
define %struct.Memory* @routine_jmpq_.L_40bb1f(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
