...
declare %struct.Memory* @sub_402040._ZN15loop_inner_bodyILi4EdE7do_workERdPKdi(%struct.State* noalias dereferenceable(3376), i64, %struct.Memory* noalias readnone returned) local_unnamed_addr
...
block_.L_40bb4f:                                  ; preds = %block_.L_40bbd8, %entry
  %74 = phi i64 [ %340, %block_.L_40bbd8 ], [ %.pre, %entry ]
...
block_.L_40bb6e:                                  ; preds = %block_40bb7f, %block_40bb5f
  %118 = phi i64 [ %201, %block_40bb7f ], [ %.pre9, %block_40bb5f ]
...
block_40bb7f:                                     ; preds = %block_.L_40bb6e
  ...
  %call2_40bb8a = tail call %struct.Memory* @sub_402040._ZN15loop_inner_bodyILi4EdE7do_workERdPKdi(%struct.State* nonnull %0, i64 %166, %struct.Memory* %call2_40bb43)
...
block_40bbae:                                     ; preds = %block_.L_40bba2
  ...
  %call2_40bbbb = tail call %struct.Memory* @sub_4014b0._Z18complete_hash_funcIdET_S0_(%struct.State* nonnull %0, i64 %252, %struct.Memory* %call2_40bb43)
...
block_.L_40bbd8:                                  ; preds = %block_.L_40bba2
  ...
  %call2_40bbdd = tail call %struct.Memory* @sub_4014e0._Z9check_sumIdEvT_(%struct.State* nonnull %0, i64 %304, %struct.Memory* %call2_40bb43)
...
block_.L_40bbf0:                                  ; preds = %block_.L_40bb4f
  ...
  %call2_40bbf0 = tail call %struct.Memory* @sub_400e20._Z5timerv(%struct.State* nonnull %0, i64 %341, %struct.Memory* %call2_40bb43)
