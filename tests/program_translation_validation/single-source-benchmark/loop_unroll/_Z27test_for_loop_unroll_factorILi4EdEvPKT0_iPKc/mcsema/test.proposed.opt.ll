...
block_.L_40bb1f:                                  ; preds = %block_.L_40bba8, %entry
  %79 = phi i64 [ %.pre, %entry ], [ %345, %block_.L_40bba8 ]
...
block_.L_40bb72:                                  ; preds = %block_40bb7e, %block_.L_40bb6d
  %209 = phi i64 [ %208, %block_.L_40bb6d ], [ %304, %block_40bb7e ]
...
block_40bb7e:                                     ; preds = %block_.L_40bb72
  ...
  %call2_40bb8b = tail call %struct.Memory* @sub_401480._Z18complete_hash_funcIdET_S0_(%struct.State* %0, i64 %259, %struct.Memory* %MEMORY.2)
...
block_.L_40bba8:                                  ; preds = %block_.L_40bb72
  ...
  %call2_40bbad = tail call %struct.Memory* @sub_4014b0._Z9check_sumIdEvT_(%struct.State* %0, i64 %309, %struct.Memory* %MEMORY.2)
...
block_.L_40bbc0:                                  ; preds = %block_.L_40bb1f
  ...
  %call2_40bbc0 = tail call %struct.Memory* @sub_400df0._Z5timerv(%struct.State* %0, i64 %346, %struct.Memory* %MEMORY.0)
  ...
  %call2_40bbc9 = tail call %struct.Memory* @sub_400790._Z13record_resultdPKc(%struct.State* %0, i64 %357, %struct.Memory* %call2_40bbc0)
