...
entry:
  ...
  %call2_416153 = tail call %struct.Memory* @sub_400e10._Z11start_timerv(%struct.State* %0, i64 %58, %struct.Memory* %2)
...
block_.L_41615f:                                  ; preds = %block_.L_4161e1, %entry
  %68 = phi i64 [ %361, %block_.L_4161e1 ], [ %.pre, %entry ]
  ...
  br i1 %101, label %block_41616f, label %block_.L_4161f7
...
block_.L_41617d:                                  ; preds = %block_41618e, %block_41616f
  %111 = phi i64 [ %194, %block_41618e ], [ %.pre9, %block_41616f ]
  ...
  br i1 %149, label %block_41618e, label %block_.L_4161ac
...
block_41618e:                                     ; preds = %block_.L_41617d
  ...
  %call2_416199 = tail call %struct.Memory* @sub_40cc10._ZN15loop_inner_bodyILi4EiE7do_workERiPKii(%struct.State* nonnull %0, i64 %159, %struct.Memory* %call2_416153)
...
block_.L_4161b1:                                  ; preds = %block_4161bd, %block_.L_4161ac
  %196 = phi i64 [ %112, %block_.L_4161ac ], [ %.pre10, %block_4161bd ]
  %storemerge = phi i64 [ %195, %block_.L_4161ac ], [ %318, %block_4161bd ]
  %197 = add i64 %196, -36
  ...
  br i1 %231, label %block_4161bd, label %block_.L_4161e1
...
block_4161bd:                                     ; preds = %block_.L_4161b1
  ...
  %call2_4161c8 = tail call %struct.Memory* @sub_40c110._Z18complete_hash_funcIiET_S0_(%struct.State* nonnull %0, i64 %246, %struct.Memory* %call2_416153)
...
block_.L_4161e1:                                  ; preds = %block_.L_4161b1
  ...
  %call2_4161e4 = tail call %struct.Memory* @sub_40c140._Z9check_sumIiEvT_(%struct.State* nonnull %0, i64 %325, %struct.Memory* %call2_416153)
...
block_.L_4161f7:                                  ; preds = %block_.L_41615f
  ...
  %call2_4161f7 = tail call %struct.Memory* @sub_400e30._Z5timerv(%struct.State* nonnull %0, i64 %362, %struct.Memory* %call2_416153)
  ...
  %call2_416200 = tail call %struct.Memory* @sub_4007d0._Z13record_resultdPKc(%struct.State* nonnull %0, i64 %373, %struct.Memory* %call2_4161f7)
