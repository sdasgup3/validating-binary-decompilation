...
block_.L_41611f:                                  ; preds = %block_.L_4161a1, %entry
  %68 = phi i64 [ %.pre, %entry ], [ %363, %block_.L_4161a1 ]
...
block_.L_416171:                                  ; preds = %block_41617d, %block_.L_41616c
  %196 = phi i64 [ %195, %block_.L_41616c ], [ %320, %block_41617d ]
...
block_.L_4161a1:                                  ; preds = %block_.L_416171
  ...
  %call2_4161a4 = tail call %struct.Memory* @sub_40c100._Z9check_sumIiEvT_(%struct.State* %0, i64 %326, %struct.Memory* %MEMORY.2)
...
block_.L_4161b7:                                  ; preds = %block_.L_41611f
  ...
  %call2_4161b7 = tail call %struct.Memory* @sub_400df0._Z5timerv(%struct.State* %0, i64 %364, %struct.Memory* %MEMORY.0)
  ...
  %call2_4161c0 = tail call %struct.Memory* @sub_400790._Z13record_resultdPKc(%struct.State* %0, i64 %375, %struct.Memory* %call2_4161b7)
