...
define %struct.Memory* @_Z27test_for_loop_unroll_factorILi4EiEvPKT0_iPKc(%struct.State* noalias, i64, %struct.Memory* noalias readnone) local_unnamed_addr #1 {
entry:
...
block_.L_41614f:                                  ; preds = %block_.L_4161d1, %entry
  %68 = phi i64 [ %361, %block_.L_4161d1 ], [ %.pre, %entry ]
...
block_.L_41616d:                                  ; preds = %block_41617e, %block_41615f
  %111 = phi i64 [ %194, %block_41617e ], [ %.pre9, %block_41615f ]
...
block_41617e:                                     ; preds = %block_.L_41616d
  ...
  %call2_416189 = tail call %struct.Memory* @sub_40cc00._ZN15loop_inner_bodyILi4EiE7do_workERiPKii(%struct.State* nonnull %0, i64 %159, %struct.Memory* %call2_416143)
...
block_4161ad:                                     ; preds = %block_.L_4161a1
  ...
  %call2_4161b8 = tail call %struct.Memory* @sub_40c100._Z18complete_hash_funcIiET_S0_(%struct.State* nonnull %0, i64 %246, %struct.Memory* %call2_416143)
...
block_.L_4161d1:                                  ; preds = %block_.L_4161a1
  ...
  %call2_4161d4 = tail call %struct.Memory* @sub_40c130._Z9check_sumIiEvT_(%struct.State* nonnull %0, i64 %325, %struct.Memory* %call2_416143)
...
block_.L_4161e7:                                  ; preds = %block_.L_41614f
  ...
  %call2_4161e7 = tail call %struct.Memory* @sub_400e20._Z5timerv(%struct.State* nonnull %0, i64 %362, %struct.Memory* %call2_416143)
