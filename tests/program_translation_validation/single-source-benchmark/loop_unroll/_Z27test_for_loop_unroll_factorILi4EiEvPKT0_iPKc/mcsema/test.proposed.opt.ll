...
entry:
  ...
  %call2_416113 = tail call %struct.Memory* @sub_400dd0._Z11start_timerv(%struct.State* %0, i64 %58, %struct.Memory* %2)
...
block_.L_41611f:                                  ; preds = %block_.L_4161a1, %entry
  %68 = phi i64 [ %.pre, %entry ], [ %361, %block_.L_4161a1 ]
  %MEMORY.0 = phi %struct.Memory* [ %call2_416113, %entry ], [ %call2_4161a4, %block_.L_4161a1 ]
  ...
  br i1 %101, label %block_41612f, label %block_.L_4161b7
...
block_.L_41613d:                                  ; preds = %block_41614e, %block_41612f
  %111 = phi i64 [ %.pre1, %block_41612f ], [ %194, %block_41614e ]
  %MEMORY.1 = phi %struct.Memory* [ %MEMORY.0, %block_41612f ], [ %call2_416159, %block_41614e ]
  ...
  br i1 %149, label %block_41614e, label %block_.L_41616c
...
block_41614e:                                     ; preds = %block_.L_41613d
  ...
  %call2_416159 = tail call %struct.Memory* @sub_40cbd0._ZN15loop_inner_bodyILi4EiE7do_workERiPKii(%struct.State* %0, i64 %159, %struct.Memory* %MEMORY.1)
...
block_.L_416171:                                  ; preds = %block_41617d, %block_.L_41616c
  %196 = phi i64 [ %195, %block_.L_41616c ], [ %319, %block_41617d ]
  %197 = phi i64 [ %112, %block_.L_41616c ], [ %.pre2, %block_41617d ]
  %MEMORY.2 = phi %struct.Memory* [ %MEMORY.1, %block_.L_41616c ], [ %call2_416188, %block_41617d ]
  %198 = add i64 %197, -36
  %199 = add i64 %196, 3
  ...
  br i1 %232, label %block_41617d, label %block_.L_4161a1
...
block_41617d:                                     ; preds = %block_.L_416171
  ...
  %call2_416188 = tail call %struct.Memory* @sub_40c0d0._Z18complete_hash_funcIiET_S0_(%struct.State* %0, i64 %247, %struct.Memory* %MEMORY.2)
...
block_.L_4161a1:                                  ; preds = %block_.L_416171
  ...
  %call2_4161a4 = tail call %struct.Memory* @sub_40c100._Z9check_sumIiEvT_(%struct.State* %0, i64 %325, %struct.Memory* %MEMORY.2)
...
block_.L_4161b7:                                  ; preds = %block_.L_41611f
  ...
  %call2_4161b7 = tail call %struct.Memory* @sub_400df0._Z5timerv(%struct.State* %0, i64 %362, %struct.Memory* %MEMORY.0)
  ...
  %call2_4161c0 = tail call %struct.Memory* @sub_400790._Z13record_resultdPKc(%struct.State* %0, i64 %373, %struct.Memory* %call2_4161b7)
  ...
  ret %struct.Memory* %call2_4161c0
}
...
define %struct.Memory* @routine_jge_.L_4161b7(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i8* %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
...
define %struct.Memory* @routine_jge_.L_41616c(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i8* %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 2, i32 9
...
define %struct.Memory* @routine_jmpq_.L_41613d(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
...
define %struct.Memory* @routine_jmpq_.L_416171(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
...
define %struct.Memory* @routine_jge_.L_4161a1(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i8* %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 2, i32 9
...
define %struct.Memory* @routine_jmpq_.L_41611f(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
