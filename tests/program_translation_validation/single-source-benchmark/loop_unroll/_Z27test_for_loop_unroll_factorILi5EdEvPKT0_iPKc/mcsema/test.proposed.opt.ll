...
block_.L_40b9ef:                                  ; preds = %block_.L_40ba78, %entry
  %79 = phi i64 [ %.pre, %entry ], [ %349, %block_.L_40ba78 ]
...
block_.L_40ba42:                                  ; preds = %block_40ba4e, %block_.L_40ba3d
  %209 = phi i64 [ %208, %block_.L_40ba3d ], [ %306, %block_40ba4e ]
...
block_40ba4e:                                     ; preds = %block_.L_40ba42
  ...
  %call2_40ba5b = tail call %struct.Memory* @sub_401480._Z18complete_hash_funcIdET_S0_(%struct.State* %0, i64 %260, %struct.Memory* %MEMORY.2)
...
block_.L_40ba78:                                  ; preds = %block_.L_40ba42
  ...
  %call2_40ba7d = tail call %struct.Memory* @sub_4014b0._Z9check_sumIdEvT_(%struct.State* %0, i64 %312, %struct.Memory* %MEMORY.2)
...
block_.L_40ba90:                                  ; preds = %block_.L_40b9ef
  ...
  %call2_40ba90 = tail call %struct.Memory* @sub_400df0._Z5timerv(%struct.State* %0, i64 %350, %struct.Memory* %MEMORY.0)
  ...
  %call2_40ba99 = tail call %struct.Memory* @sub_400790._Z13record_resultdPKc(%struct.State* %0, i64 %361, %struct.Memory* %call2_40ba90)
