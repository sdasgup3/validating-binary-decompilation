...
define %struct.Memory* @_Z27test_for_loop_unroll_factorILi5EdEvPKT0_iPKc(%struct.State* noalias, i64, %struct.Memory* noalias readnone) local_unnamed_addr #1 {
entry:
...
block_.L_40ba1f:                                  ; preds = %block_.L_40baa8, %entry
  %74 = phi i64 [ %340, %block_.L_40baa8 ], [ %.pre, %entry ]
...
block_.L_40ba3e:                                  ; preds = %block_40ba4f, %block_40ba2f
  %118 = phi i64 [ %201, %block_40ba4f ], [ %.pre9, %block_40ba2f ]
...
block_40ba4f:                                     ; preds = %block_.L_40ba3e
  ...
  %call2_40ba5a = tail call %struct.Memory* @sub_401fe0._ZN15loop_inner_bodyILi5EdE7do_workERdPKdi(%struct.State* nonnull %0, i64 %166, %struct.Memory* %call2_40ba13)
...
block_40ba7e:                                     ; preds = %block_.L_40ba72
  ...
  %call2_40ba8b = tail call %struct.Memory* @sub_4014b0._Z18complete_hash_funcIdET_S0_(%struct.State* nonnull %0, i64 %252, %struct.Memory* %call2_40ba13)
...
block_.L_40baa8:                                  ; preds = %block_.L_40ba72
  ...
  %call2_40baad = tail call %struct.Memory* @sub_4014e0._Z9check_sumIdEvT_(%struct.State* nonnull %0, i64 %304, %struct.Memory* %call2_40ba13)
...
block_.L_40bac0:                                  ; preds = %block_.L_40ba1f
  ...
  %call2_40bac0 = tail call %struct.Memory* @sub_400e20._Z5timerv(%struct.State* nonnull %0, i64 %341, %struct.Memory* %call2_40ba13)
