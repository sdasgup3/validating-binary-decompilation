...
declare %struct.Memory* @sub_40cba0._ZN15loop_inner_bodyILi5EiE7do_workERiPKii(%struct.State* dereferenceable(3376), i64, %struct.Memory*) local_unnamed_addr
...
define %struct.Memory* @_Z27test_for_loop_unroll_factorILi5EiEvPKT0_iPKc(%struct.State* noalias, i64, %struct.Memory* noalias) local_unnamed_addr #1 {
entry:
  ...
  %call2_416023 = tail call %struct.Memory* @sub_400e00._Z11start_timerv(%struct.State* %0, i64 %58, %struct.Memory* %2)
  ...
  br label %block_.L_41602f

block_.L_41602f:                                  ; preds = %block_.L_4160b1, %entry
  %68 = phi i64 [ %.pre, %entry ], [ %361, %block_.L_4160b1 ]
  %MEMORY.0 = phi %struct.Memory* [ %call2_416023, %entry ], [ %call2_4160b4, %block_.L_4160b1 ]
  ...
  br i1 %101, label %block_41603f, label %block_.L_4160c7

block_41603f:                                     ; preds = %block_.L_41602f
  %103 = add i64 %69, -32
  %104 = add i64 %102, 7
  ...
  br label %block_.L_41604d

block_.L_41604d:                                  ; preds = %block_41605e, %block_41603f
  %111 = phi i64 [ %.pre9, %block_41603f ], [ %194, %block_41605e ]
  %MEMORY.1 = phi %struct.Memory* [ %MEMORY.0, %block_41603f ], [ %call2_416069, %block_41605e ]
  ...
  br i1 %149, label %block_41605e, label %block_.L_41607c

block_41605e:                                     ; preds = %block_.L_41604d
  %151 = add i64 %112, -32
  ...
  %call2_416069 = tail call %struct.Memory* @sub_40cba0._ZN15loop_inner_bodyILi5EiE7do_workERiPKii(%struct.State* nonnull %0, i64 %159, %struct.Memory* %MEMORY.1)
...
block_.L_41607c:                                  ; preds = %block_.L_41604d
  %195 = add i64 %150, 5
  br label %block_.L_416081

block_.L_416081:                                  ; preds = %block_41608d, %block_.L_41607c
  %196 = phi i64 [ %112, %block_.L_41607c ], [ %.pre10, %block_41608d ]
  %storemerge = phi i64 [ %195, %block_.L_41607c ], [ %318, %block_41608d ]
  %MEMORY.2 = phi %struct.Memory* [ %MEMORY.1, %block_.L_41607c ], [ %call2_416098, %block_41608d ]
  %197 = add i64 %196, -36
  ...
  br i1 %231, label %block_41608d, label %block_.L_4160b1

block_41608d:                                     ; preds = %block_.L_416081
  %233 = add i64 %196, -8
  %234 = add i64 %232, 4
  ...
  %call2_416098 = tail call %struct.Memory* @sub_40c100._Z18complete_hash_funcIiET_S0_(%struct.State* nonnull %0, i64 %246, %struct.Memory* %MEMORY.2)
...
block_.L_4160b1:                                  ; preds = %block_.L_416081
  %320 = add i64 %196, -32
  %321 = add i64 %232, 3
  ...
  %call2_4160b4 = tail call %struct.Memory* @sub_40c130._Z9check_sumIiEvT_(%struct.State* nonnull %0, i64 %325, %struct.Memory* %MEMORY.2)
...
block_.L_4160c7:                                  ; preds = %block_.L_41602f
  %362 = add i64 %102, -86695
  %363 = add i64 %102, 5
  ...
  %call2_4160c7 = tail call %struct.Memory* @sub_400e20._Z5timerv(%struct.State* nonnull %0, i64 %362, %struct.Memory* %MEMORY.0)
  ...
  %call2_4160d0 = tail call %struct.Memory* @sub_4007c0._Z13record_resultdPKc(%struct.State* nonnull %0, i64 %373, %struct.Memory* %call2_4160c7)
  ...
  ret %struct.Memory* %call2_4160d0
}
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_jge_.L_4160c7(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i8* nocapture %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_jge_.L_41607c(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i8* nocapture %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 2, i32 9
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_jmpq_.L_41604d(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_jmpq_.L_416081(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_jge_.L_4160b1(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i8* nocapture %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 2, i32 9
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_jmpq_.L_41602f(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
