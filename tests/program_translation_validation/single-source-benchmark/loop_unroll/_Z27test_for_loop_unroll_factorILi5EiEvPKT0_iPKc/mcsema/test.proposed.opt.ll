...
block_.L_415fff:                                  ; preds = %block_.L_416081, %entry
  %68 = phi i64 [ %.pre, %entry ], [ %361, %block_.L_416081 ]
...
block_.L_416051:                                  ; preds = %block_41605d, %block_.L_41604c
  %196 = phi i64 [ %195, %block_.L_41604c ], [ %319, %block_41605d ]
...
block_.L_416081:                                  ; preds = %block_.L_416051
  ...
  %call2_416084 = tail call %struct.Memory* @sub_40c100._Z9check_sumIiEvT_(%struct.State* %0, i64 %325, %struct.Memory* %MEMORY.2)
...
block_.L_416097:                                  ; preds = %block_.L_415fff
  ...
  %call2_416097 = tail call %struct.Memory* @sub_400df0._Z5timerv(%struct.State* %0, i64 %362, %struct.Memory* %MEMORY.0)
  ...
  %call2_4160a0 = tail call %struct.Memory* @sub_400790._Z13record_resultdPKc(%struct.State* %0, i64 %373, %struct.Memory* %call2_416097)
