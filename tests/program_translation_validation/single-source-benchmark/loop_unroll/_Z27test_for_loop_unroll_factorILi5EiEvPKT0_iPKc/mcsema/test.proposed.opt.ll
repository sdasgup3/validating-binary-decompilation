...
entry:
  ...
  %call2_415ff3 = tail call %struct.Memory* @sub_400dd0._Z11start_timerv(%struct.State* %0, i64 %58, %struct.Memory* %2)
  ...
  br label %block_.L_415fff

block_.L_415fff:                                  ; preds = %block_.L_416081, %entry
  %68 = phi i64 [ %.pre, %entry ], [ %363, %block_.L_416081 ]
  %MEMORY.0 = phi %struct.Memory* [ %call2_415ff3, %entry ], [ %call2_416084, %block_.L_416081 ]
  ...
  br i1 %101, label %block_41600f, label %block_.L_416097

block_41600f:                                     ; preds = %block_.L_415fff
  %103 = add i64 %69, -32
  %104 = add i64 %102, 7
  ...
  br label %block_.L_41601d

block_.L_41601d:                                  ; preds = %block_41602e, %block_41600f
  %111 = phi i64 [ %.pre1, %block_41600f ], [ %194, %block_41602e ]
  %MEMORY.1 = phi %struct.Memory* [ %MEMORY.0, %block_41600f ], [ %call2_416039, %block_41602e ]
  ...
  br i1 %149, label %block_41602e, label %block_.L_41604c

block_41602e:                                     ; preds = %block_.L_41601d
  %151 = add i64 %112, -32
  ...
  %call2_416039 = tail call %struct.Memory* @sub_40cb70._ZN15loop_inner_bodyILi5EiE7do_workERiPKii(%struct.State* %0, i64 %159, %struct.Memory* %MEMORY.1)
...
block_.L_41604c:                                  ; preds = %block_.L_41601d
  %195 = add i64 %150, 5
  store i64 %195, i64* %3, align 8
  br label %block_.L_416051

block_.L_416051:                                  ; preds = %block_41605d, %block_.L_41604c
  %196 = phi i64 [ %195, %block_.L_41604c ], [ %320, %block_41605d ]
  %197 = phi i64 [ %112, %block_.L_41604c ], [ %.pre2, %block_41605d ]
  %MEMORY.2 = phi %struct.Memory* [ %MEMORY.1, %block_.L_41604c ], [ %call2_416068, %block_41605d ]
  %198 = add i64 %197, -36
  %199 = add i64 %196, 3
  ...
  br i1 %232, label %block_41605d, label %block_.L_416081

block_41605d:                                     ; preds = %block_.L_416051
  %234 = add i64 %197, -8
  %235 = add i64 %233, 4
  ...
  %call2_416068 = tail call %struct.Memory* @sub_40c0d0._Z18complete_hash_funcIiET_S0_(%struct.State* %0, i64 %247, %struct.Memory* %MEMORY.2)
...
block_.L_416081:                                  ; preds = %block_.L_416051
  %321 = add i64 %197, -32
  %322 = add i64 %233, 3
  ...
  %call2_416084 = tail call %struct.Memory* @sub_40c100._Z9check_sumIiEvT_(%struct.State* %0, i64 %326, %struct.Memory* %MEMORY.2)
...
block_.L_416097:                                  ; preds = %block_.L_415fff
  %364 = add i64 %102, -86695
  %365 = add i64 %102, 5
  ...
  %call2_416097 = tail call %struct.Memory* @sub_400df0._Z5timerv(%struct.State* %0, i64 %364, %struct.Memory* %MEMORY.0)
  ...
  %call2_4160a0 = tail call %struct.Memory* @sub_400790._Z13record_resultdPKc(%struct.State* %0, i64 %375, %struct.Memory* %call2_416097)
  ...
  ret %struct.Memory* %call2_4160a0
}
...
define %struct.Memory* @routine_jge_.L_416097(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i8* %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
...
define %struct.Memory* @routine_jge_.L_41604c(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i8* %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 2, i32 9
...
define %struct.Memory* @routine_jmpq_.L_41601d(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
...
define %struct.Memory* @routine_jmpq_.L_416051(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
...
define %struct.Memory* @routine_jge_.L_416081(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i8* %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 2, i32 9
...
define %struct.Memory* @routine_jmpq_.L_415fff(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
