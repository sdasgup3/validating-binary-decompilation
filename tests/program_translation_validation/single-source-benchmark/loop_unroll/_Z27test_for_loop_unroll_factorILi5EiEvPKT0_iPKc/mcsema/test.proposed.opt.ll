...
define %struct.Memory* @_Z27test_for_loop_unroll_factorILi5EiEvPKT0_iPKc(%struct.State* noalias, i64, %struct.Memory* noalias readnone) local_unnamed_addr #1 {
entry:
...
block_.L_41602f:                                  ; preds = %block_.L_4160b1, %entry
  %68 = phi i64 [ %361, %block_.L_4160b1 ], [ %.pre, %entry ]
...
block_.L_41604d:                                  ; preds = %block_41605e, %block_41603f
  %111 = phi i64 [ %194, %block_41605e ], [ %.pre9, %block_41603f ]
...
block_41605e:                                     ; preds = %block_.L_41604d
  ...
  %call2_416069 = tail call %struct.Memory* @sub_40cba0._ZN15loop_inner_bodyILi5EiE7do_workERiPKii(%struct.State* nonnull %0, i64 %159, %struct.Memory* %call2_416023)
...
block_41608d:                                     ; preds = %block_.L_416081
  ...
  %call2_416098 = tail call %struct.Memory* @sub_40c100._Z18complete_hash_funcIiET_S0_(%struct.State* nonnull %0, i64 %246, %struct.Memory* %call2_416023)
...
block_.L_4160b1:                                  ; preds = %block_.L_416081
  ...
  %call2_4160b4 = tail call %struct.Memory* @sub_40c130._Z9check_sumIiEvT_(%struct.State* nonnull %0, i64 %325, %struct.Memory* %call2_416023)
...
block_.L_4160c7:                                  ; preds = %block_.L_41602f
  ...
  %call2_4160c7 = tail call %struct.Memory* @sub_400e20._Z5timerv(%struct.State* nonnull %0, i64 %362, %struct.Memory* %call2_416023)
