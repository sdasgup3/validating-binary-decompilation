...
block_.L_40b8bf:                                  ; preds = %block_.L_40b948, %entry
  %79 = phi i64 [ %.pre, %entry ], [ %345, %block_.L_40b948 ]
...
block_.L_40b912:                                  ; preds = %block_40b91e, %block_.L_40b90d
  %209 = phi i64 [ %208, %block_.L_40b90d ], [ %304, %block_40b91e ]
...
block_40b91e:                                     ; preds = %block_.L_40b912
  ...
  %call2_40b92b = tail call %struct.Memory* @sub_401480._Z18complete_hash_funcIdET_S0_(%struct.State* %0, i64 %259, %struct.Memory* %MEMORY.2)
...
block_.L_40b948:                                  ; preds = %block_.L_40b912
  ...
  %call2_40b94d = tail call %struct.Memory* @sub_4014b0._Z9check_sumIdEvT_(%struct.State* %0, i64 %309, %struct.Memory* %MEMORY.2)
...
block_.L_40b960:                                  ; preds = %block_.L_40b8bf
  ...
  %call2_40b960 = tail call %struct.Memory* @sub_400df0._Z5timerv(%struct.State* %0, i64 %346, %struct.Memory* %MEMORY.0)
  ...
  %call2_40b969 = tail call %struct.Memory* @sub_400790._Z13record_resultdPKc(%struct.State* %0, i64 %357, %struct.Memory* %call2_40b960)
