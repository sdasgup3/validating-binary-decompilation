...
define %struct.Memory* @_Z27test_for_loop_unroll_factorILi6EiEvPKT0_iPKc(%struct.State* noalias, i64, %struct.Memory* noalias) local_unnamed_addr #1 {
entry:
  ...
  %call2_415f03 = tail call %struct.Memory* @sub_400e00._Z11start_timerv(%struct.State* %0, i64 %58, %struct.Memory* %2)
  ...
  br label %block_.L_415f0f

block_.L_415f0f:                                  ; preds = %block_.L_415f91, %entry
  %68 = phi i64 [ %.pre, %entry ], [ %361, %block_.L_415f91 ]
  %MEMORY.0 = phi %struct.Memory* [ %call2_415f03, %entry ], [ %call2_415f94, %block_.L_415f91 ]
  ...
  br i1 %101, label %block_415f1f, label %block_.L_415fa7

block_415f1f:                                     ; preds = %block_.L_415f0f
  %103 = add i64 %69, -32
  %104 = add i64 %102, 7
  ...
  br label %block_.L_415f2d

block_.L_415f2d:                                  ; preds = %block_415f3e, %block_415f1f
  %111 = phi i64 [ %.pre9, %block_415f1f ], [ %194, %block_415f3e ]
  %MEMORY.1 = phi %struct.Memory* [ %MEMORY.0, %block_415f1f ], [ %call2_415f49, %block_415f3e ]
  ...
  br i1 %149, label %block_415f3e, label %block_.L_415f5c

block_415f3e:                                     ; preds = %block_.L_415f2d
  %151 = add i64 %112, -32
  ...
  %call2_415f49 = tail call %struct.Memory* @sub_40cb40._ZN15loop_inner_bodyILi6EiE7do_workERiPKii(%struct.State* nonnull %0, i64 %159, %struct.Memory* %MEMORY.1)
...
block_.L_415f5c:                                  ; preds = %block_.L_415f2d
  %195 = add i64 %150, 5
  br label %block_.L_415f61

block_.L_415f61:                                  ; preds = %block_415f6d, %block_.L_415f5c
  %196 = phi i64 [ %112, %block_.L_415f5c ], [ %.pre10, %block_415f6d ]
  %storemerge = phi i64 [ %195, %block_.L_415f5c ], [ %318, %block_415f6d ]
  %MEMORY.2 = phi %struct.Memory* [ %MEMORY.1, %block_.L_415f5c ], [ %call2_415f78, %block_415f6d ]
  %197 = add i64 %196, -36
  ...
  br i1 %231, label %block_415f6d, label %block_.L_415f91

block_415f6d:                                     ; preds = %block_.L_415f61
  %233 = add i64 %196, -8
  %234 = add i64 %232, 4
  ...
  %call2_415f78 = tail call %struct.Memory* @sub_40c100._Z18complete_hash_funcIiET_S0_(%struct.State* nonnull %0, i64 %246, %struct.Memory* %MEMORY.2)
...
block_.L_415f91:                                  ; preds = %block_.L_415f61
  %320 = add i64 %196, -32
  %321 = add i64 %232, 3
  ...
  %call2_415f94 = tail call %struct.Memory* @sub_40c130._Z9check_sumIiEvT_(%struct.State* nonnull %0, i64 %325, %struct.Memory* %MEMORY.2)
...
block_.L_415fa7:                                  ; preds = %block_.L_415f0f
  %362 = add i64 %102, -86407
  %363 = add i64 %102, 5
  ...
  %call2_415fa7 = tail call %struct.Memory* @sub_400e20._Z5timerv(%struct.State* nonnull %0, i64 %362, %struct.Memory* %MEMORY.0)
  ...
  %call2_415fb0 = tail call %struct.Memory* @sub_4007c0._Z13record_resultdPKc(%struct.State* nonnull %0, i64 %373, %struct.Memory* %call2_415fa7)
  ...
  ret %struct.Memory* %call2_415fb0
}
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_jge_.L_415fa7(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i8* nocapture %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_jge_.L_415f5c(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i8* nocapture %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 2, i32 9
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_jmpq_.L_415f2d(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_jmpq_.L_415f61(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_jge_.L_415f91(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i8* nocapture %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 2, i32 9
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_jmpq_.L_415f0f(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
