...
block_.L_415edf:                                  ; preds = %block_.L_415f61, %entry
  %68 = phi i64 [ %.pre, %entry ], [ %361, %block_.L_415f61 ]
...
block_.L_415f31:                                  ; preds = %block_415f3d, %block_.L_415f2c
  %196 = phi i64 [ %195, %block_.L_415f2c ], [ %319, %block_415f3d ]
...
block_.L_415f61:                                  ; preds = %block_.L_415f31
  ...
  %call2_415f64 = tail call %struct.Memory* @sub_40c100._Z9check_sumIiEvT_(%struct.State* %0, i64 %325, %struct.Memory* %MEMORY.2)
...
block_.L_415f77:                                  ; preds = %block_.L_415edf
  ...
  %call2_415f77 = tail call %struct.Memory* @sub_400df0._Z5timerv(%struct.State* %0, i64 %362, %struct.Memory* %MEMORY.0)
  ...
  %call2_415f80 = tail call %struct.Memory* @sub_400790._Z13record_resultdPKc(%struct.State* %0, i64 %373, %struct.Memory* %call2_415f77)
