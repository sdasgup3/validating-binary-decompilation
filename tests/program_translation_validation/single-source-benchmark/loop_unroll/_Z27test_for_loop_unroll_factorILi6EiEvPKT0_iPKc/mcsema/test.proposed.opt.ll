...
entry:
  ...
  %call2_415ed3 = tail call %struct.Memory* @sub_400dd0._Z11start_timerv(%struct.State* %0, i64 %58, %struct.Memory* %2)
  ...
  br label %block_.L_415edf

block_.L_415edf:                                  ; preds = %block_.L_415f61, %entry
  %68 = phi i64 [ %.pre, %entry ], [ %363, %block_.L_415f61 ]
  %MEMORY.0 = phi %struct.Memory* [ %call2_415ed3, %entry ], [ %call2_415f64, %block_.L_415f61 ]
  ...
  br i1 %101, label %block_415eef, label %block_.L_415f77

block_415eef:                                     ; preds = %block_.L_415edf
  %103 = add i64 %69, -32
  %104 = add i64 %102, 7
  ...
  br label %block_.L_415efd

block_.L_415efd:                                  ; preds = %block_415f0e, %block_415eef
  %111 = phi i64 [ %.pre1, %block_415eef ], [ %194, %block_415f0e ]
  %MEMORY.1 = phi %struct.Memory* [ %MEMORY.0, %block_415eef ], [ %call2_415f19, %block_415f0e ]
  ...
  br i1 %149, label %block_415f0e, label %block_.L_415f2c

block_415f0e:                                     ; preds = %block_.L_415efd
  %151 = add i64 %112, -32
  ...
  %call2_415f19 = tail call %struct.Memory* @sub_40cb10._ZN15loop_inner_bodyILi6EiE7do_workERiPKii(%struct.State* %0, i64 %159, %struct.Memory* %MEMORY.1)
...
block_.L_415f2c:                                  ; preds = %block_.L_415efd
  %195 = add i64 %150, 5
  store i64 %195, i64* %3, align 8
  br label %block_.L_415f31

block_.L_415f31:                                  ; preds = %block_415f3d, %block_.L_415f2c
  %196 = phi i64 [ %195, %block_.L_415f2c ], [ %320, %block_415f3d ]
  %197 = phi i64 [ %112, %block_.L_415f2c ], [ %.pre2, %block_415f3d ]
  %MEMORY.2 = phi %struct.Memory* [ %MEMORY.1, %block_.L_415f2c ], [ %call2_415f48, %block_415f3d ]
  %198 = add i64 %197, -36
  %199 = add i64 %196, 3
  ...
  br i1 %232, label %block_415f3d, label %block_.L_415f61

block_415f3d:                                     ; preds = %block_.L_415f31
  %234 = add i64 %197, -8
  %235 = add i64 %233, 4
  ...
  %call2_415f48 = tail call %struct.Memory* @sub_40c0d0._Z18complete_hash_funcIiET_S0_(%struct.State* %0, i64 %247, %struct.Memory* %MEMORY.2)
...
block_.L_415f61:                                  ; preds = %block_.L_415f31
  %321 = add i64 %197, -32
  %322 = add i64 %233, 3
  ...
  %call2_415f64 = tail call %struct.Memory* @sub_40c100._Z9check_sumIiEvT_(%struct.State* %0, i64 %326, %struct.Memory* %MEMORY.2)
...
block_.L_415f77:                                  ; preds = %block_.L_415edf
  %364 = add i64 %102, -86407
  %365 = add i64 %102, 5
  ...
  %call2_415f77 = tail call %struct.Memory* @sub_400df0._Z5timerv(%struct.State* %0, i64 %364, %struct.Memory* %MEMORY.0)
  ...
  %call2_415f80 = tail call %struct.Memory* @sub_400790._Z13record_resultdPKc(%struct.State* %0, i64 %375, %struct.Memory* %call2_415f77)
  ...
  ret %struct.Memory* %call2_415f80
}
...
define %struct.Memory* @routine_jge_.L_415f77(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i8* %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
...
define %struct.Memory* @routine_jge_.L_415f2c(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i8* %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 2, i32 9
...
define %struct.Memory* @routine_jmpq_.L_415efd(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
...
define %struct.Memory* @routine_jmpq_.L_415f31(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
...
define %struct.Memory* @routine_jge_.L_415f61(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i8* %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 2, i32 9
...
define %struct.Memory* @routine_jmpq_.L_415edf(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
