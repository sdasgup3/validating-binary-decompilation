...
define %struct.Memory* @_Z27test_for_loop_unroll_factorILi6EiEvPKT0_iPKc(%struct.State* noalias, i64, %struct.Memory* noalias readnone) local_unnamed_addr #1 {
entry:
...
block_.L_415f0f:                                  ; preds = %block_.L_415f91, %entry
  %68 = phi i64 [ %361, %block_.L_415f91 ], [ %.pre, %entry ]
...
block_.L_415f2d:                                  ; preds = %block_415f3e, %block_415f1f
  %111 = phi i64 [ %194, %block_415f3e ], [ %.pre9, %block_415f1f ]
...
block_415f3e:                                     ; preds = %block_.L_415f2d
  ...
  %call2_415f49 = tail call %struct.Memory* @sub_40cb40._ZN15loop_inner_bodyILi6EiE7do_workERiPKii(%struct.State* nonnull %0, i64 %159, %struct.Memory* %call2_415f03)
...
block_415f6d:                                     ; preds = %block_.L_415f61
  ...
  %call2_415f78 = tail call %struct.Memory* @sub_40c100._Z18complete_hash_funcIiET_S0_(%struct.State* nonnull %0, i64 %246, %struct.Memory* %call2_415f03)
...
block_.L_415f91:                                  ; preds = %block_.L_415f61
  ...
  %call2_415f94 = tail call %struct.Memory* @sub_40c130._Z9check_sumIiEvT_(%struct.State* nonnull %0, i64 %325, %struct.Memory* %call2_415f03)
...
block_.L_415fa7:                                  ; preds = %block_.L_415f0f
  ...
  %call2_415fa7 = tail call %struct.Memory* @sub_400e20._Z5timerv(%struct.State* nonnull %0, i64 %362, %struct.Memory* %call2_415f03)
