...
define %struct.Memory* @_Z27test_for_loop_unroll_factorILi7EdEvPKT0_iPKc(%struct.State* noalias, i64, %struct.Memory* noalias) #1 {
entry:
  ...
  store %struct.Memory* %loadMem1_40b7b3, %struct.Memory** %MEMORY
...
block_.L_40b7bf:                                  ; preds = %block_.L_40b848, %entry
  ...
  store %struct.Memory* %loadMem_40b7c2, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_40b7c9, %struct.Memory** %MEMORY
...
block_40b7cf:                                     ; preds = %block_.L_40b7bf
...
block_.L_40b7de:                                  ; preds = %block_40b7ef, %block_40b7cf
  ...
  store %struct.Memory* %loadMem_40b7e1, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_40b7e4, %struct.Memory** %MEMORY
...
block_40b7ef:                                     ; preds = %block_.L_40b7de
  ...
  store %struct.Memory* %loadMem1_40b7fa, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_40b808, %struct.Memory** %MEMORY
  br label %block_.L_40b7de

block_.L_40b80d:                                  ; preds = %block_.L_40b7de
...
block_.L_40b812:                                  ; preds = %block_40b81e, %block_.L_40b80d
...
block_40b81e:                                     ; preds = %block_.L_40b812
  ...
  store %struct.Memory* %loadMem1_40b82b, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_40b830, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_40b83a, %struct.Memory** %MEMORY
...
block_.L_40b848:                                  ; preds = %block_.L_40b812
  ...
  store %struct.Memory* %loadMem_40b848, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem1_40b84d, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_40b852, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_40b855, %struct.Memory** %MEMORY
...
block_.L_40b860:                                  ; preds = %block_.L_40b7bf
  ...
  store %struct.Memory* %loadMem1_40b860, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem1_40b869, %struct.Memory** %MEMORY
  ...
  ret %struct.Memory* %loadMem_40b873
}
