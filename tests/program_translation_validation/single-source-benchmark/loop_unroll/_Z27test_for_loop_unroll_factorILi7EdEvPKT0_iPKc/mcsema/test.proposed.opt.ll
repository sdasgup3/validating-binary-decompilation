...
block_.L_40b78f:                                  ; preds = %block_.L_40b818, %entry
  %79 = phi i64 [ %.pre, %entry ], [ %345, %block_.L_40b818 ]
...
block_.L_40b7e2:                                  ; preds = %block_40b7ee, %block_.L_40b7dd
  %209 = phi i64 [ %208, %block_.L_40b7dd ], [ %304, %block_40b7ee ]
...
block_40b7ee:                                     ; preds = %block_.L_40b7e2
  ...
  %call2_40b7fb = tail call %struct.Memory* @sub_401480._Z18complete_hash_funcIdET_S0_(%struct.State* %0, i64 %259, %struct.Memory* %MEMORY.2)
...
block_.L_40b818:                                  ; preds = %block_.L_40b7e2
  ...
  %call2_40b81d = tail call %struct.Memory* @sub_4014b0._Z9check_sumIdEvT_(%struct.State* %0, i64 %309, %struct.Memory* %MEMORY.2)
...
block_.L_40b830:                                  ; preds = %block_.L_40b78f
  ...
  %call2_40b830 = tail call %struct.Memory* @sub_400df0._Z5timerv(%struct.State* %0, i64 %346, %struct.Memory* %MEMORY.0)
  ...
  %call2_40b839 = tail call %struct.Memory* @sub_400790._Z13record_resultdPKc(%struct.State* %0, i64 %357, %struct.Memory* %call2_40b830)
