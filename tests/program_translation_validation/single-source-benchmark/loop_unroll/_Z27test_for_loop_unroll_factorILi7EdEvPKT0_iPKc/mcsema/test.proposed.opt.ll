...
entry:
  ...
  %call2_40b7c3 = tail call %struct.Memory* @sub_400e10._Z11start_timerv(%struct.State* %0, i64 %58, %struct.Memory* %2)
...
block_.L_40b7cf:                                  ; preds = %block_.L_40b858, %entry
  %74 = phi i64 [ %340, %block_.L_40b858 ], [ %.pre, %entry ]
  ...
  br i1 %107, label %block_40b7df, label %block_.L_40b870
...
block_.L_40b7ee:                                  ; preds = %block_40b7ff, %block_40b7df
  %118 = phi i64 [ %201, %block_40b7ff ], [ %.pre9, %block_40b7df ]
  ...
  br i1 %156, label %block_40b7ff, label %block_.L_40b81d
...
block_40b7ff:                                     ; preds = %block_.L_40b7ee
  ...
  %call2_40b80a = tail call %struct.Memory* @sub_401f30._ZN15loop_inner_bodyILi7EdE7do_workERdPKdi(%struct.State* nonnull %0, i64 %166, %struct.Memory* %call2_40b7c3)
...
block_.L_40b822:                                  ; preds = %block_40b82e, %block_.L_40b81d
  %203 = phi i64 [ %119, %block_.L_40b81d ], [ %.pre10, %block_40b82e ]
  %storemerge = phi i64 [ %202, %block_.L_40b81d ], [ %298, %block_40b82e ]
  %204 = add i64 %203, -44
  ...
  br i1 %238, label %block_40b82e, label %block_.L_40b858
...
block_40b82e:                                     ; preds = %block_.L_40b822
  ...
  %call2_40b83b = tail call %struct.Memory* @sub_4014c0._Z18complete_hash_funcIdET_S0_(%struct.State* nonnull %0, i64 %252, %struct.Memory* %call2_40b7c3)
...
block_.L_40b858:                                  ; preds = %block_.L_40b822
  ...
  %call2_40b85d = tail call %struct.Memory* @sub_4014f0._Z9check_sumIdEvT_(%struct.State* nonnull %0, i64 %304, %struct.Memory* %call2_40b7c3)
...
block_.L_40b870:                                  ; preds = %block_.L_40b7cf
  ...
  %call2_40b870 = tail call %struct.Memory* @sub_400e30._Z5timerv(%struct.State* nonnull %0, i64 %341, %struct.Memory* %call2_40b7c3)
  ...
  %call2_40b879 = tail call %struct.Memory* @sub_4007d0._Z13record_resultdPKc(%struct.State* nonnull %0, i64 %352, %struct.Memory* %call2_40b870)
