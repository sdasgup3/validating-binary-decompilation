...
define %struct.Memory* @_Z27test_for_loop_unroll_factorILi7EdEvPKT0_iPKc(%struct.State* noalias, i64, %struct.Memory* noalias readnone) local_unnamed_addr #1 {
entry:
...
block_.L_40b7bf:                                  ; preds = %block_.L_40b848, %entry
  %74 = phi i64 [ %340, %block_.L_40b848 ], [ %.pre, %entry ]
...
block_.L_40b7de:                                  ; preds = %block_40b7ef, %block_40b7cf
  %118 = phi i64 [ %201, %block_40b7ef ], [ %.pre9, %block_40b7cf ]
...
block_40b7ef:                                     ; preds = %block_.L_40b7de
  ...
  %call2_40b7fa = tail call %struct.Memory* @sub_401f20._ZN15loop_inner_bodyILi7EdE7do_workERdPKdi(%struct.State* nonnull %0, i64 %166, %struct.Memory* %call2_40b7b3)
...
block_40b81e:                                     ; preds = %block_.L_40b812
  ...
  %call2_40b82b = tail call %struct.Memory* @sub_4014b0._Z18complete_hash_funcIdET_S0_(%struct.State* nonnull %0, i64 %252, %struct.Memory* %call2_40b7b3)
...
block_.L_40b848:                                  ; preds = %block_.L_40b812
  ...
  %call2_40b84d = tail call %struct.Memory* @sub_4014e0._Z9check_sumIdEvT_(%struct.State* nonnull %0, i64 %304, %struct.Memory* %call2_40b7b3)
...
block_.L_40b860:                                  ; preds = %block_.L_40b7bf
  ...
  %call2_40b860 = tail call %struct.Memory* @sub_400e20._Z5timerv(%struct.State* nonnull %0, i64 %341, %struct.Memory* %call2_40b7b3)
