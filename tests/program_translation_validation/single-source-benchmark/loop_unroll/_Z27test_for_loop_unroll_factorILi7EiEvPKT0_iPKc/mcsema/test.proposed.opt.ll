...
define %struct.Memory* @_Z27test_for_loop_unroll_factorILi7EiEvPKT0_iPKc(%struct.State* noalias, i64, %struct.Memory* noalias readnone) local_unnamed_addr #1 {
entry:
...
block_.L_415def:                                  ; preds = %block_.L_415e71, %entry
  %68 = phi i64 [ %361, %block_.L_415e71 ], [ %.pre, %entry ]
...
block_.L_415e0d:                                  ; preds = %block_415e1e, %block_415dff
  %111 = phi i64 [ %194, %block_415e1e ], [ %.pre9, %block_415dff ]
...
block_415e1e:                                     ; preds = %block_.L_415e0d
  ...
  %call2_415e29 = tail call %struct.Memory* @sub_40cae0._ZN15loop_inner_bodyILi7EiE7do_workERiPKii(%struct.State* nonnull %0, i64 %159, %struct.Memory* %call2_415de3)
...
block_415e4d:                                     ; preds = %block_.L_415e41
  ...
  %call2_415e58 = tail call %struct.Memory* @sub_40c100._Z18complete_hash_funcIiET_S0_(%struct.State* nonnull %0, i64 %246, %struct.Memory* %call2_415de3)
...
block_.L_415e71:                                  ; preds = %block_.L_415e41
  ...
  %call2_415e74 = tail call %struct.Memory* @sub_40c130._Z9check_sumIiEvT_(%struct.State* nonnull %0, i64 %325, %struct.Memory* %call2_415de3)
...
block_.L_415e87:                                  ; preds = %block_.L_415def
  ...
  %call2_415e87 = tail call %struct.Memory* @sub_400e20._Z5timerv(%struct.State* nonnull %0, i64 %362, %struct.Memory* %call2_415de3)
