...
block_.L_415dbf:                                  ; preds = %block_.L_415e41, %entry
  %68 = phi i64 [ %.pre, %entry ], [ %361, %block_.L_415e41 ]
...
block_.L_415e11:                                  ; preds = %block_415e1d, %block_.L_415e0c
  %196 = phi i64 [ %195, %block_.L_415e0c ], [ %319, %block_415e1d ]
...
block_.L_415e41:                                  ; preds = %block_.L_415e11
  ...
  %call2_415e44 = tail call %struct.Memory* @sub_40c100._Z9check_sumIiEvT_(%struct.State* %0, i64 %325, %struct.Memory* %MEMORY.2)
...
block_.L_415e57:                                  ; preds = %block_.L_415dbf
  ...
  %call2_415e57 = tail call %struct.Memory* @sub_400df0._Z5timerv(%struct.State* %0, i64 %362, %struct.Memory* %MEMORY.0)
  ...
  %call2_415e60 = tail call %struct.Memory* @sub_400790._Z13record_resultdPKc(%struct.State* %0, i64 %373, %struct.Memory* %call2_415e57)
