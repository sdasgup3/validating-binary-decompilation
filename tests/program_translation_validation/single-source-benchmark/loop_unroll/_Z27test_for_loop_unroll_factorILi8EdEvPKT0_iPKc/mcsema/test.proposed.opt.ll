...
block_.L_40b65f:                                  ; preds = %block_.L_40b6e8, %entry
  %79 = phi i64 [ %.pre, %entry ], [ %345, %block_.L_40b6e8 ]
...
block_.L_40b6b2:                                  ; preds = %block_40b6be, %block_.L_40b6ad
  %209 = phi i64 [ %208, %block_.L_40b6ad ], [ %304, %block_40b6be ]
...
block_40b6be:                                     ; preds = %block_.L_40b6b2
  ...
  %call2_40b6cb = tail call %struct.Memory* @sub_401480._Z18complete_hash_funcIdET_S0_(%struct.State* %0, i64 %259, %struct.Memory* %MEMORY.2)
...
block_.L_40b6e8:                                  ; preds = %block_.L_40b6b2
  ...
  %call2_40b6ed = tail call %struct.Memory* @sub_4014b0._Z9check_sumIdEvT_(%struct.State* %0, i64 %309, %struct.Memory* %MEMORY.2)
...
block_.L_40b700:                                  ; preds = %block_.L_40b65f
  ...
  %call2_40b700 = tail call %struct.Memory* @sub_400df0._Z5timerv(%struct.State* %0, i64 %346, %struct.Memory* %MEMORY.0)
  ...
  %call2_40b709 = tail call %struct.Memory* @sub_400790._Z13record_resultdPKc(%struct.State* %0, i64 %357, %struct.Memory* %call2_40b700)
