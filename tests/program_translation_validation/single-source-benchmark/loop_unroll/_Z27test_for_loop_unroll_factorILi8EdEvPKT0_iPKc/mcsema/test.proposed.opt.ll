...
entry:
  ...
  %call2_40b653 = tail call %struct.Memory* @sub_400dd0._Z11start_timerv(%struct.State* %0, i64 %58, %struct.Memory* %2)
...
block_.L_40b65f:                                  ; preds = %block_.L_40b6e8, %entry
  %79 = phi i64 [ %.pre, %entry ], [ %349, %block_.L_40b6e8 ]
  %MEMORY.0 = phi %struct.Memory* [ %call2_40b653, %entry ], [ %call2_40b6ed, %block_.L_40b6e8 ]
  ...
  br i1 %112, label %block_40b66f, label %block_.L_40b700
...
block_.L_40b67e:                                  ; preds = %block_40b68f, %block_40b66f
  %124 = phi i64 [ %.pre1, %block_40b66f ], [ %207, %block_40b68f ]
  %MEMORY.1 = phi %struct.Memory* [ %MEMORY.0, %block_40b66f ], [ %call2_40b69a, %block_40b68f ]
  ...
  br i1 %162, label %block_40b68f, label %block_.L_40b6ad
...
block_40b68f:                                     ; preds = %block_.L_40b67e
  ...
  %call2_40b69a = tail call %struct.Memory* @sub_401e90._ZN15loop_inner_bodyILi8EdE7do_workERdPKdi(%struct.State* %0, i64 %172, %struct.Memory* %MEMORY.1)
...
block_.L_40b6b2:                                  ; preds = %block_40b6be, %block_.L_40b6ad
  %209 = phi i64 [ %208, %block_.L_40b6ad ], [ %306, %block_40b6be ]
  %210 = phi i64 [ %125, %block_.L_40b6ad ], [ %.pre2, %block_40b6be ]
  %MEMORY.2 = phi %struct.Memory* [ %MEMORY.1, %block_.L_40b6ad ], [ %call2_40b6cb, %block_40b6be ]
  %211 = add i64 %210, -44
  %212 = add i64 %209, 3
  ...
  br i1 %245, label %block_40b6be, label %block_.L_40b6e8
...
block_40b6be:                                     ; preds = %block_.L_40b6b2
  ...
  %call2_40b6cb = tail call %struct.Memory* @sub_401480._Z18complete_hash_funcIdET_S0_(%struct.State* %0, i64 %260, %struct.Memory* %MEMORY.2)
...
block_.L_40b6e8:                                  ; preds = %block_.L_40b6b2
  ...
  %call2_40b6ed = tail call %struct.Memory* @sub_4014b0._Z9check_sumIdEvT_(%struct.State* %0, i64 %312, %struct.Memory* %MEMORY.2)
...
block_.L_40b700:                                  ; preds = %block_.L_40b65f
  ...
  %call2_40b700 = tail call %struct.Memory* @sub_400df0._Z5timerv(%struct.State* %0, i64 %350, %struct.Memory* %MEMORY.0)
  ...
  %call2_40b709 = tail call %struct.Memory* @sub_400790._Z13record_resultdPKc(%struct.State* %0, i64 %361, %struct.Memory* %call2_40b700)
  ...
  ret %struct.Memory* %call2_40b709
}
...
define %struct.Memory* @routine_jge_.L_40b700(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i8* %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
...
define %struct.Memory* @routine_jge_.L_40b6ad(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i8* %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 2, i32 9
...
define %struct.Memory* @routine_jmpq_.L_40b67e(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
...
define %struct.Memory* @routine_jmpq_.L_40b6b2(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
...
define %struct.Memory* @routine_jge_.L_40b6e8(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i8* %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 2, i32 9
...
define %struct.Memory* @routine_jmpq_.L_40b65f(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
