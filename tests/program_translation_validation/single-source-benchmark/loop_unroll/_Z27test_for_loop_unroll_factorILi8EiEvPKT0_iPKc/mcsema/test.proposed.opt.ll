...
declare %struct.Memory* @sub_40ca80._ZN15loop_inner_bodyILi8EiE7do_workERiPKii(%struct.State* noalias dereferenceable(3376), i64, %struct.Memory* noalias readnone returned) local_unnamed_addr
...
define %struct.Memory* @_Z27test_for_loop_unroll_factorILi8EiEvPKT0_iPKc(%struct.State* noalias, i64, %struct.Memory* noalias readnone) local_unnamed_addr #1 {
entry:
...
block_.L_415ccf:                                  ; preds = %block_.L_415d51, %entry
  %68 = phi i64 [ %361, %block_.L_415d51 ], [ %.pre, %entry ]
...
block_.L_415ced:                                  ; preds = %block_415cfe, %block_415cdf
  %111 = phi i64 [ %194, %block_415cfe ], [ %.pre9, %block_415cdf ]
...
block_415cfe:                                     ; preds = %block_.L_415ced
  ...
  %call2_415d09 = tail call %struct.Memory* @sub_40ca80._ZN15loop_inner_bodyILi8EiE7do_workERiPKii(%struct.State* nonnull %0, i64 %159, %struct.Memory* %call2_415cc3)
...
block_415d2d:                                     ; preds = %block_.L_415d21
  ...
  %call2_415d38 = tail call %struct.Memory* @sub_40c100._Z18complete_hash_funcIiET_S0_(%struct.State* nonnull %0, i64 %246, %struct.Memory* %call2_415cc3)
...
block_.L_415d51:                                  ; preds = %block_.L_415d21
  ...
  %call2_415d54 = tail call %struct.Memory* @sub_40c130._Z9check_sumIiEvT_(%struct.State* nonnull %0, i64 %325, %struct.Memory* %call2_415cc3)
...
block_.L_415d67:                                  ; preds = %block_.L_415ccf
  ...
  %call2_415d67 = tail call %struct.Memory* @sub_400e20._Z5timerv(%struct.State* nonnull %0, i64 %362, %struct.Memory* %call2_415cc3)
