...
block_.L_415c9f:                                  ; preds = %block_.L_415d21, %entry
  %68 = phi i64 [ %.pre, %entry ], [ %361, %block_.L_415d21 ]
...
block_.L_415cf1:                                  ; preds = %block_415cfd, %block_.L_415cec
  %196 = phi i64 [ %195, %block_.L_415cec ], [ %319, %block_415cfd ]
...
block_.L_415d21:                                  ; preds = %block_.L_415cf1
  ...
  %call2_415d24 = tail call %struct.Memory* @sub_40c100._Z9check_sumIiEvT_(%struct.State* %0, i64 %325, %struct.Memory* %MEMORY.2)
...
block_.L_415d37:                                  ; preds = %block_.L_415c9f
  ...
  %call2_415d37 = tail call %struct.Memory* @sub_400df0._Z5timerv(%struct.State* %0, i64 %362, %struct.Memory* %MEMORY.0)
  ...
  %call2_415d40 = tail call %struct.Memory* @sub_400790._Z13record_resultdPKc(%struct.State* %0, i64 %373, %struct.Memory* %call2_415d37)
