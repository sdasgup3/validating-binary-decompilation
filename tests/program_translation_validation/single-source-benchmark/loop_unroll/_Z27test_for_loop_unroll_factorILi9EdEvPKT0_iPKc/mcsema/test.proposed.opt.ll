...
define %struct.Memory* @_Z27test_for_loop_unroll_factorILi9EdEvPKT0_iPKc(%struct.State* noalias, i64, %struct.Memory* noalias readnone) local_unnamed_addr #1 {
entry:
...
block_.L_40b55f:                                  ; preds = %block_.L_40b5e8, %entry
  %74 = phi i64 [ %340, %block_.L_40b5e8 ], [ %.pre, %entry ]
...
block_.L_40b57e:                                  ; preds = %block_40b58f, %block_40b56f
  %118 = phi i64 [ %201, %block_40b58f ], [ %.pre9, %block_40b56f ]
...
block_40b58f:                                     ; preds = %block_.L_40b57e
  ...
  %call2_40b59a = tail call %struct.Memory* @sub_401e60._ZN15loop_inner_bodyILi9EdE7do_workERdPKdi(%struct.State* nonnull %0, i64 %166, %struct.Memory* %call2_40b553)
...
block_40b5be:                                     ; preds = %block_.L_40b5b2
  ...
  %call2_40b5cb = tail call %struct.Memory* @sub_4014b0._Z18complete_hash_funcIdET_S0_(%struct.State* nonnull %0, i64 %252, %struct.Memory* %call2_40b553)
...
block_.L_40b5e8:                                  ; preds = %block_.L_40b5b2
  ...
  %call2_40b5ed = tail call %struct.Memory* @sub_4014e0._Z9check_sumIdEvT_(%struct.State* nonnull %0, i64 %304, %struct.Memory* %call2_40b553)
...
block_.L_40b600:                                  ; preds = %block_.L_40b55f
  ...
  %call2_40b600 = tail call %struct.Memory* @sub_400e20._Z5timerv(%struct.State* nonnull %0, i64 %341, %struct.Memory* %call2_40b553)
