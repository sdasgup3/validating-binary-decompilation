...
entry:
  ...
  %call2_40b563 = tail call %struct.Memory* @sub_400e10._Z11start_timerv(%struct.State* %0, i64 %58, %struct.Memory* %2)
...
block_.L_40b56f:                                  ; preds = %block_.L_40b5f8, %entry
  %74 = phi i64 [ %340, %block_.L_40b5f8 ], [ %.pre, %entry ]
  ...
  br i1 %107, label %block_40b57f, label %block_.L_40b610

block_40b57f:                                     ; preds = %block_.L_40b56f
...
block_.L_40b58e:                                  ; preds = %block_40b59f, %block_40b57f
  %118 = phi i64 [ %201, %block_40b59f ], [ %.pre9, %block_40b57f ]
  ...
  br i1 %156, label %block_40b59f, label %block_.L_40b5bd

block_40b59f:                                     ; preds = %block_.L_40b58e
  %158 = add i64 %119, -40
  ...
  %call2_40b5aa = tail call %struct.Memory* @sub_401e70._ZN15loop_inner_bodyILi9EdE7do_workERdPKdi(%struct.State* nonnull %0, i64 %166, %struct.Memory* %call2_40b563)
...
block_.L_40b5bd:                                  ; preds = %block_.L_40b58e
  %202 = add i64 %157, 5
  br label %block_.L_40b5c2

block_.L_40b5c2:                                  ; preds = %block_40b5ce, %block_.L_40b5bd
  %203 = phi i64 [ %119, %block_.L_40b5bd ], [ %.pre10, %block_40b5ce ]
  %storemerge = phi i64 [ %202, %block_.L_40b5bd ], [ %298, %block_40b5ce ]
  %204 = add i64 %203, -44
  ...
  br i1 %238, label %block_40b5ce, label %block_.L_40b5f8
...
block_40b5ce:                                     ; preds = %block_.L_40b5c2
  ...
  %call2_40b5db = tail call %struct.Memory* @sub_4014c0._Z18complete_hash_funcIdET_S0_(%struct.State* nonnull %0, i64 %252, %struct.Memory* %call2_40b563)
...
block_.L_40b5f8:                                  ; preds = %block_.L_40b5c2
  ...
  %call2_40b5fd = tail call %struct.Memory* @sub_4014f0._Z9check_sumIdEvT_(%struct.State* nonnull %0, i64 %304, %struct.Memory* %call2_40b563)
...
block_.L_40b610:                                  ; preds = %block_.L_40b56f
  ...
  %call2_40b610 = tail call %struct.Memory* @sub_400e30._Z5timerv(%struct.State* nonnull %0, i64 %341, %struct.Memory* %call2_40b563)
  ...
  %call2_40b619 = tail call %struct.Memory* @sub_4007d0._Z13record_resultdPKc(%struct.State* nonnull %0, i64 %352, %struct.Memory* %call2_40b610)
