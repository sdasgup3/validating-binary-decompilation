...
block_.L_40b52f:                                  ; preds = %block_.L_40b5b8, %entry
  %79 = phi i64 [ %.pre, %entry ], [ %345, %block_.L_40b5b8 ]
...
block_.L_40b582:                                  ; preds = %block_40b58e, %block_.L_40b57d
  %209 = phi i64 [ %208, %block_.L_40b57d ], [ %304, %block_40b58e ]
...
block_40b58e:                                     ; preds = %block_.L_40b582
  ...
  %call2_40b59b = tail call %struct.Memory* @sub_401480._Z18complete_hash_funcIdET_S0_(%struct.State* %0, i64 %259, %struct.Memory* %MEMORY.2)
...
block_.L_40b5b8:                                  ; preds = %block_.L_40b582
  ...
  %call2_40b5bd = tail call %struct.Memory* @sub_4014b0._Z9check_sumIdEvT_(%struct.State* %0, i64 %309, %struct.Memory* %MEMORY.2)
...
block_.L_40b5d0:                                  ; preds = %block_.L_40b52f
  ...
  %call2_40b5d0 = tail call %struct.Memory* @sub_400df0._Z5timerv(%struct.State* %0, i64 %346, %struct.Memory* %MEMORY.0)
  ...
  %call2_40b5d9 = tail call %struct.Memory* @sub_400790._Z13record_resultdPKc(%struct.State* %0, i64 %357, %struct.Memory* %call2_40b5d0)
