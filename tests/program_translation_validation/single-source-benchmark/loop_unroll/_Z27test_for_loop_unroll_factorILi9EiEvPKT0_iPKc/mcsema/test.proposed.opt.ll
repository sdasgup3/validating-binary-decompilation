...
block_.L_415baf:                                  ; preds = %block_.L_415c31, %entry
  %68 = phi i64 [ %.pre, %entry ], [ %361, %block_.L_415c31 ]
  %MEMORY.0 = phi %struct.Memory* [ %call2_415ba3, %entry ], [ %call2_415c34, %block_.L_415c31 ]
...
block_.L_415bcd:                                  ; preds = %block_415bde, %block_415bbf
  %111 = phi i64 [ %.pre9, %block_415bbf ], [ %194, %block_415bde ]
  %MEMORY.1 = phi %struct.Memory* [ %MEMORY.0, %block_415bbf ], [ %call2_415be9, %block_415bde ]
...
block_415bde:                                     ; preds = %block_.L_415bcd
  ...
  %call2_415be9 = tail call %struct.Memory* @sub_40ca20._ZN15loop_inner_bodyILi9EiE7do_workERiPKii(%struct.State* nonnull %0, i64 %159, %struct.Memory* %MEMORY.1)
...
block_.L_415c01:                                  ; preds = %block_415c0d, %block_.L_415bfc
  ...
  %MEMORY.2 = phi %struct.Memory* [ %MEMORY.1, %block_.L_415bfc ], [ %call2_415c18, %block_415c0d ]
  %197 = add i64 %196, -36
...
block_415c0d:                                     ; preds = %block_.L_415c01
  ...
  %call2_415c18 = tail call %struct.Memory* @sub_40c100._Z18complete_hash_funcIiET_S0_(%struct.State* nonnull %0, i64 %246, %struct.Memory* %MEMORY.2)
...
block_.L_415c31:                                  ; preds = %block_.L_415c01
  ...
  %call2_415c34 = tail call %struct.Memory* @sub_40c130._Z9check_sumIiEvT_(%struct.State* nonnull %0, i64 %325, %struct.Memory* %MEMORY.2)
...
block_.L_415c47:                                  ; preds = %block_.L_415baf
  ...
  %call2_415c47 = tail call %struct.Memory* @sub_400e20._Z5timerv(%struct.State* nonnull %0, i64 %362, %struct.Memory* %MEMORY.0)
