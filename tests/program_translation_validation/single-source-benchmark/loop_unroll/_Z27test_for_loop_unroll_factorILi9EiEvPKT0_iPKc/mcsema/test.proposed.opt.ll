...
define %struct.Memory* @_Z27test_for_loop_unroll_factorILi9EiEvPKT0_iPKc(%struct.State* noalias, i64, %struct.Memory* noalias) local_unnamed_addr #1 {
entry:
  ...
  %call2_415b73 = tail call %struct.Memory* @sub_400dd0._Z11start_timerv(%struct.State* %0, i64 %58, %struct.Memory* %2)
...
block_.L_415b7f:                                  ; preds = %block_.L_415c01, %entry
  %68 = phi i64 [ %.pre, %entry ], [ %363, %block_.L_415c01 ]
  %MEMORY.0 = phi %struct.Memory* [ %call2_415b73, %entry ], [ %call2_415c04, %block_.L_415c01 ]
  ...
  br i1 %101, label %block_415b8f, label %block_.L_415c17
...
block_.L_415b9d:                                  ; preds = %block_415bae, %block_415b8f
  %111 = phi i64 [ %.pre1, %block_415b8f ], [ %194, %block_415bae ]
  %MEMORY.1 = phi %struct.Memory* [ %MEMORY.0, %block_415b8f ], [ %call2_415bb9, %block_415bae ]
  ...
  br i1 %149, label %block_415bae, label %block_.L_415bcc
...
block_415bae:                                     ; preds = %block_.L_415b9d
  ...
  %call2_415bb9 = tail call %struct.Memory* @sub_40c9f0._ZN15loop_inner_bodyILi9EiE7do_workERiPKii(%struct.State* %0, i64 %159, %struct.Memory* %MEMORY.1)
...
block_.L_415bd1:                                  ; preds = %block_415bdd, %block_.L_415bcc
  %196 = phi i64 [ %195, %block_.L_415bcc ], [ %320, %block_415bdd ]
  %197 = phi i64 [ %112, %block_.L_415bcc ], [ %.pre2, %block_415bdd ]
  %MEMORY.2 = phi %struct.Memory* [ %MEMORY.1, %block_.L_415bcc ], [ %call2_415be8, %block_415bdd ]
  %198 = add i64 %197, -36
  %199 = add i64 %196, 3
  ...
  br i1 %232, label %block_415bdd, label %block_.L_415c01
...
block_415bdd:                                     ; preds = %block_.L_415bd1
  ...
  %call2_415be8 = tail call %struct.Memory* @sub_40c0d0._Z18complete_hash_funcIiET_S0_(%struct.State* %0, i64 %247, %struct.Memory* %MEMORY.2)
...
block_.L_415c01:                                  ; preds = %block_.L_415bd1
  ...
  %call2_415c04 = tail call %struct.Memory* @sub_40c100._Z9check_sumIiEvT_(%struct.State* %0, i64 %326, %struct.Memory* %MEMORY.2)
...
block_.L_415c17:                                  ; preds = %block_.L_415b7f
  ...
  %call2_415c17 = tail call %struct.Memory* @sub_400df0._Z5timerv(%struct.State* %0, i64 %364, %struct.Memory* %MEMORY.0)
  ...
  %call2_415c20 = tail call %struct.Memory* @sub_400790._Z13record_resultdPKc(%struct.State* %0, i64 %375, %struct.Memory* %call2_415c17)
  ...
  ret %struct.Memory* %call2_415c20
}
...
define %struct.Memory* @routine_jge_.L_415c17(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i8* %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
...
define %struct.Memory* @routine_jge_.L_415bcc(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i8* %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 2, i32 9
...
define %struct.Memory* @routine_jmpq_.L_415b9d(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
...
define %struct.Memory* @routine_jmpq_.L_415bd1(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
...
define %struct.Memory* @routine_jge_.L_415c01(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i8* %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 2, i32 9
...
define %struct.Memory* @routine_jmpq_.L_415b7f(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
