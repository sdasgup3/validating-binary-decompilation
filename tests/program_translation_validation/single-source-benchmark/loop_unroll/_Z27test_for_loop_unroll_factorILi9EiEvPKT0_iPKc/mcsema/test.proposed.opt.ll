...
block_.L_415b7f:                                  ; preds = %block_.L_415c01, %entry
  %68 = phi i64 [ %.pre, %entry ], [ %361, %block_.L_415c01 ]
...
block_.L_415bd1:                                  ; preds = %block_415bdd, %block_.L_415bcc
  %196 = phi i64 [ %195, %block_.L_415bcc ], [ %319, %block_415bdd ]
...
block_.L_415c01:                                  ; preds = %block_.L_415bd1
  ...
  %call2_415c04 = tail call %struct.Memory* @sub_40c100._Z9check_sumIiEvT_(%struct.State* %0, i64 %325, %struct.Memory* %MEMORY.2)
...
block_.L_415c17:                                  ; preds = %block_.L_415b7f
  ...
  %call2_415c17 = tail call %struct.Memory* @sub_400df0._Z5timerv(%struct.State* %0, i64 %362, %struct.Memory* %MEMORY.0)
  ...
  %call2_415c20 = tail call %struct.Memory* @sub_400790._Z13record_resultdPKc(%struct.State* %0, i64 %373, %struct.Memory* %call2_415c17)
