...
entry:
  ...
  %call2_415bb3 = tail call %struct.Memory* @sub_400e10._Z11start_timerv(%struct.State* %0, i64 %58, %struct.Memory* %2)
...
block_.L_415bbf:                                  ; preds = %block_.L_415c41, %entry
  %68 = phi i64 [ %361, %block_.L_415c41 ], [ %.pre, %entry ]
  ...
  br i1 %101, label %block_415bcf, label %block_.L_415c57
...
block_.L_415bdd:                                  ; preds = %block_415bee, %block_415bcf
  %111 = phi i64 [ %194, %block_415bee ], [ %.pre9, %block_415bcf ]
  ...
  br i1 %149, label %block_415bee, label %block_.L_415c0c
...
block_415bee:                                     ; preds = %block_.L_415bdd
  ...
  %call2_415bf9 = tail call %struct.Memory* @sub_40ca30._ZN15loop_inner_bodyILi9EiE7do_workERiPKii(%struct.State* nonnull %0, i64 %159, %struct.Memory* %call2_415bb3)
...
block_.L_415c11:                                  ; preds = %block_415c1d, %block_.L_415c0c
  %196 = phi i64 [ %112, %block_.L_415c0c ], [ %.pre10, %block_415c1d ]
  %storemerge = phi i64 [ %195, %block_.L_415c0c ], [ %318, %block_415c1d ]
  %197 = add i64 %196, -36
  ...
  br i1 %231, label %block_415c1d, label %block_.L_415c41
...
block_415c1d:                                     ; preds = %block_.L_415c11
  ...
  %call2_415c28 = tail call %struct.Memory* @sub_40c110._Z18complete_hash_funcIiET_S0_(%struct.State* nonnull %0, i64 %246, %struct.Memory* %call2_415bb3)
...
block_.L_415c41:                                  ; preds = %block_.L_415c11
  ...
  %call2_415c44 = tail call %struct.Memory* @sub_40c140._Z9check_sumIiEvT_(%struct.State* nonnull %0, i64 %325, %struct.Memory* %call2_415bb3)
...
block_.L_415c57:                                  ; preds = %block_.L_415bbf
  ...
  %call2_415c57 = tail call %struct.Memory* @sub_400e30._Z5timerv(%struct.State* nonnull %0, i64 %362, %struct.Memory* %call2_415bb3)
  ...
  %call2_415c60 = tail call %struct.Memory* @sub_4007d0._Z13record_resultdPKc(%struct.State* nonnull %0, i64 %373, %struct.Memory* %call2_415c57)
