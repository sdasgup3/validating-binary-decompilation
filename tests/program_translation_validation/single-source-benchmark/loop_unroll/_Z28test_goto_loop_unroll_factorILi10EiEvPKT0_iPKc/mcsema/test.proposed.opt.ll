...
block_.L_40e96f:                                  ; preds = %block_.L_40ea1b, %entry
  %68 = phi i64 [ %.pre, %entry ], [ %445, %block_.L_40ea1b ]
...
block_.L_40e9e6:                                  ; preds = %block_40ea11, %block_40e9e1
  %276 = phi i64 [ %275, %block_40e9e1 ], [ %400, %block_40ea11 ]
  %277 = phi i64 [ %238, %block_40e9e1 ], [ %364, %block_40ea11 ]
  ...
  br i1 %388, label %block_.L_40ea16, label %block_40ea11
...
block_.L_40ea1b:                                  ; preds = %block_.L_40e9d5, %block_.L_40ea16
  %402 = phi i64 [ %274, %block_.L_40e9d5 ], [ %401, %block_.L_40ea16 ]
  %403 = phi i64 [ %238, %block_.L_40e9d5 ], [ %364, %block_.L_40ea16 ]
  ...
  %call2_40ea1e = tail call %struct.Memory* @sub_40c100._Z9check_sumIiEvT_(%struct.State* %0, i64 %409, %struct.Memory* %MEMORY.4)
...
block_.L_40ea31:                                  ; preds = %block_.L_40e96f
  ...
  %call2_40ea31 = tail call %struct.Memory* @sub_400df0._Z5timerv(%struct.State* %0, i64 %446, %struct.Memory* %MEMORY.0)
  ...
  %call2_40ea3a = tail call %struct.Memory* @sub_400790._Z13record_resultdPKc(%struct.State* %0, i64 %457, %struct.Memory* %call2_40ea31)
