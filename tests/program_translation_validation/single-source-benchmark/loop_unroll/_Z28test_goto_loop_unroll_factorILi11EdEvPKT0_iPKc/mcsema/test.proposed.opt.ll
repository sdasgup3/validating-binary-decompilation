...
declare %struct.Memory* @sub_401da0._ZN15loop_inner_bodyILi11EdE7do_workERdPKdi(%struct.State* noalias dereferenceable(3376), i64, %struct.Memory* noalias readnone returned) local_unnamed_addr
...
define %struct.Memory* @_Z28test_goto_loop_unroll_factorILi11EdEvPKT0_iPKc(%struct.State* noalias, i64, %struct.Memory* noalias readnone) local_unnamed_addr #1 {
entry:
...
block_.L_403cc2:                                  ; preds = %block_403cec, %block_403cbd
  ...
  %call2_403ccd = tail call %struct.Memory* @sub_401da0._ZN15loop_inner_bodyILi11EdE7do_workERdPKdi(%struct.State* nonnull %0, i64 %167, %struct.Memory* %MEMORY.0)
...
block_.L_403cf6:                                  ; preds = %block_.L_403cf1, %block_403c9f
  %244 = phi i64 [ %243, %block_.L_403cf1 ], [ %154, %block_403c9f ]
  %245 = phi i64 [ %201, %block_.L_403cf1 ], [ %118, %block_403c9f ]
  %246 = add i64 %245, -44
  %247 = add i64 %244, 3
...
block_.L_403d07:                                  ; preds = %block_403d38, %block_403d02
  ...
  %call2_403d14 = tail call %struct.Memory* @sub_4014b0._Z18complete_hash_funcIdET_S0_(%struct.State* nonnull %0, i64 %298, %struct.Memory* %MEMORY.0)
...
block_.L_403d42:                                  ; preds = %block_.L_403cf6, %block_.L_403d3d
  ...
  %call2_403d47 = tail call %struct.Memory* @sub_4014e0._Z9check_sumIdEvT_(%struct.State* nonnull %0, i64 %388, %struct.Memory* %MEMORY.0)
