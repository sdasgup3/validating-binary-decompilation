...
block_.L_40e81f:                                  ; preds = %block_.L_40e8cb, %entry
  %68 = phi i64 [ %.pre, %entry ], [ %445, %block_.L_40e8cb ]
...
block_.L_40e896:                                  ; preds = %block_40e8c1, %block_40e891
  %276 = phi i64 [ %275, %block_40e891 ], [ %400, %block_40e8c1 ]
  %277 = phi i64 [ %238, %block_40e891 ], [ %364, %block_40e8c1 ]
  ...
  store i64 %370, i64* %RAX.i108, align 8
  %371 = add i64 %364, -12
  %372 = add i64 %366, 6
  ...
  %.v8 = select i1 %388, i64 17, i64 12
  %399 = add i64 %366, %.v8
  store i64 %399, i64* %3, align 8
  br i1 %388, label %block_.L_40e8c6, label %block_40e8c1
...
block_.L_40e8cb:                                  ; preds = %block_.L_40e885, %block_.L_40e8c6
  %402 = phi i64 [ %274, %block_.L_40e885 ], [ %401, %block_.L_40e8c6 ]
  %403 = phi i64 [ %238, %block_.L_40e885 ], [ %364, %block_.L_40e8c6 ]
  ...
  %call2_40e8ce = tail call %struct.Memory* @sub_40c100._Z9check_sumIiEvT_(%struct.State* %0, i64 %409, %struct.Memory* %MEMORY.4)
...
block_.L_40e8e1:                                  ; preds = %block_.L_40e81f
  ...
  %call2_40e8e1 = tail call %struct.Memory* @sub_400df0._Z5timerv(%struct.State* %0, i64 %446, %struct.Memory* %MEMORY.0)
  ...
  %call2_40e8ea = tail call %struct.Memory* @sub_400790._Z13record_resultdPKc(%struct.State* %0, i64 %457, %struct.Memory* %call2_40e8e1)
