...
declare %struct.Memory* @sub_40c960._ZN15loop_inner_bodyILi11EiE7do_workERiPKii(%struct.State* noalias dereferenceable(3376), i64, %struct.Memory* noalias readnone returned) local_unnamed_addr
...
define %struct.Memory* @_Z28test_goto_loop_unroll_factorILi11EiEvPKT0_iPKc(%struct.State* noalias, i64, %struct.Memory* noalias readnone) local_unnamed_addr #1 {
entry:
...
block_.L_40e881:                                  ; preds = %block_40e8ab, %block_40e87c
  ...
  %call2_40e88c = tail call %struct.Memory* @sub_40c960._ZN15loop_inner_bodyILi11EiE7do_workERiPKii(%struct.State* nonnull %0, i64 %160, %struct.Memory* %MEMORY.0)
...
block_.L_40e8b5:                                  ; preds = %block_.L_40e8b0, %block_40e85f
  %237 = phi i64 [ %236, %block_.L_40e8b0 ], [ %147, %block_40e85f ]
  %238 = phi i64 [ %194, %block_.L_40e8b0 ], [ %111, %block_40e85f ]
  %239 = add i64 %238, -36
  %240 = add i64 %237, 3
...
block_.L_40e8c6:                                  ; preds = %block_40e8f1, %block_40e8c1
  ...
  %call2_40e8d1 = tail call %struct.Memory* @sub_40c100._Z18complete_hash_funcIiET_S0_(%struct.State* nonnull %0, i64 %292, %struct.Memory* %MEMORY.0)
...
block_.L_40e8fb:                                  ; preds = %block_.L_40e8b5, %block_.L_40e8f6
  ...
  %call2_40e8fe = tail call %struct.Memory* @sub_40c130._Z9check_sumIiEvT_(%struct.State* nonnull %0, i64 %409, %struct.Memory* %MEMORY.0)
