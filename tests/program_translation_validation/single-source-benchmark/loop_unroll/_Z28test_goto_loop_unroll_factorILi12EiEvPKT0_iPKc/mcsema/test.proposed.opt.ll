...
block_.L_40e6cf:                                  ; preds = %block_.L_40e77b, %entry
  %68 = phi i64 [ %.pre, %entry ], [ %447, %block_.L_40e77b ]
...
block_.L_40e746:                                  ; preds = %block_40e771, %block_40e741
  %276 = phi i64 [ %275, %block_40e741 ], [ %401, %block_40e771 ]
  %277 = phi i64 [ %238, %block_40e741 ], [ %365, %block_40e771 ]
  ...
  br i1 %389, label %block_.L_40e776, label %block_40e771
...
block_.L_40e77b:                                  ; preds = %block_.L_40e735, %block_.L_40e776
  %403 = phi i64 [ %274, %block_.L_40e735 ], [ %402, %block_.L_40e776 ]
  %404 = phi i64 [ %238, %block_.L_40e735 ], [ %365, %block_.L_40e776 ]
  ...
  %call2_40e77e = tail call %struct.Memory* @sub_40c100._Z9check_sumIiEvT_(%struct.State* %0, i64 %410, %struct.Memory* %MEMORY.4)
...
block_.L_40e791:                                  ; preds = %block_.L_40e6cf
  ...
  %call2_40e791 = tail call %struct.Memory* @sub_400df0._Z5timerv(%struct.State* %0, i64 %448, %struct.Memory* %MEMORY.0)
  ...
  %call2_40e79a = tail call %struct.Memory* @sub_400790._Z13record_resultdPKc(%struct.State* %0, i64 %459, %struct.Memory* %call2_40e791)
