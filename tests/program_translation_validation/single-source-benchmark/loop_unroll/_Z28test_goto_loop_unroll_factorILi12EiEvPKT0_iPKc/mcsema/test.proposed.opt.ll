...
declare %struct.Memory* @sub_40c900._ZN15loop_inner_bodyILi12EiE7do_workERiPKii(%struct.State* noalias dereferenceable(3376), i64, %struct.Memory* noalias readnone returned) local_unnamed_addr
...
define %struct.Memory* @_Z28test_goto_loop_unroll_factorILi12EiEvPKT0_iPKc(%struct.State* noalias, i64, %struct.Memory* noalias readnone) local_unnamed_addr #1 {
entry:
...
block_.L_40e731:                                  ; preds = %block_40e75b, %block_40e72c
  ...
  %call2_40e73c = tail call %struct.Memory* @sub_40c900._ZN15loop_inner_bodyILi12EiE7do_workERiPKii(%struct.State* nonnull %0, i64 %160, %struct.Memory* %MEMORY.0)
...
block_.L_40e765:                                  ; preds = %block_.L_40e760, %block_40e70f
  %237 = phi i64 [ %236, %block_.L_40e760 ], [ %147, %block_40e70f ]
  %238 = phi i64 [ %194, %block_.L_40e760 ], [ %111, %block_40e70f ]
  %239 = add i64 %238, -36
  %240 = add i64 %237, 3
...
block_.L_40e776:                                  ; preds = %block_40e7a1, %block_40e771
  ...
  %call2_40e781 = tail call %struct.Memory* @sub_40c100._Z18complete_hash_funcIiET_S0_(%struct.State* nonnull %0, i64 %292, %struct.Memory* %MEMORY.0)
...
block_.L_40e7ab:                                  ; preds = %block_.L_40e765, %block_.L_40e7a6
  ...
  %call2_40e7ae = tail call %struct.Memory* @sub_40c130._Z9check_sumIiEvT_(%struct.State* nonnull %0, i64 %409, %struct.Memory* %MEMORY.0)
