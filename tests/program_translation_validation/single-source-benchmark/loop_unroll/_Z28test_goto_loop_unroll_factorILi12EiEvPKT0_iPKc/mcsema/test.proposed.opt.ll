...
entry:
  ...
  %call2_40e703 = tail call %struct.Memory* @sub_400e10._Z11start_timerv(%struct.State* %0, i64 %58, %struct.Memory* %2)
...
block_.L_40e70f:                                  ; preds = %block_.L_40e7bb, %entry
  %68 = phi i64 [ %.pre, %entry ], [ %445, %block_.L_40e7bb ]
  %MEMORY.0 = phi %struct.Memory* [ %call2_40e703, %entry ], [ %call2_40e7be, %block_.L_40e7bb ]
  ...
  br i1 %101, label %block_40e71f, label %block_.L_40e7d1
...
block_40e71f:                                     ; preds = %block_.L_40e70f
  ...
  br i1 %146, label %block_.L_40e775, label %block_40e73c
...
block_.L_40e741:                                  ; preds = %block_40e76b, %block_40e73c
  %149 = phi i64 [ %111, %block_40e73c ], [ %194, %block_40e76b ]
  %storemerge = phi i64 [ %148, %block_40e73c ], [ %234, %block_40e76b ]
  %150 = add i64 %149, -32
  ...
  %call2_40e74c = tail call %struct.Memory* @sub_40c910._ZN15loop_inner_bodyILi12EiE7do_workERiPKii(%struct.State* nonnull %0, i64 %160, %struct.Memory* %MEMORY.0)
  ...
  br i1 %232, label %block_40e76b, label %block_.L_40e770
...
block_.L_40e775:                                  ; preds = %block_.L_40e770, %block_40e71f
  %237 = phi i64 [ %236, %block_.L_40e770 ], [ %147, %block_40e71f ]
  %238 = phi i64 [ %194, %block_.L_40e770 ], [ %111, %block_40e71f ]
  %239 = add i64 %238, -36
  %240 = add i64 %237, 3
  ...
  br i1 %273, label %block_40e781, label %block_.L_40e7bb
...
block_.L_40e786:                                  ; preds = %block_40e7b1, %block_40e781
  %276 = phi i64 [ %238, %block_40e781 ], [ %363, %block_40e7b1 ]
  %storemerge5 = phi i64 [ %275, %block_40e781 ], [ %399, %block_40e7b1 ]
  %277 = add i64 %276, -8
  ...
  %call2_40e791 = tail call %struct.Memory* @sub_40c110._Z18complete_hash_funcIiET_S0_(%struct.State* nonnull %0, i64 %292, %struct.Memory* %MEMORY.0)
  ...
  br i1 %387, label %block_.L_40e7b6, label %block_40e7b1
...
block_.L_40e7bb:                                  ; preds = %block_.L_40e775, %block_.L_40e7b6
  %402 = phi i64 [ %274, %block_.L_40e775 ], [ %401, %block_.L_40e7b6 ]
  %403 = phi i64 [ %238, %block_.L_40e775 ], [ %363, %block_.L_40e7b6 ]
  %404 = add i64 %403, -32
  %405 = add i64 %402, 3
  ...
  %call2_40e7be = tail call %struct.Memory* @sub_40c140._Z9check_sumIiEvT_(%struct.State* nonnull %0, i64 %409, %struct.Memory* %MEMORY.0)
...
block_.L_40e7d1:                                  ; preds = %block_.L_40e70f
  ...
  %call2_40e7d1 = tail call %struct.Memory* @sub_400e30._Z5timerv(%struct.State* nonnull %0, i64 %446, %struct.Memory* %MEMORY.0)
  ...
  %call2_40e7da = tail call %struct.Memory* @sub_4007d0._Z13record_resultdPKc(%struct.State* nonnull %0, i64 %457, %struct.Memory* %call2_40e7d1)
