...
declare %struct.Memory* @sub_40c8d0._ZN15loop_inner_bodyILi12EiE7do_workERiPKii(%struct.State* noalias dereferenceable(3376), i64, %struct.Memory* noalias readnone returned) local_unnamed_addr
...
entry:
  ...
  %call2_40e6c3 = tail call %struct.Memory* @sub_400dd0._Z11start_timerv(%struct.State* %0, i64 %58, %struct.Memory* %2)
...
block_.L_40e6cf:                                  ; preds = %block_.L_40e77b, %entry
  %68 = phi i64 [ %.pre, %entry ], [ %445, %block_.L_40e77b ]
  %MEMORY.0 = phi %struct.Memory* [ %call2_40e6c3, %entry ], [ %call2_40e77e, %block_.L_40e77b ]
  ...
  br i1 %101, label %block_40e6df, label %block_.L_40e791
...
block_40e6df:                                     ; preds = %block_.L_40e6cf
  ...
  br i1 %146, label %block_.L_40e735, label %block_40e6fc
...
block_.L_40e701:                                  ; preds = %block_40e72b, %block_40e6fc
  %149 = phi i64 [ %148, %block_40e6fc ], [ %235, %block_40e72b ]
  %150 = phi i64 [ %111, %block_40e6fc ], [ %195, %block_40e72b ]
  %MEMORY.1 = phi %struct.Memory* [ %MEMORY.0, %block_40e6fc ], [ %call2_40e70c, %block_40e72b ]
  %151 = add i64 %150, -32
  ...
  %call2_40e70c = tail call %struct.Memory* @sub_40c8d0._ZN15loop_inner_bodyILi12EiE7do_workERiPKii(%struct.State* %0, i64 %161, %struct.Memory* %MEMORY.1)
  ...
  br i1 %233, label %block_40e72b, label %block_.L_40e730
...
block_.L_40e735:                                  ; preds = %block_.L_40e730, %block_40e6df
  %237 = phi i64 [ %147, %block_40e6df ], [ %236, %block_.L_40e730 ]
  %238 = phi i64 [ %111, %block_40e6df ], [ %195, %block_.L_40e730 ]
  %MEMORY.2 = phi %struct.Memory* [ %MEMORY.0, %block_40e6df ], [ %call2_40e70c, %block_.L_40e730 ]
  %239 = add i64 %238, -36
  %240 = add i64 %237, 3
  ...
  br i1 %273, label %block_40e741, label %block_.L_40e77b
...
block_.L_40e746:                                  ; preds = %block_40e771, %block_40e741
  %276 = phi i64 [ %275, %block_40e741 ], [ %400, %block_40e771 ]
  %277 = phi i64 [ %238, %block_40e741 ], [ %364, %block_40e771 ]
  %MEMORY.3 = phi %struct.Memory* [ %MEMORY.2, %block_40e741 ], [ %call2_40e751, %block_40e771 ]
  %278 = add i64 %277, -8
  %279 = add i64 %276, 4
  ...
  %call2_40e751 = tail call %struct.Memory* @sub_40c0d0._Z18complete_hash_funcIiET_S0_(%struct.State* %0, i64 %293, %struct.Memory* %MEMORY.3)
  ...
  br i1 %388, label %block_.L_40e776, label %block_40e771
...
block_.L_40e77b:                                  ; preds = %block_.L_40e735, %block_.L_40e776
  %402 = phi i64 [ %274, %block_.L_40e735 ], [ %401, %block_.L_40e776 ]
  %403 = phi i64 [ %238, %block_.L_40e735 ], [ %364, %block_.L_40e776 ]
  %MEMORY.4 = phi %struct.Memory* [ %MEMORY.2, %block_.L_40e735 ], [ %call2_40e751, %block_.L_40e776 ]
  %404 = add i64 %403, -32
  %405 = add i64 %402, 3
  ...
  %call2_40e77e = tail call %struct.Memory* @sub_40c100._Z9check_sumIiEvT_(%struct.State* %0, i64 %409, %struct.Memory* %MEMORY.4)
...
block_.L_40e791:                                  ; preds = %block_.L_40e6cf
  ...
  %call2_40e791 = tail call %struct.Memory* @sub_400df0._Z5timerv(%struct.State* %0, i64 %446, %struct.Memory* %MEMORY.0)
  ...
  %call2_40e79a = tail call %struct.Memory* @sub_400790._Z13record_resultdPKc(%struct.State* %0, i64 %457, %struct.Memory* %call2_40e791)
  ...
  ret %struct.Memory* %call2_40e79a
}
...
define %struct.Memory* @routine_jge_.L_40e791(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i8* %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
...
define %struct.Memory* @routine_jl_.L_40e735(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i8* %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 2, i32 9
...
define %struct.Memory* @routine_jmpq_.L_40e701(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
...
define %struct.Memory* @routine_callq_._ZN15loop_inner_bodyILi12EiE7do_workERiPKii(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
...
define %struct.Memory* @routine_jge_.L_40e730(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i8* %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 2, i32 9
...
define %struct.Memory* @routine_jmpq_.L_40e735(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
...
define %struct.Memory* @routine_jge_.L_40e77b(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i8* %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 2, i32 9
...
define %struct.Memory* @routine_jmpq_.L_40e746(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
...
define %struct.Memory* @routine_je_.L_40e776(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i8* %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
...
define %struct.Memory* @routine_jmpq_.L_40e77b(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
...
define %struct.Memory* @routine_jmpq_.L_40e6cf(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
