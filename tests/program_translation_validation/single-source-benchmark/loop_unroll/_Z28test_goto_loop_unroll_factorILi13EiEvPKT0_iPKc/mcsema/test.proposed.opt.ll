...
entry:
  ...
  %call2_40e573 = tail call %struct.Memory* @sub_400dd0._Z11start_timerv(%struct.State* %0, i64 %58, %struct.Memory* %2)
...
block_.L_40e57f:                                  ; preds = %block_.L_40e62b, %entry
  %68 = phi i64 [ %.pre, %entry ], [ %445, %block_.L_40e62b ]
  %MEMORY.0 = phi %struct.Memory* [ %call2_40e573, %entry ], [ %call2_40e62e, %block_.L_40e62b ]
  ...
  br i1 %101, label %block_40e58f, label %block_.L_40e641
...
block_40e58f:                                     ; preds = %block_.L_40e57f
  ...
  br i1 %146, label %block_.L_40e5e5, label %block_40e5ac
...
block_.L_40e5b1:                                  ; preds = %block_40e5db, %block_40e5ac
  %149 = phi i64 [ %148, %block_40e5ac ], [ %235, %block_40e5db ]
  %150 = phi i64 [ %111, %block_40e5ac ], [ %195, %block_40e5db ]
  %MEMORY.1 = phi %struct.Memory* [ %MEMORY.0, %block_40e5ac ], [ %call2_40e5bc, %block_40e5db ]
  %151 = add i64 %150, -32
  ...
  %call2_40e5bc = tail call %struct.Memory* @sub_40c870._ZN15loop_inner_bodyILi13EiE7do_workERiPKii(%struct.State* %0, i64 %161, %struct.Memory* %MEMORY.1)
  ...
  br i1 %233, label %block_40e5db, label %block_.L_40e5e0
...
block_.L_40e5e5:                                  ; preds = %block_.L_40e5e0, %block_40e58f
  %237 = phi i64 [ %147, %block_40e58f ], [ %236, %block_.L_40e5e0 ]
  %238 = phi i64 [ %111, %block_40e58f ], [ %195, %block_.L_40e5e0 ]
  %MEMORY.2 = phi %struct.Memory* [ %MEMORY.0, %block_40e58f ], [ %call2_40e5bc, %block_.L_40e5e0 ]
  %239 = add i64 %238, -36
  %240 = add i64 %237, 3
  ...
  br i1 %273, label %block_40e5f1, label %block_.L_40e62b
...
block_.L_40e5f6:                                  ; preds = %block_40e621, %block_40e5f1
  %276 = phi i64 [ %275, %block_40e5f1 ], [ %400, %block_40e621 ]
  %277 = phi i64 [ %238, %block_40e5f1 ], [ %364, %block_40e621 ]
  %MEMORY.3 = phi %struct.Memory* [ %MEMORY.2, %block_40e5f1 ], [ %call2_40e601, %block_40e621 ]
  %278 = add i64 %277, -8
  %279 = add i64 %276, 4
  ...
  %call2_40e601 = tail call %struct.Memory* @sub_40c0d0._Z18complete_hash_funcIiET_S0_(%struct.State* %0, i64 %293, %struct.Memory* %MEMORY.3)
  ...
  br i1 %388, label %block_.L_40e626, label %block_40e621
...
block_.L_40e62b:                                  ; preds = %block_.L_40e5e5, %block_.L_40e626
  %402 = phi i64 [ %274, %block_.L_40e5e5 ], [ %401, %block_.L_40e626 ]
  %403 = phi i64 [ %238, %block_.L_40e5e5 ], [ %364, %block_.L_40e626 ]
  %MEMORY.4 = phi %struct.Memory* [ %MEMORY.2, %block_.L_40e5e5 ], [ %call2_40e601, %block_.L_40e626 ]
  %404 = add i64 %403, -32
  %405 = add i64 %402, 3
  ...
  %call2_40e62e = tail call %struct.Memory* @sub_40c100._Z9check_sumIiEvT_(%struct.State* %0, i64 %409, %struct.Memory* %MEMORY.4)
...
block_.L_40e641:                                  ; preds = %block_.L_40e57f
  ...
  %call2_40e641 = tail call %struct.Memory* @sub_400df0._Z5timerv(%struct.State* %0, i64 %446, %struct.Memory* %MEMORY.0)
  ...
  %call2_40e64a = tail call %struct.Memory* @sub_400790._Z13record_resultdPKc(%struct.State* %0, i64 %457, %struct.Memory* %call2_40e641)
  ...
  ret %struct.Memory* %call2_40e64a
}
...
define %struct.Memory* @routine_jge_.L_40e641(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i8* %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
...
define %struct.Memory* @routine_jl_.L_40e5e5(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i8* %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 2, i32 9
...
define %struct.Memory* @routine_jmpq_.L_40e5b1(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
...
define %struct.Memory* @routine_jge_.L_40e5e0(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i8* %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 2, i32 9
...
define %struct.Memory* @routine_jmpq_.L_40e5e5(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
...
define %struct.Memory* @routine_jge_.L_40e62b(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i8* %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 2, i32 9
...
define %struct.Memory* @routine_jmpq_.L_40e5f6(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
...
define %struct.Memory* @routine_je_.L_40e626(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i8* %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
...
define %struct.Memory* @routine_jmpq_.L_40e62b(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
...
define %struct.Memory* @routine_jmpq_.L_40e57f(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
