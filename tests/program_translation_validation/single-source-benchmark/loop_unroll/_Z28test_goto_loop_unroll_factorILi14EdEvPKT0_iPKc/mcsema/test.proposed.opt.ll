...
declare %struct.Memory* @sub_401c90._ZN15loop_inner_bodyILi14EdE7do_workERdPKdi(%struct.State* noalias dereferenceable(3376), i64, %struct.Memory* noalias readnone returned) local_unnamed_addr
...
entry:
  ...
  %call2_4038a3 = tail call %struct.Memory* @sub_400e10._Z11start_timerv(%struct.State* %0, i64 %58, %struct.Memory* %2)
...
block_.L_4038af:                                  ; preds = %block_.L_403962, %entry
  %74 = phi i64 [ %.pre, %entry ], [ %424, %block_.L_403962 ]
  %MEMORY.0 = phi %struct.Memory* [ %call2_4038a3, %entry ], [ %call2_403967, %block_.L_403962 ]
  ...
  br i1 %107, label %block_4038bf, label %block_.L_40397a
...
block_4038bf:                                     ; preds = %block_.L_4038af
  ...
  br i1 %153, label %block_.L_403916, label %block_4038dd
...
block_.L_4038e2:                                  ; preds = %block_40390c, %block_4038dd
  %156 = phi i64 [ %118, %block_4038dd ], [ %201, %block_40390c ]
  %storemerge = phi i64 [ %155, %block_4038dd ], [ %241, %block_40390c ]
  %157 = add i64 %156, -40
  ...
  %call2_4038ed = tail call %struct.Memory* @sub_401c90._ZN15loop_inner_bodyILi14EdE7do_workERdPKdi(%struct.State* nonnull %0, i64 %167, %struct.Memory* %MEMORY.0)
  ...
  br i1 %239, label %block_40390c, label %block_.L_403911
...
block_.L_403916:                                  ; preds = %block_.L_403911, %block_4038bf
  %244 = phi i64 [ %243, %block_.L_403911 ], [ %154, %block_4038bf ]
  %245 = phi i64 [ %201, %block_.L_403911 ], [ %118, %block_4038bf ]
  %246 = add i64 %245, -44
  %247 = add i64 %244, 3
  ...
  br i1 %280, label %block_403922, label %block_.L_403962
...
block_.L_403927:                                  ; preds = %block_403958, %block_403922
  %283 = phi i64 [ %245, %block_403922 ], [ %343, %block_403958 ]
  %storemerge5 = phi i64 [ %282, %block_403922 ], [ %379, %block_403958 ]
  %284 = add i64 %283, -8
  ...
  %call2_403934 = tail call %struct.Memory* @sub_4014c0._Z18complete_hash_funcIdET_S0_(%struct.State* nonnull %0, i64 %298, %struct.Memory* %MEMORY.0)
  ...
  br i1 %367, label %block_.L_40395d, label %block_403958
...
block_.L_403962:                                  ; preds = %block_.L_403916, %block_.L_40395d
  %382 = phi i64 [ %281, %block_.L_403916 ], [ %381, %block_.L_40395d ]
  %383 = phi i64 [ %245, %block_.L_403916 ], [ %343, %block_.L_40395d ]
  %384 = add i64 %383, -40
  %385 = add i64 %382, 5
  ...
  %call2_403967 = tail call %struct.Memory* @sub_4014f0._Z9check_sumIdEvT_(%struct.State* nonnull %0, i64 %388, %struct.Memory* %MEMORY.0)
...
block_.L_40397a:                                  ; preds = %block_.L_4038af
  ...
  %call2_40397a = tail call %struct.Memory* @sub_400e30._Z5timerv(%struct.State* nonnull %0, i64 %425, %struct.Memory* %MEMORY.0)
  ...
  %call2_403983 = tail call %struct.Memory* @sub_4007d0._Z13record_resultdPKc(%struct.State* nonnull %0, i64 %436, %struct.Memory* %call2_40397a)
