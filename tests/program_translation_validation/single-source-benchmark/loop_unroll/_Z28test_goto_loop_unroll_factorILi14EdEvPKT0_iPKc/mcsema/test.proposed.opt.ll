...
declare %struct.Memory* @sub_401c50._ZN15loop_inner_bodyILi14EdE7do_workERdPKdi(%struct.State* noalias dereferenceable(3376), i64, %struct.Memory* noalias readnone returned) local_unnamed_addr
...
entry:
  ...
  %call2_403863 = tail call %struct.Memory* @sub_400dd0._Z11start_timerv(%struct.State* %0, i64 %58, %struct.Memory* %2)
...
block_.L_40386f:                                  ; preds = %block_.L_403922, %entry
  %79 = phi i64 [ %.pre, %entry ], [ %433, %block_.L_403922 ]
  %MEMORY.0 = phi %struct.Memory* [ %call2_403863, %entry ], [ %call2_403927, %block_.L_403922 ]
  ...
  br i1 %112, label %block_40387f, label %block_.L_40393a
...
block_40387f:                                     ; preds = %block_.L_40386f
  ...
  br i1 %159, label %block_.L_4038d6, label %block_40389d
...
block_.L_4038a2:                                  ; preds = %block_4038cc, %block_40389d
  %162 = phi i64 [ %161, %block_40389d ], [ %248, %block_4038cc ]
  %163 = phi i64 [ %124, %block_40389d ], [ %208, %block_4038cc ]
  %MEMORY.1 = phi %struct.Memory* [ %MEMORY.0, %block_40389d ], [ %call2_4038ad, %block_4038cc ]
  %164 = add i64 %163, -40
  ...
  %call2_4038ad = tail call %struct.Memory* @sub_401c50._ZN15loop_inner_bodyILi14EdE7do_workERdPKdi(%struct.State* %0, i64 %174, %struct.Memory* %MEMORY.1)
  ...
  br i1 %246, label %block_4038cc, label %block_.L_4038d1
...
block_.L_4038d6:                                  ; preds = %block_.L_4038d1, %block_40387f
  %250 = phi i64 [ %160, %block_40387f ], [ %249, %block_.L_4038d1 ]
  %251 = phi i64 [ %124, %block_40387f ], [ %208, %block_.L_4038d1 ]
  %MEMORY.2 = phi %struct.Memory* [ %MEMORY.0, %block_40387f ], [ %call2_4038ad, %block_.L_4038d1 ]
  %252 = add i64 %251, -44
  %253 = add i64 %250, 3
  ...
  br i1 %286, label %block_4038e2, label %block_.L_403922
...
block_.L_4038e7:                                  ; preds = %block_403918, %block_4038e2
  %289 = phi i64 [ %288, %block_4038e2 ], [ %387, %block_403918 ]
  %290 = phi i64 [ %251, %block_4038e2 ], [ %351, %block_403918 ]
  %MEMORY.3 = phi %struct.Memory* [ %MEMORY.2, %block_4038e2 ], [ %call2_4038f4, %block_403918 ]
  %291 = add i64 %290, -8
  %292 = add i64 %289, 4
  ...
  %call2_4038f4 = tail call %struct.Memory* @sub_401480._Z18complete_hash_funcIdET_S0_(%struct.State* %0, i64 %306, %struct.Memory* %MEMORY.3)
  ...
  br i1 %375, label %block_.L_40391d, label %block_403918
...
block_.L_403922:                                  ; preds = %block_.L_4038d6, %block_.L_40391d
  %389 = phi i64 [ %287, %block_.L_4038d6 ], [ %388, %block_.L_40391d ]
  %390 = phi i64 [ %251, %block_.L_4038d6 ], [ %351, %block_.L_40391d ]
  %MEMORY.4 = phi %struct.Memory* [ %MEMORY.2, %block_.L_4038d6 ], [ %call2_4038f4, %block_.L_40391d ]
  %391 = add i64 %390, -40
  %392 = add i64 %389, 5
  ...
  %call2_403927 = tail call %struct.Memory* @sub_4014b0._Z9check_sumIdEvT_(%struct.State* %0, i64 %396, %struct.Memory* %MEMORY.4)
...
block_.L_40393a:                                  ; preds = %block_.L_40386f
  ...
  %call2_40393a = tail call %struct.Memory* @sub_400df0._Z5timerv(%struct.State* %0, i64 %434, %struct.Memory* %MEMORY.0)
  ...
  %call2_403943 = tail call %struct.Memory* @sub_400790._Z13record_resultdPKc(%struct.State* %0, i64 %445, %struct.Memory* %call2_40393a)
  ...
  ret %struct.Memory* %call2_403943
}
...
define %struct.Memory* @routine_jge_.L_40393a(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i8* %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
...
define %struct.Memory* @routine_jl_.L_4038d6(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i8* %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 2, i32 9
...
define %struct.Memory* @routine_jmpq_.L_4038a2(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
...
define %struct.Memory* @routine_callq_._ZN15loop_inner_bodyILi14EdE7do_workERdPKdi(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
...
define %struct.Memory* @routine_jge_.L_4038d1(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i8* %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 2, i32 9
...
define %struct.Memory* @routine_jmpq_.L_4038d6(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
...
define %struct.Memory* @routine_jge_.L_403922(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i8* %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 2, i32 9
...
define %struct.Memory* @routine_jmpq_.L_4038e7(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
...
define %struct.Memory* @routine_je_.L_40391d(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i8* %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
...
define %struct.Memory* @routine_jmpq_.L_403922(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
...
define %struct.Memory* @routine_jmpq_.L_40386f(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
