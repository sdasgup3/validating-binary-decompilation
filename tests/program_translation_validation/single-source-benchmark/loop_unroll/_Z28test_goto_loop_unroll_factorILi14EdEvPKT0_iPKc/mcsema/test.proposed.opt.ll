...
declare %struct.Memory* @sub_401c80._ZN15loop_inner_bodyILi14EdE7do_workERdPKdi(%struct.State* noalias dereferenceable(3376), i64, %struct.Memory* noalias readnone returned) local_unnamed_addr
...
block_.L_4038d2:                                  ; preds = %block_4038fc, %block_4038cd
  ...
  %call2_4038dd = tail call %struct.Memory* @sub_401c80._ZN15loop_inner_bodyILi14EdE7do_workERdPKdi(%struct.State* nonnull %0, i64 %167, %struct.Memory* %MEMORY.0)
...
block_.L_403906:                                  ; preds = %block_.L_403901, %block_4038af
  %244 = phi i64 [ %243, %block_.L_403901 ], [ %154, %block_4038af ]
  %245 = phi i64 [ %201, %block_.L_403901 ], [ %118, %block_4038af ]
  %246 = add i64 %245, -44
  %247 = add i64 %244, 3
...
block_.L_403917:                                  ; preds = %block_403948, %block_403912
  ...
  %call2_403924 = tail call %struct.Memory* @sub_4014b0._Z18complete_hash_funcIdET_S0_(%struct.State* nonnull %0, i64 %298, %struct.Memory* %MEMORY.0)
...
block_.L_403952:                                  ; preds = %block_.L_403906, %block_.L_40394d
  ...
  %call2_403957 = tail call %struct.Memory* @sub_4014e0._Z9check_sumIdEvT_(%struct.State* nonnull %0, i64 %388, %struct.Memory* %MEMORY.0)
