...
block_.L_40e42f:                                  ; preds = %block_.L_40e4db, %entry
  %68 = phi i64 [ %.pre, %entry ], [ %445, %block_.L_40e4db ]
...
block_.L_40e4a6:                                  ; preds = %block_40e4d1, %block_40e4a1
  %276 = phi i64 [ %275, %block_40e4a1 ], [ %400, %block_40e4d1 ]
  %277 = phi i64 [ %238, %block_40e4a1 ], [ %364, %block_40e4d1 ]
  ...
  br i1 %388, label %block_.L_40e4d6, label %block_40e4d1
...
block_.L_40e4db:                                  ; preds = %block_.L_40e495, %block_.L_40e4d6
  %402 = phi i64 [ %274, %block_.L_40e495 ], [ %401, %block_.L_40e4d6 ]
  %403 = phi i64 [ %238, %block_.L_40e495 ], [ %364, %block_.L_40e4d6 ]
  ...
  %call2_40e4de = tail call %struct.Memory* @sub_40c100._Z9check_sumIiEvT_(%struct.State* %0, i64 %409, %struct.Memory* %MEMORY.4)
...
block_.L_40e4f1:                                  ; preds = %block_.L_40e42f
  ...
  %call2_40e4f1 = tail call %struct.Memory* @sub_400df0._Z5timerv(%struct.State* %0, i64 %446, %struct.Memory* %MEMORY.0)
  ...
  %call2_40e4fa = tail call %struct.Memory* @sub_400790._Z13record_resultdPKc(%struct.State* %0, i64 %457, %struct.Memory* %call2_40e4f1)
