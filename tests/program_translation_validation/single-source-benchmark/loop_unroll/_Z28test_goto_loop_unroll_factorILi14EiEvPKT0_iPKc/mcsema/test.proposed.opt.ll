...
define %struct.Memory* @_Z28test_goto_loop_unroll_factorILi14EiEvPKT0_iPKc(%struct.State* noalias, i64, %struct.Memory* noalias readnone) local_unnamed_addr #1 {
entry:
...
block_.L_40e491:                                  ; preds = %block_40e4bb, %block_40e48c
  ...
  %call2_40e49c = tail call %struct.Memory* @sub_40c840._ZN15loop_inner_bodyILi14EiE7do_workERiPKii(%struct.State* nonnull %0, i64 %160, %struct.Memory* %MEMORY.0)
...
block_.L_40e4c5:                                  ; preds = %block_.L_40e4c0, %block_40e46f
  %237 = phi i64 [ %236, %block_.L_40e4c0 ], [ %147, %block_40e46f ]
  %238 = phi i64 [ %194, %block_.L_40e4c0 ], [ %111, %block_40e46f ]
  %239 = add i64 %238, -36
  %240 = add i64 %237, 3
...
block_.L_40e4d6:                                  ; preds = %block_40e501, %block_40e4d1
  ...
  %call2_40e4e1 = tail call %struct.Memory* @sub_40c100._Z18complete_hash_funcIiET_S0_(%struct.State* nonnull %0, i64 %292, %struct.Memory* %MEMORY.0)
...
block_.L_40e50b:                                  ; preds = %block_.L_40e4c5, %block_.L_40e506
  ...
  %call2_40e50e = tail call %struct.Memory* @sub_40c130._Z9check_sumIiEvT_(%struct.State* nonnull %0, i64 %409, %struct.Memory* %MEMORY.0)
