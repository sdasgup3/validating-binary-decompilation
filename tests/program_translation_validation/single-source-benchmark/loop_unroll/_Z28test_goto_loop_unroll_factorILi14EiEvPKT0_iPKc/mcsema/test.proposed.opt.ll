...
entry:
  ...
  %call2_40e463 = tail call %struct.Memory* @sub_400e10._Z11start_timerv(%struct.State* %0, i64 %58, %struct.Memory* %2)
  ...
  br label %block_.L_40e46f

block_.L_40e46f:                                  ; preds = %block_.L_40e51b, %entry
  %68 = phi i64 [ %.pre, %entry ], [ %445, %block_.L_40e51b ]
  %MEMORY.0 = phi %struct.Memory* [ %call2_40e463, %entry ], [ %call2_40e51e, %block_.L_40e51b ]
  ...
  br i1 %101, label %block_40e47f, label %block_.L_40e531

block_40e47f:                                     ; preds = %block_.L_40e46f
  %103 = add i64 %69, -32
  %104 = add i64 %102, 7
  ...
  br i1 %146, label %block_.L_40e4d5, label %block_40e49c

block_40e49c:                                     ; preds = %block_40e47f
  %148 = add i64 %147, 5
  br label %block_.L_40e4a1

block_.L_40e4a1:                                  ; preds = %block_40e4cb, %block_40e49c
  %149 = phi i64 [ %111, %block_40e49c ], [ %194, %block_40e4cb ]
  %storemerge = phi i64 [ %148, %block_40e49c ], [ %234, %block_40e4cb ]
  %150 = add i64 %149, -32
  ...
  %call2_40e4ac = tail call %struct.Memory* @sub_40c850._ZN15loop_inner_bodyILi14EiE7do_workERiPKii(%struct.State* nonnull %0, i64 %160, %struct.Memory* %MEMORY.0)
  ...
  br i1 %232, label %block_40e4cb, label %block_.L_40e4d0

block_40e4cb:                                     ; preds = %block_.L_40e4a1
  %234 = add i64 %233, -42
  %235 = add i64 %233, 5
  store i64 %235, i64* %3, align 8
  br label %block_.L_40e4a1

block_.L_40e4d0:                                  ; preds = %block_.L_40e4a1
  %236 = add i64 %233, 5
  store i64 %236, i64* %3, align 8
  br label %block_.L_40e4d5

block_.L_40e4d5:                                  ; preds = %block_.L_40e4d0, %block_40e47f
  %237 = phi i64 [ %236, %block_.L_40e4d0 ], [ %147, %block_40e47f ]
  %238 = phi i64 [ %194, %block_.L_40e4d0 ], [ %111, %block_40e47f ]
  %239 = add i64 %238, -36
  %240 = add i64 %237, 3
  ...
  br i1 %273, label %block_40e4e1, label %block_.L_40e51b

block_40e4e1:                                     ; preds = %block_.L_40e4d5
  %275 = add i64 %274, 5
  br label %block_.L_40e4e6

block_.L_40e4e6:                                  ; preds = %block_40e511, %block_40e4e1
  %276 = phi i64 [ %238, %block_40e4e1 ], [ %363, %block_40e511 ]
  %storemerge5 = phi i64 [ %275, %block_40e4e1 ], [ %399, %block_40e511 ]
  %277 = add i64 %276, -8
  ...
  %call2_40e4f1 = tail call %struct.Memory* @sub_40c110._Z18complete_hash_funcIiET_S0_(%struct.State* nonnull %0, i64 %292, %struct.Memory* %MEMORY.0)
  ...
  br i1 %387, label %block_.L_40e516, label %block_40e511

block_40e511:                                     ; preds = %block_.L_40e4e6
  %399 = add i64 %398, -43
  %400 = add i64 %398, 5
  store i64 %400, i64* %3, align 8
  br label %block_.L_40e4e6

block_.L_40e516:                                  ; preds = %block_.L_40e4e6
  %401 = add i64 %398, 5
  store i64 %401, i64* %3, align 8
  br label %block_.L_40e51b

block_.L_40e51b:                                  ; preds = %block_.L_40e4d5, %block_.L_40e516
  %402 = phi i64 [ %274, %block_.L_40e4d5 ], [ %401, %block_.L_40e516 ]
  %403 = phi i64 [ %238, %block_.L_40e4d5 ], [ %363, %block_.L_40e516 ]
  %404 = add i64 %403, -32
  %405 = add i64 %402, 3
  ...
  %call2_40e51e = tail call %struct.Memory* @sub_40c140._Z9check_sumIiEvT_(%struct.State* nonnull %0, i64 %409, %struct.Memory* %MEMORY.0)
...
block_.L_40e531:                                  ; preds = %block_.L_40e46f
  ...
  %call2_40e531 = tail call %struct.Memory* @sub_400e30._Z5timerv(%struct.State* nonnull %0, i64 %446, %struct.Memory* %MEMORY.0)
  ...
  %call2_40e53a = tail call %struct.Memory* @sub_4007d0._Z13record_resultdPKc(%struct.State* nonnull %0, i64 %457, %struct.Memory* %call2_40e531)
  ...
  ret %struct.Memory* %call2_40e53a
}
...
; Function Attrs: alwaysinline norecurse nounwind
define %struct.Memory* @routine_jge_.L_40e531(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i8* nocapture %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
...
; Function Attrs: alwaysinline norecurse nounwind
define %struct.Memory* @routine_jl_.L_40e4d5(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i8* nocapture %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 2, i32 9
...
; Function Attrs: alwaysinline norecurse nounwind
define %struct.Memory* @routine_jmpq_.L_40e4a1(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
...
; Function Attrs: alwaysinline norecurse nounwind
define %struct.Memory* @routine_jge_.L_40e4d0(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i8* nocapture %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 2, i32 9
...
; Function Attrs: alwaysinline norecurse nounwind
define %struct.Memory* @routine_jmpq_.L_40e4d5(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
...
; Function Attrs: alwaysinline norecurse nounwind
define %struct.Memory* @routine_jge_.L_40e51b(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i8* nocapture %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 2, i32 9
...
; Function Attrs: alwaysinline norecurse nounwind
define %struct.Memory* @routine_je_.L_40e516(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i8* nocapture %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
...
; Function Attrs: alwaysinline norecurse nounwind
define %struct.Memory* @routine_jmpq_.L_40e51b(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
...
; Function Attrs: alwaysinline norecurse nounwind
define %struct.Memory* @routine_jmpq_.L_40e46f(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
