...
entry:
  ...
  %call2_40e423 = tail call %struct.Memory* @sub_400dd0._Z11start_timerv(%struct.State* %0, i64 %58, %struct.Memory* %2)
...
block_.L_40e42f:                                  ; preds = %block_.L_40e4db, %entry
  %68 = phi i64 [ %.pre, %entry ], [ %447, %block_.L_40e4db ]
  %MEMORY.0 = phi %struct.Memory* [ %call2_40e423, %entry ], [ %call2_40e4de, %block_.L_40e4db ]
  ...
  br i1 %101, label %block_40e43f, label %block_.L_40e4f1

block_40e43f:                                     ; preds = %block_.L_40e42f
  %103 = add i64 %69, -32
  %104 = add i64 %102, 7
  ...
  br i1 %146, label %block_.L_40e495, label %block_40e45c

block_40e45c:                                     ; preds = %block_40e43f
  %148 = add i64 %147, 5
  br label %block_.L_40e461

block_.L_40e461:                                  ; preds = %block_40e48b, %block_40e45c
  %149 = phi i64 [ %148, %block_40e45c ], [ %235, %block_40e48b ]
  %150 = phi i64 [ %111, %block_40e45c ], [ %195, %block_40e48b ]
  %MEMORY.1 = phi %struct.Memory* [ %MEMORY.0, %block_40e45c ], [ %call2_40e46c, %block_40e48b ]
  %151 = add i64 %150, -32
  ...
  %call2_40e46c = tail call %struct.Memory* @sub_40c810._ZN15loop_inner_bodyILi14EiE7do_workERiPKii(%struct.State* %0, i64 %161, %struct.Memory* %MEMORY.1)
  ...
  br i1 %233, label %block_40e48b, label %block_.L_40e490

block_40e48b:                                     ; preds = %block_.L_40e461
  %235 = add i64 %234, -42
  br label %block_.L_40e461

block_.L_40e490:                                  ; preds = %block_.L_40e461
  %236 = add i64 %234, 5
  store i64 %236, i64* %3, align 8
  br label %block_.L_40e495

block_.L_40e495:                                  ; preds = %block_.L_40e490, %block_40e43f
  %237 = phi i64 [ %147, %block_40e43f ], [ %236, %block_.L_40e490 ]
  %238 = phi i64 [ %111, %block_40e43f ], [ %195, %block_.L_40e490 ]
  %MEMORY.2 = phi %struct.Memory* [ %MEMORY.0, %block_40e43f ], [ %call2_40e46c, %block_.L_40e490 ]
  %239 = add i64 %238, -36
  %240 = add i64 %237, 3
  ...
  br i1 %273, label %block_40e4a1, label %block_.L_40e4db

block_40e4a1:                                     ; preds = %block_.L_40e495
  %275 = add i64 %274, 5
  br label %block_.L_40e4a6

block_.L_40e4a6:                                  ; preds = %block_40e4d1, %block_40e4a1
  %276 = phi i64 [ %275, %block_40e4a1 ], [ %401, %block_40e4d1 ]
  %277 = phi i64 [ %238, %block_40e4a1 ], [ %365, %block_40e4d1 ]
  %MEMORY.3 = phi %struct.Memory* [ %MEMORY.2, %block_40e4a1 ], [ %call2_40e4b1, %block_40e4d1 ]
  %278 = add i64 %277, -8
  %279 = add i64 %276, 4
  ...
  %call2_40e4b1 = tail call %struct.Memory* @sub_40c0d0._Z18complete_hash_funcIiET_S0_(%struct.State* %0, i64 %293, %struct.Memory* %MEMORY.3)
  ...
  br i1 %389, label %block_.L_40e4d6, label %block_40e4d1

block_40e4d1:                                     ; preds = %block_.L_40e4a6
  %401 = add i64 %400, -43
  br label %block_.L_40e4a6

block_.L_40e4d6:                                  ; preds = %block_.L_40e4a6
  %402 = add i64 %400, 5
  store i64 %402, i64* %3, align 8
  br label %block_.L_40e4db

block_.L_40e4db:                                  ; preds = %block_.L_40e495, %block_.L_40e4d6
  %403 = phi i64 [ %274, %block_.L_40e495 ], [ %402, %block_.L_40e4d6 ]
  %404 = phi i64 [ %238, %block_.L_40e495 ], [ %365, %block_.L_40e4d6 ]
  %MEMORY.4 = phi %struct.Memory* [ %MEMORY.2, %block_.L_40e495 ], [ %call2_40e4b1, %block_.L_40e4d6 ]
  %405 = add i64 %404, -32
  %406 = add i64 %403, 3
  ...
  %call2_40e4de = tail call %struct.Memory* @sub_40c100._Z9check_sumIiEvT_(%struct.State* %0, i64 %410, %struct.Memory* %MEMORY.4)
...
block_.L_40e4f1:                                  ; preds = %block_.L_40e42f
  %448 = add i64 %102, -55041
  %449 = add i64 %102, 5
  ...
  %call2_40e4f1 = tail call %struct.Memory* @sub_400df0._Z5timerv(%struct.State* %0, i64 %448, %struct.Memory* %MEMORY.0)
  ...
  %call2_40e4fa = tail call %struct.Memory* @sub_400790._Z13record_resultdPKc(%struct.State* %0, i64 %459, %struct.Memory* %call2_40e4f1)
  ...
  ret %struct.Memory* %call2_40e4fa
}
...
define %struct.Memory* @routine_jge_.L_40e4f1(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i8* %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
...
define %struct.Memory* @routine_jl_.L_40e495(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i8* %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 2, i32 9
...
define %struct.Memory* @routine_jmpq_.L_40e461(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
...
define %struct.Memory* @routine_jge_.L_40e490(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i8* %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 2, i32 9
...
define %struct.Memory* @routine_jmpq_.L_40e495(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
...
define %struct.Memory* @routine_jge_.L_40e4db(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i8* %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 2, i32 9
...
define %struct.Memory* @routine_jmpq_.L_40e4a6(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
...
define %struct.Memory* @routine_je_.L_40e4d6(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i8* %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
...
define %struct.Memory* @routine_jmpq_.L_40e4db(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
...
define %struct.Memory* @routine_jmpq_.L_40e42f(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
