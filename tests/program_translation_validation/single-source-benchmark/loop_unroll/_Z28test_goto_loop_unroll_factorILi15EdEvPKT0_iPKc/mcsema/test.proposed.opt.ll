...
block_.L_40371f:                                  ; preds = %block_.L_4037d2, %entry
  %79 = phi i64 [ %.pre, %entry ], [ %429, %block_.L_4037d2 ]
...
block_.L_403797:                                  ; preds = %block_4037c8, %block_403792
  %289 = phi i64 [ %288, %block_403792 ], [ %385, %block_4037c8 ]
  %290 = phi i64 [ %251, %block_403792 ], [ %349, %block_4037c8 ]
  ...
  %call2_4037a4 = tail call %struct.Memory* @sub_401480._Z18complete_hash_funcIdET_S0_(%struct.State* %0, i64 %305, %struct.Memory* %MEMORY.3)
  ...
  br i1 %373, label %block_.L_4037cd, label %block_4037c8
...
block_.L_4037d2:                                  ; preds = %block_.L_403786, %block_.L_4037cd
  %387 = phi i64 [ %287, %block_.L_403786 ], [ %386, %block_.L_4037cd ]
  %388 = phi i64 [ %251, %block_.L_403786 ], [ %349, %block_.L_4037cd ]
  ...
  %call2_4037d7 = tail call %struct.Memory* @sub_4014b0._Z9check_sumIdEvT_(%struct.State* %0, i64 %393, %struct.Memory* %MEMORY.4)
...
block_.L_4037ea:                                  ; preds = %block_.L_40371f
  ...
  %call2_4037ea = tail call %struct.Memory* @sub_400df0._Z5timerv(%struct.State* %0, i64 %430, %struct.Memory* %MEMORY.0)
  ...
  %call2_4037f3 = tail call %struct.Memory* @sub_400790._Z13record_resultdPKc(%struct.State* %0, i64 %441, %struct.Memory* %call2_4037ea)
