...
block_.L_40e2df:                                  ; preds = %block_.L_40e38b, %entry
  %68 = phi i64 [ %.pre, %entry ], [ %445, %block_.L_40e38b ]
...
block_.L_40e356:                                  ; preds = %block_40e381, %block_40e351
  %276 = phi i64 [ %275, %block_40e351 ], [ %400, %block_40e381 ]
  %277 = phi i64 [ %238, %block_40e351 ], [ %364, %block_40e381 ]
  ...
  br i1 %388, label %block_.L_40e386, label %block_40e381
...
block_.L_40e38b:                                  ; preds = %block_.L_40e345, %block_.L_40e386
  %402 = phi i64 [ %274, %block_.L_40e345 ], [ %401, %block_.L_40e386 ]
  %403 = phi i64 [ %238, %block_.L_40e345 ], [ %364, %block_.L_40e386 ]
  ...
  %call2_40e38e = tail call %struct.Memory* @sub_40c100._Z9check_sumIiEvT_(%struct.State* %0, i64 %409, %struct.Memory* %MEMORY.4)
...
block_.L_40e3a1:                                  ; preds = %block_.L_40e2df
  ...
  %call2_40e3a1 = tail call %struct.Memory* @sub_400df0._Z5timerv(%struct.State* %0, i64 %446, %struct.Memory* %MEMORY.0)
  ...
  %call2_40e3aa = tail call %struct.Memory* @sub_400790._Z13record_resultdPKc(%struct.State* %0, i64 %457, %struct.Memory* %call2_40e3a1)
