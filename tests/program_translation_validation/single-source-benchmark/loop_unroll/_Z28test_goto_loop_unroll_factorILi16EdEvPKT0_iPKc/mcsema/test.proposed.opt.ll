...
define %struct.Memory* @_Z28test_goto_loop_unroll_factorILi16EdEvPKT0_iPKc(%struct.State* noalias, i64, %struct.Memory* noalias) local_unnamed_addr #1 {
entry:
  ...
  %call2_4035f3 = tail call %struct.Memory* @sub_400e00._Z11start_timerv(%struct.State* %0, i64 %58, %struct.Memory* %2)
...
block_.L_4035ff:                                  ; preds = %block_.L_4036b2, %entry
  %74 = phi i64 [ %.pre, %entry ], [ %426, %block_.L_4036b2 ]
  %MEMORY.0 = phi %struct.Memory* [ %call2_4035f3, %entry ], [ %call2_4036b7, %block_.L_4036b2 ]
  ...
  br i1 %107, label %block_40360f, label %block_.L_4036ca
...
block_40360f:                                     ; preds = %block_.L_4035ff
  ...
  br i1 %154, label %block_.L_403666, label %block_40362d
...
block_.L_403632:                                  ; preds = %block_40365c, %block_40362d
  %157 = phi i64 [ %118, %block_40362d ], [ %203, %block_40365c ]
  %storemerge = phi i64 [ %156, %block_40362d ], [ %243, %block_40365c ]
  %MEMORY.1 = phi %struct.Memory* [ %MEMORY.0, %block_40362d ], [ %call2_40363d, %block_40365c ]
  %158 = add i64 %157, -40
  ...
  %call2_40363d = tail call %struct.Memory* @sub_401bc0._ZN15loop_inner_bodyILi16EdE7do_workERdPKdi(%struct.State* nonnull %0, i64 %168, %struct.Memory* %MEMORY.1)
  ...
  br i1 %241, label %block_40365c, label %block_.L_403661
...
block_.L_403666:                                  ; preds = %block_.L_403661, %block_40360f
  %246 = phi i64 [ %155, %block_40360f ], [ %245, %block_.L_403661 ]
  %247 = phi i64 [ %118, %block_40360f ], [ %203, %block_.L_403661 ]
  %MEMORY.2 = phi %struct.Memory* [ %MEMORY.0, %block_40360f ], [ %call2_40363d, %block_.L_403661 ]
  %248 = add i64 %247, -44
  %249 = add i64 %246, 3
  ...
  br i1 %282, label %block_403672, label %block_.L_4036b2
...
block_.L_403677:                                  ; preds = %block_4036a8, %block_403672
  %285 = phi i64 [ %247, %block_403672 ], [ %345, %block_4036a8 ]
  %storemerge5 = phi i64 [ %284, %block_403672 ], [ %381, %block_4036a8 ]
  %MEMORY.3 = phi %struct.Memory* [ %MEMORY.2, %block_403672 ], [ %call2_403684, %block_4036a8 ]
  %286 = add i64 %285, -8
  ...
  %call2_403684 = tail call %struct.Memory* @sub_4014b0._Z18complete_hash_funcIdET_S0_(%struct.State* nonnull %0, i64 %300, %struct.Memory* %MEMORY.3)
  ...
  br i1 %369, label %block_.L_4036ad, label %block_4036a8
...
block_.L_4036b2:                                  ; preds = %block_.L_403666, %block_.L_4036ad
  %384 = phi i64 [ %283, %block_.L_403666 ], [ %383, %block_.L_4036ad ]
  %385 = phi i64 [ %247, %block_.L_403666 ], [ %345, %block_.L_4036ad ]
  %MEMORY.4 = phi %struct.Memory* [ %MEMORY.2, %block_.L_403666 ], [ %call2_403684, %block_.L_4036ad ]
  %386 = add i64 %385, -40
  %387 = add i64 %384, 5
  ...
  %call2_4036b7 = tail call %struct.Memory* @sub_4014e0._Z9check_sumIdEvT_(%struct.State* nonnull %0, i64 %390, %struct.Memory* %MEMORY.4)
...
block_.L_4036ca:                                  ; preds = %block_.L_4035ff
  ...
  %call2_4036ca = tail call %struct.Memory* @sub_400e20._Z5timerv(%struct.State* nonnull %0, i64 %427, %struct.Memory* %MEMORY.0)
  ...
  %call2_4036d3 = tail call %struct.Memory* @sub_4007c0._Z13record_resultdPKc(%struct.State* nonnull %0, i64 %438, %struct.Memory* %call2_4036ca)
  ...
  ret %struct.Memory* %call2_4036d3
}
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_jge_.L_4036ca(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i8* nocapture %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_jl_.L_403666(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i8* nocapture %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 2, i32 9
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_jmpq_.L_403632(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_jge_.L_403661(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i8* nocapture %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 2, i32 9
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_jmpq_.L_403666(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_jmpq_.L_403677(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_je_.L_4036ad(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i8* nocapture %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_jmpq_.L_4036b2(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_jmpq_.L_4035ff(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
