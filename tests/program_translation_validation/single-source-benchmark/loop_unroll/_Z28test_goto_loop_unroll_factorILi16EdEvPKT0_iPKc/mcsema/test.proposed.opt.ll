...
block_.L_4035cf:                                  ; preds = %block_.L_403682, %entry
  %79 = phi i64 [ %.pre, %entry ], [ %431, %block_.L_403682 ]
...
block_.L_403647:                                  ; preds = %block_403678, %block_403642
  %291 = phi i64 [ %290, %block_403642 ], [ %387, %block_403678 ]
  %292 = phi i64 [ %253, %block_403642 ], [ %351, %block_403678 ]
  ...
  %call2_403654 = tail call %struct.Memory* @sub_401480._Z18complete_hash_funcIdET_S0_(%struct.State* %0, i64 %307, %struct.Memory* %MEMORY.3)
  ...
  br i1 %375, label %block_.L_40367d, label %block_403678
...
block_.L_403682:                                  ; preds = %block_.L_403636, %block_.L_40367d
  %389 = phi i64 [ %289, %block_.L_403636 ], [ %388, %block_.L_40367d ]
  %390 = phi i64 [ %253, %block_.L_403636 ], [ %351, %block_.L_40367d ]
  ...
  %call2_403687 = tail call %struct.Memory* @sub_4014b0._Z9check_sumIdEvT_(%struct.State* %0, i64 %395, %struct.Memory* %MEMORY.4)
...
block_.L_40369a:                                  ; preds = %block_.L_4035cf
  ...
  %call2_40369a = tail call %struct.Memory* @sub_400df0._Z5timerv(%struct.State* %0, i64 %432, %struct.Memory* %MEMORY.0)
  ...
  %call2_4036a3 = tail call %struct.Memory* @sub_400790._Z13record_resultdPKc(%struct.State* %0, i64 %443, %struct.Memory* %call2_40369a)
