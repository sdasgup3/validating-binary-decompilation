...
entry:
  ...
  %call2_4035c3 = tail call %struct.Memory* @sub_400dd0._Z11start_timerv(%struct.State* %0, i64 %58, %struct.Memory* %2)
...
block_.L_4035cf:                                  ; preds = %block_.L_403682, %entry
  %79 = phi i64 [ %.pre, %entry ], [ %435, %block_.L_403682 ]
  %MEMORY.0 = phi %struct.Memory* [ %call2_4035c3, %entry ], [ %call2_403687, %block_.L_403682 ]
  ...
  br i1 %112, label %block_4035df, label %block_.L_40369a
...
block_4035df:                                     ; preds = %block_.L_4035cf
  ...
  br i1 %160, label %block_.L_403636, label %block_4035fd
...
block_.L_403602:                                  ; preds = %block_40362c, %block_4035fd
  %163 = phi i64 [ %162, %block_4035fd ], [ %250, %block_40362c ]
  %164 = phi i64 [ %124, %block_4035fd ], [ %210, %block_40362c ]
  %MEMORY.1 = phi %struct.Memory* [ %MEMORY.0, %block_4035fd ], [ %call2_40360d, %block_40362c ]
  %165 = add i64 %164, -40
  ...
  %call2_40360d = tail call %struct.Memory* @sub_401b90._ZN15loop_inner_bodyILi16EdE7do_workERdPKdi(%struct.State* %0, i64 %175, %struct.Memory* %MEMORY.1)
  ...
  br i1 %248, label %block_40362c, label %block_.L_403631
...
block_.L_403636:                                  ; preds = %block_.L_403631, %block_4035df
  %252 = phi i64 [ %161, %block_4035df ], [ %251, %block_.L_403631 ]
  %253 = phi i64 [ %124, %block_4035df ], [ %210, %block_.L_403631 ]
  %MEMORY.2 = phi %struct.Memory* [ %MEMORY.0, %block_4035df ], [ %call2_40360d, %block_.L_403631 ]
  %254 = add i64 %253, -44
  %255 = add i64 %252, 3
  ...
  br i1 %288, label %block_403642, label %block_.L_403682
...
block_.L_403647:                                  ; preds = %block_403678, %block_403642
  %291 = phi i64 [ %290, %block_403642 ], [ %389, %block_403678 ]
  %292 = phi i64 [ %253, %block_403642 ], [ %353, %block_403678 ]
  %MEMORY.3 = phi %struct.Memory* [ %MEMORY.2, %block_403642 ], [ %call2_403654, %block_403678 ]
  %293 = add i64 %292, -8
  %294 = add i64 %291, 4
  ...
  %call2_403654 = tail call %struct.Memory* @sub_401480._Z18complete_hash_funcIdET_S0_(%struct.State* %0, i64 %308, %struct.Memory* %MEMORY.3)
  ...
  br i1 %377, label %block_.L_40367d, label %block_403678
...
block_.L_403682:                                  ; preds = %block_.L_403636, %block_.L_40367d
  %391 = phi i64 [ %289, %block_.L_403636 ], [ %390, %block_.L_40367d ]
  %392 = phi i64 [ %253, %block_.L_403636 ], [ %353, %block_.L_40367d ]
  %MEMORY.4 = phi %struct.Memory* [ %MEMORY.2, %block_.L_403636 ], [ %call2_403654, %block_.L_40367d ]
  %393 = add i64 %392, -40
  %394 = add i64 %391, 5
  ...
  %call2_403687 = tail call %struct.Memory* @sub_4014b0._Z9check_sumIdEvT_(%struct.State* %0, i64 %398, %struct.Memory* %MEMORY.4)
...
block_.L_40369a:                                  ; preds = %block_.L_4035cf
  ...
  %call2_40369a = tail call %struct.Memory* @sub_400df0._Z5timerv(%struct.State* %0, i64 %436, %struct.Memory* %MEMORY.0)
  ...
  %call2_4036a3 = tail call %struct.Memory* @sub_400790._Z13record_resultdPKc(%struct.State* %0, i64 %447, %struct.Memory* %call2_40369a)
  ...
  ret %struct.Memory* %call2_4036a3
}
...
define %struct.Memory* @routine_jge_.L_40369a(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i8* %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
...
define %struct.Memory* @routine_jl_.L_403636(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i8* %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 2, i32 9
...
define %struct.Memory* @routine_jmpq_.L_403602(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
...
define %struct.Memory* @routine_jge_.L_403631(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i8* %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 2, i32 9
...
define %struct.Memory* @routine_jmpq_.L_403636(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
...
define %struct.Memory* @routine_jge_.L_403682(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i8* %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 2, i32 9
...
define %struct.Memory* @routine_jmpq_.L_403647(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
...
define %struct.Memory* @routine_je_.L_40367d(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i8* %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
...
define %struct.Memory* @routine_jmpq_.L_403682(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
...
define %struct.Memory* @routine_jmpq_.L_4035cf(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
