...
block_.L_403632:                                  ; preds = %block_40365c, %block_40362d
  ...
  %call2_40363d = tail call %struct.Memory* @sub_401bc0._ZN15loop_inner_bodyILi16EdE7do_workERdPKdi(%struct.State* nonnull %0, i64 %168, %struct.Memory* %MEMORY.0)
...
block_.L_403666:                                  ; preds = %block_.L_403661, %block_40360f
  %246 = phi i64 [ %245, %block_.L_403661 ], [ %155, %block_40360f ]
  %247 = phi i64 [ %203, %block_.L_403661 ], [ %118, %block_40360f ]
  %248 = add i64 %247, -44
  %249 = add i64 %246, 3
...
block_.L_403677:                                  ; preds = %block_4036a8, %block_403672
  ...
  %call2_403684 = tail call %struct.Memory* @sub_4014b0._Z18complete_hash_funcIdET_S0_(%struct.State* nonnull %0, i64 %300, %struct.Memory* %MEMORY.0)
...
block_.L_4036b2:                                  ; preds = %block_.L_403666, %block_.L_4036ad
  ...
  %call2_4036b7 = tail call %struct.Memory* @sub_4014e0._Z9check_sumIdEvT_(%struct.State* nonnull %0, i64 %390, %struct.Memory* %MEMORY.0)
