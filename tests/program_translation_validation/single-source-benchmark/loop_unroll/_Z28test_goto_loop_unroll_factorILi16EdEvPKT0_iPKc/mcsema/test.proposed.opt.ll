...
entry:
  ...
  %call2_403603 = tail call %struct.Memory* @sub_400e10._Z11start_timerv(%struct.State* %0, i64 %58, %struct.Memory* %2)
...
block_.L_40360f:                                  ; preds = %block_.L_4036c2, %entry
  %74 = phi i64 [ %.pre, %entry ], [ %426, %block_.L_4036c2 ]
  %MEMORY.0 = phi %struct.Memory* [ %call2_403603, %entry ], [ %call2_4036c7, %block_.L_4036c2 ]
  ...
  br i1 %107, label %block_40361f, label %block_.L_4036da
...
block_40361f:                                     ; preds = %block_.L_40360f
  ...
  br i1 %154, label %block_.L_403676, label %block_40363d
...
block_.L_403642:                                  ; preds = %block_40366c, %block_40363d
  %157 = phi i64 [ %118, %block_40363d ], [ %203, %block_40366c ]
  %storemerge = phi i64 [ %156, %block_40363d ], [ %243, %block_40366c ]
  %158 = add i64 %157, -40
  ...
  %call2_40364d = tail call %struct.Memory* @sub_401bd0._ZN15loop_inner_bodyILi16EdE7do_workERdPKdi(%struct.State* nonnull %0, i64 %168, %struct.Memory* %MEMORY.0)
  ...
  br i1 %241, label %block_40366c, label %block_.L_403671
...
block_.L_403676:                                  ; preds = %block_.L_403671, %block_40361f
  %246 = phi i64 [ %245, %block_.L_403671 ], [ %155, %block_40361f ]
  %247 = phi i64 [ %203, %block_.L_403671 ], [ %118, %block_40361f ]
  %248 = add i64 %247, -44
  %249 = add i64 %246, 3
  ...
  br i1 %282, label %block_403682, label %block_.L_4036c2
...
block_.L_403687:                                  ; preds = %block_4036b8, %block_403682
  %285 = phi i64 [ %247, %block_403682 ], [ %345, %block_4036b8 ]
  %storemerge5 = phi i64 [ %284, %block_403682 ], [ %381, %block_4036b8 ]
  %286 = add i64 %285, -8
  ...
  %call2_403694 = tail call %struct.Memory* @sub_4014c0._Z18complete_hash_funcIdET_S0_(%struct.State* nonnull %0, i64 %300, %struct.Memory* %MEMORY.0)
  ...
  br i1 %369, label %block_.L_4036bd, label %block_4036b8
...
block_.L_4036c2:                                  ; preds = %block_.L_403676, %block_.L_4036bd
  %384 = phi i64 [ %283, %block_.L_403676 ], [ %383, %block_.L_4036bd ]
  %385 = phi i64 [ %247, %block_.L_403676 ], [ %345, %block_.L_4036bd ]
  %386 = add i64 %385, -40
  %387 = add i64 %384, 5
  ...
  %call2_4036c7 = tail call %struct.Memory* @sub_4014f0._Z9check_sumIdEvT_(%struct.State* nonnull %0, i64 %390, %struct.Memory* %MEMORY.0)
...
block_.L_4036da:                                  ; preds = %block_.L_40360f
  ...
  %call2_4036da = tail call %struct.Memory* @sub_400e30._Z5timerv(%struct.State* nonnull %0, i64 %427, %struct.Memory* %MEMORY.0)
  ...
  %call2_4036e3 = tail call %struct.Memory* @sub_4007d0._Z13record_resultdPKc(%struct.State* nonnull %0, i64 %438, %struct.Memory* %call2_4036da)
