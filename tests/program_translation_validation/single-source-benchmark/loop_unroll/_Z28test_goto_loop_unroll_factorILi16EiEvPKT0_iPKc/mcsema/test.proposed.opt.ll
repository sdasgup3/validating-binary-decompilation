...
block_.L_40e18f:                                  ; preds = %block_.L_40e23b, %entry
  %68 = phi i64 [ %.pre, %entry ], [ %449, %block_.L_40e23b ]
...
block_.L_40e206:                                  ; preds = %block_40e231, %block_40e201
  %278 = phi i64 [ %277, %block_40e201 ], [ %403, %block_40e231 ]
  %279 = phi i64 [ %240, %block_40e201 ], [ %367, %block_40e231 ]
  ...
  br i1 %391, label %block_.L_40e236, label %block_40e231
...
block_.L_40e23b:                                  ; preds = %block_.L_40e1f5, %block_.L_40e236
  %405 = phi i64 [ %276, %block_.L_40e1f5 ], [ %404, %block_.L_40e236 ]
  %406 = phi i64 [ %240, %block_.L_40e1f5 ], [ %367, %block_.L_40e236 ]
  ...
  %call2_40e23e = tail call %struct.Memory* @sub_40c100._Z9check_sumIiEvT_(%struct.State* %0, i64 %412, %struct.Memory* %MEMORY.4)
...
block_.L_40e251:                                  ; preds = %block_.L_40e18f
  ...
  %call2_40e251 = tail call %struct.Memory* @sub_400df0._Z5timerv(%struct.State* %0, i64 %450, %struct.Memory* %MEMORY.0)
  ...
  %call2_40e25a = tail call %struct.Memory* @sub_400790._Z13record_resultdPKc(%struct.State* %0, i64 %461, %struct.Memory* %call2_40e251)
