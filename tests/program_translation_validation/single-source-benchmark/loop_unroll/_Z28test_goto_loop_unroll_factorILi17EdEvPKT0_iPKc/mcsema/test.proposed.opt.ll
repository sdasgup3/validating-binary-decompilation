...
entry:
  ...
  %call2_4034b3 = tail call %struct.Memory* @sub_400e10._Z11start_timerv(%struct.State* %0, i64 %58, %struct.Memory* %2)
...
block_.L_4034bf:                                  ; preds = %block_.L_403572, %entry
  %74 = phi i64 [ %.pre, %entry ], [ %426, %block_.L_403572 ]
  %MEMORY.0 = phi %struct.Memory* [ %call2_4034b3, %entry ], [ %call2_403577, %block_.L_403572 ]
  ...
  br i1 %107, label %block_4034cf, label %block_.L_40358a
...
block_4034cf:                                     ; preds = %block_.L_4034bf
  ...
  br i1 %154, label %block_.L_403526, label %block_4034ed
...
block_.L_4034f2:                                  ; preds = %block_40351c, %block_4034ed
  %157 = phi i64 [ %118, %block_4034ed ], [ %203, %block_40351c ]
  %storemerge = phi i64 [ %156, %block_4034ed ], [ %243, %block_40351c ]
  %158 = add i64 %157, -40
  ...
  %call2_4034fd = tail call %struct.Memory* @sub_401b70._ZN15loop_inner_bodyILi17EdE7do_workERdPKdi(%struct.State* nonnull %0, i64 %168, %struct.Memory* %MEMORY.0)
  ...
  br i1 %241, label %block_40351c, label %block_.L_403521
...
block_.L_403526:                                  ; preds = %block_.L_403521, %block_4034cf
  %246 = phi i64 [ %245, %block_.L_403521 ], [ %155, %block_4034cf ]
  %247 = phi i64 [ %203, %block_.L_403521 ], [ %118, %block_4034cf ]
  %248 = add i64 %247, -44
  %249 = add i64 %246, 3
  ...
  br i1 %282, label %block_403532, label %block_.L_403572
...
block_.L_403537:                                  ; preds = %block_403568, %block_403532
  %285 = phi i64 [ %247, %block_403532 ], [ %345, %block_403568 ]
  %storemerge5 = phi i64 [ %284, %block_403532 ], [ %381, %block_403568 ]
  %286 = add i64 %285, -8
  ...
  %call2_403544 = tail call %struct.Memory* @sub_4014c0._Z18complete_hash_funcIdET_S0_(%struct.State* nonnull %0, i64 %300, %struct.Memory* %MEMORY.0)
  ...
  br i1 %369, label %block_.L_40356d, label %block_403568
...
block_.L_403572:                                  ; preds = %block_.L_403526, %block_.L_40356d
  %384 = phi i64 [ %283, %block_.L_403526 ], [ %383, %block_.L_40356d ]
  %385 = phi i64 [ %247, %block_.L_403526 ], [ %345, %block_.L_40356d ]
  %386 = add i64 %385, -40
  %387 = add i64 %384, 5
  ...
  %call2_403577 = tail call %struct.Memory* @sub_4014f0._Z9check_sumIdEvT_(%struct.State* nonnull %0, i64 %390, %struct.Memory* %MEMORY.0)
...
block_.L_40358a:                                  ; preds = %block_.L_4034bf
  ...
  %call2_40358a = tail call %struct.Memory* @sub_400e30._Z5timerv(%struct.State* nonnull %0, i64 %427, %struct.Memory* %MEMORY.0)
  ...
  %call2_403593 = tail call %struct.Memory* @sub_4007d0._Z13record_resultdPKc(%struct.State* nonnull %0, i64 %438, %struct.Memory* %call2_40358a)
