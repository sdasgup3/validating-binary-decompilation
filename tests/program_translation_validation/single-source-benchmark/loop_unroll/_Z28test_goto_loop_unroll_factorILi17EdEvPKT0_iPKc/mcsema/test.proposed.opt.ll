...
entry:
  ...
  %call2_403473 = tail call %struct.Memory* @sub_400dd0._Z11start_timerv(%struct.State* %0, i64 %58, %struct.Memory* %2)
...
block_.L_40347f:                                  ; preds = %block_.L_403532, %entry
  %79 = phi i64 [ %.pre, %entry ], [ %435, %block_.L_403532 ]
  %MEMORY.0 = phi %struct.Memory* [ %call2_403473, %entry ], [ %call2_403537, %block_.L_403532 ]
  ...
  br i1 %112, label %block_40348f, label %block_.L_40354a
...
block_40348f:                                     ; preds = %block_.L_40347f
  ...
  br i1 %160, label %block_.L_4034e6, label %block_4034ad
...
block_.L_4034b2:                                  ; preds = %block_4034dc, %block_4034ad
  %163 = phi i64 [ %162, %block_4034ad ], [ %250, %block_4034dc ]
  %164 = phi i64 [ %124, %block_4034ad ], [ %210, %block_4034dc ]
  %MEMORY.1 = phi %struct.Memory* [ %MEMORY.0, %block_4034ad ], [ %call2_4034bd, %block_4034dc ]
  %165 = add i64 %164, -40
  ...
  %call2_4034bd = tail call %struct.Memory* @sub_401b30._ZN15loop_inner_bodyILi17EdE7do_workERdPKdi(%struct.State* %0, i64 %175, %struct.Memory* %MEMORY.1)
  ...
  br i1 %248, label %block_4034dc, label %block_.L_4034e1
...
block_.L_4034e6:                                  ; preds = %block_.L_4034e1, %block_40348f
  %252 = phi i64 [ %161, %block_40348f ], [ %251, %block_.L_4034e1 ]
  %253 = phi i64 [ %124, %block_40348f ], [ %210, %block_.L_4034e1 ]
  %MEMORY.2 = phi %struct.Memory* [ %MEMORY.0, %block_40348f ], [ %call2_4034bd, %block_.L_4034e1 ]
  %254 = add i64 %253, -44
  %255 = add i64 %252, 3
  ...
  br i1 %288, label %block_4034f2, label %block_.L_403532
...
block_.L_4034f7:                                  ; preds = %block_403528, %block_4034f2
  %291 = phi i64 [ %290, %block_4034f2 ], [ %389, %block_403528 ]
  %292 = phi i64 [ %253, %block_4034f2 ], [ %353, %block_403528 ]
  %MEMORY.3 = phi %struct.Memory* [ %MEMORY.2, %block_4034f2 ], [ %call2_403504, %block_403528 ]
  %293 = add i64 %292, -8
  %294 = add i64 %291, 4
  ...
  %call2_403504 = tail call %struct.Memory* @sub_401480._Z18complete_hash_funcIdET_S0_(%struct.State* %0, i64 %308, %struct.Memory* %MEMORY.3)
  ...
  br i1 %377, label %block_.L_40352d, label %block_403528
...
block_.L_403532:                                  ; preds = %block_.L_4034e6, %block_.L_40352d
  %391 = phi i64 [ %289, %block_.L_4034e6 ], [ %390, %block_.L_40352d ]
  %392 = phi i64 [ %253, %block_.L_4034e6 ], [ %353, %block_.L_40352d ]
  %MEMORY.4 = phi %struct.Memory* [ %MEMORY.2, %block_.L_4034e6 ], [ %call2_403504, %block_.L_40352d ]
  %393 = add i64 %392, -40
  %394 = add i64 %391, 5
  ...
  %call2_403537 = tail call %struct.Memory* @sub_4014b0._Z9check_sumIdEvT_(%struct.State* %0, i64 %398, %struct.Memory* %MEMORY.4)
...
block_.L_40354a:                                  ; preds = %block_.L_40347f
  ...
  %call2_40354a = tail call %struct.Memory* @sub_400df0._Z5timerv(%struct.State* %0, i64 %436, %struct.Memory* %MEMORY.0)
  ...
  %call2_403553 = tail call %struct.Memory* @sub_400790._Z13record_resultdPKc(%struct.State* %0, i64 %447, %struct.Memory* %call2_40354a)
  ...
  ret %struct.Memory* %call2_403553
}
...
define %struct.Memory* @routine_jge_.L_40354a(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i8* %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
...
define %struct.Memory* @routine_cmpl__0x11___eax(%struct.State* dereferenceable(3376), i64, %struct.Memory*) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 1, i32 0
  %EAX = bitcast %union.anon* %3 to i32*
...
define %struct.Memory* @routine_jl_.L_4034e6(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i8* %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 2, i32 9
...
define %struct.Memory* @routine_jmpq_.L_4034b2(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
...
define %struct.Memory* @routine_subl__0x10___eax(%struct.State* dereferenceable(3376), i64, %struct.Memory*) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %RAX = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 1, i32 0, i32 0
  %3 = load i64, i64* %RAX, align 8
...
define %struct.Memory* @routine_jge_.L_4034e1(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i8* %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 2, i32 9
...
define %struct.Memory* @routine_jmpq_.L_4034e6(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
...
define %struct.Memory* @routine_jge_.L_403532(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i8* %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 2, i32 9
...
define %struct.Memory* @routine_jmpq_.L_4034f7(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
...
define %struct.Memory* @routine_je_.L_40352d(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i8* %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
...
define %struct.Memory* @routine_jmpq_.L_403532(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
...
define %struct.Memory* @routine_jmpq_.L_40347f(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
