...
block_.L_4034e2:                                  ; preds = %block_40350c, %block_4034dd
  ...
  %call2_4034ed = tail call %struct.Memory* @sub_401b60._ZN15loop_inner_bodyILi17EdE7do_workERdPKdi(%struct.State* nonnull %0, i64 %168, %struct.Memory* %MEMORY.0)
...
block_.L_403516:                                  ; preds = %block_.L_403511, %block_4034bf
  %246 = phi i64 [ %245, %block_.L_403511 ], [ %155, %block_4034bf ]
  %247 = phi i64 [ %203, %block_.L_403511 ], [ %118, %block_4034bf ]
  %248 = add i64 %247, -44
  %249 = add i64 %246, 3
...
block_.L_403527:                                  ; preds = %block_403558, %block_403522
  ...
  %call2_403534 = tail call %struct.Memory* @sub_4014b0._Z18complete_hash_funcIdET_S0_(%struct.State* nonnull %0, i64 %300, %struct.Memory* %MEMORY.0)
...
block_.L_403562:                                  ; preds = %block_.L_403516, %block_.L_40355d
  ...
  %call2_403567 = tail call %struct.Memory* @sub_4014e0._Z9check_sumIdEvT_(%struct.State* nonnull %0, i64 %390, %struct.Memory* %MEMORY.0)
