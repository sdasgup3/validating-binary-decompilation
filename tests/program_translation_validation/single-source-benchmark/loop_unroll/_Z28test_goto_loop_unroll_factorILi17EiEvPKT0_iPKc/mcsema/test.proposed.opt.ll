...
entry:
  ...
  %call2_40e033 = tail call %struct.Memory* @sub_400dd0._Z11start_timerv(%struct.State* %0, i64 %58, %struct.Memory* %2)
...
block_.L_40e03f:                                  ; preds = %block_.L_40e0eb, %entry
  %68 = phi i64 [ %.pre, %entry ], [ %447, %block_.L_40e0eb ]
  %MEMORY.0 = phi %struct.Memory* [ %call2_40e033, %entry ], [ %call2_40e0ee, %block_.L_40e0eb ]
  ...
  br i1 %101, label %block_40e04f, label %block_.L_40e101

block_40e04f:                                     ; preds = %block_.L_40e03f
  %103 = add i64 %69, -32
  %104 = add i64 %102, 7
  ...
  br i1 %147, label %block_.L_40e0a5, label %block_40e06c

block_40e06c:                                     ; preds = %block_40e04f
  %149 = add i64 %148, 5
  br label %block_.L_40e071

block_.L_40e071:                                  ; preds = %block_40e09b, %block_40e06c
  %150 = phi i64 [ %149, %block_40e06c ], [ %237, %block_40e09b ]
  %151 = phi i64 [ %111, %block_40e06c ], [ %197, %block_40e09b ]
  %MEMORY.1 = phi %struct.Memory* [ %MEMORY.0, %block_40e06c ], [ %call2_40e07c, %block_40e09b ]
  %152 = add i64 %151, -32
  ...
  %call2_40e07c = tail call %struct.Memory* @sub_40c6f0._ZN15loop_inner_bodyILi17EiE7do_workERiPKii(%struct.State* %0, i64 %162, %struct.Memory* %MEMORY.1)
  ...
  br i1 %235, label %block_40e09b, label %block_.L_40e0a0

block_40e09b:                                     ; preds = %block_.L_40e071
  %237 = add i64 %236, -42
  br label %block_.L_40e071

block_.L_40e0a0:                                  ; preds = %block_.L_40e071
  %238 = add i64 %236, 5
  store i64 %238, i64* %3, align 8
  br label %block_.L_40e0a5

block_.L_40e0a5:                                  ; preds = %block_.L_40e0a0, %block_40e04f
  %239 = phi i64 [ %148, %block_40e04f ], [ %238, %block_.L_40e0a0 ]
  %240 = phi i64 [ %111, %block_40e04f ], [ %197, %block_.L_40e0a0 ]
  %MEMORY.2 = phi %struct.Memory* [ %MEMORY.0, %block_40e04f ], [ %call2_40e07c, %block_.L_40e0a0 ]
  %241 = add i64 %240, -36
  %242 = add i64 %239, 3
  ...
  br i1 %275, label %block_40e0b1, label %block_.L_40e0eb

block_40e0b1:                                     ; preds = %block_.L_40e0a5
  %277 = add i64 %276, 5
  br label %block_.L_40e0b6

block_.L_40e0b6:                                  ; preds = %block_40e0e1, %block_40e0b1
  %278 = phi i64 [ %277, %block_40e0b1 ], [ %402, %block_40e0e1 ]
  %279 = phi i64 [ %240, %block_40e0b1 ], [ %366, %block_40e0e1 ]
  %MEMORY.3 = phi %struct.Memory* [ %MEMORY.2, %block_40e0b1 ], [ %call2_40e0c1, %block_40e0e1 ]
  %280 = add i64 %279, -8
  %281 = add i64 %278, 4
  ...
  %call2_40e0c1 = tail call %struct.Memory* @sub_40c0d0._Z18complete_hash_funcIiET_S0_(%struct.State* %0, i64 %295, %struct.Memory* %MEMORY.3)
  ...
  br i1 %390, label %block_.L_40e0e6, label %block_40e0e1

block_40e0e1:                                     ; preds = %block_.L_40e0b6
  %402 = add i64 %401, -43
  br label %block_.L_40e0b6

block_.L_40e0e6:                                  ; preds = %block_.L_40e0b6
  %403 = add i64 %401, 5
  store i64 %403, i64* %3, align 8
  br label %block_.L_40e0eb

block_.L_40e0eb:                                  ; preds = %block_.L_40e0a5, %block_.L_40e0e6
  %404 = phi i64 [ %276, %block_.L_40e0a5 ], [ %403, %block_.L_40e0e6 ]
  %405 = phi i64 [ %240, %block_.L_40e0a5 ], [ %366, %block_.L_40e0e6 ]
  %MEMORY.4 = phi %struct.Memory* [ %MEMORY.2, %block_.L_40e0a5 ], [ %call2_40e0c1, %block_.L_40e0e6 ]
  %406 = add i64 %405, -32
  %407 = add i64 %404, 3
  ...
  %call2_40e0ee = tail call %struct.Memory* @sub_40c100._Z9check_sumIiEvT_(%struct.State* %0, i64 %411, %struct.Memory* %MEMORY.4)
...
block_.L_40e101:                                  ; preds = %block_.L_40e03f
  ...
  %call2_40e101 = tail call %struct.Memory* @sub_400df0._Z5timerv(%struct.State* %0, i64 %448, %struct.Memory* %MEMORY.0)
  ...
  %call2_40e10a = tail call %struct.Memory* @sub_400790._Z13record_resultdPKc(%struct.State* %0, i64 %459, %struct.Memory* %call2_40e101)
  ...
  ret %struct.Memory* %call2_40e10a
}
...
define %struct.Memory* @routine_jge_.L_40e101(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i8* %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
...
define %struct.Memory* @routine_jl_.L_40e0a5(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i8* %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 2, i32 9
...
define %struct.Memory* @routine_jmpq_.L_40e071(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
...
define %struct.Memory* @routine_jge_.L_40e0a0(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i8* %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 2, i32 9
...
define %struct.Memory* @routine_jmpq_.L_40e0a5(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
...
define %struct.Memory* @routine_jge_.L_40e0eb(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i8* %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 2, i32 9
...
define %struct.Memory* @routine_jmpq_.L_40e0b6(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
...
define %struct.Memory* @routine_je_.L_40e0e6(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i8* %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
...
define %struct.Memory* @routine_jmpq_.L_40e0eb(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
...
define %struct.Memory* @routine_jmpq_.L_40e03f(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
