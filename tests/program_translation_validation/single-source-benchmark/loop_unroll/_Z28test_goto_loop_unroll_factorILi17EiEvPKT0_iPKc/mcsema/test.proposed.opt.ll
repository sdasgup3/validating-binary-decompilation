...
block_.L_40e03f:                                  ; preds = %block_.L_40e0eb, %entry
  %68 = phi i64 [ %.pre, %entry ], [ %449, %block_.L_40e0eb ]
...
block_.L_40e0b6:                                  ; preds = %block_40e0e1, %block_40e0b1
  %278 = phi i64 [ %277, %block_40e0b1 ], [ %403, %block_40e0e1 ]
  %279 = phi i64 [ %240, %block_40e0b1 ], [ %367, %block_40e0e1 ]
  ...
  br i1 %391, label %block_.L_40e0e6, label %block_40e0e1
...
block_.L_40e0eb:                                  ; preds = %block_.L_40e0a5, %block_.L_40e0e6
  %405 = phi i64 [ %276, %block_.L_40e0a5 ], [ %404, %block_.L_40e0e6 ]
  %406 = phi i64 [ %240, %block_.L_40e0a5 ], [ %367, %block_.L_40e0e6 ]
  ...
  %call2_40e0ee = tail call %struct.Memory* @sub_40c100._Z9check_sumIiEvT_(%struct.State* %0, i64 %412, %struct.Memory* %MEMORY.4)
...
block_.L_40e101:                                  ; preds = %block_.L_40e03f
  ...
  %call2_40e101 = tail call %struct.Memory* @sub_400df0._Z5timerv(%struct.State* %0, i64 %450, %struct.Memory* %MEMORY.0)
  ...
  %call2_40e10a = tail call %struct.Memory* @sub_400790._Z13record_resultdPKc(%struct.State* %0, i64 %461, %struct.Memory* %call2_40e101)
