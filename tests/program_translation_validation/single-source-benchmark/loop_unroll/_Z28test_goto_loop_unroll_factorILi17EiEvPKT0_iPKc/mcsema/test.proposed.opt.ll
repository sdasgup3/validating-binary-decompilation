...
define %struct.Memory* @_Z28test_goto_loop_unroll_factorILi17EiEvPKT0_iPKc(%struct.State* noalias, i64, %struct.Memory* noalias readnone) local_unnamed_addr #1 {
entry:
...
block_.L_40e0a1:                                  ; preds = %block_40e0cb, %block_40e09c
  ...
  %call2_40e0ac = tail call %struct.Memory* @sub_40c720._ZN15loop_inner_bodyILi17EiE7do_workERiPKii(%struct.State* nonnull %0, i64 %161, %struct.Memory* %MEMORY.0)
...
block_.L_40e0d5:                                  ; preds = %block_.L_40e0d0, %block_40e07f
  %239 = phi i64 [ %238, %block_.L_40e0d0 ], [ %148, %block_40e07f ]
  %240 = phi i64 [ %196, %block_.L_40e0d0 ], [ %111, %block_40e07f ]
  %241 = add i64 %240, -36
  %242 = add i64 %239, 3
...
block_.L_40e0e6:                                  ; preds = %block_40e111, %block_40e0e1
  ...
  %call2_40e0f1 = tail call %struct.Memory* @sub_40c100._Z18complete_hash_funcIiET_S0_(%struct.State* nonnull %0, i64 %294, %struct.Memory* %MEMORY.0)
...
block_.L_40e11b:                                  ; preds = %block_.L_40e0d5, %block_.L_40e116
  ...
  %call2_40e11e = tail call %struct.Memory* @sub_40c130._Z9check_sumIiEvT_(%struct.State* nonnull %0, i64 %411, %struct.Memory* %MEMORY.0)
