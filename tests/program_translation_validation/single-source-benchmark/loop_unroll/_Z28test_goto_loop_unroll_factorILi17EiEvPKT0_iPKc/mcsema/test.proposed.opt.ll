...
entry:
  ...
  %call2_40e073 = tail call %struct.Memory* @sub_400e10._Z11start_timerv(%struct.State* %0, i64 %58, %struct.Memory* %2)
...
block_.L_40e07f:                                  ; preds = %block_.L_40e12b, %entry
  %68 = phi i64 [ %.pre, %entry ], [ %447, %block_.L_40e12b ]
  %MEMORY.0 = phi %struct.Memory* [ %call2_40e073, %entry ], [ %call2_40e12e, %block_.L_40e12b ]
  ...
  br i1 %101, label %block_40e08f, label %block_.L_40e141

block_40e08f:                                     ; preds = %block_.L_40e07f
  %103 = add i64 %69, -32
  %104 = add i64 %102, 7
  ...
  br i1 %147, label %block_.L_40e0e5, label %block_40e0ac

block_40e0ac:                                     ; preds = %block_40e08f
  %149 = add i64 %148, 5
  br label %block_.L_40e0b1

block_.L_40e0b1:                                  ; preds = %block_40e0db, %block_40e0ac
  %150 = phi i64 [ %111, %block_40e0ac ], [ %196, %block_40e0db ]
  %storemerge = phi i64 [ %149, %block_40e0ac ], [ %236, %block_40e0db ]
  %151 = add i64 %150, -32
  ...
  %call2_40e0bc = tail call %struct.Memory* @sub_40c730._ZN15loop_inner_bodyILi17EiE7do_workERiPKii(%struct.State* nonnull %0, i64 %161, %struct.Memory* %MEMORY.0)
  ...
  br i1 %234, label %block_40e0db, label %block_.L_40e0e0

block_40e0db:                                     ; preds = %block_.L_40e0b1
  %236 = add i64 %235, -42
  %237 = add i64 %235, 5
  store i64 %237, i64* %3, align 8
  br label %block_.L_40e0b1

block_.L_40e0e0:                                  ; preds = %block_.L_40e0b1
  %238 = add i64 %235, 5
  store i64 %238, i64* %3, align 8
  br label %block_.L_40e0e5

block_.L_40e0e5:                                  ; preds = %block_.L_40e0e0, %block_40e08f
  %239 = phi i64 [ %238, %block_.L_40e0e0 ], [ %148, %block_40e08f ]
  %240 = phi i64 [ %196, %block_.L_40e0e0 ], [ %111, %block_40e08f ]
  %241 = add i64 %240, -36
  %242 = add i64 %239, 3
  ...
  br i1 %275, label %block_40e0f1, label %block_.L_40e12b

block_40e0f1:                                     ; preds = %block_.L_40e0e5
  %277 = add i64 %276, 5
  br label %block_.L_40e0f6

block_.L_40e0f6:                                  ; preds = %block_40e121, %block_40e0f1
  %278 = phi i64 [ %240, %block_40e0f1 ], [ %365, %block_40e121 ]
  %storemerge5 = phi i64 [ %277, %block_40e0f1 ], [ %401, %block_40e121 ]
  %279 = add i64 %278, -8
  ...
  %call2_40e101 = tail call %struct.Memory* @sub_40c110._Z18complete_hash_funcIiET_S0_(%struct.State* nonnull %0, i64 %294, %struct.Memory* %MEMORY.0)
  ...
  br i1 %389, label %block_.L_40e126, label %block_40e121

block_40e121:                                     ; preds = %block_.L_40e0f6
  %401 = add i64 %400, -43
  %402 = add i64 %400, 5
  store i64 %402, i64* %3, align 8
  br label %block_.L_40e0f6

block_.L_40e126:                                  ; preds = %block_.L_40e0f6
  %403 = add i64 %400, 5
  store i64 %403, i64* %3, align 8
  br label %block_.L_40e12b

block_.L_40e12b:                                  ; preds = %block_.L_40e0e5, %block_.L_40e126
  %404 = phi i64 [ %276, %block_.L_40e0e5 ], [ %403, %block_.L_40e126 ]
  %405 = phi i64 [ %240, %block_.L_40e0e5 ], [ %365, %block_.L_40e126 ]
  %406 = add i64 %405, -32
  %407 = add i64 %404, 3
  ...
  %call2_40e12e = tail call %struct.Memory* @sub_40c140._Z9check_sumIiEvT_(%struct.State* nonnull %0, i64 %411, %struct.Memory* %MEMORY.0)
...
block_.L_40e141:                                  ; preds = %block_.L_40e07f
  ...
  %call2_40e141 = tail call %struct.Memory* @sub_400e30._Z5timerv(%struct.State* nonnull %0, i64 %448, %struct.Memory* %MEMORY.0)
  ...
  %call2_40e14a = tail call %struct.Memory* @sub_4007d0._Z13record_resultdPKc(%struct.State* nonnull %0, i64 %459, %struct.Memory* %call2_40e141)
