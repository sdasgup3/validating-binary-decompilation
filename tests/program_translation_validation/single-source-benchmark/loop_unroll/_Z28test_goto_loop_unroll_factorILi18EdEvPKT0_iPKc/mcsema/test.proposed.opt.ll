...
entry:
  ...
  %call2_403363 = tail call %struct.Memory* @sub_400e10._Z11start_timerv(%struct.State* %0, i64 %58, %struct.Memory* %2)
...
block_.L_40336f:                                  ; preds = %block_.L_403422, %entry
  %74 = phi i64 [ %.pre, %entry ], [ %426, %block_.L_403422 ]
  %MEMORY.0 = phi %struct.Memory* [ %call2_403363, %entry ], [ %call2_403427, %block_.L_403422 ]
  ...
  br i1 %107, label %block_40337f, label %block_.L_40343a

block_40337f:                                     ; preds = %block_.L_40336f
  ...
  br i1 %154, label %block_.L_4033d6, label %block_40339d

block_40339d:                                     ; preds = %block_40337f
  %156 = add i64 %155, 5
  br label %block_.L_4033a2

block_.L_4033a2:                                  ; preds = %block_4033cc, %block_40339d
  %157 = phi i64 [ %118, %block_40339d ], [ %203, %block_4033cc ]
  %storemerge = phi i64 [ %156, %block_40339d ], [ %243, %block_4033cc ]
  %158 = add i64 %157, -40
  ...
  %call2_4033ad = tail call %struct.Memory* @sub_401b10._ZN15loop_inner_bodyILi18EdE7do_workERdPKdi(%struct.State* nonnull %0, i64 %168, %struct.Memory* %MEMORY.0)
  ...
  br i1 %241, label %block_4033cc, label %block_.L_4033d1

block_4033cc:                                     ; preds = %block_.L_4033a2
  %243 = add i64 %242, -42
  %244 = add i64 %242, 5
  store i64 %244, i64* %3, align 8
  br label %block_.L_4033a2

block_.L_4033d1:                                  ; preds = %block_.L_4033a2
  %245 = add i64 %242, 5
  store i64 %245, i64* %3, align 8
  br label %block_.L_4033d6

block_.L_4033d6:                                  ; preds = %block_.L_4033d1, %block_40337f
  %246 = phi i64 [ %245, %block_.L_4033d1 ], [ %155, %block_40337f ]
  %247 = phi i64 [ %203, %block_.L_4033d1 ], [ %118, %block_40337f ]
  %248 = add i64 %247, -44
  %249 = add i64 %246, 3
  ...
  br i1 %282, label %block_4033e2, label %block_.L_403422

block_4033e2:                                     ; preds = %block_.L_4033d6
  %284 = add i64 %283, 5
  br label %block_.L_4033e7

block_.L_4033e7:                                  ; preds = %block_403418, %block_4033e2
  %285 = phi i64 [ %247, %block_4033e2 ], [ %345, %block_403418 ]
  %storemerge5 = phi i64 [ %284, %block_4033e2 ], [ %381, %block_403418 ]
  %286 = add i64 %285, -8
  ...
  %call2_4033f4 = tail call %struct.Memory* @sub_4014c0._Z18complete_hash_funcIdET_S0_(%struct.State* nonnull %0, i64 %300, %struct.Memory* %MEMORY.0)
  ...
  br i1 %369, label %block_.L_40341d, label %block_403418

block_403418:                                     ; preds = %block_.L_4033e7
  %381 = add i64 %380, -49
  %382 = add i64 %380, 5
  store i64 %382, i64* %3, align 8
  br label %block_.L_4033e7

block_.L_40341d:                                  ; preds = %block_.L_4033e7
  %383 = add i64 %380, 5
  store i64 %383, i64* %3, align 8
  br label %block_.L_403422

block_.L_403422:                                  ; preds = %block_.L_4033d6, %block_.L_40341d
  %384 = phi i64 [ %283, %block_.L_4033d6 ], [ %383, %block_.L_40341d ]
  %385 = phi i64 [ %247, %block_.L_4033d6 ], [ %345, %block_.L_40341d ]
  %386 = add i64 %385, -40
  %387 = add i64 %384, 5
  ...
  %call2_403427 = tail call %struct.Memory* @sub_4014f0._Z9check_sumIdEvT_(%struct.State* nonnull %0, i64 %390, %struct.Memory* %MEMORY.0)
...
block_.L_40343a:                                  ; preds = %block_.L_40336f
  ...
  %call2_40343a = tail call %struct.Memory* @sub_400e30._Z5timerv(%struct.State* nonnull %0, i64 %427, %struct.Memory* %MEMORY.0)
  ...
  %call2_403443 = tail call %struct.Memory* @sub_4007d0._Z13record_resultdPKc(%struct.State* nonnull %0, i64 %438, %struct.Memory* %call2_40343a)
