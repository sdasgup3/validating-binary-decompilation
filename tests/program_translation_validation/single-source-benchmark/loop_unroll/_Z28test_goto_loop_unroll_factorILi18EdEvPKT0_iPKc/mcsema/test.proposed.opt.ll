...
entry:
  ...
  %call2_403323 = tail call %struct.Memory* @sub_400dd0._Z11start_timerv(%struct.State* %0, i64 %58, %struct.Memory* %2)
...
block_.L_40332f:                                  ; preds = %block_.L_4033e2, %entry
  %79 = phi i64 [ %.pre, %entry ], [ %431, %block_.L_4033e2 ]
  %MEMORY.0 = phi %struct.Memory* [ %call2_403323, %entry ], [ %call2_4033e7, %block_.L_4033e2 ]
  ...
  br i1 %112, label %block_40333f, label %block_.L_4033fa

block_40333f:                                     ; preds = %block_.L_40332f
  ...
  br i1 %160, label %block_.L_403396, label %block_40335d

block_40335d:                                     ; preds = %block_40333f
  %162 = add i64 %161, 5
  br label %block_.L_403362

block_.L_403362:                                  ; preds = %block_40338c, %block_40335d
  %163 = phi i64 [ %162, %block_40335d ], [ %250, %block_40338c ]
  %164 = phi i64 [ %124, %block_40335d ], [ %210, %block_40338c ]
  %MEMORY.1 = phi %struct.Memory* [ %MEMORY.0, %block_40335d ], [ %call2_40336d, %block_40338c ]
  %165 = add i64 %164, -40
  ...
  %call2_40336d = tail call %struct.Memory* @sub_401ad0._ZN15loop_inner_bodyILi18EdE7do_workERdPKdi(%struct.State* %0, i64 %175, %struct.Memory* %MEMORY.1)
  ...
  br i1 %248, label %block_40338c, label %block_.L_403391

block_40338c:                                     ; preds = %block_.L_403362
  %250 = add i64 %249, -42
  br label %block_.L_403362

block_.L_403391:                                  ; preds = %block_.L_403362
  %251 = add i64 %249, 5
  store i64 %251, i64* %3, align 8
  br label %block_.L_403396

block_.L_403396:                                  ; preds = %block_.L_403391, %block_40333f
  %252 = phi i64 [ %161, %block_40333f ], [ %251, %block_.L_403391 ]
  %253 = phi i64 [ %124, %block_40333f ], [ %210, %block_.L_403391 ]
  %MEMORY.2 = phi %struct.Memory* [ %MEMORY.0, %block_40333f ], [ %call2_40336d, %block_.L_403391 ]
  %254 = add i64 %253, -44
  %255 = add i64 %252, 3
  ...
  br i1 %288, label %block_4033a2, label %block_.L_4033e2

block_4033a2:                                     ; preds = %block_.L_403396
  %290 = add i64 %289, 5
  br label %block_.L_4033a7

block_.L_4033a7:                                  ; preds = %block_4033d8, %block_4033a2
  %291 = phi i64 [ %290, %block_4033a2 ], [ %387, %block_4033d8 ]
  %292 = phi i64 [ %253, %block_4033a2 ], [ %351, %block_4033d8 ]
  %MEMORY.3 = phi %struct.Memory* [ %MEMORY.2, %block_4033a2 ], [ %call2_4033b4, %block_4033d8 ]
  %293 = add i64 %292, -8
  %294 = add i64 %291, 4
  ...
  %call2_4033b4 = tail call %struct.Memory* @sub_401480._Z18complete_hash_funcIdET_S0_(%struct.State* %0, i64 %307, %struct.Memory* %MEMORY.3)
  ...
  br i1 %375, label %block_.L_4033dd, label %block_4033d8

block_4033d8:                                     ; preds = %block_.L_4033a7
  %387 = add i64 %386, -49
  br label %block_.L_4033a7

block_.L_4033dd:                                  ; preds = %block_.L_4033a7
  %388 = add i64 %386, 5
  store i64 %388, i64* %3, align 8
  br label %block_.L_4033e2

block_.L_4033e2:                                  ; preds = %block_.L_403396, %block_.L_4033dd
  %389 = phi i64 [ %289, %block_.L_403396 ], [ %388, %block_.L_4033dd ]
  %390 = phi i64 [ %253, %block_.L_403396 ], [ %351, %block_.L_4033dd ]
  %MEMORY.4 = phi %struct.Memory* [ %MEMORY.2, %block_.L_403396 ], [ %call2_4033b4, %block_.L_4033dd ]
  %391 = add i64 %390, -40
  %392 = add i64 %389, 5
  ...
  %call2_4033e7 = tail call %struct.Memory* @sub_4014b0._Z9check_sumIdEvT_(%struct.State* %0, i64 %395, %struct.Memory* %MEMORY.4)
...
block_.L_4033fa:                                  ; preds = %block_.L_40332f
  %432 = add i64 %113, -9738
  %433 = add i64 %113, 5
  ...
  %call2_4033fa = tail call %struct.Memory* @sub_400df0._Z5timerv(%struct.State* %0, i64 %432, %struct.Memory* %MEMORY.0)
  ...
  %call2_403403 = tail call %struct.Memory* @sub_400790._Z13record_resultdPKc(%struct.State* %0, i64 %443, %struct.Memory* %call2_4033fa)
  ...
  ret %struct.Memory* %call2_403403
}
...
define %struct.Memory* @routine_jge_.L_4033fa(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i8* %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
...
define %struct.Memory* @routine_cmpl__0x12___eax(%struct.State* dereferenceable(3376), i64, %struct.Memory*) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 1, i32 0
  %EAX = bitcast %union.anon* %3 to i32*
...
define %struct.Memory* @routine_jl_.L_403396(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i8* %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 2, i32 9
...
define %struct.Memory* @routine_jmpq_.L_403362(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
...
define %struct.Memory* @routine_subl__0x11___eax(%struct.State* dereferenceable(3376), i64, %struct.Memory*) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %RAX = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 1, i32 0, i32 0
  %3 = load i64, i64* %RAX, align 8
...
define %struct.Memory* @routine_jge_.L_403391(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i8* %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 2, i32 9
...
define %struct.Memory* @routine_jmpq_.L_403396(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
...
define %struct.Memory* @routine_jge_.L_4033e2(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i8* %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 2, i32 9
...
define %struct.Memory* @routine_jmpq_.L_4033a7(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
...
define %struct.Memory* @routine_je_.L_4033dd(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i8* %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
...
define %struct.Memory* @routine_jmpq_.L_4033e2(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
...
define %struct.Memory* @routine_jmpq_.L_40332f(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
