...
entry:
  ...
  %call2_40dee3 = tail call %struct.Memory* @sub_400dd0._Z11start_timerv(%struct.State* %0, i64 %58, %struct.Memory* %2)
...
block_.L_40deef:                                  ; preds = %block_.L_40df9b, %entry
  %68 = phi i64 [ %.pre, %entry ], [ %449, %block_.L_40df9b ]
  %MEMORY.0 = phi %struct.Memory* [ %call2_40dee3, %entry ], [ %call2_40df9e, %block_.L_40df9b ]
  ...
  br i1 %101, label %block_40deff, label %block_.L_40dfb1
...
block_40deff:                                     ; preds = %block_.L_40deef
  ...
  br i1 %147, label %block_.L_40df55, label %block_40df1c
...
block_.L_40df21:                                  ; preds = %block_40df4b, %block_40df1c
  %150 = phi i64 [ %149, %block_40df1c ], [ %237, %block_40df4b ]
  %151 = phi i64 [ %111, %block_40df1c ], [ %197, %block_40df4b ]
  %MEMORY.1 = phi %struct.Memory* [ %MEMORY.0, %block_40df1c ], [ %call2_40df2c, %block_40df4b ]
  %152 = add i64 %151, -32
  ...
  %call2_40df2c = tail call %struct.Memory* @sub_40c690._ZN15loop_inner_bodyILi18EiE7do_workERiPKii(%struct.State* %0, i64 %162, %struct.Memory* %MEMORY.1)
  ...
  br i1 %235, label %block_40df4b, label %block_.L_40df50
...
block_.L_40df55:                                  ; preds = %block_.L_40df50, %block_40deff
  %239 = phi i64 [ %148, %block_40deff ], [ %238, %block_.L_40df50 ]
  %240 = phi i64 [ %111, %block_40deff ], [ %197, %block_.L_40df50 ]
  %MEMORY.2 = phi %struct.Memory* [ %MEMORY.0, %block_40deff ], [ %call2_40df2c, %block_.L_40df50 ]
  %241 = add i64 %240, -36
  %242 = add i64 %239, 3
  ...
  br i1 %275, label %block_40df61, label %block_.L_40df9b
...
block_.L_40df66:                                  ; preds = %block_40df91, %block_40df61
  %278 = phi i64 [ %277, %block_40df61 ], [ %403, %block_40df91 ]
  %279 = phi i64 [ %240, %block_40df61 ], [ %367, %block_40df91 ]
  %MEMORY.3 = phi %struct.Memory* [ %MEMORY.2, %block_40df61 ], [ %call2_40df71, %block_40df91 ]
  %280 = add i64 %279, -8
  %281 = add i64 %278, 4
  ...
  %call2_40df71 = tail call %struct.Memory* @sub_40c0d0._Z18complete_hash_funcIiET_S0_(%struct.State* %0, i64 %295, %struct.Memory* %MEMORY.3)
  ...
  br i1 %391, label %block_.L_40df96, label %block_40df91
...
block_.L_40df9b:                                  ; preds = %block_.L_40df55, %block_.L_40df96
  %405 = phi i64 [ %276, %block_.L_40df55 ], [ %404, %block_.L_40df96 ]
  %406 = phi i64 [ %240, %block_.L_40df55 ], [ %367, %block_.L_40df96 ]
  %MEMORY.4 = phi %struct.Memory* [ %MEMORY.2, %block_.L_40df55 ], [ %call2_40df71, %block_.L_40df96 ]
  %407 = add i64 %406, -32
  %408 = add i64 %405, 3
  ...
  %call2_40df9e = tail call %struct.Memory* @sub_40c100._Z9check_sumIiEvT_(%struct.State* %0, i64 %412, %struct.Memory* %MEMORY.4)
...
block_.L_40dfb1:                                  ; preds = %block_.L_40deef
  ...
  %call2_40dfb1 = tail call %struct.Memory* @sub_400df0._Z5timerv(%struct.State* %0, i64 %450, %struct.Memory* %MEMORY.0)
  ...
  %call2_40dfba = tail call %struct.Memory* @sub_400790._Z13record_resultdPKc(%struct.State* %0, i64 %461, %struct.Memory* %call2_40dfb1)
  ...
  ret %struct.Memory* %call2_40dfba
}
...
define %struct.Memory* @routine_jge_.L_40dfb1(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i8* %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
...
define %struct.Memory* @routine_jl_.L_40df55(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i8* %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 2, i32 9
...
define %struct.Memory* @routine_jmpq_.L_40df21(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
...
define %struct.Memory* @routine_jge_.L_40df50(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i8* %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 2, i32 9
...
define %struct.Memory* @routine_jmpq_.L_40df55(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
...
define %struct.Memory* @routine_jge_.L_40df9b(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i8* %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 2, i32 9
...
define %struct.Memory* @routine_jmpq_.L_40df66(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
...
define %struct.Memory* @routine_je_.L_40df96(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i8* %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
...
define %struct.Memory* @routine_jmpq_.L_40df9b(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
...
define %struct.Memory* @routine_jmpq_.L_40deef(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
