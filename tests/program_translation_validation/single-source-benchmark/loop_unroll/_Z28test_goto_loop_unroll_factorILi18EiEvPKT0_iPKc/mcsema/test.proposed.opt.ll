...
block_.L_40deef:                                  ; preds = %block_.L_40df9b, %entry
  %68 = phi i64 [ %.pre, %entry ], [ %447, %block_.L_40df9b ]
...
block_.L_40df66:                                  ; preds = %block_40df91, %block_40df61
  %278 = phi i64 [ %277, %block_40df61 ], [ %402, %block_40df91 ]
  %279 = phi i64 [ %240, %block_40df61 ], [ %366, %block_40df91 ]
  ...
  br i1 %390, label %block_.L_40df96, label %block_40df91
...
block_.L_40df9b:                                  ; preds = %block_.L_40df55, %block_.L_40df96
  %404 = phi i64 [ %276, %block_.L_40df55 ], [ %403, %block_.L_40df96 ]
  %405 = phi i64 [ %240, %block_.L_40df55 ], [ %366, %block_.L_40df96 ]
  ...
  %call2_40df9e = tail call %struct.Memory* @sub_40c100._Z9check_sumIiEvT_(%struct.State* %0, i64 %411, %struct.Memory* %MEMORY.4)
...
block_.L_40dfb1:                                  ; preds = %block_.L_40deef
  ...
  %call2_40dfb1 = tail call %struct.Memory* @sub_400df0._Z5timerv(%struct.State* %0, i64 %448, %struct.Memory* %MEMORY.0)
  ...
  %call2_40dfba = tail call %struct.Memory* @sub_400790._Z13record_resultdPKc(%struct.State* %0, i64 %459, %struct.Memory* %call2_40dfb1)
