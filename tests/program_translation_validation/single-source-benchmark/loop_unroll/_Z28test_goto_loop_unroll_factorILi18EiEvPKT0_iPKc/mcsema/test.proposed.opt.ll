...
entry:
  ...
  %call2_40df23 = tail call %struct.Memory* @sub_400e10._Z11start_timerv(%struct.State* %0, i64 %58, %struct.Memory* %2)
...
block_.L_40df2f:                                  ; preds = %block_.L_40dfdb, %entry
  %68 = phi i64 [ %.pre, %entry ], [ %447, %block_.L_40dfdb ]
  %MEMORY.0 = phi %struct.Memory* [ %call2_40df23, %entry ], [ %call2_40dfde, %block_.L_40dfdb ]
  ...
  br i1 %101, label %block_40df3f, label %block_.L_40dff1
...
block_40df3f:                                     ; preds = %block_.L_40df2f
  ...
  br i1 %147, label %block_.L_40df95, label %block_40df5c
...
block_.L_40df61:                                  ; preds = %block_40df8b, %block_40df5c
  %150 = phi i64 [ %111, %block_40df5c ], [ %196, %block_40df8b ]
  %storemerge = phi i64 [ %149, %block_40df5c ], [ %236, %block_40df8b ]
  %151 = add i64 %150, -32
  ...
  %call2_40df6c = tail call %struct.Memory* @sub_40c6d0._ZN15loop_inner_bodyILi18EiE7do_workERiPKii(%struct.State* nonnull %0, i64 %161, %struct.Memory* %MEMORY.0)
  ...
  br i1 %234, label %block_40df8b, label %block_.L_40df90
...
block_.L_40df95:                                  ; preds = %block_.L_40df90, %block_40df3f
  %239 = phi i64 [ %238, %block_.L_40df90 ], [ %148, %block_40df3f ]
  %240 = phi i64 [ %196, %block_.L_40df90 ], [ %111, %block_40df3f ]
  %241 = add i64 %240, -36
  %242 = add i64 %239, 3
  ...
  br i1 %275, label %block_40dfa1, label %block_.L_40dfdb
...
block_.L_40dfa6:                                  ; preds = %block_40dfd1, %block_40dfa1
  %278 = phi i64 [ %240, %block_40dfa1 ], [ %365, %block_40dfd1 ]
  %storemerge5 = phi i64 [ %277, %block_40dfa1 ], [ %401, %block_40dfd1 ]
  %279 = add i64 %278, -8
  ...
  %call2_40dfb1 = tail call %struct.Memory* @sub_40c110._Z18complete_hash_funcIiET_S0_(%struct.State* nonnull %0, i64 %294, %struct.Memory* %MEMORY.0)
  ...
  br i1 %389, label %block_.L_40dfd6, label %block_40dfd1
...
block_.L_40dfdb:                                  ; preds = %block_.L_40df95, %block_.L_40dfd6
  %404 = phi i64 [ %276, %block_.L_40df95 ], [ %403, %block_.L_40dfd6 ]
  %405 = phi i64 [ %240, %block_.L_40df95 ], [ %365, %block_.L_40dfd6 ]
  %406 = add i64 %405, -32
  %407 = add i64 %404, 3
  ...
  %call2_40dfde = tail call %struct.Memory* @sub_40c140._Z9check_sumIiEvT_(%struct.State* nonnull %0, i64 %411, %struct.Memory* %MEMORY.0)
...
block_.L_40dff1:                                  ; preds = %block_.L_40df2f
  ...
  %call2_40dff1 = tail call %struct.Memory* @sub_400e30._Z5timerv(%struct.State* nonnull %0, i64 %448, %struct.Memory* %MEMORY.0)
  ...
  %call2_40dffa = tail call %struct.Memory* @sub_4007d0._Z13record_resultdPKc(%struct.State* nonnull %0, i64 %459, %struct.Memory* %call2_40dff1)
