...
entry:
  ...
  %call2_4031d3 = tail call %struct.Memory* @sub_400dd0._Z11start_timerv(%struct.State* %0, i64 %58, %struct.Memory* %2)
...
block_.L_4031df:                                  ; preds = %block_.L_403292, %entry
  %79 = phi i64 [ %.pre, %entry ], [ %431, %block_.L_403292 ]
  %MEMORY.0 = phi %struct.Memory* [ %call2_4031d3, %entry ], [ %call2_403297, %block_.L_403292 ]
  ...
  br i1 %112, label %block_4031ef, label %block_.L_4032aa
...
block_4031ef:                                     ; preds = %block_.L_4031df
  ...
  br i1 %160, label %block_.L_403246, label %block_40320d
...
block_.L_403212:                                  ; preds = %block_40323c, %block_40320d
  %163 = phi i64 [ %162, %block_40320d ], [ %250, %block_40323c ]
  %164 = phi i64 [ %124, %block_40320d ], [ %210, %block_40323c ]
  %MEMORY.1 = phi %struct.Memory* [ %MEMORY.0, %block_40320d ], [ %call2_40321d, %block_40323c ]
  %165 = add i64 %164, -40
  ...
  %call2_40321d = tail call %struct.Memory* @sub_401a70._ZN15loop_inner_bodyILi19EdE7do_workERdPKdi(%struct.State* %0, i64 %175, %struct.Memory* %MEMORY.1)
  ...
  br i1 %248, label %block_40323c, label %block_.L_403241
...
block_.L_403246:                                  ; preds = %block_.L_403241, %block_4031ef
  %252 = phi i64 [ %161, %block_4031ef ], [ %251, %block_.L_403241 ]
  %253 = phi i64 [ %124, %block_4031ef ], [ %210, %block_.L_403241 ]
  %MEMORY.2 = phi %struct.Memory* [ %MEMORY.0, %block_4031ef ], [ %call2_40321d, %block_.L_403241 ]
  %254 = add i64 %253, -44
  %255 = add i64 %252, 3
  ...
  br i1 %288, label %block_403252, label %block_.L_403292
...
block_.L_403257:                                  ; preds = %block_403288, %block_403252
  %291 = phi i64 [ %290, %block_403252 ], [ %387, %block_403288 ]
  %292 = phi i64 [ %253, %block_403252 ], [ %351, %block_403288 ]
  %MEMORY.3 = phi %struct.Memory* [ %MEMORY.2, %block_403252 ], [ %call2_403264, %block_403288 ]
  %293 = add i64 %292, -8
  %294 = add i64 %291, 4
  ...
  %call2_403264 = tail call %struct.Memory* @sub_401480._Z18complete_hash_funcIdET_S0_(%struct.State* %0, i64 %307, %struct.Memory* %MEMORY.3)
  ...
  br i1 %375, label %block_.L_40328d, label %block_403288
...
block_.L_403292:                                  ; preds = %block_.L_403246, %block_.L_40328d
  %389 = phi i64 [ %289, %block_.L_403246 ], [ %388, %block_.L_40328d ]
  %390 = phi i64 [ %253, %block_.L_403246 ], [ %351, %block_.L_40328d ]
  %MEMORY.4 = phi %struct.Memory* [ %MEMORY.2, %block_.L_403246 ], [ %call2_403264, %block_.L_40328d ]
  %391 = add i64 %390, -40
  %392 = add i64 %389, 5
  ...
  %call2_403297 = tail call %struct.Memory* @sub_4014b0._Z9check_sumIdEvT_(%struct.State* %0, i64 %395, %struct.Memory* %MEMORY.4)
...
block_.L_4032aa:                                  ; preds = %block_.L_4031df
  ...
  %call2_4032aa = tail call %struct.Memory* @sub_400df0._Z5timerv(%struct.State* %0, i64 %432, %struct.Memory* %MEMORY.0)
  ...
  %call2_4032b3 = tail call %struct.Memory* @sub_400790._Z13record_resultdPKc(%struct.State* %0, i64 %443, %struct.Memory* %call2_4032aa)
  ...
  ret %struct.Memory* %call2_4032b3
}
...
define %struct.Memory* @routine_jge_.L_4032aa(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i8* %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
...
define %struct.Memory* @routine_cmpl__0x13___eax(%struct.State* dereferenceable(3376), i64, %struct.Memory*) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 1, i32 0
  %EAX = bitcast %union.anon* %3 to i32*
...
define %struct.Memory* @routine_jl_.L_403246(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i8* %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 2, i32 9
...
define %struct.Memory* @routine_jmpq_.L_403212(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
...
define %struct.Memory* @routine_subl__0x12___eax(%struct.State* dereferenceable(3376), i64, %struct.Memory*) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %RAX = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 1, i32 0, i32 0
  %3 = load i64, i64* %RAX, align 8
...
define %struct.Memory* @routine_jge_.L_403241(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i8* %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 2, i32 9
...
define %struct.Memory* @routine_jmpq_.L_403246(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
...
define %struct.Memory* @routine_jge_.L_403292(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i8* %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 2, i32 9
...
define %struct.Memory* @routine_jmpq_.L_403257(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
...
define %struct.Memory* @routine_je_.L_40328d(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i8* %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
...
define %struct.Memory* @routine_jmpq_.L_403292(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
...
define %struct.Memory* @routine_jmpq_.L_4031df(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
