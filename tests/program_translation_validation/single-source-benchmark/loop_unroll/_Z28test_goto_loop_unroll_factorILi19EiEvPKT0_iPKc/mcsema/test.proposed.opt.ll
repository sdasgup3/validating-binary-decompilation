...
entry:
  ...
  %call2_40ddd3 = tail call %struct.Memory* @sub_400e10._Z11start_timerv(%struct.State* %0, i64 %58, %struct.Memory* %2)
...
block_.L_40dddf:                                  ; preds = %block_.L_40de8b, %entry
  %68 = phi i64 [ %.pre, %entry ], [ %447, %block_.L_40de8b ]
  %MEMORY.0 = phi %struct.Memory* [ %call2_40ddd3, %entry ], [ %call2_40de8e, %block_.L_40de8b ]
  ...
  br i1 %101, label %block_40ddef, label %block_.L_40dea1
...
block_40ddef:                                     ; preds = %block_.L_40dddf
  ...
  br i1 %147, label %block_.L_40de45, label %block_40de0c
...
block_.L_40de11:                                  ; preds = %block_40de3b, %block_40de0c
  %150 = phi i64 [ %111, %block_40de0c ], [ %196, %block_40de3b ]
  %storemerge = phi i64 [ %149, %block_40de0c ], [ %236, %block_40de3b ]
  %151 = add i64 %150, -32
  ...
  %call2_40de1c = tail call %struct.Memory* @sub_40c670._ZN15loop_inner_bodyILi19EiE7do_workERiPKii(%struct.State* nonnull %0, i64 %161, %struct.Memory* %MEMORY.0)
  ...
  br i1 %234, label %block_40de3b, label %block_.L_40de40
...
block_.L_40de45:                                  ; preds = %block_.L_40de40, %block_40ddef
  %239 = phi i64 [ %238, %block_.L_40de40 ], [ %148, %block_40ddef ]
  %240 = phi i64 [ %196, %block_.L_40de40 ], [ %111, %block_40ddef ]
  %241 = add i64 %240, -36
  %242 = add i64 %239, 3
  ...
  br i1 %275, label %block_40de51, label %block_.L_40de8b
...
block_.L_40de56:                                  ; preds = %block_40de81, %block_40de51
  %278 = phi i64 [ %240, %block_40de51 ], [ %365, %block_40de81 ]
  %storemerge5 = phi i64 [ %277, %block_40de51 ], [ %401, %block_40de81 ]
  %279 = add i64 %278, -8
  ...
  %call2_40de61 = tail call %struct.Memory* @sub_40c110._Z18complete_hash_funcIiET_S0_(%struct.State* nonnull %0, i64 %294, %struct.Memory* %MEMORY.0)
  ...
  br i1 %389, label %block_.L_40de86, label %block_40de81
...
block_.L_40de8b:                                  ; preds = %block_.L_40de45, %block_.L_40de86
  %404 = phi i64 [ %276, %block_.L_40de45 ], [ %403, %block_.L_40de86 ]
  %405 = phi i64 [ %240, %block_.L_40de45 ], [ %365, %block_.L_40de86 ]
  %406 = add i64 %405, -32
  %407 = add i64 %404, 3
  ...
  %call2_40de8e = tail call %struct.Memory* @sub_40c140._Z9check_sumIiEvT_(%struct.State* nonnull %0, i64 %411, %struct.Memory* %MEMORY.0)
...
block_.L_40dea1:                                  ; preds = %block_.L_40dddf
  ...
  %call2_40dea1 = tail call %struct.Memory* @sub_400e30._Z5timerv(%struct.State* nonnull %0, i64 %448, %struct.Memory* %MEMORY.0)
  ...
  %call2_40deaa = tail call %struct.Memory* @sub_4007d0._Z13record_resultdPKc(%struct.State* nonnull %0, i64 %459, %struct.Memory* %call2_40dea1)
