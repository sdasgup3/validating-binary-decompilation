...
define %struct.Memory* @_Z28test_goto_loop_unroll_factorILi19EiEvPKT0_iPKc(%struct.State* noalias, i64, %struct.Memory* noalias readnone) local_unnamed_addr #1 {
entry:
...
block_.L_40de01:                                  ; preds = %block_40de2b, %block_40ddfc
  ...
  %call2_40de0c = tail call %struct.Memory* @sub_40c660._ZN15loop_inner_bodyILi19EiE7do_workERiPKii(%struct.State* nonnull %0, i64 %161, %struct.Memory* %MEMORY.0)
...
block_.L_40de35:                                  ; preds = %block_.L_40de30, %block_40dddf
  %239 = phi i64 [ %238, %block_.L_40de30 ], [ %148, %block_40dddf ]
  %240 = phi i64 [ %196, %block_.L_40de30 ], [ %111, %block_40dddf ]
  %241 = add i64 %240, -36
  %242 = add i64 %239, 3
...
block_.L_40de46:                                  ; preds = %block_40de71, %block_40de41
  ...
  %call2_40de51 = tail call %struct.Memory* @sub_40c100._Z18complete_hash_funcIiET_S0_(%struct.State* nonnull %0, i64 %294, %struct.Memory* %MEMORY.0)
...
block_.L_40de7b:                                  ; preds = %block_.L_40de35, %block_.L_40de76
  ...
  %call2_40de7e = tail call %struct.Memory* @sub_40c130._Z9check_sumIiEvT_(%struct.State* nonnull %0, i64 %411, %struct.Memory* %MEMORY.0)
