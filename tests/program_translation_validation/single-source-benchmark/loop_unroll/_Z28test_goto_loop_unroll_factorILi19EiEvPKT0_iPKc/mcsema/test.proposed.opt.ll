...
entry:
  ...
  %call2_40dd93 = tail call %struct.Memory* @sub_400dd0._Z11start_timerv(%struct.State* %0, i64 %58, %struct.Memory* %2)
...
block_.L_40dd9f:                                  ; preds = %block_.L_40de4b, %entry
  %68 = phi i64 [ %.pre, %entry ], [ %447, %block_.L_40de4b ]
  %MEMORY.0 = phi %struct.Memory* [ %call2_40dd93, %entry ], [ %call2_40de4e, %block_.L_40de4b ]
  ...
  br i1 %101, label %block_40ddaf, label %block_.L_40de61
...
block_40ddaf:                                     ; preds = %block_.L_40dd9f
  ...
  br i1 %147, label %block_.L_40de05, label %block_40ddcc
...
block_.L_40ddd1:                                  ; preds = %block_40ddfb, %block_40ddcc
  %150 = phi i64 [ %149, %block_40ddcc ], [ %237, %block_40ddfb ]
  %151 = phi i64 [ %111, %block_40ddcc ], [ %197, %block_40ddfb ]
  %MEMORY.1 = phi %struct.Memory* [ %MEMORY.0, %block_40ddcc ], [ %call2_40dddc, %block_40ddfb ]
  %152 = add i64 %151, -32
  ...
  %call2_40dddc = tail call %struct.Memory* @sub_40c630._ZN15loop_inner_bodyILi19EiE7do_workERiPKii(%struct.State* %0, i64 %162, %struct.Memory* %MEMORY.1)
  ...
  br i1 %235, label %block_40ddfb, label %block_.L_40de00
...
block_.L_40de05:                                  ; preds = %block_.L_40de00, %block_40ddaf
  %239 = phi i64 [ %148, %block_40ddaf ], [ %238, %block_.L_40de00 ]
  %240 = phi i64 [ %111, %block_40ddaf ], [ %197, %block_.L_40de00 ]
  %MEMORY.2 = phi %struct.Memory* [ %MEMORY.0, %block_40ddaf ], [ %call2_40dddc, %block_.L_40de00 ]
  %241 = add i64 %240, -36
  %242 = add i64 %239, 3
  ...
  br i1 %275, label %block_40de11, label %block_.L_40de4b
...
block_.L_40de16:                                  ; preds = %block_40de41, %block_40de11
  %278 = phi i64 [ %277, %block_40de11 ], [ %402, %block_40de41 ]
  %279 = phi i64 [ %240, %block_40de11 ], [ %366, %block_40de41 ]
  %MEMORY.3 = phi %struct.Memory* [ %MEMORY.2, %block_40de11 ], [ %call2_40de21, %block_40de41 ]
  %280 = add i64 %279, -8
  %281 = add i64 %278, 4
  ...
  %call2_40de21 = tail call %struct.Memory* @sub_40c0d0._Z18complete_hash_funcIiET_S0_(%struct.State* %0, i64 %295, %struct.Memory* %MEMORY.3)
  ...
  br i1 %390, label %block_.L_40de46, label %block_40de41
...
block_.L_40de4b:                                  ; preds = %block_.L_40de05, %block_.L_40de46
  %404 = phi i64 [ %276, %block_.L_40de05 ], [ %403, %block_.L_40de46 ]
  %405 = phi i64 [ %240, %block_.L_40de05 ], [ %366, %block_.L_40de46 ]
  %MEMORY.4 = phi %struct.Memory* [ %MEMORY.2, %block_.L_40de05 ], [ %call2_40de21, %block_.L_40de46 ]
  %406 = add i64 %405, -32
  %407 = add i64 %404, 3
  ...
  %call2_40de4e = tail call %struct.Memory* @sub_40c100._Z9check_sumIiEvT_(%struct.State* %0, i64 %411, %struct.Memory* %MEMORY.4)
...
block_.L_40de61:                                  ; preds = %block_.L_40dd9f
  ...
  %call2_40de61 = tail call %struct.Memory* @sub_400df0._Z5timerv(%struct.State* %0, i64 %448, %struct.Memory* %MEMORY.0)
  ...
  %call2_40de6a = tail call %struct.Memory* @sub_400790._Z13record_resultdPKc(%struct.State* %0, i64 %459, %struct.Memory* %call2_40de61)
  ...
  ret %struct.Memory* %call2_40de6a
}
...
define %struct.Memory* @routine_jge_.L_40de61(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i8* %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
...
define %struct.Memory* @routine_jl_.L_40de05(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i8* %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 2, i32 9
...
define %struct.Memory* @routine_jmpq_.L_40ddd1(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
...
define %struct.Memory* @routine_jge_.L_40de00(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i8* %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 2, i32 9
...
define %struct.Memory* @routine_jmpq_.L_40de05(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
...
define %struct.Memory* @routine_jge_.L_40de4b(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i8* %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 2, i32 9
...
define %struct.Memory* @routine_jmpq_.L_40de16(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
...
define %struct.Memory* @routine_je_.L_40de46(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i8* %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
...
define %struct.Memory* @routine_jmpq_.L_40de4b(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
