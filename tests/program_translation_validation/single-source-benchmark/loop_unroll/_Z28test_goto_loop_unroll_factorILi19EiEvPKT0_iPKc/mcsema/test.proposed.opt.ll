...
block_.L_40dd9f:                                  ; preds = %block_.L_40de4b, %entry
  %68 = phi i64 [ %.pre, %entry ], [ %449, %block_.L_40de4b ]
...
block_.L_40de16:                                  ; preds = %block_40de41, %block_40de11
  %278 = phi i64 [ %277, %block_40de11 ], [ %403, %block_40de41 ]
  %279 = phi i64 [ %240, %block_40de11 ], [ %367, %block_40de41 ]
  ...
  br i1 %391, label %block_.L_40de46, label %block_40de41
...
block_.L_40de4b:                                  ; preds = %block_.L_40de05, %block_.L_40de46
  %405 = phi i64 [ %276, %block_.L_40de05 ], [ %404, %block_.L_40de46 ]
  %406 = phi i64 [ %240, %block_.L_40de05 ], [ %367, %block_.L_40de46 ]
  ...
  %call2_40de4e = tail call %struct.Memory* @sub_40c100._Z9check_sumIiEvT_(%struct.State* %0, i64 %412, %struct.Memory* %MEMORY.4)
...
block_.L_40de61:                                  ; preds = %block_.L_40dd9f
  ...
  %call2_40de61 = tail call %struct.Memory* @sub_400df0._Z5timerv(%struct.State* %0, i64 %450, %struct.Memory* %MEMORY.0)
  ...
  %call2_40de6a = tail call %struct.Memory* @sub_400790._Z13record_resultdPKc(%struct.State* %0, i64 %461, %struct.Memory* %call2_40de61)
