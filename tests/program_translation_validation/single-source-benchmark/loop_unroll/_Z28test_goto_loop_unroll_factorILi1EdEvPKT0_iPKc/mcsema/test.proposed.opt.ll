...
declare %struct.Memory* @sub_402160._ZN15loop_inner_bodyILi1EdE7do_workERdPKdi(%struct.State* noalias dereferenceable(3376), i64, %struct.Memory* noalias readnone returned) local_unnamed_addr
...
block_.L_404992:                                  ; preds = %block_4049bc, %block_40498d
  ...
  %call2_40499d = tail call %struct.Memory* @sub_402160._ZN15loop_inner_bodyILi1EdE7do_workERdPKdi(%struct.State* nonnull %0, i64 %167, %struct.Memory* %MEMORY.0)
...
block_.L_4049c6:                                  ; preds = %block_.L_4049c1, %block_40496f
  %244 = phi i64 [ %243, %block_.L_4049c1 ], [ %154, %block_40496f ]
  %245 = phi i64 [ %202, %block_.L_4049c1 ], [ %118, %block_40496f ]
  %246 = add i64 %245, -44
  %247 = add i64 %244, 3
...
block_.L_4049d7:                                  ; preds = %block_404a08, %block_4049d2
  ...
  %call2_4049e4 = tail call %struct.Memory* @sub_4014b0._Z18complete_hash_funcIdET_S0_(%struct.State* nonnull %0, i64 %298, %struct.Memory* %MEMORY.0)
...
block_.L_404a12:                                  ; preds = %block_.L_4049c6, %block_.L_404a0d
  ...
  %call2_404a17 = tail call %struct.Memory* @sub_4014e0._Z9check_sumIdEvT_(%struct.State* nonnull %0, i64 %388, %struct.Memory* %MEMORY.0)
