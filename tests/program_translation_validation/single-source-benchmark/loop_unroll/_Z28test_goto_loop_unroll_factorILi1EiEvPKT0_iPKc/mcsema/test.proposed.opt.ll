...
define %struct.Memory* @_Z28test_goto_loop_unroll_factorILi1EiEvPKT0_iPKc(%struct.State* noalias, i64, %struct.Memory* noalias readnone) local_unnamed_addr #1 {
entry:
...
block_.L_40f551:                                  ; preds = %block_40f57b, %block_40f54c
  ...
  %call2_40f55c = tail call %struct.Memory* @sub_40cd20._ZN15loop_inner_bodyILi1EiE7do_workERiPKii(%struct.State* nonnull %0, i64 %160, %struct.Memory* %MEMORY.0)
...
block_.L_40f585:                                  ; preds = %block_.L_40f580, %block_40f52f
  %237 = phi i64 [ %236, %block_.L_40f580 ], [ %147, %block_40f52f ]
  %238 = phi i64 [ %195, %block_.L_40f580 ], [ %111, %block_40f52f ]
  %239 = add i64 %238, -36
  %240 = add i64 %237, 3
...
block_.L_40f596:                                  ; preds = %block_40f5c1, %block_40f591
  ...
  %call2_40f5a1 = tail call %struct.Memory* @sub_40c100._Z18complete_hash_funcIiET_S0_(%struct.State* nonnull %0, i64 %292, %struct.Memory* %MEMORY.0)
...
block_.L_40f5cb:                                  ; preds = %block_.L_40f585, %block_.L_40f5c6
  ...
  %call2_40f5ce = tail call %struct.Memory* @sub_40c130._Z9check_sumIiEvT_(%struct.State* nonnull %0, i64 %409, %struct.Memory* %MEMORY.0)
