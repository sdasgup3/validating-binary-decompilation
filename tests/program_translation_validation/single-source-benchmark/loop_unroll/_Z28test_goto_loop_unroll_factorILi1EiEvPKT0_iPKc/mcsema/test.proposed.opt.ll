...
block_.L_40f4ef:                                  ; preds = %block_.L_40f59b, %entry
  %68 = phi i64 [ %.pre, %entry ], [ %445, %block_.L_40f59b ]
...
block_.L_40f521:                                  ; preds = %block_40f54b, %block_40f51c
  %149 = phi i64 [ %148, %block_40f51c ], [ %235, %block_40f54b ]
  %150 = phi i64 [ %111, %block_40f51c ], [ %196, %block_40f54b ]
  ...
  %233 = xor i1 %232, %230
  %.v5 = select i1 %233, i64 17, i64 22
  %234 = add i64 %198, %.v5
  store i64 %234, i64* %3, align 8
  br i1 %233, label %block_40f54b, label %block_.L_40f550
...
block_.L_40f555:                                  ; preds = %block_.L_40f550, %block_40f4ff
  %237 = phi i64 [ %147, %block_40f4ff ], [ %236, %block_.L_40f550 ]
  %238 = phi i64 [ %111, %block_40f4ff ], [ %196, %block_.L_40f550 ]
  ...
  %273 = xor i1 %272, %270
  %.v6 = select i1 %273, i64 12, i64 70
  %274 = add i64 %237, %.v6
  store i64 %274, i64* %3, align 8
  br i1 %273, label %block_40f561, label %block_.L_40f59b
...
block_.L_40f566:                                  ; preds = %block_40f591, %block_40f561
  %276 = phi i64 [ %275, %block_40f561 ], [ %400, %block_40f591 ]
  %277 = phi i64 [ %238, %block_40f561 ], [ %364, %block_40f591 ]
  ...
  %call2_40f571 = tail call %struct.Memory* @sub_40c0d0._Z18complete_hash_funcIiET_S0_(%struct.State* %0, i64 %293, %struct.Memory* %MEMORY.3)
  ...
  %.v7 = select i1 %388, i64 17, i64 12
  %399 = add i64 %366, %.v7
  store i64 %399, i64* %3, align 8
  br i1 %388, label %block_.L_40f596, label %block_40f591
...
block_.L_40f59b:                                  ; preds = %block_.L_40f555, %block_.L_40f596
  %402 = phi i64 [ %274, %block_.L_40f555 ], [ %401, %block_.L_40f596 ]
  %403 = phi i64 [ %238, %block_.L_40f555 ], [ %364, %block_.L_40f596 ]
  ...
  %call2_40f59e = tail call %struct.Memory* @sub_40c100._Z9check_sumIiEvT_(%struct.State* %0, i64 %409, %struct.Memory* %MEMORY.4)
...
block_.L_40f5b1:                                  ; preds = %block_.L_40f4ef
  ...
  %call2_40f5b1 = tail call %struct.Memory* @sub_400df0._Z5timerv(%struct.State* %0, i64 %446, %struct.Memory* %MEMORY.0)
  ...
  %call2_40f5ba = tail call %struct.Memory* @sub_400790._Z13record_resultdPKc(%struct.State* %0, i64 %457, %struct.Memory* %call2_40f5b1)
