...
block_.L_4030f2:                                  ; preds = %block_40311c, %block_4030ed
  ...
  %call2_4030fd = tail call %struct.Memory* @sub_401a40._ZN15loop_inner_bodyILi20EdE7do_workERdPKdi(%struct.State* nonnull %0, i64 %168, %struct.Memory* %MEMORY.0)
...
block_.L_403126:                                  ; preds = %block_.L_403121, %block_4030cf
  %246 = phi i64 [ %245, %block_.L_403121 ], [ %155, %block_4030cf ]
  %247 = phi i64 [ %203, %block_.L_403121 ], [ %118, %block_4030cf ]
  %248 = add i64 %247, -44
  %249 = add i64 %246, 3
...
block_.L_403137:                                  ; preds = %block_403168, %block_403132
  ...
  %call2_403144 = tail call %struct.Memory* @sub_4014b0._Z18complete_hash_funcIdET_S0_(%struct.State* nonnull %0, i64 %300, %struct.Memory* %MEMORY.0)
...
block_.L_403172:                                  ; preds = %block_.L_403126, %block_.L_40316d
  ...
  %call2_403177 = tail call %struct.Memory* @sub_4014e0._Z9check_sumIdEvT_(%struct.State* nonnull %0, i64 %390, %struct.Memory* %MEMORY.0)
