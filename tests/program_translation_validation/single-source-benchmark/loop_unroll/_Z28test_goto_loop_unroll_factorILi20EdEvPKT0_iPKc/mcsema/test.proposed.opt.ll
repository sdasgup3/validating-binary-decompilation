...
entry:
  ...
  %call2_4030c3 = tail call %struct.Memory* @sub_400e10._Z11start_timerv(%struct.State* %0, i64 %58, %struct.Memory* %2)
...
block_.L_4030cf:                                  ; preds = %block_.L_403182, %entry
  %74 = phi i64 [ %.pre, %entry ], [ %426, %block_.L_403182 ]
  %MEMORY.0 = phi %struct.Memory* [ %call2_4030c3, %entry ], [ %call2_403187, %block_.L_403182 ]
  ...
  br i1 %107, label %block_4030df, label %block_.L_40319a
...
block_4030df:                                     ; preds = %block_.L_4030cf
  ...
  br i1 %154, label %block_.L_403136, label %block_4030fd
...
block_.L_403102:                                  ; preds = %block_40312c, %block_4030fd
  %157 = phi i64 [ %118, %block_4030fd ], [ %203, %block_40312c ]
  %storemerge = phi i64 [ %156, %block_4030fd ], [ %243, %block_40312c ]
  %158 = add i64 %157, -40
  ...
  %call2_40310d = tail call %struct.Memory* @sub_401a50._ZN15loop_inner_bodyILi20EdE7do_workERdPKdi(%struct.State* nonnull %0, i64 %168, %struct.Memory* %MEMORY.0)
  ...
  br i1 %241, label %block_40312c, label %block_.L_403131
...
block_.L_403136:                                  ; preds = %block_.L_403131, %block_4030df
  %246 = phi i64 [ %245, %block_.L_403131 ], [ %155, %block_4030df ]
  %247 = phi i64 [ %203, %block_.L_403131 ], [ %118, %block_4030df ]
  %248 = add i64 %247, -44
  %249 = add i64 %246, 3
  ...
  br i1 %282, label %block_403142, label %block_.L_403182
...
block_.L_403147:                                  ; preds = %block_403178, %block_403142
  %285 = phi i64 [ %247, %block_403142 ], [ %345, %block_403178 ]
  %storemerge5 = phi i64 [ %284, %block_403142 ], [ %381, %block_403178 ]
  %286 = add i64 %285, -8
  ...
  %call2_403154 = tail call %struct.Memory* @sub_4014c0._Z18complete_hash_funcIdET_S0_(%struct.State* nonnull %0, i64 %300, %struct.Memory* %MEMORY.0)
  ...
  br i1 %369, label %block_.L_40317d, label %block_403178
...
block_.L_403182:                                  ; preds = %block_.L_403136, %block_.L_40317d
  %384 = phi i64 [ %283, %block_.L_403136 ], [ %383, %block_.L_40317d ]
  %385 = phi i64 [ %247, %block_.L_403136 ], [ %345, %block_.L_40317d ]
  %386 = add i64 %385, -40
  %387 = add i64 %384, 5
  ...
  %call2_403187 = tail call %struct.Memory* @sub_4014f0._Z9check_sumIdEvT_(%struct.State* nonnull %0, i64 %390, %struct.Memory* %MEMORY.0)
...
block_.L_40319a:                                  ; preds = %block_.L_4030cf
  ...
  %call2_40319a = tail call %struct.Memory* @sub_400e30._Z5timerv(%struct.State* nonnull %0, i64 %427, %struct.Memory* %MEMORY.0)
  ...
  %call2_4031a3 = tail call %struct.Memory* @sub_4007d0._Z13record_resultdPKc(%struct.State* nonnull %0, i64 %438, %struct.Memory* %call2_40319a)
