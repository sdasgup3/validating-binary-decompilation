...
define %struct.Memory* @_Z28test_goto_loop_unroll_factorILi20EdEvPKT0_iPKc(%struct.State* noalias, i64, %struct.Memory* noalias) local_unnamed_addr #1 {
entry:
  ...
  %call2_4030b3 = tail call %struct.Memory* @sub_400e00._Z11start_timerv(%struct.State* %0, i64 %58, %struct.Memory* %2)
...
block_.L_4030bf:                                  ; preds = %block_.L_403172, %entry
  %74 = phi i64 [ %.pre, %entry ], [ %426, %block_.L_403172 ]
  %MEMORY.0 = phi %struct.Memory* [ %call2_4030b3, %entry ], [ %call2_403177, %block_.L_403172 ]
  ...
  br i1 %107, label %block_4030cf, label %block_.L_40318a
...
block_4030cf:                                     ; preds = %block_.L_4030bf
  ...
  br i1 %154, label %block_.L_403126, label %block_4030ed
...
block_.L_4030f2:                                  ; preds = %block_40311c, %block_4030ed
  %157 = phi i64 [ %118, %block_4030ed ], [ %203, %block_40311c ]
  %storemerge = phi i64 [ %156, %block_4030ed ], [ %243, %block_40311c ]
  %MEMORY.1 = phi %struct.Memory* [ %MEMORY.0, %block_4030ed ], [ %call2_4030fd, %block_40311c ]
  %158 = add i64 %157, -40
  ...
  %call2_4030fd = tail call %struct.Memory* @sub_401a40._ZN15loop_inner_bodyILi20EdE7do_workERdPKdi(%struct.State* nonnull %0, i64 %168, %struct.Memory* %MEMORY.1)
  ...
  br i1 %241, label %block_40311c, label %block_.L_403121
...
block_.L_403126:                                  ; preds = %block_.L_403121, %block_4030cf
  %246 = phi i64 [ %155, %block_4030cf ], [ %245, %block_.L_403121 ]
  %247 = phi i64 [ %118, %block_4030cf ], [ %203, %block_.L_403121 ]
  %MEMORY.2 = phi %struct.Memory* [ %MEMORY.0, %block_4030cf ], [ %call2_4030fd, %block_.L_403121 ]
  %248 = add i64 %247, -44
  %249 = add i64 %246, 3
  ...
  br i1 %282, label %block_403132, label %block_.L_403172
...
block_.L_403137:                                  ; preds = %block_403168, %block_403132
  %285 = phi i64 [ %247, %block_403132 ], [ %345, %block_403168 ]
  %storemerge5 = phi i64 [ %284, %block_403132 ], [ %381, %block_403168 ]
  %MEMORY.3 = phi %struct.Memory* [ %MEMORY.2, %block_403132 ], [ %call2_403144, %block_403168 ]
  %286 = add i64 %285, -8
  ...
  %call2_403144 = tail call %struct.Memory* @sub_4014b0._Z18complete_hash_funcIdET_S0_(%struct.State* nonnull %0, i64 %300, %struct.Memory* %MEMORY.3)
  ...
  br i1 %369, label %block_.L_40316d, label %block_403168
...
block_.L_403172:                                  ; preds = %block_.L_403126, %block_.L_40316d
  %384 = phi i64 [ %283, %block_.L_403126 ], [ %383, %block_.L_40316d ]
  %385 = phi i64 [ %247, %block_.L_403126 ], [ %345, %block_.L_40316d ]
  %MEMORY.4 = phi %struct.Memory* [ %MEMORY.2, %block_.L_403126 ], [ %call2_403144, %block_.L_40316d ]
  %386 = add i64 %385, -40
  %387 = add i64 %384, 5
  ...
  %call2_403177 = tail call %struct.Memory* @sub_4014e0._Z9check_sumIdEvT_(%struct.State* nonnull %0, i64 %390, %struct.Memory* %MEMORY.4)
...
block_.L_40318a:                                  ; preds = %block_.L_4030bf
  ...
  %call2_40318a = tail call %struct.Memory* @sub_400e20._Z5timerv(%struct.State* nonnull %0, i64 %427, %struct.Memory* %MEMORY.0)
  ...
  %call2_403193 = tail call %struct.Memory* @sub_4007c0._Z13record_resultdPKc(%struct.State* nonnull %0, i64 %438, %struct.Memory* %call2_40318a)
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_jge_.L_40318a(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i8* nocapture %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_jl_.L_403126(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i8* nocapture %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 2, i32 9
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_jmpq_.L_4030f2(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_jge_.L_403121(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i8* nocapture %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 2, i32 9
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_jmpq_.L_403126(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_jge_.L_403172(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i8* nocapture %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 2, i32 9
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_jmpq_.L_403137(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_je_.L_40316d(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i8* nocapture %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_jmpq_.L_403172(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
