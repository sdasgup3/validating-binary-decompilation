...
entry:
  ...
  %call2_403083 = tail call %struct.Memory* @sub_400dd0._Z11start_timerv(%struct.State* %0, i64 %58, %struct.Memory* %2)
...
block_.L_40308f:                                  ; preds = %block_.L_403142, %entry
  %79 = phi i64 [ %.pre, %entry ], [ %435, %block_.L_403142 ]
  %MEMORY.0 = phi %struct.Memory* [ %call2_403083, %entry ], [ %call2_403147, %block_.L_403142 ]
  ...
  br i1 %112, label %block_40309f, label %block_.L_40315a
...
block_40309f:                                     ; preds = %block_.L_40308f
  ...
  br i1 %160, label %block_.L_4030f6, label %block_4030bd
...
block_.L_4030c2:                                  ; preds = %block_4030ec, %block_4030bd
  %163 = phi i64 [ %162, %block_4030bd ], [ %250, %block_4030ec ]
  %164 = phi i64 [ %124, %block_4030bd ], [ %210, %block_4030ec ]
  %MEMORY.1 = phi %struct.Memory* [ %MEMORY.0, %block_4030bd ], [ %call2_4030cd, %block_4030ec ]
  %165 = add i64 %164, -40
  ...
  %call2_4030cd = tail call %struct.Memory* @sub_401a10._ZN15loop_inner_bodyILi20EdE7do_workERdPKdi(%struct.State* %0, i64 %175, %struct.Memory* %MEMORY.1)
  ...
  br i1 %248, label %block_4030ec, label %block_.L_4030f1
...
block_.L_4030f6:                                  ; preds = %block_.L_4030f1, %block_40309f
  %252 = phi i64 [ %161, %block_40309f ], [ %251, %block_.L_4030f1 ]
  %253 = phi i64 [ %124, %block_40309f ], [ %210, %block_.L_4030f1 ]
  %MEMORY.2 = phi %struct.Memory* [ %MEMORY.0, %block_40309f ], [ %call2_4030cd, %block_.L_4030f1 ]
  %254 = add i64 %253, -44
  %255 = add i64 %252, 3
  ...
  br i1 %288, label %block_403102, label %block_.L_403142
...
block_.L_403107:                                  ; preds = %block_403138, %block_403102
  %291 = phi i64 [ %290, %block_403102 ], [ %389, %block_403138 ]
  %292 = phi i64 [ %253, %block_403102 ], [ %353, %block_403138 ]
  %MEMORY.3 = phi %struct.Memory* [ %MEMORY.2, %block_403102 ], [ %call2_403114, %block_403138 ]
  %293 = add i64 %292, -8
  %294 = add i64 %291, 4
  ...
  %call2_403114 = tail call %struct.Memory* @sub_401480._Z18complete_hash_funcIdET_S0_(%struct.State* %0, i64 %308, %struct.Memory* %MEMORY.3)
  ...
  br i1 %377, label %block_.L_40313d, label %block_403138
...
block_.L_403142:                                  ; preds = %block_.L_4030f6, %block_.L_40313d
  %391 = phi i64 [ %289, %block_.L_4030f6 ], [ %390, %block_.L_40313d ]
  %392 = phi i64 [ %253, %block_.L_4030f6 ], [ %353, %block_.L_40313d ]
  %MEMORY.4 = phi %struct.Memory* [ %MEMORY.2, %block_.L_4030f6 ], [ %call2_403114, %block_.L_40313d ]
  %393 = add i64 %392, -40
  %394 = add i64 %391, 5
  ...
  %call2_403147 = tail call %struct.Memory* @sub_4014b0._Z9check_sumIdEvT_(%struct.State* %0, i64 %398, %struct.Memory* %MEMORY.4)
...
block_.L_40315a:                                  ; preds = %block_.L_40308f
  ...
  %call2_40315a = tail call %struct.Memory* @sub_400df0._Z5timerv(%struct.State* %0, i64 %436, %struct.Memory* %MEMORY.0)
  ...
  %call2_403163 = tail call %struct.Memory* @sub_400790._Z13record_resultdPKc(%struct.State* %0, i64 %447, %struct.Memory* %call2_40315a)
  ...
  ret %struct.Memory* %call2_403163
}
...
define %struct.Memory* @routine_jge_.L_40315a(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i8* %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
...
define %struct.Memory* @routine_jl_.L_4030f6(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i8* %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 2, i32 9
...
define %struct.Memory* @routine_jmpq_.L_4030c2(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
...
define %struct.Memory* @routine_jge_.L_4030f1(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i8* %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 2, i32 9
...
define %struct.Memory* @routine_jmpq_.L_4030f6(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
...
define %struct.Memory* @routine_jge_.L_403142(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i8* %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 2, i32 9
...
define %struct.Memory* @routine_jmpq_.L_403107(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
...
define %struct.Memory* @routine_je_.L_40313d(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i8* %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
...
define %struct.Memory* @routine_jmpq_.L_403142(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
...
define %struct.Memory* @routine_jmpq_.L_40308f(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
