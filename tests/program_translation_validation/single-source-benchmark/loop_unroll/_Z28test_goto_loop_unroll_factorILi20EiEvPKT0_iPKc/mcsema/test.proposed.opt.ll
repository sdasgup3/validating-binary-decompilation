...
define %struct.Memory* @_Z28test_goto_loop_unroll_factorILi20EiEvPKT0_iPKc(%struct.State* noalias, i64, %struct.Memory* noalias readnone) local_unnamed_addr #1 {
entry:
...
block_.L_40dcb1:                                  ; preds = %block_40dcdb, %block_40dcac
  ...
  %call2_40dcbc = tail call %struct.Memory* @sub_40c600._ZN15loop_inner_bodyILi20EiE7do_workERiPKii(%struct.State* nonnull %0, i64 %161, %struct.Memory* %MEMORY.0)
...
block_.L_40dce5:                                  ; preds = %block_.L_40dce0, %block_40dc8f
  %239 = phi i64 [ %238, %block_.L_40dce0 ], [ %148, %block_40dc8f ]
  %240 = phi i64 [ %196, %block_.L_40dce0 ], [ %111, %block_40dc8f ]
  %241 = add i64 %240, -36
  %242 = add i64 %239, 3
...
block_.L_40dcf6:                                  ; preds = %block_40dd21, %block_40dcf1
  ...
  %call2_40dd01 = tail call %struct.Memory* @sub_40c100._Z18complete_hash_funcIiET_S0_(%struct.State* nonnull %0, i64 %294, %struct.Memory* %MEMORY.0)
...
block_.L_40dd2b:                                  ; preds = %block_.L_40dce5, %block_.L_40dd26
  ...
  %call2_40dd2e = tail call %struct.Memory* @sub_40c130._Z9check_sumIiEvT_(%struct.State* nonnull %0, i64 %411, %struct.Memory* %MEMORY.0)
