...
entry:
  ...
  %call2_40dc83 = tail call %struct.Memory* @sub_400e10._Z11start_timerv(%struct.State* %0, i64 %58, %struct.Memory* %2)
...
block_.L_40dc8f:                                  ; preds = %block_.L_40dd3b, %entry
  %68 = phi i64 [ %.pre, %entry ], [ %447, %block_.L_40dd3b ]
  %MEMORY.0 = phi %struct.Memory* [ %call2_40dc83, %entry ], [ %call2_40dd3e, %block_.L_40dd3b ]
  ...
  br i1 %101, label %block_40dc9f, label %block_.L_40dd51
...
block_40dc9f:                                     ; preds = %block_.L_40dc8f
  ...
  br i1 %147, label %block_.L_40dcf5, label %block_40dcbc
...
block_.L_40dcc1:                                  ; preds = %block_40dceb, %block_40dcbc
  %150 = phi i64 [ %111, %block_40dcbc ], [ %196, %block_40dceb ]
  %storemerge = phi i64 [ %149, %block_40dcbc ], [ %236, %block_40dceb ]
  %151 = add i64 %150, -32
  ...
  %call2_40dccc = tail call %struct.Memory* @sub_40c610._ZN15loop_inner_bodyILi20EiE7do_workERiPKii(%struct.State* nonnull %0, i64 %161, %struct.Memory* %MEMORY.0)
  ...
  br i1 %234, label %block_40dceb, label %block_.L_40dcf0
...
block_.L_40dcf5:                                  ; preds = %block_.L_40dcf0, %block_40dc9f
  %239 = phi i64 [ %238, %block_.L_40dcf0 ], [ %148, %block_40dc9f ]
  %240 = phi i64 [ %196, %block_.L_40dcf0 ], [ %111, %block_40dc9f ]
  %241 = add i64 %240, -36
  %242 = add i64 %239, 3
  ...
  br i1 %275, label %block_40dd01, label %block_.L_40dd3b
...
block_.L_40dd06:                                  ; preds = %block_40dd31, %block_40dd01
  %278 = phi i64 [ %240, %block_40dd01 ], [ %365, %block_40dd31 ]
  %storemerge5 = phi i64 [ %277, %block_40dd01 ], [ %401, %block_40dd31 ]
  %279 = add i64 %278, -8
  ...
  %call2_40dd11 = tail call %struct.Memory* @sub_40c110._Z18complete_hash_funcIiET_S0_(%struct.State* nonnull %0, i64 %294, %struct.Memory* %MEMORY.0)
  ...
  br i1 %389, label %block_.L_40dd36, label %block_40dd31
...
block_.L_40dd3b:                                  ; preds = %block_.L_40dcf5, %block_.L_40dd36
  %404 = phi i64 [ %276, %block_.L_40dcf5 ], [ %403, %block_.L_40dd36 ]
  %405 = phi i64 [ %240, %block_.L_40dcf5 ], [ %365, %block_.L_40dd36 ]
  %406 = add i64 %405, -32
  %407 = add i64 %404, 3
  ...
  %call2_40dd3e = tail call %struct.Memory* @sub_40c140._Z9check_sumIiEvT_(%struct.State* nonnull %0, i64 %411, %struct.Memory* %MEMORY.0)
...
block_.L_40dd51:                                  ; preds = %block_.L_40dc8f
  ...
  %call2_40dd51 = tail call %struct.Memory* @sub_400e30._Z5timerv(%struct.State* nonnull %0, i64 %448, %struct.Memory* %MEMORY.0)
  ...
  %call2_40dd5a = tail call %struct.Memory* @sub_4007d0._Z13record_resultdPKc(%struct.State* nonnull %0, i64 %459, %struct.Memory* %call2_40dd51)
