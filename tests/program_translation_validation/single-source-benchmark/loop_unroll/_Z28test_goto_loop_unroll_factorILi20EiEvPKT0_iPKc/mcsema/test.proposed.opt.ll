...
block_.L_40dc4f:                                  ; preds = %block_.L_40dcfb, %entry
  %68 = phi i64 [ %.pre, %entry ], [ %447, %block_.L_40dcfb ]
...
block_.L_40dcc6:                                  ; preds = %block_40dcf1, %block_40dcc1
  %278 = phi i64 [ %277, %block_40dcc1 ], [ %402, %block_40dcf1 ]
  %279 = phi i64 [ %240, %block_40dcc1 ], [ %366, %block_40dcf1 ]
  ...
  br i1 %390, label %block_.L_40dcf6, label %block_40dcf1
...
block_.L_40dcfb:                                  ; preds = %block_.L_40dcb5, %block_.L_40dcf6
  %404 = phi i64 [ %276, %block_.L_40dcb5 ], [ %403, %block_.L_40dcf6 ]
  %405 = phi i64 [ %240, %block_.L_40dcb5 ], [ %366, %block_.L_40dcf6 ]
  ...
  %call2_40dcfe = tail call %struct.Memory* @sub_40c100._Z9check_sumIiEvT_(%struct.State* %0, i64 %411, %struct.Memory* %MEMORY.4)
...
block_.L_40dd11:                                  ; preds = %block_.L_40dc4f
  ...
  %call2_40dd11 = tail call %struct.Memory* @sub_400df0._Z5timerv(%struct.State* %0, i64 %448, %struct.Memory* %MEMORY.0)
  ...
  %call2_40dd1a = tail call %struct.Memory* @sub_400790._Z13record_resultdPKc(%struct.State* %0, i64 %459, %struct.Memory* %call2_40dd11)
