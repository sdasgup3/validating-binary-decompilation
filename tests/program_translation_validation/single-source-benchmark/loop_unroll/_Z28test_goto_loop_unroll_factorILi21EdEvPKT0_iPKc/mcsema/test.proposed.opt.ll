...
declare %struct.Memory* @sub_4019e0._ZN15loop_inner_bodyILi21EdE7do_workERdPKdi(%struct.State* noalias dereferenceable(3376), i64, %struct.Memory* noalias readnone returned) local_unnamed_addr
...
define %struct.Memory* @_Z28test_goto_loop_unroll_factorILi21EdEvPKT0_iPKc(%struct.State* noalias, i64, %struct.Memory* noalias readnone) local_unnamed_addr #1 {
entry:
...
block_.L_402fa2:                                  ; preds = %block_402fcc, %block_402f9d
  ...
  %call2_402fad = tail call %struct.Memory* @sub_4019e0._ZN15loop_inner_bodyILi21EdE7do_workERdPKdi(%struct.State* nonnull %0, i64 %168, %struct.Memory* %MEMORY.0)
...
block_.L_402fd6:                                  ; preds = %block_.L_402fd1, %block_402f7f
  %246 = phi i64 [ %245, %block_.L_402fd1 ], [ %155, %block_402f7f ]
  %247 = phi i64 [ %203, %block_.L_402fd1 ], [ %118, %block_402f7f ]
  %248 = add i64 %247, -44
  %249 = add i64 %246, 3
...
block_.L_402fe7:                                  ; preds = %block_403018, %block_402fe2
  ...
  %call2_402ff4 = tail call %struct.Memory* @sub_4014b0._Z18complete_hash_funcIdET_S0_(%struct.State* nonnull %0, i64 %300, %struct.Memory* %MEMORY.0)
...
block_.L_403022:                                  ; preds = %block_.L_402fd6, %block_.L_40301d
  ...
  %call2_403027 = tail call %struct.Memory* @sub_4014e0._Z9check_sumIdEvT_(%struct.State* nonnull %0, i64 %390, %struct.Memory* %MEMORY.0)
