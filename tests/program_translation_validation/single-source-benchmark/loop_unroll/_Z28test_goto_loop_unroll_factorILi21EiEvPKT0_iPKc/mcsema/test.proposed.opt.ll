...
declare %struct.Memory* @sub_40c5a0._ZN15loop_inner_bodyILi21EiE7do_workERiPKii(%struct.State* dereferenceable(3376), i64, %struct.Memory*) local_unnamed_addr
...
define %struct.Memory* @_Z28test_goto_loop_unroll_factorILi21EiEvPKT0_iPKc(%struct.State* noalias, i64, %struct.Memory* noalias) local_unnamed_addr #1 {
entry:
  ...
  %call2_40db23 = tail call %struct.Memory* @sub_400e00._Z11start_timerv(%struct.State* %0, i64 %58, %struct.Memory* %2)
...
block_.L_40db2f:                                  ; preds = %block_.L_40dbdb, %entry
  %68 = phi i64 [ %.pre, %entry ], [ %447, %block_.L_40dbdb ]
  %MEMORY.0 = phi %struct.Memory* [ %call2_40db23, %entry ], [ %call2_40dbde, %block_.L_40dbdb ]
  ...
  br i1 %101, label %block_40db3f, label %block_.L_40dbf1
...
block_40db3f:                                     ; preds = %block_.L_40db2f
  ...
  br i1 %147, label %block_.L_40db95, label %block_40db5c
...
block_.L_40db61:                                  ; preds = %block_40db8b, %block_40db5c
  %150 = phi i64 [ %111, %block_40db5c ], [ %196, %block_40db8b ]
  %storemerge = phi i64 [ %149, %block_40db5c ], [ %236, %block_40db8b ]
  %MEMORY.1 = phi %struct.Memory* [ %MEMORY.0, %block_40db5c ], [ %call2_40db6c, %block_40db8b ]
  %151 = add i64 %150, -32
  ...
  %call2_40db6c = tail call %struct.Memory* @sub_40c5a0._ZN15loop_inner_bodyILi21EiE7do_workERiPKii(%struct.State* nonnull %0, i64 %161, %struct.Memory* %MEMORY.1)
  ...
  br i1 %234, label %block_40db8b, label %block_.L_40db90
...
block_.L_40db95:                                  ; preds = %block_.L_40db90, %block_40db3f
  %239 = phi i64 [ %148, %block_40db3f ], [ %238, %block_.L_40db90 ]
  %240 = phi i64 [ %111, %block_40db3f ], [ %196, %block_.L_40db90 ]
  %MEMORY.2 = phi %struct.Memory* [ %MEMORY.0, %block_40db3f ], [ %call2_40db6c, %block_.L_40db90 ]
  %241 = add i64 %240, -36
  %242 = add i64 %239, 3
  ...
  br i1 %275, label %block_40dba1, label %block_.L_40dbdb
...
block_.L_40dba6:                                  ; preds = %block_40dbd1, %block_40dba1
  %278 = phi i64 [ %240, %block_40dba1 ], [ %365, %block_40dbd1 ]
  %storemerge5 = phi i64 [ %277, %block_40dba1 ], [ %401, %block_40dbd1 ]
  %MEMORY.3 = phi %struct.Memory* [ %MEMORY.2, %block_40dba1 ], [ %call2_40dbb1, %block_40dbd1 ]
  %279 = add i64 %278, -8
  ...
  %call2_40dbb1 = tail call %struct.Memory* @sub_40c100._Z18complete_hash_funcIiET_S0_(%struct.State* nonnull %0, i64 %294, %struct.Memory* %MEMORY.3)
  ...
  br i1 %389, label %block_.L_40dbd6, label %block_40dbd1
...
block_.L_40dbdb:                                  ; preds = %block_.L_40db95, %block_.L_40dbd6
  %404 = phi i64 [ %276, %block_.L_40db95 ], [ %403, %block_.L_40dbd6 ]
  %405 = phi i64 [ %240, %block_.L_40db95 ], [ %365, %block_.L_40dbd6 ]
  %MEMORY.4 = phi %struct.Memory* [ %MEMORY.2, %block_.L_40db95 ], [ %call2_40dbb1, %block_.L_40dbd6 ]
  %406 = add i64 %405, -32
  %407 = add i64 %404, 3
  ...
  %call2_40dbde = tail call %struct.Memory* @sub_40c130._Z9check_sumIiEvT_(%struct.State* nonnull %0, i64 %411, %struct.Memory* %MEMORY.4)
...
block_.L_40dbf1:                                  ; preds = %block_.L_40db2f
  ...
  %call2_40dbf1 = tail call %struct.Memory* @sub_400e20._Z5timerv(%struct.State* nonnull %0, i64 %448, %struct.Memory* %MEMORY.0)
  ...
  %call2_40dbfa = tail call %struct.Memory* @sub_4007c0._Z13record_resultdPKc(%struct.State* nonnull %0, i64 %459, %struct.Memory* %call2_40dbf1)
  ...
  ret %struct.Memory* %call2_40dbfa
}
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_jge_.L_40dbf1(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i8* nocapture %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_jl_.L_40db95(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i8* nocapture %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 2, i32 9
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_jmpq_.L_40db61(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_jge_.L_40db90(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i8* nocapture %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 2, i32 9
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_jmpq_.L_40db95(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_jge_.L_40dbdb(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i8* nocapture %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 2, i32 9
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_jmpq_.L_40dba6(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_je_.L_40dbd6(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i8* nocapture %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_jmpq_.L_40dbdb(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_jmpq_.L_40db2f(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
