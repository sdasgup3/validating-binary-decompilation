...
block_.L_40daff:                                  ; preds = %block_.L_40dbab, %entry
  %68 = phi i64 [ %.pre, %entry ], [ %449, %block_.L_40dbab ]
...
block_.L_40db76:                                  ; preds = %block_40dba1, %block_40db71
  %278 = phi i64 [ %277, %block_40db71 ], [ %403, %block_40dba1 ]
  %279 = phi i64 [ %240, %block_40db71 ], [ %367, %block_40dba1 ]
  ...
  br i1 %391, label %block_.L_40dba6, label %block_40dba1
...
block_.L_40dbab:                                  ; preds = %block_.L_40db65, %block_.L_40dba6
  %405 = phi i64 [ %276, %block_.L_40db65 ], [ %404, %block_.L_40dba6 ]
  %406 = phi i64 [ %240, %block_.L_40db65 ], [ %367, %block_.L_40dba6 ]
  ...
  %call2_40dbae = tail call %struct.Memory* @sub_40c100._Z9check_sumIiEvT_(%struct.State* %0, i64 %412, %struct.Memory* %MEMORY.4)
...
block_.L_40dbc1:                                  ; preds = %block_.L_40daff
  ...
  %call2_40dbc1 = tail call %struct.Memory* @sub_400df0._Z5timerv(%struct.State* %0, i64 %450, %struct.Memory* %MEMORY.0)
  ...
  %call2_40dbca = tail call %struct.Memory* @sub_400790._Z13record_resultdPKc(%struct.State* %0, i64 %461, %struct.Memory* %call2_40dbc1)
