...
declare %struct.Memory* @sub_40c570._ZN15loop_inner_bodyILi21EiE7do_workERiPKii(%struct.State* noalias dereferenceable(3376), i64, %struct.Memory* noalias readnone returned) local_unnamed_addr
...
entry:
  ...
  %call2_40daf3 = tail call %struct.Memory* @sub_400dd0._Z11start_timerv(%struct.State* %0, i64 %58, %struct.Memory* %2)
...
block_.L_40daff:                                  ; preds = %block_.L_40dbab, %entry
  %68 = phi i64 [ %.pre, %entry ], [ %447, %block_.L_40dbab ]
  %MEMORY.0 = phi %struct.Memory* [ %call2_40daf3, %entry ], [ %call2_40dbae, %block_.L_40dbab ]
  ...
  br i1 %101, label %block_40db0f, label %block_.L_40dbc1
...
block_40db0f:                                     ; preds = %block_.L_40daff
  ...
  br i1 %147, label %block_.L_40db65, label %block_40db2c
...
block_.L_40db31:                                  ; preds = %block_40db5b, %block_40db2c
  %150 = phi i64 [ %149, %block_40db2c ], [ %237, %block_40db5b ]
  %151 = phi i64 [ %111, %block_40db2c ], [ %197, %block_40db5b ]
  %MEMORY.1 = phi %struct.Memory* [ %MEMORY.0, %block_40db2c ], [ %call2_40db3c, %block_40db5b ]
  %152 = add i64 %151, -32
  ...
  %call2_40db3c = tail call %struct.Memory* @sub_40c570._ZN15loop_inner_bodyILi21EiE7do_workERiPKii(%struct.State* %0, i64 %162, %struct.Memory* %MEMORY.1)
  ...
  br i1 %235, label %block_40db5b, label %block_.L_40db60
...
block_.L_40db65:                                  ; preds = %block_.L_40db60, %block_40db0f
  %239 = phi i64 [ %148, %block_40db0f ], [ %238, %block_.L_40db60 ]
  %240 = phi i64 [ %111, %block_40db0f ], [ %197, %block_.L_40db60 ]
  %MEMORY.2 = phi %struct.Memory* [ %MEMORY.0, %block_40db0f ], [ %call2_40db3c, %block_.L_40db60 ]
  %241 = add i64 %240, -36
  %242 = add i64 %239, 3
  ...
  br i1 %275, label %block_40db71, label %block_.L_40dbab
...
block_.L_40db76:                                  ; preds = %block_40dba1, %block_40db71
  %278 = phi i64 [ %277, %block_40db71 ], [ %402, %block_40dba1 ]
  %279 = phi i64 [ %240, %block_40db71 ], [ %366, %block_40dba1 ]
  %MEMORY.3 = phi %struct.Memory* [ %MEMORY.2, %block_40db71 ], [ %call2_40db81, %block_40dba1 ]
  %280 = add i64 %279, -8
  %281 = add i64 %278, 4
  ...
  %call2_40db81 = tail call %struct.Memory* @sub_40c0d0._Z18complete_hash_funcIiET_S0_(%struct.State* %0, i64 %295, %struct.Memory* %MEMORY.3)
  ...
  br i1 %390, label %block_.L_40dba6, label %block_40dba1
...
block_.L_40dbab:                                  ; preds = %block_.L_40db65, %block_.L_40dba6
  %404 = phi i64 [ %276, %block_.L_40db65 ], [ %403, %block_.L_40dba6 ]
  %405 = phi i64 [ %240, %block_.L_40db65 ], [ %366, %block_.L_40dba6 ]
  %MEMORY.4 = phi %struct.Memory* [ %MEMORY.2, %block_.L_40db65 ], [ %call2_40db81, %block_.L_40dba6 ]
  %406 = add i64 %405, -32
  %407 = add i64 %404, 3
  ...
  %call2_40dbae = tail call %struct.Memory* @sub_40c100._Z9check_sumIiEvT_(%struct.State* %0, i64 %411, %struct.Memory* %MEMORY.4)
...
block_.L_40dbc1:                                  ; preds = %block_.L_40daff
  ...
  %call2_40dbc1 = tail call %struct.Memory* @sub_400df0._Z5timerv(%struct.State* %0, i64 %448, %struct.Memory* %MEMORY.0)
  ...
  %call2_40dbca = tail call %struct.Memory* @sub_400790._Z13record_resultdPKc(%struct.State* %0, i64 %459, %struct.Memory* %call2_40dbc1)
  ...
  ret %struct.Memory* %call2_40dbca
}
...
define %struct.Memory* @routine_jge_.L_40dbc1(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i8* %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
...
define %struct.Memory* @routine_jl_.L_40db65(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i8* %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 2, i32 9
...
define %struct.Memory* @routine_jmpq_.L_40db31(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
...
define %struct.Memory* @routine_callq_._ZN15loop_inner_bodyILi21EiE7do_workERiPKii(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
...
define %struct.Memory* @routine_jge_.L_40db60(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i8* %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 2, i32 9
...
define %struct.Memory* @routine_jmpq_.L_40db65(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
...
define %struct.Memory* @routine_jge_.L_40dbab(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i8* %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 2, i32 9
...
define %struct.Memory* @routine_jmpq_.L_40db76(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
...
define %struct.Memory* @routine_je_.L_40dba6(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i8* %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
...
define %struct.Memory* @routine_jmpq_.L_40dbab(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
...
define %struct.Memory* @routine_jmpq_.L_40daff(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
