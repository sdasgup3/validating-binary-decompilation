...
declare %struct.Memory* @sub_40c5a0._ZN15loop_inner_bodyILi21EiE7do_workERiPKii(%struct.State* noalias dereferenceable(3376), i64, %struct.Memory* noalias readnone returned) local_unnamed_addr
...
block_.L_40db61:                                  ; preds = %block_40db8b, %block_40db5c
  ...
  %call2_40db6c = tail call %struct.Memory* @sub_40c5a0._ZN15loop_inner_bodyILi21EiE7do_workERiPKii(%struct.State* nonnull %0, i64 %161, %struct.Memory* %MEMORY.0)
...
block_.L_40db95:                                  ; preds = %block_.L_40db90, %block_40db3f
  %239 = phi i64 [ %238, %block_.L_40db90 ], [ %148, %block_40db3f ]
  %240 = phi i64 [ %196, %block_.L_40db90 ], [ %111, %block_40db3f ]
  %241 = add i64 %240, -36
  %242 = add i64 %239, 3
...
block_.L_40dba6:                                  ; preds = %block_40dbd1, %block_40dba1
  ...
  %call2_40dbb1 = tail call %struct.Memory* @sub_40c100._Z18complete_hash_funcIiET_S0_(%struct.State* nonnull %0, i64 %294, %struct.Memory* %MEMORY.0)
...
block_.L_40dbdb:                                  ; preds = %block_.L_40db95, %block_.L_40dbd6
  ...
  %call2_40dbde = tail call %struct.Memory* @sub_40c130._Z9check_sumIiEvT_(%struct.State* nonnull %0, i64 %411, %struct.Memory* %MEMORY.0)
