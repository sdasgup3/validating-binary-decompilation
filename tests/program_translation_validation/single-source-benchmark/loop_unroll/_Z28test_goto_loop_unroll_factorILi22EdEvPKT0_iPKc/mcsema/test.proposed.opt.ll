...
entry:
  ...
  %call2_402e23 = tail call %struct.Memory* @sub_400e10._Z11start_timerv(%struct.State* %0, i64 %58, %struct.Memory* %2)
...
block_.L_402e2f:                                  ; preds = %block_.L_402ee2, %entry
  %74 = phi i64 [ %.pre, %entry ], [ %426, %block_.L_402ee2 ]
  %MEMORY.0 = phi %struct.Memory* [ %call2_402e23, %entry ], [ %call2_402ee7, %block_.L_402ee2 ]
  ...
  br i1 %107, label %block_402e3f, label %block_.L_402efa
...
block_402e3f:                                     ; preds = %block_.L_402e2f
  ...
  br i1 %154, label %block_.L_402e96, label %block_402e5d
...
block_.L_402e62:                                  ; preds = %block_402e8c, %block_402e5d
  %157 = phi i64 [ %118, %block_402e5d ], [ %203, %block_402e8c ]
  %storemerge = phi i64 [ %156, %block_402e5d ], [ %243, %block_402e8c ]
  %158 = add i64 %157, -40
  ...
  %call2_402e6d = tail call %struct.Memory* @sub_401990._ZN15loop_inner_bodyILi22EdE7do_workERdPKdi(%struct.State* nonnull %0, i64 %168, %struct.Memory* %MEMORY.0)
  ...
  br i1 %241, label %block_402e8c, label %block_.L_402e91
...
block_.L_402e96:                                  ; preds = %block_.L_402e91, %block_402e3f
  %246 = phi i64 [ %245, %block_.L_402e91 ], [ %155, %block_402e3f ]
  %247 = phi i64 [ %203, %block_.L_402e91 ], [ %118, %block_402e3f ]
  %248 = add i64 %247, -44
  %249 = add i64 %246, 3
  ...
  br i1 %282, label %block_402ea2, label %block_.L_402ee2
...
block_.L_402ea7:                                  ; preds = %block_402ed8, %block_402ea2
  %285 = phi i64 [ %247, %block_402ea2 ], [ %345, %block_402ed8 ]
  %storemerge5 = phi i64 [ %284, %block_402ea2 ], [ %381, %block_402ed8 ]
  %286 = add i64 %285, -8
  ...
  %call2_402eb4 = tail call %struct.Memory* @sub_4014c0._Z18complete_hash_funcIdET_S0_(%struct.State* nonnull %0, i64 %300, %struct.Memory* %MEMORY.0)
  ...
  br i1 %369, label %block_.L_402edd, label %block_402ed8
...
block_.L_402ee2:                                  ; preds = %block_.L_402e96, %block_.L_402edd
  %384 = phi i64 [ %283, %block_.L_402e96 ], [ %383, %block_.L_402edd ]
  %385 = phi i64 [ %247, %block_.L_402e96 ], [ %345, %block_.L_402edd ]
  %386 = add i64 %385, -40
  %387 = add i64 %384, 5
  ...
  %call2_402ee7 = tail call %struct.Memory* @sub_4014f0._Z9check_sumIdEvT_(%struct.State* nonnull %0, i64 %390, %struct.Memory* %MEMORY.0)
...
block_.L_402efa:                                  ; preds = %block_.L_402e2f
  ...
  %call2_402efa = tail call %struct.Memory* @sub_400e30._Z5timerv(%struct.State* nonnull %0, i64 %427, %struct.Memory* %MEMORY.0)
  ...
  %call2_402f03 = tail call %struct.Memory* @sub_4007d0._Z13record_resultdPKc(%struct.State* nonnull %0, i64 %438, %struct.Memory* %call2_402efa)
