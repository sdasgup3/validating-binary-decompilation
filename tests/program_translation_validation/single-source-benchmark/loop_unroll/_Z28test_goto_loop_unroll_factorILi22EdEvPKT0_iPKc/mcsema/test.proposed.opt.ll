...
entry:
  ...
  %call2_402de3 = tail call %struct.Memory* @sub_400dd0._Z11start_timerv(%struct.State* %0, i64 %58, %struct.Memory* %2)
...
block_.L_402def:                                  ; preds = %block_.L_402ea2, %entry
  %79 = phi i64 [ %.pre, %entry ], [ %431, %block_.L_402ea2 ]
  %MEMORY.0 = phi %struct.Memory* [ %call2_402de3, %entry ], [ %call2_402ea7, %block_.L_402ea2 ]
  ...
  br i1 %112, label %block_402dff, label %block_.L_402eba
...
block_402dff:                                     ; preds = %block_.L_402def
  ...
  br i1 %160, label %block_.L_402e56, label %block_402e1d
...
block_.L_402e22:                                  ; preds = %block_402e4c, %block_402e1d
  %163 = phi i64 [ %162, %block_402e1d ], [ %250, %block_402e4c ]
  %164 = phi i64 [ %124, %block_402e1d ], [ %210, %block_402e4c ]
  %MEMORY.1 = phi %struct.Memory* [ %MEMORY.0, %block_402e1d ], [ %call2_402e2d, %block_402e4c ]
  %165 = add i64 %164, -40
  ...
  %call2_402e2d = tail call %struct.Memory* @sub_401950._ZN15loop_inner_bodyILi22EdE7do_workERdPKdi(%struct.State* %0, i64 %175, %struct.Memory* %MEMORY.1)
  ...
  br i1 %248, label %block_402e4c, label %block_.L_402e51
...
block_.L_402e56:                                  ; preds = %block_.L_402e51, %block_402dff
  %252 = phi i64 [ %161, %block_402dff ], [ %251, %block_.L_402e51 ]
  %253 = phi i64 [ %124, %block_402dff ], [ %210, %block_.L_402e51 ]
  %MEMORY.2 = phi %struct.Memory* [ %MEMORY.0, %block_402dff ], [ %call2_402e2d, %block_.L_402e51 ]
  %254 = add i64 %253, -44
  %255 = add i64 %252, 3
  ...
  br i1 %288, label %block_402e62, label %block_.L_402ea2
...
block_.L_402e67:                                  ; preds = %block_402e98, %block_402e62
  %291 = phi i64 [ %290, %block_402e62 ], [ %387, %block_402e98 ]
  %292 = phi i64 [ %253, %block_402e62 ], [ %351, %block_402e98 ]
  %MEMORY.3 = phi %struct.Memory* [ %MEMORY.2, %block_402e62 ], [ %call2_402e74, %block_402e98 ]
  %293 = add i64 %292, -8
  %294 = add i64 %291, 4
  ...
  %call2_402e74 = tail call %struct.Memory* @sub_401480._Z18complete_hash_funcIdET_S0_(%struct.State* %0, i64 %307, %struct.Memory* %MEMORY.3)
  ...
  br i1 %375, label %block_.L_402e9d, label %block_402e98
...
block_.L_402ea2:                                  ; preds = %block_.L_402e56, %block_.L_402e9d
  %389 = phi i64 [ %289, %block_.L_402e56 ], [ %388, %block_.L_402e9d ]
  %390 = phi i64 [ %253, %block_.L_402e56 ], [ %351, %block_.L_402e9d ]
  %MEMORY.4 = phi %struct.Memory* [ %MEMORY.2, %block_.L_402e56 ], [ %call2_402e74, %block_.L_402e9d ]
  %391 = add i64 %390, -40
  %392 = add i64 %389, 5
  ...
  %call2_402ea7 = tail call %struct.Memory* @sub_4014b0._Z9check_sumIdEvT_(%struct.State* %0, i64 %395, %struct.Memory* %MEMORY.4)
...
block_.L_402eba:                                  ; preds = %block_.L_402def
  ...
  %call2_402eba = tail call %struct.Memory* @sub_400df0._Z5timerv(%struct.State* %0, i64 %432, %struct.Memory* %MEMORY.0)
  ...
  %call2_402ec3 = tail call %struct.Memory* @sub_400790._Z13record_resultdPKc(%struct.State* %0, i64 %443, %struct.Memory* %call2_402eba)
  ...
  ret %struct.Memory* %call2_402ec3
}
...
define %struct.Memory* @routine_jge_.L_402eba(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i8* %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
...
define %struct.Memory* @routine_jl_.L_402e56(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i8* %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 2, i32 9
...
define %struct.Memory* @routine_jmpq_.L_402e22(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
...
define %struct.Memory* @routine_jge_.L_402e51(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i8* %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 2, i32 9
...
define %struct.Memory* @routine_jmpq_.L_402e56(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
...
define %struct.Memory* @routine_jge_.L_402ea2(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i8* %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 2, i32 9
...
define %struct.Memory* @routine_jmpq_.L_402e67(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
...
define %struct.Memory* @routine_je_.L_402e9d(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i8* %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
...
define %struct.Memory* @routine_jmpq_.L_402ea2(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
...
define %struct.Memory* @routine_jmpq_.L_402def(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
