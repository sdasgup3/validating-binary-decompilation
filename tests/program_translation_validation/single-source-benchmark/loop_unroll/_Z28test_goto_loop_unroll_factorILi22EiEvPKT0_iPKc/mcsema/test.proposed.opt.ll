...
entry:
  ...
  %call2_40d9e3 = tail call %struct.Memory* @sub_400e10._Z11start_timerv(%struct.State* %0, i64 %58, %struct.Memory* %2)
...
block_.L_40d9ef:                                  ; preds = %block_.L_40da9b, %entry
  %68 = phi i64 [ %.pre, %entry ], [ %447, %block_.L_40da9b ]
  %MEMORY.0 = phi %struct.Memory* [ %call2_40d9e3, %entry ], [ %call2_40da9e, %block_.L_40da9b ]
  ...
  br i1 %101, label %block_40d9ff, label %block_.L_40dab1

block_40d9ff:                                     ; preds = %block_.L_40d9ef
  %103 = add i64 %69, -32
  %104 = add i64 %102, 7
  ...
  br i1 %147, label %block_.L_40da55, label %block_40da1c

block_40da1c:                                     ; preds = %block_40d9ff
  %149 = add i64 %148, 5
  br label %block_.L_40da21

block_.L_40da21:                                  ; preds = %block_40da4b, %block_40da1c
  %150 = phi i64 [ %111, %block_40da1c ], [ %196, %block_40da4b ]
  %storemerge = phi i64 [ %149, %block_40da1c ], [ %236, %block_40da4b ]
  %151 = add i64 %150, -32
  ...
  %call2_40da2c = tail call %struct.Memory* @sub_40c550._ZN15loop_inner_bodyILi22EiE7do_workERiPKii(%struct.State* nonnull %0, i64 %161, %struct.Memory* %MEMORY.0)
  ...
  br i1 %234, label %block_40da4b, label %block_.L_40da50

block_40da4b:                                     ; preds = %block_.L_40da21
  %236 = add i64 %235, -42
  %237 = add i64 %235, 5
  store i64 %237, i64* %3, align 8
  br label %block_.L_40da21

block_.L_40da50:                                  ; preds = %block_.L_40da21
  %238 = add i64 %235, 5
  store i64 %238, i64* %3, align 8
  br label %block_.L_40da55

block_.L_40da55:                                  ; preds = %block_.L_40da50, %block_40d9ff
  %239 = phi i64 [ %238, %block_.L_40da50 ], [ %148, %block_40d9ff ]
  %240 = phi i64 [ %196, %block_.L_40da50 ], [ %111, %block_40d9ff ]
  %241 = add i64 %240, -36
  %242 = add i64 %239, 3
  ...
  br i1 %275, label %block_40da61, label %block_.L_40da9b

block_40da61:                                     ; preds = %block_.L_40da55
  %277 = add i64 %276, 5
  br label %block_.L_40da66

block_.L_40da66:                                  ; preds = %block_40da91, %block_40da61
  %278 = phi i64 [ %240, %block_40da61 ], [ %365, %block_40da91 ]
  %storemerge5 = phi i64 [ %277, %block_40da61 ], [ %401, %block_40da91 ]
  %279 = add i64 %278, -8
  ...
  %call2_40da71 = tail call %struct.Memory* @sub_40c110._Z18complete_hash_funcIiET_S0_(%struct.State* nonnull %0, i64 %294, %struct.Memory* %MEMORY.0)
  ...
  br i1 %389, label %block_.L_40da96, label %block_40da91

block_40da91:                                     ; preds = %block_.L_40da66
  %401 = add i64 %400, -43
  %402 = add i64 %400, 5
  store i64 %402, i64* %3, align 8
  br label %block_.L_40da66

block_.L_40da96:                                  ; preds = %block_.L_40da66
  %403 = add i64 %400, 5
  store i64 %403, i64* %3, align 8
  br label %block_.L_40da9b

block_.L_40da9b:                                  ; preds = %block_.L_40da55, %block_.L_40da96
  %404 = phi i64 [ %276, %block_.L_40da55 ], [ %403, %block_.L_40da96 ]
  %405 = phi i64 [ %240, %block_.L_40da55 ], [ %365, %block_.L_40da96 ]
  %406 = add i64 %405, -32
  %407 = add i64 %404, 3
  ...
  %call2_40da9e = tail call %struct.Memory* @sub_40c140._Z9check_sumIiEvT_(%struct.State* nonnull %0, i64 %411, %struct.Memory* %MEMORY.0)
...
block_.L_40dab1:                                  ; preds = %block_.L_40d9ef
  ...
  %call2_40dab1 = tail call %struct.Memory* @sub_400e30._Z5timerv(%struct.State* nonnull %0, i64 %448, %struct.Memory* %MEMORY.0)
  ...
  %call2_40daba = tail call %struct.Memory* @sub_4007d0._Z13record_resultdPKc(%struct.State* nonnull %0, i64 %459, %struct.Memory* %call2_40dab1)
  ...
  ret %struct.Memory* %call2_40daba
}
...
; Function Attrs: alwaysinline norecurse nounwind
define %struct.Memory* @routine_jge_.L_40dab1(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i8* nocapture %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
...
; Function Attrs: alwaysinline norecurse nounwind
define %struct.Memory* @routine_jl_.L_40da55(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i8* nocapture %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 2, i32 9
...
; Function Attrs: alwaysinline norecurse nounwind
define %struct.Memory* @routine_jmpq_.L_40da21(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
...
; Function Attrs: alwaysinline norecurse nounwind
define %struct.Memory* @routine_jge_.L_40da50(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i8* nocapture %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 2, i32 9
...
; Function Attrs: alwaysinline norecurse nounwind
define %struct.Memory* @routine_jmpq_.L_40da55(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
...
; Function Attrs: alwaysinline norecurse nounwind
define %struct.Memory* @routine_jge_.L_40da9b(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i8* nocapture %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 2, i32 9
...
; Function Attrs: alwaysinline norecurse nounwind
define %struct.Memory* @routine_jmpq_.L_40da66(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
...
; Function Attrs: alwaysinline norecurse nounwind
define %struct.Memory* @routine_je_.L_40da96(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i8* nocapture %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
...
; Function Attrs: alwaysinline norecurse nounwind
define %struct.Memory* @routine_jmpq_.L_40da9b(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
