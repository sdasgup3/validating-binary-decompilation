...
define %struct.Memory* @_Z28test_goto_loop_unroll_factorILi22EiEvPKT0_iPKc(%struct.State* noalias, i64, %struct.Memory* noalias readnone) local_unnamed_addr #1 {
entry:
...
block_.L_40da11:                                  ; preds = %block_40da3b, %block_40da0c
  ...
  %call2_40da1c = tail call %struct.Memory* @sub_40c540._ZN15loop_inner_bodyILi22EiE7do_workERiPKii(%struct.State* nonnull %0, i64 %161, %struct.Memory* %MEMORY.0)
...
block_.L_40da45:                                  ; preds = %block_.L_40da40, %block_40d9ef
  %239 = phi i64 [ %238, %block_.L_40da40 ], [ %148, %block_40d9ef ]
  %240 = phi i64 [ %196, %block_.L_40da40 ], [ %111, %block_40d9ef ]
  %241 = add i64 %240, -36
  %242 = add i64 %239, 3
...
block_.L_40da56:                                  ; preds = %block_40da81, %block_40da51
  ...
  %call2_40da61 = tail call %struct.Memory* @sub_40c100._Z18complete_hash_funcIiET_S0_(%struct.State* nonnull %0, i64 %294, %struct.Memory* %MEMORY.0)
...
block_.L_40da8b:                                  ; preds = %block_.L_40da45, %block_.L_40da86
  ...
  %call2_40da8e = tail call %struct.Memory* @sub_40c130._Z9check_sumIiEvT_(%struct.State* nonnull %0, i64 %411, %struct.Memory* %MEMORY.0)
