...
define %struct.Memory* @_Z28test_goto_loop_unroll_factorILi23EdEvPKT0_iPKc(%struct.State* noalias, i64, %struct.Memory* noalias) local_unnamed_addr #1 {
entry:
  ...
  %call2_402c93 = tail call %struct.Memory* @sub_400dd0._Z11start_timerv(%struct.State* %0, i64 %58, %struct.Memory* %2)
...
block_.L_402c9f:                                  ; preds = %block_.L_402d52, %entry
  %79 = phi i64 [ %.pre, %entry ], [ %435, %block_.L_402d52 ]
  %MEMORY.0 = phi %struct.Memory* [ %call2_402c93, %entry ], [ %call2_402d57, %block_.L_402d52 ]
  ...
  br i1 %112, label %block_402caf, label %block_.L_402d6a
...
block_402caf:                                     ; preds = %block_.L_402c9f
  ...
  br i1 %160, label %block_.L_402d06, label %block_402ccd
...
block_.L_402cd2:                                  ; preds = %block_402cfc, %block_402ccd
  %163 = phi i64 [ %162, %block_402ccd ], [ %250, %block_402cfc ]
  %164 = phi i64 [ %124, %block_402ccd ], [ %210, %block_402cfc ]
  %MEMORY.1 = phi %struct.Memory* [ %MEMORY.0, %block_402ccd ], [ %call2_402cdd, %block_402cfc ]
  %165 = add i64 %164, -40
  ...
  %call2_402cdd = tail call %struct.Memory* @sub_4018f0._ZN15loop_inner_bodyILi23EdE7do_workERdPKdi(%struct.State* %0, i64 %175, %struct.Memory* %MEMORY.1)
  ...
  br i1 %248, label %block_402cfc, label %block_.L_402d01
...
block_.L_402d06:                                  ; preds = %block_.L_402d01, %block_402caf
  %252 = phi i64 [ %161, %block_402caf ], [ %251, %block_.L_402d01 ]
  %253 = phi i64 [ %124, %block_402caf ], [ %210, %block_.L_402d01 ]
  %MEMORY.2 = phi %struct.Memory* [ %MEMORY.0, %block_402caf ], [ %call2_402cdd, %block_.L_402d01 ]
  %254 = add i64 %253, -44
  %255 = add i64 %252, 3
  ...
  br i1 %288, label %block_402d12, label %block_.L_402d52
...
block_.L_402d17:                                  ; preds = %block_402d48, %block_402d12
  %291 = phi i64 [ %290, %block_402d12 ], [ %389, %block_402d48 ]
  %292 = phi i64 [ %253, %block_402d12 ], [ %353, %block_402d48 ]
  %MEMORY.3 = phi %struct.Memory* [ %MEMORY.2, %block_402d12 ], [ %call2_402d24, %block_402d48 ]
  %293 = add i64 %292, -8
  %294 = add i64 %291, 4
  ...
  %call2_402d24 = tail call %struct.Memory* @sub_401480._Z18complete_hash_funcIdET_S0_(%struct.State* %0, i64 %308, %struct.Memory* %MEMORY.3)
  ...
  br i1 %377, label %block_.L_402d4d, label %block_402d48
...
block_.L_402d52:                                  ; preds = %block_.L_402d06, %block_.L_402d4d
  %391 = phi i64 [ %289, %block_.L_402d06 ], [ %390, %block_.L_402d4d ]
  %392 = phi i64 [ %253, %block_.L_402d06 ], [ %353, %block_.L_402d4d ]
  %MEMORY.4 = phi %struct.Memory* [ %MEMORY.2, %block_.L_402d06 ], [ %call2_402d24, %block_.L_402d4d ]
  %393 = add i64 %392, -40
  %394 = add i64 %391, 5
  ...
  %call2_402d57 = tail call %struct.Memory* @sub_4014b0._Z9check_sumIdEvT_(%struct.State* %0, i64 %398, %struct.Memory* %MEMORY.4)
...
block_.L_402d6a:                                  ; preds = %block_.L_402c9f
  ...
  %call2_402d6a = tail call %struct.Memory* @sub_400df0._Z5timerv(%struct.State* %0, i64 %436, %struct.Memory* %MEMORY.0)
  ...
  %call2_402d73 = tail call %struct.Memory* @sub_400790._Z13record_resultdPKc(%struct.State* %0, i64 %447, %struct.Memory* %call2_402d6a)
...
define %struct.Memory* @routine_jge_.L_402d6a(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i8* %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
...
define %struct.Memory* @routine_jl_.L_402d06(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i8* %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 2, i32 9
...
define %struct.Memory* @routine_jmpq_.L_402cd2(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
...
define %struct.Memory* @routine_jge_.L_402d01(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i8* %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 2, i32 9
...
define %struct.Memory* @routine_jmpq_.L_402d06(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
...
define %struct.Memory* @routine_jge_.L_402d52(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i8* %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 2, i32 9
...
define %struct.Memory* @routine_jmpq_.L_402d17(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
...
define %struct.Memory* @routine_je_.L_402d4d(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i8* %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
...
define %struct.Memory* @routine_jmpq_.L_402d52(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
...
define %struct.Memory* @routine_jmpq_.L_402c9f(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
