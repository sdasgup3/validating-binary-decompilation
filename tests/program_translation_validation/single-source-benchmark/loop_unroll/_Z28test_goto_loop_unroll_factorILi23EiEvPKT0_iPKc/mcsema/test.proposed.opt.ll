...
block_.L_40d85f:                                  ; preds = %block_.L_40d90b, %entry
  %68 = phi i64 [ %.pre, %entry ], [ %449, %block_.L_40d90b ]
...
block_.L_40d8d6:                                  ; preds = %block_40d901, %block_40d8d1
  %278 = phi i64 [ %277, %block_40d8d1 ], [ %403, %block_40d901 ]
  %279 = phi i64 [ %240, %block_40d8d1 ], [ %367, %block_40d901 ]
  ...
  br i1 %391, label %block_.L_40d906, label %block_40d901
...
block_.L_40d90b:                                  ; preds = %block_.L_40d8c5, %block_.L_40d906
  %405 = phi i64 [ %276, %block_.L_40d8c5 ], [ %404, %block_.L_40d906 ]
  %406 = phi i64 [ %240, %block_.L_40d8c5 ], [ %367, %block_.L_40d906 ]
  ...
  %call2_40d90e = tail call %struct.Memory* @sub_40c100._Z9check_sumIiEvT_(%struct.State* %0, i64 %412, %struct.Memory* %MEMORY.4)
...
block_.L_40d921:                                  ; preds = %block_.L_40d85f
  ...
  %call2_40d921 = tail call %struct.Memory* @sub_400df0._Z5timerv(%struct.State* %0, i64 %450, %struct.Memory* %MEMORY.0)
  ...
  %call2_40d92a = tail call %struct.Memory* @sub_400790._Z13record_resultdPKc(%struct.State* %0, i64 %461, %struct.Memory* %call2_40d921)
