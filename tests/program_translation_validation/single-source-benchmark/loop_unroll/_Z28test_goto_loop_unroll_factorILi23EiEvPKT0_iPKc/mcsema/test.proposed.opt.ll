...
define %struct.Memory* @_Z28test_goto_loop_unroll_factorILi23EiEvPKT0_iPKc(%struct.State* noalias, i64, %struct.Memory* noalias readnone) local_unnamed_addr #1 {
entry:
...
block_.L_40d8c1:                                  ; preds = %block_40d8eb, %block_40d8bc
  ...
  %call2_40d8cc = tail call %struct.Memory* @sub_40c4e0._ZN15loop_inner_bodyILi23EiE7do_workERiPKii(%struct.State* nonnull %0, i64 %161, %struct.Memory* %MEMORY.0)
...
block_.L_40d8f5:                                  ; preds = %block_.L_40d8f0, %block_40d89f
  %239 = phi i64 [ %238, %block_.L_40d8f0 ], [ %148, %block_40d89f ]
  %240 = phi i64 [ %196, %block_.L_40d8f0 ], [ %111, %block_40d89f ]
  %241 = add i64 %240, -36
  %242 = add i64 %239, 3
...
block_.L_40d906:                                  ; preds = %block_40d931, %block_40d901
  ...
  %call2_40d911 = tail call %struct.Memory* @sub_40c100._Z18complete_hash_funcIiET_S0_(%struct.State* nonnull %0, i64 %294, %struct.Memory* %MEMORY.0)
...
block_.L_40d93b:                                  ; preds = %block_.L_40d8f5, %block_.L_40d936
  ...
  %call2_40d93e = tail call %struct.Memory* @sub_40c130._Z9check_sumIiEvT_(%struct.State* nonnull %0, i64 %411, %struct.Memory* %MEMORY.0)
