...
entry:
  ...
  %call2_40d893 = tail call %struct.Memory* @sub_400e10._Z11start_timerv(%struct.State* %0, i64 %58, %struct.Memory* %2)
  ...
  br label %block_.L_40d89f

block_.L_40d89f:                                  ; preds = %block_.L_40d94b, %entry
  %68 = phi i64 [ %.pre, %entry ], [ %447, %block_.L_40d94b ]
  %MEMORY.0 = phi %struct.Memory* [ %call2_40d893, %entry ], [ %call2_40d94e, %block_.L_40d94b ]
  ...
  br i1 %101, label %block_40d8af, label %block_.L_40d961

block_40d8af:                                     ; preds = %block_.L_40d89f
  %103 = add i64 %69, -32
  %104 = add i64 %102, 7
  ...
  br i1 %147, label %block_.L_40d905, label %block_40d8cc

block_40d8cc:                                     ; preds = %block_40d8af
  %149 = add i64 %148, 5
  br label %block_.L_40d8d1

block_.L_40d8d1:                                  ; preds = %block_40d8fb, %block_40d8cc
  %150 = phi i64 [ %111, %block_40d8cc ], [ %196, %block_40d8fb ]
  %storemerge = phi i64 [ %149, %block_40d8cc ], [ %236, %block_40d8fb ]
  %151 = add i64 %150, -32
  ...
  %call2_40d8dc = tail call %struct.Memory* @sub_40c4f0._ZN15loop_inner_bodyILi23EiE7do_workERiPKii(%struct.State* nonnull %0, i64 %161, %struct.Memory* %MEMORY.0)
  ...
  br i1 %234, label %block_40d8fb, label %block_.L_40d900

block_40d8fb:                                     ; preds = %block_.L_40d8d1
  %236 = add i64 %235, -42
  %237 = add i64 %235, 5
  store i64 %237, i64* %3, align 8
  br label %block_.L_40d8d1

block_.L_40d900:                                  ; preds = %block_.L_40d8d1
  %238 = add i64 %235, 5
  store i64 %238, i64* %3, align 8
  br label %block_.L_40d905

block_.L_40d905:                                  ; preds = %block_.L_40d900, %block_40d8af
  %239 = phi i64 [ %238, %block_.L_40d900 ], [ %148, %block_40d8af ]
  %240 = phi i64 [ %196, %block_.L_40d900 ], [ %111, %block_40d8af ]
  %241 = add i64 %240, -36
  %242 = add i64 %239, 3
  ...
  br i1 %275, label %block_40d911, label %block_.L_40d94b

block_40d911:                                     ; preds = %block_.L_40d905
  %277 = add i64 %276, 5
  br label %block_.L_40d916

block_.L_40d916:                                  ; preds = %block_40d941, %block_40d911
  %278 = phi i64 [ %240, %block_40d911 ], [ %365, %block_40d941 ]
  %storemerge5 = phi i64 [ %277, %block_40d911 ], [ %401, %block_40d941 ]
  %279 = add i64 %278, -8
  ...
  %call2_40d921 = tail call %struct.Memory* @sub_40c110._Z18complete_hash_funcIiET_S0_(%struct.State* nonnull %0, i64 %294, %struct.Memory* %MEMORY.0)
  ...
  br i1 %389, label %block_.L_40d946, label %block_40d941

block_40d941:                                     ; preds = %block_.L_40d916
  %401 = add i64 %400, -43
  %402 = add i64 %400, 5
  store i64 %402, i64* %3, align 8
  br label %block_.L_40d916

block_.L_40d946:                                  ; preds = %block_.L_40d916
  %403 = add i64 %400, 5
  store i64 %403, i64* %3, align 8
  br label %block_.L_40d94b

block_.L_40d94b:                                  ; preds = %block_.L_40d905, %block_.L_40d946
  %404 = phi i64 [ %276, %block_.L_40d905 ], [ %403, %block_.L_40d946 ]
  %405 = phi i64 [ %240, %block_.L_40d905 ], [ %365, %block_.L_40d946 ]
  %406 = add i64 %405, -32
  %407 = add i64 %404, 3
  ...
  %call2_40d94e = tail call %struct.Memory* @sub_40c140._Z9check_sumIiEvT_(%struct.State* nonnull %0, i64 %411, %struct.Memory* %MEMORY.0)
...
block_.L_40d961:                                  ; preds = %block_.L_40d89f
  ...
  %call2_40d961 = tail call %struct.Memory* @sub_400e30._Z5timerv(%struct.State* nonnull %0, i64 %448, %struct.Memory* %MEMORY.0)
  ...
  %call2_40d96a = tail call %struct.Memory* @sub_4007d0._Z13record_resultdPKc(%struct.State* nonnull %0, i64 %459, %struct.Memory* %call2_40d961)
