...
define %struct.Memory* @_Z28test_goto_loop_unroll_factorILi24EiEvPKT0_iPKc(%struct.State* noalias, i64, %struct.Memory* noalias) #1 {
entry:
  ...
  store %struct.Memory* %loadMem_40d720, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_40d721, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_40d724, %struct.Memory** %MEMORY
  ...
  store i64 %78, i64* %81
  store %struct.Memory* %loadMem_40d728, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_40d72f, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem1_40d733, %struct.Memory** %MEMORY
...
block_.L_40d73f:                                  ; preds = %block_.L_40d7eb, %entry
...
block_40d74f:                                     ; preds = %block_.L_40d73f
...
block_40d76c:                                     ; preds = %block_40d74f
...
block_.L_40d771:                                  ; preds = %block_40d79b, %block_40d76c
  ...
  store %struct.Memory* %loadMem1_40d77c, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_40d784, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_40d787, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_40d78d, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_40d790, %struct.Memory** %MEMORY
...
block_40d79b:                                     ; preds = %block_.L_40d771
...
block_.L_40d7a0:                                  ; preds = %block_.L_40d771
...
block_.L_40d7a5:                                  ; preds = %block_.L_40d7a0, %block_40d74f
...
block_40d7b1:                                     ; preds = %block_.L_40d7a5
...
block_.L_40d7b6:                                  ; preds = %block_40d7e1, %block_40d7b1
  ...
  store %struct.Memory* %loadMem1_40d7c1, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_40d7d8, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_40d7db, %struct.Memory** %MEMORY
...
block_40d7e1:                                     ; preds = %block_.L_40d7b6
...
block_.L_40d7e6:                                  ; preds = %block_.L_40d7b6
...
block_.L_40d7eb:                                  ; preds = %block_.L_40d7e6, %block_.L_40d7a5
  ...
  store %struct.Memory* %loadMem1_40d7ee, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_40d7f3, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_40d7f9, %struct.Memory** %MEMORY
...
block_.L_40d801:                                  ; preds = %block_.L_40d73f
  ...
  store %struct.Memory* %loadMem1_40d801, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem1_40d80a, %struct.Memory** %MEMORY
  ...
  ret %struct.Memory* %loadMem_40d814
}
