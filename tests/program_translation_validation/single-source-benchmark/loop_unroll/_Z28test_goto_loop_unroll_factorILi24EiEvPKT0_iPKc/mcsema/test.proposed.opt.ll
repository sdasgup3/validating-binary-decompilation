...
entry:
  ...
  %call2_40d703 = tail call %struct.Memory* @sub_400dd0._Z11start_timerv(%struct.State* %0, i64 %58, %struct.Memory* %2)
...
block_.L_40d70f:                                  ; preds = %block_.L_40d7bb, %entry
  %68 = phi i64 [ %.pre, %entry ], [ %449, %block_.L_40d7bb ]
  %MEMORY.0 = phi %struct.Memory* [ %call2_40d703, %entry ], [ %call2_40d7be, %block_.L_40d7bb ]
  ...
  br i1 %101, label %block_40d71f, label %block_.L_40d7d1
...
block_40d71f:                                     ; preds = %block_.L_40d70f
  ...
  br i1 %147, label %block_.L_40d775, label %block_40d73c
...
block_.L_40d741:                                  ; preds = %block_40d76b, %block_40d73c
  %150 = phi i64 [ %149, %block_40d73c ], [ %237, %block_40d76b ]
  %151 = phi i64 [ %111, %block_40d73c ], [ %197, %block_40d76b ]
  %MEMORY.1 = phi %struct.Memory* [ %MEMORY.0, %block_40d73c ], [ %call2_40d74c, %block_40d76b ]
  %152 = add i64 %151, -32
  ...
  %call2_40d74c = tail call %struct.Memory* @sub_40c450._ZN15loop_inner_bodyILi24EiE7do_workERiPKii(%struct.State* %0, i64 %162, %struct.Memory* %MEMORY.1)
  ...
  br i1 %235, label %block_40d76b, label %block_.L_40d770
...
block_.L_40d775:                                  ; preds = %block_.L_40d770, %block_40d71f
  %239 = phi i64 [ %148, %block_40d71f ], [ %238, %block_.L_40d770 ]
  %240 = phi i64 [ %111, %block_40d71f ], [ %197, %block_.L_40d770 ]
  %MEMORY.2 = phi %struct.Memory* [ %MEMORY.0, %block_40d71f ], [ %call2_40d74c, %block_.L_40d770 ]
  %241 = add i64 %240, -36
  %242 = add i64 %239, 3
  ...
  br i1 %275, label %block_40d781, label %block_.L_40d7bb
...
block_.L_40d786:                                  ; preds = %block_40d7b1, %block_40d781
  %278 = phi i64 [ %277, %block_40d781 ], [ %403, %block_40d7b1 ]
  %279 = phi i64 [ %240, %block_40d781 ], [ %367, %block_40d7b1 ]
  %MEMORY.3 = phi %struct.Memory* [ %MEMORY.2, %block_40d781 ], [ %call2_40d791, %block_40d7b1 ]
  %280 = add i64 %279, -8
  %281 = add i64 %278, 4
  ...
  %call2_40d791 = tail call %struct.Memory* @sub_40c0d0._Z18complete_hash_funcIiET_S0_(%struct.State* %0, i64 %295, %struct.Memory* %MEMORY.3)
  ...
  br i1 %391, label %block_.L_40d7b6, label %block_40d7b1
...
block_.L_40d7bb:                                  ; preds = %block_.L_40d775, %block_.L_40d7b6
  %405 = phi i64 [ %276, %block_.L_40d775 ], [ %404, %block_.L_40d7b6 ]
  %406 = phi i64 [ %240, %block_.L_40d775 ], [ %367, %block_.L_40d7b6 ]
  %MEMORY.4 = phi %struct.Memory* [ %MEMORY.2, %block_.L_40d775 ], [ %call2_40d791, %block_.L_40d7b6 ]
  %407 = add i64 %406, -32
  %408 = add i64 %405, 3
  ...
  %call2_40d7be = tail call %struct.Memory* @sub_40c100._Z9check_sumIiEvT_(%struct.State* %0, i64 %412, %struct.Memory* %MEMORY.4)
...
block_.L_40d7d1:                                  ; preds = %block_.L_40d70f
  ...
  %call2_40d7d1 = tail call %struct.Memory* @sub_400df0._Z5timerv(%struct.State* %0, i64 %450, %struct.Memory* %MEMORY.0)
  ...
  %call2_40d7da = tail call %struct.Memory* @sub_400790._Z13record_resultdPKc(%struct.State* %0, i64 %461, %struct.Memory* %call2_40d7d1)
  ...
  ret %struct.Memory* %call2_40d7da
}
...
define %struct.Memory* @routine_jge_.L_40d7d1(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i8* %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
...
define %struct.Memory* @routine_jl_.L_40d775(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i8* %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 2, i32 9
...
define %struct.Memory* @routine_jmpq_.L_40d741(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
...
define %struct.Memory* @routine_jge_.L_40d770(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i8* %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 2, i32 9
...
define %struct.Memory* @routine_jmpq_.L_40d775(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
...
define %struct.Memory* @routine_jge_.L_40d7bb(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i8* %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 2, i32 9
...
define %struct.Memory* @routine_jmpq_.L_40d786(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
...
define %struct.Memory* @routine_je_.L_40d7b6(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i8* %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
...
define %struct.Memory* @routine_jmpq_.L_40d7bb(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
...
define %struct.Memory* @routine_jmpq_.L_40d70f(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
