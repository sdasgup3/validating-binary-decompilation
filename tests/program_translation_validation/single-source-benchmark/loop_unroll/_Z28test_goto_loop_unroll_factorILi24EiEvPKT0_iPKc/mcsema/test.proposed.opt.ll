...
block_.L_40d70f:                                  ; preds = %block_.L_40d7bb, %entry
  %68 = phi i64 [ %.pre, %entry ], [ %447, %block_.L_40d7bb ]
...
block_.L_40d786:                                  ; preds = %block_40d7b1, %block_40d781
  %278 = phi i64 [ %277, %block_40d781 ], [ %402, %block_40d7b1 ]
  %279 = phi i64 [ %240, %block_40d781 ], [ %366, %block_40d7b1 ]
  ...
  br i1 %390, label %block_.L_40d7b6, label %block_40d7b1
...
block_.L_40d7bb:                                  ; preds = %block_.L_40d775, %block_.L_40d7b6
  %404 = phi i64 [ %276, %block_.L_40d775 ], [ %403, %block_.L_40d7b6 ]
  %405 = phi i64 [ %240, %block_.L_40d775 ], [ %366, %block_.L_40d7b6 ]
  ...
  %call2_40d7be = tail call %struct.Memory* @sub_40c100._Z9check_sumIiEvT_(%struct.State* %0, i64 %411, %struct.Memory* %MEMORY.4)
...
block_.L_40d7d1:                                  ; preds = %block_.L_40d70f
  ...
  %call2_40d7d1 = tail call %struct.Memory* @sub_400df0._Z5timerv(%struct.State* %0, i64 %448, %struct.Memory* %MEMORY.0)
  ...
  %call2_40d7da = tail call %struct.Memory* @sub_400790._Z13record_resultdPKc(%struct.State* %0, i64 %459, %struct.Memory* %call2_40d7d1)
