...
block_.L_40d5bf:                                  ; preds = %block_.L_40d66b, %entry
  %68 = phi i64 [ %.pre, %entry ], [ %449, %block_.L_40d66b ]
...
block_.L_40d636:                                  ; preds = %block_40d661, %block_40d631
  %278 = phi i64 [ %277, %block_40d631 ], [ %403, %block_40d661 ]
  %279 = phi i64 [ %240, %block_40d631 ], [ %367, %block_40d661 ]
  ...
  br i1 %391, label %block_.L_40d666, label %block_40d661
...
block_.L_40d66b:                                  ; preds = %block_.L_40d625, %block_.L_40d666
  %405 = phi i64 [ %276, %block_.L_40d625 ], [ %404, %block_.L_40d666 ]
  %406 = phi i64 [ %240, %block_.L_40d625 ], [ %367, %block_.L_40d666 ]
  ...
  %call2_40d66e = tail call %struct.Memory* @sub_40c100._Z9check_sumIiEvT_(%struct.State* %0, i64 %412, %struct.Memory* %MEMORY.4)
...
block_.L_40d681:                                  ; preds = %block_.L_40d5bf
  ...
  %call2_40d681 = tail call %struct.Memory* @sub_400df0._Z5timerv(%struct.State* %0, i64 %450, %struct.Memory* %MEMORY.0)
  ...
  %call2_40d68a = tail call %struct.Memory* @sub_400790._Z13record_resultdPKc(%struct.State* %0, i64 %461, %struct.Memory* %call2_40d681)
