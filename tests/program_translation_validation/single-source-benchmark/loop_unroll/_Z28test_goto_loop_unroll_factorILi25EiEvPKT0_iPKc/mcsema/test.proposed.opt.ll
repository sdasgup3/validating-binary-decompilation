...
define %struct.Memory* @_Z28test_goto_loop_unroll_factorILi25EiEvPKT0_iPKc(%struct.State* noalias, i64, %struct.Memory* noalias readnone) local_unnamed_addr #1 {
entry:
...
block_.L_40d621:                                  ; preds = %block_40d64b, %block_40d61c
  ...
  %call2_40d62c = tail call %struct.Memory* @sub_40c420._ZN15loop_inner_bodyILi25EiE7do_workERiPKii(%struct.State* nonnull %0, i64 %161, %struct.Memory* %MEMORY.0)
...
block_.L_40d655:                                  ; preds = %block_.L_40d650, %block_40d5ff
  %239 = phi i64 [ %238, %block_.L_40d650 ], [ %148, %block_40d5ff ]
  %240 = phi i64 [ %196, %block_.L_40d650 ], [ %111, %block_40d5ff ]
  %241 = add i64 %240, -36
  %242 = add i64 %239, 3
...
block_.L_40d666:                                  ; preds = %block_40d691, %block_40d661
  ...
  %call2_40d671 = tail call %struct.Memory* @sub_40c100._Z18complete_hash_funcIiET_S0_(%struct.State* nonnull %0, i64 %294, %struct.Memory* %MEMORY.0)
...
block_.L_40d69b:                                  ; preds = %block_.L_40d655, %block_.L_40d696
  ...
  %call2_40d69e = tail call %struct.Memory* @sub_40c130._Z9check_sumIiEvT_(%struct.State* nonnull %0, i64 %411, %struct.Memory* %MEMORY.0)
