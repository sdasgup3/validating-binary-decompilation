...
entry:
  ...
  %call2_40d5f3 = tail call %struct.Memory* @sub_400e10._Z11start_timerv(%struct.State* %0, i64 %58, %struct.Memory* %2)
...
block_.L_40d5ff:                                  ; preds = %block_.L_40d6ab, %entry
  %68 = phi i64 [ %.pre, %entry ], [ %447, %block_.L_40d6ab ]
  %MEMORY.0 = phi %struct.Memory* [ %call2_40d5f3, %entry ], [ %call2_40d6ae, %block_.L_40d6ab ]
  ...
  br i1 %101, label %block_40d60f, label %block_.L_40d6c1

block_40d60f:                                     ; preds = %block_.L_40d5ff
  %103 = add i64 %69, -32
  %104 = add i64 %102, 7
  ...
  br i1 %147, label %block_.L_40d665, label %block_40d62c

block_40d62c:                                     ; preds = %block_40d60f
  %149 = add i64 %148, 5
  br label %block_.L_40d631

block_.L_40d631:                                  ; preds = %block_40d65b, %block_40d62c
  %150 = phi i64 [ %111, %block_40d62c ], [ %196, %block_40d65b ]
  %storemerge = phi i64 [ %149, %block_40d62c ], [ %236, %block_40d65b ]
  %151 = add i64 %150, -32
  ...
  %call2_40d63c = tail call %struct.Memory* @sub_40c430._ZN15loop_inner_bodyILi25EiE7do_workERiPKii(%struct.State* nonnull %0, i64 %161, %struct.Memory* %MEMORY.0)
  ...
  br i1 %234, label %block_40d65b, label %block_.L_40d660

block_40d65b:                                     ; preds = %block_.L_40d631
  %236 = add i64 %235, -42
  %237 = add i64 %235, 5
  store i64 %237, i64* %3, align 8
  br label %block_.L_40d631

block_.L_40d660:                                  ; preds = %block_.L_40d631
  %238 = add i64 %235, 5
  store i64 %238, i64* %3, align 8
  br label %block_.L_40d665

block_.L_40d665:                                  ; preds = %block_.L_40d660, %block_40d60f
  %239 = phi i64 [ %238, %block_.L_40d660 ], [ %148, %block_40d60f ]
  %240 = phi i64 [ %196, %block_.L_40d660 ], [ %111, %block_40d60f ]
  %241 = add i64 %240, -36
  %242 = add i64 %239, 3
  ...
  br i1 %275, label %block_40d671, label %block_.L_40d6ab

block_40d671:                                     ; preds = %block_.L_40d665
  %277 = add i64 %276, 5
  br label %block_.L_40d676

block_.L_40d676:                                  ; preds = %block_40d6a1, %block_40d671
  %278 = phi i64 [ %240, %block_40d671 ], [ %365, %block_40d6a1 ]
  %storemerge5 = phi i64 [ %277, %block_40d671 ], [ %401, %block_40d6a1 ]
  %279 = add i64 %278, -8
  ...
  %call2_40d681 = tail call %struct.Memory* @sub_40c110._Z18complete_hash_funcIiET_S0_(%struct.State* nonnull %0, i64 %294, %struct.Memory* %MEMORY.0)
  ...
  br i1 %389, label %block_.L_40d6a6, label %block_40d6a1

block_40d6a1:                                     ; preds = %block_.L_40d676
  %401 = add i64 %400, -43
  %402 = add i64 %400, 5
  store i64 %402, i64* %3, align 8
  br label %block_.L_40d676

block_.L_40d6a6:                                  ; preds = %block_.L_40d676
  %403 = add i64 %400, 5
  store i64 %403, i64* %3, align 8
  br label %block_.L_40d6ab

block_.L_40d6ab:                                  ; preds = %block_.L_40d665, %block_.L_40d6a6
  %404 = phi i64 [ %276, %block_.L_40d665 ], [ %403, %block_.L_40d6a6 ]
  %405 = phi i64 [ %240, %block_.L_40d665 ], [ %365, %block_.L_40d6a6 ]
  %406 = add i64 %405, -32
  %407 = add i64 %404, 3
  ...
  %call2_40d6ae = tail call %struct.Memory* @sub_40c140._Z9check_sumIiEvT_(%struct.State* nonnull %0, i64 %411, %struct.Memory* %MEMORY.0)
...
block_.L_40d6c1:                                  ; preds = %block_.L_40d5ff
  ...
  %call2_40d6c1 = tail call %struct.Memory* @sub_400e30._Z5timerv(%struct.State* nonnull %0, i64 %448, %struct.Memory* %MEMORY.0)
  ...
  %call2_40d6ca = tail call %struct.Memory* @sub_4007d0._Z13record_resultdPKc(%struct.State* nonnull %0, i64 %459, %struct.Memory* %call2_40d6c1)
