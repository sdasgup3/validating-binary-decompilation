...
define %struct.Memory* @_Z28test_goto_loop_unroll_factorILi26EdEvPKT0_iPKc(%struct.State* noalias, i64, %struct.Memory* noalias) #1 {
entry:
  ...
  store %struct.Memory* %loadMem_4028c4, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem1_4028d3, %struct.Memory** %MEMORY
...
block_.L_402957:                                  ; preds = %block_402988, %block_402952
  ...
  store %struct.Memory* %loadMem1_402964, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_402973, %struct.Memory** %MEMORY
...
block_.L_402992:                                  ; preds = %block_.L_40298d, %block_.L_402946
  ...
  store %struct.Memory* %loadMem1_402997, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_4029a5, %struct.Memory** %MEMORY
  br label %block_.L_4028df
...
block_.L_4029aa:                                  ; preds = %block_.L_4028df
  ...
  store %struct.Memory* %loadMem1_4029b3, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_4029bd, %struct.Memory** %MEMORY
  ret %struct.Memory* %loadMem_4029bd
}
