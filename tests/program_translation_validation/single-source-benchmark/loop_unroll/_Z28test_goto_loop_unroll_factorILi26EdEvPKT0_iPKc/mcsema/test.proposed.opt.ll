...
declare %struct.Memory* @sub_401800._ZN15loop_inner_bodyILi26EdE7do_workERdPKdi(%struct.State* dereferenceable(3376), i64, %struct.Memory*) local_unnamed_addr
...
define %struct.Memory* @_Z28test_goto_loop_unroll_factorILi26EdEvPKT0_iPKc(%struct.State* noalias, i64, %struct.Memory* noalias) local_unnamed_addr #1 {
entry:
  ...
  %call2_4028d3 = tail call %struct.Memory* @sub_400e00._Z11start_timerv(%struct.State* %0, i64 %58, %struct.Memory* %2)
  ...
  br label %block_.L_4028df

block_.L_4028df:                                  ; preds = %block_.L_402992, %entry
  %74 = phi i64 [ %.pre, %entry ], [ %426, %block_.L_402992 ]
  %MEMORY.0 = phi %struct.Memory* [ %call2_4028d3, %entry ], [ %call2_402997, %block_.L_402992 ]
  ...
  br i1 %107, label %block_4028ef, label %block_.L_4029aa

block_4028ef:                                     ; preds = %block_.L_4028df
  ...
  br i1 %154, label %block_.L_402946, label %block_40290d

block_40290d:                                     ; preds = %block_4028ef
  %156 = add i64 %155, 5
  br label %block_.L_402912

block_.L_402912:                                  ; preds = %block_40293c, %block_40290d
  %157 = phi i64 [ %118, %block_40290d ], [ %203, %block_40293c ]
  %storemerge = phi i64 [ %156, %block_40290d ], [ %243, %block_40293c ]
  %MEMORY.1 = phi %struct.Memory* [ %MEMORY.0, %block_40290d ], [ %call2_40291d, %block_40293c ]
  %158 = add i64 %157, -40
  ...
  %call2_40291d = tail call %struct.Memory* @sub_401800._ZN15loop_inner_bodyILi26EdE7do_workERdPKdi(%struct.State* nonnull %0, i64 %168, %struct.Memory* %MEMORY.1)
  ...
  br i1 %241, label %block_40293c, label %block_.L_402941

block_40293c:                                     ; preds = %block_.L_402912
  %243 = add i64 %242, -42
  %244 = add i64 %242, 5
  store i64 %244, i64* %3, align 8
  br label %block_.L_402912

block_.L_402941:                                  ; preds = %block_.L_402912
  %245 = add i64 %242, 5
  store i64 %245, i64* %3, align 8
  br label %block_.L_402946

block_.L_402946:                                  ; preds = %block_.L_402941, %block_4028ef
  %246 = phi i64 [ %155, %block_4028ef ], [ %245, %block_.L_402941 ]
  %247 = phi i64 [ %118, %block_4028ef ], [ %203, %block_.L_402941 ]
  %MEMORY.2 = phi %struct.Memory* [ %MEMORY.0, %block_4028ef ], [ %call2_40291d, %block_.L_402941 ]
  %248 = add i64 %247, -44
  %249 = add i64 %246, 3
  ...
  br i1 %282, label %block_402952, label %block_.L_402992

block_402952:                                     ; preds = %block_.L_402946
  %284 = add i64 %283, 5
  br label %block_.L_402957

block_.L_402957:                                  ; preds = %block_402988, %block_402952
  %285 = phi i64 [ %247, %block_402952 ], [ %345, %block_402988 ]
  %storemerge5 = phi i64 [ %284, %block_402952 ], [ %381, %block_402988 ]
  %MEMORY.3 = phi %struct.Memory* [ %MEMORY.2, %block_402952 ], [ %call2_402964, %block_402988 ]
  %286 = add i64 %285, -8
  ...
  %call2_402964 = tail call %struct.Memory* @sub_4014b0._Z18complete_hash_funcIdET_S0_(%struct.State* nonnull %0, i64 %300, %struct.Memory* %MEMORY.3)
  ...
  br i1 %369, label %block_.L_40298d, label %block_402988

block_402988:                                     ; preds = %block_.L_402957
  %381 = add i64 %380, -49
  %382 = add i64 %380, 5
  store i64 %382, i64* %3, align 8
  br label %block_.L_402957

block_.L_40298d:                                  ; preds = %block_.L_402957
  %383 = add i64 %380, 5
  store i64 %383, i64* %3, align 8
  br label %block_.L_402992

block_.L_402992:                                  ; preds = %block_.L_402946, %block_.L_40298d
  %384 = phi i64 [ %283, %block_.L_402946 ], [ %383, %block_.L_40298d ]
  %385 = phi i64 [ %247, %block_.L_402946 ], [ %345, %block_.L_40298d ]
  %MEMORY.4 = phi %struct.Memory* [ %MEMORY.2, %block_.L_402946 ], [ %call2_402964, %block_.L_40298d ]
  %386 = add i64 %385, -40
  %387 = add i64 %384, 5
  ...
  %call2_402997 = tail call %struct.Memory* @sub_4014e0._Z9check_sumIdEvT_(%struct.State* nonnull %0, i64 %390, %struct.Memory* %MEMORY.4)
...
block_.L_4029aa:                                  ; preds = %block_.L_4028df
  %427 = add i64 %108, -7050
  %428 = add i64 %108, 5
  ...
  %call2_4029aa = tail call %struct.Memory* @sub_400e20._Z5timerv(%struct.State* nonnull %0, i64 %427, %struct.Memory* %MEMORY.0)
  ...
  %call2_4029b3 = tail call %struct.Memory* @sub_4007c0._Z13record_resultdPKc(%struct.State* nonnull %0, i64 %438, %struct.Memory* %call2_4029aa)
  ...
  ret %struct.Memory* %call2_4029b3
}
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_jge_.L_4029aa(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i8* nocapture %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_jl_.L_402946(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i8* nocapture %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 2, i32 9
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_jmpq_.L_402912(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_jge_.L_402941(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i8* nocapture %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 2, i32 9
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_jmpq_.L_402946(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_jge_.L_402992(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i8* nocapture %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 2, i32 9
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_jmpq_.L_402957(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_je_.L_40298d(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i8* nocapture %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_jmpq_.L_402992(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_jmpq_.L_4028df(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
