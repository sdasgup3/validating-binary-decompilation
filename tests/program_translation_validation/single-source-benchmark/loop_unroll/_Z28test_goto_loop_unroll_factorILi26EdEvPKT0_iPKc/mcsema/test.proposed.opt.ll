...
block_.L_4028af:                                  ; preds = %block_.L_402962, %entry
  %79 = phi i64 [ %.pre, %entry ], [ %431, %block_.L_402962 ]
...
block_.L_402927:                                  ; preds = %block_402958, %block_402922
  %291 = phi i64 [ %290, %block_402922 ], [ %387, %block_402958 ]
  %292 = phi i64 [ %253, %block_402922 ], [ %351, %block_402958 ]
  ...
  %call2_402934 = tail call %struct.Memory* @sub_401480._Z18complete_hash_funcIdET_S0_(%struct.State* %0, i64 %307, %struct.Memory* %MEMORY.3)
  ...
  br i1 %375, label %block_.L_40295d, label %block_402958
...
block_.L_402962:                                  ; preds = %block_.L_402916, %block_.L_40295d
  %389 = phi i64 [ %289, %block_.L_402916 ], [ %388, %block_.L_40295d ]
  %390 = phi i64 [ %253, %block_.L_402916 ], [ %351, %block_.L_40295d ]
  ...
  %call2_402967 = tail call %struct.Memory* @sub_4014b0._Z9check_sumIdEvT_(%struct.State* %0, i64 %395, %struct.Memory* %MEMORY.4)
...
block_.L_40297a:                                  ; preds = %block_.L_4028af
  ...
  %call2_40297a = tail call %struct.Memory* @sub_400df0._Z5timerv(%struct.State* %0, i64 %432, %struct.Memory* %MEMORY.0)
  ...
  %call2_402983 = tail call %struct.Memory* @sub_400790._Z13record_resultdPKc(%struct.State* %0, i64 %443, %struct.Memory* %call2_40297a)
