...
entry:
  ...
  %call2_40d463 = tail call %struct.Memory* @sub_400dd0._Z11start_timerv(%struct.State* %0, i64 %58, %struct.Memory* %2)
...
block_.L_40d46f:                                  ; preds = %block_.L_40d51b, %entry
  %68 = phi i64 [ %.pre, %entry ], [ %449, %block_.L_40d51b ]
  %MEMORY.0 = phi %struct.Memory* [ %call2_40d463, %entry ], [ %call2_40d51e, %block_.L_40d51b ]
  ...
  br i1 %101, label %block_40d47f, label %block_.L_40d531

block_40d47f:                                     ; preds = %block_.L_40d46f
  %103 = add i64 %69, -32
  %104 = add i64 %102, 7
  ...
  br i1 %147, label %block_.L_40d4d5, label %block_40d49c

block_40d49c:                                     ; preds = %block_40d47f
  %149 = add i64 %148, 5
  br label %block_.L_40d4a1

block_.L_40d4a1:                                  ; preds = %block_40d4cb, %block_40d49c
  %150 = phi i64 [ %149, %block_40d49c ], [ %237, %block_40d4cb ]
  %151 = phi i64 [ %111, %block_40d49c ], [ %197, %block_40d4cb ]
  %MEMORY.1 = phi %struct.Memory* [ %MEMORY.0, %block_40d49c ], [ %call2_40d4ac, %block_40d4cb ]
  %152 = add i64 %151, -32
  ...
  %call2_40d4ac = tail call %struct.Memory* @sub_40c390._ZN15loop_inner_bodyILi26EiE7do_workERiPKii(%struct.State* %0, i64 %162, %struct.Memory* %MEMORY.1)
  ...
  br i1 %235, label %block_40d4cb, label %block_.L_40d4d0

block_40d4cb:                                     ; preds = %block_.L_40d4a1
  %237 = add i64 %236, -42
  br label %block_.L_40d4a1

block_.L_40d4d0:                                  ; preds = %block_.L_40d4a1
  %238 = add i64 %236, 5
  store i64 %238, i64* %3, align 8
  br label %block_.L_40d4d5

block_.L_40d4d5:                                  ; preds = %block_.L_40d4d0, %block_40d47f
  %239 = phi i64 [ %148, %block_40d47f ], [ %238, %block_.L_40d4d0 ]
  %240 = phi i64 [ %111, %block_40d47f ], [ %197, %block_.L_40d4d0 ]
  %MEMORY.2 = phi %struct.Memory* [ %MEMORY.0, %block_40d47f ], [ %call2_40d4ac, %block_.L_40d4d0 ]
  %241 = add i64 %240, -36
  %242 = add i64 %239, 3
  ...
  br i1 %275, label %block_40d4e1, label %block_.L_40d51b

block_40d4e1:                                     ; preds = %block_.L_40d4d5
  %277 = add i64 %276, 5
  br label %block_.L_40d4e6

block_.L_40d4e6:                                  ; preds = %block_40d511, %block_40d4e1
  %278 = phi i64 [ %277, %block_40d4e1 ], [ %403, %block_40d511 ]
  %279 = phi i64 [ %240, %block_40d4e1 ], [ %367, %block_40d511 ]
  %MEMORY.3 = phi %struct.Memory* [ %MEMORY.2, %block_40d4e1 ], [ %call2_40d4f1, %block_40d511 ]
  %280 = add i64 %279, -8
  %281 = add i64 %278, 4
  ...
  %call2_40d4f1 = tail call %struct.Memory* @sub_40c0d0._Z18complete_hash_funcIiET_S0_(%struct.State* %0, i64 %295, %struct.Memory* %MEMORY.3)
  ...
  br i1 %391, label %block_.L_40d516, label %block_40d511

block_40d511:                                     ; preds = %block_.L_40d4e6
  %403 = add i64 %402, -43
  br label %block_.L_40d4e6

block_.L_40d516:                                  ; preds = %block_.L_40d4e6
  %404 = add i64 %402, 5
  store i64 %404, i64* %3, align 8
  br label %block_.L_40d51b

block_.L_40d51b:                                  ; preds = %block_.L_40d4d5, %block_.L_40d516
  %405 = phi i64 [ %276, %block_.L_40d4d5 ], [ %404, %block_.L_40d516 ]
  %406 = phi i64 [ %240, %block_.L_40d4d5 ], [ %367, %block_.L_40d516 ]
  %MEMORY.4 = phi %struct.Memory* [ %MEMORY.2, %block_.L_40d4d5 ], [ %call2_40d4f1, %block_.L_40d516 ]
  %407 = add i64 %406, -32
  %408 = add i64 %405, 3
  ...
  %call2_40d51e = tail call %struct.Memory* @sub_40c100._Z9check_sumIiEvT_(%struct.State* %0, i64 %412, %struct.Memory* %MEMORY.4)
...
block_.L_40d531:                                  ; preds = %block_.L_40d46f
  %450 = add i64 %102, -51009
  %451 = add i64 %102, 5
  ...
  %call2_40d531 = tail call %struct.Memory* @sub_400df0._Z5timerv(%struct.State* %0, i64 %450, %struct.Memory* %MEMORY.0)
  ...
  %call2_40d53a = tail call %struct.Memory* @sub_400790._Z13record_resultdPKc(%struct.State* %0, i64 %461, %struct.Memory* %call2_40d531)
  ...
  ret %struct.Memory* %call2_40d53a
}
...
define %struct.Memory* @routine_jge_.L_40d531(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i8* %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
...
define %struct.Memory* @routine_jl_.L_40d4d5(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i8* %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 2, i32 9
...
define %struct.Memory* @routine_jmpq_.L_40d4a1(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
...
define %struct.Memory* @routine_jge_.L_40d4d0(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i8* %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 2, i32 9
...
define %struct.Memory* @routine_jmpq_.L_40d4d5(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
...
define %struct.Memory* @routine_jge_.L_40d51b(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i8* %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 2, i32 9
...
define %struct.Memory* @routine_jmpq_.L_40d4e6(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
...
define %struct.Memory* @routine_je_.L_40d516(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i8* %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
...
define %struct.Memory* @routine_jmpq_.L_40d51b(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
...
define %struct.Memory* @routine_jmpq_.L_40d46f(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
