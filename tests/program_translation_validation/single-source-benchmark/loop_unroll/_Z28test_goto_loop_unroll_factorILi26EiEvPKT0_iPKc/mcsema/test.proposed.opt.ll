...
block_.L_40d46f:                                  ; preds = %block_.L_40d51b, %entry
  %68 = phi i64 [ %.pre, %entry ], [ %447, %block_.L_40d51b ]
...
block_.L_40d4e6:                                  ; preds = %block_40d511, %block_40d4e1
  %278 = phi i64 [ %277, %block_40d4e1 ], [ %402, %block_40d511 ]
  %279 = phi i64 [ %240, %block_40d4e1 ], [ %366, %block_40d511 ]
  ...
  br i1 %390, label %block_.L_40d516, label %block_40d511
...
block_.L_40d51b:                                  ; preds = %block_.L_40d4d5, %block_.L_40d516
  %404 = phi i64 [ %276, %block_.L_40d4d5 ], [ %403, %block_.L_40d516 ]
  %405 = phi i64 [ %240, %block_.L_40d4d5 ], [ %366, %block_.L_40d516 ]
  ...
  %call2_40d51e = tail call %struct.Memory* @sub_40c100._Z9check_sumIiEvT_(%struct.State* %0, i64 %411, %struct.Memory* %MEMORY.4)
...
block_.L_40d531:                                  ; preds = %block_.L_40d46f
  ...
  %call2_40d531 = tail call %struct.Memory* @sub_400df0._Z5timerv(%struct.State* %0, i64 %448, %struct.Memory* %MEMORY.0)
  ...
  %call2_40d53a = tail call %struct.Memory* @sub_400790._Z13record_resultdPKc(%struct.State* %0, i64 %459, %struct.Memory* %call2_40d531)
