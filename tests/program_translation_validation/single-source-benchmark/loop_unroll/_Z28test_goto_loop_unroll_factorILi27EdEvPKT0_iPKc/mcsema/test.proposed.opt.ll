...
entry:
  ...
  %call2_402753 = tail call %struct.Memory* @sub_400dd0._Z11start_timerv(%struct.State* %0, i64 %58, %struct.Memory* %2)
...
block_.L_40275f:                                  ; preds = %block_.L_402812, %entry
  %79 = phi i64 [ %.pre, %entry ], [ %435, %block_.L_402812 ]
  %MEMORY.0 = phi %struct.Memory* [ %call2_402753, %entry ], [ %call2_402817, %block_.L_402812 ]
  ...
  br i1 %112, label %block_40276f, label %block_.L_40282a
...
block_40276f:                                     ; preds = %block_.L_40275f
  ...
  br i1 %160, label %block_.L_4027c6, label %block_40278d
...
block_.L_402792:                                  ; preds = %block_4027bc, %block_40278d
  %163 = phi i64 [ %162, %block_40278d ], [ %250, %block_4027bc ]
  %164 = phi i64 [ %124, %block_40278d ], [ %210, %block_4027bc ]
  %MEMORY.1 = phi %struct.Memory* [ %MEMORY.0, %block_40278d ], [ %call2_40279d, %block_4027bc ]
  %165 = add i64 %164, -40
  ...
  %call2_40279d = tail call %struct.Memory* @sub_401770._ZN15loop_inner_bodyILi27EdE7do_workERdPKdi(%struct.State* %0, i64 %175, %struct.Memory* %MEMORY.1)
  ...
  br i1 %248, label %block_4027bc, label %block_.L_4027c1
...
block_.L_4027c6:                                  ; preds = %block_.L_4027c1, %block_40276f
  %252 = phi i64 [ %161, %block_40276f ], [ %251, %block_.L_4027c1 ]
  %253 = phi i64 [ %124, %block_40276f ], [ %210, %block_.L_4027c1 ]
  %MEMORY.2 = phi %struct.Memory* [ %MEMORY.0, %block_40276f ], [ %call2_40279d, %block_.L_4027c1 ]
  %254 = add i64 %253, -44
  %255 = add i64 %252, 3
  ...
  br i1 %288, label %block_4027d2, label %block_.L_402812
...
block_.L_4027d7:                                  ; preds = %block_402808, %block_4027d2
  %291 = phi i64 [ %290, %block_4027d2 ], [ %389, %block_402808 ]
  %292 = phi i64 [ %253, %block_4027d2 ], [ %353, %block_402808 ]
  %MEMORY.3 = phi %struct.Memory* [ %MEMORY.2, %block_4027d2 ], [ %call2_4027e4, %block_402808 ]
  %293 = add i64 %292, -8
  %294 = add i64 %291, 4
  ...
  %call2_4027e4 = tail call %struct.Memory* @sub_401480._Z18complete_hash_funcIdET_S0_(%struct.State* %0, i64 %308, %struct.Memory* %MEMORY.3)
  ...
  br i1 %377, label %block_.L_40280d, label %block_402808
...
block_.L_402812:                                  ; preds = %block_.L_4027c6, %block_.L_40280d
  %391 = phi i64 [ %289, %block_.L_4027c6 ], [ %390, %block_.L_40280d ]
  %392 = phi i64 [ %253, %block_.L_4027c6 ], [ %353, %block_.L_40280d ]
  %MEMORY.4 = phi %struct.Memory* [ %MEMORY.2, %block_.L_4027c6 ], [ %call2_4027e4, %block_.L_40280d ]
  %393 = add i64 %392, -40
  %394 = add i64 %391, 5
  ...
  %call2_402817 = tail call %struct.Memory* @sub_4014b0._Z9check_sumIdEvT_(%struct.State* %0, i64 %398, %struct.Memory* %MEMORY.4)
...
block_.L_40282a:                                  ; preds = %block_.L_40275f
  ...
  %call2_40282a = tail call %struct.Memory* @sub_400df0._Z5timerv(%struct.State* %0, i64 %436, %struct.Memory* %MEMORY.0)
  ...
  %call2_402833 = tail call %struct.Memory* @sub_400790._Z13record_resultdPKc(%struct.State* %0, i64 %447, %struct.Memory* %call2_40282a)
  ...
  ret %struct.Memory* %call2_402833
}
...
define %struct.Memory* @routine_jge_.L_40282a(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i8* %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
...
define %struct.Memory* @routine_jl_.L_4027c6(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i8* %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 2, i32 9
...
define %struct.Memory* @routine_jmpq_.L_402792(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
...
define %struct.Memory* @routine_jge_.L_4027c1(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i8* %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 2, i32 9
...
define %struct.Memory* @routine_jmpq_.L_4027c6(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
...
define %struct.Memory* @routine_jge_.L_402812(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i8* %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 2, i32 9
...
define %struct.Memory* @routine_jmpq_.L_4027d7(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
...
define %struct.Memory* @routine_je_.L_40280d(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i8* %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
...
define %struct.Memory* @routine_jmpq_.L_402812(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
...
define %struct.Memory* @routine_jmpq_.L_40275f(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
