...
entry:
  ...
  %call2_402793 = tail call %struct.Memory* @sub_400e10._Z11start_timerv(%struct.State* %0, i64 %58, %struct.Memory* %2)
...
block_.L_40279f:                                  ; preds = %block_.L_402852, %entry
  %74 = phi i64 [ %.pre, %entry ], [ %426, %block_.L_402852 ]
  %MEMORY.0 = phi %struct.Memory* [ %call2_402793, %entry ], [ %call2_402857, %block_.L_402852 ]
  ...
  br i1 %107, label %block_4027af, label %block_.L_40286a
...
block_4027af:                                     ; preds = %block_.L_40279f
  ...
  br i1 %154, label %block_.L_402806, label %block_4027cd
...
block_.L_4027d2:                                  ; preds = %block_4027fc, %block_4027cd
  %157 = phi i64 [ %118, %block_4027cd ], [ %203, %block_4027fc ]
  %storemerge = phi i64 [ %156, %block_4027cd ], [ %243, %block_4027fc ]
  %158 = add i64 %157, -40
  ...
  %call2_4027dd = tail call %struct.Memory* @sub_4017b0._ZN15loop_inner_bodyILi27EdE7do_workERdPKdi(%struct.State* nonnull %0, i64 %168, %struct.Memory* %MEMORY.0)
  ...
  br i1 %241, label %block_4027fc, label %block_.L_402801
...
block_.L_402806:                                  ; preds = %block_.L_402801, %block_4027af
  %246 = phi i64 [ %245, %block_.L_402801 ], [ %155, %block_4027af ]
  %247 = phi i64 [ %203, %block_.L_402801 ], [ %118, %block_4027af ]
  %248 = add i64 %247, -44
  %249 = add i64 %246, 3
  ...
  br i1 %282, label %block_402812, label %block_.L_402852
...
block_.L_402817:                                  ; preds = %block_402848, %block_402812
  %285 = phi i64 [ %247, %block_402812 ], [ %345, %block_402848 ]
  %storemerge5 = phi i64 [ %284, %block_402812 ], [ %381, %block_402848 ]
  %286 = add i64 %285, -8
  ...
  %call2_402824 = tail call %struct.Memory* @sub_4014c0._Z18complete_hash_funcIdET_S0_(%struct.State* nonnull %0, i64 %300, %struct.Memory* %MEMORY.0)
  ...
  br i1 %369, label %block_.L_40284d, label %block_402848
...
block_.L_402852:                                  ; preds = %block_.L_402806, %block_.L_40284d
  %384 = phi i64 [ %283, %block_.L_402806 ], [ %383, %block_.L_40284d ]
  %385 = phi i64 [ %247, %block_.L_402806 ], [ %345, %block_.L_40284d ]
  %386 = add i64 %385, -40
  %387 = add i64 %384, 5
  ...
  %call2_402857 = tail call %struct.Memory* @sub_4014f0._Z9check_sumIdEvT_(%struct.State* nonnull %0, i64 %390, %struct.Memory* %MEMORY.0)
...
block_.L_40286a:                                  ; preds = %block_.L_40279f
  ...
  %call2_40286a = tail call %struct.Memory* @sub_400e30._Z5timerv(%struct.State* nonnull %0, i64 %427, %struct.Memory* %MEMORY.0)
  ...
  %call2_402873 = tail call %struct.Memory* @sub_4007d0._Z13record_resultdPKc(%struct.State* nonnull %0, i64 %438, %struct.Memory* %call2_40286a)
