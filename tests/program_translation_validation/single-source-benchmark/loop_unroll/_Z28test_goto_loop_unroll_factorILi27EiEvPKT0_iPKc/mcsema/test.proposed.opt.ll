...
define %struct.Memory* @_Z28test_goto_loop_unroll_factorILi27EiEvPKT0_iPKc(%struct.State* noalias, i64, %struct.Memory* noalias readnone) local_unnamed_addr #1 {
entry:
  ...
  %call2_40d353 = tail call %struct.Memory* @sub_400e10._Z11start_timerv(%struct.State* %0, i64 %58, %struct.Memory* %2)
...
block_.L_40d35f:                                  ; preds = %block_.L_40d40b, %entry
  %68 = phi i64 [ %.pre, %entry ], [ %447, %block_.L_40d40b ]
  %MEMORY.0 = phi %struct.Memory* [ %call2_40d353, %entry ], [ %call2_40d40e, %block_.L_40d40b ]
  ...
  br i1 %101, label %block_40d36f, label %block_.L_40d421
...
block_40d36f:                                     ; preds = %block_.L_40d35f
  ...
  br i1 %147, label %block_.L_40d3c5, label %block_40d38c
...
block_.L_40d391:                                  ; preds = %block_40d3bb, %block_40d38c
  %150 = phi i64 [ %111, %block_40d38c ], [ %196, %block_40d3bb ]
  %storemerge = phi i64 [ %149, %block_40d38c ], [ %236, %block_40d3bb ]
  %151 = add i64 %150, -32
  ...
  %call2_40d39c = tail call %struct.Memory* @sub_40c370._ZN15loop_inner_bodyILi27EiE7do_workERiPKii(%struct.State* nonnull %0, i64 %161, %struct.Memory* %MEMORY.0)
  ...
  br i1 %234, label %block_40d3bb, label %block_.L_40d3c0
...
block_.L_40d3c5:                                  ; preds = %block_.L_40d3c0, %block_40d36f
  %239 = phi i64 [ %238, %block_.L_40d3c0 ], [ %148, %block_40d36f ]
  %240 = phi i64 [ %196, %block_.L_40d3c0 ], [ %111, %block_40d36f ]
  %241 = add i64 %240, -36
  %242 = add i64 %239, 3
  ...
  br i1 %275, label %block_40d3d1, label %block_.L_40d40b
...
block_.L_40d3d6:                                  ; preds = %block_40d401, %block_40d3d1
  %278 = phi i64 [ %240, %block_40d3d1 ], [ %365, %block_40d401 ]
  %storemerge5 = phi i64 [ %277, %block_40d3d1 ], [ %401, %block_40d401 ]
  %279 = add i64 %278, -8
  ...
  %call2_40d3e1 = tail call %struct.Memory* @sub_40c110._Z18complete_hash_funcIiET_S0_(%struct.State* nonnull %0, i64 %294, %struct.Memory* %MEMORY.0)
  ...
  br i1 %389, label %block_.L_40d406, label %block_40d401
...
block_.L_40d40b:                                  ; preds = %block_.L_40d3c5, %block_.L_40d406
  %404 = phi i64 [ %276, %block_.L_40d3c5 ], [ %403, %block_.L_40d406 ]
  %405 = phi i64 [ %240, %block_.L_40d3c5 ], [ %365, %block_.L_40d406 ]
  %406 = add i64 %405, -32
  %407 = add i64 %404, 3
  ...
  %call2_40d40e = tail call %struct.Memory* @sub_40c140._Z9check_sumIiEvT_(%struct.State* nonnull %0, i64 %411, %struct.Memory* %MEMORY.0)
...
block_.L_40d421:                                  ; preds = %block_.L_40d35f
  ...
  %call2_40d421 = tail call %struct.Memory* @sub_400e30._Z5timerv(%struct.State* nonnull %0, i64 %448, %struct.Memory* %MEMORY.0)
  ...
  %call2_40d42a = tail call %struct.Memory* @sub_4007d0._Z13record_resultdPKc(%struct.State* nonnull %0, i64 %459, %struct.Memory* %call2_40d421)
