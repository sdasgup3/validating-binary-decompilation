...
block_.L_40d31f:                                  ; preds = %block_.L_40d3cb, %entry
  %68 = phi i64 [ %.pre, %entry ], [ %449, %block_.L_40d3cb ]
...
block_.L_40d396:                                  ; preds = %block_40d3c1, %block_40d391
  %278 = phi i64 [ %277, %block_40d391 ], [ %403, %block_40d3c1 ]
  %279 = phi i64 [ %240, %block_40d391 ], [ %367, %block_40d3c1 ]
  ...
  br i1 %391, label %block_.L_40d3c6, label %block_40d3c1
...
block_.L_40d3cb:                                  ; preds = %block_.L_40d385, %block_.L_40d3c6
  %405 = phi i64 [ %276, %block_.L_40d385 ], [ %404, %block_.L_40d3c6 ]
  %406 = phi i64 [ %240, %block_.L_40d385 ], [ %367, %block_.L_40d3c6 ]
  ...
  %call2_40d3ce = tail call %struct.Memory* @sub_40c100._Z9check_sumIiEvT_(%struct.State* %0, i64 %412, %struct.Memory* %MEMORY.4)
...
block_.L_40d3e1:                                  ; preds = %block_.L_40d31f
  ...
  %call2_40d3e1 = tail call %struct.Memory* @sub_400df0._Z5timerv(%struct.State* %0, i64 %450, %struct.Memory* %MEMORY.0)
  ...
  %call2_40d3ea = tail call %struct.Memory* @sub_400790._Z13record_resultdPKc(%struct.State* %0, i64 %461, %struct.Memory* %call2_40d3e1)
