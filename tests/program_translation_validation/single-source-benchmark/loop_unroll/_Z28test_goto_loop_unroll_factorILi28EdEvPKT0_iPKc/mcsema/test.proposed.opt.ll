...
block_.L_40260f:                                  ; preds = %block_.L_4026c2, %entry
  %79 = phi i64 [ %.pre, %entry ], [ %431, %block_.L_4026c2 ]
...
block_.L_402687:                                  ; preds = %block_4026b8, %block_402682
  %291 = phi i64 [ %290, %block_402682 ], [ %387, %block_4026b8 ]
  %292 = phi i64 [ %253, %block_402682 ], [ %351, %block_4026b8 ]
  ...
  %call2_402694 = tail call %struct.Memory* @sub_401480._Z18complete_hash_funcIdET_S0_(%struct.State* %0, i64 %307, %struct.Memory* %MEMORY.3)
  ...
  br i1 %375, label %block_.L_4026bd, label %block_4026b8
...
block_.L_4026c2:                                  ; preds = %block_.L_402676, %block_.L_4026bd
  %389 = phi i64 [ %289, %block_.L_402676 ], [ %388, %block_.L_4026bd ]
  %390 = phi i64 [ %253, %block_.L_402676 ], [ %351, %block_.L_4026bd ]
  ...
  %call2_4026c7 = tail call %struct.Memory* @sub_4014b0._Z9check_sumIdEvT_(%struct.State* %0, i64 %395, %struct.Memory* %MEMORY.4)
...
block_.L_4026da:                                  ; preds = %block_.L_40260f
  ...
  %call2_4026da = tail call %struct.Memory* @sub_400df0._Z5timerv(%struct.State* %0, i64 %432, %struct.Memory* %MEMORY.0)
  ...
  %call2_4026e3 = tail call %struct.Memory* @sub_400790._Z13record_resultdPKc(%struct.State* %0, i64 %443, %struct.Memory* %call2_4026da)
