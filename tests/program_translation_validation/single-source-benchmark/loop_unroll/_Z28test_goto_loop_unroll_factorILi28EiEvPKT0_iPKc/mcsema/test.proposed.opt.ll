...
block_.L_40d1cf:                                  ; preds = %block_.L_40d27b, %entry
  %68 = phi i64 [ %.pre, %entry ], [ %449, %block_.L_40d27b ]
...
block_.L_40d246:                                  ; preds = %block_40d271, %block_40d241
  %278 = phi i64 [ %277, %block_40d241 ], [ %403, %block_40d271 ]
  %279 = phi i64 [ %240, %block_40d241 ], [ %367, %block_40d271 ]
  ...
  br i1 %391, label %block_.L_40d276, label %block_40d271
...
block_.L_40d27b:                                  ; preds = %block_.L_40d235, %block_.L_40d276
  %405 = phi i64 [ %276, %block_.L_40d235 ], [ %404, %block_.L_40d276 ]
  %406 = phi i64 [ %240, %block_.L_40d235 ], [ %367, %block_.L_40d276 ]
  ...
  %call2_40d27e = tail call %struct.Memory* @sub_40c100._Z9check_sumIiEvT_(%struct.State* %0, i64 %412, %struct.Memory* %MEMORY.4)
...
block_.L_40d291:                                  ; preds = %block_.L_40d1cf
  ...
  %call2_40d291 = tail call %struct.Memory* @sub_400df0._Z5timerv(%struct.State* %0, i64 %450, %struct.Memory* %MEMORY.0)
  ...
  %call2_40d29a = tail call %struct.Memory* @sub_400790._Z13record_resultdPKc(%struct.State* %0, i64 %461, %struct.Memory* %call2_40d291)
