...
entry:
  ...
  %call2_40d203 = tail call %struct.Memory* @sub_400e10._Z11start_timerv(%struct.State* %0, i64 %58, %struct.Memory* %2)
...
block_.L_40d20f:                                  ; preds = %block_.L_40d2bb, %entry
  %68 = phi i64 [ %.pre, %entry ], [ %447, %block_.L_40d2bb ]
  %MEMORY.0 = phi %struct.Memory* [ %call2_40d203, %entry ], [ %call2_40d2be, %block_.L_40d2bb ]
  ...
  br i1 %101, label %block_40d21f, label %block_.L_40d2d1
...
block_40d21f:                                     ; preds = %block_.L_40d20f
  ...
  br i1 %147, label %block_.L_40d275, label %block_40d23c
...
block_.L_40d241:                                  ; preds = %block_40d26b, %block_40d23c
  %150 = phi i64 [ %111, %block_40d23c ], [ %196, %block_40d26b ]
  %storemerge = phi i64 [ %149, %block_40d23c ], [ %236, %block_40d26b ]
  %151 = add i64 %150, -32
  ...
  %call2_40d24c = tail call %struct.Memory* @sub_40c310._ZN15loop_inner_bodyILi28EiE7do_workERiPKii(%struct.State* nonnull %0, i64 %161, %struct.Memory* %MEMORY.0)
  ...
  br i1 %234, label %block_40d26b, label %block_.L_40d270
...
block_.L_40d275:                                  ; preds = %block_.L_40d270, %block_40d21f
  %239 = phi i64 [ %238, %block_.L_40d270 ], [ %148, %block_40d21f ]
  %240 = phi i64 [ %196, %block_.L_40d270 ], [ %111, %block_40d21f ]
  %241 = add i64 %240, -36
  %242 = add i64 %239, 3
  ...
  br i1 %275, label %block_40d281, label %block_.L_40d2bb
...
block_.L_40d286:                                  ; preds = %block_40d2b1, %block_40d281
  %278 = phi i64 [ %240, %block_40d281 ], [ %365, %block_40d2b1 ]
  %storemerge5 = phi i64 [ %277, %block_40d281 ], [ %401, %block_40d2b1 ]
  %279 = add i64 %278, -8
  ...
  %call2_40d291 = tail call %struct.Memory* @sub_40c110._Z18complete_hash_funcIiET_S0_(%struct.State* nonnull %0, i64 %294, %struct.Memory* %MEMORY.0)
  ...
  br i1 %389, label %block_.L_40d2b6, label %block_40d2b1
...
block_.L_40d2bb:                                  ; preds = %block_.L_40d275, %block_.L_40d2b6
  %404 = phi i64 [ %276, %block_.L_40d275 ], [ %403, %block_.L_40d2b6 ]
  %405 = phi i64 [ %240, %block_.L_40d275 ], [ %365, %block_.L_40d2b6 ]
  %406 = add i64 %405, -32
  %407 = add i64 %404, 3
  ...
  %call2_40d2be = tail call %struct.Memory* @sub_40c140._Z9check_sumIiEvT_(%struct.State* nonnull %0, i64 %411, %struct.Memory* %MEMORY.0)
...
block_.L_40d2d1:                                  ; preds = %block_.L_40d20f
  ...
  %call2_40d2d1 = tail call %struct.Memory* @sub_400e30._Z5timerv(%struct.State* nonnull %0, i64 %448, %struct.Memory* %MEMORY.0)
  ...
  %call2_40d2da = tail call %struct.Memory* @sub_4007d0._Z13record_resultdPKc(%struct.State* nonnull %0, i64 %459, %struct.Memory* %call2_40d2d1)
