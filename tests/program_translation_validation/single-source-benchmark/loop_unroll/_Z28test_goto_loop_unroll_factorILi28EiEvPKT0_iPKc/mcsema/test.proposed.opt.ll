...
declare %struct.Memory* @sub_40c300._ZN15loop_inner_bodyILi28EiE7do_workERiPKii(%struct.State* noalias dereferenceable(3376), i64, %struct.Memory* noalias readnone returned) local_unnamed_addr
...
define %struct.Memory* @_Z28test_goto_loop_unroll_factorILi28EiEvPKT0_iPKc(%struct.State* noalias, i64, %struct.Memory* noalias readnone) local_unnamed_addr #1 {
entry:
...
block_.L_40d231:                                  ; preds = %block_40d25b, %block_40d22c
  ...
  %call2_40d23c = tail call %struct.Memory* @sub_40c300._ZN15loop_inner_bodyILi28EiE7do_workERiPKii(%struct.State* nonnull %0, i64 %161, %struct.Memory* %MEMORY.0)
...
block_.L_40d265:                                  ; preds = %block_.L_40d260, %block_40d20f
  %239 = phi i64 [ %238, %block_.L_40d260 ], [ %148, %block_40d20f ]
  %240 = phi i64 [ %196, %block_.L_40d260 ], [ %111, %block_40d20f ]
  %241 = add i64 %240, -36
  %242 = add i64 %239, 3
...
block_.L_40d276:                                  ; preds = %block_40d2a1, %block_40d271
  ...
  %call2_40d281 = tail call %struct.Memory* @sub_40c100._Z18complete_hash_funcIiET_S0_(%struct.State* nonnull %0, i64 %294, %struct.Memory* %MEMORY.0)
...
block_.L_40d2ab:                                  ; preds = %block_.L_40d265, %block_.L_40d2a6
  ...
  %call2_40d2ae = tail call %struct.Memory* @sub_40c130._Z9check_sumIiEvT_(%struct.State* nonnull %0, i64 %411, %struct.Memory* %MEMORY.0)
