...
declare %struct.Memory* @sub_4016e0._ZN15loop_inner_bodyILi29EdE7do_workERdPKdi(%struct.State* noalias dereferenceable(3376), i64, %struct.Memory* noalias readnone returned) local_unnamed_addr
...
block_.L_402522:                                  ; preds = %block_40254c, %block_40251d
  ...
  %call2_40252d = tail call %struct.Memory* @sub_4016e0._ZN15loop_inner_bodyILi29EdE7do_workERdPKdi(%struct.State* nonnull %0, i64 %168, %struct.Memory* %MEMORY.0)
...
block_.L_402556:                                  ; preds = %block_.L_402551, %block_4024ff
  %246 = phi i64 [ %245, %block_.L_402551 ], [ %155, %block_4024ff ]
  %247 = phi i64 [ %203, %block_.L_402551 ], [ %118, %block_4024ff ]
  %248 = add i64 %247, -44
  %249 = add i64 %246, 3
...
block_.L_402567:                                  ; preds = %block_402598, %block_402562
  ...
  %call2_402574 = tail call %struct.Memory* @sub_4014b0._Z18complete_hash_funcIdET_S0_(%struct.State* nonnull %0, i64 %300, %struct.Memory* %MEMORY.0)
...
block_.L_4025a2:                                  ; preds = %block_.L_402556, %block_.L_40259d
  ...
  %call2_4025a7 = tail call %struct.Memory* @sub_4014e0._Z9check_sumIdEvT_(%struct.State* nonnull %0, i64 %390, %struct.Memory* %MEMORY.0)
