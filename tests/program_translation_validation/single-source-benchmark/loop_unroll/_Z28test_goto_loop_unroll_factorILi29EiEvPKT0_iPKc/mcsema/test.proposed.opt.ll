...
entry:
  ...
  %call2_40d073 = tail call %struct.Memory* @sub_400dd0._Z11start_timerv(%struct.State* %0, i64 %58, %struct.Memory* %2)
...
block_.L_40d07f:                                  ; preds = %block_.L_40d12b, %entry
  %68 = phi i64 [ %.pre, %entry ], [ %447, %block_.L_40d12b ]
  %MEMORY.0 = phi %struct.Memory* [ %call2_40d073, %entry ], [ %call2_40d12e, %block_.L_40d12b ]
  ...
  br i1 %101, label %block_40d08f, label %block_.L_40d141
...
block_40d08f:                                     ; preds = %block_.L_40d07f
  ...
  br i1 %147, label %block_.L_40d0e5, label %block_40d0ac
...
block_.L_40d0b1:                                  ; preds = %block_40d0db, %block_40d0ac
  %150 = phi i64 [ %149, %block_40d0ac ], [ %237, %block_40d0db ]
  %151 = phi i64 [ %111, %block_40d0ac ], [ %197, %block_40d0db ]
  %MEMORY.1 = phi %struct.Memory* [ %MEMORY.0, %block_40d0ac ], [ %call2_40d0bc, %block_40d0db ]
  %152 = add i64 %151, -32
  ...
  %call2_40d0bc = tail call %struct.Memory* @sub_40c270._ZN15loop_inner_bodyILi29EiE7do_workERiPKii(%struct.State* %0, i64 %162, %struct.Memory* %MEMORY.1)
  ...
  br i1 %235, label %block_40d0db, label %block_.L_40d0e0
...
block_.L_40d0e5:                                  ; preds = %block_.L_40d0e0, %block_40d08f
  %239 = phi i64 [ %148, %block_40d08f ], [ %238, %block_.L_40d0e0 ]
  %240 = phi i64 [ %111, %block_40d08f ], [ %197, %block_.L_40d0e0 ]
  %MEMORY.2 = phi %struct.Memory* [ %MEMORY.0, %block_40d08f ], [ %call2_40d0bc, %block_.L_40d0e0 ]
  %241 = add i64 %240, -36
  %242 = add i64 %239, 3
  ...
  br i1 %275, label %block_40d0f1, label %block_.L_40d12b
...
block_.L_40d0f6:                                  ; preds = %block_40d121, %block_40d0f1
  %278 = phi i64 [ %277, %block_40d0f1 ], [ %402, %block_40d121 ]
  %279 = phi i64 [ %240, %block_40d0f1 ], [ %366, %block_40d121 ]
  %MEMORY.3 = phi %struct.Memory* [ %MEMORY.2, %block_40d0f1 ], [ %call2_40d101, %block_40d121 ]
  %280 = add i64 %279, -8
  %281 = add i64 %278, 4
  ...
  %call2_40d101 = tail call %struct.Memory* @sub_40c0d0._Z18complete_hash_funcIiET_S0_(%struct.State* %0, i64 %295, %struct.Memory* %MEMORY.3)
  ...
  br i1 %390, label %block_.L_40d126, label %block_40d121
...
block_.L_40d12b:                                  ; preds = %block_.L_40d0e5, %block_.L_40d126
  %404 = phi i64 [ %276, %block_.L_40d0e5 ], [ %403, %block_.L_40d126 ]
  %405 = phi i64 [ %240, %block_.L_40d0e5 ], [ %366, %block_.L_40d126 ]
  %MEMORY.4 = phi %struct.Memory* [ %MEMORY.2, %block_.L_40d0e5 ], [ %call2_40d101, %block_.L_40d126 ]
  %406 = add i64 %405, -32
  %407 = add i64 %404, 3
  ...
  %call2_40d12e = tail call %struct.Memory* @sub_40c100._Z9check_sumIiEvT_(%struct.State* %0, i64 %411, %struct.Memory* %MEMORY.4)
...
block_.L_40d141:                                  ; preds = %block_.L_40d07f
  ...
  %call2_40d141 = tail call %struct.Memory* @sub_400df0._Z5timerv(%struct.State* %0, i64 %448, %struct.Memory* %MEMORY.0)
  ...
  %call2_40d14a = tail call %struct.Memory* @sub_400790._Z13record_resultdPKc(%struct.State* %0, i64 %459, %struct.Memory* %call2_40d141)
  ...
  ret %struct.Memory* %call2_40d14a
}
...
define %struct.Memory* @routine_jge_.L_40d141(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i8* %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
...
define %struct.Memory* @routine_jl_.L_40d0e5(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i8* %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 2, i32 9
...
define %struct.Memory* @routine_jmpq_.L_40d0b1(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
...
define %struct.Memory* @routine_jge_.L_40d0e0(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i8* %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 2, i32 9
...
define %struct.Memory* @routine_jmpq_.L_40d0e5(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
...
define %struct.Memory* @routine_jge_.L_40d12b(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i8* %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 2, i32 9
...
define %struct.Memory* @routine_jmpq_.L_40d0f6(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
...
define %struct.Memory* @routine_je_.L_40d126(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i8* %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
...
define %struct.Memory* @routine_jmpq_.L_40d12b(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
...
define %struct.Memory* @routine_jmpq_.L_40d07f(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
