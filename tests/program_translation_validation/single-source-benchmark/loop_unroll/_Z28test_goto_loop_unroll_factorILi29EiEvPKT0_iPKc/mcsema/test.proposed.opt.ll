...
entry:
  ...
  %call2_40d0b3 = tail call %struct.Memory* @sub_400e10._Z11start_timerv(%struct.State* %0, i64 %58, %struct.Memory* %2)
...
block_.L_40d0bf:                                  ; preds = %block_.L_40d16b, %entry
  %68 = phi i64 [ %.pre, %entry ], [ %447, %block_.L_40d16b ]
  %MEMORY.0 = phi %struct.Memory* [ %call2_40d0b3, %entry ], [ %call2_40d16e, %block_.L_40d16b ]
  ...
  br i1 %101, label %block_40d0cf, label %block_.L_40d181
...
block_40d0cf:                                     ; preds = %block_.L_40d0bf
  ...
  br i1 %147, label %block_.L_40d125, label %block_40d0ec
...
block_.L_40d0f1:                                  ; preds = %block_40d11b, %block_40d0ec
  %150 = phi i64 [ %111, %block_40d0ec ], [ %196, %block_40d11b ]
  %storemerge = phi i64 [ %149, %block_40d0ec ], [ %236, %block_40d11b ]
  %151 = add i64 %150, -32
  ...
  %call2_40d0fc = tail call %struct.Memory* @sub_40c2b0._ZN15loop_inner_bodyILi29EiE7do_workERiPKii(%struct.State* nonnull %0, i64 %161, %struct.Memory* %MEMORY.0)
  ...
  br i1 %234, label %block_40d11b, label %block_.L_40d120
...
block_.L_40d125:                                  ; preds = %block_.L_40d120, %block_40d0cf
  %239 = phi i64 [ %238, %block_.L_40d120 ], [ %148, %block_40d0cf ]
  %240 = phi i64 [ %196, %block_.L_40d120 ], [ %111, %block_40d0cf ]
  %241 = add i64 %240, -36
  %242 = add i64 %239, 3
  ...
  br i1 %275, label %block_40d131, label %block_.L_40d16b
...
block_.L_40d136:                                  ; preds = %block_40d161, %block_40d131
  %278 = phi i64 [ %240, %block_40d131 ], [ %365, %block_40d161 ]
  %storemerge5 = phi i64 [ %277, %block_40d131 ], [ %401, %block_40d161 ]
  %279 = add i64 %278, -8
  ...
  %call2_40d141 = tail call %struct.Memory* @sub_40c110._Z18complete_hash_funcIiET_S0_(%struct.State* nonnull %0, i64 %294, %struct.Memory* %MEMORY.0)
  ...
  br i1 %389, label %block_.L_40d166, label %block_40d161
...
block_.L_40d16b:                                  ; preds = %block_.L_40d125, %block_.L_40d166
  %404 = phi i64 [ %276, %block_.L_40d125 ], [ %403, %block_.L_40d166 ]
  %405 = phi i64 [ %240, %block_.L_40d125 ], [ %365, %block_.L_40d166 ]
  %406 = add i64 %405, -32
  %407 = add i64 %404, 3
  ...
  %call2_40d16e = tail call %struct.Memory* @sub_40c140._Z9check_sumIiEvT_(%struct.State* nonnull %0, i64 %411, %struct.Memory* %MEMORY.0)
...
block_.L_40d181:                                  ; preds = %block_.L_40d0bf
  ...
  %call2_40d181 = tail call %struct.Memory* @sub_400e30._Z5timerv(%struct.State* nonnull %0, i64 %448, %struct.Memory* %MEMORY.0)
  ...
  %call2_40d18a = tail call %struct.Memory* @sub_4007d0._Z13record_resultdPKc(%struct.State* nonnull %0, i64 %459, %struct.Memory* %call2_40d181)
