...
block_.L_40d07f:                                  ; preds = %block_.L_40d12b, %entry
  %68 = phi i64 [ %.pre, %entry ], [ %449, %block_.L_40d12b ]
...
block_.L_40d0f6:                                  ; preds = %block_40d121, %block_40d0f1
  %278 = phi i64 [ %277, %block_40d0f1 ], [ %403, %block_40d121 ]
  %279 = phi i64 [ %240, %block_40d0f1 ], [ %367, %block_40d121 ]
  ...
  br i1 %391, label %block_.L_40d126, label %block_40d121
...
block_.L_40d12b:                                  ; preds = %block_.L_40d0e5, %block_.L_40d126
  %405 = phi i64 [ %276, %block_.L_40d0e5 ], [ %404, %block_.L_40d126 ]
  %406 = phi i64 [ %240, %block_.L_40d0e5 ], [ %367, %block_.L_40d126 ]
  ...
  %call2_40d12e = tail call %struct.Memory* @sub_40c100._Z9check_sumIiEvT_(%struct.State* %0, i64 %412, %struct.Memory* %MEMORY.4)
...
block_.L_40d141:                                  ; preds = %block_.L_40d07f
  ...
  %call2_40d141 = tail call %struct.Memory* @sub_400df0._Z5timerv(%struct.State* %0, i64 %450, %struct.Memory* %MEMORY.0)
  ...
  %call2_40d14a = tail call %struct.Memory* @sub_400790._Z13record_resultdPKc(%struct.State* %0, i64 %461, %struct.Memory* %call2_40d141)
