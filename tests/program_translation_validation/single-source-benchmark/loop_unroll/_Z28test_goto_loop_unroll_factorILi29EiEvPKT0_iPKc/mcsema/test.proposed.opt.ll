...
define %struct.Memory* @_Z28test_goto_loop_unroll_factorILi29EiEvPKT0_iPKc(%struct.State* noalias, i64, %struct.Memory* noalias readnone) local_unnamed_addr #1 {
entry:
...
block_.L_40d0e1:                                  ; preds = %block_40d10b, %block_40d0dc
  ...
  %call2_40d0ec = tail call %struct.Memory* @sub_40c2a0._ZN15loop_inner_bodyILi29EiE7do_workERiPKii(%struct.State* nonnull %0, i64 %161, %struct.Memory* %MEMORY.0)
...
block_.L_40d115:                                  ; preds = %block_.L_40d110, %block_40d0bf
  %239 = phi i64 [ %238, %block_.L_40d110 ], [ %148, %block_40d0bf ]
  %240 = phi i64 [ %196, %block_.L_40d110 ], [ %111, %block_40d0bf ]
  %241 = add i64 %240, -36
  %242 = add i64 %239, 3
...
block_.L_40d126:                                  ; preds = %block_40d151, %block_40d121
  ...
  %call2_40d131 = tail call %struct.Memory* @sub_40c100._Z18complete_hash_funcIiET_S0_(%struct.State* nonnull %0, i64 %294, %struct.Memory* %MEMORY.0)
...
block_.L_40d15b:                                  ; preds = %block_.L_40d115, %block_.L_40d156
  ...
  %call2_40d15e = tail call %struct.Memory* @sub_40c130._Z9check_sumIiEvT_(%struct.State* nonnull %0, i64 %411, %struct.Memory* %MEMORY.0)
