...
entry:
  ...
  %call2_404813 = tail call %struct.Memory* @sub_400dd0._Z11start_timerv(%struct.State* %0, i64 %58, %struct.Memory* %2)
...
block_.L_40481f:                                  ; preds = %block_.L_4048d2, %entry
  %79 = phi i64 [ %.pre, %entry ], [ %429, %block_.L_4048d2 ]
  %MEMORY.0 = phi %struct.Memory* [ %call2_404813, %entry ], [ %call2_4048d7, %block_.L_4048d2 ]
  ...
  br i1 %112, label %block_40482f, label %block_.L_4048ea
...
block_40482f:                                     ; preds = %block_.L_40481f
  ...
  br i1 %159, label %block_.L_404886, label %block_40484d

block_40484d:                                     ; preds = %block_40482f
  %161 = add i64 %160, 5
  br label %block_.L_404852

block_.L_404852:                                  ; preds = %block_40487c, %block_40484d
  %162 = phi i64 [ %161, %block_40484d ], [ %248, %block_40487c ]
  %163 = phi i64 [ %124, %block_40484d ], [ %208, %block_40487c ]
  %MEMORY.1 = phi %struct.Memory* [ %MEMORY.0, %block_40484d ], [ %call2_40485d, %block_40487c ]
  %164 = add i64 %163, -40
  ...
  %call2_40485d = tail call %struct.Memory* @sub_4020d0._ZN15loop_inner_bodyILi2EdE7do_workERdPKdi(%struct.State* %0, i64 %174, %struct.Memory* %MEMORY.1)
  ...
  br i1 %246, label %block_40487c, label %block_.L_404881

block_40487c:                                     ; preds = %block_.L_404852
  %248 = add i64 %247, -42
  br label %block_.L_404852

block_.L_404881:                                  ; preds = %block_.L_404852
  %249 = add i64 %247, 5
  store i64 %249, i64* %3, align 8
  br label %block_.L_404886

block_.L_404886:                                  ; preds = %block_.L_404881, %block_40482f
  %250 = phi i64 [ %160, %block_40482f ], [ %249, %block_.L_404881 ]
  %251 = phi i64 [ %124, %block_40482f ], [ %208, %block_.L_404881 ]
  %MEMORY.2 = phi %struct.Memory* [ %MEMORY.0, %block_40482f ], [ %call2_40485d, %block_.L_404881 ]
  %252 = add i64 %251, -44
  %253 = add i64 %250, 3
  ...
  br i1 %286, label %block_404892, label %block_.L_4048d2

block_404892:                                     ; preds = %block_.L_404886
  %288 = add i64 %287, 5
  br label %block_.L_404897

block_.L_404897:                                  ; preds = %block_4048c8, %block_404892
  %289 = phi i64 [ %288, %block_404892 ], [ %385, %block_4048c8 ]
  %290 = phi i64 [ %251, %block_404892 ], [ %349, %block_4048c8 ]
  %MEMORY.3 = phi %struct.Memory* [ %MEMORY.2, %block_404892 ], [ %call2_4048a4, %block_4048c8 ]
  %291 = add i64 %290, -8
  %292 = add i64 %289, 4
  ...
  %call2_4048a4 = tail call %struct.Memory* @sub_401480._Z18complete_hash_funcIdET_S0_(%struct.State* %0, i64 %305, %struct.Memory* %MEMORY.3)
  ...
  br i1 %373, label %block_.L_4048cd, label %block_4048c8

block_4048c8:                                     ; preds = %block_.L_404897
  %385 = add i64 %384, -49
  br label %block_.L_404897

block_.L_4048cd:                                  ; preds = %block_.L_404897
  %386 = add i64 %384, 5
  store i64 %386, i64* %3, align 8
  br label %block_.L_4048d2

block_.L_4048d2:                                  ; preds = %block_.L_404886, %block_.L_4048cd
  %387 = phi i64 [ %287, %block_.L_404886 ], [ %386, %block_.L_4048cd ]
  %388 = phi i64 [ %251, %block_.L_404886 ], [ %349, %block_.L_4048cd ]
  %MEMORY.4 = phi %struct.Memory* [ %MEMORY.2, %block_.L_404886 ], [ %call2_4048a4, %block_.L_4048cd ]
  %389 = add i64 %388, -40
  %390 = add i64 %387, 5
  ...
  %call2_4048d7 = tail call %struct.Memory* @sub_4014b0._Z9check_sumIdEvT_(%struct.State* %0, i64 %393, %struct.Memory* %MEMORY.4)
...
block_.L_4048ea:                                  ; preds = %block_.L_40481f
  %430 = add i64 %113, -15098
  %431 = add i64 %113, 5
  ...
  %call2_4048ea = tail call %struct.Memory* @sub_400df0._Z5timerv(%struct.State* %0, i64 %430, %struct.Memory* %MEMORY.0)
  ...
  %call2_4048f3 = tail call %struct.Memory* @sub_400790._Z13record_resultdPKc(%struct.State* %0, i64 %441, %struct.Memory* %call2_4048ea)
  ...
  ret %struct.Memory* %call2_4048f3
}
...
define %struct.Memory* @routine_jge_.L_4048ea(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i8* %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
...
define %struct.Memory* @routine_jl_.L_404886(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i8* %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 2, i32 9
...
define %struct.Memory* @routine_jmpq_.L_404852(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
...
define %struct.Memory* @routine_jge_.L_404881(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i8* %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 2, i32 9
...
define %struct.Memory* @routine_jmpq_.L_404886(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
...
define %struct.Memory* @routine_jge_.L_4048d2(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i8* %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 2, i32 9
...
define %struct.Memory* @routine_jmpq_.L_404897(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
...
define %struct.Memory* @routine_je_.L_4048cd(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i8* %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
...
define %struct.Memory* @routine_jmpq_.L_4048d2(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
...
define %struct.Memory* @routine_jmpq_.L_40481f(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
