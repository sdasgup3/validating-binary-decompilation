...
entry:
  ...
  %call2_404853 = tail call %struct.Memory* @sub_400e10._Z11start_timerv(%struct.State* %0, i64 %58, %struct.Memory* %2)
...
block_.L_40485f:                                  ; preds = %block_.L_404912, %entry
  %74 = phi i64 [ %.pre, %entry ], [ %424, %block_.L_404912 ]
  %MEMORY.0 = phi %struct.Memory* [ %call2_404853, %entry ], [ %call2_404917, %block_.L_404912 ]
  ...
  br i1 %107, label %block_40486f, label %block_.L_40492a

block_40486f:                                     ; preds = %block_.L_40485f
  ...
  br i1 %153, label %block_.L_4048c6, label %block_40488d

block_40488d:                                     ; preds = %block_40486f
  %155 = add i64 %154, 5
  br label %block_.L_404892

block_.L_404892:                                  ; preds = %block_4048bc, %block_40488d
  %156 = phi i64 [ %118, %block_40488d ], [ %201, %block_4048bc ]
  %storemerge = phi i64 [ %155, %block_40488d ], [ %241, %block_4048bc ]
  %157 = add i64 %156, -40
  ...
  %call2_40489d = tail call %struct.Memory* @sub_402110._ZN15loop_inner_bodyILi2EdE7do_workERdPKdi(%struct.State* nonnull %0, i64 %167, %struct.Memory* %MEMORY.0)
  ...
  br i1 %239, label %block_4048bc, label %block_.L_4048c1

block_4048bc:                                     ; preds = %block_.L_404892
  %241 = add i64 %240, -42
  %242 = add i64 %240, 5
  store i64 %242, i64* %3, align 8
  br label %block_.L_404892

block_.L_4048c1:                                  ; preds = %block_.L_404892
  %243 = add i64 %240, 5
  store i64 %243, i64* %3, align 8
  br label %block_.L_4048c6

block_.L_4048c6:                                  ; preds = %block_.L_4048c1, %block_40486f
  %244 = phi i64 [ %243, %block_.L_4048c1 ], [ %154, %block_40486f ]
  %245 = phi i64 [ %201, %block_.L_4048c1 ], [ %118, %block_40486f ]
  %246 = add i64 %245, -44
  %247 = add i64 %244, 3
  ...
  br i1 %280, label %block_4048d2, label %block_.L_404912

block_4048d2:                                     ; preds = %block_.L_4048c6
  %282 = add i64 %281, 5
  br label %block_.L_4048d7

block_.L_4048d7:                                  ; preds = %block_404908, %block_4048d2
  %283 = phi i64 [ %245, %block_4048d2 ], [ %343, %block_404908 ]
  %storemerge5 = phi i64 [ %282, %block_4048d2 ], [ %379, %block_404908 ]
  %284 = add i64 %283, -8
  ...
  %call2_4048e4 = tail call %struct.Memory* @sub_4014c0._Z18complete_hash_funcIdET_S0_(%struct.State* nonnull %0, i64 %298, %struct.Memory* %MEMORY.0)
  ...
  br i1 %367, label %block_.L_40490d, label %block_404908

block_404908:                                     ; preds = %block_.L_4048d7
  %379 = add i64 %378, -49
  %380 = add i64 %378, 5
  store i64 %380, i64* %3, align 8
  br label %block_.L_4048d7

block_.L_40490d:                                  ; preds = %block_.L_4048d7
  %381 = add i64 %378, 5
  store i64 %381, i64* %3, align 8
  br label %block_.L_404912

block_.L_404912:                                  ; preds = %block_.L_4048c6, %block_.L_40490d
  %382 = phi i64 [ %281, %block_.L_4048c6 ], [ %381, %block_.L_40490d ]
  %383 = phi i64 [ %245, %block_.L_4048c6 ], [ %343, %block_.L_40490d ]
  %384 = add i64 %383, -40
  %385 = add i64 %382, 5
  ...
  %call2_404917 = tail call %struct.Memory* @sub_4014f0._Z9check_sumIdEvT_(%struct.State* nonnull %0, i64 %388, %struct.Memory* %MEMORY.0)
...
block_.L_40492a:                                  ; preds = %block_.L_40485f
  ...
  %call2_40492a = tail call %struct.Memory* @sub_400e30._Z5timerv(%struct.State* nonnull %0, i64 %425, %struct.Memory* %MEMORY.0)
  ...
  %call2_404933 = tail call %struct.Memory* @sub_4007d0._Z13record_resultdPKc(%struct.State* nonnull %0, i64 %436, %struct.Memory* %call2_40492a)
