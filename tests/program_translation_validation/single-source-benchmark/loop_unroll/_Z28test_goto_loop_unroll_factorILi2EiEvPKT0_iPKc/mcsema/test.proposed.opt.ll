...
entry:
  ...
  %call2_40f3d3 = tail call %struct.Memory* @sub_400dd0._Z11start_timerv(%struct.State* %0, i64 %58, %struct.Memory* %2)
...
block_.L_40f3df:                                  ; preds = %block_.L_40f48b, %entry
  %68 = phi i64 [ %.pre, %entry ], [ %447, %block_.L_40f48b ]
  %MEMORY.0 = phi %struct.Memory* [ %call2_40f3d3, %entry ], [ %call2_40f48e, %block_.L_40f48b ]
  ...
  br i1 %101, label %block_40f3ef, label %block_.L_40f4a1
...
block_40f3ef:                                     ; preds = %block_.L_40f3df
  ...
  br i1 %146, label %block_.L_40f445, label %block_40f40c
...
block_.L_40f411:                                  ; preds = %block_40f43b, %block_40f40c
  %149 = phi i64 [ %148, %block_40f40c ], [ %235, %block_40f43b ]
  %150 = phi i64 [ %111, %block_40f40c ], [ %195, %block_40f43b ]
  %MEMORY.1 = phi %struct.Memory* [ %MEMORY.0, %block_40f40c ], [ %call2_40f41c, %block_40f43b ]
  %151 = add i64 %150, -32
  ...
  %call2_40f41c = tail call %struct.Memory* @sub_40cc90._ZN15loop_inner_bodyILi2EiE7do_workERiPKii(%struct.State* %0, i64 %161, %struct.Memory* %MEMORY.1)
  ...
  br i1 %233, label %block_40f43b, label %block_.L_40f440
...
block_.L_40f445:                                  ; preds = %block_.L_40f440, %block_40f3ef
  %237 = phi i64 [ %147, %block_40f3ef ], [ %236, %block_.L_40f440 ]
  %238 = phi i64 [ %111, %block_40f3ef ], [ %195, %block_.L_40f440 ]
  %MEMORY.2 = phi %struct.Memory* [ %MEMORY.0, %block_40f3ef ], [ %call2_40f41c, %block_.L_40f440 ]
  %239 = add i64 %238, -36
  %240 = add i64 %237, 3
  ...
  br i1 %273, label %block_40f451, label %block_.L_40f48b
...
block_.L_40f456:                                  ; preds = %block_40f481, %block_40f451
  %276 = phi i64 [ %275, %block_40f451 ], [ %401, %block_40f481 ]
  %277 = phi i64 [ %238, %block_40f451 ], [ %365, %block_40f481 ]
  %MEMORY.3 = phi %struct.Memory* [ %MEMORY.2, %block_40f451 ], [ %call2_40f461, %block_40f481 ]
  %278 = add i64 %277, -8
  %279 = add i64 %276, 4
  ...
  %call2_40f461 = tail call %struct.Memory* @sub_40c0d0._Z18complete_hash_funcIiET_S0_(%struct.State* %0, i64 %293, %struct.Memory* %MEMORY.3)
  ...
  br i1 %389, label %block_.L_40f486, label %block_40f481
...
block_.L_40f48b:                                  ; preds = %block_.L_40f445, %block_.L_40f486
  %403 = phi i64 [ %274, %block_.L_40f445 ], [ %402, %block_.L_40f486 ]
  %404 = phi i64 [ %238, %block_.L_40f445 ], [ %365, %block_.L_40f486 ]
  %MEMORY.4 = phi %struct.Memory* [ %MEMORY.2, %block_.L_40f445 ], [ %call2_40f461, %block_.L_40f486 ]
  %405 = add i64 %404, -32
  %406 = add i64 %403, 3
  ...
  %call2_40f48e = tail call %struct.Memory* @sub_40c100._Z9check_sumIiEvT_(%struct.State* %0, i64 %410, %struct.Memory* %MEMORY.4)
...
block_.L_40f4a1:                                  ; preds = %block_.L_40f3df
  ...
  %call2_40f4a1 = tail call %struct.Memory* @sub_400df0._Z5timerv(%struct.State* %0, i64 %448, %struct.Memory* %MEMORY.0)
  ...
  %call2_40f4aa = tail call %struct.Memory* @sub_400790._Z13record_resultdPKc(%struct.State* %0, i64 %459, %struct.Memory* %call2_40f4a1)
  ...
  ret %struct.Memory* %call2_40f4aa
}
...
define %struct.Memory* @routine_jge_.L_40f4a1(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i8* %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
...
define %struct.Memory* @routine_jl_.L_40f445(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i8* %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 2, i32 9
...
define %struct.Memory* @routine_jmpq_.L_40f411(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
...
define %struct.Memory* @routine_jge_.L_40f440(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i8* %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 2, i32 9
...
define %struct.Memory* @routine_jmpq_.L_40f445(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
...
define %struct.Memory* @routine_jge_.L_40f48b(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i8* %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 2, i32 9
...
define %struct.Memory* @routine_jmpq_.L_40f456(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
...
define %struct.Memory* @routine_je_.L_40f486(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i8* %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
...
define %struct.Memory* @routine_jmpq_.L_40f48b(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
...
define %struct.Memory* @routine_jmpq_.L_40f3df(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
