...
block_.L_40f441:                                  ; preds = %block_40f46b, %block_40f43c
  ...
  %call2_40f44c = tail call %struct.Memory* @sub_40ccc0._ZN15loop_inner_bodyILi2EiE7do_workERiPKii(%struct.State* nonnull %0, i64 %160, %struct.Memory* %MEMORY.0)
...
block_.L_40f475:                                  ; preds = %block_.L_40f470, %block_40f41f
  %237 = phi i64 [ %236, %block_.L_40f470 ], [ %147, %block_40f41f ]
  %238 = phi i64 [ %194, %block_.L_40f470 ], [ %111, %block_40f41f ]
  %239 = add i64 %238, -36
  %240 = add i64 %237, 3
...
block_.L_40f486:                                  ; preds = %block_40f4b1, %block_40f481
  ...
  %call2_40f491 = tail call %struct.Memory* @sub_40c100._Z18complete_hash_funcIiET_S0_(%struct.State* nonnull %0, i64 %292, %struct.Memory* %MEMORY.0)
...
block_.L_40f4bb:                                  ; preds = %block_.L_40f475, %block_.L_40f4b6
  ...
  %call2_40f4be = tail call %struct.Memory* @sub_40c130._Z9check_sumIiEvT_(%struct.State* nonnull %0, i64 %409, %struct.Memory* %MEMORY.0)
