...
block_.L_40f3df:                                  ; preds = %block_.L_40f48b, %entry
  %68 = phi i64 [ %.pre, %entry ], [ %445, %block_.L_40f48b ]
...
block_.L_40f456:                                  ; preds = %block_40f481, %block_40f451
  %276 = phi i64 [ %275, %block_40f451 ], [ %400, %block_40f481 ]
  %277 = phi i64 [ %238, %block_40f451 ], [ %364, %block_40f481 ]
  ...
  br i1 %388, label %block_.L_40f486, label %block_40f481
...
block_.L_40f48b:                                  ; preds = %block_.L_40f445, %block_.L_40f486
  %402 = phi i64 [ %274, %block_.L_40f445 ], [ %401, %block_.L_40f486 ]
  %403 = phi i64 [ %238, %block_.L_40f445 ], [ %364, %block_.L_40f486 ]
  ...
  %call2_40f48e = tail call %struct.Memory* @sub_40c100._Z9check_sumIiEvT_(%struct.State* %0, i64 %409, %struct.Memory* %MEMORY.4)
...
block_.L_40f4a1:                                  ; preds = %block_.L_40f3df
  ...
  %call2_40f4a1 = tail call %struct.Memory* @sub_400df0._Z5timerv(%struct.State* %0, i64 %446, %struct.Memory* %MEMORY.0)
  ...
  %call2_40f4aa = tail call %struct.Memory* @sub_400790._Z13record_resultdPKc(%struct.State* %0, i64 %457, %struct.Memory* %call2_40f4a1)
