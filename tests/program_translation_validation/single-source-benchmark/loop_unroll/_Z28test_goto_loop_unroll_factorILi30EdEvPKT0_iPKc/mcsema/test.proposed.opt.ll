...
entry:
  ...
  %call2_4023a3 = tail call %struct.Memory* @sub_400e10._Z11start_timerv(%struct.State* %0, i64 %58, %struct.Memory* %2)
...
block_.L_4023af:                                  ; preds = %block_.L_402462, %entry
  %74 = phi i64 [ %.pre, %entry ], [ %426, %block_.L_402462 ]
  %MEMORY.0 = phi %struct.Memory* [ %call2_4023a3, %entry ], [ %call2_402467, %block_.L_402462 ]
  ...
  br i1 %107, label %block_4023bf, label %block_.L_40247a

block_4023bf:                                     ; preds = %block_.L_4023af
  ...
  br i1 %154, label %block_.L_402416, label %block_4023dd

block_4023dd:                                     ; preds = %block_4023bf
  %156 = add i64 %155, 5
  br label %block_.L_4023e2

block_.L_4023e2:                                  ; preds = %block_40240c, %block_4023dd
  %157 = phi i64 [ %118, %block_4023dd ], [ %203, %block_40240c ]
  %storemerge = phi i64 [ %156, %block_4023dd ], [ %243, %block_40240c ]
  %158 = add i64 %157, -40
  ...
  %call2_4023ed = tail call %struct.Memory* @sub_401690._ZN15loop_inner_bodyILi30EdE7do_workERdPKdi(%struct.State* nonnull %0, i64 %168, %struct.Memory* %MEMORY.0)
  ...
  br i1 %241, label %block_40240c, label %block_.L_402411

block_40240c:                                     ; preds = %block_.L_4023e2
  %243 = add i64 %242, -42
  %244 = add i64 %242, 5
  store i64 %244, i64* %3, align 8
  br label %block_.L_4023e2

block_.L_402411:                                  ; preds = %block_.L_4023e2
  %245 = add i64 %242, 5
  store i64 %245, i64* %3, align 8
  br label %block_.L_402416

block_.L_402416:                                  ; preds = %block_.L_402411, %block_4023bf
  %246 = phi i64 [ %245, %block_.L_402411 ], [ %155, %block_4023bf ]
  %247 = phi i64 [ %203, %block_.L_402411 ], [ %118, %block_4023bf ]
  %248 = add i64 %247, -44
  %249 = add i64 %246, 3
  ...
  br i1 %282, label %block_402422, label %block_.L_402462

block_402422:                                     ; preds = %block_.L_402416
  %284 = add i64 %283, 5
  br label %block_.L_402427

block_.L_402427:                                  ; preds = %block_402458, %block_402422
  %285 = phi i64 [ %247, %block_402422 ], [ %345, %block_402458 ]
  %storemerge5 = phi i64 [ %284, %block_402422 ], [ %381, %block_402458 ]
  %286 = add i64 %285, -8
  ...
  %call2_402434 = tail call %struct.Memory* @sub_4014c0._Z18complete_hash_funcIdET_S0_(%struct.State* nonnull %0, i64 %300, %struct.Memory* %MEMORY.0)
  ...
  br i1 %369, label %block_.L_40245d, label %block_402458

block_402458:                                     ; preds = %block_.L_402427
  %381 = add i64 %380, -49
  %382 = add i64 %380, 5
  store i64 %382, i64* %3, align 8
  br label %block_.L_402427

block_.L_40245d:                                  ; preds = %block_.L_402427
  %383 = add i64 %380, 5
  store i64 %383, i64* %3, align 8
  br label %block_.L_402462

block_.L_402462:                                  ; preds = %block_.L_402416, %block_.L_40245d
  %384 = phi i64 [ %283, %block_.L_402416 ], [ %383, %block_.L_40245d ]
  %385 = phi i64 [ %247, %block_.L_402416 ], [ %345, %block_.L_40245d ]
  %386 = add i64 %385, -40
  %387 = add i64 %384, 5
  ...
  %call2_402467 = tail call %struct.Memory* @sub_4014f0._Z9check_sumIdEvT_(%struct.State* nonnull %0, i64 %390, %struct.Memory* %MEMORY.0)
...
block_.L_40247a:                                  ; preds = %block_.L_4023af
  ...
  %call2_40247a = tail call %struct.Memory* @sub_400e30._Z5timerv(%struct.State* nonnull %0, i64 %427, %struct.Memory* %MEMORY.0)
  ...
  %call2_402483 = tail call %struct.Memory* @sub_4007d0._Z13record_resultdPKc(%struct.State* nonnull %0, i64 %438, %struct.Memory* %call2_40247a)
