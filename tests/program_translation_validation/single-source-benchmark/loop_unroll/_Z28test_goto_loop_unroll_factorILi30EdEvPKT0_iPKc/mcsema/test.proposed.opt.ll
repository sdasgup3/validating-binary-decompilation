...
entry:
  ...
  %call2_402363 = tail call %struct.Memory* @sub_400dd0._Z11start_timerv(%struct.State* %0, i64 %58, %struct.Memory* %2)
...
block_.L_40236f:                                  ; preds = %block_.L_402422, %entry
  %79 = phi i64 [ %.pre, %entry ], [ %431, %block_.L_402422 ]
  %MEMORY.0 = phi %struct.Memory* [ %call2_402363, %entry ], [ %call2_402427, %block_.L_402422 ]
  ...
  br i1 %112, label %block_40237f, label %block_.L_40243a

block_40237f:                                     ; preds = %block_.L_40236f
  ...
  br i1 %160, label %block_.L_4023d6, label %block_40239d

block_40239d:                                     ; preds = %block_40237f
  %162 = add i64 %161, 5
  br label %block_.L_4023a2

block_.L_4023a2:                                  ; preds = %block_4023cc, %block_40239d
  %163 = phi i64 [ %162, %block_40239d ], [ %250, %block_4023cc ]
  %164 = phi i64 [ %124, %block_40239d ], [ %210, %block_4023cc ]
  %MEMORY.1 = phi %struct.Memory* [ %MEMORY.0, %block_40239d ], [ %call2_4023ad, %block_4023cc ]
  %165 = add i64 %164, -40
  ...
  %call2_4023ad = tail call %struct.Memory* @sub_401650._ZN15loop_inner_bodyILi30EdE7do_workERdPKdi(%struct.State* %0, i64 %175, %struct.Memory* %MEMORY.1)
  ...
  br i1 %248, label %block_4023cc, label %block_.L_4023d1

block_4023cc:                                     ; preds = %block_.L_4023a2
  %250 = add i64 %249, -42
  br label %block_.L_4023a2

block_.L_4023d1:                                  ; preds = %block_.L_4023a2
  %251 = add i64 %249, 5
  store i64 %251, i64* %3, align 8
  br label %block_.L_4023d6

block_.L_4023d6:                                  ; preds = %block_.L_4023d1, %block_40237f
  %252 = phi i64 [ %161, %block_40237f ], [ %251, %block_.L_4023d1 ]
  %253 = phi i64 [ %124, %block_40237f ], [ %210, %block_.L_4023d1 ]
  %MEMORY.2 = phi %struct.Memory* [ %MEMORY.0, %block_40237f ], [ %call2_4023ad, %block_.L_4023d1 ]
  %254 = add i64 %253, -44
  %255 = add i64 %252, 3
  ...
  br i1 %288, label %block_4023e2, label %block_.L_402422

block_4023e2:                                     ; preds = %block_.L_4023d6
  %290 = add i64 %289, 5
  br label %block_.L_4023e7

block_.L_4023e7:                                  ; preds = %block_402418, %block_4023e2
  %291 = phi i64 [ %290, %block_4023e2 ], [ %387, %block_402418 ]
  %292 = phi i64 [ %253, %block_4023e2 ], [ %351, %block_402418 ]
  %MEMORY.3 = phi %struct.Memory* [ %MEMORY.2, %block_4023e2 ], [ %call2_4023f4, %block_402418 ]
  %293 = add i64 %292, -8
  %294 = add i64 %291, 4
  ...
  %call2_4023f4 = tail call %struct.Memory* @sub_401480._Z18complete_hash_funcIdET_S0_(%struct.State* %0, i64 %307, %struct.Memory* %MEMORY.3)
  ...
  br i1 %375, label %block_.L_40241d, label %block_402418

block_402418:                                     ; preds = %block_.L_4023e7
  %387 = add i64 %386, -49
  br label %block_.L_4023e7

block_.L_40241d:                                  ; preds = %block_.L_4023e7
  %388 = add i64 %386, 5
  store i64 %388, i64* %3, align 8
  br label %block_.L_402422

block_.L_402422:                                  ; preds = %block_.L_4023d6, %block_.L_40241d
  %389 = phi i64 [ %289, %block_.L_4023d6 ], [ %388, %block_.L_40241d ]
  %390 = phi i64 [ %253, %block_.L_4023d6 ], [ %351, %block_.L_40241d ]
  %MEMORY.4 = phi %struct.Memory* [ %MEMORY.2, %block_.L_4023d6 ], [ %call2_4023f4, %block_.L_40241d ]
  %391 = add i64 %390, -40
  %392 = add i64 %389, 5
  ...
  %call2_402427 = tail call %struct.Memory* @sub_4014b0._Z9check_sumIdEvT_(%struct.State* %0, i64 %395, %struct.Memory* %MEMORY.4)
...
block_.L_40243a:                                  ; preds = %block_.L_40236f
  %432 = add i64 %113, -5706
  %433 = add i64 %113, 5
  ...
  %call2_40243a = tail call %struct.Memory* @sub_400df0._Z5timerv(%struct.State* %0, i64 %432, %struct.Memory* %MEMORY.0)
  ...
  %call2_402443 = tail call %struct.Memory* @sub_400790._Z13record_resultdPKc(%struct.State* %0, i64 %443, %struct.Memory* %call2_40243a)
  ...
  ret %struct.Memory* %call2_402443
}
...
define %struct.Memory* @routine_jge_.L_40243a(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i8* %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
...
define %struct.Memory* @routine_jl_.L_4023d6(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i8* %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 2, i32 9
...
define %struct.Memory* @routine_jmpq_.L_4023a2(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
...
define %struct.Memory* @routine_jmpq_.L_4023d6(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
...
define %struct.Memory* @routine_jge_.L_402422(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i8* %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 2, i32 9
...
define %struct.Memory* @routine_jmpq_.L_4023e7(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
...
define %struct.Memory* @routine_je_.L_40241d(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i8* %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
...
define %struct.Memory* @routine_jmpq_.L_402422(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
...
define %struct.Memory* @routine_jmpq_.L_40236f(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
