...
entry:
  ...
  %call2_40cf23 = tail call %struct.Memory* @sub_400dd0._Z11start_timerv(%struct.State* %0, i64 %58, %struct.Memory* %2)
...
block_.L_40cf2f:                                  ; preds = %block_.L_40cfdb, %entry
  %68 = phi i64 [ %.pre, %entry ], [ %447, %block_.L_40cfdb ]
  %MEMORY.0 = phi %struct.Memory* [ %call2_40cf23, %entry ], [ %call2_40cfde, %block_.L_40cfdb ]
  ...
  br i1 %101, label %block_40cf3f, label %block_.L_40cff1

block_40cf3f:                                     ; preds = %block_.L_40cf2f
  %103 = add i64 %69, -32
  %104 = add i64 %102, 7
  ...
  br i1 %147, label %block_.L_40cf95, label %block_40cf5c

block_40cf5c:                                     ; preds = %block_40cf3f
  %149 = add i64 %148, 5
  br label %block_.L_40cf61

block_.L_40cf61:                                  ; preds = %block_40cf8b, %block_40cf5c
  %150 = phi i64 [ %149, %block_40cf5c ], [ %237, %block_40cf8b ]
  %151 = phi i64 [ %111, %block_40cf5c ], [ %197, %block_40cf8b ]
  %MEMORY.1 = phi %struct.Memory* [ %MEMORY.0, %block_40cf5c ], [ %call2_40cf6c, %block_40cf8b ]
  %152 = add i64 %151, -32
  ...
  %call2_40cf6c = tail call %struct.Memory* @sub_40c210._ZN15loop_inner_bodyILi30EiE7do_workERiPKii(%struct.State* %0, i64 %162, %struct.Memory* %MEMORY.1)
  ...
  br i1 %235, label %block_40cf8b, label %block_.L_40cf90

block_40cf8b:                                     ; preds = %block_.L_40cf61
  %237 = add i64 %236, -42
  br label %block_.L_40cf61

block_.L_40cf90:                                  ; preds = %block_.L_40cf61
  %238 = add i64 %236, 5
  store i64 %238, i64* %3, align 8
  br label %block_.L_40cf95

block_.L_40cf95:                                  ; preds = %block_.L_40cf90, %block_40cf3f
  %239 = phi i64 [ %148, %block_40cf3f ], [ %238, %block_.L_40cf90 ]
  %240 = phi i64 [ %111, %block_40cf3f ], [ %197, %block_.L_40cf90 ]
  %MEMORY.2 = phi %struct.Memory* [ %MEMORY.0, %block_40cf3f ], [ %call2_40cf6c, %block_.L_40cf90 ]
  %241 = add i64 %240, -36
  %242 = add i64 %239, 3
  ...
  br i1 %275, label %block_40cfa1, label %block_.L_40cfdb

block_40cfa1:                                     ; preds = %block_.L_40cf95
  %277 = add i64 %276, 5
  br label %block_.L_40cfa6

block_.L_40cfa6:                                  ; preds = %block_40cfd1, %block_40cfa1
  %278 = phi i64 [ %277, %block_40cfa1 ], [ %402, %block_40cfd1 ]
  %279 = phi i64 [ %240, %block_40cfa1 ], [ %366, %block_40cfd1 ]
  %MEMORY.3 = phi %struct.Memory* [ %MEMORY.2, %block_40cfa1 ], [ %call2_40cfb1, %block_40cfd1 ]
  %280 = add i64 %279, -8
  %281 = add i64 %278, 4
  ...
  %call2_40cfb1 = tail call %struct.Memory* @sub_40c0d0._Z18complete_hash_funcIiET_S0_(%struct.State* %0, i64 %295, %struct.Memory* %MEMORY.3)
  ...
  br i1 %390, label %block_.L_40cfd6, label %block_40cfd1

block_40cfd1:                                     ; preds = %block_.L_40cfa6
  %402 = add i64 %401, -43
  br label %block_.L_40cfa6

block_.L_40cfd6:                                  ; preds = %block_.L_40cfa6
  %403 = add i64 %401, 5
  store i64 %403, i64* %3, align 8
  br label %block_.L_40cfdb

block_.L_40cfdb:                                  ; preds = %block_.L_40cf95, %block_.L_40cfd6
  %404 = phi i64 [ %276, %block_.L_40cf95 ], [ %403, %block_.L_40cfd6 ]
  %405 = phi i64 [ %240, %block_.L_40cf95 ], [ %366, %block_.L_40cfd6 ]
  %MEMORY.4 = phi %struct.Memory* [ %MEMORY.2, %block_.L_40cf95 ], [ %call2_40cfb1, %block_.L_40cfd6 ]
  %406 = add i64 %405, -32
  %407 = add i64 %404, 3
  ...
  %call2_40cfde = tail call %struct.Memory* @sub_40c100._Z9check_sumIiEvT_(%struct.State* %0, i64 %411, %struct.Memory* %MEMORY.4)
...
block_.L_40cff1:                                  ; preds = %block_.L_40cf2f
  ...
  %call2_40cff1 = tail call %struct.Memory* @sub_400df0._Z5timerv(%struct.State* %0, i64 %448, %struct.Memory* %MEMORY.0)
  ...
  %call2_40cffa = tail call %struct.Memory* @sub_400790._Z13record_resultdPKc(%struct.State* %0, i64 %459, %struct.Memory* %call2_40cff1)
  ...
  ret %struct.Memory* %call2_40cffa
}
...
define %struct.Memory* @routine_jge_.L_40cff1(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i8* %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
...
define %struct.Memory* @routine_jl_.L_40cf95(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i8* %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 2, i32 9
...
define %struct.Memory* @routine_jmpq_.L_40cf61(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
...
define %struct.Memory* @routine_subl__0x1d___eax(%struct.State* dereferenceable(3376), i64, %struct.Memory*) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %RAX = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 1, i32 0, i32 0
  %3 = load i64, i64* %RAX, align 8
...
define %struct.Memory* @routine_jge_.L_40cf90(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i8* %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 2, i32 9
...
define %struct.Memory* @routine_jmpq_.L_40cf95(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
...
define %struct.Memory* @routine_jge_.L_40cfdb(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i8* %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 2, i32 9
...
define %struct.Memory* @routine_jmpq_.L_40cfa6(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
...
define %struct.Memory* @routine_je_.L_40cfd6(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i8* %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
...
define %struct.Memory* @routine_jmpq_.L_40cfdb(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
...
define %struct.Memory* @routine_jmpq_.L_40cf2f(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
