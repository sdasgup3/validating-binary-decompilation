...
block_.L_40cf2f:                                  ; preds = %block_.L_40cfdb, %entry
  %68 = phi i64 [ %.pre, %entry ], [ %449, %block_.L_40cfdb ]
...
block_.L_40cfa6:                                  ; preds = %block_40cfd1, %block_40cfa1
  %278 = phi i64 [ %277, %block_40cfa1 ], [ %403, %block_40cfd1 ]
  %279 = phi i64 [ %240, %block_40cfa1 ], [ %367, %block_40cfd1 ]
  ...
  br i1 %391, label %block_.L_40cfd6, label %block_40cfd1
...
block_.L_40cfdb:                                  ; preds = %block_.L_40cf95, %block_.L_40cfd6
  %405 = phi i64 [ %276, %block_.L_40cf95 ], [ %404, %block_.L_40cfd6 ]
  %406 = phi i64 [ %240, %block_.L_40cf95 ], [ %367, %block_.L_40cfd6 ]
  ...
  %call2_40cfde = tail call %struct.Memory* @sub_40c100._Z9check_sumIiEvT_(%struct.State* %0, i64 %412, %struct.Memory* %MEMORY.4)
...
block_.L_40cff1:                                  ; preds = %block_.L_40cf2f
  ...
  %call2_40cff1 = tail call %struct.Memory* @sub_400df0._Z5timerv(%struct.State* %0, i64 %450, %struct.Memory* %MEMORY.0)
  ...
  %call2_40cffa = tail call %struct.Memory* @sub_400790._Z13record_resultdPKc(%struct.State* %0, i64 %461, %struct.Memory* %call2_40cff1)
