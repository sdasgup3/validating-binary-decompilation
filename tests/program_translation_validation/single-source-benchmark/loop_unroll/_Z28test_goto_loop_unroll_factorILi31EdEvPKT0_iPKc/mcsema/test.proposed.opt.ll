...
entry:
  ...
  %call2_402213 = tail call %struct.Memory* @sub_400dd0._Z11start_timerv(%struct.State* %0, i64 %58, %struct.Memory* %2)
...
block_.L_40221f:                                  ; preds = %block_.L_4022d2, %entry
  %79 = phi i64 [ %.pre, %entry ], [ %435, %block_.L_4022d2 ]
  %MEMORY.0 = phi %struct.Memory* [ %call2_402213, %entry ], [ %call2_4022d7, %block_.L_4022d2 ]
  ...
  br i1 %112, label %block_40222f, label %block_.L_4022ea
...
block_40222f:                                     ; preds = %block_.L_40221f
  ...
  br i1 %160, label %block_.L_402286, label %block_40224d
...
block_.L_402252:                                  ; preds = %block_40227c, %block_40224d
  %163 = phi i64 [ %162, %block_40224d ], [ %250, %block_40227c ]
  %164 = phi i64 [ %124, %block_40224d ], [ %210, %block_40227c ]
  %MEMORY.1 = phi %struct.Memory* [ %MEMORY.0, %block_40224d ], [ %call2_40225d, %block_40227c ]
  %165 = add i64 %164, -40
  ...
  %call2_40225d = tail call %struct.Memory* @sub_4015f0._ZN15loop_inner_bodyILi31EdE7do_workERdPKdi(%struct.State* %0, i64 %175, %struct.Memory* %MEMORY.1)
  ...
  br i1 %248, label %block_40227c, label %block_.L_402281
...
block_.L_402286:                                  ; preds = %block_.L_402281, %block_40222f
  %252 = phi i64 [ %161, %block_40222f ], [ %251, %block_.L_402281 ]
  %253 = phi i64 [ %124, %block_40222f ], [ %210, %block_.L_402281 ]
  %MEMORY.2 = phi %struct.Memory* [ %MEMORY.0, %block_40222f ], [ %call2_40225d, %block_.L_402281 ]
  %254 = add i64 %253, -44
  %255 = add i64 %252, 3
  ...
  br i1 %288, label %block_402292, label %block_.L_4022d2
...
block_.L_402297:                                  ; preds = %block_4022c8, %block_402292
  %291 = phi i64 [ %290, %block_402292 ], [ %389, %block_4022c8 ]
  %292 = phi i64 [ %253, %block_402292 ], [ %353, %block_4022c8 ]
  %MEMORY.3 = phi %struct.Memory* [ %MEMORY.2, %block_402292 ], [ %call2_4022a4, %block_4022c8 ]
  %293 = add i64 %292, -8
  %294 = add i64 %291, 4
  ...
  %call2_4022a4 = tail call %struct.Memory* @sub_401480._Z18complete_hash_funcIdET_S0_(%struct.State* %0, i64 %308, %struct.Memory* %MEMORY.3)
  ...
  br i1 %377, label %block_.L_4022cd, label %block_4022c8
...
block_.L_4022d2:                                  ; preds = %block_.L_402286, %block_.L_4022cd
  %391 = phi i64 [ %289, %block_.L_402286 ], [ %390, %block_.L_4022cd ]
  %392 = phi i64 [ %253, %block_.L_402286 ], [ %353, %block_.L_4022cd ]
  %MEMORY.4 = phi %struct.Memory* [ %MEMORY.2, %block_.L_402286 ], [ %call2_4022a4, %block_.L_4022cd ]
  %393 = add i64 %392, -40
  %394 = add i64 %391, 5
  ...
  %call2_4022d7 = tail call %struct.Memory* @sub_4014b0._Z9check_sumIdEvT_(%struct.State* %0, i64 %398, %struct.Memory* %MEMORY.4)
...
block_.L_4022ea:                                  ; preds = %block_.L_40221f
  ...
  %call2_4022ea = tail call %struct.Memory* @sub_400df0._Z5timerv(%struct.State* %0, i64 %436, %struct.Memory* %MEMORY.0)
  ...
  %call2_4022f3 = tail call %struct.Memory* @sub_400790._Z13record_resultdPKc(%struct.State* %0, i64 %447, %struct.Memory* %call2_4022ea)
  ...
  ret %struct.Memory* %call2_4022f3
}
...
define %struct.Memory* @routine_jge_.L_4022ea(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i8* %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
...
define %struct.Memory* @routine_jl_.L_402286(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i8* %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 2, i32 9
...
define %struct.Memory* @routine_jmpq_.L_402252(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
...
define %struct.Memory* @routine_jge_.L_402281(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i8* %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 2, i32 9
...
define %struct.Memory* @routine_jmpq_.L_402286(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
...
define %struct.Memory* @routine_jge_.L_4022d2(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i8* %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 2, i32 9
...
define %struct.Memory* @routine_jmpq_.L_402297(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
...
define %struct.Memory* @routine_je_.L_4022cd(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i8* %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
...
define %struct.Memory* @routine_jmpq_.L_4022d2(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
...
define %struct.Memory* @routine_jmpq_.L_40221f(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
