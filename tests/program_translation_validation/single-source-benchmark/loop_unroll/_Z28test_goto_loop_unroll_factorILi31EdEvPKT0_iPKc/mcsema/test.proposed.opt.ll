...
entry:
  ...
  %call2_402253 = tail call %struct.Memory* @sub_400e10._Z11start_timerv(%struct.State* %0, i64 %58, %struct.Memory* %2)
...
block_.L_40225f:                                  ; preds = %block_.L_402312, %entry
  %74 = phi i64 [ %.pre, %entry ], [ %426, %block_.L_402312 ]
  %MEMORY.0 = phi %struct.Memory* [ %call2_402253, %entry ], [ %call2_402317, %block_.L_402312 ]
  ...
  br i1 %107, label %block_40226f, label %block_.L_40232a
...
block_40226f:                                     ; preds = %block_.L_40225f
  ...
  br i1 %154, label %block_.L_4022c6, label %block_40228d
...
block_.L_402292:                                  ; preds = %block_4022bc, %block_40228d
  %157 = phi i64 [ %118, %block_40228d ], [ %203, %block_4022bc ]
  %storemerge = phi i64 [ %156, %block_40228d ], [ %243, %block_4022bc ]
  %158 = add i64 %157, -40
  ...
  %call2_40229d = tail call %struct.Memory* @sub_401630._ZN15loop_inner_bodyILi31EdE7do_workERdPKdi(%struct.State* nonnull %0, i64 %168, %struct.Memory* %MEMORY.0)
  ...
  br i1 %241, label %block_4022bc, label %block_.L_4022c1
...
block_.L_4022c6:                                  ; preds = %block_.L_4022c1, %block_40226f
  %246 = phi i64 [ %245, %block_.L_4022c1 ], [ %155, %block_40226f ]
  %247 = phi i64 [ %203, %block_.L_4022c1 ], [ %118, %block_40226f ]
  %248 = add i64 %247, -44
  %249 = add i64 %246, 3
  ...
  br i1 %282, label %block_4022d2, label %block_.L_402312
...
block_.L_4022d7:                                  ; preds = %block_402308, %block_4022d2
  %285 = phi i64 [ %247, %block_4022d2 ], [ %345, %block_402308 ]
  %storemerge5 = phi i64 [ %284, %block_4022d2 ], [ %381, %block_402308 ]
  %286 = add i64 %285, -8
  ...
  %call2_4022e4 = tail call %struct.Memory* @sub_4014c0._Z18complete_hash_funcIdET_S0_(%struct.State* nonnull %0, i64 %300, %struct.Memory* %MEMORY.0)
  ...
  br i1 %369, label %block_.L_40230d, label %block_402308
...
block_.L_402312:                                  ; preds = %block_.L_4022c6, %block_.L_40230d
  %384 = phi i64 [ %283, %block_.L_4022c6 ], [ %383, %block_.L_40230d ]
  %385 = phi i64 [ %247, %block_.L_4022c6 ], [ %345, %block_.L_40230d ]
  %386 = add i64 %385, -40
  %387 = add i64 %384, 5
  ...
  %call2_402317 = tail call %struct.Memory* @sub_4014f0._Z9check_sumIdEvT_(%struct.State* nonnull %0, i64 %390, %struct.Memory* %MEMORY.0)
...
block_.L_40232a:                                  ; preds = %block_.L_40225f
  ...
  %call2_40232a = tail call %struct.Memory* @sub_400e30._Z5timerv(%struct.State* nonnull %0, i64 %427, %struct.Memory* %MEMORY.0)
  ...
  %call2_402333 = tail call %struct.Memory* @sub_4007d0._Z13record_resultdPKc(%struct.State* nonnull %0, i64 %438, %struct.Memory* %call2_40232a)
