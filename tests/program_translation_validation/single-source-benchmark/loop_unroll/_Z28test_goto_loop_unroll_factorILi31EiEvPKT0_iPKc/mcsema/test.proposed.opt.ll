...
define %struct.Memory* @_Z28test_goto_loop_unroll_factorILi31EiEvPKT0_iPKc(%struct.State* noalias, i64, %struct.Memory* noalias) local_unnamed_addr #1 {
entry:
  ...
  %call2_40cdd3 = tail call %struct.Memory* @sub_400dd0._Z11start_timerv(%struct.State* %0, i64 %58, %struct.Memory* %2)
...
block_.L_40cddf:                                  ; preds = %block_.L_40ce8b, %entry
  %68 = phi i64 [ %.pre, %entry ], [ %449, %block_.L_40ce8b ]
  %MEMORY.0 = phi %struct.Memory* [ %call2_40cdd3, %entry ], [ %call2_40ce8e, %block_.L_40ce8b ]
  ...
  br i1 %101, label %block_40cdef, label %block_.L_40cea1
...
block_40cdef:                                     ; preds = %block_.L_40cddf
  ...
  br i1 %147, label %block_.L_40ce45, label %block_40ce0c
...
block_.L_40ce11:                                  ; preds = %block_40ce3b, %block_40ce0c
  %150 = phi i64 [ %149, %block_40ce0c ], [ %237, %block_40ce3b ]
  %151 = phi i64 [ %111, %block_40ce0c ], [ %197, %block_40ce3b ]
  %MEMORY.1 = phi %struct.Memory* [ %MEMORY.0, %block_40ce0c ], [ %call2_40ce1c, %block_40ce3b ]
  %152 = add i64 %151, -32
  ...
  %call2_40ce1c = tail call %struct.Memory* @sub_40c1b0._ZN15loop_inner_bodyILi31EiE7do_workERiPKii(%struct.State* %0, i64 %162, %struct.Memory* %MEMORY.1)
  ...
  br i1 %235, label %block_40ce3b, label %block_.L_40ce40
...
block_.L_40ce45:                                  ; preds = %block_.L_40ce40, %block_40cdef
  %239 = phi i64 [ %148, %block_40cdef ], [ %238, %block_.L_40ce40 ]
  %240 = phi i64 [ %111, %block_40cdef ], [ %197, %block_.L_40ce40 ]
  %MEMORY.2 = phi %struct.Memory* [ %MEMORY.0, %block_40cdef ], [ %call2_40ce1c, %block_.L_40ce40 ]
  %241 = add i64 %240, -36
  %242 = add i64 %239, 3
  ...
  br i1 %275, label %block_40ce51, label %block_.L_40ce8b
...
block_.L_40ce56:                                  ; preds = %block_40ce81, %block_40ce51
  %278 = phi i64 [ %277, %block_40ce51 ], [ %403, %block_40ce81 ]
  %279 = phi i64 [ %240, %block_40ce51 ], [ %367, %block_40ce81 ]
  %MEMORY.3 = phi %struct.Memory* [ %MEMORY.2, %block_40ce51 ], [ %call2_40ce61, %block_40ce81 ]
  %280 = add i64 %279, -8
  %281 = add i64 %278, 4
  ...
  %call2_40ce61 = tail call %struct.Memory* @sub_40c0d0._Z18complete_hash_funcIiET_S0_(%struct.State* %0, i64 %295, %struct.Memory* %MEMORY.3)
  ...
  br i1 %391, label %block_.L_40ce86, label %block_40ce81
...
block_.L_40ce8b:                                  ; preds = %block_.L_40ce45, %block_.L_40ce86
  %405 = phi i64 [ %276, %block_.L_40ce45 ], [ %404, %block_.L_40ce86 ]
  %406 = phi i64 [ %240, %block_.L_40ce45 ], [ %367, %block_.L_40ce86 ]
  %MEMORY.4 = phi %struct.Memory* [ %MEMORY.2, %block_.L_40ce45 ], [ %call2_40ce61, %block_.L_40ce86 ]
  %407 = add i64 %406, -32
  %408 = add i64 %405, 3
  ...
  %call2_40ce8e = tail call %struct.Memory* @sub_40c100._Z9check_sumIiEvT_(%struct.State* %0, i64 %412, %struct.Memory* %MEMORY.4)
...
block_.L_40cea1:                                  ; preds = %block_.L_40cddf
  ...
  %call2_40cea1 = tail call %struct.Memory* @sub_400df0._Z5timerv(%struct.State* %0, i64 %450, %struct.Memory* %MEMORY.0)
  ...
  %call2_40ceaa = tail call %struct.Memory* @sub_400790._Z13record_resultdPKc(%struct.State* %0, i64 %461, %struct.Memory* %call2_40cea1)
  ...
  ret %struct.Memory* %call2_40ceaa
}
...
define %struct.Memory* @routine_jge_.L_40cea1(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i8* %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
...
define %struct.Memory* @routine_jl_.L_40ce45(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i8* %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 2, i32 9
...
define %struct.Memory* @routine_jmpq_.L_40ce11(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
...
define %struct.Memory* @routine_subl__0x1e___eax(%struct.State* dereferenceable(3376), i64, %struct.Memory*) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %RAX = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 1, i32 0, i32 0
  %3 = load i64, i64* %RAX, align 8
...
define %struct.Memory* @routine_jge_.L_40ce40(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i8* %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 2, i32 9
...
define %struct.Memory* @routine_jmpq_.L_40ce45(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
...
define %struct.Memory* @routine_jge_.L_40ce8b(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i8* %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 2, i32 9
...
define %struct.Memory* @routine_jmpq_.L_40ce56(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
...
define %struct.Memory* @routine_je_.L_40ce86(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i8* %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
...
define %struct.Memory* @routine_jmpq_.L_40ce8b(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
...
define %struct.Memory* @routine_jmpq_.L_40cddf(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
