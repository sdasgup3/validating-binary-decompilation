...
block_.L_40cddf:                                  ; preds = %block_.L_40ce8b, %entry
  %68 = phi i64 [ %.pre, %entry ], [ %447, %block_.L_40ce8b ]
...
block_.L_40ce56:                                  ; preds = %block_40ce81, %block_40ce51
  %278 = phi i64 [ %277, %block_40ce51 ], [ %402, %block_40ce81 ]
  %279 = phi i64 [ %240, %block_40ce51 ], [ %366, %block_40ce81 ]
  ...
  br i1 %390, label %block_.L_40ce86, label %block_40ce81
...
block_.L_40ce8b:                                  ; preds = %block_.L_40ce45, %block_.L_40ce86
  %404 = phi i64 [ %276, %block_.L_40ce45 ], [ %403, %block_.L_40ce86 ]
  %405 = phi i64 [ %240, %block_.L_40ce45 ], [ %366, %block_.L_40ce86 ]
  ...
  %call2_40ce8e = tail call %struct.Memory* @sub_40c100._Z9check_sumIiEvT_(%struct.State* %0, i64 %411, %struct.Memory* %MEMORY.4)
...
block_.L_40cea1:                                  ; preds = %block_.L_40cddf
  ...
  %call2_40cea1 = tail call %struct.Memory* @sub_400df0._Z5timerv(%struct.State* %0, i64 %448, %struct.Memory* %MEMORY.0)
  ...
  %call2_40ceaa = tail call %struct.Memory* @sub_400790._Z13record_resultdPKc(%struct.State* %0, i64 %459, %struct.Memory* %call2_40cea1)
