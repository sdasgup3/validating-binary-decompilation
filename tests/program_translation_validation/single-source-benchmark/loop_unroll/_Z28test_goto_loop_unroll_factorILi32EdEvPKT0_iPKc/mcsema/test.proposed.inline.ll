...
declare %struct.Memory* @sub_401420._ZN15loop_inner_bodyILi32EdE7do_workERdPKdi(%struct.State* noalias dereferenceable(3376), i64, %struct.Memory* noalias readnone returned)
...
entry:
  ...
  %loadMem1_401333 = load %struct.Memory*, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem1_401333, %struct.Memory** %MEMORY
  %loadMem2_401333 = load %struct.Memory*, %struct.Memory** %MEMORY
  %loadPC_401333 = load i64, i64* %3
  %call2_401333 = call %struct.Memory* @sub_400dd0._Z11start_timerv(%struct.State* %0, i64 %loadPC_401333, %struct.Memory* %loadMem2_401333)
  store %struct.Memory* %call2_401333, %struct.Memory** %MEMORY
...
block_.L_40133f:                                  ; preds = %block_.L_4013f2, %entry
  ...
  %loadBr_401349 = load i8, i8* %BRANCH_TAKEN
  %cmpBr_401349 = icmp eq i8 %loadBr_401349, 1
  br i1 %cmpBr_401349, label %block_.L_40140a, label %block_40134f

block_40134f:                                     ; preds = %block_.L_40133f
  ...
  %loadBr_401367 = load i8, i8* %BRANCH_TAKEN
  %cmpBr_401367 = icmp eq i8 %loadBr_401367, 1
  br i1 %cmpBr_401367, label %block_.L_4013a6, label %block_40136d

block_40136d:                                     ; preds = %block_40134f
...
block_.L_401372:                                  ; preds = %block_40139c, %block_40136d
  ...
  store %struct.Memory* %loadMem1_40137d, %struct.Memory** %MEMORY
  %loadMem2_40137d = load %struct.Memory*, %struct.Memory** %MEMORY
  %loadPC_40137d = load i64, i64* %3
  %call2_40137d = call %struct.Memory* @sub_401420._ZN15loop_inner_bodyILi32EdE7do_workERdPKdi(%struct.State* %0, i64 %loadPC_40137d, %struct.Memory* %loadMem2_40137d)
  ...
  %loadBr_401396 = load i8, i8* %BRANCH_TAKEN
  %cmpBr_401396 = icmp eq i8 %loadBr_401396, 1
  br i1 %cmpBr_401396, label %block_.L_4013a1, label %block_40139c

block_40139c:                                     ; preds = %block_.L_401372
...
block_.L_4013a1:                                  ; preds = %block_.L_401372
  ...
  br label %block_.L_4013a6

block_.L_4013a6:                                  ; preds = %block_.L_4013a1, %block_40134f
  ...
  %loadBr_4013ac = load i8, i8* %BRANCH_TAKEN
  %cmpBr_4013ac = icmp eq i8 %loadBr_4013ac, 1
  br i1 %cmpBr_4013ac, label %block_.L_4013f2, label %block_4013b2

block_4013b2:                                     ; preds = %block_.L_4013a6
  ...
  br label %block_.L_4013b7

block_.L_4013b7:                                  ; preds = %block_4013e8, %block_4013b2
  ...
  %call2_4013c4 = call %struct.Memory* @sub_401480._Z18complete_hash_funcIdET_S0_(%struct.State* %0, i64 %loadPC_4013c4, %struct.Memory* %loadMem2_4013c4)
  ...
  %loadBr_4013e2 = load i8, i8* %BRANCH_TAKEN
  %cmpBr_4013e2 = icmp eq i8 %loadBr_4013e2, 1
  br i1 %cmpBr_4013e2, label %block_.L_4013ed, label %block_4013e8

block_4013e8:                                     ; preds = %block_.L_4013b7
...
block_.L_4013ed:                                  ; preds = %block_.L_4013b7
  ...
  br label %block_.L_4013f2

block_.L_4013f2:                                  ; preds = %block_.L_4013ed, %block_.L_4013a6
  ...
  %call2_4013f7 = call %struct.Memory* @sub_4014b0._Z9check_sumIdEvT_(%struct.State* %0, i64 %loadPC_4013f7, %struct.Memory* %loadMem2_4013f7)
...
block_.L_40140a:                                  ; preds = %block_.L_40133f
  ...
  %call2_40140a = call %struct.Memory* @sub_400df0._Z5timerv(%struct.State* %0, i64 %loadPC_40140a, %struct.Memory* %loadMem2_40140a)
  ...
  store %struct.Memory* %loadMem1_401413, %struct.Memory** %MEMORY
  %loadMem2_401413 = load %struct.Memory*, %struct.Memory** %MEMORY
  %loadPC_401413 = load i64, i64* %3
  %call2_401413 = call %struct.Memory* @sub_400790._Z13record_resultdPKc(%struct.State* %0, i64 %loadPC_401413, %struct.Memory* %loadMem2_401413)
  ...
  store %struct.Memory* %loadMem_40141d, %struct.Memory** %MEMORY
  ret %struct.Memory* %loadMem_40141d
}
...
define %struct.Memory* @routine_jge_.L_40140a(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i8* %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) {
block_400478:
  %3 = getelementptr inbounds %struct.State, %struct.State* %0, i32 0, i32 6
  %4 = getelementptr inbounds %struct.GPR, %struct.GPR* %3, i32 0, i32 33
  %5 = getelementptr inbounds %struct.Reg, %struct.Reg* %4, i32 0, i32 0
...
define %struct.Memory* @routine_jl_.L_4013a6(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i8* %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) {
block_400478:
  %3 = getelementptr inbounds %struct.State, %struct.State* %0, i32 0, i32 6
  %4 = getelementptr inbounds %struct.GPR, %struct.GPR* %3, i32 0, i32 33
  %5 = getelementptr inbounds %struct.Reg, %struct.Reg* %4, i32 0, i32 0
...
define %struct.Memory* @routine_jge_.L_4013a1(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i8* %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) {
block_400478:
  %3 = getelementptr inbounds %struct.State, %struct.State* %0, i32 0, i32 6
  %4 = getelementptr inbounds %struct.GPR, %struct.GPR* %3, i32 0, i32 33
  %5 = getelementptr inbounds %struct.Reg, %struct.Reg* %4, i32 0, i32 0
...
define %struct.Memory* @routine_jmpq_.L_4013a6(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i64 %rel_off1, i64 %rel_off2) {
block_400478:
  %3 = getelementptr inbounds %struct.State, %struct.State* %0, i32 0, i32 6
  %4 = getelementptr inbounds %struct.GPR, %struct.GPR* %3, i32 0, i32 33
  %5 = getelementptr inbounds %struct.Reg, %struct.Reg* %4, i32 0, i32 0
...
define %struct.Memory* @routine_jmpq_.L_4013b7(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i64 %rel_off1, i64 %rel_off2) {
block_400478:
  %3 = getelementptr inbounds %struct.State, %struct.State* %0, i32 0, i32 6
  %4 = getelementptr inbounds %struct.GPR, %struct.GPR* %3, i32 0, i32 33
  %5 = getelementptr inbounds %struct.Reg, %struct.Reg* %4, i32 0, i32 0
...
define %struct.Memory* @routine_je_.L_4013ed(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i8* %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) {
block_400478:
  %3 = getelementptr inbounds %struct.State, %struct.State* %0, i32 0, i32 6
  %4 = getelementptr inbounds %struct.GPR, %struct.GPR* %3, i32 0, i32 33
  %5 = getelementptr inbounds %struct.Reg, %struct.Reg* %4, i32 0, i32 0
...
define %struct.Memory* @routine_jmpq_.L_4013f2(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i64 %rel_off1, i64 %rel_off2) {
block_400478:
  %3 = getelementptr inbounds %struct.State, %struct.State* %0, i32 0, i32 6
  %4 = getelementptr inbounds %struct.GPR, %struct.GPR* %3, i32 0, i32 33
  %5 = getelementptr inbounds %struct.Reg, %struct.Reg* %4, i32 0, i32 0
