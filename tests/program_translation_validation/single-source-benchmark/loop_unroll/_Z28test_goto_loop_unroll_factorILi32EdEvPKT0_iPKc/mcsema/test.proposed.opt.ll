...
entry:
  ...
  %call2_401333 = tail call %struct.Memory* @sub_400dd0._Z11start_timerv(%struct.State* %0, i64 %58, %struct.Memory* %2)
...
block_.L_40133f:                                  ; preds = %block_.L_4013f2, %entry
  %79 = phi i64 [ %.pre, %entry ], [ %433, %block_.L_4013f2 ]
  %MEMORY.0 = phi %struct.Memory* [ %call2_401333, %entry ], [ %call2_4013f7, %block_.L_4013f2 ]
  ...
  br i1 %112, label %block_40134f, label %block_.L_40140a
...
block_40134f:                                     ; preds = %block_.L_40133f
  ...
  br i1 %159, label %block_.L_4013a6, label %block_40136d
...
block_.L_401372:                                  ; preds = %block_40139c, %block_40136d
  %162 = phi i64 [ %161, %block_40136d ], [ %248, %block_40139c ]
  %163 = phi i64 [ %124, %block_40136d ], [ %208, %block_40139c ]
  %MEMORY.1 = phi %struct.Memory* [ %MEMORY.0, %block_40136d ], [ %call2_40137d, %block_40139c ]
  %164 = add i64 %163, -40
  ...
  %call2_40137d = tail call %struct.Memory* @sub_401420._ZN15loop_inner_bodyILi32EdE7do_workERdPKdi(%struct.State* %0, i64 %174, %struct.Memory* %MEMORY.1)
  ...
  br i1 %246, label %block_40139c, label %block_.L_4013a1
...
block_.L_4013a6:                                  ; preds = %block_.L_4013a1, %block_40134f
  %250 = phi i64 [ %160, %block_40134f ], [ %249, %block_.L_4013a1 ]
  %251 = phi i64 [ %124, %block_40134f ], [ %208, %block_.L_4013a1 ]
  %MEMORY.2 = phi %struct.Memory* [ %MEMORY.0, %block_40134f ], [ %call2_40137d, %block_.L_4013a1 ]
  %252 = add i64 %251, -44
  %253 = add i64 %250, 3
  ...
  br i1 %286, label %block_4013b2, label %block_.L_4013f2
...
block_.L_4013b7:                                  ; preds = %block_4013e8, %block_4013b2
  %289 = phi i64 [ %288, %block_4013b2 ], [ %387, %block_4013e8 ]
  %290 = phi i64 [ %251, %block_4013b2 ], [ %351, %block_4013e8 ]
  %MEMORY.3 = phi %struct.Memory* [ %MEMORY.2, %block_4013b2 ], [ %call2_4013c4, %block_4013e8 ]
  %291 = add i64 %290, -8
  %292 = add i64 %289, 4
  ...
  %call2_4013c4 = tail call %struct.Memory* @sub_401480._Z18complete_hash_funcIdET_S0_(%struct.State* %0, i64 %306, %struct.Memory* %MEMORY.3)
  ...
  br i1 %375, label %block_.L_4013ed, label %block_4013e8
...
block_.L_4013f2:                                  ; preds = %block_.L_4013a6, %block_.L_4013ed
  %389 = phi i64 [ %287, %block_.L_4013a6 ], [ %388, %block_.L_4013ed ]
  %390 = phi i64 [ %251, %block_.L_4013a6 ], [ %351, %block_.L_4013ed ]
  %MEMORY.4 = phi %struct.Memory* [ %MEMORY.2, %block_.L_4013a6 ], [ %call2_4013c4, %block_.L_4013ed ]
  %391 = add i64 %390, -40
  %392 = add i64 %389, 5
  ...
  %call2_4013f7 = tail call %struct.Memory* @sub_4014b0._Z9check_sumIdEvT_(%struct.State* %0, i64 %396, %struct.Memory* %MEMORY.4)
...
block_.L_40140a:                                  ; preds = %block_.L_40133f
  ...
  %call2_40140a = tail call %struct.Memory* @sub_400df0._Z5timerv(%struct.State* %0, i64 %434, %struct.Memory* %MEMORY.0)
  ...
  %call2_401413 = tail call %struct.Memory* @sub_400790._Z13record_resultdPKc(%struct.State* %0, i64 %445, %struct.Memory* %call2_40140a)
  ...
  ret %struct.Memory* %call2_401413
}
...
define %struct.Memory* @routine_jge_.L_40140a(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i8* %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
...
define %struct.Memory* @routine_jl_.L_4013a6(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i8* %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 2, i32 9
...
define %struct.Memory* @routine_jmpq_.L_401372(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
...
define %struct.Memory* @routine_jge_.L_4013a1(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i8* %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 2, i32 9
...
define %struct.Memory* @routine_jmpq_.L_4013a6(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
...
define %struct.Memory* @routine_jge_.L_4013f2(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i8* %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 2, i32 9
...
define %struct.Memory* @routine_jmpq_.L_4013b7(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
...
define %struct.Memory* @routine_je_.L_4013ed(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i8* %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
...
define %struct.Memory* @routine_jmpq_.L_4013f2(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
...
define %struct.Memory* @routine_jmpq_.L_40133f(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
