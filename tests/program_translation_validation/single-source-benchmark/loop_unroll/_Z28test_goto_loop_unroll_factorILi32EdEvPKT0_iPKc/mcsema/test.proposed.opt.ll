...
define %struct.Memory* @_Z28test_goto_loop_unroll_factorILi32EdEvPKT0_iPKc(%struct.State* noalias, i64, %struct.Memory* noalias) local_unnamed_addr #1 {
entry:
  ...
  %call2_401363 = tail call %struct.Memory* @sub_400e00._Z11start_timerv(%struct.State* %0, i64 %58, %struct.Memory* %2)
...
block_.L_40136f:                                  ; preds = %block_.L_401422, %entry
  %74 = phi i64 [ %.pre, %entry ], [ %424, %block_.L_401422 ]
  %MEMORY.0 = phi %struct.Memory* [ %call2_401363, %entry ], [ %call2_401427, %block_.L_401422 ]
  ...
  br i1 %107, label %block_40137f, label %block_.L_40143a
...
block_40137f:                                     ; preds = %block_.L_40136f
  ...
  br i1 %153, label %block_.L_4013d6, label %block_40139d
...
block_.L_4013a2:                                  ; preds = %block_4013cc, %block_40139d
  %156 = phi i64 [ %118, %block_40139d ], [ %201, %block_4013cc ]
  %storemerge = phi i64 [ %155, %block_40139d ], [ %241, %block_4013cc ]
  %MEMORY.1 = phi %struct.Memory* [ %MEMORY.0, %block_40139d ], [ %call2_4013ad, %block_4013cc ]
  %157 = add i64 %156, -40
  ...
  %call2_4013ad = tail call %struct.Memory* @sub_401450._ZN15loop_inner_bodyILi32EdE7do_workERdPKdi(%struct.State* nonnull %0, i64 %167, %struct.Memory* %MEMORY.1)
  ...
  br i1 %239, label %block_4013cc, label %block_.L_4013d1
...
block_.L_4013d6:                                  ; preds = %block_.L_4013d1, %block_40137f
  %244 = phi i64 [ %154, %block_40137f ], [ %243, %block_.L_4013d1 ]
  %245 = phi i64 [ %118, %block_40137f ], [ %201, %block_.L_4013d1 ]
  %MEMORY.2 = phi %struct.Memory* [ %MEMORY.0, %block_40137f ], [ %call2_4013ad, %block_.L_4013d1 ]
  %246 = add i64 %245, -44
  %247 = add i64 %244, 3
  ...
  br i1 %280, label %block_4013e2, label %block_.L_401422
...
block_.L_4013e7:                                  ; preds = %block_401418, %block_4013e2
  %283 = phi i64 [ %245, %block_4013e2 ], [ %343, %block_401418 ]
  %storemerge5 = phi i64 [ %282, %block_4013e2 ], [ %379, %block_401418 ]
  %MEMORY.3 = phi %struct.Memory* [ %MEMORY.2, %block_4013e2 ], [ %call2_4013f4, %block_401418 ]
  %284 = add i64 %283, -8
  ...
  %call2_4013f4 = tail call %struct.Memory* @sub_4014b0._Z18complete_hash_funcIdET_S0_(%struct.State* nonnull %0, i64 %298, %struct.Memory* %MEMORY.3)
  ...
  br i1 %367, label %block_.L_40141d, label %block_401418
...
block_.L_401422:                                  ; preds = %block_.L_4013d6, %block_.L_40141d
  %382 = phi i64 [ %281, %block_.L_4013d6 ], [ %381, %block_.L_40141d ]
  %383 = phi i64 [ %245, %block_.L_4013d6 ], [ %343, %block_.L_40141d ]
  %MEMORY.4 = phi %struct.Memory* [ %MEMORY.2, %block_.L_4013d6 ], [ %call2_4013f4, %block_.L_40141d ]
  %384 = add i64 %383, -40
  %385 = add i64 %382, 5
  ...
  %call2_401427 = tail call %struct.Memory* @sub_4014e0._Z9check_sumIdEvT_(%struct.State* nonnull %0, i64 %388, %struct.Memory* %MEMORY.4)
...
block_.L_40143a:                                  ; preds = %block_.L_40136f
  ...
  %call2_40143a = tail call %struct.Memory* @sub_400e20._Z5timerv(%struct.State* nonnull %0, i64 %425, %struct.Memory* %MEMORY.0)
  ...
  %call2_401443 = tail call %struct.Memory* @sub_4007c0._Z13record_resultdPKc(%struct.State* nonnull %0, i64 %436, %struct.Memory* %call2_40143a)
  ...
  ret %struct.Memory* %call2_401443
}
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_jge_.L_40143a(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i8* nocapture %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_jl_.L_4013d6(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i8* nocapture %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 2, i32 9
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_jmpq_.L_4013a2(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_jge_.L_4013d1(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i8* nocapture %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 2, i32 9
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_jmpq_.L_4013e7(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_je_.L_40141d(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i8* nocapture %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_jmpq_.L_401422(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_jmpq_.L_40136f(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
