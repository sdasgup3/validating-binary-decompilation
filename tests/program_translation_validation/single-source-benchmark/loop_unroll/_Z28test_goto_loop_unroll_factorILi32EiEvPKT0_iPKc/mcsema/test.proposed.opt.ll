...
block_.L_40bf8f:                                  ; preds = %block_.L_40c03b, %entry
  %68 = phi i64 [ %.pre, %entry ], [ %445, %block_.L_40c03b ]
...
block_.L_40c006:                                  ; preds = %block_40c031, %block_40c001
  %276 = phi i64 [ %275, %block_40c001 ], [ %400, %block_40c031 ]
  %277 = phi i64 [ %238, %block_40c001 ], [ %364, %block_40c031 ]
  ...
  br i1 %388, label %block_.L_40c036, label %block_40c031
...
block_.L_40c03b:                                  ; preds = %block_.L_40bff5, %block_.L_40c036
  %402 = phi i64 [ %274, %block_.L_40bff5 ], [ %401, %block_.L_40c036 ]
  %403 = phi i64 [ %238, %block_.L_40bff5 ], [ %364, %block_.L_40c036 ]
  ...
  %call2_40c03e = tail call %struct.Memory* @sub_40c100._Z9check_sumIiEvT_(%struct.State* %0, i64 %409, %struct.Memory* %MEMORY.4)
...
block_.L_40c051:                                  ; preds = %block_.L_40bf8f
  ...
  %call2_40c051 = tail call %struct.Memory* @sub_400df0._Z5timerv(%struct.State* %0, i64 %446, %struct.Memory* %MEMORY.0)
  ...
  %call2_40c05a = tail call %struct.Memory* @sub_400790._Z13record_resultdPKc(%struct.State* %0, i64 %457, %struct.Memory* %call2_40c051)
