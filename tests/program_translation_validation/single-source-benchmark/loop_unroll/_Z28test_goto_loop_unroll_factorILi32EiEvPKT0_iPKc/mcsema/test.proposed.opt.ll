...
declare %struct.Memory* @sub_40c070._ZN15loop_inner_bodyILi32EiE7do_workERiPKii(%struct.State* noalias dereferenceable(3376), i64, %struct.Memory* noalias readnone returned) local_unnamed_addr
...
entry:
  ...
  %call2_40bf83 = tail call %struct.Memory* @sub_400dd0._Z11start_timerv(%struct.State* %0, i64 %58, %struct.Memory* %2)
  ...
  br label %block_.L_40bf8f

block_.L_40bf8f:                                  ; preds = %block_.L_40c03b, %entry
  %68 = phi i64 [ %.pre, %entry ], [ %447, %block_.L_40c03b ]
  %MEMORY.0 = phi %struct.Memory* [ %call2_40bf83, %entry ], [ %call2_40c03e, %block_.L_40c03b ]
  ...
  br i1 %101, label %block_40bf9f, label %block_.L_40c051

block_40bf9f:                                     ; preds = %block_.L_40bf8f
  %103 = add i64 %69, -32
  %104 = add i64 %102, 7
  ...
  br i1 %146, label %block_.L_40bff5, label %block_40bfbc

block_40bfbc:                                     ; preds = %block_40bf9f
  %148 = add i64 %147, 5
  br label %block_.L_40bfc1

block_.L_40bfc1:                                  ; preds = %block_40bfeb, %block_40bfbc
  %149 = phi i64 [ %148, %block_40bfbc ], [ %235, %block_40bfeb ]
  %150 = phi i64 [ %111, %block_40bfbc ], [ %195, %block_40bfeb ]
  %MEMORY.1 = phi %struct.Memory* [ %MEMORY.0, %block_40bfbc ], [ %call2_40bfcc, %block_40bfeb ]
  %151 = add i64 %150, -32
  ...
  %call2_40bfcc = tail call %struct.Memory* @sub_40c070._ZN15loop_inner_bodyILi32EiE7do_workERiPKii(%struct.State* %0, i64 %161, %struct.Memory* %MEMORY.1)
  ...
  br i1 %233, label %block_40bfeb, label %block_.L_40bff0

block_40bfeb:                                     ; preds = %block_.L_40bfc1
  %235 = add i64 %234, -42
  br label %block_.L_40bfc1

block_.L_40bff0:                                  ; preds = %block_.L_40bfc1
  %236 = add i64 %234, 5
  store i64 %236, i64* %3, align 8
  br label %block_.L_40bff5

block_.L_40bff5:                                  ; preds = %block_.L_40bff0, %block_40bf9f
  %237 = phi i64 [ %147, %block_40bf9f ], [ %236, %block_.L_40bff0 ]
  %238 = phi i64 [ %111, %block_40bf9f ], [ %195, %block_.L_40bff0 ]
  %MEMORY.2 = phi %struct.Memory* [ %MEMORY.0, %block_40bf9f ], [ %call2_40bfcc, %block_.L_40bff0 ]
  %239 = add i64 %238, -36
  %240 = add i64 %237, 3
  ...
  br i1 %273, label %block_40c001, label %block_.L_40c03b

block_40c001:                                     ; preds = %block_.L_40bff5
  %275 = add i64 %274, 5
  br label %block_.L_40c006

block_.L_40c006:                                  ; preds = %block_40c031, %block_40c001
  %276 = phi i64 [ %275, %block_40c001 ], [ %401, %block_40c031 ]
  %277 = phi i64 [ %238, %block_40c001 ], [ %365, %block_40c031 ]
  %MEMORY.3 = phi %struct.Memory* [ %MEMORY.2, %block_40c001 ], [ %call2_40c011, %block_40c031 ]
  %278 = add i64 %277, -8
  %279 = add i64 %276, 4
  ...
  %call2_40c011 = tail call %struct.Memory* @sub_40c0d0._Z18complete_hash_funcIiET_S0_(%struct.State* %0, i64 %293, %struct.Memory* %MEMORY.3)
  ...
  br i1 %389, label %block_.L_40c036, label %block_40c031

block_40c031:                                     ; preds = %block_.L_40c006
  %401 = add i64 %400, -43
  br label %block_.L_40c006

block_.L_40c036:                                  ; preds = %block_.L_40c006
  %402 = add i64 %400, 5
  store i64 %402, i64* %3, align 8
  br label %block_.L_40c03b

block_.L_40c03b:                                  ; preds = %block_.L_40bff5, %block_.L_40c036
  %403 = phi i64 [ %274, %block_.L_40bff5 ], [ %402, %block_.L_40c036 ]
  %404 = phi i64 [ %238, %block_.L_40bff5 ], [ %365, %block_.L_40c036 ]
  %MEMORY.4 = phi %struct.Memory* [ %MEMORY.2, %block_.L_40bff5 ], [ %call2_40c011, %block_.L_40c036 ]
  %405 = add i64 %404, -32
  %406 = add i64 %403, 3
  ...
  %call2_40c03e = tail call %struct.Memory* @sub_40c100._Z9check_sumIiEvT_(%struct.State* %0, i64 %410, %struct.Memory* %MEMORY.4)
...
block_.L_40c051:                                  ; preds = %block_.L_40bf8f
  %448 = add i64 %102, -45665
  %449 = add i64 %102, 5
  ...
  %call2_40c051 = tail call %struct.Memory* @sub_400df0._Z5timerv(%struct.State* %0, i64 %448, %struct.Memory* %MEMORY.0)
  ...
  %call2_40c05a = tail call %struct.Memory* @sub_400790._Z13record_resultdPKc(%struct.State* %0, i64 %459, %struct.Memory* %call2_40c051)
  ...
  ret %struct.Memory* %call2_40c05a
}
...
define %struct.Memory* @routine_jge_.L_40c051(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i8* %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
...
define %struct.Memory* @routine_jl_.L_40bff5(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i8* %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 2, i32 9
...
define %struct.Memory* @routine_jmpq_.L_40bfc1(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
...
define %struct.Memory* @routine_callq_._ZN15loop_inner_bodyILi32EiE7do_workERiPKii(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
...
define %struct.Memory* @routine_subl__0x1f___eax(%struct.State* dereferenceable(3376), i64, %struct.Memory*) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %RAX = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 1, i32 0, i32 0
  %3 = load i64, i64* %RAX, align 8
...
define %struct.Memory* @routine_jge_.L_40bff0(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i8* %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 2, i32 9
...
define %struct.Memory* @routine_jmpq_.L_40bff5(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
...
define %struct.Memory* @routine_jge_.L_40c03b(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i8* %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 2, i32 9
...
define %struct.Memory* @routine_jmpq_.L_40c006(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
...
define %struct.Memory* @routine_je_.L_40c036(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i8* %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
...
define %struct.Memory* @routine_jmpq_.L_40c03b(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
...
define %struct.Memory* @routine_jmpq_.L_40bf8f(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
