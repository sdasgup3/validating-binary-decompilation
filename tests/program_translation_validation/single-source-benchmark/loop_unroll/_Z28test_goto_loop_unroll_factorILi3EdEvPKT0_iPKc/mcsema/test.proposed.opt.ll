...
block_.L_404742:                                  ; preds = %block_40476c, %block_40473d
  ...
  %call2_40474d = tail call %struct.Memory* @sub_4020a0._ZN15loop_inner_bodyILi3EdE7do_workERdPKdi(%struct.State* nonnull %0, i64 %167, %struct.Memory* %MEMORY.0)
...
block_.L_404776:                                  ; preds = %block_.L_404771, %block_40471f
  %244 = phi i64 [ %243, %block_.L_404771 ], [ %154, %block_40471f ]
  %245 = phi i64 [ %201, %block_.L_404771 ], [ %118, %block_40471f ]
  %246 = add i64 %245, -44
  %247 = add i64 %244, 3
...
block_.L_404787:                                  ; preds = %block_4047b8, %block_404782
  ...
  %call2_404794 = tail call %struct.Memory* @sub_4014b0._Z18complete_hash_funcIdET_S0_(%struct.State* nonnull %0, i64 %298, %struct.Memory* %MEMORY.0)
...
block_.L_4047c2:                                  ; preds = %block_.L_404776, %block_.L_4047bd
  ...
  %call2_4047c7 = tail call %struct.Memory* @sub_4014e0._Z9check_sumIdEvT_(%struct.State* nonnull %0, i64 %388, %struct.Memory* %MEMORY.0)
