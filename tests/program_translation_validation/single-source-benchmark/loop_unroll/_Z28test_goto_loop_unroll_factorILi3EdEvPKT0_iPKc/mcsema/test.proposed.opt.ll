...
define %struct.Memory* @_Z28test_goto_loop_unroll_factorILi3EdEvPKT0_iPKc(%struct.State* noalias, i64, %struct.Memory* noalias) local_unnamed_addr #1 {
entry:
  ...
  %call2_404703 = tail call %struct.Memory* @sub_400e00._Z11start_timerv(%struct.State* %0, i64 %58, %struct.Memory* %2)
...
block_.L_40470f:                                  ; preds = %block_.L_4047c2, %entry
  %74 = phi i64 [ %.pre, %entry ], [ %424, %block_.L_4047c2 ]
  %MEMORY.0 = phi %struct.Memory* [ %call2_404703, %entry ], [ %call2_4047c7, %block_.L_4047c2 ]
  ...
  br i1 %107, label %block_40471f, label %block_.L_4047da
...
block_40471f:                                     ; preds = %block_.L_40470f
  ...
  br i1 %153, label %block_.L_404776, label %block_40473d
...
block_.L_404742:                                  ; preds = %block_40476c, %block_40473d
  %156 = phi i64 [ %118, %block_40473d ], [ %201, %block_40476c ]
  %storemerge = phi i64 [ %155, %block_40473d ], [ %241, %block_40476c ]
  %MEMORY.1 = phi %struct.Memory* [ %MEMORY.0, %block_40473d ], [ %call2_40474d, %block_40476c ]
  %157 = add i64 %156, -40
  ...
  %call2_40474d = tail call %struct.Memory* @sub_4020a0._ZN15loop_inner_bodyILi3EdE7do_workERdPKdi(%struct.State* nonnull %0, i64 %167, %struct.Memory* %MEMORY.1)
  ...
  br i1 %239, label %block_40476c, label %block_.L_404771
...
block_.L_404776:                                  ; preds = %block_.L_404771, %block_40471f
  %244 = phi i64 [ %154, %block_40471f ], [ %243, %block_.L_404771 ]
  %245 = phi i64 [ %118, %block_40471f ], [ %201, %block_.L_404771 ]
  %MEMORY.2 = phi %struct.Memory* [ %MEMORY.0, %block_40471f ], [ %call2_40474d, %block_.L_404771 ]
  %246 = add i64 %245, -44
  %247 = add i64 %244, 3
  ...
  br i1 %280, label %block_404782, label %block_.L_4047c2
...
block_.L_404787:                                  ; preds = %block_4047b8, %block_404782
  %283 = phi i64 [ %245, %block_404782 ], [ %343, %block_4047b8 ]
  %storemerge5 = phi i64 [ %282, %block_404782 ], [ %379, %block_4047b8 ]
  %MEMORY.3 = phi %struct.Memory* [ %MEMORY.2, %block_404782 ], [ %call2_404794, %block_4047b8 ]
  %284 = add i64 %283, -8
  ...
  %call2_404794 = tail call %struct.Memory* @sub_4014b0._Z18complete_hash_funcIdET_S0_(%struct.State* nonnull %0, i64 %298, %struct.Memory* %MEMORY.3)
  ...
  br i1 %367, label %block_.L_4047bd, label %block_4047b8
...
block_.L_4047c2:                                  ; preds = %block_.L_404776, %block_.L_4047bd
  %382 = phi i64 [ %281, %block_.L_404776 ], [ %381, %block_.L_4047bd ]
  %383 = phi i64 [ %245, %block_.L_404776 ], [ %343, %block_.L_4047bd ]
  %MEMORY.4 = phi %struct.Memory* [ %MEMORY.2, %block_.L_404776 ], [ %call2_404794, %block_.L_4047bd ]
  %384 = add i64 %383, -40
  %385 = add i64 %382, 5
  ...
  %call2_4047c7 = tail call %struct.Memory* @sub_4014e0._Z9check_sumIdEvT_(%struct.State* nonnull %0, i64 %388, %struct.Memory* %MEMORY.4)
...
block_.L_4047da:                                  ; preds = %block_.L_40470f
  ...
  %call2_4047da = tail call %struct.Memory* @sub_400e20._Z5timerv(%struct.State* nonnull %0, i64 %425, %struct.Memory* %MEMORY.0)
  ...
  %call2_4047e3 = tail call %struct.Memory* @sub_4007c0._Z13record_resultdPKc(%struct.State* nonnull %0, i64 %436, %struct.Memory* %call2_4047da)
  ...
  ret %struct.Memory* %call2_4047e3
}
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_jge_.L_4047da(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i8* nocapture %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_jl_.L_404776(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i8* nocapture %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 2, i32 9
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_jmpq_.L_404742(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_jge_.L_404771(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i8* nocapture %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 2, i32 9
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_jmpq_.L_404776(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_jge_.L_4047c2(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i8* nocapture %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 2, i32 9
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_jmpq_.L_404787(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_je_.L_4047bd(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i8* nocapture %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_jmpq_.L_4047c2(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_jmpq_.L_40470f(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
