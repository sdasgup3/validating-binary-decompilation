...
block_.L_40f29f:                                  ; preds = %block_.L_40f34b, %entry
  %68 = phi i64 [ %.pre, %entry ], [ %447, %block_.L_40f34b ]
...
block_.L_40f316:                                  ; preds = %block_40f341, %block_40f311
  %276 = phi i64 [ %275, %block_40f311 ], [ %401, %block_40f341 ]
  %277 = phi i64 [ %238, %block_40f311 ], [ %365, %block_40f341 ]
  ...
  br i1 %389, label %block_.L_40f346, label %block_40f341
...
block_.L_40f34b:                                  ; preds = %block_.L_40f305, %block_.L_40f346
  %403 = phi i64 [ %274, %block_.L_40f305 ], [ %402, %block_.L_40f346 ]
  %404 = phi i64 [ %238, %block_.L_40f305 ], [ %365, %block_.L_40f346 ]
  ...
  %call2_40f34e = tail call %struct.Memory* @sub_40c100._Z9check_sumIiEvT_(%struct.State* %0, i64 %410, %struct.Memory* %MEMORY.4)
...
block_.L_40f361:                                  ; preds = %block_.L_40f29f
  ...
  %call2_40f361 = tail call %struct.Memory* @sub_400df0._Z5timerv(%struct.State* %0, i64 %448, %struct.Memory* %MEMORY.0)
  ...
  %call2_40f36a = tail call %struct.Memory* @sub_400790._Z13record_resultdPKc(%struct.State* %0, i64 %459, %struct.Memory* %call2_40f361)
