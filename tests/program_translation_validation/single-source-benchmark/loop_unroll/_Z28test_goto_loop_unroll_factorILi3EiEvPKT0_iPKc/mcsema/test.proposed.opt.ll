...
entry:
  ...
  %call2_40f293 = tail call %struct.Memory* @sub_400dd0._Z11start_timerv(%struct.State* %0, i64 %58, %struct.Memory* %2)
...
block_.L_40f29f:                                  ; preds = %block_.L_40f34b, %entry
  %68 = phi i64 [ %.pre, %entry ], [ %445, %block_.L_40f34b ]
  %MEMORY.0 = phi %struct.Memory* [ %call2_40f293, %entry ], [ %call2_40f34e, %block_.L_40f34b ]
  ...
  br i1 %101, label %block_40f2af, label %block_.L_40f361

block_40f2af:                                     ; preds = %block_.L_40f29f
  %103 = add i64 %69, -32
  %104 = add i64 %102, 7
  ...
  br i1 %146, label %block_.L_40f305, label %block_40f2cc

block_40f2cc:                                     ; preds = %block_40f2af
  %148 = add i64 %147, 5
  br label %block_.L_40f2d1

block_.L_40f2d1:                                  ; preds = %block_40f2fb, %block_40f2cc
  %149 = phi i64 [ %148, %block_40f2cc ], [ %235, %block_40f2fb ]
  %150 = phi i64 [ %111, %block_40f2cc ], [ %195, %block_40f2fb ]
  %MEMORY.1 = phi %struct.Memory* [ %MEMORY.0, %block_40f2cc ], [ %call2_40f2dc, %block_40f2fb ]
  %151 = add i64 %150, -32
  ...
  %call2_40f2dc = tail call %struct.Memory* @sub_40cc30._ZN15loop_inner_bodyILi3EiE7do_workERiPKii(%struct.State* %0, i64 %161, %struct.Memory* %MEMORY.1)
  ...
  br i1 %233, label %block_40f2fb, label %block_.L_40f300

block_40f2fb:                                     ; preds = %block_.L_40f2d1
  %235 = add i64 %234, -42
  br label %block_.L_40f2d1

block_.L_40f300:                                  ; preds = %block_.L_40f2d1
  %236 = add i64 %234, 5
  store i64 %236, i64* %3, align 8
  br label %block_.L_40f305

block_.L_40f305:                                  ; preds = %block_.L_40f300, %block_40f2af
  %237 = phi i64 [ %147, %block_40f2af ], [ %236, %block_.L_40f300 ]
  %238 = phi i64 [ %111, %block_40f2af ], [ %195, %block_.L_40f300 ]
  %MEMORY.2 = phi %struct.Memory* [ %MEMORY.0, %block_40f2af ], [ %call2_40f2dc, %block_.L_40f300 ]
  %239 = add i64 %238, -36
  %240 = add i64 %237, 3
  ...
  br i1 %273, label %block_40f311, label %block_.L_40f34b

block_40f311:                                     ; preds = %block_.L_40f305
  %275 = add i64 %274, 5
  br label %block_.L_40f316

block_.L_40f316:                                  ; preds = %block_40f341, %block_40f311
  %276 = phi i64 [ %275, %block_40f311 ], [ %400, %block_40f341 ]
  %277 = phi i64 [ %238, %block_40f311 ], [ %364, %block_40f341 ]
  %MEMORY.3 = phi %struct.Memory* [ %MEMORY.2, %block_40f311 ], [ %call2_40f321, %block_40f341 ]
  %278 = add i64 %277, -8
  %279 = add i64 %276, 4
  ...
  %call2_40f321 = tail call %struct.Memory* @sub_40c0d0._Z18complete_hash_funcIiET_S0_(%struct.State* %0, i64 %293, %struct.Memory* %MEMORY.3)
  ...
  br i1 %388, label %block_.L_40f346, label %block_40f341

block_40f341:                                     ; preds = %block_.L_40f316
  %400 = add i64 %399, -43
  br label %block_.L_40f316

block_.L_40f346:                                  ; preds = %block_.L_40f316
  %401 = add i64 %399, 5
  store i64 %401, i64* %3, align 8
  br label %block_.L_40f34b

block_.L_40f34b:                                  ; preds = %block_.L_40f305, %block_.L_40f346
  %402 = phi i64 [ %274, %block_.L_40f305 ], [ %401, %block_.L_40f346 ]
  %403 = phi i64 [ %238, %block_.L_40f305 ], [ %364, %block_.L_40f346 ]
  %MEMORY.4 = phi %struct.Memory* [ %MEMORY.2, %block_.L_40f305 ], [ %call2_40f321, %block_.L_40f346 ]
  %404 = add i64 %403, -32
  %405 = add i64 %402, 3
  ...
  %call2_40f34e = tail call %struct.Memory* @sub_40c100._Z9check_sumIiEvT_(%struct.State* %0, i64 %409, %struct.Memory* %MEMORY.4)
...
block_.L_40f361:                                  ; preds = %block_.L_40f29f
  ...
  %call2_40f361 = tail call %struct.Memory* @sub_400df0._Z5timerv(%struct.State* %0, i64 %446, %struct.Memory* %MEMORY.0)
  ...
  %call2_40f36a = tail call %struct.Memory* @sub_400790._Z13record_resultdPKc(%struct.State* %0, i64 %457, %struct.Memory* %call2_40f361)
  ...
  ret %struct.Memory* %call2_40f36a
}
...
define %struct.Memory* @routine_jge_.L_40f361(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i8* %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
...
define %struct.Memory* @routine_jl_.L_40f305(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i8* %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 2, i32 9
...
define %struct.Memory* @routine_jmpq_.L_40f2d1(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
...
define %struct.Memory* @routine_jge_.L_40f300(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i8* %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 2, i32 9
...
define %struct.Memory* @routine_jmpq_.L_40f305(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
...
define %struct.Memory* @routine_jge_.L_40f34b(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i8* %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 2, i32 9
...
define %struct.Memory* @routine_jmpq_.L_40f316(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
...
define %struct.Memory* @routine_je_.L_40f346(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i8* %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
...
define %struct.Memory* @routine_jmpq_.L_40f34b(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
...
define %struct.Memory* @routine_jmpq_.L_40f29f(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
