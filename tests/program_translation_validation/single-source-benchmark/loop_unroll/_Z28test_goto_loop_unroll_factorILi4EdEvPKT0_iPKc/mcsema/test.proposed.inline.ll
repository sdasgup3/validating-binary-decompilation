...
define %struct.Memory* @_Z28test_goto_loop_unroll_factorILi4EdEvPKT0_iPKc(%struct.State* noalias, i64, %struct.Memory* noalias) #2 {
entry:
  ...
  store %struct.Memory* %loadMem_4045b4, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem1_4045c3, %struct.Memory** %MEMORY
...
block_.L_4045cf:                                  ; preds = %block_.L_404682, %entry
...
block_4045df:                                     ; preds = %block_.L_4045cf
  ...
  store %struct.Memory* %loadMem_4045df, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_4045f4, %struct.Memory** %MEMORY
...
block_4045fd:                                     ; preds = %block_4045df
...
block_.L_404602:                                  ; preds = %block_40462c, %block_4045fd
  ...
  store %struct.Memory* %loadMem1_40460d, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_404626, %struct.Memory** %MEMORY
...
block_40462c:                                     ; preds = %block_.L_404602
...
block_.L_404631:                                  ; preds = %block_.L_404602
...
block_.L_404636:                                  ; preds = %block_.L_404631, %block_4045df
...
block_404642:                                     ; preds = %block_.L_404636
...
block_.L_404647:                                  ; preds = %block_404678, %block_404642
  ...
  store %struct.Memory* %loadMem_40464f, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem1_404654, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_404669, %struct.Memory** %MEMORY
...
block_404678:                                     ; preds = %block_.L_404647
...
block_.L_40467d:                                  ; preds = %block_.L_404647
...
block_.L_404682:                                  ; preds = %block_.L_40467d, %block_.L_404636
  ...
  store %struct.Memory* %loadMem1_404687, %struct.Memory** %MEMORY
...
block_.L_40469a:                                  ; preds = %block_.L_4045cf
  ...
  store %struct.Memory* %loadMem1_40469a, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_4046ad, %struct.Memory** %MEMORY
  ret %struct.Memory* %loadMem_4046ad
}
