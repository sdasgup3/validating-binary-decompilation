...
define %struct.Memory* @_Z28test_goto_loop_unroll_factorILi4EdEvPKT0_iPKc(%struct.State* noalias, i64, %struct.Memory* noalias) #1 {
entry:
  ...
  store %struct.Memory* %loadMem1_4045b3, %struct.Memory** %MEMORY
...
block_.L_4045bf:                                  ; preds = %block_.L_404672, %entry
...
block_4045cf:                                     ; preds = %block_.L_4045bf
...
block_4045ed:                                     ; preds = %block_4045cf
...
block_.L_4045f2:                                  ; preds = %block_40461c, %block_4045ed
  ...
  store %struct.Memory* %loadMem_4045fa, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem1_4045fd, %struct.Memory** %MEMORY
...
block_40461c:                                     ; preds = %block_.L_4045f2
...
block_.L_404621:                                  ; preds = %block_.L_4045f2
...
block_.L_404626:                                  ; preds = %block_.L_404621, %block_4045cf
...
block_404632:                                     ; preds = %block_.L_404626
...
block_.L_404637:                                  ; preds = %block_404668, %block_404632
  ...
  store %struct.Memory* %loadMem1_404644, %struct.Memory** %MEMORY
...
block_404668:                                     ; preds = %block_.L_404637
...
block_.L_40466d:                                  ; preds = %block_.L_404637
...
block_.L_404672:                                  ; preds = %block_.L_40466d, %block_.L_404626
  ...
  store %struct.Memory* %loadMem1_404677, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_404685, %struct.Memory** %MEMORY
  br label %block_.L_4045bf

block_.L_40468a:                                  ; preds = %block_.L_4045bf
  ...
  store %struct.Memory* %loadMem1_40468a, %struct.Memory** %MEMORY
  ...
  ret %struct.Memory* %loadMem_40469d
}
