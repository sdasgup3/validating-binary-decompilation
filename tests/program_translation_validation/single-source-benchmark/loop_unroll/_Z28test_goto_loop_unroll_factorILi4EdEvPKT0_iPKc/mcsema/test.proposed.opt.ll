...
entry:
  ...
  %call2_404583 = tail call %struct.Memory* @sub_400dd0._Z11start_timerv(%struct.State* %0, i64 %58, %struct.Memory* %2)
...
block_.L_40458f:                                  ; preds = %block_.L_404642, %entry
  %79 = phi i64 [ %.pre, %entry ], [ %429, %block_.L_404642 ]
  %MEMORY.0 = phi %struct.Memory* [ %call2_404583, %entry ], [ %call2_404647, %block_.L_404642 ]
  ...
  br i1 %112, label %block_40459f, label %block_.L_40465a
...
block_40459f:                                     ; preds = %block_.L_40458f
  ...
  br i1 %159, label %block_.L_4045f6, label %block_4045bd
...
block_.L_4045c2:                                  ; preds = %block_4045ec, %block_4045bd
  %162 = phi i64 [ %161, %block_4045bd ], [ %248, %block_4045ec ]
  %163 = phi i64 [ %124, %block_4045bd ], [ %208, %block_4045ec ]
  %MEMORY.1 = phi %struct.Memory* [ %MEMORY.0, %block_4045bd ], [ %call2_4045cd, %block_4045ec ]
  %164 = add i64 %163, -40
  ...
  %call2_4045cd = tail call %struct.Memory* @sub_402010._ZN15loop_inner_bodyILi4EdE7do_workERdPKdi(%struct.State* %0, i64 %174, %struct.Memory* %MEMORY.1)
  ...
  br i1 %246, label %block_4045ec, label %block_.L_4045f1
...
block_.L_4045f6:                                  ; preds = %block_.L_4045f1, %block_40459f
  %250 = phi i64 [ %160, %block_40459f ], [ %249, %block_.L_4045f1 ]
  %251 = phi i64 [ %124, %block_40459f ], [ %208, %block_.L_4045f1 ]
  %MEMORY.2 = phi %struct.Memory* [ %MEMORY.0, %block_40459f ], [ %call2_4045cd, %block_.L_4045f1 ]
  %252 = add i64 %251, -44
  %253 = add i64 %250, 3
  ...
  br i1 %286, label %block_404602, label %block_.L_404642
...
block_.L_404607:                                  ; preds = %block_404638, %block_404602
  %289 = phi i64 [ %288, %block_404602 ], [ %385, %block_404638 ]
  %290 = phi i64 [ %251, %block_404602 ], [ %349, %block_404638 ]
  %MEMORY.3 = phi %struct.Memory* [ %MEMORY.2, %block_404602 ], [ %call2_404614, %block_404638 ]
  %291 = add i64 %290, -8
  %292 = add i64 %289, 4
  ...
  %call2_404614 = tail call %struct.Memory* @sub_401480._Z18complete_hash_funcIdET_S0_(%struct.State* %0, i64 %305, %struct.Memory* %MEMORY.3)
  ...
  br i1 %373, label %block_.L_40463d, label %block_404638
...
block_.L_404642:                                  ; preds = %block_.L_4045f6, %block_.L_40463d
  %387 = phi i64 [ %287, %block_.L_4045f6 ], [ %386, %block_.L_40463d ]
  %388 = phi i64 [ %251, %block_.L_4045f6 ], [ %349, %block_.L_40463d ]
  %MEMORY.4 = phi %struct.Memory* [ %MEMORY.2, %block_.L_4045f6 ], [ %call2_404614, %block_.L_40463d ]
  %389 = add i64 %388, -40
  %390 = add i64 %387, 5
  ...
  %call2_404647 = tail call %struct.Memory* @sub_4014b0._Z9check_sumIdEvT_(%struct.State* %0, i64 %393, %struct.Memory* %MEMORY.4)
...
block_.L_40465a:                                  ; preds = %block_.L_40458f
  ...
  %call2_40465a = tail call %struct.Memory* @sub_400df0._Z5timerv(%struct.State* %0, i64 %430, %struct.Memory* %MEMORY.0)
  ...
  %call2_404663 = tail call %struct.Memory* @sub_400790._Z13record_resultdPKc(%struct.State* %0, i64 %441, %struct.Memory* %call2_40465a)
  ...
  ret %struct.Memory* %call2_404663
}
...
define %struct.Memory* @routine_jge_.L_40465a(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i8* %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
...
define %struct.Memory* @routine_jl_.L_4045f6(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i8* %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 2, i32 9
...
define %struct.Memory* @routine_jmpq_.L_4045c2(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
...
define %struct.Memory* @routine_jge_.L_4045f1(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i8* %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 2, i32 9
...
define %struct.Memory* @routine_jmpq_.L_4045f6(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
...
define %struct.Memory* @routine_jge_.L_404642(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i8* %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 2, i32 9
...
define %struct.Memory* @routine_jmpq_.L_404607(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
...
define %struct.Memory* @routine_je_.L_40463d(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i8* %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
...
define %struct.Memory* @routine_jmpq_.L_404642(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
...
define %struct.Memory* @routine_jmpq_.L_40458f(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
