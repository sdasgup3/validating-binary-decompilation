...
define %struct.Memory* @_Z28test_goto_loop_unroll_factorILi4EiEvPKT0_iPKc(%struct.State* noalias, i64, %struct.Memory* noalias readnone) local_unnamed_addr #1 {
entry:
...
block_.L_40f1b1:                                  ; preds = %block_40f1db, %block_40f1ac
  ...
  %call2_40f1bc = tail call %struct.Memory* @sub_40cc00._ZN15loop_inner_bodyILi4EiE7do_workERiPKii(%struct.State* nonnull %0, i64 %160, %struct.Memory* %MEMORY.0)
...
block_.L_40f1e5:                                  ; preds = %block_.L_40f1e0, %block_40f18f
  %237 = phi i64 [ %236, %block_.L_40f1e0 ], [ %147, %block_40f18f ]
  %238 = phi i64 [ %194, %block_.L_40f1e0 ], [ %111, %block_40f18f ]
  %239 = add i64 %238, -36
  %240 = add i64 %237, 3
...
block_.L_40f1f6:                                  ; preds = %block_40f221, %block_40f1f1
  ...
  %call2_40f201 = tail call %struct.Memory* @sub_40c100._Z18complete_hash_funcIiET_S0_(%struct.State* nonnull %0, i64 %292, %struct.Memory* %MEMORY.0)
...
block_.L_40f22b:                                  ; preds = %block_.L_40f1e5, %block_.L_40f226
  ...
  %call2_40f22e = tail call %struct.Memory* @sub_40c130._Z9check_sumIiEvT_(%struct.State* nonnull %0, i64 %409, %struct.Memory* %MEMORY.0)
