...
entry:
  ...
  %call2_40f143 = tail call %struct.Memory* @sub_400dd0._Z11start_timerv(%struct.State* %0, i64 %58, %struct.Memory* %2)
...
block_.L_40f14f:                                  ; preds = %block_.L_40f1fb, %entry
  %68 = phi i64 [ %.pre, %entry ], [ %445, %block_.L_40f1fb ]
  %MEMORY.0 = phi %struct.Memory* [ %call2_40f143, %entry ], [ %call2_40f1fe, %block_.L_40f1fb ]
  ...
  br i1 %101, label %block_40f15f, label %block_.L_40f211
...
block_40f15f:                                     ; preds = %block_.L_40f14f
  ...
  br i1 %146, label %block_.L_40f1b5, label %block_40f17c
...
block_.L_40f181:                                  ; preds = %block_40f1ab, %block_40f17c
  %149 = phi i64 [ %148, %block_40f17c ], [ %235, %block_40f1ab ]
  %150 = phi i64 [ %111, %block_40f17c ], [ %195, %block_40f1ab ]
  %MEMORY.1 = phi %struct.Memory* [ %MEMORY.0, %block_40f17c ], [ %call2_40f18c, %block_40f1ab ]
  %151 = add i64 %150, -32
  ...
  %call2_40f18c = tail call %struct.Memory* @sub_40cbd0._ZN15loop_inner_bodyILi4EiE7do_workERiPKii(%struct.State* %0, i64 %161, %struct.Memory* %MEMORY.1)
  ...
  br i1 %233, label %block_40f1ab, label %block_.L_40f1b0
...
block_.L_40f1b5:                                  ; preds = %block_.L_40f1b0, %block_40f15f
  %237 = phi i64 [ %147, %block_40f15f ], [ %236, %block_.L_40f1b0 ]
  %238 = phi i64 [ %111, %block_40f15f ], [ %195, %block_.L_40f1b0 ]
  %MEMORY.2 = phi %struct.Memory* [ %MEMORY.0, %block_40f15f ], [ %call2_40f18c, %block_.L_40f1b0 ]
  %239 = add i64 %238, -36
  %240 = add i64 %237, 3
  ...
  br i1 %273, label %block_40f1c1, label %block_.L_40f1fb
...
block_.L_40f1c6:                                  ; preds = %block_40f1f1, %block_40f1c1
  %276 = phi i64 [ %275, %block_40f1c1 ], [ %400, %block_40f1f1 ]
  %277 = phi i64 [ %238, %block_40f1c1 ], [ %364, %block_40f1f1 ]
  %MEMORY.3 = phi %struct.Memory* [ %MEMORY.2, %block_40f1c1 ], [ %call2_40f1d1, %block_40f1f1 ]
  %278 = add i64 %277, -8
  %279 = add i64 %276, 4
  ...
  %call2_40f1d1 = tail call %struct.Memory* @sub_40c0d0._Z18complete_hash_funcIiET_S0_(%struct.State* %0, i64 %293, %struct.Memory* %MEMORY.3)
  ...
  br i1 %388, label %block_.L_40f1f6, label %block_40f1f1
...
block_.L_40f1fb:                                  ; preds = %block_.L_40f1b5, %block_.L_40f1f6
  %402 = phi i64 [ %274, %block_.L_40f1b5 ], [ %401, %block_.L_40f1f6 ]
  %403 = phi i64 [ %238, %block_.L_40f1b5 ], [ %364, %block_.L_40f1f6 ]
  %MEMORY.4 = phi %struct.Memory* [ %MEMORY.2, %block_.L_40f1b5 ], [ %call2_40f1d1, %block_.L_40f1f6 ]
  %404 = add i64 %403, -32
  %405 = add i64 %402, 3
  ...
  %call2_40f1fe = tail call %struct.Memory* @sub_40c100._Z9check_sumIiEvT_(%struct.State* %0, i64 %409, %struct.Memory* %MEMORY.4)
...
block_.L_40f211:                                  ; preds = %block_.L_40f14f
  ...
  %call2_40f211 = tail call %struct.Memory* @sub_400df0._Z5timerv(%struct.State* %0, i64 %446, %struct.Memory* %MEMORY.0)
  ...
  %call2_40f21a = tail call %struct.Memory* @sub_400790._Z13record_resultdPKc(%struct.State* %0, i64 %457, %struct.Memory* %call2_40f211)
  ...
  ret %struct.Memory* %call2_40f21a
}
...
define %struct.Memory* @routine_jge_.L_40f211(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i8* %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
...
define %struct.Memory* @routine_jl_.L_40f1b5(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i8* %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 2, i32 9
...
define %struct.Memory* @routine_jmpq_.L_40f181(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
...
define %struct.Memory* @routine_jge_.L_40f1b0(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i8* %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 2, i32 9
...
define %struct.Memory* @routine_jmpq_.L_40f1b5(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
...
define %struct.Memory* @routine_jge_.L_40f1fb(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i8* %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 2, i32 9
...
define %struct.Memory* @routine_jmpq_.L_40f1c6(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
...
define %struct.Memory* @routine_je_.L_40f1f6(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i8* %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
...
define %struct.Memory* @routine_jmpq_.L_40f1fb(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
...
define %struct.Memory* @routine_jmpq_.L_40f14f(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
