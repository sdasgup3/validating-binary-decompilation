...
entry:
  ...
  %call2_40f183 = tail call %struct.Memory* @sub_400e10._Z11start_timerv(%struct.State* %0, i64 %58, %struct.Memory* %2)
...
block_.L_40f18f:                                  ; preds = %block_.L_40f23b, %entry
  %68 = phi i64 [ %.pre, %entry ], [ %445, %block_.L_40f23b ]
  %MEMORY.0 = phi %struct.Memory* [ %call2_40f183, %entry ], [ %call2_40f23e, %block_.L_40f23b ]
  ...
  br i1 %101, label %block_40f19f, label %block_.L_40f251
...
block_40f19f:                                     ; preds = %block_.L_40f18f
  ...
  br i1 %146, label %block_.L_40f1f5, label %block_40f1bc
...
block_.L_40f1c1:                                  ; preds = %block_40f1eb, %block_40f1bc
  %149 = phi i64 [ %111, %block_40f1bc ], [ %194, %block_40f1eb ]
  %storemerge = phi i64 [ %148, %block_40f1bc ], [ %234, %block_40f1eb ]
  %150 = add i64 %149, -32
  ...
  %call2_40f1cc = tail call %struct.Memory* @sub_40cc10._ZN15loop_inner_bodyILi4EiE7do_workERiPKii(%struct.State* nonnull %0, i64 %160, %struct.Memory* %MEMORY.0)
  ...
  br i1 %232, label %block_40f1eb, label %block_.L_40f1f0
...
block_.L_40f1f5:                                  ; preds = %block_.L_40f1f0, %block_40f19f
  %237 = phi i64 [ %236, %block_.L_40f1f0 ], [ %147, %block_40f19f ]
  %238 = phi i64 [ %194, %block_.L_40f1f0 ], [ %111, %block_40f19f ]
  %239 = add i64 %238, -36
  %240 = add i64 %237, 3
  ...
  br i1 %273, label %block_40f201, label %block_.L_40f23b
...
block_.L_40f206:                                  ; preds = %block_40f231, %block_40f201
  %276 = phi i64 [ %238, %block_40f201 ], [ %363, %block_40f231 ]
  %storemerge5 = phi i64 [ %275, %block_40f201 ], [ %399, %block_40f231 ]
  %277 = add i64 %276, -8
  ...
  %call2_40f211 = tail call %struct.Memory* @sub_40c110._Z18complete_hash_funcIiET_S0_(%struct.State* nonnull %0, i64 %292, %struct.Memory* %MEMORY.0)
  ...
  br i1 %387, label %block_.L_40f236, label %block_40f231
...
block_.L_40f23b:                                  ; preds = %block_.L_40f1f5, %block_.L_40f236
  %402 = phi i64 [ %274, %block_.L_40f1f5 ], [ %401, %block_.L_40f236 ]
  %403 = phi i64 [ %238, %block_.L_40f1f5 ], [ %363, %block_.L_40f236 ]
  %404 = add i64 %403, -32
  %405 = add i64 %402, 3
  ...
  %call2_40f23e = tail call %struct.Memory* @sub_40c140._Z9check_sumIiEvT_(%struct.State* nonnull %0, i64 %409, %struct.Memory* %MEMORY.0)
...
block_.L_40f251:                                  ; preds = %block_.L_40f18f
  ...
  %call2_40f251 = tail call %struct.Memory* @sub_400e30._Z5timerv(%struct.State* nonnull %0, i64 %446, %struct.Memory* %MEMORY.0)
  ...
  %call2_40f25a = tail call %struct.Memory* @sub_4007d0._Z13record_resultdPKc(%struct.State* nonnull %0, i64 %457, %struct.Memory* %call2_40f251)
