...
entry:
  ...
  %call2_404433 = tail call %struct.Memory* @sub_400dd0._Z11start_timerv(%struct.State* %0, i64 %58, %struct.Memory* %2)
  ...
  br label %block_.L_40443f

block_.L_40443f:                                  ; preds = %block_.L_4044f2, %entry
  %79 = phi i64 [ %.pre, %entry ], [ %429, %block_.L_4044f2 ]
  %MEMORY.0 = phi %struct.Memory* [ %call2_404433, %entry ], [ %call2_4044f7, %block_.L_4044f2 ]
  ...
  br i1 %112, label %block_40444f, label %block_.L_40450a

block_40444f:                                     ; preds = %block_.L_40443f
  ...
  br i1 %159, label %block_.L_4044a6, label %block_40446d

block_40446d:                                     ; preds = %block_40444f
  %161 = add i64 %160, 5
  br label %block_.L_404472

block_.L_404472:                                  ; preds = %block_40449c, %block_40446d
  %162 = phi i64 [ %161, %block_40446d ], [ %248, %block_40449c ]
  %163 = phi i64 [ %124, %block_40446d ], [ %208, %block_40449c ]
  %MEMORY.1 = phi %struct.Memory* [ %MEMORY.0, %block_40446d ], [ %call2_40447d, %block_40449c ]
  %164 = add i64 %163, -40
  ...
  %call2_40447d = tail call %struct.Memory* @sub_401fb0._ZN15loop_inner_bodyILi5EdE7do_workERdPKdi(%struct.State* %0, i64 %174, %struct.Memory* %MEMORY.1)
  ...
  br i1 %246, label %block_40449c, label %block_.L_4044a1

block_40449c:                                     ; preds = %block_.L_404472
  %248 = add i64 %247, -42
  br label %block_.L_404472

block_.L_4044a1:                                  ; preds = %block_.L_404472
  %249 = add i64 %247, 5
  store i64 %249, i64* %3, align 8
  br label %block_.L_4044a6

block_.L_4044a6:                                  ; preds = %block_.L_4044a1, %block_40444f
  %250 = phi i64 [ %160, %block_40444f ], [ %249, %block_.L_4044a1 ]
  %251 = phi i64 [ %124, %block_40444f ], [ %208, %block_.L_4044a1 ]
  %MEMORY.2 = phi %struct.Memory* [ %MEMORY.0, %block_40444f ], [ %call2_40447d, %block_.L_4044a1 ]
  %252 = add i64 %251, -44
  %253 = add i64 %250, 3
  ...
  br i1 %286, label %block_4044b2, label %block_.L_4044f2

block_4044b2:                                     ; preds = %block_.L_4044a6
  %288 = add i64 %287, 5
  br label %block_.L_4044b7

block_.L_4044b7:                                  ; preds = %block_4044e8, %block_4044b2
  %289 = phi i64 [ %288, %block_4044b2 ], [ %385, %block_4044e8 ]
  %290 = phi i64 [ %251, %block_4044b2 ], [ %349, %block_4044e8 ]
  %MEMORY.3 = phi %struct.Memory* [ %MEMORY.2, %block_4044b2 ], [ %call2_4044c4, %block_4044e8 ]
  %291 = add i64 %290, -8
  %292 = add i64 %289, 4
  ...
  %call2_4044c4 = tail call %struct.Memory* @sub_401480._Z18complete_hash_funcIdET_S0_(%struct.State* %0, i64 %305, %struct.Memory* %MEMORY.3)
  ...
  br i1 %373, label %block_.L_4044ed, label %block_4044e8

block_4044e8:                                     ; preds = %block_.L_4044b7
  %385 = add i64 %384, -49
  br label %block_.L_4044b7

block_.L_4044ed:                                  ; preds = %block_.L_4044b7
  %386 = add i64 %384, 5
  store i64 %386, i64* %3, align 8
  br label %block_.L_4044f2

block_.L_4044f2:                                  ; preds = %block_.L_4044a6, %block_.L_4044ed
  %387 = phi i64 [ %287, %block_.L_4044a6 ], [ %386, %block_.L_4044ed ]
  %388 = phi i64 [ %251, %block_.L_4044a6 ], [ %349, %block_.L_4044ed ]
  %MEMORY.4 = phi %struct.Memory* [ %MEMORY.2, %block_.L_4044a6 ], [ %call2_4044c4, %block_.L_4044ed ]
  %389 = add i64 %388, -40
  %390 = add i64 %387, 5
  ...
  %call2_4044f7 = tail call %struct.Memory* @sub_4014b0._Z9check_sumIdEvT_(%struct.State* %0, i64 %393, %struct.Memory* %MEMORY.4)
...
block_.L_40450a:                                  ; preds = %block_.L_40443f
  %430 = add i64 %113, -14106
  %431 = add i64 %113, 5
  ...
  %call2_40450a = tail call %struct.Memory* @sub_400df0._Z5timerv(%struct.State* %0, i64 %430, %struct.Memory* %MEMORY.0)
  ...
  %call2_404513 = tail call %struct.Memory* @sub_400790._Z13record_resultdPKc(%struct.State* %0, i64 %441, %struct.Memory* %call2_40450a)
  ...
  ret %struct.Memory* %call2_404513
}
...
define %struct.Memory* @routine_jge_.L_40450a(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i8* %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
...
define %struct.Memory* @routine_jl_.L_4044a6(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i8* %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 2, i32 9
...
define %struct.Memory* @routine_jmpq_.L_404472(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
...
define %struct.Memory* @routine_jge_.L_4044a1(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i8* %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 2, i32 9
...
define %struct.Memory* @routine_jmpq_.L_4044a6(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
...
define %struct.Memory* @routine_jge_.L_4044f2(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i8* %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 2, i32 9
...
define %struct.Memory* @routine_jmpq_.L_4044b7(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
...
define %struct.Memory* @routine_je_.L_4044ed(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i8* %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
...
define %struct.Memory* @routine_jmpq_.L_4044f2(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
...
define %struct.Memory* @routine_jmpq_.L_40443f(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
