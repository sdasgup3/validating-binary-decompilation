...
block_.L_40443f:                                  ; preds = %block_.L_4044f2, %entry
  %79 = phi i64 [ %.pre, %entry ], [ %433, %block_.L_4044f2 ]
...
block_.L_4044b7:                                  ; preds = %block_4044e8, %block_4044b2
  %289 = phi i64 [ %288, %block_4044b2 ], [ %387, %block_4044e8 ]
  %290 = phi i64 [ %251, %block_4044b2 ], [ %351, %block_4044e8 ]
  ...
  %call2_4044c4 = tail call %struct.Memory* @sub_401480._Z18complete_hash_funcIdET_S0_(%struct.State* %0, i64 %306, %struct.Memory* %MEMORY.3)
  ...
  br i1 %375, label %block_.L_4044ed, label %block_4044e8
...
block_.L_4044f2:                                  ; preds = %block_.L_4044a6, %block_.L_4044ed
  %389 = phi i64 [ %287, %block_.L_4044a6 ], [ %388, %block_.L_4044ed ]
  %390 = phi i64 [ %251, %block_.L_4044a6 ], [ %351, %block_.L_4044ed ]
  ...
  %call2_4044f7 = tail call %struct.Memory* @sub_4014b0._Z9check_sumIdEvT_(%struct.State* %0, i64 %396, %struct.Memory* %MEMORY.4)
...
block_.L_40450a:                                  ; preds = %block_.L_40443f
  ...
  %call2_40450a = tail call %struct.Memory* @sub_400df0._Z5timerv(%struct.State* %0, i64 %434, %struct.Memory* %MEMORY.0)
  ...
  %call2_404513 = tail call %struct.Memory* @sub_400790._Z13record_resultdPKc(%struct.State* %0, i64 %445, %struct.Memory* %call2_40450a)
