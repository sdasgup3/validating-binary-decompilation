...
block_.L_40efff:                                  ; preds = %block_.L_40f0ab, %entry
  %68 = phi i64 [ %.pre, %entry ], [ %445, %block_.L_40f0ab ]
...
block_.L_40f076:                                  ; preds = %block_40f0a1, %block_40f071
  %276 = phi i64 [ %275, %block_40f071 ], [ %400, %block_40f0a1 ]
  %277 = phi i64 [ %238, %block_40f071 ], [ %364, %block_40f0a1 ]
  ...
  br i1 %388, label %block_.L_40f0a6, label %block_40f0a1
...
block_.L_40f0ab:                                  ; preds = %block_.L_40f065, %block_.L_40f0a6
  %402 = phi i64 [ %274, %block_.L_40f065 ], [ %401, %block_.L_40f0a6 ]
  %403 = phi i64 [ %238, %block_.L_40f065 ], [ %364, %block_.L_40f0a6 ]
  ...
  %call2_40f0ae = tail call %struct.Memory* @sub_40c100._Z9check_sumIiEvT_(%struct.State* %0, i64 %409, %struct.Memory* %MEMORY.4)
...
block_.L_40f0c1:                                  ; preds = %block_.L_40efff
  ...
  %call2_40f0c1 = tail call %struct.Memory* @sub_400df0._Z5timerv(%struct.State* %0, i64 %446, %struct.Memory* %MEMORY.0)
  ...
  %call2_40f0ca = tail call %struct.Memory* @sub_400790._Z13record_resultdPKc(%struct.State* %0, i64 %457, %struct.Memory* %call2_40f0c1)
