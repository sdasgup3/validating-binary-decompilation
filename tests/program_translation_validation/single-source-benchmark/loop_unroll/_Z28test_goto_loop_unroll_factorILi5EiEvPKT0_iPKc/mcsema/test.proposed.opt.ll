...
block_.L_40f061:                                  ; preds = %block_40f08b, %block_40f05c
  ...
  %MEMORY.1 = phi %struct.Memory* [ %MEMORY.0, %block_40f05c ], [ %call2_40f06c, %block_40f08b ]
  %150 = add i64 %149, -32
  ...
  %call2_40f06c = tail call %struct.Memory* @sub_40cba0._ZN15loop_inner_bodyILi5EiE7do_workERiPKii(%struct.State* nonnull %0, i64 %160, %struct.Memory* %MEMORY.1)
...
block_.L_40f095:                                  ; preds = %block_.L_40f090, %block_40f03f
  %237 = phi i64 [ %147, %block_40f03f ], [ %236, %block_.L_40f090 ]
  %238 = phi i64 [ %111, %block_40f03f ], [ %194, %block_.L_40f090 ]
  %MEMORY.2 = phi %struct.Memory* [ %MEMORY.0, %block_40f03f ], [ %call2_40f06c, %block_.L_40f090 ]
  %239 = add i64 %238, -36
  %240 = add i64 %237, 3
...
block_.L_40f0a6:                                  ; preds = %block_40f0d1, %block_40f0a1
  ...
  %MEMORY.3 = phi %struct.Memory* [ %MEMORY.2, %block_40f0a1 ], [ %call2_40f0b1, %block_40f0d1 ]
  %277 = add i64 %276, -8
  ...
  %call2_40f0b1 = tail call %struct.Memory* @sub_40c100._Z18complete_hash_funcIiET_S0_(%struct.State* nonnull %0, i64 %292, %struct.Memory* %MEMORY.3)
...
block_.L_40f0db:                                  ; preds = %block_.L_40f095, %block_.L_40f0d6
  ...
  %MEMORY.4 = phi %struct.Memory* [ %MEMORY.2, %block_.L_40f095 ], [ %call2_40f0b1, %block_.L_40f0d6 ]
  %404 = add i64 %403, -32
  %405 = add i64 %402, 3
  ...
  %call2_40f0de = tail call %struct.Memory* @sub_40c130._Z9check_sumIiEvT_(%struct.State* nonnull %0, i64 %409, %struct.Memory* %MEMORY.4)
