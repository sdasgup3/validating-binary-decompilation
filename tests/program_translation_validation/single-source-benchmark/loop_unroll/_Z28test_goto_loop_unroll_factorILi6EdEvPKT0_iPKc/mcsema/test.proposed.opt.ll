...
block_.L_404352:                                  ; preds = %block_40437c, %block_40434d
  ...
  %call2_40435d = tail call %struct.Memory* @sub_401f80._ZN15loop_inner_bodyILi6EdE7do_workERdPKdi(%struct.State* nonnull %0, i64 %167, %struct.Memory* %MEMORY.0)
...
block_.L_404386:                                  ; preds = %block_.L_404381, %block_40432f
  %244 = phi i64 [ %243, %block_.L_404381 ], [ %154, %block_40432f ]
  %245 = phi i64 [ %201, %block_.L_404381 ], [ %118, %block_40432f ]
  %246 = add i64 %245, -44
  %247 = add i64 %244, 3
...
block_.L_404397:                                  ; preds = %block_4043c8, %block_404392
  ...
  %call2_4043a4 = tail call %struct.Memory* @sub_4014b0._Z18complete_hash_funcIdET_S0_(%struct.State* nonnull %0, i64 %298, %struct.Memory* %MEMORY.0)
...
block_.L_4043d2:                                  ; preds = %block_.L_404386, %block_.L_4043cd
  ...
  %call2_4043d7 = tail call %struct.Memory* @sub_4014e0._Z9check_sumIdEvT_(%struct.State* nonnull %0, i64 %388, %struct.Memory* %MEMORY.0)
