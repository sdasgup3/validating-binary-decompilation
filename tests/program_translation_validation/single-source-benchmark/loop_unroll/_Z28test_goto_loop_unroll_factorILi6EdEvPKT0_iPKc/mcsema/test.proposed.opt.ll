...
entry:
  ...
  %call2_4042e3 = tail call %struct.Memory* @sub_400dd0._Z11start_timerv(%struct.State* %0, i64 %58, %struct.Memory* %2)
...
block_.L_4042ef:                                  ; preds = %block_.L_4043a2, %entry
  %79 = phi i64 [ %.pre, %entry ], [ %429, %block_.L_4043a2 ]
  %MEMORY.0 = phi %struct.Memory* [ %call2_4042e3, %entry ], [ %call2_4043a7, %block_.L_4043a2 ]
  ...
  br i1 %112, label %block_4042ff, label %block_.L_4043ba
...
block_4042ff:                                     ; preds = %block_.L_4042ef
  ...
  br i1 %159, label %block_.L_404356, label %block_40431d
...
block_.L_404322:                                  ; preds = %block_40434c, %block_40431d
  %162 = phi i64 [ %161, %block_40431d ], [ %248, %block_40434c ]
  %163 = phi i64 [ %124, %block_40431d ], [ %208, %block_40434c ]
  %MEMORY.1 = phi %struct.Memory* [ %MEMORY.0, %block_40431d ], [ %call2_40432d, %block_40434c ]
  %164 = add i64 %163, -40
  ...
  %call2_40432d = tail call %struct.Memory* @sub_401f50._ZN15loop_inner_bodyILi6EdE7do_workERdPKdi(%struct.State* %0, i64 %174, %struct.Memory* %MEMORY.1)
  ...
  br i1 %246, label %block_40434c, label %block_.L_404351
...
block_.L_404356:                                  ; preds = %block_.L_404351, %block_4042ff
  %250 = phi i64 [ %160, %block_4042ff ], [ %249, %block_.L_404351 ]
  %251 = phi i64 [ %124, %block_4042ff ], [ %208, %block_.L_404351 ]
  %MEMORY.2 = phi %struct.Memory* [ %MEMORY.0, %block_4042ff ], [ %call2_40432d, %block_.L_404351 ]
  %252 = add i64 %251, -44
  %253 = add i64 %250, 3
  ...
  br i1 %286, label %block_404362, label %block_.L_4043a2
...
block_.L_404367:                                  ; preds = %block_404398, %block_404362
  %289 = phi i64 [ %288, %block_404362 ], [ %385, %block_404398 ]
  %290 = phi i64 [ %251, %block_404362 ], [ %349, %block_404398 ]
  %MEMORY.3 = phi %struct.Memory* [ %MEMORY.2, %block_404362 ], [ %call2_404374, %block_404398 ]
  %291 = add i64 %290, -8
  %292 = add i64 %289, 4
  ...
  %call2_404374 = tail call %struct.Memory* @sub_401480._Z18complete_hash_funcIdET_S0_(%struct.State* %0, i64 %305, %struct.Memory* %MEMORY.3)
  ...
  br i1 %373, label %block_.L_40439d, label %block_404398
...
block_.L_4043a2:                                  ; preds = %block_.L_404356, %block_.L_40439d
  %387 = phi i64 [ %287, %block_.L_404356 ], [ %386, %block_.L_40439d ]
  %388 = phi i64 [ %251, %block_.L_404356 ], [ %349, %block_.L_40439d ]
  %MEMORY.4 = phi %struct.Memory* [ %MEMORY.2, %block_.L_404356 ], [ %call2_404374, %block_.L_40439d ]
  %389 = add i64 %388, -40
  %390 = add i64 %387, 5
  ...
  %call2_4043a7 = tail call %struct.Memory* @sub_4014b0._Z9check_sumIdEvT_(%struct.State* %0, i64 %393, %struct.Memory* %MEMORY.4)
...
block_.L_4043ba:                                  ; preds = %block_.L_4042ef
  ...
  %call2_4043ba = tail call %struct.Memory* @sub_400df0._Z5timerv(%struct.State* %0, i64 %430, %struct.Memory* %MEMORY.0)
  ...
  %call2_4043c3 = tail call %struct.Memory* @sub_400790._Z13record_resultdPKc(%struct.State* %0, i64 %441, %struct.Memory* %call2_4043ba)
  ...
  ret %struct.Memory* %call2_4043c3
}
...
define %struct.Memory* @routine_jge_.L_4043ba(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i8* %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
...
define %struct.Memory* @routine_jl_.L_404356(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i8* %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 2, i32 9
...
define %struct.Memory* @routine_jmpq_.L_404322(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
...
define %struct.Memory* @routine_jge_.L_404351(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i8* %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 2, i32 9
...
define %struct.Memory* @routine_jmpq_.L_404356(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
...
define %struct.Memory* @routine_jge_.L_4043a2(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i8* %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 2, i32 9
...
define %struct.Memory* @routine_jmpq_.L_404367(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
...
define %struct.Memory* @routine_je_.L_40439d(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i8* %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
...
define %struct.Memory* @routine_jmpq_.L_4043a2(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
...
define %struct.Memory* @routine_jmpq_.L_4042ef(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
