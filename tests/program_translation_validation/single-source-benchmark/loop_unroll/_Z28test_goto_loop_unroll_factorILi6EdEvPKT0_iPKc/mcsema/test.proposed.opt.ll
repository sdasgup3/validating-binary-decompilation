...
entry:
  ...
  %call2_404323 = tail call %struct.Memory* @sub_400e10._Z11start_timerv(%struct.State* %0, i64 %58, %struct.Memory* %2)
...
block_.L_40432f:                                  ; preds = %block_.L_4043e2, %entry
  %74 = phi i64 [ %.pre, %entry ], [ %424, %block_.L_4043e2 ]
  %MEMORY.0 = phi %struct.Memory* [ %call2_404323, %entry ], [ %call2_4043e7, %block_.L_4043e2 ]
  ...
  br i1 %107, label %block_40433f, label %block_.L_4043fa
...
block_40433f:                                     ; preds = %block_.L_40432f
  ...
  br i1 %153, label %block_.L_404396, label %block_40435d
...
block_.L_404362:                                  ; preds = %block_40438c, %block_40435d
  %156 = phi i64 [ %118, %block_40435d ], [ %201, %block_40438c ]
  %storemerge = phi i64 [ %155, %block_40435d ], [ %241, %block_40438c ]
  %157 = add i64 %156, -40
  ...
  %call2_40436d = tail call %struct.Memory* @sub_401f90._ZN15loop_inner_bodyILi6EdE7do_workERdPKdi(%struct.State* nonnull %0, i64 %167, %struct.Memory* %MEMORY.0)
  ...
  br i1 %239, label %block_40438c, label %block_.L_404391
...
block_.L_404396:                                  ; preds = %block_.L_404391, %block_40433f
  %244 = phi i64 [ %243, %block_.L_404391 ], [ %154, %block_40433f ]
  %245 = phi i64 [ %201, %block_.L_404391 ], [ %118, %block_40433f ]
  %246 = add i64 %245, -44
  %247 = add i64 %244, 3
  ...
  br i1 %280, label %block_4043a2, label %block_.L_4043e2
...
block_.L_4043a7:                                  ; preds = %block_4043d8, %block_4043a2
  %283 = phi i64 [ %245, %block_4043a2 ], [ %343, %block_4043d8 ]
  %storemerge5 = phi i64 [ %282, %block_4043a2 ], [ %379, %block_4043d8 ]
  %284 = add i64 %283, -8
  ...
  %call2_4043b4 = tail call %struct.Memory* @sub_4014c0._Z18complete_hash_funcIdET_S0_(%struct.State* nonnull %0, i64 %298, %struct.Memory* %MEMORY.0)
  ...
  br i1 %367, label %block_.L_4043dd, label %block_4043d8
...
block_.L_4043e2:                                  ; preds = %block_.L_404396, %block_.L_4043dd
  %382 = phi i64 [ %281, %block_.L_404396 ], [ %381, %block_.L_4043dd ]
  %383 = phi i64 [ %245, %block_.L_404396 ], [ %343, %block_.L_4043dd ]
  %384 = add i64 %383, -40
  %385 = add i64 %382, 5
  ...
  %call2_4043e7 = tail call %struct.Memory* @sub_4014f0._Z9check_sumIdEvT_(%struct.State* nonnull %0, i64 %388, %struct.Memory* %MEMORY.0)
...
block_.L_4043fa:                                  ; preds = %block_.L_40432f
  ...
  %call2_4043fa = tail call %struct.Memory* @sub_400e30._Z5timerv(%struct.State* nonnull %0, i64 %425, %struct.Memory* %MEMORY.0)
  ...
  %call2_404403 = tail call %struct.Memory* @sub_4007d0._Z13record_resultdPKc(%struct.State* nonnull %0, i64 %436, %struct.Memory* %call2_4043fa)
