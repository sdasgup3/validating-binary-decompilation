...
define %struct.Memory* @_Z28test_goto_loop_unroll_factorILi6EdEvPKT0_iPKc(%struct.State* noalias, i64, %struct.Memory* noalias) local_unnamed_addr #1 {
entry:
  ...
  %call2_404313 = tail call %struct.Memory* @sub_400e00._Z11start_timerv(%struct.State* %0, i64 %58, %struct.Memory* %2)
...
block_.L_40431f:                                  ; preds = %block_.L_4043d2, %entry
  %74 = phi i64 [ %.pre, %entry ], [ %424, %block_.L_4043d2 ]
  %MEMORY.0 = phi %struct.Memory* [ %call2_404313, %entry ], [ %call2_4043d7, %block_.L_4043d2 ]
  ...
  br i1 %107, label %block_40432f, label %block_.L_4043ea
...
block_40432f:                                     ; preds = %block_.L_40431f
  ...
  br i1 %153, label %block_.L_404386, label %block_40434d
...
block_.L_404352:                                  ; preds = %block_40437c, %block_40434d
  %156 = phi i64 [ %118, %block_40434d ], [ %201, %block_40437c ]
  %storemerge = phi i64 [ %155, %block_40434d ], [ %241, %block_40437c ]
  %MEMORY.1 = phi %struct.Memory* [ %MEMORY.0, %block_40434d ], [ %call2_40435d, %block_40437c ]
  %157 = add i64 %156, -40
  ...
  %call2_40435d = tail call %struct.Memory* @sub_401f80._ZN15loop_inner_bodyILi6EdE7do_workERdPKdi(%struct.State* nonnull %0, i64 %167, %struct.Memory* %MEMORY.1)
  ...
  br i1 %239, label %block_40437c, label %block_.L_404381
...
block_.L_404386:                                  ; preds = %block_.L_404381, %block_40432f
  %244 = phi i64 [ %154, %block_40432f ], [ %243, %block_.L_404381 ]
  %245 = phi i64 [ %118, %block_40432f ], [ %201, %block_.L_404381 ]
  %MEMORY.2 = phi %struct.Memory* [ %MEMORY.0, %block_40432f ], [ %call2_40435d, %block_.L_404381 ]
  %246 = add i64 %245, -44
  %247 = add i64 %244, 3
  ...
  br i1 %280, label %block_404392, label %block_.L_4043d2
...
block_.L_404397:                                  ; preds = %block_4043c8, %block_404392
  %283 = phi i64 [ %245, %block_404392 ], [ %343, %block_4043c8 ]
  %storemerge5 = phi i64 [ %282, %block_404392 ], [ %379, %block_4043c8 ]
  %MEMORY.3 = phi %struct.Memory* [ %MEMORY.2, %block_404392 ], [ %call2_4043a4, %block_4043c8 ]
  %284 = add i64 %283, -8
  ...
  %call2_4043a4 = tail call %struct.Memory* @sub_4014b0._Z18complete_hash_funcIdET_S0_(%struct.State* nonnull %0, i64 %298, %struct.Memory* %MEMORY.3)
  ...
  br i1 %367, label %block_.L_4043cd, label %block_4043c8
...
block_.L_4043d2:                                  ; preds = %block_.L_404386, %block_.L_4043cd
  %382 = phi i64 [ %281, %block_.L_404386 ], [ %381, %block_.L_4043cd ]
  %383 = phi i64 [ %245, %block_.L_404386 ], [ %343, %block_.L_4043cd ]
  %MEMORY.4 = phi %struct.Memory* [ %MEMORY.2, %block_.L_404386 ], [ %call2_4043a4, %block_.L_4043cd ]
  %384 = add i64 %383, -40
  %385 = add i64 %382, 5
  ...
  %call2_4043d7 = tail call %struct.Memory* @sub_4014e0._Z9check_sumIdEvT_(%struct.State* nonnull %0, i64 %388, %struct.Memory* %MEMORY.4)
...
block_.L_4043ea:                                  ; preds = %block_.L_40431f
  ...
  %call2_4043ea = tail call %struct.Memory* @sub_400e20._Z5timerv(%struct.State* nonnull %0, i64 %425, %struct.Memory* %MEMORY.0)
  ...
  %call2_4043f3 = tail call %struct.Memory* @sub_4007c0._Z13record_resultdPKc(%struct.State* nonnull %0, i64 %436, %struct.Memory* %call2_4043ea)
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_jge_.L_4043ea(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i8* nocapture %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_jl_.L_404386(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i8* nocapture %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 2, i32 9
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_jmpq_.L_404352(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_jge_.L_404381(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i8* nocapture %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 2, i32 9
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_jmpq_.L_404386(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_jge_.L_4043d2(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i8* nocapture %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 2, i32 9
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_jmpq_.L_404397(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_je_.L_4043cd(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i8* nocapture %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
