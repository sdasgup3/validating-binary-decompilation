...
define %struct.Memory* @_Z28test_goto_loop_unroll_factorILi6EiEvPKT0_iPKc(%struct.State* noalias, i64, %struct.Memory* noalias readnone) local_unnamed_addr #1 {
entry:
...
block_.L_40ef11:                                  ; preds = %block_40ef3b, %block_40ef0c
  ...
  %call2_40ef1c = tail call %struct.Memory* @sub_40cb40._ZN15loop_inner_bodyILi6EiE7do_workERiPKii(%struct.State* nonnull %0, i64 %160, %struct.Memory* %MEMORY.0)
...
block_.L_40ef45:                                  ; preds = %block_.L_40ef40, %block_40eeef
  %237 = phi i64 [ %236, %block_.L_40ef40 ], [ %147, %block_40eeef ]
  %238 = phi i64 [ %194, %block_.L_40ef40 ], [ %111, %block_40eeef ]
  %239 = add i64 %238, -36
  %240 = add i64 %237, 3
...
block_.L_40ef56:                                  ; preds = %block_40ef81, %block_40ef51
  ...
  %call2_40ef61 = tail call %struct.Memory* @sub_40c100._Z18complete_hash_funcIiET_S0_(%struct.State* nonnull %0, i64 %292, %struct.Memory* %MEMORY.0)
...
block_.L_40ef8b:                                  ; preds = %block_.L_40ef45, %block_.L_40ef86
  ...
  %call2_40ef8e = tail call %struct.Memory* @sub_40c130._Z9check_sumIiEvT_(%struct.State* nonnull %0, i64 %409, %struct.Memory* %MEMORY.0)
