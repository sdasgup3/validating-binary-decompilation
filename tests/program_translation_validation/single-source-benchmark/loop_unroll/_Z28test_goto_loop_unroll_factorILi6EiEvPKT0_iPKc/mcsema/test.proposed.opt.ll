...
entry:
  ...
  %call2_40eee3 = tail call %struct.Memory* @sub_400e10._Z11start_timerv(%struct.State* %0, i64 %58, %struct.Memory* %2)
...
block_.L_40eeef:                                  ; preds = %block_.L_40ef9b, %entry
  %68 = phi i64 [ %.pre, %entry ], [ %445, %block_.L_40ef9b ]
  %MEMORY.0 = phi %struct.Memory* [ %call2_40eee3, %entry ], [ %call2_40ef9e, %block_.L_40ef9b ]
  ...
  br i1 %101, label %block_40eeff, label %block_.L_40efb1
...
block_40eeff:                                     ; preds = %block_.L_40eeef
  ...
  br i1 %146, label %block_.L_40ef55, label %block_40ef1c
...
block_.L_40ef21:                                  ; preds = %block_40ef4b, %block_40ef1c
  %149 = phi i64 [ %111, %block_40ef1c ], [ %194, %block_40ef4b ]
  %storemerge = phi i64 [ %148, %block_40ef1c ], [ %234, %block_40ef4b ]
  %150 = add i64 %149, -32
  ...
  %call2_40ef2c = tail call %struct.Memory* @sub_40cb50._ZN15loop_inner_bodyILi6EiE7do_workERiPKii(%struct.State* nonnull %0, i64 %160, %struct.Memory* %MEMORY.0)
  ...
  br i1 %232, label %block_40ef4b, label %block_.L_40ef50
...
block_.L_40ef55:                                  ; preds = %block_.L_40ef50, %block_40eeff
  %237 = phi i64 [ %236, %block_.L_40ef50 ], [ %147, %block_40eeff ]
  %238 = phi i64 [ %194, %block_.L_40ef50 ], [ %111, %block_40eeff ]
  %239 = add i64 %238, -36
  %240 = add i64 %237, 3
  ...
  br i1 %273, label %block_40ef61, label %block_.L_40ef9b
...
block_.L_40ef66:                                  ; preds = %block_40ef91, %block_40ef61
  %276 = phi i64 [ %238, %block_40ef61 ], [ %363, %block_40ef91 ]
  %storemerge5 = phi i64 [ %275, %block_40ef61 ], [ %399, %block_40ef91 ]
  %277 = add i64 %276, -8
  ...
  %call2_40ef71 = tail call %struct.Memory* @sub_40c110._Z18complete_hash_funcIiET_S0_(%struct.State* nonnull %0, i64 %292, %struct.Memory* %MEMORY.0)
  ...
  br i1 %387, label %block_.L_40ef96, label %block_40ef91
...
block_.L_40ef9b:                                  ; preds = %block_.L_40ef55, %block_.L_40ef96
  %402 = phi i64 [ %274, %block_.L_40ef55 ], [ %401, %block_.L_40ef96 ]
  %403 = phi i64 [ %238, %block_.L_40ef55 ], [ %363, %block_.L_40ef96 ]
  %404 = add i64 %403, -32
  %405 = add i64 %402, 3
  ...
  %call2_40ef9e = tail call %struct.Memory* @sub_40c140._Z9check_sumIiEvT_(%struct.State* nonnull %0, i64 %409, %struct.Memory* %MEMORY.0)
...
block_.L_40efb1:                                  ; preds = %block_.L_40eeef
  ...
  %call2_40efb1 = tail call %struct.Memory* @sub_400e30._Z5timerv(%struct.State* nonnull %0, i64 %446, %struct.Memory* %MEMORY.0)
  ...
  %call2_40efba = tail call %struct.Memory* @sub_4007d0._Z13record_resultdPKc(%struct.State* nonnull %0, i64 %457, %struct.Memory* %call2_40efb1)
