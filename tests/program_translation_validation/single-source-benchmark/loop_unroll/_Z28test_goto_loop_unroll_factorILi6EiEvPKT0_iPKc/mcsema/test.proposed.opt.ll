...
block_.L_40eeaf:                                  ; preds = %block_.L_40ef5b, %entry
  %68 = phi i64 [ %.pre, %entry ], [ %445, %block_.L_40ef5b ]
...
block_.L_40ef26:                                  ; preds = %block_40ef51, %block_40ef21
  %276 = phi i64 [ %275, %block_40ef21 ], [ %400, %block_40ef51 ]
  %277 = phi i64 [ %238, %block_40ef21 ], [ %364, %block_40ef51 ]
  ...
  br i1 %388, label %block_.L_40ef56, label %block_40ef51
...
block_.L_40ef5b:                                  ; preds = %block_.L_40ef15, %block_.L_40ef56
  %402 = phi i64 [ %274, %block_.L_40ef15 ], [ %401, %block_.L_40ef56 ]
  %403 = phi i64 [ %238, %block_.L_40ef15 ], [ %364, %block_.L_40ef56 ]
  ...
  %call2_40ef5e = tail call %struct.Memory* @sub_40c100._Z9check_sumIiEvT_(%struct.State* %0, i64 %409, %struct.Memory* %MEMORY.4)
...
block_.L_40ef71:                                  ; preds = %block_.L_40eeaf
  ...
  %call2_40ef71 = tail call %struct.Memory* @sub_400df0._Z5timerv(%struct.State* %0, i64 %446, %struct.Memory* %MEMORY.0)
  ...
  %call2_40ef7a = tail call %struct.Memory* @sub_400790._Z13record_resultdPKc(%struct.State* %0, i64 %457, %struct.Memory* %call2_40ef71)
