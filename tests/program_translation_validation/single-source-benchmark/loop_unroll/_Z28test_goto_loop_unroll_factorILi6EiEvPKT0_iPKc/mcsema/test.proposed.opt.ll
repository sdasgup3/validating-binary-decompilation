...
entry:
  ...
  %call2_40eea3 = tail call %struct.Memory* @sub_400dd0._Z11start_timerv(%struct.State* %0, i64 %58, %struct.Memory* %2)
...
block_.L_40eeaf:                                  ; preds = %block_.L_40ef5b, %entry
  %68 = phi i64 [ %.pre, %entry ], [ %447, %block_.L_40ef5b ]
  %MEMORY.0 = phi %struct.Memory* [ %call2_40eea3, %entry ], [ %call2_40ef5e, %block_.L_40ef5b ]
  ...
  br i1 %101, label %block_40eebf, label %block_.L_40ef71
...
block_40eebf:                                     ; preds = %block_.L_40eeaf
  ...
  br i1 %146, label %block_.L_40ef15, label %block_40eedc
...
block_.L_40eee1:                                  ; preds = %block_40ef0b, %block_40eedc
  %149 = phi i64 [ %148, %block_40eedc ], [ %235, %block_40ef0b ]
  %150 = phi i64 [ %111, %block_40eedc ], [ %195, %block_40ef0b ]
  %MEMORY.1 = phi %struct.Memory* [ %MEMORY.0, %block_40eedc ], [ %call2_40eeec, %block_40ef0b ]
  %151 = add i64 %150, -32
  ...
  %call2_40eeec = tail call %struct.Memory* @sub_40cb10._ZN15loop_inner_bodyILi6EiE7do_workERiPKii(%struct.State* %0, i64 %161, %struct.Memory* %MEMORY.1)
  ...
  br i1 %233, label %block_40ef0b, label %block_.L_40ef10
...
block_.L_40ef15:                                  ; preds = %block_.L_40ef10, %block_40eebf
  %237 = phi i64 [ %147, %block_40eebf ], [ %236, %block_.L_40ef10 ]
  %238 = phi i64 [ %111, %block_40eebf ], [ %195, %block_.L_40ef10 ]
  %MEMORY.2 = phi %struct.Memory* [ %MEMORY.0, %block_40eebf ], [ %call2_40eeec, %block_.L_40ef10 ]
  %239 = add i64 %238, -36
  %240 = add i64 %237, 3
  ...
  br i1 %273, label %block_40ef21, label %block_.L_40ef5b
...
block_.L_40ef26:                                  ; preds = %block_40ef51, %block_40ef21
  %276 = phi i64 [ %275, %block_40ef21 ], [ %401, %block_40ef51 ]
  %277 = phi i64 [ %238, %block_40ef21 ], [ %365, %block_40ef51 ]
  %MEMORY.3 = phi %struct.Memory* [ %MEMORY.2, %block_40ef21 ], [ %call2_40ef31, %block_40ef51 ]
  %278 = add i64 %277, -8
  %279 = add i64 %276, 4
  ...
  %call2_40ef31 = tail call %struct.Memory* @sub_40c0d0._Z18complete_hash_funcIiET_S0_(%struct.State* %0, i64 %293, %struct.Memory* %MEMORY.3)
  ...
  br i1 %389, label %block_.L_40ef56, label %block_40ef51
...
block_.L_40ef5b:                                  ; preds = %block_.L_40ef15, %block_.L_40ef56
  %403 = phi i64 [ %274, %block_.L_40ef15 ], [ %402, %block_.L_40ef56 ]
  %404 = phi i64 [ %238, %block_.L_40ef15 ], [ %365, %block_.L_40ef56 ]
  %MEMORY.4 = phi %struct.Memory* [ %MEMORY.2, %block_.L_40ef15 ], [ %call2_40ef31, %block_.L_40ef56 ]
  %405 = add i64 %404, -32
  %406 = add i64 %403, 3
  ...
  %call2_40ef5e = tail call %struct.Memory* @sub_40c100._Z9check_sumIiEvT_(%struct.State* %0, i64 %410, %struct.Memory* %MEMORY.4)
...
block_.L_40ef71:                                  ; preds = %block_.L_40eeaf
  ...
  %call2_40ef71 = tail call %struct.Memory* @sub_400df0._Z5timerv(%struct.State* %0, i64 %448, %struct.Memory* %MEMORY.0)
  ...
  %call2_40ef7a = tail call %struct.Memory* @sub_400790._Z13record_resultdPKc(%struct.State* %0, i64 %459, %struct.Memory* %call2_40ef71)
  ...
  ret %struct.Memory* %call2_40ef7a
}
...
define %struct.Memory* @routine_jge_.L_40ef71(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i8* %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
...
define %struct.Memory* @routine_jl_.L_40ef15(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i8* %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 2, i32 9
...
define %struct.Memory* @routine_jmpq_.L_40eee1(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
...
define %struct.Memory* @routine_subl__0x5___eax(%struct.State* dereferenceable(3376), i64, %struct.Memory*) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %RAX = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 1, i32 0, i32 0
  %3 = load i64, i64* %RAX, align 8
...
define %struct.Memory* @routine_jge_.L_40ef10(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i8* %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 2, i32 9
...
define %struct.Memory* @routine_jmpq_.L_40ef15(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
...
define %struct.Memory* @routine_jge_.L_40ef5b(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i8* %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 2, i32 9
...
define %struct.Memory* @routine_jmpq_.L_40ef26(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
...
define %struct.Memory* @routine_je_.L_40ef56(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i8* %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
...
define %struct.Memory* @routine_jmpq_.L_40ef5b(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
...
define %struct.Memory* @routine_jmpq_.L_40eeaf(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
