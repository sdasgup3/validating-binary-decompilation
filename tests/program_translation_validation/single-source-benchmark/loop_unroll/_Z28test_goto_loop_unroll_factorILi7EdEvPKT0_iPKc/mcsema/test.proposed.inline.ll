...
declare %struct.Memory* @sub_401f20._ZN15loop_inner_bodyILi7EdE7do_workERdPKdi(%struct.State* dereferenceable(3376), i64, %struct.Memory*)
...
define %struct.Memory* @_Z28test_goto_loop_unroll_factorILi7EdEvPKT0_iPKc(%struct.State* noalias, i64, %struct.Memory* noalias) #1 {
entry:
