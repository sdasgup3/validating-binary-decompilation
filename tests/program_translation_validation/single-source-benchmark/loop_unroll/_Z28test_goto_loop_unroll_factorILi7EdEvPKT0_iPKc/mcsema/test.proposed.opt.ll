...
entry:
  ...
  %call2_404193 = tail call %struct.Memory* @sub_400dd0._Z11start_timerv(%struct.State* %0, i64 %58, %struct.Memory* %2)
...
block_.L_40419f:                                  ; preds = %block_.L_404252, %entry
  %79 = phi i64 [ %.pre, %entry ], [ %433, %block_.L_404252 ]
  %MEMORY.0 = phi %struct.Memory* [ %call2_404193, %entry ], [ %call2_404257, %block_.L_404252 ]
  ...
  br i1 %112, label %block_4041af, label %block_.L_40426a
...
block_4041af:                                     ; preds = %block_.L_40419f
  ...
  br i1 %159, label %block_.L_404206, label %block_4041cd
...
block_.L_4041d2:                                  ; preds = %block_4041fc, %block_4041cd
  %162 = phi i64 [ %161, %block_4041cd ], [ %248, %block_4041fc ]
  %163 = phi i64 [ %124, %block_4041cd ], [ %208, %block_4041fc ]
  %MEMORY.1 = phi %struct.Memory* [ %MEMORY.0, %block_4041cd ], [ %call2_4041dd, %block_4041fc ]
  %164 = add i64 %163, -40
  ...
  %call2_4041dd = tail call %struct.Memory* @sub_401ef0._ZN15loop_inner_bodyILi7EdE7do_workERdPKdi(%struct.State* %0, i64 %174, %struct.Memory* %MEMORY.1)
  ...
  br i1 %246, label %block_4041fc, label %block_.L_404201
...
block_.L_404206:                                  ; preds = %block_.L_404201, %block_4041af
  %250 = phi i64 [ %160, %block_4041af ], [ %249, %block_.L_404201 ]
  %251 = phi i64 [ %124, %block_4041af ], [ %208, %block_.L_404201 ]
  %MEMORY.2 = phi %struct.Memory* [ %MEMORY.0, %block_4041af ], [ %call2_4041dd, %block_.L_404201 ]
  %252 = add i64 %251, -44
  %253 = add i64 %250, 3
  ...
  br i1 %286, label %block_404212, label %block_.L_404252
...
block_.L_404217:                                  ; preds = %block_404248, %block_404212
  %289 = phi i64 [ %288, %block_404212 ], [ %387, %block_404248 ]
  %290 = phi i64 [ %251, %block_404212 ], [ %351, %block_404248 ]
  %MEMORY.3 = phi %struct.Memory* [ %MEMORY.2, %block_404212 ], [ %call2_404224, %block_404248 ]
  %291 = add i64 %290, -8
  %292 = add i64 %289, 4
  ...
  %call2_404224 = tail call %struct.Memory* @sub_401480._Z18complete_hash_funcIdET_S0_(%struct.State* %0, i64 %306, %struct.Memory* %MEMORY.3)
  ...
  br i1 %375, label %block_.L_40424d, label %block_404248
...
block_.L_404252:                                  ; preds = %block_.L_404206, %block_.L_40424d
  %389 = phi i64 [ %287, %block_.L_404206 ], [ %388, %block_.L_40424d ]
  %390 = phi i64 [ %251, %block_.L_404206 ], [ %351, %block_.L_40424d ]
  %MEMORY.4 = phi %struct.Memory* [ %MEMORY.2, %block_.L_404206 ], [ %call2_404224, %block_.L_40424d ]
  %391 = add i64 %390, -40
  %392 = add i64 %389, 5
  ...
  %call2_404257 = tail call %struct.Memory* @sub_4014b0._Z9check_sumIdEvT_(%struct.State* %0, i64 %396, %struct.Memory* %MEMORY.4)
...
block_.L_40426a:                                  ; preds = %block_.L_40419f
  ...
  %call2_40426a = tail call %struct.Memory* @sub_400df0._Z5timerv(%struct.State* %0, i64 %434, %struct.Memory* %MEMORY.0)
  ...
  %call2_404273 = tail call %struct.Memory* @sub_400790._Z13record_resultdPKc(%struct.State* %0, i64 %445, %struct.Memory* %call2_40426a)
  ...
  ret %struct.Memory* %call2_404273
}
...
define %struct.Memory* @routine_jge_.L_40426a(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i8* %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
...
define %struct.Memory* @routine_jl_.L_404206(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i8* %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 2, i32 9
...
define %struct.Memory* @routine_jmpq_.L_4041d2(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
...
define %struct.Memory* @routine_jge_.L_404201(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i8* %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 2, i32 9
...
define %struct.Memory* @routine_jmpq_.L_404206(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
...
define %struct.Memory* @routine_jge_.L_404252(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i8* %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 2, i32 9
...
define %struct.Memory* @routine_jmpq_.L_404217(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
...
define %struct.Memory* @routine_je_.L_40424d(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i8* %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
...
define %struct.Memory* @routine_jmpq_.L_404252(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
...
define %struct.Memory* @routine_jmpq_.L_40419f(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
