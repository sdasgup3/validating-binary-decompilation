...
entry:
  ...
  %call2_4041d3 = tail call %struct.Memory* @sub_400e10._Z11start_timerv(%struct.State* %0, i64 %58, %struct.Memory* %2)
...
block_.L_4041df:                                  ; preds = %block_.L_404292, %entry
  %74 = phi i64 [ %.pre, %entry ], [ %424, %block_.L_404292 ]
  %MEMORY.0 = phi %struct.Memory* [ %call2_4041d3, %entry ], [ %call2_404297, %block_.L_404292 ]
  ...
  br i1 %107, label %block_4041ef, label %block_.L_4042aa
...
block_4041ef:                                     ; preds = %block_.L_4041df
  ...
  br i1 %153, label %block_.L_404246, label %block_40420d
...
block_.L_404212:                                  ; preds = %block_40423c, %block_40420d
  %156 = phi i64 [ %118, %block_40420d ], [ %201, %block_40423c ]
  %storemerge = phi i64 [ %155, %block_40420d ], [ %241, %block_40423c ]
  %157 = add i64 %156, -40
  ...
  %call2_40421d = tail call %struct.Memory* @sub_401f30._ZN15loop_inner_bodyILi7EdE7do_workERdPKdi(%struct.State* nonnull %0, i64 %167, %struct.Memory* %MEMORY.0)
  ...
  br i1 %239, label %block_40423c, label %block_.L_404241
...
block_.L_404246:                                  ; preds = %block_.L_404241, %block_4041ef
  %244 = phi i64 [ %243, %block_.L_404241 ], [ %154, %block_4041ef ]
  %245 = phi i64 [ %201, %block_.L_404241 ], [ %118, %block_4041ef ]
  %246 = add i64 %245, -44
  %247 = add i64 %244, 3
  ...
  br i1 %280, label %block_404252, label %block_.L_404292
...
block_.L_404257:                                  ; preds = %block_404288, %block_404252
  %283 = phi i64 [ %245, %block_404252 ], [ %343, %block_404288 ]
  %storemerge5 = phi i64 [ %282, %block_404252 ], [ %379, %block_404288 ]
  %284 = add i64 %283, -8
  ...
  %call2_404264 = tail call %struct.Memory* @sub_4014c0._Z18complete_hash_funcIdET_S0_(%struct.State* nonnull %0, i64 %298, %struct.Memory* %MEMORY.0)
  ...
  br i1 %367, label %block_.L_40428d, label %block_404288
...
block_.L_404292:                                  ; preds = %block_.L_404246, %block_.L_40428d
  %382 = phi i64 [ %281, %block_.L_404246 ], [ %381, %block_.L_40428d ]
  %383 = phi i64 [ %245, %block_.L_404246 ], [ %343, %block_.L_40428d ]
  %384 = add i64 %383, -40
  %385 = add i64 %382, 5
  ...
  %call2_404297 = tail call %struct.Memory* @sub_4014f0._Z9check_sumIdEvT_(%struct.State* nonnull %0, i64 %388, %struct.Memory* %MEMORY.0)
...
block_.L_4042aa:                                  ; preds = %block_.L_4041df
  ...
  %call2_4042aa = tail call %struct.Memory* @sub_400e30._Z5timerv(%struct.State* nonnull %0, i64 %425, %struct.Memory* %MEMORY.0)
  ...
  %call2_4042b3 = tail call %struct.Memory* @sub_4007d0._Z13record_resultdPKc(%struct.State* nonnull %0, i64 %436, %struct.Memory* %call2_4042aa)
