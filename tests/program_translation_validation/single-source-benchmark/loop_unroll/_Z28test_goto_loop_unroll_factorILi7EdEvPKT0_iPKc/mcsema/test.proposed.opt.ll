...
block_.L_40419f:                                  ; preds = %block_.L_404252, %entry
  %79 = phi i64 [ %.pre, %entry ], [ %429, %block_.L_404252 ]
...
block_.L_404217:                                  ; preds = %block_404248, %block_404212
  %289 = phi i64 [ %288, %block_404212 ], [ %385, %block_404248 ]
  %290 = phi i64 [ %251, %block_404212 ], [ %349, %block_404248 ]
  ...
  %call2_404224 = tail call %struct.Memory* @sub_401480._Z18complete_hash_funcIdET_S0_(%struct.State* %0, i64 %305, %struct.Memory* %MEMORY.3)
  ...
  br i1 %373, label %block_.L_40424d, label %block_404248
...
block_.L_404252:                                  ; preds = %block_.L_404206, %block_.L_40424d
  %387 = phi i64 [ %287, %block_.L_404206 ], [ %386, %block_.L_40424d ]
  %388 = phi i64 [ %251, %block_.L_404206 ], [ %349, %block_.L_40424d ]
  ...
  %call2_404257 = tail call %struct.Memory* @sub_4014b0._Z9check_sumIdEvT_(%struct.State* %0, i64 %393, %struct.Memory* %MEMORY.4)
...
block_.L_40426a:                                  ; preds = %block_.L_40419f
  ...
  %call2_40426a = tail call %struct.Memory* @sub_400df0._Z5timerv(%struct.State* %0, i64 %430, %struct.Memory* %MEMORY.0)
  ...
  %call2_404273 = tail call %struct.Memory* @sub_400790._Z13record_resultdPKc(%struct.State* %0, i64 %441, %struct.Memory* %call2_40426a)
