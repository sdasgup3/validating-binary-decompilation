...
block_.L_404202:                                  ; preds = %block_40422c, %block_4041fd
  ...
  %call2_40420d = tail call %struct.Memory* @sub_401f20._ZN15loop_inner_bodyILi7EdE7do_workERdPKdi(%struct.State* nonnull %0, i64 %167, %struct.Memory* %MEMORY.0)
...
block_.L_404236:                                  ; preds = %block_.L_404231, %block_4041df
  %244 = phi i64 [ %243, %block_.L_404231 ], [ %154, %block_4041df ]
  %245 = phi i64 [ %201, %block_.L_404231 ], [ %118, %block_4041df ]
  %246 = add i64 %245, -44
  %247 = add i64 %244, 3
...
block_.L_404247:                                  ; preds = %block_404278, %block_404242
  ...
  %call2_404254 = tail call %struct.Memory* @sub_4014b0._Z18complete_hash_funcIdET_S0_(%struct.State* nonnull %0, i64 %298, %struct.Memory* %MEMORY.0)
...
block_.L_404282:                                  ; preds = %block_.L_404236, %block_.L_40427d
  ...
  %call2_404287 = tail call %struct.Memory* @sub_4014e0._Z9check_sumIdEvT_(%struct.State* nonnull %0, i64 %388, %struct.Memory* %MEMORY.0)
