...
entry:
  ...
  %call2_40ed93 = tail call %struct.Memory* @sub_400e10._Z11start_timerv(%struct.State* %0, i64 %58, %struct.Memory* %2)
...
block_.L_40ed9f:                                  ; preds = %block_.L_40ee4b, %entry
  %68 = phi i64 [ %.pre, %entry ], [ %445, %block_.L_40ee4b ]
  %MEMORY.0 = phi %struct.Memory* [ %call2_40ed93, %entry ], [ %call2_40ee4e, %block_.L_40ee4b ]
  ...
  br i1 %101, label %block_40edaf, label %block_.L_40ee61
...
block_40edaf:                                     ; preds = %block_.L_40ed9f
  ...
  br i1 %146, label %block_.L_40ee05, label %block_40edcc
...
block_.L_40edd1:                                  ; preds = %block_40edfb, %block_40edcc
  %149 = phi i64 [ %111, %block_40edcc ], [ %194, %block_40edfb ]
  %storemerge = phi i64 [ %148, %block_40edcc ], [ %234, %block_40edfb ]
  %150 = add i64 %149, -32
  ...
  %call2_40eddc = tail call %struct.Memory* @sub_40caf0._ZN15loop_inner_bodyILi7EiE7do_workERiPKii(%struct.State* nonnull %0, i64 %160, %struct.Memory* %MEMORY.0)
  ...
  br i1 %232, label %block_40edfb, label %block_.L_40ee00
...
block_.L_40ee05:                                  ; preds = %block_.L_40ee00, %block_40edaf
  %237 = phi i64 [ %236, %block_.L_40ee00 ], [ %147, %block_40edaf ]
  %238 = phi i64 [ %194, %block_.L_40ee00 ], [ %111, %block_40edaf ]
  %239 = add i64 %238, -36
  %240 = add i64 %237, 3
  ...
  br i1 %273, label %block_40ee11, label %block_.L_40ee4b
...
block_.L_40ee16:                                  ; preds = %block_40ee41, %block_40ee11
  %276 = phi i64 [ %238, %block_40ee11 ], [ %363, %block_40ee41 ]
  %storemerge5 = phi i64 [ %275, %block_40ee11 ], [ %399, %block_40ee41 ]
  %277 = add i64 %276, -8
  ...
  %call2_40ee21 = tail call %struct.Memory* @sub_40c110._Z18complete_hash_funcIiET_S0_(%struct.State* nonnull %0, i64 %292, %struct.Memory* %MEMORY.0)
  ...
  br i1 %387, label %block_.L_40ee46, label %block_40ee41
...
block_.L_40ee4b:                                  ; preds = %block_.L_40ee05, %block_.L_40ee46
  %402 = phi i64 [ %274, %block_.L_40ee05 ], [ %401, %block_.L_40ee46 ]
  %403 = phi i64 [ %238, %block_.L_40ee05 ], [ %363, %block_.L_40ee46 ]
  %404 = add i64 %403, -32
  %405 = add i64 %402, 3
  ...
  %call2_40ee4e = tail call %struct.Memory* @sub_40c140._Z9check_sumIiEvT_(%struct.State* nonnull %0, i64 %409, %struct.Memory* %MEMORY.0)
...
block_.L_40ee61:                                  ; preds = %block_.L_40ed9f
  ...
  %call2_40ee61 = tail call %struct.Memory* @sub_400e30._Z5timerv(%struct.State* nonnull %0, i64 %446, %struct.Memory* %MEMORY.0)
  ...
  %call2_40ee6a = tail call %struct.Memory* @sub_4007d0._Z13record_resultdPKc(%struct.State* nonnull %0, i64 %457, %struct.Memory* %call2_40ee61)
