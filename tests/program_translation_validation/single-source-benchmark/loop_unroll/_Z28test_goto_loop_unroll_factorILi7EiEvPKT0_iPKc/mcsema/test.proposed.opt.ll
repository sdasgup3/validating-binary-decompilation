...
block_.L_40ed5f:                                  ; preds = %block_.L_40ee0b, %entry
  %68 = phi i64 [ %.pre, %entry ], [ %445, %block_.L_40ee0b ]
...
block_.L_40edd6:                                  ; preds = %block_40ee01, %block_40edd1
  %276 = phi i64 [ %275, %block_40edd1 ], [ %400, %block_40ee01 ]
  %277 = phi i64 [ %238, %block_40edd1 ], [ %364, %block_40ee01 ]
  ...
  br i1 %388, label %block_.L_40ee06, label %block_40ee01
...
block_.L_40ee0b:                                  ; preds = %block_.L_40edc5, %block_.L_40ee06
  %402 = phi i64 [ %274, %block_.L_40edc5 ], [ %401, %block_.L_40ee06 ]
  %403 = phi i64 [ %238, %block_.L_40edc5 ], [ %364, %block_.L_40ee06 ]
  ...
  %call2_40ee0e = tail call %struct.Memory* @sub_40c100._Z9check_sumIiEvT_(%struct.State* %0, i64 %409, %struct.Memory* %MEMORY.4)
...
block_.L_40ee21:                                  ; preds = %block_.L_40ed5f
  ...
  %call2_40ee21 = tail call %struct.Memory* @sub_400df0._Z5timerv(%struct.State* %0, i64 %446, %struct.Memory* %MEMORY.0)
  ...
  %call2_40ee2a = tail call %struct.Memory* @sub_400790._Z13record_resultdPKc(%struct.State* %0, i64 %457, %struct.Memory* %call2_40ee21)
