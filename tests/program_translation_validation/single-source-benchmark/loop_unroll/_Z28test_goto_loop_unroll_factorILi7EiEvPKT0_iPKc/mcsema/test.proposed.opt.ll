...
define %struct.Memory* @_Z28test_goto_loop_unroll_factorILi7EiEvPKT0_iPKc(%struct.State* noalias, i64, %struct.Memory* noalias readnone) local_unnamed_addr #1 {
entry:
...
block_.L_40edc1:                                  ; preds = %block_40edeb, %block_40edbc
  ...
  %call2_40edcc = tail call %struct.Memory* @sub_40cae0._ZN15loop_inner_bodyILi7EiE7do_workERiPKii(%struct.State* nonnull %0, i64 %160, %struct.Memory* %MEMORY.0)
...
block_.L_40edf5:                                  ; preds = %block_.L_40edf0, %block_40ed9f
  %237 = phi i64 [ %236, %block_.L_40edf0 ], [ %147, %block_40ed9f ]
  %238 = phi i64 [ %194, %block_.L_40edf0 ], [ %111, %block_40ed9f ]
  %239 = add i64 %238, -36
  %240 = add i64 %237, 3
...
block_.L_40ee06:                                  ; preds = %block_40ee31, %block_40ee01
  ...
  %call2_40ee11 = tail call %struct.Memory* @sub_40c100._Z18complete_hash_funcIiET_S0_(%struct.State* nonnull %0, i64 %292, %struct.Memory* %MEMORY.0)
...
block_.L_40ee3b:                                  ; preds = %block_.L_40edf5, %block_.L_40ee36
  ...
  %call2_40ee3e = tail call %struct.Memory* @sub_40c130._Z9check_sumIiEvT_(%struct.State* nonnull %0, i64 %409, %struct.Memory* %MEMORY.0)
