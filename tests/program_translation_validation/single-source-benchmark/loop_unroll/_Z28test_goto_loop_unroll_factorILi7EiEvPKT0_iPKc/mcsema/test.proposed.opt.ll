...
define %struct.Memory* @_Z28test_goto_loop_unroll_factorILi7EiEvPKT0_iPKc(%struct.State* noalias, i64, %struct.Memory* noalias) local_unnamed_addr #1 {
entry:
  ...
  %call2_40ed83 = tail call %struct.Memory* @sub_400e00._Z11start_timerv(%struct.State* %0, i64 %58, %struct.Memory* %2)
...
block_.L_40ed8f:                                  ; preds = %block_.L_40ee3b, %entry
  %68 = phi i64 [ %.pre, %entry ], [ %445, %block_.L_40ee3b ]
  %MEMORY.0 = phi %struct.Memory* [ %call2_40ed83, %entry ], [ %call2_40ee3e, %block_.L_40ee3b ]
  ...
  br i1 %101, label %block_40ed9f, label %block_.L_40ee51
...
block_40ed9f:                                     ; preds = %block_.L_40ed8f
  ...
  br i1 %146, label %block_.L_40edf5, label %block_40edbc
...
block_.L_40edc1:                                  ; preds = %block_40edeb, %block_40edbc
  %149 = phi i64 [ %111, %block_40edbc ], [ %194, %block_40edeb ]
  %storemerge = phi i64 [ %148, %block_40edbc ], [ %234, %block_40edeb ]
  %MEMORY.1 = phi %struct.Memory* [ %MEMORY.0, %block_40edbc ], [ %call2_40edcc, %block_40edeb ]
  %150 = add i64 %149, -32
  ...
  %call2_40edcc = tail call %struct.Memory* @sub_40cae0._ZN15loop_inner_bodyILi7EiE7do_workERiPKii(%struct.State* nonnull %0, i64 %160, %struct.Memory* %MEMORY.1)
  ...
  br i1 %232, label %block_40edeb, label %block_.L_40edf0
...
block_.L_40edf5:                                  ; preds = %block_.L_40edf0, %block_40ed9f
  %237 = phi i64 [ %147, %block_40ed9f ], [ %236, %block_.L_40edf0 ]
  %238 = phi i64 [ %111, %block_40ed9f ], [ %194, %block_.L_40edf0 ]
  %MEMORY.2 = phi %struct.Memory* [ %MEMORY.0, %block_40ed9f ], [ %call2_40edcc, %block_.L_40edf0 ]
  %239 = add i64 %238, -36
  %240 = add i64 %237, 3
  ...
  br i1 %273, label %block_40ee01, label %block_.L_40ee3b
...
block_.L_40ee06:                                  ; preds = %block_40ee31, %block_40ee01
  %276 = phi i64 [ %238, %block_40ee01 ], [ %363, %block_40ee31 ]
  %storemerge5 = phi i64 [ %275, %block_40ee01 ], [ %399, %block_40ee31 ]
  %MEMORY.3 = phi %struct.Memory* [ %MEMORY.2, %block_40ee01 ], [ %call2_40ee11, %block_40ee31 ]
  %277 = add i64 %276, -8
  ...
  %call2_40ee11 = tail call %struct.Memory* @sub_40c100._Z18complete_hash_funcIiET_S0_(%struct.State* nonnull %0, i64 %292, %struct.Memory* %MEMORY.3)
  ...
  br i1 %387, label %block_.L_40ee36, label %block_40ee31
...
block_.L_40ee3b:                                  ; preds = %block_.L_40edf5, %block_.L_40ee36
  %402 = phi i64 [ %274, %block_.L_40edf5 ], [ %401, %block_.L_40ee36 ]
  %403 = phi i64 [ %238, %block_.L_40edf5 ], [ %363, %block_.L_40ee36 ]
  %MEMORY.4 = phi %struct.Memory* [ %MEMORY.2, %block_.L_40edf5 ], [ %call2_40ee11, %block_.L_40ee36 ]
  %404 = add i64 %403, -32
  %405 = add i64 %402, 3
  ...
  %call2_40ee3e = tail call %struct.Memory* @sub_40c130._Z9check_sumIiEvT_(%struct.State* nonnull %0, i64 %409, %struct.Memory* %MEMORY.4)
...
block_.L_40ee51:                                  ; preds = %block_.L_40ed8f
  ...
  %call2_40ee51 = tail call %struct.Memory* @sub_400e20._Z5timerv(%struct.State* nonnull %0, i64 %446, %struct.Memory* %MEMORY.0)
  ...
  %call2_40ee5a = tail call %struct.Memory* @sub_4007c0._Z13record_resultdPKc(%struct.State* nonnull %0, i64 %457, %struct.Memory* %call2_40ee51)
  ...
  ret %struct.Memory* %call2_40ee5a
}
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_jge_.L_40ee51(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i8* nocapture %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_jl_.L_40edf5(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i8* nocapture %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 2, i32 9
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_jmpq_.L_40edc1(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_jge_.L_40edf0(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i8* nocapture %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 2, i32 9
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_jmpq_.L_40edf5(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_jge_.L_40ee3b(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i8* nocapture %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 2, i32 9
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_jmpq_.L_40ee06(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_je_.L_40ee36(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i8* nocapture %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_jmpq_.L_40ee3b(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_jmpq_.L_40ed8f(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
