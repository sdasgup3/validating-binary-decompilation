...
entry:
  ...
  %call2_40ed53 = tail call %struct.Memory* @sub_400dd0._Z11start_timerv(%struct.State* %0, i64 %58, %struct.Memory* %2)
...
block_.L_40ed5f:                                  ; preds = %block_.L_40ee0b, %entry
  %68 = phi i64 [ %.pre, %entry ], [ %447, %block_.L_40ee0b ]
  %MEMORY.0 = phi %struct.Memory* [ %call2_40ed53, %entry ], [ %call2_40ee0e, %block_.L_40ee0b ]
  ...
  br i1 %101, label %block_40ed6f, label %block_.L_40ee21
...
block_40ed6f:                                     ; preds = %block_.L_40ed5f
  ...
  br i1 %146, label %block_.L_40edc5, label %block_40ed8c
...
block_.L_40ed91:                                  ; preds = %block_40edbb, %block_40ed8c
  %149 = phi i64 [ %148, %block_40ed8c ], [ %235, %block_40edbb ]
  %150 = phi i64 [ %111, %block_40ed8c ], [ %195, %block_40edbb ]
  %MEMORY.1 = phi %struct.Memory* [ %MEMORY.0, %block_40ed8c ], [ %call2_40ed9c, %block_40edbb ]
  %151 = add i64 %150, -32
  ...
  %call2_40ed9c = tail call %struct.Memory* @sub_40cab0._ZN15loop_inner_bodyILi7EiE7do_workERiPKii(%struct.State* %0, i64 %161, %struct.Memory* %MEMORY.1)
  ...
  br i1 %233, label %block_40edbb, label %block_.L_40edc0
...
block_.L_40edc5:                                  ; preds = %block_.L_40edc0, %block_40ed6f
  %237 = phi i64 [ %147, %block_40ed6f ], [ %236, %block_.L_40edc0 ]
  %238 = phi i64 [ %111, %block_40ed6f ], [ %195, %block_.L_40edc0 ]
  %MEMORY.2 = phi %struct.Memory* [ %MEMORY.0, %block_40ed6f ], [ %call2_40ed9c, %block_.L_40edc0 ]
  %239 = add i64 %238, -36
  %240 = add i64 %237, 3
  ...
  br i1 %273, label %block_40edd1, label %block_.L_40ee0b
...
block_.L_40edd6:                                  ; preds = %block_40ee01, %block_40edd1
  %276 = phi i64 [ %275, %block_40edd1 ], [ %401, %block_40ee01 ]
  %277 = phi i64 [ %238, %block_40edd1 ], [ %365, %block_40ee01 ]
  %MEMORY.3 = phi %struct.Memory* [ %MEMORY.2, %block_40edd1 ], [ %call2_40ede1, %block_40ee01 ]
  %278 = add i64 %277, -8
  %279 = add i64 %276, 4
  ...
  %call2_40ede1 = tail call %struct.Memory* @sub_40c0d0._Z18complete_hash_funcIiET_S0_(%struct.State* %0, i64 %293, %struct.Memory* %MEMORY.3)
  ...
  br i1 %389, label %block_.L_40ee06, label %block_40ee01
...
block_.L_40ee0b:                                  ; preds = %block_.L_40edc5, %block_.L_40ee06
  %403 = phi i64 [ %274, %block_.L_40edc5 ], [ %402, %block_.L_40ee06 ]
  %404 = phi i64 [ %238, %block_.L_40edc5 ], [ %365, %block_.L_40ee06 ]
  %MEMORY.4 = phi %struct.Memory* [ %MEMORY.2, %block_.L_40edc5 ], [ %call2_40ede1, %block_.L_40ee06 ]
  %405 = add i64 %404, -32
  %406 = add i64 %403, 3
  ...
  %call2_40ee0e = tail call %struct.Memory* @sub_40c100._Z9check_sumIiEvT_(%struct.State* %0, i64 %410, %struct.Memory* %MEMORY.4)
...
block_.L_40ee21:                                  ; preds = %block_.L_40ed5f
  ...
  %call2_40ee21 = tail call %struct.Memory* @sub_400df0._Z5timerv(%struct.State* %0, i64 %448, %struct.Memory* %MEMORY.0)
  ...
  %call2_40ee2a = tail call %struct.Memory* @sub_400790._Z13record_resultdPKc(%struct.State* %0, i64 %459, %struct.Memory* %call2_40ee21)
  ...
  ret %struct.Memory* %call2_40ee2a
}
...
define %struct.Memory* @routine_jge_.L_40ee21(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i8* %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
...
define %struct.Memory* @routine_jl_.L_40edc5(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i8* %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 2, i32 9
...
define %struct.Memory* @routine_jmpq_.L_40ed91(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
...
define %struct.Memory* @routine_jge_.L_40edc0(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i8* %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 2, i32 9
...
define %struct.Memory* @routine_jmpq_.L_40edc5(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
...
define %struct.Memory* @routine_jge_.L_40ee0b(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i8* %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 2, i32 9
...
define %struct.Memory* @routine_jmpq_.L_40edd6(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
...
define %struct.Memory* @routine_je_.L_40ee06(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i8* %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
...
define %struct.Memory* @routine_jmpq_.L_40ee0b(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
...
define %struct.Memory* @routine_jmpq_.L_40ed5f(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
