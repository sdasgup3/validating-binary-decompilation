...
block_.L_40404f:                                  ; preds = %block_.L_404102, %entry
  %79 = phi i64 [ %.pre, %entry ], [ %433, %block_.L_404102 ]
...
block_.L_4040c7:                                  ; preds = %block_4040f8, %block_4040c2
  %289 = phi i64 [ %288, %block_4040c2 ], [ %387, %block_4040f8 ]
  %290 = phi i64 [ %251, %block_4040c2 ], [ %351, %block_4040f8 ]
  ...
  %call2_4040d4 = tail call %struct.Memory* @sub_401480._Z18complete_hash_funcIdET_S0_(%struct.State* %0, i64 %306, %struct.Memory* %MEMORY.3)
  ...
  br i1 %375, label %block_.L_4040fd, label %block_4040f8
...
block_.L_404102:                                  ; preds = %block_.L_4040b6, %block_.L_4040fd
  %389 = phi i64 [ %287, %block_.L_4040b6 ], [ %388, %block_.L_4040fd ]
  %390 = phi i64 [ %251, %block_.L_4040b6 ], [ %351, %block_.L_4040fd ]
  ...
  %call2_404107 = tail call %struct.Memory* @sub_4014b0._Z9check_sumIdEvT_(%struct.State* %0, i64 %396, %struct.Memory* %MEMORY.4)
...
block_.L_40411a:                                  ; preds = %block_.L_40404f
  ...
  %call2_40411a = tail call %struct.Memory* @sub_400df0._Z5timerv(%struct.State* %0, i64 %434, %struct.Memory* %MEMORY.0)
  ...
  %call2_404123 = tail call %struct.Memory* @sub_400790._Z13record_resultdPKc(%struct.State* %0, i64 %445, %struct.Memory* %call2_40411a)
