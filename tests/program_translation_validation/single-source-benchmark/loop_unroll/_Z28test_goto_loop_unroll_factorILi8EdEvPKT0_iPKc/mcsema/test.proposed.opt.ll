...
define %struct.Memory* @_Z28test_goto_loop_unroll_factorILi8EdEvPKT0_iPKc(%struct.State* noalias, i64, %struct.Memory* noalias) local_unnamed_addr #1 {
entry:
  ...
  %call2_404073 = tail call %struct.Memory* @sub_400e00._Z11start_timerv(%struct.State* %0, i64 %58, %struct.Memory* %2)
...
block_.L_40407f:                                  ; preds = %block_.L_404132, %entry
  %74 = phi i64 [ %.pre, %entry ], [ %424, %block_.L_404132 ]
  %MEMORY.0 = phi %struct.Memory* [ %call2_404073, %entry ], [ %call2_404137, %block_.L_404132 ]
  ...
  br i1 %107, label %block_40408f, label %block_.L_40414a

block_40408f:                                     ; preds = %block_.L_40407f
  ...
  br i1 %153, label %block_.L_4040e6, label %block_4040ad

block_4040ad:                                     ; preds = %block_40408f
  %155 = add i64 %154, 5
  br label %block_.L_4040b2

block_.L_4040b2:                                  ; preds = %block_4040dc, %block_4040ad
  %156 = phi i64 [ %118, %block_4040ad ], [ %201, %block_4040dc ]
  %storemerge = phi i64 [ %155, %block_4040ad ], [ %241, %block_4040dc ]
  %MEMORY.1 = phi %struct.Memory* [ %MEMORY.0, %block_4040ad ], [ %call2_4040bd, %block_4040dc ]
  %157 = add i64 %156, -40
  ...
  %call2_4040bd = tail call %struct.Memory* @sub_401ec0._ZN15loop_inner_bodyILi8EdE7do_workERdPKdi(%struct.State* nonnull %0, i64 %167, %struct.Memory* %MEMORY.1)
  ...
  br i1 %239, label %block_4040dc, label %block_.L_4040e1

block_4040dc:                                     ; preds = %block_.L_4040b2
  %241 = add i64 %240, -42
  %242 = add i64 %240, 5
  store i64 %242, i64* %3, align 8
  br label %block_.L_4040b2

block_.L_4040e1:                                  ; preds = %block_.L_4040b2
  %243 = add i64 %240, 5
  store i64 %243, i64* %3, align 8
  br label %block_.L_4040e6

block_.L_4040e6:                                  ; preds = %block_.L_4040e1, %block_40408f
  %244 = phi i64 [ %154, %block_40408f ], [ %243, %block_.L_4040e1 ]
  %245 = phi i64 [ %118, %block_40408f ], [ %201, %block_.L_4040e1 ]
  %MEMORY.2 = phi %struct.Memory* [ %MEMORY.0, %block_40408f ], [ %call2_4040bd, %block_.L_4040e1 ]
  %246 = add i64 %245, -44
  %247 = add i64 %244, 3
  ...
  br i1 %280, label %block_4040f2, label %block_.L_404132

block_4040f2:                                     ; preds = %block_.L_4040e6
  %282 = add i64 %281, 5
  br label %block_.L_4040f7

block_.L_4040f7:                                  ; preds = %block_404128, %block_4040f2
  %283 = phi i64 [ %245, %block_4040f2 ], [ %343, %block_404128 ]
  %storemerge5 = phi i64 [ %282, %block_4040f2 ], [ %379, %block_404128 ]
  %MEMORY.3 = phi %struct.Memory* [ %MEMORY.2, %block_4040f2 ], [ %call2_404104, %block_404128 ]
  %284 = add i64 %283, -8
  ...
  %call2_404104 = tail call %struct.Memory* @sub_4014b0._Z18complete_hash_funcIdET_S0_(%struct.State* nonnull %0, i64 %298, %struct.Memory* %MEMORY.3)
  ...
  br i1 %367, label %block_.L_40412d, label %block_404128

block_404128:                                     ; preds = %block_.L_4040f7
  %379 = add i64 %378, -49
  %380 = add i64 %378, 5
  store i64 %380, i64* %3, align 8
  br label %block_.L_4040f7

block_.L_40412d:                                  ; preds = %block_.L_4040f7
  %381 = add i64 %378, 5
  store i64 %381, i64* %3, align 8
  br label %block_.L_404132

block_.L_404132:                                  ; preds = %block_.L_4040e6, %block_.L_40412d
  %382 = phi i64 [ %281, %block_.L_4040e6 ], [ %381, %block_.L_40412d ]
  %383 = phi i64 [ %245, %block_.L_4040e6 ], [ %343, %block_.L_40412d ]
  %MEMORY.4 = phi %struct.Memory* [ %MEMORY.2, %block_.L_4040e6 ], [ %call2_404104, %block_.L_40412d ]
  %384 = add i64 %383, -40
  %385 = add i64 %382, 5
  ...
  %call2_404137 = tail call %struct.Memory* @sub_4014e0._Z9check_sumIdEvT_(%struct.State* nonnull %0, i64 %388, %struct.Memory* %MEMORY.4)
...
block_.L_40414a:                                  ; preds = %block_.L_40407f
  %425 = add i64 %108, -13098
  %426 = add i64 %108, 5
  ...
  %call2_40414a = tail call %struct.Memory* @sub_400e20._Z5timerv(%struct.State* nonnull %0, i64 %425, %struct.Memory* %MEMORY.0)
  ...
  %call2_404153 = tail call %struct.Memory* @sub_4007c0._Z13record_resultdPKc(%struct.State* nonnull %0, i64 %436, %struct.Memory* %call2_40414a)
  ...
  ret %struct.Memory* %call2_404153
}
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_jge_.L_40414a(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i8* nocapture %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_jl_.L_4040e6(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i8* nocapture %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 2, i32 9
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_jmpq_.L_4040b2(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_jge_.L_4040e1(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i8* nocapture %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 2, i32 9
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_jmpq_.L_4040e6(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_jge_.L_404132(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i8* nocapture %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 2, i32 9
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_jmpq_.L_4040f7(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_je_.L_40412d(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i8* nocapture %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_jmpq_.L_404132(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_jmpq_.L_40407f(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
