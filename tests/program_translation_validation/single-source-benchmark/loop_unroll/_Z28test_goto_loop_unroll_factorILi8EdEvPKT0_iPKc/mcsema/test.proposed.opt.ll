...
block_.L_4040b2:                                  ; preds = %block_4040dc, %block_4040ad
  ...
  %call2_4040bd = tail call %struct.Memory* @sub_401ec0._ZN15loop_inner_bodyILi8EdE7do_workERdPKdi(%struct.State* nonnull %0, i64 %167, %struct.Memory* %MEMORY.0)
...
block_.L_4040e6:                                  ; preds = %block_.L_4040e1, %block_40408f
  %244 = phi i64 [ %243, %block_.L_4040e1 ], [ %154, %block_40408f ]
  %245 = phi i64 [ %201, %block_.L_4040e1 ], [ %118, %block_40408f ]
  %246 = add i64 %245, -44
  %247 = add i64 %244, 3
...
block_.L_4040f7:                                  ; preds = %block_404128, %block_4040f2
  ...
  %call2_404104 = tail call %struct.Memory* @sub_4014b0._Z18complete_hash_funcIdET_S0_(%struct.State* nonnull %0, i64 %298, %struct.Memory* %MEMORY.0)
...
block_.L_404132:                                  ; preds = %block_.L_4040e6, %block_.L_40412d
  ...
  %call2_404137 = tail call %struct.Memory* @sub_4014e0._Z9check_sumIdEvT_(%struct.State* nonnull %0, i64 %388, %struct.Memory* %MEMORY.0)
