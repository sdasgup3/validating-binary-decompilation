...
entry:
  ...
  %call2_404043 = tail call %struct.Memory* @sub_400dd0._Z11start_timerv(%struct.State* %0, i64 %58, %struct.Memory* %2)
...
block_.L_40404f:                                  ; preds = %block_.L_404102, %entry
  %79 = phi i64 [ %.pre, %entry ], [ %429, %block_.L_404102 ]
  %MEMORY.0 = phi %struct.Memory* [ %call2_404043, %entry ], [ %call2_404107, %block_.L_404102 ]
  ...
  br i1 %112, label %block_40405f, label %block_.L_40411a

block_40405f:                                     ; preds = %block_.L_40404f
  ...
  br i1 %159, label %block_.L_4040b6, label %block_40407d

block_40407d:                                     ; preds = %block_40405f
  %161 = add i64 %160, 5
  br label %block_.L_404082

block_.L_404082:                                  ; preds = %block_4040ac, %block_40407d
  %162 = phi i64 [ %161, %block_40407d ], [ %248, %block_4040ac ]
  %163 = phi i64 [ %124, %block_40407d ], [ %208, %block_4040ac ]
  %MEMORY.1 = phi %struct.Memory* [ %MEMORY.0, %block_40407d ], [ %call2_40408d, %block_4040ac ]
  %164 = add i64 %163, -40
  ...
  %call2_40408d = tail call %struct.Memory* @sub_401e90._ZN15loop_inner_bodyILi8EdE7do_workERdPKdi(%struct.State* %0, i64 %174, %struct.Memory* %MEMORY.1)
  ...
  br i1 %246, label %block_4040ac, label %block_.L_4040b1

block_4040ac:                                     ; preds = %block_.L_404082
  %248 = add i64 %247, -42
  br label %block_.L_404082

block_.L_4040b1:                                  ; preds = %block_.L_404082
  %249 = add i64 %247, 5
  store i64 %249, i64* %3, align 8
  br label %block_.L_4040b6

block_.L_4040b6:                                  ; preds = %block_.L_4040b1, %block_40405f
  %250 = phi i64 [ %160, %block_40405f ], [ %249, %block_.L_4040b1 ]
  %251 = phi i64 [ %124, %block_40405f ], [ %208, %block_.L_4040b1 ]
  %MEMORY.2 = phi %struct.Memory* [ %MEMORY.0, %block_40405f ], [ %call2_40408d, %block_.L_4040b1 ]
  %252 = add i64 %251, -44
  %253 = add i64 %250, 3
  ...
  br i1 %286, label %block_4040c2, label %block_.L_404102

block_4040c2:                                     ; preds = %block_.L_4040b6
  %288 = add i64 %287, 5
  br label %block_.L_4040c7

block_.L_4040c7:                                  ; preds = %block_4040f8, %block_4040c2
  %289 = phi i64 [ %288, %block_4040c2 ], [ %385, %block_4040f8 ]
  %290 = phi i64 [ %251, %block_4040c2 ], [ %349, %block_4040f8 ]
  %MEMORY.3 = phi %struct.Memory* [ %MEMORY.2, %block_4040c2 ], [ %call2_4040d4, %block_4040f8 ]
  %291 = add i64 %290, -8
  %292 = add i64 %289, 4
  ...
  %call2_4040d4 = tail call %struct.Memory* @sub_401480._Z18complete_hash_funcIdET_S0_(%struct.State* %0, i64 %305, %struct.Memory* %MEMORY.3)
  ...
  br i1 %373, label %block_.L_4040fd, label %block_4040f8

block_4040f8:                                     ; preds = %block_.L_4040c7
  %385 = add i64 %384, -49
  br label %block_.L_4040c7

block_.L_4040fd:                                  ; preds = %block_.L_4040c7
  %386 = add i64 %384, 5
  store i64 %386, i64* %3, align 8
  br label %block_.L_404102

block_.L_404102:                                  ; preds = %block_.L_4040b6, %block_.L_4040fd
  %387 = phi i64 [ %287, %block_.L_4040b6 ], [ %386, %block_.L_4040fd ]
  %388 = phi i64 [ %251, %block_.L_4040b6 ], [ %349, %block_.L_4040fd ]
  %MEMORY.4 = phi %struct.Memory* [ %MEMORY.2, %block_.L_4040b6 ], [ %call2_4040d4, %block_.L_4040fd ]
  %389 = add i64 %388, -40
  %390 = add i64 %387, 5
  ...
  %call2_404107 = tail call %struct.Memory* @sub_4014b0._Z9check_sumIdEvT_(%struct.State* %0, i64 %393, %struct.Memory* %MEMORY.4)
...
block_.L_40411a:                                  ; preds = %block_.L_40404f
  %430 = add i64 %113, -13098
  %431 = add i64 %113, 5
  ...
  %call2_40411a = tail call %struct.Memory* @sub_400df0._Z5timerv(%struct.State* %0, i64 %430, %struct.Memory* %MEMORY.0)
  ...
  %call2_404123 = tail call %struct.Memory* @sub_400790._Z13record_resultdPKc(%struct.State* %0, i64 %441, %struct.Memory* %call2_40411a)
  ...
  ret %struct.Memory* %call2_404123
}
...
define %struct.Memory* @routine_jge_.L_40411a(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i8* %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
...
define %struct.Memory* @routine_jl_.L_4040b6(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i8* %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 2, i32 9
...
define %struct.Memory* @routine_jmpq_.L_404082(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
...
define %struct.Memory* @routine_jge_.L_4040b1(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i8* %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 2, i32 9
...
define %struct.Memory* @routine_jmpq_.L_4040b6(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
...
define %struct.Memory* @routine_jge_.L_404102(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i8* %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 2, i32 9
...
define %struct.Memory* @routine_jmpq_.L_4040c7(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
...
define %struct.Memory* @routine_je_.L_4040fd(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i8* %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
...
define %struct.Memory* @routine_jmpq_.L_404102(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
...
define %struct.Memory* @routine_jmpq_.L_40404f(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
