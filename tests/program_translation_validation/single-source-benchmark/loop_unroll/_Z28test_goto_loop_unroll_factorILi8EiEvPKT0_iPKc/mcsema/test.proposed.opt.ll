...
entry:
  ...
  %call2_40ec43 = tail call %struct.Memory* @sub_400e10._Z11start_timerv(%struct.State* %0, i64 %58, %struct.Memory* %2)
...
block_.L_40ec4f:                                  ; preds = %block_.L_40ecfb, %entry
  %68 = phi i64 [ %.pre, %entry ], [ %445, %block_.L_40ecfb ]
  %MEMORY.0 = phi %struct.Memory* [ %call2_40ec43, %entry ], [ %call2_40ecfe, %block_.L_40ecfb ]
  ...
  br i1 %101, label %block_40ec5f, label %block_.L_40ed11
...
block_40ec5f:                                     ; preds = %block_.L_40ec4f
  ...
  br i1 %146, label %block_.L_40ecb5, label %block_40ec7c
...
block_.L_40ec81:                                  ; preds = %block_40ecab, %block_40ec7c
  %149 = phi i64 [ %111, %block_40ec7c ], [ %194, %block_40ecab ]
  %storemerge = phi i64 [ %148, %block_40ec7c ], [ %234, %block_40ecab ]
  %150 = add i64 %149, -32
  ...
  %call2_40ec8c = tail call %struct.Memory* @sub_40ca90._ZN15loop_inner_bodyILi8EiE7do_workERiPKii(%struct.State* nonnull %0, i64 %160, %struct.Memory* %MEMORY.0)
  ...
  br i1 %232, label %block_40ecab, label %block_.L_40ecb0
...
block_.L_40ecb5:                                  ; preds = %block_.L_40ecb0, %block_40ec5f
  %237 = phi i64 [ %236, %block_.L_40ecb0 ], [ %147, %block_40ec5f ]
  %238 = phi i64 [ %194, %block_.L_40ecb0 ], [ %111, %block_40ec5f ]
  %239 = add i64 %238, -36
  %240 = add i64 %237, 3
  ...
  br i1 %273, label %block_40ecc1, label %block_.L_40ecfb
...
block_.L_40ecc6:                                  ; preds = %block_40ecf1, %block_40ecc1
  %276 = phi i64 [ %238, %block_40ecc1 ], [ %363, %block_40ecf1 ]
  %storemerge5 = phi i64 [ %275, %block_40ecc1 ], [ %399, %block_40ecf1 ]
  %277 = add i64 %276, -8
  ...
  %call2_40ecd1 = tail call %struct.Memory* @sub_40c110._Z18complete_hash_funcIiET_S0_(%struct.State* nonnull %0, i64 %292, %struct.Memory* %MEMORY.0)
  ...
  br i1 %387, label %block_.L_40ecf6, label %block_40ecf1
...
block_.L_40ecfb:                                  ; preds = %block_.L_40ecb5, %block_.L_40ecf6
  %402 = phi i64 [ %274, %block_.L_40ecb5 ], [ %401, %block_.L_40ecf6 ]
  %403 = phi i64 [ %238, %block_.L_40ecb5 ], [ %363, %block_.L_40ecf6 ]
  %404 = add i64 %403, -32
  %405 = add i64 %402, 3
  ...
  %call2_40ecfe = tail call %struct.Memory* @sub_40c140._Z9check_sumIiEvT_(%struct.State* nonnull %0, i64 %409, %struct.Memory* %MEMORY.0)
...
block_.L_40ed11:                                  ; preds = %block_.L_40ec4f
  ...
  %call2_40ed11 = tail call %struct.Memory* @sub_400e30._Z5timerv(%struct.State* nonnull %0, i64 %446, %struct.Memory* %MEMORY.0)
  ...
  %call2_40ed1a = tail call %struct.Memory* @sub_4007d0._Z13record_resultdPKc(%struct.State* nonnull %0, i64 %457, %struct.Memory* %call2_40ed11)
