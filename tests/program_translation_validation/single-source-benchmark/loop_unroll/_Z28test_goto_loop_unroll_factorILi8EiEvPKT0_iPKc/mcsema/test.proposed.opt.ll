...
define %struct.Memory* @_Z28test_goto_loop_unroll_factorILi8EiEvPKT0_iPKc(%struct.State* noalias, i64, %struct.Memory* noalias readnone) local_unnamed_addr #1 {
entry:
...
block_.L_40ec71:                                  ; preds = %block_40ec9b, %block_40ec6c
  ...
  %call2_40ec7c = tail call %struct.Memory* @sub_40ca80._ZN15loop_inner_bodyILi8EiE7do_workERiPKii(%struct.State* nonnull %0, i64 %160, %struct.Memory* %MEMORY.0)
...
block_.L_40eca5:                                  ; preds = %block_.L_40eca0, %block_40ec4f
  %237 = phi i64 [ %236, %block_.L_40eca0 ], [ %147, %block_40ec4f ]
  %238 = phi i64 [ %194, %block_.L_40eca0 ], [ %111, %block_40ec4f ]
  %239 = add i64 %238, -36
  %240 = add i64 %237, 3
...
block_.L_40ecb6:                                  ; preds = %block_40ece1, %block_40ecb1
  ...
  %call2_40ecc1 = tail call %struct.Memory* @sub_40c100._Z18complete_hash_funcIiET_S0_(%struct.State* nonnull %0, i64 %292, %struct.Memory* %MEMORY.0)
...
block_.L_40eceb:                                  ; preds = %block_.L_40eca5, %block_.L_40ece6
  ...
  %call2_40ecee = tail call %struct.Memory* @sub_40c130._Z9check_sumIiEvT_(%struct.State* nonnull %0, i64 %409, %struct.Memory* %MEMORY.0)
