...
declare %struct.Memory* @sub_401e70._ZN15loop_inner_bodyILi9EdE7do_workERdPKdi(%struct.State* noalias dereferenceable(3376), i64, %struct.Memory* noalias readnone returned) local_unnamed_addr
...
entry:
  ...
  %call2_403f33 = tail call %struct.Memory* @sub_400e10._Z11start_timerv(%struct.State* %0, i64 %58, %struct.Memory* %2)
  ...
  br label %block_.L_403f3f

block_.L_403f3f:                                  ; preds = %block_.L_403ff2, %entry
  %74 = phi i64 [ %.pre, %entry ], [ %424, %block_.L_403ff2 ]
  %MEMORY.0 = phi %struct.Memory* [ %call2_403f33, %entry ], [ %call2_403ff7, %block_.L_403ff2 ]
  ...
  br i1 %107, label %block_403f4f, label %block_.L_40400a

block_403f4f:                                     ; preds = %block_.L_403f3f
  ...
  br i1 %153, label %block_.L_403fa6, label %block_403f6d

block_403f6d:                                     ; preds = %block_403f4f
  %155 = add i64 %154, 5
  br label %block_.L_403f72

block_.L_403f72:                                  ; preds = %block_403f9c, %block_403f6d
  %156 = phi i64 [ %118, %block_403f6d ], [ %201, %block_403f9c ]
  %storemerge = phi i64 [ %155, %block_403f6d ], [ %241, %block_403f9c ]
  %157 = add i64 %156, -40
  ...
  %call2_403f7d = tail call %struct.Memory* @sub_401e70._ZN15loop_inner_bodyILi9EdE7do_workERdPKdi(%struct.State* nonnull %0, i64 %167, %struct.Memory* %MEMORY.0)
  ...
  br i1 %239, label %block_403f9c, label %block_.L_403fa1

block_403f9c:                                     ; preds = %block_.L_403f72
  %241 = add i64 %240, -42
  %242 = add i64 %240, 5
  store i64 %242, i64* %3, align 8
  br label %block_.L_403f72

block_.L_403fa1:                                  ; preds = %block_.L_403f72
  %243 = add i64 %240, 5
  store i64 %243, i64* %3, align 8
  br label %block_.L_403fa6

block_.L_403fa6:                                  ; preds = %block_.L_403fa1, %block_403f4f
  %244 = phi i64 [ %243, %block_.L_403fa1 ], [ %154, %block_403f4f ]
  %245 = phi i64 [ %201, %block_.L_403fa1 ], [ %118, %block_403f4f ]
  %246 = add i64 %245, -44
  %247 = add i64 %244, 3
  ...
  br i1 %280, label %block_403fb2, label %block_.L_403ff2

block_403fb2:                                     ; preds = %block_.L_403fa6
  %282 = add i64 %281, 5
  br label %block_.L_403fb7

block_.L_403fb7:                                  ; preds = %block_403fe8, %block_403fb2
  %283 = phi i64 [ %245, %block_403fb2 ], [ %343, %block_403fe8 ]
  %storemerge5 = phi i64 [ %282, %block_403fb2 ], [ %379, %block_403fe8 ]
  %284 = add i64 %283, -8
  ...
  %call2_403fc4 = tail call %struct.Memory* @sub_4014c0._Z18complete_hash_funcIdET_S0_(%struct.State* nonnull %0, i64 %298, %struct.Memory* %MEMORY.0)
  ...
  br i1 %367, label %block_.L_403fed, label %block_403fe8

block_403fe8:                                     ; preds = %block_.L_403fb7
  %379 = add i64 %378, -49
  %380 = add i64 %378, 5
  store i64 %380, i64* %3, align 8
  br label %block_.L_403fb7

block_.L_403fed:                                  ; preds = %block_.L_403fb7
  %381 = add i64 %378, 5
  store i64 %381, i64* %3, align 8
  br label %block_.L_403ff2

block_.L_403ff2:                                  ; preds = %block_.L_403fa6, %block_.L_403fed
  %382 = phi i64 [ %281, %block_.L_403fa6 ], [ %381, %block_.L_403fed ]
  %383 = phi i64 [ %245, %block_.L_403fa6 ], [ %343, %block_.L_403fed ]
  %384 = add i64 %383, -40
  %385 = add i64 %382, 5
  ...
  %call2_403ff7 = tail call %struct.Memory* @sub_4014f0._Z9check_sumIdEvT_(%struct.State* nonnull %0, i64 %388, %struct.Memory* %MEMORY.0)
...
block_.L_40400a:                                  ; preds = %block_.L_403f3f
  %425 = add i64 %108, -12762
  %426 = add i64 %108, 5
  ...
  %call2_40400a = tail call %struct.Memory* @sub_400e30._Z5timerv(%struct.State* nonnull %0, i64 %425, %struct.Memory* %MEMORY.0)
  ...
  %call2_404013 = tail call %struct.Memory* @sub_4007d0._Z13record_resultdPKc(%struct.State* nonnull %0, i64 %436, %struct.Memory* %call2_40400a)
