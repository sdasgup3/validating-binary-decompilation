...
block_.L_40eabf:                                  ; preds = %block_.L_40eb6b, %entry
  %68 = phi i64 [ %.pre, %entry ], [ %445, %block_.L_40eb6b ]
...
block_.L_40eb36:                                  ; preds = %block_40eb61, %block_40eb31
  %276 = phi i64 [ %275, %block_40eb31 ], [ %400, %block_40eb61 ]
  %277 = phi i64 [ %238, %block_40eb31 ], [ %364, %block_40eb61 ]
  ...
  br i1 %388, label %block_.L_40eb66, label %block_40eb61
...
block_.L_40eb6b:                                  ; preds = %block_.L_40eb25, %block_.L_40eb66
  %402 = phi i64 [ %274, %block_.L_40eb25 ], [ %401, %block_.L_40eb66 ]
  %403 = phi i64 [ %238, %block_.L_40eb25 ], [ %364, %block_.L_40eb66 ]
  ...
  %call2_40eb6e = tail call %struct.Memory* @sub_40c100._Z9check_sumIiEvT_(%struct.State* %0, i64 %409, %struct.Memory* %MEMORY.4)
...
block_.L_40eb81:                                  ; preds = %block_.L_40eabf
  ...
  %call2_40eb81 = tail call %struct.Memory* @sub_400df0._Z5timerv(%struct.State* %0, i64 %446, %struct.Memory* %MEMORY.0)
  ...
  %call2_40eb8a = tail call %struct.Memory* @sub_400790._Z13record_resultdPKc(%struct.State* %0, i64 %457, %struct.Memory* %call2_40eb81)
