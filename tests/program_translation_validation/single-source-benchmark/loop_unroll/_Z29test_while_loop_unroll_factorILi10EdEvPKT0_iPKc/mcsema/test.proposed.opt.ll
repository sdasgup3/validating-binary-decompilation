...
define %struct.Memory* @_Z29test_while_loop_unroll_factorILi10EdEvPKT0_iPKc(%struct.State* noalias, i64, %struct.Memory* noalias readnone) local_unnamed_addr #1 {
entry:
...
block_.L_408e7f:                                  ; preds = %block_.L_408f08, %entry
  %74 = phi i64 [ %340, %block_.L_408f08 ], [ %.pre, %entry ]
...
block_.L_408e9e:                                  ; preds = %block_408eaf, %block_408e8f
  %118 = phi i64 [ %201, %block_408eaf ], [ %.pre9, %block_408e8f ]
...
block_408eaf:                                     ; preds = %block_.L_408e9e
  ...
  %call2_408eba = tail call %struct.Memory* @sub_401e00._ZN15loop_inner_bodyILi10EdE7do_workERdPKdi(%struct.State* nonnull %0, i64 %166, %struct.Memory* %call2_408e73)
...
block_408ede:                                     ; preds = %block_.L_408ed2
  ...
  %call2_408eeb = tail call %struct.Memory* @sub_4014b0._Z18complete_hash_funcIdET_S0_(%struct.State* nonnull %0, i64 %252, %struct.Memory* %call2_408e73)
...
block_.L_408f08:                                  ; preds = %block_.L_408ed2
  ...
  %call2_408f0d = tail call %struct.Memory* @sub_4014e0._Z9check_sumIdEvT_(%struct.State* nonnull %0, i64 %304, %struct.Memory* %call2_408e73)
...
block_.L_408f20:                                  ; preds = %block_.L_408e7f
  ...
  %call2_408f20 = tail call %struct.Memory* @sub_400e20._Z5timerv(%struct.State* nonnull %0, i64 %341, %struct.Memory* %call2_408e73)
