...
entry:
  ...
  %call2_408e83 = tail call %struct.Memory* @sub_400e10._Z11start_timerv(%struct.State* %0, i64 %58, %struct.Memory* %2)
...
block_.L_408e8f:                                  ; preds = %block_.L_408f18, %entry
  %74 = phi i64 [ %340, %block_.L_408f18 ], [ %.pre, %entry ]
  ...
  br i1 %107, label %block_408e9f, label %block_.L_408f30
...
block_.L_408eae:                                  ; preds = %block_408ebf, %block_408e9f
  %118 = phi i64 [ %201, %block_408ebf ], [ %.pre9, %block_408e9f ]
  ...
  br i1 %156, label %block_408ebf, label %block_.L_408edd
...
block_408ebf:                                     ; preds = %block_.L_408eae
  ...
  %call2_408eca = tail call %struct.Memory* @sub_401e10._ZN15loop_inner_bodyILi10EdE7do_workERdPKdi(%struct.State* nonnull %0, i64 %166, %struct.Memory* %call2_408e83)
...
block_.L_408ee2:                                  ; preds = %block_408eee, %block_.L_408edd
  %203 = phi i64 [ %119, %block_.L_408edd ], [ %.pre10, %block_408eee ]
  %storemerge = phi i64 [ %202, %block_.L_408edd ], [ %298, %block_408eee ]
  %204 = add i64 %203, -44
  ...
  br i1 %238, label %block_408eee, label %block_.L_408f18
...
block_408eee:                                     ; preds = %block_.L_408ee2
  ...
  %call2_408efb = tail call %struct.Memory* @sub_4014c0._Z18complete_hash_funcIdET_S0_(%struct.State* nonnull %0, i64 %252, %struct.Memory* %call2_408e83)
...
block_.L_408f18:                                  ; preds = %block_.L_408ee2
  ...
  %call2_408f1d = tail call %struct.Memory* @sub_4014f0._Z9check_sumIdEvT_(%struct.State* nonnull %0, i64 %304, %struct.Memory* %call2_408e83)
...
block_.L_408f30:                                  ; preds = %block_.L_408e8f
  ...
  %call2_408f30 = tail call %struct.Memory* @sub_400e30._Z5timerv(%struct.State* nonnull %0, i64 %341, %struct.Memory* %call2_408e83)
  ...
  %call2_408f39 = tail call %struct.Memory* @sub_4007d0._Z13record_resultdPKc(%struct.State* nonnull %0, i64 %352, %struct.Memory* %call2_408f30)
