...
entry:
  ...
  %call2_408e73 = tail call %struct.Memory* @sub_400e00._Z11start_timerv(%struct.State* %0, i64 %58, %struct.Memory* %2)
...
block_.L_408e7f:                                  ; preds = %block_.L_408f08, %entry
  %74 = phi i64 [ %.pre, %entry ], [ %340, %block_.L_408f08 ]
  %MEMORY.0 = phi %struct.Memory* [ %call2_408e73, %entry ], [ %call2_408f0d, %block_.L_408f08 ]
  ...
  br i1 %107, label %block_408e8f, label %block_.L_408f20
...
block_.L_408e9e:                                  ; preds = %block_408eaf, %block_408e8f
  %118 = phi i64 [ %.pre9, %block_408e8f ], [ %201, %block_408eaf ]
  %MEMORY.1 = phi %struct.Memory* [ %MEMORY.0, %block_408e8f ], [ %call2_408eba, %block_408eaf ]
  ...
  br i1 %156, label %block_408eaf, label %block_.L_408ecd
...
block_408eaf:                                     ; preds = %block_.L_408e9e
  ...
  %call2_408eba = tail call %struct.Memory* @sub_401e00._ZN15loop_inner_bodyILi10EdE7do_workERdPKdi(%struct.State* nonnull %0, i64 %166, %struct.Memory* %MEMORY.1)
...
block_.L_408ed2:                                  ; preds = %block_408ede, %block_.L_408ecd
  %203 = phi i64 [ %119, %block_.L_408ecd ], [ %.pre10, %block_408ede ]
  %storemerge = phi i64 [ %202, %block_.L_408ecd ], [ %298, %block_408ede ]
  %MEMORY.2 = phi %struct.Memory* [ %MEMORY.1, %block_.L_408ecd ], [ %call2_408eeb, %block_408ede ]
  %204 = add i64 %203, -44
  ...
  br i1 %238, label %block_408ede, label %block_.L_408f08
...
block_408ede:                                     ; preds = %block_.L_408ed2
  ...
  %call2_408eeb = tail call %struct.Memory* @sub_4014b0._Z18complete_hash_funcIdET_S0_(%struct.State* nonnull %0, i64 %252, %struct.Memory* %MEMORY.2)
...
block_.L_408f08:                                  ; preds = %block_.L_408ed2
  ...
  %call2_408f0d = tail call %struct.Memory* @sub_4014e0._Z9check_sumIdEvT_(%struct.State* nonnull %0, i64 %304, %struct.Memory* %MEMORY.2)
...
block_.L_408f20:                                  ; preds = %block_.L_408e7f
  ...
  %call2_408f20 = tail call %struct.Memory* @sub_400e20._Z5timerv(%struct.State* nonnull %0, i64 %341, %struct.Memory* %MEMORY.0)
  ...
  %call2_408f29 = tail call %struct.Memory* @sub_4007c0._Z13record_resultdPKc(%struct.State* nonnull %0, i64 %352, %struct.Memory* %call2_408f20)
  ...
  ret %struct.Memory* %call2_408f29
}
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_jge_.L_408f20(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i8* nocapture %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_jmpq_.L_408e9e(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_jmpq_.L_408ed2(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_jge_.L_408f08(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i8* nocapture %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 2, i32 9
