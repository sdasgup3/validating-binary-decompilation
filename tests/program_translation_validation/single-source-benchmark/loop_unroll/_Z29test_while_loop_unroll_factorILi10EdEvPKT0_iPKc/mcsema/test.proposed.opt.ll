...
define %struct.Memory* @_Z29test_while_loop_unroll_factorILi10EdEvPKT0_iPKc(%struct.State* noalias, i64, %struct.Memory* noalias) local_unnamed_addr #1 {
entry:
  ...
  %call2_408e43 = tail call %struct.Memory* @sub_400dd0._Z11start_timerv(%struct.State* %0, i64 %58, %struct.Memory* %2)
...
block_.L_408e4f:                                  ; preds = %block_.L_408ed8, %entry
  %79 = phi i64 [ %.pre, %entry ], [ %345, %block_.L_408ed8 ]
  %MEMORY.0 = phi %struct.Memory* [ %call2_408e43, %entry ], [ %call2_408edd, %block_.L_408ed8 ]
  ...
  br i1 %112, label %block_408e5f, label %block_.L_408ef0
...
block_.L_408e6e:                                  ; preds = %block_408e7f, %block_408e5f
  %124 = phi i64 [ %.pre1, %block_408e5f ], [ %207, %block_408e7f ]
  %MEMORY.1 = phi %struct.Memory* [ %MEMORY.0, %block_408e5f ], [ %call2_408e8a, %block_408e7f ]
  ...
  br i1 %162, label %block_408e7f, label %block_.L_408e9d
...
block_408e7f:                                     ; preds = %block_.L_408e6e
  ...
  %call2_408e8a = tail call %struct.Memory* @sub_401dd0._ZN15loop_inner_bodyILi10EdE7do_workERdPKdi(%struct.State* %0, i64 %172, %struct.Memory* %MEMORY.1)
...
block_.L_408ea2:                                  ; preds = %block_408eae, %block_.L_408e9d
  %209 = phi i64 [ %208, %block_.L_408e9d ], [ %304, %block_408eae ]
  %210 = phi i64 [ %125, %block_.L_408e9d ], [ %.pre2, %block_408eae ]
  %MEMORY.2 = phi %struct.Memory* [ %MEMORY.1, %block_.L_408e9d ], [ %call2_408ebb, %block_408eae ]
  %211 = add i64 %210, -44
  %212 = add i64 %209, 3
  ...
  br i1 %245, label %block_408eae, label %block_.L_408ed8
...
block_408eae:                                     ; preds = %block_.L_408ea2
  ...
  %call2_408ebb = tail call %struct.Memory* @sub_401480._Z18complete_hash_funcIdET_S0_(%struct.State* %0, i64 %259, %struct.Memory* %MEMORY.2)
...
block_.L_408ed8:                                  ; preds = %block_.L_408ea2
  ...
  %call2_408edd = tail call %struct.Memory* @sub_4014b0._Z9check_sumIdEvT_(%struct.State* %0, i64 %309, %struct.Memory* %MEMORY.2)
...
block_.L_408ef0:                                  ; preds = %block_.L_408e4f
  ...
  %call2_408ef0 = tail call %struct.Memory* @sub_400df0._Z5timerv(%struct.State* %0, i64 %346, %struct.Memory* %MEMORY.0)
  ...
  %call2_408ef9 = tail call %struct.Memory* @sub_400790._Z13record_resultdPKc(%struct.State* %0, i64 %357, %struct.Memory* %call2_408ef0)
  ...
  ret %struct.Memory* %call2_408ef9
}
...
define %struct.Memory* @routine_jge_.L_408ef0(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i8* %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
...
define %struct.Memory* @routine_jge_.L_408e9d(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i8* %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 2, i32 9
...
define %struct.Memory* @routine_jmpq_.L_408e6e(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
...
define %struct.Memory* @routine_jmpq_.L_408ea2(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
...
define %struct.Memory* @routine_jge_.L_408ed8(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i8* %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 2, i32 9
...
define %struct.Memory* @routine_jmpq_.L_408e4f(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
