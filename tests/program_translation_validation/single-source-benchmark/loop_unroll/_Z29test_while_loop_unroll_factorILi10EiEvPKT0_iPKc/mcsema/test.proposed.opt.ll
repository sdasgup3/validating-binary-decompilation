...
entry:
  ...
  %call2_4136a3 = tail call %struct.Memory* @sub_400dd0._Z11start_timerv(%struct.State* %0, i64 %58, %struct.Memory* %2)
...
block_.L_4136af:                                  ; preds = %block_.L_413731, %entry
  %68 = phi i64 [ %.pre, %entry ], [ %363, %block_.L_413731 ]
  %MEMORY.0 = phi %struct.Memory* [ %call2_4136a3, %entry ], [ %call2_413734, %block_.L_413731 ]
  ...
  br i1 %101, label %block_4136bf, label %block_.L_413747

block_4136bf:                                     ; preds = %block_.L_4136af
  %103 = add i64 %69, -32
  %104 = add i64 %102, 7
...
block_.L_4136cd:                                  ; preds = %block_4136de, %block_4136bf
  %111 = phi i64 [ %.pre1, %block_4136bf ], [ %194, %block_4136de ]
  %MEMORY.1 = phi %struct.Memory* [ %MEMORY.0, %block_4136bf ], [ %call2_4136e9, %block_4136de ]
  ...
  br i1 %149, label %block_4136de, label %block_.L_4136fc

block_4136de:                                     ; preds = %block_.L_4136cd
  %151 = add i64 %112, -32
  ...
  %call2_4136e9 = tail call %struct.Memory* @sub_40c990._ZN15loop_inner_bodyILi10EiE7do_workERiPKii(%struct.State* %0, i64 %159, %struct.Memory* %MEMORY.1)
...
block_.L_4136fc:                                  ; preds = %block_.L_4136cd
  %195 = add i64 %150, 5
  store i64 %195, i64* %3, align 8
  br label %block_.L_413701

block_.L_413701:                                  ; preds = %block_41370d, %block_.L_4136fc
  %196 = phi i64 [ %195, %block_.L_4136fc ], [ %320, %block_41370d ]
  %197 = phi i64 [ %112, %block_.L_4136fc ], [ %.pre2, %block_41370d ]
  %MEMORY.2 = phi %struct.Memory* [ %MEMORY.1, %block_.L_4136fc ], [ %call2_413718, %block_41370d ]
  %198 = add i64 %197, -36
  %199 = add i64 %196, 3
  ...
  br i1 %232, label %block_41370d, label %block_.L_413731

block_41370d:                                     ; preds = %block_.L_413701
  %234 = add i64 %197, -8
  %235 = add i64 %233, 4
  ...
  %call2_413718 = tail call %struct.Memory* @sub_40c0d0._Z18complete_hash_funcIiET_S0_(%struct.State* %0, i64 %247, %struct.Memory* %MEMORY.2)
...
block_.L_413731:                                  ; preds = %block_.L_413701
  %321 = add i64 %197, -32
  %322 = add i64 %233, 3
  ...
  %call2_413734 = tail call %struct.Memory* @sub_40c100._Z9check_sumIiEvT_(%struct.State* %0, i64 %326, %struct.Memory* %MEMORY.2)
...
block_.L_413747:                                  ; preds = %block_.L_4136af
  %364 = add i64 %102, -76119
  %365 = add i64 %102, 5
  ...
  %call2_413747 = tail call %struct.Memory* @sub_400df0._Z5timerv(%struct.State* %0, i64 %364, %struct.Memory* %MEMORY.0)
  ...
  store i64 %374, i64* %RDI.i99, align 8
  %375 = add i64 %371, -77756
  %376 = add i64 %371, 9
  ...
  %call2_413750 = tail call %struct.Memory* @sub_400790._Z13record_resultdPKc(%struct.State* %0, i64 %375, %struct.Memory* %call2_413747)
  %380 = load i64, i64* %RSP.i104, align 8
  %381 = load i64, i64* %PC.i, align 8
  %382 = add i64 %380, 48
  store i64 %382, i64* %RSP.i104, align 8
  ...
  ret %struct.Memory* %call2_413750
}
...
define %struct.Memory* @routine_jge_.L_413747(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i8* %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
...
define %struct.Memory* @routine_jge_.L_4136fc(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i8* %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 2, i32 9
...
define %struct.Memory* @routine_jmpq_.L_4136cd(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
...
define %struct.Memory* @routine_jmpq_.L_413701(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
...
define %struct.Memory* @routine_jge_.L_413731(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i8* %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 2, i32 9
...
define %struct.Memory* @routine_jmpq_.L_4136af(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
