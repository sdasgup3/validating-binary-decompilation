...
entry:
  ...
  %call2_4136e3 = tail call %struct.Memory* @sub_400e10._Z11start_timerv(%struct.State* %0, i64 %58, %struct.Memory* %2)
...
block_.L_4136ef:                                  ; preds = %block_.L_413771, %entry
  %68 = phi i64 [ %361, %block_.L_413771 ], [ %.pre, %entry ]
  ...
  br i1 %101, label %block_4136ff, label %block_.L_413787

block_4136ff:                                     ; preds = %block_.L_4136ef
  %103 = add i64 %69, -32
  %104 = add i64 %102, 7
...
block_.L_41370d:                                  ; preds = %block_41371e, %block_4136ff
  %111 = phi i64 [ %194, %block_41371e ], [ %.pre9, %block_4136ff ]
  ...
  br i1 %149, label %block_41371e, label %block_.L_41373c

block_41371e:                                     ; preds = %block_.L_41370d
  %151 = add i64 %112, -32
  ...
  %call2_413729 = tail call %struct.Memory* @sub_40c9d0._ZN15loop_inner_bodyILi10EiE7do_workERiPKii(%struct.State* nonnull %0, i64 %159, %struct.Memory* %call2_4136e3)
...
block_.L_41373c:                                  ; preds = %block_.L_41370d
  %195 = add i64 %150, 5
  br label %block_.L_413741

block_.L_413741:                                  ; preds = %block_41374d, %block_.L_41373c
  %196 = phi i64 [ %112, %block_.L_41373c ], [ %.pre10, %block_41374d ]
  %storemerge = phi i64 [ %195, %block_.L_41373c ], [ %318, %block_41374d ]
  %197 = add i64 %196, -36
  ...
  br i1 %231, label %block_41374d, label %block_.L_413771
...
block_41374d:                                     ; preds = %block_.L_413741
  ...
  %call2_413758 = tail call %struct.Memory* @sub_40c110._Z18complete_hash_funcIiET_S0_(%struct.State* nonnull %0, i64 %246, %struct.Memory* %call2_4136e3)
...
block_.L_413771:                                  ; preds = %block_.L_413741
  ...
  %call2_413774 = tail call %struct.Memory* @sub_40c140._Z9check_sumIiEvT_(%struct.State* nonnull %0, i64 %325, %struct.Memory* %call2_4136e3)
...
block_.L_413787:                                  ; preds = %block_.L_4136ef
  ...
  %call2_413787 = tail call %struct.Memory* @sub_400e30._Z5timerv(%struct.State* nonnull %0, i64 %362, %struct.Memory* %call2_4136e3)
  ...
  %call2_413790 = tail call %struct.Memory* @sub_4007d0._Z13record_resultdPKc(%struct.State* nonnull %0, i64 %373, %struct.Memory* %call2_413787)
