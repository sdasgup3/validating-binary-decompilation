...
define %struct.Memory* @_Z29test_while_loop_unroll_factorILi10EiEvPKT0_iPKc(%struct.State* noalias, i64, %struct.Memory* noalias readnone) local_unnamed_addr #1 {
entry:
...
block_.L_4136df:                                  ; preds = %block_.L_413761, %entry
  %68 = phi i64 [ %361, %block_.L_413761 ], [ %.pre, %entry ]
...
block_.L_4136fd:                                  ; preds = %block_41370e, %block_4136ef
  %111 = phi i64 [ %194, %block_41370e ], [ %.pre9, %block_4136ef ]
...
block_41370e:                                     ; preds = %block_.L_4136fd
  ...
  %call2_413719 = tail call %struct.Memory* @sub_40c9c0._ZN15loop_inner_bodyILi10EiE7do_workERiPKii(%struct.State* nonnull %0, i64 %159, %struct.Memory* %call2_4136d3)
...
block_41373d:                                     ; preds = %block_.L_413731
  ...
  %call2_413748 = tail call %struct.Memory* @sub_40c100._Z18complete_hash_funcIiET_S0_(%struct.State* nonnull %0, i64 %246, %struct.Memory* %call2_4136d3)
...
block_.L_413761:                                  ; preds = %block_.L_413731
  ...
  %call2_413764 = tail call %struct.Memory* @sub_40c130._Z9check_sumIiEvT_(%struct.State* nonnull %0, i64 %325, %struct.Memory* %call2_4136d3)
...
block_.L_413777:                                  ; preds = %block_.L_4136df
  ...
  %call2_413777 = tail call %struct.Memory* @sub_400e20._Z5timerv(%struct.State* nonnull %0, i64 %362, %struct.Memory* %call2_4136d3)
