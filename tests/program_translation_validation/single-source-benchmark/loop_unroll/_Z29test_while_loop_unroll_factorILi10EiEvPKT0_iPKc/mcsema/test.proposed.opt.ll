...
block_.L_4136af:                                  ; preds = %block_.L_413731, %entry
  %68 = phi i64 [ %.pre, %entry ], [ %361, %block_.L_413731 ]
...
block_.L_413701:                                  ; preds = %block_41370d, %block_.L_4136fc
  %196 = phi i64 [ %195, %block_.L_4136fc ], [ %319, %block_41370d ]
...
block_.L_413731:                                  ; preds = %block_.L_413701
  ...
  %call2_413734 = tail call %struct.Memory* @sub_40c100._Z9check_sumIiEvT_(%struct.State* %0, i64 %325, %struct.Memory* %MEMORY.2)
...
block_.L_413747:                                  ; preds = %block_.L_4136af
  ...
  %call2_413747 = tail call %struct.Memory* @sub_400df0._Z5timerv(%struct.State* %0, i64 %362, %struct.Memory* %MEMORY.0)
  ...
  %call2_413750 = tail call %struct.Memory* @sub_400790._Z13record_resultdPKc(%struct.State* %0, i64 %373, %struct.Memory* %call2_413747)
