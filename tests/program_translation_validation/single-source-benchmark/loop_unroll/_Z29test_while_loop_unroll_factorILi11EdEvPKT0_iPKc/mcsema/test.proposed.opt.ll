...
entry:
  ...
  %call2_408d13 = tail call %struct.Memory* @sub_400dd0._Z11start_timerv(%struct.State* %0, i64 %58, %struct.Memory* %2)
  ...
  br label %block_.L_408d1f

block_.L_408d1f:                                  ; preds = %block_.L_408da8, %entry
  %79 = phi i64 [ %.pre, %entry ], [ %349, %block_.L_408da8 ]
  %MEMORY.0 = phi %struct.Memory* [ %call2_408d13, %entry ], [ %call2_408dad, %block_.L_408da8 ]
  ...
  br i1 %112, label %block_408d2f, label %block_.L_408dc0

block_408d2f:                                     ; preds = %block_.L_408d1f
  ...
  br label %block_.L_408d3e

block_.L_408d3e:                                  ; preds = %block_408d4f, %block_408d2f
  %124 = phi i64 [ %.pre1, %block_408d2f ], [ %207, %block_408d4f ]
  %MEMORY.1 = phi %struct.Memory* [ %MEMORY.0, %block_408d2f ], [ %call2_408d5a, %block_408d4f ]
  ...
  br i1 %162, label %block_408d4f, label %block_.L_408d6d

block_408d4f:                                     ; preds = %block_.L_408d3e
  %164 = add i64 %125, -40
  ...
  %call2_408d5a = tail call %struct.Memory* @sub_401d70._ZN15loop_inner_bodyILi11EdE7do_workERdPKdi(%struct.State* %0, i64 %172, %struct.Memory* %MEMORY.1)
...
block_.L_408d6d:                                  ; preds = %block_.L_408d3e
  %208 = add i64 %163, 5
  store i64 %208, i64* %3, align 8
  br label %block_.L_408d72

block_.L_408d72:                                  ; preds = %block_408d7e, %block_.L_408d6d
  %209 = phi i64 [ %208, %block_.L_408d6d ], [ %306, %block_408d7e ]
  %210 = phi i64 [ %125, %block_.L_408d6d ], [ %.pre2, %block_408d7e ]
  %MEMORY.2 = phi %struct.Memory* [ %MEMORY.1, %block_.L_408d6d ], [ %call2_408d8b, %block_408d7e ]
  %211 = add i64 %210, -44
  %212 = add i64 %209, 3
  ...
  store i64 %215, i64* %RAX.i90, align 8
  %216 = add i64 %210, -12
  %217 = add i64 %209, 6
  ...
  br i1 %245, label %block_408d7e, label %block_.L_408da8

block_408d7e:                                     ; preds = %block_.L_408d72
  %247 = add i64 %210, -8
  %248 = add i64 %246, 4
  store i64 %248, i64* %PC.i, align 8
  %249 = inttoptr i64 %247 to i64*
  %250 = load i64, i64* %249, align 8
  store i64 %250, i64* %RAX.i90, align 8
  %251 = add i64 %246, 8
  store i64 %251, i64* %PC.i, align 8
  %252 = load i32, i32* %213, align 4
  %253 = sext i32 %252 to i64
  store i64 %253, i64* %RCX.i73, align 8
  ...
  %call2_408d8b = tail call %struct.Memory* @sub_401480._Z18complete_hash_funcIdET_S0_(%struct.State* %0, i64 %260, %struct.Memory* %MEMORY.2)
  ...
  store i64 %281, i64* %RDX.i96, align 8
...
block_.L_408da8:                                  ; preds = %block_.L_408d72
  %307 = add i64 %210, -40
  %308 = add i64 %246, 5
  ...
  %call2_408dad = tail call %struct.Memory* @sub_4014b0._Z9check_sumIdEvT_(%struct.State* %0, i64 %312, %struct.Memory* %MEMORY.2)
  ...
  store i64 %324, i64* %RAX.i90, align 8
...
block_.L_408dc0:                                  ; preds = %block_.L_408d1f
  %350 = add i64 %113, -32720
  %351 = add i64 %113, 5
  ...
  %call2_408dc0 = tail call %struct.Memory* @sub_400df0._Z5timerv(%struct.State* %0, i64 %350, %struct.Memory* %MEMORY.0)
  ...
  %call2_408dc9 = tail call %struct.Memory* @sub_400790._Z13record_resultdPKc(%struct.State* %0, i64 %361, %struct.Memory* %call2_408dc0)
  %366 = load i64, i64* %RSP.i106, align 8
  %367 = load i64, i64* %PC.i, align 8
  %368 = add i64 %366, 48
  store i64 %368, i64* %RSP.i106, align 8
  ...
  ret %struct.Memory* %call2_408dc9
}
...
define %struct.Memory* @routine_jge_.L_408dc0(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i8* %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
...
define %struct.Memory* @routine_jge_.L_408d6d(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i8* %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 2, i32 9
...
define %struct.Memory* @routine_jmpq_.L_408d3e(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
...
define %struct.Memory* @routine_jmpq_.L_408d72(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
...
define %struct.Memory* @routine_jge_.L_408da8(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i8* %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 2, i32 9
...
define %struct.Memory* @routine_jmpq_.L_408d1f(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
