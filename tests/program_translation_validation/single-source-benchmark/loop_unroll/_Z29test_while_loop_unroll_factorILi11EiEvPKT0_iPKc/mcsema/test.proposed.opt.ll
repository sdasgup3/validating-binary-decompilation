...
entry:
  ...
  %call2_413583 = tail call %struct.Memory* @sub_400dd0._Z11start_timerv(%struct.State* %0, i64 %58, %struct.Memory* %2)
...
block_.L_41358f:                                  ; preds = %block_.L_413611, %entry
  %68 = phi i64 [ %.pre, %entry ], [ %361, %block_.L_413611 ]
  %MEMORY.0 = phi %struct.Memory* [ %call2_413583, %entry ], [ %call2_413614, %block_.L_413611 ]
  ...
  br i1 %101, label %block_41359f, label %block_.L_413627
...
block_.L_4135ad:                                  ; preds = %block_4135be, %block_41359f
  %111 = phi i64 [ %.pre1, %block_41359f ], [ %194, %block_4135be ]
  %MEMORY.1 = phi %struct.Memory* [ %MEMORY.0, %block_41359f ], [ %call2_4135c9, %block_4135be ]
  ...
  br i1 %149, label %block_4135be, label %block_.L_4135dc
...
block_4135be:                                     ; preds = %block_.L_4135ad
  ...
  %call2_4135c9 = tail call %struct.Memory* @sub_40c930._ZN15loop_inner_bodyILi11EiE7do_workERiPKii(%struct.State* %0, i64 %159, %struct.Memory* %MEMORY.1)
...
block_.L_4135e1:                                  ; preds = %block_4135ed, %block_.L_4135dc
  %196 = phi i64 [ %195, %block_.L_4135dc ], [ %319, %block_4135ed ]
  %197 = phi i64 [ %112, %block_.L_4135dc ], [ %.pre2, %block_4135ed ]
  %MEMORY.2 = phi %struct.Memory* [ %MEMORY.1, %block_.L_4135dc ], [ %call2_4135f8, %block_4135ed ]
  %198 = add i64 %197, -36
  %199 = add i64 %196, 3
  ...
  br i1 %232, label %block_4135ed, label %block_.L_413611
...
block_4135ed:                                     ; preds = %block_.L_4135e1
  ...
  %call2_4135f8 = tail call %struct.Memory* @sub_40c0d0._Z18complete_hash_funcIiET_S0_(%struct.State* %0, i64 %247, %struct.Memory* %MEMORY.2)
...
block_.L_413611:                                  ; preds = %block_.L_4135e1
  ...
  %call2_413614 = tail call %struct.Memory* @sub_40c100._Z9check_sumIiEvT_(%struct.State* %0, i64 %325, %struct.Memory* %MEMORY.2)
...
block_.L_413627:                                  ; preds = %block_.L_41358f
  ...
  %call2_413627 = tail call %struct.Memory* @sub_400df0._Z5timerv(%struct.State* %0, i64 %362, %struct.Memory* %MEMORY.0)
  ...
  %call2_413630 = tail call %struct.Memory* @sub_400790._Z13record_resultdPKc(%struct.State* %0, i64 %373, %struct.Memory* %call2_413627)
  ...
  ret %struct.Memory* %call2_413630
}
...
define %struct.Memory* @routine_jge_.L_413627(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i8* %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
...
define %struct.Memory* @routine_jge_.L_4135dc(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i8* %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 2, i32 9
...
define %struct.Memory* @routine_jmpq_.L_4135ad(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
...
define %struct.Memory* @routine_jmpq_.L_4135e1(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
...
define %struct.Memory* @routine_jge_.L_413611(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i8* %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 2, i32 9
...
define %struct.Memory* @routine_jmpq_.L_41358f(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
