...
block_.L_41358f:                                  ; preds = %block_.L_413611, %entry
  %68 = phi i64 [ %.pre, %entry ], [ %363, %block_.L_413611 ]
...
block_.L_4135e1:                                  ; preds = %block_4135ed, %block_.L_4135dc
  %196 = phi i64 [ %195, %block_.L_4135dc ], [ %320, %block_4135ed ]
...
block_.L_413611:                                  ; preds = %block_.L_4135e1
  ...
  %call2_413614 = tail call %struct.Memory* @sub_40c100._Z9check_sumIiEvT_(%struct.State* %0, i64 %326, %struct.Memory* %MEMORY.2)
...
block_.L_413627:                                  ; preds = %block_.L_41358f
  ...
  %call2_413627 = tail call %struct.Memory* @sub_400df0._Z5timerv(%struct.State* %0, i64 %364, %struct.Memory* %MEMORY.0)
  ...
  %call2_413630 = tail call %struct.Memory* @sub_400790._Z13record_resultdPKc(%struct.State* %0, i64 %375, %struct.Memory* %call2_413627)
