...
block_.L_408bef:                                  ; preds = %block_.L_408c78, %entry
  %79 = phi i64 [ %.pre, %entry ], [ %349, %block_.L_408c78 ]
...
block_.L_408c42:                                  ; preds = %block_408c4e, %block_.L_408c3d
  %209 = phi i64 [ %208, %block_.L_408c3d ], [ %306, %block_408c4e ]
...
block_408c4e:                                     ; preds = %block_.L_408c42
  ...
  %call2_408c5b = tail call %struct.Memory* @sub_401480._Z18complete_hash_funcIdET_S0_(%struct.State* %0, i64 %260, %struct.Memory* %MEMORY.2)
...
block_.L_408c78:                                  ; preds = %block_.L_408c42
  ...
  %call2_408c7d = tail call %struct.Memory* @sub_4014b0._Z9check_sumIdEvT_(%struct.State* %0, i64 %312, %struct.Memory* %MEMORY.2)
...
block_.L_408c90:                                  ; preds = %block_.L_408bef
  ...
  %call2_408c90 = tail call %struct.Memory* @sub_400df0._Z5timerv(%struct.State* %0, i64 %350, %struct.Memory* %MEMORY.0)
  ...
  %call2_408c99 = tail call %struct.Memory* @sub_400790._Z13record_resultdPKc(%struct.State* %0, i64 %361, %struct.Memory* %call2_408c90)
