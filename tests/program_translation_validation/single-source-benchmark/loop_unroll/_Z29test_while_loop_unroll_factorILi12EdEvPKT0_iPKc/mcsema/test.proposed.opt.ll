...
define %struct.Memory* @_Z29test_while_loop_unroll_factorILi12EdEvPKT0_iPKc(%struct.State* noalias, i64, %struct.Memory* noalias readnone) local_unnamed_addr #1 {
entry:
...
block_.L_408c1f:                                  ; preds = %block_.L_408ca8, %entry
  %74 = phi i64 [ %340, %block_.L_408ca8 ], [ %.pre, %entry ]
...
block_.L_408c3e:                                  ; preds = %block_408c4f, %block_408c2f
  %118 = phi i64 [ %201, %block_408c4f ], [ %.pre9, %block_408c2f ]
...
block_408c4f:                                     ; preds = %block_.L_408c3e
  ...
  %call2_408c5a = tail call %struct.Memory* @sub_401d40._ZN15loop_inner_bodyILi12EdE7do_workERdPKdi(%struct.State* nonnull %0, i64 %166, %struct.Memory* %call2_408c13)
...
block_408c7e:                                     ; preds = %block_.L_408c72
  ...
  %call2_408c8b = tail call %struct.Memory* @sub_4014b0._Z18complete_hash_funcIdET_S0_(%struct.State* nonnull %0, i64 %252, %struct.Memory* %call2_408c13)
...
block_.L_408ca8:                                  ; preds = %block_.L_408c72
  ...
  %call2_408cad = tail call %struct.Memory* @sub_4014e0._Z9check_sumIdEvT_(%struct.State* nonnull %0, i64 %304, %struct.Memory* %call2_408c13)
...
block_.L_408cc0:                                  ; preds = %block_.L_408c1f
  ...
  %call2_408cc0 = tail call %struct.Memory* @sub_400e20._Z5timerv(%struct.State* nonnull %0, i64 %341, %struct.Memory* %call2_408c13)
