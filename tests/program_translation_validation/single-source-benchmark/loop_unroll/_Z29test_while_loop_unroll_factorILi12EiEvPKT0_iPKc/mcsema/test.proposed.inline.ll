...
define %struct.Memory* @_Z29test_while_loop_unroll_factorILi12EiEvPKT0_iPKc(%struct.State* noalias, i64, %struct.Memory* noalias) #1 {
entry:
  ...
  store %struct.Memory* %loadMem_413484, %struct.Memory** %MEMORY
  ...
  store i64 %78, i64* %81
  store %struct.Memory* %loadMem_413488, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem1_413493, %struct.Memory** %MEMORY
...
block_.L_41349f:                                  ; preds = %block_.L_413521, %entry
  ...
  store %struct.Memory* %loadMem_4134a2, %struct.Memory** %MEMORY
...
block_4134af:                                     ; preds = %block_.L_41349f
  ...
  store i32 0, i32* %236
  store %struct.Memory* %loadMem_4134b6, %struct.Memory** %MEMORY
  br label %block_.L_4134bd

block_.L_4134bd:                                  ; preds = %block_4134ce, %block_4134af
  ...
  store %struct.Memory* %loadMem_4134c8, %struct.Memory** %MEMORY
...
block_4134ce:                                     ; preds = %block_.L_4134bd
  ...
  store %struct.Memory* %loadMem_4134ce, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_4134d2, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem1_4134d9, %struct.Memory** %MEMORY
...
block_.L_4134ec:                                  ; preds = %block_.L_4134bd
  ...
  store %struct.Memory* %loadMem_4134ec, %struct.Memory** %MEMORY
  br label %block_.L_4134f1

block_.L_4134f1:                                  ; preds = %block_4134fd, %block_.L_4134ec
...
block_4134fd:                                     ; preds = %block_.L_4134f1
  ...
  store %struct.Memory* %loadMem1_413508, %struct.Memory** %MEMORY
...
block_.L_413521:                                  ; preds = %block_.L_4134f1
  ...
  store %struct.Memory* %loadMem1_413524, %struct.Memory** %MEMORY
...
block_.L_413537:                                  ; preds = %block_.L_41349f
  ...
  store %struct.Memory* %loadMem1_413537, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_413549, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_41354a, %struct.Memory** %MEMORY
  ret %struct.Memory* %loadMem_41354a
}
