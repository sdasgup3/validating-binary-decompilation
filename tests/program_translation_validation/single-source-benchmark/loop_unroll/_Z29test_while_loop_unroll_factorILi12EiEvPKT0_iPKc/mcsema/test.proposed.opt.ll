...
block_.L_41346f:                                  ; preds = %block_.L_4134f1, %entry
  %68 = phi i64 [ %.pre, %entry ], [ %363, %block_.L_4134f1 ]
...
block_.L_4134c1:                                  ; preds = %block_4134cd, %block_.L_4134bc
  %196 = phi i64 [ %195, %block_.L_4134bc ], [ %320, %block_4134cd ]
...
block_.L_4134f1:                                  ; preds = %block_.L_4134c1
  ...
  %call2_4134f4 = tail call %struct.Memory* @sub_40c100._Z9check_sumIiEvT_(%struct.State* %0, i64 %326, %struct.Memory* %MEMORY.2)
...
block_.L_413507:                                  ; preds = %block_.L_41346f
  ...
  %call2_413507 = tail call %struct.Memory* @sub_400df0._Z5timerv(%struct.State* %0, i64 %364, %struct.Memory* %MEMORY.0)
  ...
  %call2_413510 = tail call %struct.Memory* @sub_400790._Z13record_resultdPKc(%struct.State* %0, i64 %375, %struct.Memory* %call2_413507)
