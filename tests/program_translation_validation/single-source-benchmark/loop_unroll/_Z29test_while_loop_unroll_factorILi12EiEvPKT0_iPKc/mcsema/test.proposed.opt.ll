...
define %struct.Memory* @_Z29test_while_loop_unroll_factorILi12EiEvPKT0_iPKc(%struct.State* noalias, i64, %struct.Memory* noalias readnone) local_unnamed_addr #1 {
entry:
...
block_.L_41349f:                                  ; preds = %block_.L_413521, %entry
  %68 = phi i64 [ %361, %block_.L_413521 ], [ %.pre, %entry ]
...
block_.L_4134bd:                                  ; preds = %block_4134ce, %block_4134af
  %111 = phi i64 [ %194, %block_4134ce ], [ %.pre9, %block_4134af ]
...
block_4134ce:                                     ; preds = %block_.L_4134bd
  ...
  %call2_4134d9 = tail call %struct.Memory* @sub_40c900._ZN15loop_inner_bodyILi12EiE7do_workERiPKii(%struct.State* nonnull %0, i64 %159, %struct.Memory* %call2_413493)
...
block_4134fd:                                     ; preds = %block_.L_4134f1
  ...
  %call2_413508 = tail call %struct.Memory* @sub_40c100._Z18complete_hash_funcIiET_S0_(%struct.State* nonnull %0, i64 %246, %struct.Memory* %call2_413493)
...
block_.L_413521:                                  ; preds = %block_.L_4134f1
  ...
  %call2_413524 = tail call %struct.Memory* @sub_40c130._Z9check_sumIiEvT_(%struct.State* nonnull %0, i64 %325, %struct.Memory* %call2_413493)
...
block_.L_413537:                                  ; preds = %block_.L_41349f
  ...
  %call2_413537 = tail call %struct.Memory* @sub_400e20._Z5timerv(%struct.State* nonnull %0, i64 %362, %struct.Memory* %call2_413493)
