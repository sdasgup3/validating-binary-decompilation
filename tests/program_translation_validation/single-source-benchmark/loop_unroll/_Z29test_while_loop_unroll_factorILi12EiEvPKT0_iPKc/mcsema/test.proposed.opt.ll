...
entry:
  ...
  %call2_413463 = tail call %struct.Memory* @sub_400dd0._Z11start_timerv(%struct.State* %0, i64 %58, %struct.Memory* %2)
...
block_.L_41346f:                                  ; preds = %block_.L_4134f1, %entry
  %68 = phi i64 [ %.pre, %entry ], [ %361, %block_.L_4134f1 ]
  %MEMORY.0 = phi %struct.Memory* [ %call2_413463, %entry ], [ %call2_4134f4, %block_.L_4134f1 ]
  ...
  br i1 %101, label %block_41347f, label %block_.L_413507
...
block_.L_41348d:                                  ; preds = %block_41349e, %block_41347f
  %111 = phi i64 [ %.pre1, %block_41347f ], [ %194, %block_41349e ]
  %MEMORY.1 = phi %struct.Memory* [ %MEMORY.0, %block_41347f ], [ %call2_4134a9, %block_41349e ]
  ...
  br i1 %149, label %block_41349e, label %block_.L_4134bc
...
block_41349e:                                     ; preds = %block_.L_41348d
  ...
  %call2_4134a9 = tail call %struct.Memory* @sub_40c8d0._ZN15loop_inner_bodyILi12EiE7do_workERiPKii(%struct.State* %0, i64 %159, %struct.Memory* %MEMORY.1)
...
block_.L_4134c1:                                  ; preds = %block_4134cd, %block_.L_4134bc
  %196 = phi i64 [ %195, %block_.L_4134bc ], [ %319, %block_4134cd ]
  %197 = phi i64 [ %112, %block_.L_4134bc ], [ %.pre2, %block_4134cd ]
  %MEMORY.2 = phi %struct.Memory* [ %MEMORY.1, %block_.L_4134bc ], [ %call2_4134d8, %block_4134cd ]
  %198 = add i64 %197, -36
  %199 = add i64 %196, 3
  ...
  br i1 %232, label %block_4134cd, label %block_.L_4134f1
...
block_4134cd:                                     ; preds = %block_.L_4134c1
  ...
  %call2_4134d8 = tail call %struct.Memory* @sub_40c0d0._Z18complete_hash_funcIiET_S0_(%struct.State* %0, i64 %247, %struct.Memory* %MEMORY.2)
...
block_.L_4134f1:                                  ; preds = %block_.L_4134c1
  ...
  %call2_4134f4 = tail call %struct.Memory* @sub_40c100._Z9check_sumIiEvT_(%struct.State* %0, i64 %325, %struct.Memory* %MEMORY.2)
...
block_.L_413507:                                  ; preds = %block_.L_41346f
  ...
  %call2_413507 = tail call %struct.Memory* @sub_400df0._Z5timerv(%struct.State* %0, i64 %362, %struct.Memory* %MEMORY.0)
  ...
  %call2_413510 = tail call %struct.Memory* @sub_400790._Z13record_resultdPKc(%struct.State* %0, i64 %373, %struct.Memory* %call2_413507)
  ...
  ret %struct.Memory* %call2_413510
}
...
define %struct.Memory* @routine_jge_.L_413507(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i8* %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
...
define %struct.Memory* @routine_jge_.L_4134bc(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i8* %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 2, i32 9
...
define %struct.Memory* @routine_jmpq_.L_41348d(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
...
define %struct.Memory* @routine_jmpq_.L_4134c1(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
...
define %struct.Memory* @routine_jge_.L_4134f1(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i8* %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 2, i32 9
...
define %struct.Memory* @routine_jmpq_.L_41346f(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
