...
entry:
  ...
  %call2_4134a3 = tail call %struct.Memory* @sub_400e10._Z11start_timerv(%struct.State* %0, i64 %58, %struct.Memory* %2)
...
block_.L_4134af:                                  ; preds = %block_.L_413531, %entry
  %68 = phi i64 [ %361, %block_.L_413531 ], [ %.pre, %entry ]
  ...
  br i1 %101, label %block_4134bf, label %block_.L_413547
...
block_.L_4134cd:                                  ; preds = %block_4134de, %block_4134bf
  %111 = phi i64 [ %194, %block_4134de ], [ %.pre9, %block_4134bf ]
  ...
  br i1 %149, label %block_4134de, label %block_.L_4134fc
...
block_4134de:                                     ; preds = %block_.L_4134cd
  ...
  %call2_4134e9 = tail call %struct.Memory* @sub_40c910._ZN15loop_inner_bodyILi12EiE7do_workERiPKii(%struct.State* nonnull %0, i64 %159, %struct.Memory* %call2_4134a3)
...
block_.L_413501:                                  ; preds = %block_41350d, %block_.L_4134fc
  %196 = phi i64 [ %112, %block_.L_4134fc ], [ %.pre10, %block_41350d ]
  %storemerge = phi i64 [ %195, %block_.L_4134fc ], [ %318, %block_41350d ]
  %197 = add i64 %196, -36
  ...
  br i1 %231, label %block_41350d, label %block_.L_413531
...
block_41350d:                                     ; preds = %block_.L_413501
  ...
  %call2_413518 = tail call %struct.Memory* @sub_40c110._Z18complete_hash_funcIiET_S0_(%struct.State* nonnull %0, i64 %246, %struct.Memory* %call2_4134a3)
...
block_.L_413531:                                  ; preds = %block_.L_413501
  ...
  %call2_413534 = tail call %struct.Memory* @sub_40c140._Z9check_sumIiEvT_(%struct.State* nonnull %0, i64 %325, %struct.Memory* %call2_4134a3)
...
block_.L_413547:                                  ; preds = %block_.L_4134af
  ...
  %call2_413547 = tail call %struct.Memory* @sub_400e30._Z5timerv(%struct.State* nonnull %0, i64 %362, %struct.Memory* %call2_4134a3)
  ...
  %call2_413550 = tail call %struct.Memory* @sub_4007d0._Z13record_resultdPKc(%struct.State* nonnull %0, i64 %373, %struct.Memory* %call2_413547)
