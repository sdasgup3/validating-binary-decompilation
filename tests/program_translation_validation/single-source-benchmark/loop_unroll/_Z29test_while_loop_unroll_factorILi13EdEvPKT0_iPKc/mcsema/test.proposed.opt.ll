...
block_.L_408abf:                                  ; preds = %block_.L_408b48, %entry
  %79 = phi i64 [ %.pre, %entry ], [ %345, %block_.L_408b48 ]
...
block_.L_408b12:                                  ; preds = %block_408b1e, %block_.L_408b0d
  %209 = phi i64 [ %208, %block_.L_408b0d ], [ %304, %block_408b1e ]
...
block_408b1e:                                     ; preds = %block_.L_408b12
  ...
  %call2_408b2b = tail call %struct.Memory* @sub_401480._Z18complete_hash_funcIdET_S0_(%struct.State* %0, i64 %259, %struct.Memory* %MEMORY.2)
  ...
  store i64 %280, i64* %RDX.i96, align 8
...
block_.L_408b48:                                  ; preds = %block_.L_408b12
  ...
  %call2_408b4d = tail call %struct.Memory* @sub_4014b0._Z9check_sumIdEvT_(%struct.State* %0, i64 %309, %struct.Memory* %MEMORY.2)
  ...
  store i64 %321, i64* %RAX.i90, align 8
...
block_.L_408b60:                                  ; preds = %block_.L_408abf
  ...
  %call2_408b60 = tail call %struct.Memory* @sub_400df0._Z5timerv(%struct.State* %0, i64 %346, %struct.Memory* %MEMORY.0)
  ...
  store i64 %356, i64* %RDI.i101, align 8
  %357 = add i64 %353, -33749
  %358 = add i64 %353, 9
  ...
  %call2_408b69 = tail call %struct.Memory* @sub_400790._Z13record_resultdPKc(%struct.State* %0, i64 %357, %struct.Memory* %call2_408b60)
