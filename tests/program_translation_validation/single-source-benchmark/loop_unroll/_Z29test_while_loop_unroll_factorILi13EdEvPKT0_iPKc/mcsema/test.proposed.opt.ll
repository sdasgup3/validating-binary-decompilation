...
declare %struct.Memory* @sub_401ce0._ZN15loop_inner_bodyILi13EdE7do_workERdPKdi(%struct.State* noalias dereferenceable(3376), i64, %struct.Memory* noalias readnone returned) local_unnamed_addr
...
block_.L_408aef:                                  ; preds = %block_.L_408b78, %entry
  %74 = phi i64 [ %340, %block_.L_408b78 ], [ %.pre, %entry ]
...
block_.L_408b0e:                                  ; preds = %block_408b1f, %block_408aff
  %118 = phi i64 [ %201, %block_408b1f ], [ %.pre9, %block_408aff ]
...
block_408b1f:                                     ; preds = %block_.L_408b0e
  ...
  %call2_408b2a = tail call %struct.Memory* @sub_401ce0._ZN15loop_inner_bodyILi13EdE7do_workERdPKdi(%struct.State* nonnull %0, i64 %166, %struct.Memory* %call2_408ae3)
...
block_408b4e:                                     ; preds = %block_.L_408b42
  ...
  %call2_408b5b = tail call %struct.Memory* @sub_4014b0._Z18complete_hash_funcIdET_S0_(%struct.State* nonnull %0, i64 %252, %struct.Memory* %call2_408ae3)
...
block_.L_408b78:                                  ; preds = %block_.L_408b42
  ...
  %call2_408b7d = tail call %struct.Memory* @sub_4014e0._Z9check_sumIdEvT_(%struct.State* nonnull %0, i64 %304, %struct.Memory* %call2_408ae3)
...
block_.L_408b90:                                  ; preds = %block_.L_408aef
  ...
  %call2_408b90 = tail call %struct.Memory* @sub_400e20._Z5timerv(%struct.State* nonnull %0, i64 %341, %struct.Memory* %call2_408ae3)
