...
declare %struct.Memory* @sub_401cf0._ZN15loop_inner_bodyILi13EdE7do_workERdPKdi(%struct.State* noalias dereferenceable(3376), i64, %struct.Memory* noalias readnone returned) local_unnamed_addr
...
define %struct.Memory* @_Z29test_while_loop_unroll_factorILi13EdEvPKT0_iPKc(%struct.State* noalias, i64, %struct.Memory* noalias readnone) local_unnamed_addr #1 {
entry:
  ...
  %call2_408af3 = tail call %struct.Memory* @sub_400e10._Z11start_timerv(%struct.State* %0, i64 %58, %struct.Memory* %2)
  ...
  br label %block_.L_408aff

block_.L_408aff:                                  ; preds = %block_.L_408b88, %entry
  %74 = phi i64 [ %340, %block_.L_408b88 ], [ %.pre, %entry ]
  ...
  br i1 %107, label %block_408b0f, label %block_.L_408ba0

block_408b0f:                                     ; preds = %block_.L_408aff
  ...
  br label %block_.L_408b1e

block_.L_408b1e:                                  ; preds = %block_408b2f, %block_408b0f
  %118 = phi i64 [ %201, %block_408b2f ], [ %.pre9, %block_408b0f ]
  ...
  br i1 %156, label %block_408b2f, label %block_.L_408b4d

block_408b2f:                                     ; preds = %block_.L_408b1e
  %158 = add i64 %119, -40
  ...
  %call2_408b3a = tail call %struct.Memory* @sub_401cf0._ZN15loop_inner_bodyILi13EdE7do_workERdPKdi(%struct.State* nonnull %0, i64 %166, %struct.Memory* %call2_408af3)
...
block_.L_408b4d:                                  ; preds = %block_.L_408b1e
  %202 = add i64 %157, 5
  br label %block_.L_408b52

block_.L_408b52:                                  ; preds = %block_408b5e, %block_.L_408b4d
  %203 = phi i64 [ %119, %block_.L_408b4d ], [ %.pre10, %block_408b5e ]
  %storemerge = phi i64 [ %202, %block_.L_408b4d ], [ %298, %block_408b5e ]
  %204 = add i64 %203, -44
  ...
  br i1 %238, label %block_408b5e, label %block_.L_408b88
...
block_408b5e:                                     ; preds = %block_.L_408b52
  ...
  %call2_408b6b = tail call %struct.Memory* @sub_4014c0._Z18complete_hash_funcIdET_S0_(%struct.State* nonnull %0, i64 %252, %struct.Memory* %call2_408af3)
...
block_.L_408b88:                                  ; preds = %block_.L_408b52
  ...
  %call2_408b8d = tail call %struct.Memory* @sub_4014f0._Z9check_sumIdEvT_(%struct.State* nonnull %0, i64 %304, %struct.Memory* %call2_408af3)
...
block_.L_408ba0:                                  ; preds = %block_.L_408aff
  ...
  %call2_408ba0 = tail call %struct.Memory* @sub_400e30._Z5timerv(%struct.State* nonnull %0, i64 %341, %struct.Memory* %call2_408af3)
  ...
  %call2_408ba9 = tail call %struct.Memory* @sub_4007d0._Z13record_resultdPKc(%struct.State* nonnull %0, i64 %352, %struct.Memory* %call2_408ba0)
