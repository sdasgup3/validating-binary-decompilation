...
entry:
  ...
  %call2_413343 = tail call %struct.Memory* @sub_400dd0._Z11start_timerv(%struct.State* %0, i64 %58, %struct.Memory* %2)
...
block_.L_41334f:                                  ; preds = %block_.L_4133d1, %entry
  %68 = phi i64 [ %.pre, %entry ], [ %363, %block_.L_4133d1 ]
  %MEMORY.0 = phi %struct.Memory* [ %call2_413343, %entry ], [ %call2_4133d4, %block_.L_4133d1 ]
  ...
  br i1 %101, label %block_41335f, label %block_.L_4133e7

block_41335f:                                     ; preds = %block_.L_41334f
  %103 = add i64 %69, -32
  %104 = add i64 %102, 7
...
block_.L_41336d:                                  ; preds = %block_41337e, %block_41335f
  %111 = phi i64 [ %.pre1, %block_41335f ], [ %194, %block_41337e ]
  %MEMORY.1 = phi %struct.Memory* [ %MEMORY.0, %block_41335f ], [ %call2_413389, %block_41337e ]
  ...
  br i1 %149, label %block_41337e, label %block_.L_41339c

block_41337e:                                     ; preds = %block_.L_41336d
  %151 = add i64 %112, -32
  ...
  %call2_413389 = tail call %struct.Memory* @sub_40c870._ZN15loop_inner_bodyILi13EiE7do_workERiPKii(%struct.State* %0, i64 %159, %struct.Memory* %MEMORY.1)
...
block_.L_41339c:                                  ; preds = %block_.L_41336d
  %195 = add i64 %150, 5
  store i64 %195, i64* %3, align 8
  br label %block_.L_4133a1

block_.L_4133a1:                                  ; preds = %block_4133ad, %block_.L_41339c
  %196 = phi i64 [ %195, %block_.L_41339c ], [ %320, %block_4133ad ]
  %197 = phi i64 [ %112, %block_.L_41339c ], [ %.pre2, %block_4133ad ]
  %MEMORY.2 = phi %struct.Memory* [ %MEMORY.1, %block_.L_41339c ], [ %call2_4133b8, %block_4133ad ]
  %198 = add i64 %197, -36
  %199 = add i64 %196, 3
  ...
  br i1 %232, label %block_4133ad, label %block_.L_4133d1

block_4133ad:                                     ; preds = %block_.L_4133a1
  %234 = add i64 %197, -8
  %235 = add i64 %233, 4
  ...
  %call2_4133b8 = tail call %struct.Memory* @sub_40c0d0._Z18complete_hash_funcIiET_S0_(%struct.State* %0, i64 %247, %struct.Memory* %MEMORY.2)
...
block_.L_4133d1:                                  ; preds = %block_.L_4133a1
  %321 = add i64 %197, -32
  %322 = add i64 %233, 3
  ...
  %call2_4133d4 = tail call %struct.Memory* @sub_40c100._Z9check_sumIiEvT_(%struct.State* %0, i64 %326, %struct.Memory* %MEMORY.2)
...
block_.L_4133e7:                                  ; preds = %block_.L_41334f
  %364 = add i64 %102, -75255
  %365 = add i64 %102, 5
  ...
  %call2_4133e7 = tail call %struct.Memory* @sub_400df0._Z5timerv(%struct.State* %0, i64 %364, %struct.Memory* %MEMORY.0)
  ...
  %call2_4133f0 = tail call %struct.Memory* @sub_400790._Z13record_resultdPKc(%struct.State* %0, i64 %375, %struct.Memory* %call2_4133e7)
  ...
  ret %struct.Memory* %call2_4133f0
}
...
define %struct.Memory* @routine_jge_.L_4133e7(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i8* %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
...
define %struct.Memory* @routine_jge_.L_41339c(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i8* %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 2, i32 9
...
define %struct.Memory* @routine_jmpq_.L_41336d(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
...
define %struct.Memory* @routine_jmpq_.L_4133a1(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
...
define %struct.Memory* @routine_jge_.L_4133d1(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i8* %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 2, i32 9
...
define %struct.Memory* @routine_jmpq_.L_41334f(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
