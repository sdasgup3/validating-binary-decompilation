...
block_.L_41334f:                                  ; preds = %block_.L_4133d1, %entry
  %68 = phi i64 [ %.pre, %entry ], [ %361, %block_.L_4133d1 ]
...
block_.L_4133a1:                                  ; preds = %block_4133ad, %block_.L_41339c
  %196 = phi i64 [ %195, %block_.L_41339c ], [ %319, %block_4133ad ]
...
block_.L_4133d1:                                  ; preds = %block_.L_4133a1
  ...
  %call2_4133d4 = tail call %struct.Memory* @sub_40c100._Z9check_sumIiEvT_(%struct.State* %0, i64 %325, %struct.Memory* %MEMORY.2)
...
block_.L_4133e7:                                  ; preds = %block_.L_41334f
  ...
  %call2_4133e7 = tail call %struct.Memory* @sub_400df0._Z5timerv(%struct.State* %0, i64 %362, %struct.Memory* %MEMORY.0)
  ...
  %call2_4133f0 = tail call %struct.Memory* @sub_400790._Z13record_resultdPKc(%struct.State* %0, i64 %373, %struct.Memory* %call2_4133e7)
