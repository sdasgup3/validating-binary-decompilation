...
block_.L_40898f:                                  ; preds = %block_.L_408a18, %entry
  %79 = phi i64 [ %.pre, %entry ], [ %349, %block_.L_408a18 ]
...
block_.L_4089e2:                                  ; preds = %block_4089ee, %block_.L_4089dd
  %209 = phi i64 [ %208, %block_.L_4089dd ], [ %306, %block_4089ee ]
...
block_4089ee:                                     ; preds = %block_.L_4089e2
  ...
  %call2_4089fb = tail call %struct.Memory* @sub_401480._Z18complete_hash_funcIdET_S0_(%struct.State* %0, i64 %260, %struct.Memory* %MEMORY.2)
...
block_.L_408a18:                                  ; preds = %block_.L_4089e2
  ...
  %call2_408a1d = tail call %struct.Memory* @sub_4014b0._Z9check_sumIdEvT_(%struct.State* %0, i64 %312, %struct.Memory* %MEMORY.2)
...
block_.L_408a30:                                  ; preds = %block_.L_40898f
  ...
  %call2_408a30 = tail call %struct.Memory* @sub_400df0._Z5timerv(%struct.State* %0, i64 %350, %struct.Memory* %MEMORY.0)
  ...
  %call2_408a39 = tail call %struct.Memory* @sub_400790._Z13record_resultdPKc(%struct.State* %0, i64 %361, %struct.Memory* %call2_408a30)
