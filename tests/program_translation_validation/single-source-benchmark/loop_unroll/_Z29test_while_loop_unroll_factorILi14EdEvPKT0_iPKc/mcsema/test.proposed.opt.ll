...
define %struct.Memory* @_Z29test_while_loop_unroll_factorILi14EdEvPKT0_iPKc(%struct.State* noalias, i64, %struct.Memory* noalias readnone) local_unnamed_addr #1 {
entry:
...
block_.L_4089bf:                                  ; preds = %block_.L_408a48, %entry
  %74 = phi i64 [ %340, %block_.L_408a48 ], [ %.pre, %entry ]
...
block_.L_4089de:                                  ; preds = %block_4089ef, %block_4089cf
  %118 = phi i64 [ %201, %block_4089ef ], [ %.pre9, %block_4089cf ]
...
block_4089ef:                                     ; preds = %block_.L_4089de
  ...
  %call2_4089fa = tail call %struct.Memory* @sub_401c80._ZN15loop_inner_bodyILi14EdE7do_workERdPKdi(%struct.State* nonnull %0, i64 %166, %struct.Memory* %call2_4089b3)
...
block_408a1e:                                     ; preds = %block_.L_408a12
  ...
  %call2_408a2b = tail call %struct.Memory* @sub_4014b0._Z18complete_hash_funcIdET_S0_(%struct.State* nonnull %0, i64 %252, %struct.Memory* %call2_4089b3)
...
block_.L_408a48:                                  ; preds = %block_.L_408a12
  ...
  %call2_408a4d = tail call %struct.Memory* @sub_4014e0._Z9check_sumIdEvT_(%struct.State* nonnull %0, i64 %304, %struct.Memory* %call2_4089b3)
...
block_.L_408a60:                                  ; preds = %block_.L_4089bf
  ...
  %call2_408a60 = tail call %struct.Memory* @sub_400e20._Z5timerv(%struct.State* nonnull %0, i64 %341, %struct.Memory* %call2_4089b3)
