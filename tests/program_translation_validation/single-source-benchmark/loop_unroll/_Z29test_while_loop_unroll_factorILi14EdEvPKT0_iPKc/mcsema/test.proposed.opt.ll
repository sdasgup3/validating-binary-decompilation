...
entry:
  ...
  %call2_408983 = tail call %struct.Memory* @sub_400dd0._Z11start_timerv(%struct.State* %0, i64 %58, %struct.Memory* %2)
...
block_.L_40898f:                                  ; preds = %block_.L_408a18, %entry
  %79 = phi i64 [ %.pre, %entry ], [ %345, %block_.L_408a18 ]
  %MEMORY.0 = phi %struct.Memory* [ %call2_408983, %entry ], [ %call2_408a1d, %block_.L_408a18 ]
  ...
  br i1 %112, label %block_40899f, label %block_.L_408a30
...
block_.L_4089ae:                                  ; preds = %block_4089bf, %block_40899f
  %124 = phi i64 [ %.pre1, %block_40899f ], [ %207, %block_4089bf ]
  %MEMORY.1 = phi %struct.Memory* [ %MEMORY.0, %block_40899f ], [ %call2_4089ca, %block_4089bf ]
  ...
  br i1 %162, label %block_4089bf, label %block_.L_4089dd
...
block_4089bf:                                     ; preds = %block_.L_4089ae
  ...
  %call2_4089ca = tail call %struct.Memory* @sub_401c50._ZN15loop_inner_bodyILi14EdE7do_workERdPKdi(%struct.State* %0, i64 %172, %struct.Memory* %MEMORY.1)
...
block_.L_4089e2:                                  ; preds = %block_4089ee, %block_.L_4089dd
  %209 = phi i64 [ %208, %block_.L_4089dd ], [ %304, %block_4089ee ]
  %210 = phi i64 [ %125, %block_.L_4089dd ], [ %.pre2, %block_4089ee ]
  %MEMORY.2 = phi %struct.Memory* [ %MEMORY.1, %block_.L_4089dd ], [ %call2_4089fb, %block_4089ee ]
  %211 = add i64 %210, -44
  %212 = add i64 %209, 3
  ...
  br i1 %245, label %block_4089ee, label %block_.L_408a18
...
block_4089ee:                                     ; preds = %block_.L_4089e2
  ...
  %call2_4089fb = tail call %struct.Memory* @sub_401480._Z18complete_hash_funcIdET_S0_(%struct.State* %0, i64 %259, %struct.Memory* %MEMORY.2)
...
block_.L_408a18:                                  ; preds = %block_.L_4089e2
  ...
  %call2_408a1d = tail call %struct.Memory* @sub_4014b0._Z9check_sumIdEvT_(%struct.State* %0, i64 %309, %struct.Memory* %MEMORY.2)
...
block_.L_408a30:                                  ; preds = %block_.L_40898f
  ...
  %call2_408a30 = tail call %struct.Memory* @sub_400df0._Z5timerv(%struct.State* %0, i64 %346, %struct.Memory* %MEMORY.0)
  ...
  %call2_408a39 = tail call %struct.Memory* @sub_400790._Z13record_resultdPKc(%struct.State* %0, i64 %357, %struct.Memory* %call2_408a30)
  ...
  ret %struct.Memory* %call2_408a39
}
...
define %struct.Memory* @routine_jge_.L_408a30(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i8* %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
...
define %struct.Memory* @routine_jge_.L_4089dd(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i8* %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 2, i32 9
...
define %struct.Memory* @routine_jmpq_.L_4089ae(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
...
define %struct.Memory* @routine_jmpq_.L_4089e2(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
...
define %struct.Memory* @routine_jge_.L_408a18(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i8* %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 2, i32 9
...
define %struct.Memory* @routine_jmpq_.L_40898f(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
