...
entry:
  ...
  %call2_4089c3 = tail call %struct.Memory* @sub_400e10._Z11start_timerv(%struct.State* %0, i64 %58, %struct.Memory* %2)
...
block_.L_4089cf:                                  ; preds = %block_.L_408a58, %entry
  %74 = phi i64 [ %340, %block_.L_408a58 ], [ %.pre, %entry ]
  ...
  br i1 %107, label %block_4089df, label %block_.L_408a70
...
block_.L_4089ee:                                  ; preds = %block_4089ff, %block_4089df
  %118 = phi i64 [ %201, %block_4089ff ], [ %.pre9, %block_4089df ]
  ...
  br i1 %156, label %block_4089ff, label %block_.L_408a1d
...
block_4089ff:                                     ; preds = %block_.L_4089ee
  ...
  %call2_408a0a = tail call %struct.Memory* @sub_401c90._ZN15loop_inner_bodyILi14EdE7do_workERdPKdi(%struct.State* nonnull %0, i64 %166, %struct.Memory* %call2_4089c3)
...
block_.L_408a22:                                  ; preds = %block_408a2e, %block_.L_408a1d
  %203 = phi i64 [ %119, %block_.L_408a1d ], [ %.pre10, %block_408a2e ]
  %storemerge = phi i64 [ %202, %block_.L_408a1d ], [ %298, %block_408a2e ]
  %204 = add i64 %203, -44
  ...
  br i1 %238, label %block_408a2e, label %block_.L_408a58
...
block_408a2e:                                     ; preds = %block_.L_408a22
  ...
  %call2_408a3b = tail call %struct.Memory* @sub_4014c0._Z18complete_hash_funcIdET_S0_(%struct.State* nonnull %0, i64 %252, %struct.Memory* %call2_4089c3)
...
block_.L_408a58:                                  ; preds = %block_.L_408a22
  ...
  %call2_408a5d = tail call %struct.Memory* @sub_4014f0._Z9check_sumIdEvT_(%struct.State* nonnull %0, i64 %304, %struct.Memory* %call2_4089c3)
...
block_.L_408a70:                                  ; preds = %block_.L_4089cf
  ...
  %call2_408a70 = tail call %struct.Memory* @sub_400e30._Z5timerv(%struct.State* nonnull %0, i64 %341, %struct.Memory* %call2_4089c3)
  ...
  %call2_408a79 = tail call %struct.Memory* @sub_4007d0._Z13record_resultdPKc(%struct.State* nonnull %0, i64 %352, %struct.Memory* %call2_408a70)
