...
define %struct.Memory* @_Z29test_while_loop_unroll_factorILi14EiEvPKT0_iPKc(%struct.State* noalias, i64, %struct.Memory* noalias readnone) local_unnamed_addr #1 {
entry:
...
block_.L_41325f:                                  ; preds = %block_.L_4132e1, %entry
  %68 = phi i64 [ %361, %block_.L_4132e1 ], [ %.pre, %entry ]
...
block_.L_41327d:                                  ; preds = %block_41328e, %block_41326f
  %111 = phi i64 [ %194, %block_41328e ], [ %.pre9, %block_41326f ]
...
block_41328e:                                     ; preds = %block_.L_41327d
  ...
  %call2_413299 = tail call %struct.Memory* @sub_40c840._ZN15loop_inner_bodyILi14EiE7do_workERiPKii(%struct.State* nonnull %0, i64 %159, %struct.Memory* %call2_413253)
...
block_4132bd:                                     ; preds = %block_.L_4132b1
  ...
  %call2_4132c8 = tail call %struct.Memory* @sub_40c100._Z18complete_hash_funcIiET_S0_(%struct.State* nonnull %0, i64 %246, %struct.Memory* %call2_413253)
...
block_.L_4132e1:                                  ; preds = %block_.L_4132b1
  ...
  %call2_4132e4 = tail call %struct.Memory* @sub_40c130._Z9check_sumIiEvT_(%struct.State* nonnull %0, i64 %325, %struct.Memory* %call2_413253)
...
block_.L_4132f7:                                  ; preds = %block_.L_41325f
  ...
  %call2_4132f7 = tail call %struct.Memory* @sub_400e20._Z5timerv(%struct.State* nonnull %0, i64 %362, %struct.Memory* %call2_413253)
