...
entry:
  ...
  %call2_413223 = tail call %struct.Memory* @sub_400dd0._Z11start_timerv(%struct.State* %0, i64 %58, %struct.Memory* %2)
...
block_.L_41322f:                                  ; preds = %block_.L_4132b1, %entry
  %68 = phi i64 [ %.pre, %entry ], [ %363, %block_.L_4132b1 ]
  %MEMORY.0 = phi %struct.Memory* [ %call2_413223, %entry ], [ %call2_4132b4, %block_.L_4132b1 ]
  ...
  br i1 %101, label %block_41323f, label %block_.L_4132c7
...
block_.L_41324d:                                  ; preds = %block_41325e, %block_41323f
  %111 = phi i64 [ %.pre1, %block_41323f ], [ %194, %block_41325e ]
  %MEMORY.1 = phi %struct.Memory* [ %MEMORY.0, %block_41323f ], [ %call2_413269, %block_41325e ]
  ...
  br i1 %149, label %block_41325e, label %block_.L_41327c
...
block_41325e:                                     ; preds = %block_.L_41324d
  ...
  %call2_413269 = tail call %struct.Memory* @sub_40c810._ZN15loop_inner_bodyILi14EiE7do_workERiPKii(%struct.State* %0, i64 %159, %struct.Memory* %MEMORY.1)
...
block_.L_413281:                                  ; preds = %block_41328d, %block_.L_41327c
  %196 = phi i64 [ %195, %block_.L_41327c ], [ %320, %block_41328d ]
  %197 = phi i64 [ %112, %block_.L_41327c ], [ %.pre2, %block_41328d ]
  %MEMORY.2 = phi %struct.Memory* [ %MEMORY.1, %block_.L_41327c ], [ %call2_413298, %block_41328d ]
  %198 = add i64 %197, -36
  %199 = add i64 %196, 3
  ...
  br i1 %232, label %block_41328d, label %block_.L_4132b1
...
block_41328d:                                     ; preds = %block_.L_413281
  ...
  %call2_413298 = tail call %struct.Memory* @sub_40c0d0._Z18complete_hash_funcIiET_S0_(%struct.State* %0, i64 %247, %struct.Memory* %MEMORY.2)
...
block_.L_4132b1:                                  ; preds = %block_.L_413281
  ...
  %call2_4132b4 = tail call %struct.Memory* @sub_40c100._Z9check_sumIiEvT_(%struct.State* %0, i64 %326, %struct.Memory* %MEMORY.2)
...
block_.L_4132c7:                                  ; preds = %block_.L_41322f
  ...
  %call2_4132c7 = tail call %struct.Memory* @sub_400df0._Z5timerv(%struct.State* %0, i64 %364, %struct.Memory* %MEMORY.0)
  ...
  %call2_4132d0 = tail call %struct.Memory* @sub_400790._Z13record_resultdPKc(%struct.State* %0, i64 %375, %struct.Memory* %call2_4132c7)
  ...
  ret %struct.Memory* %call2_4132d0
}
...
define %struct.Memory* @routine_jge_.L_4132c7(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i8* %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
...
define %struct.Memory* @routine_jge_.L_41327c(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i8* %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 2, i32 9
...
define %struct.Memory* @routine_jmpq_.L_41324d(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
...
define %struct.Memory* @routine_jmpq_.L_413281(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
...
define %struct.Memory* @routine_jge_.L_4132b1(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i8* %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 2, i32 9
...
define %struct.Memory* @routine_jmpq_.L_41322f(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
