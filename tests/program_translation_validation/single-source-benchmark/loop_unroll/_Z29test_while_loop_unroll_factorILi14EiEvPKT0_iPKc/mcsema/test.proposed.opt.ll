...
block_.L_41322f:                                  ; preds = %block_.L_4132b1, %entry
  %68 = phi i64 [ %.pre, %entry ], [ %361, %block_.L_4132b1 ]
...
block_.L_413281:                                  ; preds = %block_41328d, %block_.L_41327c
  %196 = phi i64 [ %195, %block_.L_41327c ], [ %319, %block_41328d ]
...
block_.L_4132b1:                                  ; preds = %block_.L_413281
  ...
  %call2_4132b4 = tail call %struct.Memory* @sub_40c100._Z9check_sumIiEvT_(%struct.State* %0, i64 %325, %struct.Memory* %MEMORY.2)
...
block_.L_4132c7:                                  ; preds = %block_.L_41322f
  ...
  %call2_4132c7 = tail call %struct.Memory* @sub_400df0._Z5timerv(%struct.State* %0, i64 %362, %struct.Memory* %MEMORY.0)
  ...
  %call2_4132d0 = tail call %struct.Memory* @sub_400790._Z13record_resultdPKc(%struct.State* %0, i64 %373, %struct.Memory* %call2_4132c7)
