...
block_.L_40885f:                                  ; preds = %block_.L_4088e8, %entry
  %79 = phi i64 [ %.pre, %entry ], [ %349, %block_.L_4088e8 ]
...
block_.L_4088b2:                                  ; preds = %block_4088be, %block_.L_4088ad
  %209 = phi i64 [ %208, %block_.L_4088ad ], [ %306, %block_4088be ]
...
block_4088be:                                     ; preds = %block_.L_4088b2
  ...
  %call2_4088cb = tail call %struct.Memory* @sub_401480._Z18complete_hash_funcIdET_S0_(%struct.State* %0, i64 %260, %struct.Memory* %MEMORY.2)
...
block_.L_4088e8:                                  ; preds = %block_.L_4088b2
  ...
  %call2_4088ed = tail call %struct.Memory* @sub_4014b0._Z9check_sumIdEvT_(%struct.State* %0, i64 %312, %struct.Memory* %MEMORY.2)
...
block_.L_408900:                                  ; preds = %block_.L_40885f
  ...
  %call2_408900 = tail call %struct.Memory* @sub_400df0._Z5timerv(%struct.State* %0, i64 %350, %struct.Memory* %MEMORY.0)
  ...
  %call2_408909 = tail call %struct.Memory* @sub_400790._Z13record_resultdPKc(%struct.State* %0, i64 %361, %struct.Memory* %call2_408900)
