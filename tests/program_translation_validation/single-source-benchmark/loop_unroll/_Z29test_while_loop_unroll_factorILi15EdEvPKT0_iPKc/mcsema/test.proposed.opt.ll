...
entry:
  ...
  %call2_408853 = tail call %struct.Memory* @sub_400dd0._Z11start_timerv(%struct.State* %0, i64 %58, %struct.Memory* %2)
...
block_.L_40885f:                                  ; preds = %block_.L_4088e8, %entry
  %79 = phi i64 [ %.pre, %entry ], [ %345, %block_.L_4088e8 ]
  %MEMORY.0 = phi %struct.Memory* [ %call2_408853, %entry ], [ %call2_4088ed, %block_.L_4088e8 ]
  ...
  br i1 %112, label %block_40886f, label %block_.L_408900

block_40886f:                                     ; preds = %block_.L_40885f
...
block_.L_40887e:                                  ; preds = %block_40888f, %block_40886f
  %124 = phi i64 [ %.pre1, %block_40886f ], [ %207, %block_40888f ]
  %MEMORY.1 = phi %struct.Memory* [ %MEMORY.0, %block_40886f ], [ %call2_40889a, %block_40888f ]
  ...
  br i1 %162, label %block_40888f, label %block_.L_4088ad

block_40888f:                                     ; preds = %block_.L_40887e
  %164 = add i64 %125, -40
  ...
  %call2_40889a = tail call %struct.Memory* @sub_401bf0._ZN15loop_inner_bodyILi15EdE7do_workERdPKdi(%struct.State* %0, i64 %172, %struct.Memory* %MEMORY.1)
...
block_.L_4088ad:                                  ; preds = %block_.L_40887e
  %208 = add i64 %163, 5
  store i64 %208, i64* %3, align 8
  br label %block_.L_4088b2

block_.L_4088b2:                                  ; preds = %block_4088be, %block_.L_4088ad
  %209 = phi i64 [ %208, %block_.L_4088ad ], [ %304, %block_4088be ]
  %210 = phi i64 [ %125, %block_.L_4088ad ], [ %.pre2, %block_4088be ]
  %MEMORY.2 = phi %struct.Memory* [ %MEMORY.1, %block_.L_4088ad ], [ %call2_4088cb, %block_4088be ]
  %211 = add i64 %210, -44
  %212 = add i64 %209, 3
  ...
  br i1 %245, label %block_4088be, label %block_.L_4088e8

block_4088be:                                     ; preds = %block_.L_4088b2
  %247 = add i64 %210, -8
  %248 = add i64 %246, 4
  ...
  %call2_4088cb = tail call %struct.Memory* @sub_401480._Z18complete_hash_funcIdET_S0_(%struct.State* %0, i64 %259, %struct.Memory* %MEMORY.2)
...
block_.L_4088e8:                                  ; preds = %block_.L_4088b2
  %305 = add i64 %210, -40
  %306 = add i64 %246, 5
  ...
  %call2_4088ed = tail call %struct.Memory* @sub_4014b0._Z9check_sumIdEvT_(%struct.State* %0, i64 %309, %struct.Memory* %MEMORY.2)
...
block_.L_408900:                                  ; preds = %block_.L_40885f
  %346 = add i64 %113, -31504
  %347 = add i64 %113, 5
  ...
  %call2_408900 = tail call %struct.Memory* @sub_400df0._Z5timerv(%struct.State* %0, i64 %346, %struct.Memory* %MEMORY.0)
  ...
  %call2_408909 = tail call %struct.Memory* @sub_400790._Z13record_resultdPKc(%struct.State* %0, i64 %357, %struct.Memory* %call2_408900)
  ...
  ret %struct.Memory* %call2_408909
}
...
define %struct.Memory* @routine_jge_.L_408900(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i8* %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
...
define %struct.Memory* @routine_jge_.L_4088ad(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i8* %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 2, i32 9
...
define %struct.Memory* @routine_jmpq_.L_40887e(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
...
define %struct.Memory* @routine_jmpq_.L_4088b2(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
...
define %struct.Memory* @routine_jge_.L_4088e8(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i8* %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 2, i32 9
...
define %struct.Memory* @routine_jmpq_.L_40885f(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
