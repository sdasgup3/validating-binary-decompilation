...
define %struct.Memory* @_Z29test_while_loop_unroll_factorILi15EdEvPKT0_iPKc(%struct.State* noalias, i64, %struct.Memory* noalias readnone) local_unnamed_addr #1 {
entry:
...
block_.L_40888f:                                  ; preds = %block_.L_408918, %entry
  %74 = phi i64 [ %340, %block_.L_408918 ], [ %.pre, %entry ]
...
block_.L_4088ae:                                  ; preds = %block_4088bf, %block_40889f
  %118 = phi i64 [ %201, %block_4088bf ], [ %.pre9, %block_40889f ]
...
block_4088bf:                                     ; preds = %block_.L_4088ae
  ...
  %call2_4088ca = tail call %struct.Memory* @sub_401c20._ZN15loop_inner_bodyILi15EdE7do_workERdPKdi(%struct.State* nonnull %0, i64 %166, %struct.Memory* %call2_408883)
...
block_4088ee:                                     ; preds = %block_.L_4088e2
  ...
  %call2_4088fb = tail call %struct.Memory* @sub_4014b0._Z18complete_hash_funcIdET_S0_(%struct.State* nonnull %0, i64 %252, %struct.Memory* %call2_408883)
...
block_.L_408918:                                  ; preds = %block_.L_4088e2
  ...
  %call2_40891d = tail call %struct.Memory* @sub_4014e0._Z9check_sumIdEvT_(%struct.State* nonnull %0, i64 %304, %struct.Memory* %call2_408883)
...
block_.L_408930:                                  ; preds = %block_.L_40888f
  ...
  %call2_408930 = tail call %struct.Memory* @sub_400e20._Z5timerv(%struct.State* nonnull %0, i64 %341, %struct.Memory* %call2_408883)
