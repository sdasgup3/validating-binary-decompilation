...
define %struct.Memory* @_Z29test_while_loop_unroll_factorILi15EdEvPKT0_iPKc(%struct.State* noalias, i64, %struct.Memory* noalias) local_unnamed_addr #1 {
entry:
  ...
  %call2_408883 = tail call %struct.Memory* @sub_400e00._Z11start_timerv(%struct.State* %0, i64 %58, %struct.Memory* %2)
...
block_.L_40888f:                                  ; preds = %block_.L_408918, %entry
  %74 = phi i64 [ %.pre, %entry ], [ %340, %block_.L_408918 ]
  %MEMORY.0 = phi %struct.Memory* [ %call2_408883, %entry ], [ %call2_40891d, %block_.L_408918 ]
  ...
  br i1 %107, label %block_40889f, label %block_.L_408930

block_40889f:                                     ; preds = %block_.L_40888f
...
block_.L_4088ae:                                  ; preds = %block_4088bf, %block_40889f
  %118 = phi i64 [ %.pre9, %block_40889f ], [ %201, %block_4088bf ]
  %MEMORY.1 = phi %struct.Memory* [ %MEMORY.0, %block_40889f ], [ %call2_4088ca, %block_4088bf ]
  ...
  br i1 %156, label %block_4088bf, label %block_.L_4088dd

block_4088bf:                                     ; preds = %block_.L_4088ae
  %158 = add i64 %119, -40
  ...
  %call2_4088ca = tail call %struct.Memory* @sub_401c20._ZN15loop_inner_bodyILi15EdE7do_workERdPKdi(%struct.State* nonnull %0, i64 %166, %struct.Memory* %MEMORY.1)
...
block_.L_4088dd:                                  ; preds = %block_.L_4088ae
  %202 = add i64 %157, 5
  br label %block_.L_4088e2

block_.L_4088e2:                                  ; preds = %block_4088ee, %block_.L_4088dd
  %203 = phi i64 [ %119, %block_.L_4088dd ], [ %.pre10, %block_4088ee ]
  %storemerge = phi i64 [ %202, %block_.L_4088dd ], [ %298, %block_4088ee ]
  %MEMORY.2 = phi %struct.Memory* [ %MEMORY.1, %block_.L_4088dd ], [ %call2_4088fb, %block_4088ee ]
  %204 = add i64 %203, -44
  ...
  br i1 %238, label %block_4088ee, label %block_.L_408918

block_4088ee:                                     ; preds = %block_.L_4088e2
  %240 = add i64 %203, -8
  %241 = add i64 %239, 4
  ...
  %call2_4088fb = tail call %struct.Memory* @sub_4014b0._Z18complete_hash_funcIdET_S0_(%struct.State* nonnull %0, i64 %252, %struct.Memory* %MEMORY.2)
...
block_.L_408918:                                  ; preds = %block_.L_4088e2
  %300 = add i64 %203, -40
  %301 = add i64 %239, 5
  ...
  %call2_40891d = tail call %struct.Memory* @sub_4014e0._Z9check_sumIdEvT_(%struct.State* nonnull %0, i64 %304, %struct.Memory* %MEMORY.2)
...
block_.L_408930:                                  ; preds = %block_.L_40888f
  %341 = add i64 %108, -31504
  %342 = add i64 %108, 5
  ...
  %call2_408930 = tail call %struct.Memory* @sub_400e20._Z5timerv(%struct.State* nonnull %0, i64 %341, %struct.Memory* %MEMORY.0)
  ...
  %call2_408939 = tail call %struct.Memory* @sub_4007c0._Z13record_resultdPKc(%struct.State* nonnull %0, i64 %352, %struct.Memory* %call2_408930)
  ...
  ret %struct.Memory* %call2_408939
}
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_jge_.L_408930(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i8* nocapture %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_jge_.L_4088dd(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i8* nocapture %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 2, i32 9
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_jmpq_.L_4088ae(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_jmpq_.L_4088e2(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_jge_.L_408918(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i8* nocapture %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 2, i32 9
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_jmpq_.L_40888f(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
