...
entry:
  ...
  %call2_413103 = tail call %struct.Memory* @sub_400dd0._Z11start_timerv(%struct.State* %0, i64 %58, %struct.Memory* %2)
...
block_.L_41310f:                                  ; preds = %block_.L_413191, %entry
  %68 = phi i64 [ %.pre, %entry ], [ %363, %block_.L_413191 ]
  %MEMORY.0 = phi %struct.Memory* [ %call2_413103, %entry ], [ %call2_413194, %block_.L_413191 ]
  ...
  br i1 %101, label %block_41311f, label %block_.L_4131a7
...
block_.L_41312d:                                  ; preds = %block_41313e, %block_41311f
  %111 = phi i64 [ %.pre1, %block_41311f ], [ %194, %block_41313e ]
  %MEMORY.1 = phi %struct.Memory* [ %MEMORY.0, %block_41311f ], [ %call2_413149, %block_41313e ]
  ...
  br i1 %149, label %block_41313e, label %block_.L_41315c
...
block_41313e:                                     ; preds = %block_.L_41312d
  ...
  %call2_413149 = tail call %struct.Memory* @sub_40c7b0._ZN15loop_inner_bodyILi15EiE7do_workERiPKii(%struct.State* %0, i64 %159, %struct.Memory* %MEMORY.1)
...
block_.L_413161:                                  ; preds = %block_41316d, %block_.L_41315c
  %196 = phi i64 [ %195, %block_.L_41315c ], [ %320, %block_41316d ]
  %197 = phi i64 [ %112, %block_.L_41315c ], [ %.pre2, %block_41316d ]
  %MEMORY.2 = phi %struct.Memory* [ %MEMORY.1, %block_.L_41315c ], [ %call2_413178, %block_41316d ]
  %198 = add i64 %197, -36
  %199 = add i64 %196, 3
  ...
  br i1 %232, label %block_41316d, label %block_.L_413191
...
block_41316d:                                     ; preds = %block_.L_413161
  ...
  %call2_413178 = tail call %struct.Memory* @sub_40c0d0._Z18complete_hash_funcIiET_S0_(%struct.State* %0, i64 %247, %struct.Memory* %MEMORY.2)
...
block_.L_413191:                                  ; preds = %block_.L_413161
  ...
  %call2_413194 = tail call %struct.Memory* @sub_40c100._Z9check_sumIiEvT_(%struct.State* %0, i64 %326, %struct.Memory* %MEMORY.2)
...
block_.L_4131a7:                                  ; preds = %block_.L_41310f
  ...
  %call2_4131a7 = tail call %struct.Memory* @sub_400df0._Z5timerv(%struct.State* %0, i64 %364, %struct.Memory* %MEMORY.0)
  ...
  %call2_4131b0 = tail call %struct.Memory* @sub_400790._Z13record_resultdPKc(%struct.State* %0, i64 %375, %struct.Memory* %call2_4131a7)
  ...
  ret %struct.Memory* %call2_4131b0
}
...
define %struct.Memory* @routine_jge_.L_4131a7(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i8* %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
...
define %struct.Memory* @routine_jge_.L_41315c(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i8* %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 2, i32 9
...
define %struct.Memory* @routine_jmpq_.L_41312d(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
...
define %struct.Memory* @routine_jmpq_.L_413161(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
...
define %struct.Memory* @routine_jge_.L_413191(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i8* %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 2, i32 9
...
define %struct.Memory* @routine_jmpq_.L_41310f(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
