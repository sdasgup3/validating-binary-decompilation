...
define %struct.Memory* @_Z29test_while_loop_unroll_factorILi15EiEvPKT0_iPKc(%struct.State* noalias, i64, %struct.Memory* noalias readnone) local_unnamed_addr #1 {
entry:
  ...
  %call2_413143 = tail call %struct.Memory* @sub_400e10._Z11start_timerv(%struct.State* %0, i64 %58, %struct.Memory* %2)
...
block_.L_41314f:                                  ; preds = %block_.L_4131d1, %entry
  %68 = phi i64 [ %361, %block_.L_4131d1 ], [ %.pre, %entry ]
  ...
  br i1 %101, label %block_41315f, label %block_.L_4131e7
...
block_.L_41316d:                                  ; preds = %block_41317e, %block_41315f
  %111 = phi i64 [ %194, %block_41317e ], [ %.pre9, %block_41315f ]
  ...
  br i1 %149, label %block_41317e, label %block_.L_41319c
...
block_41317e:                                     ; preds = %block_.L_41316d
  ...
  %call2_413189 = tail call %struct.Memory* @sub_40c7f0._ZN15loop_inner_bodyILi15EiE7do_workERiPKii(%struct.State* nonnull %0, i64 %159, %struct.Memory* %call2_413143)
...
block_.L_4131a1:                                  ; preds = %block_4131ad, %block_.L_41319c
  %196 = phi i64 [ %112, %block_.L_41319c ], [ %.pre10, %block_4131ad ]
  %storemerge = phi i64 [ %195, %block_.L_41319c ], [ %318, %block_4131ad ]
  %197 = add i64 %196, -36
  ...
  br i1 %231, label %block_4131ad, label %block_.L_4131d1
...
block_4131ad:                                     ; preds = %block_.L_4131a1
  ...
  %call2_4131b8 = tail call %struct.Memory* @sub_40c110._Z18complete_hash_funcIiET_S0_(%struct.State* nonnull %0, i64 %246, %struct.Memory* %call2_413143)
...
block_.L_4131d1:                                  ; preds = %block_.L_4131a1
  ...
  %call2_4131d4 = tail call %struct.Memory* @sub_40c140._Z9check_sumIiEvT_(%struct.State* nonnull %0, i64 %325, %struct.Memory* %call2_413143)
...
block_.L_4131e7:                                  ; preds = %block_.L_41314f
  ...
  %call2_4131e7 = tail call %struct.Memory* @sub_400e30._Z5timerv(%struct.State* nonnull %0, i64 %362, %struct.Memory* %call2_413143)
  ...
  %call2_4131f0 = tail call %struct.Memory* @sub_4007d0._Z13record_resultdPKc(%struct.State* nonnull %0, i64 %373, %struct.Memory* %call2_4131e7)
