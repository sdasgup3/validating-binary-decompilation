...
block_.L_41310f:                                  ; preds = %block_.L_413191, %entry
  %68 = phi i64 [ %.pre, %entry ], [ %361, %block_.L_413191 ]
...
block_.L_413161:                                  ; preds = %block_41316d, %block_.L_41315c
  %196 = phi i64 [ %195, %block_.L_41315c ], [ %319, %block_41316d ]
...
block_.L_413191:                                  ; preds = %block_.L_413161
  ...
  %call2_413194 = tail call %struct.Memory* @sub_40c100._Z9check_sumIiEvT_(%struct.State* %0, i64 %325, %struct.Memory* %MEMORY.2)
...
block_.L_4131a7:                                  ; preds = %block_.L_41310f
  ...
  %call2_4131a7 = tail call %struct.Memory* @sub_400df0._Z5timerv(%struct.State* %0, i64 %362, %struct.Memory* %MEMORY.0)
  ...
  %call2_4131b0 = tail call %struct.Memory* @sub_400790._Z13record_resultdPKc(%struct.State* %0, i64 %373, %struct.Memory* %call2_4131a7)
