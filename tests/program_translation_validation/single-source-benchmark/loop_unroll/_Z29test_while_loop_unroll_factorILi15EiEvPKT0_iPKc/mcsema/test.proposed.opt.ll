...
block_.L_41313f:                                  ; preds = %block_.L_4131c1, %entry
  %68 = phi i64 [ %361, %block_.L_4131c1 ], [ %.pre, %entry ]
...
block_.L_41315d:                                  ; preds = %block_41316e, %block_41314f
  %111 = phi i64 [ %194, %block_41316e ], [ %.pre9, %block_41314f ]
...
block_41316e:                                     ; preds = %block_.L_41315d
  ...
  %call2_413179 = tail call %struct.Memory* @sub_40c7e0._ZN15loop_inner_bodyILi15EiE7do_workERiPKii(%struct.State* nonnull %0, i64 %159, %struct.Memory* %call2_413133)
...
block_41319d:                                     ; preds = %block_.L_413191
  ...
  %call2_4131a8 = tail call %struct.Memory* @sub_40c100._Z18complete_hash_funcIiET_S0_(%struct.State* nonnull %0, i64 %246, %struct.Memory* %call2_413133)
...
block_.L_4131c1:                                  ; preds = %block_.L_413191
  ...
  %call2_4131c4 = tail call %struct.Memory* @sub_40c130._Z9check_sumIiEvT_(%struct.State* nonnull %0, i64 %325, %struct.Memory* %call2_413133)
...
block_.L_4131d7:                                  ; preds = %block_.L_41313f
  ...
  %call2_4131d7 = tail call %struct.Memory* @sub_400e20._Z5timerv(%struct.State* nonnull %0, i64 %362, %struct.Memory* %call2_413133)
