...
block_.L_40872f:                                  ; preds = %block_.L_4087b8, %entry
  %79 = phi i64 [ %.pre, %entry ], [ %350, %block_.L_4087b8 ]
...
block_.L_408782:                                  ; preds = %block_40878e, %block_.L_40877d
  %210 = phi i64 [ %209, %block_.L_40877d ], [ %307, %block_40878e ]
...
block_40878e:                                     ; preds = %block_.L_408782
  ...
  %call2_40879b = tail call %struct.Memory* @sub_401480._Z18complete_hash_funcIdET_S0_(%struct.State* %0, i64 %261, %struct.Memory* %MEMORY.2)
...
block_.L_4087b8:                                  ; preds = %block_.L_408782
  ...
  %call2_4087bd = tail call %struct.Memory* @sub_4014b0._Z9check_sumIdEvT_(%struct.State* %0, i64 %313, %struct.Memory* %MEMORY.2)
...
block_.L_4087d0:                                  ; preds = %block_.L_40872f
  ...
  %call2_4087d0 = tail call %struct.Memory* @sub_400df0._Z5timerv(%struct.State* %0, i64 %351, %struct.Memory* %MEMORY.0)
  ...
  %call2_4087d9 = tail call %struct.Memory* @sub_400790._Z13record_resultdPKc(%struct.State* %0, i64 %362, %struct.Memory* %call2_4087d0)
