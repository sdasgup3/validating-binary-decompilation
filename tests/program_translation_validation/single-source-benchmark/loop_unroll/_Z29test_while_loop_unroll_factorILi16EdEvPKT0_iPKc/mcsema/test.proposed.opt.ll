...
entry:
  ...
  %call2_408763 = tail call %struct.Memory* @sub_400e10._Z11start_timerv(%struct.State* %0, i64 %58, %struct.Memory* %2)
...
block_.L_40876f:                                  ; preds = %block_.L_4087f8, %entry
  %74 = phi i64 [ %341, %block_.L_4087f8 ], [ %.pre, %entry ]
  ...
  br i1 %107, label %block_40877f, label %block_.L_408810
...
block_.L_40878e:                                  ; preds = %block_40879f, %block_40877f
  %118 = phi i64 [ %202, %block_40879f ], [ %.pre9, %block_40877f ]
  ...
  br i1 %156, label %block_40879f, label %block_.L_4087bd
...
block_40879f:                                     ; preds = %block_.L_40878e
  ...
  %call2_4087aa = tail call %struct.Memory* @sub_401bd0._ZN15loop_inner_bodyILi16EdE7do_workERdPKdi(%struct.State* nonnull %0, i64 %166, %struct.Memory* %call2_408763)
...
block_.L_4087c2:                                  ; preds = %block_4087ce, %block_.L_4087bd
  %204 = phi i64 [ %119, %block_.L_4087bd ], [ %.pre10, %block_4087ce ]
  %storemerge = phi i64 [ %203, %block_.L_4087bd ], [ %299, %block_4087ce ]
  %205 = add i64 %204, -44
  ...
  br i1 %239, label %block_4087ce, label %block_.L_4087f8
...
block_4087ce:                                     ; preds = %block_.L_4087c2
  ...
  %call2_4087db = tail call %struct.Memory* @sub_4014c0._Z18complete_hash_funcIdET_S0_(%struct.State* nonnull %0, i64 %253, %struct.Memory* %call2_408763)
...
block_.L_4087f8:                                  ; preds = %block_.L_4087c2
  ...
  %call2_4087fd = tail call %struct.Memory* @sub_4014f0._Z9check_sumIdEvT_(%struct.State* nonnull %0, i64 %305, %struct.Memory* %call2_408763)
...
block_.L_408810:                                  ; preds = %block_.L_40876f
  ...
  %call2_408810 = tail call %struct.Memory* @sub_400e30._Z5timerv(%struct.State* nonnull %0, i64 %342, %struct.Memory* %call2_408763)
  ...
  %call2_408819 = tail call %struct.Memory* @sub_4007d0._Z13record_resultdPKc(%struct.State* nonnull %0, i64 %353, %struct.Memory* %call2_408810)
