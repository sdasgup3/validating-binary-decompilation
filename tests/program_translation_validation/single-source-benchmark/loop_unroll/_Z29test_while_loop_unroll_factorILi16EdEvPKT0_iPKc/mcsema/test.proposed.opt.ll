...
define %struct.Memory* @_Z29test_while_loop_unroll_factorILi16EdEvPKT0_iPKc(%struct.State* noalias, i64, %struct.Memory* noalias readnone) local_unnamed_addr #1 {
entry:
...
block_.L_40875f:                                  ; preds = %block_.L_4087e8, %entry
  %74 = phi i64 [ %341, %block_.L_4087e8 ], [ %.pre, %entry ]
...
block_.L_40877e:                                  ; preds = %block_40878f, %block_40876f
  %118 = phi i64 [ %202, %block_40878f ], [ %.pre9, %block_40876f ]
...
block_40878f:                                     ; preds = %block_.L_40877e
  ...
  %call2_40879a = tail call %struct.Memory* @sub_401bc0._ZN15loop_inner_bodyILi16EdE7do_workERdPKdi(%struct.State* nonnull %0, i64 %166, %struct.Memory* %call2_408753)
...
block_4087be:                                     ; preds = %block_.L_4087b2
  ...
  %call2_4087cb = tail call %struct.Memory* @sub_4014b0._Z18complete_hash_funcIdET_S0_(%struct.State* nonnull %0, i64 %253, %struct.Memory* %call2_408753)
...
block_.L_4087e8:                                  ; preds = %block_.L_4087b2
  ...
  %call2_4087ed = tail call %struct.Memory* @sub_4014e0._Z9check_sumIdEvT_(%struct.State* nonnull %0, i64 %305, %struct.Memory* %call2_408753)
...
block_.L_408800:                                  ; preds = %block_.L_40875f
  ...
  %call2_408800 = tail call %struct.Memory* @sub_400e20._Z5timerv(%struct.State* nonnull %0, i64 %342, %struct.Memory* %call2_408753)
