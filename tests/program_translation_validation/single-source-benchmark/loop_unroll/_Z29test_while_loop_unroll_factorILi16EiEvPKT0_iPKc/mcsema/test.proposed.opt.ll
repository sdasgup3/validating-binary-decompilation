...
define %struct.Memory* @_Z29test_while_loop_unroll_factorILi16EiEvPKT0_iPKc(%struct.State* noalias, i64, %struct.Memory* noalias readnone) local_unnamed_addr #1 {
entry:
...
block_.L_41301f:                                  ; preds = %block_.L_4130a1, %entry
  %68 = phi i64 [ %362, %block_.L_4130a1 ], [ %.pre, %entry ]
...
block_.L_41303d:                                  ; preds = %block_41304e, %block_41302f
  %111 = phi i64 [ %195, %block_41304e ], [ %.pre9, %block_41302f ]
...
block_41304e:                                     ; preds = %block_.L_41303d
  ...
  %call2_413059 = tail call %struct.Memory* @sub_40c780._ZN15loop_inner_bodyILi16EiE7do_workERiPKii(%struct.State* nonnull %0, i64 %159, %struct.Memory* %call2_413013)
...
block_41307d:                                     ; preds = %block_.L_413071
  ...
  %call2_413088 = tail call %struct.Memory* @sub_40c100._Z18complete_hash_funcIiET_S0_(%struct.State* nonnull %0, i64 %247, %struct.Memory* %call2_413013)
...
block_.L_4130a1:                                  ; preds = %block_.L_413071
  ...
  %call2_4130a4 = tail call %struct.Memory* @sub_40c130._Z9check_sumIiEvT_(%struct.State* nonnull %0, i64 %326, %struct.Memory* %call2_413013)
...
block_.L_4130b7:                                  ; preds = %block_.L_41301f
  ...
  %call2_4130b7 = tail call %struct.Memory* @sub_400e20._Z5timerv(%struct.State* nonnull %0, i64 %363, %struct.Memory* %call2_413013)
