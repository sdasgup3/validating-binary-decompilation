...
entry:
  ...
  %call2_413023 = tail call %struct.Memory* @sub_400e10._Z11start_timerv(%struct.State* %0, i64 %58, %struct.Memory* %2)
...
block_.L_41302f:                                  ; preds = %block_.L_4130b1, %entry
  %68 = phi i64 [ %362, %block_.L_4130b1 ], [ %.pre, %entry ]
  ...
  br i1 %101, label %block_41303f, label %block_.L_4130c7

block_41303f:                                     ; preds = %block_.L_41302f
  %103 = add i64 %69, -32
  %104 = add i64 %102, 7
...
block_.L_41304d:                                  ; preds = %block_41305e, %block_41303f
  %111 = phi i64 [ %195, %block_41305e ], [ %.pre9, %block_41303f ]
  ...
  br i1 %149, label %block_41305e, label %block_.L_41307c

block_41305e:                                     ; preds = %block_.L_41304d
  %151 = add i64 %112, -32
  ...
  %call2_413069 = tail call %struct.Memory* @sub_40c790._ZN15loop_inner_bodyILi16EiE7do_workERiPKii(%struct.State* nonnull %0, i64 %159, %struct.Memory* %call2_413023)
...
block_.L_41307c:                                  ; preds = %block_.L_41304d
  %196 = add i64 %150, 5
  br label %block_.L_413081

block_.L_413081:                                  ; preds = %block_41308d, %block_.L_41307c
  %197 = phi i64 [ %112, %block_.L_41307c ], [ %.pre10, %block_41308d ]
  %storemerge = phi i64 [ %196, %block_.L_41307c ], [ %319, %block_41308d ]
  %198 = add i64 %197, -36
  ...
  br i1 %232, label %block_41308d, label %block_.L_4130b1
...
block_41308d:                                     ; preds = %block_.L_413081
  ...
  %call2_413098 = tail call %struct.Memory* @sub_40c110._Z18complete_hash_funcIiET_S0_(%struct.State* nonnull %0, i64 %247, %struct.Memory* %call2_413023)
...
block_.L_4130b1:                                  ; preds = %block_.L_413081
  ...
  %call2_4130b4 = tail call %struct.Memory* @sub_40c140._Z9check_sumIiEvT_(%struct.State* nonnull %0, i64 %326, %struct.Memory* %call2_413023)
...
block_.L_4130c7:                                  ; preds = %block_.L_41302f
  ...
  %call2_4130c7 = tail call %struct.Memory* @sub_400e30._Z5timerv(%struct.State* nonnull %0, i64 %363, %struct.Memory* %call2_413023)
  ...
  %call2_4130d0 = tail call %struct.Memory* @sub_4007d0._Z13record_resultdPKc(%struct.State* nonnull %0, i64 %374, %struct.Memory* %call2_4130c7)
