...
block_.L_412fef:                                  ; preds = %block_.L_413071, %entry
  %68 = phi i64 [ %.pre, %entry ], [ %364, %block_.L_413071 ]
...
block_.L_413041:                                  ; preds = %block_41304d, %block_.L_41303c
  %197 = phi i64 [ %196, %block_.L_41303c ], [ %321, %block_41304d ]
...
block_.L_413071:                                  ; preds = %block_.L_413041
  ...
  %call2_413074 = tail call %struct.Memory* @sub_40c100._Z9check_sumIiEvT_(%struct.State* %0, i64 %327, %struct.Memory* %MEMORY.2)
...
block_.L_413087:                                  ; preds = %block_.L_412fef
  ...
  %call2_413087 = tail call %struct.Memory* @sub_400df0._Z5timerv(%struct.State* %0, i64 %365, %struct.Memory* %MEMORY.0)
  ...
  %call2_413090 = tail call %struct.Memory* @sub_400790._Z13record_resultdPKc(%struct.State* %0, i64 %376, %struct.Memory* %call2_413087)
