...
block_.L_4085ff:                                  ; preds = %block_.L_408688, %entry
  %79 = phi i64 [ %.pre, %entry ], [ %350, %block_.L_408688 ]
...
block_.L_408652:                                  ; preds = %block_40865e, %block_.L_40864d
  %210 = phi i64 [ %209, %block_.L_40864d ], [ %307, %block_40865e ]
...
block_40865e:                                     ; preds = %block_.L_408652
  ...
  %call2_40866b = tail call %struct.Memory* @sub_401480._Z18complete_hash_funcIdET_S0_(%struct.State* %0, i64 %261, %struct.Memory* %MEMORY.2)
...
block_.L_408688:                                  ; preds = %block_.L_408652
  ...
  %call2_40868d = tail call %struct.Memory* @sub_4014b0._Z9check_sumIdEvT_(%struct.State* %0, i64 %313, %struct.Memory* %MEMORY.2)
...
block_.L_4086a0:                                  ; preds = %block_.L_4085ff
  ...
  %call2_4086a0 = tail call %struct.Memory* @sub_400df0._Z5timerv(%struct.State* %0, i64 %351, %struct.Memory* %MEMORY.0)
  ...
  %call2_4086a9 = tail call %struct.Memory* @sub_400790._Z13record_resultdPKc(%struct.State* %0, i64 %362, %struct.Memory* %call2_4086a0)
