...
block_.L_40862f:                                  ; preds = %block_.L_4086b8, %entry
  %74 = phi i64 [ %341, %block_.L_4086b8 ], [ %.pre, %entry ]
...
block_.L_40864e:                                  ; preds = %block_40865f, %block_40863f
  %118 = phi i64 [ %202, %block_40865f ], [ %.pre9, %block_40863f ]
...
block_40865f:                                     ; preds = %block_.L_40864e
  ...
  %call2_40866a = tail call %struct.Memory* @sub_401b60._ZN15loop_inner_bodyILi17EdE7do_workERdPKdi(%struct.State* nonnull %0, i64 %166, %struct.Memory* %call2_408623)
...
block_40868e:                                     ; preds = %block_.L_408682
  ...
  %call2_40869b = tail call %struct.Memory* @sub_4014b0._Z18complete_hash_funcIdET_S0_(%struct.State* nonnull %0, i64 %253, %struct.Memory* %call2_408623)
...
block_.L_4086b8:                                  ; preds = %block_.L_408682
  ...
  %call2_4086bd = tail call %struct.Memory* @sub_4014e0._Z9check_sumIdEvT_(%struct.State* nonnull %0, i64 %305, %struct.Memory* %call2_408623)
...
block_.L_4086d0:                                  ; preds = %block_.L_40862f
  ...
  %call2_4086d0 = tail call %struct.Memory* @sub_400e20._Z5timerv(%struct.State* nonnull %0, i64 %342, %struct.Memory* %call2_408623)
