...
entry:
  ...
  %call2_412f03 = tail call %struct.Memory* @sub_400e10._Z11start_timerv(%struct.State* %0, i64 %58, %struct.Memory* %2)
...
block_.L_412f0f:                                  ; preds = %block_.L_412f91, %entry
  %68 = phi i64 [ %362, %block_.L_412f91 ], [ %.pre, %entry ]
  ...
  br i1 %101, label %block_412f1f, label %block_.L_412fa7
...
block_.L_412f2d:                                  ; preds = %block_412f3e, %block_412f1f
  %111 = phi i64 [ %195, %block_412f3e ], [ %.pre9, %block_412f1f ]
  ...
  br i1 %149, label %block_412f3e, label %block_.L_412f5c
...
block_412f3e:                                     ; preds = %block_.L_412f2d
  ...
  %call2_412f49 = tail call %struct.Memory* @sub_40c730._ZN15loop_inner_bodyILi17EiE7do_workERiPKii(%struct.State* nonnull %0, i64 %159, %struct.Memory* %call2_412f03)
...
block_.L_412f61:                                  ; preds = %block_412f6d, %block_.L_412f5c
  %197 = phi i64 [ %112, %block_.L_412f5c ], [ %.pre10, %block_412f6d ]
  %storemerge = phi i64 [ %196, %block_.L_412f5c ], [ %319, %block_412f6d ]
  %198 = add i64 %197, -36
  ...
  br i1 %232, label %block_412f6d, label %block_.L_412f91
...
block_412f6d:                                     ; preds = %block_.L_412f61
  ...
  %call2_412f78 = tail call %struct.Memory* @sub_40c110._Z18complete_hash_funcIiET_S0_(%struct.State* nonnull %0, i64 %247, %struct.Memory* %call2_412f03)
...
block_.L_412f91:                                  ; preds = %block_.L_412f61
  ...
  %call2_412f94 = tail call %struct.Memory* @sub_40c140._Z9check_sumIiEvT_(%struct.State* nonnull %0, i64 %326, %struct.Memory* %call2_412f03)
...
block_.L_412fa7:                                  ; preds = %block_.L_412f0f
  ...
  %call2_412fa7 = tail call %struct.Memory* @sub_400e30._Z5timerv(%struct.State* nonnull %0, i64 %363, %struct.Memory* %call2_412f03)
  ...
  %call2_412fb0 = tail call %struct.Memory* @sub_4007d0._Z13record_resultdPKc(%struct.State* nonnull %0, i64 %374, %struct.Memory* %call2_412fa7)
