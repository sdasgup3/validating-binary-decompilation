...
define %struct.Memory* @_Z29test_while_loop_unroll_factorILi17EiEvPKT0_iPKc(%struct.State* noalias, i64, %struct.Memory* noalias) local_unnamed_addr #1 {
entry:
  ...
  %call2_412ef3 = tail call %struct.Memory* @sub_400e00._Z11start_timerv(%struct.State* %0, i64 %58, %struct.Memory* %2)
...
block_.L_412eff:                                  ; preds = %block_.L_412f81, %entry
  %68 = phi i64 [ %.pre, %entry ], [ %362, %block_.L_412f81 ]
  %MEMORY.0 = phi %struct.Memory* [ %call2_412ef3, %entry ], [ %call2_412f84, %block_.L_412f81 ]
  ...
  br i1 %101, label %block_412f0f, label %block_.L_412f97

block_412f0f:                                     ; preds = %block_.L_412eff
  %103 = add i64 %69, -32
  %104 = add i64 %102, 7
...
block_.L_412f1d:                                  ; preds = %block_412f2e, %block_412f0f
  %111 = phi i64 [ %.pre9, %block_412f0f ], [ %195, %block_412f2e ]
  %MEMORY.1 = phi %struct.Memory* [ %MEMORY.0, %block_412f0f ], [ %call2_412f39, %block_412f2e ]
  ...
  br i1 %149, label %block_412f2e, label %block_.L_412f4c

block_412f2e:                                     ; preds = %block_.L_412f1d
  %151 = add i64 %112, -32
  ...
  %call2_412f39 = tail call %struct.Memory* @sub_40c720._ZN15loop_inner_bodyILi17EiE7do_workERiPKii(%struct.State* nonnull %0, i64 %159, %struct.Memory* %MEMORY.1)
...
block_.L_412f4c:                                  ; preds = %block_.L_412f1d
  %196 = add i64 %150, 5
  br label %block_.L_412f51

block_.L_412f51:                                  ; preds = %block_412f5d, %block_.L_412f4c
  %197 = phi i64 [ %112, %block_.L_412f4c ], [ %.pre10, %block_412f5d ]
  %storemerge = phi i64 [ %196, %block_.L_412f4c ], [ %319, %block_412f5d ]
  %MEMORY.2 = phi %struct.Memory* [ %MEMORY.1, %block_.L_412f4c ], [ %call2_412f68, %block_412f5d ]
  %198 = add i64 %197, -36
  ...
  br i1 %232, label %block_412f5d, label %block_.L_412f81

block_412f5d:                                     ; preds = %block_.L_412f51
  %234 = add i64 %197, -8
  %235 = add i64 %233, 4
  ...
  %call2_412f68 = tail call %struct.Memory* @sub_40c100._Z18complete_hash_funcIiET_S0_(%struct.State* nonnull %0, i64 %247, %struct.Memory* %MEMORY.2)
...
block_.L_412f81:                                  ; preds = %block_.L_412f51
  %321 = add i64 %197, -32
  %322 = add i64 %233, 3
  ...
  %call2_412f84 = tail call %struct.Memory* @sub_40c130._Z9check_sumIiEvT_(%struct.State* nonnull %0, i64 %326, %struct.Memory* %MEMORY.2)
...
block_.L_412f97:                                  ; preds = %block_.L_412eff
  %363 = add i64 %102, -74103
  %364 = add i64 %102, 5
  ...
  %call2_412f97 = tail call %struct.Memory* @sub_400e20._Z5timerv(%struct.State* nonnull %0, i64 %363, %struct.Memory* %MEMORY.0)
  ...
  %call2_412fa0 = tail call %struct.Memory* @sub_4007c0._Z13record_resultdPKc(%struct.State* nonnull %0, i64 %374, %struct.Memory* %call2_412f97)
  ...
  ret %struct.Memory* %call2_412fa0
}
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_jge_.L_412f97(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i8* nocapture %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_jge_.L_412f4c(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i8* nocapture %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 2, i32 9
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_jmpq_.L_412f1d(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_jmpq_.L_412f51(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_jge_.L_412f81(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i8* nocapture %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 2, i32 9
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_jmpq_.L_412eff(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
