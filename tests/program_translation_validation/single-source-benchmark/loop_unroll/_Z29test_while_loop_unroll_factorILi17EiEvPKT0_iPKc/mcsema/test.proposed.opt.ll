...
block_.L_412ecf:                                  ; preds = %block_.L_412f51, %entry
  %68 = phi i64 [ %.pre, %entry ], [ %362, %block_.L_412f51 ]
...
block_.L_412f21:                                  ; preds = %block_412f2d, %block_.L_412f1c
  %197 = phi i64 [ %196, %block_.L_412f1c ], [ %320, %block_412f2d ]
...
block_.L_412f51:                                  ; preds = %block_.L_412f21
  ...
  %call2_412f54 = tail call %struct.Memory* @sub_40c100._Z9check_sumIiEvT_(%struct.State* %0, i64 %326, %struct.Memory* %MEMORY.2)
...
block_.L_412f67:                                  ; preds = %block_.L_412ecf
  ...
  %call2_412f67 = tail call %struct.Memory* @sub_400df0._Z5timerv(%struct.State* %0, i64 %363, %struct.Memory* %MEMORY.0)
  ...
  %call2_412f70 = tail call %struct.Memory* @sub_400790._Z13record_resultdPKc(%struct.State* %0, i64 %374, %struct.Memory* %call2_412f67)
