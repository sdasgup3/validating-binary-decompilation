...
define %struct.Memory* @_Z29test_while_loop_unroll_factorILi17EiEvPKT0_iPKc(%struct.State* noalias, i64, %struct.Memory* noalias readnone) local_unnamed_addr #1 {
entry:
...
block_.L_412eff:                                  ; preds = %block_.L_412f81, %entry
  %68 = phi i64 [ %362, %block_.L_412f81 ], [ %.pre, %entry ]
...
block_.L_412f1d:                                  ; preds = %block_412f2e, %block_412f0f
  %111 = phi i64 [ %195, %block_412f2e ], [ %.pre9, %block_412f0f ]
...
block_412f2e:                                     ; preds = %block_.L_412f1d
  ...
  %call2_412f39 = tail call %struct.Memory* @sub_40c720._ZN15loop_inner_bodyILi17EiE7do_workERiPKii(%struct.State* nonnull %0, i64 %159, %struct.Memory* %call2_412ef3)
...
block_412f5d:                                     ; preds = %block_.L_412f51
  ...
  %call2_412f68 = tail call %struct.Memory* @sub_40c100._Z18complete_hash_funcIiET_S0_(%struct.State* nonnull %0, i64 %247, %struct.Memory* %call2_412ef3)
...
block_.L_412f81:                                  ; preds = %block_.L_412f51
  ...
  %call2_412f84 = tail call %struct.Memory* @sub_40c130._Z9check_sumIiEvT_(%struct.State* nonnull %0, i64 %326, %struct.Memory* %call2_412ef3)
...
block_.L_412f97:                                  ; preds = %block_.L_412eff
  ...
  %call2_412f97 = tail call %struct.Memory* @sub_400e20._Z5timerv(%struct.State* nonnull %0, i64 %363, %struct.Memory* %call2_412ef3)
