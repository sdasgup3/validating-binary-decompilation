...
block_.L_4084cf:                                  ; preds = %block_.L_408558, %entry
  %79 = phi i64 [ %.pre, %entry ], [ %346, %block_.L_408558 ]
...
block_.L_408522:                                  ; preds = %block_40852e, %block_.L_40851d
  %210 = phi i64 [ %209, %block_.L_40851d ], [ %305, %block_40852e ]
...
block_40852e:                                     ; preds = %block_.L_408522
  ...
  %call2_40853b = tail call %struct.Memory* @sub_401480._Z18complete_hash_funcIdET_S0_(%struct.State* %0, i64 %260, %struct.Memory* %MEMORY.2)
...
block_.L_408558:                                  ; preds = %block_.L_408522
  ...
  %call2_40855d = tail call %struct.Memory* @sub_4014b0._Z9check_sumIdEvT_(%struct.State* %0, i64 %310, %struct.Memory* %MEMORY.2)
...
block_.L_408570:                                  ; preds = %block_.L_4084cf
  ...
  %call2_408570 = tail call %struct.Memory* @sub_400df0._Z5timerv(%struct.State* %0, i64 %347, %struct.Memory* %MEMORY.0)
  ...
  %call2_408579 = tail call %struct.Memory* @sub_400790._Z13record_resultdPKc(%struct.State* %0, i64 %358, %struct.Memory* %call2_408570)
