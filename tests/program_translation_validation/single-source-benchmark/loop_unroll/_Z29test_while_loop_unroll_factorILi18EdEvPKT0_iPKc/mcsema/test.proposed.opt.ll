...
declare %struct.Memory* @sub_401b10._ZN15loop_inner_bodyILi18EdE7do_workERdPKdi(%struct.State* noalias dereferenceable(3376), i64, %struct.Memory* noalias readnone returned) local_unnamed_addr
...
define %struct.Memory* @_Z29test_while_loop_unroll_factorILi18EdEvPKT0_iPKc(%struct.State* noalias, i64, %struct.Memory* noalias readnone) local_unnamed_addr #1 {
entry:
  ...
  %call2_408503 = tail call %struct.Memory* @sub_400e10._Z11start_timerv(%struct.State* %0, i64 %58, %struct.Memory* %2)
  ...
  br label %block_.L_40850f

block_.L_40850f:                                  ; preds = %block_.L_408598, %entry
  %74 = phi i64 [ %341, %block_.L_408598 ], [ %.pre, %entry ]
  ...
  br i1 %107, label %block_40851f, label %block_.L_4085b0

block_40851f:                                     ; preds = %block_.L_40850f
...
block_.L_40852e:                                  ; preds = %block_40853f, %block_40851f
  %118 = phi i64 [ %202, %block_40853f ], [ %.pre9, %block_40851f ]
  ...
  br i1 %156, label %block_40853f, label %block_.L_40855d

block_40853f:                                     ; preds = %block_.L_40852e
  %158 = add i64 %119, -40
  ...
  %call2_40854a = tail call %struct.Memory* @sub_401b10._ZN15loop_inner_bodyILi18EdE7do_workERdPKdi(%struct.State* nonnull %0, i64 %166, %struct.Memory* %call2_408503)
...
block_.L_40855d:                                  ; preds = %block_.L_40852e
  %203 = add i64 %157, 5
  br label %block_.L_408562

block_.L_408562:                                  ; preds = %block_40856e, %block_.L_40855d
  %204 = phi i64 [ %119, %block_.L_40855d ], [ %.pre10, %block_40856e ]
  %storemerge = phi i64 [ %203, %block_.L_40855d ], [ %299, %block_40856e ]
  %205 = add i64 %204, -44
  ...
  br i1 %239, label %block_40856e, label %block_.L_408598
...
block_40856e:                                     ; preds = %block_.L_408562
  ...
  %call2_40857b = tail call %struct.Memory* @sub_4014c0._Z18complete_hash_funcIdET_S0_(%struct.State* nonnull %0, i64 %253, %struct.Memory* %call2_408503)
...
block_.L_408598:                                  ; preds = %block_.L_408562
  ...
  %call2_40859d = tail call %struct.Memory* @sub_4014f0._Z9check_sumIdEvT_(%struct.State* nonnull %0, i64 %305, %struct.Memory* %call2_408503)
...
block_.L_4085b0:                                  ; preds = %block_.L_40850f
  ...
  %call2_4085b0 = tail call %struct.Memory* @sub_400e30._Z5timerv(%struct.State* nonnull %0, i64 %342, %struct.Memory* %call2_408503)
  ...
  %call2_4085b9 = tail call %struct.Memory* @sub_4007d0._Z13record_resultdPKc(%struct.State* nonnull %0, i64 %353, %struct.Memory* %call2_4085b0)
