...
define %struct.Memory* @_Z29test_while_loop_unroll_factorILi18EdEvPKT0_iPKc(%struct.State* noalias, i64, %struct.Memory* noalias) local_unnamed_addr #1 {
entry:
  ...
  %call2_4084f3 = tail call %struct.Memory* @sub_400e00._Z11start_timerv(%struct.State* %0, i64 %58, %struct.Memory* %2)
  ...
  br label %block_.L_4084ff

block_.L_4084ff:                                  ; preds = %block_.L_408588, %entry
  %74 = phi i64 [ %.pre, %entry ], [ %341, %block_.L_408588 ]
  %MEMORY.0 = phi %struct.Memory* [ %call2_4084f3, %entry ], [ %call2_40858d, %block_.L_408588 ]
  ...
  br i1 %107, label %block_40850f, label %block_.L_4085a0

block_40850f:                                     ; preds = %block_.L_4084ff
  ...
  br label %block_.L_40851e

block_.L_40851e:                                  ; preds = %block_40852f, %block_40850f
  %118 = phi i64 [ %.pre9, %block_40850f ], [ %202, %block_40852f ]
  %MEMORY.1 = phi %struct.Memory* [ %MEMORY.0, %block_40850f ], [ %call2_40853a, %block_40852f ]
  ...
  br i1 %156, label %block_40852f, label %block_.L_40854d

block_40852f:                                     ; preds = %block_.L_40851e
  %158 = add i64 %119, -40
  ...
  %call2_40853a = tail call %struct.Memory* @sub_401b00._ZN15loop_inner_bodyILi18EdE7do_workERdPKdi(%struct.State* nonnull %0, i64 %166, %struct.Memory* %MEMORY.1)
...
block_.L_40854d:                                  ; preds = %block_.L_40851e
  %203 = add i64 %157, 5
  br label %block_.L_408552

block_.L_408552:                                  ; preds = %block_40855e, %block_.L_40854d
  %204 = phi i64 [ %119, %block_.L_40854d ], [ %.pre10, %block_40855e ]
  %storemerge = phi i64 [ %203, %block_.L_40854d ], [ %299, %block_40855e ]
  %MEMORY.2 = phi %struct.Memory* [ %MEMORY.1, %block_.L_40854d ], [ %call2_40856b, %block_40855e ]
  %205 = add i64 %204, -44
  ...
  br i1 %239, label %block_40855e, label %block_.L_408588

block_40855e:                                     ; preds = %block_.L_408552
  %241 = add i64 %204, -8
  %242 = add i64 %240, 4
  ...
  %call2_40856b = tail call %struct.Memory* @sub_4014b0._Z18complete_hash_funcIdET_S0_(%struct.State* nonnull %0, i64 %253, %struct.Memory* %MEMORY.2)
...
block_.L_408588:                                  ; preds = %block_.L_408552
  %301 = add i64 %204, -40
  %302 = add i64 %240, 5
  ...
  %call2_40858d = tail call %struct.Memory* @sub_4014e0._Z9check_sumIdEvT_(%struct.State* nonnull %0, i64 %305, %struct.Memory* %MEMORY.2)
...
block_.L_4085a0:                                  ; preds = %block_.L_4084ff
  %342 = add i64 %108, -30592
  %343 = add i64 %108, 5
  ...
  %call2_4085a0 = tail call %struct.Memory* @sub_400e20._Z5timerv(%struct.State* nonnull %0, i64 %342, %struct.Memory* %MEMORY.0)
  ...
  %call2_4085a9 = tail call %struct.Memory* @sub_4007c0._Z13record_resultdPKc(%struct.State* nonnull %0, i64 %353, %struct.Memory* %call2_4085a0)
  ...
  ret %struct.Memory* %call2_4085a9
}
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_jge_.L_4085a0(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i8* nocapture %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_jge_.L_40854d(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i8* nocapture %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 2, i32 9
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_jmpq_.L_40851e(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_jmpq_.L_408552(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_jge_.L_408588(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i8* nocapture %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 2, i32 9
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_jmpq_.L_4084ff(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
