...
block_.L_412daf:                                  ; preds = %block_.L_412e31, %entry
  %68 = phi i64 [ %.pre, %entry ], [ %364, %block_.L_412e31 ]
...
block_.L_412e01:                                  ; preds = %block_412e0d, %block_.L_412dfc
  %197 = phi i64 [ %196, %block_.L_412dfc ], [ %321, %block_412e0d ]
...
block_.L_412e31:                                  ; preds = %block_.L_412e01
  ...
  %call2_412e34 = tail call %struct.Memory* @sub_40c100._Z9check_sumIiEvT_(%struct.State* %0, i64 %327, %struct.Memory* %MEMORY.2)
...
block_.L_412e47:                                  ; preds = %block_.L_412daf
  ...
  %call2_412e47 = tail call %struct.Memory* @sub_400df0._Z5timerv(%struct.State* %0, i64 %365, %struct.Memory* %MEMORY.0)
  ...
  %call2_412e50 = tail call %struct.Memory* @sub_400790._Z13record_resultdPKc(%struct.State* %0, i64 %376, %struct.Memory* %call2_412e47)
