...
block_.L_412ddf:                                  ; preds = %block_.L_412e61, %entry
  %68 = phi i64 [ %.pre, %entry ], [ %362, %block_.L_412e61 ]
  %MEMORY.0 = phi %struct.Memory* [ %call2_412dd3, %entry ], [ %call2_412e64, %block_.L_412e61 ]
...
block_.L_412dfd:                                  ; preds = %block_412e0e, %block_412def
  %111 = phi i64 [ %.pre9, %block_412def ], [ %195, %block_412e0e ]
  %MEMORY.1 = phi %struct.Memory* [ %MEMORY.0, %block_412def ], [ %call2_412e19, %block_412e0e ]
...
block_412e0e:                                     ; preds = %block_.L_412dfd
  ...
  %call2_412e19 = tail call %struct.Memory* @sub_40c6c0._ZN15loop_inner_bodyILi18EiE7do_workERiPKii(%struct.State* nonnull %0, i64 %159, %struct.Memory* %MEMORY.1)
...
block_.L_412e31:                                  ; preds = %block_412e3d, %block_.L_412e2c
  ...
  %MEMORY.2 = phi %struct.Memory* [ %MEMORY.1, %block_.L_412e2c ], [ %call2_412e48, %block_412e3d ]
  %198 = add i64 %197, -36
...
block_412e3d:                                     ; preds = %block_.L_412e31
  ...
  %call2_412e48 = tail call %struct.Memory* @sub_40c100._Z18complete_hash_funcIiET_S0_(%struct.State* nonnull %0, i64 %247, %struct.Memory* %MEMORY.2)
...
block_.L_412e61:                                  ; preds = %block_.L_412e31
  ...
  %call2_412e64 = tail call %struct.Memory* @sub_40c130._Z9check_sumIiEvT_(%struct.State* nonnull %0, i64 %326, %struct.Memory* %MEMORY.2)
...
block_.L_412e77:                                  ; preds = %block_.L_412ddf
  ...
  %call2_412e77 = tail call %struct.Memory* @sub_400e20._Z5timerv(%struct.State* nonnull %0, i64 %363, %struct.Memory* %MEMORY.0)
