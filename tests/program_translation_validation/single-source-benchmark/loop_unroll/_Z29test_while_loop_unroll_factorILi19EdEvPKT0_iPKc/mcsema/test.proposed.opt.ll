...
declare %struct.Memory* @sub_401a70._ZN15loop_inner_bodyILi19EdE7do_workERdPKdi(%struct.State* noalias dereferenceable(3376), i64, %struct.Memory* noalias readnone returned) local_unnamed_addr
...
entry:
  ...
  %call2_408393 = tail call %struct.Memory* @sub_400dd0._Z11start_timerv(%struct.State* %0, i64 %58, %struct.Memory* %2)
...
block_.L_40839f:                                  ; preds = %block_.L_408428, %entry
  %79 = phi i64 [ %.pre, %entry ], [ %346, %block_.L_408428 ]
  %MEMORY.0 = phi %struct.Memory* [ %call2_408393, %entry ], [ %call2_40842d, %block_.L_408428 ]
  ...
  br i1 %112, label %block_4083af, label %block_.L_408440
...
block_4083af:                                     ; preds = %block_.L_40839f
  ...
  br label %block_.L_4083be

block_.L_4083be:                                  ; preds = %block_4083cf, %block_4083af
  %124 = phi i64 [ %.pre1, %block_4083af ], [ %208, %block_4083cf ]
  %MEMORY.1 = phi %struct.Memory* [ %MEMORY.0, %block_4083af ], [ %call2_4083da, %block_4083cf ]
  ...
  br i1 %162, label %block_4083cf, label %block_.L_4083ed

block_4083cf:                                     ; preds = %block_.L_4083be
  %164 = add i64 %125, -40
  ...
  %call2_4083da = tail call %struct.Memory* @sub_401a70._ZN15loop_inner_bodyILi19EdE7do_workERdPKdi(%struct.State* %0, i64 %172, %struct.Memory* %MEMORY.1)
...
block_.L_4083ed:                                  ; preds = %block_.L_4083be
  %209 = add i64 %163, 5
  store i64 %209, i64* %3, align 8
  br label %block_.L_4083f2

block_.L_4083f2:                                  ; preds = %block_4083fe, %block_.L_4083ed
  %210 = phi i64 [ %209, %block_.L_4083ed ], [ %305, %block_4083fe ]
  %211 = phi i64 [ %125, %block_.L_4083ed ], [ %.pre2, %block_4083fe ]
  %MEMORY.2 = phi %struct.Memory* [ %MEMORY.1, %block_.L_4083ed ], [ %call2_40840b, %block_4083fe ]
  %212 = add i64 %211, -44
  %213 = add i64 %210, 3
  ...
  br i1 %246, label %block_4083fe, label %block_.L_408428

block_4083fe:                                     ; preds = %block_.L_4083f2
  %248 = add i64 %211, -8
  %249 = add i64 %247, 4
  ...
  %call2_40840b = tail call %struct.Memory* @sub_401480._Z18complete_hash_funcIdET_S0_(%struct.State* %0, i64 %260, %struct.Memory* %MEMORY.2)
...
block_.L_408428:                                  ; preds = %block_.L_4083f2
  %306 = add i64 %211, -40
  %307 = add i64 %247, 5
  ...
  %call2_40842d = tail call %struct.Memory* @sub_4014b0._Z9check_sumIdEvT_(%struct.State* %0, i64 %310, %struct.Memory* %MEMORY.2)
...
block_.L_408440:                                  ; preds = %block_.L_40839f
  %347 = add i64 %113, -30288
  %348 = add i64 %113, 5
  ...
  %call2_408440 = tail call %struct.Memory* @sub_400df0._Z5timerv(%struct.State* %0, i64 %347, %struct.Memory* %MEMORY.0)
  ...
  %call2_408449 = tail call %struct.Memory* @sub_400790._Z13record_resultdPKc(%struct.State* %0, i64 %358, %struct.Memory* %call2_408440)
  ...
  ret %struct.Memory* %call2_408449
}
...
define %struct.Memory* @routine_jge_.L_408440(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i8* %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
...
define %struct.Memory* @routine_callq_._ZN15loop_inner_bodyILi19EdE7do_workERdPKdi(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
...
define %struct.Memory* @routine_jmpq_.L_4083be(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
...
define %struct.Memory* @routine_jmpq_.L_4083f2(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
...
define %struct.Memory* @routine_jge_.L_408428(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i8* %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 2, i32 9
