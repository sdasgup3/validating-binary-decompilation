...
declare %struct.Memory* @sub_401aa0._ZN15loop_inner_bodyILi19EdE7do_workERdPKdi(%struct.State* noalias dereferenceable(3376), i64, %struct.Memory* noalias readnone returned) local_unnamed_addr
...
define %struct.Memory* @_Z29test_while_loop_unroll_factorILi19EdEvPKT0_iPKc(%struct.State* noalias, i64, %struct.Memory* noalias readnone) local_unnamed_addr #1 {
entry:
...
block_.L_4083cf:                                  ; preds = %block_.L_408458, %entry
  %74 = phi i64 [ %341, %block_.L_408458 ], [ %.pre, %entry ]
...
block_.L_4083ee:                                  ; preds = %block_4083ff, %block_4083df
  %118 = phi i64 [ %202, %block_4083ff ], [ %.pre9, %block_4083df ]
...
block_4083ff:                                     ; preds = %block_.L_4083ee
  ...
  %call2_40840a = tail call %struct.Memory* @sub_401aa0._ZN15loop_inner_bodyILi19EdE7do_workERdPKdi(%struct.State* nonnull %0, i64 %166, %struct.Memory* %call2_4083c3)
...
block_40842e:                                     ; preds = %block_.L_408422
  ...
  %call2_40843b = tail call %struct.Memory* @sub_4014b0._Z18complete_hash_funcIdET_S0_(%struct.State* nonnull %0, i64 %253, %struct.Memory* %call2_4083c3)
...
block_.L_408458:                                  ; preds = %block_.L_408422
  ...
  %call2_40845d = tail call %struct.Memory* @sub_4014e0._Z9check_sumIdEvT_(%struct.State* nonnull %0, i64 %305, %struct.Memory* %call2_4083c3)
...
block_.L_408470:                                  ; preds = %block_.L_4083cf
  ...
  %call2_408470 = tail call %struct.Memory* @sub_400e20._Z5timerv(%struct.State* nonnull %0, i64 %342, %struct.Memory* %call2_4083c3)
