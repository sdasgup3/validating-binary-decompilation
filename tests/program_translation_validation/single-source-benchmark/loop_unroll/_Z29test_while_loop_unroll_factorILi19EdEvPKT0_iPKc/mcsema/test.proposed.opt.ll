...
declare %struct.Memory* @sub_401ab0._ZN15loop_inner_bodyILi19EdE7do_workERdPKdi(%struct.State* noalias dereferenceable(3376), i64, %struct.Memory* noalias readnone returned) local_unnamed_addr
...
entry:
  ...
  %call2_4083d3 = tail call %struct.Memory* @sub_400e10._Z11start_timerv(%struct.State* %0, i64 %58, %struct.Memory* %2)
...
block_.L_4083df:                                  ; preds = %block_.L_408468, %entry
  %74 = phi i64 [ %341, %block_.L_408468 ], [ %.pre, %entry ]
  ...
  br i1 %107, label %block_4083ef, label %block_.L_408480
...
block_4083ef:                                     ; preds = %block_.L_4083df
  ...
  br label %block_.L_4083fe

block_.L_4083fe:                                  ; preds = %block_40840f, %block_4083ef
  %118 = phi i64 [ %202, %block_40840f ], [ %.pre9, %block_4083ef ]
  ...
  br i1 %156, label %block_40840f, label %block_.L_40842d

block_40840f:                                     ; preds = %block_.L_4083fe
  %158 = add i64 %119, -40
  ...
  %call2_40841a = tail call %struct.Memory* @sub_401ab0._ZN15loop_inner_bodyILi19EdE7do_workERdPKdi(%struct.State* nonnull %0, i64 %166, %struct.Memory* %call2_4083d3)
...
block_.L_40842d:                                  ; preds = %block_.L_4083fe
  %203 = add i64 %157, 5
  br label %block_.L_408432

block_.L_408432:                                  ; preds = %block_40843e, %block_.L_40842d
  %204 = phi i64 [ %119, %block_.L_40842d ], [ %.pre10, %block_40843e ]
  %storemerge = phi i64 [ %203, %block_.L_40842d ], [ %299, %block_40843e ]
  %205 = add i64 %204, -44
  ...
  br i1 %239, label %block_40843e, label %block_.L_408468
...
block_40843e:                                     ; preds = %block_.L_408432
  ...
  %call2_40844b = tail call %struct.Memory* @sub_4014c0._Z18complete_hash_funcIdET_S0_(%struct.State* nonnull %0, i64 %253, %struct.Memory* %call2_4083d3)
...
block_.L_408468:                                  ; preds = %block_.L_408432
  ...
  %call2_40846d = tail call %struct.Memory* @sub_4014f0._Z9check_sumIdEvT_(%struct.State* nonnull %0, i64 %305, %struct.Memory* %call2_4083d3)
...
block_.L_408480:                                  ; preds = %block_.L_4083df
  ...
  %call2_408480 = tail call %struct.Memory* @sub_400e30._Z5timerv(%struct.State* nonnull %0, i64 %342, %struct.Memory* %call2_4083d3)
  ...
  %call2_408489 = tail call %struct.Memory* @sub_4007d0._Z13record_resultdPKc(%struct.State* nonnull %0, i64 %353, %struct.Memory* %call2_408480)
