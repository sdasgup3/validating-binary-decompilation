...
block_.L_40839f:                                  ; preds = %block_.L_408428, %entry
  %79 = phi i64 [ %.pre, %entry ], [ %350, %block_.L_408428 ]
...
block_.L_4083f2:                                  ; preds = %block_4083fe, %block_.L_4083ed
  %210 = phi i64 [ %209, %block_.L_4083ed ], [ %307, %block_4083fe ]
...
block_4083fe:                                     ; preds = %block_.L_4083f2
  ...
  %call2_40840b = tail call %struct.Memory* @sub_401480._Z18complete_hash_funcIdET_S0_(%struct.State* %0, i64 %261, %struct.Memory* %MEMORY.2)
...
block_.L_408428:                                  ; preds = %block_.L_4083f2
  ...
  %call2_40842d = tail call %struct.Memory* @sub_4014b0._Z9check_sumIdEvT_(%struct.State* %0, i64 %313, %struct.Memory* %MEMORY.2)
...
block_.L_408440:                                  ; preds = %block_.L_40839f
  ...
  %call2_408440 = tail call %struct.Memory* @sub_400df0._Z5timerv(%struct.State* %0, i64 %351, %struct.Memory* %MEMORY.0)
  ...
  %call2_408449 = tail call %struct.Memory* @sub_400790._Z13record_resultdPKc(%struct.State* %0, i64 %362, %struct.Memory* %call2_408440)
