...
declare %struct.Memory* @sub_401aa0._ZN15loop_inner_bodyILi19EdE7do_workERdPKdi(%struct.State* dereferenceable(3376), i64, %struct.Memory*) local_unnamed_addr
...
define %struct.Memory* @_Z29test_while_loop_unroll_factorILi19EdEvPKT0_iPKc(%struct.State* noalias, i64, %struct.Memory* noalias) local_unnamed_addr #1 {
entry:
  ...
  %call2_4083c3 = tail call %struct.Memory* @sub_400e00._Z11start_timerv(%struct.State* %0, i64 %58, %struct.Memory* %2)
  ...
  br label %block_.L_4083cf

block_.L_4083cf:                                  ; preds = %block_.L_408458, %entry
  %74 = phi i64 [ %.pre, %entry ], [ %341, %block_.L_408458 ]
  %MEMORY.0 = phi %struct.Memory* [ %call2_4083c3, %entry ], [ %call2_40845d, %block_.L_408458 ]
  ...
  br i1 %107, label %block_4083df, label %block_.L_408470

block_4083df:                                     ; preds = %block_.L_4083cf
  ...
  br label %block_.L_4083ee

block_.L_4083ee:                                  ; preds = %block_4083ff, %block_4083df
  %118 = phi i64 [ %.pre9, %block_4083df ], [ %202, %block_4083ff ]
  %MEMORY.1 = phi %struct.Memory* [ %MEMORY.0, %block_4083df ], [ %call2_40840a, %block_4083ff ]
  ...
  br i1 %156, label %block_4083ff, label %block_.L_40841d

block_4083ff:                                     ; preds = %block_.L_4083ee
  %158 = add i64 %119, -40
  ...
  %call2_40840a = tail call %struct.Memory* @sub_401aa0._ZN15loop_inner_bodyILi19EdE7do_workERdPKdi(%struct.State* nonnull %0, i64 %166, %struct.Memory* %MEMORY.1)
...
block_.L_40841d:                                  ; preds = %block_.L_4083ee
  %203 = add i64 %157, 5
  br label %block_.L_408422

block_.L_408422:                                  ; preds = %block_40842e, %block_.L_40841d
  %204 = phi i64 [ %119, %block_.L_40841d ], [ %.pre10, %block_40842e ]
  %storemerge = phi i64 [ %203, %block_.L_40841d ], [ %299, %block_40842e ]
  %MEMORY.2 = phi %struct.Memory* [ %MEMORY.1, %block_.L_40841d ], [ %call2_40843b, %block_40842e ]
  %205 = add i64 %204, -44
  ...
  br i1 %239, label %block_40842e, label %block_.L_408458

block_40842e:                                     ; preds = %block_.L_408422
  %241 = add i64 %204, -8
  %242 = add i64 %240, 4
  ...
  %call2_40843b = tail call %struct.Memory* @sub_4014b0._Z18complete_hash_funcIdET_S0_(%struct.State* nonnull %0, i64 %253, %struct.Memory* %MEMORY.2)
...
block_.L_408458:                                  ; preds = %block_.L_408422
  %301 = add i64 %204, -40
  %302 = add i64 %240, 5
  ...
  %call2_40845d = tail call %struct.Memory* @sub_4014e0._Z9check_sumIdEvT_(%struct.State* nonnull %0, i64 %305, %struct.Memory* %MEMORY.2)
...
block_.L_408470:                                  ; preds = %block_.L_4083cf
  %342 = add i64 %108, -30288
  %343 = add i64 %108, 5
  ...
  %call2_408470 = tail call %struct.Memory* @sub_400e20._Z5timerv(%struct.State* nonnull %0, i64 %342, %struct.Memory* %MEMORY.0)
  ...
  %call2_408479 = tail call %struct.Memory* @sub_4007c0._Z13record_resultdPKc(%struct.State* nonnull %0, i64 %353, %struct.Memory* %call2_408470)
  ...
  ret %struct.Memory* %call2_408479
}
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_jge_.L_408470(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i8* nocapture %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_jge_.L_40841d(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i8* nocapture %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 2, i32 9
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_jmpq_.L_4083ee(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_jmpq_.L_408422(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_jge_.L_408458(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i8* nocapture %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 2, i32 9
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_jmpq_.L_4083cf(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
