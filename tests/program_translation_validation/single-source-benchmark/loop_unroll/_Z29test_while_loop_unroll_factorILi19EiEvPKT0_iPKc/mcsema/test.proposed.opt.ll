...
define %struct.Memory* @_Z29test_while_loop_unroll_factorILi19EiEvPKT0_iPKc(%struct.State* noalias, i64, %struct.Memory* noalias readnone) local_unnamed_addr #1 {
entry:
...
block_.L_412cbf:                                  ; preds = %block_.L_412d41, %entry
  %68 = phi i64 [ %362, %block_.L_412d41 ], [ %.pre, %entry ]
...
block_.L_412cdd:                                  ; preds = %block_412cee, %block_412ccf
  %111 = phi i64 [ %195, %block_412cee ], [ %.pre9, %block_412ccf ]
...
block_412cee:                                     ; preds = %block_.L_412cdd
  ...
  %call2_412cf9 = tail call %struct.Memory* @sub_40c660._ZN15loop_inner_bodyILi19EiE7do_workERiPKii(%struct.State* nonnull %0, i64 %159, %struct.Memory* %call2_412cb3)
...
block_412d1d:                                     ; preds = %block_.L_412d11
  ...
  %call2_412d28 = tail call %struct.Memory* @sub_40c100._Z18complete_hash_funcIiET_S0_(%struct.State* nonnull %0, i64 %247, %struct.Memory* %call2_412cb3)
...
block_.L_412d41:                                  ; preds = %block_.L_412d11
  ...
  %call2_412d44 = tail call %struct.Memory* @sub_40c130._Z9check_sumIiEvT_(%struct.State* nonnull %0, i64 %326, %struct.Memory* %call2_412cb3)
...
block_.L_412d57:                                  ; preds = %block_.L_412cbf
  ...
  %call2_412d57 = tail call %struct.Memory* @sub_400e20._Z5timerv(%struct.State* nonnull %0, i64 %363, %struct.Memory* %call2_412cb3)
