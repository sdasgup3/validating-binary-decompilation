...
block_.L_412c8f:                                  ; preds = %block_.L_412d11, %entry
  %68 = phi i64 [ %.pre, %entry ], [ %362, %block_.L_412d11 ]
...
block_.L_412ce1:                                  ; preds = %block_412ced, %block_.L_412cdc
  %197 = phi i64 [ %196, %block_.L_412cdc ], [ %320, %block_412ced ]
...
block_.L_412d11:                                  ; preds = %block_.L_412ce1
  ...
  %call2_412d14 = tail call %struct.Memory* @sub_40c100._Z9check_sumIiEvT_(%struct.State* %0, i64 %326, %struct.Memory* %MEMORY.2)
...
block_.L_412d27:                                  ; preds = %block_.L_412c8f
  ...
  %call2_412d27 = tail call %struct.Memory* @sub_400df0._Z5timerv(%struct.State* %0, i64 %363, %struct.Memory* %MEMORY.0)
  ...
  %call2_412d30 = tail call %struct.Memory* @sub_400790._Z13record_resultdPKc(%struct.State* %0, i64 %374, %struct.Memory* %call2_412d27)
