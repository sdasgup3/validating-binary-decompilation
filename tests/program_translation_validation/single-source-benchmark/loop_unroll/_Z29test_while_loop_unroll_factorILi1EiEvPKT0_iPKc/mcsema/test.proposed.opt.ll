...
block_.L_4140af:                                  ; preds = %block_.L_414131, %entry
  %68 = phi i64 [ %.pre, %entry ], [ %361, %block_.L_414131 ]
  %MEMORY.0 = phi %struct.Memory* [ %call2_4140a3, %entry ], [ %call2_414134, %block_.L_414131 ]
...
block_.L_4140cd:                                  ; preds = %block_4140de, %block_4140bf
  %111 = phi i64 [ %.pre9, %block_4140bf ], [ %194, %block_4140de ]
  %MEMORY.1 = phi %struct.Memory* [ %MEMORY.0, %block_4140bf ], [ %call2_4140e9, %block_4140de ]
...
block_4140de:                                     ; preds = %block_.L_4140cd
  ...
  %call2_4140e9 = tail call %struct.Memory* @sub_40cd20._ZN15loop_inner_bodyILi1EiE7do_workERiPKii(%struct.State* nonnull %0, i64 %158, %struct.Memory* %MEMORY.1)
...
block_.L_414101:                                  ; preds = %block_41410d, %block_.L_4140fc
  ...
  %MEMORY.2 = phi %struct.Memory* [ %MEMORY.1, %block_.L_4140fc ], [ %call2_414118, %block_41410d ]
  %197 = add i64 %196, -36
...
block_41410d:                                     ; preds = %block_.L_414101
  ...
  %call2_414118 = tail call %struct.Memory* @sub_40c100._Z18complete_hash_funcIiET_S0_(%struct.State* nonnull %0, i64 %246, %struct.Memory* %MEMORY.2)
...
block_.L_414131:                                  ; preds = %block_.L_414101
  ...
  %call2_414134 = tail call %struct.Memory* @sub_40c130._Z9check_sumIiEvT_(%struct.State* nonnull %0, i64 %325, %struct.Memory* %MEMORY.2)
...
block_.L_414147:                                  ; preds = %block_.L_4140af
  ...
  %call2_414147 = tail call %struct.Memory* @sub_400e20._Z5timerv(%struct.State* nonnull %0, i64 %362, %struct.Memory* %MEMORY.0)
