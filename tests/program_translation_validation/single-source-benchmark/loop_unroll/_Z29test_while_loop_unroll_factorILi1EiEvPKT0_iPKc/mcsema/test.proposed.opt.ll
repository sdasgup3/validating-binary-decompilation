...
entry:
  ...
  %call2_4140b3 = tail call %struct.Memory* @sub_400e10._Z11start_timerv(%struct.State* %0, i64 %58, %struct.Memory* %2)
...
block_.L_4140bf:                                  ; preds = %block_.L_414141, %entry
  %68 = phi i64 [ %361, %block_.L_414141 ], [ %.pre, %entry ]
  ...
  br i1 %101, label %block_4140cf, label %block_.L_414157
...
block_.L_4140dd:                                  ; preds = %block_4140ee, %block_4140cf
  %111 = phi i64 [ %194, %block_4140ee ], [ %.pre9, %block_4140cf ]
  ...
  br i1 %148, label %block_4140ee, label %block_.L_41410c
...
block_4140ee:                                     ; preds = %block_.L_4140dd
  ...
  %call2_4140f9 = tail call %struct.Memory* @sub_40cd30._ZN15loop_inner_bodyILi1EiE7do_workERiPKii(%struct.State* nonnull %0, i64 %158, %struct.Memory* %call2_4140b3)
...
block_.L_414111:                                  ; preds = %block_41411d, %block_.L_41410c
  %196 = phi i64 [ %112, %block_.L_41410c ], [ %.pre10, %block_41411d ]
  %storemerge = phi i64 [ %195, %block_.L_41410c ], [ %318, %block_41411d ]
  %197 = add i64 %196, -36
  ...
  br i1 %231, label %block_41411d, label %block_.L_414141
...
block_41411d:                                     ; preds = %block_.L_414111
  ...
  %call2_414128 = tail call %struct.Memory* @sub_40c110._Z18complete_hash_funcIiET_S0_(%struct.State* nonnull %0, i64 %246, %struct.Memory* %call2_4140b3)
...
block_.L_414141:                                  ; preds = %block_.L_414111
  ...
  %call2_414144 = tail call %struct.Memory* @sub_40c140._Z9check_sumIiEvT_(%struct.State* nonnull %0, i64 %325, %struct.Memory* %call2_4140b3)
...
block_.L_414157:                                  ; preds = %block_.L_4140bf
  ...
  %call2_414157 = tail call %struct.Memory* @sub_400e30._Z5timerv(%struct.State* nonnull %0, i64 %362, %struct.Memory* %call2_4140b3)
  ...
  %call2_414160 = tail call %struct.Memory* @sub_4007d0._Z13record_resultdPKc(%struct.State* nonnull %0, i64 %373, %struct.Memory* %call2_414157)
