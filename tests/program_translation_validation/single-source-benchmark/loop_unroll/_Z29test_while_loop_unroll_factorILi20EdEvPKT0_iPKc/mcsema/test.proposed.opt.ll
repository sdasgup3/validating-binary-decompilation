...
define %struct.Memory* @_Z29test_while_loop_unroll_factorILi20EdEvPKT0_iPKc(%struct.State* noalias, i64, %struct.Memory* noalias) local_unnamed_addr #1 {
entry:
  ...
  %call2_408263 = tail call %struct.Memory* @sub_400dd0._Z11start_timerv(%struct.State* %0, i64 %58, %struct.Memory* %2)
...
block_.L_40826f:                                  ; preds = %block_.L_4082f8, %entry
  %79 = phi i64 [ %.pre, %entry ], [ %346, %block_.L_4082f8 ]
  %MEMORY.0 = phi %struct.Memory* [ %call2_408263, %entry ], [ %call2_4082fd, %block_.L_4082f8 ]
  ...
  br i1 %112, label %block_40827f, label %block_.L_408310
...
block_.L_40828e:                                  ; preds = %block_40829f, %block_40827f
  %124 = phi i64 [ %.pre1, %block_40827f ], [ %208, %block_40829f ]
  %MEMORY.1 = phi %struct.Memory* [ %MEMORY.0, %block_40827f ], [ %call2_4082aa, %block_40829f ]
  ...
  br i1 %162, label %block_40829f, label %block_.L_4082bd
...
block_40829f:                                     ; preds = %block_.L_40828e
  ...
  %call2_4082aa = tail call %struct.Memory* @sub_401a10._ZN15loop_inner_bodyILi20EdE7do_workERdPKdi(%struct.State* %0, i64 %172, %struct.Memory* %MEMORY.1)
...
block_.L_4082c2:                                  ; preds = %block_4082ce, %block_.L_4082bd
  %210 = phi i64 [ %209, %block_.L_4082bd ], [ %305, %block_4082ce ]
  %211 = phi i64 [ %125, %block_.L_4082bd ], [ %.pre2, %block_4082ce ]
  %MEMORY.2 = phi %struct.Memory* [ %MEMORY.1, %block_.L_4082bd ], [ %call2_4082db, %block_4082ce ]
  %212 = add i64 %211, -44
  %213 = add i64 %210, 3
  ...
  br i1 %246, label %block_4082ce, label %block_.L_4082f8
...
block_4082ce:                                     ; preds = %block_.L_4082c2
  ...
  %call2_4082db = tail call %struct.Memory* @sub_401480._Z18complete_hash_funcIdET_S0_(%struct.State* %0, i64 %260, %struct.Memory* %MEMORY.2)
...
block_.L_4082f8:                                  ; preds = %block_.L_4082c2
  ...
  %call2_4082fd = tail call %struct.Memory* @sub_4014b0._Z9check_sumIdEvT_(%struct.State* %0, i64 %310, %struct.Memory* %MEMORY.2)
...
block_.L_408310:                                  ; preds = %block_.L_40826f
  ...
  %call2_408310 = tail call %struct.Memory* @sub_400df0._Z5timerv(%struct.State* %0, i64 %347, %struct.Memory* %MEMORY.0)
  ...
  %call2_408319 = tail call %struct.Memory* @sub_400790._Z13record_resultdPKc(%struct.State* %0, i64 %358, %struct.Memory* %call2_408310)
  ...
  ret %struct.Memory* %call2_408319
}
...
define %struct.Memory* @routine_jge_.L_408310(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i8* %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
...
define %struct.Memory* @routine_jge_.L_4082bd(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i8* %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 2, i32 9
...
define %struct.Memory* @routine_jmpq_.L_40828e(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
...
define %struct.Memory* @routine_jmpq_.L_4082c2(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
...
define %struct.Memory* @routine_jge_.L_4082f8(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i8* %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 2, i32 9
...
define %struct.Memory* @routine_jmpq_.L_40826f(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
