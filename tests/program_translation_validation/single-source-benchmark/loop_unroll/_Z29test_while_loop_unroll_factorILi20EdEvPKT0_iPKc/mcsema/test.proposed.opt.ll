...
entry:
  ...
  %call2_408293 = tail call %struct.Memory* @sub_400e00._Z11start_timerv(%struct.State* %0, i64 %58, %struct.Memory* %2)
...
block_.L_40829f:                                  ; preds = %block_.L_408328, %entry
  %74 = phi i64 [ %.pre, %entry ], [ %341, %block_.L_408328 ]
  %MEMORY.0 = phi %struct.Memory* [ %call2_408293, %entry ], [ %call2_40832d, %block_.L_408328 ]
  ...
  br i1 %107, label %block_4082af, label %block_.L_408340
...
block_.L_4082be:                                  ; preds = %block_4082cf, %block_4082af
  %118 = phi i64 [ %.pre9, %block_4082af ], [ %202, %block_4082cf ]
  %MEMORY.1 = phi %struct.Memory* [ %MEMORY.0, %block_4082af ], [ %call2_4082da, %block_4082cf ]
  ...
  br i1 %156, label %block_4082cf, label %block_.L_4082ed
...
block_4082cf:                                     ; preds = %block_.L_4082be
  ...
  %call2_4082da = tail call %struct.Memory* @sub_401a40._ZN15loop_inner_bodyILi20EdE7do_workERdPKdi(%struct.State* nonnull %0, i64 %166, %struct.Memory* %MEMORY.1)
...
block_.L_4082f2:                                  ; preds = %block_4082fe, %block_.L_4082ed
  %204 = phi i64 [ %119, %block_.L_4082ed ], [ %.pre10, %block_4082fe ]
  %storemerge = phi i64 [ %203, %block_.L_4082ed ], [ %299, %block_4082fe ]
  %MEMORY.2 = phi %struct.Memory* [ %MEMORY.1, %block_.L_4082ed ], [ %call2_40830b, %block_4082fe ]
  %205 = add i64 %204, -44
  ...
  br i1 %239, label %block_4082fe, label %block_.L_408328
...
block_4082fe:                                     ; preds = %block_.L_4082f2
  ...
  %call2_40830b = tail call %struct.Memory* @sub_4014b0._Z18complete_hash_funcIdET_S0_(%struct.State* nonnull %0, i64 %253, %struct.Memory* %MEMORY.2)
...
block_.L_408328:                                  ; preds = %block_.L_4082f2
  ...
  %call2_40832d = tail call %struct.Memory* @sub_4014e0._Z9check_sumIdEvT_(%struct.State* nonnull %0, i64 %305, %struct.Memory* %MEMORY.2)
...
block_.L_408340:                                  ; preds = %block_.L_40829f
  ...
  %call2_408340 = tail call %struct.Memory* @sub_400e20._Z5timerv(%struct.State* nonnull %0, i64 %342, %struct.Memory* %MEMORY.0)
  ...
  %call2_408349 = tail call %struct.Memory* @sub_4007c0._Z13record_resultdPKc(%struct.State* nonnull %0, i64 %353, %struct.Memory* %call2_408340)
  ...
  ret %struct.Memory* %call2_408349
}
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_jge_.L_408340(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i8* nocapture %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_jmpq_.L_4082be(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_jmpq_.L_4082f2(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_jge_.L_408328(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i8* nocapture %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 2, i32 9
