...
entry:
  ...
  %call2_4082a3 = tail call %struct.Memory* @sub_400e10._Z11start_timerv(%struct.State* %0, i64 %58, %struct.Memory* %2)
...
block_.L_4082af:                                  ; preds = %block_.L_408338, %entry
  %74 = phi i64 [ %341, %block_.L_408338 ], [ %.pre, %entry ]
  ...
  br i1 %107, label %block_4082bf, label %block_.L_408350
...
block_.L_4082ce:                                  ; preds = %block_4082df, %block_4082bf
  %118 = phi i64 [ %202, %block_4082df ], [ %.pre9, %block_4082bf ]
  ...
  br i1 %156, label %block_4082df, label %block_.L_4082fd
...
block_4082df:                                     ; preds = %block_.L_4082ce
  ...
  %call2_4082ea = tail call %struct.Memory* @sub_401a50._ZN15loop_inner_bodyILi20EdE7do_workERdPKdi(%struct.State* nonnull %0, i64 %166, %struct.Memory* %call2_4082a3)
...
block_.L_408302:                                  ; preds = %block_40830e, %block_.L_4082fd
  %204 = phi i64 [ %119, %block_.L_4082fd ], [ %.pre10, %block_40830e ]
  %storemerge = phi i64 [ %203, %block_.L_4082fd ], [ %299, %block_40830e ]
  %205 = add i64 %204, -44
  ...
  br i1 %239, label %block_40830e, label %block_.L_408338
...
block_40830e:                                     ; preds = %block_.L_408302
  ...
  %call2_40831b = tail call %struct.Memory* @sub_4014c0._Z18complete_hash_funcIdET_S0_(%struct.State* nonnull %0, i64 %253, %struct.Memory* %call2_4082a3)
...
block_.L_408338:                                  ; preds = %block_.L_408302
  ...
  %call2_40833d = tail call %struct.Memory* @sub_4014f0._Z9check_sumIdEvT_(%struct.State* nonnull %0, i64 %305, %struct.Memory* %call2_4082a3)
...
block_.L_408350:                                  ; preds = %block_.L_4082af
  ...
  %call2_408350 = tail call %struct.Memory* @sub_400e30._Z5timerv(%struct.State* nonnull %0, i64 %342, %struct.Memory* %call2_4082a3)
  ...
  %call2_408359 = tail call %struct.Memory* @sub_4007d0._Z13record_resultdPKc(%struct.State* nonnull %0, i64 %353, %struct.Memory* %call2_408350)
