...
block_.L_40826f:                                  ; preds = %block_.L_4082f8, %entry
  %79 = phi i64 [ %.pre, %entry ], [ %350, %block_.L_4082f8 ]
...
block_.L_4082c2:                                  ; preds = %block_4082ce, %block_.L_4082bd
  %210 = phi i64 [ %209, %block_.L_4082bd ], [ %307, %block_4082ce ]
...
block_4082ce:                                     ; preds = %block_.L_4082c2
  ...
  %call2_4082db = tail call %struct.Memory* @sub_401480._Z18complete_hash_funcIdET_S0_(%struct.State* %0, i64 %261, %struct.Memory* %MEMORY.2)
...
block_.L_4082f8:                                  ; preds = %block_.L_4082c2
  ...
  %call2_4082fd = tail call %struct.Memory* @sub_4014b0._Z9check_sumIdEvT_(%struct.State* %0, i64 %313, %struct.Memory* %MEMORY.2)
...
block_.L_408310:                                  ; preds = %block_.L_40826f
  ...
  %call2_408310 = tail call %struct.Memory* @sub_400df0._Z5timerv(%struct.State* %0, i64 %351, %struct.Memory* %MEMORY.0)
  ...
  %call2_408319 = tail call %struct.Memory* @sub_400790._Z13record_resultdPKc(%struct.State* %0, i64 %362, %struct.Memory* %call2_408310)
