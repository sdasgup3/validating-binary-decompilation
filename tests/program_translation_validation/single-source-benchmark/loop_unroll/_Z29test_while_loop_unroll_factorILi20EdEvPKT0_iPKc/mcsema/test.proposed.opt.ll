...
define %struct.Memory* @_Z29test_while_loop_unroll_factorILi20EdEvPKT0_iPKc(%struct.State* noalias, i64, %struct.Memory* noalias readnone) local_unnamed_addr #1 {
entry:
...
block_.L_40829f:                                  ; preds = %block_.L_408328, %entry
  %74 = phi i64 [ %341, %block_.L_408328 ], [ %.pre, %entry ]
...
block_.L_4082be:                                  ; preds = %block_4082cf, %block_4082af
  %118 = phi i64 [ %202, %block_4082cf ], [ %.pre9, %block_4082af ]
...
block_4082cf:                                     ; preds = %block_.L_4082be
  ...
  %call2_4082da = tail call %struct.Memory* @sub_401a40._ZN15loop_inner_bodyILi20EdE7do_workERdPKdi(%struct.State* nonnull %0, i64 %166, %struct.Memory* %call2_408293)
...
block_4082fe:                                     ; preds = %block_.L_4082f2
  ...
  %call2_40830b = tail call %struct.Memory* @sub_4014b0._Z18complete_hash_funcIdET_S0_(%struct.State* nonnull %0, i64 %253, %struct.Memory* %call2_408293)
...
block_.L_408328:                                  ; preds = %block_.L_4082f2
  ...
  %call2_40832d = tail call %struct.Memory* @sub_4014e0._Z9check_sumIdEvT_(%struct.State* nonnull %0, i64 %305, %struct.Memory* %call2_408293)
...
block_.L_408340:                                  ; preds = %block_.L_40829f
  ...
  %call2_408340 = tail call %struct.Memory* @sub_400e20._Z5timerv(%struct.State* nonnull %0, i64 %342, %struct.Memory* %call2_408293)
