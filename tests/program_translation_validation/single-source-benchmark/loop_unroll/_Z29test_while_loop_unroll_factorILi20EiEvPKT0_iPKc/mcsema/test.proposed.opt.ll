...
entry:
  ...
  %call2_412ba3 = tail call %struct.Memory* @sub_400e10._Z11start_timerv(%struct.State* %0, i64 %58, %struct.Memory* %2)
...
block_.L_412baf:                                  ; preds = %block_.L_412c31, %entry
  %68 = phi i64 [ %362, %block_.L_412c31 ], [ %.pre, %entry ]
  ...
  br i1 %101, label %block_412bbf, label %block_.L_412c47
...
block_.L_412bcd:                                  ; preds = %block_412bde, %block_412bbf
  %111 = phi i64 [ %195, %block_412bde ], [ %.pre9, %block_412bbf ]
  ...
  br i1 %149, label %block_412bde, label %block_.L_412bfc
...
block_412bde:                                     ; preds = %block_.L_412bcd
  ...
  %call2_412be9 = tail call %struct.Memory* @sub_40c610._ZN15loop_inner_bodyILi20EiE7do_workERiPKii(%struct.State* nonnull %0, i64 %159, %struct.Memory* %call2_412ba3)
...
block_.L_412c01:                                  ; preds = %block_412c0d, %block_.L_412bfc
  %197 = phi i64 [ %112, %block_.L_412bfc ], [ %.pre10, %block_412c0d ]
  %storemerge = phi i64 [ %196, %block_.L_412bfc ], [ %319, %block_412c0d ]
  %198 = add i64 %197, -36
  ...
  br i1 %232, label %block_412c0d, label %block_.L_412c31
...
block_412c0d:                                     ; preds = %block_.L_412c01
  ...
  %call2_412c18 = tail call %struct.Memory* @sub_40c110._Z18complete_hash_funcIiET_S0_(%struct.State* nonnull %0, i64 %247, %struct.Memory* %call2_412ba3)
...
block_.L_412c31:                                  ; preds = %block_.L_412c01
  ...
  %call2_412c34 = tail call %struct.Memory* @sub_40c140._Z9check_sumIiEvT_(%struct.State* nonnull %0, i64 %326, %struct.Memory* %call2_412ba3)
...
block_.L_412c47:                                  ; preds = %block_.L_412baf
  ...
  %call2_412c47 = tail call %struct.Memory* @sub_400e30._Z5timerv(%struct.State* nonnull %0, i64 %363, %struct.Memory* %call2_412ba3)
  ...
  %call2_412c50 = tail call %struct.Memory* @sub_4007d0._Z13record_resultdPKc(%struct.State* nonnull %0, i64 %374, %struct.Memory* %call2_412c47)
