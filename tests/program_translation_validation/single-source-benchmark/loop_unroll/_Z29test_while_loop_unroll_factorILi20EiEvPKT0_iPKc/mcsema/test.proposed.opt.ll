...
define %struct.Memory* @_Z29test_while_loop_unroll_factorILi20EiEvPKT0_iPKc(%struct.State* noalias, i64, %struct.Memory* noalias readnone) local_unnamed_addr #1 {
entry:
...
block_.L_412b9f:                                  ; preds = %block_.L_412c21, %entry
  %68 = phi i64 [ %362, %block_.L_412c21 ], [ %.pre, %entry ]
...
block_.L_412bbd:                                  ; preds = %block_412bce, %block_412baf
  %111 = phi i64 [ %195, %block_412bce ], [ %.pre9, %block_412baf ]
...
block_412bce:                                     ; preds = %block_.L_412bbd
  ...
  %call2_412bd9 = tail call %struct.Memory* @sub_40c600._ZN15loop_inner_bodyILi20EiE7do_workERiPKii(%struct.State* nonnull %0, i64 %159, %struct.Memory* %call2_412b93)
...
block_412bfd:                                     ; preds = %block_.L_412bf1
  ...
  %call2_412c08 = tail call %struct.Memory* @sub_40c100._Z18complete_hash_funcIiET_S0_(%struct.State* nonnull %0, i64 %247, %struct.Memory* %call2_412b93)
...
block_.L_412c21:                                  ; preds = %block_.L_412bf1
  ...
  %call2_412c24 = tail call %struct.Memory* @sub_40c130._Z9check_sumIiEvT_(%struct.State* nonnull %0, i64 %326, %struct.Memory* %call2_412b93)
...
block_.L_412c37:                                  ; preds = %block_.L_412b9f
  ...
  %call2_412c37 = tail call %struct.Memory* @sub_400e20._Z5timerv(%struct.State* nonnull %0, i64 %363, %struct.Memory* %call2_412b93)
