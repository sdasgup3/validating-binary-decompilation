...
entry:
  ...
  %call2_412b63 = tail call %struct.Memory* @sub_400dd0._Z11start_timerv(%struct.State* %0, i64 %58, %struct.Memory* %2)
...
block_.L_412b6f:                                  ; preds = %block_.L_412bf1, %entry
  %68 = phi i64 [ %.pre, %entry ], [ %362, %block_.L_412bf1 ]
  %MEMORY.0 = phi %struct.Memory* [ %call2_412b63, %entry ], [ %call2_412bf4, %block_.L_412bf1 ]
  ...
  br i1 %101, label %block_412b7f, label %block_.L_412c07
...
block_.L_412b8d:                                  ; preds = %block_412b9e, %block_412b7f
  %111 = phi i64 [ %.pre1, %block_412b7f ], [ %195, %block_412b9e ]
  %MEMORY.1 = phi %struct.Memory* [ %MEMORY.0, %block_412b7f ], [ %call2_412ba9, %block_412b9e ]
  ...
  br i1 %149, label %block_412b9e, label %block_.L_412bbc
...
block_412b9e:                                     ; preds = %block_.L_412b8d
  ...
  %call2_412ba9 = tail call %struct.Memory* @sub_40c5d0._ZN15loop_inner_bodyILi20EiE7do_workERiPKii(%struct.State* %0, i64 %159, %struct.Memory* %MEMORY.1)
...
block_.L_412bc1:                                  ; preds = %block_412bcd, %block_.L_412bbc
  %197 = phi i64 [ %196, %block_.L_412bbc ], [ %320, %block_412bcd ]
  %198 = phi i64 [ %112, %block_.L_412bbc ], [ %.pre2, %block_412bcd ]
  %MEMORY.2 = phi %struct.Memory* [ %MEMORY.1, %block_.L_412bbc ], [ %call2_412bd8, %block_412bcd ]
  %199 = add i64 %198, -36
  %200 = add i64 %197, 3
  ...
  br i1 %233, label %block_412bcd, label %block_.L_412bf1
...
block_412bcd:                                     ; preds = %block_.L_412bc1
  ...
  %call2_412bd8 = tail call %struct.Memory* @sub_40c0d0._Z18complete_hash_funcIiET_S0_(%struct.State* %0, i64 %248, %struct.Memory* %MEMORY.2)
...
block_.L_412bf1:                                  ; preds = %block_.L_412bc1
  ...
  %call2_412bf4 = tail call %struct.Memory* @sub_40c100._Z9check_sumIiEvT_(%struct.State* %0, i64 %326, %struct.Memory* %MEMORY.2)
...
block_.L_412c07:                                  ; preds = %block_.L_412b6f
  ...
  %call2_412c07 = tail call %struct.Memory* @sub_400df0._Z5timerv(%struct.State* %0, i64 %363, %struct.Memory* %MEMORY.0)
  ...
  %call2_412c10 = tail call %struct.Memory* @sub_400790._Z13record_resultdPKc(%struct.State* %0, i64 %374, %struct.Memory* %call2_412c07)
  ...
  ret %struct.Memory* %call2_412c10
}
...
define %struct.Memory* @routine_jge_.L_412c07(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i8* %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
...
define %struct.Memory* @routine_jge_.L_412bbc(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i8* %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 2, i32 9
...
define %struct.Memory* @routine_jmpq_.L_412b8d(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
...
define %struct.Memory* @routine_jmpq_.L_412bc1(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
...
define %struct.Memory* @routine_jge_.L_412bf1(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i8* %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 2, i32 9
...
define %struct.Memory* @routine_jmpq_.L_412b6f(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
