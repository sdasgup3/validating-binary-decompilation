...
block_.L_412b6f:                                  ; preds = %block_.L_412bf1, %entry
  %68 = phi i64 [ %.pre, %entry ], [ %364, %block_.L_412bf1 ]
...
block_.L_412bc1:                                  ; preds = %block_412bcd, %block_.L_412bbc
  %197 = phi i64 [ %196, %block_.L_412bbc ], [ %321, %block_412bcd ]
...
block_.L_412bf1:                                  ; preds = %block_.L_412bc1
  ...
  %call2_412bf4 = tail call %struct.Memory* @sub_40c100._Z9check_sumIiEvT_(%struct.State* %0, i64 %327, %struct.Memory* %MEMORY.2)
...
block_.L_412c07:                                  ; preds = %block_.L_412b6f
  ...
  %call2_412c07 = tail call %struct.Memory* @sub_400df0._Z5timerv(%struct.State* %0, i64 %365, %struct.Memory* %MEMORY.0)
  ...
  %call2_412c10 = tail call %struct.Memory* @sub_400790._Z13record_resultdPKc(%struct.State* %0, i64 %376, %struct.Memory* %call2_412c07)
