...
define %struct.Memory* @_Z29test_while_loop_unroll_factorILi21EdEvPKT0_iPKc(%struct.State* noalias, i64, %struct.Memory* noalias) #2 {
entry:
  ...
  store %struct.Memory* %loadMem_408164, %struct.Memory** %MEMORY
  ...
  store i32 %93, i32* %97
  store %struct.Memory* %loadMem_40816c, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem1_408173, %struct.Memory** %MEMORY
...
block_.L_40817f:                                  ; preds = %block_.L_408208, %entry
  ...
  store %struct.Memory* %loadMem_408182, %struct.Memory** %MEMORY
...
block_40818f:                                     ; preds = %block_.L_40817f
  ...
  store %struct.Memory* %loadMem_40818f, %struct.Memory** %MEMORY
...
block_.L_40819e:                                  ; preds = %block_4081af, %block_40818f
  ...
  store %struct.Memory* %loadMem_40819e, %struct.Memory** %MEMORY
...
block_4081af:                                     ; preds = %block_.L_40819e
  ...
  store %struct.Memory* %loadMem_4081b7, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem1_4081ba, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_4081c2, %struct.Memory** %MEMORY
...
block_.L_4081cd:                                  ; preds = %block_.L_40819e
  ...
  store %struct.Memory* %loadMem_4081cd, %struct.Memory** %MEMORY
  br label %block_.L_4081d2

block_.L_4081d2:                                  ; preds = %block_4081de, %block_.L_4081cd
...
block_4081de:                                     ; preds = %block_.L_4081d2
  ...
  store %struct.Memory* %loadMem_4081de, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem1_4081eb, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_4081f0, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_4081fd, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_408200, %struct.Memory** %MEMORY
...
block_.L_408208:                                  ; preds = %block_.L_4081d2
  ...
  store %struct.Memory* %loadMem1_40820d, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_40821b, %struct.Memory** %MEMORY
  br label %block_.L_40817f

block_.L_408220:                                  ; preds = %block_.L_40817f
  ...
  store %struct.Memory* %loadMem1_408220, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem1_408229, %struct.Memory** %MEMORY
  ...
  ret %struct.Memory* %loadMem_408233
}
