...
block_.L_40813f:                                  ; preds = %block_.L_4081c8, %entry
  %79 = phi i64 [ %.pre, %entry ], [ %346, %block_.L_4081c8 ]
...
block_.L_408192:                                  ; preds = %block_40819e, %block_.L_40818d
  %210 = phi i64 [ %209, %block_.L_40818d ], [ %305, %block_40819e ]
...
block_40819e:                                     ; preds = %block_.L_408192
  ...
  %call2_4081ab = tail call %struct.Memory* @sub_401480._Z18complete_hash_funcIdET_S0_(%struct.State* %0, i64 %260, %struct.Memory* %MEMORY.2)
...
block_.L_4081c8:                                  ; preds = %block_.L_408192
  ...
  %call2_4081cd = tail call %struct.Memory* @sub_4014b0._Z9check_sumIdEvT_(%struct.State* %0, i64 %310, %struct.Memory* %MEMORY.2)
...
block_.L_4081e0:                                  ; preds = %block_.L_40813f
  ...
  %call2_4081e0 = tail call %struct.Memory* @sub_400df0._Z5timerv(%struct.State* %0, i64 %347, %struct.Memory* %MEMORY.0)
  ...
  %call2_4081e9 = tail call %struct.Memory* @sub_400790._Z13record_resultdPKc(%struct.State* %0, i64 %358, %struct.Memory* %call2_4081e0)
