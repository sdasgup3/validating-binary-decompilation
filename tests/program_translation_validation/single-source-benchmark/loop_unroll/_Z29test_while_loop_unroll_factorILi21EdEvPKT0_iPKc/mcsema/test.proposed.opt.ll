...
entry:
  ...
  %call2_408163 = tail call %struct.Memory* @sub_400e00._Z11start_timerv(%struct.State* %0, i64 %58, %struct.Memory* %2)
...
block_.L_40816f:                                  ; preds = %block_.L_4081f8, %entry
  %74 = phi i64 [ %.pre, %entry ], [ %341, %block_.L_4081f8 ]
  %MEMORY.0 = phi %struct.Memory* [ %call2_408163, %entry ], [ %call2_4081fd, %block_.L_4081f8 ]
  ...
  br i1 %107, label %block_40817f, label %block_.L_408210
...
block_.L_40818e:                                  ; preds = %block_40819f, %block_40817f
  %118 = phi i64 [ %.pre9, %block_40817f ], [ %202, %block_40819f ]
  %MEMORY.1 = phi %struct.Memory* [ %MEMORY.0, %block_40817f ], [ %call2_4081aa, %block_40819f ]
  ...
  br i1 %156, label %block_40819f, label %block_.L_4081bd
...
block_40819f:                                     ; preds = %block_.L_40818e
  ...
  %call2_4081aa = tail call %struct.Memory* @sub_4019e0._ZN15loop_inner_bodyILi21EdE7do_workERdPKdi(%struct.State* nonnull %0, i64 %166, %struct.Memory* %MEMORY.1)
...
block_.L_4081c2:                                  ; preds = %block_4081ce, %block_.L_4081bd
  %204 = phi i64 [ %119, %block_.L_4081bd ], [ %.pre10, %block_4081ce ]
  %storemerge = phi i64 [ %203, %block_.L_4081bd ], [ %299, %block_4081ce ]
  %MEMORY.2 = phi %struct.Memory* [ %MEMORY.1, %block_.L_4081bd ], [ %call2_4081db, %block_4081ce ]
  %205 = add i64 %204, -44
  ...
  br i1 %239, label %block_4081ce, label %block_.L_4081f8
...
block_4081ce:                                     ; preds = %block_.L_4081c2
  ...
  %call2_4081db = tail call %struct.Memory* @sub_4014b0._Z18complete_hash_funcIdET_S0_(%struct.State* nonnull %0, i64 %253, %struct.Memory* %MEMORY.2)
...
block_.L_4081f8:                                  ; preds = %block_.L_4081c2
  ...
  %call2_4081fd = tail call %struct.Memory* @sub_4014e0._Z9check_sumIdEvT_(%struct.State* nonnull %0, i64 %305, %struct.Memory* %MEMORY.2)
...
block_.L_408210:                                  ; preds = %block_.L_40816f
  ...
  %call2_408210 = tail call %struct.Memory* @sub_400e20._Z5timerv(%struct.State* nonnull %0, i64 %342, %struct.Memory* %MEMORY.0)
  ...
  %call2_408219 = tail call %struct.Memory* @sub_4007c0._Z13record_resultdPKc(%struct.State* nonnull %0, i64 %353, %struct.Memory* %call2_408210)
  ...
  ret %struct.Memory* %call2_408219
}
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_jge_.L_408210(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i8* nocapture %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_jmpq_.L_40818e(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_jmpq_.L_4081c2(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_jge_.L_4081f8(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i8* nocapture %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 2, i32 9
