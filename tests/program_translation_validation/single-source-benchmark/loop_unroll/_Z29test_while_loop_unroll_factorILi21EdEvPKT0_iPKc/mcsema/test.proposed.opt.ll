...
entry:
  ...
  %call2_408173 = tail call %struct.Memory* @sub_400e10._Z11start_timerv(%struct.State* %0, i64 %58, %struct.Memory* %2)
...
block_.L_40817f:                                  ; preds = %block_.L_408208, %entry
  %74 = phi i64 [ %341, %block_.L_408208 ], [ %.pre, %entry ]
  ...
  br i1 %107, label %block_40818f, label %block_.L_408220
...
block_.L_40819e:                                  ; preds = %block_4081af, %block_40818f
  %118 = phi i64 [ %202, %block_4081af ], [ %.pre9, %block_40818f ]
  ...
  br i1 %156, label %block_4081af, label %block_.L_4081cd
...
block_4081af:                                     ; preds = %block_.L_40819e
  ...
  %call2_4081ba = tail call %struct.Memory* @sub_4019f0._ZN15loop_inner_bodyILi21EdE7do_workERdPKdi(%struct.State* nonnull %0, i64 %166, %struct.Memory* %call2_408173)
...
block_.L_4081d2:                                  ; preds = %block_4081de, %block_.L_4081cd
  %204 = phi i64 [ %119, %block_.L_4081cd ], [ %.pre10, %block_4081de ]
  %storemerge = phi i64 [ %203, %block_.L_4081cd ], [ %299, %block_4081de ]
  %205 = add i64 %204, -44
  ...
  br i1 %239, label %block_4081de, label %block_.L_408208
...
block_4081de:                                     ; preds = %block_.L_4081d2
  ...
  %call2_4081eb = tail call %struct.Memory* @sub_4014c0._Z18complete_hash_funcIdET_S0_(%struct.State* nonnull %0, i64 %253, %struct.Memory* %call2_408173)
...
block_.L_408208:                                  ; preds = %block_.L_4081d2
  ...
  %call2_40820d = tail call %struct.Memory* @sub_4014f0._Z9check_sumIdEvT_(%struct.State* nonnull %0, i64 %305, %struct.Memory* %call2_408173)
...
block_.L_408220:                                  ; preds = %block_.L_40817f
  ...
  %call2_408220 = tail call %struct.Memory* @sub_400e30._Z5timerv(%struct.State* nonnull %0, i64 %342, %struct.Memory* %call2_408173)
  ...
  %call2_408229 = tail call %struct.Memory* @sub_4007d0._Z13record_resultdPKc(%struct.State* nonnull %0, i64 %353, %struct.Memory* %call2_408220)
