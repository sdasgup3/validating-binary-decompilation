...
define %struct.Memory* @_Z29test_while_loop_unroll_factorILi21EdEvPKT0_iPKc(%struct.State* noalias, i64, %struct.Memory* noalias readnone) local_unnamed_addr #1 {
entry:
...
block_.L_40816f:                                  ; preds = %block_.L_4081f8, %entry
  %74 = phi i64 [ %341, %block_.L_4081f8 ], [ %.pre, %entry ]
...
block_.L_40818e:                                  ; preds = %block_40819f, %block_40817f
  %118 = phi i64 [ %202, %block_40819f ], [ %.pre9, %block_40817f ]
...
block_40819f:                                     ; preds = %block_.L_40818e
  ...
  %call2_4081aa = tail call %struct.Memory* @sub_4019e0._ZN15loop_inner_bodyILi21EdE7do_workERdPKdi(%struct.State* nonnull %0, i64 %166, %struct.Memory* %call2_408163)
...
block_4081ce:                                     ; preds = %block_.L_4081c2
  ...
  %call2_4081db = tail call %struct.Memory* @sub_4014b0._Z18complete_hash_funcIdET_S0_(%struct.State* nonnull %0, i64 %253, %struct.Memory* %call2_408163)
...
block_.L_4081f8:                                  ; preds = %block_.L_4081c2
  ...
  %call2_4081fd = tail call %struct.Memory* @sub_4014e0._Z9check_sumIdEvT_(%struct.State* nonnull %0, i64 %305, %struct.Memory* %call2_408163)
...
block_.L_408210:                                  ; preds = %block_.L_40816f
  ...
  %call2_408210 = tail call %struct.Memory* @sub_400e20._Z5timerv(%struct.State* nonnull %0, i64 %342, %struct.Memory* %call2_408163)
