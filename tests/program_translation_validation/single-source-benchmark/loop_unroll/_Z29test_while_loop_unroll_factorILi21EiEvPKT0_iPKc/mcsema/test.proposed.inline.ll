...
define %struct.Memory* @_Z29test_while_loop_unroll_factorILi21EiEvPKT0_iPKc(%struct.State* noalias, i64, %struct.Memory* noalias) #1 {
entry:
  ...
  store %struct.Memory* %loadMem_412a60, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem1_412a73, %struct.Memory** %MEMORY
...
block_.L_412a7f:                                  ; preds = %block_.L_412b01, %entry
...
block_412a8f:                                     ; preds = %block_.L_412a7f
  ...
  store i32 0, i32* %236
  store %struct.Memory* %loadMem_412a96, %struct.Memory** %MEMORY
  br label %block_.L_412a9d

block_.L_412a9d:                                  ; preds = %block_412aae, %block_412a8f
  ...
  store %struct.Memory* %loadMem_412a9d, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_412aa3, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_412aa8, %struct.Memory** %MEMORY
...
block_412aae:                                     ; preds = %block_.L_412a9d
  ...
  store %struct.Memory* %loadMem_412ab2, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem1_412ab9, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_412ac1, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_412ac4, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_412ac7, %struct.Memory** %MEMORY
  br label %block_.L_412a9d

block_.L_412acc:                                  ; preds = %block_.L_412a9d
...
block_.L_412ad1:                                  ; preds = %block_412add, %block_.L_412acc
...
block_412add:                                     ; preds = %block_.L_412ad1
  ...
  store %struct.Memory* %loadMem_412add, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_412ae5, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem1_412ae8, %struct.Memory** %MEMORY
...
block_.L_412b01:                                  ; preds = %block_.L_412ad1
  ...
  store %struct.Memory* %loadMem1_412b04, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_412b0f, %struct.Memory** %MEMORY
...
block_.L_412b17:                                  ; preds = %block_.L_412a7f
  ...
  store %struct.Memory* %loadMem1_412b17, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem1_412b20, %struct.Memory** %MEMORY
  ...
  ret %struct.Memory* %loadMem_412b2a
}
