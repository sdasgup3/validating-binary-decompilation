...
entry:
  ...
  %call2_412a83 = tail call %struct.Memory* @sub_400e10._Z11start_timerv(%struct.State* %0, i64 %58, %struct.Memory* %2)
...
block_.L_412a8f:                                  ; preds = %block_.L_412b11, %entry
  %68 = phi i64 [ %362, %block_.L_412b11 ], [ %.pre, %entry ]
  ...
  br i1 %101, label %block_412a9f, label %block_.L_412b27
...
block_.L_412aad:                                  ; preds = %block_412abe, %block_412a9f
  %111 = phi i64 [ %195, %block_412abe ], [ %.pre9, %block_412a9f ]
  ...
  br i1 %149, label %block_412abe, label %block_.L_412adc
...
block_412abe:                                     ; preds = %block_.L_412aad
  ...
  %call2_412ac9 = tail call %struct.Memory* @sub_40c5b0._ZN15loop_inner_bodyILi21EiE7do_workERiPKii(%struct.State* nonnull %0, i64 %159, %struct.Memory* %call2_412a83)
...
block_.L_412ae1:                                  ; preds = %block_412aed, %block_.L_412adc
  %197 = phi i64 [ %112, %block_.L_412adc ], [ %.pre10, %block_412aed ]
  %storemerge = phi i64 [ %196, %block_.L_412adc ], [ %319, %block_412aed ]
  %198 = add i64 %197, -36
  ...
  br i1 %232, label %block_412aed, label %block_.L_412b11
...
block_412aed:                                     ; preds = %block_.L_412ae1
  ...
  %call2_412af8 = tail call %struct.Memory* @sub_40c110._Z18complete_hash_funcIiET_S0_(%struct.State* nonnull %0, i64 %247, %struct.Memory* %call2_412a83)
...
block_.L_412b11:                                  ; preds = %block_.L_412ae1
  ...
  %call2_412b14 = tail call %struct.Memory* @sub_40c140._Z9check_sumIiEvT_(%struct.State* nonnull %0, i64 %326, %struct.Memory* %call2_412a83)
...
block_.L_412b27:                                  ; preds = %block_.L_412a8f
  ...
  %call2_412b27 = tail call %struct.Memory* @sub_400e30._Z5timerv(%struct.State* nonnull %0, i64 %363, %struct.Memory* %call2_412a83)
  ...
  %call2_412b30 = tail call %struct.Memory* @sub_4007d0._Z13record_resultdPKc(%struct.State* nonnull %0, i64 %374, %struct.Memory* %call2_412b27)
