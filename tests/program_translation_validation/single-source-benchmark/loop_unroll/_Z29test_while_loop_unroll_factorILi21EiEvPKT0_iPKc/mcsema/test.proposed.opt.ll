...
entry:
  ...
  %call2_412a43 = tail call %struct.Memory* @sub_400dd0._Z11start_timerv(%struct.State* %0, i64 %58, %struct.Memory* %2)
...
block_.L_412a4f:                                  ; preds = %block_.L_412ad1, %entry
  %68 = phi i64 [ %.pre, %entry ], [ %362, %block_.L_412ad1 ]
  %MEMORY.0 = phi %struct.Memory* [ %call2_412a43, %entry ], [ %call2_412ad4, %block_.L_412ad1 ]
  ...
  br i1 %101, label %block_412a5f, label %block_.L_412ae7
...
block_.L_412a6d:                                  ; preds = %block_412a7e, %block_412a5f
  %111 = phi i64 [ %.pre1, %block_412a5f ], [ %195, %block_412a7e ]
  %MEMORY.1 = phi %struct.Memory* [ %MEMORY.0, %block_412a5f ], [ %call2_412a89, %block_412a7e ]
  ...
  br i1 %149, label %block_412a7e, label %block_.L_412a9c
...
block_412a7e:                                     ; preds = %block_.L_412a6d
  ...
  %call2_412a89 = tail call %struct.Memory* @sub_40c570._ZN15loop_inner_bodyILi21EiE7do_workERiPKii(%struct.State* %0, i64 %159, %struct.Memory* %MEMORY.1)
...
block_.L_412aa1:                                  ; preds = %block_412aad, %block_.L_412a9c
  %197 = phi i64 [ %196, %block_.L_412a9c ], [ %320, %block_412aad ]
  %198 = phi i64 [ %112, %block_.L_412a9c ], [ %.pre2, %block_412aad ]
  %MEMORY.2 = phi %struct.Memory* [ %MEMORY.1, %block_.L_412a9c ], [ %call2_412ab8, %block_412aad ]
  %199 = add i64 %198, -36
  %200 = add i64 %197, 3
  ...
  br i1 %233, label %block_412aad, label %block_.L_412ad1
...
block_412aad:                                     ; preds = %block_.L_412aa1
  ...
  %call2_412ab8 = tail call %struct.Memory* @sub_40c0d0._Z18complete_hash_funcIiET_S0_(%struct.State* %0, i64 %248, %struct.Memory* %MEMORY.2)
...
block_.L_412ad1:                                  ; preds = %block_.L_412aa1
  ...
  %call2_412ad4 = tail call %struct.Memory* @sub_40c100._Z9check_sumIiEvT_(%struct.State* %0, i64 %326, %struct.Memory* %MEMORY.2)
...
block_.L_412ae7:                                  ; preds = %block_.L_412a4f
  ...
  %call2_412ae7 = tail call %struct.Memory* @sub_400df0._Z5timerv(%struct.State* %0, i64 %363, %struct.Memory* %MEMORY.0)
  ...
  %call2_412af0 = tail call %struct.Memory* @sub_400790._Z13record_resultdPKc(%struct.State* %0, i64 %374, %struct.Memory* %call2_412ae7)
  ...
  ret %struct.Memory* %call2_412af0
}
...
define %struct.Memory* @routine_jge_.L_412ae7(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i8* %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
...
define %struct.Memory* @routine_jge_.L_412a9c(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i8* %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 2, i32 9
...
define %struct.Memory* @routine_jmpq_.L_412a6d(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
...
define %struct.Memory* @routine_jmpq_.L_412aa1(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
...
define %struct.Memory* @routine_jge_.L_412ad1(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i8* %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 2, i32 9
...
define %struct.Memory* @routine_jmpq_.L_412a4f(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
