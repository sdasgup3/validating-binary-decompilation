...
define %struct.Memory* @_Z29test_while_loop_unroll_factorILi21EiEvPKT0_iPKc(%struct.State* noalias, i64, %struct.Memory* noalias readnone) local_unnamed_addr #1 {
entry:
...
block_.L_412a7f:                                  ; preds = %block_.L_412b01, %entry
  %68 = phi i64 [ %362, %block_.L_412b01 ], [ %.pre, %entry ]
...
block_.L_412a9d:                                  ; preds = %block_412aae, %block_412a8f
  %111 = phi i64 [ %195, %block_412aae ], [ %.pre9, %block_412a8f ]
...
block_412aae:                                     ; preds = %block_.L_412a9d
  ...
  %call2_412ab9 = tail call %struct.Memory* @sub_40c5a0._ZN15loop_inner_bodyILi21EiE7do_workERiPKii(%struct.State* nonnull %0, i64 %159, %struct.Memory* %call2_412a73)
...
block_412add:                                     ; preds = %block_.L_412ad1
  ...
  %call2_412ae8 = tail call %struct.Memory* @sub_40c100._Z18complete_hash_funcIiET_S0_(%struct.State* nonnull %0, i64 %247, %struct.Memory* %call2_412a73)
...
block_.L_412b01:                                  ; preds = %block_.L_412ad1
  ...
  %call2_412b04 = tail call %struct.Memory* @sub_40c130._Z9check_sumIiEvT_(%struct.State* nonnull %0, i64 %326, %struct.Memory* %call2_412a73)
...
block_.L_412b17:                                  ; preds = %block_.L_412a7f
  ...
  %call2_412b17 = tail call %struct.Memory* @sub_400e20._Z5timerv(%struct.State* nonnull %0, i64 %363, %struct.Memory* %call2_412a73)
