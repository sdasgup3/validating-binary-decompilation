...
block_.L_412a4f:                                  ; preds = %block_.L_412ad1, %entry
  %68 = phi i64 [ %.pre, %entry ], [ %364, %block_.L_412ad1 ]
...
block_.L_412aa1:                                  ; preds = %block_412aad, %block_.L_412a9c
  %197 = phi i64 [ %196, %block_.L_412a9c ], [ %321, %block_412aad ]
...
block_.L_412ad1:                                  ; preds = %block_.L_412aa1
  ...
  %call2_412ad4 = tail call %struct.Memory* @sub_40c100._Z9check_sumIiEvT_(%struct.State* %0, i64 %327, %struct.Memory* %MEMORY.2)
...
block_.L_412ae7:                                  ; preds = %block_.L_412a4f
  ...
  %call2_412ae7 = tail call %struct.Memory* @sub_400df0._Z5timerv(%struct.State* %0, i64 %365, %struct.Memory* %MEMORY.0)
  ...
  %call2_412af0 = tail call %struct.Memory* @sub_400790._Z13record_resultdPKc(%struct.State* %0, i64 %376, %struct.Memory* %call2_412ae7)
