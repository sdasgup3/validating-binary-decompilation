...
entry:
  ...
  %call2_408003 = tail call %struct.Memory* @sub_400dd0._Z11start_timerv(%struct.State* %0, i64 %58, %struct.Memory* %2)
...
block_.L_40800f:                                  ; preds = %block_.L_408098, %entry
  %79 = phi i64 [ %.pre, %entry ], [ %346, %block_.L_408098 ]
  %MEMORY.0 = phi %struct.Memory* [ %call2_408003, %entry ], [ %call2_40809d, %block_.L_408098 ]
  ...
  br i1 %112, label %block_40801f, label %block_.L_4080b0
...
block_.L_40802e:                                  ; preds = %block_40803f, %block_40801f
  %124 = phi i64 [ %.pre1, %block_40801f ], [ %208, %block_40803f ]
  %MEMORY.1 = phi %struct.Memory* [ %MEMORY.0, %block_40801f ], [ %call2_40804a, %block_40803f ]
  ...
  br i1 %162, label %block_40803f, label %block_.L_40805d
...
block_40803f:                                     ; preds = %block_.L_40802e
  ...
  %call2_40804a = tail call %struct.Memory* @sub_401950._ZN15loop_inner_bodyILi22EdE7do_workERdPKdi(%struct.State* %0, i64 %172, %struct.Memory* %MEMORY.1)
...
block_.L_408062:                                  ; preds = %block_40806e, %block_.L_40805d
  %210 = phi i64 [ %209, %block_.L_40805d ], [ %305, %block_40806e ]
  %211 = phi i64 [ %125, %block_.L_40805d ], [ %.pre2, %block_40806e ]
  %MEMORY.2 = phi %struct.Memory* [ %MEMORY.1, %block_.L_40805d ], [ %call2_40807b, %block_40806e ]
  %212 = add i64 %211, -44
  %213 = add i64 %210, 3
  ...
  br i1 %246, label %block_40806e, label %block_.L_408098
...
block_40806e:                                     ; preds = %block_.L_408062
  ...
  %call2_40807b = tail call %struct.Memory* @sub_401480._Z18complete_hash_funcIdET_S0_(%struct.State* %0, i64 %260, %struct.Memory* %MEMORY.2)
...
block_.L_408098:                                  ; preds = %block_.L_408062
  ...
  %call2_40809d = tail call %struct.Memory* @sub_4014b0._Z9check_sumIdEvT_(%struct.State* %0, i64 %310, %struct.Memory* %MEMORY.2)
...
block_.L_4080b0:                                  ; preds = %block_.L_40800f
  ...
  %call2_4080b0 = tail call %struct.Memory* @sub_400df0._Z5timerv(%struct.State* %0, i64 %347, %struct.Memory* %MEMORY.0)
  ...
  %call2_4080b9 = tail call %struct.Memory* @sub_400790._Z13record_resultdPKc(%struct.State* %0, i64 %358, %struct.Memory* %call2_4080b0)
  ...
  ret %struct.Memory* %call2_4080b9
}
...
define %struct.Memory* @routine_jge_.L_4080b0(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i8* %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
...
define %struct.Memory* @routine_jge_.L_40805d(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i8* %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 2, i32 9
...
define %struct.Memory* @routine_jmpq_.L_40802e(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
...
define %struct.Memory* @routine_jmpq_.L_408062(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
...
define %struct.Memory* @routine_jge_.L_408098(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i8* %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 2, i32 9
...
define %struct.Memory* @routine_jmpq_.L_40800f(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
