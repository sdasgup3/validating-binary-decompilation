...
entry:
  ...
  %call2_408043 = tail call %struct.Memory* @sub_400e10._Z11start_timerv(%struct.State* %0, i64 %58, %struct.Memory* %2)
...
block_.L_40804f:                                  ; preds = %block_.L_4080d8, %entry
  %74 = phi i64 [ %341, %block_.L_4080d8 ], [ %.pre, %entry ]
  ...
  br i1 %107, label %block_40805f, label %block_.L_4080f0
...
block_.L_40806e:                                  ; preds = %block_40807f, %block_40805f
  %118 = phi i64 [ %202, %block_40807f ], [ %.pre9, %block_40805f ]
  ...
  br i1 %156, label %block_40807f, label %block_.L_40809d
...
block_40807f:                                     ; preds = %block_.L_40806e
  ...
  %call2_40808a = tail call %struct.Memory* @sub_401990._ZN15loop_inner_bodyILi22EdE7do_workERdPKdi(%struct.State* nonnull %0, i64 %166, %struct.Memory* %call2_408043)
...
block_.L_4080a2:                                  ; preds = %block_4080ae, %block_.L_40809d
  %204 = phi i64 [ %119, %block_.L_40809d ], [ %.pre10, %block_4080ae ]
  %storemerge = phi i64 [ %203, %block_.L_40809d ], [ %299, %block_4080ae ]
  %205 = add i64 %204, -44
  ...
  br i1 %239, label %block_4080ae, label %block_.L_4080d8
...
block_4080ae:                                     ; preds = %block_.L_4080a2
  ...
  %call2_4080bb = tail call %struct.Memory* @sub_4014c0._Z18complete_hash_funcIdET_S0_(%struct.State* nonnull %0, i64 %253, %struct.Memory* %call2_408043)
...
block_.L_4080d8:                                  ; preds = %block_.L_4080a2
  ...
  %call2_4080dd = tail call %struct.Memory* @sub_4014f0._Z9check_sumIdEvT_(%struct.State* nonnull %0, i64 %305, %struct.Memory* %call2_408043)
...
block_.L_4080f0:                                  ; preds = %block_.L_40804f
  ...
  %call2_4080f0 = tail call %struct.Memory* @sub_400e30._Z5timerv(%struct.State* nonnull %0, i64 %342, %struct.Memory* %call2_408043)
  ...
  %call2_4080f9 = tail call %struct.Memory* @sub_4007d0._Z13record_resultdPKc(%struct.State* nonnull %0, i64 %353, %struct.Memory* %call2_4080f0)
