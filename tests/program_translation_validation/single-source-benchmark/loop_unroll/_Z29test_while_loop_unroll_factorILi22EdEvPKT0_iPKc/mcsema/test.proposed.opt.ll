...
define %struct.Memory* @_Z29test_while_loop_unroll_factorILi22EdEvPKT0_iPKc(%struct.State* noalias, i64, %struct.Memory* noalias readnone) local_unnamed_addr #1 {
entry:
...
block_.L_40803f:                                  ; preds = %block_.L_4080c8, %entry
  %74 = phi i64 [ %341, %block_.L_4080c8 ], [ %.pre, %entry ]
...
block_.L_40805e:                                  ; preds = %block_40806f, %block_40804f
  %118 = phi i64 [ %202, %block_40806f ], [ %.pre9, %block_40804f ]
...
block_40806f:                                     ; preds = %block_.L_40805e
  ...
  %call2_40807a = tail call %struct.Memory* @sub_401980._ZN15loop_inner_bodyILi22EdE7do_workERdPKdi(%struct.State* nonnull %0, i64 %166, %struct.Memory* %call2_408033)
...
block_40809e:                                     ; preds = %block_.L_408092
  ...
  %call2_4080ab = tail call %struct.Memory* @sub_4014b0._Z18complete_hash_funcIdET_S0_(%struct.State* nonnull %0, i64 %253, %struct.Memory* %call2_408033)
...
block_.L_4080c8:                                  ; preds = %block_.L_408092
  ...
  %call2_4080cd = tail call %struct.Memory* @sub_4014e0._Z9check_sumIdEvT_(%struct.State* nonnull %0, i64 %305, %struct.Memory* %call2_408033)
...
block_.L_4080e0:                                  ; preds = %block_.L_40803f
  ...
  %call2_4080e0 = tail call %struct.Memory* @sub_400e20._Z5timerv(%struct.State* nonnull %0, i64 %342, %struct.Memory* %call2_408033)
