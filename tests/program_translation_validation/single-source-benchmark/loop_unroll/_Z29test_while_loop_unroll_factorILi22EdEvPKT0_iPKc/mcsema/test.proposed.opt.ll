...
block_.L_40800f:                                  ; preds = %block_.L_408098, %entry
  %79 = phi i64 [ %.pre, %entry ], [ %350, %block_.L_408098 ]
...
block_.L_408062:                                  ; preds = %block_40806e, %block_.L_40805d
  %210 = phi i64 [ %209, %block_.L_40805d ], [ %307, %block_40806e ]
...
block_40806e:                                     ; preds = %block_.L_408062
  ...
  %call2_40807b = tail call %struct.Memory* @sub_401480._Z18complete_hash_funcIdET_S0_(%struct.State* %0, i64 %261, %struct.Memory* %MEMORY.2)
...
block_.L_408098:                                  ; preds = %block_.L_408062
  ...
  %call2_40809d = tail call %struct.Memory* @sub_4014b0._Z9check_sumIdEvT_(%struct.State* %0, i64 %313, %struct.Memory* %MEMORY.2)
...
block_.L_4080b0:                                  ; preds = %block_.L_40800f
  ...
  %call2_4080b0 = tail call %struct.Memory* @sub_400df0._Z5timerv(%struct.State* %0, i64 %351, %struct.Memory* %MEMORY.0)
  ...
  %call2_4080b9 = tail call %struct.Memory* @sub_400790._Z13record_resultdPKc(%struct.State* %0, i64 %362, %struct.Memory* %call2_4080b0)
