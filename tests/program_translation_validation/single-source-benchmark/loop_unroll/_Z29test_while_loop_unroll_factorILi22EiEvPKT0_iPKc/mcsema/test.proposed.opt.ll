...
entry:
  ...
  %call2_412963 = tail call %struct.Memory* @sub_400e10._Z11start_timerv(%struct.State* %0, i64 %58, %struct.Memory* %2)
...
block_.L_41296f:                                  ; preds = %block_.L_4129f1, %entry
  %68 = phi i64 [ %362, %block_.L_4129f1 ], [ %.pre, %entry ]
  ...
  br i1 %101, label %block_41297f, label %block_.L_412a07
...
block_.L_41298d:                                  ; preds = %block_41299e, %block_41297f
  %111 = phi i64 [ %195, %block_41299e ], [ %.pre9, %block_41297f ]
  ...
  br i1 %149, label %block_41299e, label %block_.L_4129bc
...
block_41299e:                                     ; preds = %block_.L_41298d
  ...
  %call2_4129a9 = tail call %struct.Memory* @sub_40c550._ZN15loop_inner_bodyILi22EiE7do_workERiPKii(%struct.State* nonnull %0, i64 %159, %struct.Memory* %call2_412963)
...
block_.L_4129c1:                                  ; preds = %block_4129cd, %block_.L_4129bc
  %197 = phi i64 [ %112, %block_.L_4129bc ], [ %.pre10, %block_4129cd ]
  %storemerge = phi i64 [ %196, %block_.L_4129bc ], [ %319, %block_4129cd ]
  %198 = add i64 %197, -36
  ...
  br i1 %232, label %block_4129cd, label %block_.L_4129f1
...
block_4129cd:                                     ; preds = %block_.L_4129c1
  ...
  %call2_4129d8 = tail call %struct.Memory* @sub_40c110._Z18complete_hash_funcIiET_S0_(%struct.State* nonnull %0, i64 %247, %struct.Memory* %call2_412963)
...
block_.L_4129f1:                                  ; preds = %block_.L_4129c1
  ...
  %call2_4129f4 = tail call %struct.Memory* @sub_40c140._Z9check_sumIiEvT_(%struct.State* nonnull %0, i64 %326, %struct.Memory* %call2_412963)
...
block_.L_412a07:                                  ; preds = %block_.L_41296f
  ...
  %call2_412a07 = tail call %struct.Memory* @sub_400e30._Z5timerv(%struct.State* nonnull %0, i64 %363, %struct.Memory* %call2_412963)
  ...
  %call2_412a10 = tail call %struct.Memory* @sub_4007d0._Z13record_resultdPKc(%struct.State* nonnull %0, i64 %374, %struct.Memory* %call2_412a07)
