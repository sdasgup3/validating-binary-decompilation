...
define %struct.Memory* @_Z29test_while_loop_unroll_factorILi22EiEvPKT0_iPKc(%struct.State* noalias, i64, %struct.Memory* noalias readnone) local_unnamed_addr #1 {
entry:
...
block_.L_41295f:                                  ; preds = %block_.L_4129e1, %entry
  %68 = phi i64 [ %362, %block_.L_4129e1 ], [ %.pre, %entry ]
...
block_.L_41297d:                                  ; preds = %block_41298e, %block_41296f
  %111 = phi i64 [ %195, %block_41298e ], [ %.pre9, %block_41296f ]
...
block_41298e:                                     ; preds = %block_.L_41297d
  ...
  %call2_412999 = tail call %struct.Memory* @sub_40c540._ZN15loop_inner_bodyILi22EiE7do_workERiPKii(%struct.State* nonnull %0, i64 %159, %struct.Memory* %call2_412953)
...
block_4129bd:                                     ; preds = %block_.L_4129b1
  ...
  %call2_4129c8 = tail call %struct.Memory* @sub_40c100._Z18complete_hash_funcIiET_S0_(%struct.State* nonnull %0, i64 %247, %struct.Memory* %call2_412953)
...
block_.L_4129e1:                                  ; preds = %block_.L_4129b1
  ...
  %call2_4129e4 = tail call %struct.Memory* @sub_40c130._Z9check_sumIiEvT_(%struct.State* nonnull %0, i64 %326, %struct.Memory* %call2_412953)
...
block_.L_4129f7:                                  ; preds = %block_.L_41295f
  ...
  %call2_4129f7 = tail call %struct.Memory* @sub_400e20._Z5timerv(%struct.State* nonnull %0, i64 %363, %struct.Memory* %call2_412953)
