...
entry:
  ...
  %call2_412923 = tail call %struct.Memory* @sub_400dd0._Z11start_timerv(%struct.State* %0, i64 %58, %struct.Memory* %2)
...
block_.L_41292f:                                  ; preds = %block_.L_4129b1, %entry
  %68 = phi i64 [ %.pre, %entry ], [ %364, %block_.L_4129b1 ]
  %MEMORY.0 = phi %struct.Memory* [ %call2_412923, %entry ], [ %call2_4129b4, %block_.L_4129b1 ]
  ...
  br i1 %101, label %block_41293f, label %block_.L_4129c7
...
block_.L_41294d:                                  ; preds = %block_41295e, %block_41293f
  %111 = phi i64 [ %.pre1, %block_41293f ], [ %195, %block_41295e ]
  %MEMORY.1 = phi %struct.Memory* [ %MEMORY.0, %block_41293f ], [ %call2_412969, %block_41295e ]
  ...
  br i1 %149, label %block_41295e, label %block_.L_41297c
...
block_41295e:                                     ; preds = %block_.L_41294d
  ...
  %call2_412969 = tail call %struct.Memory* @sub_40c510._ZN15loop_inner_bodyILi22EiE7do_workERiPKii(%struct.State* %0, i64 %159, %struct.Memory* %MEMORY.1)
...
block_.L_412981:                                  ; preds = %block_41298d, %block_.L_41297c
  %197 = phi i64 [ %196, %block_.L_41297c ], [ %321, %block_41298d ]
  %198 = phi i64 [ %112, %block_.L_41297c ], [ %.pre2, %block_41298d ]
  %MEMORY.2 = phi %struct.Memory* [ %MEMORY.1, %block_.L_41297c ], [ %call2_412998, %block_41298d ]
  %199 = add i64 %198, -36
  %200 = add i64 %197, 3
  ...
  br i1 %233, label %block_41298d, label %block_.L_4129b1
...
block_41298d:                                     ; preds = %block_.L_412981
  ...
  %call2_412998 = tail call %struct.Memory* @sub_40c0d0._Z18complete_hash_funcIiET_S0_(%struct.State* %0, i64 %248, %struct.Memory* %MEMORY.2)
...
block_.L_4129b1:                                  ; preds = %block_.L_412981
  ...
  %call2_4129b4 = tail call %struct.Memory* @sub_40c100._Z9check_sumIiEvT_(%struct.State* %0, i64 %327, %struct.Memory* %MEMORY.2)
...
block_.L_4129c7:                                  ; preds = %block_.L_41292f
  ...
  %call2_4129c7 = tail call %struct.Memory* @sub_400df0._Z5timerv(%struct.State* %0, i64 %365, %struct.Memory* %MEMORY.0)
  ...
  %call2_4129d0 = tail call %struct.Memory* @sub_400790._Z13record_resultdPKc(%struct.State* %0, i64 %376, %struct.Memory* %call2_4129c7)
  ...
  ret %struct.Memory* %call2_4129d0
}
...
define %struct.Memory* @routine_jge_.L_4129c7(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i8* %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
...
define %struct.Memory* @routine_jge_.L_41297c(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i8* %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 2, i32 9
...
define %struct.Memory* @routine_jmpq_.L_41294d(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
...
define %struct.Memory* @routine_jmpq_.L_412981(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
...
define %struct.Memory* @routine_jge_.L_4129b1(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i8* %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 2, i32 9
...
define %struct.Memory* @routine_jmpq_.L_41292f(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
