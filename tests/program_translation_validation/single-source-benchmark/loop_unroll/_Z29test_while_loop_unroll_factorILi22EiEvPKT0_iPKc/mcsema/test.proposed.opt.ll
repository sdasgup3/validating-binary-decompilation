...
block_.L_41292f:                                  ; preds = %block_.L_4129b1, %entry
  %68 = phi i64 [ %.pre, %entry ], [ %362, %block_.L_4129b1 ]
...
block_.L_412981:                                  ; preds = %block_41298d, %block_.L_41297c
  %197 = phi i64 [ %196, %block_.L_41297c ], [ %320, %block_41298d ]
...
block_.L_4129b1:                                  ; preds = %block_.L_412981
  ...
  %call2_4129b4 = tail call %struct.Memory* @sub_40c100._Z9check_sumIiEvT_(%struct.State* %0, i64 %326, %struct.Memory* %MEMORY.2)
...
block_.L_4129c7:                                  ; preds = %block_.L_41292f
  ...
  %call2_4129c7 = tail call %struct.Memory* @sub_400df0._Z5timerv(%struct.State* %0, i64 %363, %struct.Memory* %MEMORY.0)
  ...
  %call2_4129d0 = tail call %struct.Memory* @sub_400790._Z13record_resultdPKc(%struct.State* %0, i64 %374, %struct.Memory* %call2_4129c7)
