...
entry:
  ...
  %call2_407ed3 = tail call %struct.Memory* @sub_400dd0._Z11start_timerv(%struct.State* %0, i64 %58, %struct.Memory* %2)
...
block_.L_407edf:                                  ; preds = %block_.L_407f68, %entry
  %79 = phi i64 [ %.pre, %entry ], [ %346, %block_.L_407f68 ]
  %MEMORY.0 = phi %struct.Memory* [ %call2_407ed3, %entry ], [ %call2_407f6d, %block_.L_407f68 ]
  ...
  br i1 %112, label %block_407eef, label %block_.L_407f80
...
block_.L_407efe:                                  ; preds = %block_407f0f, %block_407eef
  %124 = phi i64 [ %.pre1, %block_407eef ], [ %208, %block_407f0f ]
  %MEMORY.1 = phi %struct.Memory* [ %MEMORY.0, %block_407eef ], [ %call2_407f1a, %block_407f0f ]
  ...
  br i1 %162, label %block_407f0f, label %block_.L_407f2d
...
block_407f0f:                                     ; preds = %block_.L_407efe
  ...
  %call2_407f1a = tail call %struct.Memory* @sub_4018f0._ZN15loop_inner_bodyILi23EdE7do_workERdPKdi(%struct.State* %0, i64 %172, %struct.Memory* %MEMORY.1)
...
block_.L_407f32:                                  ; preds = %block_407f3e, %block_.L_407f2d
  %210 = phi i64 [ %209, %block_.L_407f2d ], [ %305, %block_407f3e ]
  %211 = phi i64 [ %125, %block_.L_407f2d ], [ %.pre2, %block_407f3e ]
  %MEMORY.2 = phi %struct.Memory* [ %MEMORY.1, %block_.L_407f2d ], [ %call2_407f4b, %block_407f3e ]
  %212 = add i64 %211, -44
  %213 = add i64 %210, 3
  ...
  br i1 %246, label %block_407f3e, label %block_.L_407f68
...
block_407f3e:                                     ; preds = %block_.L_407f32
  ...
  %call2_407f4b = tail call %struct.Memory* @sub_401480._Z18complete_hash_funcIdET_S0_(%struct.State* %0, i64 %260, %struct.Memory* %MEMORY.2)
...
block_.L_407f68:                                  ; preds = %block_.L_407f32
  ...
  %call2_407f6d = tail call %struct.Memory* @sub_4014b0._Z9check_sumIdEvT_(%struct.State* %0, i64 %310, %struct.Memory* %MEMORY.2)
...
block_.L_407f80:                                  ; preds = %block_.L_407edf
  ...
  %call2_407f80 = tail call %struct.Memory* @sub_400df0._Z5timerv(%struct.State* %0, i64 %347, %struct.Memory* %MEMORY.0)
  ...
  %call2_407f89 = tail call %struct.Memory* @sub_400790._Z13record_resultdPKc(%struct.State* %0, i64 %358, %struct.Memory* %call2_407f80)
  ...
  ret %struct.Memory* %call2_407f89
}
...
define %struct.Memory* @routine_jge_.L_407f80(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i8* %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
...
define %struct.Memory* @routine_jge_.L_407f2d(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i8* %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 2, i32 9
...
define %struct.Memory* @routine_jmpq_.L_407efe(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
...
define %struct.Memory* @routine_jmpq_.L_407f32(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
...
define %struct.Memory* @routine_jge_.L_407f68(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i8* %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 2, i32 9
