...
entry:
  ...
  %call2_407f13 = tail call %struct.Memory* @sub_400e10._Z11start_timerv(%struct.State* %0, i64 %58, %struct.Memory* %2)
...
block_.L_407f1f:                                  ; preds = %block_.L_407fa8, %entry
  %74 = phi i64 [ %341, %block_.L_407fa8 ], [ %.pre, %entry ]
  ...
  br i1 %107, label %block_407f2f, label %block_.L_407fc0
...
block_.L_407f3e:                                  ; preds = %block_407f4f, %block_407f2f
  %118 = phi i64 [ %202, %block_407f4f ], [ %.pre9, %block_407f2f ]
  ...
  br i1 %156, label %block_407f4f, label %block_.L_407f6d
...
block_407f4f:                                     ; preds = %block_.L_407f3e
  ...
  %call2_407f5a = tail call %struct.Memory* @sub_401930._ZN15loop_inner_bodyILi23EdE7do_workERdPKdi(%struct.State* nonnull %0, i64 %166, %struct.Memory* %call2_407f13)
...
block_.L_407f72:                                  ; preds = %block_407f7e, %block_.L_407f6d
  %204 = phi i64 [ %119, %block_.L_407f6d ], [ %.pre10, %block_407f7e ]
  %storemerge = phi i64 [ %203, %block_.L_407f6d ], [ %299, %block_407f7e ]
  %205 = add i64 %204, -44
  ...
  br i1 %239, label %block_407f7e, label %block_.L_407fa8
...
block_407f7e:                                     ; preds = %block_.L_407f72
  ...
  %call2_407f8b = tail call %struct.Memory* @sub_4014c0._Z18complete_hash_funcIdET_S0_(%struct.State* nonnull %0, i64 %253, %struct.Memory* %call2_407f13)
...
block_.L_407fa8:                                  ; preds = %block_.L_407f72
  ...
  %call2_407fad = tail call %struct.Memory* @sub_4014f0._Z9check_sumIdEvT_(%struct.State* nonnull %0, i64 %305, %struct.Memory* %call2_407f13)
...
block_.L_407fc0:                                  ; preds = %block_.L_407f1f
  ...
  %call2_407fc0 = tail call %struct.Memory* @sub_400e30._Z5timerv(%struct.State* nonnull %0, i64 %342, %struct.Memory* %call2_407f13)
  ...
  %call2_407fc9 = tail call %struct.Memory* @sub_4007d0._Z13record_resultdPKc(%struct.State* nonnull %0, i64 %353, %struct.Memory* %call2_407fc0)
