...
define %struct.Memory* @_Z29test_while_loop_unroll_factorILi23EdEvPKT0_iPKc(%struct.State* noalias, i64, %struct.Memory* noalias readnone) local_unnamed_addr #1 {
entry:
...
block_.L_407f0f:                                  ; preds = %block_.L_407f98, %entry
  %74 = phi i64 [ %341, %block_.L_407f98 ], [ %.pre, %entry ]
...
block_.L_407f2e:                                  ; preds = %block_407f3f, %block_407f1f
  %118 = phi i64 [ %202, %block_407f3f ], [ %.pre9, %block_407f1f ]
...
block_407f3f:                                     ; preds = %block_.L_407f2e
  ...
  %call2_407f4a = tail call %struct.Memory* @sub_401920._ZN15loop_inner_bodyILi23EdE7do_workERdPKdi(%struct.State* nonnull %0, i64 %166, %struct.Memory* %call2_407f03)
...
block_407f6e:                                     ; preds = %block_.L_407f62
  ...
  %call2_407f7b = tail call %struct.Memory* @sub_4014b0._Z18complete_hash_funcIdET_S0_(%struct.State* nonnull %0, i64 %253, %struct.Memory* %call2_407f03)
...
block_.L_407f98:                                  ; preds = %block_.L_407f62
  ...
  %call2_407f9d = tail call %struct.Memory* @sub_4014e0._Z9check_sumIdEvT_(%struct.State* nonnull %0, i64 %305, %struct.Memory* %call2_407f03)
...
block_.L_407fb0:                                  ; preds = %block_.L_407f0f
  ...
  %call2_407fb0 = tail call %struct.Memory* @sub_400e20._Z5timerv(%struct.State* nonnull %0, i64 %342, %struct.Memory* %call2_407f03)
