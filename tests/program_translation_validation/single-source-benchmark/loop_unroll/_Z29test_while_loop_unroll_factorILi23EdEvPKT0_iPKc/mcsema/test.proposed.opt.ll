...
block_.L_407edf:                                  ; preds = %block_.L_407f68, %entry
  %79 = phi i64 [ %.pre, %entry ], [ %350, %block_.L_407f68 ]
...
block_.L_407f32:                                  ; preds = %block_407f3e, %block_.L_407f2d
  %210 = phi i64 [ %209, %block_.L_407f2d ], [ %307, %block_407f3e ]
...
block_407f3e:                                     ; preds = %block_.L_407f32
  ...
  %call2_407f4b = tail call %struct.Memory* @sub_401480._Z18complete_hash_funcIdET_S0_(%struct.State* %0, i64 %261, %struct.Memory* %MEMORY.2)
...
block_.L_407f68:                                  ; preds = %block_.L_407f32
  ...
  %call2_407f6d = tail call %struct.Memory* @sub_4014b0._Z9check_sumIdEvT_(%struct.State* %0, i64 %313, %struct.Memory* %MEMORY.2)
...
block_.L_407f80:                                  ; preds = %block_.L_407edf
  ...
  %call2_407f80 = tail call %struct.Memory* @sub_400df0._Z5timerv(%struct.State* %0, i64 %351, %struct.Memory* %MEMORY.0)
  ...
  %call2_407f89 = tail call %struct.Memory* @sub_400790._Z13record_resultdPKc(%struct.State* %0, i64 %362, %struct.Memory* %call2_407f80)
