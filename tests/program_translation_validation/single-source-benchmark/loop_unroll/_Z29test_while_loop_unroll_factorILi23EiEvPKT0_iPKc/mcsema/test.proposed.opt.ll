...
block_.L_41280f:                                  ; preds = %block_.L_412891, %entry
  %68 = phi i64 [ %.pre, %entry ], [ %362, %block_.L_412891 ]
...
block_.L_412861:                                  ; preds = %block_41286d, %block_.L_41285c
  %197 = phi i64 [ %196, %block_.L_41285c ], [ %320, %block_41286d ]
...
block_.L_412891:                                  ; preds = %block_.L_412861
  ...
  %call2_412894 = tail call %struct.Memory* @sub_40c100._Z9check_sumIiEvT_(%struct.State* %0, i64 %326, %struct.Memory* %MEMORY.2)
...
block_.L_4128a7:                                  ; preds = %block_.L_41280f
  ...
  %call2_4128a7 = tail call %struct.Memory* @sub_400df0._Z5timerv(%struct.State* %0, i64 %363, %struct.Memory* %MEMORY.0)
  ...
  %call2_4128b0 = tail call %struct.Memory* @sub_400790._Z13record_resultdPKc(%struct.State* %0, i64 %374, %struct.Memory* %call2_4128a7)
