...
block_.L_41283f:                                  ; preds = %block_.L_4128c1, %entry
  %68 = phi i64 [ %362, %block_.L_4128c1 ], [ %.pre, %entry ]
...
block_.L_41285d:                                  ; preds = %block_41286e, %block_41284f
  %111 = phi i64 [ %195, %block_41286e ], [ %.pre9, %block_41284f ]
...
block_41286e:                                     ; preds = %block_.L_41285d
  ...
  %call2_412879 = tail call %struct.Memory* @sub_40c4e0._ZN15loop_inner_bodyILi23EiE7do_workERiPKii(%struct.State* nonnull %0, i64 %159, %struct.Memory* %call2_412833)
...
block_41289d:                                     ; preds = %block_.L_412891
  ...
  %call2_4128a8 = tail call %struct.Memory* @sub_40c100._Z18complete_hash_funcIiET_S0_(%struct.State* nonnull %0, i64 %247, %struct.Memory* %call2_412833)
...
block_.L_4128c1:                                  ; preds = %block_.L_412891
  ...
  %call2_4128c4 = tail call %struct.Memory* @sub_40c130._Z9check_sumIiEvT_(%struct.State* nonnull %0, i64 %326, %struct.Memory* %call2_412833)
...
block_.L_4128d7:                                  ; preds = %block_.L_41283f
  ...
  %call2_4128d7 = tail call %struct.Memory* @sub_400e20._Z5timerv(%struct.State* nonnull %0, i64 %363, %struct.Memory* %call2_412833)
