...
entry:
  ...
  %call2_412803 = tail call %struct.Memory* @sub_400dd0._Z11start_timerv(%struct.State* %0, i64 %58, %struct.Memory* %2)
...
block_.L_41280f:                                  ; preds = %block_.L_412891, %entry
  %68 = phi i64 [ %.pre, %entry ], [ %364, %block_.L_412891 ]
  %MEMORY.0 = phi %struct.Memory* [ %call2_412803, %entry ], [ %call2_412894, %block_.L_412891 ]
  ...
  br i1 %101, label %block_41281f, label %block_.L_4128a7
...
block_.L_41282d:                                  ; preds = %block_41283e, %block_41281f
  %111 = phi i64 [ %.pre1, %block_41281f ], [ %195, %block_41283e ]
  %MEMORY.1 = phi %struct.Memory* [ %MEMORY.0, %block_41281f ], [ %call2_412849, %block_41283e ]
  ...
  br i1 %149, label %block_41283e, label %block_.L_41285c
...
block_41283e:                                     ; preds = %block_.L_41282d
  ...
  %call2_412849 = tail call %struct.Memory* @sub_40c4b0._ZN15loop_inner_bodyILi23EiE7do_workERiPKii(%struct.State* %0, i64 %159, %struct.Memory* %MEMORY.1)
...
block_.L_412861:                                  ; preds = %block_41286d, %block_.L_41285c
  %197 = phi i64 [ %196, %block_.L_41285c ], [ %321, %block_41286d ]
  %198 = phi i64 [ %112, %block_.L_41285c ], [ %.pre2, %block_41286d ]
  %MEMORY.2 = phi %struct.Memory* [ %MEMORY.1, %block_.L_41285c ], [ %call2_412878, %block_41286d ]
  %199 = add i64 %198, -36
  %200 = add i64 %197, 3
  ...
  br i1 %233, label %block_41286d, label %block_.L_412891
...
block_41286d:                                     ; preds = %block_.L_412861
  ...
  %call2_412878 = tail call %struct.Memory* @sub_40c0d0._Z18complete_hash_funcIiET_S0_(%struct.State* %0, i64 %248, %struct.Memory* %MEMORY.2)
...
block_.L_412891:                                  ; preds = %block_.L_412861
  ...
  %call2_412894 = tail call %struct.Memory* @sub_40c100._Z9check_sumIiEvT_(%struct.State* %0, i64 %327, %struct.Memory* %MEMORY.2)
...
block_.L_4128a7:                                  ; preds = %block_.L_41280f
  ...
  %call2_4128a7 = tail call %struct.Memory* @sub_400df0._Z5timerv(%struct.State* %0, i64 %365, %struct.Memory* %MEMORY.0)
  ...
  %call2_4128b0 = tail call %struct.Memory* @sub_400790._Z13record_resultdPKc(%struct.State* %0, i64 %376, %struct.Memory* %call2_4128a7)
  ...
  ret %struct.Memory* %call2_4128b0
}
...
define %struct.Memory* @routine_jge_.L_4128a7(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i8* %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
...
define %struct.Memory* @routine_jge_.L_41285c(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i8* %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 2, i32 9
...
define %struct.Memory* @routine_jmpq_.L_41282d(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
...
define %struct.Memory* @routine_jmpq_.L_412861(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
...
define %struct.Memory* @routine_jge_.L_412891(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i8* %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 2, i32 9
...
define %struct.Memory* @routine_jmpq_.L_41280f(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
