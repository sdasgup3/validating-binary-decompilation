...
block_.L_407daf:                                  ; preds = %block_.L_407e38, %entry
  %79 = phi i64 [ %.pre, %entry ], [ %346, %block_.L_407e38 ]
...
block_.L_407e02:                                  ; preds = %block_407e0e, %block_.L_407dfd
  %210 = phi i64 [ %209, %block_.L_407dfd ], [ %305, %block_407e0e ]
...
block_407e0e:                                     ; preds = %block_.L_407e02
  ...
  %call2_407e1b = tail call %struct.Memory* @sub_401480._Z18complete_hash_funcIdET_S0_(%struct.State* %0, i64 %260, %struct.Memory* %MEMORY.2)
...
block_.L_407e38:                                  ; preds = %block_.L_407e02
  ...
  %call2_407e3d = tail call %struct.Memory* @sub_4014b0._Z9check_sumIdEvT_(%struct.State* %0, i64 %310, %struct.Memory* %MEMORY.2)
...
block_.L_407e50:                                  ; preds = %block_.L_407daf
  ...
  %call2_407e50 = tail call %struct.Memory* @sub_400df0._Z5timerv(%struct.State* %0, i64 %347, %struct.Memory* %MEMORY.0)
  ...
  %call2_407e59 = tail call %struct.Memory* @sub_400790._Z13record_resultdPKc(%struct.State* %0, i64 %358, %struct.Memory* %call2_407e50)
