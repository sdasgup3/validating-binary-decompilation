...
entry:
  ...
  %call2_407da3 = tail call %struct.Memory* @sub_400dd0._Z11start_timerv(%struct.State* %0, i64 %58, %struct.Memory* %2)
...
block_.L_407daf:                                  ; preds = %block_.L_407e38, %entry
  %79 = phi i64 [ %.pre, %entry ], [ %350, %block_.L_407e38 ]
  %MEMORY.0 = phi %struct.Memory* [ %call2_407da3, %entry ], [ %call2_407e3d, %block_.L_407e38 ]
  ...
  br i1 %112, label %block_407dbf, label %block_.L_407e50
...
block_.L_407dce:                                  ; preds = %block_407ddf, %block_407dbf
  %124 = phi i64 [ %.pre1, %block_407dbf ], [ %208, %block_407ddf ]
  %MEMORY.1 = phi %struct.Memory* [ %MEMORY.0, %block_407dbf ], [ %call2_407dea, %block_407ddf ]
  ...
  br i1 %162, label %block_407ddf, label %block_.L_407dfd
...
block_407ddf:                                     ; preds = %block_.L_407dce
  ...
  %call2_407dea = tail call %struct.Memory* @sub_401890._ZN15loop_inner_bodyILi24EdE7do_workERdPKdi(%struct.State* %0, i64 %172, %struct.Memory* %MEMORY.1)
...
block_.L_407e02:                                  ; preds = %block_407e0e, %block_.L_407dfd
  %210 = phi i64 [ %209, %block_.L_407dfd ], [ %307, %block_407e0e ]
  %211 = phi i64 [ %125, %block_.L_407dfd ], [ %.pre2, %block_407e0e ]
  %MEMORY.2 = phi %struct.Memory* [ %MEMORY.1, %block_.L_407dfd ], [ %call2_407e1b, %block_407e0e ]
  %212 = add i64 %211, -44
  %213 = add i64 %210, 3
  ...
  br i1 %246, label %block_407e0e, label %block_.L_407e38
...
block_407e0e:                                     ; preds = %block_.L_407e02
  ...
  %call2_407e1b = tail call %struct.Memory* @sub_401480._Z18complete_hash_funcIdET_S0_(%struct.State* %0, i64 %261, %struct.Memory* %MEMORY.2)
...
block_.L_407e38:                                  ; preds = %block_.L_407e02
  ...
  %call2_407e3d = tail call %struct.Memory* @sub_4014b0._Z9check_sumIdEvT_(%struct.State* %0, i64 %313, %struct.Memory* %MEMORY.2)
...
block_.L_407e50:                                  ; preds = %block_.L_407daf
  ...
  %call2_407e50 = tail call %struct.Memory* @sub_400df0._Z5timerv(%struct.State* %0, i64 %351, %struct.Memory* %MEMORY.0)
  ...
  %call2_407e59 = tail call %struct.Memory* @sub_400790._Z13record_resultdPKc(%struct.State* %0, i64 %362, %struct.Memory* %call2_407e50)
  ...
  ret %struct.Memory* %call2_407e59
}
...
define %struct.Memory* @routine_jge_.L_407e50(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i8* %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
...
define %struct.Memory* @routine_jge_.L_407dfd(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i8* %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 2, i32 9
...
define %struct.Memory* @routine_jmpq_.L_407dce(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
...
define %struct.Memory* @routine_jmpq_.L_407e02(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
...
define %struct.Memory* @routine_jge_.L_407e38(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i8* %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 2, i32 9
...
define %struct.Memory* @routine_jmpq_.L_407daf(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
