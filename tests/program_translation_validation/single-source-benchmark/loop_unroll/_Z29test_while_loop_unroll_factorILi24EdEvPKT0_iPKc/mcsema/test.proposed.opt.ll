...
entry:
  ...
  %call2_407de3 = tail call %struct.Memory* @sub_400e10._Z11start_timerv(%struct.State* %0, i64 %58, %struct.Memory* %2)
...
block_.L_407def:                                  ; preds = %block_.L_407e78, %entry
  %74 = phi i64 [ %341, %block_.L_407e78 ], [ %.pre, %entry ]
  ...
  br i1 %107, label %block_407dff, label %block_.L_407e90
...
block_.L_407e0e:                                  ; preds = %block_407e1f, %block_407dff
  %118 = phi i64 [ %202, %block_407e1f ], [ %.pre9, %block_407dff ]
  ...
  br i1 %156, label %block_407e1f, label %block_.L_407e3d
...
block_407e1f:                                     ; preds = %block_.L_407e0e
  ...
  %call2_407e2a = tail call %struct.Memory* @sub_4018d0._ZN15loop_inner_bodyILi24EdE7do_workERdPKdi(%struct.State* nonnull %0, i64 %166, %struct.Memory* %call2_407de3)
...
block_.L_407e42:                                  ; preds = %block_407e4e, %block_.L_407e3d
  %204 = phi i64 [ %119, %block_.L_407e3d ], [ %.pre10, %block_407e4e ]
  %storemerge = phi i64 [ %203, %block_.L_407e3d ], [ %299, %block_407e4e ]
  %205 = add i64 %204, -44
  ...
  br i1 %239, label %block_407e4e, label %block_.L_407e78
...
block_407e4e:                                     ; preds = %block_.L_407e42
  ...
  %call2_407e5b = tail call %struct.Memory* @sub_4014c0._Z18complete_hash_funcIdET_S0_(%struct.State* nonnull %0, i64 %253, %struct.Memory* %call2_407de3)
...
block_.L_407e78:                                  ; preds = %block_.L_407e42
  ...
  %call2_407e7d = tail call %struct.Memory* @sub_4014f0._Z9check_sumIdEvT_(%struct.State* nonnull %0, i64 %305, %struct.Memory* %call2_407de3)
...
block_.L_407e90:                                  ; preds = %block_.L_407def
  ...
  %call2_407e90 = tail call %struct.Memory* @sub_400e30._Z5timerv(%struct.State* nonnull %0, i64 %342, %struct.Memory* %call2_407de3)
  ...
  %call2_407e99 = tail call %struct.Memory* @sub_4007d0._Z13record_resultdPKc(%struct.State* nonnull %0, i64 %353, %struct.Memory* %call2_407e90)
