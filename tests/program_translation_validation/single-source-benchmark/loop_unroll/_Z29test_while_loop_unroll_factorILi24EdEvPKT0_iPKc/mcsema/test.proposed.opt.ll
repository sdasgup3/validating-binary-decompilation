...
define %struct.Memory* @_Z29test_while_loop_unroll_factorILi24EdEvPKT0_iPKc(%struct.State* noalias, i64, %struct.Memory* noalias readnone) local_unnamed_addr #1 {
entry:
...
block_.L_407ddf:                                  ; preds = %block_.L_407e68, %entry
  %74 = phi i64 [ %341, %block_.L_407e68 ], [ %.pre, %entry ]
...
block_.L_407dfe:                                  ; preds = %block_407e0f, %block_407def
  %118 = phi i64 [ %202, %block_407e0f ], [ %.pre9, %block_407def ]
...
block_407e0f:                                     ; preds = %block_.L_407dfe
  ...
  %call2_407e1a = tail call %struct.Memory* @sub_4018c0._ZN15loop_inner_bodyILi24EdE7do_workERdPKdi(%struct.State* nonnull %0, i64 %166, %struct.Memory* %call2_407dd3)
...
block_407e3e:                                     ; preds = %block_.L_407e32
  ...
  %call2_407e4b = tail call %struct.Memory* @sub_4014b0._Z18complete_hash_funcIdET_S0_(%struct.State* nonnull %0, i64 %253, %struct.Memory* %call2_407dd3)
...
block_.L_407e68:                                  ; preds = %block_.L_407e32
  ...
  %call2_407e6d = tail call %struct.Memory* @sub_4014e0._Z9check_sumIdEvT_(%struct.State* nonnull %0, i64 %305, %struct.Memory* %call2_407dd3)
...
block_.L_407e80:                                  ; preds = %block_.L_407ddf
  ...
  %call2_407e80 = tail call %struct.Memory* @sub_400e20._Z5timerv(%struct.State* nonnull %0, i64 %342, %struct.Memory* %call2_407dd3)
