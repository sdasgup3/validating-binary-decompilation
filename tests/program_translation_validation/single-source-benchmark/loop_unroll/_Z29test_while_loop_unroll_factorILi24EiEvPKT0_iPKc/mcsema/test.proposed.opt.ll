...
block_.L_41271f:                                  ; preds = %block_.L_4127a1, %entry
  %68 = phi i64 [ %362, %block_.L_4127a1 ], [ %.pre, %entry ]
...
block_.L_41273d:                                  ; preds = %block_41274e, %block_41272f
  %111 = phi i64 [ %195, %block_41274e ], [ %.pre9, %block_41272f ]
...
block_41274e:                                     ; preds = %block_.L_41273d
  ...
  %call2_412759 = tail call %struct.Memory* @sub_40c480._ZN15loop_inner_bodyILi24EiE7do_workERiPKii(%struct.State* nonnull %0, i64 %159, %struct.Memory* %call2_412713)
...
block_41277d:                                     ; preds = %block_.L_412771
  ...
  %call2_412788 = tail call %struct.Memory* @sub_40c100._Z18complete_hash_funcIiET_S0_(%struct.State* nonnull %0, i64 %247, %struct.Memory* %call2_412713)
...
block_.L_4127a1:                                  ; preds = %block_.L_412771
  ...
  %call2_4127a4 = tail call %struct.Memory* @sub_40c130._Z9check_sumIiEvT_(%struct.State* nonnull %0, i64 %326, %struct.Memory* %call2_412713)
...
block_.L_4127b7:                                  ; preds = %block_.L_41271f
  ...
  %call2_4127b7 = tail call %struct.Memory* @sub_400e20._Z5timerv(%struct.State* nonnull %0, i64 %363, %struct.Memory* %call2_412713)
