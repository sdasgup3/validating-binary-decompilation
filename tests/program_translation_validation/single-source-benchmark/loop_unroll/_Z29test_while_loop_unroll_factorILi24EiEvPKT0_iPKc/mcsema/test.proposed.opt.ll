...
block_.L_4126ef:                                  ; preds = %block_.L_412771, %entry
  %68 = phi i64 [ %.pre, %entry ], [ %364, %block_.L_412771 ]
...
block_.L_412741:                                  ; preds = %block_41274d, %block_.L_41273c
  %197 = phi i64 [ %196, %block_.L_41273c ], [ %321, %block_41274d ]
...
block_.L_412771:                                  ; preds = %block_.L_412741
  ...
  %call2_412774 = tail call %struct.Memory* @sub_40c100._Z9check_sumIiEvT_(%struct.State* %0, i64 %327, %struct.Memory* %MEMORY.2)
...
block_.L_412787:                                  ; preds = %block_.L_4126ef
  ...
  %call2_412787 = tail call %struct.Memory* @sub_400df0._Z5timerv(%struct.State* %0, i64 %365, %struct.Memory* %MEMORY.0)
  ...
  %call2_412790 = tail call %struct.Memory* @sub_400790._Z13record_resultdPKc(%struct.State* %0, i64 %376, %struct.Memory* %call2_412787)
