...
entry:
  ...
  %call2_407cb3 = tail call %struct.Memory* @sub_400e10._Z11start_timerv(%struct.State* %0, i64 %58, %struct.Memory* %2)
...
block_.L_407cbf:                                  ; preds = %block_.L_407d48, %entry
  %74 = phi i64 [ %341, %block_.L_407d48 ], [ %.pre, %entry ]
  ...
  br i1 %107, label %block_407ccf, label %block_.L_407d60
...
block_.L_407cde:                                  ; preds = %block_407cef, %block_407ccf
  %118 = phi i64 [ %202, %block_407cef ], [ %.pre9, %block_407ccf ]
  ...
  br i1 %156, label %block_407cef, label %block_.L_407d0d
...
block_407cef:                                     ; preds = %block_.L_407cde
  ...
  %call2_407cfa = tail call %struct.Memory* @sub_401870._ZN15loop_inner_bodyILi25EdE7do_workERdPKdi(%struct.State* nonnull %0, i64 %166, %struct.Memory* %call2_407cb3)
...
block_.L_407d12:                                  ; preds = %block_407d1e, %block_.L_407d0d
  %204 = phi i64 [ %119, %block_.L_407d0d ], [ %.pre10, %block_407d1e ]
  %storemerge = phi i64 [ %203, %block_.L_407d0d ], [ %299, %block_407d1e ]
  %205 = add i64 %204, -44
  ...
  br i1 %239, label %block_407d1e, label %block_.L_407d48
...
block_407d1e:                                     ; preds = %block_.L_407d12
  ...
  %call2_407d2b = tail call %struct.Memory* @sub_4014c0._Z18complete_hash_funcIdET_S0_(%struct.State* nonnull %0, i64 %253, %struct.Memory* %call2_407cb3)
...
block_.L_407d48:                                  ; preds = %block_.L_407d12
  ...
  %call2_407d4d = tail call %struct.Memory* @sub_4014f0._Z9check_sumIdEvT_(%struct.State* nonnull %0, i64 %305, %struct.Memory* %call2_407cb3)
...
block_.L_407d60:                                  ; preds = %block_.L_407cbf
  ...
  %call2_407d60 = tail call %struct.Memory* @sub_400e30._Z5timerv(%struct.State* nonnull %0, i64 %342, %struct.Memory* %call2_407cb3)
  ...
  %call2_407d69 = tail call %struct.Memory* @sub_4007d0._Z13record_resultdPKc(%struct.State* nonnull %0, i64 %353, %struct.Memory* %call2_407d60)
