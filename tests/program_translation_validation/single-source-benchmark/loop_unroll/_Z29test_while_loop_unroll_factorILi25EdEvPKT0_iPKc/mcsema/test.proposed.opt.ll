...
entry:
  ...
  %call2_407c73 = tail call %struct.Memory* @sub_400dd0._Z11start_timerv(%struct.State* %0, i64 %58, %struct.Memory* %2)
...
block_.L_407c7f:                                  ; preds = %block_.L_407d08, %entry
  %79 = phi i64 [ %.pre, %entry ], [ %346, %block_.L_407d08 ]
  %MEMORY.0 = phi %struct.Memory* [ %call2_407c73, %entry ], [ %call2_407d0d, %block_.L_407d08 ]
  ...
  br i1 %112, label %block_407c8f, label %block_.L_407d20
...
block_.L_407c9e:                                  ; preds = %block_407caf, %block_407c8f
  %124 = phi i64 [ %.pre1, %block_407c8f ], [ %208, %block_407caf ]
  %MEMORY.1 = phi %struct.Memory* [ %MEMORY.0, %block_407c8f ], [ %call2_407cba, %block_407caf ]
  ...
  br i1 %162, label %block_407caf, label %block_.L_407ccd
...
block_407caf:                                     ; preds = %block_.L_407c9e
  ...
  %call2_407cba = tail call %struct.Memory* @sub_401830._ZN15loop_inner_bodyILi25EdE7do_workERdPKdi(%struct.State* %0, i64 %172, %struct.Memory* %MEMORY.1)
...
block_.L_407cd2:                                  ; preds = %block_407cde, %block_.L_407ccd
  %210 = phi i64 [ %209, %block_.L_407ccd ], [ %305, %block_407cde ]
  %211 = phi i64 [ %125, %block_.L_407ccd ], [ %.pre2, %block_407cde ]
  %MEMORY.2 = phi %struct.Memory* [ %MEMORY.1, %block_.L_407ccd ], [ %call2_407ceb, %block_407cde ]
  %212 = add i64 %211, -44
  %213 = add i64 %210, 3
  ...
  br i1 %246, label %block_407cde, label %block_.L_407d08
...
block_407cde:                                     ; preds = %block_.L_407cd2
  ...
  %call2_407ceb = tail call %struct.Memory* @sub_401480._Z18complete_hash_funcIdET_S0_(%struct.State* %0, i64 %260, %struct.Memory* %MEMORY.2)
...
block_.L_407d08:                                  ; preds = %block_.L_407cd2
  ...
  %call2_407d0d = tail call %struct.Memory* @sub_4014b0._Z9check_sumIdEvT_(%struct.State* %0, i64 %310, %struct.Memory* %MEMORY.2)
...
block_.L_407d20:                                  ; preds = %block_.L_407c7f
  ...
  %call2_407d20 = tail call %struct.Memory* @sub_400df0._Z5timerv(%struct.State* %0, i64 %347, %struct.Memory* %MEMORY.0)
  ...
  %call2_407d29 = tail call %struct.Memory* @sub_400790._Z13record_resultdPKc(%struct.State* %0, i64 %358, %struct.Memory* %call2_407d20)
  ...
  ret %struct.Memory* %call2_407d29
}
...
define %struct.Memory* @routine_jge_.L_407d20(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i8* %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
...
define %struct.Memory* @routine_jge_.L_407ccd(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i8* %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 2, i32 9
...
define %struct.Memory* @routine_jmpq_.L_407c9e(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
...
define %struct.Memory* @routine_jmpq_.L_407cd2(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
...
define %struct.Memory* @routine_jge_.L_407d08(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i8* %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 2, i32 9
...
define %struct.Memory* @routine_jmpq_.L_407c7f(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
