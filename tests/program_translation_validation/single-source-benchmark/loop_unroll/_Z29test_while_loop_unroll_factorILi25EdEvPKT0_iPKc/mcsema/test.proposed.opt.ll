...
define %struct.Memory* @_Z29test_while_loop_unroll_factorILi25EdEvPKT0_iPKc(%struct.State* noalias, i64, %struct.Memory* noalias readnone) local_unnamed_addr #1 {
entry:
...
block_.L_407caf:                                  ; preds = %block_.L_407d38, %entry
  %74 = phi i64 [ %341, %block_.L_407d38 ], [ %.pre, %entry ]
...
block_.L_407cce:                                  ; preds = %block_407cdf, %block_407cbf
  %118 = phi i64 [ %202, %block_407cdf ], [ %.pre9, %block_407cbf ]
...
block_407cdf:                                     ; preds = %block_.L_407cce
  ...
  %call2_407cea = tail call %struct.Memory* @sub_401860._ZN15loop_inner_bodyILi25EdE7do_workERdPKdi(%struct.State* nonnull %0, i64 %166, %struct.Memory* %call2_407ca3)
...
block_407d0e:                                     ; preds = %block_.L_407d02
  ...
  %call2_407d1b = tail call %struct.Memory* @sub_4014b0._Z18complete_hash_funcIdET_S0_(%struct.State* nonnull %0, i64 %253, %struct.Memory* %call2_407ca3)
...
block_.L_407d38:                                  ; preds = %block_.L_407d02
  ...
  %call2_407d3d = tail call %struct.Memory* @sub_4014e0._Z9check_sumIdEvT_(%struct.State* nonnull %0, i64 %305, %struct.Memory* %call2_407ca3)
...
block_.L_407d50:                                  ; preds = %block_.L_407caf
  ...
  %call2_407d50 = tail call %struct.Memory* @sub_400e20._Z5timerv(%struct.State* nonnull %0, i64 %342, %struct.Memory* %call2_407ca3)
