...
define %struct.Memory* @_Z29test_while_loop_unroll_factorILi25EiEvPKT0_iPKc(%struct.State* noalias, i64, %struct.Memory* noalias readnone) local_unnamed_addr #1 {
entry:
...
block_.L_4125ff:                                  ; preds = %block_.L_412681, %entry
  %68 = phi i64 [ %362, %block_.L_412681 ], [ %.pre, %entry ]
...
block_.L_41261d:                                  ; preds = %block_41262e, %block_41260f
  %111 = phi i64 [ %195, %block_41262e ], [ %.pre9, %block_41260f ]
...
block_41262e:                                     ; preds = %block_.L_41261d
  ...
  %call2_412639 = tail call %struct.Memory* @sub_40c420._ZN15loop_inner_bodyILi25EiE7do_workERiPKii(%struct.State* nonnull %0, i64 %159, %struct.Memory* %call2_4125f3)
...
block_41265d:                                     ; preds = %block_.L_412651
  ...
  %call2_412668 = tail call %struct.Memory* @sub_40c100._Z18complete_hash_funcIiET_S0_(%struct.State* nonnull %0, i64 %247, %struct.Memory* %call2_4125f3)
...
block_.L_412681:                                  ; preds = %block_.L_412651
  ...
  %call2_412684 = tail call %struct.Memory* @sub_40c130._Z9check_sumIiEvT_(%struct.State* nonnull %0, i64 %326, %struct.Memory* %call2_4125f3)
...
block_.L_412697:                                  ; preds = %block_.L_4125ff
  ...
  %call2_412697 = tail call %struct.Memory* @sub_400e20._Z5timerv(%struct.State* nonnull %0, i64 %363, %struct.Memory* %call2_4125f3)
