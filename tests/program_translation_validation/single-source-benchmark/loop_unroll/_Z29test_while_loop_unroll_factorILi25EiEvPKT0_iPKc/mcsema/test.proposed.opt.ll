...
entry:
  ...
  %call2_412603 = tail call %struct.Memory* @sub_400e10._Z11start_timerv(%struct.State* %0, i64 %58, %struct.Memory* %2)
...
block_.L_41260f:                                  ; preds = %block_.L_412691, %entry
  %68 = phi i64 [ %362, %block_.L_412691 ], [ %.pre, %entry ]
  ...
  br i1 %101, label %block_41261f, label %block_.L_4126a7
...
block_.L_41262d:                                  ; preds = %block_41263e, %block_41261f
  %111 = phi i64 [ %195, %block_41263e ], [ %.pre9, %block_41261f ]
  ...
  br i1 %149, label %block_41263e, label %block_.L_41265c
...
block_41263e:                                     ; preds = %block_.L_41262d
  ...
  %call2_412649 = tail call %struct.Memory* @sub_40c430._ZN15loop_inner_bodyILi25EiE7do_workERiPKii(%struct.State* nonnull %0, i64 %159, %struct.Memory* %call2_412603)
...
block_.L_412661:                                  ; preds = %block_41266d, %block_.L_41265c
  %197 = phi i64 [ %112, %block_.L_41265c ], [ %.pre10, %block_41266d ]
  %storemerge = phi i64 [ %196, %block_.L_41265c ], [ %319, %block_41266d ]
  %198 = add i64 %197, -36
  ...
  br i1 %232, label %block_41266d, label %block_.L_412691
...
block_41266d:                                     ; preds = %block_.L_412661
  ...
  %call2_412678 = tail call %struct.Memory* @sub_40c110._Z18complete_hash_funcIiET_S0_(%struct.State* nonnull %0, i64 %247, %struct.Memory* %call2_412603)
...
block_.L_412691:                                  ; preds = %block_.L_412661
  ...
  %call2_412694 = tail call %struct.Memory* @sub_40c140._Z9check_sumIiEvT_(%struct.State* nonnull %0, i64 %326, %struct.Memory* %call2_412603)
...
block_.L_4126a7:                                  ; preds = %block_.L_41260f
  ...
  %call2_4126a7 = tail call %struct.Memory* @sub_400e30._Z5timerv(%struct.State* nonnull %0, i64 %363, %struct.Memory* %call2_412603)
  ...
  %call2_4126b0 = tail call %struct.Memory* @sub_4007d0._Z13record_resultdPKc(%struct.State* nonnull %0, i64 %374, %struct.Memory* %call2_4126a7)
