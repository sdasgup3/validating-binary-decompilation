...
block_.L_4125cf:                                  ; preds = %block_.L_412651, %entry
  %68 = phi i64 [ %.pre, %entry ], [ %362, %block_.L_412651 ]
...
block_.L_412621:                                  ; preds = %block_41262d, %block_.L_41261c
  %197 = phi i64 [ %196, %block_.L_41261c ], [ %320, %block_41262d ]
...
block_.L_412651:                                  ; preds = %block_.L_412621
  ...
  %call2_412654 = tail call %struct.Memory* @sub_40c100._Z9check_sumIiEvT_(%struct.State* %0, i64 %326, %struct.Memory* %MEMORY.2)
...
block_.L_412667:                                  ; preds = %block_.L_4125cf
  ...
  %call2_412667 = tail call %struct.Memory* @sub_400df0._Z5timerv(%struct.State* %0, i64 %363, %struct.Memory* %MEMORY.0)
  ...
  %call2_412670 = tail call %struct.Memory* @sub_400790._Z13record_resultdPKc(%struct.State* %0, i64 %374, %struct.Memory* %call2_412667)
