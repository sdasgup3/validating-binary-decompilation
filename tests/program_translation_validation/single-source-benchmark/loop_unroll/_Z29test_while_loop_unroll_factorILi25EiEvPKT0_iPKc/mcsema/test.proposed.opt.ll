...
entry:
  ...
  %call2_4125c3 = tail call %struct.Memory* @sub_400dd0._Z11start_timerv(%struct.State* %0, i64 %58, %struct.Memory* %2)
...
block_.L_4125cf:                                  ; preds = %block_.L_412651, %entry
  %68 = phi i64 [ %.pre, %entry ], [ %364, %block_.L_412651 ]
  %MEMORY.0 = phi %struct.Memory* [ %call2_4125c3, %entry ], [ %call2_412654, %block_.L_412651 ]
  ...
  br i1 %101, label %block_4125df, label %block_.L_412667
...
block_.L_4125ed:                                  ; preds = %block_4125fe, %block_4125df
  %111 = phi i64 [ %.pre1, %block_4125df ], [ %195, %block_4125fe ]
  %MEMORY.1 = phi %struct.Memory* [ %MEMORY.0, %block_4125df ], [ %call2_412609, %block_4125fe ]
  ...
  br i1 %149, label %block_4125fe, label %block_.L_41261c
...
block_4125fe:                                     ; preds = %block_.L_4125ed
  ...
  %call2_412609 = tail call %struct.Memory* @sub_40c3f0._ZN15loop_inner_bodyILi25EiE7do_workERiPKii(%struct.State* %0, i64 %159, %struct.Memory* %MEMORY.1)
...
block_.L_412621:                                  ; preds = %block_41262d, %block_.L_41261c
  %197 = phi i64 [ %196, %block_.L_41261c ], [ %321, %block_41262d ]
  %198 = phi i64 [ %112, %block_.L_41261c ], [ %.pre2, %block_41262d ]
  %MEMORY.2 = phi %struct.Memory* [ %MEMORY.1, %block_.L_41261c ], [ %call2_412638, %block_41262d ]
  %199 = add i64 %198, -36
  %200 = add i64 %197, 3
  ...
  br i1 %233, label %block_41262d, label %block_.L_412651
...
block_41262d:                                     ; preds = %block_.L_412621
  ...
  %call2_412638 = tail call %struct.Memory* @sub_40c0d0._Z18complete_hash_funcIiET_S0_(%struct.State* %0, i64 %248, %struct.Memory* %MEMORY.2)
...
block_.L_412651:                                  ; preds = %block_.L_412621
  ...
  %call2_412654 = tail call %struct.Memory* @sub_40c100._Z9check_sumIiEvT_(%struct.State* %0, i64 %327, %struct.Memory* %MEMORY.2)
...
block_.L_412667:                                  ; preds = %block_.L_4125cf
  ...
  %call2_412667 = tail call %struct.Memory* @sub_400df0._Z5timerv(%struct.State* %0, i64 %365, %struct.Memory* %MEMORY.0)
  ...
  %call2_412670 = tail call %struct.Memory* @sub_400790._Z13record_resultdPKc(%struct.State* %0, i64 %376, %struct.Memory* %call2_412667)
  ...
  ret %struct.Memory* %call2_412670
}
...
define %struct.Memory* @routine_jge_.L_412667(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i8* %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
...
define %struct.Memory* @routine_jge_.L_41261c(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i8* %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 2, i32 9
...
define %struct.Memory* @routine_jmpq_.L_4125ed(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
...
define %struct.Memory* @routine_jmpq_.L_412621(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
...
define %struct.Memory* @routine_jge_.L_412651(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i8* %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 2, i32 9
...
define %struct.Memory* @routine_jmpq_.L_4125cf(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
