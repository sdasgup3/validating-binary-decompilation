...
define %struct.Memory* @_Z29test_while_loop_unroll_factorILi26EdEvPKT0_iPKc(%struct.State* noalias, i64, %struct.Memory* noalias readnone) local_unnamed_addr #1 {
entry:
  ...
  %call2_407b83 = tail call %struct.Memory* @sub_400e10._Z11start_timerv(%struct.State* %0, i64 %58, %struct.Memory* %2)
...
block_.L_407b8f:                                  ; preds = %block_.L_407c18, %entry
  %74 = phi i64 [ %341, %block_.L_407c18 ], [ %.pre, %entry ]
  ...
  br i1 %107, label %block_407b9f, label %block_.L_407c30
...
block_.L_407bae:                                  ; preds = %block_407bbf, %block_407b9f
  %118 = phi i64 [ %202, %block_407bbf ], [ %.pre9, %block_407b9f ]
  ...
  br i1 %156, label %block_407bbf, label %block_.L_407bdd
...
block_407bbf:                                     ; preds = %block_.L_407bae
  ...
  %call2_407bca = tail call %struct.Memory* @sub_401810._ZN15loop_inner_bodyILi26EdE7do_workERdPKdi(%struct.State* nonnull %0, i64 %166, %struct.Memory* %call2_407b83)
...
block_.L_407be2:                                  ; preds = %block_407bee, %block_.L_407bdd
  %204 = phi i64 [ %119, %block_.L_407bdd ], [ %.pre10, %block_407bee ]
  %storemerge = phi i64 [ %203, %block_.L_407bdd ], [ %299, %block_407bee ]
  %205 = add i64 %204, -44
  ...
  br i1 %239, label %block_407bee, label %block_.L_407c18
...
block_407bee:                                     ; preds = %block_.L_407be2
  ...
  %call2_407bfb = tail call %struct.Memory* @sub_4014c0._Z18complete_hash_funcIdET_S0_(%struct.State* nonnull %0, i64 %253, %struct.Memory* %call2_407b83)
...
block_.L_407c18:                                  ; preds = %block_.L_407be2
  ...
  %call2_407c1d = tail call %struct.Memory* @sub_4014f0._Z9check_sumIdEvT_(%struct.State* nonnull %0, i64 %305, %struct.Memory* %call2_407b83)
...
block_.L_407c30:                                  ; preds = %block_.L_407b8f
  ...
  %call2_407c30 = tail call %struct.Memory* @sub_400e30._Z5timerv(%struct.State* nonnull %0, i64 %342, %struct.Memory* %call2_407b83)
  ...
  %call2_407c39 = tail call %struct.Memory* @sub_4007d0._Z13record_resultdPKc(%struct.State* nonnull %0, i64 %353, %struct.Memory* %call2_407c30)
