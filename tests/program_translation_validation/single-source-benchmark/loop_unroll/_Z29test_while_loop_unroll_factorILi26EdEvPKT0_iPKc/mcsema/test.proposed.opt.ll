...
entry:
  ...
  %call2_407b43 = tail call %struct.Memory* @sub_400dd0._Z11start_timerv(%struct.State* %0, i64 %58, %struct.Memory* %2)
...
block_.L_407b4f:                                  ; preds = %block_.L_407bd8, %entry
  %79 = phi i64 [ %.pre, %entry ], [ %350, %block_.L_407bd8 ]
  %MEMORY.0 = phi %struct.Memory* [ %call2_407b43, %entry ], [ %call2_407bdd, %block_.L_407bd8 ]
  ...
  br i1 %112, label %block_407b5f, label %block_.L_407bf0
...
block_.L_407b6e:                                  ; preds = %block_407b7f, %block_407b5f
  %124 = phi i64 [ %.pre1, %block_407b5f ], [ %208, %block_407b7f ]
  %MEMORY.1 = phi %struct.Memory* [ %MEMORY.0, %block_407b5f ], [ %call2_407b8a, %block_407b7f ]
  ...
  br i1 %162, label %block_407b7f, label %block_.L_407b9d
...
block_407b7f:                                     ; preds = %block_.L_407b6e
  ...
  %call2_407b8a = tail call %struct.Memory* @sub_4017d0._ZN15loop_inner_bodyILi26EdE7do_workERdPKdi(%struct.State* %0, i64 %172, %struct.Memory* %MEMORY.1)
...
block_.L_407ba2:                                  ; preds = %block_407bae, %block_.L_407b9d
  %210 = phi i64 [ %209, %block_.L_407b9d ], [ %307, %block_407bae ]
  %211 = phi i64 [ %125, %block_.L_407b9d ], [ %.pre2, %block_407bae ]
  %MEMORY.2 = phi %struct.Memory* [ %MEMORY.1, %block_.L_407b9d ], [ %call2_407bbb, %block_407bae ]
  %212 = add i64 %211, -44
  %213 = add i64 %210, 3
  ...
  br i1 %246, label %block_407bae, label %block_.L_407bd8
...
block_407bae:                                     ; preds = %block_.L_407ba2
  ...
  %call2_407bbb = tail call %struct.Memory* @sub_401480._Z18complete_hash_funcIdET_S0_(%struct.State* %0, i64 %261, %struct.Memory* %MEMORY.2)
...
block_.L_407bd8:                                  ; preds = %block_.L_407ba2
  ...
  %call2_407bdd = tail call %struct.Memory* @sub_4014b0._Z9check_sumIdEvT_(%struct.State* %0, i64 %313, %struct.Memory* %MEMORY.2)
...
block_.L_407bf0:                                  ; preds = %block_.L_407b4f
  ...
  %call2_407bf0 = tail call %struct.Memory* @sub_400df0._Z5timerv(%struct.State* %0, i64 %351, %struct.Memory* %MEMORY.0)
  ...
  %call2_407bf9 = tail call %struct.Memory* @sub_400790._Z13record_resultdPKc(%struct.State* %0, i64 %362, %struct.Memory* %call2_407bf0)
  ...
  ret %struct.Memory* %call2_407bf9
}
...
define %struct.Memory* @routine_jge_.L_407bf0(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i8* %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
...
define %struct.Memory* @routine_jge_.L_407b9d(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i8* %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 2, i32 9
...
define %struct.Memory* @routine_jmpq_.L_407b6e(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
...
define %struct.Memory* @routine_jmpq_.L_407ba2(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
...
define %struct.Memory* @routine_jge_.L_407bd8(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i8* %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 2, i32 9
...
define %struct.Memory* @routine_jmpq_.L_407b4f(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
