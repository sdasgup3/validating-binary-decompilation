...
block_.L_407b4f:                                  ; preds = %block_.L_407bd8, %entry
  %79 = phi i64 [ %.pre, %entry ], [ %346, %block_.L_407bd8 ]
...
block_.L_407ba2:                                  ; preds = %block_407bae, %block_.L_407b9d
  %210 = phi i64 [ %209, %block_.L_407b9d ], [ %305, %block_407bae ]
...
block_407bae:                                     ; preds = %block_.L_407ba2
  ...
  %call2_407bbb = tail call %struct.Memory* @sub_401480._Z18complete_hash_funcIdET_S0_(%struct.State* %0, i64 %260, %struct.Memory* %MEMORY.2)
...
block_.L_407bd8:                                  ; preds = %block_.L_407ba2
  ...
  %call2_407bdd = tail call %struct.Memory* @sub_4014b0._Z9check_sumIdEvT_(%struct.State* %0, i64 %310, %struct.Memory* %MEMORY.2)
...
block_.L_407bf0:                                  ; preds = %block_.L_407b4f
  ...
  %call2_407bf0 = tail call %struct.Memory* @sub_400df0._Z5timerv(%struct.State* %0, i64 %347, %struct.Memory* %MEMORY.0)
  ...
  %call2_407bf9 = tail call %struct.Memory* @sub_400790._Z13record_resultdPKc(%struct.State* %0, i64 %358, %struct.Memory* %call2_407bf0)
