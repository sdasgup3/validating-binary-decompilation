...
entry:
  ...
  %call2_4124d3 = tail call %struct.Memory* @sub_400e00._Z11start_timerv(%struct.State* %0, i64 %58, %struct.Memory* %2)
...
block_.L_4124df:                                  ; preds = %block_.L_412561, %entry
  %68 = phi i64 [ %.pre, %entry ], [ %362, %block_.L_412561 ]
  %MEMORY.0 = phi %struct.Memory* [ %call2_4124d3, %entry ], [ %call2_412564, %block_.L_412561 ]
  ...
  br i1 %101, label %block_4124ef, label %block_.L_412577

block_4124ef:                                     ; preds = %block_.L_4124df
  %103 = add i64 %69, -32
  %104 = add i64 %102, 7
...
block_.L_4124fd:                                  ; preds = %block_41250e, %block_4124ef
  %111 = phi i64 [ %.pre9, %block_4124ef ], [ %195, %block_41250e ]
  %MEMORY.1 = phi %struct.Memory* [ %MEMORY.0, %block_4124ef ], [ %call2_412519, %block_41250e ]
  ...
  br i1 %149, label %block_41250e, label %block_.L_41252c

block_41250e:                                     ; preds = %block_.L_4124fd
  %151 = add i64 %112, -32
  ...
  %call2_412519 = tail call %struct.Memory* @sub_40c3c0._ZN15loop_inner_bodyILi26EiE7do_workERiPKii(%struct.State* nonnull %0, i64 %159, %struct.Memory* %MEMORY.1)
...
block_.L_41252c:                                  ; preds = %block_.L_4124fd
  %196 = add i64 %150, 5
  br label %block_.L_412531

block_.L_412531:                                  ; preds = %block_41253d, %block_.L_41252c
  %197 = phi i64 [ %112, %block_.L_41252c ], [ %.pre10, %block_41253d ]
  %storemerge = phi i64 [ %196, %block_.L_41252c ], [ %319, %block_41253d ]
  %MEMORY.2 = phi %struct.Memory* [ %MEMORY.1, %block_.L_41252c ], [ %call2_412548, %block_41253d ]
  %198 = add i64 %197, -36
  ...
  br i1 %232, label %block_41253d, label %block_.L_412561

block_41253d:                                     ; preds = %block_.L_412531
  %234 = add i64 %197, -8
  %235 = add i64 %233, 4
  ...
  %call2_412548 = tail call %struct.Memory* @sub_40c100._Z18complete_hash_funcIiET_S0_(%struct.State* nonnull %0, i64 %247, %struct.Memory* %MEMORY.2)
...
block_.L_412561:                                  ; preds = %block_.L_412531
  %321 = add i64 %197, -32
  %322 = add i64 %233, 3
  ...
  %call2_412564 = tail call %struct.Memory* @sub_40c130._Z9check_sumIiEvT_(%struct.State* nonnull %0, i64 %326, %struct.Memory* %MEMORY.2)
...
block_.L_412577:                                  ; preds = %block_.L_4124df
  ...
  %call2_412577 = tail call %struct.Memory* @sub_400e20._Z5timerv(%struct.State* nonnull %0, i64 %363, %struct.Memory* %MEMORY.0)
  ...
  %call2_412580 = tail call %struct.Memory* @sub_4007c0._Z13record_resultdPKc(%struct.State* nonnull %0, i64 %374, %struct.Memory* %call2_412577)
  ...
  ret %struct.Memory* %call2_412580
}
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_jge_.L_412577(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i8* nocapture %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_jge_.L_41252c(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i8* nocapture %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 2, i32 9
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_jmpq_.L_4124fd(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_jmpq_.L_412531(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_jge_.L_412561(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i8* nocapture %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 2, i32 9
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_jmpq_.L_4124df(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
