...
block_.L_4124af:                                  ; preds = %block_.L_412531, %entry
  %68 = phi i64 [ %.pre, %entry ], [ %364, %block_.L_412531 ]
...
block_.L_412501:                                  ; preds = %block_41250d, %block_.L_4124fc
  %197 = phi i64 [ %196, %block_.L_4124fc ], [ %321, %block_41250d ]
...
block_.L_412531:                                  ; preds = %block_.L_412501
  ...
  %call2_412534 = tail call %struct.Memory* @sub_40c100._Z9check_sumIiEvT_(%struct.State* %0, i64 %327, %struct.Memory* %MEMORY.2)
...
block_.L_412547:                                  ; preds = %block_.L_4124af
  ...
  %call2_412547 = tail call %struct.Memory* @sub_400df0._Z5timerv(%struct.State* %0, i64 %365, %struct.Memory* %MEMORY.0)
  ...
  %call2_412550 = tail call %struct.Memory* @sub_400790._Z13record_resultdPKc(%struct.State* %0, i64 %376, %struct.Memory* %call2_412547)
