...
block_.L_4124df:                                  ; preds = %block_.L_412561, %entry
  %68 = phi i64 [ %362, %block_.L_412561 ], [ %.pre, %entry ]
...
block_.L_4124fd:                                  ; preds = %block_41250e, %block_4124ef
  %111 = phi i64 [ %195, %block_41250e ], [ %.pre9, %block_4124ef ]
...
block_41250e:                                     ; preds = %block_.L_4124fd
  ...
  %call2_412519 = tail call %struct.Memory* @sub_40c3c0._ZN15loop_inner_bodyILi26EiE7do_workERiPKii(%struct.State* nonnull %0, i64 %159, %struct.Memory* %call2_4124d3)
...
block_41253d:                                     ; preds = %block_.L_412531
  ...
  %call2_412548 = tail call %struct.Memory* @sub_40c100._Z18complete_hash_funcIiET_S0_(%struct.State* nonnull %0, i64 %247, %struct.Memory* %call2_4124d3)
...
block_.L_412561:                                  ; preds = %block_.L_412531
  ...
  %call2_412564 = tail call %struct.Memory* @sub_40c130._Z9check_sumIiEvT_(%struct.State* nonnull %0, i64 %326, %struct.Memory* %call2_4124d3)
...
block_.L_412577:                                  ; preds = %block_.L_4124df
  ...
  %call2_412577 = tail call %struct.Memory* @sub_400e20._Z5timerv(%struct.State* nonnull %0, i64 %363, %struct.Memory* %call2_4124d3)
