...
declare %struct.Memory* @sub_4017a0._ZN15loop_inner_bodyILi27EdE7do_workERdPKdi(%struct.State* noalias dereferenceable(3376), i64, %struct.Memory* noalias readnone returned) local_unnamed_addr
...
block_.L_407a4f:                                  ; preds = %block_.L_407ad8, %entry
  %74 = phi i64 [ %341, %block_.L_407ad8 ], [ %.pre, %entry ]
...
block_.L_407a6e:                                  ; preds = %block_407a7f, %block_407a5f
  %118 = phi i64 [ %202, %block_407a7f ], [ %.pre9, %block_407a5f ]
...
block_407a7f:                                     ; preds = %block_.L_407a6e
  ...
  %call2_407a8a = tail call %struct.Memory* @sub_4017a0._ZN15loop_inner_bodyILi27EdE7do_workERdPKdi(%struct.State* nonnull %0, i64 %166, %struct.Memory* %call2_407a43)
...
block_407aae:                                     ; preds = %block_.L_407aa2
  ...
  %call2_407abb = tail call %struct.Memory* @sub_4014b0._Z18complete_hash_funcIdET_S0_(%struct.State* nonnull %0, i64 %253, %struct.Memory* %call2_407a43)
...
block_.L_407ad8:                                  ; preds = %block_.L_407aa2
  ...
  %call2_407add = tail call %struct.Memory* @sub_4014e0._Z9check_sumIdEvT_(%struct.State* nonnull %0, i64 %305, %struct.Memory* %call2_407a43)
...
block_.L_407af0:                                  ; preds = %block_.L_407a4f
  ...
  %call2_407af0 = tail call %struct.Memory* @sub_400e20._Z5timerv(%struct.State* nonnull %0, i64 %342, %struct.Memory* %call2_407a43)
