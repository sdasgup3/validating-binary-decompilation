...
block_.L_407a1f:                                  ; preds = %block_.L_407aa8, %entry
  %79 = phi i64 [ %.pre, %entry ], [ %346, %block_.L_407aa8 ]
...
block_.L_407a72:                                  ; preds = %block_407a7e, %block_.L_407a6d
  %210 = phi i64 [ %209, %block_.L_407a6d ], [ %305, %block_407a7e ]
...
block_407a7e:                                     ; preds = %block_.L_407a72
  ...
  %call2_407a8b = tail call %struct.Memory* @sub_401480._Z18complete_hash_funcIdET_S0_(%struct.State* %0, i64 %260, %struct.Memory* %MEMORY.2)
...
block_.L_407aa8:                                  ; preds = %block_.L_407a72
  ...
  %call2_407aad = tail call %struct.Memory* @sub_4014b0._Z9check_sumIdEvT_(%struct.State* %0, i64 %310, %struct.Memory* %MEMORY.2)
  ...
  store i64 %322, i64* %RAX.i90, align 8
...
block_.L_407ac0:                                  ; preds = %block_.L_407a1f
  ...
  %call2_407ac0 = tail call %struct.Memory* @sub_400df0._Z5timerv(%struct.State* %0, i64 %347, %struct.Memory* %MEMORY.0)
  ...
  store i64 %357, i64* %RDI.i101, align 8
  %358 = add i64 %354, -29493
  %359 = add i64 %354, 9
  ...
  %call2_407ac9 = tail call %struct.Memory* @sub_400790._Z13record_resultdPKc(%struct.State* %0, i64 %358, %struct.Memory* %call2_407ac0)
