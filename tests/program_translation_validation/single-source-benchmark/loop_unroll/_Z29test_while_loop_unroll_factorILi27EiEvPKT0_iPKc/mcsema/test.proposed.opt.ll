...
declare %struct.Memory* @sub_40c360._ZN15loop_inner_bodyILi27EiE7do_workERiPKii(%struct.State* noalias dereferenceable(3376), i64, %struct.Memory* noalias readnone returned) local_unnamed_addr
...
define %struct.Memory* @_Z29test_while_loop_unroll_factorILi27EiEvPKT0_iPKc(%struct.State* noalias, i64, %struct.Memory* noalias readnone) local_unnamed_addr #1 {
entry:
...
block_.L_4123bf:                                  ; preds = %block_.L_412441, %entry
  %68 = phi i64 [ %362, %block_.L_412441 ], [ %.pre, %entry ]
...
block_.L_4123dd:                                  ; preds = %block_4123ee, %block_4123cf
  %111 = phi i64 [ %195, %block_4123ee ], [ %.pre9, %block_4123cf ]
...
block_4123ee:                                     ; preds = %block_.L_4123dd
  ...
  %call2_4123f9 = tail call %struct.Memory* @sub_40c360._ZN15loop_inner_bodyILi27EiE7do_workERiPKii(%struct.State* nonnull %0, i64 %159, %struct.Memory* %call2_4123b3)
...
block_41241d:                                     ; preds = %block_.L_412411
  ...
  %call2_412428 = tail call %struct.Memory* @sub_40c100._Z18complete_hash_funcIiET_S0_(%struct.State* nonnull %0, i64 %247, %struct.Memory* %call2_4123b3)
...
block_.L_412441:                                  ; preds = %block_.L_412411
  ...
  %call2_412444 = tail call %struct.Memory* @sub_40c130._Z9check_sumIiEvT_(%struct.State* nonnull %0, i64 %326, %struct.Memory* %call2_4123b3)
...
block_.L_412457:                                  ; preds = %block_.L_4123bf
  ...
  %call2_412457 = tail call %struct.Memory* @sub_400e20._Z5timerv(%struct.State* nonnull %0, i64 %363, %struct.Memory* %call2_4123b3)
