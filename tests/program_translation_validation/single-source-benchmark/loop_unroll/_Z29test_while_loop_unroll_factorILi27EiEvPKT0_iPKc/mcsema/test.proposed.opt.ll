...
block_.L_41238f:                                  ; preds = %block_.L_412411, %entry
  %68 = phi i64 [ %.pre, %entry ], [ %362, %block_.L_412411 ]
...
block_.L_4123e1:                                  ; preds = %block_4123ed, %block_.L_4123dc
  %197 = phi i64 [ %196, %block_.L_4123dc ], [ %320, %block_4123ed ]
...
block_.L_412411:                                  ; preds = %block_.L_4123e1
  ...
  %call2_412414 = tail call %struct.Memory* @sub_40c100._Z9check_sumIiEvT_(%struct.State* %0, i64 %326, %struct.Memory* %MEMORY.2)
...
block_.L_412427:                                  ; preds = %block_.L_41238f
  ...
  %call2_412427 = tail call %struct.Memory* @sub_400df0._Z5timerv(%struct.State* %0, i64 %363, %struct.Memory* %MEMORY.0)
  ...
  %call2_412430 = tail call %struct.Memory* @sub_400790._Z13record_resultdPKc(%struct.State* %0, i64 %374, %struct.Memory* %call2_412427)
