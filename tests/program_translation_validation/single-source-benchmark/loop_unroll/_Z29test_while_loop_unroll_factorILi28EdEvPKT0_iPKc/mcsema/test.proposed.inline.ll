...
define %struct.Memory* @_Z29test_while_loop_unroll_factorILi28EdEvPKT0_iPKc(%struct.State* noalias, i64, %struct.Memory* noalias) #2 {
entry:
  ...
  store i32 %93, i32* %97
  store %struct.Memory* %loadMem_40791c, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem1_407923, %struct.Memory** %MEMORY
...
block_.L_40792f:                                  ; preds = %block_.L_4079b8, %entry
  ...
  store %struct.Memory* %loadMem_40792f, %struct.Memory** %MEMORY
...
block_40793f:                                     ; preds = %block_.L_40792f
  ...
  store %struct.Memory* %loadMem_40793f, %struct.Memory** %MEMORY
...
block_.L_40794e:                                  ; preds = %block_40795f, %block_40793f
  ...
  store %struct.Memory* %loadMem_407959, %struct.Memory** %MEMORY
...
block_40795f:                                     ; preds = %block_.L_40794e
  ...
  store %struct.Memory* %loadMem_407967, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem1_40796a, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_407978, %struct.Memory** %MEMORY
  br label %block_.L_40794e

block_.L_40797d:                                  ; preds = %block_.L_40794e
...
block_.L_407982:                                  ; preds = %block_40798e, %block_.L_40797d
  ...
  store %struct.Memory* %loadMem_407985, %struct.Memory** %MEMORY
...
block_40798e:                                     ; preds = %block_.L_407982
  ...
  store %struct.Memory* %loadMem_40798e, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_407992, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_407996, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem1_40799b, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_4079aa, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_4079ad, %struct.Memory** %MEMORY
...
block_.L_4079b8:                                  ; preds = %block_.L_407982
  ...
  store %struct.Memory* %loadMem1_4079bd, %struct.Memory** %MEMORY
...
block_.L_4079d0:                                  ; preds = %block_.L_40792f
  ...
  store %struct.Memory* %loadMem1_4079d0, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem1_4079d9, %struct.Memory** %MEMORY
  ...
  ret %struct.Memory* %loadMem_4079e3
}
