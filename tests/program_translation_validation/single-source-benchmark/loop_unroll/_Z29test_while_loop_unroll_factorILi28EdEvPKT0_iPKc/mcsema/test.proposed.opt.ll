...
define %struct.Memory* @_Z29test_while_loop_unroll_factorILi28EdEvPKT0_iPKc(%struct.State* noalias, i64, %struct.Memory* noalias readnone) local_unnamed_addr #1 {
entry:
...
block_.L_40791f:                                  ; preds = %block_.L_4079a8, %entry
  %74 = phi i64 [ %341, %block_.L_4079a8 ], [ %.pre, %entry ]
...
block_.L_40793e:                                  ; preds = %block_40794f, %block_40792f
  %118 = phi i64 [ %202, %block_40794f ], [ %.pre9, %block_40792f ]
...
block_40794f:                                     ; preds = %block_.L_40793e
  ...
  %call2_40795a = tail call %struct.Memory* @sub_401740._ZN15loop_inner_bodyILi28EdE7do_workERdPKdi(%struct.State* nonnull %0, i64 %166, %struct.Memory* %call2_407913)
...
block_40797e:                                     ; preds = %block_.L_407972
  ...
  %call2_40798b = tail call %struct.Memory* @sub_4014b0._Z18complete_hash_funcIdET_S0_(%struct.State* nonnull %0, i64 %253, %struct.Memory* %call2_407913)
...
block_.L_4079a8:                                  ; preds = %block_.L_407972
  ...
  %call2_4079ad = tail call %struct.Memory* @sub_4014e0._Z9check_sumIdEvT_(%struct.State* nonnull %0, i64 %305, %struct.Memory* %call2_407913)
...
block_.L_4079c0:                                  ; preds = %block_.L_40791f
  ...
  %call2_4079c0 = tail call %struct.Memory* @sub_400e20._Z5timerv(%struct.State* nonnull %0, i64 %342, %struct.Memory* %call2_407913)
