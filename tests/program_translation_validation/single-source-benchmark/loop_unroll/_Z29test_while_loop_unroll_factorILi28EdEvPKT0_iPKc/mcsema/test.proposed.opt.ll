...
entry:
  ...
  %call2_407923 = tail call %struct.Memory* @sub_400e10._Z11start_timerv(%struct.State* %0, i64 %58, %struct.Memory* %2)
...
block_.L_40792f:                                  ; preds = %block_.L_4079b8, %entry
  %74 = phi i64 [ %341, %block_.L_4079b8 ], [ %.pre, %entry ]
  ...
  br i1 %107, label %block_40793f, label %block_.L_4079d0
...
block_.L_40794e:                                  ; preds = %block_40795f, %block_40793f
  %118 = phi i64 [ %202, %block_40795f ], [ %.pre9, %block_40793f ]
  ...
  br i1 %156, label %block_40795f, label %block_.L_40797d
...
block_40795f:                                     ; preds = %block_.L_40794e
  ...
  %call2_40796a = tail call %struct.Memory* @sub_401750._ZN15loop_inner_bodyILi28EdE7do_workERdPKdi(%struct.State* nonnull %0, i64 %166, %struct.Memory* %call2_407923)
...
block_.L_407982:                                  ; preds = %block_40798e, %block_.L_40797d
  %204 = phi i64 [ %119, %block_.L_40797d ], [ %.pre10, %block_40798e ]
  %storemerge = phi i64 [ %203, %block_.L_40797d ], [ %299, %block_40798e ]
  %205 = add i64 %204, -44
  ...
  br i1 %239, label %block_40798e, label %block_.L_4079b8
...
block_40798e:                                     ; preds = %block_.L_407982
  ...
  %call2_40799b = tail call %struct.Memory* @sub_4014c0._Z18complete_hash_funcIdET_S0_(%struct.State* nonnull %0, i64 %253, %struct.Memory* %call2_407923)
...
block_.L_4079b8:                                  ; preds = %block_.L_407982
  ...
  %call2_4079bd = tail call %struct.Memory* @sub_4014f0._Z9check_sumIdEvT_(%struct.State* nonnull %0, i64 %305, %struct.Memory* %call2_407923)
...
block_.L_4079d0:                                  ; preds = %block_.L_40792f
  ...
  %call2_4079d0 = tail call %struct.Memory* @sub_400e30._Z5timerv(%struct.State* nonnull %0, i64 %342, %struct.Memory* %call2_407923)
  ...
  %call2_4079d9 = tail call %struct.Memory* @sub_4007d0._Z13record_resultdPKc(%struct.State* nonnull %0, i64 %353, %struct.Memory* %call2_4079d0)
