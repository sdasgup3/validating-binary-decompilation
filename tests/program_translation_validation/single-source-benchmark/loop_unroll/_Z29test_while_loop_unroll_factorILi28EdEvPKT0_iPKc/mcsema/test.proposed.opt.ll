...
block_.L_4078ef:                                  ; preds = %block_.L_407978, %entry
  %79 = phi i64 [ %.pre, %entry ], [ %350, %block_.L_407978 ]
...
block_.L_407942:                                  ; preds = %block_40794e, %block_.L_40793d
  %210 = phi i64 [ %209, %block_.L_40793d ], [ %307, %block_40794e ]
...
block_40794e:                                     ; preds = %block_.L_407942
  ...
  %call2_40795b = tail call %struct.Memory* @sub_401480._Z18complete_hash_funcIdET_S0_(%struct.State* %0, i64 %261, %struct.Memory* %MEMORY.2)
...
block_.L_407978:                                  ; preds = %block_.L_407942
  ...
  %call2_40797d = tail call %struct.Memory* @sub_4014b0._Z9check_sumIdEvT_(%struct.State* %0, i64 %313, %struct.Memory* %MEMORY.2)
...
block_.L_407990:                                  ; preds = %block_.L_4078ef
  ...
  %call2_407990 = tail call %struct.Memory* @sub_400df0._Z5timerv(%struct.State* %0, i64 %351, %struct.Memory* %MEMORY.0)
  ...
  %call2_407999 = tail call %struct.Memory* @sub_400790._Z13record_resultdPKc(%struct.State* %0, i64 %362, %struct.Memory* %call2_407990)
