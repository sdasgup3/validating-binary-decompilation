...
define %struct.Memory* @_Z29test_while_loop_unroll_factorILi28EiEvPKT0_iPKc(%struct.State* noalias, i64, %struct.Memory* noalias) local_unnamed_addr #1 {
entry:
  ...
  %call2_412293 = tail call %struct.Memory* @sub_400e00._Z11start_timerv(%struct.State* %0, i64 %58, %struct.Memory* %2)
...
block_.L_41229f:                                  ; preds = %block_.L_412321, %entry
  %68 = phi i64 [ %.pre, %entry ], [ %362, %block_.L_412321 ]
  %MEMORY.0 = phi %struct.Memory* [ %call2_412293, %entry ], [ %call2_412324, %block_.L_412321 ]
  ...
  br i1 %101, label %block_4122af, label %block_.L_412337

block_4122af:                                     ; preds = %block_.L_41229f
  %103 = add i64 %69, -32
  %104 = add i64 %102, 7
...
block_.L_4122bd:                                  ; preds = %block_4122ce, %block_4122af
  %111 = phi i64 [ %.pre9, %block_4122af ], [ %195, %block_4122ce ]
  %MEMORY.1 = phi %struct.Memory* [ %MEMORY.0, %block_4122af ], [ %call2_4122d9, %block_4122ce ]
  ...
  br i1 %149, label %block_4122ce, label %block_.L_4122ec

block_4122ce:                                     ; preds = %block_.L_4122bd
  %151 = add i64 %112, -32
  ...
  %call2_4122d9 = tail call %struct.Memory* @sub_40c300._ZN15loop_inner_bodyILi28EiE7do_workERiPKii(%struct.State* nonnull %0, i64 %159, %struct.Memory* %MEMORY.1)
...
block_.L_4122ec:                                  ; preds = %block_.L_4122bd
  %196 = add i64 %150, 5
  br label %block_.L_4122f1

block_.L_4122f1:                                  ; preds = %block_4122fd, %block_.L_4122ec
  %197 = phi i64 [ %112, %block_.L_4122ec ], [ %.pre10, %block_4122fd ]
  %storemerge = phi i64 [ %196, %block_.L_4122ec ], [ %319, %block_4122fd ]
  %MEMORY.2 = phi %struct.Memory* [ %MEMORY.1, %block_.L_4122ec ], [ %call2_412308, %block_4122fd ]
  %198 = add i64 %197, -36
  ...
  br i1 %232, label %block_4122fd, label %block_.L_412321

block_4122fd:                                     ; preds = %block_.L_4122f1
  %234 = add i64 %197, -8
  %235 = add i64 %233, 4
  ...
  %call2_412308 = tail call %struct.Memory* @sub_40c100._Z18complete_hash_funcIiET_S0_(%struct.State* nonnull %0, i64 %247, %struct.Memory* %MEMORY.2)
...
block_.L_412321:                                  ; preds = %block_.L_4122f1
  %321 = add i64 %197, -32
  %322 = add i64 %233, 3
  ...
  %call2_412324 = tail call %struct.Memory* @sub_40c130._Z9check_sumIiEvT_(%struct.State* nonnull %0, i64 %326, %struct.Memory* %MEMORY.2)
...
block_.L_412337:                                  ; preds = %block_.L_41229f
  %363 = add i64 %102, -70935
  %364 = add i64 %102, 5
  ...
  %call2_412337 = tail call %struct.Memory* @sub_400e20._Z5timerv(%struct.State* nonnull %0, i64 %363, %struct.Memory* %MEMORY.0)
  ...
  %call2_412340 = tail call %struct.Memory* @sub_4007c0._Z13record_resultdPKc(%struct.State* nonnull %0, i64 %374, %struct.Memory* %call2_412337)
  ...
  ret %struct.Memory* %call2_412340
}
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_jge_.L_412337(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i8* nocapture %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_jge_.L_4122ec(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i8* nocapture %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 2, i32 9
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_jmpq_.L_4122bd(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_jmpq_.L_4122f1(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_jge_.L_412321(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i8* nocapture %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 2, i32 9
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_jmpq_.L_41229f(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
