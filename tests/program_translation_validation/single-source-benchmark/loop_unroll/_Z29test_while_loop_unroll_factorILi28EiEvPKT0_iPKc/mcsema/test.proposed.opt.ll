...
block_.L_41226f:                                  ; preds = %block_.L_4122f1, %entry
  %68 = phi i64 [ %.pre, %entry ], [ %362, %block_.L_4122f1 ]
...
block_.L_4122c1:                                  ; preds = %block_4122cd, %block_.L_4122bc
  %197 = phi i64 [ %196, %block_.L_4122bc ], [ %320, %block_4122cd ]
...
block_.L_4122f1:                                  ; preds = %block_.L_4122c1
  ...
  %call2_4122f4 = tail call %struct.Memory* @sub_40c100._Z9check_sumIiEvT_(%struct.State* %0, i64 %326, %struct.Memory* %MEMORY.2)
...
block_.L_412307:                                  ; preds = %block_.L_41226f
  ...
  %call2_412307 = tail call %struct.Memory* @sub_400df0._Z5timerv(%struct.State* %0, i64 %363, %struct.Memory* %MEMORY.0)
  ...
  %call2_412310 = tail call %struct.Memory* @sub_400790._Z13record_resultdPKc(%struct.State* %0, i64 %374, %struct.Memory* %call2_412307)
