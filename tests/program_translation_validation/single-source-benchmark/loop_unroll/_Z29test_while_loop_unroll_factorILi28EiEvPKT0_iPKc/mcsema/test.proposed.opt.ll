...
block_.L_41229f:                                  ; preds = %block_.L_412321, %entry
  %68 = phi i64 [ %362, %block_.L_412321 ], [ %.pre, %entry ]
...
block_.L_4122bd:                                  ; preds = %block_4122ce, %block_4122af
  %111 = phi i64 [ %195, %block_4122ce ], [ %.pre9, %block_4122af ]
...
block_4122ce:                                     ; preds = %block_.L_4122bd
  ...
  %call2_4122d9 = tail call %struct.Memory* @sub_40c300._ZN15loop_inner_bodyILi28EiE7do_workERiPKii(%struct.State* nonnull %0, i64 %159, %struct.Memory* %call2_412293)
...
block_4122fd:                                     ; preds = %block_.L_4122f1
  ...
  %call2_412308 = tail call %struct.Memory* @sub_40c100._Z18complete_hash_funcIiET_S0_(%struct.State* nonnull %0, i64 %247, %struct.Memory* %call2_412293)
...
block_.L_412321:                                  ; preds = %block_.L_4122f1
  ...
  %call2_412324 = tail call %struct.Memory* @sub_40c130._Z9check_sumIiEvT_(%struct.State* nonnull %0, i64 %326, %struct.Memory* %call2_412293)
...
block_.L_412337:                                  ; preds = %block_.L_41229f
  ...
  %call2_412337 = tail call %struct.Memory* @sub_400e20._Z5timerv(%struct.State* nonnull %0, i64 %363, %struct.Memory* %call2_412293)
