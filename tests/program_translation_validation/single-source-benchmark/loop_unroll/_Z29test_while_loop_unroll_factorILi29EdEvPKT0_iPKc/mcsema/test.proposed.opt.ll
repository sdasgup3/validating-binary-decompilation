...
entry:
  ...
  %call2_4077b3 = tail call %struct.Memory* @sub_400dd0._Z11start_timerv(%struct.State* %0, i64 %58, %struct.Memory* %2)
...
block_.L_4077bf:                                  ; preds = %block_.L_407848, %entry
  %79 = phi i64 [ %.pre, %entry ], [ %346, %block_.L_407848 ]
  %MEMORY.0 = phi %struct.Memory* [ %call2_4077b3, %entry ], [ %call2_40784d, %block_.L_407848 ]
  ...
  br i1 %112, label %block_4077cf, label %block_.L_407860
...
block_.L_4077de:                                  ; preds = %block_4077ef, %block_4077cf
  %124 = phi i64 [ %.pre1, %block_4077cf ], [ %208, %block_4077ef ]
  %MEMORY.1 = phi %struct.Memory* [ %MEMORY.0, %block_4077cf ], [ %call2_4077fa, %block_4077ef ]
  ...
  br i1 %162, label %block_4077ef, label %block_.L_40780d
...
block_4077ef:                                     ; preds = %block_.L_4077de
  ...
  %call2_4077fa = tail call %struct.Memory* @sub_4016b0._ZN15loop_inner_bodyILi29EdE7do_workERdPKdi(%struct.State* %0, i64 %172, %struct.Memory* %MEMORY.1)
...
block_.L_407812:                                  ; preds = %block_40781e, %block_.L_40780d
  %210 = phi i64 [ %209, %block_.L_40780d ], [ %305, %block_40781e ]
  %211 = phi i64 [ %125, %block_.L_40780d ], [ %.pre2, %block_40781e ]
  %MEMORY.2 = phi %struct.Memory* [ %MEMORY.1, %block_.L_40780d ], [ %call2_40782b, %block_40781e ]
  %212 = add i64 %211, -44
  %213 = add i64 %210, 3
  ...
  br i1 %246, label %block_40781e, label %block_.L_407848
...
block_40781e:                                     ; preds = %block_.L_407812
  ...
  %call2_40782b = tail call %struct.Memory* @sub_401480._Z18complete_hash_funcIdET_S0_(%struct.State* %0, i64 %260, %struct.Memory* %MEMORY.2)
...
block_.L_407848:                                  ; preds = %block_.L_407812
  ...
  %call2_40784d = tail call %struct.Memory* @sub_4014b0._Z9check_sumIdEvT_(%struct.State* %0, i64 %310, %struct.Memory* %MEMORY.2)
...
block_.L_407860:                                  ; preds = %block_.L_4077bf
  ...
  %call2_407860 = tail call %struct.Memory* @sub_400df0._Z5timerv(%struct.State* %0, i64 %347, %struct.Memory* %MEMORY.0)
  ...
  %call2_407869 = tail call %struct.Memory* @sub_400790._Z13record_resultdPKc(%struct.State* %0, i64 %358, %struct.Memory* %call2_407860)
  ...
  ret %struct.Memory* %call2_407869
}
...
define %struct.Memory* @routine_jge_.L_407860(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i8* %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
...
define %struct.Memory* @routine_jge_.L_40780d(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i8* %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 2, i32 9
...
define %struct.Memory* @routine_jmpq_.L_4077de(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
...
define %struct.Memory* @routine_jmpq_.L_407812(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
...
define %struct.Memory* @routine_jge_.L_407848(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i8* %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 2, i32 9
...
define %struct.Memory* @routine_jmpq_.L_4077bf(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
