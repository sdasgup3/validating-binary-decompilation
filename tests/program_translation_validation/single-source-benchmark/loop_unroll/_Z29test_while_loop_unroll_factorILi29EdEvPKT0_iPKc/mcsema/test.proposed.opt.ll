...
block_.L_4077bf:                                  ; preds = %block_.L_407848, %entry
  %79 = phi i64 [ %.pre, %entry ], [ %350, %block_.L_407848 ]
...
block_.L_407812:                                  ; preds = %block_40781e, %block_.L_40780d
  %210 = phi i64 [ %209, %block_.L_40780d ], [ %307, %block_40781e ]
...
block_40781e:                                     ; preds = %block_.L_407812
  ...
  %call2_40782b = tail call %struct.Memory* @sub_401480._Z18complete_hash_funcIdET_S0_(%struct.State* %0, i64 %261, %struct.Memory* %MEMORY.2)
...
block_.L_407848:                                  ; preds = %block_.L_407812
  ...
  %call2_40784d = tail call %struct.Memory* @sub_4014b0._Z9check_sumIdEvT_(%struct.State* %0, i64 %313, %struct.Memory* %MEMORY.2)
...
block_.L_407860:                                  ; preds = %block_.L_4077bf
  ...
  %call2_407860 = tail call %struct.Memory* @sub_400df0._Z5timerv(%struct.State* %0, i64 %351, %struct.Memory* %MEMORY.0)
  ...
  %call2_407869 = tail call %struct.Memory* @sub_400790._Z13record_resultdPKc(%struct.State* %0, i64 %362, %struct.Memory* %call2_407860)
