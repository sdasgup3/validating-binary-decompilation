...
define %struct.Memory* @_Z29test_while_loop_unroll_factorILi29EdEvPKT0_iPKc(%struct.State* noalias, i64, %struct.Memory* noalias readnone) local_unnamed_addr #1 {
entry:
...
block_.L_4077ef:                                  ; preds = %block_.L_407878, %entry
  %74 = phi i64 [ %341, %block_.L_407878 ], [ %.pre, %entry ]
...
block_.L_40780e:                                  ; preds = %block_40781f, %block_4077ff
  %118 = phi i64 [ %202, %block_40781f ], [ %.pre9, %block_4077ff ]
...
block_40781f:                                     ; preds = %block_.L_40780e
  ...
  %call2_40782a = tail call %struct.Memory* @sub_4016e0._ZN15loop_inner_bodyILi29EdE7do_workERdPKdi(%struct.State* nonnull %0, i64 %166, %struct.Memory* %call2_4077e3)
...
block_40784e:                                     ; preds = %block_.L_407842
  ...
  %call2_40785b = tail call %struct.Memory* @sub_4014b0._Z18complete_hash_funcIdET_S0_(%struct.State* nonnull %0, i64 %253, %struct.Memory* %call2_4077e3)
...
block_.L_407878:                                  ; preds = %block_.L_407842
  ...
  %call2_40787d = tail call %struct.Memory* @sub_4014e0._Z9check_sumIdEvT_(%struct.State* nonnull %0, i64 %305, %struct.Memory* %call2_4077e3)
...
block_.L_407890:                                  ; preds = %block_.L_4077ef
  ...
  %call2_407890 = tail call %struct.Memory* @sub_400e20._Z5timerv(%struct.State* nonnull %0, i64 %342, %struct.Memory* %call2_4077e3)
