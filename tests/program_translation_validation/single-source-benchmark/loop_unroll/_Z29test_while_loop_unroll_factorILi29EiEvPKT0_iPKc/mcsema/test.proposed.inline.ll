...
define %struct.Memory* @_Z29test_while_loop_unroll_factorILi29EiEvPKT0_iPKc(%struct.State* noalias, i64, %struct.Memory* noalias) #1 {
entry:
  ...
  store %struct.Memory* %loadMem1_412173, %struct.Memory** %MEMORY
...
block_.L_41217f:                                  ; preds = %block_.L_412201, %entry
  ...
  store %struct.Memory* %loadMem_412189, %struct.Memory** %MEMORY
...
block_41218f:                                     ; preds = %block_.L_41217f
...
block_.L_41219d:                                  ; preds = %block_4121ae, %block_41218f
  ...
  store %struct.Memory* %loadMem_41219d, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_4121a3, %struct.Memory** %MEMORY
...
block_4121ae:                                     ; preds = %block_.L_41219d
  ...
  store %struct.Memory* %loadMem1_4121b9, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_4121c1, %struct.Memory** %MEMORY
...
block_.L_4121cc:                                  ; preds = %block_.L_41219d
...
block_.L_4121d1:                                  ; preds = %block_4121dd, %block_.L_4121cc
...
block_4121dd:                                     ; preds = %block_.L_4121d1
  ...
  store %struct.Memory* %loadMem1_4121e8, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_4121f6, %struct.Memory** %MEMORY
...
block_.L_412201:                                  ; preds = %block_.L_4121d1
...
block_.L_412217:                                  ; preds = %block_.L_41217f
  ...
  store %struct.Memory* %loadMem1_412217, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem1_412220, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_412225, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_41222a, %struct.Memory** %MEMORY
  ret %struct.Memory* %loadMem_41222a
}
