...
define %struct.Memory* @_Z29test_while_loop_unroll_factorILi29EiEvPKT0_iPKc(%struct.State* noalias, i64, %struct.Memory* noalias readnone) local_unnamed_addr #1 {
entry:
...
block_.L_41217f:                                  ; preds = %block_.L_412201, %entry
  %68 = phi i64 [ %362, %block_.L_412201 ], [ %.pre, %entry ]
...
block_.L_41219d:                                  ; preds = %block_4121ae, %block_41218f
  %111 = phi i64 [ %195, %block_4121ae ], [ %.pre9, %block_41218f ]
...
block_4121ae:                                     ; preds = %block_.L_41219d
  ...
  %call2_4121b9 = tail call %struct.Memory* @sub_40c2a0._ZN15loop_inner_bodyILi29EiE7do_workERiPKii(%struct.State* nonnull %0, i64 %159, %struct.Memory* %call2_412173)
...
block_4121dd:                                     ; preds = %block_.L_4121d1
  ...
  %call2_4121e8 = tail call %struct.Memory* @sub_40c100._Z18complete_hash_funcIiET_S0_(%struct.State* nonnull %0, i64 %247, %struct.Memory* %call2_412173)
...
block_.L_412201:                                  ; preds = %block_.L_4121d1
  ...
  %call2_412204 = tail call %struct.Memory* @sub_40c130._Z9check_sumIiEvT_(%struct.State* nonnull %0, i64 %326, %struct.Memory* %call2_412173)
...
block_.L_412217:                                  ; preds = %block_.L_41217f
  ...
  %call2_412217 = tail call %struct.Memory* @sub_400e20._Z5timerv(%struct.State* nonnull %0, i64 %363, %struct.Memory* %call2_412173)
