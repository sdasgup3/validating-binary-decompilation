...
entry:
  ...
  %call2_412183 = tail call %struct.Memory* @sub_400e10._Z11start_timerv(%struct.State* %0, i64 %58, %struct.Memory* %2)
...
block_.L_41218f:                                  ; preds = %block_.L_412211, %entry
  %68 = phi i64 [ %362, %block_.L_412211 ], [ %.pre, %entry ]
  ...
  br i1 %101, label %block_41219f, label %block_.L_412227
...
block_.L_4121ad:                                  ; preds = %block_4121be, %block_41219f
  %111 = phi i64 [ %195, %block_4121be ], [ %.pre9, %block_41219f ]
  ...
  br i1 %149, label %block_4121be, label %block_.L_4121dc
...
block_4121be:                                     ; preds = %block_.L_4121ad
  ...
  %call2_4121c9 = tail call %struct.Memory* @sub_40c2b0._ZN15loop_inner_bodyILi29EiE7do_workERiPKii(%struct.State* nonnull %0, i64 %159, %struct.Memory* %call2_412183)
...
block_.L_4121e1:                                  ; preds = %block_4121ed, %block_.L_4121dc
  %197 = phi i64 [ %112, %block_.L_4121dc ], [ %.pre10, %block_4121ed ]
  %storemerge = phi i64 [ %196, %block_.L_4121dc ], [ %319, %block_4121ed ]
  %198 = add i64 %197, -36
  ...
  br i1 %232, label %block_4121ed, label %block_.L_412211
...
block_4121ed:                                     ; preds = %block_.L_4121e1
  ...
  %call2_4121f8 = tail call %struct.Memory* @sub_40c110._Z18complete_hash_funcIiET_S0_(%struct.State* nonnull %0, i64 %247, %struct.Memory* %call2_412183)
...
block_.L_412211:                                  ; preds = %block_.L_4121e1
  ...
  %call2_412214 = tail call %struct.Memory* @sub_40c140._Z9check_sumIiEvT_(%struct.State* nonnull %0, i64 %326, %struct.Memory* %call2_412183)
...
block_.L_412227:                                  ; preds = %block_.L_41218f
  ...
  %call2_412227 = tail call %struct.Memory* @sub_400e30._Z5timerv(%struct.State* nonnull %0, i64 %363, %struct.Memory* %call2_412183)
  ...
  %call2_412230 = tail call %struct.Memory* @sub_4007d0._Z13record_resultdPKc(%struct.State* nonnull %0, i64 %374, %struct.Memory* %call2_412227)
