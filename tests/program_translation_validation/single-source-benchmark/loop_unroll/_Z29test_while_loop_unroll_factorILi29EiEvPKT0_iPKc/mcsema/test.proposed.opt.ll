...
block_.L_41214f:                                  ; preds = %block_.L_4121d1, %entry
  %68 = phi i64 [ %.pre, %entry ], [ %362, %block_.L_4121d1 ]
...
block_.L_4121a1:                                  ; preds = %block_4121ad, %block_.L_41219c
  %197 = phi i64 [ %196, %block_.L_41219c ], [ %320, %block_4121ad ]
...
block_.L_4121d1:                                  ; preds = %block_.L_4121a1
  ...
  %call2_4121d4 = tail call %struct.Memory* @sub_40c100._Z9check_sumIiEvT_(%struct.State* %0, i64 %326, %struct.Memory* %MEMORY.2)
...
block_.L_4121e7:                                  ; preds = %block_.L_41214f
  ...
  %call2_4121e7 = tail call %struct.Memory* @sub_400df0._Z5timerv(%struct.State* %0, i64 %363, %struct.Memory* %MEMORY.0)
  ...
  %call2_4121f0 = tail call %struct.Memory* @sub_400790._Z13record_resultdPKc(%struct.State* %0, i64 %374, %struct.Memory* %call2_4121e7)
