...
define %struct.Memory* @_Z29test_while_loop_unroll_factorILi2EdEvPKT0_iPKc(%struct.State* noalias, i64, %struct.Memory* noalias) #1 {
entry:
  ...
  store i32 %93, i32* %97
  store %struct.Memory* %loadMem_4097dc, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem1_4097e3, %struct.Memory** %MEMORY
  ...
  store i32 0, i32* %137
  store %struct.Memory* %loadMem_4097e8, %struct.Memory** %MEMORY
  br label %block_.L_4097ef

block_.L_4097ef:                                  ; preds = %block_.L_409878, %entry
  ...
  store %struct.Memory* %loadMem_4097f2, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_4097f9, %struct.Memory** %MEMORY
...
block_4097ff:                                     ; preds = %block_.L_4097ef
  ...
  store i32 0, i32* %278
  store %struct.Memory* %loadMem_409807, %struct.Memory** %MEMORY
  br label %block_.L_40980e

block_.L_40980e:                                  ; preds = %block_40981f, %block_4097ff
  ...
  store %struct.Memory* %loadMem_409817, %struct.Memory** %MEMORY
...
block_40981f:                                     ; preds = %block_.L_40980e
  ...
  store %struct.Memory* %loadMem1_40982a, %struct.Memory** %MEMORY
...
block_.L_40983d:                                  ; preds = %block_.L_40980e
...
block_.L_409842:                                  ; preds = %block_40984e, %block_.L_40983d
  ...
  store %struct.Memory* %loadMem_409845, %struct.Memory** %MEMORY
...
block_40984e:                                     ; preds = %block_.L_409842
  ...
  store %struct.Memory* %loadMem1_40985b, %struct.Memory** %MEMORY
...
block_.L_409878:                                  ; preds = %block_.L_409842
  ...
  store %struct.Memory* %loadMem1_40987d, %struct.Memory** %MEMORY
...
block_.L_409890:                                  ; preds = %block_.L_4097ef
  ...
  store %struct.Memory* %loadMem1_409890, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem1_409899, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_40989e, %struct.Memory** %MEMORY
  ...
  ret %struct.Memory* %loadMem_4098a3
}
