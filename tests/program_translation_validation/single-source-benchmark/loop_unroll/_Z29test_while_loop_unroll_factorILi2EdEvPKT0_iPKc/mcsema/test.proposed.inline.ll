...
define %struct.Memory* @_Z29test_while_loop_unroll_factorILi2EdEvPKT0_iPKc(%struct.State* noalias, i64, %struct.Memory* noalias) #2 {
entry:
  ...
  store %struct.Memory* %loadMem_4097a1, %struct.Memory** %MEMORY
  ...
  store i64 %78, i64* %81
  store %struct.Memory* %loadMem_4097a8, %struct.Memory** %MEMORY
  ...
  store i32 %93, i32* %97
  store %struct.Memory* %loadMem_4097ac, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_4097af, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem1_4097b3, %struct.Memory** %MEMORY
  ...
  store i32 0, i32* %137
  store %struct.Memory* %loadMem_4097b8, %struct.Memory** %MEMORY
  br label %block_.L_4097bf

block_.L_4097bf:                                  ; preds = %block_.L_409848, %entry
  ...
  store %struct.Memory* %loadMem_4097c2, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_4097c9, %struct.Memory** %MEMORY
...
block_4097cf:                                     ; preds = %block_.L_4097bf
...
block_.L_4097de:                                  ; preds = %block_4097ef, %block_4097cf
  ...
  store %struct.Memory* %loadMem_4097de, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_4097e4, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_4097e7, %struct.Memory** %MEMORY
...
block_4097ef:                                     ; preds = %block_.L_4097de
  ...
  store %struct.Memory* %loadMem1_4097fa, %struct.Memory** %MEMORY
...
block_.L_40980d:                                  ; preds = %block_.L_4097de
...
block_.L_409812:                                  ; preds = %block_40981e, %block_.L_40980d
...
block_40981e:                                     ; preds = %block_.L_409812
  ...
  store %struct.Memory* %loadMem_40981e, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem1_40982b, %struct.Memory** %MEMORY
...
block_.L_409848:                                  ; preds = %block_.L_409812
  ...
  store %struct.Memory* %loadMem1_40984d, %struct.Memory** %MEMORY
...
block_.L_409860:                                  ; preds = %block_.L_4097bf
  ...
  store %struct.Memory* %loadMem1_409860, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem1_409869, %struct.Memory** %MEMORY
  ...
  ret %struct.Memory* %loadMem_409873
}
