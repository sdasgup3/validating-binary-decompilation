...
entry:
  ...
  %call2_4097b3 = tail call %struct.Memory* @sub_400dd0._Z11start_timerv(%struct.State* %0, i64 %58, %struct.Memory* %2)
...
block_.L_4097bf:                                  ; preds = %block_.L_409848, %entry
  %79 = phi i64 [ %.pre, %entry ], [ %345, %block_.L_409848 ]
  %MEMORY.0 = phi %struct.Memory* [ %call2_4097b3, %entry ], [ %call2_40984d, %block_.L_409848 ]
  ...
  br i1 %112, label %block_4097cf, label %block_.L_409860
...
block_.L_4097de:                                  ; preds = %block_4097ef, %block_4097cf
  %124 = phi i64 [ %.pre1, %block_4097cf ], [ %207, %block_4097ef ]
  %MEMORY.1 = phi %struct.Memory* [ %MEMORY.0, %block_4097cf ], [ %call2_4097fa, %block_4097ef ]
  ...
  br i1 %162, label %block_4097ef, label %block_.L_40980d
...
block_4097ef:                                     ; preds = %block_.L_4097de
  ...
  %call2_4097fa = tail call %struct.Memory* @sub_4020d0._ZN15loop_inner_bodyILi2EdE7do_workERdPKdi(%struct.State* %0, i64 %172, %struct.Memory* %MEMORY.1)
...
block_.L_409812:                                  ; preds = %block_40981e, %block_.L_40980d
  %209 = phi i64 [ %208, %block_.L_40980d ], [ %304, %block_40981e ]
  %210 = phi i64 [ %125, %block_.L_40980d ], [ %.pre2, %block_40981e ]
  %MEMORY.2 = phi %struct.Memory* [ %MEMORY.1, %block_.L_40980d ], [ %call2_40982b, %block_40981e ]
  %211 = add i64 %210, -44
  %212 = add i64 %209, 3
  ...
  br i1 %245, label %block_40981e, label %block_.L_409848
...
block_40981e:                                     ; preds = %block_.L_409812
  ...
  %call2_40982b = tail call %struct.Memory* @sub_401480._Z18complete_hash_funcIdET_S0_(%struct.State* %0, i64 %259, %struct.Memory* %MEMORY.2)
...
block_.L_409848:                                  ; preds = %block_.L_409812
  ...
  %call2_40984d = tail call %struct.Memory* @sub_4014b0._Z9check_sumIdEvT_(%struct.State* %0, i64 %309, %struct.Memory* %MEMORY.2)
...
block_.L_409860:                                  ; preds = %block_.L_4097bf
  ...
  %call2_409860 = tail call %struct.Memory* @sub_400df0._Z5timerv(%struct.State* %0, i64 %346, %struct.Memory* %MEMORY.0)
  ...
  %call2_409869 = tail call %struct.Memory* @sub_400790._Z13record_resultdPKc(%struct.State* %0, i64 %357, %struct.Memory* %call2_409860)
  ...
  ret %struct.Memory* %call2_409869
}
...
define %struct.Memory* @routine_jge_.L_409860(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i8* %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
...
define %struct.Memory* @routine_jge_.L_40980d(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i8* %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 2, i32 9
...
define %struct.Memory* @routine_jmpq_.L_4097de(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
...
define %struct.Memory* @routine_jmpq_.L_409812(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
...
define %struct.Memory* @routine_jge_.L_409848(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i8* %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 2, i32 9
...
define %struct.Memory* @routine_jmpq_.L_4097bf(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
