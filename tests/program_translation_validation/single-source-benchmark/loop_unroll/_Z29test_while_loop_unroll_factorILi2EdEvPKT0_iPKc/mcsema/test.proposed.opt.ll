...
entry:
  ...
  %call2_4097f3 = tail call %struct.Memory* @sub_400e10._Z11start_timerv(%struct.State* %0, i64 %58, %struct.Memory* %2)
...
block_.L_4097ff:                                  ; preds = %block_.L_409888, %entry
  %74 = phi i64 [ %340, %block_.L_409888 ], [ %.pre, %entry ]
  ...
  br i1 %107, label %block_40980f, label %block_.L_4098a0
...
block_.L_40981e:                                  ; preds = %block_40982f, %block_40980f
  %118 = phi i64 [ %201, %block_40982f ], [ %.pre9, %block_40980f ]
  ...
  br i1 %156, label %block_40982f, label %block_.L_40984d
...
block_40982f:                                     ; preds = %block_.L_40981e
  ...
  %call2_40983a = tail call %struct.Memory* @sub_402110._ZN15loop_inner_bodyILi2EdE7do_workERdPKdi(%struct.State* nonnull %0, i64 %166, %struct.Memory* %call2_4097f3)
...
block_.L_409852:                                  ; preds = %block_40985e, %block_.L_40984d
  %203 = phi i64 [ %119, %block_.L_40984d ], [ %.pre10, %block_40985e ]
  %storemerge = phi i64 [ %202, %block_.L_40984d ], [ %298, %block_40985e ]
  %204 = add i64 %203, -44
  ...
  br i1 %238, label %block_40985e, label %block_.L_409888
...
block_40985e:                                     ; preds = %block_.L_409852
  ...
  %call2_40986b = tail call %struct.Memory* @sub_4014c0._Z18complete_hash_funcIdET_S0_(%struct.State* nonnull %0, i64 %252, %struct.Memory* %call2_4097f3)
...
block_.L_409888:                                  ; preds = %block_.L_409852
  ...
  %call2_40988d = tail call %struct.Memory* @sub_4014f0._Z9check_sumIdEvT_(%struct.State* nonnull %0, i64 %304, %struct.Memory* %call2_4097f3)
...
block_.L_4098a0:                                  ; preds = %block_.L_4097ff
  ...
  %call2_4098a0 = tail call %struct.Memory* @sub_400e30._Z5timerv(%struct.State* nonnull %0, i64 %341, %struct.Memory* %call2_4097f3)
  ...
  %call2_4098a9 = tail call %struct.Memory* @sub_4007d0._Z13record_resultdPKc(%struct.State* nonnull %0, i64 %352, %struct.Memory* %call2_4098a0)
