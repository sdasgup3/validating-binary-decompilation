...
block_.L_4097bf:                                  ; preds = %block_.L_409848, %entry
  %79 = phi i64 [ %.pre, %entry ], [ %349, %block_.L_409848 ]
...
block_.L_409812:                                  ; preds = %block_40981e, %block_.L_40980d
  %209 = phi i64 [ %208, %block_.L_40980d ], [ %306, %block_40981e ]
...
block_40981e:                                     ; preds = %block_.L_409812
  ...
  %call2_40982b = tail call %struct.Memory* @sub_401480._Z18complete_hash_funcIdET_S0_(%struct.State* %0, i64 %260, %struct.Memory* %MEMORY.2)
...
block_.L_409848:                                  ; preds = %block_.L_409812
  ...
  %call2_40984d = tail call %struct.Memory* @sub_4014b0._Z9check_sumIdEvT_(%struct.State* %0, i64 %312, %struct.Memory* %MEMORY.2)
...
block_.L_409860:                                  ; preds = %block_.L_4097bf
  ...
  %call2_409860 = tail call %struct.Memory* @sub_400df0._Z5timerv(%struct.State* %0, i64 %350, %struct.Memory* %MEMORY.0)
  ...
  %call2_409869 = tail call %struct.Memory* @sub_400790._Z13record_resultdPKc(%struct.State* %0, i64 %361, %struct.Memory* %call2_409860)
