...
entry:
  ...
  %call2_413fd3 = tail call %struct.Memory* @sub_400e10._Z11start_timerv(%struct.State* %0, i64 %58, %struct.Memory* %2)
...
block_.L_413fdf:                                  ; preds = %block_.L_414061, %entry
  %68 = phi i64 [ %361, %block_.L_414061 ], [ %.pre, %entry ]
  ...
  br i1 %101, label %block_413fef, label %block_.L_414077
...
block_.L_413ffd:                                  ; preds = %block_41400e, %block_413fef
  %111 = phi i64 [ %194, %block_41400e ], [ %.pre9, %block_413fef ]
  ...
  br i1 %149, label %block_41400e, label %block_.L_41402c
...
block_41400e:                                     ; preds = %block_.L_413ffd
  ...
  %call2_414019 = tail call %struct.Memory* @sub_40ccd0._ZN15loop_inner_bodyILi2EiE7do_workERiPKii(%struct.State* nonnull %0, i64 %159, %struct.Memory* %call2_413fd3)
...
block_.L_414031:                                  ; preds = %block_41403d, %block_.L_41402c
  %196 = phi i64 [ %112, %block_.L_41402c ], [ %.pre10, %block_41403d ]
  %storemerge = phi i64 [ %195, %block_.L_41402c ], [ %318, %block_41403d ]
  %197 = add i64 %196, -36
  ...
  br i1 %231, label %block_41403d, label %block_.L_414061
...
block_41403d:                                     ; preds = %block_.L_414031
  ...
  %call2_414048 = tail call %struct.Memory* @sub_40c110._Z18complete_hash_funcIiET_S0_(%struct.State* nonnull %0, i64 %246, %struct.Memory* %call2_413fd3)
...
block_.L_414061:                                  ; preds = %block_.L_414031
  ...
  %call2_414064 = tail call %struct.Memory* @sub_40c140._Z9check_sumIiEvT_(%struct.State* nonnull %0, i64 %325, %struct.Memory* %call2_413fd3)
...
block_.L_414077:                                  ; preds = %block_.L_413fdf
  ...
  %call2_414077 = tail call %struct.Memory* @sub_400e30._Z5timerv(%struct.State* nonnull %0, i64 %362, %struct.Memory* %call2_413fd3)
  ...
  %call2_414080 = tail call %struct.Memory* @sub_4007d0._Z13record_resultdPKc(%struct.State* nonnull %0, i64 %373, %struct.Memory* %call2_414077)
