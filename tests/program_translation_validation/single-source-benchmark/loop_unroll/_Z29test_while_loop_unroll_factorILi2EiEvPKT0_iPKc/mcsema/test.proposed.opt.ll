...
block_.L_413f9f:                                  ; preds = %block_.L_414021, %entry
  %68 = phi i64 [ %.pre, %entry ], [ %363, %block_.L_414021 ]
...
block_.L_413ff1:                                  ; preds = %block_413ffd, %block_.L_413fec
  %196 = phi i64 [ %195, %block_.L_413fec ], [ %320, %block_413ffd ]
...
block_.L_414021:                                  ; preds = %block_.L_413ff1
  ...
  %call2_414024 = tail call %struct.Memory* @sub_40c100._Z9check_sumIiEvT_(%struct.State* %0, i64 %326, %struct.Memory* %MEMORY.2)
...
block_.L_414037:                                  ; preds = %block_.L_413f9f
  ...
  %call2_414037 = tail call %struct.Memory* @sub_400df0._Z5timerv(%struct.State* %0, i64 %364, %struct.Memory* %MEMORY.0)
  ...
  %call2_414040 = tail call %struct.Memory* @sub_400790._Z13record_resultdPKc(%struct.State* %0, i64 %375, %struct.Memory* %call2_414037)
