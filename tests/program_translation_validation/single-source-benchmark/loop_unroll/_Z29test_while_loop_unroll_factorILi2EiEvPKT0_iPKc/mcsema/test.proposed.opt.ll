...
entry:
  ...
  %call2_413f93 = tail call %struct.Memory* @sub_400dd0._Z11start_timerv(%struct.State* %0, i64 %58, %struct.Memory* %2)
...
block_.L_413f9f:                                  ; preds = %block_.L_414021, %entry
  %68 = phi i64 [ %.pre, %entry ], [ %361, %block_.L_414021 ]
  %MEMORY.0 = phi %struct.Memory* [ %call2_413f93, %entry ], [ %call2_414024, %block_.L_414021 ]
  ...
  br i1 %101, label %block_413faf, label %block_.L_414037
...
block_.L_413fbd:                                  ; preds = %block_413fce, %block_413faf
  %111 = phi i64 [ %.pre1, %block_413faf ], [ %194, %block_413fce ]
  %MEMORY.1 = phi %struct.Memory* [ %MEMORY.0, %block_413faf ], [ %call2_413fd9, %block_413fce ]
  ...
  br i1 %149, label %block_413fce, label %block_.L_413fec
...
block_413fce:                                     ; preds = %block_.L_413fbd
  ...
  %call2_413fd9 = tail call %struct.Memory* @sub_40cc90._ZN15loop_inner_bodyILi2EiE7do_workERiPKii(%struct.State* %0, i64 %159, %struct.Memory* %MEMORY.1)
...
block_.L_413ff1:                                  ; preds = %block_413ffd, %block_.L_413fec
  %196 = phi i64 [ %195, %block_.L_413fec ], [ %319, %block_413ffd ]
  %197 = phi i64 [ %112, %block_.L_413fec ], [ %.pre2, %block_413ffd ]
  %MEMORY.2 = phi %struct.Memory* [ %MEMORY.1, %block_.L_413fec ], [ %call2_414008, %block_413ffd ]
  %198 = add i64 %197, -36
  %199 = add i64 %196, 3
  ...
  br i1 %232, label %block_413ffd, label %block_.L_414021
...
block_413ffd:                                     ; preds = %block_.L_413ff1
  ...
  %call2_414008 = tail call %struct.Memory* @sub_40c0d0._Z18complete_hash_funcIiET_S0_(%struct.State* %0, i64 %247, %struct.Memory* %MEMORY.2)
...
block_.L_414021:                                  ; preds = %block_.L_413ff1
  ...
  %call2_414024 = tail call %struct.Memory* @sub_40c100._Z9check_sumIiEvT_(%struct.State* %0, i64 %325, %struct.Memory* %MEMORY.2)
...
block_.L_414037:                                  ; preds = %block_.L_413f9f
  ...
  %call2_414037 = tail call %struct.Memory* @sub_400df0._Z5timerv(%struct.State* %0, i64 %362, %struct.Memory* %MEMORY.0)
  ...
  %call2_414040 = tail call %struct.Memory* @sub_400790._Z13record_resultdPKc(%struct.State* %0, i64 %373, %struct.Memory* %call2_414037)
  ...
  ret %struct.Memory* %call2_414040
}
...
define %struct.Memory* @routine_jge_.L_414037(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i8* %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
...
define %struct.Memory* @routine_jge_.L_413fec(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i8* %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 2, i32 9
...
define %struct.Memory* @routine_jmpq_.L_413fbd(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
...
define %struct.Memory* @routine_jmpq_.L_413ff1(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
...
define %struct.Memory* @routine_jge_.L_414021(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i8* %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 2, i32 9
...
define %struct.Memory* @routine_jmpq_.L_413f9f(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
