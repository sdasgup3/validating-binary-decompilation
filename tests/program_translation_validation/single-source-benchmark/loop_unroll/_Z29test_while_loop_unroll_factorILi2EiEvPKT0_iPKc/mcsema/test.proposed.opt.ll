...
define %struct.Memory* @_Z29test_while_loop_unroll_factorILi2EiEvPKT0_iPKc(%struct.State* noalias, i64, %struct.Memory* noalias readnone) local_unnamed_addr #1 {
entry:
...
block_.L_413fcf:                                  ; preds = %block_.L_414051, %entry
  %68 = phi i64 [ %361, %block_.L_414051 ], [ %.pre, %entry ]
...
block_.L_413fed:                                  ; preds = %block_413ffe, %block_413fdf
  %111 = phi i64 [ %194, %block_413ffe ], [ %.pre9, %block_413fdf ]
...
block_413ffe:                                     ; preds = %block_.L_413fed
  ...
  %call2_414009 = tail call %struct.Memory* @sub_40ccc0._ZN15loop_inner_bodyILi2EiE7do_workERiPKii(%struct.State* nonnull %0, i64 %159, %struct.Memory* %call2_413fc3)
...
block_41402d:                                     ; preds = %block_.L_414021
  ...
  %call2_414038 = tail call %struct.Memory* @sub_40c100._Z18complete_hash_funcIiET_S0_(%struct.State* nonnull %0, i64 %246, %struct.Memory* %call2_413fc3)
...
block_.L_414051:                                  ; preds = %block_.L_414021
  ...
  %call2_414054 = tail call %struct.Memory* @sub_40c130._Z9check_sumIiEvT_(%struct.State* nonnull %0, i64 %325, %struct.Memory* %call2_413fc3)
...
block_.L_414067:                                  ; preds = %block_.L_413fcf
  ...
  %call2_414067 = tail call %struct.Memory* @sub_400e20._Z5timerv(%struct.State* nonnull %0, i64 %362, %struct.Memory* %call2_413fc3)
