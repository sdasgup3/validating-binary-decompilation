...
entry:
  ...
  %call2_407683 = tail call %struct.Memory* @sub_400dd0._Z11start_timerv(%struct.State* %0, i64 %58, %struct.Memory* %2)
...
block_.L_40768f:                                  ; preds = %block_.L_407718, %entry
  %79 = phi i64 [ %.pre, %entry ], [ %350, %block_.L_407718 ]
  %MEMORY.0 = phi %struct.Memory* [ %call2_407683, %entry ], [ %call2_40771d, %block_.L_407718 ]
  ...
  br i1 %112, label %block_40769f, label %block_.L_407730

block_40769f:                                     ; preds = %block_.L_40768f
  ...
  br label %block_.L_4076ae

block_.L_4076ae:                                  ; preds = %block_4076bf, %block_40769f
  %124 = phi i64 [ %.pre1, %block_40769f ], [ %208, %block_4076bf ]
  %MEMORY.1 = phi %struct.Memory* [ %MEMORY.0, %block_40769f ], [ %call2_4076ca, %block_4076bf ]
  ...
  br i1 %162, label %block_4076bf, label %block_.L_4076dd

block_4076bf:                                     ; preds = %block_.L_4076ae
  %164 = add i64 %125, -40
  ...
  %call2_4076ca = tail call %struct.Memory* @sub_401650._ZN15loop_inner_bodyILi30EdE7do_workERdPKdi(%struct.State* %0, i64 %172, %struct.Memory* %MEMORY.1)
...
block_.L_4076dd:                                  ; preds = %block_.L_4076ae
  %209 = add i64 %163, 5
  store i64 %209, i64* %3, align 8
  br label %block_.L_4076e2

block_.L_4076e2:                                  ; preds = %block_4076ee, %block_.L_4076dd
  %210 = phi i64 [ %209, %block_.L_4076dd ], [ %307, %block_4076ee ]
  %211 = phi i64 [ %125, %block_.L_4076dd ], [ %.pre2, %block_4076ee ]
  %MEMORY.2 = phi %struct.Memory* [ %MEMORY.1, %block_.L_4076dd ], [ %call2_4076fb, %block_4076ee ]
  %212 = add i64 %211, -44
  %213 = add i64 %210, 3
  ...
  br i1 %246, label %block_4076ee, label %block_.L_407718

block_4076ee:                                     ; preds = %block_.L_4076e2
  %248 = add i64 %211, -8
  %249 = add i64 %247, 4
  ...
  %call2_4076fb = tail call %struct.Memory* @sub_401480._Z18complete_hash_funcIdET_S0_(%struct.State* %0, i64 %261, %struct.Memory* %MEMORY.2)
...
block_.L_407718:                                  ; preds = %block_.L_4076e2
  %308 = add i64 %211, -40
  %309 = add i64 %247, 5
  ...
  %call2_40771d = tail call %struct.Memory* @sub_4014b0._Z9check_sumIdEvT_(%struct.State* %0, i64 %313, %struct.Memory* %MEMORY.2)
...
block_.L_407730:                                  ; preds = %block_.L_40768f
  %351 = add i64 %113, -26944
  %352 = add i64 %113, 5
  ...
  %call2_407730 = tail call %struct.Memory* @sub_400df0._Z5timerv(%struct.State* %0, i64 %351, %struct.Memory* %MEMORY.0)
  ...
  %call2_407739 = tail call %struct.Memory* @sub_400790._Z13record_resultdPKc(%struct.State* %0, i64 %362, %struct.Memory* %call2_407730)
  ...
  ret %struct.Memory* %call2_407739
}
...
define %struct.Memory* @routine_jge_.L_407730(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i8* %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
...
define %struct.Memory* @routine_jge_.L_4076dd(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i8* %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 2, i32 9
...
define %struct.Memory* @routine_jmpq_.L_4076ae(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
...
define %struct.Memory* @routine_jmpq_.L_4076e2(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
...
define %struct.Memory* @routine_jge_.L_407718(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i8* %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 2, i32 9
...
define %struct.Memory* @routine_jmpq_.L_40768f(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
