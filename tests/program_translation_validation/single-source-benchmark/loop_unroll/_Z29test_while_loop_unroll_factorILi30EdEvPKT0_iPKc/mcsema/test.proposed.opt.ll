...
define %struct.Memory* @_Z29test_while_loop_unroll_factorILi30EdEvPKT0_iPKc(%struct.State* noalias, i64, %struct.Memory* noalias readnone) local_unnamed_addr #1 {
entry:
...
block_.L_4076bf:                                  ; preds = %block_.L_407748, %entry
  %74 = phi i64 [ %341, %block_.L_407748 ], [ %.pre, %entry ]
...
block_.L_4076de:                                  ; preds = %block_4076ef, %block_4076cf
  %118 = phi i64 [ %202, %block_4076ef ], [ %.pre9, %block_4076cf ]
...
block_4076ef:                                     ; preds = %block_.L_4076de
  ...
  %call2_4076fa = tail call %struct.Memory* @sub_401680._ZN15loop_inner_bodyILi30EdE7do_workERdPKdi(%struct.State* nonnull %0, i64 %166, %struct.Memory* %call2_4076b3)
...
block_40771e:                                     ; preds = %block_.L_407712
  ...
  %call2_40772b = tail call %struct.Memory* @sub_4014b0._Z18complete_hash_funcIdET_S0_(%struct.State* nonnull %0, i64 %253, %struct.Memory* %call2_4076b3)
...
block_.L_407748:                                  ; preds = %block_.L_407712
  ...
  %call2_40774d = tail call %struct.Memory* @sub_4014e0._Z9check_sumIdEvT_(%struct.State* nonnull %0, i64 %305, %struct.Memory* %call2_4076b3)
...
block_.L_407760:                                  ; preds = %block_.L_4076bf
  ...
  %call2_407760 = tail call %struct.Memory* @sub_400e20._Z5timerv(%struct.State* nonnull %0, i64 %342, %struct.Memory* %call2_4076b3)
