...
block_.L_40768f:                                  ; preds = %block_.L_407718, %entry
  %79 = phi i64 [ %.pre, %entry ], [ %346, %block_.L_407718 ]
...
block_.L_4076e2:                                  ; preds = %block_4076ee, %block_.L_4076dd
  %210 = phi i64 [ %209, %block_.L_4076dd ], [ %305, %block_4076ee ]
...
block_4076ee:                                     ; preds = %block_.L_4076e2
  ...
  %call2_4076fb = tail call %struct.Memory* @sub_401480._Z18complete_hash_funcIdET_S0_(%struct.State* %0, i64 %260, %struct.Memory* %MEMORY.2)
...
block_.L_407718:                                  ; preds = %block_.L_4076e2
  ...
  %call2_40771d = tail call %struct.Memory* @sub_4014b0._Z9check_sumIdEvT_(%struct.State* %0, i64 %310, %struct.Memory* %MEMORY.2)
...
block_.L_407730:                                  ; preds = %block_.L_40768f
  ...
  %call2_407730 = tail call %struct.Memory* @sub_400df0._Z5timerv(%struct.State* %0, i64 %347, %struct.Memory* %MEMORY.0)
  ...
  %call2_407739 = tail call %struct.Memory* @sub_400790._Z13record_resultdPKc(%struct.State* %0, i64 %358, %struct.Memory* %call2_407730)
