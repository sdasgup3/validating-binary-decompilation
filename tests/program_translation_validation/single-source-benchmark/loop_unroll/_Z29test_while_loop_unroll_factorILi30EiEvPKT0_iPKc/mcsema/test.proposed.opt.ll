...
define %struct.Memory* @_Z29test_while_loop_unroll_factorILi30EiEvPKT0_iPKc(%struct.State* noalias, i64, %struct.Memory* noalias readnone) local_unnamed_addr #1 {
entry:
...
block_.L_41205f:                                  ; preds = %block_.L_4120e1, %entry
  %68 = phi i64 [ %362, %block_.L_4120e1 ], [ %.pre, %entry ]
...
block_.L_41207d:                                  ; preds = %block_41208e, %block_41206f
  %111 = phi i64 [ %195, %block_41208e ], [ %.pre9, %block_41206f ]
...
block_41208e:                                     ; preds = %block_.L_41207d
  ...
  %call2_412099 = tail call %struct.Memory* @sub_40c240._ZN15loop_inner_bodyILi30EiE7do_workERiPKii(%struct.State* nonnull %0, i64 %159, %struct.Memory* %call2_412053)
...
block_4120bd:                                     ; preds = %block_.L_4120b1
  ...
  %call2_4120c8 = tail call %struct.Memory* @sub_40c100._Z18complete_hash_funcIiET_S0_(%struct.State* nonnull %0, i64 %247, %struct.Memory* %call2_412053)
...
block_.L_4120e1:                                  ; preds = %block_.L_4120b1
  ...
  %call2_4120e4 = tail call %struct.Memory* @sub_40c130._Z9check_sumIiEvT_(%struct.State* nonnull %0, i64 %326, %struct.Memory* %call2_412053)
...
block_.L_4120f7:                                  ; preds = %block_.L_41205f
  ...
  %call2_4120f7 = tail call %struct.Memory* @sub_400e20._Z5timerv(%struct.State* nonnull %0, i64 %363, %struct.Memory* %call2_412053)
