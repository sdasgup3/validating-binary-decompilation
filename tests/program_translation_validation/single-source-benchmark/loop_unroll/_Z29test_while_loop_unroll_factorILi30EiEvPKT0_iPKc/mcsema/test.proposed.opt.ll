...
block_.L_41202f:                                  ; preds = %block_.L_4120b1, %entry
  %68 = phi i64 [ %.pre, %entry ], [ %362, %block_.L_4120b1 ]
...
block_.L_412081:                                  ; preds = %block_41208d, %block_.L_41207c
  %197 = phi i64 [ %196, %block_.L_41207c ], [ %320, %block_41208d ]
...
block_.L_4120b1:                                  ; preds = %block_.L_412081
  ...
  %call2_4120b4 = tail call %struct.Memory* @sub_40c100._Z9check_sumIiEvT_(%struct.State* %0, i64 %326, %struct.Memory* %MEMORY.2)
...
block_.L_4120c7:                                  ; preds = %block_.L_41202f
  ...
  %call2_4120c7 = tail call %struct.Memory* @sub_400df0._Z5timerv(%struct.State* %0, i64 %363, %struct.Memory* %MEMORY.0)
  ...
  %call2_4120d0 = tail call %struct.Memory* @sub_400790._Z13record_resultdPKc(%struct.State* %0, i64 %374, %struct.Memory* %call2_4120c7)
