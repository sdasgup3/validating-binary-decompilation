...
entry:
  ...
  %call2_412063 = tail call %struct.Memory* @sub_400e10._Z11start_timerv(%struct.State* %0, i64 %58, %struct.Memory* %2)
  ...
  br label %block_.L_41206f

block_.L_41206f:                                  ; preds = %block_.L_4120f1, %entry
  %68 = phi i64 [ %362, %block_.L_4120f1 ], [ %.pre, %entry ]
  ...
  br i1 %101, label %block_41207f, label %block_.L_412107

block_41207f:                                     ; preds = %block_.L_41206f
  %103 = add i64 %69, -32
  %104 = add i64 %102, 7
  ...
  br label %block_.L_41208d

block_.L_41208d:                                  ; preds = %block_41209e, %block_41207f
  %111 = phi i64 [ %195, %block_41209e ], [ %.pre9, %block_41207f ]
  ...
  br i1 %149, label %block_41209e, label %block_.L_4120bc

block_41209e:                                     ; preds = %block_.L_41208d
  %151 = add i64 %112, -32
  ...
  %call2_4120a9 = tail call %struct.Memory* @sub_40c250._ZN15loop_inner_bodyILi30EiE7do_workERiPKii(%struct.State* nonnull %0, i64 %159, %struct.Memory* %call2_412063)
...
block_.L_4120bc:                                  ; preds = %block_.L_41208d
  %196 = add i64 %150, 5
  br label %block_.L_4120c1

block_.L_4120c1:                                  ; preds = %block_4120cd, %block_.L_4120bc
  %197 = phi i64 [ %112, %block_.L_4120bc ], [ %.pre10, %block_4120cd ]
  %storemerge = phi i64 [ %196, %block_.L_4120bc ], [ %319, %block_4120cd ]
  %198 = add i64 %197, -36
  ...
  br i1 %232, label %block_4120cd, label %block_.L_4120f1

block_4120cd:                                     ; preds = %block_.L_4120c1
  %234 = add i64 %197, -8
  %235 = add i64 %233, 4
  ...
  %call2_4120d8 = tail call %struct.Memory* @sub_40c110._Z18complete_hash_funcIiET_S0_(%struct.State* nonnull %0, i64 %247, %struct.Memory* %call2_412063)
...
block_.L_4120f1:                                  ; preds = %block_.L_4120c1
  %321 = add i64 %197, -32
  %322 = add i64 %233, 3
  ...
  %call2_4120f4 = tail call %struct.Memory* @sub_40c140._Z9check_sumIiEvT_(%struct.State* nonnull %0, i64 %326, %struct.Memory* %call2_412063)
...
block_.L_412107:                                  ; preds = %block_.L_41206f
  ...
  %call2_412107 = tail call %struct.Memory* @sub_400e30._Z5timerv(%struct.State* nonnull %0, i64 %363, %struct.Memory* %call2_412063)
  ...
  %call2_412110 = tail call %struct.Memory* @sub_4007d0._Z13record_resultdPKc(%struct.State* nonnull %0, i64 %374, %struct.Memory* %call2_412107)
  ...
  ret %struct.Memory* %call2_412110
}
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_jge_.L_412107(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i8* nocapture %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_jge_.L_4120bc(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i8* nocapture %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 2, i32 9
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_jmpq_.L_41208d(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_jmpq_.L_4120c1(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_jge_.L_4120f1(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i8* nocapture %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 2, i32 9
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_jmpq_.L_41206f(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
