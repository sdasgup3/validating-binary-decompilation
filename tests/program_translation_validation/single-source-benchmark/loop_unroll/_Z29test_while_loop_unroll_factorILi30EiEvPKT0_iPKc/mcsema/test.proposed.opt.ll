...
entry:
  ...
  %call2_412023 = tail call %struct.Memory* @sub_400dd0._Z11start_timerv(%struct.State* %0, i64 %58, %struct.Memory* %2)
  ...
  br label %block_.L_41202f

block_.L_41202f:                                  ; preds = %block_.L_4120b1, %entry
  %68 = phi i64 [ %.pre, %entry ], [ %364, %block_.L_4120b1 ]
  %MEMORY.0 = phi %struct.Memory* [ %call2_412023, %entry ], [ %call2_4120b4, %block_.L_4120b1 ]
  ...
  br i1 %101, label %block_41203f, label %block_.L_4120c7

block_41203f:                                     ; preds = %block_.L_41202f
  %103 = add i64 %69, -32
  %104 = add i64 %102, 7
  ...
  br label %block_.L_41204d

block_.L_41204d:                                  ; preds = %block_41205e, %block_41203f
  %111 = phi i64 [ %.pre1, %block_41203f ], [ %195, %block_41205e ]
  %MEMORY.1 = phi %struct.Memory* [ %MEMORY.0, %block_41203f ], [ %call2_412069, %block_41205e ]
  ...
  br i1 %149, label %block_41205e, label %block_.L_41207c

block_41205e:                                     ; preds = %block_.L_41204d
  %151 = add i64 %112, -32
  ...
  %call2_412069 = tail call %struct.Memory* @sub_40c210._ZN15loop_inner_bodyILi30EiE7do_workERiPKii(%struct.State* %0, i64 %159, %struct.Memory* %MEMORY.1)
...
block_.L_41207c:                                  ; preds = %block_.L_41204d
  %196 = add i64 %150, 5
  store i64 %196, i64* %3, align 8
  br label %block_.L_412081

block_.L_412081:                                  ; preds = %block_41208d, %block_.L_41207c
  %197 = phi i64 [ %196, %block_.L_41207c ], [ %321, %block_41208d ]
  %198 = phi i64 [ %112, %block_.L_41207c ], [ %.pre2, %block_41208d ]
  %MEMORY.2 = phi %struct.Memory* [ %MEMORY.1, %block_.L_41207c ], [ %call2_412098, %block_41208d ]
  %199 = add i64 %198, -36
  %200 = add i64 %197, 3
  ...
  br i1 %233, label %block_41208d, label %block_.L_4120b1

block_41208d:                                     ; preds = %block_.L_412081
  %235 = add i64 %198, -8
  %236 = add i64 %234, 4
  ...
  %call2_412098 = tail call %struct.Memory* @sub_40c0d0._Z18complete_hash_funcIiET_S0_(%struct.State* %0, i64 %248, %struct.Memory* %MEMORY.2)
...
block_.L_4120b1:                                  ; preds = %block_.L_412081
  %322 = add i64 %198, -32
  %323 = add i64 %234, 3
  ...
  %call2_4120b4 = tail call %struct.Memory* @sub_40c100._Z9check_sumIiEvT_(%struct.State* %0, i64 %327, %struct.Memory* %MEMORY.2)
...
block_.L_4120c7:                                  ; preds = %block_.L_41202f
  %365 = add i64 %102, -70359
  %366 = add i64 %102, 5
  ...
  %call2_4120c7 = tail call %struct.Memory* @sub_400df0._Z5timerv(%struct.State* %0, i64 %365, %struct.Memory* %MEMORY.0)
  ...
  %call2_4120d0 = tail call %struct.Memory* @sub_400790._Z13record_resultdPKc(%struct.State* %0, i64 %376, %struct.Memory* %call2_4120c7)
  ...
  ret %struct.Memory* %call2_4120d0
}
...
define %struct.Memory* @routine_jge_.L_4120c7(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i8* %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
...
define %struct.Memory* @routine_jge_.L_41207c(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i8* %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 2, i32 9
...
define %struct.Memory* @routine_jmpq_.L_41204d(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
...
define %struct.Memory* @routine_jmpq_.L_412081(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
...
define %struct.Memory* @routine_jge_.L_4120b1(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i8* %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 2, i32 9
...
define %struct.Memory* @routine_jmpq_.L_41202f(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
