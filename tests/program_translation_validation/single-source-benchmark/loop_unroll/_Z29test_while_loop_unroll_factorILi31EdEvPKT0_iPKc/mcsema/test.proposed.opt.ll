...
entry:
  ...
  %call2_407593 = tail call %struct.Memory* @sub_400e10._Z11start_timerv(%struct.State* %0, i64 %58, %struct.Memory* %2)
...
block_.L_40759f:                                  ; preds = %block_.L_407628, %entry
  %74 = phi i64 [ %341, %block_.L_407628 ], [ %.pre, %entry ]
  ...
  br i1 %107, label %block_4075af, label %block_.L_407640
...
block_.L_4075be:                                  ; preds = %block_4075cf, %block_4075af
  %118 = phi i64 [ %202, %block_4075cf ], [ %.pre9, %block_4075af ]
  ...
  br i1 %156, label %block_4075cf, label %block_.L_4075ed
...
block_4075cf:                                     ; preds = %block_.L_4075be
  ...
  %call2_4075da = tail call %struct.Memory* @sub_401630._ZN15loop_inner_bodyILi31EdE7do_workERdPKdi(%struct.State* nonnull %0, i64 %166, %struct.Memory* %call2_407593)
...
block_.L_4075f2:                                  ; preds = %block_4075fe, %block_.L_4075ed
  %204 = phi i64 [ %119, %block_.L_4075ed ], [ %.pre10, %block_4075fe ]
  %storemerge = phi i64 [ %203, %block_.L_4075ed ], [ %299, %block_4075fe ]
  %205 = add i64 %204, -44
  ...
  br i1 %239, label %block_4075fe, label %block_.L_407628
...
block_4075fe:                                     ; preds = %block_.L_4075f2
  ...
  %call2_40760b = tail call %struct.Memory* @sub_4014c0._Z18complete_hash_funcIdET_S0_(%struct.State* nonnull %0, i64 %253, %struct.Memory* %call2_407593)
...
block_.L_407628:                                  ; preds = %block_.L_4075f2
  ...
  %call2_40762d = tail call %struct.Memory* @sub_4014f0._Z9check_sumIdEvT_(%struct.State* nonnull %0, i64 %305, %struct.Memory* %call2_407593)
...
block_.L_407640:                                  ; preds = %block_.L_40759f
  ...
  %call2_407640 = tail call %struct.Memory* @sub_400e30._Z5timerv(%struct.State* nonnull %0, i64 %342, %struct.Memory* %call2_407593)
  ...
  %call2_407649 = tail call %struct.Memory* @sub_4007d0._Z13record_resultdPKc(%struct.State* nonnull %0, i64 %353, %struct.Memory* %call2_407640)
