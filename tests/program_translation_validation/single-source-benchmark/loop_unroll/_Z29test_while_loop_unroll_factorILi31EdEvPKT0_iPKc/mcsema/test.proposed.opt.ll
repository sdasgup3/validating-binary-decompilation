...
entry:
  ...
  %call2_407553 = tail call %struct.Memory* @sub_400dd0._Z11start_timerv(%struct.State* %0, i64 %58, %struct.Memory* %2)
...
block_.L_40755f:                                  ; preds = %block_.L_4075e8, %entry
  %79 = phi i64 [ %.pre, %entry ], [ %346, %block_.L_4075e8 ]
  %MEMORY.0 = phi %struct.Memory* [ %call2_407553, %entry ], [ %call2_4075ed, %block_.L_4075e8 ]
  ...
  br i1 %112, label %block_40756f, label %block_.L_407600
...
block_.L_40757e:                                  ; preds = %block_40758f, %block_40756f
  %124 = phi i64 [ %.pre1, %block_40756f ], [ %208, %block_40758f ]
  %MEMORY.1 = phi %struct.Memory* [ %MEMORY.0, %block_40756f ], [ %call2_40759a, %block_40758f ]
  ...
  br i1 %162, label %block_40758f, label %block_.L_4075ad
...
block_40758f:                                     ; preds = %block_.L_40757e
  ...
  %call2_40759a = tail call %struct.Memory* @sub_4015f0._ZN15loop_inner_bodyILi31EdE7do_workERdPKdi(%struct.State* %0, i64 %172, %struct.Memory* %MEMORY.1)
...
block_.L_4075b2:                                  ; preds = %block_4075be, %block_.L_4075ad
  %210 = phi i64 [ %209, %block_.L_4075ad ], [ %305, %block_4075be ]
  %211 = phi i64 [ %125, %block_.L_4075ad ], [ %.pre2, %block_4075be ]
  %MEMORY.2 = phi %struct.Memory* [ %MEMORY.1, %block_.L_4075ad ], [ %call2_4075cb, %block_4075be ]
  %212 = add i64 %211, -44
  %213 = add i64 %210, 3
  ...
  br i1 %246, label %block_4075be, label %block_.L_4075e8
...
block_4075be:                                     ; preds = %block_.L_4075b2
  ...
  %call2_4075cb = tail call %struct.Memory* @sub_401480._Z18complete_hash_funcIdET_S0_(%struct.State* %0, i64 %260, %struct.Memory* %MEMORY.2)
...
block_.L_4075e8:                                  ; preds = %block_.L_4075b2
  ...
  %call2_4075ed = tail call %struct.Memory* @sub_4014b0._Z9check_sumIdEvT_(%struct.State* %0, i64 %310, %struct.Memory* %MEMORY.2)
...
block_.L_407600:                                  ; preds = %block_.L_40755f
  ...
  %call2_407600 = tail call %struct.Memory* @sub_400df0._Z5timerv(%struct.State* %0, i64 %347, %struct.Memory* %MEMORY.0)
  ...
  %call2_407609 = tail call %struct.Memory* @sub_400790._Z13record_resultdPKc(%struct.State* %0, i64 %358, %struct.Memory* %call2_407600)
  ...
  ret %struct.Memory* %call2_407609
}
...
define %struct.Memory* @routine_jge_.L_407600(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i8* %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
...
define %struct.Memory* @routine_jge_.L_4075ad(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i8* %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 2, i32 9
...
define %struct.Memory* @routine_jmpq_.L_40757e(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
...
define %struct.Memory* @routine_jge_.L_4075e8(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i8* %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 2, i32 9
...
define %struct.Memory* @routine_jmpq_.L_40755f(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
