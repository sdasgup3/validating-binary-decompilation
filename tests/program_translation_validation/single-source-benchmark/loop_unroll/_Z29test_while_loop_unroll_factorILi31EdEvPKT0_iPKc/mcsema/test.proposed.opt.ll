...
define %struct.Memory* @_Z29test_while_loop_unroll_factorILi31EdEvPKT0_iPKc(%struct.State* noalias, i64, %struct.Memory* noalias) local_unnamed_addr #1 {
entry:
  ...
  %call2_407583 = tail call %struct.Memory* @sub_400e00._Z11start_timerv(%struct.State* %0, i64 %58, %struct.Memory* %2)
...
block_.L_40758f:                                  ; preds = %block_.L_407618, %entry
  %74 = phi i64 [ %.pre, %entry ], [ %341, %block_.L_407618 ]
  %MEMORY.0 = phi %struct.Memory* [ %call2_407583, %entry ], [ %call2_40761d, %block_.L_407618 ]
  ...
  br i1 %107, label %block_40759f, label %block_.L_407630
...
block_.L_4075ae:                                  ; preds = %block_4075bf, %block_40759f
  %118 = phi i64 [ %.pre9, %block_40759f ], [ %202, %block_4075bf ]
  %MEMORY.1 = phi %struct.Memory* [ %MEMORY.0, %block_40759f ], [ %call2_4075ca, %block_4075bf ]
  ...
  br i1 %156, label %block_4075bf, label %block_.L_4075dd
...
block_4075bf:                                     ; preds = %block_.L_4075ae
  ...
  %call2_4075ca = tail call %struct.Memory* @sub_401620._ZN15loop_inner_bodyILi31EdE7do_workERdPKdi(%struct.State* nonnull %0, i64 %166, %struct.Memory* %MEMORY.1)
...
block_.L_4075e2:                                  ; preds = %block_4075ee, %block_.L_4075dd
  %204 = phi i64 [ %119, %block_.L_4075dd ], [ %.pre10, %block_4075ee ]
  %storemerge = phi i64 [ %203, %block_.L_4075dd ], [ %299, %block_4075ee ]
  %MEMORY.2 = phi %struct.Memory* [ %MEMORY.1, %block_.L_4075dd ], [ %call2_4075fb, %block_4075ee ]
  %205 = add i64 %204, -44
  ...
  br i1 %239, label %block_4075ee, label %block_.L_407618
...
block_4075ee:                                     ; preds = %block_.L_4075e2
  ...
  %call2_4075fb = tail call %struct.Memory* @sub_4014b0._Z18complete_hash_funcIdET_S0_(%struct.State* nonnull %0, i64 %253, %struct.Memory* %MEMORY.2)
...
block_.L_407618:                                  ; preds = %block_.L_4075e2
  ...
  %call2_40761d = tail call %struct.Memory* @sub_4014e0._Z9check_sumIdEvT_(%struct.State* nonnull %0, i64 %305, %struct.Memory* %MEMORY.2)
...
block_.L_407630:                                  ; preds = %block_.L_40758f
  ...
  %call2_407630 = tail call %struct.Memory* @sub_400e20._Z5timerv(%struct.State* nonnull %0, i64 %342, %struct.Memory* %MEMORY.0)
  ...
  %call2_407639 = tail call %struct.Memory* @sub_4007c0._Z13record_resultdPKc(%struct.State* nonnull %0, i64 %353, %struct.Memory* %call2_407630)
  ...
  ret %struct.Memory* %call2_407639
}
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_jge_.L_407630(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i8* nocapture %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_jge_.L_4075dd(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i8* nocapture %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 2, i32 9
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_jmpq_.L_4075ae(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_jge_.L_407618(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i8* nocapture %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 2, i32 9
