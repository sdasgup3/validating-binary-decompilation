...
block_.L_40755f:                                  ; preds = %block_.L_4075e8, %entry
  %79 = phi i64 [ %.pre, %entry ], [ %350, %block_.L_4075e8 ]
...
block_.L_4075b2:                                  ; preds = %block_4075be, %block_.L_4075ad
  %210 = phi i64 [ %209, %block_.L_4075ad ], [ %307, %block_4075be ]
...
block_4075be:                                     ; preds = %block_.L_4075b2
  ...
  %call2_4075cb = tail call %struct.Memory* @sub_401480._Z18complete_hash_funcIdET_S0_(%struct.State* %0, i64 %261, %struct.Memory* %MEMORY.2)
...
block_.L_4075e8:                                  ; preds = %block_.L_4075b2
  ...
  %call2_4075ed = tail call %struct.Memory* @sub_4014b0._Z9check_sumIdEvT_(%struct.State* %0, i64 %313, %struct.Memory* %MEMORY.2)
...
block_.L_407600:                                  ; preds = %block_.L_40755f
  ...
  %call2_407600 = tail call %struct.Memory* @sub_400df0._Z5timerv(%struct.State* %0, i64 %351, %struct.Memory* %MEMORY.0)
  ...
  %call2_407609 = tail call %struct.Memory* @sub_400790._Z13record_resultdPKc(%struct.State* %0, i64 %362, %struct.Memory* %call2_407600)
