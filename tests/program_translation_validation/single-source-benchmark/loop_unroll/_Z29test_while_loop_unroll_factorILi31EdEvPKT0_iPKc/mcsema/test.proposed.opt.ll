...
define %struct.Memory* @_Z29test_while_loop_unroll_factorILi31EdEvPKT0_iPKc(%struct.State* noalias, i64, %struct.Memory* noalias readnone) local_unnamed_addr #1 {
entry:
...
block_.L_40758f:                                  ; preds = %block_.L_407618, %entry
  %74 = phi i64 [ %341, %block_.L_407618 ], [ %.pre, %entry ]
...
block_.L_4075ae:                                  ; preds = %block_4075bf, %block_40759f
  %118 = phi i64 [ %202, %block_4075bf ], [ %.pre9, %block_40759f ]
...
block_4075bf:                                     ; preds = %block_.L_4075ae
  ...
  %call2_4075ca = tail call %struct.Memory* @sub_401620._ZN15loop_inner_bodyILi31EdE7do_workERdPKdi(%struct.State* nonnull %0, i64 %166, %struct.Memory* %call2_407583)
...
block_4075ee:                                     ; preds = %block_.L_4075e2
  ...
  %call2_4075fb = tail call %struct.Memory* @sub_4014b0._Z18complete_hash_funcIdET_S0_(%struct.State* nonnull %0, i64 %253, %struct.Memory* %call2_407583)
...
block_.L_407618:                                  ; preds = %block_.L_4075e2
  ...
  %call2_40761d = tail call %struct.Memory* @sub_4014e0._Z9check_sumIdEvT_(%struct.State* nonnull %0, i64 %305, %struct.Memory* %call2_407583)
...
block_.L_407630:                                  ; preds = %block_.L_40758f
  ...
  %call2_407630 = tail call %struct.Memory* @sub_400e20._Z5timerv(%struct.State* nonnull %0, i64 %342, %struct.Memory* %call2_407583)
