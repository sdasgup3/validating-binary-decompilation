...
block_.L_411f0f:                                  ; preds = %block_.L_411f91, %entry
  %68 = phi i64 [ %.pre, %entry ], [ %362, %block_.L_411f91 ]
...
block_.L_411f61:                                  ; preds = %block_411f6d, %block_.L_411f5c
  %197 = phi i64 [ %196, %block_.L_411f5c ], [ %320, %block_411f6d ]
...
block_.L_411f91:                                  ; preds = %block_.L_411f61
  ...
  %call2_411f94 = tail call %struct.Memory* @sub_40c100._Z9check_sumIiEvT_(%struct.State* %0, i64 %326, %struct.Memory* %MEMORY.2)
...
block_.L_411fa7:                                  ; preds = %block_.L_411f0f
  ...
  %call2_411fa7 = tail call %struct.Memory* @sub_400df0._Z5timerv(%struct.State* %0, i64 %363, %struct.Memory* %MEMORY.0)
  ...
  %call2_411fb0 = tail call %struct.Memory* @sub_400790._Z13record_resultdPKc(%struct.State* %0, i64 %374, %struct.Memory* %call2_411fa7)
