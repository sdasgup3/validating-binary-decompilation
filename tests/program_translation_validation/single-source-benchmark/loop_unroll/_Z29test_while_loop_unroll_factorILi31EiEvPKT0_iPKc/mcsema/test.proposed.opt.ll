...
define %struct.Memory* @_Z29test_while_loop_unroll_factorILi31EiEvPKT0_iPKc(%struct.State* noalias, i64, %struct.Memory* noalias readnone) local_unnamed_addr #1 {
entry:
...
block_.L_411f3f:                                  ; preds = %block_.L_411fc1, %entry
  %68 = phi i64 [ %362, %block_.L_411fc1 ], [ %.pre, %entry ]
...
block_.L_411f5d:                                  ; preds = %block_411f6e, %block_411f4f
  %111 = phi i64 [ %195, %block_411f6e ], [ %.pre9, %block_411f4f ]
...
block_411f6e:                                     ; preds = %block_.L_411f5d
  ...
  %call2_411f79 = tail call %struct.Memory* @sub_40c1e0._ZN15loop_inner_bodyILi31EiE7do_workERiPKii(%struct.State* nonnull %0, i64 %159, %struct.Memory* %call2_411f33)
...
block_411f9d:                                     ; preds = %block_.L_411f91
  ...
  %call2_411fa8 = tail call %struct.Memory* @sub_40c100._Z18complete_hash_funcIiET_S0_(%struct.State* nonnull %0, i64 %247, %struct.Memory* %call2_411f33)
...
block_.L_411fc1:                                  ; preds = %block_.L_411f91
  ...
  %call2_411fc4 = tail call %struct.Memory* @sub_40c130._Z9check_sumIiEvT_(%struct.State* nonnull %0, i64 %326, %struct.Memory* %call2_411f33)
...
block_.L_411fd7:                                  ; preds = %block_.L_411f3f
  ...
  %call2_411fd7 = tail call %struct.Memory* @sub_400e20._Z5timerv(%struct.State* nonnull %0, i64 %363, %struct.Memory* %call2_411f33)
