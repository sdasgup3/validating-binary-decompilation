...
define %struct.Memory* @_Z29test_while_loop_unroll_factorILi31EiEvPKT0_iPKc(%struct.State* noalias, i64, %struct.Memory* noalias) local_unnamed_addr #1 {
entry:
  ...
  %call2_411f33 = tail call %struct.Memory* @sub_400e00._Z11start_timerv(%struct.State* %0, i64 %58, %struct.Memory* %2)
  ...
  br label %block_.L_411f3f

block_.L_411f3f:                                  ; preds = %block_.L_411fc1, %entry
  %68 = phi i64 [ %.pre, %entry ], [ %362, %block_.L_411fc1 ]
  %MEMORY.0 = phi %struct.Memory* [ %call2_411f33, %entry ], [ %call2_411fc4, %block_.L_411fc1 ]
  ...
  br i1 %101, label %block_411f4f, label %block_.L_411fd7

block_411f4f:                                     ; preds = %block_.L_411f3f
  %103 = add i64 %69, -32
  %104 = add i64 %102, 7
  ...
  br label %block_.L_411f5d

block_.L_411f5d:                                  ; preds = %block_411f6e, %block_411f4f
  %111 = phi i64 [ %.pre9, %block_411f4f ], [ %195, %block_411f6e ]
  %MEMORY.1 = phi %struct.Memory* [ %MEMORY.0, %block_411f4f ], [ %call2_411f79, %block_411f6e ]
  ...
  br i1 %149, label %block_411f6e, label %block_.L_411f8c

block_411f6e:                                     ; preds = %block_.L_411f5d
  %151 = add i64 %112, -32
  ...
  %call2_411f79 = tail call %struct.Memory* @sub_40c1e0._ZN15loop_inner_bodyILi31EiE7do_workERiPKii(%struct.State* nonnull %0, i64 %159, %struct.Memory* %MEMORY.1)
...
block_.L_411f8c:                                  ; preds = %block_.L_411f5d
  %196 = add i64 %150, 5
  br label %block_.L_411f91

block_.L_411f91:                                  ; preds = %block_411f9d, %block_.L_411f8c
  %197 = phi i64 [ %112, %block_.L_411f8c ], [ %.pre10, %block_411f9d ]
  %storemerge = phi i64 [ %196, %block_.L_411f8c ], [ %319, %block_411f9d ]
  %MEMORY.2 = phi %struct.Memory* [ %MEMORY.1, %block_.L_411f8c ], [ %call2_411fa8, %block_411f9d ]
  %198 = add i64 %197, -36
  ...
  br i1 %232, label %block_411f9d, label %block_.L_411fc1

block_411f9d:                                     ; preds = %block_.L_411f91
  %234 = add i64 %197, -8
  %235 = add i64 %233, 4
  ...
  %call2_411fa8 = tail call %struct.Memory* @sub_40c100._Z18complete_hash_funcIiET_S0_(%struct.State* nonnull %0, i64 %247, %struct.Memory* %MEMORY.2)
...
block_.L_411fc1:                                  ; preds = %block_.L_411f91
  %321 = add i64 %197, -32
  %322 = add i64 %233, 3
  ...
  %call2_411fc4 = tail call %struct.Memory* @sub_40c130._Z9check_sumIiEvT_(%struct.State* nonnull %0, i64 %326, %struct.Memory* %MEMORY.2)
...
block_.L_411fd7:                                  ; preds = %block_.L_411f3f
  %363 = add i64 %102, -70071
  %364 = add i64 %102, 5
  ...
  %call2_411fd7 = tail call %struct.Memory* @sub_400e20._Z5timerv(%struct.State* nonnull %0, i64 %363, %struct.Memory* %MEMORY.0)
  ...
  %call2_411fe0 = tail call %struct.Memory* @sub_4007c0._Z13record_resultdPKc(%struct.State* nonnull %0, i64 %374, %struct.Memory* %call2_411fd7)
  ...
  ret %struct.Memory* %call2_411fe0
}
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_jge_.L_411fd7(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i8* nocapture %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_jge_.L_411f8c(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i8* nocapture %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 2, i32 9
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_jmpq_.L_411f5d(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_jmpq_.L_411f91(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_jge_.L_411fc1(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i8* nocapture %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 2, i32 9
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_jmpq_.L_411f3f(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
