...
block_.L_40742f:                                  ; preds = %block_.L_4074b8, %entry
  %79 = phi i64 [ %.pre, %entry ], [ %349, %block_.L_4074b8 ]
...
block_.L_407482:                                  ; preds = %block_40748e, %block_.L_40747d
  %209 = phi i64 [ %208, %block_.L_40747d ], [ %306, %block_40748e ]
...
block_40748e:                                     ; preds = %block_.L_407482
  ...
  %call2_40749b = tail call %struct.Memory* @sub_401480._Z18complete_hash_funcIdET_S0_(%struct.State* %0, i64 %260, %struct.Memory* %MEMORY.2)
...
block_.L_4074b8:                                  ; preds = %block_.L_407482
  ...
  %call2_4074bd = tail call %struct.Memory* @sub_4014b0._Z9check_sumIdEvT_(%struct.State* %0, i64 %312, %struct.Memory* %MEMORY.2)
...
block_.L_4074d0:                                  ; preds = %block_.L_40742f
  ...
  %call2_4074d0 = tail call %struct.Memory* @sub_400df0._Z5timerv(%struct.State* %0, i64 %350, %struct.Memory* %MEMORY.0)
  ...
  %call2_4074d9 = tail call %struct.Memory* @sub_400790._Z13record_resultdPKc(%struct.State* %0, i64 %361, %struct.Memory* %call2_4074d0)
