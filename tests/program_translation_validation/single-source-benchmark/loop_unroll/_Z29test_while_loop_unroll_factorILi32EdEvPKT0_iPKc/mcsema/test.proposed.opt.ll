...
entry:
  ...
  %call2_407463 = tail call %struct.Memory* @sub_400e10._Z11start_timerv(%struct.State* %0, i64 %58, %struct.Memory* %2)
  ...
  br label %block_.L_40746f

block_.L_40746f:                                  ; preds = %block_.L_4074f8, %entry
  %74 = phi i64 [ %340, %block_.L_4074f8 ], [ %.pre, %entry ]
  ...
  br i1 %107, label %block_40747f, label %block_.L_407510

block_40747f:                                     ; preds = %block_.L_40746f
  ...
  br label %block_.L_40748e

block_.L_40748e:                                  ; preds = %block_40749f, %block_40747f
  %118 = phi i64 [ %201, %block_40749f ], [ %.pre9, %block_40747f ]
  ...
  br i1 %156, label %block_40749f, label %block_.L_4074bd

block_40749f:                                     ; preds = %block_.L_40748e
  %158 = add i64 %119, -40
  ...
  %call2_4074aa = tail call %struct.Memory* @sub_401460._ZN15loop_inner_bodyILi32EdE7do_workERdPKdi(%struct.State* nonnull %0, i64 %166, %struct.Memory* %call2_407463)
...
block_.L_4074bd:                                  ; preds = %block_.L_40748e
  %202 = add i64 %157, 5
  br label %block_.L_4074c2

block_.L_4074c2:                                  ; preds = %block_4074ce, %block_.L_4074bd
  %203 = phi i64 [ %119, %block_.L_4074bd ], [ %.pre10, %block_4074ce ]
  %storemerge = phi i64 [ %202, %block_.L_4074bd ], [ %298, %block_4074ce ]
  %204 = add i64 %203, -44
  ...
  br i1 %238, label %block_4074ce, label %block_.L_4074f8
...
block_4074ce:                                     ; preds = %block_.L_4074c2
  ...
  %call2_4074db = tail call %struct.Memory* @sub_4014c0._Z18complete_hash_funcIdET_S0_(%struct.State* nonnull %0, i64 %252, %struct.Memory* %call2_407463)
...
block_.L_4074f8:                                  ; preds = %block_.L_4074c2
  ...
  %call2_4074fd = tail call %struct.Memory* @sub_4014f0._Z9check_sumIdEvT_(%struct.State* nonnull %0, i64 %304, %struct.Memory* %call2_407463)
...
block_.L_407510:                                  ; preds = %block_.L_40746f
  ...
  %call2_407510 = tail call %struct.Memory* @sub_400e30._Z5timerv(%struct.State* nonnull %0, i64 %341, %struct.Memory* %call2_407463)
  ...
  %call2_407519 = tail call %struct.Memory* @sub_4007d0._Z13record_resultdPKc(%struct.State* nonnull %0, i64 %352, %struct.Memory* %call2_407510)
