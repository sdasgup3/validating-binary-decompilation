...
define %struct.Memory* @_Z29test_while_loop_unroll_factorILi32EdEvPKT0_iPKc(%struct.State* noalias, i64, %struct.Memory* noalias readnone) local_unnamed_addr #1 {
entry:
...
block_.L_40745f:                                  ; preds = %block_.L_4074e8, %entry
  %74 = phi i64 [ %340, %block_.L_4074e8 ], [ %.pre, %entry ]
...
block_.L_40747e:                                  ; preds = %block_40748f, %block_40746f
  %118 = phi i64 [ %201, %block_40748f ], [ %.pre9, %block_40746f ]
...
block_40748f:                                     ; preds = %block_.L_40747e
  ...
  %call2_40749a = tail call %struct.Memory* @sub_401450._ZN15loop_inner_bodyILi32EdE7do_workERdPKdi(%struct.State* nonnull %0, i64 %166, %struct.Memory* %call2_407453)
...
block_4074be:                                     ; preds = %block_.L_4074b2
  ...
  %call2_4074cb = tail call %struct.Memory* @sub_4014b0._Z18complete_hash_funcIdET_S0_(%struct.State* nonnull %0, i64 %252, %struct.Memory* %call2_407453)
...
block_.L_4074e8:                                  ; preds = %block_.L_4074b2
  ...
  %call2_4074ed = tail call %struct.Memory* @sub_4014e0._Z9check_sumIdEvT_(%struct.State* nonnull %0, i64 %304, %struct.Memory* %call2_407453)
...
block_.L_407500:                                  ; preds = %block_.L_40745f
  ...
  %call2_407500 = tail call %struct.Memory* @sub_400e20._Z5timerv(%struct.State* nonnull %0, i64 %341, %struct.Memory* %call2_407453)
