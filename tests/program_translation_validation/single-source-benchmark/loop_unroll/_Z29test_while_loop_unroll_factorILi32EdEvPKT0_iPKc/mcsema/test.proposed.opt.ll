...
entry:
  ...
  %call2_407423 = tail call %struct.Memory* @sub_400dd0._Z11start_timerv(%struct.State* %0, i64 %58, %struct.Memory* %2)
...
block_.L_40742f:                                  ; preds = %block_.L_4074b8, %entry
  %79 = phi i64 [ %.pre, %entry ], [ %345, %block_.L_4074b8 ]
  %MEMORY.0 = phi %struct.Memory* [ %call2_407423, %entry ], [ %call2_4074bd, %block_.L_4074b8 ]
  ...
  br i1 %112, label %block_40743f, label %block_.L_4074d0
...
block_40743f:                                     ; preds = %block_.L_40742f
  ...
  br label %block_.L_40744e

block_.L_40744e:                                  ; preds = %block_40745f, %block_40743f
  %124 = phi i64 [ %.pre1, %block_40743f ], [ %207, %block_40745f ]
  %MEMORY.1 = phi %struct.Memory* [ %MEMORY.0, %block_40743f ], [ %call2_40746a, %block_40745f ]
  ...
  br i1 %162, label %block_40745f, label %block_.L_40747d

block_40745f:                                     ; preds = %block_.L_40744e
  %164 = add i64 %125, -40
  ...
  %call2_40746a = tail call %struct.Memory* @sub_401420._ZN15loop_inner_bodyILi32EdE7do_workERdPKdi(%struct.State* %0, i64 %172, %struct.Memory* %MEMORY.1)
...
block_.L_40747d:                                  ; preds = %block_.L_40744e
  %208 = add i64 %163, 5
  store i64 %208, i64* %3, align 8
  br label %block_.L_407482

block_.L_407482:                                  ; preds = %block_40748e, %block_.L_40747d
  %209 = phi i64 [ %208, %block_.L_40747d ], [ %304, %block_40748e ]
  %210 = phi i64 [ %125, %block_.L_40747d ], [ %.pre2, %block_40748e ]
  %MEMORY.2 = phi %struct.Memory* [ %MEMORY.1, %block_.L_40747d ], [ %call2_40749b, %block_40748e ]
  %211 = add i64 %210, -44
  %212 = add i64 %209, 3
  ...
  br i1 %245, label %block_40748e, label %block_.L_4074b8

block_40748e:                                     ; preds = %block_.L_407482
  %247 = add i64 %210, -8
  %248 = add i64 %246, 4
  ...
  %call2_40749b = tail call %struct.Memory* @sub_401480._Z18complete_hash_funcIdET_S0_(%struct.State* %0, i64 %259, %struct.Memory* %MEMORY.2)
...
block_.L_4074b8:                                  ; preds = %block_.L_407482
  %305 = add i64 %210, -40
  %306 = add i64 %246, 5
  ...
  %call2_4074bd = tail call %struct.Memory* @sub_4014b0._Z9check_sumIdEvT_(%struct.State* %0, i64 %309, %struct.Memory* %MEMORY.2)
...
block_.L_4074d0:                                  ; preds = %block_.L_40742f
  %346 = add i64 %113, -26336
  %347 = add i64 %113, 5
  ...
  %call2_4074d0 = tail call %struct.Memory* @sub_400df0._Z5timerv(%struct.State* %0, i64 %346, %struct.Memory* %MEMORY.0)
  ...
  %call2_4074d9 = tail call %struct.Memory* @sub_400790._Z13record_resultdPKc(%struct.State* %0, i64 %357, %struct.Memory* %call2_4074d0)
  ...
  ret %struct.Memory* %call2_4074d9
}
...
define %struct.Memory* @routine_jge_.L_4074d0(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i8* %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
...
define %struct.Memory* @routine_jge_.L_40747d(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i8* %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 2, i32 9
...
define %struct.Memory* @routine_jmpq_.L_40744e(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
...
define %struct.Memory* @routine_jmpq_.L_407482(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
...
define %struct.Memory* @routine_jge_.L_4074b8(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i8* %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 2, i32 9
...
define %struct.Memory* @routine_jmpq_.L_40742f(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
