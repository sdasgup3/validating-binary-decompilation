...
define %struct.Memory* @_Z29test_while_loop_unroll_factorILi32EdEvPKT0_iPKc(%struct.State* noalias, i64, %struct.Memory* noalias) local_unnamed_addr #1 {
entry:
  ...
  %call2_407453 = tail call %struct.Memory* @sub_400e00._Z11start_timerv(%struct.State* %0, i64 %58, %struct.Memory* %2)
  ...
  br label %block_.L_40745f

block_.L_40745f:                                  ; preds = %block_.L_4074e8, %entry
  %74 = phi i64 [ %.pre, %entry ], [ %340, %block_.L_4074e8 ]
  %MEMORY.0 = phi %struct.Memory* [ %call2_407453, %entry ], [ %call2_4074ed, %block_.L_4074e8 ]
  ...
  br i1 %107, label %block_40746f, label %block_.L_407500

block_40746f:                                     ; preds = %block_.L_40745f
  ...
  br label %block_.L_40747e

block_.L_40747e:                                  ; preds = %block_40748f, %block_40746f
  %118 = phi i64 [ %.pre9, %block_40746f ], [ %201, %block_40748f ]
  %MEMORY.1 = phi %struct.Memory* [ %MEMORY.0, %block_40746f ], [ %call2_40749a, %block_40748f ]
  ...
  br i1 %156, label %block_40748f, label %block_.L_4074ad

block_40748f:                                     ; preds = %block_.L_40747e
  %158 = add i64 %119, -40
  ...
  %call2_40749a = tail call %struct.Memory* @sub_401450._ZN15loop_inner_bodyILi32EdE7do_workERdPKdi(%struct.State* nonnull %0, i64 %166, %struct.Memory* %MEMORY.1)
...
block_.L_4074ad:                                  ; preds = %block_.L_40747e
  %202 = add i64 %157, 5
  br label %block_.L_4074b2

block_.L_4074b2:                                  ; preds = %block_4074be, %block_.L_4074ad
  %203 = phi i64 [ %119, %block_.L_4074ad ], [ %.pre10, %block_4074be ]
  %storemerge = phi i64 [ %202, %block_.L_4074ad ], [ %298, %block_4074be ]
  %MEMORY.2 = phi %struct.Memory* [ %MEMORY.1, %block_.L_4074ad ], [ %call2_4074cb, %block_4074be ]
  %204 = add i64 %203, -44
  ...
  br i1 %238, label %block_4074be, label %block_.L_4074e8

block_4074be:                                     ; preds = %block_.L_4074b2
  %240 = add i64 %203, -8
  %241 = add i64 %239, 4
  ...
  %call2_4074cb = tail call %struct.Memory* @sub_4014b0._Z18complete_hash_funcIdET_S0_(%struct.State* nonnull %0, i64 %252, %struct.Memory* %MEMORY.2)
...
block_.L_4074e8:                                  ; preds = %block_.L_4074b2
  %300 = add i64 %203, -40
  %301 = add i64 %239, 5
  ...
  %call2_4074ed = tail call %struct.Memory* @sub_4014e0._Z9check_sumIdEvT_(%struct.State* nonnull %0, i64 %304, %struct.Memory* %MEMORY.2)
...
block_.L_407500:                                  ; preds = %block_.L_40745f
  %341 = add i64 %108, -26336
  %342 = add i64 %108, 5
  ...
  %call2_407500 = tail call %struct.Memory* @sub_400e20._Z5timerv(%struct.State* nonnull %0, i64 %341, %struct.Memory* %MEMORY.0)
  ...
  %call2_407509 = tail call %struct.Memory* @sub_4007c0._Z13record_resultdPKc(%struct.State* nonnull %0, i64 %352, %struct.Memory* %call2_407500)
  ...
  ret %struct.Memory* %call2_407509
}
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_jge_.L_407500(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i8* nocapture %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_jge_.L_4074ad(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i8* nocapture %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 2, i32 9
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_jmpq_.L_40747e(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_jmpq_.L_4074b2(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_jge_.L_4074e8(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i8* nocapture %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 2, i32 9
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_jmpq_.L_40745f(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
