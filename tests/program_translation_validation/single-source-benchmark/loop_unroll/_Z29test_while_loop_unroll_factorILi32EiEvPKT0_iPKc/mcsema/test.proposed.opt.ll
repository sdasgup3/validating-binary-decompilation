...
entry:
  ...
  %call2_411de3 = tail call %struct.Memory* @sub_400dd0._Z11start_timerv(%struct.State* %0, i64 %58, %struct.Memory* %2)
...
block_.L_411def:                                  ; preds = %block_.L_411e71, %entry
  %68 = phi i64 [ %.pre, %entry ], [ %363, %block_.L_411e71 ]
  %MEMORY.0 = phi %struct.Memory* [ %call2_411de3, %entry ], [ %call2_411e74, %block_.L_411e71 ]
  ...
  br i1 %101, label %block_411dff, label %block_.L_411e87

block_411dff:                                     ; preds = %block_.L_411def
  %103 = add i64 %69, -32
  %104 = add i64 %102, 7
...
block_.L_411e0d:                                  ; preds = %block_411e1e, %block_411dff
  %111 = phi i64 [ %.pre1, %block_411dff ], [ %194, %block_411e1e ]
  %MEMORY.1 = phi %struct.Memory* [ %MEMORY.0, %block_411dff ], [ %call2_411e29, %block_411e1e ]
  ...
  br i1 %149, label %block_411e1e, label %block_.L_411e3c

block_411e1e:                                     ; preds = %block_.L_411e0d
  %151 = add i64 %112, -32
  ...
  %call2_411e29 = tail call %struct.Memory* @sub_40c070._ZN15loop_inner_bodyILi32EiE7do_workERiPKii(%struct.State* %0, i64 %159, %struct.Memory* %MEMORY.1)
...
block_.L_411e3c:                                  ; preds = %block_.L_411e0d
  %195 = add i64 %150, 5
  store i64 %195, i64* %3, align 8
  br label %block_.L_411e41

block_.L_411e41:                                  ; preds = %block_411e4d, %block_.L_411e3c
  %196 = phi i64 [ %195, %block_.L_411e3c ], [ %320, %block_411e4d ]
  %197 = phi i64 [ %112, %block_.L_411e3c ], [ %.pre2, %block_411e4d ]
  %MEMORY.2 = phi %struct.Memory* [ %MEMORY.1, %block_.L_411e3c ], [ %call2_411e58, %block_411e4d ]
  %198 = add i64 %197, -36
  %199 = add i64 %196, 3
  ...
  br i1 %232, label %block_411e4d, label %block_.L_411e71

block_411e4d:                                     ; preds = %block_.L_411e41
  %234 = add i64 %197, -8
  %235 = add i64 %233, 4
  ...
  %call2_411e58 = tail call %struct.Memory* @sub_40c0d0._Z18complete_hash_funcIiET_S0_(%struct.State* %0, i64 %247, %struct.Memory* %MEMORY.2)
...
block_.L_411e71:                                  ; preds = %block_.L_411e41
  %321 = add i64 %197, -32
  %322 = add i64 %233, 3
  ...
  %call2_411e74 = tail call %struct.Memory* @sub_40c100._Z9check_sumIiEvT_(%struct.State* %0, i64 %326, %struct.Memory* %MEMORY.2)
...
block_.L_411e87:                                  ; preds = %block_.L_411def
  %364 = add i64 %102, -69783
  %365 = add i64 %102, 5
  ...
  %call2_411e87 = tail call %struct.Memory* @sub_400df0._Z5timerv(%struct.State* %0, i64 %364, %struct.Memory* %MEMORY.0)
  ...
  %call2_411e90 = tail call %struct.Memory* @sub_400790._Z13record_resultdPKc(%struct.State* %0, i64 %375, %struct.Memory* %call2_411e87)
  ...
  ret %struct.Memory* %call2_411e90
}
...
define %struct.Memory* @routine_jge_.L_411e87(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i8* %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
...
define %struct.Memory* @routine_jge_.L_411e3c(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i8* %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 2, i32 9
...
define %struct.Memory* @routine_jmpq_.L_411e0d(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
...
define %struct.Memory* @routine_jmpq_.L_411e41(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
...
define %struct.Memory* @routine_jge_.L_411e71(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i8* %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 2, i32 9
...
define %struct.Memory* @routine_jmpq_.L_411def(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
