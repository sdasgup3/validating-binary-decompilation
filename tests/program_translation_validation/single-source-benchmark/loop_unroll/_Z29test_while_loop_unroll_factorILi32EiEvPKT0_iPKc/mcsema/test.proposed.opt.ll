...
block_.L_411def:                                  ; preds = %block_.L_411e71, %entry
  %68 = phi i64 [ %.pre, %entry ], [ %361, %block_.L_411e71 ]
...
block_.L_411e41:                                  ; preds = %block_411e4d, %block_.L_411e3c
  %196 = phi i64 [ %195, %block_.L_411e3c ], [ %319, %block_411e4d ]
...
block_.L_411e71:                                  ; preds = %block_.L_411e41
  ...
  %call2_411e74 = tail call %struct.Memory* @sub_40c100._Z9check_sumIiEvT_(%struct.State* %0, i64 %325, %struct.Memory* %MEMORY.2)
...
block_.L_411e87:                                  ; preds = %block_.L_411def
  ...
  %call2_411e87 = tail call %struct.Memory* @sub_400df0._Z5timerv(%struct.State* %0, i64 %362, %struct.Memory* %MEMORY.0)
  ...
  %call2_411e90 = tail call %struct.Memory* @sub_400790._Z13record_resultdPKc(%struct.State* %0, i64 %373, %struct.Memory* %call2_411e87)
