...
define %struct.Memory* @_Z29test_while_loop_unroll_factorILi32EiEvPKT0_iPKc(%struct.State* noalias, i64, %struct.Memory* noalias readnone) local_unnamed_addr #1 {
entry:
...
block_.L_411e1f:                                  ; preds = %block_.L_411ea1, %entry
  %68 = phi i64 [ %361, %block_.L_411ea1 ], [ %.pre, %entry ]
...
block_.L_411e3d:                                  ; preds = %block_411e4e, %block_411e2f
  %111 = phi i64 [ %194, %block_411e4e ], [ %.pre9, %block_411e2f ]
...
block_411e4e:                                     ; preds = %block_.L_411e3d
  ...
  %call2_411e59 = tail call %struct.Memory* @sub_40c0a0._ZN15loop_inner_bodyILi32EiE7do_workERiPKii(%struct.State* nonnull %0, i64 %159, %struct.Memory* %call2_411e13)
...
block_411e7d:                                     ; preds = %block_.L_411e71
  ...
  %call2_411e88 = tail call %struct.Memory* @sub_40c100._Z18complete_hash_funcIiET_S0_(%struct.State* nonnull %0, i64 %246, %struct.Memory* %call2_411e13)
...
block_.L_411ea1:                                  ; preds = %block_.L_411e71
  ...
  %call2_411ea4 = tail call %struct.Memory* @sub_40c130._Z9check_sumIiEvT_(%struct.State* nonnull %0, i64 %325, %struct.Memory* %call2_411e13)
...
block_.L_411eb7:                                  ; preds = %block_.L_411e1f
  ...
  %call2_411eb7 = tail call %struct.Memory* @sub_400e20._Z5timerv(%struct.State* nonnull %0, i64 %362, %struct.Memory* %call2_411e13)
