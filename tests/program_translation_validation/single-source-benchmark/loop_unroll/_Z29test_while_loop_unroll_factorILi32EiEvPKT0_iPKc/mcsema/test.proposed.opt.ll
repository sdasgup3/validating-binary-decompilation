...
define %struct.Memory* @_Z29test_while_loop_unroll_factorILi32EiEvPKT0_iPKc(%struct.State* noalias, i64, %struct.Memory* noalias) local_unnamed_addr #1 {
entry:
  ...
  %call2_411e13 = tail call %struct.Memory* @sub_400e00._Z11start_timerv(%struct.State* %0, i64 %58, %struct.Memory* %2)
...
block_.L_411e1f:                                  ; preds = %block_.L_411ea1, %entry
  %68 = phi i64 [ %.pre, %entry ], [ %361, %block_.L_411ea1 ]
  %MEMORY.0 = phi %struct.Memory* [ %call2_411e13, %entry ], [ %call2_411ea4, %block_.L_411ea1 ]
  ...
  br i1 %101, label %block_411e2f, label %block_.L_411eb7

block_411e2f:                                     ; preds = %block_.L_411e1f
  %103 = add i64 %69, -32
  %104 = add i64 %102, 7
...
block_.L_411e3d:                                  ; preds = %block_411e4e, %block_411e2f
  %111 = phi i64 [ %.pre9, %block_411e2f ], [ %194, %block_411e4e ]
  %MEMORY.1 = phi %struct.Memory* [ %MEMORY.0, %block_411e2f ], [ %call2_411e59, %block_411e4e ]
  ...
  br i1 %149, label %block_411e4e, label %block_.L_411e6c

block_411e4e:                                     ; preds = %block_.L_411e3d
  %151 = add i64 %112, -32
  ...
  %call2_411e59 = tail call %struct.Memory* @sub_40c0a0._ZN15loop_inner_bodyILi32EiE7do_workERiPKii(%struct.State* nonnull %0, i64 %159, %struct.Memory* %MEMORY.1)
...
block_.L_411e6c:                                  ; preds = %block_.L_411e3d
  %195 = add i64 %150, 5
  br label %block_.L_411e71

block_.L_411e71:                                  ; preds = %block_411e7d, %block_.L_411e6c
  %196 = phi i64 [ %112, %block_.L_411e6c ], [ %.pre10, %block_411e7d ]
  %storemerge = phi i64 [ %195, %block_.L_411e6c ], [ %318, %block_411e7d ]
  %MEMORY.2 = phi %struct.Memory* [ %MEMORY.1, %block_.L_411e6c ], [ %call2_411e88, %block_411e7d ]
  %197 = add i64 %196, -36
  ...
  br i1 %231, label %block_411e7d, label %block_.L_411ea1

block_411e7d:                                     ; preds = %block_.L_411e71
  %233 = add i64 %196, -8
  %234 = add i64 %232, 4
  ...
  %call2_411e88 = tail call %struct.Memory* @sub_40c100._Z18complete_hash_funcIiET_S0_(%struct.State* nonnull %0, i64 %246, %struct.Memory* %MEMORY.2)
...
block_.L_411ea1:                                  ; preds = %block_.L_411e71
  %320 = add i64 %196, -32
  %321 = add i64 %232, 3
  ...
  %call2_411ea4 = tail call %struct.Memory* @sub_40c130._Z9check_sumIiEvT_(%struct.State* nonnull %0, i64 %325, %struct.Memory* %MEMORY.2)
...
block_.L_411eb7:                                  ; preds = %block_.L_411e1f
  %362 = add i64 %102, -69783
  %363 = add i64 %102, 5
  ...
  %call2_411eb7 = tail call %struct.Memory* @sub_400e20._Z5timerv(%struct.State* nonnull %0, i64 %362, %struct.Memory* %MEMORY.0)
  ...
  %call2_411ec0 = tail call %struct.Memory* @sub_4007c0._Z13record_resultdPKc(%struct.State* nonnull %0, i64 %373, %struct.Memory* %call2_411eb7)
  ...
  ret %struct.Memory* %call2_411ec0
}
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_jge_.L_411eb7(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i8* nocapture %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_jge_.L_411e6c(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i8* nocapture %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 2, i32 9
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_jmpq_.L_411e3d(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_jmpq_.L_411e71(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_jge_.L_411ea1(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i8* nocapture %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 2, i32 9
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_jmpq_.L_411e1f(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
