...
block_.L_4096cf:                                  ; preds = %block_.L_409758, %entry
  %74 = phi i64 [ %340, %block_.L_409758 ], [ %.pre, %entry ]
...
block_.L_4096ee:                                  ; preds = %block_4096ff, %block_4096df
  %118 = phi i64 [ %201, %block_4096ff ], [ %.pre9, %block_4096df ]
...
block_4096ff:                                     ; preds = %block_.L_4096ee
  ...
  %call2_40970a = tail call %struct.Memory* @sub_4020a0._ZN15loop_inner_bodyILi3EdE7do_workERdPKdi(%struct.State* nonnull %0, i64 %166, %struct.Memory* %call2_4096c3)
...
block_40972e:                                     ; preds = %block_.L_409722
  ...
  %call2_40973b = tail call %struct.Memory* @sub_4014b0._Z18complete_hash_funcIdET_S0_(%struct.State* nonnull %0, i64 %252, %struct.Memory* %call2_4096c3)
...
block_.L_409758:                                  ; preds = %block_.L_409722
  ...
  %call2_40975d = tail call %struct.Memory* @sub_4014e0._Z9check_sumIdEvT_(%struct.State* nonnull %0, i64 %304, %struct.Memory* %call2_4096c3)
...
block_.L_409770:                                  ; preds = %block_.L_4096cf
  ...
  %call2_409770 = tail call %struct.Memory* @sub_400e20._Z5timerv(%struct.State* nonnull %0, i64 %341, %struct.Memory* %call2_4096c3)
