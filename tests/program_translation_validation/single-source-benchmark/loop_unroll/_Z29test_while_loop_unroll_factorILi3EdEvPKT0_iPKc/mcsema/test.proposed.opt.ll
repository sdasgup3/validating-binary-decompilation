...
block_.L_40969f:                                  ; preds = %block_.L_409728, %entry
  %79 = phi i64 [ %.pre, %entry ], [ %345, %block_.L_409728 ]
...
block_.L_4096f2:                                  ; preds = %block_4096fe, %block_.L_4096ed
  %209 = phi i64 [ %208, %block_.L_4096ed ], [ %304, %block_4096fe ]
...
block_4096fe:                                     ; preds = %block_.L_4096f2
  ...
  %call2_40970b = tail call %struct.Memory* @sub_401480._Z18complete_hash_funcIdET_S0_(%struct.State* %0, i64 %259, %struct.Memory* %MEMORY.2)
...
block_.L_409728:                                  ; preds = %block_.L_4096f2
  ...
  %call2_40972d = tail call %struct.Memory* @sub_4014b0._Z9check_sumIdEvT_(%struct.State* %0, i64 %309, %struct.Memory* %MEMORY.2)
...
block_.L_409740:                                  ; preds = %block_.L_40969f
  ...
  %call2_409740 = tail call %struct.Memory* @sub_400df0._Z5timerv(%struct.State* %0, i64 %346, %struct.Memory* %MEMORY.0)
  ...
  %call2_409749 = tail call %struct.Memory* @sub_400790._Z13record_resultdPKc(%struct.State* %0, i64 %357, %struct.Memory* %call2_409740)
