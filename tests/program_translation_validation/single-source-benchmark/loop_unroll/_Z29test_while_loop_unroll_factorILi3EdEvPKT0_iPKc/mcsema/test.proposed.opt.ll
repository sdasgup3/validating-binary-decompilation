...
entry:
  ...
  %call2_409693 = tail call %struct.Memory* @sub_400dd0._Z11start_timerv(%struct.State* %0, i64 %58, %struct.Memory* %2)
...
block_.L_40969f:                                  ; preds = %block_.L_409728, %entry
  %79 = phi i64 [ %.pre, %entry ], [ %349, %block_.L_409728 ]
  %MEMORY.0 = phi %struct.Memory* [ %call2_409693, %entry ], [ %call2_40972d, %block_.L_409728 ]
  ...
  br i1 %112, label %block_4096af, label %block_.L_409740
...
block_.L_4096be:                                  ; preds = %block_4096cf, %block_4096af
  %124 = phi i64 [ %.pre1, %block_4096af ], [ %207, %block_4096cf ]
  %MEMORY.1 = phi %struct.Memory* [ %MEMORY.0, %block_4096af ], [ %call2_4096da, %block_4096cf ]
  ...
  br i1 %162, label %block_4096cf, label %block_.L_4096ed
...
block_4096cf:                                     ; preds = %block_.L_4096be
  ...
  %call2_4096da = tail call %struct.Memory* @sub_402070._ZN15loop_inner_bodyILi3EdE7do_workERdPKdi(%struct.State* %0, i64 %172, %struct.Memory* %MEMORY.1)
...
block_.L_4096f2:                                  ; preds = %block_4096fe, %block_.L_4096ed
  %209 = phi i64 [ %208, %block_.L_4096ed ], [ %306, %block_4096fe ]
  %210 = phi i64 [ %125, %block_.L_4096ed ], [ %.pre2, %block_4096fe ]
  %MEMORY.2 = phi %struct.Memory* [ %MEMORY.1, %block_.L_4096ed ], [ %call2_40970b, %block_4096fe ]
  %211 = add i64 %210, -44
  %212 = add i64 %209, 3
  ...
  br i1 %245, label %block_4096fe, label %block_.L_409728
...
block_4096fe:                                     ; preds = %block_.L_4096f2
  ...
  %call2_40970b = tail call %struct.Memory* @sub_401480._Z18complete_hash_funcIdET_S0_(%struct.State* %0, i64 %260, %struct.Memory* %MEMORY.2)
...
block_.L_409728:                                  ; preds = %block_.L_4096f2
  ...
  %call2_40972d = tail call %struct.Memory* @sub_4014b0._Z9check_sumIdEvT_(%struct.State* %0, i64 %312, %struct.Memory* %MEMORY.2)
...
block_.L_409740:                                  ; preds = %block_.L_40969f
  ...
  %call2_409740 = tail call %struct.Memory* @sub_400df0._Z5timerv(%struct.State* %0, i64 %350, %struct.Memory* %MEMORY.0)
  ...
  %call2_409749 = tail call %struct.Memory* @sub_400790._Z13record_resultdPKc(%struct.State* %0, i64 %361, %struct.Memory* %call2_409740)
  ...
  ret %struct.Memory* %call2_409749
}
...
define %struct.Memory* @routine_jge_.L_409740(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i8* %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
...
define %struct.Memory* @routine_jge_.L_4096ed(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i8* %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 2, i32 9
...
define %struct.Memory* @routine_jmpq_.L_4096be(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
...
define %struct.Memory* @routine_jmpq_.L_4096f2(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
...
define %struct.Memory* @routine_jge_.L_409728(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i8* %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 2, i32 9
...
define %struct.Memory* @routine_jmpq_.L_40969f(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
