...
block_.L_413e8f:                                  ; preds = %block_.L_413f11, %entry
  %68 = phi i64 [ %.pre, %entry ], [ %363, %block_.L_413f11 ]
...
block_.L_413ee1:                                  ; preds = %block_413eed, %block_.L_413edc
  %196 = phi i64 [ %195, %block_.L_413edc ], [ %320, %block_413eed ]
...
block_.L_413f11:                                  ; preds = %block_.L_413ee1
  ...
  %call2_413f14 = tail call %struct.Memory* @sub_40c100._Z9check_sumIiEvT_(%struct.State* %0, i64 %326, %struct.Memory* %MEMORY.2)
...
block_.L_413f27:                                  ; preds = %block_.L_413e8f
  ...
  %call2_413f27 = tail call %struct.Memory* @sub_400df0._Z5timerv(%struct.State* %0, i64 %364, %struct.Memory* %MEMORY.0)
  ...
  %call2_413f30 = tail call %struct.Memory* @sub_400790._Z13record_resultdPKc(%struct.State* %0, i64 %375, %struct.Memory* %call2_413f27)
