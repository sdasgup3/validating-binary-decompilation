...
entry:
  ...
  %call2_413e83 = tail call %struct.Memory* @sub_400dd0._Z11start_timerv(%struct.State* %0, i64 %58, %struct.Memory* %2)
...
block_.L_413e8f:                                  ; preds = %block_.L_413f11, %entry
  %68 = phi i64 [ %.pre, %entry ], [ %361, %block_.L_413f11 ]
  %MEMORY.0 = phi %struct.Memory* [ %call2_413e83, %entry ], [ %call2_413f14, %block_.L_413f11 ]
  ...
  br i1 %101, label %block_413e9f, label %block_.L_413f27
...
block_.L_413ead:                                  ; preds = %block_413ebe, %block_413e9f
  %111 = phi i64 [ %.pre1, %block_413e9f ], [ %194, %block_413ebe ]
  %MEMORY.1 = phi %struct.Memory* [ %MEMORY.0, %block_413e9f ], [ %call2_413ec9, %block_413ebe ]
  ...
  br i1 %149, label %block_413ebe, label %block_.L_413edc
...
block_413ebe:                                     ; preds = %block_.L_413ead
  ...
  %call2_413ec9 = tail call %struct.Memory* @sub_40cc30._ZN15loop_inner_bodyILi3EiE7do_workERiPKii(%struct.State* %0, i64 %159, %struct.Memory* %MEMORY.1)
...
block_.L_413ee1:                                  ; preds = %block_413eed, %block_.L_413edc
  %196 = phi i64 [ %195, %block_.L_413edc ], [ %319, %block_413eed ]
  %197 = phi i64 [ %112, %block_.L_413edc ], [ %.pre2, %block_413eed ]
  %MEMORY.2 = phi %struct.Memory* [ %MEMORY.1, %block_.L_413edc ], [ %call2_413ef8, %block_413eed ]
  %198 = add i64 %197, -36
  %199 = add i64 %196, 3
  ...
  br i1 %232, label %block_413eed, label %block_.L_413f11
...
block_413eed:                                     ; preds = %block_.L_413ee1
  ...
  %call2_413ef8 = tail call %struct.Memory* @sub_40c0d0._Z18complete_hash_funcIiET_S0_(%struct.State* %0, i64 %247, %struct.Memory* %MEMORY.2)
...
block_.L_413f11:                                  ; preds = %block_.L_413ee1
  ...
  %call2_413f14 = tail call %struct.Memory* @sub_40c100._Z9check_sumIiEvT_(%struct.State* %0, i64 %325, %struct.Memory* %MEMORY.2)
...
block_.L_413f27:                                  ; preds = %block_.L_413e8f
  ...
  %call2_413f27 = tail call %struct.Memory* @sub_400df0._Z5timerv(%struct.State* %0, i64 %362, %struct.Memory* %MEMORY.0)
  ...
  %call2_413f30 = tail call %struct.Memory* @sub_400790._Z13record_resultdPKc(%struct.State* %0, i64 %373, %struct.Memory* %call2_413f27)
  ...
  ret %struct.Memory* %call2_413f30
}
...
define %struct.Memory* @routine_jge_.L_413f27(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i8* %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
...
define %struct.Memory* @routine_jge_.L_413edc(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i8* %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 2, i32 9
...
define %struct.Memory* @routine_jmpq_.L_413ead(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
...
define %struct.Memory* @routine_jmpq_.L_413ee1(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
...
define %struct.Memory* @routine_jge_.L_413f11(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i8* %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 2, i32 9
...
define %struct.Memory* @routine_jmpq_.L_413e8f(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
