...
define %struct.Memory* @_Z29test_while_loop_unroll_factorILi3EiEvPKT0_iPKc(%struct.State* noalias, i64, %struct.Memory* noalias readnone) local_unnamed_addr #1 {
entry:
...
block_.L_413ebf:                                  ; preds = %block_.L_413f41, %entry
  %68 = phi i64 [ %361, %block_.L_413f41 ], [ %.pre, %entry ]
...
block_.L_413edd:                                  ; preds = %block_413eee, %block_413ecf
  %111 = phi i64 [ %194, %block_413eee ], [ %.pre9, %block_413ecf ]
...
block_413eee:                                     ; preds = %block_.L_413edd
  ...
  %call2_413ef9 = tail call %struct.Memory* @sub_40cc60._ZN15loop_inner_bodyILi3EiE7do_workERiPKii(%struct.State* nonnull %0, i64 %159, %struct.Memory* %call2_413eb3)
...
block_413f1d:                                     ; preds = %block_.L_413f11
  ...
  %call2_413f28 = tail call %struct.Memory* @sub_40c100._Z18complete_hash_funcIiET_S0_(%struct.State* nonnull %0, i64 %246, %struct.Memory* %call2_413eb3)
...
block_.L_413f41:                                  ; preds = %block_.L_413f11
  ...
  %call2_413f44 = tail call %struct.Memory* @sub_40c130._Z9check_sumIiEvT_(%struct.State* nonnull %0, i64 %325, %struct.Memory* %call2_413eb3)
...
block_.L_413f57:                                  ; preds = %block_.L_413ebf
  ...
  %call2_413f57 = tail call %struct.Memory* @sub_400e20._Z5timerv(%struct.State* nonnull %0, i64 %362, %struct.Memory* %call2_413eb3)
