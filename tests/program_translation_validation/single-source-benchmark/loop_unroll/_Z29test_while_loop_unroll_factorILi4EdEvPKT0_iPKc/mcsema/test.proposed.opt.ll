...
block_.L_40956f:                                  ; preds = %block_.L_4095f8, %entry
  %79 = phi i64 [ %.pre, %entry ], [ %345, %block_.L_4095f8 ]
...
block_.L_4095c2:                                  ; preds = %block_4095ce, %block_.L_4095bd
  %209 = phi i64 [ %208, %block_.L_4095bd ], [ %304, %block_4095ce ]
...
block_4095ce:                                     ; preds = %block_.L_4095c2
  ...
  %call2_4095db = tail call %struct.Memory* @sub_401480._Z18complete_hash_funcIdET_S0_(%struct.State* %0, i64 %259, %struct.Memory* %MEMORY.2)
...
block_.L_4095f8:                                  ; preds = %block_.L_4095c2
  ...
  %call2_4095fd = tail call %struct.Memory* @sub_4014b0._Z9check_sumIdEvT_(%struct.State* %0, i64 %309, %struct.Memory* %MEMORY.2)
...
block_.L_409610:                                  ; preds = %block_.L_40956f
  ...
  %call2_409610 = tail call %struct.Memory* @sub_400df0._Z5timerv(%struct.State* %0, i64 %346, %struct.Memory* %MEMORY.0)
  ...
  %call2_409619 = tail call %struct.Memory* @sub_400790._Z13record_resultdPKc(%struct.State* %0, i64 %357, %struct.Memory* %call2_409610)
