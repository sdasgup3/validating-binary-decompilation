...
define %struct.Memory* @_Z29test_while_loop_unroll_factorILi4EdEvPKT0_iPKc(%struct.State* noalias, i64, %struct.Memory* noalias) local_unnamed_addr #1 {
entry:
  ...
  %call2_409593 = tail call %struct.Memory* @sub_400e00._Z11start_timerv(%struct.State* %0, i64 %58, %struct.Memory* %2)
  ...
  br label %block_.L_40959f

block_.L_40959f:                                  ; preds = %block_.L_409628, %entry
  %74 = phi i64 [ %.pre, %entry ], [ %340, %block_.L_409628 ]
  %MEMORY.0 = phi %struct.Memory* [ %call2_409593, %entry ], [ %call2_40962d, %block_.L_409628 ]
  ...
  br i1 %107, label %block_4095af, label %block_.L_409640

block_4095af:                                     ; preds = %block_.L_40959f
  ...
  br label %block_.L_4095be

block_.L_4095be:                                  ; preds = %block_4095cf, %block_4095af
  %118 = phi i64 [ %.pre9, %block_4095af ], [ %201, %block_4095cf ]
  %MEMORY.1 = phi %struct.Memory* [ %MEMORY.0, %block_4095af ], [ %call2_4095da, %block_4095cf ]
  ...
  br i1 %156, label %block_4095cf, label %block_.L_4095ed

block_4095cf:                                     ; preds = %block_.L_4095be
  %158 = add i64 %119, -40
  ...
  %call2_4095da = tail call %struct.Memory* @sub_402040._ZN15loop_inner_bodyILi4EdE7do_workERdPKdi(%struct.State* nonnull %0, i64 %166, %struct.Memory* %MEMORY.1)
...
block_.L_4095ed:                                  ; preds = %block_.L_4095be
  %202 = add i64 %157, 5
  br label %block_.L_4095f2

block_.L_4095f2:                                  ; preds = %block_4095fe, %block_.L_4095ed
  %203 = phi i64 [ %119, %block_.L_4095ed ], [ %.pre10, %block_4095fe ]
  %storemerge = phi i64 [ %202, %block_.L_4095ed ], [ %298, %block_4095fe ]
  %MEMORY.2 = phi %struct.Memory* [ %MEMORY.1, %block_.L_4095ed ], [ %call2_40960b, %block_4095fe ]
  %204 = add i64 %203, -44
  ...
  br i1 %238, label %block_4095fe, label %block_.L_409628

block_4095fe:                                     ; preds = %block_.L_4095f2
  %240 = add i64 %203, -8
  %241 = add i64 %239, 4
  ...
  %call2_40960b = tail call %struct.Memory* @sub_4014b0._Z18complete_hash_funcIdET_S0_(%struct.State* nonnull %0, i64 %252, %struct.Memory* %MEMORY.2)
...
block_.L_409628:                                  ; preds = %block_.L_4095f2
  %300 = add i64 %203, -40
  %301 = add i64 %239, 5
  ...
  %call2_40962d = tail call %struct.Memory* @sub_4014e0._Z9check_sumIdEvT_(%struct.State* nonnull %0, i64 %304, %struct.Memory* %MEMORY.2)
...
block_.L_409640:                                  ; preds = %block_.L_40959f
  %341 = add i64 %108, -34848
  %342 = add i64 %108, 5
  ...
  %call2_409640 = tail call %struct.Memory* @sub_400e20._Z5timerv(%struct.State* nonnull %0, i64 %341, %struct.Memory* %MEMORY.0)
  ...
  %call2_409649 = tail call %struct.Memory* @sub_4007c0._Z13record_resultdPKc(%struct.State* nonnull %0, i64 %352, %struct.Memory* %call2_409640)
  ...
  ret %struct.Memory* %call2_409649
}
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_jge_.L_409640(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i8* nocapture %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_jge_.L_4095ed(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i8* nocapture %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 2, i32 9
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_jmpq_.L_4095be(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_jmpq_.L_4095f2(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_jge_.L_409628(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i8* nocapture %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 2, i32 9
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_jmpq_.L_40959f(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
