...
block_.L_40959f:                                  ; preds = %block_.L_409628, %entry
  %74 = phi i64 [ %340, %block_.L_409628 ], [ %.pre, %entry ]
...
block_.L_4095be:                                  ; preds = %block_4095cf, %block_4095af
  %118 = phi i64 [ %201, %block_4095cf ], [ %.pre9, %block_4095af ]
...
block_4095cf:                                     ; preds = %block_.L_4095be
  ...
  %call2_4095da = tail call %struct.Memory* @sub_402040._ZN15loop_inner_bodyILi4EdE7do_workERdPKdi(%struct.State* nonnull %0, i64 %166, %struct.Memory* %call2_409593)
...
block_4095fe:                                     ; preds = %block_.L_4095f2
  ...
  %call2_40960b = tail call %struct.Memory* @sub_4014b0._Z18complete_hash_funcIdET_S0_(%struct.State* nonnull %0, i64 %252, %struct.Memory* %call2_409593)
...
block_.L_409628:                                  ; preds = %block_.L_4095f2
  ...
  %call2_40962d = tail call %struct.Memory* @sub_4014e0._Z9check_sumIdEvT_(%struct.State* nonnull %0, i64 %304, %struct.Memory* %call2_409593)
...
block_.L_409640:                                  ; preds = %block_.L_40959f
  ...
  %call2_409640 = tail call %struct.Memory* @sub_400e20._Z5timerv(%struct.State* nonnull %0, i64 %341, %struct.Memory* %call2_409593)
