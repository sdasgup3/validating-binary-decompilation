...
declare %struct.Memory* @sub_40cbd0._ZN15loop_inner_bodyILi4EiE7do_workERiPKii(%struct.State* noalias dereferenceable(3376), i64, %struct.Memory* noalias readnone returned) local_unnamed_addr
...
entry:
  ...
  %call2_413d63 = tail call %struct.Memory* @sub_400dd0._Z11start_timerv(%struct.State* %0, i64 %58, %struct.Memory* %2)
...
block_.L_413d6f:                                  ; preds = %block_.L_413df1, %entry
  %68 = phi i64 [ %.pre, %entry ], [ %363, %block_.L_413df1 ]
  %MEMORY.0 = phi %struct.Memory* [ %call2_413d63, %entry ], [ %call2_413df4, %block_.L_413df1 ]
  ...
  br i1 %101, label %block_413d7f, label %block_.L_413e07

block_413d7f:                                     ; preds = %block_.L_413d6f
  %103 = add i64 %69, -32
  %104 = add i64 %102, 7
  ...
  br label %block_.L_413d8d

block_.L_413d8d:                                  ; preds = %block_413d9e, %block_413d7f
  %111 = phi i64 [ %.pre1, %block_413d7f ], [ %194, %block_413d9e ]
  %MEMORY.1 = phi %struct.Memory* [ %MEMORY.0, %block_413d7f ], [ %call2_413da9, %block_413d9e ]
  ...
  br i1 %149, label %block_413d9e, label %block_.L_413dbc

block_413d9e:                                     ; preds = %block_.L_413d8d
  %151 = add i64 %112, -32
  ...
  %call2_413da9 = tail call %struct.Memory* @sub_40cbd0._ZN15loop_inner_bodyILi4EiE7do_workERiPKii(%struct.State* %0, i64 %159, %struct.Memory* %MEMORY.1)
...
block_.L_413dbc:                                  ; preds = %block_.L_413d8d
  %195 = add i64 %150, 5
  store i64 %195, i64* %3, align 8
  br label %block_.L_413dc1

block_.L_413dc1:                                  ; preds = %block_413dcd, %block_.L_413dbc
  %196 = phi i64 [ %195, %block_.L_413dbc ], [ %320, %block_413dcd ]
  %197 = phi i64 [ %112, %block_.L_413dbc ], [ %.pre2, %block_413dcd ]
  %MEMORY.2 = phi %struct.Memory* [ %MEMORY.1, %block_.L_413dbc ], [ %call2_413dd8, %block_413dcd ]
  %198 = add i64 %197, -36
  %199 = add i64 %196, 3
  ...
  br i1 %232, label %block_413dcd, label %block_.L_413df1

block_413dcd:                                     ; preds = %block_.L_413dc1
  %234 = add i64 %197, -8
  %235 = add i64 %233, 4
  ...
  %call2_413dd8 = tail call %struct.Memory* @sub_40c0d0._Z18complete_hash_funcIiET_S0_(%struct.State* %0, i64 %247, %struct.Memory* %MEMORY.2)
...
block_.L_413df1:                                  ; preds = %block_.L_413dc1
  %321 = add i64 %197, -32
  %322 = add i64 %233, 3
  ...
  %call2_413df4 = tail call %struct.Memory* @sub_40c100._Z9check_sumIiEvT_(%struct.State* %0, i64 %326, %struct.Memory* %MEMORY.2)
...
block_.L_413e07:                                  ; preds = %block_.L_413d6f
  %364 = add i64 %102, -77847
  %365 = add i64 %102, 5
  ...
  %call2_413e07 = tail call %struct.Memory* @sub_400df0._Z5timerv(%struct.State* %0, i64 %364, %struct.Memory* %MEMORY.0)
  ...
  %call2_413e10 = tail call %struct.Memory* @sub_400790._Z13record_resultdPKc(%struct.State* %0, i64 %375, %struct.Memory* %call2_413e07)
  ...
  ret %struct.Memory* %call2_413e10
}
...
define %struct.Memory* @routine_jge_.L_413e07(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i8* %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
...
define %struct.Memory* @routine_jge_.L_413dbc(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i8* %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 2, i32 9
...
define %struct.Memory* @routine_callq_._ZN15loop_inner_bodyILi4EiE7do_workERiPKii(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
...
define %struct.Memory* @routine_jmpq_.L_413d8d(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
...
define %struct.Memory* @routine_jmpq_.L_413dc1(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
...
define %struct.Memory* @routine_jge_.L_413df1(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i8* %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 2, i32 9
...
define %struct.Memory* @routine_jmpq_.L_413d6f(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
