...
block_.L_413d6f:                                  ; preds = %block_.L_413df1, %entry
  %68 = phi i64 [ %.pre, %entry ], [ %361, %block_.L_413df1 ]
...
block_.L_413dc1:                                  ; preds = %block_413dcd, %block_.L_413dbc
  %196 = phi i64 [ %195, %block_.L_413dbc ], [ %319, %block_413dcd ]
...
block_.L_413df1:                                  ; preds = %block_.L_413dc1
  ...
  %call2_413df4 = tail call %struct.Memory* @sub_40c100._Z9check_sumIiEvT_(%struct.State* %0, i64 %325, %struct.Memory* %MEMORY.2)
...
block_.L_413e07:                                  ; preds = %block_.L_413d6f
  ...
  %call2_413e07 = tail call %struct.Memory* @sub_400df0._Z5timerv(%struct.State* %0, i64 %362, %struct.Memory* %MEMORY.0)
  ...
  %call2_413e10 = tail call %struct.Memory* @sub_400790._Z13record_resultdPKc(%struct.State* %0, i64 %373, %struct.Memory* %call2_413e07)
