...
declare %struct.Memory* @sub_40cc00._ZN15loop_inner_bodyILi4EiE7do_workERiPKii(%struct.State* noalias dereferenceable(3376), i64, %struct.Memory* noalias readnone returned) local_unnamed_addr
...
define %struct.Memory* @_Z29test_while_loop_unroll_factorILi4EiEvPKT0_iPKc(%struct.State* noalias, i64, %struct.Memory* noalias readnone) local_unnamed_addr #1 {
entry:
...
block_.L_413d9f:                                  ; preds = %block_.L_413e21, %entry
  %68 = phi i64 [ %361, %block_.L_413e21 ], [ %.pre, %entry ]
...
block_.L_413dbd:                                  ; preds = %block_413dce, %block_413daf
  %111 = phi i64 [ %194, %block_413dce ], [ %.pre9, %block_413daf ]
...
block_413dce:                                     ; preds = %block_.L_413dbd
  ...
  %call2_413dd9 = tail call %struct.Memory* @sub_40cc00._ZN15loop_inner_bodyILi4EiE7do_workERiPKii(%struct.State* nonnull %0, i64 %159, %struct.Memory* %call2_413d93)
...
block_413dfd:                                     ; preds = %block_.L_413df1
  ...
  %call2_413e08 = tail call %struct.Memory* @sub_40c100._Z18complete_hash_funcIiET_S0_(%struct.State* nonnull %0, i64 %246, %struct.Memory* %call2_413d93)
...
block_.L_413e21:                                  ; preds = %block_.L_413df1
  ...
  %call2_413e24 = tail call %struct.Memory* @sub_40c130._Z9check_sumIiEvT_(%struct.State* nonnull %0, i64 %325, %struct.Memory* %call2_413d93)
...
block_.L_413e37:                                  ; preds = %block_.L_413d9f
  ...
  %call2_413e37 = tail call %struct.Memory* @sub_400e20._Z5timerv(%struct.State* nonnull %0, i64 %362, %struct.Memory* %call2_413d93)
