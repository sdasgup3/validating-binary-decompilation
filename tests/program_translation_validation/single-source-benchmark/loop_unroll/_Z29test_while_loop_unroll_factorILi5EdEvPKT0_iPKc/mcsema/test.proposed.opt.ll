...
entry:
  ...
  %call2_409433 = tail call %struct.Memory* @sub_400dd0._Z11start_timerv(%struct.State* %0, i64 %58, %struct.Memory* %2)
...
block_.L_40943f:                                  ; preds = %block_.L_4094c8, %entry
  %79 = phi i64 [ %.pre, %entry ], [ %345, %block_.L_4094c8 ]
  %MEMORY.0 = phi %struct.Memory* [ %call2_409433, %entry ], [ %call2_4094cd, %block_.L_4094c8 ]
  ...
  br i1 %112, label %block_40944f, label %block_.L_4094e0
...
block_.L_40945e:                                  ; preds = %block_40946f, %block_40944f
  %124 = phi i64 [ %.pre1, %block_40944f ], [ %207, %block_40946f ]
  %MEMORY.1 = phi %struct.Memory* [ %MEMORY.0, %block_40944f ], [ %call2_40947a, %block_40946f ]
  ...
  br i1 %162, label %block_40946f, label %block_.L_40948d
...
block_40946f:                                     ; preds = %block_.L_40945e
  ...
  %call2_40947a = tail call %struct.Memory* @sub_401fb0._ZN15loop_inner_bodyILi5EdE7do_workERdPKdi(%struct.State* %0, i64 %172, %struct.Memory* %MEMORY.1)
...
block_.L_409492:                                  ; preds = %block_40949e, %block_.L_40948d
  %209 = phi i64 [ %208, %block_.L_40948d ], [ %304, %block_40949e ]
  %210 = phi i64 [ %125, %block_.L_40948d ], [ %.pre2, %block_40949e ]
  %MEMORY.2 = phi %struct.Memory* [ %MEMORY.1, %block_.L_40948d ], [ %call2_4094ab, %block_40949e ]
  %211 = add i64 %210, -44
  %212 = add i64 %209, 3
  ...
  br i1 %245, label %block_40949e, label %block_.L_4094c8
...
block_40949e:                                     ; preds = %block_.L_409492
  ...
  %call2_4094ab = tail call %struct.Memory* @sub_401480._Z18complete_hash_funcIdET_S0_(%struct.State* %0, i64 %259, %struct.Memory* %MEMORY.2)
...
block_.L_4094c8:                                  ; preds = %block_.L_409492
  ...
  %call2_4094cd = tail call %struct.Memory* @sub_4014b0._Z9check_sumIdEvT_(%struct.State* %0, i64 %309, %struct.Memory* %MEMORY.2)
...
block_.L_4094e0:                                  ; preds = %block_.L_40943f
  ...
  %call2_4094e0 = tail call %struct.Memory* @sub_400df0._Z5timerv(%struct.State* %0, i64 %346, %struct.Memory* %MEMORY.0)
  ...
  %call2_4094e9 = tail call %struct.Memory* @sub_400790._Z13record_resultdPKc(%struct.State* %0, i64 %357, %struct.Memory* %call2_4094e0)
  ...
  ret %struct.Memory* %call2_4094e9
}
...
define %struct.Memory* @routine_jge_.L_4094e0(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i8* %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
...
define %struct.Memory* @routine_jge_.L_40948d(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i8* %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 2, i32 9
...
define %struct.Memory* @routine_jmpq_.L_40945e(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
...
define %struct.Memory* @routine_jmpq_.L_409492(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
...
define %struct.Memory* @routine_jge_.L_4094c8(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i8* %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 2, i32 9
...
define %struct.Memory* @routine_jmpq_.L_40943f(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
