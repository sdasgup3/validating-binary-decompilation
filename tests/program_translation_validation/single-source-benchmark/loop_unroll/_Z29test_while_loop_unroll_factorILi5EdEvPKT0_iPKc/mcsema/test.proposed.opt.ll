...
block_.L_40946f:                                  ; preds = %block_.L_4094f8, %entry
  %74 = phi i64 [ %340, %block_.L_4094f8 ], [ %.pre, %entry ]
...
block_.L_40948e:                                  ; preds = %block_40949f, %block_40947f
  %118 = phi i64 [ %201, %block_40949f ], [ %.pre9, %block_40947f ]
...
block_40949f:                                     ; preds = %block_.L_40948e
  ...
  %call2_4094aa = tail call %struct.Memory* @sub_401fe0._ZN15loop_inner_bodyILi5EdE7do_workERdPKdi(%struct.State* nonnull %0, i64 %166, %struct.Memory* %call2_409463)
...
block_4094ce:                                     ; preds = %block_.L_4094c2
  ...
  %call2_4094db = tail call %struct.Memory* @sub_4014b0._Z18complete_hash_funcIdET_S0_(%struct.State* nonnull %0, i64 %252, %struct.Memory* %call2_409463)
...
block_.L_4094f8:                                  ; preds = %block_.L_4094c2
  ...
  %call2_4094fd = tail call %struct.Memory* @sub_4014e0._Z9check_sumIdEvT_(%struct.State* nonnull %0, i64 %304, %struct.Memory* %call2_409463)
...
block_.L_409510:                                  ; preds = %block_.L_40946f
  ...
  %call2_409510 = tail call %struct.Memory* @sub_400e20._Z5timerv(%struct.State* nonnull %0, i64 %341, %struct.Memory* %call2_409463)
