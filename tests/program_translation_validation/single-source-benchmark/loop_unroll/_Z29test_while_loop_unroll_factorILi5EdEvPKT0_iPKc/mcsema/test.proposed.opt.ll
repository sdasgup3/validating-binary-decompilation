...
block_.L_40943f:                                  ; preds = %block_.L_4094c8, %entry
  %79 = phi i64 [ %.pre, %entry ], [ %349, %block_.L_4094c8 ]
...
block_.L_409492:                                  ; preds = %block_40949e, %block_.L_40948d
  %209 = phi i64 [ %208, %block_.L_40948d ], [ %306, %block_40949e ]
...
block_40949e:                                     ; preds = %block_.L_409492
  ...
  %call2_4094ab = tail call %struct.Memory* @sub_401480._Z18complete_hash_funcIdET_S0_(%struct.State* %0, i64 %260, %struct.Memory* %MEMORY.2)
...
block_.L_4094c8:                                  ; preds = %block_.L_409492
  ...
  %call2_4094cd = tail call %struct.Memory* @sub_4014b0._Z9check_sumIdEvT_(%struct.State* %0, i64 %312, %struct.Memory* %MEMORY.2)
...
block_.L_4094e0:                                  ; preds = %block_.L_40943f
  ...
  %call2_4094e0 = tail call %struct.Memory* @sub_400df0._Z5timerv(%struct.State* %0, i64 %350, %struct.Memory* %MEMORY.0)
  ...
  %call2_4094e9 = tail call %struct.Memory* @sub_400790._Z13record_resultdPKc(%struct.State* %0, i64 %361, %struct.Memory* %call2_4094e0)
