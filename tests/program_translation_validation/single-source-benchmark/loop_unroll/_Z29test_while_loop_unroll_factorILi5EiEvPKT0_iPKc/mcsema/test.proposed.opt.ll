...
block_.L_413c4f:                                  ; preds = %block_.L_413cd1, %entry
  %68 = phi i64 [ %.pre, %entry ], [ %361, %block_.L_413cd1 ]
...
block_.L_413ca1:                                  ; preds = %block_413cad, %block_.L_413c9c
  %196 = phi i64 [ %195, %block_.L_413c9c ], [ %319, %block_413cad ]
...
block_.L_413cd1:                                  ; preds = %block_.L_413ca1
  ...
  %call2_413cd4 = tail call %struct.Memory* @sub_40c100._Z9check_sumIiEvT_(%struct.State* %0, i64 %325, %struct.Memory* %MEMORY.2)
...
block_.L_413ce7:                                  ; preds = %block_.L_413c4f
  ...
  %call2_413ce7 = tail call %struct.Memory* @sub_400df0._Z5timerv(%struct.State* %0, i64 %362, %struct.Memory* %MEMORY.0)
  ...
  %call2_413cf0 = tail call %struct.Memory* @sub_400790._Z13record_resultdPKc(%struct.State* %0, i64 %373, %struct.Memory* %call2_413ce7)
