...
define %struct.Memory* @_Z29test_while_loop_unroll_factorILi6EdEvPKT0_iPKc(%struct.State* noalias, i64, %struct.Memory* noalias readnone) local_unnamed_addr #1 {
entry:
...
block_.L_40933f:                                  ; preds = %block_.L_4093c8, %entry
  %74 = phi i64 [ %340, %block_.L_4093c8 ], [ %.pre, %entry ]
...
block_.L_40935e:                                  ; preds = %block_40936f, %block_40934f
  %118 = phi i64 [ %201, %block_40936f ], [ %.pre9, %block_40934f ]
...
block_40936f:                                     ; preds = %block_.L_40935e
  ...
  %call2_40937a = tail call %struct.Memory* @sub_401f80._ZN15loop_inner_bodyILi6EdE7do_workERdPKdi(%struct.State* nonnull %0, i64 %166, %struct.Memory* %call2_409333)
...
block_40939e:                                     ; preds = %block_.L_409392
  ...
  %call2_4093ab = tail call %struct.Memory* @sub_4014b0._Z18complete_hash_funcIdET_S0_(%struct.State* nonnull %0, i64 %252, %struct.Memory* %call2_409333)
...
block_.L_4093c8:                                  ; preds = %block_.L_409392
  ...
  %call2_4093cd = tail call %struct.Memory* @sub_4014e0._Z9check_sumIdEvT_(%struct.State* nonnull %0, i64 %304, %struct.Memory* %call2_409333)
...
block_.L_4093e0:                                  ; preds = %block_.L_40933f
  ...
  %call2_4093e0 = tail call %struct.Memory* @sub_400e20._Z5timerv(%struct.State* nonnull %0, i64 %341, %struct.Memory* %call2_409333)
