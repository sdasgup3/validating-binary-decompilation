...
block_.L_40930f:                                  ; preds = %block_.L_409398, %entry
  %79 = phi i64 [ %.pre, %entry ], [ %349, %block_.L_409398 ]
...
block_.L_409362:                                  ; preds = %block_40936e, %block_.L_40935d
  %209 = phi i64 [ %208, %block_.L_40935d ], [ %306, %block_40936e ]
...
block_40936e:                                     ; preds = %block_.L_409362
  ...
  %call2_40937b = tail call %struct.Memory* @sub_401480._Z18complete_hash_funcIdET_S0_(%struct.State* %0, i64 %260, %struct.Memory* %MEMORY.2)
...
block_.L_409398:                                  ; preds = %block_.L_409362
  ...
  %call2_40939d = tail call %struct.Memory* @sub_4014b0._Z9check_sumIdEvT_(%struct.State* %0, i64 %312, %struct.Memory* %MEMORY.2)
...
block_.L_4093b0:                                  ; preds = %block_.L_40930f
  ...
  %call2_4093b0 = tail call %struct.Memory* @sub_400df0._Z5timerv(%struct.State* %0, i64 %350, %struct.Memory* %MEMORY.0)
  ...
  %call2_4093b9 = tail call %struct.Memory* @sub_400790._Z13record_resultdPKc(%struct.State* %0, i64 %361, %struct.Memory* %call2_4093b0)
