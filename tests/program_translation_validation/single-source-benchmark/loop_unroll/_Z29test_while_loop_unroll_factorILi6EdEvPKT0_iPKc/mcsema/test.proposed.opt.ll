...
entry:
  ...
  %call2_409303 = tail call %struct.Memory* @sub_400dd0._Z11start_timerv(%struct.State* %0, i64 %58, %struct.Memory* %2)
...
block_.L_40930f:                                  ; preds = %block_.L_409398, %entry
  %79 = phi i64 [ %.pre, %entry ], [ %345, %block_.L_409398 ]
  %MEMORY.0 = phi %struct.Memory* [ %call2_409303, %entry ], [ %call2_40939d, %block_.L_409398 ]
  ...
  br i1 %112, label %block_40931f, label %block_.L_4093b0
...
block_.L_40932e:                                  ; preds = %block_40933f, %block_40931f
  %124 = phi i64 [ %.pre1, %block_40931f ], [ %207, %block_40933f ]
  %MEMORY.1 = phi %struct.Memory* [ %MEMORY.0, %block_40931f ], [ %call2_40934a, %block_40933f ]
  ...
  br i1 %162, label %block_40933f, label %block_.L_40935d
...
block_40933f:                                     ; preds = %block_.L_40932e
  ...
  %call2_40934a = tail call %struct.Memory* @sub_401f50._ZN15loop_inner_bodyILi6EdE7do_workERdPKdi(%struct.State* %0, i64 %172, %struct.Memory* %MEMORY.1)
...
block_.L_409362:                                  ; preds = %block_40936e, %block_.L_40935d
  %209 = phi i64 [ %208, %block_.L_40935d ], [ %304, %block_40936e ]
  %210 = phi i64 [ %125, %block_.L_40935d ], [ %.pre2, %block_40936e ]
  %MEMORY.2 = phi %struct.Memory* [ %MEMORY.1, %block_.L_40935d ], [ %call2_40937b, %block_40936e ]
  %211 = add i64 %210, -44
  %212 = add i64 %209, 3
  ...
  br i1 %245, label %block_40936e, label %block_.L_409398
...
block_40936e:                                     ; preds = %block_.L_409362
  ...
  %call2_40937b = tail call %struct.Memory* @sub_401480._Z18complete_hash_funcIdET_S0_(%struct.State* %0, i64 %259, %struct.Memory* %MEMORY.2)
...
block_.L_409398:                                  ; preds = %block_.L_409362
  ...
  %call2_40939d = tail call %struct.Memory* @sub_4014b0._Z9check_sumIdEvT_(%struct.State* %0, i64 %309, %struct.Memory* %MEMORY.2)
...
block_.L_4093b0:                                  ; preds = %block_.L_40930f
  ...
  %call2_4093b0 = tail call %struct.Memory* @sub_400df0._Z5timerv(%struct.State* %0, i64 %346, %struct.Memory* %MEMORY.0)
  ...
  %call2_4093b9 = tail call %struct.Memory* @sub_400790._Z13record_resultdPKc(%struct.State* %0, i64 %357, %struct.Memory* %call2_4093b0)
  ...
  ret %struct.Memory* %call2_4093b9
}
...
define %struct.Memory* @routine_jge_.L_4093b0(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i8* %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
...
define %struct.Memory* @routine_jge_.L_40935d(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i8* %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 2, i32 9
...
define %struct.Memory* @routine_jmpq_.L_40932e(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
...
define %struct.Memory* @routine_jmpq_.L_409362(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
...
define %struct.Memory* @routine_jge_.L_409398(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i8* %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 2, i32 9
...
define %struct.Memory* @routine_jmpq_.L_40930f(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
