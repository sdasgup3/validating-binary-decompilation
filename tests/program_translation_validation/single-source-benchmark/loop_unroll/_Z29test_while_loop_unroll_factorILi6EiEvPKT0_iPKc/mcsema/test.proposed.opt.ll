...
block_.L_413b2f:                                  ; preds = %block_.L_413bb1, %entry
  %68 = phi i64 [ %.pre, %entry ], [ %361, %block_.L_413bb1 ]
...
block_.L_413b81:                                  ; preds = %block_413b8d, %block_.L_413b7c
  %196 = phi i64 [ %195, %block_.L_413b7c ], [ %319, %block_413b8d ]
...
block_.L_413bb1:                                  ; preds = %block_.L_413b81
  ...
  %call2_413bb4 = tail call %struct.Memory* @sub_40c100._Z9check_sumIiEvT_(%struct.State* %0, i64 %325, %struct.Memory* %MEMORY.2)
...
block_.L_413bc7:                                  ; preds = %block_.L_413b2f
  ...
  %call2_413bc7 = tail call %struct.Memory* @sub_400df0._Z5timerv(%struct.State* %0, i64 %362, %struct.Memory* %MEMORY.0)
  ...
  %call2_413bd0 = tail call %struct.Memory* @sub_400790._Z13record_resultdPKc(%struct.State* %0, i64 %373, %struct.Memory* %call2_413bc7)
