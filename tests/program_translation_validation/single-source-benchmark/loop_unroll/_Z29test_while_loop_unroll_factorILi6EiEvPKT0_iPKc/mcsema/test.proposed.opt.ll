...
define %struct.Memory* @_Z29test_while_loop_unroll_factorILi6EiEvPKT0_iPKc(%struct.State* noalias, i64, %struct.Memory* noalias readnone) local_unnamed_addr #1 {
entry:
...
block_.L_413b5f:                                  ; preds = %block_.L_413be1, %entry
  %68 = phi i64 [ %361, %block_.L_413be1 ], [ %.pre, %entry ]
...
block_.L_413b7d:                                  ; preds = %block_413b8e, %block_413b6f
  %111 = phi i64 [ %194, %block_413b8e ], [ %.pre9, %block_413b6f ]
...
block_413b8e:                                     ; preds = %block_.L_413b7d
  ...
  %call2_413b99 = tail call %struct.Memory* @sub_40cb40._ZN15loop_inner_bodyILi6EiE7do_workERiPKii(%struct.State* nonnull %0, i64 %159, %struct.Memory* %call2_413b53)
...
block_413bbd:                                     ; preds = %block_.L_413bb1
  ...
  %call2_413bc8 = tail call %struct.Memory* @sub_40c100._Z18complete_hash_funcIiET_S0_(%struct.State* nonnull %0, i64 %246, %struct.Memory* %call2_413b53)
...
block_.L_413be1:                                  ; preds = %block_.L_413bb1
  ...
  %call2_413be4 = tail call %struct.Memory* @sub_40c130._Z9check_sumIiEvT_(%struct.State* nonnull %0, i64 %325, %struct.Memory* %call2_413b53)
...
block_.L_413bf7:                                  ; preds = %block_.L_413b5f
  ...
  %call2_413bf7 = tail call %struct.Memory* @sub_400e20._Z5timerv(%struct.State* nonnull %0, i64 %362, %struct.Memory* %call2_413b53)
