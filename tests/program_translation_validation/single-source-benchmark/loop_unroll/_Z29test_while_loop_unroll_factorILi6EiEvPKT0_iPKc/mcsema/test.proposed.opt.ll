...
entry:
  ...
  %call2_413b23 = tail call %struct.Memory* @sub_400dd0._Z11start_timerv(%struct.State* %0, i64 %58, %struct.Memory* %2)
...
block_.L_413b2f:                                  ; preds = %block_.L_413bb1, %entry
  %68 = phi i64 [ %.pre, %entry ], [ %363, %block_.L_413bb1 ]
  %MEMORY.0 = phi %struct.Memory* [ %call2_413b23, %entry ], [ %call2_413bb4, %block_.L_413bb1 ]
  ...
  br i1 %101, label %block_413b3f, label %block_.L_413bc7
...
block_.L_413b4d:                                  ; preds = %block_413b5e, %block_413b3f
  %111 = phi i64 [ %.pre1, %block_413b3f ], [ %194, %block_413b5e ]
  %MEMORY.1 = phi %struct.Memory* [ %MEMORY.0, %block_413b3f ], [ %call2_413b69, %block_413b5e ]
  ...
  br i1 %149, label %block_413b5e, label %block_.L_413b7c
...
block_413b5e:                                     ; preds = %block_.L_413b4d
  ...
  %call2_413b69 = tail call %struct.Memory* @sub_40cb10._ZN15loop_inner_bodyILi6EiE7do_workERiPKii(%struct.State* %0, i64 %159, %struct.Memory* %MEMORY.1)
...
block_.L_413b81:                                  ; preds = %block_413b8d, %block_.L_413b7c
  %196 = phi i64 [ %195, %block_.L_413b7c ], [ %320, %block_413b8d ]
  %197 = phi i64 [ %112, %block_.L_413b7c ], [ %.pre2, %block_413b8d ]
  %MEMORY.2 = phi %struct.Memory* [ %MEMORY.1, %block_.L_413b7c ], [ %call2_413b98, %block_413b8d ]
  %198 = add i64 %197, -36
  %199 = add i64 %196, 3
  ...
  br i1 %232, label %block_413b8d, label %block_.L_413bb1
...
block_413b8d:                                     ; preds = %block_.L_413b81
  ...
  %call2_413b98 = tail call %struct.Memory* @sub_40c0d0._Z18complete_hash_funcIiET_S0_(%struct.State* %0, i64 %247, %struct.Memory* %MEMORY.2)
...
block_.L_413bb1:                                  ; preds = %block_.L_413b81
  ...
  %call2_413bb4 = tail call %struct.Memory* @sub_40c100._Z9check_sumIiEvT_(%struct.State* %0, i64 %326, %struct.Memory* %MEMORY.2)
...
block_.L_413bc7:                                  ; preds = %block_.L_413b2f
  ...
  %call2_413bc7 = tail call %struct.Memory* @sub_400df0._Z5timerv(%struct.State* %0, i64 %364, %struct.Memory* %MEMORY.0)
  ...
  %call2_413bd0 = tail call %struct.Memory* @sub_400790._Z13record_resultdPKc(%struct.State* %0, i64 %375, %struct.Memory* %call2_413bc7)
  ...
  ret %struct.Memory* %call2_413bd0
}
...
define %struct.Memory* @routine_jge_.L_413bc7(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i8* %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
...
define %struct.Memory* @routine_jge_.L_413b7c(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i8* %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 2, i32 9
...
define %struct.Memory* @routine_jmpq_.L_413b4d(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
...
define %struct.Memory* @routine_jmpq_.L_413b81(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
...
define %struct.Memory* @routine_jge_.L_413bb1(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i8* %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 2, i32 9
...
define %struct.Memory* @routine_jmpq_.L_413b2f(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
