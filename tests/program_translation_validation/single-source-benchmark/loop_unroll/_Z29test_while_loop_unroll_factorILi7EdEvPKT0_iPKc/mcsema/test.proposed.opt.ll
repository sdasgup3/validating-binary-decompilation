...
entry:
  ...
  %call2_4091d3 = tail call %struct.Memory* @sub_400dd0._Z11start_timerv(%struct.State* %0, i64 %58, %struct.Memory* %2)
  ...
  br label %block_.L_4091df

block_.L_4091df:                                  ; preds = %block_.L_409268, %entry
  %79 = phi i64 [ %.pre, %entry ], [ %349, %block_.L_409268 ]
  %MEMORY.0 = phi %struct.Memory* [ %call2_4091d3, %entry ], [ %call2_40926d, %block_.L_409268 ]
  ...
  br i1 %112, label %block_4091ef, label %block_.L_409280

block_4091ef:                                     ; preds = %block_.L_4091df
  ...
  br label %block_.L_4091fe

block_.L_4091fe:                                  ; preds = %block_40920f, %block_4091ef
  %124 = phi i64 [ %.pre1, %block_4091ef ], [ %207, %block_40920f ]
  %MEMORY.1 = phi %struct.Memory* [ %MEMORY.0, %block_4091ef ], [ %call2_40921a, %block_40920f ]
  ...
  br i1 %162, label %block_40920f, label %block_.L_40922d

block_40920f:                                     ; preds = %block_.L_4091fe
  %164 = add i64 %125, -40
  ...
  %call2_40921a = tail call %struct.Memory* @sub_401ef0._ZN15loop_inner_bodyILi7EdE7do_workERdPKdi(%struct.State* %0, i64 %172, %struct.Memory* %MEMORY.1)
...
block_.L_40922d:                                  ; preds = %block_.L_4091fe
  %208 = add i64 %163, 5
  store i64 %208, i64* %3, align 8
  br label %block_.L_409232

block_.L_409232:                                  ; preds = %block_40923e, %block_.L_40922d
  %209 = phi i64 [ %208, %block_.L_40922d ], [ %306, %block_40923e ]
  %210 = phi i64 [ %125, %block_.L_40922d ], [ %.pre2, %block_40923e ]
  %MEMORY.2 = phi %struct.Memory* [ %MEMORY.1, %block_.L_40922d ], [ %call2_40924b, %block_40923e ]
  %211 = add i64 %210, -44
  %212 = add i64 %209, 3
  ...
  br i1 %245, label %block_40923e, label %block_.L_409268

block_40923e:                                     ; preds = %block_.L_409232
  %247 = add i64 %210, -8
  %248 = add i64 %246, 4
  ...
  %call2_40924b = tail call %struct.Memory* @sub_401480._Z18complete_hash_funcIdET_S0_(%struct.State* %0, i64 %260, %struct.Memory* %MEMORY.2)
...
block_.L_409268:                                  ; preds = %block_.L_409232
  %307 = add i64 %210, -40
  %308 = add i64 %246, 5
  ...
  %call2_40926d = tail call %struct.Memory* @sub_4014b0._Z9check_sumIdEvT_(%struct.State* %0, i64 %312, %struct.Memory* %MEMORY.2)
...
block_.L_409280:                                  ; preds = %block_.L_4091df
  %350 = add i64 %113, -33936
  %351 = add i64 %113, 5
  ...
  %call2_409280 = tail call %struct.Memory* @sub_400df0._Z5timerv(%struct.State* %0, i64 %350, %struct.Memory* %MEMORY.0)
  ...
  %call2_409289 = tail call %struct.Memory* @sub_400790._Z13record_resultdPKc(%struct.State* %0, i64 %361, %struct.Memory* %call2_409280)
  ...
  ret %struct.Memory* %call2_409289
}
...
define %struct.Memory* @routine_jge_.L_409280(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i8* %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
...
define %struct.Memory* @routine_jge_.L_40922d(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i8* %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 2, i32 9
...
define %struct.Memory* @routine_jmpq_.L_4091fe(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
...
define %struct.Memory* @routine_jmpq_.L_409232(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
...
define %struct.Memory* @routine_jge_.L_409268(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i8* %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 2, i32 9
...
define %struct.Memory* @routine_jmpq_.L_4091df(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
