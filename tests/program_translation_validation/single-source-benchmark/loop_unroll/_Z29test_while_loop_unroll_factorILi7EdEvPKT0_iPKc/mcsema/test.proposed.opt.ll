...
define %struct.Memory* @_Z29test_while_loop_unroll_factorILi7EdEvPKT0_iPKc(%struct.State* noalias, i64, %struct.Memory* noalias readnone) local_unnamed_addr #1 {
entry:
...
block_.L_40920f:                                  ; preds = %block_.L_409298, %entry
  %74 = phi i64 [ %340, %block_.L_409298 ], [ %.pre, %entry ]
...
block_.L_40922e:                                  ; preds = %block_40923f, %block_40921f
  %118 = phi i64 [ %201, %block_40923f ], [ %.pre9, %block_40921f ]
...
block_40923f:                                     ; preds = %block_.L_40922e
  ...
  %call2_40924a = tail call %struct.Memory* @sub_401f20._ZN15loop_inner_bodyILi7EdE7do_workERdPKdi(%struct.State* nonnull %0, i64 %166, %struct.Memory* %call2_409203)
...
block_40926e:                                     ; preds = %block_.L_409262
  ...
  %call2_40927b = tail call %struct.Memory* @sub_4014b0._Z18complete_hash_funcIdET_S0_(%struct.State* nonnull %0, i64 %252, %struct.Memory* %call2_409203)
...
block_.L_409298:                                  ; preds = %block_.L_409262
  ...
  %call2_40929d = tail call %struct.Memory* @sub_4014e0._Z9check_sumIdEvT_(%struct.State* nonnull %0, i64 %304, %struct.Memory* %call2_409203)
...
block_.L_4092b0:                                  ; preds = %block_.L_40920f
  ...
  %call2_4092b0 = tail call %struct.Memory* @sub_400e20._Z5timerv(%struct.State* nonnull %0, i64 %341, %struct.Memory* %call2_409203)
