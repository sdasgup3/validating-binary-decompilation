...
block_.L_4091df:                                  ; preds = %block_.L_409268, %entry
  %79 = phi i64 [ %.pre, %entry ], [ %345, %block_.L_409268 ]
...
block_.L_409232:                                  ; preds = %block_40923e, %block_.L_40922d
  %209 = phi i64 [ %208, %block_.L_40922d ], [ %304, %block_40923e ]
...
block_40923e:                                     ; preds = %block_.L_409232
  ...
  %call2_40924b = tail call %struct.Memory* @sub_401480._Z18complete_hash_funcIdET_S0_(%struct.State* %0, i64 %259, %struct.Memory* %MEMORY.2)
...
block_.L_409268:                                  ; preds = %block_.L_409232
  ...
  %call2_40926d = tail call %struct.Memory* @sub_4014b0._Z9check_sumIdEvT_(%struct.State* %0, i64 %309, %struct.Memory* %MEMORY.2)
...
block_.L_409280:                                  ; preds = %block_.L_4091df
  ...
  %call2_409280 = tail call %struct.Memory* @sub_400df0._Z5timerv(%struct.State* %0, i64 %346, %struct.Memory* %MEMORY.0)
  ...
  %call2_409289 = tail call %struct.Memory* @sub_400790._Z13record_resultdPKc(%struct.State* %0, i64 %357, %struct.Memory* %call2_409280)
