...
define %struct.Memory* @_Z29test_while_loop_unroll_factorILi7EdEvPKT0_iPKc(%struct.State* noalias, i64, %struct.Memory* noalias) local_unnamed_addr #1 {
entry:
  ...
  %call2_409203 = tail call %struct.Memory* @sub_400e00._Z11start_timerv(%struct.State* %0, i64 %58, %struct.Memory* %2)
  ...
  br label %block_.L_40920f

block_.L_40920f:                                  ; preds = %block_.L_409298, %entry
  %74 = phi i64 [ %.pre, %entry ], [ %340, %block_.L_409298 ]
  %MEMORY.0 = phi %struct.Memory* [ %call2_409203, %entry ], [ %call2_40929d, %block_.L_409298 ]
  ...
  br i1 %107, label %block_40921f, label %block_.L_4092b0

block_40921f:                                     ; preds = %block_.L_40920f
  ...
  br label %block_.L_40922e

block_.L_40922e:                                  ; preds = %block_40923f, %block_40921f
  %118 = phi i64 [ %.pre9, %block_40921f ], [ %201, %block_40923f ]
  %MEMORY.1 = phi %struct.Memory* [ %MEMORY.0, %block_40921f ], [ %call2_40924a, %block_40923f ]
  ...
  br i1 %156, label %block_40923f, label %block_.L_40925d

block_40923f:                                     ; preds = %block_.L_40922e
  %158 = add i64 %119, -40
  ...
  %call2_40924a = tail call %struct.Memory* @sub_401f20._ZN15loop_inner_bodyILi7EdE7do_workERdPKdi(%struct.State* nonnull %0, i64 %166, %struct.Memory* %MEMORY.1)
...
block_.L_40925d:                                  ; preds = %block_.L_40922e
  %202 = add i64 %157, 5
  br label %block_.L_409262

block_.L_409262:                                  ; preds = %block_40926e, %block_.L_40925d
  %203 = phi i64 [ %119, %block_.L_40925d ], [ %.pre10, %block_40926e ]
  %storemerge = phi i64 [ %202, %block_.L_40925d ], [ %298, %block_40926e ]
  %MEMORY.2 = phi %struct.Memory* [ %MEMORY.1, %block_.L_40925d ], [ %call2_40927b, %block_40926e ]
  %204 = add i64 %203, -44
  ...
  br i1 %238, label %block_40926e, label %block_.L_409298

block_40926e:                                     ; preds = %block_.L_409262
  %240 = add i64 %203, -8
  %241 = add i64 %239, 4
  ...
  %call2_40927b = tail call %struct.Memory* @sub_4014b0._Z18complete_hash_funcIdET_S0_(%struct.State* nonnull %0, i64 %252, %struct.Memory* %MEMORY.2)
...
block_.L_409298:                                  ; preds = %block_.L_409262
  %300 = add i64 %203, -40
  %301 = add i64 %239, 5
  ...
  %call2_40929d = tail call %struct.Memory* @sub_4014e0._Z9check_sumIdEvT_(%struct.State* nonnull %0, i64 %304, %struct.Memory* %MEMORY.2)
...
block_.L_4092b0:                                  ; preds = %block_.L_40920f
  %341 = add i64 %108, -33936
  %342 = add i64 %108, 5
  ...
  %call2_4092b0 = tail call %struct.Memory* @sub_400e20._Z5timerv(%struct.State* nonnull %0, i64 %341, %struct.Memory* %MEMORY.0)
  ...
  %call2_4092b9 = tail call %struct.Memory* @sub_4007c0._Z13record_resultdPKc(%struct.State* nonnull %0, i64 %352, %struct.Memory* %call2_4092b0)
  ...
  ret %struct.Memory* %call2_4092b9
}
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_jge_.L_4092b0(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i8* nocapture %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_jge_.L_40925d(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i8* nocapture %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 2, i32 9
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_jmpq_.L_40922e(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_jmpq_.L_409262(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_jge_.L_409298(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i8* nocapture %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 2, i32 9
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_jmpq_.L_40920f(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
