...
entry:
  ...
  %call2_409213 = tail call %struct.Memory* @sub_400e10._Z11start_timerv(%struct.State* %0, i64 %58, %struct.Memory* %2)
  ...
  br label %block_.L_40921f

block_.L_40921f:                                  ; preds = %block_.L_4092a8, %entry
  %74 = phi i64 [ %340, %block_.L_4092a8 ], [ %.pre, %entry ]
  ...
  br i1 %107, label %block_40922f, label %block_.L_4092c0

block_40922f:                                     ; preds = %block_.L_40921f
  ...
  br label %block_.L_40923e

block_.L_40923e:                                  ; preds = %block_40924f, %block_40922f
  %118 = phi i64 [ %201, %block_40924f ], [ %.pre9, %block_40922f ]
  ...
  br i1 %156, label %block_40924f, label %block_.L_40926d

block_40924f:                                     ; preds = %block_.L_40923e
  %158 = add i64 %119, -40
  ...
  %call2_40925a = tail call %struct.Memory* @sub_401f30._ZN15loop_inner_bodyILi7EdE7do_workERdPKdi(%struct.State* nonnull %0, i64 %166, %struct.Memory* %call2_409213)
...
block_.L_40926d:                                  ; preds = %block_.L_40923e
  %202 = add i64 %157, 5
  br label %block_.L_409272

block_.L_409272:                                  ; preds = %block_40927e, %block_.L_40926d
  %203 = phi i64 [ %119, %block_.L_40926d ], [ %.pre10, %block_40927e ]
  %storemerge = phi i64 [ %202, %block_.L_40926d ], [ %298, %block_40927e ]
  %204 = add i64 %203, -44
  ...
  br i1 %238, label %block_40927e, label %block_.L_4092a8
...
block_40927e:                                     ; preds = %block_.L_409272
  ...
  %call2_40928b = tail call %struct.Memory* @sub_4014c0._Z18complete_hash_funcIdET_S0_(%struct.State* nonnull %0, i64 %252, %struct.Memory* %call2_409213)
...
block_.L_4092a8:                                  ; preds = %block_.L_409272
  %300 = add i64 %203, -40
  %301 = add i64 %239, 5
  ...
  %call2_4092ad = tail call %struct.Memory* @sub_4014f0._Z9check_sumIdEvT_(%struct.State* nonnull %0, i64 %304, %struct.Memory* %call2_409213)
...
block_.L_4092c0:                                  ; preds = %block_.L_40921f
  ...
  %call2_4092c0 = tail call %struct.Memory* @sub_400e30._Z5timerv(%struct.State* nonnull %0, i64 %341, %struct.Memory* %call2_409213)
  ...
  %call2_4092c9 = tail call %struct.Memory* @sub_4007d0._Z13record_resultdPKc(%struct.State* nonnull %0, i64 %352, %struct.Memory* %call2_4092c0)
  ...
  ret %struct.Memory* %call2_4092c9
}
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_jge_.L_4092c0(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i8* nocapture %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_jge_.L_40926d(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i8* nocapture %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 2, i32 9
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_jmpq_.L_40923e(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_jge_.L_4092a8(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i8* nocapture %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 2, i32 9
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_jmpq_.L_40921f(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
