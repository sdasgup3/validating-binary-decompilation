...
entry:
  ...
  %call2_4090a3 = tail call %struct.Memory* @sub_400dd0._Z11start_timerv(%struct.State* %0, i64 %58, %struct.Memory* %2)
...
block_.L_4090af:                                  ; preds = %block_.L_409138, %entry
  %79 = phi i64 [ %.pre, %entry ], [ %349, %block_.L_409138 ]
  %MEMORY.0 = phi %struct.Memory* [ %call2_4090a3, %entry ], [ %call2_40913d, %block_.L_409138 ]
  ...
  br i1 %112, label %block_4090bf, label %block_.L_409150
...
block_.L_4090ce:                                  ; preds = %block_4090df, %block_4090bf
  %124 = phi i64 [ %.pre1, %block_4090bf ], [ %207, %block_4090df ]
  %MEMORY.1 = phi %struct.Memory* [ %MEMORY.0, %block_4090bf ], [ %call2_4090ea, %block_4090df ]
  ...
  br i1 %162, label %block_4090df, label %block_.L_4090fd
...
block_4090df:                                     ; preds = %block_.L_4090ce
  ...
  %call2_4090ea = tail call %struct.Memory* @sub_401e90._ZN15loop_inner_bodyILi8EdE7do_workERdPKdi(%struct.State* %0, i64 %172, %struct.Memory* %MEMORY.1)
...
block_.L_409102:                                  ; preds = %block_40910e, %block_.L_4090fd
  %209 = phi i64 [ %208, %block_.L_4090fd ], [ %306, %block_40910e ]
  %210 = phi i64 [ %125, %block_.L_4090fd ], [ %.pre2, %block_40910e ]
  %MEMORY.2 = phi %struct.Memory* [ %MEMORY.1, %block_.L_4090fd ], [ %call2_40911b, %block_40910e ]
  %211 = add i64 %210, -44
  %212 = add i64 %209, 3
  ...
  br i1 %245, label %block_40910e, label %block_.L_409138
...
block_40910e:                                     ; preds = %block_.L_409102
  ...
  %call2_40911b = tail call %struct.Memory* @sub_401480._Z18complete_hash_funcIdET_S0_(%struct.State* %0, i64 %260, %struct.Memory* %MEMORY.2)
...
block_.L_409138:                                  ; preds = %block_.L_409102
  ...
  %call2_40913d = tail call %struct.Memory* @sub_4014b0._Z9check_sumIdEvT_(%struct.State* %0, i64 %312, %struct.Memory* %MEMORY.2)
...
block_.L_409150:                                  ; preds = %block_.L_4090af
  ...
  %call2_409150 = tail call %struct.Memory* @sub_400df0._Z5timerv(%struct.State* %0, i64 %350, %struct.Memory* %MEMORY.0)
  ...
  %call2_409159 = tail call %struct.Memory* @sub_400790._Z13record_resultdPKc(%struct.State* %0, i64 %361, %struct.Memory* %call2_409150)
  ...
  ret %struct.Memory* %call2_409159
}
...
define %struct.Memory* @routine_jge_.L_409150(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i8* %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
...
define %struct.Memory* @routine_jge_.L_4090fd(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i8* %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 2, i32 9
...
define %struct.Memory* @routine_jmpq_.L_4090ce(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
...
define %struct.Memory* @routine_jmpq_.L_409102(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
...
define %struct.Memory* @routine_jge_.L_409138(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i8* %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 2, i32 9
...
define %struct.Memory* @routine_jmpq_.L_4090af(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
