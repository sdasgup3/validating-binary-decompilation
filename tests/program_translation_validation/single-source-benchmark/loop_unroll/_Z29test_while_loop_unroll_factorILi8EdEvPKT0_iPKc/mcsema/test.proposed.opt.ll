...
entry:
  ...
  %call2_4090e3 = tail call %struct.Memory* @sub_400e10._Z11start_timerv(%struct.State* %0, i64 %58, %struct.Memory* %2)
...
block_.L_4090ef:                                  ; preds = %block_.L_409178, %entry
  %74 = phi i64 [ %340, %block_.L_409178 ], [ %.pre, %entry ]
  ...
  br i1 %107, label %block_4090ff, label %block_.L_409190
...
block_.L_40910e:                                  ; preds = %block_40911f, %block_4090ff
  %118 = phi i64 [ %201, %block_40911f ], [ %.pre9, %block_4090ff ]
  ...
  br i1 %156, label %block_40911f, label %block_.L_40913d
...
block_40911f:                                     ; preds = %block_.L_40910e
  ...
  %call2_40912a = tail call %struct.Memory* @sub_401ed0._ZN15loop_inner_bodyILi8EdE7do_workERdPKdi(%struct.State* nonnull %0, i64 %166, %struct.Memory* %call2_4090e3)
...
block_.L_409142:                                  ; preds = %block_40914e, %block_.L_40913d
  %203 = phi i64 [ %119, %block_.L_40913d ], [ %.pre10, %block_40914e ]
  %storemerge = phi i64 [ %202, %block_.L_40913d ], [ %298, %block_40914e ]
  %204 = add i64 %203, -44
  ...
  br i1 %238, label %block_40914e, label %block_.L_409178
...
block_40914e:                                     ; preds = %block_.L_409142
  ...
  %call2_40915b = tail call %struct.Memory* @sub_4014c0._Z18complete_hash_funcIdET_S0_(%struct.State* nonnull %0, i64 %252, %struct.Memory* %call2_4090e3)
...
block_.L_409178:                                  ; preds = %block_.L_409142
  ...
  %call2_40917d = tail call %struct.Memory* @sub_4014f0._Z9check_sumIdEvT_(%struct.State* nonnull %0, i64 %304, %struct.Memory* %call2_4090e3)
...
block_.L_409190:                                  ; preds = %block_.L_4090ef
  ...
  %call2_409190 = tail call %struct.Memory* @sub_400e30._Z5timerv(%struct.State* nonnull %0, i64 %341, %struct.Memory* %call2_4090e3)
  ...
  %call2_409199 = tail call %struct.Memory* @sub_4007d0._Z13record_resultdPKc(%struct.State* nonnull %0, i64 %352, %struct.Memory* %call2_409190)
