...
block_.L_4090af:                                  ; preds = %block_.L_409138, %entry
  %79 = phi i64 [ %.pre, %entry ], [ %345, %block_.L_409138 ]
...
block_.L_409102:                                  ; preds = %block_40910e, %block_.L_4090fd
  %209 = phi i64 [ %208, %block_.L_4090fd ], [ %304, %block_40910e ]
...
block_40910e:                                     ; preds = %block_.L_409102
  ...
  %call2_40911b = tail call %struct.Memory* @sub_401480._Z18complete_hash_funcIdET_S0_(%struct.State* %0, i64 %259, %struct.Memory* %MEMORY.2)
...
block_.L_409138:                                  ; preds = %block_.L_409102
  ...
  %call2_40913d = tail call %struct.Memory* @sub_4014b0._Z9check_sumIdEvT_(%struct.State* %0, i64 %309, %struct.Memory* %MEMORY.2)
...
block_.L_409150:                                  ; preds = %block_.L_4090af
  ...
  %call2_409150 = tail call %struct.Memory* @sub_400df0._Z5timerv(%struct.State* %0, i64 %346, %struct.Memory* %MEMORY.0)
  ...
  %call2_409159 = tail call %struct.Memory* @sub_400790._Z13record_resultdPKc(%struct.State* %0, i64 %357, %struct.Memory* %call2_409150)
