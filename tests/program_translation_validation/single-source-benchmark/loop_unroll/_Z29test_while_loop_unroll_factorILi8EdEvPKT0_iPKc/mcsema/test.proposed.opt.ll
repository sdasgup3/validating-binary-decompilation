...
define %struct.Memory* @_Z29test_while_loop_unroll_factorILi8EdEvPKT0_iPKc(%struct.State* noalias, i64, %struct.Memory* noalias readnone) local_unnamed_addr #1 {
entry:
...
block_.L_4090df:                                  ; preds = %block_.L_409168, %entry
  %74 = phi i64 [ %340, %block_.L_409168 ], [ %.pre, %entry ]
...
block_.L_4090fe:                                  ; preds = %block_40910f, %block_4090ef
  %118 = phi i64 [ %201, %block_40910f ], [ %.pre9, %block_4090ef ]
...
block_40910f:                                     ; preds = %block_.L_4090fe
  ...
  %call2_40911a = tail call %struct.Memory* @sub_401ec0._ZN15loop_inner_bodyILi8EdE7do_workERdPKdi(%struct.State* nonnull %0, i64 %166, %struct.Memory* %call2_4090d3)
...
block_40913e:                                     ; preds = %block_.L_409132
  ...
  %call2_40914b = tail call %struct.Memory* @sub_4014b0._Z18complete_hash_funcIdET_S0_(%struct.State* nonnull %0, i64 %252, %struct.Memory* %call2_4090d3)
...
block_.L_409168:                                  ; preds = %block_.L_409132
  ...
  %call2_40916d = tail call %struct.Memory* @sub_4014e0._Z9check_sumIdEvT_(%struct.State* nonnull %0, i64 %304, %struct.Memory* %call2_4090d3)
...
block_.L_409180:                                  ; preds = %block_.L_4090df
  ...
  %call2_409180 = tail call %struct.Memory* @sub_400e20._Z5timerv(%struct.State* nonnull %0, i64 %341, %struct.Memory* %call2_4090d3)
