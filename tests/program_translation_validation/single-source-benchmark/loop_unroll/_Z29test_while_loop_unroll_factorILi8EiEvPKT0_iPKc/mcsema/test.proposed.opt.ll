...
entry:
  ...
  %call2_413923 = tail call %struct.Memory* @sub_400e10._Z11start_timerv(%struct.State* %0, i64 %58, %struct.Memory* %2)
  ...
  br label %block_.L_41392f

block_.L_41392f:                                  ; preds = %block_.L_4139b1, %entry
  %68 = phi i64 [ %361, %block_.L_4139b1 ], [ %.pre, %entry ]
  ...
  br i1 %101, label %block_41393f, label %block_.L_4139c7

block_41393f:                                     ; preds = %block_.L_41392f
  %103 = add i64 %69, -32
  %104 = add i64 %102, 7
  ...
  br label %block_.L_41394d

block_.L_41394d:                                  ; preds = %block_41395e, %block_41393f
  %111 = phi i64 [ %194, %block_41395e ], [ %.pre9, %block_41393f ]
  ...
  br i1 %149, label %block_41395e, label %block_.L_41397c

block_41395e:                                     ; preds = %block_.L_41394d
  %151 = add i64 %112, -32
  ...
  %call2_413969 = tail call %struct.Memory* @sub_40ca90._ZN15loop_inner_bodyILi8EiE7do_workERiPKii(%struct.State* nonnull %0, i64 %159, %struct.Memory* %call2_413923)
...
block_.L_41397c:                                  ; preds = %block_.L_41394d
  %195 = add i64 %150, 5
  br label %block_.L_413981

block_.L_413981:                                  ; preds = %block_41398d, %block_.L_41397c
  %196 = phi i64 [ %112, %block_.L_41397c ], [ %.pre10, %block_41398d ]
  %storemerge = phi i64 [ %195, %block_.L_41397c ], [ %318, %block_41398d ]
  %197 = add i64 %196, -36
  ...
  br i1 %231, label %block_41398d, label %block_.L_4139b1

block_41398d:                                     ; preds = %block_.L_413981
  %233 = add i64 %196, -8
  %234 = add i64 %232, 4
  ...
  %call2_413998 = tail call %struct.Memory* @sub_40c110._Z18complete_hash_funcIiET_S0_(%struct.State* nonnull %0, i64 %246, %struct.Memory* %call2_413923)
...
block_.L_4139b1:                                  ; preds = %block_.L_413981
  %320 = add i64 %196, -32
  %321 = add i64 %232, 3
  ...
  %call2_4139b4 = tail call %struct.Memory* @sub_40c140._Z9check_sumIiEvT_(%struct.State* nonnull %0, i64 %325, %struct.Memory* %call2_413923)
...
block_.L_4139c7:                                  ; preds = %block_.L_41392f
  ...
  %call2_4139c7 = tail call %struct.Memory* @sub_400e30._Z5timerv(%struct.State* nonnull %0, i64 %362, %struct.Memory* %call2_413923)
  ...
  %call2_4139d0 = tail call %struct.Memory* @sub_4007d0._Z13record_resultdPKc(%struct.State* nonnull %0, i64 %373, %struct.Memory* %call2_4139c7)
  ...
  ret %struct.Memory* %call2_4139d0
}
...
; Function Attrs: alwaysinline norecurse nounwind
define %struct.Memory* @routine_jge_.L_4139c7(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i8* nocapture %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
...
; Function Attrs: alwaysinline norecurse nounwind
define %struct.Memory* @routine_jge_.L_41397c(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i8* nocapture %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 2, i32 9
...
; Function Attrs: alwaysinline norecurse nounwind
define %struct.Memory* @routine_jmpq_.L_41394d(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
...
; Function Attrs: alwaysinline norecurse nounwind
define %struct.Memory* @routine_jmpq_.L_413981(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
...
; Function Attrs: alwaysinline norecurse nounwind
define %struct.Memory* @routine_jge_.L_4139b1(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i8* nocapture %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 2, i32 9
...
; Function Attrs: alwaysinline norecurse nounwind
define %struct.Memory* @routine_jmpq_.L_41392f(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
