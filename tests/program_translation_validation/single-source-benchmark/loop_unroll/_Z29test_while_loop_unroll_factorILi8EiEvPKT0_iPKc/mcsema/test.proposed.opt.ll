...
define %struct.Memory* @_Z29test_while_loop_unroll_factorILi8EiEvPKT0_iPKc(%struct.State* noalias, i64, %struct.Memory* noalias readnone) local_unnamed_addr #1 {
entry:
...
block_.L_41391f:                                  ; preds = %block_.L_4139a1, %entry
  %68 = phi i64 [ %361, %block_.L_4139a1 ], [ %.pre, %entry ]
...
block_.L_41393d:                                  ; preds = %block_41394e, %block_41392f
  %111 = phi i64 [ %194, %block_41394e ], [ %.pre9, %block_41392f ]
...
block_41394e:                                     ; preds = %block_.L_41393d
  ...
  %call2_413959 = tail call %struct.Memory* @sub_40ca80._ZN15loop_inner_bodyILi8EiE7do_workERiPKii(%struct.State* nonnull %0, i64 %159, %struct.Memory* %call2_413913)
...
block_41397d:                                     ; preds = %block_.L_413971
  ...
  %call2_413988 = tail call %struct.Memory* @sub_40c100._Z18complete_hash_funcIiET_S0_(%struct.State* nonnull %0, i64 %246, %struct.Memory* %call2_413913)
...
block_.L_4139a1:                                  ; preds = %block_.L_413971
  ...
  %call2_4139a4 = tail call %struct.Memory* @sub_40c130._Z9check_sumIiEvT_(%struct.State* nonnull %0, i64 %325, %struct.Memory* %call2_413913)
...
block_.L_4139b7:                                  ; preds = %block_.L_41391f
  ...
  %call2_4139b7 = tail call %struct.Memory* @sub_400e20._Z5timerv(%struct.State* nonnull %0, i64 %362, %struct.Memory* %call2_413913)
