...
block_.L_4138ef:                                  ; preds = %block_.L_413971, %entry
  %68 = phi i64 [ %.pre, %entry ], [ %361, %block_.L_413971 ]
...
block_.L_413941:                                  ; preds = %block_41394d, %block_.L_41393c
  %196 = phi i64 [ %195, %block_.L_41393c ], [ %319, %block_41394d ]
...
block_.L_413971:                                  ; preds = %block_.L_413941
  ...
  %call2_413974 = tail call %struct.Memory* @sub_40c100._Z9check_sumIiEvT_(%struct.State* %0, i64 %325, %struct.Memory* %MEMORY.2)
...
block_.L_413987:                                  ; preds = %block_.L_4138ef
  ...
  %call2_413987 = tail call %struct.Memory* @sub_400df0._Z5timerv(%struct.State* %0, i64 %362, %struct.Memory* %MEMORY.0)
  ...
  %call2_413990 = tail call %struct.Memory* @sub_400790._Z13record_resultdPKc(%struct.State* %0, i64 %373, %struct.Memory* %call2_413987)
