...
entry:
  ...
  %call2_4138e3 = tail call %struct.Memory* @sub_400dd0._Z11start_timerv(%struct.State* %0, i64 %58, %struct.Memory* %2)
  ...
  br label %block_.L_4138ef

block_.L_4138ef:                                  ; preds = %block_.L_413971, %entry
  %68 = phi i64 [ %.pre, %entry ], [ %363, %block_.L_413971 ]
  %MEMORY.0 = phi %struct.Memory* [ %call2_4138e3, %entry ], [ %call2_413974, %block_.L_413971 ]
  ...
  br i1 %101, label %block_4138ff, label %block_.L_413987

block_4138ff:                                     ; preds = %block_.L_4138ef
  %103 = add i64 %69, -32
  %104 = add i64 %102, 7
  ...
  br label %block_.L_41390d

block_.L_41390d:                                  ; preds = %block_41391e, %block_4138ff
  %111 = phi i64 [ %.pre1, %block_4138ff ], [ %194, %block_41391e ]
  %MEMORY.1 = phi %struct.Memory* [ %MEMORY.0, %block_4138ff ], [ %call2_413929, %block_41391e ]
  ...
  br i1 %149, label %block_41391e, label %block_.L_41393c

block_41391e:                                     ; preds = %block_.L_41390d
  %151 = add i64 %112, -32
  ...
  %call2_413929 = tail call %struct.Memory* @sub_40ca50._ZN15loop_inner_bodyILi8EiE7do_workERiPKii(%struct.State* %0, i64 %159, %struct.Memory* %MEMORY.1)
...
block_.L_41393c:                                  ; preds = %block_.L_41390d
  %195 = add i64 %150, 5
  store i64 %195, i64* %3, align 8
  br label %block_.L_413941

block_.L_413941:                                  ; preds = %block_41394d, %block_.L_41393c
  %196 = phi i64 [ %195, %block_.L_41393c ], [ %320, %block_41394d ]
  %197 = phi i64 [ %112, %block_.L_41393c ], [ %.pre2, %block_41394d ]
  %MEMORY.2 = phi %struct.Memory* [ %MEMORY.1, %block_.L_41393c ], [ %call2_413958, %block_41394d ]
  %198 = add i64 %197, -36
  %199 = add i64 %196, 3
  ...
  br i1 %232, label %block_41394d, label %block_.L_413971

block_41394d:                                     ; preds = %block_.L_413941
  %234 = add i64 %197, -8
  %235 = add i64 %233, 4
  ...
  %call2_413958 = tail call %struct.Memory* @sub_40c0d0._Z18complete_hash_funcIiET_S0_(%struct.State* %0, i64 %247, %struct.Memory* %MEMORY.2)
...
block_.L_413971:                                  ; preds = %block_.L_413941
  %321 = add i64 %197, -32
  %322 = add i64 %233, 3
  ...
  %call2_413974 = tail call %struct.Memory* @sub_40c100._Z9check_sumIiEvT_(%struct.State* %0, i64 %326, %struct.Memory* %MEMORY.2)
...
block_.L_413987:                                  ; preds = %block_.L_4138ef
  %364 = add i64 %102, -76695
  %365 = add i64 %102, 5
  ...
  %call2_413987 = tail call %struct.Memory* @sub_400df0._Z5timerv(%struct.State* %0, i64 %364, %struct.Memory* %MEMORY.0)
  ...
  %call2_413990 = tail call %struct.Memory* @sub_400790._Z13record_resultdPKc(%struct.State* %0, i64 %375, %struct.Memory* %call2_413987)
  ...
  ret %struct.Memory* %call2_413990
}
...
define %struct.Memory* @routine_jge_.L_413987(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i8* %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
...
define %struct.Memory* @routine_jge_.L_41393c(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i8* %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 2, i32 9
...
define %struct.Memory* @routine_jmpq_.L_41390d(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
...
define %struct.Memory* @routine_jmpq_.L_413941(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
...
define %struct.Memory* @routine_jge_.L_413971(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i8* %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 2, i32 9
...
define %struct.Memory* @routine_jmpq_.L_4138ef(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
