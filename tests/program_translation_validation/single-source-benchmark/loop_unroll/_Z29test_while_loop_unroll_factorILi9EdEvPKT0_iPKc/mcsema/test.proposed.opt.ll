...
define %struct.Memory* @_Z29test_while_loop_unroll_factorILi9EdEvPKT0_iPKc(%struct.State* noalias, i64, %struct.Memory* noalias readnone) local_unnamed_addr #1 {
entry:
...
block_.L_408faf:                                  ; preds = %block_.L_409038, %entry
  %74 = phi i64 [ %340, %block_.L_409038 ], [ %.pre, %entry ]
...
block_.L_408fce:                                  ; preds = %block_408fdf, %block_408fbf
  %118 = phi i64 [ %201, %block_408fdf ], [ %.pre9, %block_408fbf ]
...
block_408fdf:                                     ; preds = %block_.L_408fce
  ...
  %call2_408fea = tail call %struct.Memory* @sub_401e60._ZN15loop_inner_bodyILi9EdE7do_workERdPKdi(%struct.State* nonnull %0, i64 %166, %struct.Memory* %call2_408fa3)
...
block_40900e:                                     ; preds = %block_.L_409002
  ...
  %call2_40901b = tail call %struct.Memory* @sub_4014b0._Z18complete_hash_funcIdET_S0_(%struct.State* nonnull %0, i64 %252, %struct.Memory* %call2_408fa3)
...
block_.L_409038:                                  ; preds = %block_.L_409002
  ...
  %call2_40903d = tail call %struct.Memory* @sub_4014e0._Z9check_sumIdEvT_(%struct.State* nonnull %0, i64 %304, %struct.Memory* %call2_408fa3)
...
block_.L_409050:                                  ; preds = %block_.L_408faf
  ...
  %call2_409050 = tail call %struct.Memory* @sub_400e20._Z5timerv(%struct.State* nonnull %0, i64 %341, %struct.Memory* %call2_408fa3)
