...
entry:
  ...
  %call2_408fb3 = tail call %struct.Memory* @sub_400e10._Z11start_timerv(%struct.State* %0, i64 %58, %struct.Memory* %2)
...
block_.L_408fbf:                                  ; preds = %block_.L_409048, %entry
  %74 = phi i64 [ %340, %block_.L_409048 ], [ %.pre, %entry ]
  ...
  br i1 %107, label %block_408fcf, label %block_.L_409060
...
block_.L_408fde:                                  ; preds = %block_408fef, %block_408fcf
  %118 = phi i64 [ %201, %block_408fef ], [ %.pre9, %block_408fcf ]
  ...
  br i1 %156, label %block_408fef, label %block_.L_40900d
...
block_408fef:                                     ; preds = %block_.L_408fde
  ...
  %call2_408ffa = tail call %struct.Memory* @sub_401e70._ZN15loop_inner_bodyILi9EdE7do_workERdPKdi(%struct.State* nonnull %0, i64 %166, %struct.Memory* %call2_408fb3)
...
block_.L_409012:                                  ; preds = %block_40901e, %block_.L_40900d
  %203 = phi i64 [ %119, %block_.L_40900d ], [ %.pre10, %block_40901e ]
  %storemerge = phi i64 [ %202, %block_.L_40900d ], [ %298, %block_40901e ]
  %204 = add i64 %203, -44
  ...
  br i1 %238, label %block_40901e, label %block_.L_409048
...
block_40901e:                                     ; preds = %block_.L_409012
  ...
  %call2_40902b = tail call %struct.Memory* @sub_4014c0._Z18complete_hash_funcIdET_S0_(%struct.State* nonnull %0, i64 %252, %struct.Memory* %call2_408fb3)
...
block_.L_409048:                                  ; preds = %block_.L_409012
  ...
  %call2_40904d = tail call %struct.Memory* @sub_4014f0._Z9check_sumIdEvT_(%struct.State* nonnull %0, i64 %304, %struct.Memory* %call2_408fb3)
...
block_.L_409060:                                  ; preds = %block_.L_408fbf
  ...
  %call2_409060 = tail call %struct.Memory* @sub_400e30._Z5timerv(%struct.State* nonnull %0, i64 %341, %struct.Memory* %call2_408fb3)
  ...
  %call2_409069 = tail call %struct.Memory* @sub_4007d0._Z13record_resultdPKc(%struct.State* nonnull %0, i64 %352, %struct.Memory* %call2_409060)
