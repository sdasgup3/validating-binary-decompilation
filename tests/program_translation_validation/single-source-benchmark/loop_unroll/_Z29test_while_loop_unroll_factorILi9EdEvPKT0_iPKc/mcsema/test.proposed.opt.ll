...
block_.L_408f7f:                                  ; preds = %block_.L_409008, %entry
  %79 = phi i64 [ %.pre, %entry ], [ %345, %block_.L_409008 ]
...
block_.L_408fd2:                                  ; preds = %block_408fde, %block_.L_408fcd
  %209 = phi i64 [ %208, %block_.L_408fcd ], [ %304, %block_408fde ]
...
block_408fde:                                     ; preds = %block_.L_408fd2
  ...
  %call2_408feb = tail call %struct.Memory* @sub_401480._Z18complete_hash_funcIdET_S0_(%struct.State* %0, i64 %259, %struct.Memory* %MEMORY.2)
...
block_.L_409008:                                  ; preds = %block_.L_408fd2
  ...
  %call2_40900d = tail call %struct.Memory* @sub_4014b0._Z9check_sumIdEvT_(%struct.State* %0, i64 %309, %struct.Memory* %MEMORY.2)
...
block_.L_409020:                                  ; preds = %block_.L_408f7f
  ...
  %call2_409020 = tail call %struct.Memory* @sub_400df0._Z5timerv(%struct.State* %0, i64 %346, %struct.Memory* %MEMORY.0)
  ...
  %call2_409029 = tail call %struct.Memory* @sub_400790._Z13record_resultdPKc(%struct.State* %0, i64 %357, %struct.Memory* %call2_409020)
