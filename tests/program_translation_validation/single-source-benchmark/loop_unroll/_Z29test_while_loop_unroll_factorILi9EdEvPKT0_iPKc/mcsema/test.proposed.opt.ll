...
entry:
  ...
  %call2_408f73 = tail call %struct.Memory* @sub_400dd0._Z11start_timerv(%struct.State* %0, i64 %58, %struct.Memory* %2)
...
block_.L_408f7f:                                  ; preds = %block_.L_409008, %entry
  %79 = phi i64 [ %.pre, %entry ], [ %349, %block_.L_409008 ]
  %MEMORY.0 = phi %struct.Memory* [ %call2_408f73, %entry ], [ %call2_40900d, %block_.L_409008 ]
  ...
  br i1 %112, label %block_408f8f, label %block_.L_409020
...
block_.L_408f9e:                                  ; preds = %block_408faf, %block_408f8f
  %124 = phi i64 [ %.pre1, %block_408f8f ], [ %207, %block_408faf ]
  %MEMORY.1 = phi %struct.Memory* [ %MEMORY.0, %block_408f8f ], [ %call2_408fba, %block_408faf ]
  ...
  br i1 %162, label %block_408faf, label %block_.L_408fcd
...
block_408faf:                                     ; preds = %block_.L_408f9e
  ...
  %call2_408fba = tail call %struct.Memory* @sub_401e30._ZN15loop_inner_bodyILi9EdE7do_workERdPKdi(%struct.State* %0, i64 %172, %struct.Memory* %MEMORY.1)
...
block_.L_408fd2:                                  ; preds = %block_408fde, %block_.L_408fcd
  %209 = phi i64 [ %208, %block_.L_408fcd ], [ %306, %block_408fde ]
  %210 = phi i64 [ %125, %block_.L_408fcd ], [ %.pre2, %block_408fde ]
  %MEMORY.2 = phi %struct.Memory* [ %MEMORY.1, %block_.L_408fcd ], [ %call2_408feb, %block_408fde ]
  %211 = add i64 %210, -44
  %212 = add i64 %209, 3
  ...
  br i1 %245, label %block_408fde, label %block_.L_409008
...
block_408fde:                                     ; preds = %block_.L_408fd2
  ...
  %call2_408feb = tail call %struct.Memory* @sub_401480._Z18complete_hash_funcIdET_S0_(%struct.State* %0, i64 %260, %struct.Memory* %MEMORY.2)
...
block_.L_409008:                                  ; preds = %block_.L_408fd2
  ...
  %call2_40900d = tail call %struct.Memory* @sub_4014b0._Z9check_sumIdEvT_(%struct.State* %0, i64 %312, %struct.Memory* %MEMORY.2)
...
block_.L_409020:                                  ; preds = %block_.L_408f7f
  ...
  %call2_409020 = tail call %struct.Memory* @sub_400df0._Z5timerv(%struct.State* %0, i64 %350, %struct.Memory* %MEMORY.0)
  ...
  %call2_409029 = tail call %struct.Memory* @sub_400790._Z13record_resultdPKc(%struct.State* %0, i64 %361, %struct.Memory* %call2_409020)
  ...
  ret %struct.Memory* %call2_409029
}
...
define %struct.Memory* @routine_jge_.L_409020(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i8* %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
...
define %struct.Memory* @routine_jge_.L_408fcd(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i8* %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 2, i32 9
...
define %struct.Memory* @routine_jmpq_.L_408f9e(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
...
define %struct.Memory* @routine_jmpq_.L_408fd2(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
...
define %struct.Memory* @routine_jge_.L_409008(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i8* %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 2, i32 9
...
define %struct.Memory* @routine_jmpq_.L_408f7f(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
