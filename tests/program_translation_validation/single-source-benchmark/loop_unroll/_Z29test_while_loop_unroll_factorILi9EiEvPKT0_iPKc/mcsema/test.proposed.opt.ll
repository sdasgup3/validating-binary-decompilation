...
entry:
  ...
  %call2_413803 = tail call %struct.Memory* @sub_400e10._Z11start_timerv(%struct.State* %0, i64 %58, %struct.Memory* %2)
...
block_.L_41380f:                                  ; preds = %block_.L_413891, %entry
  %68 = phi i64 [ %361, %block_.L_413891 ], [ %.pre, %entry ]
  ...
  br i1 %101, label %block_41381f, label %block_.L_4138a7
...
block_.L_41382d:                                  ; preds = %block_41383e, %block_41381f
  %111 = phi i64 [ %194, %block_41383e ], [ %.pre9, %block_41381f ]
  ...
  br i1 %149, label %block_41383e, label %block_.L_41385c
...
block_41383e:                                     ; preds = %block_.L_41382d
  ...
  %call2_413849 = tail call %struct.Memory* @sub_40ca30._ZN15loop_inner_bodyILi9EiE7do_workERiPKii(%struct.State* nonnull %0, i64 %159, %struct.Memory* %call2_413803)
...
block_.L_413861:                                  ; preds = %block_41386d, %block_.L_41385c
  %196 = phi i64 [ %112, %block_.L_41385c ], [ %.pre10, %block_41386d ]
  %storemerge = phi i64 [ %195, %block_.L_41385c ], [ %318, %block_41386d ]
  %197 = add i64 %196, -36
  ...
  br i1 %231, label %block_41386d, label %block_.L_413891
...
block_41386d:                                     ; preds = %block_.L_413861
  ...
  %call2_413878 = tail call %struct.Memory* @sub_40c110._Z18complete_hash_funcIiET_S0_(%struct.State* nonnull %0, i64 %246, %struct.Memory* %call2_413803)
...
block_.L_413891:                                  ; preds = %block_.L_413861
  ...
  %call2_413894 = tail call %struct.Memory* @sub_40c140._Z9check_sumIiEvT_(%struct.State* nonnull %0, i64 %325, %struct.Memory* %call2_413803)
...
block_.L_4138a7:                                  ; preds = %block_.L_41380f
  ...
  %call2_4138a7 = tail call %struct.Memory* @sub_400e30._Z5timerv(%struct.State* nonnull %0, i64 %362, %struct.Memory* %call2_413803)
  ...
  %call2_4138b0 = tail call %struct.Memory* @sub_4007d0._Z13record_resultdPKc(%struct.State* nonnull %0, i64 %373, %struct.Memory* %call2_4138a7)
