...
define %struct.Memory* @_Z29test_while_loop_unroll_factorILi9EiEvPKT0_iPKc(%struct.State* noalias, i64, %struct.Memory* noalias readnone) local_unnamed_addr #1 {
entry:
...
block_.L_4137ff:                                  ; preds = %block_.L_413881, %entry
  %68 = phi i64 [ %361, %block_.L_413881 ], [ %.pre, %entry ]
...
block_.L_41381d:                                  ; preds = %block_41382e, %block_41380f
  %111 = phi i64 [ %194, %block_41382e ], [ %.pre9, %block_41380f ]
...
block_41382e:                                     ; preds = %block_.L_41381d
  ...
  %call2_413839 = tail call %struct.Memory* @sub_40ca20._ZN15loop_inner_bodyILi9EiE7do_workERiPKii(%struct.State* nonnull %0, i64 %159, %struct.Memory* %call2_4137f3)
...
block_41385d:                                     ; preds = %block_.L_413851
  ...
  %call2_413868 = tail call %struct.Memory* @sub_40c100._Z18complete_hash_funcIiET_S0_(%struct.State* nonnull %0, i64 %246, %struct.Memory* %call2_4137f3)
...
block_.L_413881:                                  ; preds = %block_.L_413851
  ...
  %call2_413884 = tail call %struct.Memory* @sub_40c130._Z9check_sumIiEvT_(%struct.State* nonnull %0, i64 %325, %struct.Memory* %call2_4137f3)
...
block_.L_413897:                                  ; preds = %block_.L_4137ff
  ...
  %call2_413897 = tail call %struct.Memory* @sub_400e20._Z5timerv(%struct.State* nonnull %0, i64 %362, %struct.Memory* %call2_4137f3)
