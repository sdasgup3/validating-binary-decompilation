...
block_.L_4137cf:                                  ; preds = %block_.L_413851, %entry
  %68 = phi i64 [ %.pre, %entry ], [ %363, %block_.L_413851 ]
...
block_.L_413821:                                  ; preds = %block_41382d, %block_.L_41381c
  %196 = phi i64 [ %195, %block_.L_41381c ], [ %320, %block_41382d ]
...
block_.L_413851:                                  ; preds = %block_.L_413821
  ...
  %call2_413854 = tail call %struct.Memory* @sub_40c100._Z9check_sumIiEvT_(%struct.State* %0, i64 %326, %struct.Memory* %MEMORY.2)
...
block_.L_413867:                                  ; preds = %block_.L_4137cf
  ...
  %call2_413867 = tail call %struct.Memory* @sub_400df0._Z5timerv(%struct.State* %0, i64 %364, %struct.Memory* %MEMORY.0)
  ...
  %call2_413870 = tail call %struct.Memory* @sub_400790._Z13record_resultdPKc(%struct.State* %0, i64 %375, %struct.Memory* %call2_413867)
