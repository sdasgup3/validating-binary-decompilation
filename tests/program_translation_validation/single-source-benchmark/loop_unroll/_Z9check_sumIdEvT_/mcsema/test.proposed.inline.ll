...
@G_0x15095__rip__4199643_ = global %G_0x15095__rip__4199643__type zeroinitializer
...
entry:
  ...
  store %struct.Memory* %loadMem1_4014c6, %struct.Memory** %MEMORY
  ...
  %144 = load double, double* bitcast (%G_0x15095__rip__4199643__type* @G_0x15095__rip__4199643_ to double*)
...
block_4014f1:                                     ; preds = %entry
  ...
  %259 = load i32, i32* bitcast (%G_0x61c0a8_type* @G_0x61c0a8 to i32*)
  ...
  %284 = call %struct.Memory* @__remill_function_call(%struct.State* %0, i64 ptrtoint (i64 (i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64)* @printf to i64), %struct.Memory* %loadMem2_401504)
...
block_.L_40150c:                                  ; preds = %block_4014f1, %entry
  ...
  ret %struct.Memory* %loadMem_401511
}
