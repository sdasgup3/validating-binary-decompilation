...
@G_0x15095__rip__4199643_ = local_unnamed_addr global %G_0x15095__rip__4199643__type zeroinitializer
...
entry:
  ...
  %call2_4014c6 = tail call %struct.Memory* @sub_401480._Z18complete_hash_funcIdET_S0_(%struct.State* %0, i64 %50, %struct.Memory* %2)
  ...
  %60 = load double, double* bitcast (%G_0x15095__rip__4199643__type* @G_0x15095__rip__4199643_ to double*), align 8
  ...
  %call2_4014e4 = tail call %struct.Memory* @sub_401520._Z15tolerance_equalIdEbRT_S1_(%struct.State* %0, i64 %68, %struct.Memory* %call2_4014c6)
  ...
  br i1 %82, label %block_.L_40150c, label %block_4014f1
...
block_4014f1:                                     ; preds = %entry
  ...
  %91 = tail call %struct.Memory* @__remill_function_call(%struct.State* %0, i64 ptrtoint (i64 (i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64)* @printf to i64), %struct.Memory* %call2_4014e4)
...
block_.L_40150c:                                  ; preds = %block_4014f1, %entry
  %98 = phi i64 [ %83, %entry ], [ %.pre, %block_4014f1 ]
  %MEMORY.0 = phi %struct.Memory* [ %call2_4014e4, %entry ], [ %91, %block_4014f1 ]
...
block_400478:
  ...
  %4 = add i64 %3, 8
  store i64 %4, i64* %PC, align 8
  %5 = load i64, i64* bitcast (%G_0x15095__rip__4199643__type* @G_0x15095__rip__4199643_ to i64*), align 8
