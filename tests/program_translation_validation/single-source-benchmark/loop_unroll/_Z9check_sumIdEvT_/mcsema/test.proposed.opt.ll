...
@G_0x15095__rip_ = local_unnamed_addr global %G_0x15095__rip__type zeroinitializer
...
declare %struct.Memory* @sub_401520._Z15tolerance_equalIdEbRT_S1_(%struct.State* noalias dereferenceable(3376), i64, %struct.Memory* noalias readnone returned) local_unnamed_addr

; Function Attrs: alwaysinline
define %struct.Memory* @_Z9check_sumIdEvT_(%struct.State* noalias, i64, %struct.Memory* noalias) local_unnamed_addr #1 {
entry:
  ...
  %47 = load i64, i64* bitcast (%G_0x61c080_type* @G_0x61c080 to i64*), align 8
  ...
  %call2_4014c6 = tail call %struct.Memory* @sub_401480._Z18complete_hash_funcIdET_S0_(%struct.State* %0, i64 %51, %struct.Memory* %2)
  ...
  %61 = load double, double* bitcast (%G_0x15095__rip__type* @G_0x15095__rip_ to double*), align 8
  ...
  %call2_4014e4 = tail call %struct.Memory* @sub_401520._Z15tolerance_equalIdEbRT_S1_(%struct.State* %0, i64 %69, %struct.Memory* %call2_4014c6)
  ...
  br i1 %83, label %block_.L_40150c, label %block_4014f1

block_4014f1:                                     ; preds = %entry
  store i64 ptrtoint (%G__0x4167aa_type* @G__0x4167aa to i64), i64* %RDI.i27, align 8
  %85 = load i32, i32* bitcast (%G_0x61c0a8_type* @G_0x61c0a8 to i32*), align 8
  ...
  %92 = tail call %struct.Memory* @__remill_function_call(%struct.State* %0, i64 ptrtoint (i64 (i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64)* @printf to i64), %struct.Memory* %call2_4014e4)
...
block_.L_40150c:                                  ; preds = %block_4014f1, %entry
  %99 = phi i64 [ %84, %entry ], [ %.pre, %block_4014f1 ]
  %MEMORY.0 = phi %struct.Memory* [ %call2_4014e4, %entry ], [ %92, %block_4014f1 ]
...
define %struct.Memory* @routine_movsd_0x15095__rip____xmm1(%struct.State* dereferenceable(3376), i64, %struct.Memory*) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, 8
  store i64 %4, i64* %PC, align 8
  %5 = load i64, i64* bitcast (%G_0x15095__rip__type* @G_0x15095__rip_ to i64*), align 8
...
define %struct.Memory* @routine_jne_.L_40150c(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i8* %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
...
define %struct.Memory* @routine_movq__0x4167aa___rdi(%struct.State* dereferenceable(3376), i64, %struct.Memory*) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %RDI = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 11, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
