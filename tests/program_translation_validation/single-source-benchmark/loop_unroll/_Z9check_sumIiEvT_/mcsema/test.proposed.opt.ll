...
declare %struct.Memory* @sub_40c160._Z15tolerance_equalIiEbRT_S1_(%struct.State* noalias dereferenceable(3376), i64, %struct.Memory* noalias readnone returned) local_unnamed_addr
...
entry:
  ...
  %call2_40c114 = tail call %struct.Memory* @sub_40c0d0._Z18complete_hash_funcIiET_S0_(%struct.State* %0, i64 %53, %struct.Memory* %2)
  ...
  %call2_40c12a = tail call %struct.Memory* @sub_40c160._Z15tolerance_equalIiEbRT_S1_(%struct.State* %0, i64 %83, %struct.Memory* %call2_40c114)
  ...
  br i1 %96, label %block_.L_40c152, label %block_40c137

block_40c137:                                     ; preds = %entry
  store i64 ptrtoint (%G__0x4167aa_type* @G__0x4167aa to i64), i64* %RDI.i31, align 8
  ...
  %105 = tail call %struct.Memory* @__remill_function_call(%struct.State* %0, i64 ptrtoint (i64 (i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64)* @printf to i64), %struct.Memory* %call2_40c12a)
...
block_.L_40c152:                                  ; preds = %block_40c137, %entry
  %112 = phi i64 [ %97, %entry ], [ %.pre, %block_40c137 ]
  %MEMORY.0 = phi %struct.Memory* [ %call2_40c12a, %entry ], [ %105, %block_40c137 ]
...
define %struct.Memory* @routine_cvttsd2si_0x61c080___edi(%struct.State* dereferenceable(3376), i64, %struct.Memory*) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
...
define %struct.Memory* @routine_jne_.L_40c152(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i8* %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
