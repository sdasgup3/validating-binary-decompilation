...
declare %struct.Memory* @sub_400680.log_plt(%struct.State* noalias dereferenceable(3376), i64, %struct.Memory* noalias readnone returned) local_unnamed_addr

declare %struct.Memory* @sub_400630.exp_plt(%struct.State* noalias dereferenceable(3376), i64, %struct.Memory* noalias readnone returned) local_unnamed_addr
...
block_.L_400916:                                  ; preds = %block_.L_400959, %entry
  %131 = phi i64 [ %289, %block_.L_400959 ], [ %.pre, %entry ]
...
block_400926:                                     ; preds = %block_.L_400916
  ...
  %call2_40093d = tail call %struct.Memory* @sub_400660.strlen_plt(%struct.State* nonnull %0, i64 %203, %struct.Memory* %2)
...
block_.L_40096c:                                  ; preds = %block_.L_400916
  ...
  %call2_40098a = tail call %struct.Memory* @sub_400670.printf_plt(%struct.State* nonnull %0, i64 %316, %struct.Memory* %2)
...
block_.L_4009ba:                                  ; preds = %block_4009ca, %block_.L_40096c
  %353 = phi i64 [ %723, %block_4009ca ], [ %.pre21, %block_.L_40096c ]
...
block_4009ca:                                     ; preds = %block_.L_4009ba
  ...
  %call2_400a0e = tail call %struct.Memory* @sub_400660.strlen_plt(%struct.State* nonnull %0, i64 %456, %struct.Memory* %call2_4009ab)
  ...
  %call2_400aa0 = tail call %struct.Memory* @sub_400670.printf_plt(%struct.State* nonnull %0, i64 %681, %struct.Memory* %call2_4009ab)
...
block_.L_400afc:                                  ; preds = %block_.L_400abd
  ...
  %call2_400b11 = tail call %struct.Memory* @sub_400670.printf_plt(%struct.State* nonnull %0, i64 %844, %struct.Memory* %call2_4009ab)
...
block_.L_400b38:                                  ; preds = %block_400b48, %block_400b31
  %907 = phi i64 [ %1029, %block_400b48 ], [ %.pre23, %block_400b31 ]
...
block_400b48:                                     ; preds = %block_.L_400b38
  ...
  %call2_400b6b = tail call %struct.Memory* @sub_400680.log_plt(%struct.State* nonnull %0, i64 %983, %struct.Memory* %call2_400b11)
...
block_.L_400b88:                                  ; preds = %block_.L_400b38
  ...
  %call2_400ba7 = tail call %struct.Memory* @sub_400630.exp_plt(%struct.State* nonnull %0, i64 %1065, %struct.Memory* %call2_400b11)
