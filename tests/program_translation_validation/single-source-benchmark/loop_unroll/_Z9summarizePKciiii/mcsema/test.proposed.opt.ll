...
@G_0x15cc2__rip_ = local_unnamed_addr global %G_0x15cc2__rip__type zeroinitializer
...
entry:
  ...
  %49 = load i64, i64* bitcast (%G_0x15cc2__rip__type* @G_0x15cc2__rip_ to i64*), align 8
...
block_.L_4008ea:                                  ; preds = %block_.L_40092d, %entry
  %137 = phi i64 [ %.pre, %entry ], [ %297, %block_.L_40092d ]
  %MEMORY.0 = phi %struct.Memory* [ %2, %entry ], [ %214, %block_.L_40092d ]
  ...
  %144 = load i32, i32* bitcast (%G_0x61c0a8_type* @G_0x61c0a8 to i32*), align 8
  %145 = sub i32 %142, %144
  ...
  br i1 %170, label %block_4008fa, label %block_.L_400940

block_4008fa:                                     ; preds = %block_.L_4008ea
  %172 = load i64, i64* bitcast (%G_0x61c0a0_type* @G_0x61c0a0 to i64*), align 8
  ...
  br i1 %259, label %block_.L_40092d, label %block_400927
...
block_.L_40092d:                                  ; preds = %block_400927, %block_4008fa
  %265 = phi i64 [ %.pre2, %block_400927 ], [ %222, %block_4008fa ]
  %266 = phi i64 [ %.pre1, %block_400927 ], [ %260, %block_4008fa ]
  %267 = add i64 %265, -28
  %268 = add i64 %266, 8
...
block_.L_40098e:                                  ; preds = %block_40099e, %block_.L_400940
  %364 = phi i64 [ %.pre3, %block_.L_400940 ], [ %736, %block_40099e ]
  %MEMORY.2 = phi %struct.Memory* [ %347, %block_.L_400940 ], [ %697, %block_40099e ]
  ...
  %371 = load i32, i32* bitcast (%G_0x61c0a8_type* @G_0x61c0a8 to i32*), align 8
  %372 = sub i32 %369, %371
  ...
  br i1 %397, label %block_40099e, label %block_.L_400a8a
...
block_40099e:                                     ; preds = %block_.L_40098e
  ...
  %407 = load i64, i64* bitcast (%G_0x61c0a0_type* @G_0x61c0a0 to i64*), align 8
  ...
  store i64 ptrtoint (%G__0x416638_type* @G__0x416638 to i64), i64* %446, align 8
  ...
  %506 = load i64, i64* bitcast (%G_0x61c0a0_type* @G_0x61c0a0 to i64*), align 8
  ...
  store double 0.000000e+00, double* %53, align 1
  %587 = load i64, i64* bitcast (%G_0x61c0a0_type* @G_0x61c0a0 to i64*), align 8
  ...
  %661 = load i64, i64* bitcast (%G_0x61c0a0_type* @G_0x61c0a0 to i64*), align 8
...
block_.L_400a91:                                  ; preds = %block_400aa1, %block_.L_400a8a
  %738 = phi i64 [ %847, %block_400aa1 ], [ %.pre4, %block_.L_400a8a ]
  ...
  %745 = load i32, i32* bitcast (%G_0x61c0a8_type* @G_0x61c0a8 to i32*), align 8
  %746 = sub i32 %743, %745
  ...
  br i1 %771, label %block_400aa1, label %block_.L_400ad0

block_400aa1:                                     ; preds = %block_.L_400a91
  %773 = load i64, i64* bitcast (%G_0x61c0a0_type* @G_0x61c0a0 to i64*), align 8
...
block_.L_400ad0:                                  ; preds = %block_.L_400a91
  ...
  %864 = load i32, i32* bitcast (%G_0x61c0a8_type* @G_0x61c0a8 to i32*), align 8
  %865 = add i32 %864, -1
  ...
  br i1 %899, label %block_.L_400b98, label %block_400afb
...
block_400afb:                                     ; preds = %block_.L_400ad0
  ...
  br i1 %911, label %block_.L_400b98, label %block_400b05
...
block_.L_400b0c:                                  ; preds = %block_400b1c, %block_400b05
  %919 = phi i64 [ %.pre5, %block_400b05 ], [ %1041, %block_400b1c ]
  %MEMORY.4 = phi %struct.Memory* [ %862, %block_400b05 ], [ %999, %block_400b1c ]
  ...
  %926 = load i32, i32* bitcast (%G_0x61c0a8_type* @G_0x61c0a8 to i32*), align 8
  %927 = sub i32 %924, %926
  ...
  br i1 %952, label %block_400b1c, label %block_.L_400b5c

block_400b1c:                                     ; preds = %block_.L_400b0c
  %954 = load i64, i64* bitcast (%G_0x61c0a0_type* @G_0x61c0a0 to i64*), align 8
...
block_.L_400b98:                                  ; preds = %block_.L_400b5c, %block_400afb, %block_.L_400ad0
  %1101 = phi i64 [ %900, %block_.L_400ad0 ], [ %915, %block_400afb ], [ %.pre6, %block_.L_400b5c ]
  %MEMORY.5 = phi %struct.Memory* [ %862, %block_.L_400ad0 ], [ %862, %block_400afb ], [ %1094, %block_.L_400b5c ]
...
block_400478:
  ...
  %5 = load i64, i64* bitcast (%G_0x15cc2__rip__type* @G_0x15cc2__rip_ to i64*), align 8
