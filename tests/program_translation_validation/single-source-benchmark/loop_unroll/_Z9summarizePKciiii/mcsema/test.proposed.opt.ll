...
block_.L_40098e:                                  ; preds = %block_40099e, %block_.L_400940
  %361 = phi i64 [ %.pre3, %block_.L_400940 ], [ %731, %block_40099e ]
  %MEMORY.2 = phi %struct.Memory* [ %344, %block_.L_400940 ], [ %693, %block_40099e ]
...
block_40099e:                                     ; preds = %block_.L_40098e
  ...
  store double 0.000000e+00, double* %53, align 1
  %583 = load i64, i64* bitcast (%G_0x61c0a0_type* @G_0x61c0a0 to i64*), align 8
  ...
  %657 = load i64, i64* bitcast (%G_0x61c0a0_type* @G_0x61c0a0 to i64*), align 8
...
block_.L_400a91:                                  ; preds = %block_400aa1, %block_.L_400a8a
  %733 = phi i64 [ %841, %block_400aa1 ], [ %.pre4, %block_.L_400a8a ]
  ...
  %740 = load i32, i32* bitcast (%G_0x61c0a8_type* @G_0x61c0a8 to i32*), align 8
  %741 = sub i32 %738, %740
  ...
  br i1 %766, label %block_400aa1, label %block_.L_400ad0

block_400aa1:                                     ; preds = %block_.L_400a91
  %768 = load i64, i64* bitcast (%G_0x61c0a0_type* @G_0x61c0a0 to i64*), align 8
...
block_.L_400ad0:                                  ; preds = %block_.L_400a91
  ...
  %857 = load i32, i32* bitcast (%G_0x61c0a8_type* @G_0x61c0a8 to i32*), align 8
  %858 = add i32 %857, -1
  ...
  br i1 %892, label %block_.L_400b98, label %block_400afb
...
block_400afb:                                     ; preds = %block_.L_400ad0
  ...
  br i1 %904, label %block_.L_400b98, label %block_400b05
...
block_.L_400b0c:                                  ; preds = %block_400b1c, %block_400b05
  %912 = phi i64 [ %.pre5, %block_400b05 ], [ %1033, %block_400b1c ]
  %MEMORY.4 = phi %struct.Memory* [ %855, %block_400b05 ], [ %992, %block_400b1c ]
  ...
  %919 = load i32, i32* bitcast (%G_0x61c0a8_type* @G_0x61c0a8 to i32*), align 8
  %920 = sub i32 %917, %919
  ...
  br i1 %945, label %block_400b1c, label %block_.L_400b5c

block_400b1c:                                     ; preds = %block_.L_400b0c
  %947 = load i64, i64* bitcast (%G_0x61c0a0_type* @G_0x61c0a0 to i64*), align 8
...
block_.L_400b98:                                  ; preds = %block_.L_400b5c, %block_400afb, %block_.L_400ad0
  %1093 = phi i64 [ %893, %block_.L_400ad0 ], [ %908, %block_400afb ], [ %.pre6, %block_.L_400b5c ]
  %MEMORY.5 = phi %struct.Memory* [ %855, %block_.L_400ad0 ], [ %855, %block_400afb ], [ %1086, %block_.L_400b5c ]
