...
define %struct.Memory* @_ZN13do_loop_testsILi0EdE7do_testEPKdPKc(%struct.State* noalias, i64, %struct.Memory* noalias) #2 {
entry:
  ...
  %loadMem_4072b4 = load %struct.Memory*, %struct.Memory** %MEMORY
  ...
  store i64 %40, i64* %43
  store %struct.Memory* %loadMem_4072b4, %struct.Memory** %MEMORY
  ...
  ret %struct.Memory* %loadMem_4072bd
}
