...
entry:
  ...
  store %struct.Memory* %loadMem_411cc0, %struct.Memory** %MEMORY
  ...
  store i64 %40, i64* %43
  store %struct.Memory* %loadMem_411cc4, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_411ccd, %struct.Memory** %MEMORY
  ret %struct.Memory* %loadMem_411ccd
}
