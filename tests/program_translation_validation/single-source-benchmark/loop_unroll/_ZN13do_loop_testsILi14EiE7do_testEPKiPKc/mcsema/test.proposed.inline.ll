...
define %struct.Memory* @_ZN13do_loop_testsILi14EiE7do_testEPKiPKc(%struct.State* noalias, i64, %struct.Memory* noalias) #1 {
entry:
  ...
  store %struct.Memory* %loadMem1_410b58, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_410b5d, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_410b62, %struct.Memory** %MEMORY
  ...
  ret %struct.Memory* %loadMem_410b8c
}
