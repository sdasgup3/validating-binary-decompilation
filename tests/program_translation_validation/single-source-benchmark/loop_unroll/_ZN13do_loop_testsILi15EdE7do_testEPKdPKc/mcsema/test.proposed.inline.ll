...
declare %struct.Memory* @sub_406060._ZN13do_loop_testsILi14EdE7do_testEPKdPKc(%struct.State* noalias dereferenceable(3376), i64, %struct.Memory* noalias readnone returned)

declare %struct.Memory* @sub_4060b0._Z26test_do_loop_unroll_factorILi15EdEvPKT0_iPKc(%struct.State* noalias dereferenceable(3376), i64, %struct.Memory* noalias readnone returned)
...
entry:
  ...
  %loadMem_405f14 = load %struct.Memory*, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_405f14, %struct.Memory** %MEMORY
  ...
  %loadMem1_405f28 = load %struct.Memory*, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem1_405f28, %struct.Memory** %MEMORY
  %loadMem2_405f28 = load %struct.Memory*, %struct.Memory** %MEMORY
  %loadPC_405f28 = load i64, i64* %3
  %call2_405f28 = call %struct.Memory* @sub_406060._ZN13do_loop_testsILi14EdE7do_testEPKdPKc(%struct.State* %0, i64 %loadPC_405f28, %struct.Memory* %loadMem2_405f28)
  store %struct.Memory* %call2_405f28, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_405f3c, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_405f4b, %struct.Memory** %MEMORY
  %loadMem_405f4e = load %struct.Memory*, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_405f4e, %struct.Memory** %MEMORY
  %loadMem1_405f52 = load %struct.Memory*, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem1_405f52, %struct.Memory** %MEMORY
  %loadMem2_405f52 = load %struct.Memory*, %struct.Memory** %MEMORY
  %loadPC_405f52 = load i64, i64* %3
  %call2_405f52 = call %struct.Memory* @sub_4060b0._Z26test_do_loop_unroll_factorILi15EdEvPKT0_iPKc(%struct.State* %0, i64 %loadPC_405f52, %struct.Memory* %loadMem2_405f52)
  store %struct.Memory* %call2_405f52, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_405f57, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_405f5b, %struct.Memory** %MEMORY
  ...
  ret %struct.Memory* %loadMem_405f5c
}
