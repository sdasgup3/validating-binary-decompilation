...
define %struct.Memory* @_ZN13do_loop_testsILi16EdE7do_testEPKdPKc(%struct.State* noalias, i64, %struct.Memory* noalias) #1 {
entry:
  ...
  store %struct.Memory* %loadMem1_405e08, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_405e2b, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_405e2e, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem1_405e32, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_405e3b, %struct.Memory** %MEMORY
  ...
  ret %struct.Memory* %loadMem_405e3c
}
