...
declare %struct.Memory* @sub_405b20._ZN13do_loop_testsILi18EdE7do_testEPKdPKc(%struct.State* noalias dereferenceable(3376), i64, %struct.Memory* noalias readnone returned)

declare %struct.Memory* @sub_405b70._Z26test_do_loop_unroll_factorILi19EdEvPKT0_iPKc(%struct.State* noalias dereferenceable(3376), i64, %struct.Memory* noalias readnone returned)
...
entry:
  ...
  %loadMem1_4059e8 = load %struct.Memory*, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem1_4059e8, %struct.Memory** %MEMORY
  %loadMem2_4059e8 = load %struct.Memory*, %struct.Memory** %MEMORY
  %loadPC_4059e8 = load i64, i64* %3
  %call2_4059e8 = call %struct.Memory* @sub_405b20._ZN13do_loop_testsILi18EdE7do_testEPKdPKc(%struct.State* %0, i64 %loadPC_4059e8, %struct.Memory* %loadMem2_4059e8)
  store %struct.Memory* %call2_4059e8, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_4059f2, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_4059fc, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_405a0b, %struct.Memory** %MEMORY
  ...
  %loadMem1_405a12 = load %struct.Memory*, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem1_405a12, %struct.Memory** %MEMORY
  %loadMem2_405a12 = load %struct.Memory*, %struct.Memory** %MEMORY
  %loadPC_405a12 = load i64, i64* %3
  %call2_405a12 = call %struct.Memory* @sub_405b70._Z26test_do_loop_unroll_factorILi19EdEvPKT0_iPKc(%struct.State* %0, i64 %loadPC_405a12, %struct.Memory* %loadMem2_405a12)
  store %struct.Memory* %call2_405a12, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_405a1b, %struct.Memory** %MEMORY
  ...
  ret %struct.Memory* %loadMem_405a1c
}
