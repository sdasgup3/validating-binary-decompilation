...
declare %struct.Memory* @sub_40fad0._ZN13do_loop_testsILi27EiE7do_testEPKiPKc(%struct.State* noalias dereferenceable(3376), i64, %struct.Memory* noalias readnone returned)

declare %struct.Memory* @sub_40fb20._Z26test_do_loop_unroll_factorILi28EiEvPKT0_iPKc(%struct.State* noalias dereferenceable(3376), i64, %struct.Memory* noalias readnone returned)
...
entry:
  ...
  %loadMem1_40f9a8 = load %struct.Memory*, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem1_40f9a8, %struct.Memory** %MEMORY
  %loadMem2_40f9a8 = load %struct.Memory*, %struct.Memory** %MEMORY
  %loadPC_40f9a8 = load i64, i64* %3
  %call2_40f9a8 = call %struct.Memory* @sub_40fad0._ZN13do_loop_testsILi27EiE7do_testEPKiPKc(%struct.State* %0, i64 %loadPC_40f9a8, %struct.Memory* %loadMem2_40f9a8)
  store %struct.Memory* %call2_40f9a8, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_40f9ad, %struct.Memory** %MEMORY
  ...
  %loadMem1_40f9d2 = load %struct.Memory*, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem1_40f9d2, %struct.Memory** %MEMORY
  %loadMem2_40f9d2 = load %struct.Memory*, %struct.Memory** %MEMORY
  %loadPC_40f9d2 = load i64, i64* %3
  %call2_40f9d2 = call %struct.Memory* @sub_40fb20._Z26test_do_loop_unroll_factorILi28EiEvPKT0_iPKc(%struct.State* %0, i64 %loadPC_40f9d2, %struct.Memory* %loadMem2_40f9d2)
  store %struct.Memory* %call2_40f9d2, %struct.Memory** %MEMORY
  ...
  ret %struct.Memory* %loadMem_40f9dc
}
