...
define %struct.Memory* @_ZN13do_loop_testsILi29EdE7do_testEPKdPKc(%struct.State* noalias, i64, %struct.Memory* noalias) #1 {
entry:
  ...
  store i64 %78, i64* %81
  store %struct.Memory* %loadMem_404ce8, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem1_404cf8, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem1_404d22, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_404d27, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_404d2c, %struct.Memory** %MEMORY
  ret %struct.Memory* %loadMem_404d2c
}
