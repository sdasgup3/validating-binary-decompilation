...
declare %struct.Memory* @sub_4071a0._ZN13do_loop_testsILi1EdE7do_testEPKdPKc(%struct.State* dereferenceable(3376), i64, %struct.Memory*)

declare %struct.Memory* @sub_4071e0._Z26test_do_loop_unroll_factorILi2EdEvPKT0_iPKc(%struct.State* dereferenceable(3376), i64, %struct.Memory*)

; Function Attrs: alwaysinline
define %struct.Memory* @_ZN13do_loop_testsILi2EdE7do_testEPKdPKc(%struct.State* noalias, i64, %struct.Memory* noalias) #1 {
entry:
