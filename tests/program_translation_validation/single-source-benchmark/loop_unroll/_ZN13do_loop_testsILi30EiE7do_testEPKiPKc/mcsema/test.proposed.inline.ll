...
define %struct.Memory* @_ZN13do_loop_testsILi30EiE7do_testEPKiPKc(%struct.State* noalias, i64, %struct.Memory* noalias) #1 {
entry:
  ...
  store %struct.Memory* %loadMem1_40f758, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_40f75d, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_40f773, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_40f77b, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem1_40f782, %struct.Memory** %MEMORY
  ...
  ret %struct.Memory* %loadMem_40f78c
}
