...
define %struct.Memory* @_ZN13do_loop_testsILi32EiE7do_testEPKiPKc(%struct.State* noalias, i64, %struct.Memory* noalias) #2 {
entry:
  ...
  store %struct.Memory* %loadMem1_401108, %struct.Memory** %MEMORY
  ...
  ret %struct.Memory* %loadMem_40113c
}
