...
define %struct.Memory* @_ZN13do_loop_testsILi3EdE7do_testEPKdPKc(%struct.State* noalias, i64, %struct.Memory* noalias) #2 {
entry:
  ...
  store %struct.Memory* %loadMem1_406f28, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_406f4b, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem1_406f52, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_406f5b, %struct.Memory** %MEMORY
  ...
  ret %struct.Memory* %loadMem_406f5c
}
