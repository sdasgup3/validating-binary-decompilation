...
entry:
  ...
  store %struct.Memory* %loadMem1_406ee8, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_406eed, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem1_406f12, %struct.Memory** %MEMORY
  ...
  ret %struct.Memory* %loadMem_406f1c
}
