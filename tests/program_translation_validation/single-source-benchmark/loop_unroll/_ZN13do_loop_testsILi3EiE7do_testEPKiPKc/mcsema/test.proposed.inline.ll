...
entry:
  ...
  store %struct.Memory* %loadMem_4118e4, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem1_4118e8, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_4118ed, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_41190e, %struct.Memory** %MEMORY
  ...
  ret %struct.Memory* %loadMem_41191c
}
