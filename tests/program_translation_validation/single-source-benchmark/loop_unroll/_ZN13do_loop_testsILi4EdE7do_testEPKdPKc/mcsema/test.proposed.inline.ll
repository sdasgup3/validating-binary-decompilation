...
entry:
  ...
  store %struct.Memory* %loadMem_406d84, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_406d94, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem1_406d98, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_406dbe, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem1_406dc2, %struct.Memory** %MEMORY
  ...
  ret %struct.Memory* %loadMem_406dcc
}
