...
define %struct.Memory* @_ZN13do_loop_testsILi4EiE7do_testEPKiPKc(%struct.State* noalias, i64, %struct.Memory* noalias) #1 {
entry:
  ...
  store %struct.Memory* %loadMem1_4117d8, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_4117dd, %struct.Memory** %MEMORY
  ...
  ret %struct.Memory* %loadMem_41180c
}
