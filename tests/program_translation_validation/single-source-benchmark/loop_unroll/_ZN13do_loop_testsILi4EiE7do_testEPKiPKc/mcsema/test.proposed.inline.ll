...
define %struct.Memory* @_ZN13do_loop_testsILi4EiE7do_testEPKiPKc(%struct.State* noalias, i64, %struct.Memory* noalias) #2 {
entry:
  ...
  store %struct.Memory* %loadMem_4117d1, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem1_4117e8, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_4117f2, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem1_411812, %struct.Memory** %MEMORY
  ...
  ret %struct.Memory* %loadMem_41181c
}
