...
define %struct.Memory* @_ZN13do_loop_testsILi5EdE7do_testEPKdPKc(%struct.State* noalias, i64, %struct.Memory* noalias) #2 {
entry:
  ...
  store %struct.Memory* %loadMem_406c44, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem1_406c48, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_406c4d, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem1_406c72, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_406c77, %struct.Memory** %MEMORY
  ...
  ret %struct.Memory* %loadMem_406c7c
}
