...
entry:
  ...
  store %struct.Memory* %loadMem1_406c78, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_406c7d, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem1_406ca2, %struct.Memory** %MEMORY
  ...
  ret %struct.Memory* %loadMem_406cac
}
