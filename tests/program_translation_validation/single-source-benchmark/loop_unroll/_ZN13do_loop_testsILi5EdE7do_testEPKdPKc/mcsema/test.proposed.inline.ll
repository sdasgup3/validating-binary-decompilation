...
entry:
  ...
  store %struct.Memory* %loadMem1_406c88, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_406ca3, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem1_406cb2, %struct.Memory** %MEMORY
  ...
  ret %struct.Memory* %loadMem_406cbc
}
