...
define %struct.Memory* @_ZN13do_loop_testsILi5EiE7do_testEPKiPKc(%struct.State* noalias, i64, %struct.Memory* noalias) #1 {
entry:
  ...
  store i64 %93, i64* %96
  store %struct.Memory* %loadMem_41168c, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem1_411698, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem1_4116c2, %struct.Memory** %MEMORY
  ...
  ret %struct.Memory* %loadMem_4116cc
}
