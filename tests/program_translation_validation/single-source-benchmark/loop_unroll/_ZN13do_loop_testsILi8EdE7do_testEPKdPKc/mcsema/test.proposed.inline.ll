...
define %struct.Memory* @_ZN13do_loop_testsILi8EdE7do_testEPKdPKc(%struct.State* noalias, i64, %struct.Memory* noalias) #1 {
entry:
  ...
  store %struct.Memory* %loadMem1_406888, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_4068ab, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_4068ae, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem1_4068b2, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_4068bb, %struct.Memory** %MEMORY
  ...
  ret %struct.Memory* %loadMem_4068bc
}
