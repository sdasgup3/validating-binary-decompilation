...
define %struct.Memory* @_ZN14for_loop_testsILi0EiE7do_testEPKiPKc(%struct.State* noalias nocapture, i64, %struct.Memory* noalias readnone returned) local_unnamed_addr #0 {
entry:
