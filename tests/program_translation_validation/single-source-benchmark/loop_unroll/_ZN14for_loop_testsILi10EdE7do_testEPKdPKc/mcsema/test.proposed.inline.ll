...
define %struct.Memory* @_ZN14for_loop_testsILi10EdE7do_testEPKdPKc(%struct.State* noalias, i64, %struct.Memory* noalias) #1 {
entry:
  ...
  store %struct.Memory* %loadMem1_40b2d2, %struct.Memory** %MEMORY
  ...
  ret %struct.Memory* %loadMem_40b2dc
}
