...
define %struct.Memory* @_ZN14for_loop_testsILi10EdE7do_testEPKdPKc(%struct.State* noalias, i64, %struct.Memory* noalias) #2 {
entry:
  ...
  store %struct.Memory* %loadMem_40b264, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_40b297, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem1_40b2a2, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_40b2a7, %struct.Memory** %MEMORY
  ...
  ret %struct.Memory* %loadMem_40b2ac
}
