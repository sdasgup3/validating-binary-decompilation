...
define %struct.Memory* @_ZN14for_loop_testsILi13EiE7do_testEPKiPKc(%struct.State* noalias, i64, %struct.Memory* noalias) #1 {
entry:
  ...
  store i64 %93, i64* %96
  store %struct.Memory* %loadMem_4155ac, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_4155d3, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_4155d7, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_4155de, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem1_4155e2, %struct.Memory** %MEMORY
  ...
  ret %struct.Memory* %loadMem_4155ec
}
