...
entry:
  ...
  store %struct.Memory* %loadMem_40acb1, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem1_40acc8, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_40ace3, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem1_40acf2, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_40acf7, %struct.Memory** %MEMORY
  ...
  ret %struct.Memory* %loadMem_40acfc
}
