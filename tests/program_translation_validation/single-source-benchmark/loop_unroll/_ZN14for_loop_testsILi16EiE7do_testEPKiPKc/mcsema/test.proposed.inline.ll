...
define %struct.Memory* @_ZN14for_loop_testsILi16EiE7do_testEPKiPKc(%struct.State* noalias, i64, %struct.Memory* noalias) #1 {
entry:
  ...
  store %struct.Memory* %loadMem1_415258, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_41525d, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_415262, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem1_415282, %struct.Memory** %MEMORY
  ...
  ret %struct.Memory* %loadMem_41528c
}
