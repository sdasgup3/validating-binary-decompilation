...
declare %struct.Memory* @sub_415210._ZN14for_loop_testsILi16EiE7do_testEPKiPKc(%struct.State* noalias dereferenceable(3376), i64, %struct.Memory* noalias readnone returned)

declare %struct.Memory* @sub_415260._Z27test_for_loop_unroll_factorILi17EiEvPKT0_iPKc(%struct.State* noalias dereferenceable(3376), i64, %struct.Memory* noalias readnone returned)
...
entry:
  ...
  store %struct.Memory* %loadMem_415104, %struct.Memory** %MEMORY
  ...
  %call2_415108 = call %struct.Memory* @sub_415210._ZN14for_loop_testsILi16EiE7do_testEPKiPKc(%struct.State* %0, i64 %loadPC_415108, %struct.Memory* %loadMem2_415108)
  ...
  %loadMem1_415132 = load %struct.Memory*, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem1_415132, %struct.Memory** %MEMORY
  %loadMem2_415132 = load %struct.Memory*, %struct.Memory** %MEMORY
  %loadPC_415132 = load i64, i64* %3
  %call2_415132 = call %struct.Memory* @sub_415260._Z27test_for_loop_unroll_factorILi17EiEvPKT0_iPKc(%struct.State* %0, i64 %loadPC_415132, %struct.Memory* %loadMem2_415132)
  store %struct.Memory* %call2_415132, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_415137, %struct.Memory** %MEMORY
  ...
  ret %struct.Memory* %loadMem_41513c
}
