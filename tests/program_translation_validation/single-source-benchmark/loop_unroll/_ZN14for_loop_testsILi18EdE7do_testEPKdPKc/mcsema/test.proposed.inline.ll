...
define %struct.Memory* @_ZN14for_loop_testsILi18EdE7do_testEPKdPKc(%struct.State* noalias, i64, %struct.Memory* noalias) #1 {
entry:
  ...
  store %struct.Memory* %loadMem_40a910, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem1_40a928, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_40a92d, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_40a93c, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_40a943, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_40a947, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem1_40a952, %struct.Memory** %MEMORY
  ...
  ret %struct.Memory* %loadMem_40a95c
}
