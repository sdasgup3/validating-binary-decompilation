...
declare %struct.Memory* @sub_414eb0._ZN14for_loop_testsILi19EiE7do_testEPKiPKc(%struct.State* noalias dereferenceable(3376), i64, %struct.Memory* noalias readnone returned)

declare %struct.Memory* @sub_414f00._Z27test_for_loop_unroll_factorILi20EiEvPKT0_iPKc(%struct.State* noalias dereferenceable(3376), i64, %struct.Memory* noalias readnone returned)
...
entry:
  ...
  store i64 %93, i64* %96
  store %struct.Memory* %loadMem_414d9c, %struct.Memory** %MEMORY
  ...
  %loadMem1_414da8 = load %struct.Memory*, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem1_414da8, %struct.Memory** %MEMORY
  %loadMem2_414da8 = load %struct.Memory*, %struct.Memory** %MEMORY
  %loadPC_414da8 = load i64, i64* %3
  %call2_414da8 = call %struct.Memory* @sub_414eb0._ZN14for_loop_testsILi19EiE7do_testEPKiPKc(%struct.State* %0, i64 %loadPC_414da8, %struct.Memory* %loadMem2_414da8)
  store %struct.Memory* %call2_414da8, %struct.Memory** %MEMORY
  %loadMem_414dad = load %struct.Memory*, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_414dad, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_414dc7, %struct.Memory** %MEMORY
  ...
  %loadMem1_414dd2 = load %struct.Memory*, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem1_414dd2, %struct.Memory** %MEMORY
  %loadMem2_414dd2 = load %struct.Memory*, %struct.Memory** %MEMORY
  %loadPC_414dd2 = load i64, i64* %3
  %call2_414dd2 = call %struct.Memory* @sub_414f00._Z27test_for_loop_unroll_factorILi20EiEvPKT0_iPKc(%struct.State* %0, i64 %loadPC_414dd2, %struct.Memory* %loadMem2_414dd2)
  store %struct.Memory* %call2_414dd2, %struct.Memory** %MEMORY
  ...
  ret %struct.Memory* %loadMem_414ddc
}
