...
entry:
  ...
  store %struct.Memory* %loadMem1_414ba8, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_414bad, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_414bce, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem1_414bd2, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_414bdb, %struct.Memory** %MEMORY
  ...
  ret %struct.Memory* %loadMem_414bdc
}
