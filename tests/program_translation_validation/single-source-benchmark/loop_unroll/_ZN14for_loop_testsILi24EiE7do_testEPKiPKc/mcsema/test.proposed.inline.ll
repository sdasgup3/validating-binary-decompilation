...
entry:
  ...
  store %struct.Memory* %loadMem_414920, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_414924, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem1_414928, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_41492d, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem1_414952, %struct.Memory** %MEMORY
  ...
  ret %struct.Memory* %loadMem_41495c
}
