...
define %struct.Memory* @_ZN14for_loop_testsILi24EiE7do_testEPKiPKc(%struct.State* noalias, i64, %struct.Memory* noalias) #1 {
entry:
  ...
  store i64 %78, i64* %81
  store %struct.Memory* %loadMem_414948, %struct.Memory** %MEMORY
  ...
  store i64 %93, i64* %96
  store %struct.Memory* %loadMem_41494c, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem1_414958, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_414962, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem1_414982, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_41498c, %struct.Memory** %MEMORY
  ret %struct.Memory* %loadMem_41498c
}
