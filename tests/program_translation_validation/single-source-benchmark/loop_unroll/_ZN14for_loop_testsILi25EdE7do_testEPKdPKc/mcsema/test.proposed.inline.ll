...
define %struct.Memory* @_ZN14for_loop_testsILi25EdE7do_testEPKdPKc(%struct.State* noalias, i64, %struct.Memory* noalias) #1 {
entry:
  ...
  store %struct.Memory* %loadMem1_40a0d8, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_40a0dd, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_40a0f7, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem1_40a102, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_40a107, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_40a10c, %struct.Memory** %MEMORY
  ret %struct.Memory* %loadMem_40a10c
}
