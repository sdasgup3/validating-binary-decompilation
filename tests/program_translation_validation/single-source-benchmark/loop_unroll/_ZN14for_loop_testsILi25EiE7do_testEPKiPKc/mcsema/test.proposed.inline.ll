...
declare %struct.Memory* @sub_414910._ZN14for_loop_testsILi24EiE7do_testEPKiPKc(%struct.State* noalias dereferenceable(3376), i64, %struct.Memory* noalias readnone returned)

declare %struct.Memory* @sub_414960._Z27test_for_loop_unroll_factorILi25EiEvPKT0_iPKc(%struct.State* noalias dereferenceable(3376), i64, %struct.Memory* noalias readnone returned)
...
entry:
  ...
  %loadMem_414800 = load %struct.Memory*, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_414800, %struct.Memory** %MEMORY
  ...
  %loadMem1_414808 = load %struct.Memory*, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem1_414808, %struct.Memory** %MEMORY
  %loadMem2_414808 = load %struct.Memory*, %struct.Memory** %MEMORY
  %loadPC_414808 = load i64, i64* %3
  %call2_414808 = call %struct.Memory* @sub_414910._ZN14for_loop_testsILi24EiE7do_testEPKiPKc(%struct.State* %0, i64 %loadPC_414808, %struct.Memory* %loadMem2_414808)
  store %struct.Memory* %call2_414808, %struct.Memory** %MEMORY
  ...
  %loadMem_41482e = load %struct.Memory*, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_41482e, %struct.Memory** %MEMORY
  %loadMem1_414832 = load %struct.Memory*, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem1_414832, %struct.Memory** %MEMORY
  %loadMem2_414832 = load %struct.Memory*, %struct.Memory** %MEMORY
  %loadPC_414832 = load i64, i64* %3
  %call2_414832 = call %struct.Memory* @sub_414960._Z27test_for_loop_unroll_factorILi25EiEvPKT0_iPKc(%struct.State* %0, i64 %loadPC_414832, %struct.Memory* %loadMem2_414832)
  store %struct.Memory* %call2_414832, %struct.Memory** %MEMORY
  ...
  ret %struct.Memory* %loadMem_41483c
}
