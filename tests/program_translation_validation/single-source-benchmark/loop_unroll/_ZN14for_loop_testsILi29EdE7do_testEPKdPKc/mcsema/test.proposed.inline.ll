...
define %struct.Memory* @_ZN14for_loop_testsILi29EdE7do_testEPKdPKc(%struct.State* noalias, i64, %struct.Memory* noalias) #1 {
entry:
  ...
  store %struct.Memory* %loadMem1_409c18, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem1_409c42, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_409c47, %struct.Memory** %MEMORY
  ...
  ret %struct.Memory* %loadMem_409c4c
}
