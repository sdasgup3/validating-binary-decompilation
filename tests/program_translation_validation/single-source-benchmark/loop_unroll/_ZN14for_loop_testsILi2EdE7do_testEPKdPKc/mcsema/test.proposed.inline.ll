...
define %struct.Memory* @_ZN14for_loop_testsILi2EdE7do_testEPKdPKc(%struct.State* noalias, i64, %struct.Memory* noalias) #2 {
entry:
  ...
  store %struct.Memory* %loadMem1_40bc38, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_40bc3d, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_40bc42, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_40bc54, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem1_40bc5f, %struct.Memory** %MEMORY
  ...
  ret %struct.Memory* %loadMem_40bc69
}
