...
define %struct.Memory* @_ZN14for_loop_testsILi30EdE7do_testEPKdPKc(%struct.State* noalias, i64, %struct.Memory* noalias) #1 {
entry:
  ...
  store %struct.Memory* %loadMem_409ad4, %struct.Memory** %MEMORY
  ...
  store i64 %78, i64* %81
  store %struct.Memory* %loadMem_409ad8, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem1_409ae8, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem1_409b12, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_409b1c, %struct.Memory** %MEMORY
  ret %struct.Memory* %loadMem_409b1c
}
