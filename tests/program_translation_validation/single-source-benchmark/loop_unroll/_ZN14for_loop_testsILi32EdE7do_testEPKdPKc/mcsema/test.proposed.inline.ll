...
define %struct.Memory* @_ZN14for_loop_testsILi32EdE7do_testEPKdPKc(%struct.State* noalias, i64, %struct.Memory* noalias) #1 {
entry:
  ...
  store %struct.Memory* %loadMem1_4011d8, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem1_401202, %struct.Memory** %MEMORY
  ...
  ret %struct.Memory* %loadMem_40120c
}
