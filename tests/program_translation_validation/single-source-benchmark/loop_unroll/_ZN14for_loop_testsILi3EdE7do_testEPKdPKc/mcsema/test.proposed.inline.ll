...
define %struct.Memory* @_ZN14for_loop_testsILi3EdE7do_testEPKdPKc(%struct.State* noalias, i64, %struct.Memory* noalias) #2 {
entry:
  ...
  store i64 %78, i64* %81
  store %struct.Memory* %loadMem_40baf8, %struct.Memory** %MEMORY
  ...
  store i64 %93, i64* %96
  store %struct.Memory* %loadMem_40bafc, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_40bb12, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_40bb27, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem1_40bb32, %struct.Memory** %MEMORY
  ...
  ret %struct.Memory* %loadMem_40bb3c
}
