...
declare %struct.Memory* @sub_40bab0._ZN14for_loop_testsILi3EdE7do_testEPKdPKc(%struct.State* noalias dereferenceable(3376), i64, %struct.Memory* noalias readnone returned)

declare %struct.Memory* @sub_40bb00._Z27test_for_loop_unroll_factorILi4EdEvPKT0_iPKc(%struct.State* noalias dereferenceable(3376), i64, %struct.Memory* noalias readnone returned)
...
entry:
  ...
  %call2_40b998 = call %struct.Memory* @sub_40bab0._ZN14for_loop_testsILi3EdE7do_testEPKdPKc(%struct.State* %0, i64 %loadPC_40b998, %struct.Memory* %loadMem2_40b998)
  ...
  store %struct.Memory* %loadMem_40b9a2, %struct.Memory** %MEMORY
  ...
  %loadMem1_40b9c2 = load %struct.Memory*, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem1_40b9c2, %struct.Memory** %MEMORY
  %loadMem2_40b9c2 = load %struct.Memory*, %struct.Memory** %MEMORY
  %loadPC_40b9c2 = load i64, i64* %3
  %call2_40b9c2 = call %struct.Memory* @sub_40bb00._Z27test_for_loop_unroll_factorILi4EdEvPKT0_iPKc(%struct.State* %0, i64 %loadPC_40b9c2, %struct.Memory* %loadMem2_40b9c2)
  store %struct.Memory* %call2_40b9c2, %struct.Memory** %MEMORY
  ...
  ret %struct.Memory* %loadMem_40b9cc
}
