...
declare %struct.Memory* @sub_40b9c0._ZN14for_loop_testsILi4EdE7do_testEPKdPKc(%struct.State* noalias dereferenceable(3376), i64, %struct.Memory* noalias readnone returned)

declare %struct.Memory* @sub_40ba10._Z27test_for_loop_unroll_factorILi5EdEvPKT0_iPKc(%struct.State* noalias dereferenceable(3376), i64, %struct.Memory* noalias readnone returned)
...
entry:
  ...
  %loadMem_40b894 = load %struct.Memory*, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_40b894, %struct.Memory** %MEMORY
  ...
  %loadMem_40b8a0 = load %struct.Memory*, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_40b8a0, %struct.Memory** %MEMORY
  ...
  %loadMem1_40b8a8 = load %struct.Memory*, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem1_40b8a8, %struct.Memory** %MEMORY
  %loadMem2_40b8a8 = load %struct.Memory*, %struct.Memory** %MEMORY
  %loadPC_40b8a8 = load i64, i64* %3
  %call2_40b8a8 = call %struct.Memory* @sub_40b9c0._ZN14for_loop_testsILi4EdE7do_testEPKdPKc(%struct.State* %0, i64 %loadPC_40b8a8, %struct.Memory* %loadMem2_40b8a8)
  store %struct.Memory* %call2_40b8a8, %struct.Memory** %MEMORY
  %loadMem_40b8ad = load %struct.Memory*, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_40b8ad, %struct.Memory** %MEMORY
  ...
  %loadMem_40b8cb = load %struct.Memory*, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_40b8cb, %struct.Memory** %MEMORY
  ...
  %loadMem1_40b8d2 = load %struct.Memory*, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem1_40b8d2, %struct.Memory** %MEMORY
  %loadMem2_40b8d2 = load %struct.Memory*, %struct.Memory** %MEMORY
  %loadPC_40b8d2 = load i64, i64* %3
  %call2_40b8d2 = call %struct.Memory* @sub_40ba10._Z27test_for_loop_unroll_factorILi5EdEvPKT0_iPKc(%struct.State* %0, i64 %loadPC_40b8d2, %struct.Memory* %loadMem2_40b8d2)
  store %struct.Memory* %call2_40b8d2, %struct.Memory** %MEMORY
  ...
  ret %struct.Memory* %loadMem_40b8dc
}
