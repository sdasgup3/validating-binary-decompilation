...
declare %struct.Memory* @sub_40b9b0._ZN14for_loop_testsILi4EdE7do_testEPKdPKc(%struct.State* noalias dereferenceable(3376), i64, %struct.Memory* noalias readnone returned)

declare %struct.Memory* @sub_40ba00._Z27test_for_loop_unroll_factorILi5EdEvPKT0_iPKc(%struct.State* noalias dereferenceable(3376), i64, %struct.Memory* noalias readnone returned)
...
entry:
  ...
  %loadMem1_40b898 = load %struct.Memory*, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem1_40b898, %struct.Memory** %MEMORY
  %loadMem2_40b898 = load %struct.Memory*, %struct.Memory** %MEMORY
  %loadPC_40b898 = load i64, i64* %3
  %call2_40b898 = call %struct.Memory* @sub_40b9b0._ZN14for_loop_testsILi4EdE7do_testEPKdPKc(%struct.State* %0, i64 %loadPC_40b898, %struct.Memory* %loadMem2_40b898)
  store %struct.Memory* %call2_40b898, %struct.Memory** %MEMORY
  %loadMem_40b89d = load %struct.Memory*, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_40b89d, %struct.Memory** %MEMORY
  ...
  %loadMem_40b8ac = load %struct.Memory*, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_40b8ac, %struct.Memory** %MEMORY
  %loadMem_40b8b3 = load %struct.Memory*, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_40b8b3, %struct.Memory** %MEMORY
  ...
  %loadMem1_40b8c2 = load %struct.Memory*, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem1_40b8c2, %struct.Memory** %MEMORY
  %loadMem2_40b8c2 = load %struct.Memory*, %struct.Memory** %MEMORY
  %loadPC_40b8c2 = load i64, i64* %3
  %call2_40b8c2 = call %struct.Memory* @sub_40ba00._Z27test_for_loop_unroll_factorILi5EdEvPKT0_iPKc(%struct.State* %0, i64 %loadPC_40b8c2, %struct.Memory* %loadMem2_40b8c2)
  store %struct.Memory* %call2_40b8c2, %struct.Memory** %MEMORY
  ...
  ret %struct.Memory* %loadMem_40b8cc
}
