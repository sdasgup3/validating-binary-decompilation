...
define %struct.Memory* @_ZN14for_loop_testsILi7EdE7do_testEPKdPKc(%struct.State* noalias, i64, %struct.Memory* noalias) #1 {
entry:
  ...
  store %struct.Memory* %loadMem_40b624, %struct.Memory** %MEMORY
  ...
  store i64 %93, i64* %96
  store %struct.Memory* %loadMem_40b62c, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_40b642, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_40b653, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_40b657, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem1_40b662, %struct.Memory** %MEMORY
  ...
  ret %struct.Memory* %loadMem_40b66c
}
