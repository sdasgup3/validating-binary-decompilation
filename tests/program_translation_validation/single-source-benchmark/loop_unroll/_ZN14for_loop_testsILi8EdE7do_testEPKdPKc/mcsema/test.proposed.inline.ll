...
declare %struct.Memory* @sub_40b5f0._ZN14for_loop_testsILi7EdE7do_testEPKdPKc(%struct.State* noalias dereferenceable(3376), i64, %struct.Memory* noalias readnone returned)

declare %struct.Memory* @sub_40b640._Z27test_for_loop_unroll_factorILi8EdEvPKT0_iPKc(%struct.State* noalias dereferenceable(3376), i64, %struct.Memory* noalias readnone returned)
...
entry:
  ...
  %loadMem_40b4c1 = load %struct.Memory*, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_40b4c1, %struct.Memory** %MEMORY
  ...
  %loadMem_40b4cc = load %struct.Memory*, %struct.Memory** %MEMORY
  ...
  store i64 %93, i64* %96
  store %struct.Memory* %loadMem_40b4cc, %struct.Memory** %MEMORY
  ...
  %loadMem1_40b4d8 = load %struct.Memory*, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem1_40b4d8, %struct.Memory** %MEMORY
  %loadMem2_40b4d8 = load %struct.Memory*, %struct.Memory** %MEMORY
  %loadPC_40b4d8 = load i64, i64* %3
  %call2_40b4d8 = call %struct.Memory* @sub_40b5f0._ZN14for_loop_testsILi7EdE7do_testEPKdPKc(%struct.State* %0, i64 %loadPC_40b4d8, %struct.Memory* %loadMem2_40b4d8)
  store %struct.Memory* %call2_40b4d8, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_40b4e2, %struct.Memory** %MEMORY
  %loadMem_40b4ec = load %struct.Memory*, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_40b4ec, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_40b4f3, %struct.Memory** %MEMORY
  ...
  %loadMem1_40b502 = load %struct.Memory*, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem1_40b502, %struct.Memory** %MEMORY
  %loadMem2_40b502 = load %struct.Memory*, %struct.Memory** %MEMORY
  %loadPC_40b502 = load i64, i64* %3
  %call2_40b502 = call %struct.Memory* @sub_40b640._Z27test_for_loop_unroll_factorILi8EdEvPKT0_iPKc(%struct.State* %0, i64 %loadPC_40b502, %struct.Memory* %loadMem2_40b502)
  store %struct.Memory* %call2_40b502, %struct.Memory** %MEMORY
  ...
  ret %struct.Memory* %loadMem_40b50c
}
