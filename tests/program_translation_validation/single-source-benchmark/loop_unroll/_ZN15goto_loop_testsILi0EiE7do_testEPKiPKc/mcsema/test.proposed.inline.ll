...
define %struct.Memory* @_ZN15goto_loop_testsILi0EiE7do_testEPKiPKc(%struct.State* noalias, i64, %struct.Memory* noalias) #1 {
entry:
  ...
  store i64 %55, i64* %58
  store %struct.Memory* %loadMem_40f4f8, %struct.Memory** %MEMORY
  ...
  ret %struct.Memory* %loadMem_40f4fd
}
