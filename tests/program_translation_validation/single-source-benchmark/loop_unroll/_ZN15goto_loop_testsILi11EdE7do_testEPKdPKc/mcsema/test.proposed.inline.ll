...
define %struct.Memory* @_ZN15goto_loop_testsILi11EdE7do_testEPKdPKc(%struct.State* noalias, i64, %struct.Memory* noalias) #1 {
entry:
  ...
  store %struct.Memory* %loadMem_403ad0, %struct.Memory** %MEMORY
  ...
  store i64 %78, i64* %81
  store %struct.Memory* %loadMem_403ad8, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_403ae4, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem1_403ae8, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_403b03, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem1_403b12, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_403b17, %struct.Memory** %MEMORY
  ...
  ret %struct.Memory* %loadMem_403b1c
}
