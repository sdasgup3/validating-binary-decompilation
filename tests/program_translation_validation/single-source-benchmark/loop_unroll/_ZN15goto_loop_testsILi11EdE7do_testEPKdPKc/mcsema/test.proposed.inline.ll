...
define %struct.Memory* @_ZN15goto_loop_testsILi11EdE7do_testEPKdPKc(%struct.State* noalias, i64, %struct.Memory* noalias) #2 {
entry:
  ...
  store %struct.Memory* %loadMem1_403ab8, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_403abd, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_403acc, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_403adb, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_403ade, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem1_403ae2, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_403ae7, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_403aeb, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_403aec, %struct.Memory** %MEMORY
  ret %struct.Memory* %loadMem_403aec
}
