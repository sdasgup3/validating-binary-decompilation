...
define %struct.Memory* @_ZN15goto_loop_testsILi12EdE7do_testEPKdPKc(%struct.State* noalias, i64, %struct.Memory* noalias) #1 {
entry:
  ...
  store %struct.Memory* %loadMem1_4039c2, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_4039c7, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_4039cb, %struct.Memory** %MEMORY
  ...
  ret %struct.Memory* %loadMem_4039cc
}
