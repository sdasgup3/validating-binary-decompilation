...
define %struct.Memory* @_ZN15goto_loop_testsILi13EdE7do_testEPKdPKc(%struct.State* noalias, i64, %struct.Memory* noalias) #1 {
entry:
  ...
  store %struct.Memory* %loadMem1_403848, %struct.Memory** %MEMORY
  ...
  ret %struct.Memory* %loadMem_40387c
}
