...
define %struct.Memory* @_ZN15goto_loop_testsILi14EdE7do_testEPKdPKc(%struct.State* noalias, i64, %struct.Memory* noalias) #1 {
entry:
  ...
  store %struct.Memory* %loadMem1_403722, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_403727, %struct.Memory** %MEMORY
  ...
  ret %struct.Memory* %loadMem_40372c
}
