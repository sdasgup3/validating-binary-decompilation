...
define %struct.Memory* @_ZN15goto_loop_testsILi15EdE7do_testEPKdPKc(%struct.State* noalias, i64, %struct.Memory* noalias) #1 {
entry:
  ...
  store %struct.Memory* %loadMem1_4035a8, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem1_4035d2, %struct.Memory** %MEMORY
  ...
  ret %struct.Memory* %loadMem_4035dc
}
