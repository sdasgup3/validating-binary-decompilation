...
define %struct.Memory* @_ZN15goto_loop_testsILi17EdE7do_testEPKdPKc(%struct.State* noalias, i64, %struct.Memory* noalias) #2 {
entry:
  ...
  store i64 %78, i64* %81
  store %struct.Memory* %loadMem_403308, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem1_403318, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_403322, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem1_403342, %struct.Memory** %MEMORY
  ...
  ret %struct.Memory* %loadMem_40334c
}
