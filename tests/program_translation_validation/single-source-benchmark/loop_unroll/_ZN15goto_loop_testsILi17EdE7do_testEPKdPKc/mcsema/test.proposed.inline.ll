...
define %struct.Memory* @_ZN15goto_loop_testsILi17EdE7do_testEPKdPKc(%struct.State* noalias, i64, %struct.Memory* noalias) #1 {
entry:
  ...
  store %struct.Memory* %loadMem1_403308, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_40330d, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_403323, %struct.Memory** %MEMORY
  ...
  ret %struct.Memory* %loadMem_40333c
}
