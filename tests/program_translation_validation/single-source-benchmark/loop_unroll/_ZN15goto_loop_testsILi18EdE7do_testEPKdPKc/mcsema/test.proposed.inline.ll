...
declare %struct.Memory* @sub_4032c0._ZN15goto_loop_testsILi17EdE7do_testEPKdPKc(%struct.State* noalias dereferenceable(3376), i64, %struct.Memory* noalias readnone returned)

declare %struct.Memory* @sub_403310._Z28test_goto_loop_unroll_factorILi18EdEvPKT0_iPKc(%struct.State* noalias dereferenceable(3376), i64, %struct.Memory* noalias readnone returned)
...
entry:
  ...
  store %struct.Memory* %loadMem1_403188, %struct.Memory** %MEMORY
  %loadMem2_403188 = load %struct.Memory*, %struct.Memory** %MEMORY
  %loadPC_403188 = load i64, i64* %3
  %call2_403188 = call %struct.Memory* @sub_4032c0._ZN15goto_loop_testsILi17EdE7do_testEPKdPKc(%struct.State* %0, i64 %loadPC_403188, %struct.Memory* %loadMem2_403188)
  ...
  %loadMem1_4031b2 = load %struct.Memory*, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem1_4031b2, %struct.Memory** %MEMORY
  %loadMem2_4031b2 = load %struct.Memory*, %struct.Memory** %MEMORY
  %loadPC_4031b2 = load i64, i64* %3
  %call2_4031b2 = call %struct.Memory* @sub_403310._Z28test_goto_loop_unroll_factorILi18EdEvPKT0_iPKc(%struct.State* %0, i64 %loadPC_4031b2, %struct.Memory* %loadMem2_4031b2)
  store %struct.Memory* %call2_4031b2, %struct.Memory** %MEMORY
  ...
  ret %struct.Memory* %loadMem_4031bc
}
