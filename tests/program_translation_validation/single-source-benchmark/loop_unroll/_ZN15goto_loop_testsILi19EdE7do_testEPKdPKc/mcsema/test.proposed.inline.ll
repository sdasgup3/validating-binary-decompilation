...
declare %struct.Memory* @sub_403170._ZN15goto_loop_testsILi18EdE7do_testEPKdPKc(%struct.State* noalias dereferenceable(3376), i64, %struct.Memory* noalias readnone returned)

declare %struct.Memory* @sub_4031c0._Z28test_goto_loop_unroll_factorILi19EdEvPKT0_iPKc(%struct.State* noalias dereferenceable(3376), i64, %struct.Memory* noalias readnone returned)
...
entry:
  ...
  store %struct.Memory* %loadMem_403034, %struct.Memory** %MEMORY
  %loadMem1_403038 = load %struct.Memory*, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem1_403038, %struct.Memory** %MEMORY
  %loadMem2_403038 = load %struct.Memory*, %struct.Memory** %MEMORY
  %loadPC_403038 = load i64, i64* %3
  %call2_403038 = call %struct.Memory* @sub_403170._ZN15goto_loop_testsILi18EdE7do_testEPKdPKc(%struct.State* %0, i64 %loadPC_403038, %struct.Memory* %loadMem2_403038)
  store %struct.Memory* %call2_403038, %struct.Memory** %MEMORY
  ...
  %call2_403062 = call %struct.Memory* @sub_4031c0._Z28test_goto_loop_unroll_factorILi19EdEvPKT0_iPKc(%struct.State* %0, i64 %loadPC_403062, %struct.Memory* %loadMem2_403062)
  ...
  ret %struct.Memory* %loadMem_40306c
}
