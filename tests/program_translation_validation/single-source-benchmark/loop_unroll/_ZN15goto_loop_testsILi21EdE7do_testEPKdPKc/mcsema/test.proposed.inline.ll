...
define %struct.Memory* @_ZN15goto_loop_testsILi21EdE7do_testEPKdPKc(%struct.State* noalias, i64, %struct.Memory* noalias) #1 {
entry:
  ...
  store %struct.Memory* %loadMem_402db0, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem1_402dc8, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_402dd2, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_402de3, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem1_402df2, %struct.Memory** %MEMORY
  ...
  ret %struct.Memory* %loadMem_402dfc
}
