...
entry:
  ...
  store %struct.Memory* %loadMem1_402d98, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_402d9d, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_402db7, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem1_402dc2, %struct.Memory** %MEMORY
  ...
  ret %struct.Memory* %loadMem_402dcc
}
