...
declare %struct.Memory* @sub_402d80._ZN15goto_loop_testsILi21EdE7do_testEPKdPKc(%struct.State* noalias dereferenceable(3376), i64, %struct.Memory* noalias readnone returned)

declare %struct.Memory* @sub_402dd0._Z28test_goto_loop_unroll_factorILi22EdEvPKT0_iPKc(%struct.State* noalias dereferenceable(3376), i64, %struct.Memory* noalias readnone returned)
...
entry:
  ...
  %loadMem1_402c48 = load %struct.Memory*, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem1_402c48, %struct.Memory** %MEMORY
  %loadMem2_402c48 = load %struct.Memory*, %struct.Memory** %MEMORY
  %loadPC_402c48 = load i64, i64* %3
  %call2_402c48 = call %struct.Memory* @sub_402d80._ZN15goto_loop_testsILi21EdE7do_testEPKdPKc(%struct.State* %0, i64 %loadPC_402c48, %struct.Memory* %loadMem2_402c48)
  store %struct.Memory* %call2_402c48, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_402c52, %struct.Memory** %MEMORY
  ...
  %loadMem_402c6e = load %struct.Memory*, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_402c6e, %struct.Memory** %MEMORY
  %loadMem1_402c72 = load %struct.Memory*, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem1_402c72, %struct.Memory** %MEMORY
  %loadMem2_402c72 = load %struct.Memory*, %struct.Memory** %MEMORY
  %loadPC_402c72 = load i64, i64* %3
  %call2_402c72 = call %struct.Memory* @sub_402dd0._Z28test_goto_loop_unroll_factorILi22EdEvPKT0_iPKc(%struct.State* %0, i64 %loadPC_402c72, %struct.Memory* %loadMem2_402c72)
  store %struct.Memory* %call2_402c72, %struct.Memory** %MEMORY
  ...
  ret %struct.Memory* %loadMem_402c7c
}
