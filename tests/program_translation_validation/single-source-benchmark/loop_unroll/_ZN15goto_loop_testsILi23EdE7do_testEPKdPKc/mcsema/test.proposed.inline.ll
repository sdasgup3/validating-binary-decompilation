...
entry:
  ...
  store %struct.Memory* %loadMem1_402af8, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_402b1b, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem1_402b22, %struct.Memory** %MEMORY
  ...
  ret %struct.Memory* %loadMem_402b2c
}
