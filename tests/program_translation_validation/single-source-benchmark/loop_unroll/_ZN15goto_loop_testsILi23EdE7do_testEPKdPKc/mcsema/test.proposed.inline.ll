...
define %struct.Memory* @_ZN15goto_loop_testsILi23EdE7do_testEPKdPKc(%struct.State* noalias, i64, %struct.Memory* noalias) #1 {
entry:
  ...
  store %struct.Memory* %loadMem1_402b28, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem1_402b52, %struct.Memory** %MEMORY
  ...
  ret %struct.Memory* %loadMem_402b5c
}
