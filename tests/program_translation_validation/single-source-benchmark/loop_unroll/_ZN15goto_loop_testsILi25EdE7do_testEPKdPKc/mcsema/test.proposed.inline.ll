...
define %struct.Memory* @_ZN15goto_loop_testsILi25EdE7do_testEPKdPKc(%struct.State* noalias, i64, %struct.Memory* noalias) #2 {
entry:
  ...
  store %struct.Memory* %loadMem_4028b3, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_4028be, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem1_4028c2, %struct.Memory** %MEMORY
  ...
  ret %struct.Memory* %loadMem_4028cc
}
