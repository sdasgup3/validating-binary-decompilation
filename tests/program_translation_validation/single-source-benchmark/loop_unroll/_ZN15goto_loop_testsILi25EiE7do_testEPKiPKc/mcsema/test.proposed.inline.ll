...
define %struct.Memory* @_ZN15goto_loop_testsILi25EiE7do_testEPKiPKc(%struct.State* noalias, i64, %struct.Memory* noalias) #1 {
entry:
  ...
  store %struct.Memory* %loadMem1_40d448, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_40d46b, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem1_40d472, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_40d47b, %struct.Memory** %MEMORY
  ...
  ret %struct.Memory* %loadMem_40d47c
}
