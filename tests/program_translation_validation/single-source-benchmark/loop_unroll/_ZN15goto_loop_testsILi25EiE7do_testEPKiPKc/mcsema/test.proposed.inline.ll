...
define %struct.Memory* @_ZN15goto_loop_testsILi25EiE7do_testEPKiPKc(%struct.State* noalias, i64, %struct.Memory* noalias) #2 {
entry:
  ...
  store %struct.Memory* %loadMem1_40d418, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_40d43b, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem1_40d442, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_40d447, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_40d44b, %struct.Memory** %MEMORY
  ...
  ret %struct.Memory* %loadMem_40d44c
}
