...
define %struct.Memory* @_ZN15goto_loop_testsILi26EdE7do_testEPKdPKc(%struct.State* noalias, i64, %struct.Memory* noalias) #1 {
entry:
  ...
  store %struct.Memory* %loadMem1_402738, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_40275e, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem1_402762, %struct.Memory** %MEMORY
  ...
  ret %struct.Memory* %loadMem_40276c
}
