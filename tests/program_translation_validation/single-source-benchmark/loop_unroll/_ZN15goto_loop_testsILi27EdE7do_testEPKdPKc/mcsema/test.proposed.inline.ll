...
define %struct.Memory* @_ZN15goto_loop_testsILi27EdE7do_testEPKdPKc(%struct.State* noalias, i64, %struct.Memory* noalias) #2 {
entry:
  ...
  store %struct.Memory* %loadMem1_4025b8, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem1_4025e2, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_4025ec, %struct.Memory** %MEMORY
  ret %struct.Memory* %loadMem_4025ec
}
