...
define %struct.Memory* @_ZN15goto_loop_testsILi27EdE7do_testEPKdPKc(%struct.State* noalias, i64, %struct.Memory* noalias) #1 {
entry:
  ...
  store %struct.Memory* %loadMem1_4025e8, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem1_402612, %struct.Memory** %MEMORY
  ...
  ret %struct.Memory* %loadMem_40261c
}
