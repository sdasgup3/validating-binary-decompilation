...
entry:
  ...
  store %struct.Memory* %loadMem1_40d1b8, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_40d1bd, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_40d1d3, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem1_40d1e2, %struct.Memory** %MEMORY
  ...
  ret %struct.Memory* %loadMem_40d1ec
}
