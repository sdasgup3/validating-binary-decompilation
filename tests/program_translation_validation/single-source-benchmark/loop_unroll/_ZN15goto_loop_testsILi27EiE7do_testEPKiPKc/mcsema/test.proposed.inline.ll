...
define %struct.Memory* @_ZN15goto_loop_testsILi27EiE7do_testEPKiPKc(%struct.State* noalias, i64, %struct.Memory* noalias) #2 {
entry:
  ...
  store %struct.Memory* %loadMem1_40d1a8, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_40d1c3, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_40d1cb, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_40d1ce, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem1_40d1d2, %struct.Memory** %MEMORY
  ...
  ret %struct.Memory* %loadMem_40d1dc
}
