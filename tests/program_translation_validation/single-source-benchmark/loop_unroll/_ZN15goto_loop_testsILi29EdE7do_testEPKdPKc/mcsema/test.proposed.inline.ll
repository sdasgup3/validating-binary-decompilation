...
define %struct.Memory* @_ZN15goto_loop_testsILi29EdE7do_testEPKdPKc(%struct.State* noalias, i64, %struct.Memory* noalias) #1 {
entry:
  ...
  store %struct.Memory* %loadMem1_402348, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_40236b, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem1_402372, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_402377, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_40237b, %struct.Memory** %MEMORY
  ...
  ret %struct.Memory* %loadMem_40237c
}
