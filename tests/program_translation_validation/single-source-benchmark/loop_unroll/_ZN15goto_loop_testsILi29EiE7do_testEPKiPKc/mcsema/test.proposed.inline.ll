...
define %struct.Memory* @_ZN15goto_loop_testsILi29EiE7do_testEPKiPKc(%struct.State* noalias, i64, %struct.Memory* noalias) #1 {
entry:
  ...
  store %struct.Memory* %loadMem1_40cf08, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_40cf2e, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem1_40cf32, %struct.Memory** %MEMORY
  ...
  ret %struct.Memory* %loadMem_40cf3c
}
