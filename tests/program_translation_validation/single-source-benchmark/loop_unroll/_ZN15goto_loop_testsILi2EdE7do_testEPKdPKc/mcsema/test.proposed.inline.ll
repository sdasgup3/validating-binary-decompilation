...
define %struct.Memory* @_ZN15goto_loop_testsILi2EdE7do_testEPKdPKc(%struct.State* noalias, i64, %struct.Memory* noalias) #2 {
entry:
  ...
  store %struct.Memory* %loadMem1_4046b8, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem1_4046df, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_4046e4, %struct.Memory** %MEMORY
  ...
  ret %struct.Memory* %loadMem_4046e9
}
