...
entry:
  ...
  store %struct.Memory* %loadMem_40f230, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_40f234, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_40f240, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem1_40f248, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem1_40f26f, %struct.Memory** %MEMORY
  ...
  ret %struct.Memory* %loadMem_40f279
}
