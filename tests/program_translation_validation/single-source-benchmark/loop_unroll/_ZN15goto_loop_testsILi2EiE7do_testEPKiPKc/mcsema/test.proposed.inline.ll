...
define %struct.Memory* @_ZN15goto_loop_testsILi2EiE7do_testEPKiPKc(%struct.State* noalias, i64, %struct.Memory* noalias) #1 {
entry:
  ...
  store %struct.Memory* %loadMem_40f274, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem1_40f278, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem1_40f29f, %struct.Memory** %MEMORY
  ...
  ret %struct.Memory* %loadMem_40f2a9
}
