...
define %struct.Memory* @_ZN15goto_loop_testsILi31EdE7do_testEPKdPKc(%struct.State* noalias, i64, %struct.Memory* noalias) #2 {
entry:
  ...
  store %struct.Memory* %loadMem1_4012e8, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem1_401312, %struct.Memory** %MEMORY
  ...
  ret %struct.Memory* %loadMem_40131c
}
