...
define %struct.Memory* @_ZN15goto_loop_testsILi31EdE7do_testEPKdPKc(%struct.State* noalias, i64, %struct.Memory* noalias) #1 {
entry:
  ...
  store %struct.Memory* %loadMem1_401342, %struct.Memory** %MEMORY
  ...
  ret %struct.Memory* %loadMem_40134c
}
