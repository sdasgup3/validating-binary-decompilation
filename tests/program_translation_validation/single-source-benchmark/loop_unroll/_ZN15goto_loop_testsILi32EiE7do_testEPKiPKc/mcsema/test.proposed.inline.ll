...
define %struct.Memory* @_ZN15goto_loop_testsILi32EiE7do_testEPKiPKc(%struct.State* noalias, i64, %struct.Memory* noalias) #2 {
entry:
  ...
  store %struct.Memory* %loadMem1_401118, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem1_401142, %struct.Memory** %MEMORY
  ...
  ret %struct.Memory* %loadMem_40114c
}
