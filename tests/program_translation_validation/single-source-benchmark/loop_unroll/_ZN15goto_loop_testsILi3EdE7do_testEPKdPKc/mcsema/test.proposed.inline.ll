...
define %struct.Memory* @_ZN15goto_loop_testsILi3EdE7do_testEPKdPKc(%struct.State* noalias, i64, %struct.Memory* noalias) #1 {
entry:
  ...
  store %struct.Memory* %loadMem1_404568, %struct.Memory** %MEMORY
  ...
  ret %struct.Memory* %loadMem_40459c
}
