...
entry:
  ...
  store %struct.Memory* %loadMem1_40f128, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_40f12d, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_40f147, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem1_40f152, %struct.Memory** %MEMORY
  ...
  ret %struct.Memory* %loadMem_40f15c
}
