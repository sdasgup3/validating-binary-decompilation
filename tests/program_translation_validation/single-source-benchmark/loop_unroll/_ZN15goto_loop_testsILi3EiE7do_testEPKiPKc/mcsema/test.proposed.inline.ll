...
entry:
  ...
  store %struct.Memory* %loadMem1_40f0f8, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_40f10c, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem1_40f122, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_40f12b, %struct.Memory** %MEMORY
  ...
  ret %struct.Memory* %loadMem_40f12c
}
