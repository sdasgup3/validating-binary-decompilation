...
define %struct.Memory* @_ZN15goto_loop_testsILi4EdE7do_testEPKdPKc(%struct.State* noalias, i64, %struct.Memory* noalias) #1 {
entry:
  ...
  store %struct.Memory* %loadMem1_404418, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_404437, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_40443b, %struct.Memory** %MEMORY
  ...
  ret %struct.Memory* %loadMem_40444c
}
