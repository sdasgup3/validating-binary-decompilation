...
declare %struct.Memory* @sub_404400._ZN15goto_loop_testsILi4EdE7do_testEPKdPKc(%struct.State* dereferenceable(3376), i64, %struct.Memory*)

declare %struct.Memory* @sub_404450._Z28test_goto_loop_unroll_factorILi5EdEvPKT0_iPKc(%struct.State* dereferenceable(3376), i64, %struct.Memory*)

; Function Attrs: alwaysinline
define %struct.Memory* @_ZN15goto_loop_testsILi5EdE7do_testEPKdPKc(%struct.State* noalias, i64, %struct.Memory* noalias) #1 {
entry:
