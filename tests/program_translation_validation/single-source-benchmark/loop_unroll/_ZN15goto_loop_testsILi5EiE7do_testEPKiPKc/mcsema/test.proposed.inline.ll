...
entry:
  ...
  store %struct.Memory* %loadMem_40ee92, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_40eea7, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem1_40eeb2, %struct.Memory** %MEMORY
  ...
  ret %struct.Memory* %loadMem_40eebc
}
