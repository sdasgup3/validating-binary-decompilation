...
declare %struct.Memory* @sub_404130._ZN15goto_loop_testsILi6EdE7do_testEPKdPKc(%struct.State* noalias dereferenceable(3376), i64, %struct.Memory* noalias readnone returned)

declare %struct.Memory* @sub_404180._Z28test_goto_loop_unroll_factorILi7EdEvPKT0_iPKc(%struct.State* noalias dereferenceable(3376), i64, %struct.Memory* noalias readnone returned)
...
entry:
  ...
  %loadMem1_403ff8 = load %struct.Memory*, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem1_403ff8, %struct.Memory** %MEMORY
  %loadMem2_403ff8 = load %struct.Memory*, %struct.Memory** %MEMORY
  %loadPC_403ff8 = load i64, i64* %3
  %call2_403ff8 = call %struct.Memory* @sub_404130._ZN15goto_loop_testsILi6EdE7do_testEPKdPKc(%struct.State* %0, i64 %loadPC_403ff8, %struct.Memory* %loadMem2_403ff8)
  store %struct.Memory* %call2_403ff8, %struct.Memory** %MEMORY
  ...
  %loadMem_404017 = load %struct.Memory*, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_404017, %struct.Memory** %MEMORY
  %loadMem_40401b = load %struct.Memory*, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_40401b, %struct.Memory** %MEMORY
  ...
  %loadMem1_404022 = load %struct.Memory*, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem1_404022, %struct.Memory** %MEMORY
  %loadMem2_404022 = load %struct.Memory*, %struct.Memory** %MEMORY
  %loadPC_404022 = load i64, i64* %3
  %call2_404022 = call %struct.Memory* @sub_404180._Z28test_goto_loop_unroll_factorILi7EdEvPKT0_iPKc(%struct.State* %0, i64 %loadPC_404022, %struct.Memory* %loadMem2_404022)
  store %struct.Memory* %call2_404022, %struct.Memory** %MEMORY
  ...
  ret %struct.Memory* %loadMem_40402c
}
