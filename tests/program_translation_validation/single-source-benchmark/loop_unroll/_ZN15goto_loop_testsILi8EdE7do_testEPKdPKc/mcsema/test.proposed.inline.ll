...
define %struct.Memory* @_ZN15goto_loop_testsILi8EdE7do_testEPKdPKc(%struct.State* noalias, i64, %struct.Memory* noalias) #1 {
entry:
  ...
  store %struct.Memory* %loadMem_403ec1, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem1_403ed8, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_403edd, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem1_403f02, %struct.Memory** %MEMORY
  ...
  ret %struct.Memory* %loadMem_403f0c
}
