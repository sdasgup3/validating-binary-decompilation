...
define %struct.Memory* @_ZN15goto_loop_testsILi9EdE7do_testEPKdPKc(%struct.State* noalias, i64, %struct.Memory* noalias) #2 {
entry:
  ...
  store %struct.Memory* %loadMem1_403d98, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_403d9d, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem1_403dc2, %struct.Memory** %MEMORY
  ...
  ret %struct.Memory* %loadMem_403dcc
}
