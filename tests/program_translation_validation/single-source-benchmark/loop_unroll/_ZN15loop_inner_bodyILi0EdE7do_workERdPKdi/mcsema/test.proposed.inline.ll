...
define %struct.Memory* @_ZN15loop_inner_bodyILi0EdE7do_workERdPKdi(%struct.State* noalias, i64, %struct.Memory* noalias) #2 {
entry:
  ...
  store %struct.Memory* %loadMem_4021d0, %struct.Memory** %MEMORY
  ...
  %PC.i6 = bitcast %union.anon* %46 to i64*
  ...
  %56 = load i64, i64* %PC.i6
  %57 = add i64 %56, 4
  store i64 %57, i64* %PC.i6
  ...
  %RBP.i5 = bitcast %union.anon* %67 to i64*
  %68 = load i64, i64* %RBP.i5
  %69 = sub i64 %68, 20
  ...
  store i32 %70, i32* %74
  store %struct.Memory* %loadMem_4021dc, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_4021df, %struct.Memory** %MEMORY
  ...
  ret %struct.Memory* %loadMem_4021e0
}
