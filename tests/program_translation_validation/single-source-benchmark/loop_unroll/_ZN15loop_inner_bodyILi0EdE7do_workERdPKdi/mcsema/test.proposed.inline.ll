...
define %struct.Memory* @_ZN15loop_inner_bodyILi0EdE7do_workERdPKdi(%struct.State* noalias, i64, %struct.Memory* noalias) #1 {
entry:
  ...
  store %struct.Memory* %loadMem_4021c1, %struct.Memory** %MEMORY
  ...
  ret %struct.Memory* %loadMem_4021d0
}
