...
define %struct.Memory* @_ZN15loop_inner_bodyILi0EdE7do_workERdPKdi(%struct.State* noalias nocapture, i64, %struct.Memory* noalias readnone returned) local_unnamed_addr #0 {
entry:
