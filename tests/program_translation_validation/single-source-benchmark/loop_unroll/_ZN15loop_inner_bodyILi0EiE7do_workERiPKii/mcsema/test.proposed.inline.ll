...
define %struct.Memory* @_ZN15loop_inner_bodyILi0EiE7do_workERiPKii(%struct.State* noalias, i64, %struct.Memory* noalias) #1 {
entry:
  ...
  store i32 %70, i32* %74
  store %struct.Memory* %loadMem_40cd8c, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_40cd8f, %struct.Memory** %MEMORY
  ...
  ret %struct.Memory* %loadMem_40cd90
}
