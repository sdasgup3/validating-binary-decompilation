...
define %struct.Memory* @_ZN15loop_inner_bodyILi0EiE7do_workERiPKii(%struct.State* noalias nocapture, i64, %struct.Memory* noalias readnone returned) local_unnamed_addr #0 {
entry:
