...
entry:
  ...
  %loadMem_401dd1 = load %struct.Memory*, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_401dd1, %struct.Memory** %MEMORY
  ...
  store i64 %93, i64* %96
  store %struct.Memory* %loadMem_401ddc, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem1_401dee, %struct.Memory** %MEMORY
  %loadMem2_401dee = load %struct.Memory*, %struct.Memory** %MEMORY
  %loadPC_401dee = load i64, i64* %3
  %call2_401dee = call %struct.Memory* @sub_401e30._ZN15loop_inner_bodyILi9EdE7do_workERdPKdi(%struct.State* %0, i64 %loadPC_401dee, %struct.Memory* %loadMem2_401dee)
  ...
  store %struct.Memory* %loadMem_401dfa, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_401e0a, %struct.Memory** %MEMORY
  %loadMem1_401e0f = load %struct.Memory*, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem1_401e0f, %struct.Memory** %MEMORY
  %loadMem2_401e0f = load %struct.Memory*, %struct.Memory** %MEMORY
  %loadPC_401e0f = load i64, i64* %3
  %call2_401e0f = call %struct.Memory* @sub_401480._Z18complete_hash_funcIdET_S0_(%struct.State* %0, i64 %loadPC_401e0f, %struct.Memory* %loadMem2_401e0f)
  store %struct.Memory* %call2_401e0f, %struct.Memory** %MEMORY
  ...
  ret %struct.Memory* %loadMem_401e2f
}
