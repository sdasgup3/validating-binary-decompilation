...
entry:
  ...
  %call2_401dbe = tail call %struct.Memory* @sub_401e00._ZN15loop_inner_bodyILi10EdE7do_workERdPKdi(%struct.State* %0, i64 %71, %struct.Memory* %2)
  ...
  %call2_401ddf = tail call %struct.Memory* @sub_4014b0._Z18complete_hash_funcIdET_S0_(%struct.State* %0, i64 %128, %struct.Memory* %call2_401dbe)
  ...
  ret %struct.Memory* %call2_401ddf
}
