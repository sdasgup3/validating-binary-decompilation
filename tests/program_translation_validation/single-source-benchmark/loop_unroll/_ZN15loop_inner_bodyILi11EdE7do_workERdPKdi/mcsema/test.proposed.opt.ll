...
define %struct.Memory* @_ZN15loop_inner_bodyILi11EdE7do_workERdPKdi(%struct.State* noalias, i64, %struct.Memory* noalias readnone returned) local_unnamed_addr #1 {
entry:
  ...
  %call2_401dce = tail call %struct.Memory* @sub_401e10._ZN15loop_inner_bodyILi10EdE7do_workERdPKdi(%struct.State* %0, i64 %71, %struct.Memory* %2)
  ...
  store i64 %127, i64* %116, align 1
  store double 0.000000e+00, double* %118, align 1
  %128 = add i64 %124, -2346
  %129 = add i64 %124, 10
  ...
  %call2_401def = tail call %struct.Memory* @sub_4014c0._Z18complete_hash_funcIdET_S0_(%struct.State* %0, i64 %128, %struct.Memory* %call2_401dce)
  %133 = load i64, i64* %RBP.i, align 8
  %134 = add i64 %133, -32
  %135 = load i64, i64* %3, align 8
  %136 = add i64 %135, 5
  store i64 %136, i64* %3, align 8
  %137 = load i64, i64* %116, align 1
  ...
  %150 = bitcast i64 %144 to double
  %151 = inttoptr i64 %148 to double*
  %152 = load double, double* %151, align 8
  %153 = fadd double %150, %152
  store double %153, double* %115, align 1
  store i64 0, i64* %117, align 1
  %154 = add i64 %141, 17
  store i64 %154, i64* %3, align 8
  %155 = inttoptr i64 %148 to double*
  ...
  ret %struct.Memory* %call2_401def
}
