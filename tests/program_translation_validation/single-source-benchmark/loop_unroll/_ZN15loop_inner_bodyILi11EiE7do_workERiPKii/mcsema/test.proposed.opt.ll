...
define %struct.Memory* @_ZN15loop_inner_bodyILi11EiE7do_workERiPKii(%struct.State* noalias, i64, %struct.Memory* noalias readnone returned) local_unnamed_addr #1 {
entry:
  ...
  %call2_40c98e = tail call %struct.Memory* @sub_40c9d0._ZN15loop_inner_bodyILi10EiE7do_workERiPKii(%struct.State* %0, i64 %71, %struct.Memory* %2)
  ...
  %call2_40c9a9 = tail call %struct.Memory* @sub_40c110._Z18complete_hash_funcIiET_S0_(%struct.State* %0, i64 %125, %struct.Memory* %call2_40c98e)
  ...
  ret %struct.Memory* %call2_40c9a9
}
