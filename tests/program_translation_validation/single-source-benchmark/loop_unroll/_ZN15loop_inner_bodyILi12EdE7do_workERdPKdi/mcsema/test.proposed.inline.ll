...
entry:
  ...
  store %struct.Memory* %loadMem1_401d6e, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem1_401d8f, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_401da6, %struct.Memory** %MEMORY
  ...
  ret %struct.Memory* %loadMem_401daf
}
