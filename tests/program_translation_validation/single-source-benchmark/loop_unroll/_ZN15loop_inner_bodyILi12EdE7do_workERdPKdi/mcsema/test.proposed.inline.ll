...
define %struct.Memory* @_ZN15loop_inner_bodyILi12EdE7do_workERdPKdi(%struct.State* noalias, i64, %struct.Memory* noalias) #2 {
entry:
  ...
  store %struct.Memory* %loadMem_401d2b, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem1_401d2e, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_401d33, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem1_401d4f, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_401d6e, %struct.Memory** %MEMORY
  ...
  ret %struct.Memory* %loadMem_401d6f
}
