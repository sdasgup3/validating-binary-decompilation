...
define %struct.Memory* @_ZN15loop_inner_bodyILi12EdE7do_workERdPKdi(%struct.State* noalias, i64, %struct.Memory* noalias) #1 {
entry:
  ...
  store %struct.Memory* %loadMem_401d53, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem1_401d5e, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_401d75, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem1_401d7f, %struct.Memory** %MEMORY
  ...
  ret %struct.Memory* %loadMem_401d9f
}
