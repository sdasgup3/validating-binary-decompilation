...
define %struct.Memory* @_ZN15loop_inner_bodyILi13EdE7do_workERdPKdi(%struct.State* noalias, i64, %struct.Memory* noalias) #1 {
entry:
  ...
  store %struct.Memory* %loadMem1_401d1f, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_401d3f, %struct.Memory** %MEMORY
  ret %struct.Memory* %loadMem_401d3f
}
