...
define %struct.Memory* @_ZN15loop_inner_bodyILi13EdE7do_workERdPKdi(%struct.State* noalias, i64, %struct.Memory* noalias) #2 {
entry:
  ...
  store %struct.Memory* %loadMem1_401cce, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_401cd3, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem1_401cef, %struct.Memory** %MEMORY
  ...
  ret %struct.Memory* %loadMem_401d0f
}
