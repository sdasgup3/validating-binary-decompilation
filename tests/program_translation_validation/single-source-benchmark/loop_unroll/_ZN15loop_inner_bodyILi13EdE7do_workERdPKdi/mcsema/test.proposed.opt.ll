...
define %struct.Memory* @_ZN15loop_inner_bodyILi13EdE7do_workERdPKdi(%struct.State* noalias, i64, %struct.Memory* noalias readnone returned) local_unnamed_addr #1 {
entry:
  ...
  %call2_401cfe = tail call %struct.Memory* @sub_401d40._ZN15loop_inner_bodyILi12EdE7do_workERdPKdi(%struct.State* %0, i64 %71, %struct.Memory* %2)
  ...
  %call2_401d1f = tail call %struct.Memory* @sub_4014b0._Z18complete_hash_funcIdET_S0_(%struct.State* %0, i64 %128, %struct.Memory* %call2_401cfe)
  ...
  ret %struct.Memory* %call2_401d1f
}
