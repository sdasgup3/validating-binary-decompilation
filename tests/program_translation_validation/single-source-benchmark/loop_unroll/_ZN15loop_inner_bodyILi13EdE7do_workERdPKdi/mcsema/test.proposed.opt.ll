...
entry:
  ...
  %call2_401d0e = tail call %struct.Memory* @sub_401d50._ZN15loop_inner_bodyILi12EdE7do_workERdPKdi(%struct.State* %0, i64 %71, %struct.Memory* %2)
  ...
  %call2_401d2f = tail call %struct.Memory* @sub_4014c0._Z18complete_hash_funcIdET_S0_(%struct.State* %0, i64 %128, %struct.Memory* %call2_401d0e)
  ...
  ret %struct.Memory* %call2_401d2f
}
