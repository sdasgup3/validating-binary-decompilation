...
define %struct.Memory* @_ZN15loop_inner_bodyILi13EiE7do_workERiPKii(%struct.State* noalias, i64, %struct.Memory* noalias) #1 {
entry:
  ...
  store %struct.Memory* %loadMem1_40c8be, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_40c8ca, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_40c8cd, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_40c8d6, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem1_40c8d9, %struct.Memory** %MEMORY
  ...
  ret %struct.Memory* %loadMem_40c8f1
}
