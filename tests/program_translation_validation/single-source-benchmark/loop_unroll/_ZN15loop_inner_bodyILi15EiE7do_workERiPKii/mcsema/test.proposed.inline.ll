...
define %struct.Memory* @_ZN15loop_inner_bodyILi15EiE7do_workERiPKii(%struct.State* noalias, i64, %struct.Memory* noalias) #1 {
entry:
  ...
  store %struct.Memory* %loadMem_40c7e4, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem1_40c7fe, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_40c816, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem1_40c819, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_40c824, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_40c828, %struct.Memory** %MEMORY
  ...
  ret %struct.Memory* %loadMem_40c831
}
