...
entry:
  ...
  %loadMem1_401bae = load %struct.Memory*, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem1_401bae, %struct.Memory** %MEMORY
  %loadMem2_401bae = load %struct.Memory*, %struct.Memory** %MEMORY
  %loadPC_401bae = load i64, i64* %3
  %call2_401bae = call %struct.Memory* @sub_401bf0._ZN15loop_inner_bodyILi15EdE7do_workERdPKdi(%struct.State* %0, i64 %loadPC_401bae, %struct.Memory* %loadMem2_401bae)
  store %struct.Memory* %call2_401bae, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem1_401bcf, %struct.Memory** %MEMORY
  %loadMem2_401bcf = load %struct.Memory*, %struct.Memory** %MEMORY
  %loadPC_401bcf = load i64, i64* %3
  %call2_401bcf = call %struct.Memory* @sub_401480._Z18complete_hash_funcIdET_S0_(%struct.State* %0, i64 %loadPC_401bcf, %struct.Memory* %loadMem2_401bcf)
  ...
  ret %struct.Memory* %loadMem_401bef
}
