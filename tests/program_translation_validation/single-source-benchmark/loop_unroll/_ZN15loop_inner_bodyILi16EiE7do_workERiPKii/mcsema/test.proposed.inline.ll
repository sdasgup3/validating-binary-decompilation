...
define %struct.Memory* @_ZN15loop_inner_bodyILi16EiE7do_workERiPKii(%struct.State* noalias, i64, %struct.Memory* noalias) #1 {
entry:
  ...
  store %struct.Memory* %loadMem1_40c7b9, %struct.Memory** %MEMORY
  ...
  ret %struct.Memory* %loadMem_40c7d1
}
