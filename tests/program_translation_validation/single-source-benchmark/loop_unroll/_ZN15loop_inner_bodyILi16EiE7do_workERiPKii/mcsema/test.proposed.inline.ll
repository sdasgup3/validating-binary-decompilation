...
define %struct.Memory* @_ZN15loop_inner_bodyILi16EiE7do_workERiPKii(%struct.State* noalias, i64, %struct.Memory* noalias) #2 {
entry:
  ...
  store %struct.Memory* %loadMem_40c751, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_40c754, %struct.Memory** %MEMORY
  ...
  store i64 %78, i64* %81
  store %struct.Memory* %loadMem_40c758, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_40c777, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem1_40c789, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_40c798, %struct.Memory** %MEMORY
  ...
  ret %struct.Memory* %loadMem_40c7a1
}
