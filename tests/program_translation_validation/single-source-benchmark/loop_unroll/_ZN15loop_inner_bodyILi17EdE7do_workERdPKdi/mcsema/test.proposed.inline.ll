...
define %struct.Memory* @_ZN15loop_inner_bodyILi17EdE7do_workERdPKdi(%struct.State* noalias, i64, %struct.Memory* noalias) #2 {
entry:
  ...
  store %struct.Memory* %loadMem1_401b8e, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem1_401baf, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_401bc2, %struct.Memory** %MEMORY
  ...
  ret %struct.Memory* %loadMem_401bcf
}
