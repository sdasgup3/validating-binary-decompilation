...
define %struct.Memory* @_ZN15loop_inner_bodyILi17EdE7do_workERdPKdi(%struct.State* noalias, i64, %struct.Memory* noalias readnone returned) local_unnamed_addr #1 {
entry:
  ...
  %call2_401b7e = tail call %struct.Memory* @sub_401bc0._ZN15loop_inner_bodyILi16EdE7do_workERdPKdi(%struct.State* %0, i64 %71, %struct.Memory* %2)
  ...
  %call2_401b9f = tail call %struct.Memory* @sub_4014b0._Z18complete_hash_funcIdET_S0_(%struct.State* %0, i64 %129, %struct.Memory* %call2_401b7e)
  ...
  ret %struct.Memory* %call2_401b9f
}
