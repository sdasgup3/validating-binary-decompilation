...
define %struct.Memory* @_ZN15loop_inner_bodyILi17EiE7do_workERiPKii(%struct.State* noalias, i64, %struct.Memory* noalias) #1 {
entry:
  ...
  store %struct.Memory* %loadMem1_40c73e, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_40c74a, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_40c74d, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem1_40c759, %struct.Memory** %MEMORY
  ...
  ret %struct.Memory* %loadMem_40c771
}
