...
define %struct.Memory* @_ZN15loop_inner_bodyILi18EdE7do_workERdPKdi(%struct.State* noalias, i64, %struct.Memory* noalias) #2 {
entry:
  ...
  store %struct.Memory* %loadMem1_401b1e, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem1_401b3f, %struct.Memory** %MEMORY
  ...
  ret %struct.Memory* %loadMem_401b5f
}
