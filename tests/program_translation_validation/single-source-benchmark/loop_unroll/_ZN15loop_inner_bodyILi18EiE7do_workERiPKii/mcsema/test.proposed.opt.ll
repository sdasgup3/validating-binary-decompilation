...
declare %struct.Memory* @sub_40c6f0._ZN15loop_inner_bodyILi17EiE7do_workERiPKii(%struct.State* noalias dereferenceable(3376), i64, %struct.Memory* noalias readnone returned) local_unnamed_addr
...
define %struct.Memory* @_ZN15loop_inner_bodyILi18EiE7do_workERiPKii(%struct.State* noalias, i64, %struct.Memory* noalias) local_unnamed_addr #1 {
entry:
  ...
  %call2_40c6ae = tail call %struct.Memory* @sub_40c6f0._ZN15loop_inner_bodyILi17EiE7do_workERiPKii(%struct.State* %0, i64 %71, %struct.Memory* %2)
  ...
  %call2_40c6c9 = tail call %struct.Memory* @sub_40c0d0._Z18complete_hash_funcIiET_S0_(%struct.State* %0, i64 %126, %struct.Memory* %call2_40c6ae)
  ...
  ret %struct.Memory* %call2_40c6c9
}
...
define %struct.Memory* @routine_callq_._ZN15loop_inner_bodyILi17EiE7do_workERiPKii(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
