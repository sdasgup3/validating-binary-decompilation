...
define %struct.Memory* @_ZN15loop_inner_bodyILi19EdE7do_workERdPKdi(%struct.State* noalias, i64, %struct.Memory* noalias) #2 {
entry:
  ...
  %loadMem1_401a8e = load %struct.Memory*, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem1_401a8e, %struct.Memory** %MEMORY
  %loadMem2_401a8e = load %struct.Memory*, %struct.Memory** %MEMORY
  %loadPC_401a8e = load i64, i64* %3
  %call2_401a8e = call %struct.Memory* @sub_401ad0._ZN15loop_inner_bodyILi18EdE7do_workERdPKdi(%struct.State* %0, i64 %loadPC_401a8e, %struct.Memory* %loadMem2_401a8e)
  store %struct.Memory* %call2_401a8e, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem1_401aaf, %struct.Memory** %MEMORY
  %loadMem2_401aaf = load %struct.Memory*, %struct.Memory** %MEMORY
  %loadPC_401aaf = load i64, i64* %3
  %call2_401aaf = call %struct.Memory* @sub_401480._Z18complete_hash_funcIdET_S0_(%struct.State* %0, i64 %loadPC_401aaf, %struct.Memory* %loadMem2_401aaf)
  store %struct.Memory* %call2_401aaf, %struct.Memory** %MEMORY
  ...
  ret %struct.Memory* %loadMem_401acf
}
