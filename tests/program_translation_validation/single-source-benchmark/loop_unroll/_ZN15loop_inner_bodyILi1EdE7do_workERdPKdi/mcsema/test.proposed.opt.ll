...
entry:
  ...
  %138 = bitcast i64 %132 to double
  %139 = inttoptr i64 %136 to double*
  %140 = load double, double* %139, align 8
  %141 = fadd double %138, %140
  store double %141, double* %103, align 1
  store i64 0, i64* %105, align 1
  %142 = add i64 %129, 17
  store i64 %142, i64* %3, align 8
  %143 = inttoptr i64 %136 to double*
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_callq_._ZN15loop_inner_bodyILi0EdE7do_workERdPKdi(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
