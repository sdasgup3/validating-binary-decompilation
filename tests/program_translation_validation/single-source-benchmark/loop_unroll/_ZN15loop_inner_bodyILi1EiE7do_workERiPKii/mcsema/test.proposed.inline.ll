...
entry:
  ...
  store %struct.Memory* %loadMem1_40cd0e, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_40cd13, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem1_40cd29, %struct.Memory** %MEMORY
  ...
  ret %struct.Memory* %loadMem_40cd41
}
