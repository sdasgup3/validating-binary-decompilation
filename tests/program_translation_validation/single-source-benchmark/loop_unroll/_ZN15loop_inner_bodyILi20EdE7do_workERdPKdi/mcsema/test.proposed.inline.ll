...
define %struct.Memory* @_ZN15loop_inner_bodyILi20EdE7do_workERdPKdi(%struct.State* noalias, i64, %struct.Memory* noalias) #1 {
entry:
  ...
  store %struct.Memory* %loadMem1_401a5e, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem1_401a7f, %struct.Memory** %MEMORY
  ...
  ret %struct.Memory* %loadMem_401a9f
}
