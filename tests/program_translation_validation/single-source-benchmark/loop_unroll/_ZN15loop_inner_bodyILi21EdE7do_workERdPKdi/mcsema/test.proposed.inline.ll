...
define %struct.Memory* @_ZN15loop_inner_bodyILi21EdE7do_workERdPKdi(%struct.State* noalias, i64, %struct.Memory* noalias) #1 {
entry:
  ...
  store %struct.Memory* %loadMem1_4019fe, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_401a07, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem1_401a1f, %struct.Memory** %MEMORY
  ...
  ret %struct.Memory* %loadMem_401a3f
}
