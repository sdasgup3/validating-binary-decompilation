...
define %struct.Memory* @_ZN15loop_inner_bodyILi21EdE7do_workERdPKdi(%struct.State* noalias, i64, %struct.Memory* noalias readnone returned) local_unnamed_addr #1 {
entry:
  ...
  %call2_401a0e = tail call %struct.Memory* @sub_401a50._ZN15loop_inner_bodyILi20EdE7do_workERdPKdi(%struct.State* %0, i64 %71, %struct.Memory* %2)
  ...
  %call2_401a2f = tail call %struct.Memory* @sub_4014c0._Z18complete_hash_funcIdET_S0_(%struct.State* %0, i64 %129, %struct.Memory* %call2_401a0e)
  ...
  ret %struct.Memory* %call2_401a2f
}
