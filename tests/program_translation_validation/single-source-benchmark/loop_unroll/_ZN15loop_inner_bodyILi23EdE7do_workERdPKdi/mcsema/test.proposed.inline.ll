...
define %struct.Memory* @_ZN15loop_inner_bodyILi23EdE7do_workERdPKdi(%struct.State* noalias, i64, %struct.Memory* noalias) #2 {
entry:
  ...
  store %struct.Memory* %loadMem_401903, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem1_40190e, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem1_40192f, %struct.Memory** %MEMORY
  ...
  ret %struct.Memory* %loadMem_40194f
}
