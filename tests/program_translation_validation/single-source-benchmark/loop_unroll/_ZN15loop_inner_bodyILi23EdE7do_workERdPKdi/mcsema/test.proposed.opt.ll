...
entry:
  ...
  %call2_40192f = tail call %struct.Memory* @sub_401480._Z18complete_hash_funcIdET_S0_(%struct.State* %0, i64 %129, %struct.Memory* %call2_40190e)
  ...
  store double %145, double* %116, align 1
  store double 0.000000e+00, double* %119, align 1
  %146 = add i64 %140, -8
  %147 = add i64 %142, 9
  ...
  store double %153, double* %116, align 1
