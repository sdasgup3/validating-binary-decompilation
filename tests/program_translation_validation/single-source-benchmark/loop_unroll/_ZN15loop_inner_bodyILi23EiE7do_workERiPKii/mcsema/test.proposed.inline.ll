...
declare %struct.Memory* @sub_40c510._ZN15loop_inner_bodyILi22EiE7do_workERiPKii(%struct.State* noalias dereferenceable(3376), i64, %struct.Memory* noalias readnone returned)
...
entry:
  ...
  store %struct.Memory* %loadMem_40c4b0, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_40c4b1, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_40c4c0, %struct.Memory** %MEMORY
  ...
  %call2_40c4ce = call %struct.Memory* @sub_40c510._ZN15loop_inner_bodyILi22EiE7do_workERiPKii(%struct.State* %0, i64 %loadPC_40c4ce, %struct.Memory* %loadMem2_40c4ce)
  ...
  store %struct.Memory* %loadMem_40c4dd, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_40c4e6, %struct.Memory** %MEMORY
  %loadMem1_40c4e9 = load %struct.Memory*, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem1_40c4e9, %struct.Memory** %MEMORY
  %loadMem2_40c4e9 = load %struct.Memory*, %struct.Memory** %MEMORY
  %loadPC_40c4e9 = load i64, i64* %3
  %call2_40c4e9 = call %struct.Memory* @sub_40c0d0._Z18complete_hash_funcIiET_S0_(%struct.State* %0, i64 %loadPC_40c4e9, %struct.Memory* %loadMem2_40c4e9)
  store %struct.Memory* %call2_40c4e9, %struct.Memory** %MEMORY
  ...
  ret %struct.Memory* %loadMem_40c501
}
