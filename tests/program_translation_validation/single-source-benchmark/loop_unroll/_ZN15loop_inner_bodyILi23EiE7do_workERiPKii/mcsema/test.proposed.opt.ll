...
define %struct.Memory* @_ZN15loop_inner_bodyILi23EiE7do_workERiPKii(%struct.State* noalias, i64, %struct.Memory* noalias readnone returned) local_unnamed_addr #1 {
entry:
