...
define %struct.Memory* @_ZN15loop_inner_bodyILi24EdE7do_workERdPKdi(%struct.State* noalias, i64, %struct.Memory* noalias) local_unnamed_addr #1 {
entry:
  ...
  %call2_4018ae = tail call %struct.Memory* @sub_4018f0._ZN15loop_inner_bodyILi23EdE7do_workERdPKdi(%struct.State* %0, i64 %71, %struct.Memory* %2)
  ...
  %call2_4018cf = tail call %struct.Memory* @sub_401480._Z18complete_hash_funcIdET_S0_(%struct.State* %0, i64 %130, %struct.Memory* %call2_4018ae)
  ...
  ret %struct.Memory* %call2_4018cf
}
