...
define %struct.Memory* @_ZN15loop_inner_bodyILi24EiE7do_workERiPKii(%struct.State* noalias, i64, %struct.Memory* noalias readnone returned) local_unnamed_addr #1 {
entry:
  ...
  %call2_40c49e = tail call %struct.Memory* @sub_40c4e0._ZN15loop_inner_bodyILi23EiE7do_workERiPKii(%struct.State* %0, i64 %71, %struct.Memory* %2)
  ...
  %call2_40c4b9 = tail call %struct.Memory* @sub_40c100._Z18complete_hash_funcIiET_S0_(%struct.State* %0, i64 %126, %struct.Memory* %call2_40c49e)
  ...
  ret %struct.Memory* %call2_40c4b9
}
