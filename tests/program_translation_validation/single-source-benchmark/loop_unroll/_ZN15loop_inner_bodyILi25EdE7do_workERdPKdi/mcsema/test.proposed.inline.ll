...
define %struct.Memory* @_ZN15loop_inner_bodyILi25EdE7do_workERdPKdi(%struct.State* noalias, i64, %struct.Memory* noalias) #1 {
entry:
  ...
  store i64 %93, i64* %96
  store %struct.Memory* %loadMem_40186c, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem1_40187e, %struct.Memory** %MEMORY
  ...
  ret %struct.Memory* %loadMem_4018bf
}
