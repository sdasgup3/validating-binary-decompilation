...
define %struct.Memory* @_ZN15loop_inner_bodyILi25EdE7do_workERdPKdi(%struct.State* noalias, i64, %struct.Memory* noalias) #2 {
entry:
  ...
  store %struct.Memory* %loadMem_401857, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_401886, %struct.Memory** %MEMORY
