...
define %struct.Memory* @_ZN15loop_inner_bodyILi26EdE7do_workERdPKdi(%struct.State* noalias, i64, %struct.Memory* noalias) #2 {
entry:
  ...
  store i64 %93, i64* %96
  store %struct.Memory* %loadMem_4017dc, %struct.Memory** %MEMORY
  ...
  %loadMem1_4017ee = load %struct.Memory*, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem1_4017ee, %struct.Memory** %MEMORY
  %loadMem2_4017ee = load %struct.Memory*, %struct.Memory** %MEMORY
  %loadPC_4017ee = load i64, i64* %3
  %call2_4017ee = call %struct.Memory* @sub_401830._ZN15loop_inner_bodyILi25EdE7do_workERdPKdi(%struct.State* %0, i64 %loadPC_4017ee, %struct.Memory* %loadMem2_4017ee)
  store %struct.Memory* %call2_4017ee, %struct.Memory** %MEMORY
  ...
  %loadMem1_40180f = load %struct.Memory*, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem1_40180f, %struct.Memory** %MEMORY
  %loadMem2_40180f = load %struct.Memory*, %struct.Memory** %MEMORY
  %loadPC_40180f = load i64, i64* %3
  %call2_40180f = call %struct.Memory* @sub_401480._Z18complete_hash_funcIdET_S0_(%struct.State* %0, i64 %loadPC_40180f, %struct.Memory* %loadMem2_40180f)
  store %struct.Memory* %call2_40180f, %struct.Memory** %MEMORY
  ...
  ret %struct.Memory* %loadMem_40182f
}
