...
define %struct.Memory* @_ZN15loop_inner_bodyILi28EdE7do_workERdPKdi(%struct.State* noalias, i64, %struct.Memory* noalias) #1 {
entry:
  ...
  store %struct.Memory* %loadMem1_40175e, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem1_40177f, %struct.Memory** %MEMORY
  ...
  ret %struct.Memory* %loadMem_40179f
}
