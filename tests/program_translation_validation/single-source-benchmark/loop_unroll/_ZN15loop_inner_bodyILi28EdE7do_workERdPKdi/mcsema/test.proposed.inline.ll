...
define %struct.Memory* @_ZN15loop_inner_bodyILi28EdE7do_workERdPKdi(%struct.State* noalias, i64, %struct.Memory* noalias) #2 {
entry:
  ...
  store %struct.Memory* %loadMem1_40176e, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_40178a, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem1_40178f, %struct.Memory** %MEMORY
  ...
  ret %struct.Memory* %loadMem_4017af
}
