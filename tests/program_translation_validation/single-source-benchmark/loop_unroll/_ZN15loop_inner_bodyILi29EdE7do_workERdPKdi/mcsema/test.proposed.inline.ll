...
define %struct.Memory* @_ZN15loop_inner_bodyILi29EdE7do_workERdPKdi(%struct.State* noalias, i64, %struct.Memory* noalias) #2 {
entry:
  ...
  store %struct.Memory* %loadMem1_4016ce, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem1_4016ef, %struct.Memory** %MEMORY
  ...
  ret %struct.Memory* %loadMem_40170f
}
