...
define %struct.Memory* @_ZN15loop_inner_bodyILi29EdE7do_workERdPKdi(%struct.State* noalias, i64, %struct.Memory* noalias) #1 {
entry:
  ...
  store %struct.Memory* %loadMem1_40171f, %struct.Memory** %MEMORY
