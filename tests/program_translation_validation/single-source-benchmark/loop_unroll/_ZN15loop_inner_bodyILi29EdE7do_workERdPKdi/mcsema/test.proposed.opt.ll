...
define %struct.Memory* @_ZN15loop_inner_bodyILi29EdE7do_workERdPKdi(%struct.State* noalias, i64, %struct.Memory* noalias) local_unnamed_addr #1 {
entry:
  ...
  %call2_4016ce = tail call %struct.Memory* @sub_401710._ZN15loop_inner_bodyILi28EdE7do_workERdPKdi(%struct.State* %0, i64 %71, %struct.Memory* %2)
  ...
  %call2_4016ef = tail call %struct.Memory* @sub_401480._Z18complete_hash_funcIdET_S0_(%struct.State* %0, i64 %130, %struct.Memory* %call2_4016ce)
  ...
  ret %struct.Memory* %call2_4016ef
}
