...
define %struct.Memory* @_ZN15loop_inner_bodyILi29EiE7do_workERiPKii(%struct.State* noalias, i64, %struct.Memory* noalias) #2 {
entry:
  ...
  store %struct.Memory* %loadMem_40c28b, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem1_40c28e, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_40c293, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_40c2a6, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem1_40c2a9, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_40c2bc, %struct.Memory** %MEMORY
  ...
  ret %struct.Memory* %loadMem_40c2c1
}
