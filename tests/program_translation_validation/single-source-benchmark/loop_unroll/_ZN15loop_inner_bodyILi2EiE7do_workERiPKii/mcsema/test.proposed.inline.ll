...
define %struct.Memory* @_ZN15loop_inner_bodyILi2EiE7do_workERiPKii(%struct.State* noalias, i64, %struct.Memory* noalias) #1 {
entry:
  ...
  store %struct.Memory* %loadMem1_40ccde, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem1_40ccf9, %struct.Memory** %MEMORY
  ...
  ret %struct.Memory* %loadMem_40cd11
}
