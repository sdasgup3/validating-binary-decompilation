...
entry:
  ...
  %call2_40ccae = tail call %struct.Memory* @sub_40ccf0._ZN15loop_inner_bodyILi1EiE7do_workERiPKii(%struct.State* %0, i64 %71, %struct.Memory* %2)
  ...
  %call2_40ccc9 = tail call %struct.Memory* @sub_40c0d0._Z18complete_hash_funcIiET_S0_(%struct.State* %0, i64 %126, %struct.Memory* %call2_40ccae)
  ...
  ret %struct.Memory* %call2_40ccc9
}
