...
define %struct.Memory* @_ZN15loop_inner_bodyILi30EdE7do_workERdPKdi(%struct.State* noalias, i64, %struct.Memory* noalias) #1 {
entry:
  ...
  store %struct.Memory* %loadMem1_40169e, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem1_4016bf, %struct.Memory** %MEMORY
  ...
  ret %struct.Memory* %loadMem_4016df
}
