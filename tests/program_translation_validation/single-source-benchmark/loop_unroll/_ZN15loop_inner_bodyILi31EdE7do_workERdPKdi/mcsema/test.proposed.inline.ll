...
define %struct.Memory* @_ZN15loop_inner_bodyILi31EdE7do_workERdPKdi(%struct.State* noalias, i64, %struct.Memory* noalias) #2 {
entry:
  ...
  store %struct.Memory* %loadMem_40160b, %struct.Memory** %MEMORY
  ...
  %call2_40160e = call %struct.Memory* @sub_401650._ZN15loop_inner_bodyILi30EdE7do_workERdPKdi(%struct.State* %0, i64 %loadPC_40160e, %struct.Memory* %loadMem2_40160e)
  ...
  store %struct.Memory* %loadMem_401620, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_40162a, %struct.Memory** %MEMORY
  %loadMem1_40162f = load %struct.Memory*, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem1_40162f, %struct.Memory** %MEMORY
  %loadMem2_40162f = load %struct.Memory*, %struct.Memory** %MEMORY
  %loadPC_40162f = load i64, i64* %3
  %call2_40162f = call %struct.Memory* @sub_401480._Z18complete_hash_funcIdET_S0_(%struct.State* %0, i64 %loadPC_40162f, %struct.Memory* %loadMem2_40162f)
  store %struct.Memory* %call2_40162f, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_40163e, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_401642, %struct.Memory** %MEMORY
  ...
  ret %struct.Memory* %loadMem_40164f
}
