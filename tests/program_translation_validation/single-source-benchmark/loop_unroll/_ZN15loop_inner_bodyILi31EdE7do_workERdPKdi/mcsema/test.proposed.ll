...
entry:
  ...
  ; Code: ._ZN15loop_inner_bodyILi31EdE7do_workERdPKdi:	 RIP: 4015f0	 Bytes: 0
  ...
  ; Code: subq $0x20, %rsp	 RIP: 4015f4	 Bytes: 4
  %loadMem_4015f4 = load %struct.Memory*, %struct.Memory** %MEMORY
  %call_4015f4 = call %struct.Memory* @routine_subq__0x20___rsp(%struct.State* %0, i64  0, %struct.Memory* %loadMem_4015f4)
  store %struct.Memory* %call_4015f4, %struct.Memory** %MEMORY

  ; Code: movq %rdi, -0x8(%rbp)	 RIP: 4015f8	 Bytes: 4
  %loadMem_4015f8 = load %struct.Memory*, %struct.Memory** %MEMORY
  %call_4015f8 = call %struct.Memory* @routine_movq__rdi__MINUS0x8__rbp_(%struct.State* %0, i64  0, %struct.Memory* %loadMem_4015f8)
  store %struct.Memory* %call_4015f8, %struct.Memory** %MEMORY

  ; Code: movq %rsi, -0x10(%rbp)	 RIP: 4015fc	 Bytes: 4
  %loadMem_4015fc = load %struct.Memory*, %struct.Memory** %MEMORY
  %call_4015fc = call %struct.Memory* @routine_movq__rsi__MINUS0x10__rbp_(%struct.State* %0, i64  0, %struct.Memory* %loadMem_4015fc)
  store %struct.Memory* %call_4015fc, %struct.Memory** %MEMORY

  ; Code: movl %edx, -0x14(%rbp)	 RIP: 401600	 Bytes: 3
  %loadMem_401600 = load %struct.Memory*, %struct.Memory** %MEMORY
  %call_401600 = call %struct.Memory* @routine_movl__edx__MINUS0x14__rbp_(%struct.State* %0, i64  0, %struct.Memory* %loadMem_401600)
  store %struct.Memory* %call_401600, %struct.Memory** %MEMORY

  ; Code: movq -0x8(%rbp), %rdi	 RIP: 401603	 Bytes: 4
  %loadMem_401603 = load %struct.Memory*, %struct.Memory** %MEMORY
  %call_401603 = call %struct.Memory* @routine_movq_MINUS0x8__rbp____rdi(%struct.State* %0, i64  0, %struct.Memory* %loadMem_401603)
  store %struct.Memory* %call_401603, %struct.Memory** %MEMORY

  ; Code: movq -0x10(%rbp), %rsi	 RIP: 401607	 Bytes: 4
  %loadMem_401607 = load %struct.Memory*, %struct.Memory** %MEMORY
  %call_401607 = call %struct.Memory* @routine_movq_MINUS0x10__rbp____rsi(%struct.State* %0, i64  0, %struct.Memory* %loadMem_401607)
  store %struct.Memory* %call_401607, %struct.Memory** %MEMORY

  ; Code: movl -0x14(%rbp), %edx	 RIP: 40160b	 Bytes: 3
  %loadMem_40160b = load %struct.Memory*, %struct.Memory** %MEMORY
  %call_40160b = call %struct.Memory* @routine_movl_MINUS0x14__rbp____edx(%struct.State* %0, i64  0, %struct.Memory* %loadMem_40160b)
  store %struct.Memory* %call_40160b, %struct.Memory** %MEMORY

  ; Code: callq ._ZN15loop_inner_bodyILi30EdE7do_workERdPKdi	 RIP: 40160e	 Bytes: 5
  %loadMem1_40160e = load %struct.Memory*, %struct.Memory** %MEMORY
  %call1_40160e = call %struct.Memory* @routine_callq_._ZN15loop_inner_bodyILi30EdE7do_workERdPKdi(%struct.State* %0, i64  0, %struct.Memory* %loadMem1_40160e, i64 66, i64 5, i64 5)
  ...
  ; Code: movq -0x10(%rbp), %rsi	 RIP: 401613	 Bytes: 4
  %loadMem_401613 = load %struct.Memory*, %struct.Memory** %MEMORY
  %call_401613 = call %struct.Memory* @routine_movq_MINUS0x10__rbp____rsi(%struct.State* %0, i64  0, %struct.Memory* %loadMem_401613)
  store %struct.Memory* %call_401613, %struct.Memory** %MEMORY

  ; Code: movl -0x14(%rbp), %edx	 RIP: 401617	 Bytes: 3
  %loadMem_401617 = load %struct.Memory*, %struct.Memory** %MEMORY
  %call_401617 = call %struct.Memory* @routine_movl_MINUS0x14__rbp____edx(%struct.State* %0, i64  0, %struct.Memory* %loadMem_401617)
  store %struct.Memory* %call_401617, %struct.Memory** %MEMORY

  ; Code: addl $0x1e, %edx	 RIP: 40161a	 Bytes: 3
  %loadMem_40161a = load %struct.Memory*, %struct.Memory** %MEMORY
  %call_40161a = call %struct.Memory* @routine_addl__0x1e___edx(%struct.State* %0, i64  0, %struct.Memory* %loadMem_40161a)
  store %struct.Memory* %call_40161a, %struct.Memory** %MEMORY

  ; Code: movslq %edx, %rdi	 RIP: 40161d	 Bytes: 3
  %loadMem_40161d = load %struct.Memory*, %struct.Memory** %MEMORY
  %call_40161d = call %struct.Memory* @routine_movslq__edx___rdi(%struct.State* %0, i64  0, %struct.Memory* %loadMem_40161d)
  store %struct.Memory* %call_40161d, %struct.Memory** %MEMORY

  ; Code: movsd (%rsi,%rdi,8), %xmm0	 RIP: 401620	 Bytes: 5
  %loadMem_401620 = load %struct.Memory*, %struct.Memory** %MEMORY
  %call_401620 = call %struct.Memory* @routine_movsd___rsi__rdi_8____xmm0(%struct.State* %0, i64  0, %struct.Memory* %loadMem_401620)
  store %struct.Memory* %call_401620, %struct.Memory** %MEMORY

  ; Code: movsd %xmm0, -0x20(%rbp)	 RIP: 401625	 Bytes: 5
  %loadMem_401625 = load %struct.Memory*, %struct.Memory** %MEMORY
  %call_401625 = call %struct.Memory* @routine_movsd__xmm0__MINUS0x20__rbp_(%struct.State* %0, i64  0, %struct.Memory* %loadMem_401625)
  store %struct.Memory* %call_401625, %struct.Memory** %MEMORY

  ; Code: movsd -0x20(%rbp), %xmm0	 RIP: 40162a	 Bytes: 5
  %loadMem_40162a = load %struct.Memory*, %struct.Memory** %MEMORY
  %call_40162a = call %struct.Memory* @routine_movsd_MINUS0x20__rbp____xmm0(%struct.State* %0, i64  0, %struct.Memory* %loadMem_40162a)
  store %struct.Memory* %call_40162a, %struct.Memory** %MEMORY

  ; Code: callq ._Z18complete_hash_funcIdET_S0_	 RIP: 40162f	 Bytes: 5
  %loadMem1_40162f = load %struct.Memory*, %struct.Memory** %MEMORY
  %call1_40162f = call %struct.Memory* @routine_callq_._Z18complete_hash_funcIdET_S0_(%struct.State* %0, i64  0, %struct.Memory* %loadMem1_40162f, i64 -431, i64 5, i64 5)
  store %struct.Memory* %call1_40162f, %struct.Memory** %MEMORY
  ...
  ; Code: movsd %xmm0, -0x20(%rbp)	 RIP: 401634	 Bytes: 5
  %loadMem_401634 = load %struct.Memory*, %struct.Memory** %MEMORY
  %call_401634 = call %struct.Memory* @routine_movsd__xmm0__MINUS0x20__rbp_(%struct.State* %0, i64  0, %struct.Memory* %loadMem_401634)
  store %struct.Memory* %call_401634, %struct.Memory** %MEMORY

  ; Code: movsd -0x20(%rbp), %xmm0	 RIP: 401639	 Bytes: 5
  %loadMem_401639 = load %struct.Memory*, %struct.Memory** %MEMORY
  %call_401639 = call %struct.Memory* @routine_movsd_MINUS0x20__rbp____xmm0(%struct.State* %0, i64  0, %struct.Memory* %loadMem_401639)
  store %struct.Memory* %call_401639, %struct.Memory** %MEMORY

  ; Code: movq -0x8(%rbp), %rsi	 RIP: 40163e	 Bytes: 4
  %loadMem_40163e = load %struct.Memory*, %struct.Memory** %MEMORY
  %call_40163e = call %struct.Memory* @routine_movq_MINUS0x8__rbp____rsi(%struct.State* %0, i64  0, %struct.Memory* %loadMem_40163e)
  store %struct.Memory* %call_40163e, %struct.Memory** %MEMORY

  ; Code: addsd (%rsi), %xmm0	 RIP: 401642	 Bytes: 4
  %loadMem_401642 = load %struct.Memory*, %struct.Memory** %MEMORY
  %call_401642 = call %struct.Memory* @routine_addsd___rsi____xmm0(%struct.State* %0, i64  0, %struct.Memory* %loadMem_401642)
  store %struct.Memory* %call_401642, %struct.Memory** %MEMORY

  ; Code: movsd %xmm0, (%rsi)	 RIP: 401646	 Bytes: 4
  %loadMem_401646 = load %struct.Memory*, %struct.Memory** %MEMORY
  %call_401646 = call %struct.Memory* @routine_movsd__xmm0____rsi_(%struct.State* %0, i64  0, %struct.Memory* %loadMem_401646)
  store %struct.Memory* %call_401646, %struct.Memory** %MEMORY

  ; Code: addq $0x20, %rsp	 RIP: 40164a	 Bytes: 4
  %loadMem_40164a = load %struct.Memory*, %struct.Memory** %MEMORY
  %call_40164a = call %struct.Memory* @routine_addq__0x20___rsp(%struct.State* %0, i64  0, %struct.Memory* %loadMem_40164a)
  store %struct.Memory* %call_40164a, %struct.Memory** %MEMORY

  ; Code: popq %rbp	 RIP: 40164e	 Bytes: 1
  %loadMem_40164e = load %struct.Memory*, %struct.Memory** %MEMORY
  %call_40164e = call %struct.Memory* @routine_popq__rbp(%struct.State* %0, i64  0, %struct.Memory* %loadMem_40164e)
  store %struct.Memory* %call_40164e, %struct.Memory** %MEMORY

  ; Code: retq	 RIP: 40164f	 Bytes: 1
  %loadMem_40164f = load %struct.Memory*, %struct.Memory** %MEMORY
  %call_40164f = call %struct.Memory* @routine_retq(%struct.State* %0, i64  0, %struct.Memory* %loadMem_40164f)
  store %struct.Memory* %call_40164f, %struct.Memory** %MEMORY

  ret %struct.Memory* %call_40164f
}
