...
define %struct.Memory* @_ZN15loop_inner_bodyILi31EiE7do_workERiPKii(%struct.State* noalias, i64, %struct.Memory* noalias) #2 {
entry:
  ...
  store i64 %93, i64* %96
  store %struct.Memory* %loadMem_40c1fc, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem1_40c20e, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem1_40c229, %struct.Memory** %MEMORY
  ...
  ret %struct.Memory* %loadMem_40c241
}
