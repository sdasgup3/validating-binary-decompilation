...
define %struct.Memory* @_ZN15loop_inner_bodyILi3EdE7do_workERdPKdi(%struct.State* noalias, i64, %struct.Memory* noalias) #1 {
entry:
  ...
  store %struct.Memory* %loadMem_4020d5, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem1_4020df, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_4020f6, %struct.Memory** %MEMORY
  ...
  ret %struct.Memory* %loadMem_4020ff
}
