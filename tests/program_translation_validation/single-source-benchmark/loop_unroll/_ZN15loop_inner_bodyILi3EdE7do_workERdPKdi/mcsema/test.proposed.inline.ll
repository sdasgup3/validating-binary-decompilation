...
define %struct.Memory* @_ZN15loop_inner_bodyILi3EdE7do_workERdPKdi(%struct.State* noalias, i64, %struct.Memory* noalias) #2 {
entry:
  ...
  store %struct.Memory* %loadMem_4020c7, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem1_4020ce, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem1_4020ef, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_4020fe, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_402102, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_40210e, %struct.Memory** %MEMORY
  ...
  ret %struct.Memory* %loadMem_40210f
}
