...
entry:
  ...
  store %struct.Memory* %loadMem1_40208e, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_402093, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_402097, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_40209d, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem1_4020af, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_4020ce, %struct.Memory** %MEMORY
  ...
  ret %struct.Memory* %loadMem_4020cf
}
