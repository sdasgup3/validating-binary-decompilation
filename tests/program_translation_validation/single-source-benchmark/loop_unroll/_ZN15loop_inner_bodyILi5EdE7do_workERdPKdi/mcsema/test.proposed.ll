...
entry:
  ...
  ; Code: ._ZN15loop_inner_bodyILi5EdE7do_workERdPKdi:	 RIP: 401fb0	 Bytes: 0
  ...
  ; Code: movq %rdi, -0x8(%rbp)	 RIP: 401fb8	 Bytes: 4
  %loadMem_401fb8 = load %struct.Memory*, %struct.Memory** %MEMORY
  %call_401fb8 = call %struct.Memory* @routine_movq__rdi__MINUS0x8__rbp_(%struct.State* %0, i64  0, %struct.Memory* %loadMem_401fb8)
  ...
  ; Code: movq -0x8(%rbp), %rdi	 RIP: 401fc3	 Bytes: 4
  %loadMem_401fc3 = load %struct.Memory*, %struct.Memory** %MEMORY
  %call_401fc3 = call %struct.Memory* @routine_movq_MINUS0x8__rbp____rdi(%struct.State* %0, i64  0, %struct.Memory* %loadMem_401fc3)
  store %struct.Memory* %call_401fc3, %struct.Memory** %MEMORY

  ; Code: movq -0x10(%rbp), %rsi	 RIP: 401fc7	 Bytes: 4
  %loadMem_401fc7 = load %struct.Memory*, %struct.Memory** %MEMORY
  %call_401fc7 = call %struct.Memory* @routine_movq_MINUS0x10__rbp____rsi(%struct.State* %0, i64  0, %struct.Memory* %loadMem_401fc7)
  store %struct.Memory* %call_401fc7, %struct.Memory** %MEMORY

  ; Code: movl -0x14(%rbp), %edx	 RIP: 401fcb	 Bytes: 3
  %loadMem_401fcb = load %struct.Memory*, %struct.Memory** %MEMORY
  %call_401fcb = call %struct.Memory* @routine_movl_MINUS0x14__rbp____edx(%struct.State* %0, i64  0, %struct.Memory* %loadMem_401fcb)
  store %struct.Memory* %call_401fcb, %struct.Memory** %MEMORY

  ; Code: callq ._ZN15loop_inner_bodyILi4EdE7do_workERdPKdi	 RIP: 401fce	 Bytes: 5
  %loadMem1_401fce = load %struct.Memory*, %struct.Memory** %MEMORY
  %call1_401fce = call %struct.Memory* @routine_callq_._ZN15loop_inner_bodyILi4EdE7do_workERdPKdi(%struct.State* %0, i64  0, %struct.Memory* %loadMem1_401fce, i64 66, i64 5, i64 5)
  store %struct.Memory* %call1_401fce, %struct.Memory** %MEMORY

  %loadMem2_401fce = load %struct.Memory*, %struct.Memory** %MEMORY
  %loadPC_401fce = load i64, i64* %3
  %call2_401fce = call %struct.Memory* @sub_402010._ZN15loop_inner_bodyILi4EdE7do_workERdPKdi(%struct.State* %0, i64  %loadPC_401fce, %struct.Memory* %loadMem2_401fce)
  store %struct.Memory* %call2_401fce, %struct.Memory** %MEMORY

  ; Code: movq -0x10(%rbp), %rsi	 RIP: 401fd3	 Bytes: 4
  %loadMem_401fd3 = load %struct.Memory*, %struct.Memory** %MEMORY
  %call_401fd3 = call %struct.Memory* @routine_movq_MINUS0x10__rbp____rsi(%struct.State* %0, i64  0, %struct.Memory* %loadMem_401fd3)
  store %struct.Memory* %call_401fd3, %struct.Memory** %MEMORY

  ; Code: movl -0x14(%rbp), %edx	 RIP: 401fd7	 Bytes: 3
  %loadMem_401fd7 = load %struct.Memory*, %struct.Memory** %MEMORY
  %call_401fd7 = call %struct.Memory* @routine_movl_MINUS0x14__rbp____edx(%struct.State* %0, i64  0, %struct.Memory* %loadMem_401fd7)
  store %struct.Memory* %call_401fd7, %struct.Memory** %MEMORY

  ; Code: addl $0x4, %edx	 RIP: 401fda	 Bytes: 3
  %loadMem_401fda = load %struct.Memory*, %struct.Memory** %MEMORY
  %call_401fda = call %struct.Memory* @routine_addl__0x4___edx(%struct.State* %0, i64  0, %struct.Memory* %loadMem_401fda)
  store %struct.Memory* %call_401fda, %struct.Memory** %MEMORY

  ; Code: movslq %edx, %rdi	 RIP: 401fdd	 Bytes: 3
  %loadMem_401fdd = load %struct.Memory*, %struct.Memory** %MEMORY
  %call_401fdd = call %struct.Memory* @routine_movslq__edx___rdi(%struct.State* %0, i64  0, %struct.Memory* %loadMem_401fdd)
  store %struct.Memory* %call_401fdd, %struct.Memory** %MEMORY

  ; Code: movsd (%rsi,%rdi,8), %xmm0	 RIP: 401fe0	 Bytes: 5
  %loadMem_401fe0 = load %struct.Memory*, %struct.Memory** %MEMORY
  %call_401fe0 = call %struct.Memory* @routine_movsd___rsi__rdi_8____xmm0(%struct.State* %0, i64  0, %struct.Memory* %loadMem_401fe0)
  store %struct.Memory* %call_401fe0, %struct.Memory** %MEMORY

  ; Code: movsd %xmm0, -0x20(%rbp)	 RIP: 401fe5	 Bytes: 5
  %loadMem_401fe5 = load %struct.Memory*, %struct.Memory** %MEMORY
  %call_401fe5 = call %struct.Memory* @routine_movsd__xmm0__MINUS0x20__rbp_(%struct.State* %0, i64  0, %struct.Memory* %loadMem_401fe5)
  store %struct.Memory* %call_401fe5, %struct.Memory** %MEMORY

  ; Code: movsd -0x20(%rbp), %xmm0	 RIP: 401fea	 Bytes: 5
  %loadMem_401fea = load %struct.Memory*, %struct.Memory** %MEMORY
  %call_401fea = call %struct.Memory* @routine_movsd_MINUS0x20__rbp____xmm0(%struct.State* %0, i64  0, %struct.Memory* %loadMem_401fea)
  store %struct.Memory* %call_401fea, %struct.Memory** %MEMORY

  ; Code: callq ._Z18complete_hash_funcIdET_S0_	 RIP: 401fef	 Bytes: 5
  %loadMem1_401fef = load %struct.Memory*, %struct.Memory** %MEMORY
  %call1_401fef = call %struct.Memory* @routine_callq_._Z18complete_hash_funcIdET_S0_(%struct.State* %0, i64  0, %struct.Memory* %loadMem1_401fef, i64 -2927, i64 5, i64 5)
  store %struct.Memory* %call1_401fef, %struct.Memory** %MEMORY

  %loadMem2_401fef = load %struct.Memory*, %struct.Memory** %MEMORY
  %loadPC_401fef = load i64, i64* %3
  %call2_401fef = call %struct.Memory* @sub_401480._Z18complete_hash_funcIdET_S0_(%struct.State* %0, i64  %loadPC_401fef, %struct.Memory* %loadMem2_401fef)
  store %struct.Memory* %call2_401fef, %struct.Memory** %MEMORY

  ; Code: movsd %xmm0, -0x20(%rbp)	 RIP: 401ff4	 Bytes: 5
  %loadMem_401ff4 = load %struct.Memory*, %struct.Memory** %MEMORY
  %call_401ff4 = call %struct.Memory* @routine_movsd__xmm0__MINUS0x20__rbp_(%struct.State* %0, i64  0, %struct.Memory* %loadMem_401ff4)
  store %struct.Memory* %call_401ff4, %struct.Memory** %MEMORY

  ; Code: movsd -0x20(%rbp), %xmm0	 RIP: 401ff9	 Bytes: 5
  %loadMem_401ff9 = load %struct.Memory*, %struct.Memory** %MEMORY
  %call_401ff9 = call %struct.Memory* @routine_movsd_MINUS0x20__rbp____xmm0(%struct.State* %0, i64  0, %struct.Memory* %loadMem_401ff9)
  store %struct.Memory* %call_401ff9, %struct.Memory** %MEMORY

  ; Code: movq -0x8(%rbp), %rsi	 RIP: 401ffe	 Bytes: 4
  %loadMem_401ffe = load %struct.Memory*, %struct.Memory** %MEMORY
  %call_401ffe = call %struct.Memory* @routine_movq_MINUS0x8__rbp____rsi(%struct.State* %0, i64  0, %struct.Memory* %loadMem_401ffe)
  store %struct.Memory* %call_401ffe, %struct.Memory** %MEMORY

  ; Code: addsd (%rsi), %xmm0	 RIP: 402002	 Bytes: 4
  %loadMem_402002 = load %struct.Memory*, %struct.Memory** %MEMORY
  %call_402002 = call %struct.Memory* @routine_addsd___rsi____xmm0(%struct.State* %0, i64  0, %struct.Memory* %loadMem_402002)
  store %struct.Memory* %call_402002, %struct.Memory** %MEMORY

  ; Code: movsd %xmm0, (%rsi)	 RIP: 402006	 Bytes: 4
  %loadMem_402006 = load %struct.Memory*, %struct.Memory** %MEMORY
  %call_402006 = call %struct.Memory* @routine_movsd__xmm0____rsi_(%struct.State* %0, i64  0, %struct.Memory* %loadMem_402006)
  store %struct.Memory* %call_402006, %struct.Memory** %MEMORY

  ; Code: addq $0x20, %rsp	 RIP: 40200a	 Bytes: 4
  %loadMem_40200a = load %struct.Memory*, %struct.Memory** %MEMORY
  %call_40200a = call %struct.Memory* @routine_addq__0x20___rsp(%struct.State* %0, i64  0, %struct.Memory* %loadMem_40200a)
  store %struct.Memory* %call_40200a, %struct.Memory** %MEMORY

  ; Code: popq %rbp	 RIP: 40200e	 Bytes: 1
  %loadMem_40200e = load %struct.Memory*, %struct.Memory** %MEMORY
  %call_40200e = call %struct.Memory* @routine_popq__rbp(%struct.State* %0, i64  0, %struct.Memory* %loadMem_40200e)
  store %struct.Memory* %call_40200e, %struct.Memory** %MEMORY

  ; Code: retq	 RIP: 40200f	 Bytes: 1
  %loadMem_40200f = load %struct.Memory*, %struct.Memory** %MEMORY
  %call_40200f = call %struct.Memory* @routine_retq(%struct.State* %0, i64  0, %struct.Memory* %loadMem_40200f)
  store %struct.Memory* %call_40200f, %struct.Memory** %MEMORY

  ret %struct.Memory* %call_40200f
}
