...
declare %struct.Memory* @sub_40cbd0._ZN15loop_inner_bodyILi4EiE7do_workERiPKii(%struct.State* noalias dereferenceable(3376), i64, %struct.Memory* noalias readnone returned)
...
entry:
  ...
  store i64 %93, i64* %96
  store %struct.Memory* %loadMem_40cb7c, %struct.Memory** %MEMORY
  ...
  %loadMem1_40cb8e = load %struct.Memory*, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem1_40cb8e, %struct.Memory** %MEMORY
  %loadMem2_40cb8e = load %struct.Memory*, %struct.Memory** %MEMORY
  %loadPC_40cb8e = load i64, i64* %3
  %call2_40cb8e = call %struct.Memory* @sub_40cbd0._ZN15loop_inner_bodyILi4EiE7do_workERiPKii(%struct.State* %0, i64 %loadPC_40cb8e, %struct.Memory* %loadMem2_40cb8e)
  store %struct.Memory* %call2_40cb8e, %struct.Memory** %MEMORY
  ...
  %loadMem_40cba6 = load %struct.Memory*, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_40cba6, %struct.Memory** %MEMORY
  %loadMem1_40cba9 = load %struct.Memory*, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem1_40cba9, %struct.Memory** %MEMORY
  %loadMem2_40cba9 = load %struct.Memory*, %struct.Memory** %MEMORY
  %loadPC_40cba9 = load i64, i64* %3
  %call2_40cba9 = call %struct.Memory* @sub_40c0d0._Z18complete_hash_funcIiET_S0_(%struct.State* %0, i64 %loadPC_40cba9, %struct.Memory* %loadMem2_40cba9)
  store %struct.Memory* %call2_40cba9, %struct.Memory** %MEMORY
  %loadMem_40cbae = load %struct.Memory*, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_40cbae, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_40cbb4, %struct.Memory** %MEMORY
  %loadMem_40cbb8 = load %struct.Memory*, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_40cbb8, %struct.Memory** %MEMORY
  ...
  ret %struct.Memory* %loadMem_40cbc1
}
