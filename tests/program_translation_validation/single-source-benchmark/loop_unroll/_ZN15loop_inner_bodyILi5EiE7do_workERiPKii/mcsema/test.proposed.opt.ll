...
define %struct.Memory* @_ZN15loop_inner_bodyILi5EiE7do_workERiPKii(%struct.State* noalias, i64, %struct.Memory* noalias) local_unnamed_addr #1 {
entry:
  ...
  %call2_40cb8e = tail call %struct.Memory* @sub_40cbd0._ZN15loop_inner_bodyILi4EiE7do_workERiPKii(%struct.State* %0, i64 %71, %struct.Memory* %2)
  ...
  store i64 %108, i64* %RDI.i53, align 8
  ...
  store i64 %114, i64* %RDX.i38, align 8
  %115 = add i64 %76, -24
  %116 = add i64 %78, 19
  ...
  store i64 %124, i64* %RDI.i53, align 8
  %125 = add i64 %120, -2774
  %126 = add i64 %120, 8
  ...
  %call2_40cba9 = tail call %struct.Memory* @sub_40c0d0._Z18complete_hash_funcIiET_S0_(%struct.State* %0, i64 %125, %struct.Memory* %call2_40cb8e)
  %130 = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 1, i32 0
  %EAX.i15 = bitcast %union.anon* %130 to i32*
  %131 = load i64, i64* %RBP.i, align 8
  %132 = add i64 %131, -24
  %133 = load i32, i32* %EAX.i15, align 4
  %134 = load i64, i64* %PC.i, align 8
  %135 = add i64 %134, 3
  store i64 %135, i64* %PC.i, align 8
  %136 = inttoptr i64 %132 to i32*
  store i32 %133, i32* %136, align 4
  %RAX.i12 = getelementptr inbounds %union.anon, %union.anon* %130, i64 0, i32 0
  ...
  store i64 %147, i64* %RSI.i50, align 8
  %148 = add i64 %139, 9
  ...
  store i64 %152, i64* %RAX.i12, align 8
  %153 = add i64 %139, 11
  store i64 %153, i64* %PC.i, align 8
  store i32 %151, i32* %149, align 4
  %154 = load i64, i64* %RSP.i58, align 8
  %155 = load i64, i64* %PC.i, align 8
  %156 = add i64 %154, 32
  store i64 %156, i64* %RSP.i58, align 8
  %157 = icmp ugt i64 %154, -33
  ...
  ret %struct.Memory* %call2_40cba9
}
