...
define %struct.Memory* @_ZN15loop_inner_bodyILi7EdE7do_workERdPKdi(%struct.State* noalias, i64, %struct.Memory* noalias) #1 {
entry:
  ...
  store %struct.Memory* %loadMem1_401f5f, %struct.Memory** %MEMORY
  ...
  ret %struct.Memory* %loadMem_401f7f
}
