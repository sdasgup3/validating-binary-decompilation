...
define %struct.Memory* @_ZN15loop_inner_bodyILi7EdE7do_workERdPKdi(%struct.State* noalias, i64, %struct.Memory* noalias) #2 {
entry:
  ...
  store %struct.Memory* %loadMem1_401f4e, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_401f57, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_401f5a, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem1_401f6f, %struct.Memory** %MEMORY
  ...
  ret %struct.Memory* %loadMem_401f8f
}
