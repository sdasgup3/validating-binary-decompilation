...
define %struct.Memory* @_ZN15loop_inner_bodyILi7EdE7do_workERdPKdi(%struct.State* noalias, i64, %struct.Memory* noalias) local_unnamed_addr #1 {
entry:
  ...
  %call2_401f0e = tail call %struct.Memory* @sub_401f50._ZN15loop_inner_bodyILi6EdE7do_workERdPKdi(%struct.State* %0, i64 %71, %struct.Memory* %2)
  ...
  %call2_401f2f = tail call %struct.Memory* @sub_401480._Z18complete_hash_funcIdET_S0_(%struct.State* %0, i64 %129, %struct.Memory* %call2_401f0e)
  ...
  ret %struct.Memory* %call2_401f2f
}
