...
define %struct.Memory* @_ZN15loop_inner_bodyILi7EiE7do_workERiPKii(%struct.State* noalias, i64, %struct.Memory* noalias) #2 {
entry:
  ...
  %loadMem_40cab4 = load %struct.Memory*, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_40cab4, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_40cacb, %struct.Memory** %MEMORY
  %loadMem1_40cace = load %struct.Memory*, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem1_40cace, %struct.Memory** %MEMORY
  %loadMem2_40cace = load %struct.Memory*, %struct.Memory** %MEMORY
  %loadPC_40cace = load i64, i64* %3
  %call2_40cace = call %struct.Memory* @sub_40cb10._ZN15loop_inner_bodyILi6EiE7do_workERiPKii(%struct.State* %0, i64 %loadPC_40cace, %struct.Memory* %loadMem2_40cace)
  store %struct.Memory* %call2_40cace, %struct.Memory** %MEMORY
  ...
  %loadMem1_40cae9 = load %struct.Memory*, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem1_40cae9, %struct.Memory** %MEMORY
  %loadMem2_40cae9 = load %struct.Memory*, %struct.Memory** %MEMORY
  %loadPC_40cae9 = load i64, i64* %3
  %call2_40cae9 = call %struct.Memory* @sub_40c0d0._Z18complete_hash_funcIiET_S0_(%struct.State* %0, i64 %loadPC_40cae9, %struct.Memory* %loadMem2_40cae9)
  store %struct.Memory* %call2_40cae9, %struct.Memory** %MEMORY
  ...
  ret %struct.Memory* %loadMem_40cb01
}
