...
entry:
  ...
  %loadMem1_401eae = load %struct.Memory*, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem1_401eae, %struct.Memory** %MEMORY
  %loadMem2_401eae = load %struct.Memory*, %struct.Memory** %MEMORY
  %loadPC_401eae = load i64, i64* %3
  %call2_401eae = call %struct.Memory* @sub_401ef0._ZN15loop_inner_bodyILi7EdE7do_workERdPKdi(%struct.State* %0, i64 %loadPC_401eae, %struct.Memory* %loadMem2_401eae)
  store %struct.Memory* %call2_401eae, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_401ec5, %struct.Memory** %MEMORY
  ...
  %loadMem1_401ecf = load %struct.Memory*, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem1_401ecf, %struct.Memory** %MEMORY
  %loadMem2_401ecf = load %struct.Memory*, %struct.Memory** %MEMORY
  %loadPC_401ecf = load i64, i64* %3
  %call2_401ecf = call %struct.Memory* @sub_401480._Z18complete_hash_funcIdET_S0_(%struct.State* %0, i64 %loadPC_401ecf, %struct.Memory* %loadMem2_401ecf)
  store %struct.Memory* %call2_401ecf, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_401ee6, %struct.Memory** %MEMORY
  ...
  ret %struct.Memory* %loadMem_401eef
}
