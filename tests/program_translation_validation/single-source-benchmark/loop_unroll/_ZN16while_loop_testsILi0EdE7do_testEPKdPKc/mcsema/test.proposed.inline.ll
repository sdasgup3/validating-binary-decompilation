...
entry:
  ...
  %loadMem_409880 = load %struct.Memory*, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_409880, %struct.Memory** %MEMORY
  ...
  %loadMem_409884 = load %struct.Memory*, %struct.Memory** %MEMORY
  ...
  store i64 %40, i64* %43
  store %struct.Memory* %loadMem_409884, %struct.Memory** %MEMORY
  ...
  ret %struct.Memory* %loadMem_40988d
}
