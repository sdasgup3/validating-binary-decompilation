...
define %struct.Memory* @_ZN16while_loop_testsILi0EdE7do_testEPKdPKc(%struct.State* noalias nocapture, i64, %struct.Memory* noalias readnone returned) local_unnamed_addr #0 {
entry:
