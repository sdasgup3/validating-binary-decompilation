...
define %struct.Memory* @_ZN16while_loop_testsILi0EiE7do_testEPKiPKc(%struct.State* noalias, i64, %struct.Memory* noalias) #2 {
entry:
  ...
  store i64 %40, i64* %43
  store %struct.Memory* %loadMem_414054, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_41405d, %struct.Memory** %MEMORY
  ret %struct.Memory* %loadMem_41405d
}
