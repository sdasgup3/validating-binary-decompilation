...
define %struct.Memory* @_ZN16while_loop_testsILi0EiE7do_testEPKiPKc(%struct.State* noalias, i64, %struct.Memory* noalias) #1 {
entry:
  ...
  store %struct.Memory* %loadMem_41408c, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_41408d, %struct.Memory** %MEMORY
  ret %struct.Memory* %loadMem_41408d
}
