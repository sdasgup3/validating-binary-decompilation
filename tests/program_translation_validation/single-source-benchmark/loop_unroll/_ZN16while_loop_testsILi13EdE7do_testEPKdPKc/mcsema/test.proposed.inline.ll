...
entry:
  ...
  store %struct.Memory* %loadMem_408954, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_408983, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_408987, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_40898b, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem1_408992, %struct.Memory** %MEMORY
  ...
  ret %struct.Memory* %loadMem_40899c
}
