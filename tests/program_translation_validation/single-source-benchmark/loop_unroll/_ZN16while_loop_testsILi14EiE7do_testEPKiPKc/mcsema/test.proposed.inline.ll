...
define %struct.Memory* @_ZN16while_loop_testsILi14EiE7do_testEPKiPKc(%struct.State* noalias, i64, %struct.Memory* noalias) #2 {
entry:
  ...
  store %struct.Memory* %loadMem_4130d1, %struct.Memory** %MEMORY
  ...
  store i64 %78, i64* %81
  store %struct.Memory* %loadMem_4130d8, %struct.Memory** %MEMORY
  ...
  store i64 %93, i64* %96
  store %struct.Memory* %loadMem_4130dc, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_4130e0, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem1_4130e8, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_4130ed, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_413103, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_41310b, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem1_413112, %struct.Memory** %MEMORY
  ...
  ret %struct.Memory* %loadMem_41311c
}
