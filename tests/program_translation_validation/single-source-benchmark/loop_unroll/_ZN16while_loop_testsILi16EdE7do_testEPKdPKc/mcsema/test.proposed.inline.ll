...
define %struct.Memory* @_ZN16while_loop_testsILi16EdE7do_testEPKdPKc(%struct.State* noalias, i64, %struct.Memory* noalias) #1 {
entry:
  ...
  store %struct.Memory* %loadMem_4085c1, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_4085c4, %struct.Memory** %MEMORY
  ...
  store i64 %93, i64* %96
  store %struct.Memory* %loadMem_4085cc, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_4085d4, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem1_4085d8, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_4085e2, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_4085f7, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem1_408602, %struct.Memory** %MEMORY
  ...
  ret %struct.Memory* %loadMem_40860c
}
