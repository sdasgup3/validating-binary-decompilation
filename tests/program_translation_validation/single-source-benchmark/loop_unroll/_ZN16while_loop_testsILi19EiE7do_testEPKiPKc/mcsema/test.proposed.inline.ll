...
define %struct.Memory* @_ZN16while_loop_testsILi19EiE7do_testEPKiPKc(%struct.State* noalias, i64, %struct.Memory* noalias) #1 {
entry:
  ...
  store %struct.Memory* %loadMem_412b40, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem1_412b48, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_412b4d, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_412b6e, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem1_412b72, %struct.Memory** %MEMORY
  ...
  ret %struct.Memory* %loadMem_412b7c
}
