...
define %struct.Memory* @_ZN16while_loop_testsILi19EiE7do_testEPKiPKc(%struct.State* noalias, i64, %struct.Memory* noalias) #2 {
entry:
  ...
  store i64 %93, i64* %96
  store %struct.Memory* %loadMem_412b4c, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem1_412b58, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_412b5d, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem1_412b82, %struct.Memory** %MEMORY
  ...
  ret %struct.Memory* %loadMem_412b8c
}
