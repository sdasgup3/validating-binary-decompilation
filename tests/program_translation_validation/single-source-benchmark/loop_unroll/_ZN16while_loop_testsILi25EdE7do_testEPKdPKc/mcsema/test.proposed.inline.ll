...
define %struct.Memory* @_ZN16while_loop_testsILi25EdE7do_testEPKdPKc(%struct.State* noalias, i64, %struct.Memory* noalias) #1 {
entry:
  ...
  store %struct.Memory* %loadMem_407b11, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem1_407b28, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_407b2d, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_407b4b, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem1_407b52, %struct.Memory** %MEMORY
  ...
  ret %struct.Memory* %loadMem_407b5c
}
