...
declare %struct.Memory* @sub_412350._ZN16while_loop_testsILi26EiE7do_testEPKiPKc(%struct.State* dereferenceable(3376), i64, %struct.Memory*)

declare %struct.Memory* @sub_4123a0._Z29test_while_loop_unroll_factorILi27EiEvPKT0_iPKc(%struct.State* dereferenceable(3376), i64, %struct.Memory*)

; Function Attrs: alwaysinline
define %struct.Memory* @_ZN16while_loop_testsILi27EiE7do_testEPKiPKc(%struct.State* noalias, i64, %struct.Memory* noalias) #1 {
entry:
