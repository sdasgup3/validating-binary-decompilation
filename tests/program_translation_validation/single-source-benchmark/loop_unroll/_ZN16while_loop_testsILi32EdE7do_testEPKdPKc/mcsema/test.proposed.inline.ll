...
define %struct.Memory* @_ZN16while_loop_testsILi32EdE7do_testEPKdPKc(%struct.State* noalias, i64, %struct.Memory* noalias) #1 {
entry:
  ...
  store %struct.Memory* %loadMem1_401228, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem1_401252, %struct.Memory** %MEMORY
  ...
  ret %struct.Memory* %loadMem_40125c
}
