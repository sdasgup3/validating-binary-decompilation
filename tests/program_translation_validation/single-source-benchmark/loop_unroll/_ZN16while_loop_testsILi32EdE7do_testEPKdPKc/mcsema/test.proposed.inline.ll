...
define %struct.Memory* @_ZN16while_loop_testsILi32EdE7do_testEPKdPKc(%struct.State* noalias, i64, %struct.Memory* noalias) #2 {
entry:
  ...
  store %struct.Memory* %loadMem1_401238, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem1_401262, %struct.Memory** %MEMORY
  ...
  ret %struct.Memory* %loadMem_40126c
}
