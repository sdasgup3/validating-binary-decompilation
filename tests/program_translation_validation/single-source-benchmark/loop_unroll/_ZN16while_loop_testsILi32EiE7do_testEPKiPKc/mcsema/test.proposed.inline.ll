...
declare %struct.Memory* @sub_411db0._ZN16while_loop_testsILi31EiE7do_testEPKiPKc(%struct.State* dereferenceable(3376), i64, %struct.Memory*)

declare %struct.Memory* @sub_411e00._Z29test_while_loop_unroll_factorILi32EiEvPKT0_iPKc(%struct.State* dereferenceable(3376), i64, %struct.Memory*)

; Function Attrs: alwaysinline
define %struct.Memory* @_ZN16while_loop_testsILi32EiE7do_testEPKiPKc(%struct.State* noalias, i64, %struct.Memory* noalias) #1 {
entry:
