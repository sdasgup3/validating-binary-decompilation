...
declare %struct.Memory* @sub_411d80._ZN16while_loop_testsILi31EiE7do_testEPKiPKc(%struct.State* noalias dereferenceable(3376), i64, %struct.Memory* noalias readnone returned)

declare %struct.Memory* @sub_411dd0._Z29test_while_loop_unroll_factorILi32EiEvPKT0_iPKc(%struct.State* noalias dereferenceable(3376), i64, %struct.Memory* noalias readnone returned)
...
entry:
  ...
  %call2_401078 = call %struct.Memory* @sub_411d80._ZN16while_loop_testsILi31EiE7do_testEPKiPKc(%struct.State* %0, i64 %loadPC_401078, %struct.Memory* %loadMem2_401078)
  ...
  %call2_4010a2 = call %struct.Memory* @sub_411dd0._Z29test_while_loop_unroll_factorILi32EiEvPKT0_iPKc(%struct.State* %0, i64 %loadPC_4010a2, %struct.Memory* %loadMem2_4010a2)
  ...
  ret %struct.Memory* %loadMem_4010ac
}
