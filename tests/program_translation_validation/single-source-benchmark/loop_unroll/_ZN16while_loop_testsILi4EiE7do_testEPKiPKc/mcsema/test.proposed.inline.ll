...
define %struct.Memory* @_ZN16while_loop_testsILi4EiE7do_testEPKiPKc(%struct.State* noalias, i64, %struct.Memory* noalias) #1 {
entry:
  ...
  store %struct.Memory* %loadMem1_413c28, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_413c43, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem1_413c52, %struct.Memory** %MEMORY
  ...
  ret %struct.Memory* %loadMem_413c5c
}
