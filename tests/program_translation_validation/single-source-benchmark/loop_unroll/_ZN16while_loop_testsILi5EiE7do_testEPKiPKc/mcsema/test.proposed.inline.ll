...
define %struct.Memory* @_ZN16while_loop_testsILi5EiE7do_testEPKiPKc(%struct.State* noalias, i64, %struct.Memory* noalias) #1 {
entry:
  ...
  store %struct.Memory* %loadMem1_413b08, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem1_413b32, %struct.Memory** %MEMORY
  ...
  ret %struct.Memory* %loadMem_413b3c
}
