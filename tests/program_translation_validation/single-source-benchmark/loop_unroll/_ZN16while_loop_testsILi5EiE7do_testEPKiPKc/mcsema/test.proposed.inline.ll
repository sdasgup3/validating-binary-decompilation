...
entry:
  ...
  store %struct.Memory* %loadMem1_413b18, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_413b1d, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_413b2c, %struct.Memory** %MEMORY
  ...
  ret %struct.Memory* %loadMem_413b4c
}
