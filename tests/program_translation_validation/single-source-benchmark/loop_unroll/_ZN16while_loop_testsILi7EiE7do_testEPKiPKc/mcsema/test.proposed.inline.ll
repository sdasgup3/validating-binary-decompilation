...
define %struct.Memory* @_ZN16while_loop_testsILi7EiE7do_testEPKiPKc(%struct.State* noalias, i64, %struct.Memory* noalias) #2 {
entry:
  ...
  store %struct.Memory* %loadMem1_4138c8, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem1_4138f2, %struct.Memory** %MEMORY
  ...
  ret %struct.Memory* %loadMem_4138fc
}
