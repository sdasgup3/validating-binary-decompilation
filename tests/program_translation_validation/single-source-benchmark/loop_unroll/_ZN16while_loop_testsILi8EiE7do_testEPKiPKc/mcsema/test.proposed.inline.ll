...
define %struct.Memory* @_ZN16while_loop_testsILi8EiE7do_testEPKiPKc(%struct.State* noalias, i64, %struct.Memory* noalias) #2 {
entry:
  ...
  store %struct.Memory* %loadMem1_413778, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem1_4137a2, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_4137ab, %struct.Memory** %MEMORY
  ...
  ret %struct.Memory* %loadMem_4137ac
}
