...
declare %struct.Memory* @sub_413760._ZN16while_loop_testsILi8EiE7do_testEPKiPKc(%struct.State* noalias dereferenceable(3376), i64, %struct.Memory* noalias readnone returned)

declare %struct.Memory* @sub_4137b0._Z29test_while_loop_unroll_factorILi9EiEvPKT0_iPKc(%struct.State* noalias dereferenceable(3376), i64, %struct.Memory* noalias readnone returned)
...
entry:
  ...
  %call2_413658 = call %struct.Memory* @sub_413760._ZN16while_loop_testsILi8EiE7do_testEPKiPKc(%struct.State* %0, i64 %loadPC_413658, %struct.Memory* %loadMem2_413658)
  ...
  store %struct.Memory* %loadMem_413673, %struct.Memory** %MEMORY
  ...
  %loadMem1_413682 = load %struct.Memory*, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem1_413682, %struct.Memory** %MEMORY
  %loadMem2_413682 = load %struct.Memory*, %struct.Memory** %MEMORY
  %loadPC_413682 = load i64, i64* %3
  %call2_413682 = call %struct.Memory* @sub_4137b0._Z29test_while_loop_unroll_factorILi9EiEvPKT0_iPKc(%struct.State* %0, i64 %loadPC_413682, %struct.Memory* %loadMem2_413682)
  store %struct.Memory* %call2_413682, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_41368b, %struct.Memory** %MEMORY
  ...
  ret %struct.Memory* %loadMem_41368c
}
