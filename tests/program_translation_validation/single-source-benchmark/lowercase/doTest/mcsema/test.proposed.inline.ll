...
entry:
  ...
  %336 = call %struct.Memory* @__remill_function_call(%struct.State* %0, i64 ptrtoint (i64 (i64)* @malloc to i64), %struct.Memory* %loadMem2_400624)
...
block_400643:                                     ; preds = %block_.L_400635
  ...
  %507 = load i64, i64* inttoptr (i64 6295624 to i64*)
  ...
  %537 = load i64, i64* inttoptr (i64 6295632 to i64*)
  ...
  %567 = load i64, i64* inttoptr (i64 6295640 to i64*)
...
block_.L_40068f:                                  ; preds = %block_.L_400635
  ...
  %739 = call %struct.Memory* @__remill_function_call(%struct.State* %0, i64 ptrtoint (i64 (i64)* @malloc to i64), %struct.Memory* %loadMem2_40069a)
  ...
  store i64 4196516, i64* %RDI.i67, align 8
  ...
  %816 = call %struct.Memory* @__remill_function_call(%struct.State* %0, i64 ptrtoint (i64 (i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64)* @printf to i64), %struct.Memory* %loadMem2_4006b7)
  ...
  %982 = call %struct.Memory* @__remill_function_call(%struct.State* %0, i64 ptrtoint (i64 (i64, i64, i64)* @memset to i64), %struct.Memory* %loadMem2_4006d8)
