...
declare %struct.Memory* @sub_4005d0.doTest(%struct.State* noalias dereferenceable(3376), i64, %struct.Memory* noalias readnone returned)
...
entry:
  ...
  ; Code: movl $0x0, -0x4(%rbp)	 RIP: 400588	 Bytes: 7
  %loadMem_400588 = load %struct.Memory*, %struct.Memory** %MEMORY
  %call_400588 = call %struct.Memory* @routine_movl__0x0__MINUS0x4__rbp_(%struct.State* %0, i64  0, %struct.Memory* %loadMem_400588)
  store %struct.Memory* %call_400588, %struct.Memory** %MEMORY

  ; Code: movl %edi, -0x8(%rbp)	 RIP: 40058f	 Bytes: 3
  %loadMem_40058f = load %struct.Memory*, %struct.Memory** %MEMORY
  %call_40058f = call %struct.Memory* @routine_movl__edi__MINUS0x8__rbp_(%struct.State* %0, i64  0, %struct.Memory* %loadMem_40058f)
  store %struct.Memory* %call_40058f, %struct.Memory** %MEMORY

  ; Code: movq %rsi, -0x10(%rbp)	 RIP: 400592	 Bytes: 4
  %loadMem_400592 = load %struct.Memory*, %struct.Memory** %MEMORY
  %call_400592 = call %struct.Memory* @routine_movq__rsi__MINUS0x10__rbp_(%struct.State* %0, i64  0, %struct.Memory* %loadMem_400592)
  store %struct.Memory* %call_400592, %struct.Memory** %MEMORY

  ; Code: movq $0x0, -0x18(%rbp)	 RIP: 400596	 Bytes: 8
  %loadMem_400596 = load %struct.Memory*, %struct.Memory** %MEMORY
  %call_400596 = call %struct.Memory* @routine_movq__0x0__MINUS0x18__rbp_(%struct.State* %0, i64  0, %struct.Memory* %loadMem_400596)
  store %struct.Memory* %call_400596, %struct.Memory** %MEMORY

  ; Code: .L_40059e:	 RIP: 40059e	 Bytes: 0
  br label %block_.L_40059e
block_.L_40059e:

  ; Code: cmpq $0x20, -0x18(%rbp)	 RIP: 40059e	 Bytes: 5
  %loadMem_40059e = load %struct.Memory*, %struct.Memory** %MEMORY
  %call_40059e = call %struct.Memory* @routine_cmpq__0x20__MINUS0x18__rbp_(%struct.State* %0, i64  0, %struct.Memory* %loadMem_40059e)
  store %struct.Memory* %call_40059e, %struct.Memory** %MEMORY

  ; Code: jae .L_4005c3	 RIP: 4005a3	 Bytes: 6
  %loadMem_4005a3 = load %struct.Memory*, %struct.Memory** %MEMORY
  %call_4005a3 = call %struct.Memory* @routine_jae_.L_4005c3(%struct.State* %0, i64  0, %struct.Memory* %loadMem_4005a3, i8* %BRANCH_TAKEN, i64 32, i64 6, i64 6)
  ...
  br i1 %cmpBr_4005a3, label %block_.L_4005c3, label %block_4005a9

block_4005a9:
  ; Code: movq -0x18(%rbp), %rdi	 RIP: 4005a9	 Bytes: 4
  %loadMem_4005a9 = load %struct.Memory*, %struct.Memory** %MEMORY
  %call_4005a9 = call %struct.Memory* @routine_movq_MINUS0x18__rbp____rdi(%struct.State* %0, i64  0, %struct.Memory* %loadMem_4005a9)
  store %struct.Memory* %call_4005a9, %struct.Memory** %MEMORY

  ; Code: callq .doTest	 RIP: 4005ad	 Bytes: 5
  %loadMem1_4005ad = load %struct.Memory*, %struct.Memory** %MEMORY
  %call1_4005ad = call %struct.Memory* @routine_callq_.doTest(%struct.State* %0, i64  0, %struct.Memory* %loadMem1_4005ad, i64 35, i64 5, i64 5)
  store %struct.Memory* %call1_4005ad, %struct.Memory** %MEMORY

  %loadMem2_4005ad = load %struct.Memory*, %struct.Memory** %MEMORY
  %loadPC_4005ad = load i64, i64* %3
  %call2_4005ad = call %struct.Memory* @sub_4005d0.doTest(%struct.State* %0, i64  %loadPC_4005ad, %struct.Memory* %loadMem2_4005ad)
  store %struct.Memory* %call2_4005ad, %struct.Memory** %MEMORY

  ; Code: movq -0x18(%rbp), %rax	 RIP: 4005b2	 Bytes: 4
  %loadMem_4005b2 = load %struct.Memory*, %struct.Memory** %MEMORY
  %call_4005b2 = call %struct.Memory* @routine_movq_MINUS0x18__rbp____rax(%struct.State* %0, i64  0, %struct.Memory* %loadMem_4005b2)
  store %struct.Memory* %call_4005b2, %struct.Memory** %MEMORY

  ; Code: addq $0x1, %rax	 RIP: 4005b6	 Bytes: 4
  %loadMem_4005b6 = load %struct.Memory*, %struct.Memory** %MEMORY
  %call_4005b6 = call %struct.Memory* @routine_addq__0x1___rax(%struct.State* %0, i64  0, %struct.Memory* %loadMem_4005b6)
  store %struct.Memory* %call_4005b6, %struct.Memory** %MEMORY

  ; Code: movq %rax, -0x18(%rbp)	 RIP: 4005ba	 Bytes: 4
  %loadMem_4005ba = load %struct.Memory*, %struct.Memory** %MEMORY
  %call_4005ba = call %struct.Memory* @routine_movq__rax__MINUS0x18__rbp_(%struct.State* %0, i64  0, %struct.Memory* %loadMem_4005ba)
  store %struct.Memory* %call_4005ba, %struct.Memory** %MEMORY

  ; Code: jmpq .L_40059e	 RIP: 4005be	 Bytes: 5
  %loadMem_4005be = load %struct.Memory*, %struct.Memory** %MEMORY
  %call_4005be = call %struct.Memory* @routine_jmpq_.L_40059e(%struct.State* %0, i64  0, %struct.Memory* %loadMem_4005be, i64 -32, i64 5)
  store %struct.Memory* %call_4005be, %struct.Memory** %MEMORY

  br label %block_.L_40059e

  ; Code: .L_4005c3:	 RIP: 4005c3	 Bytes: 0
block_.L_4005c3:

  ; Code: xorl %eax, %eax	 RIP: 4005c3	 Bytes: 2
  %loadMem_4005c3 = load %struct.Memory*, %struct.Memory** %MEMORY
  %call_4005c3 = call %struct.Memory* @routine_xorl__eax___eax(%struct.State* %0, i64  0, %struct.Memory* %loadMem_4005c3)
  store %struct.Memory* %call_4005c3, %struct.Memory** %MEMORY

  ; Code: addq $0x20, %rsp	 RIP: 4005c5	 Bytes: 4
  %loadMem_4005c5 = load %struct.Memory*, %struct.Memory** %MEMORY
  %call_4005c5 = call %struct.Memory* @routine_addq__0x20___rsp(%struct.State* %0, i64  0, %struct.Memory* %loadMem_4005c5)
  store %struct.Memory* %call_4005c5, %struct.Memory** %MEMORY

  ; Code: popq %rbp	 RIP: 4005c9	 Bytes: 1
  %loadMem_4005c9 = load %struct.Memory*, %struct.Memory** %MEMORY
  %call_4005c9 = call %struct.Memory* @routine_popq__rbp(%struct.State* %0, i64  0, %struct.Memory* %loadMem_4005c9)
  store %struct.Memory* %call_4005c9, %struct.Memory** %MEMORY

  ; Code: retq	 RIP: 4005ca	 Bytes: 1
  %loadMem_4005ca = load %struct.Memory*, %struct.Memory** %MEMORY
  %call_4005ca = call %struct.Memory* @routine_retq(%struct.State* %0, i64  0, %struct.Memory* %loadMem_4005ca)
  store %struct.Memory* %call_4005ca, %struct.Memory** %MEMORY

  ret %struct.Memory* %call_4005ca
}
...
define %struct.Memory* @routine_jae_.L_4005c3(%struct.State*  dereferenceable(3376), i64, %struct.Memory*, i8* %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) {
block_400478:
  %3 = getelementptr inbounds %struct.State, %struct.State* %0, i32 0, i32 6
  %4 = getelementptr inbounds %struct.GPR, %struct.GPR* %3, i32 0, i32 33
  %5 = getelementptr inbounds %struct.Reg, %struct.Reg* %4, i32 0, i32 0
