...
entry:
  ...
  br i1 %68, label %block_.L_400804, label %block_4007f7
...
block_.L_400804:                                  ; preds = %entry, %block_4007f7
  %100 = phi i64 [ %.pre, %block_4007f7 ], [ %62, %entry ]
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_jl_.L_400804(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i8* nocapture %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
