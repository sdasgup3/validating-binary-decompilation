; ModuleID = '/tmp/tmpengbttpx-query.ll'
...
entry:
  ...
  %var_2_87 = icmp ne i32 %var_2_80, 0
  %var_2_88 = xor i1 %var_2_87, %var_2_85
  %var_2_89 = or i1 %var_2_78, %var_2_88
  br i1 %var_2_89, label %entry.block_.L_401015_crit_edge, label %block_400fc4
...
entry.block_.L_401015_crit_edge:                  ; preds = %entry
  ...
  %.pre18 = getelementptr inbounds %union.anon, %union.anon* %var_2_42, i64 0, i32 0
  %.pre = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 5, i32 0, i32 0
...
block_400fc4:                                     ; preds = %entry
  ...
  %RAX.i159 = getelementptr inbounds %union.anon, %union.anon* %var_2_94, i64 0, i32 0
  %EAX.i171 = bitcast %union.anon* %var_2_94 to i32*
  %RDI.i241 = getelementptr inbounds %union.anon, %union.anon* %var_2_42, i64 0, i32 0
  %RCX.i247 = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 5, i32 0, i32 0
  %var_2_9635 = load i64, i64* %RBP.i, align 8
  %var_2_9736 = add i64 %var_2_9635, -20
  %var_2_9937 = inttoptr i64 %var_2_9736 to i32*
  %var_2_10038 = load i32, i32* %var_2_9937, align 4
  %var_2_10239 = add i64 %var_2_9635, -8
  %var_2_10440 = inttoptr i64 %var_2_10239 to i32*
  %var_2_10541 = load i32, i32* %var_2_10440, align 4
  %var_2_10642 = sub i32 %var_2_10038, %var_2_10541
  %var_2_12143 = lshr i32 %var_2_10642, 31
  %var_2_12344 = lshr i32 %var_2_10038, 31
  %var_2_12445 = lshr i32 %var_2_10541, 31
  %var_2_12546 = xor i32 %var_2_12445, %var_2_12344
  %var_2_12647 = xor i32 %var_2_12143, %var_2_12344
  %var_2_12748 = add nuw nsw i32 %var_2_12647, %var_2_12546
  %var_2_12849 = icmp eq i32 %var_2_12748, 2
  %var_2_13050 = icmp ne i32 %var_2_12143, 0
  %var_2_13151 = xor i1 %var_2_13050, %var_2_12849
  br i1 %var_2_13151, label %block_400fd7.preheader, label %block_.L_401015

block_400fd7.preheader:                           ; preds = %block_400fc4
  br label %block_400fd7

block_400fd7:                                     ; preds = %block_.L_400ffd, %block_400fd7.preheader
  %MEMORY.052 = phi %struct.Memory* [ %var_2_146, %block_.L_400ffd ], [ %2, %block_400fd7.preheader ]
  ...
  %var_2_146 = tail call %struct.Memory* @__remill_function_call(%struct.State* nonnull %0, i64 ptrtoint (i64 (i64, i64)* @strcmp to i64), %struct.Memory* %MEMORY.052)
  %var_2_147 = load i32, i32* %EAX.i171, align 4
  store i8 0, i8* %var_2_14, align 1
  %var_2_154 = icmp eq i32 %var_2_147, 0
  br i1 %var_2_154, label %block_.L_401015.loopexit, label %block_.L_400ffd
...
block_.L_400ffd:                                  ; preds = %block_400fd7
  ...
  store i64 %var_2_170, i64* %RAX.i159, align 8
  %var_2_100 = load i32, i32* %var_2_167, align 4
  %var_2_102 = add i64 %var_2_159, -8
  ...
  br i1 %var_2_131, label %block_400fd7, label %block_.L_401015.loopexit

block_.L_401015.loopexit:                         ; preds = %block_.L_400ffd, %block_400fd7
  br label %block_.L_401015

block_.L_401015:                                  ; preds = %block_.L_401015.loopexit, %block_400fc4, %entry.block_.L_401015_crit_edge
  %RCX.i193.pre-phi = phi i64* [ %RCX.i247, %block_400fc4 ], [ %.pre, %entry.block_.L_401015_crit_edge ], [ %RCX.i247, %block_.L_401015.loopexit ]
  %RDI.i219.pre-phi = phi i64* [ %RDI.i241, %block_400fc4 ], [ %.pre18, %entry.block_.L_401015_crit_edge ], [ %RDI.i241, %block_.L_401015.loopexit ]
  %EAX.i218.pre-phi = phi i32* [ %EAX.i171, %block_400fc4 ], [ %.pre17, %entry.block_.L_401015_crit_edge ], [ %EAX.i171, %block_.L_401015.loopexit ]
  %RAX.i221.pre-phi = phi i64* [ %RAX.i159, %block_400fc4 ], [ %.pre16, %entry.block_.L_401015_crit_edge ], [ %RAX.i159, %block_.L_401015.loopexit ]
  %.pre-phi = phi %union.anon* [ %var_2_94, %block_400fc4 ], [ %.pre15, %entry.block_.L_401015_crit_edge ], [ %var_2_94, %block_.L_401015.loopexit ]
  %MEMORY.2 = phi %struct.Memory* [ %2, %block_400fc4 ], [ %2, %entry.block_.L_401015_crit_edge ], [ %var_2_146, %block_.L_401015.loopexit ]
  store i64 16000, i64* %RAX.i221.pre-phi, align 8
  store i64 16000, i64* %RDI.i219.pre-phi, align 8
  %var_2_203 = tail call %struct.Memory* @__remill_function_call(%struct.State* nonnull %0, i64 ptrtoint (i64 (i64)* @malloc to i64), %struct.Memory* %MEMORY.2)
  %var_2_204 = load i64, i64* %RBP.i, align 8
  %var_2_205 = add i64 %var_2_204, -32
  %var_2_206 = load i64, i64* %RAX.i221.pre-phi, align 8
  %var_2_209 = inttoptr i64 %var_2_205 to i64*
  store i64 %var_2_206, i64* %var_2_209, align 8
  %var_2_21621 = load i64, i64* %RBP.i, align 8
  %var_2_21722 = add i64 %var_2_21621, -20
  %var_2_21923 = inttoptr i64 %var_2_21722 to i32*
  %var_2_22024 = load i32, i32* %var_2_21923, align 4
  %var_2_22125 = add i32 %var_2_22024, -2000
  %var_2_23626 = lshr i32 %var_2_22125, 31
  %var_2_23827 = lshr i32 %var_2_22024, 31
  %var_2_23928 = xor i32 %var_2_23626, %var_2_23827
  %var_2_24029 = add nuw nsw i32 %var_2_23928, %var_2_23827
  %var_2_24130 = icmp eq i32 %var_2_24029, 2
  %var_2_24331 = icmp ne i32 %var_2_23626, 0
  %var_2_24432 = xor i1 %var_2_24331, %var_2_24130
  br i1 %var_2_24432, label %block_401039.preheader, label %block_.L_40105f

block_401039.preheader:                           ; preds = %block_.L_401015
  br label %block_401039

block_401039:                                     ; preds = %block_401039, %block_401039.preheader
  %MEMORY.333 = phi %struct.Memory* [ %var_2_252, %block_401039 ], [ %var_2_203, %block_401039.preheader ]
  store i64 16008, i64* %RAX.i221.pre-phi, align 8
  store i64 16008, i64* %RDI.i219.pre-phi, align 8
  %var_2_252 = tail call %struct.Memory* @__remill_function_call(%struct.State* nonnull %0, i64 ptrtoint (i64 (i64)* @malloc to i64), %struct.Memory* %MEMORY.333)
  %var_2_253 = load i64, i64* %RBP.i, align 8
  %var_2_254 = add i64 %var_2_253, -32
  %var_2_255 = load i64, i64* %var_2_3, align 8
  %var_2_257 = inttoptr i64 %var_2_254 to i64*
  %var_2_258 = load i64, i64* %var_2_257, align 8
  store i64 %var_2_258, i64* %RDI.i219.pre-phi, align 8
  %var_2_259 = add i64 %var_2_253, -20
  ...
  store i64 %var_2_263, i64* %RCX.i193.pre-phi, align 8
  %var_2_264 = shl nsw i64 %var_2_263, 3
  %var_2_265 = add i64 %var_2_264, %var_2_258
  %var_2_266 = load i64, i64* %RAX.i221.pre-phi, align 8
  %var_2_268 = inttoptr i64 %var_2_265 to i64*
  store i64 %var_2_266, i64* %var_2_268, align 8
  %var_2_269 = load i64, i64* %RBP.i, align 8
  %var_2_270 = add i64 %var_2_269, -20
  %var_2_273 = inttoptr i64 %var_2_270 to i32*
  %var_2_274 = load i32, i32* %var_2_273, align 4
  %var_2_275 = add i32 %var_2_274, 1
  %var_2_276 = zext i32 %var_2_275 to i64
  store i64 %var_2_276, i64* %RAX.i221.pre-phi, align 8
  %var_2_220 = load i32, i32* %var_2_273, align 4
  %var_2_221 = add i32 %var_2_220, -2000
  %var_2_236 = lshr i32 %var_2_221, 31
  %var_2_238 = lshr i32 %var_2_220, 31
  %var_2_239 = xor i32 %var_2_236, %var_2_238
  %var_2_240 = add nuw nsw i32 %var_2_239, %var_2_238
  %var_2_241 = icmp eq i32 %var_2_240, 2
  %var_2_243 = icmp ne i32 %var_2_236, 0
  %var_2_244 = xor i1 %var_2_243, %var_2_241
  br i1 %var_2_244, label %block_401039, label %block_.L_40105f.loopexit

block_.L_40105f.loopexit:                         ; preds = %block_401039
  br label %block_.L_40105f

block_.L_40105f:                                  ; preds = %block_.L_40105f.loopexit, %block_.L_401015
  %MEMORY.3.lcssa = phi %struct.Memory* [ %var_2_203, %block_.L_401015 ], [ %var_2_252, %block_.L_40105f.loopexit ]
  store i64 16000, i64* %RAX.i221.pre-phi, align 8
  store i64 16000, i64* %RDI.i219.pre-phi, align 8
  %var_2_306 = tail call %struct.Memory* @__remill_function_call(%struct.State* nonnull %0, i64 ptrtoint (i64 (i64)* @malloc to i64), %struct.Memory* %MEMORY.3.lcssa)
  %var_2_307 = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 5, i32 0
  %RCX.i169 = getelementptr inbounds %union.anon, %union.anon* %var_2_307, i64 0, i32 0
  store i64 16000, i64* %RCX.i169, align 8
  %ECX.i166 = bitcast %union.anon* %var_2_307 to i32*
  store i64 16000, i64* %RDI.i219.pre-phi, align 8
  %var_2_309 = load i64, i64* %RBP.i, align 8
  %var_2_310 = add i64 %var_2_309, -40
  %var_2_311 = load i64, i64* %RAX.i221.pre-phi, align 8
  %var_2_313 = inttoptr i64 %var_2_310 to i64*
  store i64 %var_2_311, i64* %var_2_313, align 8
  %var_2_320 = tail call %struct.Memory* @__remill_function_call(%struct.State* nonnull %0, i64 ptrtoint (i64 (i64)* @malloc to i64), %struct.Memory* %var_2_306)
  store i64 8000, i64* %RCX.i169, align 8
  store i64 8000, i64* %RDI.i219.pre-phi, align 8
  %var_2_322 = load i64, i64* %RBP.i, align 8
  %var_2_323 = add i64 %var_2_322, -48
  %var_2_324 = load i64, i64* %RAX.i221.pre-phi, align 8
  %var_2_326 = inttoptr i64 %var_2_323 to i64*
  store i64 %var_2_324, i64* %var_2_326, align 8
  %var_2_333 = tail call %struct.Memory* @__remill_function_call(%struct.State* nonnull %0, i64 ptrtoint (i64 (i64)* @malloc to i64), %struct.Memory* %var_2_320)
  %var_2_334 = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 1, i64 0
  %var_2_335 = load i64, i64* %var_2_3, align 8
  %var_2_336 = add i64 %var_2_335, ptrtoint (%G_0x1a5__rip__type* @G_0x1a5__rip_ to i64)
  %var_2_337 = add i64 %var_2_335, 8
  store i64 %var_2_337, i64* %var_2_3, align 8
  %var_2_338 = inttoptr i64 %var_2_336 to i64*
  %var_2_339 = load i64, i64* %var_2_338, align 8
  %var_2_340 = getelementptr inbounds %union.VectorReg, %union.VectorReg* %var_2_334, i64 0, i32 0, i32 0, i32 0, i64 0
  store i64 %var_2_339, i64* %var_2_340, align 1
  %var_2_343 = load i64, i64* %RBP.i, align 8
  %var_2_344 = add i64 %var_2_343, -56
  %var_2_345 = load i64, i64* %RAX.i221.pre-phi, align 8
  %var_2_347 = inttoptr i64 %var_2_344 to i64*
  store i64 %var_2_345, i64* %var_2_347, align 8
  %var_2_354 = load i64, i64* %RBP.i, align 8
  %var_2_355 = add i64 %var_2_354, -32
  %var_2_356 = load i64, i64* %var_2_3, align 8
  %var_2_358 = inttoptr i64 %var_2_355 to i64*
  %var_2_359 = load i64, i64* %var_2_358, align 8
  store i64 %var_2_359, i64* %RDI.i219.pre-phi, align 8
  %var_2_361 = add i64 %var_2_356, 8
  store i64 %var_2_361, i64* %var_2_3, align 8
  %var_2_364 = add i64 %var_2_356, -2572
  %call2_4010a4 = tail call %struct.Memory* @sub_400690.matgen(%struct.State* nonnull %0, i64 %var_2_364, %struct.Memory* %var_2_333)
  %var_2_369 = load i64, i64* %RBP.i, align 8
  %var_2_370 = add i64 %var_2_369, -32
  %var_2_371 = load i64, i64* %var_2_3, align 8
  %var_2_373 = inttoptr i64 %var_2_370 to i64*
  %var_2_374 = load i64, i64* %var_2_373, align 8
  store i64 %var_2_374, i64* %RDI.i219.pre-phi, align 8
  %var_2_376 = add i64 %var_2_371, 8
  store i64 %var_2_376, i64* %var_2_3, align 8
  %var_2_379 = add i64 %var_2_371, -1161
  %call2_4010b1 = tail call %struct.Memory* @sub_400c20.dgefa(%struct.State* nonnull %0, i64 %var_2_379, %struct.Memory* %call2_4010a4)
  %var_2_384 = load i64, i64* %RBP.i, align 8
  %var_2_385 = add i64 %var_2_384, -32
  %var_2_386 = load i64, i64* %var_2_3, align 8
  %var_2_388 = inttoptr i64 %var_2_385 to i64*
  %var_2_389 = load i64, i64* %var_2_388, align 8
  store i64 %var_2_389, i64* %RDI.i219.pre-phi, align 8
  %var_2_391 = add i64 %var_2_386, 8
  store i64 %var_2_391, i64* %var_2_3, align 8
  %var_2_398 = add i64 %var_2_386, -678
  %call2_4010c2 = tail call %struct.Memory* @sub_400e10.dgesl(%struct.State* nonnull %0, i64 %var_2_398, %struct.Memory* %call2_4010b1)
  %var_2_403 = load i64, i64* %var_2_3, align 8
  %var_2_404 = bitcast %union.VectorReg* %var_2_334 to <4 x i32>*
  store <4 x i32> zeroinitializer, <4 x i32>* %var_2_404, align 1
  %var_2_407 = add i64 %var_2_403, 8
  store i64 %var_2_407, i64* %var_2_3, align 8
  %var_2_410 = load i64, i64* %RBP.i, align 8
  %var_2_411 = add i64 %var_2_410, -56
  %var_2_414 = inttoptr i64 %var_2_411 to i64*
  %var_2_415 = load i64, i64* %var_2_414, align 8
  store i64 %var_2_415, i64* %RAX.i221.pre-phi, align 8
  store i64 %var_2_415, i64* %RDI.i219.pre-phi, align 8
  %var_2_421 = tail call %struct.Memory* @__remill_function_call(%struct.State* nonnull %0, i64 ptrtoint (i64 (i64)* @free to i64), %struct.Memory* %call2_4010c2)
  %var_2_422 = load i64, i64* %RBP.i, align 8
  %var_2_423 = add i64 %var_2_422, -48
  %var_2_426 = inttoptr i64 %var_2_423 to i64*
  %var_2_427 = load i64, i64* %var_2_426, align 8
  store i64 %var_2_427, i64* %RAX.i221.pre-phi, align 8
  store i64 %var_2_427, i64* %RDI.i219.pre-phi, align 8
  %var_2_433 = tail call %struct.Memory* @__remill_function_call(%struct.State* nonnull %0, i64 ptrtoint (i64 (i64)* @free to i64), %struct.Memory* %var_2_421)
  %var_2_434 = load i64, i64* %RBP.i, align 8
  %var_2_435 = add i64 %var_2_434, -40
  %var_2_438 = inttoptr i64 %var_2_435 to i64*
  %var_2_439 = load i64, i64* %var_2_438, align 8
  store i64 %var_2_439, i64* %RAX.i221.pre-phi, align 8
  store i64 %var_2_439, i64* %RDI.i219.pre-phi, align 8
  %var_2_445 = tail call %struct.Memory* @__remill_function_call(%struct.State* nonnull %0, i64 ptrtoint (i64 (i64)* @free to i64), %struct.Memory* %var_2_433)
  %var_2_4522 = load i64, i64* %RBP.i, align 8
  %var_2_4533 = add i64 %var_2_4522, -20
  %var_2_4554 = inttoptr i64 %var_2_4533 to i32*
  %var_2_4565 = load i32, i32* %var_2_4554, align 4
  %var_2_4576 = add i32 %var_2_4565, -2000
  %var_2_4727 = lshr i32 %var_2_4576, 31
  %var_2_4748 = lshr i32 %var_2_4565, 31
  %var_2_4759 = xor i32 %var_2_4727, %var_2_4748
  %var_2_47610 = add nuw nsw i32 %var_2_4759, %var_2_4748
  %var_2_47711 = icmp eq i32 %var_2_47610, 2
  %var_2_47912 = icmp ne i32 %var_2_4727, 0
  %var_2_48013 = xor i1 %var_2_47912, %var_2_47711
  %var_2_48214 = add i64 %var_2_4522, -32
  %var_2_48415 = inttoptr i64 %var_2_48214 to i64*
  %var_2_48516 = load i64, i64* %var_2_48415, align 8
  store i64 %var_2_48516, i64* %RAX.i221.pre-phi, align 8
  br i1 %var_2_48013, label %block_401107.preheader, label %block_.L_401129

block_401107.preheader:                           ; preds = %block_.L_40105f
  br label %block_401107

block_401107:                                     ; preds = %block_401107, %block_401107.preheader
  %var_2_48519 = phi i64 [ %var_2_485, %block_401107 ], [ %var_2_48516, %block_401107.preheader ]
  %var_2_45518 = phi i32* [ %var_2_504, %block_401107 ], [ %var_2_4554, %block_401107.preheader ]
  %MEMORY.417 = phi %struct.Memory* [ %var_2_499, %block_401107 ], [ %var_2_445, %block_401107.preheader ]
  %var_2_487 = load i32, i32* %var_2_45518, align 4
  %var_2_488 = sext i32 %var_2_487 to i64
  store i64 %var_2_488, i64* %RCX.i169, align 8
  %var_2_489 = shl nsw i64 %var_2_488, 3
  %var_2_490 = add i64 %var_2_489, %var_2_48519
  %var_2_492 = inttoptr i64 %var_2_490 to i64*
  %var_2_493 = load i64, i64* %var_2_492, align 8
  store i64 %var_2_493, i64* %RAX.i221.pre-phi, align 8
  store i64 %var_2_493, i64* %RDI.i219.pre-phi, align 8
  %var_2_499 = tail call %struct.Memory* @__remill_function_call(%struct.State* nonnull %0, i64 ptrtoint (i64 (i64)* @free to i64), %struct.Memory* %MEMORY.417)
  %var_2_500 = load i64, i64* %RBP.i, align 8
  %var_2_501 = add i64 %var_2_500, -20
  %var_2_504 = inttoptr i64 %var_2_501 to i32*
  %var_2_505 = load i32, i32* %var_2_504, align 4
  %var_2_506 = add i32 %var_2_505, 1
  %var_2_507 = zext i32 %var_2_506 to i64
  store i64 %var_2_507, i64* %RAX.i221.pre-phi, align 8
  %var_2_456 = load i32, i32* %var_2_504, align 4
  %var_2_457 = add i32 %var_2_456, -2000
  %var_2_472 = lshr i32 %var_2_457, 31
  %var_2_474 = lshr i32 %var_2_456, 31
  %var_2_475 = xor i32 %var_2_472, %var_2_474
  %var_2_476 = add nuw nsw i32 %var_2_475, %var_2_474
  %var_2_477 = icmp eq i32 %var_2_476, 2
  %var_2_479 = icmp ne i32 %var_2_472, 0
  %var_2_480 = xor i1 %var_2_479, %var_2_477
  %var_2_482 = add i64 %var_2_500, -32
  %var_2_484 = inttoptr i64 %var_2_482 to i64*
  %var_2_485 = load i64, i64* %var_2_484, align 8
  store i64 %var_2_485, i64* %RAX.i221.pre-phi, align 8
  br i1 %var_2_480, label %block_401107, label %block_.L_401129.loopexit

block_.L_401129.loopexit:                         ; preds = %block_401107
  br label %block_.L_401129

block_.L_401129:                                  ; preds = %block_.L_401129.loopexit, %block_.L_40105f
  %MEMORY.4.lcssa = phi %struct.Memory* [ %var_2_445, %block_.L_40105f ], [ %var_2_499, %block_.L_401129.loopexit ]
  %var_2_485.lcssa = phi i64 [ %var_2_48516, %block_.L_40105f ], [ %var_2_485, %block_.L_401129.loopexit ]
  store i64 %var_2_485.lcssa, i64* %RDI.i219.pre-phi, align 8
  %var_2_537 = tail call %struct.Memory* @__remill_function_call(%struct.State* nonnull %0, i64 ptrtoint (i64 (i64)* @free to i64), %struct.Memory* %MEMORY.4.lcssa)
  %var_2_538 = load i64, i64* %RBP.i, align 8
  %var_2_539 = add i64 %var_2_538, -21
  %var_2_542 = inttoptr i64 %var_2_539 to i8*
  %var_2_543 = load i8, i8* %var_2_542, align 1
  %var_2_544 = and i8 %var_2_543, 1
  store i8 0, i8* %var_2_14, align 1
  %var_4_3 = shl nuw nsw i8 %var_2_544, 2
  %var_4_4 = zext i8 %var_4_3 to i64
  %var_4_5 = or i64 %var_4_4, -80
  %var_2_572 = load i64, i64* bitcast (%G_0x602058_type* @G_0x602058 to i64*), align 8
  store i64 %var_2_572, i64* %RDI.i219.pre-phi, align 8
  %AL.i = bitcast %union.anon* %.pre-phi to i8*
  store i8 1, i8* %AL.i, align 1
  %var_2_582 = tail call %struct.Memory* @__remill_function_call(%struct.State* nonnull %0, i64 ptrtoint (i64 (i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64)* @fprintf to i64), %struct.Memory* %var_2_537)
  %var_2_583 = load i64, i64* %RBP.i, align 8
  %var_2_584 = add i64 %var_2_583, %var_4_5
  %var_2_585.sink = load i32, i32* %EAX.i218.pre-phi, align 4
  %var_2_588 = inttoptr i64 %var_2_584 to i32*
  store i32 %var_2_585.sink, i32* %var_2_588, align 4
  %var_2_590 = load i64, i64* bitcast (%G_0x602058_type* @G_0x602058 to i64*), align 8
  store i64 %var_2_590, i64* %RDI.i219.pre-phi, align 8
  %var_2_596 = tail call %struct.Memory* @__remill_function_call(%struct.State* nonnull %0, i64 ptrtoint (i64 (i64)* @fflush to i64), %struct.Memory* %var_2_582)
  store i64 0, i64* %RCX.i169, align 8
  %var_2_598 = load i64, i64* %RBP.i, align 8
  %var_2_599 = add i64 %var_2_598, -84
  %var_2_600 = load i32, i32* %EAX.i218.pre-phi, align 4
  %var_2_602 = inttoptr i64 %var_2_599 to i32*
  store i32 %var_2_600, i32* %var_2_602, align 4
  %var_2_603 = load i32, i32* %ECX.i166, align 4
  %var_2_604 = zext i32 %var_2_603 to i64
  %var_2_605 = load i64, i64* %var_2_3, align 8
  store i64 %var_2_604, i64* %RAX.i221.pre-phi, align 8
  %var_2_633 = add i64 %var_2_605, 8
  store i64 %var_2_633, i64* %var_2_3, align 8
  ret %struct.Memory* %var_2_596
}
