...
@G_0x428__rip__4197344_ = global %G_0x428__rip__4197344__type zeroinitializer
...
entry:
  ...
  %76 = load double, double* bitcast (%G_0x428__rip__4197344__type* @G_0x428__rip__4197344_ to double*)
...
block_.L_400bf7:                                  ; preds = %block_.L_400cd7, %entry
...
block_.L_400c0a:                                  ; preds = %block_.L_400cc4, %block_400c03
...
block_400c16:                                     ; preds = %block_.L_400c0a
  ...
  %694 = load float, float* bitcast (%G_0x3af__rip__4197473__type* @G_0x3af__rip__4197473_ to float*)
  %695 = load float, float* inttoptr (i64 add (i64 ptrtoint (%G_0x3af__rip__4197473__type* @G_0x3af__rip__4197473_ to i64), i64 4) to float*)
  %696 = load float, float* inttoptr (i64 add (i64 ptrtoint (%G_0x3af__rip__4197473__type* @G_0x3af__rip__4197473_ to i64), i64 8) to float*)
  %697 = load float, float* inttoptr (i64 add (i64 ptrtoint (%G_0x3af__rip__4197473__type* @G_0x3af__rip__4197473_ to i64), i64 12) to float*)
...
; <label>:802:                                    ; preds = %794
  ...
  %805 = call %struct.Memory* @__remill_error(%struct.State* nonnull dereferenceable(3376) %0, i64 %804, %struct.Memory* %loadMem_400c6f)
  br label %routine_ucomisd_MINUS0x28__rbp____xmm0.exit

; <label>:806:                                    ; preds = %block_400c16
...
routine_ucomisd_MINUS0x28__rbp____xmm0.exit:      ; preds = %802, %819
  %823 = phi %struct.Memory* [ %805, %802 ], [ %loadMem_400c6f, %819 ]
...
block_400c7a:                                     ; preds = %routine_ucomisd_MINUS0x28__rbp____xmm0.exit
  ...
  store i64 ptrtoint (%G__0x40105a_type* @G__0x40105a to i64), i64* %RSI.i, align 8
  ...
  %1002 = call %struct.Memory* @__remill_function_call(%struct.State* %0, i64 ptrtoint (i64 (i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64)* @fprintf to i64), %struct.Memory* %loadMem2_400cab)
...
block_.L_400cc4:                                  ; preds = %block_.L_400cbf
...
block_.L_400cd7:                                  ; preds = %block_.L_400cd2
...
define %struct.Memory* @routine_movq__0x40105a___rsi(%struct.State* dereferenceable(3376), i64, %struct.Memory*) {
block_400478:
  %3 = getelementptr inbounds %struct.State, %struct.State* %0, i32 0, i32 6
  %4 = getelementptr inbounds %struct.GPR, %struct.GPR* %3, i32 0, i32 33
  %5 = getelementptr inbounds %struct.Reg, %struct.Reg* %4, i32 0, i32 0
