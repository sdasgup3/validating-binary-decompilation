...
block_.L_400c27:                                  ; preds = %block_.L_400d07, %entry
...
block_.L_400c3a:                                  ; preds = %block_.L_400cf4, %block_400c33
...
; <label>:812:                                    ; preds = %804
  ...
  %815 = call %struct.Memory* @__remill_error(%struct.State* nonnull dereferenceable(3376) %0, i64 %814, %struct.Memory* %loadMem_400c9f)
  br label %routine_ucomisd_MINUS0x28__rbp____xmm0.exit

; <label>:816:                                    ; preds = %block_400c46
...
routine_ucomisd_MINUS0x28__rbp____xmm0.exit:      ; preds = %812, %829
  %833 = phi %struct.Memory* [ %815, %812 ], [ %loadMem_400c9f, %829 ]
...
block_400caa:                                     ; preds = %routine_ucomisd_MINUS0x28__rbp____xmm0.exit
  ...
  store i64 4198538, i64* %RSI.i, align 8
  ...
  %1012 = call %struct.Memory* @__remill_function_call(%struct.State* %0, i64 ptrtoint (i64 (i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64)* @fprintf to i64), %struct.Memory* %loadMem2_400cdb)
...
block_.L_400cf4:                                  ; preds = %block_.L_400cef
...
block_.L_400d07:                                  ; preds = %block_.L_400d02
...
block_.L_400d1c:                                  ; preds = %block_.L_400d15, %block_400caa
  ...
  ret %struct.Memory* %loadMem_400d24
}
...
define %struct.Memory* @routine_movq__0x40108a___rsi(%struct.State* dereferenceable(3376), i64, %struct.Memory*) {
block_400488:
  %3 = getelementptr inbounds %struct.State, %struct.State* %0, i32 0, i32 6
  %4 = getelementptr inbounds %struct.GPR, %struct.GPR* %3, i32 0, i32 33
  %5 = getelementptr inbounds %struct.Reg, %struct.Reg* %4, i32 0, i32 0
