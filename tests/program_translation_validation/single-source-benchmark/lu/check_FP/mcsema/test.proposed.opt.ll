...
block_.L_400c27:                                  ; preds = %block_.L_400d02, %entry
  %95 = phi i64 [ %.pre, %entry ], [ %464, %block_.L_400d02 ]
...
block_.L_400c3a:                                  ; preds = %block_.L_400cef, %block_400c33
  %136 = phi i64 [ %.pre29, %block_400c33 ], [ %434, %block_.L_400cef ]
...
block_400caa:                                     ; preds = %routine_ucomisd_MINUS0x28__rbp____xmm0.exit
  store i64 4198538, i64* %RSI.i143, align 8
...
block_.L_400d1c:                                  ; preds = %block_.L_400d15, %block_400caa
  %468 = phi i64 [ %.pre31, %block_.L_400d15 ], [ %403, %block_400caa ]
  %MEMORY.2 = phi %struct.Memory* [ %MEMORY.0, %block_.L_400d15 ], [ %390, %block_400caa ]
