...
block_.L_400bf7:                                  ; preds = %block_.L_400cd2, %entry
  %89 = phi i64 [ %.pre, %entry ], [ %458, %block_.L_400cd2 ]
  ...
  br i1 %125, label %block_400c03, label %block_.L_400ce5
...
block_.L_400c0a:                                  ; preds = %block_.L_400cbf, %block_400c03
  %130 = phi i64 [ %.pre3, %block_400c03 ], [ %427, %block_.L_400cbf ]
  %MEMORY.1 = phi %struct.Memory* [ %MEMORY.0, %block_400c03 ], [ %333, %block_.L_400cbf ]
  ...
  br i1 %166, label %block_400c16, label %block_.L_400cd2
...
block_400c16:                                     ; preds = %block_.L_400c0a
  ...
  %281 = load i32, i32* bitcast (%G_0x3af__rip__type* @G_0x3af__rip_ to i32*), align 8
  %282 = load i32, i32* inttoptr (i64 add (i64 ptrtoint (%G_0x3af__rip__type* @G_0x3af__rip_ to i64), i64 4) to i32*), align 4
  %283 = load i32, i32* inttoptr (i64 add (i64 ptrtoint (%G_0x3af__rip__type* @G_0x3af__rip_ to i64), i64 8) to i32*), align 8
  %284 = load i32, i32* inttoptr (i64 add (i64 ptrtoint (%G_0x3af__rip__type* @G_0x3af__rip_ to i64), i64 12) to i32*), align 4
...
routine_ucomisd_MINUS0x28__rbp____xmm0.exit:      ; preds = %331, %319
  ...
  br i1 %337, label %block_.L_400cbf, label %block_400c7a
...
block_.L_400cec:                                  ; preds = %block_.L_400ce5, %block_400c7a
  %462 = phi i64 [ %.pre5, %block_.L_400ce5 ], [ %395, %block_400c7a ]
  %MEMORY.2 = phi %struct.Memory* [ %MEMORY.0, %block_.L_400ce5 ], [ %382, %block_400c7a ]
...
block_400478:
  ...
  %6 = add i64 %5, 7
  store i64 %6, i64* %PC, align 8
  %7 = load i32, i32* bitcast (%G_0x3af__rip__type* @G_0x3af__rip_ to i32*), align 8
  %8 = load i32, i32* inttoptr (i64 add (i64 ptrtoint (%G_0x3af__rip__type* @G_0x3af__rip_ to i64), i64 4) to i32*), align 4
  %9 = load i32, i32* inttoptr (i64 add (i64 ptrtoint (%G_0x3af__rip__type* @G_0x3af__rip_ to i64), i64 8) to i32*), align 8
  %10 = load i32, i32* inttoptr (i64 add (i64 ptrtoint (%G_0x3af__rip__type* @G_0x3af__rip_ to i64), i64 12) to i32*), align 4
