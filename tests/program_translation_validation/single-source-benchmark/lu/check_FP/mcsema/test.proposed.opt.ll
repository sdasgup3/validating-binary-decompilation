...
@G_0x3af__rip__4197473_ = global %G_0x3af__rip__4197473__type zeroinitializer
@G_0x428__rip__4197344_ = local_unnamed_addr global %G_0x428__rip__4197344__type zeroinitializer
@G_0x602080 = local_unnamed_addr global %G_0x602080_type zeroinitializer
@G__0x40105a = global %G__0x40105a_type zeroinitializer
...
entry:
  ...
  %42 = load i64, i64* bitcast (%G_0x428__rip__4197344__type* @G_0x428__rip__4197344_ to i64*), align 8
...
block_.L_400bf7:                                  ; preds = %block_.L_400cd2, %entry
  %88 = phi i64 [ %.pre, %entry ], [ %450, %block_.L_400cd2 ]
  %MEMORY.0 = phi %struct.Memory* [ %2, %entry ], [ %MEMORY.1, %block_.L_400cd2 ]
  ...
  br i1 %124, label %block_400c03, label %block_.L_400ce5
...
block_.L_400c0a:                                  ; preds = %block_.L_400cbf, %block_400c03
  %129 = phi i64 [ %.pre3, %block_400c03 ], [ %420, %block_.L_400cbf ]
  %MEMORY.1 = phi %struct.Memory* [ %MEMORY.0, %block_400c03 ], [ %329, %block_.L_400cbf ]
  ...
  br i1 %165, label %block_400c16, label %block_.L_400cd2
...
block_400c16:                                     ; preds = %block_.L_400c0a
  ...
  %278 = load i32, i32* bitcast (%G_0x3af__rip__4197473__type* @G_0x3af__rip__4197473_ to i32*), align 8
  %279 = load i32, i32* inttoptr (i64 add (i64 ptrtoint (%G_0x3af__rip__4197473__type* @G_0x3af__rip__4197473_ to i64), i64 4) to i32*), align 4
  %280 = load i32, i32* inttoptr (i64 add (i64 ptrtoint (%G_0x3af__rip__4197473__type* @G_0x3af__rip__4197473_ to i64), i64 8) to i32*), align 8
  %281 = load i32, i32* inttoptr (i64 add (i64 ptrtoint (%G_0x3af__rip__4197473__type* @G_0x3af__rip__4197473_ to i64), i64 12) to i32*), align 4
...
routine_ucomisd_MINUS0x28__rbp____xmm0.exit:      ; preds = %327, %315
  ...
  br i1 %333, label %block_.L_400cbf, label %block_400c7a

block_400c7a:                                     ; preds = %routine_ucomisd_MINUS0x28__rbp____xmm0.exit
  store i64 ptrtoint (%G__0x40105a_type* @G__0x40105a to i64), i64* %RSI.i143, align 8
...
block_.L_400cbf:                                  ; preds = %routine_ucomisd_MINUS0x28__rbp____xmm0.exit
...
block_.L_400cd2:                                  ; preds = %block_.L_400c0a
  %421 = add i64 %130, -28
  %422 = add i64 %166, 8
...
block_.L_400ce5:                                  ; preds = %block_.L_400bf7
  %451 = add i64 %89, -4
  %452 = add i64 %125, 7
...
block_.L_400cec:                                  ; preds = %block_.L_400ce5, %block_400c7a
  %454 = phi i64 [ %.pre5, %block_.L_400ce5 ], [ %389, %block_400c7a ]
  %MEMORY.2 = phi %struct.Memory* [ %MEMORY.0, %block_.L_400ce5 ], [ %376, %block_400c7a ]
...
block_400478:
  ...
  %5 = load i64, i64* bitcast (%G_0x428__rip__4197344__type* @G_0x428__rip__4197344_ to i64*), align 8
...
define %struct.Memory* @routine_jge_.L_400ce5(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i8* %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
...
define %struct.Memory* @routine_jge_.L_400cd2(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i8* %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 2, i32 9
...
define %struct.Memory* @routine_movaps_0x3af__rip____xmm1(%struct.State* dereferenceable(3376), i64, %struct.Memory*) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  ...
  %6 = add i64 %5, 7
  store i64 %6, i64* %PC, align 8
  %7 = load i32, i32* bitcast (%G_0x3af__rip__4197473__type* @G_0x3af__rip__4197473_ to i32*), align 8
  %8 = load i32, i32* inttoptr (i64 add (i64 ptrtoint (%G_0x3af__rip__4197473__type* @G_0x3af__rip__4197473_ to i64), i64 4) to i32*), align 4
  %9 = load i32, i32* inttoptr (i64 add (i64 ptrtoint (%G_0x3af__rip__4197473__type* @G_0x3af__rip__4197473_ to i64), i64 8) to i32*), align 8
  %10 = load i32, i32* inttoptr (i64 add (i64 ptrtoint (%G_0x3af__rip__4197473__type* @G_0x3af__rip__4197473_ to i64), i64 12) to i32*), align 4
...
define %struct.Memory* @routine_jbe_.L_400cbf(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i8* %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
...
define %struct.Memory* @routine_movq__0x40105a___rsi(%struct.State* dereferenceable(3376), i64, %struct.Memory*) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %RSI = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 9, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, 10
  store i64 %4, i64* %PC, align 8
  store i64 ptrtoint (%G__0x40105a_type* @G__0x40105a to i64), i64* %RSI, align 8
  ret %struct.Memory* %2
}
...
define %struct.Memory* @routine_jmpq_.L_400cec(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
...
define %struct.Memory* @routine_jmpq_.L_400cc4(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
...
define %struct.Memory* @routine_jmpq_.L_400c0a(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
...
define %struct.Memory* @routine_jmpq_.L_400cd7(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
