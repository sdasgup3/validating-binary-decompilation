...
block_.L_400c37:                                  ; preds = %block_.L_400d12, %entry
  %95 = phi i64 [ %.pre, %entry ], [ %464, %block_.L_400d12 ]
  %MEMORY.0 = phi %struct.Memory* [ %2, %entry ], [ %MEMORY.1, %block_.L_400d12 ]
  ...
  br i1 %131, label %block_400c43, label %block_.L_400d25
...
block_.L_400c4a:                                  ; preds = %block_.L_400cff, %block_400c43
  %136 = phi i64 [ %.pre29, %block_400c43 ], [ %434, %block_.L_400cff ]
  %MEMORY.1 = phi %struct.Memory* [ %MEMORY.0, %block_400c43 ], [ %343, %block_.L_400cff ]
  ...
  br i1 %172, label %block_400c56, label %block_.L_400d12
...
block_400c56:                                     ; preds = %block_.L_400c4a
  ...
  %286 = add i64 %276, add (i64 ptrtoint (%G_0x3af__rip__type* @G_0x3af__rip_ to i64), i64 10)
  %287 = add i64 %276, 17
  store i64 %287, i64* %3, align 8
  %288 = inttoptr i64 %286 to i32*
  %289 = load i32, i32* %288, align 4
  %290 = add i64 %276, add (i64 ptrtoint (%G_0x3af__rip__type* @G_0x3af__rip_ to i64), i64 14)
  %291 = inttoptr i64 %290 to i32*
  %292 = load i32, i32* %291, align 4
  %293 = add i64 %276, add (i64 ptrtoint (%G_0x3af__rip__type* @G_0x3af__rip_ to i64), i64 18)
  %294 = inttoptr i64 %293 to i32*
  %295 = load i32, i32* %294, align 4
  %296 = add i64 %276, add (i64 ptrtoint (%G_0x3af__rip__type* @G_0x3af__rip_ to i64), i64 22)
...
routine_ucomisd_MINUS0x28__rbp____xmm0.exit:      ; preds = %341, %329
  ...
  br i1 %347, label %block_.L_400cff, label %block_400cba

block_400cba:                                     ; preds = %routine_ucomisd_MINUS0x28__rbp____xmm0.exit
  store i64 ptrtoint (%G__0x40109a_type* @G__0x40109a to i64), i64* %RSI.i143, align 8
...
block_.L_400cff:                                  ; preds = %routine_ucomisd_MINUS0x28__rbp____xmm0.exit
...
block_.L_400d12:                                  ; preds = %block_.L_400c4a
  %435 = add i64 %137, -28
  %436 = add i64 %173, 8
...
block_.L_400d25:                                  ; preds = %block_.L_400c37
  %465 = add i64 %96, -4
  %466 = add i64 %132, 7
...
block_.L_400d2c:                                  ; preds = %block_.L_400d25, %block_400cba
  %468 = phi i64 [ %.pre31, %block_.L_400d25 ], [ %403, %block_400cba ]
  %MEMORY.2 = phi %struct.Memory* [ %MEMORY.0, %block_.L_400d25 ], [ %390, %block_400cba ]
