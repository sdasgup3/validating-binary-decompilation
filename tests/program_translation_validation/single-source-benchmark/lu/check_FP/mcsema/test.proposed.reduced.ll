; ModuleID = '/tmp/tmphscqakp_-query.ll'
...
@G__0x40109a = global %G__0x40109a_type zeroinitializer
...
entry:
  ...
  %var_2_42 = add i64 %var_2_10, add (i64 ptrtoint (%G_0x428__rip__type* @G_0x428__rip_ to i64), i64 7)
  ...
  br i1 %var_2_13122, label %block_400c43.preheader, label %block_.L_400d2c

block_400c43.preheader:                           ; preds = %entry
  br label %block_400c43

block_.L_400c37.loopexit.loopexit:                ; preds = %routine_ucomisd_MINUS0x28__rbp____xmm0.exit.block_.L_400c4a_crit_edge
  br label %block_.L_400c37.loopexit

block_.L_400c37.loopexit:                         ; preds = %block_.L_400c37.loopexit.loopexit, %block_400c43
  %var_2_137.lcssa = phi i64 [ %var_2_1379, %block_400c43 ], [ %var_2_137.pre, %block_.L_400c37.loopexit.loopexit ]
  %MEMORY.1.lcssa = phi %struct.Memory* [ %MEMORY.023, %block_400c43 ], [ %var_2_343, %block_.L_400c37.loopexit.loopexit ]
  %var_2_146.lcssa = phi i32 [ %var_2_14624, %block_400c43 ], [ %var_2_146, %block_.L_400c37.loopexit.loopexit ]
  %var_2_165.lcssa = phi i32 [ %var_2_16528, %block_400c43 ], [ %var_2_165, %block_.L_400c37.loopexit.loopexit ]
  ...
  br i1 %var_2_131, label %block_400c43, label %block_.L_400d2c.loopexit

block_400c43:                                     ; preds = %block_400c43.preheader, %block_.L_400c37.loopexit
  %var_2_1379 = phi i64 [ %var_2_137.lcssa, %block_.L_400c37.loopexit ], [ %var_2_966, %block_400c43.preheader ]
  %MEMORY.023 = phi %struct.Memory* [ %MEMORY.1.lcssa, %block_.L_400c37.loopexit ], [ %2, %block_400c43.preheader ]
  ...
  br i1 %var_2_17234, label %block_400c56.preheader, label %block_.L_400c37.loopexit

block_400c56.preheader:                           ; preds = %block_400c43
  br label %block_400c56

block_400c56:                                     ; preds = %block_400c56.preheader, %routine_ucomisd_MINUS0x28__rbp____xmm0.exit.block_.L_400c4a_crit_edge
  %MEMORY.136 = phi %struct.Memory* [ %var_2_343, %routine_ucomisd_MINUS0x28__rbp____xmm0.exit.block_.L_400c4a_crit_edge ], [ %MEMORY.023, %block_400c56.preheader ]
  %var_2_13735 = phi i64 [ %var_2_137.pre, %routine_ucomisd_MINUS0x28__rbp____xmm0.exit.block_.L_400c4a_crit_edge ], [ %var_2_1379, %block_400c56.preheader ]
  %var_2_275 = add i64 %var_2_13735, -48
  ...
  %var_2_280 = add i64 %var_2_13735, -56
  ...
  %var_2_286 = add i64 %var_2_276, add (i64 ptrtoint (%G_0x3af__rip__type* @G_0x3af__rip_ to i64), i64 10)
  ...
  %var_2_290 = add i64 %var_2_276, add (i64 ptrtoint (%G_0x3af__rip__type* @G_0x3af__rip_ to i64), i64 14)
  %var_2_291 = inttoptr i64 %var_2_290 to i32*
  %var_2_292 = load i32, i32* %var_2_291, align 4
  %var_2_293 = add i64 %var_2_276, add (i64 ptrtoint (%G_0x3af__rip__type* @G_0x3af__rip_ to i64), i64 18)
  %var_2_294 = inttoptr i64 %var_2_293 to i32*
  %var_2_295 = load i32, i32* %var_2_294, align 4
  %var_2_296 = add i64 %var_2_276, add (i64 ptrtoint (%G_0x3af__rip__type* @G_0x3af__rip_ to i64), i64 22)
...
var_2_329:                                        ; preds = %var_2_321
  %var_2_330 = tail call %struct.Memory* @__remill_error(%struct.State* nonnull dereferenceable(3376) %0, i64 %var_2_316, %struct.Memory* %MEMORY.136)
  br label %routine_ucomisd_MINUS0x28__rbp____xmm0.exit

routine_ucomisd_MINUS0x28__rbp____xmm0.exit:      ; preds = %var_2_329, %var_2_321, %block_400c56
  %var_2_343 = phi %struct.Memory* [ %var_2_330, %var_2_329 ], [ %MEMORY.136, %var_2_321 ], [ %MEMORY.136, %block_400c56 ]
  ...
  br i1 %var_2_347, label %block_400cba, label %routine_ucomisd_MINUS0x28__rbp____xmm0.exit.block_.L_400c4a_crit_edge

routine_ucomisd_MINUS0x28__rbp____xmm0.exit.block_.L_400c4a_crit_edge: ; preds = %routine_ucomisd_MINUS0x28__rbp____xmm0.exit
  ...
  br i1 %var_2_172, label %block_400c56, label %block_.L_400c37.loopexit.loopexit

block_400cba:                                     ; preds = %routine_ucomisd_MINUS0x28__rbp____xmm0.exit
  %var_2_390 = tail call %struct.Memory* @__remill_function_call(%struct.State* nonnull %0, i64 ptrtoint (i64 (i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64)* @fprintf to i64), %struct.Memory* %var_2_343)
  br label %block_.L_400d2c

block_.L_400d2c.loopexit:                         ; preds = %block_.L_400c37.loopexit
  br label %block_.L_400d2c

block_.L_400d2c:                                  ; preds = %block_.L_400d2c.loopexit, %block_400cba, %entry
  %MEMORY.2 = phi %struct.Memory* [ %var_2_390, %block_400cba ], [ %2, %entry ], [ %MEMORY.1.lcssa, %block_.L_400d2c.loopexit ]
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_movaps_0x3af__rip____xmm1(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 1, i64 1
  %4 = bitcast %union.VectorReg* %3 to i8*
  %5 = load i64, i64* %PC, align 8
  %6 = add i64 %5, ptrtoint (%G_0x3af__rip__type* @G_0x3af__rip_ to i64)
  %7 = add i64 %5, 7
  store i64 %7, i64* %PC, align 8
  %8 = inttoptr i64 %6 to i32*
  %9 = load i32, i32* %8, align 4
  %10 = add i64 %5, add (i64 ptrtoint (%G_0x3af__rip__type* @G_0x3af__rip_ to i64), i64 4)
  %11 = inttoptr i64 %10 to i32*
  %12 = load i32, i32* %11, align 4
  %13 = add i64 %5, add (i64 ptrtoint (%G_0x3af__rip__type* @G_0x3af__rip_ to i64), i64 8)
  %14 = inttoptr i64 %13 to i32*
  %15 = load i32, i32* %14, align 4
  %16 = add i64 %5, add (i64 ptrtoint (%G_0x3af__rip__type* @G_0x3af__rip_ to i64), i64 12)
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_jbe_.L_400cff(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i8* nocapture %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_movq__0x40109a___rsi(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %RSI = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 9, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  ...
  store i64 ptrtoint (%G__0x40109a_type* @G__0x40109a to i64), i64* %RSI, align 8
  ret %struct.Memory* %2
}
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_jmpq_.L_400d2c(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_jmpq_.L_400c4a(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
