...
declare %struct.Memory* @sub_400e10.print_element(%struct.State* noalias dereferenceable(3376), i64, %struct.Memory* noalias readnone returned) local_unnamed_addr
...
block_.L_400d7c:                                  ; preds = %block_.L_400dd2, %entry
  %124 = phi i64 [ %.pre, %entry ], [ %355, %block_.L_400dd2 ]
  %MEMORY.0 = phi %struct.Memory* [ %79, %entry ], [ %317, %block_.L_400dd2 ]
  ...
  br i1 %160, label %block_400d88, label %block_.L_400df4

block_400d88:                                     ; preds = %block_.L_400d7c
  %162 = add i64 %125, -24
  %163 = add i64 %161, 7
...
block_.L_400d8f:                                  ; preds = %block_400d9b, %block_400d88
  %165 = phi i64 [ %306, %block_400d9b ], [ %.pre9, %block_400d88 ]
  ...
  br i1 %201, label %block_400d9b, label %block_.L_400dd2

block_400d9b:                                     ; preds = %block_.L_400d8f
  %203 = add i64 %166, -16
  %204 = add i64 %202, 4
  ...
  %call2_400dbf = tail call %struct.Memory* @sub_400e10.print_element(%struct.State* nonnull %0, i64 %270, %struct.Memory* %MEMORY.0)
...
block_.L_400dd2:                                  ; preds = %block_.L_400d8f
  %307 = add i64 %166, -32
  %308 = add i64 %202, 4
...
block_.L_400df4:                                  ; preds = %block_.L_400d7c
  %356 = add i64 %125, -32
  %357 = add i64 %161, 4
...
; Function Attrs: alwaysinline norecurse nounwind
define %struct.Memory* @routine_jge_.L_400df4(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i8* nocapture %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
...
; Function Attrs: alwaysinline norecurse nounwind
define %struct.Memory* @routine_jmpq_.L_400d7c(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
