...
declare %struct.Memory* @sub_400e00.print_element(%struct.State* noalias dereferenceable(3376), i64, %struct.Memory* noalias readnone returned) local_unnamed_addr
...
entry:
  ...
  %call2_400d4b = tail call %struct.Memory* @sub_400640.malloc_plt(%struct.State* %0, i64 %74, %struct.Memory* %2)
...
block_.L_400d6c:                                  ; preds = %block_.L_400dc2, %entry
  %123 = phi i64 [ %353, %block_.L_400dc2 ], [ %.pre, %entry ]
  ...
  br i1 %159, label %block_400d78, label %block_.L_400de4
...
block_.L_400d7f:                                  ; preds = %block_400d8b, %block_400d78
  %164 = phi i64 [ %305, %block_400d8b ], [ %.pre9, %block_400d78 ]
  ...
  br i1 %200, label %block_400d8b, label %block_.L_400dc2

block_400d8b:                                     ; preds = %block_.L_400d7f
  %202 = add i64 %165, -16
  %203 = add i64 %201, 4
  ...
  %call2_400daf = tail call %struct.Memory* @sub_400e00.print_element(%struct.State* nonnull %0, i64 %269, %struct.Memory* %call2_400d4b)
...
block_.L_400dc2:                                  ; preds = %block_.L_400d7f
  %306 = add i64 %165, -32
  %307 = add i64 %201, 4
  ...
  %call2_400dce = tail call %struct.Memory* @sub_400610.fputs_plt(%struct.State* nonnull %0, i64 %311, %struct.Memory* %call2_400d4b)
...
block_.L_400de4:                                  ; preds = %block_.L_400d6c
  %354 = add i64 %124, -32
  %355 = add i64 %160, 4
  ...
  %call2_400de8 = tail call %struct.Memory* @sub_4005f0.free_plt(%struct.State* nonnull %0, i64 %358, %struct.Memory* %call2_400d4b)
  ...
  ret %struct.Memory* %call2_400de8
}
