...
declare %struct.Memory* @sub_400e00.print_element(%struct.State* dereferenceable(3376), i64, %struct.Memory*) local_unnamed_addr
...
block_.L_400d6c:                                  ; preds = %block_.L_400dc2, %entry
  %123 = phi i64 [ %.pre, %entry ], [ %353, %block_.L_400dc2 ]
  %MEMORY.0 = phi %struct.Memory* [ %call2_400d4b, %entry ], [ %call2_400dce, %block_.L_400dc2 ]
...
block_.L_400d7f:                                  ; preds = %block_400d8b, %block_400d78
  %164 = phi i64 [ %.pre9, %block_400d78 ], [ %305, %block_400d8b ]
  %MEMORY.1 = phi %struct.Memory* [ %MEMORY.0, %block_400d78 ], [ %call2_400daf, %block_400d8b ]
...
block_400d8b:                                     ; preds = %block_.L_400d7f
  ...
  %call2_400daf = tail call %struct.Memory* @sub_400e00.print_element(%struct.State* nonnull %0, i64 %269, %struct.Memory* %MEMORY.1)
...
block_.L_400dc2:                                  ; preds = %block_.L_400d7f
  ...
  %call2_400dce = tail call %struct.Memory* @sub_400610.fputs_plt(%struct.State* nonnull %0, i64 %311, %struct.Memory* %MEMORY.1)
...
block_.L_400de4:                                  ; preds = %block_.L_400d6c
  ...
  %call2_400de8 = tail call %struct.Memory* @sub_4005f0.free_plt(%struct.State* nonnull %0, i64 %358, %struct.Memory* %MEMORY.0)
