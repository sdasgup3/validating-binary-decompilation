...
block_.L_400d6c:                                  ; preds = %block_.L_400dc2, %entry
  %124 = phi i64 [ %.pre, %entry ], [ %355, %block_.L_400dc2 ]
  %MEMORY.0 = phi %struct.Memory* [ %79, %entry ], [ %317, %block_.L_400dc2 ]
  ...
  br i1 %160, label %block_400d78, label %block_.L_400de4
...
block_.L_400d7f:                                  ; preds = %block_400d8b, %block_400d78
  %165 = phi i64 [ %306, %block_400d8b ], [ %.pre9, %block_400d78 ]
  ...
  br i1 %201, label %block_400d8b, label %block_.L_400dc2
...
block_400d8b:                                     ; preds = %block_.L_400d7f
  ...
  %call2_400daf = tail call %struct.Memory* @sub_400e00.print_element(%struct.State* nonnull %0, i64 %270, %struct.Memory* %MEMORY.0)
