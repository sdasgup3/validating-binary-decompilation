; ModuleID = '/tmp/tmpj_ffe21s-query.ll'
...
entry:
  ...
  br i1 %var_2_16034, label %block_400d88.preheader, label %block_.L_400df4

block_400d88.preheader:                           ; preds = %entry
  br label %block_400d88

block_400d88:                                     ; preds = %block_400d88.preheader, %block_.L_400dd2
  %var_2_175 = phi i32 [ %var_2_134, %block_.L_400dd2 ], [ %var_2_13424, %block_400d88.preheader ]
  %var_2_1661 = phi i64 [ %var_2_125, %block_.L_400dd2 ], [ %var_2_12518, %block_400d88.preheader ]
  %MEMORY.035 = phi %struct.Memory* [ %var_2_317, %block_.L_400dd2 ], [ %var_2_79, %block_400d88.preheader ]
  ...
  br i1 %var_2_20117, label %block_400d9b.preheader, label %block_.L_400dd2

block_400d9b.preheader:                           ; preds = %block_400d88
  br label %block_400d9b

block_400d9b:                                     ; preds = %block_400d9b.preheader, %block_400d9b
  br label %block_400d9b

block_.L_400dd2:                                  ; preds = %block_400d88
  ...
  br i1 %var_2_160, label %block_400d88, label %block_.L_400df4.loopexit

block_.L_400df4.loopexit:                         ; preds = %block_.L_400dd2
  br label %block_.L_400df4

block_.L_400df4:                                  ; preds = %block_.L_400df4.loopexit, %entry
  %MEMORY.0.lcssa = phi %struct.Memory* [ %var_2_79, %entry ], [ %var_2_317, %block_.L_400df4.loopexit ]
