...
declare %struct.Memory* @sub_400660.posix_memalign_plt(%struct.State* dereferenceable(3376), i64, %struct.Memory*) local_unnamed_addr

declare %struct.Memory* @sub_400630.fprintf_plt(%struct.State* dereferenceable(3376), i64, %struct.Memory*) local_unnamed_addr

declare %struct.Memory* @sub_400650.exit_plt(%struct.State* dereferenceable(3376), i64, %struct.Memory*) local_unnamed_addr
