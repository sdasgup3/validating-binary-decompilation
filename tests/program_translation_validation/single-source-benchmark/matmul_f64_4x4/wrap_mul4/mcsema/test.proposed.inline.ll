...
define %struct.Memory* @wrap_mul4(%struct.State* noalias, i64, %struct.Memory* noalias) #2 {
entry:
  ...
  %RDX.i13 = bitcast %union.anon* %102 to i64*
  ...
  %RDX.i = bitcast %union.anon* %147 to i64*
  ...
  store i64 %156, i64* %RDX.i, align 8
  ...
  store %struct.Memory* %loadMem1_400550, %struct.Memory** %MEMORY
  ...
  ret %struct.Memory* %loadMem_40055a
}
