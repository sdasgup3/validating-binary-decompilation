...
declare %struct.Memory* @sub_400650.memset_plt(%struct.State* dereferenceable(3376), i64, %struct.Memory*)
declare %struct.Memory* @sub_400670.malloc_plt(%struct.State* dereferenceable(3376), i64, %struct.Memory*)
