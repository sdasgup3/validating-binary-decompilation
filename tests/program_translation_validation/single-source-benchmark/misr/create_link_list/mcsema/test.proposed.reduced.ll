; ModuleID = '/tmp/tmpdmsipv0y-query.ll'
...
entry:
  ...
  %var_2_33 = tail call %struct.Memory* @__remill_function_call(%struct.State* %0, i64 ptrtoint (i64 (i64, i64, i64)* @memset to i64), %struct.Memory* %2)
  %var_2_491 = load i64, i64* %RBP.i, align 8
  %var_2_502 = add i64 %var_2_491, -12
  %var_2_523 = inttoptr i64 %var_2_502 to i32*
  %var_2_534 = load i32, i32* %var_2_523, align 4
  %var_2_555 = load i32, i32* bitcast (%G_0x602074_type* @G_0x602074 to i32*), align 8
  %var_2_566 = add i32 %var_2_555, 1
  %var_2_587 = lshr i32 %var_2_566, 31
  %var_2_598 = sub i32 %var_2_534, %var_2_566
  %var_2_749 = lshr i32 %var_2_598, 31
  %var_2_7610 = lshr i32 %var_2_534, 31
  %var_2_7711 = xor i32 %var_2_587, %var_2_7610
  %var_2_7812 = xor i32 %var_2_749, %var_2_7610
  %var_2_7913 = add nuw nsw i32 %var_2_7812, %var_2_7711
  %var_2_8014 = icmp eq i32 %var_2_7913, 2
  %var_2_8215 = icmp ne i32 %var_2_749, 0
  %var_2_8316 = xor i1 %var_2_8215, %var_2_8014
  br i1 %var_2_8316, label %block_400b92.preheader, label %block_.L_400be9

block_400b92.preheader:                           ; preds = %entry
  br label %block_400b92

block_400b92:                                     ; preds = %block_400b92.preheader, %block_400b92
  %MEMORY.017 = phi %struct.Memory* [ %var_2_90, %block_400b92 ], [ %var_2_33, %block_400b92.preheader ]
  %var_2_90 = tail call %struct.Memory* @__remill_function_call(%struct.State* nonnull %0, i64 ptrtoint (i64 (i64)* @malloc to i64), %struct.Memory* %MEMORY.017)
  %var_2_49 = load i64, i64* %RBP.i, align 8
  %var_2_50 = add i64 %var_2_49, -12
  %var_2_52 = inttoptr i64 %var_2_50 to i32*
  %var_2_53 = load i32, i32* %var_2_52, align 4
  %var_2_55 = load i32, i32* bitcast (%G_0x602074_type* @G_0x602074 to i32*), align 8
  %var_2_56 = add i32 %var_2_55, 1
  %var_2_58 = lshr i32 %var_2_56, 31
  %var_2_59 = sub i32 %var_2_53, %var_2_56
  %var_2_74 = lshr i32 %var_2_59, 31
  %var_2_76 = lshr i32 %var_2_53, 31
  %var_2_77 = xor i32 %var_2_58, %var_2_76
  %var_2_78 = xor i32 %var_2_74, %var_2_76
  %var_2_79 = add nuw nsw i32 %var_2_78, %var_2_77
  %var_2_80 = icmp eq i32 %var_2_79, 2
  %var_2_82 = icmp ne i32 %var_2_74, 0
  %var_2_83 = xor i1 %var_2_82, %var_2_80
  br i1 %var_2_83, label %block_400b92, label %block_.L_400be9.loopexit

block_.L_400be9.loopexit:                         ; preds = %block_400b92
  br label %block_.L_400be9

block_.L_400be9:                                  ; preds = %block_.L_400be9.loopexit, %entry
  %MEMORY.0.lcssa = phi %struct.Memory* [ %var_2_33, %entry ], [ %var_2_90, %block_.L_400be9.loopexit ]
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_jge_.L_400be9(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i8* nocapture %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_jmpq_.L_400b7d(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
