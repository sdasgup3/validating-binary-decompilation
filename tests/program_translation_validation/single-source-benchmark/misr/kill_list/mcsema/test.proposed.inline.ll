...
block_400fc7:                                     ; preds = %block_.L_400fbc
  ...
  store %struct.Memory* %loadMem1_400fda, %struct.Memory** %MEMORY
  %loadMem2_400fda = load %struct.Memory*, %struct.Memory** %MEMORY
  %loadPC_400fda = load i64, i64* %3
  %212 = call %struct.Memory* @__remill_function_call(%struct.State* %0, i64 ptrtoint (i64 (i64)* @free to i64), %struct.Memory* %loadMem2_400fda)
...
block_.L_400fec:                                  ; preds = %block_.L_400fbc
  ...
  ret %struct.Memory* %loadMem_400ff1
}
