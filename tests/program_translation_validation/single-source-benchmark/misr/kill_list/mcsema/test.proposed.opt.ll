...
define %struct.Memory* @kill_list(%struct.State* noalias, i64, %struct.Memory* noalias) local_unnamed_addr #1 {
entry:
  ...
  %40 = add i64 %7, -16
  %41 = load i64, i64* %RDI.i32, align 8
  %42 = add i64 %10, 11
...
block_.L_400fbc:                                  ; preds = %block_400fc7, %entry
  %44 = phi i64 [ %.pre, %entry ], [ %92, %block_400fc7 ]
  %MEMORY.0 = phi %struct.Memory* [ %2, %entry ], [ %81, %block_400fc7 ]
  ...
  br i1 %56, label %block_.L_400fec, label %block_400fc7

block_400fc7:                                     ; preds = %block_.L_400fbc
  %61 = add i64 %60, 4
  ...
  store i64 %66, i64* %RAX.i26, align 8
  %67 = add i64 %45, -16
  %68 = add i64 %60, 12
  ...
  store i64 %75, i64* %RAX.i26, align 8
  store i64 %75, i64* %RDI.i32, align 8
  %76 = add i64 %72, -2547
  %77 = add i64 %72, 12
  ...
  %81 = tail call %struct.Memory* @__remill_function_call(%struct.State* %0, i64 ptrtoint (i64 (i64)* @free to i64), %struct.Memory* %MEMORY.0)
  ...
  store i64 %87, i64* %RAX.i26, align 8
  %88 = add i64 %82, -8
  %89 = add i64 %84, 8
...
block_.L_400fec:                                  ; preds = %block_.L_400fbc
  %93 = load i64, i64* %RSP.i12, align 8
  %94 = add i64 %93, 16
  store i64 %94, i64* %RSP.i12, align 8
...
define %struct.Memory* @routine_je_.L_400fec(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i8* %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
