...
block_400f13:                                     ; preds = %block_.L_400f07
  ...
  %428 = load float, float* bitcast (%G_0x3d8__rip__type* @G_0x3d8__rip_ to float*)
  %429 = load float, float* inttoptr (i64 add (i64 ptrtoint (%G_0x3d8__rip__type* @G_0x3d8__rip_ to i64), i64 4) to float*)
  %430 = load float, float* inttoptr (i64 add (i64 ptrtoint (%G_0x3d8__rip__type* @G_0x3d8__rip_ to i64), i64 8) to float*)
  %431 = load float, float* inttoptr (i64 add (i64 ptrtoint (%G_0x3d8__rip__type* @G_0x3d8__rip_ to i64), i64 12) to float*)
...
block_400478:
  ...
  %9 = load i64, i64* %PC
  %10 = ptrtoint %G_0x3d8__rip__type* @G_0x3d8__rip_ to i64
  %11 = load i64, i64* %PC
  %12 = add i64 %11, 7
  store i64 %12, i64* %PC
