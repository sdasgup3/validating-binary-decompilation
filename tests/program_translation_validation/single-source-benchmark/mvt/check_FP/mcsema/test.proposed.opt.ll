...
block_.L_400f27:                                  ; preds = %block_.L_400fbe, %entry
  %95 = phi i64 [ %.pre, %entry ], [ %316, %block_.L_400fbe ]
...
block_400f81:                                     ; preds = %routine_ucomisd_MINUS0x28__rbp____xmm0.exit
  store i64 4199306, i64* %RSI.i102, align 8
  ...
  %call2_400faa = tail call %struct.Memory* @sub_400630.fprintf_plt(%struct.State* nonnull %0, i64 %268, %struct.Memory* %236)
...
block_.L_400fd8:                                  ; preds = %block_.L_400fd1, %block_400f81
  %320 = phi i64 [ %.pre22, %block_.L_400fd1 ], [ %285, %block_400f81 ]
  %MEMORY.1 = phi %struct.Memory* [ %MEMORY.0, %block_.L_400fd1 ], [ %call2_400faa, %block_400f81 ]
