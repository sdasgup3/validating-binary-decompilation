; ModuleID = '/tmp/tmpfewleu79-query.ll'
...
block_.L_400f37:                                  ; preds = %routine_ucomisd_MINUS0x28__rbp____xmm0.exit, %entry
  ...
  br i1 %var_2_131, label %block_400f43, label %block_.L_400fe8
...
routine_ucomisd_MINUS0x28__rbp____xmm0.exit:      ; preds = %var_2_222, %var_2_214, %block_400f43
  ...
  br i1 %var_2_240, label %block_.L_400fe8, label %block_.L_400f37

block_.L_400fe8:                                  ; preds = %routine_ucomisd_MINUS0x28__rbp____xmm0.exit, %block_.L_400f37
