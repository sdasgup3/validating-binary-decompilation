...
block_.L_400b52:                                  ; preds = %block_.L_400c5e, %entry
  %97 = phi i64 [ %435, %block_.L_400c5e ], [ %.pre, %entry ]
  ...
  br i1 %133, label %block_400b5e, label %block_.L_400c71
...
block_.L_400c0f:                                  ; preds = %block_400c1b, %block_400b5e
  %280 = phi i64 [ %405, %block_400c1b ], [ %.pre4, %block_400b5e ]
  ...
  br i1 %316, label %block_400c1b, label %block_.L_400c5e
...
block_.L_400c5e:                                  ; preds = %block_.L_400c0f
  %406 = add i64 %281, -68
  %407 = add i64 %317, 8
...
block_.L_400c71:                                  ; preds = %block_.L_400b52
  %436 = add i64 %134, 1
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_jge_.L_400c5e(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i8* nocapture %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 2, i32 9
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_jmpq_.L_400c63(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
