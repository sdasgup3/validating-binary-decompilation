...
define %struct.Memory* @kernel_mvt(%struct.State* noalias, i64, %struct.Memory* noalias) #2 {
entry:
...
block_.L_400c82:                                  ; preds = %block_.L_400cfa, %entry
  ...
  br i1 %cmpBr_400c88, label %block_.L_400d08, label %block_400c8e
...
block_.L_400c95:                                  ; preds = %block_400ca1, %block_400c8e
  ...
  br i1 %cmpBr_400c9b, label %block_.L_400cf5, label %block_400ca1
...
block_.L_400cfa:                                  ; preds = %block_.L_400cf5
...
block_.L_400d0f:                                  ; preds = %block_.L_400d87, %block_.L_400d08
  ...
  %loadBr_400d15 = load i8, i8* %BRANCH_TAKEN
  %cmpBr_400d15 = icmp eq i8 %loadBr_400d15, 1
  br i1 %cmpBr_400d15, label %block_.L_400d95, label %block_400d1b
...
block_.L_400d22:                                  ; preds = %block_400d2e, %block_400d1b
  ...
  br i1 %cmpBr_400d28, label %block_.L_400d82, label %block_400d2e
...
block_.L_400d95:                                  ; preds = %block_.L_400d0f
  ...
  ret %struct.Memory* %loadMem_400d96
}
