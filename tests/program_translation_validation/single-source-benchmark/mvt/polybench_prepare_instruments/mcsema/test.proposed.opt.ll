...
declare %struct.Memory* @sub_400770.polybench_flush_cache(%struct.State* noalias dereferenceable(3376), i64, %struct.Memory* noalias readnone returned) local_unnamed_addr
...
entry:
  ...
  %call2_4007f4 = tail call %struct.Memory* @sub_400770.polybench_flush_cache(%struct.State* %0, i64 %11, %struct.Memory* %2)
