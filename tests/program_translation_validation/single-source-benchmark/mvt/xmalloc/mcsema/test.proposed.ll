...
block_.L_400903:
  ...
  ; Code: movq $0x401357, %rsi	 RIP: 400903	 Bytes: 10
  %loadMem_400903 = load %struct.Memory*, %struct.Memory** %MEMORY
  %call_400903 = call %struct.Memory* @routine_movq__0x401357___rsi(%struct.State* %0, i64  0, %struct.Memory* %loadMem_400903)
...
block_400488:
  ...
  %10 = add i64 %9, 10
  store i64 %10, i64* %PC
  %11 = call %struct.Memory* @_ZN12_GLOBAL__N_1L3MOVI3RnWImE2InImEEEP6MemoryS6_R5StateT_T0_(%struct.Memory* %2, %struct.State* %0, i64* %RSI, i64 4199255)
  ret %struct.Memory* %11
}
