...
define %struct.Memory* @xmalloc(%struct.State* noalias, i64, %struct.Memory* noalias) local_unnamed_addr #1 {
entry:
  ...
  %RAX.i31 = getelementptr inbounds %union.anon, %union.anon* %39, i64 0, i32 0
  %40 = add i64 %7, -24
  store i64 %40, i64* %RAX.i31, align 8
  %RCX.i = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 5, i32 0, i32 0
  store i64 32, i64* %RCX.i, align 8
  %RSI.i45 = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 9, i32 0, i32 0
  store i64 32, i64* %RSI.i45, align 8
  ...
  store i64 %55, i64* %RDX.i, align 8
  %56 = load i64, i64* %RAX.i31, align 8
  store i64 %56, i64* %RDI.i42, align 8
  %57 = add i64 %52, -639
  %58 = add i64 %52, 12
  ...
  %62 = tail call %struct.Memory* @__remill_function_call(%struct.State* %0, i64 ptrtoint (i64 (i64, i64, i64)* @posix_memalign to i64), %struct.Memory* %2)
  %EAX.i28 = bitcast %union.anon* %39 to i32*
  %63 = load i64, i64* %RBP.i, align 8
  %64 = add i64 %63, -20
  %65 = load i32, i32* %EAX.i28, align 4
  ...
  br i1 %81, label %block_.L_4008d3, label %block_4008c9
...
block_4008c9:                                     ; preds = %entry
  ...
  store i8 0, i8* %38, align 1
  %.v2 = select i1 %95, i64 48, i64 10
  %99 = add i64 %85, %.v2
  store i64 %99, i64* %3, align 8
  br i1 %95, label %block_.L_4008f9, label %block_.L_4008d3

block_.L_4008d3:                                  ; preds = %block_4008c9, %entry
  %100 = phi i64 [ %99, %block_4008c9 ], [ %85, %entry ]
  store i64 ptrtoint (%G__0x401337_type* @G__0x401337 to i64), i64* %RSI.i45, align 8
  %101 = load i64, i64* bitcast (%G_0x602080_type* @G_0x602080 to i64*), align 8
  store i64 %101, i64* %RDI.i42, align 8
  ...
  %107 = tail call %struct.Memory* @__remill_function_call(%struct.State* %0, i64 ptrtoint (i64 (i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64)* @fprintf to i64), %struct.Memory* %62)
  %108 = load i64, i64* %PC.i, align 8
  store i64 1, i64* %RDI.i42, align 8
  %109 = load i64, i64* %RBP.i, align 8
  %110 = add i64 %109, -24
  %111 = load i32, i32* %EAX.i28, align 4
  %112 = add i64 %108, 8
  ...
  %120 = tail call %struct.Memory* @__remill_function_call(%struct.State* %0, i64 ptrtoint (i64 (i64)* @exit to i64), %struct.Memory* %107)
  %.pre = load i64, i64* %RBP.i, align 8
  %.pre1 = load i64, i64* %PC.i, align 8
  br label %block_.L_4008f9

block_.L_4008f9:                                  ; preds = %block_.L_4008d3, %block_4008c9
  %121 = phi i64 [ %.pre1, %block_.L_4008d3 ], [ %99, %block_4008c9 ]
  %122 = phi i64 [ %.pre, %block_.L_4008d3 ], [ %69, %block_4008c9 ]
  %MEMORY.1 = phi %struct.Memory* [ %120, %block_.L_4008d3 ], [ %62, %block_4008c9 ]
  %123 = add i64 %122, -16
  %124 = add i64 %121, 4
...
define %struct.Memory* @routine_callq_.posix_memalign_plt(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
...
define %struct.Memory* @routine_je_.L_4008d3(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i8* %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
...
define %struct.Memory* @routine_je_.L_4008f9(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i8* %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 2, i32 7
...
define %struct.Memory* @routine_movq__0x401337___rsi(%struct.State* dereferenceable(3376), i64, %struct.Memory*) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %RSI = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 9, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
