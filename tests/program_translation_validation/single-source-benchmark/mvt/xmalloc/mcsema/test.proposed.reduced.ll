; ModuleID = '/tmp/tmpl_zbuvsz-query.ll'
...
entry:
  ...
  br i1 %var_2_81, label %block_.L_400913, label %block_400909
...
block_400909:                                     ; preds = %entry
  ...
  br i1 %var_2_95, label %block_.L_400939, label %block_.L_400913
...
block_.L_400939:                                  ; preds = %block_.L_400913, %block_400909
  %var_2_121 = phi i64 [ %.pre2, %block_.L_400913 ], [ %var_2_99, %block_400909 ]
  %var_2_122 = phi i64 [ %.pre, %block_.L_400913 ], [ %var_2_69, %block_400909 ]
  %MEMORY.1 = phi %struct.Memory* [ %var_2_120, %block_.L_400913 ], [ %var_2_62, %block_400909 ]
