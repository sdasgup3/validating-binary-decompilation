...
%G_0x32ab__rip__type = type <{ [8 x i8] }>
...
@G_0x32ab__rip_ = local_unnamed_addr global %G_0x32ab__rip__type zeroinitializer
...
entry:
  ...
  %EAX.i31 = bitcast %union.anon* %18 to i32*
  ...
  store i64 0, i64* %RSI.i29, align 8
  %19 = add i64 %10, -1857
  %20 = add i64 %10, 20
  %21 = add i64 %7, -48
  ...
  %23 = tail call %struct.Memory* @__remill_function_call(%struct.State* %0, i64 ptrtoint (i64 (i64, i64)* @gettimeofday to i64), %struct.Memory* %2)
  %24 = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 1
  %25 = bitcast [32 x %union.VectorReg]* %24 to i8*
  %26 = load i64, i64* %PC.i, align 8
  %27 = load double, double* bitcast (%G_0x32ab__rip__type* @G_0x32ab__rip_ to double*), align 8
  %28 = bitcast [32 x %union.VectorReg]* %24 to double*
  ...
  store i64 %42, i64* %RSI.i29, align 8
  %43 = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 1, i64 2
  %44 = sitofp i64 %42 to double
  %45 = bitcast %union.VectorReg* %43 to double*
  %46 = fmul double %44, %27
  store double %46, double* %45, align 1
  ...
  %50 = fadd double %37, %46
  store double %50, double* %38, align 1
  %51 = bitcast double %50 to <2 x i32>
  %52 = extractelement <2 x i32> %51, i32 0
  %53 = bitcast [32 x %union.VectorReg]* %24 to i32*
  ...
  %58 = bitcast i64* %29 to i32*
  store i32 %57, i32* %58, align 1
  %59 = extractelement <2 x i32> %49, i32 1
  %60 = getelementptr inbounds i8, i8* %25, i64 12
  ...
  %66 = load i64, i64* %RSP.i24, align 8
  %67 = load i64, i64* %PC.i, align 8
  %68 = add i64 %66, 32
  store i64 %68, i64* %RSP.i24, align 8
...
define %struct.Memory* @routine_movsd_0x32ab__rip____xmm0(%struct.State* dereferenceable(3376), i64, %struct.Memory*) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, 8
  store i64 %4, i64* %PC, align 8
  %5 = load i64, i64* bitcast (%G_0x32ab__rip__type* @G_0x32ab__rip_ to i64*), align 8
