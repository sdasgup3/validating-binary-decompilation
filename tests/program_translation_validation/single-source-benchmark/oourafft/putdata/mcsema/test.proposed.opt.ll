...
@G_0x30d9__rip_ = local_unnamed_addr global %G_0x30d9__rip__type zeroinitializer
...
block_.L_400fcb:                                  ; preds = %routine_idivl__ecx.exit, %entry
  %61 = phi i64 [ %.pre, %entry ], [ %220, %routine_idivl__ecx.exit ]
  %MEMORY.0 = phi %struct.Memory* [ %2, %entry ], [ %165, %routine_idivl__ecx.exit ]
...
block_400fd7:                                     ; preds = %block_.L_400fcb
  %99 = load i64, i64* bitcast (%G_0x30d9__rip__type* @G_0x30d9__rip_ to i64*), align 8
  %100 = getelementptr inbounds [32 x %union.VectorReg], [32 x %union.VectorReg]* %51, i64 0, i64 0, i32 0, i32 0, i32 0, i64 0
...
; <label>:155:                                    ; preds = %block_400fd7
  %156 = tail call %struct.Memory* @__remill_error(%struct.State* nonnull dereferenceable(3376) %0, i64 %146, %struct.Memory* %MEMORY.0)
...
; <label>:157:                                    ; preds = %block_400fd7
  ...
  store i64 %159, i64* %56, align 8
  %160 = and i64 %158, 4294967295
  store i64 %160, i64* %57, align 8
...
routine_idivl__ecx.exit:                          ; preds = %157, %155
  ...
  store i64 %178, i64* %RSI.i54, align 8
  %179 = add i64 %174, -20
  %180 = add i64 %170, 16
  ...
  store i64 %183, i64* %RDI.i13, align 8
  ...
  store i64 %195, i64* %RAX.i49, align 8
  ...
  %203 = and i8 %202, 1
  %204 = xor i8 %203, 1
  store i8 %204, i8* %46, align 1
  %205 = xor i32 %193, %194
  %206 = lshr i32 %205, 4
  %207 = trunc i32 %206 to i8
  %208 = and i8 %207, 1
  store i8 %208, i8* %47, align 1
  %209 = icmp eq i32 %194, 0
  %210 = zext i1 %209 to i8
  store i8 %210, i8* %48, align 1
  %211 = lshr i32 %194, 31
  %212 = trunc i32 %211 to i8
  store i8 %212, i8* %49, align 1
  %213 = lshr i32 %193, 31
  %214 = xor i32 %211, %213
...
block_400478:
  ...
  %5 = load i64, i64* bitcast (%G_0x30d9__rip__type* @G_0x30d9__rip_ to i64*), align 8
