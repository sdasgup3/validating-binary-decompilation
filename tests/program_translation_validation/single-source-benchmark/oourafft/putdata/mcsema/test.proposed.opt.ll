...
entry:
  ...
  %ESI.i61 = bitcast %union.anon* %16 to i32*
  %17 = load i64, i64* %RBP.i, align 8
  %18 = add i64 %17, -8
  %19 = load i32, i32* %ESI.i61, align 4
  ...
  %RSI.i54 = getelementptr inbounds %union.anon, %union.anon* %16, i64 0, i32 0
  ...
  store i64 %41, i64* %RSI.i54, align 8
  %42 = add i64 %35, -20
  %43 = add i64 %37, 6
  ...
  %52 = getelementptr inbounds [32 x %union.VectorReg], [32 x %union.VectorReg]* %51, i64 0, i64 0, i32 0, i32 0, i32 0, i64 0
...
block_.L_400feb:                                  ; preds = %routine_idivl__ecx.exit, %entry
  %61 = phi i64 [ %.pre, %entry ], [ %217, %routine_idivl__ecx.exit ]
  %MEMORY.0 = phi %struct.Memory* [ %2, %entry ], [ %163, %routine_idivl__ecx.exit ]
  ...
  store i64 %67, i64* %RAX.i49, align 8
  %68 = add i64 %62, -8
  %69 = add i64 %61, 6
  ...
  br i1 %.demorgan, label %block_400ff7, label %block_.L_401042
...
block_400ff7:                                     ; preds = %block_.L_400feb
  ...
  store i64 %102, i64* %52, align 1
  store double 0.000000e+00, double* %54, align 1
  store i64 259200, i64* %RAX.i49, align 8
  %103 = add i64 %62, -24
  %104 = add i64 %98, 20
  store i64 %104, i64* %3, align 8
  %105 = inttoptr i64 %103 to i32*
  %106 = load i32, i32* %105, align 4
  %107 = mul i32 %106, 7141
  ...
  store i8 %130, i8* %50, align 1
  %131 = add i64 %62, -28
  %132 = add i64 %98, 29
  store i64 %132, i64* %3, align 8
  %133 = inttoptr i64 %131 to i32*
  store i32 259200, i32* %133, align 4
  %134 = load i32, i32* %ECX.i31, align 4
  %135 = zext i32 %134 to i64
  %136 = load i64, i64* %3, align 8
  store i64 %135, i64* %RAX.i49, align 8
  ...
  store i64 %144, i64* %RCX.i39, align 8
  %145 = add i64 %136, 8
  store i64 %145, i64* %3, align 8
  %146 = sext i32 %143 to i64
  %147 = shl nuw i64 %138, 32
  %148 = or i64 %147, %135
...
; <label>:153:                                    ; preds = %block_400ff7
  %154 = tail call %struct.Memory* @__remill_error(%struct.State* nonnull dereferenceable(3376) %0, i64 %145, %struct.Memory* %MEMORY.0)
  %.pre1 = load i64, i64* %RBP.i, align 8
  %.pre2 = load i32, i32* %57, align 4
  %.pre3 = load i64, i64* %3, align 8
  br label %routine_idivl__ecx.exit

; <label>:155:                                    ; preds = %block_400ff7
...
routine_idivl__ecx.exit:                          ; preds = %155, %153
  %160 = phi i64 [ %.pre3, %153 ], [ %145, %155 ]
  %161 = phi i32 [ %.pre2, %153 ], [ %159, %155 ]
  %162 = phi i64 [ %.pre1, %153 ], [ %139, %155 ]
  %163 = phi %struct.Memory* [ %154, %153 ], [ %MEMORY.0, %155 ]
  %164 = add i64 %162, -24
  %165 = add i64 %160, 3
  ...
  %170 = load double, double* %60, align 1
  %171 = fmul double %169, %170
  store double %171, double* %59, align 1
  ...
  store i64 %176, i64* %RSI.i54, align 8
  %177 = add i64 %172, -20
  %178 = add i64 %168, 16
  ...
  store i64 %181, i64* %RDI.i13, align 8
  ...
  store i64 %193, i64* %RAX.i49, align 8
  ...
  %206 = and i8 %205, 1
  store i8 %206, i8* %47, align 1
  %207 = zext i1 %195 to i8
  store i8 %207, i8* %48, align 1
  %208 = lshr i32 %192, 31
  %209 = trunc i32 %208 to i8
  store i8 %209, i8* %49, align 1
  %210 = lshr i32 %191, 31
  %211 = xor i32 %208, %210
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_jg_.L_401042(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i8* nocapture %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_jmpq_.L_400feb(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
