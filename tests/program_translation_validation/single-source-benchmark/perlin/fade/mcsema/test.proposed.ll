...
entry:
  ...
  ; Code: movsd 0x2ac(%rip), %xmm1	 RIP: 400b94	 Bytes: 8
  %loadMem_400b94 = load %struct.Memory*, %struct.Memory** %MEMORY
  %call_400b94 = call %struct.Memory* @routine_movsd_0x2ac__rip____xmm1(%struct.State* %0, i64  0, %struct.Memory* %loadMem_400b94)
  store %struct.Memory* %call_400b94, %struct.Memory** %MEMORY

  ; Code: movsd 0x2ac(%rip), %xmm2	 RIP: 400b9c	 Bytes: 8
  %loadMem_400b9c = load %struct.Memory*, %struct.Memory** %MEMORY
  %call_400b9c = call %struct.Memory* @routine_movsd_0x2ac__rip____xmm2(%struct.State* %0, i64  0, %struct.Memory* %loadMem_400b9c)
  store %struct.Memory* %call_400b9c, %struct.Memory** %MEMORY

  ; Code: movsd 0x2ac(%rip), %xmm3	 RIP: 400ba4	 Bytes: 8
  %loadMem_400ba4 = load %struct.Memory*, %struct.Memory** %MEMORY
  %call_400ba4 = call %struct.Memory* @routine_movsd_0x2ac__rip____xmm3(%struct.State* %0, i64  0, %struct.Memory* %loadMem_400ba4)
  store %struct.Memory* %call_400ba4, %struct.Memory** %MEMORY

  ; Code: movsd %xmm0, -0x8(%rbp)	 RIP: 400bac	 Bytes: 5
  %loadMem_400bac = load %struct.Memory*, %struct.Memory** %MEMORY
  %call_400bac = call %struct.Memory* @routine_movsd__xmm0__MINUS0x8__rbp_(%struct.State* %0, i64  0, %struct.Memory* %loadMem_400bac)
  store %struct.Memory* %call_400bac, %struct.Memory** %MEMORY

  ; Code: movsd -0x8(%rbp), %xmm0	 RIP: 400bb1	 Bytes: 5
  %loadMem_400bb1 = load %struct.Memory*, %struct.Memory** %MEMORY
  %call_400bb1 = call %struct.Memory* @routine_movsd_MINUS0x8__rbp____xmm0(%struct.State* %0, i64  0, %struct.Memory* %loadMem_400bb1)
  store %struct.Memory* %call_400bb1, %struct.Memory** %MEMORY

  ; Code: mulsd -0x8(%rbp), %xmm0	 RIP: 400bb6	 Bytes: 5
  %loadMem_400bb6 = load %struct.Memory*, %struct.Memory** %MEMORY
  %call_400bb6 = call %struct.Memory* @routine_mulsd_MINUS0x8__rbp____xmm0(%struct.State* %0, i64  0, %struct.Memory* %loadMem_400bb6)
  store %struct.Memory* %call_400bb6, %struct.Memory** %MEMORY

  ; Code: mulsd -0x8(%rbp), %xmm0	 RIP: 400bbb	 Bytes: 5
  %loadMem_400bbb = load %struct.Memory*, %struct.Memory** %MEMORY
  %call_400bbb = call %struct.Memory* @routine_mulsd_MINUS0x8__rbp____xmm0(%struct.State* %0, i64  0, %struct.Memory* %loadMem_400bbb)
  store %struct.Memory* %call_400bbb, %struct.Memory** %MEMORY

  ; Code: movsd -0x8(%rbp), %xmm4	 RIP: 400bc0	 Bytes: 5
  %loadMem_400bc0 = load %struct.Memory*, %struct.Memory** %MEMORY
  %call_400bc0 = call %struct.Memory* @routine_movsd_MINUS0x8__rbp____xmm4(%struct.State* %0, i64  0, %struct.Memory* %loadMem_400bc0)
  store %struct.Memory* %call_400bc0, %struct.Memory** %MEMORY

  ; Code: mulsd -0x8(%rbp), %xmm3	 RIP: 400bc5	 Bytes: 5
  %loadMem_400bc5 = load %struct.Memory*, %struct.Memory** %MEMORY
  %call_400bc5 = call %struct.Memory* @routine_mulsd_MINUS0x8__rbp____xmm3(%struct.State* %0, i64  0, %struct.Memory* %loadMem_400bc5)
  store %struct.Memory* %call_400bc5, %struct.Memory** %MEMORY

  ; Code: subsd %xmm2, %xmm3	 RIP: 400bca	 Bytes: 4
  %loadMem_400bca = load %struct.Memory*, %struct.Memory** %MEMORY
  %call_400bca = call %struct.Memory* @routine_subsd__xmm2___xmm3(%struct.State* %0, i64  0, %struct.Memory* %loadMem_400bca)
  store %struct.Memory* %call_400bca, %struct.Memory** %MEMORY

  ; Code: mulsd %xmm3, %xmm4	 RIP: 400bce	 Bytes: 4
  %loadMem_400bce = load %struct.Memory*, %struct.Memory** %MEMORY
  %call_400bce = call %struct.Memory* @routine_mulsd__xmm3___xmm4(%struct.State* %0, i64  0, %struct.Memory* %loadMem_400bce)
  store %struct.Memory* %call_400bce, %struct.Memory** %MEMORY

  ; Code: addsd %xmm1, %xmm4	 RIP: 400bd2	 Bytes: 4
  %loadMem_400bd2 = load %struct.Memory*, %struct.Memory** %MEMORY
  %call_400bd2 = call %struct.Memory* @routine_addsd__xmm1___xmm4(%struct.State* %0, i64  0, %struct.Memory* %loadMem_400bd2)
  store %struct.Memory* %call_400bd2, %struct.Memory** %MEMORY

  ; Code: mulsd %xmm4, %xmm0	 RIP: 400bd6	 Bytes: 4
  %loadMem_400bd6 = load %struct.Memory*, %struct.Memory** %MEMORY
  %call_400bd6 = call %struct.Memory* @routine_mulsd__xmm4___xmm0(%struct.State* %0, i64  0, %struct.Memory* %loadMem_400bd6)
  store %struct.Memory* %call_400bd6, %struct.Memory** %MEMORY

  ; Code: popq %rbp	 RIP: 400bda	 Bytes: 1
  %loadMem_400bda = load %struct.Memory*, %struct.Memory** %MEMORY
  %call_400bda = call %struct.Memory* @routine_popq__rbp(%struct.State* %0, i64  0, %struct.Memory* %loadMem_400bda)
  store %struct.Memory* %call_400bda, %struct.Memory** %MEMORY

  ; Code: retq	 RIP: 400bdb	 Bytes: 1
  %loadMem_400bdb = load %struct.Memory*, %struct.Memory** %MEMORY
  %call_400bdb = call %struct.Memory* @routine_retq(%struct.State* %0, i64  0, %struct.Memory* %loadMem_400bdb)
  store %struct.Memory* %call_400bdb, %struct.Memory** %MEMORY

  ret %struct.Memory* %call_400bdb
}
