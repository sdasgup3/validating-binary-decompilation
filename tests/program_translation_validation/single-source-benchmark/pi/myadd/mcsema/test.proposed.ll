...
define %struct.Memory* @myadd(%struct.State* noalias , i64, %struct.Memory* noalias) alwaysinline  {
entry:
  ...
  ; Code: movq %rsi, -0x10(%rbp)	 RIP: 4004f8	 Bytes: 4
  %loadMem_4004f8 = load %struct.Memory*, %struct.Memory** %MEMORY
  %call_4004f8 = call %struct.Memory* @routine_movq__rsi__MINUS0x10__rbp_(%struct.State* %0, i64  0, %struct.Memory* %loadMem_4004f8)
  store %struct.Memory* %call_4004f8, %struct.Memory** %MEMORY

  ; Code: movq -0x8(%rbp), %rsi	 RIP: 4004fc	 Bytes: 4
  %loadMem_4004fc = load %struct.Memory*, %struct.Memory** %MEMORY
  %call_4004fc = call %struct.Memory* @routine_movq_MINUS0x8__rbp____rsi(%struct.State* %0, i64  0, %struct.Memory* %loadMem_4004fc)
  store %struct.Memory* %call_4004fc, %struct.Memory** %MEMORY

  ; Code: movss (%rsi), %xmm0	 RIP: 400500	 Bytes: 4
  %loadMem_400500 = load %struct.Memory*, %struct.Memory** %MEMORY
  %call_400500 = call %struct.Memory* @routine_movss___rsi____xmm0(%struct.State* %0, i64  0, %struct.Memory* %loadMem_400500)
  store %struct.Memory* %call_400500, %struct.Memory** %MEMORY

  ; Code: movq -0x10(%rbp), %rsi	 RIP: 400504	 Bytes: 4
  %loadMem_400504 = load %struct.Memory*, %struct.Memory** %MEMORY
  %call_400504 = call %struct.Memory* @routine_movq_MINUS0x10__rbp____rsi(%struct.State* %0, i64  0, %struct.Memory* %loadMem_400504)
  store %struct.Memory* %call_400504, %struct.Memory** %MEMORY

  ; Code: addss (%rsi), %xmm0	 RIP: 400508	 Bytes: 4
  %loadMem_400508 = load %struct.Memory*, %struct.Memory** %MEMORY
  %call_400508 = call %struct.Memory* @routine_addss___rsi____xmm0(%struct.State* %0, i64  0, %struct.Memory* %loadMem_400508)
  store %struct.Memory* %call_400508, %struct.Memory** %MEMORY

  ; Code: movq -0x8(%rbp), %rsi	 RIP: 40050c	 Bytes: 4
  %loadMem_40050c = load %struct.Memory*, %struct.Memory** %MEMORY
  %call_40050c = call %struct.Memory* @routine_movq_MINUS0x8__rbp____rsi(%struct.State* %0, i64  0, %struct.Memory* %loadMem_40050c)
  store %struct.Memory* %call_40050c, %struct.Memory** %MEMORY

  ; Code: movss %xmm0, (%rsi)	 RIP: 400510	 Bytes: 4
  %loadMem_400510 = load %struct.Memory*, %struct.Memory** %MEMORY
  %call_400510 = call %struct.Memory* @routine_movss__xmm0____rsi_(%struct.State* %0, i64  0, %struct.Memory* %loadMem_400510)
  store %struct.Memory* %call_400510, %struct.Memory** %MEMORY

  ; Code: popq %rbp	 RIP: 400514	 Bytes: 1
  %loadMem_400514 = load %struct.Memory*, %struct.Memory** %MEMORY
  %call_400514 = call %struct.Memory* @routine_popq__rbp(%struct.State* %0, i64  0, %struct.Memory* %loadMem_400514)
  store %struct.Memory* %call_400514, %struct.Memory** %MEMORY

  ; Code: retq	 RIP: 400515	 Bytes: 1
  %loadMem_400515 = load %struct.Memory*, %struct.Memory** %MEMORY
  %call_400515 = call %struct.Memory* @routine_retq(%struct.State* %0, i64  0, %struct.Memory* %loadMem_400515)
  store %struct.Memory* %call_400515, %struct.Memory** %MEMORY

  ret %struct.Memory* %call_400515
}
