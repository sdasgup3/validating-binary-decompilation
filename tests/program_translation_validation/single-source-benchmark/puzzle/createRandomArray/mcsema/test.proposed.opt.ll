...
declare %struct.Memory* @sub_400660.randInt(%struct.State* dereferenceable(3376), i64, %struct.Memory*) local_unnamed_addr

declare %struct.Memory* @sub_4006e0.shuffle(%struct.State* dereferenceable(3376), i64, %struct.Memory*) local_unnamed_addr
