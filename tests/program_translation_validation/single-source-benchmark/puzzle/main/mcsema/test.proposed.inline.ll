...
declare %struct.Memory* @sub_400640.srand(%struct.State* dereferenceable(3376), i64, %struct.Memory*)

declare %struct.Memory* @sub_4007e0.createRandomArray(%struct.State* dereferenceable(3376), i64, %struct.Memory*)

declare %struct.Memory* @sub_400860.findDuplicate(%struct.State* dereferenceable(3376), i64, %struct.Memory*)

declare %struct.Memory* @sub_4004d0.free_plt(%struct.State* dereferenceable(3376), i64, %struct.Memory*)
