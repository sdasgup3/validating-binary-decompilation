...
block_.L_4008c0:                                  ; preds = %block_.L_40090b, %entry
  %54 = phi i64 [ %.pre, %entry ], [ %239, %block_.L_40090b ]
  %MEMORY.0 = phi %struct.Memory* [ %call2_4008b4, %entry ], [ %200, %block_.L_40090b ]
...
block_.L_4008df:                                  ; preds = %block_4008ec, %block_4008ca
  %100 = phi i64 [ %.pre1, %block_4008ca ], [ %177, %block_4008ec ]
...
block_.L_40090b:                                  ; preds = %block_.L_4008df
  ...
  store i64 %181, i64* %RAX.i59, align 8
  store i64 %181, i64* %RDI.i73, align 8
  %182 = add i64 %129, -1131
  %183 = add i64 %129, 12
  ...
  %187 = tail call %struct.Memory* @__remill_function_call(%struct.State* %0, i64 ptrtoint (i64 (i64)* @free to i64), %struct.Memory* %MEMORY.1)
  ...
  store i64 %194, i64* %RSI.i52, align 8
  store i8 0, i8* %AL.i, align 1
  %195 = add i64 %188, -1127
  %196 = add i64 %188, 20
  ...
  %200 = tail call %struct.Memory* @__remill_function_call(%struct.State* %0, i64 ptrtoint (i64 (i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64)* @printf to i64), %struct.Memory* %187)
  %201 = load i64, i64* %RBP.i, align 8
  %202 = add i64 %201, -28
  %203 = load i32, i32* %EAX.i45, align 4
  ...
  store i64 %214, i64* %RAX.i59, align 8
...
block_.L_40093c:                                  ; preds = %block_.L_4008c0
  ...
  %240 = load i64, i64* %RSP.i19, align 8
  %241 = add i64 %240, 32
  store i64 %241, i64* %RSP.i19, align 8
