...
entry:
  ...
  ; Code: movl -0x4(%rbp), %edi	 RIP: 400617	 Bytes: 3
  %loadMem_400617 = load %struct.Memory*, %struct.Memory** %MEMORY
  %call_400617 = call %struct.Memory* @routine_movl_MINUS0x4__rbp____edi(%struct.State* %0, i64  0, %struct.Memory* %loadMem_400617)
  store %struct.Memory* %call_400617, %struct.Memory** %MEMORY

  ; Code: movl %edi, %eax	 RIP: 40061a	 Bytes: 2
  %loadMem_40061a = load %struct.Memory*, %struct.Memory** %MEMORY
  %call_40061a = call %struct.Memory* @routine_movl__edi___eax(%struct.State* %0, i64  0, %struct.Memory* %loadMem_40061a)
  store %struct.Memory* %call_40061a, %struct.Memory** %MEMORY

  ; Code: movq %rax, 0x601040	 RIP: 40061c	 Bytes: 8
  %loadMem_40061c = load %struct.Memory*, %struct.Memory** %MEMORY
  %call_40061c = call %struct.Memory* @routine_movq__rax__0x601040(%struct.State* %0, i64  0, %struct.Memory* %loadMem_40061c)
