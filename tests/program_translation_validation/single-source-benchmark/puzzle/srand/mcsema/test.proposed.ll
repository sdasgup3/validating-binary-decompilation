...
entry:
  ...
  ; Code: movl -0x4(%rbp), %edi	 RIP: 400647	 Bytes: 3
  %loadMem_400647 = load %struct.Memory*, %struct.Memory** %MEMORY
  %call_400647 = call %struct.Memory* @routine_movl_MINUS0x4__rbp____edi(%struct.State* %0, i64  0, %struct.Memory* %loadMem_400647)
  store %struct.Memory* %call_400647, %struct.Memory** %MEMORY

  ; Code: movl %edi, %eax	 RIP: 40064a	 Bytes: 2
  %loadMem_40064a = load %struct.Memory*, %struct.Memory** %MEMORY
  %call_40064a = call %struct.Memory* @routine_movl__edi___eax(%struct.State* %0, i64  0, %struct.Memory* %loadMem_40064a)
  store %struct.Memory* %call_40064a, %struct.Memory** %MEMORY

  ; Code: movq %rax, 0x601040	 RIP: 40064c	 Bytes: 8
  %loadMem_40064c = load %struct.Memory*, %struct.Memory** %MEMORY
  %call_40064c = call %struct.Memory* @routine_movq__rax__0x601040(%struct.State* %0, i64  0, %struct.Memory* %loadMem_40064c)
