...
define %struct.Memory* @srand(%struct.State* noalias nocapture, i64, %struct.Memory* noalias readnone returned) local_unnamed_addr #0 {
entry:
  ...
  store i64 %22, i64* bitcast (%G_0x601040_type* @G_0x601040 to i64*), align 8
  %23 = add i64 %18, 14
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_movq__rax__0x601040(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned) local_unnamed_addr #1 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %RAX = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 1, i32 0, i32 0
