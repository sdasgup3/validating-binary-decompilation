; ModuleID = '/tmp/tmpbahsm3ur-query.ll'
...
entry:
  ...
  %RAX.i = getelementptr inbounds %union.anon, %union.anon* %var_2_40, i64 0, i32 0
  ...
  %EAX.i254 = bitcast %union.anon* %var_2_40 to i32*
  %RCX.i292 = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 5, i32 0, i32 0
  %RDX.i363 = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 7, i32 0, i32 0
  ...
  %var_2_7723 = load i64, i64* %RBP.i, align 8
  %var_2_7824 = add i64 %var_2_7723, -20
  %var_2_8025 = inttoptr i64 %var_2_7824 to i32*
  %var_2_8126 = load i32, i32* %var_2_8025, align 4
  %var_2_8327 = add i64 %var_2_7723, -8
  %var_2_8528 = inttoptr i64 %var_2_8327 to i32*
  %var_2_8629 = load i32, i32* %var_2_8528, align 4
  %var_2_8730 = sub i32 %var_2_8126, %var_2_8629
  %var_2_10231 = lshr i32 %var_2_8730, 31
  %var_2_10432 = lshr i32 %var_2_8126, 31
  %var_2_10533 = lshr i32 %var_2_8629, 31
  %var_2_10634 = xor i32 %var_2_10533, %var_2_10432
  %var_2_10735 = xor i32 %var_2_10231, %var_2_10432
  %var_2_10836 = add nuw nsw i32 %var_2_10735, %var_2_10634
  %var_2_10937 = icmp eq i32 %var_2_10836, 2
  %var_2_11138 = icmp ne i32 %var_2_10231, 0
  %var_2_11239 = xor i1 %var_2_11138, %var_2_10937
  br i1 %var_2_11239, label %block_400797.preheader, label %block_.L_400972.thread

block_400797.preheader:                           ; preds = %entry
  br label %block_400797

block_.L_400972.thread:                           ; preds = %entry
  store i8 0, i8* %var_2_14, align 1
  %var_2_5355 = add i64 %.pre, 577
  store i64 %var_2_5355, i64* %var_2_3, align 8
  br label %block_.L_4009cc

block_400797:                                     ; preds = %block_400797.preheader, %block_.L_40095f
  %var_2_131 = phi i64 [ %var_2_522, %block_.L_40095f ], [ %.pre, %block_400797.preheader ]
  %var_2_7741 = phi i64 [ %var_2_77, %block_.L_40095f ], [ %var_2_7723, %block_400797.preheader ]
  %MEMORY.040 = phi %struct.Memory* [ %MEMORY.7, %block_.L_40095f ], [ %2, %block_400797.preheader ]
  %var_2_130 = add i64 %var_2_7741, -32
  %var_4_4 = inttoptr i64 %var_2_130 to i8**
  %var_2_1342 = load i8*, i8** %var_4_4, align 8
  %var_2_137 = load i8, i8* %var_2_1342, align 1
  %var_2_153 = icmp eq i8 %var_2_137, 45
  br i1 %var_2_153, label %block_4007b7, label %block_.L_400883

block_4007b7:                                     ; preds = %block_400797
  %var_2_163 = add i64 %var_2_131, 21
  %var_2_19215 = add i64 %var_2_131, 36
  store i64 %var_2_19215, i64* %var_2_3, align 8
  %var_2_19316 = load i64, i64* %RAX.i, align 8
  %var_2_19417 = add i64 %var_2_19316, 1
  %var_2_19718 = inttoptr i64 %var_2_19417 to i8*
  %var_2_19819 = load i8, i8* %var_2_19718, align 1
  store i8 0, i8* %var_2_14, align 1
  %var_2_20420 = icmp eq i8 %var_2_19819, 0
  br i1 %var_2_20420, label %block_.L_40087e, label %block_4007d5.preheader

block_4007d5.preheader:                           ; preds = %block_4007b7
  br label %block_4007d5

block_4007d5:                                     ; preds = %block_4007d5.preheader, %block_.L_400879
  %var_2_19346 = phi i64 [ %var_2_193, %block_.L_400879 ], [ %var_2_19316, %block_4007d5.preheader ]
  %var_2_250 = phi i64 [ %var_2_192, %block_.L_400879 ], [ %var_2_19215, %block_4007d5.preheader ]
  %MEMORY.121 = phi %struct.Memory* [ %MEMORY.3, %block_.L_400879 ], [ %MEMORY.040, %block_4007d5.preheader ]
  %var_2_251 = load i8, i8* %var_2_30, align 1
  %var_2_252 = icmp ne i8 %var_2_251, 0
  %.v50 = select i1 %var_2_252, i64 42, i64 6
  %var_2_253 = add i64 %.v50, %var_2_250
  switch i8 %var_2_251, label %block_400801 [
    i8 1, label %block_.L_400811
    i8 0, label %block_.L_400821
  ]

block_400801:                                     ; preds = %block_4007d5
  %var_2_288 = add i64 %var_2_250, 22
  store i32 0, i32* bitcast (%G_0x602058_type* @G_0x602058 to i32*), align 8
  br label %block_.L_400811

block_.L_400811:                                  ; preds = %block_400801, %block_4007d5
  %var_2_289 = phi i64 [ %var_2_288, %block_400801 ], [ %var_2_253, %block_4007d5 ]
  store i32 1, i32* bitcast (%G_0x602090_type* @G_0x602090 to i32*), align 8
  %var_2_290 = add i64 %var_2_289, 104
  br label %block_.L_400879

block_.L_400821:                                  ; preds = %block_4007d5
  store i64 ptrtoint (%G__0x400edc_type* @G__0x400edc to i64), i64* %RSI.i111, align 8
  %var_2_313 = tail call %struct.Memory* @__remill_function_call(%struct.State* nonnull %0, i64 ptrtoint (i64 (i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64)* @fprintf to i64), %struct.Memory* %MEMORY.121)
  %var_2_332 = tail call %struct.Memory* @__remill_function_call(%struct.State* nonnull %0, i64 ptrtoint (i64 (i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64)* @fprintf to i64), %struct.Memory* %var_2_313)
  store i64 4294967295, i64* %RDI.i260, align 8
  %var_2_345 = tail call %struct.Memory* @__remill_function_call(%struct.State* nonnull %0, i64 ptrtoint (i64 (i64)* @exit to i64), %struct.Memory* %var_2_332)
  %.pre30 = load i64, i64* %var_2_3, align 8
  %var_2_193.pre = load i64, i64* %RAX.i, align 8
  br label %block_.L_400879

block_.L_400879:                                  ; preds = %block_.L_400821, %block_.L_400811
  %var_2_193 = phi i64 [ %var_2_19346, %block_.L_400811 ], [ %var_2_193.pre, %block_.L_400821 ]
  %var_2_346 = phi i64 [ %var_2_290, %block_.L_400811 ], [ %.pre30, %block_.L_400821 ]
  %MEMORY.3 = phi %struct.Memory* [ %MEMORY.121, %block_.L_400811 ], [ %var_2_345, %block_.L_400821 ]
  %var_2_192 = add i64 %var_2_346, -174
  store i64 %var_2_192, i64* %var_2_3, align 8
  %var_2_194 = add i64 %var_2_193, 1
  %var_2_197 = inttoptr i64 %var_2_194 to i8*
  %var_2_198 = load i8, i8* %var_2_197, align 1
  store i8 0, i8* %var_2_14, align 1
  %var_2_204 = icmp eq i8 %var_2_198, 0
  br i1 %var_2_204, label %block_.L_40087e.loopexit, label %block_4007d5

block_.L_40087e.loopexit:                         ; preds = %block_.L_400879
  %var_2_347 = add i64 %var_2_346, -189
  br label %block_.L_40087e

block_.L_40087e:                                  ; preds = %block_.L_40087e.loopexit, %block_4007b7
  %storemerge.lcssa = phi i64 [ %var_2_163, %block_4007b7 ], [ %var_2_347, %block_.L_40087e.loopexit ]
  %MEMORY.1.lcssa = phi %struct.Memory* [ %MEMORY.040, %block_4007b7 ], [ %MEMORY.3, %block_.L_40087e.loopexit ]
  %var_2_349 = add i64 %storemerge.lcssa, 419
...
block_.L_400883:                                  ; preds = %block_400797
  ...
  %var_2_357 = tail call %struct.Memory* @__remill_function_call(%struct.State* nonnull %0, i64 ptrtoint (i64 (i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64)* @__isoc99_sscanf to i64), %struct.Memory* %MEMORY.040)
  %var_2_358 = load i32, i32* %EAX.i254, align 4
  %var_2_359 = load i64, i64* %var_2_3, align 8
  %var_2_372 = icmp eq i32 %var_2_358, 1
  %.v42 = select i1 %var_2_372, i64 59, i64 9
  %var_2_381 = add i64 %.v42, %var_2_359
  br i1 %var_2_372, label %block_.L_4008dd, label %block_4008ab

block_4008ab:                                     ; preds = %block_.L_400883
  store i64 ptrtoint (%G__0x400ef8_type* @G__0x400ef8 to i64), i64* %RSI.i111, align 8
  %var_2_394 = tail call %struct.Memory* @__remill_function_call(%struct.State* nonnull %0, i64 ptrtoint (i64 (i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64)* @fprintf to i64), %struct.Memory* %var_2_357)
  store i64 4294967295, i64* %RDI.i260, align 8
  %var_2_407 = tail call %struct.Memory* @__remill_function_call(%struct.State* nonnull %0, i64 ptrtoint (i64 (i64)* @exit to i64), %struct.Memory* %var_2_394)
  %.pre31 = load i64, i64* %var_2_3, align 8
  br label %block_.L_4008dd

block_.L_4008dd:                                  ; preds = %block_4008ab, %block_.L_400883
  %var_2_408 = phi i64 [ %var_2_381, %block_.L_400883 ], [ %.pre31, %block_4008ab ]
  %MEMORY.4 = phi %struct.Memory* [ %var_2_357, %block_.L_400883 ], [ %var_2_407, %block_4008ab ]
  %var_2_409 = load i32, i32* bitcast (%G_0x6020b0_type* @G_0x6020b0 to i32*), align 8
  store i8 0, i8* %var_2_14, align 1
  %var_6_3 = icmp sgt i32 %var_2_409, 0
  %.v43 = select i1 %var_6_3, i64 60, i64 14
  %var_2_422 = add i64 %.v43, %var_2_408
  store i64 %var_2_422, i64* %var_2_3, align 8
  br i1 %var_6_3, label %block_.L_400919, label %block_4008eb

block_4008eb:                                     ; preds = %block_.L_4008dd
  store i64 ptrtoint (%G__0x400f17_type* @G__0x400f17 to i64), i64* %RSI.i111, align 8
  %var_2_425 = add i64 %var_2_422, -747
  %var_2_426 = add i64 %var_2_422, 33
  ...
  %var_2_430 = tail call %struct.Memory* @__remill_function_call(%struct.State* nonnull %0, i64 ptrtoint (i64 (i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64)* @fprintf to i64), %struct.Memory* %MEMORY.4)
  store i64 4294967295, i64* %RDI.i260, align 8
  %var_2_443 = tail call %struct.Memory* @__remill_function_call(%struct.State* nonnull %0, i64 ptrtoint (i64 (i64)* @exit to i64), %struct.Memory* %var_2_430)
...
block_.L_400919:                                  ; preds = %block_4008eb, %block_.L_4008dd
  %var_2_444 = phi i32 [ %var_2_409, %block_.L_4008dd ], [ %.pre33, %block_4008eb ]
  %var_2_445 = phi i64 [ %var_2_422, %block_.L_4008dd ], [ %.pre32, %block_4008eb ]
  %MEMORY.5 = phi %struct.Memory* [ %MEMORY.4, %block_.L_4008dd ], [ %var_2_443, %block_4008eb ]
  %var_2_446 = add i32 %var_2_444, -100
  %var_2_447 = icmp ult i32 %var_2_444, 100
  %var_2_448 = zext i1 %var_2_447 to i8
  store i8 %var_2_448, i8* %var_2_14, align 1
  %var_2_449 = and i32 %var_2_446, 255
  %var_2_450 = tail call i32 @llvm.ctpop.i32(i32 %var_2_449)
  %var_2_451 = trunc i32 %var_2_450 to i8
  %var_2_452 = and i8 %var_2_451, 1
  %var_2_453 = xor i8 %var_2_452, 1
  store i8 %var_2_453, i8* %var_2_21, align 1
  %var_2_454 = xor i32 %var_2_446, %var_2_444
  %var_2_455 = lshr i32 %var_2_454, 4
  %var_2_456 = trunc i32 %var_2_455 to i8
  %var_2_457 = and i8 %var_2_456, 1
  store i8 %var_2_457, i8* %var_2_27, align 1
  %var_2_458 = icmp eq i32 %var_2_446, 0
  %var_2_459 = zext i1 %var_2_458 to i8
  store i8 %var_2_459, i8* %var_2_30, align 1
  %var_2_460 = lshr i32 %var_2_446, 31
  %var_2_461 = trunc i32 %var_2_460 to i8
  store i8 %var_2_461, i8* %var_2_33, align 1
  %var_2_462 = lshr i32 %var_2_444, 31
  %var_2_463 = xor i32 %var_2_460, %var_2_462
  %var_2_464 = add nuw nsw i32 %var_2_463, %var_2_462
  %var_2_465 = icmp eq i32 %var_2_464, 2
  %var_2_466 = zext i1 %var_2_465 to i8
  store i8 %var_2_466, i8* %var_2_39, align 1
  %var_2_467 = icmp ne i8 %var_2_461, 0
  %var_2_468 = xor i1 %var_2_467, %var_2_465
  %var_2_469 = or i1 %var_2_458, %var_2_468
  %.v44 = select i1 %var_2_469, i64 65, i64 14
  %var_2_470 = add i64 %.v44, %var_2_445
  store i64 %var_2_470, i64* %var_2_3, align 8
  br i1 %var_2_469, label %block_.L_40095a, label %block_400927
...
block_400927:                                     ; preds = %block_.L_400919
  ...
  %var_2_473 = add i64 %var_2_470, -807
  %var_2_474 = add i64 %var_2_470, 38
  %var_2_475 = load i64, i64* %var_2_6, align 8
  %var_2_476 = add i64 %var_2_475, -8
  %var_2_477 = inttoptr i64 %var_2_476 to i64*
  store i64 %var_2_474, i64* %var_2_477, align 8
  store i64 %var_2_473, i64* %var_2_3, align 8
  %var_2_478 = tail call %struct.Memory* @__remill_function_call(%struct.State* nonnull %0, i64 ptrtoint (i64 (i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64)* @fprintf to i64), %struct.Memory* %MEMORY.5)
  store i64 4294967295, i64* %RDI.i260, align 8
  %var_2_491 = tail call %struct.Memory* @__remill_function_call(%struct.State* nonnull %0, i64 ptrtoint (i64 (i64)* @exit to i64), %struct.Memory* %var_2_478)
  %.pre34 = load i64, i64* %var_2_3, align 8
  br label %block_.L_40095a

block_.L_40095a:                                  ; preds = %block_400927, %block_.L_400919
  %var_2_492 = phi i64 [ %var_2_470, %block_.L_400919 ], [ %.pre34, %block_400927 ]
  %MEMORY.6 = phi %struct.Memory* [ %MEMORY.5, %block_.L_400919 ], [ %var_2_491, %block_400927 ]
  %var_2_493 = add i64 %var_2_492, 5
  store i64 %var_2_493, i64* %var_2_3, align 8
  br label %block_.L_40095f

block_.L_40095f:                                  ; preds = %block_.L_40095a, %block_.L_40087e
  %storemerge14 = phi i64 [ %var_2_349, %block_.L_40087e ], [ %var_2_493, %block_.L_40095a ]
  %MEMORY.7 = phi %struct.Memory* [ %MEMORY.1.lcssa, %block_.L_40087e ], [ %MEMORY.6, %block_.L_40095a ]
  %var_2_522 = add i64 %storemerge14, 14
  ...
  br i1 %var_2_112, label %block_400797, label %block_.L_400972

block_.L_400972:                                  ; preds = %block_.L_40095f
  %var_2_525.pre = load i32, i32* bitcast (%G_0x6020b0_type* @G_0x6020b0 to i32*), align 8
  %var_2_113 = add i64 %storemerge14, 19
  store i8 0, i8* %var_2_14, align 1
  %var_2_531 = icmp eq i32 %var_2_525.pre, 0
  %.v35 = select i1 %var_2_531, i64 14, i64 90
  %var_2_535 = add i64 %var_2_113, %.v35
  store i64 %var_2_535, i64* %var_2_3, align 8
  br i1 %var_2_531, label %block_400980, label %block_.L_4009cc

block_400980:                                     ; preds = %block_.L_400972
  store i64 ptrtoint (%G__0x400f5b_type* @G__0x400f5b to i64), i64* %RSI.i111, align 8
  %var_2_543 = tail call %struct.Memory* @__remill_function_call(%struct.State* nonnull %0, i64 ptrtoint (i64 (i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64)* @fprintf to i64), %struct.Memory* %MEMORY.7)
  %var_2_562 = tail call %struct.Memory* @__remill_function_call(%struct.State* nonnull %0, i64 ptrtoint (i64 (i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64)* @fprintf to i64), %struct.Memory* %var_2_543)
  store i64 4294967295, i64* %RDI.i260, align 8
  %var_2_575 = tail call %struct.Memory* @__remill_function_call(%struct.State* nonnull %0, i64 ptrtoint (i64 (i64)* @exit to i64), %struct.Memory* %var_2_562)
  %.pre23 = load i64, i64* %var_2_3, align 8
  %.pre24 = load i32, i32* bitcast (%G_0x6020b0_type* @G_0x6020b0 to i32*), align 8
  br label %block_.L_4009cc

block_.L_4009cc:                                  ; preds = %block_400980, %block_.L_400972, %block_.L_400972.thread
  %var_2_576 = phi i32 [ %var_2_525.pre, %block_.L_400972 ], [ %.pre24, %block_400980 ], [ 14, %block_.L_400972.thread ]
  %var_2_577 = phi i64 [ %var_2_535, %block_.L_400972 ], [ %.pre23, %block_400980 ], [ %var_2_5355, %block_.L_400972.thread ]
  %MEMORY.8 = phi %struct.Memory* [ %MEMORY.7, %block_.L_400972 ], [ %var_2_575, %block_400980 ], [ %2, %block_.L_400972.thread ]
  store i64 ptrtoint (%G__0x400f75_type* @G__0x400f75 to i64), i64* %RDI.i260, align 8
  %var_2_578 = zext i32 %var_2_576 to i64
  store i32 %var_2_576, i32* bitcast (%G_0x602a20_type* @G_0x602a20 to i32*), align 8
  store i32 %var_2_576, i32* bitcast (%G_0x6020b4_type* @G_0x6020b4 to i32*), align 8
  store i64 %var_2_578, i64* %RSI.i111, align 8
  %var_2_579 = add i32 %var_2_576, -1
  %var_2_580 = icmp eq i32 %var_2_576, 0
  %var_2_581 = zext i1 %var_2_580 to i8
  store i8 %var_2_581, i8* %var_2_14, align 1
  %var_2_582 = and i32 %var_2_579, 255
  %var_2_583 = tail call i32 @llvm.ctpop.i32(i32 %var_2_582)
  %var_2_584 = trunc i32 %var_2_583 to i8
  %var_2_585 = and i8 %var_2_584, 1
  %var_2_586 = xor i8 %var_2_585, 1
  store i8 %var_2_586, i8* %var_2_21, align 1
  %var_2_587 = xor i32 %var_2_579, %var_2_576
  %var_2_588 = lshr i32 %var_2_587, 4
  %var_2_589 = trunc i32 %var_2_588 to i8
  %var_2_590 = and i8 %var_2_589, 1
  store i8 %var_2_590, i8* %var_2_27, align 1
  %var_2_591 = icmp eq i32 %var_2_579, 0
  %var_2_592 = zext i1 %var_2_591 to i8
  store i8 %var_2_592, i8* %var_2_30, align 1
  %var_2_593 = lshr i32 %var_2_579, 31
  %var_2_594 = trunc i32 %var_2_593 to i8
  store i8 %var_2_594, i8* %var_2_33, align 1
  %var_2_595 = lshr i32 %var_2_576, 31
  %var_2_596 = xor i32 %var_2_593, %var_2_595
  %var_2_597 = add nuw nsw i32 %var_2_596, %var_2_595
  %var_2_598 = icmp eq i32 %var_2_597, 2
  %var_2_599 = zext i1 %var_2_598 to i8
  store i8 %var_2_599, i8* %var_2_39, align 1
  %var_2_600 = icmp ne i8 %var_2_594, 0
  %var_2_601 = xor i1 %var_2_600, %var_2_598
  %.demorgan = or i1 %var_2_591, %var_2_601
  %var_2_602 = select i1 %.demorgan, i64 ptrtoint (%G__0x400ef4_type* @G__0x400ef4 to i64), i64 ptrtoint (%G__0x400f73_type* @G__0x400f73 to i64)
  store i64 %var_2_602, i64* %RAX.i, align 8
  store i64 %var_2_578, i64* %RCX.i292, align 8
  %var_2_603 = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 17, i32 0, i32 0
  store i64 %var_2_578, i64* %var_2_603, align 8
  store i64 %var_2_602, i64* %RDX.i363, align 8
  %var_2_604 = add i64 %var_2_577, -988
  %var_2_605 = add i64 %var_2_577, 95
  %var_2_606 = load i64, i64* %var_2_6, align 8
  %var_2_607 = add i64 %var_2_606, -8
  %var_2_608 = inttoptr i64 %var_2_607 to i64*
  store i64 %var_2_605, i64* %var_2_608, align 8
  store i64 %var_2_604, i64* %var_2_3, align 8
  %var_2_609 = tail call %struct.Memory* @__remill_function_call(%struct.State* nonnull %0, i64 ptrtoint (i64 (i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64)* @printf to i64), %struct.Memory* %MEMORY.8)
  %var_2_623 = tail call %struct.Memory* @__remill_function_call(%struct.State* nonnull %0, i64 ptrtoint (i64 (i64)* @fflush to i64), %struct.Memory* %var_2_609)
  store i64 0, i64* bitcast (%G_0x602098_type* @G_0x602098 to i64*), align 8
  %var_2_636 = load i64, i64* %RBP.i, align 8
  %var_2_637 = add i64 %var_2_636, -20
  %var_2_639 = inttoptr i64 %var_2_637 to i32*
  %var_2_640 = load i32, i32* %var_2_639, align 4
  %var_2_641 = add i32 %var_2_640, -100
  %var_2_655 = lshr i32 %var_2_641, 31
  %var_2_657 = lshr i32 %var_2_640, 31
  %var_2_658 = xor i32 %var_2_655, %var_2_657
  %var_2_659 = add nuw nsw i32 %var_2_658, %var_2_657
  %var_2_660 = icmp eq i32 %var_2_659, 2
  %var_2_662 = icmp ne i32 %var_2_655, 0
  %var_2_663 = xor i1 %var_2_662, %var_2_660
  br i1 %var_2_663, label %block_.L_400a51.us.preheader, label %block_.L_400a78

block_.L_400a51.us.preheader:                     ; preds = %block_.L_4009cc
  br label %block_.L_400a51.us

block_.L_400a51.us:                               ; preds = %block_.L_400a51.us.preheader, %block_.L_400a51.us
  br label %block_.L_400a51.us

block_.L_400a78:                                  ; preds = %block_.L_4009cc
  %var_2_7117 = add i32 %var_2_640, -199
  %var_2_7258 = lshr i32 %var_2_7117, 31
  %var_2_72810 = xor i32 %var_2_7258, %var_2_657
  %var_2_72911 = add nuw nsw i32 %var_2_72810, %var_2_657
  %var_2_73012 = icmp eq i32 %var_2_72911, 2
  %var_2_73213 = icmp ne i32 %var_2_7258, 0
  %var_2_73314 = xor i1 %var_2_73213, %var_2_73012
  br i1 %var_2_73314, label %block_400a8c.preheader, label %block_.L_400ab8

block_400a8c.preheader:                           ; preds = %block_.L_400a78
  br label %block_400a8c

block_400a8c:                                     ; preds = %block_400a8c.preheader, %block_400a8c
  br label %block_400a8c

block_.L_400ab8:                                  ; preds = %block_.L_400a78
  %.pre26 = load i64, i64* %var_2_3, align 8
  store i64 0, i64* %RDI.i260, align 8
  store i8 0, i8* %var_2_14, align 1
  %var_2_785 = add i64 %.pre26, 193
  %call2_400aba = tail call %struct.Memory* @sub_400b40.find(%struct.State* nonnull %0, i64 %var_2_785, %struct.Memory* %var_2_623)
  %var_2_791 = load i32, i32* bitcast (%G_0x602058_type* @G_0x602058 to i32*), align 8
  store i8 0, i8* %var_2_14, align 1
  %var_2_797 = icmp eq i32 %var_2_791, 0
  br i1 %var_2_797, label %block_.L_400ae9, label %block_400acd

block_400acd:                                     ; preds = %block_.L_400ab8
  %var_2_802 = load i64, i64* bitcast (%G_0x602098_type* @G_0x602098 to i64*), align 8
  store i8 0, i8* %var_2_14, align 1
  %var_2_809 = icmp eq i64 %var_2_802, 0
  br i1 %var_2_809, label %block_.L_400ae9, label %block_400adc

block_400adc:                                     ; preds = %block_400acd
  store i64 10, i64* %RDI.i260, align 8
  %var_2_819 = tail call %struct.Memory* @__remill_function_call(%struct.State* nonnull %0, i64 ptrtoint (i64 (i64)* @putchar to i64), %struct.Memory* %call2_400aba)
  br label %block_.L_400ae9

block_.L_400ae9:                                  ; preds = %block_400adc, %block_400acd, %block_.L_400ab8
  %MEMORY.11 = phi %struct.Memory* [ %call2_400aba, %block_.L_400ab8 ], [ %call2_400aba, %block_400acd ], [ %var_2_819, %block_400adc ]
  %var_2_827 = load i64, i64* bitcast (%G_0x602098_type* @G_0x602098 to i64*), align 8
  %var_2_828 = add i64 %var_2_827, -1
  %var_2_837 = xor i64 %var_2_828, %var_2_827
  %var_2_838 = lshr i64 %var_2_837, 4
  %var_2_839 = trunc i64 %var_2_838 to i8
  %var_2_840 = and i8 %var_2_839, 1
  store i8 %var_2_840, i8* %var_2_27, align 1
  %var_2_841 = icmp eq i64 %var_2_828, 0
  %var_2_842 = zext i1 %var_2_841 to i8
  store i8 %var_2_842, i8* %var_2_30, align 1
  %.sink = select i1 %var_2_841, i64 ptrtoint (%G__0x400f95_type* @G__0x400f95 to i64), i64 ptrtoint (%G__0x400fad_type* @G__0x400fad to i64)
  store i64 %.sink, i64* %RDI.i260, align 8
  %var_2_871 = tail call %struct.Memory* @__remill_function_call(%struct.State* nonnull %0, i64 ptrtoint (i64 (i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64)* @printf to i64), %struct.Memory* %MEMORY.11)
  store i64 0, i64* %RDI.i260, align 8
  store i8 0, i8* %var_2_14, align 1
  %var_2_884 = tail call %struct.Memory* @__remill_function_call(%struct.State* nonnull %0, i64 ptrtoint (i64 (i64)* @exit to i64), %struct.Memory* %var_2_871)
  ret %struct.Memory* %var_2_884
}
