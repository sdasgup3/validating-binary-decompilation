...
block_.L_400cb9:                                  ; preds = %block_.L_400d33, %block_.L_400cb2
  %47 = phi i64 [ %.pre2, %block_.L_400cb2 ], [ %278, %block_.L_400d33 ]
  %MEMORY.1 = phi %struct.Memory* [ %MEMORY.0, %block_.L_400cb2 ], [ %240, %block_.L_400d33 ]
...
block_.L_400cd0:                                  ; preds = %block_.L_400d20, %block_400cc9
  %85 = phi i64 [ %.pre3, %block_400cc9 ], [ %234, %block_.L_400d20 ]
...
block_.L_400d33:                                  ; preds = %block_.L_400cd0
  ...
  %240 = tail call %struct.Memory* @__remill_function_call(%struct.State* %0, i64 ptrtoint (i64 (i64)* @putchar to i64), %struct.Memory* %MEMORY.2)
  %241 = load i64, i64* %RBP.i, align 8
  %242 = add i64 %241, -28
  %243 = load i32, i32* %EAX.i79.pre-phi, align 4
  ...
  store i64 %254, i64* %RAX.i81, align 8
...
block_.L_400d4e:                                  ; preds = %block_.L_400cb9
  %279 = load i64, i64* bitcast (%G_0x602060_type* @G_0x602060 to i64*), align 8
  store i64 %279, i64* %RDI.i68.pre-phi, align 8
  %280 = add i64 %81, -1918
  %281 = add i64 %81, 13
  ...
  %285 = tail call %struct.Memory* @__remill_function_call(%struct.State* %0, i64 ptrtoint (i64 (i64)* @fflush to i64), %struct.Memory* %MEMORY.1)
  %286 = load i64, i64* %RBP.i, align 8
  %287 = add i64 %286, -32
  %288 = load i32, i32* %EAX.i79.pre-phi, align 4
