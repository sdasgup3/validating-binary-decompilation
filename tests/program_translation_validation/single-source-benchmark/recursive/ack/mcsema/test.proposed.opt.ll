...
entry:
  ...
  br i1 %62, label %block_400508, label %block_.L_400516
...
block_400529:                                     ; preds = %block_.L_400516
  ...
  %call2_400534 = tail call %struct.Memory* @sub_4004f0.ack(%struct.State* %0, i64 %176, %struct.Memory* %2)
...
block_.L_400541:                                  ; preds = %block_.L_400516
  ...
  %194 = add i64 %193, 5
  %.pre1 = getelementptr inbounds %union.anon, %union.anon* %39, i64 0, i32 0
  %.pre2 = getelementptr inbounds %union.anon, %union.anon* %44, i64 0, i32 0
  br label %block_.L_40054e

block_.L_40054e:                                  ; preds = %block_.L_400541, %block_400529
  %storemerge = phi i64 [ %188, %block_400529 ], [ %194, %block_.L_400541 ]
  ...
  %call2_400556 = tail call %struct.Memory* @sub_4004f0.ack(%struct.State* %0, i64 %206, %struct.Memory* %MEMORY.0)
...
block_.L_40055e:                                  ; preds = %block_.L_40054e, %block_400508
  %217 = phi i64 [ %.pre, %block_.L_40054e ], [ %99, %block_400508 ]
  %MEMORY.1 = phi %struct.Memory* [ %call2_400556, %block_.L_40054e ], [ %2, %block_400508 ]
...
define %struct.Memory* @routine_jne_.L_400516(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i8* %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
...
define %struct.Memory* @routine_jmpq_.L_40055e(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
...
define %struct.Memory* @routine_je_.L_400541(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i8* %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 2, i32 7
...
define %struct.Memory* @routine_jmpq_.L_40054e(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
