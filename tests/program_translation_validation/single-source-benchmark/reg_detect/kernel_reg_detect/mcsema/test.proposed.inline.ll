...
define %struct.Memory* @kernel_reg_detect(%struct.State* noalias, i64, %struct.Memory* noalias) #2 {
entry:
  ...
  %158 = load i64, i64* %RBP.i548
  %159 = sub i64 %158, 44
  %160 = load i64, i64* %PC.i547
  %161 = add i64 %160, 7
  store i64 %161, i64* %PC.i547
  ...
  %PC.i545 = bitcast %union.anon* %165 to i64*
  %166 = getelementptr inbounds %struct.State, %struct.State* %0, i32 0, i32 6
  %167 = getelementptr inbounds %struct.GPR, %struct.GPR* %166, i32 0, i32 15
  %168 = getelementptr inbounds %struct.Reg, %struct.Reg* %167, i32 0, i32 0
  %RBP.i546 = bitcast %union.anon* %168 to i64*
  %169 = getelementptr inbounds %struct.State, %struct.State* %0, i32 0, i32 6
  %170 = getelementptr inbounds %struct.GPR, %struct.GPR* %169, i32 0, i32 21
  %171 = getelementptr inbounds %struct.Reg, %struct.Reg* %170, i32 0, i32 0
  %R10.i = bitcast %union.anon* %171 to i64*
  %172 = load i64, i64* %RBP.i546
  %173 = sub i64 %172, 64
  %174 = load i64, i64* %R10.i
  %175 = load i64, i64* %PC.i545
  %176 = add i64 %175, 4
  store i64 %176, i64* %PC.i545
...
block_.L_400b40:                                  ; preds = %block_.L_400e42, %entry
...
block_.L_400b53:                                  ; preds = %block_.L_400bf3, %block_400b4c
...
block_.L_400b6a:                                  ; preds = %block_.L_400be0, %block_400b64
...
block_.L_400be0:                                  ; preds = %block_.L_400bdb
...
block_.L_400c08:                                  ; preds = %block_.L_400d57, %block_.L_400c01
...
block_.L_400d57:                                  ; preds = %block_.L_400d52
...
block_.L_400da8:                                  ; preds = %block_.L_400e2f, %block_.L_400da1
...
block_.L_400e2f:                                  ; preds = %block_.L_400e2a
...
block_.L_400e42:                                  ; preds = %block_.L_400e3d
...
block_.L_400e50:                                  ; preds = %block_.L_400b40
  ...
  ret %struct.Memory* %loadMem_400e51
}
