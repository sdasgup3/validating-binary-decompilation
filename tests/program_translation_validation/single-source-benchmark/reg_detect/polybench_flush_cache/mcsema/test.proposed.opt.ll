...
block_.L_4006d2:                                  ; preds = %block_4006de, %entry
  %84 = phi i64 [ %172, %block_4006de ], [ %.pre, %entry ]
  ...
  br i1 %120, label %block_4006de, label %block_.L_400703
...
define %struct.Memory* @routine_jge_.L_400703(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i8* %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
