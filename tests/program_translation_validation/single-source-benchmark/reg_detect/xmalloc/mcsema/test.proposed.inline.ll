...
declare %struct.Memory* @sub_4005d0.posix_memalign_plt(%struct.State* dereferenceable(3376), i64, %struct.Memory*)

declare %struct.Memory* @sub_4005b0.fprintf_plt(%struct.State* dereferenceable(3376), i64, %struct.Memory*)

declare %struct.Memory* @sub_4005c0.exit_plt(%struct.State* dereferenceable(3376), i64, %struct.Memory*)

; Function Attrs: alwaysinline
define %struct.Memory* @xmalloc(%struct.State* noalias, i64, %struct.Memory* noalias) #1 {
entry:
