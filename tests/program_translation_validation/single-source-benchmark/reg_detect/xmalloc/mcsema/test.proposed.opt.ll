...
entry:
  ...
  br i1 %81, label %block_.L_400883, label %block_400879
...
block_400879:                                     ; preds = %entry
  ...
  br i1 %95, label %block_.L_4008a9, label %block_.L_400883

block_.L_400883:                                  ; preds = %block_400879, %entry
  %100 = phi i64 [ %99, %block_400879 ], [ %85, %entry ]
  store i64 ptrtoint (%G__0x4014c7_type* @G__0x4014c7 to i64), i64* %RSI.i45, align 8
...
block_.L_4008a9:                                  ; preds = %block_.L_400883, %block_400879
  %121 = phi i64 [ %.pre2, %block_.L_400883 ], [ %99, %block_400879 ]
  %122 = phi i64 [ %.pre, %block_.L_400883 ], [ %69, %block_400879 ]
  %MEMORY.1 = phi %struct.Memory* [ %120, %block_.L_400883 ], [ %62, %block_400879 ]
  %123 = add i64 %122, -16
  %124 = add i64 %121, 4
