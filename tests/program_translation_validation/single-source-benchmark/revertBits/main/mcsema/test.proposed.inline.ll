...
declare %struct.Memory* @sub_400450.strtoll_plt(%struct.State* dereferenceable(3376), i64, %struct.Memory*)

declare %struct.Memory* @sub_400550.ReverseBits32(%struct.State* dereferenceable(3376), i64, %struct.Memory*)

declare %struct.Memory* @sub_4005f0.ReverseBits64(%struct.State* dereferenceable(3376), i64, %struct.Memory*)
