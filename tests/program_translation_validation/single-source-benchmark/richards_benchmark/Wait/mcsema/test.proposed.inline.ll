...
define %struct.Memory* @Wait(%struct.State* noalias, i64, %struct.Memory* noalias) #1 {
entry:
  ...
  %37 = load i64, i64* inttoptr (i64 6299872 to i64*)
  ...
  %103 = load i64, i64* inttoptr (i64 6299872 to i64*)
  ...
  ret %struct.Memory* %loadMem_4008ce
}
