...
block_.L_400ae7:                                  ; preds = %block_400af5, %entry
  ...
  br i1 %cmpBr_400aef, label %block_.L_400b05, label %block_400af5

block_400af5:                                     ; preds = %block_.L_400ae7
...
block_.L_400b05:                                  ; preds = %block_.L_400ae7
  ...
  ret %struct.Memory* %loadMem_400b11
}
...
define %struct.Memory* @routine_je_.L_400b05(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i8* %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) {
block_400478:
  %3 = getelementptr inbounds %struct.State, %struct.State* %0, i32 0, i32 6
  %4 = getelementptr inbounds %struct.GPR, %struct.GPR* %3, i32 0, i32 33
  %5 = getelementptr inbounds %struct.Reg, %struct.Reg* %4, i32 0, i32 0
