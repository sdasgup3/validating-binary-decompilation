; ModuleID = '/tmp/tmp06yliyvg-query.ll'
...
entry:
  ...
  %var_2_95 = tail call %struct.Memory* @__remill_function_call(%struct.State* %0, i64 ptrtoint (i64 (i64)* @malloc to i64), %struct.Memory* %2)
  %var_2_102 = load i64, i64* %RBP.i, align 8
  %var_2_103 = add i64 %var_2_102, -56
  %var_2_106 = inttoptr i64 %var_2_103 to i64*
  %var_2_107 = load i64, i64* %var_2_106, align 8
  %var_2_108 = add i64 %var_2_102, -4
  ...
  %var_2_114 = add nsw i64 %var_2_113, 6299760
  %var_2_116 = inttoptr i64 %var_2_114 to i64*
  store i64 %var_2_107, i64* %var_2_116, align 8
  %var_2_126 = load i64, i64* %RBP.i, align 8
  %var_2_133 = add i64 %var_2_126, -56
  %var_2_135 = inttoptr i64 %var_2_133 to i64*
  %var_2_225 = load i64, i64* %var_2_135, align 8
  store i64 %var_2_225, i64* bitcast (%G_0x6020c8_type* @G_0x6020c8 to i64*), align 8
  ret %struct.Memory* %var_2_95
}
