...
declare %struct.Memory* @sub_400910.findtcb(%struct.State* dereferenceable(3376), i64, %struct.Memory*)

declare %struct.Memory* @sub_400ae0.append(%struct.State* dereferenceable(3376), i64, %struct.Memory*)

; Function Attrs: alwaysinline
define %struct.Memory* @qpkt(%struct.State* noalias, i64, %struct.Memory* noalias) #1 {
entry:
