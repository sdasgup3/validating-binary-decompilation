...
entry:
  ...
  %76 = load double, double* bitcast (%G_0x438__rip__type* @G_0x438__rip_ to double*)
...
block_400cd6:                                     ; preds = %block_.L_400cca
  ...
  %710 = load float, float* bitcast (%G_0x3b9__rip__type* @G_0x3b9__rip_ to float*)
  %711 = load float, float* inttoptr (i64 add (i64 ptrtoint (%G_0x3b9__rip__type* @G_0x3b9__rip_ to i64), i64 4) to float*)
  %712 = load float, float* inttoptr (i64 add (i64 ptrtoint (%G_0x3b9__rip__type* @G_0x3b9__rip_ to i64), i64 8) to float*)
  %713 = load float, float* inttoptr (i64 add (i64 ptrtoint (%G_0x3b9__rip__type* @G_0x3b9__rip_ to i64), i64 12) to float*)
