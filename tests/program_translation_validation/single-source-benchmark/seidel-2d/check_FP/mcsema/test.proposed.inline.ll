...
block_400d70:                                     ; preds = %routine_ucomisd_MINUS0x28__rbp____xmm0.exit
  ...
  %call2_400da1 = call %struct.Memory* @sub_400630.fprintf_plt(%struct.State* %0, i64 %loadPC_400da1, %struct.Memory* %loadMem2_400da1)
  store %struct.Memory* %call2_400da1, %struct.Memory** %MEMORY
