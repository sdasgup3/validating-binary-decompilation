...
%G_0x3b9__rip__4197671__type = type <{ [16 x i8] }>
%G_0x438__rip__4197536__type = type <{ [16 x i8] }>
%G_0x602080_type = type <{ [8 x i8] }>
%G__0x40112a_type = type <{ [8 x i8] }>
...
@G_0x3b9__rip__4197671_ = global %G_0x3b9__rip__4197671__type zeroinitializer
@G_0x438__rip__4197536_ = global %G_0x438__rip__4197536__type zeroinitializer
@G_0x602080 = global %G_0x602080_type zeroinitializer
@G__0x40112a = global %G__0x40112a_type zeroinitializer
...
entry:
  ...
  %76 = load double, double* bitcast (%G_0x438__rip__4197536__type* @G_0x438__rip__4197536_ to double*)
...
block_.L_400cb7:                                  ; preds = %block_.L_400d9d, %entry
  ...
  br i1 %cmpBr_400cbd, label %block_.L_400dab, label %block_400cc3
...
block_400cc3:                                     ; preds = %block_.L_400cb7
  ...
  br label %block_.L_400cca

block_.L_400cca:                                  ; preds = %block_.L_400d8a, %block_400cc3
  ...
  %loadBr_400cd0 = load i8, i8* %BRANCH_TAKEN
  %cmpBr_400cd0 = icmp eq i8 %loadBr_400cd0, 1
  br i1 %cmpBr_400cd0, label %block_.L_400d98, label %block_400cd6

block_400cd6:                                     ; preds = %block_.L_400cca
  ...
  %710 = load float, float* bitcast (%G_0x3b9__rip__4197671__type* @G_0x3b9__rip__4197671_ to float*)
  %711 = load float, float* inttoptr (i64 add (i64 ptrtoint (%G_0x3b9__rip__4197671__type* @G_0x3b9__rip__4197671_ to i64), i64 4) to float*)
  %712 = load float, float* inttoptr (i64 add (i64 ptrtoint (%G_0x3b9__rip__4197671__type* @G_0x3b9__rip__4197671_ to i64), i64 8) to float*)
  %713 = load float, float* inttoptr (i64 add (i64 ptrtoint (%G_0x3b9__rip__4197671__type* @G_0x3b9__rip__4197671_ to i64), i64 12) to float*)
...
; <label>:818:                                    ; preds = %810
  ...
  %821 = call %struct.Memory* @__remill_error(%struct.State* nonnull dereferenceable(3376) %0, i64 %820, %struct.Memory* %loadMem_400d35)
  br label %routine_ucomisd_MINUS0x28__rbp____xmm0.exit

; <label>:822:                                    ; preds = %block_400cd6
...
routine_ucomisd_MINUS0x28__rbp____xmm0.exit:      ; preds = %818, %835
  %839 = phi %struct.Memory* [ %821, %818 ], [ %loadMem_400d35, %835 ]
  ...
  %loadBr_400d3a = load i8, i8* %BRANCH_TAKEN
  %cmpBr_400d3a = icmp eq i8 %loadBr_400d3a, 1
  br i1 %cmpBr_400d3a, label %block_.L_400d85, label %block_400d40

block_400d40:                                     ; preds = %routine_ucomisd_MINUS0x28__rbp____xmm0.exit
  ...
  store i64 ptrtoint (%G__0x40112a_type* @G__0x40112a to i64), i64* %RSI.i, align 8
  ...
  %loadMem1_400d71 = load %struct.Memory*, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem1_400d71, %struct.Memory** %MEMORY
  %loadMem2_400d71 = load %struct.Memory*, %struct.Memory** %MEMORY
  %loadPC_400d71 = load i64, i64* %3
  %1018 = call %struct.Memory* @__remill_function_call(%struct.State* %0, i64 ptrtoint (i64 (i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64)* @fprintf to i64), %struct.Memory* %loadMem2_400d71)
...
block_.L_400d85:                                  ; preds = %routine_ucomisd_MINUS0x28__rbp____xmm0.exit
...
block_.L_400d8a:                                  ; preds = %block_.L_400d85
...
block_.L_400d98:                                  ; preds = %block_.L_400cca
...
block_.L_400dab:                                  ; preds = %block_.L_400cb7
...
block_.L_400db2:                                  ; preds = %block_.L_400dab, %block_400d40
  ...
  ret %struct.Memory* %loadMem_400dba
}
...
block_400478:
  ...
  %9 = load i64, i64* %PC
  %10 = ptrtoint %G_0x438__rip__4197536__type* @G_0x438__rip__4197536_ to i64
  %11 = load i64, i64* %PC
  %12 = add i64 %11, 8
  store i64 %12, i64* %PC
...
block_400478:
  ...
  %9 = load i64, i64* %PC
  %10 = ptrtoint %G_0x3b9__rip__4197671__type* @G_0x3b9__rip__4197671_ to i64
  %11 = load i64, i64* %PC
  %12 = add i64 %11, 7
  store i64 %12, i64* %PC
...
define %struct.Memory* @routine_jbe_.L_400d85(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i8* %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) {
block_400478:
  %3 = getelementptr inbounds %struct.State, %struct.State* %0, i32 0, i32 6
  %4 = getelementptr inbounds %struct.GPR, %struct.GPR* %3, i32 0, i32 33
  %5 = getelementptr inbounds %struct.Reg, %struct.Reg* %4, i32 0, i32 0
...
define %struct.Memory* @routine_movq__0x40112a___rsi(%struct.State* dereferenceable(3376), i64, %struct.Memory*) {
block_400478:
  %3 = getelementptr inbounds %struct.State, %struct.State* %0, i32 0, i32 6
  %4 = getelementptr inbounds %struct.GPR, %struct.GPR* %3, i32 0, i32 33
  %5 = getelementptr inbounds %struct.Reg, %struct.Reg* %4, i32 0, i32 0
  ...
  %10 = add i64 %9, 10
  store i64 %10, i64* %PC
  store i64 ptrtoint (%G__0x40112a_type* @G__0x40112a to i64), i64* %RSI, align 8
  ret %struct.Memory* %2
}
...
define %struct.Memory* @routine_jmpq_.L_400cca(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i64 %rel_off1, i64 %rel_off2) {
block_400478:
  %3 = getelementptr inbounds %struct.State, %struct.State* %0, i32 0, i32 6
  %4 = getelementptr inbounds %struct.GPR, %struct.GPR* %3, i32 0, i32 33
  %5 = getelementptr inbounds %struct.Reg, %struct.Reg* %4, i32 0, i32 0
