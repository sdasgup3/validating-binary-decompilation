...
block_.L_400cb7:                                  ; preds = %block_.L_400d98, %entry
  %89 = phi i64 [ %.pre, %entry ], [ %456, %block_.L_400d98 ]
  %MEMORY.0 = phi %struct.Memory* [ %2, %entry ], [ %MEMORY.1, %block_.L_400d98 ]
  ...
  br i1 %125, label %block_400cc3, label %block_.L_400dab
...
block_.L_400cca:                                  ; preds = %block_.L_400d85, %block_400cc3
  %130 = phi i64 [ %.pre3, %block_400cc3 ], [ %425, %block_.L_400d85 ]
  %MEMORY.1 = phi %struct.Memory* [ %MEMORY.0, %block_400cc3 ], [ %331, %block_.L_400d85 ]
  ...
  br i1 %166, label %block_400cd6, label %block_.L_400d98
...
routine_ucomisd_MINUS0x28__rbp____xmm0.exit:      ; preds = %329, %317
  ...
  br i1 %335, label %block_.L_400d85, label %block_400d40

block_400d40:                                     ; preds = %routine_ucomisd_MINUS0x28__rbp____xmm0.exit
  store i64 ptrtoint (%G__0x40112a_type* @G__0x40112a to i64), i64* %RSI.i143, align 8
...
block_.L_400db2:                                  ; preds = %block_.L_400dab, %block_400d40
  %460 = phi i64 [ %.pre5, %block_.L_400dab ], [ %393, %block_400d40 ]
  %MEMORY.2 = phi %struct.Memory* [ %MEMORY.0, %block_.L_400dab ], [ %380, %block_400d40 ]
...
define %struct.Memory* @routine_jge_.L_400dab(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i8* %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
...
define %struct.Memory* @routine_jge_.L_400d98(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i8* %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 2, i32 9
...
define %struct.Memory* @routine_jbe_.L_400d85(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i8* %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
...
define %struct.Memory* @routine_movq__0x40112a___rsi(%struct.State* dereferenceable(3376), i64, %struct.Memory*) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %RSI = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 9, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
...
define %struct.Memory* @routine_jmpq_.L_400cca(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
