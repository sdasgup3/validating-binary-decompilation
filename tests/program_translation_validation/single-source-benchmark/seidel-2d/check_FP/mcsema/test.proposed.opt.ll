...
@G_0x438__rip__4197536_ = local_unnamed_addr global %G_0x438__rip__4197536__type zeroinitializer
...
entry:
  ...
  %42 = load i64, i64* bitcast (%G_0x438__rip__4197536__type* @G_0x438__rip__4197536_ to i64*), align 8
...
block_.L_400cb7:                                  ; preds = %block_.L_400d98, %entry
  %88 = phi i64 [ %.pre, %entry ], [ %448, %block_.L_400d98 ]
  ...
  br i1 %124, label %block_400cc3, label %block_.L_400dab
...
block_.L_400cca:                                  ; preds = %block_.L_400d85, %block_400cc3
  %129 = phi i64 [ %.pre3, %block_400cc3 ], [ %418, %block_.L_400d85 ]
  %MEMORY.1 = phi %struct.Memory* [ %MEMORY.0, %block_400cc3 ], [ %327, %block_.L_400d85 ]
  ...
  br i1 %165, label %block_400cd6, label %block_.L_400d98
...
block_400cd6:                                     ; preds = %block_.L_400cca
  ...
  %276 = load i32, i32* bitcast (%G_0x3b9__rip__4197671__type* @G_0x3b9__rip__4197671_ to i32*), align 8
  %277 = load i32, i32* inttoptr (i64 add (i64 ptrtoint (%G_0x3b9__rip__4197671__type* @G_0x3b9__rip__4197671_ to i64), i64 4) to i32*), align 4
  %278 = load i32, i32* inttoptr (i64 add (i64 ptrtoint (%G_0x3b9__rip__4197671__type* @G_0x3b9__rip__4197671_ to i64), i64 8) to i32*), align 8
  %279 = load i32, i32* inttoptr (i64 add (i64 ptrtoint (%G_0x3b9__rip__4197671__type* @G_0x3b9__rip__4197671_ to i64), i64 12) to i32*), align 4
...
routine_ucomisd_MINUS0x28__rbp____xmm0.exit:      ; preds = %325, %313
  ...
  br i1 %331, label %block_.L_400d85, label %block_400d40
...
block_.L_400db2:                                  ; preds = %block_.L_400dab, %block_400d40
  %452 = phi i64 [ %.pre5, %block_.L_400dab ], [ %387, %block_400d40 ]
  %MEMORY.2 = phi %struct.Memory* [ %MEMORY.0, %block_.L_400dab ], [ %374, %block_400d40 ]
...
block_400478:
  ...
  %5 = load i64, i64* bitcast (%G_0x438__rip__4197536__type* @G_0x438__rip__4197536_ to i64*), align 8
...
block_400478:
  ...
  %6 = add i64 %5, 7
  store i64 %6, i64* %PC, align 8
  %7 = load i32, i32* bitcast (%G_0x3b9__rip__4197671__type* @G_0x3b9__rip__4197671_ to i32*), align 8
  %8 = load i32, i32* inttoptr (i64 add (i64 ptrtoint (%G_0x3b9__rip__4197671__type* @G_0x3b9__rip__4197671_ to i64), i64 4) to i32*), align 4
  %9 = load i32, i32* inttoptr (i64 add (i64 ptrtoint (%G_0x3b9__rip__4197671__type* @G_0x3b9__rip__4197671_ to i64), i64 8) to i32*), align 8
  %10 = load i32, i32* inttoptr (i64 add (i64 ptrtoint (%G_0x3b9__rip__4197671__type* @G_0x3b9__rip__4197671_ to i64), i64 12) to i32*), align 4
