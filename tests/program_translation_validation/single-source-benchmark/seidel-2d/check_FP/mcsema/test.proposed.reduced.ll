; ModuleID = '/tmp/tmpuh7fgceh-query.ll'
...
entry:
  ...
  br i1 %var_2_13122, label %block_400d03.preheader, label %block_.L_400df2

block_400d03.preheader:                           ; preds = %entry
  br label %block_400d03

block_.L_400cf7.loopexit.loopexit:                ; preds = %routine_ucomisd_MINUS0x28__rbp____xmm0.exit.block_.L_400d0a_crit_edge
  br label %block_.L_400cf7.loopexit

block_.L_400cf7.loopexit:                         ; preds = %block_.L_400cf7.loopexit.loopexit, %block_400d03
  %var_2_137.lcssa = phi i64 [ %var_2_1379, %block_400d03 ], [ %var_2_137.pre, %block_.L_400cf7.loopexit.loopexit ]
  %MEMORY.1.lcssa = phi %struct.Memory* [ %MEMORY.023, %block_400d03 ], [ %var_2_341, %block_.L_400cf7.loopexit.loopexit ]
  %var_2_146.lcssa = phi i32 [ %var_2_14624, %block_400d03 ], [ %var_2_146, %block_.L_400cf7.loopexit.loopexit ]
  %var_2_165.lcssa = phi i32 [ %var_2_16528, %block_400d03 ], [ %var_2_165, %block_.L_400cf7.loopexit.loopexit ]
  ...
  br i1 %var_2_131, label %block_400d03, label %block_.L_400df2.loopexit

block_400d03:                                     ; preds = %block_400d03.preheader, %block_.L_400cf7.loopexit
  %var_2_1379 = phi i64 [ %var_2_137.lcssa, %block_.L_400cf7.loopexit ], [ %var_2_966, %block_400d03.preheader ]
  %MEMORY.023 = phi %struct.Memory* [ %MEMORY.1.lcssa, %block_.L_400cf7.loopexit ], [ %2, %block_400d03.preheader ]
  ...
  br i1 %var_2_17234, label %block_400d16.preheader, label %block_.L_400cf7.loopexit

block_400d16.preheader:                           ; preds = %block_400d03
  br label %block_400d16

block_400d16:                                     ; preds = %block_400d16.preheader, %routine_ucomisd_MINUS0x28__rbp____xmm0.exit.block_.L_400d0a_crit_edge
  %MEMORY.136 = phi %struct.Memory* [ %var_2_341, %routine_ucomisd_MINUS0x28__rbp____xmm0.exit.block_.L_400d0a_crit_edge ], [ %MEMORY.023, %block_400d16.preheader ]
  %var_2_13735 = phi i64 [ %var_2_137.pre, %routine_ucomisd_MINUS0x28__rbp____xmm0.exit.block_.L_400d0a_crit_edge ], [ %var_2_1379, %block_400d16.preheader ]
  %var_2_273 = add i64 %var_2_13735, -48
  ...
  %var_2_278 = add i64 %var_2_13735, -56
...
var_2_327:                                        ; preds = %var_2_319
  %var_2_328 = tail call %struct.Memory* @__remill_error(%struct.State* nonnull dereferenceable(3376) %0, i64 %var_2_314, %struct.Memory* %MEMORY.136)
  br label %routine_ucomisd_MINUS0x28__rbp____xmm0.exit

routine_ucomisd_MINUS0x28__rbp____xmm0.exit:      ; preds = %var_2_327, %var_2_319, %block_400d16
  %var_2_341 = phi %struct.Memory* [ %var_2_328, %var_2_327 ], [ %MEMORY.136, %var_2_319 ], [ %MEMORY.136, %block_400d16 ]
  ...
  br i1 %var_2_345, label %block_400d80, label %routine_ucomisd_MINUS0x28__rbp____xmm0.exit.block_.L_400d0a_crit_edge

routine_ucomisd_MINUS0x28__rbp____xmm0.exit.block_.L_400d0a_crit_edge: ; preds = %routine_ucomisd_MINUS0x28__rbp____xmm0.exit
  ...
  br i1 %var_2_172, label %block_400d16, label %block_.L_400cf7.loopexit.loopexit

block_400d80:                                     ; preds = %routine_ucomisd_MINUS0x28__rbp____xmm0.exit
  %var_2_388 = tail call %struct.Memory* @__remill_function_call(%struct.State* nonnull %0, i64 ptrtoint (i64 (i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64)* @fprintf to i64), %struct.Memory* %var_2_341)
  br label %block_.L_400df2

block_.L_400df2.loopexit:                         ; preds = %block_.L_400cf7.loopexit
  br label %block_.L_400df2

block_.L_400df2:                                  ; preds = %block_.L_400df2.loopexit, %block_400d80, %entry
  %MEMORY.2 = phi %struct.Memory* [ %var_2_388, %block_400d80 ], [ %2, %entry ], [ %MEMORY.1.lcssa, %block_.L_400df2.loopexit ]
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_jge_.L_400deb(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i8* nocapture %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_jge_.L_400dd8(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i8* nocapture %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 2, i32 9
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_jbe_.L_400dc5(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i8* nocapture %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_movq__0x40116a___rsi(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %RSI = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 9, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_jmpq_.L_400d0a(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_jmpq_.L_400ddd(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_jmpq_.L_400cf7(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
