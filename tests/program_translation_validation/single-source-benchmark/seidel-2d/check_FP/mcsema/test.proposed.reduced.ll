; ModuleID = '/tmp/tmpg0_tk4kf-query.ll'
...
entry:
  ...
  br i1 %var_2_13121, label %block_400d03.preheader, label %block_.L_400df2
...
block_.L_400cf7.loopexit:                         ; preds = %block_.L_400cf7.loopexit.loopexit, %block_400d03
  %var_2_137.lcssa = phi i64 [ %var_2_13711, %block_400d03 ], [ %var_2_137.pre, %block_.L_400cf7.loopexit.loopexit ]
  %MEMORY.1.lcssa = phi %struct.Memory* [ %MEMORY.022, %block_400d03 ], [ %var_2_341, %block_.L_400cf7.loopexit.loopexit ]
  %var_2_146.lcssa = phi i32 [ %var_2_14628, %block_400d03 ], [ %var_2_146, %block_.L_400cf7.loopexit.loopexit ]
  %var_2_165.lcssa = phi i32 [ %var_2_16532, %block_400d03 ], [ %var_2_165, %block_.L_400cf7.loopexit.loopexit ]
  ...
  br i1 %var_2_131, label %block_400d03, label %block_.L_400df2.loopexit17

block_400d03:                                     ; preds = %block_400d03.preheader, %block_.L_400cf7.loopexit
  %var_2_13711 = phi i64 [ %var_2_137.lcssa, %block_.L_400cf7.loopexit ], [ %var_2_965, %block_400d03.preheader ]
  %MEMORY.022 = phi %struct.Memory* [ %MEMORY.1.lcssa, %block_.L_400cf7.loopexit ], [ %2, %block_400d03.preheader ]
  ...
  br i1 %var_2_17238, label %block_400d16.preheader, label %block_.L_400cf7.loopexit
...
block_400d16:                                     ; preds = %block_400d16.preheader, %routine_ucomisd_MINUS0x28__rbp____xmm0.exit.block_.L_400d0a_crit_edge
  %MEMORY.140 = phi %struct.Memory* [ %var_2_341, %routine_ucomisd_MINUS0x28__rbp____xmm0.exit.block_.L_400d0a_crit_edge ], [ %MEMORY.022, %block_400d16.preheader ]
  %var_2_13739 = phi i64 [ %var_2_137.pre, %routine_ucomisd_MINUS0x28__rbp____xmm0.exit.block_.L_400d0a_crit_edge ], [ %var_2_13711, %block_400d16.preheader ]
...
routine_ucomisd_MINUS0x28__rbp____xmm0.exit:      ; preds = %var_2_327, %var_2_319, %block_400d16
  %var_2_341 = phi %struct.Memory* [ %var_2_328, %var_2_327 ], [ %MEMORY.140, %var_2_319 ], [ %MEMORY.140, %block_400d16 ]
  ...
  br i1 %var_2_345, label %block_.L_400df2.loopexit, label %routine_ucomisd_MINUS0x28__rbp____xmm0.exit.block_.L_400d0a_crit_edge
...
block_.L_400df2.loopexit:                         ; preds = %routine_ucomisd_MINUS0x28__rbp____xmm0.exit
  br label %block_.L_400df2

block_.L_400df2.loopexit17:                       ; preds = %block_.L_400cf7.loopexit
  br label %block_.L_400df2

block_.L_400df2:                                  ; preds = %block_.L_400df2.loopexit17, %block_.L_400df2.loopexit, %entry
