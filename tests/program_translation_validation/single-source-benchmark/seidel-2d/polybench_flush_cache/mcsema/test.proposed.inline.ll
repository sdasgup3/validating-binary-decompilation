...
entry:
  ...
  store %struct.Memory* %loadMem1_40078a, %struct.Memory** %MEMORY
  %loadMem2_40078a = load %struct.Memory*, %struct.Memory** %MEMORY
  %loadPC_40078a = load i64, i64* %3
  %130 = call %struct.Memory* @__remill_function_call(%struct.State* %0, i64 ptrtoint (i64 (i64, i64)* @calloc to i64), %struct.Memory* %loadMem2_40078a)
...
block_.L_4007a2:                                  ; preds = %block_4007ae, %entry
  ...
  %loadBr_4007a8 = load i8, i8* %BRANCH_TAKEN
  %cmpBr_4007a8 = icmp eq i8 %loadBr_4007a8, 1
  br i1 %cmpBr_4007a8, label %block_.L_4007d3, label %block_4007ae

block_4007ae:                                     ; preds = %block_.L_4007a2
...
block_.L_4007d3:                                  ; preds = %block_.L_4007a2
  ...
  %loadMem1_4007da = load %struct.Memory*, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem1_4007da, %struct.Memory** %MEMORY
  %loadMem2_4007da = load %struct.Memory*, %struct.Memory** %MEMORY
  %loadPC_4007da = load i64, i64* %3
  %511 = call %struct.Memory* @__remill_function_call(%struct.State* %0, i64 ptrtoint (i64 (i64)* @free to i64), %struct.Memory* %loadMem2_4007da)
  ...
  ret %struct.Memory* %loadMem_4007e4
}
...
define %struct.Memory* @routine_jge_.L_4007d3(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i8* %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) {
block_400488:
  %3 = getelementptr inbounds %struct.State, %struct.State* %0, i32 0, i32 6
  %4 = getelementptr inbounds %struct.GPR, %struct.GPR* %3, i32 0, i32 33
  %5 = getelementptr inbounds %struct.Reg, %struct.Reg* %4, i32 0, i32 0
