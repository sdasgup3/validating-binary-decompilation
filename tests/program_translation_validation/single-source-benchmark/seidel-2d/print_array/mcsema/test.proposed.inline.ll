...
entry:
  ...
  %216 = call %struct.Memory* @__remill_function_call(%struct.State* %0, i64 ptrtoint (i64 (i64)* @malloc to i64), %struct.Memory* %loadMem2_400ddb)
...
block_400e1b:                                     ; preds = %block_.L_400e0f
  ...
  store %struct.Memory* %loadMem1_400e42, %struct.Memory** %MEMORY
...
block_.L_400e55:                                  ; preds = %block_.L_400e0f
  ...
  %870 = call %struct.Memory* @__remill_function_call(%struct.State* %0, i64 ptrtoint (i64 (i64, i64)* @fputs to i64), %struct.Memory* %loadMem2_400e61)
...
block_.L_400e77:                                  ; preds = %block_.L_400dfc
  ...
  %998 = call %struct.Memory* @__remill_function_call(%struct.State* %0, i64 ptrtoint (i64 (i64)* @free to i64), %struct.Memory* %loadMem2_400e7b)
  ...
  ret %struct.Memory* %loadMem_400e85
}
