...
entry:
  ...
  %216 = call %struct.Memory* @__remill_function_call(%struct.State* %0, i64 ptrtoint (i64 (i64)* @malloc to i64), %struct.Memory* %loadMem2_400e0b)
...
block_400e4b:                                     ; preds = %block_.L_400e3f
  ...
  store %struct.Memory* %loadMem1_400e72, %struct.Memory** %MEMORY
...
block_.L_400e85:                                  ; preds = %block_.L_400e3f
  ...
  store %struct.Memory* %loadMem1_400e91, %struct.Memory** %MEMORY
  %loadMem2_400e91 = load %struct.Memory*, %struct.Memory** %MEMORY
  %loadPC_400e91 = load i64, i64* %3
  %870 = call %struct.Memory* @__remill_function_call(%struct.State* %0, i64 ptrtoint (i64 (i64, i64)* @fputs to i64), %struct.Memory* %loadMem2_400e91)
...
block_.L_400ea7:                                  ; preds = %block_.L_400e2c
  ...
  store %struct.Memory* %loadMem1_400eab, %struct.Memory** %MEMORY
  %loadMem2_400eab = load %struct.Memory*, %struct.Memory** %MEMORY
  %loadPC_400eab = load i64, i64* %3
  %998 = call %struct.Memory* @__remill_function_call(%struct.State* %0, i64 ptrtoint (i64 (i64)* @free to i64), %struct.Memory* %loadMem2_400eab)
  ...
  ret %struct.Memory* %loadMem_400eb5
}
