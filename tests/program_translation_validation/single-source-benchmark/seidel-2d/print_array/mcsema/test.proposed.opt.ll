...
block_.L_400dfc:                                  ; preds = %block_.L_400e55, %entry
  %117 = phi i64 [ %.pre, %entry ], [ %348, %block_.L_400e55 ]
  %MEMORY.0 = phi %struct.Memory* [ %73, %entry ], [ %310, %block_.L_400e55 ]
...
block_.L_400e0f:                                  ; preds = %block_400e1b, %block_400e08
  %158 = phi i64 [ %.pre1, %block_400e08 ], [ %299, %block_400e1b ]
...
block_400e1b:                                     ; preds = %block_.L_400e0f
  ...
  %call2_400e42 = tail call %struct.Memory* @sub_400e90.print_element(%struct.State* %0, i64 %263, %struct.Memory* %MEMORY.1)
