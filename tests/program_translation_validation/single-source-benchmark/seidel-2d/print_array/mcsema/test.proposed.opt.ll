...
declare %struct.Memory* @sub_400ec0.print_element(%struct.State* noalias dereferenceable(3376), i64, %struct.Memory* noalias readnone returned) local_unnamed_addr
...
block_.L_400e2c:                                  ; preds = %block_.L_400e85, %entry
  %123 = phi i64 [ %352, %block_.L_400e85 ], [ %.pre, %entry ]
...
block_.L_400e3f:                                  ; preds = %block_400e4b, %block_400e38
  %164 = phi i64 [ %304, %block_400e4b ], [ %.pre8, %block_400e38 ]
...
block_400e4b:                                     ; preds = %block_.L_400e3f
  ...
  %call2_400e72 = tail call %struct.Memory* @sub_400ec0.print_element(%struct.State* nonnull %0, i64 %268, %struct.Memory* %call2_400e0b)
...
block_.L_400e85:                                  ; preds = %block_.L_400e3f
  ...
  %call2_400e91 = tail call %struct.Memory* @sub_400610.fputs_plt(%struct.State* nonnull %0, i64 %310, %struct.Memory* %call2_400e0b)
...
block_.L_400ea7:                                  ; preds = %block_.L_400e2c
  ...
  %call2_400eab = tail call %struct.Memory* @sub_4005f0.free_plt(%struct.State* nonnull %0, i64 %357, %struct.Memory* %call2_400e0b)
