; ModuleID = '/tmp/tmp6kfrf8vc-query.ll'
...
entry:
  ...
  br i1 %var_2_16034, label %block_400e48.preheader, label %block_.L_400eb7

block_400e48.preheader:                           ; preds = %entry
  br label %block_400e48

block_400e48:                                     ; preds = %block_400e48.preheader, %block_.L_400e95
  %var_2_175 = phi i32 [ %var_2_134, %block_.L_400e95 ], [ %var_2_13424, %block_400e48.preheader ]
  %var_2_1661 = phi i64 [ %var_2_125, %block_.L_400e95 ], [ %var_2_12518, %block_400e48.preheader ]
  %MEMORY.035 = phi %struct.Memory* [ %var_2_316, %block_.L_400e95 ], [ %var_2_79, %block_400e48.preheader ]
  ...
  br i1 %var_2_20117, label %block_400e5b.preheader, label %block_.L_400e95

block_400e5b.preheader:                           ; preds = %block_400e48
  br label %block_400e5b

block_400e5b:                                     ; preds = %block_400e5b.preheader, %block_400e5b
  br label %block_400e5b

block_.L_400e95:                                  ; preds = %block_400e48
  ...
  br i1 %var_2_160, label %block_400e48, label %block_.L_400eb7.loopexit

block_.L_400eb7.loopexit:                         ; preds = %block_.L_400e95
  br label %block_.L_400eb7

block_.L_400eb7:                                  ; preds = %block_.L_400eb7.loopexit, %entry
  %MEMORY.0.lcssa = phi %struct.Memory* [ %var_2_79, %entry ], [ %var_2_316, %block_.L_400eb7.loopexit ]
