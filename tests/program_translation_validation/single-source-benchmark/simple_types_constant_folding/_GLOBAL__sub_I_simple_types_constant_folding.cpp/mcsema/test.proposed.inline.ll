...
declare %struct.Memory* @sub_4006f0.__cxx_global_var_init(%struct.State* noalias dereferenceable(3376), i64, %struct.Memory* noalias readnone returned)
...
entry:
  ...
  %call2_4006e4 = call %struct.Memory* @sub_4006f0.__cxx_global_var_init(%struct.State* %0, i64 %loadPC_4006e4, %struct.Memory* %loadMem2_4006e4)
  ...
  ret %struct.Memory* %loadMem_4006ea
}
