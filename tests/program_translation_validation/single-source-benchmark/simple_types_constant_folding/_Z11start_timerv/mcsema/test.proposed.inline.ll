...
entry:
  ...
  %loadMem1_400e94 = load %struct.Memory*, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem1_400e94, %struct.Memory** %MEMORY
  %loadMem2_400e94 = load %struct.Memory*, %struct.Memory** %MEMORY
  %loadPC_400e94 = load i64, i64* %3
  %43 = call %struct.Memory* @__remill_function_call(%struct.State* %0, i64 ptrtoint (i64 ()* @clock to i64), %struct.Memory* %loadMem2_400e94)
  ...
  ret %struct.Memory* %loadMem_400ea2
}
