...
declare %struct.Memory* @sub_418900._ZN10custom_twoIaE8do_shiftEa(%struct.State* noalias dereferenceable(3376), i64, %struct.Memory* noalias readnone returned) local_unnamed_addr

declare %struct.Memory* @sub_418920._Z17check_shifted_sumIa10custom_twoIaEEvT_(%struct.State* noalias dereferenceable(3376), i64, %struct.Memory* noalias readnone returned) local_unnamed_addr
...
define %struct.Memory* @_Z13test_constantIa10custom_twoIaEEvPT_iPKc(%struct.State* noalias, i64, %struct.Memory* noalias readnone) local_unnamed_addr #1 {
entry:
...
block_.L_402bbf:                                  ; preds = %block_.L_402c13, %entry
  %69 = phi i64 [ %283, %block_.L_402c13 ], [ %.pre, %entry ]
...
block_.L_402bda:                                  ; preds = %block_402be6, %block_402bcf
  %112 = phi i64 [ %240, %block_402be6 ], [ %.pre6, %block_402bcf ]
...
block_402be6:                                     ; preds = %block_.L_402bda
  ...
  %call2_402bf2 = tail call %struct.Memory* @sub_418900._ZN10custom_twoIaE8do_shiftEa(%struct.State* nonnull %0, i64 %163, %struct.Memory* %call2_402bb3)
...
block_.L_402c13:                                  ; preds = %block_.L_402bda
  ...
  %call2_402c17 = tail call %struct.Memory* @sub_418920._Z17check_shifted_sumIa10custom_twoIaEEvT_(%struct.State* nonnull %0, i64 %247, %struct.Memory* %call2_402bb3)
...
block_.L_402c2a:                                  ; preds = %block_.L_402bbf
  ...
  %call2_402c2a = tail call %struct.Memory* @sub_400ea0._Z5timerv(%struct.State* nonnull %0, i64 %284, %struct.Memory* %call2_402bb3)
