...
block_.L_402b7f:                                  ; preds = %block_.L_402bd3, %entry
  %69 = phi i64 [ %.pre, %entry ], [ %282, %block_.L_402bd3 ]
...
block_.L_402b9a:                                  ; preds = %block_402ba6, %block_402b8f
  %112 = phi i64 [ %.pre1, %block_402b8f ], [ %239, %block_402ba6 ]
...
block_.L_402bd3:                                  ; preds = %block_.L_402b9a
  ...
  %call2_402bd7 = tail call %struct.Memory* @sub_4188e0._Z17check_shifted_sumIa10custom_twoIaEEvT_(%struct.State* %0, i64 %246, %struct.Memory* %MEMORY.1)
...
block_.L_402bea:                                  ; preds = %block_.L_402b7f
  ...
  %call2_402bea = tail call %struct.Memory* @sub_400e60._Z5timerv(%struct.State* %0, i64 %283, %struct.Memory* %MEMORY.0)
  ...
  %call2_402bf3 = tail call %struct.Memory* @sub_400800._Z13record_resultdPKc(%struct.State* %0, i64 %294, %struct.Memory* %call2_402bea)
