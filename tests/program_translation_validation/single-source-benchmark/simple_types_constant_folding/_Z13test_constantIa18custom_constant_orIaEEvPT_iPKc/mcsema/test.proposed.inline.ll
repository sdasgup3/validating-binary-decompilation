...
declare %struct.Memory* @sub_417900._Z17check_shifted_sumIa18custom_constant_orIaEEvT_(%struct.State* dereferenceable(3376), i64, %struct.Memory*)
...
define %struct.Memory* @_Z13test_constantIa18custom_constant_orIaEEvPT_iPKc(%struct.State* noalias, i64, %struct.Memory* noalias) #1 {
entry:
