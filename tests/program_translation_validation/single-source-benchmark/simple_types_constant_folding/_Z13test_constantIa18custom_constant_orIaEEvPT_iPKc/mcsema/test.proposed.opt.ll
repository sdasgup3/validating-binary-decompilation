...
declare %struct.Memory* @sub_417910._Z17check_shifted_sumIa18custom_constant_orIaEEvT_(%struct.State* noalias dereferenceable(3376), i64, %struct.Memory* noalias readnone returned) local_unnamed_addr
...
entry:
  ...
  %call2_403d43 = tail call %struct.Memory* @sub_400e90._Z11start_timerv(%struct.State* %0, i64 %58, %struct.Memory* %2)
...
block_.L_403d4f:                                  ; preds = %block_.L_403da3, %entry
  %69 = phi i64 [ %283, %block_.L_403da3 ], [ %.pre, %entry ]
  ...
  br i1 %102, label %block_403d5f, label %block_.L_403dba
...
block_.L_403d6a:                                  ; preds = %block_403d76, %block_403d5f
  %112 = phi i64 [ %240, %block_403d76 ], [ %.pre6, %block_403d5f ]
  ...
  br i1 %148, label %block_403d76, label %block_.L_403da3
...
block_403d76:                                     ; preds = %block_.L_403d6a
  ...
  %call2_403d82 = tail call %struct.Memory* @sub_4178f0._ZN18custom_constant_orIaE8do_shiftEa(%struct.State* nonnull %0, i64 %163, %struct.Memory* %call2_403d43)
...
block_.L_403da3:                                  ; preds = %block_.L_403d6a
  ...
  %call2_403da7 = tail call %struct.Memory* @sub_417910._Z17check_shifted_sumIa18custom_constant_orIaEEvT_(%struct.State* nonnull %0, i64 %247, %struct.Memory* %call2_403d43)
...
block_.L_403dba:                                  ; preds = %block_.L_403d4f
  ...
  %call2_403dba = tail call %struct.Memory* @sub_400eb0._Z5timerv(%struct.State* nonnull %0, i64 %284, %struct.Memory* %call2_403d43)
  ...
  %call2_403dc3 = tail call %struct.Memory* @sub_400850._Z13record_resultdPKc(%struct.State* nonnull %0, i64 %295, %struct.Memory* %call2_403dba)
