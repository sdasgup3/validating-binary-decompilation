...
block_.L_403cff:                                  ; preds = %block_.L_403d53, %entry
  %69 = phi i64 [ %.pre, %entry ], [ %284, %block_.L_403d53 ]
...
block_.L_403d1a:                                  ; preds = %block_403d26, %block_403d0f
  %112 = phi i64 [ %.pre1, %block_403d0f ], [ %240, %block_403d26 ]
...
block_.L_403d53:                                  ; preds = %block_.L_403d1a
  ...
  %call2_403d57 = tail call %struct.Memory* @sub_4178c0._Z17check_shifted_sumIa18custom_constant_orIaEEvT_(%struct.State* %0, i64 %247, %struct.Memory* %MEMORY.1)
...
block_.L_403d6a:                                  ; preds = %block_.L_403cff
  ...
  %call2_403d6a = tail call %struct.Memory* @sub_400e60._Z5timerv(%struct.State* %0, i64 %285, %struct.Memory* %MEMORY.0)
  ...
  %call2_403d73 = tail call %struct.Memory* @sub_400800._Z13record_resultdPKc(%struct.State* %0, i64 %296, %struct.Memory* %call2_403d6a)
