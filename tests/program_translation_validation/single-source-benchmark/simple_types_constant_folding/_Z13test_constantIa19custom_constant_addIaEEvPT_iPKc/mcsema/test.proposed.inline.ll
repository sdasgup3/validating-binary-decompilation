...
declare %struct.Memory* @sub_4180b0._Z17check_shifted_sumIa19custom_constant_addIaEEvT_(%struct.State* dereferenceable(3376), i64, %struct.Memory*)
...
define %struct.Memory* @_Z13test_constantIa19custom_constant_addIaEEvPT_iPKc(%struct.State* noalias, i64, %struct.Memory* noalias) #1 {
entry:
