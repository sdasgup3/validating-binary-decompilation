...
block_.L_403bbf:                                  ; preds = %block_.L_403c13, %entry
  %69 = phi i64 [ %.pre, %entry ], [ %282, %block_.L_403c13 ]
...
block_.L_403bda:                                  ; preds = %block_403be6, %block_403bcf
  %112 = phi i64 [ %.pre1, %block_403bcf ], [ %239, %block_403be6 ]
...
block_.L_403c13:                                  ; preds = %block_.L_403bda
  ...
  %call2_403c17 = tail call %struct.Memory* @sub_4179f0._Z17check_shifted_sumIa19custom_constant_andIaEEvT_(%struct.State* %0, i64 %246, %struct.Memory* %MEMORY.1)
...
block_.L_403c2a:                                  ; preds = %block_.L_403bbf
  ...
  %call2_403c2a = tail call %struct.Memory* @sub_400e60._Z5timerv(%struct.State* %0, i64 %283, %struct.Memory* %MEMORY.0)
  ...
  %call2_403c33 = tail call %struct.Memory* @sub_400800._Z13record_resultdPKc(%struct.State* %0, i64 %294, %struct.Memory* %call2_403c2a)
