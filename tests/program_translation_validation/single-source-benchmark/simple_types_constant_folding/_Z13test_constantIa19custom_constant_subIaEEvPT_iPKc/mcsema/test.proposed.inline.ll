...
define %struct.Memory* @_Z13test_constantIa19custom_constant_subIaEEvPT_iPKc(%struct.State* noalias, i64, %struct.Memory* noalias) #1 {
entry:
  ...
  store %struct.Memory* %loadMem1_403653, %struct.Memory** %MEMORY
...
block_403686:                                     ; preds = %block_.L_40367a
  ...
  store %struct.Memory* %loadMem_403686, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem1_403692, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_403697, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_4036a5, %struct.Memory** %MEMORY
