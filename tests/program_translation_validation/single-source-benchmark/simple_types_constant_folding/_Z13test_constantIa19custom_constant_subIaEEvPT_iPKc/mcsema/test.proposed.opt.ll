...
declare %struct.Memory* @sub_417f90._Z17check_shifted_sumIa19custom_constant_subIaEEvT_(%struct.State* noalias dereferenceable(3376), i64, %struct.Memory* noalias readnone returned) local_unnamed_addr
...
entry:
  ...
  %call2_403663 = tail call %struct.Memory* @sub_400e90._Z11start_timerv(%struct.State* %0, i64 %58, %struct.Memory* %2)
...
block_.L_40366f:                                  ; preds = %block_.L_4036c3, %entry
  %69 = phi i64 [ %283, %block_.L_4036c3 ], [ %.pre, %entry ]
  ...
  br i1 %102, label %block_40367f, label %block_.L_4036da

block_40367f:                                     ; preds = %block_.L_40366f
  %104 = add i64 %70, -29
  %105 = add i64 %103, 4
...
block_.L_40368a:                                  ; preds = %block_403696, %block_40367f
  %112 = phi i64 [ %240, %block_403696 ], [ %.pre6, %block_40367f ]
  ...
  br i1 %148, label %block_403696, label %block_.L_4036c3

block_403696:                                     ; preds = %block_.L_40368a
  %150 = add i64 %113, -8
  %151 = add i64 %149, 4
  ...
  %call2_4036a2 = tail call %struct.Memory* @sub_417f70._ZN19custom_constant_subIaE8do_shiftEa(%struct.State* nonnull %0, i64 %163, %struct.Memory* %call2_403663)
...
block_.L_4036c3:                                  ; preds = %block_.L_40368a
  %241 = add i64 %113, -29
  %242 = add i64 %149, 4
  ...
  %call2_4036c7 = tail call %struct.Memory* @sub_417f90._Z17check_shifted_sumIa19custom_constant_subIaEEvT_(%struct.State* nonnull %0, i64 %247, %struct.Memory* %call2_403663)
...
block_.L_4036da:                                  ; preds = %block_.L_40366f
  ...
  %call2_4036da = tail call %struct.Memory* @sub_400eb0._Z5timerv(%struct.State* nonnull %0, i64 %284, %struct.Memory* %call2_403663)
  ...
  %call2_4036e3 = tail call %struct.Memory* @sub_400850._Z13record_resultdPKc(%struct.State* nonnull %0, i64 %295, %struct.Memory* %call2_4036da)
...
; Function Attrs: alwaysinline norecurse nounwind
define %struct.Memory* @routine_jge_.L_4036c3(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i8* nocapture %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 2, i32 9
...
; Function Attrs: alwaysinline norecurse nounwind
define %struct.Memory* @routine_jmpq_.L_40368a(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
...
; Function Attrs: alwaysinline norecurse nounwind
define %struct.Memory* @routine_jmpq_.L_40366f(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
