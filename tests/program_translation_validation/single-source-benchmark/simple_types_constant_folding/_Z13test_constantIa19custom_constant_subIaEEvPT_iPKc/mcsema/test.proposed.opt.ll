...
declare %struct.Memory* @sub_417f80._Z17check_shifted_sumIa19custom_constant_subIaEEvT_(%struct.State* noalias dereferenceable(3376), i64, %struct.Memory* noalias readnone returned) local_unnamed_addr
...
define %struct.Memory* @_Z13test_constantIa19custom_constant_subIaEEvPT_iPKc(%struct.State* noalias, i64, %struct.Memory* noalias readnone) local_unnamed_addr #1 {
entry:
...
block_.L_40365f:                                  ; preds = %block_.L_4036b3, %entry
  %69 = phi i64 [ %283, %block_.L_4036b3 ], [ %.pre, %entry ]
...
block_.L_40367a:                                  ; preds = %block_403686, %block_40366f
  %112 = phi i64 [ %240, %block_403686 ], [ %.pre6, %block_40366f ]
...
block_403686:                                     ; preds = %block_.L_40367a
  ...
  %call2_403692 = tail call %struct.Memory* @sub_417f60._ZN19custom_constant_subIaE8do_shiftEa(%struct.State* nonnull %0, i64 %163, %struct.Memory* %call2_403653)
...
block_.L_4036b3:                                  ; preds = %block_.L_40367a
  ...
  %call2_4036b7 = tail call %struct.Memory* @sub_417f80._Z17check_shifted_sumIa19custom_constant_subIaEEvT_(%struct.State* nonnull %0, i64 %247, %struct.Memory* %call2_403653)
...
block_.L_4036ca:                                  ; preds = %block_.L_40365f
  ...
  %call2_4036ca = tail call %struct.Memory* @sub_400ea0._Z5timerv(%struct.State* nonnull %0, i64 %284, %struct.Memory* %call2_403653)
