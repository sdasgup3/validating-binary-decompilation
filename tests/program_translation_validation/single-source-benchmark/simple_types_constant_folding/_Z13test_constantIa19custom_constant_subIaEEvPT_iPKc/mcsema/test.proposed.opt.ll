...
declare %struct.Memory* @sub_417f40._Z17check_shifted_sumIa19custom_constant_subIaEEvT_(%struct.State* noalias dereferenceable(3376), i64, %struct.Memory* noalias readnone returned) local_unnamed_addr
...
entry:
  ...
  %call2_403613 = tail call %struct.Memory* @sub_400e40._Z11start_timerv(%struct.State* %0, i64 %58, %struct.Memory* %2)
...
block_.L_40361f:                                  ; preds = %block_.L_403673, %entry
  %69 = phi i64 [ %.pre, %entry ], [ %284, %block_.L_403673 ]
  %MEMORY.0 = phi %struct.Memory* [ %call2_403613, %entry ], [ %call2_403677, %block_.L_403673 ]
  ...
  br i1 %102, label %block_40362f, label %block_.L_40368a

block_40362f:                                     ; preds = %block_.L_40361f
  %104 = add i64 %70, -29
  %105 = add i64 %103, 4
...
block_.L_40363a:                                  ; preds = %block_403646, %block_40362f
  %112 = phi i64 [ %.pre1, %block_40362f ], [ %240, %block_403646 ]
  %MEMORY.1 = phi %struct.Memory* [ %MEMORY.0, %block_40362f ], [ %call2_403652, %block_403646 ]
  ...
  br i1 %148, label %block_403646, label %block_.L_403673

block_403646:                                     ; preds = %block_.L_40363a
  %150 = add i64 %113, -8
  %151 = add i64 %149, 4
  ...
  %call2_403652 = tail call %struct.Memory* @sub_417f20._ZN19custom_constant_subIaE8do_shiftEa(%struct.State* %0, i64 %163, %struct.Memory* %MEMORY.1)
...
block_.L_403673:                                  ; preds = %block_.L_40363a
  %241 = add i64 %113, -29
  %242 = add i64 %149, 4
  ...
  %call2_403677 = tail call %struct.Memory* @sub_417f40._Z17check_shifted_sumIa19custom_constant_subIaEEvT_(%struct.State* %0, i64 %247, %struct.Memory* %MEMORY.1)
...
block_.L_40368a:                                  ; preds = %block_.L_40361f
  %285 = add i64 %103, -10282
  %286 = add i64 %103, 5
  ...
  %call2_40368a = tail call %struct.Memory* @sub_400e60._Z5timerv(%struct.State* %0, i64 %285, %struct.Memory* %MEMORY.0)
  ...
  %call2_403693 = tail call %struct.Memory* @sub_400800._Z13record_resultdPKc(%struct.State* %0, i64 %296, %struct.Memory* %call2_40368a)
  ...
  ret %struct.Memory* %call2_403693
}
...
define %struct.Memory* @routine_jge_.L_40368a(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i8* %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
...
define %struct.Memory* @routine_jge_.L_403673(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i8* %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 2, i32 9
...
define %struct.Memory* @routine_jmpq_.L_40363a(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
...
define %struct.Memory* @routine_callq_._Z17check_shifted_sumIa19custom_constant_subIaEEvT_(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
...
define %struct.Memory* @routine_jmpq_.L_40361f(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
