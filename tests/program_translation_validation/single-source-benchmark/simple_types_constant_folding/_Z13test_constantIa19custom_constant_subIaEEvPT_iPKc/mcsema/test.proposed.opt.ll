...
block_.L_40361f:                                  ; preds = %block_.L_403673, %entry
  %69 = phi i64 [ %.pre, %entry ], [ %282, %block_.L_403673 ]
...
block_.L_40363a:                                  ; preds = %block_403646, %block_40362f
  %112 = phi i64 [ %.pre1, %block_40362f ], [ %239, %block_403646 ]
...
block_.L_403673:                                  ; preds = %block_.L_40363a
  ...
  %call2_403677 = tail call %struct.Memory* @sub_417f40._Z17check_shifted_sumIa19custom_constant_subIaEEvT_(%struct.State* %0, i64 %246, %struct.Memory* %MEMORY.1)
...
block_.L_40368a:                                  ; preds = %block_.L_40361f
  ...
  %call2_40368a = tail call %struct.Memory* @sub_400e60._Z5timerv(%struct.State* %0, i64 %283, %struct.Memory* %MEMORY.0)
  ...
  %call2_403693 = tail call %struct.Memory* @sub_400800._Z13record_resultdPKc(%struct.State* %0, i64 %294, %struct.Memory* %call2_40368a)
