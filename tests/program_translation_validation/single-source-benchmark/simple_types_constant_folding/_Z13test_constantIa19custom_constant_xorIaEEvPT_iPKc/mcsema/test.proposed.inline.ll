...
declare %struct.Memory* @sub_4177d0._Z17check_shifted_sumIa19custom_constant_xorIaEEvT_(%struct.State* dereferenceable(3376), i64, %struct.Memory*)
...
define %struct.Memory* @_Z13test_constantIa19custom_constant_xorIaEEvPT_iPKc(%struct.State* noalias, i64, %struct.Memory* noalias) #1 {
entry:
