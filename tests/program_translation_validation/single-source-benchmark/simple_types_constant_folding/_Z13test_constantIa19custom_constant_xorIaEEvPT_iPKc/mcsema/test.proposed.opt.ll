...
block_.L_403e3f:                                  ; preds = %block_.L_403e93, %entry
  %69 = phi i64 [ %.pre, %entry ], [ %282, %block_.L_403e93 ]
...
block_.L_403e5a:                                  ; preds = %block_403e66, %block_403e4f
  %112 = phi i64 [ %.pre1, %block_403e4f ], [ %239, %block_403e66 ]
...
block_.L_403e93:                                  ; preds = %block_.L_403e5a
  ...
  %call2_403e97 = tail call %struct.Memory* @sub_417790._Z17check_shifted_sumIa19custom_constant_xorIaEEvT_(%struct.State* %0, i64 %246, %struct.Memory* %MEMORY.1)
...
block_.L_403eaa:                                  ; preds = %block_.L_403e3f
  ...
  %call2_403eaa = tail call %struct.Memory* @sub_400e60._Z5timerv(%struct.State* %0, i64 %283, %struct.Memory* %MEMORY.0)
  ...
  %call2_403eb3 = tail call %struct.Memory* @sub_400800._Z13record_resultdPKc(%struct.State* %0, i64 %294, %struct.Memory* %call2_403eaa)
