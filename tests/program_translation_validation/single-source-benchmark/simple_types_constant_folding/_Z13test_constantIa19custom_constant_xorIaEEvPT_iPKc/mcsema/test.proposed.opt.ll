...
declare %struct.Memory* @sub_4177b0._ZN19custom_constant_xorIaE8do_shiftEa(%struct.State* dereferenceable(3376), i64, %struct.Memory*) local_unnamed_addr

declare %struct.Memory* @sub_4177d0._Z17check_shifted_sumIa19custom_constant_xorIaEEvT_(%struct.State* dereferenceable(3376), i64, %struct.Memory*) local_unnamed_addr
...
block_.L_403e7f:                                  ; preds = %block_.L_403ed3, %entry
  %69 = phi i64 [ %.pre, %entry ], [ %283, %block_.L_403ed3 ]
  %MEMORY.0 = phi %struct.Memory* [ %call2_403e73, %entry ], [ %call2_403ed7, %block_.L_403ed3 ]
...
block_.L_403e9a:                                  ; preds = %block_403ea6, %block_403e8f
  %112 = phi i64 [ %.pre6, %block_403e8f ], [ %240, %block_403ea6 ]
  %MEMORY.1 = phi %struct.Memory* [ %MEMORY.0, %block_403e8f ], [ %call2_403eb2, %block_403ea6 ]
...
block_403ea6:                                     ; preds = %block_.L_403e9a
  ...
  %call2_403eb2 = tail call %struct.Memory* @sub_4177b0._ZN19custom_constant_xorIaE8do_shiftEa(%struct.State* nonnull %0, i64 %163, %struct.Memory* %MEMORY.1)
...
block_.L_403ed3:                                  ; preds = %block_.L_403e9a
  ...
  %call2_403ed7 = tail call %struct.Memory* @sub_4177d0._Z17check_shifted_sumIa19custom_constant_xorIaEEvT_(%struct.State* nonnull %0, i64 %247, %struct.Memory* %MEMORY.1)
...
block_.L_403eea:                                  ; preds = %block_.L_403e7f
  ...
  %call2_403eea = tail call %struct.Memory* @sub_400ea0._Z5timerv(%struct.State* nonnull %0, i64 %284, %struct.Memory* %MEMORY.0)
