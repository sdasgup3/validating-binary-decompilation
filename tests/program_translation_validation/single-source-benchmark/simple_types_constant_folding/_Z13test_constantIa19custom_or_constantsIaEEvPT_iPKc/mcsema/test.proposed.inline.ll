...
declare %struct.Memory* @sub_4181b0._ZN19custom_or_constantsIaE8do_shiftEa(%struct.State* dereferenceable(3376), i64, %struct.Memory*)

declare %struct.Memory* @sub_4181d0._Z17check_shifted_sumIa19custom_or_constantsIaEEvT_(%struct.State* dereferenceable(3376), i64, %struct.Memory*)
...
define %struct.Memory* @_Z13test_constantIa19custom_or_constantsIaEEvPT_iPKc(%struct.State* noalias, i64, %struct.Memory* noalias) #1 {
entry:
