...
declare %struct.Memory* @sub_4181e0._Z17check_shifted_sumIa19custom_or_constantsIaEEvT_(%struct.State* noalias dereferenceable(3376), i64, %struct.Memory* noalias readnone returned) local_unnamed_addr
...
entry:
  ...
  %call2_4033e3 = tail call %struct.Memory* @sub_400e90._Z11start_timerv(%struct.State* %0, i64 %58, %struct.Memory* %2)
...
block_.L_4033ef:                                  ; preds = %block_.L_403443, %entry
  %69 = phi i64 [ %283, %block_.L_403443 ], [ %.pre, %entry ]
  ...
  br i1 %102, label %block_4033ff, label %block_.L_40345a
...
block_.L_40340a:                                  ; preds = %block_403416, %block_4033ff
  %112 = phi i64 [ %240, %block_403416 ], [ %.pre6, %block_4033ff ]
  ...
  br i1 %148, label %block_403416, label %block_.L_403443
...
block_403416:                                     ; preds = %block_.L_40340a
  ...
  %call2_403422 = tail call %struct.Memory* @sub_4181c0._ZN19custom_or_constantsIaE8do_shiftEa(%struct.State* nonnull %0, i64 %163, %struct.Memory* %call2_4033e3)
...
block_.L_403443:                                  ; preds = %block_.L_40340a
  ...
  %call2_403447 = tail call %struct.Memory* @sub_4181e0._Z17check_shifted_sumIa19custom_or_constantsIaEEvT_(%struct.State* nonnull %0, i64 %247, %struct.Memory* %call2_4033e3)
...
block_.L_40345a:                                  ; preds = %block_.L_4033ef
  ...
  %call2_40345a = tail call %struct.Memory* @sub_400eb0._Z5timerv(%struct.State* nonnull %0, i64 %284, %struct.Memory* %call2_4033e3)
  ...
  %call2_403463 = tail call %struct.Memory* @sub_400850._Z13record_resultdPKc(%struct.State* nonnull %0, i64 %295, %struct.Memory* %call2_40345a)
