...
block_.L_40339f:                                  ; preds = %block_.L_4033f3, %entry
  %69 = phi i64 [ %.pre, %entry ], [ %282, %block_.L_4033f3 ]
...
block_.L_4033ba:                                  ; preds = %block_4033c6, %block_4033af
  %112 = phi i64 [ %.pre1, %block_4033af ], [ %239, %block_4033c6 ]
...
block_.L_4033f3:                                  ; preds = %block_.L_4033ba
  ...
  %call2_4033f7 = tail call %struct.Memory* @sub_418190._Z17check_shifted_sumIa19custom_or_constantsIaEEvT_(%struct.State* %0, i64 %246, %struct.Memory* %MEMORY.1)
...
block_.L_40340a:                                  ; preds = %block_.L_40339f
  ...
  %call2_40340a = tail call %struct.Memory* @sub_400e60._Z5timerv(%struct.State* %0, i64 %283, %struct.Memory* %MEMORY.0)
  ...
  %call2_403413 = tail call %struct.Memory* @sub_400800._Z13record_resultdPKc(%struct.State* %0, i64 %294, %struct.Memory* %call2_40340a)
