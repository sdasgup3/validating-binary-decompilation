...
declare %struct.Memory* @sub_4181b0._ZN19custom_or_constantsIaE8do_shiftEa(%struct.State* noalias dereferenceable(3376), i64, %struct.Memory* noalias readnone returned) local_unnamed_addr

declare %struct.Memory* @sub_4181d0._Z17check_shifted_sumIa19custom_or_constantsIaEEvT_(%struct.State* noalias dereferenceable(3376), i64, %struct.Memory* noalias readnone returned) local_unnamed_addr
...
define %struct.Memory* @_Z13test_constantIa19custom_or_constantsIaEEvPT_iPKc(%struct.State* noalias, i64, %struct.Memory* noalias readnone) local_unnamed_addr #1 {
entry:
...
block_.L_4033df:                                  ; preds = %block_.L_403433, %entry
  %69 = phi i64 [ %283, %block_.L_403433 ], [ %.pre, %entry ]
...
block_.L_4033fa:                                  ; preds = %block_403406, %block_4033ef
  %112 = phi i64 [ %240, %block_403406 ], [ %.pre6, %block_4033ef ]
...
block_403406:                                     ; preds = %block_.L_4033fa
  ...
  %call2_403412 = tail call %struct.Memory* @sub_4181b0._ZN19custom_or_constantsIaE8do_shiftEa(%struct.State* nonnull %0, i64 %163, %struct.Memory* %call2_4033d3)
...
block_.L_403433:                                  ; preds = %block_.L_4033fa
  ...
  %call2_403437 = tail call %struct.Memory* @sub_4181d0._Z17check_shifted_sumIa19custom_or_constantsIaEEvT_(%struct.State* nonnull %0, i64 %247, %struct.Memory* %call2_4033d3)
...
block_.L_40344a:                                  ; preds = %block_.L_4033df
  ...
  %call2_40344a = tail call %struct.Memory* @sub_400ea0._Z5timerv(%struct.State* nonnull %0, i64 %284, %struct.Memory* %call2_4033d3)
