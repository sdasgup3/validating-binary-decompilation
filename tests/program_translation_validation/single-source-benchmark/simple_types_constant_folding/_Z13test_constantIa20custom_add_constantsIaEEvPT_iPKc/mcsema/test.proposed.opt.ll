...
declare %struct.Memory* @sub_418890._Z17check_shifted_sumIa20custom_add_constantsIaEEvT_(%struct.State* noalias dereferenceable(3376), i64, %struct.Memory* noalias readnone returned) local_unnamed_addr
...
define %struct.Memory* @_Z13test_constantIa20custom_add_constantsIaEEvPT_iPKc(%struct.State* noalias, i64, %struct.Memory* noalias readnone) local_unnamed_addr #1 {
entry:
...
block_.L_402c5f:                                  ; preds = %block_.L_402cb3, %entry
  %69 = phi i64 [ %283, %block_.L_402cb3 ], [ %.pre, %entry ]
...
block_.L_402c7a:                                  ; preds = %block_402c86, %block_402c6f
  %112 = phi i64 [ %240, %block_402c86 ], [ %.pre6, %block_402c6f ]
...
block_402c86:                                     ; preds = %block_.L_402c7a
  ...
  %call2_402c92 = tail call %struct.Memory* @sub_418870._ZN20custom_add_constantsIaE8do_shiftEa(%struct.State* nonnull %0, i64 %163, %struct.Memory* %call2_402c53)
...
block_.L_402cb3:                                  ; preds = %block_.L_402c7a
  ...
  %call2_402cb7 = tail call %struct.Memory* @sub_418890._Z17check_shifted_sumIa20custom_add_constantsIaEEvT_(%struct.State* nonnull %0, i64 %247, %struct.Memory* %call2_402c53)
...
block_.L_402cca:                                  ; preds = %block_.L_402c5f
  ...
  %call2_402cca = tail call %struct.Memory* @sub_400ea0._Z5timerv(%struct.State* nonnull %0, i64 %284, %struct.Memory* %call2_402c53)
