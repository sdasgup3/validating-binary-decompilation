...
declare %struct.Memory* @sub_4188a0._Z17check_shifted_sumIa20custom_add_constantsIaEEvT_(%struct.State* noalias dereferenceable(3376), i64, %struct.Memory* noalias readnone returned) local_unnamed_addr
...
entry:
  ...
  %call2_402c63 = tail call %struct.Memory* @sub_400e90._Z11start_timerv(%struct.State* %0, i64 %58, %struct.Memory* %2)
...
block_.L_402c6f:                                  ; preds = %block_.L_402cc3, %entry
  %69 = phi i64 [ %283, %block_.L_402cc3 ], [ %.pre, %entry ]
  ...
  br i1 %102, label %block_402c7f, label %block_.L_402cda
...
block_.L_402c8a:                                  ; preds = %block_402c96, %block_402c7f
  %112 = phi i64 [ %240, %block_402c96 ], [ %.pre6, %block_402c7f ]
  ...
  br i1 %148, label %block_402c96, label %block_.L_402cc3
...
block_402c96:                                     ; preds = %block_.L_402c8a
  ...
  %call2_402ca2 = tail call %struct.Memory* @sub_418880._ZN20custom_add_constantsIaE8do_shiftEa(%struct.State* nonnull %0, i64 %163, %struct.Memory* %call2_402c63)
...
block_.L_402cc3:                                  ; preds = %block_.L_402c8a
  ...
  %call2_402cc7 = tail call %struct.Memory* @sub_4188a0._Z17check_shifted_sumIa20custom_add_constantsIaEEvT_(%struct.State* nonnull %0, i64 %247, %struct.Memory* %call2_402c63)
...
block_.L_402cda:                                  ; preds = %block_.L_402c6f
  ...
  %call2_402cda = tail call %struct.Memory* @sub_400eb0._Z5timerv(%struct.State* nonnull %0, i64 %284, %struct.Memory* %call2_402c63)
  ...
  %call2_402ce3 = tail call %struct.Memory* @sub_400850._Z13record_resultdPKc(%struct.State* nonnull %0, i64 %295, %struct.Memory* %call2_402cda)
