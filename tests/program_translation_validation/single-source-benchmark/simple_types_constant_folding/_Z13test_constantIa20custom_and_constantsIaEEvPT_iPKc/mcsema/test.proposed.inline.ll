...
define %struct.Memory* @_Z13test_constantIa20custom_and_constantsIaEEvPT_iPKc(%struct.State* noalias, i64, %struct.Memory* noalias) #1 {
entry:
...
block_.L_403393:                                  ; preds = %block_.L_40335a
  ...
  store %struct.Memory* %loadMem1_403397, %struct.Memory** %MEMORY
...
block_.L_4033aa:                                  ; preds = %block_.L_40333f
  ...
  store %struct.Memory* %loadMem1_4033aa, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem1_4033b3, %struct.Memory** %MEMORY
  ...
  ret %struct.Memory* %loadMem_4033bd
}
