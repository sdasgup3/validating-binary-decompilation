...
declare %struct.Memory* @sub_418270._Z17check_shifted_sumIa20custom_and_constantsIaEEvT_(%struct.State* noalias dereferenceable(3376), i64, %struct.Memory* noalias readnone returned) local_unnamed_addr
...
entry:
  ...
  %call2_403343 = tail call %struct.Memory* @sub_400e90._Z11start_timerv(%struct.State* %0, i64 %58, %struct.Memory* %2)
...
block_.L_40334f:                                  ; preds = %block_.L_4033a3, %entry
  %69 = phi i64 [ %283, %block_.L_4033a3 ], [ %.pre, %entry ]
  ...
  br i1 %102, label %block_40335f, label %block_.L_4033ba
...
block_.L_40336a:                                  ; preds = %block_403376, %block_40335f
  %112 = phi i64 [ %240, %block_403376 ], [ %.pre6, %block_40335f ]
  ...
  br i1 %148, label %block_403376, label %block_.L_4033a3
...
block_403376:                                     ; preds = %block_.L_40336a
  ...
  %call2_403382 = tail call %struct.Memory* @sub_418250._ZN20custom_and_constantsIaE8do_shiftEa(%struct.State* nonnull %0, i64 %163, %struct.Memory* %call2_403343)
...
block_.L_4033a3:                                  ; preds = %block_.L_40336a
  ...
  %call2_4033a7 = tail call %struct.Memory* @sub_418270._Z17check_shifted_sumIa20custom_and_constantsIaEEvT_(%struct.State* nonnull %0, i64 %247, %struct.Memory* %call2_403343)
...
block_.L_4033ba:                                  ; preds = %block_.L_40334f
  ...
  %call2_4033ba = tail call %struct.Memory* @sub_400eb0._Z5timerv(%struct.State* nonnull %0, i64 %284, %struct.Memory* %call2_403343)
  ...
  %call2_4033c3 = tail call %struct.Memory* @sub_400850._Z13record_resultdPKc(%struct.State* nonnull %0, i64 %295, %struct.Memory* %call2_4033ba)
