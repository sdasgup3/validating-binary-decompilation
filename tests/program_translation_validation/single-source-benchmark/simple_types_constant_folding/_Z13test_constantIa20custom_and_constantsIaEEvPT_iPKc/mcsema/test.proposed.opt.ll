...
block_.L_4032ff:                                  ; preds = %block_.L_403353, %entry
  %69 = phi i64 [ %.pre, %entry ], [ %284, %block_.L_403353 ]
...
block_.L_40331a:                                  ; preds = %block_403326, %block_40330f
  %112 = phi i64 [ %.pre1, %block_40330f ], [ %240, %block_403326 ]
...
block_.L_403353:                                  ; preds = %block_.L_40331a
  ...
  %call2_403357 = tail call %struct.Memory* @sub_418220._Z17check_shifted_sumIa20custom_and_constantsIaEEvT_(%struct.State* %0, i64 %247, %struct.Memory* %MEMORY.1)
...
block_.L_40336a:                                  ; preds = %block_.L_4032ff
  ...
  %call2_40336a = tail call %struct.Memory* @sub_400e60._Z5timerv(%struct.State* %0, i64 %285, %struct.Memory* %MEMORY.0)
  ...
  %call2_403373 = tail call %struct.Memory* @sub_400800._Z13record_resultdPKc(%struct.State* %0, i64 %296, %struct.Memory* %call2_40336a)
