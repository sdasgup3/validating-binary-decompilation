...
declare %struct.Memory* @sub_418240._ZN20custom_and_constantsIaE8do_shiftEa(%struct.State* noalias dereferenceable(3376), i64, %struct.Memory* noalias readnone returned) local_unnamed_addr

declare %struct.Memory* @sub_418260._Z17check_shifted_sumIa20custom_and_constantsIaEEvT_(%struct.State* noalias dereferenceable(3376), i64, %struct.Memory* noalias readnone returned) local_unnamed_addr
...
define %struct.Memory* @_Z13test_constantIa20custom_and_constantsIaEEvPT_iPKc(%struct.State* noalias, i64, %struct.Memory* noalias readnone) local_unnamed_addr #1 {
entry:
...
block_.L_40333f:                                  ; preds = %block_.L_403393, %entry
  %69 = phi i64 [ %283, %block_.L_403393 ], [ %.pre, %entry ]
...
block_.L_40335a:                                  ; preds = %block_403366, %block_40334f
  %112 = phi i64 [ %240, %block_403366 ], [ %.pre6, %block_40334f ]
...
block_403366:                                     ; preds = %block_.L_40335a
  ...
  %call2_403372 = tail call %struct.Memory* @sub_418240._ZN20custom_and_constantsIaE8do_shiftEa(%struct.State* nonnull %0, i64 %163, %struct.Memory* %call2_403333)
...
block_.L_403393:                                  ; preds = %block_.L_40335a
  ...
  %call2_403397 = tail call %struct.Memory* @sub_418260._Z17check_shifted_sumIa20custom_and_constantsIaEEvT_(%struct.State* nonnull %0, i64 %247, %struct.Memory* %call2_403333)
...
block_.L_4033aa:                                  ; preds = %block_.L_40333f
  ...
  %call2_4033aa = tail call %struct.Memory* @sub_400ea0._Z5timerv(%struct.State* nonnull %0, i64 %284, %struct.Memory* %call2_403333)
