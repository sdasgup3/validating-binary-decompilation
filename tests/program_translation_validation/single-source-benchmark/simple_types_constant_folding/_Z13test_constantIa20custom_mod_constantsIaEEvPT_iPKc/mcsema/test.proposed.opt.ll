...
block_.L_402e9f:                                  ; preds = %block_.L_402ef3, %entry
  %69 = phi i64 [ %.pre, %entry ], [ %282, %block_.L_402ef3 ]
...
block_.L_402eba:                                  ; preds = %block_402ec6, %block_402eaf
  %112 = phi i64 [ %.pre1, %block_402eaf ], [ %239, %block_402ec6 ]
...
block_.L_402ef3:                                  ; preds = %block_.L_402eba
  ...
  %call2_402ef7 = tail call %struct.Memory* @sub_418610._Z17check_shifted_sumIa20custom_mod_constantsIaEEvT_(%struct.State* %0, i64 %246, %struct.Memory* %MEMORY.1)
...
block_.L_402f0a:                                  ; preds = %block_.L_402e9f
  ...
  %call2_402f0a = tail call %struct.Memory* @sub_400e60._Z5timerv(%struct.State* %0, i64 %283, %struct.Memory* %MEMORY.0)
  ...
  %call2_402f13 = tail call %struct.Memory* @sub_400800._Z13record_resultdPKc(%struct.State* %0, i64 %294, %struct.Memory* %call2_402f0a)
