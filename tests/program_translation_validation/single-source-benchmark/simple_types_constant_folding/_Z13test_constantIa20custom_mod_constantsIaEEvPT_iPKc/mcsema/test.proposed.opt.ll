...
declare %struct.Memory* @sub_418660._Z17check_shifted_sumIa20custom_mod_constantsIaEEvT_(%struct.State* noalias dereferenceable(3376), i64, %struct.Memory* noalias readnone returned) local_unnamed_addr
...
entry:
  ...
  %call2_402ee3 = tail call %struct.Memory* @sub_400e90._Z11start_timerv(%struct.State* %0, i64 %58, %struct.Memory* %2)
...
block_.L_402eef:                                  ; preds = %block_.L_402f43, %entry
  %69 = phi i64 [ %283, %block_.L_402f43 ], [ %.pre, %entry ]
  ...
  br i1 %102, label %block_402eff, label %block_.L_402f5a

block_402eff:                                     ; preds = %block_.L_402eef
  %104 = add i64 %70, -29
  %105 = add i64 %103, 4
...
block_.L_402f0a:                                  ; preds = %block_402f16, %block_402eff
  %112 = phi i64 [ %240, %block_402f16 ], [ %.pre6, %block_402eff ]
  ...
  br i1 %148, label %block_402f16, label %block_.L_402f43

block_402f16:                                     ; preds = %block_.L_402f0a
  %150 = add i64 %113, -8
  %151 = add i64 %149, 4
  ...
  %call2_402f22 = tail call %struct.Memory* @sub_418640._ZN20custom_mod_constantsIaE8do_shiftEa(%struct.State* nonnull %0, i64 %163, %struct.Memory* %call2_402ee3)
...
block_.L_402f43:                                  ; preds = %block_.L_402f0a
  %241 = add i64 %113, -29
  %242 = add i64 %149, 4
  ...
  %call2_402f47 = tail call %struct.Memory* @sub_418660._Z17check_shifted_sumIa20custom_mod_constantsIaEEvT_(%struct.State* nonnull %0, i64 %247, %struct.Memory* %call2_402ee3)
...
block_.L_402f5a:                                  ; preds = %block_.L_402eef
  ...
  %call2_402f5a = tail call %struct.Memory* @sub_400eb0._Z5timerv(%struct.State* nonnull %0, i64 %284, %struct.Memory* %call2_402ee3)
  ...
  %call2_402f63 = tail call %struct.Memory* @sub_400850._Z13record_resultdPKc(%struct.State* nonnull %0, i64 %295, %struct.Memory* %call2_402f5a)
