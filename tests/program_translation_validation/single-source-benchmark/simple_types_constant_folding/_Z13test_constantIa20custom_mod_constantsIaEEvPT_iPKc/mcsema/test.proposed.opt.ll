...
declare %struct.Memory* @sub_418650._Z17check_shifted_sumIa20custom_mod_constantsIaEEvT_(%struct.State* noalias dereferenceable(3376), i64, %struct.Memory* noalias readnone returned) local_unnamed_addr
...
define %struct.Memory* @_Z13test_constantIa20custom_mod_constantsIaEEvPT_iPKc(%struct.State* noalias, i64, %struct.Memory* noalias readnone) local_unnamed_addr #1 {
entry:
...
block_.L_402edf:                                  ; preds = %block_.L_402f33, %entry
  %69 = phi i64 [ %283, %block_.L_402f33 ], [ %.pre, %entry ]
...
block_.L_402efa:                                  ; preds = %block_402f06, %block_402eef
  %112 = phi i64 [ %240, %block_402f06 ], [ %.pre6, %block_402eef ]
...
block_402f06:                                     ; preds = %block_.L_402efa
  ...
  %call2_402f12 = tail call %struct.Memory* @sub_418630._ZN20custom_mod_constantsIaE8do_shiftEa(%struct.State* nonnull %0, i64 %163, %struct.Memory* %call2_402ed3)
...
block_.L_402f33:                                  ; preds = %block_.L_402efa
  ...
  %call2_402f37 = tail call %struct.Memory* @sub_418650._Z17check_shifted_sumIa20custom_mod_constantsIaEEvT_(%struct.State* nonnull %0, i64 %247, %struct.Memory* %call2_402ed3)
...
block_.L_402f4a:                                  ; preds = %block_.L_402edf
  ...
  %call2_402f4a = tail call %struct.Memory* @sub_400ea0._Z5timerv(%struct.State* nonnull %0, i64 %284, %struct.Memory* %call2_402ed3)
