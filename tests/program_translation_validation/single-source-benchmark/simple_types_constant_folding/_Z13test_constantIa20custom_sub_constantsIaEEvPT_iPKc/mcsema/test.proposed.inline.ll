...
declare %struct.Memory* @sub_4187e0._ZN20custom_sub_constantsIaE8do_shiftEa(%struct.State* dereferenceable(3376), i64, %struct.Memory*)

declare %struct.Memory* @sub_418800._Z17check_shifted_sumIa20custom_sub_constantsIaEEvT_(%struct.State* dereferenceable(3376), i64, %struct.Memory*)
...
define %struct.Memory* @_Z13test_constantIa20custom_sub_constantsIaEEvPT_iPKc(%struct.State* noalias, i64, %struct.Memory* noalias) #1 {
entry:
