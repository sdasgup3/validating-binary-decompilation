...
block_.L_402cbf:                                  ; preds = %block_.L_402d13, %entry
  %69 = phi i64 [ %.pre, %entry ], [ %284, %block_.L_402d13 ]
...
block_.L_402cda:                                  ; preds = %block_402ce6, %block_402ccf
  %112 = phi i64 [ %.pre1, %block_402ccf ], [ %240, %block_402ce6 ]
...
block_.L_402d13:                                  ; preds = %block_.L_402cda
  ...
  %call2_402d17 = tail call %struct.Memory* @sub_4187c0._Z17check_shifted_sumIa20custom_sub_constantsIaEEvT_(%struct.State* %0, i64 %247, %struct.Memory* %MEMORY.1)
...
block_.L_402d2a:                                  ; preds = %block_.L_402cbf
  ...
  %call2_402d2a = tail call %struct.Memory* @sub_400e60._Z5timerv(%struct.State* %0, i64 %285, %struct.Memory* %MEMORY.0)
  ...
  %call2_402d33 = tail call %struct.Memory* @sub_400800._Z13record_resultdPKc(%struct.State* %0, i64 %296, %struct.Memory* %call2_402d2a)
