...
declare %struct.Memory* @sub_4187f0._ZN20custom_sub_constantsIaE8do_shiftEa(%struct.State* noalias dereferenceable(3376), i64, %struct.Memory* noalias readnone returned) local_unnamed_addr

declare %struct.Memory* @sub_418810._Z17check_shifted_sumIa20custom_sub_constantsIaEEvT_(%struct.State* noalias dereferenceable(3376), i64, %struct.Memory* noalias readnone returned) local_unnamed_addr
...
entry:
  ...
  %call2_402d03 = tail call %struct.Memory* @sub_400e90._Z11start_timerv(%struct.State* %0, i64 %58, %struct.Memory* %2)
  ...
  br label %block_.L_402d0f

block_.L_402d0f:                                  ; preds = %block_.L_402d63, %entry
  %69 = phi i64 [ %283, %block_.L_402d63 ], [ %.pre, %entry ]
  ...
  br i1 %102, label %block_402d1f, label %block_.L_402d7a

block_402d1f:                                     ; preds = %block_.L_402d0f
  %104 = add i64 %70, -29
  %105 = add i64 %103, 4
...
block_.L_402d2a:                                  ; preds = %block_402d36, %block_402d1f
  %112 = phi i64 [ %240, %block_402d36 ], [ %.pre6, %block_402d1f ]
  ...
  br i1 %148, label %block_402d36, label %block_.L_402d63

block_402d36:                                     ; preds = %block_.L_402d2a
  %150 = add i64 %113, -8
  %151 = add i64 %149, 4
  ...
  %call2_402d42 = tail call %struct.Memory* @sub_4187f0._ZN20custom_sub_constantsIaE8do_shiftEa(%struct.State* nonnull %0, i64 %163, %struct.Memory* %call2_402d03)
...
block_.L_402d63:                                  ; preds = %block_.L_402d2a
  %241 = add i64 %113, -29
  %242 = add i64 %149, 4
  ...
  %call2_402d67 = tail call %struct.Memory* @sub_418810._Z17check_shifted_sumIa20custom_sub_constantsIaEEvT_(%struct.State* nonnull %0, i64 %247, %struct.Memory* %call2_402d03)
...
block_.L_402d7a:                                  ; preds = %block_.L_402d0f
  ...
  %call2_402d7a = tail call %struct.Memory* @sub_400eb0._Z5timerv(%struct.State* nonnull %0, i64 %284, %struct.Memory* %call2_402d03)
  ...
  %call2_402d83 = tail call %struct.Memory* @sub_400850._Z13record_resultdPKc(%struct.State* nonnull %0, i64 %295, %struct.Memory* %call2_402d7a)
