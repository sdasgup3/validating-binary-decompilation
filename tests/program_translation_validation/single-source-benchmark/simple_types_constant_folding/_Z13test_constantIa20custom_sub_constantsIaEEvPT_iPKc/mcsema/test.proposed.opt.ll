...
declare %struct.Memory* @sub_4187e0._ZN20custom_sub_constantsIaE8do_shiftEa(%struct.State* noalias dereferenceable(3376), i64, %struct.Memory* noalias readnone returned) local_unnamed_addr

declare %struct.Memory* @sub_418800._Z17check_shifted_sumIa20custom_sub_constantsIaEEvT_(%struct.State* noalias dereferenceable(3376), i64, %struct.Memory* noalias readnone returned) local_unnamed_addr
...
define %struct.Memory* @_Z13test_constantIa20custom_sub_constantsIaEEvPT_iPKc(%struct.State* noalias, i64, %struct.Memory* noalias readnone) local_unnamed_addr #1 {
entry:
...
block_.L_402cff:                                  ; preds = %block_.L_402d53, %entry
  %69 = phi i64 [ %283, %block_.L_402d53 ], [ %.pre, %entry ]
...
block_.L_402d1a:                                  ; preds = %block_402d26, %block_402d0f
  %112 = phi i64 [ %240, %block_402d26 ], [ %.pre6, %block_402d0f ]
...
block_402d26:                                     ; preds = %block_.L_402d1a
  ...
  %call2_402d32 = tail call %struct.Memory* @sub_4187e0._ZN20custom_sub_constantsIaE8do_shiftEa(%struct.State* nonnull %0, i64 %163, %struct.Memory* %call2_402cf3)
...
block_.L_402d53:                                  ; preds = %block_.L_402d1a
  ...
  %call2_402d57 = tail call %struct.Memory* @sub_418800._Z17check_shifted_sumIa20custom_sub_constantsIaEEvT_(%struct.State* nonnull %0, i64 %247, %struct.Memory* %call2_402cf3)
...
block_.L_402d6a:                                  ; preds = %block_.L_402cff
  ...
  %call2_402d6a = tail call %struct.Memory* @sub_400ea0._Z5timerv(%struct.State* nonnull %0, i64 %284, %struct.Memory* %call2_402cf3)
