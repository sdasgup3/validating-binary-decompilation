...
declare %struct.Memory* @sub_418120._ZN20custom_xor_constantsIaE8do_shiftEa(%struct.State* dereferenceable(3376), i64, %struct.Memory*)

declare %struct.Memory* @sub_418140._Z17check_shifted_sumIa20custom_xor_constantsIaEEvT_(%struct.State* dereferenceable(3376), i64, %struct.Memory*)
...
define %struct.Memory* @_Z13test_constantIa20custom_xor_constantsIaEEvPT_iPKc(%struct.State* noalias, i64, %struct.Memory* noalias) #1 {
entry:
