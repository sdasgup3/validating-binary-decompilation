...
block_.L_40343f:                                  ; preds = %block_.L_403493, %entry
  %69 = phi i64 [ %.pre, %entry ], [ %282, %block_.L_403493 ]
...
block_.L_40345a:                                  ; preds = %block_403466, %block_40344f
  %112 = phi i64 [ %.pre1, %block_40344f ], [ %239, %block_403466 ]
...
block_.L_403493:                                  ; preds = %block_.L_40345a
  ...
  %call2_403497 = tail call %struct.Memory* @sub_418100._Z17check_shifted_sumIa20custom_xor_constantsIaEEvT_(%struct.State* %0, i64 %246, %struct.Memory* %MEMORY.1)
...
block_.L_4034aa:                                  ; preds = %block_.L_40343f
  ...
  %call2_4034aa = tail call %struct.Memory* @sub_400e60._Z5timerv(%struct.State* %0, i64 %283, %struct.Memory* %MEMORY.0)
  ...
  %call2_4034b3 = tail call %struct.Memory* @sub_400800._Z13record_resultdPKc(%struct.State* %0, i64 %294, %struct.Memory* %call2_4034aa)
