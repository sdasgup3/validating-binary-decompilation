...
declare %struct.Memory* @sub_418120._ZN20custom_xor_constantsIaE8do_shiftEa(%struct.State* dereferenceable(3376), i64, %struct.Memory*) local_unnamed_addr

declare %struct.Memory* @sub_418140._Z17check_shifted_sumIa20custom_xor_constantsIaEEvT_(%struct.State* dereferenceable(3376), i64, %struct.Memory*) local_unnamed_addr
...
block_.L_40347f:                                  ; preds = %block_.L_4034d3, %entry
  %69 = phi i64 [ %.pre, %entry ], [ %283, %block_.L_4034d3 ]
  %MEMORY.0 = phi %struct.Memory* [ %call2_403473, %entry ], [ %call2_4034d7, %block_.L_4034d3 ]
...
block_.L_40349a:                                  ; preds = %block_4034a6, %block_40348f
  %112 = phi i64 [ %.pre6, %block_40348f ], [ %240, %block_4034a6 ]
  %MEMORY.1 = phi %struct.Memory* [ %MEMORY.0, %block_40348f ], [ %call2_4034b2, %block_4034a6 ]
...
block_4034a6:                                     ; preds = %block_.L_40349a
  ...
  %call2_4034b2 = tail call %struct.Memory* @sub_418120._ZN20custom_xor_constantsIaE8do_shiftEa(%struct.State* nonnull %0, i64 %163, %struct.Memory* %MEMORY.1)
...
block_.L_4034d3:                                  ; preds = %block_.L_40349a
  ...
  %call2_4034d7 = tail call %struct.Memory* @sub_418140._Z17check_shifted_sumIa20custom_xor_constantsIaEEvT_(%struct.State* nonnull %0, i64 %247, %struct.Memory* %MEMORY.1)
...
block_.L_4034ea:                                  ; preds = %block_.L_40347f
  ...
  %call2_4034ea = tail call %struct.Memory* @sub_400ea0._Z5timerv(%struct.State* nonnull %0, i64 %284, %struct.Memory* %MEMORY.0)
