...
define %struct.Memory* @_Z13test_constantIa22custom_constant_divideIaEEvPT_iPKc(%struct.State* noalias, i64, %struct.Memory* noalias) #1 {
entry:
...
block_4039a6:                                     ; preds = %block_.L_40399a
  ...
  store %struct.Memory* %loadMem1_4039b2, %struct.Memory** %MEMORY
...
block_.L_4039d3:                                  ; preds = %block_.L_40399a
  ...
  store %struct.Memory* %loadMem1_4039d7, %struct.Memory** %MEMORY
...
block_.L_4039ea:                                  ; preds = %block_.L_40397f
  ...
  store %struct.Memory* %loadMem1_4039ea, %struct.Memory** %MEMORY
  ...
  ret %struct.Memory* %loadMem_4039fd
}
