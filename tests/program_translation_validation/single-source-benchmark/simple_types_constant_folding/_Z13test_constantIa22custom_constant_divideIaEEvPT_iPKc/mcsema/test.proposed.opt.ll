...
declare %struct.Memory* @sub_417c70._ZN22custom_constant_divideIaE8do_shiftEa(%struct.State* noalias dereferenceable(3376), i64, %struct.Memory* noalias readnone returned) local_unnamed_addr

declare %struct.Memory* @sub_417c90._Z17check_shifted_sumIa22custom_constant_divideIaEEvT_(%struct.State* noalias dereferenceable(3376), i64, %struct.Memory* noalias readnone returned) local_unnamed_addr
...
define %struct.Memory* @_Z13test_constantIa22custom_constant_divideIaEEvPT_iPKc(%struct.State* noalias, i64, %struct.Memory* noalias readnone) local_unnamed_addr #1 {
entry:
...
block_.L_40397f:                                  ; preds = %block_.L_4039d3, %entry
  %69 = phi i64 [ %283, %block_.L_4039d3 ], [ %.pre, %entry ]
...
block_.L_40399a:                                  ; preds = %block_4039a6, %block_40398f
  %112 = phi i64 [ %240, %block_4039a6 ], [ %.pre6, %block_40398f ]
...
block_4039a6:                                     ; preds = %block_.L_40399a
  ...
  %call2_4039b2 = tail call %struct.Memory* @sub_417c70._ZN22custom_constant_divideIaE8do_shiftEa(%struct.State* nonnull %0, i64 %163, %struct.Memory* %call2_403973)
...
block_.L_4039d3:                                  ; preds = %block_.L_40399a
  ...
  %call2_4039d7 = tail call %struct.Memory* @sub_417c90._Z17check_shifted_sumIa22custom_constant_divideIaEEvT_(%struct.State* nonnull %0, i64 %247, %struct.Memory* %call2_403973)
...
block_.L_4039ea:                                  ; preds = %block_.L_40397f
  ...
  %call2_4039ea = tail call %struct.Memory* @sub_400ea0._Z5timerv(%struct.State* nonnull %0, i64 %284, %struct.Memory* %call2_403973)
