...
block_.L_40393f:                                  ; preds = %block_.L_403993, %entry
  %69 = phi i64 [ %.pre, %entry ], [ %282, %block_.L_403993 ]
...
block_.L_40395a:                                  ; preds = %block_403966, %block_40394f
  %112 = phi i64 [ %.pre1, %block_40394f ], [ %239, %block_403966 ]
...
block_.L_403993:                                  ; preds = %block_.L_40395a
  ...
  %call2_403997 = tail call %struct.Memory* @sub_417c50._Z17check_shifted_sumIa22custom_constant_divideIaEEvT_(%struct.State* %0, i64 %246, %struct.Memory* %MEMORY.1)
...
block_.L_4039aa:                                  ; preds = %block_.L_40393f
  ...
  %call2_4039aa = tail call %struct.Memory* @sub_400e60._Z5timerv(%struct.State* %0, i64 %283, %struct.Memory* %MEMORY.0)
  ...
  %call2_4039b3 = tail call %struct.Memory* @sub_400800._Z13record_resultdPKc(%struct.State* %0, i64 %294, %struct.Memory* %call2_4039aa)
