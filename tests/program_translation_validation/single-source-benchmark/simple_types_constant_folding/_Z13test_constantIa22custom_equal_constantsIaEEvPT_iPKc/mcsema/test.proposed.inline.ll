...
declare %struct.Memory* @sub_4185c0._Z17check_shifted_sumIa22custom_equal_constantsIaEEvT_(%struct.State* dereferenceable(3376), i64, %struct.Memory*)
...
define %struct.Memory* @_Z13test_constantIa22custom_equal_constantsIaEEvPT_iPKc(%struct.State* noalias, i64, %struct.Memory* noalias) #1 {
entry:
