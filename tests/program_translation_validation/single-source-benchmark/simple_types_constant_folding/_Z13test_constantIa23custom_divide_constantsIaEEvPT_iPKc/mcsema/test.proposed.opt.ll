...
block_.L_402dff:                                  ; preds = %block_.L_402e53, %entry
  %69 = phi i64 [ %.pre, %entry ], [ %284, %block_.L_402e53 ]
...
block_.L_402e1a:                                  ; preds = %block_402e26, %block_402e0f
  %112 = phi i64 [ %.pre1, %block_402e0f ], [ %240, %block_402e26 ]
...
block_.L_402e53:                                  ; preds = %block_.L_402e1a
  ...
  %call2_402e57 = tail call %struct.Memory* @sub_4186a0._Z17check_shifted_sumIa23custom_divide_constantsIaEEvT_(%struct.State* %0, i64 %247, %struct.Memory* %MEMORY.1)
...
block_.L_402e6a:                                  ; preds = %block_.L_402dff
  ...
  %call2_402e6a = tail call %struct.Memory* @sub_400e60._Z5timerv(%struct.State* %0, i64 %285, %struct.Memory* %MEMORY.0)
  ...
  %call2_402e73 = tail call %struct.Memory* @sub_400800._Z13record_resultdPKc(%struct.State* %0, i64 %296, %struct.Memory* %call2_402e6a)
