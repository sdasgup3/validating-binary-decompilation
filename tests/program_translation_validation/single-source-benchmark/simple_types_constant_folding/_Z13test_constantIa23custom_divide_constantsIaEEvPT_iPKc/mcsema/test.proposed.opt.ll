...
declare %struct.Memory* @sub_4186a0._Z17check_shifted_sumIa23custom_divide_constantsIaEEvT_(%struct.State* noalias dereferenceable(3376), i64, %struct.Memory* noalias readnone returned) local_unnamed_addr
...
entry:
  ...
  %call2_402df3 = tail call %struct.Memory* @sub_400e40._Z11start_timerv(%struct.State* %0, i64 %58, %struct.Memory* %2)
...
block_.L_402dff:                                  ; preds = %block_.L_402e53, %entry
  %69 = phi i64 [ %.pre, %entry ], [ %282, %block_.L_402e53 ]
  %MEMORY.0 = phi %struct.Memory* [ %call2_402df3, %entry ], [ %call2_402e57, %block_.L_402e53 ]
  ...
  br i1 %102, label %block_402e0f, label %block_.L_402e6a

block_402e0f:                                     ; preds = %block_.L_402dff
  %104 = add i64 %70, -29
  %105 = add i64 %103, 4
...
block_.L_402e1a:                                  ; preds = %block_402e26, %block_402e0f
  %112 = phi i64 [ %.pre1, %block_402e0f ], [ %239, %block_402e26 ]
  %MEMORY.1 = phi %struct.Memory* [ %MEMORY.0, %block_402e0f ], [ %call2_402e32, %block_402e26 ]
  ...
  br i1 %148, label %block_402e26, label %block_.L_402e53

block_402e26:                                     ; preds = %block_.L_402e1a
  %150 = add i64 %113, -8
  %151 = add i64 %149, 4
  ...
  %call2_402e32 = tail call %struct.Memory* @sub_418680._ZN23custom_divide_constantsIaE8do_shiftEa(%struct.State* %0, i64 %163, %struct.Memory* %MEMORY.1)
...
block_.L_402e53:                                  ; preds = %block_.L_402e1a
  %240 = add i64 %113, -29
  %241 = add i64 %149, 4
  ...
  %call2_402e57 = tail call %struct.Memory* @sub_4186a0._Z17check_shifted_sumIa23custom_divide_constantsIaEEvT_(%struct.State* %0, i64 %246, %struct.Memory* %MEMORY.1)
...
block_.L_402e6a:                                  ; preds = %block_.L_402dff
  %283 = add i64 %103, -8202
  %284 = add i64 %103, 5
  ...
  %call2_402e6a = tail call %struct.Memory* @sub_400e60._Z5timerv(%struct.State* %0, i64 %283, %struct.Memory* %MEMORY.0)
  ...
  %call2_402e73 = tail call %struct.Memory* @sub_400800._Z13record_resultdPKc(%struct.State* %0, i64 %294, %struct.Memory* %call2_402e6a)
  ...
  ret %struct.Memory* %call2_402e73
}
...
define %struct.Memory* @routine_jge_.L_402e6a(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i8* %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
...
define %struct.Memory* @routine_jge_.L_402e53(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i8* %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 2, i32 9
...
define %struct.Memory* @routine_jmpq_.L_402e1a(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
...
define %struct.Memory* @routine_callq_._Z17check_shifted_sumIa23custom_divide_constantsIaEEvT_(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
...
define %struct.Memory* @routine_jmpq_.L_402dff(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
