...
block_.L_40375f:                                  ; preds = %block_.L_4037b3, %entry
  %69 = phi i64 [ %.pre, %entry ], [ %282, %block_.L_4037b3 ]
...
block_.L_40377a:                                  ; preds = %block_403786, %block_40376f
  %112 = phi i64 [ %.pre1, %block_40376f ], [ %239, %block_403786 ]
...
block_.L_4037b3:                                  ; preds = %block_.L_40377a
  ...
  %call2_4037b7 = tail call %struct.Memory* @sub_417e10._Z17check_shifted_sumIa24custom_constant_multiplyIaEEvT_(%struct.State* %0, i64 %246, %struct.Memory* %MEMORY.1)
...
block_.L_4037ca:                                  ; preds = %block_.L_40375f
  ...
  %call2_4037ca = tail call %struct.Memory* @sub_400e60._Z5timerv(%struct.State* %0, i64 %283, %struct.Memory* %MEMORY.0)
  ...
  %call2_4037d3 = tail call %struct.Memory* @sub_400800._Z13record_resultdPKc(%struct.State* %0, i64 %294, %struct.Memory* %call2_4037ca)
