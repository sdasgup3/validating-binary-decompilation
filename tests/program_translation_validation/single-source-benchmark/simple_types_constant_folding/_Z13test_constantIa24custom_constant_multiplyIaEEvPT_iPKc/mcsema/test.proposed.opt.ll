...
declare %struct.Memory* @sub_417e30._ZN24custom_constant_multiplyIaE8do_shiftEa(%struct.State* dereferenceable(3376), i64, %struct.Memory*) local_unnamed_addr

declare %struct.Memory* @sub_417e50._Z17check_shifted_sumIa24custom_constant_multiplyIaEEvT_(%struct.State* dereferenceable(3376), i64, %struct.Memory*) local_unnamed_addr
...
block_.L_40379f:                                  ; preds = %block_.L_4037f3, %entry
  %69 = phi i64 [ %.pre, %entry ], [ %283, %block_.L_4037f3 ]
  %MEMORY.0 = phi %struct.Memory* [ %call2_403793, %entry ], [ %call2_4037f7, %block_.L_4037f3 ]
...
block_.L_4037ba:                                  ; preds = %block_4037c6, %block_4037af
  %112 = phi i64 [ %.pre6, %block_4037af ], [ %240, %block_4037c6 ]
  %MEMORY.1 = phi %struct.Memory* [ %MEMORY.0, %block_4037af ], [ %call2_4037d2, %block_4037c6 ]
...
block_4037c6:                                     ; preds = %block_.L_4037ba
  ...
  %call2_4037d2 = tail call %struct.Memory* @sub_417e30._ZN24custom_constant_multiplyIaE8do_shiftEa(%struct.State* nonnull %0, i64 %163, %struct.Memory* %MEMORY.1)
...
block_.L_4037f3:                                  ; preds = %block_.L_4037ba
  ...
  %call2_4037f7 = tail call %struct.Memory* @sub_417e50._Z17check_shifted_sumIa24custom_constant_multiplyIaEEvT_(%struct.State* nonnull %0, i64 %247, %struct.Memory* %MEMORY.1)
...
block_.L_40380a:                                  ; preds = %block_.L_40379f
  ...
  %call2_40380a = tail call %struct.Memory* @sub_400ea0._Z5timerv(%struct.State* nonnull %0, i64 %284, %struct.Memory* %MEMORY.0)
