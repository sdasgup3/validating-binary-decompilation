...
declare %struct.Memory* @sub_4183f0._ZN25custom_lessthan_constantsIaE8do_shiftEa(%struct.State* dereferenceable(3376), i64, %struct.Memory*) local_unnamed_addr

declare %struct.Memory* @sub_418410._Z17check_shifted_sumIa25custom_lessthan_constantsIaEEvT_(%struct.State* dereferenceable(3376), i64, %struct.Memory*) local_unnamed_addr
...
block_.L_40315f:                                  ; preds = %block_.L_4031b3, %entry
  %69 = phi i64 [ %.pre, %entry ], [ %283, %block_.L_4031b3 ]
  %MEMORY.0 = phi %struct.Memory* [ %call2_403153, %entry ], [ %call2_4031b7, %block_.L_4031b3 ]
...
block_.L_40317a:                                  ; preds = %block_403186, %block_40316f
  %112 = phi i64 [ %.pre6, %block_40316f ], [ %240, %block_403186 ]
  %MEMORY.1 = phi %struct.Memory* [ %MEMORY.0, %block_40316f ], [ %call2_403192, %block_403186 ]
...
block_403186:                                     ; preds = %block_.L_40317a
  ...
  %call2_403192 = tail call %struct.Memory* @sub_4183f0._ZN25custom_lessthan_constantsIaE8do_shiftEa(%struct.State* nonnull %0, i64 %163, %struct.Memory* %MEMORY.1)
...
block_.L_4031b3:                                  ; preds = %block_.L_40317a
  ...
  %call2_4031b7 = tail call %struct.Memory* @sub_418410._Z17check_shifted_sumIa25custom_lessthan_constantsIaEEvT_(%struct.State* nonnull %0, i64 %247, %struct.Memory* %MEMORY.1)
...
block_.L_4031ca:                                  ; preds = %block_.L_40315f
  ...
  %call2_4031ca = tail call %struct.Memory* @sub_400ea0._Z5timerv(%struct.State* nonnull %0, i64 %284, %struct.Memory* %MEMORY.0)
