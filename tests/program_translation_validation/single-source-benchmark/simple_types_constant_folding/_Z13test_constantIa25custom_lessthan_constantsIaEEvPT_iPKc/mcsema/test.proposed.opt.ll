...
block_.L_40311f:                                  ; preds = %block_.L_403173, %entry
  %69 = phi i64 [ %.pre, %entry ], [ %282, %block_.L_403173 ]
...
block_.L_40313a:                                  ; preds = %block_403146, %block_40312f
  %112 = phi i64 [ %.pre1, %block_40312f ], [ %239, %block_403146 ]
...
block_.L_403173:                                  ; preds = %block_.L_40313a
  ...
  %call2_403177 = tail call %struct.Memory* @sub_4183d0._Z17check_shifted_sumIa25custom_lessthan_constantsIaEEvT_(%struct.State* %0, i64 %246, %struct.Memory* %MEMORY.1)
...
block_.L_40318a:                                  ; preds = %block_.L_40311f
  ...
  %call2_40318a = tail call %struct.Memory* @sub_400e60._Z5timerv(%struct.State* %0, i64 %283, %struct.Memory* %MEMORY.0)
  ...
  %call2_403193 = tail call %struct.Memory* @sub_400800._Z13record_resultdPKc(%struct.State* %0, i64 %294, %struct.Memory* %call2_40318a)
