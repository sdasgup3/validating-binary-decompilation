...
define %struct.Memory* @_Z13test_constantIa25custom_multiply_constantsIaEEvPT_iPKc(%struct.State* noalias, i64, %struct.Memory* noalias) #1 {
entry:
  ...
  store %struct.Memory* %loadMem1_402d93, %struct.Memory** %MEMORY
...
block_.L_402dba:                                  ; preds = %block_402dc6, %block_402daf
  ...
  store %struct.Memory* %loadMem_402dc0, %struct.Memory** %MEMORY
...
block_402dc6:                                     ; preds = %block_.L_402dba
  ...
  store %struct.Memory* %loadMem_402dc6, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_402dce, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem1_402dd2, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_402dd7, %struct.Memory** %MEMORY
  ...
  store i8 %497, i8* %501
  store %struct.Memory* %loadMem_402de2, %struct.Memory** %MEMORY
...
block_.L_402df3:                                  ; preds = %block_.L_402dba
  ...
  store %struct.Memory* %loadMem1_402df7, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_402dfc, %struct.Memory** %MEMORY
...
block_.L_402e0a:                                  ; preds = %block_.L_402d9f
  ...
  store %struct.Memory* %loadMem1_402e0a, %struct.Memory** %MEMORY
  ...
  ret %struct.Memory* %loadMem_402e1d
}
