...
block_.L_402d5f:                                  ; preds = %block_.L_402db3, %entry
  %69 = phi i64 [ %.pre, %entry ], [ %284, %block_.L_402db3 ]
...
block_.L_402d7a:                                  ; preds = %block_402d86, %block_402d6f
  %112 = phi i64 [ %.pre1, %block_402d6f ], [ %240, %block_402d86 ]
...
block_.L_402db3:                                  ; preds = %block_.L_402d7a
  ...
  %call2_402db7 = tail call %struct.Memory* @sub_418730._Z17check_shifted_sumIa25custom_multiply_constantsIaEEvT_(%struct.State* %0, i64 %247, %struct.Memory* %MEMORY.1)
...
block_.L_402dca:                                  ; preds = %block_.L_402d5f
  ...
  %call2_402dca = tail call %struct.Memory* @sub_400e60._Z5timerv(%struct.State* %0, i64 %285, %struct.Memory* %MEMORY.0)
  ...
  %call2_402dd3 = tail call %struct.Memory* @sub_400800._Z13record_resultdPKc(%struct.State* %0, i64 %296, %struct.Memory* %call2_402dca)
