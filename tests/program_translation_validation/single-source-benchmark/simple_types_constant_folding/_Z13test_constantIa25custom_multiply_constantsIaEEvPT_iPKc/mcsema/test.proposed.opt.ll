...
declare %struct.Memory* @sub_418750._ZN25custom_multiply_constantsIaE8do_shiftEa(%struct.State* noalias dereferenceable(3376), i64, %struct.Memory* noalias readnone returned) local_unnamed_addr

declare %struct.Memory* @sub_418770._Z17check_shifted_sumIa25custom_multiply_constantsIaEEvT_(%struct.State* noalias dereferenceable(3376), i64, %struct.Memory* noalias readnone returned) local_unnamed_addr
...
define %struct.Memory* @_Z13test_constantIa25custom_multiply_constantsIaEEvPT_iPKc(%struct.State* noalias, i64, %struct.Memory* noalias readnone) local_unnamed_addr #1 {
entry:
...
block_.L_402d9f:                                  ; preds = %block_.L_402df3, %entry
  %69 = phi i64 [ %283, %block_.L_402df3 ], [ %.pre, %entry ]
...
block_.L_402dba:                                  ; preds = %block_402dc6, %block_402daf
  %112 = phi i64 [ %240, %block_402dc6 ], [ %.pre6, %block_402daf ]
...
block_402dc6:                                     ; preds = %block_.L_402dba
  ...
  %call2_402dd2 = tail call %struct.Memory* @sub_418750._ZN25custom_multiply_constantsIaE8do_shiftEa(%struct.State* nonnull %0, i64 %163, %struct.Memory* %call2_402d93)
...
block_.L_402df3:                                  ; preds = %block_.L_402dba
  ...
  %call2_402df7 = tail call %struct.Memory* @sub_418770._Z17check_shifted_sumIa25custom_multiply_constantsIaEEvT_(%struct.State* nonnull %0, i64 %247, %struct.Memory* %call2_402d93)
...
block_.L_402e0a:                                  ; preds = %block_.L_402d9f
  ...
  %call2_402e0a = tail call %struct.Memory* @sub_400ea0._Z5timerv(%struct.State* nonnull %0, i64 %284, %struct.Memory* %call2_402d93)
