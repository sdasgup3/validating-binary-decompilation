...
declare %struct.Memory* @sub_418530._Z17check_shifted_sumIa25custom_notequal_constantsIaEEvT_(%struct.State* noalias dereferenceable(3376), i64, %struct.Memory* noalias readnone returned) local_unnamed_addr
...
define %struct.Memory* @_Z13test_constantIa25custom_notequal_constantsIaEEvPT_iPKc(%struct.State* noalias, i64, %struct.Memory* noalias readnone) local_unnamed_addr #1 {
entry:
...
block_.L_40301f:                                  ; preds = %block_.L_403073, %entry
  %69 = phi i64 [ %283, %block_.L_403073 ], [ %.pre, %entry ]
...
block_.L_40303a:                                  ; preds = %block_403046, %block_40302f
  %112 = phi i64 [ %240, %block_403046 ], [ %.pre6, %block_40302f ]
...
block_403046:                                     ; preds = %block_.L_40303a
  ...
  %call2_403052 = tail call %struct.Memory* @sub_418510._ZN25custom_notequal_constantsIaE8do_shiftEa(%struct.State* nonnull %0, i64 %163, %struct.Memory* %call2_403013)
...
block_.L_403073:                                  ; preds = %block_.L_40303a
  ...
  %call2_403077 = tail call %struct.Memory* @sub_418530._Z17check_shifted_sumIa25custom_notequal_constantsIaEEvT_(%struct.State* nonnull %0, i64 %247, %struct.Memory* %call2_403013)
...
block_.L_40308a:                                  ; preds = %block_.L_40301f
  ...
  %call2_40308a = tail call %struct.Memory* @sub_400ea0._Z5timerv(%struct.State* nonnull %0, i64 %284, %struct.Memory* %call2_403013)
