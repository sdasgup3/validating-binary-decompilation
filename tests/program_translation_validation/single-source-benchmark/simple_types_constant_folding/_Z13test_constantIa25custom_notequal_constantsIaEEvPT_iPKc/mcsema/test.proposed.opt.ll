...
declare %struct.Memory* @sub_418540._Z17check_shifted_sumIa25custom_notequal_constantsIaEEvT_(%struct.State* noalias dereferenceable(3376), i64, %struct.Memory* noalias readnone returned) local_unnamed_addr
...
entry:
  ...
  %call2_403023 = tail call %struct.Memory* @sub_400e90._Z11start_timerv(%struct.State* %0, i64 %58, %struct.Memory* %2)
...
block_.L_40302f:                                  ; preds = %block_.L_403083, %entry
  %69 = phi i64 [ %283, %block_.L_403083 ], [ %.pre, %entry ]
  ...
  br i1 %102, label %block_40303f, label %block_.L_40309a
...
block_.L_40304a:                                  ; preds = %block_403056, %block_40303f
  %112 = phi i64 [ %240, %block_403056 ], [ %.pre6, %block_40303f ]
  ...
  br i1 %148, label %block_403056, label %block_.L_403083
...
block_403056:                                     ; preds = %block_.L_40304a
  ...
  %call2_403062 = tail call %struct.Memory* @sub_418520._ZN25custom_notequal_constantsIaE8do_shiftEa(%struct.State* nonnull %0, i64 %163, %struct.Memory* %call2_403023)
...
block_.L_403083:                                  ; preds = %block_.L_40304a
  ...
  %call2_403087 = tail call %struct.Memory* @sub_418540._Z17check_shifted_sumIa25custom_notequal_constantsIaEEvT_(%struct.State* nonnull %0, i64 %247, %struct.Memory* %call2_403023)
...
block_.L_40309a:                                  ; preds = %block_.L_40302f
  ...
  %call2_40309a = tail call %struct.Memory* @sub_400eb0._Z5timerv(%struct.State* nonnull %0, i64 %284, %struct.Memory* %call2_403023)
  ...
  %call2_4030a3 = tail call %struct.Memory* @sub_400850._Z13record_resultdPKc(%struct.State* nonnull %0, i64 %295, %struct.Memory* %call2_40309a)
