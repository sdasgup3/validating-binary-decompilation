...
block_.L_402fdf:                                  ; preds = %block_.L_403033, %entry
  %69 = phi i64 [ %.pre, %entry ], [ %282, %block_.L_403033 ]
...
block_.L_402ffa:                                  ; preds = %block_403006, %block_402fef
  %112 = phi i64 [ %.pre1, %block_402fef ], [ %239, %block_403006 ]
...
block_.L_403033:                                  ; preds = %block_.L_402ffa
  ...
  %call2_403037 = tail call %struct.Memory* @sub_4184f0._Z17check_shifted_sumIa25custom_notequal_constantsIaEEvT_(%struct.State* %0, i64 %246, %struct.Memory* %MEMORY.1)
...
block_.L_40304a:                                  ; preds = %block_.L_402fdf
  ...
  %call2_40304a = tail call %struct.Memory* @sub_400e60._Z5timerv(%struct.State* %0, i64 %283, %struct.Memory* %MEMORY.0)
  ...
  %call2_403053 = tail call %struct.Memory* @sub_400800._Z13record_resultdPKc(%struct.State* %0, i64 %294, %struct.Memory* %call2_40304a)
