...
block_.L_403d9f:                                  ; preds = %block_.L_403df3, %entry
  %69 = phi i64 [ %.pre, %entry ], [ %284, %block_.L_403df3 ]
...
block_.L_403dba:                                  ; preds = %block_403dc6, %block_403daf
  %112 = phi i64 [ %.pre1, %block_403daf ], [ %240, %block_403dc6 ]
...
block_.L_403df3:                                  ; preds = %block_.L_403dba
  ...
  %call2_403df7 = tail call %struct.Memory* @sub_417830._Z17check_shifted_sumIa27custom_multiple_constant_orIaEEvT_(%struct.State* %0, i64 %247, %struct.Memory* %MEMORY.1)
...
block_.L_403e0a:                                  ; preds = %block_.L_403d9f
  ...
  %call2_403e0a = tail call %struct.Memory* @sub_400e60._Z5timerv(%struct.State* %0, i64 %285, %struct.Memory* %MEMORY.0)
  ...
  %call2_403e13 = tail call %struct.Memory* @sub_400800._Z13record_resultdPKc(%struct.State* %0, i64 %296, %struct.Memory* %call2_403e0a)
