...
declare %struct.Memory* @sub_417880._Z17check_shifted_sumIa27custom_multiple_constant_orIaEEvT_(%struct.State* noalias dereferenceable(3376), i64, %struct.Memory* noalias readnone returned) local_unnamed_addr
...
entry:
  ...
  %call2_403de3 = tail call %struct.Memory* @sub_400e90._Z11start_timerv(%struct.State* %0, i64 %58, %struct.Memory* %2)
...
block_.L_403def:                                  ; preds = %block_.L_403e43, %entry
  %69 = phi i64 [ %283, %block_.L_403e43 ], [ %.pre, %entry ]
  ...
  br i1 %102, label %block_403dff, label %block_.L_403e5a
...
block_.L_403e0a:                                  ; preds = %block_403e16, %block_403dff
  %112 = phi i64 [ %240, %block_403e16 ], [ %.pre6, %block_403dff ]
  ...
  br i1 %148, label %block_403e16, label %block_.L_403e43
...
block_403e16:                                     ; preds = %block_.L_403e0a
  ...
  %call2_403e22 = tail call %struct.Memory* @sub_417850._ZN27custom_multiple_constant_orIaE8do_shiftEa(%struct.State* nonnull %0, i64 %163, %struct.Memory* %call2_403de3)
...
block_.L_403e43:                                  ; preds = %block_.L_403e0a
  ...
  %call2_403e47 = tail call %struct.Memory* @sub_417880._Z17check_shifted_sumIa27custom_multiple_constant_orIaEEvT_(%struct.State* nonnull %0, i64 %247, %struct.Memory* %call2_403de3)
...
block_.L_403e5a:                                  ; preds = %block_.L_403def
  ...
  %call2_403e5a = tail call %struct.Memory* @sub_400eb0._Z5timerv(%struct.State* nonnull %0, i64 %284, %struct.Memory* %call2_403de3)
  ...
  %call2_403e63 = tail call %struct.Memory* @sub_400850._Z13record_resultdPKc(%struct.State* nonnull %0, i64 %295, %struct.Memory* %call2_403e5a)
