...
define %struct.Memory* @_Z13test_constantIa28custom_greaterthan_constantsIaEEvPT_iPKc(%struct.State* noalias, i64, %struct.Memory* noalias) #1 {
entry:
...
block_4030e6:                                     ; preds = %block_.L_4030da
  ...
  store %struct.Memory* %loadMem1_4030f2, %struct.Memory** %MEMORY
...
block_.L_403113:                                  ; preds = %block_.L_4030da
  ...
  store %struct.Memory* %loadMem1_403117, %struct.Memory** %MEMORY
...
block_.L_40312a:                                  ; preds = %block_.L_4030bf
  ...
  store %struct.Memory* %loadMem1_40312a, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem1_403133, %struct.Memory** %MEMORY
  ...
  ret %struct.Memory* %loadMem_40313d
}
