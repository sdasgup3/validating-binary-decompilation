...
declare %struct.Memory* @sub_418460._Z17check_shifted_sumIa28custom_greaterthan_constantsIaEEvT_(%struct.State* noalias dereferenceable(3376), i64, %struct.Memory* noalias readnone returned) local_unnamed_addr
...
entry:
  ...
  %call2_403073 = tail call %struct.Memory* @sub_400e40._Z11start_timerv(%struct.State* %0, i64 %58, %struct.Memory* %2)
...
block_.L_40307f:                                  ; preds = %block_.L_4030d3, %entry
  %69 = phi i64 [ %.pre, %entry ], [ %282, %block_.L_4030d3 ]
  %MEMORY.0 = phi %struct.Memory* [ %call2_403073, %entry ], [ %call2_4030d7, %block_.L_4030d3 ]
  ...
  br i1 %102, label %block_40308f, label %block_.L_4030ea

block_40308f:                                     ; preds = %block_.L_40307f
  %104 = add i64 %70, -29
  %105 = add i64 %103, 4
...
block_.L_40309a:                                  ; preds = %block_4030a6, %block_40308f
  %112 = phi i64 [ %.pre1, %block_40308f ], [ %239, %block_4030a6 ]
  %MEMORY.1 = phi %struct.Memory* [ %MEMORY.0, %block_40308f ], [ %call2_4030b2, %block_4030a6 ]
  ...
  br i1 %148, label %block_4030a6, label %block_.L_4030d3

block_4030a6:                                     ; preds = %block_.L_40309a
  %150 = add i64 %113, -8
  %151 = add i64 %149, 4
  ...
  %call2_4030b2 = tail call %struct.Memory* @sub_418440._ZN28custom_greaterthan_constantsIaE8do_shiftEa(%struct.State* %0, i64 %163, %struct.Memory* %MEMORY.1)
...
block_.L_4030d3:                                  ; preds = %block_.L_40309a
  %240 = add i64 %113, -29
  %241 = add i64 %149, 4
  ...
  %call2_4030d7 = tail call %struct.Memory* @sub_418460._Z17check_shifted_sumIa28custom_greaterthan_constantsIaEEvT_(%struct.State* %0, i64 %246, %struct.Memory* %MEMORY.1)
...
block_.L_4030ea:                                  ; preds = %block_.L_40307f
  %283 = add i64 %103, -8842
  %284 = add i64 %103, 5
  ...
  %call2_4030ea = tail call %struct.Memory* @sub_400e60._Z5timerv(%struct.State* %0, i64 %283, %struct.Memory* %MEMORY.0)
  ...
  %call2_4030f3 = tail call %struct.Memory* @sub_400800._Z13record_resultdPKc(%struct.State* %0, i64 %294, %struct.Memory* %call2_4030ea)
  ...
  ret %struct.Memory* %call2_4030f3
}
...
define %struct.Memory* @routine_jge_.L_4030ea(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i8* %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
...
define %struct.Memory* @routine_jge_.L_4030d3(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i8* %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 2, i32 9
...
define %struct.Memory* @routine_jmpq_.L_40309a(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
...
define %struct.Memory* @routine_callq_._Z17check_shifted_sumIa28custom_greaterthan_constantsIaEEvT_(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
...
define %struct.Memory* @routine_jmpq_.L_40307f(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
