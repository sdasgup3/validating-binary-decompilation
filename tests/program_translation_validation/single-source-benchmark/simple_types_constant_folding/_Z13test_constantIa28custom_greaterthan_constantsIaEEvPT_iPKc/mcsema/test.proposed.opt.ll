...
block_.L_40307f:                                  ; preds = %block_.L_4030d3, %entry
  %69 = phi i64 [ %.pre, %entry ], [ %284, %block_.L_4030d3 ]
...
block_.L_40309a:                                  ; preds = %block_4030a6, %block_40308f
  %112 = phi i64 [ %.pre1, %block_40308f ], [ %240, %block_4030a6 ]
...
block_.L_4030d3:                                  ; preds = %block_.L_40309a
  ...
  %call2_4030d7 = tail call %struct.Memory* @sub_418460._Z17check_shifted_sumIa28custom_greaterthan_constantsIaEEvT_(%struct.State* %0, i64 %247, %struct.Memory* %MEMORY.1)
...
block_.L_4030ea:                                  ; preds = %block_.L_40307f
  ...
  %call2_4030ea = tail call %struct.Memory* @sub_400e60._Z5timerv(%struct.State* %0, i64 %285, %struct.Memory* %MEMORY.0)
  ...
  %call2_4030f3 = tail call %struct.Memory* @sub_400800._Z13record_resultdPKc(%struct.State* %0, i64 %296, %struct.Memory* %call2_4030ea)
