...
declare %struct.Memory* @sub_418020._Z17check_shifted_sumIa28custom_multiple_constant_addIaEEvT_(%struct.State* dereferenceable(3376), i64, %struct.Memory*)
...
define %struct.Memory* @_Z13test_constantIa28custom_multiple_constant_addIaEEvPT_iPKc(%struct.State* noalias, i64, %struct.Memory* noalias) #1 {
entry:
