...
block_.L_40357f:                                  ; preds = %block_.L_4035d3, %entry
  %69 = phi i64 [ %.pre, %entry ], [ %284, %block_.L_4035d3 ]
...
block_.L_40359a:                                  ; preds = %block_4035a6, %block_40358f
  %112 = phi i64 [ %.pre1, %block_40358f ], [ %240, %block_4035a6 ]
...
block_.L_4035d3:                                  ; preds = %block_.L_40359a
  ...
  %call2_4035d7 = tail call %struct.Memory* @sub_417fe0._Z17check_shifted_sumIa28custom_multiple_constant_addIaEEvT_(%struct.State* %0, i64 %247, %struct.Memory* %MEMORY.1)
...
block_.L_4035ea:                                  ; preds = %block_.L_40357f
  ...
  %call2_4035ea = tail call %struct.Memory* @sub_400e60._Z5timerv(%struct.State* %0, i64 %285, %struct.Memory* %MEMORY.0)
  ...
  %call2_4035f3 = tail call %struct.Memory* @sub_400800._Z13record_resultdPKc(%struct.State* %0, i64 %296, %struct.Memory* %call2_4035ea)
