...
declare %struct.Memory* @sub_417ff0._ZN28custom_multiple_constant_addIaE8do_shiftEa(%struct.State* noalias dereferenceable(3376), i64, %struct.Memory* noalias readnone returned) local_unnamed_addr

declare %struct.Memory* @sub_418020._Z17check_shifted_sumIa28custom_multiple_constant_addIaEEvT_(%struct.State* noalias dereferenceable(3376), i64, %struct.Memory* noalias readnone returned) local_unnamed_addr
...
define %struct.Memory* @_Z13test_constantIa28custom_multiple_constant_addIaEEvPT_iPKc(%struct.State* noalias, i64, %struct.Memory* noalias readnone) local_unnamed_addr #1 {
entry:
...
block_.L_4035bf:                                  ; preds = %block_.L_403613, %entry
  %69 = phi i64 [ %283, %block_.L_403613 ], [ %.pre, %entry ]
...
block_.L_4035da:                                  ; preds = %block_4035e6, %block_4035cf
  %112 = phi i64 [ %240, %block_4035e6 ], [ %.pre6, %block_4035cf ]
...
block_4035e6:                                     ; preds = %block_.L_4035da
  ...
  %call2_4035f2 = tail call %struct.Memory* @sub_417ff0._ZN28custom_multiple_constant_addIaE8do_shiftEa(%struct.State* nonnull %0, i64 %163, %struct.Memory* %call2_4035b3)
...
block_.L_403613:                                  ; preds = %block_.L_4035da
  ...
  %call2_403617 = tail call %struct.Memory* @sub_418020._Z17check_shifted_sumIa28custom_multiple_constant_addIaEEvT_(%struct.State* nonnull %0, i64 %247, %struct.Memory* %call2_4035b3)
...
block_.L_40362a:                                  ; preds = %block_.L_4035bf
  ...
  %call2_40362a = tail call %struct.Memory* @sub_400ea0._Z5timerv(%struct.State* nonnull %0, i64 %284, %struct.Memory* %call2_4035b3)
