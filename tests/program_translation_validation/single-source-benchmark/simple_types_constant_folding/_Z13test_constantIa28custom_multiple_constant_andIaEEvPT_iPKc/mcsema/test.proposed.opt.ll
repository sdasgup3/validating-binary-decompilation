...
block_.L_403c5f:                                  ; preds = %block_.L_403cb3, %entry
  %69 = phi i64 [ %.pre, %entry ], [ %282, %block_.L_403cb3 ]
...
block_.L_403c7a:                                  ; preds = %block_403c86, %block_403c6f
  %112 = phi i64 [ %.pre1, %block_403c6f ], [ %239, %block_403c86 ]
...
block_.L_403cb3:                                  ; preds = %block_.L_403c7a
  ...
  %call2_403cb7 = tail call %struct.Memory* @sub_417960._Z17check_shifted_sumIa28custom_multiple_constant_andIaEEvT_(%struct.State* %0, i64 %246, %struct.Memory* %MEMORY.1)
...
block_.L_403cca:                                  ; preds = %block_.L_403c5f
  ...
  %call2_403cca = tail call %struct.Memory* @sub_400e60._Z5timerv(%struct.State* %0, i64 %283, %struct.Memory* %MEMORY.0)
  ...
  %call2_403cd3 = tail call %struct.Memory* @sub_400800._Z13record_resultdPKc(%struct.State* %0, i64 %294, %struct.Memory* %call2_403cca)
