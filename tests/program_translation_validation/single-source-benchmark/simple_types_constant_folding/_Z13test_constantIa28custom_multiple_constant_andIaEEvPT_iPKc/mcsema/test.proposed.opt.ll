...
declare %struct.Memory* @sub_4179a0._Z17check_shifted_sumIa28custom_multiple_constant_andIaEEvT_(%struct.State* noalias dereferenceable(3376), i64, %struct.Memory* noalias readnone returned) local_unnamed_addr
...
define %struct.Memory* @_Z13test_constantIa28custom_multiple_constant_andIaEEvPT_iPKc(%struct.State* noalias, i64, %struct.Memory* noalias readnone) local_unnamed_addr #1 {
entry:
...
block_.L_403c9f:                                  ; preds = %block_.L_403cf3, %entry
  %69 = phi i64 [ %283, %block_.L_403cf3 ], [ %.pre, %entry ]
...
block_.L_403cba:                                  ; preds = %block_403cc6, %block_403caf
  %112 = phi i64 [ %240, %block_403cc6 ], [ %.pre6, %block_403caf ]
...
block_403cc6:                                     ; preds = %block_.L_403cba
  ...
  %call2_403cd2 = tail call %struct.Memory* @sub_417970._ZN28custom_multiple_constant_andIaE8do_shiftEa(%struct.State* nonnull %0, i64 %163, %struct.Memory* %call2_403c93)
...
block_.L_403cf3:                                  ; preds = %block_.L_403cba
  ...
  %call2_403cf7 = tail call %struct.Memory* @sub_4179a0._Z17check_shifted_sumIa28custom_multiple_constant_andIaEEvT_(%struct.State* nonnull %0, i64 %247, %struct.Memory* %call2_403c93)
...
block_.L_403d0a:                                  ; preds = %block_.L_403c9f
  ...
  %call2_403d0a = tail call %struct.Memory* @sub_400ea0._Z5timerv(%struct.State* nonnull %0, i64 %284, %struct.Memory* %call2_403c93)
