...
declare %struct.Memory* @sub_4179b0._Z17check_shifted_sumIa28custom_multiple_constant_andIaEEvT_(%struct.State* noalias dereferenceable(3376), i64, %struct.Memory* noalias readnone returned) local_unnamed_addr
...
entry:
  ...
  %call2_403ca3 = tail call %struct.Memory* @sub_400e90._Z11start_timerv(%struct.State* %0, i64 %58, %struct.Memory* %2)
...
block_.L_403caf:                                  ; preds = %block_.L_403d03, %entry
  %69 = phi i64 [ %283, %block_.L_403d03 ], [ %.pre, %entry ]
  ...
  br i1 %102, label %block_403cbf, label %block_.L_403d1a
...
block_.L_403cca:                                  ; preds = %block_403cd6, %block_403cbf
  %112 = phi i64 [ %240, %block_403cd6 ], [ %.pre6, %block_403cbf ]
  ...
  br i1 %148, label %block_403cd6, label %block_.L_403d03
...
block_403cd6:                                     ; preds = %block_.L_403cca
  ...
  %call2_403ce2 = tail call %struct.Memory* @sub_417980._ZN28custom_multiple_constant_andIaE8do_shiftEa(%struct.State* nonnull %0, i64 %163, %struct.Memory* %call2_403ca3)
...
block_.L_403d03:                                  ; preds = %block_.L_403cca
  ...
  %call2_403d07 = tail call %struct.Memory* @sub_4179b0._Z17check_shifted_sumIa28custom_multiple_constant_andIaEEvT_(%struct.State* nonnull %0, i64 %247, %struct.Memory* %call2_403ca3)
...
block_.L_403d1a:                                  ; preds = %block_.L_403caf
  ...
  %call2_403d1a = tail call %struct.Memory* @sub_400eb0._Z5timerv(%struct.State* nonnull %0, i64 %284, %struct.Memory* %call2_403ca3)
  ...
  %call2_403d23 = tail call %struct.Memory* @sub_400850._Z13record_resultdPKc(%struct.State* nonnull %0, i64 %295, %struct.Memory* %call2_403d1a)
