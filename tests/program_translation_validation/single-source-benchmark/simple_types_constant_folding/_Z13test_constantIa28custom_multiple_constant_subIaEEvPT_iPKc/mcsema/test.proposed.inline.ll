...
entry:
  ...
  store %struct.Memory* %loadMem_4036a1, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem1_4036b3, %struct.Memory** %MEMORY
...
block_.L_4036bf:                                  ; preds = %block_.L_403713, %entry
...
block_4036cf:                                     ; preds = %block_.L_4036bf
  ...
  store i32 0, i32* %236
  store %struct.Memory* %loadMem_4036d3, %struct.Memory** %MEMORY
  br label %block_.L_4036da

block_.L_4036da:                                  ; preds = %block_4036e6, %block_4036cf
...
block_4036e6:                                     ; preds = %block_.L_4036da
  ...
  store %struct.Memory* %loadMem_4036e6, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_4036ee, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem1_4036f2, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_4036fe, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_403705, %struct.Memory** %MEMORY
...
block_.L_403713:                                  ; preds = %block_.L_4036da
  ...
  store %struct.Memory* %loadMem1_403717, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_40371c, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_403725, %struct.Memory** %MEMORY
  br label %block_.L_4036bf

block_.L_40372a:                                  ; preds = %block_.L_4036bf
  ...
  store %struct.Memory* %loadMem1_40372a, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem1_403733, %struct.Memory** %MEMORY
  ...
  ret %struct.Memory* %loadMem_40373d
}
