...
block_.L_4036bf:                                  ; preds = %block_.L_403713, %entry
  %69 = phi i64 [ %.pre, %entry ], [ %284, %block_.L_403713 ]
...
block_.L_4036da:                                  ; preds = %block_4036e6, %block_4036cf
  %112 = phi i64 [ %.pre1, %block_4036cf ], [ %240, %block_4036e6 ]
...
block_.L_403713:                                  ; preds = %block_.L_4036da
  ...
  %call2_403717 = tail call %struct.Memory* @sub_417eb0._Z17check_shifted_sumIa28custom_multiple_constant_subIaEEvT_(%struct.State* %0, i64 %247, %struct.Memory* %MEMORY.1)
...
block_.L_40372a:                                  ; preds = %block_.L_4036bf
  ...
  %call2_40372a = tail call %struct.Memory* @sub_400e60._Z5timerv(%struct.State* %0, i64 %285, %struct.Memory* %MEMORY.0)
  ...
  %call2_403733 = tail call %struct.Memory* @sub_400800._Z13record_resultdPKc(%struct.State* %0, i64 %296, %struct.Memory* %call2_40372a)
