...
declare %struct.Memory* @sub_417ec0._ZN28custom_multiple_constant_subIaE8do_shiftEa(%struct.State* noalias dereferenceable(3376), i64, %struct.Memory* noalias readnone returned) local_unnamed_addr

declare %struct.Memory* @sub_417ef0._Z17check_shifted_sumIa28custom_multiple_constant_subIaEEvT_(%struct.State* noalias dereferenceable(3376), i64, %struct.Memory* noalias readnone returned) local_unnamed_addr
...
define %struct.Memory* @_Z13test_constantIa28custom_multiple_constant_subIaEEvPT_iPKc(%struct.State* noalias, i64, %struct.Memory* noalias readnone) local_unnamed_addr #1 {
entry:
...
block_.L_4036ff:                                  ; preds = %block_.L_403753, %entry
  %69 = phi i64 [ %283, %block_.L_403753 ], [ %.pre, %entry ]
...
block_.L_40371a:                                  ; preds = %block_403726, %block_40370f
  %112 = phi i64 [ %240, %block_403726 ], [ %.pre6, %block_40370f ]
...
block_403726:                                     ; preds = %block_.L_40371a
  ...
  %call2_403732 = tail call %struct.Memory* @sub_417ec0._ZN28custom_multiple_constant_subIaE8do_shiftEa(%struct.State* nonnull %0, i64 %163, %struct.Memory* %call2_4036f3)
...
block_.L_403753:                                  ; preds = %block_.L_40371a
  ...
  %call2_403757 = tail call %struct.Memory* @sub_417ef0._Z17check_shifted_sumIa28custom_multiple_constant_subIaEEvT_(%struct.State* nonnull %0, i64 %247, %struct.Memory* %call2_4036f3)
...
block_.L_40376a:                                  ; preds = %block_.L_4036ff
  ...
  %call2_40376a = tail call %struct.Memory* @sub_400ea0._Z5timerv(%struct.State* nonnull %0, i64 %284, %struct.Memory* %call2_4036f3)
