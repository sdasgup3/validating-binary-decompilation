...
block_.L_403edf:                                  ; preds = %block_.L_403f33, %entry
  %69 = phi i64 [ %.pre, %entry ], [ %282, %block_.L_403f33 ]
...
block_.L_403efa:                                  ; preds = %block_403f06, %block_403eef
  %112 = phi i64 [ %.pre1, %block_403eef ], [ %239, %block_403f06 ]
...
block_.L_403f33:                                  ; preds = %block_.L_403efa
  ...
  %call2_403f37 = tail call %struct.Memory* @sub_4176b0._Z17check_shifted_sumIa28custom_multiple_constant_xorIaEEvT_(%struct.State* %0, i64 %246, %struct.Memory* %MEMORY.1)
...
block_.L_403f4a:                                  ; preds = %block_.L_403edf
  ...
  %call2_403f4a = tail call %struct.Memory* @sub_400e60._Z5timerv(%struct.State* %0, i64 %283, %struct.Memory* %MEMORY.0)
  ...
  %call2_403f53 = tail call %struct.Memory* @sub_400800._Z13record_resultdPKc(%struct.State* %0, i64 %294, %struct.Memory* %call2_403f4a)
