...
declare %struct.Memory* @sub_4182f0._Z17check_shifted_sumIa30custom_lessthanequal_constantsIaEEvT_(%struct.State* dereferenceable(3376), i64, %struct.Memory*)
...
define %struct.Memory* @_Z13test_constantIa30custom_lessthanequal_constantsIaEEvPT_iPKc(%struct.State* noalias, i64, %struct.Memory* noalias) #1 {
entry:
