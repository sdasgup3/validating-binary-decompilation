...
declare %struct.Memory* @sub_4182b0._Z17check_shifted_sumIa30custom_lessthanequal_constantsIaEEvT_(%struct.State* noalias dereferenceable(3376), i64, %struct.Memory* noalias readnone returned) local_unnamed_addr
...
define %struct.Memory* @_Z13test_constantIa30custom_lessthanequal_constantsIaEEvPT_iPKc(%struct.State* noalias, i64, %struct.Memory* noalias) local_unnamed_addr #1 {
entry:
  ...
  %call2_403253 = tail call %struct.Memory* @sub_400e40._Z11start_timerv(%struct.State* %0, i64 %58, %struct.Memory* %2)
  ...
  br label %block_.L_40325f

block_.L_40325f:                                  ; preds = %block_.L_4032b3, %entry
  %69 = phi i64 [ %.pre, %entry ], [ %284, %block_.L_4032b3 ]
  %MEMORY.0 = phi %struct.Memory* [ %call2_403253, %entry ], [ %call2_4032b7, %block_.L_4032b3 ]
  ...
  br i1 %102, label %block_40326f, label %block_.L_4032ca

block_40326f:                                     ; preds = %block_.L_40325f
  %104 = add i64 %70, -29
  %105 = add i64 %103, 4
  ...
  br label %block_.L_40327a

block_.L_40327a:                                  ; preds = %block_403286, %block_40326f
  %112 = phi i64 [ %.pre1, %block_40326f ], [ %240, %block_403286 ]
  %MEMORY.1 = phi %struct.Memory* [ %MEMORY.0, %block_40326f ], [ %call2_403292, %block_403286 ]
  ...
  br i1 %148, label %block_403286, label %block_.L_4032b3

block_403286:                                     ; preds = %block_.L_40327a
  %150 = add i64 %113, -8
  %151 = add i64 %149, 4
  ...
  %call2_403292 = tail call %struct.Memory* @sub_418290._ZN30custom_lessthanequal_constantsIaE8do_shiftEa(%struct.State* %0, i64 %163, %struct.Memory* %MEMORY.1)
...
block_.L_4032b3:                                  ; preds = %block_.L_40327a
  %241 = add i64 %113, -29
  %242 = add i64 %149, 4
  ...
  %call2_4032b7 = tail call %struct.Memory* @sub_4182b0._Z17check_shifted_sumIa30custom_lessthanequal_constantsIaEEvT_(%struct.State* %0, i64 %247, %struct.Memory* %MEMORY.1)
...
block_.L_4032ca:                                  ; preds = %block_.L_40325f
  %285 = add i64 %103, -9322
  %286 = add i64 %103, 5
  ...
  %call2_4032ca = tail call %struct.Memory* @sub_400e60._Z5timerv(%struct.State* %0, i64 %285, %struct.Memory* %MEMORY.0)
  ...
  %call2_4032d3 = tail call %struct.Memory* @sub_400800._Z13record_resultdPKc(%struct.State* %0, i64 %296, %struct.Memory* %call2_4032ca)
  ...
  ret %struct.Memory* %call2_4032d3
}
...
define %struct.Memory* @routine_jge_.L_4032ca(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i8* %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
...
define %struct.Memory* @routine_jge_.L_4032b3(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i8* %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 2, i32 9
...
define %struct.Memory* @routine_jmpq_.L_40327a(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
...
define %struct.Memory* @routine_callq_._Z17check_shifted_sumIa30custom_lessthanequal_constantsIaEEvT_(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
...
define %struct.Memory* @routine_jmpq_.L_40325f(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
