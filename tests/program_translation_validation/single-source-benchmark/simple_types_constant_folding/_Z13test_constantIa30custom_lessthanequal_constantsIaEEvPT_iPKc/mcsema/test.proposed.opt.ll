...
declare %struct.Memory* @sub_4182f0._Z17check_shifted_sumIa30custom_lessthanequal_constantsIaEEvT_(%struct.State* noalias dereferenceable(3376), i64, %struct.Memory* noalias readnone returned) local_unnamed_addr
...
define %struct.Memory* @_Z13test_constantIa30custom_lessthanequal_constantsIaEEvPT_iPKc(%struct.State* noalias, i64, %struct.Memory* noalias readnone) local_unnamed_addr #1 {
entry:
...
block_.L_40329f:                                  ; preds = %block_.L_4032f3, %entry
  %69 = phi i64 [ %283, %block_.L_4032f3 ], [ %.pre, %entry ]
...
block_.L_4032ba:                                  ; preds = %block_4032c6, %block_4032af
  %112 = phi i64 [ %240, %block_4032c6 ], [ %.pre6, %block_4032af ]
...
block_4032c6:                                     ; preds = %block_.L_4032ba
  ...
  %call2_4032d2 = tail call %struct.Memory* @sub_4182d0._ZN30custom_lessthanequal_constantsIaE8do_shiftEa(%struct.State* nonnull %0, i64 %163, %struct.Memory* %call2_403293)
...
block_.L_4032f3:                                  ; preds = %block_.L_4032ba
  ...
  %call2_4032f7 = tail call %struct.Memory* @sub_4182f0._Z17check_shifted_sumIa30custom_lessthanequal_constantsIaEEvT_(%struct.State* nonnull %0, i64 %247, %struct.Memory* %call2_403293)
...
block_.L_40330a:                                  ; preds = %block_.L_40329f
  ...
  %call2_40330a = tail call %struct.Memory* @sub_400ea0._Z5timerv(%struct.State* nonnull %0, i64 %284, %struct.Memory* %call2_403293)
