...
block_.L_40325f:                                  ; preds = %block_.L_4032b3, %entry
  %69 = phi i64 [ %.pre, %entry ], [ %282, %block_.L_4032b3 ]
...
block_.L_40327a:                                  ; preds = %block_403286, %block_40326f
  %112 = phi i64 [ %.pre1, %block_40326f ], [ %239, %block_403286 ]
...
block_.L_4032b3:                                  ; preds = %block_.L_40327a
  ...
  %call2_4032b7 = tail call %struct.Memory* @sub_4182b0._Z17check_shifted_sumIa30custom_lessthanequal_constantsIaEEvT_(%struct.State* %0, i64 %246, %struct.Memory* %MEMORY.1)
...
block_.L_4032ca:                                  ; preds = %block_.L_40325f
  ...
  %call2_4032ca = tail call %struct.Memory* @sub_400e60._Z5timerv(%struct.State* %0, i64 %283, %struct.Memory* %MEMORY.0)
  ...
  %call2_4032d3 = tail call %struct.Memory* @sub_400800._Z13record_resultdPKc(%struct.State* %0, i64 %294, %struct.Memory* %call2_4032ca)
