...
declare %struct.Memory* @sub_418300._Z17check_shifted_sumIa30custom_lessthanequal_constantsIaEEvT_(%struct.State* noalias dereferenceable(3376), i64, %struct.Memory* noalias readnone returned) local_unnamed_addr
...
entry:
  ...
  %call2_4032a3 = tail call %struct.Memory* @sub_400e90._Z11start_timerv(%struct.State* %0, i64 %58, %struct.Memory* %2)
  ...
  br label %block_.L_4032af

block_.L_4032af:                                  ; preds = %block_.L_403303, %entry
  %69 = phi i64 [ %283, %block_.L_403303 ], [ %.pre, %entry ]
  ...
  br i1 %102, label %block_4032bf, label %block_.L_40331a

block_4032bf:                                     ; preds = %block_.L_4032af
  %104 = add i64 %70, -29
  %105 = add i64 %103, 4
...
block_.L_4032ca:                                  ; preds = %block_4032d6, %block_4032bf
  %112 = phi i64 [ %240, %block_4032d6 ], [ %.pre6, %block_4032bf ]
  ...
  br i1 %148, label %block_4032d6, label %block_.L_403303

block_4032d6:                                     ; preds = %block_.L_4032ca
  %150 = add i64 %113, -8
  %151 = add i64 %149, 4
  ...
  %call2_4032e2 = tail call %struct.Memory* @sub_4182e0._ZN30custom_lessthanequal_constantsIaE8do_shiftEa(%struct.State* nonnull %0, i64 %163, %struct.Memory* %call2_4032a3)
...
block_.L_403303:                                  ; preds = %block_.L_4032ca
  %241 = add i64 %113, -29
  %242 = add i64 %149, 4
  ...
  %call2_403307 = tail call %struct.Memory* @sub_418300._Z17check_shifted_sumIa30custom_lessthanequal_constantsIaEEvT_(%struct.State* nonnull %0, i64 %247, %struct.Memory* %call2_4032a3)
...
block_.L_40331a:                                  ; preds = %block_.L_4032af
  ...
  %call2_40331a = tail call %struct.Memory* @sub_400eb0._Z5timerv(%struct.State* nonnull %0, i64 %284, %struct.Memory* %call2_4032a3)
  ...
  %call2_403323 = tail call %struct.Memory* @sub_400850._Z13record_resultdPKc(%struct.State* nonnull %0, i64 %295, %struct.Memory* %call2_40331a)
