...
declare %struct.Memory* @sub_417c00._Z17check_shifted_sumIa31custom_multiple_constant_divideIaEEvT_(%struct.State* dereferenceable(3376), i64, %struct.Memory*)
...
define %struct.Memory* @_Z13test_constantIa31custom_multiple_constant_divideIaEEvPT_iPKc(%struct.State* noalias, i64, %struct.Memory* noalias) #1 {
entry:
