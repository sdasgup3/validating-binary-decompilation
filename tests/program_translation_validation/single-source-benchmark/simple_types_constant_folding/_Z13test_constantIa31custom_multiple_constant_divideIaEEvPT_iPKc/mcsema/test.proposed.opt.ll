...
declare %struct.Memory* @sub_417c10._Z17check_shifted_sumIa31custom_multiple_constant_divideIaEEvT_(%struct.State* noalias dereferenceable(3376), i64, %struct.Memory* noalias readnone returned) local_unnamed_addr
...
define %struct.Memory* @_Z13test_constantIa31custom_multiple_constant_divideIaEEvPT_iPKc(%struct.State* noalias, i64, %struct.Memory* noalias readnone) local_unnamed_addr #1 {
entry:
  ...
  %call2_403a23 = tail call %struct.Memory* @sub_400e90._Z11start_timerv(%struct.State* %0, i64 %58, %struct.Memory* %2)
...
block_.L_403a2f:                                  ; preds = %block_.L_403a83, %entry
  %69 = phi i64 [ %283, %block_.L_403a83 ], [ %.pre, %entry ]
  ...
  br i1 %102, label %block_403a3f, label %block_.L_403a9a
...
block_.L_403a4a:                                  ; preds = %block_403a56, %block_403a3f
  %112 = phi i64 [ %240, %block_403a56 ], [ %.pre6, %block_403a3f ]
  ...
  br i1 %148, label %block_403a56, label %block_.L_403a83
...
block_403a56:                                     ; preds = %block_.L_403a4a
  ...
  %call2_403a62 = tail call %struct.Memory* @sub_417bd0._ZN31custom_multiple_constant_divideIaE8do_shiftEa(%struct.State* nonnull %0, i64 %163, %struct.Memory* %call2_403a23)
...
block_.L_403a83:                                  ; preds = %block_.L_403a4a
  ...
  %call2_403a87 = tail call %struct.Memory* @sub_417c10._Z17check_shifted_sumIa31custom_multiple_constant_divideIaEEvT_(%struct.State* nonnull %0, i64 %247, %struct.Memory* %call2_403a23)
...
block_.L_403a9a:                                  ; preds = %block_.L_403a2f
  ...
  %call2_403a9a = tail call %struct.Memory* @sub_400eb0._Z5timerv(%struct.State* nonnull %0, i64 %284, %struct.Memory* %call2_403a23)
  ...
  %call2_403aa3 = tail call %struct.Memory* @sub_400850._Z13record_resultdPKc(%struct.State* nonnull %0, i64 %295, %struct.Memory* %call2_403a9a)
  ...
  ret %struct.Memory* %call2_403aa3
}
...
; Function Attrs: alwaysinline norecurse nounwind
define %struct.Memory* @routine_jge_.L_403a9a(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i8* nocapture %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
...
; Function Attrs: alwaysinline norecurse nounwind
define %struct.Memory* @routine_jge_.L_403a83(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i8* nocapture %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 2, i32 9
