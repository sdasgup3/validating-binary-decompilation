...
block_.L_4039df:                                  ; preds = %block_.L_403a33, %entry
  %69 = phi i64 [ %.pre, %entry ], [ %282, %block_.L_403a33 ]
...
block_.L_4039fa:                                  ; preds = %block_403a06, %block_4039ef
  %112 = phi i64 [ %.pre1, %block_4039ef ], [ %239, %block_403a06 ]
...
block_.L_403a33:                                  ; preds = %block_.L_4039fa
  ...
  %call2_403a37 = tail call %struct.Memory* @sub_417bc0._Z17check_shifted_sumIa31custom_multiple_constant_divideIaEEvT_(%struct.State* %0, i64 %246, %struct.Memory* %MEMORY.1)
...
block_.L_403a4a:                                  ; preds = %block_.L_4039df
  ...
  %call2_403a4a = tail call %struct.Memory* @sub_400e60._Z5timerv(%struct.State* %0, i64 %283, %struct.Memory* %MEMORY.0)
  ...
  %call2_403a53 = tail call %struct.Memory* @sub_400800._Z13record_resultdPKc(%struct.State* %0, i64 %294, %struct.Memory* %call2_403a4a)
