...
block_.L_403a7f:                                  ; preds = %block_.L_403ad3, %entry
  %69 = phi i64 [ %.pre, %entry ], [ %284, %block_.L_403ad3 ]
...
block_.L_403a9a:                                  ; preds = %block_403aa6, %block_403a8f
  %112 = phi i64 [ %.pre1, %block_403a8f ], [ %240, %block_403aa6 ]
...
block_.L_403ad3:                                  ; preds = %block_.L_403a9a
  ...
  %call2_403ad7 = tail call %struct.Memory* @sub_417b10._Z17check_shifted_sumIa32custom_multiple_constant_divide2IaEEvT_(%struct.State* %0, i64 %247, %struct.Memory* %MEMORY.1)
...
block_.L_403aea:                                  ; preds = %block_.L_403a7f
  ...
  %call2_403aea = tail call %struct.Memory* @sub_400e60._Z5timerv(%struct.State* %0, i64 %285, %struct.Memory* %MEMORY.0)
  ...
  %call2_403af3 = tail call %struct.Memory* @sub_400800._Z13record_resultdPKc(%struct.State* %0, i64 %296, %struct.Memory* %call2_403aea)
