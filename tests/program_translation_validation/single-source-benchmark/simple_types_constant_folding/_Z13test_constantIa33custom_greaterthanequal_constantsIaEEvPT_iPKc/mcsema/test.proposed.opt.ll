...
block_.L_4031bf:                                  ; preds = %block_.L_403213, %entry
  %69 = phi i64 [ %.pre, %entry ], [ %282, %block_.L_403213 ]
...
block_.L_4031da:                                  ; preds = %block_4031e6, %block_4031cf
  %112 = phi i64 [ %.pre1, %block_4031cf ], [ %239, %block_4031e6 ]
...
block_.L_403213:                                  ; preds = %block_.L_4031da
  ...
  %call2_403217 = tail call %struct.Memory* @sub_418340._Z17check_shifted_sumIa33custom_greaterthanequal_constantsIaEEvT_(%struct.State* %0, i64 %246, %struct.Memory* %MEMORY.1)
...
block_.L_40322a:                                  ; preds = %block_.L_4031bf
  ...
  %call2_40322a = tail call %struct.Memory* @sub_400e60._Z5timerv(%struct.State* %0, i64 %283, %struct.Memory* %MEMORY.0)
  ...
  %call2_403233 = tail call %struct.Memory* @sub_400800._Z13record_resultdPKc(%struct.State* %0, i64 %294, %struct.Memory* %call2_40322a)
