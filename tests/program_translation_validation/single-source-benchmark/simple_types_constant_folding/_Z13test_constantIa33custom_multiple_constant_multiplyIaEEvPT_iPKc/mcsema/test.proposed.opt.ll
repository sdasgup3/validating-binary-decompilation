...
declare %struct.Memory* @sub_417dc0._Z17check_shifted_sumIa33custom_multiple_constant_multiplyIaEEvT_(%struct.State* noalias dereferenceable(3376), i64, %struct.Memory* noalias readnone returned) local_unnamed_addr
...
define %struct.Memory* @_Z13test_constantIa33custom_multiple_constant_multiplyIaEEvPT_iPKc(%struct.State* noalias, i64, %struct.Memory* noalias readnone) local_unnamed_addr #1 {
entry:
...
block_.L_40383f:                                  ; preds = %block_.L_403893, %entry
  %69 = phi i64 [ %283, %block_.L_403893 ], [ %.pre, %entry ]
...
block_.L_40385a:                                  ; preds = %block_403866, %block_40384f
  %112 = phi i64 [ %240, %block_403866 ], [ %.pre6, %block_40384f ]
...
block_403866:                                     ; preds = %block_.L_40385a
  ...
  %call2_403872 = tail call %struct.Memory* @sub_417d90._ZN33custom_multiple_constant_multiplyIaE8do_shiftEa(%struct.State* nonnull %0, i64 %163, %struct.Memory* %call2_403833)
...
block_.L_403893:                                  ; preds = %block_.L_40385a
  ...
  %call2_403897 = tail call %struct.Memory* @sub_417dc0._Z17check_shifted_sumIa33custom_multiple_constant_multiplyIaEEvT_(%struct.State* nonnull %0, i64 %247, %struct.Memory* %call2_403833)
...
block_.L_4038aa:                                  ; preds = %block_.L_40383f
  ...
  %call2_4038aa = tail call %struct.Memory* @sub_400ea0._Z5timerv(%struct.State* nonnull %0, i64 %284, %struct.Memory* %call2_403833)
