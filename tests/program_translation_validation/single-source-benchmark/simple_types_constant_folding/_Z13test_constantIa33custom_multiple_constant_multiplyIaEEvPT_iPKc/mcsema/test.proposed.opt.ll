...
block_.L_4037ff:                                  ; preds = %block_.L_403853, %entry
  %69 = phi i64 [ %.pre, %entry ], [ %284, %block_.L_403853 ]
...
block_.L_40381a:                                  ; preds = %block_403826, %block_40380f
  %112 = phi i64 [ %.pre1, %block_40380f ], [ %240, %block_403826 ]
...
block_.L_403853:                                  ; preds = %block_.L_40381a
  ...
  %call2_403857 = tail call %struct.Memory* @sub_417d80._Z17check_shifted_sumIa33custom_multiple_constant_multiplyIaEEvT_(%struct.State* %0, i64 %247, %struct.Memory* %MEMORY.1)
...
block_.L_40386a:                                  ; preds = %block_.L_4037ff
  ...
  %call2_40386a = tail call %struct.Memory* @sub_400e60._Z5timerv(%struct.State* %0, i64 %285, %struct.Memory* %MEMORY.0)
  ...
  %call2_403873 = tail call %struct.Memory* @sub_400800._Z13record_resultdPKc(%struct.State* %0, i64 %296, %struct.Memory* %call2_40386a)
