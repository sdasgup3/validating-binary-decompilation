...
declare %struct.Memory* @sub_417d80._Z17check_shifted_sumIa33custom_multiple_constant_multiplyIaEEvT_(%struct.State* noalias dereferenceable(3376), i64, %struct.Memory* noalias readnone returned) local_unnamed_addr
...
entry:
  ...
  %call2_4037f3 = tail call %struct.Memory* @sub_400e40._Z11start_timerv(%struct.State* %0, i64 %58, %struct.Memory* %2)
...
block_.L_4037ff:                                  ; preds = %block_.L_403853, %entry
  %69 = phi i64 [ %.pre, %entry ], [ %282, %block_.L_403853 ]
  %MEMORY.0 = phi %struct.Memory* [ %call2_4037f3, %entry ], [ %call2_403857, %block_.L_403853 ]
  ...
  br i1 %102, label %block_40380f, label %block_.L_40386a
...
block_.L_40381a:                                  ; preds = %block_403826, %block_40380f
  %112 = phi i64 [ %.pre1, %block_40380f ], [ %239, %block_403826 ]
  %MEMORY.1 = phi %struct.Memory* [ %MEMORY.0, %block_40380f ], [ %call2_403832, %block_403826 ]
  ...
  br i1 %148, label %block_403826, label %block_.L_403853
...
block_403826:                                     ; preds = %block_.L_40381a
  ...
  %call2_403832 = tail call %struct.Memory* @sub_417d50._ZN33custom_multiple_constant_multiplyIaE8do_shiftEa(%struct.State* %0, i64 %163, %struct.Memory* %MEMORY.1)
...
block_.L_403853:                                  ; preds = %block_.L_40381a
  %240 = add i64 %113, -29
  %241 = add i64 %149, 4
  ...
  %call2_403857 = tail call %struct.Memory* @sub_417d80._Z17check_shifted_sumIa33custom_multiple_constant_multiplyIaEEvT_(%struct.State* %0, i64 %246, %struct.Memory* %MEMORY.1)
...
block_.L_40386a:                                  ; preds = %block_.L_4037ff
  %283 = add i64 %103, -10762
  %284 = add i64 %103, 5
  ...
  %call2_40386a = tail call %struct.Memory* @sub_400e60._Z5timerv(%struct.State* %0, i64 %283, %struct.Memory* %MEMORY.0)
  ...
  %call2_403873 = tail call %struct.Memory* @sub_400800._Z13record_resultdPKc(%struct.State* %0, i64 %294, %struct.Memory* %call2_40386a)
  ...
  ret %struct.Memory* %call2_403873
}
...
define %struct.Memory* @routine_jge_.L_40386a(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i8* %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
...
define %struct.Memory* @routine_jge_.L_403853(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i8* %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 2, i32 9
...
define %struct.Memory* @routine_jmpq_.L_40381a(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
...
define %struct.Memory* @routine_callq_._Z17check_shifted_sumIa33custom_multiple_constant_multiplyIaEEvT_(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
...
define %struct.Memory* @routine_jmpq_.L_4037ff(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
