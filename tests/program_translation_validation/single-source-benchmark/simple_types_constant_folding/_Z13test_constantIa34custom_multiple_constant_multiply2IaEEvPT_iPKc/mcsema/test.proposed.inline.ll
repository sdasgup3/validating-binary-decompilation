...
block_.L_40389f:                                  ; preds = %block_.L_4038f3, %entry
...
block_4038af:                                     ; preds = %block_.L_40389f
  ...
  store i32 0, i32* %236
  store %struct.Memory* %loadMem_4038b3, %struct.Memory** %MEMORY
  br label %block_.L_4038ba

block_.L_4038ba:                                  ; preds = %block_4038c6, %block_4038af
  ...
  store %struct.Memory* %loadMem_4038ba, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_4038bd, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_4038c0, %struct.Memory** %MEMORY
...
block_4038c6:                                     ; preds = %block_.L_4038ba
  ...
  store %struct.Memory* %loadMem_4038ca, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem1_4038d2, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_4038e0, %struct.Memory** %MEMORY
...
block_.L_4038f3:                                  ; preds = %block_.L_4038ba
  ...
  store %struct.Memory* %loadMem_4038f3, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem1_4038f7, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_403905, %struct.Memory** %MEMORY
  br label %block_.L_40389f

block_.L_40390a:                                  ; preds = %block_.L_40389f
  ...
  store %struct.Memory* %loadMem1_40390a, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem1_403913, %struct.Memory** %MEMORY
  ...
  ret %struct.Memory* %loadMem_40391d
}
