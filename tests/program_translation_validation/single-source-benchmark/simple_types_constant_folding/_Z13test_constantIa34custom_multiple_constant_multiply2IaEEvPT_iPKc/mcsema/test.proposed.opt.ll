...
declare %struct.Memory* @sub_417d30._Z17check_shifted_sumIa34custom_multiple_constant_multiply2IaEEvT_(%struct.State* noalias dereferenceable(3376), i64, %struct.Memory* noalias readnone returned) local_unnamed_addr
...
entry:
  ...
  %call2_4038e3 = tail call %struct.Memory* @sub_400e90._Z11start_timerv(%struct.State* %0, i64 %58, %struct.Memory* %2)
...
block_.L_4038ef:                                  ; preds = %block_.L_403943, %entry
  %69 = phi i64 [ %283, %block_.L_403943 ], [ %.pre, %entry ]
  ...
  br i1 %102, label %block_4038ff, label %block_.L_40395a
...
block_.L_40390a:                                  ; preds = %block_403916, %block_4038ff
  %112 = phi i64 [ %240, %block_403916 ], [ %.pre6, %block_4038ff ]
  ...
  br i1 %148, label %block_403916, label %block_.L_403943
...
block_403916:                                     ; preds = %block_.L_40390a
  ...
  %call2_403922 = tail call %struct.Memory* @sub_417d10._ZN34custom_multiple_constant_multiply2IaE8do_shiftEa(%struct.State* nonnull %0, i64 %163, %struct.Memory* %call2_4038e3)
...
block_.L_403943:                                  ; preds = %block_.L_40390a
  ...
  %call2_403947 = tail call %struct.Memory* @sub_417d30._Z17check_shifted_sumIa34custom_multiple_constant_multiply2IaEEvT_(%struct.State* nonnull %0, i64 %247, %struct.Memory* %call2_4038e3)
...
block_.L_40395a:                                  ; preds = %block_.L_4038ef
  ...
  %call2_40395a = tail call %struct.Memory* @sub_400eb0._Z5timerv(%struct.State* nonnull %0, i64 %284, %struct.Memory* %call2_4038e3)
  ...
  %call2_403963 = tail call %struct.Memory* @sub_400850._Z13record_resultdPKc(%struct.State* nonnull %0, i64 %295, %struct.Memory* %call2_40395a)
