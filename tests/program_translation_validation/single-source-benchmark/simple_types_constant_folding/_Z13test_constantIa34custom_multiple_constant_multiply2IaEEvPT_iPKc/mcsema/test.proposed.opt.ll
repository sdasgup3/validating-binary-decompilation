...
block_.L_40389f:                                  ; preds = %block_.L_4038f3, %entry
  %69 = phi i64 [ %.pre, %entry ], [ %282, %block_.L_4038f3 ]
...
block_.L_4038ba:                                  ; preds = %block_4038c6, %block_4038af
  %112 = phi i64 [ %.pre1, %block_4038af ], [ %239, %block_4038c6 ]
...
block_.L_4038f3:                                  ; preds = %block_.L_4038ba
  ...
  %call2_4038f7 = tail call %struct.Memory* @sub_417ce0._Z17check_shifted_sumIa34custom_multiple_constant_multiply2IaEEvT_(%struct.State* %0, i64 %246, %struct.Memory* %MEMORY.1)
...
block_.L_40390a:                                  ; preds = %block_.L_40389f
  ...
  %call2_40390a = tail call %struct.Memory* @sub_400e60._Z5timerv(%struct.State* %0, i64 %283, %struct.Memory* %MEMORY.0)
  ...
  %call2_403913 = tail call %struct.Memory* @sub_400800._Z13record_resultdPKc(%struct.State* %0, i64 %294, %struct.Memory* %call2_40390a)
