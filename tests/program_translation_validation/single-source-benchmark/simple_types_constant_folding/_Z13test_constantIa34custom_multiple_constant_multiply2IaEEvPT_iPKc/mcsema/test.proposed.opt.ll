...
declare %struct.Memory* @sub_417d20._Z17check_shifted_sumIa34custom_multiple_constant_multiply2IaEEvT_(%struct.State* noalias dereferenceable(3376), i64, %struct.Memory* noalias readnone returned) local_unnamed_addr
...
define %struct.Memory* @_Z13test_constantIa34custom_multiple_constant_multiply2IaEEvPT_iPKc(%struct.State* noalias, i64, %struct.Memory* noalias readnone) local_unnamed_addr #1 {
entry:
...
block_.L_4038df:                                  ; preds = %block_.L_403933, %entry
  %69 = phi i64 [ %283, %block_.L_403933 ], [ %.pre, %entry ]
...
block_.L_4038fa:                                  ; preds = %block_403906, %block_4038ef
  %112 = phi i64 [ %240, %block_403906 ], [ %.pre6, %block_4038ef ]
...
block_403906:                                     ; preds = %block_.L_4038fa
  ...
  %call2_403912 = tail call %struct.Memory* @sub_417d00._ZN34custom_multiple_constant_multiply2IaE8do_shiftEa(%struct.State* nonnull %0, i64 %163, %struct.Memory* %call2_4038d3)
...
block_.L_403933:                                  ; preds = %block_.L_4038fa
  ...
  %call2_403937 = tail call %struct.Memory* @sub_417d20._Z17check_shifted_sumIa34custom_multiple_constant_multiply2IaEEvT_(%struct.State* nonnull %0, i64 %247, %struct.Memory* %call2_4038d3)
...
block_.L_40394a:                                  ; preds = %block_.L_4038df
  ...
  %call2_40394a = tail call %struct.Memory* @sub_400ea0._Z5timerv(%struct.State* nonnull %0, i64 %284, %struct.Memory* %call2_4038d3)
