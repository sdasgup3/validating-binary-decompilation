...
declare %struct.Memory* @sub_40ef70._ZN10custom_twoIdE8do_shiftEd(%struct.State* dereferenceable(3376), i64, %struct.Memory*)

declare %struct.Memory* @sub_40ef90._Z17check_shifted_sumId10custom_twoIdEEvT_(%struct.State* dereferenceable(3376), i64, %struct.Memory*)
...
define %struct.Memory* @_Z13test_constantId10custom_twoIdEEvPT_iPKc(%struct.State* noalias, i64, %struct.Memory* noalias) #1 {
entry:
