...
block_.L_40dbbf:                                  ; preds = %block_.L_40dc14, %entry
  %79 = phi i64 [ %.pre, %entry ], [ %260, %block_.L_40dc14 ]
...
block_.L_40dbde:                                  ; preds = %block_40dbea, %block_40dbcf
  %124 = phi i64 [ %.pre1, %block_40dbcf ], [ %219, %block_40dbea ]
...
block_40dbea:                                     ; preds = %block_.L_40dbde
  ...
  %call2_40dbf7 = tail call %struct.Memory* @sub_40ef30._ZN10custom_twoIdE8do_shiftEd(%struct.State* %0, i64 %174, %struct.Memory* %MEMORY.1)
...
block_.L_40dc14:                                  ; preds = %block_.L_40dbde
  ...
  %call2_40dc19 = tail call %struct.Memory* @sub_40ef50._Z17check_shifted_sumId10custom_twoIdEEvT_(%struct.State* %0, i64 %224, %struct.Memory* %MEMORY.1)
...
block_.L_40dc2c:                                  ; preds = %block_.L_40dbbf
  ...
  %call2_40dc2c = tail call %struct.Memory* @sub_400e60._Z5timerv(%struct.State* %0, i64 %261, %struct.Memory* %MEMORY.0)
  ...
  %call2_40dc35 = tail call %struct.Memory* @sub_400800._Z13record_resultdPKc(%struct.State* %0, i64 %272, %struct.Memory* %call2_40dc2c)
