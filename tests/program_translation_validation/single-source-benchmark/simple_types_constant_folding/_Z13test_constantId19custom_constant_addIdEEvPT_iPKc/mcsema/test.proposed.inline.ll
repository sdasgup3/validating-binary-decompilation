...
declare %struct.Memory* @sub_40ecc0._Z17check_shifted_sumId19custom_constant_addIdEEvT_(%struct.State* dereferenceable(3376), i64, %struct.Memory*)
...
define %struct.Memory* @_Z13test_constantId19custom_constant_addIdEEvPT_iPKc(%struct.State* noalias, i64, %struct.Memory* noalias) #1 {
entry:
