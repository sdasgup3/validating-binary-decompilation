...
block_.L_40dedf:                                  ; preds = %block_.L_40df34, %entry
  %79 = phi i64 [ %.pre, %entry ], [ %264, %block_.L_40df34 ]
...
block_.L_40defe:                                  ; preds = %block_40df0a, %block_40deef
  %124 = phi i64 [ %.pre1, %block_40deef ], [ %221, %block_40df0a ]
...
block_40df0a:                                     ; preds = %block_.L_40defe
  ...
  %call2_40df17 = tail call %struct.Memory* @sub_40ec60._ZN19custom_constant_addIdE8do_shiftEd(%struct.State* %0, i64 %175, %struct.Memory* %MEMORY.1)
...
block_.L_40df34:                                  ; preds = %block_.L_40defe
  ...
  %call2_40df39 = tail call %struct.Memory* @sub_40ec80._Z17check_shifted_sumId19custom_constant_addIdEEvT_(%struct.State* %0, i64 %227, %struct.Memory* %MEMORY.1)
...
block_.L_40df4c:                                  ; preds = %block_.L_40dedf
  ...
  %call2_40df4c = tail call %struct.Memory* @sub_400e60._Z5timerv(%struct.State* %0, i64 %265, %struct.Memory* %MEMORY.0)
  ...
  %call2_40df55 = tail call %struct.Memory* @sub_400800._Z13record_resultdPKc(%struct.State* %0, i64 %276, %struct.Memory* %call2_40df4c)
