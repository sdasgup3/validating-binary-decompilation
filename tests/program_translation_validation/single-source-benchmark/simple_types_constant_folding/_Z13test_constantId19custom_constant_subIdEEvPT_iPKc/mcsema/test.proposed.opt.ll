...
declare %struct.Memory* @sub_40eb90._Z17check_shifted_sumId19custom_constant_subIdEEvT_(%struct.State* noalias dereferenceable(3376), i64, %struct.Memory* noalias readnone returned) local_unnamed_addr
...
entry:
  ...
  %call2_40e063 = tail call %struct.Memory* @sub_400e90._Z11start_timerv(%struct.State* %0, i64 %58, %struct.Memory* %2)
...
block_.L_40e06f:                                  ; preds = %block_.L_40e0c4, %entry
  %74 = phi i64 [ %255, %block_.L_40e0c4 ], [ %.pre, %entry ]
  ...
  br i1 %107, label %block_40e07f, label %block_.L_40e0dc
...
block_.L_40e08e:                                  ; preds = %block_40e09a, %block_40e07f
  %118 = phi i64 [ %214, %block_40e09a ], [ %.pre6, %block_40e07f ]
  ...
  br i1 %154, label %block_40e09a, label %block_.L_40e0c4
...
block_40e09a:                                     ; preds = %block_.L_40e08e
  ...
  %call2_40e0a7 = tail call %struct.Memory* @sub_40eb70._ZN19custom_constant_subIdE8do_shiftEd(%struct.State* nonnull %0, i64 %168, %struct.Memory* %call2_40e063)
...
block_.L_40e0c4:                                  ; preds = %block_.L_40e08e
  ...
  %call2_40e0c9 = tail call %struct.Memory* @sub_40eb90._Z17check_shifted_sumId19custom_constant_subIdEEvT_(%struct.State* nonnull %0, i64 %219, %struct.Memory* %call2_40e063)
...
block_.L_40e0dc:                                  ; preds = %block_.L_40e06f
  ...
  %call2_40e0dc = tail call %struct.Memory* @sub_400eb0._Z5timerv(%struct.State* nonnull %0, i64 %256, %struct.Memory* %call2_40e063)
  ...
  %call2_40e0e5 = tail call %struct.Memory* @sub_400850._Z13record_resultdPKc(%struct.State* nonnull %0, i64 %267, %struct.Memory* %call2_40e0dc)
