...
block_.L_40e01f:                                  ; preds = %block_.L_40e074, %entry
  %79 = phi i64 [ %.pre, %entry ], [ %264, %block_.L_40e074 ]
...
block_.L_40e03e:                                  ; preds = %block_40e04a, %block_40e02f
  %124 = phi i64 [ %.pre1, %block_40e02f ], [ %221, %block_40e04a ]
...
block_40e04a:                                     ; preds = %block_.L_40e03e
  ...
  %call2_40e057 = tail call %struct.Memory* @sub_40eb20._ZN19custom_constant_subIdE8do_shiftEd(%struct.State* %0, i64 %175, %struct.Memory* %MEMORY.1)
...
block_.L_40e074:                                  ; preds = %block_.L_40e03e
  ...
  %call2_40e079 = tail call %struct.Memory* @sub_40eb40._Z17check_shifted_sumId19custom_constant_subIdEEvT_(%struct.State* %0, i64 %227, %struct.Memory* %MEMORY.1)
...
block_.L_40e08c:                                  ; preds = %block_.L_40e01f
  ...
  %call2_40e08c = tail call %struct.Memory* @sub_400e60._Z5timerv(%struct.State* %0, i64 %265, %struct.Memory* %MEMORY.0)
  ...
  %call2_40e095 = tail call %struct.Memory* @sub_400800._Z13record_resultdPKc(%struct.State* %0, i64 %276, %struct.Memory* %call2_40e08c)
