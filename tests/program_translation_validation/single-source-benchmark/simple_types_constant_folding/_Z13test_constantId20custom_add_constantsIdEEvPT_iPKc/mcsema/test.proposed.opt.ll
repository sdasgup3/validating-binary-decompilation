...
block_.L_40dc5f:                                  ; preds = %block_.L_40dcb4, %entry
  %79 = phi i64 [ %.pre, %entry ], [ %260, %block_.L_40dcb4 ]
...
block_.L_40dc7e:                                  ; preds = %block_40dc8a, %block_40dc6f
  %124 = phi i64 [ %.pre1, %block_40dc6f ], [ %219, %block_40dc8a ]
...
block_40dc8a:                                     ; preds = %block_.L_40dc7e
  ...
  %call2_40dc97 = tail call %struct.Memory* @sub_40eea0._ZN20custom_add_constantsIdE8do_shiftEd(%struct.State* %0, i64 %174, %struct.Memory* %MEMORY.1)
...
block_.L_40dcb4:                                  ; preds = %block_.L_40dc7e
  ...
  %call2_40dcb9 = tail call %struct.Memory* @sub_40eec0._Z17check_shifted_sumId20custom_add_constantsIdEEvT_(%struct.State* %0, i64 %224, %struct.Memory* %MEMORY.1)
...
block_.L_40dccc:                                  ; preds = %block_.L_40dc5f
  ...
  %call2_40dccc = tail call %struct.Memory* @sub_400e60._Z5timerv(%struct.State* %0, i64 %261, %struct.Memory* %MEMORY.0)
  ...
  %call2_40dcd5 = tail call %struct.Memory* @sub_400800._Z13record_resultdPKc(%struct.State* %0, i64 %272, %struct.Memory* %call2_40dccc)
