...
declare %struct.Memory* @sub_40eee0._ZN20custom_add_constantsIdE8do_shiftEd(%struct.State* dereferenceable(3376), i64, %struct.Memory*) local_unnamed_addr

declare %struct.Memory* @sub_40ef00._Z17check_shifted_sumId20custom_add_constantsIdEEvT_(%struct.State* dereferenceable(3376), i64, %struct.Memory*) local_unnamed_addr
...
block_.L_40dc9f:                                  ; preds = %block_.L_40dcf4, %entry
  %74 = phi i64 [ %.pre, %entry ], [ %255, %block_.L_40dcf4 ]
  %MEMORY.0 = phi %struct.Memory* [ %call2_40dc93, %entry ], [ %call2_40dcf9, %block_.L_40dcf4 ]
...
block_.L_40dcbe:                                  ; preds = %block_40dcca, %block_40dcaf
  %118 = phi i64 [ %.pre6, %block_40dcaf ], [ %214, %block_40dcca ]
  %MEMORY.1 = phi %struct.Memory* [ %MEMORY.0, %block_40dcaf ], [ %call2_40dcd7, %block_40dcca ]
...
block_40dcca:                                     ; preds = %block_.L_40dcbe
  ...
  %call2_40dcd7 = tail call %struct.Memory* @sub_40eee0._ZN20custom_add_constantsIdE8do_shiftEd(%struct.State* nonnull %0, i64 %168, %struct.Memory* %MEMORY.1)
...
block_.L_40dcf4:                                  ; preds = %block_.L_40dcbe
  ...
  %call2_40dcf9 = tail call %struct.Memory* @sub_40ef00._Z17check_shifted_sumId20custom_add_constantsIdEEvT_(%struct.State* nonnull %0, i64 %219, %struct.Memory* %MEMORY.1)
...
block_.L_40dd0c:                                  ; preds = %block_.L_40dc9f
  ...
  %call2_40dd0c = tail call %struct.Memory* @sub_400ea0._Z5timerv(%struct.State* nonnull %0, i64 %256, %struct.Memory* %MEMORY.0)
