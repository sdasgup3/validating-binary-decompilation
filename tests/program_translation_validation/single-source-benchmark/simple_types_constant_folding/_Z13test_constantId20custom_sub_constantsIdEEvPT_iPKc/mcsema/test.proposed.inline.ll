...
declare %struct.Memory* @sub_40ee50._ZN20custom_sub_constantsIdE8do_shiftEd(%struct.State* dereferenceable(3376), i64, %struct.Memory*)

declare %struct.Memory* @sub_40ee70._Z17check_shifted_sumId20custom_sub_constantsIdEEvT_(%struct.State* dereferenceable(3376), i64, %struct.Memory*)
...
define %struct.Memory* @_Z13test_constantId20custom_sub_constantsIdEEvPT_iPKc(%struct.State* noalias, i64, %struct.Memory* noalias) #1 {
entry:
