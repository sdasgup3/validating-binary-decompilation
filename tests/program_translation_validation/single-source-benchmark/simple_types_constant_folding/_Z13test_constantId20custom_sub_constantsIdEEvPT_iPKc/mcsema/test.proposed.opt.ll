...
declare %struct.Memory* @sub_40ee50._ZN20custom_sub_constantsIdE8do_shiftEd(%struct.State* noalias dereferenceable(3376), i64, %struct.Memory* noalias readnone returned) local_unnamed_addr

declare %struct.Memory* @sub_40ee70._Z17check_shifted_sumId20custom_sub_constantsIdEEvT_(%struct.State* noalias dereferenceable(3376), i64, %struct.Memory* noalias readnone returned) local_unnamed_addr
...
block_.L_40dd3f:                                  ; preds = %block_.L_40dd94, %entry
  %74 = phi i64 [ %255, %block_.L_40dd94 ], [ %.pre, %entry ]
...
block_.L_40dd5e:                                  ; preds = %block_40dd6a, %block_40dd4f
  %118 = phi i64 [ %214, %block_40dd6a ], [ %.pre6, %block_40dd4f ]
...
block_40dd6a:                                     ; preds = %block_.L_40dd5e
  ...
  %call2_40dd77 = tail call %struct.Memory* @sub_40ee50._ZN20custom_sub_constantsIdE8do_shiftEd(%struct.State* nonnull %0, i64 %168, %struct.Memory* %call2_40dd33)
...
block_.L_40dd94:                                  ; preds = %block_.L_40dd5e
  ...
  %call2_40dd99 = tail call %struct.Memory* @sub_40ee70._Z17check_shifted_sumId20custom_sub_constantsIdEEvT_(%struct.State* nonnull %0, i64 %219, %struct.Memory* %call2_40dd33)
...
block_.L_40ddac:                                  ; preds = %block_.L_40dd3f
  ...
  %call2_40ddac = tail call %struct.Memory* @sub_400ea0._Z5timerv(%struct.State* nonnull %0, i64 %256, %struct.Memory* %call2_40dd33)
