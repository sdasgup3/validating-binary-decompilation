...
block_.L_40dcff:                                  ; preds = %block_.L_40dd54, %entry
  %79 = phi i64 [ %.pre, %entry ], [ %264, %block_.L_40dd54 ]
...
block_.L_40dd1e:                                  ; preds = %block_40dd2a, %block_40dd0f
  %124 = phi i64 [ %.pre1, %block_40dd0f ], [ %221, %block_40dd2a ]
...
block_40dd2a:                                     ; preds = %block_.L_40dd1e
  ...
  %call2_40dd37 = tail call %struct.Memory* @sub_40ee10._ZN20custom_sub_constantsIdE8do_shiftEd(%struct.State* %0, i64 %175, %struct.Memory* %MEMORY.1)
...
block_.L_40dd54:                                  ; preds = %block_.L_40dd1e
  ...
  %call2_40dd59 = tail call %struct.Memory* @sub_40ee30._Z17check_shifted_sumId20custom_sub_constantsIdEEvT_(%struct.State* %0, i64 %227, %struct.Memory* %MEMORY.1)
...
block_.L_40dd6c:                                  ; preds = %block_.L_40dcff
  ...
  %call2_40dd6c = tail call %struct.Memory* @sub_400e60._Z5timerv(%struct.State* %0, i64 %265, %struct.Memory* %MEMORY.0)
  ...
  %call2_40dd75 = tail call %struct.Memory* @sub_400800._Z13record_resultdPKc(%struct.State* %0, i64 %276, %struct.Memory* %call2_40dd6c)
