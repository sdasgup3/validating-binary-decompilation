...
declare %struct.Memory* @sub_40e880._Z17check_shifted_sumId22custom_constant_divideIdEEvT_(%struct.State* noalias dereferenceable(3376), i64, %struct.Memory* noalias readnone returned) local_unnamed_addr
...
entry:
  ...
  %call2_40e383 = tail call %struct.Memory* @sub_400e90._Z11start_timerv(%struct.State* %0, i64 %58, %struct.Memory* %2)
  ...
  br label %block_.L_40e38f

block_.L_40e38f:                                  ; preds = %block_.L_40e3e4, %entry
  %74 = phi i64 [ %255, %block_.L_40e3e4 ], [ %.pre, %entry ]
  ...
  br i1 %107, label %block_40e39f, label %block_.L_40e3fc

block_40e39f:                                     ; preds = %block_.L_40e38f
...
block_.L_40e3ae:                                  ; preds = %block_40e3ba, %block_40e39f
  %118 = phi i64 [ %214, %block_40e3ba ], [ %.pre6, %block_40e39f ]
  ...
  br i1 %154, label %block_40e3ba, label %block_.L_40e3e4

block_40e3ba:                                     ; preds = %block_.L_40e3ae
  %156 = add i64 %119, -8
  %157 = add i64 %155, 4
  ...
  %call2_40e3c7 = tail call %struct.Memory* @sub_40e860._ZN22custom_constant_divideIdE8do_shiftEd(%struct.State* nonnull %0, i64 %168, %struct.Memory* %call2_40e383)
...
block_.L_40e3e4:                                  ; preds = %block_.L_40e3ae
  %215 = add i64 %119, -40
  %216 = add i64 %155, 5
  ...
  %call2_40e3e9 = tail call %struct.Memory* @sub_40e880._Z17check_shifted_sumId22custom_constant_divideIdEEvT_(%struct.State* nonnull %0, i64 %219, %struct.Memory* %call2_40e383)
...
block_.L_40e3fc:                                  ; preds = %block_.L_40e38f
  ...
  %call2_40e3fc = tail call %struct.Memory* @sub_400eb0._Z5timerv(%struct.State* nonnull %0, i64 %256, %struct.Memory* %call2_40e383)
  ...
  %call2_40e405 = tail call %struct.Memory* @sub_400850._Z13record_resultdPKc(%struct.State* nonnull %0, i64 %267, %struct.Memory* %call2_40e3fc)
