...
define %struct.Memory* @_Z13test_constantId23custom_divide_constantsIdEEvPT_iPKc(%struct.State* noalias, i64, %struct.Memory* noalias) #1 {
entry:
  ...
  store %struct.Memory* %loadMem1_40de73, %struct.Memory** %MEMORY
...
block_.L_40de7f:                                  ; preds = %block_.L_40ded4, %entry
  ...
  store %struct.Memory* %loadMem_40de82, %struct.Memory** %MEMORY
...
block_40de8f:                                     ; preds = %block_.L_40de7f
  ...
  store i32 0, i32* %278
  store %struct.Memory* %loadMem_40de97, %struct.Memory** %MEMORY
  br label %block_.L_40de9e

block_.L_40de9e:                                  ; preds = %block_40deaa, %block_40de8f
...
block_40deaa:                                     ; preds = %block_.L_40de9e
  ...
  store %struct.Memory* %loadMem1_40deb7, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_40dec9, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_40decf, %struct.Memory** %MEMORY
  br label %block_.L_40de9e

block_.L_40ded4:                                  ; preds = %block_.L_40de9e
  ...
  store %struct.Memory* %loadMem1_40ded9, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_40dee1, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_40dee4, %struct.Memory** %MEMORY
...
block_.L_40deec:                                  ; preds = %block_.L_40de7f
  ...
  store %struct.Memory* %loadMem1_40deec, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_40def1, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_40deff, %struct.Memory** %MEMORY
  ret %struct.Memory* %loadMem_40deff
}
