...
block_.L_40de3f:                                  ; preds = %block_.L_40de94, %entry
  %79 = phi i64 [ %.pre, %entry ], [ %264, %block_.L_40de94 ]
...
block_.L_40de5e:                                  ; preds = %block_40de6a, %block_40de4f
  %124 = phi i64 [ %.pre1, %block_40de4f ], [ %221, %block_40de6a ]
...
block_40de6a:                                     ; preds = %block_.L_40de5e
  ...
  %call2_40de77 = tail call %struct.Memory* @sub_40ecf0._ZN23custom_divide_constantsIdE8do_shiftEd(%struct.State* %0, i64 %175, %struct.Memory* %MEMORY.1)
...
block_.L_40de94:                                  ; preds = %block_.L_40de5e
  ...
  %call2_40de99 = tail call %struct.Memory* @sub_40ed10._Z17check_shifted_sumId23custom_divide_constantsIdEEvT_(%struct.State* %0, i64 %227, %struct.Memory* %MEMORY.1)
...
block_.L_40deac:                                  ; preds = %block_.L_40de3f
  ...
  %call2_40deac = tail call %struct.Memory* @sub_400e60._Z5timerv(%struct.State* %0, i64 %265, %struct.Memory* %MEMORY.0)
  ...
  %call2_40deb5 = tail call %struct.Memory* @sub_400800._Z13record_resultdPKc(%struct.State* %0, i64 %276, %struct.Memory* %call2_40deac)
