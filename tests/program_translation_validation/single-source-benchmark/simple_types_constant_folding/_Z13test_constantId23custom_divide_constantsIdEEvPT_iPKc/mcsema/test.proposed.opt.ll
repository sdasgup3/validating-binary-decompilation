...
declare %struct.Memory* @sub_40ed30._ZN23custom_divide_constantsIdE8do_shiftEd(%struct.State* noalias dereferenceable(3376), i64, %struct.Memory* noalias readnone returned) local_unnamed_addr

declare %struct.Memory* @sub_40ed50._Z17check_shifted_sumId23custom_divide_constantsIdEEvT_(%struct.State* noalias dereferenceable(3376), i64, %struct.Memory* noalias readnone returned) local_unnamed_addr
...
define %struct.Memory* @_Z13test_constantId23custom_divide_constantsIdEEvPT_iPKc(%struct.State* noalias, i64, %struct.Memory* noalias readnone) local_unnamed_addr #1 {
entry:
...
block_.L_40de7f:                                  ; preds = %block_.L_40ded4, %entry
  %74 = phi i64 [ %255, %block_.L_40ded4 ], [ %.pre, %entry ]
...
block_.L_40de9e:                                  ; preds = %block_40deaa, %block_40de8f
  %118 = phi i64 [ %214, %block_40deaa ], [ %.pre6, %block_40de8f ]
...
block_40deaa:                                     ; preds = %block_.L_40de9e
  ...
  %call2_40deb7 = tail call %struct.Memory* @sub_40ed30._ZN23custom_divide_constantsIdE8do_shiftEd(%struct.State* nonnull %0, i64 %168, %struct.Memory* %call2_40de73)
...
block_.L_40ded4:                                  ; preds = %block_.L_40de9e
  ...
  %call2_40ded9 = tail call %struct.Memory* @sub_40ed50._Z17check_shifted_sumId23custom_divide_constantsIdEEvT_(%struct.State* nonnull %0, i64 %219, %struct.Memory* %call2_40de73)
...
block_.L_40deec:                                  ; preds = %block_.L_40de7f
  ...
  %call2_40deec = tail call %struct.Memory* @sub_400ea0._Z5timerv(%struct.State* nonnull %0, i64 %256, %struct.Memory* %call2_40de73)
