...
declare %struct.Memory* @sub_40ea20._ZN24custom_constant_multiplyIdE8do_shiftEd(%struct.State* dereferenceable(3376), i64, %struct.Memory*) local_unnamed_addr

declare %struct.Memory* @sub_40ea40._Z17check_shifted_sumId24custom_constant_multiplyIdEEvT_(%struct.State* dereferenceable(3376), i64, %struct.Memory*) local_unnamed_addr
...
block_.L_40e19f:                                  ; preds = %block_.L_40e1f4, %entry
  %74 = phi i64 [ %.pre, %entry ], [ %255, %block_.L_40e1f4 ]
  %MEMORY.0 = phi %struct.Memory* [ %call2_40e193, %entry ], [ %call2_40e1f9, %block_.L_40e1f4 ]
...
block_.L_40e1be:                                  ; preds = %block_40e1ca, %block_40e1af
  %118 = phi i64 [ %.pre6, %block_40e1af ], [ %214, %block_40e1ca ]
  %MEMORY.1 = phi %struct.Memory* [ %MEMORY.0, %block_40e1af ], [ %call2_40e1d7, %block_40e1ca ]
...
block_40e1ca:                                     ; preds = %block_.L_40e1be
  ...
  %call2_40e1d7 = tail call %struct.Memory* @sub_40ea20._ZN24custom_constant_multiplyIdE8do_shiftEd(%struct.State* nonnull %0, i64 %168, %struct.Memory* %MEMORY.1)
...
block_.L_40e1f4:                                  ; preds = %block_.L_40e1be
  ...
  %call2_40e1f9 = tail call %struct.Memory* @sub_40ea40._Z17check_shifted_sumId24custom_constant_multiplyIdEEvT_(%struct.State* nonnull %0, i64 %219, %struct.Memory* %MEMORY.1)
...
block_.L_40e20c:                                  ; preds = %block_.L_40e19f
  ...
  %call2_40e20c = tail call %struct.Memory* @sub_400ea0._Z5timerv(%struct.State* nonnull %0, i64 %256, %struct.Memory* %MEMORY.0)
