...
block_.L_40e15f:                                  ; preds = %block_.L_40e1b4, %entry
  %79 = phi i64 [ %.pre, %entry ], [ %260, %block_.L_40e1b4 ]
...
block_.L_40e17e:                                  ; preds = %block_40e18a, %block_40e16f
  %124 = phi i64 [ %.pre1, %block_40e16f ], [ %219, %block_40e18a ]
...
block_40e18a:                                     ; preds = %block_.L_40e17e
  ...
  %call2_40e197 = tail call %struct.Memory* @sub_40e9e0._ZN24custom_constant_multiplyIdE8do_shiftEd(%struct.State* %0, i64 %174, %struct.Memory* %MEMORY.1)
...
block_.L_40e1b4:                                  ; preds = %block_.L_40e17e
  ...
  %call2_40e1b9 = tail call %struct.Memory* @sub_40ea00._Z17check_shifted_sumId24custom_constant_multiplyIdEEvT_(%struct.State* %0, i64 %224, %struct.Memory* %MEMORY.1)
...
block_.L_40e1cc:                                  ; preds = %block_.L_40e15f
  ...
  %call2_40e1cc = tail call %struct.Memory* @sub_400e60._Z5timerv(%struct.State* %0, i64 %261, %struct.Memory* %MEMORY.0)
  ...
  %call2_40e1d5 = tail call %struct.Memory* @sub_400800._Z13record_resultdPKc(%struct.State* %0, i64 %272, %struct.Memory* %call2_40e1cc)
