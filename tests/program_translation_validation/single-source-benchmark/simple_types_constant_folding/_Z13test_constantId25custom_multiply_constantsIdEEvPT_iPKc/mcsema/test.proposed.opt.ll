...
declare %struct.Memory* @sub_40edc0._ZN25custom_multiply_constantsIdE8do_shiftEd(%struct.State* dereferenceable(3376), i64, %struct.Memory*) local_unnamed_addr

declare %struct.Memory* @sub_40ede0._Z17check_shifted_sumId25custom_multiply_constantsIdEEvT_(%struct.State* dereferenceable(3376), i64, %struct.Memory*) local_unnamed_addr
...
define %struct.Memory* @_Z13test_constantId25custom_multiply_constantsIdEEvPT_iPKc(%struct.State* noalias, i64, %struct.Memory* noalias) local_unnamed_addr #1 {
entry:
...
block_.L_40dddf:                                  ; preds = %block_.L_40de34, %entry
  %74 = phi i64 [ %.pre, %entry ], [ %255, %block_.L_40de34 ]
  %MEMORY.0 = phi %struct.Memory* [ %call2_40ddd3, %entry ], [ %call2_40de39, %block_.L_40de34 ]
...
block_.L_40ddfe:                                  ; preds = %block_40de0a, %block_40ddef
  %118 = phi i64 [ %.pre6, %block_40ddef ], [ %214, %block_40de0a ]
  %MEMORY.1 = phi %struct.Memory* [ %MEMORY.0, %block_40ddef ], [ %call2_40de17, %block_40de0a ]
...
block_40de0a:                                     ; preds = %block_.L_40ddfe
  ...
  %call2_40de17 = tail call %struct.Memory* @sub_40edc0._ZN25custom_multiply_constantsIdE8do_shiftEd(%struct.State* nonnull %0, i64 %168, %struct.Memory* %MEMORY.1)
...
block_.L_40de34:                                  ; preds = %block_.L_40ddfe
  ...
  %call2_40de39 = tail call %struct.Memory* @sub_40ede0._Z17check_shifted_sumId25custom_multiply_constantsIdEEvT_(%struct.State* nonnull %0, i64 %219, %struct.Memory* %MEMORY.1)
...
block_.L_40de4c:                                  ; preds = %block_.L_40dddf
  ...
  %call2_40de4c = tail call %struct.Memory* @sub_400ea0._Z5timerv(%struct.State* nonnull %0, i64 %256, %struct.Memory* %MEMORY.0)
