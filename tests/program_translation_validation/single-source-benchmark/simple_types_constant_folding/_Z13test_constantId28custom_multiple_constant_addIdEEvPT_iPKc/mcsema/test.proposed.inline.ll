...
declare %struct.Memory* @sub_40ebf0._ZN28custom_multiple_constant_addIdE8do_shiftEd(%struct.State* dereferenceable(3376), i64, %struct.Memory*)

declare %struct.Memory* @sub_40ec30._Z17check_shifted_sumId28custom_multiple_constant_addIdEEvT_(%struct.State* dereferenceable(3376), i64, %struct.Memory*)
...
define %struct.Memory* @_Z13test_constantId28custom_multiple_constant_addIdEEvPT_iPKc(%struct.State* noalias, i64, %struct.Memory* noalias) #1 {
entry:
