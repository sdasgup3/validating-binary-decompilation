...
block_.L_40df7f:                                  ; preds = %block_.L_40dfd4, %entry
  %79 = phi i64 [ %.pre, %entry ], [ %264, %block_.L_40dfd4 ]
...
block_.L_40df9e:                                  ; preds = %block_40dfaa, %block_40df8f
  %124 = phi i64 [ %.pre1, %block_40df8f ], [ %221, %block_40dfaa ]
...
block_40dfaa:                                     ; preds = %block_.L_40df9e
  ...
  %call2_40dfb7 = tail call %struct.Memory* @sub_40ebb0._ZN28custom_multiple_constant_addIdE8do_shiftEd(%struct.State* %0, i64 %175, %struct.Memory* %MEMORY.1)
...
block_.L_40dfd4:                                  ; preds = %block_.L_40df9e
  ...
  %call2_40dfd9 = tail call %struct.Memory* @sub_40ebf0._Z17check_shifted_sumId28custom_multiple_constant_addIdEEvT_(%struct.State* %0, i64 %227, %struct.Memory* %MEMORY.1)
...
block_.L_40dfec:                                  ; preds = %block_.L_40df7f
  ...
  %call2_40dfec = tail call %struct.Memory* @sub_400e60._Z5timerv(%struct.State* %0, i64 %265, %struct.Memory* %MEMORY.0)
  ...
  %call2_40dff5 = tail call %struct.Memory* @sub_400800._Z13record_resultdPKc(%struct.State* %0, i64 %276, %struct.Memory* %call2_40dfec)
