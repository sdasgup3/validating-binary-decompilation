...
declare %struct.Memory* @sub_40ebf0._ZN28custom_multiple_constant_addIdE8do_shiftEd(%struct.State* noalias dereferenceable(3376), i64, %struct.Memory* noalias readnone returned) local_unnamed_addr

declare %struct.Memory* @sub_40ec30._Z17check_shifted_sumId28custom_multiple_constant_addIdEEvT_(%struct.State* noalias dereferenceable(3376), i64, %struct.Memory* noalias readnone returned) local_unnamed_addr
...
define %struct.Memory* @_Z13test_constantId28custom_multiple_constant_addIdEEvPT_iPKc(%struct.State* noalias, i64, %struct.Memory* noalias readnone) local_unnamed_addr #1 {
entry:
...
block_.L_40dfbf:                                  ; preds = %block_.L_40e014, %entry
  %74 = phi i64 [ %255, %block_.L_40e014 ], [ %.pre, %entry ]
...
block_.L_40dfde:                                  ; preds = %block_40dfea, %block_40dfcf
  %118 = phi i64 [ %214, %block_40dfea ], [ %.pre6, %block_40dfcf ]
...
block_40dfea:                                     ; preds = %block_.L_40dfde
  ...
  %call2_40dff7 = tail call %struct.Memory* @sub_40ebf0._ZN28custom_multiple_constant_addIdE8do_shiftEd(%struct.State* nonnull %0, i64 %168, %struct.Memory* %call2_40dfb3)
...
block_.L_40e014:                                  ; preds = %block_.L_40dfde
  ...
  %call2_40e019 = tail call %struct.Memory* @sub_40ec30._Z17check_shifted_sumId28custom_multiple_constant_addIdEEvT_(%struct.State* nonnull %0, i64 %219, %struct.Memory* %call2_40dfb3)
...
block_.L_40e02c:                                  ; preds = %block_.L_40dfbf
  ...
  %call2_40e02c = tail call %struct.Memory* @sub_400ea0._Z5timerv(%struct.State* nonnull %0, i64 %256, %struct.Memory* %call2_40dfb3)
