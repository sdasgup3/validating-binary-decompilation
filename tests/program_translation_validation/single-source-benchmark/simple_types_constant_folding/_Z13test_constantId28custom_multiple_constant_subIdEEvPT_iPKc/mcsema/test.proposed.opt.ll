...
declare %struct.Memory* @sub_40eab0._ZN28custom_multiple_constant_subIdE8do_shiftEd(%struct.State* dereferenceable(3376), i64, %struct.Memory*) local_unnamed_addr

declare %struct.Memory* @sub_40eaf0._Z17check_shifted_sumId28custom_multiple_constant_subIdEEvT_(%struct.State* dereferenceable(3376), i64, %struct.Memory*) local_unnamed_addr
...
block_.L_40e0ff:                                  ; preds = %block_.L_40e154, %entry
  %74 = phi i64 [ %.pre, %entry ], [ %255, %block_.L_40e154 ]
  %MEMORY.0 = phi %struct.Memory* [ %call2_40e0f3, %entry ], [ %call2_40e159, %block_.L_40e154 ]
...
block_.L_40e11e:                                  ; preds = %block_40e12a, %block_40e10f
  %118 = phi i64 [ %.pre6, %block_40e10f ], [ %214, %block_40e12a ]
  %MEMORY.1 = phi %struct.Memory* [ %MEMORY.0, %block_40e10f ], [ %call2_40e137, %block_40e12a ]
...
block_40e12a:                                     ; preds = %block_.L_40e11e
  ...
  %call2_40e137 = tail call %struct.Memory* @sub_40eab0._ZN28custom_multiple_constant_subIdE8do_shiftEd(%struct.State* nonnull %0, i64 %168, %struct.Memory* %MEMORY.1)
...
block_.L_40e154:                                  ; preds = %block_.L_40e11e
  ...
  %call2_40e159 = tail call %struct.Memory* @sub_40eaf0._Z17check_shifted_sumId28custom_multiple_constant_subIdEEvT_(%struct.State* nonnull %0, i64 %219, %struct.Memory* %MEMORY.1)
...
block_.L_40e16c:                                  ; preds = %block_.L_40e0ff
  ...
  %call2_40e16c = tail call %struct.Memory* @sub_400ea0._Z5timerv(%struct.State* nonnull %0, i64 %256, %struct.Memory* %MEMORY.0)
