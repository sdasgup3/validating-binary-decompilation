...
block_.L_40e3df:                                  ; preds = %block_.L_40e434, %entry
  %79 = phi i64 [ %.pre, %entry ], [ %264, %block_.L_40e434 ]
...
block_.L_40e3fe:                                  ; preds = %block_40e40a, %block_40e3ef
  %124 = phi i64 [ %.pre1, %block_40e3ef ], [ %221, %block_40e40a ]
...
block_40e40a:                                     ; preds = %block_.L_40e3fe
  ...
  %call2_40e417 = tail call %struct.Memory* @sub_40e760._ZN31custom_multiple_constant_divideIdE8do_shiftEd(%struct.State* %0, i64 %175, %struct.Memory* %MEMORY.1)
...
block_.L_40e434:                                  ; preds = %block_.L_40e3fe
  ...
  %call2_40e439 = tail call %struct.Memory* @sub_40e7a0._Z17check_shifted_sumId31custom_multiple_constant_divideIdEEvT_(%struct.State* %0, i64 %227, %struct.Memory* %MEMORY.1)
...
block_.L_40e44c:                                  ; preds = %block_.L_40e3df
  ...
  %call2_40e44c = tail call %struct.Memory* @sub_400e60._Z5timerv(%struct.State* %0, i64 %265, %struct.Memory* %MEMORY.0)
  ...
  %call2_40e455 = tail call %struct.Memory* @sub_400800._Z13record_resultdPKc(%struct.State* %0, i64 %276, %struct.Memory* %call2_40e44c)
