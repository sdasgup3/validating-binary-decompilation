...
declare %struct.Memory* @sub_40e7a0._ZN31custom_multiple_constant_divideIdE8do_shiftEd(%struct.State* noalias dereferenceable(3376), i64, %struct.Memory* noalias readnone returned) local_unnamed_addr

declare %struct.Memory* @sub_40e7e0._Z17check_shifted_sumId31custom_multiple_constant_divideIdEEvT_(%struct.State* noalias dereferenceable(3376), i64, %struct.Memory* noalias readnone returned) local_unnamed_addr
...
define %struct.Memory* @_Z13test_constantId31custom_multiple_constant_divideIdEEvPT_iPKc(%struct.State* noalias, i64, %struct.Memory* noalias readnone) local_unnamed_addr #1 {
entry:
...
block_.L_40e41f:                                  ; preds = %block_.L_40e474, %entry
  %74 = phi i64 [ %255, %block_.L_40e474 ], [ %.pre, %entry ]
...
block_.L_40e43e:                                  ; preds = %block_40e44a, %block_40e42f
  %118 = phi i64 [ %214, %block_40e44a ], [ %.pre6, %block_40e42f ]
...
block_40e44a:                                     ; preds = %block_.L_40e43e
  ...
  %call2_40e457 = tail call %struct.Memory* @sub_40e7a0._ZN31custom_multiple_constant_divideIdE8do_shiftEd(%struct.State* nonnull %0, i64 %168, %struct.Memory* %call2_40e413)
...
block_.L_40e474:                                  ; preds = %block_.L_40e43e
  ...
  %call2_40e479 = tail call %struct.Memory* @sub_40e7e0._Z17check_shifted_sumId31custom_multiple_constant_divideIdEEvT_(%struct.State* nonnull %0, i64 %219, %struct.Memory* %call2_40e413)
...
block_.L_40e48c:                                  ; preds = %block_.L_40e41f
  ...
  %call2_40e48c = tail call %struct.Memory* @sub_400ea0._Z5timerv(%struct.State* nonnull %0, i64 %256, %struct.Memory* %call2_40e413)
