...
block_.L_40e47f:                                  ; preds = %block_.L_40e4d4, %entry
  %79 = phi i64 [ %.pre, %entry ], [ %260, %block_.L_40e4d4 ]
...
block_.L_40e49e:                                  ; preds = %block_40e4aa, %block_40e48f
  %124 = phi i64 [ %.pre1, %block_40e48f ], [ %219, %block_40e4aa ]
...
block_40e4aa:                                     ; preds = %block_.L_40e49e
  ...
  %call2_40e4b7 = tail call %struct.Memory* @sub_40e6d0._ZN32custom_multiple_constant_divide2IdE8do_shiftEd(%struct.State* %0, i64 %174, %struct.Memory* %MEMORY.1)
...
block_.L_40e4d4:                                  ; preds = %block_.L_40e49e
  ...
  %call2_40e4d9 = tail call %struct.Memory* @sub_40e6f0._Z17check_shifted_sumId32custom_multiple_constant_divide2IdEEvT_(%struct.State* %0, i64 %224, %struct.Memory* %MEMORY.1)
...
block_.L_40e4ec:                                  ; preds = %block_.L_40e47f
  ...
  %call2_40e4ec = tail call %struct.Memory* @sub_400e60._Z5timerv(%struct.State* %0, i64 %261, %struct.Memory* %MEMORY.0)
  ...
  %call2_40e4f5 = tail call %struct.Memory* @sub_400800._Z13record_resultdPKc(%struct.State* %0, i64 %272, %struct.Memory* %call2_40e4ec)
