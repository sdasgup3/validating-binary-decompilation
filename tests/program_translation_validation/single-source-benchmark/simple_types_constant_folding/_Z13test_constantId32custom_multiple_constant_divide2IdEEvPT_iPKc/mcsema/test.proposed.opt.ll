...
declare %struct.Memory* @sub_40e740._Z17check_shifted_sumId32custom_multiple_constant_divide2IdEEvT_(%struct.State* noalias dereferenceable(3376), i64, %struct.Memory* noalias readnone returned) local_unnamed_addr
...
entry:
  ...
  %call2_40e4c3 = tail call %struct.Memory* @sub_400e90._Z11start_timerv(%struct.State* %0, i64 %58, %struct.Memory* %2)
...
block_.L_40e4cf:                                  ; preds = %block_.L_40e524, %entry
  %74 = phi i64 [ %255, %block_.L_40e524 ], [ %.pre, %entry ]
  ...
  br i1 %107, label %block_40e4df, label %block_.L_40e53c
...
block_.L_40e4ee:                                  ; preds = %block_40e4fa, %block_40e4df
  %118 = phi i64 [ %214, %block_40e4fa ], [ %.pre6, %block_40e4df ]
  ...
  br i1 %154, label %block_40e4fa, label %block_.L_40e524
...
block_40e4fa:                                     ; preds = %block_.L_40e4ee
  ...
  %call2_40e507 = tail call %struct.Memory* @sub_40e720._ZN32custom_multiple_constant_divide2IdE8do_shiftEd(%struct.State* nonnull %0, i64 %168, %struct.Memory* %call2_40e4c3)
...
block_.L_40e524:                                  ; preds = %block_.L_40e4ee
  ...
  %call2_40e529 = tail call %struct.Memory* @sub_40e740._Z17check_shifted_sumId32custom_multiple_constant_divide2IdEEvT_(%struct.State* nonnull %0, i64 %219, %struct.Memory* %call2_40e4c3)
...
block_.L_40e53c:                                  ; preds = %block_.L_40e4cf
  ...
  %call2_40e53c = tail call %struct.Memory* @sub_400eb0._Z5timerv(%struct.State* nonnull %0, i64 %256, %struct.Memory* %call2_40e4c3)
  ...
  %call2_40e545 = tail call %struct.Memory* @sub_400850._Z13record_resultdPKc(%struct.State* nonnull %0, i64 %267, %struct.Memory* %call2_40e53c)
