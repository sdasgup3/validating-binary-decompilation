...
declare %struct.Memory* @sub_40e730._Z17check_shifted_sumId32custom_multiple_constant_divide2IdEEvT_(%struct.State* noalias dereferenceable(3376), i64, %struct.Memory* noalias readnone returned) local_unnamed_addr
...
define %struct.Memory* @_Z13test_constantId32custom_multiple_constant_divide2IdEEvPT_iPKc(%struct.State* noalias, i64, %struct.Memory* noalias readnone) local_unnamed_addr #1 {
entry:
...
block_.L_40e4bf:                                  ; preds = %block_.L_40e514, %entry
  %74 = phi i64 [ %255, %block_.L_40e514 ], [ %.pre, %entry ]
...
block_.L_40e4de:                                  ; preds = %block_40e4ea, %block_40e4cf
  %118 = phi i64 [ %214, %block_40e4ea ], [ %.pre6, %block_40e4cf ]
...
block_40e4ea:                                     ; preds = %block_.L_40e4de
  ...
  %call2_40e4f7 = tail call %struct.Memory* @sub_40e710._ZN32custom_multiple_constant_divide2IdE8do_shiftEd(%struct.State* nonnull %0, i64 %168, %struct.Memory* %call2_40e4b3)
...
block_.L_40e514:                                  ; preds = %block_.L_40e4de
  ...
  %call2_40e519 = tail call %struct.Memory* @sub_40e730._Z17check_shifted_sumId32custom_multiple_constant_divide2IdEEvT_(%struct.State* nonnull %0, i64 %219, %struct.Memory* %call2_40e4b3)
...
block_.L_40e52c:                                  ; preds = %block_.L_40e4bf
  ...
  %call2_40e52c = tail call %struct.Memory* @sub_400ea0._Z5timerv(%struct.State* nonnull %0, i64 %256, %struct.Memory* %call2_40e4b3)
