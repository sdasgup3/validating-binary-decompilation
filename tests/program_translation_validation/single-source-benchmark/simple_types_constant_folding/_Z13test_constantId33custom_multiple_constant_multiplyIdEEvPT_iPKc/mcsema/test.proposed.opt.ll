...
block_.L_40e1ff:                                  ; preds = %block_.L_40e254, %entry
  %79 = phi i64 [ %.pre, %entry ], [ %260, %block_.L_40e254 ]
...
block_.L_40e21e:                                  ; preds = %block_40e22a, %block_40e20f
  %124 = phi i64 [ %.pre1, %block_40e20f ], [ %219, %block_40e22a ]
...
block_40e22a:                                     ; preds = %block_.L_40e21e
  ...
  %call2_40e237 = tail call %struct.Memory* @sub_40e930._ZN33custom_multiple_constant_multiplyIdE8do_shiftEd(%struct.State* %0, i64 %174, %struct.Memory* %MEMORY.1)
...
block_.L_40e254:                                  ; preds = %block_.L_40e21e
  ...
  %call2_40e259 = tail call %struct.Memory* @sub_40e970._Z17check_shifted_sumId33custom_multiple_constant_multiplyIdEEvT_(%struct.State* %0, i64 %224, %struct.Memory* %MEMORY.1)
...
block_.L_40e26c:                                  ; preds = %block_.L_40e1ff
  ...
  %call2_40e26c = tail call %struct.Memory* @sub_400e60._Z5timerv(%struct.State* %0, i64 %261, %struct.Memory* %MEMORY.0)
  ...
  %call2_40e275 = tail call %struct.Memory* @sub_400800._Z13record_resultdPKc(%struct.State* %0, i64 %272, %struct.Memory* %call2_40e26c)
