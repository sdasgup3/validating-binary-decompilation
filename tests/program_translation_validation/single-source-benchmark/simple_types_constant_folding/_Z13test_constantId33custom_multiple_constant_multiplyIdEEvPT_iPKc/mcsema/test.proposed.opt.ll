...
declare %struct.Memory* @sub_40e970._Z17check_shifted_sumId33custom_multiple_constant_multiplyIdEEvT_(%struct.State* noalias dereferenceable(3376), i64, %struct.Memory* noalias readnone returned) local_unnamed_addr
...
entry:
  ...
  %call2_40e1f3 = tail call %struct.Memory* @sub_400e40._Z11start_timerv(%struct.State* %0, i64 %58, %struct.Memory* %2)
...
block_.L_40e1ff:                                  ; preds = %block_.L_40e254, %entry
  %79 = phi i64 [ %.pre, %entry ], [ %264, %block_.L_40e254 ]
  %MEMORY.0 = phi %struct.Memory* [ %call2_40e1f3, %entry ], [ %call2_40e259, %block_.L_40e254 ]
  ...
  br i1 %112, label %block_40e20f, label %block_.L_40e26c
...
block_.L_40e21e:                                  ; preds = %block_40e22a, %block_40e20f
  %124 = phi i64 [ %.pre1, %block_40e20f ], [ %221, %block_40e22a ]
  %MEMORY.1 = phi %struct.Memory* [ %MEMORY.0, %block_40e20f ], [ %call2_40e237, %block_40e22a ]
  ...
  br i1 %160, label %block_40e22a, label %block_.L_40e254
...
block_40e22a:                                     ; preds = %block_.L_40e21e
  ...
  %call2_40e237 = tail call %struct.Memory* @sub_40e930._ZN33custom_multiple_constant_multiplyIdE8do_shiftEd(%struct.State* %0, i64 %175, %struct.Memory* %MEMORY.1)
...
block_.L_40e254:                                  ; preds = %block_.L_40e21e
  ...
  %call2_40e259 = tail call %struct.Memory* @sub_40e970._Z17check_shifted_sumId33custom_multiple_constant_multiplyIdEEvT_(%struct.State* %0, i64 %227, %struct.Memory* %MEMORY.1)
...
block_.L_40e26c:                                  ; preds = %block_.L_40e1ff
  ...
  %call2_40e26c = tail call %struct.Memory* @sub_400e60._Z5timerv(%struct.State* %0, i64 %265, %struct.Memory* %MEMORY.0)
  ...
  %call2_40e275 = tail call %struct.Memory* @sub_400800._Z13record_resultdPKc(%struct.State* %0, i64 %276, %struct.Memory* %call2_40e26c)
  ...
  ret %struct.Memory* %call2_40e275
}
...
define %struct.Memory* @routine_jge_.L_40e26c(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i8* %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
...
define %struct.Memory* @routine_jge_.L_40e254(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i8* %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 2, i32 9
...
define %struct.Memory* @routine_jmpq_.L_40e21e(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
...
define %struct.Memory* @routine_callq_._Z17check_shifted_sumId33custom_multiple_constant_multiplyIdEEvT_(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
...
define %struct.Memory* @routine_jmpq_.L_40e1ff(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
