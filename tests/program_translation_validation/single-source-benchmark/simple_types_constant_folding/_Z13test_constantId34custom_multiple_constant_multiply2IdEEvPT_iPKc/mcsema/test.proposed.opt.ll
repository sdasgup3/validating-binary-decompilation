...
block_.L_40e29f:                                  ; preds = %block_.L_40e2f4, %entry
  %79 = phi i64 [ %.pre, %entry ], [ %264, %block_.L_40e2f4 ]
...
block_.L_40e2be:                                  ; preds = %block_40e2ca, %block_40e2af
  %124 = phi i64 [ %.pre1, %block_40e2af ], [ %221, %block_40e2ca ]
...
block_40e2ca:                                     ; preds = %block_.L_40e2be
  ...
  %call2_40e2d7 = tail call %struct.Memory* @sub_40e8a0._ZN34custom_multiple_constant_multiply2IdE8do_shiftEd(%struct.State* %0, i64 %175, %struct.Memory* %MEMORY.1)
...
block_.L_40e2f4:                                  ; preds = %block_.L_40e2be
  ...
  %call2_40e2f9 = tail call %struct.Memory* @sub_40e8c0._Z17check_shifted_sumId34custom_multiple_constant_multiply2IdEEvT_(%struct.State* %0, i64 %227, %struct.Memory* %MEMORY.1)
...
block_.L_40e30c:                                  ; preds = %block_.L_40e29f
  ...
  %call2_40e30c = tail call %struct.Memory* @sub_400e60._Z5timerv(%struct.State* %0, i64 %265, %struct.Memory* %MEMORY.0)
  ...
  %call2_40e315 = tail call %struct.Memory* @sub_400800._Z13record_resultdPKc(%struct.State* %0, i64 %276, %struct.Memory* %call2_40e30c)
