...
declare %struct.Memory* @sub_40f9e0._Z17check_shifted_sumIf10custom_twoIfEEvT_(%struct.State* dereferenceable(3376), i64, %struct.Memory*)
...
define %struct.Memory* @_Z13test_constantIf10custom_twoIfEEvPT_iPKc(%struct.State* noalias, i64, %struct.Memory* noalias) #1 {
entry:
