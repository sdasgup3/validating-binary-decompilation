...
declare %struct.Memory* @sub_40f9e0._Z17check_shifted_sumIf10custom_twoIfEEvT_(%struct.State* noalias dereferenceable(3376), i64, %struct.Memory* noalias readnone returned) local_unnamed_addr
...
define %struct.Memory* @_Z13test_constantIf10custom_twoIfEEvPT_iPKc(%struct.State* noalias, i64, %struct.Memory* noalias readnone) local_unnamed_addr #1 {
entry:
...
block_.L_40d1bf:                                  ; preds = %block_.L_40d214, %entry
  %84 = phi i64 [ %273, %block_.L_40d214 ], [ %.pre, %entry ]
...
block_.L_40d1de:                                  ; preds = %block_40d1ea, %block_40d1cf
  %129 = phi i64 [ %232, %block_40d1ea ], [ %.pre6, %block_40d1cf ]
...
block_40d1ea:                                     ; preds = %block_.L_40d1de
  ...
  %call2_40d1f7 = tail call %struct.Memory* @sub_40f9c0._ZN10custom_twoIfE8do_shiftEf(%struct.State* nonnull %0, i64 %179, %struct.Memory* %call2_40d1b3)
...
block_.L_40d214:                                  ; preds = %block_.L_40d1de
  ...
  %call2_40d219 = tail call %struct.Memory* @sub_40f9e0._Z17check_shifted_sumIf10custom_twoIfEEvT_(%struct.State* nonnull %0, i64 %237, %struct.Memory* %call2_40d1b3)
...
block_.L_40d22c:                                  ; preds = %block_.L_40d1bf
  ...
  %call2_40d22c = tail call %struct.Memory* @sub_400ea0._Z5timerv(%struct.State* nonnull %0, i64 %274, %struct.Memory* %call2_40d1b3)
