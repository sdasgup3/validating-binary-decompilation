...
declare %struct.Memory* @sub_40f9f0._Z17check_shifted_sumIf10custom_twoIfEEvT_(%struct.State* noalias dereferenceable(3376), i64, %struct.Memory* noalias readnone returned) local_unnamed_addr
...
entry:
  ...
  %call2_40d1c3 = tail call %struct.Memory* @sub_400e90._Z11start_timerv(%struct.State* %0, i64 %58, %struct.Memory* %2)
...
block_.L_40d1cf:                                  ; preds = %block_.L_40d224, %entry
  %84 = phi i64 [ %273, %block_.L_40d224 ], [ %.pre, %entry ]
  ...
  br i1 %117, label %block_40d1df, label %block_.L_40d23c
...
block_.L_40d1ee:                                  ; preds = %block_40d1fa, %block_40d1df
  %129 = phi i64 [ %232, %block_40d1fa ], [ %.pre6, %block_40d1df ]
  ...
  br i1 %165, label %block_40d1fa, label %block_.L_40d224
...
block_40d1fa:                                     ; preds = %block_.L_40d1ee
  ...
  %call2_40d207 = tail call %struct.Memory* @sub_40f9d0._ZN10custom_twoIfE8do_shiftEf(%struct.State* nonnull %0, i64 %179, %struct.Memory* %call2_40d1c3)
...
block_.L_40d224:                                  ; preds = %block_.L_40d1ee
  ...
  %call2_40d229 = tail call %struct.Memory* @sub_40f9f0._Z17check_shifted_sumIf10custom_twoIfEEvT_(%struct.State* nonnull %0, i64 %237, %struct.Memory* %call2_40d1c3)
...
block_.L_40d23c:                                  ; preds = %block_.L_40d1cf
  ...
  %call2_40d23c = tail call %struct.Memory* @sub_400eb0._Z5timerv(%struct.State* nonnull %0, i64 %274, %struct.Memory* %call2_40d1c3)
  ...
  %call2_40d245 = tail call %struct.Memory* @sub_400850._Z13record_resultdPKc(%struct.State* nonnull %0, i64 %285, %struct.Memory* %call2_40d23c)
