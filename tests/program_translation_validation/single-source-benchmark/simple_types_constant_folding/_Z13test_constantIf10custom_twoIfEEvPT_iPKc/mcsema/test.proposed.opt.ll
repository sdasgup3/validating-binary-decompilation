...
block_.L_40d17f:                                  ; preds = %block_.L_40d1d4, %entry
  %83 = phi i64 [ %.pre, %entry ], [ %272, %block_.L_40d1d4 ]
  ...
  br i1 %116, label %block_40d18f, label %block_.L_40d1ec
...
block_.L_40d19e:                                  ; preds = %block_40d1aa, %block_40d18f
  %128 = phi i64 [ %.pre1, %block_40d18f ], [ %231, %block_40d1aa ]
  ...
  br i1 %164, label %block_40d1aa, label %block_.L_40d1d4
...
block_40d1aa:                                     ; preds = %block_.L_40d19e
  ...
  %call2_40d1b7 = tail call %struct.Memory* @sub_40f980._ZN10custom_twoIfE8do_shiftEf(%struct.State* %0, i64 %178, %struct.Memory* %MEMORY.1)
...
block_.L_40d1d4:                                  ; preds = %block_.L_40d19e
  ...
  %call2_40d1d9 = tail call %struct.Memory* @sub_40f9a0._Z17check_shifted_sumIf10custom_twoIfEEvT_(%struct.State* %0, i64 %236, %struct.Memory* %MEMORY.1)
...
block_.L_40d1ec:                                  ; preds = %block_.L_40d17f
  ...
  %call2_40d1ec = tail call %struct.Memory* @sub_400e60._Z5timerv(%struct.State* %0, i64 %273, %struct.Memory* %MEMORY.0)
  ...
  %call2_40d1f5 = tail call %struct.Memory* @sub_400800._Z13record_resultdPKc(%struct.State* %0, i64 %284, %struct.Memory* %call2_40d1ec)
