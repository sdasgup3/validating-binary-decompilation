...
block_.L_40d49f:                                  ; preds = %block_.L_40d4f4, %entry
  %84 = phi i64 [ %.pre, %entry ], [ %277, %block_.L_40d4f4 ]
  ...
  br i1 %117, label %block_40d4af, label %block_.L_40d50c
...
block_.L_40d4be:                                  ; preds = %block_40d4ca, %block_40d4af
  %129 = phi i64 [ %.pre1, %block_40d4af ], [ %234, %block_40d4ca ]
  ...
  br i1 %165, label %block_40d4ca, label %block_.L_40d4f4
...
block_40d4ca:                                     ; preds = %block_.L_40d4be
  ...
  %call2_40d4d7 = tail call %struct.Memory* @sub_40f6b0._ZN19custom_constant_addIfE8do_shiftEf(%struct.State* %0, i64 %180, %struct.Memory* %MEMORY.1)
...
block_.L_40d4f4:                                  ; preds = %block_.L_40d4be
  ...
  %call2_40d4f9 = tail call %struct.Memory* @sub_40f6d0._Z17check_shifted_sumIf19custom_constant_addIfEEvT_(%struct.State* %0, i64 %240, %struct.Memory* %MEMORY.1)
...
block_.L_40d50c:                                  ; preds = %block_.L_40d49f
  ...
  %call2_40d50c = tail call %struct.Memory* @sub_400e60._Z5timerv(%struct.State* %0, i64 %278, %struct.Memory* %MEMORY.0)
  ...
  %call2_40d515 = tail call %struct.Memory* @sub_400800._Z13record_resultdPKc(%struct.State* %0, i64 %289, %struct.Memory* %call2_40d50c)
