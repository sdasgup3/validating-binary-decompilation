...
declare %struct.Memory* @sub_40f6f0._ZN19custom_constant_addIfE8do_shiftEf(%struct.State* dereferenceable(3376), i64, %struct.Memory*) local_unnamed_addr

declare %struct.Memory* @sub_40f710._Z17check_shifted_sumIf19custom_constant_addIfEEvT_(%struct.State* dereferenceable(3376), i64, %struct.Memory*) local_unnamed_addr
...
define %struct.Memory* @_Z13test_constantIf19custom_constant_addIfEEvPT_iPKc(%struct.State* noalias, i64, %struct.Memory* noalias) local_unnamed_addr #1 {
entry:
...
block_.L_40d4df:                                  ; preds = %block_.L_40d534, %entry
  %84 = phi i64 [ %.pre, %entry ], [ %273, %block_.L_40d534 ]
  %MEMORY.0 = phi %struct.Memory* [ %call2_40d4d3, %entry ], [ %call2_40d539, %block_.L_40d534 ]
...
block_.L_40d4fe:                                  ; preds = %block_40d50a, %block_40d4ef
  %129 = phi i64 [ %.pre6, %block_40d4ef ], [ %232, %block_40d50a ]
  %MEMORY.1 = phi %struct.Memory* [ %MEMORY.0, %block_40d4ef ], [ %call2_40d517, %block_40d50a ]
...
block_40d50a:                                     ; preds = %block_.L_40d4fe
  ...
  %call2_40d517 = tail call %struct.Memory* @sub_40f6f0._ZN19custom_constant_addIfE8do_shiftEf(%struct.State* nonnull %0, i64 %179, %struct.Memory* %MEMORY.1)
...
block_.L_40d534:                                  ; preds = %block_.L_40d4fe
  ...
  %call2_40d539 = tail call %struct.Memory* @sub_40f710._Z17check_shifted_sumIf19custom_constant_addIfEEvT_(%struct.State* nonnull %0, i64 %237, %struct.Memory* %MEMORY.1)
...
block_.L_40d54c:                                  ; preds = %block_.L_40d4df
  ...
  %call2_40d54c = tail call %struct.Memory* @sub_400ea0._Z5timerv(%struct.State* nonnull %0, i64 %274, %struct.Memory* %MEMORY.0)
