...
block_.L_40d5df:                                  ; preds = %block_.L_40d634, %entry
  %83 = phi i64 [ %.pre, %entry ], [ %272, %block_.L_40d634 ]
  ...
  br i1 %116, label %block_40d5ef, label %block_.L_40d64c
...
block_.L_40d5fe:                                  ; preds = %block_40d60a, %block_40d5ef
  %128 = phi i64 [ %.pre1, %block_40d5ef ], [ %231, %block_40d60a ]
  ...
  br i1 %164, label %block_40d60a, label %block_.L_40d634
...
block_40d60a:                                     ; preds = %block_.L_40d5fe
  ...
  %call2_40d617 = tail call %struct.Memory* @sub_40f570._ZN19custom_constant_subIfE8do_shiftEf(%struct.State* %0, i64 %178, %struct.Memory* %MEMORY.1)
...
block_.L_40d634:                                  ; preds = %block_.L_40d5fe
  ...
  %call2_40d639 = tail call %struct.Memory* @sub_40f590._Z17check_shifted_sumIf19custom_constant_subIfEEvT_(%struct.State* %0, i64 %236, %struct.Memory* %MEMORY.1)
...
block_.L_40d64c:                                  ; preds = %block_.L_40d5df
  ...
  %call2_40d64c = tail call %struct.Memory* @sub_400e60._Z5timerv(%struct.State* %0, i64 %273, %struct.Memory* %MEMORY.0)
  ...
  %call2_40d655 = tail call %struct.Memory* @sub_400800._Z13record_resultdPKc(%struct.State* %0, i64 %284, %struct.Memory* %call2_40d64c)
