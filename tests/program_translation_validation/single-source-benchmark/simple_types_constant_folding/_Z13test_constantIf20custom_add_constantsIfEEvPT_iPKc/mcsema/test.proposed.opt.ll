...
declare %struct.Memory* @sub_40f930._ZN20custom_add_constantsIfE8do_shiftEf(%struct.State* dereferenceable(3376), i64, %struct.Memory*) local_unnamed_addr

declare %struct.Memory* @sub_40f950._Z17check_shifted_sumIf20custom_add_constantsIfEEvT_(%struct.State* dereferenceable(3376), i64, %struct.Memory*) local_unnamed_addr
...
block_.L_40d25f:                                  ; preds = %block_.L_40d2b4, %entry
  %84 = phi i64 [ %.pre, %entry ], [ %273, %block_.L_40d2b4 ]
  %MEMORY.0 = phi %struct.Memory* [ %call2_40d253, %entry ], [ %call2_40d2b9, %block_.L_40d2b4 ]
...
block_.L_40d27e:                                  ; preds = %block_40d28a, %block_40d26f
  %129 = phi i64 [ %.pre6, %block_40d26f ], [ %232, %block_40d28a ]
  %MEMORY.1 = phi %struct.Memory* [ %MEMORY.0, %block_40d26f ], [ %call2_40d297, %block_40d28a ]
...
block_40d28a:                                     ; preds = %block_.L_40d27e
  ...
  %call2_40d297 = tail call %struct.Memory* @sub_40f930._ZN20custom_add_constantsIfE8do_shiftEf(%struct.State* nonnull %0, i64 %179, %struct.Memory* %MEMORY.1)
...
block_.L_40d2b4:                                  ; preds = %block_.L_40d27e
  ...
  %call2_40d2b9 = tail call %struct.Memory* @sub_40f950._Z17check_shifted_sumIf20custom_add_constantsIfEEvT_(%struct.State* nonnull %0, i64 %237, %struct.Memory* %MEMORY.1)
...
block_.L_40d2cc:                                  ; preds = %block_.L_40d25f
  ...
  %call2_40d2cc = tail call %struct.Memory* @sub_400ea0._Z5timerv(%struct.State* nonnull %0, i64 %274, %struct.Memory* %MEMORY.0)
