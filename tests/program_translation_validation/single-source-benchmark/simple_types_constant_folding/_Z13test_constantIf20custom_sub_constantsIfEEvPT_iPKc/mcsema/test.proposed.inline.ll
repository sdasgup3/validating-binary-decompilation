...
declare %struct.Memory* @sub_40f8a0._ZN20custom_sub_constantsIfE8do_shiftEf(%struct.State* dereferenceable(3376), i64, %struct.Memory*)

declare %struct.Memory* @sub_40f8c0._Z17check_shifted_sumIf20custom_sub_constantsIfEEvT_(%struct.State* dereferenceable(3376), i64, %struct.Memory*)
...
define %struct.Memory* @_Z13test_constantIf20custom_sub_constantsIfEEvPT_iPKc(%struct.State* noalias, i64, %struct.Memory* noalias) #1 {
entry:
