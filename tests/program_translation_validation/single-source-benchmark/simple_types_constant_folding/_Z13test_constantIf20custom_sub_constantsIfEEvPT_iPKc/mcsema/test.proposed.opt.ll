...
block_.L_40d2bf:                                  ; preds = %block_.L_40d314, %entry
  %83 = phi i64 [ %.pre, %entry ], [ %272, %block_.L_40d314 ]
  ...
  br i1 %116, label %block_40d2cf, label %block_.L_40d32c
...
block_.L_40d2de:                                  ; preds = %block_40d2ea, %block_40d2cf
  %128 = phi i64 [ %.pre1, %block_40d2cf ], [ %231, %block_40d2ea ]
  ...
  br i1 %164, label %block_40d2ea, label %block_.L_40d314
...
block_40d2ea:                                     ; preds = %block_.L_40d2de
  ...
  %call2_40d2f7 = tail call %struct.Memory* @sub_40f860._ZN20custom_sub_constantsIfE8do_shiftEf(%struct.State* %0, i64 %178, %struct.Memory* %MEMORY.1)
...
block_.L_40d314:                                  ; preds = %block_.L_40d2de
  ...
  %call2_40d319 = tail call %struct.Memory* @sub_40f880._Z17check_shifted_sumIf20custom_sub_constantsIfEEvT_(%struct.State* %0, i64 %236, %struct.Memory* %MEMORY.1)
...
block_.L_40d32c:                                  ; preds = %block_.L_40d2bf
  ...
  %call2_40d32c = tail call %struct.Memory* @sub_400e60._Z5timerv(%struct.State* %0, i64 %273, %struct.Memory* %MEMORY.0)
  ...
  %call2_40d335 = tail call %struct.Memory* @sub_400800._Z13record_resultdPKc(%struct.State* %0, i64 %284, %struct.Memory* %call2_40d32c)
