...
declare %struct.Memory* @sub_40f2a0._ZN22custom_constant_divideIfE8do_shiftEf(%struct.State* dereferenceable(3376), i64, %struct.Memory*)

declare %struct.Memory* @sub_40f2c0._Z17check_shifted_sumIf22custom_constant_divideIfEEvT_(%struct.State* dereferenceable(3376), i64, %struct.Memory*)
...
define %struct.Memory* @_Z13test_constantIf22custom_constant_divideIfEEvPT_iPKc(%struct.State* noalias, i64, %struct.Memory* noalias) #1 {
entry:
