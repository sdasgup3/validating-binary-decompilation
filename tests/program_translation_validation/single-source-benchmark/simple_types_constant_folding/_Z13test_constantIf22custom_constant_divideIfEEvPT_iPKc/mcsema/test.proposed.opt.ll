...
block_.L_40d8ff:                                  ; preds = %block_.L_40d954, %entry
  %83 = phi i64 [ %.pre, %entry ], [ %272, %block_.L_40d954 ]
  ...
  br i1 %116, label %block_40d90f, label %block_.L_40d96c
...
block_.L_40d91e:                                  ; preds = %block_40d92a, %block_40d90f
  %128 = phi i64 [ %.pre1, %block_40d90f ], [ %231, %block_40d92a ]
  ...
  br i1 %164, label %block_40d92a, label %block_.L_40d954
...
block_40d92a:                                     ; preds = %block_.L_40d91e
  ...
  %call2_40d937 = tail call %struct.Memory* @sub_40f260._ZN22custom_constant_divideIfE8do_shiftEf(%struct.State* %0, i64 %178, %struct.Memory* %MEMORY.1)
...
block_.L_40d954:                                  ; preds = %block_.L_40d91e
  ...
  %call2_40d959 = tail call %struct.Memory* @sub_40f280._Z17check_shifted_sumIf22custom_constant_divideIfEEvT_(%struct.State* %0, i64 %236, %struct.Memory* %MEMORY.1)
...
block_.L_40d96c:                                  ; preds = %block_.L_40d8ff
  ...
  %call2_40d96c = tail call %struct.Memory* @sub_400e60._Z5timerv(%struct.State* %0, i64 %273, %struct.Memory* %MEMORY.0)
  ...
  %call2_40d975 = tail call %struct.Memory* @sub_400800._Z13record_resultdPKc(%struct.State* %0, i64 %284, %struct.Memory* %call2_40d96c)
