...
declare %struct.Memory* @sub_40f2c0._Z17check_shifted_sumIf22custom_constant_divideIfEEvT_(%struct.State* noalias dereferenceable(3376), i64, %struct.Memory* noalias readnone returned) local_unnamed_addr
...
block_.L_40d93f:                                  ; preds = %block_.L_40d994, %entry
  %84 = phi i64 [ %273, %block_.L_40d994 ], [ %.pre, %entry ]
...
block_.L_40d95e:                                  ; preds = %block_40d96a, %block_40d94f
  %129 = phi i64 [ %232, %block_40d96a ], [ %.pre6, %block_40d94f ]
...
block_40d96a:                                     ; preds = %block_.L_40d95e
  ...
  %call2_40d977 = tail call %struct.Memory* @sub_40f2a0._ZN22custom_constant_divideIfE8do_shiftEf(%struct.State* nonnull %0, i64 %179, %struct.Memory* %call2_40d933)
...
block_.L_40d994:                                  ; preds = %block_.L_40d95e
  ...
  %call2_40d999 = tail call %struct.Memory* @sub_40f2c0._Z17check_shifted_sumIf22custom_constant_divideIfEEvT_(%struct.State* nonnull %0, i64 %237, %struct.Memory* %call2_40d933)
...
block_.L_40d9ac:                                  ; preds = %block_.L_40d93f
  ...
  %call2_40d9ac = tail call %struct.Memory* @sub_400ea0._Z5timerv(%struct.State* nonnull %0, i64 %274, %struct.Memory* %call2_40d933)
