...
declare %struct.Memory* @sub_40f780._ZN23custom_divide_constantsIfE8do_shiftEf(%struct.State* noalias dereferenceable(3376), i64, %struct.Memory* noalias readnone returned) local_unnamed_addr

declare %struct.Memory* @sub_40f7a0._Z17check_shifted_sumIf23custom_divide_constantsIfEEvT_(%struct.State* noalias dereferenceable(3376), i64, %struct.Memory* noalias readnone returned) local_unnamed_addr
...
define %struct.Memory* @_Z13test_constantIf23custom_divide_constantsIfEEvPT_iPKc(%struct.State* noalias, i64, %struct.Memory* noalias readnone) local_unnamed_addr #1 {
entry:
...
block_.L_40d43f:                                  ; preds = %block_.L_40d494, %entry
  %84 = phi i64 [ %273, %block_.L_40d494 ], [ %.pre, %entry ]
...
block_.L_40d45e:                                  ; preds = %block_40d46a, %block_40d44f
  %129 = phi i64 [ %232, %block_40d46a ], [ %.pre6, %block_40d44f ]
...
block_40d46a:                                     ; preds = %block_.L_40d45e
  ...
  %call2_40d477 = tail call %struct.Memory* @sub_40f780._ZN23custom_divide_constantsIfE8do_shiftEf(%struct.State* nonnull %0, i64 %179, %struct.Memory* %call2_40d433)
...
block_.L_40d494:                                  ; preds = %block_.L_40d45e
  ...
  %call2_40d499 = tail call %struct.Memory* @sub_40f7a0._Z17check_shifted_sumIf23custom_divide_constantsIfEEvT_(%struct.State* nonnull %0, i64 %237, %struct.Memory* %call2_40d433)
...
block_.L_40d4ac:                                  ; preds = %block_.L_40d43f
  ...
  %call2_40d4ac = tail call %struct.Memory* @sub_400ea0._Z5timerv(%struct.State* nonnull %0, i64 %274, %struct.Memory* %call2_40d433)
