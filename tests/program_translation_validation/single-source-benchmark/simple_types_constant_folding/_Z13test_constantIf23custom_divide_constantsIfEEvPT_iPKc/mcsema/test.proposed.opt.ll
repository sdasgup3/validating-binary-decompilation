...
block_.L_40d3ff:                                  ; preds = %block_.L_40d454, %entry
  %83 = phi i64 [ %.pre, %entry ], [ %272, %block_.L_40d454 ]
  ...
  br i1 %116, label %block_40d40f, label %block_.L_40d46c
...
block_.L_40d41e:                                  ; preds = %block_40d42a, %block_40d40f
  %128 = phi i64 [ %.pre1, %block_40d40f ], [ %231, %block_40d42a ]
  ...
  br i1 %164, label %block_40d42a, label %block_.L_40d454
...
block_40d42a:                                     ; preds = %block_.L_40d41e
  ...
  %call2_40d437 = tail call %struct.Memory* @sub_40f740._ZN23custom_divide_constantsIfE8do_shiftEf(%struct.State* %0, i64 %178, %struct.Memory* %MEMORY.1)
...
block_.L_40d454:                                  ; preds = %block_.L_40d41e
  ...
  %call2_40d459 = tail call %struct.Memory* @sub_40f760._Z17check_shifted_sumIf23custom_divide_constantsIfEEvT_(%struct.State* %0, i64 %236, %struct.Memory* %MEMORY.1)
...
block_.L_40d46c:                                  ; preds = %block_.L_40d3ff
  ...
  %call2_40d46c = tail call %struct.Memory* @sub_400e60._Z5timerv(%struct.State* %0, i64 %273, %struct.Memory* %MEMORY.0)
  ...
  %call2_40d475 = tail call %struct.Memory* @sub_400800._Z13record_resultdPKc(%struct.State* %0, i64 %284, %struct.Memory* %call2_40d46c)
