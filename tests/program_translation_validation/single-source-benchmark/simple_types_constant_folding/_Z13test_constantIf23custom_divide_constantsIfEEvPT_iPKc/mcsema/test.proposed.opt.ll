...
declare %struct.Memory* @sub_40f7b0._Z17check_shifted_sumIf23custom_divide_constantsIfEEvT_(%struct.State* noalias dereferenceable(3376), i64, %struct.Memory* noalias readnone returned) local_unnamed_addr
...
entry:
  ...
  %call2_40d443 = tail call %struct.Memory* @sub_400e90._Z11start_timerv(%struct.State* %0, i64 %58, %struct.Memory* %2)
...
block_.L_40d44f:                                  ; preds = %block_.L_40d4a4, %entry
  %84 = phi i64 [ %273, %block_.L_40d4a4 ], [ %.pre, %entry ]
  ...
  br i1 %117, label %block_40d45f, label %block_.L_40d4bc
...
block_.L_40d46e:                                  ; preds = %block_40d47a, %block_40d45f
  %129 = phi i64 [ %232, %block_40d47a ], [ %.pre6, %block_40d45f ]
  ...
  br i1 %165, label %block_40d47a, label %block_.L_40d4a4
...
block_40d47a:                                     ; preds = %block_.L_40d46e
  ...
  %call2_40d487 = tail call %struct.Memory* @sub_40f790._ZN23custom_divide_constantsIfE8do_shiftEf(%struct.State* nonnull %0, i64 %179, %struct.Memory* %call2_40d443)
...
block_.L_40d4a4:                                  ; preds = %block_.L_40d46e
  ...
  %call2_40d4a9 = tail call %struct.Memory* @sub_40f7b0._Z17check_shifted_sumIf23custom_divide_constantsIfEEvT_(%struct.State* nonnull %0, i64 %237, %struct.Memory* %call2_40d443)
...
block_.L_40d4bc:                                  ; preds = %block_.L_40d44f
  ...
  %call2_40d4bc = tail call %struct.Memory* @sub_400eb0._Z5timerv(%struct.State* nonnull %0, i64 %274, %struct.Memory* %call2_40d443)
  ...
  %call2_40d4c5 = tail call %struct.Memory* @sub_400850._Z13record_resultdPKc(%struct.State* nonnull %0, i64 %285, %struct.Memory* %call2_40d4bc)
