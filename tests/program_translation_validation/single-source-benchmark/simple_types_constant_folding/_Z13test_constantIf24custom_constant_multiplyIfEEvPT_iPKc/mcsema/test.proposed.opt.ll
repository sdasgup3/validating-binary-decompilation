...
block_.L_40d71f:                                  ; preds = %block_.L_40d774, %entry
  %83 = phi i64 [ %.pre, %entry ], [ %272, %block_.L_40d774 ]
  ...
  br i1 %116, label %block_40d72f, label %block_.L_40d78c
...
block_.L_40d73e:                                  ; preds = %block_40d74a, %block_40d72f
  %128 = phi i64 [ %.pre1, %block_40d72f ], [ %231, %block_40d74a ]
  ...
  br i1 %164, label %block_40d74a, label %block_.L_40d774
...
block_40d74a:                                     ; preds = %block_.L_40d73e
  ...
  %call2_40d757 = tail call %struct.Memory* @sub_40f430._ZN24custom_constant_multiplyIfE8do_shiftEf(%struct.State* %0, i64 %178, %struct.Memory* %MEMORY.1)
...
block_.L_40d774:                                  ; preds = %block_.L_40d73e
  ...
  %call2_40d779 = tail call %struct.Memory* @sub_40f450._Z17check_shifted_sumIf24custom_constant_multiplyIfEEvT_(%struct.State* %0, i64 %236, %struct.Memory* %MEMORY.1)
...
block_.L_40d78c:                                  ; preds = %block_.L_40d71f
  ...
  %call2_40d78c = tail call %struct.Memory* @sub_400e60._Z5timerv(%struct.State* %0, i64 %273, %struct.Memory* %MEMORY.0)
  ...
  %call2_40d795 = tail call %struct.Memory* @sub_400800._Z13record_resultdPKc(%struct.State* %0, i64 %284, %struct.Memory* %call2_40d78c)
