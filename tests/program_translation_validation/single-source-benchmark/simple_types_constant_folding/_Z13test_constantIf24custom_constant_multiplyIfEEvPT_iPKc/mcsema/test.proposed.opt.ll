...
declare %struct.Memory* @sub_40f470._ZN24custom_constant_multiplyIfE8do_shiftEf(%struct.State* noalias dereferenceable(3376), i64, %struct.Memory* noalias readnone returned) local_unnamed_addr

declare %struct.Memory* @sub_40f490._Z17check_shifted_sumIf24custom_constant_multiplyIfEEvT_(%struct.State* noalias dereferenceable(3376), i64, %struct.Memory* noalias readnone returned) local_unnamed_addr
...
define %struct.Memory* @_Z13test_constantIf24custom_constant_multiplyIfEEvPT_iPKc(%struct.State* noalias, i64, %struct.Memory* noalias readnone) local_unnamed_addr #1 {
entry:
...
block_.L_40d75f:                                  ; preds = %block_.L_40d7b4, %entry
  %84 = phi i64 [ %273, %block_.L_40d7b4 ], [ %.pre, %entry ]
...
block_.L_40d77e:                                  ; preds = %block_40d78a, %block_40d76f
  %129 = phi i64 [ %232, %block_40d78a ], [ %.pre6, %block_40d76f ]
...
block_40d78a:                                     ; preds = %block_.L_40d77e
  ...
  %call2_40d797 = tail call %struct.Memory* @sub_40f470._ZN24custom_constant_multiplyIfE8do_shiftEf(%struct.State* nonnull %0, i64 %179, %struct.Memory* %call2_40d753)
...
block_.L_40d7b4:                                  ; preds = %block_.L_40d77e
  ...
  %call2_40d7b9 = tail call %struct.Memory* @sub_40f490._Z17check_shifted_sumIf24custom_constant_multiplyIfEEvT_(%struct.State* nonnull %0, i64 %237, %struct.Memory* %call2_40d753)
...
block_.L_40d7cc:                                  ; preds = %block_.L_40d75f
  ...
  %call2_40d7cc = tail call %struct.Memory* @sub_400ea0._Z5timerv(%struct.State* nonnull %0, i64 %274, %struct.Memory* %call2_40d753)
