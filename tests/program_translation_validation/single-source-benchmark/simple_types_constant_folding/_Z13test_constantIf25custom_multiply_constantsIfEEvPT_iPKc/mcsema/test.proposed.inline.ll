...
declare %struct.Memory* @sub_40f810._ZN25custom_multiply_constantsIfE8do_shiftEf(%struct.State* dereferenceable(3376), i64, %struct.Memory*)

declare %struct.Memory* @sub_40f830._Z17check_shifted_sumIf25custom_multiply_constantsIfEEvT_(%struct.State* dereferenceable(3376), i64, %struct.Memory*)
...
define %struct.Memory* @_Z13test_constantIf25custom_multiply_constantsIfEEvPT_iPKc(%struct.State* noalias, i64, %struct.Memory* noalias) #1 {
entry:
