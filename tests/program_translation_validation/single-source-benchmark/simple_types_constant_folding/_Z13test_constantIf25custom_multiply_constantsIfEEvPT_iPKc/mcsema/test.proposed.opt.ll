...
block_.L_40d35f:                                  ; preds = %block_.L_40d3b4, %entry
  %83 = phi i64 [ %.pre, %entry ], [ %272, %block_.L_40d3b4 ]
  ...
  br i1 %116, label %block_40d36f, label %block_.L_40d3cc
...
block_.L_40d37e:                                  ; preds = %block_40d38a, %block_40d36f
  %128 = phi i64 [ %.pre1, %block_40d36f ], [ %231, %block_40d38a ]
  ...
  br i1 %164, label %block_40d38a, label %block_.L_40d3b4
...
block_40d38a:                                     ; preds = %block_.L_40d37e
  ...
  %call2_40d397 = tail call %struct.Memory* @sub_40f7d0._ZN25custom_multiply_constantsIfE8do_shiftEf(%struct.State* %0, i64 %178, %struct.Memory* %MEMORY.1)
...
block_.L_40d3b4:                                  ; preds = %block_.L_40d37e
  ...
  %call2_40d3b9 = tail call %struct.Memory* @sub_40f7f0._Z17check_shifted_sumIf25custom_multiply_constantsIfEEvT_(%struct.State* %0, i64 %236, %struct.Memory* %MEMORY.1)
...
block_.L_40d3cc:                                  ; preds = %block_.L_40d35f
  ...
  %call2_40d3cc = tail call %struct.Memory* @sub_400e60._Z5timerv(%struct.State* %0, i64 %273, %struct.Memory* %MEMORY.0)
  ...
  %call2_40d3d5 = tail call %struct.Memory* @sub_400800._Z13record_resultdPKc(%struct.State* %0, i64 %284, %struct.Memory* %call2_40d3cc)
