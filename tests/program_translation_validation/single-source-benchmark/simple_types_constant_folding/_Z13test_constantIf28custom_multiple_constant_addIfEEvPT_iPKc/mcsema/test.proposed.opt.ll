...
declare %struct.Memory* @sub_40f640._ZN28custom_multiple_constant_addIfE8do_shiftEf(%struct.State* noalias dereferenceable(3376), i64, %struct.Memory* noalias readnone returned) local_unnamed_addr

declare %struct.Memory* @sub_40f680._Z17check_shifted_sumIf28custom_multiple_constant_addIfEEvT_(%struct.State* noalias dereferenceable(3376), i64, %struct.Memory* noalias readnone returned) local_unnamed_addr
...
block_.L_40d57f:                                  ; preds = %block_.L_40d5d4, %entry
  %84 = phi i64 [ %273, %block_.L_40d5d4 ], [ %.pre, %entry ]
...
block_.L_40d59e:                                  ; preds = %block_40d5aa, %block_40d58f
  %129 = phi i64 [ %232, %block_40d5aa ], [ %.pre6, %block_40d58f ]
...
block_40d5aa:                                     ; preds = %block_.L_40d59e
  ...
  %call2_40d5b7 = tail call %struct.Memory* @sub_40f640._ZN28custom_multiple_constant_addIfE8do_shiftEf(%struct.State* nonnull %0, i64 %179, %struct.Memory* %call2_40d573)
...
block_.L_40d5d4:                                  ; preds = %block_.L_40d59e
  ...
  %call2_40d5d9 = tail call %struct.Memory* @sub_40f680._Z17check_shifted_sumIf28custom_multiple_constant_addIfEEvT_(%struct.State* nonnull %0, i64 %237, %struct.Memory* %call2_40d573)
...
block_.L_40d5ec:                                  ; preds = %block_.L_40d57f
  ...
  %call2_40d5ec = tail call %struct.Memory* @sub_400ea0._Z5timerv(%struct.State* nonnull %0, i64 %274, %struct.Memory* %call2_40d573)
