...
block_.L_40d53f:                                  ; preds = %block_.L_40d594, %entry
  %83 = phi i64 [ %.pre, %entry ], [ %272, %block_.L_40d594 ]
  ...
  br i1 %116, label %block_40d54f, label %block_.L_40d5ac
...
block_.L_40d55e:                                  ; preds = %block_40d56a, %block_40d54f
  %128 = phi i64 [ %.pre1, %block_40d54f ], [ %231, %block_40d56a ]
  ...
  br i1 %164, label %block_40d56a, label %block_.L_40d594
...
block_40d56a:                                     ; preds = %block_.L_40d55e
  ...
  %call2_40d577 = tail call %struct.Memory* @sub_40f600._ZN28custom_multiple_constant_addIfE8do_shiftEf(%struct.State* %0, i64 %178, %struct.Memory* %MEMORY.1)
...
block_.L_40d594:                                  ; preds = %block_.L_40d55e
  ...
  %call2_40d599 = tail call %struct.Memory* @sub_40f640._Z17check_shifted_sumIf28custom_multiple_constant_addIfEEvT_(%struct.State* %0, i64 %236, %struct.Memory* %MEMORY.1)
...
block_.L_40d5ac:                                  ; preds = %block_.L_40d53f
  ...
  %call2_40d5ac = tail call %struct.Memory* @sub_400e60._Z5timerv(%struct.State* %0, i64 %273, %struct.Memory* %MEMORY.0)
  ...
  %call2_40d5b5 = tail call %struct.Memory* @sub_400800._Z13record_resultdPKc(%struct.State* %0, i64 %284, %struct.Memory* %call2_40d5ac)
