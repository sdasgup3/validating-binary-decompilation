...
define %struct.Memory* @_Z13test_constantIf28custom_multiple_constant_subIfEEvPT_iPKc(%struct.State* noalias, i64, %struct.Memory* noalias) #1 {
entry:
  ...
  store %struct.Memory* %loadMem1_40d6b3, %struct.Memory** %MEMORY
...
block_.L_40d6bf:                                  ; preds = %block_.L_40d714, %entry
  ...
  store %struct.Memory* %loadMem_40d6c9, %struct.Memory** %MEMORY
...
block_40d6ea:                                     ; preds = %block_.L_40d6de
  ...
  store %struct.Memory* %loadMem_40d6ea, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem1_40d6f7, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_40d706, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_40d709, %struct.Memory** %MEMORY
...
block_.L_40d714:                                  ; preds = %block_.L_40d6de
  ...
  store %struct.Memory* %loadMem1_40d719, %struct.Memory** %MEMORY
...
block_.L_40d72c:                                  ; preds = %block_.L_40d6bf
  ...
  store %struct.Memory* %loadMem1_40d72c, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem1_40d735, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_40d73a, %struct.Memory** %MEMORY
  ...
  ret %struct.Memory* %loadMem_40d73f
}
