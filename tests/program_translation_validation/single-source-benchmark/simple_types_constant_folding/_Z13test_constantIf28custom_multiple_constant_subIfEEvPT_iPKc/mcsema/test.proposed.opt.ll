...
declare %struct.Memory* @sub_40f540._Z17check_shifted_sumIf28custom_multiple_constant_subIfEEvT_(%struct.State* noalias dereferenceable(3376), i64, %struct.Memory* noalias readnone returned) local_unnamed_addr
...
block_.L_40d6bf:                                  ; preds = %block_.L_40d714, %entry
  %84 = phi i64 [ %273, %block_.L_40d714 ], [ %.pre, %entry ]
...
block_.L_40d6de:                                  ; preds = %block_40d6ea, %block_40d6cf
  %129 = phi i64 [ %232, %block_40d6ea ], [ %.pre6, %block_40d6cf ]
...
block_40d6ea:                                     ; preds = %block_.L_40d6de
  ...
  %call2_40d6f7 = tail call %struct.Memory* @sub_40f500._ZN28custom_multiple_constant_subIfE8do_shiftEf(%struct.State* nonnull %0, i64 %179, %struct.Memory* %call2_40d6b3)
...
block_.L_40d714:                                  ; preds = %block_.L_40d6de
  ...
  %call2_40d719 = tail call %struct.Memory* @sub_40f540._Z17check_shifted_sumIf28custom_multiple_constant_subIfEEvT_(%struct.State* nonnull %0, i64 %237, %struct.Memory* %call2_40d6b3)
...
block_.L_40d72c:                                  ; preds = %block_.L_40d6bf
  ...
  %call2_40d72c = tail call %struct.Memory* @sub_400ea0._Z5timerv(%struct.State* nonnull %0, i64 %274, %struct.Memory* %call2_40d6b3)
