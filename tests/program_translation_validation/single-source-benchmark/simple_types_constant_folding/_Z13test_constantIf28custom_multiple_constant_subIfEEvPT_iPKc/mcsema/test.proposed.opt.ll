...
declare %struct.Memory* @sub_40f500._Z17check_shifted_sumIf28custom_multiple_constant_subIfEEvT_(%struct.State* noalias dereferenceable(3376), i64, %struct.Memory* noalias readnone returned) local_unnamed_addr
...
entry:
  ...
  %call2_40d673 = tail call %struct.Memory* @sub_400e40._Z11start_timerv(%struct.State* %0, i64 %58, %struct.Memory* %2)
...
block_.L_40d67f:                                  ; preds = %block_.L_40d6d4, %entry
  %84 = phi i64 [ %.pre, %entry ], [ %277, %block_.L_40d6d4 ]
  %MEMORY.0 = phi %struct.Memory* [ %call2_40d673, %entry ], [ %call2_40d6d9, %block_.L_40d6d4 ]
  ...
  br i1 %117, label %block_40d68f, label %block_.L_40d6ec

block_40d68f:                                     ; preds = %block_.L_40d67f
...
block_.L_40d69e:                                  ; preds = %block_40d6aa, %block_40d68f
  %129 = phi i64 [ %.pre1, %block_40d68f ], [ %234, %block_40d6aa ]
  %MEMORY.1 = phi %struct.Memory* [ %MEMORY.0, %block_40d68f ], [ %call2_40d6b7, %block_40d6aa ]
  ...
  br i1 %165, label %block_40d6aa, label %block_.L_40d6d4

block_40d6aa:                                     ; preds = %block_.L_40d69e
  %167 = add i64 %130, -8
  %168 = add i64 %166, 4
  ...
  %call2_40d6b7 = tail call %struct.Memory* @sub_40f4c0._ZN28custom_multiple_constant_subIfE8do_shiftEf(%struct.State* %0, i64 %180, %struct.Memory* %MEMORY.1)
...
block_.L_40d6d4:                                  ; preds = %block_.L_40d69e
  %235 = add i64 %130, -32
  %236 = add i64 %166, 5
  ...
  %call2_40d6d9 = tail call %struct.Memory* @sub_40f500._Z17check_shifted_sumIf28custom_multiple_constant_subIfEEvT_(%struct.State* %0, i64 %240, %struct.Memory* %MEMORY.1)
...
block_.L_40d6ec:                                  ; preds = %block_.L_40d67f
  %278 = add i64 %118, -51340
  %279 = add i64 %118, 5
  ...
  %call2_40d6ec = tail call %struct.Memory* @sub_400e60._Z5timerv(%struct.State* %0, i64 %278, %struct.Memory* %MEMORY.0)
  ...
  %call2_40d6f5 = tail call %struct.Memory* @sub_400800._Z13record_resultdPKc(%struct.State* %0, i64 %289, %struct.Memory* %call2_40d6ec)
  ...
  ret %struct.Memory* %call2_40d6f5
}
...
define %struct.Memory* @routine_jge_.L_40d6ec(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i8* %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
...
define %struct.Memory* @routine_jge_.L_40d6d4(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i8* %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 2, i32 9
...
define %struct.Memory* @routine_jmpq_.L_40d69e(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
...
define %struct.Memory* @routine_callq_._Z17check_shifted_sumIf28custom_multiple_constant_subIfEEvT_(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
...
define %struct.Memory* @routine_jmpq_.L_40d67f(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
