...
block_.L_40d67f:                                  ; preds = %block_.L_40d6d4, %entry
  %83 = phi i64 [ %.pre, %entry ], [ %272, %block_.L_40d6d4 ]
  ...
  br i1 %116, label %block_40d68f, label %block_.L_40d6ec
...
block_.L_40d69e:                                  ; preds = %block_40d6aa, %block_40d68f
  %128 = phi i64 [ %.pre1, %block_40d68f ], [ %231, %block_40d6aa ]
  ...
  br i1 %164, label %block_40d6aa, label %block_.L_40d6d4
...
block_40d6aa:                                     ; preds = %block_.L_40d69e
  ...
  %call2_40d6b7 = tail call %struct.Memory* @sub_40f4c0._ZN28custom_multiple_constant_subIfE8do_shiftEf(%struct.State* %0, i64 %178, %struct.Memory* %MEMORY.1)
...
block_.L_40d6d4:                                  ; preds = %block_.L_40d69e
  ...
  %call2_40d6d9 = tail call %struct.Memory* @sub_40f500._Z17check_shifted_sumIf28custom_multiple_constant_subIfEEvT_(%struct.State* %0, i64 %236, %struct.Memory* %MEMORY.1)
...
block_.L_40d6ec:                                  ; preds = %block_.L_40d67f
  ...
  %call2_40d6ec = tail call %struct.Memory* @sub_400e60._Z5timerv(%struct.State* %0, i64 %273, %struct.Memory* %MEMORY.0)
  ...
  %call2_40d6f5 = tail call %struct.Memory* @sub_400800._Z13record_resultdPKc(%struct.State* %0, i64 %284, %struct.Memory* %call2_40d6ec)
