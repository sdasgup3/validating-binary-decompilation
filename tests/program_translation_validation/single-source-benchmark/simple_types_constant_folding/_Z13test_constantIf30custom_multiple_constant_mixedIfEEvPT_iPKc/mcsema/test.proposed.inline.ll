...
define %struct.Memory* @_Z13test_constantIf30custom_multiple_constant_mixedIfEEvPT_iPKc(%struct.State* noalias, i64, %struct.Memory* noalias) #2 {
entry:
  ...
  store %struct.Memory* %loadMem_40dacf, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem1_40dad3, %struct.Memory** %MEMORY
...
block_.L_40dadf:                                  ; preds = %block_.L_40db34, %entry
  ...
  store %struct.Memory* %loadMem_40dadf, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_40dae2, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_40dae9, %struct.Memory** %MEMORY
...
block_40daef:                                     ; preds = %block_.L_40dadf
  ...
  store %struct.Memory* %loadMem_40daf2, %struct.Memory** %MEMORY
  ...
  store i32 0, i32* %279
  store %struct.Memory* %loadMem_40daf7, %struct.Memory** %MEMORY
...
block_.L_40dafe:                                  ; preds = %block_40db0a, %block_40daef
  ...
  store %struct.Memory* %loadMem_40dafe, %struct.Memory** %MEMORY
...
block_40db0a:                                     ; preds = %block_.L_40dafe
  ...
  store %struct.Memory* %loadMem_40db0a, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_40db0e, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_40db12, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem1_40db17, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_40db29, %struct.Memory** %MEMORY
...
block_.L_40db34:                                  ; preds = %block_.L_40dafe
  ...
  store %struct.Memory* %loadMem_40db34, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem1_40db39, %struct.Memory** %MEMORY
...
block_.L_40db4c:                                  ; preds = %block_.L_40dadf
  ...
  store %struct.Memory* %loadMem1_40db4c, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_40db51, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem1_40db55, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_40db5a, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_40db5e, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_40db5f, %struct.Memory** %MEMORY
  ret %struct.Memory* %loadMem_40db5f
}
