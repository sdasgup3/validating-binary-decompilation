...
block_.L_40dadf:                                  ; preds = %block_.L_40db34, %entry
  %83 = phi i64 [ %.pre, %entry ], [ %272, %block_.L_40db34 ]
  ...
  br i1 %116, label %block_40daef, label %block_.L_40db4c
...
block_.L_40dafe:                                  ; preds = %block_40db0a, %block_40daef
  %128 = phi i64 [ %.pre1, %block_40daef ], [ %231, %block_40db0a ]
  ...
  br i1 %164, label %block_40db0a, label %block_.L_40db34
...
block_40db0a:                                     ; preds = %block_.L_40dafe
  ...
  %call2_40db17 = tail call %struct.Memory* @sub_40efc0._ZN30custom_multiple_constant_mixedIfE8do_shiftEf(%struct.State* %0, i64 %178, %struct.Memory* %MEMORY.1)
...
block_.L_40db34:                                  ; preds = %block_.L_40dafe
  ...
  %call2_40db39 = tail call %struct.Memory* @sub_40eff0._Z17check_shifted_sumIf30custom_multiple_constant_mixedIfEEvT_(%struct.State* %0, i64 %236, %struct.Memory* %MEMORY.1)
...
block_.L_40db4c:                                  ; preds = %block_.L_40dadf
  ...
  %call2_40db4c = tail call %struct.Memory* @sub_400e60._Z5timerv(%struct.State* %0, i64 %273, %struct.Memory* %MEMORY.0)
  ...
  %call2_40db55 = tail call %struct.Memory* @sub_400800._Z13record_resultdPKc(%struct.State* %0, i64 %284, %struct.Memory* %call2_40db4c)
