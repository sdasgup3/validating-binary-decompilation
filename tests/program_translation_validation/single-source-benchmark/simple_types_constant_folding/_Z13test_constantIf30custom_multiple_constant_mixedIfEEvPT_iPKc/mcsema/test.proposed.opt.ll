...
declare %struct.Memory* @sub_40f030._Z17check_shifted_sumIf30custom_multiple_constant_mixedIfEEvT_(%struct.State* noalias dereferenceable(3376), i64, %struct.Memory* noalias readnone returned) local_unnamed_addr
...
define %struct.Memory* @_Z13test_constantIf30custom_multiple_constant_mixedIfEEvPT_iPKc(%struct.State* noalias, i64, %struct.Memory* noalias readnone) local_unnamed_addr #1 {
entry:
...
block_.L_40db1f:                                  ; preds = %block_.L_40db74, %entry
  %84 = phi i64 [ %273, %block_.L_40db74 ], [ %.pre, %entry ]
...
block_.L_40db3e:                                  ; preds = %block_40db4a, %block_40db2f
  %129 = phi i64 [ %232, %block_40db4a ], [ %.pre6, %block_40db2f ]
...
block_40db4a:                                     ; preds = %block_.L_40db3e
  ...
  %call2_40db57 = tail call %struct.Memory* @sub_40f000._ZN30custom_multiple_constant_mixedIfE8do_shiftEf(%struct.State* nonnull %0, i64 %179, %struct.Memory* %call2_40db13)
...
block_.L_40db74:                                  ; preds = %block_.L_40db3e
  ...
  %call2_40db79 = tail call %struct.Memory* @sub_40f030._Z17check_shifted_sumIf30custom_multiple_constant_mixedIfEEvT_(%struct.State* nonnull %0, i64 %237, %struct.Memory* %call2_40db13)
...
block_.L_40db8c:                                  ; preds = %block_.L_40db1f
  ...
  %call2_40db8c = tail call %struct.Memory* @sub_400ea0._Z5timerv(%struct.State* nonnull %0, i64 %274, %struct.Memory* %call2_40db13)
