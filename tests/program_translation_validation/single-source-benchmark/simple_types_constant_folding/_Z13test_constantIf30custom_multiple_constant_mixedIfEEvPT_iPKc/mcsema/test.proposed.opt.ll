...
declare %struct.Memory* @sub_40eff0._Z17check_shifted_sumIf30custom_multiple_constant_mixedIfEEvT_(%struct.State* noalias dereferenceable(3376), i64, %struct.Memory* noalias readnone returned) local_unnamed_addr
...
entry:
  ...
  %call2_40dad3 = tail call %struct.Memory* @sub_400e40._Z11start_timerv(%struct.State* %0, i64 %58, %struct.Memory* %2)
  ...
  br label %block_.L_40dadf

block_.L_40dadf:                                  ; preds = %block_.L_40db34, %entry
  %84 = phi i64 [ %.pre, %entry ], [ %277, %block_.L_40db34 ]
  %MEMORY.0 = phi %struct.Memory* [ %call2_40dad3, %entry ], [ %call2_40db39, %block_.L_40db34 ]
  ...
  br i1 %117, label %block_40daef, label %block_.L_40db4c

block_40daef:                                     ; preds = %block_.L_40dadf
  ...
  br label %block_.L_40dafe

block_.L_40dafe:                                  ; preds = %block_40db0a, %block_40daef
  %129 = phi i64 [ %.pre1, %block_40daef ], [ %234, %block_40db0a ]
  %MEMORY.1 = phi %struct.Memory* [ %MEMORY.0, %block_40daef ], [ %call2_40db17, %block_40db0a ]
  ...
  br i1 %165, label %block_40db0a, label %block_.L_40db34

block_40db0a:                                     ; preds = %block_.L_40dafe
  %167 = add i64 %130, -8
  %168 = add i64 %166, 4
  ...
  %call2_40db17 = tail call %struct.Memory* @sub_40efc0._ZN30custom_multiple_constant_mixedIfE8do_shiftEf(%struct.State* %0, i64 %180, %struct.Memory* %MEMORY.1)
...
block_.L_40db34:                                  ; preds = %block_.L_40dafe
  %235 = add i64 %130, -32
  %236 = add i64 %166, 5
  ...
  %call2_40db39 = tail call %struct.Memory* @sub_40eff0._Z17check_shifted_sumIf30custom_multiple_constant_mixedIfEEvT_(%struct.State* %0, i64 %240, %struct.Memory* %MEMORY.1)
...
block_.L_40db4c:                                  ; preds = %block_.L_40dadf
  %278 = add i64 %118, -52460
  %279 = add i64 %118, 5
  ...
  %call2_40db4c = tail call %struct.Memory* @sub_400e60._Z5timerv(%struct.State* %0, i64 %278, %struct.Memory* %MEMORY.0)
  ...
  %call2_40db55 = tail call %struct.Memory* @sub_400800._Z13record_resultdPKc(%struct.State* %0, i64 %289, %struct.Memory* %call2_40db4c)
  ...
  ret %struct.Memory* %call2_40db55
}
...
define %struct.Memory* @routine_jge_.L_40db4c(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i8* %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
...
define %struct.Memory* @routine_jge_.L_40db34(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i8* %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 2, i32 9
...
define %struct.Memory* @routine_jmpq_.L_40dafe(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
...
define %struct.Memory* @routine_callq_._Z17check_shifted_sumIf30custom_multiple_constant_mixedIfEEvT_(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
...
define %struct.Memory* @routine_jmpq_.L_40dadf(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
