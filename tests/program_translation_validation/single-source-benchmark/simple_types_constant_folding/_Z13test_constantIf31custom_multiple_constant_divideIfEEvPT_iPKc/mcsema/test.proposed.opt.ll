...
block_.L_40d99f:                                  ; preds = %block_.L_40d9f4, %entry
  %83 = phi i64 [ %.pre, %entry ], [ %272, %block_.L_40d9f4 ]
  ...
  br i1 %116, label %block_40d9af, label %block_.L_40da0c
...
block_.L_40d9be:                                  ; preds = %block_40d9ca, %block_40d9af
  %128 = phi i64 [ %.pre1, %block_40d9af ], [ %231, %block_40d9ca ]
  ...
  br i1 %164, label %block_40d9ca, label %block_.L_40d9f4
...
block_40d9ca:                                     ; preds = %block_.L_40d9be
  ...
  %call2_40d9d7 = tail call %struct.Memory* @sub_40f1b0._ZN31custom_multiple_constant_divideIfE8do_shiftEf(%struct.State* %0, i64 %178, %struct.Memory* %MEMORY.1)
...
block_.L_40d9f4:                                  ; preds = %block_.L_40d9be
  ...
  %call2_40d9f9 = tail call %struct.Memory* @sub_40f1f0._Z17check_shifted_sumIf31custom_multiple_constant_divideIfEEvT_(%struct.State* %0, i64 %236, %struct.Memory* %MEMORY.1)
...
block_.L_40da0c:                                  ; preds = %block_.L_40d99f
  ...
  %call2_40da0c = tail call %struct.Memory* @sub_400e60._Z5timerv(%struct.State* %0, i64 %273, %struct.Memory* %MEMORY.0)
  ...
  %call2_40da15 = tail call %struct.Memory* @sub_400800._Z13record_resultdPKc(%struct.State* %0, i64 %284, %struct.Memory* %call2_40da0c)
