...
declare %struct.Memory* @sub_40f240._Z17check_shifted_sumIf31custom_multiple_constant_divideIfEEvT_(%struct.State* noalias dereferenceable(3376), i64, %struct.Memory* noalias readnone returned) local_unnamed_addr
...
entry:
  ...
  %call2_40d9e3 = tail call %struct.Memory* @sub_400e90._Z11start_timerv(%struct.State* %0, i64 %58, %struct.Memory* %2)
...
block_.L_40d9ef:                                  ; preds = %block_.L_40da44, %entry
  %84 = phi i64 [ %273, %block_.L_40da44 ], [ %.pre, %entry ]
  ...
  br i1 %117, label %block_40d9ff, label %block_.L_40da5c
...
block_.L_40da0e:                                  ; preds = %block_40da1a, %block_40d9ff
  %129 = phi i64 [ %232, %block_40da1a ], [ %.pre6, %block_40d9ff ]
  ...
  br i1 %165, label %block_40da1a, label %block_.L_40da44
...
block_40da1a:                                     ; preds = %block_.L_40da0e
  ...
  %call2_40da27 = tail call %struct.Memory* @sub_40f200._ZN31custom_multiple_constant_divideIfE8do_shiftEf(%struct.State* nonnull %0, i64 %179, %struct.Memory* %call2_40d9e3)
...
block_.L_40da44:                                  ; preds = %block_.L_40da0e
  ...
  %call2_40da49 = tail call %struct.Memory* @sub_40f240._Z17check_shifted_sumIf31custom_multiple_constant_divideIfEEvT_(%struct.State* nonnull %0, i64 %237, %struct.Memory* %call2_40d9e3)
...
block_.L_40da5c:                                  ; preds = %block_.L_40d9ef
  ...
  %call2_40da5c = tail call %struct.Memory* @sub_400eb0._Z5timerv(%struct.State* nonnull %0, i64 %274, %struct.Memory* %call2_40d9e3)
  ...
  %call2_40da65 = tail call %struct.Memory* @sub_400850._Z13record_resultdPKc(%struct.State* nonnull %0, i64 %285, %struct.Memory* %call2_40da5c)
