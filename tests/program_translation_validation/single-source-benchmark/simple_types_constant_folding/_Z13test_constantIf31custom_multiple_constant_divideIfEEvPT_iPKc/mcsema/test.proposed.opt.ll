...
declare %struct.Memory* @sub_40f230._Z17check_shifted_sumIf31custom_multiple_constant_divideIfEEvT_(%struct.State* dereferenceable(3376), i64, %struct.Memory*) local_unnamed_addr
...
block_.L_40d9df:                                  ; preds = %block_.L_40da34, %entry
  %84 = phi i64 [ %.pre, %entry ], [ %273, %block_.L_40da34 ]
  %MEMORY.0 = phi %struct.Memory* [ %call2_40d9d3, %entry ], [ %call2_40da39, %block_.L_40da34 ]
...
block_.L_40d9fe:                                  ; preds = %block_40da0a, %block_40d9ef
  %129 = phi i64 [ %.pre6, %block_40d9ef ], [ %232, %block_40da0a ]
  %MEMORY.1 = phi %struct.Memory* [ %MEMORY.0, %block_40d9ef ], [ %call2_40da17, %block_40da0a ]
...
block_40da0a:                                     ; preds = %block_.L_40d9fe
  ...
  %call2_40da17 = tail call %struct.Memory* @sub_40f1f0._ZN31custom_multiple_constant_divideIfE8do_shiftEf(%struct.State* nonnull %0, i64 %179, %struct.Memory* %MEMORY.1)
...
block_.L_40da34:                                  ; preds = %block_.L_40d9fe
  ...
  %call2_40da39 = tail call %struct.Memory* @sub_40f230._Z17check_shifted_sumIf31custom_multiple_constant_divideIfEEvT_(%struct.State* nonnull %0, i64 %237, %struct.Memory* %MEMORY.1)
...
block_.L_40da4c:                                  ; preds = %block_.L_40d9df
  ...
  %call2_40da4c = tail call %struct.Memory* @sub_400ea0._Z5timerv(%struct.State* nonnull %0, i64 %274, %struct.Memory* %MEMORY.0)
