...
declare %struct.Memory* @sub_40f1f0._Z17check_shifted_sumIf31custom_multiple_constant_divideIfEEvT_(%struct.State* noalias dereferenceable(3376), i64, %struct.Memory* noalias readnone returned) local_unnamed_addr
...
define %struct.Memory* @_Z13test_constantIf31custom_multiple_constant_divideIfEEvPT_iPKc(%struct.State* noalias, i64, %struct.Memory* noalias) local_unnamed_addr #1 {
entry:
  ...
  %call2_40d993 = tail call %struct.Memory* @sub_400e40._Z11start_timerv(%struct.State* %0, i64 %58, %struct.Memory* %2)
...
block_.L_40d99f:                                  ; preds = %block_.L_40d9f4, %entry
  %84 = phi i64 [ %.pre, %entry ], [ %277, %block_.L_40d9f4 ]
  %MEMORY.0 = phi %struct.Memory* [ %call2_40d993, %entry ], [ %call2_40d9f9, %block_.L_40d9f4 ]
  ...
  br i1 %117, label %block_40d9af, label %block_.L_40da0c
...
block_.L_40d9be:                                  ; preds = %block_40d9ca, %block_40d9af
  %129 = phi i64 [ %.pre1, %block_40d9af ], [ %234, %block_40d9ca ]
  %MEMORY.1 = phi %struct.Memory* [ %MEMORY.0, %block_40d9af ], [ %call2_40d9d7, %block_40d9ca ]
  ...
  br i1 %165, label %block_40d9ca, label %block_.L_40d9f4
...
block_40d9ca:                                     ; preds = %block_.L_40d9be
  ...
  %call2_40d9d7 = tail call %struct.Memory* @sub_40f1b0._ZN31custom_multiple_constant_divideIfE8do_shiftEf(%struct.State* %0, i64 %180, %struct.Memory* %MEMORY.1)
...
block_.L_40d9f4:                                  ; preds = %block_.L_40d9be
  ...
  %call2_40d9f9 = tail call %struct.Memory* @sub_40f1f0._Z17check_shifted_sumIf31custom_multiple_constant_divideIfEEvT_(%struct.State* %0, i64 %240, %struct.Memory* %MEMORY.1)
...
block_.L_40da0c:                                  ; preds = %block_.L_40d99f
  ...
  %call2_40da0c = tail call %struct.Memory* @sub_400e60._Z5timerv(%struct.State* %0, i64 %278, %struct.Memory* %MEMORY.0)
  ...
  %call2_40da15 = tail call %struct.Memory* @sub_400800._Z13record_resultdPKc(%struct.State* %0, i64 %289, %struct.Memory* %call2_40da0c)
  ...
  ret %struct.Memory* %call2_40da15
}
...
define %struct.Memory* @routine_jge_.L_40da0c(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i8* %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
...
define %struct.Memory* @routine_jge_.L_40d9f4(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i8* %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 2, i32 9
...
define %struct.Memory* @routine_jmpq_.L_40d9be(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
...
define %struct.Memory* @routine_callq_._Z17check_shifted_sumIf31custom_multiple_constant_divideIfEEvT_(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
...
define %struct.Memory* @routine_jmpq_.L_40d99f(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
