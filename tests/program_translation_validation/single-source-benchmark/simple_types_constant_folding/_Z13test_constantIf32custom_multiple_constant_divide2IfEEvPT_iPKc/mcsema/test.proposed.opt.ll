...
declare %struct.Memory* @sub_40f180._Z17check_shifted_sumIf32custom_multiple_constant_divide2IfEEvT_(%struct.State* noalias dereferenceable(3376), i64, %struct.Memory* noalias readnone returned) local_unnamed_addr
...
define %struct.Memory* @_Z13test_constantIf32custom_multiple_constant_divide2IfEEvPT_iPKc(%struct.State* noalias, i64, %struct.Memory* noalias readnone) local_unnamed_addr #1 {
entry:
...
block_.L_40da7f:                                  ; preds = %block_.L_40dad4, %entry
  %84 = phi i64 [ %273, %block_.L_40dad4 ], [ %.pre, %entry ]
...
block_.L_40da9e:                                  ; preds = %block_40daaa, %block_40da8f
  %129 = phi i64 [ %232, %block_40daaa ], [ %.pre6, %block_40da8f ]
...
block_40daaa:                                     ; preds = %block_.L_40da9e
  ...
  %call2_40dab7 = tail call %struct.Memory* @sub_40f160._ZN32custom_multiple_constant_divide2IfE8do_shiftEf(%struct.State* nonnull %0, i64 %179, %struct.Memory* %call2_40da73)
...
block_.L_40dad4:                                  ; preds = %block_.L_40da9e
  ...
  %call2_40dad9 = tail call %struct.Memory* @sub_40f180._Z17check_shifted_sumIf32custom_multiple_constant_divide2IfEEvT_(%struct.State* nonnull %0, i64 %237, %struct.Memory* %call2_40da73)
...
block_.L_40daec:                                  ; preds = %block_.L_40da7f
  ...
  %call2_40daec = tail call %struct.Memory* @sub_400ea0._Z5timerv(%struct.State* nonnull %0, i64 %274, %struct.Memory* %call2_40da73)
