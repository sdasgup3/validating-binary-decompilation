...
declare %struct.Memory* @sub_40f140._Z17check_shifted_sumIf32custom_multiple_constant_divide2IfEEvT_(%struct.State* noalias dereferenceable(3376), i64, %struct.Memory* noalias readnone returned) local_unnamed_addr
...
define %struct.Memory* @_Z13test_constantIf32custom_multiple_constant_divide2IfEEvPT_iPKc(%struct.State* noalias, i64, %struct.Memory* noalias) local_unnamed_addr #1 {
entry:
  ...
  %call2_40da33 = tail call %struct.Memory* @sub_400e40._Z11start_timerv(%struct.State* %0, i64 %58, %struct.Memory* %2)
...
block_.L_40da3f:                                  ; preds = %block_.L_40da94, %entry
  %84 = phi i64 [ %.pre, %entry ], [ %277, %block_.L_40da94 ]
  %MEMORY.0 = phi %struct.Memory* [ %call2_40da33, %entry ], [ %call2_40da99, %block_.L_40da94 ]
  ...
  br i1 %117, label %block_40da4f, label %block_.L_40daac

block_40da4f:                                     ; preds = %block_.L_40da3f
...
block_.L_40da5e:                                  ; preds = %block_40da6a, %block_40da4f
  %129 = phi i64 [ %.pre1, %block_40da4f ], [ %234, %block_40da6a ]
  %MEMORY.1 = phi %struct.Memory* [ %MEMORY.0, %block_40da4f ], [ %call2_40da77, %block_40da6a ]
  ...
  br i1 %165, label %block_40da6a, label %block_.L_40da94

block_40da6a:                                     ; preds = %block_.L_40da5e
  %167 = add i64 %130, -8
  %168 = add i64 %166, 4
  ...
  %call2_40da77 = tail call %struct.Memory* @sub_40f120._ZN32custom_multiple_constant_divide2IfE8do_shiftEf(%struct.State* %0, i64 %180, %struct.Memory* %MEMORY.1)
...
block_.L_40da94:                                  ; preds = %block_.L_40da5e
  %235 = add i64 %130, -32
  %236 = add i64 %166, 5
  ...
  %call2_40da99 = tail call %struct.Memory* @sub_40f140._Z17check_shifted_sumIf32custom_multiple_constant_divide2IfEEvT_(%struct.State* %0, i64 %240, %struct.Memory* %MEMORY.1)
...
block_.L_40daac:                                  ; preds = %block_.L_40da3f
  %278 = add i64 %118, -52300
  %279 = add i64 %118, 5
  ...
  %call2_40daac = tail call %struct.Memory* @sub_400e60._Z5timerv(%struct.State* %0, i64 %278, %struct.Memory* %MEMORY.0)
  ...
  %call2_40dab5 = tail call %struct.Memory* @sub_400800._Z13record_resultdPKc(%struct.State* %0, i64 %289, %struct.Memory* %call2_40daac)
  ...
  ret %struct.Memory* %call2_40dab5
}
...
define %struct.Memory* @routine_jge_.L_40daac(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i8* %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
...
define %struct.Memory* @routine_jge_.L_40da94(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i8* %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 2, i32 9
...
define %struct.Memory* @routine_jmpq_.L_40da5e(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
...
define %struct.Memory* @routine_callq_._Z17check_shifted_sumIf32custom_multiple_constant_divide2IfEEvT_(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
...
define %struct.Memory* @routine_jmpq_.L_40da3f(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
