...
block_.L_40da3f:                                  ; preds = %block_.L_40da94, %entry
  %83 = phi i64 [ %.pre, %entry ], [ %272, %block_.L_40da94 ]
  ...
  br i1 %116, label %block_40da4f, label %block_.L_40daac
...
block_.L_40da5e:                                  ; preds = %block_40da6a, %block_40da4f
  %128 = phi i64 [ %.pre1, %block_40da4f ], [ %231, %block_40da6a ]
  ...
  br i1 %164, label %block_40da6a, label %block_.L_40da94
...
block_40da6a:                                     ; preds = %block_.L_40da5e
  ...
  %call2_40da77 = tail call %struct.Memory* @sub_40f120._ZN32custom_multiple_constant_divide2IfE8do_shiftEf(%struct.State* %0, i64 %178, %struct.Memory* %MEMORY.1)
...
block_.L_40da94:                                  ; preds = %block_.L_40da5e
  ...
  %call2_40da99 = tail call %struct.Memory* @sub_40f140._Z17check_shifted_sumIf32custom_multiple_constant_divide2IfEEvT_(%struct.State* %0, i64 %236, %struct.Memory* %MEMORY.1)
...
block_.L_40daac:                                  ; preds = %block_.L_40da3f
  ...
  %call2_40daac = tail call %struct.Memory* @sub_400e60._Z5timerv(%struct.State* %0, i64 %273, %struct.Memory* %MEMORY.0)
  ...
  %call2_40dab5 = tail call %struct.Memory* @sub_400800._Z13record_resultdPKc(%struct.State* %0, i64 %284, %struct.Memory* %call2_40daac)
