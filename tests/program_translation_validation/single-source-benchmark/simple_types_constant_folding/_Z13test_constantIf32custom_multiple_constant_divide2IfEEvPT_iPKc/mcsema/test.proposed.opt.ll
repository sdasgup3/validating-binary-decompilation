...
declare %struct.Memory* @sub_40f190._Z17check_shifted_sumIf32custom_multiple_constant_divide2IfEEvT_(%struct.State* noalias dereferenceable(3376), i64, %struct.Memory* noalias readnone returned) local_unnamed_addr
...
entry:
  ...
  %call2_40da83 = tail call %struct.Memory* @sub_400e90._Z11start_timerv(%struct.State* %0, i64 %58, %struct.Memory* %2)
...
block_.L_40da8f:                                  ; preds = %block_.L_40dae4, %entry
  %84 = phi i64 [ %273, %block_.L_40dae4 ], [ %.pre, %entry ]
  ...
  br i1 %117, label %block_40da9f, label %block_.L_40dafc

block_40da9f:                                     ; preds = %block_.L_40da8f
...
block_.L_40daae:                                  ; preds = %block_40daba, %block_40da9f
  %129 = phi i64 [ %232, %block_40daba ], [ %.pre6, %block_40da9f ]
  ...
  br i1 %165, label %block_40daba, label %block_.L_40dae4

block_40daba:                                     ; preds = %block_.L_40daae
  %167 = add i64 %130, -8
  %168 = add i64 %166, 4
  ...
  %call2_40dac7 = tail call %struct.Memory* @sub_40f170._ZN32custom_multiple_constant_divide2IfE8do_shiftEf(%struct.State* nonnull %0, i64 %179, %struct.Memory* %call2_40da83)
...
block_.L_40dae4:                                  ; preds = %block_.L_40daae
  ...
  %call2_40dae9 = tail call %struct.Memory* @sub_40f190._Z17check_shifted_sumIf32custom_multiple_constant_divide2IfEEvT_(%struct.State* nonnull %0, i64 %237, %struct.Memory* %call2_40da83)
...
block_.L_40dafc:                                  ; preds = %block_.L_40da8f
  ...
  %call2_40dafc = tail call %struct.Memory* @sub_400eb0._Z5timerv(%struct.State* nonnull %0, i64 %274, %struct.Memory* %call2_40da83)
  ...
  %call2_40db05 = tail call %struct.Memory* @sub_400850._Z13record_resultdPKc(%struct.State* nonnull %0, i64 %285, %struct.Memory* %call2_40dafc)
