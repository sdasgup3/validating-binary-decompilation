...
declare %struct.Memory* @sub_40f400._Z17check_shifted_sumIf33custom_multiple_constant_multiplyIfEEvT_(%struct.State* dereferenceable(3376), i64, %struct.Memory*)
...
define %struct.Memory* @_Z13test_constantIf33custom_multiple_constant_multiplyIfEEvPT_iPKc(%struct.State* noalias, i64, %struct.Memory* noalias) #1 {
entry:
