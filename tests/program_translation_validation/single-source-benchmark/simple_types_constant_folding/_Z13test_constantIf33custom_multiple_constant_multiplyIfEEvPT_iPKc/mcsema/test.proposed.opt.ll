...
block_.L_40d7bf:                                  ; preds = %block_.L_40d814, %entry
  %83 = phi i64 [ %.pre, %entry ], [ %272, %block_.L_40d814 ]
  ...
  br i1 %116, label %block_40d7cf, label %block_.L_40d82c
...
block_.L_40d7de:                                  ; preds = %block_40d7ea, %block_40d7cf
  %128 = phi i64 [ %.pre1, %block_40d7cf ], [ %231, %block_40d7ea ]
  ...
  br i1 %164, label %block_40d7ea, label %block_.L_40d814
...
block_40d7ea:                                     ; preds = %block_.L_40d7de
  ...
  %call2_40d7f7 = tail call %struct.Memory* @sub_40f380._ZN33custom_multiple_constant_multiplyIfE8do_shiftEf(%struct.State* %0, i64 %178, %struct.Memory* %MEMORY.1)
...
block_.L_40d814:                                  ; preds = %block_.L_40d7de
  ...
  %call2_40d819 = tail call %struct.Memory* @sub_40f3c0._Z17check_shifted_sumIf33custom_multiple_constant_multiplyIfEEvT_(%struct.State* %0, i64 %236, %struct.Memory* %MEMORY.1)
...
block_.L_40d82c:                                  ; preds = %block_.L_40d7bf
  ...
  %call2_40d82c = tail call %struct.Memory* @sub_400e60._Z5timerv(%struct.State* %0, i64 %273, %struct.Memory* %MEMORY.0)
  ...
  %call2_40d835 = tail call %struct.Memory* @sub_400800._Z13record_resultdPKc(%struct.State* %0, i64 %284, %struct.Memory* %call2_40d82c)
