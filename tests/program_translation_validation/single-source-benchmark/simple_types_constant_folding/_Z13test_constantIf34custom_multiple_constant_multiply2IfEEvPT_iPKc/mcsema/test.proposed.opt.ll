...
declare %struct.Memory* @sub_40f360._Z17check_shifted_sumIf34custom_multiple_constant_multiply2IfEEvT_(%struct.State* noalias dereferenceable(3376), i64, %struct.Memory* noalias readnone returned) local_unnamed_addr
...
entry:
  ...
  %call2_40d8a3 = tail call %struct.Memory* @sub_400e90._Z11start_timerv(%struct.State* %0, i64 %58, %struct.Memory* %2)
...
block_.L_40d8af:                                  ; preds = %block_.L_40d904, %entry
  %84 = phi i64 [ %273, %block_.L_40d904 ], [ %.pre, %entry ]
  ...
  br i1 %117, label %block_40d8bf, label %block_.L_40d91c
...
block_.L_40d8ce:                                  ; preds = %block_40d8da, %block_40d8bf
  %129 = phi i64 [ %232, %block_40d8da ], [ %.pre6, %block_40d8bf ]
  ...
  br i1 %165, label %block_40d8da, label %block_.L_40d904
...
block_40d8da:                                     ; preds = %block_.L_40d8ce
  ...
  %call2_40d8e7 = tail call %struct.Memory* @sub_40f340._ZN34custom_multiple_constant_multiply2IfE8do_shiftEf(%struct.State* nonnull %0, i64 %179, %struct.Memory* %call2_40d8a3)
...
block_.L_40d904:                                  ; preds = %block_.L_40d8ce
  ...
  %call2_40d909 = tail call %struct.Memory* @sub_40f360._Z17check_shifted_sumIf34custom_multiple_constant_multiply2IfEEvT_(%struct.State* nonnull %0, i64 %237, %struct.Memory* %call2_40d8a3)
...
block_.L_40d91c:                                  ; preds = %block_.L_40d8af
  ...
  %call2_40d91c = tail call %struct.Memory* @sub_400eb0._Z5timerv(%struct.State* nonnull %0, i64 %274, %struct.Memory* %call2_40d8a3)
  ...
  %call2_40d925 = tail call %struct.Memory* @sub_400850._Z13record_resultdPKc(%struct.State* nonnull %0, i64 %285, %struct.Memory* %call2_40d91c)
