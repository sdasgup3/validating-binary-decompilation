...
declare %struct.Memory* @sub_40f350._Z17check_shifted_sumIf34custom_multiple_constant_multiply2IfEEvT_(%struct.State* noalias dereferenceable(3376), i64, %struct.Memory* noalias readnone returned) local_unnamed_addr
...
define %struct.Memory* @_Z13test_constantIf34custom_multiple_constant_multiply2IfEEvPT_iPKc(%struct.State* noalias, i64, %struct.Memory* noalias readnone) local_unnamed_addr #1 {
entry:
...
block_.L_40d89f:                                  ; preds = %block_.L_40d8f4, %entry
  %84 = phi i64 [ %273, %block_.L_40d8f4 ], [ %.pre, %entry ]
...
block_.L_40d8be:                                  ; preds = %block_40d8ca, %block_40d8af
  %129 = phi i64 [ %232, %block_40d8ca ], [ %.pre6, %block_40d8af ]
...
block_40d8ca:                                     ; preds = %block_.L_40d8be
  ...
  %call2_40d8d7 = tail call %struct.Memory* @sub_40f330._ZN34custom_multiple_constant_multiply2IfE8do_shiftEf(%struct.State* nonnull %0, i64 %179, %struct.Memory* %call2_40d893)
...
block_.L_40d8f4:                                  ; preds = %block_.L_40d8be
  ...
  %call2_40d8f9 = tail call %struct.Memory* @sub_40f350._Z17check_shifted_sumIf34custom_multiple_constant_multiply2IfEEvT_(%struct.State* nonnull %0, i64 %237, %struct.Memory* %call2_40d893)
...
block_.L_40d90c:                                  ; preds = %block_.L_40d89f
  ...
  %call2_40d90c = tail call %struct.Memory* @sub_400ea0._Z5timerv(%struct.State* nonnull %0, i64 %274, %struct.Memory* %call2_40d893)
