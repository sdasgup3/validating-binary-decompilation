...
block_.L_40d85f:                                  ; preds = %block_.L_40d8b4, %entry
  %83 = phi i64 [ %.pre, %entry ], [ %272, %block_.L_40d8b4 ]
  ...
  br i1 %116, label %block_40d86f, label %block_.L_40d8cc
...
block_.L_40d87e:                                  ; preds = %block_40d88a, %block_40d86f
  %128 = phi i64 [ %.pre1, %block_40d86f ], [ %231, %block_40d88a ]
  ...
  br i1 %164, label %block_40d88a, label %block_.L_40d8b4
...
block_40d88a:                                     ; preds = %block_.L_40d87e
  ...
  %call2_40d897 = tail call %struct.Memory* @sub_40f2f0._ZN34custom_multiple_constant_multiply2IfE8do_shiftEf(%struct.State* %0, i64 %178, %struct.Memory* %MEMORY.1)
...
block_.L_40d8b4:                                  ; preds = %block_.L_40d87e
  ...
  %call2_40d8b9 = tail call %struct.Memory* @sub_40f310._Z17check_shifted_sumIf34custom_multiple_constant_multiply2IfEEvT_(%struct.State* %0, i64 %236, %struct.Memory* %MEMORY.1)
...
block_.L_40d8cc:                                  ; preds = %block_.L_40d85f
  ...
  %call2_40d8cc = tail call %struct.Memory* @sub_400e60._Z5timerv(%struct.State* %0, i64 %273, %struct.Memory* %MEMORY.0)
  ...
  %call2_40d8d5 = tail call %struct.Memory* @sub_400800._Z13record_resultdPKc(%struct.State* %0, i64 %284, %struct.Memory* %call2_40d8cc)
