...
block_.L_403fbf:                                  ; preds = %block_.L_404013, %entry
  %69 = phi i64 [ %.pre, %entry ], [ %269, %block_.L_404013 ]
...
block_.L_403fda:                                  ; preds = %block_403fe6, %block_403fcf
  %112 = phi i64 [ %.pre1, %block_403fcf ], [ %226, %block_403fe6 ]
...
block_.L_404013:                                  ; preds = %block_.L_403fda
  ...
  %call2_404017 = tail call %struct.Memory* @sub_417610._Z17check_shifted_sumIh10custom_twoIhEEvT_(%struct.State* %0, i64 %232, %struct.Memory* %MEMORY.1)
...
block_.L_40402a:                                  ; preds = %block_.L_403fbf
  ...
  %call2_40402a = tail call %struct.Memory* @sub_400e60._Z5timerv(%struct.State* %0, i64 %270, %struct.Memory* %MEMORY.0)
  ...
  %call2_404033 = tail call %struct.Memory* @sub_400800._Z13record_resultdPKc(%struct.State* %0, i64 %281, %struct.Memory* %call2_40402a)
