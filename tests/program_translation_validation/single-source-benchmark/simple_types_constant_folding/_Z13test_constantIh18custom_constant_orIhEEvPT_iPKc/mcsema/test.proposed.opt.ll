...
block_.L_40513f:                                  ; preds = %block_.L_405193, %entry
  %69 = phi i64 [ %.pre, %entry ], [ %269, %block_.L_405193 ]
...
block_.L_40515a:                                  ; preds = %block_405166, %block_40514f
  %112 = phi i64 [ %.pre1, %block_40514f ], [ %226, %block_405166 ]
...
block_.L_405193:                                  ; preds = %block_.L_40515a
  ...
  %call2_405197 = tail call %struct.Memory* @sub_4165f0._Z17check_shifted_sumIh18custom_constant_orIhEEvT_(%struct.State* %0, i64 %232, %struct.Memory* %MEMORY.1)
...
block_.L_4051aa:                                  ; preds = %block_.L_40513f
  ...
  %call2_4051aa = tail call %struct.Memory* @sub_400e60._Z5timerv(%struct.State* %0, i64 %270, %struct.Memory* %MEMORY.0)
  ...
  %call2_4051b3 = tail call %struct.Memory* @sub_400800._Z13record_resultdPKc(%struct.State* %0, i64 %281, %struct.Memory* %call2_4051aa)
