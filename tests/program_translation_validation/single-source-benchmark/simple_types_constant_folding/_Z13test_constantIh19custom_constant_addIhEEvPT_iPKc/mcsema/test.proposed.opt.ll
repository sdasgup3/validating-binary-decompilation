...
block_.L_40491f:                                  ; preds = %block_.L_404973, %entry
  %69 = phi i64 [ %.pre, %entry ], [ %267, %block_.L_404973 ]
...
block_.L_40493a:                                  ; preds = %block_404946, %block_40492f
  %112 = phi i64 [ %.pre1, %block_40492f ], [ %225, %block_404946 ]
...
block_.L_404973:                                  ; preds = %block_.L_40493a
  ...
  %call2_404977 = tail call %struct.Memory* @sub_416da0._Z17check_shifted_sumIh19custom_constant_addIhEEvT_(%struct.State* %0, i64 %231, %struct.Memory* %MEMORY.1)
...
block_.L_40498a:                                  ; preds = %block_.L_40491f
  ...
  %call2_40498a = tail call %struct.Memory* @sub_400e60._Z5timerv(%struct.State* %0, i64 %268, %struct.Memory* %MEMORY.0)
  ...
  %call2_404993 = tail call %struct.Memory* @sub_400800._Z13record_resultdPKc(%struct.State* %0, i64 %279, %struct.Memory* %call2_40498a)
