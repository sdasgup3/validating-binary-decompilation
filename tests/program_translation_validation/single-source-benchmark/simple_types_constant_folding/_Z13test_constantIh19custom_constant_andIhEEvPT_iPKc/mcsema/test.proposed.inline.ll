...
declare %struct.Memory* @sub_416760._Z17check_shifted_sumIh19custom_constant_andIhEEvT_(%struct.State* dereferenceable(3376), i64, %struct.Memory*)
...
define %struct.Memory* @_Z13test_constantIh19custom_constant_andIhEEvPT_iPKc(%struct.State* noalias, i64, %struct.Memory* noalias) #1 {
entry:
