...
block_.L_404fff:                                  ; preds = %block_.L_405053, %entry
  %69 = phi i64 [ %.pre, %entry ], [ %269, %block_.L_405053 ]
...
block_.L_40501a:                                  ; preds = %block_405026, %block_40500f
  %112 = phi i64 [ %.pre1, %block_40500f ], [ %226, %block_405026 ]
...
block_.L_405053:                                  ; preds = %block_.L_40501a
  ...
  %call2_405057 = tail call %struct.Memory* @sub_416720._Z17check_shifted_sumIh19custom_constant_andIhEEvT_(%struct.State* %0, i64 %232, %struct.Memory* %MEMORY.1)
...
block_.L_40506a:                                  ; preds = %block_.L_404fff
  ...
  %call2_40506a = tail call %struct.Memory* @sub_400e60._Z5timerv(%struct.State* %0, i64 %270, %struct.Memory* %MEMORY.0)
  ...
  %call2_405073 = tail call %struct.Memory* @sub_400800._Z13record_resultdPKc(%struct.State* %0, i64 %281, %struct.Memory* %call2_40506a)
