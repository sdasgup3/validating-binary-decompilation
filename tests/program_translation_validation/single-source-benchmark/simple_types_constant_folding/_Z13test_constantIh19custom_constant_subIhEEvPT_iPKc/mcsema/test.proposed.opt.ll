...
block_.L_404a5f:                                  ; preds = %block_.L_404ab3, %entry
  %69 = phi i64 [ %.pre, %entry ], [ %269, %block_.L_404ab3 ]
...
block_.L_404a7a:                                  ; preds = %block_404a86, %block_404a6f
  %112 = phi i64 [ %.pre1, %block_404a6f ], [ %226, %block_404a86 ]
...
block_.L_404ab3:                                  ; preds = %block_.L_404a7a
  ...
  %call2_404ab7 = tail call %struct.Memory* @sub_416c70._Z17check_shifted_sumIh19custom_constant_subIhEEvT_(%struct.State* %0, i64 %232, %struct.Memory* %MEMORY.1)
...
block_.L_404aca:                                  ; preds = %block_.L_404a5f
  ...
  %call2_404aca = tail call %struct.Memory* @sub_400e60._Z5timerv(%struct.State* %0, i64 %270, %struct.Memory* %MEMORY.0)
  ...
  %call2_404ad3 = tail call %struct.Memory* @sub_400800._Z13record_resultdPKc(%struct.State* %0, i64 %281, %struct.Memory* %call2_404aca)
