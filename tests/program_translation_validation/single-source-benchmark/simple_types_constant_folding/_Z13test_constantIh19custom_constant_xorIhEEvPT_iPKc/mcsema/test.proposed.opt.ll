...
block_.L_40527f:                                  ; preds = %block_.L_4052d3, %entry
  %69 = phi i64 [ %.pre, %entry ], [ %269, %block_.L_4052d3 ]
...
block_.L_40529a:                                  ; preds = %block_4052a6, %block_40528f
  %112 = phi i64 [ %.pre1, %block_40528f ], [ %226, %block_4052a6 ]
...
block_.L_4052d3:                                  ; preds = %block_.L_40529a
  ...
  %call2_4052d7 = tail call %struct.Memory* @sub_4164c0._Z17check_shifted_sumIh19custom_constant_xorIhEEvT_(%struct.State* %0, i64 %232, %struct.Memory* %MEMORY.1)
...
block_.L_4052ea:                                  ; preds = %block_.L_40527f
  ...
  %call2_4052ea = tail call %struct.Memory* @sub_400e60._Z5timerv(%struct.State* %0, i64 %270, %struct.Memory* %MEMORY.0)
  ...
  %call2_4052f3 = tail call %struct.Memory* @sub_400800._Z13record_resultdPKc(%struct.State* %0, i64 %281, %struct.Memory* %call2_4052ea)
