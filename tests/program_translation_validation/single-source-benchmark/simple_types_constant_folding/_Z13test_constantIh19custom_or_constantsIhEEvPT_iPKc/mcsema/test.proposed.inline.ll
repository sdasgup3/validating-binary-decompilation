...
declare %struct.Memory* @sub_416ee0._ZN19custom_or_constantsIhE8do_shiftEh(%struct.State* dereferenceable(3376), i64, %struct.Memory*)

declare %struct.Memory* @sub_416f00._Z17check_shifted_sumIh19custom_or_constantsIhEEvT_(%struct.State* dereferenceable(3376), i64, %struct.Memory*)
...
define %struct.Memory* @_Z13test_constantIh19custom_or_constantsIhEEvPT_iPKc(%struct.State* noalias, i64, %struct.Memory* noalias) #1 {
entry:
