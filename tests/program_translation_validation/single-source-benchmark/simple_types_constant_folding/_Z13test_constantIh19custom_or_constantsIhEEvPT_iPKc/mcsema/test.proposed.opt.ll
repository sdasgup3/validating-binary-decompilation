...
block_.L_4047df:                                  ; preds = %block_.L_404833, %entry
  %69 = phi i64 [ %.pre, %entry ], [ %269, %block_.L_404833 ]
...
block_.L_4047fa:                                  ; preds = %block_404806, %block_4047ef
  %112 = phi i64 [ %.pre1, %block_4047ef ], [ %226, %block_404806 ]
...
block_.L_404833:                                  ; preds = %block_.L_4047fa
  ...
  %call2_404837 = tail call %struct.Memory* @sub_416ec0._Z17check_shifted_sumIh19custom_or_constantsIhEEvT_(%struct.State* %0, i64 %232, %struct.Memory* %MEMORY.1)
...
block_.L_40484a:                                  ; preds = %block_.L_4047df
  ...
  %call2_40484a = tail call %struct.Memory* @sub_400e60._Z5timerv(%struct.State* %0, i64 %270, %struct.Memory* %MEMORY.0)
  ...
  %call2_404853 = tail call %struct.Memory* @sub_400800._Z13record_resultdPKc(%struct.State* %0, i64 %281, %struct.Memory* %call2_40484a)
