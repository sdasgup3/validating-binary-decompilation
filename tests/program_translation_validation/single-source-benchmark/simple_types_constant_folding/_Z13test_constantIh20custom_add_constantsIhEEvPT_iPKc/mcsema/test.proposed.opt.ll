...
block_.L_40405f:                                  ; preds = %block_.L_4040b3, %entry
  %69 = phi i64 [ %.pre, %entry ], [ %269, %block_.L_4040b3 ]
...
block_.L_40407a:                                  ; preds = %block_404086, %block_40406f
  %112 = phi i64 [ %.pre1, %block_40406f ], [ %226, %block_404086 ]
...
block_.L_4040b3:                                  ; preds = %block_.L_40407a
  ...
  %call2_4040b7 = tail call %struct.Memory* @sub_417580._Z17check_shifted_sumIh20custom_add_constantsIhEEvT_(%struct.State* %0, i64 %232, %struct.Memory* %MEMORY.1)
...
block_.L_4040ca:                                  ; preds = %block_.L_40405f
  ...
  %call2_4040ca = tail call %struct.Memory* @sub_400e60._Z5timerv(%struct.State* %0, i64 %270, %struct.Memory* %MEMORY.0)
  ...
  %call2_4040d3 = tail call %struct.Memory* @sub_400800._Z13record_resultdPKc(%struct.State* %0, i64 %281, %struct.Memory* %call2_4040ca)
