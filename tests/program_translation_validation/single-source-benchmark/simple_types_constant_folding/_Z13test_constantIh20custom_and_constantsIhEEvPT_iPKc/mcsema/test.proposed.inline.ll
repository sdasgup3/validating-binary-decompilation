...
declare %struct.Memory* @sub_416f90._Z17check_shifted_sumIh20custom_and_constantsIhEEvT_(%struct.State* dereferenceable(3376), i64, %struct.Memory*)
...
define %struct.Memory* @_Z13test_constantIh20custom_and_constantsIhEEvPT_iPKc(%struct.State* noalias, i64, %struct.Memory* noalias) #1 {
entry:
