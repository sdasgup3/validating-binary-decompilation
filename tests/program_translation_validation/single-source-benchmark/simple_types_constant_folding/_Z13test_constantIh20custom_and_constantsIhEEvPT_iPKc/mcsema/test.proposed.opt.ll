...
block_.L_40473f:                                  ; preds = %block_.L_404793, %entry
  %69 = phi i64 [ %.pre, %entry ], [ %267, %block_.L_404793 ]
...
block_.L_40475a:                                  ; preds = %block_404766, %block_40474f
  %112 = phi i64 [ %.pre1, %block_40474f ], [ %225, %block_404766 ]
...
block_.L_404793:                                  ; preds = %block_.L_40475a
  ...
  %call2_404797 = tail call %struct.Memory* @sub_416f50._Z17check_shifted_sumIh20custom_and_constantsIhEEvT_(%struct.State* %0, i64 %231, %struct.Memory* %MEMORY.1)
...
block_.L_4047aa:                                  ; preds = %block_.L_40473f
  ...
  %call2_4047aa = tail call %struct.Memory* @sub_400e60._Z5timerv(%struct.State* %0, i64 %268, %struct.Memory* %MEMORY.0)
  ...
  %call2_4047b3 = tail call %struct.Memory* @sub_400800._Z13record_resultdPKc(%struct.State* %0, i64 %279, %struct.Memory* %call2_4047aa)
