...
declare %struct.Memory* @sub_417360._ZN20custom_mod_constantsIhE8do_shiftEh(%struct.State* dereferenceable(3376), i64, %struct.Memory*)

declare %struct.Memory* @sub_417380._Z17check_shifted_sumIh20custom_mod_constantsIhEEvT_(%struct.State* dereferenceable(3376), i64, %struct.Memory*)
...
define %struct.Memory* @_Z13test_constantIh20custom_mod_constantsIhEEvPT_iPKc(%struct.State* noalias, i64, %struct.Memory* noalias) #1 {
entry:
