...
block_.L_4042df:                                  ; preds = %block_.L_404333, %entry
  %69 = phi i64 [ %.pre, %entry ], [ %267, %block_.L_404333 ]
...
block_.L_4042fa:                                  ; preds = %block_404306, %block_4042ef
  %112 = phi i64 [ %.pre1, %block_4042ef ], [ %225, %block_404306 ]
...
block_.L_404333:                                  ; preds = %block_.L_4042fa
  ...
  %call2_404337 = tail call %struct.Memory* @sub_417340._Z17check_shifted_sumIh20custom_mod_constantsIhEEvT_(%struct.State* %0, i64 %231, %struct.Memory* %MEMORY.1)
...
block_.L_40434a:                                  ; preds = %block_.L_4042df
  ...
  %call2_40434a = tail call %struct.Memory* @sub_400e60._Z5timerv(%struct.State* %0, i64 %268, %struct.Memory* %MEMORY.0)
  ...
  %call2_404353 = tail call %struct.Memory* @sub_400800._Z13record_resultdPKc(%struct.State* %0, i64 %279, %struct.Memory* %call2_40434a)
