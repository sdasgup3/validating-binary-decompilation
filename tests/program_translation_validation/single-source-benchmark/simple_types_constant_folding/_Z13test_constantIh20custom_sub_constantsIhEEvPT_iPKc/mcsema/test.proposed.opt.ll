...
block_.L_4040ff:                                  ; preds = %block_.L_404153, %entry
  %69 = phi i64 [ %.pre, %entry ], [ %267, %block_.L_404153 ]
...
block_.L_40411a:                                  ; preds = %block_404126, %block_40410f
  %112 = phi i64 [ %.pre1, %block_40410f ], [ %225, %block_404126 ]
...
block_.L_404153:                                  ; preds = %block_.L_40411a
  ...
  %call2_404157 = tail call %struct.Memory* @sub_4174f0._Z17check_shifted_sumIh20custom_sub_constantsIhEEvT_(%struct.State* %0, i64 %231, %struct.Memory* %MEMORY.1)
...
block_.L_40416a:                                  ; preds = %block_.L_4040ff
  ...
  %call2_40416a = tail call %struct.Memory* @sub_400e60._Z5timerv(%struct.State* %0, i64 %268, %struct.Memory* %MEMORY.0)
  ...
  %call2_404173 = tail call %struct.Memory* @sub_400800._Z13record_resultdPKc(%struct.State* %0, i64 %279, %struct.Memory* %call2_40416a)
