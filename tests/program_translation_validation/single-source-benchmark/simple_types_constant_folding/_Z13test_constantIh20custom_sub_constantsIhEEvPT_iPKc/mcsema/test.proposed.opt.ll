...
declare %struct.Memory* @sub_4174f0._Z17check_shifted_sumIh20custom_sub_constantsIhEEvT_(%struct.State* noalias dereferenceable(3376), i64, %struct.Memory* noalias readnone returned) local_unnamed_addr
...
define %struct.Memory* @_Z13test_constantIh20custom_sub_constantsIhEEvPT_iPKc(%struct.State* noalias, i64, %struct.Memory* noalias) local_unnamed_addr #1 {
entry:
  ...
  %call2_4040f3 = tail call %struct.Memory* @sub_400e40._Z11start_timerv(%struct.State* %0, i64 %58, %struct.Memory* %2)
...
block_.L_4040ff:                                  ; preds = %block_.L_404153, %entry
  %69 = phi i64 [ %.pre, %entry ], [ %269, %block_.L_404153 ]
  %MEMORY.0 = phi %struct.Memory* [ %call2_4040f3, %entry ], [ %call2_404157, %block_.L_404153 ]
  ...
  br i1 %102, label %block_40410f, label %block_.L_40416a
...
block_.L_40411a:                                  ; preds = %block_404126, %block_40410f
  %112 = phi i64 [ %.pre1, %block_40410f ], [ %226, %block_404126 ]
  %MEMORY.1 = phi %struct.Memory* [ %MEMORY.0, %block_40410f ], [ %call2_404132, %block_404126 ]
  ...
  br i1 %148, label %block_404126, label %block_.L_404153
...
block_404126:                                     ; preds = %block_.L_40411a
  ...
  %call2_404132 = tail call %struct.Memory* @sub_4174d0._ZN20custom_sub_constantsIhE8do_shiftEh(%struct.State* %0, i64 %162, %struct.Memory* %MEMORY.1)
...
block_.L_404153:                                  ; preds = %block_.L_40411a
  ...
  %call2_404157 = tail call %struct.Memory* @sub_4174f0._Z17check_shifted_sumIh20custom_sub_constantsIhEEvT_(%struct.State* %0, i64 %232, %struct.Memory* %MEMORY.1)
...
block_.L_40416a:                                  ; preds = %block_.L_4040ff
  ...
  %call2_40416a = tail call %struct.Memory* @sub_400e60._Z5timerv(%struct.State* %0, i64 %270, %struct.Memory* %MEMORY.0)
  ...
  %call2_404173 = tail call %struct.Memory* @sub_400800._Z13record_resultdPKc(%struct.State* %0, i64 %281, %struct.Memory* %call2_40416a)
  ...
  ret %struct.Memory* %call2_404173
}
...
define %struct.Memory* @routine_jge_.L_40416a(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i8* %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
...
define %struct.Memory* @routine_jge_.L_404153(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i8* %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 2, i32 9
...
define %struct.Memory* @routine_jmpq_.L_40411a(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
...
define %struct.Memory* @routine_callq_._Z17check_shifted_sumIh20custom_sub_constantsIhEEvT_(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
...
define %struct.Memory* @routine_jmpq_.L_4040ff(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
