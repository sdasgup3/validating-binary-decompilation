...
block_.L_40487f:                                  ; preds = %block_.L_4048d3, %entry
  %69 = phi i64 [ %.pre, %entry ], [ %267, %block_.L_4048d3 ]
...
block_.L_40489a:                                  ; preds = %block_4048a6, %block_40488f
  %112 = phi i64 [ %.pre1, %block_40488f ], [ %225, %block_4048a6 ]
...
block_.L_4048d3:                                  ; preds = %block_.L_40489a
  ...
  %call2_4048d7 = tail call %struct.Memory* @sub_416e30._Z17check_shifted_sumIh20custom_xor_constantsIhEEvT_(%struct.State* %0, i64 %231, %struct.Memory* %MEMORY.1)
...
block_.L_4048ea:                                  ; preds = %block_.L_40487f
  ...
  %call2_4048ea = tail call %struct.Memory* @sub_400e60._Z5timerv(%struct.State* %0, i64 %268, %struct.Memory* %MEMORY.0)
  ...
  %call2_4048f3 = tail call %struct.Memory* @sub_400800._Z13record_resultdPKc(%struct.State* %0, i64 %279, %struct.Memory* %call2_4048ea)
