...
block_.L_404d7f:                                  ; preds = %block_.L_404dd3, %entry
  %69 = phi i64 [ %.pre, %entry ], [ %269, %block_.L_404dd3 ]
...
block_.L_404d9a:                                  ; preds = %block_404da6, %block_404d8f
  %112 = phi i64 [ %.pre1, %block_404d8f ], [ %226, %block_404da6 ]
...
block_.L_404dd3:                                  ; preds = %block_.L_404d9a
  ...
  %call2_404dd7 = tail call %struct.Memory* @sub_416980._Z17check_shifted_sumIh22custom_constant_divideIhEEvT_(%struct.State* %0, i64 %232, %struct.Memory* %MEMORY.1)
...
block_.L_404dea:                                  ; preds = %block_.L_404d7f
  ...
  %call2_404dea = tail call %struct.Memory* @sub_400e60._Z5timerv(%struct.State* %0, i64 %270, %struct.Memory* %MEMORY.0)
  ...
  %call2_404df3 = tail call %struct.Memory* @sub_400800._Z13record_resultdPKc(%struct.State* %0, i64 %281, %struct.Memory* %call2_404dea)
