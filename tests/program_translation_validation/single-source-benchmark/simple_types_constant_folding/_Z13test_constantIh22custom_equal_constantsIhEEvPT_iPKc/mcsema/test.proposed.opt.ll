...
block_.L_40437f:                                  ; preds = %block_.L_4043d3, %entry
  %69 = phi i64 [ %.pre, %entry ], [ %267, %block_.L_4043d3 ]
...
block_.L_40439a:                                  ; preds = %block_4043a6, %block_40438f
  %112 = phi i64 [ %.pre1, %block_40438f ], [ %225, %block_4043a6 ]
...
block_.L_4043d3:                                  ; preds = %block_.L_40439a
  ...
  %call2_4043d7 = tail call %struct.Memory* @sub_4172b0._Z17check_shifted_sumIh22custom_equal_constantsIhEEvT_(%struct.State* %0, i64 %231, %struct.Memory* %MEMORY.1)
...
block_.L_4043ea:                                  ; preds = %block_.L_40437f
  ...
  %call2_4043ea = tail call %struct.Memory* @sub_400e60._Z5timerv(%struct.State* %0, i64 %268, %struct.Memory* %MEMORY.0)
  ...
  %call2_4043f3 = tail call %struct.Memory* @sub_400800._Z13record_resultdPKc(%struct.State* %0, i64 %279, %struct.Memory* %call2_4043ea)
