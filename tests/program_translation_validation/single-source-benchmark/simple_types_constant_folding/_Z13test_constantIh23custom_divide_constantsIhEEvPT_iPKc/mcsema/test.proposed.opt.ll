...
block_.L_40423f:                                  ; preds = %block_.L_404293, %entry
  %69 = phi i64 [ %.pre, %entry ], [ %269, %block_.L_404293 ]
...
block_.L_40425a:                                  ; preds = %block_404266, %block_40424f
  %112 = phi i64 [ %.pre1, %block_40424f ], [ %226, %block_404266 ]
...
block_.L_404293:                                  ; preds = %block_.L_40425a
  ...
  %call2_404297 = tail call %struct.Memory* @sub_4173d0._Z17check_shifted_sumIh23custom_divide_constantsIhEEvT_(%struct.State* %0, i64 %232, %struct.Memory* %MEMORY.1)
...
block_.L_4042aa:                                  ; preds = %block_.L_40423f
  ...
  %call2_4042aa = tail call %struct.Memory* @sub_400e60._Z5timerv(%struct.State* %0, i64 %270, %struct.Memory* %MEMORY.0)
  ...
  %call2_4042b3 = tail call %struct.Memory* @sub_400800._Z13record_resultdPKc(%struct.State* %0, i64 %281, %struct.Memory* %call2_4042aa)
