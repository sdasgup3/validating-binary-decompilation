...
block_.L_404b9f:                                  ; preds = %block_.L_404bf3, %entry
  %69 = phi i64 [ %.pre, %entry ], [ %269, %block_.L_404bf3 ]
...
block_.L_404bba:                                  ; preds = %block_404bc6, %block_404baf
  %112 = phi i64 [ %.pre1, %block_404baf ], [ %226, %block_404bc6 ]
...
block_.L_404bf3:                                  ; preds = %block_.L_404bba
  ...
  %call2_404bf7 = tail call %struct.Memory* @sub_416b40._Z17check_shifted_sumIh24custom_constant_multiplyIhEEvT_(%struct.State* %0, i64 %232, %struct.Memory* %MEMORY.1)
...
block_.L_404c0a:                                  ; preds = %block_.L_404b9f
  ...
  %call2_404c0a = tail call %struct.Memory* @sub_400e60._Z5timerv(%struct.State* %0, i64 %270, %struct.Memory* %MEMORY.0)
  ...
  %call2_404c13 = tail call %struct.Memory* @sub_400800._Z13record_resultdPKc(%struct.State* %0, i64 %281, %struct.Memory* %call2_404c0a)
