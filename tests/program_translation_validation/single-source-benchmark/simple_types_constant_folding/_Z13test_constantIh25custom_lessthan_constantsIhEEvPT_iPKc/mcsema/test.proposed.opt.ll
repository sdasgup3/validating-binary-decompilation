...
block_.L_40455f:                                  ; preds = %block_.L_4045b3, %entry
  %69 = phi i64 [ %.pre, %entry ], [ %267, %block_.L_4045b3 ]
...
block_.L_40457a:                                  ; preds = %block_404586, %block_40456f
  %112 = phi i64 [ %.pre1, %block_40456f ], [ %225, %block_404586 ]
...
block_.L_4045b3:                                  ; preds = %block_.L_40457a
  ...
  %call2_4045b7 = tail call %struct.Memory* @sub_417100._Z17check_shifted_sumIh25custom_lessthan_constantsIhEEvT_(%struct.State* %0, i64 %231, %struct.Memory* %MEMORY.1)
...
block_.L_4045ca:                                  ; preds = %block_.L_40455f
  ...
  %call2_4045ca = tail call %struct.Memory* @sub_400e60._Z5timerv(%struct.State* %0, i64 %268, %struct.Memory* %MEMORY.0)
  ...
  %call2_4045d3 = tail call %struct.Memory* @sub_400800._Z13record_resultdPKc(%struct.State* %0, i64 %279, %struct.Memory* %call2_4045ca)
