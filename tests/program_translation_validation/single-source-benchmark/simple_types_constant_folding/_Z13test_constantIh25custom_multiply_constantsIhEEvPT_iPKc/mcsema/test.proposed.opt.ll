...
declare %struct.Memory* @sub_417460._Z17check_shifted_sumIh25custom_multiply_constantsIhEEvT_(%struct.State* noalias dereferenceable(3376), i64, %struct.Memory* noalias readnone returned) local_unnamed_addr
...
define %struct.Memory* @_Z13test_constantIh25custom_multiply_constantsIhEEvPT_iPKc(%struct.State* noalias, i64, %struct.Memory* noalias) local_unnamed_addr #1 {
entry:
  ...
  %call2_404193 = tail call %struct.Memory* @sub_400e40._Z11start_timerv(%struct.State* %0, i64 %58, %struct.Memory* %2)
...
block_.L_40419f:                                  ; preds = %block_.L_4041f3, %entry
  %69 = phi i64 [ %.pre, %entry ], [ %267, %block_.L_4041f3 ]
  %MEMORY.0 = phi %struct.Memory* [ %call2_404193, %entry ], [ %call2_4041f7, %block_.L_4041f3 ]
  ...
  br i1 %102, label %block_4041af, label %block_.L_40420a
...
block_.L_4041ba:                                  ; preds = %block_4041c6, %block_4041af
  %112 = phi i64 [ %.pre1, %block_4041af ], [ %225, %block_4041c6 ]
  %MEMORY.1 = phi %struct.Memory* [ %MEMORY.0, %block_4041af ], [ %call2_4041d2, %block_4041c6 ]
  ...
  br i1 %148, label %block_4041c6, label %block_.L_4041f3
...
block_4041c6:                                     ; preds = %block_.L_4041ba
  ...
  %call2_4041d2 = tail call %struct.Memory* @sub_417440._ZN25custom_multiply_constantsIhE8do_shiftEh(%struct.State* %0, i64 %162, %struct.Memory* %MEMORY.1)
...
block_.L_4041f3:                                  ; preds = %block_.L_4041ba
  ...
  %call2_4041f7 = tail call %struct.Memory* @sub_417460._Z17check_shifted_sumIh25custom_multiply_constantsIhEEvT_(%struct.State* %0, i64 %231, %struct.Memory* %MEMORY.1)
...
block_.L_40420a:                                  ; preds = %block_.L_40419f
  ...
  %call2_40420a = tail call %struct.Memory* @sub_400e60._Z5timerv(%struct.State* %0, i64 %268, %struct.Memory* %MEMORY.0)
  ...
  %call2_404213 = tail call %struct.Memory* @sub_400800._Z13record_resultdPKc(%struct.State* %0, i64 %279, %struct.Memory* %call2_40420a)
  ...
  ret %struct.Memory* %call2_404213
}
...
define %struct.Memory* @routine_jge_.L_40420a(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i8* %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
...
define %struct.Memory* @routine_jge_.L_4041f3(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i8* %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 2, i32 9
...
define %struct.Memory* @routine_jmpq_.L_4041ba(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
...
define %struct.Memory* @routine_callq_._Z17check_shifted_sumIh25custom_multiply_constantsIhEEvT_(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
