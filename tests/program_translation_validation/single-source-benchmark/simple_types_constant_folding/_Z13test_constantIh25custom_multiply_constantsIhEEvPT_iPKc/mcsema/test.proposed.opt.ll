...
block_.L_40419f:                                  ; preds = %block_.L_4041f3, %entry
  %69 = phi i64 [ %.pre, %entry ], [ %269, %block_.L_4041f3 ]
...
block_.L_4041ba:                                  ; preds = %block_4041c6, %block_4041af
  %112 = phi i64 [ %.pre1, %block_4041af ], [ %226, %block_4041c6 ]
...
block_.L_4041f3:                                  ; preds = %block_.L_4041ba
  ...
  %call2_4041f7 = tail call %struct.Memory* @sub_417460._Z17check_shifted_sumIh25custom_multiply_constantsIhEEvT_(%struct.State* %0, i64 %232, %struct.Memory* %MEMORY.1)
...
block_.L_40420a:                                  ; preds = %block_.L_40419f
  ...
  %call2_40420a = tail call %struct.Memory* @sub_400e60._Z5timerv(%struct.State* %0, i64 %270, %struct.Memory* %MEMORY.0)
  ...
  %call2_404213 = tail call %struct.Memory* @sub_400800._Z13record_resultdPKc(%struct.State* %0, i64 %281, %struct.Memory* %call2_40420a)
