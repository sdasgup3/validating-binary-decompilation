...
declare %struct.Memory* @sub_417260._Z17check_shifted_sumIh25custom_notequal_constantsIhEEvT_(%struct.State* dereferenceable(3376), i64, %struct.Memory*)
...
define %struct.Memory* @_Z13test_constantIh25custom_notequal_constantsIhEEvPT_iPKc(%struct.State* noalias, i64, %struct.Memory* noalias) #1 {
entry:
