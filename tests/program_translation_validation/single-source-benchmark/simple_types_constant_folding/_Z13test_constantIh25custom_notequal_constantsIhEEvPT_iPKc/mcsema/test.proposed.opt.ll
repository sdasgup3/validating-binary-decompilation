...
declare %struct.Memory* @sub_417200._ZN25custom_notequal_constantsIhE8do_shiftEh(%struct.State* noalias dereferenceable(3376), i64, %struct.Memory* noalias readnone returned) local_unnamed_addr

declare %struct.Memory* @sub_417220._Z17check_shifted_sumIh25custom_notequal_constantsIhEEvT_(%struct.State* noalias dereferenceable(3376), i64, %struct.Memory* noalias readnone returned) local_unnamed_addr
...
entry:
  ...
  %call2_404413 = tail call %struct.Memory* @sub_400e40._Z11start_timerv(%struct.State* %0, i64 %58, %struct.Memory* %2)
  ...
  br label %block_.L_40441f

block_.L_40441f:                                  ; preds = %block_.L_404473, %entry
  %69 = phi i64 [ %.pre, %entry ], [ %267, %block_.L_404473 ]
  %MEMORY.0 = phi %struct.Memory* [ %call2_404413, %entry ], [ %call2_404477, %block_.L_404473 ]
  ...
  br i1 %102, label %block_40442f, label %block_.L_40448a

block_40442f:                                     ; preds = %block_.L_40441f
  %104 = add i64 %70, -29
  %105 = add i64 %103, 4
  ...
  br label %block_.L_40443a

block_.L_40443a:                                  ; preds = %block_404446, %block_40442f
  %112 = phi i64 [ %.pre1, %block_40442f ], [ %225, %block_404446 ]
  %MEMORY.1 = phi %struct.Memory* [ %MEMORY.0, %block_40442f ], [ %call2_404452, %block_404446 ]
  ...
  br i1 %148, label %block_404446, label %block_.L_404473

block_404446:                                     ; preds = %block_.L_40443a
  %150 = add i64 %113, -8
  %151 = add i64 %149, 4
  ...
  %call2_404452 = tail call %struct.Memory* @sub_417200._ZN25custom_notequal_constantsIhE8do_shiftEh(%struct.State* %0, i64 %162, %struct.Memory* %MEMORY.1)
...
block_.L_404473:                                  ; preds = %block_.L_40443a
  %226 = add i64 %113, -29
  %227 = add i64 %149, 4
  ...
  %call2_404477 = tail call %struct.Memory* @sub_417220._Z17check_shifted_sumIh25custom_notequal_constantsIhEEvT_(%struct.State* %0, i64 %231, %struct.Memory* %MEMORY.1)
...
block_.L_40448a:                                  ; preds = %block_.L_40441f
  ...
  %call2_40448a = tail call %struct.Memory* @sub_400e60._Z5timerv(%struct.State* %0, i64 %268, %struct.Memory* %MEMORY.0)
  ...
  %call2_404493 = tail call %struct.Memory* @sub_400800._Z13record_resultdPKc(%struct.State* %0, i64 %279, %struct.Memory* %call2_40448a)
  ...
  ret %struct.Memory* %call2_404493
}
...
define %struct.Memory* @routine_jge_.L_40448a(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i8* %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
...
define %struct.Memory* @routine_jge_.L_404473(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i8* %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 2, i32 9
...
define %struct.Memory* @routine_callq_._ZN25custom_notequal_constantsIhE8do_shiftEh(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
...
define %struct.Memory* @routine_jmpq_.L_40443a(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
...
define %struct.Memory* @routine_callq_._Z17check_shifted_sumIh25custom_notequal_constantsIhEEvT_(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
...
define %struct.Memory* @routine_jmpq_.L_40441f(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
