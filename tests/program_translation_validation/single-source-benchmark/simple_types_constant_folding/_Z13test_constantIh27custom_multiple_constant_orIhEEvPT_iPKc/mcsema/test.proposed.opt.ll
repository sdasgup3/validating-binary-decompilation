...
block_.L_4051df:                                  ; preds = %block_.L_405233, %entry
  %69 = phi i64 [ %.pre, %entry ], [ %269, %block_.L_405233 ]
...
block_.L_4051fa:                                  ; preds = %block_405206, %block_4051ef
  %112 = phi i64 [ %.pre1, %block_4051ef ], [ %226, %block_405206 ]
...
block_.L_405233:                                  ; preds = %block_.L_4051fa
  ...
  %call2_405237 = tail call %struct.Memory* @sub_416560._Z17check_shifted_sumIh27custom_multiple_constant_orIhEEvT_(%struct.State* %0, i64 %232, %struct.Memory* %MEMORY.1)
...
block_.L_40524a:                                  ; preds = %block_.L_4051df
  ...
  %call2_40524a = tail call %struct.Memory* @sub_400e60._Z5timerv(%struct.State* %0, i64 %270, %struct.Memory* %MEMORY.0)
  ...
  %call2_405253 = tail call %struct.Memory* @sub_400800._Z13record_resultdPKc(%struct.State* %0, i64 %281, %struct.Memory* %call2_40524a)
