...
block_.L_4044bf:                                  ; preds = %block_.L_404513, %entry
  %69 = phi i64 [ %.pre, %entry ], [ %269, %block_.L_404513 ]
...
block_.L_4044da:                                  ; preds = %block_4044e6, %block_4044cf
  %112 = phi i64 [ %.pre1, %block_4044cf ], [ %226, %block_4044e6 ]
...
block_.L_404513:                                  ; preds = %block_.L_4044da
  ...
  %call2_404517 = tail call %struct.Memory* @sub_417190._Z17check_shifted_sumIh28custom_greaterthan_constantsIhEEvT_(%struct.State* %0, i64 %232, %struct.Memory* %MEMORY.1)
...
block_.L_40452a:                                  ; preds = %block_.L_4044bf
  ...
  %call2_40452a = tail call %struct.Memory* @sub_400e60._Z5timerv(%struct.State* %0, i64 %270, %struct.Memory* %MEMORY.0)
  ...
  %call2_404533 = tail call %struct.Memory* @sub_400800._Z13record_resultdPKc(%struct.State* %0, i64 %281, %struct.Memory* %call2_40452a)
