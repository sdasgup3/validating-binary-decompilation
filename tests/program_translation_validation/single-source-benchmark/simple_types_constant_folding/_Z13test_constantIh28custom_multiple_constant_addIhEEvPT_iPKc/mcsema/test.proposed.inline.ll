...
entry:
  ...
  store %struct.Memory* %loadMem_4049e4, %struct.Memory** %MEMORY
...
block_.L_4049ff:                                  ; preds = %block_.L_404a53, %entry
...
block_404a0f:                                     ; preds = %block_.L_4049ff
...
block_.L_404a1a:                                  ; preds = %block_404a26, %block_404a0f
  ...
  store %struct.Memory* %loadMem_404a1a, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_404a20, %struct.Memory** %MEMORY
...
block_404a26:                                     ; preds = %block_.L_404a1a
  ...
  store %struct.Memory* %loadMem1_404a32, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_404a37, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_404a40, %struct.Memory** %MEMORY
  ...
  store i8 %492, i8* %496
  store %struct.Memory* %loadMem_404a42, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_404a45, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_404a4b, %struct.Memory** %MEMORY
...
block_.L_404a53:                                  ; preds = %block_.L_404a1a
  ...
  store %struct.Memory* %loadMem1_404a57, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_404a5f, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_404a62, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_404a65, %struct.Memory** %MEMORY
  br label %block_.L_4049ff

block_.L_404a6a:                                  ; preds = %block_.L_4049ff
  ...
  store %struct.Memory* %loadMem1_404a6a, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem1_404a73, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_404a78, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_404a7c, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_404a7d, %struct.Memory** %MEMORY
  ret %struct.Memory* %loadMem_404a7d
}
