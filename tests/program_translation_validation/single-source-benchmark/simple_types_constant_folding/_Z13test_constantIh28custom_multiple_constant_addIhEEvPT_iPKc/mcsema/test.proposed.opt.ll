...
block_.L_4049bf:                                  ; preds = %block_.L_404a13, %entry
  %69 = phi i64 [ %.pre, %entry ], [ %269, %block_.L_404a13 ]
...
block_.L_4049da:                                  ; preds = %block_4049e6, %block_4049cf
  %112 = phi i64 [ %.pre1, %block_4049cf ], [ %226, %block_4049e6 ]
...
block_.L_404a13:                                  ; preds = %block_.L_4049da
  ...
  %call2_404a17 = tail call %struct.Memory* @sub_416d10._Z17check_shifted_sumIh28custom_multiple_constant_addIhEEvT_(%struct.State* %0, i64 %232, %struct.Memory* %MEMORY.1)
...
block_.L_404a2a:                                  ; preds = %block_.L_4049bf
  ...
  %call2_404a2a = tail call %struct.Memory* @sub_400e60._Z5timerv(%struct.State* %0, i64 %270, %struct.Memory* %MEMORY.0)
  ...
  %call2_404a33 = tail call %struct.Memory* @sub_400800._Z13record_resultdPKc(%struct.State* %0, i64 %281, %struct.Memory* %call2_404a2a)
