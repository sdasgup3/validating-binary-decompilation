...
block_.L_40509f:                                  ; preds = %block_.L_4050f3, %entry
  %69 = phi i64 [ %.pre, %entry ], [ %267, %block_.L_4050f3 ]
...
block_.L_4050ba:                                  ; preds = %block_4050c6, %block_4050af
  %112 = phi i64 [ %.pre1, %block_4050af ], [ %225, %block_4050c6 ]
...
block_.L_4050f3:                                  ; preds = %block_.L_4050ba
  ...
  %call2_4050f7 = tail call %struct.Memory* @sub_416690._Z17check_shifted_sumIh28custom_multiple_constant_andIhEEvT_(%struct.State* %0, i64 %231, %struct.Memory* %MEMORY.1)
...
block_.L_40510a:                                  ; preds = %block_.L_40509f
  ...
  %call2_40510a = tail call %struct.Memory* @sub_400e60._Z5timerv(%struct.State* %0, i64 %268, %struct.Memory* %MEMORY.0)
  ...
  %call2_405113 = tail call %struct.Memory* @sub_400800._Z13record_resultdPKc(%struct.State* %0, i64 %279, %struct.Memory* %call2_40510a)
