...
block_.L_404aff:                                  ; preds = %block_.L_404b53, %entry
  %69 = phi i64 [ %.pre, %entry ], [ %269, %block_.L_404b53 ]
...
block_.L_404b1a:                                  ; preds = %block_404b26, %block_404b0f
  %112 = phi i64 [ %.pre1, %block_404b0f ], [ %226, %block_404b26 ]
...
block_.L_404b53:                                  ; preds = %block_.L_404b1a
  ...
  %call2_404b57 = tail call %struct.Memory* @sub_416be0._Z17check_shifted_sumIh28custom_multiple_constant_subIhEEvT_(%struct.State* %0, i64 %232, %struct.Memory* %MEMORY.1)
...
block_.L_404b6a:                                  ; preds = %block_.L_404aff
  ...
  %call2_404b6a = tail call %struct.Memory* @sub_400e60._Z5timerv(%struct.State* %0, i64 %270, %struct.Memory* %MEMORY.0)
  ...
  %call2_404b73 = tail call %struct.Memory* @sub_400800._Z13record_resultdPKc(%struct.State* %0, i64 %281, %struct.Memory* %call2_404b6a)
