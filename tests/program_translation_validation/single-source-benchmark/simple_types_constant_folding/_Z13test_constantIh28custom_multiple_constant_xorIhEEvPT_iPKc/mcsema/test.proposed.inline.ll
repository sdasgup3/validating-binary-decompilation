...
declare %struct.Memory* @sub_4163f0._ZN28custom_multiple_constant_xorIhE8do_shiftEh(%struct.State* dereferenceable(3376), i64, %struct.Memory*)

declare %struct.Memory* @sub_416420._Z17check_shifted_sumIh28custom_multiple_constant_xorIhEEvT_(%struct.State* dereferenceable(3376), i64, %struct.Memory*)
...
define %struct.Memory* @_Z13test_constantIh28custom_multiple_constant_xorIhEEvPT_iPKc(%struct.State* noalias, i64, %struct.Memory* noalias) #1 {
entry:
