...
block_.L_40531f:                                  ; preds = %block_.L_405373, %entry
  %69 = phi i64 [ %.pre, %entry ], [ %269, %block_.L_405373 ]
...
block_.L_40533a:                                  ; preds = %block_405346, %block_40532f
  %112 = phi i64 [ %.pre1, %block_40532f ], [ %226, %block_405346 ]
...
block_.L_405373:                                  ; preds = %block_.L_40533a
  ...
  %call2_405377 = tail call %struct.Memory* @sub_4163e0._Z17check_shifted_sumIh28custom_multiple_constant_xorIhEEvT_(%struct.State* %0, i64 %232, %struct.Memory* %MEMORY.1)
...
block_.L_40538a:                                  ; preds = %block_.L_40531f
  ...
  %call2_40538a = tail call %struct.Memory* @sub_400e60._Z5timerv(%struct.State* %0, i64 %270, %struct.Memory* %MEMORY.0)
  ...
  %call2_405393 = tail call %struct.Memory* @sub_400800._Z13record_resultdPKc(%struct.State* %0, i64 %281, %struct.Memory* %call2_40538a)
