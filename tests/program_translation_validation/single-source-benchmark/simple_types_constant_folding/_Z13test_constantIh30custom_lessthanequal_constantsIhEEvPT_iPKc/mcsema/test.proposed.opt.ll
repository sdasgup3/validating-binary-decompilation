...
block_.L_40469f:                                  ; preds = %block_.L_4046f3, %entry
  %69 = phi i64 [ %.pre, %entry ], [ %269, %block_.L_4046f3 ]
...
block_.L_4046ba:                                  ; preds = %block_4046c6, %block_4046af
  %112 = phi i64 [ %.pre1, %block_4046af ], [ %226, %block_4046c6 ]
...
block_.L_4046f3:                                  ; preds = %block_.L_4046ba
  ...
  %call2_4046f7 = tail call %struct.Memory* @sub_416fe0._Z17check_shifted_sumIh30custom_lessthanequal_constantsIhEEvT_(%struct.State* %0, i64 %232, %struct.Memory* %MEMORY.1)
...
block_.L_40470a:                                  ; preds = %block_.L_40469f
  ...
  %call2_40470a = tail call %struct.Memory* @sub_400e60._Z5timerv(%struct.State* %0, i64 %270, %struct.Memory* %MEMORY.0)
  ...
  %call2_404713 = tail call %struct.Memory* @sub_400800._Z13record_resultdPKc(%struct.State* %0, i64 %281, %struct.Memory* %call2_40470a)
