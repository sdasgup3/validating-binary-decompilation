...
block_.L_404f5f:                                  ; preds = %block_.L_404fb3, %entry
  %69 = phi i64 [ %.pre, %entry ], [ %267, %block_.L_404fb3 ]
...
block_.L_404f7a:                                  ; preds = %block_404f86, %block_404f6f
  %112 = phi i64 [ %.pre1, %block_404f6f ], [ %225, %block_404f86 ]
...
block_.L_404fb3:                                  ; preds = %block_.L_404f7a
  ...
  %call2_404fb7 = tail call %struct.Memory* @sub_4167b0._Z17check_shifted_sumIh30custom_multiple_constant_mixedIhEEvT_(%struct.State* %0, i64 %231, %struct.Memory* %MEMORY.1)
...
block_.L_404fca:                                  ; preds = %block_.L_404f5f
  ...
  %call2_404fca = tail call %struct.Memory* @sub_400e60._Z5timerv(%struct.State* %0, i64 %268, %struct.Memory* %MEMORY.0)
  ...
  %call2_404fd3 = tail call %struct.Memory* @sub_400800._Z13record_resultdPKc(%struct.State* %0, i64 %279, %struct.Memory* %call2_404fca)
