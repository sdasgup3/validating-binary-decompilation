...
block_.L_404e1f:                                  ; preds = %block_.L_404e73, %entry
  %69 = phi i64 [ %.pre, %entry ], [ %269, %block_.L_404e73 ]
...
block_.L_404e3a:                                  ; preds = %block_404e46, %block_404e2f
  %112 = phi i64 [ %.pre1, %block_404e2f ], [ %226, %block_404e46 ]
...
block_.L_404e73:                                  ; preds = %block_.L_404e3a
  ...
  %call2_404e77 = tail call %struct.Memory* @sub_4168f0._Z17check_shifted_sumIh31custom_multiple_constant_divideIhEEvT_(%struct.State* %0, i64 %232, %struct.Memory* %MEMORY.1)
...
block_.L_404e8a:                                  ; preds = %block_.L_404e1f
  ...
  %call2_404e8a = tail call %struct.Memory* @sub_400e60._Z5timerv(%struct.State* %0, i64 %270, %struct.Memory* %MEMORY.0)
  ...
  %call2_404e93 = tail call %struct.Memory* @sub_400800._Z13record_resultdPKc(%struct.State* %0, i64 %281, %struct.Memory* %call2_404e8a)
