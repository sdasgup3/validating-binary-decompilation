...
block_.L_404ebf:                                  ; preds = %block_.L_404f13, %entry
  %69 = phi i64 [ %.pre, %entry ], [ %267, %block_.L_404f13 ]
...
block_.L_404eda:                                  ; preds = %block_404ee6, %block_404ecf
  %112 = phi i64 [ %.pre1, %block_404ecf ], [ %225, %block_404ee6 ]
...
block_.L_404f13:                                  ; preds = %block_.L_404eda
  ...
  %call2_404f17 = tail call %struct.Memory* @sub_416840._Z17check_shifted_sumIh32custom_multiple_constant_divide2IhEEvT_(%struct.State* %0, i64 %231, %struct.Memory* %MEMORY.1)
...
block_.L_404f2a:                                  ; preds = %block_.L_404ebf
  ...
  %call2_404f2a = tail call %struct.Memory* @sub_400e60._Z5timerv(%struct.State* %0, i64 %268, %struct.Memory* %MEMORY.0)
  ...
  %call2_404f33 = tail call %struct.Memory* @sub_400800._Z13record_resultdPKc(%struct.State* %0, i64 %279, %struct.Memory* %call2_404f2a)
