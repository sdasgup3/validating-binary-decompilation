...
block_.L_4045ff:                                  ; preds = %block_.L_404653, %entry
  %69 = phi i64 [ %.pre, %entry ], [ %269, %block_.L_404653 ]
...
block_.L_40461a:                                  ; preds = %block_404626, %block_40460f
  %112 = phi i64 [ %.pre1, %block_40460f ], [ %226, %block_404626 ]
...
block_.L_404653:                                  ; preds = %block_.L_40461a
  ...
  %call2_404657 = tail call %struct.Memory* @sub_417070._Z17check_shifted_sumIh33custom_greaterthanequal_constantsIhEEvT_(%struct.State* %0, i64 %232, %struct.Memory* %MEMORY.1)
...
block_.L_40466a:                                  ; preds = %block_.L_4045ff
  ...
  %call2_40466a = tail call %struct.Memory* @sub_400e60._Z5timerv(%struct.State* %0, i64 %270, %struct.Memory* %MEMORY.0)
  ...
  %call2_404673 = tail call %struct.Memory* @sub_400800._Z13record_resultdPKc(%struct.State* %0, i64 %281, %struct.Memory* %call2_40466a)
