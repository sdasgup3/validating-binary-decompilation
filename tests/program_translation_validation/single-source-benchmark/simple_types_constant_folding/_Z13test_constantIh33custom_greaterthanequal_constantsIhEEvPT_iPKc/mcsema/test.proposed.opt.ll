...
declare %struct.Memory* @sub_417070._Z17check_shifted_sumIh33custom_greaterthanequal_constantsIhEEvT_(%struct.State* noalias dereferenceable(3376), i64, %struct.Memory* noalias readnone returned) local_unnamed_addr
...
define %struct.Memory* @_Z13test_constantIh33custom_greaterthanequal_constantsIhEEvPT_iPKc(%struct.State* noalias, i64, %struct.Memory* noalias) local_unnamed_addr #1 {
entry:
  ...
  %call2_4045f3 = tail call %struct.Memory* @sub_400e40._Z11start_timerv(%struct.State* %0, i64 %58, %struct.Memory* %2)
  ...
  br label %block_.L_4045ff

block_.L_4045ff:                                  ; preds = %block_.L_404653, %entry
  %69 = phi i64 [ %.pre, %entry ], [ %267, %block_.L_404653 ]
  %MEMORY.0 = phi %struct.Memory* [ %call2_4045f3, %entry ], [ %call2_404657, %block_.L_404653 ]
  ...
  br i1 %102, label %block_40460f, label %block_.L_40466a

block_40460f:                                     ; preds = %block_.L_4045ff
  %104 = add i64 %70, -29
  %105 = add i64 %103, 4
  ...
  br label %block_.L_40461a

block_.L_40461a:                                  ; preds = %block_404626, %block_40460f
  %112 = phi i64 [ %.pre1, %block_40460f ], [ %225, %block_404626 ]
  %MEMORY.1 = phi %struct.Memory* [ %MEMORY.0, %block_40460f ], [ %call2_404632, %block_404626 ]
  ...
  br i1 %148, label %block_404626, label %block_.L_404653

block_404626:                                     ; preds = %block_.L_40461a
  %150 = add i64 %113, -8
  %151 = add i64 %149, 4
  ...
  %call2_404632 = tail call %struct.Memory* @sub_417050._ZN33custom_greaterthanequal_constantsIhE8do_shiftEh(%struct.State* %0, i64 %162, %struct.Memory* %MEMORY.1)
...
block_.L_404653:                                  ; preds = %block_.L_40461a
  %226 = add i64 %113, -29
  %227 = add i64 %149, 4
  ...
  %call2_404657 = tail call %struct.Memory* @sub_417070._Z17check_shifted_sumIh33custom_greaterthanequal_constantsIhEEvT_(%struct.State* %0, i64 %231, %struct.Memory* %MEMORY.1)
...
block_.L_40466a:                                  ; preds = %block_.L_4045ff
  %268 = add i64 %103, -14346
  %269 = add i64 %103, 5
  ...
  %call2_40466a = tail call %struct.Memory* @sub_400e60._Z5timerv(%struct.State* %0, i64 %268, %struct.Memory* %MEMORY.0)
  ...
  %call2_404673 = tail call %struct.Memory* @sub_400800._Z13record_resultdPKc(%struct.State* %0, i64 %279, %struct.Memory* %call2_40466a)
  ...
  ret %struct.Memory* %call2_404673
}
...
define %struct.Memory* @routine_jge_.L_40466a(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i8* %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
...
define %struct.Memory* @routine_jge_.L_404653(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i8* %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 2, i32 9
...
define %struct.Memory* @routine_jmpq_.L_40461a(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
...
define %struct.Memory* @routine_callq_._Z17check_shifted_sumIh33custom_greaterthanequal_constantsIhEEvT_(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
...
define %struct.Memory* @routine_jmpq_.L_4045ff(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
