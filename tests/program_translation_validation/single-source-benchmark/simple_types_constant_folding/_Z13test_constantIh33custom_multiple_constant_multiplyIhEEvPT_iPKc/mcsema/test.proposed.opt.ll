...
block_.L_404c3f:                                  ; preds = %block_.L_404c93, %entry
  %69 = phi i64 [ %.pre, %entry ], [ %269, %block_.L_404c93 ]
...
block_.L_404c5a:                                  ; preds = %block_404c66, %block_404c4f
  %112 = phi i64 [ %.pre1, %block_404c4f ], [ %226, %block_404c66 ]
...
block_.L_404c93:                                  ; preds = %block_.L_404c5a
  ...
  %call2_404c97 = tail call %struct.Memory* @sub_416ab0._Z17check_shifted_sumIh33custom_multiple_constant_multiplyIhEEvT_(%struct.State* %0, i64 %232, %struct.Memory* %MEMORY.1)
...
block_.L_404caa:                                  ; preds = %block_.L_404c3f
  ...
  %call2_404caa = tail call %struct.Memory* @sub_400e60._Z5timerv(%struct.State* %0, i64 %270, %struct.Memory* %MEMORY.0)
  ...
  %call2_404cb3 = tail call %struct.Memory* @sub_400800._Z13record_resultdPKc(%struct.State* %0, i64 %281, %struct.Memory* %call2_404caa)
