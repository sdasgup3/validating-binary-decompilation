...
block_.L_404cdf:                                  ; preds = %block_.L_404d33, %entry
  %69 = phi i64 [ %.pre, %entry ], [ %267, %block_.L_404d33 ]
...
block_.L_404cfa:                                  ; preds = %block_404d06, %block_404cef
  %112 = phi i64 [ %.pre1, %block_404cef ], [ %225, %block_404d06 ]
...
block_.L_404d33:                                  ; preds = %block_.L_404cfa
  ...
  %call2_404d37 = tail call %struct.Memory* @sub_416a10._Z17check_shifted_sumIh34custom_multiple_constant_multiply2IhEEvT_(%struct.State* %0, i64 %231, %struct.Memory* %MEMORY.1)
...
block_.L_404d4a:                                  ; preds = %block_.L_404cdf
  ...
  %call2_404d4a = tail call %struct.Memory* @sub_400e60._Z5timerv(%struct.State* %0, i64 %268, %struct.Memory* %MEMORY.0)
  ...
  %call2_404d53 = tail call %struct.Memory* @sub_400800._Z13record_resultdPKc(%struct.State* %0, i64 %279, %struct.Memory* %call2_404d4a)
