...
define %struct.Memory* @_Z13test_constantIi10custom_twoIiEEvPT_iPKc(%struct.State* noalias, i64, %struct.Memory* noalias) #2 {
entry:
  ...
  store i32 %93, i32* %97
  store %struct.Memory* %loadMem_40806c, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem1_408073, %struct.Memory** %MEMORY
...
block_.L_40807f:                                  ; preds = %block_.L_4080cd, %entry
  ...
  store %struct.Memory* %loadMem_408089, %struct.Memory** %MEMORY
...
block_40808f:                                     ; preds = %block_.L_40807f
  ...
  store i32 0, i32* %236
  store %struct.Memory* %loadMem_408096, %struct.Memory** %MEMORY
  br label %block_.L_40809d

block_.L_40809d:                                  ; preds = %block_4080a9, %block_40808f
  ...
  store %struct.Memory* %loadMem_4080a3, %struct.Memory** %MEMORY
...
block_4080a9:                                     ; preds = %block_.L_40809d
  ...
  store %struct.Memory* %loadMem_4080a9, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_4080ad, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem1_4080b4, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_4080b9, %struct.Memory** %MEMORY
...
block_.L_4080cd:                                  ; preds = %block_.L_40809d
  ...
  store %struct.Memory* %loadMem1_4080d0, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_4080de, %struct.Memory** %MEMORY
  br label %block_.L_40807f

block_.L_4080e3:                                  ; preds = %block_.L_40807f
  ...
  store %struct.Memory* %loadMem1_4080e3, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem1_4080ec, %struct.Memory** %MEMORY
  ...
  ret %struct.Memory* %loadMem_4080f6
}
