...
block_.L_40807f:                                  ; preds = %block_.L_4080cd, %entry
  %68 = phi i64 [ %.pre, %entry ], [ %278, %block_.L_4080cd ]
...
block_.L_40809d:                                  ; preds = %block_4080a9, %block_40808f
  %111 = phi i64 [ %.pre1, %block_40808f ], [ %235, %block_4080a9 ]
...
block_.L_4080cd:                                  ; preds = %block_.L_40809d
  ...
  %call2_4080d0 = tail call %struct.Memory* @sub_413d90._Z17check_shifted_sumIi10custom_twoIiEEvT_(%struct.State* %0, i64 %241, %struct.Memory* %MEMORY.1)
...
block_.L_4080e3:                                  ; preds = %block_.L_40807f
  ...
  %call2_4080e3 = tail call %struct.Memory* @sub_400e60._Z5timerv(%struct.State* %0, i64 %279, %struct.Memory* %MEMORY.0)
  ...
  %call2_4080ec = tail call %struct.Memory* @sub_400800._Z13record_resultdPKc(%struct.State* %0, i64 %290, %struct.Memory* %call2_4080e3)
