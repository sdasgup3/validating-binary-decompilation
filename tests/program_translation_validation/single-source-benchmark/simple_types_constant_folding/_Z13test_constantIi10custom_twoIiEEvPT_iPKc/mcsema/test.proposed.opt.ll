...
declare %struct.Memory* @sub_413d90._Z17check_shifted_sumIi10custom_twoIiEEvT_(%struct.State* noalias dereferenceable(3376), i64, %struct.Memory* noalias readnone returned) local_unnamed_addr
...
entry:
  ...
  %call2_408073 = tail call %struct.Memory* @sub_400e40._Z11start_timerv(%struct.State* %0, i64 %58, %struct.Memory* %2)
...
block_.L_40807f:                                  ; preds = %block_.L_4080cd, %entry
  %68 = phi i64 [ %.pre, %entry ], [ %276, %block_.L_4080cd ]
  %MEMORY.0 = phi %struct.Memory* [ %call2_408073, %entry ], [ %call2_4080d0, %block_.L_4080cd ]
  ...
  br i1 %101, label %block_40808f, label %block_.L_4080e3
...
block_.L_40809d:                                  ; preds = %block_4080a9, %block_40808f
  %111 = phi i64 [ %.pre1, %block_40808f ], [ %234, %block_4080a9 ]
  %MEMORY.1 = phi %struct.Memory* [ %MEMORY.0, %block_40808f ], [ %call2_4080b4, %block_4080a9 ]
  ...
  br i1 %147, label %block_4080a9, label %block_.L_4080cd
...
block_4080a9:                                     ; preds = %block_.L_40809d
  ...
  %call2_4080b4 = tail call %struct.Memory* @sub_413d80._ZN10custom_twoIiE8do_shiftEi(%struct.State* %0, i64 %162, %struct.Memory* %MEMORY.1)
...
block_.L_4080cd:                                  ; preds = %block_.L_40809d
  ...
  %call2_4080d0 = tail call %struct.Memory* @sub_413d90._Z17check_shifted_sumIi10custom_twoIiEEvT_(%struct.State* %0, i64 %240, %struct.Memory* %MEMORY.1)
...
block_.L_4080e3:                                  ; preds = %block_.L_40807f
  ...
  %call2_4080e3 = tail call %struct.Memory* @sub_400e60._Z5timerv(%struct.State* %0, i64 %277, %struct.Memory* %MEMORY.0)
  ...
  %call2_4080ec = tail call %struct.Memory* @sub_400800._Z13record_resultdPKc(%struct.State* %0, i64 %288, %struct.Memory* %call2_4080e3)
  ...
  ret %struct.Memory* %call2_4080ec
}
...
define %struct.Memory* @routine_jge_.L_4080e3(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i8* %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
...
define %struct.Memory* @routine_jge_.L_4080cd(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i8* %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 2, i32 9
...
define %struct.Memory* @routine_jmpq_.L_40809d(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
...
define %struct.Memory* @routine_callq_._Z17check_shifted_sumIi10custom_twoIiEEvT_(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
...
define %struct.Memory* @routine_jmpq_.L_40807f(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
