...
declare %struct.Memory* @sub_413dd0._Z17check_shifted_sumIi10custom_twoIiEEvT_(%struct.State* noalias dereferenceable(3376), i64, %struct.Memory* noalias readnone returned) local_unnamed_addr
...
block_.L_4080bf:                                  ; preds = %block_.L_40810d, %entry
  %68 = phi i64 [ %276, %block_.L_40810d ], [ %.pre, %entry ]
...
block_.L_4080dd:                                  ; preds = %block_4080e9, %block_4080cf
  %111 = phi i64 [ %234, %block_4080e9 ], [ %.pre6, %block_4080cf ]
...
block_4080e9:                                     ; preds = %block_.L_4080dd
  ...
  %call2_4080f4 = tail call %struct.Memory* @sub_413dc0._ZN10custom_twoIiE8do_shiftEi(%struct.State* nonnull %0, i64 %162, %struct.Memory* %call2_4080b3)
...
block_.L_40810d:                                  ; preds = %block_.L_4080dd
  ...
  %call2_408110 = tail call %struct.Memory* @sub_413dd0._Z17check_shifted_sumIi10custom_twoIiEEvT_(%struct.State* nonnull %0, i64 %240, %struct.Memory* %call2_4080b3)
...
block_.L_408123:                                  ; preds = %block_.L_4080bf
  ...
  %call2_408123 = tail call %struct.Memory* @sub_400ea0._Z5timerv(%struct.State* nonnull %0, i64 %277, %struct.Memory* %call2_4080b3)
