...
define %struct.Memory* @_Z13test_constantIi18custom_constant_orIiEEvPT_iPKc(%struct.State* noalias, i64, %struct.Memory* noalias) #1 {
entry:
  ...
  store %struct.Memory* %loadMem_409220, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_409224, %struct.Memory** %MEMORY
  ...
  store i64 %78, i64* %81
  store %struct.Memory* %loadMem_409228, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_40922f, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem1_409233, %struct.Memory** %MEMORY
...
block_.L_40923f:                                  ; preds = %block_.L_40928d, %entry
...
block_40924f:                                     ; preds = %block_.L_40923f
...
block_.L_40925d:                                  ; preds = %block_409269, %block_40924f
  ...
  store %struct.Memory* %loadMem_409260, %struct.Memory** %MEMORY
...
block_409269:                                     ; preds = %block_.L_40925d
  ...
  store %struct.Memory* %loadMem_409269, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem1_409274, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_40927c, %struct.Memory** %MEMORY
...
block_.L_40928d:                                  ; preds = %block_.L_40925d
  ...
  store %struct.Memory* %loadMem1_409290, %struct.Memory** %MEMORY
...
block_.L_4092a3:                                  ; preds = %block_.L_40923f
  ...
  store %struct.Memory* %loadMem1_4092a3, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem1_4092ac, %struct.Memory** %MEMORY
  ...
  ret %struct.Memory* %loadMem_4092b6
}
