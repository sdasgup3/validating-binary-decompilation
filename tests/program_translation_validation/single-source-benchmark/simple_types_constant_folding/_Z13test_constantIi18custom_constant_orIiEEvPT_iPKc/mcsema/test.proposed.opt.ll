...
declare %struct.Memory* @sub_4130c0._Z17check_shifted_sumIi18custom_constant_orIiEEvT_(%struct.State* noalias dereferenceable(3376), i64, %struct.Memory* noalias readnone returned) local_unnamed_addr
...
entry:
  ...
  %call2_409243 = tail call %struct.Memory* @sub_400e90._Z11start_timerv(%struct.State* %0, i64 %58, %struct.Memory* %2)
...
block_.L_40924f:                                  ; preds = %block_.L_40929d, %entry
  %68 = phi i64 [ %276, %block_.L_40929d ], [ %.pre, %entry ]
  ...
  br i1 %101, label %block_40925f, label %block_.L_4092b3
...
block_.L_40926d:                                  ; preds = %block_409279, %block_40925f
  %111 = phi i64 [ %234, %block_409279 ], [ %.pre6, %block_40925f ]
  ...
  br i1 %147, label %block_409279, label %block_.L_40929d
...
block_409279:                                     ; preds = %block_.L_40926d
  ...
  %call2_409284 = tail call %struct.Memory* @sub_4130a0._ZN18custom_constant_orIiE8do_shiftEi(%struct.State* nonnull %0, i64 %162, %struct.Memory* %call2_409243)
...
block_.L_40929d:                                  ; preds = %block_.L_40926d
  ...
  %call2_4092a0 = tail call %struct.Memory* @sub_4130c0._Z17check_shifted_sumIi18custom_constant_orIiEEvT_(%struct.State* nonnull %0, i64 %240, %struct.Memory* %call2_409243)
...
block_.L_4092b3:                                  ; preds = %block_.L_40924f
  ...
  %call2_4092b3 = tail call %struct.Memory* @sub_400eb0._Z5timerv(%struct.State* nonnull %0, i64 %277, %struct.Memory* %call2_409243)
  ...
  %call2_4092bc = tail call %struct.Memory* @sub_400850._Z13record_resultdPKc(%struct.State* nonnull %0, i64 %288, %struct.Memory* %call2_4092b3)
