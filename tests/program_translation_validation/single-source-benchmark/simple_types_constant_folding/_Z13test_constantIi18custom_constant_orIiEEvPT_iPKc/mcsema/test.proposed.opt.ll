...
block_.L_4091ff:                                  ; preds = %block_.L_40924d, %entry
  %68 = phi i64 [ %.pre, %entry ], [ %278, %block_.L_40924d ]
...
block_.L_40921d:                                  ; preds = %block_409229, %block_40920f
  %111 = phi i64 [ %.pre1, %block_40920f ], [ %235, %block_409229 ]
...
block_.L_40924d:                                  ; preds = %block_.L_40921d
  ...
  %call2_409250 = tail call %struct.Memory* @sub_413070._Z17check_shifted_sumIi18custom_constant_orIiEEvT_(%struct.State* %0, i64 %241, %struct.Memory* %MEMORY.1)
...
block_.L_409263:                                  ; preds = %block_.L_4091ff
  ...
  %call2_409263 = tail call %struct.Memory* @sub_400e60._Z5timerv(%struct.State* %0, i64 %279, %struct.Memory* %MEMORY.0)
  ...
  %call2_40926c = tail call %struct.Memory* @sub_400800._Z13record_resultdPKc(%struct.State* %0, i64 %290, %struct.Memory* %call2_409263)
