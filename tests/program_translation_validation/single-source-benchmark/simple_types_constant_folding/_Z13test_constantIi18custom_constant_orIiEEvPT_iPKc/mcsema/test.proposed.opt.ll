...
declare %struct.Memory* @sub_4130b0._Z17check_shifted_sumIi18custom_constant_orIiEEvT_(%struct.State* noalias dereferenceable(3376), i64, %struct.Memory* noalias readnone returned) local_unnamed_addr
...
define %struct.Memory* @_Z13test_constantIi18custom_constant_orIiEEvPT_iPKc(%struct.State* noalias, i64, %struct.Memory* noalias readnone) local_unnamed_addr #1 {
entry:
...
block_.L_40923f:                                  ; preds = %block_.L_40928d, %entry
  %68 = phi i64 [ %276, %block_.L_40928d ], [ %.pre, %entry ]
...
block_.L_40925d:                                  ; preds = %block_409269, %block_40924f
  %111 = phi i64 [ %234, %block_409269 ], [ %.pre6, %block_40924f ]
...
block_409269:                                     ; preds = %block_.L_40925d
  ...
  %call2_409274 = tail call %struct.Memory* @sub_413090._ZN18custom_constant_orIiE8do_shiftEi(%struct.State* nonnull %0, i64 %162, %struct.Memory* %call2_409233)
...
block_.L_40928d:                                  ; preds = %block_.L_40925d
  ...
  %call2_409290 = tail call %struct.Memory* @sub_4130b0._Z17check_shifted_sumIi18custom_constant_orIiEEvT_(%struct.State* nonnull %0, i64 %240, %struct.Memory* %call2_409233)
...
block_.L_4092a3:                                  ; preds = %block_.L_40923f
  ...
  %call2_4092a3 = tail call %struct.Memory* @sub_400ea0._Z5timerv(%struct.State* nonnull %0, i64 %277, %struct.Memory* %call2_409233)
