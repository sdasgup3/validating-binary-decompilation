...
declare %struct.Memory* @sub_413740._Z17check_shifted_sumIi19custom_constant_addIiEEvT_(%struct.State* noalias dereferenceable(3376), i64, %struct.Memory* noalias readnone returned) local_unnamed_addr
...
define %struct.Memory* @_Z13test_constantIi19custom_constant_addIiEEvPT_iPKc(%struct.State* noalias, i64, %struct.Memory* noalias readnone) local_unnamed_addr #1 {
entry:
...
block_.L_408a1f:                                  ; preds = %block_.L_408a6d, %entry
  %68 = phi i64 [ %276, %block_.L_408a6d ], [ %.pre, %entry ]
...
block_.L_408a3d:                                  ; preds = %block_408a49, %block_408a2f
  %111 = phi i64 [ %234, %block_408a49 ], [ %.pre6, %block_408a2f ]
...
block_408a49:                                     ; preds = %block_.L_408a3d
  ...
  %call2_408a54 = tail call %struct.Memory* @sub_413720._ZN19custom_constant_addIiE8do_shiftEi(%struct.State* nonnull %0, i64 %162, %struct.Memory* %call2_408a13)
...
block_.L_408a6d:                                  ; preds = %block_.L_408a3d
  ...
  %call2_408a70 = tail call %struct.Memory* @sub_413740._Z17check_shifted_sumIi19custom_constant_addIiEEvT_(%struct.State* nonnull %0, i64 %240, %struct.Memory* %call2_408a13)
...
block_.L_408a83:                                  ; preds = %block_.L_408a1f
  ...
  %call2_408a83 = tail call %struct.Memory* @sub_400ea0._Z5timerv(%struct.State* nonnull %0, i64 %277, %struct.Memory* %call2_408a13)
