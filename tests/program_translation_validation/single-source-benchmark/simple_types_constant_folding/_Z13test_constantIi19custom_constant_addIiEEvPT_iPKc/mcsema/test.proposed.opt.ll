...
declare %struct.Memory* @sub_413750._Z17check_shifted_sumIi19custom_constant_addIiEEvT_(%struct.State* noalias dereferenceable(3376), i64, %struct.Memory* noalias readnone returned) local_unnamed_addr
...
entry:
  ...
  %call2_408a23 = tail call %struct.Memory* @sub_400e90._Z11start_timerv(%struct.State* %0, i64 %58, %struct.Memory* %2)
...
block_.L_408a2f:                                  ; preds = %block_.L_408a7d, %entry
  %68 = phi i64 [ %276, %block_.L_408a7d ], [ %.pre, %entry ]
  ...
  br i1 %101, label %block_408a3f, label %block_.L_408a93

block_408a3f:                                     ; preds = %block_.L_408a2f
  %103 = add i64 %69, -32
  %104 = add i64 %102, 7
...
block_.L_408a4d:                                  ; preds = %block_408a59, %block_408a3f
  %111 = phi i64 [ %234, %block_408a59 ], [ %.pre6, %block_408a3f ]
  ...
  br i1 %147, label %block_408a59, label %block_.L_408a7d

block_408a59:                                     ; preds = %block_.L_408a4d
  %149 = add i64 %112, -8
  %150 = add i64 %148, 4
  ...
  %call2_408a64 = tail call %struct.Memory* @sub_413730._ZN19custom_constant_addIiE8do_shiftEi(%struct.State* nonnull %0, i64 %162, %struct.Memory* %call2_408a23)
...
block_.L_408a7d:                                  ; preds = %block_.L_408a4d
  %235 = add i64 %112, -32
  %236 = add i64 %148, 3
  ...
  %call2_408a80 = tail call %struct.Memory* @sub_413750._Z17check_shifted_sumIi19custom_constant_addIiEEvT_(%struct.State* nonnull %0, i64 %240, %struct.Memory* %call2_408a23)
...
block_.L_408a93:                                  ; preds = %block_.L_408a2f
  ...
  %call2_408a93 = tail call %struct.Memory* @sub_400eb0._Z5timerv(%struct.State* nonnull %0, i64 %277, %struct.Memory* %call2_408a23)
  ...
  %call2_408a9c = tail call %struct.Memory* @sub_400850._Z13record_resultdPKc(%struct.State* nonnull %0, i64 %288, %struct.Memory* %call2_408a93)
