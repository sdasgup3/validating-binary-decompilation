...
block_.L_4089df:                                  ; preds = %block_.L_408a2d, %entry
  %68 = phi i64 [ %.pre, %entry ], [ %276, %block_.L_408a2d ]
...
block_.L_4089fd:                                  ; preds = %block_408a09, %block_4089ef
  %111 = phi i64 [ %.pre1, %block_4089ef ], [ %234, %block_408a09 ]
...
block_.L_408a2d:                                  ; preds = %block_.L_4089fd
  ...
  %call2_408a30 = tail call %struct.Memory* @sub_413700._Z17check_shifted_sumIi19custom_constant_addIiEEvT_(%struct.State* %0, i64 %240, %struct.Memory* %MEMORY.1)
...
block_.L_408a43:                                  ; preds = %block_.L_4089df
  ...
  %call2_408a43 = tail call %struct.Memory* @sub_400e60._Z5timerv(%struct.State* %0, i64 %277, %struct.Memory* %MEMORY.0)
  ...
  %call2_408a4c = tail call %struct.Memory* @sub_400800._Z13record_resultdPKc(%struct.State* %0, i64 %288, %struct.Memory* %call2_408a43)
