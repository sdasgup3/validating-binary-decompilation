...
declare %struct.Memory* @sub_413190._ZN19custom_constant_andIiE8do_shiftEi(%struct.State* dereferenceable(3376), i64, %struct.Memory*) local_unnamed_addr

declare %struct.Memory* @sub_4131b0._Z17check_shifted_sumIi19custom_constant_andIiEEvT_(%struct.State* dereferenceable(3376), i64, %struct.Memory*) local_unnamed_addr
...
block_.L_4090ff:                                  ; preds = %block_.L_40914d, %entry
  %68 = phi i64 [ %.pre, %entry ], [ %276, %block_.L_40914d ]
  %MEMORY.0 = phi %struct.Memory* [ %call2_4090f3, %entry ], [ %call2_409150, %block_.L_40914d ]
...
block_.L_40911d:                                  ; preds = %block_409129, %block_40910f
  %111 = phi i64 [ %.pre6, %block_40910f ], [ %234, %block_409129 ]
  %MEMORY.1 = phi %struct.Memory* [ %MEMORY.0, %block_40910f ], [ %call2_409134, %block_409129 ]
...
block_409129:                                     ; preds = %block_.L_40911d
  ...
  %call2_409134 = tail call %struct.Memory* @sub_413190._ZN19custom_constant_andIiE8do_shiftEi(%struct.State* nonnull %0, i64 %162, %struct.Memory* %MEMORY.1)
...
block_.L_40914d:                                  ; preds = %block_.L_40911d
  ...
  %call2_409150 = tail call %struct.Memory* @sub_4131b0._Z17check_shifted_sumIi19custom_constant_andIiEEvT_(%struct.State* nonnull %0, i64 %240, %struct.Memory* %MEMORY.1)
...
block_.L_409163:                                  ; preds = %block_.L_4090ff
  ...
  %call2_409163 = tail call %struct.Memory* @sub_400ea0._Z5timerv(%struct.State* nonnull %0, i64 %277, %struct.Memory* %MEMORY.0)
