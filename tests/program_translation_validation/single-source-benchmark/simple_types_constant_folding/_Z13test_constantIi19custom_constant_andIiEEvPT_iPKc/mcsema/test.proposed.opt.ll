...
block_.L_4090bf:                                  ; preds = %block_.L_40910d, %entry
  %68 = phi i64 [ %.pre, %entry ], [ %276, %block_.L_40910d ]
...
block_.L_4090dd:                                  ; preds = %block_4090e9, %block_4090cf
  %111 = phi i64 [ %.pre1, %block_4090cf ], [ %234, %block_4090e9 ]
...
block_.L_40910d:                                  ; preds = %block_.L_4090dd
  ...
  %call2_409110 = tail call %struct.Memory* @sub_413170._Z17check_shifted_sumIi19custom_constant_andIiEEvT_(%struct.State* %0, i64 %240, %struct.Memory* %MEMORY.1)
...
block_.L_409123:                                  ; preds = %block_.L_4090bf
  ...
  %call2_409123 = tail call %struct.Memory* @sub_400e60._Z5timerv(%struct.State* %0, i64 %277, %struct.Memory* %MEMORY.0)
  ...
  %call2_40912c = tail call %struct.Memory* @sub_400800._Z13record_resultdPKc(%struct.State* %0, i64 %288, %struct.Memory* %call2_409123)
