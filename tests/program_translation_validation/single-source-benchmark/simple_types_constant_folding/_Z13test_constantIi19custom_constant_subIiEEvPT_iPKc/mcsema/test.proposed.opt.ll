...
block_.L_408b1f:                                  ; preds = %block_.L_408b6d, %entry
  %68 = phi i64 [ %.pre, %entry ], [ %276, %block_.L_408b6d ]
...
block_.L_408b3d:                                  ; preds = %block_408b49, %block_408b2f
  %111 = phi i64 [ %.pre1, %block_408b2f ], [ %234, %block_408b49 ]
...
block_.L_408b6d:                                  ; preds = %block_.L_408b3d
  ...
  %call2_408b70 = tail call %struct.Memory* @sub_413600._Z17check_shifted_sumIi19custom_constant_subIiEEvT_(%struct.State* %0, i64 %240, %struct.Memory* %MEMORY.1)
...
block_.L_408b83:                                  ; preds = %block_.L_408b1f
  ...
  %call2_408b83 = tail call %struct.Memory* @sub_400e60._Z5timerv(%struct.State* %0, i64 %277, %struct.Memory* %MEMORY.0)
  ...
  %call2_408b8c = tail call %struct.Memory* @sub_400800._Z13record_resultdPKc(%struct.State* %0, i64 %288, %struct.Memory* %call2_408b83)
