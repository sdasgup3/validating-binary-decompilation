...
declare %struct.Memory* @sub_413640._Z17check_shifted_sumIi19custom_constant_subIiEEvT_(%struct.State* noalias dereferenceable(3376), i64, %struct.Memory* noalias readnone returned) local_unnamed_addr
...
block_.L_408b5f:                                  ; preds = %block_.L_408bad, %entry
  %68 = phi i64 [ %276, %block_.L_408bad ], [ %.pre, %entry ]
...
block_.L_408b7d:                                  ; preds = %block_408b89, %block_408b6f
  %111 = phi i64 [ %234, %block_408b89 ], [ %.pre6, %block_408b6f ]
...
block_408b89:                                     ; preds = %block_.L_408b7d
  ...
  %call2_408b94 = tail call %struct.Memory* @sub_413620._ZN19custom_constant_subIiE8do_shiftEi(%struct.State* nonnull %0, i64 %162, %struct.Memory* %call2_408b53)
...
block_.L_408bad:                                  ; preds = %block_.L_408b7d
  ...
  %call2_408bb0 = tail call %struct.Memory* @sub_413640._Z17check_shifted_sumIi19custom_constant_subIiEEvT_(%struct.State* nonnull %0, i64 %240, %struct.Memory* %call2_408b53)
...
block_.L_408bc3:                                  ; preds = %block_.L_408b5f
  ...
  %call2_408bc3 = tail call %struct.Memory* @sub_400ea0._Z5timerv(%struct.State* nonnull %0, i64 %277, %struct.Memory* %call2_408b53)
