...
declare %struct.Memory* @sub_412f90._ZN19custom_constant_xorIiE8do_shiftEi(%struct.State* dereferenceable(3376), i64, %struct.Memory*)

declare %struct.Memory* @sub_412fb0._Z17check_shifted_sumIi19custom_constant_xorIiEEvT_(%struct.State* dereferenceable(3376), i64, %struct.Memory*)
...
define %struct.Memory* @_Z13test_constantIi19custom_constant_xorIiEEvPT_iPKc(%struct.State* noalias, i64, %struct.Memory* noalias) #1 {
entry:
