...
block_.L_40933f:                                  ; preds = %block_.L_40938d, %entry
  %68 = phi i64 [ %.pre, %entry ], [ %276, %block_.L_40938d ]
...
block_.L_40935d:                                  ; preds = %block_409369, %block_40934f
  %111 = phi i64 [ %.pre1, %block_40934f ], [ %234, %block_409369 ]
...
block_.L_40938d:                                  ; preds = %block_.L_40935d
  ...
  %call2_409390 = tail call %struct.Memory* @sub_412f70._Z17check_shifted_sumIi19custom_constant_xorIiEEvT_(%struct.State* %0, i64 %240, %struct.Memory* %MEMORY.1)
...
block_.L_4093a3:                                  ; preds = %block_.L_40933f
  ...
  %call2_4093a3 = tail call %struct.Memory* @sub_400e60._Z5timerv(%struct.State* %0, i64 %277, %struct.Memory* %MEMORY.0)
  ...
  %call2_4093ac = tail call %struct.Memory* @sub_400800._Z13record_resultdPKc(%struct.State* %0, i64 %288, %struct.Memory* %call2_4093a3)
