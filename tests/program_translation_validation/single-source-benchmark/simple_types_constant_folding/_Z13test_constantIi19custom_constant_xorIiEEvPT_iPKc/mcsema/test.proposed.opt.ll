...
declare %struct.Memory* @sub_412f90._ZN19custom_constant_xorIiE8do_shiftEi(%struct.State* dereferenceable(3376), i64, %struct.Memory*) local_unnamed_addr

declare %struct.Memory* @sub_412fb0._Z17check_shifted_sumIi19custom_constant_xorIiEEvT_(%struct.State* dereferenceable(3376), i64, %struct.Memory*) local_unnamed_addr
...
block_.L_40937f:                                  ; preds = %block_.L_4093cd, %entry
  %68 = phi i64 [ %.pre, %entry ], [ %276, %block_.L_4093cd ]
  %MEMORY.0 = phi %struct.Memory* [ %call2_409373, %entry ], [ %call2_4093d0, %block_.L_4093cd ]
...
block_.L_40939d:                                  ; preds = %block_4093a9, %block_40938f
  %111 = phi i64 [ %.pre6, %block_40938f ], [ %234, %block_4093a9 ]
  %MEMORY.1 = phi %struct.Memory* [ %MEMORY.0, %block_40938f ], [ %call2_4093b4, %block_4093a9 ]
...
block_4093a9:                                     ; preds = %block_.L_40939d
  ...
  %call2_4093b4 = tail call %struct.Memory* @sub_412f90._ZN19custom_constant_xorIiE8do_shiftEi(%struct.State* nonnull %0, i64 %162, %struct.Memory* %MEMORY.1)
...
block_.L_4093cd:                                  ; preds = %block_.L_40939d
  ...
  %call2_4093d0 = tail call %struct.Memory* @sub_412fb0._Z17check_shifted_sumIi19custom_constant_xorIiEEvT_(%struct.State* nonnull %0, i64 %240, %struct.Memory* %MEMORY.1)
...
block_.L_4093e3:                                  ; preds = %block_.L_40937f
  ...
  %call2_4093e3 = tail call %struct.Memory* @sub_400ea0._Z5timerv(%struct.State* nonnull %0, i64 %277, %struct.Memory* %MEMORY.0)
