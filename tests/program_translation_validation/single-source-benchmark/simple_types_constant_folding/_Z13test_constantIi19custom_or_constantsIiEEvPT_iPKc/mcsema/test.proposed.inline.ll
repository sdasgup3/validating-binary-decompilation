...
declare %struct.Memory* @sub_413810._ZN19custom_or_constantsIiE8do_shiftEi(%struct.State* dereferenceable(3376), i64, %struct.Memory*)

declare %struct.Memory* @sub_413820._Z17check_shifted_sumIi19custom_or_constantsIiEEvT_(%struct.State* dereferenceable(3376), i64, %struct.Memory*)
...
define %struct.Memory* @_Z13test_constantIi19custom_or_constantsIiEEvPT_iPKc(%struct.State* noalias, i64, %struct.Memory* noalias) #1 {
entry:
