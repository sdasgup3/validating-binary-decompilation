...
block_.L_40889f:                                  ; preds = %block_.L_4088ed, %entry
  %68 = phi i64 [ %.pre, %entry ], [ %278, %block_.L_4088ed ]
...
block_.L_4088bd:                                  ; preds = %block_4088c9, %block_4088af
  %111 = phi i64 [ %.pre1, %block_4088af ], [ %235, %block_4088c9 ]
...
block_.L_4088ed:                                  ; preds = %block_.L_4088bd
  ...
  %call2_4088f0 = tail call %struct.Memory* @sub_4137e0._Z17check_shifted_sumIi19custom_or_constantsIiEEvT_(%struct.State* %0, i64 %241, %struct.Memory* %MEMORY.1)
...
block_.L_408903:                                  ; preds = %block_.L_40889f
  ...
  %call2_408903 = tail call %struct.Memory* @sub_400e60._Z5timerv(%struct.State* %0, i64 %279, %struct.Memory* %MEMORY.0)
  ...
  %call2_40890c = tail call %struct.Memory* @sub_400800._Z13record_resultdPKc(%struct.State* %0, i64 %290, %struct.Memory* %call2_408903)
