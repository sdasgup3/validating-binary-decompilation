...
declare %struct.Memory* @sub_413820._ZN19custom_or_constantsIiE8do_shiftEi(%struct.State* noalias dereferenceable(3376), i64, %struct.Memory* noalias readnone returned) local_unnamed_addr

declare %struct.Memory* @sub_413830._Z17check_shifted_sumIi19custom_or_constantsIiEEvT_(%struct.State* noalias dereferenceable(3376), i64, %struct.Memory* noalias readnone returned) local_unnamed_addr
...
entry:
  ...
  %call2_4088e3 = tail call %struct.Memory* @sub_400e90._Z11start_timerv(%struct.State* %0, i64 %58, %struct.Memory* %2)
...
block_.L_4088ef:                                  ; preds = %block_.L_40893d, %entry
  %68 = phi i64 [ %276, %block_.L_40893d ], [ %.pre, %entry ]
  ...
  br i1 %101, label %block_4088ff, label %block_.L_408953
...
block_.L_40890d:                                  ; preds = %block_408919, %block_4088ff
  %111 = phi i64 [ %234, %block_408919 ], [ %.pre6, %block_4088ff ]
  ...
  br i1 %147, label %block_408919, label %block_.L_40893d
...
block_408919:                                     ; preds = %block_.L_40890d
  ...
  %call2_408924 = tail call %struct.Memory* @sub_413820._ZN19custom_or_constantsIiE8do_shiftEi(%struct.State* nonnull %0, i64 %162, %struct.Memory* %call2_4088e3)
...
block_.L_40893d:                                  ; preds = %block_.L_40890d
  ...
  %call2_408940 = tail call %struct.Memory* @sub_413830._Z17check_shifted_sumIi19custom_or_constantsIiEEvT_(%struct.State* nonnull %0, i64 %240, %struct.Memory* %call2_4088e3)
...
block_.L_408953:                                  ; preds = %block_.L_4088ef
  ...
  %call2_408953 = tail call %struct.Memory* @sub_400eb0._Z5timerv(%struct.State* nonnull %0, i64 %277, %struct.Memory* %call2_4088e3)
  ...
  %call2_40895c = tail call %struct.Memory* @sub_400850._Z13record_resultdPKc(%struct.State* nonnull %0, i64 %288, %struct.Memory* %call2_408953)
