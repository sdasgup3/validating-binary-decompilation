...
declare %struct.Memory* @sub_413810._ZN19custom_or_constantsIiE8do_shiftEi(%struct.State* noalias dereferenceable(3376), i64, %struct.Memory* noalias readnone returned) local_unnamed_addr

declare %struct.Memory* @sub_413820._Z17check_shifted_sumIi19custom_or_constantsIiEEvT_(%struct.State* noalias dereferenceable(3376), i64, %struct.Memory* noalias readnone returned) local_unnamed_addr
...
define %struct.Memory* @_Z13test_constantIi19custom_or_constantsIiEEvPT_iPKc(%struct.State* noalias, i64, %struct.Memory* noalias readnone) local_unnamed_addr #1 {
entry:
...
block_.L_4088df:                                  ; preds = %block_.L_40892d, %entry
  %68 = phi i64 [ %276, %block_.L_40892d ], [ %.pre, %entry ]
...
block_.L_4088fd:                                  ; preds = %block_408909, %block_4088ef
  %111 = phi i64 [ %234, %block_408909 ], [ %.pre6, %block_4088ef ]
...
block_408909:                                     ; preds = %block_.L_4088fd
  ...
  %call2_408914 = tail call %struct.Memory* @sub_413810._ZN19custom_or_constantsIiE8do_shiftEi(%struct.State* nonnull %0, i64 %162, %struct.Memory* %call2_4088d3)
...
block_.L_40892d:                                  ; preds = %block_.L_4088fd
  ...
  %call2_408930 = tail call %struct.Memory* @sub_413820._Z17check_shifted_sumIi19custom_or_constantsIiEEvT_(%struct.State* nonnull %0, i64 %240, %struct.Memory* %call2_4088d3)
...
block_.L_408943:                                  ; preds = %block_.L_4088df
  ...
  %call2_408943 = tail call %struct.Memory* @sub_400ea0._Z5timerv(%struct.State* nonnull %0, i64 %277, %struct.Memory* %call2_4088d3)
