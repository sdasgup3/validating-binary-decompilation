...
declare %struct.Memory* @sub_413d50._ZN20custom_add_constantsIiE8do_shiftEi(%struct.State* dereferenceable(3376), i64, %struct.Memory*)

declare %struct.Memory* @sub_413d60._Z17check_shifted_sumIi20custom_add_constantsIiEEvT_(%struct.State* dereferenceable(3376), i64, %struct.Memory*)
...
define %struct.Memory* @_Z13test_constantIi20custom_add_constantsIiEEvPT_iPKc(%struct.State* noalias, i64, %struct.Memory* noalias) #1 {
entry:
