...
block_.L_40811f:                                  ; preds = %block_.L_40816d, %entry
  %68 = phi i64 [ %.pre, %entry ], [ %276, %block_.L_40816d ]
...
block_.L_40813d:                                  ; preds = %block_408149, %block_40812f
  %111 = phi i64 [ %.pre1, %block_40812f ], [ %234, %block_408149 ]
...
block_.L_40816d:                                  ; preds = %block_.L_40813d
  ...
  %call2_408170 = tail call %struct.Memory* @sub_413d20._Z17check_shifted_sumIi20custom_add_constantsIiEEvT_(%struct.State* %0, i64 %240, %struct.Memory* %MEMORY.1)
...
block_.L_408183:                                  ; preds = %block_.L_40811f
  ...
  %call2_408183 = tail call %struct.Memory* @sub_400e60._Z5timerv(%struct.State* %0, i64 %277, %struct.Memory* %MEMORY.0)
  ...
  %call2_40818c = tail call %struct.Memory* @sub_400800._Z13record_resultdPKc(%struct.State* %0, i64 %288, %struct.Memory* %call2_408183)
