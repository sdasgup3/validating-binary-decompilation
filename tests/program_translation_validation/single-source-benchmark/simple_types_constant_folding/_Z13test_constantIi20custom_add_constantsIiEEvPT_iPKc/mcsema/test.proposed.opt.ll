...
declare %struct.Memory* @sub_413d60._ZN20custom_add_constantsIiE8do_shiftEi(%struct.State* noalias dereferenceable(3376), i64, %struct.Memory* noalias readnone returned) local_unnamed_addr

declare %struct.Memory* @sub_413d70._Z17check_shifted_sumIi20custom_add_constantsIiEEvT_(%struct.State* noalias dereferenceable(3376), i64, %struct.Memory* noalias readnone returned) local_unnamed_addr
...
entry:
  ...
  %call2_408163 = tail call %struct.Memory* @sub_400e90._Z11start_timerv(%struct.State* %0, i64 %58, %struct.Memory* %2)
...
block_.L_40816f:                                  ; preds = %block_.L_4081bd, %entry
  %68 = phi i64 [ %276, %block_.L_4081bd ], [ %.pre, %entry ]
  ...
  br i1 %101, label %block_40817f, label %block_.L_4081d3
...
block_.L_40818d:                                  ; preds = %block_408199, %block_40817f
  %111 = phi i64 [ %234, %block_408199 ], [ %.pre6, %block_40817f ]
  ...
  br i1 %147, label %block_408199, label %block_.L_4081bd
...
block_408199:                                     ; preds = %block_.L_40818d
  ...
  %call2_4081a4 = tail call %struct.Memory* @sub_413d60._ZN20custom_add_constantsIiE8do_shiftEi(%struct.State* nonnull %0, i64 %162, %struct.Memory* %call2_408163)
...
block_.L_4081bd:                                  ; preds = %block_.L_40818d
  ...
  %call2_4081c0 = tail call %struct.Memory* @sub_413d70._Z17check_shifted_sumIi20custom_add_constantsIiEEvT_(%struct.State* nonnull %0, i64 %240, %struct.Memory* %call2_408163)
...
block_.L_4081d3:                                  ; preds = %block_.L_40816f
  ...
  %call2_4081d3 = tail call %struct.Memory* @sub_400eb0._Z5timerv(%struct.State* nonnull %0, i64 %277, %struct.Memory* %call2_408163)
  ...
  %call2_4081dc = tail call %struct.Memory* @sub_400850._Z13record_resultdPKc(%struct.State* nonnull %0, i64 %288, %struct.Memory* %call2_4081d3)
