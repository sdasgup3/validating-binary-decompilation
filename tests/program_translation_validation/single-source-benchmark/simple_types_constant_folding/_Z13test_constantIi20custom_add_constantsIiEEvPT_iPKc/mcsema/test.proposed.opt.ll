...
declare %struct.Memory* @sub_413d50._ZN20custom_add_constantsIiE8do_shiftEi(%struct.State* noalias dereferenceable(3376), i64, %struct.Memory* noalias readnone returned) local_unnamed_addr

declare %struct.Memory* @sub_413d60._Z17check_shifted_sumIi20custom_add_constantsIiEEvT_(%struct.State* noalias dereferenceable(3376), i64, %struct.Memory* noalias readnone returned) local_unnamed_addr
...
define %struct.Memory* @_Z13test_constantIi20custom_add_constantsIiEEvPT_iPKc(%struct.State* noalias, i64, %struct.Memory* noalias readnone) local_unnamed_addr #1 {
entry:
...
block_.L_40815f:                                  ; preds = %block_.L_4081ad, %entry
  %68 = phi i64 [ %276, %block_.L_4081ad ], [ %.pre, %entry ]
...
block_.L_40817d:                                  ; preds = %block_408189, %block_40816f
  %111 = phi i64 [ %234, %block_408189 ], [ %.pre6, %block_40816f ]
...
block_408189:                                     ; preds = %block_.L_40817d
  ...
  %call2_408194 = tail call %struct.Memory* @sub_413d50._ZN20custom_add_constantsIiE8do_shiftEi(%struct.State* nonnull %0, i64 %162, %struct.Memory* %call2_408153)
...
block_.L_4081ad:                                  ; preds = %block_.L_40817d
  ...
  %call2_4081b0 = tail call %struct.Memory* @sub_413d60._Z17check_shifted_sumIi20custom_add_constantsIiEEvT_(%struct.State* nonnull %0, i64 %240, %struct.Memory* %call2_408153)
...
block_.L_4081c3:                                  ; preds = %block_.L_40815f
  ...
  %call2_4081c3 = tail call %struct.Memory* @sub_400ea0._Z5timerv(%struct.State* nonnull %0, i64 %277, %struct.Memory* %call2_408153)
