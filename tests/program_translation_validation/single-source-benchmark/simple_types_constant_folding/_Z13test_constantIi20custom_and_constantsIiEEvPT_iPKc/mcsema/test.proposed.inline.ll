...
define %struct.Memory* @_Z13test_constantIi20custom_and_constantsIiEEvPT_iPKc(%struct.State* noalias, i64, %struct.Memory* noalias) #1 {
entry:
  ...
  store %struct.Memory* %loadMem1_408833, %struct.Memory** %MEMORY
...
block_.L_40883f:                                  ; preds = %block_.L_40888d, %entry
  ...
  store %struct.Memory* %loadMem_408849, %struct.Memory** %MEMORY
...
block_40884f:                                     ; preds = %block_.L_40883f
  ...
  store i32 0, i32* %236
  store %struct.Memory* %loadMem_408856, %struct.Memory** %MEMORY
  br label %block_.L_40885d

block_.L_40885d:                                  ; preds = %block_408869, %block_40884f
...
block_408869:                                     ; preds = %block_.L_40885d
  ...
  store %struct.Memory* %loadMem1_408874, %struct.Memory** %MEMORY
...
block_.L_40888d:                                  ; preds = %block_.L_40885d
  ...
  store %struct.Memory* %loadMem1_408890, %struct.Memory** %MEMORY
...
block_.L_4088a3:                                  ; preds = %block_.L_40883f
  ...
  store %struct.Memory* %loadMem1_4088a3, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem1_4088ac, %struct.Memory** %MEMORY
  ...
  ret %struct.Memory* %loadMem_4088b6
}
