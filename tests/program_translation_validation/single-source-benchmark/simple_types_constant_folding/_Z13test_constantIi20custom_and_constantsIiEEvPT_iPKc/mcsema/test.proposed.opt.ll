...
block_.L_4087ff:                                  ; preds = %block_.L_40884d, %entry
  %68 = phi i64 [ %.pre, %entry ], [ %278, %block_.L_40884d ]
...
block_.L_40881d:                                  ; preds = %block_408829, %block_40880f
  %111 = phi i64 [ %.pre1, %block_40880f ], [ %235, %block_408829 ]
...
block_.L_40884d:                                  ; preds = %block_.L_40881d
  ...
  %call2_408850 = tail call %struct.Memory* @sub_413850._Z17check_shifted_sumIi20custom_and_constantsIiEEvT_(%struct.State* %0, i64 %241, %struct.Memory* %MEMORY.1)
...
block_.L_408863:                                  ; preds = %block_.L_4087ff
  ...
  %call2_408863 = tail call %struct.Memory* @sub_400e60._Z5timerv(%struct.State* %0, i64 %279, %struct.Memory* %MEMORY.0)
  ...
  %call2_40886c = tail call %struct.Memory* @sub_400800._Z13record_resultdPKc(%struct.State* %0, i64 %290, %struct.Memory* %call2_408863)
