...
declare %struct.Memory* @sub_413890._Z17check_shifted_sumIi20custom_and_constantsIiEEvT_(%struct.State* noalias dereferenceable(3376), i64, %struct.Memory* noalias readnone returned) local_unnamed_addr
...
define %struct.Memory* @_Z13test_constantIi20custom_and_constantsIiEEvPT_iPKc(%struct.State* noalias, i64, %struct.Memory* noalias readnone) local_unnamed_addr #1 {
entry:
...
block_.L_40883f:                                  ; preds = %block_.L_40888d, %entry
  %68 = phi i64 [ %276, %block_.L_40888d ], [ %.pre, %entry ]
...
block_.L_40885d:                                  ; preds = %block_408869, %block_40884f
  %111 = phi i64 [ %234, %block_408869 ], [ %.pre6, %block_40884f ]
...
block_408869:                                     ; preds = %block_.L_40885d
  ...
  %call2_408874 = tail call %struct.Memory* @sub_413880._ZN20custom_and_constantsIiE8do_shiftEi(%struct.State* nonnull %0, i64 %162, %struct.Memory* %call2_408833)
...
block_.L_40888d:                                  ; preds = %block_.L_40885d
  ...
  %call2_408890 = tail call %struct.Memory* @sub_413890._Z17check_shifted_sumIi20custom_and_constantsIiEEvT_(%struct.State* nonnull %0, i64 %240, %struct.Memory* %call2_408833)
...
block_.L_4088a3:                                  ; preds = %block_.L_40883f
  ...
  %call2_4088a3 = tail call %struct.Memory* @sub_400ea0._Z5timerv(%struct.State* nonnull %0, i64 %277, %struct.Memory* %call2_408833)
