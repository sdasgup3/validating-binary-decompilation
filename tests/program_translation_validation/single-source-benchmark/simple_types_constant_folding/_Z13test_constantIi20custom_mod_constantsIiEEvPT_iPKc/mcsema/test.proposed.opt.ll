...
declare %struct.Memory* @sub_413b90._ZN20custom_mod_constantsIiE8do_shiftEi(%struct.State* dereferenceable(3376), i64, %struct.Memory*) local_unnamed_addr

declare %struct.Memory* @sub_413ba0._Z17check_shifted_sumIi20custom_mod_constantsIiEEvT_(%struct.State* dereferenceable(3376), i64, %struct.Memory*) local_unnamed_addr
...
block_.L_4083df:                                  ; preds = %block_.L_40842d, %entry
  %68 = phi i64 [ %.pre, %entry ], [ %276, %block_.L_40842d ]
  %MEMORY.0 = phi %struct.Memory* [ %call2_4083d3, %entry ], [ %call2_408430, %block_.L_40842d ]
...
block_.L_4083fd:                                  ; preds = %block_408409, %block_4083ef
  %111 = phi i64 [ %.pre6, %block_4083ef ], [ %234, %block_408409 ]
  %MEMORY.1 = phi %struct.Memory* [ %MEMORY.0, %block_4083ef ], [ %call2_408414, %block_408409 ]
...
block_408409:                                     ; preds = %block_.L_4083fd
  ...
  %call2_408414 = tail call %struct.Memory* @sub_413b90._ZN20custom_mod_constantsIiE8do_shiftEi(%struct.State* nonnull %0, i64 %162, %struct.Memory* %MEMORY.1)
...
block_.L_40842d:                                  ; preds = %block_.L_4083fd
  ...
  %call2_408430 = tail call %struct.Memory* @sub_413ba0._Z17check_shifted_sumIi20custom_mod_constantsIiEEvT_(%struct.State* nonnull %0, i64 %240, %struct.Memory* %MEMORY.1)
...
block_.L_408443:                                  ; preds = %block_.L_4083df
  ...
  %call2_408443 = tail call %struct.Memory* @sub_400ea0._Z5timerv(%struct.State* nonnull %0, i64 %277, %struct.Memory* %MEMORY.0)
