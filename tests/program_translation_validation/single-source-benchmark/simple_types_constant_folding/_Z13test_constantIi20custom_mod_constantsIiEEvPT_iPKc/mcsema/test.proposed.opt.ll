...
declare %struct.Memory* @sub_413b90._ZN20custom_mod_constantsIiE8do_shiftEi(%struct.State* noalias dereferenceable(3376), i64, %struct.Memory* noalias readnone returned) local_unnamed_addr

declare %struct.Memory* @sub_413ba0._Z17check_shifted_sumIi20custom_mod_constantsIiEEvT_(%struct.State* noalias dereferenceable(3376), i64, %struct.Memory* noalias readnone returned) local_unnamed_addr
...
entry:
  ...
  %call2_4083d3 = tail call %struct.Memory* @sub_400e80._Z11start_timerv(%struct.State* %0, i64 %58, %struct.Memory* %2)
  ...
  br label %block_.L_4083df

block_.L_4083df:                                  ; preds = %block_.L_40842d, %entry
  %68 = phi i64 [ %276, %block_.L_40842d ], [ %.pre, %entry ]
  ...
  br i1 %101, label %block_4083ef, label %block_.L_408443

block_4083ef:                                     ; preds = %block_.L_4083df
  %103 = add i64 %69, -32
  %104 = add i64 %102, 7
  ...
  br label %block_.L_4083fd

block_.L_4083fd:                                  ; preds = %block_408409, %block_4083ef
  %111 = phi i64 [ %234, %block_408409 ], [ %.pre6, %block_4083ef ]
  ...
  br i1 %147, label %block_408409, label %block_.L_40842d

block_408409:                                     ; preds = %block_.L_4083fd
  %149 = add i64 %112, -8
  %150 = add i64 %148, 4
  ...
  %call2_408414 = tail call %struct.Memory* @sub_413b90._ZN20custom_mod_constantsIiE8do_shiftEi(%struct.State* nonnull %0, i64 %162, %struct.Memory* %call2_4083d3)
...
block_.L_40842d:                                  ; preds = %block_.L_4083fd
  %235 = add i64 %112, -32
  %236 = add i64 %148, 3
  ...
  %call2_408430 = tail call %struct.Memory* @sub_413ba0._Z17check_shifted_sumIi20custom_mod_constantsIiEEvT_(%struct.State* nonnull %0, i64 %240, %struct.Memory* %call2_4083d3)
...
block_.L_408443:                                  ; preds = %block_.L_4083df
  ...
  %call2_408443 = tail call %struct.Memory* @sub_400ea0._Z5timerv(%struct.State* nonnull %0, i64 %277, %struct.Memory* %call2_4083d3)
  ...
  %call2_40844c = tail call %struct.Memory* @sub_400840._Z13record_resultdPKc(%struct.State* nonnull %0, i64 %288, %struct.Memory* %call2_408443)
  ...
  ret %struct.Memory* %call2_40844c
}
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_jge_.L_408443(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i8* nocapture %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_jmpq_.L_4083fd(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
