...
block_.L_40839f:                                  ; preds = %block_.L_4083ed, %entry
  %68 = phi i64 [ %.pre, %entry ], [ %276, %block_.L_4083ed ]
...
block_.L_4083bd:                                  ; preds = %block_4083c9, %block_4083af
  %111 = phi i64 [ %.pre1, %block_4083af ], [ %234, %block_4083c9 ]
...
block_.L_4083ed:                                  ; preds = %block_.L_4083bd
  ...
  %call2_4083f0 = tail call %struct.Memory* @sub_413b60._Z17check_shifted_sumIi20custom_mod_constantsIiEEvT_(%struct.State* %0, i64 %240, %struct.Memory* %MEMORY.1)
...
block_.L_408403:                                  ; preds = %block_.L_40839f
  ...
  %call2_408403 = tail call %struct.Memory* @sub_400e60._Z5timerv(%struct.State* %0, i64 %277, %struct.Memory* %MEMORY.0)
  ...
  %call2_40840c = tail call %struct.Memory* @sub_400800._Z13record_resultdPKc(%struct.State* %0, i64 %288, %struct.Memory* %call2_408403)
