...
declare %struct.Memory* @sub_413cf0._Z17check_shifted_sumIi20custom_sub_constantsIiEEvT_(%struct.State* dereferenceable(3376), i64, %struct.Memory*)
...
define %struct.Memory* @_Z13test_constantIi20custom_sub_constantsIiEEvPT_iPKc(%struct.State* noalias, i64, %struct.Memory* noalias) #1 {
entry:
