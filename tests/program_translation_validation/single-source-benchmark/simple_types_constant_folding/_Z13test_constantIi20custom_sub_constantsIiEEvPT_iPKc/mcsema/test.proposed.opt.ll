...
block_.L_4081bf:                                  ; preds = %block_.L_40820d, %entry
  %68 = phi i64 [ %.pre, %entry ], [ %276, %block_.L_40820d ]
...
block_.L_4081dd:                                  ; preds = %block_4081e9, %block_4081cf
  %111 = phi i64 [ %.pre1, %block_4081cf ], [ %234, %block_4081e9 ]
...
block_.L_40820d:                                  ; preds = %block_.L_4081dd
  ...
  %call2_408210 = tail call %struct.Memory* @sub_413cb0._Z17check_shifted_sumIi20custom_sub_constantsIiEEvT_(%struct.State* %0, i64 %240, %struct.Memory* %MEMORY.1)
...
block_.L_408223:                                  ; preds = %block_.L_4081bf
  ...
  %call2_408223 = tail call %struct.Memory* @sub_400e60._Z5timerv(%struct.State* %0, i64 %277, %struct.Memory* %MEMORY.0)
  ...
  %call2_40822c = tail call %struct.Memory* @sub_400800._Z13record_resultdPKc(%struct.State* %0, i64 %288, %struct.Memory* %call2_408223)
