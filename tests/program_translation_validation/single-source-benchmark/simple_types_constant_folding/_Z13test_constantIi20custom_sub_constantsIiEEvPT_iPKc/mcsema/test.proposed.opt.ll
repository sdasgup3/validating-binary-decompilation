...
declare %struct.Memory* @sub_413ce0._ZN20custom_sub_constantsIiE8do_shiftEi(%struct.State* noalias dereferenceable(3376), i64, %struct.Memory* noalias readnone returned) local_unnamed_addr

declare %struct.Memory* @sub_413cf0._Z17check_shifted_sumIi20custom_sub_constantsIiEEvT_(%struct.State* noalias dereferenceable(3376), i64, %struct.Memory* noalias readnone returned) local_unnamed_addr
...
block_.L_4081ff:                                  ; preds = %block_.L_40824d, %entry
  %68 = phi i64 [ %276, %block_.L_40824d ], [ %.pre, %entry ]
...
block_.L_40821d:                                  ; preds = %block_408229, %block_40820f
  %111 = phi i64 [ %234, %block_408229 ], [ %.pre6, %block_40820f ]
...
block_408229:                                     ; preds = %block_.L_40821d
  ...
  %call2_408234 = tail call %struct.Memory* @sub_413ce0._ZN20custom_sub_constantsIiE8do_shiftEi(%struct.State* nonnull %0, i64 %162, %struct.Memory* %call2_4081f3)
...
block_.L_40824d:                                  ; preds = %block_.L_40821d
  ...
  %call2_408250 = tail call %struct.Memory* @sub_413cf0._Z17check_shifted_sumIi20custom_sub_constantsIiEEvT_(%struct.State* nonnull %0, i64 %240, %struct.Memory* %call2_4081f3)
...
block_.L_408263:                                  ; preds = %block_.L_4081ff
  ...
  %call2_408263 = tail call %struct.Memory* @sub_400ea0._Z5timerv(%struct.State* nonnull %0, i64 %277, %struct.Memory* %call2_4081f3)
