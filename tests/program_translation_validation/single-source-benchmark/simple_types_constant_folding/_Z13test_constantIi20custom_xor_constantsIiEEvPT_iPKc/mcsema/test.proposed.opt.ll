...
block_.L_40893f:                                  ; preds = %block_.L_40898d, %entry
  %68 = phi i64 [ %.pre, %entry ], [ %276, %block_.L_40898d ]
...
block_.L_40895d:                                  ; preds = %block_408969, %block_40894f
  %111 = phi i64 [ %.pre1, %block_40894f ], [ %234, %block_408969 ]
...
block_.L_40898d:                                  ; preds = %block_.L_40895d
  ...
  %call2_408990 = tail call %struct.Memory* @sub_413770._Z17check_shifted_sumIi20custom_xor_constantsIiEEvT_(%struct.State* %0, i64 %240, %struct.Memory* %MEMORY.1)
...
block_.L_4089a3:                                  ; preds = %block_.L_40893f
  ...
  %call2_4089a3 = tail call %struct.Memory* @sub_400e60._Z5timerv(%struct.State* %0, i64 %277, %struct.Memory* %MEMORY.0)
  ...
  %call2_4089ac = tail call %struct.Memory* @sub_400800._Z13record_resultdPKc(%struct.State* %0, i64 %288, %struct.Memory* %call2_4089a3)
