...
declare %struct.Memory* @sub_4133b0._ZN22custom_constant_divideIiE8do_shiftEi(%struct.State* noalias dereferenceable(3376), i64, %struct.Memory* noalias readnone returned) local_unnamed_addr

declare %struct.Memory* @sub_4133d0._Z17check_shifted_sumIi22custom_constant_divideIiEEvT_(%struct.State* noalias dereferenceable(3376), i64, %struct.Memory* noalias readnone returned) local_unnamed_addr
...
block_.L_408e7f:                                  ; preds = %block_.L_408ecd, %entry
  %68 = phi i64 [ %276, %block_.L_408ecd ], [ %.pre, %entry ]
...
block_.L_408e9d:                                  ; preds = %block_408ea9, %block_408e8f
  %111 = phi i64 [ %234, %block_408ea9 ], [ %.pre6, %block_408e8f ]
...
block_408ea9:                                     ; preds = %block_.L_408e9d
  ...
  %call2_408eb4 = tail call %struct.Memory* @sub_4133b0._ZN22custom_constant_divideIiE8do_shiftEi(%struct.State* nonnull %0, i64 %162, %struct.Memory* %call2_408e73)
...
block_.L_408ecd:                                  ; preds = %block_.L_408e9d
  ...
  %call2_408ed0 = tail call %struct.Memory* @sub_4133d0._Z17check_shifted_sumIi22custom_constant_divideIiEEvT_(%struct.State* nonnull %0, i64 %240, %struct.Memory* %call2_408e73)
...
block_.L_408ee3:                                  ; preds = %block_.L_408e7f
  ...
  %call2_408ee3 = tail call %struct.Memory* @sub_400ea0._Z5timerv(%struct.State* nonnull %0, i64 %277, %struct.Memory* %call2_408e73)
