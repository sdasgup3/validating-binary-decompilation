...
block_.L_408e3f:                                  ; preds = %block_.L_408e8d, %entry
  %68 = phi i64 [ %.pre, %entry ], [ %278, %block_.L_408e8d ]
...
block_.L_408e5d:                                  ; preds = %block_408e69, %block_408e4f
  %111 = phi i64 [ %.pre1, %block_408e4f ], [ %235, %block_408e69 ]
...
block_.L_408e8d:                                  ; preds = %block_.L_408e5d
  ...
  %call2_408e90 = tail call %struct.Memory* @sub_413390._Z17check_shifted_sumIi22custom_constant_divideIiEEvT_(%struct.State* %0, i64 %241, %struct.Memory* %MEMORY.1)
...
block_.L_408ea3:                                  ; preds = %block_.L_408e3f
  ...
  %call2_408ea3 = tail call %struct.Memory* @sub_400e60._Z5timerv(%struct.State* %0, i64 %279, %struct.Memory* %MEMORY.0)
  ...
  %call2_408eac = tail call %struct.Memory* @sub_400800._Z13record_resultdPKc(%struct.State* %0, i64 %290, %struct.Memory* %call2_408ea3)
