...
declare %struct.Memory* @sub_413af0._Z17check_shifted_sumIi22custom_equal_constantsIiEEvT_(%struct.State* noalias dereferenceable(3376), i64, %struct.Memory* noalias readnone returned) local_unnamed_addr
...
entry:
  ...
  %call2_408433 = tail call %struct.Memory* @sub_400e40._Z11start_timerv(%struct.State* %0, i64 %58, %struct.Memory* %2)
...
block_.L_40843f:                                  ; preds = %block_.L_40848d, %entry
  %68 = phi i64 [ %.pre, %entry ], [ %276, %block_.L_40848d ]
  %MEMORY.0 = phi %struct.Memory* [ %call2_408433, %entry ], [ %call2_408490, %block_.L_40848d ]
  ...
  br i1 %101, label %block_40844f, label %block_.L_4084a3
...
block_.L_40845d:                                  ; preds = %block_408469, %block_40844f
  %111 = phi i64 [ %.pre1, %block_40844f ], [ %234, %block_408469 ]
  %MEMORY.1 = phi %struct.Memory* [ %MEMORY.0, %block_40844f ], [ %call2_408474, %block_408469 ]
  ...
  br i1 %147, label %block_408469, label %block_.L_40848d
...
block_408469:                                     ; preds = %block_.L_40845d
  ...
  %call2_408474 = tail call %struct.Memory* @sub_413ae0._ZN22custom_equal_constantsIiE8do_shiftEi(%struct.State* %0, i64 %162, %struct.Memory* %MEMORY.1)
...
block_.L_40848d:                                  ; preds = %block_.L_40845d
  ...
  %call2_408490 = tail call %struct.Memory* @sub_413af0._Z17check_shifted_sumIi22custom_equal_constantsIiEEvT_(%struct.State* %0, i64 %240, %struct.Memory* %MEMORY.1)
...
block_.L_4084a3:                                  ; preds = %block_.L_40843f
  ...
  %call2_4084a3 = tail call %struct.Memory* @sub_400e60._Z5timerv(%struct.State* %0, i64 %277, %struct.Memory* %MEMORY.0)
  ...
  %call2_4084ac = tail call %struct.Memory* @sub_400800._Z13record_resultdPKc(%struct.State* %0, i64 %288, %struct.Memory* %call2_4084a3)
  ...
  ret %struct.Memory* %call2_4084ac
}
...
define %struct.Memory* @routine_jge_.L_4084a3(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i8* %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
...
define %struct.Memory* @routine_jge_.L_40848d(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i8* %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 2, i32 9
...
define %struct.Memory* @routine_jmpq_.L_40845d(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
...
define %struct.Memory* @routine_callq_._Z17check_shifted_sumIi22custom_equal_constantsIiEEvT_(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
...
define %struct.Memory* @routine_jmpq_.L_40843f(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
