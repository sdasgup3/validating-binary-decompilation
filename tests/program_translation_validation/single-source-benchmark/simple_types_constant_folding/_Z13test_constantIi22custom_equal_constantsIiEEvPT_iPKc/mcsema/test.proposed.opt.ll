...
declare %struct.Memory* @sub_413b30._Z17check_shifted_sumIi22custom_equal_constantsIiEEvT_(%struct.State* noalias dereferenceable(3376), i64, %struct.Memory* noalias readnone returned) local_unnamed_addr
...
block_.L_40847f:                                  ; preds = %block_.L_4084cd, %entry
  %68 = phi i64 [ %276, %block_.L_4084cd ], [ %.pre, %entry ]
...
block_.L_40849d:                                  ; preds = %block_4084a9, %block_40848f
  %111 = phi i64 [ %234, %block_4084a9 ], [ %.pre6, %block_40848f ]
...
block_4084a9:                                     ; preds = %block_.L_40849d
  ...
  %call2_4084b4 = tail call %struct.Memory* @sub_413b20._ZN22custom_equal_constantsIiE8do_shiftEi(%struct.State* nonnull %0, i64 %162, %struct.Memory* %call2_408473)
...
block_.L_4084cd:                                  ; preds = %block_.L_40849d
  ...
  %call2_4084d0 = tail call %struct.Memory* @sub_413b30._Z17check_shifted_sumIi22custom_equal_constantsIiEEvT_(%struct.State* nonnull %0, i64 %240, %struct.Memory* %call2_408473)
...
block_.L_4084e3:                                  ; preds = %block_.L_40847f
  ...
  %call2_4084e3 = tail call %struct.Memory* @sub_400ea0._Z5timerv(%struct.State* nonnull %0, i64 %277, %struct.Memory* %call2_408473)
