...
block_.L_40843f:                                  ; preds = %block_.L_40848d, %entry
  %68 = phi i64 [ %.pre, %entry ], [ %278, %block_.L_40848d ]
...
block_.L_40845d:                                  ; preds = %block_408469, %block_40844f
  %111 = phi i64 [ %.pre1, %block_40844f ], [ %235, %block_408469 ]
...
block_.L_40848d:                                  ; preds = %block_.L_40845d
  ...
  %call2_408490 = tail call %struct.Memory* @sub_413af0._Z17check_shifted_sumIi22custom_equal_constantsIiEEvT_(%struct.State* %0, i64 %241, %struct.Memory* %MEMORY.1)
...
block_.L_4084a3:                                  ; preds = %block_.L_40843f
  ...
  %call2_4084a3 = tail call %struct.Memory* @sub_400e60._Z5timerv(%struct.State* %0, i64 %279, %struct.Memory* %MEMORY.0)
  ...
  %call2_4084ac = tail call %struct.Memory* @sub_400800._Z13record_resultdPKc(%struct.State* %0, i64 %290, %struct.Memory* %call2_4084a3)
