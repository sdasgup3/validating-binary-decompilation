...
declare %struct.Memory* @sub_413c00._ZN23custom_divide_constantsIiE8do_shiftEi(%struct.State* dereferenceable(3376), i64, %struct.Memory*) local_unnamed_addr

declare %struct.Memory* @sub_413c10._Z17check_shifted_sumIi23custom_divide_constantsIiEEvT_(%struct.State* dereferenceable(3376), i64, %struct.Memory*) local_unnamed_addr
...
entry:
  ...
  %call2_408333 = tail call %struct.Memory* @sub_400e80._Z11start_timerv(%struct.State* %0, i64 %58, %struct.Memory* %2)
...
block_.L_40833f:                                  ; preds = %block_.L_40838d, %entry
  %68 = phi i64 [ %.pre, %entry ], [ %276, %block_.L_40838d ]
  %MEMORY.0 = phi %struct.Memory* [ %call2_408333, %entry ], [ %call2_408390, %block_.L_40838d ]
  ...
  br i1 %101, label %block_40834f, label %block_.L_4083a3

block_40834f:                                     ; preds = %block_.L_40833f
  %103 = add i64 %69, -32
  %104 = add i64 %102, 7
...
block_.L_40835d:                                  ; preds = %block_408369, %block_40834f
  %111 = phi i64 [ %.pre6, %block_40834f ], [ %234, %block_408369 ]
  %MEMORY.1 = phi %struct.Memory* [ %MEMORY.0, %block_40834f ], [ %call2_408374, %block_408369 ]
  ...
  br i1 %147, label %block_408369, label %block_.L_40838d

block_408369:                                     ; preds = %block_.L_40835d
  %149 = add i64 %112, -8
  %150 = add i64 %148, 4
  ...
  %call2_408374 = tail call %struct.Memory* @sub_413c00._ZN23custom_divide_constantsIiE8do_shiftEi(%struct.State* nonnull %0, i64 %162, %struct.Memory* %MEMORY.1)
...
block_.L_40838d:                                  ; preds = %block_.L_40835d
  %235 = add i64 %112, -32
  %236 = add i64 %148, 3
  ...
  %call2_408390 = tail call %struct.Memory* @sub_413c10._Z17check_shifted_sumIi23custom_divide_constantsIiEEvT_(%struct.State* nonnull %0, i64 %240, %struct.Memory* %MEMORY.1)
...
block_.L_4083a3:                                  ; preds = %block_.L_40833f
  ...
  %call2_4083a3 = tail call %struct.Memory* @sub_400ea0._Z5timerv(%struct.State* nonnull %0, i64 %277, %struct.Memory* %MEMORY.0)
  ...
  %call2_4083ac = tail call %struct.Memory* @sub_400840._Z13record_resultdPKc(%struct.State* nonnull %0, i64 %288, %struct.Memory* %call2_4083a3)
  ...
  ret %struct.Memory* %call2_4083ac
}
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_jge_.L_4083a3(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i8* nocapture %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_jge_.L_40838d(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i8* nocapture %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 2, i32 9
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_jmpq_.L_40833f(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
