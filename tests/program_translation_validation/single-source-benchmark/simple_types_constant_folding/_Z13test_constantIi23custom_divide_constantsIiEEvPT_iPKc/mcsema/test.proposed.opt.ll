...
declare %struct.Memory* @sub_413c00._ZN23custom_divide_constantsIiE8do_shiftEi(%struct.State* noalias dereferenceable(3376), i64, %struct.Memory* noalias readnone returned) local_unnamed_addr

declare %struct.Memory* @sub_413c10._Z17check_shifted_sumIi23custom_divide_constantsIiEEvT_(%struct.State* noalias dereferenceable(3376), i64, %struct.Memory* noalias readnone returned) local_unnamed_addr
...
block_.L_40833f:                                  ; preds = %block_.L_40838d, %entry
  %68 = phi i64 [ %276, %block_.L_40838d ], [ %.pre, %entry ]
...
block_.L_40835d:                                  ; preds = %block_408369, %block_40834f
  %111 = phi i64 [ %234, %block_408369 ], [ %.pre6, %block_40834f ]
...
block_408369:                                     ; preds = %block_.L_40835d
  ...
  %call2_408374 = tail call %struct.Memory* @sub_413c00._ZN23custom_divide_constantsIiE8do_shiftEi(%struct.State* nonnull %0, i64 %162, %struct.Memory* %call2_408333)
...
block_.L_40838d:                                  ; preds = %block_.L_40835d
  ...
  %call2_408390 = tail call %struct.Memory* @sub_413c10._Z17check_shifted_sumIi23custom_divide_constantsIiEEvT_(%struct.State* nonnull %0, i64 %240, %struct.Memory* %call2_408333)
...
block_.L_4083a3:                                  ; preds = %block_.L_40833f
  ...
  %call2_4083a3 = tail call %struct.Memory* @sub_400ea0._Z5timerv(%struct.State* nonnull %0, i64 %277, %struct.Memory* %call2_408333)
