...
block_.L_4082ff:                                  ; preds = %block_.L_40834d, %entry
  %68 = phi i64 [ %.pre, %entry ], [ %276, %block_.L_40834d ]
...
block_.L_40831d:                                  ; preds = %block_408329, %block_40830f
  %111 = phi i64 [ %.pre1, %block_40830f ], [ %234, %block_408329 ]
...
block_.L_40834d:                                  ; preds = %block_.L_40831d
  ...
  %call2_408350 = tail call %struct.Memory* @sub_413bd0._Z17check_shifted_sumIi23custom_divide_constantsIiEEvT_(%struct.State* %0, i64 %240, %struct.Memory* %MEMORY.1)
...
block_.L_408363:                                  ; preds = %block_.L_4082ff
  ...
  %call2_408363 = tail call %struct.Memory* @sub_400e60._Z5timerv(%struct.State* %0, i64 %277, %struct.Memory* %MEMORY.0)
  ...
  %call2_40836c = tail call %struct.Memory* @sub_400800._Z13record_resultdPKc(%struct.State* %0, i64 %288, %struct.Memory* %call2_408363)
