...
declare %struct.Memory* @sub_413540._Z17check_shifted_sumIi24custom_constant_multiplyIiEEvT_(%struct.State* noalias dereferenceable(3376), i64, %struct.Memory* noalias readnone returned) local_unnamed_addr
...
define %struct.Memory* @_Z13test_constantIi24custom_constant_multiplyIiEEvPT_iPKc(%struct.State* noalias, i64, %struct.Memory* noalias readnone) local_unnamed_addr #1 {
entry:
...
block_.L_408c9f:                                  ; preds = %block_.L_408ced, %entry
  %68 = phi i64 [ %276, %block_.L_408ced ], [ %.pre, %entry ]
...
block_.L_408cbd:                                  ; preds = %block_408cc9, %block_408caf
  %111 = phi i64 [ %234, %block_408cc9 ], [ %.pre6, %block_408caf ]
...
block_408cc9:                                     ; preds = %block_.L_408cbd
  ...
  %call2_408cd4 = tail call %struct.Memory* @sub_413530._ZN24custom_constant_multiplyIiE8do_shiftEi(%struct.State* nonnull %0, i64 %162, %struct.Memory* %call2_408c93)
...
block_.L_408ced:                                  ; preds = %block_.L_408cbd
  ...
  %call2_408cf0 = tail call %struct.Memory* @sub_413540._Z17check_shifted_sumIi24custom_constant_multiplyIiEEvT_(%struct.State* nonnull %0, i64 %240, %struct.Memory* %call2_408c93)
...
block_.L_408d03:                                  ; preds = %block_.L_408c9f
  ...
  %call2_408d03 = tail call %struct.Memory* @sub_400ea0._Z5timerv(%struct.State* nonnull %0, i64 %277, %struct.Memory* %call2_408c93)
