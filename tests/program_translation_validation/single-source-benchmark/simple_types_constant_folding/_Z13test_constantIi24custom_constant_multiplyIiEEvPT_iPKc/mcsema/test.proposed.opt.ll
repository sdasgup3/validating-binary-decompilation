...
block_.L_408c5f:                                  ; preds = %block_.L_408cad, %entry
  %68 = phi i64 [ %.pre, %entry ], [ %276, %block_.L_408cad ]
...
block_.L_408c7d:                                  ; preds = %block_408c89, %block_408c6f
  %111 = phi i64 [ %.pre1, %block_408c6f ], [ %234, %block_408c89 ]
...
block_.L_408cad:                                  ; preds = %block_.L_408c7d
  ...
  %call2_408cb0 = tail call %struct.Memory* @sub_413500._Z17check_shifted_sumIi24custom_constant_multiplyIiEEvT_(%struct.State* %0, i64 %240, %struct.Memory* %MEMORY.1)
...
block_.L_408cc3:                                  ; preds = %block_.L_408c5f
  ...
  %call2_408cc3 = tail call %struct.Memory* @sub_400e60._Z5timerv(%struct.State* %0, i64 %277, %struct.Memory* %MEMORY.0)
  ...
  %call2_408ccc = tail call %struct.Memory* @sub_400800._Z13record_resultdPKc(%struct.State* %0, i64 %288, %struct.Memory* %call2_408cc3)
