...
declare %struct.Memory* @sub_4139d0._ZN25custom_lessthan_constantsIiE8do_shiftEi(%struct.State* noalias dereferenceable(3376), i64, %struct.Memory* noalias readnone returned) local_unnamed_addr

declare %struct.Memory* @sub_4139e0._Z17check_shifted_sumIi25custom_lessthan_constantsIiEEvT_(%struct.State* noalias dereferenceable(3376), i64, %struct.Memory* noalias readnone returned) local_unnamed_addr
...
block_.L_40865f:                                  ; preds = %block_.L_4086ad, %entry
  %68 = phi i64 [ %276, %block_.L_4086ad ], [ %.pre, %entry ]
...
block_.L_40867d:                                  ; preds = %block_408689, %block_40866f
  %111 = phi i64 [ %234, %block_408689 ], [ %.pre6, %block_40866f ]
...
block_408689:                                     ; preds = %block_.L_40867d
  ...
  %call2_408694 = tail call %struct.Memory* @sub_4139d0._ZN25custom_lessthan_constantsIiE8do_shiftEi(%struct.State* nonnull %0, i64 %162, %struct.Memory* %call2_408653)
...
block_.L_4086ad:                                  ; preds = %block_.L_40867d
  ...
  %call2_4086b0 = tail call %struct.Memory* @sub_4139e0._Z17check_shifted_sumIi25custom_lessthan_constantsIiEEvT_(%struct.State* nonnull %0, i64 %240, %struct.Memory* %call2_408653)
...
block_.L_4086c3:                                  ; preds = %block_.L_40865f
  ...
  %call2_4086c3 = tail call %struct.Memory* @sub_400ea0._Z5timerv(%struct.State* nonnull %0, i64 %277, %struct.Memory* %call2_408653)
