...
block_.L_40861f:                                  ; preds = %block_.L_40866d, %entry
  %68 = phi i64 [ %.pre, %entry ], [ %276, %block_.L_40866d ]
...
block_.L_40863d:                                  ; preds = %block_408649, %block_40862f
  %111 = phi i64 [ %.pre1, %block_40862f ], [ %234, %block_408649 ]
...
block_.L_40866d:                                  ; preds = %block_.L_40863d
  ...
  %call2_408670 = tail call %struct.Memory* @sub_4139a0._Z17check_shifted_sumIi25custom_lessthan_constantsIiEEvT_(%struct.State* %0, i64 %240, %struct.Memory* %MEMORY.1)
...
block_.L_408683:                                  ; preds = %block_.L_40861f
  ...
  %call2_408683 = tail call %struct.Memory* @sub_400e60._Z5timerv(%struct.State* %0, i64 %277, %struct.Memory* %MEMORY.0)
  ...
  %call2_40868c = tail call %struct.Memory* @sub_400800._Z13record_resultdPKc(%struct.State* %0, i64 %288, %struct.Memory* %call2_408683)
