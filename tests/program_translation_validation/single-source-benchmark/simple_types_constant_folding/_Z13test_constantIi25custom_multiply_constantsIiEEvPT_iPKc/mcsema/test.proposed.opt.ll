...
declare %struct.Memory* @sub_413c70._ZN25custom_multiply_constantsIiE8do_shiftEi(%struct.State* noalias dereferenceable(3376), i64, %struct.Memory* noalias readnone returned) local_unnamed_addr

declare %struct.Memory* @sub_413c80._Z17check_shifted_sumIi25custom_multiply_constantsIiEEvT_(%struct.State* noalias dereferenceable(3376), i64, %struct.Memory* noalias readnone returned) local_unnamed_addr
...
block_.L_40829f:                                  ; preds = %block_.L_4082ed, %entry
  %68 = phi i64 [ %276, %block_.L_4082ed ], [ %.pre, %entry ]
...
block_.L_4082bd:                                  ; preds = %block_4082c9, %block_4082af
  %111 = phi i64 [ %234, %block_4082c9 ], [ %.pre6, %block_4082af ]
...
block_4082c9:                                     ; preds = %block_.L_4082bd
  ...
  %call2_4082d4 = tail call %struct.Memory* @sub_413c70._ZN25custom_multiply_constantsIiE8do_shiftEi(%struct.State* nonnull %0, i64 %162, %struct.Memory* %call2_408293)
...
block_.L_4082ed:                                  ; preds = %block_.L_4082bd
  ...
  %call2_4082f0 = tail call %struct.Memory* @sub_413c80._Z17check_shifted_sumIi25custom_multiply_constantsIiEEvT_(%struct.State* nonnull %0, i64 %240, %struct.Memory* %call2_408293)
...
block_.L_408303:                                  ; preds = %block_.L_40829f
  ...
  %call2_408303 = tail call %struct.Memory* @sub_400ea0._Z5timerv(%struct.State* nonnull %0, i64 %277, %struct.Memory* %call2_408293)
