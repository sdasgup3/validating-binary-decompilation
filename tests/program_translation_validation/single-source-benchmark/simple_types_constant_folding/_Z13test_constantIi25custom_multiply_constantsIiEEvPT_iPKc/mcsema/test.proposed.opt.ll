...
block_.L_40825f:                                  ; preds = %block_.L_4082ad, %entry
  %68 = phi i64 [ %.pre, %entry ], [ %276, %block_.L_4082ad ]
...
block_.L_40827d:                                  ; preds = %block_408289, %block_40826f
  %111 = phi i64 [ %.pre1, %block_40826f ], [ %234, %block_408289 ]
...
block_.L_4082ad:                                  ; preds = %block_.L_40827d
  ...
  %call2_4082b0 = tail call %struct.Memory* @sub_413c40._Z17check_shifted_sumIi25custom_multiply_constantsIiEEvT_(%struct.State* %0, i64 %240, %struct.Memory* %MEMORY.1)
...
block_.L_4082c3:                                  ; preds = %block_.L_40825f
  ...
  %call2_4082c3 = tail call %struct.Memory* @sub_400e60._Z5timerv(%struct.State* %0, i64 %277, %struct.Memory* %MEMORY.0)
  ...
  %call2_4082cc = tail call %struct.Memory* @sub_400800._Z13record_resultdPKc(%struct.State* %0, i64 %288, %struct.Memory* %call2_4082c3)
