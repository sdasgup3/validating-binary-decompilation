...
declare %struct.Memory* @sub_413ab0._ZN25custom_notequal_constantsIiE8do_shiftEi(%struct.State* dereferenceable(3376), i64, %struct.Memory*)

declare %struct.Memory* @sub_413ac0._Z17check_shifted_sumIi25custom_notequal_constantsIiEEvT_(%struct.State* dereferenceable(3376), i64, %struct.Memory*)
...
define %struct.Memory* @_Z13test_constantIi25custom_notequal_constantsIiEEvPT_iPKc(%struct.State* noalias, i64, %struct.Memory* noalias) #1 {
entry:
