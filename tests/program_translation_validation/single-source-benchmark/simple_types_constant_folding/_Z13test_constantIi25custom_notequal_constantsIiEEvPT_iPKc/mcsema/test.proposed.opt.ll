...
block_.L_4084df:                                  ; preds = %block_.L_40852d, %entry
  %68 = phi i64 [ %.pre, %entry ], [ %278, %block_.L_40852d ]
...
block_.L_4084fd:                                  ; preds = %block_408509, %block_4084ef
  %111 = phi i64 [ %.pre1, %block_4084ef ], [ %235, %block_408509 ]
...
block_.L_40852d:                                  ; preds = %block_.L_4084fd
  ...
  %call2_408530 = tail call %struct.Memory* @sub_413a80._Z17check_shifted_sumIi25custom_notequal_constantsIiEEvT_(%struct.State* %0, i64 %241, %struct.Memory* %MEMORY.1)
...
block_.L_408543:                                  ; preds = %block_.L_4084df
  ...
  %call2_408543 = tail call %struct.Memory* @sub_400e60._Z5timerv(%struct.State* %0, i64 %279, %struct.Memory* %MEMORY.0)
  ...
  %call2_40854c = tail call %struct.Memory* @sub_400800._Z13record_resultdPKc(%struct.State* %0, i64 %290, %struct.Memory* %call2_408543)
