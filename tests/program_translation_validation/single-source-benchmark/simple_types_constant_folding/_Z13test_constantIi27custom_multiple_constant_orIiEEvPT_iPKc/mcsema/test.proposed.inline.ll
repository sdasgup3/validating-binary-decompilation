...
declare %struct.Memory* @sub_413030._Z17check_shifted_sumIi27custom_multiple_constant_orIiEEvT_(%struct.State* dereferenceable(3376), i64, %struct.Memory*)
...
define %struct.Memory* @_Z13test_constantIi27custom_multiple_constant_orIiEEvPT_iPKc(%struct.State* noalias, i64, %struct.Memory* noalias) #1 {
entry:
