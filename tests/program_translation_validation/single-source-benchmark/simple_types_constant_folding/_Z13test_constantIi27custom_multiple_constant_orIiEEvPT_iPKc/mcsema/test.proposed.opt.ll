...
declare %struct.Memory* @sub_413020._ZN27custom_multiple_constant_orIiE8do_shiftEi(%struct.State* noalias dereferenceable(3376), i64, %struct.Memory* noalias readnone returned) local_unnamed_addr

declare %struct.Memory* @sub_413040._Z17check_shifted_sumIi27custom_multiple_constant_orIiEEvT_(%struct.State* noalias dereferenceable(3376), i64, %struct.Memory* noalias readnone returned) local_unnamed_addr
...
entry:
  ...
  %call2_4092e3 = tail call %struct.Memory* @sub_400e90._Z11start_timerv(%struct.State* %0, i64 %58, %struct.Memory* %2)
...
block_.L_4092ef:                                  ; preds = %block_.L_40933d, %entry
  %68 = phi i64 [ %276, %block_.L_40933d ], [ %.pre, %entry ]
  ...
  br i1 %101, label %block_4092ff, label %block_.L_409353
...
block_.L_40930d:                                  ; preds = %block_409319, %block_4092ff
  %111 = phi i64 [ %234, %block_409319 ], [ %.pre6, %block_4092ff ]
  ...
  br i1 %147, label %block_409319, label %block_.L_40933d
...
block_409319:                                     ; preds = %block_.L_40930d
  ...
  %call2_409324 = tail call %struct.Memory* @sub_413020._ZN27custom_multiple_constant_orIiE8do_shiftEi(%struct.State* nonnull %0, i64 %162, %struct.Memory* %call2_4092e3)
...
block_.L_40933d:                                  ; preds = %block_.L_40930d
  ...
  %call2_409340 = tail call %struct.Memory* @sub_413040._Z17check_shifted_sumIi27custom_multiple_constant_orIiEEvT_(%struct.State* nonnull %0, i64 %240, %struct.Memory* %call2_4092e3)
...
block_.L_409353:                                  ; preds = %block_.L_4092ef
  ...
  %call2_409353 = tail call %struct.Memory* @sub_400eb0._Z5timerv(%struct.State* nonnull %0, i64 %277, %struct.Memory* %call2_4092e3)
  ...
  %call2_40935c = tail call %struct.Memory* @sub_400850._Z13record_resultdPKc(%struct.State* nonnull %0, i64 %288, %struct.Memory* %call2_409353)
