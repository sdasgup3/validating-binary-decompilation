...
declare %struct.Memory* @sub_413010._ZN27custom_multiple_constant_orIiE8do_shiftEi(%struct.State* noalias dereferenceable(3376), i64, %struct.Memory* noalias readnone returned) local_unnamed_addr

declare %struct.Memory* @sub_413030._Z17check_shifted_sumIi27custom_multiple_constant_orIiEEvT_(%struct.State* noalias dereferenceable(3376), i64, %struct.Memory* noalias readnone returned) local_unnamed_addr
...
define %struct.Memory* @_Z13test_constantIi27custom_multiple_constant_orIiEEvPT_iPKc(%struct.State* noalias, i64, %struct.Memory* noalias readnone) local_unnamed_addr #1 {
entry:
...
block_.L_4092df:                                  ; preds = %block_.L_40932d, %entry
  %68 = phi i64 [ %276, %block_.L_40932d ], [ %.pre, %entry ]
...
block_.L_4092fd:                                  ; preds = %block_409309, %block_4092ef
  %111 = phi i64 [ %234, %block_409309 ], [ %.pre6, %block_4092ef ]
...
block_409309:                                     ; preds = %block_.L_4092fd
  ...
  %call2_409314 = tail call %struct.Memory* @sub_413010._ZN27custom_multiple_constant_orIiE8do_shiftEi(%struct.State* nonnull %0, i64 %162, %struct.Memory* %call2_4092d3)
...
block_.L_40932d:                                  ; preds = %block_.L_4092fd
  ...
  %call2_409330 = tail call %struct.Memory* @sub_413030._Z17check_shifted_sumIi27custom_multiple_constant_orIiEEvT_(%struct.State* nonnull %0, i64 %240, %struct.Memory* %call2_4092d3)
...
block_.L_409343:                                  ; preds = %block_.L_4092df
  ...
  %call2_409343 = tail call %struct.Memory* @sub_400ea0._Z5timerv(%struct.State* nonnull %0, i64 %277, %struct.Memory* %call2_4092d3)
