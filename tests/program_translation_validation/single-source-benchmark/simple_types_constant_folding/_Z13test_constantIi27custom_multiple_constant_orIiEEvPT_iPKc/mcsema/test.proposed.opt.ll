...
block_.L_40929f:                                  ; preds = %block_.L_4092ed, %entry
  %68 = phi i64 [ %.pre, %entry ], [ %276, %block_.L_4092ed ]
...
block_.L_4092bd:                                  ; preds = %block_4092c9, %block_4092af
  %111 = phi i64 [ %.pre1, %block_4092af ], [ %234, %block_4092c9 ]
...
block_.L_4092ed:                                  ; preds = %block_.L_4092bd
  ...
  %call2_4092f0 = tail call %struct.Memory* @sub_412ff0._Z17check_shifted_sumIi27custom_multiple_constant_orIiEEvT_(%struct.State* %0, i64 %240, %struct.Memory* %MEMORY.1)
...
block_.L_409303:                                  ; preds = %block_.L_40929f
  ...
  %call2_409303 = tail call %struct.Memory* @sub_400e60._Z5timerv(%struct.State* %0, i64 %277, %struct.Memory* %MEMORY.0)
  ...
  %call2_40930c = tail call %struct.Memory* @sub_400800._Z13record_resultdPKc(%struct.State* %0, i64 %288, %struct.Memory* %call2_409303)
