...
define %struct.Memory* @_Z13test_constantIi28custom_greaterthan_constantsIiEEvPT_iPKc(%struct.State* noalias, i64, %struct.Memory* noalias) #1 {
entry:
  ...
  store %struct.Memory* %loadMem_4085a4, %struct.Memory** %MEMORY
  ...
  store i32 %93, i32* %97
  store %struct.Memory* %loadMem_4085ac, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_4085af, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem1_4085b3, %struct.Memory** %MEMORY
...
block_.L_4085bf:                                  ; preds = %block_.L_40860d, %entry
...
block_4085cf:                                     ; preds = %block_.L_4085bf
...
block_.L_4085dd:                                  ; preds = %block_4085e9, %block_4085cf
...
block_4085e9:                                     ; preds = %block_.L_4085dd
  ...
  store %struct.Memory* %loadMem1_4085f4, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_408608, %struct.Memory** %MEMORY
  br label %block_.L_4085dd

block_.L_40860d:                                  ; preds = %block_.L_4085dd
  ...
  store %struct.Memory* %loadMem_40860d, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem1_408610, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_40861b, %struct.Memory** %MEMORY
...
block_.L_408623:                                  ; preds = %block_.L_4085bf
  ...
  store %struct.Memory* %loadMem1_40862c, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_408635, %struct.Memory** %MEMORY
  ...
  ret %struct.Memory* %loadMem_408636
}
