...
declare %struct.Memory* @sub_413a50._Z17check_shifted_sumIi28custom_greaterthan_constantsIiEEvT_(%struct.State* noalias dereferenceable(3376), i64, %struct.Memory* noalias readnone returned) local_unnamed_addr
...
define %struct.Memory* @_Z13test_constantIi28custom_greaterthan_constantsIiEEvPT_iPKc(%struct.State* noalias, i64, %struct.Memory* noalias readnone) local_unnamed_addr #1 {
entry:
...
block_.L_4085bf:                                  ; preds = %block_.L_40860d, %entry
  %68 = phi i64 [ %276, %block_.L_40860d ], [ %.pre, %entry ]
...
block_.L_4085dd:                                  ; preds = %block_4085e9, %block_4085cf
  %111 = phi i64 [ %234, %block_4085e9 ], [ %.pre6, %block_4085cf ]
...
block_4085e9:                                     ; preds = %block_.L_4085dd
  ...
  %call2_4085f4 = tail call %struct.Memory* @sub_413a40._ZN28custom_greaterthan_constantsIiE8do_shiftEi(%struct.State* nonnull %0, i64 %162, %struct.Memory* %call2_4085b3)
...
block_.L_40860d:                                  ; preds = %block_.L_4085dd
  ...
  %call2_408610 = tail call %struct.Memory* @sub_413a50._Z17check_shifted_sumIi28custom_greaterthan_constantsIiEEvT_(%struct.State* nonnull %0, i64 %240, %struct.Memory* %call2_4085b3)
...
block_.L_408623:                                  ; preds = %block_.L_4085bf
  ...
  %call2_408623 = tail call %struct.Memory* @sub_400ea0._Z5timerv(%struct.State* nonnull %0, i64 %277, %struct.Memory* %call2_4085b3)
