...
declare %struct.Memory* @sub_413a60._Z17check_shifted_sumIi28custom_greaterthan_constantsIiEEvT_(%struct.State* noalias dereferenceable(3376), i64, %struct.Memory* noalias readnone returned) local_unnamed_addr
...
entry:
  ...
  %call2_4085c3 = tail call %struct.Memory* @sub_400e90._Z11start_timerv(%struct.State* %0, i64 %58, %struct.Memory* %2)
...
block_.L_4085cf:                                  ; preds = %block_.L_40861d, %entry
  %68 = phi i64 [ %276, %block_.L_40861d ], [ %.pre, %entry ]
  ...
  br i1 %101, label %block_4085df, label %block_.L_408633
...
block_.L_4085ed:                                  ; preds = %block_4085f9, %block_4085df
  %111 = phi i64 [ %234, %block_4085f9 ], [ %.pre6, %block_4085df ]
  ...
  br i1 %147, label %block_4085f9, label %block_.L_40861d
...
block_4085f9:                                     ; preds = %block_.L_4085ed
  ...
  %call2_408604 = tail call %struct.Memory* @sub_413a50._ZN28custom_greaterthan_constantsIiE8do_shiftEi(%struct.State* nonnull %0, i64 %162, %struct.Memory* %call2_4085c3)
...
block_.L_40861d:                                  ; preds = %block_.L_4085ed
  ...
  %call2_408620 = tail call %struct.Memory* @sub_413a60._Z17check_shifted_sumIi28custom_greaterthan_constantsIiEEvT_(%struct.State* nonnull %0, i64 %240, %struct.Memory* %call2_4085c3)
...
block_.L_408633:                                  ; preds = %block_.L_4085cf
  ...
  %call2_408633 = tail call %struct.Memory* @sub_400eb0._Z5timerv(%struct.State* nonnull %0, i64 %277, %struct.Memory* %call2_4085c3)
  ...
  %call2_40863c = tail call %struct.Memory* @sub_400850._Z13record_resultdPKc(%struct.State* nonnull %0, i64 %288, %struct.Memory* %call2_408633)
