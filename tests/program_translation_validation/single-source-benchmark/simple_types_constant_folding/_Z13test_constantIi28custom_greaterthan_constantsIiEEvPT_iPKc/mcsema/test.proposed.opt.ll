...
block_.L_40857f:                                  ; preds = %block_.L_4085cd, %entry
  %68 = phi i64 [ %.pre, %entry ], [ %276, %block_.L_4085cd ]
...
block_.L_40859d:                                  ; preds = %block_4085a9, %block_40858f
  %111 = phi i64 [ %.pre1, %block_40858f ], [ %234, %block_4085a9 ]
...
block_.L_4085cd:                                  ; preds = %block_.L_40859d
  ...
  %call2_4085d0 = tail call %struct.Memory* @sub_413a10._Z17check_shifted_sumIi28custom_greaterthan_constantsIiEEvT_(%struct.State* %0, i64 %240, %struct.Memory* %MEMORY.1)
...
block_.L_4085e3:                                  ; preds = %block_.L_40857f
  ...
  %call2_4085e3 = tail call %struct.Memory* @sub_400e60._Z5timerv(%struct.State* %0, i64 %277, %struct.Memory* %MEMORY.0)
  ...
  %call2_4085ec = tail call %struct.Memory* @sub_400800._Z13record_resultdPKc(%struct.State* %0, i64 %288, %struct.Memory* %call2_4085e3)
