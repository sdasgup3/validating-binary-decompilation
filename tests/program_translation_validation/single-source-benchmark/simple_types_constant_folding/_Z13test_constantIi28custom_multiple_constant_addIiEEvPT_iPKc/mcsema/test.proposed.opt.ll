...
declare %struct.Memory* @sub_4136a0._ZN28custom_multiple_constant_addIiE8do_shiftEi(%struct.State* noalias dereferenceable(3376), i64, %struct.Memory* noalias readnone returned) local_unnamed_addr

declare %struct.Memory* @sub_4136c0._Z17check_shifted_sumIi28custom_multiple_constant_addIiEEvT_(%struct.State* noalias dereferenceable(3376), i64, %struct.Memory* noalias readnone returned) local_unnamed_addr
...
block_.L_408abf:                                  ; preds = %block_.L_408b0d, %entry
  %68 = phi i64 [ %276, %block_.L_408b0d ], [ %.pre, %entry ]
...
block_.L_408add:                                  ; preds = %block_408ae9, %block_408acf
  %111 = phi i64 [ %234, %block_408ae9 ], [ %.pre6, %block_408acf ]
...
block_408ae9:                                     ; preds = %block_.L_408add
  ...
  %call2_408af4 = tail call %struct.Memory* @sub_4136a0._ZN28custom_multiple_constant_addIiE8do_shiftEi(%struct.State* nonnull %0, i64 %162, %struct.Memory* %call2_408ab3)
...
block_.L_408b0d:                                  ; preds = %block_.L_408add
  ...
  %call2_408b10 = tail call %struct.Memory* @sub_4136c0._Z17check_shifted_sumIi28custom_multiple_constant_addIiEEvT_(%struct.State* nonnull %0, i64 %240, %struct.Memory* %call2_408ab3)
...
block_.L_408b23:                                  ; preds = %block_.L_408abf
  ...
  %call2_408b23 = tail call %struct.Memory* @sub_400ea0._Z5timerv(%struct.State* nonnull %0, i64 %277, %struct.Memory* %call2_408ab3)
