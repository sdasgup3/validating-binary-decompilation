...
block_.L_408a7f:                                  ; preds = %block_.L_408acd, %entry
  %68 = phi i64 [ %.pre, %entry ], [ %278, %block_.L_408acd ]
...
block_.L_408a9d:                                  ; preds = %block_408aa9, %block_408a8f
  %111 = phi i64 [ %.pre1, %block_408a8f ], [ %235, %block_408aa9 ]
...
block_.L_408acd:                                  ; preds = %block_.L_408a9d
  ...
  %call2_408ad0 = tail call %struct.Memory* @sub_413680._Z17check_shifted_sumIi28custom_multiple_constant_addIiEEvT_(%struct.State* %0, i64 %241, %struct.Memory* %MEMORY.1)
...
block_.L_408ae3:                                  ; preds = %block_.L_408a7f
  ...
  %call2_408ae3 = tail call %struct.Memory* @sub_400e60._Z5timerv(%struct.State* %0, i64 %279, %struct.Memory* %MEMORY.0)
  ...
  %call2_408aec = tail call %struct.Memory* @sub_400800._Z13record_resultdPKc(%struct.State* %0, i64 %290, %struct.Memory* %call2_408ae3)
