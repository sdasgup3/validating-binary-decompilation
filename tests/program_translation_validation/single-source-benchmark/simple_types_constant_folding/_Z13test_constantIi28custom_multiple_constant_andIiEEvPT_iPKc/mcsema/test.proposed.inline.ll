...
declare %struct.Memory* @sub_413110._ZN28custom_multiple_constant_andIiE8do_shiftEi(%struct.State* dereferenceable(3376), i64, %struct.Memory*)

declare %struct.Memory* @sub_413130._Z17check_shifted_sumIi28custom_multiple_constant_andIiEEvT_(%struct.State* dereferenceable(3376), i64, %struct.Memory*)
...
define %struct.Memory* @_Z13test_constantIi28custom_multiple_constant_andIiEEvPT_iPKc(%struct.State* noalias, i64, %struct.Memory* noalias) #1 {
entry:
