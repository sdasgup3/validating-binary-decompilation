...
declare %struct.Memory* @sub_413110._ZN28custom_multiple_constant_andIiE8do_shiftEi(%struct.State* noalias dereferenceable(3376), i64, %struct.Memory* noalias readnone returned) local_unnamed_addr

declare %struct.Memory* @sub_413130._Z17check_shifted_sumIi28custom_multiple_constant_andIiEEvT_(%struct.State* noalias dereferenceable(3376), i64, %struct.Memory* noalias readnone returned) local_unnamed_addr
...
block_.L_40919f:                                  ; preds = %block_.L_4091ed, %entry
  %68 = phi i64 [ %276, %block_.L_4091ed ], [ %.pre, %entry ]
...
block_.L_4091bd:                                  ; preds = %block_4091c9, %block_4091af
  %111 = phi i64 [ %234, %block_4091c9 ], [ %.pre6, %block_4091af ]
...
block_4091c9:                                     ; preds = %block_.L_4091bd
  ...
  %call2_4091d4 = tail call %struct.Memory* @sub_413110._ZN28custom_multiple_constant_andIiE8do_shiftEi(%struct.State* nonnull %0, i64 %162, %struct.Memory* %call2_409193)
...
block_.L_4091ed:                                  ; preds = %block_.L_4091bd
  ...
  %call2_4091f0 = tail call %struct.Memory* @sub_413130._Z17check_shifted_sumIi28custom_multiple_constant_andIiEEvT_(%struct.State* nonnull %0, i64 %240, %struct.Memory* %call2_409193)
...
block_.L_409203:                                  ; preds = %block_.L_40919f
  ...
  %call2_409203 = tail call %struct.Memory* @sub_400ea0._Z5timerv(%struct.State* nonnull %0, i64 %277, %struct.Memory* %call2_409193)
