...
block_.L_40915f:                                  ; preds = %block_.L_4091ad, %entry
  %68 = phi i64 [ %.pre, %entry ], [ %276, %block_.L_4091ad ]
...
block_.L_40917d:                                  ; preds = %block_409189, %block_40916f
  %111 = phi i64 [ %.pre1, %block_40916f ], [ %234, %block_409189 ]
...
block_.L_4091ad:                                  ; preds = %block_.L_40917d
  ...
  %call2_4091b0 = tail call %struct.Memory* @sub_4130f0._Z17check_shifted_sumIi28custom_multiple_constant_andIiEEvT_(%struct.State* %0, i64 %240, %struct.Memory* %MEMORY.1)
...
block_.L_4091c3:                                  ; preds = %block_.L_40915f
  ...
  %call2_4091c3 = tail call %struct.Memory* @sub_400e60._Z5timerv(%struct.State* %0, i64 %277, %struct.Memory* %MEMORY.0)
  ...
  %call2_4091cc = tail call %struct.Memory* @sub_400800._Z13record_resultdPKc(%struct.State* %0, i64 %288, %struct.Memory* %call2_4091c3)
