...
declare %struct.Memory* @sub_4135a0._ZN28custom_multiple_constant_subIiE8do_shiftEi(%struct.State* dereferenceable(3376), i64, %struct.Memory*) local_unnamed_addr

declare %struct.Memory* @sub_4135c0._Z17check_shifted_sumIi28custom_multiple_constant_subIiEEvT_(%struct.State* dereferenceable(3376), i64, %struct.Memory*) local_unnamed_addr
...
block_.L_408bff:                                  ; preds = %block_.L_408c4d, %entry
  %68 = phi i64 [ %.pre, %entry ], [ %276, %block_.L_408c4d ]
  %MEMORY.0 = phi %struct.Memory* [ %call2_408bf3, %entry ], [ %call2_408c50, %block_.L_408c4d ]
...
block_.L_408c1d:                                  ; preds = %block_408c29, %block_408c0f
  %111 = phi i64 [ %.pre6, %block_408c0f ], [ %234, %block_408c29 ]
  %MEMORY.1 = phi %struct.Memory* [ %MEMORY.0, %block_408c0f ], [ %call2_408c34, %block_408c29 ]
...
block_408c29:                                     ; preds = %block_.L_408c1d
  ...
  %call2_408c34 = tail call %struct.Memory* @sub_4135a0._ZN28custom_multiple_constant_subIiE8do_shiftEi(%struct.State* nonnull %0, i64 %162, %struct.Memory* %MEMORY.1)
...
block_.L_408c4d:                                  ; preds = %block_.L_408c1d
  ...
  %call2_408c50 = tail call %struct.Memory* @sub_4135c0._Z17check_shifted_sumIi28custom_multiple_constant_subIiEEvT_(%struct.State* nonnull %0, i64 %240, %struct.Memory* %MEMORY.1)
...
block_.L_408c63:                                  ; preds = %block_.L_408bff
  ...
  %call2_408c63 = tail call %struct.Memory* @sub_400ea0._Z5timerv(%struct.State* nonnull %0, i64 %277, %struct.Memory* %MEMORY.0)
