...
block_.L_408bbf:                                  ; preds = %block_.L_408c0d, %entry
  %68 = phi i64 [ %.pre, %entry ], [ %276, %block_.L_408c0d ]
...
block_.L_408bdd:                                  ; preds = %block_408be9, %block_408bcf
  %111 = phi i64 [ %.pre1, %block_408bcf ], [ %234, %block_408be9 ]
...
block_.L_408c0d:                                  ; preds = %block_.L_408bdd
  ...
  %call2_408c10 = tail call %struct.Memory* @sub_413580._Z17check_shifted_sumIi28custom_multiple_constant_subIiEEvT_(%struct.State* %0, i64 %240, %struct.Memory* %MEMORY.1)
...
block_.L_408c23:                                  ; preds = %block_.L_408bbf
  ...
  %call2_408c23 = tail call %struct.Memory* @sub_400e60._Z5timerv(%struct.State* %0, i64 %277, %struct.Memory* %MEMORY.0)
  ...
  %call2_408c2c = tail call %struct.Memory* @sub_400800._Z13record_resultdPKc(%struct.State* %0, i64 %288, %struct.Memory* %call2_408c23)
