...
declare %struct.Memory* @sub_412ee0._ZN28custom_multiple_constant_xorIiE8do_shiftEi(%struct.State* dereferenceable(3376), i64, %struct.Memory*)

declare %struct.Memory* @sub_412f00._Z17check_shifted_sumIi28custom_multiple_constant_xorIiEEvT_(%struct.State* dereferenceable(3376), i64, %struct.Memory*)
...
define %struct.Memory* @_Z13test_constantIi28custom_multiple_constant_xorIiEEvPT_iPKc(%struct.State* noalias, i64, %struct.Memory* noalias) #1 {
entry:
