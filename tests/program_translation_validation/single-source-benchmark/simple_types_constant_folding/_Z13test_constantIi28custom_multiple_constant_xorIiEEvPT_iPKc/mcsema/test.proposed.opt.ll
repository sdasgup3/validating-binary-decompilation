...
declare %struct.Memory* @sub_412ee0._ZN28custom_multiple_constant_xorIiE8do_shiftEi(%struct.State* noalias dereferenceable(3376), i64, %struct.Memory* noalias readnone returned) local_unnamed_addr

declare %struct.Memory* @sub_412f00._Z17check_shifted_sumIi28custom_multiple_constant_xorIiEEvT_(%struct.State* noalias dereferenceable(3376), i64, %struct.Memory* noalias readnone returned) local_unnamed_addr
...
block_.L_40941f:                                  ; preds = %block_.L_40946d, %entry
  %68 = phi i64 [ %276, %block_.L_40946d ], [ %.pre, %entry ]
...
block_.L_40943d:                                  ; preds = %block_409449, %block_40942f
  %111 = phi i64 [ %234, %block_409449 ], [ %.pre6, %block_40942f ]
...
block_409449:                                     ; preds = %block_.L_40943d
  ...
  %call2_409454 = tail call %struct.Memory* @sub_412ee0._ZN28custom_multiple_constant_xorIiE8do_shiftEi(%struct.State* nonnull %0, i64 %162, %struct.Memory* %call2_409413)
...
block_.L_40946d:                                  ; preds = %block_.L_40943d
  ...
  %call2_409470 = tail call %struct.Memory* @sub_412f00._Z17check_shifted_sumIi28custom_multiple_constant_xorIiEEvT_(%struct.State* nonnull %0, i64 %240, %struct.Memory* %call2_409413)
...
block_.L_409483:                                  ; preds = %block_.L_40941f
  ...
  %call2_409483 = tail call %struct.Memory* @sub_400ea0._Z5timerv(%struct.State* nonnull %0, i64 %277, %struct.Memory* %call2_409413)
