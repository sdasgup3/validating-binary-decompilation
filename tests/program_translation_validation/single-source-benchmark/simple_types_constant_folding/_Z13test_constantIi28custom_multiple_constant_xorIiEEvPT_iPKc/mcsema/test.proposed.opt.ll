...
block_.L_4093df:                                  ; preds = %block_.L_40942d, %entry
  %68 = phi i64 [ %.pre, %entry ], [ %278, %block_.L_40942d ]
...
block_.L_4093fd:                                  ; preds = %block_409409, %block_4093ef
  %111 = phi i64 [ %.pre1, %block_4093ef ], [ %235, %block_409409 ]
...
block_.L_40942d:                                  ; preds = %block_.L_4093fd
  ...
  %call2_409430 = tail call %struct.Memory* @sub_412ec0._Z17check_shifted_sumIi28custom_multiple_constant_xorIiEEvT_(%struct.State* %0, i64 %241, %struct.Memory* %MEMORY.1)
...
block_.L_409443:                                  ; preds = %block_.L_4093df
  ...
  %call2_409443 = tail call %struct.Memory* @sub_400e60._Z5timerv(%struct.State* %0, i64 %279, %struct.Memory* %MEMORY.0)
  ...
  %call2_40944c = tail call %struct.Memory* @sub_400800._Z13record_resultdPKc(%struct.State* %0, i64 %290, %struct.Memory* %call2_409443)
