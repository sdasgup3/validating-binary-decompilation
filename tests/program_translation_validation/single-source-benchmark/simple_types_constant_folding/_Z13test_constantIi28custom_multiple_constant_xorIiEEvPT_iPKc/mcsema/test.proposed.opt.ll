...
declare %struct.Memory* @sub_412ea0._ZN28custom_multiple_constant_xorIiE8do_shiftEi(%struct.State* noalias dereferenceable(3376), i64, %struct.Memory* noalias readnone returned) local_unnamed_addr

declare %struct.Memory* @sub_412ec0._Z17check_shifted_sumIi28custom_multiple_constant_xorIiEEvT_(%struct.State* noalias dereferenceable(3376), i64, %struct.Memory* noalias readnone returned) local_unnamed_addr
...
entry:
  ...
  %call2_4093d3 = tail call %struct.Memory* @sub_400e40._Z11start_timerv(%struct.State* %0, i64 %58, %struct.Memory* %2)
...
block_.L_4093df:                                  ; preds = %block_.L_40942d, %entry
  %68 = phi i64 [ %.pre, %entry ], [ %276, %block_.L_40942d ]
  %MEMORY.0 = phi %struct.Memory* [ %call2_4093d3, %entry ], [ %call2_409430, %block_.L_40942d ]
  ...
  br i1 %101, label %block_4093ef, label %block_.L_409443
...
block_.L_4093fd:                                  ; preds = %block_409409, %block_4093ef
  %111 = phi i64 [ %.pre1, %block_4093ef ], [ %234, %block_409409 ]
  %MEMORY.1 = phi %struct.Memory* [ %MEMORY.0, %block_4093ef ], [ %call2_409414, %block_409409 ]
  ...
  br i1 %147, label %block_409409, label %block_.L_40942d
...
block_409409:                                     ; preds = %block_.L_4093fd
  ...
  %call2_409414 = tail call %struct.Memory* @sub_412ea0._ZN28custom_multiple_constant_xorIiE8do_shiftEi(%struct.State* %0, i64 %162, %struct.Memory* %MEMORY.1)
...
block_.L_40942d:                                  ; preds = %block_.L_4093fd
  ...
  %call2_409430 = tail call %struct.Memory* @sub_412ec0._Z17check_shifted_sumIi28custom_multiple_constant_xorIiEEvT_(%struct.State* %0, i64 %240, %struct.Memory* %MEMORY.1)
...
block_.L_409443:                                  ; preds = %block_.L_4093df
  ...
  %call2_409443 = tail call %struct.Memory* @sub_400e60._Z5timerv(%struct.State* %0, i64 %277, %struct.Memory* %MEMORY.0)
  ...
  %call2_40944c = tail call %struct.Memory* @sub_400800._Z13record_resultdPKc(%struct.State* %0, i64 %288, %struct.Memory* %call2_409443)
  ...
  ret %struct.Memory* %call2_40944c
}
...
define %struct.Memory* @routine_jge_.L_409443(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i8* %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
...
define %struct.Memory* @routine_jge_.L_40942d(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i8* %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 2, i32 9
...
define %struct.Memory* @routine_callq_._ZN28custom_multiple_constant_xorIiE8do_shiftEi(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
...
define %struct.Memory* @routine_jmpq_.L_4093fd(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
...
define %struct.Memory* @routine_callq_._Z17check_shifted_sumIi28custom_multiple_constant_xorIiEEvT_(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
...
define %struct.Memory* @routine_jmpq_.L_4093df(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
