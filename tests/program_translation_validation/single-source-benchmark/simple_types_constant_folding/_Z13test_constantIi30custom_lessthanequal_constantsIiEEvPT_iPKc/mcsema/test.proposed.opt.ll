...
block_.L_40875f:                                  ; preds = %block_.L_4087ad, %entry
  %68 = phi i64 [ %.pre, %entry ], [ %276, %block_.L_4087ad ]
...
block_.L_40877d:                                  ; preds = %block_408789, %block_40876f
  %111 = phi i64 [ %.pre1, %block_40876f ], [ %234, %block_408789 ]
...
block_.L_4087ad:                                  ; preds = %block_.L_40877d
  ...
  %call2_4087b0 = tail call %struct.Memory* @sub_4138c0._Z17check_shifted_sumIi30custom_lessthanequal_constantsIiEEvT_(%struct.State* %0, i64 %240, %struct.Memory* %MEMORY.1)
...
block_.L_4087c3:                                  ; preds = %block_.L_40875f
  ...
  %call2_4087c3 = tail call %struct.Memory* @sub_400e60._Z5timerv(%struct.State* %0, i64 %277, %struct.Memory* %MEMORY.0)
  ...
  %call2_4087cc = tail call %struct.Memory* @sub_400800._Z13record_resultdPKc(%struct.State* %0, i64 %288, %struct.Memory* %call2_4087c3)
