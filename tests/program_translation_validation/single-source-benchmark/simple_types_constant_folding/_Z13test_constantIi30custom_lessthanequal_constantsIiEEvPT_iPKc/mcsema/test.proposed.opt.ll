...
declare %struct.Memory* @sub_4138f0._ZN30custom_lessthanequal_constantsIiE8do_shiftEi(%struct.State* dereferenceable(3376), i64, %struct.Memory*) local_unnamed_addr

declare %struct.Memory* @sub_413900._Z17check_shifted_sumIi30custom_lessthanequal_constantsIiEEvT_(%struct.State* dereferenceable(3376), i64, %struct.Memory*) local_unnamed_addr
...
block_.L_40879f:                                  ; preds = %block_.L_4087ed, %entry
  %68 = phi i64 [ %.pre, %entry ], [ %276, %block_.L_4087ed ]
  %MEMORY.0 = phi %struct.Memory* [ %call2_408793, %entry ], [ %call2_4087f0, %block_.L_4087ed ]
...
block_.L_4087bd:                                  ; preds = %block_4087c9, %block_4087af
  %111 = phi i64 [ %.pre6, %block_4087af ], [ %234, %block_4087c9 ]
  %MEMORY.1 = phi %struct.Memory* [ %MEMORY.0, %block_4087af ], [ %call2_4087d4, %block_4087c9 ]
...
block_4087c9:                                     ; preds = %block_.L_4087bd
  ...
  %call2_4087d4 = tail call %struct.Memory* @sub_4138f0._ZN30custom_lessthanequal_constantsIiE8do_shiftEi(%struct.State* nonnull %0, i64 %162, %struct.Memory* %MEMORY.1)
...
block_.L_4087ed:                                  ; preds = %block_.L_4087bd
  ...
  %call2_4087f0 = tail call %struct.Memory* @sub_413900._Z17check_shifted_sumIi30custom_lessthanequal_constantsIiEEvT_(%struct.State* nonnull %0, i64 %240, %struct.Memory* %MEMORY.1)
...
block_.L_408803:                                  ; preds = %block_.L_40879f
  ...
  %call2_408803 = tail call %struct.Memory* @sub_400ea0._Z5timerv(%struct.State* nonnull %0, i64 %277, %struct.Memory* %MEMORY.0)
