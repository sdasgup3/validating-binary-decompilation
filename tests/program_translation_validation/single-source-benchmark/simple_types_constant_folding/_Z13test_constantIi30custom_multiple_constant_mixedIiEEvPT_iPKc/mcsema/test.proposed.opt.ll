...
block_.L_40901f:                                  ; preds = %block_.L_40906d, %entry
  %68 = phi i64 [ %.pre, %entry ], [ %278, %block_.L_40906d ]
...
block_.L_40903d:                                  ; preds = %block_409049, %block_40902f
  %111 = phi i64 [ %.pre1, %block_40902f ], [ %235, %block_409049 ]
...
block_.L_40906d:                                  ; preds = %block_.L_40903d
  ...
  %call2_409070 = tail call %struct.Memory* @sub_4131f0._Z17check_shifted_sumIi30custom_multiple_constant_mixedIiEEvT_(%struct.State* %0, i64 %241, %struct.Memory* %MEMORY.1)
...
block_.L_409083:                                  ; preds = %block_.L_40901f
  ...
  %call2_409083 = tail call %struct.Memory* @sub_400e60._Z5timerv(%struct.State* %0, i64 %279, %struct.Memory* %MEMORY.0)
  ...
  %call2_40908c = tail call %struct.Memory* @sub_400800._Z13record_resultdPKc(%struct.State* %0, i64 %290, %struct.Memory* %call2_409083)
