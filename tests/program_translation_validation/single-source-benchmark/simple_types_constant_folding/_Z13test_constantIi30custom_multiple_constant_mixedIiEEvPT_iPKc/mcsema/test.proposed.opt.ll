...
declare %struct.Memory* @sub_413220._ZN30custom_multiple_constant_mixedIiE8do_shiftEi(%struct.State* noalias dereferenceable(3376), i64, %struct.Memory* noalias readnone returned) local_unnamed_addr

declare %struct.Memory* @sub_413240._Z17check_shifted_sumIi30custom_multiple_constant_mixedIiEEvT_(%struct.State* noalias dereferenceable(3376), i64, %struct.Memory* noalias readnone returned) local_unnamed_addr
...
entry:
  ...
  %call2_409063 = tail call %struct.Memory* @sub_400e90._Z11start_timerv(%struct.State* %0, i64 %58, %struct.Memory* %2)
...
block_.L_40906f:                                  ; preds = %block_.L_4090bd, %entry
  %68 = phi i64 [ %276, %block_.L_4090bd ], [ %.pre, %entry ]
  ...
  br i1 %101, label %block_40907f, label %block_.L_4090d3
...
block_.L_40908d:                                  ; preds = %block_409099, %block_40907f
  %111 = phi i64 [ %234, %block_409099 ], [ %.pre6, %block_40907f ]
  ...
  br i1 %147, label %block_409099, label %block_.L_4090bd
...
block_409099:                                     ; preds = %block_.L_40908d
  ...
  %call2_4090a4 = tail call %struct.Memory* @sub_413220._ZN30custom_multiple_constant_mixedIiE8do_shiftEi(%struct.State* nonnull %0, i64 %162, %struct.Memory* %call2_409063)
...
block_.L_4090bd:                                  ; preds = %block_.L_40908d
  ...
  %call2_4090c0 = tail call %struct.Memory* @sub_413240._Z17check_shifted_sumIi30custom_multiple_constant_mixedIiEEvT_(%struct.State* nonnull %0, i64 %240, %struct.Memory* %call2_409063)
...
block_.L_4090d3:                                  ; preds = %block_.L_40906f
  ...
  %call2_4090d3 = tail call %struct.Memory* @sub_400eb0._Z5timerv(%struct.State* nonnull %0, i64 %277, %struct.Memory* %call2_409063)
  ...
  %call2_4090dc = tail call %struct.Memory* @sub_400850._Z13record_resultdPKc(%struct.State* nonnull %0, i64 %288, %struct.Memory* %call2_4090d3)
