...
declare %struct.Memory* @sub_413210._ZN30custom_multiple_constant_mixedIiE8do_shiftEi(%struct.State* noalias dereferenceable(3376), i64, %struct.Memory* noalias readnone returned) local_unnamed_addr

declare %struct.Memory* @sub_413230._Z17check_shifted_sumIi30custom_multiple_constant_mixedIiEEvT_(%struct.State* noalias dereferenceable(3376), i64, %struct.Memory* noalias readnone returned) local_unnamed_addr
...
define %struct.Memory* @_Z13test_constantIi30custom_multiple_constant_mixedIiEEvPT_iPKc(%struct.State* noalias, i64, %struct.Memory* noalias readnone) local_unnamed_addr #1 {
entry:
...
block_.L_40905f:                                  ; preds = %block_.L_4090ad, %entry
  %68 = phi i64 [ %276, %block_.L_4090ad ], [ %.pre, %entry ]
...
block_.L_40907d:                                  ; preds = %block_409089, %block_40906f
  %111 = phi i64 [ %234, %block_409089 ], [ %.pre6, %block_40906f ]
...
block_409089:                                     ; preds = %block_.L_40907d
  ...
  %call2_409094 = tail call %struct.Memory* @sub_413210._ZN30custom_multiple_constant_mixedIiE8do_shiftEi(%struct.State* nonnull %0, i64 %162, %struct.Memory* %call2_409053)
...
block_.L_4090ad:                                  ; preds = %block_.L_40907d
  ...
  %call2_4090b0 = tail call %struct.Memory* @sub_413230._Z17check_shifted_sumIi30custom_multiple_constant_mixedIiEEvT_(%struct.State* nonnull %0, i64 %240, %struct.Memory* %call2_409053)
...
block_.L_4090c3:                                  ; preds = %block_.L_40905f
  ...
  %call2_4090c3 = tail call %struct.Memory* @sub_400ea0._Z5timerv(%struct.State* nonnull %0, i64 %277, %struct.Memory* %call2_409053)
