...
block_.L_408edf:                                  ; preds = %block_.L_408f2d, %entry
  %68 = phi i64 [ %.pre, %entry ], [ %278, %block_.L_408f2d ]
...
block_.L_408efd:                                  ; preds = %block_408f09, %block_408eef
  %111 = phi i64 [ %.pre1, %block_408eef ], [ %235, %block_408f09 ]
...
block_.L_408f2d:                                  ; preds = %block_.L_408efd
  ...
  %call2_408f30 = tail call %struct.Memory* @sub_413310._Z17check_shifted_sumIi31custom_multiple_constant_divideIiEEvT_(%struct.State* %0, i64 %241, %struct.Memory* %MEMORY.1)
...
block_.L_408f43:                                  ; preds = %block_.L_408edf
  ...
  %call2_408f43 = tail call %struct.Memory* @sub_400e60._Z5timerv(%struct.State* %0, i64 %279, %struct.Memory* %MEMORY.0)
  ...
  %call2_408f4c = tail call %struct.Memory* @sub_400800._Z13record_resultdPKc(%struct.State* %0, i64 %290, %struct.Memory* %call2_408f43)
