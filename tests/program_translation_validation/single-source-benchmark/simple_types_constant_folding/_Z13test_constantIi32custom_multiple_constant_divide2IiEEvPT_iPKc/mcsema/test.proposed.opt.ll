...
declare %struct.Memory* @sub_4132b0._Z17check_shifted_sumIi32custom_multiple_constant_divide2IiEEvT_(%struct.State* noalias dereferenceable(3376), i64, %struct.Memory* noalias readnone returned) local_unnamed_addr
...
block_.L_408fbf:                                  ; preds = %block_.L_40900d, %entry
  %68 = phi i64 [ %276, %block_.L_40900d ], [ %.pre, %entry ]
...
block_.L_408fdd:                                  ; preds = %block_408fe9, %block_408fcf
  %111 = phi i64 [ %234, %block_408fe9 ], [ %.pre6, %block_408fcf ]
...
block_408fe9:                                     ; preds = %block_.L_408fdd
  ...
  %call2_408ff4 = tail call %struct.Memory* @sub_413290._ZN32custom_multiple_constant_divide2IiE8do_shiftEi(%struct.State* nonnull %0, i64 %162, %struct.Memory* %call2_408fb3)
...
block_.L_40900d:                                  ; preds = %block_.L_408fdd
  ...
  %call2_409010 = tail call %struct.Memory* @sub_4132b0._Z17check_shifted_sumIi32custom_multiple_constant_divide2IiEEvT_(%struct.State* nonnull %0, i64 %240, %struct.Memory* %call2_408fb3)
...
block_.L_409023:                                  ; preds = %block_.L_408fbf
  ...
  %call2_409023 = tail call %struct.Memory* @sub_400ea0._Z5timerv(%struct.State* nonnull %0, i64 %277, %struct.Memory* %call2_408fb3)
