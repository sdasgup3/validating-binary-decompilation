...
declare %struct.Memory* @sub_4132b0._Z17check_shifted_sumIi32custom_multiple_constant_divide2IiEEvT_(%struct.State* dereferenceable(3376), i64, %struct.Memory*) local_unnamed_addr
...
entry:
  ...
  %call2_408fb3 = tail call %struct.Memory* @sub_400e80._Z11start_timerv(%struct.State* %0, i64 %58, %struct.Memory* %2)
...
block_.L_408fbf:                                  ; preds = %block_.L_40900d, %entry
  %68 = phi i64 [ %.pre, %entry ], [ %276, %block_.L_40900d ]
  %MEMORY.0 = phi %struct.Memory* [ %call2_408fb3, %entry ], [ %call2_409010, %block_.L_40900d ]
  ...
  br i1 %101, label %block_408fcf, label %block_.L_409023
...
block_.L_408fdd:                                  ; preds = %block_408fe9, %block_408fcf
  %111 = phi i64 [ %.pre6, %block_408fcf ], [ %234, %block_408fe9 ]
  %MEMORY.1 = phi %struct.Memory* [ %MEMORY.0, %block_408fcf ], [ %call2_408ff4, %block_408fe9 ]
  ...
  br i1 %147, label %block_408fe9, label %block_.L_40900d
...
block_408fe9:                                     ; preds = %block_.L_408fdd
  ...
  %call2_408ff4 = tail call %struct.Memory* @sub_413290._ZN32custom_multiple_constant_divide2IiE8do_shiftEi(%struct.State* nonnull %0, i64 %162, %struct.Memory* %MEMORY.1)
...
block_.L_40900d:                                  ; preds = %block_.L_408fdd
  ...
  %call2_409010 = tail call %struct.Memory* @sub_4132b0._Z17check_shifted_sumIi32custom_multiple_constant_divide2IiEEvT_(%struct.State* nonnull %0, i64 %240, %struct.Memory* %MEMORY.1)
...
block_.L_409023:                                  ; preds = %block_.L_408fbf
  ...
  %call2_409023 = tail call %struct.Memory* @sub_400ea0._Z5timerv(%struct.State* nonnull %0, i64 %277, %struct.Memory* %MEMORY.0)
  ...
  %call2_40902c = tail call %struct.Memory* @sub_400840._Z13record_resultdPKc(%struct.State* nonnull %0, i64 %288, %struct.Memory* %call2_409023)
  ...
  ret %struct.Memory* %call2_40902c
}
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_jge_.L_409023(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i8* nocapture %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_jmpq_.L_408fdd(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
