...
declare %struct.Memory* @sub_413970._Z17check_shifted_sumIi33custom_greaterthanequal_constantsIiEEvT_(%struct.State* noalias dereferenceable(3376), i64, %struct.Memory* noalias readnone returned) local_unnamed_addr
...
define %struct.Memory* @_Z13test_constantIi33custom_greaterthanequal_constantsIiEEvPT_iPKc(%struct.State* noalias, i64, %struct.Memory* noalias readnone) local_unnamed_addr #1 {
entry:
...
block_.L_4086ff:                                  ; preds = %block_.L_40874d, %entry
  %68 = phi i64 [ %276, %block_.L_40874d ], [ %.pre, %entry ]
...
block_.L_40871d:                                  ; preds = %block_408729, %block_40870f
  %111 = phi i64 [ %234, %block_408729 ], [ %.pre6, %block_40870f ]
...
block_408729:                                     ; preds = %block_.L_40871d
  ...
  %call2_408734 = tail call %struct.Memory* @sub_413960._ZN33custom_greaterthanequal_constantsIiE8do_shiftEi(%struct.State* nonnull %0, i64 %162, %struct.Memory* %call2_4086f3)
...
block_.L_40874d:                                  ; preds = %block_.L_40871d
  ...
  %call2_408750 = tail call %struct.Memory* @sub_413970._Z17check_shifted_sumIi33custom_greaterthanequal_constantsIiEEvT_(%struct.State* nonnull %0, i64 %240, %struct.Memory* %call2_4086f3)
...
block_.L_408763:                                  ; preds = %block_.L_4086ff
  ...
  %call2_408763 = tail call %struct.Memory* @sub_400ea0._Z5timerv(%struct.State* nonnull %0, i64 %277, %struct.Memory* %call2_4086f3)
