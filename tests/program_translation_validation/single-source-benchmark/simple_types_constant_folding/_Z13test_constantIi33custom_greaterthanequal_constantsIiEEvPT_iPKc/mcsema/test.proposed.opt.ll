...
declare %struct.Memory* @sub_413980._Z17check_shifted_sumIi33custom_greaterthanequal_constantsIiEEvT_(%struct.State* noalias dereferenceable(3376), i64, %struct.Memory* noalias readnone returned) local_unnamed_addr
...
entry:
  ...
  %call2_408703 = tail call %struct.Memory* @sub_400e90._Z11start_timerv(%struct.State* %0, i64 %58, %struct.Memory* %2)
...
block_.L_40870f:                                  ; preds = %block_.L_40875d, %entry
  %68 = phi i64 [ %276, %block_.L_40875d ], [ %.pre, %entry ]
  ...
  br i1 %101, label %block_40871f, label %block_.L_408773
...
block_.L_40872d:                                  ; preds = %block_408739, %block_40871f
  %111 = phi i64 [ %234, %block_408739 ], [ %.pre6, %block_40871f ]
  ...
  br i1 %147, label %block_408739, label %block_.L_40875d
...
block_408739:                                     ; preds = %block_.L_40872d
  ...
  %call2_408744 = tail call %struct.Memory* @sub_413970._ZN33custom_greaterthanequal_constantsIiE8do_shiftEi(%struct.State* nonnull %0, i64 %162, %struct.Memory* %call2_408703)
...
block_.L_40875d:                                  ; preds = %block_.L_40872d
  ...
  %call2_408760 = tail call %struct.Memory* @sub_413980._Z17check_shifted_sumIi33custom_greaterthanequal_constantsIiEEvT_(%struct.State* nonnull %0, i64 %240, %struct.Memory* %call2_408703)
...
block_.L_408773:                                  ; preds = %block_.L_40870f
  ...
  %call2_408773 = tail call %struct.Memory* @sub_400eb0._Z5timerv(%struct.State* nonnull %0, i64 %277, %struct.Memory* %call2_408703)
  ...
  %call2_40877c = tail call %struct.Memory* @sub_400850._Z13record_resultdPKc(%struct.State* nonnull %0, i64 %288, %struct.Memory* %call2_408773)
