...
block_.L_4086bf:                                  ; preds = %block_.L_40870d, %entry
  %68 = phi i64 [ %.pre, %entry ], [ %276, %block_.L_40870d ]
...
block_.L_4086dd:                                  ; preds = %block_4086e9, %block_4086cf
  %111 = phi i64 [ %.pre1, %block_4086cf ], [ %234, %block_4086e9 ]
...
block_.L_40870d:                                  ; preds = %block_.L_4086dd
  ...
  %call2_408710 = tail call %struct.Memory* @sub_413930._Z17check_shifted_sumIi33custom_greaterthanequal_constantsIiEEvT_(%struct.State* %0, i64 %240, %struct.Memory* %MEMORY.1)
...
block_.L_408723:                                  ; preds = %block_.L_4086bf
  ...
  %call2_408723 = tail call %struct.Memory* @sub_400e60._Z5timerv(%struct.State* %0, i64 %277, %struct.Memory* %MEMORY.0)
  ...
  %call2_40872c = tail call %struct.Memory* @sub_400800._Z13record_resultdPKc(%struct.State* %0, i64 %288, %struct.Memory* %call2_408723)
