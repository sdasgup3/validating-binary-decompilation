...
block_.L_408cff:                                  ; preds = %block_.L_408d4d, %entry
  %68 = phi i64 [ %.pre, %entry ], [ %276, %block_.L_408d4d ]
...
block_.L_408d1d:                                  ; preds = %block_408d29, %block_408d0f
  %111 = phi i64 [ %.pre1, %block_408d0f ], [ %234, %block_408d29 ]
...
block_.L_408d4d:                                  ; preds = %block_.L_408d1d
  ...
  %call2_408d50 = tail call %struct.Memory* @sub_413490._Z17check_shifted_sumIi33custom_multiple_constant_multiplyIiEEvT_(%struct.State* %0, i64 %240, %struct.Memory* %MEMORY.1)
...
block_.L_408d63:                                  ; preds = %block_.L_408cff
  ...
  %call2_408d63 = tail call %struct.Memory* @sub_400e60._Z5timerv(%struct.State* %0, i64 %277, %struct.Memory* %MEMORY.0)
  ...
  %call2_408d6c = tail call %struct.Memory* @sub_400800._Z13record_resultdPKc(%struct.State* %0, i64 %288, %struct.Memory* %call2_408d63)
