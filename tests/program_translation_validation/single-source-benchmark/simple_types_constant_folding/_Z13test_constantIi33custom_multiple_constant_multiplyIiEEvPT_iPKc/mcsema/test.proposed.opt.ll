...
declare %struct.Memory* @sub_4134d0._Z17check_shifted_sumIi33custom_multiple_constant_multiplyIiEEvT_(%struct.State* noalias dereferenceable(3376), i64, %struct.Memory* noalias readnone returned) local_unnamed_addr
...
define %struct.Memory* @_Z13test_constantIi33custom_multiple_constant_multiplyIiEEvPT_iPKc(%struct.State* noalias, i64, %struct.Memory* noalias readnone) local_unnamed_addr #1 {
entry:
...
block_.L_408d3f:                                  ; preds = %block_.L_408d8d, %entry
  %68 = phi i64 [ %276, %block_.L_408d8d ], [ %.pre, %entry ]
...
block_.L_408d5d:                                  ; preds = %block_408d69, %block_408d4f
  %111 = phi i64 [ %234, %block_408d69 ], [ %.pre6, %block_408d4f ]
...
block_408d69:                                     ; preds = %block_.L_408d5d
  ...
  %call2_408d74 = tail call %struct.Memory* @sub_4134b0._ZN33custom_multiple_constant_multiplyIiE8do_shiftEi(%struct.State* nonnull %0, i64 %162, %struct.Memory* %call2_408d33)
...
block_.L_408d8d:                                  ; preds = %block_.L_408d5d
  ...
  %call2_408d90 = tail call %struct.Memory* @sub_4134d0._Z17check_shifted_sumIi33custom_multiple_constant_multiplyIiEEvT_(%struct.State* nonnull %0, i64 %240, %struct.Memory* %call2_408d33)
...
block_.L_408da3:                                  ; preds = %block_.L_408d3f
  ...
  %call2_408da3 = tail call %struct.Memory* @sub_400ea0._Z5timerv(%struct.State* nonnull %0, i64 %277, %struct.Memory* %call2_408d33)
