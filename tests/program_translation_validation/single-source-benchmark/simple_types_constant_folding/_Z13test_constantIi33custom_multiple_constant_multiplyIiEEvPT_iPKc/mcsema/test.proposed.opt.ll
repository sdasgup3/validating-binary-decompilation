...
declare %struct.Memory* @sub_413490._Z17check_shifted_sumIi33custom_multiple_constant_multiplyIiEEvT_(%struct.State* noalias dereferenceable(3376), i64, %struct.Memory* noalias readnone returned) local_unnamed_addr
...
entry:
  ...
  %call2_408cf3 = tail call %struct.Memory* @sub_400e40._Z11start_timerv(%struct.State* %0, i64 %58, %struct.Memory* %2)
...
block_.L_408cff:                                  ; preds = %block_.L_408d4d, %entry
  %68 = phi i64 [ %.pre, %entry ], [ %278, %block_.L_408d4d ]
  %MEMORY.0 = phi %struct.Memory* [ %call2_408cf3, %entry ], [ %call2_408d50, %block_.L_408d4d ]
  ...
  br i1 %101, label %block_408d0f, label %block_.L_408d63
...
block_.L_408d1d:                                  ; preds = %block_408d29, %block_408d0f
  %111 = phi i64 [ %.pre1, %block_408d0f ], [ %235, %block_408d29 ]
  %MEMORY.1 = phi %struct.Memory* [ %MEMORY.0, %block_408d0f ], [ %call2_408d34, %block_408d29 ]
  ...
  br i1 %147, label %block_408d29, label %block_.L_408d4d
...
block_408d29:                                     ; preds = %block_.L_408d1d
  ...
  %call2_408d34 = tail call %struct.Memory* @sub_413470._ZN33custom_multiple_constant_multiplyIiE8do_shiftEi(%struct.State* %0, i64 %162, %struct.Memory* %MEMORY.1)
...
block_.L_408d4d:                                  ; preds = %block_.L_408d1d
  ...
  %call2_408d50 = tail call %struct.Memory* @sub_413490._Z17check_shifted_sumIi33custom_multiple_constant_multiplyIiEEvT_(%struct.State* %0, i64 %241, %struct.Memory* %MEMORY.1)
...
block_.L_408d63:                                  ; preds = %block_.L_408cff
  ...
  %call2_408d63 = tail call %struct.Memory* @sub_400e60._Z5timerv(%struct.State* %0, i64 %279, %struct.Memory* %MEMORY.0)
  ...
  %call2_408d6c = tail call %struct.Memory* @sub_400800._Z13record_resultdPKc(%struct.State* %0, i64 %290, %struct.Memory* %call2_408d63)
  ...
  ret %struct.Memory* %call2_408d6c
}
...
define %struct.Memory* @routine_jge_.L_408d63(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i8* %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
...
define %struct.Memory* @routine_jge_.L_408d4d(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i8* %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 2, i32 9
...
define %struct.Memory* @routine_jmpq_.L_408d1d(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
...
define %struct.Memory* @routine_callq_._Z17check_shifted_sumIi33custom_multiple_constant_multiplyIiEEvT_(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
...
define %struct.Memory* @routine_jmpq_.L_408cff(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
