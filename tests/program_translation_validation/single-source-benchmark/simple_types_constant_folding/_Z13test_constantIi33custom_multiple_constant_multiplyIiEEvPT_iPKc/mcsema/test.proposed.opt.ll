...
declare %struct.Memory* @sub_4134e0._Z17check_shifted_sumIi33custom_multiple_constant_multiplyIiEEvT_(%struct.State* noalias dereferenceable(3376), i64, %struct.Memory* noalias readnone returned) local_unnamed_addr
...
entry:
  ...
  %call2_408d43 = tail call %struct.Memory* @sub_400e90._Z11start_timerv(%struct.State* %0, i64 %58, %struct.Memory* %2)
...
block_.L_408d4f:                                  ; preds = %block_.L_408d9d, %entry
  %68 = phi i64 [ %276, %block_.L_408d9d ], [ %.pre, %entry ]
  ...
  br i1 %101, label %block_408d5f, label %block_.L_408db3
...
block_.L_408d6d:                                  ; preds = %block_408d79, %block_408d5f
  %111 = phi i64 [ %234, %block_408d79 ], [ %.pre6, %block_408d5f ]
  ...
  br i1 %147, label %block_408d79, label %block_.L_408d9d
...
block_408d79:                                     ; preds = %block_.L_408d6d
  ...
  %call2_408d84 = tail call %struct.Memory* @sub_4134c0._ZN33custom_multiple_constant_multiplyIiE8do_shiftEi(%struct.State* nonnull %0, i64 %162, %struct.Memory* %call2_408d43)
...
block_.L_408d9d:                                  ; preds = %block_.L_408d6d
  ...
  %call2_408da0 = tail call %struct.Memory* @sub_4134e0._Z17check_shifted_sumIi33custom_multiple_constant_multiplyIiEEvT_(%struct.State* nonnull %0, i64 %240, %struct.Memory* %call2_408d43)
...
block_.L_408db3:                                  ; preds = %block_.L_408d4f
  ...
  %call2_408db3 = tail call %struct.Memory* @sub_400eb0._Z5timerv(%struct.State* nonnull %0, i64 %277, %struct.Memory* %call2_408d43)
  ...
  %call2_408dbc = tail call %struct.Memory* @sub_400850._Z13record_resultdPKc(%struct.State* nonnull %0, i64 %288, %struct.Memory* %call2_408db3)
  ...
  ret %struct.Memory* %call2_408dbc
}
...
; Function Attrs: alwaysinline norecurse nounwind
define %struct.Memory* @routine_jge_.L_408db3(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i8* nocapture %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
...
; Function Attrs: alwaysinline norecurse nounwind
define %struct.Memory* @routine_jmpq_.L_408d6d(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
