...
declare %struct.Memory* @sub_413440._ZN34custom_multiple_constant_multiply2IiE8do_shiftEi(%struct.State* noalias dereferenceable(3376), i64, %struct.Memory* noalias readnone returned) local_unnamed_addr

declare %struct.Memory* @sub_413460._Z17check_shifted_sumIi34custom_multiple_constant_multiply2IiEEvT_(%struct.State* noalias dereferenceable(3376), i64, %struct.Memory* noalias readnone returned) local_unnamed_addr
...
entry:
  ...
  %call2_408de3 = tail call %struct.Memory* @sub_400e90._Z11start_timerv(%struct.State* %0, i64 %58, %struct.Memory* %2)
...
block_.L_408def:                                  ; preds = %block_.L_408e3d, %entry
  %68 = phi i64 [ %276, %block_.L_408e3d ], [ %.pre, %entry ]
  ...
  br i1 %101, label %block_408dff, label %block_.L_408e53
...
block_.L_408e0d:                                  ; preds = %block_408e19, %block_408dff
  %111 = phi i64 [ %234, %block_408e19 ], [ %.pre6, %block_408dff ]
  ...
  br i1 %147, label %block_408e19, label %block_.L_408e3d
...
block_408e19:                                     ; preds = %block_.L_408e0d
  ...
  %call2_408e24 = tail call %struct.Memory* @sub_413440._ZN34custom_multiple_constant_multiply2IiE8do_shiftEi(%struct.State* nonnull %0, i64 %162, %struct.Memory* %call2_408de3)
...
block_.L_408e3d:                                  ; preds = %block_.L_408e0d
  ...
  %call2_408e40 = tail call %struct.Memory* @sub_413460._Z17check_shifted_sumIi34custom_multiple_constant_multiply2IiEEvT_(%struct.State* nonnull %0, i64 %240, %struct.Memory* %call2_408de3)
...
block_.L_408e53:                                  ; preds = %block_.L_408def
  ...
  %call2_408e53 = tail call %struct.Memory* @sub_400eb0._Z5timerv(%struct.State* nonnull %0, i64 %277, %struct.Memory* %call2_408de3)
  ...
  %call2_408e5c = tail call %struct.Memory* @sub_400850._Z13record_resultdPKc(%struct.State* nonnull %0, i64 %288, %struct.Memory* %call2_408e53)
