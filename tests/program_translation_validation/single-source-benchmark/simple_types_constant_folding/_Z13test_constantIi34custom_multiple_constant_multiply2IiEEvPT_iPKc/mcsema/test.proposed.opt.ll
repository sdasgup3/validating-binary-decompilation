...
block_.L_408d9f:                                  ; preds = %block_.L_408ded, %entry
  %68 = phi i64 [ %.pre, %entry ], [ %276, %block_.L_408ded ]
...
block_.L_408dbd:                                  ; preds = %block_408dc9, %block_408daf
  %111 = phi i64 [ %.pre1, %block_408daf ], [ %234, %block_408dc9 ]
...
block_.L_408ded:                                  ; preds = %block_.L_408dbd
  ...
  %call2_408df0 = tail call %struct.Memory* @sub_413410._Z17check_shifted_sumIi34custom_multiple_constant_multiply2IiEEvT_(%struct.State* %0, i64 %240, %struct.Memory* %MEMORY.1)
...
block_.L_408e03:                                  ; preds = %block_.L_408d9f
  ...
  %call2_408e03 = tail call %struct.Memory* @sub_400e60._Z5timerv(%struct.State* %0, i64 %277, %struct.Memory* %MEMORY.0)
  ...
  %call2_408e0c = tail call %struct.Memory* @sub_400800._Z13record_resultdPKc(%struct.State* %0, i64 %288, %struct.Memory* %call2_408e03)
