...
declare %struct.Memory* @sub_413430._ZN34custom_multiple_constant_multiply2IiE8do_shiftEi(%struct.State* noalias dereferenceable(3376), i64, %struct.Memory* noalias readnone returned) local_unnamed_addr

declare %struct.Memory* @sub_413450._Z17check_shifted_sumIi34custom_multiple_constant_multiply2IiEEvT_(%struct.State* noalias dereferenceable(3376), i64, %struct.Memory* noalias readnone returned) local_unnamed_addr
...
define %struct.Memory* @_Z13test_constantIi34custom_multiple_constant_multiply2IiEEvPT_iPKc(%struct.State* noalias, i64, %struct.Memory* noalias readnone) local_unnamed_addr #1 {
entry:
...
block_.L_408ddf:                                  ; preds = %block_.L_408e2d, %entry
  %68 = phi i64 [ %276, %block_.L_408e2d ], [ %.pre, %entry ]
...
block_.L_408dfd:                                  ; preds = %block_408e09, %block_408def
  %111 = phi i64 [ %234, %block_408e09 ], [ %.pre6, %block_408def ]
...
block_408e09:                                     ; preds = %block_.L_408dfd
  ...
  %call2_408e14 = tail call %struct.Memory* @sub_413430._ZN34custom_multiple_constant_multiply2IiE8do_shiftEi(%struct.State* nonnull %0, i64 %162, %struct.Memory* %call2_408dd3)
...
block_.L_408e2d:                                  ; preds = %block_.L_408dfd
  ...
  %call2_408e30 = tail call %struct.Memory* @sub_413450._Z17check_shifted_sumIi34custom_multiple_constant_multiply2IiEEvT_(%struct.State* nonnull %0, i64 %240, %struct.Memory* %call2_408dd3)
...
block_.L_408e43:                                  ; preds = %block_.L_408ddf
  ...
  %call2_408e43 = tail call %struct.Memory* @sub_400ea0._Z5timerv(%struct.State* nonnull %0, i64 %277, %struct.Memory* %call2_408dd3)
