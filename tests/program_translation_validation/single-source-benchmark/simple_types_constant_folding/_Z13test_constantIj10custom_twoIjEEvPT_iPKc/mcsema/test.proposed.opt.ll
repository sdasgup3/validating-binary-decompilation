...
declare %struct.Memory* @sub_412e80._Z17check_shifted_sumIj10custom_twoIjEEvT_(%struct.State* noalias dereferenceable(3376), i64, %struct.Memory* noalias readnone returned) local_unnamed_addr
...
define %struct.Memory* @_Z13test_constantIj10custom_twoIjEEvPT_iPKc(%struct.State* noalias, i64, %struct.Memory* noalias readnone) local_unnamed_addr #1 {
entry:
...
block_.L_4094ff:                                  ; preds = %block_.L_40954d, %entry
  %68 = phi i64 [ %276, %block_.L_40954d ], [ %.pre, %entry ]
...
block_.L_40951d:                                  ; preds = %block_409529, %block_40950f
  %111 = phi i64 [ %234, %block_409529 ], [ %.pre6, %block_40950f ]
...
block_409529:                                     ; preds = %block_.L_40951d
  ...
  %call2_409534 = tail call %struct.Memory* @sub_412e70._ZN10custom_twoIjE8do_shiftEj(%struct.State* nonnull %0, i64 %162, %struct.Memory* %call2_4094f3)
...
block_.L_40954d:                                  ; preds = %block_.L_40951d
  ...
  %call2_409550 = tail call %struct.Memory* @sub_412e80._Z17check_shifted_sumIj10custom_twoIjEEvT_(%struct.State* nonnull %0, i64 %240, %struct.Memory* %call2_4094f3)
...
block_.L_409563:                                  ; preds = %block_.L_4094ff
  ...
  %call2_409563 = tail call %struct.Memory* @sub_400ea0._Z5timerv(%struct.State* nonnull %0, i64 %277, %struct.Memory* %call2_4094f3)
