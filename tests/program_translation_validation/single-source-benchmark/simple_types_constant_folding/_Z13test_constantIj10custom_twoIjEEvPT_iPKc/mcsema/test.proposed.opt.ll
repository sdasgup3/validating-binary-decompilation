...
declare %struct.Memory* @sub_412e80._Z17check_shifted_sumIj10custom_twoIjEEvT_(%struct.State* dereferenceable(3376), i64, %struct.Memory*) local_unnamed_addr
...
entry:
  ...
  %call2_4094f3 = tail call %struct.Memory* @sub_400e80._Z11start_timerv(%struct.State* %0, i64 %58, %struct.Memory* %2)
...
block_.L_4094ff:                                  ; preds = %block_.L_40954d, %entry
  %68 = phi i64 [ %.pre, %entry ], [ %276, %block_.L_40954d ]
  %MEMORY.0 = phi %struct.Memory* [ %call2_4094f3, %entry ], [ %call2_409550, %block_.L_40954d ]
  ...
  br i1 %101, label %block_40950f, label %block_.L_409563

block_40950f:                                     ; preds = %block_.L_4094ff
  %103 = add i64 %69, -32
  %104 = add i64 %102, 7
...
block_.L_40951d:                                  ; preds = %block_409529, %block_40950f
  %111 = phi i64 [ %.pre6, %block_40950f ], [ %234, %block_409529 ]
  %MEMORY.1 = phi %struct.Memory* [ %MEMORY.0, %block_40950f ], [ %call2_409534, %block_409529 ]
  ...
  br i1 %147, label %block_409529, label %block_.L_40954d

block_409529:                                     ; preds = %block_.L_40951d
  %149 = add i64 %112, -8
  %150 = add i64 %148, 4
  ...
  %call2_409534 = tail call %struct.Memory* @sub_412e70._ZN10custom_twoIjE8do_shiftEj(%struct.State* nonnull %0, i64 %162, %struct.Memory* %MEMORY.1)
...
block_.L_40954d:                                  ; preds = %block_.L_40951d
  %235 = add i64 %112, -32
  %236 = add i64 %148, 3
  ...
  %call2_409550 = tail call %struct.Memory* @sub_412e80._Z17check_shifted_sumIj10custom_twoIjEEvT_(%struct.State* nonnull %0, i64 %240, %struct.Memory* %MEMORY.1)
...
block_.L_409563:                                  ; preds = %block_.L_4094ff
  ...
  %call2_409563 = tail call %struct.Memory* @sub_400ea0._Z5timerv(%struct.State* nonnull %0, i64 %277, %struct.Memory* %MEMORY.0)
  ...
  %call2_40956c = tail call %struct.Memory* @sub_400840._Z13record_resultdPKc(%struct.State* nonnull %0, i64 %288, %struct.Memory* %call2_409563)
  ...
  ret %struct.Memory* %call2_40956c
}
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_jge_.L_409563(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i8* nocapture %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_jge_.L_40954d(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i8* nocapture %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 2, i32 9
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_jmpq_.L_40951d(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_jmpq_.L_4094ff(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
