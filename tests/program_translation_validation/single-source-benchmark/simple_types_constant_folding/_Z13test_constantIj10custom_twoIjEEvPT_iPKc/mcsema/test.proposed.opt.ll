...
block_.L_4094bf:                                  ; preds = %block_.L_40950d, %entry
  %68 = phi i64 [ %.pre, %entry ], [ %276, %block_.L_40950d ]
...
block_.L_4094dd:                                  ; preds = %block_4094e9, %block_4094cf
  %111 = phi i64 [ %.pre1, %block_4094cf ], [ %234, %block_4094e9 ]
...
block_.L_40950d:                                  ; preds = %block_.L_4094dd
  ...
  %call2_409510 = tail call %struct.Memory* @sub_412e40._Z17check_shifted_sumIj10custom_twoIjEEvT_(%struct.State* %0, i64 %240, %struct.Memory* %MEMORY.1)
...
block_.L_409523:                                  ; preds = %block_.L_4094bf
  ...
  %call2_409523 = tail call %struct.Memory* @sub_400e60._Z5timerv(%struct.State* %0, i64 %277, %struct.Memory* %MEMORY.0)
  ...
  %call2_40952c = tail call %struct.Memory* @sub_400800._Z13record_resultdPKc(%struct.State* %0, i64 %288, %struct.Memory* %call2_409523)
