...
declare %struct.Memory* @sub_412e90._Z17check_shifted_sumIj10custom_twoIjEEvT_(%struct.State* noalias dereferenceable(3376), i64, %struct.Memory* noalias readnone returned) local_unnamed_addr
...
entry:
  ...
  %call2_409503 = tail call %struct.Memory* @sub_400e90._Z11start_timerv(%struct.State* %0, i64 %58, %struct.Memory* %2)
...
block_.L_40950f:                                  ; preds = %block_.L_40955d, %entry
  %68 = phi i64 [ %276, %block_.L_40955d ], [ %.pre, %entry ]
  ...
  br i1 %101, label %block_40951f, label %block_.L_409573
...
block_.L_40952d:                                  ; preds = %block_409539, %block_40951f
  %111 = phi i64 [ %234, %block_409539 ], [ %.pre6, %block_40951f ]
  ...
  br i1 %147, label %block_409539, label %block_.L_40955d
...
block_409539:                                     ; preds = %block_.L_40952d
  ...
  %call2_409544 = tail call %struct.Memory* @sub_412e80._ZN10custom_twoIjE8do_shiftEj(%struct.State* nonnull %0, i64 %162, %struct.Memory* %call2_409503)
...
block_.L_40955d:                                  ; preds = %block_.L_40952d
  ...
  %call2_409560 = tail call %struct.Memory* @sub_412e90._Z17check_shifted_sumIj10custom_twoIjEEvT_(%struct.State* nonnull %0, i64 %240, %struct.Memory* %call2_409503)
...
block_.L_409573:                                  ; preds = %block_.L_40950f
  ...
  %call2_409573 = tail call %struct.Memory* @sub_400eb0._Z5timerv(%struct.State* nonnull %0, i64 %277, %struct.Memory* %call2_409503)
  ...
  %call2_40957c = tail call %struct.Memory* @sub_400850._Z13record_resultdPKc(%struct.State* nonnull %0, i64 %288, %struct.Memory* %call2_409573)
