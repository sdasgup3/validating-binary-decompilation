...
declare %struct.Memory* @sub_412170._Z17check_shifted_sumIj18custom_constant_orIjEEvT_(%struct.State* dereferenceable(3376), i64, %struct.Memory*)
...
define %struct.Memory* @_Z13test_constantIj18custom_constant_orIjEEvPT_iPKc(%struct.State* noalias, i64, %struct.Memory* noalias) #1 {
entry:
