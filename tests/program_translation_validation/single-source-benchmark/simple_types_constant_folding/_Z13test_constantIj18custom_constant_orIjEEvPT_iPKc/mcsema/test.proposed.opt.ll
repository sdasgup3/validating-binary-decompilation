...
declare %struct.Memory* @sub_412150._ZN18custom_constant_orIjE8do_shiftEj(%struct.State* dereferenceable(3376), i64, %struct.Memory*) local_unnamed_addr

declare %struct.Memory* @sub_412170._Z17check_shifted_sumIj18custom_constant_orIjEEvT_(%struct.State* dereferenceable(3376), i64, %struct.Memory*) local_unnamed_addr
...
block_.L_40a67f:                                  ; preds = %block_.L_40a6cd, %entry
  %68 = phi i64 [ %.pre, %entry ], [ %276, %block_.L_40a6cd ]
  %MEMORY.0 = phi %struct.Memory* [ %call2_40a673, %entry ], [ %call2_40a6d0, %block_.L_40a6cd ]
...
block_.L_40a69d:                                  ; preds = %block_40a6a9, %block_40a68f
  %111 = phi i64 [ %.pre6, %block_40a68f ], [ %234, %block_40a6a9 ]
  %MEMORY.1 = phi %struct.Memory* [ %MEMORY.0, %block_40a68f ], [ %call2_40a6b4, %block_40a6a9 ]
...
block_40a6a9:                                     ; preds = %block_.L_40a69d
  ...
  %call2_40a6b4 = tail call %struct.Memory* @sub_412150._ZN18custom_constant_orIjE8do_shiftEj(%struct.State* nonnull %0, i64 %162, %struct.Memory* %MEMORY.1)
...
block_.L_40a6cd:                                  ; preds = %block_.L_40a69d
  ...
  %call2_40a6d0 = tail call %struct.Memory* @sub_412170._Z17check_shifted_sumIj18custom_constant_orIjEEvT_(%struct.State* nonnull %0, i64 %240, %struct.Memory* %MEMORY.1)
...
block_.L_40a6e3:                                  ; preds = %block_.L_40a67f
  ...
  %call2_40a6e3 = tail call %struct.Memory* @sub_400ea0._Z5timerv(%struct.State* nonnull %0, i64 %277, %struct.Memory* %MEMORY.0)
