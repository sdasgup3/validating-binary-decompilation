...
block_.L_40a63f:                                  ; preds = %block_.L_40a68d, %entry
  %68 = phi i64 [ %.pre, %entry ], [ %276, %block_.L_40a68d ]
...
block_.L_40a65d:                                  ; preds = %block_40a669, %block_40a64f
  %111 = phi i64 [ %.pre1, %block_40a64f ], [ %234, %block_40a669 ]
...
block_.L_40a68d:                                  ; preds = %block_.L_40a65d
  ...
  %call2_40a690 = tail call %struct.Memory* @sub_412130._Z17check_shifted_sumIj18custom_constant_orIjEEvT_(%struct.State* %0, i64 %240, %struct.Memory* %MEMORY.1)
...
block_.L_40a6a3:                                  ; preds = %block_.L_40a63f
  ...
  %call2_40a6a3 = tail call %struct.Memory* @sub_400e60._Z5timerv(%struct.State* %0, i64 %277, %struct.Memory* %MEMORY.0)
  ...
  %call2_40a6ac = tail call %struct.Memory* @sub_400800._Z13record_resultdPKc(%struct.State* %0, i64 %288, %struct.Memory* %call2_40a6a3)
