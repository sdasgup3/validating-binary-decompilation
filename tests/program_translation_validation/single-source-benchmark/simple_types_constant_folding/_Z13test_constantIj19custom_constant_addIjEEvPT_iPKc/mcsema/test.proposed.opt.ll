...
declare %struct.Memory* @sub_4127f0._Z17check_shifted_sumIj19custom_constant_addIjEEvT_(%struct.State* noalias dereferenceable(3376), i64, %struct.Memory* noalias readnone returned) local_unnamed_addr
...
define %struct.Memory* @_Z13test_constantIj19custom_constant_addIjEEvPT_iPKc(%struct.State* noalias, i64, %struct.Memory* noalias readnone) local_unnamed_addr #1 {
entry:
...
block_.L_409e5f:                                  ; preds = %block_.L_409ead, %entry
  %68 = phi i64 [ %276, %block_.L_409ead ], [ %.pre, %entry ]
...
block_.L_409e7d:                                  ; preds = %block_409e89, %block_409e6f
  %111 = phi i64 [ %234, %block_409e89 ], [ %.pre6, %block_409e6f ]
...
block_409e89:                                     ; preds = %block_.L_409e7d
  ...
  %call2_409e94 = tail call %struct.Memory* @sub_4127d0._ZN19custom_constant_addIjE8do_shiftEj(%struct.State* nonnull %0, i64 %162, %struct.Memory* %call2_409e53)
...
block_.L_409ead:                                  ; preds = %block_.L_409e7d
  ...
  %call2_409eb0 = tail call %struct.Memory* @sub_4127f0._Z17check_shifted_sumIj19custom_constant_addIjEEvT_(%struct.State* nonnull %0, i64 %240, %struct.Memory* %call2_409e53)
...
block_.L_409ec3:                                  ; preds = %block_.L_409e5f
  ...
  %call2_409ec3 = tail call %struct.Memory* @sub_400ea0._Z5timerv(%struct.State* nonnull %0, i64 %277, %struct.Memory* %call2_409e53)
