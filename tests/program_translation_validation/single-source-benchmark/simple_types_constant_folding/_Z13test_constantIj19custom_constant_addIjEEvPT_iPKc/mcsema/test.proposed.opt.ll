...
declare %struct.Memory* @sub_4127f0._Z17check_shifted_sumIj19custom_constant_addIjEEvT_(%struct.State* dereferenceable(3376), i64, %struct.Memory*) local_unnamed_addr
...
entry:
  ...
  %call2_409e53 = tail call %struct.Memory* @sub_400e80._Z11start_timerv(%struct.State* %0, i64 %58, %struct.Memory* %2)
...
block_.L_409e5f:                                  ; preds = %block_.L_409ead, %entry
  %68 = phi i64 [ %.pre, %entry ], [ %276, %block_.L_409ead ]
  %MEMORY.0 = phi %struct.Memory* [ %call2_409e53, %entry ], [ %call2_409eb0, %block_.L_409ead ]
  ...
  br i1 %101, label %block_409e6f, label %block_.L_409ec3
...
block_.L_409e7d:                                  ; preds = %block_409e89, %block_409e6f
  %111 = phi i64 [ %.pre6, %block_409e6f ], [ %234, %block_409e89 ]
  %MEMORY.1 = phi %struct.Memory* [ %MEMORY.0, %block_409e6f ], [ %call2_409e94, %block_409e89 ]
  ...
  br i1 %147, label %block_409e89, label %block_.L_409ead
...
block_409e89:                                     ; preds = %block_.L_409e7d
  ...
  %call2_409e94 = tail call %struct.Memory* @sub_4127d0._ZN19custom_constant_addIjE8do_shiftEj(%struct.State* nonnull %0, i64 %162, %struct.Memory* %MEMORY.1)
...
block_.L_409ead:                                  ; preds = %block_.L_409e7d
  ...
  %call2_409eb0 = tail call %struct.Memory* @sub_4127f0._Z17check_shifted_sumIj19custom_constant_addIjEEvT_(%struct.State* nonnull %0, i64 %240, %struct.Memory* %MEMORY.1)
...
block_.L_409ec3:                                  ; preds = %block_.L_409e5f
  ...
  %call2_409ec3 = tail call %struct.Memory* @sub_400ea0._Z5timerv(%struct.State* nonnull %0, i64 %277, %struct.Memory* %MEMORY.0)
  ...
  %call2_409ecc = tail call %struct.Memory* @sub_400840._Z13record_resultdPKc(%struct.State* nonnull %0, i64 %288, %struct.Memory* %call2_409ec3)
  ...
  ret %struct.Memory* %call2_409ecc
}
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_jge_.L_409ec3(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i8* nocapture %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_jmpq_.L_409e7d(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_jmpq_.L_409e5f(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
