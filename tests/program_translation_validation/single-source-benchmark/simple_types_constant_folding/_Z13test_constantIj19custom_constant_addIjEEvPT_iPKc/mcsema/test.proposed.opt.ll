...
declare %struct.Memory* @sub_4127b0._Z17check_shifted_sumIj19custom_constant_addIjEEvT_(%struct.State* noalias dereferenceable(3376), i64, %struct.Memory* noalias readnone returned) local_unnamed_addr
...
define %struct.Memory* @_Z13test_constantIj19custom_constant_addIjEEvPT_iPKc(%struct.State* noalias, i64, %struct.Memory* noalias) local_unnamed_addr #1 {
entry:
  ...
  %call2_409e13 = tail call %struct.Memory* @sub_400e40._Z11start_timerv(%struct.State* %0, i64 %58, %struct.Memory* %2)
...
block_.L_409e1f:                                  ; preds = %block_.L_409e6d, %entry
  %68 = phi i64 [ %.pre, %entry ], [ %276, %block_.L_409e6d ]
  %MEMORY.0 = phi %struct.Memory* [ %call2_409e13, %entry ], [ %call2_409e70, %block_.L_409e6d ]
  ...
  br i1 %101, label %block_409e2f, label %block_.L_409e83
...
block_.L_409e3d:                                  ; preds = %block_409e49, %block_409e2f
  %111 = phi i64 [ %.pre1, %block_409e2f ], [ %234, %block_409e49 ]
  %MEMORY.1 = phi %struct.Memory* [ %MEMORY.0, %block_409e2f ], [ %call2_409e54, %block_409e49 ]
  ...
  br i1 %147, label %block_409e49, label %block_.L_409e6d
...
block_409e49:                                     ; preds = %block_.L_409e3d
  ...
  %call2_409e54 = tail call %struct.Memory* @sub_412790._ZN19custom_constant_addIjE8do_shiftEj(%struct.State* %0, i64 %162, %struct.Memory* %MEMORY.1)
...
block_.L_409e6d:                                  ; preds = %block_.L_409e3d
  ...
  %call2_409e70 = tail call %struct.Memory* @sub_4127b0._Z17check_shifted_sumIj19custom_constant_addIjEEvT_(%struct.State* %0, i64 %240, %struct.Memory* %MEMORY.1)
...
block_.L_409e83:                                  ; preds = %block_.L_409e1f
  ...
  %call2_409e83 = tail call %struct.Memory* @sub_400e60._Z5timerv(%struct.State* %0, i64 %277, %struct.Memory* %MEMORY.0)
  ...
  %call2_409e8c = tail call %struct.Memory* @sub_400800._Z13record_resultdPKc(%struct.State* %0, i64 %288, %struct.Memory* %call2_409e83)
  ...
  ret %struct.Memory* %call2_409e8c
}
...
define %struct.Memory* @routine_jge_.L_409e83(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i8* %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
...
define %struct.Memory* @routine_jge_.L_409e6d(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i8* %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 2, i32 9
...
define %struct.Memory* @routine_jmpq_.L_409e3d(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
...
define %struct.Memory* @routine_callq_._Z17check_shifted_sumIj19custom_constant_addIjEEvT_(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
...
define %struct.Memory* @routine_jmpq_.L_409e1f(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
