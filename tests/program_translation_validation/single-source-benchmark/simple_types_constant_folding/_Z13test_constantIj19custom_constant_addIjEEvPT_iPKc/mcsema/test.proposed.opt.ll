...
block_.L_409e1f:                                  ; preds = %block_.L_409e6d, %entry
  %68 = phi i64 [ %.pre, %entry ], [ %278, %block_.L_409e6d ]
...
block_.L_409e3d:                                  ; preds = %block_409e49, %block_409e2f
  %111 = phi i64 [ %.pre1, %block_409e2f ], [ %235, %block_409e49 ]
...
block_.L_409e6d:                                  ; preds = %block_.L_409e3d
  ...
  %call2_409e70 = tail call %struct.Memory* @sub_4127b0._Z17check_shifted_sumIj19custom_constant_addIjEEvT_(%struct.State* %0, i64 %241, %struct.Memory* %MEMORY.1)
...
block_.L_409e83:                                  ; preds = %block_.L_409e1f
  ...
  %call2_409e83 = tail call %struct.Memory* @sub_400e60._Z5timerv(%struct.State* %0, i64 %279, %struct.Memory* %MEMORY.0)
  ...
  %call2_409e8c = tail call %struct.Memory* @sub_400800._Z13record_resultdPKc(%struct.State* %0, i64 %290, %struct.Memory* %call2_409e83)
