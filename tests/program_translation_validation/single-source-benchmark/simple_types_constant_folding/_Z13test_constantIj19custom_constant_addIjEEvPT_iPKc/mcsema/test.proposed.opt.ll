...
declare %struct.Memory* @sub_412800._Z17check_shifted_sumIj19custom_constant_addIjEEvT_(%struct.State* noalias dereferenceable(3376), i64, %struct.Memory* noalias readnone returned) local_unnamed_addr
...
entry:
  ...
  %call2_409e63 = tail call %struct.Memory* @sub_400e90._Z11start_timerv(%struct.State* %0, i64 %58, %struct.Memory* %2)
...
block_.L_409e6f:                                  ; preds = %block_.L_409ebd, %entry
  %68 = phi i64 [ %276, %block_.L_409ebd ], [ %.pre, %entry ]
  ...
  br i1 %101, label %block_409e7f, label %block_.L_409ed3
...
block_.L_409e8d:                                  ; preds = %block_409e99, %block_409e7f
  %111 = phi i64 [ %234, %block_409e99 ], [ %.pre6, %block_409e7f ]
  ...
  br i1 %147, label %block_409e99, label %block_.L_409ebd
...
block_409e99:                                     ; preds = %block_.L_409e8d
  ...
  %call2_409ea4 = tail call %struct.Memory* @sub_4127e0._ZN19custom_constant_addIjE8do_shiftEj(%struct.State* nonnull %0, i64 %162, %struct.Memory* %call2_409e63)
...
block_.L_409ebd:                                  ; preds = %block_.L_409e8d
  ...
  %call2_409ec0 = tail call %struct.Memory* @sub_412800._Z17check_shifted_sumIj19custom_constant_addIjEEvT_(%struct.State* nonnull %0, i64 %240, %struct.Memory* %call2_409e63)
...
block_.L_409ed3:                                  ; preds = %block_.L_409e6f
  ...
  %call2_409ed3 = tail call %struct.Memory* @sub_400eb0._Z5timerv(%struct.State* nonnull %0, i64 %277, %struct.Memory* %call2_409e63)
  ...
  %call2_409edc = tail call %struct.Memory* @sub_400850._Z13record_resultdPKc(%struct.State* nonnull %0, i64 %288, %struct.Memory* %call2_409ed3)
