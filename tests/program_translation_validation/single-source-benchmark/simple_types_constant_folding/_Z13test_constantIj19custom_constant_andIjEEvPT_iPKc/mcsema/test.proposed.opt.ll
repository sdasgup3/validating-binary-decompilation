...
block_.L_40a4ff:                                  ; preds = %block_.L_40a54d, %entry
  %68 = phi i64 [ %.pre, %entry ], [ %278, %block_.L_40a54d ]
...
block_.L_40a51d:                                  ; preds = %block_40a529, %block_40a50f
  %111 = phi i64 [ %.pre1, %block_40a50f ], [ %235, %block_40a529 ]
...
block_.L_40a54d:                                  ; preds = %block_.L_40a51d
  ...
  %call2_40a550 = tail call %struct.Memory* @sub_412230._Z17check_shifted_sumIj19custom_constant_andIjEEvT_(%struct.State* %0, i64 %241, %struct.Memory* %MEMORY.1)
...
block_.L_40a563:                                  ; preds = %block_.L_40a4ff
  ...
  %call2_40a563 = tail call %struct.Memory* @sub_400e60._Z5timerv(%struct.State* %0, i64 %279, %struct.Memory* %MEMORY.0)
  ...
  %call2_40a56c = tail call %struct.Memory* @sub_400800._Z13record_resultdPKc(%struct.State* %0, i64 %290, %struct.Memory* %call2_40a563)
