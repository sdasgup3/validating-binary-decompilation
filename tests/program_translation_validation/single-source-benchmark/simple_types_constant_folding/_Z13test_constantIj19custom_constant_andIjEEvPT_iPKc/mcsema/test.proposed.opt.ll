...
declare %struct.Memory* @sub_412250._ZN19custom_constant_andIjE8do_shiftEj(%struct.State* noalias dereferenceable(3376), i64, %struct.Memory* noalias readnone returned) local_unnamed_addr

declare %struct.Memory* @sub_412270._Z17check_shifted_sumIj19custom_constant_andIjEEvT_(%struct.State* noalias dereferenceable(3376), i64, %struct.Memory* noalias readnone returned) local_unnamed_addr
...
define %struct.Memory* @_Z13test_constantIj19custom_constant_andIjEEvPT_iPKc(%struct.State* noalias, i64, %struct.Memory* noalias readnone) local_unnamed_addr #1 {
entry:
...
block_.L_40a53f:                                  ; preds = %block_.L_40a58d, %entry
  %68 = phi i64 [ %276, %block_.L_40a58d ], [ %.pre, %entry ]
...
block_.L_40a55d:                                  ; preds = %block_40a569, %block_40a54f
  %111 = phi i64 [ %234, %block_40a569 ], [ %.pre6, %block_40a54f ]
...
block_40a569:                                     ; preds = %block_.L_40a55d
  ...
  %call2_40a574 = tail call %struct.Memory* @sub_412250._ZN19custom_constant_andIjE8do_shiftEj(%struct.State* nonnull %0, i64 %162, %struct.Memory* %call2_40a533)
...
block_.L_40a58d:                                  ; preds = %block_.L_40a55d
  ...
  %call2_40a590 = tail call %struct.Memory* @sub_412270._Z17check_shifted_sumIj19custom_constant_andIjEEvT_(%struct.State* nonnull %0, i64 %240, %struct.Memory* %call2_40a533)
...
block_.L_40a5a3:                                  ; preds = %block_.L_40a53f
  ...
  %call2_40a5a3 = tail call %struct.Memory* @sub_400ea0._Z5timerv(%struct.State* nonnull %0, i64 %277, %struct.Memory* %call2_40a533)
