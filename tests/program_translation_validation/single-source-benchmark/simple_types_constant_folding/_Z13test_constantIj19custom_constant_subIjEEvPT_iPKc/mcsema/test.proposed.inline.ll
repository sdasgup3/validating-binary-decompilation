...
declare %struct.Memory* @sub_4126d0._ZN19custom_constant_subIjE8do_shiftEj(%struct.State* dereferenceable(3376), i64, %struct.Memory*)

declare %struct.Memory* @sub_4126f0._Z17check_shifted_sumIj19custom_constant_subIjEEvT_(%struct.State* dereferenceable(3376), i64, %struct.Memory*)
...
define %struct.Memory* @_Z13test_constantIj19custom_constant_subIjEEvPT_iPKc(%struct.State* noalias, i64, %struct.Memory* noalias) #1 {
entry:
