...
declare %struct.Memory* @sub_4126b0._Z17check_shifted_sumIj19custom_constant_subIjEEvT_(%struct.State* noalias dereferenceable(3376), i64, %struct.Memory* noalias readnone returned) local_unnamed_addr
...
define %struct.Memory* @_Z13test_constantIj19custom_constant_subIjEEvPT_iPKc(%struct.State* noalias, i64, %struct.Memory* noalias) local_unnamed_addr #1 {
entry:
  ...
  %call2_409f53 = tail call %struct.Memory* @sub_400e40._Z11start_timerv(%struct.State* %0, i64 %58, %struct.Memory* %2)
...
block_.L_409f5f:                                  ; preds = %block_.L_409fad, %entry
  %68 = phi i64 [ %.pre, %entry ], [ %278, %block_.L_409fad ]
  %MEMORY.0 = phi %struct.Memory* [ %call2_409f53, %entry ], [ %call2_409fb0, %block_.L_409fad ]
  ...
  br i1 %101, label %block_409f6f, label %block_.L_409fc3
...
block_.L_409f7d:                                  ; preds = %block_409f89, %block_409f6f
  %111 = phi i64 [ %.pre1, %block_409f6f ], [ %235, %block_409f89 ]
  %MEMORY.1 = phi %struct.Memory* [ %MEMORY.0, %block_409f6f ], [ %call2_409f94, %block_409f89 ]
  ...
  br i1 %147, label %block_409f89, label %block_.L_409fad
...
block_409f89:                                     ; preds = %block_.L_409f7d
  ...
  %call2_409f94 = tail call %struct.Memory* @sub_412690._ZN19custom_constant_subIjE8do_shiftEj(%struct.State* %0, i64 %162, %struct.Memory* %MEMORY.1)
...
block_.L_409fad:                                  ; preds = %block_.L_409f7d
  ...
  %call2_409fb0 = tail call %struct.Memory* @sub_4126b0._Z17check_shifted_sumIj19custom_constant_subIjEEvT_(%struct.State* %0, i64 %241, %struct.Memory* %MEMORY.1)
...
block_.L_409fc3:                                  ; preds = %block_.L_409f5f
  ...
  %call2_409fc3 = tail call %struct.Memory* @sub_400e60._Z5timerv(%struct.State* %0, i64 %279, %struct.Memory* %MEMORY.0)
  ...
  %call2_409fcc = tail call %struct.Memory* @sub_400800._Z13record_resultdPKc(%struct.State* %0, i64 %290, %struct.Memory* %call2_409fc3)
  ...
  ret %struct.Memory* %call2_409fcc
}
...
define %struct.Memory* @routine_jge_.L_409fc3(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i8* %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
...
define %struct.Memory* @routine_jge_.L_409fad(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i8* %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 2, i32 9
...
define %struct.Memory* @routine_jmpq_.L_409f7d(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
...
define %struct.Memory* @routine_callq_._Z17check_shifted_sumIj19custom_constant_subIjEEvT_(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
...
define %struct.Memory* @routine_jmpq_.L_409f5f(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
