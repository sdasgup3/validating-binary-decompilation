...
declare %struct.Memory* @sub_4126f0._Z17check_shifted_sumIj19custom_constant_subIjEEvT_(%struct.State* noalias dereferenceable(3376), i64, %struct.Memory* noalias readnone returned) local_unnamed_addr
...
block_.L_409f9f:                                  ; preds = %block_.L_409fed, %entry
  %68 = phi i64 [ %276, %block_.L_409fed ], [ %.pre, %entry ]
...
block_.L_409fbd:                                  ; preds = %block_409fc9, %block_409faf
  %111 = phi i64 [ %234, %block_409fc9 ], [ %.pre6, %block_409faf ]
...
block_409fc9:                                     ; preds = %block_.L_409fbd
  ...
  %call2_409fd4 = tail call %struct.Memory* @sub_4126d0._ZN19custom_constant_subIjE8do_shiftEj(%struct.State* nonnull %0, i64 %162, %struct.Memory* %call2_409f93)
...
block_.L_409fed:                                  ; preds = %block_.L_409fbd
  ...
  %call2_409ff0 = tail call %struct.Memory* @sub_4126f0._Z17check_shifted_sumIj19custom_constant_subIjEEvT_(%struct.State* nonnull %0, i64 %240, %struct.Memory* %call2_409f93)
...
block_.L_40a003:                                  ; preds = %block_.L_409f9f
  ...
  %call2_40a003 = tail call %struct.Memory* @sub_400ea0._Z5timerv(%struct.State* nonnull %0, i64 %277, %struct.Memory* %call2_409f93)
