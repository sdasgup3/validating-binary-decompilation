...
block_.L_409f5f:                                  ; preds = %block_.L_409fad, %entry
  %68 = phi i64 [ %.pre, %entry ], [ %276, %block_.L_409fad ]
...
block_.L_409f7d:                                  ; preds = %block_409f89, %block_409f6f
  %111 = phi i64 [ %.pre1, %block_409f6f ], [ %234, %block_409f89 ]
...
block_.L_409fad:                                  ; preds = %block_.L_409f7d
  ...
  %call2_409fb0 = tail call %struct.Memory* @sub_4126b0._Z17check_shifted_sumIj19custom_constant_subIjEEvT_(%struct.State* %0, i64 %240, %struct.Memory* %MEMORY.1)
...
block_.L_409fc3:                                  ; preds = %block_.L_409f5f
  ...
  %call2_409fc3 = tail call %struct.Memory* @sub_400e60._Z5timerv(%struct.State* %0, i64 %277, %struct.Memory* %MEMORY.0)
  ...
  %call2_409fcc = tail call %struct.Memory* @sub_400800._Z13record_resultdPKc(%struct.State* %0, i64 %288, %struct.Memory* %call2_409fc3)
