...
declare %struct.Memory* @sub_4126f0._Z17check_shifted_sumIj19custom_constant_subIjEEvT_(%struct.State* dereferenceable(3376), i64, %struct.Memory*) local_unnamed_addr
...
entry:
  ...
  %call2_409f93 = tail call %struct.Memory* @sub_400e80._Z11start_timerv(%struct.State* %0, i64 %58, %struct.Memory* %2)
...
block_.L_409f9f:                                  ; preds = %block_.L_409fed, %entry
  %68 = phi i64 [ %.pre, %entry ], [ %276, %block_.L_409fed ]
  %MEMORY.0 = phi %struct.Memory* [ %call2_409f93, %entry ], [ %call2_409ff0, %block_.L_409fed ]
  ...
  br i1 %101, label %block_409faf, label %block_.L_40a003
...
block_.L_409fbd:                                  ; preds = %block_409fc9, %block_409faf
  %111 = phi i64 [ %.pre6, %block_409faf ], [ %234, %block_409fc9 ]
  %MEMORY.1 = phi %struct.Memory* [ %MEMORY.0, %block_409faf ], [ %call2_409fd4, %block_409fc9 ]
  ...
  br i1 %147, label %block_409fc9, label %block_.L_409fed
...
block_409fc9:                                     ; preds = %block_.L_409fbd
  ...
  %call2_409fd4 = tail call %struct.Memory* @sub_4126d0._ZN19custom_constant_subIjE8do_shiftEj(%struct.State* nonnull %0, i64 %162, %struct.Memory* %MEMORY.1)
...
block_.L_409fed:                                  ; preds = %block_.L_409fbd
  ...
  %call2_409ff0 = tail call %struct.Memory* @sub_4126f0._Z17check_shifted_sumIj19custom_constant_subIjEEvT_(%struct.State* nonnull %0, i64 %240, %struct.Memory* %MEMORY.1)
...
block_.L_40a003:                                  ; preds = %block_.L_409f9f
  ...
  %call2_40a003 = tail call %struct.Memory* @sub_400ea0._Z5timerv(%struct.State* nonnull %0, i64 %277, %struct.Memory* %MEMORY.0)
  ...
  %call2_40a00c = tail call %struct.Memory* @sub_400840._Z13record_resultdPKc(%struct.State* nonnull %0, i64 %288, %struct.Memory* %call2_40a003)
  ...
  ret %struct.Memory* %call2_40a00c
}
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_jge_.L_40a003(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i8* nocapture %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_jge_.L_409fed(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i8* nocapture %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 2, i32 9
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_jmpq_.L_409fbd(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
