...
declare %struct.Memory* @sub_412050._ZN19custom_constant_xorIjE8do_shiftEj(%struct.State* dereferenceable(3376), i64, %struct.Memory*)

declare %struct.Memory* @sub_412070._Z17check_shifted_sumIj19custom_constant_xorIjEEvT_(%struct.State* dereferenceable(3376), i64, %struct.Memory*)
...
define %struct.Memory* @_Z13test_constantIj19custom_constant_xorIjEEvPT_iPKc(%struct.State* noalias, i64, %struct.Memory* noalias) #1 {
entry:
