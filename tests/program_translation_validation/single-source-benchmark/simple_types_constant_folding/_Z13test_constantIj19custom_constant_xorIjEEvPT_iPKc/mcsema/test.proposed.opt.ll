...
block_.L_40a77f:                                  ; preds = %block_.L_40a7cd, %entry
  %68 = phi i64 [ %.pre, %entry ], [ %276, %block_.L_40a7cd ]
...
block_.L_40a79d:                                  ; preds = %block_40a7a9, %block_40a78f
  %111 = phi i64 [ %.pre1, %block_40a78f ], [ %234, %block_40a7a9 ]
...
block_.L_40a7cd:                                  ; preds = %block_.L_40a79d
  ...
  %call2_40a7d0 = tail call %struct.Memory* @sub_412030._Z17check_shifted_sumIj19custom_constant_xorIjEEvT_(%struct.State* %0, i64 %240, %struct.Memory* %MEMORY.1)
...
block_.L_40a7e3:                                  ; preds = %block_.L_40a77f
  ...
  %call2_40a7e3 = tail call %struct.Memory* @sub_400e60._Z5timerv(%struct.State* %0, i64 %277, %struct.Memory* %MEMORY.0)
  ...
  %call2_40a7ec = tail call %struct.Memory* @sub_400800._Z13record_resultdPKc(%struct.State* %0, i64 %288, %struct.Memory* %call2_40a7e3)
