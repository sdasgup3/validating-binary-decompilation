...
declare %struct.Memory* @sub_412080._Z17check_shifted_sumIj19custom_constant_xorIjEEvT_(%struct.State* noalias dereferenceable(3376), i64, %struct.Memory* noalias readnone returned) local_unnamed_addr
...
entry:
  ...
  %call2_40a7c3 = tail call %struct.Memory* @sub_400e90._Z11start_timerv(%struct.State* %0, i64 %58, %struct.Memory* %2)
...
block_.L_40a7cf:                                  ; preds = %block_.L_40a81d, %entry
  %68 = phi i64 [ %276, %block_.L_40a81d ], [ %.pre, %entry ]
  ...
  br i1 %101, label %block_40a7df, label %block_.L_40a833
...
block_.L_40a7ed:                                  ; preds = %block_40a7f9, %block_40a7df
  %111 = phi i64 [ %234, %block_40a7f9 ], [ %.pre6, %block_40a7df ]
  ...
  br i1 %147, label %block_40a7f9, label %block_.L_40a81d
...
block_40a7f9:                                     ; preds = %block_.L_40a7ed
  ...
  %call2_40a804 = tail call %struct.Memory* @sub_412060._ZN19custom_constant_xorIjE8do_shiftEj(%struct.State* nonnull %0, i64 %162, %struct.Memory* %call2_40a7c3)
...
block_.L_40a81d:                                  ; preds = %block_.L_40a7ed
  ...
  %call2_40a820 = tail call %struct.Memory* @sub_412080._Z17check_shifted_sumIj19custom_constant_xorIjEEvT_(%struct.State* nonnull %0, i64 %240, %struct.Memory* %call2_40a7c3)
...
block_.L_40a833:                                  ; preds = %block_.L_40a7cf
  ...
  %call2_40a833 = tail call %struct.Memory* @sub_400eb0._Z5timerv(%struct.State* nonnull %0, i64 %277, %struct.Memory* %call2_40a7c3)
  ...
  %call2_40a83c = tail call %struct.Memory* @sub_400850._Z13record_resultdPKc(%struct.State* nonnull %0, i64 %288, %struct.Memory* %call2_40a833)
