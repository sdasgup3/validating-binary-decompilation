...
declare %struct.Memory* @sub_4128c0._ZN19custom_or_constantsIjE8do_shiftEj(%struct.State* dereferenceable(3376), i64, %struct.Memory*) local_unnamed_addr

declare %struct.Memory* @sub_4128d0._Z17check_shifted_sumIj19custom_or_constantsIjEEvT_(%struct.State* dereferenceable(3376), i64, %struct.Memory*) local_unnamed_addr
...
block_.L_409d1f:                                  ; preds = %block_.L_409d6d, %entry
  %68 = phi i64 [ %.pre, %entry ], [ %276, %block_.L_409d6d ]
  %MEMORY.0 = phi %struct.Memory* [ %call2_409d13, %entry ], [ %call2_409d70, %block_.L_409d6d ]
...
block_.L_409d3d:                                  ; preds = %block_409d49, %block_409d2f
  %111 = phi i64 [ %.pre6, %block_409d2f ], [ %234, %block_409d49 ]
  %MEMORY.1 = phi %struct.Memory* [ %MEMORY.0, %block_409d2f ], [ %call2_409d54, %block_409d49 ]
...
block_409d49:                                     ; preds = %block_.L_409d3d
  ...
  %call2_409d54 = tail call %struct.Memory* @sub_4128c0._ZN19custom_or_constantsIjE8do_shiftEj(%struct.State* nonnull %0, i64 %162, %struct.Memory* %MEMORY.1)
...
block_.L_409d6d:                                  ; preds = %block_.L_409d3d
  ...
  %call2_409d70 = tail call %struct.Memory* @sub_4128d0._Z17check_shifted_sumIj19custom_or_constantsIjEEvT_(%struct.State* nonnull %0, i64 %240, %struct.Memory* %MEMORY.1)
...
block_.L_409d83:                                  ; preds = %block_.L_409d1f
  ...
  %call2_409d83 = tail call %struct.Memory* @sub_400ea0._Z5timerv(%struct.State* nonnull %0, i64 %277, %struct.Memory* %MEMORY.0)
