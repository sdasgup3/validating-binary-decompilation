...
block_.L_409cdf:                                  ; preds = %block_.L_409d2d, %entry
  %68 = phi i64 [ %.pre, %entry ], [ %276, %block_.L_409d2d ]
...
block_.L_409cfd:                                  ; preds = %block_409d09, %block_409cef
  %111 = phi i64 [ %.pre1, %block_409cef ], [ %234, %block_409d09 ]
...
block_.L_409d2d:                                  ; preds = %block_.L_409cfd
  ...
  %call2_409d30 = tail call %struct.Memory* @sub_412890._Z17check_shifted_sumIj19custom_or_constantsIjEEvT_(%struct.State* %0, i64 %240, %struct.Memory* %MEMORY.1)
...
block_.L_409d43:                                  ; preds = %block_.L_409cdf
  ...
  %call2_409d43 = tail call %struct.Memory* @sub_400e60._Z5timerv(%struct.State* %0, i64 %277, %struct.Memory* %MEMORY.0)
  ...
  %call2_409d4c = tail call %struct.Memory* @sub_400800._Z13record_resultdPKc(%struct.State* %0, i64 %288, %struct.Memory* %call2_409d43)
