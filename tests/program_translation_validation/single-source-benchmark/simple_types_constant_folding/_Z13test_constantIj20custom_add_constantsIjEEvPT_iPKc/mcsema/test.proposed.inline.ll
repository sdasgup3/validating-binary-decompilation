...
declare %struct.Memory* @sub_412e10._Z17check_shifted_sumIj20custom_add_constantsIjEEvT_(%struct.State* dereferenceable(3376), i64, %struct.Memory*)
...
define %struct.Memory* @_Z13test_constantIj20custom_add_constantsIjEEvPT_iPKc(%struct.State* noalias, i64, %struct.Memory* noalias) #1 {
entry:
