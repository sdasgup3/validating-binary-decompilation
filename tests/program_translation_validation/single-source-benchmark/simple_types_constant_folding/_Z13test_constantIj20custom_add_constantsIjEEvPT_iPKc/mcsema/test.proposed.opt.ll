...
declare %struct.Memory* @sub_412e10._ZN20custom_add_constantsIjE8do_shiftEj(%struct.State* noalias dereferenceable(3376), i64, %struct.Memory* noalias readnone returned) local_unnamed_addr

declare %struct.Memory* @sub_412e20._Z17check_shifted_sumIj20custom_add_constantsIjEEvT_(%struct.State* noalias dereferenceable(3376), i64, %struct.Memory* noalias readnone returned) local_unnamed_addr
...
entry:
  ...
  %call2_4095a3 = tail call %struct.Memory* @sub_400e90._Z11start_timerv(%struct.State* %0, i64 %58, %struct.Memory* %2)
...
block_.L_4095af:                                  ; preds = %block_.L_4095fd, %entry
  %68 = phi i64 [ %276, %block_.L_4095fd ], [ %.pre, %entry ]
  ...
  br i1 %101, label %block_4095bf, label %block_.L_409613
...
block_.L_4095cd:                                  ; preds = %block_4095d9, %block_4095bf
  %111 = phi i64 [ %234, %block_4095d9 ], [ %.pre6, %block_4095bf ]
  ...
  br i1 %147, label %block_4095d9, label %block_.L_4095fd
...
block_4095d9:                                     ; preds = %block_.L_4095cd
  ...
  %call2_4095e4 = tail call %struct.Memory* @sub_412e10._ZN20custom_add_constantsIjE8do_shiftEj(%struct.State* nonnull %0, i64 %162, %struct.Memory* %call2_4095a3)
...
block_.L_4095fd:                                  ; preds = %block_.L_4095cd
  ...
  %call2_409600 = tail call %struct.Memory* @sub_412e20._Z17check_shifted_sumIj20custom_add_constantsIjEEvT_(%struct.State* nonnull %0, i64 %240, %struct.Memory* %call2_4095a3)
...
block_.L_409613:                                  ; preds = %block_.L_4095af
  ...
  %call2_409613 = tail call %struct.Memory* @sub_400eb0._Z5timerv(%struct.State* nonnull %0, i64 %277, %struct.Memory* %call2_4095a3)
  ...
  %call2_40961c = tail call %struct.Memory* @sub_400850._Z13record_resultdPKc(%struct.State* nonnull %0, i64 %288, %struct.Memory* %call2_409613)
