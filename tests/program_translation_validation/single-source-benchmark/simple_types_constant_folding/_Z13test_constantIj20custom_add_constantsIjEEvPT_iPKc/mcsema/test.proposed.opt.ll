...
block_.L_40955f:                                  ; preds = %block_.L_4095ad, %entry
  %68 = phi i64 [ %.pre, %entry ], [ %278, %block_.L_4095ad ]
...
block_.L_40957d:                                  ; preds = %block_409589, %block_40956f
  %111 = phi i64 [ %.pre1, %block_40956f ], [ %235, %block_409589 ]
...
block_.L_4095ad:                                  ; preds = %block_.L_40957d
  ...
  %call2_4095b0 = tail call %struct.Memory* @sub_412dd0._Z17check_shifted_sumIj20custom_add_constantsIjEEvT_(%struct.State* %0, i64 %241, %struct.Memory* %MEMORY.1)
...
block_.L_4095c3:                                  ; preds = %block_.L_40955f
  ...
  %call2_4095c3 = tail call %struct.Memory* @sub_400e60._Z5timerv(%struct.State* %0, i64 %279, %struct.Memory* %MEMORY.0)
  ...
  %call2_4095cc = tail call %struct.Memory* @sub_400800._Z13record_resultdPKc(%struct.State* %0, i64 %290, %struct.Memory* %call2_4095c3)
