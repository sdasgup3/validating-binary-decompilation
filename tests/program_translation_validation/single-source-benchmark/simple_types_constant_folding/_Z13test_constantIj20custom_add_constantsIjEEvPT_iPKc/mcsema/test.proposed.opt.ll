...
declare %struct.Memory* @sub_412e00._ZN20custom_add_constantsIjE8do_shiftEj(%struct.State* noalias dereferenceable(3376), i64, %struct.Memory* noalias readnone returned) local_unnamed_addr

declare %struct.Memory* @sub_412e10._Z17check_shifted_sumIj20custom_add_constantsIjEEvT_(%struct.State* noalias dereferenceable(3376), i64, %struct.Memory* noalias readnone returned) local_unnamed_addr
...
define %struct.Memory* @_Z13test_constantIj20custom_add_constantsIjEEvPT_iPKc(%struct.State* noalias, i64, %struct.Memory* noalias readnone) local_unnamed_addr #1 {
entry:
...
block_.L_40959f:                                  ; preds = %block_.L_4095ed, %entry
  %68 = phi i64 [ %276, %block_.L_4095ed ], [ %.pre, %entry ]
...
block_.L_4095bd:                                  ; preds = %block_4095c9, %block_4095af
  %111 = phi i64 [ %234, %block_4095c9 ], [ %.pre6, %block_4095af ]
...
block_4095c9:                                     ; preds = %block_.L_4095bd
  ...
  %call2_4095d4 = tail call %struct.Memory* @sub_412e00._ZN20custom_add_constantsIjE8do_shiftEj(%struct.State* nonnull %0, i64 %162, %struct.Memory* %call2_409593)
...
block_.L_4095ed:                                  ; preds = %block_.L_4095bd
  ...
  %call2_4095f0 = tail call %struct.Memory* @sub_412e10._Z17check_shifted_sumIj20custom_add_constantsIjEEvT_(%struct.State* nonnull %0, i64 %240, %struct.Memory* %call2_409593)
...
block_.L_409603:                                  ; preds = %block_.L_40959f
  ...
  %call2_409603 = tail call %struct.Memory* @sub_400ea0._Z5timerv(%struct.State* nonnull %0, i64 %277, %struct.Memory* %call2_409593)
