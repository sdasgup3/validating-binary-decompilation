...
declare %struct.Memory* @sub_412e00._ZN20custom_add_constantsIjE8do_shiftEj(%struct.State* dereferenceable(3376), i64, %struct.Memory*) local_unnamed_addr

declare %struct.Memory* @sub_412e10._Z17check_shifted_sumIj20custom_add_constantsIjEEvT_(%struct.State* dereferenceable(3376), i64, %struct.Memory*) local_unnamed_addr
...
entry:
  ...
  %call2_409593 = tail call %struct.Memory* @sub_400e80._Z11start_timerv(%struct.State* %0, i64 %58, %struct.Memory* %2)
...
block_.L_40959f:                                  ; preds = %block_.L_4095ed, %entry
  %68 = phi i64 [ %.pre, %entry ], [ %276, %block_.L_4095ed ]
  %MEMORY.0 = phi %struct.Memory* [ %call2_409593, %entry ], [ %call2_4095f0, %block_.L_4095ed ]
  ...
  br i1 %101, label %block_4095af, label %block_.L_409603
...
block_.L_4095bd:                                  ; preds = %block_4095c9, %block_4095af
  %111 = phi i64 [ %.pre6, %block_4095af ], [ %234, %block_4095c9 ]
  %MEMORY.1 = phi %struct.Memory* [ %MEMORY.0, %block_4095af ], [ %call2_4095d4, %block_4095c9 ]
  ...
  br i1 %147, label %block_4095c9, label %block_.L_4095ed
...
block_4095c9:                                     ; preds = %block_.L_4095bd
  ...
  %call2_4095d4 = tail call %struct.Memory* @sub_412e00._ZN20custom_add_constantsIjE8do_shiftEj(%struct.State* nonnull %0, i64 %162, %struct.Memory* %MEMORY.1)
...
block_.L_4095ed:                                  ; preds = %block_.L_4095bd
  ...
  %call2_4095f0 = tail call %struct.Memory* @sub_412e10._Z17check_shifted_sumIj20custom_add_constantsIjEEvT_(%struct.State* nonnull %0, i64 %240, %struct.Memory* %MEMORY.1)
...
block_.L_409603:                                  ; preds = %block_.L_40959f
  ...
  %call2_409603 = tail call %struct.Memory* @sub_400ea0._Z5timerv(%struct.State* nonnull %0, i64 %277, %struct.Memory* %MEMORY.0)
  ...
  %call2_40960c = tail call %struct.Memory* @sub_400840._Z13record_resultdPKc(%struct.State* nonnull %0, i64 %288, %struct.Memory* %call2_409603)
  ...
  ret %struct.Memory* %call2_40960c
}
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_jge_.L_409603(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i8* nocapture %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_jmpq_.L_4095bd(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
