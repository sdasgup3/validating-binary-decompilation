...
declare %struct.Memory* @sub_412940._Z17check_shifted_sumIj20custom_and_constantsIjEEvT_(%struct.State* dereferenceable(3376), i64, %struct.Memory*) local_unnamed_addr
...
define %struct.Memory* @_Z13test_constantIj20custom_and_constantsIjEEvPT_iPKc(%struct.State* noalias, i64, %struct.Memory* noalias) local_unnamed_addr #1 {
entry:
  ...
  %call2_409c73 = tail call %struct.Memory* @sub_400e80._Z11start_timerv(%struct.State* %0, i64 %58, %struct.Memory* %2)
...
block_.L_409c7f:                                  ; preds = %block_.L_409ccd, %entry
  %68 = phi i64 [ %.pre, %entry ], [ %276, %block_.L_409ccd ]
  %MEMORY.0 = phi %struct.Memory* [ %call2_409c73, %entry ], [ %call2_409cd0, %block_.L_409ccd ]
  ...
  br i1 %101, label %block_409c8f, label %block_.L_409ce3
...
block_.L_409c9d:                                  ; preds = %block_409ca9, %block_409c8f
  %111 = phi i64 [ %.pre6, %block_409c8f ], [ %234, %block_409ca9 ]
  %MEMORY.1 = phi %struct.Memory* [ %MEMORY.0, %block_409c8f ], [ %call2_409cb4, %block_409ca9 ]
  ...
  br i1 %147, label %block_409ca9, label %block_.L_409ccd

block_409ca9:                                     ; preds = %block_.L_409c9d
  %149 = add i64 %112, -8
  %150 = add i64 %148, 4
  ...
  %call2_409cb4 = tail call %struct.Memory* @sub_412930._ZN20custom_and_constantsIjE8do_shiftEj(%struct.State* nonnull %0, i64 %162, %struct.Memory* %MEMORY.1)
...
block_.L_409ccd:                                  ; preds = %block_.L_409c9d
  %235 = add i64 %112, -32
  %236 = add i64 %148, 3
  ...
  %call2_409cd0 = tail call %struct.Memory* @sub_412940._Z17check_shifted_sumIj20custom_and_constantsIjEEvT_(%struct.State* nonnull %0, i64 %240, %struct.Memory* %MEMORY.1)
...
block_.L_409ce3:                                  ; preds = %block_.L_409c7f
  %277 = add i64 %102, -36419
  %278 = add i64 %102, 5
  ...
  %call2_409ce3 = tail call %struct.Memory* @sub_400ea0._Z5timerv(%struct.State* nonnull %0, i64 %277, %struct.Memory* %MEMORY.0)
  ...
  %call2_409cec = tail call %struct.Memory* @sub_400840._Z13record_resultdPKc(%struct.State* nonnull %0, i64 %288, %struct.Memory* %call2_409ce3)
  ...
  ret %struct.Memory* %call2_409cec
}
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_jge_.L_409ce3(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i8* nocapture %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_jmpq_.L_409c9d(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_callq_._Z17check_shifted_sumIj20custom_and_constantsIjEEvT_(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
