...
declare %struct.Memory* @sub_412940._Z17check_shifted_sumIj20custom_and_constantsIjEEvT_(%struct.State* noalias dereferenceable(3376), i64, %struct.Memory* noalias readnone returned) local_unnamed_addr
...
block_.L_409c7f:                                  ; preds = %block_.L_409ccd, %entry
  %68 = phi i64 [ %276, %block_.L_409ccd ], [ %.pre, %entry ]
...
block_.L_409c9d:                                  ; preds = %block_409ca9, %block_409c8f
  %111 = phi i64 [ %234, %block_409ca9 ], [ %.pre6, %block_409c8f ]
...
block_409ca9:                                     ; preds = %block_.L_409c9d
  ...
  %call2_409cb4 = tail call %struct.Memory* @sub_412930._ZN20custom_and_constantsIjE8do_shiftEj(%struct.State* nonnull %0, i64 %162, %struct.Memory* %call2_409c73)
...
block_.L_409ccd:                                  ; preds = %block_.L_409c9d
  ...
  %call2_409cd0 = tail call %struct.Memory* @sub_412940._Z17check_shifted_sumIj20custom_and_constantsIjEEvT_(%struct.State* nonnull %0, i64 %240, %struct.Memory* %call2_409c73)
...
block_.L_409ce3:                                  ; preds = %block_.L_409c7f
  ...
  %call2_409ce3 = tail call %struct.Memory* @sub_400ea0._Z5timerv(%struct.State* nonnull %0, i64 %277, %struct.Memory* %call2_409c73)
