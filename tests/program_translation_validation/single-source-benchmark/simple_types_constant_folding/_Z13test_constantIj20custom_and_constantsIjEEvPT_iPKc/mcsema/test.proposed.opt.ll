...
declare %struct.Memory* @sub_412900._Z17check_shifted_sumIj20custom_and_constantsIjEEvT_(%struct.State* noalias dereferenceable(3376), i64, %struct.Memory* noalias readnone returned) local_unnamed_addr
...
entry:
  ...
  %call2_409c33 = tail call %struct.Memory* @sub_400e40._Z11start_timerv(%struct.State* %0, i64 %58, %struct.Memory* %2)
...
block_.L_409c3f:                                  ; preds = %block_.L_409c8d, %entry
  %68 = phi i64 [ %.pre, %entry ], [ %278, %block_.L_409c8d ]
  %MEMORY.0 = phi %struct.Memory* [ %call2_409c33, %entry ], [ %call2_409c90, %block_.L_409c8d ]
  ...
  br i1 %101, label %block_409c4f, label %block_.L_409ca3
...
block_.L_409c5d:                                  ; preds = %block_409c69, %block_409c4f
  %111 = phi i64 [ %.pre1, %block_409c4f ], [ %235, %block_409c69 ]
  %MEMORY.1 = phi %struct.Memory* [ %MEMORY.0, %block_409c4f ], [ %call2_409c74, %block_409c69 ]
  ...
  br i1 %147, label %block_409c69, label %block_.L_409c8d

block_409c69:                                     ; preds = %block_.L_409c5d
  %149 = add i64 %112, -8
  %150 = add i64 %148, 4
  ...
  %call2_409c74 = tail call %struct.Memory* @sub_4128f0._ZN20custom_and_constantsIjE8do_shiftEj(%struct.State* %0, i64 %162, %struct.Memory* %MEMORY.1)
...
block_.L_409c8d:                                  ; preds = %block_.L_409c5d
  %236 = add i64 %112, -32
  %237 = add i64 %148, 3
  ...
  %call2_409c90 = tail call %struct.Memory* @sub_412900._Z17check_shifted_sumIj20custom_and_constantsIjEEvT_(%struct.State* %0, i64 %241, %struct.Memory* %MEMORY.1)
...
block_.L_409ca3:                                  ; preds = %block_.L_409c3f
  %279 = add i64 %102, -36419
  %280 = add i64 %102, 5
  ...
  %call2_409ca3 = tail call %struct.Memory* @sub_400e60._Z5timerv(%struct.State* %0, i64 %279, %struct.Memory* %MEMORY.0)
  ...
  %call2_409cac = tail call %struct.Memory* @sub_400800._Z13record_resultdPKc(%struct.State* %0, i64 %290, %struct.Memory* %call2_409ca3)
  ...
  ret %struct.Memory* %call2_409cac
}
...
define %struct.Memory* @routine_jge_.L_409ca3(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i8* %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
...
define %struct.Memory* @routine_jge_.L_409c8d(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i8* %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 2, i32 9
...
define %struct.Memory* @routine_jmpq_.L_409c5d(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
...
define %struct.Memory* @routine_callq_._Z17check_shifted_sumIj20custom_and_constantsIjEEvT_(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
...
define %struct.Memory* @routine_jmpq_.L_409c3f(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
