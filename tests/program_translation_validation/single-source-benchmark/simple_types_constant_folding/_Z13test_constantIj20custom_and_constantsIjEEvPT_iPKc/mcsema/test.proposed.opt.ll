...
block_.L_409c3f:                                  ; preds = %block_.L_409c8d, %entry
  %68 = phi i64 [ %.pre, %entry ], [ %276, %block_.L_409c8d ]
...
block_.L_409c5d:                                  ; preds = %block_409c69, %block_409c4f
  %111 = phi i64 [ %.pre1, %block_409c4f ], [ %234, %block_409c69 ]
...
block_.L_409c8d:                                  ; preds = %block_.L_409c5d
  ...
  %call2_409c90 = tail call %struct.Memory* @sub_412900._Z17check_shifted_sumIj20custom_and_constantsIjEEvT_(%struct.State* %0, i64 %240, %struct.Memory* %MEMORY.1)
...
block_.L_409ca3:                                  ; preds = %block_.L_409c3f
  ...
  %call2_409ca3 = tail call %struct.Memory* @sub_400e60._Z5timerv(%struct.State* %0, i64 %277, %struct.Memory* %MEMORY.0)
  ...
  %call2_409cac = tail call %struct.Memory* @sub_400800._Z13record_resultdPKc(%struct.State* %0, i64 %288, %struct.Memory* %call2_409ca3)
