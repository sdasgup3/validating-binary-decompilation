...
declare %struct.Memory* @sub_412c40._ZN20custom_mod_constantsIjE8do_shiftEj(%struct.State* noalias dereferenceable(3376), i64, %struct.Memory* noalias readnone returned) local_unnamed_addr

declare %struct.Memory* @sub_412c50._Z17check_shifted_sumIj20custom_mod_constantsIjEEvT_(%struct.State* noalias dereferenceable(3376), i64, %struct.Memory* noalias readnone returned) local_unnamed_addr
...
define %struct.Memory* @_Z13test_constantIj20custom_mod_constantsIjEEvPT_iPKc(%struct.State* noalias, i64, %struct.Memory* noalias readnone) local_unnamed_addr #1 {
entry:
...
block_.L_40981f:                                  ; preds = %block_.L_40986d, %entry
  %68 = phi i64 [ %276, %block_.L_40986d ], [ %.pre, %entry ]
...
block_.L_40983d:                                  ; preds = %block_409849, %block_40982f
  %111 = phi i64 [ %234, %block_409849 ], [ %.pre6, %block_40982f ]
...
block_409849:                                     ; preds = %block_.L_40983d
  ...
  %call2_409854 = tail call %struct.Memory* @sub_412c40._ZN20custom_mod_constantsIjE8do_shiftEj(%struct.State* nonnull %0, i64 %162, %struct.Memory* %call2_409813)
...
block_.L_40986d:                                  ; preds = %block_.L_40983d
  ...
  %call2_409870 = tail call %struct.Memory* @sub_412c50._Z17check_shifted_sumIj20custom_mod_constantsIjEEvT_(%struct.State* nonnull %0, i64 %240, %struct.Memory* %call2_409813)
...
block_.L_409883:                                  ; preds = %block_.L_40981f
  ...
  %call2_409883 = tail call %struct.Memory* @sub_400ea0._Z5timerv(%struct.State* nonnull %0, i64 %277, %struct.Memory* %call2_409813)
