...
block_.L_4097df:                                  ; preds = %block_.L_40982d, %entry
  %68 = phi i64 [ %.pre, %entry ], [ %276, %block_.L_40982d ]
...
block_.L_4097fd:                                  ; preds = %block_409809, %block_4097ef
  %111 = phi i64 [ %.pre1, %block_4097ef ], [ %234, %block_409809 ]
...
block_.L_40982d:                                  ; preds = %block_.L_4097fd
  ...
  %call2_409830 = tail call %struct.Memory* @sub_412c10._Z17check_shifted_sumIj20custom_mod_constantsIjEEvT_(%struct.State* %0, i64 %240, %struct.Memory* %MEMORY.1)
...
block_.L_409843:                                  ; preds = %block_.L_4097df
  ...
  %call2_409843 = tail call %struct.Memory* @sub_400e60._Z5timerv(%struct.State* %0, i64 %277, %struct.Memory* %MEMORY.0)
  ...
  %call2_40984c = tail call %struct.Memory* @sub_400800._Z13record_resultdPKc(%struct.State* %0, i64 %288, %struct.Memory* %call2_409843)
