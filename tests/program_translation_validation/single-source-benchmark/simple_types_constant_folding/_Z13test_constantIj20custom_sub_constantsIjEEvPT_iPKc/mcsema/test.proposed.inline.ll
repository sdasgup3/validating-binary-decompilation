...
declare %struct.Memory* @sub_412d90._ZN20custom_sub_constantsIjE8do_shiftEj(%struct.State* dereferenceable(3376), i64, %struct.Memory*)

declare %struct.Memory* @sub_412da0._Z17check_shifted_sumIj20custom_sub_constantsIjEEvT_(%struct.State* dereferenceable(3376), i64, %struct.Memory*)
...
define %struct.Memory* @_Z13test_constantIj20custom_sub_constantsIjEEvPT_iPKc(%struct.State* noalias, i64, %struct.Memory* noalias) #1 {
entry:
