...
block_.L_4095ff:                                  ; preds = %block_.L_40964d, %entry
  %68 = phi i64 [ %.pre, %entry ], [ %276, %block_.L_40964d ]
...
block_.L_40961d:                                  ; preds = %block_409629, %block_40960f
  %111 = phi i64 [ %.pre1, %block_40960f ], [ %234, %block_409629 ]
...
block_.L_40964d:                                  ; preds = %block_.L_40961d
  ...
  %call2_409650 = tail call %struct.Memory* @sub_412d60._Z17check_shifted_sumIj20custom_sub_constantsIjEEvT_(%struct.State* %0, i64 %240, %struct.Memory* %MEMORY.1)
...
block_.L_409663:                                  ; preds = %block_.L_4095ff
  ...
  %call2_409663 = tail call %struct.Memory* @sub_400e60._Z5timerv(%struct.State* %0, i64 %277, %struct.Memory* %MEMORY.0)
  ...
  %call2_40966c = tail call %struct.Memory* @sub_400800._Z13record_resultdPKc(%struct.State* %0, i64 %288, %struct.Memory* %call2_409663)
