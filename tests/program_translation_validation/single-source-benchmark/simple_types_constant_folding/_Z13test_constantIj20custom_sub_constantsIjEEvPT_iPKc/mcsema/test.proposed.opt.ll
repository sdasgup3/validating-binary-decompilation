...
declare %struct.Memory* @sub_412d90._ZN20custom_sub_constantsIjE8do_shiftEj(%struct.State* dereferenceable(3376), i64, %struct.Memory*) local_unnamed_addr

declare %struct.Memory* @sub_412da0._Z17check_shifted_sumIj20custom_sub_constantsIjEEvT_(%struct.State* dereferenceable(3376), i64, %struct.Memory*) local_unnamed_addr
...
block_.L_40963f:                                  ; preds = %block_.L_40968d, %entry
  %68 = phi i64 [ %.pre, %entry ], [ %276, %block_.L_40968d ]
  %MEMORY.0 = phi %struct.Memory* [ %call2_409633, %entry ], [ %call2_409690, %block_.L_40968d ]
...
block_.L_40965d:                                  ; preds = %block_409669, %block_40964f
  %111 = phi i64 [ %.pre6, %block_40964f ], [ %234, %block_409669 ]
  %MEMORY.1 = phi %struct.Memory* [ %MEMORY.0, %block_40964f ], [ %call2_409674, %block_409669 ]
...
block_409669:                                     ; preds = %block_.L_40965d
  ...
  %call2_409674 = tail call %struct.Memory* @sub_412d90._ZN20custom_sub_constantsIjE8do_shiftEj(%struct.State* nonnull %0, i64 %162, %struct.Memory* %MEMORY.1)
...
block_.L_40968d:                                  ; preds = %block_.L_40965d
  ...
  %call2_409690 = tail call %struct.Memory* @sub_412da0._Z17check_shifted_sumIj20custom_sub_constantsIjEEvT_(%struct.State* nonnull %0, i64 %240, %struct.Memory* %MEMORY.1)
...
block_.L_4096a3:                                  ; preds = %block_.L_40963f
  ...
  %call2_4096a3 = tail call %struct.Memory* @sub_400ea0._Z5timerv(%struct.State* nonnull %0, i64 %277, %struct.Memory* %MEMORY.0)
