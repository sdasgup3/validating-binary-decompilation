...
declare %struct.Memory* @sub_412850._ZN20custom_xor_constantsIjE8do_shiftEj(%struct.State* dereferenceable(3376), i64, %struct.Memory*) local_unnamed_addr

declare %struct.Memory* @sub_412860._Z17check_shifted_sumIj20custom_xor_constantsIjEEvT_(%struct.State* dereferenceable(3376), i64, %struct.Memory*) local_unnamed_addr
...
block_.L_409dbf:                                  ; preds = %block_.L_409e0d, %entry
  %68 = phi i64 [ %.pre, %entry ], [ %276, %block_.L_409e0d ]
  %MEMORY.0 = phi %struct.Memory* [ %call2_409db3, %entry ], [ %call2_409e10, %block_.L_409e0d ]
...
block_.L_409ddd:                                  ; preds = %block_409de9, %block_409dcf
  %111 = phi i64 [ %.pre6, %block_409dcf ], [ %234, %block_409de9 ]
  %MEMORY.1 = phi %struct.Memory* [ %MEMORY.0, %block_409dcf ], [ %call2_409df4, %block_409de9 ]
...
block_409de9:                                     ; preds = %block_.L_409ddd
  ...
  %call2_409df4 = tail call %struct.Memory* @sub_412850._ZN20custom_xor_constantsIjE8do_shiftEj(%struct.State* nonnull %0, i64 %162, %struct.Memory* %MEMORY.1)
...
block_.L_409e0d:                                  ; preds = %block_.L_409ddd
  ...
  %call2_409e10 = tail call %struct.Memory* @sub_412860._Z17check_shifted_sumIj20custom_xor_constantsIjEEvT_(%struct.State* nonnull %0, i64 %240, %struct.Memory* %MEMORY.1)
...
block_.L_409e23:                                  ; preds = %block_.L_409dbf
  ...
  %call2_409e23 = tail call %struct.Memory* @sub_400ea0._Z5timerv(%struct.State* nonnull %0, i64 %277, %struct.Memory* %MEMORY.0)
