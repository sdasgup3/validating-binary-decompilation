...
block_.L_409d7f:                                  ; preds = %block_.L_409dcd, %entry
  %68 = phi i64 [ %.pre, %entry ], [ %276, %block_.L_409dcd ]
...
block_.L_409d9d:                                  ; preds = %block_409da9, %block_409d8f
  %111 = phi i64 [ %.pre1, %block_409d8f ], [ %234, %block_409da9 ]
...
block_.L_409dcd:                                  ; preds = %block_.L_409d9d
  ...
  %call2_409dd0 = tail call %struct.Memory* @sub_412820._Z17check_shifted_sumIj20custom_xor_constantsIjEEvT_(%struct.State* %0, i64 %240, %struct.Memory* %MEMORY.1)
...
block_.L_409de3:                                  ; preds = %block_.L_409d7f
  ...
  %call2_409de3 = tail call %struct.Memory* @sub_400e60._Z5timerv(%struct.State* %0, i64 %277, %struct.Memory* %MEMORY.0)
  ...
  %call2_409dec = tail call %struct.Memory* @sub_400800._Z13record_resultdPKc(%struct.State* %0, i64 %288, %struct.Memory* %call2_409de3)
