...
declare %struct.Memory* @sub_412850._ZN20custom_xor_constantsIjE8do_shiftEj(%struct.State* noalias dereferenceable(3376), i64, %struct.Memory* noalias readnone returned) local_unnamed_addr

declare %struct.Memory* @sub_412860._Z17check_shifted_sumIj20custom_xor_constantsIjEEvT_(%struct.State* noalias dereferenceable(3376), i64, %struct.Memory* noalias readnone returned) local_unnamed_addr
...
entry:
  ...
  %call2_409db3 = tail call %struct.Memory* @sub_400e80._Z11start_timerv(%struct.State* %0, i64 %58, %struct.Memory* %2)
...
block_.L_409dbf:                                  ; preds = %block_.L_409e0d, %entry
  %68 = phi i64 [ %276, %block_.L_409e0d ], [ %.pre, %entry ]
  ...
  br i1 %101, label %block_409dcf, label %block_.L_409e23

block_409dcf:                                     ; preds = %block_.L_409dbf
  %103 = add i64 %69, -32
  %104 = add i64 %102, 7
...
block_.L_409ddd:                                  ; preds = %block_409de9, %block_409dcf
  %111 = phi i64 [ %234, %block_409de9 ], [ %.pre6, %block_409dcf ]
  ...
  br i1 %147, label %block_409de9, label %block_.L_409e0d

block_409de9:                                     ; preds = %block_.L_409ddd
  %149 = add i64 %112, -8
  %150 = add i64 %148, 4
  ...
  %call2_409df4 = tail call %struct.Memory* @sub_412850._ZN20custom_xor_constantsIjE8do_shiftEj(%struct.State* nonnull %0, i64 %162, %struct.Memory* %call2_409db3)
...
block_.L_409e0d:                                  ; preds = %block_.L_409ddd
  %235 = add i64 %112, -32
  %236 = add i64 %148, 3
  ...
  %call2_409e10 = tail call %struct.Memory* @sub_412860._Z17check_shifted_sumIj20custom_xor_constantsIjEEvT_(%struct.State* nonnull %0, i64 %240, %struct.Memory* %call2_409db3)
...
block_.L_409e23:                                  ; preds = %block_.L_409dbf
  ...
  %call2_409e23 = tail call %struct.Memory* @sub_400ea0._Z5timerv(%struct.State* nonnull %0, i64 %277, %struct.Memory* %call2_409db3)
  ...
  %call2_409e2c = tail call %struct.Memory* @sub_400840._Z13record_resultdPKc(%struct.State* nonnull %0, i64 %288, %struct.Memory* %call2_409e23)
  ...
  ret %struct.Memory* %call2_409e2c
}
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_jge_.L_409e23(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i8* nocapture %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_jge_.L_409e0d(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i8* nocapture %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 2, i32 9
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_jmpq_.L_409ddd(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
