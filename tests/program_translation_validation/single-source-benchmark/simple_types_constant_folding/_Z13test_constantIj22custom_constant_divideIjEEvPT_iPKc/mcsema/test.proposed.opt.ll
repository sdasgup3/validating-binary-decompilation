...
block_.L_40a27f:                                  ; preds = %block_.L_40a2cd, %entry
  %68 = phi i64 [ %.pre, %entry ], [ %278, %block_.L_40a2cd ]
...
block_.L_40a29d:                                  ; preds = %block_40a2a9, %block_40a28f
  %111 = phi i64 [ %.pre1, %block_40a28f ], [ %235, %block_40a2a9 ]
...
block_.L_40a2cd:                                  ; preds = %block_.L_40a29d
  ...
  %call2_40a2d0 = tail call %struct.Memory* @sub_412440._Z17check_shifted_sumIj22custom_constant_divideIjEEvT_(%struct.State* %0, i64 %241, %struct.Memory* %MEMORY.1)
...
block_.L_40a2e3:                                  ; preds = %block_.L_40a27f
  ...
  %call2_40a2e3 = tail call %struct.Memory* @sub_400e60._Z5timerv(%struct.State* %0, i64 %279, %struct.Memory* %MEMORY.0)
  ...
  %call2_40a2ec = tail call %struct.Memory* @sub_400800._Z13record_resultdPKc(%struct.State* %0, i64 %290, %struct.Memory* %call2_40a2e3)
