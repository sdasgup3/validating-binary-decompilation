...
declare %struct.Memory* @sub_412bd0._ZN22custom_equal_constantsIjE8do_shiftEj(%struct.State* dereferenceable(3376), i64, %struct.Memory*)

declare %struct.Memory* @sub_412be0._Z17check_shifted_sumIj22custom_equal_constantsIjEEvT_(%struct.State* dereferenceable(3376), i64, %struct.Memory*)
...
define %struct.Memory* @_Z13test_constantIj22custom_equal_constantsIjEEvPT_iPKc(%struct.State* noalias, i64, %struct.Memory* noalias) #1 {
entry:
