...
declare %struct.Memory* @sub_412bd0._ZN22custom_equal_constantsIjE8do_shiftEj(%struct.State* noalias dereferenceable(3376), i64, %struct.Memory* noalias readnone returned) local_unnamed_addr

declare %struct.Memory* @sub_412be0._Z17check_shifted_sumIj22custom_equal_constantsIjEEvT_(%struct.State* noalias dereferenceable(3376), i64, %struct.Memory* noalias readnone returned) local_unnamed_addr
...
define %struct.Memory* @_Z13test_constantIj22custom_equal_constantsIjEEvPT_iPKc(%struct.State* noalias, i64, %struct.Memory* noalias readnone) local_unnamed_addr #1 {
entry:
...
block_.L_4098bf:                                  ; preds = %block_.L_40990d, %entry
  %68 = phi i64 [ %276, %block_.L_40990d ], [ %.pre, %entry ]
...
block_.L_4098dd:                                  ; preds = %block_4098e9, %block_4098cf
  %111 = phi i64 [ %234, %block_4098e9 ], [ %.pre6, %block_4098cf ]
...
block_4098e9:                                     ; preds = %block_.L_4098dd
  ...
  %call2_4098f4 = tail call %struct.Memory* @sub_412bd0._ZN22custom_equal_constantsIjE8do_shiftEj(%struct.State* nonnull %0, i64 %162, %struct.Memory* %call2_4098b3)
...
block_.L_40990d:                                  ; preds = %block_.L_4098dd
  ...
  %call2_409910 = tail call %struct.Memory* @sub_412be0._Z17check_shifted_sumIj22custom_equal_constantsIjEEvT_(%struct.State* nonnull %0, i64 %240, %struct.Memory* %call2_4098b3)
...
block_.L_409923:                                  ; preds = %block_.L_4098bf
  ...
  %call2_409923 = tail call %struct.Memory* @sub_400ea0._Z5timerv(%struct.State* nonnull %0, i64 %277, %struct.Memory* %call2_4098b3)
