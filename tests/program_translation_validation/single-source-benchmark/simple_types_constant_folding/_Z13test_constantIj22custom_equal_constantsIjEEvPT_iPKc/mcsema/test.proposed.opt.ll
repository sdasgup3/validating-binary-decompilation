...
declare %struct.Memory* @sub_412bf0._Z17check_shifted_sumIj22custom_equal_constantsIjEEvT_(%struct.State* noalias dereferenceable(3376), i64, %struct.Memory* noalias readnone returned) local_unnamed_addr
...
entry:
  ...
  %call2_4098c3 = tail call %struct.Memory* @sub_400e90._Z11start_timerv(%struct.State* %0, i64 %58, %struct.Memory* %2)
...
block_.L_4098cf:                                  ; preds = %block_.L_40991d, %entry
  %68 = phi i64 [ %276, %block_.L_40991d ], [ %.pre, %entry ]
  ...
  br i1 %101, label %block_4098df, label %block_.L_409933
...
block_.L_4098ed:                                  ; preds = %block_4098f9, %block_4098df
  %111 = phi i64 [ %234, %block_4098f9 ], [ %.pre6, %block_4098df ]
  ...
  br i1 %147, label %block_4098f9, label %block_.L_40991d
...
block_4098f9:                                     ; preds = %block_.L_4098ed
  ...
  %call2_409904 = tail call %struct.Memory* @sub_412be0._ZN22custom_equal_constantsIjE8do_shiftEj(%struct.State* nonnull %0, i64 %162, %struct.Memory* %call2_4098c3)
...
block_.L_40991d:                                  ; preds = %block_.L_4098ed
  ...
  %call2_409920 = tail call %struct.Memory* @sub_412bf0._Z17check_shifted_sumIj22custom_equal_constantsIjEEvT_(%struct.State* nonnull %0, i64 %240, %struct.Memory* %call2_4098c3)
...
block_.L_409933:                                  ; preds = %block_.L_4098cf
  ...
  %call2_409933 = tail call %struct.Memory* @sub_400eb0._Z5timerv(%struct.State* nonnull %0, i64 %277, %struct.Memory* %call2_4098c3)
  ...
  %call2_40993c = tail call %struct.Memory* @sub_400850._Z13record_resultdPKc(%struct.State* nonnull %0, i64 %288, %struct.Memory* %call2_409933)
