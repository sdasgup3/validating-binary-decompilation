...
block_.L_40987f:                                  ; preds = %block_.L_4098cd, %entry
  %68 = phi i64 [ %.pre, %entry ], [ %276, %block_.L_4098cd ]
...
block_.L_40989d:                                  ; preds = %block_4098a9, %block_40988f
  %111 = phi i64 [ %.pre1, %block_40988f ], [ %234, %block_4098a9 ]
...
block_.L_4098cd:                                  ; preds = %block_.L_40989d
  ...
  %call2_4098d0 = tail call %struct.Memory* @sub_412ba0._Z17check_shifted_sumIj22custom_equal_constantsIjEEvT_(%struct.State* %0, i64 %240, %struct.Memory* %MEMORY.1)
...
block_.L_4098e3:                                  ; preds = %block_.L_40987f
  ...
  %call2_4098e3 = tail call %struct.Memory* @sub_400e60._Z5timerv(%struct.State* %0, i64 %277, %struct.Memory* %MEMORY.0)
  ...
  %call2_4098ec = tail call %struct.Memory* @sub_400800._Z13record_resultdPKc(%struct.State* %0, i64 %288, %struct.Memory* %call2_4098e3)
