...
declare %struct.Memory* @sub_412cb0._ZN23custom_divide_constantsIjE8do_shiftEj(%struct.State* dereferenceable(3376), i64, %struct.Memory*) local_unnamed_addr

declare %struct.Memory* @sub_412cc0._Z17check_shifted_sumIj23custom_divide_constantsIjEEvT_(%struct.State* dereferenceable(3376), i64, %struct.Memory*) local_unnamed_addr
...
block_.L_40977f:                                  ; preds = %block_.L_4097cd, %entry
  %68 = phi i64 [ %.pre, %entry ], [ %276, %block_.L_4097cd ]
  %MEMORY.0 = phi %struct.Memory* [ %call2_409773, %entry ], [ %call2_4097d0, %block_.L_4097cd ]
...
block_.L_40979d:                                  ; preds = %block_4097a9, %block_40978f
  %111 = phi i64 [ %.pre6, %block_40978f ], [ %234, %block_4097a9 ]
  %MEMORY.1 = phi %struct.Memory* [ %MEMORY.0, %block_40978f ], [ %call2_4097b4, %block_4097a9 ]
...
block_4097a9:                                     ; preds = %block_.L_40979d
  ...
  %call2_4097b4 = tail call %struct.Memory* @sub_412cb0._ZN23custom_divide_constantsIjE8do_shiftEj(%struct.State* nonnull %0, i64 %162, %struct.Memory* %MEMORY.1)
...
block_.L_4097cd:                                  ; preds = %block_.L_40979d
  ...
  %call2_4097d0 = tail call %struct.Memory* @sub_412cc0._Z17check_shifted_sumIj23custom_divide_constantsIjEEvT_(%struct.State* nonnull %0, i64 %240, %struct.Memory* %MEMORY.1)
...
block_.L_4097e3:                                  ; preds = %block_.L_40977f
  ...
  %call2_4097e3 = tail call %struct.Memory* @sub_400ea0._Z5timerv(%struct.State* nonnull %0, i64 %277, %struct.Memory* %MEMORY.0)
