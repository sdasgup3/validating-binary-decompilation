...
block_.L_40973f:                                  ; preds = %block_.L_40978d, %entry
  %68 = phi i64 [ %.pre, %entry ], [ %276, %block_.L_40978d ]
...
block_.L_40975d:                                  ; preds = %block_409769, %block_40974f
  %111 = phi i64 [ %.pre1, %block_40974f ], [ %234, %block_409769 ]
...
block_.L_40978d:                                  ; preds = %block_.L_40975d
  ...
  %call2_409790 = tail call %struct.Memory* @sub_412c80._Z17check_shifted_sumIj23custom_divide_constantsIjEEvT_(%struct.State* %0, i64 %240, %struct.Memory* %MEMORY.1)
...
block_.L_4097a3:                                  ; preds = %block_.L_40973f
  ...
  %call2_4097a3 = tail call %struct.Memory* @sub_400e60._Z5timerv(%struct.State* %0, i64 %277, %struct.Memory* %MEMORY.0)
  ...
  %call2_4097ac = tail call %struct.Memory* @sub_400800._Z13record_resultdPKc(%struct.State* %0, i64 %288, %struct.Memory* %call2_4097a3)
