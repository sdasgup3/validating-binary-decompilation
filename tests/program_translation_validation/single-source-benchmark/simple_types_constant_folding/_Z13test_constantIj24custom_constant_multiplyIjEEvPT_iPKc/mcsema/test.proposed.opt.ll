...
block_.L_40a09f:                                  ; preds = %block_.L_40a0ed, %entry
  %68 = phi i64 [ %.pre, %entry ], [ %278, %block_.L_40a0ed ]
...
block_.L_40a0bd:                                  ; preds = %block_40a0c9, %block_40a0af
  %111 = phi i64 [ %.pre1, %block_40a0af ], [ %235, %block_40a0c9 ]
...
block_.L_40a0ed:                                  ; preds = %block_.L_40a0bd
  ...
  %call2_40a0f0 = tail call %struct.Memory* @sub_4125b0._Z17check_shifted_sumIj24custom_constant_multiplyIjEEvT_(%struct.State* %0, i64 %241, %struct.Memory* %MEMORY.1)
...
block_.L_40a103:                                  ; preds = %block_.L_40a09f
  ...
  %call2_40a103 = tail call %struct.Memory* @sub_400e60._Z5timerv(%struct.State* %0, i64 %279, %struct.Memory* %MEMORY.0)
  ...
  %call2_40a10c = tail call %struct.Memory* @sub_400800._Z13record_resultdPKc(%struct.State* %0, i64 %290, %struct.Memory* %call2_40a103)
