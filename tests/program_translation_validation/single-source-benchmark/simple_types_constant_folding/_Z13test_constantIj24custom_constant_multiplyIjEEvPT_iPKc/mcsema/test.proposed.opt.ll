...
declare %struct.Memory* @sub_4125f0._Z17check_shifted_sumIj24custom_constant_multiplyIjEEvT_(%struct.State* noalias dereferenceable(3376), i64, %struct.Memory* noalias readnone returned) local_unnamed_addr
...
define %struct.Memory* @_Z13test_constantIj24custom_constant_multiplyIjEEvPT_iPKc(%struct.State* noalias, i64, %struct.Memory* noalias readnone) local_unnamed_addr #1 {
entry:
...
block_.L_40a0df:                                  ; preds = %block_.L_40a12d, %entry
  %68 = phi i64 [ %276, %block_.L_40a12d ], [ %.pre, %entry ]
...
block_.L_40a0fd:                                  ; preds = %block_40a109, %block_40a0ef
  %111 = phi i64 [ %234, %block_40a109 ], [ %.pre6, %block_40a0ef ]
...
block_40a109:                                     ; preds = %block_.L_40a0fd
  ...
  %call2_40a114 = tail call %struct.Memory* @sub_4125e0._ZN24custom_constant_multiplyIjE8do_shiftEj(%struct.State* nonnull %0, i64 %162, %struct.Memory* %call2_40a0d3)
...
block_.L_40a12d:                                  ; preds = %block_.L_40a0fd
  ...
  %call2_40a130 = tail call %struct.Memory* @sub_4125f0._Z17check_shifted_sumIj24custom_constant_multiplyIjEEvT_(%struct.State* nonnull %0, i64 %240, %struct.Memory* %call2_40a0d3)
...
block_.L_40a143:                                  ; preds = %block_.L_40a0df
  ...
  %call2_40a143 = tail call %struct.Memory* @sub_400ea0._Z5timerv(%struct.State* nonnull %0, i64 %277, %struct.Memory* %call2_40a0d3)
