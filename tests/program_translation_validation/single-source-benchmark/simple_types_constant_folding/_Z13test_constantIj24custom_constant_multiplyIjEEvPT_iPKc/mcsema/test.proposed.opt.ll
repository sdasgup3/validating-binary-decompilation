...
declare %struct.Memory* @sub_412600._Z17check_shifted_sumIj24custom_constant_multiplyIjEEvT_(%struct.State* noalias dereferenceable(3376), i64, %struct.Memory* noalias readnone returned) local_unnamed_addr
...
entry:
  ...
  %call2_40a0e3 = tail call %struct.Memory* @sub_400e90._Z11start_timerv(%struct.State* %0, i64 %58, %struct.Memory* %2)
...
block_.L_40a0ef:                                  ; preds = %block_.L_40a13d, %entry
  %68 = phi i64 [ %276, %block_.L_40a13d ], [ %.pre, %entry ]
  ...
  br i1 %101, label %block_40a0ff, label %block_.L_40a153
...
block_.L_40a10d:                                  ; preds = %block_40a119, %block_40a0ff
  %111 = phi i64 [ %234, %block_40a119 ], [ %.pre6, %block_40a0ff ]
  ...
  br i1 %147, label %block_40a119, label %block_.L_40a13d
...
block_40a119:                                     ; preds = %block_.L_40a10d
  ...
  %call2_40a124 = tail call %struct.Memory* @sub_4125f0._ZN24custom_constant_multiplyIjE8do_shiftEj(%struct.State* nonnull %0, i64 %162, %struct.Memory* %call2_40a0e3)
...
block_.L_40a13d:                                  ; preds = %block_.L_40a10d
  ...
  %call2_40a140 = tail call %struct.Memory* @sub_412600._Z17check_shifted_sumIj24custom_constant_multiplyIjEEvT_(%struct.State* nonnull %0, i64 %240, %struct.Memory* %call2_40a0e3)
...
block_.L_40a153:                                  ; preds = %block_.L_40a0ef
  ...
  %call2_40a153 = tail call %struct.Memory* @sub_400eb0._Z5timerv(%struct.State* nonnull %0, i64 %277, %struct.Memory* %call2_40a0e3)
  ...
  %call2_40a15c = tail call %struct.Memory* @sub_400850._Z13record_resultdPKc(%struct.State* nonnull %0, i64 %288, %struct.Memory* %call2_40a153)
