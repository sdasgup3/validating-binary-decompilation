...
block_.L_409a5f:                                  ; preds = %block_.L_409aad, %entry
  %68 = phi i64 [ %.pre, %entry ], [ %278, %block_.L_409aad ]
...
block_.L_409a7d:                                  ; preds = %block_409a89, %block_409a6f
  %111 = phi i64 [ %.pre1, %block_409a6f ], [ %235, %block_409a89 ]
...
block_.L_409aad:                                  ; preds = %block_.L_409a7d
  ...
  %call2_409ab0 = tail call %struct.Memory* @sub_412a50._Z17check_shifted_sumIj25custom_lessthan_constantsIjEEvT_(%struct.State* %0, i64 %241, %struct.Memory* %MEMORY.1)
...
block_.L_409ac3:                                  ; preds = %block_.L_409a5f
  ...
  %call2_409ac3 = tail call %struct.Memory* @sub_400e60._Z5timerv(%struct.State* %0, i64 %279, %struct.Memory* %MEMORY.0)
  ...
  %call2_409acc = tail call %struct.Memory* @sub_400800._Z13record_resultdPKc(%struct.State* %0, i64 %290, %struct.Memory* %call2_409ac3)
