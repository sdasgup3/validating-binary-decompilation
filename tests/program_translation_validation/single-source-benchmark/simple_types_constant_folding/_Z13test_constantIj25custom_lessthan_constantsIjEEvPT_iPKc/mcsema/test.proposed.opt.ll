...
declare %struct.Memory* @sub_412a50._Z17check_shifted_sumIj25custom_lessthan_constantsIjEEvT_(%struct.State* noalias dereferenceable(3376), i64, %struct.Memory* noalias readnone returned) local_unnamed_addr
...
entry:
  ...
  %call2_409a53 = tail call %struct.Memory* @sub_400e40._Z11start_timerv(%struct.State* %0, i64 %58, %struct.Memory* %2)
...
block_.L_409a5f:                                  ; preds = %block_.L_409aad, %entry
  %68 = phi i64 [ %.pre, %entry ], [ %276, %block_.L_409aad ]
  %MEMORY.0 = phi %struct.Memory* [ %call2_409a53, %entry ], [ %call2_409ab0, %block_.L_409aad ]
  ...
  br i1 %101, label %block_409a6f, label %block_.L_409ac3
...
block_.L_409a7d:                                  ; preds = %block_409a89, %block_409a6f
  %111 = phi i64 [ %.pre1, %block_409a6f ], [ %234, %block_409a89 ]
  %MEMORY.1 = phi %struct.Memory* [ %MEMORY.0, %block_409a6f ], [ %call2_409a94, %block_409a89 ]
  ...
  br i1 %147, label %block_409a89, label %block_.L_409aad
...
block_409a89:                                     ; preds = %block_.L_409a7d
  ...
  %call2_409a94 = tail call %struct.Memory* @sub_412a40._ZN25custom_lessthan_constantsIjE8do_shiftEj(%struct.State* %0, i64 %162, %struct.Memory* %MEMORY.1)
...
block_.L_409aad:                                  ; preds = %block_.L_409a7d
  ...
  %call2_409ab0 = tail call %struct.Memory* @sub_412a50._Z17check_shifted_sumIj25custom_lessthan_constantsIjEEvT_(%struct.State* %0, i64 %240, %struct.Memory* %MEMORY.1)
...
block_.L_409ac3:                                  ; preds = %block_.L_409a5f
  ...
  %call2_409ac3 = tail call %struct.Memory* @sub_400e60._Z5timerv(%struct.State* %0, i64 %277, %struct.Memory* %MEMORY.0)
  ...
  %call2_409acc = tail call %struct.Memory* @sub_400800._Z13record_resultdPKc(%struct.State* %0, i64 %288, %struct.Memory* %call2_409ac3)
  ...
  ret %struct.Memory* %call2_409acc
}
...
define %struct.Memory* @routine_jge_.L_409ac3(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i8* %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
...
define %struct.Memory* @routine_jge_.L_409aad(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i8* %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 2, i32 9
...
define %struct.Memory* @routine_jmpq_.L_409a7d(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
...
define %struct.Memory* @routine_callq_._Z17check_shifted_sumIj25custom_lessthan_constantsIjEEvT_(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
...
define %struct.Memory* @routine_jmpq_.L_409a5f(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
