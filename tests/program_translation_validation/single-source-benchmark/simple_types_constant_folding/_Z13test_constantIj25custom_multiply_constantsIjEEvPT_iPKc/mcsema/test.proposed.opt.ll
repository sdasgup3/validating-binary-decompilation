...
declare %struct.Memory* @sub_412d30._Z17check_shifted_sumIj25custom_multiply_constantsIjEEvT_(%struct.State* noalias dereferenceable(3376), i64, %struct.Memory* noalias readnone returned) local_unnamed_addr
...
define %struct.Memory* @_Z13test_constantIj25custom_multiply_constantsIjEEvPT_iPKc(%struct.State* noalias, i64, %struct.Memory* noalias readnone) local_unnamed_addr #1 {
entry:
...
block_.L_4096df:                                  ; preds = %block_.L_40972d, %entry
  %68 = phi i64 [ %276, %block_.L_40972d ], [ %.pre, %entry ]
...
block_.L_4096fd:                                  ; preds = %block_409709, %block_4096ef
  %111 = phi i64 [ %234, %block_409709 ], [ %.pre6, %block_4096ef ]
...
block_409709:                                     ; preds = %block_.L_4096fd
  ...
  %call2_409714 = tail call %struct.Memory* @sub_412d20._ZN25custom_multiply_constantsIjE8do_shiftEj(%struct.State* nonnull %0, i64 %162, %struct.Memory* %call2_4096d3)
...
block_.L_40972d:                                  ; preds = %block_.L_4096fd
  ...
  %call2_409730 = tail call %struct.Memory* @sub_412d30._Z17check_shifted_sumIj25custom_multiply_constantsIjEEvT_(%struct.State* nonnull %0, i64 %240, %struct.Memory* %call2_4096d3)
...
block_.L_409743:                                  ; preds = %block_.L_4096df
  ...
  %call2_409743 = tail call %struct.Memory* @sub_400ea0._Z5timerv(%struct.State* nonnull %0, i64 %277, %struct.Memory* %call2_4096d3)
