...
declare %struct.Memory* @sub_412cf0._Z17check_shifted_sumIj25custom_multiply_constantsIjEEvT_(%struct.State* noalias dereferenceable(3376), i64, %struct.Memory* noalias readnone returned) local_unnamed_addr
...
define %struct.Memory* @_Z13test_constantIj25custom_multiply_constantsIjEEvPT_iPKc(%struct.State* noalias, i64, %struct.Memory* noalias) local_unnamed_addr #1 {
entry:
  ...
  %call2_409693 = tail call %struct.Memory* @sub_400e40._Z11start_timerv(%struct.State* %0, i64 %58, %struct.Memory* %2)
...
block_.L_40969f:                                  ; preds = %block_.L_4096ed, %entry
  %68 = phi i64 [ %.pre, %entry ], [ %276, %block_.L_4096ed ]
  %MEMORY.0 = phi %struct.Memory* [ %call2_409693, %entry ], [ %call2_4096f0, %block_.L_4096ed ]
  ...
  br i1 %101, label %block_4096af, label %block_.L_409703
...
block_.L_4096bd:                                  ; preds = %block_4096c9, %block_4096af
  %111 = phi i64 [ %.pre1, %block_4096af ], [ %234, %block_4096c9 ]
  %MEMORY.1 = phi %struct.Memory* [ %MEMORY.0, %block_4096af ], [ %call2_4096d4, %block_4096c9 ]
  ...
  br i1 %147, label %block_4096c9, label %block_.L_4096ed

block_4096c9:                                     ; preds = %block_.L_4096bd
  %149 = add i64 %112, -8
  %150 = add i64 %148, 4
  ...
  %call2_4096d4 = tail call %struct.Memory* @sub_412ce0._ZN25custom_multiply_constantsIjE8do_shiftEj(%struct.State* %0, i64 %162, %struct.Memory* %MEMORY.1)
...
block_.L_4096ed:                                  ; preds = %block_.L_4096bd
  %235 = add i64 %112, -32
  %236 = add i64 %148, 3
  ...
  %call2_4096f0 = tail call %struct.Memory* @sub_412cf0._Z17check_shifted_sumIj25custom_multiply_constantsIjEEvT_(%struct.State* %0, i64 %240, %struct.Memory* %MEMORY.1)
...
block_.L_409703:                                  ; preds = %block_.L_40969f
  %277 = add i64 %102, -34979
  %278 = add i64 %102, 5
  ...
  %call2_409703 = tail call %struct.Memory* @sub_400e60._Z5timerv(%struct.State* %0, i64 %277, %struct.Memory* %MEMORY.0)
  ...
  %call2_40970c = tail call %struct.Memory* @sub_400800._Z13record_resultdPKc(%struct.State* %0, i64 %288, %struct.Memory* %call2_409703)
  ...
  ret %struct.Memory* %call2_40970c
}
...
define %struct.Memory* @routine_jge_.L_409703(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i8* %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
...
define %struct.Memory* @routine_jmpq_.L_4096bd(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
...
define %struct.Memory* @routine_callq_._Z17check_shifted_sumIj25custom_multiply_constantsIjEEvT_(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
