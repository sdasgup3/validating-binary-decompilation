...
declare %struct.Memory* @sub_412d30._Z17check_shifted_sumIj25custom_multiply_constantsIjEEvT_(%struct.State* dereferenceable(3376), i64, %struct.Memory*) local_unnamed_addr
...
entry:
  ...
  %call2_4096d3 = tail call %struct.Memory* @sub_400e80._Z11start_timerv(%struct.State* %0, i64 %58, %struct.Memory* %2)
...
block_.L_4096df:                                  ; preds = %block_.L_40972d, %entry
  %68 = phi i64 [ %.pre, %entry ], [ %276, %block_.L_40972d ]
  %MEMORY.0 = phi %struct.Memory* [ %call2_4096d3, %entry ], [ %call2_409730, %block_.L_40972d ]
  ...
  br i1 %101, label %block_4096ef, label %block_.L_409743
...
block_.L_4096fd:                                  ; preds = %block_409709, %block_4096ef
  %111 = phi i64 [ %.pre6, %block_4096ef ], [ %234, %block_409709 ]
  %MEMORY.1 = phi %struct.Memory* [ %MEMORY.0, %block_4096ef ], [ %call2_409714, %block_409709 ]
  ...
  br i1 %147, label %block_409709, label %block_.L_40972d

block_409709:                                     ; preds = %block_.L_4096fd
  %149 = add i64 %112, -8
  %150 = add i64 %148, 4
  ...
  %call2_409714 = tail call %struct.Memory* @sub_412d20._ZN25custom_multiply_constantsIjE8do_shiftEj(%struct.State* nonnull %0, i64 %162, %struct.Memory* %MEMORY.1)
...
block_.L_40972d:                                  ; preds = %block_.L_4096fd
  %235 = add i64 %112, -32
  %236 = add i64 %148, 3
  ...
  %call2_409730 = tail call %struct.Memory* @sub_412d30._Z17check_shifted_sumIj25custom_multiply_constantsIjEEvT_(%struct.State* nonnull %0, i64 %240, %struct.Memory* %MEMORY.1)
...
block_.L_409743:                                  ; preds = %block_.L_4096df
  ...
  %call2_409743 = tail call %struct.Memory* @sub_400ea0._Z5timerv(%struct.State* nonnull %0, i64 %277, %struct.Memory* %MEMORY.0)
  ...
  %call2_40974c = tail call %struct.Memory* @sub_400840._Z13record_resultdPKc(%struct.State* nonnull %0, i64 %288, %struct.Memory* %call2_409743)
  ...
  ret %struct.Memory* %call2_40974c
}
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_jge_.L_409743(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i8* nocapture %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_jmpq_.L_4096fd(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
