...
declare %struct.Memory* @sub_412d40._Z17check_shifted_sumIj25custom_multiply_constantsIjEEvT_(%struct.State* noalias dereferenceable(3376), i64, %struct.Memory* noalias readnone returned) local_unnamed_addr
...
entry:
  ...
  %call2_4096e3 = tail call %struct.Memory* @sub_400e90._Z11start_timerv(%struct.State* %0, i64 %58, %struct.Memory* %2)
...
block_.L_4096ef:                                  ; preds = %block_.L_40973d, %entry
  %68 = phi i64 [ %276, %block_.L_40973d ], [ %.pre, %entry ]
  ...
  br i1 %101, label %block_4096ff, label %block_.L_409753
...
block_.L_40970d:                                  ; preds = %block_409719, %block_4096ff
  %111 = phi i64 [ %234, %block_409719 ], [ %.pre6, %block_4096ff ]
  ...
  br i1 %147, label %block_409719, label %block_.L_40973d
...
block_409719:                                     ; preds = %block_.L_40970d
  ...
  %call2_409724 = tail call %struct.Memory* @sub_412d30._ZN25custom_multiply_constantsIjE8do_shiftEj(%struct.State* nonnull %0, i64 %162, %struct.Memory* %call2_4096e3)
...
block_.L_40973d:                                  ; preds = %block_.L_40970d
  ...
  %call2_409740 = tail call %struct.Memory* @sub_412d40._Z17check_shifted_sumIj25custom_multiply_constantsIjEEvT_(%struct.State* nonnull %0, i64 %240, %struct.Memory* %call2_4096e3)
...
block_.L_409753:                                  ; preds = %block_.L_4096ef
  ...
  %call2_409753 = tail call %struct.Memory* @sub_400eb0._Z5timerv(%struct.State* nonnull %0, i64 %277, %struct.Memory* %call2_4096e3)
  ...
  %call2_40975c = tail call %struct.Memory* @sub_400850._Z13record_resultdPKc(%struct.State* nonnull %0, i64 %288, %struct.Memory* %call2_409753)
