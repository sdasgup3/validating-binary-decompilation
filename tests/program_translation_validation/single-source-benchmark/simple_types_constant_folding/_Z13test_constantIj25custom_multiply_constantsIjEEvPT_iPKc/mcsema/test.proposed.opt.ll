...
block_.L_40969f:                                  ; preds = %block_.L_4096ed, %entry
  %68 = phi i64 [ %.pre, %entry ], [ %278, %block_.L_4096ed ]
...
block_.L_4096bd:                                  ; preds = %block_4096c9, %block_4096af
  %111 = phi i64 [ %.pre1, %block_4096af ], [ %235, %block_4096c9 ]
...
block_.L_4096ed:                                  ; preds = %block_.L_4096bd
  ...
  %call2_4096f0 = tail call %struct.Memory* @sub_412cf0._Z17check_shifted_sumIj25custom_multiply_constantsIjEEvT_(%struct.State* %0, i64 %241, %struct.Memory* %MEMORY.1)
...
block_.L_409703:                                  ; preds = %block_.L_40969f
  ...
  %call2_409703 = tail call %struct.Memory* @sub_400e60._Z5timerv(%struct.State* %0, i64 %279, %struct.Memory* %MEMORY.0)
  ...
  %call2_40970c = tail call %struct.Memory* @sub_400800._Z13record_resultdPKc(%struct.State* %0, i64 %290, %struct.Memory* %call2_409703)
