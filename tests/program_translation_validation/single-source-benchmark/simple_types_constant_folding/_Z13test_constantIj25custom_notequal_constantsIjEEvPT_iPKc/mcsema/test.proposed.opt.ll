...
declare %struct.Memory* @sub_412b60._ZN25custom_notequal_constantsIjE8do_shiftEj(%struct.State* dereferenceable(3376), i64, %struct.Memory*) local_unnamed_addr

declare %struct.Memory* @sub_412b70._Z17check_shifted_sumIj25custom_notequal_constantsIjEEvT_(%struct.State* dereferenceable(3376), i64, %struct.Memory*) local_unnamed_addr
...
block_.L_40995f:                                  ; preds = %block_.L_4099ad, %entry
  %68 = phi i64 [ %.pre, %entry ], [ %276, %block_.L_4099ad ]
  %MEMORY.0 = phi %struct.Memory* [ %call2_409953, %entry ], [ %call2_4099b0, %block_.L_4099ad ]
...
block_.L_40997d:                                  ; preds = %block_409989, %block_40996f
  %111 = phi i64 [ %.pre6, %block_40996f ], [ %234, %block_409989 ]
  %MEMORY.1 = phi %struct.Memory* [ %MEMORY.0, %block_40996f ], [ %call2_409994, %block_409989 ]
...
block_409989:                                     ; preds = %block_.L_40997d
  ...
  %call2_409994 = tail call %struct.Memory* @sub_412b60._ZN25custom_notequal_constantsIjE8do_shiftEj(%struct.State* nonnull %0, i64 %162, %struct.Memory* %MEMORY.1)
...
block_.L_4099ad:                                  ; preds = %block_.L_40997d
  ...
  %call2_4099b0 = tail call %struct.Memory* @sub_412b70._Z17check_shifted_sumIj25custom_notequal_constantsIjEEvT_(%struct.State* nonnull %0, i64 %240, %struct.Memory* %MEMORY.1)
...
block_.L_4099c3:                                  ; preds = %block_.L_40995f
  ...
  %call2_4099c3 = tail call %struct.Memory* @sub_400ea0._Z5timerv(%struct.State* nonnull %0, i64 %277, %struct.Memory* %MEMORY.0)
