...
block_.L_40991f:                                  ; preds = %block_.L_40996d, %entry
  %68 = phi i64 [ %.pre, %entry ], [ %276, %block_.L_40996d ]
...
block_.L_40993d:                                  ; preds = %block_409949, %block_40992f
  %111 = phi i64 [ %.pre1, %block_40992f ], [ %234, %block_409949 ]
...
block_.L_40996d:                                  ; preds = %block_.L_40993d
  ...
  %call2_409970 = tail call %struct.Memory* @sub_412b30._Z17check_shifted_sumIj25custom_notequal_constantsIjEEvT_(%struct.State* %0, i64 %240, %struct.Memory* %MEMORY.1)
...
block_.L_409983:                                  ; preds = %block_.L_40991f
  ...
  %call2_409983 = tail call %struct.Memory* @sub_400e60._Z5timerv(%struct.State* %0, i64 %277, %struct.Memory* %MEMORY.0)
  ...
  %call2_40998c = tail call %struct.Memory* @sub_400800._Z13record_resultdPKc(%struct.State* %0, i64 %288, %struct.Memory* %call2_409983)
