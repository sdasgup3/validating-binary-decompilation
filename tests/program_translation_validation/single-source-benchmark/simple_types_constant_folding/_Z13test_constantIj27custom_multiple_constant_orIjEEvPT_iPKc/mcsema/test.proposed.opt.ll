...
declare %struct.Memory* @sub_412100._Z17check_shifted_sumIj27custom_multiple_constant_orIjEEvT_(%struct.State* noalias dereferenceable(3376), i64, %struct.Memory* noalias readnone returned) local_unnamed_addr
...
entry:
  ...
  %call2_40a723 = tail call %struct.Memory* @sub_400e90._Z11start_timerv(%struct.State* %0, i64 %58, %struct.Memory* %2)
...
block_.L_40a72f:                                  ; preds = %block_.L_40a77d, %entry
  %68 = phi i64 [ %276, %block_.L_40a77d ], [ %.pre, %entry ]
  ...
  br i1 %101, label %block_40a73f, label %block_.L_40a793
...
block_.L_40a74d:                                  ; preds = %block_40a759, %block_40a73f
  %111 = phi i64 [ %234, %block_40a759 ], [ %.pre6, %block_40a73f ]
  ...
  br i1 %147, label %block_40a759, label %block_.L_40a77d

block_40a759:                                     ; preds = %block_.L_40a74d
  %149 = add i64 %112, -8
  %150 = add i64 %148, 4
  ...
  %call2_40a764 = tail call %struct.Memory* @sub_4120e0._ZN27custom_multiple_constant_orIjE8do_shiftEj(%struct.State* nonnull %0, i64 %162, %struct.Memory* %call2_40a723)
...
block_.L_40a77d:                                  ; preds = %block_.L_40a74d
  %235 = add i64 %112, -32
  %236 = add i64 %148, 3
  ...
  %call2_40a780 = tail call %struct.Memory* @sub_412100._Z17check_shifted_sumIj27custom_multiple_constant_orIjEEvT_(%struct.State* nonnull %0, i64 %240, %struct.Memory* %call2_40a723)
...
block_.L_40a793:                                  ; preds = %block_.L_40a72f
  ...
  %call2_40a793 = tail call %struct.Memory* @sub_400eb0._Z5timerv(%struct.State* nonnull %0, i64 %277, %struct.Memory* %call2_40a723)
  ...
  %call2_40a79c = tail call %struct.Memory* @sub_400850._Z13record_resultdPKc(%struct.State* nonnull %0, i64 %288, %struct.Memory* %call2_40a793)
  ...
  ret %struct.Memory* %call2_40a79c
}
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_jge_.L_40a793(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i8* nocapture %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_jmpq_.L_40a74d(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
