...
block_.L_40a6df:                                  ; preds = %block_.L_40a72d, %entry
  %68 = phi i64 [ %.pre, %entry ], [ %276, %block_.L_40a72d ]
...
block_.L_40a6fd:                                  ; preds = %block_40a709, %block_40a6ef
  %111 = phi i64 [ %.pre1, %block_40a6ef ], [ %234, %block_40a709 ]
...
block_.L_40a72d:                                  ; preds = %block_.L_40a6fd
  ...
  %call2_40a730 = tail call %struct.Memory* @sub_4120b0._Z17check_shifted_sumIj27custom_multiple_constant_orIjEEvT_(%struct.State* %0, i64 %240, %struct.Memory* %MEMORY.1)
...
block_.L_40a743:                                  ; preds = %block_.L_40a6df
  ...
  %call2_40a743 = tail call %struct.Memory* @sub_400e60._Z5timerv(%struct.State* %0, i64 %277, %struct.Memory* %MEMORY.0)
  ...
  %call2_40a74c = tail call %struct.Memory* @sub_400800._Z13record_resultdPKc(%struct.State* %0, i64 %288, %struct.Memory* %call2_40a743)
