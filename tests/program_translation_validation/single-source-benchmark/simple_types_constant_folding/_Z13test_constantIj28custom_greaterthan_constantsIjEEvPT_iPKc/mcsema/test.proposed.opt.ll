...
block_.L_4099bf:                                  ; preds = %block_.L_409a0d, %entry
  %68 = phi i64 [ %.pre, %entry ], [ %276, %block_.L_409a0d ]
...
block_.L_4099dd:                                  ; preds = %block_4099e9, %block_4099cf
  %111 = phi i64 [ %.pre1, %block_4099cf ], [ %234, %block_4099e9 ]
...
block_.L_409a0d:                                  ; preds = %block_.L_4099dd
  ...
  %call2_409a10 = tail call %struct.Memory* @sub_412ac0._Z17check_shifted_sumIj28custom_greaterthan_constantsIjEEvT_(%struct.State* %0, i64 %240, %struct.Memory* %MEMORY.1)
...
block_.L_409a23:                                  ; preds = %block_.L_4099bf
  ...
  %call2_409a23 = tail call %struct.Memory* @sub_400e60._Z5timerv(%struct.State* %0, i64 %277, %struct.Memory* %MEMORY.0)
  ...
  %call2_409a2c = tail call %struct.Memory* @sub_400800._Z13record_resultdPKc(%struct.State* %0, i64 %288, %struct.Memory* %call2_409a23)
