...
declare %struct.Memory* @sub_412af0._ZN28custom_greaterthan_constantsIjE8do_shiftEj(%struct.State* dereferenceable(3376), i64, %struct.Memory*) local_unnamed_addr

declare %struct.Memory* @sub_412b00._Z17check_shifted_sumIj28custom_greaterthan_constantsIjEEvT_(%struct.State* dereferenceable(3376), i64, %struct.Memory*) local_unnamed_addr
...
block_.L_4099ff:                                  ; preds = %block_.L_409a4d, %entry
  %68 = phi i64 [ %.pre, %entry ], [ %276, %block_.L_409a4d ]
  %MEMORY.0 = phi %struct.Memory* [ %call2_4099f3, %entry ], [ %call2_409a50, %block_.L_409a4d ]
...
block_.L_409a1d:                                  ; preds = %block_409a29, %block_409a0f
  %111 = phi i64 [ %.pre6, %block_409a0f ], [ %234, %block_409a29 ]
  %MEMORY.1 = phi %struct.Memory* [ %MEMORY.0, %block_409a0f ], [ %call2_409a34, %block_409a29 ]
...
block_409a29:                                     ; preds = %block_.L_409a1d
  ...
  %call2_409a34 = tail call %struct.Memory* @sub_412af0._ZN28custom_greaterthan_constantsIjE8do_shiftEj(%struct.State* nonnull %0, i64 %162, %struct.Memory* %MEMORY.1)
...
block_.L_409a4d:                                  ; preds = %block_.L_409a1d
  ...
  %call2_409a50 = tail call %struct.Memory* @sub_412b00._Z17check_shifted_sumIj28custom_greaterthan_constantsIjEEvT_(%struct.State* nonnull %0, i64 %240, %struct.Memory* %MEMORY.1)
...
block_.L_409a63:                                  ; preds = %block_.L_4099ff
  ...
  %call2_409a63 = tail call %struct.Memory* @sub_400ea0._Z5timerv(%struct.State* nonnull %0, i64 %277, %struct.Memory* %MEMORY.0)
