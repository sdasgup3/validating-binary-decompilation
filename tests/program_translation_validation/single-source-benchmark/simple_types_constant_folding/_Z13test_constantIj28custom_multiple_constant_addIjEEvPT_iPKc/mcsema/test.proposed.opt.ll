...
declare %struct.Memory* @sub_412750._ZN28custom_multiple_constant_addIjE8do_shiftEj(%struct.State* noalias dereferenceable(3376), i64, %struct.Memory* noalias readnone returned) local_unnamed_addr

declare %struct.Memory* @sub_412770._Z17check_shifted_sumIj28custom_multiple_constant_addIjEEvT_(%struct.State* noalias dereferenceable(3376), i64, %struct.Memory* noalias readnone returned) local_unnamed_addr
...
define %struct.Memory* @_Z13test_constantIj28custom_multiple_constant_addIjEEvPT_iPKc(%struct.State* noalias, i64, %struct.Memory* noalias readnone) local_unnamed_addr #1 {
entry:
...
block_.L_409eff:                                  ; preds = %block_.L_409f4d, %entry
  %68 = phi i64 [ %276, %block_.L_409f4d ], [ %.pre, %entry ]
...
block_.L_409f1d:                                  ; preds = %block_409f29, %block_409f0f
  %111 = phi i64 [ %234, %block_409f29 ], [ %.pre6, %block_409f0f ]
...
block_409f29:                                     ; preds = %block_.L_409f1d
  ...
  %call2_409f34 = tail call %struct.Memory* @sub_412750._ZN28custom_multiple_constant_addIjE8do_shiftEj(%struct.State* nonnull %0, i64 %162, %struct.Memory* %call2_409ef3)
...
block_.L_409f4d:                                  ; preds = %block_.L_409f1d
  ...
  %call2_409f50 = tail call %struct.Memory* @sub_412770._Z17check_shifted_sumIj28custom_multiple_constant_addIjEEvT_(%struct.State* nonnull %0, i64 %240, %struct.Memory* %call2_409ef3)
...
block_.L_409f63:                                  ; preds = %block_.L_409eff
  ...
  %call2_409f63 = tail call %struct.Memory* @sub_400ea0._Z5timerv(%struct.State* nonnull %0, i64 %277, %struct.Memory* %call2_409ef3)
