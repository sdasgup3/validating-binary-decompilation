...
declare %struct.Memory* @sub_412710._ZN28custom_multiple_constant_addIjE8do_shiftEj(%struct.State* noalias dereferenceable(3376), i64, %struct.Memory* noalias readnone returned) local_unnamed_addr

declare %struct.Memory* @sub_412730._Z17check_shifted_sumIj28custom_multiple_constant_addIjEEvT_(%struct.State* noalias dereferenceable(3376), i64, %struct.Memory* noalias readnone returned) local_unnamed_addr
...
define %struct.Memory* @_Z13test_constantIj28custom_multiple_constant_addIjEEvPT_iPKc(%struct.State* noalias, i64, %struct.Memory* noalias) local_unnamed_addr #1 {
entry:
  ...
  %call2_409eb3 = tail call %struct.Memory* @sub_400e40._Z11start_timerv(%struct.State* %0, i64 %58, %struct.Memory* %2)
...
block_.L_409ebf:                                  ; preds = %block_.L_409f0d, %entry
  %68 = phi i64 [ %.pre, %entry ], [ %278, %block_.L_409f0d ]
  %MEMORY.0 = phi %struct.Memory* [ %call2_409eb3, %entry ], [ %call2_409f10, %block_.L_409f0d ]
  ...
  br i1 %101, label %block_409ecf, label %block_.L_409f23
...
block_.L_409edd:                                  ; preds = %block_409ee9, %block_409ecf
  %111 = phi i64 [ %.pre1, %block_409ecf ], [ %235, %block_409ee9 ]
  %MEMORY.1 = phi %struct.Memory* [ %MEMORY.0, %block_409ecf ], [ %call2_409ef4, %block_409ee9 ]
  ...
  br i1 %147, label %block_409ee9, label %block_.L_409f0d
...
block_409ee9:                                     ; preds = %block_.L_409edd
  ...
  %call2_409ef4 = tail call %struct.Memory* @sub_412710._ZN28custom_multiple_constant_addIjE8do_shiftEj(%struct.State* %0, i64 %162, %struct.Memory* %MEMORY.1)
...
block_.L_409f0d:                                  ; preds = %block_.L_409edd
  ...
  %call2_409f10 = tail call %struct.Memory* @sub_412730._Z17check_shifted_sumIj28custom_multiple_constant_addIjEEvT_(%struct.State* %0, i64 %241, %struct.Memory* %MEMORY.1)
...
block_.L_409f23:                                  ; preds = %block_.L_409ebf
  ...
  %call2_409f23 = tail call %struct.Memory* @sub_400e60._Z5timerv(%struct.State* %0, i64 %279, %struct.Memory* %MEMORY.0)
  ...
  %call2_409f2c = tail call %struct.Memory* @sub_400800._Z13record_resultdPKc(%struct.State* %0, i64 %290, %struct.Memory* %call2_409f23)
  ...
  ret %struct.Memory* %call2_409f2c
}
...
define %struct.Memory* @routine_jge_.L_409f23(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i8* %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
...
define %struct.Memory* @routine_jge_.L_409f0d(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i8* %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 2, i32 9
...
define %struct.Memory* @routine_callq_._ZN28custom_multiple_constant_addIjE8do_shiftEj(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
...
define %struct.Memory* @routine_jmpq_.L_409edd(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
...
define %struct.Memory* @routine_callq_._Z17check_shifted_sumIj28custom_multiple_constant_addIjEEvT_(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
...
define %struct.Memory* @routine_jmpq_.L_409ebf(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
