...
block_.L_409ebf:                                  ; preds = %block_.L_409f0d, %entry
  %68 = phi i64 [ %.pre, %entry ], [ %276, %block_.L_409f0d ]
...
block_.L_409edd:                                  ; preds = %block_409ee9, %block_409ecf
  %111 = phi i64 [ %.pre1, %block_409ecf ], [ %234, %block_409ee9 ]
...
block_.L_409f0d:                                  ; preds = %block_.L_409edd
  ...
  %call2_409f10 = tail call %struct.Memory* @sub_412730._Z17check_shifted_sumIj28custom_multiple_constant_addIjEEvT_(%struct.State* %0, i64 %240, %struct.Memory* %MEMORY.1)
...
block_.L_409f23:                                  ; preds = %block_.L_409ebf
  ...
  %call2_409f23 = tail call %struct.Memory* @sub_400e60._Z5timerv(%struct.State* %0, i64 %277, %struct.Memory* %MEMORY.0)
  ...
  %call2_409f2c = tail call %struct.Memory* @sub_400800._Z13record_resultdPKc(%struct.State* %0, i64 %288, %struct.Memory* %call2_409f23)
