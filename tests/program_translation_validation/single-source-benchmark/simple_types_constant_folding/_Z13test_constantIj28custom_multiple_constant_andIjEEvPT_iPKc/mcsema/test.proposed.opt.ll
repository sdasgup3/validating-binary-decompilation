...
block_.L_40a59f:                                  ; preds = %block_.L_40a5ed, %entry
  %68 = phi i64 [ %.pre, %entry ], [ %276, %block_.L_40a5ed ]
...
block_.L_40a5bd:                                  ; preds = %block_40a5c9, %block_40a5af
  %111 = phi i64 [ %.pre1, %block_40a5af ], [ %234, %block_40a5c9 ]
...
block_.L_40a5ed:                                  ; preds = %block_.L_40a5bd
  ...
  %call2_40a5f0 = tail call %struct.Memory* @sub_4121b0._Z17check_shifted_sumIj28custom_multiple_constant_andIjEEvT_(%struct.State* %0, i64 %240, %struct.Memory* %MEMORY.1)
...
block_.L_40a603:                                  ; preds = %block_.L_40a59f
  ...
  %call2_40a603 = tail call %struct.Memory* @sub_400e60._Z5timerv(%struct.State* %0, i64 %277, %struct.Memory* %MEMORY.0)
  ...
  %call2_40a60c = tail call %struct.Memory* @sub_400800._Z13record_resultdPKc(%struct.State* %0, i64 %288, %struct.Memory* %call2_40a603)
