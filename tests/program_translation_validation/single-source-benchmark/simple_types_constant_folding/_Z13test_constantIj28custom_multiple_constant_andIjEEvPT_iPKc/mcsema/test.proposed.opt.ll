...
declare %struct.Memory* @sub_4121f0._Z17check_shifted_sumIj28custom_multiple_constant_andIjEEvT_(%struct.State* dereferenceable(3376), i64, %struct.Memory*) local_unnamed_addr
...
entry:
  ...
  %call2_40a5d3 = tail call %struct.Memory* @sub_400e80._Z11start_timerv(%struct.State* %0, i64 %58, %struct.Memory* %2)
...
block_.L_40a5df:                                  ; preds = %block_.L_40a62d, %entry
  %68 = phi i64 [ %.pre, %entry ], [ %276, %block_.L_40a62d ]
  %MEMORY.0 = phi %struct.Memory* [ %call2_40a5d3, %entry ], [ %call2_40a630, %block_.L_40a62d ]
  ...
  br i1 %101, label %block_40a5ef, label %block_.L_40a643

block_40a5ef:                                     ; preds = %block_.L_40a5df
  %103 = add i64 %69, -32
  %104 = add i64 %102, 7
...
block_.L_40a5fd:                                  ; preds = %block_40a609, %block_40a5ef
  %111 = phi i64 [ %.pre6, %block_40a5ef ], [ %234, %block_40a609 ]
  %MEMORY.1 = phi %struct.Memory* [ %MEMORY.0, %block_40a5ef ], [ %call2_40a614, %block_40a609 ]
  ...
  br i1 %147, label %block_40a609, label %block_.L_40a62d

block_40a609:                                     ; preds = %block_.L_40a5fd
  %149 = add i64 %112, -8
  %150 = add i64 %148, 4
  ...
  %call2_40a614 = tail call %struct.Memory* @sub_4121d0._ZN28custom_multiple_constant_andIjE8do_shiftEj(%struct.State* nonnull %0, i64 %162, %struct.Memory* %MEMORY.1)
...
block_.L_40a62d:                                  ; preds = %block_.L_40a5fd
  %235 = add i64 %112, -32
  %236 = add i64 %148, 3
  ...
  %call2_40a630 = tail call %struct.Memory* @sub_4121f0._Z17check_shifted_sumIj28custom_multiple_constant_andIjEEvT_(%struct.State* nonnull %0, i64 %240, %struct.Memory* %MEMORY.1)
...
block_.L_40a643:                                  ; preds = %block_.L_40a5df
  ...
  %call2_40a643 = tail call %struct.Memory* @sub_400ea0._Z5timerv(%struct.State* nonnull %0, i64 %277, %struct.Memory* %MEMORY.0)
  ...
  %call2_40a64c = tail call %struct.Memory* @sub_400840._Z13record_resultdPKc(%struct.State* nonnull %0, i64 %288, %struct.Memory* %call2_40a643)
  ...
  ret %struct.Memory* %call2_40a64c
}
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_jge_.L_40a643(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i8* nocapture %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_jge_.L_40a62d(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i8* nocapture %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 2, i32 9
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_jmpq_.L_40a5fd(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
