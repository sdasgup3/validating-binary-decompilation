...
declare %struct.Memory* @sub_4121f0._Z17check_shifted_sumIj28custom_multiple_constant_andIjEEvT_(%struct.State* noalias dereferenceable(3376), i64, %struct.Memory* noalias readnone returned) local_unnamed_addr
...
block_.L_40a5df:                                  ; preds = %block_.L_40a62d, %entry
  %68 = phi i64 [ %276, %block_.L_40a62d ], [ %.pre, %entry ]
...
block_.L_40a5fd:                                  ; preds = %block_40a609, %block_40a5ef
  %111 = phi i64 [ %234, %block_40a609 ], [ %.pre6, %block_40a5ef ]
...
block_40a609:                                     ; preds = %block_.L_40a5fd
  ...
  %call2_40a614 = tail call %struct.Memory* @sub_4121d0._ZN28custom_multiple_constant_andIjE8do_shiftEj(%struct.State* nonnull %0, i64 %162, %struct.Memory* %call2_40a5d3)
...
block_.L_40a62d:                                  ; preds = %block_.L_40a5fd
  ...
  %call2_40a630 = tail call %struct.Memory* @sub_4121f0._Z17check_shifted_sumIj28custom_multiple_constant_andIjEEvT_(%struct.State* nonnull %0, i64 %240, %struct.Memory* %call2_40a5d3)
...
block_.L_40a643:                                  ; preds = %block_.L_40a5df
  ...
  %call2_40a643 = tail call %struct.Memory* @sub_400ea0._Z5timerv(%struct.State* nonnull %0, i64 %277, %struct.Memory* %call2_40a5d3)
