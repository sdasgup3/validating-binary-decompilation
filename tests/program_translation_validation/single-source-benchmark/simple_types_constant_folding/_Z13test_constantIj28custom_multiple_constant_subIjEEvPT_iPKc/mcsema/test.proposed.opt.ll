...
block_.L_409fff:                                  ; preds = %block_.L_40a04d, %entry
  %68 = phi i64 [ %.pre, %entry ], [ %276, %block_.L_40a04d ]
...
block_.L_40a01d:                                  ; preds = %block_40a029, %block_40a00f
  %111 = phi i64 [ %.pre1, %block_40a00f ], [ %234, %block_40a029 ]
...
block_.L_40a04d:                                  ; preds = %block_.L_40a01d
  ...
  %call2_40a050 = tail call %struct.Memory* @sub_412630._Z17check_shifted_sumIj28custom_multiple_constant_subIjEEvT_(%struct.State* %0, i64 %240, %struct.Memory* %MEMORY.1)
...
block_.L_40a063:                                  ; preds = %block_.L_409fff
  ...
  %call2_40a063 = tail call %struct.Memory* @sub_400e60._Z5timerv(%struct.State* %0, i64 %277, %struct.Memory* %MEMORY.0)
  ...
  %call2_40a06c = tail call %struct.Memory* @sub_400800._Z13record_resultdPKc(%struct.State* %0, i64 %288, %struct.Memory* %call2_40a063)
