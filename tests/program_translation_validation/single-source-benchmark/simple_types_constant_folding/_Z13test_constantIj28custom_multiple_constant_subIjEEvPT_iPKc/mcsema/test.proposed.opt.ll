...
declare %struct.Memory* @sub_412650._ZN28custom_multiple_constant_subIjE8do_shiftEj(%struct.State* noalias dereferenceable(3376), i64, %struct.Memory* noalias readnone returned) local_unnamed_addr

declare %struct.Memory* @sub_412670._Z17check_shifted_sumIj28custom_multiple_constant_subIjEEvT_(%struct.State* noalias dereferenceable(3376), i64, %struct.Memory* noalias readnone returned) local_unnamed_addr
...
define %struct.Memory* @_Z13test_constantIj28custom_multiple_constant_subIjEEvPT_iPKc(%struct.State* noalias, i64, %struct.Memory* noalias readnone) local_unnamed_addr #1 {
entry:
...
block_.L_40a03f:                                  ; preds = %block_.L_40a08d, %entry
  %68 = phi i64 [ %276, %block_.L_40a08d ], [ %.pre, %entry ]
...
block_.L_40a05d:                                  ; preds = %block_40a069, %block_40a04f
  %111 = phi i64 [ %234, %block_40a069 ], [ %.pre6, %block_40a04f ]
...
block_40a069:                                     ; preds = %block_.L_40a05d
  ...
  %call2_40a074 = tail call %struct.Memory* @sub_412650._ZN28custom_multiple_constant_subIjE8do_shiftEj(%struct.State* nonnull %0, i64 %162, %struct.Memory* %call2_40a033)
...
block_.L_40a08d:                                  ; preds = %block_.L_40a05d
  ...
  %call2_40a090 = tail call %struct.Memory* @sub_412670._Z17check_shifted_sumIj28custom_multiple_constant_subIjEEvT_(%struct.State* nonnull %0, i64 %240, %struct.Memory* %call2_40a033)
...
block_.L_40a0a3:                                  ; preds = %block_.L_40a03f
  ...
  %call2_40a0a3 = tail call %struct.Memory* @sub_400ea0._Z5timerv(%struct.State* nonnull %0, i64 %277, %struct.Memory* %call2_40a033)
