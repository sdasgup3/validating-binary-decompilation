...
declare %struct.Memory* @sub_412680._Z17check_shifted_sumIj28custom_multiple_constant_subIjEEvT_(%struct.State* noalias dereferenceable(3376), i64, %struct.Memory* noalias readnone returned) local_unnamed_addr
...
entry:
  ...
  %call2_40a043 = tail call %struct.Memory* @sub_400e90._Z11start_timerv(%struct.State* %0, i64 %58, %struct.Memory* %2)
...
block_.L_40a04f:                                  ; preds = %block_.L_40a09d, %entry
  %68 = phi i64 [ %276, %block_.L_40a09d ], [ %.pre, %entry ]
  ...
  br i1 %101, label %block_40a05f, label %block_.L_40a0b3
...
block_.L_40a06d:                                  ; preds = %block_40a079, %block_40a05f
  %111 = phi i64 [ %234, %block_40a079 ], [ %.pre6, %block_40a05f ]
  ...
  br i1 %147, label %block_40a079, label %block_.L_40a09d
...
block_40a079:                                     ; preds = %block_.L_40a06d
  ...
  %call2_40a084 = tail call %struct.Memory* @sub_412660._ZN28custom_multiple_constant_subIjE8do_shiftEj(%struct.State* nonnull %0, i64 %162, %struct.Memory* %call2_40a043)
...
block_.L_40a09d:                                  ; preds = %block_.L_40a06d
  ...
  %call2_40a0a0 = tail call %struct.Memory* @sub_412680._Z17check_shifted_sumIj28custom_multiple_constant_subIjEEvT_(%struct.State* nonnull %0, i64 %240, %struct.Memory* %call2_40a043)
...
block_.L_40a0b3:                                  ; preds = %block_.L_40a04f
  ...
  %call2_40a0b3 = tail call %struct.Memory* @sub_400eb0._Z5timerv(%struct.State* nonnull %0, i64 %277, %struct.Memory* %call2_40a043)
  ...
  %call2_40a0bc = tail call %struct.Memory* @sub_400850._Z13record_resultdPKc(%struct.State* nonnull %0, i64 %288, %struct.Memory* %call2_40a0b3)
