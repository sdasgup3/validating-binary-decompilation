...
block_.L_40a81f:                                  ; preds = %block_.L_40a86d, %entry
  %68 = phi i64 [ %.pre, %entry ], [ %278, %block_.L_40a86d ]
...
block_.L_40a83d:                                  ; preds = %block_40a849, %block_40a82f
  %111 = phi i64 [ %.pre1, %block_40a82f ], [ %235, %block_40a849 ]
...
block_.L_40a86d:                                  ; preds = %block_.L_40a83d
  ...
  %call2_40a870 = tail call %struct.Memory* @sub_411f80._Z17check_shifted_sumIj28custom_multiple_constant_xorIjEEvT_(%struct.State* %0, i64 %241, %struct.Memory* %MEMORY.1)
...
block_.L_40a883:                                  ; preds = %block_.L_40a81f
  ...
  %call2_40a883 = tail call %struct.Memory* @sub_400e60._Z5timerv(%struct.State* %0, i64 %279, %struct.Memory* %MEMORY.0)
  ...
  %call2_40a88c = tail call %struct.Memory* @sub_400800._Z13record_resultdPKc(%struct.State* %0, i64 %290, %struct.Memory* %call2_40a883)
