...
declare %struct.Memory* @sub_411fc0._Z17check_shifted_sumIj28custom_multiple_constant_xorIjEEvT_(%struct.State* noalias dereferenceable(3376), i64, %struct.Memory* noalias readnone returned) local_unnamed_addr
...
define %struct.Memory* @_Z13test_constantIj28custom_multiple_constant_xorIjEEvPT_iPKc(%struct.State* noalias, i64, %struct.Memory* noalias readnone) local_unnamed_addr #1 {
entry:
...
block_.L_40a85f:                                  ; preds = %block_.L_40a8ad, %entry
  %68 = phi i64 [ %276, %block_.L_40a8ad ], [ %.pre, %entry ]
...
block_.L_40a87d:                                  ; preds = %block_40a889, %block_40a86f
  %111 = phi i64 [ %234, %block_40a889 ], [ %.pre6, %block_40a86f ]
...
block_40a889:                                     ; preds = %block_.L_40a87d
  ...
  %call2_40a894 = tail call %struct.Memory* @sub_411fa0._ZN28custom_multiple_constant_xorIjE8do_shiftEj(%struct.State* nonnull %0, i64 %162, %struct.Memory* %call2_40a853)
...
block_.L_40a8ad:                                  ; preds = %block_.L_40a87d
  ...
  %call2_40a8b0 = tail call %struct.Memory* @sub_411fc0._Z17check_shifted_sumIj28custom_multiple_constant_xorIjEEvT_(%struct.State* nonnull %0, i64 %240, %struct.Memory* %call2_40a853)
...
block_.L_40a8c3:                                  ; preds = %block_.L_40a85f
  ...
  %call2_40a8c3 = tail call %struct.Memory* @sub_400ea0._Z5timerv(%struct.State* nonnull %0, i64 %277, %struct.Memory* %call2_40a853)
