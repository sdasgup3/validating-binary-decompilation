...
declare %struct.Memory* @sub_411fc0._Z17check_shifted_sumIj28custom_multiple_constant_xorIjEEvT_(%struct.State* dereferenceable(3376), i64, %struct.Memory*) local_unnamed_addr
...
entry:
  ...
  %call2_40a853 = tail call %struct.Memory* @sub_400e80._Z11start_timerv(%struct.State* %0, i64 %58, %struct.Memory* %2)
...
block_.L_40a85f:                                  ; preds = %block_.L_40a8ad, %entry
  %68 = phi i64 [ %.pre, %entry ], [ %276, %block_.L_40a8ad ]
  %MEMORY.0 = phi %struct.Memory* [ %call2_40a853, %entry ], [ %call2_40a8b0, %block_.L_40a8ad ]
  ...
  br i1 %101, label %block_40a86f, label %block_.L_40a8c3
...
block_.L_40a87d:                                  ; preds = %block_40a889, %block_40a86f
  %111 = phi i64 [ %.pre6, %block_40a86f ], [ %234, %block_40a889 ]
  %MEMORY.1 = phi %struct.Memory* [ %MEMORY.0, %block_40a86f ], [ %call2_40a894, %block_40a889 ]
  ...
  br i1 %147, label %block_40a889, label %block_.L_40a8ad
...
block_40a889:                                     ; preds = %block_.L_40a87d
  ...
  %call2_40a894 = tail call %struct.Memory* @sub_411fa0._ZN28custom_multiple_constant_xorIjE8do_shiftEj(%struct.State* nonnull %0, i64 %162, %struct.Memory* %MEMORY.1)
...
block_.L_40a8ad:                                  ; preds = %block_.L_40a87d
  ...
  %call2_40a8b0 = tail call %struct.Memory* @sub_411fc0._Z17check_shifted_sumIj28custom_multiple_constant_xorIjEEvT_(%struct.State* nonnull %0, i64 %240, %struct.Memory* %MEMORY.1)
...
block_.L_40a8c3:                                  ; preds = %block_.L_40a85f
  ...
  %call2_40a8c3 = tail call %struct.Memory* @sub_400ea0._Z5timerv(%struct.State* nonnull %0, i64 %277, %struct.Memory* %MEMORY.0)
  ...
  %call2_40a8cc = tail call %struct.Memory* @sub_400840._Z13record_resultdPKc(%struct.State* nonnull %0, i64 %288, %struct.Memory* %call2_40a8c3)
  ...
  ret %struct.Memory* %call2_40a8cc
}
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_jge_.L_40a8c3(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i8* nocapture %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_jmpq_.L_40a87d(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
