...
declare %struct.Memory* @sub_411fd0._Z17check_shifted_sumIj28custom_multiple_constant_xorIjEEvT_(%struct.State* noalias dereferenceable(3376), i64, %struct.Memory* noalias readnone returned) local_unnamed_addr
...
entry:
  ...
  %call2_40a863 = tail call %struct.Memory* @sub_400e90._Z11start_timerv(%struct.State* %0, i64 %58, %struct.Memory* %2)
...
block_.L_40a86f:                                  ; preds = %block_.L_40a8bd, %entry
  %68 = phi i64 [ %276, %block_.L_40a8bd ], [ %.pre, %entry ]
  ...
  br i1 %101, label %block_40a87f, label %block_.L_40a8d3
...
block_.L_40a88d:                                  ; preds = %block_40a899, %block_40a87f
  %111 = phi i64 [ %234, %block_40a899 ], [ %.pre6, %block_40a87f ]
  ...
  br i1 %147, label %block_40a899, label %block_.L_40a8bd
...
block_40a899:                                     ; preds = %block_.L_40a88d
  ...
  %call2_40a8a4 = tail call %struct.Memory* @sub_411fb0._ZN28custom_multiple_constant_xorIjE8do_shiftEj(%struct.State* nonnull %0, i64 %162, %struct.Memory* %call2_40a863)
...
block_.L_40a8bd:                                  ; preds = %block_.L_40a88d
  ...
  %call2_40a8c0 = tail call %struct.Memory* @sub_411fd0._Z17check_shifted_sumIj28custom_multiple_constant_xorIjEEvT_(%struct.State* nonnull %0, i64 %240, %struct.Memory* %call2_40a863)
...
block_.L_40a8d3:                                  ; preds = %block_.L_40a86f
  ...
  %call2_40a8d3 = tail call %struct.Memory* @sub_400eb0._Z5timerv(%struct.State* nonnull %0, i64 %277, %struct.Memory* %call2_40a863)
  ...
  %call2_40a8dc = tail call %struct.Memory* @sub_400850._Z13record_resultdPKc(%struct.State* nonnull %0, i64 %288, %struct.Memory* %call2_40a8d3)
