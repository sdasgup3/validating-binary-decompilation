...
declare %struct.Memory* @sub_411f80._Z17check_shifted_sumIj28custom_multiple_constant_xorIjEEvT_(%struct.State* noalias dereferenceable(3376), i64, %struct.Memory* noalias readnone returned) local_unnamed_addr
...
define %struct.Memory* @_Z13test_constantIj28custom_multiple_constant_xorIjEEvPT_iPKc(%struct.State* noalias, i64, %struct.Memory* noalias) local_unnamed_addr #1 {
entry:
  ...
  %call2_40a813 = tail call %struct.Memory* @sub_400e40._Z11start_timerv(%struct.State* %0, i64 %58, %struct.Memory* %2)
...
block_.L_40a81f:                                  ; preds = %block_.L_40a86d, %entry
  %68 = phi i64 [ %.pre, %entry ], [ %276, %block_.L_40a86d ]
  %MEMORY.0 = phi %struct.Memory* [ %call2_40a813, %entry ], [ %call2_40a870, %block_.L_40a86d ]
  ...
  br i1 %101, label %block_40a82f, label %block_.L_40a883
...
block_.L_40a83d:                                  ; preds = %block_40a849, %block_40a82f
  %111 = phi i64 [ %.pre1, %block_40a82f ], [ %234, %block_40a849 ]
  %MEMORY.1 = phi %struct.Memory* [ %MEMORY.0, %block_40a82f ], [ %call2_40a854, %block_40a849 ]
  ...
  br i1 %147, label %block_40a849, label %block_.L_40a86d
...
block_40a849:                                     ; preds = %block_.L_40a83d
  ...
  %call2_40a854 = tail call %struct.Memory* @sub_411f60._ZN28custom_multiple_constant_xorIjE8do_shiftEj(%struct.State* %0, i64 %162, %struct.Memory* %MEMORY.1)
...
block_.L_40a86d:                                  ; preds = %block_.L_40a83d
  ...
  %call2_40a870 = tail call %struct.Memory* @sub_411f80._Z17check_shifted_sumIj28custom_multiple_constant_xorIjEEvT_(%struct.State* %0, i64 %240, %struct.Memory* %MEMORY.1)
...
block_.L_40a883:                                  ; preds = %block_.L_40a81f
  ...
  %call2_40a883 = tail call %struct.Memory* @sub_400e60._Z5timerv(%struct.State* %0, i64 %277, %struct.Memory* %MEMORY.0)
  ...
  %call2_40a88c = tail call %struct.Memory* @sub_400800._Z13record_resultdPKc(%struct.State* %0, i64 %288, %struct.Memory* %call2_40a883)
  ...
  ret %struct.Memory* %call2_40a88c
}
...
define %struct.Memory* @routine_jge_.L_40a883(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i8* %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
...
define %struct.Memory* @routine_jmpq_.L_40a83d(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
...
define %struct.Memory* @routine_callq_._Z17check_shifted_sumIj28custom_multiple_constant_xorIjEEvT_(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
