...
define %struct.Memory* @_Z13test_constantIj30custom_lessthanequal_constantsIjEEvPT_iPKc(%struct.State* noalias, i64, %struct.Memory* noalias) #1 {
entry:
  ...
  store i32 %93, i32* %97
  store %struct.Memory* %loadMem_409bcc, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem1_409bd3, %struct.Memory** %MEMORY
...
block_409bef:                                     ; preds = %block_.L_409bdf
  ...
  store i32 0, i32* %236
  store %struct.Memory* %loadMem_409bf6, %struct.Memory** %MEMORY
...
block_.L_409bfd:                                  ; preds = %block_409c09, %block_409bef
  ...
  store %struct.Memory* %loadMem_409c00, %struct.Memory** %MEMORY
...
block_409c09:                                     ; preds = %block_.L_409bfd
  ...
  store %struct.Memory* %loadMem_409c09, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem1_409c14, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_409c1c, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_409c25, %struct.Memory** %MEMORY
...
block_.L_409c2d:                                  ; preds = %block_.L_409bfd
  ...
  store %struct.Memory* %loadMem1_409c30, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_409c3e, %struct.Memory** %MEMORY
  br label %block_.L_409bdf
...
block_.L_409c43:                                  ; preds = %block_.L_409bdf
  ...
  store %struct.Memory* %loadMem1_409c43, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem1_409c4c, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_409c55, %struct.Memory** %MEMORY
  ...
  ret %struct.Memory* %loadMem_409c56
}
