...
block_.L_409b9f:                                  ; preds = %block_.L_409bed, %entry
  %68 = phi i64 [ %.pre, %entry ], [ %276, %block_.L_409bed ]
...
block_.L_409bbd:                                  ; preds = %block_409bc9, %block_409baf
  %111 = phi i64 [ %.pre1, %block_409baf ], [ %234, %block_409bc9 ]
...
block_.L_409bed:                                  ; preds = %block_.L_409bbd
  ...
  %call2_409bf0 = tail call %struct.Memory* @sub_412970._Z17check_shifted_sumIj30custom_lessthanequal_constantsIjEEvT_(%struct.State* %0, i64 %240, %struct.Memory* %MEMORY.1)
...
block_.L_409c03:                                  ; preds = %block_.L_409b9f
  ...
  %call2_409c03 = tail call %struct.Memory* @sub_400e60._Z5timerv(%struct.State* %0, i64 %277, %struct.Memory* %MEMORY.0)
  ...
  %call2_409c0c = tail call %struct.Memory* @sub_400800._Z13record_resultdPKc(%struct.State* %0, i64 %288, %struct.Memory* %call2_409c03)
