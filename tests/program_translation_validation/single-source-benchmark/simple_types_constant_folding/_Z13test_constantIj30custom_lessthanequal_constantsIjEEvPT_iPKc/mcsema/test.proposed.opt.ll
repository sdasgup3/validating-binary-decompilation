...
declare %struct.Memory* @sub_4129b0._Z17check_shifted_sumIj30custom_lessthanequal_constantsIjEEvT_(%struct.State* dereferenceable(3376), i64, %struct.Memory*) local_unnamed_addr
...
block_.L_409bdf:                                  ; preds = %block_.L_409c2d, %entry
  %68 = phi i64 [ %.pre, %entry ], [ %276, %block_.L_409c2d ]
  %MEMORY.0 = phi %struct.Memory* [ %call2_409bd3, %entry ], [ %call2_409c30, %block_.L_409c2d ]
...
block_.L_409bfd:                                  ; preds = %block_409c09, %block_409bef
  %111 = phi i64 [ %.pre6, %block_409bef ], [ %234, %block_409c09 ]
  %MEMORY.1 = phi %struct.Memory* [ %MEMORY.0, %block_409bef ], [ %call2_409c14, %block_409c09 ]
...
block_409c09:                                     ; preds = %block_.L_409bfd
  ...
  %call2_409c14 = tail call %struct.Memory* @sub_4129a0._ZN30custom_lessthanequal_constantsIjE8do_shiftEj(%struct.State* nonnull %0, i64 %162, %struct.Memory* %MEMORY.1)
...
block_.L_409c2d:                                  ; preds = %block_.L_409bfd
  ...
  %call2_409c30 = tail call %struct.Memory* @sub_4129b0._Z17check_shifted_sumIj30custom_lessthanequal_constantsIjEEvT_(%struct.State* nonnull %0, i64 %240, %struct.Memory* %MEMORY.1)
...
block_.L_409c43:                                  ; preds = %block_.L_409bdf
  ...
  %call2_409c43 = tail call %struct.Memory* @sub_400ea0._Z5timerv(%struct.State* nonnull %0, i64 %277, %struct.Memory* %MEMORY.0)
