...
declare %struct.Memory* @sub_4122d0._ZN30custom_multiple_constant_mixedIjE8do_shiftEj(%struct.State* dereferenceable(3376), i64, %struct.Memory*)

declare %struct.Memory* @sub_4122f0._Z17check_shifted_sumIj30custom_multiple_constant_mixedIjEEvT_(%struct.State* dereferenceable(3376), i64, %struct.Memory*)
...
define %struct.Memory* @_Z13test_constantIj30custom_multiple_constant_mixedIjEEvPT_iPKc(%struct.State* noalias, i64, %struct.Memory* noalias) #1 {
entry:
