...
block_.L_40a45f:                                  ; preds = %block_.L_40a4ad, %entry
  %68 = phi i64 [ %.pre, %entry ], [ %278, %block_.L_40a4ad ]
...
block_.L_40a47d:                                  ; preds = %block_40a489, %block_40a46f
  %111 = phi i64 [ %.pre1, %block_40a46f ], [ %235, %block_40a489 ]
...
block_.L_40a4ad:                                  ; preds = %block_.L_40a47d
  ...
  %call2_40a4b0 = tail call %struct.Memory* @sub_4122b0._Z17check_shifted_sumIj30custom_multiple_constant_mixedIjEEvT_(%struct.State* %0, i64 %241, %struct.Memory* %MEMORY.1)
...
block_.L_40a4c3:                                  ; preds = %block_.L_40a45f
  ...
  %call2_40a4c3 = tail call %struct.Memory* @sub_400e60._Z5timerv(%struct.State* %0, i64 %279, %struct.Memory* %MEMORY.0)
  ...
  %call2_40a4cc = tail call %struct.Memory* @sub_400800._Z13record_resultdPKc(%struct.State* %0, i64 %290, %struct.Memory* %call2_40a4c3)
