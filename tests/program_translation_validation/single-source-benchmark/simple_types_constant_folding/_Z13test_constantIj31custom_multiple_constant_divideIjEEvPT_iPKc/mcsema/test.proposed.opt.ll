...
block_.L_40a31f:                                  ; preds = %block_.L_40a36d, %entry
  %68 = phi i64 [ %.pre, %entry ], [ %276, %block_.L_40a36d ]
...
block_.L_40a33d:                                  ; preds = %block_40a349, %block_40a32f
  %111 = phi i64 [ %.pre1, %block_40a32f ], [ %234, %block_40a349 ]
...
block_.L_40a36d:                                  ; preds = %block_.L_40a33d
  ...
  %call2_40a370 = tail call %struct.Memory* @sub_4123c0._Z17check_shifted_sumIj31custom_multiple_constant_divideIjEEvT_(%struct.State* %0, i64 %240, %struct.Memory* %MEMORY.1)
...
block_.L_40a383:                                  ; preds = %block_.L_40a31f
  ...
  %call2_40a383 = tail call %struct.Memory* @sub_400e60._Z5timerv(%struct.State* %0, i64 %277, %struct.Memory* %MEMORY.0)
  ...
  %call2_40a38c = tail call %struct.Memory* @sub_400800._Z13record_resultdPKc(%struct.State* %0, i64 %288, %struct.Memory* %call2_40a383)
