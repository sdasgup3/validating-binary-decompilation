...
declare %struct.Memory* @sub_4123d0._ZN31custom_multiple_constant_divideIjE8do_shiftEj(%struct.State* dereferenceable(3376), i64, %struct.Memory*) local_unnamed_addr

declare %struct.Memory* @sub_412400._Z17check_shifted_sumIj31custom_multiple_constant_divideIjEEvT_(%struct.State* dereferenceable(3376), i64, %struct.Memory*) local_unnamed_addr
...
block_.L_40a35f:                                  ; preds = %block_.L_40a3ad, %entry
  %68 = phi i64 [ %.pre, %entry ], [ %276, %block_.L_40a3ad ]
  %MEMORY.0 = phi %struct.Memory* [ %call2_40a353, %entry ], [ %call2_40a3b0, %block_.L_40a3ad ]
...
block_.L_40a37d:                                  ; preds = %block_40a389, %block_40a36f
  %111 = phi i64 [ %.pre6, %block_40a36f ], [ %234, %block_40a389 ]
  %MEMORY.1 = phi %struct.Memory* [ %MEMORY.0, %block_40a36f ], [ %call2_40a394, %block_40a389 ]
...
block_40a389:                                     ; preds = %block_.L_40a37d
  ...
  %call2_40a394 = tail call %struct.Memory* @sub_4123d0._ZN31custom_multiple_constant_divideIjE8do_shiftEj(%struct.State* nonnull %0, i64 %162, %struct.Memory* %MEMORY.1)
...
block_.L_40a3ad:                                  ; preds = %block_.L_40a37d
  ...
  %call2_40a3b0 = tail call %struct.Memory* @sub_412400._Z17check_shifted_sumIj31custom_multiple_constant_divideIjEEvT_(%struct.State* nonnull %0, i64 %240, %struct.Memory* %MEMORY.1)
...
block_.L_40a3c3:                                  ; preds = %block_.L_40a35f
  ...
  %call2_40a3c3 = tail call %struct.Memory* @sub_400ea0._Z5timerv(%struct.State* nonnull %0, i64 %277, %struct.Memory* %MEMORY.0)
