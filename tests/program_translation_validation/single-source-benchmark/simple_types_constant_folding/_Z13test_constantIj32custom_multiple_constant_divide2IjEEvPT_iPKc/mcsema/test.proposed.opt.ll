...
declare %struct.Memory* @sub_412380._Z17check_shifted_sumIj32custom_multiple_constant_divide2IjEEvT_(%struct.State* noalias dereferenceable(3376), i64, %struct.Memory* noalias readnone returned) local_unnamed_addr
...
entry:
  ...
  %call2_40a403 = tail call %struct.Memory* @sub_400e90._Z11start_timerv(%struct.State* %0, i64 %58, %struct.Memory* %2)
...
block_.L_40a40f:                                  ; preds = %block_.L_40a45d, %entry
  %68 = phi i64 [ %276, %block_.L_40a45d ], [ %.pre, %entry ]
  ...
  br i1 %101, label %block_40a41f, label %block_.L_40a473

block_40a41f:                                     ; preds = %block_.L_40a40f
  %103 = add i64 %69, -32
  %104 = add i64 %102, 7
...
block_.L_40a42d:                                  ; preds = %block_40a439, %block_40a41f
  %111 = phi i64 [ %234, %block_40a439 ], [ %.pre6, %block_40a41f ]
  ...
  br i1 %147, label %block_40a439, label %block_.L_40a45d

block_40a439:                                     ; preds = %block_.L_40a42d
  %149 = add i64 %112, -8
  %150 = add i64 %148, 4
  ...
  %call2_40a444 = tail call %struct.Memory* @sub_412360._ZN32custom_multiple_constant_divide2IjE8do_shiftEj(%struct.State* nonnull %0, i64 %162, %struct.Memory* %call2_40a403)
...
block_.L_40a45d:                                  ; preds = %block_.L_40a42d
  %235 = add i64 %112, -32
  %236 = add i64 %148, 3
  ...
  %call2_40a460 = tail call %struct.Memory* @sub_412380._Z17check_shifted_sumIj32custom_multiple_constant_divide2IjEEvT_(%struct.State* nonnull %0, i64 %240, %struct.Memory* %call2_40a403)
...
block_.L_40a473:                                  ; preds = %block_.L_40a40f
  ...
  %call2_40a473 = tail call %struct.Memory* @sub_400eb0._Z5timerv(%struct.State* nonnull %0, i64 %277, %struct.Memory* %call2_40a403)
  ...
  %call2_40a47c = tail call %struct.Memory* @sub_400850._Z13record_resultdPKc(%struct.State* nonnull %0, i64 %288, %struct.Memory* %call2_40a473)
