...
block_.L_40a3bf:                                  ; preds = %block_.L_40a40d, %entry
  %68 = phi i64 [ %.pre, %entry ], [ %276, %block_.L_40a40d ]
...
block_.L_40a3dd:                                  ; preds = %block_40a3e9, %block_40a3cf
  %111 = phi i64 [ %.pre1, %block_40a3cf ], [ %234, %block_40a3e9 ]
...
block_.L_40a40d:                                  ; preds = %block_.L_40a3dd
  ...
  %call2_40a410 = tail call %struct.Memory* @sub_412330._Z17check_shifted_sumIj32custom_multiple_constant_divide2IjEEvT_(%struct.State* %0, i64 %240, %struct.Memory* %MEMORY.1)
...
block_.L_40a423:                                  ; preds = %block_.L_40a3bf
  ...
  %call2_40a423 = tail call %struct.Memory* @sub_400e60._Z5timerv(%struct.State* %0, i64 %277, %struct.Memory* %MEMORY.0)
  ...
  %call2_40a42c = tail call %struct.Memory* @sub_400800._Z13record_resultdPKc(%struct.State* %0, i64 %288, %struct.Memory* %call2_40a423)
