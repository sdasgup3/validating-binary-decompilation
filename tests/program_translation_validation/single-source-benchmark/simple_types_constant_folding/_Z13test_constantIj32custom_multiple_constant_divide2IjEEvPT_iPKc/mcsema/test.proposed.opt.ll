...
declare %struct.Memory* @sub_412370._Z17check_shifted_sumIj32custom_multiple_constant_divide2IjEEvT_(%struct.State* noalias dereferenceable(3376), i64, %struct.Memory* noalias readnone returned) local_unnamed_addr
...
define %struct.Memory* @_Z13test_constantIj32custom_multiple_constant_divide2IjEEvPT_iPKc(%struct.State* noalias, i64, %struct.Memory* noalias readnone) local_unnamed_addr #1 {
entry:
...
block_.L_40a3ff:                                  ; preds = %block_.L_40a44d, %entry
  %68 = phi i64 [ %276, %block_.L_40a44d ], [ %.pre, %entry ]
...
block_.L_40a41d:                                  ; preds = %block_40a429, %block_40a40f
  %111 = phi i64 [ %234, %block_40a429 ], [ %.pre6, %block_40a40f ]
...
block_40a429:                                     ; preds = %block_.L_40a41d
  ...
  %call2_40a434 = tail call %struct.Memory* @sub_412350._ZN32custom_multiple_constant_divide2IjE8do_shiftEj(%struct.State* nonnull %0, i64 %162, %struct.Memory* %call2_40a3f3)
...
block_.L_40a44d:                                  ; preds = %block_.L_40a41d
  ...
  %call2_40a450 = tail call %struct.Memory* @sub_412370._Z17check_shifted_sumIj32custom_multiple_constant_divide2IjEEvT_(%struct.State* nonnull %0, i64 %240, %struct.Memory* %call2_40a3f3)
...
block_.L_40a463:                                  ; preds = %block_.L_40a3ff
  ...
  %call2_40a463 = tail call %struct.Memory* @sub_400ea0._Z5timerv(%struct.State* nonnull %0, i64 %277, %struct.Memory* %call2_40a3f3)
