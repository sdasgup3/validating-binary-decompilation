...
declare %struct.Memory* @sub_412a30._Z17check_shifted_sumIj33custom_greaterthanequal_constantsIjEEvT_(%struct.State* noalias dereferenceable(3376), i64, %struct.Memory* noalias readnone returned) local_unnamed_addr
...
entry:
  ...
  %call2_409b43 = tail call %struct.Memory* @sub_400e90._Z11start_timerv(%struct.State* %0, i64 %58, %struct.Memory* %2)
...
block_.L_409b4f:                                  ; preds = %block_.L_409b9d, %entry
  %68 = phi i64 [ %276, %block_.L_409b9d ], [ %.pre, %entry ]
  ...
  br i1 %101, label %block_409b5f, label %block_.L_409bb3
...
block_.L_409b6d:                                  ; preds = %block_409b79, %block_409b5f
  %111 = phi i64 [ %234, %block_409b79 ], [ %.pre6, %block_409b5f ]
  ...
  br i1 %147, label %block_409b79, label %block_.L_409b9d
...
block_409b79:                                     ; preds = %block_.L_409b6d
  ...
  %call2_409b84 = tail call %struct.Memory* @sub_412a20._ZN33custom_greaterthanequal_constantsIjE8do_shiftEj(%struct.State* nonnull %0, i64 %162, %struct.Memory* %call2_409b43)
...
block_.L_409b9d:                                  ; preds = %block_.L_409b6d
  ...
  %call2_409ba0 = tail call %struct.Memory* @sub_412a30._Z17check_shifted_sumIj33custom_greaterthanequal_constantsIjEEvT_(%struct.State* nonnull %0, i64 %240, %struct.Memory* %call2_409b43)
...
block_.L_409bb3:                                  ; preds = %block_.L_409b4f
  ...
  %call2_409bb3 = tail call %struct.Memory* @sub_400eb0._Z5timerv(%struct.State* nonnull %0, i64 %277, %struct.Memory* %call2_409b43)
  ...
  %call2_409bbc = tail call %struct.Memory* @sub_400850._Z13record_resultdPKc(%struct.State* nonnull %0, i64 %288, %struct.Memory* %call2_409bb3)
