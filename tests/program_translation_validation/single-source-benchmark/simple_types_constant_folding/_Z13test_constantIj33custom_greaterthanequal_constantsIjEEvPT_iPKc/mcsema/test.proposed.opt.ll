...
declare %struct.Memory* @sub_412a20._Z17check_shifted_sumIj33custom_greaterthanequal_constantsIjEEvT_(%struct.State* dereferenceable(3376), i64, %struct.Memory*) local_unnamed_addr
...
entry:
  ...
  %call2_409b33 = tail call %struct.Memory* @sub_400e80._Z11start_timerv(%struct.State* %0, i64 %58, %struct.Memory* %2)
...
block_.L_409b3f:                                  ; preds = %block_.L_409b8d, %entry
  %68 = phi i64 [ %.pre, %entry ], [ %276, %block_.L_409b8d ]
  %MEMORY.0 = phi %struct.Memory* [ %call2_409b33, %entry ], [ %call2_409b90, %block_.L_409b8d ]
  ...
  br i1 %101, label %block_409b4f, label %block_.L_409ba3
...
block_.L_409b5d:                                  ; preds = %block_409b69, %block_409b4f
  %111 = phi i64 [ %.pre6, %block_409b4f ], [ %234, %block_409b69 ]
  %MEMORY.1 = phi %struct.Memory* [ %MEMORY.0, %block_409b4f ], [ %call2_409b74, %block_409b69 ]
  ...
  br i1 %147, label %block_409b69, label %block_.L_409b8d
...
block_409b69:                                     ; preds = %block_.L_409b5d
  ...
  %call2_409b74 = tail call %struct.Memory* @sub_412a10._ZN33custom_greaterthanequal_constantsIjE8do_shiftEj(%struct.State* nonnull %0, i64 %162, %struct.Memory* %MEMORY.1)
...
block_.L_409b8d:                                  ; preds = %block_.L_409b5d
  ...
  %call2_409b90 = tail call %struct.Memory* @sub_412a20._Z17check_shifted_sumIj33custom_greaterthanequal_constantsIjEEvT_(%struct.State* nonnull %0, i64 %240, %struct.Memory* %MEMORY.1)
...
block_.L_409ba3:                                  ; preds = %block_.L_409b3f
  ...
  %call2_409ba3 = tail call %struct.Memory* @sub_400ea0._Z5timerv(%struct.State* nonnull %0, i64 %277, %struct.Memory* %MEMORY.0)
  ...
  %call2_409bac = tail call %struct.Memory* @sub_400840._Z13record_resultdPKc(%struct.State* nonnull %0, i64 %288, %struct.Memory* %call2_409ba3)
  ...
  ret %struct.Memory* %call2_409bac
}
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_jge_.L_409ba3(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i8* nocapture %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_jmpq_.L_409b5d(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
