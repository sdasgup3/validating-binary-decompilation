...
declare %struct.Memory* @sub_412a20._Z17check_shifted_sumIj33custom_greaterthanequal_constantsIjEEvT_(%struct.State* noalias dereferenceable(3376), i64, %struct.Memory* noalias readnone returned) local_unnamed_addr
...
define %struct.Memory* @_Z13test_constantIj33custom_greaterthanequal_constantsIjEEvPT_iPKc(%struct.State* noalias, i64, %struct.Memory* noalias readnone) local_unnamed_addr #1 {
entry:
...
block_.L_409b3f:                                  ; preds = %block_.L_409b8d, %entry
  %68 = phi i64 [ %276, %block_.L_409b8d ], [ %.pre, %entry ]
...
block_.L_409b5d:                                  ; preds = %block_409b69, %block_409b4f
  %111 = phi i64 [ %234, %block_409b69 ], [ %.pre6, %block_409b4f ]
...
block_409b69:                                     ; preds = %block_.L_409b5d
  ...
  %call2_409b74 = tail call %struct.Memory* @sub_412a10._ZN33custom_greaterthanequal_constantsIjE8do_shiftEj(%struct.State* nonnull %0, i64 %162, %struct.Memory* %call2_409b33)
...
block_.L_409b8d:                                  ; preds = %block_.L_409b5d
  ...
  %call2_409b90 = tail call %struct.Memory* @sub_412a20._Z17check_shifted_sumIj33custom_greaterthanequal_constantsIjEEvT_(%struct.State* nonnull %0, i64 %240, %struct.Memory* %call2_409b33)
...
block_.L_409ba3:                                  ; preds = %block_.L_409b3f
  ...
  %call2_409ba3 = tail call %struct.Memory* @sub_400ea0._Z5timerv(%struct.State* nonnull %0, i64 %277, %struct.Memory* %call2_409b33)
