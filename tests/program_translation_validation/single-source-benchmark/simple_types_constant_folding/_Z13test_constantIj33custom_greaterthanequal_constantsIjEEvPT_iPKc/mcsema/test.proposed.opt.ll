...
declare %struct.Memory* @sub_4129e0._Z17check_shifted_sumIj33custom_greaterthanequal_constantsIjEEvT_(%struct.State* noalias dereferenceable(3376), i64, %struct.Memory* noalias readnone returned) local_unnamed_addr
...
define %struct.Memory* @_Z13test_constantIj33custom_greaterthanequal_constantsIjEEvPT_iPKc(%struct.State* noalias, i64, %struct.Memory* noalias) local_unnamed_addr #1 {
entry:
  ...
  %call2_409af3 = tail call %struct.Memory* @sub_400e40._Z11start_timerv(%struct.State* %0, i64 %58, %struct.Memory* %2)
...
block_.L_409aff:                                  ; preds = %block_.L_409b4d, %entry
  %68 = phi i64 [ %.pre, %entry ], [ %278, %block_.L_409b4d ]
  %MEMORY.0 = phi %struct.Memory* [ %call2_409af3, %entry ], [ %call2_409b50, %block_.L_409b4d ]
  ...
  br i1 %101, label %block_409b0f, label %block_.L_409b63
...
block_.L_409b1d:                                  ; preds = %block_409b29, %block_409b0f
  %111 = phi i64 [ %.pre1, %block_409b0f ], [ %235, %block_409b29 ]
  %MEMORY.1 = phi %struct.Memory* [ %MEMORY.0, %block_409b0f ], [ %call2_409b34, %block_409b29 ]
  ...
  br i1 %147, label %block_409b29, label %block_.L_409b4d
...
block_409b29:                                     ; preds = %block_.L_409b1d
  ...
  %call2_409b34 = tail call %struct.Memory* @sub_4129d0._ZN33custom_greaterthanequal_constantsIjE8do_shiftEj(%struct.State* %0, i64 %162, %struct.Memory* %MEMORY.1)
...
block_.L_409b4d:                                  ; preds = %block_.L_409b1d
  ...
  %call2_409b50 = tail call %struct.Memory* @sub_4129e0._Z17check_shifted_sumIj33custom_greaterthanequal_constantsIjEEvT_(%struct.State* %0, i64 %241, %struct.Memory* %MEMORY.1)
...
block_.L_409b63:                                  ; preds = %block_.L_409aff
  ...
  %call2_409b63 = tail call %struct.Memory* @sub_400e60._Z5timerv(%struct.State* %0, i64 %279, %struct.Memory* %MEMORY.0)
  ...
  %call2_409b6c = tail call %struct.Memory* @sub_400800._Z13record_resultdPKc(%struct.State* %0, i64 %290, %struct.Memory* %call2_409b63)
  ...
  ret %struct.Memory* %call2_409b6c
}
...
define %struct.Memory* @routine_jge_.L_409b63(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i8* %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
...
define %struct.Memory* @routine_jge_.L_409b4d(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i8* %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 2, i32 9
...
define %struct.Memory* @routine_jmpq_.L_409b1d(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
...
define %struct.Memory* @routine_callq_._Z17check_shifted_sumIj33custom_greaterthanequal_constantsIjEEvT_(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
...
define %struct.Memory* @routine_jmpq_.L_409aff(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
