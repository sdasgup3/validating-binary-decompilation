...
block_.L_409aff:                                  ; preds = %block_.L_409b4d, %entry
  %68 = phi i64 [ %.pre, %entry ], [ %276, %block_.L_409b4d ]
...
block_.L_409b1d:                                  ; preds = %block_409b29, %block_409b0f
  %111 = phi i64 [ %.pre1, %block_409b0f ], [ %234, %block_409b29 ]
...
block_.L_409b4d:                                  ; preds = %block_.L_409b1d
  ...
  %call2_409b50 = tail call %struct.Memory* @sub_4129e0._Z17check_shifted_sumIj33custom_greaterthanequal_constantsIjEEvT_(%struct.State* %0, i64 %240, %struct.Memory* %MEMORY.1)
...
block_.L_409b63:                                  ; preds = %block_.L_409aff
  ...
  %call2_409b63 = tail call %struct.Memory* @sub_400e60._Z5timerv(%struct.State* %0, i64 %277, %struct.Memory* %MEMORY.0)
  ...
  %call2_409b6c = tail call %struct.Memory* @sub_400800._Z13record_resultdPKc(%struct.State* %0, i64 %288, %struct.Memory* %call2_409b63)
