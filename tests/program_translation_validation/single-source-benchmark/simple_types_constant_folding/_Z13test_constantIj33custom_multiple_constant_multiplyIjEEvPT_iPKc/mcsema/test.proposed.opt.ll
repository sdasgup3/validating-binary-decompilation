...
declare %struct.Memory* @sub_412560._ZN33custom_multiple_constant_multiplyIjE8do_shiftEj(%struct.State* dereferenceable(3376), i64, %struct.Memory*) local_unnamed_addr

declare %struct.Memory* @sub_412580._Z17check_shifted_sumIj33custom_multiple_constant_multiplyIjEEvT_(%struct.State* dereferenceable(3376), i64, %struct.Memory*) local_unnamed_addr
...
block_.L_40a17f:                                  ; preds = %block_.L_40a1cd, %entry
  %68 = phi i64 [ %.pre, %entry ], [ %276, %block_.L_40a1cd ]
  %MEMORY.0 = phi %struct.Memory* [ %call2_40a173, %entry ], [ %call2_40a1d0, %block_.L_40a1cd ]
...
block_.L_40a19d:                                  ; preds = %block_40a1a9, %block_40a18f
  %111 = phi i64 [ %.pre6, %block_40a18f ], [ %234, %block_40a1a9 ]
  %MEMORY.1 = phi %struct.Memory* [ %MEMORY.0, %block_40a18f ], [ %call2_40a1b4, %block_40a1a9 ]
...
block_40a1a9:                                     ; preds = %block_.L_40a19d
  ...
  %call2_40a1b4 = tail call %struct.Memory* @sub_412560._ZN33custom_multiple_constant_multiplyIjE8do_shiftEj(%struct.State* nonnull %0, i64 %162, %struct.Memory* %MEMORY.1)
...
block_.L_40a1cd:                                  ; preds = %block_.L_40a19d
  ...
  %call2_40a1d0 = tail call %struct.Memory* @sub_412580._Z17check_shifted_sumIj33custom_multiple_constant_multiplyIjEEvT_(%struct.State* nonnull %0, i64 %240, %struct.Memory* %MEMORY.1)
...
block_.L_40a1e3:                                  ; preds = %block_.L_40a17f
  ...
  %call2_40a1e3 = tail call %struct.Memory* @sub_400ea0._Z5timerv(%struct.State* nonnull %0, i64 %277, %struct.Memory* %MEMORY.0)
