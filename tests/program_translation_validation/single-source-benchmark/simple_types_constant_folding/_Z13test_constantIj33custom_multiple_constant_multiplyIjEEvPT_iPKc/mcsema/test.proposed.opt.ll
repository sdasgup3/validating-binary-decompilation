...
block_.L_40a13f:                                  ; preds = %block_.L_40a18d, %entry
  %68 = phi i64 [ %.pre, %entry ], [ %276, %block_.L_40a18d ]
...
block_.L_40a15d:                                  ; preds = %block_40a169, %block_40a14f
  %111 = phi i64 [ %.pre1, %block_40a14f ], [ %234, %block_40a169 ]
...
block_.L_40a18d:                                  ; preds = %block_.L_40a15d
  ...
  %call2_40a190 = tail call %struct.Memory* @sub_412540._Z17check_shifted_sumIj33custom_multiple_constant_multiplyIjEEvT_(%struct.State* %0, i64 %240, %struct.Memory* %MEMORY.1)
...
block_.L_40a1a3:                                  ; preds = %block_.L_40a13f
  ...
  %call2_40a1a3 = tail call %struct.Memory* @sub_400e60._Z5timerv(%struct.State* %0, i64 %277, %struct.Memory* %MEMORY.0)
  ...
  %call2_40a1ac = tail call %struct.Memory* @sub_400800._Z13record_resultdPKc(%struct.State* %0, i64 %288, %struct.Memory* %call2_40a1a3)
