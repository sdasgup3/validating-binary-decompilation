...
block_.L_40a1df:                                  ; preds = %block_.L_40a22d, %entry
  %68 = phi i64 [ %.pre, %entry ], [ %278, %block_.L_40a22d ]
...
block_.L_40a1fd:                                  ; preds = %block_40a209, %block_40a1ef
  %111 = phi i64 [ %.pre1, %block_40a1ef ], [ %235, %block_40a209 ]
...
block_.L_40a22d:                                  ; preds = %block_.L_40a1fd
  ...
  %call2_40a230 = tail call %struct.Memory* @sub_4124c0._Z17check_shifted_sumIj34custom_multiple_constant_multiply2IjEEvT_(%struct.State* %0, i64 %241, %struct.Memory* %MEMORY.1)
...
block_.L_40a243:                                  ; preds = %block_.L_40a1df
  ...
  %call2_40a243 = tail call %struct.Memory* @sub_400e60._Z5timerv(%struct.State* %0, i64 %279, %struct.Memory* %MEMORY.0)
  ...
  %call2_40a24c = tail call %struct.Memory* @sub_400800._Z13record_resultdPKc(%struct.State* %0, i64 %290, %struct.Memory* %call2_40a243)
