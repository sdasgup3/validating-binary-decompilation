...
declare %struct.Memory* @sub_412500._Z17check_shifted_sumIj34custom_multiple_constant_multiply2IjEEvT_(%struct.State* noalias dereferenceable(3376), i64, %struct.Memory* noalias readnone returned) local_unnamed_addr
...
define %struct.Memory* @_Z13test_constantIj34custom_multiple_constant_multiply2IjEEvPT_iPKc(%struct.State* noalias, i64, %struct.Memory* noalias readnone) local_unnamed_addr #1 {
entry:
...
block_.L_40a21f:                                  ; preds = %block_.L_40a26d, %entry
  %68 = phi i64 [ %276, %block_.L_40a26d ], [ %.pre, %entry ]
...
block_.L_40a23d:                                  ; preds = %block_40a249, %block_40a22f
  %111 = phi i64 [ %234, %block_40a249 ], [ %.pre6, %block_40a22f ]
...
block_40a249:                                     ; preds = %block_.L_40a23d
  ...
  %call2_40a254 = tail call %struct.Memory* @sub_4124e0._ZN34custom_multiple_constant_multiply2IjE8do_shiftEj(%struct.State* nonnull %0, i64 %162, %struct.Memory* %call2_40a213)
...
block_.L_40a26d:                                  ; preds = %block_.L_40a23d
  ...
  %call2_40a270 = tail call %struct.Memory* @sub_412500._Z17check_shifted_sumIj34custom_multiple_constant_multiply2IjEEvT_(%struct.State* nonnull %0, i64 %240, %struct.Memory* %call2_40a213)
...
block_.L_40a283:                                  ; preds = %block_.L_40a21f
  ...
  %call2_40a283 = tail call %struct.Memory* @sub_400ea0._Z5timerv(%struct.State* nonnull %0, i64 %277, %struct.Memory* %call2_40a213)
