...
declare %struct.Memory* @sub_412510._Z17check_shifted_sumIj34custom_multiple_constant_multiply2IjEEvT_(%struct.State* noalias dereferenceable(3376), i64, %struct.Memory* noalias readnone returned) local_unnamed_addr
...
entry:
  ...
  %call2_40a223 = tail call %struct.Memory* @sub_400e90._Z11start_timerv(%struct.State* %0, i64 %58, %struct.Memory* %2)
...
block_.L_40a22f:                                  ; preds = %block_.L_40a27d, %entry
  %68 = phi i64 [ %276, %block_.L_40a27d ], [ %.pre, %entry ]
  ...
  br i1 %101, label %block_40a23f, label %block_.L_40a293
...
block_.L_40a24d:                                  ; preds = %block_40a259, %block_40a23f
  %111 = phi i64 [ %234, %block_40a259 ], [ %.pre6, %block_40a23f ]
  ...
  br i1 %147, label %block_40a259, label %block_.L_40a27d
...
block_40a259:                                     ; preds = %block_.L_40a24d
  ...
  %call2_40a264 = tail call %struct.Memory* @sub_4124f0._ZN34custom_multiple_constant_multiply2IjE8do_shiftEj(%struct.State* nonnull %0, i64 %162, %struct.Memory* %call2_40a223)
...
block_.L_40a27d:                                  ; preds = %block_.L_40a24d
  ...
  %call2_40a280 = tail call %struct.Memory* @sub_412510._Z17check_shifted_sumIj34custom_multiple_constant_multiply2IjEEvT_(%struct.State* nonnull %0, i64 %240, %struct.Memory* %call2_40a223)
...
block_.L_40a293:                                  ; preds = %block_.L_40a22f
  ...
  %call2_40a293 = tail call %struct.Memory* @sub_400eb0._Z5timerv(%struct.State* nonnull %0, i64 %277, %struct.Memory* %call2_40a223)
  ...
  %call2_40a29c = tail call %struct.Memory* @sub_400850._Z13record_resultdPKc(%struct.State* nonnull %0, i64 %288, %struct.Memory* %call2_40a293)
