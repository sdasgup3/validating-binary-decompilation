...
declare %struct.Memory* @sub_411f40._Z17check_shifted_sumIl10custom_twoIlEEvT_(%struct.State* dereferenceable(3376), i64, %struct.Memory*)
...
define %struct.Memory* @_Z13test_constantIl10custom_twoIlEEvPT_iPKc(%struct.State* noalias, i64, %struct.Memory* noalias) #1 {
entry:
