...
declare %struct.Memory* @sub_411f30._ZN10custom_twoIlE8do_shiftEl(%struct.State* noalias dereferenceable(3376), i64, %struct.Memory* noalias readnone returned) local_unnamed_addr

declare %struct.Memory* @sub_411f40._Z17check_shifted_sumIl10custom_twoIlEEvT_(%struct.State* noalias dereferenceable(3376), i64, %struct.Memory* noalias readnone returned) local_unnamed_addr
...
block_.L_40a93f:                                  ; preds = %block_.L_40a991, %entry
  %68 = phi i64 [ %273, %block_.L_40a991 ], [ %.pre, %entry ]
...
block_.L_40a95e:                                  ; preds = %block_40a96a, %block_40a94f
  %111 = phi i64 [ %232, %block_40a96a ], [ %.pre6, %block_40a94f ]
...
block_40a96a:                                     ; preds = %block_.L_40a95e
  ...
  %call2_40a976 = tail call %struct.Memory* @sub_411f30._ZN10custom_twoIlE8do_shiftEl(%struct.State* nonnull %0, i64 %161, %struct.Memory* %call2_40a933)
...
block_.L_40a991:                                  ; preds = %block_.L_40a95e
  ...
  %call2_40a995 = tail call %struct.Memory* @sub_411f40._Z17check_shifted_sumIl10custom_twoIlEEvT_(%struct.State* nonnull %0, i64 %237, %struct.Memory* %call2_40a933)
...
block_.L_40a9a8:                                  ; preds = %block_.L_40a93f
  ...
  %call2_40a9a8 = tail call %struct.Memory* @sub_400ea0._Z5timerv(%struct.State* nonnull %0, i64 %274, %struct.Memory* %call2_40a933)
