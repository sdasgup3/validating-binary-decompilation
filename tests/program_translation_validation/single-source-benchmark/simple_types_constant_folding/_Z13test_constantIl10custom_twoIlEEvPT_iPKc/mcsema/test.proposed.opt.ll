...
block_.L_40a8ff:                                  ; preds = %block_.L_40a951, %entry
  %68 = phi i64 [ %.pre, %entry ], [ %275, %block_.L_40a951 ]
...
block_.L_40a91e:                                  ; preds = %block_40a92a, %block_40a90f
  %111 = phi i64 [ %.pre1, %block_40a90f ], [ %233, %block_40a92a ]
...
block_.L_40a951:                                  ; preds = %block_.L_40a91e
  ...
  %call2_40a955 = tail call %struct.Memory* @sub_411f00._Z17check_shifted_sumIl10custom_twoIlEEvT_(%struct.State* %0, i64 %238, %struct.Memory* %MEMORY.1)
...
block_.L_40a968:                                  ; preds = %block_.L_40a8ff
  ...
  %call2_40a968 = tail call %struct.Memory* @sub_400e60._Z5timerv(%struct.State* %0, i64 %276, %struct.Memory* %MEMORY.0)
  ...
  %call2_40a971 = tail call %struct.Memory* @sub_400800._Z13record_resultdPKc(%struct.State* %0, i64 %287, %struct.Memory* %call2_40a968)
