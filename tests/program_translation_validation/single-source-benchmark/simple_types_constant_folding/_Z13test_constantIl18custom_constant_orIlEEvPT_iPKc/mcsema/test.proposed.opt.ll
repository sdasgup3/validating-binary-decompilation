...
block_.L_40ba7f:                                  ; preds = %block_.L_40bad1, %entry
  %68 = phi i64 [ %.pre, %entry ], [ %273, %block_.L_40bad1 ]
...
block_.L_40ba9e:                                  ; preds = %block_40baaa, %block_40ba8f
  %111 = phi i64 [ %.pre1, %block_40ba8f ], [ %232, %block_40baaa ]
...
block_.L_40bad1:                                  ; preds = %block_.L_40ba9e
  ...
  %call2_40bad5 = tail call %struct.Memory* @sub_4111a0._Z17check_shifted_sumIl18custom_constant_orIlEEvT_(%struct.State* %0, i64 %237, %struct.Memory* %MEMORY.1)
...
block_.L_40bae8:                                  ; preds = %block_.L_40ba7f
  ...
  %call2_40bae8 = tail call %struct.Memory* @sub_400e60._Z5timerv(%struct.State* %0, i64 %274, %struct.Memory* %MEMORY.0)
  ...
  %call2_40baf1 = tail call %struct.Memory* @sub_400800._Z13record_resultdPKc(%struct.State* %0, i64 %285, %struct.Memory* %call2_40bae8)
