...
declare %struct.Memory* @sub_411890._ZN19custom_constant_addIlE8do_shiftEl(%struct.State* dereferenceable(3376), i64, %struct.Memory*)

declare %struct.Memory* @sub_4118b0._Z17check_shifted_sumIl19custom_constant_addIlEEvT_(%struct.State* dereferenceable(3376), i64, %struct.Memory*)
...
define %struct.Memory* @_Z13test_constantIl19custom_constant_addIlEEvPT_iPKc(%struct.State* noalias, i64, %struct.Memory* noalias) #1 {
entry:
