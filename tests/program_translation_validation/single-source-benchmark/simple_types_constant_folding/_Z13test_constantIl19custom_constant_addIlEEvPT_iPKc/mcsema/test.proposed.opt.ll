...
declare %struct.Memory* @sub_411890._ZN19custom_constant_addIlE8do_shiftEl(%struct.State* dereferenceable(3376), i64, %struct.Memory*) local_unnamed_addr

declare %struct.Memory* @sub_4118b0._Z17check_shifted_sumIl19custom_constant_addIlEEvT_(%struct.State* dereferenceable(3376), i64, %struct.Memory*) local_unnamed_addr
...
block_.L_40b29f:                                  ; preds = %block_.L_40b2f1, %entry
  %68 = phi i64 [ %.pre, %entry ], [ %273, %block_.L_40b2f1 ]
  %MEMORY.0 = phi %struct.Memory* [ %call2_40b293, %entry ], [ %call2_40b2f5, %block_.L_40b2f1 ]
...
block_.L_40b2be:                                  ; preds = %block_40b2ca, %block_40b2af
  %111 = phi i64 [ %.pre6, %block_40b2af ], [ %232, %block_40b2ca ]
  %MEMORY.1 = phi %struct.Memory* [ %MEMORY.0, %block_40b2af ], [ %call2_40b2d6, %block_40b2ca ]
...
block_40b2ca:                                     ; preds = %block_.L_40b2be
  ...
  %call2_40b2d6 = tail call %struct.Memory* @sub_411890._ZN19custom_constant_addIlE8do_shiftEl(%struct.State* nonnull %0, i64 %161, %struct.Memory* %MEMORY.1)
...
block_.L_40b2f1:                                  ; preds = %block_.L_40b2be
  ...
  %call2_40b2f5 = tail call %struct.Memory* @sub_4118b0._Z17check_shifted_sumIl19custom_constant_addIlEEvT_(%struct.State* nonnull %0, i64 %237, %struct.Memory* %MEMORY.1)
...
block_.L_40b308:                                  ; preds = %block_.L_40b29f
  ...
  %call2_40b308 = tail call %struct.Memory* @sub_400ea0._Z5timerv(%struct.State* nonnull %0, i64 %274, %struct.Memory* %MEMORY.0)
