...
block_.L_40b25f:                                  ; preds = %block_.L_40b2b1, %entry
  %68 = phi i64 [ %.pre, %entry ], [ %273, %block_.L_40b2b1 ]
...
block_.L_40b27e:                                  ; preds = %block_40b28a, %block_40b26f
  %111 = phi i64 [ %.pre1, %block_40b26f ], [ %232, %block_40b28a ]
...
block_.L_40b2b1:                                  ; preds = %block_.L_40b27e
  ...
  %call2_40b2b5 = tail call %struct.Memory* @sub_411870._Z17check_shifted_sumIl19custom_constant_addIlEEvT_(%struct.State* %0, i64 %237, %struct.Memory* %MEMORY.1)
...
block_.L_40b2c8:                                  ; preds = %block_.L_40b25f
  ...
  %call2_40b2c8 = tail call %struct.Memory* @sub_400e60._Z5timerv(%struct.State* %0, i64 %274, %struct.Memory* %MEMORY.0)
  ...
  %call2_40b2d1 = tail call %struct.Memory* @sub_400800._Z13record_resultdPKc(%struct.State* %0, i64 %285, %struct.Memory* %call2_40b2c8)
