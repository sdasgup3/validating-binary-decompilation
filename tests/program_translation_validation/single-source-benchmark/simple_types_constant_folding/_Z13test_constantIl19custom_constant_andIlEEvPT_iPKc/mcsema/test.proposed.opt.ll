...
block_.L_40b93f:                                  ; preds = %block_.L_40b991, %entry
  %68 = phi i64 [ %.pre, %entry ], [ %273, %block_.L_40b991 ]
...
block_.L_40b95e:                                  ; preds = %block_40b96a, %block_40b94f
  %111 = phi i64 [ %.pre1, %block_40b94f ], [ %232, %block_40b96a ]
...
block_.L_40b991:                                  ; preds = %block_.L_40b95e
  ...
  %call2_40b995 = tail call %struct.Memory* @sub_4112b0._Z17check_shifted_sumIl19custom_constant_andIlEEvT_(%struct.State* %0, i64 %237, %struct.Memory* %MEMORY.1)
...
block_.L_40b9a8:                                  ; preds = %block_.L_40b93f
  ...
  %call2_40b9a8 = tail call %struct.Memory* @sub_400e60._Z5timerv(%struct.State* %0, i64 %274, %struct.Memory* %MEMORY.0)
  ...
  %call2_40b9b1 = tail call %struct.Memory* @sub_400800._Z13record_resultdPKc(%struct.State* %0, i64 %285, %struct.Memory* %call2_40b9a8)
