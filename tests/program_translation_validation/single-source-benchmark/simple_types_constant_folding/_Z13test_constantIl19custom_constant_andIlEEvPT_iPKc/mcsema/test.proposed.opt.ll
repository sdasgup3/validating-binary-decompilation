...
declare %struct.Memory* @sub_4112f0._Z17check_shifted_sumIl19custom_constant_andIlEEvT_(%struct.State* dereferenceable(3376), i64, %struct.Memory*) local_unnamed_addr
...
block_.L_40b97f:                                  ; preds = %block_.L_40b9d1, %entry
  %68 = phi i64 [ %.pre, %entry ], [ %273, %block_.L_40b9d1 ]
  %MEMORY.0 = phi %struct.Memory* [ %call2_40b973, %entry ], [ %call2_40b9d5, %block_.L_40b9d1 ]
...
block_.L_40b99e:                                  ; preds = %block_40b9aa, %block_40b98f
  %111 = phi i64 [ %.pre6, %block_40b98f ], [ %232, %block_40b9aa ]
  %MEMORY.1 = phi %struct.Memory* [ %MEMORY.0, %block_40b98f ], [ %call2_40b9b6, %block_40b9aa ]
...
block_40b9aa:                                     ; preds = %block_.L_40b99e
  ...
  %call2_40b9b6 = tail call %struct.Memory* @sub_4112d0._ZN19custom_constant_andIlE8do_shiftEl(%struct.State* nonnull %0, i64 %161, %struct.Memory* %MEMORY.1)
...
block_.L_40b9d1:                                  ; preds = %block_.L_40b99e
  ...
  %call2_40b9d5 = tail call %struct.Memory* @sub_4112f0._Z17check_shifted_sumIl19custom_constant_andIlEEvT_(%struct.State* nonnull %0, i64 %237, %struct.Memory* %MEMORY.1)
...
block_.L_40b9e8:                                  ; preds = %block_.L_40b97f
  ...
  %call2_40b9e8 = tail call %struct.Memory* @sub_400ea0._Z5timerv(%struct.State* nonnull %0, i64 %274, %struct.Memory* %MEMORY.0)
