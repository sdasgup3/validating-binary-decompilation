...
declare %struct.Memory* @sub_4117a0._Z17check_shifted_sumIl19custom_constant_subIlEEvT_(%struct.State* dereferenceable(3376), i64, %struct.Memory*)
...
define %struct.Memory* @_Z13test_constantIl19custom_constant_subIlEEvPT_iPKc(%struct.State* noalias, i64, %struct.Memory* noalias) #1 {
entry:
