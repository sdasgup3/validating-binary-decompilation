...
declare %struct.Memory* @sub_4117a0._Z17check_shifted_sumIl19custom_constant_subIlEEvT_(%struct.State* noalias dereferenceable(3376), i64, %struct.Memory* noalias readnone returned) local_unnamed_addr
...
define %struct.Memory* @_Z13test_constantIl19custom_constant_subIlEEvPT_iPKc(%struct.State* noalias, i64, %struct.Memory* noalias readnone) local_unnamed_addr #1 {
entry:
...
block_.L_40b3df:                                  ; preds = %block_.L_40b431, %entry
  %68 = phi i64 [ %273, %block_.L_40b431 ], [ %.pre, %entry ]
...
block_.L_40b3fe:                                  ; preds = %block_40b40a, %block_40b3ef
  %111 = phi i64 [ %232, %block_40b40a ], [ %.pre6, %block_40b3ef ]
...
block_40b40a:                                     ; preds = %block_.L_40b3fe
  ...
  %call2_40b416 = tail call %struct.Memory* @sub_411780._ZN19custom_constant_subIlE8do_shiftEl(%struct.State* nonnull %0, i64 %161, %struct.Memory* %call2_40b3d3)
...
block_.L_40b431:                                  ; preds = %block_.L_40b3fe
  ...
  %call2_40b435 = tail call %struct.Memory* @sub_4117a0._Z17check_shifted_sumIl19custom_constant_subIlEEvT_(%struct.State* nonnull %0, i64 %237, %struct.Memory* %call2_40b3d3)
...
block_.L_40b448:                                  ; preds = %block_.L_40b3df
  ...
  %call2_40b448 = tail call %struct.Memory* @sub_400ea0._Z5timerv(%struct.State* nonnull %0, i64 %274, %struct.Memory* %call2_40b3d3)
