...
block_.L_40b39f:                                  ; preds = %block_.L_40b3f1, %entry
  %68 = phi i64 [ %.pre, %entry ], [ %273, %block_.L_40b3f1 ]
...
block_.L_40b3be:                                  ; preds = %block_40b3ca, %block_40b3af
  %111 = phi i64 [ %.pre1, %block_40b3af ], [ %232, %block_40b3ca ]
...
block_.L_40b3f1:                                  ; preds = %block_.L_40b3be
  ...
  %call2_40b3f5 = tail call %struct.Memory* @sub_411760._Z17check_shifted_sumIl19custom_constant_subIlEEvT_(%struct.State* %0, i64 %237, %struct.Memory* %MEMORY.1)
...
block_.L_40b408:                                  ; preds = %block_.L_40b39f
  ...
  %call2_40b408 = tail call %struct.Memory* @sub_400e60._Z5timerv(%struct.State* %0, i64 %274, %struct.Memory* %MEMORY.0)
  ...
  %call2_40b411 = tail call %struct.Memory* @sub_400800._Z13record_resultdPKc(%struct.State* %0, i64 %285, %struct.Memory* %call2_40b408)
