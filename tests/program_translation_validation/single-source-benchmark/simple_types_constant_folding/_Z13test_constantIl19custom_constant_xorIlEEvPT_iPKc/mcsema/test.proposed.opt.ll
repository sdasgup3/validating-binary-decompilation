...
declare %struct.Memory* @sub_4110e0._Z17check_shifted_sumIl19custom_constant_xorIlEEvT_(%struct.State* noalias dereferenceable(3376), i64, %struct.Memory* noalias readnone returned) local_unnamed_addr
...
entry:
  ...
  %call2_40bc03 = tail call %struct.Memory* @sub_400e90._Z11start_timerv(%struct.State* %0, i64 %58, %struct.Memory* %2)
...
block_.L_40bc0f:                                  ; preds = %block_.L_40bc61, %entry
  %68 = phi i64 [ %273, %block_.L_40bc61 ], [ %.pre, %entry ]
  ...
  br i1 %101, label %block_40bc1f, label %block_.L_40bc78

block_40bc1f:                                     ; preds = %block_.L_40bc0f
  %103 = add i64 %69, -40
  %104 = add i64 %102, 8
...
block_.L_40bc2e:                                  ; preds = %block_40bc3a, %block_40bc1f
  %111 = phi i64 [ %232, %block_40bc3a ], [ %.pre6, %block_40bc1f ]
  ...
  br i1 %147, label %block_40bc3a, label %block_.L_40bc61

block_40bc3a:                                     ; preds = %block_.L_40bc2e
  %149 = add i64 %112, -8
  %150 = add i64 %148, 4
  ...
  %call2_40bc46 = tail call %struct.Memory* @sub_4110c0._ZN19custom_constant_xorIlE8do_shiftEl(%struct.State* nonnull %0, i64 %161, %struct.Memory* %call2_40bc03)
...
block_.L_40bc61:                                  ; preds = %block_.L_40bc2e
  %233 = add i64 %112, -40
  %234 = add i64 %148, 4
  ...
  %call2_40bc65 = tail call %struct.Memory* @sub_4110e0._Z17check_shifted_sumIl19custom_constant_xorIlEEvT_(%struct.State* nonnull %0, i64 %237, %struct.Memory* %call2_40bc03)
...
block_.L_40bc78:                                  ; preds = %block_.L_40bc0f
  ...
  %call2_40bc78 = tail call %struct.Memory* @sub_400eb0._Z5timerv(%struct.State* nonnull %0, i64 %274, %struct.Memory* %call2_40bc03)
  ...
  %call2_40bc81 = tail call %struct.Memory* @sub_400850._Z13record_resultdPKc(%struct.State* nonnull %0, i64 %285, %struct.Memory* %call2_40bc78)
