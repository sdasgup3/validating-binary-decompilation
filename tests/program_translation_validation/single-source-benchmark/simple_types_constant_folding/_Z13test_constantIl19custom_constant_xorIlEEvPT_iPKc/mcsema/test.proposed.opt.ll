...
block_.L_40bbbf:                                  ; preds = %block_.L_40bc11, %entry
  %68 = phi i64 [ %.pre, %entry ], [ %273, %block_.L_40bc11 ]
...
block_.L_40bbde:                                  ; preds = %block_40bbea, %block_40bbcf
  %111 = phi i64 [ %.pre1, %block_40bbcf ], [ %232, %block_40bbea ]
...
block_.L_40bc11:                                  ; preds = %block_.L_40bbde
  ...
  %call2_40bc15 = tail call %struct.Memory* @sub_411090._Z17check_shifted_sumIl19custom_constant_xorIlEEvT_(%struct.State* %0, i64 %237, %struct.Memory* %MEMORY.1)
...
block_.L_40bc28:                                  ; preds = %block_.L_40bbbf
  ...
  %call2_40bc28 = tail call %struct.Memory* @sub_400e60._Z5timerv(%struct.State* %0, i64 %274, %struct.Memory* %MEMORY.0)
  ...
  %call2_40bc31 = tail call %struct.Memory* @sub_400800._Z13record_resultdPKc(%struct.State* %0, i64 %285, %struct.Memory* %call2_40bc28)
