...
declare %struct.Memory* @sub_4110d0._Z17check_shifted_sumIl19custom_constant_xorIlEEvT_(%struct.State* noalias dereferenceable(3376), i64, %struct.Memory* noalias readnone returned) local_unnamed_addr
...
define %struct.Memory* @_Z13test_constantIl19custom_constant_xorIlEEvPT_iPKc(%struct.State* noalias, i64, %struct.Memory* noalias readnone) local_unnamed_addr #1 {
entry:
...
block_.L_40bbff:                                  ; preds = %block_.L_40bc51, %entry
  %68 = phi i64 [ %273, %block_.L_40bc51 ], [ %.pre, %entry ]
...
block_.L_40bc1e:                                  ; preds = %block_40bc2a, %block_40bc0f
  %111 = phi i64 [ %232, %block_40bc2a ], [ %.pre6, %block_40bc0f ]
...
block_40bc2a:                                     ; preds = %block_.L_40bc1e
  ...
  %call2_40bc36 = tail call %struct.Memory* @sub_4110b0._ZN19custom_constant_xorIlE8do_shiftEl(%struct.State* nonnull %0, i64 %161, %struct.Memory* %call2_40bbf3)
...
block_.L_40bc51:                                  ; preds = %block_.L_40bc1e
  ...
  %call2_40bc55 = tail call %struct.Memory* @sub_4110d0._Z17check_shifted_sumIl19custom_constant_xorIlEEvT_(%struct.State* nonnull %0, i64 %237, %struct.Memory* %call2_40bbf3)
...
block_.L_40bc68:                                  ; preds = %block_.L_40bbff
  ...
  %call2_40bc68 = tail call %struct.Memory* @sub_400ea0._Z5timerv(%struct.State* nonnull %0, i64 %274, %struct.Memory* %call2_40bbf3)
