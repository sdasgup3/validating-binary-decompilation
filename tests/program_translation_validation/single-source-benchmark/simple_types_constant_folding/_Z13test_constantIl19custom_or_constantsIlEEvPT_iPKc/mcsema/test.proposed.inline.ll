...
declare %struct.Memory* @sub_411980._ZN19custom_or_constantsIlE8do_shiftEl(%struct.State* dereferenceable(3376), i64, %struct.Memory*)

declare %struct.Memory* @sub_411990._Z17check_shifted_sumIl19custom_or_constantsIlEEvT_(%struct.State* dereferenceable(3376), i64, %struct.Memory*)
...
define %struct.Memory* @_Z13test_constantIl19custom_or_constantsIlEEvPT_iPKc(%struct.State* noalias, i64, %struct.Memory* noalias) #1 {
entry:
