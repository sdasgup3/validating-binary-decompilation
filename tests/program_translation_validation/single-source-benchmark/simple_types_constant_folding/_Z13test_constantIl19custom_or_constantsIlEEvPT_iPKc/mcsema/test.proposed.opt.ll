...
declare %struct.Memory* @sub_411990._Z17check_shifted_sumIl19custom_or_constantsIlEEvT_(%struct.State* noalias dereferenceable(3376), i64, %struct.Memory* noalias readnone returned) local_unnamed_addr
...
define %struct.Memory* @_Z13test_constantIl19custom_or_constantsIlEEvPT_iPKc(%struct.State* noalias, i64, %struct.Memory* noalias readnone) local_unnamed_addr #1 {
entry:
...
block_.L_40b15f:                                  ; preds = %block_.L_40b1b1, %entry
  %68 = phi i64 [ %273, %block_.L_40b1b1 ], [ %.pre, %entry ]
...
block_.L_40b17e:                                  ; preds = %block_40b18a, %block_40b16f
  %111 = phi i64 [ %232, %block_40b18a ], [ %.pre6, %block_40b16f ]
...
block_40b18a:                                     ; preds = %block_.L_40b17e
  ...
  %call2_40b196 = tail call %struct.Memory* @sub_411980._ZN19custom_or_constantsIlE8do_shiftEl(%struct.State* nonnull %0, i64 %161, %struct.Memory* %call2_40b153)
...
block_.L_40b1b1:                                  ; preds = %block_.L_40b17e
  ...
  %call2_40b1b5 = tail call %struct.Memory* @sub_411990._Z17check_shifted_sumIl19custom_or_constantsIlEEvT_(%struct.State* nonnull %0, i64 %237, %struct.Memory* %call2_40b153)
...
block_.L_40b1c8:                                  ; preds = %block_.L_40b15f
  ...
  %call2_40b1c8 = tail call %struct.Memory* @sub_400ea0._Z5timerv(%struct.State* nonnull %0, i64 %274, %struct.Memory* %call2_40b153)
