...
declare %struct.Memory* @sub_4119a0._Z17check_shifted_sumIl19custom_or_constantsIlEEvT_(%struct.State* noalias dereferenceable(3376), i64, %struct.Memory* noalias readnone returned) local_unnamed_addr
...
entry:
  ...
  %call2_40b163 = tail call %struct.Memory* @sub_400e90._Z11start_timerv(%struct.State* %0, i64 %58, %struct.Memory* %2)
...
block_.L_40b16f:                                  ; preds = %block_.L_40b1c1, %entry
  %68 = phi i64 [ %273, %block_.L_40b1c1 ], [ %.pre, %entry ]
  ...
  br i1 %101, label %block_40b17f, label %block_.L_40b1d8
...
block_.L_40b18e:                                  ; preds = %block_40b19a, %block_40b17f
  %111 = phi i64 [ %232, %block_40b19a ], [ %.pre6, %block_40b17f ]
  ...
  br i1 %147, label %block_40b19a, label %block_.L_40b1c1
...
block_40b19a:                                     ; preds = %block_.L_40b18e
  ...
  %call2_40b1a6 = tail call %struct.Memory* @sub_411990._ZN19custom_or_constantsIlE8do_shiftEl(%struct.State* nonnull %0, i64 %161, %struct.Memory* %call2_40b163)
...
block_.L_40b1c1:                                  ; preds = %block_.L_40b18e
  ...
  %call2_40b1c5 = tail call %struct.Memory* @sub_4119a0._Z17check_shifted_sumIl19custom_or_constantsIlEEvT_(%struct.State* nonnull %0, i64 %237, %struct.Memory* %call2_40b163)
...
block_.L_40b1d8:                                  ; preds = %block_.L_40b16f
  ...
  %call2_40b1d8 = tail call %struct.Memory* @sub_400eb0._Z5timerv(%struct.State* nonnull %0, i64 %274, %struct.Memory* %call2_40b163)
  ...
  %call2_40b1e1 = tail call %struct.Memory* @sub_400850._Z13record_resultdPKc(%struct.State* nonnull %0, i64 %285, %struct.Memory* %call2_40b1d8)
