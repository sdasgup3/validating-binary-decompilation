...
declare %struct.Memory* @sub_411ed0._Z17check_shifted_sumIl20custom_add_constantsIlEEvT_(%struct.State* noalias dereferenceable(3376), i64, %struct.Memory* noalias readnone returned) local_unnamed_addr
...
define %struct.Memory* @_Z13test_constantIl20custom_add_constantsIlEEvPT_iPKc(%struct.State* noalias, i64, %struct.Memory* noalias readnone) local_unnamed_addr #1 {
entry:
...
block_.L_40a9df:                                  ; preds = %block_.L_40aa31, %entry
  %68 = phi i64 [ %273, %block_.L_40aa31 ], [ %.pre, %entry ]
...
block_.L_40a9fe:                                  ; preds = %block_40aa0a, %block_40a9ef
  %111 = phi i64 [ %232, %block_40aa0a ], [ %.pre6, %block_40a9ef ]
...
block_40aa0a:                                     ; preds = %block_.L_40a9fe
  ...
  %call2_40aa16 = tail call %struct.Memory* @sub_411ec0._ZN20custom_add_constantsIlE8do_shiftEl(%struct.State* nonnull %0, i64 %161, %struct.Memory* %call2_40a9d3)
...
block_.L_40aa31:                                  ; preds = %block_.L_40a9fe
  ...
  %call2_40aa35 = tail call %struct.Memory* @sub_411ed0._Z17check_shifted_sumIl20custom_add_constantsIlEEvT_(%struct.State* nonnull %0, i64 %237, %struct.Memory* %call2_40a9d3)
...
block_.L_40aa48:                                  ; preds = %block_.L_40a9df
  ...
  %call2_40aa48 = tail call %struct.Memory* @sub_400ea0._Z5timerv(%struct.State* nonnull %0, i64 %274, %struct.Memory* %call2_40a9d3)
