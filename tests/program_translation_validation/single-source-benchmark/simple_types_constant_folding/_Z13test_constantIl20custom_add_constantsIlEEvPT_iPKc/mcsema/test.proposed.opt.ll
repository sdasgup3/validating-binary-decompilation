...
declare %struct.Memory* @sub_411ee0._Z17check_shifted_sumIl20custom_add_constantsIlEEvT_(%struct.State* noalias dereferenceable(3376), i64, %struct.Memory* noalias readnone returned) local_unnamed_addr
...
entry:
  ...
  %call2_40a9e3 = tail call %struct.Memory* @sub_400e90._Z11start_timerv(%struct.State* %0, i64 %58, %struct.Memory* %2)
...
block_.L_40a9ef:                                  ; preds = %block_.L_40aa41, %entry
  %68 = phi i64 [ %273, %block_.L_40aa41 ], [ %.pre, %entry ]
  ...
  br i1 %101, label %block_40a9ff, label %block_.L_40aa58
...
block_.L_40aa0e:                                  ; preds = %block_40aa1a, %block_40a9ff
  %111 = phi i64 [ %232, %block_40aa1a ], [ %.pre6, %block_40a9ff ]
  ...
  br i1 %147, label %block_40aa1a, label %block_.L_40aa41
...
block_40aa1a:                                     ; preds = %block_.L_40aa0e
  ...
  %call2_40aa26 = tail call %struct.Memory* @sub_411ed0._ZN20custom_add_constantsIlE8do_shiftEl(%struct.State* nonnull %0, i64 %161, %struct.Memory* %call2_40a9e3)
...
block_.L_40aa41:                                  ; preds = %block_.L_40aa0e
  ...
  %call2_40aa45 = tail call %struct.Memory* @sub_411ee0._Z17check_shifted_sumIl20custom_add_constantsIlEEvT_(%struct.State* nonnull %0, i64 %237, %struct.Memory* %call2_40a9e3)
...
block_.L_40aa58:                                  ; preds = %block_.L_40a9ef
  ...
  %call2_40aa58 = tail call %struct.Memory* @sub_400eb0._Z5timerv(%struct.State* nonnull %0, i64 %274, %struct.Memory* %call2_40a9e3)
  ...
  %call2_40aa61 = tail call %struct.Memory* @sub_400850._Z13record_resultdPKc(%struct.State* nonnull %0, i64 %285, %struct.Memory* %call2_40aa58)
