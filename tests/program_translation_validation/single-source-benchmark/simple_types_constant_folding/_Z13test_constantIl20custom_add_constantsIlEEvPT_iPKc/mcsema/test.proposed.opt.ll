...
block_.L_40a99f:                                  ; preds = %block_.L_40a9f1, %entry
  %68 = phi i64 [ %.pre, %entry ], [ %275, %block_.L_40a9f1 ]
...
block_.L_40a9be:                                  ; preds = %block_40a9ca, %block_40a9af
  %111 = phi i64 [ %.pre1, %block_40a9af ], [ %233, %block_40a9ca ]
...
block_.L_40a9f1:                                  ; preds = %block_.L_40a9be
  ...
  %call2_40a9f5 = tail call %struct.Memory* @sub_411e90._Z17check_shifted_sumIl20custom_add_constantsIlEEvT_(%struct.State* %0, i64 %238, %struct.Memory* %MEMORY.1)
...
block_.L_40aa08:                                  ; preds = %block_.L_40a99f
  ...
  %call2_40aa08 = tail call %struct.Memory* @sub_400e60._Z5timerv(%struct.State* %0, i64 %276, %struct.Memory* %MEMORY.0)
  ...
  %call2_40aa11 = tail call %struct.Memory* @sub_400800._Z13record_resultdPKc(%struct.State* %0, i64 %287, %struct.Memory* %call2_40aa08)
