...
declare %struct.Memory* @sub_4119f0._ZN20custom_and_constantsIlE8do_shiftEl(%struct.State* dereferenceable(3376), i64, %struct.Memory*)

declare %struct.Memory* @sub_411a00._Z17check_shifted_sumIl20custom_and_constantsIlEEvT_(%struct.State* dereferenceable(3376), i64, %struct.Memory*)
...
define %struct.Memory* @_Z13test_constantIl20custom_and_constantsIlEEvPT_iPKc(%struct.State* noalias, i64, %struct.Memory* noalias) #1 {
entry:
