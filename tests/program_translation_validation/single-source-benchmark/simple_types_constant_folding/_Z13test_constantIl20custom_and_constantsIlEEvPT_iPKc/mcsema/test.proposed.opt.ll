...
block_.L_40b07f:                                  ; preds = %block_.L_40b0d1, %entry
  %68 = phi i64 [ %.pre, %entry ], [ %273, %block_.L_40b0d1 ]
...
block_.L_40b09e:                                  ; preds = %block_40b0aa, %block_40b08f
  %111 = phi i64 [ %.pre1, %block_40b08f ], [ %232, %block_40b0aa ]
...
block_.L_40b0d1:                                  ; preds = %block_.L_40b09e
  ...
  %call2_40b0d5 = tail call %struct.Memory* @sub_4119c0._Z17check_shifted_sumIl20custom_and_constantsIlEEvT_(%struct.State* %0, i64 %237, %struct.Memory* %MEMORY.1)
...
block_.L_40b0e8:                                  ; preds = %block_.L_40b07f
  ...
  %call2_40b0e8 = tail call %struct.Memory* @sub_400e60._Z5timerv(%struct.State* %0, i64 %274, %struct.Memory* %MEMORY.0)
  ...
  %call2_40b0f1 = tail call %struct.Memory* @sub_400800._Z13record_resultdPKc(%struct.State* %0, i64 %285, %struct.Memory* %call2_40b0e8)
