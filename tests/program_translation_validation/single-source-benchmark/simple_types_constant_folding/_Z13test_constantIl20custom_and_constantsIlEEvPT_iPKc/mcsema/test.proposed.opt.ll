...
declare %struct.Memory* @sub_411a00._Z17check_shifted_sumIl20custom_and_constantsIlEEvT_(%struct.State* noalias dereferenceable(3376), i64, %struct.Memory* noalias readnone returned) local_unnamed_addr
...
define %struct.Memory* @_Z13test_constantIl20custom_and_constantsIlEEvPT_iPKc(%struct.State* noalias, i64, %struct.Memory* noalias readnone) local_unnamed_addr #1 {
entry:
...
block_.L_40b0bf:                                  ; preds = %block_.L_40b111, %entry
  %68 = phi i64 [ %273, %block_.L_40b111 ], [ %.pre, %entry ]
...
block_.L_40b0de:                                  ; preds = %block_40b0ea, %block_40b0cf
  %111 = phi i64 [ %232, %block_40b0ea ], [ %.pre6, %block_40b0cf ]
...
block_40b0ea:                                     ; preds = %block_.L_40b0de
  ...
  %call2_40b0f6 = tail call %struct.Memory* @sub_4119f0._ZN20custom_and_constantsIlE8do_shiftEl(%struct.State* nonnull %0, i64 %161, %struct.Memory* %call2_40b0b3)
...
block_.L_40b111:                                  ; preds = %block_.L_40b0de
  ...
  %call2_40b115 = tail call %struct.Memory* @sub_411a00._Z17check_shifted_sumIl20custom_and_constantsIlEEvT_(%struct.State* nonnull %0, i64 %237, %struct.Memory* %call2_40b0b3)
...
block_.L_40b128:                                  ; preds = %block_.L_40b0bf
  ...
  %call2_40b128 = tail call %struct.Memory* @sub_400ea0._Z5timerv(%struct.State* nonnull %0, i64 %274, %struct.Memory* %call2_40b0b3)
