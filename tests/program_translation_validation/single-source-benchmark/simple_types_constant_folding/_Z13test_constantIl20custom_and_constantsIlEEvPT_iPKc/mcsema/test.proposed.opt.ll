...
declare %struct.Memory* @sub_411a10._Z17check_shifted_sumIl20custom_and_constantsIlEEvT_(%struct.State* noalias dereferenceable(3376), i64, %struct.Memory* noalias readnone returned) local_unnamed_addr
...
entry:
  ...
  %call2_40b0c3 = tail call %struct.Memory* @sub_400e90._Z11start_timerv(%struct.State* %0, i64 %58, %struct.Memory* %2)
...
block_.L_40b0cf:                                  ; preds = %block_.L_40b121, %entry
  %68 = phi i64 [ %273, %block_.L_40b121 ], [ %.pre, %entry ]
  ...
  br i1 %101, label %block_40b0df, label %block_.L_40b138
...
block_.L_40b0ee:                                  ; preds = %block_40b0fa, %block_40b0df
  %111 = phi i64 [ %232, %block_40b0fa ], [ %.pre6, %block_40b0df ]
  ...
  br i1 %147, label %block_40b0fa, label %block_.L_40b121
...
block_40b0fa:                                     ; preds = %block_.L_40b0ee
  ...
  %call2_40b106 = tail call %struct.Memory* @sub_411a00._ZN20custom_and_constantsIlE8do_shiftEl(%struct.State* nonnull %0, i64 %161, %struct.Memory* %call2_40b0c3)
...
block_.L_40b121:                                  ; preds = %block_.L_40b0ee
  ...
  %call2_40b125 = tail call %struct.Memory* @sub_411a10._Z17check_shifted_sumIl20custom_and_constantsIlEEvT_(%struct.State* nonnull %0, i64 %237, %struct.Memory* %call2_40b0c3)
...
block_.L_40b138:                                  ; preds = %block_.L_40b0cf
  ...
  %call2_40b138 = tail call %struct.Memory* @sub_400eb0._Z5timerv(%struct.State* nonnull %0, i64 %274, %struct.Memory* %call2_40b0c3)
  ...
  %call2_40b141 = tail call %struct.Memory* @sub_400850._Z13record_resultdPKc(%struct.State* nonnull %0, i64 %285, %struct.Memory* %call2_40b138)
