...
block_.L_40ac1f:                                  ; preds = %block_.L_40ac71, %entry
  %68 = phi i64 [ %.pre, %entry ], [ %273, %block_.L_40ac71 ]
...
block_.L_40ac3e:                                  ; preds = %block_40ac4a, %block_40ac2f
  %111 = phi i64 [ %.pre1, %block_40ac2f ], [ %232, %block_40ac4a ]
...
block_.L_40ac71:                                  ; preds = %block_.L_40ac3e
  ...
  %call2_40ac75 = tail call %struct.Memory* @sub_411cd0._Z17check_shifted_sumIl20custom_mod_constantsIlEEvT_(%struct.State* %0, i64 %237, %struct.Memory* %MEMORY.1)
...
block_.L_40ac88:                                  ; preds = %block_.L_40ac1f
  ...
  %call2_40ac88 = tail call %struct.Memory* @sub_400e60._Z5timerv(%struct.State* %0, i64 %274, %struct.Memory* %MEMORY.0)
  ...
  %call2_40ac91 = tail call %struct.Memory* @sub_400800._Z13record_resultdPKc(%struct.State* %0, i64 %285, %struct.Memory* %call2_40ac88)
