...
declare %struct.Memory* @sub_411d10._ZN20custom_mod_constantsIlE8do_shiftEl(%struct.State* noalias dereferenceable(3376), i64, %struct.Memory* noalias readnone returned) local_unnamed_addr

declare %struct.Memory* @sub_411d20._Z17check_shifted_sumIl20custom_mod_constantsIlEEvT_(%struct.State* noalias dereferenceable(3376), i64, %struct.Memory* noalias readnone returned) local_unnamed_addr
...
entry:
  ...
  %call2_40ac63 = tail call %struct.Memory* @sub_400e90._Z11start_timerv(%struct.State* %0, i64 %58, %struct.Memory* %2)
...
block_.L_40ac6f:                                  ; preds = %block_.L_40acc1, %entry
  %68 = phi i64 [ %273, %block_.L_40acc1 ], [ %.pre, %entry ]
  ...
  br i1 %101, label %block_40ac7f, label %block_.L_40acd8
...
block_.L_40ac8e:                                  ; preds = %block_40ac9a, %block_40ac7f
  %111 = phi i64 [ %232, %block_40ac9a ], [ %.pre6, %block_40ac7f ]
  ...
  br i1 %147, label %block_40ac9a, label %block_.L_40acc1
...
block_40ac9a:                                     ; preds = %block_.L_40ac8e
  ...
  %call2_40aca6 = tail call %struct.Memory* @sub_411d10._ZN20custom_mod_constantsIlE8do_shiftEl(%struct.State* nonnull %0, i64 %161, %struct.Memory* %call2_40ac63)
...
block_.L_40acc1:                                  ; preds = %block_.L_40ac8e
  ...
  %call2_40acc5 = tail call %struct.Memory* @sub_411d20._Z17check_shifted_sumIl20custom_mod_constantsIlEEvT_(%struct.State* nonnull %0, i64 %237, %struct.Memory* %call2_40ac63)
...
block_.L_40acd8:                                  ; preds = %block_.L_40ac6f
  ...
  %call2_40acd8 = tail call %struct.Memory* @sub_400eb0._Z5timerv(%struct.State* nonnull %0, i64 %274, %struct.Memory* %call2_40ac63)
  ...
  %call2_40ace1 = tail call %struct.Memory* @sub_400850._Z13record_resultdPKc(%struct.State* nonnull %0, i64 %285, %struct.Memory* %call2_40acd8)
