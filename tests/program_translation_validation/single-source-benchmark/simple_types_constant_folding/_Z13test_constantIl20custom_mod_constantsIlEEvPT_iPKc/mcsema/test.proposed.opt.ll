...
declare %struct.Memory* @sub_411d00._ZN20custom_mod_constantsIlE8do_shiftEl(%struct.State* noalias dereferenceable(3376), i64, %struct.Memory* noalias readnone returned) local_unnamed_addr

declare %struct.Memory* @sub_411d10._Z17check_shifted_sumIl20custom_mod_constantsIlEEvT_(%struct.State* noalias dereferenceable(3376), i64, %struct.Memory* noalias readnone returned) local_unnamed_addr
...
define %struct.Memory* @_Z13test_constantIl20custom_mod_constantsIlEEvPT_iPKc(%struct.State* noalias, i64, %struct.Memory* noalias readnone) local_unnamed_addr #1 {
entry:
...
block_.L_40ac5f:                                  ; preds = %block_.L_40acb1, %entry
  %68 = phi i64 [ %273, %block_.L_40acb1 ], [ %.pre, %entry ]
...
block_.L_40ac7e:                                  ; preds = %block_40ac8a, %block_40ac6f
  %111 = phi i64 [ %232, %block_40ac8a ], [ %.pre6, %block_40ac6f ]
...
block_40ac8a:                                     ; preds = %block_.L_40ac7e
  ...
  %call2_40ac96 = tail call %struct.Memory* @sub_411d00._ZN20custom_mod_constantsIlE8do_shiftEl(%struct.State* nonnull %0, i64 %161, %struct.Memory* %call2_40ac53)
...
block_.L_40acb1:                                  ; preds = %block_.L_40ac7e
  ...
  %call2_40acb5 = tail call %struct.Memory* @sub_411d10._Z17check_shifted_sumIl20custom_mod_constantsIlEEvT_(%struct.State* nonnull %0, i64 %237, %struct.Memory* %call2_40ac53)
...
block_.L_40acc8:                                  ; preds = %block_.L_40ac5f
  ...
  %call2_40acc8 = tail call %struct.Memory* @sub_400ea0._Z5timerv(%struct.State* nonnull %0, i64 %274, %struct.Memory* %call2_40ac53)
