...
block_.L_40aa3f:                                  ; preds = %block_.L_40aa91, %entry
  %68 = phi i64 [ %.pre, %entry ], [ %275, %block_.L_40aa91 ]
...
block_.L_40aa5e:                                  ; preds = %block_40aa6a, %block_40aa4f
  %111 = phi i64 [ %.pre1, %block_40aa4f ], [ %233, %block_40aa6a ]
...
block_.L_40aa91:                                  ; preds = %block_.L_40aa5e
  ...
  %call2_40aa95 = tail call %struct.Memory* @sub_411e20._Z17check_shifted_sumIl20custom_sub_constantsIlEEvT_(%struct.State* %0, i64 %238, %struct.Memory* %MEMORY.1)
...
block_.L_40aaa8:                                  ; preds = %block_.L_40aa3f
  ...
  %call2_40aaa8 = tail call %struct.Memory* @sub_400e60._Z5timerv(%struct.State* %0, i64 %276, %struct.Memory* %MEMORY.0)
  ...
  %call2_40aab1 = tail call %struct.Memory* @sub_400800._Z13record_resultdPKc(%struct.State* %0, i64 %287, %struct.Memory* %call2_40aaa8)
