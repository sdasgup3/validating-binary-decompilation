...
declare %struct.Memory* @sub_411e50._ZN20custom_sub_constantsIlE8do_shiftEl(%struct.State* noalias dereferenceable(3376), i64, %struct.Memory* noalias readnone returned) local_unnamed_addr

declare %struct.Memory* @sub_411e60._Z17check_shifted_sumIl20custom_sub_constantsIlEEvT_(%struct.State* noalias dereferenceable(3376), i64, %struct.Memory* noalias readnone returned) local_unnamed_addr
...
block_.L_40aa7f:                                  ; preds = %block_.L_40aad1, %entry
  %68 = phi i64 [ %273, %block_.L_40aad1 ], [ %.pre, %entry ]
...
block_.L_40aa9e:                                  ; preds = %block_40aaaa, %block_40aa8f
  %111 = phi i64 [ %232, %block_40aaaa ], [ %.pre6, %block_40aa8f ]
...
block_40aaaa:                                     ; preds = %block_.L_40aa9e
  ...
  %call2_40aab6 = tail call %struct.Memory* @sub_411e50._ZN20custom_sub_constantsIlE8do_shiftEl(%struct.State* nonnull %0, i64 %161, %struct.Memory* %call2_40aa73)
...
block_.L_40aad1:                                  ; preds = %block_.L_40aa9e
  ...
  %call2_40aad5 = tail call %struct.Memory* @sub_411e60._Z17check_shifted_sumIl20custom_sub_constantsIlEEvT_(%struct.State* nonnull %0, i64 %237, %struct.Memory* %call2_40aa73)
...
block_.L_40aae8:                                  ; preds = %block_.L_40aa7f
  ...
  %call2_40aae8 = tail call %struct.Memory* @sub_400ea0._Z5timerv(%struct.State* nonnull %0, i64 %274, %struct.Memory* %call2_40aa73)
