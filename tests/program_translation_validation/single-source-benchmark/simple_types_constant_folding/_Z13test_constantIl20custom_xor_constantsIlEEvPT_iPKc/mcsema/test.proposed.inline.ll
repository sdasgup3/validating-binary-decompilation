...
declare %struct.Memory* @sub_411920._Z17check_shifted_sumIl20custom_xor_constantsIlEEvT_(%struct.State* dereferenceable(3376), i64, %struct.Memory*)
...
define %struct.Memory* @_Z13test_constantIl20custom_xor_constantsIlEEvPT_iPKc(%struct.State* noalias, i64, %struct.Memory* noalias) #1 {
entry:
