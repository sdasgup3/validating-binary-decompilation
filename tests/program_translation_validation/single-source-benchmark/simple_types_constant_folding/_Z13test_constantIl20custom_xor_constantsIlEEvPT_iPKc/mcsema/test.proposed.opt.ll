...
block_.L_40b1bf:                                  ; preds = %block_.L_40b211, %entry
  %68 = phi i64 [ %.pre, %entry ], [ %275, %block_.L_40b211 ]
...
block_.L_40b1de:                                  ; preds = %block_40b1ea, %block_40b1cf
  %111 = phi i64 [ %.pre1, %block_40b1cf ], [ %233, %block_40b1ea ]
...
block_.L_40b211:                                  ; preds = %block_.L_40b1de
  ...
  %call2_40b215 = tail call %struct.Memory* @sub_4118e0._Z17check_shifted_sumIl20custom_xor_constantsIlEEvT_(%struct.State* %0, i64 %238, %struct.Memory* %MEMORY.1)
...
block_.L_40b228:                                  ; preds = %block_.L_40b1bf
  ...
  %call2_40b228 = tail call %struct.Memory* @sub_400e60._Z5timerv(%struct.State* %0, i64 %276, %struct.Memory* %MEMORY.0)
  ...
  %call2_40b231 = tail call %struct.Memory* @sub_400800._Z13record_resultdPKc(%struct.State* %0, i64 %287, %struct.Memory* %call2_40b228)
