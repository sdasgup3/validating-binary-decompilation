...
declare %struct.Memory* @sub_411920._Z17check_shifted_sumIl20custom_xor_constantsIlEEvT_(%struct.State* noalias dereferenceable(3376), i64, %struct.Memory* noalias readnone returned) local_unnamed_addr
...
define %struct.Memory* @_Z13test_constantIl20custom_xor_constantsIlEEvPT_iPKc(%struct.State* noalias, i64, %struct.Memory* noalias readnone) local_unnamed_addr #1 {
entry:
...
block_.L_40b1ff:                                  ; preds = %block_.L_40b251, %entry
  %68 = phi i64 [ %273, %block_.L_40b251 ], [ %.pre, %entry ]
...
block_.L_40b21e:                                  ; preds = %block_40b22a, %block_40b20f
  %111 = phi i64 [ %232, %block_40b22a ], [ %.pre6, %block_40b20f ]
...
block_40b22a:                                     ; preds = %block_.L_40b21e
  ...
  %call2_40b236 = tail call %struct.Memory* @sub_411910._ZN20custom_xor_constantsIlE8do_shiftEl(%struct.State* nonnull %0, i64 %161, %struct.Memory* %call2_40b1f3)
...
block_.L_40b251:                                  ; preds = %block_.L_40b21e
  ...
  %call2_40b255 = tail call %struct.Memory* @sub_411920._Z17check_shifted_sumIl20custom_xor_constantsIlEEvT_(%struct.State* nonnull %0, i64 %237, %struct.Memory* %call2_40b1f3)
...
block_.L_40b268:                                  ; preds = %block_.L_40b1ff
  ...
  %call2_40b268 = tail call %struct.Memory* @sub_400ea0._Z5timerv(%struct.State* nonnull %0, i64 %274, %struct.Memory* %call2_40b1f3)
