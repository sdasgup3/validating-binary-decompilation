...
declare %struct.Memory* @sub_411930._Z17check_shifted_sumIl20custom_xor_constantsIlEEvT_(%struct.State* noalias dereferenceable(3376), i64, %struct.Memory* noalias readnone returned) local_unnamed_addr
...
entry:
  ...
  %call2_40b203 = tail call %struct.Memory* @sub_400e90._Z11start_timerv(%struct.State* %0, i64 %58, %struct.Memory* %2)
...
block_.L_40b20f:                                  ; preds = %block_.L_40b261, %entry
  %68 = phi i64 [ %273, %block_.L_40b261 ], [ %.pre, %entry ]
  ...
  br i1 %101, label %block_40b21f, label %block_.L_40b278
...
block_.L_40b22e:                                  ; preds = %block_40b23a, %block_40b21f
  %111 = phi i64 [ %232, %block_40b23a ], [ %.pre6, %block_40b21f ]
  ...
  br i1 %147, label %block_40b23a, label %block_.L_40b261
...
block_40b23a:                                     ; preds = %block_.L_40b22e
  ...
  %call2_40b246 = tail call %struct.Memory* @sub_411920._ZN20custom_xor_constantsIlE8do_shiftEl(%struct.State* nonnull %0, i64 %161, %struct.Memory* %call2_40b203)
...
block_.L_40b261:                                  ; preds = %block_.L_40b22e
  ...
  %call2_40b265 = tail call %struct.Memory* @sub_411930._Z17check_shifted_sumIl20custom_xor_constantsIlEEvT_(%struct.State* nonnull %0, i64 %237, %struct.Memory* %call2_40b203)
...
block_.L_40b278:                                  ; preds = %block_.L_40b20f
  ...
  %call2_40b278 = tail call %struct.Memory* @sub_400eb0._Z5timerv(%struct.State* nonnull %0, i64 %274, %struct.Memory* %call2_40b203)
  ...
  %call2_40b281 = tail call %struct.Memory* @sub_400850._Z13record_resultdPKc(%struct.State* nonnull %0, i64 %285, %struct.Memory* %call2_40b278)
