...
declare %struct.Memory* @sub_411530._Z17check_shifted_sumIl22custom_constant_divideIlEEvT_(%struct.State* noalias dereferenceable(3376), i64, %struct.Memory* noalias readnone returned) local_unnamed_addr
...
entry:
  ...
  %call2_40b703 = tail call %struct.Memory* @sub_400e90._Z11start_timerv(%struct.State* %0, i64 %58, %struct.Memory* %2)
...
block_.L_40b70f:                                  ; preds = %block_.L_40b761, %entry
  %68 = phi i64 [ %273, %block_.L_40b761 ], [ %.pre, %entry ]
  ...
  br i1 %101, label %block_40b71f, label %block_.L_40b778
...
block_.L_40b72e:                                  ; preds = %block_40b73a, %block_40b71f
  %111 = phi i64 [ %232, %block_40b73a ], [ %.pre6, %block_40b71f ]
  ...
  br i1 %147, label %block_40b73a, label %block_.L_40b761
...
block_40b73a:                                     ; preds = %block_.L_40b72e
  ...
  %call2_40b746 = tail call %struct.Memory* @sub_411510._ZN22custom_constant_divideIlE8do_shiftEl(%struct.State* nonnull %0, i64 %161, %struct.Memory* %call2_40b703)
...
block_.L_40b761:                                  ; preds = %block_.L_40b72e
  ...
  %call2_40b765 = tail call %struct.Memory* @sub_411530._Z17check_shifted_sumIl22custom_constant_divideIlEEvT_(%struct.State* nonnull %0, i64 %237, %struct.Memory* %call2_40b703)
...
block_.L_40b778:                                  ; preds = %block_.L_40b70f
  ...
  %call2_40b778 = tail call %struct.Memory* @sub_400eb0._Z5timerv(%struct.State* nonnull %0, i64 %274, %struct.Memory* %call2_40b703)
  ...
  %call2_40b781 = tail call %struct.Memory* @sub_400850._Z13record_resultdPKc(%struct.State* nonnull %0, i64 %285, %struct.Memory* %call2_40b778)
