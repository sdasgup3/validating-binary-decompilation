...
block_.L_40b6bf:                                  ; preds = %block_.L_40b711, %entry
  %68 = phi i64 [ %.pre, %entry ], [ %275, %block_.L_40b711 ]
...
block_.L_40b6de:                                  ; preds = %block_40b6ea, %block_40b6cf
  %111 = phi i64 [ %.pre1, %block_40b6cf ], [ %233, %block_40b6ea ]
...
block_.L_40b711:                                  ; preds = %block_.L_40b6de
  ...
  %call2_40b715 = tail call %struct.Memory* @sub_4114e0._Z17check_shifted_sumIl22custom_constant_divideIlEEvT_(%struct.State* %0, i64 %238, %struct.Memory* %MEMORY.1)
...
block_.L_40b728:                                  ; preds = %block_.L_40b6bf
  ...
  %call2_40b728 = tail call %struct.Memory* @sub_400e60._Z5timerv(%struct.State* %0, i64 %276, %struct.Memory* %MEMORY.0)
  ...
  %call2_40b731 = tail call %struct.Memory* @sub_400800._Z13record_resultdPKc(%struct.State* %0, i64 %287, %struct.Memory* %call2_40b728)
