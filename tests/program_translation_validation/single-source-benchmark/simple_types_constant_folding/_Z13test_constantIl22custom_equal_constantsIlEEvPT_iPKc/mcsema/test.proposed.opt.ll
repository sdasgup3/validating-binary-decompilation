...
declare %struct.Memory* @sub_411c90._ZN22custom_equal_constantsIlE8do_shiftEl(%struct.State* dereferenceable(3376), i64, %struct.Memory*) local_unnamed_addr

declare %struct.Memory* @sub_411ca0._Z17check_shifted_sumIl22custom_equal_constantsIlEEvT_(%struct.State* dereferenceable(3376), i64, %struct.Memory*) local_unnamed_addr
...
block_.L_40acff:                                  ; preds = %block_.L_40ad51, %entry
  %68 = phi i64 [ %.pre, %entry ], [ %273, %block_.L_40ad51 ]
  %MEMORY.0 = phi %struct.Memory* [ %call2_40acf3, %entry ], [ %call2_40ad55, %block_.L_40ad51 ]
...
block_.L_40ad1e:                                  ; preds = %block_40ad2a, %block_40ad0f
  %111 = phi i64 [ %.pre6, %block_40ad0f ], [ %232, %block_40ad2a ]
  %MEMORY.1 = phi %struct.Memory* [ %MEMORY.0, %block_40ad0f ], [ %call2_40ad36, %block_40ad2a ]
...
block_40ad2a:                                     ; preds = %block_.L_40ad1e
  ...
  %call2_40ad36 = tail call %struct.Memory* @sub_411c90._ZN22custom_equal_constantsIlE8do_shiftEl(%struct.State* nonnull %0, i64 %161, %struct.Memory* %MEMORY.1)
...
block_.L_40ad51:                                  ; preds = %block_.L_40ad1e
  ...
  %call2_40ad55 = tail call %struct.Memory* @sub_411ca0._Z17check_shifted_sumIl22custom_equal_constantsIlEEvT_(%struct.State* nonnull %0, i64 %237, %struct.Memory* %MEMORY.1)
...
block_.L_40ad68:                                  ; preds = %block_.L_40acff
  ...
  %call2_40ad68 = tail call %struct.Memory* @sub_400ea0._Z5timerv(%struct.State* nonnull %0, i64 %274, %struct.Memory* %MEMORY.0)
