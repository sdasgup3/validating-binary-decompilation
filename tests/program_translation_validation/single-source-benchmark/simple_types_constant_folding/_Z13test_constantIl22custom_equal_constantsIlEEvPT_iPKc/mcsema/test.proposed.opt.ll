...
block_.L_40acbf:                                  ; preds = %block_.L_40ad11, %entry
  %68 = phi i64 [ %.pre, %entry ], [ %273, %block_.L_40ad11 ]
...
block_.L_40acde:                                  ; preds = %block_40acea, %block_40accf
  %111 = phi i64 [ %.pre1, %block_40accf ], [ %232, %block_40acea ]
...
block_.L_40ad11:                                  ; preds = %block_.L_40acde
  ...
  %call2_40ad15 = tail call %struct.Memory* @sub_411c60._Z17check_shifted_sumIl22custom_equal_constantsIlEEvT_(%struct.State* %0, i64 %237, %struct.Memory* %MEMORY.1)
...
block_.L_40ad28:                                  ; preds = %block_.L_40acbf
  ...
  %call2_40ad28 = tail call %struct.Memory* @sub_400e60._Z5timerv(%struct.State* %0, i64 %274, %struct.Memory* %MEMORY.0)
  ...
  %call2_40ad31 = tail call %struct.Memory* @sub_400800._Z13record_resultdPKc(%struct.State* %0, i64 %285, %struct.Memory* %call2_40ad28)
