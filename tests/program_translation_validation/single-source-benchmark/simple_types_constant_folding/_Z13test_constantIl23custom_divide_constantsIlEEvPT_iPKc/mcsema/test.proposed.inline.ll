...
declare %struct.Memory* @sub_411d80._Z17check_shifted_sumIl23custom_divide_constantsIlEEvT_(%struct.State* dereferenceable(3376), i64, %struct.Memory*)
...
define %struct.Memory* @_Z13test_constantIl23custom_divide_constantsIlEEvPT_iPKc(%struct.State* noalias, i64, %struct.Memory* noalias) #1 {
entry:
