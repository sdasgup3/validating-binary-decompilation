...
declare %struct.Memory* @sub_411d80._Z17check_shifted_sumIl23custom_divide_constantsIlEEvT_(%struct.State* noalias dereferenceable(3376), i64, %struct.Memory* noalias readnone returned) local_unnamed_addr
...
block_.L_40abbf:                                  ; preds = %block_.L_40ac11, %entry
  %68 = phi i64 [ %273, %block_.L_40ac11 ], [ %.pre, %entry ]
...
block_.L_40abde:                                  ; preds = %block_40abea, %block_40abcf
  %111 = phi i64 [ %232, %block_40abea ], [ %.pre6, %block_40abcf ]
...
block_40abea:                                     ; preds = %block_.L_40abde
  ...
  %call2_40abf6 = tail call %struct.Memory* @sub_411d70._ZN23custom_divide_constantsIlE8do_shiftEl(%struct.State* nonnull %0, i64 %161, %struct.Memory* %call2_40abb3)
...
block_.L_40ac11:                                  ; preds = %block_.L_40abde
  ...
  %call2_40ac15 = tail call %struct.Memory* @sub_411d80._Z17check_shifted_sumIl23custom_divide_constantsIlEEvT_(%struct.State* nonnull %0, i64 %237, %struct.Memory* %call2_40abb3)
...
block_.L_40ac28:                                  ; preds = %block_.L_40abbf
  ...
  %call2_40ac28 = tail call %struct.Memory* @sub_400ea0._Z5timerv(%struct.State* nonnull %0, i64 %274, %struct.Memory* %call2_40abb3)
