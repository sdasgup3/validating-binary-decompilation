...
block_.L_40ab7f:                                  ; preds = %block_.L_40abd1, %entry
  %68 = phi i64 [ %.pre, %entry ], [ %273, %block_.L_40abd1 ]
...
block_.L_40ab9e:                                  ; preds = %block_40abaa, %block_40ab8f
  %111 = phi i64 [ %.pre1, %block_40ab8f ], [ %232, %block_40abaa ]
...
block_.L_40abd1:                                  ; preds = %block_.L_40ab9e
  ...
  %call2_40abd5 = tail call %struct.Memory* @sub_411d40._Z17check_shifted_sumIl23custom_divide_constantsIlEEvT_(%struct.State* %0, i64 %237, %struct.Memory* %MEMORY.1)
...
block_.L_40abe8:                                  ; preds = %block_.L_40ab7f
  ...
  %call2_40abe8 = tail call %struct.Memory* @sub_400e60._Z5timerv(%struct.State* %0, i64 %274, %struct.Memory* %MEMORY.0)
  ...
  %call2_40abf1 = tail call %struct.Memory* @sub_400800._Z13record_resultdPKc(%struct.State* %0, i64 %285, %struct.Memory* %call2_40abe8)
