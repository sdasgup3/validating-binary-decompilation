...
declare %struct.Memory* @sub_411d40._Z17check_shifted_sumIl23custom_divide_constantsIlEEvT_(%struct.State* noalias dereferenceable(3376), i64, %struct.Memory* noalias readnone returned) local_unnamed_addr
...
entry:
  ...
  %call2_40ab73 = tail call %struct.Memory* @sub_400e40._Z11start_timerv(%struct.State* %0, i64 %58, %struct.Memory* %2)
...
block_.L_40ab7f:                                  ; preds = %block_.L_40abd1, %entry
  %68 = phi i64 [ %.pre, %entry ], [ %275, %block_.L_40abd1 ]
  %MEMORY.0 = phi %struct.Memory* [ %call2_40ab73, %entry ], [ %call2_40abd5, %block_.L_40abd1 ]
  ...
  br i1 %101, label %block_40ab8f, label %block_.L_40abe8
...
block_.L_40ab9e:                                  ; preds = %block_40abaa, %block_40ab8f
  %111 = phi i64 [ %.pre1, %block_40ab8f ], [ %233, %block_40abaa ]
  %MEMORY.1 = phi %struct.Memory* [ %MEMORY.0, %block_40ab8f ], [ %call2_40abb6, %block_40abaa ]
  ...
  br i1 %147, label %block_40abaa, label %block_.L_40abd1
...
block_40abaa:                                     ; preds = %block_.L_40ab9e
  ...
  %call2_40abb6 = tail call %struct.Memory* @sub_411d30._ZN23custom_divide_constantsIlE8do_shiftEl(%struct.State* %0, i64 %161, %struct.Memory* %MEMORY.1)
...
block_.L_40abd1:                                  ; preds = %block_.L_40ab9e
  ...
  %call2_40abd5 = tail call %struct.Memory* @sub_411d40._Z17check_shifted_sumIl23custom_divide_constantsIlEEvT_(%struct.State* %0, i64 %238, %struct.Memory* %MEMORY.1)
...
block_.L_40abe8:                                  ; preds = %block_.L_40ab7f
  ...
  %call2_40abe8 = tail call %struct.Memory* @sub_400e60._Z5timerv(%struct.State* %0, i64 %276, %struct.Memory* %MEMORY.0)
  ...
  %call2_40abf1 = tail call %struct.Memory* @sub_400800._Z13record_resultdPKc(%struct.State* %0, i64 %287, %struct.Memory* %call2_40abe8)
  ...
  ret %struct.Memory* %call2_40abf1
}
...
define %struct.Memory* @routine_jge_.L_40abe8(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i8* %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
...
define %struct.Memory* @routine_jge_.L_40abd1(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i8* %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 2, i32 9
...
define %struct.Memory* @routine_jmpq_.L_40ab9e(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
...
define %struct.Memory* @routine_callq_._Z17check_shifted_sumIl23custom_divide_constantsIlEEvT_(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
...
define %struct.Memory* @routine_jmpq_.L_40ab7f(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
