...
declare %struct.Memory* @sub_411690._Z17check_shifted_sumIl24custom_constant_multiplyIlEEvT_(%struct.State* dereferenceable(3376), i64, %struct.Memory*)
...
define %struct.Memory* @_Z13test_constantIl24custom_constant_multiplyIlEEvPT_iPKc(%struct.State* noalias, i64, %struct.Memory* noalias) #1 {
entry:
