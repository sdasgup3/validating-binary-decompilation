...
declare %struct.Memory* @sub_411680._ZN24custom_constant_multiplyIlE8do_shiftEl(%struct.State* dereferenceable(3376), i64, %struct.Memory*) local_unnamed_addr

declare %struct.Memory* @sub_411690._Z17check_shifted_sumIl24custom_constant_multiplyIlEEvT_(%struct.State* dereferenceable(3376), i64, %struct.Memory*) local_unnamed_addr
...
block_.L_40b51f:                                  ; preds = %block_.L_40b571, %entry
  %68 = phi i64 [ %.pre, %entry ], [ %273, %block_.L_40b571 ]
  %MEMORY.0 = phi %struct.Memory* [ %call2_40b513, %entry ], [ %call2_40b575, %block_.L_40b571 ]
...
block_.L_40b53e:                                  ; preds = %block_40b54a, %block_40b52f
  %111 = phi i64 [ %.pre6, %block_40b52f ], [ %232, %block_40b54a ]
  %MEMORY.1 = phi %struct.Memory* [ %MEMORY.0, %block_40b52f ], [ %call2_40b556, %block_40b54a ]
...
block_40b54a:                                     ; preds = %block_.L_40b53e
  ...
  %call2_40b556 = tail call %struct.Memory* @sub_411680._ZN24custom_constant_multiplyIlE8do_shiftEl(%struct.State* nonnull %0, i64 %161, %struct.Memory* %MEMORY.1)
...
block_.L_40b571:                                  ; preds = %block_.L_40b53e
  ...
  %call2_40b575 = tail call %struct.Memory* @sub_411690._Z17check_shifted_sumIl24custom_constant_multiplyIlEEvT_(%struct.State* nonnull %0, i64 %237, %struct.Memory* %MEMORY.1)
...
block_.L_40b588:                                  ; preds = %block_.L_40b51f
  ...
  %call2_40b588 = tail call %struct.Memory* @sub_400ea0._Z5timerv(%struct.State* nonnull %0, i64 %274, %struct.Memory* %MEMORY.0)
