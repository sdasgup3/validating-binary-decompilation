...
block_.L_40b4df:                                  ; preds = %block_.L_40b531, %entry
  %68 = phi i64 [ %.pre, %entry ], [ %273, %block_.L_40b531 ]
...
block_.L_40b4fe:                                  ; preds = %block_40b50a, %block_40b4ef
  %111 = phi i64 [ %.pre1, %block_40b4ef ], [ %232, %block_40b50a ]
...
block_.L_40b531:                                  ; preds = %block_.L_40b4fe
  ...
  %call2_40b535 = tail call %struct.Memory* @sub_411650._Z17check_shifted_sumIl24custom_constant_multiplyIlEEvT_(%struct.State* %0, i64 %237, %struct.Memory* %MEMORY.1)
...
block_.L_40b548:                                  ; preds = %block_.L_40b4df
  ...
  %call2_40b548 = tail call %struct.Memory* @sub_400e60._Z5timerv(%struct.State* %0, i64 %274, %struct.Memory* %MEMORY.0)
  ...
  %call2_40b551 = tail call %struct.Memory* @sub_400800._Z13record_resultdPKc(%struct.State* %0, i64 %285, %struct.Memory* %call2_40b548)
