...
declare %struct.Memory* @sub_411b40._ZN25custom_lessthan_constantsIlE8do_shiftEl(%struct.State* noalias dereferenceable(3376), i64, %struct.Memory* noalias readnone returned) local_unnamed_addr

declare %struct.Memory* @sub_411b50._Z17check_shifted_sumIl25custom_lessthan_constantsIlEEvT_(%struct.State* noalias dereferenceable(3376), i64, %struct.Memory* noalias readnone returned) local_unnamed_addr
...
define %struct.Memory* @_Z13test_constantIl25custom_lessthan_constantsIlEEvPT_iPKc(%struct.State* noalias, i64, %struct.Memory* noalias readnone) local_unnamed_addr #1 {
entry:
...
block_.L_40aedf:                                  ; preds = %block_.L_40af31, %entry
  %68 = phi i64 [ %273, %block_.L_40af31 ], [ %.pre, %entry ]
...
block_.L_40aefe:                                  ; preds = %block_40af0a, %block_40aeef
  %111 = phi i64 [ %232, %block_40af0a ], [ %.pre6, %block_40aeef ]
...
block_40af0a:                                     ; preds = %block_.L_40aefe
  ...
  %call2_40af16 = tail call %struct.Memory* @sub_411b40._ZN25custom_lessthan_constantsIlE8do_shiftEl(%struct.State* nonnull %0, i64 %161, %struct.Memory* %call2_40aed3)
...
block_.L_40af31:                                  ; preds = %block_.L_40aefe
  ...
  %call2_40af35 = tail call %struct.Memory* @sub_411b50._Z17check_shifted_sumIl25custom_lessthan_constantsIlEEvT_(%struct.State* nonnull %0, i64 %237, %struct.Memory* %call2_40aed3)
...
block_.L_40af48:                                  ; preds = %block_.L_40aedf
  ...
  %call2_40af48 = tail call %struct.Memory* @sub_400ea0._Z5timerv(%struct.State* nonnull %0, i64 %274, %struct.Memory* %call2_40aed3)
