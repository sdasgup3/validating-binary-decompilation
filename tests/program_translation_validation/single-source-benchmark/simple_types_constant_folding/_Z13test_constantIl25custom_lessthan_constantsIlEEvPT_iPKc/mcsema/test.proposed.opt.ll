...
block_.L_40ae9f:                                  ; preds = %block_.L_40aef1, %entry
  %68 = phi i64 [ %.pre, %entry ], [ %273, %block_.L_40aef1 ]
...
block_.L_40aebe:                                  ; preds = %block_40aeca, %block_40aeaf
  %111 = phi i64 [ %.pre1, %block_40aeaf ], [ %232, %block_40aeca ]
...
block_.L_40aef1:                                  ; preds = %block_.L_40aebe
  ...
  %call2_40aef5 = tail call %struct.Memory* @sub_411b10._Z17check_shifted_sumIl25custom_lessthan_constantsIlEEvT_(%struct.State* %0, i64 %237, %struct.Memory* %MEMORY.1)
...
block_.L_40af08:                                  ; preds = %block_.L_40ae9f
  ...
  %call2_40af08 = tail call %struct.Memory* @sub_400e60._Z5timerv(%struct.State* %0, i64 %274, %struct.Memory* %MEMORY.0)
  ...
  %call2_40af11 = tail call %struct.Memory* @sub_400800._Z13record_resultdPKc(%struct.State* %0, i64 %285, %struct.Memory* %call2_40af08)
