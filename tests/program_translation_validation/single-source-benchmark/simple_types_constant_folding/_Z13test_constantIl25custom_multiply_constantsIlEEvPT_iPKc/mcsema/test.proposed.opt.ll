...
declare %struct.Memory* @sub_411df0._Z17check_shifted_sumIl25custom_multiply_constantsIlEEvT_(%struct.State* noalias dereferenceable(3376), i64, %struct.Memory* noalias readnone returned) local_unnamed_addr
...
block_.L_40ab1f:                                  ; preds = %block_.L_40ab71, %entry
  %68 = phi i64 [ %273, %block_.L_40ab71 ], [ %.pre, %entry ]
...
block_.L_40ab3e:                                  ; preds = %block_40ab4a, %block_40ab2f
  %111 = phi i64 [ %232, %block_40ab4a ], [ %.pre6, %block_40ab2f ]
...
block_40ab4a:                                     ; preds = %block_.L_40ab3e
  ...
  %call2_40ab56 = tail call %struct.Memory* @sub_411de0._ZN25custom_multiply_constantsIlE8do_shiftEl(%struct.State* nonnull %0, i64 %161, %struct.Memory* %call2_40ab13)
...
block_.L_40ab71:                                  ; preds = %block_.L_40ab3e
  ...
  %call2_40ab75 = tail call %struct.Memory* @sub_411df0._Z17check_shifted_sumIl25custom_multiply_constantsIlEEvT_(%struct.State* nonnull %0, i64 %237, %struct.Memory* %call2_40ab13)
...
block_.L_40ab88:                                  ; preds = %block_.L_40ab1f
  ...
  %call2_40ab88 = tail call %struct.Memory* @sub_400ea0._Z5timerv(%struct.State* nonnull %0, i64 %274, %struct.Memory* %call2_40ab13)
