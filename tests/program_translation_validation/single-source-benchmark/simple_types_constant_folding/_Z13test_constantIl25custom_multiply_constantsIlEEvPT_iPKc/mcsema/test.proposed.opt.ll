...
block_.L_40aadf:                                  ; preds = %block_.L_40ab31, %entry
  %68 = phi i64 [ %.pre, %entry ], [ %273, %block_.L_40ab31 ]
...
block_.L_40aafe:                                  ; preds = %block_40ab0a, %block_40aaef
  %111 = phi i64 [ %.pre1, %block_40aaef ], [ %232, %block_40ab0a ]
...
block_.L_40ab31:                                  ; preds = %block_.L_40aafe
  ...
  %call2_40ab35 = tail call %struct.Memory* @sub_411db0._Z17check_shifted_sumIl25custom_multiply_constantsIlEEvT_(%struct.State* %0, i64 %237, %struct.Memory* %MEMORY.1)
...
block_.L_40ab48:                                  ; preds = %block_.L_40aadf
  ...
  %call2_40ab48 = tail call %struct.Memory* @sub_400e60._Z5timerv(%struct.State* %0, i64 %274, %struct.Memory* %MEMORY.0)
  ...
  %call2_40ab51 = tail call %struct.Memory* @sub_400800._Z13record_resultdPKc(%struct.State* %0, i64 %285, %struct.Memory* %call2_40ab48)
