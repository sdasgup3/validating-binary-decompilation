...
declare %struct.Memory* @sub_411db0._Z17check_shifted_sumIl25custom_multiply_constantsIlEEvT_(%struct.State* noalias dereferenceable(3376), i64, %struct.Memory* noalias readnone returned) local_unnamed_addr
...
entry:
  ...
  %call2_40aad3 = tail call %struct.Memory* @sub_400e40._Z11start_timerv(%struct.State* %0, i64 %58, %struct.Memory* %2)
...
block_.L_40aadf:                                  ; preds = %block_.L_40ab31, %entry
  %68 = phi i64 [ %.pre, %entry ], [ %275, %block_.L_40ab31 ]
  %MEMORY.0 = phi %struct.Memory* [ %call2_40aad3, %entry ], [ %call2_40ab35, %block_.L_40ab31 ]
  ...
  br i1 %101, label %block_40aaef, label %block_.L_40ab48

block_40aaef:                                     ; preds = %block_.L_40aadf
  %103 = add i64 %69, -40
  %104 = add i64 %102, 8
...
block_.L_40aafe:                                  ; preds = %block_40ab0a, %block_40aaef
  %111 = phi i64 [ %.pre1, %block_40aaef ], [ %233, %block_40ab0a ]
  %MEMORY.1 = phi %struct.Memory* [ %MEMORY.0, %block_40aaef ], [ %call2_40ab16, %block_40ab0a ]
  ...
  br i1 %147, label %block_40ab0a, label %block_.L_40ab31

block_40ab0a:                                     ; preds = %block_.L_40aafe
  %149 = add i64 %112, -8
  %150 = add i64 %148, 4
  ...
  %call2_40ab16 = tail call %struct.Memory* @sub_411da0._ZN25custom_multiply_constantsIlE8do_shiftEl(%struct.State* %0, i64 %161, %struct.Memory* %MEMORY.1)
...
block_.L_40ab31:                                  ; preds = %block_.L_40aafe
  %234 = add i64 %112, -40
  %235 = add i64 %148, 4
  ...
  %call2_40ab35 = tail call %struct.Memory* @sub_411db0._Z17check_shifted_sumIl25custom_multiply_constantsIlEEvT_(%struct.State* %0, i64 %238, %struct.Memory* %MEMORY.1)
...
block_.L_40ab48:                                  ; preds = %block_.L_40aadf
  %276 = add i64 %102, -40168
  %277 = add i64 %102, 5
  ...
  %call2_40ab48 = tail call %struct.Memory* @sub_400e60._Z5timerv(%struct.State* %0, i64 %276, %struct.Memory* %MEMORY.0)
  ...
  %call2_40ab51 = tail call %struct.Memory* @sub_400800._Z13record_resultdPKc(%struct.State* %0, i64 %287, %struct.Memory* %call2_40ab48)
  ...
  ret %struct.Memory* %call2_40ab51
}
...
define %struct.Memory* @routine_jge_.L_40ab48(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i8* %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
...
define %struct.Memory* @routine_jge_.L_40ab31(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i8* %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 2, i32 9
...
define %struct.Memory* @routine_jmpq_.L_40aafe(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
...
define %struct.Memory* @routine_callq_._Z17check_shifted_sumIl25custom_multiply_constantsIlEEvT_(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
...
define %struct.Memory* @routine_jmpq_.L_40aadf(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
