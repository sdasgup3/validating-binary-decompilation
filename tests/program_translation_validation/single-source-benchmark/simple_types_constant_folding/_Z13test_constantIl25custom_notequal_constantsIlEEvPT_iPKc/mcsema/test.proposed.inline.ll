...
define %struct.Memory* @_Z13test_constantIl25custom_notequal_constantsIlEEvPT_iPKc(%struct.State* noalias, i64, %struct.Memory* noalias) #1 {
entry:
  ...
  store i32 %93, i32* %97
  store %struct.Memory* %loadMem_40ad8c, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_40ad8f, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem1_40ad93, %struct.Memory** %MEMORY
...
block_.L_40ad9f:                                  ; preds = %block_.L_40adf1, %entry
  ...
  store %struct.Memory* %loadMem_40ada9, %struct.Memory** %MEMORY
...
block_40adaf:                                     ; preds = %block_.L_40ad9f
  ...
  store i32 0, i32* %236
  store %struct.Memory* %loadMem_40adb7, %struct.Memory** %MEMORY
...
block_40adca:                                     ; preds = %block_.L_40adbe
  ...
  store %struct.Memory* %loadMem1_40add6, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_40ade3, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_40ade9, %struct.Memory** %MEMORY
