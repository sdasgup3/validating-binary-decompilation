...
block_.L_40ad5f:                                  ; preds = %block_.L_40adb1, %entry
  %68 = phi i64 [ %.pre, %entry ], [ %273, %block_.L_40adb1 ]
...
block_.L_40ad7e:                                  ; preds = %block_40ad8a, %block_40ad6f
  %111 = phi i64 [ %.pre1, %block_40ad6f ], [ %232, %block_40ad8a ]
...
block_.L_40adb1:                                  ; preds = %block_.L_40ad7e
  ...
  %call2_40adb5 = tail call %struct.Memory* @sub_411bf0._Z17check_shifted_sumIl25custom_notequal_constantsIlEEvT_(%struct.State* %0, i64 %237, %struct.Memory* %MEMORY.1)
...
block_.L_40adc8:                                  ; preds = %block_.L_40ad5f
  ...
  %call2_40adc8 = tail call %struct.Memory* @sub_400e60._Z5timerv(%struct.State* %0, i64 %274, %struct.Memory* %MEMORY.0)
  ...
  %call2_40add1 = tail call %struct.Memory* @sub_400800._Z13record_resultdPKc(%struct.State* %0, i64 %285, %struct.Memory* %call2_40adc8)
