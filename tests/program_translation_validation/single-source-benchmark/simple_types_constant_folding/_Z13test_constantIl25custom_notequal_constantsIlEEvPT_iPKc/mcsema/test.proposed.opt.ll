...
declare %struct.Memory* @sub_411c20._ZN25custom_notequal_constantsIlE8do_shiftEl(%struct.State* dereferenceable(3376), i64, %struct.Memory*) local_unnamed_addr

declare %struct.Memory* @sub_411c30._Z17check_shifted_sumIl25custom_notequal_constantsIlEEvT_(%struct.State* dereferenceable(3376), i64, %struct.Memory*) local_unnamed_addr
...
block_.L_40ad9f:                                  ; preds = %block_.L_40adf1, %entry
  %68 = phi i64 [ %.pre, %entry ], [ %273, %block_.L_40adf1 ]
  %MEMORY.0 = phi %struct.Memory* [ %call2_40ad93, %entry ], [ %call2_40adf5, %block_.L_40adf1 ]
...
block_.L_40adbe:                                  ; preds = %block_40adca, %block_40adaf
  %111 = phi i64 [ %.pre6, %block_40adaf ], [ %232, %block_40adca ]
  %MEMORY.1 = phi %struct.Memory* [ %MEMORY.0, %block_40adaf ], [ %call2_40add6, %block_40adca ]
...
block_40adca:                                     ; preds = %block_.L_40adbe
  ...
  %call2_40add6 = tail call %struct.Memory* @sub_411c20._ZN25custom_notequal_constantsIlE8do_shiftEl(%struct.State* nonnull %0, i64 %161, %struct.Memory* %MEMORY.1)
...
block_.L_40adf1:                                  ; preds = %block_.L_40adbe
  ...
  %call2_40adf5 = tail call %struct.Memory* @sub_411c30._Z17check_shifted_sumIl25custom_notequal_constantsIlEEvT_(%struct.State* nonnull %0, i64 %237, %struct.Memory* %MEMORY.1)
...
block_.L_40ae08:                                  ; preds = %block_.L_40ad9f
  ...
  %call2_40ae08 = tail call %struct.Memory* @sub_400ea0._Z5timerv(%struct.State* nonnull %0, i64 %274, %struct.Memory* %MEMORY.0)
