...
declare %struct.Memory* @sub_411130._ZN27custom_multiple_constant_orIlE8do_shiftEl(%struct.State* dereferenceable(3376), i64, %struct.Memory*)

declare %struct.Memory* @sub_411160._Z17check_shifted_sumIl27custom_multiple_constant_orIlEEvT_(%struct.State* dereferenceable(3376), i64, %struct.Memory*)
...
define %struct.Memory* @_Z13test_constantIl27custom_multiple_constant_orIlEEvPT_iPKc(%struct.State* noalias, i64, %struct.Memory* noalias) #1 {
entry:
