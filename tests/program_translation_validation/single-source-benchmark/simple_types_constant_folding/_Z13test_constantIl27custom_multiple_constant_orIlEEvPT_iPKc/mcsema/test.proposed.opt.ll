...
block_.L_40bb1f:                                  ; preds = %block_.L_40bb71, %entry
  %68 = phi i64 [ %.pre, %entry ], [ %273, %block_.L_40bb71 ]
...
block_.L_40bb3e:                                  ; preds = %block_40bb4a, %block_40bb2f
  %111 = phi i64 [ %.pre1, %block_40bb2f ], [ %232, %block_40bb4a ]
...
block_.L_40bb71:                                  ; preds = %block_.L_40bb3e
  ...
  %call2_40bb75 = tail call %struct.Memory* @sub_411120._Z17check_shifted_sumIl27custom_multiple_constant_orIlEEvT_(%struct.State* %0, i64 %237, %struct.Memory* %MEMORY.1)
...
block_.L_40bb88:                                  ; preds = %block_.L_40bb1f
  ...
  %call2_40bb88 = tail call %struct.Memory* @sub_400e60._Z5timerv(%struct.State* %0, i64 %274, %struct.Memory* %MEMORY.0)
  ...
  %call2_40bb91 = tail call %struct.Memory* @sub_400800._Z13record_resultdPKc(%struct.State* %0, i64 %285, %struct.Memory* %call2_40bb88)
