...
declare %struct.Memory* @sub_411160._Z17check_shifted_sumIl27custom_multiple_constant_orIlEEvT_(%struct.State* noalias dereferenceable(3376), i64, %struct.Memory* noalias readnone returned) local_unnamed_addr
...
define %struct.Memory* @_Z13test_constantIl27custom_multiple_constant_orIlEEvPT_iPKc(%struct.State* noalias, i64, %struct.Memory* noalias readnone) local_unnamed_addr #1 {
entry:
...
block_.L_40bb5f:                                  ; preds = %block_.L_40bbb1, %entry
  %68 = phi i64 [ %273, %block_.L_40bbb1 ], [ %.pre, %entry ]
...
block_.L_40bb7e:                                  ; preds = %block_40bb8a, %block_40bb6f
  %111 = phi i64 [ %232, %block_40bb8a ], [ %.pre6, %block_40bb6f ]
...
block_40bb8a:                                     ; preds = %block_.L_40bb7e
  ...
  %call2_40bb96 = tail call %struct.Memory* @sub_411130._ZN27custom_multiple_constant_orIlE8do_shiftEl(%struct.State* nonnull %0, i64 %161, %struct.Memory* %call2_40bb53)
...
block_.L_40bbb1:                                  ; preds = %block_.L_40bb7e
  ...
  %call2_40bbb5 = tail call %struct.Memory* @sub_411160._Z17check_shifted_sumIl27custom_multiple_constant_orIlEEvT_(%struct.State* nonnull %0, i64 %237, %struct.Memory* %call2_40bb53)
...
block_.L_40bbc8:                                  ; preds = %block_.L_40bb5f
  ...
  %call2_40bbc8 = tail call %struct.Memory* @sub_400ea0._Z5timerv(%struct.State* nonnull %0, i64 %274, %struct.Memory* %call2_40bb53)
