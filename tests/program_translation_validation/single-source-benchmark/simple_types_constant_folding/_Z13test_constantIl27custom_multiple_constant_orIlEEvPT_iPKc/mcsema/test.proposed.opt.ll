...
declare %struct.Memory* @sub_411160._Z17check_shifted_sumIl27custom_multiple_constant_orIlEEvT_(%struct.State* dereferenceable(3376), i64, %struct.Memory*) local_unnamed_addr
...
entry:
  ...
  %call2_40bb53 = tail call %struct.Memory* @sub_400e80._Z11start_timerv(%struct.State* %0, i64 %58, %struct.Memory* %2)
...
block_.L_40bb5f:                                  ; preds = %block_.L_40bbb1, %entry
  %68 = phi i64 [ %.pre, %entry ], [ %273, %block_.L_40bbb1 ]
  %MEMORY.0 = phi %struct.Memory* [ %call2_40bb53, %entry ], [ %call2_40bbb5, %block_.L_40bbb1 ]
  ...
  br i1 %101, label %block_40bb6f, label %block_.L_40bbc8
...
block_.L_40bb7e:                                  ; preds = %block_40bb8a, %block_40bb6f
  %111 = phi i64 [ %.pre6, %block_40bb6f ], [ %232, %block_40bb8a ]
  %MEMORY.1 = phi %struct.Memory* [ %MEMORY.0, %block_40bb6f ], [ %call2_40bb96, %block_40bb8a ]
  ...
  br i1 %147, label %block_40bb8a, label %block_.L_40bbb1
...
block_40bb8a:                                     ; preds = %block_.L_40bb7e
  ...
  %call2_40bb96 = tail call %struct.Memory* @sub_411130._ZN27custom_multiple_constant_orIlE8do_shiftEl(%struct.State* nonnull %0, i64 %161, %struct.Memory* %MEMORY.1)
...
block_.L_40bbb1:                                  ; preds = %block_.L_40bb7e
  ...
  %call2_40bbb5 = tail call %struct.Memory* @sub_411160._Z17check_shifted_sumIl27custom_multiple_constant_orIlEEvT_(%struct.State* nonnull %0, i64 %237, %struct.Memory* %MEMORY.1)
...
block_.L_40bbc8:                                  ; preds = %block_.L_40bb5f
  ...
  %call2_40bbc8 = tail call %struct.Memory* @sub_400ea0._Z5timerv(%struct.State* nonnull %0, i64 %274, %struct.Memory* %MEMORY.0)
  ...
  %call2_40bbd1 = tail call %struct.Memory* @sub_400840._Z13record_resultdPKc(%struct.State* nonnull %0, i64 %285, %struct.Memory* %call2_40bbc8)
  ...
  ret %struct.Memory* %call2_40bbd1
}
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_jge_.L_40bbc8(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i8* nocapture %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_jge_.L_40bbb1(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i8* nocapture %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 2, i32 9
