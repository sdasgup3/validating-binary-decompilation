...
declare %struct.Memory* @sub_411170._Z17check_shifted_sumIl27custom_multiple_constant_orIlEEvT_(%struct.State* noalias dereferenceable(3376), i64, %struct.Memory* noalias readnone returned) local_unnamed_addr
...
entry:
  ...
  %call2_40bb63 = tail call %struct.Memory* @sub_400e90._Z11start_timerv(%struct.State* %0, i64 %58, %struct.Memory* %2)
...
block_.L_40bb6f:                                  ; preds = %block_.L_40bbc1, %entry
  %68 = phi i64 [ %273, %block_.L_40bbc1 ], [ %.pre, %entry ]
  ...
  br i1 %101, label %block_40bb7f, label %block_.L_40bbd8
...
block_.L_40bb8e:                                  ; preds = %block_40bb9a, %block_40bb7f
  %111 = phi i64 [ %232, %block_40bb9a ], [ %.pre6, %block_40bb7f ]
  ...
  br i1 %147, label %block_40bb9a, label %block_.L_40bbc1
...
block_40bb9a:                                     ; preds = %block_.L_40bb8e
  ...
  %call2_40bba6 = tail call %struct.Memory* @sub_411140._ZN27custom_multiple_constant_orIlE8do_shiftEl(%struct.State* nonnull %0, i64 %161, %struct.Memory* %call2_40bb63)
...
block_.L_40bbc1:                                  ; preds = %block_.L_40bb8e
  ...
  %call2_40bbc5 = tail call %struct.Memory* @sub_411170._Z17check_shifted_sumIl27custom_multiple_constant_orIlEEvT_(%struct.State* nonnull %0, i64 %237, %struct.Memory* %call2_40bb63)
...
block_.L_40bbd8:                                  ; preds = %block_.L_40bb6f
  ...
  %call2_40bbd8 = tail call %struct.Memory* @sub_400eb0._Z5timerv(%struct.State* nonnull %0, i64 %274, %struct.Memory* %call2_40bb63)
  ...
  %call2_40bbe1 = tail call %struct.Memory* @sub_400850._Z13record_resultdPKc(%struct.State* nonnull %0, i64 %285, %struct.Memory* %call2_40bbd8)
