...
declare %struct.Memory* @sub_411120._Z17check_shifted_sumIl27custom_multiple_constant_orIlEEvT_(%struct.State* noalias dereferenceable(3376), i64, %struct.Memory* noalias readnone returned) local_unnamed_addr
...
define %struct.Memory* @_Z13test_constantIl27custom_multiple_constant_orIlEEvPT_iPKc(%struct.State* noalias, i64, %struct.Memory* noalias) local_unnamed_addr #1 {
entry:
  ...
  %call2_40bb13 = tail call %struct.Memory* @sub_400e40._Z11start_timerv(%struct.State* %0, i64 %58, %struct.Memory* %2)
...
block_.L_40bb1f:                                  ; preds = %block_.L_40bb71, %entry
  %68 = phi i64 [ %.pre, %entry ], [ %275, %block_.L_40bb71 ]
  %MEMORY.0 = phi %struct.Memory* [ %call2_40bb13, %entry ], [ %call2_40bb75, %block_.L_40bb71 ]
  ...
  br i1 %101, label %block_40bb2f, label %block_.L_40bb88
...
block_.L_40bb3e:                                  ; preds = %block_40bb4a, %block_40bb2f
  %111 = phi i64 [ %.pre1, %block_40bb2f ], [ %233, %block_40bb4a ]
  %MEMORY.1 = phi %struct.Memory* [ %MEMORY.0, %block_40bb2f ], [ %call2_40bb56, %block_40bb4a ]
  ...
  br i1 %147, label %block_40bb4a, label %block_.L_40bb71
...
block_40bb4a:                                     ; preds = %block_.L_40bb3e
  ...
  %call2_40bb56 = tail call %struct.Memory* @sub_4110f0._ZN27custom_multiple_constant_orIlE8do_shiftEl(%struct.State* %0, i64 %161, %struct.Memory* %MEMORY.1)
...
block_.L_40bb71:                                  ; preds = %block_.L_40bb3e
  ...
  %call2_40bb75 = tail call %struct.Memory* @sub_411120._Z17check_shifted_sumIl27custom_multiple_constant_orIlEEvT_(%struct.State* %0, i64 %238, %struct.Memory* %MEMORY.1)
...
block_.L_40bb88:                                  ; preds = %block_.L_40bb1f
  ...
  %call2_40bb88 = tail call %struct.Memory* @sub_400e60._Z5timerv(%struct.State* %0, i64 %276, %struct.Memory* %MEMORY.0)
  ...
  %call2_40bb91 = tail call %struct.Memory* @sub_400800._Z13record_resultdPKc(%struct.State* %0, i64 %287, %struct.Memory* %call2_40bb88)
  ...
  ret %struct.Memory* %call2_40bb91
}
...
define %struct.Memory* @routine_jge_.L_40bb88(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i8* %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
...
define %struct.Memory* @routine_jge_.L_40bb71(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i8* %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 2, i32 9
...
define %struct.Memory* @routine_callq_._Z17check_shifted_sumIl27custom_multiple_constant_orIlEEvT_(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
