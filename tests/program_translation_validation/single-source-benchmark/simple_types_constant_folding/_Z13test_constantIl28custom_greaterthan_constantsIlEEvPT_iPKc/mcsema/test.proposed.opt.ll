...
block_.L_40adff:                                  ; preds = %block_.L_40ae51, %entry
  %68 = phi i64 [ %.pre, %entry ], [ %275, %block_.L_40ae51 ]
...
block_.L_40ae1e:                                  ; preds = %block_40ae2a, %block_40ae0f
  %111 = phi i64 [ %.pre1, %block_40ae0f ], [ %233, %block_40ae2a ]
...
block_.L_40ae51:                                  ; preds = %block_.L_40ae1e
  ...
  %call2_40ae55 = tail call %struct.Memory* @sub_411b80._Z17check_shifted_sumIl28custom_greaterthan_constantsIlEEvT_(%struct.State* %0, i64 %238, %struct.Memory* %MEMORY.1)
...
block_.L_40ae68:                                  ; preds = %block_.L_40adff
  ...
  %call2_40ae68 = tail call %struct.Memory* @sub_400e60._Z5timerv(%struct.State* %0, i64 %276, %struct.Memory* %MEMORY.0)
  ...
  %call2_40ae71 = tail call %struct.Memory* @sub_400800._Z13record_resultdPKc(%struct.State* %0, i64 %287, %struct.Memory* %call2_40ae68)
