...
declare %struct.Memory* @sub_411bd0._Z17check_shifted_sumIl28custom_greaterthan_constantsIlEEvT_(%struct.State* noalias dereferenceable(3376), i64, %struct.Memory* noalias readnone returned) local_unnamed_addr
...
entry:
  ...
  %call2_40ae43 = tail call %struct.Memory* @sub_400e90._Z11start_timerv(%struct.State* %0, i64 %58, %struct.Memory* %2)
...
block_.L_40ae4f:                                  ; preds = %block_.L_40aea1, %entry
  %68 = phi i64 [ %273, %block_.L_40aea1 ], [ %.pre, %entry ]
  ...
  br i1 %101, label %block_40ae5f, label %block_.L_40aeb8
...
block_.L_40ae6e:                                  ; preds = %block_40ae7a, %block_40ae5f
  %111 = phi i64 [ %232, %block_40ae7a ], [ %.pre6, %block_40ae5f ]
  ...
  br i1 %147, label %block_40ae7a, label %block_.L_40aea1
...
block_40ae7a:                                     ; preds = %block_.L_40ae6e
  ...
  %call2_40ae86 = tail call %struct.Memory* @sub_411bc0._ZN28custom_greaterthan_constantsIlE8do_shiftEl(%struct.State* nonnull %0, i64 %161, %struct.Memory* %call2_40ae43)
...
block_.L_40aea1:                                  ; preds = %block_.L_40ae6e
  ...
  %call2_40aea5 = tail call %struct.Memory* @sub_411bd0._Z17check_shifted_sumIl28custom_greaterthan_constantsIlEEvT_(%struct.State* nonnull %0, i64 %237, %struct.Memory* %call2_40ae43)
...
block_.L_40aeb8:                                  ; preds = %block_.L_40ae4f
  ...
  %call2_40aeb8 = tail call %struct.Memory* @sub_400eb0._Z5timerv(%struct.State* nonnull %0, i64 %274, %struct.Memory* %call2_40ae43)
  ...
  %call2_40aec1 = tail call %struct.Memory* @sub_400850._Z13record_resultdPKc(%struct.State* nonnull %0, i64 %285, %struct.Memory* %call2_40aeb8)
