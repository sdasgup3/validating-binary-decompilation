...
declare %struct.Memory* @sub_411b80._Z17check_shifted_sumIl28custom_greaterthan_constantsIlEEvT_(%struct.State* noalias dereferenceable(3376), i64, %struct.Memory* noalias readnone returned) local_unnamed_addr
...
define %struct.Memory* @_Z13test_constantIl28custom_greaterthan_constantsIlEEvPT_iPKc(%struct.State* noalias, i64, %struct.Memory* noalias) local_unnamed_addr #1 {
entry:
  ...
  %call2_40adf3 = tail call %struct.Memory* @sub_400e40._Z11start_timerv(%struct.State* %0, i64 %58, %struct.Memory* %2)
...
block_.L_40adff:                                  ; preds = %block_.L_40ae51, %entry
  %68 = phi i64 [ %.pre, %entry ], [ %273, %block_.L_40ae51 ]
  %MEMORY.0 = phi %struct.Memory* [ %call2_40adf3, %entry ], [ %call2_40ae55, %block_.L_40ae51 ]
  ...
  br i1 %101, label %block_40ae0f, label %block_.L_40ae68
...
block_.L_40ae1e:                                  ; preds = %block_40ae2a, %block_40ae0f
  %111 = phi i64 [ %.pre1, %block_40ae0f ], [ %232, %block_40ae2a ]
  %MEMORY.1 = phi %struct.Memory* [ %MEMORY.0, %block_40ae0f ], [ %call2_40ae36, %block_40ae2a ]
  ...
  br i1 %147, label %block_40ae2a, label %block_.L_40ae51
...
block_40ae2a:                                     ; preds = %block_.L_40ae1e
  ...
  %call2_40ae36 = tail call %struct.Memory* @sub_411b70._ZN28custom_greaterthan_constantsIlE8do_shiftEl(%struct.State* %0, i64 %161, %struct.Memory* %MEMORY.1)
...
block_.L_40ae51:                                  ; preds = %block_.L_40ae1e
  ...
  %call2_40ae55 = tail call %struct.Memory* @sub_411b80._Z17check_shifted_sumIl28custom_greaterthan_constantsIlEEvT_(%struct.State* %0, i64 %237, %struct.Memory* %MEMORY.1)
...
block_.L_40ae68:                                  ; preds = %block_.L_40adff
  ...
  %call2_40ae68 = tail call %struct.Memory* @sub_400e60._Z5timerv(%struct.State* %0, i64 %274, %struct.Memory* %MEMORY.0)
  ...
  %call2_40ae71 = tail call %struct.Memory* @sub_400800._Z13record_resultdPKc(%struct.State* %0, i64 %285, %struct.Memory* %call2_40ae68)
  ...
  ret %struct.Memory* %call2_40ae71
}
...
define %struct.Memory* @routine_jge_.L_40ae68(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i8* %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
...
define %struct.Memory* @routine_jge_.L_40ae51(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i8* %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 2, i32 9
...
define %struct.Memory* @routine_jmpq_.L_40ae1e(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
...
define %struct.Memory* @routine_callq_._Z17check_shifted_sumIl28custom_greaterthan_constantsIlEEvT_(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
...
define %struct.Memory* @routine_jmpq_.L_40adff(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
