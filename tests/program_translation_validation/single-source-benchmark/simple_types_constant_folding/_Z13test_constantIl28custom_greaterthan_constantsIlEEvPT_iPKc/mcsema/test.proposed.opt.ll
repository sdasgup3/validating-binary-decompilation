...
declare %struct.Memory* @sub_411bc0._Z17check_shifted_sumIl28custom_greaterthan_constantsIlEEvT_(%struct.State* noalias dereferenceable(3376), i64, %struct.Memory* noalias readnone returned) local_unnamed_addr
...
define %struct.Memory* @_Z13test_constantIl28custom_greaterthan_constantsIlEEvPT_iPKc(%struct.State* noalias, i64, %struct.Memory* noalias readnone) local_unnamed_addr #1 {
entry:
...
block_.L_40ae3f:                                  ; preds = %block_.L_40ae91, %entry
  %68 = phi i64 [ %273, %block_.L_40ae91 ], [ %.pre, %entry ]
...
block_.L_40ae5e:                                  ; preds = %block_40ae6a, %block_40ae4f
  %111 = phi i64 [ %232, %block_40ae6a ], [ %.pre6, %block_40ae4f ]
...
block_40ae6a:                                     ; preds = %block_.L_40ae5e
  ...
  %call2_40ae76 = tail call %struct.Memory* @sub_411bb0._ZN28custom_greaterthan_constantsIlE8do_shiftEl(%struct.State* nonnull %0, i64 %161, %struct.Memory* %call2_40ae33)
...
block_.L_40ae91:                                  ; preds = %block_.L_40ae5e
  ...
  %call2_40ae95 = tail call %struct.Memory* @sub_411bc0._Z17check_shifted_sumIl28custom_greaterthan_constantsIlEEvT_(%struct.State* nonnull %0, i64 %237, %struct.Memory* %call2_40ae33)
...
block_.L_40aea8:                                  ; preds = %block_.L_40ae3f
  ...
  %call2_40aea8 = tail call %struct.Memory* @sub_400ea0._Z5timerv(%struct.State* nonnull %0, i64 %274, %struct.Memory* %call2_40ae33)
