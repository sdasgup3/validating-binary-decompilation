...
block_.L_40b2ff:                                  ; preds = %block_.L_40b351, %entry
  %68 = phi i64 [ %.pre, %entry ], [ %273, %block_.L_40b351 ]
...
block_.L_40b31e:                                  ; preds = %block_40b32a, %block_40b30f
  %111 = phi i64 [ %.pre1, %block_40b30f ], [ %232, %block_40b32a ]
...
block_.L_40b351:                                  ; preds = %block_.L_40b31e
  ...
  %call2_40b355 = tail call %struct.Memory* @sub_4117f0._Z17check_shifted_sumIl28custom_multiple_constant_addIlEEvT_(%struct.State* %0, i64 %237, %struct.Memory* %MEMORY.1)
...
block_.L_40b368:                                  ; preds = %block_.L_40b2ff
  ...
  %call2_40b368 = tail call %struct.Memory* @sub_400e60._Z5timerv(%struct.State* %0, i64 %274, %struct.Memory* %MEMORY.0)
  ...
  %call2_40b371 = tail call %struct.Memory* @sub_400800._Z13record_resultdPKc(%struct.State* %0, i64 %285, %struct.Memory* %call2_40b368)
