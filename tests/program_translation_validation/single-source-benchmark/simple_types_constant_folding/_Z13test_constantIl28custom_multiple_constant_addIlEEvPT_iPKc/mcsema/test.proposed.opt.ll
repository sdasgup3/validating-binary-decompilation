...
declare %struct.Memory* @sub_411840._Z17check_shifted_sumIl28custom_multiple_constant_addIlEEvT_(%struct.State* noalias dereferenceable(3376), i64, %struct.Memory* noalias readnone returned) local_unnamed_addr
...
entry:
  ...
  %call2_40b343 = tail call %struct.Memory* @sub_400e90._Z11start_timerv(%struct.State* %0, i64 %58, %struct.Memory* %2)
...
block_.L_40b34f:                                  ; preds = %block_.L_40b3a1, %entry
  %68 = phi i64 [ %273, %block_.L_40b3a1 ], [ %.pre, %entry ]
  ...
  br i1 %101, label %block_40b35f, label %block_.L_40b3b8

block_40b35f:                                     ; preds = %block_.L_40b34f
  %103 = add i64 %69, -40
  %104 = add i64 %102, 8
...
block_.L_40b36e:                                  ; preds = %block_40b37a, %block_40b35f
  %111 = phi i64 [ %232, %block_40b37a ], [ %.pre6, %block_40b35f ]
  ...
  br i1 %147, label %block_40b37a, label %block_.L_40b3a1

block_40b37a:                                     ; preds = %block_.L_40b36e
  %149 = add i64 %112, -8
  %150 = add i64 %148, 4
  ...
  %call2_40b386 = tail call %struct.Memory* @sub_411810._ZN28custom_multiple_constant_addIlE8do_shiftEl(%struct.State* nonnull %0, i64 %161, %struct.Memory* %call2_40b343)
...
block_.L_40b3a1:                                  ; preds = %block_.L_40b36e
  %233 = add i64 %112, -40
  %234 = add i64 %148, 4
  ...
  %call2_40b3a5 = tail call %struct.Memory* @sub_411840._Z17check_shifted_sumIl28custom_multiple_constant_addIlEEvT_(%struct.State* nonnull %0, i64 %237, %struct.Memory* %call2_40b343)
...
block_.L_40b3b8:                                  ; preds = %block_.L_40b34f
  ...
  %call2_40b3b8 = tail call %struct.Memory* @sub_400eb0._Z5timerv(%struct.State* nonnull %0, i64 %274, %struct.Memory* %call2_40b343)
  ...
  %call2_40b3c1 = tail call %struct.Memory* @sub_400850._Z13record_resultdPKc(%struct.State* nonnull %0, i64 %285, %struct.Memory* %call2_40b3b8)
