...
declare %struct.Memory* @sub_411240._ZN28custom_multiple_constant_andIlE8do_shiftEl(%struct.State* noalias dereferenceable(3376), i64, %struct.Memory* noalias readnone returned) local_unnamed_addr

declare %struct.Memory* @sub_411270._Z17check_shifted_sumIl28custom_multiple_constant_andIlEEvT_(%struct.State* noalias dereferenceable(3376), i64, %struct.Memory* noalias readnone returned) local_unnamed_addr
...
define %struct.Memory* @_Z13test_constantIl28custom_multiple_constant_andIlEEvPT_iPKc(%struct.State* noalias, i64, %struct.Memory* noalias readnone) local_unnamed_addr #1 {
entry:
...
block_.L_40ba1f:                                  ; preds = %block_.L_40ba71, %entry
  %68 = phi i64 [ %273, %block_.L_40ba71 ], [ %.pre, %entry ]
...
block_.L_40ba3e:                                  ; preds = %block_40ba4a, %block_40ba2f
  %111 = phi i64 [ %232, %block_40ba4a ], [ %.pre6, %block_40ba2f ]
...
block_40ba4a:                                     ; preds = %block_.L_40ba3e
  ...
  %call2_40ba56 = tail call %struct.Memory* @sub_411240._ZN28custom_multiple_constant_andIlE8do_shiftEl(%struct.State* nonnull %0, i64 %161, %struct.Memory* %call2_40ba13)
...
block_.L_40ba71:                                  ; preds = %block_.L_40ba3e
  ...
  %call2_40ba75 = tail call %struct.Memory* @sub_411270._Z17check_shifted_sumIl28custom_multiple_constant_andIlEEvT_(%struct.State* nonnull %0, i64 %237, %struct.Memory* %call2_40ba13)
...
block_.L_40ba88:                                  ; preds = %block_.L_40ba1f
  ...
  %call2_40ba88 = tail call %struct.Memory* @sub_400ea0._Z5timerv(%struct.State* nonnull %0, i64 %274, %struct.Memory* %call2_40ba13)
