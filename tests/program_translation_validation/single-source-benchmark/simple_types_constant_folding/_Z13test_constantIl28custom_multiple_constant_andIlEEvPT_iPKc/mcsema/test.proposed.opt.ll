...
declare %struct.Memory* @sub_411250._ZN28custom_multiple_constant_andIlE8do_shiftEl(%struct.State* noalias dereferenceable(3376), i64, %struct.Memory* noalias readnone returned) local_unnamed_addr

declare %struct.Memory* @sub_411280._Z17check_shifted_sumIl28custom_multiple_constant_andIlEEvT_(%struct.State* noalias dereferenceable(3376), i64, %struct.Memory* noalias readnone returned) local_unnamed_addr
...
entry:
  ...
  %call2_40ba23 = tail call %struct.Memory* @sub_400e90._Z11start_timerv(%struct.State* %0, i64 %58, %struct.Memory* %2)
...
block_.L_40ba2f:                                  ; preds = %block_.L_40ba81, %entry
  %68 = phi i64 [ %273, %block_.L_40ba81 ], [ %.pre, %entry ]
  ...
  br i1 %101, label %block_40ba3f, label %block_.L_40ba98
...
block_.L_40ba4e:                                  ; preds = %block_40ba5a, %block_40ba3f
  %111 = phi i64 [ %232, %block_40ba5a ], [ %.pre6, %block_40ba3f ]
  ...
  br i1 %147, label %block_40ba5a, label %block_.L_40ba81
...
block_40ba5a:                                     ; preds = %block_.L_40ba4e
  ...
  %call2_40ba66 = tail call %struct.Memory* @sub_411250._ZN28custom_multiple_constant_andIlE8do_shiftEl(%struct.State* nonnull %0, i64 %161, %struct.Memory* %call2_40ba23)
...
block_.L_40ba81:                                  ; preds = %block_.L_40ba4e
  ...
  %call2_40ba85 = tail call %struct.Memory* @sub_411280._Z17check_shifted_sumIl28custom_multiple_constant_andIlEEvT_(%struct.State* nonnull %0, i64 %237, %struct.Memory* %call2_40ba23)
...
block_.L_40ba98:                                  ; preds = %block_.L_40ba2f
  ...
  %call2_40ba98 = tail call %struct.Memory* @sub_400eb0._Z5timerv(%struct.State* nonnull %0, i64 %274, %struct.Memory* %call2_40ba23)
  ...
  %call2_40baa1 = tail call %struct.Memory* @sub_400850._Z13record_resultdPKc(%struct.State* nonnull %0, i64 %285, %struct.Memory* %call2_40ba98)
