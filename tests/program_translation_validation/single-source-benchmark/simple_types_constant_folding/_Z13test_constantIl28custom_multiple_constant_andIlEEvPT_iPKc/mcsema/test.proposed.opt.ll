...
declare %struct.Memory* @sub_411240._ZN28custom_multiple_constant_andIlE8do_shiftEl(%struct.State* dereferenceable(3376), i64, %struct.Memory*) local_unnamed_addr

declare %struct.Memory* @sub_411270._Z17check_shifted_sumIl28custom_multiple_constant_andIlEEvT_(%struct.State* dereferenceable(3376), i64, %struct.Memory*) local_unnamed_addr
...
entry:
  ...
  %call2_40ba13 = tail call %struct.Memory* @sub_400e80._Z11start_timerv(%struct.State* %0, i64 %58, %struct.Memory* %2)
...
block_.L_40ba1f:                                  ; preds = %block_.L_40ba71, %entry
  %68 = phi i64 [ %.pre, %entry ], [ %273, %block_.L_40ba71 ]
  %MEMORY.0 = phi %struct.Memory* [ %call2_40ba13, %entry ], [ %call2_40ba75, %block_.L_40ba71 ]
  ...
  br i1 %101, label %block_40ba2f, label %block_.L_40ba88
...
block_.L_40ba3e:                                  ; preds = %block_40ba4a, %block_40ba2f
  %111 = phi i64 [ %.pre6, %block_40ba2f ], [ %232, %block_40ba4a ]
  %MEMORY.1 = phi %struct.Memory* [ %MEMORY.0, %block_40ba2f ], [ %call2_40ba56, %block_40ba4a ]
  ...
  br i1 %147, label %block_40ba4a, label %block_.L_40ba71
...
block_40ba4a:                                     ; preds = %block_.L_40ba3e
  ...
  %call2_40ba56 = tail call %struct.Memory* @sub_411240._ZN28custom_multiple_constant_andIlE8do_shiftEl(%struct.State* nonnull %0, i64 %161, %struct.Memory* %MEMORY.1)
...
block_.L_40ba71:                                  ; preds = %block_.L_40ba3e
  ...
  %call2_40ba75 = tail call %struct.Memory* @sub_411270._Z17check_shifted_sumIl28custom_multiple_constant_andIlEEvT_(%struct.State* nonnull %0, i64 %237, %struct.Memory* %MEMORY.1)
...
block_.L_40ba88:                                  ; preds = %block_.L_40ba1f
  ...
  %call2_40ba88 = tail call %struct.Memory* @sub_400ea0._Z5timerv(%struct.State* nonnull %0, i64 %274, %struct.Memory* %MEMORY.0)
  ...
  %call2_40ba91 = tail call %struct.Memory* @sub_400840._Z13record_resultdPKc(%struct.State* nonnull %0, i64 %285, %struct.Memory* %call2_40ba88)
  ...
  ret %struct.Memory* %call2_40ba91
}
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_jge_.L_40ba88(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i8* nocapture %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_jge_.L_40ba71(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i8* nocapture %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 2, i32 9
