...
block_.L_40b9df:                                  ; preds = %block_.L_40ba31, %entry
  %68 = phi i64 [ %.pre, %entry ], [ %275, %block_.L_40ba31 ]
...
block_.L_40b9fe:                                  ; preds = %block_40ba0a, %block_40b9ef
  %111 = phi i64 [ %.pre1, %block_40b9ef ], [ %233, %block_40ba0a ]
...
block_.L_40ba31:                                  ; preds = %block_.L_40b9fe
  ...
  %call2_40ba35 = tail call %struct.Memory* @sub_411230._Z17check_shifted_sumIl28custom_multiple_constant_andIlEEvT_(%struct.State* %0, i64 %238, %struct.Memory* %MEMORY.1)
...
block_.L_40ba48:                                  ; preds = %block_.L_40b9df
  ...
  %call2_40ba48 = tail call %struct.Memory* @sub_400e60._Z5timerv(%struct.State* %0, i64 %276, %struct.Memory* %MEMORY.0)
  ...
  %call2_40ba51 = tail call %struct.Memory* @sub_400800._Z13record_resultdPKc(%struct.State* %0, i64 %287, %struct.Memory* %call2_40ba48)
