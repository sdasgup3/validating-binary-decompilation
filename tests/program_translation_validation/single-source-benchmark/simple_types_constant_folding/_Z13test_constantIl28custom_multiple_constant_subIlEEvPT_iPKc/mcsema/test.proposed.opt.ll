...
block_.L_40b43f:                                  ; preds = %block_.L_40b491, %entry
  %68 = phi i64 [ %.pre, %entry ], [ %273, %block_.L_40b491 ]
...
block_.L_40b45e:                                  ; preds = %block_40b46a, %block_40b44f
  %111 = phi i64 [ %.pre1, %block_40b44f ], [ %232, %block_40b46a ]
...
block_.L_40b491:                                  ; preds = %block_.L_40b45e
  ...
  %call2_40b495 = tail call %struct.Memory* @sub_4116e0._Z17check_shifted_sumIl28custom_multiple_constant_subIlEEvT_(%struct.State* %0, i64 %237, %struct.Memory* %MEMORY.1)
...
block_.L_40b4a8:                                  ; preds = %block_.L_40b43f
  ...
  %call2_40b4a8 = tail call %struct.Memory* @sub_400e60._Z5timerv(%struct.State* %0, i64 %274, %struct.Memory* %MEMORY.0)
  ...
  %call2_40b4b1 = tail call %struct.Memory* @sub_400800._Z13record_resultdPKc(%struct.State* %0, i64 %285, %struct.Memory* %call2_40b4a8)
