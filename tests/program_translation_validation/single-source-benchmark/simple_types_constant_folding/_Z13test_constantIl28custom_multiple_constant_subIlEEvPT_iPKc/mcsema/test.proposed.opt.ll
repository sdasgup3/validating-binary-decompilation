...
declare %struct.Memory* @sub_4116f0._ZN28custom_multiple_constant_subIlE8do_shiftEl(%struct.State* dereferenceable(3376), i64, %struct.Memory*) local_unnamed_addr

declare %struct.Memory* @sub_411720._Z17check_shifted_sumIl28custom_multiple_constant_subIlEEvT_(%struct.State* dereferenceable(3376), i64, %struct.Memory*) local_unnamed_addr
...
block_.L_40b47f:                                  ; preds = %block_.L_40b4d1, %entry
  %68 = phi i64 [ %.pre, %entry ], [ %273, %block_.L_40b4d1 ]
  %MEMORY.0 = phi %struct.Memory* [ %call2_40b473, %entry ], [ %call2_40b4d5, %block_.L_40b4d1 ]
...
block_.L_40b49e:                                  ; preds = %block_40b4aa, %block_40b48f
  %111 = phi i64 [ %.pre6, %block_40b48f ], [ %232, %block_40b4aa ]
  %MEMORY.1 = phi %struct.Memory* [ %MEMORY.0, %block_40b48f ], [ %call2_40b4b6, %block_40b4aa ]
...
block_40b4aa:                                     ; preds = %block_.L_40b49e
  ...
  %call2_40b4b6 = tail call %struct.Memory* @sub_4116f0._ZN28custom_multiple_constant_subIlE8do_shiftEl(%struct.State* nonnull %0, i64 %161, %struct.Memory* %MEMORY.1)
...
block_.L_40b4d1:                                  ; preds = %block_.L_40b49e
  ...
  %call2_40b4d5 = tail call %struct.Memory* @sub_411720._Z17check_shifted_sumIl28custom_multiple_constant_subIlEEvT_(%struct.State* nonnull %0, i64 %237, %struct.Memory* %MEMORY.1)
...
block_.L_40b4e8:                                  ; preds = %block_.L_40b47f
  ...
  %call2_40b4e8 = tail call %struct.Memory* @sub_400ea0._Z5timerv(%struct.State* nonnull %0, i64 %274, %struct.Memory* %MEMORY.0)
