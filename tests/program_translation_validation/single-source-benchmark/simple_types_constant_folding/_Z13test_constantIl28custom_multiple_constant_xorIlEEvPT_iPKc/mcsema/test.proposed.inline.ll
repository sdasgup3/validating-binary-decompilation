...
declare %struct.Memory* @sub_410ff0._ZN28custom_multiple_constant_xorIlE8do_shiftEl(%struct.State* dereferenceable(3376), i64, %struct.Memory*)

declare %struct.Memory* @sub_411020._Z17check_shifted_sumIl28custom_multiple_constant_xorIlEEvT_(%struct.State* dereferenceable(3376), i64, %struct.Memory*)
...
define %struct.Memory* @_Z13test_constantIl28custom_multiple_constant_xorIlEEvPT_iPKc(%struct.State* noalias, i64, %struct.Memory* noalias) #1 {
entry:
