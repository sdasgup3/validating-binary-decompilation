...
declare %struct.Memory* @sub_411030._Z17check_shifted_sumIl28custom_multiple_constant_xorIlEEvT_(%struct.State* noalias dereferenceable(3376), i64, %struct.Memory* noalias readnone returned) local_unnamed_addr
...
entry:
  ...
  %call2_40bca3 = tail call %struct.Memory* @sub_400e90._Z11start_timerv(%struct.State* %0, i64 %58, %struct.Memory* %2)
...
block_.L_40bcaf:                                  ; preds = %block_.L_40bd01, %entry
  %68 = phi i64 [ %273, %block_.L_40bd01 ], [ %.pre, %entry ]
  ...
  br i1 %101, label %block_40bcbf, label %block_.L_40bd18
...
block_.L_40bcce:                                  ; preds = %block_40bcda, %block_40bcbf
  %111 = phi i64 [ %232, %block_40bcda ], [ %.pre6, %block_40bcbf ]
  ...
  br i1 %147, label %block_40bcda, label %block_.L_40bd01
...
block_40bcda:                                     ; preds = %block_.L_40bcce
  ...
  %call2_40bce6 = tail call %struct.Memory* @sub_411000._ZN28custom_multiple_constant_xorIlE8do_shiftEl(%struct.State* nonnull %0, i64 %161, %struct.Memory* %call2_40bca3)
...
block_.L_40bd01:                                  ; preds = %block_.L_40bcce
  ...
  %call2_40bd05 = tail call %struct.Memory* @sub_411030._Z17check_shifted_sumIl28custom_multiple_constant_xorIlEEvT_(%struct.State* nonnull %0, i64 %237, %struct.Memory* %call2_40bca3)
...
block_.L_40bd18:                                  ; preds = %block_.L_40bcaf
  ...
  %call2_40bd18 = tail call %struct.Memory* @sub_400eb0._Z5timerv(%struct.State* nonnull %0, i64 %274, %struct.Memory* %call2_40bca3)
  ...
  %call2_40bd21 = tail call %struct.Memory* @sub_400850._Z13record_resultdPKc(%struct.State* nonnull %0, i64 %285, %struct.Memory* %call2_40bd18)
