...
block_.L_40bc5f:                                  ; preds = %block_.L_40bcb1, %entry
  %68 = phi i64 [ %.pre, %entry ], [ %273, %block_.L_40bcb1 ]
...
block_.L_40bc7e:                                  ; preds = %block_40bc8a, %block_40bc6f
  %111 = phi i64 [ %.pre1, %block_40bc6f ], [ %232, %block_40bc8a ]
...
block_.L_40bcb1:                                  ; preds = %block_.L_40bc7e
  ...
  %call2_40bcb5 = tail call %struct.Memory* @sub_410fe0._Z17check_shifted_sumIl28custom_multiple_constant_xorIlEEvT_(%struct.State* %0, i64 %237, %struct.Memory* %MEMORY.1)
...
block_.L_40bcc8:                                  ; preds = %block_.L_40bc5f
  ...
  %call2_40bcc8 = tail call %struct.Memory* @sub_400e60._Z5timerv(%struct.State* %0, i64 %274, %struct.Memory* %MEMORY.0)
  ...
  %call2_40bcd1 = tail call %struct.Memory* @sub_400800._Z13record_resultdPKc(%struct.State* %0, i64 %285, %struct.Memory* %call2_40bcc8)
