...
declare %struct.Memory* @sub_410fe0._Z17check_shifted_sumIl28custom_multiple_constant_xorIlEEvT_(%struct.State* noalias dereferenceable(3376), i64, %struct.Memory* noalias readnone returned) local_unnamed_addr
...
define %struct.Memory* @_Z13test_constantIl28custom_multiple_constant_xorIlEEvPT_iPKc(%struct.State* noalias, i64, %struct.Memory* noalias) local_unnamed_addr #1 {
entry:
  ...
  %call2_40bc53 = tail call %struct.Memory* @sub_400e40._Z11start_timerv(%struct.State* %0, i64 %58, %struct.Memory* %2)
...
block_.L_40bc5f:                                  ; preds = %block_.L_40bcb1, %entry
  %68 = phi i64 [ %.pre, %entry ], [ %275, %block_.L_40bcb1 ]
  %MEMORY.0 = phi %struct.Memory* [ %call2_40bc53, %entry ], [ %call2_40bcb5, %block_.L_40bcb1 ]
  ...
  br i1 %101, label %block_40bc6f, label %block_.L_40bcc8
...
block_.L_40bc7e:                                  ; preds = %block_40bc8a, %block_40bc6f
  %111 = phi i64 [ %.pre1, %block_40bc6f ], [ %233, %block_40bc8a ]
  %MEMORY.1 = phi %struct.Memory* [ %MEMORY.0, %block_40bc6f ], [ %call2_40bc96, %block_40bc8a ]
  ...
  br i1 %147, label %block_40bc8a, label %block_.L_40bcb1
...
block_40bc8a:                                     ; preds = %block_.L_40bc7e
  ...
  %call2_40bc96 = tail call %struct.Memory* @sub_410fb0._ZN28custom_multiple_constant_xorIlE8do_shiftEl(%struct.State* %0, i64 %161, %struct.Memory* %MEMORY.1)
...
block_.L_40bcb1:                                  ; preds = %block_.L_40bc7e
  ...
  %call2_40bcb5 = tail call %struct.Memory* @sub_410fe0._Z17check_shifted_sumIl28custom_multiple_constant_xorIlEEvT_(%struct.State* %0, i64 %238, %struct.Memory* %MEMORY.1)
...
block_.L_40bcc8:                                  ; preds = %block_.L_40bc5f
  ...
  %call2_40bcc8 = tail call %struct.Memory* @sub_400e60._Z5timerv(%struct.State* %0, i64 %276, %struct.Memory* %MEMORY.0)
  ...
  %call2_40bcd1 = tail call %struct.Memory* @sub_400800._Z13record_resultdPKc(%struct.State* %0, i64 %287, %struct.Memory* %call2_40bcc8)
  ...
  ret %struct.Memory* %call2_40bcd1
}
...
define %struct.Memory* @routine_jge_.L_40bcc8(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i8* %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
...
define %struct.Memory* @routine_jge_.L_40bcb1(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i8* %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 2, i32 9
...
define %struct.Memory* @routine_jmpq_.L_40bc7e(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
...
define %struct.Memory* @routine_callq_._Z17check_shifted_sumIl28custom_multiple_constant_xorIlEEvT_(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
...
define %struct.Memory* @routine_jmpq_.L_40bc5f(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
