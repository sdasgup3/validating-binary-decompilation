...
declare %struct.Memory* @sub_411020._Z17check_shifted_sumIl28custom_multiple_constant_xorIlEEvT_(%struct.State* noalias dereferenceable(3376), i64, %struct.Memory* noalias readnone returned) local_unnamed_addr
...
define %struct.Memory* @_Z13test_constantIl28custom_multiple_constant_xorIlEEvPT_iPKc(%struct.State* noalias, i64, %struct.Memory* noalias readnone) local_unnamed_addr #1 {
entry:
...
block_.L_40bc9f:                                  ; preds = %block_.L_40bcf1, %entry
  %68 = phi i64 [ %273, %block_.L_40bcf1 ], [ %.pre, %entry ]
...
block_.L_40bcbe:                                  ; preds = %block_40bcca, %block_40bcaf
  %111 = phi i64 [ %232, %block_40bcca ], [ %.pre6, %block_40bcaf ]
...
block_40bcca:                                     ; preds = %block_.L_40bcbe
  ...
  %call2_40bcd6 = tail call %struct.Memory* @sub_410ff0._ZN28custom_multiple_constant_xorIlE8do_shiftEl(%struct.State* nonnull %0, i64 %161, %struct.Memory* %call2_40bc93)
...
block_.L_40bcf1:                                  ; preds = %block_.L_40bcbe
  ...
  %call2_40bcf5 = tail call %struct.Memory* @sub_411020._Z17check_shifted_sumIl28custom_multiple_constant_xorIlEEvT_(%struct.State* nonnull %0, i64 %237, %struct.Memory* %call2_40bc93)
...
block_.L_40bd08:                                  ; preds = %block_.L_40bc9f
  ...
  %call2_40bd08 = tail call %struct.Memory* @sub_400ea0._Z5timerv(%struct.State* nonnull %0, i64 %274, %struct.Memory* %call2_40bc93)
