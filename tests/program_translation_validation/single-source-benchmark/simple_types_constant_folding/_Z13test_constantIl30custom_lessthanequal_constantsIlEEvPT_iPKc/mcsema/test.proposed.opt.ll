...
block_.L_40afdf:                                  ; preds = %block_.L_40b031, %entry
  %68 = phi i64 [ %.pre, %entry ], [ %273, %block_.L_40b031 ]
...
block_.L_40affe:                                  ; preds = %block_40b00a, %block_40afef
  %111 = phi i64 [ %.pre1, %block_40afef ], [ %232, %block_40b00a ]
...
block_.L_40b031:                                  ; preds = %block_.L_40affe
  ...
  %call2_40b035 = tail call %struct.Memory* @sub_411a30._Z17check_shifted_sumIl30custom_lessthanequal_constantsIlEEvT_(%struct.State* %0, i64 %237, %struct.Memory* %MEMORY.1)
...
block_.L_40b048:                                  ; preds = %block_.L_40afdf
  ...
  %call2_40b048 = tail call %struct.Memory* @sub_400e60._Z5timerv(%struct.State* %0, i64 %274, %struct.Memory* %MEMORY.0)
  ...
  %call2_40b051 = tail call %struct.Memory* @sub_400800._Z13record_resultdPKc(%struct.State* %0, i64 %285, %struct.Memory* %call2_40b048)
