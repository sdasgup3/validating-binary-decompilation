...
block_.L_40b89f:                                  ; preds = %block_.L_40b8f1, %entry
  %68 = phi i64 [ %.pre, %entry ], [ %273, %block_.L_40b8f1 ]
...
block_.L_40b8be:                                  ; preds = %block_40b8ca, %block_40b8af
  %111 = phi i64 [ %.pre1, %block_40b8af ], [ %232, %block_40b8ca ]
...
block_.L_40b8f1:                                  ; preds = %block_.L_40b8be
  ...
  %call2_40b8f5 = tail call %struct.Memory* @sub_411330._Z17check_shifted_sumIl30custom_multiple_constant_mixedIlEEvT_(%struct.State* %0, i64 %237, %struct.Memory* %MEMORY.1)
...
block_.L_40b908:                                  ; preds = %block_.L_40b89f
  ...
  %call2_40b908 = tail call %struct.Memory* @sub_400e60._Z5timerv(%struct.State* %0, i64 %274, %struct.Memory* %MEMORY.0)
  ...
  %call2_40b911 = tail call %struct.Memory* @sub_400800._Z13record_resultdPKc(%struct.State* %0, i64 %285, %struct.Memory* %call2_40b908)
