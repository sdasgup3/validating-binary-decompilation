...
declare %struct.Memory* @sub_411350._ZN30custom_multiple_constant_mixedIlE8do_shiftEl(%struct.State* dereferenceable(3376), i64, %struct.Memory*) local_unnamed_addr

declare %struct.Memory* @sub_411370._Z17check_shifted_sumIl30custom_multiple_constant_mixedIlEEvT_(%struct.State* dereferenceable(3376), i64, %struct.Memory*) local_unnamed_addr
...
block_.L_40b8df:                                  ; preds = %block_.L_40b931, %entry
  %68 = phi i64 [ %.pre, %entry ], [ %273, %block_.L_40b931 ]
  %MEMORY.0 = phi %struct.Memory* [ %call2_40b8d3, %entry ], [ %call2_40b935, %block_.L_40b931 ]
...
block_.L_40b8fe:                                  ; preds = %block_40b90a, %block_40b8ef
  %111 = phi i64 [ %.pre6, %block_40b8ef ], [ %232, %block_40b90a ]
  %MEMORY.1 = phi %struct.Memory* [ %MEMORY.0, %block_40b8ef ], [ %call2_40b916, %block_40b90a ]
...
block_40b90a:                                     ; preds = %block_.L_40b8fe
  ...
  %call2_40b916 = tail call %struct.Memory* @sub_411350._ZN30custom_multiple_constant_mixedIlE8do_shiftEl(%struct.State* nonnull %0, i64 %161, %struct.Memory* %MEMORY.1)
...
block_.L_40b931:                                  ; preds = %block_.L_40b8fe
  ...
  %call2_40b935 = tail call %struct.Memory* @sub_411370._Z17check_shifted_sumIl30custom_multiple_constant_mixedIlEEvT_(%struct.State* nonnull %0, i64 %237, %struct.Memory* %MEMORY.1)
...
block_.L_40b948:                                  ; preds = %block_.L_40b8df
  ...
  %call2_40b948 = tail call %struct.Memory* @sub_400ea0._Z5timerv(%struct.State* nonnull %0, i64 %274, %struct.Memory* %MEMORY.0)
