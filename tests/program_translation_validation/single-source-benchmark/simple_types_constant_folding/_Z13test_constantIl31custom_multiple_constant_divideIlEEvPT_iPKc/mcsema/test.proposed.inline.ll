...
declare %struct.Memory* @sub_411450._ZN31custom_multiple_constant_divideIlE8do_shiftEl(%struct.State* dereferenceable(3376), i64, %struct.Memory*)

declare %struct.Memory* @sub_4114a0._Z17check_shifted_sumIl31custom_multiple_constant_divideIlEEvT_(%struct.State* dereferenceable(3376), i64, %struct.Memory*)
...
define %struct.Memory* @_Z13test_constantIl31custom_multiple_constant_divideIlEEvPT_iPKc(%struct.State* noalias, i64, %struct.Memory* noalias) #1 {
entry:
