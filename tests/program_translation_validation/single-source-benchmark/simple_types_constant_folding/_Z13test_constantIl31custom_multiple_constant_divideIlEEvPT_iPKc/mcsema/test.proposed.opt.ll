...
block_.L_40b75f:                                  ; preds = %block_.L_40b7b1, %entry
  %68 = phi i64 [ %.pre, %entry ], [ %273, %block_.L_40b7b1 ]
...
block_.L_40b77e:                                  ; preds = %block_40b78a, %block_40b76f
  %111 = phi i64 [ %.pre1, %block_40b76f ], [ %232, %block_40b78a ]
...
block_.L_40b7b1:                                  ; preds = %block_.L_40b77e
  ...
  %call2_40b7b5 = tail call %struct.Memory* @sub_411460._Z17check_shifted_sumIl31custom_multiple_constant_divideIlEEvT_(%struct.State* %0, i64 %237, %struct.Memory* %MEMORY.1)
...
block_.L_40b7c8:                                  ; preds = %block_.L_40b75f
  ...
  %call2_40b7c8 = tail call %struct.Memory* @sub_400e60._Z5timerv(%struct.State* %0, i64 %274, %struct.Memory* %MEMORY.0)
  ...
  %call2_40b7d1 = tail call %struct.Memory* @sub_400800._Z13record_resultdPKc(%struct.State* %0, i64 %285, %struct.Memory* %call2_40b7c8)
