...
declare %struct.Memory* @sub_411450._ZN31custom_multiple_constant_divideIlE8do_shiftEl(%struct.State* noalias dereferenceable(3376), i64, %struct.Memory* noalias readnone returned) local_unnamed_addr

declare %struct.Memory* @sub_4114a0._Z17check_shifted_sumIl31custom_multiple_constant_divideIlEEvT_(%struct.State* noalias dereferenceable(3376), i64, %struct.Memory* noalias readnone returned) local_unnamed_addr
...
define %struct.Memory* @_Z13test_constantIl31custom_multiple_constant_divideIlEEvPT_iPKc(%struct.State* noalias, i64, %struct.Memory* noalias readnone) local_unnamed_addr #1 {
entry:
...
block_.L_40b79f:                                  ; preds = %block_.L_40b7f1, %entry
  %68 = phi i64 [ %273, %block_.L_40b7f1 ], [ %.pre, %entry ]
...
block_.L_40b7be:                                  ; preds = %block_40b7ca, %block_40b7af
  %111 = phi i64 [ %232, %block_40b7ca ], [ %.pre6, %block_40b7af ]
...
block_40b7ca:                                     ; preds = %block_.L_40b7be
  ...
  %call2_40b7d6 = tail call %struct.Memory* @sub_411450._ZN31custom_multiple_constant_divideIlE8do_shiftEl(%struct.State* nonnull %0, i64 %161, %struct.Memory* %call2_40b793)
...
block_.L_40b7f1:                                  ; preds = %block_.L_40b7be
  ...
  %call2_40b7f5 = tail call %struct.Memory* @sub_4114a0._Z17check_shifted_sumIl31custom_multiple_constant_divideIlEEvT_(%struct.State* nonnull %0, i64 %237, %struct.Memory* %call2_40b793)
...
block_.L_40b808:                                  ; preds = %block_.L_40b79f
  ...
  %call2_40b808 = tail call %struct.Memory* @sub_400ea0._Z5timerv(%struct.State* nonnull %0, i64 %274, %struct.Memory* %call2_40b793)
