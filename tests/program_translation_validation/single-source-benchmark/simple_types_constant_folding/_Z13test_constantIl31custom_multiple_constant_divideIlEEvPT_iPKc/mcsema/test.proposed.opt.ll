...
declare %struct.Memory* @sub_411460._ZN31custom_multiple_constant_divideIlE8do_shiftEl(%struct.State* noalias dereferenceable(3376), i64, %struct.Memory* noalias readnone returned) local_unnamed_addr

declare %struct.Memory* @sub_4114b0._Z17check_shifted_sumIl31custom_multiple_constant_divideIlEEvT_(%struct.State* noalias dereferenceable(3376), i64, %struct.Memory* noalias readnone returned) local_unnamed_addr
...
entry:
  ...
  %call2_40b7a3 = tail call %struct.Memory* @sub_400e90._Z11start_timerv(%struct.State* %0, i64 %58, %struct.Memory* %2)
...
block_.L_40b7af:                                  ; preds = %block_.L_40b801, %entry
  %68 = phi i64 [ %273, %block_.L_40b801 ], [ %.pre, %entry ]
  ...
  br i1 %101, label %block_40b7bf, label %block_.L_40b818
...
block_.L_40b7ce:                                  ; preds = %block_40b7da, %block_40b7bf
  %111 = phi i64 [ %232, %block_40b7da ], [ %.pre6, %block_40b7bf ]
  ...
  br i1 %147, label %block_40b7da, label %block_.L_40b801
...
block_40b7da:                                     ; preds = %block_.L_40b7ce
  ...
  %call2_40b7e6 = tail call %struct.Memory* @sub_411460._ZN31custom_multiple_constant_divideIlE8do_shiftEl(%struct.State* nonnull %0, i64 %161, %struct.Memory* %call2_40b7a3)
...
block_.L_40b801:                                  ; preds = %block_.L_40b7ce
  ...
  %call2_40b805 = tail call %struct.Memory* @sub_4114b0._Z17check_shifted_sumIl31custom_multiple_constant_divideIlEEvT_(%struct.State* nonnull %0, i64 %237, %struct.Memory* %call2_40b7a3)
...
block_.L_40b818:                                  ; preds = %block_.L_40b7af
  ...
  %call2_40b818 = tail call %struct.Memory* @sub_400eb0._Z5timerv(%struct.State* nonnull %0, i64 %274, %struct.Memory* %call2_40b7a3)
  ...
  %call2_40b821 = tail call %struct.Memory* @sub_400850._Z13record_resultdPKc(%struct.State* nonnull %0, i64 %285, %struct.Memory* %call2_40b818)
