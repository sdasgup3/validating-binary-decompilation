...
block_.L_40b7ff:                                  ; preds = %block_.L_40b851, %entry
  %68 = phi i64 [ %.pre, %entry ], [ %273, %block_.L_40b851 ]
...
block_.L_40b81e:                                  ; preds = %block_40b82a, %block_40b80f
  %111 = phi i64 [ %.pre1, %block_40b80f ], [ %232, %block_40b82a ]
...
block_.L_40b851:                                  ; preds = %block_.L_40b81e
  ...
  %call2_40b855 = tail call %struct.Memory* @sub_4113b0._Z17check_shifted_sumIl32custom_multiple_constant_divide2IlEEvT_(%struct.State* %0, i64 %237, %struct.Memory* %MEMORY.1)
...
block_.L_40b868:                                  ; preds = %block_.L_40b7ff
  ...
  %call2_40b868 = tail call %struct.Memory* @sub_400e60._Z5timerv(%struct.State* %0, i64 %274, %struct.Memory* %MEMORY.0)
  ...
  %call2_40b871 = tail call %struct.Memory* @sub_400800._Z13record_resultdPKc(%struct.State* %0, i64 %285, %struct.Memory* %call2_40b868)
