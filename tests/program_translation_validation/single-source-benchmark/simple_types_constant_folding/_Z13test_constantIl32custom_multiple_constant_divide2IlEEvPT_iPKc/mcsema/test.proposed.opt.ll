...
declare %struct.Memory* @sub_4113d0._ZN32custom_multiple_constant_divide2IlE8do_shiftEl(%struct.State* dereferenceable(3376), i64, %struct.Memory*) local_unnamed_addr

declare %struct.Memory* @sub_4113f0._Z17check_shifted_sumIl32custom_multiple_constant_divide2IlEEvT_(%struct.State* dereferenceable(3376), i64, %struct.Memory*) local_unnamed_addr
...
block_.L_40b83f:                                  ; preds = %block_.L_40b891, %entry
  %68 = phi i64 [ %.pre, %entry ], [ %273, %block_.L_40b891 ]
  %MEMORY.0 = phi %struct.Memory* [ %call2_40b833, %entry ], [ %call2_40b895, %block_.L_40b891 ]
...
block_.L_40b85e:                                  ; preds = %block_40b86a, %block_40b84f
  %111 = phi i64 [ %.pre6, %block_40b84f ], [ %232, %block_40b86a ]
  %MEMORY.1 = phi %struct.Memory* [ %MEMORY.0, %block_40b84f ], [ %call2_40b876, %block_40b86a ]
...
block_40b86a:                                     ; preds = %block_.L_40b85e
  ...
  %call2_40b876 = tail call %struct.Memory* @sub_4113d0._ZN32custom_multiple_constant_divide2IlE8do_shiftEl(%struct.State* nonnull %0, i64 %161, %struct.Memory* %MEMORY.1)
...
block_.L_40b891:                                  ; preds = %block_.L_40b85e
  ...
  %call2_40b895 = tail call %struct.Memory* @sub_4113f0._Z17check_shifted_sumIl32custom_multiple_constant_divide2IlEEvT_(%struct.State* nonnull %0, i64 %237, %struct.Memory* %MEMORY.1)
...
block_.L_40b8a8:                                  ; preds = %block_.L_40b83f
  ...
  %call2_40b8a8 = tail call %struct.Memory* @sub_400ea0._Z5timerv(%struct.State* nonnull %0, i64 %274, %struct.Memory* %MEMORY.0)
