...
block_.L_40af3f:                                  ; preds = %block_.L_40af91, %entry
  %68 = phi i64 [ %.pre, %entry ], [ %275, %block_.L_40af91 ]
...
block_.L_40af5e:                                  ; preds = %block_40af6a, %block_40af4f
  %111 = phi i64 [ %.pre1, %block_40af4f ], [ %233, %block_40af6a ]
...
block_.L_40af91:                                  ; preds = %block_.L_40af5e
  ...
  %call2_40af95 = tail call %struct.Memory* @sub_411aa0._Z17check_shifted_sumIl33custom_greaterthanequal_constantsIlEEvT_(%struct.State* %0, i64 %238, %struct.Memory* %MEMORY.1)
...
block_.L_40afa8:                                  ; preds = %block_.L_40af3f
  ...
  %call2_40afa8 = tail call %struct.Memory* @sub_400e60._Z5timerv(%struct.State* %0, i64 %276, %struct.Memory* %MEMORY.0)
  ...
  %call2_40afb1 = tail call %struct.Memory* @sub_400800._Z13record_resultdPKc(%struct.State* %0, i64 %287, %struct.Memory* %call2_40afa8)
