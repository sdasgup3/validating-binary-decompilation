...
declare %struct.Memory* @sub_411ad0._ZN33custom_greaterthanequal_constantsIlE8do_shiftEl(%struct.State* noalias dereferenceable(3376), i64, %struct.Memory* noalias readnone returned) local_unnamed_addr

declare %struct.Memory* @sub_411ae0._Z17check_shifted_sumIl33custom_greaterthanequal_constantsIlEEvT_(%struct.State* noalias dereferenceable(3376), i64, %struct.Memory* noalias readnone returned) local_unnamed_addr
...
define %struct.Memory* @_Z13test_constantIl33custom_greaterthanequal_constantsIlEEvPT_iPKc(%struct.State* noalias, i64, %struct.Memory* noalias readnone) local_unnamed_addr #1 {
entry:
...
block_.L_40af7f:                                  ; preds = %block_.L_40afd1, %entry
  %68 = phi i64 [ %273, %block_.L_40afd1 ], [ %.pre, %entry ]
...
block_.L_40af9e:                                  ; preds = %block_40afaa, %block_40af8f
  %111 = phi i64 [ %232, %block_40afaa ], [ %.pre6, %block_40af8f ]
...
block_40afaa:                                     ; preds = %block_.L_40af9e
  ...
  %call2_40afb6 = tail call %struct.Memory* @sub_411ad0._ZN33custom_greaterthanequal_constantsIlE8do_shiftEl(%struct.State* nonnull %0, i64 %161, %struct.Memory* %call2_40af73)
...
block_.L_40afd1:                                  ; preds = %block_.L_40af9e
  ...
  %call2_40afd5 = tail call %struct.Memory* @sub_411ae0._Z17check_shifted_sumIl33custom_greaterthanequal_constantsIlEEvT_(%struct.State* nonnull %0, i64 %237, %struct.Memory* %call2_40af73)
...
block_.L_40afe8:                                  ; preds = %block_.L_40af7f
  ...
  %call2_40afe8 = tail call %struct.Memory* @sub_400ea0._Z5timerv(%struct.State* nonnull %0, i64 %274, %struct.Memory* %call2_40af73)
