...
declare %struct.Memory* @sub_411620._Z17check_shifted_sumIl33custom_multiple_constant_multiplyIlEEvT_(%struct.State* noalias dereferenceable(3376), i64, %struct.Memory* noalias readnone returned) local_unnamed_addr
...
block_.L_40b5bf:                                  ; preds = %block_.L_40b611, %entry
  %68 = phi i64 [ %273, %block_.L_40b611 ], [ %.pre, %entry ]
...
block_.L_40b5de:                                  ; preds = %block_40b5ea, %block_40b5cf
  %111 = phi i64 [ %232, %block_40b5ea ], [ %.pre6, %block_40b5cf ]
...
block_40b5ea:                                     ; preds = %block_.L_40b5de
  ...
  %call2_40b5f6 = tail call %struct.Memory* @sub_411600._ZN33custom_multiple_constant_multiplyIlE8do_shiftEl(%struct.State* nonnull %0, i64 %161, %struct.Memory* %call2_40b5b3)
...
block_.L_40b611:                                  ; preds = %block_.L_40b5de
  ...
  %call2_40b615 = tail call %struct.Memory* @sub_411620._Z17check_shifted_sumIl33custom_multiple_constant_multiplyIlEEvT_(%struct.State* nonnull %0, i64 %237, %struct.Memory* %call2_40b5b3)
...
block_.L_40b628:                                  ; preds = %block_.L_40b5bf
  ...
  %call2_40b628 = tail call %struct.Memory* @sub_400ea0._Z5timerv(%struct.State* nonnull %0, i64 %274, %struct.Memory* %call2_40b5b3)
