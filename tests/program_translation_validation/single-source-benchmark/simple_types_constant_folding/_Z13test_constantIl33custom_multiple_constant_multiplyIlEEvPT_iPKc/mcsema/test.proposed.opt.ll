...
block_.L_40b57f:                                  ; preds = %block_.L_40b5d1, %entry
  %68 = phi i64 [ %.pre, %entry ], [ %273, %block_.L_40b5d1 ]
...
block_.L_40b59e:                                  ; preds = %block_40b5aa, %block_40b58f
  %111 = phi i64 [ %.pre1, %block_40b58f ], [ %232, %block_40b5aa ]
...
block_.L_40b5d1:                                  ; preds = %block_.L_40b59e
  ...
  %call2_40b5d5 = tail call %struct.Memory* @sub_4115e0._Z17check_shifted_sumIl33custom_multiple_constant_multiplyIlEEvT_(%struct.State* %0, i64 %237, %struct.Memory* %MEMORY.1)
...
block_.L_40b5e8:                                  ; preds = %block_.L_40b57f
  ...
  %call2_40b5e8 = tail call %struct.Memory* @sub_400e60._Z5timerv(%struct.State* %0, i64 %274, %struct.Memory* %MEMORY.0)
  ...
  %call2_40b5f1 = tail call %struct.Memory* @sub_400800._Z13record_resultdPKc(%struct.State* %0, i64 %285, %struct.Memory* %call2_40b5e8)
