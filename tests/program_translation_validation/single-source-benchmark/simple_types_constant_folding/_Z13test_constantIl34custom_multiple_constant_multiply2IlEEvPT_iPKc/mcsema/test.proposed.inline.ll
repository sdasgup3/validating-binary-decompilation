...
define %struct.Memory* @_Z13test_constantIl34custom_multiple_constant_multiply2IlEEvPT_iPKc(%struct.State* noalias, i64, %struct.Memory* noalias) #1 {
entry:
...
block_40b68a:                                     ; preds = %block_.L_40b67e
  ...
  store %struct.Memory* %loadMem_40b68a, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem1_40b696, %struct.Memory** %MEMORY
...
block_.L_40b6b1:                                  ; preds = %block_.L_40b67e
  ...
  store %struct.Memory* %loadMem1_40b6b5, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_40b6ba, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_40b6bd, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_40b6c0, %struct.Memory** %MEMORY
...
block_.L_40b6c8:                                  ; preds = %block_.L_40b65f
  ...
  store %struct.Memory* %loadMem1_40b6c8, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem1_40b6d1, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_40b6d6, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_40b6db, %struct.Memory** %MEMORY
  ret %struct.Memory* %loadMem_40b6db
}
