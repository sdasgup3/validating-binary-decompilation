...
block_.L_40b61f:                                  ; preds = %block_.L_40b671, %entry
  %68 = phi i64 [ %.pre, %entry ], [ %273, %block_.L_40b671 ]
...
block_.L_40b63e:                                  ; preds = %block_40b64a, %block_40b62f
  %111 = phi i64 [ %.pre1, %block_40b62f ], [ %232, %block_40b64a ]
...
block_.L_40b671:                                  ; preds = %block_.L_40b63e
  ...
  %call2_40b675 = tail call %struct.Memory* @sub_411560._Z17check_shifted_sumIl34custom_multiple_constant_multiply2IlEEvT_(%struct.State* %0, i64 %237, %struct.Memory* %MEMORY.1)
...
block_.L_40b688:                                  ; preds = %block_.L_40b61f
  ...
  %call2_40b688 = tail call %struct.Memory* @sub_400e60._Z5timerv(%struct.State* %0, i64 %274, %struct.Memory* %MEMORY.0)
  ...
  %call2_40b691 = tail call %struct.Memory* @sub_400800._Z13record_resultdPKc(%struct.State* %0, i64 %285, %struct.Memory* %call2_40b688)
