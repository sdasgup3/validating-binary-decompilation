...
declare %struct.Memory* @sub_411580._ZN34custom_multiple_constant_multiply2IlE8do_shiftEl(%struct.State* dereferenceable(3376), i64, %struct.Memory*) local_unnamed_addr

declare %struct.Memory* @sub_4115a0._Z17check_shifted_sumIl34custom_multiple_constant_multiply2IlEEvT_(%struct.State* dereferenceable(3376), i64, %struct.Memory*) local_unnamed_addr
...
block_.L_40b65f:                                  ; preds = %block_.L_40b6b1, %entry
  %68 = phi i64 [ %.pre, %entry ], [ %273, %block_.L_40b6b1 ]
  %MEMORY.0 = phi %struct.Memory* [ %call2_40b653, %entry ], [ %call2_40b6b5, %block_.L_40b6b1 ]
...
block_.L_40b67e:                                  ; preds = %block_40b68a, %block_40b66f
  %111 = phi i64 [ %.pre6, %block_40b66f ], [ %232, %block_40b68a ]
  %MEMORY.1 = phi %struct.Memory* [ %MEMORY.0, %block_40b66f ], [ %call2_40b696, %block_40b68a ]
...
block_40b68a:                                     ; preds = %block_.L_40b67e
  ...
  %call2_40b696 = tail call %struct.Memory* @sub_411580._ZN34custom_multiple_constant_multiply2IlE8do_shiftEl(%struct.State* nonnull %0, i64 %161, %struct.Memory* %MEMORY.1)
...
block_.L_40b6b1:                                  ; preds = %block_.L_40b67e
  ...
  %call2_40b6b5 = tail call %struct.Memory* @sub_4115a0._Z17check_shifted_sumIl34custom_multiple_constant_multiply2IlEEvT_(%struct.State* nonnull %0, i64 %237, %struct.Memory* %MEMORY.1)
...
block_.L_40b6c8:                                  ; preds = %block_.L_40b65f
  ...
  %call2_40b6c8 = tail call %struct.Memory* @sub_400ea0._Z5timerv(%struct.State* nonnull %0, i64 %274, %struct.Memory* %MEMORY.0)
