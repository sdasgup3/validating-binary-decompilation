...
declare %struct.Memory* @sub_410f50._ZN10custom_twoImE8do_shiftEm(%struct.State* noalias dereferenceable(3376), i64, %struct.Memory* noalias readnone returned) local_unnamed_addr

declare %struct.Memory* @sub_410f60._Z17check_shifted_sumIm10custom_twoImEEvT_(%struct.State* noalias dereferenceable(3376), i64, %struct.Memory* noalias readnone returned) local_unnamed_addr
...
define %struct.Memory* @_Z13test_constantIm10custom_twoImEEvPT_iPKc(%struct.State* noalias, i64, %struct.Memory* noalias readnone) local_unnamed_addr #1 {
entry:
...
block_.L_40bd7f:                                  ; preds = %block_.L_40bdd1, %entry
  %68 = phi i64 [ %273, %block_.L_40bdd1 ], [ %.pre, %entry ]
...
block_.L_40bd9e:                                  ; preds = %block_40bdaa, %block_40bd8f
  %111 = phi i64 [ %232, %block_40bdaa ], [ %.pre6, %block_40bd8f ]
...
block_40bdaa:                                     ; preds = %block_.L_40bd9e
  ...
  %call2_40bdb6 = tail call %struct.Memory* @sub_410f50._ZN10custom_twoImE8do_shiftEm(%struct.State* nonnull %0, i64 %161, %struct.Memory* %call2_40bd73)
...
block_.L_40bdd1:                                  ; preds = %block_.L_40bd9e
  ...
  %call2_40bdd5 = tail call %struct.Memory* @sub_410f60._Z17check_shifted_sumIm10custom_twoImEEvT_(%struct.State* nonnull %0, i64 %237, %struct.Memory* %call2_40bd73)
...
block_.L_40bde8:                                  ; preds = %block_.L_40bd7f
  ...
  %call2_40bde8 = tail call %struct.Memory* @sub_400ea0._Z5timerv(%struct.State* nonnull %0, i64 %274, %struct.Memory* %call2_40bd73)
