...
declare %struct.Memory* @sub_410f70._Z17check_shifted_sumIm10custom_twoImEEvT_(%struct.State* noalias dereferenceable(3376), i64, %struct.Memory* noalias readnone returned) local_unnamed_addr
...
entry:
  ...
  %call2_40bd83 = tail call %struct.Memory* @sub_400e90._Z11start_timerv(%struct.State* %0, i64 %58, %struct.Memory* %2)
  ...
  br label %block_.L_40bd8f

block_.L_40bd8f:                                  ; preds = %block_.L_40bde1, %entry
  %68 = phi i64 [ %273, %block_.L_40bde1 ], [ %.pre, %entry ]
  ...
  br i1 %101, label %block_40bd9f, label %block_.L_40bdf8

block_40bd9f:                                     ; preds = %block_.L_40bd8f
  %103 = add i64 %69, -40
  %104 = add i64 %102, 8
...
block_.L_40bdae:                                  ; preds = %block_40bdba, %block_40bd9f
  %111 = phi i64 [ %232, %block_40bdba ], [ %.pre6, %block_40bd9f ]
  ...
  br i1 %147, label %block_40bdba, label %block_.L_40bde1

block_40bdba:                                     ; preds = %block_.L_40bdae
  %149 = add i64 %112, -8
  %150 = add i64 %148, 4
  ...
  %call2_40bdc6 = tail call %struct.Memory* @sub_410f60._ZN10custom_twoImE8do_shiftEm(%struct.State* nonnull %0, i64 %161, %struct.Memory* %call2_40bd83)
...
block_.L_40bde1:                                  ; preds = %block_.L_40bdae
  %233 = add i64 %112, -40
  %234 = add i64 %148, 4
  ...
  %call2_40bde5 = tail call %struct.Memory* @sub_410f70._Z17check_shifted_sumIm10custom_twoImEEvT_(%struct.State* nonnull %0, i64 %237, %struct.Memory* %call2_40bd83)
...
block_.L_40bdf8:                                  ; preds = %block_.L_40bd8f
  ...
  %call2_40bdf8 = tail call %struct.Memory* @sub_400eb0._Z5timerv(%struct.State* nonnull %0, i64 %274, %struct.Memory* %call2_40bd83)
  ...
  %call2_40be01 = tail call %struct.Memory* @sub_400850._Z13record_resultdPKc(%struct.State* nonnull %0, i64 %285, %struct.Memory* %call2_40bdf8)
