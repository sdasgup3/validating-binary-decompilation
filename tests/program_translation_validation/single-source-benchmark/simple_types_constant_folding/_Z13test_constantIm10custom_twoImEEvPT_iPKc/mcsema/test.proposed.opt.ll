...
block_.L_40bd3f:                                  ; preds = %block_.L_40bd91, %entry
  %68 = phi i64 [ %.pre, %entry ], [ %275, %block_.L_40bd91 ]
...
block_.L_40bd5e:                                  ; preds = %block_40bd6a, %block_40bd4f
  %111 = phi i64 [ %.pre1, %block_40bd4f ], [ %233, %block_40bd6a ]
...
block_.L_40bd91:                                  ; preds = %block_.L_40bd5e
  ...
  %call2_40bd95 = tail call %struct.Memory* @sub_410f20._Z17check_shifted_sumIm10custom_twoImEEvT_(%struct.State* %0, i64 %238, %struct.Memory* %MEMORY.1)
...
block_.L_40bda8:                                  ; preds = %block_.L_40bd3f
  ...
  %call2_40bda8 = tail call %struct.Memory* @sub_400e60._Z5timerv(%struct.State* %0, i64 %276, %struct.Memory* %MEMORY.0)
  ...
  %call2_40bdb1 = tail call %struct.Memory* @sub_400800._Z13record_resultdPKc(%struct.State* %0, i64 %287, %struct.Memory* %call2_40bda8)
