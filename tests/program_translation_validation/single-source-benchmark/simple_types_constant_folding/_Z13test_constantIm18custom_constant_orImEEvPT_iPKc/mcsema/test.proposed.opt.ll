...
declare %struct.Memory* @sub_40fcb0._ZN18custom_constant_orImE8do_shiftEm(%struct.State* noalias dereferenceable(3376), i64, %struct.Memory* noalias readnone returned) local_unnamed_addr

declare %struct.Memory* @sub_40fcd0._Z17check_shifted_sumIm18custom_constant_orImEEvT_(%struct.State* noalias dereferenceable(3376), i64, %struct.Memory* noalias readnone returned) local_unnamed_addr
...
define %struct.Memory* @_Z13test_constantIm18custom_constant_orImEEvPT_iPKc(%struct.State* noalias, i64, %struct.Memory* noalias readnone) local_unnamed_addr #1 {
entry:
...
block_.L_40ceff:                                  ; preds = %block_.L_40cf51, %entry
  %68 = phi i64 [ %273, %block_.L_40cf51 ], [ %.pre, %entry ]
...
block_.L_40cf1e:                                  ; preds = %block_40cf2a, %block_40cf0f
  %111 = phi i64 [ %232, %block_40cf2a ], [ %.pre6, %block_40cf0f ]
...
block_40cf2a:                                     ; preds = %block_.L_40cf1e
  ...
  %call2_40cf36 = tail call %struct.Memory* @sub_40fcb0._ZN18custom_constant_orImE8do_shiftEm(%struct.State* nonnull %0, i64 %161, %struct.Memory* %call2_40cef3)
...
block_.L_40cf51:                                  ; preds = %block_.L_40cf1e
  ...
  %call2_40cf55 = tail call %struct.Memory* @sub_40fcd0._Z17check_shifted_sumIm18custom_constant_orImEEvT_(%struct.State* nonnull %0, i64 %237, %struct.Memory* %call2_40cef3)
...
block_.L_40cf68:                                  ; preds = %block_.L_40ceff
  ...
  %call2_40cf68 = tail call %struct.Memory* @sub_400ea0._Z5timerv(%struct.State* nonnull %0, i64 %274, %struct.Memory* %call2_40cef3)
