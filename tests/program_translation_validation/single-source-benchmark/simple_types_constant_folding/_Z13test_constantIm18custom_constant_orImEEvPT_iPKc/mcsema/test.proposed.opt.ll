...
block_.L_40cebf:                                  ; preds = %block_.L_40cf11, %entry
  %68 = phi i64 [ %.pre, %entry ], [ %275, %block_.L_40cf11 ]
...
block_.L_40cede:                                  ; preds = %block_40ceea, %block_40cecf
  %111 = phi i64 [ %.pre1, %block_40cecf ], [ %233, %block_40ceea ]
...
block_.L_40cf11:                                  ; preds = %block_.L_40cede
  ...
  %call2_40cf15 = tail call %struct.Memory* @sub_40fc90._Z17check_shifted_sumIm18custom_constant_orImEEvT_(%struct.State* %0, i64 %238, %struct.Memory* %MEMORY.1)
...
block_.L_40cf28:                                  ; preds = %block_.L_40cebf
  ...
  %call2_40cf28 = tail call %struct.Memory* @sub_400e60._Z5timerv(%struct.State* %0, i64 %276, %struct.Memory* %MEMORY.0)
  ...
  %call2_40cf31 = tail call %struct.Memory* @sub_400800._Z13record_resultdPKc(%struct.State* %0, i64 %287, %struct.Memory* %call2_40cf28)
