...
declare %struct.Memory* @sub_40fce0._Z17check_shifted_sumIm18custom_constant_orImEEvT_(%struct.State* noalias dereferenceable(3376), i64, %struct.Memory* noalias readnone returned) local_unnamed_addr
...
entry:
  ...
  %call2_40cf03 = tail call %struct.Memory* @sub_400e90._Z11start_timerv(%struct.State* %0, i64 %58, %struct.Memory* %2)
...
block_.L_40cf0f:                                  ; preds = %block_.L_40cf61, %entry
  %68 = phi i64 [ %273, %block_.L_40cf61 ], [ %.pre, %entry ]
  ...
  br i1 %101, label %block_40cf1f, label %block_.L_40cf78

block_40cf1f:                                     ; preds = %block_.L_40cf0f
  %103 = add i64 %69, -40
  %104 = add i64 %102, 8
...
block_.L_40cf2e:                                  ; preds = %block_40cf3a, %block_40cf1f
  %111 = phi i64 [ %232, %block_40cf3a ], [ %.pre6, %block_40cf1f ]
  ...
  br i1 %147, label %block_40cf3a, label %block_.L_40cf61

block_40cf3a:                                     ; preds = %block_.L_40cf2e
  %149 = add i64 %112, -8
  %150 = add i64 %148, 4
  ...
  %call2_40cf46 = tail call %struct.Memory* @sub_40fcc0._ZN18custom_constant_orImE8do_shiftEm(%struct.State* nonnull %0, i64 %161, %struct.Memory* %call2_40cf03)
...
block_.L_40cf61:                                  ; preds = %block_.L_40cf2e
  %233 = add i64 %112, -40
  %234 = add i64 %148, 4
  ...
  %call2_40cf65 = tail call %struct.Memory* @sub_40fce0._Z17check_shifted_sumIm18custom_constant_orImEEvT_(%struct.State* nonnull %0, i64 %237, %struct.Memory* %call2_40cf03)
...
block_.L_40cf78:                                  ; preds = %block_.L_40cf0f
  ...
  %call2_40cf78 = tail call %struct.Memory* @sub_400eb0._Z5timerv(%struct.State* nonnull %0, i64 %274, %struct.Memory* %call2_40cf03)
  ...
  %call2_40cf81 = tail call %struct.Memory* @sub_400850._Z13record_resultdPKc(%struct.State* nonnull %0, i64 %285, %struct.Memory* %call2_40cf78)
  ...
  ret %struct.Memory* %call2_40cf81
}
...
; Function Attrs: alwaysinline norecurse nounwind
define %struct.Memory* @routine_jge_.L_40cf61(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i8* nocapture %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 2, i32 9
...
; Function Attrs: alwaysinline norecurse nounwind
define %struct.Memory* @routine_jmpq_.L_40cf2e(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
...
; Function Attrs: alwaysinline norecurse nounwind
define %struct.Memory* @routine_jmpq_.L_40cf0f(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
