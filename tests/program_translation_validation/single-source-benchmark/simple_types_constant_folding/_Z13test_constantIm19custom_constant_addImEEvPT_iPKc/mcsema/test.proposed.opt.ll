...
block_.L_40c69f:                                  ; preds = %block_.L_40c6f1, %entry
  %68 = phi i64 [ %.pre, %entry ], [ %275, %block_.L_40c6f1 ]
...
block_.L_40c6be:                                  ; preds = %block_40c6ca, %block_40c6af
  %111 = phi i64 [ %.pre1, %block_40c6af ], [ %233, %block_40c6ca ]
...
block_.L_40c6f1:                                  ; preds = %block_.L_40c6be
  ...
  %call2_40c6f5 = tail call %struct.Memory* @sub_4105c0._Z17check_shifted_sumIm19custom_constant_addImEEvT_(%struct.State* %0, i64 %238, %struct.Memory* %MEMORY.1)
...
block_.L_40c708:                                  ; preds = %block_.L_40c69f
  ...
  %call2_40c708 = tail call %struct.Memory* @sub_400e60._Z5timerv(%struct.State* %0, i64 %276, %struct.Memory* %MEMORY.0)
  ...
  %call2_40c711 = tail call %struct.Memory* @sub_400800._Z13record_resultdPKc(%struct.State* %0, i64 %287, %struct.Memory* %call2_40c708)
