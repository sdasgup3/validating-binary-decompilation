...
declare %struct.Memory* @sub_410610._Z17check_shifted_sumIm19custom_constant_addImEEvT_(%struct.State* noalias dereferenceable(3376), i64, %struct.Memory* noalias readnone returned) local_unnamed_addr
...
entry:
  ...
  %call2_40c6e3 = tail call %struct.Memory* @sub_400e90._Z11start_timerv(%struct.State* %0, i64 %58, %struct.Memory* %2)
...
block_.L_40c6ef:                                  ; preds = %block_.L_40c741, %entry
  %68 = phi i64 [ %273, %block_.L_40c741 ], [ %.pre, %entry ]
  ...
  br i1 %101, label %block_40c6ff, label %block_.L_40c758
...
block_.L_40c70e:                                  ; preds = %block_40c71a, %block_40c6ff
  %111 = phi i64 [ %232, %block_40c71a ], [ %.pre6, %block_40c6ff ]
  ...
  br i1 %147, label %block_40c71a, label %block_.L_40c741
...
block_40c71a:                                     ; preds = %block_.L_40c70e
  ...
  %call2_40c726 = tail call %struct.Memory* @sub_4105f0._ZN19custom_constant_addImE8do_shiftEm(%struct.State* nonnull %0, i64 %161, %struct.Memory* %call2_40c6e3)
...
block_.L_40c741:                                  ; preds = %block_.L_40c70e
  ...
  %call2_40c745 = tail call %struct.Memory* @sub_410610._Z17check_shifted_sumIm19custom_constant_addImEEvT_(%struct.State* nonnull %0, i64 %237, %struct.Memory* %call2_40c6e3)
...
block_.L_40c758:                                  ; preds = %block_.L_40c6ef
  ...
  %call2_40c758 = tail call %struct.Memory* @sub_400eb0._Z5timerv(%struct.State* nonnull %0, i64 %274, %struct.Memory* %call2_40c6e3)
  ...
  %call2_40c761 = tail call %struct.Memory* @sub_400850._Z13record_resultdPKc(%struct.State* nonnull %0, i64 %285, %struct.Memory* %call2_40c758)
