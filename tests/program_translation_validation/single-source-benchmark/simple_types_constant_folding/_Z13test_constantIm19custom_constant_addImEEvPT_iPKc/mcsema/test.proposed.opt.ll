...
declare %struct.Memory* @sub_4105e0._ZN19custom_constant_addImE8do_shiftEm(%struct.State* noalias dereferenceable(3376), i64, %struct.Memory* noalias readnone returned) local_unnamed_addr

declare %struct.Memory* @sub_410600._Z17check_shifted_sumIm19custom_constant_addImEEvT_(%struct.State* noalias dereferenceable(3376), i64, %struct.Memory* noalias readnone returned) local_unnamed_addr
...
define %struct.Memory* @_Z13test_constantIm19custom_constant_addImEEvPT_iPKc(%struct.State* noalias, i64, %struct.Memory* noalias readnone) local_unnamed_addr #1 {
entry:
...
block_.L_40c6df:                                  ; preds = %block_.L_40c731, %entry
  %68 = phi i64 [ %273, %block_.L_40c731 ], [ %.pre, %entry ]
...
block_.L_40c6fe:                                  ; preds = %block_40c70a, %block_40c6ef
  %111 = phi i64 [ %232, %block_40c70a ], [ %.pre6, %block_40c6ef ]
...
block_40c70a:                                     ; preds = %block_.L_40c6fe
  ...
  %call2_40c716 = tail call %struct.Memory* @sub_4105e0._ZN19custom_constant_addImE8do_shiftEm(%struct.State* nonnull %0, i64 %161, %struct.Memory* %call2_40c6d3)
...
block_.L_40c731:                                  ; preds = %block_.L_40c6fe
  ...
  %call2_40c735 = tail call %struct.Memory* @sub_410600._Z17check_shifted_sumIm19custom_constant_addImEEvT_(%struct.State* nonnull %0, i64 %237, %struct.Memory* %call2_40c6d3)
...
block_.L_40c748:                                  ; preds = %block_.L_40c6df
  ...
  %call2_40c748 = tail call %struct.Memory* @sub_400ea0._Z5timerv(%struct.State* nonnull %0, i64 %274, %struct.Memory* %call2_40c6d3)
