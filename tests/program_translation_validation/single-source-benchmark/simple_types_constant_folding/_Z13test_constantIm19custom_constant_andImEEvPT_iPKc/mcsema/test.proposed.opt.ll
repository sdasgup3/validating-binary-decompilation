...
block_.L_40cd7f:                                  ; preds = %block_.L_40cdd1, %entry
  %68 = phi i64 [ %.pre, %entry ], [ %273, %block_.L_40cdd1 ]
...
block_.L_40cd9e:                                  ; preds = %block_40cdaa, %block_40cd8f
  %111 = phi i64 [ %.pre1, %block_40cd8f ], [ %232, %block_40cdaa ]
...
block_.L_40cdd1:                                  ; preds = %block_.L_40cd9e
  ...
  %call2_40cdd5 = tail call %struct.Memory* @sub_40fe00._Z17check_shifted_sumIm19custom_constant_andImEEvT_(%struct.State* %0, i64 %237, %struct.Memory* %MEMORY.1)
...
block_.L_40cde8:                                  ; preds = %block_.L_40cd7f
  ...
  %call2_40cde8 = tail call %struct.Memory* @sub_400e60._Z5timerv(%struct.State* %0, i64 %274, %struct.Memory* %MEMORY.0)
  ...
  %call2_40cdf1 = tail call %struct.Memory* @sub_400800._Z13record_resultdPKc(%struct.State* %0, i64 %285, %struct.Memory* %call2_40cde8)
