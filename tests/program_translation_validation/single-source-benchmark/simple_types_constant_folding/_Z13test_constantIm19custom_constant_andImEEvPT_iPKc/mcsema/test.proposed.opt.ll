...
declare %struct.Memory* @sub_40fe20._ZN19custom_constant_andImE8do_shiftEm(%struct.State* noalias dereferenceable(3376), i64, %struct.Memory* noalias readnone returned) local_unnamed_addr

declare %struct.Memory* @sub_40fe40._Z17check_shifted_sumIm19custom_constant_andImEEvT_(%struct.State* noalias dereferenceable(3376), i64, %struct.Memory* noalias readnone returned) local_unnamed_addr
...
define %struct.Memory* @_Z13test_constantIm19custom_constant_andImEEvPT_iPKc(%struct.State* noalias, i64, %struct.Memory* noalias readnone) local_unnamed_addr #1 {
entry:
...
block_.L_40cdbf:                                  ; preds = %block_.L_40ce11, %entry
  %68 = phi i64 [ %273, %block_.L_40ce11 ], [ %.pre, %entry ]
...
block_.L_40cdde:                                  ; preds = %block_40cdea, %block_40cdcf
  %111 = phi i64 [ %232, %block_40cdea ], [ %.pre6, %block_40cdcf ]
...
block_40cdea:                                     ; preds = %block_.L_40cdde
  ...
  %call2_40cdf6 = tail call %struct.Memory* @sub_40fe20._ZN19custom_constant_andImE8do_shiftEm(%struct.State* nonnull %0, i64 %161, %struct.Memory* %call2_40cdb3)
...
block_.L_40ce11:                                  ; preds = %block_.L_40cdde
  ...
  %call2_40ce15 = tail call %struct.Memory* @sub_40fe40._Z17check_shifted_sumIm19custom_constant_andImEEvT_(%struct.State* nonnull %0, i64 %237, %struct.Memory* %call2_40cdb3)
...
block_.L_40ce28:                                  ; preds = %block_.L_40cdbf
  ...
  %call2_40ce28 = tail call %struct.Memory* @sub_400ea0._Z5timerv(%struct.State* nonnull %0, i64 %274, %struct.Memory* %call2_40cdb3)
