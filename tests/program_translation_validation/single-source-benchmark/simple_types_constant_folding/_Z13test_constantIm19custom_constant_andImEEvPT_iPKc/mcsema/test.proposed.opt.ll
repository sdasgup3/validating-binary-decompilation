...
declare %struct.Memory* @sub_40fe30._ZN19custom_constant_andImE8do_shiftEm(%struct.State* noalias dereferenceable(3376), i64, %struct.Memory* noalias readnone returned) local_unnamed_addr

declare %struct.Memory* @sub_40fe50._Z17check_shifted_sumIm19custom_constant_andImEEvT_(%struct.State* noalias dereferenceable(3376), i64, %struct.Memory* noalias readnone returned) local_unnamed_addr
...
entry:
  ...
  %call2_40cdc3 = tail call %struct.Memory* @sub_400e90._Z11start_timerv(%struct.State* %0, i64 %58, %struct.Memory* %2)
  ...
  br label %block_.L_40cdcf

block_.L_40cdcf:                                  ; preds = %block_.L_40ce21, %entry
  %68 = phi i64 [ %273, %block_.L_40ce21 ], [ %.pre, %entry ]
  ...
  br i1 %101, label %block_40cddf, label %block_.L_40ce38

block_40cddf:                                     ; preds = %block_.L_40cdcf
  %103 = add i64 %69, -40
  %104 = add i64 %102, 8
...
block_.L_40cdee:                                  ; preds = %block_40cdfa, %block_40cddf
  %111 = phi i64 [ %232, %block_40cdfa ], [ %.pre6, %block_40cddf ]
  ...
  br i1 %147, label %block_40cdfa, label %block_.L_40ce21

block_40cdfa:                                     ; preds = %block_.L_40cdee
  %149 = add i64 %112, -8
  %150 = add i64 %148, 4
  ...
  %call2_40ce06 = tail call %struct.Memory* @sub_40fe30._ZN19custom_constant_andImE8do_shiftEm(%struct.State* nonnull %0, i64 %161, %struct.Memory* %call2_40cdc3)
...
block_.L_40ce21:                                  ; preds = %block_.L_40cdee
  %233 = add i64 %112, -40
  %234 = add i64 %148, 4
  ...
  %call2_40ce25 = tail call %struct.Memory* @sub_40fe50._Z17check_shifted_sumIm19custom_constant_andImEEvT_(%struct.State* nonnull %0, i64 %237, %struct.Memory* %call2_40cdc3)
...
block_.L_40ce38:                                  ; preds = %block_.L_40cdcf
  ...
  %call2_40ce38 = tail call %struct.Memory* @sub_400eb0._Z5timerv(%struct.State* nonnull %0, i64 %274, %struct.Memory* %call2_40cdc3)
  ...
  %call2_40ce41 = tail call %struct.Memory* @sub_400850._Z13record_resultdPKc(%struct.State* nonnull %0, i64 %285, %struct.Memory* %call2_40ce38)
