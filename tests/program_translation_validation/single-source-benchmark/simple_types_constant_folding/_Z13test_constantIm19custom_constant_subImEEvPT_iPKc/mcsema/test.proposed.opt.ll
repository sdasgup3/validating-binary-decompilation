...
declare %struct.Memory* @sub_410490._Z17check_shifted_sumIm19custom_constant_subImEEvT_(%struct.State* noalias dereferenceable(3376), i64, %struct.Memory* noalias readnone returned) local_unnamed_addr
...
define %struct.Memory* @_Z13test_constantIm19custom_constant_subImEEvPT_iPKc(%struct.State* noalias, i64, %struct.Memory* noalias readnone) local_unnamed_addr #1 {
entry:
...
block_.L_40c81f:                                  ; preds = %block_.L_40c871, %entry
  %68 = phi i64 [ %273, %block_.L_40c871 ], [ %.pre, %entry ]
...
block_.L_40c83e:                                  ; preds = %block_40c84a, %block_40c82f
  %111 = phi i64 [ %232, %block_40c84a ], [ %.pre6, %block_40c82f ]
...
block_40c84a:                                     ; preds = %block_.L_40c83e
  ...
  %call2_40c856 = tail call %struct.Memory* @sub_410470._ZN19custom_constant_subImE8do_shiftEm(%struct.State* nonnull %0, i64 %161, %struct.Memory* %call2_40c813)
...
block_.L_40c871:                                  ; preds = %block_.L_40c83e
  ...
  %call2_40c875 = tail call %struct.Memory* @sub_410490._Z17check_shifted_sumIm19custom_constant_subImEEvT_(%struct.State* nonnull %0, i64 %237, %struct.Memory* %call2_40c813)
...
block_.L_40c888:                                  ; preds = %block_.L_40c81f
  ...
  %call2_40c888 = tail call %struct.Memory* @sub_400ea0._Z5timerv(%struct.State* nonnull %0, i64 %274, %struct.Memory* %call2_40c813)
