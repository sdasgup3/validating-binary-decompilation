...
declare %struct.Memory* @sub_410450._Z17check_shifted_sumIm19custom_constant_subImEEvT_(%struct.State* noalias dereferenceable(3376), i64, %struct.Memory* noalias readnone returned) local_unnamed_addr
...
entry:
  ...
  %call2_40c7d3 = tail call %struct.Memory* @sub_400e40._Z11start_timerv(%struct.State* %0, i64 %58, %struct.Memory* %2)
...
block_.L_40c7df:                                  ; preds = %block_.L_40c831, %entry
  %68 = phi i64 [ %.pre, %entry ], [ %273, %block_.L_40c831 ]
  %MEMORY.0 = phi %struct.Memory* [ %call2_40c7d3, %entry ], [ %call2_40c835, %block_.L_40c831 ]
  ...
  br i1 %101, label %block_40c7ef, label %block_.L_40c848

block_40c7ef:                                     ; preds = %block_.L_40c7df
  %103 = add i64 %69, -40
  %104 = add i64 %102, 8
...
block_.L_40c7fe:                                  ; preds = %block_40c80a, %block_40c7ef
  %111 = phi i64 [ %.pre1, %block_40c7ef ], [ %232, %block_40c80a ]
  %MEMORY.1 = phi %struct.Memory* [ %MEMORY.0, %block_40c7ef ], [ %call2_40c816, %block_40c80a ]
  ...
  br i1 %147, label %block_40c80a, label %block_.L_40c831

block_40c80a:                                     ; preds = %block_.L_40c7fe
  %149 = add i64 %112, -8
  %150 = add i64 %148, 4
  ...
  %call2_40c816 = tail call %struct.Memory* @sub_410430._ZN19custom_constant_subImE8do_shiftEm(%struct.State* %0, i64 %161, %struct.Memory* %MEMORY.1)
...
block_.L_40c831:                                  ; preds = %block_.L_40c7fe
  %233 = add i64 %112, -40
  %234 = add i64 %148, 4
  ...
  %call2_40c835 = tail call %struct.Memory* @sub_410450._Z17check_shifted_sumIm19custom_constant_subImEEvT_(%struct.State* %0, i64 %237, %struct.Memory* %MEMORY.1)
...
block_.L_40c848:                                  ; preds = %block_.L_40c7df
  ...
  %call2_40c848 = tail call %struct.Memory* @sub_400e60._Z5timerv(%struct.State* %0, i64 %274, %struct.Memory* %MEMORY.0)
  ...
  %call2_40c851 = tail call %struct.Memory* @sub_400800._Z13record_resultdPKc(%struct.State* %0, i64 %285, %struct.Memory* %call2_40c848)
  ...
  ret %struct.Memory* %call2_40c851
}
...
define %struct.Memory* @routine_jge_.L_40c848(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i8* %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
...
define %struct.Memory* @routine_jge_.L_40c831(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i8* %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 2, i32 9
...
define %struct.Memory* @routine_jmpq_.L_40c7fe(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
...
define %struct.Memory* @routine_callq_._Z17check_shifted_sumIm19custom_constant_subImEEvT_(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
...
define %struct.Memory* @routine_jmpq_.L_40c7df(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
