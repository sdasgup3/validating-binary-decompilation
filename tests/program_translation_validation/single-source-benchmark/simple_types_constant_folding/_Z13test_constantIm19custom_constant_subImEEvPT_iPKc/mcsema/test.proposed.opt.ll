...
block_.L_40c7df:                                  ; preds = %block_.L_40c831, %entry
  %68 = phi i64 [ %.pre, %entry ], [ %275, %block_.L_40c831 ]
...
block_.L_40c7fe:                                  ; preds = %block_40c80a, %block_40c7ef
  %111 = phi i64 [ %.pre1, %block_40c7ef ], [ %233, %block_40c80a ]
...
block_.L_40c831:                                  ; preds = %block_.L_40c7fe
  ...
  %call2_40c835 = tail call %struct.Memory* @sub_410450._Z17check_shifted_sumIm19custom_constant_subImEEvT_(%struct.State* %0, i64 %238, %struct.Memory* %MEMORY.1)
...
block_.L_40c848:                                  ; preds = %block_.L_40c7df
  ...
  %call2_40c848 = tail call %struct.Memory* @sub_400e60._Z5timerv(%struct.State* %0, i64 %276, %struct.Memory* %MEMORY.0)
  ...
  %call2_40c851 = tail call %struct.Memory* @sub_400800._Z13record_resultdPKc(%struct.State* %0, i64 %287, %struct.Memory* %call2_40c848)
