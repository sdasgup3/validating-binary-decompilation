...
declare %struct.Memory* @sub_40fb60._Z17check_shifted_sumIm19custom_constant_xorImEEvT_(%struct.State* dereferenceable(3376), i64, %struct.Memory*)
...
define %struct.Memory* @_Z13test_constantIm19custom_constant_xorImEEvPT_iPKc(%struct.State* noalias, i64, %struct.Memory* noalias) #1 {
entry:
