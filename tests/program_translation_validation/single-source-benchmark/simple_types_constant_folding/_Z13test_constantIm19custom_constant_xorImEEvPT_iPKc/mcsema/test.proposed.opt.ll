...
block_.L_40cfff:                                  ; preds = %block_.L_40d051, %entry
  %68 = phi i64 [ %.pre, %entry ], [ %273, %block_.L_40d051 ]
...
block_.L_40d01e:                                  ; preds = %block_40d02a, %block_40d00f
  %111 = phi i64 [ %.pre1, %block_40d00f ], [ %232, %block_40d02a ]
...
block_.L_40d051:                                  ; preds = %block_.L_40d01e
  ...
  %call2_40d055 = tail call %struct.Memory* @sub_40fb20._Z17check_shifted_sumIm19custom_constant_xorImEEvT_(%struct.State* %0, i64 %237, %struct.Memory* %MEMORY.1)
...
block_.L_40d068:                                  ; preds = %block_.L_40cfff
  ...
  %call2_40d068 = tail call %struct.Memory* @sub_400e60._Z5timerv(%struct.State* %0, i64 %274, %struct.Memory* %MEMORY.0)
  ...
  %call2_40d071 = tail call %struct.Memory* @sub_400800._Z13record_resultdPKc(%struct.State* %0, i64 %285, %struct.Memory* %call2_40d068)
