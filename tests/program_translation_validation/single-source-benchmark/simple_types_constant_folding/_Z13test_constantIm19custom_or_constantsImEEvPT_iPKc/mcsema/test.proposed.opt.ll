...
declare %struct.Memory* @sub_410730._ZN19custom_or_constantsImE8do_shiftEm(%struct.State* noalias dereferenceable(3376), i64, %struct.Memory* noalias readnone returned) local_unnamed_addr

declare %struct.Memory* @sub_410740._Z17check_shifted_sumIm19custom_or_constantsImEEvT_(%struct.State* noalias dereferenceable(3376), i64, %struct.Memory* noalias readnone returned) local_unnamed_addr
...
define %struct.Memory* @_Z13test_constantIm19custom_or_constantsImEEvPT_iPKc(%struct.State* noalias, i64, %struct.Memory* noalias readnone) local_unnamed_addr #1 {
entry:
...
block_.L_40c59f:                                  ; preds = %block_.L_40c5f1, %entry
  %68 = phi i64 [ %273, %block_.L_40c5f1 ], [ %.pre, %entry ]
...
block_.L_40c5be:                                  ; preds = %block_40c5ca, %block_40c5af
  %111 = phi i64 [ %232, %block_40c5ca ], [ %.pre6, %block_40c5af ]
...
block_40c5ca:                                     ; preds = %block_.L_40c5be
  ...
  %call2_40c5d6 = tail call %struct.Memory* @sub_410730._ZN19custom_or_constantsImE8do_shiftEm(%struct.State* nonnull %0, i64 %161, %struct.Memory* %call2_40c593)
...
block_.L_40c5f1:                                  ; preds = %block_.L_40c5be
  ...
  %call2_40c5f5 = tail call %struct.Memory* @sub_410740._Z17check_shifted_sumIm19custom_or_constantsImEEvT_(%struct.State* nonnull %0, i64 %237, %struct.Memory* %call2_40c593)
...
block_.L_40c608:                                  ; preds = %block_.L_40c59f
  ...
  %call2_40c608 = tail call %struct.Memory* @sub_400ea0._Z5timerv(%struct.State* nonnull %0, i64 %274, %struct.Memory* %call2_40c593)
