...
block_.L_40c55f:                                  ; preds = %block_.L_40c5b1, %entry
  %68 = phi i64 [ %.pre, %entry ], [ %273, %block_.L_40c5b1 ]
...
block_.L_40c57e:                                  ; preds = %block_40c58a, %block_40c56f
  %111 = phi i64 [ %.pre1, %block_40c56f ], [ %232, %block_40c58a ]
...
block_.L_40c5b1:                                  ; preds = %block_.L_40c57e
  ...
  %call2_40c5b5 = tail call %struct.Memory* @sub_410700._Z17check_shifted_sumIm19custom_or_constantsImEEvT_(%struct.State* %0, i64 %237, %struct.Memory* %MEMORY.1)
...
block_.L_40c5c8:                                  ; preds = %block_.L_40c55f
  ...
  %call2_40c5c8 = tail call %struct.Memory* @sub_400e60._Z5timerv(%struct.State* %0, i64 %274, %struct.Memory* %MEMORY.0)
  ...
  %call2_40c5d1 = tail call %struct.Memory* @sub_400800._Z13record_resultdPKc(%struct.State* %0, i64 %285, %struct.Memory* %call2_40c5c8)
