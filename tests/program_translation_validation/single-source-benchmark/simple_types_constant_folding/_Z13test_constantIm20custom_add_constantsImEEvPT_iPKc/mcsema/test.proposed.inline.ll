...
declare %struct.Memory* @sub_410eb0._ZN20custom_add_constantsImE8do_shiftEm(%struct.State* dereferenceable(3376), i64, %struct.Memory*)

declare %struct.Memory* @sub_410ec0._Z17check_shifted_sumIm20custom_add_constantsImEEvT_(%struct.State* dereferenceable(3376), i64, %struct.Memory*)
...
define %struct.Memory* @_Z13test_constantIm20custom_add_constantsImEEvPT_iPKc(%struct.State* noalias, i64, %struct.Memory* noalias) #1 {
entry:
