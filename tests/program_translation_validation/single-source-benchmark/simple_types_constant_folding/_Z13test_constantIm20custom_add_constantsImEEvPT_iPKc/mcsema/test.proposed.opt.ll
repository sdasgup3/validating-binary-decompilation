...
declare %struct.Memory* @sub_410eb0._ZN20custom_add_constantsImE8do_shiftEm(%struct.State* noalias dereferenceable(3376), i64, %struct.Memory* noalias readnone returned) local_unnamed_addr

declare %struct.Memory* @sub_410ec0._Z17check_shifted_sumIm20custom_add_constantsImEEvT_(%struct.State* noalias dereferenceable(3376), i64, %struct.Memory* noalias readnone returned) local_unnamed_addr
...
define %struct.Memory* @_Z13test_constantIm20custom_add_constantsImEEvPT_iPKc(%struct.State* noalias, i64, %struct.Memory* noalias readnone) local_unnamed_addr #1 {
entry:
...
block_.L_40be1f:                                  ; preds = %block_.L_40be71, %entry
  %68 = phi i64 [ %273, %block_.L_40be71 ], [ %.pre, %entry ]
...
block_.L_40be3e:                                  ; preds = %block_40be4a, %block_40be2f
  %111 = phi i64 [ %232, %block_40be4a ], [ %.pre6, %block_40be2f ]
...
block_40be4a:                                     ; preds = %block_.L_40be3e
  ...
  %call2_40be56 = tail call %struct.Memory* @sub_410eb0._ZN20custom_add_constantsImE8do_shiftEm(%struct.State* nonnull %0, i64 %161, %struct.Memory* %call2_40be13)
...
block_.L_40be71:                                  ; preds = %block_.L_40be3e
  ...
  %call2_40be75 = tail call %struct.Memory* @sub_410ec0._Z17check_shifted_sumIm20custom_add_constantsImEEvT_(%struct.State* nonnull %0, i64 %237, %struct.Memory* %call2_40be13)
...
block_.L_40be88:                                  ; preds = %block_.L_40be1f
  ...
  %call2_40be88 = tail call %struct.Memory* @sub_400ea0._Z5timerv(%struct.State* nonnull %0, i64 %274, %struct.Memory* %call2_40be13)
