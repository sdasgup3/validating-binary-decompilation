...
declare %struct.Memory* @sub_410ec0._ZN20custom_add_constantsImE8do_shiftEm(%struct.State* noalias dereferenceable(3376), i64, %struct.Memory* noalias readnone returned) local_unnamed_addr

declare %struct.Memory* @sub_410ed0._Z17check_shifted_sumIm20custom_add_constantsImEEvT_(%struct.State* noalias dereferenceable(3376), i64, %struct.Memory* noalias readnone returned) local_unnamed_addr
...
entry:
  ...
  %call2_40be23 = tail call %struct.Memory* @sub_400e90._Z11start_timerv(%struct.State* %0, i64 %58, %struct.Memory* %2)
  ...
  br label %block_.L_40be2f

block_.L_40be2f:                                  ; preds = %block_.L_40be81, %entry
  %68 = phi i64 [ %273, %block_.L_40be81 ], [ %.pre, %entry ]
  ...
  br i1 %101, label %block_40be3f, label %block_.L_40be98

block_40be3f:                                     ; preds = %block_.L_40be2f
  %103 = add i64 %69, -40
  %104 = add i64 %102, 8
...
block_.L_40be4e:                                  ; preds = %block_40be5a, %block_40be3f
  %111 = phi i64 [ %232, %block_40be5a ], [ %.pre6, %block_40be3f ]
  ...
  br i1 %147, label %block_40be5a, label %block_.L_40be81

block_40be5a:                                     ; preds = %block_.L_40be4e
  %149 = add i64 %112, -8
  %150 = add i64 %148, 4
  ...
  %call2_40be66 = tail call %struct.Memory* @sub_410ec0._ZN20custom_add_constantsImE8do_shiftEm(%struct.State* nonnull %0, i64 %161, %struct.Memory* %call2_40be23)
...
block_.L_40be81:                                  ; preds = %block_.L_40be4e
  %233 = add i64 %112, -40
  %234 = add i64 %148, 4
  ...
  %call2_40be85 = tail call %struct.Memory* @sub_410ed0._Z17check_shifted_sumIm20custom_add_constantsImEEvT_(%struct.State* nonnull %0, i64 %237, %struct.Memory* %call2_40be23)
...
block_.L_40be98:                                  ; preds = %block_.L_40be2f
  ...
  %call2_40be98 = tail call %struct.Memory* @sub_400eb0._Z5timerv(%struct.State* nonnull %0, i64 %274, %struct.Memory* %call2_40be23)
  ...
  %call2_40bea1 = tail call %struct.Memory* @sub_400850._Z13record_resultdPKc(%struct.State* nonnull %0, i64 %285, %struct.Memory* %call2_40be98)
