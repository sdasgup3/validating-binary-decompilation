...
block_.L_40bddf:                                  ; preds = %block_.L_40be31, %entry
  %68 = phi i64 [ %.pre, %entry ], [ %275, %block_.L_40be31 ]
...
block_.L_40bdfe:                                  ; preds = %block_40be0a, %block_40bdef
  %111 = phi i64 [ %.pre1, %block_40bdef ], [ %233, %block_40be0a ]
...
block_.L_40be31:                                  ; preds = %block_.L_40bdfe
  ...
  %call2_40be35 = tail call %struct.Memory* @sub_410e80._Z17check_shifted_sumIm20custom_add_constantsImEEvT_(%struct.State* %0, i64 %238, %struct.Memory* %MEMORY.1)
...
block_.L_40be48:                                  ; preds = %block_.L_40bddf
  ...
  %call2_40be48 = tail call %struct.Memory* @sub_400e60._Z5timerv(%struct.State* %0, i64 %276, %struct.Memory* %MEMORY.0)
  ...
  %call2_40be51 = tail call %struct.Memory* @sub_400800._Z13record_resultdPKc(%struct.State* %0, i64 %287, %struct.Memory* %call2_40be48)
