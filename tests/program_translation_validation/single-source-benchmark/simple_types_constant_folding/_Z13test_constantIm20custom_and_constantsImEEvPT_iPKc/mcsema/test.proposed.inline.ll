...
declare %struct.Memory* @sub_4107d0._ZN20custom_and_constantsImE8do_shiftEm(%struct.State* dereferenceable(3376), i64, %struct.Memory*)

declare %struct.Memory* @sub_4107e0._Z17check_shifted_sumIm20custom_and_constantsImEEvT_(%struct.State* dereferenceable(3376), i64, %struct.Memory*)
...
define %struct.Memory* @_Z13test_constantIm20custom_and_constantsImEEvPT_iPKc(%struct.State* noalias, i64, %struct.Memory* noalias) #1 {
entry:
