...
declare %struct.Memory* @sub_4107e0._Z17check_shifted_sumIm20custom_and_constantsImEEvT_(%struct.State* noalias dereferenceable(3376), i64, %struct.Memory* noalias readnone returned) local_unnamed_addr
...
block_.L_40c4ff:                                  ; preds = %block_.L_40c551, %entry
  %68 = phi i64 [ %273, %block_.L_40c551 ], [ %.pre, %entry ]
...
block_.L_40c51e:                                  ; preds = %block_40c52a, %block_40c50f
  %111 = phi i64 [ %232, %block_40c52a ], [ %.pre6, %block_40c50f ]
...
block_40c52a:                                     ; preds = %block_.L_40c51e
  ...
  %call2_40c536 = tail call %struct.Memory* @sub_4107d0._ZN20custom_and_constantsImE8do_shiftEm(%struct.State* nonnull %0, i64 %161, %struct.Memory* %call2_40c4f3)
...
block_.L_40c551:                                  ; preds = %block_.L_40c51e
  ...
  %call2_40c555 = tail call %struct.Memory* @sub_4107e0._Z17check_shifted_sumIm20custom_and_constantsImEEvT_(%struct.State* nonnull %0, i64 %237, %struct.Memory* %call2_40c4f3)
...
block_.L_40c568:                                  ; preds = %block_.L_40c4ff
  ...
  %call2_40c568 = tail call %struct.Memory* @sub_400ea0._Z5timerv(%struct.State* nonnull %0, i64 %274, %struct.Memory* %call2_40c4f3)
