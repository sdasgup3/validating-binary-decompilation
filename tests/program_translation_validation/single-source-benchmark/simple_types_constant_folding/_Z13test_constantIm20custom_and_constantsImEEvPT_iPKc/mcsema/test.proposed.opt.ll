...
declare %struct.Memory* @sub_4107a0._Z17check_shifted_sumIm20custom_and_constantsImEEvT_(%struct.State* noalias dereferenceable(3376), i64, %struct.Memory* noalias readnone returned) local_unnamed_addr
...
entry:
  ...
  %call2_40c4b3 = tail call %struct.Memory* @sub_400e40._Z11start_timerv(%struct.State* %0, i64 %58, %struct.Memory* %2)
...
block_.L_40c4bf:                                  ; preds = %block_.L_40c511, %entry
  %68 = phi i64 [ %.pre, %entry ], [ %275, %block_.L_40c511 ]
  %MEMORY.0 = phi %struct.Memory* [ %call2_40c4b3, %entry ], [ %call2_40c515, %block_.L_40c511 ]
  ...
  br i1 %101, label %block_40c4cf, label %block_.L_40c528
...
block_.L_40c4de:                                  ; preds = %block_40c4ea, %block_40c4cf
  %111 = phi i64 [ %.pre1, %block_40c4cf ], [ %233, %block_40c4ea ]
  %MEMORY.1 = phi %struct.Memory* [ %MEMORY.0, %block_40c4cf ], [ %call2_40c4f6, %block_40c4ea ]
  ...
  br i1 %147, label %block_40c4ea, label %block_.L_40c511
...
block_40c4ea:                                     ; preds = %block_.L_40c4de
  ...
  %call2_40c4f6 = tail call %struct.Memory* @sub_410790._ZN20custom_and_constantsImE8do_shiftEm(%struct.State* %0, i64 %161, %struct.Memory* %MEMORY.1)
...
block_.L_40c511:                                  ; preds = %block_.L_40c4de
  ...
  %call2_40c515 = tail call %struct.Memory* @sub_4107a0._Z17check_shifted_sumIm20custom_and_constantsImEEvT_(%struct.State* %0, i64 %238, %struct.Memory* %MEMORY.1)
...
block_.L_40c528:                                  ; preds = %block_.L_40c4bf
  ...
  %call2_40c528 = tail call %struct.Memory* @sub_400e60._Z5timerv(%struct.State* %0, i64 %276, %struct.Memory* %MEMORY.0)
  ...
  %call2_40c531 = tail call %struct.Memory* @sub_400800._Z13record_resultdPKc(%struct.State* %0, i64 %287, %struct.Memory* %call2_40c528)
  ...
  ret %struct.Memory* %call2_40c531
}
...
define %struct.Memory* @routine_jge_.L_40c528(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i8* %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
...
define %struct.Memory* @routine_jge_.L_40c511(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i8* %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 2, i32 9
...
define %struct.Memory* @routine_jmpq_.L_40c4de(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
...
define %struct.Memory* @routine_callq_._Z17check_shifted_sumIm20custom_and_constantsImEEvT_(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
...
define %struct.Memory* @routine_jmpq_.L_40c4bf(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
