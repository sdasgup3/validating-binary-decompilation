...
block_.L_40c4bf:                                  ; preds = %block_.L_40c511, %entry
  %68 = phi i64 [ %.pre, %entry ], [ %273, %block_.L_40c511 ]
...
block_.L_40c4de:                                  ; preds = %block_40c4ea, %block_40c4cf
  %111 = phi i64 [ %.pre1, %block_40c4cf ], [ %232, %block_40c4ea ]
...
block_.L_40c511:                                  ; preds = %block_.L_40c4de
  ...
  %call2_40c515 = tail call %struct.Memory* @sub_4107a0._Z17check_shifted_sumIm20custom_and_constantsImEEvT_(%struct.State* %0, i64 %237, %struct.Memory* %MEMORY.1)
...
block_.L_40c528:                                  ; preds = %block_.L_40c4bf
  ...
  %call2_40c528 = tail call %struct.Memory* @sub_400e60._Z5timerv(%struct.State* %0, i64 %274, %struct.Memory* %MEMORY.0)
  ...
  %call2_40c531 = tail call %struct.Memory* @sub_400800._Z13record_resultdPKc(%struct.State* %0, i64 %285, %struct.Memory* %call2_40c528)
