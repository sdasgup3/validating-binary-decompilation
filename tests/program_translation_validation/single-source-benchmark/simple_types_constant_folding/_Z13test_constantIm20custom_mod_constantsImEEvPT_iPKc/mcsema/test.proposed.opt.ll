...
block_.L_40c05f:                                  ; preds = %block_.L_40c0b1, %entry
  %68 = phi i64 [ %.pre, %entry ], [ %273, %block_.L_40c0b1 ]
...
block_.L_40c07e:                                  ; preds = %block_40c08a, %block_40c06f
  %111 = phi i64 [ %.pre1, %block_40c06f ], [ %232, %block_40c08a ]
...
block_.L_40c0b1:                                  ; preds = %block_.L_40c07e
  ...
  %call2_40c0b5 = tail call %struct.Memory* @sub_410c00._Z17check_shifted_sumIm20custom_mod_constantsImEEvT_(%struct.State* %0, i64 %237, %struct.Memory* %MEMORY.1)
...
block_.L_40c0c8:                                  ; preds = %block_.L_40c05f
  ...
  %call2_40c0c8 = tail call %struct.Memory* @sub_400e60._Z5timerv(%struct.State* %0, i64 %274, %struct.Memory* %MEMORY.0)
  ...
  %call2_40c0d1 = tail call %struct.Memory* @sub_400800._Z13record_resultdPKc(%struct.State* %0, i64 %285, %struct.Memory* %call2_40c0c8)
