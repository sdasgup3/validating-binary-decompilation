...
declare %struct.Memory* @sub_410c30._ZN20custom_mod_constantsImE8do_shiftEm(%struct.State* dereferenceable(3376), i64, %struct.Memory*) local_unnamed_addr

declare %struct.Memory* @sub_410c40._Z17check_shifted_sumIm20custom_mod_constantsImEEvT_(%struct.State* dereferenceable(3376), i64, %struct.Memory*) local_unnamed_addr
...
block_.L_40c09f:                                  ; preds = %block_.L_40c0f1, %entry
  %68 = phi i64 [ %.pre, %entry ], [ %273, %block_.L_40c0f1 ]
  %MEMORY.0 = phi %struct.Memory* [ %call2_40c093, %entry ], [ %call2_40c0f5, %block_.L_40c0f1 ]
...
block_.L_40c0be:                                  ; preds = %block_40c0ca, %block_40c0af
  %111 = phi i64 [ %.pre6, %block_40c0af ], [ %232, %block_40c0ca ]
  %MEMORY.1 = phi %struct.Memory* [ %MEMORY.0, %block_40c0af ], [ %call2_40c0d6, %block_40c0ca ]
...
block_40c0ca:                                     ; preds = %block_.L_40c0be
  ...
  %call2_40c0d6 = tail call %struct.Memory* @sub_410c30._ZN20custom_mod_constantsImE8do_shiftEm(%struct.State* nonnull %0, i64 %161, %struct.Memory* %MEMORY.1)
...
block_.L_40c0f1:                                  ; preds = %block_.L_40c0be
  ...
  %call2_40c0f5 = tail call %struct.Memory* @sub_410c40._Z17check_shifted_sumIm20custom_mod_constantsImEEvT_(%struct.State* nonnull %0, i64 %237, %struct.Memory* %MEMORY.1)
...
block_.L_40c108:                                  ; preds = %block_.L_40c09f
  ...
  %call2_40c108 = tail call %struct.Memory* @sub_400ea0._Z5timerv(%struct.State* nonnull %0, i64 %274, %struct.Memory* %MEMORY.0)
