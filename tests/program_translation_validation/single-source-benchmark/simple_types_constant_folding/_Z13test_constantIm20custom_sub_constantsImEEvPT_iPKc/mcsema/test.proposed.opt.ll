...
declare %struct.Memory* @sub_410e10._ZN20custom_sub_constantsImE8do_shiftEm(%struct.State* dereferenceable(3376), i64, %struct.Memory*) local_unnamed_addr

declare %struct.Memory* @sub_410e20._Z17check_shifted_sumIm20custom_sub_constantsImEEvT_(%struct.State* dereferenceable(3376), i64, %struct.Memory*) local_unnamed_addr
...
block_.L_40bebf:                                  ; preds = %block_.L_40bf11, %entry
  %68 = phi i64 [ %.pre, %entry ], [ %273, %block_.L_40bf11 ]
  %MEMORY.0 = phi %struct.Memory* [ %call2_40beb3, %entry ], [ %call2_40bf15, %block_.L_40bf11 ]
...
block_.L_40bede:                                  ; preds = %block_40beea, %block_40becf
  %111 = phi i64 [ %.pre6, %block_40becf ], [ %232, %block_40beea ]
  %MEMORY.1 = phi %struct.Memory* [ %MEMORY.0, %block_40becf ], [ %call2_40bef6, %block_40beea ]
...
block_40beea:                                     ; preds = %block_.L_40bede
  ...
  %call2_40bef6 = tail call %struct.Memory* @sub_410e10._ZN20custom_sub_constantsImE8do_shiftEm(%struct.State* nonnull %0, i64 %161, %struct.Memory* %MEMORY.1)
...
block_.L_40bf11:                                  ; preds = %block_.L_40bede
  ...
  %call2_40bf15 = tail call %struct.Memory* @sub_410e20._Z17check_shifted_sumIm20custom_sub_constantsImEEvT_(%struct.State* nonnull %0, i64 %237, %struct.Memory* %MEMORY.1)
...
block_.L_40bf28:                                  ; preds = %block_.L_40bebf
  ...
  %call2_40bf28 = tail call %struct.Memory* @sub_400ea0._Z5timerv(%struct.State* nonnull %0, i64 %274, %struct.Memory* %MEMORY.0)
