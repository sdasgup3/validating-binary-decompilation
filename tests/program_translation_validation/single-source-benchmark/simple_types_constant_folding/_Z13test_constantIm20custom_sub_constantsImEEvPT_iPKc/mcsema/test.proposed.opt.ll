...
block_.L_40be7f:                                  ; preds = %block_.L_40bed1, %entry
  %68 = phi i64 [ %.pre, %entry ], [ %273, %block_.L_40bed1 ]
...
block_.L_40be9e:                                  ; preds = %block_40beaa, %block_40be8f
  %111 = phi i64 [ %.pre1, %block_40be8f ], [ %232, %block_40beaa ]
...
block_.L_40bed1:                                  ; preds = %block_.L_40be9e
  ...
  %call2_40bed5 = tail call %struct.Memory* @sub_410de0._Z17check_shifted_sumIm20custom_sub_constantsImEEvT_(%struct.State* %0, i64 %237, %struct.Memory* %MEMORY.1)
...
block_.L_40bee8:                                  ; preds = %block_.L_40be7f
  ...
  %call2_40bee8 = tail call %struct.Memory* @sub_400e60._Z5timerv(%struct.State* %0, i64 %274, %struct.Memory* %MEMORY.0)
  ...
  %call2_40bef1 = tail call %struct.Memory* @sub_400800._Z13record_resultdPKc(%struct.State* %0, i64 %285, %struct.Memory* %call2_40bee8)
