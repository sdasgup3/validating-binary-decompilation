...
block_.L_40c5ff:                                  ; preds = %block_.L_40c651, %entry
  %68 = phi i64 [ %.pre, %entry ], [ %273, %block_.L_40c651 ]
...
block_.L_40c61e:                                  ; preds = %block_40c62a, %block_40c60f
  %111 = phi i64 [ %.pre1, %block_40c60f ], [ %232, %block_40c62a ]
...
block_.L_40c651:                                  ; preds = %block_.L_40c61e
  ...
  %call2_40c655 = tail call %struct.Memory* @sub_410660._Z17check_shifted_sumIm20custom_xor_constantsImEEvT_(%struct.State* %0, i64 %237, %struct.Memory* %MEMORY.1)
...
block_.L_40c668:                                  ; preds = %block_.L_40c5ff
  ...
  %call2_40c668 = tail call %struct.Memory* @sub_400e60._Z5timerv(%struct.State* %0, i64 %274, %struct.Memory* %MEMORY.0)
  ...
  %call2_40c671 = tail call %struct.Memory* @sub_400800._Z13record_resultdPKc(%struct.State* %0, i64 %285, %struct.Memory* %call2_40c668)
