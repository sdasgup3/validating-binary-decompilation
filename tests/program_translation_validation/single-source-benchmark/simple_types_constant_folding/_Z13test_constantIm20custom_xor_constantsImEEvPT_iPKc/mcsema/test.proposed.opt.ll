...
declare %struct.Memory* @sub_4106b0._Z17check_shifted_sumIm20custom_xor_constantsImEEvT_(%struct.State* noalias dereferenceable(3376), i64, %struct.Memory* noalias readnone returned) local_unnamed_addr
...
entry:
  ...
  %call2_40c643 = tail call %struct.Memory* @sub_400e90._Z11start_timerv(%struct.State* %0, i64 %58, %struct.Memory* %2)
...
block_.L_40c64f:                                  ; preds = %block_.L_40c6a1, %entry
  %68 = phi i64 [ %273, %block_.L_40c6a1 ], [ %.pre, %entry ]
  ...
  br i1 %101, label %block_40c65f, label %block_.L_40c6b8
...
block_.L_40c66e:                                  ; preds = %block_40c67a, %block_40c65f
  %111 = phi i64 [ %232, %block_40c67a ], [ %.pre6, %block_40c65f ]
  ...
  br i1 %147, label %block_40c67a, label %block_.L_40c6a1
...
block_40c67a:                                     ; preds = %block_.L_40c66e
  ...
  %call2_40c686 = tail call %struct.Memory* @sub_4106a0._ZN20custom_xor_constantsImE8do_shiftEm(%struct.State* nonnull %0, i64 %161, %struct.Memory* %call2_40c643)
...
block_.L_40c6a1:                                  ; preds = %block_.L_40c66e
  ...
  %call2_40c6a5 = tail call %struct.Memory* @sub_4106b0._Z17check_shifted_sumIm20custom_xor_constantsImEEvT_(%struct.State* nonnull %0, i64 %237, %struct.Memory* %call2_40c643)
...
block_.L_40c6b8:                                  ; preds = %block_.L_40c64f
  ...
  %call2_40c6b8 = tail call %struct.Memory* @sub_400eb0._Z5timerv(%struct.State* nonnull %0, i64 %274, %struct.Memory* %call2_40c643)
  ...
  %call2_40c6c1 = tail call %struct.Memory* @sub_400850._Z13record_resultdPKc(%struct.State* nonnull %0, i64 %285, %struct.Memory* %call2_40c6b8)
