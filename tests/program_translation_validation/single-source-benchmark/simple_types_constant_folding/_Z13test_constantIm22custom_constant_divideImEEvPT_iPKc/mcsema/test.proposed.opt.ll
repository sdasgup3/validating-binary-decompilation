...
block_.L_40caff:                                  ; preds = %block_.L_40cb51, %entry
  %68 = phi i64 [ %.pre, %entry ], [ %273, %block_.L_40cb51 ]
...
block_.L_40cb1e:                                  ; preds = %block_40cb2a, %block_40cb0f
  %111 = phi i64 [ %.pre1, %block_40cb0f ], [ %232, %block_40cb2a ]
...
block_.L_40cb51:                                  ; preds = %block_.L_40cb1e
  ...
  %call2_40cb55 = tail call %struct.Memory* @sub_4100e0._Z17check_shifted_sumIm22custom_constant_divideImEEvT_(%struct.State* %0, i64 %237, %struct.Memory* %MEMORY.1)
...
block_.L_40cb68:                                  ; preds = %block_.L_40caff
  ...
  %call2_40cb68 = tail call %struct.Memory* @sub_400e60._Z5timerv(%struct.State* %0, i64 %274, %struct.Memory* %MEMORY.0)
  ...
  %call2_40cb71 = tail call %struct.Memory* @sub_400800._Z13record_resultdPKc(%struct.State* %0, i64 %285, %struct.Memory* %call2_40cb68)
