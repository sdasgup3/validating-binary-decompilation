...
declare %struct.Memory* @sub_410130._Z17check_shifted_sumIm22custom_constant_divideImEEvT_(%struct.State* noalias dereferenceable(3376), i64, %struct.Memory* noalias readnone returned) local_unnamed_addr
...
entry:
  ...
  %call2_40cb43 = tail call %struct.Memory* @sub_400e90._Z11start_timerv(%struct.State* %0, i64 %58, %struct.Memory* %2)
...
block_.L_40cb4f:                                  ; preds = %block_.L_40cba1, %entry
  %68 = phi i64 [ %273, %block_.L_40cba1 ], [ %.pre, %entry ]
  ...
  br i1 %101, label %block_40cb5f, label %block_.L_40cbb8
...
block_.L_40cb6e:                                  ; preds = %block_40cb7a, %block_40cb5f
  %111 = phi i64 [ %232, %block_40cb7a ], [ %.pre6, %block_40cb5f ]
  ...
  br i1 %147, label %block_40cb7a, label %block_.L_40cba1
...
block_40cb7a:                                     ; preds = %block_.L_40cb6e
  ...
  %call2_40cb86 = tail call %struct.Memory* @sub_410110._ZN22custom_constant_divideImE8do_shiftEm(%struct.State* nonnull %0, i64 %161, %struct.Memory* %call2_40cb43)
...
block_.L_40cba1:                                  ; preds = %block_.L_40cb6e
  ...
  %call2_40cba5 = tail call %struct.Memory* @sub_410130._Z17check_shifted_sumIm22custom_constant_divideImEEvT_(%struct.State* nonnull %0, i64 %237, %struct.Memory* %call2_40cb43)
...
block_.L_40cbb8:                                  ; preds = %block_.L_40cb4f
  ...
  %call2_40cbb8 = tail call %struct.Memory* @sub_400eb0._Z5timerv(%struct.State* nonnull %0, i64 %274, %struct.Memory* %call2_40cb43)
  ...
  %call2_40cbc1 = tail call %struct.Memory* @sub_400850._Z13record_resultdPKc(%struct.State* nonnull %0, i64 %285, %struct.Memory* %call2_40cbb8)
