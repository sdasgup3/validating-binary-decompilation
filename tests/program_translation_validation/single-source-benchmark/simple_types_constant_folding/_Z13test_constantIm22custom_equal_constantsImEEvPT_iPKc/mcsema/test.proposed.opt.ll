...
block_.L_40c0ff:                                  ; preds = %block_.L_40c151, %entry
  %68 = phi i64 [ %.pre, %entry ], [ %275, %block_.L_40c151 ]
...
block_.L_40c11e:                                  ; preds = %block_40c12a, %block_40c10f
  %111 = phi i64 [ %.pre1, %block_40c10f ], [ %233, %block_40c12a ]
...
block_.L_40c151:                                  ; preds = %block_.L_40c11e
  ...
  %call2_40c155 = tail call %struct.Memory* @sub_410b60._Z17check_shifted_sumIm22custom_equal_constantsImEEvT_(%struct.State* %0, i64 %238, %struct.Memory* %MEMORY.1)
...
block_.L_40c168:                                  ; preds = %block_.L_40c0ff
  ...
  %call2_40c168 = tail call %struct.Memory* @sub_400e60._Z5timerv(%struct.State* %0, i64 %276, %struct.Memory* %MEMORY.0)
  ...
  %call2_40c171 = tail call %struct.Memory* @sub_400800._Z13record_resultdPKc(%struct.State* %0, i64 %287, %struct.Memory* %call2_40c168)
