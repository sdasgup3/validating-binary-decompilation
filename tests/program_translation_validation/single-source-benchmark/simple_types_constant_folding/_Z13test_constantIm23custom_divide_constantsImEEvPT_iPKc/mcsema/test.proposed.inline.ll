...
declare %struct.Memory* @sub_410cd0._ZN23custom_divide_constantsImE8do_shiftEm(%struct.State* dereferenceable(3376), i64, %struct.Memory*)

declare %struct.Memory* @sub_410ce0._Z17check_shifted_sumIm23custom_divide_constantsImEEvT_(%struct.State* dereferenceable(3376), i64, %struct.Memory*)
...
define %struct.Memory* @_Z13test_constantIm23custom_divide_constantsImEEvPT_iPKc(%struct.State* noalias, i64, %struct.Memory* noalias) #1 {
entry:
