...
block_.L_40bfbf:                                  ; preds = %block_.L_40c011, %entry
  %68 = phi i64 [ %.pre, %entry ], [ %273, %block_.L_40c011 ]
...
block_.L_40bfde:                                  ; preds = %block_40bfea, %block_40bfcf
  %111 = phi i64 [ %.pre1, %block_40bfcf ], [ %232, %block_40bfea ]
...
block_.L_40c011:                                  ; preds = %block_.L_40bfde
  ...
  %call2_40c015 = tail call %struct.Memory* @sub_410ca0._Z17check_shifted_sumIm23custom_divide_constantsImEEvT_(%struct.State* %0, i64 %237, %struct.Memory* %MEMORY.1)
...
block_.L_40c028:                                  ; preds = %block_.L_40bfbf
  ...
  %call2_40c028 = tail call %struct.Memory* @sub_400e60._Z5timerv(%struct.State* %0, i64 %274, %struct.Memory* %MEMORY.0)
  ...
  %call2_40c031 = tail call %struct.Memory* @sub_400800._Z13record_resultdPKc(%struct.State* %0, i64 %285, %struct.Memory* %call2_40c028)
