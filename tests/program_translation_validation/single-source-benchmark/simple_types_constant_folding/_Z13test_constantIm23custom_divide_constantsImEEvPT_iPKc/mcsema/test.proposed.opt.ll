...
declare %struct.Memory* @sub_410cd0._ZN23custom_divide_constantsImE8do_shiftEm(%struct.State* dereferenceable(3376), i64, %struct.Memory*) local_unnamed_addr

declare %struct.Memory* @sub_410ce0._Z17check_shifted_sumIm23custom_divide_constantsImEEvT_(%struct.State* dereferenceable(3376), i64, %struct.Memory*) local_unnamed_addr
...
block_.L_40bfff:                                  ; preds = %block_.L_40c051, %entry
  %68 = phi i64 [ %.pre, %entry ], [ %273, %block_.L_40c051 ]
  %MEMORY.0 = phi %struct.Memory* [ %call2_40bff3, %entry ], [ %call2_40c055, %block_.L_40c051 ]
...
block_.L_40c01e:                                  ; preds = %block_40c02a, %block_40c00f
  %111 = phi i64 [ %.pre6, %block_40c00f ], [ %232, %block_40c02a ]
  %MEMORY.1 = phi %struct.Memory* [ %MEMORY.0, %block_40c00f ], [ %call2_40c036, %block_40c02a ]
...
block_40c02a:                                     ; preds = %block_.L_40c01e
  ...
  %call2_40c036 = tail call %struct.Memory* @sub_410cd0._ZN23custom_divide_constantsImE8do_shiftEm(%struct.State* nonnull %0, i64 %161, %struct.Memory* %MEMORY.1)
...
block_.L_40c051:                                  ; preds = %block_.L_40c01e
  ...
  %call2_40c055 = tail call %struct.Memory* @sub_410ce0._Z17check_shifted_sumIm23custom_divide_constantsImEEvT_(%struct.State* nonnull %0, i64 %237, %struct.Memory* %MEMORY.1)
...
block_.L_40c068:                                  ; preds = %block_.L_40bfff
  ...
  %call2_40c068 = tail call %struct.Memory* @sub_400ea0._Z5timerv(%struct.State* nonnull %0, i64 %274, %struct.Memory* %MEMORY.0)
