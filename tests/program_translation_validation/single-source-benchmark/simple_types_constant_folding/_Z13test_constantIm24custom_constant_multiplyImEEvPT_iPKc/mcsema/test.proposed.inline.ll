...
declare %struct.Memory* @sub_410310._ZN24custom_constant_multiplyImE8do_shiftEm(%struct.State* dereferenceable(3376), i64, %struct.Memory*)

declare %struct.Memory* @sub_410320._Z17check_shifted_sumIm24custom_constant_multiplyImEEvT_(%struct.State* dereferenceable(3376), i64, %struct.Memory*)
...
define %struct.Memory* @_Z13test_constantIm24custom_constant_multiplyImEEvPT_iPKc(%struct.State* noalias, i64, %struct.Memory* noalias) #1 {
entry:
