...
block_.L_40c91f:                                  ; preds = %block_.L_40c971, %entry
  %68 = phi i64 [ %.pre, %entry ], [ %275, %block_.L_40c971 ]
...
block_.L_40c93e:                                  ; preds = %block_40c94a, %block_40c92f
  %111 = phi i64 [ %.pre1, %block_40c92f ], [ %233, %block_40c94a ]
...
block_.L_40c971:                                  ; preds = %block_.L_40c93e
  ...
  %call2_40c975 = tail call %struct.Memory* @sub_4102e0._Z17check_shifted_sumIm24custom_constant_multiplyImEEvT_(%struct.State* %0, i64 %238, %struct.Memory* %MEMORY.1)
...
block_.L_40c988:                                  ; preds = %block_.L_40c91f
  ...
  %call2_40c988 = tail call %struct.Memory* @sub_400e60._Z5timerv(%struct.State* %0, i64 %276, %struct.Memory* %MEMORY.0)
  ...
  %call2_40c991 = tail call %struct.Memory* @sub_400800._Z13record_resultdPKc(%struct.State* %0, i64 %287, %struct.Memory* %call2_40c988)
