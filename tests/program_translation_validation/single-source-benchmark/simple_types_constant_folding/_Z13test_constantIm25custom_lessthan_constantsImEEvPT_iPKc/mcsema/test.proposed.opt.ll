...
declare %struct.Memory* @sub_4109c0._Z17check_shifted_sumIm25custom_lessthan_constantsImEEvT_(%struct.State* noalias dereferenceable(3376), i64, %struct.Memory* noalias readnone returned) local_unnamed_addr
...
block_.L_40c31f:                                  ; preds = %block_.L_40c371, %entry
  %68 = phi i64 [ %273, %block_.L_40c371 ], [ %.pre, %entry ]
...
block_.L_40c33e:                                  ; preds = %block_40c34a, %block_40c32f
  %111 = phi i64 [ %232, %block_40c34a ], [ %.pre6, %block_40c32f ]
...
block_40c34a:                                     ; preds = %block_.L_40c33e
  ...
  %call2_40c356 = tail call %struct.Memory* @sub_4109b0._ZN25custom_lessthan_constantsImE8do_shiftEm(%struct.State* nonnull %0, i64 %161, %struct.Memory* %call2_40c313)
...
block_.L_40c371:                                  ; preds = %block_.L_40c33e
  ...
  %call2_40c375 = tail call %struct.Memory* @sub_4109c0._Z17check_shifted_sumIm25custom_lessthan_constantsImEEvT_(%struct.State* nonnull %0, i64 %237, %struct.Memory* %call2_40c313)
...
block_.L_40c388:                                  ; preds = %block_.L_40c31f
  ...
  %call2_40c388 = tail call %struct.Memory* @sub_400ea0._Z5timerv(%struct.State* nonnull %0, i64 %274, %struct.Memory* %call2_40c313)
