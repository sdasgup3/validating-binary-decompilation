...
declare %struct.Memory* @sub_410980._Z17check_shifted_sumIm25custom_lessthan_constantsImEEvT_(%struct.State* noalias dereferenceable(3376), i64, %struct.Memory* noalias readnone returned) local_unnamed_addr
...
entry:
  ...
  %call2_40c2d3 = tail call %struct.Memory* @sub_400e40._Z11start_timerv(%struct.State* %0, i64 %58, %struct.Memory* %2)
  ...
  br label %block_.L_40c2df

block_.L_40c2df:                                  ; preds = %block_.L_40c331, %entry
  %68 = phi i64 [ %.pre, %entry ], [ %273, %block_.L_40c331 ]
  %MEMORY.0 = phi %struct.Memory* [ %call2_40c2d3, %entry ], [ %call2_40c335, %block_.L_40c331 ]
  ...
  br i1 %101, label %block_40c2ef, label %block_.L_40c348

block_40c2ef:                                     ; preds = %block_.L_40c2df
  %103 = add i64 %69, -40
  %104 = add i64 %102, 8
  ...
  br label %block_.L_40c2fe

block_.L_40c2fe:                                  ; preds = %block_40c30a, %block_40c2ef
  %111 = phi i64 [ %.pre1, %block_40c2ef ], [ %232, %block_40c30a ]
  %MEMORY.1 = phi %struct.Memory* [ %MEMORY.0, %block_40c2ef ], [ %call2_40c316, %block_40c30a ]
  ...
  br i1 %147, label %block_40c30a, label %block_.L_40c331

block_40c30a:                                     ; preds = %block_.L_40c2fe
  %149 = add i64 %112, -8
  %150 = add i64 %148, 4
  ...
  %call2_40c316 = tail call %struct.Memory* @sub_410970._ZN25custom_lessthan_constantsImE8do_shiftEm(%struct.State* %0, i64 %161, %struct.Memory* %MEMORY.1)
...
block_.L_40c331:                                  ; preds = %block_.L_40c2fe
  %233 = add i64 %112, -40
  %234 = add i64 %148, 4
  ...
  %call2_40c335 = tail call %struct.Memory* @sub_410980._Z17check_shifted_sumIm25custom_lessthan_constantsImEEvT_(%struct.State* %0, i64 %237, %struct.Memory* %MEMORY.1)
...
block_.L_40c348:                                  ; preds = %block_.L_40c2df
  ...
  %call2_40c348 = tail call %struct.Memory* @sub_400e60._Z5timerv(%struct.State* %0, i64 %274, %struct.Memory* %MEMORY.0)
  ...
  %call2_40c351 = tail call %struct.Memory* @sub_400800._Z13record_resultdPKc(%struct.State* %0, i64 %285, %struct.Memory* %call2_40c348)
  ...
  ret %struct.Memory* %call2_40c351
}
...
define %struct.Memory* @routine_jge_.L_40c348(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i8* %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
...
define %struct.Memory* @routine_jge_.L_40c331(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i8* %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 2, i32 9
...
define %struct.Memory* @routine_jmpq_.L_40c2fe(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
...
define %struct.Memory* @routine_callq_._Z17check_shifted_sumIm25custom_lessthan_constantsImEEvT_(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
...
define %struct.Memory* @routine_jmpq_.L_40c2df(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
