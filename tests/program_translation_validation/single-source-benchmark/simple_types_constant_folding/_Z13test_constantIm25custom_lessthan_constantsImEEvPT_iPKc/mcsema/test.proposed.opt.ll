...
block_.L_40c2df:                                  ; preds = %block_.L_40c331, %entry
  %68 = phi i64 [ %.pre, %entry ], [ %275, %block_.L_40c331 ]
...
block_.L_40c2fe:                                  ; preds = %block_40c30a, %block_40c2ef
  %111 = phi i64 [ %.pre1, %block_40c2ef ], [ %233, %block_40c30a ]
...
block_.L_40c331:                                  ; preds = %block_.L_40c2fe
  ...
  %call2_40c335 = tail call %struct.Memory* @sub_410980._Z17check_shifted_sumIm25custom_lessthan_constantsImEEvT_(%struct.State* %0, i64 %238, %struct.Memory* %MEMORY.1)
...
block_.L_40c348:                                  ; preds = %block_.L_40c2df
  ...
  %call2_40c348 = tail call %struct.Memory* @sub_400e60._Z5timerv(%struct.State* %0, i64 %276, %struct.Memory* %MEMORY.0)
  ...
  %call2_40c351 = tail call %struct.Memory* @sub_400800._Z13record_resultdPKc(%struct.State* %0, i64 %287, %struct.Memory* %call2_40c348)
