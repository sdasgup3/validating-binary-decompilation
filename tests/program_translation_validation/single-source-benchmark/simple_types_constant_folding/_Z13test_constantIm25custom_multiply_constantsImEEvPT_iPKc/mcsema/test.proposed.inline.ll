...
declare %struct.Memory* @sub_410d80._Z17check_shifted_sumIm25custom_multiply_constantsImEEvT_(%struct.State* dereferenceable(3376), i64, %struct.Memory*)
...
define %struct.Memory* @_Z13test_constantIm25custom_multiply_constantsImEEvPT_iPKc(%struct.State* noalias, i64, %struct.Memory* noalias) #1 {
entry:
