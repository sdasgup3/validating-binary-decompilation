...
block_.L_40bf1f:                                  ; preds = %block_.L_40bf71, %entry
  %68 = phi i64 [ %.pre, %entry ], [ %273, %block_.L_40bf71 ]
...
block_.L_40bf3e:                                  ; preds = %block_40bf4a, %block_40bf2f
  %111 = phi i64 [ %.pre1, %block_40bf2f ], [ %232, %block_40bf4a ]
...
block_.L_40bf71:                                  ; preds = %block_.L_40bf3e
  ...
  %call2_40bf75 = tail call %struct.Memory* @sub_410d40._Z17check_shifted_sumIm25custom_multiply_constantsImEEvT_(%struct.State* %0, i64 %237, %struct.Memory* %MEMORY.1)
...
block_.L_40bf88:                                  ; preds = %block_.L_40bf1f
  ...
  %call2_40bf88 = tail call %struct.Memory* @sub_400e60._Z5timerv(%struct.State* %0, i64 %274, %struct.Memory* %MEMORY.0)
  ...
  %call2_40bf91 = tail call %struct.Memory* @sub_400800._Z13record_resultdPKc(%struct.State* %0, i64 %285, %struct.Memory* %call2_40bf88)
