...
declare %struct.Memory* @sub_410d70._ZN25custom_multiply_constantsImE8do_shiftEm(%struct.State* dereferenceable(3376), i64, %struct.Memory*) local_unnamed_addr

declare %struct.Memory* @sub_410d80._Z17check_shifted_sumIm25custom_multiply_constantsImEEvT_(%struct.State* dereferenceable(3376), i64, %struct.Memory*) local_unnamed_addr
...
block_.L_40bf5f:                                  ; preds = %block_.L_40bfb1, %entry
  %68 = phi i64 [ %.pre, %entry ], [ %273, %block_.L_40bfb1 ]
  %MEMORY.0 = phi %struct.Memory* [ %call2_40bf53, %entry ], [ %call2_40bfb5, %block_.L_40bfb1 ]
...
block_.L_40bf7e:                                  ; preds = %block_40bf8a, %block_40bf6f
  %111 = phi i64 [ %.pre6, %block_40bf6f ], [ %232, %block_40bf8a ]
  %MEMORY.1 = phi %struct.Memory* [ %MEMORY.0, %block_40bf6f ], [ %call2_40bf96, %block_40bf8a ]
...
block_40bf8a:                                     ; preds = %block_.L_40bf7e
  ...
  %call2_40bf96 = tail call %struct.Memory* @sub_410d70._ZN25custom_multiply_constantsImE8do_shiftEm(%struct.State* nonnull %0, i64 %161, %struct.Memory* %MEMORY.1)
...
block_.L_40bfb1:                                  ; preds = %block_.L_40bf7e
  ...
  %call2_40bfb5 = tail call %struct.Memory* @sub_410d80._Z17check_shifted_sumIm25custom_multiply_constantsImEEvT_(%struct.State* nonnull %0, i64 %237, %struct.Memory* %MEMORY.1)
...
block_.L_40bfc8:                                  ; preds = %block_.L_40bf5f
  ...
  %call2_40bfc8 = tail call %struct.Memory* @sub_400ea0._Z5timerv(%struct.State* nonnull %0, i64 %274, %struct.Memory* %MEMORY.0)
