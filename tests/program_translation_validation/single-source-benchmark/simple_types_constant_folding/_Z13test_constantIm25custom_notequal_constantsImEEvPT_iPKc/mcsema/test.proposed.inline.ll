...
declare %struct.Memory* @sub_410af0._ZN25custom_notequal_constantsImE8do_shiftEm(%struct.State* dereferenceable(3376), i64, %struct.Memory*)

declare %struct.Memory* @sub_410b00._Z17check_shifted_sumIm25custom_notequal_constantsImEEvT_(%struct.State* dereferenceable(3376), i64, %struct.Memory*)
...
define %struct.Memory* @_Z13test_constantIm25custom_notequal_constantsImEEvPT_iPKc(%struct.State* noalias, i64, %struct.Memory* noalias) #1 {
entry:
