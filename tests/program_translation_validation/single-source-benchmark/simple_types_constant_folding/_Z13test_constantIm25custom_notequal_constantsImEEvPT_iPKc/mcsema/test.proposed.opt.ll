...
declare %struct.Memory* @sub_410b10._Z17check_shifted_sumIm25custom_notequal_constantsImEEvT_(%struct.State* noalias dereferenceable(3376), i64, %struct.Memory* noalias readnone returned) local_unnamed_addr
...
entry:
  ...
  %call2_40c1e3 = tail call %struct.Memory* @sub_400e90._Z11start_timerv(%struct.State* %0, i64 %58, %struct.Memory* %2)
...
block_.L_40c1ef:                                  ; preds = %block_.L_40c241, %entry
  %68 = phi i64 [ %273, %block_.L_40c241 ], [ %.pre, %entry ]
  ...
  br i1 %101, label %block_40c1ff, label %block_.L_40c258
...
block_.L_40c20e:                                  ; preds = %block_40c21a, %block_40c1ff
  %111 = phi i64 [ %232, %block_40c21a ], [ %.pre6, %block_40c1ff ]
  ...
  br i1 %147, label %block_40c21a, label %block_.L_40c241
...
block_40c21a:                                     ; preds = %block_.L_40c20e
  ...
  %call2_40c226 = tail call %struct.Memory* @sub_410b00._ZN25custom_notequal_constantsImE8do_shiftEm(%struct.State* nonnull %0, i64 %161, %struct.Memory* %call2_40c1e3)
...
block_.L_40c241:                                  ; preds = %block_.L_40c20e
  ...
  %call2_40c245 = tail call %struct.Memory* @sub_410b10._Z17check_shifted_sumIm25custom_notequal_constantsImEEvT_(%struct.State* nonnull %0, i64 %237, %struct.Memory* %call2_40c1e3)
...
block_.L_40c258:                                  ; preds = %block_.L_40c1ef
  ...
  %call2_40c258 = tail call %struct.Memory* @sub_400eb0._Z5timerv(%struct.State* nonnull %0, i64 %274, %struct.Memory* %call2_40c1e3)
  ...
  %call2_40c261 = tail call %struct.Memory* @sub_400850._Z13record_resultdPKc(%struct.State* nonnull %0, i64 %285, %struct.Memory* %call2_40c258)
