...
block_.L_40c19f:                                  ; preds = %block_.L_40c1f1, %entry
  %68 = phi i64 [ %.pre, %entry ], [ %275, %block_.L_40c1f1 ]
...
block_.L_40c1be:                                  ; preds = %block_40c1ca, %block_40c1af
  %111 = phi i64 [ %.pre1, %block_40c1af ], [ %233, %block_40c1ca ]
...
block_.L_40c1f1:                                  ; preds = %block_.L_40c1be
  ...
  %call2_40c1f5 = tail call %struct.Memory* @sub_410ac0._Z17check_shifted_sumIm25custom_notequal_constantsImEEvT_(%struct.State* %0, i64 %238, %struct.Memory* %MEMORY.1)
...
block_.L_40c208:                                  ; preds = %block_.L_40c19f
  ...
  %call2_40c208 = tail call %struct.Memory* @sub_400e60._Z5timerv(%struct.State* %0, i64 %276, %struct.Memory* %MEMORY.0)
  ...
  %call2_40c211 = tail call %struct.Memory* @sub_400800._Z13record_resultdPKc(%struct.State* %0, i64 %287, %struct.Memory* %call2_40c208)
