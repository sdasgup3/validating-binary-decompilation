...
declare %struct.Memory* @sub_410af0._ZN25custom_notequal_constantsImE8do_shiftEm(%struct.State* noalias dereferenceable(3376), i64, %struct.Memory* noalias readnone returned) local_unnamed_addr

declare %struct.Memory* @sub_410b00._Z17check_shifted_sumIm25custom_notequal_constantsImEEvT_(%struct.State* noalias dereferenceable(3376), i64, %struct.Memory* noalias readnone returned) local_unnamed_addr
...
define %struct.Memory* @_Z13test_constantIm25custom_notequal_constantsImEEvPT_iPKc(%struct.State* noalias, i64, %struct.Memory* noalias readnone) local_unnamed_addr #1 {
entry:
...
block_.L_40c1df:                                  ; preds = %block_.L_40c231, %entry
  %68 = phi i64 [ %273, %block_.L_40c231 ], [ %.pre, %entry ]
...
block_.L_40c1fe:                                  ; preds = %block_40c20a, %block_40c1ef
  %111 = phi i64 [ %232, %block_40c20a ], [ %.pre6, %block_40c1ef ]
...
block_40c20a:                                     ; preds = %block_.L_40c1fe
  ...
  %call2_40c216 = tail call %struct.Memory* @sub_410af0._ZN25custom_notequal_constantsImE8do_shiftEm(%struct.State* nonnull %0, i64 %161, %struct.Memory* %call2_40c1d3)
...
block_.L_40c231:                                  ; preds = %block_.L_40c1fe
  ...
  %call2_40c235 = tail call %struct.Memory* @sub_410b00._Z17check_shifted_sumIm25custom_notequal_constantsImEEvT_(%struct.State* nonnull %0, i64 %237, %struct.Memory* %call2_40c1d3)
...
block_.L_40c248:                                  ; preds = %block_.L_40c1df
  ...
  %call2_40c248 = tail call %struct.Memory* @sub_400ea0._Z5timerv(%struct.State* nonnull %0, i64 %274, %struct.Memory* %call2_40c1d3)
