...
declare %struct.Memory* @sub_40fbf0._ZN27custom_multiple_constant_orImE8do_shiftEm(%struct.State* noalias dereferenceable(3376), i64, %struct.Memory* noalias readnone returned) local_unnamed_addr

declare %struct.Memory* @sub_40fc20._Z17check_shifted_sumIm27custom_multiple_constant_orImEEvT_(%struct.State* noalias dereferenceable(3376), i64, %struct.Memory* noalias readnone returned) local_unnamed_addr
...
define %struct.Memory* @_Z13test_constantIm27custom_multiple_constant_orImEEvPT_iPKc(%struct.State* noalias, i64, %struct.Memory* noalias readnone) local_unnamed_addr #1 {
entry:
...
block_.L_40cf9f:                                  ; preds = %block_.L_40cff1, %entry
  %68 = phi i64 [ %273, %block_.L_40cff1 ], [ %.pre, %entry ]
...
block_.L_40cfbe:                                  ; preds = %block_40cfca, %block_40cfaf
  %111 = phi i64 [ %232, %block_40cfca ], [ %.pre6, %block_40cfaf ]
...
block_40cfca:                                     ; preds = %block_.L_40cfbe
  ...
  %call2_40cfd6 = tail call %struct.Memory* @sub_40fbf0._ZN27custom_multiple_constant_orImE8do_shiftEm(%struct.State* nonnull %0, i64 %161, %struct.Memory* %call2_40cf93)
...
block_.L_40cff1:                                  ; preds = %block_.L_40cfbe
  ...
  %call2_40cff5 = tail call %struct.Memory* @sub_40fc20._Z17check_shifted_sumIm27custom_multiple_constant_orImEEvT_(%struct.State* nonnull %0, i64 %237, %struct.Memory* %call2_40cf93)
...
block_.L_40d008:                                  ; preds = %block_.L_40cf9f
  ...
  %call2_40d008 = tail call %struct.Memory* @sub_400ea0._Z5timerv(%struct.State* nonnull %0, i64 %274, %struct.Memory* %call2_40cf93)
