...
declare %struct.Memory* @sub_40fc30._Z17check_shifted_sumIm27custom_multiple_constant_orImEEvT_(%struct.State* noalias dereferenceable(3376), i64, %struct.Memory* noalias readnone returned) local_unnamed_addr
...
entry:
  ...
  %call2_40cfa3 = tail call %struct.Memory* @sub_400e90._Z11start_timerv(%struct.State* %0, i64 %58, %struct.Memory* %2)
  ...
  br label %block_.L_40cfaf

block_.L_40cfaf:                                  ; preds = %block_.L_40d001, %entry
  %68 = phi i64 [ %273, %block_.L_40d001 ], [ %.pre, %entry ]
  ...
  br i1 %101, label %block_40cfbf, label %block_.L_40d018

block_40cfbf:                                     ; preds = %block_.L_40cfaf
  %103 = add i64 %69, -40
  %104 = add i64 %102, 8
...
block_.L_40cfce:                                  ; preds = %block_40cfda, %block_40cfbf
  %111 = phi i64 [ %232, %block_40cfda ], [ %.pre6, %block_40cfbf ]
  ...
  br i1 %147, label %block_40cfda, label %block_.L_40d001

block_40cfda:                                     ; preds = %block_.L_40cfce
  %149 = add i64 %112, -8
  %150 = add i64 %148, 4
  ...
  %call2_40cfe6 = tail call %struct.Memory* @sub_40fc00._ZN27custom_multiple_constant_orImE8do_shiftEm(%struct.State* nonnull %0, i64 %161, %struct.Memory* %call2_40cfa3)
...
block_.L_40d001:                                  ; preds = %block_.L_40cfce
  %233 = add i64 %112, -40
  %234 = add i64 %148, 4
  ...
  %call2_40d005 = tail call %struct.Memory* @sub_40fc30._Z17check_shifted_sumIm27custom_multiple_constant_orImEEvT_(%struct.State* nonnull %0, i64 %237, %struct.Memory* %call2_40cfa3)
...
block_.L_40d018:                                  ; preds = %block_.L_40cfaf
  ...
  %call2_40d018 = tail call %struct.Memory* @sub_400eb0._Z5timerv(%struct.State* nonnull %0, i64 %274, %struct.Memory* %call2_40cfa3)
  ...
  %call2_40d021 = tail call %struct.Memory* @sub_400850._Z13record_resultdPKc(%struct.State* nonnull %0, i64 %285, %struct.Memory* %call2_40d018)
