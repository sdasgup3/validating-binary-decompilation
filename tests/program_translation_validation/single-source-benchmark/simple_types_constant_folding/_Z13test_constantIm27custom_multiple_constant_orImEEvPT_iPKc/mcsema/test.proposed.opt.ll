...
block_.L_40cf5f:                                  ; preds = %block_.L_40cfb1, %entry
  %68 = phi i64 [ %.pre, %entry ], [ %273, %block_.L_40cfb1 ]
...
block_.L_40cf7e:                                  ; preds = %block_40cf8a, %block_40cf6f
  %111 = phi i64 [ %.pre1, %block_40cf6f ], [ %232, %block_40cf8a ]
...
block_.L_40cfb1:                                  ; preds = %block_.L_40cf7e
  ...
  %call2_40cfb5 = tail call %struct.Memory* @sub_40fbe0._Z17check_shifted_sumIm27custom_multiple_constant_orImEEvT_(%struct.State* %0, i64 %237, %struct.Memory* %MEMORY.1)
...
block_.L_40cfc8:                                  ; preds = %block_.L_40cf5f
  ...
  %call2_40cfc8 = tail call %struct.Memory* @sub_400e60._Z5timerv(%struct.State* %0, i64 %274, %struct.Memory* %MEMORY.0)
  ...
  %call2_40cfd1 = tail call %struct.Memory* @sub_400800._Z13record_resultdPKc(%struct.State* %0, i64 %285, %struct.Memory* %call2_40cfc8)
