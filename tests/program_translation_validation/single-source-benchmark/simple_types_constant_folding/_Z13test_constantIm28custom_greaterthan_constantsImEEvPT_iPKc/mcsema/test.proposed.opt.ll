...
declare %struct.Memory* @sub_410a60._Z17check_shifted_sumIm28custom_greaterthan_constantsImEEvT_(%struct.State* noalias dereferenceable(3376), i64, %struct.Memory* noalias readnone returned) local_unnamed_addr
...
block_.L_40c27f:                                  ; preds = %block_.L_40c2d1, %entry
  %68 = phi i64 [ %273, %block_.L_40c2d1 ], [ %.pre, %entry ]
...
block_.L_40c29e:                                  ; preds = %block_40c2aa, %block_40c28f
  %111 = phi i64 [ %232, %block_40c2aa ], [ %.pre6, %block_40c28f ]
...
block_40c2aa:                                     ; preds = %block_.L_40c29e
  ...
  %call2_40c2b6 = tail call %struct.Memory* @sub_410a50._ZN28custom_greaterthan_constantsImE8do_shiftEm(%struct.State* nonnull %0, i64 %161, %struct.Memory* %call2_40c273)
...
block_.L_40c2d1:                                  ; preds = %block_.L_40c29e
  ...
  %call2_40c2d5 = tail call %struct.Memory* @sub_410a60._Z17check_shifted_sumIm28custom_greaterthan_constantsImEEvT_(%struct.State* nonnull %0, i64 %237, %struct.Memory* %call2_40c273)
...
block_.L_40c2e8:                                  ; preds = %block_.L_40c27f
  ...
  %call2_40c2e8 = tail call %struct.Memory* @sub_400ea0._Z5timerv(%struct.State* nonnull %0, i64 %274, %struct.Memory* %call2_40c273)
