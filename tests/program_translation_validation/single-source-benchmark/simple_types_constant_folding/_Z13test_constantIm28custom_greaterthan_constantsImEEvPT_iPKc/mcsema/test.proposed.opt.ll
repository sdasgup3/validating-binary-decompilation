...
block_.L_40c23f:                                  ; preds = %block_.L_40c291, %entry
  %68 = phi i64 [ %.pre, %entry ], [ %275, %block_.L_40c291 ]
...
block_.L_40c25e:                                  ; preds = %block_40c26a, %block_40c24f
  %111 = phi i64 [ %.pre1, %block_40c24f ], [ %233, %block_40c26a ]
...
block_.L_40c291:                                  ; preds = %block_.L_40c25e
  ...
  %call2_40c295 = tail call %struct.Memory* @sub_410a20._Z17check_shifted_sumIm28custom_greaterthan_constantsImEEvT_(%struct.State* %0, i64 %238, %struct.Memory* %MEMORY.1)
...
block_.L_40c2a8:                                  ; preds = %block_.L_40c23f
  ...
  %call2_40c2a8 = tail call %struct.Memory* @sub_400e60._Z5timerv(%struct.State* %0, i64 %276, %struct.Memory* %MEMORY.0)
  ...
  %call2_40c2b1 = tail call %struct.Memory* @sub_400800._Z13record_resultdPKc(%struct.State* %0, i64 %287, %struct.Memory* %call2_40c2a8)
