...
declare %struct.Memory* @sub_410550._Z17check_shifted_sumIm28custom_multiple_constant_addImEEvT_(%struct.State* dereferenceable(3376), i64, %struct.Memory*)
...
define %struct.Memory* @_Z13test_constantIm28custom_multiple_constant_addImEEvPT_iPKc(%struct.State* noalias, i64, %struct.Memory* noalias) #1 {
entry:
