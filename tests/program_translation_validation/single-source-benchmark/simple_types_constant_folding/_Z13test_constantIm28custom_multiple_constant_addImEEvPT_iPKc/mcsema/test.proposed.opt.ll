...
declare %struct.Memory* @sub_410520._ZN28custom_multiple_constant_addImE8do_shiftEm(%struct.State* noalias dereferenceable(3376), i64, %struct.Memory* noalias readnone returned) local_unnamed_addr

declare %struct.Memory* @sub_410550._Z17check_shifted_sumIm28custom_multiple_constant_addImEEvT_(%struct.State* noalias dereferenceable(3376), i64, %struct.Memory* noalias readnone returned) local_unnamed_addr
...
define %struct.Memory* @_Z13test_constantIm28custom_multiple_constant_addImEEvPT_iPKc(%struct.State* noalias, i64, %struct.Memory* noalias readnone) local_unnamed_addr #1 {
entry:
...
block_.L_40c77f:                                  ; preds = %block_.L_40c7d1, %entry
  %68 = phi i64 [ %273, %block_.L_40c7d1 ], [ %.pre, %entry ]
...
block_.L_40c79e:                                  ; preds = %block_40c7aa, %block_40c78f
  %111 = phi i64 [ %232, %block_40c7aa ], [ %.pre6, %block_40c78f ]
...
block_40c7aa:                                     ; preds = %block_.L_40c79e
  ...
  %call2_40c7b6 = tail call %struct.Memory* @sub_410520._ZN28custom_multiple_constant_addImE8do_shiftEm(%struct.State* nonnull %0, i64 %161, %struct.Memory* %call2_40c773)
...
block_.L_40c7d1:                                  ; preds = %block_.L_40c79e
  ...
  %call2_40c7d5 = tail call %struct.Memory* @sub_410550._Z17check_shifted_sumIm28custom_multiple_constant_addImEEvT_(%struct.State* nonnull %0, i64 %237, %struct.Memory* %call2_40c773)
...
block_.L_40c7e8:                                  ; preds = %block_.L_40c77f
  ...
  %call2_40c7e8 = tail call %struct.Memory* @sub_400ea0._Z5timerv(%struct.State* nonnull %0, i64 %274, %struct.Memory* %call2_40c773)
