...
declare %struct.Memory* @sub_4104e0._ZN28custom_multiple_constant_addImE8do_shiftEm(%struct.State* noalias dereferenceable(3376), i64, %struct.Memory* noalias readnone returned) local_unnamed_addr

declare %struct.Memory* @sub_410510._Z17check_shifted_sumIm28custom_multiple_constant_addImEEvT_(%struct.State* noalias dereferenceable(3376), i64, %struct.Memory* noalias readnone returned) local_unnamed_addr
...
entry:
  ...
  %call2_40c733 = tail call %struct.Memory* @sub_400e40._Z11start_timerv(%struct.State* %0, i64 %58, %struct.Memory* %2)
...
block_.L_40c73f:                                  ; preds = %block_.L_40c791, %entry
  %68 = phi i64 [ %.pre, %entry ], [ %273, %block_.L_40c791 ]
  %MEMORY.0 = phi %struct.Memory* [ %call2_40c733, %entry ], [ %call2_40c795, %block_.L_40c791 ]
  ...
  br i1 %101, label %block_40c74f, label %block_.L_40c7a8
...
block_.L_40c75e:                                  ; preds = %block_40c76a, %block_40c74f
  %111 = phi i64 [ %.pre1, %block_40c74f ], [ %232, %block_40c76a ]
  %MEMORY.1 = phi %struct.Memory* [ %MEMORY.0, %block_40c74f ], [ %call2_40c776, %block_40c76a ]
  ...
  br i1 %147, label %block_40c76a, label %block_.L_40c791
...
block_40c76a:                                     ; preds = %block_.L_40c75e
  ...
  %call2_40c776 = tail call %struct.Memory* @sub_4104e0._ZN28custom_multiple_constant_addImE8do_shiftEm(%struct.State* %0, i64 %161, %struct.Memory* %MEMORY.1)
...
block_.L_40c791:                                  ; preds = %block_.L_40c75e
  ...
  %call2_40c795 = tail call %struct.Memory* @sub_410510._Z17check_shifted_sumIm28custom_multiple_constant_addImEEvT_(%struct.State* %0, i64 %237, %struct.Memory* %MEMORY.1)
...
block_.L_40c7a8:                                  ; preds = %block_.L_40c73f
  ...
  %call2_40c7a8 = tail call %struct.Memory* @sub_400e60._Z5timerv(%struct.State* %0, i64 %274, %struct.Memory* %MEMORY.0)
  ...
  %call2_40c7b1 = tail call %struct.Memory* @sub_400800._Z13record_resultdPKc(%struct.State* %0, i64 %285, %struct.Memory* %call2_40c7a8)
  ...
  ret %struct.Memory* %call2_40c7b1
}
...
define %struct.Memory* @routine_jge_.L_40c7a8(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i8* %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
...
define %struct.Memory* @routine_jge_.L_40c791(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i8* %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 2, i32 9
...
define %struct.Memory* @routine_callq_._ZN28custom_multiple_constant_addImE8do_shiftEm(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
...
define %struct.Memory* @routine_jmpq_.L_40c75e(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
...
define %struct.Memory* @routine_callq_._Z17check_shifted_sumIm28custom_multiple_constant_addImEEvT_(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
...
define %struct.Memory* @routine_jmpq_.L_40c73f(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
