...
block_.L_40c73f:                                  ; preds = %block_.L_40c791, %entry
  %68 = phi i64 [ %.pre, %entry ], [ %275, %block_.L_40c791 ]
...
block_.L_40c75e:                                  ; preds = %block_40c76a, %block_40c74f
  %111 = phi i64 [ %.pre1, %block_40c74f ], [ %233, %block_40c76a ]
...
block_.L_40c791:                                  ; preds = %block_.L_40c75e
  ...
  %call2_40c795 = tail call %struct.Memory* @sub_410510._Z17check_shifted_sumIm28custom_multiple_constant_addImEEvT_(%struct.State* %0, i64 %238, %struct.Memory* %MEMORY.1)
...
block_.L_40c7a8:                                  ; preds = %block_.L_40c73f
  ...
  %call2_40c7a8 = tail call %struct.Memory* @sub_400e60._Z5timerv(%struct.State* %0, i64 %276, %struct.Memory* %MEMORY.0)
  ...
  %call2_40c7b1 = tail call %struct.Memory* @sub_400800._Z13record_resultdPKc(%struct.State* %0, i64 %287, %struct.Memory* %call2_40c7a8)
