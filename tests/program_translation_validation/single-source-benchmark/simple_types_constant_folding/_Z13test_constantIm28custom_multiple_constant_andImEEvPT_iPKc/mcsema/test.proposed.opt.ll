...
declare %struct.Memory* @sub_40fd90._Z17check_shifted_sumIm28custom_multiple_constant_andImEEvT_(%struct.State* noalias dereferenceable(3376), i64, %struct.Memory* noalias readnone returned) local_unnamed_addr
...
define %struct.Memory* @_Z13test_constantIm28custom_multiple_constant_andImEEvPT_iPKc(%struct.State* noalias, i64, %struct.Memory* noalias readnone) local_unnamed_addr #1 {
entry:
...
block_.L_40ce5f:                                  ; preds = %block_.L_40ceb1, %entry
  %68 = phi i64 [ %273, %block_.L_40ceb1 ], [ %.pre, %entry ]
...
block_.L_40ce7e:                                  ; preds = %block_40ce8a, %block_40ce6f
  %111 = phi i64 [ %232, %block_40ce8a ], [ %.pre6, %block_40ce6f ]
...
block_40ce8a:                                     ; preds = %block_.L_40ce7e
  ...
  %call2_40ce96 = tail call %struct.Memory* @sub_40fd60._ZN28custom_multiple_constant_andImE8do_shiftEm(%struct.State* nonnull %0, i64 %161, %struct.Memory* %call2_40ce53)
...
block_.L_40ceb1:                                  ; preds = %block_.L_40ce7e
  ...
  %call2_40ceb5 = tail call %struct.Memory* @sub_40fd90._Z17check_shifted_sumIm28custom_multiple_constant_andImEEvT_(%struct.State* nonnull %0, i64 %237, %struct.Memory* %call2_40ce53)
...
block_.L_40cec8:                                  ; preds = %block_.L_40ce5f
  ...
  %call2_40cec8 = tail call %struct.Memory* @sub_400ea0._Z5timerv(%struct.State* nonnull %0, i64 %274, %struct.Memory* %call2_40ce53)
