...
block_.L_40ce1f:                                  ; preds = %block_.L_40ce71, %entry
  %68 = phi i64 [ %.pre, %entry ], [ %275, %block_.L_40ce71 ]
...
block_.L_40ce3e:                                  ; preds = %block_40ce4a, %block_40ce2f
  %111 = phi i64 [ %.pre1, %block_40ce2f ], [ %233, %block_40ce4a ]
...
block_.L_40ce71:                                  ; preds = %block_.L_40ce3e
  ...
  %call2_40ce75 = tail call %struct.Memory* @sub_40fd50._Z17check_shifted_sumIm28custom_multiple_constant_andImEEvT_(%struct.State* %0, i64 %238, %struct.Memory* %MEMORY.1)
...
block_.L_40ce88:                                  ; preds = %block_.L_40ce1f
  ...
  %call2_40ce88 = tail call %struct.Memory* @sub_400e60._Z5timerv(%struct.State* %0, i64 %276, %struct.Memory* %MEMORY.0)
  ...
  %call2_40ce91 = tail call %struct.Memory* @sub_400800._Z13record_resultdPKc(%struct.State* %0, i64 %287, %struct.Memory* %call2_40ce88)
