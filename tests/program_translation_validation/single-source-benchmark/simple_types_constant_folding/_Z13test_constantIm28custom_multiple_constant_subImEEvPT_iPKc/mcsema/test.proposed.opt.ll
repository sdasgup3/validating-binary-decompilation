...
block_.L_40c87f:                                  ; preds = %block_.L_40c8d1, %entry
  %68 = phi i64 [ %.pre, %entry ], [ %275, %block_.L_40c8d1 ]
...
block_.L_40c89e:                                  ; preds = %block_40c8aa, %block_40c88f
  %111 = phi i64 [ %.pre1, %block_40c88f ], [ %233, %block_40c8aa ]
...
block_.L_40c8d1:                                  ; preds = %block_.L_40c89e
  ...
  %call2_40c8d5 = tail call %struct.Memory* @sub_4103a0._Z17check_shifted_sumIm28custom_multiple_constant_subImEEvT_(%struct.State* %0, i64 %238, %struct.Memory* %MEMORY.1)
...
block_.L_40c8e8:                                  ; preds = %block_.L_40c87f
  ...
  %call2_40c8e8 = tail call %struct.Memory* @sub_400e60._Z5timerv(%struct.State* %0, i64 %276, %struct.Memory* %MEMORY.0)
  ...
  %call2_40c8f1 = tail call %struct.Memory* @sub_400800._Z13record_resultdPKc(%struct.State* %0, i64 %287, %struct.Memory* %call2_40c8e8)
