...
block_.L_40d09f:                                  ; preds = %block_.L_40d0f1, %entry
  %68 = phi i64 [ %.pre, %entry ], [ %273, %block_.L_40d0f1 ]
...
block_.L_40d0be:                                  ; preds = %block_40d0ca, %block_40d0af
  %111 = phi i64 [ %.pre1, %block_40d0af ], [ %232, %block_40d0ca ]
...
block_.L_40d0f1:                                  ; preds = %block_.L_40d0be
  ...
  %call2_40d0f5 = tail call %struct.Memory* @sub_40fa40._Z17check_shifted_sumIm28custom_multiple_constant_xorImEEvT_(%struct.State* %0, i64 %237, %struct.Memory* %MEMORY.1)
...
block_.L_40d108:                                  ; preds = %block_.L_40d09f
  ...
  %call2_40d108 = tail call %struct.Memory* @sub_400e60._Z5timerv(%struct.State* %0, i64 %274, %struct.Memory* %MEMORY.0)
  ...
  %call2_40d111 = tail call %struct.Memory* @sub_400800._Z13record_resultdPKc(%struct.State* %0, i64 %285, %struct.Memory* %call2_40d108)
