...
declare %struct.Memory* @sub_40fa50._ZN28custom_multiple_constant_xorImE8do_shiftEm(%struct.State* noalias dereferenceable(3376), i64, %struct.Memory* noalias readnone returned) local_unnamed_addr

declare %struct.Memory* @sub_40fa80._Z17check_shifted_sumIm28custom_multiple_constant_xorImEEvT_(%struct.State* noalias dereferenceable(3376), i64, %struct.Memory* noalias readnone returned) local_unnamed_addr
...
block_.L_40d0df:                                  ; preds = %block_.L_40d131, %entry
  %68 = phi i64 [ %273, %block_.L_40d131 ], [ %.pre, %entry ]
...
block_.L_40d0fe:                                  ; preds = %block_40d10a, %block_40d0ef
  %111 = phi i64 [ %232, %block_40d10a ], [ %.pre6, %block_40d0ef ]
...
block_40d10a:                                     ; preds = %block_.L_40d0fe
  ...
  %call2_40d116 = tail call %struct.Memory* @sub_40fa50._ZN28custom_multiple_constant_xorImE8do_shiftEm(%struct.State* nonnull %0, i64 %161, %struct.Memory* %call2_40d0d3)
...
block_.L_40d131:                                  ; preds = %block_.L_40d0fe
  ...
  %call2_40d135 = tail call %struct.Memory* @sub_40fa80._Z17check_shifted_sumIm28custom_multiple_constant_xorImEEvT_(%struct.State* nonnull %0, i64 %237, %struct.Memory* %call2_40d0d3)
...
block_.L_40d148:                                  ; preds = %block_.L_40d0df
  ...
  %call2_40d148 = tail call %struct.Memory* @sub_400ea0._Z5timerv(%struct.State* nonnull %0, i64 %274, %struct.Memory* %call2_40d0d3)
