...
declare %struct.Memory* @sub_410840._Z17check_shifted_sumIm30custom_lessthanequal_constantsImEEvT_(%struct.State* noalias dereferenceable(3376), i64, %struct.Memory* noalias readnone returned) local_unnamed_addr
...
entry:
  ...
  %call2_40c413 = tail call %struct.Memory* @sub_400e40._Z11start_timerv(%struct.State* %0, i64 %58, %struct.Memory* %2)
...
block_.L_40c41f:                                  ; preds = %block_.L_40c471, %entry
  %68 = phi i64 [ %.pre, %entry ], [ %275, %block_.L_40c471 ]
  %MEMORY.0 = phi %struct.Memory* [ %call2_40c413, %entry ], [ %call2_40c475, %block_.L_40c471 ]
  ...
  br i1 %101, label %block_40c42f, label %block_.L_40c488

block_40c42f:                                     ; preds = %block_.L_40c41f
  %103 = add i64 %69, -40
  %104 = add i64 %102, 8
...
block_.L_40c43e:                                  ; preds = %block_40c44a, %block_40c42f
  %111 = phi i64 [ %.pre1, %block_40c42f ], [ %233, %block_40c44a ]
  %MEMORY.1 = phi %struct.Memory* [ %MEMORY.0, %block_40c42f ], [ %call2_40c456, %block_40c44a ]
  ...
  br i1 %147, label %block_40c44a, label %block_.L_40c471

block_40c44a:                                     ; preds = %block_.L_40c43e
  %149 = add i64 %112, -8
  %150 = add i64 %148, 4
  ...
  %call2_40c456 = tail call %struct.Memory* @sub_410830._ZN30custom_lessthanequal_constantsImE8do_shiftEm(%struct.State* %0, i64 %161, %struct.Memory* %MEMORY.1)
...
block_.L_40c471:                                  ; preds = %block_.L_40c43e
  %234 = add i64 %112, -40
  %235 = add i64 %148, 4
  ...
  %call2_40c475 = tail call %struct.Memory* @sub_410840._Z17check_shifted_sumIm30custom_lessthanequal_constantsImEEvT_(%struct.State* %0, i64 %238, %struct.Memory* %MEMORY.1)
...
block_.L_40c488:                                  ; preds = %block_.L_40c41f
  %276 = add i64 %102, -46632
  %277 = add i64 %102, 5
  ...
  %call2_40c488 = tail call %struct.Memory* @sub_400e60._Z5timerv(%struct.State* %0, i64 %276, %struct.Memory* %MEMORY.0)
  ...
  %call2_40c491 = tail call %struct.Memory* @sub_400800._Z13record_resultdPKc(%struct.State* %0, i64 %287, %struct.Memory* %call2_40c488)
  ...
  ret %struct.Memory* %call2_40c491
}
...
define %struct.Memory* @routine_jge_.L_40c488(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i8* %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
...
define %struct.Memory* @routine_jge_.L_40c471(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i8* %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 2, i32 9
...
define %struct.Memory* @routine_jmpq_.L_40c43e(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
...
define %struct.Memory* @routine_callq_._Z17check_shifted_sumIm30custom_lessthanequal_constantsImEEvT_(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
...
define %struct.Memory* @routine_jmpq_.L_40c41f(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
