...
block_.L_40c41f:                                  ; preds = %block_.L_40c471, %entry
  %68 = phi i64 [ %.pre, %entry ], [ %273, %block_.L_40c471 ]
...
block_.L_40c43e:                                  ; preds = %block_40c44a, %block_40c42f
  %111 = phi i64 [ %.pre1, %block_40c42f ], [ %232, %block_40c44a ]
...
block_.L_40c471:                                  ; preds = %block_.L_40c43e
  ...
  %call2_40c475 = tail call %struct.Memory* @sub_410840._Z17check_shifted_sumIm30custom_lessthanequal_constantsImEEvT_(%struct.State* %0, i64 %237, %struct.Memory* %MEMORY.1)
...
block_.L_40c488:                                  ; preds = %block_.L_40c41f
  ...
  %call2_40c488 = tail call %struct.Memory* @sub_400e60._Z5timerv(%struct.State* %0, i64 %274, %struct.Memory* %MEMORY.0)
  ...
  %call2_40c491 = tail call %struct.Memory* @sub_400800._Z13record_resultdPKc(%struct.State* %0, i64 %285, %struct.Memory* %call2_40c488)
