...
declare %struct.Memory* @sub_410880._Z17check_shifted_sumIm30custom_lessthanequal_constantsImEEvT_(%struct.State* noalias dereferenceable(3376), i64, %struct.Memory* noalias readnone returned) local_unnamed_addr
...
block_.L_40c45f:                                  ; preds = %block_.L_40c4b1, %entry
  %68 = phi i64 [ %273, %block_.L_40c4b1 ], [ %.pre, %entry ]
...
block_.L_40c47e:                                  ; preds = %block_40c48a, %block_40c46f
  %111 = phi i64 [ %232, %block_40c48a ], [ %.pre6, %block_40c46f ]
...
block_40c48a:                                     ; preds = %block_.L_40c47e
  ...
  %call2_40c496 = tail call %struct.Memory* @sub_410870._ZN30custom_lessthanequal_constantsImE8do_shiftEm(%struct.State* nonnull %0, i64 %161, %struct.Memory* %call2_40c453)
...
block_.L_40c4b1:                                  ; preds = %block_.L_40c47e
  ...
  %call2_40c4b5 = tail call %struct.Memory* @sub_410880._Z17check_shifted_sumIm30custom_lessthanequal_constantsImEEvT_(%struct.State* nonnull %0, i64 %237, %struct.Memory* %call2_40c453)
...
block_.L_40c4c8:                                  ; preds = %block_.L_40c45f
  ...
  %call2_40c4c8 = tail call %struct.Memory* @sub_400ea0._Z5timerv(%struct.State* nonnull %0, i64 %274, %struct.Memory* %call2_40c453)
