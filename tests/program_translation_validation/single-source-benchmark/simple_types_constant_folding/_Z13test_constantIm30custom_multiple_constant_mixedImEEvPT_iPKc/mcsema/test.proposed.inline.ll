...
declare %struct.Memory* @sub_40fed0._ZN30custom_multiple_constant_mixedImE8do_shiftEm(%struct.State* dereferenceable(3376), i64, %struct.Memory*)

declare %struct.Memory* @sub_40fef0._Z17check_shifted_sumIm30custom_multiple_constant_mixedImEEvT_(%struct.State* dereferenceable(3376), i64, %struct.Memory*)
...
define %struct.Memory* @_Z13test_constantIm30custom_multiple_constant_mixedImEEvPT_iPKc(%struct.State* noalias, i64, %struct.Memory* noalias) #1 {
entry:
