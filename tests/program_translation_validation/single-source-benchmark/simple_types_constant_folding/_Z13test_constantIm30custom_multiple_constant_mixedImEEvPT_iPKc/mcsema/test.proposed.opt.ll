...
block_.L_40ccdf:                                  ; preds = %block_.L_40cd31, %entry
  %68 = phi i64 [ %.pre, %entry ], [ %275, %block_.L_40cd31 ]
...
block_.L_40ccfe:                                  ; preds = %block_40cd0a, %block_40ccef
  %111 = phi i64 [ %.pre1, %block_40ccef ], [ %233, %block_40cd0a ]
...
block_.L_40cd31:                                  ; preds = %block_.L_40ccfe
  ...
  %call2_40cd35 = tail call %struct.Memory* @sub_40feb0._Z17check_shifted_sumIm30custom_multiple_constant_mixedImEEvT_(%struct.State* %0, i64 %238, %struct.Memory* %MEMORY.1)
...
block_.L_40cd48:                                  ; preds = %block_.L_40ccdf
  ...
  %call2_40cd48 = tail call %struct.Memory* @sub_400e60._Z5timerv(%struct.State* %0, i64 %276, %struct.Memory* %MEMORY.0)
  ...
  %call2_40cd51 = tail call %struct.Memory* @sub_400800._Z13record_resultdPKc(%struct.State* %0, i64 %287, %struct.Memory* %call2_40cd48)
