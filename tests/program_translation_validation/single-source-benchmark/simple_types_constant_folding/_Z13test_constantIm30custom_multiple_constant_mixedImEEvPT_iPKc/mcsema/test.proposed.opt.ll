...
declare %struct.Memory* @sub_40fef0._Z17check_shifted_sumIm30custom_multiple_constant_mixedImEEvT_(%struct.State* noalias dereferenceable(3376), i64, %struct.Memory* noalias readnone returned) local_unnamed_addr
...
block_.L_40cd1f:                                  ; preds = %block_.L_40cd71, %entry
  %68 = phi i64 [ %273, %block_.L_40cd71 ], [ %.pre, %entry ]
...
block_.L_40cd3e:                                  ; preds = %block_40cd4a, %block_40cd2f
  %111 = phi i64 [ %232, %block_40cd4a ], [ %.pre6, %block_40cd2f ]
...
block_40cd4a:                                     ; preds = %block_.L_40cd3e
  ...
  %call2_40cd56 = tail call %struct.Memory* @sub_40fed0._ZN30custom_multiple_constant_mixedImE8do_shiftEm(%struct.State* nonnull %0, i64 %161, %struct.Memory* %call2_40cd13)
...
block_.L_40cd71:                                  ; preds = %block_.L_40cd3e
  ...
  %call2_40cd75 = tail call %struct.Memory* @sub_40fef0._Z17check_shifted_sumIm30custom_multiple_constant_mixedImEEvT_(%struct.State* nonnull %0, i64 %237, %struct.Memory* %call2_40cd13)
...
block_.L_40cd88:                                  ; preds = %block_.L_40cd1f
  ...
  %call2_40cd88 = tail call %struct.Memory* @sub_400ea0._Z5timerv(%struct.State* nonnull %0, i64 %274, %struct.Memory* %call2_40cd13)
