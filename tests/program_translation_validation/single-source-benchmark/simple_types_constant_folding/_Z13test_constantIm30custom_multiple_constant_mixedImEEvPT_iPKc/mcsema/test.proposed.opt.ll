...
declare %struct.Memory* @sub_40feb0._Z17check_shifted_sumIm30custom_multiple_constant_mixedImEEvT_(%struct.State* noalias dereferenceable(3376), i64, %struct.Memory* noalias readnone returned) local_unnamed_addr
...
entry:
  ...
  %call2_40ccd3 = tail call %struct.Memory* @sub_400e40._Z11start_timerv(%struct.State* %0, i64 %58, %struct.Memory* %2)
...
block_.L_40ccdf:                                  ; preds = %block_.L_40cd31, %entry
  %68 = phi i64 [ %.pre, %entry ], [ %273, %block_.L_40cd31 ]
  %MEMORY.0 = phi %struct.Memory* [ %call2_40ccd3, %entry ], [ %call2_40cd35, %block_.L_40cd31 ]
  ...
  br i1 %101, label %block_40ccef, label %block_.L_40cd48
...
block_.L_40ccfe:                                  ; preds = %block_40cd0a, %block_40ccef
  %111 = phi i64 [ %.pre1, %block_40ccef ], [ %232, %block_40cd0a ]
  %MEMORY.1 = phi %struct.Memory* [ %MEMORY.0, %block_40ccef ], [ %call2_40cd16, %block_40cd0a ]
  ...
  br i1 %147, label %block_40cd0a, label %block_.L_40cd31
...
block_40cd0a:                                     ; preds = %block_.L_40ccfe
  ...
  %call2_40cd16 = tail call %struct.Memory* @sub_40fe90._ZN30custom_multiple_constant_mixedImE8do_shiftEm(%struct.State* %0, i64 %161, %struct.Memory* %MEMORY.1)
...
block_.L_40cd31:                                  ; preds = %block_.L_40ccfe
  ...
  %call2_40cd35 = tail call %struct.Memory* @sub_40feb0._Z17check_shifted_sumIm30custom_multiple_constant_mixedImEEvT_(%struct.State* %0, i64 %237, %struct.Memory* %MEMORY.1)
...
block_.L_40cd48:                                  ; preds = %block_.L_40ccdf
  ...
  %call2_40cd48 = tail call %struct.Memory* @sub_400e60._Z5timerv(%struct.State* %0, i64 %274, %struct.Memory* %MEMORY.0)
  ...
  %call2_40cd51 = tail call %struct.Memory* @sub_400800._Z13record_resultdPKc(%struct.State* %0, i64 %285, %struct.Memory* %call2_40cd48)
  ...
  ret %struct.Memory* %call2_40cd51
}
...
define %struct.Memory* @routine_jge_.L_40cd48(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i8* %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
...
define %struct.Memory* @routine_jge_.L_40cd31(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i8* %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 2, i32 9
...
define %struct.Memory* @routine_jmpq_.L_40ccfe(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
...
define %struct.Memory* @routine_callq_._Z17check_shifted_sumIm30custom_multiple_constant_mixedImEEvT_(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
...
define %struct.Memory* @routine_jmpq_.L_40ccdf(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
