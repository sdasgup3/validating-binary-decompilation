...
block_.L_40cb9f:                                  ; preds = %block_.L_40cbf1, %entry
  %68 = phi i64 [ %.pre, %entry ], [ %275, %block_.L_40cbf1 ]
...
block_.L_40cbbe:                                  ; preds = %block_40cbca, %block_40cbaf
  %111 = phi i64 [ %.pre1, %block_40cbaf ], [ %233, %block_40cbca ]
...
block_.L_40cbf1:                                  ; preds = %block_.L_40cbbe
  ...
  %call2_40cbf5 = tail call %struct.Memory* @sub_410030._Z17check_shifted_sumIm31custom_multiple_constant_divideImEEvT_(%struct.State* %0, i64 %238, %struct.Memory* %MEMORY.1)
...
block_.L_40cc08:                                  ; preds = %block_.L_40cb9f
  ...
  %call2_40cc08 = tail call %struct.Memory* @sub_400e60._Z5timerv(%struct.State* %0, i64 %276, %struct.Memory* %MEMORY.0)
  ...
  %call2_40cc11 = tail call %struct.Memory* @sub_400800._Z13record_resultdPKc(%struct.State* %0, i64 %287, %struct.Memory* %call2_40cc08)
