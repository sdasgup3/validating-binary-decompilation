...
declare %struct.Memory* @sub_410080._Z17check_shifted_sumIm31custom_multiple_constant_divideImEEvT_(%struct.State* noalias dereferenceable(3376), i64, %struct.Memory* noalias readnone returned) local_unnamed_addr
...
entry:
  ...
  %call2_40cbe3 = tail call %struct.Memory* @sub_400e90._Z11start_timerv(%struct.State* %0, i64 %58, %struct.Memory* %2)
...
block_.L_40cbef:                                  ; preds = %block_.L_40cc41, %entry
  %68 = phi i64 [ %273, %block_.L_40cc41 ], [ %.pre, %entry ]
  ...
  br i1 %101, label %block_40cbff, label %block_.L_40cc58
...
block_.L_40cc0e:                                  ; preds = %block_40cc1a, %block_40cbff
  %111 = phi i64 [ %232, %block_40cc1a ], [ %.pre6, %block_40cbff ]
  ...
  br i1 %147, label %block_40cc1a, label %block_.L_40cc41
...
block_40cc1a:                                     ; preds = %block_.L_40cc0e
  ...
  %call2_40cc26 = tail call %struct.Memory* @sub_410040._ZN31custom_multiple_constant_divideImE8do_shiftEm(%struct.State* nonnull %0, i64 %161, %struct.Memory* %call2_40cbe3)
...
block_.L_40cc41:                                  ; preds = %block_.L_40cc0e
  ...
  %call2_40cc45 = tail call %struct.Memory* @sub_410080._Z17check_shifted_sumIm31custom_multiple_constant_divideImEEvT_(%struct.State* nonnull %0, i64 %237, %struct.Memory* %call2_40cbe3)
...
block_.L_40cc58:                                  ; preds = %block_.L_40cbef
  ...
  %call2_40cc58 = tail call %struct.Memory* @sub_400eb0._Z5timerv(%struct.State* nonnull %0, i64 %274, %struct.Memory* %call2_40cbe3)
  ...
  %call2_40cc61 = tail call %struct.Memory* @sub_400850._Z13record_resultdPKc(%struct.State* nonnull %0, i64 %285, %struct.Memory* %call2_40cc58)
