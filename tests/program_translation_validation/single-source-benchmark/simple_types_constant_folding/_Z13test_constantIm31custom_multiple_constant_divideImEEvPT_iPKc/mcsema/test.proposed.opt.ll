...
declare %struct.Memory* @sub_410070._Z17check_shifted_sumIm31custom_multiple_constant_divideImEEvT_(%struct.State* noalias dereferenceable(3376), i64, %struct.Memory* noalias readnone returned) local_unnamed_addr
...
define %struct.Memory* @_Z13test_constantIm31custom_multiple_constant_divideImEEvPT_iPKc(%struct.State* noalias, i64, %struct.Memory* noalias readnone) local_unnamed_addr #1 {
entry:
...
block_.L_40cbdf:                                  ; preds = %block_.L_40cc31, %entry
  %68 = phi i64 [ %273, %block_.L_40cc31 ], [ %.pre, %entry ]
...
block_.L_40cbfe:                                  ; preds = %block_40cc0a, %block_40cbef
  %111 = phi i64 [ %232, %block_40cc0a ], [ %.pre6, %block_40cbef ]
...
block_40cc0a:                                     ; preds = %block_.L_40cbfe
  ...
  %call2_40cc16 = tail call %struct.Memory* @sub_410030._ZN31custom_multiple_constant_divideImE8do_shiftEm(%struct.State* nonnull %0, i64 %161, %struct.Memory* %call2_40cbd3)
...
block_.L_40cc31:                                  ; preds = %block_.L_40cbfe
  ...
  %call2_40cc35 = tail call %struct.Memory* @sub_410070._Z17check_shifted_sumIm31custom_multiple_constant_divideImEEvT_(%struct.State* nonnull %0, i64 %237, %struct.Memory* %call2_40cbd3)
...
block_.L_40cc48:                                  ; preds = %block_.L_40cbdf
  ...
  %call2_40cc48 = tail call %struct.Memory* @sub_400ea0._Z5timerv(%struct.State* nonnull %0, i64 %274, %struct.Memory* %call2_40cbd3)
