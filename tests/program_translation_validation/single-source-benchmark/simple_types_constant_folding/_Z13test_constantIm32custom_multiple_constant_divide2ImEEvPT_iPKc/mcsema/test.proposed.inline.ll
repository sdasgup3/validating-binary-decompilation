...
declare %struct.Memory* @sub_40ffa0._Z17check_shifted_sumIm32custom_multiple_constant_divide2ImEEvT_(%struct.State* dereferenceable(3376), i64, %struct.Memory*)
...
define %struct.Memory* @_Z13test_constantIm32custom_multiple_constant_divide2ImEEvPT_iPKc(%struct.State* noalias, i64, %struct.Memory* noalias) #1 {
entry:
