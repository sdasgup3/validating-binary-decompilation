...
declare %struct.Memory* @sub_40ffa0._Z17check_shifted_sumIm32custom_multiple_constant_divide2ImEEvT_(%struct.State* noalias dereferenceable(3376), i64, %struct.Memory* noalias readnone returned) local_unnamed_addr
...
define %struct.Memory* @_Z13test_constantIm32custom_multiple_constant_divide2ImEEvPT_iPKc(%struct.State* noalias, i64, %struct.Memory* noalias readnone) local_unnamed_addr #1 {
entry:
...
block_.L_40cc7f:                                  ; preds = %block_.L_40ccd1, %entry
  %68 = phi i64 [ %273, %block_.L_40ccd1 ], [ %.pre, %entry ]
...
block_.L_40cc9e:                                  ; preds = %block_40ccaa, %block_40cc8f
  %111 = phi i64 [ %232, %block_40ccaa ], [ %.pre6, %block_40cc8f ]
...
block_40ccaa:                                     ; preds = %block_.L_40cc9e
  ...
  %call2_40ccb6 = tail call %struct.Memory* @sub_40ff80._ZN32custom_multiple_constant_divide2ImE8do_shiftEm(%struct.State* nonnull %0, i64 %161, %struct.Memory* %call2_40cc73)
...
block_.L_40ccd1:                                  ; preds = %block_.L_40cc9e
  ...
  %call2_40ccd5 = tail call %struct.Memory* @sub_40ffa0._Z17check_shifted_sumIm32custom_multiple_constant_divide2ImEEvT_(%struct.State* nonnull %0, i64 %237, %struct.Memory* %call2_40cc73)
...
block_.L_40cce8:                                  ; preds = %block_.L_40cc7f
  ...
  %call2_40cce8 = tail call %struct.Memory* @sub_400ea0._Z5timerv(%struct.State* nonnull %0, i64 %274, %struct.Memory* %call2_40cc73)
