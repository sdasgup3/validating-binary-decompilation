...
block_.L_40cc3f:                                  ; preds = %block_.L_40cc91, %entry
  %68 = phi i64 [ %.pre, %entry ], [ %275, %block_.L_40cc91 ]
...
block_.L_40cc5e:                                  ; preds = %block_40cc6a, %block_40cc4f
  %111 = phi i64 [ %.pre1, %block_40cc4f ], [ %233, %block_40cc6a ]
...
block_.L_40cc91:                                  ; preds = %block_.L_40cc5e
  ...
  %call2_40cc95 = tail call %struct.Memory* @sub_40ff60._Z17check_shifted_sumIm32custom_multiple_constant_divide2ImEEvT_(%struct.State* %0, i64 %238, %struct.Memory* %MEMORY.1)
...
block_.L_40cca8:                                  ; preds = %block_.L_40cc3f
  ...
  %call2_40cca8 = tail call %struct.Memory* @sub_400e60._Z5timerv(%struct.State* %0, i64 %276, %struct.Memory* %MEMORY.0)
  ...
  %call2_40ccb1 = tail call %struct.Memory* @sub_400800._Z13record_resultdPKc(%struct.State* %0, i64 %287, %struct.Memory* %call2_40cca8)
