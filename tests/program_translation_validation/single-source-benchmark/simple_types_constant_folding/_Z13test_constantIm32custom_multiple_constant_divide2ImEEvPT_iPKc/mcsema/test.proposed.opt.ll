...
declare %struct.Memory* @sub_40ffb0._Z17check_shifted_sumIm32custom_multiple_constant_divide2ImEEvT_(%struct.State* noalias dereferenceable(3376), i64, %struct.Memory* noalias readnone returned) local_unnamed_addr
...
entry:
  ...
  %call2_40cc83 = tail call %struct.Memory* @sub_400e90._Z11start_timerv(%struct.State* %0, i64 %58, %struct.Memory* %2)
...
block_.L_40cc8f:                                  ; preds = %block_.L_40cce1, %entry
  %68 = phi i64 [ %273, %block_.L_40cce1 ], [ %.pre, %entry ]
  ...
  br i1 %101, label %block_40cc9f, label %block_.L_40ccf8
...
block_.L_40ccae:                                  ; preds = %block_40ccba, %block_40cc9f
  %111 = phi i64 [ %232, %block_40ccba ], [ %.pre6, %block_40cc9f ]
  ...
  br i1 %147, label %block_40ccba, label %block_.L_40cce1
...
block_40ccba:                                     ; preds = %block_.L_40ccae
  ...
  %call2_40ccc6 = tail call %struct.Memory* @sub_40ff90._ZN32custom_multiple_constant_divide2ImE8do_shiftEm(%struct.State* nonnull %0, i64 %161, %struct.Memory* %call2_40cc83)
...
block_.L_40cce1:                                  ; preds = %block_.L_40ccae
  ...
  %call2_40cce5 = tail call %struct.Memory* @sub_40ffb0._Z17check_shifted_sumIm32custom_multiple_constant_divide2ImEEvT_(%struct.State* nonnull %0, i64 %237, %struct.Memory* %call2_40cc83)
...
block_.L_40ccf8:                                  ; preds = %block_.L_40cc8f
  ...
  %call2_40ccf8 = tail call %struct.Memory* @sub_400eb0._Z5timerv(%struct.State* nonnull %0, i64 %274, %struct.Memory* %call2_40cc83)
  ...
  %call2_40cd01 = tail call %struct.Memory* @sub_400850._Z13record_resultdPKc(%struct.State* nonnull %0, i64 %285, %struct.Memory* %call2_40ccf8)
