...
declare %struct.Memory* @sub_410910._ZN33custom_greaterthanequal_constantsImE8do_shiftEm(%struct.State* dereferenceable(3376), i64, %struct.Memory*) local_unnamed_addr

declare %struct.Memory* @sub_410920._Z17check_shifted_sumIm33custom_greaterthanequal_constantsImEEvT_(%struct.State* dereferenceable(3376), i64, %struct.Memory*) local_unnamed_addr
...
block_.L_40c3bf:                                  ; preds = %block_.L_40c411, %entry
  %68 = phi i64 [ %.pre, %entry ], [ %273, %block_.L_40c411 ]
  %MEMORY.0 = phi %struct.Memory* [ %call2_40c3b3, %entry ], [ %call2_40c415, %block_.L_40c411 ]
...
block_.L_40c3de:                                  ; preds = %block_40c3ea, %block_40c3cf
  %111 = phi i64 [ %.pre6, %block_40c3cf ], [ %232, %block_40c3ea ]
  %MEMORY.1 = phi %struct.Memory* [ %MEMORY.0, %block_40c3cf ], [ %call2_40c3f6, %block_40c3ea ]
...
block_40c3ea:                                     ; preds = %block_.L_40c3de
  ...
  %call2_40c3f6 = tail call %struct.Memory* @sub_410910._ZN33custom_greaterthanequal_constantsImE8do_shiftEm(%struct.State* nonnull %0, i64 %161, %struct.Memory* %MEMORY.1)
...
block_.L_40c411:                                  ; preds = %block_.L_40c3de
  ...
  %call2_40c415 = tail call %struct.Memory* @sub_410920._Z17check_shifted_sumIm33custom_greaterthanequal_constantsImEEvT_(%struct.State* nonnull %0, i64 %237, %struct.Memory* %MEMORY.1)
...
block_.L_40c428:                                  ; preds = %block_.L_40c3bf
  ...
  %call2_40c428 = tail call %struct.Memory* @sub_400ea0._Z5timerv(%struct.State* nonnull %0, i64 %274, %struct.Memory* %MEMORY.0)
