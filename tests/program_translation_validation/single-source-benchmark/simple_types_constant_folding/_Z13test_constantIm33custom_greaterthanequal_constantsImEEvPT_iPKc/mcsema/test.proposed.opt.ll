...
block_.L_40c37f:                                  ; preds = %block_.L_40c3d1, %entry
  %68 = phi i64 [ %.pre, %entry ], [ %273, %block_.L_40c3d1 ]
...
block_.L_40c39e:                                  ; preds = %block_40c3aa, %block_40c38f
  %111 = phi i64 [ %.pre1, %block_40c38f ], [ %232, %block_40c3aa ]
...
block_.L_40c3d1:                                  ; preds = %block_.L_40c39e
  ...
  %call2_40c3d5 = tail call %struct.Memory* @sub_4108e0._Z17check_shifted_sumIm33custom_greaterthanequal_constantsImEEvT_(%struct.State* %0, i64 %237, %struct.Memory* %MEMORY.1)
...
block_.L_40c3e8:                                  ; preds = %block_.L_40c37f
  ...
  %call2_40c3e8 = tail call %struct.Memory* @sub_400e60._Z5timerv(%struct.State* %0, i64 %274, %struct.Memory* %MEMORY.0)
  ...
  %call2_40c3f1 = tail call %struct.Memory* @sub_400800._Z13record_resultdPKc(%struct.State* %0, i64 %285, %struct.Memory* %call2_40c3e8)
