...
declare %struct.Memory* @sub_410290._Z17check_shifted_sumIm33custom_multiple_constant_multiplyImEEvT_(%struct.State* noalias dereferenceable(3376), i64, %struct.Memory* noalias readnone returned) local_unnamed_addr
...
entry:
  ...
  %call2_40ca03 = tail call %struct.Memory* @sub_400e90._Z11start_timerv(%struct.State* %0, i64 %58, %struct.Memory* %2)
...
block_.L_40ca0f:                                  ; preds = %block_.L_40ca61, %entry
  %68 = phi i64 [ %273, %block_.L_40ca61 ], [ %.pre, %entry ]
  ...
  br i1 %101, label %block_40ca1f, label %block_.L_40ca78
...
block_.L_40ca2e:                                  ; preds = %block_40ca3a, %block_40ca1f
  %111 = phi i64 [ %232, %block_40ca3a ], [ %.pre6, %block_40ca1f ]
  ...
  br i1 %147, label %block_40ca3a, label %block_.L_40ca61
...
block_40ca3a:                                     ; preds = %block_.L_40ca2e
  ...
  %call2_40ca46 = tail call %struct.Memory* @sub_410270._ZN33custom_multiple_constant_multiplyImE8do_shiftEm(%struct.State* nonnull %0, i64 %161, %struct.Memory* %call2_40ca03)
...
block_.L_40ca61:                                  ; preds = %block_.L_40ca2e
  ...
  %call2_40ca65 = tail call %struct.Memory* @sub_410290._Z17check_shifted_sumIm33custom_multiple_constant_multiplyImEEvT_(%struct.State* nonnull %0, i64 %237, %struct.Memory* %call2_40ca03)
...
block_.L_40ca78:                                  ; preds = %block_.L_40ca0f
  ...
  %call2_40ca78 = tail call %struct.Memory* @sub_400eb0._Z5timerv(%struct.State* nonnull %0, i64 %274, %struct.Memory* %call2_40ca03)
  ...
  %call2_40ca81 = tail call %struct.Memory* @sub_400850._Z13record_resultdPKc(%struct.State* nonnull %0, i64 %285, %struct.Memory* %call2_40ca78)
