...
declare %struct.Memory* @sub_410280._Z17check_shifted_sumIm33custom_multiple_constant_multiplyImEEvT_(%struct.State* noalias dereferenceable(3376), i64, %struct.Memory* noalias readnone returned) local_unnamed_addr
...
define %struct.Memory* @_Z13test_constantIm33custom_multiple_constant_multiplyImEEvPT_iPKc(%struct.State* noalias, i64, %struct.Memory* noalias readnone) local_unnamed_addr #1 {
entry:
...
block_.L_40c9ff:                                  ; preds = %block_.L_40ca51, %entry
  %68 = phi i64 [ %273, %block_.L_40ca51 ], [ %.pre, %entry ]
...
block_.L_40ca1e:                                  ; preds = %block_40ca2a, %block_40ca0f
  %111 = phi i64 [ %232, %block_40ca2a ], [ %.pre6, %block_40ca0f ]
...
block_40ca2a:                                     ; preds = %block_.L_40ca1e
  ...
  %call2_40ca36 = tail call %struct.Memory* @sub_410260._ZN33custom_multiple_constant_multiplyImE8do_shiftEm(%struct.State* nonnull %0, i64 %161, %struct.Memory* %call2_40c9f3)
...
block_.L_40ca51:                                  ; preds = %block_.L_40ca1e
  ...
  %call2_40ca55 = tail call %struct.Memory* @sub_410280._Z17check_shifted_sumIm33custom_multiple_constant_multiplyImEEvT_(%struct.State* nonnull %0, i64 %237, %struct.Memory* %call2_40c9f3)
...
block_.L_40ca68:                                  ; preds = %block_.L_40c9ff
  ...
  %call2_40ca68 = tail call %struct.Memory* @sub_400ea0._Z5timerv(%struct.State* nonnull %0, i64 %274, %struct.Memory* %call2_40c9f3)
