...
block_.L_40c9bf:                                  ; preds = %block_.L_40ca11, %entry
  %68 = phi i64 [ %.pre, %entry ], [ %273, %block_.L_40ca11 ]
...
block_.L_40c9de:                                  ; preds = %block_40c9ea, %block_40c9cf
  %111 = phi i64 [ %.pre1, %block_40c9cf ], [ %232, %block_40c9ea ]
...
block_.L_40ca11:                                  ; preds = %block_.L_40c9de
  ...
  %call2_40ca15 = tail call %struct.Memory* @sub_410240._Z17check_shifted_sumIm33custom_multiple_constant_multiplyImEEvT_(%struct.State* %0, i64 %237, %struct.Memory* %MEMORY.1)
...
block_.L_40ca28:                                  ; preds = %block_.L_40c9bf
  ...
  %call2_40ca28 = tail call %struct.Memory* @sub_400e60._Z5timerv(%struct.State* %0, i64 %274, %struct.Memory* %MEMORY.0)
  ...
  %call2_40ca31 = tail call %struct.Memory* @sub_400800._Z13record_resultdPKc(%struct.State* %0, i64 %285, %struct.Memory* %call2_40ca28)
