...
declare %struct.Memory* @sub_4101b0._ZN34custom_multiple_constant_multiply2ImE8do_shiftEm(%struct.State* dereferenceable(3376), i64, %struct.Memory*)

declare %struct.Memory* @sub_4101d0._Z17check_shifted_sumIm34custom_multiple_constant_multiply2ImEEvT_(%struct.State* dereferenceable(3376), i64, %struct.Memory*)
...
define %struct.Memory* @_Z13test_constantIm34custom_multiple_constant_multiply2ImEEvPT_iPKc(%struct.State* noalias, i64, %struct.Memory* noalias) #1 {
entry:
