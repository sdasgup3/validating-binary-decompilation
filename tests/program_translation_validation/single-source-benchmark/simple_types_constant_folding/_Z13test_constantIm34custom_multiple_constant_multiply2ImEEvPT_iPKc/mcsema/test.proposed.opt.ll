...
declare %struct.Memory* @sub_4101b0._ZN34custom_multiple_constant_multiply2ImE8do_shiftEm(%struct.State* noalias dereferenceable(3376), i64, %struct.Memory* noalias readnone returned) local_unnamed_addr

declare %struct.Memory* @sub_4101d0._Z17check_shifted_sumIm34custom_multiple_constant_multiply2ImEEvT_(%struct.State* noalias dereferenceable(3376), i64, %struct.Memory* noalias readnone returned) local_unnamed_addr
...
define %struct.Memory* @_Z13test_constantIm34custom_multiple_constant_multiply2ImEEvPT_iPKc(%struct.State* noalias, i64, %struct.Memory* noalias readnone) local_unnamed_addr #1 {
entry:
...
block_.L_40ca9f:                                  ; preds = %block_.L_40caf1, %entry
  %68 = phi i64 [ %273, %block_.L_40caf1 ], [ %.pre, %entry ]
...
block_.L_40cabe:                                  ; preds = %block_40caca, %block_40caaf
  %111 = phi i64 [ %232, %block_40caca ], [ %.pre6, %block_40caaf ]
...
block_40caca:                                     ; preds = %block_.L_40cabe
  ...
  %call2_40cad6 = tail call %struct.Memory* @sub_4101b0._ZN34custom_multiple_constant_multiply2ImE8do_shiftEm(%struct.State* nonnull %0, i64 %161, %struct.Memory* %call2_40ca93)
...
block_.L_40caf1:                                  ; preds = %block_.L_40cabe
  ...
  %call2_40caf5 = tail call %struct.Memory* @sub_4101d0._Z17check_shifted_sumIm34custom_multiple_constant_multiply2ImEEvT_(%struct.State* nonnull %0, i64 %237, %struct.Memory* %call2_40ca93)
...
block_.L_40cb08:                                  ; preds = %block_.L_40ca9f
  ...
  %call2_40cb08 = tail call %struct.Memory* @sub_400ea0._Z5timerv(%struct.State* nonnull %0, i64 %274, %struct.Memory* %call2_40ca93)
