...
block_.L_40ca5f:                                  ; preds = %block_.L_40cab1, %entry
  %68 = phi i64 [ %.pre, %entry ], [ %275, %block_.L_40cab1 ]
...
block_.L_40ca7e:                                  ; preds = %block_40ca8a, %block_40ca6f
  %111 = phi i64 [ %.pre1, %block_40ca6f ], [ %233, %block_40ca8a ]
...
block_.L_40cab1:                                  ; preds = %block_.L_40ca7e
  ...
  %call2_40cab5 = tail call %struct.Memory* @sub_410190._Z17check_shifted_sumIm34custom_multiple_constant_multiply2ImEEvT_(%struct.State* %0, i64 %238, %struct.Memory* %MEMORY.1)
...
block_.L_40cac8:                                  ; preds = %block_.L_40ca5f
  ...
  %call2_40cac8 = tail call %struct.Memory* @sub_400e60._Z5timerv(%struct.State* %0, i64 %276, %struct.Memory* %MEMORY.0)
  ...
  %call2_40cad1 = tail call %struct.Memory* @sub_400800._Z13record_resultdPKc(%struct.State* %0, i64 %287, %struct.Memory* %call2_40cac8)
