...
declare %struct.Memory* @sub_4101e0._Z17check_shifted_sumIm34custom_multiple_constant_multiply2ImEEvT_(%struct.State* noalias dereferenceable(3376), i64, %struct.Memory* noalias readnone returned) local_unnamed_addr
...
entry:
  ...
  %call2_40caa3 = tail call %struct.Memory* @sub_400e90._Z11start_timerv(%struct.State* %0, i64 %58, %struct.Memory* %2)
...
block_.L_40caaf:                                  ; preds = %block_.L_40cb01, %entry
  %68 = phi i64 [ %273, %block_.L_40cb01 ], [ %.pre, %entry ]
  ...
  br i1 %101, label %block_40cabf, label %block_.L_40cb18
...
block_.L_40cace:                                  ; preds = %block_40cada, %block_40cabf
  %111 = phi i64 [ %232, %block_40cada ], [ %.pre6, %block_40cabf ]
  ...
  br i1 %147, label %block_40cada, label %block_.L_40cb01
...
block_40cada:                                     ; preds = %block_.L_40cace
  ...
  %call2_40cae6 = tail call %struct.Memory* @sub_4101c0._ZN34custom_multiple_constant_multiply2ImE8do_shiftEm(%struct.State* nonnull %0, i64 %161, %struct.Memory* %call2_40caa3)
...
block_.L_40cb01:                                  ; preds = %block_.L_40cace
  ...
  %call2_40cb05 = tail call %struct.Memory* @sub_4101e0._Z17check_shifted_sumIm34custom_multiple_constant_multiply2ImEEvT_(%struct.State* nonnull %0, i64 %237, %struct.Memory* %call2_40caa3)
...
block_.L_40cb18:                                  ; preds = %block_.L_40caaf
  ...
  %call2_40cb18 = tail call %struct.Memory* @sub_400eb0._Z5timerv(%struct.State* nonnull %0, i64 %274, %struct.Memory* %call2_40caa3)
  ...
  %call2_40cb21 = tail call %struct.Memory* @sub_400850._Z13record_resultdPKc(%struct.State* nonnull %0, i64 %285, %struct.Memory* %call2_40cb18)
