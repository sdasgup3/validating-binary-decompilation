...
define %struct.Memory* @_Z13test_constantIs10custom_twoIsEEvPT_iPKc(%struct.State* noalias, i64, %struct.Memory* noalias) #1 {
entry:
  ...
  store %struct.Memory* %loadMem_405421, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_405424, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_40542f, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem1_405433, %struct.Memory** %MEMORY
...
block_.L_40543f:                                  ; preds = %block_.L_405497, %entry
  ...
  store %struct.Memory* %loadMem_405442, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_405449, %struct.Memory** %MEMORY
...
block_40544f:                                     ; preds = %block_.L_40543f
...
block_.L_40545c:                                  ; preds = %block_405468, %block_40544f
  ...
  store %struct.Memory* %loadMem_40545c, %struct.Memory** %MEMORY
...
block_405468:                                     ; preds = %block_.L_40545c
  ...
  store %struct.Memory* %loadMem_405470, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem1_405474, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_405485, %struct.Memory** %MEMORY
...
block_.L_405497:                                  ; preds = %block_.L_40545c
  ...
  store %struct.Memory* %loadMem1_40549b, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_4054a6, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_4054a9, %struct.Memory** %MEMORY
  br label %block_.L_40543f

block_.L_4054ae:                                  ; preds = %block_.L_40543f
  ...
  store %struct.Memory* %loadMem1_4054ae, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem1_4054b7, %struct.Memory** %MEMORY
  ...
  ret %struct.Memory* %loadMem_4054c1
}
