...
block_.L_4053ff:                                  ; preds = %block_.L_405457, %entry
  %69 = phi i64 [ %.pre, %entry ], [ %283, %block_.L_405457 ]
...
block_.L_40541c:                                  ; preds = %block_405428, %block_40540f
  %112 = phi i64 [ %.pre1, %block_40540f ], [ %240, %block_405428 ]
...
block_.L_405457:                                  ; preds = %block_.L_40541c
  ...
  %call2_40545b = tail call %struct.Memory* @sub_416340._Z17check_shifted_sumIs10custom_twoIsEEvT_(%struct.State* %0, i64 %247, %struct.Memory* %MEMORY.1)
...
block_.L_40546e:                                  ; preds = %block_.L_4053ff
  ...
  %call2_40546e = tail call %struct.Memory* @sub_400e60._Z5timerv(%struct.State* %0, i64 %284, %struct.Memory* %MEMORY.0)
  ...
  %call2_405477 = tail call %struct.Memory* @sub_400800._Z13record_resultdPKc(%struct.State* %0, i64 %295, %struct.Memory* %call2_40546e)
