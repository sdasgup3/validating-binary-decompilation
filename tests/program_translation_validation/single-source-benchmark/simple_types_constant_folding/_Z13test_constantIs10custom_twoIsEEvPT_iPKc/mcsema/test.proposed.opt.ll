...
declare %struct.Memory* @sub_416380._Z17check_shifted_sumIs10custom_twoIsEEvT_(%struct.State* dereferenceable(3376), i64, %struct.Memory*) local_unnamed_addr
...
block_.L_40543f:                                  ; preds = %block_.L_405497, %entry
  %69 = phi i64 [ %.pre, %entry ], [ %284, %block_.L_405497 ]
  %MEMORY.0 = phi %struct.Memory* [ %call2_405433, %entry ], [ %call2_40549b, %block_.L_405497 ]
...
block_.L_40545c:                                  ; preds = %block_405468, %block_40544f
  %112 = phi i64 [ %.pre6, %block_40544f ], [ %241, %block_405468 ]
  %MEMORY.1 = phi %struct.Memory* [ %MEMORY.0, %block_40544f ], [ %call2_405474, %block_405468 ]
...
block_405468:                                     ; preds = %block_.L_40545c
  ...
  %call2_405474 = tail call %struct.Memory* @sub_416360._ZN10custom_twoIsE8do_shiftEs(%struct.State* nonnull %0, i64 %164, %struct.Memory* %MEMORY.1)
...
block_.L_405497:                                  ; preds = %block_.L_40545c
  ...
  %call2_40549b = tail call %struct.Memory* @sub_416380._Z17check_shifted_sumIs10custom_twoIsEEvT_(%struct.State* nonnull %0, i64 %248, %struct.Memory* %MEMORY.1)
...
block_.L_4054ae:                                  ; preds = %block_.L_40543f
  ...
  %call2_4054ae = tail call %struct.Memory* @sub_400ea0._Z5timerv(%struct.State* nonnull %0, i64 %285, %struct.Memory* %MEMORY.0)
