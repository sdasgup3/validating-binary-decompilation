...
declare %struct.Memory* @sub_415360._Z17check_shifted_sumIs18custom_constant_orIsEEvT_(%struct.State* dereferenceable(3376), i64, %struct.Memory*)
...
define %struct.Memory* @_Z13test_constantIs18custom_constant_orIsEEvPT_iPKc(%struct.State* noalias, i64, %struct.Memory* noalias) #1 {
entry:
