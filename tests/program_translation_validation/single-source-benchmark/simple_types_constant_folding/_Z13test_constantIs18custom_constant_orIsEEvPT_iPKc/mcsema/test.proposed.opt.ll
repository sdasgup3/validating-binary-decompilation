...
declare %struct.Memory* @sub_415320._Z17check_shifted_sumIs18custom_constant_orIsEEvT_(%struct.State* noalias dereferenceable(3376), i64, %struct.Memory* noalias readnone returned) local_unnamed_addr
...
entry:
  ...
  %call2_406733 = tail call %struct.Memory* @sub_400e40._Z11start_timerv(%struct.State* %0, i64 %58, %struct.Memory* %2)
...
block_.L_40673f:                                  ; preds = %block_.L_406797, %entry
  %69 = phi i64 [ %.pre, %entry ], [ %283, %block_.L_406797 ]
  %MEMORY.0 = phi %struct.Memory* [ %call2_406733, %entry ], [ %call2_40679b, %block_.L_406797 ]
  ...
  br i1 %102, label %block_40674f, label %block_.L_4067ae
...
block_.L_40675c:                                  ; preds = %block_406768, %block_40674f
  %112 = phi i64 [ %.pre1, %block_40674f ], [ %240, %block_406768 ]
  %MEMORY.1 = phi %struct.Memory* [ %MEMORY.0, %block_40674f ], [ %call2_406774, %block_406768 ]
  ...
  br i1 %148, label %block_406768, label %block_.L_406797
...
block_406768:                                     ; preds = %block_.L_40675c
  ...
  %call2_406774 = tail call %struct.Memory* @sub_415300._ZN18custom_constant_orIsE8do_shiftEs(%struct.State* %0, i64 %164, %struct.Memory* %MEMORY.1)
...
block_.L_406797:                                  ; preds = %block_.L_40675c
  ...
  %call2_40679b = tail call %struct.Memory* @sub_415320._Z17check_shifted_sumIs18custom_constant_orIsEEvT_(%struct.State* %0, i64 %247, %struct.Memory* %MEMORY.1)
...
block_.L_4067ae:                                  ; preds = %block_.L_40673f
  ...
  %call2_4067ae = tail call %struct.Memory* @sub_400e60._Z5timerv(%struct.State* %0, i64 %284, %struct.Memory* %MEMORY.0)
  ...
  %call2_4067b7 = tail call %struct.Memory* @sub_400800._Z13record_resultdPKc(%struct.State* %0, i64 %295, %struct.Memory* %call2_4067ae)
  ...
  ret %struct.Memory* %call2_4067b7
}
...
define %struct.Memory* @routine_jge_.L_4067ae(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i8* %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
...
define %struct.Memory* @routine_jge_.L_406797(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i8* %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 2, i32 9
...
define %struct.Memory* @routine_jmpq_.L_40675c(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
...
define %struct.Memory* @routine_callq_._Z17check_shifted_sumIs18custom_constant_orIsEEvT_(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
...
define %struct.Memory* @routine_jmpq_.L_40673f(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
