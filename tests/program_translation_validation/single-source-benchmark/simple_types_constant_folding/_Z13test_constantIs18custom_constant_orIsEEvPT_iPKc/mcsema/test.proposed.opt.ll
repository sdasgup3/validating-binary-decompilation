...
declare %struct.Memory* @sub_415360._Z17check_shifted_sumIs18custom_constant_orIsEEvT_(%struct.State* noalias dereferenceable(3376), i64, %struct.Memory* noalias readnone returned) local_unnamed_addr
...
define %struct.Memory* @_Z13test_constantIs18custom_constant_orIsEEvPT_iPKc(%struct.State* noalias, i64, %struct.Memory* noalias readnone) local_unnamed_addr #1 {
entry:
...
block_.L_40677f:                                  ; preds = %block_.L_4067d7, %entry
  %69 = phi i64 [ %284, %block_.L_4067d7 ], [ %.pre, %entry ]
...
block_.L_40679c:                                  ; preds = %block_4067a8, %block_40678f
  %112 = phi i64 [ %241, %block_4067a8 ], [ %.pre6, %block_40678f ]
...
block_4067a8:                                     ; preds = %block_.L_40679c
  ...
  %call2_4067b4 = tail call %struct.Memory* @sub_415340._ZN18custom_constant_orIsE8do_shiftEs(%struct.State* nonnull %0, i64 %164, %struct.Memory* %call2_406773)
...
block_.L_4067d7:                                  ; preds = %block_.L_40679c
  ...
  %call2_4067db = tail call %struct.Memory* @sub_415360._Z17check_shifted_sumIs18custom_constant_orIsEEvT_(%struct.State* nonnull %0, i64 %248, %struct.Memory* %call2_406773)
...
block_.L_4067ee:                                  ; preds = %block_.L_40677f
  ...
  %call2_4067ee = tail call %struct.Memory* @sub_400ea0._Z5timerv(%struct.State* nonnull %0, i64 %285, %struct.Memory* %call2_406773)
