...
block_.L_40673f:                                  ; preds = %block_.L_406797, %entry
  %69 = phi i64 [ %.pre, %entry ], [ %285, %block_.L_406797 ]
...
block_.L_40675c:                                  ; preds = %block_406768, %block_40674f
  %112 = phi i64 [ %.pre1, %block_40674f ], [ %241, %block_406768 ]
...
block_.L_406797:                                  ; preds = %block_.L_40675c
  ...
  %call2_40679b = tail call %struct.Memory* @sub_415320._Z17check_shifted_sumIs18custom_constant_orIsEEvT_(%struct.State* %0, i64 %248, %struct.Memory* %MEMORY.1)
...
block_.L_4067ae:                                  ; preds = %block_.L_40673f
  ...
  %call2_4067ae = tail call %struct.Memory* @sub_400e60._Z5timerv(%struct.State* %0, i64 %286, %struct.Memory* %MEMORY.0)
  ...
  %call2_4067b7 = tail call %struct.Memory* @sub_400800._Z13record_resultdPKc(%struct.State* %0, i64 %297, %struct.Memory* %call2_4067ae)
