...
declare %struct.Memory* @sub_415b10._Z17check_shifted_sumIs19custom_constant_addIsEEvT_(%struct.State* noalias dereferenceable(3376), i64, %struct.Memory* noalias readnone returned) local_unnamed_addr
...
define %struct.Memory* @_Z13test_constantIs19custom_constant_addIsEEvPT_iPKc(%struct.State* noalias, i64, %struct.Memory* noalias readnone) local_unnamed_addr #1 {
entry:
...
block_.L_405e8f:                                  ; preds = %block_.L_405ee7, %entry
  %69 = phi i64 [ %284, %block_.L_405ee7 ], [ %.pre, %entry ]
...
block_.L_405eac:                                  ; preds = %block_405eb8, %block_405e9f
  %112 = phi i64 [ %241, %block_405eb8 ], [ %.pre6, %block_405e9f ]
...
block_405eb8:                                     ; preds = %block_.L_405eac
  ...
  %call2_405ec4 = tail call %struct.Memory* @sub_415af0._ZN19custom_constant_addIsE8do_shiftEs(%struct.State* nonnull %0, i64 %164, %struct.Memory* %call2_405e83)
...
block_.L_405ee7:                                  ; preds = %block_.L_405eac
  ...
  %call2_405eeb = tail call %struct.Memory* @sub_415b10._Z17check_shifted_sumIs19custom_constant_addIsEEvT_(%struct.State* nonnull %0, i64 %248, %struct.Memory* %call2_405e83)
...
block_.L_405efe:                                  ; preds = %block_.L_405e8f
  ...
  %call2_405efe = tail call %struct.Memory* @sub_400ea0._Z5timerv(%struct.State* nonnull %0, i64 %285, %struct.Memory* %call2_405e83)
