...
declare %struct.Memory* @sub_415b20._Z17check_shifted_sumIs19custom_constant_addIsEEvT_(%struct.State* noalias dereferenceable(3376), i64, %struct.Memory* noalias readnone returned) local_unnamed_addr
...
entry:
  ...
  %call2_405e93 = tail call %struct.Memory* @sub_400e90._Z11start_timerv(%struct.State* %0, i64 %58, %struct.Memory* %2)
...
block_.L_405e9f:                                  ; preds = %block_.L_405ef7, %entry
  %69 = phi i64 [ %284, %block_.L_405ef7 ], [ %.pre, %entry ]
  ...
  br i1 %102, label %block_405eaf, label %block_.L_405f0e
...
block_.L_405ebc:                                  ; preds = %block_405ec8, %block_405eaf
  %112 = phi i64 [ %241, %block_405ec8 ], [ %.pre6, %block_405eaf ]
  ...
  br i1 %148, label %block_405ec8, label %block_.L_405ef7
...
block_405ec8:                                     ; preds = %block_.L_405ebc
  ...
  %call2_405ed4 = tail call %struct.Memory* @sub_415b00._ZN19custom_constant_addIsE8do_shiftEs(%struct.State* nonnull %0, i64 %164, %struct.Memory* %call2_405e93)
...
block_.L_405ef7:                                  ; preds = %block_.L_405ebc
  ...
  %call2_405efb = tail call %struct.Memory* @sub_415b20._Z17check_shifted_sumIs19custom_constant_addIsEEvT_(%struct.State* nonnull %0, i64 %248, %struct.Memory* %call2_405e93)
...
block_.L_405f0e:                                  ; preds = %block_.L_405e9f
  ...
  %call2_405f0e = tail call %struct.Memory* @sub_400eb0._Z5timerv(%struct.State* nonnull %0, i64 %285, %struct.Memory* %call2_405e93)
  ...
  %call2_405f17 = tail call %struct.Memory* @sub_400850._Z13record_resultdPKc(%struct.State* nonnull %0, i64 %296, %struct.Memory* %call2_405f0e)
