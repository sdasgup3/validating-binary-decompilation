...
declare %struct.Memory* @sub_415ad0._Z17check_shifted_sumIs19custom_constant_addIsEEvT_(%struct.State* noalias dereferenceable(3376), i64, %struct.Memory* noalias readnone returned) local_unnamed_addr
...
define %struct.Memory* @_Z13test_constantIs19custom_constant_addIsEEvPT_iPKc(%struct.State* noalias, i64, %struct.Memory* noalias) local_unnamed_addr #1 {
entry:
  ...
  %call2_405e43 = tail call %struct.Memory* @sub_400e40._Z11start_timerv(%struct.State* %0, i64 %58, %struct.Memory* %2)
...
block_.L_405e4f:                                  ; preds = %block_.L_405ea7, %entry
  %69 = phi i64 [ %.pre, %entry ], [ %285, %block_.L_405ea7 ]
  %MEMORY.0 = phi %struct.Memory* [ %call2_405e43, %entry ], [ %call2_405eab, %block_.L_405ea7 ]
  ...
  br i1 %102, label %block_405e5f, label %block_.L_405ebe
...
block_.L_405e6c:                                  ; preds = %block_405e78, %block_405e5f
  %112 = phi i64 [ %.pre1, %block_405e5f ], [ %241, %block_405e78 ]
  %MEMORY.1 = phi %struct.Memory* [ %MEMORY.0, %block_405e5f ], [ %call2_405e84, %block_405e78 ]
  ...
  br i1 %148, label %block_405e78, label %block_.L_405ea7
...
block_405e78:                                     ; preds = %block_.L_405e6c
  ...
  %call2_405e84 = tail call %struct.Memory* @sub_415ab0._ZN19custom_constant_addIsE8do_shiftEs(%struct.State* %0, i64 %164, %struct.Memory* %MEMORY.1)
...
block_.L_405ea7:                                  ; preds = %block_.L_405e6c
  ...
  %call2_405eab = tail call %struct.Memory* @sub_415ad0._Z17check_shifted_sumIs19custom_constant_addIsEEvT_(%struct.State* %0, i64 %248, %struct.Memory* %MEMORY.1)
...
block_.L_405ebe:                                  ; preds = %block_.L_405e4f
  ...
  %call2_405ebe = tail call %struct.Memory* @sub_400e60._Z5timerv(%struct.State* %0, i64 %286, %struct.Memory* %MEMORY.0)
  ...
  %call2_405ec7 = tail call %struct.Memory* @sub_400800._Z13record_resultdPKc(%struct.State* %0, i64 %297, %struct.Memory* %call2_405ebe)
  ...
  ret %struct.Memory* %call2_405ec7
}
...
define %struct.Memory* @routine_jge_.L_405ebe(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i8* %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
...
define %struct.Memory* @routine_jge_.L_405ea7(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i8* %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 2, i32 9
...
define %struct.Memory* @routine_jmpq_.L_405e6c(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
...
define %struct.Memory* @routine_callq_._Z17check_shifted_sumIs19custom_constant_addIsEEvT_(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
...
define %struct.Memory* @routine_jmpq_.L_405e4f(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
