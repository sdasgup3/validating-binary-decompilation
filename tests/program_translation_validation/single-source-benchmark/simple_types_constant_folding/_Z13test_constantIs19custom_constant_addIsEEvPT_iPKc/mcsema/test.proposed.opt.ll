...
block_.L_405e4f:                                  ; preds = %block_.L_405ea7, %entry
  %69 = phi i64 [ %.pre, %entry ], [ %283, %block_.L_405ea7 ]
...
block_.L_405e6c:                                  ; preds = %block_405e78, %block_405e5f
  %112 = phi i64 [ %.pre1, %block_405e5f ], [ %240, %block_405e78 ]
...
block_.L_405ea7:                                  ; preds = %block_.L_405e6c
  ...
  %call2_405eab = tail call %struct.Memory* @sub_415ad0._Z17check_shifted_sumIs19custom_constant_addIsEEvT_(%struct.State* %0, i64 %247, %struct.Memory* %MEMORY.1)
...
block_.L_405ebe:                                  ; preds = %block_.L_405e4f
  ...
  %call2_405ebe = tail call %struct.Memory* @sub_400e60._Z5timerv(%struct.State* %0, i64 %284, %struct.Memory* %MEMORY.0)
  ...
  %call2_405ec7 = tail call %struct.Memory* @sub_400800._Z13record_resultdPKc(%struct.State* %0, i64 %295, %struct.Memory* %call2_405ebe)
