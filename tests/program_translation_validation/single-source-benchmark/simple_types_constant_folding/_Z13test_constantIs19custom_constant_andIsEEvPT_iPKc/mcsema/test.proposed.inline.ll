...
declare %struct.Memory* @sub_415470._ZN19custom_constant_andIsE8do_shiftEs(%struct.State* dereferenceable(3376), i64, %struct.Memory*)

declare %struct.Memory* @sub_415490._Z17check_shifted_sumIs19custom_constant_andIsEEvT_(%struct.State* dereferenceable(3376), i64, %struct.Memory*)
...
define %struct.Memory* @_Z13test_constantIs19custom_constant_andIsEEvPT_iPKc(%struct.State* noalias, i64, %struct.Memory* noalias) #1 {
entry:
