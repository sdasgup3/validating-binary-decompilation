...
block_.L_4065df:                                  ; preds = %block_.L_406637, %entry
  %69 = phi i64 [ %.pre, %entry ], [ %283, %block_.L_406637 ]
...
block_.L_4065fc:                                  ; preds = %block_406608, %block_4065ef
  %112 = phi i64 [ %.pre1, %block_4065ef ], [ %240, %block_406608 ]
...
block_.L_406637:                                  ; preds = %block_.L_4065fc
  ...
  %call2_40663b = tail call %struct.Memory* @sub_415450._Z17check_shifted_sumIs19custom_constant_andIsEEvT_(%struct.State* %0, i64 %247, %struct.Memory* %MEMORY.1)
...
block_.L_40664e:                                  ; preds = %block_.L_4065df
  ...
  %call2_40664e = tail call %struct.Memory* @sub_400e60._Z5timerv(%struct.State* %0, i64 %284, %struct.Memory* %MEMORY.0)
  ...
  %call2_406657 = tail call %struct.Memory* @sub_400800._Z13record_resultdPKc(%struct.State* %0, i64 %295, %struct.Memory* %call2_40664e)
