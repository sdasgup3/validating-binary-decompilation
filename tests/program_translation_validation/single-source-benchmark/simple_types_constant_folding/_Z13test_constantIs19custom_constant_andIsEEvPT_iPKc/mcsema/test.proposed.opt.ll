...
declare %struct.Memory* @sub_415470._ZN19custom_constant_andIsE8do_shiftEs(%struct.State* dereferenceable(3376), i64, %struct.Memory*) local_unnamed_addr

declare %struct.Memory* @sub_415490._Z17check_shifted_sumIs19custom_constant_andIsEEvT_(%struct.State* dereferenceable(3376), i64, %struct.Memory*) local_unnamed_addr
...
block_.L_40661f:                                  ; preds = %block_.L_406677, %entry
  %69 = phi i64 [ %.pre, %entry ], [ %284, %block_.L_406677 ]
  %MEMORY.0 = phi %struct.Memory* [ %call2_406613, %entry ], [ %call2_40667b, %block_.L_406677 ]
...
block_.L_40663c:                                  ; preds = %block_406648, %block_40662f
  %112 = phi i64 [ %.pre6, %block_40662f ], [ %241, %block_406648 ]
  %MEMORY.1 = phi %struct.Memory* [ %MEMORY.0, %block_40662f ], [ %call2_406654, %block_406648 ]
...
block_406648:                                     ; preds = %block_.L_40663c
  ...
  %call2_406654 = tail call %struct.Memory* @sub_415470._ZN19custom_constant_andIsE8do_shiftEs(%struct.State* nonnull %0, i64 %164, %struct.Memory* %MEMORY.1)
...
block_.L_406677:                                  ; preds = %block_.L_40663c
  ...
  %call2_40667b = tail call %struct.Memory* @sub_415490._Z17check_shifted_sumIs19custom_constant_andIsEEvT_(%struct.State* nonnull %0, i64 %248, %struct.Memory* %MEMORY.1)
...
block_.L_40668e:                                  ; preds = %block_.L_40661f
  ...
  %call2_40668e = tail call %struct.Memory* @sub_400ea0._Z5timerv(%struct.State* nonnull %0, i64 %285, %struct.Memory* %MEMORY.0)
