...
block_.L_405faf:                                  ; preds = %block_.L_406007, %entry
  %69 = phi i64 [ %.pre, %entry ], [ %283, %block_.L_406007 ]
...
block_.L_405fcc:                                  ; preds = %block_405fd8, %block_405fbf
  %112 = phi i64 [ %.pre1, %block_405fbf ], [ %240, %block_405fd8 ]
...
block_.L_406007:                                  ; preds = %block_.L_405fcc
  ...
  %call2_40600b = tail call %struct.Memory* @sub_4159a0._Z17check_shifted_sumIs19custom_constant_subIsEEvT_(%struct.State* %0, i64 %247, %struct.Memory* %MEMORY.1)
...
block_.L_40601e:                                  ; preds = %block_.L_405faf
  ...
  %call2_40601e = tail call %struct.Memory* @sub_400e60._Z5timerv(%struct.State* %0, i64 %284, %struct.Memory* %MEMORY.0)
  ...
  %call2_406027 = tail call %struct.Memory* @sub_400800._Z13record_resultdPKc(%struct.State* %0, i64 %295, %struct.Memory* %call2_40601e)
