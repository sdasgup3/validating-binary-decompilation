...
declare %struct.Memory* @sub_4159c0._ZN19custom_constant_subIsE8do_shiftEs(%struct.State* noalias dereferenceable(3376), i64, %struct.Memory* noalias readnone returned) local_unnamed_addr

declare %struct.Memory* @sub_4159e0._Z17check_shifted_sumIs19custom_constant_subIsEEvT_(%struct.State* noalias dereferenceable(3376), i64, %struct.Memory* noalias readnone returned) local_unnamed_addr
...
define %struct.Memory* @_Z13test_constantIs19custom_constant_subIsEEvPT_iPKc(%struct.State* noalias, i64, %struct.Memory* noalias readnone) local_unnamed_addr #1 {
entry:
...
block_.L_405fef:                                  ; preds = %block_.L_406047, %entry
  %69 = phi i64 [ %284, %block_.L_406047 ], [ %.pre, %entry ]
...
block_.L_40600c:                                  ; preds = %block_406018, %block_405fff
  %112 = phi i64 [ %241, %block_406018 ], [ %.pre6, %block_405fff ]
...
block_406018:                                     ; preds = %block_.L_40600c
  ...
  %call2_406024 = tail call %struct.Memory* @sub_4159c0._ZN19custom_constant_subIsE8do_shiftEs(%struct.State* nonnull %0, i64 %164, %struct.Memory* %call2_405fe3)
...
block_.L_406047:                                  ; preds = %block_.L_40600c
  ...
  %call2_40604b = tail call %struct.Memory* @sub_4159e0._Z17check_shifted_sumIs19custom_constant_subIsEEvT_(%struct.State* nonnull %0, i64 %248, %struct.Memory* %call2_405fe3)
...
block_.L_40605e:                                  ; preds = %block_.L_405fef
  ...
  %call2_40605e = tail call %struct.Memory* @sub_400ea0._Z5timerv(%struct.State* nonnull %0, i64 %285, %struct.Memory* %call2_405fe3)
