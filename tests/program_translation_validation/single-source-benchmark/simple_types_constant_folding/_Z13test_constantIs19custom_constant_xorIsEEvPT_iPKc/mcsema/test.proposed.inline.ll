...
define %struct.Memory* @_Z13test_constantIs19custom_constant_xorIsEEvPT_iPKc(%struct.State* noalias, i64, %struct.Memory* noalias) #2 {
entry:
  ...
  store i64 %78, i64* %81
  store %struct.Memory* %loadMem_4068c8, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_4068cf, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem1_4068d3, %struct.Memory** %MEMORY
...
block_.L_4068df:                                  ; preds = %block_.L_406937, %entry
...
block_4068ef:                                     ; preds = %block_.L_4068df
...
block_.L_4068fc:                                  ; preds = %block_406908, %block_4068ef
  ...
  store %struct.Memory* %loadMem_4068fc, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_4068ff, %struct.Memory** %MEMORY
...
block_406908:                                     ; preds = %block_.L_4068fc
  ...
  store %struct.Memory* %loadMem_406908, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_406910, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem1_406914, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_406919, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_406920, %struct.Memory** %MEMORY
...
block_.L_406937:                                  ; preds = %block_.L_4068fc
  ...
  store %struct.Memory* %loadMem1_40693b, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_406949, %struct.Memory** %MEMORY
  br label %block_.L_4068df

block_.L_40694e:                                  ; preds = %block_.L_4068df
  ...
  store %struct.Memory* %loadMem1_40694e, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_406953, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_406960, %struct.Memory** %MEMORY
  ...
  ret %struct.Memory* %loadMem_406961
}
