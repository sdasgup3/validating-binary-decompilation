...
block_.L_40689f:                                  ; preds = %block_.L_4068f7, %entry
  %69 = phi i64 [ %.pre, %entry ], [ %283, %block_.L_4068f7 ]
...
block_.L_4068bc:                                  ; preds = %block_4068c8, %block_4068af
  %112 = phi i64 [ %.pre1, %block_4068af ], [ %240, %block_4068c8 ]
...
block_.L_4068f7:                                  ; preds = %block_.L_4068bc
  ...
  %call2_4068fb = tail call %struct.Memory* @sub_4151f0._Z17check_shifted_sumIs19custom_constant_xorIsEEvT_(%struct.State* %0, i64 %247, %struct.Memory* %MEMORY.1)
...
block_.L_40690e:                                  ; preds = %block_.L_40689f
  ...
  %call2_40690e = tail call %struct.Memory* @sub_400e60._Z5timerv(%struct.State* %0, i64 %284, %struct.Memory* %MEMORY.0)
  ...
  %call2_406917 = tail call %struct.Memory* @sub_400800._Z13record_resultdPKc(%struct.State* %0, i64 %295, %struct.Memory* %call2_40690e)
