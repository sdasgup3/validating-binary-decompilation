...
declare %struct.Memory* @sub_415220._ZN19custom_constant_xorIsE8do_shiftEs(%struct.State* noalias dereferenceable(3376), i64, %struct.Memory* noalias readnone returned) local_unnamed_addr

declare %struct.Memory* @sub_415240._Z17check_shifted_sumIs19custom_constant_xorIsEEvT_(%struct.State* noalias dereferenceable(3376), i64, %struct.Memory* noalias readnone returned) local_unnamed_addr
...
entry:
  ...
  %call2_4068e3 = tail call %struct.Memory* @sub_400e90._Z11start_timerv(%struct.State* %0, i64 %58, %struct.Memory* %2)
...
block_.L_4068ef:                                  ; preds = %block_.L_406947, %entry
  %69 = phi i64 [ %284, %block_.L_406947 ], [ %.pre, %entry ]
  ...
  br i1 %102, label %block_4068ff, label %block_.L_40695e
...
block_.L_40690c:                                  ; preds = %block_406918, %block_4068ff
  %112 = phi i64 [ %241, %block_406918 ], [ %.pre6, %block_4068ff ]
  ...
  br i1 %148, label %block_406918, label %block_.L_406947
...
block_406918:                                     ; preds = %block_.L_40690c
  ...
  %call2_406924 = tail call %struct.Memory* @sub_415220._ZN19custom_constant_xorIsE8do_shiftEs(%struct.State* nonnull %0, i64 %164, %struct.Memory* %call2_4068e3)
...
block_.L_406947:                                  ; preds = %block_.L_40690c
  ...
  %call2_40694b = tail call %struct.Memory* @sub_415240._Z17check_shifted_sumIs19custom_constant_xorIsEEvT_(%struct.State* nonnull %0, i64 %248, %struct.Memory* %call2_4068e3)
...
block_.L_40695e:                                  ; preds = %block_.L_4068ef
  ...
  %call2_40695e = tail call %struct.Memory* @sub_400eb0._Z5timerv(%struct.State* nonnull %0, i64 %285, %struct.Memory* %call2_4068e3)
  ...
  %call2_406967 = tail call %struct.Memory* @sub_400850._Z13record_resultdPKc(%struct.State* nonnull %0, i64 %296, %struct.Memory* %call2_40695e)
