...
declare %struct.Memory* @sub_415210._ZN19custom_constant_xorIsE8do_shiftEs(%struct.State* noalias dereferenceable(3376), i64, %struct.Memory* noalias readnone returned) local_unnamed_addr

declare %struct.Memory* @sub_415230._Z17check_shifted_sumIs19custom_constant_xorIsEEvT_(%struct.State* noalias dereferenceable(3376), i64, %struct.Memory* noalias readnone returned) local_unnamed_addr
...
define %struct.Memory* @_Z13test_constantIs19custom_constant_xorIsEEvPT_iPKc(%struct.State* noalias, i64, %struct.Memory* noalias readnone) local_unnamed_addr #1 {
entry:
...
block_.L_4068df:                                  ; preds = %block_.L_406937, %entry
  %69 = phi i64 [ %284, %block_.L_406937 ], [ %.pre, %entry ]
...
block_.L_4068fc:                                  ; preds = %block_406908, %block_4068ef
  %112 = phi i64 [ %241, %block_406908 ], [ %.pre6, %block_4068ef ]
...
block_406908:                                     ; preds = %block_.L_4068fc
  ...
  %call2_406914 = tail call %struct.Memory* @sub_415210._ZN19custom_constant_xorIsE8do_shiftEs(%struct.State* nonnull %0, i64 %164, %struct.Memory* %call2_4068d3)
...
block_.L_406937:                                  ; preds = %block_.L_4068fc
  ...
  %call2_40693b = tail call %struct.Memory* @sub_415230._Z17check_shifted_sumIs19custom_constant_xorIsEEvT_(%struct.State* nonnull %0, i64 %248, %struct.Memory* %call2_4068d3)
...
block_.L_40694e:                                  ; preds = %block_.L_4068df
  ...
  %call2_40694e = tail call %struct.Memory* @sub_400ea0._Z5timerv(%struct.State* nonnull %0, i64 %285, %struct.Memory* %call2_4068d3)
