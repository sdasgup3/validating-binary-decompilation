...
block_.L_405cef:                                  ; preds = %block_.L_405d47, %entry
  %69 = phi i64 [ %.pre, %entry ], [ %283, %block_.L_405d47 ]
...
block_.L_405d0c:                                  ; preds = %block_405d18, %block_405cff
  %112 = phi i64 [ %.pre1, %block_405cff ], [ %240, %block_405d18 ]
...
block_.L_405d47:                                  ; preds = %block_.L_405d0c
  ...
  %call2_405d4b = tail call %struct.Memory* @sub_415bf0._Z17check_shifted_sumIs19custom_or_constantsIsEEvT_(%struct.State* %0, i64 %247, %struct.Memory* %MEMORY.1)
...
block_.L_405d5e:                                  ; preds = %block_.L_405cef
  ...
  %call2_405d5e = tail call %struct.Memory* @sub_400e60._Z5timerv(%struct.State* %0, i64 %284, %struct.Memory* %MEMORY.0)
  ...
  %call2_405d67 = tail call %struct.Memory* @sub_400800._Z13record_resultdPKc(%struct.State* %0, i64 %295, %struct.Memory* %call2_405d5e)
