...
define %struct.Memory* @_Z13test_constantIs20custom_add_constantsIsEEvPT_iPKc(%struct.State* noalias, i64, %struct.Memory* noalias) #1 {
entry:
  ...
  store %struct.Memory* %loadMem_4054df, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem1_4054e3, %struct.Memory** %MEMORY
...
block_4054ff:                                     ; preds = %block_.L_4054ef
  ...
  store i32 0, i32* %236
  store %struct.Memory* %loadMem_405505, %struct.Memory** %MEMORY
...
block_.L_40550c:                                  ; preds = %block_405518, %block_4054ff
  ...
  store %struct.Memory* %loadMem_405512, %struct.Memory** %MEMORY
...
block_405518:                                     ; preds = %block_.L_40550c
  ...
  store %struct.Memory* %loadMem_405518, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_405520, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem1_405524, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_405529, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_405532, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_405535, %struct.Memory** %MEMORY
...
block_.L_405547:                                  ; preds = %block_.L_40550c
  ...
  store %struct.Memory* %loadMem_405547, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem1_40554b, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_405553, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_405556, %struct.Memory** %MEMORY
...
block_.L_40555e:                                  ; preds = %block_.L_4054ef
  ...
  store %struct.Memory* %loadMem1_40555e, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem1_405567, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_40556c, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_405570, %struct.Memory** %MEMORY
  ...
  ret %struct.Memory* %loadMem_405571
}
