...
block_.L_4054af:                                  ; preds = %block_.L_405507, %entry
  %69 = phi i64 [ %.pre, %entry ], [ %285, %block_.L_405507 ]
...
block_.L_4054cc:                                  ; preds = %block_4054d8, %block_4054bf
  %112 = phi i64 [ %.pre1, %block_4054bf ], [ %241, %block_4054d8 ]
...
block_.L_405507:                                  ; preds = %block_.L_4054cc
  ...
  %call2_40550b = tail call %struct.Memory* @sub_4162b0._Z17check_shifted_sumIs20custom_add_constantsIsEEvT_(%struct.State* %0, i64 %248, %struct.Memory* %MEMORY.1)
...
block_.L_40551e:                                  ; preds = %block_.L_4054af
  ...
  %call2_40551e = tail call %struct.Memory* @sub_400e60._Z5timerv(%struct.State* %0, i64 %286, %struct.Memory* %MEMORY.0)
  ...
  %call2_405527 = tail call %struct.Memory* @sub_400800._Z13record_resultdPKc(%struct.State* %0, i64 %297, %struct.Memory* %call2_40551e)
