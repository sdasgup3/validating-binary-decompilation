...
declare %struct.Memory* @sub_4162d0._ZN20custom_add_constantsIsE8do_shiftEs(%struct.State* noalias dereferenceable(3376), i64, %struct.Memory* noalias readnone returned) local_unnamed_addr

declare %struct.Memory* @sub_4162f0._Z17check_shifted_sumIs20custom_add_constantsIsEEvT_(%struct.State* noalias dereferenceable(3376), i64, %struct.Memory* noalias readnone returned) local_unnamed_addr
...
define %struct.Memory* @_Z13test_constantIs20custom_add_constantsIsEEvPT_iPKc(%struct.State* noalias, i64, %struct.Memory* noalias readnone) local_unnamed_addr #1 {
entry:
...
block_.L_4054ef:                                  ; preds = %block_.L_405547, %entry
  %69 = phi i64 [ %284, %block_.L_405547 ], [ %.pre, %entry ]
...
block_.L_40550c:                                  ; preds = %block_405518, %block_4054ff
  %112 = phi i64 [ %241, %block_405518 ], [ %.pre6, %block_4054ff ]
...
block_405518:                                     ; preds = %block_.L_40550c
  ...
  %call2_405524 = tail call %struct.Memory* @sub_4162d0._ZN20custom_add_constantsIsE8do_shiftEs(%struct.State* nonnull %0, i64 %164, %struct.Memory* %call2_4054e3)
...
block_.L_405547:                                  ; preds = %block_.L_40550c
  ...
  %call2_40554b = tail call %struct.Memory* @sub_4162f0._Z17check_shifted_sumIs20custom_add_constantsIsEEvT_(%struct.State* nonnull %0, i64 %248, %struct.Memory* %call2_4054e3)
...
block_.L_40555e:                                  ; preds = %block_.L_4054ef
  ...
  %call2_40555e = tail call %struct.Memory* @sub_400ea0._Z5timerv(%struct.State* nonnull %0, i64 %285, %struct.Memory* %call2_4054e3)
