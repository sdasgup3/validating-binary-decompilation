...
declare %struct.Memory* @sub_415cc0._Z17check_shifted_sumIs20custom_and_constantsIsEEvT_(%struct.State* dereferenceable(3376), i64, %struct.Memory*)
...
define %struct.Memory* @_Z13test_constantIs20custom_and_constantsIsEEvPT_iPKc(%struct.State* noalias, i64, %struct.Memory* noalias) #1 {
entry:
