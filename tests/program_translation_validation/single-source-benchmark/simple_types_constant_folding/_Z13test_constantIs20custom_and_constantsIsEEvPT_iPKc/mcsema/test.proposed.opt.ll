...
block_.L_405c3f:                                  ; preds = %block_.L_405c97, %entry
  %69 = phi i64 [ %.pre, %entry ], [ %285, %block_.L_405c97 ]
...
block_.L_405c5c:                                  ; preds = %block_405c68, %block_405c4f
  %112 = phi i64 [ %.pre1, %block_405c4f ], [ %241, %block_405c68 ]
...
block_.L_405c97:                                  ; preds = %block_.L_405c5c
  ...
  %call2_405c9b = tail call %struct.Memory* @sub_415c80._Z17check_shifted_sumIs20custom_and_constantsIsEEvT_(%struct.State* %0, i64 %248, %struct.Memory* %MEMORY.1)
...
block_.L_405cae:                                  ; preds = %block_.L_405c3f
  ...
  %call2_405cae = tail call %struct.Memory* @sub_400e60._Z5timerv(%struct.State* %0, i64 %286, %struct.Memory* %MEMORY.0)
  ...
  %call2_405cb7 = tail call %struct.Memory* @sub_400800._Z13record_resultdPKc(%struct.State* %0, i64 %297, %struct.Memory* %call2_405cae)
