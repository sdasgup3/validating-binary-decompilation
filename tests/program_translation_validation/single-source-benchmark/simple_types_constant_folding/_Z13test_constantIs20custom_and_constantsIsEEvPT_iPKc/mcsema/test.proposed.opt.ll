...
declare %struct.Memory* @sub_415cc0._Z17check_shifted_sumIs20custom_and_constantsIsEEvT_(%struct.State* noalias dereferenceable(3376), i64, %struct.Memory* noalias readnone returned) local_unnamed_addr
...
block_.L_405c7f:                                  ; preds = %block_.L_405cd7, %entry
  %69 = phi i64 [ %284, %block_.L_405cd7 ], [ %.pre, %entry ]
...
block_.L_405c9c:                                  ; preds = %block_405ca8, %block_405c8f
  %112 = phi i64 [ %241, %block_405ca8 ], [ %.pre6, %block_405c8f ]
...
block_405ca8:                                     ; preds = %block_.L_405c9c
  ...
  %call2_405cb4 = tail call %struct.Memory* @sub_415ca0._ZN20custom_and_constantsIsE8do_shiftEs(%struct.State* nonnull %0, i64 %164, %struct.Memory* %call2_405c73)
...
block_.L_405cd7:                                  ; preds = %block_.L_405c9c
  ...
  %call2_405cdb = tail call %struct.Memory* @sub_415cc0._Z17check_shifted_sumIs20custom_and_constantsIsEEvT_(%struct.State* nonnull %0, i64 %248, %struct.Memory* %call2_405c73)
...
block_.L_405cee:                                  ; preds = %block_.L_405c7f
  ...
  %call2_405cee = tail call %struct.Memory* @sub_400ea0._Z5timerv(%struct.State* nonnull %0, i64 %285, %struct.Memory* %call2_405c73)
