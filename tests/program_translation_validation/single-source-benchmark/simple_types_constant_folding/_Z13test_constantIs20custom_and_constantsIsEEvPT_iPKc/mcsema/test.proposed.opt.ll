...
declare %struct.Memory* @sub_415c80._Z17check_shifted_sumIs20custom_and_constantsIsEEvT_(%struct.State* noalias dereferenceable(3376), i64, %struct.Memory* noalias readnone returned) local_unnamed_addr
...
entry:
  ...
  %call2_405c33 = tail call %struct.Memory* @sub_400e40._Z11start_timerv(%struct.State* %0, i64 %58, %struct.Memory* %2)
  ...
  br label %block_.L_405c3f

block_.L_405c3f:                                  ; preds = %block_.L_405c97, %entry
  %69 = phi i64 [ %.pre, %entry ], [ %283, %block_.L_405c97 ]
  %MEMORY.0 = phi %struct.Memory* [ %call2_405c33, %entry ], [ %call2_405c9b, %block_.L_405c97 ]
  ...
  br i1 %102, label %block_405c4f, label %block_.L_405cae

block_405c4f:                                     ; preds = %block_.L_405c3f
  %104 = add i64 %70, -30
  %105 = add i64 %103, 6
  ...
  br label %block_.L_405c5c

block_.L_405c5c:                                  ; preds = %block_405c68, %block_405c4f
  %112 = phi i64 [ %.pre1, %block_405c4f ], [ %240, %block_405c68 ]
  %MEMORY.1 = phi %struct.Memory* [ %MEMORY.0, %block_405c4f ], [ %call2_405c74, %block_405c68 ]
  ...
  br i1 %148, label %block_405c68, label %block_.L_405c97

block_405c68:                                     ; preds = %block_.L_405c5c
  %150 = add i64 %113, -8
  %151 = add i64 %149, 4
  ...
  %call2_405c74 = tail call %struct.Memory* @sub_415c60._ZN20custom_and_constantsIsE8do_shiftEs(%struct.State* %0, i64 %164, %struct.Memory* %MEMORY.1)
...
block_.L_405c97:                                  ; preds = %block_.L_405c5c
  %241 = add i64 %113, -30
  %242 = add i64 %149, 4
  ...
  %call2_405c9b = tail call %struct.Memory* @sub_415c80._Z17check_shifted_sumIs20custom_and_constantsIsEEvT_(%struct.State* %0, i64 %247, %struct.Memory* %MEMORY.1)
...
block_.L_405cae:                                  ; preds = %block_.L_405c3f
  %284 = add i64 %103, -20046
  %285 = add i64 %103, 5
  ...
  %call2_405cae = tail call %struct.Memory* @sub_400e60._Z5timerv(%struct.State* %0, i64 %284, %struct.Memory* %MEMORY.0)
  ...
  %call2_405cb7 = tail call %struct.Memory* @sub_400800._Z13record_resultdPKc(%struct.State* %0, i64 %295, %struct.Memory* %call2_405cae)
  ...
  ret %struct.Memory* %call2_405cb7
}
...
define %struct.Memory* @routine_jge_.L_405cae(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i8* %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
...
define %struct.Memory* @routine_jge_.L_405c97(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i8* %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 2, i32 9
...
define %struct.Memory* @routine_jmpq_.L_405c5c(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
...
define %struct.Memory* @routine_callq_._Z17check_shifted_sumIs20custom_and_constantsIsEEvT_(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
...
define %struct.Memory* @routine_jmpq_.L_405c3f(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
