...
block_.L_40576f:                                  ; preds = %block_.L_4057c7, %entry
  %69 = phi i64 [ %.pre, %entry ], [ %283, %block_.L_4057c7 ]
...
block_.L_40578c:                                  ; preds = %block_405798, %block_40577f
  %112 = phi i64 [ %.pre1, %block_40577f ], [ %240, %block_405798 ]
...
block_.L_4057c7:                                  ; preds = %block_.L_40578c
  ...
  %call2_4057cb = tail call %struct.Memory* @sub_416070._Z17check_shifted_sumIs20custom_mod_constantsIsEEvT_(%struct.State* %0, i64 %247, %struct.Memory* %MEMORY.1)
...
block_.L_4057de:                                  ; preds = %block_.L_40576f
  ...
  %call2_4057de = tail call %struct.Memory* @sub_400e60._Z5timerv(%struct.State* %0, i64 %284, %struct.Memory* %MEMORY.0)
  ...
  %call2_4057e7 = tail call %struct.Memory* @sub_400800._Z13record_resultdPKc(%struct.State* %0, i64 %295, %struct.Memory* %call2_4057de)
