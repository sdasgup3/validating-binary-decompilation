...
declare %struct.Memory* @sub_416090._ZN20custom_mod_constantsIsE8do_shiftEs(%struct.State* dereferenceable(3376), i64, %struct.Memory*) local_unnamed_addr

declare %struct.Memory* @sub_4160b0._Z17check_shifted_sumIs20custom_mod_constantsIsEEvT_(%struct.State* dereferenceable(3376), i64, %struct.Memory*) local_unnamed_addr
...
block_.L_4057af:                                  ; preds = %block_.L_405807, %entry
  %69 = phi i64 [ %.pre, %entry ], [ %284, %block_.L_405807 ]
  %MEMORY.0 = phi %struct.Memory* [ %call2_4057a3, %entry ], [ %call2_40580b, %block_.L_405807 ]
...
block_.L_4057cc:                                  ; preds = %block_4057d8, %block_4057bf
  %112 = phi i64 [ %.pre6, %block_4057bf ], [ %241, %block_4057d8 ]
  %MEMORY.1 = phi %struct.Memory* [ %MEMORY.0, %block_4057bf ], [ %call2_4057e4, %block_4057d8 ]
...
block_4057d8:                                     ; preds = %block_.L_4057cc
  ...
  %call2_4057e4 = tail call %struct.Memory* @sub_416090._ZN20custom_mod_constantsIsE8do_shiftEs(%struct.State* nonnull %0, i64 %164, %struct.Memory* %MEMORY.1)
...
block_.L_405807:                                  ; preds = %block_.L_4057cc
  ...
  %call2_40580b = tail call %struct.Memory* @sub_4160b0._Z17check_shifted_sumIs20custom_mod_constantsIsEEvT_(%struct.State* nonnull %0, i64 %248, %struct.Memory* %MEMORY.1)
...
block_.L_40581e:                                  ; preds = %block_.L_4057af
  ...
  %call2_40581e = tail call %struct.Memory* @sub_400ea0._Z5timerv(%struct.State* nonnull %0, i64 %285, %struct.Memory* %MEMORY.0)
