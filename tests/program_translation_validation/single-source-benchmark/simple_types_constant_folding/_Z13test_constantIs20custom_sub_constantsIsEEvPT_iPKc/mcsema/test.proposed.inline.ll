...
declare %struct.Memory* @sub_416240._ZN20custom_sub_constantsIsE8do_shiftEs(%struct.State* dereferenceable(3376), i64, %struct.Memory*)

declare %struct.Memory* @sub_416260._Z17check_shifted_sumIs20custom_sub_constantsIsEEvT_(%struct.State* dereferenceable(3376), i64, %struct.Memory*)
...
define %struct.Memory* @_Z13test_constantIs20custom_sub_constantsIsEEvPT_iPKc(%struct.State* noalias, i64, %struct.Memory* noalias) #1 {
entry:
