...
block_.L_40555f:                                  ; preds = %block_.L_4055b7, %entry
  %69 = phi i64 [ %.pre, %entry ], [ %285, %block_.L_4055b7 ]
...
block_.L_40557c:                                  ; preds = %block_405588, %block_40556f
  %112 = phi i64 [ %.pre1, %block_40556f ], [ %241, %block_405588 ]
...
block_.L_4055b7:                                  ; preds = %block_.L_40557c
  ...
  %call2_4055bb = tail call %struct.Memory* @sub_416220._Z17check_shifted_sumIs20custom_sub_constantsIsEEvT_(%struct.State* %0, i64 %248, %struct.Memory* %MEMORY.1)
...
block_.L_4055ce:                                  ; preds = %block_.L_40555f
  ...
  %call2_4055ce = tail call %struct.Memory* @sub_400e60._Z5timerv(%struct.State* %0, i64 %286, %struct.Memory* %MEMORY.0)
  ...
  %call2_4055d7 = tail call %struct.Memory* @sub_400800._Z13record_resultdPKc(%struct.State* %0, i64 %297, %struct.Memory* %call2_4055ce)
