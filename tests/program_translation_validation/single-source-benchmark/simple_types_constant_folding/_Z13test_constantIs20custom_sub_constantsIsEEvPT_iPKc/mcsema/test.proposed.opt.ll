...
declare %struct.Memory* @sub_416240._ZN20custom_sub_constantsIsE8do_shiftEs(%struct.State* noalias dereferenceable(3376), i64, %struct.Memory* noalias readnone returned) local_unnamed_addr

declare %struct.Memory* @sub_416260._Z17check_shifted_sumIs20custom_sub_constantsIsEEvT_(%struct.State* noalias dereferenceable(3376), i64, %struct.Memory* noalias readnone returned) local_unnamed_addr
...
block_.L_40559f:                                  ; preds = %block_.L_4055f7, %entry
  %69 = phi i64 [ %284, %block_.L_4055f7 ], [ %.pre, %entry ]
...
block_.L_4055bc:                                  ; preds = %block_4055c8, %block_4055af
  %112 = phi i64 [ %241, %block_4055c8 ], [ %.pre6, %block_4055af ]
...
block_4055c8:                                     ; preds = %block_.L_4055bc
  ...
  %call2_4055d4 = tail call %struct.Memory* @sub_416240._ZN20custom_sub_constantsIsE8do_shiftEs(%struct.State* nonnull %0, i64 %164, %struct.Memory* %call2_405593)
...
block_.L_4055f7:                                  ; preds = %block_.L_4055bc
  ...
  %call2_4055fb = tail call %struct.Memory* @sub_416260._Z17check_shifted_sumIs20custom_sub_constantsIsEEvT_(%struct.State* nonnull %0, i64 %248, %struct.Memory* %call2_405593)
...
block_.L_40560e:                                  ; preds = %block_.L_40559f
  ...
  %call2_40560e = tail call %struct.Memory* @sub_400ea0._Z5timerv(%struct.State* nonnull %0, i64 %285, %struct.Memory* %call2_405593)
