...
declare %struct.Memory* @sub_415b80._ZN20custom_xor_constantsIsE8do_shiftEs(%struct.State* noalias dereferenceable(3376), i64, %struct.Memory* noalias readnone returned) local_unnamed_addr

declare %struct.Memory* @sub_415ba0._Z17check_shifted_sumIs20custom_xor_constantsIsEEvT_(%struct.State* noalias dereferenceable(3376), i64, %struct.Memory* noalias readnone returned) local_unnamed_addr
...
define %struct.Memory* @_Z13test_constantIs20custom_xor_constantsIsEEvPT_iPKc(%struct.State* noalias, i64, %struct.Memory* noalias readnone) local_unnamed_addr #1 {
entry:
...
block_.L_405ddf:                                  ; preds = %block_.L_405e37, %entry
  %69 = phi i64 [ %284, %block_.L_405e37 ], [ %.pre, %entry ]
...
block_.L_405dfc:                                  ; preds = %block_405e08, %block_405def
  %112 = phi i64 [ %241, %block_405e08 ], [ %.pre6, %block_405def ]
...
block_405e08:                                     ; preds = %block_.L_405dfc
  ...
  %call2_405e14 = tail call %struct.Memory* @sub_415b80._ZN20custom_xor_constantsIsE8do_shiftEs(%struct.State* nonnull %0, i64 %164, %struct.Memory* %call2_405dd3)
...
block_.L_405e37:                                  ; preds = %block_.L_405dfc
  ...
  %call2_405e3b = tail call %struct.Memory* @sub_415ba0._Z17check_shifted_sumIs20custom_xor_constantsIsEEvT_(%struct.State* nonnull %0, i64 %248, %struct.Memory* %call2_405dd3)
...
block_.L_405e4e:                                  ; preds = %block_.L_405ddf
  ...
  %call2_405e4e = tail call %struct.Memory* @sub_400ea0._Z5timerv(%struct.State* nonnull %0, i64 %285, %struct.Memory* %call2_405dd3)
