...
block_.L_405d9f:                                  ; preds = %block_.L_405df7, %entry
  %69 = phi i64 [ %.pre, %entry ], [ %285, %block_.L_405df7 ]
...
block_.L_405dbc:                                  ; preds = %block_405dc8, %block_405daf
  %112 = phi i64 [ %.pre1, %block_405daf ], [ %241, %block_405dc8 ]
...
block_.L_405df7:                                  ; preds = %block_.L_405dbc
  ...
  %call2_405dfb = tail call %struct.Memory* @sub_415b60._Z17check_shifted_sumIs20custom_xor_constantsIsEEvT_(%struct.State* %0, i64 %248, %struct.Memory* %MEMORY.1)
...
block_.L_405e0e:                                  ; preds = %block_.L_405d9f
  ...
  %call2_405e0e = tail call %struct.Memory* @sub_400e60._Z5timerv(%struct.State* %0, i64 %286, %struct.Memory* %MEMORY.0)
  ...
  %call2_405e17 = tail call %struct.Memory* @sub_400800._Z13record_resultdPKc(%struct.State* %0, i64 %297, %struct.Memory* %call2_405e0e)
