...
declare %struct.Memory* @sub_415b90._ZN20custom_xor_constantsIsE8do_shiftEs(%struct.State* noalias dereferenceable(3376), i64, %struct.Memory* noalias readnone returned) local_unnamed_addr

declare %struct.Memory* @sub_415bb0._Z17check_shifted_sumIs20custom_xor_constantsIsEEvT_(%struct.State* noalias dereferenceable(3376), i64, %struct.Memory* noalias readnone returned) local_unnamed_addr
...
entry:
  ...
  %call2_405de3 = tail call %struct.Memory* @sub_400e90._Z11start_timerv(%struct.State* %0, i64 %58, %struct.Memory* %2)
...
block_.L_405def:                                  ; preds = %block_.L_405e47, %entry
  %69 = phi i64 [ %284, %block_.L_405e47 ], [ %.pre, %entry ]
  ...
  br i1 %102, label %block_405dff, label %block_.L_405e5e
...
block_.L_405e0c:                                  ; preds = %block_405e18, %block_405dff
  %112 = phi i64 [ %241, %block_405e18 ], [ %.pre6, %block_405dff ]
  ...
  br i1 %148, label %block_405e18, label %block_.L_405e47
...
block_405e18:                                     ; preds = %block_.L_405e0c
  ...
  %call2_405e24 = tail call %struct.Memory* @sub_415b90._ZN20custom_xor_constantsIsE8do_shiftEs(%struct.State* nonnull %0, i64 %164, %struct.Memory* %call2_405de3)
...
block_.L_405e47:                                  ; preds = %block_.L_405e0c
  ...
  %call2_405e4b = tail call %struct.Memory* @sub_415bb0._Z17check_shifted_sumIs20custom_xor_constantsIsEEvT_(%struct.State* nonnull %0, i64 %248, %struct.Memory* %call2_405de3)
...
block_.L_405e5e:                                  ; preds = %block_.L_405def
  ...
  %call2_405e5e = tail call %struct.Memory* @sub_400eb0._Z5timerv(%struct.State* nonnull %0, i64 %285, %struct.Memory* %call2_405de3)
  ...
  %call2_405e67 = tail call %struct.Memory* @sub_400850._Z13record_resultdPKc(%struct.State* nonnull %0, i64 %296, %struct.Memory* %call2_405e5e)
