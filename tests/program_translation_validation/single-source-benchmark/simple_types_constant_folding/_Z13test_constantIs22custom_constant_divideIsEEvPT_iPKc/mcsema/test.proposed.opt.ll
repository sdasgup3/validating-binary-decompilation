...
block_.L_40631f:                                  ; preds = %block_.L_406377, %entry
  %69 = phi i64 [ %.pre, %entry ], [ %283, %block_.L_406377 ]
...
block_.L_40633c:                                  ; preds = %block_406348, %block_40632f
  %112 = phi i64 [ %.pre1, %block_40632f ], [ %240, %block_406348 ]
...
block_.L_406377:                                  ; preds = %block_.L_40633c
  ...
  %call2_40637b = tail call %struct.Memory* @sub_4156b0._Z17check_shifted_sumIs22custom_constant_divideIsEEvT_(%struct.State* %0, i64 %247, %struct.Memory* %MEMORY.1)
...
block_.L_40638e:                                  ; preds = %block_.L_40631f
  ...
  %call2_40638e = tail call %struct.Memory* @sub_400e60._Z5timerv(%struct.State* %0, i64 %284, %struct.Memory* %MEMORY.0)
  ...
  %call2_406397 = tail call %struct.Memory* @sub_400800._Z13record_resultdPKc(%struct.State* %0, i64 %295, %struct.Memory* %call2_40638e)
