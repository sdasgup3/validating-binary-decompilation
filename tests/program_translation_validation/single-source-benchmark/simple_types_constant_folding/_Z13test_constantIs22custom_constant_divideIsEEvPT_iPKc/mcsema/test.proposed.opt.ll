...
declare %struct.Memory* @sub_4156d0._ZN22custom_constant_divideIsE8do_shiftEs(%struct.State* noalias dereferenceable(3376), i64, %struct.Memory* noalias readnone returned) local_unnamed_addr

declare %struct.Memory* @sub_4156f0._Z17check_shifted_sumIs22custom_constant_divideIsEEvT_(%struct.State* noalias dereferenceable(3376), i64, %struct.Memory* noalias readnone returned) local_unnamed_addr
...
define %struct.Memory* @_Z13test_constantIs22custom_constant_divideIsEEvPT_iPKc(%struct.State* noalias, i64, %struct.Memory* noalias readnone) local_unnamed_addr #1 {
entry:
...
block_.L_40635f:                                  ; preds = %block_.L_4063b7, %entry
  %69 = phi i64 [ %284, %block_.L_4063b7 ], [ %.pre, %entry ]
...
block_.L_40637c:                                  ; preds = %block_406388, %block_40636f
  %112 = phi i64 [ %241, %block_406388 ], [ %.pre6, %block_40636f ]
...
block_406388:                                     ; preds = %block_.L_40637c
  ...
  %call2_406394 = tail call %struct.Memory* @sub_4156d0._ZN22custom_constant_divideIsE8do_shiftEs(%struct.State* nonnull %0, i64 %164, %struct.Memory* %call2_406353)
...
block_.L_4063b7:                                  ; preds = %block_.L_40637c
  ...
  %call2_4063bb = tail call %struct.Memory* @sub_4156f0._Z17check_shifted_sumIs22custom_constant_divideIsEEvT_(%struct.State* nonnull %0, i64 %248, %struct.Memory* %call2_406353)
...
block_.L_4063ce:                                  ; preds = %block_.L_40635f
  ...
  %call2_4063ce = tail call %struct.Memory* @sub_400ea0._Z5timerv(%struct.State* nonnull %0, i64 %285, %struct.Memory* %call2_406353)
