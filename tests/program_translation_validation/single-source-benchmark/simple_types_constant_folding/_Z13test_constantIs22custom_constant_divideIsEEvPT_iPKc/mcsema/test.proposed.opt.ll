...
declare %struct.Memory* @sub_4156e0._ZN22custom_constant_divideIsE8do_shiftEs(%struct.State* noalias dereferenceable(3376), i64, %struct.Memory* noalias readnone returned) local_unnamed_addr

declare %struct.Memory* @sub_415700._Z17check_shifted_sumIs22custom_constant_divideIsEEvT_(%struct.State* noalias dereferenceable(3376), i64, %struct.Memory* noalias readnone returned) local_unnamed_addr
...
entry:
  ...
  %call2_406363 = tail call %struct.Memory* @sub_400e90._Z11start_timerv(%struct.State* %0, i64 %58, %struct.Memory* %2)
...
block_.L_40636f:                                  ; preds = %block_.L_4063c7, %entry
  %69 = phi i64 [ %284, %block_.L_4063c7 ], [ %.pre, %entry ]
  ...
  br i1 %102, label %block_40637f, label %block_.L_4063de
...
block_.L_40638c:                                  ; preds = %block_406398, %block_40637f
  %112 = phi i64 [ %241, %block_406398 ], [ %.pre6, %block_40637f ]
  ...
  br i1 %148, label %block_406398, label %block_.L_4063c7

block_406398:                                     ; preds = %block_.L_40638c
  %150 = add i64 %113, -8
  %151 = add i64 %149, 4
  ...
  %call2_4063a4 = tail call %struct.Memory* @sub_4156e0._ZN22custom_constant_divideIsE8do_shiftEs(%struct.State* nonnull %0, i64 %164, %struct.Memory* %call2_406363)
...
block_.L_4063c7:                                  ; preds = %block_.L_40638c
  %242 = add i64 %113, -30
  %243 = add i64 %149, 4
  ...
  %call2_4063cb = tail call %struct.Memory* @sub_415700._Z17check_shifted_sumIs22custom_constant_divideIsEEvT_(%struct.State* nonnull %0, i64 %248, %struct.Memory* %call2_406363)
...
block_.L_4063de:                                  ; preds = %block_.L_40636f
  ...
  %call2_4063de = tail call %struct.Memory* @sub_400eb0._Z5timerv(%struct.State* nonnull %0, i64 %285, %struct.Memory* %call2_406363)
  ...
  %call2_4063e7 = tail call %struct.Memory* @sub_400850._Z13record_resultdPKc(%struct.State* nonnull %0, i64 %296, %struct.Memory* %call2_4063de)
