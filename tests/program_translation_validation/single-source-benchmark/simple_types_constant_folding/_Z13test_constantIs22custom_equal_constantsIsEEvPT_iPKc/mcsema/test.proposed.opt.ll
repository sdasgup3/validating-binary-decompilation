...
block_.L_40581f:                                  ; preds = %block_.L_405877, %entry
  %69 = phi i64 [ %.pre, %entry ], [ %283, %block_.L_405877 ]
...
block_.L_40583c:                                  ; preds = %block_405848, %block_40582f
  %112 = phi i64 [ %.pre1, %block_40582f ], [ %240, %block_405848 ]
...
block_.L_405877:                                  ; preds = %block_.L_40583c
  ...
  %call2_40587b = tail call %struct.Memory* @sub_415fe0._Z17check_shifted_sumIs22custom_equal_constantsIsEEvT_(%struct.State* %0, i64 %247, %struct.Memory* %MEMORY.1)
...
block_.L_40588e:                                  ; preds = %block_.L_40581f
  ...
  %call2_40588e = tail call %struct.Memory* @sub_400e60._Z5timerv(%struct.State* %0, i64 %284, %struct.Memory* %MEMORY.0)
  ...
  %call2_405897 = tail call %struct.Memory* @sub_400800._Z13record_resultdPKc(%struct.State* %0, i64 %295, %struct.Memory* %call2_40588e)
