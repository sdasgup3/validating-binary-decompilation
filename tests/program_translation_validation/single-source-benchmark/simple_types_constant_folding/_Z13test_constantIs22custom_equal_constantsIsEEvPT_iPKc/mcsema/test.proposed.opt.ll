...
declare %struct.Memory* @sub_416000._ZN22custom_equal_constantsIsE8do_shiftEs(%struct.State* noalias dereferenceable(3376), i64, %struct.Memory* noalias readnone returned) local_unnamed_addr

declare %struct.Memory* @sub_416020._Z17check_shifted_sumIs22custom_equal_constantsIsEEvT_(%struct.State* noalias dereferenceable(3376), i64, %struct.Memory* noalias readnone returned) local_unnamed_addr
...
block_.L_40585f:                                  ; preds = %block_.L_4058b7, %entry
  %69 = phi i64 [ %284, %block_.L_4058b7 ], [ %.pre, %entry ]
...
block_.L_40587c:                                  ; preds = %block_405888, %block_40586f
  %112 = phi i64 [ %241, %block_405888 ], [ %.pre6, %block_40586f ]
...
block_405888:                                     ; preds = %block_.L_40587c
  ...
  %call2_405894 = tail call %struct.Memory* @sub_416000._ZN22custom_equal_constantsIsE8do_shiftEs(%struct.State* nonnull %0, i64 %164, %struct.Memory* %call2_405853)
...
block_.L_4058b7:                                  ; preds = %block_.L_40587c
  ...
  %call2_4058bb = tail call %struct.Memory* @sub_416020._Z17check_shifted_sumIs22custom_equal_constantsIsEEvT_(%struct.State* nonnull %0, i64 %248, %struct.Memory* %call2_405853)
...
block_.L_4058ce:                                  ; preds = %block_.L_40585f
  ...
  %call2_4058ce = tail call %struct.Memory* @sub_400ea0._Z5timerv(%struct.State* nonnull %0, i64 %285, %struct.Memory* %call2_405853)
