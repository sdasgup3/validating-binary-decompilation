...
block_.L_4056bf:                                  ; preds = %block_.L_405717, %entry
  %69 = phi i64 [ %.pre, %entry ], [ %285, %block_.L_405717 ]
...
block_.L_4056dc:                                  ; preds = %block_4056e8, %block_4056cf
  %112 = phi i64 [ %.pre1, %block_4056cf ], [ %241, %block_4056e8 ]
...
block_.L_405717:                                  ; preds = %block_.L_4056dc
  ...
  %call2_40571b = tail call %struct.Memory* @sub_416100._Z17check_shifted_sumIs23custom_divide_constantsIsEEvT_(%struct.State* %0, i64 %248, %struct.Memory* %MEMORY.1)
...
block_.L_40572e:                                  ; preds = %block_.L_4056bf
  ...
  %call2_40572e = tail call %struct.Memory* @sub_400e60._Z5timerv(%struct.State* %0, i64 %286, %struct.Memory* %MEMORY.0)
  ...
  %call2_405737 = tail call %struct.Memory* @sub_400800._Z13record_resultdPKc(%struct.State* %0, i64 %297, %struct.Memory* %call2_40572e)
