...
declare %struct.Memory* @sub_416120._ZN23custom_divide_constantsIsE8do_shiftEs(%struct.State* noalias dereferenceable(3376), i64, %struct.Memory* noalias readnone returned) local_unnamed_addr

declare %struct.Memory* @sub_416140._Z17check_shifted_sumIs23custom_divide_constantsIsEEvT_(%struct.State* noalias dereferenceable(3376), i64, %struct.Memory* noalias readnone returned) local_unnamed_addr
...
block_.L_4056ff:                                  ; preds = %block_.L_405757, %entry
  %69 = phi i64 [ %284, %block_.L_405757 ], [ %.pre, %entry ]
...
block_.L_40571c:                                  ; preds = %block_405728, %block_40570f
  %112 = phi i64 [ %241, %block_405728 ], [ %.pre6, %block_40570f ]
...
block_405728:                                     ; preds = %block_.L_40571c
  ...
  %call2_405734 = tail call %struct.Memory* @sub_416120._ZN23custom_divide_constantsIsE8do_shiftEs(%struct.State* nonnull %0, i64 %164, %struct.Memory* %call2_4056f3)
...
block_.L_405757:                                  ; preds = %block_.L_40571c
  ...
  %call2_40575b = tail call %struct.Memory* @sub_416140._Z17check_shifted_sumIs23custom_divide_constantsIsEEvT_(%struct.State* nonnull %0, i64 %248, %struct.Memory* %call2_4056f3)
...
block_.L_40576e:                                  ; preds = %block_.L_4056ff
  ...
  %call2_40576e = tail call %struct.Memory* @sub_400ea0._Z5timerv(%struct.State* nonnull %0, i64 %285, %struct.Memory* %call2_4056f3)
