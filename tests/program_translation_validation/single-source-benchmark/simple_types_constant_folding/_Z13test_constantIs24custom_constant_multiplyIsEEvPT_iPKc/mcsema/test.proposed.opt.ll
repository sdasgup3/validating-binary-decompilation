...
block_.L_40610f:                                  ; preds = %block_.L_406167, %entry
  %69 = phi i64 [ %.pre, %entry ], [ %283, %block_.L_406167 ]
...
block_.L_40612c:                                  ; preds = %block_406138, %block_40611f
  %112 = phi i64 [ %.pre1, %block_40611f ], [ %240, %block_406138 ]
...
block_.L_406167:                                  ; preds = %block_.L_40612c
  ...
  %call2_40616b = tail call %struct.Memory* @sub_415870._Z17check_shifted_sumIs24custom_constant_multiplyIsEEvT_(%struct.State* %0, i64 %247, %struct.Memory* %MEMORY.1)
...
block_.L_40617e:                                  ; preds = %block_.L_40610f
  ...
  %call2_40617e = tail call %struct.Memory* @sub_400e60._Z5timerv(%struct.State* %0, i64 %284, %struct.Memory* %MEMORY.0)
  ...
  %call2_406187 = tail call %struct.Memory* @sub_400800._Z13record_resultdPKc(%struct.State* %0, i64 %295, %struct.Memory* %call2_40617e)
