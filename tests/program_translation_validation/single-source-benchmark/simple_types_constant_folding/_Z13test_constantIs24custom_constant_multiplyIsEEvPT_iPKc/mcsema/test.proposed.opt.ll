...
declare %struct.Memory* @sub_4158c0._Z17check_shifted_sumIs24custom_constant_multiplyIsEEvT_(%struct.State* noalias dereferenceable(3376), i64, %struct.Memory* noalias readnone returned) local_unnamed_addr
...
entry:
  ...
  %call2_406153 = tail call %struct.Memory* @sub_400e90._Z11start_timerv(%struct.State* %0, i64 %58, %struct.Memory* %2)
...
block_.L_40615f:                                  ; preds = %block_.L_4061b7, %entry
  %69 = phi i64 [ %284, %block_.L_4061b7 ], [ %.pre, %entry ]
  ...
  br i1 %102, label %block_40616f, label %block_.L_4061ce
...
block_.L_40617c:                                  ; preds = %block_406188, %block_40616f
  %112 = phi i64 [ %241, %block_406188 ], [ %.pre6, %block_40616f ]
  ...
  br i1 %148, label %block_406188, label %block_.L_4061b7
...
block_406188:                                     ; preds = %block_.L_40617c
  ...
  %call2_406194 = tail call %struct.Memory* @sub_4158a0._ZN24custom_constant_multiplyIsE8do_shiftEs(%struct.State* nonnull %0, i64 %164, %struct.Memory* %call2_406153)
...
block_.L_4061b7:                                  ; preds = %block_.L_40617c
  ...
  %call2_4061bb = tail call %struct.Memory* @sub_4158c0._Z17check_shifted_sumIs24custom_constant_multiplyIsEEvT_(%struct.State* nonnull %0, i64 %248, %struct.Memory* %call2_406153)
...
block_.L_4061ce:                                  ; preds = %block_.L_40615f
  ...
  %call2_4061ce = tail call %struct.Memory* @sub_400eb0._Z5timerv(%struct.State* nonnull %0, i64 %285, %struct.Memory* %call2_406153)
  ...
  %call2_4061d7 = tail call %struct.Memory* @sub_400850._Z13record_resultdPKc(%struct.State* nonnull %0, i64 %296, %struct.Memory* %call2_4061ce)
