...
declare %struct.Memory* @sub_4158b0._Z17check_shifted_sumIs24custom_constant_multiplyIsEEvT_(%struct.State* noalias dereferenceable(3376), i64, %struct.Memory* noalias readnone returned) local_unnamed_addr
...
define %struct.Memory* @_Z13test_constantIs24custom_constant_multiplyIsEEvPT_iPKc(%struct.State* noalias, i64, %struct.Memory* noalias readnone) local_unnamed_addr #1 {
entry:
...
block_.L_40614f:                                  ; preds = %block_.L_4061a7, %entry
  %69 = phi i64 [ %284, %block_.L_4061a7 ], [ %.pre, %entry ]
...
block_.L_40616c:                                  ; preds = %block_406178, %block_40615f
  %112 = phi i64 [ %241, %block_406178 ], [ %.pre6, %block_40615f ]
...
block_406178:                                     ; preds = %block_.L_40616c
  ...
  %call2_406184 = tail call %struct.Memory* @sub_415890._ZN24custom_constant_multiplyIsE8do_shiftEs(%struct.State* nonnull %0, i64 %164, %struct.Memory* %call2_406143)
...
block_.L_4061a7:                                  ; preds = %block_.L_40616c
  ...
  %call2_4061ab = tail call %struct.Memory* @sub_4158b0._Z17check_shifted_sumIs24custom_constant_multiplyIsEEvT_(%struct.State* nonnull %0, i64 %248, %struct.Memory* %call2_406143)
...
block_.L_4061be:                                  ; preds = %block_.L_40614f
  ...
  %call2_4061be = tail call %struct.Memory* @sub_400ea0._Z5timerv(%struct.State* nonnull %0, i64 %285, %struct.Memory* %call2_406143)
