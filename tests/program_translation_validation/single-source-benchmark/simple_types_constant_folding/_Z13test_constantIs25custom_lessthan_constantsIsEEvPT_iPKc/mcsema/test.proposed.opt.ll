...
block_.L_405a2f:                                  ; preds = %block_.L_405a87, %entry
  %69 = phi i64 [ %.pre, %entry ], [ %285, %block_.L_405a87 ]
...
block_.L_405a4c:                                  ; preds = %block_405a58, %block_405a3f
  %112 = phi i64 [ %.pre1, %block_405a3f ], [ %241, %block_405a58 ]
...
block_.L_405a87:                                  ; preds = %block_.L_405a4c
  ...
  %call2_405a8b = tail call %struct.Memory* @sub_415e30._Z17check_shifted_sumIs25custom_lessthan_constantsIsEEvT_(%struct.State* %0, i64 %248, %struct.Memory* %MEMORY.1)
...
block_.L_405a9e:                                  ; preds = %block_.L_405a2f
  ...
  %call2_405a9e = tail call %struct.Memory* @sub_400e60._Z5timerv(%struct.State* %0, i64 %286, %struct.Memory* %MEMORY.0)
  ...
  %call2_405aa7 = tail call %struct.Memory* @sub_400800._Z13record_resultdPKc(%struct.State* %0, i64 %297, %struct.Memory* %call2_405a9e)
