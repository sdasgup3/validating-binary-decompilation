...
declare %struct.Memory* @sub_415e50._ZN25custom_lessthan_constantsIsE8do_shiftEs(%struct.State* noalias dereferenceable(3376), i64, %struct.Memory* noalias readnone returned) local_unnamed_addr

declare %struct.Memory* @sub_415e70._Z17check_shifted_sumIs25custom_lessthan_constantsIsEEvT_(%struct.State* noalias dereferenceable(3376), i64, %struct.Memory* noalias readnone returned) local_unnamed_addr
...
define %struct.Memory* @_Z13test_constantIs25custom_lessthan_constantsIsEEvPT_iPKc(%struct.State* noalias, i64, %struct.Memory* noalias readnone) local_unnamed_addr #1 {
entry:
...
block_.L_405a6f:                                  ; preds = %block_.L_405ac7, %entry
  %69 = phi i64 [ %284, %block_.L_405ac7 ], [ %.pre, %entry ]
...
block_.L_405a8c:                                  ; preds = %block_405a98, %block_405a7f
  %112 = phi i64 [ %241, %block_405a98 ], [ %.pre6, %block_405a7f ]
...
block_405a98:                                     ; preds = %block_.L_405a8c
  ...
  %call2_405aa4 = tail call %struct.Memory* @sub_415e50._ZN25custom_lessthan_constantsIsE8do_shiftEs(%struct.State* nonnull %0, i64 %164, %struct.Memory* %call2_405a63)
...
block_.L_405ac7:                                  ; preds = %block_.L_405a8c
  ...
  %call2_405acb = tail call %struct.Memory* @sub_415e70._Z17check_shifted_sumIs25custom_lessthan_constantsIsEEvT_(%struct.State* nonnull %0, i64 %248, %struct.Memory* %call2_405a63)
...
block_.L_405ade:                                  ; preds = %block_.L_405a6f
  ...
  %call2_405ade = tail call %struct.Memory* @sub_400ea0._Z5timerv(%struct.State* nonnull %0, i64 %285, %struct.Memory* %call2_405a63)
