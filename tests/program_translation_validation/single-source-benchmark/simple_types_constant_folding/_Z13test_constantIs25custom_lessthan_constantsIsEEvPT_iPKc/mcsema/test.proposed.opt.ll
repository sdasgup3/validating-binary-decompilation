...
declare %struct.Memory* @sub_415e80._Z17check_shifted_sumIs25custom_lessthan_constantsIsEEvT_(%struct.State* noalias dereferenceable(3376), i64, %struct.Memory* noalias readnone returned) local_unnamed_addr
...
entry:
  ...
  %call2_405a73 = tail call %struct.Memory* @sub_400e90._Z11start_timerv(%struct.State* %0, i64 %58, %struct.Memory* %2)
...
block_.L_405a7f:                                  ; preds = %block_.L_405ad7, %entry
  %69 = phi i64 [ %284, %block_.L_405ad7 ], [ %.pre, %entry ]
  ...
  br i1 %102, label %block_405a8f, label %block_.L_405aee
...
block_.L_405a9c:                                  ; preds = %block_405aa8, %block_405a8f
  %112 = phi i64 [ %241, %block_405aa8 ], [ %.pre6, %block_405a8f ]
  ...
  br i1 %148, label %block_405aa8, label %block_.L_405ad7
...
block_405aa8:                                     ; preds = %block_.L_405a9c
  ...
  %call2_405ab4 = tail call %struct.Memory* @sub_415e60._ZN25custom_lessthan_constantsIsE8do_shiftEs(%struct.State* nonnull %0, i64 %164, %struct.Memory* %call2_405a73)
...
block_.L_405ad7:                                  ; preds = %block_.L_405a9c
  ...
  %call2_405adb = tail call %struct.Memory* @sub_415e80._Z17check_shifted_sumIs25custom_lessthan_constantsIsEEvT_(%struct.State* nonnull %0, i64 %248, %struct.Memory* %call2_405a73)
...
block_.L_405aee:                                  ; preds = %block_.L_405a7f
  ...
  %call2_405aee = tail call %struct.Memory* @sub_400eb0._Z5timerv(%struct.State* nonnull %0, i64 %285, %struct.Memory* %call2_405a73)
  ...
  %call2_405af7 = tail call %struct.Memory* @sub_400850._Z13record_resultdPKc(%struct.State* nonnull %0, i64 %296, %struct.Memory* %call2_405aee)
