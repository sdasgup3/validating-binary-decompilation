...
block_.L_40560f:                                  ; preds = %block_.L_405667, %entry
  %69 = phi i64 [ %.pre, %entry ], [ %283, %block_.L_405667 ]
...
block_.L_40562c:                                  ; preds = %block_405638, %block_40561f
  %112 = phi i64 [ %.pre1, %block_40561f ], [ %240, %block_405638 ]
...
block_.L_405667:                                  ; preds = %block_.L_40562c
  ...
  %call2_40566b = tail call %struct.Memory* @sub_416190._Z17check_shifted_sumIs25custom_multiply_constantsIsEEvT_(%struct.State* %0, i64 %247, %struct.Memory* %MEMORY.1)
...
block_.L_40567e:                                  ; preds = %block_.L_40560f
  ...
  %call2_40567e = tail call %struct.Memory* @sub_400e60._Z5timerv(%struct.State* %0, i64 %284, %struct.Memory* %MEMORY.0)
  ...
  %call2_405687 = tail call %struct.Memory* @sub_400800._Z13record_resultdPKc(%struct.State* %0, i64 %295, %struct.Memory* %call2_40567e)
