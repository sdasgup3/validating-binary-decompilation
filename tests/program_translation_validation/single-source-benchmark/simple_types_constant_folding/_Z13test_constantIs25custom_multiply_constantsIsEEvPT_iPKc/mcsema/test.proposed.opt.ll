...
declare %struct.Memory* @sub_4161b0._ZN25custom_multiply_constantsIsE8do_shiftEs(%struct.State* dereferenceable(3376), i64, %struct.Memory*) local_unnamed_addr

declare %struct.Memory* @sub_4161d0._Z17check_shifted_sumIs25custom_multiply_constantsIsEEvT_(%struct.State* dereferenceable(3376), i64, %struct.Memory*) local_unnamed_addr
...
block_.L_40564f:                                  ; preds = %block_.L_4056a7, %entry
  %69 = phi i64 [ %.pre, %entry ], [ %284, %block_.L_4056a7 ]
  %MEMORY.0 = phi %struct.Memory* [ %call2_405643, %entry ], [ %call2_4056ab, %block_.L_4056a7 ]
...
block_.L_40566c:                                  ; preds = %block_405678, %block_40565f
  %112 = phi i64 [ %.pre6, %block_40565f ], [ %241, %block_405678 ]
  %MEMORY.1 = phi %struct.Memory* [ %MEMORY.0, %block_40565f ], [ %call2_405684, %block_405678 ]
...
block_405678:                                     ; preds = %block_.L_40566c
  ...
  %call2_405684 = tail call %struct.Memory* @sub_4161b0._ZN25custom_multiply_constantsIsE8do_shiftEs(%struct.State* nonnull %0, i64 %164, %struct.Memory* %MEMORY.1)
...
block_.L_4056a7:                                  ; preds = %block_.L_40566c
  ...
  %call2_4056ab = tail call %struct.Memory* @sub_4161d0._Z17check_shifted_sumIs25custom_multiply_constantsIsEEvT_(%struct.State* nonnull %0, i64 %248, %struct.Memory* %MEMORY.1)
...
block_.L_4056be:                                  ; preds = %block_.L_40564f
  ...
  %call2_4056be = tail call %struct.Memory* @sub_400ea0._Z5timerv(%struct.State* nonnull %0, i64 %285, %struct.Memory* %MEMORY.0)
