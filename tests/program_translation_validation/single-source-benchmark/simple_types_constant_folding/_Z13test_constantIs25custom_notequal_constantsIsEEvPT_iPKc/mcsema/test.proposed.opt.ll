...
declare %struct.Memory* @sub_415fa0._Z17check_shifted_sumIs25custom_notequal_constantsIsEEvT_(%struct.State* noalias dereferenceable(3376), i64, %struct.Memory* noalias readnone returned) local_unnamed_addr
...
entry:
  ...
  %call2_405913 = tail call %struct.Memory* @sub_400e90._Z11start_timerv(%struct.State* %0, i64 %58, %struct.Memory* %2)
  ...
  br label %block_.L_40591f

block_.L_40591f:                                  ; preds = %block_.L_405977, %entry
  %69 = phi i64 [ %284, %block_.L_405977 ], [ %.pre, %entry ]
  ...
  br i1 %102, label %block_40592f, label %block_.L_40598e

block_40592f:                                     ; preds = %block_.L_40591f
  %104 = add i64 %70, -30
  %105 = add i64 %103, 6
...
block_.L_40593c:                                  ; preds = %block_405948, %block_40592f
  %112 = phi i64 [ %241, %block_405948 ], [ %.pre6, %block_40592f ]
  ...
  br i1 %148, label %block_405948, label %block_.L_405977

block_405948:                                     ; preds = %block_.L_40593c
  %150 = add i64 %113, -8
  %151 = add i64 %149, 4
  ...
  %call2_405954 = tail call %struct.Memory* @sub_415f80._ZN25custom_notequal_constantsIsE8do_shiftEs(%struct.State* nonnull %0, i64 %164, %struct.Memory* %call2_405913)
...
block_.L_405977:                                  ; preds = %block_.L_40593c
  %242 = add i64 %113, -30
  %243 = add i64 %149, 4
  ...
  %call2_40597b = tail call %struct.Memory* @sub_415fa0._Z17check_shifted_sumIs25custom_notequal_constantsIsEEvT_(%struct.State* nonnull %0, i64 %248, %struct.Memory* %call2_405913)
...
block_.L_40598e:                                  ; preds = %block_.L_40591f
  ...
  %call2_40598e = tail call %struct.Memory* @sub_400eb0._Z5timerv(%struct.State* nonnull %0, i64 %285, %struct.Memory* %call2_405913)
  ...
  %call2_405997 = tail call %struct.Memory* @sub_400850._Z13record_resultdPKc(%struct.State* nonnull %0, i64 %296, %struct.Memory* %call2_40598e)
