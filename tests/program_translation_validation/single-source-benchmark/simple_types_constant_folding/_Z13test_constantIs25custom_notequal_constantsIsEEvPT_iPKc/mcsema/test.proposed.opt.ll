...
declare %struct.Memory* @sub_415f70._ZN25custom_notequal_constantsIsE8do_shiftEs(%struct.State* noalias dereferenceable(3376), i64, %struct.Memory* noalias readnone returned) local_unnamed_addr

declare %struct.Memory* @sub_415f90._Z17check_shifted_sumIs25custom_notequal_constantsIsEEvT_(%struct.State* noalias dereferenceable(3376), i64, %struct.Memory* noalias readnone returned) local_unnamed_addr
...
define %struct.Memory* @_Z13test_constantIs25custom_notequal_constantsIsEEvPT_iPKc(%struct.State* noalias, i64, %struct.Memory* noalias readnone) local_unnamed_addr #1 {
entry:
...
block_.L_40590f:                                  ; preds = %block_.L_405967, %entry
  %69 = phi i64 [ %284, %block_.L_405967 ], [ %.pre, %entry ]
...
block_.L_40592c:                                  ; preds = %block_405938, %block_40591f
  %112 = phi i64 [ %241, %block_405938 ], [ %.pre6, %block_40591f ]
...
block_405938:                                     ; preds = %block_.L_40592c
  ...
  %call2_405944 = tail call %struct.Memory* @sub_415f70._ZN25custom_notequal_constantsIsE8do_shiftEs(%struct.State* nonnull %0, i64 %164, %struct.Memory* %call2_405903)
...
block_.L_405967:                                  ; preds = %block_.L_40592c
  ...
  %call2_40596b = tail call %struct.Memory* @sub_415f90._Z17check_shifted_sumIs25custom_notequal_constantsIsEEvT_(%struct.State* nonnull %0, i64 %248, %struct.Memory* %call2_405903)
...
block_.L_40597e:                                  ; preds = %block_.L_40590f
  ...
  %call2_40597e = tail call %struct.Memory* @sub_400ea0._Z5timerv(%struct.State* nonnull %0, i64 %285, %struct.Memory* %call2_405903)
