...
block_.L_4058cf:                                  ; preds = %block_.L_405927, %entry
  %69 = phi i64 [ %.pre, %entry ], [ %283, %block_.L_405927 ]
...
block_.L_4058ec:                                  ; preds = %block_4058f8, %block_4058df
  %112 = phi i64 [ %.pre1, %block_4058df ], [ %240, %block_4058f8 ]
...
block_.L_405927:                                  ; preds = %block_.L_4058ec
  ...
  %call2_40592b = tail call %struct.Memory* @sub_415f50._Z17check_shifted_sumIs25custom_notequal_constantsIsEEvT_(%struct.State* %0, i64 %247, %struct.Memory* %MEMORY.1)
...
block_.L_40593e:                                  ; preds = %block_.L_4058cf
  ...
  %call2_40593e = tail call %struct.Memory* @sub_400e60._Z5timerv(%struct.State* %0, i64 %284, %struct.Memory* %MEMORY.0)
  ...
  %call2_405947 = tail call %struct.Memory* @sub_400800._Z13record_resultdPKc(%struct.State* %0, i64 %295, %struct.Memory* %call2_40593e)
