...
declare %struct.Memory* @sub_4152a0._ZN27custom_multiple_constant_orIsE8do_shiftEs(%struct.State* dereferenceable(3376), i64, %struct.Memory*)

declare %struct.Memory* @sub_4152d0._Z17check_shifted_sumIs27custom_multiple_constant_orIsEEvT_(%struct.State* dereferenceable(3376), i64, %struct.Memory*)
...
define %struct.Memory* @_Z13test_constantIs27custom_multiple_constant_orIsEEvPT_iPKc(%struct.State* noalias, i64, %struct.Memory* noalias) #1 {
entry:
