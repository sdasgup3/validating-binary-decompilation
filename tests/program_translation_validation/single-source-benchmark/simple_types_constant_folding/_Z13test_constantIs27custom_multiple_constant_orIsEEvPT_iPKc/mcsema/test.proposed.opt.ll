...
declare %struct.Memory* @sub_4152a0._ZN27custom_multiple_constant_orIsE8do_shiftEs(%struct.State* dereferenceable(3376), i64, %struct.Memory*) local_unnamed_addr

declare %struct.Memory* @sub_4152d0._Z17check_shifted_sumIs27custom_multiple_constant_orIsEEvT_(%struct.State* dereferenceable(3376), i64, %struct.Memory*) local_unnamed_addr
...
block_.L_40682f:                                  ; preds = %block_.L_406887, %entry
  %69 = phi i64 [ %.pre, %entry ], [ %284, %block_.L_406887 ]
  %MEMORY.0 = phi %struct.Memory* [ %call2_406823, %entry ], [ %call2_40688b, %block_.L_406887 ]
...
block_.L_40684c:                                  ; preds = %block_406858, %block_40683f
  %112 = phi i64 [ %.pre6, %block_40683f ], [ %241, %block_406858 ]
  %MEMORY.1 = phi %struct.Memory* [ %MEMORY.0, %block_40683f ], [ %call2_406864, %block_406858 ]
...
block_406858:                                     ; preds = %block_.L_40684c
  ...
  %call2_406864 = tail call %struct.Memory* @sub_4152a0._ZN27custom_multiple_constant_orIsE8do_shiftEs(%struct.State* nonnull %0, i64 %164, %struct.Memory* %MEMORY.1)
...
block_.L_406887:                                  ; preds = %block_.L_40684c
  ...
  %call2_40688b = tail call %struct.Memory* @sub_4152d0._Z17check_shifted_sumIs27custom_multiple_constant_orIsEEvT_(%struct.State* nonnull %0, i64 %248, %struct.Memory* %MEMORY.1)
...
block_.L_40689e:                                  ; preds = %block_.L_40682f
  ...
  %call2_40689e = tail call %struct.Memory* @sub_400ea0._Z5timerv(%struct.State* nonnull %0, i64 %285, %struct.Memory* %MEMORY.0)
