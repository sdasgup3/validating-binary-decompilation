...
block_.L_4067ef:                                  ; preds = %block_.L_406847, %entry
  %69 = phi i64 [ %.pre, %entry ], [ %283, %block_.L_406847 ]
...
block_.L_40680c:                                  ; preds = %block_406818, %block_4067ff
  %112 = phi i64 [ %.pre1, %block_4067ff ], [ %240, %block_406818 ]
...
block_.L_406847:                                  ; preds = %block_.L_40680c
  ...
  %call2_40684b = tail call %struct.Memory* @sub_415290._Z17check_shifted_sumIs27custom_multiple_constant_orIsEEvT_(%struct.State* %0, i64 %247, %struct.Memory* %MEMORY.1)
...
block_.L_40685e:                                  ; preds = %block_.L_4067ef
  ...
  %call2_40685e = tail call %struct.Memory* @sub_400e60._Z5timerv(%struct.State* %0, i64 %284, %struct.Memory* %MEMORY.0)
  ...
  %call2_406867 = tail call %struct.Memory* @sub_400800._Z13record_resultdPKc(%struct.State* %0, i64 %295, %struct.Memory* %call2_40685e)
