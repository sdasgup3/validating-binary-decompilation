...
define %struct.Memory* @_Z13test_constantIs28custom_greaterthan_constantsIsEEvPT_iPKc(%struct.State* noalias, i64, %struct.Memory* noalias) #1 {
entry:
  ...
  store %struct.Memory* %loadMem1_4059b3, %struct.Memory** %MEMORY
...
block_4059e8:                                     ; preds = %block_.L_4059dc
  ...
  store %struct.Memory* %loadMem1_4059f4, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_405a05, %struct.Memory** %MEMORY
...
block_.L_405a2e:                                  ; preds = %block_.L_4059bf
  ...
  store %struct.Memory* %loadMem1_405a2e, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem1_405a37, %struct.Memory** %MEMORY
  ...
  ret %struct.Memory* %loadMem_405a41
}
