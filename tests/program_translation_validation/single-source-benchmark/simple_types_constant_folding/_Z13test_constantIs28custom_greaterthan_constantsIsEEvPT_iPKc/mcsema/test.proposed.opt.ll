...
declare %struct.Memory* @sub_415f00._Z17check_shifted_sumIs28custom_greaterthan_constantsIsEEvT_(%struct.State* noalias dereferenceable(3376), i64, %struct.Memory* noalias readnone returned) local_unnamed_addr
...
block_.L_4059bf:                                  ; preds = %block_.L_405a17, %entry
  %69 = phi i64 [ %284, %block_.L_405a17 ], [ %.pre, %entry ]
...
block_.L_4059dc:                                  ; preds = %block_4059e8, %block_4059cf
  %112 = phi i64 [ %241, %block_4059e8 ], [ %.pre6, %block_4059cf ]
...
block_4059e8:                                     ; preds = %block_.L_4059dc
  ...
  %call2_4059f4 = tail call %struct.Memory* @sub_415ee0._ZN28custom_greaterthan_constantsIsE8do_shiftEs(%struct.State* nonnull %0, i64 %164, %struct.Memory* %call2_4059b3)
...
block_.L_405a17:                                  ; preds = %block_.L_4059dc
  ...
  %call2_405a1b = tail call %struct.Memory* @sub_415f00._Z17check_shifted_sumIs28custom_greaterthan_constantsIsEEvT_(%struct.State* nonnull %0, i64 %248, %struct.Memory* %call2_4059b3)
...
block_.L_405a2e:                                  ; preds = %block_.L_4059bf
  ...
  %call2_405a2e = tail call %struct.Memory* @sub_400ea0._Z5timerv(%struct.State* nonnull %0, i64 %285, %struct.Memory* %call2_4059b3)
