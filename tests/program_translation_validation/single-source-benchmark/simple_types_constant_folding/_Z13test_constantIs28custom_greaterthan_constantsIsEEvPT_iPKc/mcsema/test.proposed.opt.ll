...
declare %struct.Memory* @sub_415ec0._Z17check_shifted_sumIs28custom_greaterthan_constantsIsEEvT_(%struct.State* noalias dereferenceable(3376), i64, %struct.Memory* noalias readnone returned) local_unnamed_addr
...
entry:
  ...
  %call2_405973 = tail call %struct.Memory* @sub_400e40._Z11start_timerv(%struct.State* %0, i64 %58, %struct.Memory* %2)
...
block_.L_40597f:                                  ; preds = %block_.L_4059d7, %entry
  %69 = phi i64 [ %.pre, %entry ], [ %283, %block_.L_4059d7 ]
  %MEMORY.0 = phi %struct.Memory* [ %call2_405973, %entry ], [ %call2_4059db, %block_.L_4059d7 ]
  ...
  br i1 %102, label %block_40598f, label %block_.L_4059ee

block_40598f:                                     ; preds = %block_.L_40597f
  %104 = add i64 %70, -30
  %105 = add i64 %103, 6
...
block_.L_40599c:                                  ; preds = %block_4059a8, %block_40598f
  %112 = phi i64 [ %.pre1, %block_40598f ], [ %240, %block_4059a8 ]
  %MEMORY.1 = phi %struct.Memory* [ %MEMORY.0, %block_40598f ], [ %call2_4059b4, %block_4059a8 ]
  ...
  br i1 %148, label %block_4059a8, label %block_.L_4059d7

block_4059a8:                                     ; preds = %block_.L_40599c
  %150 = add i64 %113, -8
  %151 = add i64 %149, 4
  ...
  %call2_4059b4 = tail call %struct.Memory* @sub_415ea0._ZN28custom_greaterthan_constantsIsE8do_shiftEs(%struct.State* %0, i64 %164, %struct.Memory* %MEMORY.1)
...
block_.L_4059d7:                                  ; preds = %block_.L_40599c
  %241 = add i64 %113, -30
  %242 = add i64 %149, 4
  ...
  %call2_4059db = tail call %struct.Memory* @sub_415ec0._Z17check_shifted_sumIs28custom_greaterthan_constantsIsEEvT_(%struct.State* %0, i64 %247, %struct.Memory* %MEMORY.1)
...
block_.L_4059ee:                                  ; preds = %block_.L_40597f
  %284 = add i64 %103, -19342
  %285 = add i64 %103, 5
  ...
  %call2_4059ee = tail call %struct.Memory* @sub_400e60._Z5timerv(%struct.State* %0, i64 %284, %struct.Memory* %MEMORY.0)
  ...
  %call2_4059f7 = tail call %struct.Memory* @sub_400800._Z13record_resultdPKc(%struct.State* %0, i64 %295, %struct.Memory* %call2_4059ee)
  ...
  ret %struct.Memory* %call2_4059f7
}
...
define %struct.Memory* @routine_jge_.L_4059ee(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i8* %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
...
define %struct.Memory* @routine_jge_.L_4059d7(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i8* %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 2, i32 9
...
define %struct.Memory* @routine_jmpq_.L_40599c(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
...
define %struct.Memory* @routine_callq_._Z17check_shifted_sumIs28custom_greaterthan_constantsIsEEvT_(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
...
define %struct.Memory* @routine_jmpq_.L_40597f(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
