...
block_.L_40597f:                                  ; preds = %block_.L_4059d7, %entry
  %69 = phi i64 [ %.pre, %entry ], [ %285, %block_.L_4059d7 ]
...
block_.L_40599c:                                  ; preds = %block_4059a8, %block_40598f
  %112 = phi i64 [ %.pre1, %block_40598f ], [ %241, %block_4059a8 ]
...
block_.L_4059d7:                                  ; preds = %block_.L_40599c
  ...
  %call2_4059db = tail call %struct.Memory* @sub_415ec0._Z17check_shifted_sumIs28custom_greaterthan_constantsIsEEvT_(%struct.State* %0, i64 %248, %struct.Memory* %MEMORY.1)
...
block_.L_4059ee:                                  ; preds = %block_.L_40597f
  ...
  %call2_4059ee = tail call %struct.Memory* @sub_400e60._Z5timerv(%struct.State* %0, i64 %286, %struct.Memory* %MEMORY.0)
  ...
  %call2_4059f7 = tail call %struct.Memory* @sub_400800._Z13record_resultdPKc(%struct.State* %0, i64 %297, %struct.Memory* %call2_4059ee)
