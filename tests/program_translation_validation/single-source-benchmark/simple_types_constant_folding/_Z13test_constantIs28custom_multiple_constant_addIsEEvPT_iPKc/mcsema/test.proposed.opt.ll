...
declare %struct.Memory* @sub_415a80._Z17check_shifted_sumIs28custom_multiple_constant_addIsEEvT_(%struct.State* noalias dereferenceable(3376), i64, %struct.Memory* noalias readnone returned) local_unnamed_addr
...
define %struct.Memory* @_Z13test_constantIs28custom_multiple_constant_addIsEEvPT_iPKc(%struct.State* noalias, i64, %struct.Memory* noalias readnone) local_unnamed_addr #1 {
entry:
...
block_.L_405f3f:                                  ; preds = %block_.L_405f97, %entry
  %69 = phi i64 [ %284, %block_.L_405f97 ], [ %.pre, %entry ]
...
block_.L_405f5c:                                  ; preds = %block_405f68, %block_405f4f
  %112 = phi i64 [ %241, %block_405f68 ], [ %.pre6, %block_405f4f ]
...
block_405f68:                                     ; preds = %block_.L_405f5c
  ...
  %call2_405f74 = tail call %struct.Memory* @sub_415a50._ZN28custom_multiple_constant_addIsE8do_shiftEs(%struct.State* nonnull %0, i64 %164, %struct.Memory* %call2_405f33)
...
block_.L_405f97:                                  ; preds = %block_.L_405f5c
  ...
  %call2_405f9b = tail call %struct.Memory* @sub_415a80._Z17check_shifted_sumIs28custom_multiple_constant_addIsEEvT_(%struct.State* nonnull %0, i64 %248, %struct.Memory* %call2_405f33)
...
block_.L_405fae:                                  ; preds = %block_.L_405f3f
  ...
  %call2_405fae = tail call %struct.Memory* @sub_400ea0._Z5timerv(%struct.State* nonnull %0, i64 %285, %struct.Memory* %call2_405f33)
