...
block_.L_405eff:                                  ; preds = %block_.L_405f57, %entry
  %69 = phi i64 [ %.pre, %entry ], [ %285, %block_.L_405f57 ]
...
block_.L_405f1c:                                  ; preds = %block_405f28, %block_405f0f
  %112 = phi i64 [ %.pre1, %block_405f0f ], [ %241, %block_405f28 ]
...
block_.L_405f57:                                  ; preds = %block_.L_405f1c
  ...
  %call2_405f5b = tail call %struct.Memory* @sub_415a40._Z17check_shifted_sumIs28custom_multiple_constant_addIsEEvT_(%struct.State* %0, i64 %248, %struct.Memory* %MEMORY.1)
...
block_.L_405f6e:                                  ; preds = %block_.L_405eff
  ...
  %call2_405f6e = tail call %struct.Memory* @sub_400e60._Z5timerv(%struct.State* %0, i64 %286, %struct.Memory* %MEMORY.0)
  ...
  %call2_405f77 = tail call %struct.Memory* @sub_400800._Z13record_resultdPKc(%struct.State* %0, i64 %297, %struct.Memory* %call2_405f6e)
