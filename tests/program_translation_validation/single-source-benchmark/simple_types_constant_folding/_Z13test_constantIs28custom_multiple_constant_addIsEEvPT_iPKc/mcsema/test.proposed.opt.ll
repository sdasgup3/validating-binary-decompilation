...
declare %struct.Memory* @sub_415a40._Z17check_shifted_sumIs28custom_multiple_constant_addIsEEvT_(%struct.State* noalias dereferenceable(3376), i64, %struct.Memory* noalias readnone returned) local_unnamed_addr
...
entry:
  ...
  %call2_405ef3 = tail call %struct.Memory* @sub_400e40._Z11start_timerv(%struct.State* %0, i64 %58, %struct.Memory* %2)
...
block_.L_405eff:                                  ; preds = %block_.L_405f57, %entry
  %69 = phi i64 [ %.pre, %entry ], [ %283, %block_.L_405f57 ]
  %MEMORY.0 = phi %struct.Memory* [ %call2_405ef3, %entry ], [ %call2_405f5b, %block_.L_405f57 ]
  ...
  br i1 %102, label %block_405f0f, label %block_.L_405f6e
...
block_.L_405f1c:                                  ; preds = %block_405f28, %block_405f0f
  %112 = phi i64 [ %.pre1, %block_405f0f ], [ %240, %block_405f28 ]
  %MEMORY.1 = phi %struct.Memory* [ %MEMORY.0, %block_405f0f ], [ %call2_405f34, %block_405f28 ]
  ...
  br i1 %148, label %block_405f28, label %block_.L_405f57
...
block_405f28:                                     ; preds = %block_.L_405f1c
  ...
  %call2_405f34 = tail call %struct.Memory* @sub_415a10._ZN28custom_multiple_constant_addIsE8do_shiftEs(%struct.State* %0, i64 %164, %struct.Memory* %MEMORY.1)
...
block_.L_405f57:                                  ; preds = %block_.L_405f1c
  ...
  %call2_405f5b = tail call %struct.Memory* @sub_415a40._Z17check_shifted_sumIs28custom_multiple_constant_addIsEEvT_(%struct.State* %0, i64 %247, %struct.Memory* %MEMORY.1)
...
block_.L_405f6e:                                  ; preds = %block_.L_405eff
  ...
  %call2_405f6e = tail call %struct.Memory* @sub_400e60._Z5timerv(%struct.State* %0, i64 %284, %struct.Memory* %MEMORY.0)
  ...
  %call2_405f77 = tail call %struct.Memory* @sub_400800._Z13record_resultdPKc(%struct.State* %0, i64 %295, %struct.Memory* %call2_405f6e)
  ...
  ret %struct.Memory* %call2_405f77
}
...
define %struct.Memory* @routine_jge_.L_405f6e(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i8* %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
...
define %struct.Memory* @routine_jge_.L_405f57(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i8* %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 2, i32 9
...
define %struct.Memory* @routine_jmpq_.L_405f1c(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
...
define %struct.Memory* @routine_callq_._Z17check_shifted_sumIs28custom_multiple_constant_addIsEEvT_(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
...
define %struct.Memory* @routine_jmpq_.L_405eff(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
