...
declare %struct.Memory* @sub_4153d0._ZN28custom_multiple_constant_andIsE8do_shiftEs(%struct.State* dereferenceable(3376), i64, %struct.Memory*)

declare %struct.Memory* @sub_415400._Z17check_shifted_sumIs28custom_multiple_constant_andIsEEvT_(%struct.State* dereferenceable(3376), i64, %struct.Memory*)
...
define %struct.Memory* @_Z13test_constantIs28custom_multiple_constant_andIsEEvPT_iPKc(%struct.State* noalias, i64, %struct.Memory* noalias) #1 {
entry:
