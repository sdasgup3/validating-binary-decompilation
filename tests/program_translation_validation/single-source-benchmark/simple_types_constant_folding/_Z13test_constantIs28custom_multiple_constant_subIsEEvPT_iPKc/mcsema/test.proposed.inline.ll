...
declare %struct.Memory* @sub_415920._ZN28custom_multiple_constant_subIsE8do_shiftEs(%struct.State* dereferenceable(3376), i64, %struct.Memory*)

declare %struct.Memory* @sub_415950._Z17check_shifted_sumIs28custom_multiple_constant_subIsEEvT_(%struct.State* dereferenceable(3376), i64, %struct.Memory*)
...
define %struct.Memory* @_Z13test_constantIs28custom_multiple_constant_subIsEEvPT_iPKc(%struct.State* noalias, i64, %struct.Memory* noalias) #1 {
entry:
