...
block_.L_40605f:                                  ; preds = %block_.L_4060b7, %entry
  %69 = phi i64 [ %.pre, %entry ], [ %285, %block_.L_4060b7 ]
...
block_.L_40607c:                                  ; preds = %block_406088, %block_40606f
  %112 = phi i64 [ %.pre1, %block_40606f ], [ %241, %block_406088 ]
...
block_.L_4060b7:                                  ; preds = %block_.L_40607c
  ...
  %call2_4060bb = tail call %struct.Memory* @sub_415910._Z17check_shifted_sumIs28custom_multiple_constant_subIsEEvT_(%struct.State* %0, i64 %248, %struct.Memory* %MEMORY.1)
...
block_.L_4060ce:                                  ; preds = %block_.L_40605f
  ...
  %call2_4060ce = tail call %struct.Memory* @sub_400e60._Z5timerv(%struct.State* %0, i64 %286, %struct.Memory* %MEMORY.0)
  ...
  %call2_4060d7 = tail call %struct.Memory* @sub_400800._Z13record_resultdPKc(%struct.State* %0, i64 %297, %struct.Memory* %call2_4060ce)
