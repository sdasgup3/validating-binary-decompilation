...
declare %struct.Memory* @sub_415920._ZN28custom_multiple_constant_subIsE8do_shiftEs(%struct.State* noalias dereferenceable(3376), i64, %struct.Memory* noalias readnone returned) local_unnamed_addr

declare %struct.Memory* @sub_415950._Z17check_shifted_sumIs28custom_multiple_constant_subIsEEvT_(%struct.State* noalias dereferenceable(3376), i64, %struct.Memory* noalias readnone returned) local_unnamed_addr
...
block_.L_40609f:                                  ; preds = %block_.L_4060f7, %entry
  %69 = phi i64 [ %284, %block_.L_4060f7 ], [ %.pre, %entry ]
...
block_.L_4060bc:                                  ; preds = %block_4060c8, %block_4060af
  %112 = phi i64 [ %241, %block_4060c8 ], [ %.pre6, %block_4060af ]
...
block_4060c8:                                     ; preds = %block_.L_4060bc
  ...
  %call2_4060d4 = tail call %struct.Memory* @sub_415920._ZN28custom_multiple_constant_subIsE8do_shiftEs(%struct.State* nonnull %0, i64 %164, %struct.Memory* %call2_406093)
...
block_.L_4060f7:                                  ; preds = %block_.L_4060bc
  ...
  %call2_4060fb = tail call %struct.Memory* @sub_415950._Z17check_shifted_sumIs28custom_multiple_constant_subIsEEvT_(%struct.State* nonnull %0, i64 %248, %struct.Memory* %call2_406093)
...
block_.L_40610e:                                  ; preds = %block_.L_40609f
  ...
  %call2_40610e = tail call %struct.Memory* @sub_400ea0._Z5timerv(%struct.State* nonnull %0, i64 %285, %struct.Memory* %call2_406093)
