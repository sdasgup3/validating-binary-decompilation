...
declare %struct.Memory* @sub_415110._ZN28custom_multiple_constant_xorIsE8do_shiftEs(%struct.State* dereferenceable(3376), i64, %struct.Memory*)

declare %struct.Memory* @sub_415140._Z17check_shifted_sumIs28custom_multiple_constant_xorIsEEvT_(%struct.State* dereferenceable(3376), i64, %struct.Memory*)
...
define %struct.Memory* @_Z13test_constantIs28custom_multiple_constant_xorIsEEvPT_iPKc(%struct.State* noalias, i64, %struct.Memory* noalias) #1 {
entry:
