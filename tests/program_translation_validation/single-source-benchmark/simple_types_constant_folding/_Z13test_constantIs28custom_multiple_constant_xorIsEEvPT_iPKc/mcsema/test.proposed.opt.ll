...
declare %struct.Memory* @sub_415110._ZN28custom_multiple_constant_xorIsE8do_shiftEs(%struct.State* dereferenceable(3376), i64, %struct.Memory*) local_unnamed_addr

declare %struct.Memory* @sub_415140._Z17check_shifted_sumIs28custom_multiple_constant_xorIsEEvT_(%struct.State* dereferenceable(3376), i64, %struct.Memory*) local_unnamed_addr
...
block_.L_40698f:                                  ; preds = %block_.L_4069e7, %entry
  %69 = phi i64 [ %.pre, %entry ], [ %284, %block_.L_4069e7 ]
  %MEMORY.0 = phi %struct.Memory* [ %call2_406983, %entry ], [ %call2_4069eb, %block_.L_4069e7 ]
...
block_.L_4069ac:                                  ; preds = %block_4069b8, %block_40699f
  %112 = phi i64 [ %.pre6, %block_40699f ], [ %241, %block_4069b8 ]
  %MEMORY.1 = phi %struct.Memory* [ %MEMORY.0, %block_40699f ], [ %call2_4069c4, %block_4069b8 ]
...
block_4069b8:                                     ; preds = %block_.L_4069ac
  ...
  %call2_4069c4 = tail call %struct.Memory* @sub_415110._ZN28custom_multiple_constant_xorIsE8do_shiftEs(%struct.State* nonnull %0, i64 %164, %struct.Memory* %MEMORY.1)
...
block_.L_4069e7:                                  ; preds = %block_.L_4069ac
  ...
  %call2_4069eb = tail call %struct.Memory* @sub_415140._Z17check_shifted_sumIs28custom_multiple_constant_xorIsEEvT_(%struct.State* nonnull %0, i64 %248, %struct.Memory* %MEMORY.1)
...
block_.L_4069fe:                                  ; preds = %block_.L_40698f
  ...
  %call2_4069fe = tail call %struct.Memory* @sub_400ea0._Z5timerv(%struct.State* nonnull %0, i64 %285, %struct.Memory* %MEMORY.0)
