...
block_.L_40694f:                                  ; preds = %block_.L_4069a7, %entry
  %69 = phi i64 [ %.pre, %entry ], [ %283, %block_.L_4069a7 ]
...
block_.L_40696c:                                  ; preds = %block_406978, %block_40695f
  %112 = phi i64 [ %.pre1, %block_40695f ], [ %240, %block_406978 ]
...
block_.L_4069a7:                                  ; preds = %block_.L_40696c
  ...
  %call2_4069ab = tail call %struct.Memory* @sub_415100._Z17check_shifted_sumIs28custom_multiple_constant_xorIsEEvT_(%struct.State* %0, i64 %247, %struct.Memory* %MEMORY.1)
...
block_.L_4069be:                                  ; preds = %block_.L_40694f
  ...
  %call2_4069be = tail call %struct.Memory* @sub_400e60._Z5timerv(%struct.State* %0, i64 %284, %struct.Memory* %MEMORY.0)
  ...
  %call2_4069c7 = tail call %struct.Memory* @sub_400800._Z13record_resultdPKc(%struct.State* %0, i64 %295, %struct.Memory* %call2_4069be)
