...
block_.L_405b8f:                                  ; preds = %block_.L_405be7, %entry
  %69 = phi i64 [ %.pre, %entry ], [ %283, %block_.L_405be7 ]
...
block_.L_405bac:                                  ; preds = %block_405bb8, %block_405b9f
  %112 = phi i64 [ %.pre1, %block_405b9f ], [ %240, %block_405bb8 ]
...
block_.L_405be7:                                  ; preds = %block_.L_405bac
  ...
  %call2_405beb = tail call %struct.Memory* @sub_415d10._Z17check_shifted_sumIs30custom_lessthanequal_constantsIsEEvT_(%struct.State* %0, i64 %247, %struct.Memory* %MEMORY.1)
...
block_.L_405bfe:                                  ; preds = %block_.L_405b8f
  ...
  %call2_405bfe = tail call %struct.Memory* @sub_400e60._Z5timerv(%struct.State* %0, i64 %284, %struct.Memory* %MEMORY.0)
  ...
  %call2_405c07 = tail call %struct.Memory* @sub_400800._Z13record_resultdPKc(%struct.State* %0, i64 %295, %struct.Memory* %call2_405bfe)
