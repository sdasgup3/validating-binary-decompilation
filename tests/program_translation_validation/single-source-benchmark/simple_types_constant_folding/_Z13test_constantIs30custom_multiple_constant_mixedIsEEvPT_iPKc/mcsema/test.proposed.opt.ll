...
block_.L_40652f:                                  ; preds = %block_.L_406587, %entry
  %69 = phi i64 [ %.pre, %entry ], [ %283, %block_.L_406587 ]
...
block_.L_40654c:                                  ; preds = %block_406558, %block_40653f
  %112 = phi i64 [ %.pre1, %block_40653f ], [ %240, %block_406558 ]
...
block_.L_406587:                                  ; preds = %block_.L_40654c
  ...
  %call2_40658b = tail call %struct.Memory* @sub_4154e0._Z17check_shifted_sumIs30custom_multiple_constant_mixedIsEEvT_(%struct.State* %0, i64 %247, %struct.Memory* %MEMORY.1)
...
block_.L_40659e:                                  ; preds = %block_.L_40652f
  ...
  %call2_40659e = tail call %struct.Memory* @sub_400e60._Z5timerv(%struct.State* %0, i64 %284, %struct.Memory* %MEMORY.0)
  ...
  %call2_4065a7 = tail call %struct.Memory* @sub_400800._Z13record_resultdPKc(%struct.State* %0, i64 %295, %struct.Memory* %call2_40659e)
