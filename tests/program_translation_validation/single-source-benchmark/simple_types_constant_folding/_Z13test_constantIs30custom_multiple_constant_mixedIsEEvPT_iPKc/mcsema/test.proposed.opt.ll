...
declare %struct.Memory* @sub_415530._Z17check_shifted_sumIs30custom_multiple_constant_mixedIsEEvT_(%struct.State* noalias dereferenceable(3376), i64, %struct.Memory* noalias readnone returned) local_unnamed_addr
...
entry:
  ...
  %call2_406573 = tail call %struct.Memory* @sub_400e90._Z11start_timerv(%struct.State* %0, i64 %58, %struct.Memory* %2)
...
block_.L_40657f:                                  ; preds = %block_.L_4065d7, %entry
  %69 = phi i64 [ %284, %block_.L_4065d7 ], [ %.pre, %entry ]
  ...
  br i1 %102, label %block_40658f, label %block_.L_4065ee
...
block_.L_40659c:                                  ; preds = %block_4065a8, %block_40658f
  %112 = phi i64 [ %241, %block_4065a8 ], [ %.pre6, %block_40658f ]
  ...
  br i1 %148, label %block_4065a8, label %block_.L_4065d7
...
block_4065a8:                                     ; preds = %block_.L_40659c
  ...
  %call2_4065b4 = tail call %struct.Memory* @sub_415510._ZN30custom_multiple_constant_mixedIsE8do_shiftEs(%struct.State* nonnull %0, i64 %164, %struct.Memory* %call2_406573)
...
block_.L_4065d7:                                  ; preds = %block_.L_40659c
  ...
  %call2_4065db = tail call %struct.Memory* @sub_415530._Z17check_shifted_sumIs30custom_multiple_constant_mixedIsEEvT_(%struct.State* nonnull %0, i64 %248, %struct.Memory* %call2_406573)
...
block_.L_4065ee:                                  ; preds = %block_.L_40657f
  ...
  %call2_4065ee = tail call %struct.Memory* @sub_400eb0._Z5timerv(%struct.State* nonnull %0, i64 %285, %struct.Memory* %call2_406573)
  ...
  %call2_4065f7 = tail call %struct.Memory* @sub_400850._Z13record_resultdPKc(%struct.State* nonnull %0, i64 %296, %struct.Memory* %call2_4065ee)
