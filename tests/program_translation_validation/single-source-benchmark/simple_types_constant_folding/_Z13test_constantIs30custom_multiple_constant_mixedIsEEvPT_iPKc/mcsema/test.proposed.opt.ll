...
declare %struct.Memory* @sub_415500._ZN30custom_multiple_constant_mixedIsE8do_shiftEs(%struct.State* noalias dereferenceable(3376), i64, %struct.Memory* noalias readnone returned) local_unnamed_addr

declare %struct.Memory* @sub_415520._Z17check_shifted_sumIs30custom_multiple_constant_mixedIsEEvT_(%struct.State* noalias dereferenceable(3376), i64, %struct.Memory* noalias readnone returned) local_unnamed_addr
...
define %struct.Memory* @_Z13test_constantIs30custom_multiple_constant_mixedIsEEvPT_iPKc(%struct.State* noalias, i64, %struct.Memory* noalias readnone) local_unnamed_addr #1 {
entry:
...
block_.L_40656f:                                  ; preds = %block_.L_4065c7, %entry
  %69 = phi i64 [ %284, %block_.L_4065c7 ], [ %.pre, %entry ]
...
block_.L_40658c:                                  ; preds = %block_406598, %block_40657f
  %112 = phi i64 [ %241, %block_406598 ], [ %.pre6, %block_40657f ]
...
block_406598:                                     ; preds = %block_.L_40658c
  ...
  %call2_4065a4 = tail call %struct.Memory* @sub_415500._ZN30custom_multiple_constant_mixedIsE8do_shiftEs(%struct.State* nonnull %0, i64 %164, %struct.Memory* %call2_406563)
...
block_.L_4065c7:                                  ; preds = %block_.L_40658c
  ...
  %call2_4065cb = tail call %struct.Memory* @sub_415520._Z17check_shifted_sumIs30custom_multiple_constant_mixedIsEEvT_(%struct.State* nonnull %0, i64 %248, %struct.Memory* %call2_406563)
...
block_.L_4065de:                                  ; preds = %block_.L_40656f
  ...
  %call2_4065de = tail call %struct.Memory* @sub_400ea0._Z5timerv(%struct.State* nonnull %0, i64 %285, %struct.Memory* %call2_406563)
