...
declare %struct.Memory* @sub_415620._ZN31custom_multiple_constant_divideIsE8do_shiftEs(%struct.State* dereferenceable(3376), i64, %struct.Memory*)

declare %struct.Memory* @sub_415660._Z17check_shifted_sumIs31custom_multiple_constant_divideIsEEvT_(%struct.State* dereferenceable(3376), i64, %struct.Memory*)
...
define %struct.Memory* @_Z13test_constantIs31custom_multiple_constant_divideIsEEvPT_iPKc(%struct.State* noalias, i64, %struct.Memory* noalias) #1 {
entry:
