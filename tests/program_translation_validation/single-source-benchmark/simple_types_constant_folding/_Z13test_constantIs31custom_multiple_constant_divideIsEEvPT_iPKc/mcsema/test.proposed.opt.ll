...
declare %struct.Memory* @sub_415660._Z17check_shifted_sumIs31custom_multiple_constant_divideIsEEvT_(%struct.State* noalias dereferenceable(3376), i64, %struct.Memory* noalias readnone returned) local_unnamed_addr
...
define %struct.Memory* @_Z13test_constantIs31custom_multiple_constant_divideIsEEvPT_iPKc(%struct.State* noalias, i64, %struct.Memory* noalias readnone) local_unnamed_addr #1 {
entry:
...
block_.L_40640f:                                  ; preds = %block_.L_406467, %entry
  %69 = phi i64 [ %284, %block_.L_406467 ], [ %.pre, %entry ]
...
block_.L_40642c:                                  ; preds = %block_406438, %block_40641f
  %112 = phi i64 [ %241, %block_406438 ], [ %.pre6, %block_40641f ]
...
block_406438:                                     ; preds = %block_.L_40642c
  ...
  %call2_406444 = tail call %struct.Memory* @sub_415620._ZN31custom_multiple_constant_divideIsE8do_shiftEs(%struct.State* nonnull %0, i64 %164, %struct.Memory* %call2_406403)
...
block_.L_406467:                                  ; preds = %block_.L_40642c
  ...
  %call2_40646b = tail call %struct.Memory* @sub_415660._Z17check_shifted_sumIs31custom_multiple_constant_divideIsEEvT_(%struct.State* nonnull %0, i64 %248, %struct.Memory* %call2_406403)
...
block_.L_40647e:                                  ; preds = %block_.L_40640f
  ...
  %call2_40647e = tail call %struct.Memory* @sub_400ea0._Z5timerv(%struct.State* nonnull %0, i64 %285, %struct.Memory* %call2_406403)
