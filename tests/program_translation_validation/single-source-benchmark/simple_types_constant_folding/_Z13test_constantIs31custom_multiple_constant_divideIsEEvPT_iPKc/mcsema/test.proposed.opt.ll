...
block_.L_4063cf:                                  ; preds = %block_.L_406427, %entry
  %69 = phi i64 [ %.pre, %entry ], [ %285, %block_.L_406427 ]
...
block_.L_4063ec:                                  ; preds = %block_4063f8, %block_4063df
  %112 = phi i64 [ %.pre1, %block_4063df ], [ %241, %block_4063f8 ]
...
block_.L_406427:                                  ; preds = %block_.L_4063ec
  ...
  %call2_40642b = tail call %struct.Memory* @sub_415620._Z17check_shifted_sumIs31custom_multiple_constant_divideIsEEvT_(%struct.State* %0, i64 %248, %struct.Memory* %MEMORY.1)
...
block_.L_40643e:                                  ; preds = %block_.L_4063cf
  ...
  %call2_40643e = tail call %struct.Memory* @sub_400e60._Z5timerv(%struct.State* %0, i64 %286, %struct.Memory* %MEMORY.0)
  ...
  %call2_406447 = tail call %struct.Memory* @sub_400800._Z13record_resultdPKc(%struct.State* %0, i64 %297, %struct.Memory* %call2_40643e)
