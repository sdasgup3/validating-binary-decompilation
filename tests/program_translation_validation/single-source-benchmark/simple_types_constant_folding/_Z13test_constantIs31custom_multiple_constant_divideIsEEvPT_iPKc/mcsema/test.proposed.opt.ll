...
declare %struct.Memory* @sub_415670._Z17check_shifted_sumIs31custom_multiple_constant_divideIsEEvT_(%struct.State* noalias dereferenceable(3376), i64, %struct.Memory* noalias readnone returned) local_unnamed_addr
...
entry:
  ...
  %call2_406413 = tail call %struct.Memory* @sub_400e90._Z11start_timerv(%struct.State* %0, i64 %58, %struct.Memory* %2)
...
block_.L_40641f:                                  ; preds = %block_.L_406477, %entry
  %69 = phi i64 [ %284, %block_.L_406477 ], [ %.pre, %entry ]
  ...
  br i1 %102, label %block_40642f, label %block_.L_40648e
...
block_.L_40643c:                                  ; preds = %block_406448, %block_40642f
  %112 = phi i64 [ %241, %block_406448 ], [ %.pre6, %block_40642f ]
  ...
  br i1 %148, label %block_406448, label %block_.L_406477
...
block_406448:                                     ; preds = %block_.L_40643c
  ...
  %call2_406454 = tail call %struct.Memory* @sub_415630._ZN31custom_multiple_constant_divideIsE8do_shiftEs(%struct.State* nonnull %0, i64 %164, %struct.Memory* %call2_406413)
...
block_.L_406477:                                  ; preds = %block_.L_40643c
  ...
  %call2_40647b = tail call %struct.Memory* @sub_415670._Z17check_shifted_sumIs31custom_multiple_constant_divideIsEEvT_(%struct.State* nonnull %0, i64 %248, %struct.Memory* %call2_406413)
...
block_.L_40648e:                                  ; preds = %block_.L_40641f
  ...
  %call2_40648e = tail call %struct.Memory* @sub_400eb0._Z5timerv(%struct.State* nonnull %0, i64 %285, %struct.Memory* %call2_406413)
  ...
  %call2_406497 = tail call %struct.Memory* @sub_400850._Z13record_resultdPKc(%struct.State* nonnull %0, i64 %296, %struct.Memory* %call2_40648e)
