...
block_.L_40647f:                                  ; preds = %block_.L_4064d7, %entry
  %69 = phi i64 [ %.pre, %entry ], [ %283, %block_.L_4064d7 ]
...
block_.L_40649c:                                  ; preds = %block_4064a8, %block_40648f
  %112 = phi i64 [ %.pre1, %block_40648f ], [ %240, %block_4064a8 ]
...
block_.L_4064d7:                                  ; preds = %block_.L_40649c
  ...
  %call2_4064db = tail call %struct.Memory* @sub_415570._Z17check_shifted_sumIs32custom_multiple_constant_divide2IsEEvT_(%struct.State* %0, i64 %247, %struct.Memory* %MEMORY.1)
...
block_.L_4064ee:                                  ; preds = %block_.L_40647f
  ...
  %call2_4064ee = tail call %struct.Memory* @sub_400e60._Z5timerv(%struct.State* %0, i64 %284, %struct.Memory* %MEMORY.0)
  ...
  %call2_4064f7 = tail call %struct.Memory* @sub_400800._Z13record_resultdPKc(%struct.State* %0, i64 %295, %struct.Memory* %call2_4064ee)
