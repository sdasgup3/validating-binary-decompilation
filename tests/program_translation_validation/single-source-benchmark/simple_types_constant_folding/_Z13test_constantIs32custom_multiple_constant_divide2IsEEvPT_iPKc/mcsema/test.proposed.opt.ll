...
declare %struct.Memory* @sub_415590._ZN32custom_multiple_constant_divide2IsE8do_shiftEs(%struct.State* dereferenceable(3376), i64, %struct.Memory*) local_unnamed_addr

declare %struct.Memory* @sub_4155b0._Z17check_shifted_sumIs32custom_multiple_constant_divide2IsEEvT_(%struct.State* dereferenceable(3376), i64, %struct.Memory*) local_unnamed_addr
...
block_.L_4064bf:                                  ; preds = %block_.L_406517, %entry
  %69 = phi i64 [ %.pre, %entry ], [ %284, %block_.L_406517 ]
  %MEMORY.0 = phi %struct.Memory* [ %call2_4064b3, %entry ], [ %call2_40651b, %block_.L_406517 ]
...
block_.L_4064dc:                                  ; preds = %block_4064e8, %block_4064cf
  %112 = phi i64 [ %.pre6, %block_4064cf ], [ %241, %block_4064e8 ]
  %MEMORY.1 = phi %struct.Memory* [ %MEMORY.0, %block_4064cf ], [ %call2_4064f4, %block_4064e8 ]
...
block_4064e8:                                     ; preds = %block_.L_4064dc
  ...
  %call2_4064f4 = tail call %struct.Memory* @sub_415590._ZN32custom_multiple_constant_divide2IsE8do_shiftEs(%struct.State* nonnull %0, i64 %164, %struct.Memory* %MEMORY.1)
...
block_.L_406517:                                  ; preds = %block_.L_4064dc
  ...
  %call2_40651b = tail call %struct.Memory* @sub_4155b0._Z17check_shifted_sumIs32custom_multiple_constant_divide2IsEEvT_(%struct.State* nonnull %0, i64 %248, %struct.Memory* %MEMORY.1)
...
block_.L_40652e:                                  ; preds = %block_.L_4064bf
  ...
  %call2_40652e = tail call %struct.Memory* @sub_400ea0._Z5timerv(%struct.State* nonnull %0, i64 %285, %struct.Memory* %MEMORY.0)
