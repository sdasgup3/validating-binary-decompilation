...
declare %struct.Memory* @sub_415de0._Z17check_shifted_sumIs33custom_greaterthanequal_constantsIsEEvT_(%struct.State* noalias dereferenceable(3376), i64, %struct.Memory* noalias readnone returned) local_unnamed_addr
...
define %struct.Memory* @_Z13test_constantIs33custom_greaterthanequal_constantsIsEEvPT_iPKc(%struct.State* noalias, i64, %struct.Memory* noalias readnone) local_unnamed_addr #1 {
entry:
...
block_.L_405b1f:                                  ; preds = %block_.L_405b77, %entry
  %69 = phi i64 [ %284, %block_.L_405b77 ], [ %.pre, %entry ]
...
block_.L_405b3c:                                  ; preds = %block_405b48, %block_405b2f
  %112 = phi i64 [ %241, %block_405b48 ], [ %.pre6, %block_405b2f ]
...
block_405b48:                                     ; preds = %block_.L_405b3c
  ...
  %call2_405b54 = tail call %struct.Memory* @sub_415dc0._ZN33custom_greaterthanequal_constantsIsE8do_shiftEs(%struct.State* nonnull %0, i64 %164, %struct.Memory* %call2_405b13)
...
block_.L_405b77:                                  ; preds = %block_.L_405b3c
  ...
  %call2_405b7b = tail call %struct.Memory* @sub_415de0._Z17check_shifted_sumIs33custom_greaterthanequal_constantsIsEEvT_(%struct.State* nonnull %0, i64 %248, %struct.Memory* %call2_405b13)
...
block_.L_405b8e:                                  ; preds = %block_.L_405b1f
  ...
  %call2_405b8e = tail call %struct.Memory* @sub_400ea0._Z5timerv(%struct.State* nonnull %0, i64 %285, %struct.Memory* %call2_405b13)
