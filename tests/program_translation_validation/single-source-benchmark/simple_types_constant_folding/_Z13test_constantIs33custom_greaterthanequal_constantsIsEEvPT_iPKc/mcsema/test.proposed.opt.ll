...
block_.L_405adf:                                  ; preds = %block_.L_405b37, %entry
  %69 = phi i64 [ %.pre, %entry ], [ %283, %block_.L_405b37 ]
...
block_.L_405afc:                                  ; preds = %block_405b08, %block_405aef
  %112 = phi i64 [ %.pre1, %block_405aef ], [ %240, %block_405b08 ]
...
block_.L_405b37:                                  ; preds = %block_.L_405afc
  ...
  %call2_405b3b = tail call %struct.Memory* @sub_415da0._Z17check_shifted_sumIs33custom_greaterthanequal_constantsIsEEvT_(%struct.State* %0, i64 %247, %struct.Memory* %MEMORY.1)
...
block_.L_405b4e:                                  ; preds = %block_.L_405adf
  ...
  %call2_405b4e = tail call %struct.Memory* @sub_400e60._Z5timerv(%struct.State* %0, i64 %284, %struct.Memory* %MEMORY.0)
  ...
  %call2_405b57 = tail call %struct.Memory* @sub_400800._Z13record_resultdPKc(%struct.State* %0, i64 %295, %struct.Memory* %call2_405b4e)
