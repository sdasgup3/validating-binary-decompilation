...
declare %struct.Memory* @sub_415df0._Z17check_shifted_sumIs33custom_greaterthanequal_constantsIsEEvT_(%struct.State* noalias dereferenceable(3376), i64, %struct.Memory* noalias readnone returned) local_unnamed_addr
...
entry:
  ...
  %call2_405b23 = tail call %struct.Memory* @sub_400e90._Z11start_timerv(%struct.State* %0, i64 %58, %struct.Memory* %2)
...
block_.L_405b2f:                                  ; preds = %block_.L_405b87, %entry
  %69 = phi i64 [ %284, %block_.L_405b87 ], [ %.pre, %entry ]
  ...
  br i1 %102, label %block_405b3f, label %block_.L_405b9e
...
block_.L_405b4c:                                  ; preds = %block_405b58, %block_405b3f
  %112 = phi i64 [ %241, %block_405b58 ], [ %.pre6, %block_405b3f ]
  ...
  br i1 %148, label %block_405b58, label %block_.L_405b87
...
block_405b58:                                     ; preds = %block_.L_405b4c
  ...
  %call2_405b64 = tail call %struct.Memory* @sub_415dd0._ZN33custom_greaterthanequal_constantsIsE8do_shiftEs(%struct.State* nonnull %0, i64 %164, %struct.Memory* %call2_405b23)
...
block_.L_405b87:                                  ; preds = %block_.L_405b4c
  ...
  %call2_405b8b = tail call %struct.Memory* @sub_415df0._Z17check_shifted_sumIs33custom_greaterthanequal_constantsIsEEvT_(%struct.State* nonnull %0, i64 %248, %struct.Memory* %call2_405b23)
...
block_.L_405b9e:                                  ; preds = %block_.L_405b2f
  ...
  %call2_405b9e = tail call %struct.Memory* @sub_400eb0._Z5timerv(%struct.State* nonnull %0, i64 %285, %struct.Memory* %call2_405b23)
  ...
  %call2_405ba7 = tail call %struct.Memory* @sub_400850._Z13record_resultdPKc(%struct.State* nonnull %0, i64 %296, %struct.Memory* %call2_405b9e)
