...
declare %struct.Memory* @sub_4157e0._Z17check_shifted_sumIs33custom_multiple_constant_multiplyIsEEvT_(%struct.State* noalias dereferenceable(3376), i64, %struct.Memory* noalias readnone returned)
...
entry:
  ...
  store %struct.Memory* %loadMem_4061a0, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_4061a1, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_4061a4, %struct.Memory** %MEMORY
  ...
  store i64 %78, i64* %81
  store %struct.Memory* %loadMem_4061a8, %struct.Memory** %MEMORY
  %loadMem_4061ac = load %struct.Memory*, %struct.Memory** %MEMORY
  ...
  store i32 %93, i32* %97
  store %struct.Memory* %loadMem_4061ac, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_4061af, %struct.Memory** %MEMORY
  %loadMem1_4061b3 = load %struct.Memory*, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem1_4061b3, %struct.Memory** %MEMORY
  %loadMem2_4061b3 = load %struct.Memory*, %struct.Memory** %MEMORY
  %loadPC_4061b3 = load i64, i64* %3
  %call2_4061b3 = call %struct.Memory* @sub_400e40._Z11start_timerv(%struct.State* %0, i64 %loadPC_4061b3, %struct.Memory* %loadMem2_4061b3)
  store %struct.Memory* %call2_4061b3, %struct.Memory** %MEMORY
...
block_.L_4061bf:                                  ; preds = %block_.L_406217, %entry
  ...
  store %struct.Memory* %loadMem_4061bf, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_4061c2, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_4061c9, %struct.Memory** %MEMORY
  %loadBr_4061c9 = load i8, i8* %BRANCH_TAKEN
  %cmpBr_4061c9 = icmp eq i8 %loadBr_4061c9, 1
  br i1 %cmpBr_4061c9, label %block_.L_40622e, label %block_4061cf

block_4061cf:                                     ; preds = %block_.L_4061bf
  %loadMem_4061cf = load %struct.Memory*, %struct.Memory** %MEMORY
  ...
  store i16 0, i16* %225
  store %struct.Memory* %loadMem_4061cf, %struct.Memory** %MEMORY
  ...
  br label %block_.L_4061dc

block_.L_4061dc:                                  ; preds = %block_4061e8, %block_4061cf
  ...
  store %struct.Memory* %loadMem_4061dc, %struct.Memory** %MEMORY
  ...
  %loadMem_4061e2 = load %struct.Memory*, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_4061e2, %struct.Memory** %MEMORY
  %loadBr_4061e2 = load i8, i8* %BRANCH_TAKEN
  %cmpBr_4061e2 = icmp eq i8 %loadBr_4061e2, 1
  br i1 %cmpBr_4061e2, label %block_.L_406217, label %block_4061e8

block_4061e8:                                     ; preds = %block_.L_4061dc
  ...
  %loadMem1_4061f4 = load %struct.Memory*, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem1_4061f4, %struct.Memory** %MEMORY
  %loadMem2_4061f4 = load %struct.Memory*, %struct.Memory** %MEMORY
  %loadPC_4061f4 = load i64, i64* %3
  %call2_4061f4 = call %struct.Memory* @sub_4157b0._ZN33custom_multiple_constant_multiplyIsE8do_shiftEs(%struct.State* %0, i64 %loadPC_4061f4, %struct.Memory* %loadMem2_4061f4)
  store %struct.Memory* %call2_4061f4, %struct.Memory** %MEMORY
  %loadMem_4061f9 = load %struct.Memory*, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_4061f9, %struct.Memory** %MEMORY
  ...
  %loadMem_406205 = load %struct.Memory*, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_406205, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_406212, %struct.Memory** %MEMORY
  br label %block_.L_4061dc

block_.L_406217:                                  ; preds = %block_.L_4061dc
  %loadMem_406217 = load %struct.Memory*, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_406217, %struct.Memory** %MEMORY
  %loadMem1_40621b = load %struct.Memory*, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem1_40621b, %struct.Memory** %MEMORY
  %loadMem2_40621b = load %struct.Memory*, %struct.Memory** %MEMORY
  %loadPC_40621b = load i64, i64* %3
  %call2_40621b = call %struct.Memory* @sub_4157e0._Z17check_shifted_sumIs33custom_multiple_constant_multiplyIsEEvT_(%struct.State* %0, i64 %loadPC_40621b, %struct.Memory* %loadMem2_40621b)
  store %struct.Memory* %call2_40621b, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_406220, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_406223, %struct.Memory** %MEMORY
  %loadMem_406226 = load %struct.Memory*, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_406226, %struct.Memory** %MEMORY
...
block_.L_40622e:                                  ; preds = %block_.L_4061bf
  %loadMem1_40622e = load %struct.Memory*, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem1_40622e, %struct.Memory** %MEMORY
  %loadMem2_40622e = load %struct.Memory*, %struct.Memory** %MEMORY
  %loadPC_40622e = load i64, i64* %3
  %call2_40622e = call %struct.Memory* @sub_400e60._Z5timerv(%struct.State* %0, i64 %loadPC_40622e, %struct.Memory* %loadMem2_40622e)
  store %struct.Memory* %call2_40622e, %struct.Memory** %MEMORY
  %loadMem_406233 = load %struct.Memory*, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_406233, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem1_406237, %struct.Memory** %MEMORY
  %loadMem2_406237 = load %struct.Memory*, %struct.Memory** %MEMORY
  %loadPC_406237 = load i64, i64* %3
  %call2_406237 = call %struct.Memory* @sub_400800._Z13record_resultdPKc(%struct.State* %0, i64 %loadPC_406237, %struct.Memory* %loadMem2_406237)
  ...
  store %struct.Memory* %loadMem_406241, %struct.Memory** %MEMORY
  ret %struct.Memory* %loadMem_406241
}
...
define %struct.Memory* @routine_jge_.L_40622e(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i8* %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) {
block_400478:
  %3 = getelementptr inbounds %struct.State, %struct.State* %0, i32 0, i32 6
  %4 = getelementptr inbounds %struct.GPR, %struct.GPR* %3, i32 0, i32 33
  %5 = getelementptr inbounds %struct.Reg, %struct.Reg* %4, i32 0, i32 0
...
define %struct.Memory* @routine_jge_.L_406217(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i8* %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) {
block_400478:
  %3 = getelementptr inbounds %struct.State, %struct.State* %0, i32 0, i32 6
  %4 = getelementptr inbounds %struct.GPR, %struct.GPR* %3, i32 0, i32 33
  %5 = getelementptr inbounds %struct.Reg, %struct.Reg* %4, i32 0, i32 0
...
define %struct.Memory* @routine_jmpq_.L_4061dc(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i64 %rel_off1, i64 %rel_off2) {
block_400478:
  %3 = getelementptr inbounds %struct.State, %struct.State* %0, i32 0, i32 6
  %4 = getelementptr inbounds %struct.GPR, %struct.GPR* %3, i32 0, i32 33
  %5 = getelementptr inbounds %struct.Reg, %struct.Reg* %4, i32 0, i32 0
