...
declare %struct.Memory* @sub_415830._Z17check_shifted_sumIs33custom_multiple_constant_multiplyIsEEvT_(%struct.State* noalias dereferenceable(3376), i64, %struct.Memory* noalias readnone returned) local_unnamed_addr
...
entry:
  ...
  %call2_406203 = tail call %struct.Memory* @sub_400e90._Z11start_timerv(%struct.State* %0, i64 %58, %struct.Memory* %2)
...
block_.L_40620f:                                  ; preds = %block_.L_406267, %entry
  %69 = phi i64 [ %284, %block_.L_406267 ], [ %.pre, %entry ]
  ...
  br i1 %102, label %block_40621f, label %block_.L_40627e
...
block_.L_40622c:                                  ; preds = %block_406238, %block_40621f
  %112 = phi i64 [ %241, %block_406238 ], [ %.pre6, %block_40621f ]
  ...
  br i1 %148, label %block_406238, label %block_.L_406267
...
block_406238:                                     ; preds = %block_.L_40622c
  ...
  %call2_406244 = tail call %struct.Memory* @sub_415800._ZN33custom_multiple_constant_multiplyIsE8do_shiftEs(%struct.State* nonnull %0, i64 %164, %struct.Memory* %call2_406203)
...
block_.L_406267:                                  ; preds = %block_.L_40622c
  ...
  %call2_40626b = tail call %struct.Memory* @sub_415830._Z17check_shifted_sumIs33custom_multiple_constant_multiplyIsEEvT_(%struct.State* nonnull %0, i64 %248, %struct.Memory* %call2_406203)
...
block_.L_40627e:                                  ; preds = %block_.L_40620f
  ...
  %call2_40627e = tail call %struct.Memory* @sub_400eb0._Z5timerv(%struct.State* nonnull %0, i64 %285, %struct.Memory* %call2_406203)
  ...
  %call2_406287 = tail call %struct.Memory* @sub_400850._Z13record_resultdPKc(%struct.State* nonnull %0, i64 %296, %struct.Memory* %call2_40627e)
