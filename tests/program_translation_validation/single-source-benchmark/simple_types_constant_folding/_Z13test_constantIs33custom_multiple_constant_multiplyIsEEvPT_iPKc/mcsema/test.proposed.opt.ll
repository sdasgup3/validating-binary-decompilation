...
block_.L_4061bf:                                  ; preds = %block_.L_406217, %entry
  %69 = phi i64 [ %.pre, %entry ], [ %285, %block_.L_406217 ]
...
block_.L_4061dc:                                  ; preds = %block_4061e8, %block_4061cf
  %112 = phi i64 [ %.pre1, %block_4061cf ], [ %241, %block_4061e8 ]
...
block_.L_406217:                                  ; preds = %block_.L_4061dc
  ...
  %call2_40621b = tail call %struct.Memory* @sub_4157e0._Z17check_shifted_sumIs33custom_multiple_constant_multiplyIsEEvT_(%struct.State* %0, i64 %248, %struct.Memory* %MEMORY.1)
...
block_.L_40622e:                                  ; preds = %block_.L_4061bf
  ...
  %call2_40622e = tail call %struct.Memory* @sub_400e60._Z5timerv(%struct.State* %0, i64 %286, %struct.Memory* %MEMORY.0)
  ...
  %call2_406237 = tail call %struct.Memory* @sub_400800._Z13record_resultdPKc(%struct.State* %0, i64 %297, %struct.Memory* %call2_40622e)
