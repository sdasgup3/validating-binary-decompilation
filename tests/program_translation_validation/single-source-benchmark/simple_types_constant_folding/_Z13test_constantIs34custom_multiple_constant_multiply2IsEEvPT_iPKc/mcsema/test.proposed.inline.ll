...
define %struct.Memory* @_Z13test_constantIs34custom_multiple_constant_multiply2IsEEvPT_iPKc(%struct.State* noalias, i64, %struct.Memory* noalias) #2 {
entry:
  ...
  store %struct.Memory* %loadMem1_406263, %struct.Memory** %MEMORY
...
block_.L_40626f:                                  ; preds = %block_.L_4062c7, %entry
...
block_40627f:                                     ; preds = %block_.L_40626f
...
block_.L_40628c:                                  ; preds = %block_406298, %block_40627f
...
block_406298:                                     ; preds = %block_.L_40628c
  ...
  store %struct.Memory* %loadMem1_4062a4, %struct.Memory** %MEMORY
...
block_.L_4062c7:                                  ; preds = %block_.L_40628c
  ...
  store %struct.Memory* %loadMem1_4062cb, %struct.Memory** %MEMORY
...
block_.L_4062de:                                  ; preds = %block_.L_40626f
  ...
  store %struct.Memory* %loadMem1_4062de, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem1_4062e7, %struct.Memory** %MEMORY
  ...
  ret %struct.Memory* %loadMem_4062f1
}
