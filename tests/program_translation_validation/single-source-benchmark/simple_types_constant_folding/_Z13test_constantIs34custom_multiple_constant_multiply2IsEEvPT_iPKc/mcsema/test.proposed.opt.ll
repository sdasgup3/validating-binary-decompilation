...
declare %struct.Memory* @sub_415790._Z17check_shifted_sumIs34custom_multiple_constant_multiply2IsEEvT_(%struct.State* noalias dereferenceable(3376), i64, %struct.Memory* noalias readnone returned) local_unnamed_addr
...
entry:
  ...
  %call2_4062b3 = tail call %struct.Memory* @sub_400e90._Z11start_timerv(%struct.State* %0, i64 %58, %struct.Memory* %2)
...
block_.L_4062bf:                                  ; preds = %block_.L_406317, %entry
  %69 = phi i64 [ %284, %block_.L_406317 ], [ %.pre, %entry ]
  ...
  br i1 %102, label %block_4062cf, label %block_.L_40632e
...
block_.L_4062dc:                                  ; preds = %block_4062e8, %block_4062cf
  %112 = phi i64 [ %241, %block_4062e8 ], [ %.pre6, %block_4062cf ]
  ...
  br i1 %148, label %block_4062e8, label %block_.L_406317
...
block_4062e8:                                     ; preds = %block_.L_4062dc
  ...
  %call2_4062f4 = tail call %struct.Memory* @sub_415770._ZN34custom_multiple_constant_multiply2IsE8do_shiftEs(%struct.State* nonnull %0, i64 %164, %struct.Memory* %call2_4062b3)
...
block_.L_406317:                                  ; preds = %block_.L_4062dc
  ...
  %call2_40631b = tail call %struct.Memory* @sub_415790._Z17check_shifted_sumIs34custom_multiple_constant_multiply2IsEEvT_(%struct.State* nonnull %0, i64 %248, %struct.Memory* %call2_4062b3)
...
block_.L_40632e:                                  ; preds = %block_.L_4062bf
  ...
  %call2_40632e = tail call %struct.Memory* @sub_400eb0._Z5timerv(%struct.State* nonnull %0, i64 %285, %struct.Memory* %call2_4062b3)
  ...
  %call2_406337 = tail call %struct.Memory* @sub_400850._Z13record_resultdPKc(%struct.State* nonnull %0, i64 %296, %struct.Memory* %call2_40632e)
