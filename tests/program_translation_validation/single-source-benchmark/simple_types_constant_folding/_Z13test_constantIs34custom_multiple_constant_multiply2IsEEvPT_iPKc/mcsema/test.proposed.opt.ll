...
declare %struct.Memory* @sub_415760._ZN34custom_multiple_constant_multiply2IsE8do_shiftEs(%struct.State* noalias dereferenceable(3376), i64, %struct.Memory* noalias readnone returned) local_unnamed_addr

declare %struct.Memory* @sub_415780._Z17check_shifted_sumIs34custom_multiple_constant_multiply2IsEEvT_(%struct.State* noalias dereferenceable(3376), i64, %struct.Memory* noalias readnone returned) local_unnamed_addr
...
define %struct.Memory* @_Z13test_constantIs34custom_multiple_constant_multiply2IsEEvPT_iPKc(%struct.State* noalias, i64, %struct.Memory* noalias readnone) local_unnamed_addr #1 {
entry:
...
block_.L_4062af:                                  ; preds = %block_.L_406307, %entry
  %69 = phi i64 [ %284, %block_.L_406307 ], [ %.pre, %entry ]
...
block_.L_4062cc:                                  ; preds = %block_4062d8, %block_4062bf
  %112 = phi i64 [ %241, %block_4062d8 ], [ %.pre6, %block_4062bf ]
...
block_4062d8:                                     ; preds = %block_.L_4062cc
  ...
  %call2_4062e4 = tail call %struct.Memory* @sub_415760._ZN34custom_multiple_constant_multiply2IsE8do_shiftEs(%struct.State* nonnull %0, i64 %164, %struct.Memory* %call2_4062a3)
...
block_.L_406307:                                  ; preds = %block_.L_4062cc
  ...
  %call2_40630b = tail call %struct.Memory* @sub_415780._Z17check_shifted_sumIs34custom_multiple_constant_multiply2IsEEvT_(%struct.State* nonnull %0, i64 %248, %struct.Memory* %call2_4062a3)
...
block_.L_40631e:                                  ; preds = %block_.L_4062af
  ...
  %call2_40631e = tail call %struct.Memory* @sub_400ea0._Z5timerv(%struct.State* nonnull %0, i64 %285, %struct.Memory* %call2_4062a3)
