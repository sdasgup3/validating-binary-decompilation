...
block_.L_40626f:                                  ; preds = %block_.L_4062c7, %entry
  %69 = phi i64 [ %.pre, %entry ], [ %285, %block_.L_4062c7 ]
...
block_.L_40628c:                                  ; preds = %block_406298, %block_40627f
  %112 = phi i64 [ %.pre1, %block_40627f ], [ %241, %block_406298 ]
...
block_.L_4062c7:                                  ; preds = %block_.L_40628c
  ...
  %call2_4062cb = tail call %struct.Memory* @sub_415740._Z17check_shifted_sumIs34custom_multiple_constant_multiply2IsEEvT_(%struct.State* %0, i64 %248, %struct.Memory* %MEMORY.1)
...
block_.L_4062de:                                  ; preds = %block_.L_40626f
  ...
  %call2_4062de = tail call %struct.Memory* @sub_400e60._Z5timerv(%struct.State* %0, i64 %286, %struct.Memory* %MEMORY.0)
  ...
  %call2_4062e7 = tail call %struct.Memory* @sub_400800._Z13record_resultdPKc(%struct.State* %0, i64 %297, %struct.Memory* %call2_4062de)
