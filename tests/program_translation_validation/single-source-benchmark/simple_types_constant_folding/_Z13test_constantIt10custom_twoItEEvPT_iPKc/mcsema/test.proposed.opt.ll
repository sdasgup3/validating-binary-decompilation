...
declare %struct.Memory* @sub_415060._Z17check_shifted_sumIt10custom_twoItEEvT_(%struct.State* noalias dereferenceable(3376), i64, %struct.Memory* noalias readnone returned) local_unnamed_addr
...
define %struct.Memory* @_Z13test_constantIt10custom_twoItEEvPT_iPKc(%struct.State* noalias, i64, %struct.Memory* noalias) local_unnamed_addr #1 {
entry:
  ...
  %call2_406a33 = tail call %struct.Memory* @sub_400e40._Z11start_timerv(%struct.State* %0, i64 %58, %struct.Memory* %2)
...
block_.L_406a3f:                                  ; preds = %block_.L_406a97, %entry
  %69 = phi i64 [ %.pre, %entry ], [ %268, %block_.L_406a97 ]
  %MEMORY.0 = phi %struct.Memory* [ %call2_406a33, %entry ], [ %call2_406a9b, %block_.L_406a97 ]
  ...
  br i1 %102, label %block_406a4f, label %block_.L_406aae
...
block_.L_406a5c:                                  ; preds = %block_406a68, %block_406a4f
  %112 = phi i64 [ %.pre1, %block_406a4f ], [ %226, %block_406a68 ]
  %MEMORY.1 = phi %struct.Memory* [ %MEMORY.0, %block_406a4f ], [ %call2_406a74, %block_406a68 ]
  ...
  br i1 %148, label %block_406a68, label %block_.L_406a97

block_406a68:                                     ; preds = %block_.L_406a5c
  %150 = add i64 %113, -8
  %151 = add i64 %149, 4
  ...
  %call2_406a74 = tail call %struct.Memory* @sub_415040._ZN10custom_twoItE8do_shiftEt(%struct.State* %0, i64 %163, %struct.Memory* %MEMORY.1)
...
block_.L_406a97:                                  ; preds = %block_.L_406a5c
  %227 = add i64 %113, -30
  %228 = add i64 %149, 4
  ...
  %call2_406a9b = tail call %struct.Memory* @sub_415060._Z17check_shifted_sumIt10custom_twoItEEvT_(%struct.State* %0, i64 %232, %struct.Memory* %MEMORY.1)
...
block_.L_406aae:                                  ; preds = %block_.L_406a3f
  %269 = add i64 %103, -23630
  %270 = add i64 %103, 5
  ...
  %call2_406aae = tail call %struct.Memory* @sub_400e60._Z5timerv(%struct.State* %0, i64 %269, %struct.Memory* %MEMORY.0)
  ...
  %call2_406ab7 = tail call %struct.Memory* @sub_400800._Z13record_resultdPKc(%struct.State* %0, i64 %280, %struct.Memory* %call2_406aae)
  ...
  ret %struct.Memory* %call2_406ab7
}
...
define %struct.Memory* @routine_jge_.L_406aae(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i8* %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
...
define %struct.Memory* @routine_jge_.L_406a97(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i8* %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 2, i32 9
...
define %struct.Memory* @routine_jmpq_.L_406a5c(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
...
define %struct.Memory* @routine_callq_._Z17check_shifted_sumIt10custom_twoItEEvT_(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
...
define %struct.Memory* @routine_jmpq_.L_406a3f(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
