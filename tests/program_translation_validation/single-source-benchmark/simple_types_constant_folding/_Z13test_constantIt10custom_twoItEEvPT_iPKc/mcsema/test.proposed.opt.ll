...
block_.L_406a3f:                                  ; preds = %block_.L_406a97, %entry
  %69 = phi i64 [ %.pre, %entry ], [ %270, %block_.L_406a97 ]
...
block_.L_406a5c:                                  ; preds = %block_406a68, %block_406a4f
  %112 = phi i64 [ %.pre1, %block_406a4f ], [ %227, %block_406a68 ]
...
block_.L_406a97:                                  ; preds = %block_.L_406a5c
  ...
  %call2_406a9b = tail call %struct.Memory* @sub_415060._Z17check_shifted_sumIt10custom_twoItEEvT_(%struct.State* %0, i64 %233, %struct.Memory* %MEMORY.1)
...
block_.L_406aae:                                  ; preds = %block_.L_406a3f
  ...
  %call2_406aae = tail call %struct.Memory* @sub_400e60._Z5timerv(%struct.State* %0, i64 %271, %struct.Memory* %MEMORY.0)
  ...
  %call2_406ab7 = tail call %struct.Memory* @sub_400800._Z13record_resultdPKc(%struct.State* %0, i64 %282, %struct.Memory* %call2_406aae)
