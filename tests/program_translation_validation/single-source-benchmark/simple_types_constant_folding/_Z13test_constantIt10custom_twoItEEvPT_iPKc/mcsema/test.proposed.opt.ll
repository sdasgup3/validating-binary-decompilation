...
declare %struct.Memory* @sub_4150b0._Z17check_shifted_sumIt10custom_twoItEEvT_(%struct.State* noalias dereferenceable(3376), i64, %struct.Memory* noalias readnone returned) local_unnamed_addr
...
entry:
  ...
  %call2_406a83 = tail call %struct.Memory* @sub_400e90._Z11start_timerv(%struct.State* %0, i64 %58, %struct.Memory* %2)
...
block_.L_406a8f:                                  ; preds = %block_.L_406ae7, %entry
  %69 = phi i64 [ %268, %block_.L_406ae7 ], [ %.pre, %entry ]
  ...
  br i1 %102, label %block_406a9f, label %block_.L_406afe
...
block_.L_406aac:                                  ; preds = %block_406ab8, %block_406a9f
  %112 = phi i64 [ %226, %block_406ab8 ], [ %.pre6, %block_406a9f ]
  ...
  br i1 %148, label %block_406ab8, label %block_.L_406ae7
...
block_406ab8:                                     ; preds = %block_.L_406aac
  ...
  %call2_406ac4 = tail call %struct.Memory* @sub_415090._ZN10custom_twoItE8do_shiftEt(%struct.State* nonnull %0, i64 %163, %struct.Memory* %call2_406a83)
...
block_.L_406ae7:                                  ; preds = %block_.L_406aac
  ...
  %call2_406aeb = tail call %struct.Memory* @sub_4150b0._Z17check_shifted_sumIt10custom_twoItEEvT_(%struct.State* nonnull %0, i64 %232, %struct.Memory* %call2_406a83)
...
block_.L_406afe:                                  ; preds = %block_.L_406a8f
  ...
  %call2_406afe = tail call %struct.Memory* @sub_400eb0._Z5timerv(%struct.State* nonnull %0, i64 %269, %struct.Memory* %call2_406a83)
  ...
  %call2_406b07 = tail call %struct.Memory* @sub_400850._Z13record_resultdPKc(%struct.State* nonnull %0, i64 %280, %struct.Memory* %call2_406afe)
