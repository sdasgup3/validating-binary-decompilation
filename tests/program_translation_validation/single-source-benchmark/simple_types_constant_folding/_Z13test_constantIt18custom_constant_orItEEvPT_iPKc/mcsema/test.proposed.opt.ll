...
declare %struct.Memory* @sub_414080._Z17check_shifted_sumIt18custom_constant_orItEEvT_(%struct.State* noalias dereferenceable(3376), i64, %struct.Memory* noalias readnone returned) local_unnamed_addr
...
block_.L_407dbf:                                  ; preds = %block_.L_407e17, %entry
  %69 = phi i64 [ %268, %block_.L_407e17 ], [ %.pre, %entry ]
...
block_.L_407ddc:                                  ; preds = %block_407de8, %block_407dcf
  %112 = phi i64 [ %226, %block_407de8 ], [ %.pre6, %block_407dcf ]
...
block_407de8:                                     ; preds = %block_.L_407ddc
  ...
  %call2_407df4 = tail call %struct.Memory* @sub_414060._ZN18custom_constant_orItE8do_shiftEt(%struct.State* nonnull %0, i64 %163, %struct.Memory* %call2_407db3)
...
block_.L_407e17:                                  ; preds = %block_.L_407ddc
  ...
  %call2_407e1b = tail call %struct.Memory* @sub_414080._Z17check_shifted_sumIt18custom_constant_orItEEvT_(%struct.State* nonnull %0, i64 %232, %struct.Memory* %call2_407db3)
...
block_.L_407e2e:                                  ; preds = %block_.L_407dbf
  ...
  %call2_407e2e = tail call %struct.Memory* @sub_400ea0._Z5timerv(%struct.State* nonnull %0, i64 %269, %struct.Memory* %call2_407db3)
