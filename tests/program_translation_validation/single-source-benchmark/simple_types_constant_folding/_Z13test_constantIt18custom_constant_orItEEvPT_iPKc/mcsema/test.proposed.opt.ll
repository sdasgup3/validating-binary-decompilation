...
block_.L_407d7f:                                  ; preds = %block_.L_407dd7, %entry
  %69 = phi i64 [ %.pre, %entry ], [ %270, %block_.L_407dd7 ]
...
block_.L_407d9c:                                  ; preds = %block_407da8, %block_407d8f
  %112 = phi i64 [ %.pre1, %block_407d8f ], [ %227, %block_407da8 ]
...
block_.L_407dd7:                                  ; preds = %block_.L_407d9c
  ...
  %call2_407ddb = tail call %struct.Memory* @sub_414040._Z17check_shifted_sumIt18custom_constant_orItEEvT_(%struct.State* %0, i64 %233, %struct.Memory* %MEMORY.1)
...
block_.L_407dee:                                  ; preds = %block_.L_407d7f
  ...
  %call2_407dee = tail call %struct.Memory* @sub_400e60._Z5timerv(%struct.State* %0, i64 %271, %struct.Memory* %MEMORY.0)
  ...
  %call2_407df7 = tail call %struct.Memory* @sub_400800._Z13record_resultdPKc(%struct.State* %0, i64 %282, %struct.Memory* %call2_407dee)
