...
declare %struct.Memory* @sub_414040._Z17check_shifted_sumIt18custom_constant_orItEEvT_(%struct.State* noalias dereferenceable(3376), i64, %struct.Memory* noalias readnone returned) local_unnamed_addr
...
entry:
  ...
  %call2_407d73 = tail call %struct.Memory* @sub_400e40._Z11start_timerv(%struct.State* %0, i64 %58, %struct.Memory* %2)
...
block_.L_407d7f:                                  ; preds = %block_.L_407dd7, %entry
  %69 = phi i64 [ %.pre, %entry ], [ %268, %block_.L_407dd7 ]
  %MEMORY.0 = phi %struct.Memory* [ %call2_407d73, %entry ], [ %call2_407ddb, %block_.L_407dd7 ]
  ...
  br i1 %102, label %block_407d8f, label %block_.L_407dee

block_407d8f:                                     ; preds = %block_.L_407d7f
  %104 = add i64 %70, -30
  %105 = add i64 %103, 6
  ...
  br label %block_.L_407d9c

block_.L_407d9c:                                  ; preds = %block_407da8, %block_407d8f
  %112 = phi i64 [ %.pre1, %block_407d8f ], [ %226, %block_407da8 ]
  %MEMORY.1 = phi %struct.Memory* [ %MEMORY.0, %block_407d8f ], [ %call2_407db4, %block_407da8 ]
  ...
  br i1 %148, label %block_407da8, label %block_.L_407dd7

block_407da8:                                     ; preds = %block_.L_407d9c
  %150 = add i64 %113, -8
  %151 = add i64 %149, 4
  ...
  %call2_407db4 = tail call %struct.Memory* @sub_414020._ZN18custom_constant_orItE8do_shiftEt(%struct.State* %0, i64 %163, %struct.Memory* %MEMORY.1)
...
block_.L_407dd7:                                  ; preds = %block_.L_407d9c
  %227 = add i64 %113, -30
  %228 = add i64 %149, 4
  ...
  %call2_407ddb = tail call %struct.Memory* @sub_414040._Z17check_shifted_sumIt18custom_constant_orItEEvT_(%struct.State* %0, i64 %232, %struct.Memory* %MEMORY.1)
...
block_.L_407dee:                                  ; preds = %block_.L_407d7f
  ...
  %call2_407dee = tail call %struct.Memory* @sub_400e60._Z5timerv(%struct.State* %0, i64 %269, %struct.Memory* %MEMORY.0)
  ...
  %call2_407df7 = tail call %struct.Memory* @sub_400800._Z13record_resultdPKc(%struct.State* %0, i64 %280, %struct.Memory* %call2_407dee)
  ...
  ret %struct.Memory* %call2_407df7
}
...
define %struct.Memory* @routine_jge_.L_407dee(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i8* %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
...
define %struct.Memory* @routine_jge_.L_407dd7(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i8* %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 2, i32 9
...
define %struct.Memory* @routine_jmpq_.L_407d9c(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
...
define %struct.Memory* @routine_callq_._Z17check_shifted_sumIt18custom_constant_orItEEvT_(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
...
define %struct.Memory* @routine_jmpq_.L_407d7f(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
