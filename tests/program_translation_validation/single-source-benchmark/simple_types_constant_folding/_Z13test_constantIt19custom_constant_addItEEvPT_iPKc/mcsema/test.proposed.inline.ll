...
declare %struct.Memory* @sub_414810._ZN19custom_constant_addItE8do_shiftEt(%struct.State* dereferenceable(3376), i64, %struct.Memory*)

declare %struct.Memory* @sub_414830._Z17check_shifted_sumIt19custom_constant_addItEEvT_(%struct.State* dereferenceable(3376), i64, %struct.Memory*)
...
define %struct.Memory* @_Z13test_constantIt19custom_constant_addItEEvPT_iPKc(%struct.State* noalias, i64, %struct.Memory* noalias) #1 {
entry:
