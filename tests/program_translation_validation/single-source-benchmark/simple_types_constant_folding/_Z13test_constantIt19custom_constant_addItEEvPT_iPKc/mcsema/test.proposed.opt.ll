...
declare %struct.Memory* @sub_414810._ZN19custom_constant_addItE8do_shiftEt(%struct.State* dereferenceable(3376), i64, %struct.Memory*) local_unnamed_addr

declare %struct.Memory* @sub_414830._Z17check_shifted_sumIt19custom_constant_addItEEvT_(%struct.State* dereferenceable(3376), i64, %struct.Memory*) local_unnamed_addr
...
block_.L_4074cf:                                  ; preds = %block_.L_407527, %entry
  %69 = phi i64 [ %.pre, %entry ], [ %268, %block_.L_407527 ]
  %MEMORY.0 = phi %struct.Memory* [ %call2_4074c3, %entry ], [ %call2_40752b, %block_.L_407527 ]
...
block_.L_4074ec:                                  ; preds = %block_4074f8, %block_4074df
  %112 = phi i64 [ %.pre6, %block_4074df ], [ %226, %block_4074f8 ]
  %MEMORY.1 = phi %struct.Memory* [ %MEMORY.0, %block_4074df ], [ %call2_407504, %block_4074f8 ]
...
block_4074f8:                                     ; preds = %block_.L_4074ec
  ...
  %call2_407504 = tail call %struct.Memory* @sub_414810._ZN19custom_constant_addItE8do_shiftEt(%struct.State* nonnull %0, i64 %163, %struct.Memory* %MEMORY.1)
...
block_.L_407527:                                  ; preds = %block_.L_4074ec
  ...
  %call2_40752b = tail call %struct.Memory* @sub_414830._Z17check_shifted_sumIt19custom_constant_addItEEvT_(%struct.State* nonnull %0, i64 %232, %struct.Memory* %MEMORY.1)
...
block_.L_40753e:                                  ; preds = %block_.L_4074cf
  ...
  %call2_40753e = tail call %struct.Memory* @sub_400ea0._Z5timerv(%struct.State* nonnull %0, i64 %269, %struct.Memory* %MEMORY.0)
