...
declare %struct.Memory* @sub_4141b0._Z17check_shifted_sumIt19custom_constant_andItEEvT_(%struct.State* noalias dereferenceable(3376), i64, %struct.Memory* noalias readnone returned) local_unnamed_addr
...
define %struct.Memory* @_Z13test_constantIt19custom_constant_andItEEvPT_iPKc(%struct.State* noalias, i64, %struct.Memory* noalias readnone) local_unnamed_addr #1 {
entry:
...
block_.L_407c5f:                                  ; preds = %block_.L_407cb7, %entry
  %69 = phi i64 [ %268, %block_.L_407cb7 ], [ %.pre, %entry ]
...
block_.L_407c7c:                                  ; preds = %block_407c88, %block_407c6f
  %112 = phi i64 [ %226, %block_407c88 ], [ %.pre6, %block_407c6f ]
...
block_407c88:                                     ; preds = %block_.L_407c7c
  ...
  %call2_407c94 = tail call %struct.Memory* @sub_414190._ZN19custom_constant_andItE8do_shiftEt(%struct.State* nonnull %0, i64 %163, %struct.Memory* %call2_407c53)
...
block_.L_407cb7:                                  ; preds = %block_.L_407c7c
  ...
  %call2_407cbb = tail call %struct.Memory* @sub_4141b0._Z17check_shifted_sumIt19custom_constant_andItEEvT_(%struct.State* nonnull %0, i64 %232, %struct.Memory* %call2_407c53)
...
block_.L_407cce:                                  ; preds = %block_.L_407c5f
  ...
  %call2_407cce = tail call %struct.Memory* @sub_400ea0._Z5timerv(%struct.State* nonnull %0, i64 %269, %struct.Memory* %call2_407c53)
