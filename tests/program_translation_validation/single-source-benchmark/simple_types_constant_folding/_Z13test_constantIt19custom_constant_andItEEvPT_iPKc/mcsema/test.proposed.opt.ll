...
declare %struct.Memory* @sub_4141c0._Z17check_shifted_sumIt19custom_constant_andItEEvT_(%struct.State* noalias dereferenceable(3376), i64, %struct.Memory* noalias readnone returned) local_unnamed_addr
...
entry:
  ...
  %call2_407c63 = tail call %struct.Memory* @sub_400e90._Z11start_timerv(%struct.State* %0, i64 %58, %struct.Memory* %2)
...
block_.L_407c6f:                                  ; preds = %block_.L_407cc7, %entry
  %69 = phi i64 [ %268, %block_.L_407cc7 ], [ %.pre, %entry ]
  ...
  br i1 %102, label %block_407c7f, label %block_.L_407cde
...
block_.L_407c8c:                                  ; preds = %block_407c98, %block_407c7f
  %112 = phi i64 [ %226, %block_407c98 ], [ %.pre6, %block_407c7f ]
  ...
  br i1 %148, label %block_407c98, label %block_.L_407cc7
...
block_407c98:                                     ; preds = %block_.L_407c8c
  ...
  %call2_407ca4 = tail call %struct.Memory* @sub_4141a0._ZN19custom_constant_andItE8do_shiftEt(%struct.State* nonnull %0, i64 %163, %struct.Memory* %call2_407c63)
...
block_.L_407cc7:                                  ; preds = %block_.L_407c8c
  ...
  %call2_407ccb = tail call %struct.Memory* @sub_4141c0._Z17check_shifted_sumIt19custom_constant_andItEEvT_(%struct.State* nonnull %0, i64 %232, %struct.Memory* %call2_407c63)
...
block_.L_407cde:                                  ; preds = %block_.L_407c6f
  ...
  %call2_407cde = tail call %struct.Memory* @sub_400eb0._Z5timerv(%struct.State* nonnull %0, i64 %269, %struct.Memory* %call2_407c63)
  ...
  %call2_407ce7 = tail call %struct.Memory* @sub_400850._Z13record_resultdPKc(%struct.State* nonnull %0, i64 %280, %struct.Memory* %call2_407cde)
