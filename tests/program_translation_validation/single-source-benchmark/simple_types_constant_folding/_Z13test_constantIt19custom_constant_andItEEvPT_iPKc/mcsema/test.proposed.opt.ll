...
block_.L_407c1f:                                  ; preds = %block_.L_407c77, %entry
  %69 = phi i64 [ %.pre, %entry ], [ %270, %block_.L_407c77 ]
...
block_.L_407c3c:                                  ; preds = %block_407c48, %block_407c2f
  %112 = phi i64 [ %.pre1, %block_407c2f ], [ %227, %block_407c48 ]
...
block_.L_407c77:                                  ; preds = %block_.L_407c3c
  ...
  %call2_407c7b = tail call %struct.Memory* @sub_414170._Z17check_shifted_sumIt19custom_constant_andItEEvT_(%struct.State* %0, i64 %233, %struct.Memory* %MEMORY.1)
...
block_.L_407c8e:                                  ; preds = %block_.L_407c1f
  ...
  %call2_407c8e = tail call %struct.Memory* @sub_400e60._Z5timerv(%struct.State* %0, i64 %271, %struct.Memory* %MEMORY.0)
  ...
  %call2_407c97 = tail call %struct.Memory* @sub_400800._Z13record_resultdPKc(%struct.State* %0, i64 %282, %struct.Memory* %call2_407c8e)
