...
declare %struct.Memory* @sub_4146e0._ZN19custom_constant_subItE8do_shiftEt(%struct.State* noalias dereferenceable(3376), i64, %struct.Memory* noalias readnone returned) local_unnamed_addr

declare %struct.Memory* @sub_414700._Z17check_shifted_sumIt19custom_constant_subItEEvT_(%struct.State* noalias dereferenceable(3376), i64, %struct.Memory* noalias readnone returned) local_unnamed_addr
...
block_.L_40762f:                                  ; preds = %block_.L_407687, %entry
  %69 = phi i64 [ %268, %block_.L_407687 ], [ %.pre, %entry ]
...
block_.L_40764c:                                  ; preds = %block_407658, %block_40763f
  %112 = phi i64 [ %226, %block_407658 ], [ %.pre6, %block_40763f ]
...
block_407658:                                     ; preds = %block_.L_40764c
  ...
  %call2_407664 = tail call %struct.Memory* @sub_4146e0._ZN19custom_constant_subItE8do_shiftEt(%struct.State* nonnull %0, i64 %163, %struct.Memory* %call2_407623)
...
block_.L_407687:                                  ; preds = %block_.L_40764c
  ...
  %call2_40768b = tail call %struct.Memory* @sub_414700._Z17check_shifted_sumIt19custom_constant_subItEEvT_(%struct.State* nonnull %0, i64 %232, %struct.Memory* %call2_407623)
...
block_.L_40769e:                                  ; preds = %block_.L_40762f
  ...
  %call2_40769e = tail call %struct.Memory* @sub_400ea0._Z5timerv(%struct.State* nonnull %0, i64 %269, %struct.Memory* %call2_407623)
