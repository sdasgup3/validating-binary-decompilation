...
block_.L_4075ef:                                  ; preds = %block_.L_407647, %entry
  %69 = phi i64 [ %.pre, %entry ], [ %268, %block_.L_407647 ]
...
block_.L_40760c:                                  ; preds = %block_407618, %block_4075ff
  %112 = phi i64 [ %.pre1, %block_4075ff ], [ %226, %block_407618 ]
...
block_.L_407647:                                  ; preds = %block_.L_40760c
  ...
  %call2_40764b = tail call %struct.Memory* @sub_4146c0._Z17check_shifted_sumIt19custom_constant_subItEEvT_(%struct.State* %0, i64 %232, %struct.Memory* %MEMORY.1)
...
block_.L_40765e:                                  ; preds = %block_.L_4075ef
  ...
  %call2_40765e = tail call %struct.Memory* @sub_400e60._Z5timerv(%struct.State* %0, i64 %269, %struct.Memory* %MEMORY.0)
  ...
  %call2_407667 = tail call %struct.Memory* @sub_400800._Z13record_resultdPKc(%struct.State* %0, i64 %280, %struct.Memory* %call2_40765e)
