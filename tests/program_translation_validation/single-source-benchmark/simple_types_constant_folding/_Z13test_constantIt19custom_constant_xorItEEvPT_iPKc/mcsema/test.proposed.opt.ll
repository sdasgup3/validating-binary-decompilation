...
block_.L_407edf:                                  ; preds = %block_.L_407f37, %entry
  %69 = phi i64 [ %.pre, %entry ], [ %270, %block_.L_407f37 ]
...
block_.L_407efc:                                  ; preds = %block_407f08, %block_407eef
  %112 = phi i64 [ %.pre1, %block_407eef ], [ %227, %block_407f08 ]
...
block_.L_407f37:                                  ; preds = %block_.L_407efc
  ...
  %call2_407f3b = tail call %struct.Memory* @sub_413f10._Z17check_shifted_sumIt19custom_constant_xorItEEvT_(%struct.State* %0, i64 %233, %struct.Memory* %MEMORY.1)
...
block_.L_407f4e:                                  ; preds = %block_.L_407edf
  ...
  %call2_407f4e = tail call %struct.Memory* @sub_400e60._Z5timerv(%struct.State* %0, i64 %271, %struct.Memory* %MEMORY.0)
  ...
  %call2_407f57 = tail call %struct.Memory* @sub_400800._Z13record_resultdPKc(%struct.State* %0, i64 %282, %struct.Memory* %call2_407f4e)
