...
declare %struct.Memory* @sub_414930._ZN19custom_or_constantsItE8do_shiftEt(%struct.State* dereferenceable(3376), i64, %struct.Memory*)

declare %struct.Memory* @sub_414950._Z17check_shifted_sumIt19custom_or_constantsItEEvT_(%struct.State* dereferenceable(3376), i64, %struct.Memory*)
...
define %struct.Memory* @_Z13test_constantIt19custom_or_constantsItEEvPT_iPKc(%struct.State* noalias, i64, %struct.Memory* noalias) #1 {
entry:
