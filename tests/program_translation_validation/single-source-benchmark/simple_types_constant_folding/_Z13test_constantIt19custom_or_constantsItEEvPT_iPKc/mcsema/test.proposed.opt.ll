...
block_.L_40732f:                                  ; preds = %block_.L_407387, %entry
  %69 = phi i64 [ %.pre, %entry ], [ %268, %block_.L_407387 ]
...
block_.L_40734c:                                  ; preds = %block_407358, %block_40733f
  %112 = phi i64 [ %.pre1, %block_40733f ], [ %226, %block_407358 ]
...
block_.L_407387:                                  ; preds = %block_.L_40734c
  ...
  %call2_40738b = tail call %struct.Memory* @sub_414910._Z17check_shifted_sumIt19custom_or_constantsItEEvT_(%struct.State* %0, i64 %232, %struct.Memory* %MEMORY.1)
...
block_.L_40739e:                                  ; preds = %block_.L_40732f
  ...
  %call2_40739e = tail call %struct.Memory* @sub_400e60._Z5timerv(%struct.State* %0, i64 %269, %struct.Memory* %MEMORY.0)
  ...
  %call2_4073a7 = tail call %struct.Memory* @sub_400800._Z13record_resultdPKc(%struct.State* %0, i64 %280, %struct.Memory* %call2_40739e)
