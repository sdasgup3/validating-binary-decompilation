...
declare %struct.Memory* @sub_414960._Z17check_shifted_sumIt19custom_or_constantsItEEvT_(%struct.State* noalias dereferenceable(3376), i64, %struct.Memory* noalias readnone returned) local_unnamed_addr
...
entry:
  ...
  %call2_407373 = tail call %struct.Memory* @sub_400e90._Z11start_timerv(%struct.State* %0, i64 %58, %struct.Memory* %2)
...
block_.L_40737f:                                  ; preds = %block_.L_4073d7, %entry
  %69 = phi i64 [ %268, %block_.L_4073d7 ], [ %.pre, %entry ]
  ...
  br i1 %102, label %block_40738f, label %block_.L_4073ee
...
block_.L_40739c:                                  ; preds = %block_4073a8, %block_40738f
  %112 = phi i64 [ %226, %block_4073a8 ], [ %.pre6, %block_40738f ]
  ...
  br i1 %148, label %block_4073a8, label %block_.L_4073d7
...
block_4073a8:                                     ; preds = %block_.L_40739c
  ...
  %call2_4073b4 = tail call %struct.Memory* @sub_414940._ZN19custom_or_constantsItE8do_shiftEt(%struct.State* nonnull %0, i64 %163, %struct.Memory* %call2_407373)
...
block_.L_4073d7:                                  ; preds = %block_.L_40739c
  ...
  %call2_4073db = tail call %struct.Memory* @sub_414960._Z17check_shifted_sumIt19custom_or_constantsItEEvT_(%struct.State* nonnull %0, i64 %232, %struct.Memory* %call2_407373)
...
block_.L_4073ee:                                  ; preds = %block_.L_40737f
  ...
  %call2_4073ee = tail call %struct.Memory* @sub_400eb0._Z5timerv(%struct.State* nonnull %0, i64 %269, %struct.Memory* %call2_407373)
  ...
  %call2_4073f7 = tail call %struct.Memory* @sub_400850._Z13record_resultdPKc(%struct.State* nonnull %0, i64 %280, %struct.Memory* %call2_4073ee)
