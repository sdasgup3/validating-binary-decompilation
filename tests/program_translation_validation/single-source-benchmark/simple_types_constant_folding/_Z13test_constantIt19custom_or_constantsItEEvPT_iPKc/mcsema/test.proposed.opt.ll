...
declare %struct.Memory* @sub_414950._Z17check_shifted_sumIt19custom_or_constantsItEEvT_(%struct.State* noalias dereferenceable(3376), i64, %struct.Memory* noalias readnone returned) local_unnamed_addr
...
define %struct.Memory* @_Z13test_constantIt19custom_or_constantsItEEvPT_iPKc(%struct.State* noalias, i64, %struct.Memory* noalias readnone) local_unnamed_addr #1 {
entry:
...
block_.L_40736f:                                  ; preds = %block_.L_4073c7, %entry
  %69 = phi i64 [ %268, %block_.L_4073c7 ], [ %.pre, %entry ]
...
block_.L_40738c:                                  ; preds = %block_407398, %block_40737f
  %112 = phi i64 [ %226, %block_407398 ], [ %.pre6, %block_40737f ]
...
block_407398:                                     ; preds = %block_.L_40738c
  ...
  %call2_4073a4 = tail call %struct.Memory* @sub_414930._ZN19custom_or_constantsItE8do_shiftEt(%struct.State* nonnull %0, i64 %163, %struct.Memory* %call2_407363)
...
block_.L_4073c7:                                  ; preds = %block_.L_40738c
  ...
  %call2_4073cb = tail call %struct.Memory* @sub_414950._Z17check_shifted_sumIt19custom_or_constantsItEEvT_(%struct.State* nonnull %0, i64 %232, %struct.Memory* %call2_407363)
...
block_.L_4073de:                                  ; preds = %block_.L_40736f
  ...
  %call2_4073de = tail call %struct.Memory* @sub_400ea0._Z5timerv(%struct.State* nonnull %0, i64 %269, %struct.Memory* %call2_407363)
