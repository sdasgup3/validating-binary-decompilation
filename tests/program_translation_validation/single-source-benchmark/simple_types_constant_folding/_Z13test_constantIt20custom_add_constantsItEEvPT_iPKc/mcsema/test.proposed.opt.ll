...
declare %struct.Memory* @sub_415010._Z17check_shifted_sumIt20custom_add_constantsItEEvT_(%struct.State* noalias dereferenceable(3376), i64, %struct.Memory* noalias readnone returned) local_unnamed_addr
...
block_.L_406b2f:                                  ; preds = %block_.L_406b87, %entry
  %69 = phi i64 [ %268, %block_.L_406b87 ], [ %.pre, %entry ]
...
block_.L_406b4c:                                  ; preds = %block_406b58, %block_406b3f
  %112 = phi i64 [ %226, %block_406b58 ], [ %.pre6, %block_406b3f ]
...
block_406b58:                                     ; preds = %block_.L_406b4c
  ...
  %call2_406b64 = tail call %struct.Memory* @sub_414ff0._ZN20custom_add_constantsItE8do_shiftEt(%struct.State* nonnull %0, i64 %163, %struct.Memory* %call2_406b23)
...
block_.L_406b87:                                  ; preds = %block_.L_406b4c
  ...
  %call2_406b8b = tail call %struct.Memory* @sub_415010._Z17check_shifted_sumIt20custom_add_constantsItEEvT_(%struct.State* nonnull %0, i64 %232, %struct.Memory* %call2_406b23)
...
block_.L_406b9e:                                  ; preds = %block_.L_406b2f
  ...
  %call2_406b9e = tail call %struct.Memory* @sub_400ea0._Z5timerv(%struct.State* nonnull %0, i64 %269, %struct.Memory* %call2_406b23)
