...
block_.L_406aef:                                  ; preds = %block_.L_406b47, %entry
  %69 = phi i64 [ %.pre, %entry ], [ %270, %block_.L_406b47 ]
...
block_.L_406b0c:                                  ; preds = %block_406b18, %block_406aff
  %112 = phi i64 [ %.pre1, %block_406aff ], [ %227, %block_406b18 ]
...
block_.L_406b47:                                  ; preds = %block_.L_406b0c
  ...
  %call2_406b4b = tail call %struct.Memory* @sub_414fd0._Z17check_shifted_sumIt20custom_add_constantsItEEvT_(%struct.State* %0, i64 %233, %struct.Memory* %MEMORY.1)
...
block_.L_406b5e:                                  ; preds = %block_.L_406aef
  ...
  %call2_406b5e = tail call %struct.Memory* @sub_400e60._Z5timerv(%struct.State* %0, i64 %271, %struct.Memory* %MEMORY.0)
  ...
  %call2_406b67 = tail call %struct.Memory* @sub_400800._Z13record_resultdPKc(%struct.State* %0, i64 %282, %struct.Memory* %call2_406b5e)
