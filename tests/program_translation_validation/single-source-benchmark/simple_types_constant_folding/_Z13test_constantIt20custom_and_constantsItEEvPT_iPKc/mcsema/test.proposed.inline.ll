...
declare %struct.Memory* @sub_4149e0._Z17check_shifted_sumIt20custom_and_constantsItEEvT_(%struct.State* dereferenceable(3376), i64, %struct.Memory*)
...
define %struct.Memory* @_Z13test_constantIt20custom_and_constantsItEEvPT_iPKc(%struct.State* noalias, i64, %struct.Memory* noalias) #1 {
entry:
