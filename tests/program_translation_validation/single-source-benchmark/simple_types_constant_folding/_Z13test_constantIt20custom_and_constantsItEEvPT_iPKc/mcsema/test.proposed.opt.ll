...
block_.L_40727f:                                  ; preds = %block_.L_4072d7, %entry
  %69 = phi i64 [ %.pre, %entry ], [ %268, %block_.L_4072d7 ]
...
block_.L_40729c:                                  ; preds = %block_4072a8, %block_40728f
  %112 = phi i64 [ %.pre1, %block_40728f ], [ %226, %block_4072a8 ]
...
block_.L_4072d7:                                  ; preds = %block_.L_40729c
  ...
  %call2_4072db = tail call %struct.Memory* @sub_4149a0._Z17check_shifted_sumIt20custom_and_constantsItEEvT_(%struct.State* %0, i64 %232, %struct.Memory* %MEMORY.1)
...
block_.L_4072ee:                                  ; preds = %block_.L_40727f
  ...
  %call2_4072ee = tail call %struct.Memory* @sub_400e60._Z5timerv(%struct.State* %0, i64 %269, %struct.Memory* %MEMORY.0)
  ...
  %call2_4072f7 = tail call %struct.Memory* @sub_400800._Z13record_resultdPKc(%struct.State* %0, i64 %280, %struct.Memory* %call2_4072ee)
