...
declare %struct.Memory* @sub_4149c0._ZN20custom_and_constantsItE8do_shiftEt(%struct.State* dereferenceable(3376), i64, %struct.Memory*) local_unnamed_addr

declare %struct.Memory* @sub_4149e0._Z17check_shifted_sumIt20custom_and_constantsItEEvT_(%struct.State* dereferenceable(3376), i64, %struct.Memory*) local_unnamed_addr
...
block_.L_4072bf:                                  ; preds = %block_.L_407317, %entry
  %69 = phi i64 [ %.pre, %entry ], [ %268, %block_.L_407317 ]
  %MEMORY.0 = phi %struct.Memory* [ %call2_4072b3, %entry ], [ %call2_40731b, %block_.L_407317 ]
...
block_.L_4072dc:                                  ; preds = %block_4072e8, %block_4072cf
  %112 = phi i64 [ %.pre6, %block_4072cf ], [ %226, %block_4072e8 ]
  %MEMORY.1 = phi %struct.Memory* [ %MEMORY.0, %block_4072cf ], [ %call2_4072f4, %block_4072e8 ]
...
block_4072e8:                                     ; preds = %block_.L_4072dc
  ...
  %call2_4072f4 = tail call %struct.Memory* @sub_4149c0._ZN20custom_and_constantsItE8do_shiftEt(%struct.State* nonnull %0, i64 %163, %struct.Memory* %MEMORY.1)
...
block_.L_407317:                                  ; preds = %block_.L_4072dc
  ...
  %call2_40731b = tail call %struct.Memory* @sub_4149e0._Z17check_shifted_sumIt20custom_and_constantsItEEvT_(%struct.State* nonnull %0, i64 %232, %struct.Memory* %MEMORY.1)
...
block_.L_40732e:                                  ; preds = %block_.L_4072bf
  ...
  %call2_40732e = tail call %struct.Memory* @sub_400ea0._Z5timerv(%struct.State* nonnull %0, i64 %269, %struct.Memory* %MEMORY.0)
