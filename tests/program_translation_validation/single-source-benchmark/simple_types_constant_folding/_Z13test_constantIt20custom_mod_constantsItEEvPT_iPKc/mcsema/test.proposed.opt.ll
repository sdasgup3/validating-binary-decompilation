...
block_.L_406daf:                                  ; preds = %block_.L_406e07, %entry
  %69 = phi i64 [ %.pre, %entry ], [ %268, %block_.L_406e07 ]
...
block_.L_406dcc:                                  ; preds = %block_406dd8, %block_406dbf
  %112 = phi i64 [ %.pre1, %block_406dbf ], [ %226, %block_406dd8 ]
...
block_.L_406e07:                                  ; preds = %block_.L_406dcc
  ...
  %call2_406e0b = tail call %struct.Memory* @sub_414d90._Z17check_shifted_sumIt20custom_mod_constantsItEEvT_(%struct.State* %0, i64 %232, %struct.Memory* %MEMORY.1)
...
block_.L_406e1e:                                  ; preds = %block_.L_406daf
  ...
  %call2_406e1e = tail call %struct.Memory* @sub_400e60._Z5timerv(%struct.State* %0, i64 %269, %struct.Memory* %MEMORY.0)
  ...
  %call2_406e27 = tail call %struct.Memory* @sub_400800._Z13record_resultdPKc(%struct.State* %0, i64 %280, %struct.Memory* %call2_406e1e)
