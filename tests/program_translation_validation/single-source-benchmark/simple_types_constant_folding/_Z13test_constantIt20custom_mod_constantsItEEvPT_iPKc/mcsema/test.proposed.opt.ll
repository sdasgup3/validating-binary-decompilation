...
declare %struct.Memory* @sub_414db0._ZN20custom_mod_constantsItE8do_shiftEt(%struct.State* dereferenceable(3376), i64, %struct.Memory*) local_unnamed_addr

declare %struct.Memory* @sub_414dd0._Z17check_shifted_sumIt20custom_mod_constantsItEEvT_(%struct.State* dereferenceable(3376), i64, %struct.Memory*) local_unnamed_addr
...
block_.L_406def:                                  ; preds = %block_.L_406e47, %entry
  %69 = phi i64 [ %.pre, %entry ], [ %268, %block_.L_406e47 ]
  %MEMORY.0 = phi %struct.Memory* [ %call2_406de3, %entry ], [ %call2_406e4b, %block_.L_406e47 ]
...
block_.L_406e0c:                                  ; preds = %block_406e18, %block_406dff
  %112 = phi i64 [ %.pre6, %block_406dff ], [ %226, %block_406e18 ]
  %MEMORY.1 = phi %struct.Memory* [ %MEMORY.0, %block_406dff ], [ %call2_406e24, %block_406e18 ]
...
block_406e18:                                     ; preds = %block_.L_406e0c
  ...
  %call2_406e24 = tail call %struct.Memory* @sub_414db0._ZN20custom_mod_constantsItE8do_shiftEt(%struct.State* nonnull %0, i64 %163, %struct.Memory* %MEMORY.1)
...
block_.L_406e47:                                  ; preds = %block_.L_406e0c
  ...
  %call2_406e4b = tail call %struct.Memory* @sub_414dd0._Z17check_shifted_sumIt20custom_mod_constantsItEEvT_(%struct.State* nonnull %0, i64 %232, %struct.Memory* %MEMORY.1)
...
block_.L_406e5e:                                  ; preds = %block_.L_406def
  ...
  %call2_406e5e = tail call %struct.Memory* @sub_400ea0._Z5timerv(%struct.State* nonnull %0, i64 %269, %struct.Memory* %MEMORY.0)
