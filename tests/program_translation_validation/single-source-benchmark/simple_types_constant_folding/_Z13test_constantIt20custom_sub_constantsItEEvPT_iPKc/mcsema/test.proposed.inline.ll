...
define %struct.Memory* @_Z13test_constantIt20custom_sub_constantsItEEvPT_iPKc(%struct.State* noalias, i64, %struct.Memory* noalias) #2 {
entry:
  ...
  store %struct.Memory* %loadMem_406bc1, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_406bcf, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem1_406bd3, %struct.Memory** %MEMORY
...
block_.L_406bdf:                                  ; preds = %block_.L_406c37, %entry
  ...
  store %struct.Memory* %loadMem_406bdf, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_406be2, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_406be9, %struct.Memory** %MEMORY
...
block_406bef:                                     ; preds = %block_.L_406bdf
  ...
  store i32 0, i32* %236
  store %struct.Memory* %loadMem_406bf5, %struct.Memory** %MEMORY
...
block_406c08:                                     ; preds = %block_.L_406bfc
  ...
  store %struct.Memory* %loadMem1_406c14, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_406c1c, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_406c20, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_406c25, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_406c29, %struct.Memory** %MEMORY
...
block_.L_406c37:                                  ; preds = %block_.L_406bfc
  ...
  store %struct.Memory* %loadMem_406c37, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem1_406c3b, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_406c40, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_406c46, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_406c49, %struct.Memory** %MEMORY
  br label %block_.L_406bdf
...
block_.L_406c4e:                                  ; preds = %block_.L_406bdf
  ...
  store %struct.Memory* %loadMem1_406c4e, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem1_406c57, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_406c5c, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_406c60, %struct.Memory** %MEMORY
  ...
  ret %struct.Memory* %loadMem_406c61
}
