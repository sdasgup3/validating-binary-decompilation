...
block_.L_406b9f:                                  ; preds = %block_.L_406bf7, %entry
  %69 = phi i64 [ %.pre, %entry ], [ %270, %block_.L_406bf7 ]
...
block_.L_406bbc:                                  ; preds = %block_406bc8, %block_406baf
  %112 = phi i64 [ %.pre1, %block_406baf ], [ %227, %block_406bc8 ]
...
block_.L_406bf7:                                  ; preds = %block_.L_406bbc
  ...
  %call2_406bfb = tail call %struct.Memory* @sub_414f40._Z17check_shifted_sumIt20custom_sub_constantsItEEvT_(%struct.State* %0, i64 %233, %struct.Memory* %MEMORY.1)
...
block_.L_406c0e:                                  ; preds = %block_.L_406b9f
  ...
  %call2_406c0e = tail call %struct.Memory* @sub_400e60._Z5timerv(%struct.State* %0, i64 %271, %struct.Memory* %MEMORY.0)
  ...
  %call2_406c17 = tail call %struct.Memory* @sub_400800._Z13record_resultdPKc(%struct.State* %0, i64 %282, %struct.Memory* %call2_406c0e)
