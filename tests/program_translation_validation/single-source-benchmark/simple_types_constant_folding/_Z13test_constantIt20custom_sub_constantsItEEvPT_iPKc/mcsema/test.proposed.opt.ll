...
declare %struct.Memory* @sub_414f70._ZN20custom_sub_constantsItE8do_shiftEt(%struct.State* noalias dereferenceable(3376), i64, %struct.Memory* noalias readnone returned) local_unnamed_addr

declare %struct.Memory* @sub_414f90._Z17check_shifted_sumIt20custom_sub_constantsItEEvT_(%struct.State* noalias dereferenceable(3376), i64, %struct.Memory* noalias readnone returned) local_unnamed_addr
...
entry:
  ...
  %call2_406be3 = tail call %struct.Memory* @sub_400e90._Z11start_timerv(%struct.State* %0, i64 %58, %struct.Memory* %2)
...
block_.L_406bef:                                  ; preds = %block_.L_406c47, %entry
  %69 = phi i64 [ %268, %block_.L_406c47 ], [ %.pre, %entry ]
  ...
  br i1 %102, label %block_406bff, label %block_.L_406c5e

block_406bff:                                     ; preds = %block_.L_406bef
  %104 = add i64 %70, -30
  %105 = add i64 %103, 6
  ...
  br label %block_.L_406c0c

block_.L_406c0c:                                  ; preds = %block_406c18, %block_406bff
  %112 = phi i64 [ %226, %block_406c18 ], [ %.pre6, %block_406bff ]
  ...
  br i1 %148, label %block_406c18, label %block_.L_406c47

block_406c18:                                     ; preds = %block_.L_406c0c
  %150 = add i64 %113, -8
  %151 = add i64 %149, 4
  ...
  %call2_406c24 = tail call %struct.Memory* @sub_414f70._ZN20custom_sub_constantsItE8do_shiftEt(%struct.State* nonnull %0, i64 %163, %struct.Memory* %call2_406be3)
...
block_.L_406c47:                                  ; preds = %block_.L_406c0c
  %227 = add i64 %113, -30
  %228 = add i64 %149, 4
  ...
  %call2_406c4b = tail call %struct.Memory* @sub_414f90._Z17check_shifted_sumIt20custom_sub_constantsItEEvT_(%struct.State* nonnull %0, i64 %232, %struct.Memory* %call2_406be3)
...
block_.L_406c5e:                                  ; preds = %block_.L_406bef
  ...
  %call2_406c5e = tail call %struct.Memory* @sub_400eb0._Z5timerv(%struct.State* nonnull %0, i64 %269, %struct.Memory* %call2_406be3)
  ...
  %call2_406c67 = tail call %struct.Memory* @sub_400850._Z13record_resultdPKc(%struct.State* nonnull %0, i64 %280, %struct.Memory* %call2_406c5e)
