...
declare %struct.Memory* @sub_414f60._ZN20custom_sub_constantsItE8do_shiftEt(%struct.State* noalias dereferenceable(3376), i64, %struct.Memory* noalias readnone returned) local_unnamed_addr

declare %struct.Memory* @sub_414f80._Z17check_shifted_sumIt20custom_sub_constantsItEEvT_(%struct.State* noalias dereferenceable(3376), i64, %struct.Memory* noalias readnone returned) local_unnamed_addr
...
define %struct.Memory* @_Z13test_constantIt20custom_sub_constantsItEEvPT_iPKc(%struct.State* noalias, i64, %struct.Memory* noalias readnone) local_unnamed_addr #1 {
entry:
...
block_.L_406bdf:                                  ; preds = %block_.L_406c37, %entry
  %69 = phi i64 [ %268, %block_.L_406c37 ], [ %.pre, %entry ]
...
block_.L_406bfc:                                  ; preds = %block_406c08, %block_406bef
  %112 = phi i64 [ %226, %block_406c08 ], [ %.pre6, %block_406bef ]
...
block_406c08:                                     ; preds = %block_.L_406bfc
  ...
  %call2_406c14 = tail call %struct.Memory* @sub_414f60._ZN20custom_sub_constantsItE8do_shiftEt(%struct.State* nonnull %0, i64 %163, %struct.Memory* %call2_406bd3)
...
block_.L_406c37:                                  ; preds = %block_.L_406bfc
  ...
  %call2_406c3b = tail call %struct.Memory* @sub_414f80._Z17check_shifted_sumIt20custom_sub_constantsItEEvT_(%struct.State* nonnull %0, i64 %232, %struct.Memory* %call2_406bd3)
...
block_.L_406c4e:                                  ; preds = %block_.L_406bdf
  ...
  %call2_406c4e = tail call %struct.Memory* @sub_400ea0._Z5timerv(%struct.State* nonnull %0, i64 %269, %struct.Memory* %call2_406bd3)
