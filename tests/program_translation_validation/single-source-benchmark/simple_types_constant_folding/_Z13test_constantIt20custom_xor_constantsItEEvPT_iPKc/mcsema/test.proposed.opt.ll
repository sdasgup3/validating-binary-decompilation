...
declare %struct.Memory* @sub_4148a0._ZN20custom_xor_constantsItE8do_shiftEt(%struct.State* noalias dereferenceable(3376), i64, %struct.Memory* noalias readnone returned) local_unnamed_addr

declare %struct.Memory* @sub_4148c0._Z17check_shifted_sumIt20custom_xor_constantsItEEvT_(%struct.State* noalias dereferenceable(3376), i64, %struct.Memory* noalias readnone returned) local_unnamed_addr
...
block_.L_40741f:                                  ; preds = %block_.L_407477, %entry
  %69 = phi i64 [ %268, %block_.L_407477 ], [ %.pre, %entry ]
...
block_.L_40743c:                                  ; preds = %block_407448, %block_40742f
  %112 = phi i64 [ %226, %block_407448 ], [ %.pre6, %block_40742f ]
...
block_407448:                                     ; preds = %block_.L_40743c
  ...
  %call2_407454 = tail call %struct.Memory* @sub_4148a0._ZN20custom_xor_constantsItE8do_shiftEt(%struct.State* nonnull %0, i64 %163, %struct.Memory* %call2_407413)
...
block_.L_407477:                                  ; preds = %block_.L_40743c
  ...
  %call2_40747b = tail call %struct.Memory* @sub_4148c0._Z17check_shifted_sumIt20custom_xor_constantsItEEvT_(%struct.State* nonnull %0, i64 %232, %struct.Memory* %call2_407413)
...
block_.L_40748e:                                  ; preds = %block_.L_40741f
  ...
  %call2_40748e = tail call %struct.Memory* @sub_400ea0._Z5timerv(%struct.State* nonnull %0, i64 %269, %struct.Memory* %call2_407413)
