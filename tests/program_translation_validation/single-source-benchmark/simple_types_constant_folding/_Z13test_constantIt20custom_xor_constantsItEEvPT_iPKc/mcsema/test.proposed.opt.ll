...
block_.L_4073df:                                  ; preds = %block_.L_407437, %entry
  %69 = phi i64 [ %.pre, %entry ], [ %268, %block_.L_407437 ]
...
block_.L_4073fc:                                  ; preds = %block_407408, %block_4073ef
  %112 = phi i64 [ %.pre1, %block_4073ef ], [ %226, %block_407408 ]
...
block_.L_407437:                                  ; preds = %block_.L_4073fc
  ...
  %call2_40743b = tail call %struct.Memory* @sub_414880._Z17check_shifted_sumIt20custom_xor_constantsItEEvT_(%struct.State* %0, i64 %232, %struct.Memory* %MEMORY.1)
...
block_.L_40744e:                                  ; preds = %block_.L_4073df
  ...
  %call2_40744e = tail call %struct.Memory* @sub_400e60._Z5timerv(%struct.State* %0, i64 %269, %struct.Memory* %MEMORY.0)
  ...
  %call2_407457 = tail call %struct.Memory* @sub_400800._Z13record_resultdPKc(%struct.State* %0, i64 %280, %struct.Memory* %call2_40744e)
