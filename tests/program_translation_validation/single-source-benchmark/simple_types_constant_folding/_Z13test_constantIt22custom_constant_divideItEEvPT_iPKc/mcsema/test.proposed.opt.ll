...
block_.L_40795f:                                  ; preds = %block_.L_4079b7, %entry
  %69 = phi i64 [ %.pre, %entry ], [ %268, %block_.L_4079b7 ]
...
block_.L_40797c:                                  ; preds = %block_407988, %block_40796f
  %112 = phi i64 [ %.pre1, %block_40796f ], [ %226, %block_407988 ]
...
block_.L_4079b7:                                  ; preds = %block_.L_40797c
  ...
  %call2_4079bb = tail call %struct.Memory* @sub_4143d0._Z17check_shifted_sumIt22custom_constant_divideItEEvT_(%struct.State* %0, i64 %232, %struct.Memory* %MEMORY.1)
...
block_.L_4079ce:                                  ; preds = %block_.L_40795f
  ...
  %call2_4079ce = tail call %struct.Memory* @sub_400e60._Z5timerv(%struct.State* %0, i64 %269, %struct.Memory* %MEMORY.0)
  ...
  %call2_4079d7 = tail call %struct.Memory* @sub_400800._Z13record_resultdPKc(%struct.State* %0, i64 %280, %struct.Memory* %call2_4079ce)
