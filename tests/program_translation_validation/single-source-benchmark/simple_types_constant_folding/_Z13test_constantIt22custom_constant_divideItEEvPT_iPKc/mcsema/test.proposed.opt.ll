...
declare %struct.Memory* @sub_4143f0._ZN22custom_constant_divideItE8do_shiftEt(%struct.State* dereferenceable(3376), i64, %struct.Memory*) local_unnamed_addr

declare %struct.Memory* @sub_414410._Z17check_shifted_sumIt22custom_constant_divideItEEvT_(%struct.State* dereferenceable(3376), i64, %struct.Memory*) local_unnamed_addr
...
block_.L_40799f:                                  ; preds = %block_.L_4079f7, %entry
  %69 = phi i64 [ %.pre, %entry ], [ %268, %block_.L_4079f7 ]
  %MEMORY.0 = phi %struct.Memory* [ %call2_407993, %entry ], [ %call2_4079fb, %block_.L_4079f7 ]
...
block_.L_4079bc:                                  ; preds = %block_4079c8, %block_4079af
  %112 = phi i64 [ %.pre6, %block_4079af ], [ %226, %block_4079c8 ]
  %MEMORY.1 = phi %struct.Memory* [ %MEMORY.0, %block_4079af ], [ %call2_4079d4, %block_4079c8 ]
...
block_4079c8:                                     ; preds = %block_.L_4079bc
  ...
  %call2_4079d4 = tail call %struct.Memory* @sub_4143f0._ZN22custom_constant_divideItE8do_shiftEt(%struct.State* nonnull %0, i64 %163, %struct.Memory* %MEMORY.1)
...
block_.L_4079f7:                                  ; preds = %block_.L_4079bc
  ...
  %call2_4079fb = tail call %struct.Memory* @sub_414410._Z17check_shifted_sumIt22custom_constant_divideItEEvT_(%struct.State* nonnull %0, i64 %232, %struct.Memory* %MEMORY.1)
...
block_.L_407a0e:                                  ; preds = %block_.L_40799f
  ...
  %call2_407a0e = tail call %struct.Memory* @sub_400ea0._Z5timerv(%struct.State* nonnull %0, i64 %269, %struct.Memory* %MEMORY.0)
