...
declare %struct.Memory* @sub_414d40._Z17check_shifted_sumIt22custom_equal_constantsItEEvT_(%struct.State* noalias dereferenceable(3376), i64, %struct.Memory* noalias readnone returned) local_unnamed_addr
...
define %struct.Memory* @_Z13test_constantIt22custom_equal_constantsItEEvPT_iPKc(%struct.State* noalias, i64, %struct.Memory* noalias readnone) local_unnamed_addr #1 {
entry:
...
block_.L_406e9f:                                  ; preds = %block_.L_406ef7, %entry
  %69 = phi i64 [ %268, %block_.L_406ef7 ], [ %.pre, %entry ]
...
block_.L_406ebc:                                  ; preds = %block_406ec8, %block_406eaf
  %112 = phi i64 [ %226, %block_406ec8 ], [ %.pre6, %block_406eaf ]
...
block_406ec8:                                     ; preds = %block_.L_406ebc
  ...
  %call2_406ed4 = tail call %struct.Memory* @sub_414d20._ZN22custom_equal_constantsItE8do_shiftEt(%struct.State* nonnull %0, i64 %163, %struct.Memory* %call2_406e93)
...
block_.L_406ef7:                                  ; preds = %block_.L_406ebc
  ...
  %call2_406efb = tail call %struct.Memory* @sub_414d40._Z17check_shifted_sumIt22custom_equal_constantsItEEvT_(%struct.State* nonnull %0, i64 %232, %struct.Memory* %call2_406e93)
...
block_.L_406f0e:                                  ; preds = %block_.L_406e9f
  ...
  %call2_406f0e = tail call %struct.Memory* @sub_400ea0._Z5timerv(%struct.State* nonnull %0, i64 %269, %struct.Memory* %call2_406e93)
