...
declare %struct.Memory* @sub_414d50._Z17check_shifted_sumIt22custom_equal_constantsItEEvT_(%struct.State* noalias dereferenceable(3376), i64, %struct.Memory* noalias readnone returned) local_unnamed_addr
...
entry:
  ...
  %call2_406ea3 = tail call %struct.Memory* @sub_400e90._Z11start_timerv(%struct.State* %0, i64 %58, %struct.Memory* %2)
...
block_.L_406eaf:                                  ; preds = %block_.L_406f07, %entry
  %69 = phi i64 [ %268, %block_.L_406f07 ], [ %.pre, %entry ]
  ...
  br i1 %102, label %block_406ebf, label %block_.L_406f1e

block_406ebf:                                     ; preds = %block_.L_406eaf
  %104 = add i64 %70, -30
  %105 = add i64 %103, 6
...
block_.L_406ecc:                                  ; preds = %block_406ed8, %block_406ebf
  %112 = phi i64 [ %226, %block_406ed8 ], [ %.pre6, %block_406ebf ]
  ...
  br i1 %148, label %block_406ed8, label %block_.L_406f07

block_406ed8:                                     ; preds = %block_.L_406ecc
  %150 = add i64 %113, -8
  %151 = add i64 %149, 4
  ...
  %call2_406ee4 = tail call %struct.Memory* @sub_414d30._ZN22custom_equal_constantsItE8do_shiftEt(%struct.State* nonnull %0, i64 %163, %struct.Memory* %call2_406ea3)
...
block_.L_406f07:                                  ; preds = %block_.L_406ecc
  %227 = add i64 %113, -30
  %228 = add i64 %149, 4
  ...
  %call2_406f0b = tail call %struct.Memory* @sub_414d50._Z17check_shifted_sumIt22custom_equal_constantsItEEvT_(%struct.State* nonnull %0, i64 %232, %struct.Memory* %call2_406ea3)
...
block_.L_406f1e:                                  ; preds = %block_.L_406eaf
  ...
  %call2_406f1e = tail call %struct.Memory* @sub_400eb0._Z5timerv(%struct.State* nonnull %0, i64 %269, %struct.Memory* %call2_406ea3)
  ...
  %call2_406f27 = tail call %struct.Memory* @sub_400850._Z13record_resultdPKc(%struct.State* nonnull %0, i64 %280, %struct.Memory* %call2_406f1e)
