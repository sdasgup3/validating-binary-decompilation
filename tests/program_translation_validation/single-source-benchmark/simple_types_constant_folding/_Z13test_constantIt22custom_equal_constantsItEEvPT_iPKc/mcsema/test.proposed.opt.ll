...
block_.L_406e5f:                                  ; preds = %block_.L_406eb7, %entry
  %69 = phi i64 [ %.pre, %entry ], [ %268, %block_.L_406eb7 ]
...
block_.L_406e7c:                                  ; preds = %block_406e88, %block_406e6f
  %112 = phi i64 [ %.pre1, %block_406e6f ], [ %226, %block_406e88 ]
...
block_.L_406eb7:                                  ; preds = %block_.L_406e7c
  ...
  %call2_406ebb = tail call %struct.Memory* @sub_414d00._Z17check_shifted_sumIt22custom_equal_constantsItEEvT_(%struct.State* %0, i64 %232, %struct.Memory* %MEMORY.1)
...
block_.L_406ece:                                  ; preds = %block_.L_406e5f
  ...
  %call2_406ece = tail call %struct.Memory* @sub_400e60._Z5timerv(%struct.State* %0, i64 %269, %struct.Memory* %MEMORY.0)
  ...
  %call2_406ed7 = tail call %struct.Memory* @sub_400800._Z13record_resultdPKc(%struct.State* %0, i64 %280, %struct.Memory* %call2_406ece)
