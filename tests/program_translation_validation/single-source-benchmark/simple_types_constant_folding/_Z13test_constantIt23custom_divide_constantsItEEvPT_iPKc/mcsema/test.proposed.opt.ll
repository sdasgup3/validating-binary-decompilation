...
declare %struct.Memory* @sub_414e60._Z17check_shifted_sumIt23custom_divide_constantsItEEvT_(%struct.State* dereferenceable(3376), i64, %struct.Memory*) local_unnamed_addr
...
block_.L_406d3f:                                  ; preds = %block_.L_406d97, %entry
  %69 = phi i64 [ %.pre, %entry ], [ %268, %block_.L_406d97 ]
  %MEMORY.0 = phi %struct.Memory* [ %call2_406d33, %entry ], [ %call2_406d9b, %block_.L_406d97 ]
...
block_.L_406d5c:                                  ; preds = %block_406d68, %block_406d4f
  %112 = phi i64 [ %.pre6, %block_406d4f ], [ %226, %block_406d68 ]
  %MEMORY.1 = phi %struct.Memory* [ %MEMORY.0, %block_406d4f ], [ %call2_406d74, %block_406d68 ]
...
block_406d68:                                     ; preds = %block_.L_406d5c
  ...
  %call2_406d74 = tail call %struct.Memory* @sub_414e40._ZN23custom_divide_constantsItE8do_shiftEt(%struct.State* nonnull %0, i64 %163, %struct.Memory* %MEMORY.1)
...
block_.L_406d97:                                  ; preds = %block_.L_406d5c
  ...
  %call2_406d9b = tail call %struct.Memory* @sub_414e60._Z17check_shifted_sumIt23custom_divide_constantsItEEvT_(%struct.State* nonnull %0, i64 %232, %struct.Memory* %MEMORY.1)
...
block_.L_406dae:                                  ; preds = %block_.L_406d3f
  ...
  %call2_406dae = tail call %struct.Memory* @sub_400ea0._Z5timerv(%struct.State* nonnull %0, i64 %269, %struct.Memory* %MEMORY.0)
