...
block_.L_406cff:                                  ; preds = %block_.L_406d57, %entry
  %69 = phi i64 [ %.pre, %entry ], [ %268, %block_.L_406d57 ]
...
block_.L_406d1c:                                  ; preds = %block_406d28, %block_406d0f
  %112 = phi i64 [ %.pre1, %block_406d0f ], [ %226, %block_406d28 ]
...
block_.L_406d57:                                  ; preds = %block_.L_406d1c
  ...
  %call2_406d5b = tail call %struct.Memory* @sub_414e20._Z17check_shifted_sumIt23custom_divide_constantsItEEvT_(%struct.State* %0, i64 %232, %struct.Memory* %MEMORY.1)
...
block_.L_406d6e:                                  ; preds = %block_.L_406cff
  ...
  %call2_406d6e = tail call %struct.Memory* @sub_400e60._Z5timerv(%struct.State* %0, i64 %269, %struct.Memory* %MEMORY.0)
  ...
  %call2_406d77 = tail call %struct.Memory* @sub_400800._Z13record_resultdPKc(%struct.State* %0, i64 %280, %struct.Memory* %call2_406d6e)
