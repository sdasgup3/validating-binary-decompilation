...
declare %struct.Memory* @sub_414e70._Z17check_shifted_sumIt23custom_divide_constantsItEEvT_(%struct.State* noalias dereferenceable(3376), i64, %struct.Memory* noalias readnone returned) local_unnamed_addr
...
entry:
  ...
  %call2_406d43 = tail call %struct.Memory* @sub_400e90._Z11start_timerv(%struct.State* %0, i64 %58, %struct.Memory* %2)
...
block_.L_406d4f:                                  ; preds = %block_.L_406da7, %entry
  %69 = phi i64 [ %268, %block_.L_406da7 ], [ %.pre, %entry ]
  ...
  br i1 %102, label %block_406d5f, label %block_.L_406dbe
...
block_.L_406d6c:                                  ; preds = %block_406d78, %block_406d5f
  %112 = phi i64 [ %226, %block_406d78 ], [ %.pre6, %block_406d5f ]
  ...
  br i1 %148, label %block_406d78, label %block_.L_406da7
...
block_406d78:                                     ; preds = %block_.L_406d6c
  ...
  %call2_406d84 = tail call %struct.Memory* @sub_414e50._ZN23custom_divide_constantsItE8do_shiftEt(%struct.State* nonnull %0, i64 %163, %struct.Memory* %call2_406d43)
...
block_.L_406da7:                                  ; preds = %block_.L_406d6c
  ...
  %call2_406dab = tail call %struct.Memory* @sub_414e70._Z17check_shifted_sumIt23custom_divide_constantsItEEvT_(%struct.State* nonnull %0, i64 %232, %struct.Memory* %call2_406d43)
...
block_.L_406dbe:                                  ; preds = %block_.L_406d4f
  ...
  %call2_406dbe = tail call %struct.Memory* @sub_400eb0._Z5timerv(%struct.State* nonnull %0, i64 %269, %struct.Memory* %call2_406d43)
  ...
  %call2_406dc7 = tail call %struct.Memory* @sub_400850._Z13record_resultdPKc(%struct.State* nonnull %0, i64 %280, %struct.Memory* %call2_406dbe)
