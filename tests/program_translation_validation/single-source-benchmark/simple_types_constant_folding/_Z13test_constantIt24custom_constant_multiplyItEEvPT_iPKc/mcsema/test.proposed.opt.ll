...
declare %struct.Memory* @sub_4145e0._Z17check_shifted_sumIt24custom_constant_multiplyItEEvT_(%struct.State* noalias dereferenceable(3376), i64, %struct.Memory* noalias readnone returned) local_unnamed_addr
...
entry:
  ...
  %call2_407793 = tail call %struct.Memory* @sub_400e90._Z11start_timerv(%struct.State* %0, i64 %58, %struct.Memory* %2)
...
block_.L_40779f:                                  ; preds = %block_.L_4077f7, %entry
  %69 = phi i64 [ %268, %block_.L_4077f7 ], [ %.pre, %entry ]
  ...
  br i1 %102, label %block_4077af, label %block_.L_40780e
...
block_.L_4077bc:                                  ; preds = %block_4077c8, %block_4077af
  %112 = phi i64 [ %226, %block_4077c8 ], [ %.pre6, %block_4077af ]
  ...
  br i1 %148, label %block_4077c8, label %block_.L_4077f7
...
block_4077c8:                                     ; preds = %block_.L_4077bc
  ...
  %call2_4077d4 = tail call %struct.Memory* @sub_4145c0._ZN24custom_constant_multiplyItE8do_shiftEt(%struct.State* nonnull %0, i64 %163, %struct.Memory* %call2_407793)
...
block_.L_4077f7:                                  ; preds = %block_.L_4077bc
  ...
  %call2_4077fb = tail call %struct.Memory* @sub_4145e0._Z17check_shifted_sumIt24custom_constant_multiplyItEEvT_(%struct.State* nonnull %0, i64 %232, %struct.Memory* %call2_407793)
...
block_.L_40780e:                                  ; preds = %block_.L_40779f
  ...
  %call2_40780e = tail call %struct.Memory* @sub_400eb0._Z5timerv(%struct.State* nonnull %0, i64 %269, %struct.Memory* %call2_407793)
  ...
  %call2_407817 = tail call %struct.Memory* @sub_400850._Z13record_resultdPKc(%struct.State* nonnull %0, i64 %280, %struct.Memory* %call2_40780e)
