...
block_.L_40774f:                                  ; preds = %block_.L_4077a7, %entry
  %69 = phi i64 [ %.pre, %entry ], [ %268, %block_.L_4077a7 ]
...
block_.L_40776c:                                  ; preds = %block_407778, %block_40775f
  %112 = phi i64 [ %.pre1, %block_40775f ], [ %226, %block_407778 ]
...
block_.L_4077a7:                                  ; preds = %block_.L_40776c
  ...
  %call2_4077ab = tail call %struct.Memory* @sub_414590._Z17check_shifted_sumIt24custom_constant_multiplyItEEvT_(%struct.State* %0, i64 %232, %struct.Memory* %MEMORY.1)
...
block_.L_4077be:                                  ; preds = %block_.L_40774f
  ...
  %call2_4077be = tail call %struct.Memory* @sub_400e60._Z5timerv(%struct.State* %0, i64 %269, %struct.Memory* %MEMORY.0)
  ...
  %call2_4077c7 = tail call %struct.Memory* @sub_400800._Z13record_resultdPKc(%struct.State* %0, i64 %280, %struct.Memory* %call2_4077be)
