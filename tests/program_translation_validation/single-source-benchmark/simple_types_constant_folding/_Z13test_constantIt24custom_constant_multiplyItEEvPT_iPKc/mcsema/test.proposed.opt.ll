...
declare %struct.Memory* @sub_4145d0._Z17check_shifted_sumIt24custom_constant_multiplyItEEvT_(%struct.State* noalias dereferenceable(3376), i64, %struct.Memory* noalias readnone returned) local_unnamed_addr
...
define %struct.Memory* @_Z13test_constantIt24custom_constant_multiplyItEEvPT_iPKc(%struct.State* noalias, i64, %struct.Memory* noalias readnone) local_unnamed_addr #1 {
entry:
...
block_.L_40778f:                                  ; preds = %block_.L_4077e7, %entry
  %69 = phi i64 [ %268, %block_.L_4077e7 ], [ %.pre, %entry ]
...
block_.L_4077ac:                                  ; preds = %block_4077b8, %block_40779f
  %112 = phi i64 [ %226, %block_4077b8 ], [ %.pre6, %block_40779f ]
...
block_4077b8:                                     ; preds = %block_.L_4077ac
  ...
  %call2_4077c4 = tail call %struct.Memory* @sub_4145b0._ZN24custom_constant_multiplyItE8do_shiftEt(%struct.State* nonnull %0, i64 %163, %struct.Memory* %call2_407783)
...
block_.L_4077e7:                                  ; preds = %block_.L_4077ac
  ...
  %call2_4077eb = tail call %struct.Memory* @sub_4145d0._Z17check_shifted_sumIt24custom_constant_multiplyItEEvT_(%struct.State* nonnull %0, i64 %232, %struct.Memory* %call2_407783)
...
block_.L_4077fe:                                  ; preds = %block_.L_40778f
  ...
  %call2_4077fe = tail call %struct.Memory* @sub_400ea0._Z5timerv(%struct.State* nonnull %0, i64 %269, %struct.Memory* %call2_407783)
