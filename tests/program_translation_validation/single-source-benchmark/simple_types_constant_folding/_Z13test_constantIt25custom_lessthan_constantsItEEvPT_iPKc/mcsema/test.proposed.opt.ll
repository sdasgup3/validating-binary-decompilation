...
declare %struct.Memory* @sub_414ba0._Z17check_shifted_sumIt25custom_lessthan_constantsItEEvT_(%struct.State* noalias dereferenceable(3376), i64, %struct.Memory* noalias readnone returned) local_unnamed_addr
...
entry:
  ...
  %call2_4070b3 = tail call %struct.Memory* @sub_400e90._Z11start_timerv(%struct.State* %0, i64 %58, %struct.Memory* %2)
...
block_.L_4070bf:                                  ; preds = %block_.L_407117, %entry
  %69 = phi i64 [ %268, %block_.L_407117 ], [ %.pre, %entry ]
  ...
  br i1 %102, label %block_4070cf, label %block_.L_40712e
...
block_.L_4070dc:                                  ; preds = %block_4070e8, %block_4070cf
  %112 = phi i64 [ %226, %block_4070e8 ], [ %.pre6, %block_4070cf ]
  ...
  br i1 %148, label %block_4070e8, label %block_.L_407117
...
block_4070e8:                                     ; preds = %block_.L_4070dc
  ...
  %call2_4070f4 = tail call %struct.Memory* @sub_414b80._ZN25custom_lessthan_constantsItE8do_shiftEt(%struct.State* nonnull %0, i64 %163, %struct.Memory* %call2_4070b3)
...
block_.L_407117:                                  ; preds = %block_.L_4070dc
  ...
  %call2_40711b = tail call %struct.Memory* @sub_414ba0._Z17check_shifted_sumIt25custom_lessthan_constantsItEEvT_(%struct.State* nonnull %0, i64 %232, %struct.Memory* %call2_4070b3)
...
block_.L_40712e:                                  ; preds = %block_.L_4070bf
  ...
  %call2_40712e = tail call %struct.Memory* @sub_400eb0._Z5timerv(%struct.State* nonnull %0, i64 %269, %struct.Memory* %call2_4070b3)
  ...
  %call2_407137 = tail call %struct.Memory* @sub_400850._Z13record_resultdPKc(%struct.State* nonnull %0, i64 %280, %struct.Memory* %call2_40712e)
