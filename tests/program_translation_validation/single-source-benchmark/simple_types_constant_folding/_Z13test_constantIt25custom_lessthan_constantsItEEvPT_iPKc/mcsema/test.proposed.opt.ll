...
block_.L_40706f:                                  ; preds = %block_.L_4070c7, %entry
  %69 = phi i64 [ %.pre, %entry ], [ %268, %block_.L_4070c7 ]
...
block_.L_40708c:                                  ; preds = %block_407098, %block_40707f
  %112 = phi i64 [ %.pre1, %block_40707f ], [ %226, %block_407098 ]
...
block_.L_4070c7:                                  ; preds = %block_.L_40708c
  ...
  %call2_4070cb = tail call %struct.Memory* @sub_414b50._Z17check_shifted_sumIt25custom_lessthan_constantsItEEvT_(%struct.State* %0, i64 %232, %struct.Memory* %MEMORY.1)
...
block_.L_4070de:                                  ; preds = %block_.L_40706f
  ...
  %call2_4070de = tail call %struct.Memory* @sub_400e60._Z5timerv(%struct.State* %0, i64 %269, %struct.Memory* %MEMORY.0)
  ...
  %call2_4070e7 = tail call %struct.Memory* @sub_400800._Z13record_resultdPKc(%struct.State* %0, i64 %280, %struct.Memory* %call2_4070de)
