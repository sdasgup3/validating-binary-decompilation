...
declare %struct.Memory* @sub_414ed0._ZN25custom_multiply_constantsItE8do_shiftEt(%struct.State* noalias dereferenceable(3376), i64, %struct.Memory* noalias readnone returned) local_unnamed_addr

declare %struct.Memory* @sub_414ef0._Z17check_shifted_sumIt25custom_multiply_constantsItEEvT_(%struct.State* noalias dereferenceable(3376), i64, %struct.Memory* noalias readnone returned) local_unnamed_addr
...
define %struct.Memory* @_Z13test_constantIt25custom_multiply_constantsItEEvPT_iPKc(%struct.State* noalias, i64, %struct.Memory* noalias readnone) local_unnamed_addr #1 {
entry:
...
block_.L_406c8f:                                  ; preds = %block_.L_406ce7, %entry
  %69 = phi i64 [ %268, %block_.L_406ce7 ], [ %.pre, %entry ]
...
block_.L_406cac:                                  ; preds = %block_406cb8, %block_406c9f
  %112 = phi i64 [ %226, %block_406cb8 ], [ %.pre6, %block_406c9f ]
...
block_406cb8:                                     ; preds = %block_.L_406cac
  ...
  %call2_406cc4 = tail call %struct.Memory* @sub_414ed0._ZN25custom_multiply_constantsItE8do_shiftEt(%struct.State* nonnull %0, i64 %163, %struct.Memory* %call2_406c83)
...
block_.L_406ce7:                                  ; preds = %block_.L_406cac
  ...
  %call2_406ceb = tail call %struct.Memory* @sub_414ef0._Z17check_shifted_sumIt25custom_multiply_constantsItEEvT_(%struct.State* nonnull %0, i64 %232, %struct.Memory* %call2_406c83)
...
block_.L_406cfe:                                  ; preds = %block_.L_406c8f
  ...
  %call2_406cfe = tail call %struct.Memory* @sub_400ea0._Z5timerv(%struct.State* nonnull %0, i64 %269, %struct.Memory* %call2_406c83)
