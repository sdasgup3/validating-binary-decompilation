...
block_.L_406c4f:                                  ; preds = %block_.L_406ca7, %entry
  %69 = phi i64 [ %.pre, %entry ], [ %270, %block_.L_406ca7 ]
...
block_.L_406c6c:                                  ; preds = %block_406c78, %block_406c5f
  %112 = phi i64 [ %.pre1, %block_406c5f ], [ %227, %block_406c78 ]
...
block_.L_406ca7:                                  ; preds = %block_.L_406c6c
  ...
  %call2_406cab = tail call %struct.Memory* @sub_414eb0._Z17check_shifted_sumIt25custom_multiply_constantsItEEvT_(%struct.State* %0, i64 %233, %struct.Memory* %MEMORY.1)
...
block_.L_406cbe:                                  ; preds = %block_.L_406c4f
  ...
  %call2_406cbe = tail call %struct.Memory* @sub_400e60._Z5timerv(%struct.State* %0, i64 %271, %struct.Memory* %MEMORY.0)
  ...
  %call2_406cc7 = tail call %struct.Memory* @sub_400800._Z13record_resultdPKc(%struct.State* %0, i64 %282, %struct.Memory* %call2_406cbe)
