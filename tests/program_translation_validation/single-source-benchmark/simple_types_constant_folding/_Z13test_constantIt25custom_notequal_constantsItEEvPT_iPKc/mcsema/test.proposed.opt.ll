...
declare %struct.Memory* @sub_414c90._ZN25custom_notequal_constantsItE8do_shiftEt(%struct.State* noalias dereferenceable(3376), i64, %struct.Memory* noalias readnone returned) local_unnamed_addr

declare %struct.Memory* @sub_414cb0._Z17check_shifted_sumIt25custom_notequal_constantsItEEvT_(%struct.State* noalias dereferenceable(3376), i64, %struct.Memory* noalias readnone returned) local_unnamed_addr
...
block_.L_406f4f:                                  ; preds = %block_.L_406fa7, %entry
  %69 = phi i64 [ %268, %block_.L_406fa7 ], [ %.pre, %entry ]
...
block_.L_406f6c:                                  ; preds = %block_406f78, %block_406f5f
  %112 = phi i64 [ %226, %block_406f78 ], [ %.pre6, %block_406f5f ]
...
block_406f78:                                     ; preds = %block_.L_406f6c
  ...
  %call2_406f84 = tail call %struct.Memory* @sub_414c90._ZN25custom_notequal_constantsItE8do_shiftEt(%struct.State* nonnull %0, i64 %163, %struct.Memory* %call2_406f43)
...
block_.L_406fa7:                                  ; preds = %block_.L_406f6c
  ...
  %call2_406fab = tail call %struct.Memory* @sub_414cb0._Z17check_shifted_sumIt25custom_notequal_constantsItEEvT_(%struct.State* nonnull %0, i64 %232, %struct.Memory* %call2_406f43)
...
block_.L_406fbe:                                  ; preds = %block_.L_406f4f
  ...
  %call2_406fbe = tail call %struct.Memory* @sub_400ea0._Z5timerv(%struct.State* nonnull %0, i64 %269, %struct.Memory* %call2_406f43)
