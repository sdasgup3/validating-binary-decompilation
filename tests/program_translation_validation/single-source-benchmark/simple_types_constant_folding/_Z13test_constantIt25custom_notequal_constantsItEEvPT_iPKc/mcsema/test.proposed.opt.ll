...
block_.L_406f0f:                                  ; preds = %block_.L_406f67, %entry
  %69 = phi i64 [ %.pre, %entry ], [ %270, %block_.L_406f67 ]
...
block_.L_406f2c:                                  ; preds = %block_406f38, %block_406f1f
  %112 = phi i64 [ %.pre1, %block_406f1f ], [ %227, %block_406f38 ]
...
block_.L_406f67:                                  ; preds = %block_.L_406f2c
  ...
  %call2_406f6b = tail call %struct.Memory* @sub_414c70._Z17check_shifted_sumIt25custom_notequal_constantsItEEvT_(%struct.State* %0, i64 %233, %struct.Memory* %MEMORY.1)
...
block_.L_406f7e:                                  ; preds = %block_.L_406f0f
  ...
  %call2_406f7e = tail call %struct.Memory* @sub_400e60._Z5timerv(%struct.State* %0, i64 %271, %struct.Memory* %MEMORY.0)
  ...
  %call2_406f87 = tail call %struct.Memory* @sub_400800._Z13record_resultdPKc(%struct.State* %0, i64 %282, %struct.Memory* %call2_406f7e)
