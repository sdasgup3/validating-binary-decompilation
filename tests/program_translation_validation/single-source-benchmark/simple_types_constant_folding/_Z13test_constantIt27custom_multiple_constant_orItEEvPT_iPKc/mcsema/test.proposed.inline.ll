...
define %struct.Memory* @_Z13test_constantIt27custom_multiple_constant_orItEEvPT_iPKc(%struct.State* noalias, i64, %struct.Memory* noalias) #2 {
entry:
  ...
  store %struct.Memory* %loadMem_407e51, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_407e54, %struct.Memory** %MEMORY
  ...
  store i64 %78, i64* %81
  store %struct.Memory* %loadMem_407e58, %struct.Memory** %MEMORY
  ...
  store i32 %93, i32* %97
  store %struct.Memory* %loadMem_407e5c, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem1_407e63, %struct.Memory** %MEMORY
...
block_.L_407e6f:                                  ; preds = %block_.L_407ec7, %entry
  ...
  store %struct.Memory* %loadMem_407e6f, %struct.Memory** %MEMORY
...
block_407e7f:                                     ; preds = %block_.L_407e6f
  ...
  store i16 0, i16* %225
  store %struct.Memory* %loadMem_407e7f, %struct.Memory** %MEMORY
...
block_.L_407e8c:                                  ; preds = %block_407e98, %block_407e7f
  ...
  store %struct.Memory* %loadMem_407e8c, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_407e8f, %struct.Memory** %MEMORY
...
block_407e98:                                     ; preds = %block_.L_407e8c
  ...
  store %struct.Memory* %loadMem_407e98, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem1_407ea4, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_407ea9, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_407eb2, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_407eb5, %struct.Memory** %MEMORY
...
block_.L_407ec7:                                  ; preds = %block_.L_407e8c
  ...
  store %struct.Memory* %loadMem_407ec7, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem1_407ecb, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_407ed0, %struct.Memory** %MEMORY
...
block_.L_407ede:                                  ; preds = %block_.L_407e6f
  ...
  store %struct.Memory* %loadMem1_407ede, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem1_407ee7, %struct.Memory** %MEMORY
  ...
  ret %struct.Memory* %loadMem_407ef1
}
