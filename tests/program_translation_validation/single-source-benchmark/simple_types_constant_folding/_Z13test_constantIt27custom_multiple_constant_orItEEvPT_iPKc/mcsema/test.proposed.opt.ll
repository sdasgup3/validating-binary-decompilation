...
declare %struct.Memory* @sub_413fc0._ZN27custom_multiple_constant_orItE8do_shiftEt(%struct.State* dereferenceable(3376), i64, %struct.Memory*) local_unnamed_addr

declare %struct.Memory* @sub_413ff0._Z17check_shifted_sumIt27custom_multiple_constant_orItEEvT_(%struct.State* dereferenceable(3376), i64, %struct.Memory*) local_unnamed_addr
...
block_.L_407e6f:                                  ; preds = %block_.L_407ec7, %entry
  %69 = phi i64 [ %.pre, %entry ], [ %268, %block_.L_407ec7 ]
  %MEMORY.0 = phi %struct.Memory* [ %call2_407e63, %entry ], [ %call2_407ecb, %block_.L_407ec7 ]
...
block_.L_407e8c:                                  ; preds = %block_407e98, %block_407e7f
  %112 = phi i64 [ %.pre6, %block_407e7f ], [ %226, %block_407e98 ]
  %MEMORY.1 = phi %struct.Memory* [ %MEMORY.0, %block_407e7f ], [ %call2_407ea4, %block_407e98 ]
...
block_407e98:                                     ; preds = %block_.L_407e8c
  ...
  %call2_407ea4 = tail call %struct.Memory* @sub_413fc0._ZN27custom_multiple_constant_orItE8do_shiftEt(%struct.State* nonnull %0, i64 %163, %struct.Memory* %MEMORY.1)
...
block_.L_407ec7:                                  ; preds = %block_.L_407e8c
  ...
  %call2_407ecb = tail call %struct.Memory* @sub_413ff0._Z17check_shifted_sumIt27custom_multiple_constant_orItEEvT_(%struct.State* nonnull %0, i64 %232, %struct.Memory* %MEMORY.1)
...
block_.L_407ede:                                  ; preds = %block_.L_407e6f
  ...
  %call2_407ede = tail call %struct.Memory* @sub_400ea0._Z5timerv(%struct.State* nonnull %0, i64 %269, %struct.Memory* %MEMORY.0)
