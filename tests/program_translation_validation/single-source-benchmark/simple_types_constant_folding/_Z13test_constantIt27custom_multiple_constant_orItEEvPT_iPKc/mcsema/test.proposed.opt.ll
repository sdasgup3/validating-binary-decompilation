...
block_.L_407e2f:                                  ; preds = %block_.L_407e87, %entry
  %69 = phi i64 [ %.pre, %entry ], [ %268, %block_.L_407e87 ]
...
block_.L_407e4c:                                  ; preds = %block_407e58, %block_407e3f
  %112 = phi i64 [ %.pre1, %block_407e3f ], [ %226, %block_407e58 ]
...
block_.L_407e87:                                  ; preds = %block_.L_407e4c
  ...
  %call2_407e8b = tail call %struct.Memory* @sub_413fb0._Z17check_shifted_sumIt27custom_multiple_constant_orItEEvT_(%struct.State* %0, i64 %232, %struct.Memory* %MEMORY.1)
...
block_.L_407e9e:                                  ; preds = %block_.L_407e2f
  ...
  %call2_407e9e = tail call %struct.Memory* @sub_400e60._Z5timerv(%struct.State* %0, i64 %269, %struct.Memory* %MEMORY.0)
  ...
  %call2_407ea7 = tail call %struct.Memory* @sub_400800._Z13record_resultdPKc(%struct.State* %0, i64 %280, %struct.Memory* %call2_407e9e)
