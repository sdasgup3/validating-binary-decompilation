...
block_.L_406fbf:                                  ; preds = %block_.L_407017, %entry
  %69 = phi i64 [ %.pre, %entry ], [ %268, %block_.L_407017 ]
...
block_.L_406fdc:                                  ; preds = %block_406fe8, %block_406fcf
  %112 = phi i64 [ %.pre1, %block_406fcf ], [ %226, %block_406fe8 ]
...
block_.L_407017:                                  ; preds = %block_.L_406fdc
  ...
  %call2_40701b = tail call %struct.Memory* @sub_414be0._Z17check_shifted_sumIt28custom_greaterthan_constantsItEEvT_(%struct.State* %0, i64 %232, %struct.Memory* %MEMORY.1)
...
block_.L_40702e:                                  ; preds = %block_.L_406fbf
  ...
  %call2_40702e = tail call %struct.Memory* @sub_400e60._Z5timerv(%struct.State* %0, i64 %269, %struct.Memory* %MEMORY.0)
  ...
  %call2_407037 = tail call %struct.Memory* @sub_400800._Z13record_resultdPKc(%struct.State* %0, i64 %280, %struct.Memory* %call2_40702e)
