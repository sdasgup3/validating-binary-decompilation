...
declare %struct.Memory* @sub_414c20._Z17check_shifted_sumIt28custom_greaterthan_constantsItEEvT_(%struct.State* noalias dereferenceable(3376), i64, %struct.Memory* noalias readnone returned) local_unnamed_addr
...
define %struct.Memory* @_Z13test_constantIt28custom_greaterthan_constantsItEEvPT_iPKc(%struct.State* noalias, i64, %struct.Memory* noalias readnone) local_unnamed_addr #1 {
entry:
...
block_.L_406fff:                                  ; preds = %block_.L_407057, %entry
  %69 = phi i64 [ %268, %block_.L_407057 ], [ %.pre, %entry ]
...
block_.L_40701c:                                  ; preds = %block_407028, %block_40700f
  %112 = phi i64 [ %226, %block_407028 ], [ %.pre6, %block_40700f ]
...
block_407028:                                     ; preds = %block_.L_40701c
  ...
  %call2_407034 = tail call %struct.Memory* @sub_414c00._ZN28custom_greaterthan_constantsItE8do_shiftEt(%struct.State* nonnull %0, i64 %163, %struct.Memory* %call2_406ff3)
...
block_.L_407057:                                  ; preds = %block_.L_40701c
  ...
  %call2_40705b = tail call %struct.Memory* @sub_414c20._Z17check_shifted_sumIt28custom_greaterthan_constantsItEEvT_(%struct.State* nonnull %0, i64 %232, %struct.Memory* %call2_406ff3)
...
block_.L_40706e:                                  ; preds = %block_.L_406fff
  ...
  %call2_40706e = tail call %struct.Memory* @sub_400ea0._Z5timerv(%struct.State* nonnull %0, i64 %269, %struct.Memory* %call2_406ff3)
