...
declare %struct.Memory* @sub_414c30._Z17check_shifted_sumIt28custom_greaterthan_constantsItEEvT_(%struct.State* noalias dereferenceable(3376), i64, %struct.Memory* noalias readnone returned) local_unnamed_addr
...
entry:
  ...
  %call2_407003 = tail call %struct.Memory* @sub_400e90._Z11start_timerv(%struct.State* %0, i64 %58, %struct.Memory* %2)
...
block_.L_40700f:                                  ; preds = %block_.L_407067, %entry
  %69 = phi i64 [ %268, %block_.L_407067 ], [ %.pre, %entry ]
  ...
  br i1 %102, label %block_40701f, label %block_.L_40707e

block_40701f:                                     ; preds = %block_.L_40700f
  %104 = add i64 %70, -30
  %105 = add i64 %103, 6
...
block_.L_40702c:                                  ; preds = %block_407038, %block_40701f
  %112 = phi i64 [ %226, %block_407038 ], [ %.pre6, %block_40701f ]
  ...
  br i1 %148, label %block_407038, label %block_.L_407067

block_407038:                                     ; preds = %block_.L_40702c
  %150 = add i64 %113, -8
  %151 = add i64 %149, 4
  ...
  %call2_407044 = tail call %struct.Memory* @sub_414c10._ZN28custom_greaterthan_constantsItE8do_shiftEt(%struct.State* nonnull %0, i64 %163, %struct.Memory* %call2_407003)
...
block_.L_407067:                                  ; preds = %block_.L_40702c
  %227 = add i64 %113, -30
  %228 = add i64 %149, 4
  ...
  %call2_40706b = tail call %struct.Memory* @sub_414c30._Z17check_shifted_sumIt28custom_greaterthan_constantsItEEvT_(%struct.State* nonnull %0, i64 %232, %struct.Memory* %call2_407003)
...
block_.L_40707e:                                  ; preds = %block_.L_40700f
  ...
  %call2_40707e = tail call %struct.Memory* @sub_400eb0._Z5timerv(%struct.State* nonnull %0, i64 %269, %struct.Memory* %call2_407003)
  ...
  %call2_407087 = tail call %struct.Memory* @sub_400850._Z13record_resultdPKc(%struct.State* nonnull %0, i64 %280, %struct.Memory* %call2_40707e)
