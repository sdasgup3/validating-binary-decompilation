...
block_.L_40753f:                                  ; preds = %block_.L_407597, %entry
  %69 = phi i64 [ %.pre, %entry ], [ %268, %block_.L_407597 ]
...
block_.L_40755c:                                  ; preds = %block_407568, %block_40754f
  %112 = phi i64 [ %.pre1, %block_40754f ], [ %226, %block_407568 ]
...
block_.L_407597:                                  ; preds = %block_.L_40755c
  ...
  %call2_40759b = tail call %struct.Memory* @sub_414760._Z17check_shifted_sumIt28custom_multiple_constant_addItEEvT_(%struct.State* %0, i64 %232, %struct.Memory* %MEMORY.1)
...
block_.L_4075ae:                                  ; preds = %block_.L_40753f
  ...
  %call2_4075ae = tail call %struct.Memory* @sub_400e60._Z5timerv(%struct.State* %0, i64 %269, %struct.Memory* %MEMORY.0)
  ...
  store i64 %279, i64* %RDI.i76, align 8
  %280 = add i64 %276, -28083
  %281 = add i64 %276, 9
  ...
  %call2_4075b7 = tail call %struct.Memory* @sub_400800._Z13record_resultdPKc(%struct.State* %0, i64 %280, %struct.Memory* %call2_4075ae)
  %285 = load i64, i64* %6, align 8
  %286 = load i64, i64* %3, align 8
  %287 = add i64 %285, 48
  store i64 %287, i64* %6, align 8
  %288 = icmp ugt i64 %285, -49
  ...
  %311 = add i64 %285, 56
  %312 = inttoptr i64 %287 to i64*
  %313 = load i64, i64* %312, align 8
  store i64 %313, i64* %RBP.i, align 8
