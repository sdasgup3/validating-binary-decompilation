...
declare %struct.Memory* @sub_414770._ZN28custom_multiple_constant_addItE8do_shiftEt(%struct.State* dereferenceable(3376), i64, %struct.Memory*) local_unnamed_addr

declare %struct.Memory* @sub_4147a0._Z17check_shifted_sumIt28custom_multiple_constant_addItEEvT_(%struct.State* dereferenceable(3376), i64, %struct.Memory*) local_unnamed_addr
...
block_.L_40757f:                                  ; preds = %block_.L_4075d7, %entry
  %69 = phi i64 [ %.pre, %entry ], [ %268, %block_.L_4075d7 ]
  %MEMORY.0 = phi %struct.Memory* [ %call2_407573, %entry ], [ %call2_4075db, %block_.L_4075d7 ]
...
block_.L_40759c:                                  ; preds = %block_4075a8, %block_40758f
  %112 = phi i64 [ %.pre6, %block_40758f ], [ %226, %block_4075a8 ]
  %MEMORY.1 = phi %struct.Memory* [ %MEMORY.0, %block_40758f ], [ %call2_4075b4, %block_4075a8 ]
...
block_4075a8:                                     ; preds = %block_.L_40759c
  ...
  %call2_4075b4 = tail call %struct.Memory* @sub_414770._ZN28custom_multiple_constant_addItE8do_shiftEt(%struct.State* nonnull %0, i64 %163, %struct.Memory* %MEMORY.1)
...
block_.L_4075d7:                                  ; preds = %block_.L_40759c
  ...
  %call2_4075db = tail call %struct.Memory* @sub_4147a0._Z17check_shifted_sumIt28custom_multiple_constant_addItEEvT_(%struct.State* nonnull %0, i64 %232, %struct.Memory* %MEMORY.1)
...
block_.L_4075ee:                                  ; preds = %block_.L_40757f
  ...
  %call2_4075ee = tail call %struct.Memory* @sub_400ea0._Z5timerv(%struct.State* nonnull %0, i64 %269, %struct.Memory* %MEMORY.0)
