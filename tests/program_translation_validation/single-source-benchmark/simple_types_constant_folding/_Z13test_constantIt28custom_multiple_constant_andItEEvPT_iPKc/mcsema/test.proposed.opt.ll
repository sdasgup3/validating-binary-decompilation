...
block_.L_407ccf:                                  ; preds = %block_.L_407d27, %entry
  %69 = phi i64 [ %.pre, %entry ], [ %268, %block_.L_407d27 ]
...
block_.L_407cec:                                  ; preds = %block_407cf8, %block_407cdf
  %112 = phi i64 [ %.pre1, %block_407cdf ], [ %226, %block_407cf8 ]
...
block_.L_407d27:                                  ; preds = %block_.L_407cec
  ...
  %call2_407d2b = tail call %struct.Memory* @sub_4140e0._Z17check_shifted_sumIt28custom_multiple_constant_andItEEvT_(%struct.State* %0, i64 %232, %struct.Memory* %MEMORY.1)
...
block_.L_407d3e:                                  ; preds = %block_.L_407ccf
  ...
  %call2_407d3e = tail call %struct.Memory* @sub_400e60._Z5timerv(%struct.State* %0, i64 %269, %struct.Memory* %MEMORY.0)
  ...
  %call2_407d47 = tail call %struct.Memory* @sub_400800._Z13record_resultdPKc(%struct.State* %0, i64 %280, %struct.Memory* %call2_407d3e)
