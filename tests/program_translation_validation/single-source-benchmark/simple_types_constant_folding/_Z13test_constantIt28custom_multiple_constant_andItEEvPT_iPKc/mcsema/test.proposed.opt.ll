...
declare %struct.Memory* @sub_4140f0._ZN28custom_multiple_constant_andItE8do_shiftEt(%struct.State* noalias dereferenceable(3376), i64, %struct.Memory* noalias readnone returned) local_unnamed_addr

declare %struct.Memory* @sub_414120._Z17check_shifted_sumIt28custom_multiple_constant_andItEEvT_(%struct.State* noalias dereferenceable(3376), i64, %struct.Memory* noalias readnone returned) local_unnamed_addr
...
block_.L_407d0f:                                  ; preds = %block_.L_407d67, %entry
  %69 = phi i64 [ %268, %block_.L_407d67 ], [ %.pre, %entry ]
...
block_.L_407d2c:                                  ; preds = %block_407d38, %block_407d1f
  %112 = phi i64 [ %226, %block_407d38 ], [ %.pre6, %block_407d1f ]
...
block_407d38:                                     ; preds = %block_.L_407d2c
  ...
  %call2_407d44 = tail call %struct.Memory* @sub_4140f0._ZN28custom_multiple_constant_andItE8do_shiftEt(%struct.State* nonnull %0, i64 %163, %struct.Memory* %call2_407d03)
...
block_.L_407d67:                                  ; preds = %block_.L_407d2c
  ...
  %call2_407d6b = tail call %struct.Memory* @sub_414120._Z17check_shifted_sumIt28custom_multiple_constant_andItEEvT_(%struct.State* nonnull %0, i64 %232, %struct.Memory* %call2_407d03)
...
block_.L_407d7e:                                  ; preds = %block_.L_407d0f
  ...
  %call2_407d7e = tail call %struct.Memory* @sub_400ea0._Z5timerv(%struct.State* nonnull %0, i64 %269, %struct.Memory* %call2_407d03)
