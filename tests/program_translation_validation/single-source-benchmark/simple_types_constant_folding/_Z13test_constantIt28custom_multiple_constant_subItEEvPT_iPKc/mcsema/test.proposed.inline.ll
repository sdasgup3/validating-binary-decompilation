...
define %struct.Memory* @_Z13test_constantIt28custom_multiple_constant_subItEEvPT_iPKc(%struct.State* noalias, i64, %struct.Memory* noalias) #1 {
entry:
  ...
  store %struct.Memory* %loadMem_4076c0, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem1_4076d3, %struct.Memory** %MEMORY
...
block_.L_4076df:                                  ; preds = %block_.L_407737, %entry
...
block_4076ef:                                     ; preds = %block_.L_4076df
  ...
  store i32 0, i32* %236
  store %struct.Memory* %loadMem_4076f5, %struct.Memory** %MEMORY
  br label %block_.L_4076fc

block_.L_4076fc:                                  ; preds = %block_407708, %block_4076ef
...
block_407708:                                     ; preds = %block_.L_4076fc
  ...
  store %struct.Memory* %loadMem1_407714, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_407719, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_407725, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_40772f, %struct.Memory** %MEMORY
...
block_.L_407737:                                  ; preds = %block_.L_4076fc
  ...
  store %struct.Memory* %loadMem_407737, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem1_40773b, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_407743, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_407746, %struct.Memory** %MEMORY
...
block_.L_40774e:                                  ; preds = %block_.L_4076df
  ...
  store %struct.Memory* %loadMem1_40774e, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem1_407757, %struct.Memory** %MEMORY
  ...
  ret %struct.Memory* %loadMem_407761
}
