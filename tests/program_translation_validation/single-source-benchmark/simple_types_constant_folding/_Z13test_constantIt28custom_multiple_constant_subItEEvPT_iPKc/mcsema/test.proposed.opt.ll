...
block_.L_40769f:                                  ; preds = %block_.L_4076f7, %entry
  %69 = phi i64 [ %.pre, %entry ], [ %270, %block_.L_4076f7 ]
...
block_.L_4076bc:                                  ; preds = %block_4076c8, %block_4076af
  %112 = phi i64 [ %.pre1, %block_4076af ], [ %227, %block_4076c8 ]
...
block_.L_4076f7:                                  ; preds = %block_.L_4076bc
  ...
  %call2_4076fb = tail call %struct.Memory* @sub_414630._Z17check_shifted_sumIt28custom_multiple_constant_subItEEvT_(%struct.State* %0, i64 %233, %struct.Memory* %MEMORY.1)
...
block_.L_40770e:                                  ; preds = %block_.L_40769f
  ...
  %call2_40770e = tail call %struct.Memory* @sub_400e60._Z5timerv(%struct.State* %0, i64 %271, %struct.Memory* %MEMORY.0)
  ...
  %call2_407717 = tail call %struct.Memory* @sub_400800._Z13record_resultdPKc(%struct.State* %0, i64 %282, %struct.Memory* %call2_40770e)
