...
block_.L_407f8f:                                  ; preds = %block_.L_407fe7, %entry
  %69 = phi i64 [ %.pre, %entry ], [ %270, %block_.L_407fe7 ]
...
block_.L_407fac:                                  ; preds = %block_407fb8, %block_407f9f
  %112 = phi i64 [ %.pre1, %block_407f9f ], [ %227, %block_407fb8 ]
...
block_.L_407fe7:                                  ; preds = %block_.L_407fac
  ...
  %call2_407feb = tail call %struct.Memory* @sub_413e20._Z17check_shifted_sumIt28custom_multiple_constant_xorItEEvT_(%struct.State* %0, i64 %233, %struct.Memory* %MEMORY.1)
...
block_.L_407ffe:                                  ; preds = %block_.L_407f8f
  ...
  %call2_407ffe = tail call %struct.Memory* @sub_400e60._Z5timerv(%struct.State* %0, i64 %271, %struct.Memory* %MEMORY.0)
  ...
  %call2_408007 = tail call %struct.Memory* @sub_400800._Z13record_resultdPKc(%struct.State* %0, i64 %282, %struct.Memory* %call2_407ffe)
