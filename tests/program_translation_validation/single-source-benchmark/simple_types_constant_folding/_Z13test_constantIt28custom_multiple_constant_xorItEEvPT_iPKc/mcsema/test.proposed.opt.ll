...
declare %struct.Memory* @sub_413e30._ZN28custom_multiple_constant_xorItE8do_shiftEt(%struct.State* noalias dereferenceable(3376), i64, %struct.Memory* noalias readnone returned) local_unnamed_addr

declare %struct.Memory* @sub_413e60._Z17check_shifted_sumIt28custom_multiple_constant_xorItEEvT_(%struct.State* noalias dereferenceable(3376), i64, %struct.Memory* noalias readnone returned) local_unnamed_addr
...
define %struct.Memory* @_Z13test_constantIt28custom_multiple_constant_xorItEEvPT_iPKc(%struct.State* noalias, i64, %struct.Memory* noalias readnone) local_unnamed_addr #1 {
entry:
...
block_.L_407fcf:                                  ; preds = %block_.L_408027, %entry
  %69 = phi i64 [ %268, %block_.L_408027 ], [ %.pre, %entry ]
...
block_.L_407fec:                                  ; preds = %block_407ff8, %block_407fdf
  %112 = phi i64 [ %226, %block_407ff8 ], [ %.pre6, %block_407fdf ]
...
block_407ff8:                                     ; preds = %block_.L_407fec
  ...
  %call2_408004 = tail call %struct.Memory* @sub_413e30._ZN28custom_multiple_constant_xorItE8do_shiftEt(%struct.State* nonnull %0, i64 %163, %struct.Memory* %call2_407fc3)
...
block_.L_408027:                                  ; preds = %block_.L_407fec
  ...
  %call2_40802b = tail call %struct.Memory* @sub_413e60._Z17check_shifted_sumIt28custom_multiple_constant_xorItEEvT_(%struct.State* nonnull %0, i64 %232, %struct.Memory* %call2_407fc3)
...
block_.L_40803e:                                  ; preds = %block_.L_407fcf
  ...
  %call2_40803e = tail call %struct.Memory* @sub_400ea0._Z5timerv(%struct.State* nonnull %0, i64 %269, %struct.Memory* %call2_407fc3)
