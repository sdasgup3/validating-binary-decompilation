...
declare %struct.Memory* @sub_414a50._ZN30custom_lessthanequal_constantsItE8do_shiftEt(%struct.State* noalias dereferenceable(3376), i64, %struct.Memory* noalias readnone returned) local_unnamed_addr

declare %struct.Memory* @sub_414a70._Z17check_shifted_sumIt30custom_lessthanequal_constantsItEEvT_(%struct.State* noalias dereferenceable(3376), i64, %struct.Memory* noalias readnone returned) local_unnamed_addr
...
define %struct.Memory* @_Z13test_constantIt30custom_lessthanequal_constantsItEEvPT_iPKc(%struct.State* noalias, i64, %struct.Memory* noalias readnone) local_unnamed_addr #1 {
entry:
...
block_.L_40720f:                                  ; preds = %block_.L_407267, %entry
  %69 = phi i64 [ %268, %block_.L_407267 ], [ %.pre, %entry ]
...
block_.L_40722c:                                  ; preds = %block_407238, %block_40721f
  %112 = phi i64 [ %226, %block_407238 ], [ %.pre6, %block_40721f ]
...
block_407238:                                     ; preds = %block_.L_40722c
  ...
  %call2_407244 = tail call %struct.Memory* @sub_414a50._ZN30custom_lessthanequal_constantsItE8do_shiftEt(%struct.State* nonnull %0, i64 %163, %struct.Memory* %call2_407203)
...
block_.L_407267:                                  ; preds = %block_.L_40722c
  ...
  %call2_40726b = tail call %struct.Memory* @sub_414a70._Z17check_shifted_sumIt30custom_lessthanequal_constantsItEEvT_(%struct.State* nonnull %0, i64 %232, %struct.Memory* %call2_407203)
...
block_.L_40727e:                                  ; preds = %block_.L_40720f
  ...
  %call2_40727e = tail call %struct.Memory* @sub_400ea0._Z5timerv(%struct.State* nonnull %0, i64 %269, %struct.Memory* %call2_407203)
