...
block_.L_4071cf:                                  ; preds = %block_.L_407227, %entry
  %69 = phi i64 [ %.pre, %entry ], [ %270, %block_.L_407227 ]
...
block_.L_4071ec:                                  ; preds = %block_4071f8, %block_4071df
  %112 = phi i64 [ %.pre1, %block_4071df ], [ %227, %block_4071f8 ]
...
block_.L_407227:                                  ; preds = %block_.L_4071ec
  ...
  %call2_40722b = tail call %struct.Memory* @sub_414a30._Z17check_shifted_sumIt30custom_lessthanequal_constantsItEEvT_(%struct.State* %0, i64 %233, %struct.Memory* %MEMORY.1)
...
block_.L_40723e:                                  ; preds = %block_.L_4071cf
  ...
  %call2_40723e = tail call %struct.Memory* @sub_400e60._Z5timerv(%struct.State* %0, i64 %271, %struct.Memory* %MEMORY.0)
  ...
  %call2_407247 = tail call %struct.Memory* @sub_400800._Z13record_resultdPKc(%struct.State* %0, i64 %282, %struct.Memory* %call2_40723e)
