...
declare %struct.Memory* @sub_414a80._Z17check_shifted_sumIt30custom_lessthanequal_constantsItEEvT_(%struct.State* noalias dereferenceable(3376), i64, %struct.Memory* noalias readnone returned) local_unnamed_addr
...
entry:
  ...
  %call2_407213 = tail call %struct.Memory* @sub_400e90._Z11start_timerv(%struct.State* %0, i64 %58, %struct.Memory* %2)
...
block_.L_40721f:                                  ; preds = %block_.L_407277, %entry
  %69 = phi i64 [ %268, %block_.L_407277 ], [ %.pre, %entry ]
  ...
  br i1 %102, label %block_40722f, label %block_.L_40728e
...
block_.L_40723c:                                  ; preds = %block_407248, %block_40722f
  %112 = phi i64 [ %226, %block_407248 ], [ %.pre6, %block_40722f ]
  ...
  br i1 %148, label %block_407248, label %block_.L_407277
...
block_407248:                                     ; preds = %block_.L_40723c
  ...
  %call2_407254 = tail call %struct.Memory* @sub_414a60._ZN30custom_lessthanequal_constantsItE8do_shiftEt(%struct.State* nonnull %0, i64 %163, %struct.Memory* %call2_407213)
...
block_.L_407277:                                  ; preds = %block_.L_40723c
  ...
  %call2_40727b = tail call %struct.Memory* @sub_414a80._Z17check_shifted_sumIt30custom_lessthanequal_constantsItEEvT_(%struct.State* nonnull %0, i64 %232, %struct.Memory* %call2_407213)
...
block_.L_40728e:                                  ; preds = %block_.L_40721f
  ...
  %call2_40728e = tail call %struct.Memory* @sub_400eb0._Z5timerv(%struct.State* nonnull %0, i64 %269, %struct.Memory* %call2_407213)
  ...
  %call2_407297 = tail call %struct.Memory* @sub_400850._Z13record_resultdPKc(%struct.State* nonnull %0, i64 %280, %struct.Memory* %call2_40728e)
