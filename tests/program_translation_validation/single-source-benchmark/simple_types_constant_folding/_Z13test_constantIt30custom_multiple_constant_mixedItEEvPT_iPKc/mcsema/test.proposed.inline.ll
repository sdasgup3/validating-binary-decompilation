...
declare %struct.Memory* @sub_414240._Z17check_shifted_sumIt30custom_multiple_constant_mixedItEEvT_(%struct.State* dereferenceable(3376), i64, %struct.Memory*)
...
define %struct.Memory* @_Z13test_constantIt30custom_multiple_constant_mixedItEEvPT_iPKc(%struct.State* noalias, i64, %struct.Memory* noalias) #1 {
entry:
