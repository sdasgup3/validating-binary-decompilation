...
block_.L_407b6f:                                  ; preds = %block_.L_407bc7, %entry
  %69 = phi i64 [ %.pre, %entry ], [ %268, %block_.L_407bc7 ]
...
block_.L_407b8c:                                  ; preds = %block_407b98, %block_407b7f
  %112 = phi i64 [ %.pre1, %block_407b7f ], [ %226, %block_407b98 ]
...
block_.L_407bc7:                                  ; preds = %block_.L_407b8c
  ...
  %call2_407bcb = tail call %struct.Memory* @sub_414200._Z17check_shifted_sumIt30custom_multiple_constant_mixedItEEvT_(%struct.State* %0, i64 %232, %struct.Memory* %MEMORY.1)
...
block_.L_407bde:                                  ; preds = %block_.L_407b6f
  ...
  %call2_407bde = tail call %struct.Memory* @sub_400e60._Z5timerv(%struct.State* %0, i64 %269, %struct.Memory* %MEMORY.0)
  ...
  %call2_407be7 = tail call %struct.Memory* @sub_400800._Z13record_resultdPKc(%struct.State* %0, i64 %280, %struct.Memory* %call2_407bde)
