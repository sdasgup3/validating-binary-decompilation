...
declare %struct.Memory* @sub_414240._Z17check_shifted_sumIt30custom_multiple_constant_mixedItEEvT_(%struct.State* noalias dereferenceable(3376), i64, %struct.Memory* noalias readnone returned) local_unnamed_addr
...
define %struct.Memory* @_Z13test_constantIt30custom_multiple_constant_mixedItEEvPT_iPKc(%struct.State* noalias, i64, %struct.Memory* noalias readnone) local_unnamed_addr #1 {
entry:
...
block_.L_407baf:                                  ; preds = %block_.L_407c07, %entry
  %69 = phi i64 [ %268, %block_.L_407c07 ], [ %.pre, %entry ]
...
block_.L_407bcc:                                  ; preds = %block_407bd8, %block_407bbf
  %112 = phi i64 [ %226, %block_407bd8 ], [ %.pre6, %block_407bbf ]
...
block_407bd8:                                     ; preds = %block_.L_407bcc
  ...
  %call2_407be4 = tail call %struct.Memory* @sub_414220._ZN30custom_multiple_constant_mixedItE8do_shiftEt(%struct.State* nonnull %0, i64 %163, %struct.Memory* %call2_407ba3)
...
block_.L_407c07:                                  ; preds = %block_.L_407bcc
  ...
  %call2_407c0b = tail call %struct.Memory* @sub_414240._Z17check_shifted_sumIt30custom_multiple_constant_mixedItEEvT_(%struct.State* nonnull %0, i64 %232, %struct.Memory* %call2_407ba3)
...
block_.L_407c1e:                                  ; preds = %block_.L_407baf
  ...
  %call2_407c1e = tail call %struct.Memory* @sub_400ea0._Z5timerv(%struct.State* nonnull %0, i64 %269, %struct.Memory* %call2_407ba3)
