...
declare %struct.Memory* @sub_414250._Z17check_shifted_sumIt30custom_multiple_constant_mixedItEEvT_(%struct.State* noalias dereferenceable(3376), i64, %struct.Memory* noalias readnone returned) local_unnamed_addr
...
entry:
  ...
  %call2_407bb3 = tail call %struct.Memory* @sub_400e90._Z11start_timerv(%struct.State* %0, i64 %58, %struct.Memory* %2)
...
block_.L_407bbf:                                  ; preds = %block_.L_407c17, %entry
  %69 = phi i64 [ %268, %block_.L_407c17 ], [ %.pre, %entry ]
  ...
  br i1 %102, label %block_407bcf, label %block_.L_407c2e
...
block_.L_407bdc:                                  ; preds = %block_407be8, %block_407bcf
  %112 = phi i64 [ %226, %block_407be8 ], [ %.pre6, %block_407bcf ]
  ...
  br i1 %148, label %block_407be8, label %block_.L_407c17
...
block_407be8:                                     ; preds = %block_.L_407bdc
  ...
  %call2_407bf4 = tail call %struct.Memory* @sub_414230._ZN30custom_multiple_constant_mixedItE8do_shiftEt(%struct.State* nonnull %0, i64 %163, %struct.Memory* %call2_407bb3)
...
block_.L_407c17:                                  ; preds = %block_.L_407bdc
  ...
  %call2_407c1b = tail call %struct.Memory* @sub_414250._Z17check_shifted_sumIt30custom_multiple_constant_mixedItEEvT_(%struct.State* nonnull %0, i64 %232, %struct.Memory* %call2_407bb3)
...
block_.L_407c2e:                                  ; preds = %block_.L_407bbf
  ...
  %call2_407c2e = tail call %struct.Memory* @sub_400eb0._Z5timerv(%struct.State* nonnull %0, i64 %269, %struct.Memory* %call2_407bb3)
  ...
  %call2_407c37 = tail call %struct.Memory* @sub_400850._Z13record_resultdPKc(%struct.State* nonnull %0, i64 %280, %struct.Memory* %call2_407c2e)
