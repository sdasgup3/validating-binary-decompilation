...
declare %struct.Memory* @sub_414340._ZN31custom_multiple_constant_divideItE8do_shiftEt(%struct.State* dereferenceable(3376), i64, %struct.Memory*)

declare %struct.Memory* @sub_414380._Z17check_shifted_sumIt31custom_multiple_constant_divideItEEvT_(%struct.State* dereferenceable(3376), i64, %struct.Memory*)
...
define %struct.Memory* @_Z13test_constantIt31custom_multiple_constant_divideItEEvPT_iPKc(%struct.State* noalias, i64, %struct.Memory* noalias) #1 {
entry:
