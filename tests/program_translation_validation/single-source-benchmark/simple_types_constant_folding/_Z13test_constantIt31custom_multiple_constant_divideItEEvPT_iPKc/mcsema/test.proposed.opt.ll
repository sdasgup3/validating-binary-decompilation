...
declare %struct.Memory* @sub_414340._ZN31custom_multiple_constant_divideItE8do_shiftEt(%struct.State* noalias dereferenceable(3376), i64, %struct.Memory* noalias readnone returned) local_unnamed_addr

declare %struct.Memory* @sub_414380._Z17check_shifted_sumIt31custom_multiple_constant_divideItEEvT_(%struct.State* noalias dereferenceable(3376), i64, %struct.Memory* noalias readnone returned) local_unnamed_addr
...
define %struct.Memory* @_Z13test_constantIt31custom_multiple_constant_divideItEEvPT_iPKc(%struct.State* noalias, i64, %struct.Memory* noalias readnone) local_unnamed_addr #1 {
entry:
...
block_.L_407a4f:                                  ; preds = %block_.L_407aa7, %entry
  %69 = phi i64 [ %268, %block_.L_407aa7 ], [ %.pre, %entry ]
...
block_.L_407a6c:                                  ; preds = %block_407a78, %block_407a5f
  %112 = phi i64 [ %226, %block_407a78 ], [ %.pre6, %block_407a5f ]
...
block_407a78:                                     ; preds = %block_.L_407a6c
  ...
  %call2_407a84 = tail call %struct.Memory* @sub_414340._ZN31custom_multiple_constant_divideItE8do_shiftEt(%struct.State* nonnull %0, i64 %163, %struct.Memory* %call2_407a43)
...
block_.L_407aa7:                                  ; preds = %block_.L_407a6c
  ...
  %call2_407aab = tail call %struct.Memory* @sub_414380._Z17check_shifted_sumIt31custom_multiple_constant_divideItEEvT_(%struct.State* nonnull %0, i64 %232, %struct.Memory* %call2_407a43)
...
block_.L_407abe:                                  ; preds = %block_.L_407a4f
  ...
  %call2_407abe = tail call %struct.Memory* @sub_400ea0._Z5timerv(%struct.State* nonnull %0, i64 %269, %struct.Memory* %call2_407a43)
