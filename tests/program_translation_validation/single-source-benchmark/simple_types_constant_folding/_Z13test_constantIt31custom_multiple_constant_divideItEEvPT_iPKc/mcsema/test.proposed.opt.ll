...
block_.L_407a0f:                                  ; preds = %block_.L_407a67, %entry
  %69 = phi i64 [ %.pre, %entry ], [ %270, %block_.L_407a67 ]
...
block_.L_407a2c:                                  ; preds = %block_407a38, %block_407a1f
  %112 = phi i64 [ %.pre1, %block_407a1f ], [ %227, %block_407a38 ]
...
block_.L_407a67:                                  ; preds = %block_.L_407a2c
  ...
  %call2_407a6b = tail call %struct.Memory* @sub_414340._Z17check_shifted_sumIt31custom_multiple_constant_divideItEEvT_(%struct.State* %0, i64 %233, %struct.Memory* %MEMORY.1)
...
block_.L_407a7e:                                  ; preds = %block_.L_407a0f
  ...
  %call2_407a7e = tail call %struct.Memory* @sub_400e60._Z5timerv(%struct.State* %0, i64 %271, %struct.Memory* %MEMORY.0)
  ...
  %call2_407a87 = tail call %struct.Memory* @sub_400800._Z13record_resultdPKc(%struct.State* %0, i64 %282, %struct.Memory* %call2_407a7e)
