...
define %struct.Memory* @_Z13test_constantIt32custom_multiple_constant_divide2ItEEvPT_iPKc(%struct.State* noalias, i64, %struct.Memory* noalias) #1 {
entry:
  ...
  store %struct.Memory* %loadMem_407ae4, %struct.Memory** %MEMORY
  ...
  store i32 %93, i32* %97
  store %struct.Memory* %loadMem_407aec, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_407aef, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem1_407af3, %struct.Memory** %MEMORY
...
block_.L_407aff:                                  ; preds = %block_.L_407b57, %entry
...
block_407b0f:                                     ; preds = %block_.L_407aff
...
block_.L_407b1c:                                  ; preds = %block_407b28, %block_407b0f
...
block_407b28:                                     ; preds = %block_.L_407b1c
  ...
  store %struct.Memory* %loadMem1_407b34, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_407b39, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_407b42, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_407b45, %struct.Memory** %MEMORY
...
block_.L_407b57:                                  ; preds = %block_.L_407b1c
  ...
  store %struct.Memory* %loadMem_407b57, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem1_407b5b, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_407b63, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_407b66, %struct.Memory** %MEMORY
...
block_.L_407b6e:                                  ; preds = %block_.L_407aff
  ...
  store %struct.Memory* %loadMem1_407b6e, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem1_407b77, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_407b80, %struct.Memory** %MEMORY
  ...
  ret %struct.Memory* %loadMem_407b81
}
