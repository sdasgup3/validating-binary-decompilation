...
declare %struct.Memory* @sub_4142e0._Z17check_shifted_sumIt32custom_multiple_constant_divide2ItEEvT_(%struct.State* noalias dereferenceable(3376), i64, %struct.Memory* noalias readnone returned) local_unnamed_addr
...
entry:
  ...
  %call2_407b03 = tail call %struct.Memory* @sub_400e90._Z11start_timerv(%struct.State* %0, i64 %58, %struct.Memory* %2)
...
block_.L_407b0f:                                  ; preds = %block_.L_407b67, %entry
  %69 = phi i64 [ %268, %block_.L_407b67 ], [ %.pre, %entry ]
  ...
  br i1 %102, label %block_407b1f, label %block_.L_407b7e
...
block_.L_407b2c:                                  ; preds = %block_407b38, %block_407b1f
  %112 = phi i64 [ %226, %block_407b38 ], [ %.pre6, %block_407b1f ]
  ...
  br i1 %148, label %block_407b38, label %block_.L_407b67
...
block_407b38:                                     ; preds = %block_.L_407b2c
  ...
  %call2_407b44 = tail call %struct.Memory* @sub_4142c0._ZN32custom_multiple_constant_divide2ItE8do_shiftEt(%struct.State* nonnull %0, i64 %163, %struct.Memory* %call2_407b03)
...
block_.L_407b67:                                  ; preds = %block_.L_407b2c
  ...
  %call2_407b6b = tail call %struct.Memory* @sub_4142e0._Z17check_shifted_sumIt32custom_multiple_constant_divide2ItEEvT_(%struct.State* nonnull %0, i64 %232, %struct.Memory* %call2_407b03)
...
block_.L_407b7e:                                  ; preds = %block_.L_407b0f
  ...
  %call2_407b7e = tail call %struct.Memory* @sub_400eb0._Z5timerv(%struct.State* nonnull %0, i64 %269, %struct.Memory* %call2_407b03)
  ...
  %call2_407b87 = tail call %struct.Memory* @sub_400850._Z13record_resultdPKc(%struct.State* nonnull %0, i64 %280, %struct.Memory* %call2_407b7e)
