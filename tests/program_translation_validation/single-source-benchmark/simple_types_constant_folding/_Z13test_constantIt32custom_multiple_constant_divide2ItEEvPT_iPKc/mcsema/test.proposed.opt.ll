...
block_.L_407abf:                                  ; preds = %block_.L_407b17, %entry
  %69 = phi i64 [ %.pre, %entry ], [ %270, %block_.L_407b17 ]
...
block_.L_407adc:                                  ; preds = %block_407ae8, %block_407acf
  %112 = phi i64 [ %.pre1, %block_407acf ], [ %227, %block_407ae8 ]
...
block_.L_407b17:                                  ; preds = %block_.L_407adc
  ...
  %call2_407b1b = tail call %struct.Memory* @sub_414290._Z17check_shifted_sumIt32custom_multiple_constant_divide2ItEEvT_(%struct.State* %0, i64 %233, %struct.Memory* %MEMORY.1)
...
block_.L_407b2e:                                  ; preds = %block_.L_407abf
  ...
  %call2_407b2e = tail call %struct.Memory* @sub_400e60._Z5timerv(%struct.State* %0, i64 %271, %struct.Memory* %MEMORY.0)
  ...
  %call2_407b37 = tail call %struct.Memory* @sub_400800._Z13record_resultdPKc(%struct.State* %0, i64 %282, %struct.Memory* %call2_407b2e)
