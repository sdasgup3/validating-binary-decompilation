...
declare %struct.Memory* @sub_4142d0._Z17check_shifted_sumIt32custom_multiple_constant_divide2ItEEvT_(%struct.State* noalias dereferenceable(3376), i64, %struct.Memory* noalias readnone returned) local_unnamed_addr
...
define %struct.Memory* @_Z13test_constantIt32custom_multiple_constant_divide2ItEEvPT_iPKc(%struct.State* noalias, i64, %struct.Memory* noalias readnone) local_unnamed_addr #1 {
entry:
...
block_.L_407aff:                                  ; preds = %block_.L_407b57, %entry
  %69 = phi i64 [ %268, %block_.L_407b57 ], [ %.pre, %entry ]
...
block_.L_407b1c:                                  ; preds = %block_407b28, %block_407b0f
  %112 = phi i64 [ %226, %block_407b28 ], [ %.pre6, %block_407b0f ]
...
block_407b28:                                     ; preds = %block_.L_407b1c
  ...
  %call2_407b34 = tail call %struct.Memory* @sub_4142b0._ZN32custom_multiple_constant_divide2ItE8do_shiftEt(%struct.State* nonnull %0, i64 %163, %struct.Memory* %call2_407af3)
...
block_.L_407b57:                                  ; preds = %block_.L_407b1c
  ...
  %call2_407b5b = tail call %struct.Memory* @sub_4142d0._Z17check_shifted_sumIt32custom_multiple_constant_divide2ItEEvT_(%struct.State* nonnull %0, i64 %232, %struct.Memory* %call2_407af3)
...
block_.L_407b6e:                                  ; preds = %block_.L_407aff
  ...
  %call2_407b6e = tail call %struct.Memory* @sub_400ea0._Z5timerv(%struct.State* nonnull %0, i64 %269, %struct.Memory* %call2_407af3)
