...
declare %struct.Memory* @sub_414ae0._ZN33custom_greaterthanequal_constantsItE8do_shiftEt(%struct.State* dereferenceable(3376), i64, %struct.Memory*)

declare %struct.Memory* @sub_414b00._Z17check_shifted_sumIt33custom_greaterthanequal_constantsItEEvT_(%struct.State* dereferenceable(3376), i64, %struct.Memory*)
...
define %struct.Memory* @_Z13test_constantIt33custom_greaterthanequal_constantsItEEvPT_iPKc(%struct.State* noalias, i64, %struct.Memory* noalias) #1 {
entry:
