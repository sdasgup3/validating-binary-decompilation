...
declare %struct.Memory* @sub_414ac0._Z17check_shifted_sumIt33custom_greaterthanequal_constantsItEEvT_(%struct.State* noalias dereferenceable(3376), i64, %struct.Memory* noalias readnone returned) local_unnamed_addr
...
entry:
  ...
  %call2_407113 = tail call %struct.Memory* @sub_400e40._Z11start_timerv(%struct.State* %0, i64 %58, %struct.Memory* %2)
...
block_.L_40711f:                                  ; preds = %block_.L_407177, %entry
  %69 = phi i64 [ %.pre, %entry ], [ %270, %block_.L_407177 ]
  %MEMORY.0 = phi %struct.Memory* [ %call2_407113, %entry ], [ %call2_40717b, %block_.L_407177 ]
  ...
  br i1 %102, label %block_40712f, label %block_.L_40718e
...
block_.L_40713c:                                  ; preds = %block_407148, %block_40712f
  %112 = phi i64 [ %.pre1, %block_40712f ], [ %227, %block_407148 ]
  %MEMORY.1 = phi %struct.Memory* [ %MEMORY.0, %block_40712f ], [ %call2_407154, %block_407148 ]
  ...
  br i1 %148, label %block_407148, label %block_.L_407177
...
block_407148:                                     ; preds = %block_.L_40713c
  ...
  %call2_407154 = tail call %struct.Memory* @sub_414aa0._ZN33custom_greaterthanequal_constantsItE8do_shiftEt(%struct.State* %0, i64 %163, %struct.Memory* %MEMORY.1)
...
block_.L_407177:                                  ; preds = %block_.L_40713c
  ...
  %call2_40717b = tail call %struct.Memory* @sub_414ac0._Z17check_shifted_sumIt33custom_greaterthanequal_constantsItEEvT_(%struct.State* %0, i64 %233, %struct.Memory* %MEMORY.1)
...
block_.L_40718e:                                  ; preds = %block_.L_40711f
  ...
  %call2_40718e = tail call %struct.Memory* @sub_400e60._Z5timerv(%struct.State* %0, i64 %271, %struct.Memory* %MEMORY.0)
  ...
  %call2_407197 = tail call %struct.Memory* @sub_400800._Z13record_resultdPKc(%struct.State* %0, i64 %282, %struct.Memory* %call2_40718e)
  ...
  ret %struct.Memory* %call2_407197
}
...
define %struct.Memory* @routine_jge_.L_40718e(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i8* %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
...
define %struct.Memory* @routine_jge_.L_407177(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i8* %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 2, i32 9
...
define %struct.Memory* @routine_jmpq_.L_40713c(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
...
define %struct.Memory* @routine_callq_._Z17check_shifted_sumIt33custom_greaterthanequal_constantsItEEvT_(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
...
define %struct.Memory* @routine_jmpq_.L_40711f(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
