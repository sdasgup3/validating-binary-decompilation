...
block_.L_40711f:                                  ; preds = %block_.L_407177, %entry
  %69 = phi i64 [ %.pre, %entry ], [ %268, %block_.L_407177 ]
...
block_.L_40713c:                                  ; preds = %block_407148, %block_40712f
  %112 = phi i64 [ %.pre1, %block_40712f ], [ %226, %block_407148 ]
...
block_.L_407177:                                  ; preds = %block_.L_40713c
  ...
  %call2_40717b = tail call %struct.Memory* @sub_414ac0._Z17check_shifted_sumIt33custom_greaterthanequal_constantsItEEvT_(%struct.State* %0, i64 %232, %struct.Memory* %MEMORY.1)
...
block_.L_40718e:                                  ; preds = %block_.L_40711f
  ...
  %call2_40718e = tail call %struct.Memory* @sub_400e60._Z5timerv(%struct.State* %0, i64 %269, %struct.Memory* %MEMORY.0)
  ...
  %call2_407197 = tail call %struct.Memory* @sub_400800._Z13record_resultdPKc(%struct.State* %0, i64 %280, %struct.Memory* %call2_40718e)
