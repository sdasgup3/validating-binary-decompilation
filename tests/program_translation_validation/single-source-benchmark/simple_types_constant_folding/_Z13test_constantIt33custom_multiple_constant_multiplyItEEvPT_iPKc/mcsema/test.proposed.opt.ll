...
block_.L_4077ff:                                  ; preds = %block_.L_407857, %entry
  %69 = phi i64 [ %.pre, %entry ], [ %268, %block_.L_407857 ]
...
block_.L_40781c:                                  ; preds = %block_407828, %block_40780f
  %112 = phi i64 [ %.pre1, %block_40780f ], [ %226, %block_407828 ]
...
block_.L_407857:                                  ; preds = %block_.L_40781c
  ...
  %call2_40785b = tail call %struct.Memory* @sub_414500._Z17check_shifted_sumIt33custom_multiple_constant_multiplyItEEvT_(%struct.State* %0, i64 %232, %struct.Memory* %MEMORY.1)
...
block_.L_40786e:                                  ; preds = %block_.L_4077ff
  ...
  %call2_40786e = tail call %struct.Memory* @sub_400e60._Z5timerv(%struct.State* %0, i64 %269, %struct.Memory* %MEMORY.0)
  ...
  %call2_407877 = tail call %struct.Memory* @sub_400800._Z13record_resultdPKc(%struct.State* %0, i64 %280, %struct.Memory* %call2_40786e)
