...
declare %struct.Memory* @sub_414480._ZN34custom_multiple_constant_multiply2ItE8do_shiftEt(%struct.State* noalias dereferenceable(3376), i64, %struct.Memory* noalias readnone returned) local_unnamed_addr

declare %struct.Memory* @sub_4144a0._Z17check_shifted_sumIt34custom_multiple_constant_multiply2ItEEvT_(%struct.State* noalias dereferenceable(3376), i64, %struct.Memory* noalias readnone returned) local_unnamed_addr
...
define %struct.Memory* @_Z13test_constantIt34custom_multiple_constant_multiply2ItEEvPT_iPKc(%struct.State* noalias, i64, %struct.Memory* noalias readnone) local_unnamed_addr #1 {
entry:
...
block_.L_4078ef:                                  ; preds = %block_.L_407947, %entry
  %69 = phi i64 [ %268, %block_.L_407947 ], [ %.pre, %entry ]
...
block_.L_40790c:                                  ; preds = %block_407918, %block_4078ff
  %112 = phi i64 [ %226, %block_407918 ], [ %.pre6, %block_4078ff ]
...
block_407918:                                     ; preds = %block_.L_40790c
  ...
  %call2_407924 = tail call %struct.Memory* @sub_414480._ZN34custom_multiple_constant_multiply2ItE8do_shiftEt(%struct.State* nonnull %0, i64 %163, %struct.Memory* %call2_4078e3)
...
block_.L_407947:                                  ; preds = %block_.L_40790c
  ...
  %call2_40794b = tail call %struct.Memory* @sub_4144a0._Z17check_shifted_sumIt34custom_multiple_constant_multiply2ItEEvT_(%struct.State* nonnull %0, i64 %232, %struct.Memory* %call2_4078e3)
...
block_.L_40795e:                                  ; preds = %block_.L_4078ef
  ...
  %call2_40795e = tail call %struct.Memory* @sub_400ea0._Z5timerv(%struct.State* nonnull %0, i64 %269, %struct.Memory* %call2_4078e3)
