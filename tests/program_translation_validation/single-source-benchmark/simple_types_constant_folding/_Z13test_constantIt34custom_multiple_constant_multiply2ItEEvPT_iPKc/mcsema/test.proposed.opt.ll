...
block_.L_4078af:                                  ; preds = %block_.L_407907, %entry
  %69 = phi i64 [ %.pre, %entry ], [ %268, %block_.L_407907 ]
...
block_.L_4078cc:                                  ; preds = %block_4078d8, %block_4078bf
  %112 = phi i64 [ %.pre1, %block_4078bf ], [ %226, %block_4078d8 ]
...
block_.L_407907:                                  ; preds = %block_.L_4078cc
  ...
  %call2_40790b = tail call %struct.Memory* @sub_414460._Z17check_shifted_sumIt34custom_multiple_constant_multiply2ItEEvT_(%struct.State* %0, i64 %232, %struct.Memory* %MEMORY.1)
...
block_.L_40791e:                                  ; preds = %block_.L_4078af
  ...
  %call2_40791e = tail call %struct.Memory* @sub_400e60._Z5timerv(%struct.State* %0, i64 %269, %struct.Memory* %MEMORY.0)
  ...
  %call2_407927 = tail call %struct.Memory* @sub_400800._Z13record_resultdPKc(%struct.State* %0, i64 %280, %struct.Memory* %call2_40791e)
