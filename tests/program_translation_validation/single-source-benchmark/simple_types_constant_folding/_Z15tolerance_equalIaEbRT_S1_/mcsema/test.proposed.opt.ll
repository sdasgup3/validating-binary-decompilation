...
@G_0x12b2__rip_ = local_unnamed_addr global %G_0x12b2__rip__type zeroinitializer
...
entry:
  ...
  %120 = load double, double* bitcast (%G_0x12b2__rip__type* @G_0x12b2__rip_ to double*), align 8
...
routine_ucomisd__xmm1___xmm0.exit:                ; preds = %150, %138
  ...
  %159 = load i64, i64* %RSP.i12, align 8
  %160 = add i64 %159, 32
  store i64 %160, i64* %RSP.i12, align 8
...
block_400478:
  ...
  %5 = load i64, i64* bitcast (%G_0x12b2__rip__type* @G_0x12b2__rip_ to i64*), align 8
