...
@G_0xa35e__rip__4253354_ = local_unnamed_addr global %G_0xa35e__rip__4253354__type zeroinitializer
@G_0xa3aa__rip__4253366_ = global %G_0xa3aa__rip__4253366__type zeroinitializer
@G_0xa3b4__rip__4253260_ = local_unnamed_addr global %G_0xa3b4__rip__4253260__type zeroinitializer
@G_0xa3de__rip__4253314_ = global %G_0xa3de__rip__4253314__type zeroinitializer
...
entry:
  ...
  %12 = load i64, i64* bitcast (%G_0xa3b4__rip__4253260__type* @G_0xa3b4__rip__4253260_ to i64*), align 8
  ...
  %73 = load i32, i32* bitcast (%G_0xa3de__rip__4253314__type* @G_0xa3de__rip__4253314_ to i32*), align 8
  %74 = load i32, i32* inttoptr (i64 add (i64 ptrtoint (%G_0xa3de__rip__4253314__type* @G_0xa3de__rip__4253314_ to i64), i64 4) to i32*), align 4
  %75 = load i32, i32* inttoptr (i64 add (i64 ptrtoint (%G_0xa3de__rip__4253314__type* @G_0xa3de__rip__4253314_ to i64), i64 8) to i32*), align 8
  %76 = load i32, i32* inttoptr (i64 add (i64 ptrtoint (%G_0xa3de__rip__4253314__type* @G_0xa3de__rip__4253314_ to i64), i64 12) to i32*), align 4
...
routine_ucomisd__xmm0___xmm1.exit:                ; preds = %123, %108
  ...
  br i1 %134, label %block_.L_40e6a2, label %block_40e690

block_40e690:                                     ; preds = %routine_ucomisd__xmm0___xmm1.exit
...
block_.L_40e6a2:                                  ; preds = %block_40e690, %routine_ucomisd__xmm0___xmm1.exit
  %152 = phi i64 [ %.pre1, %block_40e690 ], [ %135, %routine_ucomisd__xmm0___xmm1.exit ]
  %153 = load double, double* bitcast (%G_0xa35e__rip__4253354__type* @G_0xa35e__rip__4253354_ to double*), align 8
  ...
  %159 = load i32, i32* bitcast (%G_0xa3aa__rip__4253366__type* @G_0xa3aa__rip__4253366_ to i32*), align 8
  %160 = load i32, i32* inttoptr (i64 add (i64 ptrtoint (%G_0xa3aa__rip__4253366__type* @G_0xa3aa__rip__4253366_ to i64), i64 4) to i32*), align 4
  %161 = load i32, i32* inttoptr (i64 add (i64 ptrtoint (%G_0xa3aa__rip__4253366__type* @G_0xa3aa__rip__4253366_ to i64), i64 8) to i32*), align 8
  %162 = load i32, i32* inttoptr (i64 add (i64 ptrtoint (%G_0xa3aa__rip__4253366__type* @G_0xa3aa__rip__4253366_ to i64), i64 12) to i32*), align 4
...
; <label>:171:                                    ; preds = %block_.L_40e6a2
...
; <label>:181:                                    ; preds = %block_.L_40e6a2
...
define %struct.Memory* @routine_movsd_0xa3b4__rip____xmm0(%struct.State* dereferenceable(3376), i64, %struct.Memory*) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, 8
  store i64 %4, i64* %PC, align 8
  %5 = load i64, i64* bitcast (%G_0xa3b4__rip__4253260__type* @G_0xa3b4__rip__4253260_ to i64*), align 8
...
define %struct.Memory* @routine_movaps_0xa3de__rip____xmm2(%struct.State* dereferenceable(3376), i64, %struct.Memory*) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  ...
  %6 = add i64 %5, 7
  store i64 %6, i64* %PC, align 8
  %7 = load i32, i32* bitcast (%G_0xa3de__rip__4253314__type* @G_0xa3de__rip__4253314_ to i32*), align 8
  %8 = load i32, i32* inttoptr (i64 add (i64 ptrtoint (%G_0xa3de__rip__4253314__type* @G_0xa3de__rip__4253314_ to i64), i64 4) to i32*), align 4
  %9 = load i32, i32* inttoptr (i64 add (i64 ptrtoint (%G_0xa3de__rip__4253314__type* @G_0xa3de__rip__4253314_ to i64), i64 8) to i32*), align 8
  %10 = load i32, i32* inttoptr (i64 add (i64 ptrtoint (%G_0xa3de__rip__4253314__type* @G_0xa3de__rip__4253314_ to i64), i64 12) to i32*), align 4
...
define %struct.Memory* @routine_jbe_.L_40e6a2(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i8* %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
...
define %struct.Memory* @routine_movsd_0xa35e__rip____xmm0(%struct.State* dereferenceable(3376), i64, %struct.Memory*) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, 8
  store i64 %4, i64* %PC, align 8
  %5 = load i64, i64* bitcast (%G_0xa35e__rip__4253354__type* @G_0xa35e__rip__4253354_ to i64*), align 8
  %6 = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 1, i64 0, i32 0, i32 0, i32 0, i64 0
  store i64 %5, i64* %6, align 1
  %7 = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 1, i64 0, i32 0, i32 0, i32 0, i64 1
  %8 = bitcast i64* %7 to double*
...
define %struct.Memory* @routine_movaps_0xa3aa__rip____xmm2(%struct.State* dereferenceable(3376), i64, %struct.Memory*) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 1, i64 2
  %4 = bitcast %union.VectorReg* %3 to i8*
  ...
  %6 = add i64 %5, 7
  store i64 %6, i64* %PC, align 8
  %7 = load i32, i32* bitcast (%G_0xa3aa__rip__4253366__type* @G_0xa3aa__rip__4253366_ to i32*), align 8
  %8 = load i32, i32* inttoptr (i64 add (i64 ptrtoint (%G_0xa3aa__rip__4253366__type* @G_0xa3aa__rip__4253366_ to i64), i64 4) to i32*), align 4
  %9 = load i32, i32* inttoptr (i64 add (i64 ptrtoint (%G_0xa3aa__rip__4253366__type* @G_0xa3aa__rip__4253366_ to i64), i64 8) to i32*), align 8
  %10 = load i32, i32* inttoptr (i64 add (i64 ptrtoint (%G_0xa3aa__rip__4253366__type* @G_0xa3aa__rip__4253366_ to i64), i64 12) to i32*), align 4
  %11 = bitcast %union.VectorReg* %3 to i32*
  store i32 %7, i32* %11, align 1
  %12 = getelementptr inbounds i8, i8* %4, i64 4
  %13 = bitcast i8* %12 to i32*
