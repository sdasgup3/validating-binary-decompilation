...
entry:
  ...
  %266 = call %struct.Memory* @__remill_function_call(%struct.State* %0, i64 ptrtoint (i64 (i64)* @abs to i64), %struct.Memory* %loadMem2_4164b9)
...
; <label>:321:                                    ; preds = %313
  ...
  %324 = call %struct.Memory* @__remill_error(%struct.State* nonnull dereferenceable(3376) %0, i64 %323, %struct.Memory* %loadMem_4164ca)
...
routine_ucomisd__xmm1___xmm0.exit:                ; preds = %321, %338
  %342 = phi %struct.Memory* [ %324, %321 ], [ %loadMem_4164ca, %338 ]
  ...
  %DL.i9 = getelementptr inbounds %struct.anon.2, %struct.anon.2* %349, i32 0, i32 0
  ...
  %DL.i7 = getelementptr inbounds %struct.anon.2, %struct.anon.2* %365, i32 0, i32 0
  %366 = load i8, i8* %DL.i7
  ...
  %DL.i = getelementptr inbounds %struct.anon.2, %struct.anon.2* %392, i32 0, i32 0
