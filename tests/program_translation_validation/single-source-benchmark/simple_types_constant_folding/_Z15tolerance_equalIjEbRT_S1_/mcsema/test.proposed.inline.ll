...
define %struct.Memory* @_Z15tolerance_equalIjEbRT_S1_(%struct.State* noalias, i64, %struct.Memory* noalias) #1 {
entry:
  ...
  %loadMem_412024 = load %struct.Memory*, %struct.Memory** %MEMORY
  ...
  store i64 %40, i64* %43
  store %struct.Memory* %loadMem_412024, %struct.Memory** %MEMORY
  ...
  store i64 %55, i64* %58
  store %struct.Memory* %loadMem_412028, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_41202c, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_412032, %struct.Memory** %MEMORY
  %loadMem_412036 = load %struct.Memory*, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_412036, %struct.Memory** %MEMORY
  ...
  ret %struct.Memory* %loadMem_412042
}
