...
entry:
  ...
  %loadMem_41109a = load %struct.Memory*, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_41109a, %struct.Memory** %MEMORY
  ...
  %loadMem_4110a2 = load %struct.Memory*, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_4110a2, %struct.Memory** %MEMORY
  ...
  ret %struct.Memory* %loadMem_4110a3
}
