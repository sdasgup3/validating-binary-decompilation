...
%G_0x3860__rip__4280744__type = type <{ [16 x i8] }>
...
@G_0x3860__rip__4280744_ = global %G_0x3860__rip__4280744__type zeroinitializer
...
entry:
  ...
  %loadMem_41517c = load %struct.Memory*, %struct.Memory** %MEMORY
  ...
  store i64 %93, i64* %96
  store %struct.Memory* %loadMem_41517c, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_415184, %struct.Memory** %MEMORY
  %loadMem_415187 = load %struct.Memory*, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_415187, %struct.Memory** %MEMORY
  ...
  %loadMem_415190 = load %struct.Memory*, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_415190, %struct.Memory** %MEMORY
  ...
  %loadMem_415197 = load %struct.Memory*, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_415197, %struct.Memory** %MEMORY
  %loadMem1_41519b = load %struct.Memory*, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem1_41519b, %struct.Memory** %MEMORY
  %loadMem2_41519b = load %struct.Memory*, %struct.Memory** %MEMORY
  %loadPC_41519b = load i64, i64* %3
  %266 = call %struct.Memory* @__remill_function_call(%struct.State* %0, i64 ptrtoint (i64 (i64)* @abs to i64), %struct.Memory* %loadMem2_41519b)
  store %struct.Memory* %266, %struct.Memory** %MEMORY
  %loadMem_4151a0 = load %struct.Memory*, %struct.Memory** %MEMORY
  ...
  %276 = load double, double* bitcast (%G_0x3860__rip__4280744__type* @G_0x3860__rip__4280744_ to double*)
  ...
  store %struct.Memory* %loadMem_4151a0, %struct.Memory** %MEMORY
  %loadMem_4151a8 = load %struct.Memory*, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_4151a8, %struct.Memory** %MEMORY
  %loadMem_4151ac = load %struct.Memory*, %struct.Memory** %MEMORY
...
; <label>:319:                                    ; preds = %311
  ...
  %322 = call %struct.Memory* @__remill_error(%struct.State* nonnull dereferenceable(3376) %0, i64 %321, %struct.Memory* %loadMem_4151ac)
...
routine_ucomisd__xmm1___xmm0.exit:                ; preds = %319, %336
  %340 = phi %struct.Memory* [ %322, %319 ], [ %loadMem_4151ac, %336 ]
  store %struct.Memory* %340, %struct.Memory** %MEMORY
  %loadMem_4151b0 = load %struct.Memory*, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_4151b0, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_4151b4, %struct.Memory** %MEMORY
  ...
  %loadMem_4151bc = load %struct.Memory*, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_4151bc, %struct.Memory** %MEMORY
  ...
  ret %struct.Memory* %loadMem_4151c1
}
...
define %struct.Memory* @routine_movsd_0x3860__rip____xmm0(%struct.State* dereferenceable(3376), i64, %struct.Memory*) {
block_400478:
  %3 = getelementptr inbounds %struct.State, %struct.State* %0, i32 0, i32 6
  %4 = getelementptr inbounds %struct.GPR, %struct.GPR* %3, i32 0, i32 33
  %5 = getelementptr inbounds %struct.Reg, %struct.Reg* %4, i32 0, i32 0
  ...
  %9 = load i64, i64* %PC
  %10 = ptrtoint %G_0x3860__rip__4280744__type* @G_0x3860__rip__4280744_ to i64
  %11 = load i64, i64* %PC
  %12 = add i64 %11, 8
  store i64 %12, i64* %PC
