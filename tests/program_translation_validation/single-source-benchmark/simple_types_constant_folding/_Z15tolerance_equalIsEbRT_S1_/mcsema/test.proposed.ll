...
@G_0x3860__rip__4280744_= global %G_0x3860__rip__4280744__type <{ [16 x i8] c"\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00" }>
...
entry:
  ...
  ; Code: ._Z15tolerance_equalIsEbRT_S1_:	 RIP: 415170	 Bytes: 0
  ...
  ; Code: subq $0x20, %rsp	 RIP: 415174	 Bytes: 4
  %loadMem_415174 = load %struct.Memory*, %struct.Memory** %MEMORY
  %call_415174 = call %struct.Memory* @routine_subq__0x20___rsp(%struct.State* %0, i64  0, %struct.Memory* %loadMem_415174)
  ...
  ; Code: movq %rsi, -0x10(%rbp)	 RIP: 41517c	 Bytes: 4
  %loadMem_41517c = load %struct.Memory*, %struct.Memory** %MEMORY
  %call_41517c = call %struct.Memory* @routine_movq__rsi__MINUS0x10__rbp_(%struct.State* %0, i64  0, %struct.Memory* %loadMem_41517c)
  store %struct.Memory* %call_41517c, %struct.Memory** %MEMORY

  ; Code: movq -0x8(%rbp), %rsi	 RIP: 415180	 Bytes: 4
  %loadMem_415180 = load %struct.Memory*, %struct.Memory** %MEMORY
  %call_415180 = call %struct.Memory* @routine_movq_MINUS0x8__rbp____rsi(%struct.State* %0, i64  0, %struct.Memory* %loadMem_415180)
  store %struct.Memory* %call_415180, %struct.Memory** %MEMORY

  ; Code: movswl (%rsi), %eax	 RIP: 415184	 Bytes: 3
  %loadMem_415184 = load %struct.Memory*, %struct.Memory** %MEMORY
  %call_415184 = call %struct.Memory* @routine_movswl___rsi____eax(%struct.State* %0, i64  0, %struct.Memory* %loadMem_415184)
  store %struct.Memory* %call_415184, %struct.Memory** %MEMORY

  ; Code: movq -0x10(%rbp), %rsi	 RIP: 415187	 Bytes: 4
  %loadMem_415187 = load %struct.Memory*, %struct.Memory** %MEMORY
  %call_415187 = call %struct.Memory* @routine_movq_MINUS0x10__rbp____rsi(%struct.State* %0, i64  0, %struct.Memory* %loadMem_415187)
  store %struct.Memory* %call_415187, %struct.Memory** %MEMORY

  ; Code: movswl (%rsi), %ecx	 RIP: 41518b	 Bytes: 3
  %loadMem_41518b = load %struct.Memory*, %struct.Memory** %MEMORY
  %call_41518b = call %struct.Memory* @routine_movswl___rsi____ecx(%struct.State* %0, i64  0, %struct.Memory* %loadMem_41518b)
  store %struct.Memory* %call_41518b, %struct.Memory** %MEMORY

  ; Code: subl %ecx, %eax	 RIP: 41518e	 Bytes: 2
  %loadMem_41518e = load %struct.Memory*, %struct.Memory** %MEMORY
  %call_41518e = call %struct.Memory* @routine_subl__ecx___eax(%struct.State* %0, i64  0, %struct.Memory* %loadMem_41518e)
  store %struct.Memory* %call_41518e, %struct.Memory** %MEMORY

  ; Code: movw %ax, %dx	 RIP: 415190	 Bytes: 3
  %loadMem_415190 = load %struct.Memory*, %struct.Memory** %MEMORY
  %call_415190 = call %struct.Memory* @routine_movw__ax___dx(%struct.State* %0, i64  0, %struct.Memory* %loadMem_415190)
  store %struct.Memory* %call_415190, %struct.Memory** %MEMORY

  ; Code: movw %dx, -0x12(%rbp)	 RIP: 415193	 Bytes: 4
  %loadMem_415193 = load %struct.Memory*, %struct.Memory** %MEMORY
  %call_415193 = call %struct.Memory* @routine_movw__dx__MINUS0x12__rbp_(%struct.State* %0, i64  0, %struct.Memory* %loadMem_415193)
  store %struct.Memory* %call_415193, %struct.Memory** %MEMORY

  ; Code: movswl -0x12(%rbp), %edi	 RIP: 415197	 Bytes: 4
  %loadMem_415197 = load %struct.Memory*, %struct.Memory** %MEMORY
  %call_415197 = call %struct.Memory* @routine_movswl_MINUS0x12__rbp____edi(%struct.State* %0, i64  0, %struct.Memory* %loadMem_415197)
  store %struct.Memory* %call_415197, %struct.Memory** %MEMORY

  ; Code: callq .abs_plt	 RIP: 41519b	 Bytes: 5
  %loadMem1_41519b = load %struct.Memory*, %struct.Memory** %MEMORY
  %call1_41519b = call %struct.Memory* @routine_callq_.abs_plt(%struct.State* %0, i64  0, %struct.Memory* %loadMem1_41519b, i64 -84843, i64 5, i64 5)
  store %struct.Memory* %call1_41519b, %struct.Memory** %MEMORY

  %loadMem2_41519b = load %struct.Memory*, %struct.Memory** %MEMORY
  %loadPC_41519b = load i64, i64* %3
  %call2_41519b = call %struct.Memory* @ext_abs(%struct.State* %0, i64  %loadPC_41519b, %struct.Memory* %loadMem2_41519b)
  store %struct.Memory* %call2_41519b, %struct.Memory** %MEMORY

  ; Code: movsd 0x3860(%rip), %xmm0	 RIP: 4151a0	 Bytes: 8
  %loadMem_4151a0 = load %struct.Memory*, %struct.Memory** %MEMORY
  %call_4151a0 = call %struct.Memory* @routine_movsd_0x3860__rip____xmm0(%struct.State* %0, i64  0, %struct.Memory* %loadMem_4151a0)
  store %struct.Memory* %call_4151a0, %struct.Memory** %MEMORY

  ; Code: cvtsi2sdl %eax, %xmm1	 RIP: 4151a8	 Bytes: 4
  %loadMem_4151a8 = load %struct.Memory*, %struct.Memory** %MEMORY
  %call_4151a8 = call %struct.Memory* @routine_cvtsi2sdl__eax___xmm1(%struct.State* %0, i64  0, %struct.Memory* %loadMem_4151a8)
  store %struct.Memory* %call_4151a8, %struct.Memory** %MEMORY

  ; Code: ucomisd %xmm1, %xmm0	 RIP: 4151ac	 Bytes: 4
  %loadMem_4151ac = load %struct.Memory*, %struct.Memory** %MEMORY
  %call_4151ac = call %struct.Memory* @routine_ucomisd__xmm1___xmm0(%struct.State* %0, i64  0, %struct.Memory* %loadMem_4151ac)
  store %struct.Memory* %call_4151ac, %struct.Memory** %MEMORY

  ; Code: seta %r8b	 RIP: 4151b0	 Bytes: 4
  %loadMem_4151b0 = load %struct.Memory*, %struct.Memory** %MEMORY
  %call_4151b0 = call %struct.Memory* @routine_seta__r8b(%struct.State* %0, i64  0, %struct.Memory* %loadMem_4151b0)
  store %struct.Memory* %call_4151b0, %struct.Memory** %MEMORY

  ; Code: andb $0x1, %r8b	 RIP: 4151b4	 Bytes: 4
  %loadMem_4151b4 = load %struct.Memory*, %struct.Memory** %MEMORY
  %call_4151b4 = call %struct.Memory* @routine_andb__0x1___r8b(%struct.State* %0, i64  0, %struct.Memory* %loadMem_4151b4)
  store %struct.Memory* %call_4151b4, %struct.Memory** %MEMORY

  ; Code: movzbl %r8b, %eax	 RIP: 4151b8	 Bytes: 4
  %loadMem_4151b8 = load %struct.Memory*, %struct.Memory** %MEMORY
  %call_4151b8 = call %struct.Memory* @routine_movzbl__r8b___eax(%struct.State* %0, i64  0, %struct.Memory* %loadMem_4151b8)
  store %struct.Memory* %call_4151b8, %struct.Memory** %MEMORY

  ; Code: addq $0x20, %rsp	 RIP: 4151bc	 Bytes: 4
  %loadMem_4151bc = load %struct.Memory*, %struct.Memory** %MEMORY
  %call_4151bc = call %struct.Memory* @routine_addq__0x20___rsp(%struct.State* %0, i64  0, %struct.Memory* %loadMem_4151bc)
  store %struct.Memory* %call_4151bc, %struct.Memory** %MEMORY

  ; Code: popq %rbp	 RIP: 4151c0	 Bytes: 1
  %loadMem_4151c0 = load %struct.Memory*, %struct.Memory** %MEMORY
  %call_4151c0 = call %struct.Memory* @routine_popq__rbp(%struct.State* %0, i64  0, %struct.Memory* %loadMem_4151c0)
  store %struct.Memory* %call_4151c0, %struct.Memory** %MEMORY

  ; Code: retq	 RIP: 4151c1	 Bytes: 1
  %loadMem_4151c1 = load %struct.Memory*, %struct.Memory** %MEMORY
  %call_4151c1 = call %struct.Memory* @routine_retq(%struct.State* %0, i64  0, %struct.Memory* %loadMem_4151c1)
  store %struct.Memory* %call_4151c1, %struct.Memory** %MEMORY

  ret %struct.Memory* %call_4151c1
}
