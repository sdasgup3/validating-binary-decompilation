...
@G_0x209822__rip__4294758_ = global %G_0x209822__rip__4294758__type zeroinitializer
...
entry:
  ...
  store %struct.Memory* %loadMem_418851, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_418858, %struct.Memory** %MEMORY
  ...
  %108 = load double, double* bitcast (%G_0x209822__rip__4294758__type* @G_0x209822__rip__4294758_ to double*)
  ...
  store %struct.Memory* %loadMem_41885e, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem1_418870, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_418879, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_41887d, %struct.Memory** %MEMORY
  ...
  store i8 %280, i8* %284
  store %struct.Memory* %loadMem_418885, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem1_418888, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_41888d, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_41888f, %struct.Memory** %MEMORY
...
block_418895:                                     ; preds = %entry
  ...
  store %struct.Memory* %loadMem_41889f, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem1_4188a8, %struct.Memory** %MEMORY
  %loadMem2_4188a8 = load %struct.Memory*, %struct.Memory** %MEMORY
  %loadPC_4188a8 = load i64, i64* %3
  %382 = call %struct.Memory* @__remill_function_call(%struct.State* %0, i64 ptrtoint (i64 (i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64)* @printf to i64), %struct.Memory* %loadMem2_4188a8)
...
block_.L_4188b0:                                  ; preds = %block_418895, %entry
  ...
  store %struct.Memory* %loadMem_4188b0, %struct.Memory** %MEMORY
  ...
  ret %struct.Memory* %loadMem_4188b5
}
...
define %struct.Memory* @routine_movsd_0x209822__rip____xmm0(%struct.State* dereferenceable(3376), i64, %struct.Memory*) {
block_400478:
  %3 = getelementptr inbounds %struct.State, %struct.State* %0, i32 0, i32 6
  %4 = getelementptr inbounds %struct.GPR, %struct.GPR* %3, i32 0, i32 33
  %5 = getelementptr inbounds %struct.Reg, %struct.Reg* %4, i32 0, i32 0
