...
define %struct.Memory* @_Z17check_shifted_sumIa20custom_mod_constantsIaEEvT_(%struct.State* noalias, i64, %struct.Memory* noalias) #2 {
entry:
  ...
  store %struct.Memory* %loadMem_418650, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_418651, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_418658, %struct.Memory** %MEMORY
  ...
  store i8 %94, i8* %98
  store %struct.Memory* %loadMem_41865b, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_418666, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_41866a, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_41866d, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem1_418670, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_418675, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_418683, %struct.Memory** %MEMORY
  ...
  store i8 %282, i8* %286
  store %struct.Memory* %loadMem_418685, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem1_418688, %struct.Memory** %MEMORY
...
block_418695:                                     ; preds = %entry
  ...
  store %struct.Memory* %loadMem_418695, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_41869f, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_4186a6, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem1_4186a8, %struct.Memory** %MEMORY
  %loadMem2_4186a8 = load %struct.Memory*, %struct.Memory** %MEMORY
  %loadPC_4186a8 = load i64, i64* %3
  %384 = call %struct.Memory* @__remill_function_call(%struct.State* %0, i64 ptrtoint (i64 (i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64)* @printf to i64), %struct.Memory* %loadMem2_4186a8)
  ...
  store %struct.Memory* %loadMem_4186ad, %struct.Memory** %MEMORY
...
block_.L_4186b0:                                  ; preds = %block_418695, %entry
  ...
  store %struct.Memory* %loadMem_4186b0, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_4186b5, %struct.Memory** %MEMORY
  ret %struct.Memory* %loadMem_4186b5
}
...
define %struct.Memory* @routine_movsd_0x209a22__rip____xmm0(%struct.State* dereferenceable(3376), i64, %struct.Memory*) {
block_400488:
  %3 = getelementptr inbounds %struct.State, %struct.State* %0, i32 0, i32 6
  %4 = getelementptr inbounds %struct.GPR, %struct.GPR* %3, i32 0, i32 33
  %5 = getelementptr inbounds %struct.Reg, %struct.Reg* %4, i32 0, i32 0
