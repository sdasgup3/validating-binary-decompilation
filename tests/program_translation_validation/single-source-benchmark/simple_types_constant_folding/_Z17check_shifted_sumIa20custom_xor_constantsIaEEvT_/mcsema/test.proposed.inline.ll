...
entry:
  ...
  %loadMem_418150 = load %struct.Memory*, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_418150, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_418151, %struct.Memory** %MEMORY
  ...
  %loadMem_418158 = load %struct.Memory*, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_418158, %struct.Memory** %MEMORY
  ...
  store i8 %94, i8* %98
  store %struct.Memory* %loadMem_41815b, %struct.Memory** %MEMORY
  %loadMem_41815e = load %struct.Memory*, %struct.Memory** %MEMORY
  ...
  %106 = add i64 %105, ptrtoint (%G_0x209f22__rip__type* @G_0x209f22__rip_ to i64)
  ...
  store %struct.Memory* %loadMem_41815e, %struct.Memory** %MEMORY
  %loadMem_418166 = load %struct.Memory*, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_418166, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_41816a, %struct.Memory** %MEMORY
  ...
  %loadMem1_418170 = load %struct.Memory*, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem1_418170, %struct.Memory** %MEMORY
  %loadMem2_418170 = load %struct.Memory*, %struct.Memory** %MEMORY
  %loadPC_418170 = load i64, i64* %3
  %call2_418170 = call %struct.Memory* @sub_418130._ZN20custom_xor_constantsIaE8do_shiftEa(%struct.State* %0, i64 %loadPC_418170, %struct.Memory* %loadMem2_418170)
  store %struct.Memory* %call2_418170, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_418179, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_418180, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_418183, %struct.Memory** %MEMORY
  ...
  %loadMem1_418188 = load %struct.Memory*, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem1_418188, %struct.Memory** %MEMORY
  %loadMem2_418188 = load %struct.Memory*, %struct.Memory** %MEMORY
  %loadPC_418188 = load i64, i64* %3
  %call2_418188 = call %struct.Memory* @sub_417770._Z15tolerance_equalIaEbRT_S1_(%struct.State* %0, i64 %loadPC_418188, %struct.Memory* %loadMem2_418188)
  store %struct.Memory* %call2_418188, %struct.Memory** %MEMORY
  %loadMem_41818d = load %struct.Memory*, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_41818d, %struct.Memory** %MEMORY
  ...
  %loadBr_41818f = load i8, i8* %BRANCH_TAKEN
  %cmpBr_41818f = icmp eq i8 %loadBr_41818f, 1
  br i1 %cmpBr_41818f, label %block_.L_4181b0, label %block_418195

block_418195:                                     ; preds = %entry
  %loadMem_418195 = load %struct.Memory*, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_418195, %struct.Memory** %MEMORY
  %loadMem_41819f = load %struct.Memory*, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_41819f, %struct.Memory** %MEMORY
  ...
  %loadMem1_4181a8 = load %struct.Memory*, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem1_4181a8, %struct.Memory** %MEMORY
  %loadMem2_4181a8 = load %struct.Memory*, %struct.Memory** %MEMORY
  %loadPC_4181a8 = load i64, i64* %3
  %384 = call %struct.Memory* @__remill_function_call(%struct.State* %0, i64 ptrtoint (i64 (i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64)* @printf to i64), %struct.Memory* %loadMem2_4181a8)
...
block_.L_4181b0:                                  ; preds = %block_418195, %entry
  ...
  store %struct.Memory* %loadMem_4181b4, %struct.Memory** %MEMORY
  ...
  ret %struct.Memory* %loadMem_4181b5
}
...
; Function Attrs: alwaysinline
define %struct.Memory* @routine_movsd_0x209f22__rip____xmm0(%struct.State* dereferenceable(3376), i64, %struct.Memory*) #2 {
block_400488:
  %3 = getelementptr inbounds %struct.State, %struct.State* %0, i32 0, i32 6
  %4 = getelementptr inbounds %struct.GPR, %struct.GPR* %3, i32 0, i32 33
  %5 = getelementptr inbounds %struct.Reg, %struct.Reg* %4, i32 0, i32 0
  ...
  %9 = load i64, i64* %PC
  %10 = add i64 %9, ptrtoint (%G_0x209f22__rip__type* @G_0x209f22__rip_ to i64)
  %11 = load i64, i64* %PC
  %12 = add i64 %11, 8
  store i64 %12, i64* %PC
...
; Function Attrs: alwaysinline
define %struct.Memory* @routine_jne_.L_4181b0(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i8* %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) #2 {
block_400488:
  %3 = getelementptr inbounds %struct.State, %struct.State* %0, i32 0, i32 6
  %4 = getelementptr inbounds %struct.GPR, %struct.GPR* %3, i32 0, i32 33
  %5 = getelementptr inbounds %struct.Reg, %struct.Reg* %4, i32 0, i32 0
