...
block_4183c5:                                     ; preds = %entry
  ...
  %call2_4183d8 = call %struct.Memory* @sub_4006c0.printf_plt(%struct.State* %0, i64 %loadPC_4183d8, %struct.Memory* %loadMem2_4183d8)
  store %struct.Memory* %call2_4183d8, %struct.Memory** %MEMORY
