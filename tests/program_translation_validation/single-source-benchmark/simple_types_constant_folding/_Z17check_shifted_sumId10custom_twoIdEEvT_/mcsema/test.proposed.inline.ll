...
define %struct.Memory* @_Z17check_shifted_sumId10custom_twoIdEEvT_(%struct.State* noalias, i64, %struct.Memory* noalias) #1 {
entry:
...
block_40efd1:                                     ; preds = %entry
  ...
  %call2_40efe4 = call %struct.Memory* @sub_4006c0.printf_plt(%struct.State* %0, i64 %loadPC_40efe4, %struct.Memory* %loadMem2_40efe4)
  store %struct.Memory* %call2_40efe4, %struct.Memory** %MEMORY
