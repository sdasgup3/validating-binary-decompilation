...
define %struct.Memory* @_Z17check_shifted_sumId10custom_twoIdEEvT_(%struct.State* noalias, i64, %struct.Memory* noalias readnone) local_unnamed_addr #1 {
entry:
...
block_40efd1:                                     ; preds = %entry
  ...
  %call2_40efe4 = tail call %struct.Memory* @sub_4006c0.printf_plt(%struct.State* nonnull %0, i64 %89, %struct.Memory* %call2_40efc4)
...
block_.L_40efec:                                  ; preds = %block_40efd1, %entry
  %100 = phi i64 [ %86, %entry ], [ %.pre, %block_40efd1 ]
  %MEMORY.0 = phi %struct.Memory* [ %call2_40efc4, %entry ], [ %call2_40efe4, %block_40efd1 ]
