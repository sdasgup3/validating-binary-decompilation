...
define %struct.Memory* @_Z17check_shifted_sumId19custom_constant_addIdEEvT_(%struct.State* noalias, i64, %struct.Memory* noalias readnone) local_unnamed_addr #1 {
entry:
...
block_40ed01:                                     ; preds = %entry
  ...
  %call2_40ed14 = tail call %struct.Memory* @sub_4006c0.printf_plt(%struct.State* nonnull %0, i64 %89, %struct.Memory* %call2_40ecf4)
...
block_.L_40ed1c:                                  ; preds = %block_40ed01, %entry
  %100 = phi i64 [ %86, %entry ], [ %.pre, %block_40ed01 ]
  %MEMORY.0 = phi %struct.Memory* [ %call2_40ecf4, %entry ], [ %call2_40ed14, %block_40ed01 ]
