...
@G_0x9e8d__rip__4254571_ = global %G_0x9e8d__rip__4254571__type zeroinitializer
...
entry:
  ...
  store %struct.Memory* %loadMem_40eb40, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_40eb44, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_40eb48, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_40eb5f, %struct.Memory** %MEMORY
  ...
  %144 = load double, double* bitcast (%G_0x9e8d__rip__4254571__type* @G_0x9e8d__rip__4254571_ to double*)
  ...
  store %struct.Memory* %loadMem_40eb6f, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem1_40eb74, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_40eb79, %struct.Memory** %MEMORY
...
block_40eb81:                                     ; preds = %entry
  ...
  store %struct.Memory* %loadMem_40eb8b, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_40eb92, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem1_40eb94, %struct.Memory** %MEMORY
  %loadMem2_40eb94 = load %struct.Memory*, %struct.Memory** %MEMORY
  %loadPC_40eb94 = load i64, i64* %3
  %284 = call %struct.Memory* @__remill_function_call(%struct.State* %0, i64 ptrtoint (i64 (i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64)* @printf to i64), %struct.Memory* %loadMem2_40eb94)
  ...
  store %struct.Memory* %loadMem_40eb99, %struct.Memory** %MEMORY
  br label %block_.L_40eb9c

block_.L_40eb9c:                                  ; preds = %block_40eb81, %entry
  ...
  store %struct.Memory* %loadMem_40eb9c, %struct.Memory** %MEMORY
  ...
  ret %struct.Memory* %loadMem_40eba1
}
