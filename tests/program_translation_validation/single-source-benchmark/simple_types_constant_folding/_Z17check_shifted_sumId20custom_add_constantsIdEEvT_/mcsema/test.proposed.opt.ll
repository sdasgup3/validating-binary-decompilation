...
@G_0x9b0d__rip_ = local_unnamed_addr global %G_0x9b0d__rip__type zeroinitializer
...
entry:
  ...
  %call2_40eed6 = tail call %struct.Memory* @sub_40eea0._ZN20custom_add_constantsIdE8do_shiftEd(%struct.State* %0, i64 %51, %struct.Memory* %2)
  ...
  %61 = load double, double* bitcast (%G_0x9b0d__rip__type* @G_0x9b0d__rip_ to double*), align 8
  ...
  %call2_40eef4 = tail call %struct.Memory* @sub_40e640._Z15tolerance_equalIdEbRT_S1_(%struct.State* %0, i64 %69, %struct.Memory* %call2_40eed6)
  ...
  br i1 %83, label %block_.L_40ef1c, label %block_40ef01

block_40ef01:                                     ; preds = %entry
  ...
  %92 = tail call %struct.Memory* @__remill_function_call(%struct.State* %0, i64 ptrtoint (i64 (i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64)* @printf to i64), %struct.Memory* %call2_40eef4)
...
block_.L_40ef1c:                                  ; preds = %block_40ef01, %entry
  %99 = phi i64 [ %84, %entry ], [ %.pre, %block_40ef01 ]
  %MEMORY.0 = phi %struct.Memory* [ %call2_40eef4, %entry ], [ %92, %block_40ef01 ]
...
define %struct.Memory* @routine_movsd_0x9b0d__rip____xmm1(%struct.State* dereferenceable(3376), i64, %struct.Memory*) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, 8
  store i64 %4, i64* %PC, align 8
  %5 = load i64, i64* bitcast (%G_0x9b0d__rip__type* @G_0x9b0d__rip_ to i64*), align 8
...
define %struct.Memory* @routine_jne_.L_40ef1c(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i8* %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
