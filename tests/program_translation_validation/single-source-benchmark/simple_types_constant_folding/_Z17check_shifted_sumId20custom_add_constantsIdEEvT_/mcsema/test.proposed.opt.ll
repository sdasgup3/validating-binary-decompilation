...
@G_0x9b0d__rip__4255467_ = local_unnamed_addr global %G_0x9b0d__rip__4255467__type zeroinitializer
...
entry:
  ...
  %call2_40eed6 = tail call %struct.Memory* @sub_40eea0._ZN20custom_add_constantsIdE8do_shiftEd(%struct.State* %0, i64 %50, %struct.Memory* %2)
  ...
  %60 = load double, double* bitcast (%G_0x9b0d__rip__4255467__type* @G_0x9b0d__rip__4255467_ to double*), align 8
  ...
  %call2_40eef4 = tail call %struct.Memory* @sub_40e640._Z15tolerance_equalIdEbRT_S1_(%struct.State* %0, i64 %68, %struct.Memory* %call2_40eed6)
  ...
  br i1 %82, label %block_.L_40ef1c, label %block_40ef01
...
block_40ef01:                                     ; preds = %entry
  ...
  %91 = tail call %struct.Memory* @__remill_function_call(%struct.State* %0, i64 ptrtoint (i64 (i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64)* @printf to i64), %struct.Memory* %call2_40eef4)
...
block_.L_40ef1c:                                  ; preds = %block_40ef01, %entry
  %98 = phi i64 [ %83, %entry ], [ %.pre, %block_40ef01 ]
  %MEMORY.0 = phi %struct.Memory* [ %call2_40eef4, %entry ], [ %91, %block_40ef01 ]
...
block_400478:
  ...
  %4 = add i64 %3, 8
  store i64 %4, i64* %PC, align 8
  %5 = load i64, i64* bitcast (%G_0x9b0d__rip__4255467__type* @G_0x9b0d__rip__4255467_ to i64*), align 8
