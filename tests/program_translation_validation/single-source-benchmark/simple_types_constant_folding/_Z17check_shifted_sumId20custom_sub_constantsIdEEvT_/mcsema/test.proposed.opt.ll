...
define %struct.Memory* @_Z17check_shifted_sumId20custom_sub_constantsIdEEvT_(%struct.State* noalias, i64, %struct.Memory* noalias readnone) local_unnamed_addr #1 {
entry:
...
block_40eeb1:                                     ; preds = %entry
  ...
  %call2_40eec4 = tail call %struct.Memory* @sub_4006c0.printf_plt(%struct.State* nonnull %0, i64 %89, %struct.Memory* %call2_40eea4)
...
block_.L_40eecc:                                  ; preds = %block_40eeb1, %entry
  %100 = phi i64 [ %86, %entry ], [ %.pre, %block_40eeb1 ]
  %MEMORY.0 = phi %struct.Memory* [ %call2_40eea4, %entry ], [ %call2_40eec4, %block_40eeb1 ]
