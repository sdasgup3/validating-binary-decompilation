...
define %struct.Memory* @_Z17check_shifted_sumId20custom_sub_constantsIdEEvT_(%struct.State* noalias, i64, %struct.Memory* noalias) local_unnamed_addr #1 {
entry:
  ...
  %call2_40ee96 = tail call %struct.Memory* @sub_40ee60._ZN20custom_sub_constantsIdE8do_shiftEd(%struct.State* %0, i64 %50, %struct.Memory* %2)
  ...
  %60 = add i64 %57, add (i64 ptrtoint (%G_0x9b9d__rip__type* @G_0x9b9d__rip_ to i64), i64 8)
  %61 = add i64 %57, 16
  ...
  %call2_40eeb4 = tail call %struct.Memory* @sub_40e690._Z15tolerance_equalIdEbRT_S1_(%struct.State* %0, i64 %71, %struct.Memory* %call2_40ee96)
  ...
  br i1 %85, label %block_.L_40eedc, label %block_40eec1
...
block_40eec1:                                     ; preds = %entry
  ...
  %94 = tail call %struct.Memory* @__remill_function_call(%struct.State* nonnull %0, i64 ptrtoint (i64 (i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64)* @printf to i64), %struct.Memory* %call2_40eeb4)
...
block_.L_40eedc:                                  ; preds = %block_40eec1, %entry
  %101 = phi i64 [ %86, %entry ], [ %.pre, %block_40eec1 ]
  %MEMORY.0 = phi %struct.Memory* [ %call2_40eeb4, %entry ], [ %94, %block_40eec1 ]
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_movsd_0x9b9d__rip____xmm1(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, ptrtoint (%G_0x9b9d__rip__type* @G_0x9b9d__rip_ to i64)
  %5 = add i64 %3, 8
  store i64 %5, i64* %PC, align 8
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_jne_.L_40eedc(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i8* nocapture %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
