...
%G_0xa19d__rip__4253787__type = type <{ [16 x i8] }>
...
@G_0xa19d__rip__4253787_ = global %G_0xa19d__rip__4253787__type zeroinitializer
...
declare %struct.Memory* @sub_40e810._ZN22custom_constant_divideIdE8do_shiftEd(%struct.State* noalias dereferenceable(3376), i64, %struct.Memory* noalias readnone returned)
...
entry:
  ...
  %loadMem1_40e846 = load %struct.Memory*, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem1_40e846, %struct.Memory** %MEMORY
  %loadMem2_40e846 = load %struct.Memory*, %struct.Memory** %MEMORY
  %loadPC_40e846 = load i64, i64* %3
  %call2_40e846 = call %struct.Memory* @sub_40e810._ZN22custom_constant_divideIdE8do_shiftEd(%struct.State* %0, i64 %loadPC_40e846, %struct.Memory* %loadMem2_40e846)
  store %struct.Memory* %call2_40e846, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_40e84b, %struct.Memory** %MEMORY
  ...
  %loadMem_40e853 = load %struct.Memory*, %struct.Memory** %MEMORY
  ...
  %144 = load double, double* bitcast (%G_0xa19d__rip__4253787__type* @G_0xa19d__rip__4253787_ to double*)
  ...
  store %struct.Memory* %loadMem_40e853, %struct.Memory** %MEMORY
  %loadMem_40e85b = load %struct.Memory*, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_40e85b, %struct.Memory** %MEMORY
  ...
  %loadMem1_40e864 = load %struct.Memory*, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem1_40e864, %struct.Memory** %MEMORY
  %loadMem2_40e864 = load %struct.Memory*, %struct.Memory** %MEMORY
  %loadPC_40e864 = load i64, i64* %3
  %call2_40e864 = call %struct.Memory* @sub_40e640._Z15tolerance_equalIdEbRT_S1_(%struct.State* %0, i64 %loadPC_40e864, %struct.Memory* %loadMem2_40e864)
  store %struct.Memory* %call2_40e864, %struct.Memory** %MEMORY
  ...
  %loadBr_40e86b = load i8, i8* %BRANCH_TAKEN
  %cmpBr_40e86b = icmp eq i8 %loadBr_40e86b, 1
  br i1 %cmpBr_40e86b, label %block_.L_40e88c, label %block_40e871

block_40e871:                                     ; preds = %entry
  ...
  %loadMem_40e882 = load %struct.Memory*, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_40e882, %struct.Memory** %MEMORY
  %loadMem1_40e884 = load %struct.Memory*, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem1_40e884, %struct.Memory** %MEMORY
  %loadMem2_40e884 = load %struct.Memory*, %struct.Memory** %MEMORY
  %loadPC_40e884 = load i64, i64* %3
  %284 = call %struct.Memory* @__remill_function_call(%struct.State* %0, i64 ptrtoint (i64 (i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64)* @printf to i64), %struct.Memory* %loadMem2_40e884)
  ...
  br label %block_.L_40e88c

block_.L_40e88c:                                  ; preds = %block_40e871, %entry
  ...
  store %struct.Memory* %loadMem_40e890, %struct.Memory** %MEMORY
  ...
  ret %struct.Memory* %loadMem_40e891
}
...
block_400478:
  ...
  %9 = load i64, i64* %PC
  %10 = ptrtoint %G_0xa19d__rip__4253787__type* @G_0xa19d__rip__4253787_ to i64
  %11 = load i64, i64* %PC
  %12 = add i64 %11, 8
  store i64 %12, i64* %PC
...
define %struct.Memory* @routine_jne_.L_40e88c(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i8* %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) {
block_400478:
  %3 = getelementptr inbounds %struct.State, %struct.State* %0, i32 0, i32 6
  %4 = getelementptr inbounds %struct.GPR, %struct.GPR* %3, i32 0, i32 33
  %5 = getelementptr inbounds %struct.Reg, %struct.Reg* %4, i32 0, i32 0
