...
entry:
  ...
  %call2_40e896 = tail call %struct.Memory* @sub_40e860._ZN22custom_constant_divideIdE8do_shiftEd(%struct.State* %0, i64 %50, %struct.Memory* %2)
  ...
  %60 = add i64 %57, add (i64 ptrtoint (%G_0xa19d__rip__type* @G_0xa19d__rip_ to i64), i64 8)
  %61 = add i64 %57, 16
  ...
  %call2_40e8b4 = tail call %struct.Memory* @sub_40e690._Z15tolerance_equalIdEbRT_S1_(%struct.State* %0, i64 %71, %struct.Memory* %call2_40e896)
  ...
  br i1 %85, label %block_.L_40e8dc, label %block_40e8c1
...
block_40e8c1:                                     ; preds = %entry
  ...
  %94 = tail call %struct.Memory* @__remill_function_call(%struct.State* nonnull %0, i64 ptrtoint (i64 (i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64)* @printf to i64), %struct.Memory* %call2_40e8b4)
...
block_.L_40e8dc:                                  ; preds = %block_40e8c1, %entry
  %101 = phi i64 [ %86, %entry ], [ %.pre, %block_40e8c1 ]
  %MEMORY.0 = phi %struct.Memory* [ %call2_40e8b4, %entry ], [ %94, %block_40e8c1 ]
