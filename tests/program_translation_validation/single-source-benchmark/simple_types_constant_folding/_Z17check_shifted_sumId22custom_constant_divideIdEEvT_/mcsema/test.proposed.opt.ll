...
block_40e8b1:                                     ; preds = %entry
  ...
  %94 = tail call %struct.Memory* @__remill_function_call(%struct.State* nonnull %0, i64 ptrtoint (i64 (i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64)* @printf to i64), %struct.Memory* %call2_40e8a4)
...
block_.L_40e8cc:                                  ; preds = %block_40e8b1, %entry
  %101 = phi i64 [ %86, %entry ], [ %.pre, %block_40e8b1 ]
  %MEMORY.0 = phi %struct.Memory* [ %call2_40e8a4, %entry ], [ %94, %block_40e8b1 ]
