...
define %struct.Memory* @_Z17check_shifted_sumId23custom_divide_constantsIdEEvT_(%struct.State* noalias, i64, %struct.Memory* noalias readnone) local_unnamed_addr #1 {
entry:
...
block_40ed91:                                     ; preds = %entry
  ...
  %call2_40eda4 = tail call %struct.Memory* @sub_4006c0.printf_plt(%struct.State* nonnull %0, i64 %89, %struct.Memory* %call2_40ed84)
...
block_.L_40edac:                                  ; preds = %block_40ed91, %entry
  %100 = phi i64 [ %86, %entry ], [ %.pre, %block_40ed91 ]
  %MEMORY.0 = phi %struct.Memory* [ %call2_40ed84, %entry ], [ %call2_40eda4, %block_40ed91 ]
