...
entry:
  ...
  %call2_40ed76 = tail call %struct.Memory* @sub_40ed40._ZN23custom_divide_constantsIdE8do_shiftEd(%struct.State* %0, i64 %50, %struct.Memory* %2)
  ...
  %60 = add i64 %57, add (i64 ptrtoint (%G_0x9cbd__rip__type* @G_0x9cbd__rip_ to i64), i64 8)
  %61 = add i64 %57, 16
  ...
  %call2_40ed94 = tail call %struct.Memory* @sub_40e690._Z15tolerance_equalIdEbRT_S1_(%struct.State* %0, i64 %71, %struct.Memory* %call2_40ed76)
  ...
  br i1 %85, label %block_.L_40edbc, label %block_40eda1
...
block_40eda1:                                     ; preds = %entry
  ...
  %94 = tail call %struct.Memory* @__remill_function_call(%struct.State* nonnull %0, i64 ptrtoint (i64 (i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64)* @printf to i64), %struct.Memory* %call2_40ed94)
...
block_.L_40edbc:                                  ; preds = %block_40eda1, %entry
  %101 = phi i64 [ %86, %entry ], [ %.pre, %block_40eda1 ]
  %MEMORY.0 = phi %struct.Memory* [ %call2_40ed94, %entry ], [ %94, %block_40eda1 ]
