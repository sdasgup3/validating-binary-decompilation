...
block_40ea81:                                     ; preds = %entry
  ...
  %94 = tail call %struct.Memory* @__remill_function_call(%struct.State* nonnull %0, i64 ptrtoint (i64 (i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64)* @printf to i64), %struct.Memory* %call2_40ea74)
...
block_.L_40ea9c:                                  ; preds = %block_40ea81, %entry
  %101 = phi i64 [ %86, %entry ], [ %.pre, %block_40ea81 ]
  %MEMORY.0 = phi %struct.Memory* [ %call2_40ea74, %entry ], [ %94, %block_40ea81 ]
