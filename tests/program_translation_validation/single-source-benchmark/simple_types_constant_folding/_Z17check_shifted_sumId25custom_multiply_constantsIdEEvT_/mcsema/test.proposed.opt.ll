...
@G_0x9c2d__rip_ = local_unnamed_addr global %G_0x9c2d__rip__type zeroinitializer
...
entry:
  ...
  %call2_40edb6 = tail call %struct.Memory* @sub_40ed80._ZN25custom_multiply_constantsIdE8do_shiftEd(%struct.State* %0, i64 %51, %struct.Memory* %2)
  ...
  %61 = load double, double* bitcast (%G_0x9c2d__rip__type* @G_0x9c2d__rip_ to double*), align 8
  ...
  %call2_40edd4 = tail call %struct.Memory* @sub_40e640._Z15tolerance_equalIdEbRT_S1_(%struct.State* %0, i64 %69, %struct.Memory* %call2_40edb6)
  ...
  br i1 %83, label %block_.L_40edfc, label %block_40ede1
...
block_40ede1:                                     ; preds = %entry
  ...
  %92 = tail call %struct.Memory* @__remill_function_call(%struct.State* %0, i64 ptrtoint (i64 (i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64)* @printf to i64), %struct.Memory* %call2_40edd4)
...
block_.L_40edfc:                                  ; preds = %block_40ede1, %entry
  %99 = phi i64 [ %84, %entry ], [ %.pre, %block_40ede1 ]
  %MEMORY.0 = phi %struct.Memory* [ %call2_40edd4, %entry ], [ %92, %block_40ede1 ]
...
block_400478:
  ...
  %4 = add i64 %3, 8
  store i64 %4, i64* %PC, align 8
  %5 = load i64, i64* bitcast (%G_0x9c2d__rip__type* @G_0x9c2d__rip_ to i64*), align 8
