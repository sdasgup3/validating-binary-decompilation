...
define %struct.Memory* @_Z17check_shifted_sumId25custom_multiply_constantsIdEEvT_(%struct.State* noalias, i64, %struct.Memory* noalias readnone) local_unnamed_addr #1 {
entry:
...
block_40ee21:                                     ; preds = %entry
  ...
  %call2_40ee34 = tail call %struct.Memory* @sub_4006c0.printf_plt(%struct.State* nonnull %0, i64 %89, %struct.Memory* %call2_40ee14)
...
block_.L_40ee3c:                                  ; preds = %block_40ee21, %entry
  %100 = phi i64 [ %86, %entry ], [ %.pre, %block_40ee21 ]
  %MEMORY.0 = phi %struct.Memory* [ %call2_40ee14, %entry ], [ %call2_40ee34, %block_40ee21 ]
