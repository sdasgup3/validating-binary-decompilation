...
@G_0x9ddd__rip__4254747_ = global %G_0x9ddd__rip__4254747__type zeroinitializer
...
entry:
  ...
  store %struct.Memory* %loadMem1_40ec06, %struct.Memory** %MEMORY
  ...
  %144 = load double, double* bitcast (%G_0x9ddd__rip__4254747__type* @G_0x9ddd__rip__4254747_ to double*)
  ...
  store %struct.Memory* %loadMem1_40ec24, %struct.Memory** %MEMORY
...
block_40ec31:                                     ; preds = %entry
  ...
  store %struct.Memory* %loadMem1_40ec44, %struct.Memory** %MEMORY
  %loadMem2_40ec44 = load %struct.Memory*, %struct.Memory** %MEMORY
  %loadPC_40ec44 = load i64, i64* %3
  %284 = call %struct.Memory* @__remill_function_call(%struct.State* %0, i64 ptrtoint (i64 (i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64)* @printf to i64), %struct.Memory* %loadMem2_40ec44)
...
block_.L_40ec4c:                                  ; preds = %block_40ec31, %entry
  ...
  ret %struct.Memory* %loadMem_40ec51
}
