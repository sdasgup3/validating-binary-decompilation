...
entry:
  ...
  %call2_40eb16 = tail call %struct.Memory* @sub_40eac0._ZN28custom_multiple_constant_subIdE8do_shiftEd(%struct.State* %0, i64 %50, %struct.Memory* %2)
  ...
  %60 = add i64 %57, add (i64 ptrtoint (%G_0x9f1d__rip__type* @G_0x9f1d__rip_ to i64), i64 8)
  %61 = add i64 %57, 16
  ...
  %call2_40eb34 = tail call %struct.Memory* @sub_40e690._Z15tolerance_equalIdEbRT_S1_(%struct.State* %0, i64 %71, %struct.Memory* %call2_40eb16)
  ...
  br i1 %85, label %block_.L_40eb5c, label %block_40eb41
...
block_40eb41:                                     ; preds = %entry
  ...
  %94 = tail call %struct.Memory* @__remill_function_call(%struct.State* nonnull %0, i64 ptrtoint (i64 (i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64)* @printf to i64), %struct.Memory* %call2_40eb34)
...
block_.L_40eb5c:                                  ; preds = %block_40eb41, %entry
  %101 = phi i64 [ %86, %entry ], [ %.pre, %block_40eb41 ]
  %MEMORY.0 = phi %struct.Memory* [ %call2_40eb34, %entry ], [ %94, %block_40eb41 ]
