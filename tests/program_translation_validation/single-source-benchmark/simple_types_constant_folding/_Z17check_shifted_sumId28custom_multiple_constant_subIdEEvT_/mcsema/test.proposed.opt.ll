...
@G_0x9f1d__rip__4254427_ = local_unnamed_addr global %G_0x9f1d__rip__4254427__type zeroinitializer
...
entry:
  ...
  %call2_40eac6 = tail call %struct.Memory* @sub_40ea70._ZN28custom_multiple_constant_subIdE8do_shiftEd(%struct.State* %0, i64 %50, %struct.Memory* %2)
  ...
  %60 = load double, double* bitcast (%G_0x9f1d__rip__4254427__type* @G_0x9f1d__rip__4254427_ to double*), align 8
  ...
  %call2_40eae4 = tail call %struct.Memory* @sub_40e640._Z15tolerance_equalIdEbRT_S1_(%struct.State* %0, i64 %68, %struct.Memory* %call2_40eac6)
  ...
  br i1 %82, label %block_.L_40eb0c, label %block_40eaf1
...
block_40eaf1:                                     ; preds = %entry
  ...
  %91 = tail call %struct.Memory* @__remill_function_call(%struct.State* %0, i64 ptrtoint (i64 (i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64)* @printf to i64), %struct.Memory* %call2_40eae4)
...
block_.L_40eb0c:                                  ; preds = %block_40eaf1, %entry
  %98 = phi i64 [ %83, %entry ], [ %.pre, %block_40eaf1 ]
  %MEMORY.0 = phi %struct.Memory* [ %call2_40eae4, %entry ], [ %91, %block_40eaf1 ]
...
block_400478:
  ...
  %4 = add i64 %3, 8
  store i64 %4, i64* %PC, align 8
  %5 = load i64, i64* bitcast (%G_0x9f1d__rip__4254427__type* @G_0x9f1d__rip__4254427_ to i64*), align 8
