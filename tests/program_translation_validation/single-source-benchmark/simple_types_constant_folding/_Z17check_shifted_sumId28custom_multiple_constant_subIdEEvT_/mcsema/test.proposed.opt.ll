...
@G_0x9f1d__rip_ = local_unnamed_addr global %G_0x9f1d__rip__type zeroinitializer
...
define %struct.Memory* @_Z17check_shifted_sumId28custom_multiple_constant_subIdEEvT_(%struct.State* noalias, i64, %struct.Memory* noalias) local_unnamed_addr #1 {
entry:
  ...
  %call2_40eac6 = tail call %struct.Memory* @sub_40ea70._ZN28custom_multiple_constant_subIdE8do_shiftEd(%struct.State* %0, i64 %51, %struct.Memory* %2)
  ...
  %61 = load double, double* bitcast (%G_0x9f1d__rip__type* @G_0x9f1d__rip_ to double*), align 8
  ...
  %call2_40eae4 = tail call %struct.Memory* @sub_40e640._Z15tolerance_equalIdEbRT_S1_(%struct.State* %0, i64 %69, %struct.Memory* %call2_40eac6)
  ...
  br i1 %83, label %block_.L_40eb0c, label %block_40eaf1

block_40eaf1:                                     ; preds = %entry
  ...
  %92 = tail call %struct.Memory* @__remill_function_call(%struct.State* %0, i64 ptrtoint (i64 (i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64)* @printf to i64), %struct.Memory* %call2_40eae4)
...
block_.L_40eb0c:                                  ; preds = %block_40eaf1, %entry
  %99 = phi i64 [ %84, %entry ], [ %.pre, %block_40eaf1 ]
  %MEMORY.0 = phi %struct.Memory* [ %call2_40eae4, %entry ], [ %92, %block_40eaf1 ]
...
define %struct.Memory* @routine_movsd_0x9f1d__rip____xmm1(%struct.State* dereferenceable(3376), i64, %struct.Memory*) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, 8
  store i64 %4, i64* %PC, align 8
  %5 = load i64, i64* bitcast (%G_0x9f1d__rip__type* @G_0x9f1d__rip_ to i64*), align 8
...
define %struct.Memory* @routine_jne_.L_40eb0c(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i8* %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
