...
declare %struct.Memory* @sub_40e5e0._ZN30custom_multiple_constant_mixedIdE8do_shiftEd(%struct.State* dereferenceable(3376), i64, %struct.Memory*)
...
define %struct.Memory* @_Z17check_shifted_sumId30custom_multiple_constant_mixedIdEEvT_(%struct.State* noalias, i64, %struct.Memory* noalias) #1 {
entry:
