...
define %struct.Memory* @_Z17check_shifted_sumId30custom_multiple_constant_mixedIdEEvT_(%struct.State* noalias, i64, %struct.Memory* noalias readnone) local_unnamed_addr #1 {
entry:
...
block_40e651:                                     ; preds = %entry
  ...
  %call2_40e664 = tail call %struct.Memory* @sub_4006c0.printf_plt(%struct.State* nonnull %0, i64 %89, %struct.Memory* %call2_40e644)
...
block_.L_40e66c:                                  ; preds = %block_40e651, %entry
  %100 = phi i64 [ %86, %entry ], [ %.pre, %block_40e651 ]
  %MEMORY.0 = phi %struct.Memory* [ %call2_40e644, %entry ], [ %call2_40e664, %block_40e651 ]
