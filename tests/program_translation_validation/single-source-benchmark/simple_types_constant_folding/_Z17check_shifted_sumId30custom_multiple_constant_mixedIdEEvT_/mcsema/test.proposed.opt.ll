...
@G_0xa3fd__rip__4253179_ = local_unnamed_addr global %G_0xa3fd__rip__4253179__type zeroinitializer
...
define %struct.Memory* @_Z17check_shifted_sumId30custom_multiple_constant_mixedIdEEvT_(%struct.State* noalias, i64, %struct.Memory* noalias) local_unnamed_addr #1 {
entry:
  ...
  %call2_40e5e6 = tail call %struct.Memory* @sub_40e5a0._ZN30custom_multiple_constant_mixedIdE8do_shiftEd(%struct.State* %0, i64 %50, %struct.Memory* %2)
  ...
  %60 = load double, double* bitcast (%G_0xa3fd__rip__4253179__type* @G_0xa3fd__rip__4253179_ to double*), align 8
  ...
  %call2_40e604 = tail call %struct.Memory* @sub_40e640._Z15tolerance_equalIdEbRT_S1_(%struct.State* %0, i64 %68, %struct.Memory* %call2_40e5e6)
  ...
  br i1 %82, label %block_.L_40e62c, label %block_40e611
...
block_40e611:                                     ; preds = %entry
  ...
  %91 = tail call %struct.Memory* @__remill_function_call(%struct.State* %0, i64 ptrtoint (i64 (i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64)* @printf to i64), %struct.Memory* %call2_40e604)
...
block_.L_40e62c:                                  ; preds = %block_40e611, %entry
  %98 = phi i64 [ %83, %entry ], [ %.pre, %block_40e611 ]
  %MEMORY.0 = phi %struct.Memory* [ %call2_40e604, %entry ], [ %91, %block_40e611 ]
...
define %struct.Memory* @routine_movsd_0xa3fd__rip____xmm1(%struct.State* dereferenceable(3376), i64, %struct.Memory*) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, 8
  store i64 %4, i64* %PC, align 8
  %5 = load i64, i64* bitcast (%G_0xa3fd__rip__4253179__type* @G_0xa3fd__rip__4253179_ to i64*), align 8
...
define %struct.Memory* @routine_jne_.L_40e62c(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i8* %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
