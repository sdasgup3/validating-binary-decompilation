...
define %struct.Memory* @_Z17check_shifted_sumId31custom_multiple_constant_divideIdEEvT_(%struct.State* noalias, i64, %struct.Memory* noalias readnone) local_unnamed_addr #1 {
entry:
  ...
  %call2_40e7f6 = tail call %struct.Memory* @sub_40e7a0._ZN31custom_multiple_constant_divideIdE8do_shiftEd(%struct.State* %0, i64 %50, %struct.Memory* %2)
  ...
  %call2_40e814 = tail call %struct.Memory* @sub_40e680._Z15tolerance_equalIdEbRT_S1_(%struct.State* %0, i64 %71, %struct.Memory* %call2_40e7f6)
  ...
  br i1 %85, label %block_.L_40e83c, label %block_40e821
...
block_40e821:                                     ; preds = %entry
  ...
  %call2_40e834 = tail call %struct.Memory* @sub_4006c0.printf_plt(%struct.State* nonnull %0, i64 %89, %struct.Memory* %call2_40e814)
...
block_.L_40e83c:                                  ; preds = %block_40e821, %entry
  %100 = phi i64 [ %86, %entry ], [ %.pre, %block_40e821 ]
  %MEMORY.0 = phi %struct.Memory* [ %call2_40e814, %entry ], [ %call2_40e834, %block_40e821 ]
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_jne_.L_40e83c(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i8* nocapture %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
