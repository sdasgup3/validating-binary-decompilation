...
declare %struct.Memory* @sub_40e720._ZN32custom_multiple_constant_divide2IdE8do_shiftEd(%struct.State* noalias dereferenceable(3376), i64, %struct.Memory* noalias readnone returned) local_unnamed_addr
...
entry:
  ...
  %call2_40e756 = tail call %struct.Memory* @sub_40e720._ZN32custom_multiple_constant_divide2IdE8do_shiftEd(%struct.State* %0, i64 %50, %struct.Memory* %2)
  ...
  %60 = add i64 %57, add (i64 ptrtoint (%G_0xa2dd__rip__type* @G_0xa2dd__rip_ to i64), i64 8)
  %61 = add i64 %57, 16
  ...
  %call2_40e774 = tail call %struct.Memory* @sub_40e690._Z15tolerance_equalIdEbRT_S1_(%struct.State* %0, i64 %71, %struct.Memory* %call2_40e756)
  %76 = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 1, i32 0
  %AL.i16 = bitcast %union.anon* %76 to i8*
  %77 = load i8, i8* %AL.i16, align 1
  ...
  br i1 %85, label %block_.L_40e79c, label %block_40e781

block_40e781:                                     ; preds = %entry
  store i64 ptrtoint (%G__0x419d98_type* @G__0x419d98 to i64), i64* %RDI.i27, align 8
  %87 = load i32, i32* bitcast (%G_0x6220a8_type* @G_0x6220a8 to i32*), align 8
  %88 = zext i32 %87 to i64
  store i64 %88, i64* %RSI.i24, align 8
  ...
  %94 = tail call %struct.Memory* @__remill_function_call(%struct.State* nonnull %0, i64 ptrtoint (i64 (i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64)* @printf to i64), %struct.Memory* %call2_40e774)
  %EAX.i = bitcast %union.anon* %76 to i32*
  %95 = load i64, i64* %RBP.i, align 8
  %96 = add i64 %95, -20
  %97 = load i32, i32* %EAX.i, align 4
...
block_.L_40e79c:                                  ; preds = %block_40e781, %entry
  %101 = phi i64 [ %86, %entry ], [ %.pre, %block_40e781 ]
  %MEMORY.0 = phi %struct.Memory* [ %call2_40e774, %entry ], [ %94, %block_40e781 ]
  ...
  store i64 %128, i64* %RBP.i, align 8
...
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, ptrtoint (%G_0xa2dd__rip__type* @G_0xa2dd__rip_ to i64)
  %5 = add i64 %3, 8
  store i64 %5, i64* %PC, align 8
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_jne_.L_40e79c(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i8* nocapture %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
