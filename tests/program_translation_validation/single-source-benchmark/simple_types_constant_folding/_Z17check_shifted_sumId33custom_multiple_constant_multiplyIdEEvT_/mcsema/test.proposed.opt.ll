...
declare %struct.Memory* @sub_40e970._ZN33custom_multiple_constant_multiplyIdE8do_shiftEd(%struct.State* dereferenceable(3376), i64, %struct.Memory*) local_unnamed_addr
