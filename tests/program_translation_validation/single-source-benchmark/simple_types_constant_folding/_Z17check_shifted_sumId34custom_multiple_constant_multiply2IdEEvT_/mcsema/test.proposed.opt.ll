...
@G_0xa10d__rip_ = local_unnamed_addr global %G_0xa10d__rip__type zeroinitializer
...
entry:
  ...
  %call2_40e8d6 = tail call %struct.Memory* @sub_40e8a0._ZN34custom_multiple_constant_multiply2IdE8do_shiftEd(%struct.State* %0, i64 %51, %struct.Memory* %2)
  ...
  %61 = load double, double* bitcast (%G_0xa10d__rip__type* @G_0xa10d__rip_ to double*), align 8
  ...
  %call2_40e8f4 = tail call %struct.Memory* @sub_40e640._Z15tolerance_equalIdEbRT_S1_(%struct.State* %0, i64 %69, %struct.Memory* %call2_40e8d6)
  ...
  br i1 %83, label %block_.L_40e91c, label %block_40e901
...
block_40e901:                                     ; preds = %entry
  ...
  %92 = tail call %struct.Memory* @__remill_function_call(%struct.State* %0, i64 ptrtoint (i64 (i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64)* @printf to i64), %struct.Memory* %call2_40e8f4)
...
block_.L_40e91c:                                  ; preds = %block_40e901, %entry
  %99 = phi i64 [ %84, %entry ], [ %.pre, %block_40e901 ]
  %MEMORY.0 = phi %struct.Memory* [ %call2_40e8f4, %entry ], [ %92, %block_40e901 ]
...
block_400478:
  ...
  %4 = add i64 %3, 8
  store i64 %4, i64* %PC, align 8
  %5 = load i64, i64* bitcast (%G_0xa10d__rip__type* @G_0xa10d__rip_ to i64*), align 8
