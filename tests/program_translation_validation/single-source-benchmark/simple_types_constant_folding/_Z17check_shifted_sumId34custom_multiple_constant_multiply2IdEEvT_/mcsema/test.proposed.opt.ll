...
entry:
  ...
  %call2_40e916 = tail call %struct.Memory* @sub_40e8e0._ZN34custom_multiple_constant_multiply2IdE8do_shiftEd(%struct.State* %0, i64 %50, %struct.Memory* %2)
  ...
  %call2_40e934 = tail call %struct.Memory* @sub_40e680._Z15tolerance_equalIdEbRT_S1_(%struct.State* %0, i64 %71, %struct.Memory* %call2_40e916)
  ...
  br i1 %85, label %block_.L_40e95c, label %block_40e941
...
block_40e941:                                     ; preds = %entry
  ...
  %94 = tail call %struct.Memory* @__remill_function_call(%struct.State* nonnull %0, i64 ptrtoint (i64 (i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64)* @printf to i64), %struct.Memory* %call2_40e934)
...
block_.L_40e95c:                                  ; preds = %block_40e941, %entry
  %101 = phi i64 [ %86, %entry ], [ %.pre, %block_40e941 ]
  %MEMORY.0 = phi %struct.Memory* [ %call2_40e934, %entry ], [ %94, %block_40e941 ]
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_jne_.L_40e95c(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i8* nocapture %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
