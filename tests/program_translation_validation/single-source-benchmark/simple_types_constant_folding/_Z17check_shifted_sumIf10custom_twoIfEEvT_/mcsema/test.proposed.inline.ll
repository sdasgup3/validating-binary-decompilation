...
@G_0x90b9__rip__4258255_ = global %G_0x90b9__rip__4258255__type zeroinitializer
...
define %struct.Memory* @_Z17check_shifted_sumIf10custom_twoIfEEvT_(%struct.State* noalias, i64, %struct.Memory* noalias) #2 {
entry:
  ...
  store %struct.Memory* %loadMem1_40f9ba, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_40f9bf, %struct.Memory** %MEMORY
  ...
  %173 = load float, float* bitcast (%G_0x90b9__rip__4258255__type* @G_0x90b9__rip__4258255_ to float*)
  ...
  store %struct.Memory* %loadMem_40f9cf, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_40f9d3, %struct.Memory** %MEMORY
...
block_40f9e5:                                     ; preds = %entry
  ...
  store %struct.Memory* %loadMem_40f9e5, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_40f9f6, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem1_40f9f8, %struct.Memory** %MEMORY
  %loadMem2_40f9f8 = load %struct.Memory*, %struct.Memory** %MEMORY
  %loadPC_40f9f8 = load i64, i64* %3
  %328 = call %struct.Memory* @__remill_function_call(%struct.State* %0, i64 ptrtoint (i64 (i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64)* @printf to i64), %struct.Memory* %loadMem2_40f9f8)
  ...
  store %struct.Memory* %loadMem_40f9fd, %struct.Memory** %MEMORY
...
block_.L_40fa00:                                  ; preds = %block_40f9e5, %entry
  ...
  store %struct.Memory* %loadMem_40fa05, %struct.Memory** %MEMORY
  ret %struct.Memory* %loadMem_40fa05
}
...
define %struct.Memory* @routine_movss_0x90b9__rip____xmm1(%struct.State* dereferenceable(3376), i64, %struct.Memory*) {
block_400478:
  %3 = getelementptr inbounds %struct.State, %struct.State* %0, i32 0, i32 6
  %4 = getelementptr inbounds %struct.GPR, %struct.GPR* %3, i32 0, i32 33
  %5 = getelementptr inbounds %struct.Reg, %struct.Reg* %4, i32 0, i32 0
