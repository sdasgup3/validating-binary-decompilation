...
declare %struct.Memory* @sub_40f9c0._ZN10custom_twoIfE8do_shiftEf(%struct.State* noalias dereferenceable(3376), i64, %struct.Memory* noalias readnone returned) local_unnamed_addr
...
define %struct.Memory* @_Z17check_shifted_sumIf10custom_twoIfEEvT_(%struct.State* noalias, i64, %struct.Memory* noalias readnone) local_unnamed_addr #1 {
entry:
  ...
  %call2_40f9f6 = tail call %struct.Memory* @sub_40f9c0._ZN10custom_twoIfE8do_shiftEf(%struct.State* %0, i64 %65, %struct.Memory* %2)
  ...
  %call2_40fa14 = tail call %struct.Memory* @sub_40f0a0._Z15tolerance_equalIfEbRT_S1_(%struct.State* %0, i64 %108, %struct.Memory* %call2_40f9f6)
  ...
  br i1 %122, label %block_.L_40fa3c, label %block_40fa21

block_40fa21:                                     ; preds = %entry
  ...
  %call2_40fa34 = tail call %struct.Memory* @sub_4006c0.printf_plt(%struct.State* nonnull %0, i64 %126, %struct.Memory* %call2_40fa14)
...
block_.L_40fa3c:                                  ; preds = %block_40fa21, %entry
  %137 = phi i64 [ %123, %entry ], [ %.pre, %block_40fa21 ]
  %MEMORY.0 = phi %struct.Memory* [ %call2_40fa14, %entry ], [ %call2_40fa34, %block_40fa21 ]
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_jne_.L_40fa3c(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i8* nocapture %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
