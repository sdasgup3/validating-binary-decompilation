...
entry:
  ...
  %call2_40fa06 = tail call %struct.Memory* @sub_40f9d0._ZN10custom_twoIfE8do_shiftEf(%struct.State* %0, i64 %65, %struct.Memory* %2)
  ...
  %76 = add i64 %72, add (i64 ptrtoint (%G_0x90bd__rip__type* @G_0x90bd__rip_ to i64), i64 8)
  %77 = add i64 %72, 16
  ...
  %call2_40fa24 = tail call %struct.Memory* @sub_40f0b0._Z15tolerance_equalIfEbRT_S1_(%struct.State* %0, i64 %108, %struct.Memory* %call2_40fa06)
  ...
  br i1 %122, label %block_.L_40fa4c, label %block_40fa31
...
block_40fa31:                                     ; preds = %entry
  ...
  %131 = tail call %struct.Memory* @__remill_function_call(%struct.State* nonnull %0, i64 ptrtoint (i64 (i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64)* @printf to i64), %struct.Memory* %call2_40fa24)
...
block_.L_40fa4c:                                  ; preds = %block_40fa31, %entry
  %138 = phi i64 [ %123, %entry ], [ %.pre, %block_40fa31 ]
  %MEMORY.0 = phi %struct.Memory* [ %call2_40fa24, %entry ], [ %131, %block_40fa31 ]
