...
entry:
  ...
  %call2_40f726 = tail call %struct.Memory* @sub_40f6f0._ZN19custom_constant_addIfE8do_shiftEf(%struct.State* %0, i64 %65, %struct.Memory* %2)
  ...
  %call2_40f744 = tail call %struct.Memory* @sub_40f0a0._Z15tolerance_equalIfEbRT_S1_(%struct.State* %0, i64 %108, %struct.Memory* %call2_40f726)
  ...
  br i1 %122, label %block_.L_40f76c, label %block_40f751
...
block_40f751:                                     ; preds = %entry
  ...
  %131 = tail call %struct.Memory* @__remill_function_call(%struct.State* nonnull %0, i64 ptrtoint (i64 (i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64)* @printf to i64), %struct.Memory* %call2_40f744)
...
block_.L_40f76c:                                  ; preds = %block_40f751, %entry
  %138 = phi i64 [ %123, %entry ], [ %.pre, %block_40f751 ]
  %MEMORY.0 = phi %struct.Memory* [ %call2_40f744, %entry ], [ %131, %block_40f751 ]
