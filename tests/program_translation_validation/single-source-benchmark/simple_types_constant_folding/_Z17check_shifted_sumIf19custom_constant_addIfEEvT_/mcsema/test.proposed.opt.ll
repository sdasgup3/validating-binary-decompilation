...
define %struct.Memory* @_Z17check_shifted_sumIf19custom_constant_addIfEEvT_(%struct.State* noalias, i64, %struct.Memory* noalias readnone) local_unnamed_addr #1 {
entry:
...
block_40f751:                                     ; preds = %entry
  ...
  %call2_40f764 = tail call %struct.Memory* @sub_4006c0.printf_plt(%struct.State* nonnull %0, i64 %126, %struct.Memory* %call2_40f744)
...
block_.L_40f76c:                                  ; preds = %block_40f751, %entry
  %137 = phi i64 [ %123, %entry ], [ %.pre, %block_40f751 ]
  %MEMORY.0 = phi %struct.Memory* [ %call2_40f744, %entry ], [ %call2_40f764, %block_40f751 ]
