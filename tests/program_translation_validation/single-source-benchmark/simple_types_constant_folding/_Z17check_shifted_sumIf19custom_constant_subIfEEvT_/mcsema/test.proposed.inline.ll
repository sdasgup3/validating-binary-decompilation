...
@G_0x94c9__rip__4257215_ = global %G_0x94c9__rip__4257215__type zeroinitializer
...
define %struct.Memory* @_Z17check_shifted_sumIf19custom_constant_subIfEEvT_(%struct.State* noalias, i64, %struct.Memory* noalias) #2 {
entry:
  ...
  %loadMem1_40f5aa = load %struct.Memory*, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem1_40f5aa, %struct.Memory** %MEMORY
  %loadMem2_40f5aa = load %struct.Memory*, %struct.Memory** %MEMORY
  %loadPC_40f5aa = load i64, i64* %3
  %call2_40f5aa = call %struct.Memory* @sub_40f570._ZN19custom_constant_subIfE8do_shiftEf(%struct.State* %0, i64 %loadPC_40f5aa, %struct.Memory* %loadMem2_40f5aa)
  store %struct.Memory* %call2_40f5aa, %struct.Memory** %MEMORY
  ...
  %loadMem_40f5b7 = load %struct.Memory*, %struct.Memory** %MEMORY
  ...
  %173 = load float, float* bitcast (%G_0x94c9__rip__4257215__type* @G_0x94c9__rip__4257215_ to float*)
  ...
  store %struct.Memory* %loadMem_40f5b7, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem1_40f5c8, %struct.Memory** %MEMORY
  %loadMem2_40f5c8 = load %struct.Memory*, %struct.Memory** %MEMORY
  %loadPC_40f5c8 = load i64, i64* %3
  %call2_40f5c8 = call %struct.Memory* @sub_40f060._Z15tolerance_equalIfEbRT_S1_(%struct.State* %0, i64 %loadPC_40f5c8, %struct.Memory* %loadMem2_40f5c8)
  store %struct.Memory* %call2_40f5c8, %struct.Memory** %MEMORY
  %loadMem_40f5cd = load %struct.Memory*, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_40f5cd, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_40f5cf, %struct.Memory** %MEMORY
  %loadBr_40f5cf = load i8, i8* %BRANCH_TAKEN
  %cmpBr_40f5cf = icmp eq i8 %loadBr_40f5cf, 1
  br i1 %cmpBr_40f5cf, label %block_.L_40f5f0, label %block_40f5d5
...
block_40f5d5:                                     ; preds = %entry
  ...
  store %struct.Memory* %loadMem_40f5d5, %struct.Memory** %MEMORY
  %loadMem_40f5df = load %struct.Memory*, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_40f5df, %struct.Memory** %MEMORY
  ...
  %328 = call %struct.Memory* @__remill_function_call(%struct.State* %0, i64 ptrtoint (i64 (i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64)* @printf to i64), %struct.Memory* %loadMem2_40f5e8)
...
block_.L_40f5f0:                                  ; preds = %block_40f5d5, %entry
  ...
  store %struct.Memory* %loadMem_40f5f0, %struct.Memory** %MEMORY
  ...
  ret %struct.Memory* %loadMem_40f5f5
}
...
define %struct.Memory* @routine_movss_0x94c9__rip____xmm1(%struct.State* dereferenceable(3376), i64, %struct.Memory*) {
block_400478:
  %3 = getelementptr inbounds %struct.State, %struct.State* %0, i32 0, i32 6
  %4 = getelementptr inbounds %struct.GPR, %struct.GPR* %3, i32 0, i32 33
  %5 = getelementptr inbounds %struct.Reg, %struct.Reg* %4, i32 0, i32 0
  ...
  %9 = load i64, i64* %PC
  %10 = ptrtoint %G_0x94c9__rip__4257215__type* @G_0x94c9__rip__4257215_ to i64
  %11 = load i64, i64* %PC
  %12 = add i64 %11, 8
  store i64 %12, i64* %PC
...
define %struct.Memory* @routine_jne_.L_40f5f0(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i8* %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) {
block_400478:
  %3 = getelementptr inbounds %struct.State, %struct.State* %0, i32 0, i32 6
  %4 = getelementptr inbounds %struct.GPR, %struct.GPR* %3, i32 0, i32 33
  %5 = getelementptr inbounds %struct.Reg, %struct.Reg* %4, i32 0, i32 0
