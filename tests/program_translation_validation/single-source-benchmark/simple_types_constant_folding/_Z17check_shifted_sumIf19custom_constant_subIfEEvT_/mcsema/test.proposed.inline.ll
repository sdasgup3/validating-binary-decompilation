...
define %struct.Memory* @_Z17check_shifted_sumIf19custom_constant_subIfEEvT_(%struct.State* noalias, i64, %struct.Memory* noalias) #1 {
entry:
...
block_40f611:                                     ; preds = %entry
  ...
  %call2_40f624 = call %struct.Memory* @sub_4006c0.printf_plt(%struct.State* %0, i64 %loadPC_40f624, %struct.Memory* %loadMem2_40f624)
