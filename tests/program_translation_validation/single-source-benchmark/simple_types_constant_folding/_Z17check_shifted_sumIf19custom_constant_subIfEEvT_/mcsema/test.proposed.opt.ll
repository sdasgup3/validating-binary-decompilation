...
define %struct.Memory* @_Z17check_shifted_sumIf19custom_constant_subIfEEvT_(%struct.State* noalias, i64, %struct.Memory* noalias readnone) local_unnamed_addr #1 {
entry:
  ...
  %call2_40f5e6 = tail call %struct.Memory* @sub_40f5b0._ZN19custom_constant_subIfE8do_shiftEf(%struct.State* %0, i64 %65, %struct.Memory* %2)
  ...
  %call2_40f604 = tail call %struct.Memory* @sub_40f0a0._Z15tolerance_equalIfEbRT_S1_(%struct.State* %0, i64 %108, %struct.Memory* %call2_40f5e6)
  ...
  br i1 %122, label %block_.L_40f62c, label %block_40f611

block_40f611:                                     ; preds = %entry
  ...
  %call2_40f624 = tail call %struct.Memory* @sub_4006c0.printf_plt(%struct.State* nonnull %0, i64 %126, %struct.Memory* %call2_40f604)
  ...
  br label %block_.L_40f62c

block_.L_40f62c:                                  ; preds = %block_40f611, %entry
  %137 = phi i64 [ %123, %entry ], [ %.pre, %block_40f611 ]
  %MEMORY.0 = phi %struct.Memory* [ %call2_40f604, %entry ], [ %call2_40f624, %block_40f611 ]
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_jne_.L_40f62c(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i8* nocapture %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
