...
entry:
  ...
  %call2_40f5f6 = tail call %struct.Memory* @sub_40f5c0._ZN19custom_constant_subIfE8do_shiftEf(%struct.State* %0, i64 %65, %struct.Memory* %2)
  ...
  %76 = add i64 %72, add (i64 ptrtoint (%G_0x94cd__rip__type* @G_0x94cd__rip_ to i64), i64 8)
  %77 = add i64 %72, 16
  ...
  %call2_40f614 = tail call %struct.Memory* @sub_40f0b0._Z15tolerance_equalIfEbRT_S1_(%struct.State* %0, i64 %108, %struct.Memory* %call2_40f5f6)
  ...
  br i1 %122, label %block_.L_40f63c, label %block_40f621
...
block_40f621:                                     ; preds = %entry
  ...
  %131 = tail call %struct.Memory* @__remill_function_call(%struct.State* nonnull %0, i64 ptrtoint (i64 (i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64)* @printf to i64), %struct.Memory* %call2_40f614)
...
block_.L_40f63c:                                  ; preds = %block_40f621, %entry
  %138 = phi i64 [ %123, %entry ], [ %.pre, %block_40f621 ]
  %MEMORY.0 = phi %struct.Memory* [ %call2_40f614, %entry ], [ %131, %block_40f621 ]
