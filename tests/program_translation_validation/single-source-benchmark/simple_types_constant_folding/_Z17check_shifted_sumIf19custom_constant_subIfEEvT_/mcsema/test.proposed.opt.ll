...
block_40f611:                                     ; preds = %entry
  ...
  %131 = tail call %struct.Memory* @__remill_function_call(%struct.State* nonnull %0, i64 ptrtoint (i64 (i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64)* @printf to i64), %struct.Memory* %call2_40f604)
...
block_.L_40f62c:                                  ; preds = %block_40f611, %entry
  %138 = phi i64 [ %123, %entry ], [ %.pre, %block_40f611 ]
  %MEMORY.0 = phi %struct.Memory* [ %call2_40f604, %entry ], [ %131, %block_40f611 ]
