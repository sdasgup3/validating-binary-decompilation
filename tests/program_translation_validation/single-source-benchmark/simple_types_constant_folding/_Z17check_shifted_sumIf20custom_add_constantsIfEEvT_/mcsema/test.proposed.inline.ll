...
entry:
  ...
  store %struct.Memory* %loadMem1_40f966, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_40f96b, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem1_40f984, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_40f989, %struct.Memory** %MEMORY
...
block_40f991:                                     ; preds = %entry
  ...
  store %struct.Memory* %loadMem_40f9a2, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem1_40f9a4, %struct.Memory** %MEMORY
  %loadMem2_40f9a4 = load %struct.Memory*, %struct.Memory** %MEMORY
  %loadPC_40f9a4 = load i64, i64* %3
  %314 = call %struct.Memory* @__remill_function_call(%struct.State* %0, i64 ptrtoint (i64 (i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64)* @printf to i64), %struct.Memory* %loadMem2_40f9a4)
...
block_.L_40f9ac:                                  ; preds = %block_40f991, %entry
  ...
  store %struct.Memory* %loadMem_40f9b0, %struct.Memory** %MEMORY
  ...
  ret %struct.Memory* %loadMem_40f9b1
}
