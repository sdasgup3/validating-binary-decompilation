...
define %struct.Memory* @_Z17check_shifted_sumIf20custom_add_constantsIfEEvT_(%struct.State* noalias, i64, %struct.Memory* noalias) #2 {
entry:
  ...
  store %struct.Memory* %loadMem1_40f976, %struct.Memory** %MEMORY
  ...
  %155 = add i64 %154, ptrtoint (%G_0x914d__rip__type* @G_0x914d__rip_ to i64)
  ...
  store %struct.Memory* %loadMem_40f98f, %struct.Memory** %MEMORY
...
block_40f9a1:                                     ; preds = %entry
  ...
  %314 = call %struct.Memory* @__remill_function_call(%struct.State* %0, i64 ptrtoint (i64 (i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64)* @printf to i64), %struct.Memory* %loadMem2_40f9b4)
...
define %struct.Memory* @routine_movss_0x914d__rip____xmm1(%struct.State* dereferenceable(3376), i64, %struct.Memory*) {
block_400488:
  %3 = getelementptr inbounds %struct.State, %struct.State* %0, i32 0, i32 6
  %4 = getelementptr inbounds %struct.GPR, %struct.GPR* %3, i32 0, i32 33
  %5 = getelementptr inbounds %struct.Reg, %struct.Reg* %4, i32 0, i32 0
