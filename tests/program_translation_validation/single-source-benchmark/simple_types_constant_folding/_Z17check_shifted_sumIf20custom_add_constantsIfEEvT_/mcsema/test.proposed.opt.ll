...
%G_0x9149__rip__type = type <{ [4 x i8] }>
...
@G_0x9149__rip_ = local_unnamed_addr global %G_0x9149__rip__type zeroinitializer
...
define %struct.Memory* @_Z17check_shifted_sumIf20custom_add_constantsIfEEvT_(%struct.State* noalias, i64, %struct.Memory* noalias) local_unnamed_addr #1 {
entry:
  ...
  %call2_40f92a = tail call %struct.Memory* @sub_40f8f0._ZN20custom_add_constantsIfE8do_shiftEf(%struct.State* %0, i64 %60, %struct.Memory* %2)
  ...
  %71 = load i32, i32* bitcast (%G_0x9149__rip__type* @G_0x9149__rip_ to i32*), align 8
  ...
  %call2_40f948 = tail call %struct.Memory* @sub_40f060._Z15tolerance_equalIfEbRT_S1_(%struct.State* %0, i64 %101, %struct.Memory* %call2_40f92a)
  ...
  br i1 %115, label %block_.L_40f970, label %block_40f955

block_40f955:                                     ; preds = %entry
  ...
  %124 = tail call %struct.Memory* @__remill_function_call(%struct.State* %0, i64 ptrtoint (i64 (i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64)* @printf to i64), %struct.Memory* %call2_40f948)
  ...
  br label %block_.L_40f970

block_.L_40f970:                                  ; preds = %block_40f955, %entry
  %131 = phi i64 [ %116, %entry ], [ %.pre, %block_40f955 ]
  %MEMORY.0 = phi %struct.Memory* [ %call2_40f948, %entry ], [ %124, %block_40f955 ]
...
define %struct.Memory* @routine_movss_0x9149__rip____xmm1(%struct.State* dereferenceable(3376), i64, %struct.Memory*) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  ...
  %6 = add i64 %5, 8
  store i64 %6, i64* %PC, align 8
  %7 = load i32, i32* bitcast (%G_0x9149__rip__type* @G_0x9149__rip_ to i32*), align 8
...
define %struct.Memory* @routine_jne_.L_40f970(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i8* %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
