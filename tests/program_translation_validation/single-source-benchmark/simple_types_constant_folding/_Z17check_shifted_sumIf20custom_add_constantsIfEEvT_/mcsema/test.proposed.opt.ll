...
%G_0x9149__rip__4258111__type = type <{ [16 x i8] }>
...
@G_0x9149__rip__4258111_ = local_unnamed_addr global %G_0x9149__rip__4258111__type zeroinitializer
...
entry:
  ...
  %71 = load i32, i32* bitcast (%G_0x9149__rip__4258111__type* @G_0x9149__rip__4258111_ to i32*), align 8
  ...
  %call2_40f948 = tail call %struct.Memory* @sub_40f060._Z15tolerance_equalIfEbRT_S1_(%struct.State* %0, i64 %100, %struct.Memory* %call2_40f92a)
  ...
  br i1 %114, label %block_.L_40f970, label %block_40f955
...
block_40f955:                                     ; preds = %entry
  ...
  %123 = tail call %struct.Memory* @__remill_function_call(%struct.State* %0, i64 ptrtoint (i64 (i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64)* @printf to i64), %struct.Memory* %call2_40f948)
...
block_.L_40f970:                                  ; preds = %block_40f955, %entry
  %130 = phi i64 [ %115, %entry ], [ %.pre, %block_40f955 ]
  %MEMORY.0 = phi %struct.Memory* [ %call2_40f948, %entry ], [ %123, %block_40f955 ]
...
block_400478:
  ...
  %6 = add i64 %5, 8
  store i64 %6, i64* %PC, align 8
  %7 = load i32, i32* bitcast (%G_0x9149__rip__4258111__type* @G_0x9149__rip__4258111_ to i32*), align 8
