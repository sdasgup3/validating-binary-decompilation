; ModuleID = '/tmp/tmp4myxpb11-query.ll'
...
%call2_40f976 = tail call %struct.Memory* @sub_40f940._ZN20custom_add_constantsIfE8do_shiftEf(%struct.State* %0, i64 %var_2_65, %struct.Memory* %2)
...
%var_2_76 = add i64 %var_2_72, add (i64 ptrtoint (%G_0x914d__rip__type* @G_0x914d__rip_ to i64), i64 8)
...
%var_2_108 = add i64 %var_2_107, -2276
...
%call2_40f994 = tail call %struct.Memory* @sub_40f0b0._Z15tolerance_equalIfEbRT_S1_(%struct.State* %0, i64 %var_2_108, %struct.Memory* %call2_40f976)
...
br i1 %var_2_122, label %block_.L_40f9bc, label %block_40f9a1
...
; Matched:%var_2_156:  %var_2_156 = add i64 %var_2_120, -62161
; %var_2_126 = add i64 %var_2_123, -62161
...
%var_2_131 = tail call %struct.Memory* @__remill_function_call(%struct.State* nonnull %0, i64 ptrtoint (i64 (i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64)* @printf to i64), %struct.Memory* %call2_40f994)
...
; Matched:%var_2_121:  %var_2_121 = phi i64 [ %var_2_120, %block_40f960 ], [ %.pre, %block_40f9a1 ]
; %var_2_138 = phi i64 [ %var_2_123, %entry ], [ %.pre, %block_40f9a1 ]
%MEMORY.0 = phi %struct.Memory* [ %call2_40f994, %entry ], [ %var_2_131, %block_40f9a1 ]
