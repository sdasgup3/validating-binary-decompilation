...
define %struct.Memory* @_Z17check_shifted_sumIf20custom_sub_constantsIfEEvT_(%struct.State* noalias, i64, %struct.Memory* noalias) #1 {
entry:
...
block_40f901:                                     ; preds = %entry
  ...
  %call2_40f914 = call %struct.Memory* @sub_4006c0.printf_plt(%struct.State* %0, i64 %loadPC_40f914, %struct.Memory* %loadMem2_40f914)
  store %struct.Memory* %call2_40f914, %struct.Memory** %MEMORY
