...
@G_0x97d9__rip__4256431_ = global %G_0x97d9__rip__4256431__type zeroinitializer
...
define %struct.Memory* @_Z17check_shifted_sumIf22custom_constant_divideIfEEvT_(%struct.State* noalias, i64, %struct.Memory* noalias) #2 {
entry:
  ...
  store %struct.Memory* %loadMem_40f296, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem1_40f29a, %struct.Memory** %MEMORY
  ...
  %173 = load float, float* bitcast (%G_0x97d9__rip__4256431__type* @G_0x97d9__rip__4256431_ to float*)
  ...
  store %struct.Memory* %loadMem_40f2a7, %struct.Memory** %MEMORY
...
block_40f2c5:                                     ; preds = %entry
  ...
  store %struct.Memory* %loadMem_40f2cf, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_40f2d6, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem1_40f2d8, %struct.Memory** %MEMORY
  %loadMem2_40f2d8 = load %struct.Memory*, %struct.Memory** %MEMORY
  %loadPC_40f2d8 = load i64, i64* %3
  %328 = call %struct.Memory* @__remill_function_call(%struct.State* %0, i64 ptrtoint (i64 (i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64)* @printf to i64), %struct.Memory* %loadMem2_40f2d8)
...
block_.L_40f2e0:                                  ; preds = %block_40f2c5, %entry
  ...
  store %struct.Memory* %loadMem_40f2e0, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_40f2e4, %struct.Memory** %MEMORY
  ...
  ret %struct.Memory* %loadMem_40f2e5
}
...
define %struct.Memory* @routine_movss_0x97d9__rip____xmm1(%struct.State* dereferenceable(3376), i64, %struct.Memory*) {
block_400478:
  %3 = getelementptr inbounds %struct.State, %struct.State* %0, i32 0, i32 6
  %4 = getelementptr inbounds %struct.GPR, %struct.GPR* %3, i32 0, i32 33
  %5 = getelementptr inbounds %struct.Reg, %struct.Reg* %4, i32 0, i32 0
