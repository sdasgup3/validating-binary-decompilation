...
entry:
  ...
  store %struct.Memory* %loadMem_40f2d0, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_40f2d4, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_40f2d8, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem1_40f2e6, %struct.Memory** %MEMORY
  ...
  %155 = add i64 %154, ptrtoint (%G_0x97dd__rip__type* @G_0x97dd__rip_ to i64)
  ...
  store %struct.Memory* %loadMem_40f2ff, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem1_40f304, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_40f309, %struct.Memory** %MEMORY
...
block_40f311:                                     ; preds = %entry
  ...
  store %struct.Memory* %loadMem_40f31b, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_40f322, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem1_40f324, %struct.Memory** %MEMORY
  %loadMem2_40f324 = load %struct.Memory*, %struct.Memory** %MEMORY
  %loadPC_40f324 = load i64, i64* %3
  %314 = call %struct.Memory* @__remill_function_call(%struct.State* %0, i64 ptrtoint (i64 (i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64)* @printf to i64), %struct.Memory* %loadMem2_40f324)
  ...
  store %struct.Memory* %loadMem_40f329, %struct.Memory** %MEMORY
...
block_.L_40f32c:                                  ; preds = %block_40f311, %entry
  ...
  store %struct.Memory* %loadMem_40f32c, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_40f330, %struct.Memory** %MEMORY
  ...
  ret %struct.Memory* %loadMem_40f331
}
...
define %struct.Memory* @routine_movss_0x97dd__rip____xmm1(%struct.State* dereferenceable(3376), i64, %struct.Memory*) {
block_400488:
  %3 = getelementptr inbounds %struct.State, %struct.State* %0, i32 0, i32 6
  %4 = getelementptr inbounds %struct.GPR, %struct.GPR* %3, i32 0, i32 33
  %5 = getelementptr inbounds %struct.Reg, %struct.Reg* %4, i32 0, i32 0
