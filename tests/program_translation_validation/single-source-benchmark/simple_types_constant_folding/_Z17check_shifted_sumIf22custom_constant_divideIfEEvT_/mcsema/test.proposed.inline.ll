...
entry:
  ...
  store %struct.Memory* %loadMem_40f2c8, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem1_40f2d6, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_40f2df, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem1_40f2f4, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_40f2f9, %struct.Memory** %MEMORY
...
block_40f301:                                     ; preds = %entry
  ...
  store %struct.Memory* %loadMem_40f312, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem1_40f314, %struct.Memory** %MEMORY
  %loadMem2_40f314 = load %struct.Memory*, %struct.Memory** %MEMORY
  %loadPC_40f314 = load i64, i64* %3
  %314 = call %struct.Memory* @__remill_function_call(%struct.State* %0, i64 ptrtoint (i64 (i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64)* @printf to i64), %struct.Memory* %loadMem2_40f314)
  ...
  store %struct.Memory* %loadMem_40f319, %struct.Memory** %MEMORY
...
block_.L_40f31c:                                  ; preds = %block_40f301, %entry
  ...
  store %struct.Memory* %loadMem_40f31c, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_40f321, %struct.Memory** %MEMORY
  ret %struct.Memory* %loadMem_40f321
}
