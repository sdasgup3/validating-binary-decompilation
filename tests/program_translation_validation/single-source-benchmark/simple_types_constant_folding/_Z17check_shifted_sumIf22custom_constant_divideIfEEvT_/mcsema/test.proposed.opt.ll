...
%G_0x97d9__rip__type = type <{ [4 x i8] }>
...
@G_0x97d9__rip_ = local_unnamed_addr global %G_0x97d9__rip__type zeroinitializer
...
declare %struct.Memory* @sub_40f260._ZN22custom_constant_divideIfE8do_shiftEf(%struct.State* noalias dereferenceable(3376), i64, %struct.Memory* noalias readnone returned) local_unnamed_addr
...
define %struct.Memory* @_Z17check_shifted_sumIf22custom_constant_divideIfEEvT_(%struct.State* noalias, i64, %struct.Memory* noalias) local_unnamed_addr #1 {
entry:
  ...
  %call2_40f29a = tail call %struct.Memory* @sub_40f260._ZN22custom_constant_divideIfE8do_shiftEf(%struct.State* %0, i64 %60, %struct.Memory* %2)
  ...
  %71 = load i32, i32* bitcast (%G_0x97d9__rip__type* @G_0x97d9__rip_ to i32*), align 8
  ...
  %call2_40f2b8 = tail call %struct.Memory* @sub_40f060._Z15tolerance_equalIfEbRT_S1_(%struct.State* %0, i64 %101, %struct.Memory* %call2_40f29a)
  ...
  br i1 %115, label %block_.L_40f2e0, label %block_40f2c5

block_40f2c5:                                     ; preds = %entry
  ...
  %124 = tail call %struct.Memory* @__remill_function_call(%struct.State* %0, i64 ptrtoint (i64 (i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64)* @printf to i64), %struct.Memory* %call2_40f2b8)
  ...
  br label %block_.L_40f2e0

block_.L_40f2e0:                                  ; preds = %block_40f2c5, %entry
  %131 = phi i64 [ %116, %entry ], [ %.pre, %block_40f2c5 ]
  %MEMORY.0 = phi %struct.Memory* [ %call2_40f2b8, %entry ], [ %124, %block_40f2c5 ]
...
define %struct.Memory* @routine_callq_._ZN22custom_constant_divideIfE8do_shiftEf(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
...
define %struct.Memory* @routine_movss_0x97d9__rip____xmm1(%struct.State* dereferenceable(3376), i64, %struct.Memory*) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  ...
  %6 = add i64 %5, 8
  store i64 %6, i64* %PC, align 8
  %7 = load i32, i32* bitcast (%G_0x97d9__rip__type* @G_0x97d9__rip_ to i32*), align 8
...
define %struct.Memory* @routine_jne_.L_40f2e0(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i8* %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
