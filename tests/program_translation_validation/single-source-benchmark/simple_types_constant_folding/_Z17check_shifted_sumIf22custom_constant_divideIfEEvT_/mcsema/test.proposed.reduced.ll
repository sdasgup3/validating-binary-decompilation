; ModuleID = '/tmp/tmphhmee311-query.ll'
...
%call2_40f2e6 = tail call %struct.Memory* @sub_40f2b0._ZN22custom_constant_divideIfE8do_shiftEf(%struct.State* %0, i64 %var_2_65, %struct.Memory* %2)
...
%var_2_76 = add i64 %var_2_72, add (i64 ptrtoint (%G_0x97dd__rip__type* @G_0x97dd__rip_ to i64), i64 8)
...
%var_2_108 = add i64 %var_2_107, -596
...
%call2_40f304 = tail call %struct.Memory* @sub_40f0b0._Z15tolerance_equalIfEbRT_S1_(%struct.State* %0, i64 %var_2_108, %struct.Memory* %call2_40f2e6)
...
br i1 %var_2_122, label %block_.L_40f32c, label %block_40f311
...
; Matched:%var_2_156:  %var_2_156 = add i64 %var_2_120, -60481
; %var_2_126 = add i64 %var_2_123, -60481
...
%var_2_131 = tail call %struct.Memory* @__remill_function_call(%struct.State* nonnull %0, i64 ptrtoint (i64 (i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64)* @printf to i64), %struct.Memory* %call2_40f304)
...
; Matched:%var_2_121:  %var_2_121 = phi i64 [ %var_2_120, %block_40f2d0 ], [ %.pre, %block_40f311 ]
; %var_2_138 = phi i64 [ %var_2_123, %entry ], [ %.pre, %block_40f311 ]
%MEMORY.0 = phi %struct.Memory* [ %call2_40f304, %entry ], [ %var_2_131, %block_40f311 ]
