...
%G_0x92f9__rip__4257679__type = type <{ [16 x i8] }>
...
@G_0x92f9__rip__4257679_ = global %G_0x92f9__rip__4257679__type zeroinitializer
...
entry:
  ...
  store %struct.Memory* %loadMem_40f764, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_40f76d, %struct.Memory** %MEMORY
  %loadMem_40f776 = load %struct.Memory*, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_40f776, %struct.Memory** %MEMORY
  %loadMem1_40f77a = load %struct.Memory*, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem1_40f77a, %struct.Memory** %MEMORY
  %loadMem2_40f77a = load %struct.Memory*, %struct.Memory** %MEMORY
  %loadPC_40f77a = load i64, i64* %3
  %call2_40f77a = call %struct.Memory* @sub_40f740._ZN23custom_divide_constantsIfE8do_shiftEf(%struct.State* %0, i64 %loadPC_40f77a, %struct.Memory* %loadMem2_40f77a)
  store %struct.Memory* %call2_40f77a, %struct.Memory** %MEMORY
  %loadMem_40f77f = load %struct.Memory*, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_40f77f, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_40f783, %struct.Memory** %MEMORY
  ...
  %173 = load float, float* bitcast (%G_0x92f9__rip__4257679__type* @G_0x92f9__rip__4257679_ to float*)
  ...
  store %struct.Memory* %loadMem_40f787, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem1_40f798, %struct.Memory** %MEMORY
  %loadMem2_40f798 = load %struct.Memory*, %struct.Memory** %MEMORY
  %loadPC_40f798 = load i64, i64* %3
  %call2_40f798 = call %struct.Memory* @sub_40f060._Z15tolerance_equalIfEbRT_S1_(%struct.State* %0, i64 %loadPC_40f798, %struct.Memory* %loadMem2_40f798)
  store %struct.Memory* %call2_40f798, %struct.Memory** %MEMORY
  %loadMem_40f79d = load %struct.Memory*, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_40f79d, %struct.Memory** %MEMORY
  %loadMem_40f79f = load %struct.Memory*, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_40f79f, %struct.Memory** %MEMORY
  %loadBr_40f79f = load i8, i8* %BRANCH_TAKEN
  %cmpBr_40f79f = icmp eq i8 %loadBr_40f79f, 1
  br i1 %cmpBr_40f79f, label %block_.L_40f7c0, label %block_40f7a5

block_40f7a5:                                     ; preds = %entry
  ...
  %loadMem1_40f7b8 = load %struct.Memory*, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem1_40f7b8, %struct.Memory** %MEMORY
  %loadMem2_40f7b8 = load %struct.Memory*, %struct.Memory** %MEMORY
  %loadPC_40f7b8 = load i64, i64* %3
  %328 = call %struct.Memory* @__remill_function_call(%struct.State* %0, i64 ptrtoint (i64 (i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64)* @printf to i64), %struct.Memory* %loadMem2_40f7b8)
  ...
  br label %block_.L_40f7c0

block_.L_40f7c0:                                  ; preds = %block_40f7a5, %entry
  ...
  store %struct.Memory* %loadMem_40f7c5, %struct.Memory** %MEMORY
  ret %struct.Memory* %loadMem_40f7c5
}
...
define %struct.Memory* @routine_movss_0x92f9__rip____xmm1(%struct.State* dereferenceable(3376), i64, %struct.Memory*) {
block_400478:
  %3 = getelementptr inbounds %struct.State, %struct.State* %0, i32 0, i32 6
  %4 = getelementptr inbounds %struct.GPR, %struct.GPR* %3, i32 0, i32 33
  %5 = getelementptr inbounds %struct.Reg, %struct.Reg* %4, i32 0, i32 0
  ...
  %9 = load i64, i64* %PC
  %10 = ptrtoint %G_0x92f9__rip__4257679__type* @G_0x92f9__rip__4257679_ to i64
  %11 = load i64, i64* %PC
  %12 = add i64 %11, 8
  store i64 %12, i64* %PC
...
define %struct.Memory* @routine_jne_.L_40f7c0(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i8* %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) {
block_400478:
  %3 = getelementptr inbounds %struct.State, %struct.State* %0, i32 0, i32 6
  %4 = getelementptr inbounds %struct.GPR, %struct.GPR* %3, i32 0, i32 33
  %5 = getelementptr inbounds %struct.Reg, %struct.Reg* %4, i32 0, i32 0
