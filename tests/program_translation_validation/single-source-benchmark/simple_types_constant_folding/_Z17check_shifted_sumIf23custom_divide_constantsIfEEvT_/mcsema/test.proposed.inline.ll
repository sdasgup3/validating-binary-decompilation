...
block_40f7e1:                                     ; preds = %entry
  ...
  %call2_40f7f4 = call %struct.Memory* @sub_4006c0.printf_plt(%struct.State* %0, i64 %loadPC_40f7f4, %struct.Memory* %loadMem2_40f7f4)
  store %struct.Memory* %call2_40f7f4, %struct.Memory** %MEMORY
