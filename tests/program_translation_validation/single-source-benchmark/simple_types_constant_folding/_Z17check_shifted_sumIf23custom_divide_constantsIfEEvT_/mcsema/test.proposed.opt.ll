...
block_40f7e1:                                     ; preds = %entry
  ...
  %131 = tail call %struct.Memory* @__remill_function_call(%struct.State* nonnull %0, i64 ptrtoint (i64 (i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64)* @printf to i64), %struct.Memory* %call2_40f7d4)
...
block_.L_40f7fc:                                  ; preds = %block_40f7e1, %entry
  %138 = phi i64 [ %123, %entry ], [ %.pre, %block_40f7e1 ]
  %MEMORY.0 = phi %struct.Memory* [ %call2_40f7d4, %entry ], [ %131, %block_40f7e1 ]
