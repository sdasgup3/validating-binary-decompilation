...
@G_0x9609__rip__4256895_ = global %G_0x9609__rip__4256895__type zeroinitializer
...
define %struct.Memory* @_Z17check_shifted_sumIf24custom_constant_multiplyIfEEvT_(%struct.State* noalias, i64, %struct.Memory* noalias) #2 {
entry:
  ...
  store %struct.Memory* %loadMem_40f450, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem1_40f46a, %struct.Memory** %MEMORY
  ...
  %173 = load float, float* bitcast (%G_0x9609__rip__4256895__type* @G_0x9609__rip__4256895_ to float*)
  ...
  store %struct.Memory* %loadMem_40f477, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_40f47f, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_40f483, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem1_40f488, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_40f48d, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_40f48f, %struct.Memory** %MEMORY
...
block_40f495:                                     ; preds = %entry
  ...
  %328 = call %struct.Memory* @__remill_function_call(%struct.State* %0, i64 ptrtoint (i64 (i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64)* @printf to i64), %struct.Memory* %loadMem2_40f4a8)
...
block_.L_40f4b0:                                  ; preds = %block_40f495, %entry
  ...
  ret %struct.Memory* %loadMem_40f4b5
}
...
define %struct.Memory* @routine_movss_0x9609__rip____xmm1(%struct.State* dereferenceable(3376), i64, %struct.Memory*) {
block_400478:
  %3 = getelementptr inbounds %struct.State, %struct.State* %0, i32 0, i32 6
  %4 = getelementptr inbounds %struct.GPR, %struct.GPR* %3, i32 0, i32 33
  %5 = getelementptr inbounds %struct.Reg, %struct.Reg* %4, i32 0, i32 0
