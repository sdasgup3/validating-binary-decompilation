...
entry:
  ...
  store %struct.Memory* %loadMem1_40f4b6, %struct.Memory** %MEMORY
  ...
  %155 = add i64 %154, ptrtoint (%G_0x960d__rip__type* @G_0x960d__rip_ to i64)
  ...
  store %struct.Memory* %loadMem_40f4cf, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem1_40f4d4, %struct.Memory** %MEMORY
...
block_40f4e1:                                     ; preds = %entry
  ...
  store %struct.Memory* %loadMem1_40f4f4, %struct.Memory** %MEMORY
  %loadMem2_40f4f4 = load %struct.Memory*, %struct.Memory** %MEMORY
  %loadPC_40f4f4 = load i64, i64* %3
  %314 = call %struct.Memory* @__remill_function_call(%struct.State* %0, i64 ptrtoint (i64 (i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64)* @printf to i64), %struct.Memory* %loadMem2_40f4f4)
...
block_.L_40f4fc:                                  ; preds = %block_40f4e1, %entry
  ...
  ret %struct.Memory* %loadMem_40f501
}
