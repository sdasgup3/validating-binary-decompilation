...
entry:
  ...
  store %struct.Memory* %loadMem_40f830, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem1_40f846, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_40f84f, %struct.Memory** %MEMORY
...
block_40f871:                                     ; preds = %entry
  ...
  %314 = call %struct.Memory* @__remill_function_call(%struct.State* %0, i64 ptrtoint (i64 (i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64)* @printf to i64), %struct.Memory* %loadMem2_40f884)
