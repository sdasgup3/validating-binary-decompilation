...
@G_0x9269__rip__4257823_ = global %G_0x9269__rip__4257823__type zeroinitializer
...
define %struct.Memory* @_Z17check_shifted_sumIf25custom_multiply_constantsIfEEvT_(%struct.State* noalias, i64, %struct.Memory* noalias) #2 {
entry:
  ...
  store %struct.Memory* %loadMem_40f7f0, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_40f7f8, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_40f806, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem1_40f80a, %struct.Memory** %MEMORY
  ...
  %173 = load float, float* bitcast (%G_0x9269__rip__4257823__type* @G_0x9269__rip__4257823_ to float*)
  ...
  store %struct.Memory* %loadMem_40f81f, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem1_40f828, %struct.Memory** %MEMORY
...
block_40f835:                                     ; preds = %entry
  ...
  store %struct.Memory* %loadMem_40f83f, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem1_40f848, %struct.Memory** %MEMORY
  %loadMem2_40f848 = load %struct.Memory*, %struct.Memory** %MEMORY
  %loadPC_40f848 = load i64, i64* %3
  %328 = call %struct.Memory* @__remill_function_call(%struct.State* %0, i64 ptrtoint (i64 (i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64)* @printf to i64), %struct.Memory* %loadMem2_40f848)
...
block_.L_40f850:                                  ; preds = %block_40f835, %entry
  ...
  store %struct.Memory* %loadMem_40f855, %struct.Memory** %MEMORY
  ret %struct.Memory* %loadMem_40f855
}
...
define %struct.Memory* @routine_movss_0x9269__rip____xmm1(%struct.State* dereferenceable(3376), i64, %struct.Memory*) {
block_400478:
  %3 = getelementptr inbounds %struct.State, %struct.State* %0, i32 0, i32 6
  %4 = getelementptr inbounds %struct.GPR, %struct.GPR* %3, i32 0, i32 33
  %5 = getelementptr inbounds %struct.Reg, %struct.Reg* %4, i32 0, i32 0
