...
entry:
  ...
  store i64 %71, i64* %RDI.i27, align 8
  ...
  %AL.i16 = bitcast %union.anon* %113 to i8*
...
block_40f871:                                     ; preds = %entry
  store i64 4300168, i64* %RDI.i27, align 8
  %124 = load i32, i32* inttoptr (i64 6430888 to i32*), align 8
  %125 = zext i32 %124 to i64
  store i64 %125, i64* %RSI.i24, align 8
  ...
  %131 = tail call %struct.Memory* @__remill_function_call(%struct.State* nonnull %0, i64 ptrtoint (i64 (i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64)* @printf to i64), %struct.Memory* %call2_40f864)
...
block_.L_40f88c:                                  ; preds = %block_40f871, %entry
  %138 = phi i64 [ %123, %entry ], [ %.pre, %block_40f871 ]
  %MEMORY.0 = phi %struct.Memory* [ %call2_40f864, %entry ], [ %131, %block_40f871 ]
