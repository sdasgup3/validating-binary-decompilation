...
define %struct.Memory* @_Z17check_shifted_sumIf28custom_multiple_constant_addIfEEvT_(%struct.State* noalias, i64, %struct.Memory* noalias) #1 {
entry:
...
block_40f6c1:                                     ; preds = %entry
  ...
  %call2_40f6d4 = call %struct.Memory* @sub_4006c0.printf_plt(%struct.State* %0, i64 %loadPC_40f6d4, %struct.Memory* %loadMem2_40f6d4)
  store %struct.Memory* %call2_40f6d4, %struct.Memory** %MEMORY
