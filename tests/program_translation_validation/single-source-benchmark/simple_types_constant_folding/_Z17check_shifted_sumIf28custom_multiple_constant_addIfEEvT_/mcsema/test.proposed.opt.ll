...
define %struct.Memory* @_Z17check_shifted_sumIf28custom_multiple_constant_addIfEEvT_(%struct.State* noalias, i64, %struct.Memory* noalias readnone) local_unnamed_addr #1 {
entry:
...
block_40f6c1:                                     ; preds = %entry
  ...
  %call2_40f6d4 = tail call %struct.Memory* @sub_4006c0.printf_plt(%struct.State* nonnull %0, i64 %126, %struct.Memory* %call2_40f6b4)
...
block_.L_40f6dc:                                  ; preds = %block_40f6c1, %entry
  %137 = phi i64 [ %123, %entry ], [ %.pre, %block_40f6c1 ]
  %MEMORY.0 = phi %struct.Memory* [ %call2_40f6b4, %entry ], [ %call2_40f6d4, %block_40f6c1 ]
