; ModuleID = '/tmp/tmpd1t4vlni-query.ll'
...
define %struct.Memory* @_Z17check_shifted_sumIf28custom_multiple_constant_addIfEEvT_(%struct.State* noalias, i64, %struct.Memory* noalias) local_unnamed_addr #1 {
entry:
...
%call2_40f6a6 = tail call %struct.Memory* @sub_40f650._ZN28custom_multiple_constant_addIfE8do_shiftEf(%struct.State* %0, i64 %var_2_65, %struct.Memory* %2)
...
%var_2_76 = add i64 %var_2_72, add (i64 ptrtoint (%G_0x941d__rip__type* @G_0x941d__rip_ to i64), i64 8)
...
%var_2_108 = add i64 %var_2_107, -1556
...
%call2_40f6c4 = tail call %struct.Memory* @sub_40f0b0._Z15tolerance_equalIfEbRT_S1_(%struct.State* %0, i64 %var_2_108, %struct.Memory* %call2_40f6a6)
...
br i1 %var_2_122, label %block_.L_40f6ec, label %block_40f6d1
...
; Matched:%var_2_156:  %var_2_156 = add i64 %var_2_120, -61441
; %var_2_126 = add i64 %var_2_123, -61441
...
%var_2_131 = tail call %struct.Memory* @__remill_function_call(%struct.State* nonnull %0, i64 ptrtoint (i64 (i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64)* @printf to i64), %struct.Memory* %call2_40f6c4)
...
; Matched:%var_2_121:  %var_2_121 = phi i64 [ %var_2_120, %block_40f690 ], [ %.pre, %block_40f6d1 ]
; %var_2_138 = phi i64 [ %var_2_123, %entry ], [ %.pre, %block_40f6d1 ]
%MEMORY.0 = phi %struct.Memory* [ %call2_40f6c4, %entry ], [ %var_2_131, %block_40f6d1 ]
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_movss_0x941d__rip____xmm1(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_jne_.L_40f6ec(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i8* nocapture %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
