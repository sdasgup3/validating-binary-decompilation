...
define %struct.Memory* @_Z17check_shifted_sumIf28custom_multiple_constant_subIfEEvT_(%struct.State* noalias, i64, %struct.Memory* noalias) #1 {
entry:
...
block_40f581:                                     ; preds = %entry
  ...
  %call2_40f594 = call %struct.Memory* @sub_4006c0.printf_plt(%struct.State* %0, i64 %loadPC_40f594, %struct.Memory* %loadMem2_40f594)
  store %struct.Memory* %call2_40f594, %struct.Memory** %MEMORY
