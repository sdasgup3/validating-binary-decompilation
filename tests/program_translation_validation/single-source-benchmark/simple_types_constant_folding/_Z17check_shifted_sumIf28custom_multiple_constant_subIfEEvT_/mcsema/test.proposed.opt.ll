...
declare %struct.Memory* @sub_40f500._ZN28custom_multiple_constant_subIfE8do_shiftEf(%struct.State* noalias dereferenceable(3376), i64, %struct.Memory* noalias readnone returned) local_unnamed_addr
...
entry:
  ...
  %call2_40f556 = tail call %struct.Memory* @sub_40f500._ZN28custom_multiple_constant_subIfE8do_shiftEf(%struct.State* %0, i64 %65, %struct.Memory* %2)
  ...
  %call2_40f574 = tail call %struct.Memory* @sub_40f0a0._Z15tolerance_equalIfEbRT_S1_(%struct.State* %0, i64 %108, %struct.Memory* %call2_40f556)
  ...
  br i1 %122, label %block_.L_40f59c, label %block_40f581
...
block_40f581:                                     ; preds = %entry
  ...
  %131 = tail call %struct.Memory* @__remill_function_call(%struct.State* nonnull %0, i64 ptrtoint (i64 (i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64)* @printf to i64), %struct.Memory* %call2_40f574)
...
block_.L_40f59c:                                  ; preds = %block_40f581, %entry
  %138 = phi i64 [ %123, %entry ], [ %.pre, %block_40f581 ]
  %MEMORY.0 = phi %struct.Memory* [ %call2_40f574, %entry ], [ %131, %block_40f581 ]
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_jne_.L_40f59c(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i8* nocapture %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
