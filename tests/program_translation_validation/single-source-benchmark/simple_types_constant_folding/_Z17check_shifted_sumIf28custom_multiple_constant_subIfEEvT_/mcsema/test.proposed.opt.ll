...
define %struct.Memory* @_Z17check_shifted_sumIf28custom_multiple_constant_subIfEEvT_(%struct.State* noalias, i64, %struct.Memory* noalias readnone) local_unnamed_addr #1 {
entry:
...
block_40f581:                                     ; preds = %entry
  ...
  %call2_40f594 = tail call %struct.Memory* @sub_4006c0.printf_plt(%struct.State* nonnull %0, i64 %126, %struct.Memory* %call2_40f574)
...
block_.L_40f59c:                                  ; preds = %block_40f581, %entry
  %137 = phi i64 [ %123, %entry ], [ %.pre, %block_40f581 ]
  %MEMORY.0 = phi %struct.Memory* [ %call2_40f574, %entry ], [ %call2_40f594, %block_40f581 ]
