...
declare %struct.Memory* @sub_40f500._ZN28custom_multiple_constant_subIfE8do_shiftEf(%struct.State* dereferenceable(3376), i64, %struct.Memory*) local_unnamed_addr
