; ModuleID = '/tmp/tmpyh9lx4sq-query.ll'
...
%call2_40f566 = tail call %struct.Memory* @sub_40f510._ZN28custom_multiple_constant_subIfE8do_shiftEf(%struct.State* %0, i64 %var_2_65, %struct.Memory* %2)
...
%var_2_76 = add i64 %var_2_72, add (i64 ptrtoint (%G_0x955d__rip__type* @G_0x955d__rip_ to i64), i64 8)
...
%var_2_108 = add i64 %var_2_107, -1236
...
%call2_40f584 = tail call %struct.Memory* @sub_40f0b0._Z15tolerance_equalIfEbRT_S1_(%struct.State* %0, i64 %var_2_108, %struct.Memory* %call2_40f566)
...
br i1 %var_2_122, label %block_.L_40f5ac, label %block_40f591
...
; Matched:%var_2_156:  %var_2_156 = add i64 %var_2_120, -61121
; %var_2_126 = add i64 %var_2_123, -61121
...
%var_2_131 = tail call %struct.Memory* @__remill_function_call(%struct.State* nonnull %0, i64 ptrtoint (i64 (i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64)* @printf to i64), %struct.Memory* %call2_40f584)
...
; Matched:%var_2_121:  %var_2_121 = phi i64 [ %var_2_120, %block_40f550 ], [ %.pre, %block_40f591 ]
; %var_2_138 = phi i64 [ %var_2_123, %entry ], [ %.pre, %block_40f591 ]
%MEMORY.0 = phi %struct.Memory* [ %call2_40f584, %entry ], [ %var_2_131, %block_40f591 ]
