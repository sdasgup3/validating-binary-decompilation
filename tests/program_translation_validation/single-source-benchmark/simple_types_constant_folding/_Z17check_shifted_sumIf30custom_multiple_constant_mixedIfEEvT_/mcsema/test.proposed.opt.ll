...
@G_0x9a69__rip__4255775_ = local_unnamed_addr global %G_0x9a69__rip__4255775__type zeroinitializer
...
entry:
  ...
  %71 = load i32, i32* bitcast (%G_0x9a69__rip__4255775__type* @G_0x9a69__rip__4255775_ to i32*), align 8
  ...
  %96 = load <2 x float>, <2 x float>* %80, align 1
  %97 = extractelement <2 x float> %96, i32 0
  %98 = inttoptr i64 %68 to float*
  ...
  %call2_40f028 = tail call %struct.Memory* @sub_40f060._Z15tolerance_equalIfEbRT_S1_(%struct.State* %0, i64 %100, %struct.Memory* %call2_40f00a)
  %105 = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 1, i32 0
  %AL.i16 = bitcast %union.anon* %105 to i8*
  %106 = load i8, i8* %AL.i16, align 1
  ...
  %.v = select i1 %114, i64 35, i64 8
  %115 = add i64 %107, %.v
  store i64 %115, i64* %3, align 8
  br i1 %114, label %block_.L_40f050, label %block_40f035

block_40f035:                                     ; preds = %entry
  store i64 ptrtoint (%G__0x419d48_type* @G__0x419d48 to i64), i64* %RDI.i27, align 8
  %116 = load i32, i32* bitcast (%G_0x6220a8_type* @G_0x6220a8 to i32*), align 8
  %117 = zext i32 %116 to i64
  store i64 %117, i64* %RSI.i24, align 8
  store i8 0, i8* %AL.i16, align 1
  %118 = add i64 %115, -59829
  %119 = add i64 %115, 24
  ...
  %123 = tail call %struct.Memory* @__remill_function_call(%struct.State* %0, i64 ptrtoint (i64 (i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64)* @printf to i64), %struct.Memory* %call2_40f028)
  %EAX.i = bitcast %union.anon* %105 to i32*
  %124 = load i64, i64* %RBP.i, align 8
  %125 = add i64 %124, -12
  %126 = load i32, i32* %EAX.i, align 4
...
block_.L_40f050:                                  ; preds = %block_40f035, %entry
  %130 = phi i64 [ %115, %entry ], [ %.pre, %block_40f035 ]
  %MEMORY.0 = phi %struct.Memory* [ %call2_40f028, %entry ], [ %123, %block_40f035 ]
  %131 = load i64, i64* %6, align 8
  %132 = add i64 %131, 16
  store i64 %132, i64* %6, align 8
  %133 = icmp ugt i64 %131, -17
...
block_400478:
  ...
  %6 = add i64 %5, 8
  store i64 %6, i64* %PC, align 8
  %7 = load i32, i32* bitcast (%G_0x9a69__rip__4255775__type* @G_0x9a69__rip__4255775_ to i32*), align 8
