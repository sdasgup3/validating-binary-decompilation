...
declare %struct.Memory* @sub_40f000._ZN30custom_multiple_constant_mixedIfE8do_shiftEf(%struct.State* dereferenceable(3376), i64, %struct.Memory*) local_unnamed_addr
