...
@G_0x9869__rip__4256287_ = global %G_0x9869__rip__4256287__type zeroinitializer
...
define %struct.Memory* @_Z17check_shifted_sumIf31custom_multiple_constant_divideIfEEvT_(%struct.State* noalias, i64, %struct.Memory* noalias) #2 {
entry:
  ...
  store %struct.Memory* %loadMem_40f1fd, %struct.Memory** %MEMORY
  ...
  %173 = load float, float* bitcast (%G_0x9869__rip__4256287__type* @G_0x9869__rip__4256287_ to float*)
  ...
  store %struct.Memory* %loadMem1_40f228, %struct.Memory** %MEMORY
...
block_40f235:                                     ; preds = %entry
  ...
  store %struct.Memory* %loadMem_40f235, %struct.Memory** %MEMORY
  ...
  %328 = call %struct.Memory* @__remill_function_call(%struct.State* %0, i64 ptrtoint (i64 (i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64)* @printf to i64), %struct.Memory* %loadMem2_40f248)
...
block_.L_40f250:                                  ; preds = %block_40f235, %entry
  ...
  store %struct.Memory* %loadMem_40f255, %struct.Memory** %MEMORY
  ret %struct.Memory* %loadMem_40f255
}
...
define %struct.Memory* @routine_movss_0x9869__rip____xmm1(%struct.State* dereferenceable(3376), i64, %struct.Memory*) {
block_400478:
  %3 = getelementptr inbounds %struct.State, %struct.State* %0, i32 0, i32 6
  %4 = getelementptr inbounds %struct.GPR, %struct.GPR* %3, i32 0, i32 33
  %5 = getelementptr inbounds %struct.Reg, %struct.Reg* %4, i32 0, i32 0
