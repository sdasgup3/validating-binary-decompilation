...
entry:
  ...
  store %struct.Memory* %loadMem1_40f256, %struct.Memory** %MEMORY
  ...
  %155 = add i64 %154, ptrtoint (%G_0x986d__rip__type* @G_0x986d__rip_ to i64)
  ...
  store %struct.Memory* %loadMem_40f26f, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem1_40f274, %struct.Memory** %MEMORY
...
block_40f281:                                     ; preds = %entry
  ...
  store %struct.Memory* %loadMem1_40f294, %struct.Memory** %MEMORY
  %loadMem2_40f294 = load %struct.Memory*, %struct.Memory** %MEMORY
  %loadPC_40f294 = load i64, i64* %3
  %314 = call %struct.Memory* @__remill_function_call(%struct.State* %0, i64 ptrtoint (i64 (i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64)* @printf to i64), %struct.Memory* %loadMem2_40f294)
...
block_.L_40f29c:                                  ; preds = %block_40f281, %entry
  ...
  ret %struct.Memory* %loadMem_40f2a1
}
