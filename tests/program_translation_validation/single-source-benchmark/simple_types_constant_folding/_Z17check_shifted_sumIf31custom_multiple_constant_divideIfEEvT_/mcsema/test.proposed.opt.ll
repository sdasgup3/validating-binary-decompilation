...
%G_0x986d__rip__type = type <{ [4 x i8] }>
...
@G_0x986d__rip_ = global %G_0x986d__rip__type zeroinitializer
...
declare %struct.Memory* @sub_40f200._ZN31custom_multiple_constant_divideIfE8do_shiftEf(%struct.State* noalias dereferenceable(3376), i64, %struct.Memory* noalias readnone returned) local_unnamed_addr
...
entry:
  ...
  %call2_40f256 = tail call %struct.Memory* @sub_40f200._ZN31custom_multiple_constant_divideIfE8do_shiftEf(%struct.State* %0, i64 %65, %struct.Memory* %2)
  ...
  %76 = add i64 %72, add (i64 ptrtoint (%G_0x986d__rip__type* @G_0x986d__rip_ to i64), i64 8)
  %77 = add i64 %72, 16
  ...
  %call2_40f274 = tail call %struct.Memory* @sub_40f0b0._Z15tolerance_equalIfEbRT_S1_(%struct.State* %0, i64 %108, %struct.Memory* %call2_40f256)
  ...
  br i1 %122, label %block_.L_40f29c, label %block_40f281

block_40f281:                                     ; preds = %entry
  ...
  %131 = tail call %struct.Memory* @__remill_function_call(%struct.State* nonnull %0, i64 ptrtoint (i64 (i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64)* @printf to i64), %struct.Memory* %call2_40f274)
  ...
  br label %block_.L_40f29c

block_.L_40f29c:                                  ; preds = %block_40f281, %entry
  %138 = phi i64 [ %123, %entry ], [ %.pre, %block_40f281 ]
  %MEMORY.0 = phi %struct.Memory* [ %call2_40f274, %entry ], [ %131, %block_40f281 ]
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_movss_0x986d__rip____xmm1(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 1, i64 1
  %4 = bitcast %union.VectorReg* %3 to i8*
  %5 = load i64, i64* %PC, align 8
  %6 = add i64 %5, ptrtoint (%G_0x986d__rip__type* @G_0x986d__rip_ to i64)
  %7 = add i64 %5, 8
  store i64 %7, i64* %PC, align 8
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_jne_.L_40f29c(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i8* nocapture %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
