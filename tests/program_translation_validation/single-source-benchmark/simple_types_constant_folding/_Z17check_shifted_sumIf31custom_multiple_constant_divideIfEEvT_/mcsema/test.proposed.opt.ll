...
define %struct.Memory* @_Z17check_shifted_sumIf31custom_multiple_constant_divideIfEEvT_(%struct.State* noalias, i64, %struct.Memory* noalias readnone) local_unnamed_addr #1 {
entry:
...
block_40f271:                                     ; preds = %entry
  ...
  %call2_40f284 = tail call %struct.Memory* @sub_4006c0.printf_plt(%struct.State* nonnull %0, i64 %126, %struct.Memory* %call2_40f264)
...
block_.L_40f28c:                                  ; preds = %block_40f271, %entry
  %137 = phi i64 [ %123, %entry ], [ %.pre, %block_40f271 ]
  %MEMORY.0 = phi %struct.Memory* [ %call2_40f264, %entry ], [ %call2_40f284, %block_40f271 ]
