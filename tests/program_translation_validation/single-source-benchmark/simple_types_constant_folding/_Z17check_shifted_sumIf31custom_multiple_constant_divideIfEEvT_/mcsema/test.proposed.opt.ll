...
declare %struct.Memory* @sub_40f1f0._ZN31custom_multiple_constant_divideIfE8do_shiftEf(%struct.State* dereferenceable(3376), i64, %struct.Memory*) local_unnamed_addr
