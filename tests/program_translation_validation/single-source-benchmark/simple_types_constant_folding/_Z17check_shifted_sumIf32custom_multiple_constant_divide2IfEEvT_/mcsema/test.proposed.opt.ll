...
@G_0x9919__rip_ = local_unnamed_addr global %G_0x9919__rip__type zeroinitializer
...
entry:
  ...
  %71 = load i32, i32* bitcast (%G_0x9919__rip__type* @G_0x9919__rip_ to i32*), align 8
  ...
  %call2_40f178 = tail call %struct.Memory* @sub_40f060._Z15tolerance_equalIfEbRT_S1_(%struct.State* %0, i64 %101, %struct.Memory* %call2_40f15a)
  ...
  br i1 %115, label %block_.L_40f1a0, label %block_40f185
...
block_40f185:                                     ; preds = %entry
  ...
  %124 = tail call %struct.Memory* @__remill_function_call(%struct.State* %0, i64 ptrtoint (i64 (i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64)* @printf to i64), %struct.Memory* %call2_40f178)
...
block_.L_40f1a0:                                  ; preds = %block_40f185, %entry
  %131 = phi i64 [ %116, %entry ], [ %.pre, %block_40f185 ]
  %MEMORY.0 = phi %struct.Memory* [ %call2_40f178, %entry ], [ %124, %block_40f185 ]
...
block_400478:
  ...
  %6 = add i64 %5, 8
  store i64 %6, i64* %PC, align 8
  %7 = load i32, i32* bitcast (%G_0x9919__rip__type* @G_0x9919__rip_ to i32*), align 8
