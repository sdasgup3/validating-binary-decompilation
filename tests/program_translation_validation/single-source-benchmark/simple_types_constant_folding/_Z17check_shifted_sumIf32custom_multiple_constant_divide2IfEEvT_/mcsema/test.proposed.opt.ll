...
declare %struct.Memory* @sub_40f160._ZN32custom_multiple_constant_divide2IfE8do_shiftEf(%struct.State* dereferenceable(3376), i64, %struct.Memory*) local_unnamed_addr
