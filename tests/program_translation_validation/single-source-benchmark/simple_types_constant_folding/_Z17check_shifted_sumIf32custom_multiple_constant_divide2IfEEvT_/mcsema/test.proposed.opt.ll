...
@G_0x9919__rip__4256111_ = local_unnamed_addr global %G_0x9919__rip__4256111__type zeroinitializer
...
declare %struct.Memory* @sub_40f120._ZN32custom_multiple_constant_divide2IfE8do_shiftEf(%struct.State* noalias dereferenceable(3376), i64, %struct.Memory* noalias readnone returned) local_unnamed_addr
...
define %struct.Memory* @_Z17check_shifted_sumIf32custom_multiple_constant_divide2IfEEvT_(%struct.State* noalias, i64, %struct.Memory* noalias) local_unnamed_addr #1 {
entry:
  ...
  %call2_40f15a = tail call %struct.Memory* @sub_40f120._ZN32custom_multiple_constant_divide2IfE8do_shiftEf(%struct.State* %0, i64 %60, %struct.Memory* %2)
  ...
  %71 = load i32, i32* bitcast (%G_0x9919__rip__4256111__type* @G_0x9919__rip__4256111_ to i32*), align 8
  ...
  %call2_40f178 = tail call %struct.Memory* @sub_40f060._Z15tolerance_equalIfEbRT_S1_(%struct.State* %0, i64 %100, %struct.Memory* %call2_40f15a)
  ...
  br i1 %114, label %block_.L_40f1a0, label %block_40f185

block_40f185:                                     ; preds = %entry
  ...
  %123 = tail call %struct.Memory* @__remill_function_call(%struct.State* %0, i64 ptrtoint (i64 (i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64)* @printf to i64), %struct.Memory* %call2_40f178)
...
block_.L_40f1a0:                                  ; preds = %block_40f185, %entry
  %130 = phi i64 [ %115, %entry ], [ %.pre, %block_40f185 ]
  %MEMORY.0 = phi %struct.Memory* [ %call2_40f178, %entry ], [ %123, %block_40f185 ]
...
define %struct.Memory* @routine_callq_._ZN32custom_multiple_constant_divide2IfE8do_shiftEf(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
...
define %struct.Memory* @routine_movss_0x9919__rip____xmm1(%struct.State* dereferenceable(3376), i64, %struct.Memory*) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  ...
  %6 = add i64 %5, 8
  store i64 %6, i64* %PC, align 8
  %7 = load i32, i32* bitcast (%G_0x9919__rip__4256111__type* @G_0x9919__rip__4256111_ to i32*), align 8
...
define %struct.Memory* @routine_jne_.L_40f1a0(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i8* %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
