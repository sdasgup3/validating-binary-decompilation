...
entry:
  ...
  store %struct.Memory* %loadMem1_40f416, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_40f41b, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem1_40f434, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_40f439, %struct.Memory** %MEMORY
...
block_40f441:                                     ; preds = %entry
  ...
  store %struct.Memory* %loadMem_40f452, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem1_40f454, %struct.Memory** %MEMORY
  %loadMem2_40f454 = load %struct.Memory*, %struct.Memory** %MEMORY
  %loadPC_40f454 = load i64, i64* %3
  %314 = call %struct.Memory* @__remill_function_call(%struct.State* %0, i64 ptrtoint (i64 (i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64)* @printf to i64), %struct.Memory* %loadMem2_40f454)
...
block_.L_40f45c:                                  ; preds = %block_40f441, %entry
  ...
  store %struct.Memory* %loadMem_40f45c, %struct.Memory** %MEMORY
  ...
  ret %struct.Memory* %loadMem_40f461
}
