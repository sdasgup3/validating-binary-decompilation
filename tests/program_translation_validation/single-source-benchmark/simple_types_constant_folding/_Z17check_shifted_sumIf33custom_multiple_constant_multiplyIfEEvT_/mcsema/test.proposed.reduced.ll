; ModuleID = '/tmp/tmpj2gp3pkw-query.ll'
...
declare %struct.Memory* @sub_40f3d0._ZN33custom_multiple_constant_multiplyIfE8do_shiftEf(%struct.State* noalias dereferenceable(3376), i64, %struct.Memory* noalias readnone returned) local_unnamed_addr
...
define %struct.Memory* @_Z17check_shifted_sumIf33custom_multiple_constant_multiplyIfEEvT_(%struct.State* noalias, i64, %struct.Memory* noalias) local_unnamed_addr #1 {
entry:
...
%call2_40f426 = tail call %struct.Memory* @sub_40f3d0._ZN33custom_multiple_constant_multiplyIfE8do_shiftEf(%struct.State* %0, i64 %var_2_65, %struct.Memory* %2)
...
%var_2_76 = add i64 %var_2_72, add (i64 ptrtoint (%G_0x969d__rip__type* @G_0x969d__rip_ to i64), i64 8)
...
%var_2_108 = add i64 %var_2_107, -916
...
%call2_40f444 = tail call %struct.Memory* @sub_40f0b0._Z15tolerance_equalIfEbRT_S1_(%struct.State* %0, i64 %var_2_108, %struct.Memory* %call2_40f426)
...
br i1 %var_2_122, label %block_.L_40f46c, label %block_40f451
...
; Matched:%var_2_156:  %var_2_156 = add i64 %var_2_120, -60801
; %var_2_126 = add i64 %var_2_123, -60801
...
%var_2_131 = tail call %struct.Memory* @__remill_function_call(%struct.State* nonnull %0, i64 ptrtoint (i64 (i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64)* @printf to i64), %struct.Memory* %call2_40f444)
...
; Matched:%var_2_121:  %var_2_121 = phi i64 [ %var_2_120, %block_40f410 ], [ %.pre, %block_40f451 ]
; %var_2_138 = phi i64 [ %var_2_123, %entry ], [ %.pre, %block_40f451 ]
%MEMORY.0 = phi %struct.Memory* [ %call2_40f444, %entry ], [ %var_2_131, %block_40f451 ]
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_movss_0x969d__rip____xmm1(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 1, i64 1
  %4 = bitcast %union.VectorReg* %3 to i8*
  %5 = load i64, i64* %PC, align 8
  %6 = add i64 %5, ptrtoint (%G_0x969d__rip__type* @G_0x969d__rip_ to i64)
  %7 = add i64 %5, 8
  store i64 %7, i64* %PC, align 8
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_jne_.L_40f46c(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i8* nocapture %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
