...
%G_0x9749__rip__type = type <{ [4 x i8] }>
...
@G_0x9749__rip_ = global %G_0x9749__rip__type zeroinitializer
...
entry:
  ...
  %173 = load float, float* bitcast (%G_0x9749__rip__type* @G_0x9749__rip_ to float*)
...
block_400478:
  ...
  %9 = load i64, i64* %PC
  %10 = ptrtoint %G_0x9749__rip__type* @G_0x9749__rip_ to i64
  %11 = load i64, i64* %PC
  %12 = add i64 %11, 8
  store i64 %12, i64* %PC
