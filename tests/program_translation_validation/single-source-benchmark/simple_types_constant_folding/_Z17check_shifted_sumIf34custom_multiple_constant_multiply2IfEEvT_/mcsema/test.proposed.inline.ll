...
declare %struct.Memory* @sub_40f330._ZN34custom_multiple_constant_multiply2IfE8do_shiftEf(%struct.State* dereferenceable(3376), i64, %struct.Memory*)
...
define %struct.Memory* @_Z17check_shifted_sumIf34custom_multiple_constant_multiply2IfEEvT_(%struct.State* noalias, i64, %struct.Memory* noalias) #1 {
entry:
