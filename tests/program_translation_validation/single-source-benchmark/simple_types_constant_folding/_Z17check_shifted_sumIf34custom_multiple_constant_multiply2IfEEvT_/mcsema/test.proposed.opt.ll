...
entry:
  ...
  %call2_40f376 = tail call %struct.Memory* @sub_40f340._ZN34custom_multiple_constant_multiply2IfE8do_shiftEf(%struct.State* %0, i64 %65, %struct.Memory* %2)
  ...
  %76 = add i64 %72, add (i64 ptrtoint (%G_0x974d__rip__type* @G_0x974d__rip_ to i64), i64 8)
  %77 = add i64 %72, 16
  ...
  %call2_40f394 = tail call %struct.Memory* @sub_40f0b0._Z15tolerance_equalIfEbRT_S1_(%struct.State* %0, i64 %108, %struct.Memory* %call2_40f376)
  ...
  br i1 %122, label %block_.L_40f3bc, label %block_40f3a1
...
block_40f3a1:                                     ; preds = %entry
  ...
  %131 = tail call %struct.Memory* @__remill_function_call(%struct.State* nonnull %0, i64 ptrtoint (i64 (i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64)* @printf to i64), %struct.Memory* %call2_40f394)
...
block_.L_40f3bc:                                  ; preds = %block_40f3a1, %entry
  %138 = phi i64 [ %123, %entry ], [ %.pre, %block_40f3a1 ]
  %MEMORY.0 = phi %struct.Memory* [ %call2_40f394, %entry ], [ %131, %block_40f3a1 ]
