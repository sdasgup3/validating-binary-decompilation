...
%G_0x20b492__rip__4287478__type = type <{ [4 x i8] }>
...
@G_0x20b492__rip__4287478_ = global %G_0x20b492__rip__4287478__type zeroinitializer
...
entry:
  ...
  store %struct.Memory* %loadMem_416be0, %struct.Memory** %MEMORY
  ...
  %loadMem_416be8 = load %struct.Memory*, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_416be8, %struct.Memory** %MEMORY
  %loadMem_416beb = load %struct.Memory*, %struct.Memory** %MEMORY
  ...
  store i8 %94, i8* %98
  store %struct.Memory* %loadMem_416beb, %struct.Memory** %MEMORY
  ...
  %108 = load double, double* bitcast (%G_0x20b492__rip__4287478__type* @G_0x20b492__rip__4287478_ to double*)
  ...
  %loadMem1_416bfc = load %struct.Memory*, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem1_416bfc, %struct.Memory** %MEMORY
  %loadMem2_416bfc = load %struct.Memory*, %struct.Memory** %MEMORY
  %loadPC_416bfc = load i64, i64* %3
  %call2_416bfc = call %struct.Memory* @sub_416bb0._ZN28custom_multiple_constant_subIhE8do_shiftEh(%struct.State* %0, i64 %loadPC_416bfc, %struct.Memory* %loadMem2_416bfc)
  store %struct.Memory* %call2_416bfc, %struct.Memory** %MEMORY
  ...
  %loadMem_416c09 = load %struct.Memory*, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_416c09, %struct.Memory** %MEMORY
  %loadMem_416c0c = load %struct.Memory*, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_416c0c, %struct.Memory** %MEMORY
  %loadMem_416c0f = load %struct.Memory*, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_416c0f, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem1_416c14, %struct.Memory** %MEMORY
  %loadMem2_416c14 = load %struct.Memory*, %struct.Memory** %MEMORY
  %loadPC_416c14 = load i64, i64* %3
  %call2_416c14 = call %struct.Memory* @sub_416450._Z15tolerance_equalIhEbRT_S1_(%struct.State* %0, i64 %loadPC_416c14, %struct.Memory* %loadMem2_416c14)
  store %struct.Memory* %call2_416c14, %struct.Memory** %MEMORY
  %loadMem_416c19 = load %struct.Memory*, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_416c19, %struct.Memory** %MEMORY
  ...
  %loadBr_416c1b = load i8, i8* %BRANCH_TAKEN
  %cmpBr_416c1b = icmp eq i8 %loadBr_416c1b, 1
  br i1 %cmpBr_416c1b, label %block_.L_416c3c, label %block_416c21

block_416c21:                                     ; preds = %entry
  ...
  store %struct.Memory* %loadMem_416c21, %struct.Memory** %MEMORY
  %loadMem_416c2b = load %struct.Memory*, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_416c2b, %struct.Memory** %MEMORY
  ...
  %loadMem1_416c34 = load %struct.Memory*, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem1_416c34, %struct.Memory** %MEMORY
  %loadMem2_416c34 = load %struct.Memory*, %struct.Memory** %MEMORY
  %loadPC_416c34 = load i64, i64* %3
  %360 = call %struct.Memory* @__remill_function_call(%struct.State* %0, i64 ptrtoint (i64 (i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64)* @printf to i64), %struct.Memory* %loadMem2_416c34)
  store %struct.Memory* %360, %struct.Memory** %MEMORY
  %loadMem_416c39 = load %struct.Memory*, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_416c39, %struct.Memory** %MEMORY
  br label %block_.L_416c3c

block_.L_416c3c:                                  ; preds = %block_416c21, %entry
  ...
  %loadMem_416c40 = load %struct.Memory*, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_416c40, %struct.Memory** %MEMORY
  ...
  ret %struct.Memory* %loadMem_416c41
}
...
define %struct.Memory* @routine_cvttsd2si_0x20b492__rip____edi(%struct.State* dereferenceable(3376), i64, %struct.Memory*) {
block_400478:
  %3 = getelementptr inbounds %struct.State, %struct.State* %0, i32 0, i32 6
  %4 = getelementptr inbounds %struct.GPR, %struct.GPR* %3, i32 0, i32 33
  %5 = getelementptr inbounds %struct.Reg, %struct.Reg* %4, i32 0, i32 0
  ...
  %9 = load i64, i64* %PC
  %10 = ptrtoint %G_0x20b492__rip__4287478__type* @G_0x20b492__rip__4287478_ to i64
  %11 = load i64, i64* %PC
  %12 = add i64 %11, 8
  store i64 %12, i64* %PC
...
define %struct.Memory* @routine_jne_.L_416c3c(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i8* %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) {
block_400478:
  %3 = getelementptr inbounds %struct.State, %struct.State* %0, i32 0, i32 6
  %4 = getelementptr inbounds %struct.GPR, %struct.GPR* %3, i32 0, i32 33
  %5 = getelementptr inbounds %struct.Reg, %struct.Reg* %4, i32 0, i32 0
