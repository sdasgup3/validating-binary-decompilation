...
@G_0x20b832__rip__4286550_ = global %G_0x20b832__rip__4286550__type zeroinitializer
...
entry:
  ...
  store %struct.Memory* %loadMem_416840, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_416848, %struct.Memory** %MEMORY
  ...
  %108 = load double, double* bitcast (%G_0x20b832__rip__4286550__type* @G_0x20b832__rip__4286550_ to double*)
  ...
  store %struct.Memory* %loadMem1_41685c, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_416865, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_41686f, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem1_416874, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_416879, %struct.Memory** %MEMORY
...
block_416881:                                     ; preds = %entry
  ...
  store %struct.Memory* %loadMem_416892, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem1_416894, %struct.Memory** %MEMORY
  %loadMem2_416894 = load %struct.Memory*, %struct.Memory** %MEMORY
  %loadPC_416894 = load i64, i64* %3
  %360 = call %struct.Memory* @__remill_function_call(%struct.State* %0, i64 ptrtoint (i64 (i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64)* @printf to i64), %struct.Memory* %loadMem2_416894)
  ...
  store %struct.Memory* %loadMem_416899, %struct.Memory** %MEMORY
  br label %block_.L_41689c

block_.L_41689c:                                  ; preds = %block_416881, %entry
  ...
  store %struct.Memory* %loadMem_4168a1, %struct.Memory** %MEMORY
  ret %struct.Memory* %loadMem_4168a1
}
...
define %struct.Memory* @routine_cvttsd2si_0x20b832__rip____edi(%struct.State* dereferenceable(3376), i64, %struct.Memory*) {
block_400478:
  %3 = getelementptr inbounds %struct.State, %struct.State* %0, i32 0, i32 6
  %4 = getelementptr inbounds %struct.GPR, %struct.GPR* %3, i32 0, i32 33
  %5 = getelementptr inbounds %struct.Reg, %struct.Reg* %4, i32 0, i32 0
