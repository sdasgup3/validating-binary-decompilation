...
define %struct.Memory* @_Z17check_shifted_sumIi18custom_constant_orIiEEvT_(%struct.State* noalias, i64, %struct.Memory* noalias) #2 {
entry:
  ...
  store %struct.Memory* %loadMem_4130c1, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem1_4130d4, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem1_4130ea, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_4130ef, %struct.Memory** %MEMORY
...
block_4130f7:                                     ; preds = %entry
  ...
  store %struct.Memory* %loadMem1_41310a, %struct.Memory** %MEMORY
  %loadMem2_41310a = load %struct.Memory*, %struct.Memory** %MEMORY
  %loadPC_41310a = load i64, i64* %3
  %286 = call %struct.Memory* @__remill_function_call(%struct.State* %0, i64 ptrtoint (i64 (i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64)* @printf to i64), %struct.Memory* %loadMem2_41310a)
...
block_.L_413112:                                  ; preds = %block_4130f7, %entry
  ...
  ret %struct.Memory* %loadMem_413117
}
