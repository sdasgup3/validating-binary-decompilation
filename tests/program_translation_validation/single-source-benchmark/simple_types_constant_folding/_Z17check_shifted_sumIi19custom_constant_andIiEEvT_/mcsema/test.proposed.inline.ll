...
entry:
  ...
  store %struct.Memory* %loadMem1_4131d4, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_4131d9, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem1_4131ea, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_4131ef, %struct.Memory** %MEMORY
...
block_4131f7:                                     ; preds = %entry
  ...
  store %struct.Memory* %loadMem1_41320a, %struct.Memory** %MEMORY
  %loadMem2_41320a = load %struct.Memory*, %struct.Memory** %MEMORY
  %loadPC_41320a = load i64, i64* %3
  %286 = call %struct.Memory* @__remill_function_call(%struct.State* %0, i64 ptrtoint (i64 (i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64)* @printf to i64), %struct.Memory* %loadMem2_41320a)
  ...
  store %struct.Memory* %loadMem_41320f, %struct.Memory** %MEMORY
  br label %block_.L_413212

block_.L_413212:                                  ; preds = %block_4131f7, %entry
  ...
  ret %struct.Memory* %loadMem_413217
}
