...
define %struct.Memory* @_Z17check_shifted_sumIi19custom_constant_subIiEEvT_(%struct.State* noalias, i64, %struct.Memory* noalias) #2 {
entry:
  ...
  store i32 %78, i32* %82
  store %struct.Memory* %loadMem_413658, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem1_413664, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem1_41367a, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_41367f, %struct.Memory** %MEMORY
...
block_413687:                                     ; preds = %entry
  ...
  store %struct.Memory* %loadMem_413691, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem1_41369a, %struct.Memory** %MEMORY
  %loadMem2_41369a = load %struct.Memory*, %struct.Memory** %MEMORY
  %loadPC_41369a = load i64, i64* %3
  %286 = call %struct.Memory* @__remill_function_call(%struct.State* %0, i64 ptrtoint (i64 (i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64)* @printf to i64), %struct.Memory* %loadMem2_41369a)
...
block_.L_4136a2:                                  ; preds = %block_413687, %entry
  ...
  ret %struct.Memory* %loadMem_4136a7
}
