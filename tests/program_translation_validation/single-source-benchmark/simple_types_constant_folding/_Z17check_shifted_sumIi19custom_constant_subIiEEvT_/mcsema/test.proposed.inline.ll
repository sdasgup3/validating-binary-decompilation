...
entry:
  ...
  store %struct.Memory* %loadMem1_41362a, %struct.Memory** %MEMORY
...
block_413637:                                     ; preds = %entry
  ...
  store %struct.Memory* %loadMem1_41364a, %struct.Memory** %MEMORY
  %loadMem2_41364a = load %struct.Memory*, %struct.Memory** %MEMORY
  %loadPC_41364a = load i64, i64* %3
  %286 = call %struct.Memory* @__remill_function_call(%struct.State* %0, i64 ptrtoint (i64 (i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64)* @printf to i64), %struct.Memory* %loadMem2_41364a)
...
block_.L_413652:                                  ; preds = %block_413637, %entry
  ...
  store %struct.Memory* %loadMem_413656, %struct.Memory** %MEMORY
  ...
  ret %struct.Memory* %loadMem_413657
}
