...
block_412fe7:                                     ; preds = %entry
  ...
  %call2_412ffa = call %struct.Memory* @sub_4006c0.printf_plt(%struct.State* %0, i64 %loadPC_412ffa, %struct.Memory* %loadMem2_412ffa)
  store %struct.Memory* %call2_412ffa, %struct.Memory** %MEMORY
