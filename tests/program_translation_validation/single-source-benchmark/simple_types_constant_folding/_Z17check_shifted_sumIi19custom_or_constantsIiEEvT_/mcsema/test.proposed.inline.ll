...
entry:
  ...
  store %struct.Memory* %loadMem1_413844, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem1_41385a, %struct.Memory** %MEMORY
...
block_413867:                                     ; preds = %entry
  ...
  store %struct.Memory* %loadMem_413878, %struct.Memory** %MEMORY
  ...
  %286 = call %struct.Memory* @__remill_function_call(%struct.State* %0, i64 ptrtoint (i64 (i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64)* @printf to i64), %struct.Memory* %loadMem2_41387a)
...
block_.L_413882:                                  ; preds = %block_413867, %entry
  ...
  ret %struct.Memory* %loadMem_413887
}
