...
entry:
  ...
  store %struct.Memory* %loadMem1_4137f4, %struct.Memory** %MEMORY
...
block_413817:                                     ; preds = %entry
  ...
  store %struct.Memory* %loadMem1_41382a, %struct.Memory** %MEMORY
  %loadMem2_41382a = load %struct.Memory*, %struct.Memory** %MEMORY
  %loadPC_41382a = load i64, i64* %3
  %286 = call %struct.Memory* @__remill_function_call(%struct.State* %0, i64 ptrtoint (i64 (i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64)* @printf to i64), %struct.Memory* %loadMem2_41382a)
...
block_.L_413832:                                  ; preds = %block_413817, %entry
  ...
  ret %struct.Memory* %loadMem_413837
}
