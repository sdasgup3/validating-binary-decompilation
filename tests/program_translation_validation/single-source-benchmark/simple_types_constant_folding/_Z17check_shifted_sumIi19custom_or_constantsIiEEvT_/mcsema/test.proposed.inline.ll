...
define %struct.Memory* @_Z17check_shifted_sumIi19custom_or_constantsIiEEvT_(%struct.State* noalias, i64, %struct.Memory* noalias) #2 {
entry:
  ...
  store %struct.Memory* %loadMem1_413834, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem1_41384a, %struct.Memory** %MEMORY
...
block_413857:                                     ; preds = %entry
  ...
  store %struct.Memory* %loadMem1_41386a, %struct.Memory** %MEMORY
  %loadMem2_41386a = load %struct.Memory*, %struct.Memory** %MEMORY
  %loadPC_41386a = load i64, i64* %3
  %286 = call %struct.Memory* @__remill_function_call(%struct.State* %0, i64 ptrtoint (i64 (i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64)* @printf to i64), %struct.Memory* %loadMem2_41386a)
...
block_.L_413872:                                  ; preds = %block_413857, %entry
  ...
  ret %struct.Memory* %loadMem_413877
}
