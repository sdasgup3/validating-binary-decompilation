...
entry:
  ...
  %loadMem1_413d34 = load %struct.Memory*, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem1_413d34, %struct.Memory** %MEMORY
  %loadMem2_413d34 = load %struct.Memory*, %struct.Memory** %MEMORY
  %loadPC_413d34 = load i64, i64* %3
  %call2_413d34 = call %struct.Memory* @sub_413d10._ZN20custom_add_constantsIiE8do_shiftEi(%struct.State* %0, i64 %loadPC_413d34, %struct.Memory* %loadMem2_413d34)
  store %struct.Memory* %call2_413d34, %struct.Memory** %MEMORY
  ...
  %call2_413d4a = call %struct.Memory* @sub_412f20._Z15tolerance_equalIiEbRT_S1_(%struct.State* %0, i64 %loadPC_413d4a, %struct.Memory* %loadMem2_413d4a)
  store %struct.Memory* %call2_413d4a, %struct.Memory** %MEMORY
  ...
  %loadBr_413d51 = load i8, i8* %BRANCH_TAKEN
  %cmpBr_413d51 = icmp eq i8 %loadBr_413d51, 1
  br i1 %cmpBr_413d51, label %block_.L_413d72, label %block_413d57

block_413d57:                                     ; preds = %entry
  ...
  %286 = call %struct.Memory* @__remill_function_call(%struct.State* %0, i64 ptrtoint (i64 (i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64)* @printf to i64), %struct.Memory* %loadMem2_413d6a)
  ...
  br label %block_.L_413d72

block_.L_413d72:                                  ; preds = %block_413d57, %entry
  %loadMem_413d72 = load %struct.Memory*, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_413d72, %struct.Memory** %MEMORY
  ...
  ret %struct.Memory* %loadMem_413d77
}
...
define %struct.Memory* @routine_jne_.L_413d72(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i8* %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) {
block_400478:
  %3 = getelementptr inbounds %struct.State, %struct.State* %0, i32 0, i32 6
  %4 = getelementptr inbounds %struct.GPR, %struct.GPR* %3, i32 0, i32 33
  %5 = getelementptr inbounds %struct.Reg, %struct.Reg* %4, i32 0, i32 0
