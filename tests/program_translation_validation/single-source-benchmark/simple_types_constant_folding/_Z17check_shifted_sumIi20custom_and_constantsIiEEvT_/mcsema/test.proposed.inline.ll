...
entry:
  ...
  %loadMem_413858 = load %struct.Memory*, %struct.Memory** %MEMORY
  ...
  store i32 %78, i32* %82
  store %struct.Memory* %loadMem_413858, %struct.Memory** %MEMORY
  %loadMem_41385b = load %struct.Memory*, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_41385b, %struct.Memory** %MEMORY
  %loadMem1_413864 = load %struct.Memory*, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem1_413864, %struct.Memory** %MEMORY
  %loadMem2_413864 = load %struct.Memory*, %struct.Memory** %MEMORY
  %loadPC_413864 = load i64, i64* %3
  %call2_413864 = call %struct.Memory* @sub_413840._ZN20custom_and_constantsIiE8do_shiftEi(%struct.State* %0, i64 %loadPC_413864, %struct.Memory* %loadMem2_413864)
  store %struct.Memory* %call2_413864, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem1_41387a, %struct.Memory** %MEMORY
  %loadMem2_41387a = load %struct.Memory*, %struct.Memory** %MEMORY
  %loadPC_41387a = load i64, i64* %3
  %call2_41387a = call %struct.Memory* @sub_412f20._Z15tolerance_equalIiEbRT_S1_(%struct.State* %0, i64 %loadPC_41387a, %struct.Memory* %loadMem2_41387a)
  ...
  %loadBr_413881 = load i8, i8* %BRANCH_TAKEN
  %cmpBr_413881 = icmp eq i8 %loadBr_413881, 1
  br i1 %cmpBr_413881, label %block_.L_4138a2, label %block_413887

block_413887:                                     ; preds = %entry
  ...
  %loadMem1_41389a = load %struct.Memory*, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem1_41389a, %struct.Memory** %MEMORY
  %loadMem2_41389a = load %struct.Memory*, %struct.Memory** %MEMORY
  %loadPC_41389a = load i64, i64* %3
  %286 = call %struct.Memory* @__remill_function_call(%struct.State* %0, i64 ptrtoint (i64 (i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64)* @printf to i64), %struct.Memory* %loadMem2_41389a)
  ...
  br label %block_.L_4138a2

block_.L_4138a2:                                  ; preds = %block_413887, %entry
  ...
  %loadMem_4138a6 = load %struct.Memory*, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_4138a6, %struct.Memory** %MEMORY
  ...
  ret %struct.Memory* %loadMem_4138a7
}
...
define %struct.Memory* @routine_jne_.L_4138a2(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i8* %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) {
block_400478:
  %3 = getelementptr inbounds %struct.State, %struct.State* %0, i32 0, i32 6
  %4 = getelementptr inbounds %struct.GPR, %struct.GPR* %3, i32 0, i32 33
  %5 = getelementptr inbounds %struct.Reg, %struct.Reg* %4, i32 0, i32 0
