...
define %struct.Memory* @_Z17check_shifted_sumIi20custom_mod_constantsIiEEvT_(%struct.State* noalias, i64, %struct.Memory* noalias) #2 {
entry:
  ...
  store %struct.Memory* %loadMem1_413bb4, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_413bb9, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_413bc1, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_413bc7, %struct.Memory** %MEMORY
...
block_413bd7:                                     ; preds = %entry
  ...
  store %struct.Memory* %loadMem1_413bea, %struct.Memory** %MEMORY
...
block_.L_413bf2:                                  ; preds = %block_413bd7, %entry
  ...
  ret %struct.Memory* %loadMem_413bf7
}
