...
entry:
  ...
  store %struct.Memory* %loadMem_413b61, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_413b6b, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_413b7d, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem1_413b8a, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_413b91, %struct.Memory** %MEMORY
...
block_413b97:                                     ; preds = %entry
  ...
  store %struct.Memory* %loadMem1_413baa, %struct.Memory** %MEMORY
  %loadMem2_413baa = load %struct.Memory*, %struct.Memory** %MEMORY
  %loadPC_413baa = load i64, i64* %3
  %286 = call %struct.Memory* @__remill_function_call(%struct.State* %0, i64 ptrtoint (i64 (i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64)* @printf to i64), %struct.Memory* %loadMem2_413baa)
...
block_.L_413bb2:                                  ; preds = %block_413b97, %entry
  ...
  store %struct.Memory* %loadMem_413bb2, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_413bb6, %struct.Memory** %MEMORY
  ...
  ret %struct.Memory* %loadMem_413bb7
}
