...
entry:
  ...
  store %struct.Memory* %loadMem1_4137c4, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem1_4137da, %struct.Memory** %MEMORY
...
block_4137e7:                                     ; preds = %entry
  ...
  %286 = call %struct.Memory* @__remill_function_call(%struct.State* %0, i64 ptrtoint (i64 (i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64)* @printf to i64), %struct.Memory* %loadMem2_4137fa)
...
block_.L_413802:                                  ; preds = %block_4137e7, %entry
  ...
  ret %struct.Memory* %loadMem_413807
}
