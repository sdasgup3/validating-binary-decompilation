...
entry:
  ...
  store %struct.Memory* %loadMem_413770, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem1_413784, %struct.Memory** %MEMORY
...
block_4137a7:                                     ; preds = %entry
  ...
  %286 = call %struct.Memory* @__remill_function_call(%struct.State* %0, i64 ptrtoint (i64 (i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64)* @printf to i64), %struct.Memory* %loadMem2_4137ba)
...
block_.L_4137c2:                                  ; preds = %block_4137a7, %entry
  ...
  store %struct.Memory* %loadMem_4137c2, %struct.Memory** %MEMORY
  ...
  ret %struct.Memory* %loadMem_4137c7
}
