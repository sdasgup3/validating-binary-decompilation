...
define %struct.Memory* @_Z17check_shifted_sumIi20custom_xor_constantsIiEEvT_(%struct.State* noalias, i64, %struct.Memory* noalias) #2 {
entry:
  ...
  store %struct.Memory* %loadMem1_4137d4, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_4137dd, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_4137e7, %struct.Memory** %MEMORY
...
block_4137f7:                                     ; preds = %entry
  ...
  store %struct.Memory* %loadMem_413801, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem1_41380a, %struct.Memory** %MEMORY
  %loadMem2_41380a = load %struct.Memory*, %struct.Memory** %MEMORY
  %loadPC_41380a = load i64, i64* %3
  %286 = call %struct.Memory* @__remill_function_call(%struct.State* %0, i64 ptrtoint (i64 (i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64)* @printf to i64), %struct.Memory* %loadMem2_41380a)
...
block_.L_413812:                                  ; preds = %block_4137f7, %entry
  ...
  ret %struct.Memory* %loadMem_413817
}
