...
entry:
  ...
  store %struct.Memory* %loadMem1_413b04, %struct.Memory** %MEMORY
...
block_413b27:                                     ; preds = %entry
  ...
  store %struct.Memory* %loadMem1_413b3a, %struct.Memory** %MEMORY
  %loadMem2_413b3a = load %struct.Memory*, %struct.Memory** %MEMORY
  %loadPC_413b3a = load i64, i64* %3
  %286 = call %struct.Memory* @__remill_function_call(%struct.State* %0, i64 ptrtoint (i64 (i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64)* @printf to i64), %struct.Memory* %loadMem2_413b3a)
...
block_.L_413b42:                                  ; preds = %block_413b27, %entry
  ...
  ret %struct.Memory* %loadMem_413b47
}
