...
define %struct.Memory* @_Z17check_shifted_sumIi22custom_equal_constantsIiEEvT_(%struct.State* noalias, i64, %struct.Memory* noalias) #2 {
entry:
  ...
  store %struct.Memory* %loadMem1_413b44, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_413b49, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem1_413b5a, %struct.Memory** %MEMORY
...
block_413b67:                                     ; preds = %entry
  ...
  store %struct.Memory* %loadMem1_413b7a, %struct.Memory** %MEMORY
  %loadMem2_413b7a = load %struct.Memory*, %struct.Memory** %MEMORY
  %loadPC_413b7a = load i64, i64* %3
  %286 = call %struct.Memory* @__remill_function_call(%struct.State* %0, i64 ptrtoint (i64 (i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64)* @printf to i64), %struct.Memory* %loadMem2_413b7a)
...
block_.L_413b82:                                  ; preds = %block_413b67, %entry
  ...
  store %struct.Memory* %loadMem_413b82, %struct.Memory** %MEMORY
  ...
  ret %struct.Memory* %loadMem_413b87
}
