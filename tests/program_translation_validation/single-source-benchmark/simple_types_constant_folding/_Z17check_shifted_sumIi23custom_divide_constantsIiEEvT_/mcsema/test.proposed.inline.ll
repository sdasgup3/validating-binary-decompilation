...
entry:
  ...
  store %struct.Memory* %loadMem_413bed, %struct.Memory** %MEMORY
...
block_413c07:                                     ; preds = %entry
  ...
  store %struct.Memory* %loadMem1_413c1a, %struct.Memory** %MEMORY
  %loadMem2_413c1a = load %struct.Memory*, %struct.Memory** %MEMORY
  %loadPC_413c1a = load i64, i64* %3
  %286 = call %struct.Memory* @__remill_function_call(%struct.State* %0, i64 ptrtoint (i64 (i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64)* @printf to i64), %struct.Memory* %loadMem2_413c1a)
...
block_.L_413c22:                                  ; preds = %block_413c07, %entry
  ...
  store %struct.Memory* %loadMem_413c22, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_413c26, %struct.Memory** %MEMORY
  ...
  ret %struct.Memory* %loadMem_413c27
}
