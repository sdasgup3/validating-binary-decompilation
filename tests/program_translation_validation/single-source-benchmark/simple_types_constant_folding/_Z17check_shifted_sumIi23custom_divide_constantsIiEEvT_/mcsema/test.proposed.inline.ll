...
entry:
  ...
  store %struct.Memory* %loadMem1_413c34, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem1_413c4a, %struct.Memory** %MEMORY
...
block_413c57:                                     ; preds = %entry
  ...
  %286 = call %struct.Memory* @__remill_function_call(%struct.State* %0, i64 ptrtoint (i64 (i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64)* @printf to i64), %struct.Memory* %loadMem2_413c6a)
...
block_.L_413c72:                                  ; preds = %block_413c57, %entry
  ...
  ret %struct.Memory* %loadMem_413c77
}
