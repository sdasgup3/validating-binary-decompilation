...
define %struct.Memory* @_Z17check_shifted_sumIi23custom_divide_constantsIiEEvT_(%struct.State* noalias, i64, %struct.Memory* noalias) #2 {
entry:
  ...
  store %struct.Memory* %loadMem1_413c24, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_413c2d, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem1_413c3a, %struct.Memory** %MEMORY
...
block_413c47:                                     ; preds = %entry
  ...
  store %struct.Memory* %loadMem1_413c5a, %struct.Memory** %MEMORY
  %loadMem2_413c5a = load %struct.Memory*, %struct.Memory** %MEMORY
  %loadPC_413c5a = load i64, i64* %3
  %286 = call %struct.Memory* @__remill_function_call(%struct.State* %0, i64 ptrtoint (i64 (i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64)* @printf to i64), %struct.Memory* %loadMem2_413c5a)
...
block_.L_413c62:                                  ; preds = %block_413c47, %entry
  ...
  ret %struct.Memory* %loadMem_413c67
}
