...
entry:
  ...
  store %struct.Memory* %loadMem1_413514, %struct.Memory** %MEMORY
...
block_413537:                                     ; preds = %entry
  ...
  store %struct.Memory* %loadMem1_41354a, %struct.Memory** %MEMORY
  %loadMem2_41354a = load %struct.Memory*, %struct.Memory** %MEMORY
  %loadPC_41354a = load i64, i64* %3
  %286 = call %struct.Memory* @__remill_function_call(%struct.State* %0, i64 ptrtoint (i64 (i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64)* @printf to i64), %struct.Memory* %loadMem2_41354a)
...
block_.L_413552:                                  ; preds = %block_413537, %entry
  ...
  store %struct.Memory* %loadMem_413556, %struct.Memory** %MEMORY
  ...
  ret %struct.Memory* %loadMem_413557
}
