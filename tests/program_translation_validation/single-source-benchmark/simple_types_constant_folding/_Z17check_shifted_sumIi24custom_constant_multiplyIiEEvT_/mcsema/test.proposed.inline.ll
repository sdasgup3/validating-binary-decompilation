...
define %struct.Memory* @_Z17check_shifted_sumIi24custom_constant_multiplyIiEEvT_(%struct.State* noalias, i64, %struct.Memory* noalias) #2 {
entry:
  ...
  store %struct.Memory* %loadMem_413551, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem1_413564, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem1_41357a, %struct.Memory** %MEMORY
...
block_413587:                                     ; preds = %entry
  ...
  store %struct.Memory* %loadMem_413591, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem1_41359a, %struct.Memory** %MEMORY
  %loadMem2_41359a = load %struct.Memory*, %struct.Memory** %MEMORY
  %loadPC_41359a = load i64, i64* %3
  %286 = call %struct.Memory* @__remill_function_call(%struct.State* %0, i64 ptrtoint (i64 (i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64)* @printf to i64), %struct.Memory* %loadMem2_41359a)
...
block_.L_4135a2:                                  ; preds = %block_413587, %entry
  ...
  ret %struct.Memory* %loadMem_4135a7
}
