...
entry:
  ...
  store %struct.Memory* %loadMem1_4139b4, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem1_4139ca, %struct.Memory** %MEMORY
...
block_4139d7:                                     ; preds = %entry
  ...
  store %struct.Memory* %loadMem1_4139ea, %struct.Memory** %MEMORY
  %loadMem2_4139ea = load %struct.Memory*, %struct.Memory** %MEMORY
  %loadPC_4139ea = load i64, i64* %3
  %286 = call %struct.Memory* @__remill_function_call(%struct.State* %0, i64 ptrtoint (i64 (i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64)* @printf to i64), %struct.Memory* %loadMem2_4139ea)
...
block_.L_4139f2:                                  ; preds = %block_4139d7, %entry
  ...
  ret %struct.Memory* %loadMem_4139f7
}
