...
entry:
  ...
  store i32 %78, i32* %82
  store %struct.Memory* %loadMem_413c48, %struct.Memory** %MEMORY
  ...
  %loadMem1_413c54 = load %struct.Memory*, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem1_413c54, %struct.Memory** %MEMORY
  %loadMem2_413c54 = load %struct.Memory*, %struct.Memory** %MEMORY
  %loadPC_413c54 = load i64, i64* %3
  %call2_413c54 = call %struct.Memory* @sub_413c30._ZN25custom_multiply_constantsIiE8do_shiftEi(%struct.State* %0, i64 %loadPC_413c54, %struct.Memory* %loadMem2_413c54)
  store %struct.Memory* %call2_413c54, %struct.Memory** %MEMORY
  %loadMem_413c59 = load %struct.Memory*, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_413c59, %struct.Memory** %MEMORY
  ...
  %loadMem1_413c6a = load %struct.Memory*, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem1_413c6a, %struct.Memory** %MEMORY
  %loadMem2_413c6a = load %struct.Memory*, %struct.Memory** %MEMORY
  %loadPC_413c6a = load i64, i64* %3
  %call2_413c6a = call %struct.Memory* @sub_412f20._Z15tolerance_equalIiEbRT_S1_(%struct.State* %0, i64 %loadPC_413c6a, %struct.Memory* %loadMem2_413c6a)
  store %struct.Memory* %call2_413c6a, %struct.Memory** %MEMORY
  ...
  %loadBr_413c71 = load i8, i8* %BRANCH_TAKEN
  %cmpBr_413c71 = icmp eq i8 %loadBr_413c71, 1
  br i1 %cmpBr_413c71, label %block_.L_413c92, label %block_413c77

block_413c77:                                     ; preds = %entry
  ...
  %loadMem1_413c8a = load %struct.Memory*, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem1_413c8a, %struct.Memory** %MEMORY
  %loadMem2_413c8a = load %struct.Memory*, %struct.Memory** %MEMORY
  %loadPC_413c8a = load i64, i64* %3
  %286 = call %struct.Memory* @__remill_function_call(%struct.State* %0, i64 ptrtoint (i64 (i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64)* @printf to i64), %struct.Memory* %loadMem2_413c8a)
  ...
  br label %block_.L_413c92

block_.L_413c92:                                  ; preds = %block_413c77, %entry
  ...
  ret %struct.Memory* %loadMem_413c97
}
...
define %struct.Memory* @routine_jne_.L_413c92(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i8* %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) {
block_400478:
  %3 = getelementptr inbounds %struct.State, %struct.State* %0, i32 0, i32 6
  %4 = getelementptr inbounds %struct.GPR, %struct.GPR* %3, i32 0, i32 33
  %5 = getelementptr inbounds %struct.Reg, %struct.Reg* %4, i32 0, i32 0
