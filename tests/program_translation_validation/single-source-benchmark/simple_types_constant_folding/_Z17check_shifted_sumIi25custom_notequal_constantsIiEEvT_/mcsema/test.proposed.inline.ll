...
entry:
  ...
  store %struct.Memory* %loadMem1_413ae4, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem1_413afa, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_413aff, %struct.Memory** %MEMORY
...
block_413b07:                                     ; preds = %entry
  ...
  store %struct.Memory* %loadMem1_413b1a, %struct.Memory** %MEMORY
  %loadMem2_413b1a = load %struct.Memory*, %struct.Memory** %MEMORY
  %loadPC_413b1a = load i64, i64* %3
  %286 = call %struct.Memory* @__remill_function_call(%struct.State* %0, i64 ptrtoint (i64 (i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64)* @printf to i64), %struct.Memory* %loadMem2_413b1a)
...
block_.L_413b22:                                  ; preds = %block_413b07, %entry
  ...
  ret %struct.Memory* %loadMem_413b27
}
