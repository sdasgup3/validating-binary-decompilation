...
entry:
  ...
  store %struct.Memory* %loadMem1_413044, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_413049, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_41304d, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_413057, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem1_41305a, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_41305f, %struct.Memory** %MEMORY
...
block_413067:                                     ; preds = %entry
  ...
  store %struct.Memory* %loadMem1_41307a, %struct.Memory** %MEMORY
  %loadMem2_41307a = load %struct.Memory*, %struct.Memory** %MEMORY
  %loadPC_41307a = load i64, i64* %3
  %286 = call %struct.Memory* @__remill_function_call(%struct.State* %0, i64 ptrtoint (i64 (i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64)* @printf to i64), %struct.Memory* %loadMem2_41307a)
  ...
  store %struct.Memory* %loadMem_41307f, %struct.Memory** %MEMORY
  br label %block_.L_413082

block_.L_413082:                                  ; preds = %block_413067, %entry
  ...
  ret %struct.Memory* %loadMem_413087
}
