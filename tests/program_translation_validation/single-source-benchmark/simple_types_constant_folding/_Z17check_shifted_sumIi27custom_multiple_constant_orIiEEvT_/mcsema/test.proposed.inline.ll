...
entry:
  ...
  store %struct.Memory* %loadMem1_41301a, %struct.Memory** %MEMORY
...
block_413027:                                     ; preds = %entry
  ...
  store %struct.Memory* %loadMem1_41303a, %struct.Memory** %MEMORY
  %loadMem2_41303a = load %struct.Memory*, %struct.Memory** %MEMORY
  %loadPC_41303a = load i64, i64* %3
  %286 = call %struct.Memory* @__remill_function_call(%struct.State* %0, i64 ptrtoint (i64 (i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64)* @printf to i64), %struct.Memory* %loadMem2_41303a)
  ...
  store %struct.Memory* %loadMem_41303f, %struct.Memory** %MEMORY
  br label %block_.L_413042

block_.L_413042:                                  ; preds = %block_413027, %entry
  ...
  store %struct.Memory* %loadMem_413047, %struct.Memory** %MEMORY
  ret %struct.Memory* %loadMem_413047
}
