...
define %struct.Memory* @_Z17check_shifted_sumIi27custom_multiple_constant_orIiEEvT_(%struct.State* noalias, i64, %struct.Memory* noalias) #2 {
entry:
  ...
  store %struct.Memory* %loadMem_413040, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_413041, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_413044, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem1_413054, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_413061, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_413067, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem1_41306a, %struct.Memory** %MEMORY
...
block_413077:                                     ; preds = %entry
  ...
  store %struct.Memory* %loadMem_413081, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_413088, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem1_41308a, %struct.Memory** %MEMORY
  %loadMem2_41308a = load %struct.Memory*, %struct.Memory** %MEMORY
  %loadPC_41308a = load i64, i64* %3
  %286 = call %struct.Memory* @__remill_function_call(%struct.State* %0, i64 ptrtoint (i64 (i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64)* @printf to i64), %struct.Memory* %loadMem2_41308a)
...
block_.L_413092:                                  ; preds = %block_413077, %entry
  ...
  store %struct.Memory* %loadMem_413096, %struct.Memory** %MEMORY
  ...
  ret %struct.Memory* %loadMem_413097
}
