...
define %struct.Memory* @_Z17check_shifted_sumIi28custom_multiple_constant_andIiEEvT_(%struct.State* noalias, i64, %struct.Memory* noalias) #2 {
entry:
  ...
  store %struct.Memory* %loadMem1_413154, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem1_41316a, %struct.Memory** %MEMORY
...
block_413177:                                     ; preds = %entry
  ...
  store %struct.Memory* %loadMem1_41318a, %struct.Memory** %MEMORY
  %loadMem2_41318a = load %struct.Memory*, %struct.Memory** %MEMORY
  %loadPC_41318a = load i64, i64* %3
  %286 = call %struct.Memory* @__remill_function_call(%struct.State* %0, i64 ptrtoint (i64 (i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64)* @printf to i64), %struct.Memory* %loadMem2_41318a)
...
block_.L_413192:                                  ; preds = %block_413177, %entry
  ...
  store %struct.Memory* %loadMem_413192, %struct.Memory** %MEMORY
  ...
  ret %struct.Memory* %loadMem_413197
}
