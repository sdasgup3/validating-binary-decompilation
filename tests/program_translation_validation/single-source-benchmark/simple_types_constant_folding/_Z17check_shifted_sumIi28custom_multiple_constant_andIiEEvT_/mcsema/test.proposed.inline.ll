...
entry:
  ...
  store %struct.Memory* %loadMem1_413144, %struct.Memory** %MEMORY
...
block_413167:                                     ; preds = %entry
  ...
  store %struct.Memory* %loadMem1_41317a, %struct.Memory** %MEMORY
  %loadMem2_41317a = load %struct.Memory*, %struct.Memory** %MEMORY
  %loadPC_41317a = load i64, i64* %3
  %286 = call %struct.Memory* @__remill_function_call(%struct.State* %0, i64 ptrtoint (i64 (i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64)* @printf to i64), %struct.Memory* %loadMem2_41317a)
...
block_.L_413182:                                  ; preds = %block_413167, %entry
  ...
  ret %struct.Memory* %loadMem_413187
}
