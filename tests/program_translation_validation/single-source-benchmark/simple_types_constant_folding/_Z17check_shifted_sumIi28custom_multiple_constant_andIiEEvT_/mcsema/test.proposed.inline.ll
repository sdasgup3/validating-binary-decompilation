...
block_413127:                                     ; preds = %entry
  ...
  store %struct.Memory* %loadMem1_41313a, %struct.Memory** %MEMORY
  %loadMem2_41313a = load %struct.Memory*, %struct.Memory** %MEMORY
  %loadPC_41313a = load i64, i64* %3
  %286 = call %struct.Memory* @__remill_function_call(%struct.State* %0, i64 ptrtoint (i64 (i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64)* @printf to i64), %struct.Memory* %loadMem2_41313a)
...
block_.L_413142:                                  ; preds = %block_413127, %entry
  ...
  ret %struct.Memory* %loadMem_413147
}
