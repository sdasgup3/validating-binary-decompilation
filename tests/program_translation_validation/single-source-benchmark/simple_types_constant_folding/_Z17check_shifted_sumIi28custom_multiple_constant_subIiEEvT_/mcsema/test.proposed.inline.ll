...
block_4135f7:                                     ; preds = %entry
  ...
  %call2_41360a = call %struct.Memory* @sub_4006c0.printf_plt(%struct.State* %0, i64 %loadPC_41360a, %struct.Memory* %loadMem2_41360a)
  store %struct.Memory* %call2_41360a, %struct.Memory** %MEMORY
