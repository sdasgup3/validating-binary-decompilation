...
entry:
  ...
  %loadMem_412ec0 = load %struct.Memory*, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_412ec0, %struct.Memory** %MEMORY
  ...
  %loadMem_412ec8 = load %struct.Memory*, %struct.Memory** %MEMORY
  ...
  store i32 %78, i32* %82
  store %struct.Memory* %loadMem_412ec8, %struct.Memory** %MEMORY
  ...
  %loadMem1_412ed4 = load %struct.Memory*, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem1_412ed4, %struct.Memory** %MEMORY
  %loadMem2_412ed4 = load %struct.Memory*, %struct.Memory** %MEMORY
  %loadPC_412ed4 = load i64, i64* %3
  %call2_412ed4 = call %struct.Memory* @sub_412ea0._ZN28custom_multiple_constant_xorIiE8do_shiftEi(%struct.State* %0, i64 %loadPC_412ed4, %struct.Memory* %loadMem2_412ed4)
  store %struct.Memory* %call2_412ed4, %struct.Memory** %MEMORY
  ...
  %loadMem1_412eea = load %struct.Memory*, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem1_412eea, %struct.Memory** %MEMORY
  %loadMem2_412eea = load %struct.Memory*, %struct.Memory** %MEMORY
  %loadPC_412eea = load i64, i64* %3
  %call2_412eea = call %struct.Memory* @sub_412f20._Z15tolerance_equalIiEbRT_S1_(%struct.State* %0, i64 %loadPC_412eea, %struct.Memory* %loadMem2_412eea)
  store %struct.Memory* %call2_412eea, %struct.Memory** %MEMORY
  %loadMem_412eef = load %struct.Memory*, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_412eef, %struct.Memory** %MEMORY
  ...
  %loadBr_412ef1 = load i8, i8* %BRANCH_TAKEN
  %cmpBr_412ef1 = icmp eq i8 %loadBr_412ef1, 1
  br i1 %cmpBr_412ef1, label %block_.L_412f12, label %block_412ef7

block_412ef7:                                     ; preds = %entry
  ...
  %loadMem1_412f0a = load %struct.Memory*, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem1_412f0a, %struct.Memory** %MEMORY
  %loadMem2_412f0a = load %struct.Memory*, %struct.Memory** %MEMORY
  %loadPC_412f0a = load i64, i64* %3
  %286 = call %struct.Memory* @__remill_function_call(%struct.State* %0, i64 ptrtoint (i64 (i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64)* @printf to i64), %struct.Memory* %loadMem2_412f0a)
  ...
  br label %block_.L_412f12

block_.L_412f12:                                  ; preds = %block_412ef7, %entry
  %loadMem_412f12 = load %struct.Memory*, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_412f12, %struct.Memory** %MEMORY
  ...
  %loadMem_412f17 = load %struct.Memory*, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_412f17, %struct.Memory** %MEMORY
  ret %struct.Memory* %loadMem_412f17
}
...
define %struct.Memory* @routine_jne_.L_412f12(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i8* %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) {
block_400478:
  %3 = getelementptr inbounds %struct.State, %struct.State* %0, i32 0, i32 6
  %4 = getelementptr inbounds %struct.GPR, %struct.GPR* %3, i32 0, i32 33
  %5 = getelementptr inbounds %struct.Reg, %struct.Reg* %4, i32 0, i32 0
