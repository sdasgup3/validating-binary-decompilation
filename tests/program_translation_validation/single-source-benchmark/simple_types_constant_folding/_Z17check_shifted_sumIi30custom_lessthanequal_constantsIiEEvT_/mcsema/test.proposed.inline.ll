...
entry:
  ...
  %loadMem1_4138d4 = load %struct.Memory*, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem1_4138d4, %struct.Memory** %MEMORY
  %loadMem2_4138d4 = load %struct.Memory*, %struct.Memory** %MEMORY
  %loadPC_4138d4 = load i64, i64* %3
  %call2_4138d4 = call %struct.Memory* @sub_4138b0._ZN30custom_lessthanequal_constantsIiE8do_shiftEi(%struct.State* %0, i64 %loadPC_4138d4, %struct.Memory* %loadMem2_4138d4)
  store %struct.Memory* %call2_4138d4, %struct.Memory** %MEMORY
  %loadMem_4138d9 = load %struct.Memory*, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_4138d9, %struct.Memory** %MEMORY
  ...
  %call2_4138ea = call %struct.Memory* @sub_412f20._Z15tolerance_equalIiEbRT_S1_(%struct.State* %0, i64 %loadPC_4138ea, %struct.Memory* %loadMem2_4138ea)
  store %struct.Memory* %call2_4138ea, %struct.Memory** %MEMORY
  ...
  %loadBr_4138f1 = load i8, i8* %BRANCH_TAKEN
  %cmpBr_4138f1 = icmp eq i8 %loadBr_4138f1, 1
  br i1 %cmpBr_4138f1, label %block_.L_413912, label %block_4138f7
...
block_4138f7:                                     ; preds = %entry
  ...
  %loadMem1_41390a = load %struct.Memory*, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem1_41390a, %struct.Memory** %MEMORY
  %loadMem2_41390a = load %struct.Memory*, %struct.Memory** %MEMORY
  %loadPC_41390a = load i64, i64* %3
  %286 = call %struct.Memory* @__remill_function_call(%struct.State* %0, i64 ptrtoint (i64 (i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64)* @printf to i64), %struct.Memory* %loadMem2_41390a)
...
block_.L_413912:                                  ; preds = %block_4138f7, %entry
  ...
  ret %struct.Memory* %loadMem_413917
}
...
define %struct.Memory* @routine_jne_.L_413912(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i8* %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) {
block_400478:
  %3 = getelementptr inbounds %struct.State, %struct.State* %0, i32 0, i32 6
  %4 = getelementptr inbounds %struct.GPR, %struct.GPR* %3, i32 0, i32 33
  %5 = getelementptr inbounds %struct.Reg, %struct.Reg* %4, i32 0, i32 0
