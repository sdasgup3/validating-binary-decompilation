...
block_413937:                                     ; preds = %entry
  ...
  %call2_41394a = call %struct.Memory* @sub_4006c0.printf_plt(%struct.State* %0, i64 %loadPC_41394a, %struct.Memory* %loadMem2_41394a)
  store %struct.Memory* %call2_41394a, %struct.Memory** %MEMORY
