...
define %struct.Memory* @_Z17check_shifted_sumIi32custom_multiple_constant_divide2IiEEvT_(%struct.State* noalias, i64, %struct.Memory* noalias) #2 {
entry:
  ...
  store %struct.Memory* %loadMem1_413284, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_413289, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem1_41329a, %struct.Memory** %MEMORY
...
block_4132a7:                                     ; preds = %entry
  ...
  store %struct.Memory* %loadMem1_4132ba, %struct.Memory** %MEMORY
  %loadMem2_4132ba = load %struct.Memory*, %struct.Memory** %MEMORY
  %loadPC_4132ba = load i64, i64* %3
  %286 = call %struct.Memory* @__remill_function_call(%struct.State* %0, i64 ptrtoint (i64 (i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64)* @printf to i64), %struct.Memory* %loadMem2_4132ba)
...
block_.L_4132c2:                                  ; preds = %block_4132a7, %entry
  ...
  ret %struct.Memory* %loadMem_4132c7
}
