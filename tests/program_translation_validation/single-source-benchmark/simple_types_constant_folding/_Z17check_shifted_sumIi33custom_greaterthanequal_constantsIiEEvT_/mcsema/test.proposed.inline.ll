...
entry:
  ...
  store %struct.Memory* %loadMem1_413994, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem1_4139aa, %struct.Memory** %MEMORY
...
block_4139b7:                                     ; preds = %entry
  ...
  %286 = call %struct.Memory* @__remill_function_call(%struct.State* %0, i64 ptrtoint (i64 (i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64)* @printf to i64), %struct.Memory* %loadMem2_4139ca)
...
block_.L_4139d2:                                  ; preds = %block_4139b7, %entry
  ...
  ret %struct.Memory* %loadMem_4139d7
}
