...
define %struct.Memory* @_Z17check_shifted_sumIi33custom_multiple_constant_multiplyIiEEvT_(%struct.State* noalias, i64, %struct.Memory* noalias) #2 {
entry:
  ...
  %loadMem_413490 = load %struct.Memory*, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_413490, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_413491, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_413494, %struct.Memory** %MEMORY
  ...
  store i32 %78, i32* %82
  store %struct.Memory* %loadMem_413498, %struct.Memory** %MEMORY
  ...
  %loadMem1_4134a4 = load %struct.Memory*, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem1_4134a4, %struct.Memory** %MEMORY
  %loadMem2_4134a4 = load %struct.Memory*, %struct.Memory** %MEMORY
  %loadPC_4134a4 = load i64, i64* %3
  %call2_4134a4 = call %struct.Memory* @sub_413470._ZN33custom_multiple_constant_multiplyIiE8do_shiftEi(%struct.State* %0, i64 %loadPC_4134a4, %struct.Memory* %loadMem2_4134a4)
  store %struct.Memory* %call2_4134a4, %struct.Memory** %MEMORY
  %loadMem_4134a9 = load %struct.Memory*, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_4134a9, %struct.Memory** %MEMORY
  ...
  %loadMem1_4134ba = load %struct.Memory*, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem1_4134ba, %struct.Memory** %MEMORY
  %loadMem2_4134ba = load %struct.Memory*, %struct.Memory** %MEMORY
  %loadPC_4134ba = load i64, i64* %3
  %call2_4134ba = call %struct.Memory* @sub_412f20._Z15tolerance_equalIiEbRT_S1_(%struct.State* %0, i64 %loadPC_4134ba, %struct.Memory* %loadMem2_4134ba)
  store %struct.Memory* %call2_4134ba, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_4134bf, %struct.Memory** %MEMORY
  ...
  %loadBr_4134c1 = load i8, i8* %BRANCH_TAKEN
  %cmpBr_4134c1 = icmp eq i8 %loadBr_4134c1, 1
  br i1 %cmpBr_4134c1, label %block_.L_4134e2, label %block_4134c7
...
block_4134c7:                                     ; preds = %entry
  ...
  %loadMem_4134d8 = load %struct.Memory*, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_4134d8, %struct.Memory** %MEMORY
  %loadMem1_4134da = load %struct.Memory*, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem1_4134da, %struct.Memory** %MEMORY
  %loadMem2_4134da = load %struct.Memory*, %struct.Memory** %MEMORY
  %loadPC_4134da = load i64, i64* %3
  %286 = call %struct.Memory* @__remill_function_call(%struct.State* %0, i64 ptrtoint (i64 (i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64)* @printf to i64), %struct.Memory* %loadMem2_4134da)
...
block_.L_4134e2:                                  ; preds = %block_4134c7, %entry
  ...
  store %struct.Memory* %loadMem_4134e7, %struct.Memory** %MEMORY
  ret %struct.Memory* %loadMem_4134e7
}
...
define %struct.Memory* @routine_jne_.L_4134e2(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i8* %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) {
block_400478:
  %3 = getelementptr inbounds %struct.State, %struct.State* %0, i32 0, i32 6
  %4 = getelementptr inbounds %struct.GPR, %struct.GPR* %3, i32 0, i32 33
  %5 = getelementptr inbounds %struct.Reg, %struct.Reg* %4, i32 0, i32 0
