...
define %struct.Memory* @_Z17check_shifted_sumIi34custom_multiple_constant_multiply2IiEEvT_(%struct.State* noalias, i64, %struct.Memory* noalias) #2 {
entry:
  ...
  store %struct.Memory* %loadMem_413460, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_413461, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem1_413474, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem1_41348a, %struct.Memory** %MEMORY
...
block_413497:                                     ; preds = %entry
  ...
  store %struct.Memory* %loadMem1_4134aa, %struct.Memory** %MEMORY
  %loadMem2_4134aa = load %struct.Memory*, %struct.Memory** %MEMORY
  %loadPC_4134aa = load i64, i64* %3
  %286 = call %struct.Memory* @__remill_function_call(%struct.State* %0, i64 ptrtoint (i64 (i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64)* @printf to i64), %struct.Memory* %loadMem2_4134aa)
...
block_.L_4134b2:                                  ; preds = %block_413497, %entry
  ...
  ret %struct.Memory* %loadMem_4134b7
}
