...
@G_0x20f234__rip__4271700_ = global %G_0x20f234__rip__4271700__type zeroinitializer
...
entry:
  ...
  %92 = load double, double* bitcast (%G_0x20f234__rip__4271700__type* @G_0x20f234__rip__4271700_ to double*)
  ...
  store %struct.Memory* %loadMem1_412e56, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_412e73, %struct.Memory** %MEMORY
...
block_412e79:                                     ; preds = %entry
  ...
  store %struct.Memory* %loadMem1_412e8c, %struct.Memory** %MEMORY
  %loadMem2_412e8c = load %struct.Memory*, %struct.Memory** %MEMORY
  %loadPC_412e8c = load i64, i64* %3
  %300 = call %struct.Memory* @__remill_function_call(%struct.State* %0, i64 ptrtoint (i64 (i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64)* @printf to i64), %struct.Memory* %loadMem2_412e8c)
...
block_.L_412e94:                                  ; preds = %block_412e79, %entry
  ...
  ret %struct.Memory* %loadMem_412e99
}
...
define %struct.Memory* @routine_cvttsd2si_0x20f234__rip____rax(%struct.State* dereferenceable(3376), i64, %struct.Memory*) {
block_400478:
  %3 = getelementptr inbounds %struct.State, %struct.State* %0, i32 0, i32 6
  %4 = getelementptr inbounds %struct.GPR, %struct.GPR* %3, i32 0, i32 33
  %5 = getelementptr inbounds %struct.Reg, %struct.Reg* %4, i32 0, i32 0
