...
entry:
  ...
  store %struct.Memory* %loadMem1_412286, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem1_41229c, %struct.Memory** %MEMORY
...
block_4122a9:                                     ; preds = %entry
  ...
  store %struct.Memory* %loadMem1_4122bc, %struct.Memory** %MEMORY
  %loadMem2_4122bc = load %struct.Memory*, %struct.Memory** %MEMORY
  %loadPC_4122bc = load i64, i64* %3
  %302 = call %struct.Memory* @__remill_function_call(%struct.State* %0, i64 ptrtoint (i64 (i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64)* @printf to i64), %struct.Memory* %loadMem2_4122bc)
...
block_.L_4122c4:                                  ; preds = %block_4122a9, %entry
  ...
  ret %struct.Memory* %loadMem_4122c9
}
...
define %struct.Memory* @routine_cvttsd2si_0x20fe04__rip____rax(%struct.State* dereferenceable(3376), i64, %struct.Memory*) {
block_400488:
  %3 = getelementptr inbounds %struct.State, %struct.State* %0, i32 0, i32 6
  %4 = getelementptr inbounds %struct.GPR, %struct.GPR* %3, i32 0, i32 33
  %5 = getelementptr inbounds %struct.Reg, %struct.Reg* %4, i32 0, i32 0
