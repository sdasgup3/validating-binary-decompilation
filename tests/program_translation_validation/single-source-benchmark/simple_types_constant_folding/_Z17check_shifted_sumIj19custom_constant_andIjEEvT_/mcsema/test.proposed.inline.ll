...
@G_0x20fe44__rip__4268612_ = global %G_0x20fe44__rip__4268612__type zeroinitializer
...
entry:
  ...
  %92 = load double, double* bitcast (%G_0x20fe44__rip__4268612__type* @G_0x20fe44__rip__4268612_ to double*)
  ...
  store %struct.Memory* %loadMem1_412246, %struct.Memory** %MEMORY
...
block_412269:                                     ; preds = %entry
  ...
  %300 = call %struct.Memory* @__remill_function_call(%struct.State* %0, i64 ptrtoint (i64 (i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64)* @printf to i64), %struct.Memory* %loadMem2_41227c)
...
block_.L_412284:                                  ; preds = %block_412269, %entry
  ...
  ret %struct.Memory* %loadMem_412289
}
...
define %struct.Memory* @routine_cvttsd2si_0x20fe44__rip____rax(%struct.State* dereferenceable(3376), i64, %struct.Memory*) {
block_400478:
  %3 = getelementptr inbounds %struct.State, %struct.State* %0, i32 0, i32 6
  %4 = getelementptr inbounds %struct.GPR, %struct.GPR* %3, i32 0, i32 33
  %5 = getelementptr inbounds %struct.Reg, %struct.Reg* %4, i32 0, i32 0
