...
@G_0x20f9c4__rip__4269764_ = global %G_0x20f9c4__rip__4269764__type zeroinitializer
...
define %struct.Memory* @_Z17check_shifted_sumIj19custom_constant_subIjEEvT_(%struct.State* noalias, i64, %struct.Memory* noalias) #2 {
entry:
  ...
  %92 = load double, double* bitcast (%G_0x20f9c4__rip__4269764__type* @G_0x20f9c4__rip__4269764_ to double*)
  ...
  store %struct.Memory* %loadMem1_4126c6, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem1_4126dc, %struct.Memory** %MEMORY
...
block_4126e9:                                     ; preds = %entry
  ...
  store %struct.Memory* %loadMem1_4126fc, %struct.Memory** %MEMORY
  %loadMem2_4126fc = load %struct.Memory*, %struct.Memory** %MEMORY
  %loadPC_4126fc = load i64, i64* %3
  %300 = call %struct.Memory* @__remill_function_call(%struct.State* %0, i64 ptrtoint (i64 (i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64)* @printf to i64), %struct.Memory* %loadMem2_4126fc)
...
block_.L_412704:                                  ; preds = %block_4126e9, %entry
  ...
  ret %struct.Memory* %loadMem_412709
}
...
define %struct.Memory* @routine_cvttsd2si_0x20f9c4__rip____rax(%struct.State* dereferenceable(3376), i64, %struct.Memory*) {
block_400478:
  %3 = getelementptr inbounds %struct.State, %struct.State* %0, i32 0, i32 6
  %4 = getelementptr inbounds %struct.GPR, %struct.GPR* %3, i32 0, i32 33
  %5 = getelementptr inbounds %struct.Reg, %struct.Reg* %4, i32 0, i32 0
