...
define %struct.Memory* @_Z17check_shifted_sumIj19custom_constant_xorIjEEvT_(%struct.State* noalias, i64, %struct.Memory* noalias) #2 {
entry:
  ...
  %loadMem_412078 = load %struct.Memory*, %struct.Memory** %MEMORY
  ...
  store i32 %78, i32* %82
  store %struct.Memory* %loadMem_412078, %struct.Memory** %MEMORY
  ...
  %loadMem1_412086 = load %struct.Memory*, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem1_412086, %struct.Memory** %MEMORY
  %loadMem2_412086 = load %struct.Memory*, %struct.Memory** %MEMORY
  %loadPC_412086 = load i64, i64* %3
  %call2_412086 = call %struct.Memory* @sub_412050._ZN19custom_constant_xorIjE8do_shiftEj(%struct.State* %0, i64 %loadPC_412086, %struct.Memory* %loadMem2_412086)
  store %struct.Memory* %call2_412086, %struct.Memory** %MEMORY
  ...
  %loadMem_41208f = load %struct.Memory*, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_41208f, %struct.Memory** %MEMORY
  ...
  %loadMem_412099 = load %struct.Memory*, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_412099, %struct.Memory** %MEMORY
  %loadMem1_41209c = load %struct.Memory*, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem1_41209c, %struct.Memory** %MEMORY
  %loadMem2_41209c = load %struct.Memory*, %struct.Memory** %MEMORY
  %loadPC_41209c = load i64, i64* %3
  %call2_41209c = call %struct.Memory* @sub_412020._Z15tolerance_equalIjEbRT_S1_(%struct.State* %0, i64 %loadPC_41209c, %struct.Memory* %loadMem2_41209c)
  store %struct.Memory* %call2_41209c, %struct.Memory** %MEMORY
  ...
  %loadBr_4120a3 = load i8, i8* %BRANCH_TAKEN
  %cmpBr_4120a3 = icmp eq i8 %loadBr_4120a3, 1
  br i1 %cmpBr_4120a3, label %block_.L_4120c4, label %block_4120a9

block_4120a9:                                     ; preds = %entry
  ...
  store %struct.Memory* %loadMem_4120b3, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_4120ba, %struct.Memory** %MEMORY
  %loadMem1_4120bc = load %struct.Memory*, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem1_4120bc, %struct.Memory** %MEMORY
  %loadMem2_4120bc = load %struct.Memory*, %struct.Memory** %MEMORY
  %loadPC_4120bc = load i64, i64* %3
  %302 = call %struct.Memory* @__remill_function_call(%struct.State* %0, i64 ptrtoint (i64 (i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64)* @printf to i64), %struct.Memory* %loadMem2_4120bc)
  ...
  br label %block_.L_4120c4

block_.L_4120c4:                                  ; preds = %block_4120a9, %entry
  ...
  %loadMem_4120c9 = load %struct.Memory*, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_4120c9, %struct.Memory** %MEMORY
  ret %struct.Memory* %loadMem_4120c9
}
...
define %struct.Memory* @routine_cvttsd2si_0x210004__rip____rax(%struct.State* dereferenceable(3376), i64, %struct.Memory*) {
block_400488:
  %3 = getelementptr inbounds %struct.State, %struct.State* %0, i32 0, i32 6
  %4 = getelementptr inbounds %struct.GPR, %struct.GPR* %3, i32 0, i32 33
  %5 = getelementptr inbounds %struct.Reg, %struct.Reg* %4, i32 0, i32 0
...
define %struct.Memory* @routine_jne_.L_4120c4(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i8* %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) {
block_400488:
  %3 = getelementptr inbounds %struct.State, %struct.State* %0, i32 0, i32 6
  %4 = getelementptr inbounds %struct.GPR, %struct.GPR* %3, i32 0, i32 33
  %5 = getelementptr inbounds %struct.Reg, %struct.Reg* %4, i32 0, i32 0
