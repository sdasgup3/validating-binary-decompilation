...
%G_0x210044__rip__4268100__type = type <{ [8 x i8] }>
...
@G_0x210044__rip__4268100_ = global %G_0x210044__rip__4268100__type zeroinitializer
...
entry:
  ...
  %92 = load double, double* bitcast (%G_0x210044__rip__4268100__type* @G_0x210044__rip__4268100_ to double*)
  ...
  %loadMem1_412046 = load %struct.Memory*, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem1_412046, %struct.Memory** %MEMORY
  %loadMem2_412046 = load %struct.Memory*, %struct.Memory** %MEMORY
  %loadPC_412046 = load i64, i64* %3
  %call2_412046 = call %struct.Memory* @sub_412010._ZN19custom_constant_xorIjE8do_shiftEj(%struct.State* %0, i64 %loadPC_412046, %struct.Memory* %loadMem2_412046)
  store %struct.Memory* %call2_412046, %struct.Memory** %MEMORY
  ...
  %loadMem1_41205c = load %struct.Memory*, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem1_41205c, %struct.Memory** %MEMORY
  %loadMem2_41205c = load %struct.Memory*, %struct.Memory** %MEMORY
  %loadPC_41205c = load i64, i64* %3
  %call2_41205c = call %struct.Memory* @sub_411fe0._Z15tolerance_equalIjEbRT_S1_(%struct.State* %0, i64 %loadPC_41205c, %struct.Memory* %loadMem2_41205c)
  store %struct.Memory* %call2_41205c, %struct.Memory** %MEMORY
  ...
  %loadBr_412063 = load i8, i8* %BRANCH_TAKEN
  %cmpBr_412063 = icmp eq i8 %loadBr_412063, 1
  br i1 %cmpBr_412063, label %block_.L_412084, label %block_412069

block_412069:                                     ; preds = %entry
  ...
  %loadMem_412073 = load %struct.Memory*, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_412073, %struct.Memory** %MEMORY
  ...
  %loadMem1_41207c = load %struct.Memory*, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem1_41207c, %struct.Memory** %MEMORY
  %loadMem2_41207c = load %struct.Memory*, %struct.Memory** %MEMORY
  %loadPC_41207c = load i64, i64* %3
  %300 = call %struct.Memory* @__remill_function_call(%struct.State* %0, i64 ptrtoint (i64 (i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64)* @printf to i64), %struct.Memory* %loadMem2_41207c)
  ...
  br label %block_.L_412084

block_.L_412084:                                  ; preds = %block_412069, %entry
  ...
  store %struct.Memory* %loadMem_412089, %struct.Memory** %MEMORY
  ret %struct.Memory* %loadMem_412089
}
...
define %struct.Memory* @routine_cvttsd2si_0x210044__rip____rax(%struct.State* dereferenceable(3376), i64, %struct.Memory*) {
block_400478:
  %3 = getelementptr inbounds %struct.State, %struct.State* %0, i32 0, i32 6
  %4 = getelementptr inbounds %struct.GPR, %struct.GPR* %3, i32 0, i32 33
  %5 = getelementptr inbounds %struct.Reg, %struct.Reg* %4, i32 0, i32 0
  ...
  %9 = load i64, i64* %PC
  %10 = ptrtoint %G_0x210044__rip__4268100__type* @G_0x210044__rip__4268100_ to i64
  %11 = load i64, i64* %PC
  %12 = add i64 %11, 9
  store i64 %12, i64* %PC
...
define %struct.Memory* @routine_jne_.L_412084(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i8* %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) {
block_400478:
  %3 = getelementptr inbounds %struct.State, %struct.State* %0, i32 0, i32 6
  %4 = getelementptr inbounds %struct.GPR, %struct.GPR* %3, i32 0, i32 33
  %5 = getelementptr inbounds %struct.Reg, %struct.Reg* %4, i32 0, i32 0
