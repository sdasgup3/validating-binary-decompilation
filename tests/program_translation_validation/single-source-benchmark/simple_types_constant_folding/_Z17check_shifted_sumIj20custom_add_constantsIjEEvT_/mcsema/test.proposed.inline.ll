...
@G_0x20f2a4__rip__4271588_ = global %G_0x20f2a4__rip__4271588__type zeroinitializer
...
entry:
  ...
  store %struct.Memory* %loadMem_412dd0, %struct.Memory** %MEMORY
  ...
  store i32 %78, i32* %82
  store %struct.Memory* %loadMem_412dd8, %struct.Memory** %MEMORY
  ...
  %92 = load double, double* bitcast (%G_0x20f2a4__rip__4271588__type* @G_0x20f2a4__rip__4271588_ to double*)
  ...
  store %struct.Memory* %loadMem1_412dfc, %struct.Memory** %MEMORY
...
block_412e09:                                     ; preds = %entry
  ...
  store %struct.Memory* %loadMem_412e09, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem1_412e1c, %struct.Memory** %MEMORY
  %loadMem2_412e1c = load %struct.Memory*, %struct.Memory** %MEMORY
  %loadPC_412e1c = load i64, i64* %3
  %300 = call %struct.Memory* @__remill_function_call(%struct.State* %0, i64 ptrtoint (i64 (i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64)* @printf to i64), %struct.Memory* %loadMem2_412e1c)
...
block_.L_412e24:                                  ; preds = %block_412e09, %entry
  ...
  ret %struct.Memory* %loadMem_412e29
}
...
define %struct.Memory* @routine_cvttsd2si_0x20f2a4__rip____rax(%struct.State* dereferenceable(3376), i64, %struct.Memory*) {
block_400478:
  %3 = getelementptr inbounds %struct.State, %struct.State* %0, i32 0, i32 6
  %4 = getelementptr inbounds %struct.GPR, %struct.GPR* %3, i32 0, i32 33
  %5 = getelementptr inbounds %struct.Reg, %struct.Reg* %4, i32 0, i32 0
