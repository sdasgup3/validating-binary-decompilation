...
entry:
  ...
  %loadMem1_412956 = load %struct.Memory*, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem1_412956, %struct.Memory** %MEMORY
  %loadMem2_412956 = load %struct.Memory*, %struct.Memory** %MEMORY
  %loadPC_412956 = load i64, i64* %3
  %call2_412956 = call %struct.Memory* @sub_412930._ZN20custom_and_constantsIjE8do_shiftEj(%struct.State* %0, i64 %loadPC_412956, %struct.Memory* %loadMem2_412956)
  store %struct.Memory* %call2_412956, %struct.Memory** %MEMORY
  ...
  %call2_41296c = call %struct.Memory* @sub_412020._Z15tolerance_equalIjEbRT_S1_(%struct.State* %0, i64 %loadPC_41296c, %struct.Memory* %loadMem2_41296c)
  ...
  %loadBr_412973 = load i8, i8* %BRANCH_TAKEN
  %cmpBr_412973 = icmp eq i8 %loadBr_412973, 1
  br i1 %cmpBr_412973, label %block_.L_412994, label %block_412979
...
block_412979:                                     ; preds = %entry
  ...
  %loadMem1_41298c = load %struct.Memory*, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem1_41298c, %struct.Memory** %MEMORY
  %loadMem2_41298c = load %struct.Memory*, %struct.Memory** %MEMORY
  %loadPC_41298c = load i64, i64* %3
  %302 = call %struct.Memory* @__remill_function_call(%struct.State* %0, i64 ptrtoint (i64 (i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64)* @printf to i64), %struct.Memory* %loadMem2_41298c)
...
block_.L_412994:                                  ; preds = %block_412979, %entry
  ...
  store %struct.Memory* %loadMem_412994, %struct.Memory** %MEMORY
  ...
  ret %struct.Memory* %loadMem_412999
}
...
define %struct.Memory* @routine_cvttsd2si_0x20f734__rip____rax(%struct.State* dereferenceable(3376), i64, %struct.Memory*) {
block_400488:
  %3 = getelementptr inbounds %struct.State, %struct.State* %0, i32 0, i32 6
  %4 = getelementptr inbounds %struct.GPR, %struct.GPR* %3, i32 0, i32 33
  %5 = getelementptr inbounds %struct.Reg, %struct.Reg* %4, i32 0, i32 0
...
define %struct.Memory* @routine_jne_.L_412994(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i8* %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) {
block_400488:
  %3 = getelementptr inbounds %struct.State, %struct.State* %0, i32 0, i32 6
  %4 = getelementptr inbounds %struct.GPR, %struct.GPR* %3, i32 0, i32 33
  %5 = getelementptr inbounds %struct.Reg, %struct.Reg* %4, i32 0, i32 0
