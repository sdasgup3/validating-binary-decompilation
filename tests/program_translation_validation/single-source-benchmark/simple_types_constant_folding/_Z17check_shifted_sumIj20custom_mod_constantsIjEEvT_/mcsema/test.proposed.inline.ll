...
%G_0x20f414__rip__type = type <{ [8 x i8] }>
...
@G_0x20f414__rip_ = global %G_0x20f414__rip__type zeroinitializer
...
entry:
  ...
  %90 = add i64 %89, ptrtoint (%G_0x20f414__rip__type* @G_0x20f414__rip_ to i64)
  ...
  %loadMem1_412c76 = load %struct.Memory*, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem1_412c76, %struct.Memory** %MEMORY
  %loadMem2_412c76 = load %struct.Memory*, %struct.Memory** %MEMORY
  %loadPC_412c76 = load i64, i64* %3
  %call2_412c76 = call %struct.Memory* @sub_412c50._ZN20custom_mod_constantsIjE8do_shiftEj(%struct.State* %0, i64 %loadPC_412c76, %struct.Memory* %loadMem2_412c76)
  store %struct.Memory* %call2_412c76, %struct.Memory** %MEMORY
  ...
  %loadMem_412c89 = load %struct.Memory*, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_412c89, %struct.Memory** %MEMORY
  %loadMem1_412c8c = load %struct.Memory*, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem1_412c8c, %struct.Memory** %MEMORY
  %loadMem2_412c8c = load %struct.Memory*, %struct.Memory** %MEMORY
  %loadPC_412c8c = load i64, i64* %3
  %call2_412c8c = call %struct.Memory* @sub_412030._Z15tolerance_equalIjEbRT_S1_(%struct.State* %0, i64 %loadPC_412c8c, %struct.Memory* %loadMem2_412c8c)
  store %struct.Memory* %call2_412c8c, %struct.Memory** %MEMORY
  ...
  %loadBr_412c93 = load i8, i8* %BRANCH_TAKEN
  %cmpBr_412c93 = icmp eq i8 %loadBr_412c93, 1
  br i1 %cmpBr_412c93, label %block_.L_412cb4, label %block_412c99

block_412c99:                                     ; preds = %entry
  ...
  %302 = call %struct.Memory* @__remill_function_call(%struct.State* %0, i64 ptrtoint (i64 (i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64)* @printf to i64), %struct.Memory* %loadMem2_412cac)
  ...
  br label %block_.L_412cb4

block_.L_412cb4:                                  ; preds = %block_412c99, %entry
  ...
  ret %struct.Memory* %loadMem_412cb9
}
...
; Function Attrs: alwaysinline
define %struct.Memory* @routine_cvttsd2si_0x20f414__rip____rax(%struct.State* dereferenceable(3376), i64, %struct.Memory*) #2 {
block_400488:
  %3 = getelementptr inbounds %struct.State, %struct.State* %0, i32 0, i32 6
  %4 = getelementptr inbounds %struct.GPR, %struct.GPR* %3, i32 0, i32 33
  %5 = getelementptr inbounds %struct.Reg, %struct.Reg* %4, i32 0, i32 0
  ...
  %9 = load i64, i64* %PC
  %10 = add i64 %9, ptrtoint (%G_0x20f414__rip__type* @G_0x20f414__rip_ to i64)
  %11 = load i64, i64* %PC
  %12 = add i64 %11, 9
  store i64 %12, i64* %PC
...
; Function Attrs: alwaysinline
define %struct.Memory* @routine_jne_.L_412cb4(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i8* %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) #2 {
block_400488:
  %3 = getelementptr inbounds %struct.State, %struct.State* %0, i32 0, i32 6
  %4 = getelementptr inbounds %struct.GPR, %struct.GPR* %3, i32 0, i32 33
  %5 = getelementptr inbounds %struct.Reg, %struct.Reg* %4, i32 0, i32 0
