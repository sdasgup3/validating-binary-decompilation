...
%G_0x20f464__rip__4271140__type = type <{ [8 x i8] }>
...
@G_0x20f464__rip__4271140_ = global %G_0x20f464__rip__4271140__type zeroinitializer
...
define %struct.Memory* @_Z17check_shifted_sumIj20custom_mod_constantsIjEEvT_(%struct.State* noalias, i64, %struct.Memory* noalias) #2 {
entry:
  ...
  %92 = load double, double* bitcast (%G_0x20f464__rip__4271140__type* @G_0x20f464__rip__4271140_ to double*)
  ...
  %loadMem1_412c26 = load %struct.Memory*, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem1_412c26, %struct.Memory** %MEMORY
  %loadMem2_412c26 = load %struct.Memory*, %struct.Memory** %MEMORY
  %loadPC_412c26 = load i64, i64* %3
  %call2_412c26 = call %struct.Memory* @sub_412c00._ZN20custom_mod_constantsIjE8do_shiftEj(%struct.State* %0, i64 %loadPC_412c26, %struct.Memory* %loadMem2_412c26)
  store %struct.Memory* %call2_412c26, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_412c2f, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_412c39, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem1_412c3c, %struct.Memory** %MEMORY
  %loadMem2_412c3c = load %struct.Memory*, %struct.Memory** %MEMORY
  %loadPC_412c3c = load i64, i64* %3
  %call2_412c3c = call %struct.Memory* @sub_411fe0._Z15tolerance_equalIjEbRT_S1_(%struct.State* %0, i64 %loadPC_412c3c, %struct.Memory* %loadMem2_412c3c)
  ...
  %loadBr_412c43 = load i8, i8* %BRANCH_TAKEN
  %cmpBr_412c43 = icmp eq i8 %loadBr_412c43, 1
  br i1 %cmpBr_412c43, label %block_.L_412c64, label %block_412c49

block_412c49:                                     ; preds = %entry
  ...
  store %struct.Memory* %loadMem_412c49, %struct.Memory** %MEMORY
  ...
  %loadMem1_412c5c = load %struct.Memory*, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem1_412c5c, %struct.Memory** %MEMORY
  %loadMem2_412c5c = load %struct.Memory*, %struct.Memory** %MEMORY
  %loadPC_412c5c = load i64, i64* %3
  %300 = call %struct.Memory* @__remill_function_call(%struct.State* %0, i64 ptrtoint (i64 (i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64)* @printf to i64), %struct.Memory* %loadMem2_412c5c)
  ...
  br label %block_.L_412c64

block_.L_412c64:                                  ; preds = %block_412c49, %entry
  ...
  ret %struct.Memory* %loadMem_412c69
}
...
define %struct.Memory* @routine_cvttsd2si_0x20f464__rip____rax(%struct.State* dereferenceable(3376), i64, %struct.Memory*) {
block_400478:
  %3 = getelementptr inbounds %struct.State, %struct.State* %0, i32 0, i32 6
  %4 = getelementptr inbounds %struct.GPR, %struct.GPR* %3, i32 0, i32 33
  %5 = getelementptr inbounds %struct.Reg, %struct.Reg* %4, i32 0, i32 0
  ...
  %9 = load i64, i64* %PC
  %10 = ptrtoint %G_0x20f464__rip__4271140__type* @G_0x20f464__rip__4271140_ to i64
  %11 = load i64, i64* %PC
  %12 = add i64 %11, 9
  store i64 %12, i64* %PC
...
define %struct.Memory* @routine_jne_.L_412c64(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i8* %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) {
block_400478:
  %3 = getelementptr inbounds %struct.State, %struct.State* %0, i32 0, i32 6
  %4 = getelementptr inbounds %struct.GPR, %struct.GPR* %3, i32 0, i32 33
  %5 = getelementptr inbounds %struct.Reg, %struct.Reg* %4, i32 0, i32 0
