...
@G_0x20f854__rip__4270132_ = global %G_0x20f854__rip__4270132__type zeroinitializer
...
entry:
  ...
  %92 = load double, double* bitcast (%G_0x20f854__rip__4270132__type* @G_0x20f854__rip__4270132_ to double*)
  ...
  store %struct.Memory* %loadMem1_412836, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_412843, %struct.Memory** %MEMORY
...
block_412859:                                     ; preds = %entry
  ...
  %300 = call %struct.Memory* @__remill_function_call(%struct.State* %0, i64 ptrtoint (i64 (i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64)* @printf to i64), %struct.Memory* %loadMem2_41286c)
...
block_.L_412874:                                  ; preds = %block_412859, %entry
  ...
  ret %struct.Memory* %loadMem_412879
}
...
define %struct.Memory* @routine_cvttsd2si_0x20f854__rip____rax(%struct.State* dereferenceable(3376), i64, %struct.Memory*) {
block_400478:
  %3 = getelementptr inbounds %struct.State, %struct.State* %0, i32 0, i32 6
  %4 = getelementptr inbounds %struct.GPR, %struct.GPR* %3, i32 0, i32 33
  %5 = getelementptr inbounds %struct.Reg, %struct.Reg* %4, i32 0, i32 0
