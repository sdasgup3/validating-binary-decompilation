...
@G_0x20fac4__rip__4269508_ = global %G_0x20fac4__rip__4269508__type zeroinitializer
...
define %struct.Memory* @_Z17check_shifted_sumIj24custom_constant_multiplyIjEEvT_(%struct.State* noalias, i64, %struct.Memory* noalias) #2 {
entry:
  ...
  %92 = load double, double* bitcast (%G_0x20fac4__rip__4269508__type* @G_0x20fac4__rip__4269508_ to double*)
  ...
  store %struct.Memory* %loadMem1_4125c6, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_4125e3, %struct.Memory** %MEMORY
...
block_4125e9:                                     ; preds = %entry
  ...
  store %struct.Memory* %loadMem1_4125fc, %struct.Memory** %MEMORY
  %loadMem2_4125fc = load %struct.Memory*, %struct.Memory** %MEMORY
  %loadPC_4125fc = load i64, i64* %3
  %300 = call %struct.Memory* @__remill_function_call(%struct.State* %0, i64 ptrtoint (i64 (i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64)* @printf to i64), %struct.Memory* %loadMem2_4125fc)
...
block_.L_412604:                                  ; preds = %block_4125e9, %entry
  ...
  ret %struct.Memory* %loadMem_412609
}
...
define %struct.Memory* @routine_cvttsd2si_0x20fac4__rip____rax(%struct.State* dereferenceable(3376), i64, %struct.Memory*) {
block_400478:
  %3 = getelementptr inbounds %struct.State, %struct.State* %0, i32 0, i32 6
  %4 = getelementptr inbounds %struct.GPR, %struct.GPR* %3, i32 0, i32 33
  %5 = getelementptr inbounds %struct.Reg, %struct.Reg* %4, i32 0, i32 0
