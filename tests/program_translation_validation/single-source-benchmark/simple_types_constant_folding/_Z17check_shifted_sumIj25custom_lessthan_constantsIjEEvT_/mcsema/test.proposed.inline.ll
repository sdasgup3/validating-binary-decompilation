...
@G_0x20f624__rip__4270692_ = global %G_0x20f624__rip__4270692__type zeroinitializer
...
define %struct.Memory* @_Z17check_shifted_sumIj25custom_lessthan_constantsIjEEvT_(%struct.State* noalias, i64, %struct.Memory* noalias) #2 {
entry:
  ...
  store %struct.Memory* %loadMem_412a54, %struct.Memory** %MEMORY
  ...
  %92 = load double, double* bitcast (%G_0x20f624__rip__4270692__type* @G_0x20f624__rip__4270692_ to double*)
  ...
  store %struct.Memory* %loadMem1_412a66, %struct.Memory** %MEMORY
...
block_412a89:                                     ; preds = %entry
  ...
  %300 = call %struct.Memory* @__remill_function_call(%struct.State* %0, i64 ptrtoint (i64 (i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64)* @printf to i64), %struct.Memory* %loadMem2_412a9c)
...
block_.L_412aa4:                                  ; preds = %block_412a89, %entry
  ...
  ret %struct.Memory* %loadMem_412aa9
}
...
define %struct.Memory* @routine_cvttsd2si_0x20f624__rip____rax(%struct.State* dereferenceable(3376), i64, %struct.Memory*) {
block_400478:
  %3 = getelementptr inbounds %struct.State, %struct.State* %0, i32 0, i32 6
  %4 = getelementptr inbounds %struct.GPR, %struct.GPR* %3, i32 0, i32 33
  %5 = getelementptr inbounds %struct.Reg, %struct.Reg* %4, i32 0, i32 0
