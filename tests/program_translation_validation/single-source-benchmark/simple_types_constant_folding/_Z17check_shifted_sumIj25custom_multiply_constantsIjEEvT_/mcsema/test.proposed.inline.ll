...
define %struct.Memory* @_Z17check_shifted_sumIj25custom_multiply_constantsIjEEvT_(%struct.State* noalias, i64, %struct.Memory* noalias) #2 {
entry:
  ...
  store %struct.Memory* %loadMem1_412d46, %struct.Memory** %MEMORY
...
block_412d69:                                     ; preds = %entry
  ...
  %302 = call %struct.Memory* @__remill_function_call(%struct.State* %0, i64 ptrtoint (i64 (i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64)* @printf to i64), %struct.Memory* %loadMem2_412d7c)
...
block_.L_412d84:                                  ; preds = %block_412d69, %entry
  ...
  ret %struct.Memory* %loadMem_412d89
}
...
define %struct.Memory* @routine_cvttsd2si_0x20f344__rip____rax(%struct.State* dereferenceable(3376), i64, %struct.Memory*) {
block_400488:
  %3 = getelementptr inbounds %struct.State, %struct.State* %0, i32 0, i32 6
  %4 = getelementptr inbounds %struct.GPR, %struct.GPR* %3, i32 0, i32 33
  %5 = getelementptr inbounds %struct.Reg, %struct.Reg* %4, i32 0, i32 0
