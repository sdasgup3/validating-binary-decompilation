...
define %struct.Memory* @_Z17check_shifted_sumIj25custom_notequal_constantsIjEEvT_(%struct.State* noalias, i64, %struct.Memory* noalias) #2 {
entry:
  ...
  %90 = add i64 %89, ptrtoint (%G_0x20f4f4__rip__type* @G_0x20f4f4__rip_ to i64)
  ...
  store %struct.Memory* %loadMem1_412b96, %struct.Memory** %MEMORY
...
block_412bb9:                                     ; preds = %entry
  ...
  %302 = call %struct.Memory* @__remill_function_call(%struct.State* %0, i64 ptrtoint (i64 (i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64)* @printf to i64), %struct.Memory* %loadMem2_412bcc)
...
block_.L_412bd4:                                  ; preds = %block_412bb9, %entry
  ...
  ret %struct.Memory* %loadMem_412bd9
}
...
; Function Attrs: alwaysinline
define %struct.Memory* @routine_cvttsd2si_0x20f4f4__rip____rax(%struct.State* dereferenceable(3376), i64, %struct.Memory*) #2 {
block_400488:
  %3 = getelementptr inbounds %struct.State, %struct.State* %0, i32 0, i32 6
  %4 = getelementptr inbounds %struct.GPR, %struct.GPR* %3, i32 0, i32 33
  %5 = getelementptr inbounds %struct.Reg, %struct.Reg* %4, i32 0, i32 0
...
; Function Attrs: alwaysinline
define %struct.Memory* @routine_jne_.L_412bd4(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i8* %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) #2 {
block_400488:
  %3 = getelementptr inbounds %struct.State, %struct.State* %0, i32 0, i32 6
  %4 = getelementptr inbounds %struct.GPR, %struct.GPR* %3, i32 0, i32 33
  %5 = getelementptr inbounds %struct.Reg, %struct.Reg* %4, i32 0, i32 0
