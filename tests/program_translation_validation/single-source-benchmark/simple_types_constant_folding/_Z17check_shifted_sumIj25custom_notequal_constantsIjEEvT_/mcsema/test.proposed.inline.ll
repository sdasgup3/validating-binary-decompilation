...
@G_0x20f544__rip__4270916_ = global %G_0x20f544__rip__4270916__type zeroinitializer
...
entry:
  ...
  store %struct.Memory* %loadMem_412b34, %struct.Memory** %MEMORY
  ...
  %92 = load double, double* bitcast (%G_0x20f544__rip__4270916__type* @G_0x20f544__rip__4270916_ to double*)
  ...
  store %struct.Memory* %loadMem1_412b46, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_412b4b, %struct.Memory** %MEMORY
...
block_412b69:                                     ; preds = %entry
  ...
  store %struct.Memory* %loadMem1_412b7c, %struct.Memory** %MEMORY
  %loadMem2_412b7c = load %struct.Memory*, %struct.Memory** %MEMORY
  %loadPC_412b7c = load i64, i64* %3
  %300 = call %struct.Memory* @__remill_function_call(%struct.State* %0, i64 ptrtoint (i64 (i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64)* @printf to i64), %struct.Memory* %loadMem2_412b7c)
...
block_.L_412b84:                                  ; preds = %block_412b69, %entry
  ...
  ret %struct.Memory* %loadMem_412b89
}
...
define %struct.Memory* @routine_cvttsd2si_0x20f544__rip____rax(%struct.State* dereferenceable(3376), i64, %struct.Memory*) {
block_400478:
  %3 = getelementptr inbounds %struct.State, %struct.State* %0, i32 0, i32 6
  %4 = getelementptr inbounds %struct.GPR, %struct.GPR* %3, i32 0, i32 33
  %5 = getelementptr inbounds %struct.Reg, %struct.Reg* %4, i32 0, i32 0
