...
entry:
  ...
  store %struct.Memory* %loadMem1_412b86, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem1_412b9c, %struct.Memory** %MEMORY
...
block_412ba9:                                     ; preds = %entry
  ...
  %302 = call %struct.Memory* @__remill_function_call(%struct.State* %0, i64 ptrtoint (i64 (i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64)* @printf to i64), %struct.Memory* %loadMem2_412bbc)
...
block_.L_412bc4:                                  ; preds = %block_412ba9, %entry
  ...
  ret %struct.Memory* %loadMem_412bc9
}
...
define %struct.Memory* @routine_cvttsd2si_0x20f504__rip____rax(%struct.State* dereferenceable(3376), i64, %struct.Memory*) {
block_400488:
  %3 = getelementptr inbounds %struct.State, %struct.State* %0, i32 0, i32 6
  %4 = getelementptr inbounds %struct.GPR, %struct.GPR* %3, i32 0, i32 33
  %5 = getelementptr inbounds %struct.Reg, %struct.Reg* %4, i32 0, i32 0
