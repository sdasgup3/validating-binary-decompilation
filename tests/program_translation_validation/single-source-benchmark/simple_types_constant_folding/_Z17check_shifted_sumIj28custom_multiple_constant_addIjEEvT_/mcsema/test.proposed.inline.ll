...
entry:
  ...
  store %struct.Memory* %loadMem_41277b, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem1_412786, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem1_41279c, %struct.Memory** %MEMORY
...
block_4127a9:                                     ; preds = %entry
  ...
  store %struct.Memory* %loadMem1_4127bc, %struct.Memory** %MEMORY
  %loadMem2_4127bc = load %struct.Memory*, %struct.Memory** %MEMORY
  %loadPC_4127bc = load i64, i64* %3
  %302 = call %struct.Memory* @__remill_function_call(%struct.State* %0, i64 ptrtoint (i64 (i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64)* @printf to i64), %struct.Memory* %loadMem2_4127bc)
...
block_.L_4127c4:                                  ; preds = %block_4127a9, %entry
  ...
  ret %struct.Memory* %loadMem_4127c9
}
...
define %struct.Memory* @routine_cvttsd2si_0x20f904__rip____rax(%struct.State* dereferenceable(3376), i64, %struct.Memory*) {
block_400488:
  %3 = getelementptr inbounds %struct.State, %struct.State* %0, i32 0, i32 6
  %4 = getelementptr inbounds %struct.GPR, %struct.GPR* %3, i32 0, i32 33
  %5 = getelementptr inbounds %struct.Reg, %struct.Reg* %4, i32 0, i32 0
