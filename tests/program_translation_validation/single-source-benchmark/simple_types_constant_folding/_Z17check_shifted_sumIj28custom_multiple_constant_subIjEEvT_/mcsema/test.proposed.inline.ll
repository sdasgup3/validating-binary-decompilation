...
@G_0x20fa44__rip__4269636_ = global %G_0x20fa44__rip__4269636__type zeroinitializer
...
entry:
  ...
  %92 = load double, double* bitcast (%G_0x20fa44__rip__4269636__type* @G_0x20fa44__rip__4269636_ to double*)
  ...
  store %struct.Memory* %loadMem1_41265c, %struct.Memory** %MEMORY
...
block_412669:                                     ; preds = %entry
  ...
  store %struct.Memory* %loadMem1_41267c, %struct.Memory** %MEMORY
  %loadMem2_41267c = load %struct.Memory*, %struct.Memory** %MEMORY
  %loadPC_41267c = load i64, i64* %3
  %300 = call %struct.Memory* @__remill_function_call(%struct.State* %0, i64 ptrtoint (i64 (i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64)* @printf to i64), %struct.Memory* %loadMem2_41267c)
...
block_.L_412684:                                  ; preds = %block_412669, %entry
  ...
  ret %struct.Memory* %loadMem_412689
}
...
define %struct.Memory* @routine_cvttsd2si_0x20fa44__rip____rax(%struct.State* dereferenceable(3376), i64, %struct.Memory*) {
block_400478:
  %3 = getelementptr inbounds %struct.State, %struct.State* %0, i32 0, i32 6
  %4 = getelementptr inbounds %struct.GPR, %struct.GPR* %3, i32 0, i32 33
  %5 = getelementptr inbounds %struct.Reg, %struct.Reg* %4, i32 0, i32 0
