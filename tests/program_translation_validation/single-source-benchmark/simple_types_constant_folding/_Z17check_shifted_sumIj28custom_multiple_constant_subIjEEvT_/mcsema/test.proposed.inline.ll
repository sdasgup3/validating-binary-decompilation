...
entry:
  ...
  store %struct.Memory* %loadMem1_412686, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem1_41269c, %struct.Memory** %MEMORY
...
block_4126a9:                                     ; preds = %entry
  ...
  store %struct.Memory* %loadMem1_4126bc, %struct.Memory** %MEMORY
  %loadMem2_4126bc = load %struct.Memory*, %struct.Memory** %MEMORY
  %loadPC_4126bc = load i64, i64* %3
  %302 = call %struct.Memory* @__remill_function_call(%struct.State* %0, i64 ptrtoint (i64 (i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64)* @printf to i64), %struct.Memory* %loadMem2_4126bc)
...
block_.L_4126c4:                                  ; preds = %block_4126a9, %entry
  ...
  store %struct.Memory* %loadMem_4126c9, %struct.Memory** %MEMORY
  ret %struct.Memory* %loadMem_4126c9
}
...
define %struct.Memory* @routine_cvttsd2si_0x20fa04__rip____rax(%struct.State* dereferenceable(3376), i64, %struct.Memory*) {
block_400488:
  %3 = getelementptr inbounds %struct.State, %struct.State* %0, i32 0, i32 6
  %4 = getelementptr inbounds %struct.GPR, %struct.GPR* %3, i32 0, i32 33
  %5 = getelementptr inbounds %struct.Reg, %struct.Reg* %4, i32 0, i32 0
