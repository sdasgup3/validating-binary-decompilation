...
block_412329:                                     ; preds = %entry
  ...
  %call2_41233c = call %struct.Memory* @sub_4006c0.printf_plt(%struct.State* %0, i64 %loadPC_41233c, %struct.Memory* %loadMem2_41233c)
  store %struct.Memory* %call2_41233c, %struct.Memory** %MEMORY
