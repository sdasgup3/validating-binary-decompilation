...
@G_0x20fcb4__rip__4269012_ = global %G_0x20fcb4__rip__4269012__type zeroinitializer
...
define %struct.Memory* @_Z17check_shifted_sumIj31custom_multiple_constant_divideIjEEvT_(%struct.State* noalias, i64, %struct.Memory* noalias) #2 {
entry:
  ...
  %92 = load double, double* bitcast (%G_0x20fcb4__rip__4269012__type* @G_0x20fcb4__rip__4269012_ to double*)
  ...
  store %struct.Memory* %loadMem_4123cb, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem1_4123d6, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_4123db, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem1_4123ec, %struct.Memory** %MEMORY
...
block_4123f9:                                     ; preds = %entry
  ...
  store %struct.Memory* %loadMem_41240a, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem1_41240c, %struct.Memory** %MEMORY
  %loadMem2_41240c = load %struct.Memory*, %struct.Memory** %MEMORY
  %loadPC_41240c = load i64, i64* %3
  %300 = call %struct.Memory* @__remill_function_call(%struct.State* %0, i64 ptrtoint (i64 (i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64)* @printf to i64), %struct.Memory* %loadMem2_41240c)
...
block_.L_412414:                                  ; preds = %block_4123f9, %entry
  ...
  store %struct.Memory* %loadMem_412418, %struct.Memory** %MEMORY
  ...
  ret %struct.Memory* %loadMem_412419
}
...
define %struct.Memory* @routine_cvttsd2si_0x20fcb4__rip____rax(%struct.State* dereferenceable(3376), i64, %struct.Memory*) {
block_400478:
  %3 = getelementptr inbounds %struct.State, %struct.State* %0, i32 0, i32 6
  %4 = getelementptr inbounds %struct.GPR, %struct.GPR* %3, i32 0, i32 33
  %5 = getelementptr inbounds %struct.Reg, %struct.Reg* %4, i32 0, i32 0
