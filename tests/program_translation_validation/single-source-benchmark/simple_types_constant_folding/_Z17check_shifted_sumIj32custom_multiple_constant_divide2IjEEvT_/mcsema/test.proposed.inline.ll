...
%G_0x20fd44__rip__4268868__type = type <{ [8 x i8] }>
...
@G_0x20fd44__rip__4268868_ = global %G_0x20fd44__rip__4268868__type zeroinitializer
...
entry:
  ...
  %loadMem_412330 = load %struct.Memory*, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_412330, %struct.Memory** %MEMORY
  ...
  %loadMem_412338 = load %struct.Memory*, %struct.Memory** %MEMORY
  ...
  store i32 %78, i32* %82
  store %struct.Memory* %loadMem_412338, %struct.Memory** %MEMORY
  %loadMem_41233b = load %struct.Memory*, %struct.Memory** %MEMORY
  ...
  %92 = load double, double* bitcast (%G_0x20fd44__rip__4268868__type* @G_0x20fd44__rip__4268868_ to double*)
  ...
  store %struct.Memory* %loadMem_41233b, %struct.Memory** %MEMORY
  %loadMem_412344 = load %struct.Memory*, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_412344, %struct.Memory** %MEMORY
  %loadMem1_412346 = load %struct.Memory*, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem1_412346, %struct.Memory** %MEMORY
  %loadMem2_412346 = load %struct.Memory*, %struct.Memory** %MEMORY
  %loadPC_412346 = load i64, i64* %3
  %call2_412346 = call %struct.Memory* @sub_412310._ZN32custom_multiple_constant_divide2IjE8do_shiftEj(%struct.State* %0, i64 %loadPC_412346, %struct.Memory* %loadMem2_412346)
  store %struct.Memory* %call2_412346, %struct.Memory** %MEMORY
  ...
  %loadMem_412353 = load %struct.Memory*, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_412353, %struct.Memory** %MEMORY
  ...
  %loadMem1_41235c = load %struct.Memory*, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem1_41235c, %struct.Memory** %MEMORY
  %loadMem2_41235c = load %struct.Memory*, %struct.Memory** %MEMORY
  %loadPC_41235c = load i64, i64* %3
  %call2_41235c = call %struct.Memory* @sub_411fe0._Z15tolerance_equalIjEbRT_S1_(%struct.State* %0, i64 %loadPC_41235c, %struct.Memory* %loadMem2_41235c)
  store %struct.Memory* %call2_41235c, %struct.Memory** %MEMORY
  %loadMem_412361 = load %struct.Memory*, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_412361, %struct.Memory** %MEMORY
  %loadMem_412363 = load %struct.Memory*, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_412363, %struct.Memory** %MEMORY
  %loadBr_412363 = load i8, i8* %BRANCH_TAKEN
  %cmpBr_412363 = icmp eq i8 %loadBr_412363, 1
  br i1 %cmpBr_412363, label %block_.L_412384, label %block_412369

block_412369:                                     ; preds = %entry
  ...
  %loadMem_412373 = load %struct.Memory*, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_412373, %struct.Memory** %MEMORY
  %loadMem_41237a = load %struct.Memory*, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_41237a, %struct.Memory** %MEMORY
  %loadMem1_41237c = load %struct.Memory*, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem1_41237c, %struct.Memory** %MEMORY
  %loadMem2_41237c = load %struct.Memory*, %struct.Memory** %MEMORY
  %loadPC_41237c = load i64, i64* %3
  %300 = call %struct.Memory* @__remill_function_call(%struct.State* %0, i64 ptrtoint (i64 (i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64)* @printf to i64), %struct.Memory* %loadMem2_41237c)
  ...
  br label %block_.L_412384

block_.L_412384:                                  ; preds = %block_412369, %entry
  ...
  %loadMem_412389 = load %struct.Memory*, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_412389, %struct.Memory** %MEMORY
  ret %struct.Memory* %loadMem_412389
}
...
define %struct.Memory* @routine_cvttsd2si_0x20fd44__rip____rax(%struct.State* dereferenceable(3376), i64, %struct.Memory*) {
block_400478:
  %3 = getelementptr inbounds %struct.State, %struct.State* %0, i32 0, i32 6
  %4 = getelementptr inbounds %struct.GPR, %struct.GPR* %3, i32 0, i32 33
  %5 = getelementptr inbounds %struct.Reg, %struct.Reg* %4, i32 0, i32 0
  ...
  %9 = load i64, i64* %PC
  %10 = ptrtoint %G_0x20fd44__rip__4268868__type* @G_0x20fd44__rip__4268868_ to i64
  %11 = load i64, i64* %PC
  %12 = add i64 %11, 9
  store i64 %12, i64* %PC
...
define %struct.Memory* @routine_jne_.L_412384(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i8* %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) {
block_400478:
  %3 = getelementptr inbounds %struct.State, %struct.State* %0, i32 0, i32 6
  %4 = getelementptr inbounds %struct.GPR, %struct.GPR* %3, i32 0, i32 33
  %5 = getelementptr inbounds %struct.Reg, %struct.Reg* %4, i32 0, i32 0
