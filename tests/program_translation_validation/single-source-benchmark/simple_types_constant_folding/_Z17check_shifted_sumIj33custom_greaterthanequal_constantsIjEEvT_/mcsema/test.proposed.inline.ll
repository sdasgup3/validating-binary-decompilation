...
%G_0x20f694__rip__4270580__type = type <{ [8 x i8] }>
...
@G_0x20f694__rip__4270580_ = global %G_0x20f694__rip__4270580__type zeroinitializer
...
declare %struct.Memory* @sub_4129d0._ZN33custom_greaterthanequal_constantsIjE8do_shiftEj(%struct.State* noalias dereferenceable(3376), i64, %struct.Memory* noalias readnone returned)
...
entry:
  ...
  %92 = load double, double* bitcast (%G_0x20f694__rip__4270580__type* @G_0x20f694__rip__4270580_ to double*)
  ...
  %loadMem1_4129f6 = load %struct.Memory*, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem1_4129f6, %struct.Memory** %MEMORY
  %loadMem2_4129f6 = load %struct.Memory*, %struct.Memory** %MEMORY
  %loadPC_4129f6 = load i64, i64* %3
  %call2_4129f6 = call %struct.Memory* @sub_4129d0._ZN33custom_greaterthanequal_constantsIjE8do_shiftEj(%struct.State* %0, i64 %loadPC_4129f6, %struct.Memory* %loadMem2_4129f6)
  store %struct.Memory* %call2_4129f6, %struct.Memory** %MEMORY
  ...
  %call2_412a0c = call %struct.Memory* @sub_411fe0._Z15tolerance_equalIjEbRT_S1_(%struct.State* %0, i64 %loadPC_412a0c, %struct.Memory* %loadMem2_412a0c)
  ...
  br i1 %cmpBr_412a13, label %block_.L_412a34, label %block_412a19

block_412a19:                                     ; preds = %entry
  ...
  %loadMem1_412a2c = load %struct.Memory*, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem1_412a2c, %struct.Memory** %MEMORY
  %loadMem2_412a2c = load %struct.Memory*, %struct.Memory** %MEMORY
  %loadPC_412a2c = load i64, i64* %3
  %300 = call %struct.Memory* @__remill_function_call(%struct.State* %0, i64 ptrtoint (i64 (i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64)* @printf to i64), %struct.Memory* %loadMem2_412a2c)
  ...
  br label %block_.L_412a34

block_.L_412a34:                                  ; preds = %block_412a19, %entry
  ...
  %loadMem_412a39 = load %struct.Memory*, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_412a39, %struct.Memory** %MEMORY
  ret %struct.Memory* %loadMem_412a39
}
...
define %struct.Memory* @routine_cvttsd2si_0x20f694__rip____rax(%struct.State* dereferenceable(3376), i64, %struct.Memory*) {
block_400478:
  %3 = getelementptr inbounds %struct.State, %struct.State* %0, i32 0, i32 6
  %4 = getelementptr inbounds %struct.GPR, %struct.GPR* %3, i32 0, i32 33
  %5 = getelementptr inbounds %struct.Reg, %struct.Reg* %4, i32 0, i32 0
  ...
  %9 = load i64, i64* %PC
  %10 = ptrtoint %G_0x20f694__rip__4270580__type* @G_0x20f694__rip__4270580_ to i64
  %11 = load i64, i64* %PC
  %12 = add i64 %11, 9
  store i64 %12, i64* %PC
...
define %struct.Memory* @routine_jne_.L_412a34(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i8* %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) {
block_400478:
  %3 = getelementptr inbounds %struct.State, %struct.State* %0, i32 0, i32 6
  %4 = getelementptr inbounds %struct.GPR, %struct.GPR* %3, i32 0, i32 33
  %5 = getelementptr inbounds %struct.Reg, %struct.Reg* %4, i32 0, i32 0
