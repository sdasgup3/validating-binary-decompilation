...
entry:
  ...
  store %struct.Memory* %loadMem_412581, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_412584, %struct.Memory** %MEMORY
  ...
  store i32 %78, i32* %82
  store %struct.Memory* %loadMem_412588, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_41258b, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem1_412596, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_4125a3, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem1_4125ac, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_4125b1, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_4125b3, %struct.Memory** %MEMORY
...
block_4125b9:                                     ; preds = %entry
  ...
  store %struct.Memory* %loadMem_4125ca, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem1_4125cc, %struct.Memory** %MEMORY
  %loadMem2_4125cc = load %struct.Memory*, %struct.Memory** %MEMORY
  %loadPC_4125cc = load i64, i64* %3
  %302 = call %struct.Memory* @__remill_function_call(%struct.State* %0, i64 ptrtoint (i64 (i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64)* @printf to i64), %struct.Memory* %loadMem2_4125cc)
  ...
  store %struct.Memory* %loadMem_4125d1, %struct.Memory** %MEMORY
  br label %block_.L_4125d4

block_.L_4125d4:                                  ; preds = %block_4125b9, %entry
  ...
  store %struct.Memory* %loadMem_4125d4, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_4125d8, %struct.Memory** %MEMORY
  ...
  ret %struct.Memory* %loadMem_4125d9
}
...
define %struct.Memory* @routine_cvttsd2si_0x20faf4__rip____rax(%struct.State* dereferenceable(3376), i64, %struct.Memory*) {
block_400488:
  %3 = getelementptr inbounds %struct.State, %struct.State* %0, i32 0, i32 6
  %4 = getelementptr inbounds %struct.GPR, %struct.GPR* %3, i32 0, i32 33
  %5 = getelementptr inbounds %struct.Reg, %struct.Reg* %4, i32 0, i32 0
