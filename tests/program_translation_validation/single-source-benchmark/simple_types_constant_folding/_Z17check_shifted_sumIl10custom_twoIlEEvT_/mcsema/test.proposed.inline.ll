...
entry:
  ...
  store %struct.Memory* %loadMem1_411f66, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_411f6b, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem1_411f7e, %struct.Memory** %MEMORY
...
block_411f8b:                                     ; preds = %entry
  ...
  store %struct.Memory* %loadMem1_411f9e, %struct.Memory** %MEMORY
  %loadMem2_411f9e = load %struct.Memory*, %struct.Memory** %MEMORY
  %loadPC_411f9e = load i64, i64* %3
  %280 = call %struct.Memory* @__remill_function_call(%struct.State* %0, i64 ptrtoint (i64 (i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64)* @printf to i64), %struct.Memory* %loadMem2_411f9e)
...
block_.L_411fa6:                                  ; preds = %block_411f8b, %entry
  ...
  ret %struct.Memory* %loadMem_411fab
}
