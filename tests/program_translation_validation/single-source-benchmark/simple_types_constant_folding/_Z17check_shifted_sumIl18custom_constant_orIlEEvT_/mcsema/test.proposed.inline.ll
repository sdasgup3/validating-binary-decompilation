...
entry:
  ...
  store %struct.Memory* %loadMem1_4111b6, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_4111ca, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem1_4111ce, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_4111d5, %struct.Memory** %MEMORY
...
block_4111db:                                     ; preds = %entry
  ...
  store %struct.Memory* %loadMem1_4111ee, %struct.Memory** %MEMORY
  %loadMem2_4111ee = load %struct.Memory*, %struct.Memory** %MEMORY
  %loadPC_4111ee = load i64, i64* %3
  %280 = call %struct.Memory* @__remill_function_call(%struct.State* %0, i64 ptrtoint (i64 (i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64)* @printf to i64), %struct.Memory* %loadMem2_4111ee)
  ...
  store %struct.Memory* %loadMem_4111f3, %struct.Memory** %MEMORY
  br label %block_.L_4111f6

block_.L_4111f6:                                  ; preds = %block_4111db, %entry
  ...
  ret %struct.Memory* %loadMem_4111fb
}
