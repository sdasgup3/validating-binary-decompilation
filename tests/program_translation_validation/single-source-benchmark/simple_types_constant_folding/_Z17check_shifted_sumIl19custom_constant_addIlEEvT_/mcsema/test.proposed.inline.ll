...
entry:
  ...
  store %struct.Memory* %loadMem1_411886, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem1_41189e, %struct.Memory** %MEMORY
...
block_4118ab:                                     ; preds = %entry
  ...
  store %struct.Memory* %loadMem1_4118be, %struct.Memory** %MEMORY
  %loadMem2_4118be = load %struct.Memory*, %struct.Memory** %MEMORY
  %loadPC_4118be = load i64, i64* %3
  %280 = call %struct.Memory* @__remill_function_call(%struct.State* %0, i64 ptrtoint (i64 (i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64)* @printf to i64), %struct.Memory* %loadMem2_4118be)
...
block_.L_4118c6:                                  ; preds = %block_4118ab, %entry
  ...
  ret %struct.Memory* %loadMem_4118cb
}
