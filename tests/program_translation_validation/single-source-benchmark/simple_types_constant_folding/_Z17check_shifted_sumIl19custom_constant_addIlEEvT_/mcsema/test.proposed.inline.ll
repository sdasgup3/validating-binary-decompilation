...
define %struct.Memory* @_Z17check_shifted_sumIl19custom_constant_addIlEEvT_(%struct.State* noalias, i64, %struct.Memory* noalias) #2 {
entry:
  ...
  store %struct.Memory* %loadMem_4118b0, %struct.Memory** %MEMORY
  ...
  store i64 %78, i64* %81
  store %struct.Memory* %loadMem_4118b8, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem1_4118c6, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_4118cb, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem1_4118de, %struct.Memory** %MEMORY
...
block_4118eb:                                     ; preds = %entry
  ...
  store %struct.Memory* %loadMem1_4118fe, %struct.Memory** %MEMORY
  %loadMem2_4118fe = load %struct.Memory*, %struct.Memory** %MEMORY
  %loadPC_4118fe = load i64, i64* %3
  %280 = call %struct.Memory* @__remill_function_call(%struct.State* %0, i64 ptrtoint (i64 (i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64)* @printf to i64), %struct.Memory* %loadMem2_4118fe)
  ...
  store %struct.Memory* %loadMem_411903, %struct.Memory** %MEMORY
  br label %block_.L_411906

block_.L_411906:                                  ; preds = %block_4118eb, %entry
  ...
  ret %struct.Memory* %loadMem_41190b
}
