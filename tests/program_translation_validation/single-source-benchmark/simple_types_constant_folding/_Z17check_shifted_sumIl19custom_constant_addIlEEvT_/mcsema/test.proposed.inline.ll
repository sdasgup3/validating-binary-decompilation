...
entry:
  ...
  store %struct.Memory* %loadMem1_4118d6, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_4118db, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem1_4118ee, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_4118f3, %struct.Memory** %MEMORY
...
block_4118fb:                                     ; preds = %entry
  ...
  store %struct.Memory* %loadMem_41190c, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem1_41190e, %struct.Memory** %MEMORY
  %loadMem2_41190e = load %struct.Memory*, %struct.Memory** %MEMORY
  %loadPC_41190e = load i64, i64* %3
  %280 = call %struct.Memory* @__remill_function_call(%struct.State* %0, i64 ptrtoint (i64 (i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64)* @printf to i64), %struct.Memory* %loadMem2_41190e)
  ...
  store %struct.Memory* %loadMem_411913, %struct.Memory** %MEMORY
  br label %block_.L_411916

block_.L_411916:                                  ; preds = %block_4118fb, %entry
  ...
  store %struct.Memory* %loadMem_411916, %struct.Memory** %MEMORY
  ...
  ret %struct.Memory* %loadMem_41191b
}
