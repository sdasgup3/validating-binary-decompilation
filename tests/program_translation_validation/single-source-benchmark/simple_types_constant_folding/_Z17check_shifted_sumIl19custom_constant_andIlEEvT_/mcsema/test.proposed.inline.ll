...
entry:
  ...
  store i64 %78, i64* %81
  store %struct.Memory* %loadMem_4112b8, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem1_4112c6, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem1_4112de, %struct.Memory** %MEMORY
...
block_4112eb:                                     ; preds = %entry
  ...
  store %struct.Memory* %loadMem1_4112fe, %struct.Memory** %MEMORY
  %loadMem2_4112fe = load %struct.Memory*, %struct.Memory** %MEMORY
  %loadPC_4112fe = load i64, i64* %3
  %280 = call %struct.Memory* @__remill_function_call(%struct.State* %0, i64 ptrtoint (i64 (i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64)* @printf to i64), %struct.Memory* %loadMem2_4112fe)
...
block_.L_411306:                                  ; preds = %block_4112eb, %entry
  ...
  ret %struct.Memory* %loadMem_41130b
}
