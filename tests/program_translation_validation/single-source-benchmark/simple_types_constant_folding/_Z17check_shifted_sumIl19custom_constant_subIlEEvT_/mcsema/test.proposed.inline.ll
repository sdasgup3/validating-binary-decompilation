...
declare %struct.Memory* @sub_411740._ZN19custom_constant_subIlE8do_shiftEl(%struct.State* noalias dereferenceable(3376), i64, %struct.Memory* noalias readnone returned)
...
entry:
  ...
  store %struct.Memory* %loadMem_411760, %struct.Memory** %MEMORY
  ...
  %loadMem_411764 = load %struct.Memory*, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_411764, %struct.Memory** %MEMORY
  ...
  %loadMem1_411776 = load %struct.Memory*, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem1_411776, %struct.Memory** %MEMORY
  %loadMem2_411776 = load %struct.Memory*, %struct.Memory** %MEMORY
  %loadPC_411776 = load i64, i64* %3
  %call2_411776 = call %struct.Memory* @sub_411740._ZN19custom_constant_subIlE8do_shiftEl(%struct.State* %0, i64 %loadPC_411776, %struct.Memory* %loadMem2_411776)
  store %struct.Memory* %call2_411776, %struct.Memory** %MEMORY
  %loadMem_41177b = load %struct.Memory*, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_41177b, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_41177f, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_41178a, %struct.Memory** %MEMORY
  %loadMem1_41178e = load %struct.Memory*, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem1_41178e, %struct.Memory** %MEMORY
  %loadMem2_41178e = load %struct.Memory*, %struct.Memory** %MEMORY
  %loadPC_41178e = load i64, i64* %3
  %call2_41178e = call %struct.Memory* @sub_411040._Z15tolerance_equalIlEbRT_S1_(%struct.State* %0, i64 %loadPC_41178e, %struct.Memory* %loadMem2_41178e)
  store %struct.Memory* %call2_41178e, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_411793, %struct.Memory** %MEMORY
  %loadMem_411795 = load %struct.Memory*, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_411795, %struct.Memory** %MEMORY
  %loadBr_411795 = load i8, i8* %BRANCH_TAKEN
  %cmpBr_411795 = icmp eq i8 %loadBr_411795, 1
  br i1 %cmpBr_411795, label %block_.L_4117b6, label %block_41179b

block_41179b:                                     ; preds = %entry
  ...
  %loadMem_4117a5 = load %struct.Memory*, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_4117a5, %struct.Memory** %MEMORY
  ...
  %loadMem1_4117ae = load %struct.Memory*, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem1_4117ae, %struct.Memory** %MEMORY
  %loadMem2_4117ae = load %struct.Memory*, %struct.Memory** %MEMORY
  %loadPC_4117ae = load i64, i64* %3
  %280 = call %struct.Memory* @__remill_function_call(%struct.State* %0, i64 ptrtoint (i64 (i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64)* @printf to i64), %struct.Memory* %loadMem2_4117ae)
  ...
  br label %block_.L_4117b6

block_.L_4117b6:                                  ; preds = %block_41179b, %entry
  ...
  store %struct.Memory* %loadMem_4117b6, %struct.Memory** %MEMORY
  ...
  ret %struct.Memory* %loadMem_4117bb
}
