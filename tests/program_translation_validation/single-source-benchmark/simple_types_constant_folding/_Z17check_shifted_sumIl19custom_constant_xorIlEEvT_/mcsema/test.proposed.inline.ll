...
define %struct.Memory* @_Z17check_shifted_sumIl19custom_constant_xorIlEEvT_(%struct.State* noalias, i64, %struct.Memory* noalias) #2 {
entry:
  ...
  store %struct.Memory* %loadMem1_4110a6, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_4110b3, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem1_4110be, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_4110c3, %struct.Memory** %MEMORY
...
block_4110cb:                                     ; preds = %entry
  ...
  store %struct.Memory* %loadMem_4110cb, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem1_4110de, %struct.Memory** %MEMORY
  %loadMem2_4110de = load %struct.Memory*, %struct.Memory** %MEMORY
  %loadPC_4110de = load i64, i64* %3
  %280 = call %struct.Memory* @__remill_function_call(%struct.State* %0, i64 ptrtoint (i64 (i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64)* @printf to i64), %struct.Memory* %loadMem2_4110de)
...
block_.L_4110e6:                                  ; preds = %block_4110cb, %entry
  ...
  store %struct.Memory* %loadMem_4110eb, %struct.Memory** %MEMORY
  ret %struct.Memory* %loadMem_4110eb
}
