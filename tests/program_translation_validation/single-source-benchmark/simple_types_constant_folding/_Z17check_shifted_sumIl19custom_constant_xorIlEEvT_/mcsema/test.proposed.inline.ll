...
entry:
  ...
  store %struct.Memory* %loadMem1_4110e6, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_4110ef, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_4110f3, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem1_4110fe, %struct.Memory** %MEMORY
...
block_41110b:                                     ; preds = %entry
  ...
  store %struct.Memory* %loadMem1_41111e, %struct.Memory** %MEMORY
  %loadMem2_41111e = load %struct.Memory*, %struct.Memory** %MEMORY
  %loadPC_41111e = load i64, i64* %3
  %280 = call %struct.Memory* @__remill_function_call(%struct.State* %0, i64 ptrtoint (i64 (i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64)* @printf to i64), %struct.Memory* %loadMem2_41111e)
...
block_.L_411126:                                  ; preds = %block_41110b, %entry
  ...
  store %struct.Memory* %loadMem_41112b, %struct.Memory** %MEMORY
  ret %struct.Memory* %loadMem_41112b
}
