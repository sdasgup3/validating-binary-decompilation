...
entry:
  ...
  store i64 %78, i64* %81
  store %struct.Memory* %loadMem_4119a8, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem1_4119b6, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_4119bb, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem1_4119ce, %struct.Memory** %MEMORY
...
block_4119db:                                     ; preds = %entry
  ...
  %280 = call %struct.Memory* @__remill_function_call(%struct.State* %0, i64 ptrtoint (i64 (i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64)* @printf to i64), %struct.Memory* %loadMem2_4119ee)
...
block_.L_4119f6:                                  ; preds = %block_4119db, %entry
  ...
  store %struct.Memory* %loadMem_4119f6, %struct.Memory** %MEMORY
  ...
  ret %struct.Memory* %loadMem_4119fb
}
