...
entry:
  ...
  %loadMem_411ed8 = load %struct.Memory*, %struct.Memory** %MEMORY
  ...
  store i64 %78, i64* %81
  store %struct.Memory* %loadMem_411ed8, %struct.Memory** %MEMORY
  %loadMem_411edc = load %struct.Memory*, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_411edc, %struct.Memory** %MEMORY
  %loadMem1_411ee6 = load %struct.Memory*, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem1_411ee6, %struct.Memory** %MEMORY
  %loadMem2_411ee6 = load %struct.Memory*, %struct.Memory** %MEMORY
  %loadPC_411ee6 = load i64, i64* %3
  %call2_411ee6 = call %struct.Memory* @sub_411ec0._ZN20custom_add_constantsIlE8do_shiftEl(%struct.State* %0, i64 %loadPC_411ee6, %struct.Memory* %loadMem2_411ee6)
  store %struct.Memory* %call2_411ee6, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_411ef3, %struct.Memory** %MEMORY
  ...
  %loadMem1_411efe = load %struct.Memory*, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem1_411efe, %struct.Memory** %MEMORY
  %loadMem2_411efe = load %struct.Memory*, %struct.Memory** %MEMORY
  %loadPC_411efe = load i64, i64* %3
  %call2_411efe = call %struct.Memory* @sub_411080._Z15tolerance_equalIlEbRT_S1_(%struct.State* %0, i64 %loadPC_411efe, %struct.Memory* %loadMem2_411efe)
  store %struct.Memory* %call2_411efe, %struct.Memory** %MEMORY
  ...
  %loadBr_411f05 = load i8, i8* %BRANCH_TAKEN
  %cmpBr_411f05 = icmp eq i8 %loadBr_411f05, 1
  br i1 %cmpBr_411f05, label %block_.L_411f26, label %block_411f0b

block_411f0b:                                     ; preds = %entry
  %loadMem_411f0b = load %struct.Memory*, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_411f0b, %struct.Memory** %MEMORY
  ...
  %loadMem_411f1c = load %struct.Memory*, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_411f1c, %struct.Memory** %MEMORY
  %loadMem1_411f1e = load %struct.Memory*, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem1_411f1e, %struct.Memory** %MEMORY
  %loadMem2_411f1e = load %struct.Memory*, %struct.Memory** %MEMORY
  %loadPC_411f1e = load i64, i64* %3
  %280 = call %struct.Memory* @__remill_function_call(%struct.State* %0, i64 ptrtoint (i64 (i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64)* @printf to i64), %struct.Memory* %loadMem2_411f1e)
  store %struct.Memory* %280, %struct.Memory** %MEMORY
  %loadMem_411f23 = load %struct.Memory*, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_411f23, %struct.Memory** %MEMORY
...
block_.L_411f26:                                  ; preds = %block_411f0b, %entry
  ...
  ret %struct.Memory* %loadMem_411f2b
}
...
define %struct.Memory* @routine_jne_.L_411f26(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i8* %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) {
block_400488:
  %3 = getelementptr inbounds %struct.State, %struct.State* %0, i32 0, i32 6
  %4 = getelementptr inbounds %struct.GPR, %struct.GPR* %3, i32 0, i32 33
  %5 = getelementptr inbounds %struct.Reg, %struct.Reg* %4, i32 0, i32 0
