...
define %struct.Memory* @_Z17check_shifted_sumIl20custom_add_constantsIlEEvT_(%struct.State* noalias, i64, %struct.Memory* noalias) #2 {
entry:
  ...
  %loadMem_411ee0 = load %struct.Memory*, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_411ee0, %struct.Memory** %MEMORY
  ...
  %loadMem_411ee4 = load %struct.Memory*, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_411ee4, %struct.Memory** %MEMORY
  %loadMem_411ee8 = load %struct.Memory*, %struct.Memory** %MEMORY
  ...
  store i64 %78, i64* %81
  store %struct.Memory* %loadMem_411ee8, %struct.Memory** %MEMORY
  %loadMem_411eec = load %struct.Memory*, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_411eec, %struct.Memory** %MEMORY
  %loadMem1_411ef6 = load %struct.Memory*, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem1_411ef6, %struct.Memory** %MEMORY
  %loadMem2_411ef6 = load %struct.Memory*, %struct.Memory** %MEMORY
  %loadPC_411ef6 = load i64, i64* %3
  %call2_411ef6 = call %struct.Memory* @sub_411ed0._ZN20custom_add_constantsIlE8do_shiftEl(%struct.State* %0, i64 %loadPC_411ef6, %struct.Memory* %loadMem2_411ef6)
  store %struct.Memory* %call2_411ef6, %struct.Memory** %MEMORY
  %loadMem_411efb = load %struct.Memory*, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_411efb, %struct.Memory** %MEMORY
  ...
  %loadMem_411f03 = load %struct.Memory*, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_411f03, %struct.Memory** %MEMORY
  ...
  %loadMem1_411f0e = load %struct.Memory*, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem1_411f0e, %struct.Memory** %MEMORY
  %loadMem2_411f0e = load %struct.Memory*, %struct.Memory** %MEMORY
  %loadPC_411f0e = load i64, i64* %3
  %call2_411f0e = call %struct.Memory* @sub_411090._Z15tolerance_equalIlEbRT_S1_(%struct.State* %0, i64 %loadPC_411f0e, %struct.Memory* %loadMem2_411f0e)
  store %struct.Memory* %call2_411f0e, %struct.Memory** %MEMORY
  ...
  %loadMem_411f15 = load %struct.Memory*, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_411f15, %struct.Memory** %MEMORY
  %loadBr_411f15 = load i8, i8* %BRANCH_TAKEN
  %cmpBr_411f15 = icmp eq i8 %loadBr_411f15, 1
  br i1 %cmpBr_411f15, label %block_.L_411f36, label %block_411f1b
...
block_411f1b:                                     ; preds = %entry
  ...
  %loadMem_411f2c = load %struct.Memory*, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_411f2c, %struct.Memory** %MEMORY
  %loadMem1_411f2e = load %struct.Memory*, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem1_411f2e, %struct.Memory** %MEMORY
  %loadMem2_411f2e = load %struct.Memory*, %struct.Memory** %MEMORY
  %loadPC_411f2e = load i64, i64* %3
  %280 = call %struct.Memory* @__remill_function_call(%struct.State* %0, i64 ptrtoint (i64 (i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64)* @printf to i64), %struct.Memory* %loadMem2_411f2e)
...
block_.L_411f36:                                  ; preds = %block_411f1b, %entry
  ...
  store %struct.Memory* %loadMem_411f3b, %struct.Memory** %MEMORY
  ret %struct.Memory* %loadMem_411f3b
}
...
define %struct.Memory* @routine_jne_.L_411f36(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i8* %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) {
block_400488:
  %3 = getelementptr inbounds %struct.State, %struct.State* %0, i32 0, i32 6
  %4 = getelementptr inbounds %struct.GPR, %struct.GPR* %3, i32 0, i32 33
  %5 = getelementptr inbounds %struct.Reg, %struct.Reg* %4, i32 0, i32 0
