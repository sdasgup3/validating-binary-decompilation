...
entry:
  ...
  store %struct.Memory* %loadMem_411e90, %struct.Memory** %MEMORY
  ...
  %loadMem1_411ea6 = load %struct.Memory*, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem1_411ea6, %struct.Memory** %MEMORY
  %loadMem2_411ea6 = load %struct.Memory*, %struct.Memory** %MEMORY
  %loadPC_411ea6 = load i64, i64* %3
  %call2_411ea6 = call %struct.Memory* @sub_411e80._ZN20custom_add_constantsIlE8do_shiftEl(%struct.State* %0, i64 %loadPC_411ea6, %struct.Memory* %loadMem2_411ea6)
  store %struct.Memory* %call2_411ea6, %struct.Memory** %MEMORY
  ...
  %loadMem1_411ebe = load %struct.Memory*, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem1_411ebe, %struct.Memory** %MEMORY
  %loadMem2_411ebe = load %struct.Memory*, %struct.Memory** %MEMORY
  %loadPC_411ebe = load i64, i64* %3
  %call2_411ebe = call %struct.Memory* @sub_411040._Z15tolerance_equalIlEbRT_S1_(%struct.State* %0, i64 %loadPC_411ebe, %struct.Memory* %loadMem2_411ebe)
  store %struct.Memory* %call2_411ebe, %struct.Memory** %MEMORY
  %loadMem_411ec3 = load %struct.Memory*, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_411ec3, %struct.Memory** %MEMORY
  ...
  %loadBr_411ec5 = load i8, i8* %BRANCH_TAKEN
  %cmpBr_411ec5 = icmp eq i8 %loadBr_411ec5, 1
  br i1 %cmpBr_411ec5, label %block_.L_411ee6, label %block_411ecb
...
block_411ecb:                                     ; preds = %entry
  ...
  %loadMem1_411ede = load %struct.Memory*, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem1_411ede, %struct.Memory** %MEMORY
  %loadMem2_411ede = load %struct.Memory*, %struct.Memory** %MEMORY
  %loadPC_411ede = load i64, i64* %3
  %280 = call %struct.Memory* @__remill_function_call(%struct.State* %0, i64 ptrtoint (i64 (i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64)* @printf to i64), %struct.Memory* %loadMem2_411ede)
  store %struct.Memory* %280, %struct.Memory** %MEMORY
  %loadMem_411ee3 = load %struct.Memory*, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_411ee3, %struct.Memory** %MEMORY
...
block_.L_411ee6:                                  ; preds = %block_411ecb, %entry
  ...
  store %struct.Memory* %loadMem_411eea, %struct.Memory** %MEMORY
  ...
  ret %struct.Memory* %loadMem_411eeb
}
...
define %struct.Memory* @routine_jne_.L_411ee6(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i8* %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) {
block_400478:
  %3 = getelementptr inbounds %struct.State, %struct.State* %0, i32 0, i32 6
  %4 = getelementptr inbounds %struct.GPR, %struct.GPR* %3, i32 0, i32 33
  %5 = getelementptr inbounds %struct.Reg, %struct.Reg* %4, i32 0, i32 0
