...
define %struct.Memory* @_Z17check_shifted_sumIl20custom_and_constantsIlEEvT_(%struct.State* noalias, i64, %struct.Memory* noalias) #2 {
entry:
  ...
  store %struct.Memory* %loadMem_4119c1, %struct.Memory** %MEMORY
  ...
  store i64 %78, i64* %81
  store %struct.Memory* %loadMem_4119c8, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_4119cc, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem1_4119d6, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_4119e3, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_4119ea, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem1_4119ee, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_4119f3, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_4119f5, %struct.Memory** %MEMORY
...
block_4119fb:                                     ; preds = %entry
  ...
  store %struct.Memory* %loadMem_4119fb, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_411a0c, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem1_411a0e, %struct.Memory** %MEMORY
  %loadMem2_411a0e = load %struct.Memory*, %struct.Memory** %MEMORY
  %loadPC_411a0e = load i64, i64* %3
  %280 = call %struct.Memory* @__remill_function_call(%struct.State* %0, i64 ptrtoint (i64 (i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64)* @printf to i64), %struct.Memory* %loadMem2_411a0e)
  ...
  store %struct.Memory* %loadMem_411a13, %struct.Memory** %MEMORY
  br label %block_.L_411a16

block_.L_411a16:                                  ; preds = %block_4119fb, %entry
  ...
  store %struct.Memory* %loadMem_411a16, %struct.Memory** %MEMORY
  ...
  ret %struct.Memory* %loadMem_411a1b
}
