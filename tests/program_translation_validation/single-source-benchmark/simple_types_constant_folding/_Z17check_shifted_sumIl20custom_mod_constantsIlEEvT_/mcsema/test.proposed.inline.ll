...
declare %struct.Memory* @sub_411cc0._ZN20custom_mod_constantsIlE8do_shiftEl(%struct.State* noalias dereferenceable(3376), i64, %struct.Memory* noalias readnone returned)
...
entry:
  ...
  %loadMem_411cd0 = load %struct.Memory*, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_411cd0, %struct.Memory** %MEMORY
  ...
  store i64 %78, i64* %81
  store %struct.Memory* %loadMem_411cd8, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_411cdc, %struct.Memory** %MEMORY
  %loadMem1_411ce6 = load %struct.Memory*, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem1_411ce6, %struct.Memory** %MEMORY
  %loadMem2_411ce6 = load %struct.Memory*, %struct.Memory** %MEMORY
  %loadPC_411ce6 = load i64, i64* %3
  %call2_411ce6 = call %struct.Memory* @sub_411cc0._ZN20custom_mod_constantsIlE8do_shiftEl(%struct.State* %0, i64 %loadPC_411ce6, %struct.Memory* %loadMem2_411ce6)
  store %struct.Memory* %call2_411ce6, %struct.Memory** %MEMORY
  ...
  %loadMem_411cef = load %struct.Memory*, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_411cef, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_411cf3, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem1_411cfe, %struct.Memory** %MEMORY
  %loadMem2_411cfe = load %struct.Memory*, %struct.Memory** %MEMORY
  %loadPC_411cfe = load i64, i64* %3
  %call2_411cfe = call %struct.Memory* @sub_411040._Z15tolerance_equalIlEbRT_S1_(%struct.State* %0, i64 %loadPC_411cfe, %struct.Memory* %loadMem2_411cfe)
  ...
  store %struct.Memory* %loadMem_411d03, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_411d05, %struct.Memory** %MEMORY
  %loadBr_411d05 = load i8, i8* %BRANCH_TAKEN
  %cmpBr_411d05 = icmp eq i8 %loadBr_411d05, 1
  br i1 %cmpBr_411d05, label %block_.L_411d26, label %block_411d0b

block_411d0b:                                     ; preds = %entry
  ...
  store %struct.Memory* %loadMem_411d0b, %struct.Memory** %MEMORY
  ...
  %loadMem1_411d1e = load %struct.Memory*, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem1_411d1e, %struct.Memory** %MEMORY
  %loadMem2_411d1e = load %struct.Memory*, %struct.Memory** %MEMORY
  %loadPC_411d1e = load i64, i64* %3
  %280 = call %struct.Memory* @__remill_function_call(%struct.State* %0, i64 ptrtoint (i64 (i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64)* @printf to i64), %struct.Memory* %loadMem2_411d1e)
  ...
  br label %block_.L_411d26

block_.L_411d26:                                  ; preds = %block_411d0b, %entry
  %loadMem_411d26 = load %struct.Memory*, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_411d26, %struct.Memory** %MEMORY
  ...
  ret %struct.Memory* %loadMem_411d2b
}
...
define %struct.Memory* @routine_jne_.L_411d26(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i8* %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) {
block_400478:
  %3 = getelementptr inbounds %struct.State, %struct.State* %0, i32 0, i32 6
  %4 = getelementptr inbounds %struct.GPR, %struct.GPR* %3, i32 0, i32 33
  %5 = getelementptr inbounds %struct.Reg, %struct.Reg* %4, i32 0, i32 0
