...
block_411d4b:                                     ; preds = %entry
  ...
  %call2_411d5e = call %struct.Memory* @sub_4006c0.printf_plt(%struct.State* %0, i64 %loadPC_411d5e, %struct.Memory* %loadMem2_411d5e)
  store %struct.Memory* %call2_411d5e, %struct.Memory** %MEMORY
