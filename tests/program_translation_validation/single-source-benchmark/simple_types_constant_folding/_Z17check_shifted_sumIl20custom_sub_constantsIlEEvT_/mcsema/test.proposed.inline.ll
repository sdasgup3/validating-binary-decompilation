...
entry:
  ...
  store %struct.Memory* %loadMem1_411e86, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem1_411e9e, %struct.Memory** %MEMORY
...
block_411eab:                                     ; preds = %entry
  ...
  %280 = call %struct.Memory* @__remill_function_call(%struct.State* %0, i64 ptrtoint (i64 (i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64)* @printf to i64), %struct.Memory* %loadMem2_411ebe)
...
block_.L_411ec6:                                  ; preds = %block_411eab, %entry
  ...
  store %struct.Memory* %loadMem_411ec6, %struct.Memory** %MEMORY
  ...
  ret %struct.Memory* %loadMem_411ecb
}
