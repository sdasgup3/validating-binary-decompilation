...
define %struct.Memory* @_Z17check_shifted_sumIl20custom_sub_constantsIlEEvT_(%struct.State* noalias, i64, %struct.Memory* noalias) #2 {
entry:
  ...
  store %struct.Memory* %loadMem1_411e76, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem1_411e8e, %struct.Memory** %MEMORY
...
block_411e9b:                                     ; preds = %entry
  ...
  store %struct.Memory* %loadMem1_411eae, %struct.Memory** %MEMORY
  %loadMem2_411eae = load %struct.Memory*, %struct.Memory** %MEMORY
  %loadPC_411eae = load i64, i64* %3
  %280 = call %struct.Memory* @__remill_function_call(%struct.State* %0, i64 ptrtoint (i64 (i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64)* @printf to i64), %struct.Memory* %loadMem2_411eae)
...
block_.L_411eb6:                                  ; preds = %block_411e9b, %entry
  ...
  store %struct.Memory* %loadMem_411eb6, %struct.Memory** %MEMORY
  ...
  ret %struct.Memory* %loadMem_411ebb
}
