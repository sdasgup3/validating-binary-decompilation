...
entry:
  ...
  store %struct.Memory* %loadMem1_411e36, %struct.Memory** %MEMORY
...
block_411e5b:                                     ; preds = %entry
  ...
  store %struct.Memory* %loadMem1_411e6e, %struct.Memory** %MEMORY
  %loadMem2_411e6e = load %struct.Memory*, %struct.Memory** %MEMORY
  %loadPC_411e6e = load i64, i64* %3
  %280 = call %struct.Memory* @__remill_function_call(%struct.State* %0, i64 ptrtoint (i64 (i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64)* @printf to i64), %struct.Memory* %loadMem2_411e6e)
  ...
  store %struct.Memory* %loadMem_411e73, %struct.Memory** %MEMORY
...
block_.L_411e76:                                  ; preds = %block_411e5b, %entry
  ...
  store %struct.Memory* %loadMem_411e76, %struct.Memory** %MEMORY
  ...
  ret %struct.Memory* %loadMem_411e7b
}
