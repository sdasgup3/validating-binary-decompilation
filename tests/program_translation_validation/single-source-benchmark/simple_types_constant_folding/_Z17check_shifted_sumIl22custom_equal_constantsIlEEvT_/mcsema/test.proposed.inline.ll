...
entry:
  ...
  store %struct.Memory* %loadMem1_411c76, %struct.Memory** %MEMORY
...
block_411c9b:                                     ; preds = %entry
  ...
  store %struct.Memory* %loadMem1_411cae, %struct.Memory** %MEMORY
  %loadMem2_411cae = load %struct.Memory*, %struct.Memory** %MEMORY
  %loadPC_411cae = load i64, i64* %3
  %280 = call %struct.Memory* @__remill_function_call(%struct.State* %0, i64 ptrtoint (i64 (i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64)* @printf to i64), %struct.Memory* %loadMem2_411cae)
...
block_.L_411cb6:                                  ; preds = %block_411c9b, %entry
  ...
  store %struct.Memory* %loadMem_411cb6, %struct.Memory** %MEMORY
  ...
  ret %struct.Memory* %loadMem_411cbb
}
