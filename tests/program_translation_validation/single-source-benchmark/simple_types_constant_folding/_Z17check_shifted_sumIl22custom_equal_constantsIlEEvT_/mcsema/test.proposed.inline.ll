...
define %struct.Memory* @_Z17check_shifted_sumIl22custom_equal_constantsIlEEvT_(%struct.State* noalias, i64, %struct.Memory* noalias) #2 {
entry:
  ...
  store %struct.Memory* %loadMem1_411cc6, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_411cda, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem1_411cde, %struct.Memory** %MEMORY
...
block_411ceb:                                     ; preds = %entry
  ...
  store %struct.Memory* %loadMem_411cfc, %struct.Memory** %MEMORY
  ...
  %280 = call %struct.Memory* @__remill_function_call(%struct.State* %0, i64 ptrtoint (i64 (i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64)* @printf to i64), %struct.Memory* %loadMem2_411cfe)
...
block_.L_411d06:                                  ; preds = %block_411ceb, %entry
  ...
  store %struct.Memory* %loadMem_411d0a, %struct.Memory** %MEMORY
  ...
  ret %struct.Memory* %loadMem_411d0b
}
