...
define %struct.Memory* @_Z17check_shifted_sumIl23custom_divide_constantsIlEEvT_(%struct.State* noalias, i64, %struct.Memory* noalias) #2 {
entry:
  ...
  store %struct.Memory* %loadMem1_411da6, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_411dab, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_411daf, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem1_411dbe, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_411dc3, %struct.Memory** %MEMORY
...
block_411dcb:                                     ; preds = %entry
  ...
  %280 = call %struct.Memory* @__remill_function_call(%struct.State* %0, i64 ptrtoint (i64 (i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64)* @printf to i64), %struct.Memory* %loadMem2_411dde)
...
block_.L_411de6:                                  ; preds = %block_411dcb, %entry
  ...
  store %struct.Memory* %loadMem_411dea, %struct.Memory** %MEMORY
  ...
  ret %struct.Memory* %loadMem_411deb
}
