...
entry:
  ...
  store %struct.Memory* %loadMem1_411d56, %struct.Memory** %MEMORY
...
block_411d7b:                                     ; preds = %entry
  ...
  store %struct.Memory* %loadMem1_411d8e, %struct.Memory** %MEMORY
  %loadMem2_411d8e = load %struct.Memory*, %struct.Memory** %MEMORY
  %loadPC_411d8e = load i64, i64* %3
  %280 = call %struct.Memory* @__remill_function_call(%struct.State* %0, i64 ptrtoint (i64 (i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64)* @printf to i64), %struct.Memory* %loadMem2_411d8e)
  ...
  store %struct.Memory* %loadMem_411d93, %struct.Memory** %MEMORY
...
block_.L_411d96:                                  ; preds = %block_411d7b, %entry
  ...
  store %struct.Memory* %loadMem_411d9a, %struct.Memory** %MEMORY
  ...
  ret %struct.Memory* %loadMem_411d9b
}
