...
entry:
  ...
  store %struct.Memory* %loadMem1_411d96, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem1_411dae, %struct.Memory** %MEMORY
...
block_411dbb:                                     ; preds = %entry
  ...
  store %struct.Memory* %loadMem1_411dce, %struct.Memory** %MEMORY
  %loadMem2_411dce = load %struct.Memory*, %struct.Memory** %MEMORY
  %loadPC_411dce = load i64, i64* %3
  %280 = call %struct.Memory* @__remill_function_call(%struct.State* %0, i64 ptrtoint (i64 (i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64)* @printf to i64), %struct.Memory* %loadMem2_411dce)
...
block_.L_411dd6:                                  ; preds = %block_411dbb, %entry
  ...
  store %struct.Memory* %loadMem_411ddb, %struct.Memory** %MEMORY
  ret %struct.Memory* %loadMem_411ddb
}
