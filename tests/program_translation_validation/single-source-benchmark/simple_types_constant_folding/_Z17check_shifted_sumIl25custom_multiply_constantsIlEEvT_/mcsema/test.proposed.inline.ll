...
define %struct.Memory* @_Z17check_shifted_sumIl25custom_multiply_constantsIlEEvT_(%struct.State* noalias, i64, %struct.Memory* noalias) #2 {
entry:
  ...
  store i64 %78, i64* %81
  store %struct.Memory* %loadMem_411df8, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem1_411e06, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_411e1a, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem1_411e1e, %struct.Memory** %MEMORY
...
block_411e2b:                                     ; preds = %entry
  ...
  store %struct.Memory* %loadMem1_411e3e, %struct.Memory** %MEMORY
  %loadMem2_411e3e = load %struct.Memory*, %struct.Memory** %MEMORY
  %loadPC_411e3e = load i64, i64* %3
  %280 = call %struct.Memory* @__remill_function_call(%struct.State* %0, i64 ptrtoint (i64 (i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64)* @printf to i64), %struct.Memory* %loadMem2_411e3e)
...
block_.L_411e46:                                  ; preds = %block_411e2b, %entry
  ...
  ret %struct.Memory* %loadMem_411e4b
}
