...
entry:
  ...
  store %struct.Memory* %loadMem1_411e16, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_411e2a, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem1_411e2e, %struct.Memory** %MEMORY
...
block_411e3b:                                     ; preds = %entry
  ...
  store %struct.Memory* %loadMem1_411e4e, %struct.Memory** %MEMORY
  %loadMem2_411e4e = load %struct.Memory*, %struct.Memory** %MEMORY
  %loadPC_411e4e = load i64, i64* %3
  %280 = call %struct.Memory* @__remill_function_call(%struct.State* %0, i64 ptrtoint (i64 (i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64)* @printf to i64), %struct.Memory* %loadMem2_411e4e)
...
block_.L_411e56:                                  ; preds = %block_411e3b, %entry
  ...
  ret %struct.Memory* %loadMem_411e5b
}
