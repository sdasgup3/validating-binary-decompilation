...
define %struct.Memory* @_Z17check_shifted_sumIl27custom_multiple_constant_orIlEEvT_(%struct.State* noalias, i64, %struct.Memory* noalias) #2 {
entry:
  ...
  store %struct.Memory* %loadMem_411174, %struct.Memory** %MEMORY
  ...
  store i64 %78, i64* %81
  store %struct.Memory* %loadMem_411178, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem1_411186, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_41119a, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem1_41119e, %struct.Memory** %MEMORY
...
block_4111ab:                                     ; preds = %entry
  ...
  store %struct.Memory* %loadMem_4111ab, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem1_4111be, %struct.Memory** %MEMORY
  %loadMem2_4111be = load %struct.Memory*, %struct.Memory** %MEMORY
  %loadPC_4111be = load i64, i64* %3
  %280 = call %struct.Memory* @__remill_function_call(%struct.State* %0, i64 ptrtoint (i64 (i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64)* @printf to i64), %struct.Memory* %loadMem2_4111be)
...
block_.L_4111c6:                                  ; preds = %block_4111ab, %entry
  ...
  ret %struct.Memory* %loadMem_4111cb
}
