...
define %struct.Memory* @_Z17check_shifted_sumIl28custom_greaterthan_constantsIlEEvT_(%struct.State* noalias, i64, %struct.Memory* noalias) #2 {
entry:
  ...
  store %struct.Memory* %loadMem1_411bd6, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_411bdb, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_411bea, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem1_411bee, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_411bf3, %struct.Memory** %MEMORY
...
block_411bfb:                                     ; preds = %entry
  ...
  store %struct.Memory* %loadMem1_411c0e, %struct.Memory** %MEMORY
  %loadMem2_411c0e = load %struct.Memory*, %struct.Memory** %MEMORY
  %loadPC_411c0e = load i64, i64* %3
  %280 = call %struct.Memory* @__remill_function_call(%struct.State* %0, i64 ptrtoint (i64 (i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64)* @printf to i64), %struct.Memory* %loadMem2_411c0e)
...
block_.L_411c16:                                  ; preds = %block_411bfb, %entry
  ...
  ret %struct.Memory* %loadMem_411c1b
}
