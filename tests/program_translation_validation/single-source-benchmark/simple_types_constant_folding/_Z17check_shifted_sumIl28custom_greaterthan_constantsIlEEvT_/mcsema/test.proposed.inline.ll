...
entry:
  ...
  store %struct.Memory* %loadMem1_411be6, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem1_411bfe, %struct.Memory** %MEMORY
...
block_411c0b:                                     ; preds = %entry
  ...
  %280 = call %struct.Memory* @__remill_function_call(%struct.State* %0, i64 ptrtoint (i64 (i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64)* @printf to i64), %struct.Memory* %loadMem2_411c1e)
...
block_.L_411c26:                                  ; preds = %block_411c0b, %entry
  ...
  store %struct.Memory* %loadMem_411c26, %struct.Memory** %MEMORY
  ...
  ret %struct.Memory* %loadMem_411c2b
}
