...
entry:
  ...
  store %struct.Memory* %loadMem1_411b96, %struct.Memory** %MEMORY
...
block_411bbb:                                     ; preds = %entry
  ...
  store %struct.Memory* %loadMem1_411bce, %struct.Memory** %MEMORY
  %loadMem2_411bce = load %struct.Memory*, %struct.Memory** %MEMORY
  %loadPC_411bce = load i64, i64* %3
  %280 = call %struct.Memory* @__remill_function_call(%struct.State* %0, i64 ptrtoint (i64 (i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64)* @printf to i64), %struct.Memory* %loadMem2_411bce)
...
block_.L_411bd6:                                  ; preds = %block_411bbb, %entry
  ...
  ret %struct.Memory* %loadMem_411bdb
}
