...
declare %struct.Memory* @sub_411200._ZN28custom_multiple_constant_andIlE8do_shiftEl(%struct.State* noalias dereferenceable(3376), i64, %struct.Memory* noalias readnone returned)
...
entry:
  ...
  %loadMem_411231 = load %struct.Memory*, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_411231, %struct.Memory** %MEMORY
  ...
  %loadMem_411238 = load %struct.Memory*, %struct.Memory** %MEMORY
  ...
  store i64 %78, i64* %81
  store %struct.Memory* %loadMem_411238, %struct.Memory** %MEMORY
  ...
  %loadMem1_411246 = load %struct.Memory*, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem1_411246, %struct.Memory** %MEMORY
  %loadMem2_411246 = load %struct.Memory*, %struct.Memory** %MEMORY
  %loadPC_411246 = load i64, i64* %3
  %call2_411246 = call %struct.Memory* @sub_411200._ZN28custom_multiple_constant_andIlE8do_shiftEl(%struct.State* %0, i64 %loadPC_411246, %struct.Memory* %loadMem2_411246)
  store %struct.Memory* %call2_411246, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_41124b, %struct.Memory** %MEMORY
  %loadMem_41124f = load %struct.Memory*, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_41124f, %struct.Memory** %MEMORY
  ...
  %loadMem1_41125e = load %struct.Memory*, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem1_41125e, %struct.Memory** %MEMORY
  %loadMem2_41125e = load %struct.Memory*, %struct.Memory** %MEMORY
  %loadPC_41125e = load i64, i64* %3
  %call2_41125e = call %struct.Memory* @sub_411040._Z15tolerance_equalIlEbRT_S1_(%struct.State* %0, i64 %loadPC_41125e, %struct.Memory* %loadMem2_41125e)
  store %struct.Memory* %call2_41125e, %struct.Memory** %MEMORY
  ...
  %loadBr_411265 = load i8, i8* %BRANCH_TAKEN
  %cmpBr_411265 = icmp eq i8 %loadBr_411265, 1
  br i1 %cmpBr_411265, label %block_.L_411286, label %block_41126b

block_41126b:                                     ; preds = %entry
  ...
  %loadMem_411275 = load %struct.Memory*, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_411275, %struct.Memory** %MEMORY
  ...
  %280 = call %struct.Memory* @__remill_function_call(%struct.State* %0, i64 ptrtoint (i64 (i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64)* @printf to i64), %struct.Memory* %loadMem2_41127e)
  ...
  br label %block_.L_411286

block_.L_411286:                                  ; preds = %block_41126b, %entry
  %loadMem_411286 = load %struct.Memory*, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_411286, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_41128a, %struct.Memory** %MEMORY
  ...
  ret %struct.Memory* %loadMem_41128b
}
...
define %struct.Memory* @routine_jne_.L_411286(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i8* %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) {
block_400478:
  %3 = getelementptr inbounds %struct.State, %struct.State* %0, i32 0, i32 6
  %4 = getelementptr inbounds %struct.GPR, %struct.GPR* %3, i32 0, i32 33
  %5 = getelementptr inbounds %struct.Reg, %struct.Reg* %4, i32 0, i32 0
