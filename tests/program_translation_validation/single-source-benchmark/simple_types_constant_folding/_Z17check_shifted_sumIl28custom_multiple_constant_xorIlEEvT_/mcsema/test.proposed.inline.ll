...
entry:
  ...
  %loadMem1_410ff6 = load %struct.Memory*, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem1_410ff6, %struct.Memory** %MEMORY
  %loadMem2_410ff6 = load %struct.Memory*, %struct.Memory** %MEMORY
  %loadPC_410ff6 = load i64, i64* %3
  %call2_410ff6 = call %struct.Memory* @sub_410fb0._ZN28custom_multiple_constant_xorIlE8do_shiftEl(%struct.State* %0, i64 %loadPC_410ff6, %struct.Memory* %loadMem2_410ff6)
  store %struct.Memory* %call2_410ff6, %struct.Memory** %MEMORY
  ...
  %call2_41100e = call %struct.Memory* @sub_411040._Z15tolerance_equalIlEbRT_S1_(%struct.State* %0, i64 %loadPC_41100e, %struct.Memory* %loadMem2_41100e)
...
block_41101b:                                     ; preds = %entry
  ...
  %280 = call %struct.Memory* @__remill_function_call(%struct.State* %0, i64 ptrtoint (i64 (i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64)* @printf to i64), %struct.Memory* %loadMem2_41102e)
...
block_.L_411036:                                  ; preds = %block_41101b, %entry
  ...
  ret %struct.Memory* %loadMem_41103b
}
