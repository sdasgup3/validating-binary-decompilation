...
entry:
  ...
  store %struct.Memory* %loadMem1_411a96, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem1_411aae, %struct.Memory** %MEMORY
...
block_411abb:                                     ; preds = %entry
  ...
  store %struct.Memory* %loadMem1_411ace, %struct.Memory** %MEMORY
  %loadMem2_411ace = load %struct.Memory*, %struct.Memory** %MEMORY
  %loadPC_411ace = load i64, i64* %3
  %280 = call %struct.Memory* @__remill_function_call(%struct.State* %0, i64 ptrtoint (i64 (i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64)* @printf to i64), %struct.Memory* %loadMem2_411ace)
...
block_.L_411ad6:                                  ; preds = %block_411abb, %entry
  ...
  store %struct.Memory* %loadMem_411ada, %struct.Memory** %MEMORY
  ...
  ret %struct.Memory* %loadMem_411adb
}
