...
define %struct.Memory* @_Z17check_shifted_sumIl30custom_multiple_constant_mixedIlEEvT_(%struct.State* noalias, i64, %struct.Memory* noalias) #2 {
entry:
  ...
  store %struct.Memory* %loadMem_411380, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_411381, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_411384, %struct.Memory** %MEMORY
  %loadMem_411388 = load %struct.Memory*, %struct.Memory** %MEMORY
  ...
  store i64 %78, i64* %81
  store %struct.Memory* %loadMem_411388, %struct.Memory** %MEMORY
  %loadMem_41138c = load %struct.Memory*, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_41138c, %struct.Memory** %MEMORY
  %loadMem1_411396 = load %struct.Memory*, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem1_411396, %struct.Memory** %MEMORY
  %loadMem2_411396 = load %struct.Memory*, %struct.Memory** %MEMORY
  %loadPC_411396 = load i64, i64* %3
  %call2_411396 = call %struct.Memory* @sub_411360._ZN30custom_multiple_constant_mixedIlE8do_shiftEl(%struct.State* %0, i64 %loadPC_411396, %struct.Memory* %loadMem2_411396)
  store %struct.Memory* %call2_411396, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_41139b, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_4113a3, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_4113aa, %struct.Memory** %MEMORY
  %loadMem1_4113ae = load %struct.Memory*, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem1_4113ae, %struct.Memory** %MEMORY
  %loadMem2_4113ae = load %struct.Memory*, %struct.Memory** %MEMORY
  %loadPC_4113ae = load i64, i64* %3
  %call2_4113ae = call %struct.Memory* @sub_411090._Z15tolerance_equalIlEbRT_S1_(%struct.State* %0, i64 %loadPC_4113ae, %struct.Memory* %loadMem2_4113ae)
  store %struct.Memory* %call2_4113ae, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_4113b3, %struct.Memory** %MEMORY
  ...
  %loadBr_4113b5 = load i8, i8* %BRANCH_TAKEN
  %cmpBr_4113b5 = icmp eq i8 %loadBr_4113b5, 1
  br i1 %cmpBr_4113b5, label %block_.L_4113d6, label %block_4113bb

block_4113bb:                                     ; preds = %entry
  ...
  store %struct.Memory* %loadMem_4113bb, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_4113c5, %struct.Memory** %MEMORY
  ...
  %loadMem1_4113ce = load %struct.Memory*, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem1_4113ce, %struct.Memory** %MEMORY
  %loadMem2_4113ce = load %struct.Memory*, %struct.Memory** %MEMORY
  %loadPC_4113ce = load i64, i64* %3
  %280 = call %struct.Memory* @__remill_function_call(%struct.State* %0, i64 ptrtoint (i64 (i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64)* @printf to i64), %struct.Memory* %loadMem2_4113ce)
  ...
  br label %block_.L_4113d6

block_.L_4113d6:                                  ; preds = %block_4113bb, %entry
  ...
  store %struct.Memory* %loadMem_4113d6, %struct.Memory** %MEMORY
  ...
  ret %struct.Memory* %loadMem_4113db
}
...
define %struct.Memory* @routine_jne_.L_4113d6(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i8* %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) {
block_400488:
  %3 = getelementptr inbounds %struct.State, %struct.State* %0, i32 0, i32 6
  %4 = getelementptr inbounds %struct.GPR, %struct.GPR* %3, i32 0, i32 33
  %5 = getelementptr inbounds %struct.Reg, %struct.Reg* %4, i32 0, i32 0
