...
entry:
  ...
  store %struct.Memory* %loadMem_411331, %struct.Memory** %MEMORY
  %loadMem_411334 = load %struct.Memory*, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_411334, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_41133c, %struct.Memory** %MEMORY
  %loadMem1_411346 = load %struct.Memory*, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem1_411346, %struct.Memory** %MEMORY
  %loadMem2_411346 = load %struct.Memory*, %struct.Memory** %MEMORY
  %loadPC_411346 = load i64, i64* %3
  %call2_411346 = call %struct.Memory* @sub_411310._ZN30custom_multiple_constant_mixedIlE8do_shiftEl(%struct.State* %0, i64 %loadPC_411346, %struct.Memory* %loadMem2_411346)
  store %struct.Memory* %call2_411346, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_41134f, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_411353, %struct.Memory** %MEMORY
  ...
  %loadMem1_41135e = load %struct.Memory*, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem1_41135e, %struct.Memory** %MEMORY
  %loadMem2_41135e = load %struct.Memory*, %struct.Memory** %MEMORY
  %loadPC_41135e = load i64, i64* %3
  %call2_41135e = call %struct.Memory* @sub_411040._Z15tolerance_equalIlEbRT_S1_(%struct.State* %0, i64 %loadPC_41135e, %struct.Memory* %loadMem2_41135e)
  store %struct.Memory* %call2_41135e, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_411363, %struct.Memory** %MEMORY
  ...
  %loadBr_411365 = load i8, i8* %BRANCH_TAKEN
  %cmpBr_411365 = icmp eq i8 %loadBr_411365, 1
  br i1 %cmpBr_411365, label %block_.L_411386, label %block_41136b

block_41136b:                                     ; preds = %entry
  ...
  store %struct.Memory* %loadMem_411375, %struct.Memory** %MEMORY
  ...
  %loadMem1_41137e = load %struct.Memory*, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem1_41137e, %struct.Memory** %MEMORY
  %loadMem2_41137e = load %struct.Memory*, %struct.Memory** %MEMORY
  %loadPC_41137e = load i64, i64* %3
  %280 = call %struct.Memory* @__remill_function_call(%struct.State* %0, i64 ptrtoint (i64 (i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64)* @printf to i64), %struct.Memory* %loadMem2_41137e)
  ...
  store %struct.Memory* %loadMem_411383, %struct.Memory** %MEMORY
  br label %block_.L_411386

block_.L_411386:                                  ; preds = %block_41136b, %entry
  ...
  store %struct.Memory* %loadMem_41138a, %struct.Memory** %MEMORY
  ...
  ret %struct.Memory* %loadMem_41138b
}
...
define %struct.Memory* @routine_jne_.L_411386(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i8* %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) {
block_400478:
  %3 = getelementptr inbounds %struct.State, %struct.State* %0, i32 0, i32 6
  %4 = getelementptr inbounds %struct.GPR, %struct.GPR* %3, i32 0, i32 33
  %5 = getelementptr inbounds %struct.Reg, %struct.Reg* %4, i32 0, i32 0
