...
define %struct.Memory* @_Z17check_shifted_sumIl31custom_multiple_constant_divideIlEEvT_(%struct.State* noalias, i64, %struct.Memory* noalias) #2 {
entry:
  ...
  store %struct.Memory* %loadMem_4114bc, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem1_4114c6, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_4114da, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem1_4114de, %struct.Memory** %MEMORY
...
block_4114eb:                                     ; preds = %entry
  ...
  store %struct.Memory* %loadMem_4114eb, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem1_4114fe, %struct.Memory** %MEMORY
  %loadMem2_4114fe = load %struct.Memory*, %struct.Memory** %MEMORY
  %loadPC_4114fe = load i64, i64* %3
  %280 = call %struct.Memory* @__remill_function_call(%struct.State* %0, i64 ptrtoint (i64 (i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64)* @printf to i64), %struct.Memory* %loadMem2_4114fe)
...
block_.L_411506:                                  ; preds = %block_4114eb, %entry
  ...
  ret %struct.Memory* %loadMem_41150b
}
