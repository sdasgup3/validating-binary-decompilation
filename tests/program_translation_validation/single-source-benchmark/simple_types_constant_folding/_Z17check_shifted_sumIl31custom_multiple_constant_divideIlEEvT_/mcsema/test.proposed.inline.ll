...
entry:
  ...
  store %struct.Memory* %loadMem1_411476, %struct.Memory** %MEMORY
...
block_41149b:                                     ; preds = %entry
  ...
  store %struct.Memory* %loadMem1_4114ae, %struct.Memory** %MEMORY
  %loadMem2_4114ae = load %struct.Memory*, %struct.Memory** %MEMORY
  %loadPC_4114ae = load i64, i64* %3
  %280 = call %struct.Memory* @__remill_function_call(%struct.State* %0, i64 ptrtoint (i64 (i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64)* @printf to i64), %struct.Memory* %loadMem2_4114ae)
...
block_.L_4114b6:                                  ; preds = %block_41149b, %entry
  ...
  ret %struct.Memory* %loadMem_4114bb
}
