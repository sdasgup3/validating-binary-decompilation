...
declare %struct.Memory* @sub_411390._ZN32custom_multiple_constant_divide2IlE8do_shiftEl(%struct.State* noalias dereferenceable(3376), i64, %struct.Memory* noalias readnone returned)
...
define %struct.Memory* @_Z17check_shifted_sumIl32custom_multiple_constant_divide2IlEEvT_(%struct.State* noalias, i64, %struct.Memory* noalias) #2 {
entry:
  ...
  store %struct.Memory* %loadMem_4113b0, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_4113b4, %struct.Memory** %MEMORY
  %loadMem_4113b8 = load %struct.Memory*, %struct.Memory** %MEMORY
  ...
  store i64 %78, i64* %81
  store %struct.Memory* %loadMem_4113b8, %struct.Memory** %MEMORY
  ...
  %loadMem1_4113c6 = load %struct.Memory*, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem1_4113c6, %struct.Memory** %MEMORY
  %loadMem2_4113c6 = load %struct.Memory*, %struct.Memory** %MEMORY
  %loadPC_4113c6 = load i64, i64* %3
  %call2_4113c6 = call %struct.Memory* @sub_411390._ZN32custom_multiple_constant_divide2IlE8do_shiftEl(%struct.State* %0, i64 %loadPC_4113c6, %struct.Memory* %loadMem2_4113c6)
  store %struct.Memory* %call2_4113c6, %struct.Memory** %MEMORY
  %loadMem_4113cb = load %struct.Memory*, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_4113cb, %struct.Memory** %MEMORY
  %loadMem_4113cf = load %struct.Memory*, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_4113cf, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_4113d3, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_4113da, %struct.Memory** %MEMORY
  %loadMem1_4113de = load %struct.Memory*, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem1_4113de, %struct.Memory** %MEMORY
  %loadMem2_4113de = load %struct.Memory*, %struct.Memory** %MEMORY
  %loadPC_4113de = load i64, i64* %3
  %call2_4113de = call %struct.Memory* @sub_411040._Z15tolerance_equalIlEbRT_S1_(%struct.State* %0, i64 %loadPC_4113de, %struct.Memory* %loadMem2_4113de)
  store %struct.Memory* %call2_4113de, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_4113e3, %struct.Memory** %MEMORY
  ...
  %loadBr_4113e5 = load i8, i8* %BRANCH_TAKEN
  %cmpBr_4113e5 = icmp eq i8 %loadBr_4113e5, 1
  br i1 %cmpBr_4113e5, label %block_.L_411406, label %block_4113eb

block_4113eb:                                     ; preds = %entry
  ...
  store %struct.Memory* %loadMem_4113eb, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_4113fc, %struct.Memory** %MEMORY
  %loadMem1_4113fe = load %struct.Memory*, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem1_4113fe, %struct.Memory** %MEMORY
  %loadMem2_4113fe = load %struct.Memory*, %struct.Memory** %MEMORY
  %loadPC_4113fe = load i64, i64* %3
  %280 = call %struct.Memory* @__remill_function_call(%struct.State* %0, i64 ptrtoint (i64 (i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64)* @printf to i64), %struct.Memory* %loadMem2_4113fe)
  ...
  store %struct.Memory* %loadMem_411403, %struct.Memory** %MEMORY
  br label %block_.L_411406

block_.L_411406:                                  ; preds = %block_4113eb, %entry
  %loadMem_411406 = load %struct.Memory*, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_411406, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_41140a, %struct.Memory** %MEMORY
  ...
  ret %struct.Memory* %loadMem_41140b
}
...
define %struct.Memory* @routine_callq_._ZN32custom_multiple_constant_divide2IlE8do_shiftEl(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) {
block_400478:
  %3 = getelementptr inbounds %struct.State, %struct.State* %0, i32 0, i32 6
  %4 = getelementptr inbounds %struct.GPR, %struct.GPR* %3, i32 0, i32 33
  %5 = getelementptr inbounds %struct.Reg, %struct.Reg* %4, i32 0, i32 0
...
define %struct.Memory* @routine_jne_.L_411406(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i8* %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) {
block_400478:
  %3 = getelementptr inbounds %struct.State, %struct.State* %0, i32 0, i32 6
  %4 = getelementptr inbounds %struct.GPR, %struct.GPR* %3, i32 0, i32 33
  %5 = getelementptr inbounds %struct.Reg, %struct.Reg* %4, i32 0, i32 0
