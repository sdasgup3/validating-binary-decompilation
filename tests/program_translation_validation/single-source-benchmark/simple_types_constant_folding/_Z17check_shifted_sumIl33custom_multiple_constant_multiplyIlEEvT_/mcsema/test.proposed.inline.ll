...
entry:
  ...
  store %struct.Memory* %loadMem1_4115f6, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem1_41160e, %struct.Memory** %MEMORY
...
block_41161b:                                     ; preds = %entry
  ...
  store %struct.Memory* %loadMem_411625, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem1_41162e, %struct.Memory** %MEMORY
  %loadMem2_41162e = load %struct.Memory*, %struct.Memory** %MEMORY
  %loadPC_41162e = load i64, i64* %3
  %280 = call %struct.Memory* @__remill_function_call(%struct.State* %0, i64 ptrtoint (i64 (i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64)* @printf to i64), %struct.Memory* %loadMem2_41162e)
...
block_.L_411636:                                  ; preds = %block_41161b, %entry
  ...
  ret %struct.Memory* %loadMem_41163b
}
