...
define %struct.Memory* @_Z17check_shifted_sumIl33custom_multiple_constant_multiplyIlEEvT_(%struct.State* noalias, i64, %struct.Memory* noalias) #2 {
entry:
  ...
  store %struct.Memory* %loadMem_411621, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem1_411636, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem1_41164e, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_411655, %struct.Memory** %MEMORY
...
block_41165b:                                     ; preds = %entry
  ...
  store %struct.Memory* %loadMem_41165b, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem1_41166e, %struct.Memory** %MEMORY
  %loadMem2_41166e = load %struct.Memory*, %struct.Memory** %MEMORY
  %loadPC_41166e = load i64, i64* %3
  %280 = call %struct.Memory* @__remill_function_call(%struct.State* %0, i64 ptrtoint (i64 (i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64)* @printf to i64), %struct.Memory* %loadMem2_41166e)
  ...
  store %struct.Memory* %loadMem_411673, %struct.Memory** %MEMORY
...
block_.L_411676:                                  ; preds = %block_41165b, %entry
  ...
  store %struct.Memory* %loadMem_41167a, %struct.Memory** %MEMORY
  ...
  ret %struct.Memory* %loadMem_41167b
}
