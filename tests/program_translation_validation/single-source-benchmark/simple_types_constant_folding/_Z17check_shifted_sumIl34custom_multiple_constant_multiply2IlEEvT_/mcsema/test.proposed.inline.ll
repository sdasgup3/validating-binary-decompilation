...
define %struct.Memory* @_Z17check_shifted_sumIl34custom_multiple_constant_multiply2IlEEvT_(%struct.State* noalias, i64, %struct.Memory* noalias) #2 {
entry:
  ...
  store %struct.Memory* %loadMem_4115bc, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem1_4115c6, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_4115da, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem1_4115de, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_4115e3, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_4115e5, %struct.Memory** %MEMORY
...
block_4115eb:                                     ; preds = %entry
  ...
  store %struct.Memory* %loadMem_4115eb, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_4115fc, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem1_4115fe, %struct.Memory** %MEMORY
  %loadMem2_4115fe = load %struct.Memory*, %struct.Memory** %MEMORY
  %loadPC_4115fe = load i64, i64* %3
  %280 = call %struct.Memory* @__remill_function_call(%struct.State* %0, i64 ptrtoint (i64 (i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64)* @printf to i64), %struct.Memory* %loadMem2_4115fe)
  ...
  store %struct.Memory* %loadMem_411603, %struct.Memory** %MEMORY
  br label %block_.L_411606

block_.L_411606:                                  ; preds = %block_4115eb, %entry
  ...
  store %struct.Memory* %loadMem_411606, %struct.Memory** %MEMORY
  ...
  ret %struct.Memory* %loadMem_41160b
}
