...
entry:
  ...
  %44 = add i64 %43, ptrtoint (%G_0x211104__rip__type* @G_0x211104__rip_ to i64)
  %45 = add i64 %43, 8
  ...
  %51 = add i64 %43, add (i64 ptrtoint (%G_0x7aa4__rip__type* @G_0x7aa4__rip_ to i64), i64 8)
  %52 = add i64 %43, 16
...
routine_ucomisd__xmm0___xmm1.exit:                ; preds = %119, %107
  ...
  %call2_410fb2 = tail call %struct.Memory* @sub_410f60._ZN10custom_twoImE8do_shiftEm(%struct.State* nonnull %0, i64 %131, %struct.Memory* %127)
  ...
  %call2_410fca = tail call %struct.Memory* @sub_40fb20._Z15tolerance_equalImEbRT_S1_(%struct.State* nonnull %0, i64 %161, %struct.Memory* %call2_410fb2)
  ...
  br i1 %174, label %block_.L_410ff2, label %block_410fd7
...
block_410fd7:                                     ; preds = %routine_ucomisd__xmm0___xmm1.exit
  ...
  %183 = tail call %struct.Memory* @__remill_function_call(%struct.State* nonnull %0, i64 ptrtoint (i64 (i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64)* @printf to i64), %struct.Memory* %call2_410fca)
...
block_.L_410ff2:                                  ; preds = %block_410fd7, %routine_ucomisd__xmm0___xmm1.exit
  %190 = phi i64 [ %175, %routine_ucomisd__xmm0___xmm1.exit ], [ %.pre5, %block_410fd7 ]
  %MEMORY.0 = phi %struct.Memory* [ %call2_410fca, %routine_ucomisd__xmm0___xmm1.exit ], [ %183, %block_410fd7 ]
