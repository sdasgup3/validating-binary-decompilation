...
block_40fd37:                                     ; preds = %routine_ucomisd__xmm0___xmm1.exit
  ...
  %call2_40fd4a = call %struct.Memory* @sub_4006c0.printf_plt(%struct.State* %0, i64 %loadPC_40fd4a, %struct.Memory* %loadMem2_40fd4a)
  store %struct.Memory* %call2_40fd4a, %struct.Memory** %MEMORY
