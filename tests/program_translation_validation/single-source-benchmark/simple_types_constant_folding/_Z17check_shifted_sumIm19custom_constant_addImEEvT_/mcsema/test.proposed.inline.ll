...
declare %struct.Memory* @sub_4105e0._ZN19custom_constant_addImE8do_shiftEm(%struct.State* noalias dereferenceable(3376), i64, %struct.Memory* noalias readnone returned)
...
entry:
  ...
  store i64 %78, i64* %81
  store %struct.Memory* %loadMem_410608, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_41060c, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_410623, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_410628, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_410635, %struct.Memory** %MEMORY
...
; <label>:260:                                    ; preds = %252
  ...
  %263 = call %struct.Memory* @__remill_error(%struct.State* nonnull dereferenceable(3376) %0, i64 %262, %struct.Memory* %loadMem_41063a)
...
routine_ucomisd__xmm0___xmm1.exit:                ; preds = %260, %277
  %281 = phi %struct.Memory* [ %263, %260 ], [ %loadMem_41063a, %277 ]
  store %struct.Memory* %281, %struct.Memory** %MEMORY
  %loadMem_41063e = load %struct.Memory*, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_41063e, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem1_410642, %struct.Memory** %MEMORY
  %loadMem2_410642 = load %struct.Memory*, %struct.Memory** %MEMORY
  %loadPC_410642 = load i64, i64* %3
  %call2_410642 = call %struct.Memory* @sub_4105e0._ZN19custom_constant_addImE8do_shiftEm(%struct.State* %0, i64 %loadPC_410642, %struct.Memory* %loadMem2_410642)
  ...
  store %struct.Memory* %loadMem_41064b, %struct.Memory** %MEMORY
  %loadMem_41064f = load %struct.Memory*, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_41064f, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_410656, %struct.Memory** %MEMORY
  %loadMem1_41065a = load %struct.Memory*, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem1_41065a, %struct.Memory** %MEMORY
  %loadMem2_41065a = load %struct.Memory*, %struct.Memory** %MEMORY
  %loadPC_41065a = load i64, i64* %3
  %call2_41065a = call %struct.Memory* @sub_40fb10._Z15tolerance_equalImEbRT_S1_(%struct.State* %0, i64 %loadPC_41065a, %struct.Memory* %loadMem2_41065a)
  store %struct.Memory* %call2_41065a, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_410661, %struct.Memory** %MEMORY
  %loadBr_410661 = load i8, i8* %BRANCH_TAKEN
  %cmpBr_410661 = icmp eq i8 %loadBr_410661, 1
  br i1 %cmpBr_410661, label %block_.L_410682, label %block_410667

block_410667:                                     ; preds = %routine_ucomisd__xmm0___xmm1.exit
  ...
  store %struct.Memory* %loadMem_410667, %struct.Memory** %MEMORY
  ...
  %loadMem_410678 = load %struct.Memory*, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_410678, %struct.Memory** %MEMORY
  %loadMem1_41067a = load %struct.Memory*, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem1_41067a, %struct.Memory** %MEMORY
  %loadMem2_41067a = load %struct.Memory*, %struct.Memory** %MEMORY
  %loadPC_41067a = load i64, i64* %3
  %486 = call %struct.Memory* @__remill_function_call(%struct.State* %0, i64 ptrtoint (i64 (i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64)* @printf to i64), %struct.Memory* %loadMem2_41067a)
  store %struct.Memory* %486, %struct.Memory** %MEMORY
  %loadMem_41067f = load %struct.Memory*, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_41067f, %struct.Memory** %MEMORY
  br label %block_.L_410682

block_.L_410682:                                  ; preds = %block_410667, %routine_ucomisd__xmm0___xmm1.exit
  ...
  store %struct.Memory* %loadMem_410686, %struct.Memory** %MEMORY
  %loadMem_410687 = load %struct.Memory*, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_410687, %struct.Memory** %MEMORY
  ret %struct.Memory* %loadMem_410687
}
...
define %struct.Memory* @routine_movsd_0x211a74__rip____xmm0(%struct.State* dereferenceable(3376), i64, %struct.Memory*) {
block_400488:
  %3 = getelementptr inbounds %struct.State, %struct.State* %0, i32 0, i32 6
  %4 = getelementptr inbounds %struct.GPR, %struct.GPR* %3, i32 0, i32 33
  %5 = getelementptr inbounds %struct.Reg, %struct.Reg* %4, i32 0, i32 0
...
define %struct.Memory* @routine_jne_.L_410682(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i8* %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) {
block_400488:
  %3 = getelementptr inbounds %struct.State, %struct.State* %0, i32 0, i32 6
  %4 = getelementptr inbounds %struct.GPR, %struct.GPR* %3, i32 0, i32 33
  %5 = getelementptr inbounds %struct.Reg, %struct.Reg* %4, i32 0, i32 0
