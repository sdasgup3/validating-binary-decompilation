...
block_4104f7:                                     ; preds = %routine_ucomisd__xmm0___xmm1.exit
  ...
  %call2_41050a = call %struct.Memory* @sub_4006c0.printf_plt(%struct.State* %0, i64 %loadPC_41050a, %struct.Memory* %loadMem2_41050a)
  store %struct.Memory* %call2_41050a, %struct.Memory** %MEMORY
