...
block_40fbc7:                                     ; preds = %routine_ucomisd__xmm0___xmm1.exit
  ...
  %call2_40fbda = call %struct.Memory* @sub_4006c0.printf_plt(%struct.State* %0, i64 %loadPC_40fbda, %struct.Memory* %loadMem2_40fbda)
  store %struct.Memory* %call2_40fbda, %struct.Memory** %MEMORY
