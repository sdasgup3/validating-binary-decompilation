...
block_4107a7:                                     ; preds = %routine_ucomisd__xmm0___xmm1.exit
  ...
  %call2_4107ba = call %struct.Memory* @sub_4006c0.printf_plt(%struct.State* %0, i64 %loadPC_4107ba, %struct.Memory* %loadMem2_4107ba)
  store %struct.Memory* %call2_4107ba, %struct.Memory** %MEMORY
