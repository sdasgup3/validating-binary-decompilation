...
@G_0x2118d4__rip__4261812_ = global %G_0x2118d4__rip__4261812__type zeroinitializer
@G_0x6220a8 = global %G_0x6220a8_type zeroinitializer
@G_0x8224__rip__4261820_ = global %G_0x8224__rip__4261820__type zeroinitializer
...
entry:
  ...
  %91 = load double, double* bitcast (%G_0x2118d4__rip__4261812__type* @G_0x2118d4__rip__4261812_ to double*)
  ...
  %104 = load double, double* bitcast (%G_0x8224__rip__4261820__type* @G_0x8224__rip__4261820_ to double*)
...
; <label>:256:                                    ; preds = %248
  ...
  %259 = call %struct.Memory* @__remill_error(%struct.State* nonnull dereferenceable(3376) %0, i64 %258, %struct.Memory* %loadMem_4107da)
...
routine_ucomisd__xmm0___xmm1.exit:                ; preds = %256, %273
  %277 = phi %struct.Memory* [ %259, %256 ], [ %loadMem_4107da, %273 ]
  ...
  store %struct.Memory* %loadMem1_4107e2, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_4107e7, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem1_4107fa, %struct.Memory** %MEMORY
...
block_410807:                                     ; preds = %routine_ucomisd__xmm0___xmm1.exit
  ...
  %482 = call %struct.Memory* @__remill_function_call(%struct.State* %0, i64 ptrtoint (i64 (i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64)* @printf to i64), %struct.Memory* %loadMem2_41081a)
...
block_.L_410822:                                  ; preds = %block_410807, %routine_ucomisd__xmm0___xmm1.exit
  ...
  store %struct.Memory* %loadMem_410827, %struct.Memory** %MEMORY
  ret %struct.Memory* %loadMem_410827
}
...
define %struct.Memory* @routine_movsd_0x2118d4__rip____xmm0(%struct.State* dereferenceable(3376), i64, %struct.Memory*) {
block_400478:
  %3 = getelementptr inbounds %struct.State, %struct.State* %0, i32 0, i32 6
  %4 = getelementptr inbounds %struct.GPR, %struct.GPR* %3, i32 0, i32 33
  %5 = getelementptr inbounds %struct.Reg, %struct.Reg* %4, i32 0, i32 0
...
define %struct.Memory* @routine_movsd_0x8224__rip____xmm1(%struct.State* dereferenceable(3376), i64, %struct.Memory*) {
block_400478:
  %3 = getelementptr inbounds %struct.State, %struct.State* %0, i32 0, i32 6
  %4 = getelementptr inbounds %struct.GPR, %struct.GPR* %3, i32 0, i32 33
  %5 = getelementptr inbounds %struct.Reg, %struct.Reg* %4, i32 0, i32 0
