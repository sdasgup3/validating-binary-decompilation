...
entry:
  ...
  store %struct.Memory* %loadMem_410808, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_410812, %struct.Memory** %MEMORY
...
; <label>:260:                                    ; preds = %252
  ...
  %263 = call %struct.Memory* @__remill_error(%struct.State* nonnull dereferenceable(3376) %0, i64 %262, %struct.Memory* %loadMem_41081a)
...
routine_ucomisd__xmm0___xmm1.exit:                ; preds = %260, %277
  %281 = phi %struct.Memory* [ %263, %260 ], [ %loadMem_41081a, %277 ]
  ...
  store %struct.Memory* %loadMem_41081e, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem1_410822, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem1_41083a, %struct.Memory** %MEMORY
...
block_410847:                                     ; preds = %routine_ucomisd__xmm0___xmm1.exit
  ...
  store %struct.Memory* %loadMem1_41085a, %struct.Memory** %MEMORY
  %loadMem2_41085a = load %struct.Memory*, %struct.Memory** %MEMORY
  %loadPC_41085a = load i64, i64* %3
  %486 = call %struct.Memory* @__remill_function_call(%struct.State* %0, i64 ptrtoint (i64 (i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64)* @printf to i64), %struct.Memory* %loadMem2_41085a)
...
block_.L_410862:                                  ; preds = %block_410847, %routine_ucomisd__xmm0___xmm1.exit
  ...
  store %struct.Memory* %loadMem_410867, %struct.Memory** %MEMORY
  ret %struct.Memory* %loadMem_410867
}
...
define %struct.Memory* @routine_movsd_0x211894__rip____xmm0(%struct.State* dereferenceable(3376), i64, %struct.Memory*) {
block_400488:
  %3 = getelementptr inbounds %struct.State, %struct.State* %0, i32 0, i32 6
  %4 = getelementptr inbounds %struct.GPR, %struct.GPR* %3, i32 0, i32 33
  %5 = getelementptr inbounds %struct.Reg, %struct.Reg* %4, i32 0, i32 0
