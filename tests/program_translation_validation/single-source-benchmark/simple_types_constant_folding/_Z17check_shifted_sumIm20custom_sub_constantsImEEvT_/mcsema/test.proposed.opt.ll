...
block_410e87:                                     ; preds = %routine_ucomisd__xmm0___xmm1.exit
  ...
  %call2_410e9a = tail call %struct.Memory* @sub_4006c0.printf_plt(%struct.State* nonnull %0, i64 %178, %struct.Memory* %call2_410e7a)
...
block_.L_410ea2:                                  ; preds = %block_410e87, %routine_ucomisd__xmm0___xmm1.exit
  %189 = phi i64 [ %175, %routine_ucomisd__xmm0___xmm1.exit ], [ %.pre5, %block_410e87 ]
  %MEMORY.0 = phi %struct.Memory* [ %call2_410e7a, %routine_ucomisd__xmm0___xmm1.exit ], [ %call2_410e9a, %block_410e87 ]
