...
block_410ac7:                                     ; preds = %routine_ucomisd__xmm0___xmm1.exit
  ...
  %call2_410ada = call %struct.Memory* @sub_4006c0.printf_plt(%struct.State* %0, i64 %loadPC_410ada, %struct.Memory* %loadMem2_410ada)
  store %struct.Memory* %call2_410ada, %struct.Memory** %MEMORY
