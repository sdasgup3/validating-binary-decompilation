...
declare %struct.Memory* @sub_410a50._ZN28custom_greaterthan_constantsImE8do_shiftEm(%struct.State* dereferenceable(3376), i64, %struct.Memory*) local_unnamed_addr
