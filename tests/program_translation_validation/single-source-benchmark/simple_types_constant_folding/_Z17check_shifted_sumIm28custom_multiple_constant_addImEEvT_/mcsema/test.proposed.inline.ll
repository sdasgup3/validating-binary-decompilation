...
; <label>:260:                                    ; preds = %252
  ...
  %263 = call %struct.Memory* @__remill_error(%struct.State* nonnull dereferenceable(3376) %0, i64 %262, %struct.Memory* %loadMem_41058a)
...
routine_ucomisd__xmm0___xmm1.exit:                ; preds = %260, %277
  %281 = phi %struct.Memory* [ %263, %260 ], [ %loadMem_41058a, %277 ]
  ...
  store %struct.Memory* %loadMem1_410592, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_41059f, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem1_4105aa, %struct.Memory** %MEMORY
...
block_4105b7:                                     ; preds = %routine_ucomisd__xmm0___xmm1.exit
  ...
  store %struct.Memory* %loadMem1_4105ca, %struct.Memory** %MEMORY
  %loadMem2_4105ca = load %struct.Memory*, %struct.Memory** %MEMORY
  %loadPC_4105ca = load i64, i64* %3
  %486 = call %struct.Memory* @__remill_function_call(%struct.State* %0, i64 ptrtoint (i64 (i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64)* @printf to i64), %struct.Memory* %loadMem2_4105ca)
...
block_.L_4105d2:                                  ; preds = %block_4105b7, %routine_ucomisd__xmm0___xmm1.exit
  ...
  store %struct.Memory* %loadMem_4105d2, %struct.Memory** %MEMORY
  ...
  ret %struct.Memory* %loadMem_4105d7
}
...
define %struct.Memory* @routine_movsd_0x211b24__rip____xmm0(%struct.State* dereferenceable(3376), i64, %struct.Memory*) {
block_400488:
  %3 = getelementptr inbounds %struct.State, %struct.State* %0, i32 0, i32 6
  %4 = getelementptr inbounds %struct.GPR, %struct.GPR* %3, i32 0, i32 33
  %5 = getelementptr inbounds %struct.Reg, %struct.Reg* %4, i32 0, i32 0
