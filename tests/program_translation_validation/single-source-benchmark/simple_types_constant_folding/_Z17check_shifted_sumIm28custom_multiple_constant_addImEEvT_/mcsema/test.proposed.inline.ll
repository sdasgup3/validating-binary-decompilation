...
@G_0x211b64__rip__4261156_ = global %G_0x211b64__rip__4261156__type zeroinitializer
@G_0x6220a8 = global %G_0x6220a8_type zeroinitializer
@G_0x84b4__rip__4261164_ = global %G_0x84b4__rip__4261164__type zeroinitializer
...
entry:
  ...
  store %struct.Memory* %loadMem_410514, %struct.Memory** %MEMORY
  ...
  %91 = load double, double* bitcast (%G_0x211b64__rip__4261156__type* @G_0x211b64__rip__4261156_ to double*)
  ...
  %104 = load double, double* bitcast (%G_0x84b4__rip__4261164__type* @G_0x84b4__rip__4261164_ to double*)
...
; <label>:256:                                    ; preds = %248
  ...
  %259 = call %struct.Memory* @__remill_error(%struct.State* nonnull dereferenceable(3376) %0, i64 %258, %struct.Memory* %loadMem_41054a)
...
routine_ucomisd__xmm0___xmm1.exit:                ; preds = %256, %273
  %277 = phi %struct.Memory* [ %259, %256 ], [ %loadMem_41054a, %273 ]
  ...
  store %struct.Memory* %loadMem1_410552, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem1_41056a, %struct.Memory** %MEMORY
...
block_410577:                                     ; preds = %routine_ucomisd__xmm0___xmm1.exit
  ...
  store %struct.Memory* %loadMem1_41058a, %struct.Memory** %MEMORY
  %loadMem2_41058a = load %struct.Memory*, %struct.Memory** %MEMORY
  %loadPC_41058a = load i64, i64* %3
  %482 = call %struct.Memory* @__remill_function_call(%struct.State* %0, i64 ptrtoint (i64 (i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64)* @printf to i64), %struct.Memory* %loadMem2_41058a)
...
block_.L_410592:                                  ; preds = %block_410577, %routine_ucomisd__xmm0___xmm1.exit
  ...
  store %struct.Memory* %loadMem_410597, %struct.Memory** %MEMORY
  ret %struct.Memory* %loadMem_410597
}
...
define %struct.Memory* @routine_movsd_0x211b64__rip____xmm0(%struct.State* dereferenceable(3376), i64, %struct.Memory*) {
block_400478:
  %3 = getelementptr inbounds %struct.State, %struct.State* %0, i32 0, i32 6
  %4 = getelementptr inbounds %struct.GPR, %struct.GPR* %3, i32 0, i32 33
  %5 = getelementptr inbounds %struct.Reg, %struct.Reg* %4, i32 0, i32 0
...
define %struct.Memory* @routine_movsd_0x84b4__rip____xmm1(%struct.State* dereferenceable(3376), i64, %struct.Memory*) {
block_400478:
  %3 = getelementptr inbounds %struct.State, %struct.State* %0, i32 0, i32 6
  %4 = getelementptr inbounds %struct.GPR, %struct.GPR* %3, i32 0, i32 33
  %5 = getelementptr inbounds %struct.Reg, %struct.Reg* %4, i32 0, i32 0
