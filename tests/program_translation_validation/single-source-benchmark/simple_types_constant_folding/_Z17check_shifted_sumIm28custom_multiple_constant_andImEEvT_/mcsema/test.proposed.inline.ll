...
block_40fdf7:                                     ; preds = %routine_ucomisd__xmm0___xmm1.exit
  ...
  %call2_40fe0a = call %struct.Memory* @sub_4006c0.printf_plt(%struct.State* %0, i64 %loadPC_40fe0a, %struct.Memory* %loadMem2_40fe0a)
  store %struct.Memory* %call2_40fe0a, %struct.Memory** %MEMORY
