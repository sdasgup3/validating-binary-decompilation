...
entry:
  ...
  %loadMem_40fd98 = load %struct.Memory*, %struct.Memory** %MEMORY
  ...
  store i64 %78, i64* %81
  store %struct.Memory* %loadMem_40fd98, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_40fd9c, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_40fdb8, %struct.Memory** %MEMORY
  %loadMem_40fdc2 = load %struct.Memory*, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_40fdc2, %struct.Memory** %MEMORY
  %loadMem_40fdc5 = load %struct.Memory*, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_40fdc5, %struct.Memory** %MEMORY
...
; <label>:260:                                    ; preds = %252
  ...
  %263 = call %struct.Memory* @__remill_error(%struct.State* nonnull dereferenceable(3376) %0, i64 %262, %struct.Memory* %loadMem_40fdca)
...
routine_ucomisd__xmm0___xmm1.exit:                ; preds = %260, %277
  %281 = phi %struct.Memory* [ %263, %260 ], [ %loadMem_40fdca, %277 ]
  ...
  %loadMem1_40fdd2 = load %struct.Memory*, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem1_40fdd2, %struct.Memory** %MEMORY
  %loadMem2_40fdd2 = load %struct.Memory*, %struct.Memory** %MEMORY
  %loadPC_40fdd2 = load i64, i64* %3
  %call2_40fdd2 = call %struct.Memory* @sub_40fd60._ZN28custom_multiple_constant_andImE8do_shiftEm(%struct.State* %0, i64 %loadPC_40fdd2, %struct.Memory* %loadMem2_40fdd2)
  store %struct.Memory* %call2_40fdd2, %struct.Memory** %MEMORY
  ...
  %loadMem_40fde6 = load %struct.Memory*, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_40fde6, %struct.Memory** %MEMORY
  %loadMem1_40fdea = load %struct.Memory*, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem1_40fdea, %struct.Memory** %MEMORY
  %loadMem2_40fdea = load %struct.Memory*, %struct.Memory** %MEMORY
  %loadPC_40fdea = load i64, i64* %3
  %call2_40fdea = call %struct.Memory* @sub_40fb10._Z15tolerance_equalImEbRT_S1_(%struct.State* %0, i64 %loadPC_40fdea, %struct.Memory* %loadMem2_40fdea)
  store %struct.Memory* %call2_40fdea, %struct.Memory** %MEMORY
  ...
  %loadBr_40fdf1 = load i8, i8* %BRANCH_TAKEN
  %cmpBr_40fdf1 = icmp eq i8 %loadBr_40fdf1, 1
  br i1 %cmpBr_40fdf1, label %block_.L_40fe12, label %block_40fdf7

block_40fdf7:                                     ; preds = %routine_ucomisd__xmm0___xmm1.exit
  ...
  %loadMem1_40fe0a = load %struct.Memory*, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem1_40fe0a, %struct.Memory** %MEMORY
  %loadMem2_40fe0a = load %struct.Memory*, %struct.Memory** %MEMORY
  %loadPC_40fe0a = load i64, i64* %3
  %486 = call %struct.Memory* @__remill_function_call(%struct.State* %0, i64 ptrtoint (i64 (i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64)* @printf to i64), %struct.Memory* %loadMem2_40fe0a)
  ...
  store %struct.Memory* %loadMem_40fe0f, %struct.Memory** %MEMORY
  br label %block_.L_40fe12

block_.L_40fe12:                                  ; preds = %block_40fdf7, %routine_ucomisd__xmm0___xmm1.exit
  ...
  store %struct.Memory* %loadMem_40fe12, %struct.Memory** %MEMORY
  ...
  ret %struct.Memory* %loadMem_40fe17
}
...
define %struct.Memory* @routine_movsd_0x2122e4__rip____xmm0(%struct.State* dereferenceable(3376), i64, %struct.Memory*) {
block_400488:
  %3 = getelementptr inbounds %struct.State, %struct.State* %0, i32 0, i32 6
  %4 = getelementptr inbounds %struct.GPR, %struct.GPR* %3, i32 0, i32 33
  %5 = getelementptr inbounds %struct.Reg, %struct.Reg* %4, i32 0, i32 0
...
define %struct.Memory* @routine_jne_.L_40fe12(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i8* %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) {
block_400488:
  %3 = getelementptr inbounds %struct.State, %struct.State* %0, i32 0, i32 6
  %4 = getelementptr inbounds %struct.GPR, %struct.GPR* %3, i32 0, i32 33
  %5 = getelementptr inbounds %struct.Reg, %struct.Reg* %4, i32 0, i32 0
