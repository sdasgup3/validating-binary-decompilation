...
@G_0x212634__rip__4258388_ = global %G_0x212634__rip__4258388__type zeroinitializer
@G_0x6220a8 = global %G_0x6220a8_type zeroinitializer
@G_0x8f84__rip__4258396_ = global %G_0x8f84__rip__4258396__type zeroinitializer
...
entry:
  ...
  store i64 %78, i64* %81
  store %struct.Memory* %loadMem_40fa48, %struct.Memory** %MEMORY
  ...
  %91 = load double, double* bitcast (%G_0x212634__rip__4258388__type* @G_0x212634__rip__4258388_ to double*)
  ...
  %104 = load double, double* bitcast (%G_0x8f84__rip__4258396__type* @G_0x8f84__rip__4258396_ to double*)
...
; <label>:256:                                    ; preds = %248
  ...
  %259 = call %struct.Memory* @__remill_error(%struct.State* nonnull dereferenceable(3376) %0, i64 %258, %struct.Memory* %loadMem_40fa7a)
...
routine_ucomisd__xmm0___xmm1.exit:                ; preds = %256, %273
  %277 = phi %struct.Memory* [ %259, %256 ], [ %loadMem_40fa7a, %273 ]
  ...
  store %struct.Memory* %loadMem_40fa7e, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem1_40fa82, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_40fa8f, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem1_40fa9a, %struct.Memory** %MEMORY
...
block_40faa7:                                     ; preds = %routine_ucomisd__xmm0___xmm1.exit
  ...
  store %struct.Memory* %loadMem1_40faba, %struct.Memory** %MEMORY
  %loadMem2_40faba = load %struct.Memory*, %struct.Memory** %MEMORY
  %loadPC_40faba = load i64, i64* %3
  %482 = call %struct.Memory* @__remill_function_call(%struct.State* %0, i64 ptrtoint (i64 (i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64)* @printf to i64), %struct.Memory* %loadMem2_40faba)
...
block_.L_40fac2:                                  ; preds = %block_40faa7, %routine_ucomisd__xmm0___xmm1.exit
  ...
  ret %struct.Memory* %loadMem_40fac7
}
...
define %struct.Memory* @routine_movsd_0x212634__rip____xmm0(%struct.State* dereferenceable(3376), i64, %struct.Memory*) {
block_400478:
  %3 = getelementptr inbounds %struct.State, %struct.State* %0, i32 0, i32 6
  %4 = getelementptr inbounds %struct.GPR, %struct.GPR* %3, i32 0, i32 33
  %5 = getelementptr inbounds %struct.Reg, %struct.Reg* %4, i32 0, i32 0
