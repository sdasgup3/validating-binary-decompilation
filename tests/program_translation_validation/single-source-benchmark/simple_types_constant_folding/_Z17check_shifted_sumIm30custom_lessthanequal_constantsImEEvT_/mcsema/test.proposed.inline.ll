...
block_4108e7:                                     ; preds = %routine_ucomisd__xmm0___xmm1.exit
  ...
  %call2_4108fa = call %struct.Memory* @sub_4006c0.printf_plt(%struct.State* %0, i64 %loadPC_4108fa, %struct.Memory* %loadMem2_4108fa)
  store %struct.Memory* %call2_4108fa, %struct.Memory** %MEMORY
