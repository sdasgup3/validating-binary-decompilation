...
@G_0x212044__rip__4259908_ = global %G_0x212044__rip__4259908__type zeroinitializer
@G_0x6220a8 = global %G_0x6220a8_type zeroinitializer
@G_0x8994__rip__4259916_ = global %G_0x8994__rip__4259916__type zeroinitializer
...
entry:
  ...
  store %struct.Memory* %loadMem_410030, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_410031, %struct.Memory** %MEMORY
  ...
  %91 = load double, double* bitcast (%G_0x212044__rip__4259908__type* @G_0x212044__rip__4259908_ to double*)
  ...
  store %struct.Memory* %loadMem_41003c, %struct.Memory** %MEMORY
  ...
  %104 = load double, double* bitcast (%G_0x8994__rip__4259916__type* @G_0x8994__rip__4259916_ to double*)
  ...
  store %struct.Memory* %loadMem_41004c, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_410053, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_410062, %struct.Memory** %MEMORY
...
; <label>:256:                                    ; preds = %248
  ...
  %259 = call %struct.Memory* @__remill_error(%struct.State* nonnull dereferenceable(3376) %0, i64 %258, %struct.Memory* %loadMem_41006a)
...
routine_ucomisd__xmm0___xmm1.exit:                ; preds = %256, %273
  %277 = phi %struct.Memory* [ %259, %256 ], [ %loadMem_41006a, %273 ]
  ...
  store %struct.Memory* %loadMem1_410072, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_410077, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_41007b, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem1_41008a, %struct.Memory** %MEMORY
...
block_410097:                                     ; preds = %routine_ucomisd__xmm0___xmm1.exit
  ...
  store %struct.Memory* %loadMem_410097, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem1_4100aa, %struct.Memory** %MEMORY
  %loadMem2_4100aa = load %struct.Memory*, %struct.Memory** %MEMORY
  %loadPC_4100aa = load i64, i64* %3
  %482 = call %struct.Memory* @__remill_function_call(%struct.State* %0, i64 ptrtoint (i64 (i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64)* @printf to i64), %struct.Memory* %loadMem2_4100aa)
  ...
  store %struct.Memory* %loadMem_4100af, %struct.Memory** %MEMORY
  br label %block_.L_4100b2

block_.L_4100b2:                                  ; preds = %block_410097, %routine_ucomisd__xmm0___xmm1.exit
  ...
  ret %struct.Memory* %loadMem_4100b7
}
...
define %struct.Memory* @routine_movsd_0x212044__rip____xmm0(%struct.State* dereferenceable(3376), i64, %struct.Memory*) {
block_400478:
  %3 = getelementptr inbounds %struct.State, %struct.State* %0, i32 0, i32 6
  %4 = getelementptr inbounds %struct.GPR, %struct.GPR* %3, i32 0, i32 33
  %5 = getelementptr inbounds %struct.Reg, %struct.Reg* %4, i32 0, i32 0
