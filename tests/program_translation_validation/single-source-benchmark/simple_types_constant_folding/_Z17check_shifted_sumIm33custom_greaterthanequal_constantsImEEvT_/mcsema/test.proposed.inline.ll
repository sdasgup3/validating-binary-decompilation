...
@G_0x211794__rip__4262132_ = global %G_0x211794__rip__4262132__type zeroinitializer
@G_0x6220a8 = global %G_0x6220a8_type zeroinitializer
@G_0x80e4__rip__4262140_ = global %G_0x80e4__rip__4262140__type zeroinitializer
...
declare %struct.Memory* @sub_4108d0._ZN33custom_greaterthanequal_constantsImE8do_shiftEm(%struct.State* noalias dereferenceable(3376), i64, %struct.Memory* noalias readnone returned)
...
entry:
  ...
  %91 = load double, double* bitcast (%G_0x211794__rip__4262132__type* @G_0x211794__rip__4262132_ to double*)
  ...
  %loadMem_4108f4 = load %struct.Memory*, %struct.Memory** %MEMORY
  ...
  %104 = load double, double* bitcast (%G_0x80e4__rip__4262140__type* @G_0x80e4__rip__4262140_ to double*)
  ...
  store %struct.Memory* %loadMem_4108f4, %struct.Memory** %MEMORY
...
; <label>:256:                                    ; preds = %248
  ...
  %259 = call %struct.Memory* @__remill_error(%struct.State* nonnull dereferenceable(3376) %0, i64 %258, %struct.Memory* %loadMem_41091a)
...
routine_ucomisd__xmm0___xmm1.exit:                ; preds = %256, %273
  %277 = phi %struct.Memory* [ %259, %256 ], [ %loadMem_41091a, %273 ]
  ...
  %loadMem1_410922 = load %struct.Memory*, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem1_410922, %struct.Memory** %MEMORY
  %loadMem2_410922 = load %struct.Memory*, %struct.Memory** %MEMORY
  %loadPC_410922 = load i64, i64* %3
  %call2_410922 = call %struct.Memory* @sub_4108d0._ZN33custom_greaterthanequal_constantsImE8do_shiftEm(%struct.State* %0, i64 %loadPC_410922, %struct.Memory* %loadMem2_410922)
  store %struct.Memory* %call2_410922, %struct.Memory** %MEMORY
  %loadMem_410927 = load %struct.Memory*, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_410927, %struct.Memory** %MEMORY
  ...
  %loadMem1_41093a = load %struct.Memory*, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem1_41093a, %struct.Memory** %MEMORY
  %loadMem2_41093a = load %struct.Memory*, %struct.Memory** %MEMORY
  %loadPC_41093a = load i64, i64* %3
  %call2_41093a = call %struct.Memory* @sub_40fad0._Z15tolerance_equalImEbRT_S1_(%struct.State* %0, i64 %loadPC_41093a, %struct.Memory* %loadMem2_41093a)
  store %struct.Memory* %call2_41093a, %struct.Memory** %MEMORY
  ...
  %loadBr_410941 = load i8, i8* %BRANCH_TAKEN
  %cmpBr_410941 = icmp eq i8 %loadBr_410941, 1
  br i1 %cmpBr_410941, label %block_.L_410962, label %block_410947
...
block_410947:                                     ; preds = %routine_ucomisd__xmm0___xmm1.exit
  ...
  %loadMem1_41095a = load %struct.Memory*, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem1_41095a, %struct.Memory** %MEMORY
  %loadMem2_41095a = load %struct.Memory*, %struct.Memory** %MEMORY
  %loadPC_41095a = load i64, i64* %3
  %482 = call %struct.Memory* @__remill_function_call(%struct.State* %0, i64 ptrtoint (i64 (i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64)* @printf to i64), %struct.Memory* %loadMem2_41095a)
...
block_.L_410962:                                  ; preds = %block_410947, %routine_ucomisd__xmm0___xmm1.exit
  ...
  ret %struct.Memory* %loadMem_410967
}
...
define %struct.Memory* @routine_movsd_0x211794__rip____xmm0(%struct.State* dereferenceable(3376), i64, %struct.Memory*) {
block_400478:
  %3 = getelementptr inbounds %struct.State, %struct.State* %0, i32 0, i32 6
  %4 = getelementptr inbounds %struct.GPR, %struct.GPR* %3, i32 0, i32 33
  %5 = getelementptr inbounds %struct.Reg, %struct.Reg* %4, i32 0, i32 0
  ...
  %9 = load i64, i64* %PC
  %10 = ptrtoint %G_0x211794__rip__4262132__type* @G_0x211794__rip__4262132_ to i64
  %11 = load i64, i64* %PC
  %12 = add i64 %11, 8
  store i64 %12, i64* %PC
...
block_400478:
  ...
  %9 = load i64, i64* %PC
  %10 = ptrtoint %G_0x80e4__rip__4262140__type* @G_0x80e4__rip__4262140_ to i64
  %11 = load i64, i64* %PC
  %12 = add i64 %11, 8
  store i64 %12, i64* %PC
  %13 = inttoptr i64 %10 to double*
...
define %struct.Memory* @routine_jne_.L_410962(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i8* %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) {
block_400478:
  %3 = getelementptr inbounds %struct.State, %struct.State* %0, i32 0, i32 6
  %4 = getelementptr inbounds %struct.GPR, %struct.GPR* %3, i32 0, i32 33
  %5 = getelementptr inbounds %struct.Reg, %struct.Reg* %4, i32 0, i32 0
