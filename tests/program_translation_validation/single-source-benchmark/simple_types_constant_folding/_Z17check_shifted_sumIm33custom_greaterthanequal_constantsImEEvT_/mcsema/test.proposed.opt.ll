...
%G_0x211744__rip__type = type <{ [8 x i8] }>
%G_0x6220a8_type = type <{ [4 x i8] }>
%G_0x80e4__rip__type = type <{ [8 x i8] }>
...
@G_0x211744__rip_ = global %G_0x211744__rip__type zeroinitializer
@G_0x6220a8 = local_unnamed_addr global %G_0x6220a8_type zeroinitializer
@G_0x80e4__rip_ = global %G_0x80e4__rip__type zeroinitializer
...
entry:
  ...
  %44 = add i64 %43, ptrtoint (%G_0x211744__rip__type* @G_0x211744__rip_ to i64)
  %45 = add i64 %43, 8
  ...
  %51 = add i64 %43, add (i64 ptrtoint (%G_0x80e4__rip__type* @G_0x80e4__rip_ to i64), i64 8)
  %52 = add i64 %43, 16
...
routine_ucomisd__xmm0___xmm1.exit:                ; preds = %119, %107
  ...
  %call2_410972 = tail call %struct.Memory* @sub_410920._ZN33custom_greaterthanequal_constantsImE8do_shiftEm(%struct.State* nonnull %0, i64 %131, %struct.Memory* %127)
  ...
  %call2_41098a = tail call %struct.Memory* @sub_40fb20._Z15tolerance_equalImEbRT_S1_(%struct.State* nonnull %0, i64 %161, %struct.Memory* %call2_410972)
  ...
  br i1 %174, label %block_.L_4109b2, label %block_410997

block_410997:                                     ; preds = %routine_ucomisd__xmm0___xmm1.exit
  ...
  %183 = tail call %struct.Memory* @__remill_function_call(%struct.State* nonnull %0, i64 ptrtoint (i64 (i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64)* @printf to i64), %struct.Memory* %call2_41098a)
  ...
  br label %block_.L_4109b2

block_.L_4109b2:                                  ; preds = %block_410997, %routine_ucomisd__xmm0___xmm1.exit
  %190 = phi i64 [ %175, %routine_ucomisd__xmm0___xmm1.exit ], [ %.pre5, %block_410997 ]
  %MEMORY.0 = phi %struct.Memory* [ %call2_41098a, %routine_ucomisd__xmm0___xmm1.exit ], [ %183, %block_410997 ]
...
; Function Attrs: alwaysinline norecurse nounwind
define %struct.Memory* @routine_movsd_0x211744__rip____xmm0(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, ptrtoint (%G_0x211744__rip__type* @G_0x211744__rip_ to i64)
  %5 = add i64 %3, 8
  store i64 %5, i64* %PC, align 8
...
; Function Attrs: alwaysinline norecurse nounwind
define %struct.Memory* @routine_movsd_0x80e4__rip____xmm1(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, ptrtoint (%G_0x80e4__rip__type* @G_0x80e4__rip_ to i64)
  %5 = add i64 %3, 8
  store i64 %5, i64* %PC, align 8
  %6 = inttoptr i64 %4 to i64*
  %7 = load i64, i64* %6, align 8
...
; Function Attrs: alwaysinline norecurse nounwind
define %struct.Memory* @routine_jne_.L_4109b2(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i8* nocapture %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
