...
block_4102e7:                                     ; preds = %routine_ucomisd__xmm0___xmm1.exit
  ...
  %call2_4102fa = call %struct.Memory* @sub_4006c0.printf_plt(%struct.State* %0, i64 %loadPC_4102fa, %struct.Memory* %loadMem2_4102fa)
  store %struct.Memory* %call2_4102fa, %struct.Memory** %MEMORY
