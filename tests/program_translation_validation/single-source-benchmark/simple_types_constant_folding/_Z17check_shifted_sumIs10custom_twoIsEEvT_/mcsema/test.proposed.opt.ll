...
entry:
  ...
  %47 = add i64 %46, ptrtoint (%G_0x20bce1__rip__type* @G_0x20bce1__rip_ to i64)
  %48 = add i64 %46, 8
  ...
  %call2_4163b1 = tail call %struct.Memory* @sub_416370._ZN10custom_twoIsE8do_shiftEs(%struct.State* %0, i64 %64, %struct.Memory* %2)
  ...
  %call2_4163ce = tail call %struct.Memory* @sub_4151c0._Z15tolerance_equalIsEbRT_S1_(%struct.State* %0, i64 %93, %struct.Memory* %call2_4163b1)
  ...
  br i1 %106, label %block_.L_4163f6, label %block_4163db
...
block_4163db:                                     ; preds = %entry
  ...
  %115 = tail call %struct.Memory* @__remill_function_call(%struct.State* nonnull %0, i64 ptrtoint (i64 (i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64)* @printf to i64), %struct.Memory* %call2_4163ce)
...
block_.L_4163f6:                                  ; preds = %block_4163db, %entry
  %122 = phi i64 [ %107, %entry ], [ %.pre, %block_4163db ]
  %MEMORY.0 = phi %struct.Memory* [ %call2_4163ce, %entry ], [ %115, %block_4163db ]
