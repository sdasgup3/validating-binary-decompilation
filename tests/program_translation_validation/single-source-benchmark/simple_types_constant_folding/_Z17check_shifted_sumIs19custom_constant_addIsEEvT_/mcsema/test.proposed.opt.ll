...
entry:
  ...
  %47 = add i64 %46, ptrtoint (%G_0x20c551__rip__type* @G_0x20c551__rip_ to i64)
  %48 = add i64 %46, 8
  ...
  %call2_415b41 = tail call %struct.Memory* @sub_415b00._ZN19custom_constant_addIsE8do_shiftEs(%struct.State* %0, i64 %64, %struct.Memory* %2)
  ...
  %call2_415b5e = tail call %struct.Memory* @sub_4151c0._Z15tolerance_equalIsEbRT_S1_(%struct.State* %0, i64 %93, %struct.Memory* %call2_415b41)
  ...
  br i1 %106, label %block_.L_415b86, label %block_415b6b
...
block_415b6b:                                     ; preds = %entry
  ...
  %115 = tail call %struct.Memory* @__remill_function_call(%struct.State* nonnull %0, i64 ptrtoint (i64 (i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64)* @printf to i64), %struct.Memory* %call2_415b5e)
...
block_.L_415b86:                                  ; preds = %block_415b6b, %entry
  %122 = phi i64 [ %107, %entry ], [ %.pre, %block_415b6b ]
  %MEMORY.0 = phi %struct.Memory* [ %call2_415b5e, %entry ], [ %115, %block_415b6b ]
