...
entry:
  ...
  %47 = add i64 %46, ptrtoint (%G_0x20c681__rip__type* @G_0x20c681__rip_ to i64)
  %48 = add i64 %46, 8
  ...
  %call2_415a11 = tail call %struct.Memory* @sub_4159d0._ZN19custom_constant_subIsE8do_shiftEs(%struct.State* %0, i64 %64, %struct.Memory* %2)
  ...
  %call2_415a2e = tail call %struct.Memory* @sub_4151c0._Z15tolerance_equalIsEbRT_S1_(%struct.State* %0, i64 %93, %struct.Memory* %call2_415a11)
  ...
  br i1 %106, label %block_.L_415a56, label %block_415a3b
...
block_415a3b:                                     ; preds = %entry
  ...
  %115 = tail call %struct.Memory* @__remill_function_call(%struct.State* nonnull %0, i64 ptrtoint (i64 (i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64)* @printf to i64), %struct.Memory* %call2_415a2e)
...
block_.L_415a56:                                  ; preds = %block_415a3b, %entry
  %122 = phi i64 [ %107, %entry ], [ %.pre, %block_415a3b ]
  %MEMORY.0 = phi %struct.Memory* [ %call2_415a2e, %entry ], [ %115, %block_415a3b ]
