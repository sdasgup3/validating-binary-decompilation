...
define %struct.Memory* @_Z17check_shifted_sumIs19custom_constant_xorIsEEvT_(%struct.State* noalias, i64, %struct.Memory* noalias) #2 {
entry:
  ...
  store %struct.Memory* %loadMem_415241, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_415248, %struct.Memory** %MEMORY
  ...
  store i16 %91, i16* %95
  store %struct.Memory* %loadMem_41524b, %struct.Memory** %MEMORY
  %loadMem_41524f = load %struct.Memory*, %struct.Memory** %MEMORY
  ...
  %103 = add i64 %102, ptrtoint (%G_0x20ce31__rip__type* @G_0x20ce31__rip_ to i64)
  ...
  store %struct.Memory* %loadMem_41524f, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_415257, %struct.Memory** %MEMORY
  ...
  %loadMem1_415261 = load %struct.Memory*, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem1_415261, %struct.Memory** %MEMORY
  %loadMem2_415261 = load %struct.Memory*, %struct.Memory** %MEMORY
  %loadPC_415261 = load i64, i64* %3
  %call2_415261 = call %struct.Memory* @sub_415220._ZN19custom_constant_xorIsE8do_shiftEs(%struct.State* %0, i64 %loadPC_415261, %struct.Memory* %loadMem2_415261)
  store %struct.Memory* %call2_415261, %struct.Memory** %MEMORY
  %loadMem_415266 = load %struct.Memory*, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_415266, %struct.Memory** %MEMORY
  %loadMem_41526a = load %struct.Memory*, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_41526a, %struct.Memory** %MEMORY
  %loadMem_41526e = load %struct.Memory*, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_41526e, %struct.Memory** %MEMORY
  %loadMem_415271 = load %struct.Memory*, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_415271, %struct.Memory** %MEMORY
  ...
  %loadMem1_41527e = load %struct.Memory*, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem1_41527e, %struct.Memory** %MEMORY
  %loadMem2_41527e = load %struct.Memory*, %struct.Memory** %MEMORY
  %loadPC_41527e = load i64, i64* %3
  %call2_41527e = call %struct.Memory* @sub_4151c0._Z15tolerance_equalIsEbRT_S1_(%struct.State* %0, i64 %loadPC_41527e, %struct.Memory* %loadMem2_41527e)
  store %struct.Memory* %call2_41527e, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_415283, %struct.Memory** %MEMORY
  ...
  %loadBr_415285 = load i8, i8* %BRANCH_TAKEN
  %cmpBr_415285 = icmp eq i8 %loadBr_415285, 1
  br i1 %cmpBr_415285, label %block_.L_4152a6, label %block_41528b
...
block_41528b:                                     ; preds = %entry
  ...
  store %struct.Memory* %loadMem_41528b, %struct.Memory** %MEMORY
  %loadMem_415295 = load %struct.Memory*, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_415295, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem1_41529e, %struct.Memory** %MEMORY
  %loadMem2_41529e = load %struct.Memory*, %struct.Memory** %MEMORY
  %loadPC_41529e = load i64, i64* %3
  %378 = call %struct.Memory* @__remill_function_call(%struct.State* %0, i64 ptrtoint (i64 (i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64)* @printf to i64), %struct.Memory* %loadMem2_41529e)
...
block_.L_4152a6:                                  ; preds = %block_41528b, %entry
  ...
  ret %struct.Memory* %loadMem_4152ab
}
...
; Function Attrs: alwaysinline
define %struct.Memory* @routine_movsd_0x20ce31__rip____xmm0(%struct.State* dereferenceable(3376), i64, %struct.Memory*) #2 {
block_400488:
  %3 = getelementptr inbounds %struct.State, %struct.State* %0, i32 0, i32 6
  %4 = getelementptr inbounds %struct.GPR, %struct.GPR* %3, i32 0, i32 33
  %5 = getelementptr inbounds %struct.Reg, %struct.Reg* %4, i32 0, i32 0
  ...
  %9 = load i64, i64* %PC
  %10 = add i64 %9, ptrtoint (%G_0x20ce31__rip__type* @G_0x20ce31__rip_ to i64)
  %11 = load i64, i64* %PC
  %12 = add i64 %11, 8
  store i64 %12, i64* %PC
...
; Function Attrs: alwaysinline
define %struct.Memory* @routine_jne_.L_4152a6(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i8* %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) #2 {
block_400488:
  %3 = getelementptr inbounds %struct.State, %struct.State* %0, i32 0, i32 6
  %4 = getelementptr inbounds %struct.GPR, %struct.GPR* %3, i32 0, i32 33
  %5 = getelementptr inbounds %struct.Reg, %struct.Reg* %4, i32 0, i32 0
