...
entry:
  ...
  %47 = add i64 %46, ptrtoint (%G_0x20ce31__rip__type* @G_0x20ce31__rip_ to i64)
  %48 = add i64 %46, 8
  ...
  %call2_415261 = tail call %struct.Memory* @sub_415220._ZN19custom_constant_xorIsE8do_shiftEs(%struct.State* %0, i64 %64, %struct.Memory* %2)
  ...
  %call2_41527e = tail call %struct.Memory* @sub_4151c0._Z15tolerance_equalIsEbRT_S1_(%struct.State* %0, i64 %93, %struct.Memory* %call2_415261)
  ...
  br i1 %106, label %block_.L_4152a6, label %block_41528b
...
block_41528b:                                     ; preds = %entry
  ...
  %115 = tail call %struct.Memory* @__remill_function_call(%struct.State* nonnull %0, i64 ptrtoint (i64 (i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64)* @printf to i64), %struct.Memory* %call2_41527e)
...
block_.L_4152a6:                                  ; preds = %block_41528b, %entry
  %122 = phi i64 [ %107, %entry ], [ %.pre, %block_41528b ]
  %MEMORY.0 = phi %struct.Memory* [ %call2_41527e, %entry ], [ %115, %block_41528b ]
