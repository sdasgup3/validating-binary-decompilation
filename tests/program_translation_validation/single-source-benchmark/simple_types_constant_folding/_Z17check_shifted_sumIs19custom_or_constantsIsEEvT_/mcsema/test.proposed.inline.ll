...
@G_0x20c481__rip__4283399_ = global %G_0x20c481__rip__4283399__type zeroinitializer
...
define %struct.Memory* @_Z17check_shifted_sumIs19custom_or_constantsIsEEvT_(%struct.State* noalias, i64, %struct.Memory* noalias) #2 {
entry:
  ...
  store %struct.Memory* %loadMem_415bf8, %struct.Memory** %MEMORY
  ...
  %105 = load double, double* bitcast (%G_0x20c481__rip__4283399__type* @G_0x20c481__rip__4283399_ to double*)
  ...
  store %struct.Memory* %loadMem_415c0e, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem1_415c11, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_415c1e, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem1_415c2e, %struct.Memory** %MEMORY
...
block_415c3b:                                     ; preds = %entry
  ...
  store %struct.Memory* %loadMem_415c3b, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_415c45, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem1_415c4e, %struct.Memory** %MEMORY
  %loadMem2_415c4e = load %struct.Memory*, %struct.Memory** %MEMORY
  %loadPC_415c4e = load i64, i64* %3
  %376 = call %struct.Memory* @__remill_function_call(%struct.State* %0, i64 ptrtoint (i64 (i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64)* @printf to i64), %struct.Memory* %loadMem2_415c4e)
...
block_.L_415c56:                                  ; preds = %block_415c3b, %entry
  ...
  store %struct.Memory* %loadMem_415c56, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_415c5b, %struct.Memory** %MEMORY
  ret %struct.Memory* %loadMem_415c5b
}
...
define %struct.Memory* @routine_movsd_0x20c481__rip____xmm0(%struct.State* dereferenceable(3376), i64, %struct.Memory*) {
block_400478:
  %3 = getelementptr inbounds %struct.State, %struct.State* %0, i32 0, i32 6
  %4 = getelementptr inbounds %struct.GPR, %struct.GPR* %3, i32 0, i32 33
  %5 = getelementptr inbounds %struct.Reg, %struct.Reg* %4, i32 0, i32 0
