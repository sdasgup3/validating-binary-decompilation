...
entry:
  ...
  %47 = add i64 %46, ptrtoint (%G_0x20c3a1__rip__type* @G_0x20c3a1__rip_ to i64)
  %48 = add i64 %46, 8
  ...
  %call2_415cf1 = tail call %struct.Memory* @sub_415cb0._ZN20custom_and_constantsIsE8do_shiftEs(%struct.State* %0, i64 %64, %struct.Memory* %2)
  ...
  %call2_415d0e = tail call %struct.Memory* @sub_4151c0._Z15tolerance_equalIsEbRT_S1_(%struct.State* %0, i64 %93, %struct.Memory* %call2_415cf1)
  ...
  br i1 %106, label %block_.L_415d36, label %block_415d1b
...
block_415d1b:                                     ; preds = %entry
  ...
  %115 = tail call %struct.Memory* @__remill_function_call(%struct.State* nonnull %0, i64 ptrtoint (i64 (i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64)* @printf to i64), %struct.Memory* %call2_415d0e)
...
block_.L_415d36:                                  ; preds = %block_415d1b, %entry
  %122 = phi i64 [ %107, %entry ], [ %.pre, %block_415d1b ]
  %MEMORY.0 = phi %struct.Memory* [ %call2_415d0e, %entry ], [ %115, %block_415d1b ]
