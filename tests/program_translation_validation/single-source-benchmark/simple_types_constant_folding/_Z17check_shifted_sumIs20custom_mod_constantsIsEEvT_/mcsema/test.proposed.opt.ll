...
entry:
  ...
  %47 = add i64 %46, ptrtoint (%G_0x20bfb1__rip__type* @G_0x20bfb1__rip_ to i64)
  %48 = add i64 %46, 8
  ...
  %call2_4160e1 = tail call %struct.Memory* @sub_4160a0._ZN20custom_mod_constantsIsE8do_shiftEs(%struct.State* %0, i64 %64, %struct.Memory* %2)
  ...
  %call2_4160fe = tail call %struct.Memory* @sub_4151c0._Z15tolerance_equalIsEbRT_S1_(%struct.State* %0, i64 %93, %struct.Memory* %call2_4160e1)
  ...
  br i1 %106, label %block_.L_416126, label %block_41610b
...
block_41610b:                                     ; preds = %entry
  ...
  %115 = tail call %struct.Memory* @__remill_function_call(%struct.State* nonnull %0, i64 ptrtoint (i64 (i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64)* @printf to i64), %struct.Memory* %call2_4160fe)
...
block_.L_416126:                                  ; preds = %block_41610b, %entry
  %122 = phi i64 [ %107, %entry ], [ %.pre, %block_41610b ]
  %MEMORY.0 = phi %struct.Memory* [ %call2_4160fe, %entry ], [ %115, %block_41610b ]
