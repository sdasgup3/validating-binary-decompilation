...
block_415beb:                                     ; preds = %entry
  ...
  %call2_415bfe = call %struct.Memory* @sub_4006c0.printf_plt(%struct.State* %0, i64 %loadPC_415bfe, %struct.Memory* %loadMem2_415bfe)
  store %struct.Memory* %call2_415bfe, %struct.Memory** %MEMORY
