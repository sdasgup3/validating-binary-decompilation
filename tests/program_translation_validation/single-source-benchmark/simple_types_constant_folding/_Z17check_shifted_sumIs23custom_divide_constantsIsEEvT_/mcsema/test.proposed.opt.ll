...
entry:
  ...
  %47 = add i64 %46, ptrtoint (%G_0x20bf21__rip__type* @G_0x20bf21__rip_ to i64)
  %48 = add i64 %46, 8
  ...
  %call2_416171 = tail call %struct.Memory* @sub_416130._ZN23custom_divide_constantsIsE8do_shiftEs(%struct.State* %0, i64 %64, %struct.Memory* %2)
  ...
  %call2_41618e = tail call %struct.Memory* @sub_4151c0._Z15tolerance_equalIsEbRT_S1_(%struct.State* %0, i64 %93, %struct.Memory* %call2_416171)
  ...
  br i1 %106, label %block_.L_4161b6, label %block_41619b
...
block_41619b:                                     ; preds = %entry
  ...
  %115 = tail call %struct.Memory* @__remill_function_call(%struct.State* nonnull %0, i64 ptrtoint (i64 (i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64)* @printf to i64), %struct.Memory* %call2_41618e)
...
block_.L_4161b6:                                  ; preds = %block_41619b, %entry
  %122 = phi i64 [ %107, %entry ], [ %.pre, %block_41619b ]
  %MEMORY.0 = phi %struct.Memory* [ %call2_41618e, %entry ], [ %115, %block_41619b ]
