...
entry:
  ...
  %47 = add i64 %46, ptrtoint (%G_0x20c7b1__rip__type* @G_0x20c7b1__rip_ to i64)
  %48 = add i64 %46, 8
  ...
  %call2_4158e1 = tail call %struct.Memory* @sub_4158a0._ZN24custom_constant_multiplyIsE8do_shiftEs(%struct.State* %0, i64 %64, %struct.Memory* %2)
  ...
  %call2_4158fe = tail call %struct.Memory* @sub_4151c0._Z15tolerance_equalIsEbRT_S1_(%struct.State* %0, i64 %93, %struct.Memory* %call2_4158e1)
  ...
  br i1 %106, label %block_.L_415926, label %block_41590b
...
block_41590b:                                     ; preds = %entry
  ...
  %115 = tail call %struct.Memory* @__remill_function_call(%struct.State* nonnull %0, i64 ptrtoint (i64 (i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64)* @printf to i64), %struct.Memory* %call2_4158fe)
...
block_.L_415926:                                  ; preds = %block_41590b, %entry
  %122 = phi i64 [ %107, %entry ], [ %.pre, %block_41590b ]
  %MEMORY.0 = phi %struct.Memory* [ %call2_4158fe, %entry ], [ %115, %block_41590b ]
