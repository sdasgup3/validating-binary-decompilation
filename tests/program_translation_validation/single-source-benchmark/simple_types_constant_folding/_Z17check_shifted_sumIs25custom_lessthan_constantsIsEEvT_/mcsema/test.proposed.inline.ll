...
block_415ebb:                                     ; preds = %entry
  ...
  %call2_415ece = call %struct.Memory* @sub_4006c0.printf_plt(%struct.State* %0, i64 %loadPC_415ece, %struct.Memory* %loadMem2_415ece)
  store %struct.Memory* %call2_415ece, %struct.Memory** %MEMORY
