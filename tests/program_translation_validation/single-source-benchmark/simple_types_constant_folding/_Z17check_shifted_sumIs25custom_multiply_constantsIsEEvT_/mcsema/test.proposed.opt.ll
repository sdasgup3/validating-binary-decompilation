...
entry:
  ...
  %47 = add i64 %46, ptrtoint (%G_0x20be91__rip__type* @G_0x20be91__rip_ to i64)
  %48 = add i64 %46, 8
  ...
  %call2_416201 = tail call %struct.Memory* @sub_4161c0._ZN25custom_multiply_constantsIsE8do_shiftEs(%struct.State* %0, i64 %64, %struct.Memory* %2)
  ...
  %call2_41621e = tail call %struct.Memory* @sub_4151c0._Z15tolerance_equalIsEbRT_S1_(%struct.State* %0, i64 %93, %struct.Memory* %call2_416201)
  ...
  br i1 %106, label %block_.L_416246, label %block_41622b
...
block_41622b:                                     ; preds = %entry
  ...
  %115 = tail call %struct.Memory* @__remill_function_call(%struct.State* nonnull %0, i64 ptrtoint (i64 (i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64)* @printf to i64), %struct.Memory* %call2_41621e)
...
block_.L_416246:                                  ; preds = %block_41622b, %entry
  %122 = phi i64 [ %107, %entry ], [ %.pre, %block_41622b ]
  %MEMORY.0 = phi %struct.Memory* [ %call2_41621e, %entry ], [ %115, %block_41622b ]
