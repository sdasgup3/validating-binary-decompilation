...
entry:
  ...
  %47 = add i64 %46, ptrtoint (%G_0x20c0d1__rip__type* @G_0x20c0d1__rip_ to i64)
  %48 = add i64 %46, 8
  ...
  %call2_415fc1 = tail call %struct.Memory* @sub_415f80._ZN25custom_notequal_constantsIsE8do_shiftEs(%struct.State* %0, i64 %64, %struct.Memory* %2)
  ...
  %call2_415fde = tail call %struct.Memory* @sub_4151c0._Z15tolerance_equalIsEbRT_S1_(%struct.State* %0, i64 %93, %struct.Memory* %call2_415fc1)
  ...
  br i1 %106, label %block_.L_416006, label %block_415feb
...
block_415feb:                                     ; preds = %entry
  ...
  %115 = tail call %struct.Memory* @__remill_function_call(%struct.State* nonnull %0, i64 ptrtoint (i64 (i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64)* @printf to i64), %struct.Memory* %call2_415fde)
...
block_.L_416006:                                  ; preds = %block_415feb, %entry
  %122 = phi i64 [ %107, %entry ], [ %.pre, %block_415feb ]
  %MEMORY.0 = phi %struct.Memory* [ %call2_415fde, %entry ], [ %115, %block_415feb ]
