...
entry:
  ...
  store %struct.Memory* %loadMem_4152e7, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem1_4152f1, %struct.Memory** %MEMORY
...
block_41531b:                                     ; preds = %entry
  ...
  store %struct.Memory* %loadMem1_41532e, %struct.Memory** %MEMORY
  %loadMem2_41532e = load %struct.Memory*, %struct.Memory** %MEMORY
  %loadPC_41532e = load i64, i64* %3
  %378 = call %struct.Memory* @__remill_function_call(%struct.State* %0, i64 ptrtoint (i64 (i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64)* @printf to i64), %struct.Memory* %loadMem2_41532e)
...
block_.L_415336:                                  ; preds = %block_41531b, %entry
  ...
  ret %struct.Memory* %loadMem_41533b
}
...
define %struct.Memory* @routine_movsd_0x20cda1__rip____xmm0(%struct.State* dereferenceable(3376), i64, %struct.Memory*) {
block_400488:
  %3 = getelementptr inbounds %struct.State, %struct.State* %0, i32 0, i32 6
  %4 = getelementptr inbounds %struct.GPR, %struct.GPR* %3, i32 0, i32 33
  %5 = getelementptr inbounds %struct.Reg, %struct.Reg* %4, i32 0, i32 0
