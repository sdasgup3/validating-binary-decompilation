...
@G_0x20cde1__rip__4280999_ = global %G_0x20cde1__rip__4280999__type zeroinitializer
...
entry:
  ...
  store i16 %91, i16* %95
  store %struct.Memory* %loadMem_41529b, %struct.Memory** %MEMORY
  ...
  %105 = load double, double* bitcast (%G_0x20cde1__rip__4280999__type* @G_0x20cde1__rip__4280999_ to double*)
  ...
  store %struct.Memory* %loadMem1_4152b1, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_4152ca, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem1_4152ce, %struct.Memory** %MEMORY
...
block_4152db:                                     ; preds = %entry
  ...
  store %struct.Memory* %loadMem_4152db, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem1_4152ee, %struct.Memory** %MEMORY
  %loadMem2_4152ee = load %struct.Memory*, %struct.Memory** %MEMORY
  %loadPC_4152ee = load i64, i64* %3
  %376 = call %struct.Memory* @__remill_function_call(%struct.State* %0, i64 ptrtoint (i64 (i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64)* @printf to i64), %struct.Memory* %loadMem2_4152ee)
...
block_.L_4152f6:                                  ; preds = %block_4152db, %entry
  ...
  ret %struct.Memory* %loadMem_4152fb
}
...
define %struct.Memory* @routine_movsd_0x20cde1__rip____xmm0(%struct.State* dereferenceable(3376), i64, %struct.Memory*) {
block_400478:
  %3 = getelementptr inbounds %struct.State, %struct.State* %0, i32 0, i32 6
  %4 = getelementptr inbounds %struct.GPR, %struct.GPR* %3, i32 0, i32 33
  %5 = getelementptr inbounds %struct.Reg, %struct.Reg* %4, i32 0, i32 0
