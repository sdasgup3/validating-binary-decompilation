...
declare %struct.Memory* @sub_415ee0._ZN28custom_greaterthan_constantsIsE8do_shiftEs(%struct.State* dereferenceable(3376), i64, %struct.Memory*) local_unnamed_addr
