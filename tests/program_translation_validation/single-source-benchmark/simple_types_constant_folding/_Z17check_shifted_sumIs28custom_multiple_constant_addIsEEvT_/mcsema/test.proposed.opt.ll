...
declare %struct.Memory* @sub_415a50._ZN28custom_multiple_constant_addIsE8do_shiftEs(%struct.State* dereferenceable(3376), i64, %struct.Memory*) local_unnamed_addr
