...
@G_0x20c711__rip_ = global %G_0x20c711__rip__type zeroinitializer
...
define %struct.Memory* @_Z17check_shifted_sumIs28custom_multiple_constant_subIsEEvT_(%struct.State* noalias, i64, %struct.Memory* noalias) local_unnamed_addr #1 {
entry:
  ...
  %47 = add i64 %46, ptrtoint (%G_0x20c711__rip__type* @G_0x20c711__rip_ to i64)
  %48 = add i64 %46, 8
  ...
  %call2_415981 = tail call %struct.Memory* @sub_415930._ZN28custom_multiple_constant_subIsE8do_shiftEs(%struct.State* %0, i64 %64, %struct.Memory* %2)
  ...
  %call2_41599e = tail call %struct.Memory* @sub_4151c0._Z15tolerance_equalIsEbRT_S1_(%struct.State* %0, i64 %93, %struct.Memory* %call2_415981)
  ...
  br i1 %106, label %block_.L_4159c6, label %block_4159ab

block_4159ab:                                     ; preds = %entry
  ...
  %115 = tail call %struct.Memory* @__remill_function_call(%struct.State* nonnull %0, i64 ptrtoint (i64 (i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64)* @printf to i64), %struct.Memory* %call2_41599e)
...
block_.L_4159c6:                                  ; preds = %block_4159ab, %entry
  %122 = phi i64 [ %107, %entry ], [ %.pre, %block_4159ab ]
  %MEMORY.0 = phi %struct.Memory* [ %call2_41599e, %entry ], [ %115, %block_4159ab ]
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_movsd_0x20c711__rip____xmm0(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, ptrtoint (%G_0x20c711__rip__type* @G_0x20c711__rip_ to i64)
  %5 = add i64 %3, 8
  store i64 %5, i64* %PC, align 8
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_jne_.L_4159c6(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i8* nocapture %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
