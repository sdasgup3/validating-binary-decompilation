...
entry:
  ...
  store %struct.Memory* %loadMem1_415161, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem1_41517e, %struct.Memory** %MEMORY
...
block_41518b:                                     ; preds = %entry
  ...
  store %struct.Memory* %loadMem_41519c, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem1_41519e, %struct.Memory** %MEMORY
  %loadMem2_41519e = load %struct.Memory*, %struct.Memory** %MEMORY
  %loadPC_41519e = load i64, i64* %3
  %378 = call %struct.Memory* @__remill_function_call(%struct.State* %0, i64 ptrtoint (i64 (i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64)* @printf to i64), %struct.Memory* %loadMem2_41519e)
...
block_.L_4151a6:                                  ; preds = %block_41518b, %entry
  ...
  ret %struct.Memory* %loadMem_4151ab
}
...
define %struct.Memory* @routine_movsd_0x20cf31__rip____xmm0(%struct.State* dereferenceable(3376), i64, %struct.Memory*) {
block_400488:
  %3 = getelementptr inbounds %struct.State, %struct.State* %0, i32 0, i32 6
  %4 = getelementptr inbounds %struct.GPR, %struct.GPR* %3, i32 0, i32 33
  %5 = getelementptr inbounds %struct.Reg, %struct.Reg* %4, i32 0, i32 0
