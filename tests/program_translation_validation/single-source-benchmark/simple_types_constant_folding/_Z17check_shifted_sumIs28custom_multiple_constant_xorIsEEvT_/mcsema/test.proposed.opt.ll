...
@G_0x20cf21__rip_ = global %G_0x20cf21__rip__type zeroinitializer
...
entry:
  ...
  %47 = add i64 %46, ptrtoint (%G_0x20cf21__rip__type* @G_0x20cf21__rip_ to i64)
  %48 = add i64 %46, 8
  ...
  %call2_415171 = tail call %struct.Memory* @sub_415120._ZN28custom_multiple_constant_xorIsE8do_shiftEs(%struct.State* %0, i64 %64, %struct.Memory* %2)
  ...
  %call2_41518e = tail call %struct.Memory* @sub_4151c0._Z15tolerance_equalIsEbRT_S1_(%struct.State* %0, i64 %93, %struct.Memory* %call2_415171)
  ...
  br i1 %106, label %block_.L_4151b6, label %block_41519b

block_41519b:                                     ; preds = %entry
  ...
  %115 = tail call %struct.Memory* @__remill_function_call(%struct.State* nonnull %0, i64 ptrtoint (i64 (i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64)* @printf to i64), %struct.Memory* %call2_41518e)
...
block_.L_4151b6:                                  ; preds = %block_41519b, %entry
  %122 = phi i64 [ %107, %entry ], [ %.pre, %block_41519b ]
  %MEMORY.0 = phi %struct.Memory* [ %call2_41518e, %entry ], [ %115, %block_41519b ]
...
; Function Attrs: alwaysinline norecurse nounwind
define %struct.Memory* @routine_movsd_0x20cf21__rip____xmm0(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, ptrtoint (%G_0x20cf21__rip__type* @G_0x20cf21__rip_ to i64)
  %5 = add i64 %3, 8
  store i64 %5, i64* %PC, align 8
...
; Function Attrs: alwaysinline norecurse nounwind
define %struct.Memory* @routine_jne_.L_4151b6(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i8* nocapture %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
