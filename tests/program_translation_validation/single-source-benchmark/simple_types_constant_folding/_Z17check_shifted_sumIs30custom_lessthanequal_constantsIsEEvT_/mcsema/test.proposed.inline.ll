...
block_415d9b:                                     ; preds = %entry
  ...
  %call2_415dae = call %struct.Memory* @sub_4006c0.printf_plt(%struct.State* %0, i64 %loadPC_415dae, %struct.Memory* %loadMem2_415dae)
  store %struct.Memory* %call2_415dae, %struct.Memory** %MEMORY
