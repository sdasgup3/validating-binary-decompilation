...
@G_0x20ca01__rip_ = global %G_0x20ca01__rip__type zeroinitializer
...
declare %struct.Memory* @sub_415630._ZN31custom_multiple_constant_divideIsE8do_shiftEs(%struct.State* noalias dereferenceable(3376), i64, %struct.Memory* noalias readnone returned) local_unnamed_addr
...
entry:
  ...
  store i16 %42, i16* %AX.i45, align 2
  %43 = add i64 %7, -10
  %44 = add i64 %10, 14
  ...
  %47 = add i64 %46, ptrtoint (%G_0x20ca01__rip__type* @G_0x20ca01__rip_ to i64)
  %48 = add i64 %46, 8
  ...
  store i16 %61, i16* %AX.i45, align 2
  %sext = shl i64 %60, 48
  %62 = ashr exact i64 %sext, 48
  %63 = and i64 %62, 4294967295
  store i64 %63, i64* %RDI.i39, align 8
  %64 = add i64 %46, -79
  %65 = add i64 %46, 23
  ...
  store i16 %89, i16* %AX.i45, align 2
  %90 = add i64 %71, 24
  ...
  %call2_4156ae = tail call %struct.Memory* @sub_4151c0._Z15tolerance_equalIsEbRT_S1_(%struct.State* %0, i64 %93, %struct.Memory* %call2_415691)
  %AL.i16 = bitcast %union.anon* %40 to i8*
  %98 = load i8, i8* %AL.i16, align 1
  ...
  br i1 %106, label %block_.L_4156d6, label %block_4156bb

block_4156bb:                                     ; preds = %entry
  store i64 ptrtoint (%G__0x419d98_type* @G__0x419d98 to i64), i64* %RDI.i39, align 8
  %108 = load i32, i32* bitcast (%G_0x6220a8_type* @G_0x6220a8 to i32*), align 8
  %109 = zext i32 %108 to i64
  store i64 %109, i64* %RSI.i27, align 8
  ...
  %115 = tail call %struct.Memory* @__remill_function_call(%struct.State* nonnull %0, i64 ptrtoint (i64 (i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64)* @printf to i64), %struct.Memory* %call2_4156ae)
...
block_.L_4156d6:                                  ; preds = %block_4156bb, %entry
  %122 = phi i64 [ %107, %entry ], [ %.pre, %block_4156bb ]
  %MEMORY.0 = phi %struct.Memory* [ %call2_4156ae, %entry ], [ %115, %block_4156bb ]
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_movsd_0x20ca01__rip____xmm0(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, ptrtoint (%G_0x20ca01__rip__type* @G_0x20ca01__rip_ to i64)
  %5 = add i64 %3, 8
  store i64 %5, i64* %PC, align 8
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_jne_.L_4156d6(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i8* nocapture %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
