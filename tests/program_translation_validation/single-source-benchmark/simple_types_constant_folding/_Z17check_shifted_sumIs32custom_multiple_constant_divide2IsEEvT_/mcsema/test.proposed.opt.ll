...
entry:
  ...
  %47 = add i64 %46, ptrtoint (%G_0x20cab1__rip__type* @G_0x20cab1__rip_ to i64)
  %48 = add i64 %46, 8
  ...
  %call2_4155e1 = tail call %struct.Memory* @sub_4155a0._ZN32custom_multiple_constant_divide2IsE8do_shiftEs(%struct.State* %0, i64 %64, %struct.Memory* %2)
  ...
  %call2_4155fe = tail call %struct.Memory* @sub_4151c0._Z15tolerance_equalIsEbRT_S1_(%struct.State* %0, i64 %93, %struct.Memory* %call2_4155e1)
  ...
  br i1 %106, label %block_.L_415626, label %block_41560b
...
block_41560b:                                     ; preds = %entry
  ...
  %115 = tail call %struct.Memory* @__remill_function_call(%struct.State* nonnull %0, i64 ptrtoint (i64 (i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64)* @printf to i64), %struct.Memory* %call2_4155fe)
...
block_.L_415626:                                  ; preds = %block_41560b, %entry
  %122 = phi i64 [ %107, %entry ], [ %.pre, %block_41560b ]
  %MEMORY.0 = phi %struct.Memory* [ %call2_4155fe, %entry ], [ %115, %block_41560b ]
