...
declare %struct.Memory* @sub_415800._ZN33custom_multiple_constant_multiplyIsE8do_shiftEs(%struct.State* noalias dereferenceable(3376), i64, %struct.Memory* noalias readnone returned) local_unnamed_addr
...
entry:
  ...
  %47 = add i64 %46, ptrtoint (%G_0x20c841__rip__type* @G_0x20c841__rip_ to i64)
  %48 = add i64 %46, 8
  ...
  %call2_415851 = tail call %struct.Memory* @sub_415800._ZN33custom_multiple_constant_multiplyIsE8do_shiftEs(%struct.State* %0, i64 %64, %struct.Memory* %2)
  ...
  %call2_41586e = tail call %struct.Memory* @sub_4151c0._Z15tolerance_equalIsEbRT_S1_(%struct.State* %0, i64 %93, %struct.Memory* %call2_415851)
  ...
  br i1 %106, label %block_.L_415896, label %block_41587b
...
block_41587b:                                     ; preds = %entry
  ...
  %115 = tail call %struct.Memory* @__remill_function_call(%struct.State* nonnull %0, i64 ptrtoint (i64 (i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64)* @printf to i64), %struct.Memory* %call2_41586e)
...
block_.L_415896:                                  ; preds = %block_41587b, %entry
  %122 = phi i64 [ %107, %entry ], [ %.pre, %block_41587b ]
  %MEMORY.0 = phi %struct.Memory* [ %call2_41586e, %entry ], [ %115, %block_41587b ]
...
; Function Attrs: alwaysinline norecurse nounwind
define %struct.Memory* @routine_movsd_0x20c841__rip____xmm0(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, ptrtoint (%G_0x20c841__rip__type* @G_0x20c841__rip_ to i64)
  %5 = add i64 %3, 8
  store i64 %5, i64* %PC, align 8
...
; Function Attrs: alwaysinline norecurse nounwind
define %struct.Memory* @routine_jne_.L_415896(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i8* nocapture %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
