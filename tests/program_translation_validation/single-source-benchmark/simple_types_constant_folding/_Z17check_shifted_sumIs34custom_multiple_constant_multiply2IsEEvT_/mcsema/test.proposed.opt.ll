...
entry:
  ...
  %47 = add i64 %46, ptrtoint (%G_0x20c8e1__rip__type* @G_0x20c8e1__rip_ to i64)
  %48 = add i64 %46, 8
  ...
  %call2_4157b1 = tail call %struct.Memory* @sub_415770._ZN34custom_multiple_constant_multiply2IsE8do_shiftEs(%struct.State* %0, i64 %64, %struct.Memory* %2)
  ...
  %call2_4157ce = tail call %struct.Memory* @sub_4151c0._Z15tolerance_equalIsEbRT_S1_(%struct.State* %0, i64 %93, %struct.Memory* %call2_4157b1)
  ...
  br i1 %106, label %block_.L_4157f6, label %block_4157db
...
block_4157db:                                     ; preds = %entry
  ...
  %115 = tail call %struct.Memory* @__remill_function_call(%struct.State* nonnull %0, i64 ptrtoint (i64 (i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64)* @printf to i64), %struct.Memory* %call2_4157ce)
...
block_.L_4157f6:                                  ; preds = %block_4157db, %entry
  %122 = phi i64 [ %107, %entry ], [ %.pre, %block_4157db ]
  %MEMORY.0 = phi %struct.Memory* [ %call2_4157ce, %entry ], [ %115, %block_4157db ]
