...
block_414fc7:                                     ; preds = %entry
  ...
  %call2_414fda = call %struct.Memory* @sub_4006c0.printf_plt(%struct.State* %0, i64 %loadPC_414fda, %struct.Memory* %loadMem2_414fda)
  store %struct.Memory* %call2_414fda, %struct.Memory** %MEMORY
