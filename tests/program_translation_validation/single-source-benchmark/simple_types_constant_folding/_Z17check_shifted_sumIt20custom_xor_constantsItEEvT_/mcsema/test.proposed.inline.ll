...
@G_0x20d7f1__rip__4278423_ = global %G_0x20d7f1__rip__4278423__type zeroinitializer
...
entry:
  ...
  store i16 %91, i16* %95
  store %struct.Memory* %loadMem_41488b, %struct.Memory** %MEMORY
  ...
  %105 = load double, double* bitcast (%G_0x20d7f1__rip__4278423__type* @G_0x20d7f1__rip__4278423_ to double*)
  ...
  store %struct.Memory* %loadMem1_41489d, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem1_4148ba, %struct.Memory** %MEMORY
...
block_4148c7:                                     ; preds = %entry
  ...
  store %struct.Memory* %loadMem1_4148da, %struct.Memory** %MEMORY
  %loadMem2_4148da = load %struct.Memory*, %struct.Memory** %MEMORY
  %loadPC_4148da = load i64, i64* %3
  %354 = call %struct.Memory* @__remill_function_call(%struct.State* %0, i64 ptrtoint (i64 (i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64)* @printf to i64), %struct.Memory* %loadMem2_4148da)
...
block_.L_4148e2:                                  ; preds = %block_4148c7, %entry
  ...
  ret %struct.Memory* %loadMem_4148e7
}
...
define %struct.Memory* @routine_cvttsd2si_0x20d7f1__rip____edi(%struct.State* dereferenceable(3376), i64, %struct.Memory*) {
block_400478:
  %3 = getelementptr inbounds %struct.State, %struct.State* %0, i32 0, i32 6
  %4 = getelementptr inbounds %struct.GPR, %struct.GPR* %3, i32 0, i32 33
  %5 = getelementptr inbounds %struct.Reg, %struct.Reg* %4, i32 0, i32 0
