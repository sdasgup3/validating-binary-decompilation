...
block_414ea7:                                     ; preds = %entry
  ...
  %call2_414eba = call %struct.Memory* @sub_4006c0.printf_plt(%struct.State* %0, i64 %loadPC_414eba, %struct.Memory* %loadMem2_414eba)
  store %struct.Memory* %call2_414eba, %struct.Memory** %MEMORY
