...
%G_0x20d251__rip__type = type <{ [8 x i8] }>
...
@G_0x20d251__rip_ = local_unnamed_addr global %G_0x20d251__rip__type zeroinitializer
...
declare %struct.Memory* @sub_414e00._ZN23custom_divide_constantsItE8do_shiftEt(%struct.State* noalias dereferenceable(3376), i64, %struct.Memory* noalias readnone returned) local_unnamed_addr
...
entry:
  ...
  %47 = load double, double* bitcast (%G_0x20d251__rip__type* @G_0x20d251__rip_ to double*), align 8
  ...
  %call2_414e3d = tail call %struct.Memory* @sub_414e00._ZN23custom_divide_constantsItE8do_shiftEt(%struct.State* %0, i64 %55, %struct.Memory* %2)
  ...
  %call2_414e5a = tail call %struct.Memory* @sub_413e90._Z15tolerance_equalItEbRT_S1_(%struct.State* %0, i64 %81, %struct.Memory* %call2_414e3d)
  ...
  br i1 %94, label %block_.L_414e82, label %block_414e67

block_414e67:                                     ; preds = %entry
  ...
  %103 = tail call %struct.Memory* @__remill_function_call(%struct.State* %0, i64 ptrtoint (i64 (i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64)* @printf to i64), %struct.Memory* %call2_414e5a)
  ...
  br label %block_.L_414e82

block_.L_414e82:                                  ; preds = %block_414e67, %entry
  %110 = phi i64 [ %95, %entry ], [ %.pre, %block_414e67 ]
  %MEMORY.0 = phi %struct.Memory* [ %call2_414e5a, %entry ], [ %103, %block_414e67 ]
...
define %struct.Memory* @routine_cvttsd2si_0x20d251__rip____edi(%struct.State* dereferenceable(3376), i64, %struct.Memory*) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  ...
  %5 = load double, double* bitcast (%G_0x20d251__rip__type* @G_0x20d251__rip_ to double*), align 8
...
define %struct.Memory* @routine_callq_._ZN23custom_divide_constantsItE8do_shiftEt(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
...
define %struct.Memory* @routine_jne_.L_414e82(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i8* %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
