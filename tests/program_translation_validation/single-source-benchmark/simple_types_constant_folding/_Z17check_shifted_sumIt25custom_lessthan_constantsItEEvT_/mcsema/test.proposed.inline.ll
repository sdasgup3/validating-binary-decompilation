...
block_414bd7:                                     ; preds = %entry
  ...
  %call2_414bea = call %struct.Memory* @sub_4006c0.printf_plt(%struct.State* %0, i64 %loadPC_414bea, %struct.Memory* %loadMem2_414bea)
  store %struct.Memory* %call2_414bea, %struct.Memory** %MEMORY
