...
@G_0x20d521__rip__4279143_ = global %G_0x20d521__rip__4279143__type zeroinitializer
...
entry:
  ...
  store %struct.Memory* %loadMem_414b54, %struct.Memory** %MEMORY
  ...
  %105 = load double, double* bitcast (%G_0x20d521__rip__4279143__type* @G_0x20d521__rip__4279143_ to double*)
  ...
  %loadMem1_414b6d = load %struct.Memory*, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem1_414b6d, %struct.Memory** %MEMORY
  %loadMem2_414b6d = load %struct.Memory*, %struct.Memory** %MEMORY
  %loadPC_414b6d = load i64, i64* %3
  %call2_414b6d = call %struct.Memory* @sub_414b30._ZN25custom_lessthan_constantsItE8do_shiftEt(%struct.State* %0, i64 %loadPC_414b6d, %struct.Memory* %loadMem2_414b6d)
  store %struct.Memory* %call2_414b6d, %struct.Memory** %MEMORY
  ...
  %loadMem1_414b8a = load %struct.Memory*, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem1_414b8a, %struct.Memory** %MEMORY
  %loadMem2_414b8a = load %struct.Memory*, %struct.Memory** %MEMORY
  %loadPC_414b8a = load i64, i64* %3
  %call2_414b8a = call %struct.Memory* @sub_413e90._Z15tolerance_equalItEbRT_S1_(%struct.State* %0, i64 %loadPC_414b8a, %struct.Memory* %loadMem2_414b8a)
  store %struct.Memory* %call2_414b8a, %struct.Memory** %MEMORY
  ...
  %loadBr_414b91 = load i8, i8* %BRANCH_TAKEN
  %cmpBr_414b91 = icmp eq i8 %loadBr_414b91, 1
  br i1 %cmpBr_414b91, label %block_.L_414bb2, label %block_414b97
...
block_414b97:                                     ; preds = %entry
  ...
  store %struct.Memory* %loadMem1_414baa, %struct.Memory** %MEMORY
  %loadMem2_414baa = load %struct.Memory*, %struct.Memory** %MEMORY
  %loadPC_414baa = load i64, i64* %3
  %354 = call %struct.Memory* @__remill_function_call(%struct.State* %0, i64 ptrtoint (i64 (i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64)* @printf to i64), %struct.Memory* %loadMem2_414baa)
...
block_.L_414bb2:                                  ; preds = %block_414b97, %entry
  ...
  ret %struct.Memory* %loadMem_414bb7
}
...
define %struct.Memory* @routine_cvttsd2si_0x20d521__rip____edi(%struct.State* dereferenceable(3376), i64, %struct.Memory*) {
block_400478:
  %3 = getelementptr inbounds %struct.State, %struct.State* %0, i32 0, i32 6
  %4 = getelementptr inbounds %struct.GPR, %struct.GPR* %3, i32 0, i32 33
  %5 = getelementptr inbounds %struct.Reg, %struct.Reg* %4, i32 0, i32 0
  ...
  %9 = load i64, i64* %PC
  %10 = ptrtoint %G_0x20d521__rip__4279143__type* @G_0x20d521__rip__4279143_ to i64
  %11 = load i64, i64* %PC
  %12 = add i64 %11, 8
  store i64 %12, i64* %PC
...
define %struct.Memory* @routine_jne_.L_414bb2(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i8* %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) {
block_400478:
  %3 = getelementptr inbounds %struct.State, %struct.State* %0, i32 0, i32 6
  %4 = getelementptr inbounds %struct.GPR, %struct.GPR* %3, i32 0, i32 33
  %5 = getelementptr inbounds %struct.Reg, %struct.Reg* %4, i32 0, i32 0
