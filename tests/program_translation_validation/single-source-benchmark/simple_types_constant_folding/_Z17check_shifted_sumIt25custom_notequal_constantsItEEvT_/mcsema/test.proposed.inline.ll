...
@G_0x20d401__rip__4279431_ = global %G_0x20d401__rip__4279431__type zeroinitializer
...
entry:
  ...
  store %struct.Memory* %loadMem_414c74, %struct.Memory** %MEMORY
  ...
  store i16 %91, i16* %95
  store %struct.Memory* %loadMem_414c7b, %struct.Memory** %MEMORY
  ...
  %105 = load double, double* bitcast (%G_0x20d401__rip__4279431__type* @G_0x20d401__rip__4279431_ to double*)
  ...
  store %struct.Memory* %loadMem1_414c8d, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_414c96, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_414c9d, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_414ca3, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_414ca6, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem1_414caa, %struct.Memory** %MEMORY
...
block_414cb7:                                     ; preds = %entry
  ...
  store %struct.Memory* %loadMem1_414cca, %struct.Memory** %MEMORY
  %loadMem2_414cca = load %struct.Memory*, %struct.Memory** %MEMORY
  %loadPC_414cca = load i64, i64* %3
  %354 = call %struct.Memory* @__remill_function_call(%struct.State* %0, i64 ptrtoint (i64 (i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64)* @printf to i64), %struct.Memory* %loadMem2_414cca)
...
block_.L_414cd2:                                  ; preds = %block_414cb7, %entry
  ...
  ret %struct.Memory* %loadMem_414cd7
}
...
define %struct.Memory* @routine_cvttsd2si_0x20d401__rip____edi(%struct.State* dereferenceable(3376), i64, %struct.Memory*) {
block_400478:
  %3 = getelementptr inbounds %struct.State, %struct.State* %0, i32 0, i32 6
  %4 = getelementptr inbounds %struct.GPR, %struct.GPR* %3, i32 0, i32 33
  %5 = getelementptr inbounds %struct.Reg, %struct.Reg* %4, i32 0, i32 0
