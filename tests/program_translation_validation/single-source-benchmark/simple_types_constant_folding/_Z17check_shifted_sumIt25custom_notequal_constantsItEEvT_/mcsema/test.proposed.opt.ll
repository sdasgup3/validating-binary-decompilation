...
entry:
  ...
  %47 = add i64 %46, ptrtoint (%G_0x20d3b1__rip__type* @G_0x20d3b1__rip_ to i64)
  %48 = add i64 %46, 8
  ...
  %call2_414cdd = tail call %struct.Memory* @sub_414ca0._ZN25custom_notequal_constantsItE8do_shiftEt(%struct.State* %0, i64 %59, %struct.Memory* %2)
  ...
  %call2_414cfa = tail call %struct.Memory* @sub_413ee0._Z15tolerance_equalItEbRT_S1_(%struct.State* %0, i64 %85, %struct.Memory* %call2_414cdd)
  ...
  br i1 %98, label %block_.L_414d22, label %block_414d07
...
block_414d07:                                     ; preds = %entry
  ...
  %107 = tail call %struct.Memory* @__remill_function_call(%struct.State* nonnull %0, i64 ptrtoint (i64 (i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64)* @printf to i64), %struct.Memory* %call2_414cfa)
...
block_.L_414d22:                                  ; preds = %block_414d07, %entry
  %114 = phi i64 [ %99, %entry ], [ %.pre, %block_414d07 ]
  %MEMORY.0 = phi %struct.Memory* [ %call2_414cfa, %entry ], [ %107, %block_414d07 ]
