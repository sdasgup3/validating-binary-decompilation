...
@G_0x20d491__rip__4279287_ = global %G_0x20d491__rip__4279287__type zeroinitializer
...
entry:
  ...
  store i16 %91, i16* %95
  store %struct.Memory* %loadMem_414beb, %struct.Memory** %MEMORY
  ...
  %105 = load double, double* bitcast (%G_0x20d491__rip__4279287__type* @G_0x20d491__rip__4279287_ to double*)
  ...
  store %struct.Memory* %loadMem1_414bfd, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_414c0a, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem1_414c1a, %struct.Memory** %MEMORY
...
block_414c27:                                     ; preds = %entry
  ...
  store %struct.Memory* %loadMem_414c27, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem1_414c3a, %struct.Memory** %MEMORY
  %loadMem2_414c3a = load %struct.Memory*, %struct.Memory** %MEMORY
  %loadPC_414c3a = load i64, i64* %3
  %354 = call %struct.Memory* @__remill_function_call(%struct.State* %0, i64 ptrtoint (i64 (i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64)* @printf to i64), %struct.Memory* %loadMem2_414c3a)
...
block_.L_414c42:                                  ; preds = %block_414c27, %entry
  ...
  ret %struct.Memory* %loadMem_414c47
}
...
define %struct.Memory* @routine_cvttsd2si_0x20d491__rip____edi(%struct.State* dereferenceable(3376), i64, %struct.Memory*) {
block_400478:
  %3 = getelementptr inbounds %struct.State, %struct.State* %0, i32 0, i32 6
  %4 = getelementptr inbounds %struct.GPR, %struct.GPR* %3, i32 0, i32 33
  %5 = getelementptr inbounds %struct.Reg, %struct.Reg* %4, i32 0, i32 0
