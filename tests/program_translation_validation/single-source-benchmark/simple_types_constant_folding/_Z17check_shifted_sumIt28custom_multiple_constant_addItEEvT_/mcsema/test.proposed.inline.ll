...
@G_0x20d911__rip__4278135_ = global %G_0x20d911__rip__4278135__type zeroinitializer
...
define %struct.Memory* @_Z17check_shifted_sumIt28custom_multiple_constant_addItEEvT_(%struct.State* noalias, i64, %struct.Memory* noalias) #2 {
entry:
  ...
  store i16 %91, i16* %95
  store %struct.Memory* %loadMem_41476b, %struct.Memory** %MEMORY
  ...
  %105 = load double, double* bitcast (%G_0x20d911__rip__4278135__type* @G_0x20d911__rip__4278135_ to double*)
  ...
  store %struct.Memory* %loadMem_41477a, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem1_41477d, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem1_41479a, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_41479f, %struct.Memory** %MEMORY
...
block_4147a7:                                     ; preds = %entry
  ...
  store %struct.Memory* %loadMem_4147b8, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem1_4147ba, %struct.Memory** %MEMORY
  %loadMem2_4147ba = load %struct.Memory*, %struct.Memory** %MEMORY
  %loadPC_4147ba = load i64, i64* %3
  %354 = call %struct.Memory* @__remill_function_call(%struct.State* %0, i64 ptrtoint (i64 (i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64)* @printf to i64), %struct.Memory* %loadMem2_4147ba)
  ...
  store %struct.Memory* %loadMem_4147bf, %struct.Memory** %MEMORY
...
block_.L_4147c2:                                  ; preds = %block_4147a7, %entry
  ...
  store %struct.Memory* %loadMem_4147c2, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_4147c6, %struct.Memory** %MEMORY
  ...
  ret %struct.Memory* %loadMem_4147c7
}
...
define %struct.Memory* @routine_cvttsd2si_0x20d911__rip____edi(%struct.State* dereferenceable(3376), i64, %struct.Memory*) {
block_400478:
  %3 = getelementptr inbounds %struct.State, %struct.State* %0, i32 0, i32 6
  %4 = getelementptr inbounds %struct.GPR, %struct.GPR* %3, i32 0, i32 33
  %5 = getelementptr inbounds %struct.Reg, %struct.Reg* %4, i32 0, i32 0
