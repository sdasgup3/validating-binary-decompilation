...
%G_0x20d911__rip__type = type <{ [8 x i8] }>
...
@G_0x20d911__rip_ = local_unnamed_addr global %G_0x20d911__rip__type zeroinitializer
...
entry:
  ...
  %47 = load double, double* bitcast (%G_0x20d911__rip__type* @G_0x20d911__rip_ to double*), align 8
...
block_.L_4147c2:                                  ; preds = %block_4147a7, %entry
  ...
  %111 = load i64, i64* %RSP.i8, align 8
  %112 = add i64 %111, 16
  store i64 %112, i64* %RSP.i8, align 8
...
block_400478:
  ...
  %5 = load double, double* bitcast (%G_0x20d911__rip__type* @G_0x20d911__rip_ to double*), align 8
