...
@G_0x20da41__rip__4277831_ = global %G_0x20da41__rip__4277831__type zeroinitializer
...
entry:
  ...
  %105 = load double, double* bitcast (%G_0x20da41__rip__4277831__type* @G_0x20da41__rip__4277831_ to double*)
  ...
  store %struct.Memory* %loadMem_41464a, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem1_41464d, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_41465a, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_41465d, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem1_41466a, %struct.Memory** %MEMORY
...
block_414677:                                     ; preds = %entry
  ...
  store %struct.Memory* %loadMem1_41468a, %struct.Memory** %MEMORY
  %loadMem2_41468a = load %struct.Memory*, %struct.Memory** %MEMORY
  %loadPC_41468a = load i64, i64* %3
  %354 = call %struct.Memory* @__remill_function_call(%struct.State* %0, i64 ptrtoint (i64 (i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64)* @printf to i64), %struct.Memory* %loadMem2_41468a)
...
block_.L_414692:                                  ; preds = %block_414677, %entry
  ...
  ret %struct.Memory* %loadMem_414697
}
...
define %struct.Memory* @routine_cvttsd2si_0x20da41__rip____edi(%struct.State* dereferenceable(3376), i64, %struct.Memory*) {
block_400478:
  %3 = getelementptr inbounds %struct.State, %struct.State* %0, i32 0, i32 6
  %4 = getelementptr inbounds %struct.GPR, %struct.GPR* %3, i32 0, i32 33
  %5 = getelementptr inbounds %struct.Reg, %struct.Reg* %4, i32 0, i32 0
