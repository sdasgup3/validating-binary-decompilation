...
block_414b47:                                     ; preds = %entry
  ...
  %call2_414b5a = call %struct.Memory* @sub_4006c0.printf_plt(%struct.State* %0, i64 %loadPC_414b5a, %struct.Memory* %loadMem2_414b5a)
  store %struct.Memory* %call2_414b5a, %struct.Memory** %MEMORY
