...
@G_0x20db71__rip__4277527_ = global %G_0x20db71__rip__4277527__type zeroinitializer
...
entry:
  ...
  %105 = load double, double* bitcast (%G_0x20db71__rip__4277527__type* @G_0x20db71__rip__4277527_ to double*)
  ...
  store %struct.Memory* %loadMem_41451a, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem1_41451d, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_41452a, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem1_41453a, %struct.Memory** %MEMORY
...
block_414547:                                     ; preds = %entry
  ...
  store %struct.Memory* %loadMem1_41455a, %struct.Memory** %MEMORY
  %loadMem2_41455a = load %struct.Memory*, %struct.Memory** %MEMORY
  %loadPC_41455a = load i64, i64* %3
  %354 = call %struct.Memory* @__remill_function_call(%struct.State* %0, i64 ptrtoint (i64 (i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64)* @printf to i64), %struct.Memory* %loadMem2_41455a)
...
block_.L_414562:                                  ; preds = %block_414547, %entry
  ...
  ret %struct.Memory* %loadMem_414567
}
...
define %struct.Memory* @routine_cvttsd2si_0x20db71__rip____edi(%struct.State* dereferenceable(3376), i64, %struct.Memory*) {
block_400478:
  %3 = getelementptr inbounds %struct.State, %struct.State* %0, i32 0, i32 6
  %4 = getelementptr inbounds %struct.GPR, %struct.GPR* %3, i32 0, i32 33
  %5 = getelementptr inbounds %struct.Reg, %struct.Reg* %4, i32 0, i32 0
