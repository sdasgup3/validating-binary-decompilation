...
@G_0x20dc11__rip__4277367_ = global %G_0x20dc11__rip__4277367__type zeroinitializer
...
entry:
  ...
  %105 = load double, double* bitcast (%G_0x20dc11__rip__4277367__type* @G_0x20dc11__rip__4277367_ to double*)
  ...
  store %struct.Memory* %loadMem1_41447d, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem1_41449a, %struct.Memory** %MEMORY
...
block_4144a7:                                     ; preds = %entry
  ...
  store %struct.Memory* %loadMem1_4144ba, %struct.Memory** %MEMORY
  %loadMem2_4144ba = load %struct.Memory*, %struct.Memory** %MEMORY
  %loadPC_4144ba = load i64, i64* %3
  %354 = call %struct.Memory* @__remill_function_call(%struct.State* %0, i64 ptrtoint (i64 (i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64)* @printf to i64), %struct.Memory* %loadMem2_4144ba)
...
block_.L_4144c2:                                  ; preds = %block_4144a7, %entry
  ...
  ret %struct.Memory* %loadMem_4144c7
}
...
define %struct.Memory* @routine_cvttsd2si_0x20dc11__rip____edi(%struct.State* dereferenceable(3376), i64, %struct.Memory*) {
block_400478:
  %3 = getelementptr inbounds %struct.State, %struct.State* %0, i32 0, i32 6
  %4 = getelementptr inbounds %struct.GPR, %struct.GPR* %3, i32 0, i32 33
  %5 = getelementptr inbounds %struct.Reg, %struct.Reg* %4, i32 0, i32 0
