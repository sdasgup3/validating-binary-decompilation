...
block_.L_400c46:                                  ; preds = %block_.L_400c89, %entry
  %77 = phi i64 [ %.pre, %entry ], [ %237, %block_.L_400c89 ]
...
block_.L_400cf2:                                  ; preds = %block_400d02, %block_.L_400c9c
  %311 = phi i64 [ %.pre3, %block_.L_400c9c ], [ %614, %block_400d02 ]
  %MEMORY.2 = phi %struct.Memory* [ %295, %block_.L_400c9c ], [ %575, %block_400d02 ]
  ...
  %318 = load i32, i32* bitcast (%G_0x6220a8_type* @G_0x6220a8 to i32*), align 8
  %319 = sub i32 %316, %318
  ...
  br i1 %344, label %block_400d02, label %block_.L_400dbb
...
block_400d02:                                     ; preds = %block_.L_400cf2
  ...
  %358 = load i64, i64* bitcast (%G_0x6220a0_type* @G_0x6220a0 to i64*), align 8
  ...
  %463 = load i64, i64* bitcast (%G_0x6220a0_type* @G_0x6220a0 to i64*), align 8
...
block_.L_400dc2:                                  ; preds = %block_400dd2, %block_.L_400dbb
  %616 = phi i64 [ %725, %block_400dd2 ], [ %.pre4, %block_.L_400dbb ]
  ...
  %623 = load i32, i32* bitcast (%G_0x6220a8_type* @G_0x6220a8 to i32*), align 8
  %624 = sub i32 %621, %623
  ...
  br i1 %649, label %block_400dd2, label %block_.L_400e01

block_400dd2:                                     ; preds = %block_.L_400dc2
  %651 = load i64, i64* bitcast (%G_0x6220a0_type* @G_0x6220a0 to i64*), align 8
