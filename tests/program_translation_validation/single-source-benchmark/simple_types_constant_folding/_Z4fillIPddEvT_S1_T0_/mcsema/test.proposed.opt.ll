...
block_.L_40db71:                                  ; preds = %block_40db7f, %entry
  %37 = phi i64 [ %107, %block_40db7f ], [ %.pre, %entry ]
  ...
  br i1 %61, label %block_.L_40db9c, label %block_40db7f

block_40db7f:                                     ; preds = %block_.L_40db71
  %73 = add i64 %38, -24
  %74 = add i64 %72, 5
...
block_.L_40db9c:                                  ; preds = %block_.L_40db71
  %108 = add i64 %72, 1
...
define %struct.Memory* @routine_je_.L_40db9c(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i8* %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
...
define %struct.Memory* @routine_jmpq_.L_40db71(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
