...
block_.L_40807f:                                  ; preds = %block_40808d, %entry
  %36 = phi i64 [ %107, %block_40808d ], [ %.pre, %entry ]
  ...
  br i1 %60, label %block_.L_4080a6, label %block_40808d

block_40808d:                                     ; preds = %block_.L_40807f
  %72 = add i64 %37, -20
  %73 = add i64 %71, 3
...
block_.L_4080a6:                                  ; preds = %block_.L_40807f
  %108 = add i64 %71, 1
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_je_.L_4080a6(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i8* nocapture %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_jmpq_.L_40807f(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
