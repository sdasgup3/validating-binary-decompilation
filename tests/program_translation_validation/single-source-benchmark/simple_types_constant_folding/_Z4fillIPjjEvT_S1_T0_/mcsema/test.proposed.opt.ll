...
block_.L_40946f:                                  ; preds = %block_40947d, %entry
  %35 = phi i64 [ %105, %block_40947d ], [ %.pre, %entry ]
  ...
  br i1 %59, label %block_.L_409496, label %block_40947d

block_40947d:                                     ; preds = %block_.L_40946f
  %71 = add i64 %36, -20
  %72 = add i64 %70, 3
...
block_.L_409496:                                  ; preds = %block_.L_40946f
  %106 = add i64 %70, 1
...
define %struct.Memory* @routine_je_.L_409496(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i8* %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
...
define %struct.Memory* @routine_jmpq_.L_40946f(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
