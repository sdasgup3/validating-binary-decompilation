...
define %struct.Memory* @_Z4fillIPmmEvT_S1_T0_(%struct.State* noalias, i64, %struct.Memory* noalias) local_unnamed_addr #1 {
entry:
  ...
  br label %block_.L_40bcf0

block_.L_40bcf0:                                  ; preds = %block_40bcfe, %entry
  %33 = phi i64 [ %102, %block_40bcfe ], [ %.pre, %entry ]
  ...
  br i1 %57, label %block_.L_40bd19, label %block_40bcfe

block_40bcfe:                                     ; preds = %block_.L_40bcf0
  %69 = add i64 %34, -24
  %70 = add i64 %68, 4
...
block_.L_40bd19:                                  ; preds = %block_.L_40bcf0
  %103 = add i64 %68, 1
...
define %struct.Memory* @routine_je_.L_40bd19(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i8* %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
...
define %struct.Memory* @routine_jmpq_.L_40bcf0(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
