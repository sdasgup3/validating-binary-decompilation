...
define %struct.Memory* @_Z4fillIPttEvT_S1_T0_(%struct.State* noalias, i64, %struct.Memory* noalias) local_unnamed_addr #1 {
entry:
  ...
  br label %block_.L_4069f3

block_.L_4069f3:                                  ; preds = %block_406a01, %entry
  %36 = phi i64 [ %106, %block_406a01 ], [ %.pre, %entry ]
  ...
  br i1 %60, label %block_.L_406a1c, label %block_406a01

block_406a01:                                     ; preds = %block_.L_4069f3
  %72 = add i64 %37, -18
  %73 = add i64 %71, 4
...
block_.L_406a1c:                                  ; preds = %block_.L_4069f3
  %107 = add i64 %71, 1
...
define %struct.Memory* @routine_je_.L_406a1c(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i8* %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
...
define %struct.Memory* @routine_jmpq_.L_4069f3(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
