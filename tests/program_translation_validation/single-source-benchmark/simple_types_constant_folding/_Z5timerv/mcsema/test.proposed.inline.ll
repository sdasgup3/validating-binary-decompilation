...
entry:
  ...
  %loadMem1_400ea4 = load %struct.Memory*, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem1_400ea4, %struct.Memory** %MEMORY
  %loadMem2_400ea4 = load %struct.Memory*, %struct.Memory** %MEMORY
  %loadPC_400ea4 = load i64, i64* %3
  %call2_400ea4 = call %struct.Memory* @sub_4006a0.clock_plt(%struct.State* %0, i64 %loadPC_400ea4, %struct.Memory* %loadMem2_400ea4)
  store %struct.Memory* %call2_400ea4, %struct.Memory** %MEMORY
  ...
  store i64 %64, i64* inttoptr (i64 6430904 to i64*)
  ...
  %75 = load i64, i64* inttoptr (i64 6430904 to i64*)
  ...
  %85 = load i64, i64* inttoptr (i64 6430896 to i64*)
  %86 = sub i64 %82, %85
...
block_400488:
  ...
  %11 = add i64 %10, 8
  store i64 %11, i64* %PC
  store i64 %9, i64* inttoptr (i64 6430904 to i64*)
  ret %struct.Memory* %2
}
...
block_400488:
  ...
  %10 = add i64 %9, 8
  store i64 %10, i64* %PC
  %11 = load i64, i64* inttoptr (i64 6430904 to i64*)
...
block_400488:
  ...
  %11 = add i64 %10, 8
  store i64 %11, i64* %PC
  %12 = load i64, i64* inttoptr (i64 6430896 to i64*)
  %13 = sub i64 %9, %12
