...
%G_0x17b67__rip__4198001__type = type <{ [16 x i8] }>
...
@G_0x17b67__rip__4198001_ = global %G_0x17b67__rip__4198001__type zeroinitializer
...
entry:
  ...
  %53 = load double, double* bitcast (%G_0x17b67__rip__4198001__type* @G_0x17b67__rip__4198001_ to double*)
  ...
  store i64 %63, i64* bitcast (%G_0x6220b8_type* @G_0x6220b8 to i64*)
  ...
  %74 = load i64, i64* bitcast (%G_0x6220b8_type* @G_0x6220b8 to i64*)
  ...
  %84 = load i64, i64* bitcast (%G_0x6220b0_type* @G_0x6220b0 to i64*)
  %85 = sub i64 %81, %84
  ...
  ret %struct.Memory* %loadMem_400e96
}
...
block_400478:
  ...
  %9 = load i64, i64* %PC
  %10 = ptrtoint %G_0x17b67__rip__4198001__type* @G_0x17b67__rip__4198001_ to i64
  %11 = load i64, i64* %PC
  %12 = add i64 %11, 8
  store i64 %12, i64* %PC
