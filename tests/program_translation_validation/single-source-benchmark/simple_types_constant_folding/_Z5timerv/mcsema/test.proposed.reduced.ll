; ModuleID = '/tmp/tmpwac97my5-query.ll'
...
; Matched:%var_2_12:  %var_2_12 = add i64 %var_2_11, -2049
; %var_2_11 = add i64 %var_2_10, -2049
...
%var_2_19 = add i64 %var_2_18, ptrtoint (%G_0x17b67__rip__type* @G_0x17b67__rip_ to i64)
...
; store i64 %var_2_24, i64* bitcast (%G_0x6220b8_type* @G_0x6220b8 to i64*), align 8
%var_2_25 = load i64, i64* bitcast (%G_0x6220b0_type* @G_0x6220b0 to i64*), align 8
