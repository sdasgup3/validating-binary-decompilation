...
@G_0x180c2__rip_ = local_unnamed_addr global %G_0x180c2__rip__type zeroinitializer
...
entry:
  ...
  %49 = load i64, i64* bitcast (%G_0x180c2__rip__type* @G_0x180c2__rip_ to i64*), align 8
...
block_.L_40095a:                                  ; preds = %block_.L_40099d, %entry
  %137 = phi i64 [ %.pre, %entry ], [ %297, %block_.L_40099d ]
  %MEMORY.0 = phi %struct.Memory* [ %2, %entry ], [ %214, %block_.L_40099d ]
  ...
  %144 = load i32, i32* bitcast (%G_0x6220a8_type* @G_0x6220a8 to i32*), align 8
  %145 = sub i32 %142, %144
  ...
  br i1 %170, label %block_40096a, label %block_.L_4009b0

block_40096a:                                     ; preds = %block_.L_40095a
  %172 = load i64, i64* bitcast (%G_0x6220a0_type* @G_0x6220a0 to i64*), align 8
  ...
  br i1 %259, label %block_.L_40099d, label %block_400997
...
block_.L_40099d:                                  ; preds = %block_400997, %block_40096a
  %265 = phi i64 [ %.pre2, %block_400997 ], [ %222, %block_40096a ]
  %266 = phi i64 [ %.pre1, %block_400997 ], [ %260, %block_40096a ]
  %267 = add i64 %265, -28
  %268 = add i64 %266, 8
...
block_.L_4009fe:                                  ; preds = %block_400a0e, %block_.L_4009b0
  %364 = phi i64 [ %.pre3, %block_.L_4009b0 ], [ %736, %block_400a0e ]
  %MEMORY.2 = phi %struct.Memory* [ %347, %block_.L_4009b0 ], [ %697, %block_400a0e ]
  ...
  %371 = load i32, i32* bitcast (%G_0x6220a8_type* @G_0x6220a8 to i32*), align 8
  %372 = sub i32 %369, %371
  ...
  br i1 %397, label %block_400a0e, label %block_.L_400afa
...
block_400a0e:                                     ; preds = %block_.L_4009fe
  ...
  %407 = load i64, i64* bitcast (%G_0x6220a0_type* @G_0x6220a0 to i64*), align 8
  ...
  store i64 ptrtoint (%G__0x418b30_type* @G__0x418b30 to i64), i64* %446, align 8
  ...
  %506 = load i64, i64* bitcast (%G_0x6220a0_type* @G_0x6220a0 to i64*), align 8
  ...
  store double 0.000000e+00, double* %53, align 1
  %587 = load i64, i64* bitcast (%G_0x6220a0_type* @G_0x6220a0 to i64*), align 8
  ...
  %661 = load i64, i64* bitcast (%G_0x6220a0_type* @G_0x6220a0 to i64*), align 8
...
block_.L_400b01:                                  ; preds = %block_400b11, %block_.L_400afa
  %738 = phi i64 [ %847, %block_400b11 ], [ %.pre4, %block_.L_400afa ]
  ...
  %745 = load i32, i32* bitcast (%G_0x6220a8_type* @G_0x6220a8 to i32*), align 8
  %746 = sub i32 %743, %745
  ...
  br i1 %771, label %block_400b11, label %block_.L_400b40

block_400b11:                                     ; preds = %block_.L_400b01
  %773 = load i64, i64* bitcast (%G_0x6220a0_type* @G_0x6220a0 to i64*), align 8
...
block_.L_400b40:                                  ; preds = %block_.L_400b01
  ...
  %864 = load i32, i32* bitcast (%G_0x6220a8_type* @G_0x6220a8 to i32*), align 8
  %865 = add i32 %864, -1
  ...
  br i1 %899, label %block_.L_400c08, label %block_400b6b
...
block_400b6b:                                     ; preds = %block_.L_400b40
  ...
  br i1 %911, label %block_.L_400c08, label %block_400b75
...
block_.L_400b7c:                                  ; preds = %block_400b8c, %block_400b75
  %919 = phi i64 [ %.pre5, %block_400b75 ], [ %1041, %block_400b8c ]
  %MEMORY.4 = phi %struct.Memory* [ %862, %block_400b75 ], [ %999, %block_400b8c ]
  ...
  %926 = load i32, i32* bitcast (%G_0x6220a8_type* @G_0x6220a8 to i32*), align 8
  %927 = sub i32 %924, %926
  ...
  br i1 %952, label %block_400b8c, label %block_.L_400bcc

block_400b8c:                                     ; preds = %block_.L_400b7c
  %954 = load i64, i64* bitcast (%G_0x6220a0_type* @G_0x6220a0 to i64*), align 8
...
block_.L_400c08:                                  ; preds = %block_.L_400bcc, %block_400b6b, %block_.L_400b40
  %1101 = phi i64 [ %900, %block_.L_400b40 ], [ %915, %block_400b6b ], [ %.pre6, %block_.L_400bcc ]
  %MEMORY.5 = phi %struct.Memory* [ %862, %block_.L_400b40 ], [ %862, %block_400b6b ], [ %1094, %block_.L_400bcc ]
...
block_400478:
  ...
  %5 = load i64, i64* bitcast (%G_0x180c2__rip__type* @G_0x180c2__rip_ to i64*), align 8
