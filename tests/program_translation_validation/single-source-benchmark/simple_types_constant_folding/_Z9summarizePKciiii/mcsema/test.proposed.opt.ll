...
block_.L_400996:                                  ; preds = %block_.L_4009d9, %entry
  %131 = phi i64 [ %289, %block_.L_4009d9 ], [ %.pre, %entry ]
...
block_4009a6:                                     ; preds = %block_.L_400996
  ...
  %call2_4009bd = tail call %struct.Memory* @sub_4006b0.strlen_plt(%struct.State* nonnull %0, i64 %203, %struct.Memory* %2)
...
block_.L_4009ec:                                  ; preds = %block_.L_400996
  ...
  %call2_400a0a = tail call %struct.Memory* @sub_4006c0.printf_plt(%struct.State* nonnull %0, i64 %316, %struct.Memory* %2)
...
block_.L_400a3a:                                  ; preds = %block_400a4a, %block_.L_4009ec
  %353 = phi i64 [ %723, %block_400a4a ], [ %.pre21, %block_.L_4009ec ]
...
block_400a4a:                                     ; preds = %block_.L_400a3a
  ...
  %call2_400a8e = tail call %struct.Memory* @sub_4006b0.strlen_plt(%struct.State* nonnull %0, i64 %456, %struct.Memory* %call2_400a2b)
  ...
  %call2_400b20 = tail call %struct.Memory* @sub_4006c0.printf_plt(%struct.State* nonnull %0, i64 %681, %struct.Memory* %call2_400a2b)
...
block_.L_400b7c:                                  ; preds = %block_.L_400b3d
  ...
  %call2_400b91 = tail call %struct.Memory* @sub_4006c0.printf_plt(%struct.State* nonnull %0, i64 %844, %struct.Memory* %call2_400a2b)
...
block_.L_400bb8:                                  ; preds = %block_400bc8, %block_400bb1
  %907 = phi i64 [ %1029, %block_400bc8 ], [ %.pre23, %block_400bb1 ]
...
block_400bc8:                                     ; preds = %block_.L_400bb8
  ...
  %call2_400beb = tail call %struct.Memory* @sub_4006d0.log_plt(%struct.State* nonnull %0, i64 %983, %struct.Memory* %call2_400b91)
...
block_.L_400c08:                                  ; preds = %block_.L_400bb8
  ...
  %call2_400c27 = tail call %struct.Memory* @sub_400680.exp_plt(%struct.State* nonnull %0, i64 %1065, %struct.Memory* %call2_400b91)
