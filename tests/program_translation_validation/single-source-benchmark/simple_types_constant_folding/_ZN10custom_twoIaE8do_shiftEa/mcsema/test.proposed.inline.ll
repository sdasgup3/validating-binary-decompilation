...
entry:
  ...
  store %struct.Memory* %loadMem_4188c0, %struct.Memory** %MEMORY
  %loadMem_4188c1 = load %struct.Memory*, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_4188c1, %struct.Memory** %MEMORY
  %loadMem_4188c4 = load %struct.Memory*, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_4188c4, %struct.Memory** %MEMORY
  %loadMem_4188c7 = load %struct.Memory*, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_4188c7, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_4188d0, %struct.Memory** %MEMORY
  ret %struct.Memory* %loadMem_4188d0
}
