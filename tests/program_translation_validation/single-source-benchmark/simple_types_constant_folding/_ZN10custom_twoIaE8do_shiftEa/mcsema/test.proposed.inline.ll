...
define %struct.Memory* @_ZN10custom_twoIaE8do_shiftEa(%struct.State* noalias, i64, %struct.Memory* noalias) #1 {
entry:
  ...
  store %struct.Memory* %loadMem_418900, %struct.Memory** %MEMORY
  %loadMem_418901 = load %struct.Memory*, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_418901, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_418904, %struct.Memory** %MEMORY
  %loadMem_418907 = load %struct.Memory*, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_418907, %struct.Memory** %MEMORY
  ...
  ret %struct.Memory* %loadMem_418910
}
