...
define %struct.Memory* @_ZN10custom_twoIaE8do_shiftEa(%struct.State* noalias, i64, %struct.Memory* noalias) #2 {
entry:
  ...
  %loadMem_418911 = load %struct.Memory*, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_418911, %struct.Memory** %MEMORY
  %loadMem_418914 = load %struct.Memory*, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_418914, %struct.Memory** %MEMORY
  %loadMem_418917 = load %struct.Memory*, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_418917, %struct.Memory** %MEMORY
  ...
  store i8 %65, i8* %69
  store %struct.Memory* %loadMem_418919, %struct.Memory** %MEMORY
  %loadMem_41891c = load %struct.Memory*, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_41891c, %struct.Memory** %MEMORY
  ...
  ret %struct.Memory* %loadMem_418920
}
