...
@G_0x9ab4__rip__4255548_ = global %G_0x9ab4__rip__4255548__type zeroinitializer
...
define %struct.Memory* @_ZN10custom_twoIdE8do_shiftEd(%struct.State* noalias, i64, %struct.Memory* noalias) #2 {
entry:
  ...
  %38 = load double, double* bitcast (%G_0x9ab4__rip__4255548__type* @G_0x9ab4__rip__4255548_ to double*)
  ...
  ret %struct.Memory* %loadMem_40ef45
}
...
define %struct.Memory* @routine_movsd_0x9ab4__rip____xmm1(%struct.State* dereferenceable(3376), i64, %struct.Memory*) {
block_400478:
  %3 = getelementptr inbounds %struct.State, %struct.State* %0, i32 0, i32 6
  %4 = getelementptr inbounds %struct.GPR, %struct.GPR* %3, i32 0, i32 33
  %5 = getelementptr inbounds %struct.Reg, %struct.Reg* %4, i32 0, i32 0
