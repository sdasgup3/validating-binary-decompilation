...
@G_0x90f8__rip_= global %G_0x90f8__rip__type <{ [4 x i8] c"\00\00\00\00" }>
...
entry:
  ...
  ; Code: ._ZN10custom_twoIfE8do_shiftEf:	 RIP: 40f9d0	 Bytes: 0
  ...
  ; Code: movss 0x90f8(%rip), %xmm1	 RIP: 40f9d4	 Bytes: 8
  %loadMem_40f9d4 = load %struct.Memory*, %struct.Memory** %MEMORY
  %call_40f9d4 = call %struct.Memory* @routine_movss_0x90f8__rip____xmm1(%struct.State* %0, i64  0, %struct.Memory* %loadMem_40f9d4)
  store %struct.Memory* %call_40f9d4, %struct.Memory** %MEMORY

  ; Code: movss %xmm0, -0x4(%rbp)	 RIP: 40f9dc	 Bytes: 5
  %loadMem_40f9dc = load %struct.Memory*, %struct.Memory** %MEMORY
  %call_40f9dc = call %struct.Memory* @routine_movss__xmm0__MINUS0x4__rbp_(%struct.State* %0, i64  0, %struct.Memory* %loadMem_40f9dc)
  store %struct.Memory* %call_40f9dc, %struct.Memory** %MEMORY

  ; Code: movaps %xmm1, %xmm0	 RIP: 40f9e1	 Bytes: 3
  %loadMem_40f9e1 = load %struct.Memory*, %struct.Memory** %MEMORY
  %call_40f9e1 = call %struct.Memory* @routine_movaps__xmm1___xmm0(%struct.State* %0, i64  0, %struct.Memory* %loadMem_40f9e1)
  store %struct.Memory* %call_40f9e1, %struct.Memory** %MEMORY

  ; Code: popq %rbp	 RIP: 40f9e4	 Bytes: 1
  %loadMem_40f9e4 = load %struct.Memory*, %struct.Memory** %MEMORY
  %call_40f9e4 = call %struct.Memory* @routine_popq__rbp(%struct.State* %0, i64  0, %struct.Memory* %loadMem_40f9e4)
  store %struct.Memory* %call_40f9e4, %struct.Memory** %MEMORY

  ; Code: retq	 RIP: 40f9e5	 Bytes: 1
  %loadMem_40f9e5 = load %struct.Memory*, %struct.Memory** %MEMORY
  %call_40f9e5 = call %struct.Memory* @routine_retq(%struct.State* %0, i64  0, %struct.Memory* %loadMem_40f9e5)
  store %struct.Memory* %call_40f9e5, %struct.Memory** %MEMORY

  ret %struct.Memory* %call_40f9e5
}
...
define %struct.Memory* @routine_movss_0x90f8__rip____xmm1(%struct.State*  dereferenceable(3376), i64, %struct.Memory* ) #19 alwaysinline {
block_400488:
  %3 = getelementptr inbounds %struct.State, %struct.State* %0, i32 0, i32 6
  %4 = getelementptr inbounds %struct.GPR, %struct.GPR* %3, i32 0, i32 33
  %5 = getelementptr inbounds %struct.Reg, %struct.Reg* %4, i32 0, i32 0
  ...
  %9 = load i64, i64* %PC
  %10 = add i64 %9, ptrtoint( %G_0x90f8__rip__type* @G_0x90f8__rip_ to i64)
  %11 = load i64, i64* %PC
  %12 = add i64 %11, 8
  store i64 %12, i64* %PC
