...
define %struct.Memory* @_ZN10custom_twoIfE8do_shiftEf(%struct.State* noalias , i64, %struct.Memory* noalias) alwaysinline  {
entry:
  ...
  ; Code: ._ZN10custom_twoIfE8do_shiftEf:	 RIP: 40f9c0	 Bytes: 0
  ...
  ; Code: movss 0x90f8(%rip), %xmm1	 RIP: 40f9c4	 Bytes: 8
  %loadMem_40f9c4 = load %struct.Memory*, %struct.Memory** %MEMORY
  %call_40f9c4 = call %struct.Memory* @routine_movss_0x90f8__rip____xmm1(%struct.State* %0, i64  0, %struct.Memory* %loadMem_40f9c4)
  store %struct.Memory* %call_40f9c4, %struct.Memory** %MEMORY

  ; Code: movss %xmm0, -0x4(%rbp)	 RIP: 40f9cc	 Bytes: 5
  %loadMem_40f9cc = load %struct.Memory*, %struct.Memory** %MEMORY
  %call_40f9cc = call %struct.Memory* @routine_movss__xmm0__MINUS0x4__rbp_(%struct.State* %0, i64  0, %struct.Memory* %loadMem_40f9cc)
  store %struct.Memory* %call_40f9cc, %struct.Memory** %MEMORY

  ; Code: movaps %xmm1, %xmm0	 RIP: 40f9d1	 Bytes: 3
  %loadMem_40f9d1 = load %struct.Memory*, %struct.Memory** %MEMORY
  %call_40f9d1 = call %struct.Memory* @routine_movaps__xmm1___xmm0(%struct.State* %0, i64  0, %struct.Memory* %loadMem_40f9d1)
  store %struct.Memory* %call_40f9d1, %struct.Memory** %MEMORY

  ; Code: popq %rbp	 RIP: 40f9d4	 Bytes: 1
  %loadMem_40f9d4 = load %struct.Memory*, %struct.Memory** %MEMORY
  %call_40f9d4 = call %struct.Memory* @routine_popq__rbp(%struct.State* %0, i64  0, %struct.Memory* %loadMem_40f9d4)
  store %struct.Memory* %call_40f9d4, %struct.Memory** %MEMORY

  ; Code: retq	 RIP: 40f9d5	 Bytes: 1
  %loadMem_40f9d5 = load %struct.Memory*, %struct.Memory** %MEMORY
  %call_40f9d5 = call %struct.Memory* @routine_retq(%struct.State* %0, i64  0, %struct.Memory* %loadMem_40f9d5)
  store %struct.Memory* %call_40f9d5, %struct.Memory** %MEMORY

  ret %struct.Memory* %call_40f9d5
}
