...
%G_0x90f8__rip__type = type <{ [4 x i8] }>
...
@G_0x90f8__rip_ = global %G_0x90f8__rip__type zeroinitializer
...
entry:
  ...
  %13 = add i64 %10, add (i64 ptrtoint (%G_0x90f8__rip__type* @G_0x90f8__rip_ to i64), i64 3)
  %14 = add i64 %10, 11
...
; Function Attrs: alwaysinline norecurse nounwind
define %struct.Memory* @routine_movss_0x90f8__rip____xmm1(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned) local_unnamed_addr #0 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 1, i64 1
  %4 = bitcast %union.VectorReg* %3 to i8*
  %5 = load i64, i64* %PC, align 8
  %6 = add i64 %5, ptrtoint (%G_0x90f8__rip__type* @G_0x90f8__rip_ to i64)
  %7 = add i64 %5, 8
