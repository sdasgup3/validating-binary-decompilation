...
define %struct.Memory* @_ZN10custom_twoIhE8do_shiftEh(%struct.State* noalias, i64, %struct.Memory* noalias) #1 {
entry:
  ...
  store %struct.Memory* %loadMem_417634, %struct.Memory** %MEMORY
  ...
  ret %struct.Memory* %loadMem_417640
}
