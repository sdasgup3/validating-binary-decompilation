...
define %struct.Memory* @_ZN10custom_twoIiE8do_shiftEi(%struct.State* noalias, i64, %struct.Memory* noalias) #2 {
entry:
  ...
  store i32 %48, i32* %52
  store %struct.Memory* %loadMem_413dd9, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_413ddc, %struct.Memory** %MEMORY
  ...
  ret %struct.Memory* %loadMem_413ddd
}
