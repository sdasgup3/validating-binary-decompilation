...
define %struct.Memory* @_ZN10custom_twoIjE8do_shiftEj(%struct.State* noalias, i64, %struct.Memory* noalias) #2 {
entry:
  ...
  store %struct.Memory* %loadMem_412e81, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_412e84, %struct.Memory** %MEMORY
  ...
  store i32 %48, i32* %52
  store %struct.Memory* %loadMem_412e89, %struct.Memory** %MEMORY
  ...
  ret %struct.Memory* %loadMem_412e8d
}
