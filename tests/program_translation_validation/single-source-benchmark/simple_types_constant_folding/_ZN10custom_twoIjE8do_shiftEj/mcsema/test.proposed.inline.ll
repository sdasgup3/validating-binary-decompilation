...
define %struct.Memory* @_ZN10custom_twoIjE8do_shiftEj(%struct.State* noalias, i64, %struct.Memory* noalias) #1 {
entry:
  ...
  store %struct.Memory* %loadMem_412e71, %struct.Memory** %MEMORY
  ...
  ret %struct.Memory* %loadMem_412e7d
}
