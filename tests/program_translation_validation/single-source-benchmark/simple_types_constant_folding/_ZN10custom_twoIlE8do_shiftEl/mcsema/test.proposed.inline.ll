...
define %struct.Memory* @_ZN10custom_twoIlE8do_shiftEl(%struct.State* noalias, i64, %struct.Memory* noalias) #1 {
entry:
  ...
  %loadMem_411f30 = load %struct.Memory*, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_411f30, %struct.Memory** %MEMORY
  %loadMem_411f31 = load %struct.Memory*, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_411f31, %struct.Memory** %MEMORY
  ...
  %loadMem_411f39 = load %struct.Memory*, %struct.Memory** %MEMORY
  ...
  store i64 %48, i64* %51
  store %struct.Memory* %loadMem_411f39, %struct.Memory** %MEMORY
  %loadMem_411f3d = load %struct.Memory*, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_411f3d, %struct.Memory** %MEMORY
  ...
  ret %struct.Memory* %loadMem_411f3e
}
