...
define %struct.Memory* @_ZN10custom_twoIsE8do_shiftEs(%struct.State* noalias, i64, %struct.Memory* noalias) #1 {
entry:
  ...
  store %struct.Memory* %loadMem_416361, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_416364, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_416372, %struct.Memory** %MEMORY
  ...
  ret %struct.Memory* %loadMem_416373
}
