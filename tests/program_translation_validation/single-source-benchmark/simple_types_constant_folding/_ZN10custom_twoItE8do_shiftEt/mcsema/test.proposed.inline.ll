...
define %struct.Memory* @_ZN10custom_twoItE8do_shiftEt(%struct.State* noalias, i64, %struct.Memory* noalias) #1 {
entry:
  ...
  store %struct.Memory* %loadMem_415084, %struct.Memory** %MEMORY
  ...
  store i16 %61, i16* %65
  store %struct.Memory* %loadMem_41508b, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_41508f, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_415092, %struct.Memory** %MEMORY
  ...
  ret %struct.Memory* %loadMem_415093
}
