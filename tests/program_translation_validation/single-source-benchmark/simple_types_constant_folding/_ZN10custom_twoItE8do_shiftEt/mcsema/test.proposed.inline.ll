...
define %struct.Memory* @_ZN10custom_twoItE8do_shiftEt(%struct.State* noalias, i64, %struct.Memory* noalias) #2 {
entry:
  ...
  store %struct.Memory* %loadMem_415091, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_415094, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_415097, %struct.Memory** %MEMORY
  ...
  store i16 %61, i16* %65
  store %struct.Memory* %loadMem_41509b, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_4150a2, %struct.Memory** %MEMORY
  ...
  ret %struct.Memory* %loadMem_4150a3
}
