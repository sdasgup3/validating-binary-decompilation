...
entry:
  ...
  store %struct.Memory* %loadMem_415040, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_415044, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_415052, %struct.Memory** %MEMORY
  ...
  ret %struct.Memory* %loadMem_415053
}
