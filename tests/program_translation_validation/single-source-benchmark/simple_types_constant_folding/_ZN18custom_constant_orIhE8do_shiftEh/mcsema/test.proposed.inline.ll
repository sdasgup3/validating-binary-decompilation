...
define %struct.Memory* @_ZN18custom_constant_orIhE8do_shiftEh(%struct.State* noalias, i64, %struct.Memory* noalias) #2 {
entry:
  ...
  store %struct.Memory* %loadMem_416620, %struct.Memory** %MEMORY
  ...
  store i8 %56, i8* %60
  store %struct.Memory* %loadMem_416627, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_41662a, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_41662e, %struct.Memory** %MEMORY
  ...
  %PC.i5 = bitcast %union.anon* %104 to i64*
  ...
  %AL.i6 = getelementptr inbounds %struct.anon.2, %struct.anon.2* %108, i32 0, i32 0
  ...
  store i8 %113, i8* %AL.i6, align 1
  store %struct.Memory* %loadMem_416631, %struct.Memory** %MEMORY
  ...
  %131 = and i64 %128, 255
  store i64 %131, i64* %RAX.i, align 8
  store %struct.Memory* %loadMem_416634, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_416637, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_416638, %struct.Memory** %MEMORY
  ret %struct.Memory* %loadMem_416638
}
