...
define %struct.Memory* @_ZN18custom_constant_orIhE8do_shiftEh(%struct.State* noalias, i64, %struct.Memory* noalias) #1 {
entry:
  ...
  store i8 %56, i8* %60
  store %struct.Memory* %loadMem_416617, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_41661a, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_416628, %struct.Memory** %MEMORY
  ret %struct.Memory* %loadMem_416628
}
