...
define %struct.Memory* @_ZN18custom_constant_orIiE8do_shiftEi(%struct.State* noalias, i64, %struct.Memory* noalias) #2 {
entry:
  ...
  store %struct.Memory* %loadMem_41305a, %struct.Memory** %MEMORY
  ...
  ret %struct.Memory* %loadMem_413060
}
