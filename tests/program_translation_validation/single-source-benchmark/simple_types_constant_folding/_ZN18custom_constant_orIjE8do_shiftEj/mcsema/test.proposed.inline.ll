...
define %struct.Memory* @_ZN18custom_constant_orIjE8do_shiftEj(%struct.State* noalias, i64, %struct.Memory* noalias) #1 {
entry:
  ...
  store i32 %40, i32* %44
  store %struct.Memory* %loadMem_412154, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_412157, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_41215a, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_41215f, %struct.Memory** %MEMORY
  ...
  ret %struct.Memory* %loadMem_412160
}
