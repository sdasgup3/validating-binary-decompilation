...
define %struct.Memory* @_ZN18custom_constant_orImE8do_shiftEm(%struct.State* noalias, i64, %struct.Memory* noalias) #1 {
entry:
  ...
  store %struct.Memory* %loadMem_40fcbc, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_40fcc3, %struct.Memory** %MEMORY
  ...
  ret %struct.Memory* %loadMem_40fcc4
}
