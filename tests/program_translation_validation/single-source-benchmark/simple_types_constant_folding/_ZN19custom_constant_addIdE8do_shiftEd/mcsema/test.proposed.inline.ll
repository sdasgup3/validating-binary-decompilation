...
entry:
  ...
  store %struct.Memory* %loadMem_40eca0, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_40eca1, %struct.Memory** %MEMORY
  %loadMem_40eca4 = load %struct.Memory*, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_40eca4, %struct.Memory** %MEMORY
  %loadMem_40ecac = load %struct.Memory*, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_40ecac, %struct.Memory** %MEMORY
  ...
  %loadMem_40ecb6 = load %struct.Memory*, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_40ecb6, %struct.Memory** %MEMORY
  %loadMem_40ecb9 = load %struct.Memory*, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_40ecb9, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_40ecba, %struct.Memory** %MEMORY
  ret %struct.Memory* %loadMem_40ecba
}
