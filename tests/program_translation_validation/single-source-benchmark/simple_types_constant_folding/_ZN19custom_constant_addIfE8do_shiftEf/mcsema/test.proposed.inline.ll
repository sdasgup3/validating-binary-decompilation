...
define %struct.Memory* @_ZN19custom_constant_addIfE8do_shiftEf(%struct.State* noalias, i64, %struct.Memory* noalias) #1 {
entry:
  ...
  store %struct.Memory* %loadMem_40f70a, %struct.Memory** %MEMORY
  ret %struct.Memory* %loadMem_40f70a
}
