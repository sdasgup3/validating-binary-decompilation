...
entry:
  ...
  %loadMem_416dc0 = load %struct.Memory*, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_416dc0, %struct.Memory** %MEMORY
  ...
  %loadMem_416dc4 = load %struct.Memory*, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_416dc4, %struct.Memory** %MEMORY
  %loadMem_416dc7 = load %struct.Memory*, %struct.Memory** %MEMORY
  ...
  store i8 %56, i8* %60
  store %struct.Memory* %loadMem_416dc7, %struct.Memory** %MEMORY
  ...
  ret %struct.Memory* %loadMem_416dd8
}
