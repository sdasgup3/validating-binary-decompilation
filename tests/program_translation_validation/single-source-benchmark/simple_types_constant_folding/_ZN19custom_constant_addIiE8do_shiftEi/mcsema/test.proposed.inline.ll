...
define %struct.Memory* @_ZN19custom_constant_addIiE8do_shiftEi(%struct.State* noalias, i64, %struct.Memory* noalias) #2 {
entry:
  ...
  store i32 %40, i32* %44
  store %struct.Memory* %loadMem_4136e4, %struct.Memory** %MEMORY
  ...
  ret %struct.Memory* %loadMem_4136f0
}
