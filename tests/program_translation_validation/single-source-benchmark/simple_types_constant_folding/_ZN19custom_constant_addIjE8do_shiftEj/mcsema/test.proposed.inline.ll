...
define %struct.Memory* @_ZN19custom_constant_addIjE8do_shiftEj(%struct.State* noalias, i64, %struct.Memory* noalias) #1 {
entry:
  ...
  %loadMem_4127dd = load %struct.Memory*, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_4127dd, %struct.Memory** %MEMORY
  %loadMem_4127df = load %struct.Memory*, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_4127df, %struct.Memory** %MEMORY
  ...
  ret %struct.Memory* %loadMem_4127e0
}
