...
define %struct.Memory* @_ZN19custom_constant_addIlE8do_shiftEl(%struct.State* noalias, i64, %struct.Memory* noalias) #2 {
entry:
  ...
  store i64 %40, i64* %43
  store %struct.Memory* %loadMem_4118a4, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_4118a8, %struct.Memory** %MEMORY
  ...
  ret %struct.Memory* %loadMem_4118b4
}
...
define %struct.Memory* @routine_addq__0xa___rdi(%struct.State* dereferenceable(3376), i64, %struct.Memory*) {
block_400488:
  %3 = getelementptr inbounds %struct.State, %struct.State* %0, i32 0, i32 6
  %4 = getelementptr inbounds %struct.GPR, %struct.GPR* %3, i32 0, i32 33
  %5 = getelementptr inbounds %struct.Reg, %struct.Reg* %4, i32 0, i32 0
