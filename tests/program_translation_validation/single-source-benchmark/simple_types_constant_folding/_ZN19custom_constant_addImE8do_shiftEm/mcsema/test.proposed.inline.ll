...
define %struct.Memory* @_ZN19custom_constant_addImE8do_shiftEm(%struct.State* noalias, i64, %struct.Memory* noalias) #1 {
entry:
  ...
  store %struct.Memory* %loadMem_4105f3, %struct.Memory** %MEMORY
  ...
  ret %struct.Memory* %loadMem_4105f4
}
