...
entry:
  ...
  store %struct.Memory* %loadMem_415af0, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_415af4, %struct.Memory** %MEMORY
  ...
  store i16 %53, i16* %57
  store %struct.Memory* %loadMem_415af7, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_415aff, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_415b05, %struct.Memory** %MEMORY
  ...
  ret %struct.Memory* %loadMem_415b07
}
