...
define %struct.Memory* @_ZN19custom_constant_addIsE8do_shiftEs(%struct.State* noalias nocapture, i64, %struct.Memory* noalias readnone returned) local_unnamed_addr #1 {
entry:
  ...
  %AX.i14 = bitcast %union.anon* %11 to i16*
  %12 = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 11, i32 0
  %DI.i15 = bitcast %union.anon* %12 to i16*
  %13 = load i16, i16* %DI.i15, align 2
  store i16 %13, i16* %AX.i14, align 2
  %14 = add i64 %7, -10
  %15 = add i64 %10, 10
  store i64 %15, i64* %3, align 8
  %16 = inttoptr i64 %14 to i16*
  store i16 %13, i16* %16, align 2
  %RDI.i8 = getelementptr inbounds %union.anon, %union.anon* %12, i64 0, i32 0
  ...
  store i64 %25, i64* %RDI.i8, align 8
  %26 = icmp ugt i16 %22, -11
  %27 = zext i1 %26 to i8
