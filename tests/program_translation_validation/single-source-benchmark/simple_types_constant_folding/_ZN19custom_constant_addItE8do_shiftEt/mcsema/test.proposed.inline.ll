...
entry:
  ...
  %loadMem_414835 = load %struct.Memory*, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_414835, %struct.Memory** %MEMORY
  ...
  %loadMem_414839 = load %struct.Memory*, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_414839, %struct.Memory** %MEMORY
  ret %struct.Memory* %loadMem_414839
}
