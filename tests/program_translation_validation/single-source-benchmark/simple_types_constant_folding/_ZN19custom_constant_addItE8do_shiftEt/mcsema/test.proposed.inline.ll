...
define %struct.Memory* @_ZN19custom_constant_addItE8do_shiftEt(%struct.State* noalias, i64, %struct.Memory* noalias) #1 {
entry:
  ...
  %loadMem_414810 = load %struct.Memory*, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_414810, %struct.Memory** %MEMORY
  %loadMem_414811 = load %struct.Memory*, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_414811, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_414814, %struct.Memory** %MEMORY
  ...
  %loadMem_41481f = load %struct.Memory*, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_41481f, %struct.Memory** %MEMORY
  ...
  ret %struct.Memory* %loadMem_414829
}
