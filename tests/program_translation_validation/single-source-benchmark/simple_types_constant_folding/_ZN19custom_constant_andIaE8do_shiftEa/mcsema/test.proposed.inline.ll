...
define %struct.Memory* @_ZN19custom_constant_andIaE8do_shiftEa(%struct.State* noalias, i64, %struct.Memory* noalias) #2 {
entry:
  ...
  store %struct.Memory* %loadMem_4179d4, %struct.Memory** %MEMORY
  ...
  store i8 %56, i8* %60
  store %struct.Memory* %loadMem_4179d7, %struct.Memory** %MEMORY
  ...
  store i64 %87, i64* %RDI.i, align 8
  ...
  store %struct.Memory* %loadMem_4179de, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_4179e1, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_4179e7, %struct.Memory** %MEMORY
  ...
  ret %struct.Memory* %loadMem_4179e8
}
