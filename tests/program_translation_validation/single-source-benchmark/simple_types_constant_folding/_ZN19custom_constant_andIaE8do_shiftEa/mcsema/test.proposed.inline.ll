...
define %struct.Memory* @_ZN19custom_constant_andIaE8do_shiftEa(%struct.State* noalias, i64, %struct.Memory* noalias) #1 {
entry:
  ...
  store %struct.Memory* %loadMem_417a1a, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_417a1e, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_417a28, %struct.Memory** %MEMORY
  ret %struct.Memory* %loadMem_417a28
}
