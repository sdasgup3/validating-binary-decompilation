...
entry:
  ...
  store %struct.Memory* %loadMem_41670a, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_416717, %struct.Memory** %MEMORY
  %loadMem_416718 = load %struct.Memory*, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_416718, %struct.Memory** %MEMORY
  ret %struct.Memory* %loadMem_416718
}
