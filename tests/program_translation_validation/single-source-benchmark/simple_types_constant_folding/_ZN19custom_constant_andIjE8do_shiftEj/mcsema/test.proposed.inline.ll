...
define %struct.Memory* @_ZN19custom_constant_andIjE8do_shiftEj(%struct.State* noalias, i64, %struct.Memory* noalias) #2 {
entry:
  ...
  store %struct.Memory* %loadMem_41226d, %struct.Memory** %MEMORY
  ...
  ret %struct.Memory* %loadMem_412270
}
