...
define %struct.Memory* @_ZN19custom_constant_andIlE8do_shiftEl(%struct.State* noalias, i64, %struct.Memory* noalias) #2 {
entry:
  ...
  store %struct.Memory* %loadMem_4112f4, %struct.Memory** %MEMORY
  ret %struct.Memory* %loadMem_4112f4
}
