...
define %struct.Memory* @_ZN19custom_constant_andImE8do_shiftEm(%struct.State* noalias, i64, %struct.Memory* noalias) #2 {
entry:
  ...
  %loadMem_40fe38 = load %struct.Memory*, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_40fe38, %struct.Memory** %MEMORY
  ...
  %loadMem_40fe40 = load %struct.Memory*, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_40fe40, %struct.Memory** %MEMORY
  %loadMem_40fe43 = load %struct.Memory*, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_40fe43, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_40fe44, %struct.Memory** %MEMORY
  ret %struct.Memory* %loadMem_40fe44
}
