...
define %struct.Memory* @_ZN19custom_constant_andIsE8do_shiftEs(%struct.State* noalias, i64, %struct.Memory* noalias) #2 {
entry:
  ...
  %AX.i = bitcast %union.anon* %104 to i16*
  %105 = getelementptr inbounds %struct.State, %struct.State* %0, i32 0, i32 6
  %106 = getelementptr inbounds %struct.GPR, %struct.GPR* %105, i32 0, i32 11
  %107 = getelementptr inbounds %struct.Reg, %struct.Reg* %106, i32 0, i32 0
  %DI.i = bitcast %union.anon* %107 to i16*
  %108 = load i16, i16* %DI.i
  %109 = zext i16 %108 to i64
  %110 = load i64, i64* %PC.i5
  %111 = add i64 %110, 3
  store i64 %111, i64* %PC.i5
  store i16 %108, i16* %AX.i, align 2
  store %struct.Memory* %loadMem_415492, %struct.Memory** %MEMORY
  ...
  %119 = bitcast %union.anon* %117 to i16*
  ...
  store %struct.Memory* %loadMem_415496, %struct.Memory** %MEMORY
  ...
  ret %struct.Memory* %loadMem_415497
}
