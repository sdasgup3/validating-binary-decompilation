...
define %struct.Memory* @_ZN19custom_constant_subIaE8do_shiftEa(%struct.State* noalias, i64, %struct.Memory* noalias) #2 {
entry:
  ...
  store %struct.Memory* %loadMem_417f20, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_417f21, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_417f24, %struct.Memory** %MEMORY
  ...
  store i8 %56, i8* %60
  store %struct.Memory* %loadMem_417f27, %struct.Memory** %MEMORY
  ...
  %PC.i5 = bitcast %union.anon* %120 to i64*
  ...
  %AL.i6 = getelementptr inbounds %struct.anon.2, %struct.anon.2* %124, i32 0, i32 0
  ...
  %DIL.i = getelementptr inbounds %struct.anon.2, %struct.anon.2* %128, i32 0, i32 0
  %129 = load i8, i8* %DIL.i
  %130 = zext i8 %129 to i64
  %131 = load i64, i64* %PC.i5
  %132 = add i64 %131, 3
  store i64 %132, i64* %PC.i5
  store i8 %129, i8* %AL.i6, align 1
  store %struct.Memory* %loadMem_417f31, %struct.Memory** %MEMORY
  ...
  %PC.i4 = bitcast %union.anon* %135 to i64*
  ...
  %AL.i = getelementptr inbounds %struct.anon.2, %struct.anon.2* %139, i32 0, i32 0
  ...
  %145 = load i64, i64* %PC.i4
  %146 = add i64 %145, 3
  store i64 %146, i64* %PC.i4
  %147 = trunc i64 %144 to i32
  %148 = shl i32 %147, 24
  %149 = ashr exact i32 %148, 24
  %150 = zext i32 %149 to i64
  store i64 %150, i64* %RAX.i, align 8
  store %struct.Memory* %loadMem_417f34, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_417f37, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_417f38, %struct.Memory** %MEMORY
  ret %struct.Memory* %loadMem_417f38
}
