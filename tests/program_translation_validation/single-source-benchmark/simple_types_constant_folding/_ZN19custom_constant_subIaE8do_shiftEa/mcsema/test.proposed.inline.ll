...
entry:
  ...
  store %struct.Memory* %loadMem_417f7a, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_417f7e, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_417f87, %struct.Memory** %MEMORY
  ...
  ret %struct.Memory* %loadMem_417f88
}
