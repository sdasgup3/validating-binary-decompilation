...
define %struct.Memory* @_ZN19custom_constant_subIdE8do_shiftEd(%struct.State* noalias, i64, %struct.Memory* noalias) #1 {
entry:
  ...
  store %struct.Memory* %loadMem_40eb6c, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_40eb76, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_40eb7a, %struct.Memory** %MEMORY
  ...
  ret %struct.Memory* %loadMem_40eb7b
}
