...
define %struct.Memory* @_ZN19custom_constant_subIfE8do_shiftEf(%struct.State* noalias, i64, %struct.Memory* noalias) #1 {
entry:
  ...
  store %struct.Memory* %loadMem_40f5b4, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_40f5ca, %struct.Memory** %MEMORY
  ...
  ret %struct.Memory* %loadMem_40f5cb
}
