...
define %struct.Memory* @_ZN19custom_constant_subIiE8do_shiftEi(%struct.State* noalias, i64, %struct.Memory* noalias) #2 {
entry:
  ...
  store i32 %40, i32* %44
  store %struct.Memory* %loadMem_413634, %struct.Memory** %MEMORY
  ...
  %loadMem_41363f = load %struct.Memory*, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_41363f, %struct.Memory** %MEMORY
  ...
  ret %struct.Memory* %loadMem_413640
}
