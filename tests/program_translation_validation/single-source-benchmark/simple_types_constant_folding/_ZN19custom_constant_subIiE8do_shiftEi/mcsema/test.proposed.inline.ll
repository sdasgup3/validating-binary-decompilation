...
define %struct.Memory* @_ZN19custom_constant_subIiE8do_shiftEi(%struct.State* noalias, i64, %struct.Memory* noalias) #1 {
entry:
  ...
  %loadMem_413620 = load %struct.Memory*, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_413620, %struct.Memory** %MEMORY
  ...
  ret %struct.Memory* %loadMem_413630
}
