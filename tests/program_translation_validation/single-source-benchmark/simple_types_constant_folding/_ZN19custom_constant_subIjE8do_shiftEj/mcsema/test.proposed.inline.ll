...
define %struct.Memory* @_ZN19custom_constant_subIjE8do_shiftEj(%struct.State* noalias, i64, %struct.Memory* noalias) #2 {
entry:
  ...
  %loadMem_4126ea = load %struct.Memory*, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_4126ea, %struct.Memory** %MEMORY
  ...
  %PC.i4 = bitcast %union.anon* %103 to i64*
  ...
  %112 = load i64, i64* %PC.i4
  %113 = add i64 %112, 2
  store i64 %113, i64* %PC.i4
  ...
  %PC.i2 = bitcast %union.anon* %117 to i64*
  %118 = getelementptr inbounds %struct.State, %struct.State* %0, i32 0, i32 6
  %119 = getelementptr inbounds %struct.GPR, %struct.GPR* %118, i32 0, i32 15
  %120 = getelementptr inbounds %struct.Reg, %struct.Reg* %119, i32 0, i32 0
  %RBP.i3 = bitcast %union.anon* %120 to i64*
  %121 = load i64, i64* %PC.i2
  %122 = add i64 %121, 1
  store i64 %122, i64* %PC.i2
  ...
  store i64 %127, i64* %RBP.i3, align 8
  ...
  %PC.i1 = bitcast %union.anon* %130 to i64*
  %131 = load i64, i64* %PC.i1
  %132 = add i64 %131, 1
  store i64 %132, i64* %PC.i1
  ...
  ret %struct.Memory* %loadMem_4126f0
}
