...
entry:
  ...
  store %struct.Memory* %loadMem_411740, %struct.Memory** %MEMORY
  ...
  %loadMem_411748 = load %struct.Memory*, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_411748, %struct.Memory** %MEMORY
  ...
  %loadMem_411754 = load %struct.Memory*, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_411754, %struct.Memory** %MEMORY
  ret %struct.Memory* %loadMem_411754
}
