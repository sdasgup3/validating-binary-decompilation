...
entry:
  ...
  store %struct.Memory* %loadMem_410431, %struct.Memory** %MEMORY
  %loadMem_410434 = load %struct.Memory*, %struct.Memory** %MEMORY
  ...
  store i64 %40, i64* %43
  store %struct.Memory* %loadMem_410434, %struct.Memory** %MEMORY
  %loadMem_410438 = load %struct.Memory*, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_410438, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_41043c, %struct.Memory** %MEMORY
  ...
  %loadMem_410444 = load %struct.Memory*, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_410444, %struct.Memory** %MEMORY
  ret %struct.Memory* %loadMem_410444
}
