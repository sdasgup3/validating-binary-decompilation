...
define %struct.Memory* @_ZN19custom_constant_subImE8do_shiftEm(%struct.State* noalias, i64, %struct.Memory* noalias) #1 {
entry:
  ...
  %loadMem_410470 = load %struct.Memory*, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_410470, %struct.Memory** %MEMORY
  %loadMem_410471 = load %struct.Memory*, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_410471, %struct.Memory** %MEMORY
  ...
  %loadMem_41047c = load %struct.Memory*, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_41047c, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_410483, %struct.Memory** %MEMORY
  ...
  ret %struct.Memory* %loadMem_410484
}
