...
define %struct.Memory* @_ZN19custom_constant_subIsE8do_shiftEs(%struct.State* noalias, i64, %struct.Memory* noalias) #2 {
entry:
  ...
  store %struct.Memory* %loadMem_4159d0, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_4159db, %struct.Memory** %MEMORY
  ...
  %134 = getelementptr inbounds %union.anon, %union.anon* %133, i64 0, i32 0
  %135 = bitcast %union.anon* %133 to i16*
  ...
  ret %struct.Memory* %loadMem_4159e7
}
