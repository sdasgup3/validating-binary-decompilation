...
define %struct.Memory* @_ZN19custom_constant_subItE8do_shiftEt(%struct.State* noalias, i64, %struct.Memory* noalias) #2 {
entry:
  ...
  store %struct.Memory* %loadMem_4146a0, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_4146a1, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_4146a4, %struct.Memory** %MEMORY
  ...
  store i16 %53, i16* %57
  store %struct.Memory* %loadMem_4146a7, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_4146af, %struct.Memory** %MEMORY
  ...
  %AX.i6 = bitcast %union.anon* %119 to i16*
  ...
  store i16 %123, i16* %AX.i6, align 2
  store %struct.Memory* %loadMem_4146b2, %struct.Memory** %MEMORY
  ...
  %AX.i = bitcast %union.anon* %132 to i16*
  ...
  store %struct.Memory* %loadMem_4146b5, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_4146b8, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_4146b9, %struct.Memory** %MEMORY
  ret %struct.Memory* %loadMem_4146b9
}
