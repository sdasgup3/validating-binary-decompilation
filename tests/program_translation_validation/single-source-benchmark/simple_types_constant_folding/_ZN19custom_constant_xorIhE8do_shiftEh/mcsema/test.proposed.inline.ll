...
entry:
  ...
  store %struct.Memory* %loadMem_4164a0, %struct.Memory** %MEMORY
  ...
  %loadMem_4164aa = load %struct.Memory*, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_4164aa, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_4164ae, %struct.Memory** %MEMORY
  ...
  %loadMem_4164b8 = load %struct.Memory*, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_4164b8, %struct.Memory** %MEMORY
  ret %struct.Memory* %loadMem_4164b8
}
