...
entry:
  ...
  store %struct.Memory* %loadMem_4164f0, %struct.Memory** %MEMORY
  ...
  %loadMem_4164fa = load %struct.Memory*, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_4164fa, %struct.Memory** %MEMORY
  %loadMem_4164fe = load %struct.Memory*, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_4164fe, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_416507, %struct.Memory** %MEMORY
  ...
  ret %struct.Memory* %loadMem_416508
}
