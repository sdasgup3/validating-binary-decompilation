...
define %struct.Memory* @_ZN19custom_constant_xorIiE8do_shiftEi(%struct.State* noalias, i64, %struct.Memory* noalias) #2 {
entry:
  ...
  store %struct.Memory* %loadMem_412faf, %struct.Memory** %MEMORY
  ...
  ret %struct.Memory* %loadMem_412fb0
}
