...
entry:
  ...
  store %struct.Memory* %loadMem_412010, %struct.Memory** %MEMORY
  %loadMem_412011 = load %struct.Memory*, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_412011, %struct.Memory** %MEMORY
  ...
  store i32 %40, i32* %44
  store %struct.Memory* %loadMem_412014, %struct.Memory** %MEMORY
  %loadMem_412017 = load %struct.Memory*, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_412017, %struct.Memory** %MEMORY
  %loadMem_41201a = load %struct.Memory*, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_41201a, %struct.Memory** %MEMORY
  ...
  %loadMem_41201f = load %struct.Memory*, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_41201f, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_412020, %struct.Memory** %MEMORY
  ret %struct.Memory* %loadMem_412020
}
