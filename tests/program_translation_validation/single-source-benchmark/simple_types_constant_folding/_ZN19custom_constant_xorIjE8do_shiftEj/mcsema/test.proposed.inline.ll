...
define %struct.Memory* @_ZN19custom_constant_xorIjE8do_shiftEj(%struct.State* noalias, i64, %struct.Memory* noalias) #1 {
entry:
  ...
  %loadMem_412051 = load %struct.Memory*, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_412051, %struct.Memory** %MEMORY
  ...
  store i32 %40, i32* %44
  store %struct.Memory* %loadMem_412054, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_412057, %struct.Memory** %MEMORY
  %loadMem_41205a = load %struct.Memory*, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_41205a, %struct.Memory** %MEMORY
  %loadMem_41205d = load %struct.Memory*, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_41205d, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_41205f, %struct.Memory** %MEMORY
  ...
  ret %struct.Memory* %loadMem_412060
}
