...
define %struct.Memory* @_ZN19custom_constant_xorIjE8do_shiftEj(%struct.State* noalias nocapture, i64, %struct.Memory* noalias readnone returned) local_unnamed_addr #1 {
entry:
