...
define %struct.Memory* @_ZN19custom_constant_xorIlE8do_shiftEl(%struct.State* noalias, i64, %struct.Memory* noalias) #1 {
entry:
  ...
  store %struct.Memory* %loadMem_4110b0, %struct.Memory** %MEMORY
  ...
  store i64 %40, i64* %43
  store %struct.Memory* %loadMem_4110b4, %struct.Memory** %MEMORY
  ...
  ret %struct.Memory* %loadMem_4110c4
}
