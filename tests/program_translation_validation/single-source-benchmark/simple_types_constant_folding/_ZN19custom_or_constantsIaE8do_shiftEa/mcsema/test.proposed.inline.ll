...
define %struct.Memory* @_ZN19custom_or_constantsIaE8do_shiftEa(%struct.State* noalias, i64, %struct.Memory* noalias) #2 {
entry:
  ...
  store %struct.Memory* %loadMem_4181c4, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_4181c7, %struct.Memory** %MEMORY
  ...
  store i8 %65, i8* %69
  store %struct.Memory* %loadMem_4181c9, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_4181cc, %struct.Memory** %MEMORY
  ...
  ret %struct.Memory* %loadMem_4181d0
}
