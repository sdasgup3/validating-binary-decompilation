...
define %struct.Memory* @_ZN19custom_or_constantsIaE8do_shiftEa(%struct.State* noalias, i64, %struct.Memory* noalias) #1 {
entry:
  ...
  store %struct.Memory* %loadMem_4181b1, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_4181b7, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_4181bc, %struct.Memory** %MEMORY
  ...
  ret %struct.Memory* %loadMem_4181c0
}
