...
define %struct.Memory* @_ZN19custom_or_constantsIhE8do_shiftEh(%struct.State* noalias, i64, %struct.Memory* noalias) #2 {
entry:
  ...
  %loadMem_416ef4 = load %struct.Memory*, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_416ef4, %struct.Memory** %MEMORY
  %loadMem_416ef7 = load %struct.Memory*, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_416ef7, %struct.Memory** %MEMORY
  ...
  %loadMem_416efc = load %struct.Memory*, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_416efc, %struct.Memory** %MEMORY
  ...
  ret %struct.Memory* %loadMem_416f00
}
