...
define %struct.Memory* @_ZN19custom_or_constantsIiE8do_shiftEi(%struct.State* noalias, i64, %struct.Memory* noalias) #1 {
entry:
  ...
  store %struct.Memory* %loadMem_413810, %struct.Memory** %MEMORY
  ...
  ret %struct.Memory* %loadMem_41381d
}
