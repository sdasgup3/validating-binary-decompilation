...
define %struct.Memory* @_ZN19custom_or_constantsIlE8do_shiftEl(%struct.State* noalias, i64, %struct.Memory* noalias) #1 {
entry:
  ...
  store %struct.Memory* %loadMem_411984, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_41198d, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_41198e, %struct.Memory** %MEMORY
  ret %struct.Memory* %loadMem_41198e
}
