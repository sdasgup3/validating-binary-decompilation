...
define %struct.Memory* @_ZN19custom_or_constantsIlE8do_shiftEl(%struct.State* noalias, i64, %struct.Memory* noalias) #2 {
entry:
  ...
  store %struct.Memory* %loadMem_411990, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_411991, %struct.Memory** %MEMORY
  ...
  store i64 31, i64* %RAX.i, align 8
  store %struct.Memory* %loadMem_411994, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_41199d, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_41199e, %struct.Memory** %MEMORY
  ret %struct.Memory* %loadMem_41199e
}
