...
define %struct.Memory* @_ZN19custom_or_constantsImE8do_shiftEm(%struct.State* noalias, i64, %struct.Memory* noalias) #2 {
entry:
  ...
  store %struct.Memory* %loadMem_41074e, %struct.Memory** %MEMORY
  ret %struct.Memory* %loadMem_41074e
}
