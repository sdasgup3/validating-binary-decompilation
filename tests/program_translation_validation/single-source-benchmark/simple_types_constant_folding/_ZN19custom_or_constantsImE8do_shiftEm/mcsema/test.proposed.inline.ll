...
define %struct.Memory* @_ZN19custom_or_constantsImE8do_shiftEm(%struct.State* noalias, i64, %struct.Memory* noalias) #1 {
entry:
  ...
  store %struct.Memory* %loadMem_410730, %struct.Memory** %MEMORY
  ...
  ret %struct.Memory* %loadMem_41073e
}
