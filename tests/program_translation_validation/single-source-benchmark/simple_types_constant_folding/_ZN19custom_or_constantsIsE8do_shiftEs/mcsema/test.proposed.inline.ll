...
entry:
  ...
  %loadMem_415c24 = load %struct.Memory*, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_415c24, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_415c27, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_415c2f, %struct.Memory** %MEMORY
  ...
  ret %struct.Memory* %loadMem_415c33
}
