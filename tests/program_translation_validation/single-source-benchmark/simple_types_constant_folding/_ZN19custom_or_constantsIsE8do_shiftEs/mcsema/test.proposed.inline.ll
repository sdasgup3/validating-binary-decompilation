...
define %struct.Memory* @_ZN19custom_or_constantsIsE8do_shiftEs(%struct.State* noalias, i64, %struct.Memory* noalias) #2 {
entry:
  ...
  store i16 31, i16* %CX.i8, align 2
  store %struct.Memory* %loadMem_415bd7, %struct.Memory** %MEMORY
  %loadMem_415bdb = load %struct.Memory*, %struct.Memory** %MEMORY
  ...
  store i16 %61, i16* %65
  store %struct.Memory* %loadMem_415bdb, %struct.Memory** %MEMORY
  %loadMem_415bdf = load %struct.Memory*, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_415bdf, %struct.Memory** %MEMORY
  ...
  ret %struct.Memory* %loadMem_415be3
}
...
define %struct.Memory* @routine_movw__0x1f___cx(%struct.State* dereferenceable(3376), i64, %struct.Memory*) {
block_400478:
  %3 = getelementptr inbounds %struct.State, %struct.State* %0, i32 0, i32 6
  %4 = getelementptr inbounds %struct.GPR, %struct.GPR* %3, i32 0, i32 33
  %5 = getelementptr inbounds %struct.Reg, %struct.Reg* %4, i32 0, i32 0
