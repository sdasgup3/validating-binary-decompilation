...
define %struct.Memory* @_ZN19custom_or_constantsIsE8do_shiftEs(%struct.State* noalias, i64, %struct.Memory* noalias) #1 {
entry:
  ...
  %loadMem_415c1f = load %struct.Memory*, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_415c1f, %struct.Memory** %MEMORY
  ...
  ret %struct.Memory* %loadMem_415c23
}
