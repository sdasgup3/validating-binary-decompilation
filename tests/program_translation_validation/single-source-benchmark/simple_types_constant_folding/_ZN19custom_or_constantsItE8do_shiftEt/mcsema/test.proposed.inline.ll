...
entry:
  ...
  %loadMem_4148f0 = load %struct.Memory*, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_4148f0, %struct.Memory** %MEMORY
  ...
  %loadMem_4148fb = load %struct.Memory*, %struct.Memory** %MEMORY
  ...
  store i16 %61, i16* %65
  store %struct.Memory* %loadMem_4148fb, %struct.Memory** %MEMORY
  ...
  ret %struct.Memory* %loadMem_414903
}
