...
entry:
  ...
  store %struct.Memory* %loadMem_414947, %struct.Memory** %MEMORY
  ...
  %loadMem_414953 = load %struct.Memory*, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_414953, %struct.Memory** %MEMORY
  ret %struct.Memory* %loadMem_414953
}
