...
define %struct.Memory* @_ZN19custom_or_constantsItE8do_shiftEt(%struct.State* noalias, i64, %struct.Memory* noalias) #1 {
entry:
  ...
  store %struct.Memory* %loadMem_414930, %struct.Memory** %MEMORY
  %loadMem_414931 = load %struct.Memory*, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_414931, %struct.Memory** %MEMORY
  %loadMem_414934 = load %struct.Memory*, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_414934, %struct.Memory** %MEMORY
  ...
  %loadMem_41493b = load %struct.Memory*, %struct.Memory** %MEMORY
  ...
  store i16 %61, i16* %65
  store %struct.Memory* %loadMem_41493b, %struct.Memory** %MEMORY
  %loadMem_41493f = load %struct.Memory*, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_41493f, %struct.Memory** %MEMORY
  %loadMem_414942 = load %struct.Memory*, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_414942, %struct.Memory** %MEMORY
  ...
  ret %struct.Memory* %loadMem_414943
}
