...
define %struct.Memory* @_ZN20custom_add_constantsIaE8do_shiftEa(%struct.State* noalias, i64, %struct.Memory* noalias) #2 {
entry:
  ...
  store %struct.Memory* %loadMem_418881, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_418884, %struct.Memory** %MEMORY
  ...
  store i8 %65, i8* %69
  store %struct.Memory* %loadMem_418889, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_41888c, %struct.Memory** %MEMORY
  ...
  ret %struct.Memory* %loadMem_418890
}
