...
define %struct.Memory* @_ZN20custom_add_constantsIaE8do_shiftEa(%struct.State* noalias, i64, %struct.Memory* noalias) #1 {
entry:
  ...
  store %struct.Memory* %loadMem_418877, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_41887f, %struct.Memory** %MEMORY
  ...
  ret %struct.Memory* %loadMem_418880
}
