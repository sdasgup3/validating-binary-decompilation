...
%G_0x9b74__rip__4255404__type = type <{ [16 x i8] }>
...
@G_0x9b74__rip__4255404_ = global %G_0x9b74__rip__4255404__type zeroinitializer
...
entry:
  ...
  %loadMem_40eea0 = load %struct.Memory*, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_40eea0, %struct.Memory** %MEMORY
  ...
  %38 = load double, double* bitcast (%G_0x9b74__rip__4255404__type* @G_0x9b74__rip__4255404_ to double*)
  ...
  %PC.i4 = bitcast %union.anon* %60 to i64*
  ...
  %YMM0.i = bitcast %union.VectorReg* %62 to %"class.std::bitset"*
  ...
  %XMM1.i = bitcast %union.VectorReg* %64 to %union.vec128_t*
  %65 = bitcast %"class.std::bitset"* %YMM0.i to i8*
  %66 = bitcast %union.vec128_t* %XMM1.i to i8*
  %67 = load i64, i64* %PC.i4
  %68 = add i64 %67, 3
  store i64 %68, i64* %PC.i4
  %69 = bitcast i8* %66 to <2 x i32>*
  ...
  %82 = extractelement <2 x i32> %73, i32 1
  ...
  ret %struct.Memory* %loadMem_40eeb5
}
...
block_400478:
  ...
  %9 = load i64, i64* %PC
  %10 = ptrtoint %G_0x9b74__rip__4255404__type* @G_0x9b74__rip__4255404_ to i64
  %11 = load i64, i64* %PC
  %12 = add i64 %11, 8
  store i64 %12, i64* %PC
