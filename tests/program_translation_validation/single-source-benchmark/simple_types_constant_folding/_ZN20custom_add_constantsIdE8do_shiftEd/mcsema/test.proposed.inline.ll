...
define %struct.Memory* @_ZN20custom_add_constantsIdE8do_shiftEd(%struct.State* noalias, i64, %struct.Memory* noalias) #1 {
entry:
  ...
  store %struct.Memory* %loadMem_40eee0, %struct.Memory** %MEMORY
  ...
  %loadMem_40eee4 = load %struct.Memory*, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_40eee4, %struct.Memory** %MEMORY
  ...
  ret %struct.Memory* %loadMem_40eef5
}
