...
define %struct.Memory* @_ZN20custom_add_constantsIdE8do_shiftEd(%struct.State* noalias nocapture, i64, %struct.Memory* noalias readnone returned) local_unnamed_addr #0 {
entry:
  ...
  %12 = add i64 %10, add (i64 ptrtoint (%G_0x9b74__rip__type* @G_0x9b74__rip_ to i64), i64 3)
  %13 = add i64 %10, 11
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_movsd_0x9b74__rip____xmm1(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned) local_unnamed_addr #1 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, ptrtoint (%G_0x9b74__rip__type* @G_0x9b74__rip_ to i64)
  %5 = add i64 %3, 8
  store i64 %5, i64* %PC, align 8
