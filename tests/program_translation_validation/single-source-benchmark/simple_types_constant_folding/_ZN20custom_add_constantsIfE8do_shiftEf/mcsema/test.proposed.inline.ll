...
define %struct.Memory* @_ZN20custom_add_constantsIfE8do_shiftEf(%struct.State* noalias, i64, %struct.Memory* noalias) #1 {
entry:
  ...
  store %struct.Memory* %loadMem_40f93c, %struct.Memory** %MEMORY
  ...
  ret %struct.Memory* %loadMem_40f945
}
