...
define %struct.Memory* @_ZN20custom_add_constantsIhE8do_shiftEh(%struct.State* noalias, i64, %struct.Memory* noalias) #1 {
entry:
  ...
  store %struct.Memory* %loadMem_4175a0, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_4175a4, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_4175a7, %struct.Memory** %MEMORY
  ...
  store i8 %65, i8* %69
  store %struct.Memory* %loadMem_4175a9, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_4175af, %struct.Memory** %MEMORY
  ...
  ret %struct.Memory* %loadMem_4175b0
}
