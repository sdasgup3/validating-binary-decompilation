...
define %struct.Memory* @_ZN20custom_add_constantsIiE8do_shiftEi(%struct.State* noalias, i64, %struct.Memory* noalias) #2 {
entry:
  ...
  store i32 %48, i32* %52
  store %struct.Memory* %loadMem_413d69, %struct.Memory** %MEMORY
  ...
  ret %struct.Memory* %loadMem_413d6d
}
