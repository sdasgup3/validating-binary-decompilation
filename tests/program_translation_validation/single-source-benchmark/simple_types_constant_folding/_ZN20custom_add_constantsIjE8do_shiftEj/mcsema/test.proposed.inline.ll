...
define %struct.Memory* @_ZN20custom_add_constantsIjE8do_shiftEj(%struct.State* noalias, i64, %struct.Memory* noalias) #2 {
entry:
  ...
  store i32 %48, i32* %52
  store %struct.Memory* %loadMem_412e19, %struct.Memory** %MEMORY
  ...
  ret %struct.Memory* %loadMem_412e1d
}
