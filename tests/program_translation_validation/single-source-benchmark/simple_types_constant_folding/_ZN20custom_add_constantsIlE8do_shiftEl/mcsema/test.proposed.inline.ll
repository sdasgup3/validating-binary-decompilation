...
define %struct.Memory* @_ZN20custom_add_constantsIlE8do_shiftEl(%struct.State* noalias, i64, %struct.Memory* noalias) #1 {
entry:
  ...
  store %struct.Memory* %loadMem_411ec1, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_411ecd, %struct.Memory** %MEMORY
  ...
  ret %struct.Memory* %loadMem_411ece
}
