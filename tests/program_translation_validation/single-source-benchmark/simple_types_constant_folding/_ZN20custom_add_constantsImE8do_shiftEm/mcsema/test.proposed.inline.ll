...
define %struct.Memory* @_ZN20custom_add_constantsImE8do_shiftEm(%struct.State* noalias, i64, %struct.Memory* noalias) #2 {
entry:
  ...
  %loadMem_410e70 = load %struct.Memory*, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_410e70, %struct.Memory** %MEMORY
  ...
  ret %struct.Memory* %loadMem_410e7e
}
