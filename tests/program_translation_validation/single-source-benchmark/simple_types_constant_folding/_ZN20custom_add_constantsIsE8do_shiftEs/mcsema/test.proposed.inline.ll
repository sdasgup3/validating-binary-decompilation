...
define %struct.Memory* @_ZN20custom_add_constantsIsE8do_shiftEs(%struct.State* noalias, i64, %struct.Memory* noalias) #2 {
entry:
  ...
  store %struct.Memory* %loadMem_4162e0, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_4162e1, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_4162e4, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_4162e7, %struct.Memory** %MEMORY
  ...
  store i16 %61, i16* %65
  store %struct.Memory* %loadMem_4162eb, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_4162ef, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_4162f3, %struct.Memory** %MEMORY
  ret %struct.Memory* %loadMem_4162f3
}
...
define %struct.Memory* @routine_movw__0x3___cx(%struct.State* dereferenceable(3376), i64, %struct.Memory*) {
block_400488:
  %3 = getelementptr inbounds %struct.State, %struct.State* %0, i32 0, i32 6
  %4 = getelementptr inbounds %struct.GPR, %struct.GPR* %3, i32 0, i32 33
  %5 = getelementptr inbounds %struct.Reg, %struct.Reg* %4, i32 0, i32 0
