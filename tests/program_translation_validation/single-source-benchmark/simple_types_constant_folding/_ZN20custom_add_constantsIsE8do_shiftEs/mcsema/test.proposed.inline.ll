...
define %struct.Memory* @_ZN20custom_add_constantsIsE8do_shiftEs(%struct.State* noalias, i64, %struct.Memory* noalias) #1 {
entry:
  ...
  store %struct.Memory* %loadMem_4162d1, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_4162d4, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_4162d7, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_4162e3, %struct.Memory** %MEMORY
  ret %struct.Memory* %loadMem_4162e3
}
