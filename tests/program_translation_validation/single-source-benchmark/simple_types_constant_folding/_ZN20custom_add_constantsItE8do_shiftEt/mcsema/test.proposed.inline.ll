...
define %struct.Memory* @_ZN20custom_add_constantsItE8do_shiftEt(%struct.State* noalias, i64, %struct.Memory* noalias) #1 {
entry:
  ...
  store %struct.Memory* %loadMem_414ff0, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_414ff4, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_414ff7, %struct.Memory** %MEMORY
  ...
  store i16 %61, i16* %65
  store %struct.Memory* %loadMem_414ffb, %struct.Memory** %MEMORY
  ...
  ret %struct.Memory* %loadMem_415003
}
