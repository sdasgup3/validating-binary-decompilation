...
define %struct.Memory* @_ZN20custom_add_constantsItE8do_shiftEt(%struct.State* noalias, i64, %struct.Memory* noalias) #2 {
entry:
  ...
  store %struct.Memory* %loadMem_415000, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_415001, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_415004, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_415007, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_415012, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_415013, %struct.Memory** %MEMORY
  ret %struct.Memory* %loadMem_415013
}
