...
entry:
  ...
  store %struct.Memory* %loadMem_414fb0, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_414fb7, %struct.Memory** %MEMORY
  ...
  store i16 %61, i16* %65
  store %struct.Memory* %loadMem_414fbb, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_414fc2, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_414fc3, %struct.Memory** %MEMORY
  ret %struct.Memory* %loadMem_414fc3
}
