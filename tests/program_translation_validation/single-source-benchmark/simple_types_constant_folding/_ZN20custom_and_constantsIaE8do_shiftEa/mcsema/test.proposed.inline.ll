...
define %struct.Memory* @_ZN20custom_and_constantsIaE8do_shiftEa(%struct.State* noalias, i64, %struct.Memory* noalias) #2 {
entry:
  ...
  store %struct.Memory* %loadMem_418251, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_418254, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_418257, %struct.Memory** %MEMORY
  ...
  store i8 %65, i8* %69
  store %struct.Memory* %loadMem_418259, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_41825c, %struct.Memory** %MEMORY
  ...
  ret %struct.Memory* %loadMem_418260
}
