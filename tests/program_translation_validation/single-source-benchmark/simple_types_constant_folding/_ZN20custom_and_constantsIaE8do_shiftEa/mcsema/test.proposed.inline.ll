...
define %struct.Memory* @_ZN20custom_and_constantsIaE8do_shiftEa(%struct.State* noalias, i64, %struct.Memory* noalias) #1 {
entry:
  ...
  store %struct.Memory* %loadMem_418241, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_418247, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_41824f, %struct.Memory** %MEMORY
  ...
  ret %struct.Memory* %loadMem_418250
}
