...
define %struct.Memory* @_ZN20custom_and_constantsIiE8do_shiftEi(%struct.State* noalias, i64, %struct.Memory* noalias) #2 {
entry:
  ...
  %loadMem_41389d = load %struct.Memory*, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_41389d, %struct.Memory** %MEMORY
  ret %struct.Memory* %loadMem_41389d
}
