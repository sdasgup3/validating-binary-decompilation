...
define %struct.Memory* @_ZN20custom_and_constantsIlE8do_shiftEl(%struct.State* noalias, i64, %struct.Memory* noalias) #2 {
entry:
  ...
  store %struct.Memory* %loadMem_4119be, %struct.Memory** %MEMORY
  ret %struct.Memory* %loadMem_4119be
}
