...
entry:
  ...
  store i64 %48, i64* %51
  store %struct.Memory* %loadMem_4107e9, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_4107ed, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_4107ee, %struct.Memory** %MEMORY
  ret %struct.Memory* %loadMem_4107ee
}
