...
define %struct.Memory* @_ZN20custom_and_constantsImE8do_shiftEm(%struct.State* noalias, i64, %struct.Memory* noalias) #2 {
entry:
  ...
  store %struct.Memory* %loadMem_410790, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_410791, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_410794, %struct.Memory** %MEMORY
  ...
  store i64 %48, i64* %51
  store %struct.Memory* %loadMem_410799, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_41079d, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_41079e, %struct.Memory** %MEMORY
  ret %struct.Memory* %loadMem_41079e
}
