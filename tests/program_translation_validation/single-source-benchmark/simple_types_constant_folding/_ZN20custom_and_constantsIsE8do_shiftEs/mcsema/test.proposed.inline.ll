...
define %struct.Memory* @_ZN20custom_and_constantsIsE8do_shiftEs(%struct.State* noalias, i64, %struct.Memory* noalias) #1 {
entry:
  ...
  store %struct.Memory* %loadMem_415ca1, %struct.Memory** %MEMORY
  %loadMem_415ca4 = load %struct.Memory*, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_415ca4, %struct.Memory** %MEMORY
  ...
  %loadMem_415cb3 = load %struct.Memory*, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_415cb3, %struct.Memory** %MEMORY
  ret %struct.Memory* %loadMem_415cb3
}
