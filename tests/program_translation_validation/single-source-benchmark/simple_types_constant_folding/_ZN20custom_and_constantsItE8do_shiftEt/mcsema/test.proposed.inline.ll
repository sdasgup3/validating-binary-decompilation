...
define %struct.Memory* @_ZN20custom_and_constantsItE8do_shiftEt(%struct.State* noalias, i64, %struct.Memory* noalias) #1 {
entry:
  ...
  %loadMem_4149cb = load %struct.Memory*, %struct.Memory** %MEMORY
  ...
  store i16 %61, i16* %65
  store %struct.Memory* %loadMem_4149cb, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_4149cf, %struct.Memory** %MEMORY
  ...
  %loadMem_4149d3 = load %struct.Memory*, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_4149d3, %struct.Memory** %MEMORY
  ret %struct.Memory* %loadMem_4149d3
}
