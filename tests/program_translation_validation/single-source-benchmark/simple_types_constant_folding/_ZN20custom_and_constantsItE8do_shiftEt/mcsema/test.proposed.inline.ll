...
define %struct.Memory* @_ZN20custom_and_constantsItE8do_shiftEt(%struct.State* noalias, i64, %struct.Memory* noalias) #2 {
entry:
  ...
  %loadMem_4149db = load %struct.Memory*, %struct.Memory** %MEMORY
  ...
  store i16 %61, i16* %65
  store %struct.Memory* %loadMem_4149db, %struct.Memory** %MEMORY
  %loadMem_4149df = load %struct.Memory*, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_4149df, %struct.Memory** %MEMORY
  ...
  %loadMem_4149e3 = load %struct.Memory*, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_4149e3, %struct.Memory** %MEMORY
  ret %struct.Memory* %loadMem_4149e3
}
