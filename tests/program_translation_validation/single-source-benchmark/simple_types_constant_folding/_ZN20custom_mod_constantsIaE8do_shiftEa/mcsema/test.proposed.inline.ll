...
define %struct.Memory* @_ZN20custom_mod_constantsIaE8do_shiftEa(%struct.State* noalias, i64, %struct.Memory* noalias) #2 {
entry:
  ...
  store %struct.Memory* %loadMem_418641, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_418644, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_418647, %struct.Memory** %MEMORY
  ...
  store i8 %65, i8* %69
  store %struct.Memory* %loadMem_418649, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_41864c, %struct.Memory** %MEMORY
  ...
  ret %struct.Memory* %loadMem_418650
}
