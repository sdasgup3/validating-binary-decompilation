...
entry:
  ...
  store %struct.Memory* %loadMem_4185f1, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_4185f4, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_4185f7, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_4185fc, %struct.Memory** %MEMORY
  ...
  ret %struct.Memory* %loadMem_418600
}
