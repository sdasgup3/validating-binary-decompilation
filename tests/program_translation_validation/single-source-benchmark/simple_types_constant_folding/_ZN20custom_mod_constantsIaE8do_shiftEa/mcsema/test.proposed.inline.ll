...
define %struct.Memory* @_ZN20custom_mod_constantsIaE8do_shiftEa(%struct.State* noalias, i64, %struct.Memory* noalias) #1 {
entry:
  ...
  store %struct.Memory* %loadMem_418631, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_418637, %struct.Memory** %MEMORY
  ...
  ret %struct.Memory* %loadMem_418640
}
