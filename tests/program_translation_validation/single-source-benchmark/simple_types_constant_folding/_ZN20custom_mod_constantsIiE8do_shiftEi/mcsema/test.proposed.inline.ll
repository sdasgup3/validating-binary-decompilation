...
define %struct.Memory* @_ZN20custom_mod_constantsIiE8do_shiftEi(%struct.State* noalias, i64, %struct.Memory* noalias) #1 {
entry:
  ...
  store %struct.Memory* %loadMem_413b94, %struct.Memory** %MEMORY
  ...
  store i32 %48, i32* %52
  store %struct.Memory* %loadMem_413b99, %struct.Memory** %MEMORY
  ...
  ret %struct.Memory* %loadMem_413b9d
}
