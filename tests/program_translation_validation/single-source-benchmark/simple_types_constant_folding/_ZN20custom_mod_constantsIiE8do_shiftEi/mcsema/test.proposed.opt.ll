...
define %struct.Memory* @_ZN20custom_mod_constantsIiE8do_shiftEi(%struct.State* noalias nocapture, i64, %struct.Memory* noalias readnone returned) local_unnamed_addr #0 {
entry:
