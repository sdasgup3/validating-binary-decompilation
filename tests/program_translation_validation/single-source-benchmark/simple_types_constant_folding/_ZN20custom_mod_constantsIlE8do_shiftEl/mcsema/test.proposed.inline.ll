...
define %struct.Memory* @_ZN20custom_mod_constantsIlE8do_shiftEl(%struct.State* noalias, i64, %struct.Memory* noalias) #1 {
entry:
  ...
  store %struct.Memory* %loadMem_411d0d, %struct.Memory** %MEMORY
  ...
  ret %struct.Memory* %loadMem_411d0e
}
