...
entry:
  ...
  store %struct.Memory* %loadMem_4160a0, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_4160a1, %struct.Memory** %MEMORY
  ...
  store i16 %61, i16* %65
  store %struct.Memory* %loadMem_4160ab, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_4160af, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_4160b2, %struct.Memory** %MEMORY
  ...
  ret %struct.Memory* %loadMem_4160b3
}
