...
define %struct.Memory* @_ZN20custom_mod_constantsIsE8do_shiftEs(%struct.State* noalias, i64, %struct.Memory* noalias) #1 {
entry:
  ...
  store %struct.Memory* %loadMem_416090, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_416091, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_416094, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_416097, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_41609f, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_4160a2, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_4160a3, %struct.Memory** %MEMORY
  ret %struct.Memory* %loadMem_4160a3
}
