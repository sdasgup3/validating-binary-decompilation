...
entry:
  ...
  store i16 %61, i16* %65
  store %struct.Memory* %loadMem_414d7b, %struct.Memory** %MEMORY
  ...
  %loadMem_414d82 = load %struct.Memory*, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_414d82, %struct.Memory** %MEMORY
  ...
  ret %struct.Memory* %loadMem_414d83
}
