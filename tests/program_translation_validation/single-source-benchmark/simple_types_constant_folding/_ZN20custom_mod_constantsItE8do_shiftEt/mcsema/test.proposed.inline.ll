...
define %struct.Memory* @_ZN20custom_mod_constantsItE8do_shiftEt(%struct.State* noalias, i64, %struct.Memory* noalias) #1 {
entry:
  ...
  %loadMem_414db0 = load %struct.Memory*, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_414db0, %struct.Memory** %MEMORY
  %loadMem_414db1 = load %struct.Memory*, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_414db1, %struct.Memory** %MEMORY
  %loadMem_414db4 = load %struct.Memory*, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_414db4, %struct.Memory** %MEMORY
  ...
  ret %struct.Memory* %loadMem_414dc3
}
