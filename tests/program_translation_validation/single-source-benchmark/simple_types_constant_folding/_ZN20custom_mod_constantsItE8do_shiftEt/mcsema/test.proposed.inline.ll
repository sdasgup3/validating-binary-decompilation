...
entry:
  ...
  store %struct.Memory* %loadMem_414dd2, %struct.Memory** %MEMORY
  %loadMem_414dd3 = load %struct.Memory*, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_414dd3, %struct.Memory** %MEMORY
  ret %struct.Memory* %loadMem_414dd3
}
