...
define %struct.Memory* @_ZN20custom_sub_constantsIaE8do_shiftEa(%struct.State* noalias, i64, %struct.Memory* noalias) #1 {
entry:
  ...
  store %struct.Memory* %loadMem_4187e1, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_4187e7, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_4187ec, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_4187ef, %struct.Memory** %MEMORY
  ...
  ret %struct.Memory* %loadMem_4187f0
}
