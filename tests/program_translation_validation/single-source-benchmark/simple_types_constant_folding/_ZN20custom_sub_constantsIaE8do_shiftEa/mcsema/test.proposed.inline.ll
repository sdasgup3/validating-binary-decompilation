...
define %struct.Memory* @_ZN20custom_sub_constantsIaE8do_shiftEa(%struct.State* noalias, i64, %struct.Memory* noalias) #2 {
entry:
  ...
  store %struct.Memory* %loadMem_4187a1, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_4187a4, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_4187a7, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_4187ac, %struct.Memory** %MEMORY
  ...
  ret %struct.Memory* %loadMem_4187b0
}
