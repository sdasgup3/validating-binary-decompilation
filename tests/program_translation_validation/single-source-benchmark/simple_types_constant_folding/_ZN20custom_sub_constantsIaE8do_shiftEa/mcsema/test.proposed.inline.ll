...
entry:
  ...
  store %struct.Memory* %loadMem_4187f7, %struct.Memory** %MEMORY
  ...
  store i8 %65, i8* %69
  store %struct.Memory* %loadMem_4187f9, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_4187fc, %struct.Memory** %MEMORY
  ...
  ret %struct.Memory* %loadMem_418800
}
