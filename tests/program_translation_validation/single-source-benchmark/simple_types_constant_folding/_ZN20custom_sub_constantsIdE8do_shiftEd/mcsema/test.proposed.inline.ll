...
define %struct.Memory* @_ZN20custom_sub_constantsIdE8do_shiftEd(%struct.State* noalias, i64, %struct.Memory* noalias) #1 {
entry:
  ...
  store %struct.Memory* %loadMem_40ee65, %struct.Memory** %MEMORY
  ret %struct.Memory* %loadMem_40ee65
}
