...
@G_0x9c14__rip__4255260_ = global %G_0x9c14__rip__4255260__type zeroinitializer
...
define %struct.Memory* @_ZN20custom_sub_constantsIdE8do_shiftEd(%struct.State* noalias, i64, %struct.Memory* noalias) #2 {
entry:
  ...
  %38 = load double, double* bitcast (%G_0x9c14__rip__4255260__type* @G_0x9c14__rip__4255260_ to double*)
  ...
  store %struct.Memory* %loadMem_40ee14, %struct.Memory** %MEMORY
  ...
  ret %struct.Memory* %loadMem_40ee25
}
...
define %struct.Memory* @routine_movsd_0x9c14__rip____xmm1(%struct.State* dereferenceable(3376), i64, %struct.Memory*) {
block_400478:
  %3 = getelementptr inbounds %struct.State, %struct.State* %0, i32 0, i32 6
  %4 = getelementptr inbounds %struct.GPR, %struct.GPR* %3, i32 0, i32 33
  %5 = getelementptr inbounds %struct.Reg, %struct.Reg* %4, i32 0, i32 0
