...
define %struct.Memory* @_ZN20custom_sub_constantsIfE8do_shiftEf(%struct.State* noalias, i64, %struct.Memory* noalias) #1 {
entry:
  ...
  store %struct.Memory* %loadMem_40f8a4, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_40f8b5, %struct.Memory** %MEMORY
  ret %struct.Memory* %loadMem_40f8b5
}
