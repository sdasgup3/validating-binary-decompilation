...
define %struct.Memory* @_ZN20custom_sub_constantsIhE8do_shiftEh(%struct.State* noalias, i64, %struct.Memory* noalias) #1 {
entry:
  ...
  store %struct.Memory* %loadMem_417514, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_417517, %struct.Memory** %MEMORY
  ...
  store i8 %65, i8* %69
  store %struct.Memory* %loadMem_417519, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_41751c, %struct.Memory** %MEMORY
  ...
  ret %struct.Memory* %loadMem_417520
}
