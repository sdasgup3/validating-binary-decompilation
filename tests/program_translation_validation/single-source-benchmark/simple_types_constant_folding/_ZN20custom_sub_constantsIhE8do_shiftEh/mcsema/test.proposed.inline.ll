...
entry:
  ...
  store %struct.Memory* %loadMem_4174d0, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_4174d4, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_4174e0, %struct.Memory** %MEMORY
  ret %struct.Memory* %loadMem_4174e0
}
