...
define %struct.Memory* @_ZN20custom_sub_constantsIhE8do_shiftEh(%struct.State* noalias, i64, %struct.Memory* noalias) #2 {
entry:
  ...
  store %struct.Memory* %loadMem_417520, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_417521, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_417524, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_417527, %struct.Memory** %MEMORY
  ...
  store i8 %65, i8* %69
  store %struct.Memory* %loadMem_417529, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_41752c, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_417530, %struct.Memory** %MEMORY
  ret %struct.Memory* %loadMem_417530
}
