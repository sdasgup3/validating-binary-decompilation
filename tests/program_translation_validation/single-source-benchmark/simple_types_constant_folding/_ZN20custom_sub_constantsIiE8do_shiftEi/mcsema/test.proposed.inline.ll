...
define %struct.Memory* @_ZN20custom_sub_constantsIiE8do_shiftEi(%struct.State* noalias, i64, %struct.Memory* noalias) #1 {
entry:
  ...
  store i32 %48, i32* %52
  store %struct.Memory* %loadMem_413ce9, %struct.Memory** %MEMORY
  ...
  ret %struct.Memory* %loadMem_413ced
}
