...
define %struct.Memory* @_ZN20custom_sub_constantsIjE8do_shiftEj(%struct.State* noalias, i64, %struct.Memory* noalias) #2 {
entry:
  ...
  store i32 %48, i32* %52
  store %struct.Memory* %loadMem_412da9, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_412dac, %struct.Memory** %MEMORY
  ...
  ret %struct.Memory* %loadMem_412dad
}
