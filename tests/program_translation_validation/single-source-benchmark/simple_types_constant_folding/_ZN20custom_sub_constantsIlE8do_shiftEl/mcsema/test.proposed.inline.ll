...
entry:
  ...
  %loadMem_411e10 = load %struct.Memory*, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_411e10, %struct.Memory** %MEMORY
  ...
  %loadMem_411e14 = load %struct.Memory*, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_411e14, %struct.Memory** %MEMORY
  %loadMem_411e19 = load %struct.Memory*, %struct.Memory** %MEMORY
  ...
  store i64 %48, i64* %51
  store %struct.Memory* %loadMem_411e19, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_411e1d, %struct.Memory** %MEMORY
  ...
  ret %struct.Memory* %loadMem_411e1e
}
