...
define %struct.Memory* @_ZN20custom_sub_constantsImE8do_shiftEm(%struct.State* noalias, i64, %struct.Memory* noalias) #2 {
entry:
  ...
  store %struct.Memory* %loadMem_410e2d, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_410e2e, %struct.Memory** %MEMORY
  ret %struct.Memory* %loadMem_410e2e
}
