...
define %struct.Memory* @_ZN20custom_sub_constantsIsE8do_shiftEs(%struct.State* noalias nocapture, i64, %struct.Memory* noalias readnone returned) local_unnamed_addr #0 {
entry:
