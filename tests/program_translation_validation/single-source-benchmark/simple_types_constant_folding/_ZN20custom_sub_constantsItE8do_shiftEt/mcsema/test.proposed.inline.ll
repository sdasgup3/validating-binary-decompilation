...
entry:
  ...
  store %struct.Memory* %loadMem_414f71, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_414f74, %struct.Memory** %MEMORY
  ...
  %loadMem_414f7b = load %struct.Memory*, %struct.Memory** %MEMORY
  ...
  store i16 %61, i16* %65
  store %struct.Memory* %loadMem_414f7b, %struct.Memory** %MEMORY
  %loadMem_414f7f = load %struct.Memory*, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_414f7f, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_414f82, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_414f83, %struct.Memory** %MEMORY
  ret %struct.Memory* %loadMem_414f83
}
