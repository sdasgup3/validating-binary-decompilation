...
entry:
  ...
  %loadMem_414f20 = load %struct.Memory*, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_414f20, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_414f24, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_414f27, %struct.Memory** %MEMORY
  ...
  store i16 %61, i16* %65
  store %struct.Memory* %loadMem_414f2b, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_414f2f, %struct.Memory** %MEMORY
  %loadMem_414f32 = load %struct.Memory*, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_414f32, %struct.Memory** %MEMORY
  ...
  ret %struct.Memory* %loadMem_414f33
}
