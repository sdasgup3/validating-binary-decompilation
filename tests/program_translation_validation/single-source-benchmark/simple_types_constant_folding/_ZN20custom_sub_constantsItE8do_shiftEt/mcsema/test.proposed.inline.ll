...
define %struct.Memory* @_ZN20custom_sub_constantsItE8do_shiftEt(%struct.State* noalias, i64, %struct.Memory* noalias) #1 {
entry:
  ...
  %loadMem_414f60 = load %struct.Memory*, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_414f60, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_414f64, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_414f67, %struct.Memory** %MEMORY
  %loadMem_414f6b = load %struct.Memory*, %struct.Memory** %MEMORY
  ...
  store i16 %61, i16* %65
  store %struct.Memory* %loadMem_414f6b, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_414f6f, %struct.Memory** %MEMORY
  %loadMem_414f72 = load %struct.Memory*, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_414f72, %struct.Memory** %MEMORY
  ...
  ret %struct.Memory* %loadMem_414f73
}
