...
define %struct.Memory* @_ZN20custom_sub_constantsItE8do_shiftEt(%struct.State* noalias nocapture, i64, %struct.Memory* noalias readnone returned) local_unnamed_addr #0 {
entry:
