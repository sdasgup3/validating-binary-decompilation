...
define %struct.Memory* @_ZN20custom_xor_constantsIaE8do_shiftEa(%struct.State* noalias, i64, %struct.Memory* noalias) #2 {
entry:
  ...
  store %struct.Memory* %loadMem_4180e1, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_4180e4, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_4180e7, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_4180ec, %struct.Memory** %MEMORY
  ...
  ret %struct.Memory* %loadMem_4180f0
}
