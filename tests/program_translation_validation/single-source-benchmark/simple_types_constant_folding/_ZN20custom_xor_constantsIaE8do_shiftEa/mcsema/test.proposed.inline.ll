...
entry:
  ...
  store %struct.Memory* %loadMem_418131, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_418134, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_418137, %struct.Memory** %MEMORY
  ...
  store i8 %65, i8* %69
  store %struct.Memory* %loadMem_418139, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_41813c, %struct.Memory** %MEMORY
  ...
  ret %struct.Memory* %loadMem_418140
}
