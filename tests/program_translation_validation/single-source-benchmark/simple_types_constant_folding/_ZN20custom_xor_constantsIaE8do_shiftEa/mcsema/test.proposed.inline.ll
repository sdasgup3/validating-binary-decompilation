...
define %struct.Memory* @_ZN20custom_xor_constantsIaE8do_shiftEa(%struct.State* noalias, i64, %struct.Memory* noalias) #1 {
entry:
  ...
  store %struct.Memory* %loadMem_418121, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_418127, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_41812c, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_41812f, %struct.Memory** %MEMORY
  ...
  ret %struct.Memory* %loadMem_418130
}
