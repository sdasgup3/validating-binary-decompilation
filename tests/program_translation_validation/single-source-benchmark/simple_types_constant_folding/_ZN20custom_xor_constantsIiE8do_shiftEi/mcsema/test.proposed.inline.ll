...
define %struct.Memory* @_ZN20custom_xor_constantsIiE8do_shiftEi(%struct.State* noalias, i64, %struct.Memory* noalias) #1 {
entry:
  ...
  store i32 %48, i32* %52
  store %struct.Memory* %loadMem_4137a9, %struct.Memory** %MEMORY
  ...
  ret %struct.Memory* %loadMem_4137ad
}
