...
define %struct.Memory* @_ZN20custom_xor_constantsIjE8do_shiftEj(%struct.State* noalias, i64, %struct.Memory* noalias) #1 {
entry:
  ...
  store %struct.Memory* %loadMem_412850, %struct.Memory** %MEMORY
  ...
  ret %struct.Memory* %loadMem_41285d
}
