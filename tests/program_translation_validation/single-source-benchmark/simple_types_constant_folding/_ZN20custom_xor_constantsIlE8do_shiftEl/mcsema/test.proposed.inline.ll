...
define %struct.Memory* @_ZN20custom_xor_constantsIlE8do_shiftEl(%struct.State* noalias, i64, %struct.Memory* noalias) #2 {
entry:
  ...
  store i64 %48, i64* %51
  store %struct.Memory* %loadMem_411929, %struct.Memory** %MEMORY
  ...
  ret %struct.Memory* %loadMem_41192e
}
