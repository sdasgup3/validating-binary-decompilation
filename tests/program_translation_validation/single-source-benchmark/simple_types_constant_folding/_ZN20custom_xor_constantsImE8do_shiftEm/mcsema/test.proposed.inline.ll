...
define %struct.Memory* @_ZN20custom_xor_constantsImE8do_shiftEm(%struct.State* noalias, i64, %struct.Memory* noalias) #2 {
entry:
  ...
  store i64 %48, i64* %51
  store %struct.Memory* %loadMem_4106a9, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_4106ad, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_4106ae, %struct.Memory** %MEMORY
  ret %struct.Memory* %loadMem_4106ae
}
