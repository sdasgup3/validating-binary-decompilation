...
define %struct.Memory* @_ZN20custom_xor_constantsImE8do_shiftEm(%struct.State* noalias, i64, %struct.Memory* noalias) #1 {
entry:
  ...
  %loadMem_410699 = load %struct.Memory*, %struct.Memory** %MEMORY
  ...
  store i64 %48, i64* %51
  store %struct.Memory* %loadMem_410699, %struct.Memory** %MEMORY
  ...
  ret %struct.Memory* %loadMem_41069e
}
