...
define %struct.Memory* @_ZN20custom_xor_constantsImE8do_shiftEm(%struct.State* noalias nocapture, i64, %struct.Memory* noalias readnone returned) local_unnamed_addr #0 {
entry:
