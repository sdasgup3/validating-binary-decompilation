...
define %struct.Memory* @_ZN20custom_xor_constantsIsE8do_shiftEs(%struct.State* noalias, i64, %struct.Memory* noalias) #1 {
entry:
  ...
  store %struct.Memory* %loadMem_415b80, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_415b84, %struct.Memory** %MEMORY
  ...
  store i16 29, i16* %CX.i8, align 2
  ...
  store %struct.Memory* %loadMem_415b92, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_415b93, %struct.Memory** %MEMORY
  ret %struct.Memory* %loadMem_415b93
}
...
define %struct.Memory* @routine_movw__0x1d___cx(%struct.State* dereferenceable(3376), i64, %struct.Memory*) {
block_400488:
  %3 = getelementptr inbounds %struct.State, %struct.State* %0, i32 0, i32 6
  %4 = getelementptr inbounds %struct.GPR, %struct.GPR* %3, i32 0, i32 33
  %5 = getelementptr inbounds %struct.Reg, %struct.Reg* %4, i32 0, i32 0
