...
define %struct.Memory* @_ZN20custom_xor_constantsItE8do_shiftEt(%struct.State* noalias, i64, %struct.Memory* noalias) #1 {
entry:
  ...
  store i16 %61, i16* %65
  store %struct.Memory* %loadMem_4148ab, %struct.Memory** %MEMORY
  ...
  ret %struct.Memory* %loadMem_4148b3
}
