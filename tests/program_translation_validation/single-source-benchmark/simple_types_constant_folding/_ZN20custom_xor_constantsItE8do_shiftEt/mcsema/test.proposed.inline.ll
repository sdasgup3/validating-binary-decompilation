...
define %struct.Memory* @_ZN20custom_xor_constantsItE8do_shiftEt(%struct.State* noalias, i64, %struct.Memory* noalias) #2 {
entry:
  ...
  store %struct.Memory* %loadMem_414860, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_414861, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_414864, %struct.Memory** %MEMORY
  ...
  ret %struct.Memory* %loadMem_414873
}
