...
define %struct.Memory* @_ZN20custom_xor_constantsItE8do_shiftEt(%struct.State* noalias nocapture, i64, %struct.Memory* noalias readnone returned) local_unnamed_addr #0 {
entry:
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_movw__0x1d___cx(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned) local_unnamed_addr #1 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
