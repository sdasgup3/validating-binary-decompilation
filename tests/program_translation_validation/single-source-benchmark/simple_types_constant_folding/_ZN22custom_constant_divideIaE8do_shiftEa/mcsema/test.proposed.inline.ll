...
entry:
  ...
  store %struct.Memory* %loadMem_417c34, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_417c37, %struct.Memory** %MEMORY
...
; <label>:123:                                    ; preds = %entry
  ...
  %126 = call %struct.Memory* @__remill_error(%struct.State* nonnull dereferenceable(3376) %0, i64 %125, %struct.Memory* %loadMem_417c44)
...
routine_idivl__edi.exit:                          ; preds = %123, %127
  %139 = phi %struct.Memory* [ %126, %123 ], [ %loadMem_417c44, %127 ]
  ...
  ret %struct.Memory* %loadMem_417c4c
}
