...
define %struct.Memory* @_ZN22custom_constant_divideIdE8do_shiftEd(%struct.State* noalias, i64, %struct.Memory* noalias) #1 {
entry:
  ...
  store %struct.Memory* %loadMem_40e85c, %struct.Memory** %MEMORY
  ...
  ret %struct.Memory* %loadMem_40e86b
}
