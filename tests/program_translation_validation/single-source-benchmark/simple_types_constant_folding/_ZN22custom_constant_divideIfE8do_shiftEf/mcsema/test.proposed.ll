...
@G_0x9820__rip__4256364_= global %G_0x9820__rip__4256364__type <{ [16 x i8] c"\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00" }>
...
entry:
  ...
  ; Code: ._ZN22custom_constant_divideIfE8do_shiftEf:	 RIP: 40f260	 Bytes: 0
  ...
  ; Code: movss 0x9820(%rip), %xmm1	 RIP: 40f264	 Bytes: 8
  %loadMem_40f264 = load %struct.Memory*, %struct.Memory** %MEMORY
  %call_40f264 = call %struct.Memory* @routine_movss_0x9820__rip____xmm1(%struct.State* %0, i64  0, %struct.Memory* %loadMem_40f264)
  store %struct.Memory* %call_40f264, %struct.Memory** %MEMORY

  ; Code: movss %xmm0, -0x4(%rbp)	 RIP: 40f26c	 Bytes: 5
  %loadMem_40f26c = load %struct.Memory*, %struct.Memory** %MEMORY
  %call_40f26c = call %struct.Memory* @routine_movss__xmm0__MINUS0x4__rbp_(%struct.State* %0, i64  0, %struct.Memory* %loadMem_40f26c)
  store %struct.Memory* %call_40f26c, %struct.Memory** %MEMORY

  ; Code: movss -0x4(%rbp), %xmm0	 RIP: 40f271	 Bytes: 5
  %loadMem_40f271 = load %struct.Memory*, %struct.Memory** %MEMORY
  %call_40f271 = call %struct.Memory* @routine_movss_MINUS0x4__rbp____xmm0(%struct.State* %0, i64  0, %struct.Memory* %loadMem_40f271)
  store %struct.Memory* %call_40f271, %struct.Memory** %MEMORY

  ; Code: divss %xmm1, %xmm0	 RIP: 40f276	 Bytes: 4
  %loadMem_40f276 = load %struct.Memory*, %struct.Memory** %MEMORY
  %call_40f276 = call %struct.Memory* @routine_divss__xmm1___xmm0(%struct.State* %0, i64  0, %struct.Memory* %loadMem_40f276)
  store %struct.Memory* %call_40f276, %struct.Memory** %MEMORY

  ; Code: popq %rbp	 RIP: 40f27a	 Bytes: 1
  %loadMem_40f27a = load %struct.Memory*, %struct.Memory** %MEMORY
  %call_40f27a = call %struct.Memory* @routine_popq__rbp(%struct.State* %0, i64  0, %struct.Memory* %loadMem_40f27a)
  store %struct.Memory* %call_40f27a, %struct.Memory** %MEMORY

  ; Code: retq	 RIP: 40f27b	 Bytes: 1
  %loadMem_40f27b = load %struct.Memory*, %struct.Memory** %MEMORY
  %call_40f27b = call %struct.Memory* @routine_retq(%struct.State* %0, i64  0, %struct.Memory* %loadMem_40f27b)
  store %struct.Memory* %call_40f27b, %struct.Memory** %MEMORY

  ret %struct.Memory* %call_40f27b
}
