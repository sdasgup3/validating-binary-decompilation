...
@G_0x9820__rip_ = local_unnamed_addr global %G_0x9820__rip__type zeroinitializer

; Function Attrs: alwaysinline
define %struct.Memory* @_ZN22custom_constant_divideIfE8do_shiftEf(%struct.State* noalias, i64, %struct.Memory* noalias) local_unnamed_addr #0 {
entry:
  ...
  %13 = load i32, i32* bitcast (%G_0x9820__rip__type* @G_0x9820__rip_ to i32*), align 8
  ...
  %45 = bitcast i64* %39 to <2 x i32>*
  %46 = load <2 x i32>, <2 x i32>* %45, align 1
  %47 = bitcast %union.VectorReg* %11 to <2 x float>*
  %48 = load <2 x float>, <2 x float>* %47, align 1
  %49 = extractelement <2 x float> %44, i32 0
  %50 = extractelement <2 x float> %48, i32 0
  %51 = fdiv float %49, %50
  store float %51, float* %35, align 1
  %52 = bitcast <2 x float> %44 to <2 x i32>
  %53 = extractelement <2 x i32> %52, i32 1
  %54 = bitcast i8* %37 to i32*
  store i32 %53, i32* %54, align 1
  %55 = extractelement <2 x i32> %46, i32 0
  %56 = bitcast i64* %39 to i32*
  store i32 %55, i32* %56, align 1
  %57 = extractelement <2 x i32> %46, i32 1
...
define %struct.Memory* @routine_movss_0x9820__rip____xmm1(%struct.State* dereferenceable(3376), i64, %struct.Memory*) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  ...
  %7 = load i32, i32* bitcast (%G_0x9820__rip__type* @G_0x9820__rip_ to i32*), align 8
