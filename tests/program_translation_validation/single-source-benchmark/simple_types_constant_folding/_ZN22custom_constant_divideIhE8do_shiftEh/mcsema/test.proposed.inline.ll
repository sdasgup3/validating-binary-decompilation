...
entry:
  ...
  store %struct.Memory* %loadMem_416960, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_416964, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_416973, %struct.Memory** %MEMORY
...
; <label>:122:                                    ; preds = %entry
  ...
  %125 = call %struct.Memory* @__remill_error(%struct.State* nonnull dereferenceable(3376) %0, i64 %124, %struct.Memory* %loadMem_416974)
...
routine_idivl__edi.exit:                          ; preds = %122, %126
  %138 = phi %struct.Memory* [ %125, %122 ], [ %loadMem_416974, %126 ]
  ...
  store %struct.Memory* %loadMem_416976, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_416978, %struct.Memory** %MEMORY
  ...
  ret %struct.Memory* %loadMem_41697c
}
