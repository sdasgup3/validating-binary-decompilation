...
define %struct.Memory* @_ZN22custom_constant_divideIhE8do_shiftEh(%struct.State* noalias, i64, %struct.Memory* noalias) #1 {
entry:
  ...
  store %struct.Memory* %loadMem_4169b3, %struct.Memory** %MEMORY
...
; <label>:122:                                    ; preds = %entry
  ...
  %125 = call %struct.Memory* @__remill_error(%struct.State* nonnull dereferenceable(3376) %0, i64 %124, %struct.Memory* %loadMem_4169b4)
...
routine_idivl__edi.exit:                          ; preds = %122, %126
  %138 = phi %struct.Memory* [ %125, %122 ], [ %loadMem_4169b4, %126 ]
  ...
  store %struct.Memory* %loadMem_4169b8, %struct.Memory** %MEMORY
  ...
  ret %struct.Memory* %loadMem_4169bc
}
