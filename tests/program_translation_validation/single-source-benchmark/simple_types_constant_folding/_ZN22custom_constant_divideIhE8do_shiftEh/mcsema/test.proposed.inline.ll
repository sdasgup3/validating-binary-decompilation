...
define %struct.Memory* @_ZN22custom_constant_divideIhE8do_shiftEh(%struct.State* noalias, i64, %struct.Memory* noalias) #2 {
entry:
  ...
  store %struct.Memory* %loadMem_4169b0, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_4169b4, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_4169b7, %struct.Memory** %MEMORY
  ...
  store i8 %64, i8* %68
  store %struct.Memory* %loadMem_4169bc, %struct.Memory** %MEMORY
  ...
  store i64 %84, i64* %RAX.i12, align 8
  ...
  %90 = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 7, i32 0, i32 0
  ...
  %EDI.i = bitcast %union.anon* %101 to i32*
...
; <label>:122:                                    ; preds = %entry
  ...
  %125 = call %struct.Memory* @__remill_error(%struct.State* nonnull dereferenceable(3376) %0, i64 %124, %struct.Memory* %loadMem_4169c4)
  br label %routine_idivl__edi.exit

; <label>:126:                                    ; preds = %entry
  %127 = srem i64 %117, %115
  %128 = getelementptr inbounds %union.anon, %union.anon* %106, i64 0, i32 0
  %129 = and i64 %118, 4294967295
  store i64 %129, i64* %128, align 8
  %130 = getelementptr inbounds %union.anon, %union.anon* %110, i64 0, i32 0
...
routine_idivl__edi.exit:                          ; preds = %122, %126
  %138 = phi %struct.Memory* [ %125, %122 ], [ %loadMem_4169c4, %126 ]
  ...
  %CL.i6 = getelementptr inbounds %struct.anon.2, %struct.anon.2* %149, i32 0, i32 0
  %150 = load i8, i8* %AL.i
  %151 = zext i8 %150 to i64
  %152 = load i64, i64* %PC.i5
  %153 = add i64 %152, 2
  store i64 %153, i64* %PC.i5
  store i8 %150, i8* %CL.i6, align 1
  store %struct.Memory* %loadMem_4169c6, %struct.Memory** %MEMORY
  ...
  %CL.i = getelementptr inbounds %struct.anon.2, %struct.anon.2* %160, i32 0, i32 0
  ...
  store %struct.Memory* %loadMem_4169cc, %struct.Memory** %MEMORY
  ret %struct.Memory* %loadMem_4169cc
}
