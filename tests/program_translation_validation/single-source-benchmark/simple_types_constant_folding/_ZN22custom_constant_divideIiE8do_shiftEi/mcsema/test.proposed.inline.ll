...
; <label>:152:                                    ; preds = %entry
  ...
  %155 = call %struct.Memory* @__remill_error(%struct.State* nonnull dereferenceable(3376) %0, i64 %154, %struct.Memory* %loadMem_413388)
...
routine_idivl__edi.exit:                          ; preds = %152, %156
  %168 = phi %struct.Memory* [ %155, %152 ], [ %loadMem_413388, %156 ]
  ...
  ret %struct.Memory* %loadMem_41338b
}
