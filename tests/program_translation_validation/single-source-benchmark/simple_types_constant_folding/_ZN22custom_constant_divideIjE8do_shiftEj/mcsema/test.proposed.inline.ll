...
entry:
  ...
  %loadMem_412420 = load %struct.Memory*, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_412420, %struct.Memory** %MEMORY
  ...
  store i32 %48, i32* %52
  store %struct.Memory* %loadMem_412429, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_412434, %struct.Memory** %MEMORY
...
; <label>:171:                                    ; preds = %entry
  ...
  %174 = call %struct.Memory* @__remill_error(%struct.State* nonnull dereferenceable(3376) %0, i64 %173, %struct.Memory* %loadMem_412439)
...
routine_divl__edi.exit:                           ; preds = %171, %175
  %185 = phi %struct.Memory* [ %174, %171 ], [ %loadMem_412439, %175 ]
  ...
  ret %struct.Memory* %loadMem_41243c
}
