...
define %struct.Memory* @_ZN22custom_constant_divideIjE8do_shiftEj(%struct.State* noalias , i64, %struct.Memory* noalias) alwaysinline  {
entry:
  ...
  ; Code: ._ZN22custom_constant_divideIjE8do_shiftEj:	 RIP: 412420	 Bytes: 0
  ; Code: pushq %rbp	 RIP: 412420	 Bytes: 1
  %loadMem_412420 = load %struct.Memory*, %struct.Memory** %MEMORY
  %call_412420 = call %struct.Memory* @routine_pushq__rbp(%struct.State* %0, i64  0, %struct.Memory* %loadMem_412420)
  store %struct.Memory* %call_412420, %struct.Memory** %MEMORY

  ; Code: movq %rsp, %rbp	 RIP: 412421	 Bytes: 3
  %loadMem_412421 = load %struct.Memory*, %struct.Memory** %MEMORY
  %call_412421 = call %struct.Memory* @routine_movq__rsp___rbp(%struct.State* %0, i64  0, %struct.Memory* %loadMem_412421)
  store %struct.Memory* %call_412421, %struct.Memory** %MEMORY

  ; Code: movl $0x5, %eax	 RIP: 412424	 Bytes: 5
  %loadMem_412424 = load %struct.Memory*, %struct.Memory** %MEMORY
  %call_412424 = call %struct.Memory* @routine_movl__0x5___eax(%struct.State* %0, i64  0, %struct.Memory* %loadMem_412424)
  store %struct.Memory* %call_412424, %struct.Memory** %MEMORY

  ; Code: movl %edi, -0x4(%rbp)	 RIP: 412429	 Bytes: 3
  %loadMem_412429 = load %struct.Memory*, %struct.Memory** %MEMORY
  %call_412429 = call %struct.Memory* @routine_movl__edi__MINUS0x4__rbp_(%struct.State* %0, i64  0, %struct.Memory* %loadMem_412429)
  store %struct.Memory* %call_412429, %struct.Memory** %MEMORY

  ; Code: movl -0x4(%rbp), %edi	 RIP: 41242c	 Bytes: 3
  %loadMem_41242c = load %struct.Memory*, %struct.Memory** %MEMORY
  %call_41242c = call %struct.Memory* @routine_movl_MINUS0x4__rbp____edi(%struct.State* %0, i64  0, %struct.Memory* %loadMem_41242c)
  store %struct.Memory* %call_41242c, %struct.Memory** %MEMORY

  ; Code: movl %eax, -0x8(%rbp)	 RIP: 41242f	 Bytes: 3
  %loadMem_41242f = load %struct.Memory*, %struct.Memory** %MEMORY
  %call_41242f = call %struct.Memory* @routine_movl__eax__MINUS0x8__rbp_(%struct.State* %0, i64  0, %struct.Memory* %loadMem_41242f)
  store %struct.Memory* %call_41242f, %struct.Memory** %MEMORY

  ; Code: movl %edi, %eax	 RIP: 412432	 Bytes: 2
  %loadMem_412432 = load %struct.Memory*, %struct.Memory** %MEMORY
  %call_412432 = call %struct.Memory* @routine_movl__edi___eax(%struct.State* %0, i64  0, %struct.Memory* %loadMem_412432)
  store %struct.Memory* %call_412432, %struct.Memory** %MEMORY

  ; Code: xorl %edx, %edx	 RIP: 412434	 Bytes: 2
  %loadMem_412434 = load %struct.Memory*, %struct.Memory** %MEMORY
  %call_412434 = call %struct.Memory* @routine_xorl__edx___edx(%struct.State* %0, i64  0, %struct.Memory* %loadMem_412434)
  store %struct.Memory* %call_412434, %struct.Memory** %MEMORY

  ; Code: movl -0x8(%rbp), %edi	 RIP: 412436	 Bytes: 3
  %loadMem_412436 = load %struct.Memory*, %struct.Memory** %MEMORY
  %call_412436 = call %struct.Memory* @routine_movl_MINUS0x8__rbp____edi(%struct.State* %0, i64  0, %struct.Memory* %loadMem_412436)
  store %struct.Memory* %call_412436, %struct.Memory** %MEMORY

  ; Code: divl %edi	 RIP: 412439	 Bytes: 2
  %loadMem_412439 = load %struct.Memory*, %struct.Memory** %MEMORY
  %call_412439 = call %struct.Memory* @routine_divl__edi(%struct.State* %0, i64  0, %struct.Memory* %loadMem_412439)
  store %struct.Memory* %call_412439, %struct.Memory** %MEMORY

  ; Code: popq %rbp	 RIP: 41243b	 Bytes: 1
  %loadMem_41243b = load %struct.Memory*, %struct.Memory** %MEMORY
  %call_41243b = call %struct.Memory* @routine_popq__rbp(%struct.State* %0, i64  0, %struct.Memory* %loadMem_41243b)
  store %struct.Memory* %call_41243b, %struct.Memory** %MEMORY

  ; Code: retq	 RIP: 41243c	 Bytes: 1
  %loadMem_41243c = load %struct.Memory*, %struct.Memory** %MEMORY
  %call_41243c = call %struct.Memory* @routine_retq(%struct.State* %0, i64  0, %struct.Memory* %loadMem_41243c)
  store %struct.Memory* %call_41243c, %struct.Memory** %MEMORY

  ret %struct.Memory* %call_41243c
}
