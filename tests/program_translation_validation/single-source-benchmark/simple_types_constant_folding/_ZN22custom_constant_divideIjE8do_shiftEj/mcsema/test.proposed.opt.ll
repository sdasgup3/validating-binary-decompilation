...
define %struct.Memory* @_ZN22custom_constant_divideIjE8do_shiftEj(%struct.State* noalias, i64, %struct.Memory* noalias) local_unnamed_addr #0 {
routine_divl__edi.exit:
  ...
  store i64 %43, i64* %RAX.i21, align 8
