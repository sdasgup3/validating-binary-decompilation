...
define %struct.Memory* @_ZN22custom_constant_divideImE8do_shiftEm(%struct.State* noalias, i64, %struct.Memory* noalias) local_unnamed_addr #1 {
entry:
