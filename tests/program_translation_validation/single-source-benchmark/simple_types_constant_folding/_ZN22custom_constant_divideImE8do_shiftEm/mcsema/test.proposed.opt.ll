...
define %struct.Memory* @_ZN22custom_constant_divideImE8do_shiftEm(%struct.State* noalias, i64, %struct.Memory* noalias) local_unnamed_addr #0 {
routine_divq__rcx.exit:
  ...
  store i64 %35, i64* %RBP.i, align 8
