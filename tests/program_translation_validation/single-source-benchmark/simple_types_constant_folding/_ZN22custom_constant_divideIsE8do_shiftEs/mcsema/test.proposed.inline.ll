...
entry:
  ...
  store %struct.Memory* %loadMem_415697, %struct.Memory** %MEMORY
  ...
  store i16 %61, i16* %65
  store %struct.Memory* %loadMem_41569c, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_4156a0, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_4156a4, %struct.Memory** %MEMORY
...
; <label>:120:                                    ; preds = %entry
  ...
  %123 = call %struct.Memory* @__remill_error(%struct.State* nonnull dereferenceable(3376) %0, i64 %122, %struct.Memory* %loadMem_4156a5)
...
routine_idivl__edi.exit:                          ; preds = %120, %124
  %136 = phi %struct.Memory* [ %123, %120 ], [ %loadMem_4156a5, %124 ]
  ...
  store %struct.Memory* %loadMem_4156a7, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_4156aa, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_4156ad, %struct.Memory** %MEMORY
  %loadMem_4156ae = load %struct.Memory*, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_4156ae, %struct.Memory** %MEMORY
  ret %struct.Memory* %loadMem_4156ae
}
