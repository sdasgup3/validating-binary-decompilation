...
define %struct.Memory* @_ZN22custom_constant_divideItE8do_shiftEt(%struct.State* noalias, i64, %struct.Memory* noalias) local_unnamed_addr #0 {
entry:
  ...
  store i64 %23, i64* %RAX.i12, align 8
...
; <label>:33:                                     ; preds = %entry
  %34 = tail call %struct.Memory* @__remill_error(%struct.State* nonnull dereferenceable(3376) %0, i64 %26, %struct.Memory* %2)
...
; <label>:35:                                     ; preds = %entry
  ...
  %39 = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 7, i32 0, i32 0
  ...
  %47 = trunc i64 %29 to i16
  br label %routine_idivl__edi.exit

routine_idivl__edi.exit:                          ; preds = %35, %33
  %48 = phi i64 [ %.pre1, %33 ], [ %26, %35 ]
  %49 = phi i16 [ %.pre, %33 ], [ %47, %35 ]
  %50 = phi %struct.Memory* [ %34, %33 ], [ %2, %35 ]
  %51 = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 5, i32 0
  %CX.i6 = bitcast %union.anon* %51 to i16*
  %52 = zext i16 %49 to i64
  store i16 %49, i16* %CX.i6, align 2
  store i64 %52, i64* %RAX.i12, align 8
  %53 = add i64 %48, 7
...
define %struct.Memory* @routine_movzwl_MINUS0x2__rbp____eax(%struct.State* dereferenceable(3376), i64, %struct.Memory*) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
