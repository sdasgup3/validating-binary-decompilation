...
; <label>:32:                                     ; preds = %entry
  %33 = tail call %struct.Memory* @__remill_error(%struct.State* nonnull dereferenceable(3376) %0, i64 %26, %struct.Memory* %2)
...
routine_idivl__edi.exit:                          ; preds = %34, %32
  %46 = phi i64 [ %.pre1, %32 ], [ %26, %34 ]
  %47 = phi i16 [ %.pre, %32 ], [ %45, %34 ]
  %48 = phi %struct.Memory* [ %33, %32 ], [ %2, %34 ]
  %49 = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 5, i32 0
  %CX.i6 = bitcast %union.anon* %49 to i16*
  %50 = zext i16 %47 to i64
  store i16 %47, i16* %CX.i6, align 2
  store i64 %50, i64* %RAX.i12, align 8
  %51 = add i64 %46, 7
