...
entry:
  ...
  %loadMem_418560 = load %struct.Memory*, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_418560, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_418561, %struct.Memory** %MEMORY
  %loadMem_418564 = load %struct.Memory*, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_418564, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_418567, %struct.Memory** %MEMORY
  %loadMem_418569 = load %struct.Memory*, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_418569, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_418573, %struct.Memory** %MEMORY
  ret %struct.Memory* %loadMem_418573
}
