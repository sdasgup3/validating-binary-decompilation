...
entry:
  ...
  %loadMem_4185b1 = load %struct.Memory*, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_4185b1, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_4185b4, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_4185b7, %struct.Memory** %MEMORY
  %loadMem_4185b9 = load %struct.Memory*, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_4185b9, %struct.Memory** %MEMORY
  %loadMem_4185bc = load %struct.Memory*, %struct.Memory** %MEMORY
  ...
  store i8 %103, i8* %107
  store %struct.Memory* %loadMem_4185bc, %struct.Memory** %MEMORY
  %loadMem_4185bf = load %struct.Memory*, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_4185bf, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_4185c2, %struct.Memory** %MEMORY
  ...
  ret %struct.Memory* %loadMem_4185c3
}
