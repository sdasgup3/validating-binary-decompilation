...
define %struct.Memory* @_ZN22custom_equal_constantsIiE8do_shiftEi(%struct.State* noalias, i64, %struct.Memory* noalias) #1 {
entry:
  ...
  store %struct.Memory* %loadMem_413b20, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_413b21, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_413b29, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_413b2a, %struct.Memory** %MEMORY
  ret %struct.Memory* %loadMem_413b2a
}
