...
define %struct.Memory* @_ZN22custom_equal_constantsIiE8do_shiftEi(%struct.State* noalias, i64, %struct.Memory* noalias) #2 {
entry:
  ...
  store %struct.Memory* %loadMem_413ae0, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_413ae4, %struct.Memory** %MEMORY
  ...
  store i32 %72, i32* %76
  store %struct.Memory* %loadMem_413ae6, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_413ae9, %struct.Memory** %MEMORY
  ...
  ret %struct.Memory* %loadMem_413aea
}
