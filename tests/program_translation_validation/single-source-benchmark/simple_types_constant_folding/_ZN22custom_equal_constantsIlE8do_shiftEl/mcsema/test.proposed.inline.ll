...
define %struct.Memory* @_ZN22custom_equal_constantsIlE8do_shiftEl(%struct.State* noalias, i64, %struct.Memory* noalias) #2 {
entry:
  ...
  store %struct.Memory* %loadMem_411ca0, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_411ca1, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_411ca4, %struct.Memory** %MEMORY
  %loadMem_411ca6 = load %struct.Memory*, %struct.Memory** %MEMORY
  ...
  store i64 %72, i64* %75
  store %struct.Memory* %loadMem_411ca6, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_411caa, %struct.Memory** %MEMORY
  %loadMem_411cab = load %struct.Memory*, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_411cab, %struct.Memory** %MEMORY
  ret %struct.Memory* %loadMem_411cab
}
