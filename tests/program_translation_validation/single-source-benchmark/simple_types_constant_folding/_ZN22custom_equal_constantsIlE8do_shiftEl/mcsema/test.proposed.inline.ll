...
define %struct.Memory* @_ZN22custom_equal_constantsIlE8do_shiftEl(%struct.State* noalias, i64, %struct.Memory* noalias) #1 {
entry:
  ...
  store %struct.Memory* %loadMem_411c90, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_411c91, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_411c94, %struct.Memory** %MEMORY
  ...
  %loadMem_411c9a = load %struct.Memory*, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_411c9a, %struct.Memory** %MEMORY
  ...
  ret %struct.Memory* %loadMem_411c9b
}
