...
define %struct.Memory* @_ZN22custom_equal_constantsImE8do_shiftEm(%struct.State* noalias, i64, %struct.Memory* noalias) #1 {
entry:
  ...
  store %struct.Memory* %loadMem_410b90, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_410b91, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_410b94, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_410b9a, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_410b9b, %struct.Memory** %MEMORY
  ret %struct.Memory* %loadMem_410b9b
}
