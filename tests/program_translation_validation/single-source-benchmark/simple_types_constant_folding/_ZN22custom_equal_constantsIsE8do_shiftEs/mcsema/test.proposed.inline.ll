...
define %struct.Memory* @_ZN22custom_equal_constantsIsE8do_shiftEs(%struct.State* noalias, i64, %struct.Memory* noalias) #1 {
entry:
  ...
  store %struct.Memory* %loadMem_416013, %struct.Memory** %MEMORY
  ...
  ret %struct.Memory* %loadMem_416014
}
