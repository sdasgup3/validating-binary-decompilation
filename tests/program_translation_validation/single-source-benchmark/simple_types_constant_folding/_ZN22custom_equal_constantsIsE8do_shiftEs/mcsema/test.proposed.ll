...
entry:
  ...
  ; Code: ._ZN22custom_equal_constantsIsE8do_shiftEs:	 RIP: 415fc0	 Bytes: 0
  ...
  ; Code: movw %di, %ax	 RIP: 415fc4	 Bytes: 3
  %loadMem_415fc4 = load %struct.Memory*, %struct.Memory** %MEMORY
  %call_415fc4 = call %struct.Memory* @routine_movw__di___ax(%struct.State* %0, i64  0, %struct.Memory* %loadMem_415fc4)
  store %struct.Memory* %call_415fc4, %struct.Memory** %MEMORY

  ; Code: xorl %edi, %edi	 RIP: 415fc7	 Bytes: 2
  %loadMem_415fc7 = load %struct.Memory*, %struct.Memory** %MEMORY
  %call_415fc7 = call %struct.Memory* @routine_xorl__edi___edi(%struct.State* %0, i64  0, %struct.Memory* %loadMem_415fc7)
  store %struct.Memory* %call_415fc7, %struct.Memory** %MEMORY

  ; Code: movw %di, %cx	 RIP: 415fc9	 Bytes: 3
  %loadMem_415fc9 = load %struct.Memory*, %struct.Memory** %MEMORY
  %call_415fc9 = call %struct.Memory* @routine_movw__di___cx(%struct.State* %0, i64  0, %struct.Memory* %loadMem_415fc9)
  store %struct.Memory* %call_415fc9, %struct.Memory** %MEMORY

  ; Code: movw %ax, -0x2(%rbp)	 RIP: 415fcc	 Bytes: 4
  %loadMem_415fcc = load %struct.Memory*, %struct.Memory** %MEMORY
  %call_415fcc = call %struct.Memory* @routine_movw__ax__MINUS0x2__rbp_(%struct.State* %0, i64  0, %struct.Memory* %loadMem_415fcc)
  store %struct.Memory* %call_415fcc, %struct.Memory** %MEMORY

  ; Code: movswl %cx, %eax	 RIP: 415fd0	 Bytes: 3
  %loadMem_415fd0 = load %struct.Memory*, %struct.Memory** %MEMORY
  %call_415fd0 = call %struct.Memory* @routine_movswl__cx___eax(%struct.State* %0, i64  0, %struct.Memory* %loadMem_415fd0)
  store %struct.Memory* %call_415fd0, %struct.Memory** %MEMORY

  ; Code: popq %rbp	 RIP: 415fd3	 Bytes: 1
  %loadMem_415fd3 = load %struct.Memory*, %struct.Memory** %MEMORY
  %call_415fd3 = call %struct.Memory* @routine_popq__rbp(%struct.State* %0, i64  0, %struct.Memory* %loadMem_415fd3)
  store %struct.Memory* %call_415fd3, %struct.Memory** %MEMORY

  ; Code: retq	 RIP: 415fd4	 Bytes: 1
  %loadMem_415fd4 = load %struct.Memory*, %struct.Memory** %MEMORY
  %call_415fd4 = call %struct.Memory* @routine_retq(%struct.State* %0, i64  0, %struct.Memory* %loadMem_415fd4)
  store %struct.Memory* %call_415fd4, %struct.Memory** %MEMORY

  ret %struct.Memory* %call_415fd4
}
