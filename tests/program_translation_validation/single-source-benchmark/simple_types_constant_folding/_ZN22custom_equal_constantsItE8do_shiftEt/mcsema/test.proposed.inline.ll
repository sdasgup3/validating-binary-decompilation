...
define %struct.Memory* @_ZN22custom_equal_constantsItE8do_shiftEt(%struct.State* noalias, i64, %struct.Memory* noalias) #1 {
entry:
  ...
  store %struct.Memory* %loadMem_414d20, %struct.Memory** %MEMORY
  ...
  ret %struct.Memory* %loadMem_414d34
}
