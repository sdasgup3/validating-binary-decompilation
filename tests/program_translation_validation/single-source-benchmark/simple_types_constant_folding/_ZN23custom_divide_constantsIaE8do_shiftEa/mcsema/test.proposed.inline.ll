...
define %struct.Memory* @_ZN23custom_divide_constantsIaE8do_shiftEa(%struct.State* noalias, i64, %struct.Memory* noalias) #1 {
entry:
  ...
  store %struct.Memory* %loadMem_4186c0, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_4186c1, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_4186c4, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_4186c7, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_4186cf, %struct.Memory** %MEMORY
  ...
  ret %struct.Memory* %loadMem_4186d0
}
