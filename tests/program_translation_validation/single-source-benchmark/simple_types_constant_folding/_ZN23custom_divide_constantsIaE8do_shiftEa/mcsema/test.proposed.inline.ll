...
define %struct.Memory* @_ZN23custom_divide_constantsIaE8do_shiftEa(%struct.State* noalias, i64, %struct.Memory* noalias) #2 {
entry:
  ...
  store %struct.Memory* %loadMem_418680, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_418681, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_418684, %struct.Memory** %MEMORY
  ...
  store i8 %65, i8* %69
  store %struct.Memory* %loadMem_418689, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_41868c, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_41868f, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_418690, %struct.Memory** %MEMORY
  ret %struct.Memory* %loadMem_418690
}
