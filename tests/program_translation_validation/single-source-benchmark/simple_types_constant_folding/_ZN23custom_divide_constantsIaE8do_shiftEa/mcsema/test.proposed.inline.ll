...
entry:
  ...
  store %struct.Memory* %loadMem_4186d1, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_4186d4, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_4186d7, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_4186dc, %struct.Memory** %MEMORY
  ...
  ret %struct.Memory* %loadMem_4186e0
}
