...
entry:
  ...
  %36 = add i64 %35, ptrtoint (%G_0x9cf4__rip__type* @G_0x9cf4__rip_ to i64)
  ...
  store %struct.Memory* %loadMem_40ed4c, %struct.Memory** %MEMORY
  ...
  ret %struct.Memory* %loadMem_40ed55
}
...
; Function Attrs: alwaysinline
define %struct.Memory* @routine_movsd_0x9cf4__rip____xmm1(%struct.State* dereferenceable(3376), i64, %struct.Memory*) #2 {
block_400488:
  %3 = getelementptr inbounds %struct.State, %struct.State* %0, i32 0, i32 6
  %4 = getelementptr inbounds %struct.GPR, %struct.GPR* %3, i32 0, i32 33
  %5 = getelementptr inbounds %struct.Reg, %struct.Reg* %4, i32 0, i32 0
