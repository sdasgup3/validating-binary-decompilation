...
@G_0x9338__rip__4257612_ = global %G_0x9338__rip__4257612__type zeroinitializer
...
define %struct.Memory* @_ZN23custom_divide_constantsIfE8do_shiftEf(%struct.State* noalias, i64, %struct.Memory* noalias) #2 {
entry:
  ...
  %38 = load float, float* bitcast (%G_0x9338__rip__4257612__type* @G_0x9338__rip__4257612_ to float*)
  ...
  store %struct.Memory* %loadMem_40f754, %struct.Memory** %MEMORY
  ...
  ret %struct.Memory* %loadMem_40f755
}
...
define %struct.Memory* @routine_movss_0x9338__rip____xmm1(%struct.State* dereferenceable(3376), i64, %struct.Memory*) {
block_400478:
  %3 = getelementptr inbounds %struct.State, %struct.State* %0, i32 0, i32 6
  %4 = getelementptr inbounds %struct.GPR, %struct.GPR* %3, i32 0, i32 33
  %5 = getelementptr inbounds %struct.Reg, %struct.Reg* %4, i32 0, i32 0
