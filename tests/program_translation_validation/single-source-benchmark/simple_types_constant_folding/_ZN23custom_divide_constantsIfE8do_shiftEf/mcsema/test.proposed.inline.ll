...
define %struct.Memory* @_ZN23custom_divide_constantsIfE8do_shiftEf(%struct.State* noalias, i64, %struct.Memory* noalias) #1 {
entry:
  ...
  store %struct.Memory* %loadMem_40f795, %struct.Memory** %MEMORY
  ret %struct.Memory* %loadMem_40f795
}
