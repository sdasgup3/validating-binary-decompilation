...
define %struct.Memory* @_ZN23custom_divide_constantsIiE8do_shiftEi(%struct.State* noalias, i64, %struct.Memory* noalias) #2 {
entry:
  ...
  store %struct.Memory* %loadMem_413c1c, %struct.Memory** %MEMORY
  ...
  ret %struct.Memory* %loadMem_413c1d
}
