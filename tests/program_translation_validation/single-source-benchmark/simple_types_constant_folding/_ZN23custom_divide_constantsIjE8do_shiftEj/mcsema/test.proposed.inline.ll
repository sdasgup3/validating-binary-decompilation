...
define %struct.Memory* @_ZN23custom_divide_constantsIjE8do_shiftEj(%struct.State* noalias, i64, %struct.Memory* noalias) #1 {
entry:
  ...
  %loadMem_412cb0 = load %struct.Memory*, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_412cb0, %struct.Memory** %MEMORY
  ...
  %loadMem_412cbd = load %struct.Memory*, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_412cbd, %struct.Memory** %MEMORY
  ret %struct.Memory* %loadMem_412cbd
}
