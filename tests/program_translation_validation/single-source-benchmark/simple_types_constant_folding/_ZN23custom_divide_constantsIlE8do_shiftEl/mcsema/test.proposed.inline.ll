...
define %struct.Memory* @_ZN23custom_divide_constantsIlE8do_shiftEl(%struct.State* noalias, i64, %struct.Memory* noalias) #2 {
entry:
  ...
  store %struct.Memory* %loadMem_411d31, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_411d34, %struct.Memory** %MEMORY
  ...
  store i64 %48, i64* %51
  store %struct.Memory* %loadMem_411d39, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_411d3d, %struct.Memory** %MEMORY
  ...
  ret %struct.Memory* %loadMem_411d3e
}
