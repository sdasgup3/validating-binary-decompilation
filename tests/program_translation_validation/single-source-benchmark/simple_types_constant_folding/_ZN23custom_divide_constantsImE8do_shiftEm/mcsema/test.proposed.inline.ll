...
define %struct.Memory* @_ZN23custom_divide_constantsImE8do_shiftEm(%struct.State* noalias, i64, %struct.Memory* noalias) #2 {
entry:
  ...
  store %struct.Memory* %loadMem_410c90, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_410c91, %struct.Memory** %MEMORY
  ...
  %loadMem_410c99 = load %struct.Memory*, %struct.Memory** %MEMORY
  ...
  store i64 %48, i64* %51
  store %struct.Memory* %loadMem_410c99, %struct.Memory** %MEMORY
  ...
  %loadMem_410c9e = load %struct.Memory*, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_410c9e, %struct.Memory** %MEMORY
  ret %struct.Memory* %loadMem_410c9e
}
