...
entry:
  ...
  store i64 %48, i64* %51
  store %struct.Memory* %loadMem_410ce9, %struct.Memory** %MEMORY
  %loadMem_410ced = load %struct.Memory*, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_410ced, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_410cee, %struct.Memory** %MEMORY
  ret %struct.Memory* %loadMem_410cee
}
