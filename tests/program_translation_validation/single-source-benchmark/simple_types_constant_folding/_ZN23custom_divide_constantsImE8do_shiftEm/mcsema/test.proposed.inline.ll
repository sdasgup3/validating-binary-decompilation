...
define %struct.Memory* @_ZN23custom_divide_constantsImE8do_shiftEm(%struct.State* noalias, i64, %struct.Memory* noalias) #1 {
entry:
  ...
  store i64 %48, i64* %51
  store %struct.Memory* %loadMem_410cd9, %struct.Memory** %MEMORY
  ...
  %loadMem_410cde = load %struct.Memory*, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_410cde, %struct.Memory** %MEMORY
  ret %struct.Memory* %loadMem_410cde
}
