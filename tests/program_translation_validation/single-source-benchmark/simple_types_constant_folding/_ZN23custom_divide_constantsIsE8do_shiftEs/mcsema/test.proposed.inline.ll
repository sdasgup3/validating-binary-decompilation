...
define %struct.Memory* @_ZN23custom_divide_constantsIsE8do_shiftEs(%struct.State* noalias, i64, %struct.Memory* noalias) #1 {
entry:
  ...
  store %struct.Memory* %loadMem_416120, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_416121, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_416124, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_416132, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_416133, %struct.Memory** %MEMORY
  ret %struct.Memory* %loadMem_416133
}
