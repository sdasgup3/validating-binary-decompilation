...
entry:
  ...
  %loadMem_417e40 = load %struct.Memory*, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_417e40, %struct.Memory** %MEMORY
  ...
  %loadMem_417e4a = load %struct.Memory*, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_417e4a, %struct.Memory** %MEMORY
  %loadMem_417e4e = load %struct.Memory*, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_417e4e, %struct.Memory** %MEMORY
  ...
  %loadMem_417e57 = load %struct.Memory*, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_417e57, %struct.Memory** %MEMORY
  ...
  ret %struct.Memory* %loadMem_417e58
}
