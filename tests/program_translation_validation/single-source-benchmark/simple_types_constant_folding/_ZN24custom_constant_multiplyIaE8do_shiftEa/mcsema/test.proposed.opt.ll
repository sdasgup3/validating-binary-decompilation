...
define %struct.Memory* @_ZN24custom_constant_multiplyIaE8do_shiftEa(%struct.State* noalias, i64, %struct.Memory* noalias) local_unnamed_addr #1 {
entry:
  ...
  store i64 %26, i64* %RDI.i9, align 8
