...
define %struct.Memory* @_ZN24custom_constant_multiplyIaE8do_shiftEa(%struct.State* noalias nocapture, i64, %struct.Memory* noalias readnone returned) local_unnamed_addr #1 {
entry:
  ...
  %sext = mul i64 %23, 8646911284551352320
