...
define %struct.Memory* @_ZN24custom_constant_multiplyIdE8do_shiftEd(%struct.State* noalias, i64, %struct.Memory* noalias) #1 {
entry:
  ...
  store %struct.Memory* %loadMem_40ea24, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_40ea3a, %struct.Memory** %MEMORY
  ret %struct.Memory* %loadMem_40ea3a
}
