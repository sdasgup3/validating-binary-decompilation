...
@G_0xa03c__rip__4254188_ = local_unnamed_addr global %G_0xa03c__rip__4254188__type zeroinitializer

; Function Attrs: alwaysinline
define %struct.Memory* @_ZN24custom_constant_multiplyIdE8do_shiftEd(%struct.State* noalias, i64, %struct.Memory* noalias) local_unnamed_addr #0 {
entry:
  ...
  %12 = load i64, i64* bitcast (%G_0xa03c__rip__4254188__type* @G_0xa03c__rip__4254188_ to i64*), align 8
  %13 = bitcast %union.VectorReg* %11 to double*
  ...
  %27 = load double, double* %13, align 1
  %28 = bitcast i64* %15 to <2 x i32>*
  %29 = load <2 x i32>, <2 x i32>* %28, align 1
  %30 = inttoptr i64 %24 to double*
  %31 = load double, double* %30, align 8
  %32 = fmul double %27, %31
  store double %32, double* %13, align 1
  %33 = bitcast %union.VectorReg* %17 to i8*
  %34 = bitcast double %32 to <2 x i32>
  %35 = extractelement <2 x i32> %34, i32 0
  %36 = bitcast %union.VectorReg* %17 to i32*
  store i32 %35, i32* %36, align 1
  %37 = extractelement <2 x i32> %34, i32 1
  %38 = getelementptr inbounds i8, i8* %33, i64 4
  %39 = bitcast i8* %38 to i32*
  store i32 %37, i32* %39, align 1
  %40 = extractelement <2 x i32> %29, i32 0
  ...
  %43 = extractelement <2 x i32> %29, i32 1
  %44 = getelementptr inbounds i8, i8* %33, i64 12
...
define %struct.Memory* @routine_movsd_0xa03c__rip____xmm1(%struct.State* dereferenceable(3376), i64, %struct.Memory*) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, 8
  store i64 %4, i64* %PC, align 8
  %5 = load i64, i64* bitcast (%G_0xa03c__rip__4254188__type* @G_0xa03c__rip__4254188_ to i64*), align 8
...
define %struct.Memory* @routine_mulsd_MINUS0x8__rbp____xmm1(%struct.State* dereferenceable(3376), i64, %struct.Memory*) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %RBP = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 15, i32 0, i32 0
