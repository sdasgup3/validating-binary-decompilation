...
define %struct.Memory* @_ZN24custom_constant_multiplyIfE8do_shiftEf(%struct.State* noalias, i64, %struct.Memory* noalias) #1 {
entry:
  ...
  %loadMem_40f47c = load %struct.Memory*, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_40f47c, %struct.Memory** %MEMORY
  ...
  %loadMem_40f489 = load %struct.Memory*, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_40f489, %struct.Memory** %MEMORY
  ...
  ret %struct.Memory* %loadMem_40f48a
}
