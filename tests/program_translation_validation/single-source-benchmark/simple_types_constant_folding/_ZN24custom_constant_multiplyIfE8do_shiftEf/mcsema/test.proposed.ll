...
@G_0x965c__rip__4256828_= global %G_0x965c__rip__4256828__type <{ [16 x i8] c"\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00" }>


define %struct.Memory* @_ZN24custom_constant_multiplyIfE8do_shiftEf(%struct.State* noalias , i64, %struct.Memory* noalias) alwaysinline  {
entry:
  ...
  ; Code: ._ZN24custom_constant_multiplyIfE8do_shiftEf:	 RIP: 40f430	 Bytes: 0
  ; Code: pushq %rbp	 RIP: 40f430	 Bytes: 1
  %loadMem_40f430 = load %struct.Memory*, %struct.Memory** %MEMORY
  %call_40f430 = call %struct.Memory* @routine_pushq__rbp(%struct.State* %0, i64  0, %struct.Memory* %loadMem_40f430)
  store %struct.Memory* %call_40f430, %struct.Memory** %MEMORY

  ; Code: movq %rsp, %rbp	 RIP: 40f431	 Bytes: 3
  %loadMem_40f431 = load %struct.Memory*, %struct.Memory** %MEMORY
  %call_40f431 = call %struct.Memory* @routine_movq__rsp___rbp(%struct.State* %0, i64  0, %struct.Memory* %loadMem_40f431)
  store %struct.Memory* %call_40f431, %struct.Memory** %MEMORY

  ; Code: movss 0x965c(%rip), %xmm1	 RIP: 40f434	 Bytes: 8
  %loadMem_40f434 = load %struct.Memory*, %struct.Memory** %MEMORY
  %call_40f434 = call %struct.Memory* @routine_movss_0x965c__rip____xmm1(%struct.State* %0, i64  0, %struct.Memory* %loadMem_40f434)
  store %struct.Memory* %call_40f434, %struct.Memory** %MEMORY

  ; Code: movss %xmm0, -0x4(%rbp)	 RIP: 40f43c	 Bytes: 5
  %loadMem_40f43c = load %struct.Memory*, %struct.Memory** %MEMORY
  %call_40f43c = call %struct.Memory* @routine_movss__xmm0__MINUS0x4__rbp_(%struct.State* %0, i64  0, %struct.Memory* %loadMem_40f43c)
  store %struct.Memory* %call_40f43c, %struct.Memory** %MEMORY

  ; Code: mulss -0x4(%rbp), %xmm1	 RIP: 40f441	 Bytes: 5
  %loadMem_40f441 = load %struct.Memory*, %struct.Memory** %MEMORY
  %call_40f441 = call %struct.Memory* @routine_mulss_MINUS0x4__rbp____xmm1(%struct.State* %0, i64  0, %struct.Memory* %loadMem_40f441)
  store %struct.Memory* %call_40f441, %struct.Memory** %MEMORY

  ; Code: movaps %xmm1, %xmm0	 RIP: 40f446	 Bytes: 3
  %loadMem_40f446 = load %struct.Memory*, %struct.Memory** %MEMORY
  %call_40f446 = call %struct.Memory* @routine_movaps__xmm1___xmm0(%struct.State* %0, i64  0, %struct.Memory* %loadMem_40f446)
  store %struct.Memory* %call_40f446, %struct.Memory** %MEMORY

  ; Code: popq %rbp	 RIP: 40f449	 Bytes: 1
  %loadMem_40f449 = load %struct.Memory*, %struct.Memory** %MEMORY
  %call_40f449 = call %struct.Memory* @routine_popq__rbp(%struct.State* %0, i64  0, %struct.Memory* %loadMem_40f449)
  store %struct.Memory* %call_40f449, %struct.Memory** %MEMORY

  ; Code: retq	 RIP: 40f44a	 Bytes: 1
  %loadMem_40f44a = load %struct.Memory*, %struct.Memory** %MEMORY
  %call_40f44a = call %struct.Memory* @routine_retq(%struct.State* %0, i64  0, %struct.Memory* %loadMem_40f44a)
  store %struct.Memory* %call_40f44a, %struct.Memory** %MEMORY

  ret %struct.Memory* %call_40f44a
}
