...
entry:
  ...
  store %struct.Memory* %loadMem_416b20, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_416b24, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_416b2a, %struct.Memory** %MEMORY
  ...
  ret %struct.Memory* %loadMem_416b38
}
