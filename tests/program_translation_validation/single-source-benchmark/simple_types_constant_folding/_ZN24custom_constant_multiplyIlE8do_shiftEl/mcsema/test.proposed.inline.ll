...
entry:
  ...
  store %struct.Memory* %loadMem_411640, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_411641, %struct.Memory** %MEMORY
  ...
  store i64 %40, i64* %43
  store %struct.Memory* %loadMem_411644, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_411648, %struct.Memory** %MEMORY
  ...
  %loadMem_41164e = load %struct.Memory*, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_41164e, %struct.Memory** %MEMORY
  ret %struct.Memory* %loadMem_41164e
}
