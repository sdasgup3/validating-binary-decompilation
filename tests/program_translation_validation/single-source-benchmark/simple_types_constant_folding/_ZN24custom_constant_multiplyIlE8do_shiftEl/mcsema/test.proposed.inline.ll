...
define %struct.Memory* @_ZN24custom_constant_multiplyIlE8do_shiftEl(%struct.State* noalias, i64, %struct.Memory* noalias) #1 {
entry:
  ...
  %loadMem_411680 = load %struct.Memory*, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_411680, %struct.Memory** %MEMORY
  ...
  %loadMem_41168d = load %struct.Memory*, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_41168d, %struct.Memory** %MEMORY
  %loadMem_41168e = load %struct.Memory*, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_41168e, %struct.Memory** %MEMORY
  ret %struct.Memory* %loadMem_41168e
}
