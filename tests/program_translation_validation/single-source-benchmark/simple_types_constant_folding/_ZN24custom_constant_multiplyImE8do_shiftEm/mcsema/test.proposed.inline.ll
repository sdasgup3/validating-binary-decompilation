...
define %struct.Memory* @_ZN24custom_constant_multiplyImE8do_shiftEm(%struct.State* noalias, i64, %struct.Memory* noalias) #1 {
entry:
  ...
  store %struct.Memory* %loadMem_410310, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_410311, %struct.Memory** %MEMORY
  ...
  store i64 %40, i64* %43
  store %struct.Memory* %loadMem_410314, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_410318, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_41031d, %struct.Memory** %MEMORY
  ...
  ret %struct.Memory* %loadMem_41031e
}
