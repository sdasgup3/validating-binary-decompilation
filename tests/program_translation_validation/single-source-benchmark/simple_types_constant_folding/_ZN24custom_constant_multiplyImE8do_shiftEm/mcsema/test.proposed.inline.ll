...
entry:
  ...
  store %struct.Memory* %loadMem_4102d0, %struct.Memory** %MEMORY
  ...
  store i64 %40, i64* %43
  store %struct.Memory* %loadMem_4102d4, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_4102d8, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_4102dd, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_4102de, %struct.Memory** %MEMORY
  ret %struct.Memory* %loadMem_4102de
}
