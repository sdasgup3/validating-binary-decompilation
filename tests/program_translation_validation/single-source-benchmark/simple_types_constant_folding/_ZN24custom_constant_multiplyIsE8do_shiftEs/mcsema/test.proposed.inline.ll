...
entry:
  ...
  %loadMem_415850 = load %struct.Memory*, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_415850, %struct.Memory** %MEMORY
  ...
  %loadMem_415854 = load %struct.Memory*, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_415854, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_415862, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_415866, %struct.Memory** %MEMORY
  ...
  ret %struct.Memory* %loadMem_415867
}
