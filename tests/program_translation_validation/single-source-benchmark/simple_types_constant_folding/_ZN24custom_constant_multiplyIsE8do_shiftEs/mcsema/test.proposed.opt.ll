...
define %struct.Memory* @_ZN24custom_constant_multiplyIsE8do_shiftEs(%struct.State* noalias nocapture, i64, %struct.Memory* noalias readnone returned) local_unnamed_addr #1 {
entry:
  ...
  %24 = mul nsw i64 %23, 120
  %25 = trunc i64 %24 to i32
  %26 = and i64 %24, 4294967288
  store i64 %26, i64* %RDI.i8, align 8
  %27 = mul nsw i64 %23, 515396075520
  ...
  %44 = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 1, i32 0, i32 0
  %sext = mul i64 %23, 33776997205278720
...
define %struct.Memory* @routine_imull__0x78___edi___edi(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned) local_unnamed_addr #3 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
