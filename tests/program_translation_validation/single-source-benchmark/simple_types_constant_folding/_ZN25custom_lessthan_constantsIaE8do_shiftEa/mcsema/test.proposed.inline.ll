...
entry:
  ...
  %loadMem_418400 = load %struct.Memory*, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_418400, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_418404, %struct.Memory** %MEMORY
  ...
  %loadMem_41840f = load %struct.Memory*, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_41840f, %struct.Memory** %MEMORY
  %loadMem_418412 = load %struct.Memory*, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_418412, %struct.Memory** %MEMORY
  %loadMem_418413 = load %struct.Memory*, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_418413, %struct.Memory** %MEMORY
  ret %struct.Memory* %loadMem_418413
}
