...
entry:
  ...
  store %struct.Memory* %loadMem_4183b0, %struct.Memory** %MEMORY
  %loadMem_4183b1 = load %struct.Memory*, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_4183b1, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_4183b4, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_4183b9, %struct.Memory** %MEMORY
  ...
  %loadMem_4183c2 = load %struct.Memory*, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_4183c2, %struct.Memory** %MEMORY
  ...
  ret %struct.Memory* %loadMem_4183c3
}
