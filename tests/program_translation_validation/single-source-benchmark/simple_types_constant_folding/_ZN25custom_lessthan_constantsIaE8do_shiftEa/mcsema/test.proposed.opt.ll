...
define %struct.Memory* @_ZN25custom_lessthan_constantsIaE8do_shiftEa(%struct.State* noalias nocapture, i64, %struct.Memory* noalias readnone returned) local_unnamed_addr #0 {
entry:
