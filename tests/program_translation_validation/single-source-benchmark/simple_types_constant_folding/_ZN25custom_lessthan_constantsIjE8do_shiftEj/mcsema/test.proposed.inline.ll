...
define %struct.Memory* @_ZN25custom_lessthan_constantsIjE8do_shiftEj(%struct.State* noalias, i64, %struct.Memory* noalias) #2 {
entry:
  ...
  store %struct.Memory* %loadMem_412a40, %struct.Memory** %MEMORY
  ...
  ret %struct.Memory* %loadMem_412a4a
}
