...
define %struct.Memory* @_ZN25custom_lessthan_constantsIlE8do_shiftEl(%struct.State* noalias, i64, %struct.Memory* noalias) #2 {
entry:
  ...
  store %struct.Memory* %loadMem_411b5b, %struct.Memory** %MEMORY
  ret %struct.Memory* %loadMem_411b5b
}
