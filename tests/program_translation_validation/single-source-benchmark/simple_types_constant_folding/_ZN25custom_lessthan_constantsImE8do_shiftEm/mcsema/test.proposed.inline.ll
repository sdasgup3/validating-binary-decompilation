...
define %struct.Memory* @_ZN25custom_lessthan_constantsImE8do_shiftEm(%struct.State* noalias, i64, %struct.Memory* noalias) #2 {
entry:
  ...
  store i64 %72, i64* %75
  store %struct.Memory* %loadMem_410976, %struct.Memory** %MEMORY
  ...
  ret %struct.Memory* %loadMem_41097b
}
