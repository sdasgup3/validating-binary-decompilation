...
define %struct.Memory* @_ZN25custom_lessthan_constantsItE8do_shiftEt(%struct.State* noalias, i64, %struct.Memory* noalias) #1 {
entry:
  ...
  store %struct.Memory* %loadMem_414b70, %struct.Memory** %MEMORY
  ...
  ret %struct.Memory* %loadMem_414b84
}
