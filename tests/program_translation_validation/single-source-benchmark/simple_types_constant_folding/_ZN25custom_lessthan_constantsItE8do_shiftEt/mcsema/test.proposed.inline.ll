...
define %struct.Memory* @_ZN25custom_lessthan_constantsItE8do_shiftEt(%struct.State* noalias, i64, %struct.Memory* noalias) #2 {
entry:
  ...
  store %struct.Memory* %loadMem_414b87, %struct.Memory** %MEMORY
  ...
  ret %struct.Memory* %loadMem_414b94
}
