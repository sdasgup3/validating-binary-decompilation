...
define %struct.Memory* @_ZN25custom_lessthan_constantsItE8do_shiftEt(%struct.State* noalias nocapture, i64, %struct.Memory* noalias readnone returned) local_unnamed_addr #0 {
entry:
  ...
  %DI.i12 = bitcast %union.anon* %11 to i16*
  %12 = load i16, i16* %DI.i12, align 2
  ...
  %CX.i8 = bitcast %union.anon* %19 to i16*
  store i16 0, i16* %CX.i8, align 2
  %20 = add i64 %7, -10
  %21 = add i64 %10, 15
