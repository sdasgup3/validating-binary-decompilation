...
define %struct.Memory* @_ZN25custom_multiply_constantsIdE8do_shiftEd(%struct.State* noalias, i64, %struct.Memory* noalias) #1 {
entry:
  ...
  store %struct.Memory* %loadMem_40edc4, %struct.Memory** %MEMORY
  ...
  ret %struct.Memory* %loadMem_40edd5
}
