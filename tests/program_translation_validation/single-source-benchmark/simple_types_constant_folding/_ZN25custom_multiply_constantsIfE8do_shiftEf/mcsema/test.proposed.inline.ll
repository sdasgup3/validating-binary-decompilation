...
%G_0x92c8__rip__type = type <{ [16 x i8] }>
...
entry:
  ...
  %38 = load float, float* bitcast (%G_0x92c8__rip__type* @G_0x92c8__rip_ to float*)
...
block_400478:
  ...
  %9 = load i64, i64* %PC
  %10 = ptrtoint %G_0x92c8__rip__type* @G_0x92c8__rip_ to i64
  %11 = load i64, i64* %PC
  %12 = add i64 %11, 8
  store i64 %12, i64* %PC
