...
define %struct.Memory* @_ZN25custom_multiply_constantsIjE8do_shiftEj(%struct.State* noalias, i64, %struct.Memory* noalias) #2 {
entry:
  ...
  %loadMem_412d30 = load %struct.Memory*, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_412d30, %struct.Memory** %MEMORY
  ...
  %loadMem_412d39 = load %struct.Memory*, %struct.Memory** %MEMORY
  ...
  store i32 %48, i32* %52
  store %struct.Memory* %loadMem_412d39, %struct.Memory** %MEMORY
  ...
  ret %struct.Memory* %loadMem_412d3d
}
