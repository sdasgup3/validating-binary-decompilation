...
define %struct.Memory* @_ZN25custom_multiply_constantsIjE8do_shiftEj(%struct.State* noalias, i64, %struct.Memory* noalias) #1 {
entry:
  ...
  %loadMem_412d2c = load %struct.Memory*, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_412d2c, %struct.Memory** %MEMORY
  ...
  ret %struct.Memory* %loadMem_412d2d
}
