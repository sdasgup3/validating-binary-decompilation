...
define %struct.Memory* @_ZN25custom_multiply_constantsIlE8do_shiftEl(%struct.State* noalias, i64, %struct.Memory* noalias) #1 {
entry:
  ...
  store i64 %48, i64* %51
  store %struct.Memory* %loadMem_411de9, %struct.Memory** %MEMORY
  %loadMem_411ded = load %struct.Memory*, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_411ded, %struct.Memory** %MEMORY
  ...
  ret %struct.Memory* %loadMem_411dee
}
