...
define %struct.Memory* @_ZN25custom_multiply_constantsIlE8do_shiftEl(%struct.State* noalias, i64, %struct.Memory* noalias) #2 {
entry:
  ...
  store %struct.Memory* %loadMem_411da4, %struct.Memory** %MEMORY
  ...
  %loadMem_411dad = load %struct.Memory*, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_411dad, %struct.Memory** %MEMORY
  ...
  ret %struct.Memory* %loadMem_411dae
}
