...
define %struct.Memory* @_ZN25custom_multiply_constantsImE8do_shiftEm(%struct.State* noalias, i64, %struct.Memory* noalias) #1 {
entry:
  ...
  store %struct.Memory* %loadMem_410d70, %struct.Memory** %MEMORY
  ...
  ret %struct.Memory* %loadMem_410d7e
}
