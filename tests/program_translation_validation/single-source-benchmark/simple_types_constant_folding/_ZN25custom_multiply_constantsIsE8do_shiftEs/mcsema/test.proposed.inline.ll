...
define %struct.Memory* @_ZN25custom_multiply_constantsIsE8do_shiftEs(%struct.State* noalias, i64, %struct.Memory* noalias) #2 {
entry:
  ...
  %loadMem_4161c4 = load %struct.Memory*, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_4161c4, %struct.Memory** %MEMORY
  ...
  store i16 6, i16* %CX.i8, align 2
  store %struct.Memory* %loadMem_4161c7, %struct.Memory** %MEMORY
  %loadMem_4161cb = load %struct.Memory*, %struct.Memory** %MEMORY
  ...
  store i16 %61, i16* %65
  store %struct.Memory* %loadMem_4161cb, %struct.Memory** %MEMORY
  %loadMem_4161cf = load %struct.Memory*, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_4161cf, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_4161d2, %struct.Memory** %MEMORY
  ...
  ret %struct.Memory* %loadMem_4161d3
}
...
define %struct.Memory* @routine_movw__0x6___cx(%struct.State* dereferenceable(3376), i64, %struct.Memory*) {
block_400488:
  %3 = getelementptr inbounds %struct.State, %struct.State* %0, i32 0, i32 6
  %4 = getelementptr inbounds %struct.GPR, %struct.GPR* %3, i32 0, i32 33
  %5 = getelementptr inbounds %struct.Reg, %struct.Reg* %4, i32 0, i32 0
