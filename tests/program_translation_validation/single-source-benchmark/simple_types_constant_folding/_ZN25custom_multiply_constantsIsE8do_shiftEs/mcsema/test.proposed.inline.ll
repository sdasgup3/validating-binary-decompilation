...
entry:
  ...
  %loadMem_41617b = load %struct.Memory*, %struct.Memory** %MEMORY
  ...
  store i16 %61, i16* %65
  store %struct.Memory* %loadMem_41617b, %struct.Memory** %MEMORY
  %loadMem_41617f = load %struct.Memory*, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_41617f, %struct.Memory** %MEMORY
  ...
  ret %struct.Memory* %loadMem_416183
}
