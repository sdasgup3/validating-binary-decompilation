...
define %struct.Memory* @_ZN25custom_notequal_constantsIaE8do_shiftEa(%struct.State* noalias, i64, %struct.Memory* noalias) #1 {
entry:
  ...
  store %struct.Memory* %loadMem_418510, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_418511, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_418514, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_418517, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_41851c, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_41851f, %struct.Memory** %MEMORY
  ...
  ret %struct.Memory* %loadMem_418520
}
