...
entry:
  ...
  store %struct.Memory* %loadMem_4184d0, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_4184d1, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_4184d4, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_4184d7, %struct.Memory** %MEMORY
  ...
  store i8 %65, i8* %69
  store %struct.Memory* %loadMem_4184d9, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_4184dc, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_4184df, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_4184e0, %struct.Memory** %MEMORY
  ret %struct.Memory* %loadMem_4184e0
}
