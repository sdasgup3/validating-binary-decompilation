...
entry:
  ...
  store %struct.Memory* %loadMem_418521, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_418524, %struct.Memory** %MEMORY
  ...
  store i8 %65, i8* %69
  store %struct.Memory* %loadMem_418529, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_41852c, %struct.Memory** %MEMORY
  ...
  ret %struct.Memory* %loadMem_418530
}
