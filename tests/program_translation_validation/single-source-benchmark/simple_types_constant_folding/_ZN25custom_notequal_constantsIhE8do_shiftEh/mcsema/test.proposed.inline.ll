...
define %struct.Memory* @_ZN25custom_notequal_constantsIhE8do_shiftEh(%struct.State* noalias, i64, %struct.Memory* noalias) #1 {
entry:
  ...
  %loadMem_417244 = load %struct.Memory*, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_417244, %struct.Memory** %MEMORY
  %loadMem_417247 = load %struct.Memory*, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_417247, %struct.Memory** %MEMORY
  ...
  store i8 %65, i8* %69
  store %struct.Memory* %loadMem_417249, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_41724c, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_41724f, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_417250, %struct.Memory** %MEMORY
  ret %struct.Memory* %loadMem_417250
}
