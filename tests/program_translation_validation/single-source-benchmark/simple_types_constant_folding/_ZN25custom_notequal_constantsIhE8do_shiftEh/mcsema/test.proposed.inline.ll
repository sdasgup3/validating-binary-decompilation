...
define %struct.Memory* @_ZN25custom_notequal_constantsIhE8do_shiftEh(%struct.State* noalias, i64, %struct.Memory* noalias) #2 {
entry:
  ...
  %loadMem_417200 = load %struct.Memory*, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_417200, %struct.Memory** %MEMORY
  ...
  %loadMem_417204 = load %struct.Memory*, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_417204, %struct.Memory** %MEMORY
  %loadMem_417207 = load %struct.Memory*, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_417207, %struct.Memory** %MEMORY
  ...
  ret %struct.Memory* %loadMem_417210
}
