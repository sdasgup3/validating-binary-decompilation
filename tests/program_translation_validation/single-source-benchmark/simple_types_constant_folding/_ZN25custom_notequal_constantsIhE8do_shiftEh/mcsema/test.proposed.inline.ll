...
entry:
  ...
  store %struct.Memory* %loadMem_417251, %struct.Memory** %MEMORY
  %loadMem_417254 = load %struct.Memory*, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_417254, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_417257, %struct.Memory** %MEMORY
  ...
  store i8 %65, i8* %69
  store %struct.Memory* %loadMem_417259, %struct.Memory** %MEMORY
  %loadMem_41725c = load %struct.Memory*, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_41725c, %struct.Memory** %MEMORY
  %loadMem_41725f = load %struct.Memory*, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_41725f, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_417260, %struct.Memory** %MEMORY
  ret %struct.Memory* %loadMem_417260
}
