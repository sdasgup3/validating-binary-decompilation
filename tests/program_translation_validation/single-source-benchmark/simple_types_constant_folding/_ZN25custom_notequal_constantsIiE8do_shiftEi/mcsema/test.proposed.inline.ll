...
define %struct.Memory* @_ZN25custom_notequal_constantsIiE8do_shiftEi(%struct.State* noalias, i64, %struct.Memory* noalias) #2 {
entry:
  ...
  store %struct.Memory* %loadMem_413ac4, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_413acd, %struct.Memory** %MEMORY
  ret %struct.Memory* %loadMem_413acd
}
