...
define %struct.Memory* @_ZN25custom_notequal_constantsIjE8do_shiftEj(%struct.State* noalias, i64, %struct.Memory* noalias) #2 {
entry:
  ...
  store %struct.Memory* %loadMem_412b20, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_412b21, %struct.Memory** %MEMORY
  ...
  ret %struct.Memory* %loadMem_412b2d
}
