...
define %struct.Memory* @_ZN25custom_notequal_constantsIlE8do_shiftEl(%struct.State* noalias, i64, %struct.Memory* noalias) #2 {
entry:
  ...
  store %struct.Memory* %loadMem_411be1, %struct.Memory** %MEMORY
  %loadMem_411be4 = load %struct.Memory*, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_411be4, %struct.Memory** %MEMORY
  ...
  %loadMem_411bed = load %struct.Memory*, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_411bed, %struct.Memory** %MEMORY
  ...
  ret %struct.Memory* %loadMem_411bee
}
