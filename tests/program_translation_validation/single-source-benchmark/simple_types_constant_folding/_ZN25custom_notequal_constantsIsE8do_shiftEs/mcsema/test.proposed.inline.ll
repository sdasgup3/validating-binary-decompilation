...
define %struct.Memory* @_ZN25custom_notequal_constantsIsE8do_shiftEs(%struct.State* noalias, i64, %struct.Memory* noalias) #1 {
entry:
  ...
  store %struct.Memory* %loadMem_415f70, %struct.Memory** %MEMORY
  ...
  store i16 %61, i16* %65
  store %struct.Memory* %loadMem_415f7b, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_415f7f, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_415f82, %struct.Memory** %MEMORY
  ...
  ret %struct.Memory* %loadMem_415f83
}
