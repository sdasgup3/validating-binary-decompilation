...
define %struct.Memory* @_ZN25custom_notequal_constantsItE8do_shiftEt(%struct.State* noalias, i64, %struct.Memory* noalias) #1 {
entry:
  ...
  store %struct.Memory* %loadMem_414c91, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_414c94, %struct.Memory** %MEMORY
  ...
  ret %struct.Memory* %loadMem_414ca3
}
