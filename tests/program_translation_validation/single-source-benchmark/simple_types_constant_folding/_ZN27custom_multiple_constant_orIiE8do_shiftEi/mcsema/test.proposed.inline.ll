...
entry:
  ...
  store %struct.Memory* %loadMem_412fd1, %struct.Memory** %MEMORY
  ...
  %loadMem_412fe3 = load %struct.Memory*, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_412fe3, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_412fe8, %struct.Memory** %MEMORY
  ...
  ret %struct.Memory* %loadMem_412fe9
}
