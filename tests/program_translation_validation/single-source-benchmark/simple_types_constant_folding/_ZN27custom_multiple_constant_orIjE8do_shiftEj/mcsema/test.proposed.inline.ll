...
define %struct.Memory* @_ZN27custom_multiple_constant_orIjE8do_shiftEj(%struct.State* noalias, i64, %struct.Memory* noalias) #1 {
entry:
  ...
  store %struct.Memory* %loadMem_4120d7, %struct.Memory** %MEMORY
  ...
  ret %struct.Memory* %loadMem_4120e9
}
