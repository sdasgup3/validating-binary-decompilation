...
entry:
  ...
  store %struct.Memory* %loadMem_415272, %struct.Memory** %MEMORY
  %loadMem_415275 = load %struct.Memory*, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_415275, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_41527b, %struct.Memory** %MEMORY
  ...
  ret %struct.Memory* %loadMem_415280
}
