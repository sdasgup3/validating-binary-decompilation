...
entry:
  ...
  store %struct.Memory* %loadMem_418491, %struct.Memory** %MEMORY
  ...
  %loadMem_418497 = load %struct.Memory*, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_418497, %struct.Memory** %MEMORY
  %loadMem_418499 = load %struct.Memory*, %struct.Memory** %MEMORY
  ...
  store i8 %65, i8* %69
  store %struct.Memory* %loadMem_418499, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_41849c, %struct.Memory** %MEMORY
  %loadMem_41849f = load %struct.Memory*, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_41849f, %struct.Memory** %MEMORY
  ...
  ret %struct.Memory* %loadMem_4184a0
}
