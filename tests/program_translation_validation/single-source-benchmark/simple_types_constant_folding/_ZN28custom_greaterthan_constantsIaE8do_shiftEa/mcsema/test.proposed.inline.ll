...
entry:
  ...
  store %struct.Memory* %loadMem_418440, %struct.Memory** %MEMORY
  ...
  %loadMem_418444 = load %struct.Memory*, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_418444, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_418447, %struct.Memory** %MEMORY
  ...
  %loadMem_41844c = load %struct.Memory*, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_41844c, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_41844f, %struct.Memory** %MEMORY
  ...
  ret %struct.Memory* %loadMem_418450
}
