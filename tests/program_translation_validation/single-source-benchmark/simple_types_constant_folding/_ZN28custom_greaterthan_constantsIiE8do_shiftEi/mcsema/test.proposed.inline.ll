...
define %struct.Memory* @_ZN28custom_greaterthan_constantsIiE8do_shiftEi(%struct.State* noalias, i64, %struct.Memory* noalias) #2 {
entry:
  ...
  store %struct.Memory* %loadMem_413a04, %struct.Memory** %MEMORY
  ...
  ret %struct.Memory* %loadMem_413a0d
}
