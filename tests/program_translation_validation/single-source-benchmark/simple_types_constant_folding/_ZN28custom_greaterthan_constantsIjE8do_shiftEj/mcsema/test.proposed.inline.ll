...
entry:
  ...
  %loadMem_412ab0 = load %struct.Memory*, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_412ab0, %struct.Memory** %MEMORY
  ...
  %loadMem_412ab9 = load %struct.Memory*, %struct.Memory** %MEMORY
  ...
  store i32 %48, i32* %52
  store %struct.Memory* %loadMem_412ab9, %struct.Memory** %MEMORY
  ...
  %loadMem_412abd = load %struct.Memory*, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_412abd, %struct.Memory** %MEMORY
  ret %struct.Memory* %loadMem_412abd
}
