...
define %struct.Memory* @_ZN28custom_greaterthan_constantsIjE8do_shiftEj(%struct.State* noalias, i64, %struct.Memory* noalias) #1 {
entry:
  ...
  %loadMem_412af0 = load %struct.Memory*, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_412af0, %struct.Memory** %MEMORY
  %loadMem_412af1 = load %struct.Memory*, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_412af1, %struct.Memory** %MEMORY
  %loadMem_412af4 = load %struct.Memory*, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_412af4, %struct.Memory** %MEMORY
  %loadMem_412af9 = load %struct.Memory*, %struct.Memory** %MEMORY
  ...
  store i32 %48, i32* %52
  store %struct.Memory* %loadMem_412af9, %struct.Memory** %MEMORY
  %loadMem_412afc = load %struct.Memory*, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_412afc, %struct.Memory** %MEMORY
  ...
  ret %struct.Memory* %loadMem_412afd
}
