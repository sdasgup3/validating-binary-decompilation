...
define %struct.Memory* @_ZN28custom_greaterthan_constantsIjE8do_shiftEj(%struct.State* noalias, i64, %struct.Memory* noalias) #2 {
entry:
  ...
  store %struct.Memory* %loadMem_412b00, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_412b01, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_412b04, %struct.Memory** %MEMORY
  %loadMem_412b09 = load %struct.Memory*, %struct.Memory** %MEMORY
  ...
  store i32 %48, i32* %52
  store %struct.Memory* %loadMem_412b09, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_412b0c, %struct.Memory** %MEMORY
  %loadMem_412b0d = load %struct.Memory*, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_412b0d, %struct.Memory** %MEMORY
  ret %struct.Memory* %loadMem_412b0d
}
