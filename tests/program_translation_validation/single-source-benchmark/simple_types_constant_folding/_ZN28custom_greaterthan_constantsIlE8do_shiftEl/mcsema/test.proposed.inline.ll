...
define %struct.Memory* @_ZN28custom_greaterthan_constantsIlE8do_shiftEl(%struct.State* noalias, i64, %struct.Memory* noalias) #1 {
entry:
  ...
  store %struct.Memory* %loadMem_411bbd, %struct.Memory** %MEMORY
  ...
  ret %struct.Memory* %loadMem_411bbe
}
