...
define %struct.Memory* @_ZN28custom_greaterthan_constantsImE8do_shiftEm(%struct.State* noalias, i64, %struct.Memory* noalias) #2 {
entry:
  ...
  store i64 %48, i64* %51
  store %struct.Memory* %loadMem_410a19, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_410a1e, %struct.Memory** %MEMORY
  ret %struct.Memory* %loadMem_410a1e
}
