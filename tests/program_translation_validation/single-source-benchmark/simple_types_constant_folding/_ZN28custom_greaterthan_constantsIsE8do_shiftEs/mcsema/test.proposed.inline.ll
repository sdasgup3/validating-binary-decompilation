...
define %struct.Memory* @_ZN28custom_greaterthan_constantsIsE8do_shiftEs(%struct.State* noalias, i64, %struct.Memory* noalias) #1 {
entry:
  ...
  store %struct.Memory* %loadMem_415ee1, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_415ee4, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_415ef3, %struct.Memory** %MEMORY
  ret %struct.Memory* %loadMem_415ef3
}
