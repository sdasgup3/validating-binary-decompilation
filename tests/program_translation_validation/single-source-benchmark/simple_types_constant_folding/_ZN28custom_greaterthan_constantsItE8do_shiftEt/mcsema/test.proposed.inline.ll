...
define %struct.Memory* @_ZN28custom_greaterthan_constantsItE8do_shiftEt(%struct.State* noalias, i64, %struct.Memory* noalias) #1 {
entry:
  ...
  %loadMem_414c01 = load %struct.Memory*, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_414c01, %struct.Memory** %MEMORY
  %loadMem_414c04 = load %struct.Memory*, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_414c04, %struct.Memory** %MEMORY
  ...
  %loadMem_414c12 = load %struct.Memory*, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_414c12, %struct.Memory** %MEMORY
  ...
  ret %struct.Memory* %loadMem_414c13
}
