...
entry:
  ...
  %loadMem_414bc0 = load %struct.Memory*, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_414bc0, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_414bc1, %struct.Memory** %MEMORY
  %loadMem_414bc4 = load %struct.Memory*, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_414bc4, %struct.Memory** %MEMORY
  %loadMem_414bc7 = load %struct.Memory*, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_414bc7, %struct.Memory** %MEMORY
  ...
  %loadMem_414bd2 = load %struct.Memory*, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_414bd2, %struct.Memory** %MEMORY
  ...
  ret %struct.Memory* %loadMem_414bd3
}
