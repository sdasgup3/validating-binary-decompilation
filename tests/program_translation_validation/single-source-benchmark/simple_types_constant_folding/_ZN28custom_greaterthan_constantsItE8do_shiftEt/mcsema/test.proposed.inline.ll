...
define %struct.Memory* @_ZN28custom_greaterthan_constantsItE8do_shiftEt(%struct.State* noalias, i64, %struct.Memory* noalias) #2 {
entry:
  ...
  %loadMem_414c10 = load %struct.Memory*, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_414c10, %struct.Memory** %MEMORY
  ...
  %loadMem_414c17 = load %struct.Memory*, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_414c17, %struct.Memory** %MEMORY
  ...
  %loadMem_414c1f = load %struct.Memory*, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_414c1f, %struct.Memory** %MEMORY
  %loadMem_414c22 = load %struct.Memory*, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_414c22, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_414c23, %struct.Memory** %MEMORY
  ret %struct.Memory* %loadMem_414c23
}
