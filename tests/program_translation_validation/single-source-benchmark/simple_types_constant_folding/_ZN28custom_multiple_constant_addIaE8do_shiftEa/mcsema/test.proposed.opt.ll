...
define %struct.Memory* @_ZN28custom_multiple_constant_addIaE8do_shiftEa(%struct.State* noalias, i64, %struct.Memory* noalias readnone returned) local_unnamed_addr #1 {
entry:
