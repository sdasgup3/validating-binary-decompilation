...
@G_0x9e24__rip_ = local_unnamed_addr global %G_0x9e24__rip__type zeroinitializer
@G_0x9e5c__rip_ = local_unnamed_addr global %G_0x9e5c__rip__type zeroinitializer
...
entry:
  ...
  %12 = load i64, i64* bitcast (%G_0x9e5c__rip__type* @G_0x9e5c__rip_ to i64*), align 8
  ...
  %21 = load i64, i64* bitcast (%G_0x9e24__rip__type* @G_0x9e24__rip_ to i64*), align 8
  %22 = getelementptr inbounds %union.VectorReg, %union.VectorReg* %20, i64 0, i32 0, i32 0, i32 0, i64 0
  ...
  %25 = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 1, i64 4
  ...
  store i64 %12, i64* %27, align 1
  %28 = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 1, i64 4, i32 0, i32 0, i32 0, i64 1
  ...
  %33 = getelementptr inbounds %union.VectorReg, %union.VectorReg* %30, i64 0, i32 0, i32 0, i32 0, i64 0
  ...
  %40 = load double, double* %26, align 1
  %41 = bitcast i64* %28 to <2 x i32>*
  %42 = load <2 x i32>, <2 x i32>* %41, align 1
  ...
  store double %54, double* %26, align 1
  %55 = bitcast %union.VectorReg* %30 to i8*
  %56 = bitcast double %54 to <2 x i32>
  %57 = extractelement <2 x i32> %56, i32 0
  %58 = bitcast %union.VectorReg* %30 to i32*
  store i32 %57, i32* %58, align 1
  %59 = extractelement <2 x i32> %56, i32 1
  %60 = getelementptr inbounds i8, i8* %55, i64 4
  %61 = bitcast i8* %60 to i32*
  store i32 %59, i32* %61, align 1
  %62 = extractelement <2 x i32> %42, i32 0
  ...
  %65 = extractelement <2 x i32> %42, i32 1
...
block_400478:
  ...
  %5 = load i64, i64* bitcast (%G_0x9e5c__rip__type* @G_0x9e5c__rip_ to i64*), align 8
...
block_400478:
  ...
  %4 = add i64 %3, 8
  store i64 %4, i64* %PC, align 8
  %5 = load i64, i64* bitcast (%G_0x9e24__rip__type* @G_0x9e24__rip_ to i64*), align 8
