; ModuleID = '/tmp/tmps39oardm-query.ll'
...
define %struct.Memory* @_ZN28custom_multiple_constant_addIdE8do_shiftEd(%struct.State* noalias nocapture, i64, %struct.Memory* noalias readnone returned) local_unnamed_addr #0 {
entry:
  ...
  %var_2_12 = add i64 %var_2_10, add (i64 ptrtoint (%G_0x9e5c__rip__type* @G_0x9e5c__rip_ to i64), i64 3)
  ...
  %var_2_20 = add i64 %var_2_10, add (i64 ptrtoint (%G_0x9e5c__rip__type* @G_0x9e5c__rip_ to i64), i64 11)
  ...
  %var_2_28 = add i64 %var_2_10, add (i64 ptrtoint (%G_0x9e24__rip__type* @G_0x9e24__rip_ to i64), i64 19)
  ...
  %var_2_36 = add i64 %var_2_10, add (i64 ptrtoint (%G_0x9e5c__rip__type* @G_0x9e5c__rip_ to i64), i64 27)
