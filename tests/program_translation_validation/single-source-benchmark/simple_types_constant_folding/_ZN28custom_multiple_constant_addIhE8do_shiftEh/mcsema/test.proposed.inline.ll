...
entry:
  ...
  %loadMem_416d27 = load %struct.Memory*, %struct.Memory** %MEMORY
  ...
  store i8 %56, i8* %60
  store %struct.Memory* %loadMem_416d27, %struct.Memory** %MEMORY
  %loadMem_416d2a = load %struct.Memory*, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_416d2a, %struct.Memory** %MEMORY
  ...
  %loadMem_416d3d = load %struct.Memory*, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_416d3d, %struct.Memory** %MEMORY
  ...
  ret %struct.Memory* %loadMem_416d41
}
