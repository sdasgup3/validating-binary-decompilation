...
define %struct.Memory* @_ZN28custom_multiple_constant_addIjE8do_shiftEj(%struct.State* noalias, i64, %struct.Memory* noalias) #2 {
entry:
  ...
  store %struct.Memory* %loadMem_41271d, %struct.Memory** %MEMORY
  ...
  ret %struct.Memory* %loadMem_412729
}
