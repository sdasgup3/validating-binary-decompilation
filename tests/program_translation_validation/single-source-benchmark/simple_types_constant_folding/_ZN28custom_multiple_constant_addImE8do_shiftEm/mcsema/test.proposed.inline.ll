...
define %struct.Memory* @_ZN28custom_multiple_constant_addImE8do_shiftEm(%struct.State* noalias, i64, %struct.Memory* noalias) #2 {
entry:
  ...
  %loadMem_4104f0 = load %struct.Memory*, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_4104f0, %struct.Memory** %MEMORY
  ...
  ret %struct.Memory* %loadMem_410500
}
