...
define %struct.Memory* @_ZN28custom_multiple_constant_addImE8do_shiftEm(%struct.State* noalias, i64, %struct.Memory* noalias) #1 {
entry:
  ...
  store %struct.Memory* %loadMem_41053c, %struct.Memory** %MEMORY
  ...
  ret %struct.Memory* %loadMem_410540
}
