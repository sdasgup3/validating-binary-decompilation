...
define %struct.Memory* @_ZN28custom_multiple_constant_addIsE8do_shiftEs(%struct.State* noalias, i64, %struct.Memory* noalias) #2 {
entry:
  ...
  store %struct.Memory* %loadMem_415a10, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_415a1b, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_415a1f, %struct.Memory** %MEMORY
  ...
  %RDI.i10 = bitcast %union.anon* %122 to i64*
  %123 = load i64, i64* %RDI.i10
  %124 = load i64, i64* %PC.i9
  %125 = add i64 %124, 3
  store i64 %125, i64* %PC.i9
  %126 = trunc i64 %123 to i32
  %127 = add i32 2, %126
  %128 = zext i32 %127 to i64
  store i64 %128, i64* %RDI.i10, align 8
  ...
  store %struct.Memory* %loadMem_415a22, %struct.Memory** %MEMORY
  ...
  %RDI.i8 = bitcast %union.anon* %164 to i64*
  %165 = load i64, i64* %RDI.i8
  ...
  store i64 %170, i64* %RDI.i8, align 8
  %171 = icmp ult i32 %169, %168
  %172 = icmp ult i32 %169, 3
  %173 = or i1 %171, %172
  ...
  store %struct.Memory* %loadMem_415a28, %struct.Memory** %MEMORY
  ...
  %DI.i = bitcast %union.anon* %251 to i16*
  %252 = load i16, i16* %DI.i
  %253 = zext i16 %252 to i64
  %254 = load i64, i64* %PC.i5
  %255 = add i64 %254, 3
  store i64 %255, i64* %PC.i5
  store i16 %252, i16* %AX.i, align 2
  ...
  %262 = getelementptr inbounds %union.anon, %union.anon* %261, i64 0, i32 0
  %263 = bitcast %union.anon* %261 to i16*
  ...
  store %struct.Memory* %loadMem_415a2f, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_415a30, %struct.Memory** %MEMORY
  ret %struct.Memory* %loadMem_415a30
}
