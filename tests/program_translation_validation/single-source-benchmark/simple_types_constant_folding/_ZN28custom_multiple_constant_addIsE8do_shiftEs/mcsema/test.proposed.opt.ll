...
define %struct.Memory* @_ZN28custom_multiple_constant_addIsE8do_shiftEs(%struct.State* noalias, i64, %struct.Memory* noalias) local_unnamed_addr #1 {
entry:
  ...
  store i64 %33, i64* %RDI.i14, align 8
