...
define %struct.Memory* @_ZN28custom_multiple_constant_addItE8do_shiftEt(%struct.State* noalias, i64, %struct.Memory* noalias) #2 {
entry:
  ...
  %loadMem_414730 = load %struct.Memory*, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_414730, %struct.Memory** %MEMORY
  ...
  store i16 %53, i16* %57
  store %struct.Memory* %loadMem_414737, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_41473b, %struct.Memory** %MEMORY
  ...
  %loadMem_414745 = load %struct.Memory*, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_414745, %struct.Memory** %MEMORY
  %loadMem_414748 = load %struct.Memory*, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_414748, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_41474b, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_41474e, %struct.Memory** %MEMORY
  ...
  %loadMem_414752 = load %struct.Memory*, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_414752, %struct.Memory** %MEMORY
  ret %struct.Memory* %loadMem_414752
}
