...
entry:
  ...
  %loadMem_414795 = load %struct.Memory*, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_414795, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_41479b, %struct.Memory** %MEMORY
  ...
  ret %struct.Memory* %loadMem_4147a2
}
