...
define %struct.Memory* @_ZN28custom_multiple_constant_addItE8do_shiftEt(%struct.State* noalias, i64, %struct.Memory* noalias readnone returned) local_unnamed_addr #1 {
entry:
  ...
  %.mask = and i32 %31, 65535
  %42 = zext i32 %.mask to i64
