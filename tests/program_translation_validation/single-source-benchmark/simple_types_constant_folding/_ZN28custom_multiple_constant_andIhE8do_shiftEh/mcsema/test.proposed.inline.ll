...
define %struct.Memory* @_ZN28custom_multiple_constant_andIhE8do_shiftEh(%struct.State* noalias, i64, %struct.Memory* noalias) #2 {
entry:
  ...
  store %struct.Memory* %loadMem_416660, %struct.Memory** %MEMORY
  ...
  store i8 %56, i8* %60
  store %struct.Memory* %loadMem_416667, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_41666a, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_41666e, %struct.Memory** %MEMORY
  ...
  %RDI.i9 = bitcast %union.anon* %130 to i64*
  %131 = load i64, i64* %RDI.i9
  %132 = load i64, i64* %PC.i8
  %133 = add i64 %132, 3
  store i64 %133, i64* %PC.i8
  %134 = and i64 31, %131
  %135 = trunc i64 %134 to i32
  store i64 %134, i64* %RDI.i9, align 8
  ...
  store %struct.Memory* %loadMem_416674, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_416677, %struct.Memory** %MEMORY
  ...
  %AL.i6 = getelementptr inbounds %struct.anon.2, %struct.anon.2* %179, i32 0, i32 0
  ...
  %DIL.i = getelementptr inbounds %struct.anon.2, %struct.anon.2* %183, i32 0, i32 0
  %184 = load i8, i8* %DIL.i
  %185 = zext i8 %184 to i64
  %186 = load i64, i64* %PC.i5
  %187 = add i64 %186, 3
  store i64 %187, i64* %PC.i5
  store i8 %184, i8* %AL.i6, align 1
  store %struct.Memory* %loadMem_41667a, %struct.Memory** %MEMORY
  ...
  ret %struct.Memory* %loadMem_416681
}
