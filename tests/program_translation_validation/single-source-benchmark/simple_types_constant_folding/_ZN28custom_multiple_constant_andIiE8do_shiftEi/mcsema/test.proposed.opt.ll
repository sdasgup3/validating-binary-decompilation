...
define %struct.Memory* @_ZN28custom_multiple_constant_andIiE8do_shiftEi(%struct.State* noalias nocapture, i64, %struct.Memory* noalias readnone returned) local_unnamed_addr #1 {
entry:
  ...
  %30 = tail call i32 @llvm.ctpop.i32(i32 %28)
