...
define %struct.Memory* @_ZN28custom_multiple_constant_andIjE8do_shiftEj(%struct.State* noalias, i64, %struct.Memory* noalias) #2 {
entry:
  ...
  store %struct.Memory* %loadMem_4121ea, %struct.Memory** %MEMORY
  ...
  ret %struct.Memory* %loadMem_4121f9
}
