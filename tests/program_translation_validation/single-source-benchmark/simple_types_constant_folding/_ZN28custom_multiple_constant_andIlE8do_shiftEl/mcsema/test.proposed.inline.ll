...
entry:
  ...
  store %struct.Memory* %loadMem_411201, %struct.Memory** %MEMORY
  ...
  store i64 %40, i64* %43
  store %struct.Memory* %loadMem_411204, %struct.Memory** %MEMORY
  %loadMem_411208 = load %struct.Memory*, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_411208, %struct.Memory** %MEMORY
  ...
  ret %struct.Memory* %loadMem_411220
}
