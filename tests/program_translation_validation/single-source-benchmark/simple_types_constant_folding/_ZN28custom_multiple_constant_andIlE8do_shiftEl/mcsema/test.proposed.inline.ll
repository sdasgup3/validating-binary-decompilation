...
define %struct.Memory* @_ZN28custom_multiple_constant_andIlE8do_shiftEl(%struct.State* noalias, i64, %struct.Memory* noalias) #2 {
entry:
  ...
  %loadMem_411268 = load %struct.Memory*, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_411268, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_41126c, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_41126f, %struct.Memory** %MEMORY
  ...
  ret %struct.Memory* %loadMem_411270
}
