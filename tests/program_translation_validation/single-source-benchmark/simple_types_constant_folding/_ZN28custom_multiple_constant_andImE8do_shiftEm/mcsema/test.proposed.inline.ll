...
define %struct.Memory* @_ZN28custom_multiple_constant_andImE8do_shiftEm(%struct.State* noalias, i64, %struct.Memory* noalias) #1 {
entry:
  ...
  store %struct.Memory* %loadMem_40fd60, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_40fd61, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_40fd68, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_40fd7c, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_40fd7f, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_40fd80, %struct.Memory** %MEMORY
  ret %struct.Memory* %loadMem_40fd80
}
