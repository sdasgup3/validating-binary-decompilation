...
define %struct.Memory* @_ZN28custom_multiple_constant_andIsE8do_shiftEs(%struct.State* noalias, i64, %struct.Memory* noalias readnone returned) local_unnamed_addr #1 {
entry:
  ...
  %36 = icmp eq i32 %31, 0
  %37 = zext i1 %36 to i8
  store i64 %30, i64* %RDI.i14, align 8
