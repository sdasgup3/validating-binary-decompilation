...
entry:
  ...
  store %struct.Memory* %loadMem_4140fb, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_4140ff, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_414105, %struct.Memory** %MEMORY
  ...
  ret %struct.Memory* %loadMem_414112
}
