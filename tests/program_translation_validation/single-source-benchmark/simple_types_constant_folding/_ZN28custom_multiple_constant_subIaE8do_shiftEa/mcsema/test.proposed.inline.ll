...
entry:
  ...
  store %struct.Memory* %loadMem_417ec0, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_417ec1, %struct.Memory** %MEMORY
  ...
  store i8 %56, i8* %60
  store %struct.Memory* %loadMem_417ec7, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_417eca, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_417ece, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_417ed1, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_417ed4, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_417ed7, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_417edd, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_417ee0, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_417ee1, %struct.Memory** %MEMORY
  ret %struct.Memory* %loadMem_417ee1
}
