...
entry:
  ...
  store %struct.Memory* %loadMem_416bba, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_416bbe, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_416bc7, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_416bca, %struct.Memory** %MEMORY
  ...
  ret %struct.Memory* %loadMem_416bd1
}
