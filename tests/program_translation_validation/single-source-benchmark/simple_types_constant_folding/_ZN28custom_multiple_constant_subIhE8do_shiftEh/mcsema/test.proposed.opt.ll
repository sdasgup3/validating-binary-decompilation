...
define %struct.Memory* @_ZN28custom_multiple_constant_subIhE8do_shiftEh(%struct.State* noalias, i64, %struct.Memory* noalias readnone returned) local_unnamed_addr #1 {
entry:
