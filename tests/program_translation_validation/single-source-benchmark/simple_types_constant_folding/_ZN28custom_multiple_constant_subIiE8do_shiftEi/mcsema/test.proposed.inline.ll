...
entry:
  ...
  store %struct.Memory* %loadMem_4135ba, %struct.Memory** %MEMORY
  %loadMem_4135bd = load %struct.Memory*, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_4135bd, %struct.Memory** %MEMORY
  ...
  ret %struct.Memory* %loadMem_4135c9
}
