...
define %struct.Memory* @_ZN28custom_multiple_constant_subIiE8do_shiftEi(%struct.State* noalias, i64, %struct.Memory* noalias) #2 {
entry:
  ...
  %loadMem_41356a = load %struct.Memory*, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_41356a, %struct.Memory** %MEMORY
  ...
  %loadMem_413573 = load %struct.Memory*, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_413573, %struct.Memory** %MEMORY
  %loadMem_413576 = load %struct.Memory*, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_413576, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_413579, %struct.Memory** %MEMORY
  ret %struct.Memory* %loadMem_413579
}
