...
entry:
  ...
  %loadMem_4116b0 = load %struct.Memory*, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_4116b0, %struct.Memory** %MEMORY
  ...
  %loadMem_4116b4 = load %struct.Memory*, %struct.Memory** %MEMORY
  ...
  store i64 %40, i64* %43
  store %struct.Memory* %loadMem_4116b4, %struct.Memory** %MEMORY
  ...
  %loadMem_4116c0 = load %struct.Memory*, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_4116c0, %struct.Memory** %MEMORY
  ...
  %loadMem_4116c8 = load %struct.Memory*, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_4116c8, %struct.Memory** %MEMORY
  ...
  ret %struct.Memory* %loadMem_4116d0
}
