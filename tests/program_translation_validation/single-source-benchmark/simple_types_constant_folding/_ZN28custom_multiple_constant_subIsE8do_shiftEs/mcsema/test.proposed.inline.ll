...
entry:
  ...
  store %struct.Memory* %loadMem_415935, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_41593e, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_415940, %struct.Memory** %MEMORY
  ret %struct.Memory* %loadMem_415940
}
