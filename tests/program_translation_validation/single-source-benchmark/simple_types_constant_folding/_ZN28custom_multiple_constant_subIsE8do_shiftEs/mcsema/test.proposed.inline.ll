...
entry:
  ...
  store %struct.Memory* %loadMem_4158e4, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_4158eb, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_4158f8, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_4158fe, %struct.Memory** %MEMORY
  ...
  ret %struct.Memory* %loadMem_415900
}
