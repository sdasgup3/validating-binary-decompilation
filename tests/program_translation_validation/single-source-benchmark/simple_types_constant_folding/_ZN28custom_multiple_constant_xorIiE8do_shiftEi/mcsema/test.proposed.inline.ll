...
define %struct.Memory* @_ZN28custom_multiple_constant_xorIiE8do_shiftEi(%struct.State* noalias, i64, %struct.Memory* noalias) #1 {
entry:
  ...
  store %struct.Memory* %loadMem_412eea, %struct.Memory** %MEMORY
  ...
  ret %struct.Memory* %loadMem_412ef9
}
