...
define %struct.Memory* @_ZN28custom_multiple_constant_xorIjE8do_shiftEj(%struct.State* noalias, i64, %struct.Memory* noalias) #1 {
entry:
  ...
  store %struct.Memory* %loadMem_411faa, %struct.Memory** %MEMORY
  ...
  %RDI.i9 = bitcast %union.anon* %93 to i64*
  %94 = load i64, i64* %RDI.i9
  ...
  store i64 %99, i64* %RDI.i9, align 8
  ...
  %RDI.i7 = bitcast %union.anon* %120 to i64*
  %121 = load i64, i64* %RDI.i7
  ...
  store i64 %126, i64* %RDI.i7, align 8
  ...
  %PC.i5 = bitcast %union.anon* %144 to i64*
  ...
  %149 = load i64, i64* %PC.i5
  %150 = add i64 %149, 3
  store i64 %150, i64* %PC.i5
  %151 = xor i64 63, %148
  ...
  store %struct.Memory* %loadMem_411fb8, %struct.Memory** %MEMORY
  ...
  ret %struct.Memory* %loadMem_411fb9
}
