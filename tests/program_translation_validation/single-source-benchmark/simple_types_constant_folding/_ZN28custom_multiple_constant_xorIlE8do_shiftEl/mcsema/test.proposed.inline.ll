...
define %struct.Memory* @_ZN28custom_multiple_constant_xorIlE8do_shiftEl(%struct.State* noalias, i64, %struct.Memory* noalias) #1 {
entry:
  ...
  %loadMem_410ff1 = load %struct.Memory*, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_410ff1, %struct.Memory** %MEMORY
  ...
  store i64 %40, i64* %43
  store %struct.Memory* %loadMem_410ff4, %struct.Memory** %MEMORY
  %loadMem_410ff8 = load %struct.Memory*, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_410ff8, %struct.Memory** %MEMORY
  %loadMem_410ffc = load %struct.Memory*, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_410ffc, %struct.Memory** %MEMORY
  ...
  ret %struct.Memory* %loadMem_411010
}
