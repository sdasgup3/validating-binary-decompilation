...
define %struct.Memory* @_ZN28custom_multiple_constant_xorImE8do_shiftEm(%struct.State* noalias, i64, %struct.Memory* noalias) #2 {
entry:
  ...
  store %struct.Memory* %loadMem_40fa58, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_40fa68, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_40fa6f, %struct.Memory** %MEMORY
  ...
  ret %struct.Memory* %loadMem_40fa70
}
