...
define %struct.Memory* @_ZN30custom_lessthanequal_constantsIaE8do_shiftEa(%struct.State* noalias, i64, %struct.Memory* noalias) #1 {
entry:
  ...
  %loadMem_4182d1 = load %struct.Memory*, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_4182d1, %struct.Memory** %MEMORY
  ...
  %loadMem_4182d7 = load %struct.Memory*, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_4182d7, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_4182d9, %struct.Memory** %MEMORY
  %loadMem_4182dc = load %struct.Memory*, %struct.Memory** %MEMORY
  ...
  store i8 %103, i8* %107
  store %struct.Memory* %loadMem_4182dc, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_4182df, %struct.Memory** %MEMORY
  %loadMem_4182e2 = load %struct.Memory*, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_4182e2, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_4182e3, %struct.Memory** %MEMORY
  ret %struct.Memory* %loadMem_4182e3
}
