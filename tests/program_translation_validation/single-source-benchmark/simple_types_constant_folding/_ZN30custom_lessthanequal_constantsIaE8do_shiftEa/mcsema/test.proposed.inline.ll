...
entry:
  ...
  store %struct.Memory* %loadMem_4182e0, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_4182e7, %struct.Memory** %MEMORY
  %loadMem_4182e9 = load %struct.Memory*, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_4182e9, %struct.Memory** %MEMORY
  %loadMem_4182ec = load %struct.Memory*, %struct.Memory** %MEMORY
  ...
  store i8 %103, i8* %107
  store %struct.Memory* %loadMem_4182ec, %struct.Memory** %MEMORY
  %loadMem_4182ef = load %struct.Memory*, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_4182ef, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_4182f3, %struct.Memory** %MEMORY
  ret %struct.Memory* %loadMem_4182f3
}
