...
entry:
  ...
  %loadMem_418294 = load %struct.Memory*, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_418294, %struct.Memory** %MEMORY
  ...
  %loadMem_4182a2 = load %struct.Memory*, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_4182a2, %struct.Memory** %MEMORY
  ...
  ret %struct.Memory* %loadMem_4182a3
}
