...
define %struct.Memory* @_ZN30custom_lessthanequal_constantsIiE8do_shiftEi(%struct.State* noalias, i64, %struct.Memory* noalias) #2 {
entry:
  ...
  %loadMem_413900 = load %struct.Memory*, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_413900, %struct.Memory** %MEMORY
  ...
  %loadMem_413906 = load %struct.Memory*, %struct.Memory** %MEMORY
  ...
  store i32 %72, i32* %76
  store %struct.Memory* %loadMem_413906, %struct.Memory** %MEMORY
  %loadMem_413909 = load %struct.Memory*, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_413909, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_41390a, %struct.Memory** %MEMORY
  ret %struct.Memory* %loadMem_41390a
}
