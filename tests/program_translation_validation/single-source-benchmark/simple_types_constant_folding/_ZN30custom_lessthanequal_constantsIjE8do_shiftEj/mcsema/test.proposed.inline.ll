...
entry:
  ...
  store i32 %72, i32* %76
  store %struct.Memory* %loadMem_4129b6, %struct.Memory** %MEMORY
  %loadMem_4129b9 = load %struct.Memory*, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_4129b9, %struct.Memory** %MEMORY
  ...
  ret %struct.Memory* %loadMem_4129ba
}
