...
define %struct.Memory* @_ZN30custom_lessthanequal_constantsIlE8do_shiftEl(%struct.State* noalias, i64, %struct.Memory* noalias) #2 {
entry:
  ...
  store i64 %72, i64* %75
  store %struct.Memory* %loadMem_411a26, %struct.Memory** %MEMORY
  ...
  ret %struct.Memory* %loadMem_411a2b
}
