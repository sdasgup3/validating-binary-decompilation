...
entry:
  ...
  store %struct.Memory* %loadMem_415d41, %struct.Memory** %MEMORY
  %loadMem_415d44 = load %struct.Memory*, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_415d44, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_415d49, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_415d4c, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_415d50, %struct.Memory** %MEMORY
  ...
  %loadMem_415d54 = load %struct.Memory*, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_415d54, %struct.Memory** %MEMORY
  ret %struct.Memory* %loadMem_415d54
}
