...
define %struct.Memory* @_ZN30custom_lessthanequal_constantsItE8do_shiftEt(%struct.State* noalias, i64, %struct.Memory* noalias) #2 {
entry:
  ...
  store %struct.Memory* %loadMem_414a10, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_414a19, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_414a24, %struct.Memory** %MEMORY
  ret %struct.Memory* %loadMem_414a24
}
