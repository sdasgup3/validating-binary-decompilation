...
define %struct.Memory* @_ZN30custom_lessthanequal_constantsItE8do_shiftEt(%struct.State* noalias, i64, %struct.Memory* noalias) #1 {
entry:
  ...
  store %struct.Memory* %loadMem_414a50, %struct.Memory** %MEMORY
  ...
  ret %struct.Memory* %loadMem_414a64
}
