...
entry:
  ...
  store %struct.Memory* %loadMem_417a61, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_417a6a, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_417a7a, %struct.Memory** %MEMORY
  ...
  ret %struct.Memory* %loadMem_417a7b
}
