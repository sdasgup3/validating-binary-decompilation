...
entry:
  ...
  store %struct.Memory* %loadMem_417abe, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_417ac7, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_417aca, %struct.Memory** %MEMORY
  ...
  ret %struct.Memory* %loadMem_417acb
}
