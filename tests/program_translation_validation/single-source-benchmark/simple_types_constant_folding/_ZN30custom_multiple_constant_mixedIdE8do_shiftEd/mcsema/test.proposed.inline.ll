...
define %struct.Memory* @_ZN30custom_multiple_constant_mixedIdE8do_shiftEd(%struct.State* noalias, i64, %struct.Memory* noalias) #1 {
entry:
  ...
  store %struct.Memory* %loadMem_40e602, %struct.Memory** %MEMORY
  ...
  ret %struct.Memory* %loadMem_40e606
}
