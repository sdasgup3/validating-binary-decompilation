...
entry:
  ...
  store %struct.Memory* %loadMem_4167ee, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_4167f4, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_4167fa, %struct.Memory** %MEMORY
  ...
  ret %struct.Memory* %loadMem_4167fb
}
