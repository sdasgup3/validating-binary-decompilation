...
entry:
  ...
  store %struct.Memory* %loadMem_416790, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_416794, %struct.Memory** %MEMORY
  ...
  store i8 %56, i8* %60
  store %struct.Memory* %loadMem_416797, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_41679a, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_41679e, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_4167a1, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_4167a4, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_4167aa, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_4167ab, %struct.Memory** %MEMORY
  ret %struct.Memory* %loadMem_4167ab
}
