...
define %struct.Memory* @_ZN30custom_multiple_constant_mixedIiE8do_shiftEi(%struct.State* noalias, i64, %struct.Memory* noalias) #1 {
entry:
  ...
  ret %struct.Memory* %loadMem_413223
}
