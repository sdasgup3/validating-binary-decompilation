...
define %struct.Memory* @_ZN30custom_multiple_constant_mixedIjE8do_shiftEj(%struct.State* noalias, i64, %struct.Memory* noalias) #1 {
entry:
  ...
  store %struct.Memory* %loadMem_4122d7, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_4122dd, %struct.Memory** %MEMORY
  ...
  %loadMem_4122e2 = load %struct.Memory*, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_4122e2, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_4122e3, %struct.Memory** %MEMORY
  ret %struct.Memory* %loadMem_4122e3
}
