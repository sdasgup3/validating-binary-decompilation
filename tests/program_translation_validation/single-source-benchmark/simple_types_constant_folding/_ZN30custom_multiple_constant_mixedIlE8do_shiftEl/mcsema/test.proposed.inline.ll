...
define %struct.Memory* @_ZN30custom_multiple_constant_mixedIlE8do_shiftEl(%struct.State* noalias, i64, %struct.Memory* noalias) #1 {
entry:
  ...
  store i64 %40, i64* %43
  store %struct.Memory* %loadMem_411354, %struct.Memory** %MEMORY
  %loadMem_411358 = load %struct.Memory*, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_411358, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_411364, %struct.Memory** %MEMORY
  %loadMem_411367 = load %struct.Memory*, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_411367, %struct.Memory** %MEMORY
  ...
  ret %struct.Memory* %loadMem_411368
}
