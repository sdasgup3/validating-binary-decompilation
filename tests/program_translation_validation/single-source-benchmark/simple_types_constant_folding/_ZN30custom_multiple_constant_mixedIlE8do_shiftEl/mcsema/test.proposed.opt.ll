...
define %struct.Memory* @_ZN30custom_multiple_constant_mixedIlE8do_shiftEl(%struct.State* noalias nocapture, i64, %struct.Memory* noalias readnone returned) local_unnamed_addr #1 {
entry:
