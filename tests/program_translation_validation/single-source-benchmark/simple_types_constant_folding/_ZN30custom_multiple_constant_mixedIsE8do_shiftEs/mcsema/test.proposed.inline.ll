...
entry:
  ...
  store %struct.Memory* %loadMem_4154c4, %struct.Memory** %MEMORY
  ...
  %loadMem_4154cb = load %struct.Memory*, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_4154cb, %struct.Memory** %MEMORY
  ...
  ret %struct.Memory* %loadMem_4154da
}
