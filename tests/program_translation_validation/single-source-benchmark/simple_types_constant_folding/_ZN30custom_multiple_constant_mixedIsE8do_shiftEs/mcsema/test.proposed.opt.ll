...
define %struct.Memory* @_ZN30custom_multiple_constant_mixedIsE8do_shiftEs(%struct.State* noalias, i64, %struct.Memory* noalias) local_unnamed_addr #1 {
entry:
  ...
  store i64 %38, i64* %RDI.i10, align 8
  %39 = zext i1 %25 to i8
