...
%G_0x98b0__rip__4256212__type = type <{ [16 x i8] }>
%G_0x98c8__rip__4256204__type = type <{ [16 x i8] }>
%G_0x98cc__rip__4256196__type = type <{ [16 x i8] }>
%G_0x98d0__rip__4256188__type = type <{ [16 x i8] }>
...
@G_0x98b0__rip__4256212_ = local_unnamed_addr global %G_0x98b0__rip__4256212__type zeroinitializer
@G_0x98c8__rip__4256204_ = local_unnamed_addr global %G_0x98c8__rip__4256204__type zeroinitializer
@G_0x98cc__rip__4256196_ = local_unnamed_addr global %G_0x98cc__rip__4256196__type zeroinitializer
@G_0x98d0__rip__4256188_ = local_unnamed_addr global %G_0x98d0__rip__4256188__type zeroinitializer
...
entry:
  ...
  %13 = load i32, i32* bitcast (%G_0x98d0__rip__4256188__type* @G_0x98d0__rip__4256188_ to i32*), align 8
  ...
  %23 = load i32, i32* bitcast (%G_0x98cc__rip__4256196__type* @G_0x98cc__rip__4256196_ to i32*), align 8
  ...
  %33 = load i32, i32* bitcast (%G_0x98c8__rip__4256204__type* @G_0x98c8__rip__4256204_ to i32*), align 8
  ...
  %43 = load i32, i32* bitcast (%G_0x98b0__rip__4256212__type* @G_0x98b0__rip__4256212_ to i32*), align 8
  ...
  %73 = load <2 x float>, <2 x float>* %54, align 1
  %74 = bitcast i64* %69 to <2 x i32>*
  %75 = load <2 x i32>, <2 x i32>* %74, align 1
  %76 = bitcast %union.VectorReg* %41 to <2 x float>*
  %77 = load <2 x float>, <2 x float>* %76, align 1
  %78 = extractelement <2 x float> %73, i32 0
  %79 = extractelement <2 x float> %77, i32 0
  %80 = fdiv float %78, %79
  store float %80, float* %65, align 1
  %81 = bitcast <2 x float> %73 to <2 x i32>
  %82 = extractelement <2 x i32> %81, i32 1
  %83 = bitcast i8* %67 to i32*
  store i32 %82, i32* %83, align 1
  %84 = extractelement <2 x i32> %75, i32 0
  %85 = bitcast i64* %69 to i32*
  store i32 %84, i32* %85, align 1
  %86 = extractelement <2 x i32> %75, i32 1
  %87 = bitcast i8* %71 to i32*
  store i32 %86, i32* %87, align 1
  %88 = load <2 x float>, <2 x float>* %54, align 1
  %89 = load <2 x i32>, <2 x i32>* %74, align 1
  %90 = bitcast %union.VectorReg* %31 to <2 x float>*
  %91 = load <2 x float>, <2 x float>* %90, align 1
  %92 = extractelement <2 x float> %88, i32 0
  %93 = extractelement <2 x float> %91, i32 0
  %94 = fdiv float %92, %93
  store float %94, float* %65, align 1
  %95 = bitcast <2 x float> %88 to <2 x i32>
  %96 = extractelement <2 x i32> %95, i32 1
  store i32 %96, i32* %83, align 1
  %97 = extractelement <2 x i32> %89, i32 0
  store i32 %97, i32* %85, align 1
  %98 = extractelement <2 x i32> %89, i32 1
  store i32 %98, i32* %87, align 1
  %99 = load <2 x float>, <2 x float>* %54, align 1
  %100 = load <2 x i32>, <2 x i32>* %74, align 1
  %101 = bitcast %union.VectorReg* %21 to <2 x float>*
  %102 = load <2 x float>, <2 x float>* %101, align 1
  %103 = extractelement <2 x float> %99, i32 0
  %104 = extractelement <2 x float> %102, i32 0
  %105 = fdiv float %103, %104
  store float %105, float* %65, align 1
  %106 = bitcast <2 x float> %99 to <2 x i32>
  %107 = extractelement <2 x i32> %106, i32 1
  store i32 %107, i32* %83, align 1
  %108 = extractelement <2 x i32> %100, i32 0
  store i32 %108, i32* %85, align 1
  %109 = extractelement <2 x i32> %100, i32 1
  store i32 %109, i32* %87, align 1
  %110 = load <2 x float>, <2 x float>* %54, align 1
  %111 = load <2 x i32>, <2 x i32>* %74, align 1
  %112 = bitcast %union.VectorReg* %11 to <2 x float>*
  %113 = load <2 x float>, <2 x float>* %112, align 1
  %114 = extractelement <2 x float> %110, i32 0
  %115 = extractelement <2 x float> %113, i32 0
  %116 = fdiv float %114, %115
  store float %116, float* %65, align 1
  %117 = bitcast <2 x float> %110 to <2 x i32>
  %118 = extractelement <2 x i32> %117, i32 1
  store i32 %118, i32* %83, align 1
  %119 = extractelement <2 x i32> %111, i32 0
  store i32 %119, i32* %85, align 1
  %120 = extractelement <2 x i32> %111, i32 1
  store i32 %120, i32* %87, align 1
  %121 = add i64 %61, 22
...
block_400478:
  ...
  %7 = load i32, i32* bitcast (%G_0x98d0__rip__4256188__type* @G_0x98d0__rip__4256188_ to i32*), align 8
...
block_400478:
  ...
  %6 = add i64 %5, 8
  store i64 %6, i64* %PC, align 8
  %7 = load i32, i32* bitcast (%G_0x98cc__rip__4256196__type* @G_0x98cc__rip__4256196_ to i32*), align 8
  %8 = bitcast %union.VectorReg* %3 to i32*
  store i32 %7, i32* %8, align 1
  %9 = getelementptr inbounds i8, i8* %4, i64 4
  %10 = bitcast i8* %9 to float*
...
block_400478:
  ...
  %6 = add i64 %5, 8
  store i64 %6, i64* %PC, align 8
  %7 = load i32, i32* bitcast (%G_0x98c8__rip__4256204__type* @G_0x98c8__rip__4256204_ to i32*), align 8
  %8 = bitcast %union.VectorReg* %3 to i32*
  store i32 %7, i32* %8, align 1
  %9 = getelementptr inbounds i8, i8* %4, i64 4
  %10 = bitcast i8* %9 to float*
...
block_400478:
  ...
  %6 = add i64 %5, 8
  store i64 %6, i64* %PC, align 8
  %7 = load i32, i32* bitcast (%G_0x98b0__rip__4256212__type* @G_0x98b0__rip__4256212_ to i32*), align 8
  %8 = bitcast %union.VectorReg* %3 to i32*
  store i32 %7, i32* %8, align 1
  %9 = getelementptr inbounds i8, i8* %4, i64 4
  %10 = bitcast i8* %9 to float*
