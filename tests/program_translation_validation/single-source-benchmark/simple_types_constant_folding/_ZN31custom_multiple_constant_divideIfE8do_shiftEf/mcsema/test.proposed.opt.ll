...
%G_0x98b0__rip__type = type <{ [4 x i8] }>
%G_0x98c8__rip__type = type <{ [4 x i8] }>
%G_0x98cc__rip__type = type <{ [4 x i8] }>
%G_0x98d0__rip__type = type <{ [4 x i8] }>
...
@G_0x98b0__rip_ = global %G_0x98b0__rip__type zeroinitializer
@G_0x98c8__rip_ = global %G_0x98c8__rip__type zeroinitializer
@G_0x98cc__rip_ = global %G_0x98cc__rip__type zeroinitializer
@G_0x98d0__rip_ = global %G_0x98d0__rip__type zeroinitializer

; Function Attrs: alwaysinline norecurse nounwind
define %struct.Memory* @_ZN31custom_multiple_constant_divideIfE8do_shiftEf(%struct.State* noalias, i64, %struct.Memory* noalias readnone returned) local_unnamed_addr #0 {
entry:
  ...
  %13 = add i64 %10, add (i64 ptrtoint (%G_0x98d0__rip__type* @G_0x98d0__rip_ to i64), i64 3)
  %14 = add i64 %10, 11
  ...
  %26 = add i64 %10, add (i64 ptrtoint (%G_0x98cc__rip__type* @G_0x98cc__rip_ to i64), i64 11)
  %27 = add i64 %10, 19
  ...
  %33 = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 1, i64 2, i32 0, i32 0, i32 0, i64 1
  ...
  %37 = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 1, i64 3
  %38 = bitcast %union.VectorReg* %37 to i8*
  %39 = add i64 %10, add (i64 ptrtoint (%G_0x98c8__rip__type* @G_0x98c8__rip_ to i64), i64 19)
  %40 = add i64 %10, 27
  ...
  %46 = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 1, i64 3, i32 0, i32 0, i32 0, i64 1
  ...
  %50 = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 1, i64 4
  %51 = bitcast %union.VectorReg* %50 to i8*
  %52 = add i64 %10, add (i64 ptrtoint (%G_0x98b0__rip__type* @G_0x98b0__rip_ to i64), i64 27)
  %53 = add i64 %10, 35
  ...
  %59 = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 1, i64 4, i32 0, i32 0, i32 0, i64 1
  ...
  %77 = bitcast %union.VectorReg* %63 to float*
  %78 = bitcast %union.VectorReg* %63 to i32*
  ...
  store float %106, float* %77, align 1
  ...
  store i32 %110, i32* %99, align 1
  %111 = load <2 x float>, <2 x float>* %66, align 1
  %112 = load <2 x i32>, <2 x i32>* %86, align 1
  %113 = bitcast %union.VectorReg* %24 to <2 x float>*
  ...
  store float %117, float* %77, align 1
  %118 = bitcast <2 x float> %111 to <2 x i32>
  %119 = extractelement <2 x i32> %118, i32 1
  store i32 %119, i32* %95, align 1
  %120 = extractelement <2 x i32> %112, i32 0
  store i32 %120, i32* %97, align 1
  %121 = extractelement <2 x i32> %112, i32 1
  store i32 %121, i32* %99, align 1
  %122 = load <2 x float>, <2 x float>* %66, align 1
  %123 = load <2 x i32>, <2 x i32>* %86, align 1
  %124 = bitcast %union.VectorReg* %11 to <2 x float>*
  %125 = load <2 x float>, <2 x float>* %124, align 1
  %126 = extractelement <2 x float> %122, i32 0
  %127 = extractelement <2 x float> %125, i32 0
  %128 = fdiv float %126, %127
  store float %128, float* %77, align 1
  %129 = bitcast <2 x float> %122 to <2 x i32>
  %130 = extractelement <2 x i32> %129, i32 1
  store i32 %130, i32* %95, align 1
  %131 = extractelement <2 x i32> %123, i32 0
  store i32 %131, i32* %97, align 1
  %132 = extractelement <2 x i32> %123, i32 1
  store i32 %132, i32* %99, align 1
  %133 = add i64 %73, 22
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_movss_0x98d0__rip____xmm1(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned) local_unnamed_addr #1 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 1, i64 1
  %4 = bitcast %union.VectorReg* %3 to i8*
  %5 = load i64, i64* %PC, align 8
  %6 = add i64 %5, ptrtoint (%G_0x98d0__rip__type* @G_0x98d0__rip_ to i64)
  %7 = add i64 %5, 8
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_movss_0x98cc__rip____xmm2(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned) local_unnamed_addr #1 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 1, i64 2
  %4 = bitcast %union.VectorReg* %3 to i8*
  %5 = load i64, i64* %PC, align 8
  %6 = add i64 %5, ptrtoint (%G_0x98cc__rip__type* @G_0x98cc__rip_ to i64)
  %7 = add i64 %5, 8
  store i64 %7, i64* %PC, align 8
  %8 = inttoptr i64 %6 to i32*
  %9 = load i32, i32* %8, align 4
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_movss_0x98c8__rip____xmm3(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned) local_unnamed_addr #1 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 1, i64 3
  %4 = bitcast %union.VectorReg* %3 to i8*
  %5 = load i64, i64* %PC, align 8
  %6 = add i64 %5, ptrtoint (%G_0x98c8__rip__type* @G_0x98c8__rip_ to i64)
  %7 = add i64 %5, 8
  store i64 %7, i64* %PC, align 8
  %8 = inttoptr i64 %6 to i32*
  %9 = load i32, i32* %8, align 4
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_movss_0x98b0__rip____xmm4(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned) local_unnamed_addr #1 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 1, i64 4
  %4 = bitcast %union.VectorReg* %3 to i8*
  %5 = load i64, i64* %PC, align 8
  %6 = add i64 %5, ptrtoint (%G_0x98b0__rip__type* @G_0x98b0__rip_ to i64)
  %7 = add i64 %5, 8
  store i64 %7, i64* %PC, align 8
  %8 = inttoptr i64 %6 to i32*
  %9 = load i32, i32* %8, align 4
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_divss__xmm4___xmm0(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned) local_unnamed_addr #1 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_divss__xmm3___xmm0(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned) local_unnamed_addr #1 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 1
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_divss__xmm2___xmm0(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned) local_unnamed_addr #1 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 1
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_divss__xmm1___xmm0(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned) local_unnamed_addr #1 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 1
