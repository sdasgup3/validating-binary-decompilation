...
define %struct.Memory* @_ZN32custom_multiple_constant_divide2IaE8do_shiftEa(%struct.State* noalias, i64, %struct.Memory* noalias) #1 {
entry:
  ...
  store i8 %56, i8* %60
  store %struct.Memory* %loadMem_417b37, %struct.Memory** %MEMORY
  ...
  ret %struct.Memory* %loadMem_417b48
}
