...
%G_0xa314__rip__4253404__type = type <{ [16 x i8] }>
...
@G_0xa314__rip__4253404_ = global %G_0xa314__rip__4253404__type zeroinitializer
...
define %struct.Memory* @_ZN32custom_multiple_constant_divide2IdE8do_shiftEd(%struct.State* noalias, i64, %struct.Memory* noalias) #2 {
entry:
  ...
  %loadMem_40e6d1 = load %struct.Memory*, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_40e6d1, %struct.Memory** %MEMORY
  ...
  %38 = load double, double* bitcast (%G_0xa314__rip__4253404__type* @G_0xa314__rip__4253404_ to double*)
  ...
  store %struct.Memory* %loadMem_40e6d4, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_40e6ea, %struct.Memory** %MEMORY
  ret %struct.Memory* %loadMem_40e6ea
}
...
define %struct.Memory* @routine_movsd_0xa314__rip____xmm1(%struct.State* dereferenceable(3376), i64, %struct.Memory*) {
block_400478:
  %3 = getelementptr inbounds %struct.State, %struct.State* %0, i32 0, i32 6
  %4 = getelementptr inbounds %struct.GPR, %struct.GPR* %3, i32 0, i32 33
  %5 = getelementptr inbounds %struct.Reg, %struct.Reg* %4, i32 0, i32 0
  ...
  %9 = load i64, i64* %PC
  %10 = ptrtoint %G_0xa314__rip__4253404__type* @G_0xa314__rip__4253404_ to i64
  %11 = load i64, i64* %PC
  %12 = add i64 %11, 8
  store i64 %12, i64* %PC
