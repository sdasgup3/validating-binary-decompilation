...
define %struct.Memory* @_ZN32custom_multiple_constant_divide2IdE8do_shiftEd(%struct.State* noalias, i64, %struct.Memory* noalias) #1 {
entry:
  ...
  ret %struct.Memory* %loadMem_40e72a
}
