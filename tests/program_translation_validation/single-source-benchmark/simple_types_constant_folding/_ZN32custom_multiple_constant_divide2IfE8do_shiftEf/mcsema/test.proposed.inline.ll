...
define %struct.Memory* @_ZN32custom_multiple_constant_divide2IfE8do_shiftEf(%struct.State* noalias, i64, %struct.Memory* noalias) #1 {
entry:
  ...
  store %struct.Memory* %loadMem_40f161, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_40f164, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_40f16c, %struct.Memory** %MEMORY
  ...
  %loadMem_40f176 = load %struct.Memory*, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_40f176, %struct.Memory** %MEMORY
  %loadMem_40f179 = load %struct.Memory*, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_40f179, %struct.Memory** %MEMORY
  %loadMem_40f17a = load %struct.Memory*, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_40f17a, %struct.Memory** %MEMORY
  ret %struct.Memory* %loadMem_40f17a
}
