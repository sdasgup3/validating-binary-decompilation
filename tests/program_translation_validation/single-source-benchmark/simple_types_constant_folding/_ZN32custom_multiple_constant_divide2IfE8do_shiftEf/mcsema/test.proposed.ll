...
@G_0x9958__rip__4256044_= global %G_0x9958__rip__4256044__type <{ [16 x i8] c"\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00" }>
...
entry:
  ...
  ; Code: ._ZN32custom_multiple_constant_divide2IfE8do_shiftEf:	 RIP: 40f120	 Bytes: 0
  ; Code: pushq %rbp	 RIP: 40f120	 Bytes: 1
  %loadMem_40f120 = load %struct.Memory*, %struct.Memory** %MEMORY
  %call_40f120 = call %struct.Memory* @routine_pushq__rbp(%struct.State* %0, i64  0, %struct.Memory* %loadMem_40f120)
  store %struct.Memory* %call_40f120, %struct.Memory** %MEMORY

  ; Code: movq %rsp, %rbp	 RIP: 40f121	 Bytes: 3
  %loadMem_40f121 = load %struct.Memory*, %struct.Memory** %MEMORY
  %call_40f121 = call %struct.Memory* @routine_movq__rsp___rbp(%struct.State* %0, i64  0, %struct.Memory* %loadMem_40f121)
  store %struct.Memory* %call_40f121, %struct.Memory** %MEMORY

  ; Code: movss 0x9958(%rip), %xmm1	 RIP: 40f124	 Bytes: 8
  %loadMem_40f124 = load %struct.Memory*, %struct.Memory** %MEMORY
  %call_40f124 = call %struct.Memory* @routine_movss_0x9958__rip____xmm1(%struct.State* %0, i64  0, %struct.Memory* %loadMem_40f124)
  store %struct.Memory* %call_40f124, %struct.Memory** %MEMORY

  ; Code: movss %xmm0, -0x4(%rbp)	 RIP: 40f12c	 Bytes: 5
  %loadMem_40f12c = load %struct.Memory*, %struct.Memory** %MEMORY
  %call_40f12c = call %struct.Memory* @routine_movss__xmm0__MINUS0x4__rbp_(%struct.State* %0, i64  0, %struct.Memory* %loadMem_40f12c)
  store %struct.Memory* %call_40f12c, %struct.Memory** %MEMORY

  ; Code: addss -0x4(%rbp), %xmm1	 RIP: 40f131	 Bytes: 5
  %loadMem_40f131 = load %struct.Memory*, %struct.Memory** %MEMORY
  %call_40f131 = call %struct.Memory* @routine_addss_MINUS0x4__rbp____xmm1(%struct.State* %0, i64  0, %struct.Memory* %loadMem_40f131)
  store %struct.Memory* %call_40f131, %struct.Memory** %MEMORY

  ; Code: movaps %xmm1, %xmm0	 RIP: 40f136	 Bytes: 3
  %loadMem_40f136 = load %struct.Memory*, %struct.Memory** %MEMORY
  %call_40f136 = call %struct.Memory* @routine_movaps__xmm1___xmm0(%struct.State* %0, i64  0, %struct.Memory* %loadMem_40f136)
  store %struct.Memory* %call_40f136, %struct.Memory** %MEMORY

  ; Code: popq %rbp	 RIP: 40f139	 Bytes: 1
  %loadMem_40f139 = load %struct.Memory*, %struct.Memory** %MEMORY
  %call_40f139 = call %struct.Memory* @routine_popq__rbp(%struct.State* %0, i64  0, %struct.Memory* %loadMem_40f139)
  store %struct.Memory* %call_40f139, %struct.Memory** %MEMORY

  ; Code: retq	 RIP: 40f13a	 Bytes: 1
  %loadMem_40f13a = load %struct.Memory*, %struct.Memory** %MEMORY
  %call_40f13a = call %struct.Memory* @routine_retq(%struct.State* %0, i64  0, %struct.Memory* %loadMem_40f13a)
  store %struct.Memory* %call_40f13a, %struct.Memory** %MEMORY

  ret %struct.Memory* %call_40f13a
}
