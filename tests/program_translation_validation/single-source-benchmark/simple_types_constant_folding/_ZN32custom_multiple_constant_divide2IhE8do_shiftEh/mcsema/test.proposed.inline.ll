...
entry:
  ...
  store %struct.Memory* %loadMem_416820, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_416824, %struct.Memory** %MEMORY
  ...
  store i8 %56, i8* %60
  store %struct.Memory* %loadMem_416827, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_41682e, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_416837, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_416838, %struct.Memory** %MEMORY
  ret %struct.Memory* %loadMem_416838
}
