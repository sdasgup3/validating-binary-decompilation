...
entry:
  ...
  store %struct.Memory* %loadMem_41236a, %struct.Memory** %MEMORY
  ...
  %loadMem_41236f = load %struct.Memory*, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_41236f, %struct.Memory** %MEMORY
  ...
  ret %struct.Memory* %loadMem_412370
}
