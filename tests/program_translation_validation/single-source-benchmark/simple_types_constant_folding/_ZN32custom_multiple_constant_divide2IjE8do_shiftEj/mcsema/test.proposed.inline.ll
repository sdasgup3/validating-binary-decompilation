...
entry:
  ...
  store %struct.Memory* %loadMem_412310, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_412311, %struct.Memory** %MEMORY
  %loadMem_412314 = load %struct.Memory*, %struct.Memory** %MEMORY
  ...
  store i32 %40, i32* %44
  store %struct.Memory* %loadMem_412314, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_412317, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_41231a, %struct.Memory** %MEMORY
  ...
  %loadMem_41231f = load %struct.Memory*, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_41231f, %struct.Memory** %MEMORY
  ...
  ret %struct.Memory* %loadMem_412320
}
