...
define %struct.Memory* @_ZN32custom_multiple_constant_divide2IjE8do_shiftEj(%struct.State* noalias, i64, %struct.Memory* noalias) #1 {
entry:
  ...
  store %struct.Memory* %loadMem_41235a, %struct.Memory** %MEMORY
  %loadMem_41235d = load %struct.Memory*, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_41235d, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_41235f, %struct.Memory** %MEMORY
  ...
  ret %struct.Memory* %loadMem_412360
}
