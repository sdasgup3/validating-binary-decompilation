...
define %struct.Memory* @_ZN32custom_multiple_constant_divide2IlE8do_shiftEl(%struct.State* noalias, i64, %struct.Memory* noalias) #2 {
entry:
  ...
  store %struct.Memory* %loadMem_411391, %struct.Memory** %MEMORY
  ...
  store i64 %40, i64* %43
  store %struct.Memory* %loadMem_411394, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_411398, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_41139c, %struct.Memory** %MEMORY
  ...
  ret %struct.Memory* %loadMem_4113a4
}
...
define %struct.Memory* @routine_addq__0x2___rdi(%struct.State* dereferenceable(3376), i64, %struct.Memory*) {
block_400478:
  %3 = getelementptr inbounds %struct.State, %struct.State* %0, i32 0, i32 6
  %4 = getelementptr inbounds %struct.GPR, %struct.GPR* %3, i32 0, i32 33
  %5 = getelementptr inbounds %struct.Reg, %struct.Reg* %4, i32 0, i32 0
