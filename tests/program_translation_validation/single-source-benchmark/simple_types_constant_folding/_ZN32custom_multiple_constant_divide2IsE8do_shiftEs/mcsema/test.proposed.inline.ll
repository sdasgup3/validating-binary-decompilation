...
entry:
  ...
  %loadMem_4155a1 = load %struct.Memory*, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_4155a1, %struct.Memory** %MEMORY
  %loadMem_4155a4 = load %struct.Memory*, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_4155a4, %struct.Memory** %MEMORY
  ...
  %loadMem_4155ab = load %struct.Memory*, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_4155ab, %struct.Memory** %MEMORY
  ...
  %loadMem_4155b5 = load %struct.Memory*, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_4155b5, %struct.Memory** %MEMORY
  ...
  %loadMem_4155b7 = load %struct.Memory*, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_4155b7, %struct.Memory** %MEMORY
  ret %struct.Memory* %loadMem_4155b7
}
