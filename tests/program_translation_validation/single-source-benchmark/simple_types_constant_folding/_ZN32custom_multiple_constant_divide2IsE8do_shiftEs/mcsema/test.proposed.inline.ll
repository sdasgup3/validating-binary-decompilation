...
entry:
  ...
  store %struct.Memory* %loadMem_415551, %struct.Memory** %MEMORY
  %loadMem_415554 = load %struct.Memory*, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_415554, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_41555b, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_41555f, %struct.Memory** %MEMORY
  %loadMem_415562 = load %struct.Memory*, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_415562, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_415566, %struct.Memory** %MEMORY
  ...
  ret %struct.Memory* %loadMem_415567
}
