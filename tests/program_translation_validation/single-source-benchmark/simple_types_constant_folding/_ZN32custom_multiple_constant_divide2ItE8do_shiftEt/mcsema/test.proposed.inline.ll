...
define %struct.Memory* @_ZN32custom_multiple_constant_divide2ItE8do_shiftEt(%struct.State* noalias, i64, %struct.Memory* noalias) #1 {
entry:
  ...
  store %struct.Memory* %loadMem_4142b1, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_4142b4, %struct.Memory** %MEMORY
  ...
  ret %struct.Memory* %loadMem_4142c9
}
