...
entry:
  ...
  store %struct.Memory* %loadMem_414271, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_414274, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_414282, %struct.Memory** %MEMORY
  ...
  ret %struct.Memory* %loadMem_414289
}
