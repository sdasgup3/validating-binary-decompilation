...
entry:
  ...
  store %struct.Memory* %loadMem_4170a7, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_4170ac, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_4170af, %struct.Memory** %MEMORY
  ...
  ret %struct.Memory* %loadMem_4170b0
}
