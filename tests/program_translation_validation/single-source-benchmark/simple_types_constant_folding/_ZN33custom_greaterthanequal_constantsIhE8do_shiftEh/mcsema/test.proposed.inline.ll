...
define %struct.Memory* @_ZN33custom_greaterthanequal_constantsIhE8do_shiftEh(%struct.State* noalias, i64, %struct.Memory* noalias) #2 {
entry:
  ...
  store %struct.Memory* %loadMem_417050, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_417051, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_417054, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_417057, %struct.Memory** %MEMORY
  ...
  store i8 %65, i8* %69
  store %struct.Memory* %loadMem_417059, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_41705c, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_41705f, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_417060, %struct.Memory** %MEMORY
  ret %struct.Memory* %loadMem_417060
}
