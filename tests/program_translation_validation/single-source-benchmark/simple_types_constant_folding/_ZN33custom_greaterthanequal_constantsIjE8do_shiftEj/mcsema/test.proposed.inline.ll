...
entry:
  ...
  %loadMem_4129d1 = load %struct.Memory*, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_4129d1, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_4129dd, %struct.Memory** %MEMORY
  ret %struct.Memory* %loadMem_4129dd
}
