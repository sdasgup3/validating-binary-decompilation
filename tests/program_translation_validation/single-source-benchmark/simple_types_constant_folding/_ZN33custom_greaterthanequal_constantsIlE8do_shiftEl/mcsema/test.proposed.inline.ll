...
define %struct.Memory* @_ZN33custom_greaterthanequal_constantsIlE8do_shiftEl(%struct.State* noalias, i64, %struct.Memory* noalias) #1 {
entry:
  ...
  store %struct.Memory* %loadMem_411ad1, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_411ad4, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_411add, %struct.Memory** %MEMORY
  ...
  ret %struct.Memory* %loadMem_411ade
}
