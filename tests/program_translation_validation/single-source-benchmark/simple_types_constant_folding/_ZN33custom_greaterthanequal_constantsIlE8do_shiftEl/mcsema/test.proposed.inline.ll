...
entry:
  ...
  store %struct.Memory* %loadMem_411ae0, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_411ae4, %struct.Memory** %MEMORY
  ...
  store i64 %48, i64* %51
  store %struct.Memory* %loadMem_411ae9, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_411aed, %struct.Memory** %MEMORY
  ...
  ret %struct.Memory* %loadMem_411aee
}
