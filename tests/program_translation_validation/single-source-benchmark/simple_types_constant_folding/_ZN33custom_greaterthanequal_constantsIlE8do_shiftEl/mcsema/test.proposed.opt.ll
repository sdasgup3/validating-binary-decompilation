...
define %struct.Memory* @_ZN33custom_greaterthanequal_constantsIlE8do_shiftEl(%struct.State* noalias nocapture, i64, %struct.Memory* noalias readnone returned) local_unnamed_addr #0 {
entry:
