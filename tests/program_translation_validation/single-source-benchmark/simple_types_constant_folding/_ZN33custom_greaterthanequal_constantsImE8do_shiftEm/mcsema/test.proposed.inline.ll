...
define %struct.Memory* @_ZN33custom_greaterthanequal_constantsImE8do_shiftEm(%struct.State* noalias, i64, %struct.Memory* noalias) #2 {
entry:
  ...
  %loadMem_4108d9 = load %struct.Memory*, %struct.Memory** %MEMORY
  ...
  store i64 %48, i64* %51
  store %struct.Memory* %loadMem_4108d9, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_4108de, %struct.Memory** %MEMORY
  ret %struct.Memory* %loadMem_4108de
}
