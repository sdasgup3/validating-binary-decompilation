...
entry:
  ...
  store i64 %48, i64* %51
  store %struct.Memory* %loadMem_410929, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_41092d, %struct.Memory** %MEMORY
  %loadMem_41092e = load %struct.Memory*, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_41092e, %struct.Memory** %MEMORY
  ret %struct.Memory* %loadMem_41092e
}
