...
define %struct.Memory* @_ZN33custom_greaterthanequal_constantsIsE8do_shiftEs(%struct.State* noalias, i64, %struct.Memory* noalias) #2 {
entry:
  ...
  store %struct.Memory* %loadMem_415d8f, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_415d92, %struct.Memory** %MEMORY
  ...
  ret %struct.Memory* %loadMem_415d93
}
