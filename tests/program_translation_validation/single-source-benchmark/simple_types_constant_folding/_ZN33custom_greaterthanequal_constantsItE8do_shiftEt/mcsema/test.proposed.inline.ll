...
entry:
  ...
  store %struct.Memory* %loadMem_414af0, %struct.Memory** %MEMORY
  ...
  %loadMem_414b02 = load %struct.Memory*, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_414b02, %struct.Memory** %MEMORY
  ...
  ret %struct.Memory* %loadMem_414b03
}
