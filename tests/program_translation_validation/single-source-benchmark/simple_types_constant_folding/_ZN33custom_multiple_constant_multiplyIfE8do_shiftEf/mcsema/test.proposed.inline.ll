...
define %struct.Memory* @_ZN33custom_multiple_constant_multiplyIfE8do_shiftEf(%struct.State* noalias, i64, %struct.Memory* noalias) #1 {
entry:
  ...
  %loadMem_40f3f2 = load %struct.Memory*, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_40f3f2, %struct.Memory** %MEMORY
  ...
  ret %struct.Memory* %loadMem_40f3fe
}
