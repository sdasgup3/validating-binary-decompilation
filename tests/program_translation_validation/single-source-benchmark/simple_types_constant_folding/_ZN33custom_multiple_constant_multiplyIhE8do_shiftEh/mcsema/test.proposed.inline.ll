...
entry:
  ...
  store %struct.Memory* %loadMem_416a80, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_416a81, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_416a8a, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_416a9a, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_416a9d, %struct.Memory** %MEMORY
  ...
  ret %struct.Memory* %loadMem_416aa1
}
