...
define %struct.Memory* @_ZN33custom_multiple_constant_multiplyIiE8do_shiftEi(%struct.State* noalias, i64, %struct.Memory* noalias) #2 {
entry:
  ...
  store %struct.Memory* %loadMem_413470, %struct.Memory** %MEMORY
  %loadMem_413471 = load %struct.Memory*, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_413471, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_413477, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_41347d, %struct.Memory** %MEMORY
  %loadMem_413480 = load %struct.Memory*, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_413480, %struct.Memory** %MEMORY
  ...
  %loadMem_413486 = load %struct.Memory*, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_413486, %struct.Memory** %MEMORY
  %loadMem_413487 = load %struct.Memory*, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_413487, %struct.Memory** %MEMORY
  ret %struct.Memory* %loadMem_413487
}
