...
entry:
  ...
  store %struct.Memory* %loadMem_412520, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_412521, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_412527, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_41252d, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_412530, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_412533, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_412537, %struct.Memory** %MEMORY
  ret %struct.Memory* %loadMem_412537
}
...
define %struct.Memory* @routine_imull__0x5___edi___eax(%struct.State* dereferenceable(3376), i64, %struct.Memory*) {
block_400478:
  %3 = getelementptr inbounds %struct.State, %struct.State* %0, i32 0, i32 6
  %4 = getelementptr inbounds %struct.GPR, %struct.GPR* %3, i32 0, i32 33
  %5 = getelementptr inbounds %struct.Reg, %struct.Reg* %4, i32 0, i32 0
