...
define %struct.Memory* @_ZN33custom_multiple_constant_multiplyIjE8do_shiftEj(%struct.State* noalias, i64, %struct.Memory* noalias) #1 {
entry:
  ...
  store %struct.Memory* %loadMem_41256a, %struct.Memory** %MEMORY
  ...
  ret %struct.Memory* %loadMem_412577
}
