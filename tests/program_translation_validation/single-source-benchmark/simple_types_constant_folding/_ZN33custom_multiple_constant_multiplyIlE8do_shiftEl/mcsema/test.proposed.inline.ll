...
define %struct.Memory* @_ZN33custom_multiple_constant_multiplyIlE8do_shiftEl(%struct.State* noalias, i64, %struct.Memory* noalias) #1 {
entry:
  ...
  store %struct.Memory* %loadMem_411600, %struct.Memory** %MEMORY
  ...
  ret %struct.Memory* %loadMem_41161d
}
