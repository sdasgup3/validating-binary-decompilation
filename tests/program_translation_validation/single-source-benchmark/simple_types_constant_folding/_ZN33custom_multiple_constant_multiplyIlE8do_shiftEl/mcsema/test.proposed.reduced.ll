; ModuleID = '/tmp/tmpxv3vyyhu-query.ll'
...
define %struct.Memory* @_ZN33custom_multiple_constant_multiplyIlE8do_shiftEl(%struct.State* noalias nocapture, i64, %struct.Memory* noalias readnone returned) local_unnamed_addr #1 {
entry:
