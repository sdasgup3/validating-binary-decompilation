...
entry:
  ...
  %loadMem_4157bb = load %struct.Memory*, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_4157bb, %struct.Memory** %MEMORY
  %loadMem_4157bf = load %struct.Memory*, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_4157bf, %struct.Memory** %MEMORY
  %loadMem_4157c2 = load %struct.Memory*, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_4157c2, %struct.Memory** %MEMORY
  ...
  %loadMem_4157cf = load %struct.Memory*, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_4157cf, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_4157d0, %struct.Memory** %MEMORY
  ret %struct.Memory* %loadMem_4157d0
}
