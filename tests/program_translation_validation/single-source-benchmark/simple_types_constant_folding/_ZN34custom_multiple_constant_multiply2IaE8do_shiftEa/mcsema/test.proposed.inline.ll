...
define %struct.Memory* @_ZN34custom_multiple_constant_multiply2IaE8do_shiftEa(%struct.State* noalias, i64, %struct.Memory* noalias) #1 {
entry:
  ...
  store %struct.Memory* %loadMem_417d01, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_417d0e, %struct.Memory** %MEMORY
  ...
  ret %struct.Memory* %loadMem_417d18
}
