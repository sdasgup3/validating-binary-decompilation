...
@G_0xa17c__rip__4253868_ = global %G_0xa17c__rip__4253868__type zeroinitializer
...
define %struct.Memory* @_ZN34custom_multiple_constant_multiply2IdE8do_shiftEd(%struct.State* noalias, i64, %struct.Memory* noalias) #2 {
entry:
  ...
  %38 = load double, double* bitcast (%G_0xa17c__rip__4253868__type* @G_0xa17c__rip__4253868_ to double*)
  ...
  store %struct.Memory* %loadMem_40e8b6, %struct.Memory** %MEMORY
  ...
  ret %struct.Memory* %loadMem_40e8ba
}
...
define %struct.Memory* @routine_movsd_0xa17c__rip____xmm1(%struct.State* dereferenceable(3376), i64, %struct.Memory*) {
block_400478:
  %3 = getelementptr inbounds %struct.State, %struct.State* %0, i32 0, i32 6
  %4 = getelementptr inbounds %struct.GPR, %struct.GPR* %3, i32 0, i32 33
  %5 = getelementptr inbounds %struct.Reg, %struct.Reg* %4, i32 0, i32 0
