...
@G_0x979c__rip__4256508_= global %G_0x979c__rip__4256508__type <{ [16 x i8] c"\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00" }>


define %struct.Memory* @_ZN34custom_multiple_constant_multiply2IfE8do_shiftEf(%struct.State* noalias , i64, %struct.Memory* noalias) alwaysinline  {
entry:
  ...
  ; Code: ._ZN34custom_multiple_constant_multiply2IfE8do_shiftEf:	 RIP: 40f2f0	 Bytes: 0
  ; Code: pushq %rbp	 RIP: 40f2f0	 Bytes: 1
  %loadMem_40f2f0 = load %struct.Memory*, %struct.Memory** %MEMORY
  %call_40f2f0 = call %struct.Memory* @routine_pushq__rbp(%struct.State* %0, i64  0, %struct.Memory* %loadMem_40f2f0)
  store %struct.Memory* %call_40f2f0, %struct.Memory** %MEMORY

  ; Code: movq %rsp, %rbp	 RIP: 40f2f1	 Bytes: 3
  %loadMem_40f2f1 = load %struct.Memory*, %struct.Memory** %MEMORY
  %call_40f2f1 = call %struct.Memory* @routine_movq__rsp___rbp(%struct.State* %0, i64  0, %struct.Memory* %loadMem_40f2f1)
  store %struct.Memory* %call_40f2f1, %struct.Memory** %MEMORY

  ; Code: movss 0x979c(%rip), %xmm1	 RIP: 40f2f4	 Bytes: 8
  %loadMem_40f2f4 = load %struct.Memory*, %struct.Memory** %MEMORY
  %call_40f2f4 = call %struct.Memory* @routine_movss_0x979c__rip____xmm1(%struct.State* %0, i64  0, %struct.Memory* %loadMem_40f2f4)
  store %struct.Memory* %call_40f2f4, %struct.Memory** %MEMORY

  ; Code: movss %xmm0, -0x4(%rbp)	 RIP: 40f2fc	 Bytes: 5
  %loadMem_40f2fc = load %struct.Memory*, %struct.Memory** %MEMORY
  %call_40f2fc = call %struct.Memory* @routine_movss__xmm0__MINUS0x4__rbp_(%struct.State* %0, i64  0, %struct.Memory* %loadMem_40f2fc)
  store %struct.Memory* %call_40f2fc, %struct.Memory** %MEMORY

  ; Code: addss -0x4(%rbp), %xmm1	 RIP: 40f301	 Bytes: 5
  %loadMem_40f301 = load %struct.Memory*, %struct.Memory** %MEMORY
  %call_40f301 = call %struct.Memory* @routine_addss_MINUS0x4__rbp____xmm1(%struct.State* %0, i64  0, %struct.Memory* %loadMem_40f301)
  store %struct.Memory* %call_40f301, %struct.Memory** %MEMORY

  ; Code: movaps %xmm1, %xmm0	 RIP: 40f306	 Bytes: 3
  %loadMem_40f306 = load %struct.Memory*, %struct.Memory** %MEMORY
  %call_40f306 = call %struct.Memory* @routine_movaps__xmm1___xmm0(%struct.State* %0, i64  0, %struct.Memory* %loadMem_40f306)
  store %struct.Memory* %call_40f306, %struct.Memory** %MEMORY

  ; Code: popq %rbp	 RIP: 40f309	 Bytes: 1
  %loadMem_40f309 = load %struct.Memory*, %struct.Memory** %MEMORY
  %call_40f309 = call %struct.Memory* @routine_popq__rbp(%struct.State* %0, i64  0, %struct.Memory* %loadMem_40f309)
  store %struct.Memory* %call_40f309, %struct.Memory** %MEMORY

  ; Code: retq	 RIP: 40f30a	 Bytes: 1
  %loadMem_40f30a = load %struct.Memory*, %struct.Memory** %MEMORY
  %call_40f30a = call %struct.Memory* @routine_retq(%struct.State* %0, i64  0, %struct.Memory* %loadMem_40f30a)
  store %struct.Memory* %call_40f30a, %struct.Memory** %MEMORY

  ret %struct.Memory* %call_40f30a
}
