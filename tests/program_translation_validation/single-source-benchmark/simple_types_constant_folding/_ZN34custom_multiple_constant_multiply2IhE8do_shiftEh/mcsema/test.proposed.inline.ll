...
entry:
  ...
  store %struct.Memory* %loadMem_4169f0, %struct.Memory** %MEMORY
  ...
  store i8 %56, i8* %60
  store %struct.Memory* %loadMem_4169f7, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_4169fa, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_416a04, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_416a07, %struct.Memory** %MEMORY
  ...
  ret %struct.Memory* %loadMem_416a08
}
