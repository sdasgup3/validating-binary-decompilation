...
define %struct.Memory* @_ZN34custom_multiple_constant_multiply2IlE8do_shiftEl(%struct.State* noalias, i64, %struct.Memory* noalias) #1 {
entry:
  ...
  store %struct.Memory* %loadMem_411588, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_41158c, %struct.Memory** %MEMORY
  ...
  ret %struct.Memory* %loadMem_411594
}
