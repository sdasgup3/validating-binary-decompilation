...
entry:
  ...
  %loadMem_410170 = load %struct.Memory*, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_410170, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_410171, %struct.Memory** %MEMORY
  %loadMem_410174 = load %struct.Memory*, %struct.Memory** %MEMORY
  ...
  store i64 %40, i64* %43
  store %struct.Memory* %loadMem_410174, %struct.Memory** %MEMORY
  ...
  %loadMem_41017c = load %struct.Memory*, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_41017c, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_410183, %struct.Memory** %MEMORY
  ...
  ret %struct.Memory* %loadMem_410184
}
