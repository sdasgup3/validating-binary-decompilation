...
define %struct.Memory* @_ZN34custom_multiple_constant_multiply2IsE8do_shiftEs(%struct.State* noalias nocapture, i64, %struct.Memory* noalias readnone returned) local_unnamed_addr #1 {
entry:
