...
define %struct.Memory* @_ZN34custom_multiple_constant_multiply2ItE8do_shiftEt(%struct.State* noalias, i64, %struct.Memory* noalias) #1 {
entry:
  ...
  store %struct.Memory* %loadMem_414484, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_41448b, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_41448f, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_414492, %struct.Memory** %MEMORY
  ...
  ret %struct.Memory* %loadMem_414499
}
