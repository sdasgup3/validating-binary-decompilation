...
@G_0x61a0b0 = global %G_0x61a0b0_type zeroinitializer
...
entry:
  ...
  %43 = call %struct.Memory* @__remill_function_call(%struct.State* %0, i64 ptrtoint (i64 ()* @clock to i64), %struct.Memory* %loadMem2_400e14)
  ...
  store i64 %50, i64* bitcast (%G_0x61a0b0_type* @G_0x61a0b0 to i64*)
  ...
  ret %struct.Memory* %loadMem_400e22
}
...
define %struct.Memory* @routine_movq__rax__0x61a0b0(%struct.State* dereferenceable(3376), i64, %struct.Memory*) {
block_400478:
  %3 = getelementptr inbounds %struct.State, %struct.State* %0, i32 0, i32 6
  %4 = getelementptr inbounds %struct.GPR, %struct.GPR* %3, i32 0, i32 33
  %5 = getelementptr inbounds %struct.Reg, %struct.Reg* %4, i32 0, i32 0
  ...
  %11 = add i64 %10, 8
  store i64 %11, i64* %PC
  store i64 %9, i64* bitcast (%G_0x61a0b0_type* @G_0x61a0b0 to i64*)
  ret %struct.Memory* %2
}
