...
define %struct.Memory* @_Z14test_variable1Ia18custom_variable_orIaEEvPT_iS2_PKc(%struct.State* noalias, i64, %struct.Memory* noalias) #1 {
entry:
  ...
  store %struct.Memory* %loadMem1_403cc8, %struct.Memory** %MEMORY
...
block_403cfb:                                     ; preds = %block_.L_403cef
  ...
  store %struct.Memory* %loadMem1_403d0d, %struct.Memory** %MEMORY
...
block_.L_403d2f:                                  ; preds = %block_.L_403cef
  ...
  store %struct.Memory* %loadMem_403d32, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem1_403d39, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_403d47, %struct.Memory** %MEMORY
  br label %block_.L_403cd4
...
block_.L_403d4c:                                  ; preds = %block_.L_403cd4
  ...
  store %struct.Memory* %loadMem1_403d4c, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem1_403d55, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_403d5e, %struct.Memory** %MEMORY
  ...
  ret %struct.Memory* %loadMem_403d5f
}
