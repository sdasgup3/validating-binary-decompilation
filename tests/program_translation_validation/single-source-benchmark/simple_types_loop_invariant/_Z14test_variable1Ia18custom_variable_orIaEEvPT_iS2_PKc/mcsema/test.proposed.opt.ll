...
declare %struct.Memory* @sub_413280._Z26check_shifted_variable_sumIa18custom_variable_orIaEEvT_S2_(%struct.State* noalias dereferenceable(3376), i64, %struct.Memory* noalias readnone returned) local_unnamed_addr
...
entry:
  ...
  %call2_403c98 = tail call %struct.Memory* @sub_400e10._Z11start_timerv(%struct.State* %0, i64 %67, %struct.Memory* %2)
...
block_.L_403ca4:                                  ; preds = %block_.L_403cff, %entry
  %77 = phi i64 [ %.pre, %entry ], [ %302, %block_.L_403cff ]
  %MEMORY.0 = phi %struct.Memory* [ %call2_403c98, %entry ], [ %call2_403d09, %block_.L_403cff ]
  ...
  br i1 %110, label %block_403cb4, label %block_.L_403d1c

block_403cb4:                                     ; preds = %block_.L_403ca4
  %112 = add i64 %78, -29
  %113 = add i64 %111, 4
...
block_.L_403cbf:                                  ; preds = %block_403ccb, %block_403cb4
  %120 = phi i64 [ %.pre1, %block_403cb4 ], [ %253, %block_403ccb ]
  %MEMORY.1 = phi %struct.Memory* [ %MEMORY.0, %block_403cb4 ], [ %call2_403cdd, %block_403ccb ]
  ...
  br i1 %156, label %block_403ccb, label %block_.L_403cff

block_403ccb:                                     ; preds = %block_.L_403cbf
  %158 = add i64 %121, -8
  %159 = add i64 %157, 4
  ...
  %call2_403cdd = tail call %struct.Memory* @sub_413250._ZN18custom_variable_orIaE8do_shiftEaa(%struct.State* %0, i64 %177, %struct.Memory* %MEMORY.1)
...
block_.L_403cff:                                  ; preds = %block_.L_403cbf
  %254 = add i64 %121, -29
  %255 = add i64 %157, 3
  ...
  %call2_403d09 = tail call %struct.Memory* @sub_413280._Z26check_shifted_variable_sumIa18custom_variable_orIaEEvT_S2_(%struct.State* %0, i64 %266, %struct.Memory* %MEMORY.1)
...
block_.L_403d1c:                                  ; preds = %block_.L_403ca4
  %303 = add i64 %111, -12012
  %304 = add i64 %111, 5
  ...
  %call2_403d1c = tail call %struct.Memory* @sub_400e30._Z5timerv(%struct.State* %0, i64 %303, %struct.Memory* %MEMORY.0)
  ...
  %call2_403d25 = tail call %struct.Memory* @sub_4007d0._Z13record_resultdPKc(%struct.State* %0, i64 %314, %struct.Memory* %call2_403d1c)
  ...
  ret %struct.Memory* %call2_403d25
}
...
define %struct.Memory* @routine_jge_.L_403d1c(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i8* %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
...
define %struct.Memory* @routine_jge_.L_403cff(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i8* %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 2, i32 9
...
define %struct.Memory* @routine_jmpq_.L_403cbf(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
...
define %struct.Memory* @routine_callq_._Z26check_shifted_variable_sumIa18custom_variable_orIaEEvT_S2_(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
...
define %struct.Memory* @routine_jmpq_.L_403ca4(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
