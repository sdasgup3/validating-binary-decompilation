...
block_.L_403ca4:                                  ; preds = %block_.L_403cff, %entry
  %77 = phi i64 [ %.pre, %entry ], [ %304, %block_.L_403cff ]
...
block_.L_403cbf:                                  ; preds = %block_403ccb, %block_403cb4
  %120 = phi i64 [ %.pre1, %block_403cb4 ], [ %254, %block_403ccb ]
...
block_.L_403cff:                                  ; preds = %block_.L_403cbf
  ...
  %call2_403d09 = tail call %struct.Memory* @sub_413280._Z26check_shifted_variable_sumIa18custom_variable_orIaEEvT_S2_(%struct.State* %0, i64 %267, %struct.Memory* %MEMORY.1)
...
block_.L_403d1c:                                  ; preds = %block_.L_403ca4
  ...
  %call2_403d1c = tail call %struct.Memory* @sub_400e30._Z5timerv(%struct.State* %0, i64 %305, %struct.Memory* %MEMORY.0)
  ...
  %call2_403d25 = tail call %struct.Memory* @sub_4007d0._Z13record_resultdPKc(%struct.State* %0, i64 %316, %struct.Memory* %call2_403d1c)
