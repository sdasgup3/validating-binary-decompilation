...
block_.L_402ff4:                                  ; preds = %block_.L_40304f, %entry
  %77 = phi i64 [ %.pre, %entry ], [ %304, %block_.L_40304f ]
...
block_.L_40300f:                                  ; preds = %block_40301b, %block_403004
  %120 = phi i64 [ %.pre1, %block_403004 ], [ %254, %block_40301b ]
...
block_.L_40304f:                                  ; preds = %block_.L_40300f
  ...
  %call2_403059 = tail call %struct.Memory* @sub_413d00._Z26check_shifted_variable_sumIa19custom_add_variableIaEEvT_S2_(%struct.State* %0, i64 %267, %struct.Memory* %MEMORY.1)
...
block_.L_40306c:                                  ; preds = %block_.L_402ff4
  ...
  %call2_40306c = tail call %struct.Memory* @sub_400e30._Z5timerv(%struct.State* %0, i64 %305, %struct.Memory* %MEMORY.0)
  ...
  %call2_403075 = tail call %struct.Memory* @sub_4007d0._Z13record_resultdPKc(%struct.State* %0, i64 %316, %struct.Memory* %call2_40306c)
