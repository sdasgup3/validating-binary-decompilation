...
block_.L_403274:                                  ; preds = %block_.L_4032cf, %entry
  %77 = phi i64 [ %.pre, %entry ], [ %302, %block_.L_4032cf ]
...
block_.L_40328f:                                  ; preds = %block_40329b, %block_403284
  %120 = phi i64 [ %.pre1, %block_403284 ], [ %253, %block_40329b ]
...
block_.L_4032cf:                                  ; preds = %block_.L_40328f
  ...
  %call2_4032d9 = tail call %struct.Memory* @sub_413ba0._Z26check_shifted_variable_sumIa19custom_sub_variableIaEEvT_S2_(%struct.State* %0, i64 %266, %struct.Memory* %MEMORY.1)
...
block_.L_4032ec:                                  ; preds = %block_.L_403274
  ...
  %call2_4032ec = tail call %struct.Memory* @sub_400e30._Z5timerv(%struct.State* %0, i64 %303, %struct.Memory* %MEMORY.0)
  ...
  %call2_4032f5 = tail call %struct.Memory* @sub_4007d0._Z13record_resultdPKc(%struct.State* %0, i64 %314, %struct.Memory* %call2_4032ec)
