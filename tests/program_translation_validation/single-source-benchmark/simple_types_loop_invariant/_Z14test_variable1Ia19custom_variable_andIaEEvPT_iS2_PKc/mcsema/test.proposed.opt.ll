...
block_.L_403ae4:                                  ; preds = %block_.L_403b3f, %entry
  %77 = phi i64 [ %.pre, %entry ], [ %302, %block_.L_403b3f ]
...
block_.L_403aff:                                  ; preds = %block_403b0b, %block_403af4
  %120 = phi i64 [ %.pre1, %block_403af4 ], [ %253, %block_403b0b ]
...
block_.L_403b3f:                                  ; preds = %block_.L_403aff
  ...
  %call2_403b49 = tail call %struct.Memory* @sub_413410._Z26check_shifted_variable_sumIa19custom_variable_andIaEEvT_S2_(%struct.State* %0, i64 %266, %struct.Memory* %MEMORY.1)
...
block_.L_403b5c:                                  ; preds = %block_.L_403ae4
  ...
  %call2_403b5c = tail call %struct.Memory* @sub_400e30._Z5timerv(%struct.State* %0, i64 %303, %struct.Memory* %MEMORY.0)
  ...
  %call2_403b65 = tail call %struct.Memory* @sub_4007d0._Z13record_resultdPKc(%struct.State* %0, i64 %314, %struct.Memory* %call2_403b5c)
