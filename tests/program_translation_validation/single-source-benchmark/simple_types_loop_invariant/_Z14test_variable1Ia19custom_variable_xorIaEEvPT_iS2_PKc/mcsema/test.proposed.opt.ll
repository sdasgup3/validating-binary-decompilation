...
declare %struct.Memory* @sub_4130f0._Z26check_shifted_variable_sumIa19custom_variable_xorIaEEvT_S2_(%struct.State* noalias dereferenceable(3376), i64, %struct.Memory* noalias readnone returned) local_unnamed_addr
...
entry:
  ...
  %call2_403e58 = tail call %struct.Memory* @sub_400e10._Z11start_timerv(%struct.State* %0, i64 %67, %struct.Memory* %2)
...
block_.L_403e64:                                  ; preds = %block_.L_403ebf, %entry
  %77 = phi i64 [ %.pre, %entry ], [ %302, %block_.L_403ebf ]
  %MEMORY.0 = phi %struct.Memory* [ %call2_403e58, %entry ], [ %call2_403ec9, %block_.L_403ebf ]
  ...
  br i1 %110, label %block_403e74, label %block_.L_403edc

block_403e74:                                     ; preds = %block_.L_403e64
  %112 = add i64 %78, -29
  %113 = add i64 %111, 4
...
block_.L_403e7f:                                  ; preds = %block_403e8b, %block_403e74
  %120 = phi i64 [ %.pre1, %block_403e74 ], [ %253, %block_403e8b ]
  %MEMORY.1 = phi %struct.Memory* [ %MEMORY.0, %block_403e74 ], [ %call2_403e9d, %block_403e8b ]
  ...
  br i1 %156, label %block_403e8b, label %block_.L_403ebf

block_403e8b:                                     ; preds = %block_.L_403e7f
  %158 = add i64 %121, -8
  %159 = add i64 %157, 4
  ...
  %call2_403e9d = tail call %struct.Memory* @sub_4130c0._ZN19custom_variable_xorIaE8do_shiftEaa(%struct.State* %0, i64 %177, %struct.Memory* %MEMORY.1)
...
block_.L_403ebf:                                  ; preds = %block_.L_403e7f
  %254 = add i64 %121, -29
  %255 = add i64 %157, 3
  ...
  %call2_403ec9 = tail call %struct.Memory* @sub_4130f0._Z26check_shifted_variable_sumIa19custom_variable_xorIaEEvT_S2_(%struct.State* %0, i64 %266, %struct.Memory* %MEMORY.1)
...
block_.L_403edc:                                  ; preds = %block_.L_403e64
  %303 = add i64 %111, -12460
  %304 = add i64 %111, 5
  ...
  %call2_403edc = tail call %struct.Memory* @sub_400e30._Z5timerv(%struct.State* %0, i64 %303, %struct.Memory* %MEMORY.0)
  ...
  %call2_403ee5 = tail call %struct.Memory* @sub_4007d0._Z13record_resultdPKc(%struct.State* %0, i64 %314, %struct.Memory* %call2_403edc)
  ...
  ret %struct.Memory* %call2_403ee5
}
...
define %struct.Memory* @routine_jge_.L_403edc(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i8* %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
...
define %struct.Memory* @routine_jge_.L_403ebf(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i8* %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 2, i32 9
...
define %struct.Memory* @routine_jmpq_.L_403e7f(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
...
define %struct.Memory* @routine_callq_._Z26check_shifted_variable_sumIa19custom_variable_xorIaEEvT_S2_(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
...
define %struct.Memory* @routine_jmpq_.L_403e64(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
