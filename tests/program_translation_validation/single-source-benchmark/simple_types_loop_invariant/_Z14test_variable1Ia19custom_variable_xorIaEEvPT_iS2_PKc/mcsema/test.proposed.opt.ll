...
block_.L_403e64:                                  ; preds = %block_.L_403ebf, %entry
  %77 = phi i64 [ %.pre, %entry ], [ %304, %block_.L_403ebf ]
...
block_.L_403e7f:                                  ; preds = %block_403e8b, %block_403e74
  %120 = phi i64 [ %.pre1, %block_403e74 ], [ %254, %block_403e8b ]
...
block_.L_403ebf:                                  ; preds = %block_.L_403e7f
  ...
  %call2_403ec9 = tail call %struct.Memory* @sub_4130f0._Z26check_shifted_variable_sumIa19custom_variable_xorIaEEvT_S2_(%struct.State* %0, i64 %267, %struct.Memory* %MEMORY.1)
...
block_.L_403edc:                                  ; preds = %block_.L_403e64
  ...
  %call2_403edc = tail call %struct.Memory* @sub_400e30._Z5timerv(%struct.State* %0, i64 %305, %struct.Memory* %MEMORY.0)
  ...
  %call2_403ee5 = tail call %struct.Memory* @sub_4007d0._Z13record_resultdPKc(%struct.State* %0, i64 %316, %struct.Memory* %call2_403edc)
