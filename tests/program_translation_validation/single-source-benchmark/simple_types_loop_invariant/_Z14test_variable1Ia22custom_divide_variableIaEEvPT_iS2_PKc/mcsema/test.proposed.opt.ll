...
declare %struct.Memory* @sub_413790._Z26check_shifted_variable_sumIa22custom_divide_variableIaEEvT_S2_(%struct.State* noalias dereferenceable(3376), i64, %struct.Memory* noalias readnone returned) local_unnamed_addr
...
entry:
  ...
  %call2_4036f8 = tail call %struct.Memory* @sub_400e10._Z11start_timerv(%struct.State* %0, i64 %67, %struct.Memory* %2)
...
block_.L_403704:                                  ; preds = %block_.L_40375f, %entry
  %77 = phi i64 [ %.pre, %entry ], [ %304, %block_.L_40375f ]
  %MEMORY.0 = phi %struct.Memory* [ %call2_4036f8, %entry ], [ %call2_403769, %block_.L_40375f ]
  ...
  br i1 %110, label %block_403714, label %block_.L_40377c
...
block_.L_40371f:                                  ; preds = %block_40372b, %block_403714
  %120 = phi i64 [ %.pre1, %block_403714 ], [ %254, %block_40372b ]
  %MEMORY.1 = phi %struct.Memory* [ %MEMORY.0, %block_403714 ], [ %call2_40373d, %block_40372b ]
  ...
  br i1 %156, label %block_40372b, label %block_.L_40375f
...
block_40372b:                                     ; preds = %block_.L_40371f
  ...
  %call2_40373d = tail call %struct.Memory* @sub_413760._ZN22custom_divide_variableIaE8do_shiftEaa(%struct.State* %0, i64 %177, %struct.Memory* %MEMORY.1)
...
block_.L_40375f:                                  ; preds = %block_.L_40371f
  ...
  %call2_403769 = tail call %struct.Memory* @sub_413790._Z26check_shifted_variable_sumIa22custom_divide_variableIaEEvT_S2_(%struct.State* %0, i64 %267, %struct.Memory* %MEMORY.1)
...
block_.L_40377c:                                  ; preds = %block_.L_403704
  ...
  %call2_40377c = tail call %struct.Memory* @sub_400e30._Z5timerv(%struct.State* %0, i64 %305, %struct.Memory* %MEMORY.0)
  ...
  %call2_403785 = tail call %struct.Memory* @sub_4007d0._Z13record_resultdPKc(%struct.State* %0, i64 %316, %struct.Memory* %call2_40377c)
  ...
  ret %struct.Memory* %call2_403785
}
...
define %struct.Memory* @routine_jge_.L_40377c(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i8* %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
...
define %struct.Memory* @routine_jge_.L_40375f(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i8* %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 2, i32 9
...
define %struct.Memory* @routine_callq_._Z26check_shifted_variable_sumIa22custom_divide_variableIaEEvT_S2_(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
...
define %struct.Memory* @routine_jmpq_.L_403704(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
