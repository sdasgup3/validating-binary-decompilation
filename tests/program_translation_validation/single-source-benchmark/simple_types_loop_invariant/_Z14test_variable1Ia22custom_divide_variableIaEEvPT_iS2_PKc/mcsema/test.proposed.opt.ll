...
declare %struct.Memory* @sub_4137c0._Z26check_shifted_variable_sumIa22custom_divide_variableIaEEvT_S2_(%struct.State* noalias dereferenceable(3376), i64, %struct.Memory* noalias readnone returned) local_unnamed_addr
...
define %struct.Memory* @_Z14test_variable1Ia22custom_divide_variableIaEEvPT_iS2_PKc(%struct.State* noalias, i64, %struct.Memory* noalias readnone) local_unnamed_addr #1 {
entry:
...
block_.L_403734:                                  ; preds = %block_.L_40378f, %entry
  %77 = phi i64 [ %303, %block_.L_40378f ], [ %.pre, %entry ]
...
block_.L_40374f:                                  ; preds = %block_40375b, %block_403744
  %120 = phi i64 [ %254, %block_40375b ], [ %.pre6, %block_403744 ]
...
block_40375b:                                     ; preds = %block_.L_40374f
  ...
  %call2_40376d = tail call %struct.Memory* @sub_413790._ZN22custom_divide_variableIaE8do_shiftEaa(%struct.State* nonnull %0, i64 %177, %struct.Memory* %call2_403728)
...
block_.L_40378f:                                  ; preds = %block_.L_40374f
  ...
  %call2_403799 = tail call %struct.Memory* @sub_4137c0._Z26check_shifted_variable_sumIa22custom_divide_variableIaEEvT_S2_(%struct.State* nonnull %0, i64 %267, %struct.Memory* %call2_403728)
...
block_.L_4037ac:                                  ; preds = %block_.L_403734
  ...
  %call2_4037ac = tail call %struct.Memory* @sub_400e70._Z5timerv(%struct.State* nonnull %0, i64 %304, %struct.Memory* %call2_403728)
