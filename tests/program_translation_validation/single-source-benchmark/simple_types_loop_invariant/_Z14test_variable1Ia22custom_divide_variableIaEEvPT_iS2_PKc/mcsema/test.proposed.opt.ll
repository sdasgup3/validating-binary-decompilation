...
declare %struct.Memory* @sub_4137d0._Z26check_shifted_variable_sumIa22custom_divide_variableIaEEvT_S2_(%struct.State* noalias dereferenceable(3376), i64, %struct.Memory* noalias readnone returned) local_unnamed_addr
...
entry:
  ...
  %call2_403738 = tail call %struct.Memory* @sub_400e60._Z11start_timerv(%struct.State* %0, i64 %67, %struct.Memory* %2)
...
block_.L_403744:                                  ; preds = %block_.L_40379f, %entry
  %77 = phi i64 [ %303, %block_.L_40379f ], [ %.pre, %entry ]
  ...
  br i1 %110, label %block_403754, label %block_.L_4037bc
...
block_.L_40375f:                                  ; preds = %block_40376b, %block_403754
  %120 = phi i64 [ %254, %block_40376b ], [ %.pre6, %block_403754 ]
  ...
  br i1 %156, label %block_40376b, label %block_.L_40379f
...
block_40376b:                                     ; preds = %block_.L_40375f
  ...
  %call2_40377d = tail call %struct.Memory* @sub_4137a0._ZN22custom_divide_variableIaE8do_shiftEaa(%struct.State* nonnull %0, i64 %177, %struct.Memory* %call2_403738)
...
block_.L_40379f:                                  ; preds = %block_.L_40375f
  ...
  %call2_4037a9 = tail call %struct.Memory* @sub_4137d0._Z26check_shifted_variable_sumIa22custom_divide_variableIaEEvT_S2_(%struct.State* nonnull %0, i64 %267, %struct.Memory* %call2_403738)
...
block_.L_4037bc:                                  ; preds = %block_.L_403744
  ...
  %call2_4037bc = tail call %struct.Memory* @sub_400e80._Z5timerv(%struct.State* nonnull %0, i64 %304, %struct.Memory* %call2_403738)
  ...
  %call2_4037c5 = tail call %struct.Memory* @sub_400820._Z13record_resultdPKc(%struct.State* nonnull %0, i64 %315, %struct.Memory* %call2_4037bc)
