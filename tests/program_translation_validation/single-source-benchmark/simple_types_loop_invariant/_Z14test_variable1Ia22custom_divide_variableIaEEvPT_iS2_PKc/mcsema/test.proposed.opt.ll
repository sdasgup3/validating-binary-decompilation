...
block_.L_403704:                                  ; preds = %block_.L_40375f, %entry
  %77 = phi i64 [ %.pre, %entry ], [ %302, %block_.L_40375f ]
...
block_.L_40371f:                                  ; preds = %block_40372b, %block_403714
  %120 = phi i64 [ %.pre1, %block_403714 ], [ %253, %block_40372b ]
...
block_.L_40375f:                                  ; preds = %block_.L_40371f
  ...
  %call2_403769 = tail call %struct.Memory* @sub_413790._Z26check_shifted_variable_sumIa22custom_divide_variableIaEEvT_S2_(%struct.State* %0, i64 %266, %struct.Memory* %MEMORY.1)
...
block_.L_40377c:                                  ; preds = %block_.L_403704
  ...
  %call2_40377c = tail call %struct.Memory* @sub_400e30._Z5timerv(%struct.State* %0, i64 %303, %struct.Memory* %MEMORY.0)
  ...
  %call2_403785 = tail call %struct.Memory* @sub_4007d0._Z13record_resultdPKc(%struct.State* %0, i64 %314, %struct.Memory* %call2_40377c)
