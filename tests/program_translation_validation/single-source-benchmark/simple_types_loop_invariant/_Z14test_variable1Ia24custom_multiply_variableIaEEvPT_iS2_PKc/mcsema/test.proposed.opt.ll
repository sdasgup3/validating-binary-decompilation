...
block_.L_403434:                                  ; preds = %block_.L_40348f, %entry
  %77 = phi i64 [ %.pre, %entry ], [ %304, %block_.L_40348f ]
...
block_.L_40344f:                                  ; preds = %block_40345b, %block_403444
  %120 = phi i64 [ %.pre1, %block_403444 ], [ %254, %block_40345b ]
...
block_.L_40348f:                                  ; preds = %block_.L_40344f
  ...
  %call2_403499 = tail call %struct.Memory* @sub_413a10._Z26check_shifted_variable_sumIa24custom_multiply_variableIaEEvT_S2_(%struct.State* %0, i64 %267, %struct.Memory* %MEMORY.1)
...
block_.L_4034ac:                                  ; preds = %block_.L_403434
  ...
  %call2_4034ac = tail call %struct.Memory* @sub_400e30._Z5timerv(%struct.State* %0, i64 %305, %struct.Memory* %MEMORY.0)
  ...
  store i64 %315, i64* %RDI.i91, align 8
  %316 = add i64 %312, -11489
  %317 = add i64 %312, 9
  ...
  %call2_4034b5 = tail call %struct.Memory* @sub_4007d0._Z13record_resultdPKc(%struct.State* %0, i64 %316, %struct.Memory* %call2_4034ac)
  %321 = load i64, i64* %RSP.i99, align 8
  %322 = load i64, i64* %PC.i, align 8
  %323 = add i64 %321, 48
  store i64 %323, i64* %RSP.i99, align 8
  %324 = icmp ugt i64 %321, -49
