...
define %struct.Memory* @_Z14test_variable1Id19custom_add_variableIdEEvPT_iS2_PKc(%struct.State* noalias, i64, %struct.Memory* noalias readnone) local_unnamed_addr #1 {
entry:
...
block_.L_40b5c4:                                  ; preds = %block_.L_40b61e, %entry
  %82 = phi i64 [ %271, %block_.L_40b61e ], [ %.pre, %entry ]
...
block_.L_40b5e3:                                  ; preds = %block_40b5ef, %block_40b5d4
  %126 = phi i64 [ %226, %block_40b5ef ], [ %.pre6, %block_40b5d4 ]
...
block_40b5ef:                                     ; preds = %block_.L_40b5e3
  ...
  %call2_40b601 = tail call %struct.Memory* @sub_40c7a0._ZN19custom_add_variableIdE8do_shiftEdd(%struct.State* nonnull %0, i64 %180, %struct.Memory* %call2_40b5b8)
...
block_.L_40b61e:                                  ; preds = %block_.L_40b5e3
  ...
  %call2_40b628 = tail call %struct.Memory* @sub_40c730._Z26check_shifted_variable_sumId19custom_add_variableIdEEvT_S2_(%struct.State* nonnull %0, i64 %235, %struct.Memory* %call2_40b5b8)
...
block_.L_40b63b:                                  ; preds = %block_.L_40b5c4
  ...
  %call2_40b63b = tail call %struct.Memory* @sub_400e70._Z5timerv(%struct.State* nonnull %0, i64 %272, %struct.Memory* %call2_40b5b8)
