...
define %struct.Memory* @_Z14test_variable1Id19custom_sub_variableIdEEvPT_iS2_PKc(%struct.State* noalias, i64, %struct.Memory* noalias) #1 {
entry:
  ...
  store %struct.Memory* %loadMem_40b7f0, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_40b804, %struct.Memory** %MEMORY
...
block_.L_40b814:                                  ; preds = %block_.L_40b86e, %entry
  ...
  store %struct.Memory* %loadMem_40b814, %struct.Memory** %MEMORY
...
block_40b824:                                     ; preds = %block_.L_40b814
  ...
  store %struct.Memory* %loadMem_40b827, %struct.Memory** %MEMORY
  ...
  store i32 0, i32* %294
  store %struct.Memory* %loadMem_40b82c, %struct.Memory** %MEMORY
  br label %block_.L_40b833

block_.L_40b833:                                  ; preds = %block_40b83f, %block_40b824
  ...
  store %struct.Memory* %loadMem_40b833, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_40b839, %struct.Memory** %MEMORY
...
block_40b83f:                                     ; preds = %block_.L_40b833
  ...
  store %struct.Memory* %loadMem_40b83f, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem1_40b851, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_40b863, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_40b866, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_40b869, %struct.Memory** %MEMORY
  br label %block_.L_40b833

block_.L_40b86e:                                  ; preds = %block_.L_40b833
  ...
  store %struct.Memory* %loadMem1_40b878, %struct.Memory** %MEMORY
...
block_.L_40b88b:                                  ; preds = %block_.L_40b814
  ...
  store %struct.Memory* %loadMem1_40b88b, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem1_40b894, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_40b89e, %struct.Memory** %MEMORY
  ret %struct.Memory* %loadMem_40b89e
}
