...
declare %struct.Memory* @sub_40c600._Z26check_shifted_variable_sumId19custom_sub_variableIdEEvT_S2_(%struct.State* noalias dereferenceable(3376), i64, %struct.Memory* noalias readnone returned) local_unnamed_addr
...
entry:
  ...
  %call2_40b818 = tail call %struct.Memory* @sub_400e60._Z11start_timerv(%struct.State* %0, i64 %65, %struct.Memory* %2)
...
block_.L_40b824:                                  ; preds = %block_.L_40b87e, %entry
  %82 = phi i64 [ %271, %block_.L_40b87e ], [ %.pre, %entry ]
  ...
  br i1 %115, label %block_40b834, label %block_.L_40b89b
...
block_.L_40b843:                                  ; preds = %block_40b84f, %block_40b834
  %126 = phi i64 [ %226, %block_40b84f ], [ %.pre6, %block_40b834 ]
  ...
  br i1 %162, label %block_40b84f, label %block_.L_40b87e
...
block_40b84f:                                     ; preds = %block_.L_40b843
  ...
  %call2_40b861 = tail call %struct.Memory* @sub_40c5e0._ZN19custom_sub_variableIdE8do_shiftEdd(%struct.State* nonnull %0, i64 %180, %struct.Memory* %call2_40b818)
...
block_.L_40b87e:                                  ; preds = %block_.L_40b843
  ...
  %call2_40b888 = tail call %struct.Memory* @sub_40c600._Z26check_shifted_variable_sumId19custom_sub_variableIdEEvT_S2_(%struct.State* nonnull %0, i64 %235, %struct.Memory* %call2_40b818)
...
block_.L_40b89b:                                  ; preds = %block_.L_40b824
  ...
  %call2_40b89b = tail call %struct.Memory* @sub_400e80._Z5timerv(%struct.State* nonnull %0, i64 %272, %struct.Memory* %call2_40b818)
  ...
  %call2_40b8a4 = tail call %struct.Memory* @sub_400820._Z13record_resultdPKc(%struct.State* nonnull %0, i64 %283, %struct.Memory* %call2_40b89b)
