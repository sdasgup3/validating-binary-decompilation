...
block_.L_40b7e4:                                  ; preds = %block_.L_40b83e, %entry
  %88 = phi i64 [ %.pre, %entry ], [ %278, %block_.L_40b83e ]
...
block_.L_40b803:                                  ; preds = %block_40b80f, %block_40b7f4
  %132 = phi i64 [ %.pre1, %block_40b7f4 ], [ %232, %block_40b80f ]
  ...
  br i1 %168, label %block_40b80f, label %block_.L_40b83e
...
block_40b80f:                                     ; preds = %block_.L_40b803
  ...
  %call2_40b821 = tail call %struct.Memory* @sub_40c5a0._ZN19custom_sub_variableIdE8do_shiftEdd(%struct.State* %0, i64 %187, %struct.Memory* %MEMORY.1)
...
block_.L_40b83e:                                  ; preds = %block_.L_40b803
  ...
  %call2_40b848 = tail call %struct.Memory* @sub_40c5c0._Z26check_shifted_variable_sumId19custom_sub_variableIdEEvT_S2_(%struct.State* %0, i64 %242, %struct.Memory* %MEMORY.1)
...
block_.L_40b85b:                                  ; preds = %block_.L_40b7e4
  ...
  %call2_40b85b = tail call %struct.Memory* @sub_400e30._Z5timerv(%struct.State* %0, i64 %279, %struct.Memory* %MEMORY.0)
  ...
  %call2_40b864 = tail call %struct.Memory* @sub_4007d0._Z13record_resultdPKc(%struct.State* %0, i64 %290, %struct.Memory* %call2_40b85b)
