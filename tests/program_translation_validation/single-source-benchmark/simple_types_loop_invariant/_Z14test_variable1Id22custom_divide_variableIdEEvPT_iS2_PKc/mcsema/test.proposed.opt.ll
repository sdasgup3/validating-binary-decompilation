...
declare %struct.Memory* @sub_40c270._Z26check_shifted_variable_sumId22custom_divide_variableIdEEvT_S2_(%struct.State* noalias dereferenceable(3376), i64, %struct.Memory* noalias readnone returned) local_unnamed_addr
...
entry:
  ...
  %call2_40bc18 = tail call %struct.Memory* @sub_400e60._Z11start_timerv(%struct.State* %0, i64 %65, %struct.Memory* %2)
...
block_.L_40bc24:                                  ; preds = %block_.L_40bc7e, %entry
  %82 = phi i64 [ %271, %block_.L_40bc7e ], [ %.pre, %entry ]
  ...
  br i1 %115, label %block_40bc34, label %block_.L_40bc9b
...
block_.L_40bc43:                                  ; preds = %block_40bc4f, %block_40bc34
  %126 = phi i64 [ %226, %block_40bc4f ], [ %.pre6, %block_40bc34 ]
  ...
  br i1 %162, label %block_40bc4f, label %block_.L_40bc7e
...
block_40bc4f:                                     ; preds = %block_.L_40bc43
  ...
  %call2_40bc61 = tail call %struct.Memory* @sub_40c250._ZN22custom_divide_variableIdE8do_shiftEdd(%struct.State* nonnull %0, i64 %180, %struct.Memory* %call2_40bc18)
...
block_.L_40bc7e:                                  ; preds = %block_.L_40bc43
  ...
  %call2_40bc88 = tail call %struct.Memory* @sub_40c270._Z26check_shifted_variable_sumId22custom_divide_variableIdEEvT_S2_(%struct.State* nonnull %0, i64 %235, %struct.Memory* %call2_40bc18)
...
block_.L_40bc9b:                                  ; preds = %block_.L_40bc24
  ...
  %call2_40bc9b = tail call %struct.Memory* @sub_400e80._Z5timerv(%struct.State* nonnull %0, i64 %272, %struct.Memory* %call2_40bc18)
  ...
  %call2_40bca4 = tail call %struct.Memory* @sub_400820._Z13record_resultdPKc(%struct.State* nonnull %0, i64 %283, %struct.Memory* %call2_40bc9b)
