...
block_.L_40abb4:                                  ; preds = %block_.L_40ac0e, %entry
  %99 = phi i64 [ %.pre, %entry ], [ %302, %block_.L_40ac0e ]
  ...
  br i1 %132, label %block_40abc4, label %block_.L_40ac2b
...
block_.L_40abd3:                                  ; preds = %block_40abdf, %block_40abc4
  %144 = phi i64 [ %.pre1, %block_40abc4 ], [ %254, %block_40abdf ]
  ...
  br i1 %180, label %block_40abdf, label %block_.L_40ac0e
...
block_40abdf:                                     ; preds = %block_.L_40abd3
  ...
  %call2_40abf1 = tail call %struct.Memory* @sub_40d020._ZN19custom_add_variableIfE8do_shiftEff(%struct.State* %0, i64 %200, %struct.Memory* %MEMORY.1)
...
block_.L_40ac0e:                                  ; preds = %block_.L_40abd3
  ...
  %call2_40ac18 = tail call %struct.Memory* @sub_40cfb0._Z26check_shifted_variable_sumIf19custom_add_variableIfEEvT_S2_(%struct.State* %0, i64 %265, %struct.Memory* %MEMORY.1)
...
block_.L_40ac2b:                                  ; preds = %block_.L_40abb4
  ...
  %call2_40ac2b = tail call %struct.Memory* @sub_400e30._Z5timerv(%struct.State* %0, i64 %303, %struct.Memory* %MEMORY.0)
  ...
  %call2_40ac34 = tail call %struct.Memory* @sub_4007d0._Z13record_resultdPKc(%struct.State* %0, i64 %314, %struct.Memory* %call2_40ac2b)
