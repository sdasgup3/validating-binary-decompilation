...
define %struct.Memory* @_Z14test_variable1If19custom_add_variableIfEEvPT_iS2_PKc(%struct.State* noalias, i64, %struct.Memory* noalias) local_unnamed_addr #1 {
entry:
  ...
  %call2_40aba8 = tail call %struct.Memory* @sub_400e10._Z11start_timerv(%struct.State* %0, i64 %67, %struct.Memory* %2)
...
block_.L_40abb4:                                  ; preds = %block_.L_40ac0e, %entry
  %98 = phi i64 [ %.pre, %entry ], [ %297, %block_.L_40ac0e ]
  %MEMORY.0 = phi %struct.Memory* [ %call2_40aba8, %entry ], [ %call2_40ac18, %block_.L_40ac0e ]
  ...
  br i1 %131, label %block_40abc4, label %block_.L_40ac2b
...
block_.L_40abd3:                                  ; preds = %block_40abdf, %block_40abc4
  %143 = phi i64 [ %.pre1, %block_40abc4 ], [ %251, %block_40abdf ]
  %MEMORY.1 = phi %struct.Memory* [ %MEMORY.0, %block_40abc4 ], [ %call2_40abf1, %block_40abdf ]
  ...
  br i1 %179, label %block_40abdf, label %block_.L_40ac0e
...
block_40abdf:                                     ; preds = %block_.L_40abd3
  ...
  %call2_40abf1 = tail call %struct.Memory* @sub_40d020._ZN19custom_add_variableIfE8do_shiftEff(%struct.State* %0, i64 %198, %struct.Memory* %MEMORY.1)
...
block_.L_40ac0e:                                  ; preds = %block_.L_40abd3
  ...
  %call2_40ac18 = tail call %struct.Memory* @sub_40cfb0._Z26check_shifted_variable_sumIf19custom_add_variableIfEEvT_S2_(%struct.State* %0, i64 %261, %struct.Memory* %MEMORY.1)
...
block_.L_40ac2b:                                  ; preds = %block_.L_40abb4
  ...
  %call2_40ac2b = tail call %struct.Memory* @sub_400e30._Z5timerv(%struct.State* %0, i64 %298, %struct.Memory* %MEMORY.0)
  ...
  %call2_40ac34 = tail call %struct.Memory* @sub_4007d0._Z13record_resultdPKc(%struct.State* %0, i64 %309, %struct.Memory* %call2_40ac2b)
  ...
  ret %struct.Memory* %call2_40ac34
}
...
define %struct.Memory* @routine_jge_.L_40ac2b(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i8* %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
...
define %struct.Memory* @routine_jge_.L_40ac0e(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i8* %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 2, i32 9
...
define %struct.Memory* @routine_jmpq_.L_40abd3(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
...
define %struct.Memory* @routine_jmpq_.L_40abb4(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
