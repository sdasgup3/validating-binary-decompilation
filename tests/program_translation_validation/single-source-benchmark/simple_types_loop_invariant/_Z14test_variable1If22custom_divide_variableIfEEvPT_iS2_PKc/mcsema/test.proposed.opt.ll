...
declare %struct.Memory* @sub_40cb10._Z26check_shifted_variable_sumIf22custom_divide_variableIfEEvT_S2_(%struct.State* noalias dereferenceable(3376), i64, %struct.Memory* noalias readnone returned) local_unnamed_addr
...
define %struct.Memory* @_Z14test_variable1If22custom_divide_variableIfEEvPT_iS2_PKc(%struct.State* noalias, i64, %struct.Memory* noalias readnone) local_unnamed_addr #1 {
entry:
...
block_.L_40b234:                                  ; preds = %block_.L_40b28e, %entry
  %100 = phi i64 [ %297, %block_.L_40b28e ], [ %.pre, %entry ]
...
block_.L_40b253:                                  ; preds = %block_40b25f, %block_40b244
  %145 = phi i64 [ %252, %block_40b25f ], [ %.pre6, %block_40b244 ]
...
block_40b25f:                                     ; preds = %block_.L_40b253
  ...
  %call2_40b271 = tail call %struct.Memory* @sub_40caf0._ZN22custom_divide_variableIfE8do_shiftEff(%struct.State* nonnull %0, i64 %199, %struct.Memory* %call2_40b228)
...
block_.L_40b28e:                                  ; preds = %block_.L_40b253
  ...
  %call2_40b298 = tail call %struct.Memory* @sub_40cb10._Z26check_shifted_variable_sumIf22custom_divide_variableIfEEvT_S2_(%struct.State* nonnull %0, i64 %261, %struct.Memory* %call2_40b228)
...
block_.L_40b2ab:                                  ; preds = %block_.L_40b234
  ...
  %call2_40b2ab = tail call %struct.Memory* @sub_400e70._Z5timerv(%struct.State* nonnull %0, i64 %298, %struct.Memory* %call2_40b228)
