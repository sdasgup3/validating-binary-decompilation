...
declare %struct.Memory* @sub_40cb20._Z26check_shifted_variable_sumIf22custom_divide_variableIfEEvT_S2_(%struct.State* noalias dereferenceable(3376), i64, %struct.Memory* noalias readnone returned) local_unnamed_addr
...
entry:
  ...
  %call2_40b238 = tail call %struct.Memory* @sub_400e60._Z11start_timerv(%struct.State* %0, i64 %67, %struct.Memory* %2)
...
block_.L_40b244:                                  ; preds = %block_.L_40b29e, %entry
  %100 = phi i64 [ %297, %block_.L_40b29e ], [ %.pre, %entry ]
  ...
  br i1 %133, label %block_40b254, label %block_.L_40b2bb
...
block_.L_40b263:                                  ; preds = %block_40b26f, %block_40b254
  %145 = phi i64 [ %252, %block_40b26f ], [ %.pre6, %block_40b254 ]
  ...
  br i1 %181, label %block_40b26f, label %block_.L_40b29e
...
block_40b26f:                                     ; preds = %block_.L_40b263
  ...
  %call2_40b281 = tail call %struct.Memory* @sub_40cb00._ZN22custom_divide_variableIfE8do_shiftEff(%struct.State* nonnull %0, i64 %199, %struct.Memory* %call2_40b238)
...
block_.L_40b29e:                                  ; preds = %block_.L_40b263
  ...
  %call2_40b2a8 = tail call %struct.Memory* @sub_40cb20._Z26check_shifted_variable_sumIf22custom_divide_variableIfEEvT_S2_(%struct.State* nonnull %0, i64 %261, %struct.Memory* %call2_40b238)
...
block_.L_40b2bb:                                  ; preds = %block_.L_40b244
  ...
  %call2_40b2bb = tail call %struct.Memory* @sub_400e80._Z5timerv(%struct.State* nonnull %0, i64 %298, %struct.Memory* %call2_40b238)
  ...
  %call2_40b2c4 = tail call %struct.Memory* @sub_400820._Z13record_resultdPKc(%struct.State* nonnull %0, i64 %309, %struct.Memory* %call2_40b2bb)
