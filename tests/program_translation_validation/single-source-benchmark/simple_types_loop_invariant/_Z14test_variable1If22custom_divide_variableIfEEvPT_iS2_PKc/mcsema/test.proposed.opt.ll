...
block_.L_40b204:                                  ; preds = %block_.L_40b25e, %entry
  %99 = phi i64 [ %.pre, %entry ], [ %302, %block_.L_40b25e ]
  ...
  br i1 %132, label %block_40b214, label %block_.L_40b27b
...
block_.L_40b223:                                  ; preds = %block_40b22f, %block_40b214
  %144 = phi i64 [ %.pre1, %block_40b214 ], [ %254, %block_40b22f ]
  ...
  br i1 %180, label %block_40b22f, label %block_.L_40b25e
...
block_40b22f:                                     ; preds = %block_.L_40b223
  ...
  %call2_40b241 = tail call %struct.Memory* @sub_40cac0._ZN22custom_divide_variableIfE8do_shiftEff(%struct.State* %0, i64 %200, %struct.Memory* %MEMORY.1)
...
block_.L_40b25e:                                  ; preds = %block_.L_40b223
  ...
  %call2_40b268 = tail call %struct.Memory* @sub_40cae0._Z26check_shifted_variable_sumIf22custom_divide_variableIfEEvT_S2_(%struct.State* %0, i64 %265, %struct.Memory* %MEMORY.1)
...
block_.L_40b27b:                                  ; preds = %block_.L_40b204
  ...
  %call2_40b27b = tail call %struct.Memory* @sub_400e30._Z5timerv(%struct.State* %0, i64 %303, %struct.Memory* %MEMORY.0)
  ...
  %call2_40b284 = tail call %struct.Memory* @sub_4007d0._Z13record_resultdPKc(%struct.State* %0, i64 %314, %struct.Memory* %call2_40b27b)
