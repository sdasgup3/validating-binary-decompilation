...
declare %struct.Memory* @sub_40cd20._ZN24custom_multiply_variableIfE8do_shiftEff(%struct.State* dereferenceable(3376), i64, %struct.Memory*)

declare %struct.Memory* @sub_40cd40._Z26check_shifted_variable_sumIf24custom_multiply_variableIfEEvT_S2_(%struct.State* dereferenceable(3376), i64, %struct.Memory*)
