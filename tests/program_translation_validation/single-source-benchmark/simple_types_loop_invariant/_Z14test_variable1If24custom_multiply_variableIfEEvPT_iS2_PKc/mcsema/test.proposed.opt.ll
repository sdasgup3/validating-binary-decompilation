...
block_.L_40af94:                                  ; preds = %block_.L_40afee, %entry
  %98 = phi i64 [ %.pre, %entry ], [ %297, %block_.L_40afee ]
  ...
  br i1 %131, label %block_40afa4, label %block_.L_40b00b
...
block_.L_40afb3:                                  ; preds = %block_40afbf, %block_40afa4
  %143 = phi i64 [ %.pre1, %block_40afa4 ], [ %251, %block_40afbf ]
  ...
  br i1 %179, label %block_40afbf, label %block_.L_40afee
...
block_40afbf:                                     ; preds = %block_.L_40afb3
  ...
  %call2_40afd1 = tail call %struct.Memory* @sub_40ccf0._ZN24custom_multiply_variableIfE8do_shiftEff(%struct.State* %0, i64 %198, %struct.Memory* %MEMORY.1)
...
block_.L_40afee:                                  ; preds = %block_.L_40afb3
  ...
  %call2_40aff8 = tail call %struct.Memory* @sub_40cd10._Z26check_shifted_variable_sumIf24custom_multiply_variableIfEEvT_S2_(%struct.State* %0, i64 %261, %struct.Memory* %MEMORY.1)
...
block_.L_40b00b:                                  ; preds = %block_.L_40af94
  ...
  %call2_40b00b = tail call %struct.Memory* @sub_400e30._Z5timerv(%struct.State* %0, i64 %298, %struct.Memory* %MEMORY.0)
  ...
  %call2_40b014 = tail call %struct.Memory* @sub_4007d0._Z13record_resultdPKc(%struct.State* %0, i64 %309, %struct.Memory* %call2_40b00b)
