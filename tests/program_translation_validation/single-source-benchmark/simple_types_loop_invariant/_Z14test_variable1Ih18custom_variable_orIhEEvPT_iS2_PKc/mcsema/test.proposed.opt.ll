...
block_.L_404d14:                                  ; preds = %block_.L_404d6f, %entry
  %77 = phi i64 [ %.pre, %entry ], [ %287, %block_.L_404d6f ]
...
block_.L_404d2f:                                  ; preds = %block_404d3b, %block_404d24
  %120 = phi i64 [ %.pre1, %block_404d24 ], [ %239, %block_404d3b ]
...
block_.L_404d6f:                                  ; preds = %block_.L_404d2f
  ...
  %call2_404d79 = tail call %struct.Memory* @sub_412460._Z26check_shifted_variable_sumIh18custom_variable_orIhEEvT_S2_(%struct.State* %0, i64 %250, %struct.Memory* %MEMORY.1)
...
block_.L_404d8c:                                  ; preds = %block_.L_404d14
  ...
  %call2_404d8c = tail call %struct.Memory* @sub_400e30._Z5timerv(%struct.State* %0, i64 %288, %struct.Memory* %MEMORY.0)
  ...
  %call2_404d95 = tail call %struct.Memory* @sub_4007d0._Z13record_resultdPKc(%struct.State* %0, i64 %299, %struct.Memory* %call2_404d8c)
