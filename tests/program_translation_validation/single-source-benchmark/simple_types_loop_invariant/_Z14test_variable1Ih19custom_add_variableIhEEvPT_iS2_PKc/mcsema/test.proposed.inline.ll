...
define %struct.Memory* @_Z14test_variable1Ih19custom_add_variableIhEEvPT_iS2_PKc(%struct.State* noalias, i64, %struct.Memory* noalias) #2 {
entry:
  ...
  store %struct.Memory* %loadMem1_404058, %struct.Memory** %MEMORY
...
block_.L_404064:                                  ; preds = %block_.L_4040bf, %entry
  ...
  store %struct.Memory* %loadMem_404064, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_404067, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_40406e, %struct.Memory** %MEMORY
...
block_404074:                                     ; preds = %block_.L_404064
  ...
  store i8 0, i8* %257
  store %struct.Memory* %loadMem_404074, %struct.Memory** %MEMORY
  ...
  store i32 0, i32* %268
  store %struct.Memory* %loadMem_404078, %struct.Memory** %MEMORY
  br label %block_.L_40407f

block_.L_40407f:                                  ; preds = %block_40408b, %block_404074
  ...
  store %struct.Memory* %loadMem_40407f, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_404085, %struct.Memory** %MEMORY
...
block_40408b:                                     ; preds = %block_.L_40407f
  ...
  store %struct.Memory* %loadMem_40408b, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_404093, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem1_40409d, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_4040b7, %struct.Memory** %MEMORY
...
block_.L_4040bf:                                  ; preds = %block_.L_40407f
  ...
  store %struct.Memory* %loadMem1_4040c9, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_4040d4, %struct.Memory** %MEMORY
...
block_.L_4040dc:                                  ; preds = %block_.L_404064
  ...
  store %struct.Memory* %loadMem1_4040dc, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem1_4040e5, %struct.Memory** %MEMORY
  ...
  ret %struct.Memory* %loadMem_4040ef
}
