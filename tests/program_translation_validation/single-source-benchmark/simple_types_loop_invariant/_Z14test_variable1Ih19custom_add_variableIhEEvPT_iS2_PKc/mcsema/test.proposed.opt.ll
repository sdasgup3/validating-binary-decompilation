...
block_.L_404064:                                  ; preds = %block_.L_4040bf, %entry
  %77 = phi i64 [ %.pre, %entry ], [ %287, %block_.L_4040bf ]
...
block_.L_40407f:                                  ; preds = %block_40408b, %block_404074
  %120 = phi i64 [ %.pre1, %block_404074 ], [ %239, %block_40408b ]
...
block_.L_4040bf:                                  ; preds = %block_.L_40407f
  ...
  %call2_4040c9 = tail call %struct.Memory* @sub_412ee0._Z26check_shifted_variable_sumIh19custom_add_variableIhEEvT_S2_(%struct.State* %0, i64 %250, %struct.Memory* %MEMORY.1)
...
block_.L_4040dc:                                  ; preds = %block_.L_404064
  ...
  %call2_4040dc = tail call %struct.Memory* @sub_400e30._Z5timerv(%struct.State* %0, i64 %288, %struct.Memory* %MEMORY.0)
  ...
  %call2_4040e5 = tail call %struct.Memory* @sub_4007d0._Z13record_resultdPKc(%struct.State* %0, i64 %299, %struct.Memory* %call2_4040dc)
