...
entry:
  ...
  %call2_404058 = tail call %struct.Memory* @sub_400e10._Z11start_timerv(%struct.State* %0, i64 %67, %struct.Memory* %2)
...
block_.L_404064:                                  ; preds = %block_.L_4040bf, %entry
  %77 = phi i64 [ %.pre, %entry ], [ %285, %block_.L_4040bf ]
  %MEMORY.0 = phi %struct.Memory* [ %call2_404058, %entry ], [ %call2_4040c9, %block_.L_4040bf ]
  ...
  br i1 %110, label %block_404074, label %block_.L_4040dc
...
block_.L_40407f:                                  ; preds = %block_40408b, %block_404074
  %120 = phi i64 [ %.pre1, %block_404074 ], [ %238, %block_40408b ]
  %MEMORY.1 = phi %struct.Memory* [ %MEMORY.0, %block_404074 ], [ %call2_40409d, %block_40408b ]
  ...
  br i1 %156, label %block_40408b, label %block_.L_4040bf
...
block_40408b:                                     ; preds = %block_.L_40407f
  ...
  %call2_40409d = tail call %struct.Memory* @sub_412f50._ZN19custom_add_variableIhE8do_shiftEhh(%struct.State* %0, i64 %175, %struct.Memory* %MEMORY.1)
...
block_.L_4040bf:                                  ; preds = %block_.L_40407f
  ...
  %call2_4040c9 = tail call %struct.Memory* @sub_412ee0._Z26check_shifted_variable_sumIh19custom_add_variableIhEEvT_S2_(%struct.State* %0, i64 %249, %struct.Memory* %MEMORY.1)
...
block_.L_4040dc:                                  ; preds = %block_.L_404064
  ...
  %call2_4040dc = tail call %struct.Memory* @sub_400e30._Z5timerv(%struct.State* %0, i64 %286, %struct.Memory* %MEMORY.0)
  ...
  %call2_4040e5 = tail call %struct.Memory* @sub_4007d0._Z13record_resultdPKc(%struct.State* %0, i64 %297, %struct.Memory* %call2_4040dc)
  ...
  ret %struct.Memory* %call2_4040e5
}
...
define %struct.Memory* @routine_jge_.L_4040dc(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i8* %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
...
define %struct.Memory* @routine_jge_.L_4040bf(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i8* %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 2, i32 9
...
define %struct.Memory* @routine_jmpq_.L_40407f(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
...
define %struct.Memory* @routine_jmpq_.L_404064(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
