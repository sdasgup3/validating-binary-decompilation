...
declare %struct.Memory* @sub_412db0._Z26check_shifted_variable_sumIh19custom_sub_variableIhEEvT_S2_(%struct.State* dereferenceable(3376), i64, %struct.Memory*) local_unnamed_addr
...
block_.L_404314:                                  ; preds = %block_.L_40436f, %entry
  %77 = phi i64 [ %.pre, %entry ], [ %285, %block_.L_40436f ]
  %MEMORY.0 = phi %struct.Memory* [ %call2_404308, %entry ], [ %call2_404379, %block_.L_40436f ]
...
block_.L_40432f:                                  ; preds = %block_40433b, %block_404324
  %120 = phi i64 [ %.pre6, %block_404324 ], [ %238, %block_40433b ]
  %MEMORY.1 = phi %struct.Memory* [ %MEMORY.0, %block_404324 ], [ %call2_40434d, %block_40433b ]
...
block_40433b:                                     ; preds = %block_.L_40432f
  ...
  %call2_40434d = tail call %struct.Memory* @sub_412d80._ZN19custom_sub_variableIhE8do_shiftEhh(%struct.State* nonnull %0, i64 %175, %struct.Memory* %MEMORY.1)
...
block_.L_40436f:                                  ; preds = %block_.L_40432f
  ...
  %call2_404379 = tail call %struct.Memory* @sub_412db0._Z26check_shifted_variable_sumIh19custom_sub_variableIhEEvT_S2_(%struct.State* nonnull %0, i64 %249, %struct.Memory* %MEMORY.1)
...
block_.L_40438c:                                  ; preds = %block_.L_404314
  ...
  %call2_40438c = tail call %struct.Memory* @sub_400e70._Z5timerv(%struct.State* nonnull %0, i64 %286, %struct.Memory* %MEMORY.0)
