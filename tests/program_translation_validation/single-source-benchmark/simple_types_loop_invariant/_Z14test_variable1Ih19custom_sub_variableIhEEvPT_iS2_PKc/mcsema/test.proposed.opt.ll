...
declare %struct.Memory* @sub_412dc0._Z26check_shifted_variable_sumIh19custom_sub_variableIhEEvT_S2_(%struct.State* noalias dereferenceable(3376), i64, %struct.Memory* noalias readnone returned) local_unnamed_addr
...
entry:
  ...
  %call2_404318 = tail call %struct.Memory* @sub_400e60._Z11start_timerv(%struct.State* %0, i64 %67, %struct.Memory* %2)
...
block_.L_404324:                                  ; preds = %block_.L_40437f, %entry
  %77 = phi i64 [ %285, %block_.L_40437f ], [ %.pre, %entry ]
  ...
  br i1 %110, label %block_404334, label %block_.L_40439c
...
block_.L_40433f:                                  ; preds = %block_40434b, %block_404334
  %120 = phi i64 [ %238, %block_40434b ], [ %.pre6, %block_404334 ]
  ...
  br i1 %156, label %block_40434b, label %block_.L_40437f
...
block_40434b:                                     ; preds = %block_.L_40433f
  ...
  %call2_40435d = tail call %struct.Memory* @sub_412d90._ZN19custom_sub_variableIhE8do_shiftEhh(%struct.State* nonnull %0, i64 %175, %struct.Memory* %call2_404318)
...
block_.L_40437f:                                  ; preds = %block_.L_40433f
  ...
  %call2_404389 = tail call %struct.Memory* @sub_412dc0._Z26check_shifted_variable_sumIh19custom_sub_variableIhEEvT_S2_(%struct.State* nonnull %0, i64 %249, %struct.Memory* %call2_404318)
...
block_.L_40439c:                                  ; preds = %block_.L_404324
  ...
  %call2_40439c = tail call %struct.Memory* @sub_400e80._Z5timerv(%struct.State* nonnull %0, i64 %286, %struct.Memory* %call2_404318)
  ...
  %call2_4043a5 = tail call %struct.Memory* @sub_400820._Z13record_resultdPKc(%struct.State* nonnull %0, i64 %297, %struct.Memory* %call2_40439c)
