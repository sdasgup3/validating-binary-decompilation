...
block_.L_4042e4:                                  ; preds = %block_.L_40433f, %entry
  %77 = phi i64 [ %.pre, %entry ], [ %285, %block_.L_40433f ]
...
block_.L_4042ff:                                  ; preds = %block_40430b, %block_4042f4
  %120 = phi i64 [ %.pre1, %block_4042f4 ], [ %238, %block_40430b ]
...
block_.L_40433f:                                  ; preds = %block_.L_4042ff
  ...
  %call2_404349 = tail call %struct.Memory* @sub_412d80._Z26check_shifted_variable_sumIh19custom_sub_variableIhEEvT_S2_(%struct.State* %0, i64 %249, %struct.Memory* %MEMORY.1)
...
block_.L_40435c:                                  ; preds = %block_.L_4042e4
  ...
  %call2_40435c = tail call %struct.Memory* @sub_400e30._Z5timerv(%struct.State* %0, i64 %286, %struct.Memory* %MEMORY.0)
  ...
  %call2_404365 = tail call %struct.Memory* @sub_4007d0._Z13record_resultdPKc(%struct.State* %0, i64 %297, %struct.Memory* %call2_40435c)
