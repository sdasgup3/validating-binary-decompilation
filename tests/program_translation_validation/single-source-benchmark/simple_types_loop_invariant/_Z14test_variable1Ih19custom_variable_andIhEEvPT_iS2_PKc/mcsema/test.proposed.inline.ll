...
declare %struct.Memory* @sub_412620._Z26check_shifted_variable_sumIh19custom_variable_andIhEEvT_S2_(%struct.State* dereferenceable(3376), i64, %struct.Memory*)
...
define %struct.Memory* @_Z14test_variable1Ih19custom_variable_andIhEEvPT_iS2_PKc(%struct.State* noalias, i64, %struct.Memory* noalias) #1 {
entry:
