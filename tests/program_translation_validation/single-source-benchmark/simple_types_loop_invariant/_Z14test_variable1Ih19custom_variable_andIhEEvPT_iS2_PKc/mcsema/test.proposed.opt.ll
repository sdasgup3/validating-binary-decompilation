...
block_.L_404b54:                                  ; preds = %block_.L_404baf, %entry
  %77 = phi i64 [ %.pre, %entry ], [ %285, %block_.L_404baf ]
...
block_.L_404b6f:                                  ; preds = %block_404b7b, %block_404b64
  %120 = phi i64 [ %.pre1, %block_404b64 ], [ %238, %block_404b7b ]
...
block_.L_404baf:                                  ; preds = %block_.L_404b6f
  ...
  %call2_404bb9 = tail call %struct.Memory* @sub_4125f0._Z26check_shifted_variable_sumIh19custom_variable_andIhEEvT_S2_(%struct.State* %0, i64 %249, %struct.Memory* %MEMORY.1)
...
block_.L_404bcc:                                  ; preds = %block_.L_404b54
  ...
  %call2_404bcc = tail call %struct.Memory* @sub_400e30._Z5timerv(%struct.State* %0, i64 %286, %struct.Memory* %MEMORY.0)
  ...
  %call2_404bd5 = tail call %struct.Memory* @sub_4007d0._Z13record_resultdPKc(%struct.State* %0, i64 %297, %struct.Memory* %call2_404bcc)
