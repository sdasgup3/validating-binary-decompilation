...
declare %struct.Memory* @sub_4125f0._ZN19custom_variable_andIhE8do_shiftEhh(%struct.State* dereferenceable(3376), i64, %struct.Memory*) local_unnamed_addr

declare %struct.Memory* @sub_412620._Z26check_shifted_variable_sumIh19custom_variable_andIhEEvT_S2_(%struct.State* dereferenceable(3376), i64, %struct.Memory*) local_unnamed_addr
...
block_.L_404b84:                                  ; preds = %block_.L_404bdf, %entry
  %77 = phi i64 [ %.pre, %entry ], [ %285, %block_.L_404bdf ]
  %MEMORY.0 = phi %struct.Memory* [ %call2_404b78, %entry ], [ %call2_404be9, %block_.L_404bdf ]
...
block_.L_404b9f:                                  ; preds = %block_404bab, %block_404b94
  %120 = phi i64 [ %.pre6, %block_404b94 ], [ %238, %block_404bab ]
  %MEMORY.1 = phi %struct.Memory* [ %MEMORY.0, %block_404b94 ], [ %call2_404bbd, %block_404bab ]
...
block_404bab:                                     ; preds = %block_.L_404b9f
  ...
  %call2_404bbd = tail call %struct.Memory* @sub_4125f0._ZN19custom_variable_andIhE8do_shiftEhh(%struct.State* nonnull %0, i64 %175, %struct.Memory* %MEMORY.1)
...
block_.L_404bdf:                                  ; preds = %block_.L_404b9f
  ...
  %call2_404be9 = tail call %struct.Memory* @sub_412620._Z26check_shifted_variable_sumIh19custom_variable_andIhEEvT_S2_(%struct.State* nonnull %0, i64 %249, %struct.Memory* %MEMORY.1)
...
block_.L_404bfc:                                  ; preds = %block_.L_404b84
  ...
  %call2_404bfc = tail call %struct.Memory* @sub_400e70._Z5timerv(%struct.State* nonnull %0, i64 %286, %struct.Memory* %MEMORY.0)
