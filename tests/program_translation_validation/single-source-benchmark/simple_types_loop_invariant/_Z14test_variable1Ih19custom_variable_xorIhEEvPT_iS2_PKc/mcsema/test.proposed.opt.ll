...
block_.L_404ed4:                                  ; preds = %block_.L_404f2f, %entry
  %77 = phi i64 [ %.pre, %entry ], [ %287, %block_.L_404f2f ]
...
block_.L_404eef:                                  ; preds = %block_404efb, %block_404ee4
  %120 = phi i64 [ %.pre1, %block_404ee4 ], [ %239, %block_404efb ]
...
block_.L_404f2f:                                  ; preds = %block_.L_404eef
  ...
  %call2_404f39 = tail call %struct.Memory* @sub_4122d0._Z26check_shifted_variable_sumIh19custom_variable_xorIhEEvT_S2_(%struct.State* %0, i64 %250, %struct.Memory* %MEMORY.1)
...
block_.L_404f4c:                                  ; preds = %block_.L_404ed4
  ...
  %call2_404f4c = tail call %struct.Memory* @sub_400e30._Z5timerv(%struct.State* %0, i64 %288, %struct.Memory* %MEMORY.0)
  ...
  %call2_404f55 = tail call %struct.Memory* @sub_4007d0._Z13record_resultdPKc(%struct.State* %0, i64 %299, %struct.Memory* %call2_404f4c)
