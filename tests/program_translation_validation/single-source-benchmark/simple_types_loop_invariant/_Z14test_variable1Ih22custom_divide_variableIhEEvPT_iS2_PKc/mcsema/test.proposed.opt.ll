...
declare %struct.Memory* @sub_4129a0._Z26check_shifted_variable_sumIh22custom_divide_variableIhEEvT_S2_(%struct.State* dereferenceable(3376), i64, %struct.Memory*) local_unnamed_addr
