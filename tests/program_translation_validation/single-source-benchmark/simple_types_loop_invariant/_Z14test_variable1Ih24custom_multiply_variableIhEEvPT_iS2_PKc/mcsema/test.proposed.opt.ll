...
declare %struct.Memory* @sub_412bf0._ZN24custom_multiply_variableIhE8do_shiftEhh(%struct.State* dereferenceable(3376), i64, %struct.Memory*) local_unnamed_addr

declare %struct.Memory* @sub_412c20._Z26check_shifted_variable_sumIh24custom_multiply_variableIhEEvT_S2_(%struct.State* dereferenceable(3376), i64, %struct.Memory*) local_unnamed_addr
...
block_.L_4044d4:                                  ; preds = %block_.L_40452f, %entry
  %77 = phi i64 [ %.pre, %entry ], [ %285, %block_.L_40452f ]
  %MEMORY.0 = phi %struct.Memory* [ %call2_4044c8, %entry ], [ %call2_404539, %block_.L_40452f ]
...
block_.L_4044ef:                                  ; preds = %block_4044fb, %block_4044e4
  %120 = phi i64 [ %.pre6, %block_4044e4 ], [ %238, %block_4044fb ]
  %MEMORY.1 = phi %struct.Memory* [ %MEMORY.0, %block_4044e4 ], [ %call2_40450d, %block_4044fb ]
...
block_4044fb:                                     ; preds = %block_.L_4044ef
  ...
  %call2_40450d = tail call %struct.Memory* @sub_412bf0._ZN24custom_multiply_variableIhE8do_shiftEhh(%struct.State* nonnull %0, i64 %175, %struct.Memory* %MEMORY.1)
...
block_.L_40452f:                                  ; preds = %block_.L_4044ef
  ...
  %call2_404539 = tail call %struct.Memory* @sub_412c20._Z26check_shifted_variable_sumIh24custom_multiply_variableIhEEvT_S2_(%struct.State* nonnull %0, i64 %249, %struct.Memory* %MEMORY.1)
...
block_.L_40454c:                                  ; preds = %block_.L_4044d4
  ...
  %call2_40454c = tail call %struct.Memory* @sub_400e70._Z5timerv(%struct.State* nonnull %0, i64 %286, %struct.Memory* %MEMORY.0)
