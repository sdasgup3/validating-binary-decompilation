...
declare %struct.Memory* @sub_40f8d0._ZN18custom_variable_orIiE8do_shiftEii(%struct.State* dereferenceable(3376), i64, %struct.Memory*)

declare %struct.Memory* @sub_40f8f0._Z26check_shifted_variable_sumIi18custom_variable_orIiEEvT_S2_(%struct.State* dereferenceable(3376), i64, %struct.Memory*)
...
define %struct.Memory* @_Z14test_variable1Ii18custom_variable_orIiEEvPT_iS2_PKc(%struct.State* noalias, i64, %struct.Memory* noalias) #1 {
entry:
