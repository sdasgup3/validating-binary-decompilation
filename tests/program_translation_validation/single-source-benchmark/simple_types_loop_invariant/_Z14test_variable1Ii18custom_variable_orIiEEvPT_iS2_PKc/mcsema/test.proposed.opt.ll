...
declare %struct.Memory* @sub_40f8d0._ZN18custom_variable_orIiE8do_shiftEii(%struct.State* noalias dereferenceable(3376), i64, %struct.Memory* noalias readnone returned) local_unnamed_addr

declare %struct.Memory* @sub_40f8f0._Z26check_shifted_variable_sumIi18custom_variable_orIiEEvT_S2_(%struct.State* noalias dereferenceable(3376), i64, %struct.Memory* noalias readnone returned) local_unnamed_addr
...
define %struct.Memory* @_Z14test_variable1Ii18custom_variable_orIiEEvPT_iS2_PKc(%struct.State* noalias, i64, %struct.Memory* noalias readnone) local_unnamed_addr #1 {
entry:
...
block_.L_407f92:                                  ; preds = %block_.L_407fe3, %entry
  %75 = phi i64 [ %293, %block_.L_407fe3 ], [ %.pre, %entry ]
...
block_.L_407fb0:                                  ; preds = %block_407fbc, %block_407fa2
  %118 = phi i64 [ %246, %block_407fbc ], [ %.pre6, %block_407fa2 ]
...
block_407fbc:                                     ; preds = %block_.L_407fb0
  ...
  %call2_407fca = tail call %struct.Memory* @sub_40f8d0._ZN18custom_variable_orIiE8do_shiftEii(%struct.State* nonnull %0, i64 %174, %struct.Memory* %call2_407f86)
...
block_.L_407fe3:                                  ; preds = %block_.L_407fb0
  ...
  %call2_407fe9 = tail call %struct.Memory* @sub_40f8f0._Z26check_shifted_variable_sumIi18custom_variable_orIiEEvT_S2_(%struct.State* nonnull %0, i64 %257, %struct.Memory* %call2_407f86)
...
block_.L_407ffc:                                  ; preds = %block_.L_407f92
  ...
  %call2_407ffc = tail call %struct.Memory* @sub_400e70._Z5timerv(%struct.State* nonnull %0, i64 %294, %struct.Memory* %call2_407f86)
