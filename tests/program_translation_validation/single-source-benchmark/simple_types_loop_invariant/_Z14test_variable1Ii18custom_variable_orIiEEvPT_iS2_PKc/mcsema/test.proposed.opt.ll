...
block_.L_407f62:                                  ; preds = %block_.L_407fb3, %entry
  %75 = phi i64 [ %.pre, %entry ], [ %295, %block_.L_407fb3 ]
...
block_.L_407f80:                                  ; preds = %block_407f8c, %block_407f72
  %118 = phi i64 [ %.pre1, %block_407f72 ], [ %247, %block_407f8c ]
...
block_.L_407fb3:                                  ; preds = %block_.L_407f80
  ...
  %call2_407fb9 = tail call %struct.Memory* @sub_40f8c0._Z26check_shifted_variable_sumIi18custom_variable_orIiEEvT_S2_(%struct.State* %0, i64 %258, %struct.Memory* %MEMORY.1)
...
block_.L_407fcc:                                  ; preds = %block_.L_407f62
  ...
  %call2_407fcc = tail call %struct.Memory* @sub_400e30._Z5timerv(%struct.State* %0, i64 %296, %struct.Memory* %MEMORY.0)
  ...
  %call2_407fd5 = tail call %struct.Memory* @sub_4007d0._Z13record_resultdPKc(%struct.State* %0, i64 %307, %struct.Memory* %call2_407fcc)
