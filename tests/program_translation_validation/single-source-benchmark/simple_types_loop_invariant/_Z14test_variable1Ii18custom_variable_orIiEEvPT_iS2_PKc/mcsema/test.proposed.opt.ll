...
declare %struct.Memory* @sub_40f8e0._ZN18custom_variable_orIiE8do_shiftEii(%struct.State* noalias dereferenceable(3376), i64, %struct.Memory* noalias readnone returned) local_unnamed_addr

declare %struct.Memory* @sub_40f900._Z26check_shifted_variable_sumIi18custom_variable_orIiEEvT_S2_(%struct.State* noalias dereferenceable(3376), i64, %struct.Memory* noalias readnone returned) local_unnamed_addr
...
entry:
  ...
  %call2_407f96 = tail call %struct.Memory* @sub_400e60._Z11start_timerv(%struct.State* %0, i64 %65, %struct.Memory* %2)
...
block_.L_407fa2:                                  ; preds = %block_.L_407ff3, %entry
  %75 = phi i64 [ %293, %block_.L_407ff3 ], [ %.pre, %entry ]
  ...
  br i1 %108, label %block_407fb2, label %block_.L_40800c
...
block_.L_407fc0:                                  ; preds = %block_407fcc, %block_407fb2
  %118 = phi i64 [ %246, %block_407fcc ], [ %.pre6, %block_407fb2 ]
  ...
  br i1 %154, label %block_407fcc, label %block_.L_407ff3
...
block_407fcc:                                     ; preds = %block_.L_407fc0
  ...
  %call2_407fda = tail call %struct.Memory* @sub_40f8e0._ZN18custom_variable_orIiE8do_shiftEii(%struct.State* nonnull %0, i64 %174, %struct.Memory* %call2_407f96)
...
block_.L_407ff3:                                  ; preds = %block_.L_407fc0
  ...
  %call2_407ff9 = tail call %struct.Memory* @sub_40f900._Z26check_shifted_variable_sumIi18custom_variable_orIiEEvT_S2_(%struct.State* nonnull %0, i64 %257, %struct.Memory* %call2_407f96)
...
block_.L_40800c:                                  ; preds = %block_.L_407fa2
  ...
  %call2_40800c = tail call %struct.Memory* @sub_400e80._Z5timerv(%struct.State* nonnull %0, i64 %294, %struct.Memory* %call2_407f96)
  ...
  %call2_408015 = tail call %struct.Memory* @sub_400820._Z13record_resultdPKc(%struct.State* nonnull %0, i64 %305, %struct.Memory* %call2_40800c)
