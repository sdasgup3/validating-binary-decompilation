...
block_.L_407512:                                  ; preds = %block_.L_407563, %entry
  %75 = phi i64 [ %.pre, %entry ], [ %295, %block_.L_407563 ]
...
block_.L_407530:                                  ; preds = %block_40753c, %block_407522
  %118 = phi i64 [ %.pre1, %block_407522 ], [ %247, %block_40753c ]
...
block_.L_407563:                                  ; preds = %block_.L_407530
  ...
  %call2_407569 = tail call %struct.Memory* @sub_4100a0._Z26check_shifted_variable_sumIi19custom_add_variableIiEEvT_S2_(%struct.State* %0, i64 %258, %struct.Memory* %MEMORY.1)
...
block_.L_40757c:                                  ; preds = %block_.L_407512
  ...
  %call2_40757c = tail call %struct.Memory* @sub_400e30._Z5timerv(%struct.State* %0, i64 %296, %struct.Memory* %MEMORY.0)
  ...
  %call2_407585 = tail call %struct.Memory* @sub_4007d0._Z13record_resultdPKc(%struct.State* %0, i64 %307, %struct.Memory* %call2_40757c)
