...
declare %struct.Memory* @sub_410140._ZN19custom_add_variableIiE8do_shiftEii(%struct.State* noalias dereferenceable(3376), i64, %struct.Memory* noalias readnone returned) local_unnamed_addr
...
entry:
  ...
  %call2_407546 = tail call %struct.Memory* @sub_400e60._Z11start_timerv(%struct.State* %0, i64 %65, %struct.Memory* %2)
...
block_.L_407552:                                  ; preds = %block_.L_4075a3, %entry
  %75 = phi i64 [ %293, %block_.L_4075a3 ], [ %.pre, %entry ]
  ...
  br i1 %108, label %block_407562, label %block_.L_4075bc
...
block_.L_407570:                                  ; preds = %block_40757c, %block_407562
  %118 = phi i64 [ %246, %block_40757c ], [ %.pre6, %block_407562 ]
  ...
  br i1 %154, label %block_40757c, label %block_.L_4075a3
...
block_40757c:                                     ; preds = %block_.L_407570
  ...
  %call2_40758a = tail call %struct.Memory* @sub_410140._ZN19custom_add_variableIiE8do_shiftEii(%struct.State* nonnull %0, i64 %174, %struct.Memory* %call2_407546)
...
block_.L_4075a3:                                  ; preds = %block_.L_407570
  ...
  %call2_4075a9 = tail call %struct.Memory* @sub_4100e0._Z26check_shifted_variable_sumIi19custom_add_variableIiEEvT_S2_(%struct.State* nonnull %0, i64 %257, %struct.Memory* %call2_407546)
...
block_.L_4075bc:                                  ; preds = %block_.L_407552
  ...
  %call2_4075bc = tail call %struct.Memory* @sub_400e80._Z5timerv(%struct.State* nonnull %0, i64 %294, %struct.Memory* %call2_407546)
  ...
  %call2_4075c5 = tail call %struct.Memory* @sub_400820._Z13record_resultdPKc(%struct.State* nonnull %0, i64 %305, %struct.Memory* %call2_4075bc)
