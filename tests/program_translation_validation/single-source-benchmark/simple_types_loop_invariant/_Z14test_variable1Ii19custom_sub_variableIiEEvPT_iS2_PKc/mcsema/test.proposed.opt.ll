...
block_.L_407732:                                  ; preds = %block_.L_407783, %entry
  %75 = phi i64 [ %.pre, %entry ], [ %295, %block_.L_407783 ]
...
block_.L_407750:                                  ; preds = %block_40775c, %block_407742
  %118 = phi i64 [ %.pre1, %block_407742 ], [ %247, %block_40775c ]
...
block_.L_407783:                                  ; preds = %block_.L_407750
  ...
  %call2_407789 = tail call %struct.Memory* @sub_40ff90._Z26check_shifted_variable_sumIi19custom_sub_variableIiEEvT_S2_(%struct.State* %0, i64 %258, %struct.Memory* %MEMORY.1)
...
block_.L_40779c:                                  ; preds = %block_.L_407732
  ...
  %call2_40779c = tail call %struct.Memory* @sub_400e30._Z5timerv(%struct.State* %0, i64 %296, %struct.Memory* %MEMORY.0)
  ...
  %call2_4077a5 = tail call %struct.Memory* @sub_4007d0._Z13record_resultdPKc(%struct.State* %0, i64 %307, %struct.Memory* %call2_40779c)
