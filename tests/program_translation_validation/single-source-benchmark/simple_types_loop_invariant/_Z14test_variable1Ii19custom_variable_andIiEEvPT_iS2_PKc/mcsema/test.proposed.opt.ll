...
block_.L_407df2:                                  ; preds = %block_.L_407e43, %entry
  %75 = phi i64 [ %.pre, %entry ], [ %295, %block_.L_407e43 ]
...
block_.L_407e10:                                  ; preds = %block_407e1c, %block_407e02
  %118 = phi i64 [ %.pre1, %block_407e02 ], [ %247, %block_407e1c ]
...
block_.L_407e43:                                  ; preds = %block_.L_407e10
  ...
  %call2_407e49 = tail call %struct.Memory* @sub_40f9f0._Z26check_shifted_variable_sumIi19custom_variable_andIiEEvT_S2_(%struct.State* %0, i64 %258, %struct.Memory* %MEMORY.1)
...
block_.L_407e5c:                                  ; preds = %block_.L_407df2
  ...
  %call2_407e5c = tail call %struct.Memory* @sub_400e30._Z5timerv(%struct.State* %0, i64 %296, %struct.Memory* %MEMORY.0)
  ...
  %call2_407e65 = tail call %struct.Memory* @sub_4007d0._Z13record_resultdPKc(%struct.State* %0, i64 %307, %struct.Memory* %call2_407e5c)
