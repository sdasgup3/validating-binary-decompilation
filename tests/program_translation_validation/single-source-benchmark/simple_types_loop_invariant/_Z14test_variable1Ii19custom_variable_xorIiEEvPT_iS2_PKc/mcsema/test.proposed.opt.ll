...
block_.L_4080d2:                                  ; preds = %block_.L_408123, %entry
  %75 = phi i64 [ %.pre, %entry ], [ %295, %block_.L_408123 ]
...
block_.L_4080f0:                                  ; preds = %block_4080fc, %block_4080e2
  %118 = phi i64 [ %.pre1, %block_4080e2 ], [ %247, %block_4080fc ]
...
block_.L_408123:                                  ; preds = %block_.L_4080f0
  ...
  %call2_408129 = tail call %struct.Memory* @sub_40f790._Z26check_shifted_variable_sumIi19custom_variable_xorIiEEvT_S2_(%struct.State* %0, i64 %258, %struct.Memory* %MEMORY.1)
...
block_.L_40813c:                                  ; preds = %block_.L_4080d2
  ...
  %call2_40813c = tail call %struct.Memory* @sub_400e30._Z5timerv(%struct.State* %0, i64 %296, %struct.Memory* %MEMORY.0)
  ...
  %call2_408145 = tail call %struct.Memory* @sub_4007d0._Z13record_resultdPKc(%struct.State* %0, i64 %307, %struct.Memory* %call2_40813c)
