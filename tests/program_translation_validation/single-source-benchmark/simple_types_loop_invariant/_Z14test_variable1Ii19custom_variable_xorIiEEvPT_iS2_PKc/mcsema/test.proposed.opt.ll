...
declare %struct.Memory* @sub_40f7b0._ZN19custom_variable_xorIiE8do_shiftEii(%struct.State* noalias dereferenceable(3376), i64, %struct.Memory* noalias readnone returned) local_unnamed_addr

declare %struct.Memory* @sub_40f7d0._Z26check_shifted_variable_sumIi19custom_variable_xorIiEEvT_S2_(%struct.State* noalias dereferenceable(3376), i64, %struct.Memory* noalias readnone returned) local_unnamed_addr
...
entry:
  ...
  %call2_408106 = tail call %struct.Memory* @sub_400e60._Z11start_timerv(%struct.State* %0, i64 %65, %struct.Memory* %2)
  ...
  br label %block_.L_408112

block_.L_408112:                                  ; preds = %block_.L_408163, %entry
  %75 = phi i64 [ %293, %block_.L_408163 ], [ %.pre, %entry ]
  ...
  br i1 %108, label %block_408122, label %block_.L_40817c

block_408122:                                     ; preds = %block_.L_408112
  %110 = add i64 %76, -32
  %111 = add i64 %109, 7
...
block_.L_408130:                                  ; preds = %block_40813c, %block_408122
  %118 = phi i64 [ %246, %block_40813c ], [ %.pre6, %block_408122 ]
  ...
  br i1 %154, label %block_40813c, label %block_.L_408163

block_40813c:                                     ; preds = %block_.L_408130
  %156 = add i64 %119, -8
  %157 = add i64 %155, 4
  ...
  %call2_40814a = tail call %struct.Memory* @sub_40f7b0._ZN19custom_variable_xorIiE8do_shiftEii(%struct.State* nonnull %0, i64 %174, %struct.Memory* %call2_408106)
...
block_.L_408163:                                  ; preds = %block_.L_408130
  %247 = add i64 %119, -32
  %248 = add i64 %155, 3
  ...
  %call2_408169 = tail call %struct.Memory* @sub_40f7d0._Z26check_shifted_variable_sumIi19custom_variable_xorIiEEvT_S2_(%struct.State* nonnull %0, i64 %257, %struct.Memory* %call2_408106)
...
block_.L_40817c:                                  ; preds = %block_.L_408112
  ...
  %call2_40817c = tail call %struct.Memory* @sub_400e80._Z5timerv(%struct.State* nonnull %0, i64 %294, %struct.Memory* %call2_408106)
  ...
  %call2_408185 = tail call %struct.Memory* @sub_400820._Z13record_resultdPKc(%struct.State* nonnull %0, i64 %305, %struct.Memory* %call2_40817c)
