...
declare %struct.Memory* @sub_40f7a0._ZN19custom_variable_xorIiE8do_shiftEii(%struct.State* noalias dereferenceable(3376), i64, %struct.Memory* noalias readnone returned) local_unnamed_addr

declare %struct.Memory* @sub_40f7c0._Z26check_shifted_variable_sumIi19custom_variable_xorIiEEvT_S2_(%struct.State* noalias dereferenceable(3376), i64, %struct.Memory* noalias readnone returned) local_unnamed_addr
...
define %struct.Memory* @_Z14test_variable1Ii19custom_variable_xorIiEEvPT_iS2_PKc(%struct.State* noalias, i64, %struct.Memory* noalias readnone) local_unnamed_addr #1 {
entry:
...
block_.L_408102:                                  ; preds = %block_.L_408153, %entry
  %75 = phi i64 [ %293, %block_.L_408153 ], [ %.pre, %entry ]
...
block_.L_408120:                                  ; preds = %block_40812c, %block_408112
  %118 = phi i64 [ %246, %block_40812c ], [ %.pre6, %block_408112 ]
...
block_40812c:                                     ; preds = %block_.L_408120
  ...
  %call2_40813a = tail call %struct.Memory* @sub_40f7a0._ZN19custom_variable_xorIiE8do_shiftEii(%struct.State* nonnull %0, i64 %174, %struct.Memory* %call2_4080f6)
...
block_.L_408153:                                  ; preds = %block_.L_408120
  ...
  %call2_408159 = tail call %struct.Memory* @sub_40f7c0._Z26check_shifted_variable_sumIi19custom_variable_xorIiEEvT_S2_(%struct.State* nonnull %0, i64 %257, %struct.Memory* %call2_4080f6)
...
block_.L_40816c:                                  ; preds = %block_.L_408102
  ...
  %call2_40816c = tail call %struct.Memory* @sub_400e70._Z5timerv(%struct.State* nonnull %0, i64 %294, %struct.Memory* %call2_4080f6)
