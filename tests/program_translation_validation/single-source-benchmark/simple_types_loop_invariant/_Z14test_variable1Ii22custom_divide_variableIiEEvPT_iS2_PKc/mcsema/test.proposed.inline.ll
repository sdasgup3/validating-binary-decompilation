...
declare %struct.Memory* @sub_40fcb0._Z26check_shifted_variable_sumIi22custom_divide_variableIiEEvT_S2_(%struct.State* noalias dereferenceable(3376), i64, %struct.Memory* noalias readnone returned)
