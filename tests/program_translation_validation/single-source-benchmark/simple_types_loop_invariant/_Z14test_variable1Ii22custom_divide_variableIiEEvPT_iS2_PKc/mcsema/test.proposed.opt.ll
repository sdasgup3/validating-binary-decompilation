...
declare %struct.Memory* @sub_40fcb0._Z26check_shifted_variable_sumIi22custom_divide_variableIiEEvT_S2_(%struct.State* noalias dereferenceable(3376), i64, %struct.Memory* noalias readnone returned) local_unnamed_addr
...
define %struct.Memory* @_Z14test_variable1Ii22custom_divide_variableIiEEvPT_iS2_PKc(%struct.State* noalias, i64, %struct.Memory* noalias readnone) local_unnamed_addr #1 {
entry:
...
block_.L_407b12:                                  ; preds = %block_.L_407b63, %entry
  %75 = phi i64 [ %293, %block_.L_407b63 ], [ %.pre, %entry ]
...
block_.L_407b30:                                  ; preds = %block_407b3c, %block_407b22
  %118 = phi i64 [ %246, %block_407b3c ], [ %.pre6, %block_407b22 ]
...
block_407b3c:                                     ; preds = %block_.L_407b30
  ...
  %call2_407b4a = tail call %struct.Memory* @sub_40fc90._ZN22custom_divide_variableIiE8do_shiftEii(%struct.State* nonnull %0, i64 %174, %struct.Memory* %call2_407b06)
...
block_.L_407b63:                                  ; preds = %block_.L_407b30
  ...
  %call2_407b69 = tail call %struct.Memory* @sub_40fcb0._Z26check_shifted_variable_sumIi22custom_divide_variableIiEEvT_S2_(%struct.State* nonnull %0, i64 %257, %struct.Memory* %call2_407b06)
...
block_.L_407b7c:                                  ; preds = %block_.L_407b12
  ...
  %call2_407b7c = tail call %struct.Memory* @sub_400e70._Z5timerv(%struct.State* nonnull %0, i64 %294, %struct.Memory* %call2_407b06)
