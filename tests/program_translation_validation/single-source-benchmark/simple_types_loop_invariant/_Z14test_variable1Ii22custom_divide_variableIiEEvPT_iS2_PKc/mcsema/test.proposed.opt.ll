...
declare %struct.Memory* @sub_40fcc0._Z26check_shifted_variable_sumIi22custom_divide_variableIiEEvT_S2_(%struct.State* noalias dereferenceable(3376), i64, %struct.Memory* noalias readnone returned) local_unnamed_addr
...
entry:
  ...
  %call2_407b16 = tail call %struct.Memory* @sub_400e60._Z11start_timerv(%struct.State* %0, i64 %65, %struct.Memory* %2)
...
block_.L_407b22:                                  ; preds = %block_.L_407b73, %entry
  %75 = phi i64 [ %293, %block_.L_407b73 ], [ %.pre, %entry ]
  ...
  br i1 %108, label %block_407b32, label %block_.L_407b8c
...
block_.L_407b40:                                  ; preds = %block_407b4c, %block_407b32
  %118 = phi i64 [ %246, %block_407b4c ], [ %.pre6, %block_407b32 ]
  ...
  br i1 %154, label %block_407b4c, label %block_.L_407b73
...
block_407b4c:                                     ; preds = %block_.L_407b40
  ...
  %call2_407b5a = tail call %struct.Memory* @sub_40fca0._ZN22custom_divide_variableIiE8do_shiftEii(%struct.State* nonnull %0, i64 %174, %struct.Memory* %call2_407b16)
...
block_.L_407b73:                                  ; preds = %block_.L_407b40
  ...
  %call2_407b79 = tail call %struct.Memory* @sub_40fcc0._Z26check_shifted_variable_sumIi22custom_divide_variableIiEEvT_S2_(%struct.State* nonnull %0, i64 %257, %struct.Memory* %call2_407b16)
...
block_.L_407b8c:                                  ; preds = %block_.L_407b22
  ...
  %call2_407b8c = tail call %struct.Memory* @sub_400e80._Z5timerv(%struct.State* nonnull %0, i64 %294, %struct.Memory* %call2_407b16)
  ...
  %call2_407b95 = tail call %struct.Memory* @sub_400820._Z13record_resultdPKc(%struct.State* nonnull %0, i64 %305, %struct.Memory* %call2_407b8c)
