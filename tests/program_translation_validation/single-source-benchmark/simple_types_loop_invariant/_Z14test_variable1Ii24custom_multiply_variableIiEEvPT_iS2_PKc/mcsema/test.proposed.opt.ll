...
block_.L_4078a2:                                  ; preds = %block_.L_4078f3, %entry
  %75 = phi i64 [ %.pre, %entry ], [ %295, %block_.L_4078f3 ]
...
block_.L_4078c0:                                  ; preds = %block_4078cc, %block_4078b2
  %118 = phi i64 [ %.pre1, %block_4078b2 ], [ %247, %block_4078cc ]
...
block_.L_4078f3:                                  ; preds = %block_.L_4078c0
  ...
  %call2_4078f9 = tail call %struct.Memory* @sub_40fe60._Z26check_shifted_variable_sumIi24custom_multiply_variableIiEEvT_S2_(%struct.State* %0, i64 %258, %struct.Memory* %MEMORY.1)
...
block_.L_40790c:                                  ; preds = %block_.L_4078a2
  ...
  %call2_40790c = tail call %struct.Memory* @sub_400e30._Z5timerv(%struct.State* %0, i64 %296, %struct.Memory* %MEMORY.0)
  ...
  %call2_407915 = tail call %struct.Memory* @sub_4007d0._Z13record_resultdPKc(%struct.State* %0, i64 %307, %struct.Memory* %call2_40790c)
