...
declare %struct.Memory* @sub_40edc0._ZN18custom_variable_orIjE8do_shiftEjj(%struct.State* dereferenceable(3376), i64, %struct.Memory*)

declare %struct.Memory* @sub_40ede0._Z26check_shifted_variable_sumIj18custom_variable_orIjEEvT_S2_(%struct.State* dereferenceable(3376), i64, %struct.Memory*)
...
define %struct.Memory* @_Z14test_variable1Ij18custom_variable_orIjEEvPT_iS2_PKc(%struct.State* noalias, i64, %struct.Memory* noalias) #1 {
entry:
