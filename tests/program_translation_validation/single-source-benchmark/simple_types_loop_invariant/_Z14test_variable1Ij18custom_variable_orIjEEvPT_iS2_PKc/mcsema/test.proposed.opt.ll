...
declare %struct.Memory* @sub_40edc0._ZN18custom_variable_orIjE8do_shiftEjj(%struct.State* noalias dereferenceable(3376), i64, %struct.Memory* noalias readnone returned) local_unnamed_addr

declare %struct.Memory* @sub_40ede0._Z26check_shifted_variable_sumIj18custom_variable_orIjEEvT_S2_(%struct.State* noalias dereferenceable(3376), i64, %struct.Memory* noalias readnone returned) local_unnamed_addr
...
block_.L_408d02:                                  ; preds = %block_.L_408d53, %entry
  %75 = phi i64 [ %293, %block_.L_408d53 ], [ %.pre, %entry ]
...
block_.L_408d20:                                  ; preds = %block_408d2c, %block_408d12
  %118 = phi i64 [ %246, %block_408d2c ], [ %.pre6, %block_408d12 ]
...
block_408d2c:                                     ; preds = %block_.L_408d20
  ...
  %call2_408d3a = tail call %struct.Memory* @sub_40edc0._ZN18custom_variable_orIjE8do_shiftEjj(%struct.State* nonnull %0, i64 %174, %struct.Memory* %call2_408cf6)
...
block_.L_408d53:                                  ; preds = %block_.L_408d20
  ...
  %call2_408d59 = tail call %struct.Memory* @sub_40ede0._Z26check_shifted_variable_sumIj18custom_variable_orIjEEvT_S2_(%struct.State* nonnull %0, i64 %257, %struct.Memory* %call2_408cf6)
...
block_.L_408d6c:                                  ; preds = %block_.L_408d02
  ...
  %call2_408d6c = tail call %struct.Memory* @sub_400e70._Z5timerv(%struct.State* nonnull %0, i64 %294, %struct.Memory* %call2_408cf6)
