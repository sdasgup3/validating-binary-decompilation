...
declare %struct.Memory* @sub_40edd0._ZN18custom_variable_orIjE8do_shiftEjj(%struct.State* noalias dereferenceable(3376), i64, %struct.Memory* noalias readnone returned) local_unnamed_addr

declare %struct.Memory* @sub_40edf0._Z26check_shifted_variable_sumIj18custom_variable_orIjEEvT_S2_(%struct.State* noalias dereferenceable(3376), i64, %struct.Memory* noalias readnone returned) local_unnamed_addr
...
define %struct.Memory* @_Z14test_variable1Ij18custom_variable_orIjEEvPT_iS2_PKc(%struct.State* noalias, i64, %struct.Memory* noalias readnone) local_unnamed_addr #1 {
entry:
  ...
  %call2_408d06 = tail call %struct.Memory* @sub_400e60._Z11start_timerv(%struct.State* %0, i64 %65, %struct.Memory* %2)
...
block_.L_408d12:                                  ; preds = %block_.L_408d63, %entry
  %75 = phi i64 [ %293, %block_.L_408d63 ], [ %.pre, %entry ]
  ...
  br i1 %108, label %block_408d22, label %block_.L_408d7c
...
block_.L_408d30:                                  ; preds = %block_408d3c, %block_408d22
  %118 = phi i64 [ %246, %block_408d3c ], [ %.pre6, %block_408d22 ]
  ...
  br i1 %154, label %block_408d3c, label %block_.L_408d63
...
block_408d3c:                                     ; preds = %block_.L_408d30
  ...
  %call2_408d4a = tail call %struct.Memory* @sub_40edd0._ZN18custom_variable_orIjE8do_shiftEjj(%struct.State* nonnull %0, i64 %174, %struct.Memory* %call2_408d06)
...
block_.L_408d63:                                  ; preds = %block_.L_408d30
  ...
  %call2_408d69 = tail call %struct.Memory* @sub_40edf0._Z26check_shifted_variable_sumIj18custom_variable_orIjEEvT_S2_(%struct.State* nonnull %0, i64 %257, %struct.Memory* %call2_408d06)
...
block_.L_408d7c:                                  ; preds = %block_.L_408d12
  ...
  %call2_408d7c = tail call %struct.Memory* @sub_400e80._Z5timerv(%struct.State* nonnull %0, i64 %294, %struct.Memory* %call2_408d06)
  ...
  %call2_408d85 = tail call %struct.Memory* @sub_400820._Z13record_resultdPKc(%struct.State* nonnull %0, i64 %305, %struct.Memory* %call2_408d7c)
  ...
  ret %struct.Memory* %call2_408d85
}
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_jge_.L_408d7c(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i8* nocapture %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_jge_.L_408d63(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i8* nocapture %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 2, i32 9
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_jmpq_.L_408d30(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_jmpq_.L_408d12(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
