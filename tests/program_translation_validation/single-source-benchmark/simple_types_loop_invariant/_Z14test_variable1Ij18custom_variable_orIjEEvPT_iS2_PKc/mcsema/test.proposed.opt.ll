...
block_.L_408cd2:                                  ; preds = %block_.L_408d23, %entry
  %75 = phi i64 [ %.pre, %entry ], [ %293, %block_.L_408d23 ]
...
block_.L_408cf0:                                  ; preds = %block_408cfc, %block_408ce2
  %118 = phi i64 [ %.pre1, %block_408ce2 ], [ %246, %block_408cfc ]
...
block_.L_408d23:                                  ; preds = %block_.L_408cf0
  ...
  %call2_408d29 = tail call %struct.Memory* @sub_40edb0._Z26check_shifted_variable_sumIj18custom_variable_orIjEEvT_S2_(%struct.State* %0, i64 %257, %struct.Memory* %MEMORY.1)
...
block_.L_408d3c:                                  ; preds = %block_.L_408cd2
  ...
  %call2_408d3c = tail call %struct.Memory* @sub_400e30._Z5timerv(%struct.State* %0, i64 %294, %struct.Memory* %MEMORY.0)
  ...
  %call2_408d45 = tail call %struct.Memory* @sub_4007d0._Z13record_resultdPKc(%struct.State* %0, i64 %305, %struct.Memory* %call2_408d3c)
