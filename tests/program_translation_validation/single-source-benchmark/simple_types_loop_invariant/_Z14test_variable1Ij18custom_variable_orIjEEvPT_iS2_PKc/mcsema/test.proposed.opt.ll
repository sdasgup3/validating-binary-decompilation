...
declare %struct.Memory* @sub_40ed90._ZN18custom_variable_orIjE8do_shiftEjj(%struct.State* noalias dereferenceable(3376), i64, %struct.Memory* noalias readnone returned) local_unnamed_addr

declare %struct.Memory* @sub_40edb0._Z26check_shifted_variable_sumIj18custom_variable_orIjEEvT_S2_(%struct.State* noalias dereferenceable(3376), i64, %struct.Memory* noalias readnone returned) local_unnamed_addr
...
entry:
  ...
  %call2_408cc6 = tail call %struct.Memory* @sub_400e10._Z11start_timerv(%struct.State* %0, i64 %65, %struct.Memory* %2)
...
block_.L_408cd2:                                  ; preds = %block_.L_408d23, %entry
  %75 = phi i64 [ %.pre, %entry ], [ %295, %block_.L_408d23 ]
  %MEMORY.0 = phi %struct.Memory* [ %call2_408cc6, %entry ], [ %call2_408d29, %block_.L_408d23 ]
  ...
  br i1 %108, label %block_408ce2, label %block_.L_408d3c
...
block_.L_408cf0:                                  ; preds = %block_408cfc, %block_408ce2
  %118 = phi i64 [ %.pre1, %block_408ce2 ], [ %247, %block_408cfc ]
  %MEMORY.1 = phi %struct.Memory* [ %MEMORY.0, %block_408ce2 ], [ %call2_408d0a, %block_408cfc ]
  ...
  br i1 %154, label %block_408cfc, label %block_.L_408d23
...
block_408cfc:                                     ; preds = %block_.L_408cf0
  ...
  %call2_408d0a = tail call %struct.Memory* @sub_40ed90._ZN18custom_variable_orIjE8do_shiftEjj(%struct.State* %0, i64 %174, %struct.Memory* %MEMORY.1)
...
block_.L_408d23:                                  ; preds = %block_.L_408cf0
  ...
  %call2_408d29 = tail call %struct.Memory* @sub_40edb0._Z26check_shifted_variable_sumIj18custom_variable_orIjEEvT_S2_(%struct.State* %0, i64 %258, %struct.Memory* %MEMORY.1)
...
block_.L_408d3c:                                  ; preds = %block_.L_408cd2
  ...
  %call2_408d3c = tail call %struct.Memory* @sub_400e30._Z5timerv(%struct.State* %0, i64 %296, %struct.Memory* %MEMORY.0)
  ...
  %call2_408d45 = tail call %struct.Memory* @sub_4007d0._Z13record_resultdPKc(%struct.State* %0, i64 %307, %struct.Memory* %call2_408d3c)
  ...
  ret %struct.Memory* %call2_408d45
}
...
define %struct.Memory* @routine_jge_.L_408d3c(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i8* %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
...
define %struct.Memory* @routine_jge_.L_408d23(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i8* %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 2, i32 9
...
define %struct.Memory* @routine_callq_._ZN18custom_variable_orIjE8do_shiftEjj(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
...
define %struct.Memory* @routine_jmpq_.L_408cf0(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
...
define %struct.Memory* @routine_callq_._Z26check_shifted_variable_sumIj18custom_variable_orIjEEvT_S2_(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
...
define %struct.Memory* @routine_jmpq_.L_408cd2(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
