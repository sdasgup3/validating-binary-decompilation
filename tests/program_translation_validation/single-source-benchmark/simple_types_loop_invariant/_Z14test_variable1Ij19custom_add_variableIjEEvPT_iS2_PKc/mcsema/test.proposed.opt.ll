...
declare %struct.Memory* @sub_40f640._Z26check_shifted_variable_sumIj19custom_add_variableIjEEvT_S2_(%struct.State* noalias dereferenceable(3376), i64, %struct.Memory* noalias readnone returned) local_unnamed_addr
...
entry:
  ...
  %call2_4082b6 = tail call %struct.Memory* @sub_400e60._Z11start_timerv(%struct.State* %0, i64 %65, %struct.Memory* %2)
...
block_.L_4082c2:                                  ; preds = %block_.L_408313, %entry
  %75 = phi i64 [ %293, %block_.L_408313 ], [ %.pre, %entry ]
  ...
  br i1 %108, label %block_4082d2, label %block_.L_40832c

block_4082d2:                                     ; preds = %block_.L_4082c2
  %110 = add i64 %76, -32
  %111 = add i64 %109, 7
...
block_.L_4082e0:                                  ; preds = %block_4082ec, %block_4082d2
  %118 = phi i64 [ %246, %block_4082ec ], [ %.pre6, %block_4082d2 ]
  ...
  br i1 %154, label %block_4082ec, label %block_.L_408313

block_4082ec:                                     ; preds = %block_.L_4082e0
  %156 = add i64 %119, -8
  %157 = add i64 %155, 4
  ...
  %call2_4082fa = tail call %struct.Memory* @sub_40f6b0._ZN19custom_add_variableIjE8do_shiftEjj(%struct.State* nonnull %0, i64 %174, %struct.Memory* %call2_4082b6)
...
block_.L_408313:                                  ; preds = %block_.L_4082e0
  %247 = add i64 %119, -32
  %248 = add i64 %155, 3
  ...
  %call2_408319 = tail call %struct.Memory* @sub_40f640._Z26check_shifted_variable_sumIj19custom_add_variableIjEEvT_S2_(%struct.State* nonnull %0, i64 %257, %struct.Memory* %call2_4082b6)
...
block_.L_40832c:                                  ; preds = %block_.L_4082c2
  ...
  %call2_40832c = tail call %struct.Memory* @sub_400e80._Z5timerv(%struct.State* nonnull %0, i64 %294, %struct.Memory* %call2_4082b6)
  ...
  %call2_408335 = tail call %struct.Memory* @sub_400820._Z13record_resultdPKc(%struct.State* nonnull %0, i64 %305, %struct.Memory* %call2_40832c)
  ...
  ret %struct.Memory* %call2_408335
}
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_jge_.L_40832c(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i8* nocapture %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_jmpq_.L_4082e0(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_jmpq_.L_4082c2(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
