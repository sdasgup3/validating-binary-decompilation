...
declare %struct.Memory* @sub_40f630._Z26check_shifted_variable_sumIj19custom_add_variableIjEEvT_S2_(%struct.State* dereferenceable(3376), i64, %struct.Memory*) local_unnamed_addr
...
entry:
  ...
  %call2_4082a6 = tail call %struct.Memory* @sub_400e50._Z11start_timerv(%struct.State* %0, i64 %65, %struct.Memory* %2)
...
block_.L_4082b2:                                  ; preds = %block_.L_408303, %entry
  %75 = phi i64 [ %.pre, %entry ], [ %293, %block_.L_408303 ]
  %MEMORY.0 = phi %struct.Memory* [ %call2_4082a6, %entry ], [ %call2_408309, %block_.L_408303 ]
  ...
  br i1 %108, label %block_4082c2, label %block_.L_40831c

block_4082c2:                                     ; preds = %block_.L_4082b2
  %110 = add i64 %76, -32
  %111 = add i64 %109, 7
...
block_.L_4082d0:                                  ; preds = %block_4082dc, %block_4082c2
  %118 = phi i64 [ %.pre6, %block_4082c2 ], [ %246, %block_4082dc ]
  %MEMORY.1 = phi %struct.Memory* [ %MEMORY.0, %block_4082c2 ], [ %call2_4082ea, %block_4082dc ]
  ...
  br i1 %154, label %block_4082dc, label %block_.L_408303

block_4082dc:                                     ; preds = %block_.L_4082d0
  %156 = add i64 %119, -8
  %157 = add i64 %155, 4
  ...
  %call2_4082ea = tail call %struct.Memory* @sub_40f6a0._ZN19custom_add_variableIjE8do_shiftEjj(%struct.State* nonnull %0, i64 %174, %struct.Memory* %MEMORY.1)
...
block_.L_408303:                                  ; preds = %block_.L_4082d0
  %247 = add i64 %119, -32
  %248 = add i64 %155, 3
  ...
  %call2_408309 = tail call %struct.Memory* @sub_40f630._Z26check_shifted_variable_sumIj19custom_add_variableIjEEvT_S2_(%struct.State* nonnull %0, i64 %257, %struct.Memory* %MEMORY.1)
...
block_.L_40831c:                                  ; preds = %block_.L_4082b2
  %294 = add i64 %109, -29868
  %295 = add i64 %109, 5
  ...
  %call2_40831c = tail call %struct.Memory* @sub_400e70._Z5timerv(%struct.State* nonnull %0, i64 %294, %struct.Memory* %MEMORY.0)
  ...
  %call2_408325 = tail call %struct.Memory* @sub_400810._Z13record_resultdPKc(%struct.State* nonnull %0, i64 %305, %struct.Memory* %call2_40831c)
  ...
  ret %struct.Memory* %call2_408325
}
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_jge_.L_40831c(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i8* nocapture %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_jmpq_.L_4082d0(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_jmpq_.L_4082b2(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
