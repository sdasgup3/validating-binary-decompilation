...
define %struct.Memory* @_Z14test_variable1Ij19custom_add_variableIjEEvPT_iS2_PKc(%struct.State* noalias, i64, %struct.Memory* noalias readnone) local_unnamed_addr #1 {
entry:
...
block_.L_4082b2:                                  ; preds = %block_.L_408303, %entry
  %75 = phi i64 [ %293, %block_.L_408303 ], [ %.pre, %entry ]
...
block_.L_4082d0:                                  ; preds = %block_4082dc, %block_4082c2
  %118 = phi i64 [ %246, %block_4082dc ], [ %.pre6, %block_4082c2 ]
...
block_4082dc:                                     ; preds = %block_.L_4082d0
  ...
  %call2_4082ea = tail call %struct.Memory* @sub_40f6a0._ZN19custom_add_variableIjE8do_shiftEjj(%struct.State* nonnull %0, i64 %174, %struct.Memory* %call2_4082a6)
...
block_.L_408303:                                  ; preds = %block_.L_4082d0
  ...
  %call2_408309 = tail call %struct.Memory* @sub_40f630._Z26check_shifted_variable_sumIj19custom_add_variableIjEEvT_S2_(%struct.State* nonnull %0, i64 %257, %struct.Memory* %call2_4082a6)
...
block_.L_40831c:                                  ; preds = %block_.L_4082b2
  ...
  %call2_40831c = tail call %struct.Memory* @sub_400e70._Z5timerv(%struct.State* nonnull %0, i64 %294, %struct.Memory* %call2_4082a6)
