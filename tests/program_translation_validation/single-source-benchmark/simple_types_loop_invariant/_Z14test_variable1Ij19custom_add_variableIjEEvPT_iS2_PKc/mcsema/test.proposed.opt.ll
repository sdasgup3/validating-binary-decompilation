...
block_.L_408282:                                  ; preds = %block_.L_4082d3, %entry
  %75 = phi i64 [ %.pre, %entry ], [ %295, %block_.L_4082d3 ]
...
block_.L_4082a0:                                  ; preds = %block_4082ac, %block_408292
  %118 = phi i64 [ %.pre1, %block_408292 ], [ %247, %block_4082ac ]
...
block_.L_4082d3:                                  ; preds = %block_.L_4082a0
  ...
  %call2_4082d9 = tail call %struct.Memory* @sub_40f600._Z26check_shifted_variable_sumIj19custom_add_variableIjEEvT_S2_(%struct.State* %0, i64 %258, %struct.Memory* %MEMORY.1)
...
block_.L_4082ec:                                  ; preds = %block_.L_408282
  ...
  %call2_4082ec = tail call %struct.Memory* @sub_400e30._Z5timerv(%struct.State* %0, i64 %296, %struct.Memory* %MEMORY.0)
  ...
  %call2_4082f5 = tail call %struct.Memory* @sub_4007d0._Z13record_resultdPKc(%struct.State* %0, i64 %307, %struct.Memory* %call2_4082ec)
