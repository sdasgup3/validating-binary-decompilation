; ModuleID = '/tmp/tmp28wth7sm-query.ll'
...
define %struct.Memory* @_Z14test_variable1Ij19custom_add_variableIjEEvPT_iS2_PKc(%struct.State* noalias nocapture readonly, i64, %struct.Memory* noalias readnone returned) local_unnamed_addr #1 {
entry:
