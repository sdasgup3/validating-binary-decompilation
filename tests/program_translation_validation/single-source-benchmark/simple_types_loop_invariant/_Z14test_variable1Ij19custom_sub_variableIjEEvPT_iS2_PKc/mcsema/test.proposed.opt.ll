...
declare %struct.Memory* @sub_40f4f0._ZN19custom_sub_variableIjE8do_shiftEjj(%struct.State* dereferenceable(3376), i64, %struct.Memory*) local_unnamed_addr

declare %struct.Memory* @sub_40f510._Z26check_shifted_variable_sumIj19custom_sub_variableIjEEvT_S2_(%struct.State* dereferenceable(3376), i64, %struct.Memory*) local_unnamed_addr
...
define %struct.Memory* @_Z14test_variable1Ij19custom_sub_variableIjEEvPT_iS2_PKc(%struct.State* noalias, i64, %struct.Memory* noalias) local_unnamed_addr #1 {
entry:
...
block_.L_4084d2:                                  ; preds = %block_.L_408523, %entry
  %75 = phi i64 [ %.pre, %entry ], [ %293, %block_.L_408523 ]
  %MEMORY.0 = phi %struct.Memory* [ %call2_4084c6, %entry ], [ %call2_408529, %block_.L_408523 ]
...
block_.L_4084f0:                                  ; preds = %block_4084fc, %block_4084e2
  %118 = phi i64 [ %.pre6, %block_4084e2 ], [ %246, %block_4084fc ]
  %MEMORY.1 = phi %struct.Memory* [ %MEMORY.0, %block_4084e2 ], [ %call2_40850a, %block_4084fc ]
...
block_4084fc:                                     ; preds = %block_.L_4084f0
  ...
  %call2_40850a = tail call %struct.Memory* @sub_40f4f0._ZN19custom_sub_variableIjE8do_shiftEjj(%struct.State* nonnull %0, i64 %174, %struct.Memory* %MEMORY.1)
...
block_.L_408523:                                  ; preds = %block_.L_4084f0
  ...
  %call2_408529 = tail call %struct.Memory* @sub_40f510._Z26check_shifted_variable_sumIj19custom_sub_variableIjEEvT_S2_(%struct.State* nonnull %0, i64 %257, %struct.Memory* %MEMORY.1)
...
block_.L_40853c:                                  ; preds = %block_.L_4084d2
  ...
  %call2_40853c = tail call %struct.Memory* @sub_400e70._Z5timerv(%struct.State* nonnull %0, i64 %294, %struct.Memory* %MEMORY.0)
