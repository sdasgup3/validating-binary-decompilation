...
block_.L_4084a2:                                  ; preds = %block_.L_4084f3, %entry
  %75 = phi i64 [ %.pre, %entry ], [ %293, %block_.L_4084f3 ]
...
block_.L_4084c0:                                  ; preds = %block_4084cc, %block_4084b2
  %118 = phi i64 [ %.pre1, %block_4084b2 ], [ %246, %block_4084cc ]
...
block_.L_4084f3:                                  ; preds = %block_.L_4084c0
  ...
  %call2_4084f9 = tail call %struct.Memory* @sub_40f4e0._Z26check_shifted_variable_sumIj19custom_sub_variableIjEEvT_S2_(%struct.State* %0, i64 %257, %struct.Memory* %MEMORY.1)
...
block_.L_40850c:                                  ; preds = %block_.L_4084a2
  ...
  %call2_40850c = tail call %struct.Memory* @sub_400e30._Z5timerv(%struct.State* %0, i64 %294, %struct.Memory* %MEMORY.0)
  ...
  %call2_408515 = tail call %struct.Memory* @sub_4007d0._Z13record_resultdPKc(%struct.State* %0, i64 %305, %struct.Memory* %call2_40850c)
