...
block_.L_408b62:                                  ; preds = %block_.L_408bb3, %entry
  %75 = phi i64 [ %.pre, %entry ], [ %293, %block_.L_408bb3 ]
...
block_.L_408b80:                                  ; preds = %block_408b8c, %block_408b72
  %118 = phi i64 [ %.pre1, %block_408b72 ], [ %246, %block_408b8c ]
...
block_.L_408bb3:                                  ; preds = %block_.L_408b80
  ...
  %call2_408bb9 = tail call %struct.Memory* @sub_40eef0._Z26check_shifted_variable_sumIj19custom_variable_andIjEEvT_S2_(%struct.State* %0, i64 %257, %struct.Memory* %MEMORY.1)
...
block_.L_408bcc:                                  ; preds = %block_.L_408b62
  ...
  %call2_408bcc = tail call %struct.Memory* @sub_400e30._Z5timerv(%struct.State* %0, i64 %294, %struct.Memory* %MEMORY.0)
  ...
  %call2_408bd5 = tail call %struct.Memory* @sub_4007d0._Z13record_resultdPKc(%struct.State* %0, i64 %305, %struct.Memory* %call2_408bcc)
