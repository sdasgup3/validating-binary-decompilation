...
declare %struct.Memory* @sub_40ef00._ZN19custom_variable_andIjE8do_shiftEjj(%struct.State* dereferenceable(3376), i64, %struct.Memory*) local_unnamed_addr

declare %struct.Memory* @sub_40ef20._Z26check_shifted_variable_sumIj19custom_variable_andIjEEvT_S2_(%struct.State* dereferenceable(3376), i64, %struct.Memory*) local_unnamed_addr
...
block_.L_408b92:                                  ; preds = %block_.L_408be3, %entry
  %75 = phi i64 [ %.pre, %entry ], [ %293, %block_.L_408be3 ]
  %MEMORY.0 = phi %struct.Memory* [ %call2_408b86, %entry ], [ %call2_408be9, %block_.L_408be3 ]
...
block_.L_408bb0:                                  ; preds = %block_408bbc, %block_408ba2
  %118 = phi i64 [ %.pre6, %block_408ba2 ], [ %246, %block_408bbc ]
  %MEMORY.1 = phi %struct.Memory* [ %MEMORY.0, %block_408ba2 ], [ %call2_408bca, %block_408bbc ]
...
block_408bbc:                                     ; preds = %block_.L_408bb0
  ...
  %call2_408bca = tail call %struct.Memory* @sub_40ef00._ZN19custom_variable_andIjE8do_shiftEjj(%struct.State* nonnull %0, i64 %174, %struct.Memory* %MEMORY.1)
...
block_.L_408be3:                                  ; preds = %block_.L_408bb0
  ...
  %call2_408be9 = tail call %struct.Memory* @sub_40ef20._Z26check_shifted_variable_sumIj19custom_variable_andIjEEvT_S2_(%struct.State* nonnull %0, i64 %257, %struct.Memory* %MEMORY.1)
...
block_.L_408bfc:                                  ; preds = %block_.L_408b92
  ...
  %call2_408bfc = tail call %struct.Memory* @sub_400e70._Z5timerv(%struct.State* nonnull %0, i64 %294, %struct.Memory* %MEMORY.0)
