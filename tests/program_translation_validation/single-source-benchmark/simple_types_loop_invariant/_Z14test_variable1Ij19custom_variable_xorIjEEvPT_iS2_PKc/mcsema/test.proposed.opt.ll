...
declare %struct.Memory* @sub_40ec80._ZN19custom_variable_xorIjE8do_shiftEjj(%struct.State* dereferenceable(3376), i64, %struct.Memory*) local_unnamed_addr

declare %struct.Memory* @sub_40eca0._Z26check_shifted_variable_sumIj19custom_variable_xorIjEEvT_S2_(%struct.State* dereferenceable(3376), i64, %struct.Memory*) local_unnamed_addr
...
define %struct.Memory* @_Z14test_variable1Ij19custom_variable_xorIjEEvPT_iS2_PKc(%struct.State* noalias, i64, %struct.Memory* noalias) local_unnamed_addr #1 {
entry:
...
block_.L_408e72:                                  ; preds = %block_.L_408ec3, %entry
  %75 = phi i64 [ %.pre, %entry ], [ %293, %block_.L_408ec3 ]
  %MEMORY.0 = phi %struct.Memory* [ %call2_408e66, %entry ], [ %call2_408ec9, %block_.L_408ec3 ]
...
block_.L_408e90:                                  ; preds = %block_408e9c, %block_408e82
  %118 = phi i64 [ %.pre6, %block_408e82 ], [ %246, %block_408e9c ]
  %MEMORY.1 = phi %struct.Memory* [ %MEMORY.0, %block_408e82 ], [ %call2_408eaa, %block_408e9c ]
...
block_408e9c:                                     ; preds = %block_.L_408e90
  ...
  %call2_408eaa = tail call %struct.Memory* @sub_40ec80._ZN19custom_variable_xorIjE8do_shiftEjj(%struct.State* nonnull %0, i64 %174, %struct.Memory* %MEMORY.1)
...
block_.L_408ec3:                                  ; preds = %block_.L_408e90
  ...
  %call2_408ec9 = tail call %struct.Memory* @sub_40eca0._Z26check_shifted_variable_sumIj19custom_variable_xorIjEEvT_S2_(%struct.State* nonnull %0, i64 %257, %struct.Memory* %MEMORY.1)
...
block_.L_408edc:                                  ; preds = %block_.L_408e72
  ...
  %call2_408edc = tail call %struct.Memory* @sub_400e70._Z5timerv(%struct.State* nonnull %0, i64 %294, %struct.Memory* %MEMORY.0)
