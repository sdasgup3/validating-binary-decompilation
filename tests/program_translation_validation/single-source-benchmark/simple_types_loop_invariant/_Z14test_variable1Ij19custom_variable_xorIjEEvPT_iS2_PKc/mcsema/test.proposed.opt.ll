...
block_.L_408e42:                                  ; preds = %block_.L_408e93, %entry
  %75 = phi i64 [ %.pre, %entry ], [ %293, %block_.L_408e93 ]
...
block_.L_408e60:                                  ; preds = %block_408e6c, %block_408e52
  %118 = phi i64 [ %.pre1, %block_408e52 ], [ %246, %block_408e6c ]
...
block_.L_408e93:                                  ; preds = %block_.L_408e60
  ...
  %call2_408e99 = tail call %struct.Memory* @sub_40ec70._Z26check_shifted_variable_sumIj19custom_variable_xorIjEEvT_S2_(%struct.State* %0, i64 %257, %struct.Memory* %MEMORY.1)
...
block_.L_408eac:                                  ; preds = %block_.L_408e42
  ...
  %call2_408eac = tail call %struct.Memory* @sub_400e30._Z5timerv(%struct.State* %0, i64 %294, %struct.Memory* %MEMORY.0)
  ...
  %call2_408eb5 = tail call %struct.Memory* @sub_4007d0._Z13record_resultdPKc(%struct.State* %0, i64 %305, %struct.Memory* %call2_408eac)
