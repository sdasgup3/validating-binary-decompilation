...
declare %struct.Memory* @sub_40f1c0._ZN22custom_divide_variableIjE8do_shiftEjj(%struct.State* noalias dereferenceable(3376), i64, %struct.Memory* noalias)

declare %struct.Memory* @sub_40f1e0._Z26check_shifted_variable_sumIj22custom_divide_variableIjEEvT_S2_(%struct.State* noalias dereferenceable(3376), i64, %struct.Memory* noalias)
