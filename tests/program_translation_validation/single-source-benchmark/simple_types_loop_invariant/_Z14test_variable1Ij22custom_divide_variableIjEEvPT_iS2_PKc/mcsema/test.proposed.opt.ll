...
declare %struct.Memory* @sub_40f1c0._ZN22custom_divide_variableIjE8do_shiftEjj(%struct.State* noalias dereferenceable(3376), i64, %struct.Memory* noalias readnone returned) local_unnamed_addr

declare %struct.Memory* @sub_40f1e0._Z26check_shifted_variable_sumIj22custom_divide_variableIjEEvT_S2_(%struct.State* noalias dereferenceable(3376), i64, %struct.Memory* noalias readnone returned) local_unnamed_addr
...
define %struct.Memory* @_Z14test_variable1Ij22custom_divide_variableIjEEvPT_iS2_PKc(%struct.State* noalias, i64, %struct.Memory* noalias readnone) local_unnamed_addr #1 {
entry:
...
block_.L_408882:                                  ; preds = %block_.L_4088d3, %entry
  %75 = phi i64 [ %293, %block_.L_4088d3 ], [ %.pre, %entry ]
...
block_.L_4088a0:                                  ; preds = %block_4088ac, %block_408892
  %118 = phi i64 [ %246, %block_4088ac ], [ %.pre6, %block_408892 ]
...
block_4088ac:                                     ; preds = %block_.L_4088a0
  ...
  %call2_4088ba = tail call %struct.Memory* @sub_40f1c0._ZN22custom_divide_variableIjE8do_shiftEjj(%struct.State* nonnull %0, i64 %174, %struct.Memory* %call2_408876)
...
block_.L_4088d3:                                  ; preds = %block_.L_4088a0
  ...
  %call2_4088d9 = tail call %struct.Memory* @sub_40f1e0._Z26check_shifted_variable_sumIj22custom_divide_variableIjEEvT_S2_(%struct.State* nonnull %0, i64 %257, %struct.Memory* %call2_408876)
...
block_.L_4088ec:                                  ; preds = %block_.L_408882
  ...
  %call2_4088ec = tail call %struct.Memory* @sub_400e70._Z5timerv(%struct.State* nonnull %0, i64 %294, %struct.Memory* %call2_408876)
