...
declare %struct.Memory* @sub_40f1b0._Z26check_shifted_variable_sumIj22custom_divide_variableIjEEvT_S2_(%struct.State* noalias dereferenceable(3376), i64, %struct.Memory* noalias readnone returned) local_unnamed_addr
...
entry:
  ...
  %call2_408846 = tail call %struct.Memory* @sub_400e10._Z11start_timerv(%struct.State* %0, i64 %65, %struct.Memory* %2)
...
block_.L_408852:                                  ; preds = %block_.L_4088a3, %entry
  %75 = phi i64 [ %.pre, %entry ], [ %295, %block_.L_4088a3 ]
  %MEMORY.0 = phi %struct.Memory* [ %call2_408846, %entry ], [ %call2_4088a9, %block_.L_4088a3 ]
  ...
  br i1 %108, label %block_408862, label %block_.L_4088bc
...
block_.L_408870:                                  ; preds = %block_40887c, %block_408862
  %118 = phi i64 [ %.pre1, %block_408862 ], [ %247, %block_40887c ]
  %MEMORY.1 = phi %struct.Memory* [ %MEMORY.0, %block_408862 ], [ %call2_40888a, %block_40887c ]
  ...
  br i1 %154, label %block_40887c, label %block_.L_4088a3
...
block_40887c:                                     ; preds = %block_.L_408870
  ...
  %call2_40888a = tail call %struct.Memory* @sub_40f190._ZN22custom_divide_variableIjE8do_shiftEjj(%struct.State* %0, i64 %174, %struct.Memory* %MEMORY.1)
...
block_.L_4088a3:                                  ; preds = %block_.L_408870
  ...
  %call2_4088a9 = tail call %struct.Memory* @sub_40f1b0._Z26check_shifted_variable_sumIj22custom_divide_variableIjEEvT_S2_(%struct.State* %0, i64 %258, %struct.Memory* %MEMORY.1)
...
block_.L_4088bc:                                  ; preds = %block_.L_408852
  ...
  %call2_4088bc = tail call %struct.Memory* @sub_400e30._Z5timerv(%struct.State* %0, i64 %296, %struct.Memory* %MEMORY.0)
  ...
  %call2_4088c5 = tail call %struct.Memory* @sub_4007d0._Z13record_resultdPKc(%struct.State* %0, i64 %307, %struct.Memory* %call2_4088bc)
  ...
  ret %struct.Memory* %call2_4088c5
}
...
define %struct.Memory* @routine_jge_.L_4088bc(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i8* %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
...
define %struct.Memory* @routine_jge_.L_4088a3(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i8* %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 2, i32 9
...
define %struct.Memory* @routine_jmpq_.L_408870(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
...
define %struct.Memory* @routine_callq_._Z26check_shifted_variable_sumIj22custom_divide_variableIjEEvT_S2_(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
...
define %struct.Memory* @routine_jmpq_.L_408852(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
