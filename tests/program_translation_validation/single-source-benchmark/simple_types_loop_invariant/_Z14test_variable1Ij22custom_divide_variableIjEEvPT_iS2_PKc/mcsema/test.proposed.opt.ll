...
block_.L_408852:                                  ; preds = %block_.L_4088a3, %entry
  %75 = phi i64 [ %.pre, %entry ], [ %293, %block_.L_4088a3 ]
...
block_.L_408870:                                  ; preds = %block_40887c, %block_408862
  %118 = phi i64 [ %.pre1, %block_408862 ], [ %246, %block_40887c ]
...
block_.L_4088a3:                                  ; preds = %block_.L_408870
  ...
  %call2_4088a9 = tail call %struct.Memory* @sub_40f1b0._Z26check_shifted_variable_sumIj22custom_divide_variableIjEEvT_S2_(%struct.State* %0, i64 %257, %struct.Memory* %MEMORY.1)
...
block_.L_4088bc:                                  ; preds = %block_.L_408852
  ...
  %call2_4088bc = tail call %struct.Memory* @sub_400e30._Z5timerv(%struct.State* %0, i64 %294, %struct.Memory* %MEMORY.0)
  ...
  %call2_4088c5 = tail call %struct.Memory* @sub_4007d0._Z13record_resultdPKc(%struct.State* %0, i64 %305, %struct.Memory* %call2_4088bc)
