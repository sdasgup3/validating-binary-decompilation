...
declare %struct.Memory* @sub_40f3b0._ZN24custom_multiply_variableIjE8do_shiftEjj(%struct.State* dereferenceable(3376), i64, %struct.Memory*) local_unnamed_addr

declare %struct.Memory* @sub_40f3d0._Z26check_shifted_variable_sumIj24custom_multiply_variableIjEEvT_S2_(%struct.State* dereferenceable(3376), i64, %struct.Memory*) local_unnamed_addr
...
define %struct.Memory* @_Z14test_variable1Ij24custom_multiply_variableIjEEvPT_iS2_PKc(%struct.State* noalias, i64, %struct.Memory* noalias) local_unnamed_addr #1 {
entry:
...
block_.L_408642:                                  ; preds = %block_.L_408693, %entry
  %75 = phi i64 [ %.pre, %entry ], [ %293, %block_.L_408693 ]
  %MEMORY.0 = phi %struct.Memory* [ %call2_408636, %entry ], [ %call2_408699, %block_.L_408693 ]
...
block_.L_408660:                                  ; preds = %block_40866c, %block_408652
  %118 = phi i64 [ %.pre6, %block_408652 ], [ %246, %block_40866c ]
  %MEMORY.1 = phi %struct.Memory* [ %MEMORY.0, %block_408652 ], [ %call2_40867a, %block_40866c ]
...
block_40866c:                                     ; preds = %block_.L_408660
  ...
  %call2_40867a = tail call %struct.Memory* @sub_40f3b0._ZN24custom_multiply_variableIjE8do_shiftEjj(%struct.State* nonnull %0, i64 %174, %struct.Memory* %MEMORY.1)
...
block_.L_408693:                                  ; preds = %block_.L_408660
  ...
  %call2_408699 = tail call %struct.Memory* @sub_40f3d0._Z26check_shifted_variable_sumIj24custom_multiply_variableIjEEvT_S2_(%struct.State* nonnull %0, i64 %257, %struct.Memory* %MEMORY.1)
...
block_.L_4086ac:                                  ; preds = %block_.L_408642
  ...
  %call2_4086ac = tail call %struct.Memory* @sub_400e70._Z5timerv(%struct.State* nonnull %0, i64 %294, %struct.Memory* %MEMORY.0)
