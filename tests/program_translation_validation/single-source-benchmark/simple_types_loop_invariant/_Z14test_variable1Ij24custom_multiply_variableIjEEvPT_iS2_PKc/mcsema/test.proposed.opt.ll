...
block_.L_408612:                                  ; preds = %block_.L_408663, %entry
  %75 = phi i64 [ %.pre, %entry ], [ %293, %block_.L_408663 ]
...
block_.L_408630:                                  ; preds = %block_40863c, %block_408622
  %118 = phi i64 [ %.pre1, %block_408622 ], [ %246, %block_40863c ]
...
block_.L_408663:                                  ; preds = %block_.L_408630
  ...
  %call2_408669 = tail call %struct.Memory* @sub_40f3a0._Z26check_shifted_variable_sumIj24custom_multiply_variableIjEEvT_S2_(%struct.State* %0, i64 %257, %struct.Memory* %MEMORY.1)
...
block_.L_40867c:                                  ; preds = %block_.L_408612
  ...
  %call2_40867c = tail call %struct.Memory* @sub_400e30._Z5timerv(%struct.State* %0, i64 %294, %struct.Memory* %MEMORY.0)
  ...
  %call2_408685 = tail call %struct.Memory* @sub_4007d0._Z13record_resultdPKc(%struct.State* %0, i64 %305, %struct.Memory* %call2_40867c)
