...
declare %struct.Memory* @sub_40e240._ZN18custom_variable_orIlE8do_shiftEll(%struct.State* dereferenceable(3376), i64, %struct.Memory*) local_unnamed_addr

declare %struct.Memory* @sub_40e260._Z26check_shifted_variable_sumIl18custom_variable_orIlEEvT_S2_(%struct.State* dereferenceable(3376), i64, %struct.Memory*) local_unnamed_addr
...
entry:
  ...
  %call2_409ab7 = tail call %struct.Memory* @sub_400e50._Z11start_timerv(%struct.State* %0, i64 %63, %struct.Memory* %2)
  ...
  br label %block_.L_409ac3

block_.L_409ac3:                                  ; preds = %block_.L_409b19, %entry
  %73 = phi i64 [ %.pre, %entry ], [ %286, %block_.L_409b19 ]
  %MEMORY.0 = phi %struct.Memory* [ %call2_409ab7, %entry ], [ %call2_409b21, %block_.L_409b19 ]
  ...
  br i1 %106, label %block_409ad3, label %block_.L_409b34

block_409ad3:                                     ; preds = %block_.L_409ac3
  %108 = add i64 %74, -48
  %109 = add i64 %107, 8
  ...
  br label %block_.L_409ae2

block_.L_409ae2:                                  ; preds = %block_409aee, %block_409ad3
  %116 = phi i64 [ %.pre6, %block_409ad3 ], [ %241, %block_409aee ]
  %MEMORY.1 = phi %struct.Memory* [ %MEMORY.0, %block_409ad3 ], [ %call2_409afe, %block_409aee ]
  ...
  br i1 %152, label %block_409aee, label %block_.L_409b19

block_409aee:                                     ; preds = %block_.L_409ae2
  %154 = add i64 %117, -8
  %155 = add i64 %153, 4
  ...
  %call2_409afe = tail call %struct.Memory* @sub_40e240._ZN18custom_variable_orIlE8do_shiftEll(%struct.State* nonnull %0, i64 %170, %struct.Memory* %MEMORY.1)
...
block_.L_409b19:                                  ; preds = %block_.L_409ae2
  %242 = add i64 %117, -48
  %243 = add i64 %153, 4
  ...
  %call2_409b21 = tail call %struct.Memory* @sub_40e260._Z26check_shifted_variable_sumIl18custom_variable_orIlEEvT_S2_(%struct.State* nonnull %0, i64 %250, %struct.Memory* %MEMORY.1)
...
block_.L_409b34:                                  ; preds = %block_.L_409ac3
  ...
  %call2_409b34 = tail call %struct.Memory* @sub_400e70._Z5timerv(%struct.State* nonnull %0, i64 %287, %struct.Memory* %MEMORY.0)
  ...
  %call2_409b3d = tail call %struct.Memory* @sub_400810._Z13record_resultdPKc(%struct.State* nonnull %0, i64 %298, %struct.Memory* %call2_409b34)
  ...
  ret %struct.Memory* %call2_409b3d
}
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_jge_.L_409b34(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i8* nocapture %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_jmpq_.L_409ae2(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_jmpq_.L_409ac3(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
