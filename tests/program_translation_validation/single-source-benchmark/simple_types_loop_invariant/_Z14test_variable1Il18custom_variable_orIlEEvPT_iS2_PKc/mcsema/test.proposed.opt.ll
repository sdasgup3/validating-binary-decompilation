...
block_.L_409a93:                                  ; preds = %block_.L_409ae9, %entry
  %73 = phi i64 [ %.pre, %entry ], [ %288, %block_.L_409ae9 ]
...
block_.L_409ab2:                                  ; preds = %block_409abe, %block_409aa3
  %116 = phi i64 [ %.pre1, %block_409aa3 ], [ %242, %block_409abe ]
...
block_.L_409ae9:                                  ; preds = %block_.L_409ab2
  ...
  %call2_409af1 = tail call %struct.Memory* @sub_40e230._Z26check_shifted_variable_sumIl18custom_variable_orIlEEvT_S2_(%struct.State* %0, i64 %251, %struct.Memory* %MEMORY.1)
...
block_.L_409b04:                                  ; preds = %block_.L_409a93
  ...
  %call2_409b04 = tail call %struct.Memory* @sub_400e30._Z5timerv(%struct.State* %0, i64 %289, %struct.Memory* %MEMORY.0)
  ...
  %call2_409b0d = tail call %struct.Memory* @sub_4007d0._Z13record_resultdPKc(%struct.State* %0, i64 %300, %struct.Memory* %call2_409b04)
