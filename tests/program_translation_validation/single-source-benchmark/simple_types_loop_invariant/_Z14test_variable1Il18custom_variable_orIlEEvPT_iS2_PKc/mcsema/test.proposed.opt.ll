...
declare %struct.Memory* @sub_40e240._ZN18custom_variable_orIlE8do_shiftEll(%struct.State* noalias dereferenceable(3376), i64, %struct.Memory* noalias readnone returned) local_unnamed_addr

declare %struct.Memory* @sub_40e260._Z26check_shifted_variable_sumIl18custom_variable_orIlEEvT_S2_(%struct.State* noalias dereferenceable(3376), i64, %struct.Memory* noalias readnone returned) local_unnamed_addr
...
block_.L_409ac3:                                  ; preds = %block_.L_409b19, %entry
  %73 = phi i64 [ %286, %block_.L_409b19 ], [ %.pre, %entry ]
...
block_.L_409ae2:                                  ; preds = %block_409aee, %block_409ad3
  %116 = phi i64 [ %241, %block_409aee ], [ %.pre6, %block_409ad3 ]
...
block_409aee:                                     ; preds = %block_.L_409ae2
  ...
  %call2_409afe = tail call %struct.Memory* @sub_40e240._ZN18custom_variable_orIlE8do_shiftEll(%struct.State* nonnull %0, i64 %170, %struct.Memory* %call2_409ab7)
...
block_.L_409b19:                                  ; preds = %block_.L_409ae2
  ...
  %call2_409b21 = tail call %struct.Memory* @sub_40e260._Z26check_shifted_variable_sumIl18custom_variable_orIlEEvT_S2_(%struct.State* nonnull %0, i64 %250, %struct.Memory* %call2_409ab7)
...
block_.L_409b34:                                  ; preds = %block_.L_409ac3
  ...
  %call2_409b34 = tail call %struct.Memory* @sub_400e70._Z5timerv(%struct.State* nonnull %0, i64 %287, %struct.Memory* %call2_409ab7)
