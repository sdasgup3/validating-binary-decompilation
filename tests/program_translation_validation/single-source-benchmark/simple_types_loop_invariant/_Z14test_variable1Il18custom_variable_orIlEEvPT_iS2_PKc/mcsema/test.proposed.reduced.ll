; ModuleID = '/tmp/tmptq96v39b-query.ll'
...
define %struct.Memory* @_Z14test_variable1Il18custom_variable_orIlEEvPT_iS2_PKc(%struct.State* noalias, i64, %struct.Memory* noalias readnone returned) local_unnamed_addr #1 {
entry:
  %var_2_3 = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %RBP.i = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 15, i32 0, i32 0
  %var_2_62 = load i64, i64* %var_2_3, align 8
  %var_2_63 = add i64 %var_2_62, -35943
  %call2_409ac7 = tail call %struct.Memory* @sub_400e60._Z11start_timerv(%struct.State* %0, i64 %var_2_63, %struct.Memory* %2)
  ...
  br i1 %var_2_10615, label %block_409ae3.preheader, label %block_.L_409b44

block_409ae3.preheader:                           ; preds = %entry
  ...
  br i1 %var_2_152, label %block_.L_409af2.preheader, label %block_409ae3.preheader5

block_409ae3.preheader5:                          ; preds = %block_409ae3.preheader
  br label %block_409ae3

block_.L_409af2.preheader:                        ; preds = %block_409ae3.preheader
  br label %block_.L_409af2

block_409ae3:                                     ; preds = %block_409ae3.preheader5, %block_409ae3
  br label %block_409ae3

block_.L_409af2:                                  ; preds = %block_.L_409af2.preheader, %block_.L_409af2
  br label %block_.L_409af2

block_.L_409b44:                                  ; preds = %entry
  %.pre = load i64, i64* %var_2_3, align 8
  %var_2_287 = add i64 %.pre, -35923
  %call2_409b44 = tail call %struct.Memory* @sub_400e80._Z5timerv(%struct.State* nonnull %0, i64 %var_2_287, %struct.Memory* %call2_409ac7)
  %var_2_294 = load i64, i64* %var_2_3, align 8
  %var_2_298 = add i64 %var_2_294, -37673
  %call2_409b4d = tail call %struct.Memory* @sub_400820._Z13record_resultdPKc(%struct.State* nonnull %0, i64 %var_2_298, %struct.Memory* %call2_409b44)
