; ModuleID = '/tmp/tmpi5k72x2f-query.ll'
...
define %struct.Memory* @_Z14test_variable1Il18custom_variable_orIlEEvPT_iS2_PKc(%struct.State* noalias nocapture readonly, i64, %struct.Memory* noalias readnone returned) local_unnamed_addr #1 {
entry:
