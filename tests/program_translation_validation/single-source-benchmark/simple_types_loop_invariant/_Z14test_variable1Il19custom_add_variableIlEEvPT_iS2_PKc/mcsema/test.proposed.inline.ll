...
define %struct.Memory* @_Z14test_variable1Il19custom_add_variableIlEEvPT_iS2_PKc(%struct.State* noalias, i64, %struct.Memory* noalias) #1 {
entry:
  ...
  store %struct.Memory* %loadMem_409013, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem1_409017, %struct.Memory** %MEMORY
  ...
  store i32 0, i32* %152
  store %struct.Memory* %loadMem_40901c, %struct.Memory** %MEMORY
  br label %block_.L_409023

block_.L_409023:                                  ; preds = %block_.L_409079, %entry
...
block_409033:                                     ; preds = %block_.L_409023
  ...
  store i32 0, i32* %251
  store %struct.Memory* %loadMem_40903b, %struct.Memory** %MEMORY
  br label %block_.L_409042

block_.L_409042:                                  ; preds = %block_40904e, %block_409033
...
block_40904e:                                     ; preds = %block_.L_409042
  ...
  store %struct.Memory* %loadMem_40904e, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_409056, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_40905a, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem1_40905e, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_409067, %struct.Memory** %MEMORY
...
block_.L_409079:                                  ; preds = %block_.L_409042
  ...
  store %struct.Memory* %loadMem_409079, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_40907d, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem1_409081, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_409086, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_409089, %struct.Memory** %MEMORY
...
block_.L_409094:                                  ; preds = %block_.L_409023
  ...
  store %struct.Memory* %loadMem1_409094, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem1_40909d, %struct.Memory** %MEMORY
  ...
  ret %struct.Memory* %loadMem_4090a7
}
