...
block_.L_408ff3:                                  ; preds = %block_.L_409049, %entry
  %73 = phi i64 [ %.pre, %entry ], [ %286, %block_.L_409049 ]
...
block_.L_409012:                                  ; preds = %block_40901e, %block_409003
  %116 = phi i64 [ %.pre1, %block_409003 ], [ %241, %block_40901e ]
...
block_.L_409049:                                  ; preds = %block_.L_409012
  ...
  %call2_409051 = tail call %struct.Memory* @sub_40eae0._Z26check_shifted_variable_sumIl19custom_add_variableIlEEvT_S2_(%struct.State* %0, i64 %250, %struct.Memory* %MEMORY.1)
...
block_.L_409064:                                  ; preds = %block_.L_408ff3
  ...
  %call2_409064 = tail call %struct.Memory* @sub_400e30._Z5timerv(%struct.State* %0, i64 %287, %struct.Memory* %MEMORY.0)
  ...
  %call2_40906d = tail call %struct.Memory* @sub_4007d0._Z13record_resultdPKc(%struct.State* %0, i64 %298, %struct.Memory* %call2_409064)
