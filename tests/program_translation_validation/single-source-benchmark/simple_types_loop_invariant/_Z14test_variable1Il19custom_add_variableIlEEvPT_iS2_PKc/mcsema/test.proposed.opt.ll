...
entry:
  ...
  %call2_408fe7 = tail call %struct.Memory* @sub_400e10._Z11start_timerv(%struct.State* %0, i64 %63, %struct.Memory* %2)
...
block_.L_408ff3:                                  ; preds = %block_.L_409049, %entry
  %73 = phi i64 [ %.pre, %entry ], [ %288, %block_.L_409049 ]
  %MEMORY.0 = phi %struct.Memory* [ %call2_408fe7, %entry ], [ %call2_409051, %block_.L_409049 ]
  ...
  br i1 %106, label %block_409003, label %block_.L_409064
...
block_.L_409012:                                  ; preds = %block_40901e, %block_409003
  %116 = phi i64 [ %.pre1, %block_409003 ], [ %242, %block_40901e ]
  %MEMORY.1 = phi %struct.Memory* [ %MEMORY.0, %block_409003 ], [ %call2_40902e, %block_40901e ]
  ...
  br i1 %152, label %block_40901e, label %block_.L_409049
...
block_40901e:                                     ; preds = %block_.L_409012
  ...
  %call2_40902e = tail call %struct.Memory* @sub_40eb50._ZN19custom_add_variableIlE8do_shiftEll(%struct.State* %0, i64 %170, %struct.Memory* %MEMORY.1)
...
block_.L_409049:                                  ; preds = %block_.L_409012
  ...
  %call2_409051 = tail call %struct.Memory* @sub_40eae0._Z26check_shifted_variable_sumIl19custom_add_variableIlEEvT_S2_(%struct.State* %0, i64 %251, %struct.Memory* %MEMORY.1)
...
block_.L_409064:                                  ; preds = %block_.L_408ff3
  ...
  %call2_409064 = tail call %struct.Memory* @sub_400e30._Z5timerv(%struct.State* %0, i64 %289, %struct.Memory* %MEMORY.0)
  ...
  %call2_40906d = tail call %struct.Memory* @sub_4007d0._Z13record_resultdPKc(%struct.State* %0, i64 %300, %struct.Memory* %call2_409064)
  ...
  ret %struct.Memory* %call2_40906d
}
...
define %struct.Memory* @routine_jge_.L_409064(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i8* %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
...
define %struct.Memory* @routine_jge_.L_409049(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i8* %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 2, i32 9
...
define %struct.Memory* @routine_jmpq_.L_409012(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
...
define %struct.Memory* @routine_jmpq_.L_408ff3(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
