...
declare %struct.Memory* @sub_40e9c0._ZN19custom_sub_variableIlE8do_shiftEll(%struct.State* dereferenceable(3376), i64, %struct.Memory*) local_unnamed_addr

declare %struct.Memory* @sub_40e9e0._Z26check_shifted_variable_sumIl19custom_sub_variableIlEEvT_S2_(%struct.State* dereferenceable(3376), i64, %struct.Memory*) local_unnamed_addr
...
define %struct.Memory* @_Z14test_variable1Il19custom_sub_variableIlEEvPT_iS2_PKc(%struct.State* noalias, i64, %struct.Memory* noalias) local_unnamed_addr #1 {
entry:
...
block_.L_409253:                                  ; preds = %block_.L_4092a9, %entry
  %73 = phi i64 [ %.pre, %entry ], [ %286, %block_.L_4092a9 ]
  %MEMORY.0 = phi %struct.Memory* [ %call2_409247, %entry ], [ %call2_4092b1, %block_.L_4092a9 ]
...
block_.L_409272:                                  ; preds = %block_40927e, %block_409263
  %116 = phi i64 [ %.pre6, %block_409263 ], [ %241, %block_40927e ]
  %MEMORY.1 = phi %struct.Memory* [ %MEMORY.0, %block_409263 ], [ %call2_40928e, %block_40927e ]
...
block_40927e:                                     ; preds = %block_.L_409272
  ...
  %call2_40928e = tail call %struct.Memory* @sub_40e9c0._ZN19custom_sub_variableIlE8do_shiftEll(%struct.State* nonnull %0, i64 %170, %struct.Memory* %MEMORY.1)
...
block_.L_4092a9:                                  ; preds = %block_.L_409272
  ...
  %call2_4092b1 = tail call %struct.Memory* @sub_40e9e0._Z26check_shifted_variable_sumIl19custom_sub_variableIlEEvT_S2_(%struct.State* nonnull %0, i64 %250, %struct.Memory* %MEMORY.1)
...
block_.L_4092c4:                                  ; preds = %block_.L_409253
  ...
  %call2_4092c4 = tail call %struct.Memory* @sub_400e70._Z5timerv(%struct.State* nonnull %0, i64 %287, %struct.Memory* %MEMORY.0)
