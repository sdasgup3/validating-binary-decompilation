...
block_.L_409223:                                  ; preds = %block_.L_409279, %entry
  %73 = phi i64 [ %.pre, %entry ], [ %288, %block_.L_409279 ]
...
block_.L_409242:                                  ; preds = %block_40924e, %block_409233
  %116 = phi i64 [ %.pre1, %block_409233 ], [ %242, %block_40924e ]
...
block_.L_409279:                                  ; preds = %block_.L_409242
  ...
  %call2_409281 = tail call %struct.Memory* @sub_40e9b0._Z26check_shifted_variable_sumIl19custom_sub_variableIlEEvT_S2_(%struct.State* %0, i64 %251, %struct.Memory* %MEMORY.1)
...
block_.L_409294:                                  ; preds = %block_.L_409223
  ...
  %call2_409294 = tail call %struct.Memory* @sub_400e30._Z5timerv(%struct.State* %0, i64 %289, %struct.Memory* %MEMORY.0)
  ...
  %call2_40929d = tail call %struct.Memory* @sub_4007d0._Z13record_resultdPKc(%struct.State* %0, i64 %300, %struct.Memory* %call2_409294)
