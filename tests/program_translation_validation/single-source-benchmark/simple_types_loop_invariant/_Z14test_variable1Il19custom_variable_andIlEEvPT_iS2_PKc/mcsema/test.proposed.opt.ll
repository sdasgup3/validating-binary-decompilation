...
declare %struct.Memory* @sub_40e380._Z26check_shifted_variable_sumIl19custom_variable_andIlEEvT_S2_(%struct.State* noalias dereferenceable(3376), i64, %struct.Memory* noalias readnone returned) local_unnamed_addr
...
entry:
  ...
  %call2_409907 = tail call %struct.Memory* @sub_400e10._Z11start_timerv(%struct.State* %0, i64 %63, %struct.Memory* %2)
...
block_.L_409913:                                  ; preds = %block_.L_409969, %entry
  %73 = phi i64 [ %.pre, %entry ], [ %286, %block_.L_409969 ]
  %MEMORY.0 = phi %struct.Memory* [ %call2_409907, %entry ], [ %call2_409971, %block_.L_409969 ]
  ...
  br i1 %106, label %block_409923, label %block_.L_409984
...
block_.L_409932:                                  ; preds = %block_40993e, %block_409923
  %116 = phi i64 [ %.pre1, %block_409923 ], [ %241, %block_40993e ]
  %MEMORY.1 = phi %struct.Memory* [ %MEMORY.0, %block_409923 ], [ %call2_40994e, %block_40993e ]
  ...
  br i1 %152, label %block_40993e, label %block_.L_409969
...
block_40993e:                                     ; preds = %block_.L_409932
  ...
  %call2_40994e = tail call %struct.Memory* @sub_40e360._ZN19custom_variable_andIlE8do_shiftEll(%struct.State* %0, i64 %170, %struct.Memory* %MEMORY.1)
...
block_.L_409969:                                  ; preds = %block_.L_409932
  ...
  %call2_409971 = tail call %struct.Memory* @sub_40e380._Z26check_shifted_variable_sumIl19custom_variable_andIlEEvT_S2_(%struct.State* %0, i64 %250, %struct.Memory* %MEMORY.1)
...
block_.L_409984:                                  ; preds = %block_.L_409913
  ...
  %call2_409984 = tail call %struct.Memory* @sub_400e30._Z5timerv(%struct.State* %0, i64 %287, %struct.Memory* %MEMORY.0)
  ...
  %call2_40998d = tail call %struct.Memory* @sub_4007d0._Z13record_resultdPKc(%struct.State* %0, i64 %298, %struct.Memory* %call2_409984)
  ...
  ret %struct.Memory* %call2_40998d
}
...
define %struct.Memory* @routine_jge_.L_409984(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i8* %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
...
define %struct.Memory* @routine_jge_.L_409969(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i8* %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 2, i32 9
...
define %struct.Memory* @routine_jmpq_.L_409932(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
...
define %struct.Memory* @routine_callq_._Z26check_shifted_variable_sumIl19custom_variable_andIlEEvT_S2_(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
...
define %struct.Memory* @routine_jmpq_.L_409913(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
