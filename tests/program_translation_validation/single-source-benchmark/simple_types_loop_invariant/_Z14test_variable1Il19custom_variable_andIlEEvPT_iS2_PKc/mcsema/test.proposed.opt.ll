...
block_.L_409913:                                  ; preds = %block_.L_409969, %entry
  %73 = phi i64 [ %.pre, %entry ], [ %288, %block_.L_409969 ]
...
block_.L_409932:                                  ; preds = %block_40993e, %block_409923
  %116 = phi i64 [ %.pre1, %block_409923 ], [ %242, %block_40993e ]
...
block_.L_409969:                                  ; preds = %block_.L_409932
  ...
  %call2_409971 = tail call %struct.Memory* @sub_40e380._Z26check_shifted_variable_sumIl19custom_variable_andIlEEvT_S2_(%struct.State* %0, i64 %251, %struct.Memory* %MEMORY.1)
...
block_.L_409984:                                  ; preds = %block_.L_409913
  ...
  %call2_409984 = tail call %struct.Memory* @sub_400e30._Z5timerv(%struct.State* %0, i64 %289, %struct.Memory* %MEMORY.0)
  ...
  %call2_40998d = tail call %struct.Memory* @sub_4007d0._Z13record_resultdPKc(%struct.State* %0, i64 %300, %struct.Memory* %call2_409984)
