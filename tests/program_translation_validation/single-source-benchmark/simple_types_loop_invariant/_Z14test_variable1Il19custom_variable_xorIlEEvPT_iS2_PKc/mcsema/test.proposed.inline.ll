...
define %struct.Memory* @_Z14test_variable1Il19custom_variable_xorIlEEvPT_iS2_PKc(%struct.State* noalias, i64, %struct.Memory* noalias) #2 {
entry:
  ...
  store i32 %93, i32* %97
  store %struct.Memory* %loadMem_409bfc, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem1_409c07, %struct.Memory** %MEMORY
  ...
  store i32 0, i32* %152
  store %struct.Memory* %loadMem_409c0c, %struct.Memory** %MEMORY
  br label %block_.L_409c13

block_.L_409c13:                                  ; preds = %block_.L_409c69, %entry
...
block_409c23:                                     ; preds = %block_.L_409c13
  ...
  store i64 0, i64* %240
  store %struct.Memory* %loadMem_409c23, %struct.Memory** %MEMORY
...
block_.L_409c32:                                  ; preds = %block_409c3e, %block_409c23
...
block_409c3e:                                     ; preds = %block_.L_409c32
  ...
  store %struct.Memory* %loadMem_409c46, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_409c4a, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem1_409c4e, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_409c53, %struct.Memory** %MEMORY
...
block_.L_409c69:                                  ; preds = %block_.L_409c32
  ...
  store %struct.Memory* %loadMem1_409c71, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_409c76, %struct.Memory** %MEMORY
...
block_.L_409c84:                                  ; preds = %block_.L_409c13
  ...
  store %struct.Memory* %loadMem1_409c84, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem1_409c8d, %struct.Memory** %MEMORY
  ...
  ret %struct.Memory* %loadMem_409c97
}
