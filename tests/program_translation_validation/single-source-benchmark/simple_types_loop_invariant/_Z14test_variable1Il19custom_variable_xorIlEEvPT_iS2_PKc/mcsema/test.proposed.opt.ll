...
declare %struct.Memory* @sub_40e110._Z26check_shifted_variable_sumIl19custom_variable_xorIlEEvT_S2_(%struct.State* dereferenceable(3376), i64, %struct.Memory*) local_unnamed_addr
...
block_.L_409c43:                                  ; preds = %block_.L_409c99, %entry
  %73 = phi i64 [ %.pre, %entry ], [ %286, %block_.L_409c99 ]
  %MEMORY.0 = phi %struct.Memory* [ %call2_409c37, %entry ], [ %call2_409ca1, %block_.L_409c99 ]
...
block_.L_409c62:                                  ; preds = %block_409c6e, %block_409c53
  %116 = phi i64 [ %.pre6, %block_409c53 ], [ %241, %block_409c6e ]
  %MEMORY.1 = phi %struct.Memory* [ %MEMORY.0, %block_409c53 ], [ %call2_409c7e, %block_409c6e ]
...
block_409c6e:                                     ; preds = %block_.L_409c62
  ...
  %call2_409c7e = tail call %struct.Memory* @sub_40e0f0._ZN19custom_variable_xorIlE8do_shiftEll(%struct.State* nonnull %0, i64 %170, %struct.Memory* %MEMORY.1)
...
block_.L_409c99:                                  ; preds = %block_.L_409c62
  ...
  %call2_409ca1 = tail call %struct.Memory* @sub_40e110._Z26check_shifted_variable_sumIl19custom_variable_xorIlEEvT_S2_(%struct.State* nonnull %0, i64 %250, %struct.Memory* %MEMORY.1)
...
block_.L_409cb4:                                  ; preds = %block_.L_409c43
  ...
  %call2_409cb4 = tail call %struct.Memory* @sub_400e70._Z5timerv(%struct.State* nonnull %0, i64 %287, %struct.Memory* %MEMORY.0)
