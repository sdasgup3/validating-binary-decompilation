...
declare %struct.Memory* @sub_40e120._Z26check_shifted_variable_sumIl19custom_variable_xorIlEEvT_S2_(%struct.State* noalias dereferenceable(3376), i64, %struct.Memory* noalias readnone returned) local_unnamed_addr
...
entry:
  ...
  %call2_409c47 = tail call %struct.Memory* @sub_400e60._Z11start_timerv(%struct.State* %0, i64 %63, %struct.Memory* %2)
...
block_.L_409c53:                                  ; preds = %block_.L_409ca9, %entry
  %73 = phi i64 [ %286, %block_.L_409ca9 ], [ %.pre, %entry ]
  ...
  br i1 %106, label %block_409c63, label %block_.L_409cc4
...
block_.L_409c72:                                  ; preds = %block_409c7e, %block_409c63
  %116 = phi i64 [ %241, %block_409c7e ], [ %.pre6, %block_409c63 ]
  ...
  br i1 %152, label %block_409c7e, label %block_.L_409ca9
...
block_409c7e:                                     ; preds = %block_.L_409c72
  ...
  %call2_409c8e = tail call %struct.Memory* @sub_40e100._ZN19custom_variable_xorIlE8do_shiftEll(%struct.State* nonnull %0, i64 %170, %struct.Memory* %call2_409c47)
...
block_.L_409ca9:                                  ; preds = %block_.L_409c72
  ...
  %call2_409cb1 = tail call %struct.Memory* @sub_40e120._Z26check_shifted_variable_sumIl19custom_variable_xorIlEEvT_S2_(%struct.State* nonnull %0, i64 %250, %struct.Memory* %call2_409c47)
...
block_.L_409cc4:                                  ; preds = %block_.L_409c53
  ...
  %call2_409cc4 = tail call %struct.Memory* @sub_400e80._Z5timerv(%struct.State* nonnull %0, i64 %287, %struct.Memory* %call2_409c47)
  ...
  %call2_409ccd = tail call %struct.Memory* @sub_400820._Z13record_resultdPKc(%struct.State* nonnull %0, i64 %298, %struct.Memory* %call2_409cc4)
