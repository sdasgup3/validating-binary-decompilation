...
declare %struct.Memory* @sub_40e0e0._Z26check_shifted_variable_sumIl19custom_variable_xorIlEEvT_S2_(%struct.State* noalias dereferenceable(3376), i64, %struct.Memory* noalias readnone returned) local_unnamed_addr
...
define %struct.Memory* @_Z14test_variable1Il19custom_variable_xorIlEEvPT_iS2_PKc(%struct.State* noalias, i64, %struct.Memory* noalias) local_unnamed_addr #1 {
entry:
  ...
  %call2_409c07 = tail call %struct.Memory* @sub_400e10._Z11start_timerv(%struct.State* %0, i64 %63, %struct.Memory* %2)
...
block_.L_409c13:                                  ; preds = %block_.L_409c69, %entry
  %73 = phi i64 [ %.pre, %entry ], [ %288, %block_.L_409c69 ]
  %MEMORY.0 = phi %struct.Memory* [ %call2_409c07, %entry ], [ %call2_409c71, %block_.L_409c69 ]
  ...
  br i1 %106, label %block_409c23, label %block_.L_409c84
...
block_.L_409c32:                                  ; preds = %block_409c3e, %block_409c23
  %116 = phi i64 [ %.pre1, %block_409c23 ], [ %242, %block_409c3e ]
  %MEMORY.1 = phi %struct.Memory* [ %MEMORY.0, %block_409c23 ], [ %call2_409c4e, %block_409c3e ]
  ...
  br i1 %152, label %block_409c3e, label %block_.L_409c69
...
block_409c3e:                                     ; preds = %block_.L_409c32
  ...
  %call2_409c4e = tail call %struct.Memory* @sub_40e0c0._ZN19custom_variable_xorIlE8do_shiftEll(%struct.State* %0, i64 %170, %struct.Memory* %MEMORY.1)
...
block_.L_409c69:                                  ; preds = %block_.L_409c32
  ...
  %call2_409c71 = tail call %struct.Memory* @sub_40e0e0._Z26check_shifted_variable_sumIl19custom_variable_xorIlEEvT_S2_(%struct.State* %0, i64 %251, %struct.Memory* %MEMORY.1)
...
block_.L_409c84:                                  ; preds = %block_.L_409c13
  ...
  %call2_409c84 = tail call %struct.Memory* @sub_400e30._Z5timerv(%struct.State* %0, i64 %289, %struct.Memory* %MEMORY.0)
  ...
  %call2_409c8d = tail call %struct.Memory* @sub_4007d0._Z13record_resultdPKc(%struct.State* %0, i64 %300, %struct.Memory* %call2_409c84)
  ...
  ret %struct.Memory* %call2_409c8d
}
...
define %struct.Memory* @routine_jge_.L_409c84(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i8* %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
...
define %struct.Memory* @routine_jge_.L_409c69(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i8* %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 2, i32 9
...
define %struct.Memory* @routine_jmpq_.L_409c32(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
...
define %struct.Memory* @routine_callq_._Z26check_shifted_variable_sumIl19custom_variable_xorIlEEvT_S2_(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
...
define %struct.Memory* @routine_jmpq_.L_409c13(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
