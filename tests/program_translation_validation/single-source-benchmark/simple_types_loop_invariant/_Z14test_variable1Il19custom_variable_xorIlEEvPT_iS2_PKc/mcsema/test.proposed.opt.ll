...
block_.L_409c13:                                  ; preds = %block_.L_409c69, %entry
  %73 = phi i64 [ %.pre, %entry ], [ %286, %block_.L_409c69 ]
...
block_.L_409c32:                                  ; preds = %block_409c3e, %block_409c23
  %116 = phi i64 [ %.pre1, %block_409c23 ], [ %241, %block_409c3e ]
...
block_.L_409c69:                                  ; preds = %block_.L_409c32
  ...
  %call2_409c71 = tail call %struct.Memory* @sub_40e0e0._Z26check_shifted_variable_sumIl19custom_variable_xorIlEEvT_S2_(%struct.State* %0, i64 %250, %struct.Memory* %MEMORY.1)
...
block_.L_409c84:                                  ; preds = %block_.L_409c13
  ...
  %call2_409c84 = tail call %struct.Memory* @sub_400e30._Z5timerv(%struct.State* %0, i64 %287, %struct.Memory* %MEMORY.0)
  ...
  %call2_409c8d = tail call %struct.Memory* @sub_4007d0._Z13record_resultdPKc(%struct.State* %0, i64 %298, %struct.Memory* %call2_409c84)
