; ModuleID = '/tmp/tmp97478cyu-query.ll'
...
define %struct.Memory* @_Z14test_variable1Il19custom_variable_xorIlEEvPT_iS2_PKc(%struct.State* noalias nocapture readonly, i64, %struct.Memory* noalias readnone returned) local_unnamed_addr #1 {
entry:
