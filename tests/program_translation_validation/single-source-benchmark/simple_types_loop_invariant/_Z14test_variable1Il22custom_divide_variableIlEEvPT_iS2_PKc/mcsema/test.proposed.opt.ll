...
block_.L_4095f3:                                  ; preds = %block_.L_409649, %entry
  %73 = phi i64 [ %.pre, %entry ], [ %286, %block_.L_409649 ]
...
block_.L_409612:                                  ; preds = %block_40961e, %block_409603
  %116 = phi i64 [ %.pre1, %block_409603 ], [ %241, %block_40961e ]
...
block_.L_409649:                                  ; preds = %block_.L_409612
  ...
  %call2_409651 = tail call %struct.Memory* @sub_40e650._Z26check_shifted_variable_sumIl22custom_divide_variableIlEEvT_S2_(%struct.State* %0, i64 %250, %struct.Memory* %MEMORY.1)
...
block_.L_409664:                                  ; preds = %block_.L_4095f3
  ...
  %call2_409664 = tail call %struct.Memory* @sub_400e30._Z5timerv(%struct.State* %0, i64 %287, %struct.Memory* %MEMORY.0)
  ...
  %call2_40966d = tail call %struct.Memory* @sub_4007d0._Z13record_resultdPKc(%struct.State* %0, i64 %298, %struct.Memory* %call2_409664)
