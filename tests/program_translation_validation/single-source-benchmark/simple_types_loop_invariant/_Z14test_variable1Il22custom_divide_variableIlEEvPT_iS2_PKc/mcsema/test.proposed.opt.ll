...
declare %struct.Memory* @sub_40e670._ZN22custom_divide_variableIlE8do_shiftEll(%struct.State* noalias dereferenceable(3376), i64, %struct.Memory* noalias readnone returned) local_unnamed_addr

declare %struct.Memory* @sub_40e690._Z26check_shifted_variable_sumIl22custom_divide_variableIlEEvT_S2_(%struct.State* noalias dereferenceable(3376), i64, %struct.Memory* noalias readnone returned) local_unnamed_addr
...
entry:
  ...
  %call2_409627 = tail call %struct.Memory* @sub_400e60._Z11start_timerv(%struct.State* %0, i64 %63, %struct.Memory* %2)
  ...
  br label %block_.L_409633

block_.L_409633:                                  ; preds = %block_.L_409689, %entry
  %73 = phi i64 [ %286, %block_.L_409689 ], [ %.pre, %entry ]
  ...
  br i1 %106, label %block_409643, label %block_.L_4096a4

block_409643:                                     ; preds = %block_.L_409633
  %108 = add i64 %74, -48
  %109 = add i64 %107, 8
...
block_.L_409652:                                  ; preds = %block_40965e, %block_409643
  %116 = phi i64 [ %241, %block_40965e ], [ %.pre6, %block_409643 ]
  ...
  br i1 %152, label %block_40965e, label %block_.L_409689

block_40965e:                                     ; preds = %block_.L_409652
  %154 = add i64 %117, -8
  %155 = add i64 %153, 4
  ...
  %call2_40966e = tail call %struct.Memory* @sub_40e670._ZN22custom_divide_variableIlE8do_shiftEll(%struct.State* nonnull %0, i64 %170, %struct.Memory* %call2_409627)
...
block_.L_409689:                                  ; preds = %block_.L_409652
  %242 = add i64 %117, -48
  %243 = add i64 %153, 4
  ...
  %call2_409691 = tail call %struct.Memory* @sub_40e690._Z26check_shifted_variable_sumIl22custom_divide_variableIlEEvT_S2_(%struct.State* nonnull %0, i64 %250, %struct.Memory* %call2_409627)
...
block_.L_4096a4:                                  ; preds = %block_.L_409633
  ...
  %call2_4096a4 = tail call %struct.Memory* @sub_400e80._Z5timerv(%struct.State* nonnull %0, i64 %287, %struct.Memory* %call2_409627)
  ...
  %call2_4096ad = tail call %struct.Memory* @sub_400820._Z13record_resultdPKc(%struct.State* nonnull %0, i64 %298, %struct.Memory* %call2_4096a4)
