; ModuleID = '/tmp/tmpl69a2awd-query.ll'
...
define %struct.Memory* @_Z14test_variable1Il22custom_divide_variableIlEEvPT_iS2_PKc(%struct.State* noalias, i64, %struct.Memory* noalias readnone returned) local_unnamed_addr #1 {
entry:
  %var_2_3 = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %RBP.i = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 15, i32 0, i32 0
  %var_2_62 = load i64, i64* %var_2_3, align 8
  %var_2_63 = add i64 %var_2_62, -34759
  %call2_409627 = tail call %struct.Memory* @sub_400e60._Z11start_timerv(%struct.State* %0, i64 %var_2_63, %struct.Memory* %2)
  %var_2_741 = load i64, i64* %RBP.i, align 8
  %var_2_752 = add i64 %var_2_741, -36
  %var_2_773 = inttoptr i64 %var_2_752 to i32*
  %var_2_784 = load i32, i32* %var_2_773, align 4
  %var_2_805 = load i32, i32* bitcast (%G_0x61a080_type* @G_0x61a080 to i32*), align 8
  %var_2_816 = sub i32 %var_2_784, %var_2_805
  %var_2_967 = lshr i32 %var_2_816, 31
  %var_2_988 = lshr i32 %var_2_784, 31
  %var_2_999 = lshr i32 %var_2_805, 31
  %var_2_10010 = xor i32 %var_2_999, %var_2_988
  %var_2_10111 = xor i32 %var_2_967, %var_2_988
  %var_2_10212 = add nuw nsw i32 %var_2_10111, %var_2_10010
  %var_2_10313 = icmp eq i32 %var_2_10212, 2
  %var_2_10514 = icmp ne i32 %var_2_967, 0
  %var_2_10615 = xor i1 %var_2_10514, %var_2_10313
  br i1 %var_2_10615, label %block_409643.preheader, label %block_.L_4096a4

block_409643.preheader:                           ; preds = %entry
  %var_2_118 = add i64 %var_2_741, -52
  %var_2_120 = inttoptr i64 %var_2_118 to i32*
  %var_2_121 = load i32, i32* %var_2_120, align 4
  %var_2_123 = add i64 %var_2_741, -12
  %var_2_125 = inttoptr i64 %var_2_123 to i32*
  %var_2_126 = load i32, i32* %var_2_125, align 4
  %var_2_127 = sub i32 %var_2_121, %var_2_126
  %var_2_142 = lshr i32 %var_2_127, 31
  %var_2_144 = lshr i32 %var_2_121, 31
  %var_2_145 = lshr i32 %var_2_126, 31
  %var_2_146 = xor i32 %var_2_145, %var_2_144
  %var_2_147 = xor i32 %var_2_142, %var_2_144
  %var_2_148 = add nuw nsw i32 %var_2_147, %var_2_146
  %var_2_149 = icmp eq i32 %var_2_148, 2
  %var_2_151 = icmp ne i32 %var_2_142, 0
  %var_2_152 = xor i1 %var_2_151, %var_2_149
  br i1 %var_2_152, label %block_.L_409652.preheader, label %block_409643.preheader5

block_409643.preheader5:                          ; preds = %block_409643.preheader
  br label %block_409643

block_.L_409652.preheader:                        ; preds = %block_409643.preheader
  br label %block_.L_409652

block_409643:                                     ; preds = %block_409643.preheader5, %block_409643
  br label %block_409643

block_.L_409652:                                  ; preds = %block_.L_409652.preheader, %block_.L_409652
  br label %block_.L_409652

block_.L_4096a4:                                  ; preds = %entry
  %.pre = load i64, i64* %var_2_3, align 8
  %var_2_287 = add i64 %.pre, -34739
  %call2_4096a4 = tail call %struct.Memory* @sub_400e80._Z5timerv(%struct.State* nonnull %0, i64 %var_2_287, %struct.Memory* %call2_409627)
  %var_2_294 = load i64, i64* %var_2_3, align 8
  %var_2_298 = add i64 %var_2_294, -36489
  %call2_4096ad = tail call %struct.Memory* @sub_400820._Z13record_resultdPKc(%struct.State* nonnull %0, i64 %var_2_298, %struct.Memory* %call2_4096a4)
  ret %struct.Memory* %call2_4096ad
}
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_jge_.L_4096a4(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i8* nocapture %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_jge_.L_409689(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i8* nocapture %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 2, i32 9
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_callq_._ZN22custom_divide_variableIlE8do_shiftEll(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_jmpq_.L_409652(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_callq_._Z26check_shifted_variable_sumIl22custom_divide_variableIlEEvT_S2_(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_jmpq_.L_409633(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
