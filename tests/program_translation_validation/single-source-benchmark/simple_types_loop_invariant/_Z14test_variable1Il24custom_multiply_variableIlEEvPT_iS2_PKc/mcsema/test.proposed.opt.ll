...
declare %struct.Memory* @sub_40e860._Z26check_shifted_variable_sumIl24custom_multiply_variableIlEEvT_S2_(%struct.State* noalias dereferenceable(3376), i64, %struct.Memory* noalias readnone returned) local_unnamed_addr
...
entry:
  ...
  %call2_409397 = tail call %struct.Memory* @sub_400e10._Z11start_timerv(%struct.State* %0, i64 %63, %struct.Memory* %2)
...
block_.L_4093a3:                                  ; preds = %block_.L_4093f9, %entry
  %73 = phi i64 [ %.pre, %entry ], [ %288, %block_.L_4093f9 ]
  %MEMORY.0 = phi %struct.Memory* [ %call2_409397, %entry ], [ %call2_409401, %block_.L_4093f9 ]
  ...
  br i1 %106, label %block_4093b3, label %block_.L_409414
...
block_.L_4093c2:                                  ; preds = %block_4093ce, %block_4093b3
  %116 = phi i64 [ %.pre1, %block_4093b3 ], [ %242, %block_4093ce ]
  %MEMORY.1 = phi %struct.Memory* [ %MEMORY.0, %block_4093b3 ], [ %call2_4093de, %block_4093ce ]
  ...
  br i1 %152, label %block_4093ce, label %block_.L_4093f9
...
block_4093ce:                                     ; preds = %block_.L_4093c2
  ...
  %call2_4093de = tail call %struct.Memory* @sub_40e840._ZN24custom_multiply_variableIlE8do_shiftEll(%struct.State* %0, i64 %170, %struct.Memory* %MEMORY.1)
...
block_.L_4093f9:                                  ; preds = %block_.L_4093c2
  ...
  %call2_409401 = tail call %struct.Memory* @sub_40e860._Z26check_shifted_variable_sumIl24custom_multiply_variableIlEEvT_S2_(%struct.State* %0, i64 %251, %struct.Memory* %MEMORY.1)
...
block_.L_409414:                                  ; preds = %block_.L_4093a3
  ...
  %call2_409414 = tail call %struct.Memory* @sub_400e30._Z5timerv(%struct.State* %0, i64 %289, %struct.Memory* %MEMORY.0)
  ...
  %call2_40941d = tail call %struct.Memory* @sub_4007d0._Z13record_resultdPKc(%struct.State* %0, i64 %300, %struct.Memory* %call2_409414)
  ...
  ret %struct.Memory* %call2_40941d
}
...
define %struct.Memory* @routine_jge_.L_409414(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i8* %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
...
define %struct.Memory* @routine_jge_.L_4093f9(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i8* %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 2, i32 9
...
define %struct.Memory* @routine_jmpq_.L_4093c2(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
...
define %struct.Memory* @routine_callq_._Z26check_shifted_variable_sumIl24custom_multiply_variableIlEEvT_S2_(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
...
define %struct.Memory* @routine_jmpq_.L_4093a3(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
