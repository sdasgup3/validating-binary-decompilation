...
block_.L_4093a3:                                  ; preds = %block_.L_4093f9, %entry
  %73 = phi i64 [ %.pre, %entry ], [ %286, %block_.L_4093f9 ]
...
block_.L_4093c2:                                  ; preds = %block_4093ce, %block_4093b3
  %116 = phi i64 [ %.pre1, %block_4093b3 ], [ %241, %block_4093ce ]
...
block_.L_4093f9:                                  ; preds = %block_.L_4093c2
  ...
  %call2_409401 = tail call %struct.Memory* @sub_40e860._Z26check_shifted_variable_sumIl24custom_multiply_variableIlEEvT_S2_(%struct.State* %0, i64 %250, %struct.Memory* %MEMORY.1)
...
block_.L_409414:                                  ; preds = %block_.L_4093a3
  ...
  %call2_409414 = tail call %struct.Memory* @sub_400e30._Z5timerv(%struct.State* %0, i64 %287, %struct.Memory* %MEMORY.0)
  ...
  %call2_40941d = tail call %struct.Memory* @sub_4007d0._Z13record_resultdPKc(%struct.State* %0, i64 %298, %struct.Memory* %call2_409414)
