...
declare %struct.Memory* @sub_40d360._ZN18custom_variable_orImE8do_shiftEmm(%struct.State* dereferenceable(3376), i64, %struct.Memory*)

declare %struct.Memory* @sub_40d380._Z26check_shifted_variable_sumIm18custom_variable_orImEEvT_S2_(%struct.State* dereferenceable(3376), i64, %struct.Memory*)
...
define %struct.Memory* @_Z14test_variable1Im18custom_variable_orImEEvPT_iS2_PKc(%struct.State* noalias, i64, %struct.Memory* noalias) #1 {
entry:
