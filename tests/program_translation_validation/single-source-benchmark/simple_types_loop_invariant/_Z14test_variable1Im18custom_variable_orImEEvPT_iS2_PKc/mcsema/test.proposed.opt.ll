...
declare %struct.Memory* @sub_40d390._Z26check_shifted_variable_sumIm18custom_variable_orImEEvT_S2_(%struct.State* noalias dereferenceable(3376), i64, %struct.Memory* noalias readnone returned) local_unnamed_addr
...
entry:
  ...
  %call2_40a8a7 = tail call %struct.Memory* @sub_400e60._Z11start_timerv(%struct.State* %0, i64 %63, %struct.Memory* %2)
...
block_.L_40a8b3:                                  ; preds = %block_.L_40a909, %entry
  %73 = phi i64 [ %286, %block_.L_40a909 ], [ %.pre, %entry ]
  ...
  br i1 %106, label %block_40a8c3, label %block_.L_40a924
...
block_.L_40a8d2:                                  ; preds = %block_40a8de, %block_40a8c3
  %116 = phi i64 [ %241, %block_40a8de ], [ %.pre6, %block_40a8c3 ]
  ...
  br i1 %152, label %block_40a8de, label %block_.L_40a909
...
block_40a8de:                                     ; preds = %block_.L_40a8d2
  ...
  %call2_40a8ee = tail call %struct.Memory* @sub_40d370._ZN18custom_variable_orImE8do_shiftEmm(%struct.State* nonnull %0, i64 %170, %struct.Memory* %call2_40a8a7)
...
block_.L_40a909:                                  ; preds = %block_.L_40a8d2
  ...
  %call2_40a911 = tail call %struct.Memory* @sub_40d390._Z26check_shifted_variable_sumIm18custom_variable_orImEEvT_S2_(%struct.State* nonnull %0, i64 %250, %struct.Memory* %call2_40a8a7)
...
block_.L_40a924:                                  ; preds = %block_.L_40a8b3
  ...
  %call2_40a924 = tail call %struct.Memory* @sub_400e80._Z5timerv(%struct.State* nonnull %0, i64 %287, %struct.Memory* %call2_40a8a7)
  ...
  %call2_40a92d = tail call %struct.Memory* @sub_400820._Z13record_resultdPKc(%struct.State* nonnull %0, i64 %298, %struct.Memory* %call2_40a924)
