...
declare %struct.Memory* @sub_40d380._Z26check_shifted_variable_sumIm18custom_variable_orImEEvT_S2_(%struct.State* noalias dereferenceable(3376), i64, %struct.Memory* noalias readnone returned) local_unnamed_addr
...
define %struct.Memory* @_Z14test_variable1Im18custom_variable_orImEEvPT_iS2_PKc(%struct.State* noalias, i64, %struct.Memory* noalias readnone) local_unnamed_addr #1 {
entry:
...
block_.L_40a8a3:                                  ; preds = %block_.L_40a8f9, %entry
  %73 = phi i64 [ %286, %block_.L_40a8f9 ], [ %.pre, %entry ]
...
block_.L_40a8c2:                                  ; preds = %block_40a8ce, %block_40a8b3
  %116 = phi i64 [ %241, %block_40a8ce ], [ %.pre6, %block_40a8b3 ]
...
block_40a8ce:                                     ; preds = %block_.L_40a8c2
  ...
  %call2_40a8de = tail call %struct.Memory* @sub_40d360._ZN18custom_variable_orImE8do_shiftEmm(%struct.State* nonnull %0, i64 %170, %struct.Memory* %call2_40a897)
...
block_.L_40a8f9:                                  ; preds = %block_.L_40a8c2
  ...
  %call2_40a901 = tail call %struct.Memory* @sub_40d380._Z26check_shifted_variable_sumIm18custom_variable_orImEEvT_S2_(%struct.State* nonnull %0, i64 %250, %struct.Memory* %call2_40a897)
...
block_.L_40a914:                                  ; preds = %block_.L_40a8a3
  ...
  %call2_40a914 = tail call %struct.Memory* @sub_400e70._Z5timerv(%struct.State* nonnull %0, i64 %287, %struct.Memory* %call2_40a897)
