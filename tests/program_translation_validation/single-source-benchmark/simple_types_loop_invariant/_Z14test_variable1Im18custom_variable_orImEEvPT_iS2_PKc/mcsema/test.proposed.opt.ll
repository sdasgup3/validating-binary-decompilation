...
block_.L_40a873:                                  ; preds = %block_.L_40a8c9, %entry
  %73 = phi i64 [ %.pre, %entry ], [ %286, %block_.L_40a8c9 ]
...
block_.L_40a892:                                  ; preds = %block_40a89e, %block_40a883
  %116 = phi i64 [ %.pre1, %block_40a883 ], [ %241, %block_40a89e ]
...
block_.L_40a8c9:                                  ; preds = %block_.L_40a892
  ...
  %call2_40a8d1 = tail call %struct.Memory* @sub_40d350._Z26check_shifted_variable_sumIm18custom_variable_orImEEvT_S2_(%struct.State* %0, i64 %250, %struct.Memory* %MEMORY.1)
...
block_.L_40a8e4:                                  ; preds = %block_.L_40a873
  ...
  %call2_40a8e4 = tail call %struct.Memory* @sub_400e30._Z5timerv(%struct.State* %0, i64 %287, %struct.Memory* %MEMORY.0)
  ...
  %call2_40a8ed = tail call %struct.Memory* @sub_4007d0._Z13record_resultdPKc(%struct.State* %0, i64 %298, %struct.Memory* %call2_40a8e4)
