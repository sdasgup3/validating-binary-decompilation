; ModuleID = '/tmp/tmpqvzn88kd-query.ll'
...
define %struct.Memory* @_Z14test_variable1Im18custom_variable_orImEEvPT_iS2_PKc(%struct.State* noalias nocapture readonly, i64, %struct.Memory* noalias readnone returned) local_unnamed_addr #1 {
entry:
