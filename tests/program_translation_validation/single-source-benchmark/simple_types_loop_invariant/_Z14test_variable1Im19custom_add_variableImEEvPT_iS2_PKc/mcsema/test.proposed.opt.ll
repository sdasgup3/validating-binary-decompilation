...
declare %struct.Memory* @sub_40df40._Z26check_shifted_variable_sumIm19custom_add_variableImEEvT_S2_(%struct.State* dereferenceable(3376), i64, %struct.Memory*) local_unnamed_addr
...
define %struct.Memory* @_Z14test_variable1Im19custom_add_variableImEEvPT_iS2_PKc(%struct.State* noalias, i64, %struct.Memory* noalias) local_unnamed_addr #1 {
entry:
...
block_.L_409e03:                                  ; preds = %block_.L_409e59, %entry
  %73 = phi i64 [ %.pre, %entry ], [ %286, %block_.L_409e59 ]
  %MEMORY.0 = phi %struct.Memory* [ %call2_409df7, %entry ], [ %call2_409e61, %block_.L_409e59 ]
...
block_.L_409e22:                                  ; preds = %block_409e2e, %block_409e13
  %116 = phi i64 [ %.pre6, %block_409e13 ], [ %241, %block_409e2e ]
  %MEMORY.1 = phi %struct.Memory* [ %MEMORY.0, %block_409e13 ], [ %call2_409e3e, %block_409e2e ]
...
block_409e2e:                                     ; preds = %block_.L_409e22
  ...
  %call2_409e3e = tail call %struct.Memory* @sub_40dfe0._ZN19custom_add_variableImE8do_shiftEmm(%struct.State* nonnull %0, i64 %170, %struct.Memory* %MEMORY.1)
...
block_.L_409e59:                                  ; preds = %block_.L_409e22
  ...
  %call2_409e61 = tail call %struct.Memory* @sub_40df40._Z26check_shifted_variable_sumIm19custom_add_variableImEEvT_S2_(%struct.State* nonnull %0, i64 %250, %struct.Memory* %MEMORY.1)
...
block_.L_409e74:                                  ; preds = %block_.L_409e03
  ...
  %call2_409e74 = tail call %struct.Memory* @sub_400e70._Z5timerv(%struct.State* nonnull %0, i64 %287, %struct.Memory* %MEMORY.0)
