...
declare %struct.Memory* @sub_40df10._Z26check_shifted_variable_sumIm19custom_add_variableImEEvT_S2_(%struct.State* noalias dereferenceable(3376), i64, %struct.Memory* noalias readnone returned) local_unnamed_addr
...
entry:
  ...
  %call2_409dc7 = tail call %struct.Memory* @sub_400e10._Z11start_timerv(%struct.State* %0, i64 %63, %struct.Memory* %2)
...
block_.L_409dd3:                                  ; preds = %block_.L_409e29, %entry
  %73 = phi i64 [ %.pre, %entry ], [ %286, %block_.L_409e29 ]
  %MEMORY.0 = phi %struct.Memory* [ %call2_409dc7, %entry ], [ %call2_409e31, %block_.L_409e29 ]
  ...
  br i1 %106, label %block_409de3, label %block_.L_409e44
...
block_.L_409df2:                                  ; preds = %block_409dfe, %block_409de3
  %116 = phi i64 [ %.pre1, %block_409de3 ], [ %241, %block_409dfe ]
  %MEMORY.1 = phi %struct.Memory* [ %MEMORY.0, %block_409de3 ], [ %call2_409e0e, %block_409dfe ]
  ...
  br i1 %152, label %block_409dfe, label %block_.L_409e29
...
block_409dfe:                                     ; preds = %block_.L_409df2
  ...
  %call2_409e0e = tail call %struct.Memory* @sub_40dfb0._ZN19custom_add_variableImE8do_shiftEmm(%struct.State* %0, i64 %170, %struct.Memory* %MEMORY.1)
...
block_.L_409e29:                                  ; preds = %block_.L_409df2
  ...
  %call2_409e31 = tail call %struct.Memory* @sub_40df10._Z26check_shifted_variable_sumIm19custom_add_variableImEEvT_S2_(%struct.State* %0, i64 %250, %struct.Memory* %MEMORY.1)
...
block_.L_409e44:                                  ; preds = %block_.L_409dd3
  ...
  %call2_409e44 = tail call %struct.Memory* @sub_400e30._Z5timerv(%struct.State* %0, i64 %287, %struct.Memory* %MEMORY.0)
  ...
  %call2_409e4d = tail call %struct.Memory* @sub_4007d0._Z13record_resultdPKc(%struct.State* %0, i64 %298, %struct.Memory* %call2_409e44)
  ...
  ret %struct.Memory* %call2_409e4d
}
...
define %struct.Memory* @routine_jge_.L_409e44(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i8* %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
...
define %struct.Memory* @routine_jge_.L_409e29(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i8* %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 2, i32 9
...
define %struct.Memory* @routine_jmpq_.L_409df2(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
...
define %struct.Memory* @routine_callq_._Z26check_shifted_variable_sumIm19custom_add_variableImEEvT_S2_(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
...
define %struct.Memory* @routine_jmpq_.L_409dd3(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
