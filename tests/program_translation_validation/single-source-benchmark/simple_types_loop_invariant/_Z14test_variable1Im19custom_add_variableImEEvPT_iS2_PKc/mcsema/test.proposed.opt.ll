...
block_.L_409dd3:                                  ; preds = %block_.L_409e29, %entry
  %73 = phi i64 [ %.pre, %entry ], [ %288, %block_.L_409e29 ]
...
block_.L_409df2:                                  ; preds = %block_409dfe, %block_409de3
  %116 = phi i64 [ %.pre1, %block_409de3 ], [ %242, %block_409dfe ]
...
block_.L_409e29:                                  ; preds = %block_.L_409df2
  ...
  %call2_409e31 = tail call %struct.Memory* @sub_40df10._Z26check_shifted_variable_sumIm19custom_add_variableImEEvT_S2_(%struct.State* %0, i64 %251, %struct.Memory* %MEMORY.1)
...
block_.L_409e44:                                  ; preds = %block_.L_409dd3
  ...
  %call2_409e44 = tail call %struct.Memory* @sub_400e30._Z5timerv(%struct.State* %0, i64 %289, %struct.Memory* %MEMORY.0)
  ...
  %call2_409e4d = tail call %struct.Memory* @sub_4007d0._Z13record_resultdPKc(%struct.State* %0, i64 %300, %struct.Memory* %call2_409e44)
