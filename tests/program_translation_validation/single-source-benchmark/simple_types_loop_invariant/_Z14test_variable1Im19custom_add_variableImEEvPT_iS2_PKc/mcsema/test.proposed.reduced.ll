; ModuleID = '/tmp/tmp_5i8spps-query.ll'
...
define %struct.Memory* @_Z14test_variable1Im19custom_add_variableImEEvPT_iS2_PKc(%struct.State* noalias, i64, %struct.Memory* noalias readnone returned) local_unnamed_addr #1 {
entry:
  %var_2_3 = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %RBP.i = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 15, i32 0, i32 0
  %var_2_62 = load i64, i64* %var_2_3, align 8
  %var_2_63 = add i64 %var_2_62, -36775
  %call2_409e07 = tail call %struct.Memory* @sub_400e60._Z11start_timerv(%struct.State* %0, i64 %var_2_63, %struct.Memory* %2)
  ...
  br i1 %var_2_10615, label %block_409e23.preheader, label %block_.L_409e84

block_409e23.preheader:                           ; preds = %entry
  ...
  br i1 %var_2_152, label %block_.L_409e32.preheader, label %block_409e23.preheader5

block_409e23.preheader5:                          ; preds = %block_409e23.preheader
  br label %block_409e23

block_.L_409e32.preheader:                        ; preds = %block_409e23.preheader
  br label %block_.L_409e32

block_409e23:                                     ; preds = %block_409e23.preheader5, %block_409e23
  br label %block_409e23

block_.L_409e32:                                  ; preds = %block_.L_409e32.preheader, %block_.L_409e32
  br label %block_.L_409e32

block_.L_409e84:                                  ; preds = %entry
  %.pre = load i64, i64* %var_2_3, align 8
  %var_2_287 = add i64 %.pre, -36755
  %call2_409e84 = tail call %struct.Memory* @sub_400e80._Z5timerv(%struct.State* nonnull %0, i64 %var_2_287, %struct.Memory* %call2_409e07)
  %var_2_294 = load i64, i64* %var_2_3, align 8
  %var_2_298 = add i64 %var_2_294, -38505
  %call2_409e8d = tail call %struct.Memory* @sub_400820._Z13record_resultdPKc(%struct.State* nonnull %0, i64 %var_2_298, %struct.Memory* %call2_409e84)
