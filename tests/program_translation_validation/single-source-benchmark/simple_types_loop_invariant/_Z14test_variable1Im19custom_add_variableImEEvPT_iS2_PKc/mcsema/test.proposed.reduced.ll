; ModuleID = '/tmp/tmpq4ci6y99-query.ll'
...
define %struct.Memory* @_Z14test_variable1Im19custom_add_variableImEEvPT_iS2_PKc(%struct.State* noalias nocapture readonly, i64, %struct.Memory* noalias readnone returned) local_unnamed_addr #1 {
entry:
