...
declare %struct.Memory* @sub_40dd80._ZN19custom_sub_variableImE8do_shiftEmm(%struct.State* dereferenceable(3376), i64, %struct.Memory*)

declare %struct.Memory* @sub_40dda0._Z26check_shifted_variable_sumIm19custom_sub_variableImEEvT_S2_(%struct.State* dereferenceable(3376), i64, %struct.Memory*)
...
define %struct.Memory* @_Z14test_variable1Im19custom_sub_variableImEEvPT_iS2_PKc(%struct.State* noalias, i64, %struct.Memory* noalias) #1 {
entry:
