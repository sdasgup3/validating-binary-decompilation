...
block_.L_40a003:                                  ; preds = %block_.L_40a059, %entry
  %73 = phi i64 [ %.pre, %entry ], [ %288, %block_.L_40a059 ]
...
block_.L_40a022:                                  ; preds = %block_40a02e, %block_40a013
  %116 = phi i64 [ %.pre1, %block_40a013 ], [ %242, %block_40a02e ]
...
block_.L_40a059:                                  ; preds = %block_.L_40a022
  ...
  %call2_40a061 = tail call %struct.Memory* @sub_40dd70._Z26check_shifted_variable_sumIm19custom_sub_variableImEEvT_S2_(%struct.State* %0, i64 %251, %struct.Memory* %MEMORY.1)
...
block_.L_40a074:                                  ; preds = %block_.L_40a003
  ...
  %call2_40a074 = tail call %struct.Memory* @sub_400e30._Z5timerv(%struct.State* %0, i64 %289, %struct.Memory* %MEMORY.0)
  ...
  %call2_40a07d = tail call %struct.Memory* @sub_4007d0._Z13record_resultdPKc(%struct.State* %0, i64 %300, %struct.Memory* %call2_40a074)
