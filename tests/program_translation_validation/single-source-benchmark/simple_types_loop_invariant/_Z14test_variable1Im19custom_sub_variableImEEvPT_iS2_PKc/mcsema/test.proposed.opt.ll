...
declare %struct.Memory* @sub_40dd90._ZN19custom_sub_variableImE8do_shiftEmm(%struct.State* noalias dereferenceable(3376), i64, %struct.Memory* noalias readnone returned) local_unnamed_addr

declare %struct.Memory* @sub_40ddb0._Z26check_shifted_variable_sumIm19custom_sub_variableImEEvT_S2_(%struct.State* noalias dereferenceable(3376), i64, %struct.Memory* noalias readnone returned) local_unnamed_addr
...
entry:
  ...
  %call2_40a037 = tail call %struct.Memory* @sub_400e60._Z11start_timerv(%struct.State* %0, i64 %63, %struct.Memory* %2)
...
block_.L_40a043:                                  ; preds = %block_.L_40a099, %entry
  %73 = phi i64 [ %286, %block_.L_40a099 ], [ %.pre, %entry ]
  ...
  br i1 %106, label %block_40a053, label %block_.L_40a0b4
...
block_.L_40a062:                                  ; preds = %block_40a06e, %block_40a053
  %116 = phi i64 [ %241, %block_40a06e ], [ %.pre6, %block_40a053 ]
  ...
  br i1 %152, label %block_40a06e, label %block_.L_40a099
...
block_40a06e:                                     ; preds = %block_.L_40a062
  ...
  %call2_40a07e = tail call %struct.Memory* @sub_40dd90._ZN19custom_sub_variableImE8do_shiftEmm(%struct.State* nonnull %0, i64 %170, %struct.Memory* %call2_40a037)
...
block_.L_40a099:                                  ; preds = %block_.L_40a062
  ...
  %call2_40a0a1 = tail call %struct.Memory* @sub_40ddb0._Z26check_shifted_variable_sumIm19custom_sub_variableImEEvT_S2_(%struct.State* nonnull %0, i64 %250, %struct.Memory* %call2_40a037)
...
block_.L_40a0b4:                                  ; preds = %block_.L_40a043
  ...
  %call2_40a0b4 = tail call %struct.Memory* @sub_400e80._Z5timerv(%struct.State* nonnull %0, i64 %287, %struct.Memory* %call2_40a037)
  ...
  %call2_40a0bd = tail call %struct.Memory* @sub_400820._Z13record_resultdPKc(%struct.State* nonnull %0, i64 %298, %struct.Memory* %call2_40a0b4)
