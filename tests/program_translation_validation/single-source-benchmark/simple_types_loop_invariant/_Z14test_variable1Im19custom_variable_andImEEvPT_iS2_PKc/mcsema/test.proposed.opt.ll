...
block_.L_40a6f3:                                  ; preds = %block_.L_40a749, %entry
  %73 = phi i64 [ %.pre, %entry ], [ %288, %block_.L_40a749 ]
...
block_.L_40a712:                                  ; preds = %block_40a71e, %block_40a703
  %116 = phi i64 [ %.pre1, %block_40a703 ], [ %242, %block_40a71e ]
...
block_.L_40a749:                                  ; preds = %block_.L_40a712
  ...
  %call2_40a751 = tail call %struct.Memory* @sub_40d510._Z26check_shifted_variable_sumIm19custom_variable_andImEEvT_S2_(%struct.State* %0, i64 %251, %struct.Memory* %MEMORY.1)
...
block_.L_40a764:                                  ; preds = %block_.L_40a6f3
  ...
  %call2_40a764 = tail call %struct.Memory* @sub_400e30._Z5timerv(%struct.State* %0, i64 %289, %struct.Memory* %MEMORY.0)
  ...
  %call2_40a76d = tail call %struct.Memory* @sub_4007d0._Z13record_resultdPKc(%struct.State* %0, i64 %300, %struct.Memory* %call2_40a764)
