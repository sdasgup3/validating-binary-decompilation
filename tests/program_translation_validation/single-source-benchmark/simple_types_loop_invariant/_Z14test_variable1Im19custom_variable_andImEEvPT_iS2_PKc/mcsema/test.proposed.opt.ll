...
declare %struct.Memory* @sub_40d550._Z26check_shifted_variable_sumIm19custom_variable_andImEEvT_S2_(%struct.State* noalias dereferenceable(3376), i64, %struct.Memory* noalias readnone returned) local_unnamed_addr
...
entry:
  ...
  %call2_40a727 = tail call %struct.Memory* @sub_400e60._Z11start_timerv(%struct.State* %0, i64 %63, %struct.Memory* %2)
...
block_.L_40a733:                                  ; preds = %block_.L_40a789, %entry
  %73 = phi i64 [ %286, %block_.L_40a789 ], [ %.pre, %entry ]
  ...
  br i1 %106, label %block_40a743, label %block_.L_40a7a4
...
block_.L_40a752:                                  ; preds = %block_40a75e, %block_40a743
  %116 = phi i64 [ %241, %block_40a75e ], [ %.pre6, %block_40a743 ]
  ...
  br i1 %152, label %block_40a75e, label %block_.L_40a789
...
block_40a75e:                                     ; preds = %block_.L_40a752
  ...
  %call2_40a76e = tail call %struct.Memory* @sub_40d530._ZN19custom_variable_andImE8do_shiftEmm(%struct.State* nonnull %0, i64 %170, %struct.Memory* %call2_40a727)
...
block_.L_40a789:                                  ; preds = %block_.L_40a752
  ...
  %call2_40a791 = tail call %struct.Memory* @sub_40d550._Z26check_shifted_variable_sumIm19custom_variable_andImEEvT_S2_(%struct.State* nonnull %0, i64 %250, %struct.Memory* %call2_40a727)
...
block_.L_40a7a4:                                  ; preds = %block_.L_40a733
  ...
  %call2_40a7a4 = tail call %struct.Memory* @sub_400e80._Z5timerv(%struct.State* nonnull %0, i64 %287, %struct.Memory* %call2_40a727)
  ...
  %call2_40a7ad = tail call %struct.Memory* @sub_400820._Z13record_resultdPKc(%struct.State* nonnull %0, i64 %298, %struct.Memory* %call2_40a7a4)
