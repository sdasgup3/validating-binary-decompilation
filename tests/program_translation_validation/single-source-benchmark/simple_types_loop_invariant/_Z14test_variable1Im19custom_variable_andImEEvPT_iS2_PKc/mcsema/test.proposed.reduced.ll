; ModuleID = '/tmp/tmp0sm7jgrn-query.ll'
...
define %struct.Memory* @_Z14test_variable1Im19custom_variable_andImEEvPT_iS2_PKc(%struct.State* noalias nocapture readonly, i64, %struct.Memory* noalias readnone returned) local_unnamed_addr #1 {
entry:
