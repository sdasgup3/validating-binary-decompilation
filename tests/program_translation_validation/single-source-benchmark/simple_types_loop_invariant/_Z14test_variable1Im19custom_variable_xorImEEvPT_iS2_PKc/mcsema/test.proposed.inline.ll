...
declare %struct.Memory* @sub_40d1c0._Z26check_shifted_variable_sumIm19custom_variable_xorImEEvT_S2_(%struct.State* dereferenceable(3376), i64, %struct.Memory*)
...
define %struct.Memory* @_Z14test_variable1Im19custom_variable_xorImEEvPT_iS2_PKc(%struct.State* noalias, i64, %struct.Memory* noalias) #1 {
entry:
