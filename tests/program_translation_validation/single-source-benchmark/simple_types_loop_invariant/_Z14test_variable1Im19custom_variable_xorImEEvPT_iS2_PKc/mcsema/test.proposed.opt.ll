...
declare %struct.Memory* @sub_40d190._Z26check_shifted_variable_sumIm19custom_variable_xorImEEvT_S2_(%struct.State* noalias dereferenceable(3376), i64, %struct.Memory* noalias readnone returned) local_unnamed_addr
...
define %struct.Memory* @_Z14test_variable1Im19custom_variable_xorImEEvPT_iS2_PKc(%struct.State* noalias, i64, %struct.Memory* noalias) local_unnamed_addr #1 {
entry:
  ...
  %call2_40a9e7 = tail call %struct.Memory* @sub_400e10._Z11start_timerv(%struct.State* %0, i64 %63, %struct.Memory* %2)
...
block_.L_40a9f3:                                  ; preds = %block_.L_40aa49, %entry
  %73 = phi i64 [ %.pre, %entry ], [ %286, %block_.L_40aa49 ]
  %MEMORY.0 = phi %struct.Memory* [ %call2_40a9e7, %entry ], [ %call2_40aa51, %block_.L_40aa49 ]
  ...
  br i1 %106, label %block_40aa03, label %block_.L_40aa64
...
block_.L_40aa12:                                  ; preds = %block_40aa1e, %block_40aa03
  %116 = phi i64 [ %.pre1, %block_40aa03 ], [ %241, %block_40aa1e ]
  %MEMORY.1 = phi %struct.Memory* [ %MEMORY.0, %block_40aa03 ], [ %call2_40aa2e, %block_40aa1e ]
  ...
  br i1 %152, label %block_40aa1e, label %block_.L_40aa49
...
block_40aa1e:                                     ; preds = %block_.L_40aa12
  ...
  %call2_40aa2e = tail call %struct.Memory* @sub_40d170._ZN19custom_variable_xorImE8do_shiftEmm(%struct.State* %0, i64 %170, %struct.Memory* %MEMORY.1)
...
block_.L_40aa49:                                  ; preds = %block_.L_40aa12
  ...
  %call2_40aa51 = tail call %struct.Memory* @sub_40d190._Z26check_shifted_variable_sumIm19custom_variable_xorImEEvT_S2_(%struct.State* %0, i64 %250, %struct.Memory* %MEMORY.1)
...
block_.L_40aa64:                                  ; preds = %block_.L_40a9f3
  ...
  %call2_40aa64 = tail call %struct.Memory* @sub_400e30._Z5timerv(%struct.State* %0, i64 %287, %struct.Memory* %MEMORY.0)
  ...
  %call2_40aa6d = tail call %struct.Memory* @sub_4007d0._Z13record_resultdPKc(%struct.State* %0, i64 %298, %struct.Memory* %call2_40aa64)
  ...
  ret %struct.Memory* %call2_40aa6d
}
...
define %struct.Memory* @routine_jge_.L_40aa64(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i8* %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
...
define %struct.Memory* @routine_jge_.L_40aa49(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i8* %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 2, i32 9
...
define %struct.Memory* @routine_jmpq_.L_40aa12(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
...
define %struct.Memory* @routine_callq_._Z26check_shifted_variable_sumIm19custom_variable_xorImEEvT_S2_(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
...
define %struct.Memory* @routine_jmpq_.L_40a9f3(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
