...
declare %struct.Memory* @sub_40d1d0._Z26check_shifted_variable_sumIm19custom_variable_xorImEEvT_S2_(%struct.State* noalias dereferenceable(3376), i64, %struct.Memory* noalias readnone returned) local_unnamed_addr
...
entry:
  ...
  %call2_40aa27 = tail call %struct.Memory* @sub_400e60._Z11start_timerv(%struct.State* %0, i64 %63, %struct.Memory* %2)
...
block_.L_40aa33:                                  ; preds = %block_.L_40aa89, %entry
  %73 = phi i64 [ %286, %block_.L_40aa89 ], [ %.pre, %entry ]
  ...
  br i1 %106, label %block_40aa43, label %block_.L_40aaa4
...
block_.L_40aa52:                                  ; preds = %block_40aa5e, %block_40aa43
  %116 = phi i64 [ %241, %block_40aa5e ], [ %.pre6, %block_40aa43 ]
  ...
  br i1 %152, label %block_40aa5e, label %block_.L_40aa89
...
block_40aa5e:                                     ; preds = %block_.L_40aa52
  ...
  %call2_40aa6e = tail call %struct.Memory* @sub_40d1b0._ZN19custom_variable_xorImE8do_shiftEmm(%struct.State* nonnull %0, i64 %170, %struct.Memory* %call2_40aa27)
...
block_.L_40aa89:                                  ; preds = %block_.L_40aa52
  ...
  %call2_40aa91 = tail call %struct.Memory* @sub_40d1d0._Z26check_shifted_variable_sumIm19custom_variable_xorImEEvT_S2_(%struct.State* nonnull %0, i64 %250, %struct.Memory* %call2_40aa27)
...
block_.L_40aaa4:                                  ; preds = %block_.L_40aa33
  ...
  %call2_40aaa4 = tail call %struct.Memory* @sub_400e80._Z5timerv(%struct.State* nonnull %0, i64 %287, %struct.Memory* %call2_40aa27)
  ...
  %call2_40aaad = tail call %struct.Memory* @sub_400820._Z13record_resultdPKc(%struct.State* nonnull %0, i64 %298, %struct.Memory* %call2_40aaa4)
