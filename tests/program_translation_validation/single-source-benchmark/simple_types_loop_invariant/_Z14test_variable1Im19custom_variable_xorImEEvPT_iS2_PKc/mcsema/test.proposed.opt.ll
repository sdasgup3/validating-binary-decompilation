...
block_.L_40a9f3:                                  ; preds = %block_.L_40aa49, %entry
  %73 = phi i64 [ %.pre, %entry ], [ %288, %block_.L_40aa49 ]
...
block_.L_40aa12:                                  ; preds = %block_40aa1e, %block_40aa03
  %116 = phi i64 [ %.pre1, %block_40aa03 ], [ %242, %block_40aa1e ]
...
block_.L_40aa49:                                  ; preds = %block_.L_40aa12
  ...
  %call2_40aa51 = tail call %struct.Memory* @sub_40d190._Z26check_shifted_variable_sumIm19custom_variable_xorImEEvT_S2_(%struct.State* %0, i64 %251, %struct.Memory* %MEMORY.1)
...
block_.L_40aa64:                                  ; preds = %block_.L_40a9f3
  ...
  %call2_40aa64 = tail call %struct.Memory* @sub_400e30._Z5timerv(%struct.State* %0, i64 %289, %struct.Memory* %MEMORY.0)
  ...
  %call2_40aa6d = tail call %struct.Memory* @sub_4007d0._Z13record_resultdPKc(%struct.State* %0, i64 %300, %struct.Memory* %call2_40aa64)
