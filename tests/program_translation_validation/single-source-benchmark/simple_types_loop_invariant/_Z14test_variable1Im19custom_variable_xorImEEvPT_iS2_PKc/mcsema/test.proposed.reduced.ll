; ModuleID = '/tmp/tmp1qwsi5as-query.ll'
...
define %struct.Memory* @_Z14test_variable1Im19custom_variable_xorImEEvPT_iS2_PKc(%struct.State* noalias nocapture readonly, i64, %struct.Memory* noalias readnone returned) local_unnamed_addr #1 {
entry:
