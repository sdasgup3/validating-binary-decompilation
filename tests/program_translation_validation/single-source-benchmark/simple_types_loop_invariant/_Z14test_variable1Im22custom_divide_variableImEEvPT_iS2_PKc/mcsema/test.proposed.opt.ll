...
block_.L_40a3d3:                                  ; preds = %block_.L_40a429, %entry
  %73 = phi i64 [ %.pre, %entry ], [ %288, %block_.L_40a429 ]
...
block_.L_40a3f2:                                  ; preds = %block_40a3fe, %block_40a3e3
  %116 = phi i64 [ %.pre1, %block_40a3e3 ], [ %242, %block_40a3fe ]
...
block_.L_40a429:                                  ; preds = %block_.L_40a3f2
  ...
  %call2_40a431 = tail call %struct.Memory* @sub_40d8f0._Z26check_shifted_variable_sumIm22custom_divide_variableImEEvT_S2_(%struct.State* %0, i64 %251, %struct.Memory* %MEMORY.1)
...
block_.L_40a444:                                  ; preds = %block_.L_40a3d3
  ...
  %call2_40a444 = tail call %struct.Memory* @sub_400e30._Z5timerv(%struct.State* %0, i64 %289, %struct.Memory* %MEMORY.0)
  ...
  %call2_40a44d = tail call %struct.Memory* @sub_4007d0._Z13record_resultdPKc(%struct.State* %0, i64 %300, %struct.Memory* %call2_40a444)
