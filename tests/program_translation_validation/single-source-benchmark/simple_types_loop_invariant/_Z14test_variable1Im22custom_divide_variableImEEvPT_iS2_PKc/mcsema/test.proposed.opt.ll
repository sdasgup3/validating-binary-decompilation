...
declare %struct.Memory* @sub_40d930._Z26check_shifted_variable_sumIm22custom_divide_variableImEEvT_S2_(%struct.State* noalias dereferenceable(3376), i64, %struct.Memory* noalias readnone returned) local_unnamed_addr
...
entry:
  ...
  %call2_40a407 = tail call %struct.Memory* @sub_400e60._Z11start_timerv(%struct.State* %0, i64 %63, %struct.Memory* %2)
...
block_.L_40a413:                                  ; preds = %block_.L_40a469, %entry
  %73 = phi i64 [ %286, %block_.L_40a469 ], [ %.pre, %entry ]
  ...
  br i1 %106, label %block_40a423, label %block_.L_40a484

block_40a423:                                     ; preds = %block_.L_40a413
  %108 = add i64 %74, -48
  %109 = add i64 %107, 8
...
block_.L_40a432:                                  ; preds = %block_40a43e, %block_40a423
  %116 = phi i64 [ %241, %block_40a43e ], [ %.pre6, %block_40a423 ]
  ...
  br i1 %152, label %block_40a43e, label %block_.L_40a469

block_40a43e:                                     ; preds = %block_.L_40a432
  %154 = add i64 %117, -8
  %155 = add i64 %153, 4
  ...
  %call2_40a44e = tail call %struct.Memory* @sub_40d910._ZN22custom_divide_variableImE8do_shiftEmm(%struct.State* nonnull %0, i64 %170, %struct.Memory* %call2_40a407)
...
block_.L_40a469:                                  ; preds = %block_.L_40a432
  %242 = add i64 %117, -48
  %243 = add i64 %153, 4
  ...
  %call2_40a471 = tail call %struct.Memory* @sub_40d930._Z26check_shifted_variable_sumIm22custom_divide_variableImEEvT_S2_(%struct.State* nonnull %0, i64 %250, %struct.Memory* %call2_40a407)
...
block_.L_40a484:                                  ; preds = %block_.L_40a413
  ...
  %call2_40a484 = tail call %struct.Memory* @sub_400e80._Z5timerv(%struct.State* nonnull %0, i64 %287, %struct.Memory* %call2_40a407)
  ...
  %call2_40a48d = tail call %struct.Memory* @sub_400820._Z13record_resultdPKc(%struct.State* nonnull %0, i64 %298, %struct.Memory* %call2_40a484)
