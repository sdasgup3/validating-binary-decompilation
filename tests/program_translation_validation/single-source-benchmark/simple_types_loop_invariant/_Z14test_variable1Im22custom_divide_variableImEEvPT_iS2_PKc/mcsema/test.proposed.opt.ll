...
declare %struct.Memory* @sub_40d8f0._Z26check_shifted_variable_sumIm22custom_divide_variableImEEvT_S2_(%struct.State* noalias dereferenceable(3376), i64, %struct.Memory* noalias readnone returned) local_unnamed_addr
...
entry:
  ...
  %call2_40a3c7 = tail call %struct.Memory* @sub_400e10._Z11start_timerv(%struct.State* %0, i64 %63, %struct.Memory* %2)
...
block_.L_40a3d3:                                  ; preds = %block_.L_40a429, %entry
  %73 = phi i64 [ %.pre, %entry ], [ %286, %block_.L_40a429 ]
  %MEMORY.0 = phi %struct.Memory* [ %call2_40a3c7, %entry ], [ %call2_40a431, %block_.L_40a429 ]
  ...
  br i1 %106, label %block_40a3e3, label %block_.L_40a444

block_40a3e3:                                     ; preds = %block_.L_40a3d3
  %108 = add i64 %74, -48
  %109 = add i64 %107, 8
...
block_.L_40a3f2:                                  ; preds = %block_40a3fe, %block_40a3e3
  %116 = phi i64 [ %.pre1, %block_40a3e3 ], [ %241, %block_40a3fe ]
  %MEMORY.1 = phi %struct.Memory* [ %MEMORY.0, %block_40a3e3 ], [ %call2_40a40e, %block_40a3fe ]
  ...
  br i1 %152, label %block_40a3fe, label %block_.L_40a429
...
block_40a3fe:                                     ; preds = %block_.L_40a3f2
  ...
  %call2_40a40e = tail call %struct.Memory* @sub_40d8d0._ZN22custom_divide_variableImE8do_shiftEmm(%struct.State* %0, i64 %170, %struct.Memory* %MEMORY.1)
...
block_.L_40a429:                                  ; preds = %block_.L_40a3f2
  %242 = add i64 %117, -48
  %243 = add i64 %153, 4
  ...
  %call2_40a431 = tail call %struct.Memory* @sub_40d8f0._Z26check_shifted_variable_sumIm22custom_divide_variableImEEvT_S2_(%struct.State* %0, i64 %250, %struct.Memory* %MEMORY.1)
...
block_.L_40a444:                                  ; preds = %block_.L_40a3d3
  %287 = add i64 %107, -38420
  %288 = add i64 %107, 5
  ...
  %call2_40a444 = tail call %struct.Memory* @sub_400e30._Z5timerv(%struct.State* %0, i64 %287, %struct.Memory* %MEMORY.0)
  ...
  %call2_40a44d = tail call %struct.Memory* @sub_4007d0._Z13record_resultdPKc(%struct.State* %0, i64 %298, %struct.Memory* %call2_40a444)
  ...
  ret %struct.Memory* %call2_40a44d
}
...
define %struct.Memory* @routine_jge_.L_40a444(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i8* %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
...
define %struct.Memory* @routine_jge_.L_40a429(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i8* %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 2, i32 9
...
define %struct.Memory* @routine_jmpq_.L_40a3f2(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
...
define %struct.Memory* @routine_callq_._Z26check_shifted_variable_sumIm22custom_divide_variableImEEvT_S2_(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
...
define %struct.Memory* @routine_jmpq_.L_40a3d3(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
