...
declare %struct.Memory* @sub_40dbc0._ZN24custom_multiply_variableImE8do_shiftEmm(%struct.State* dereferenceable(3376), i64, %struct.Memory*)

declare %struct.Memory* @sub_40dbe0._Z26check_shifted_variable_sumIm24custom_multiply_variableImEEvT_S2_(%struct.State* dereferenceable(3376), i64, %struct.Memory*)
...
define %struct.Memory* @_Z14test_variable1Im24custom_multiply_variableImEEvPT_iS2_PKc(%struct.State* noalias, i64, %struct.Memory* noalias) #1 {
entry:
