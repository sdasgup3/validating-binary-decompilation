...
declare %struct.Memory* @sub_411440._ZN18custom_variable_orIsE8do_shiftEss(%struct.State* noalias dereferenceable(3376), i64, %struct.Memory* noalias readnone returned) local_unnamed_addr

declare %struct.Memory* @sub_411470._Z26check_shifted_variable_sumIs18custom_variable_orIsEEvT_S2_(%struct.State* noalias dereferenceable(3376), i64, %struct.Memory* noalias readnone returned) local_unnamed_addr
...
entry:
  ...
  %call2_405eca = tail call %struct.Memory* @sub_400e10._Z11start_timerv(%struct.State* %0, i64 %67, %struct.Memory* %2)
...
block_.L_405ed6:                                  ; preds = %block_.L_405f35, %entry
  %77 = phi i64 [ %.pre, %entry ], [ %305, %block_.L_405f35 ]
  %MEMORY.0 = phi %struct.Memory* [ %call2_405eca, %entry ], [ %call2_405f40, %block_.L_405f35 ]
  ...
  br i1 %110, label %block_405ee6, label %block_.L_405f53

block_405ee6:                                     ; preds = %block_.L_405ed6
  %112 = add i64 %78, -30
  %113 = add i64 %111, 6
  ...
  br label %block_.L_405ef3

block_.L_405ef3:                                  ; preds = %block_405eff, %block_405ee6
  %120 = phi i64 [ %.pre1, %block_405ee6 ], [ %255, %block_405eff ]
  %MEMORY.1 = phi %struct.Memory* [ %MEMORY.0, %block_405ee6 ], [ %call2_405f12, %block_405eff ]
  ...
  br i1 %156, label %block_405eff, label %block_.L_405f35

block_405eff:                                     ; preds = %block_.L_405ef3
  %158 = add i64 %121, -8
  %159 = add i64 %157, 4
  ...
  %call2_405f12 = tail call %struct.Memory* @sub_411440._ZN18custom_variable_orIsE8do_shiftEss(%struct.State* %0, i64 %178, %struct.Memory* %MEMORY.1)
...
block_.L_405f35:                                  ; preds = %block_.L_405ef3
  %256 = add i64 %121, -30
  %257 = add i64 %157, 4
  ...
  %call2_405f40 = tail call %struct.Memory* @sub_411470._Z26check_shifted_variable_sumIs18custom_variable_orIsEEvT_S2_(%struct.State* %0, i64 %268, %struct.Memory* %MEMORY.1)
...
block_.L_405f53:                                  ; preds = %block_.L_405ed6
  %306 = add i64 %111, -20771
  %307 = add i64 %111, 5
  ...
  %call2_405f53 = tail call %struct.Memory* @sub_400e30._Z5timerv(%struct.State* %0, i64 %306, %struct.Memory* %MEMORY.0)
  ...
  %call2_405f5c = tail call %struct.Memory* @sub_4007d0._Z13record_resultdPKc(%struct.State* %0, i64 %317, %struct.Memory* %call2_405f53)
  ...
  ret %struct.Memory* %call2_405f5c
}
...
define %struct.Memory* @routine_jge_.L_405f53(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i8* %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
...
define %struct.Memory* @routine_jge_.L_405f35(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i8* %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 2, i32 9
...
define %struct.Memory* @routine_callq_._ZN18custom_variable_orIsE8do_shiftEss(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
...
define %struct.Memory* @routine_jmpq_.L_405ef3(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
...
define %struct.Memory* @routine_callq_._Z26check_shifted_variable_sumIs18custom_variable_orIsEEvT_S2_(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
...
define %struct.Memory* @routine_jmpq_.L_405ed6(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
