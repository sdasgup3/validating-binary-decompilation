...
block_.L_405ed6:                                  ; preds = %block_.L_405f35, %entry
  %77 = phi i64 [ %.pre, %entry ], [ %303, %block_.L_405f35 ]
...
block_.L_405ef3:                                  ; preds = %block_405eff, %block_405ee6
  %120 = phi i64 [ %.pre1, %block_405ee6 ], [ %254, %block_405eff ]
...
block_.L_405f35:                                  ; preds = %block_.L_405ef3
  ...
  %call2_405f40 = tail call %struct.Memory* @sub_411470._Z26check_shifted_variable_sumIs18custom_variable_orIsEEvT_S2_(%struct.State* %0, i64 %267, %struct.Memory* %MEMORY.1)
...
block_.L_405f53:                                  ; preds = %block_.L_405ed6
  ...
  %call2_405f53 = tail call %struct.Memory* @sub_400e30._Z5timerv(%struct.State* %0, i64 %304, %struct.Memory* %MEMORY.0)
  ...
  %call2_405f5c = tail call %struct.Memory* @sub_4007d0._Z13record_resultdPKc(%struct.State* %0, i64 %315, %struct.Memory* %call2_405f53)
