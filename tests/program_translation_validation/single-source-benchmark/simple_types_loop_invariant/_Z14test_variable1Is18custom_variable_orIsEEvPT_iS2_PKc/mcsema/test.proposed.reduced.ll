; ModuleID = '/tmp/tmpx7srtcbw-query.ll'
...
define %struct.Memory* @_Z14test_variable1Is18custom_variable_orIsEEvPT_iS2_PKc(%struct.State* noalias nocapture readonly, i64, %struct.Memory* noalias readnone returned) local_unnamed_addr #1 {
entry:
