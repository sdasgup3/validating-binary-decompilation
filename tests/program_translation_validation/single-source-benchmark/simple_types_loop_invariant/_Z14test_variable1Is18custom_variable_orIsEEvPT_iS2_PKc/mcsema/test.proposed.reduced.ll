; ModuleID = '/tmp/tmpr03m3ggg-query.ll'
...
define %struct.Memory* @_Z14test_variable1Is18custom_variable_orIsEEvPT_iS2_PKc(%struct.State* noalias, i64, %struct.Memory* noalias readnone returned) local_unnamed_addr #1 {
entry:
  %var_2_3 = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %RBP.i = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 15, i32 0, i32 0
  %var_2_66 = load i64, i64* %var_2_3, align 8
  %var_2_67 = add i64 %var_2_66, -20650
  %call2_405f0a = tail call %struct.Memory* @sub_400e60._Z11start_timerv(%struct.State* %0, i64 %var_2_67, %struct.Memory* %2)
  ...
  br i1 %var_2_11015, label %block_405f26.preheader, label %block_.L_405f93

block_405f26.preheader:                           ; preds = %entry
  ...
  br i1 %var_2_156, label %block_.L_405f33.preheader, label %block_405f26.preheader5

block_405f26.preheader5:                          ; preds = %block_405f26.preheader
  br label %block_405f26

block_.L_405f33.preheader:                        ; preds = %block_405f26.preheader
  br label %block_.L_405f33

block_405f26:                                     ; preds = %block_405f26.preheader5, %block_405f26
  br label %block_405f26

block_.L_405f33:                                  ; preds = %block_.L_405f33.preheader, %block_.L_405f33
  br label %block_.L_405f33

block_.L_405f93:                                  ; preds = %entry
  %.pre = load i64, i64* %var_2_3, align 8
  %var_2_305 = add i64 %.pre, -20630
  %call2_405f93 = tail call %struct.Memory* @sub_400e80._Z5timerv(%struct.State* nonnull %0, i64 %var_2_305, %struct.Memory* %call2_405f0a)
  %var_2_312 = load i64, i64* %var_2_3, align 8
  %var_2_316 = add i64 %var_2_312, -22392
  %call2_405f9c = tail call %struct.Memory* @sub_400820._Z13record_resultdPKc(%struct.State* nonnull %0, i64 %var_2_316, %struct.Memory* %call2_405f93)
