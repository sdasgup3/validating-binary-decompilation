...
declare %struct.Memory* @sub_412160._ZN19custom_add_variableIsE8do_shiftEss(%struct.State* dereferenceable(3376), i64, %struct.Memory*) local_unnamed_addr

declare %struct.Memory* @sub_4120e0._Z26check_shifted_variable_sumIs19custom_add_variableIsEEvT_S2_(%struct.State* dereferenceable(3376), i64, %struct.Memory*) local_unnamed_addr
...
block_.L_405106:                                  ; preds = %block_.L_405165, %entry
  %77 = phi i64 [ %.pre, %entry ], [ %304, %block_.L_405165 ]
  %MEMORY.0 = phi %struct.Memory* [ %call2_4050fa, %entry ], [ %call2_405170, %block_.L_405165 ]
...
block_.L_405123:                                  ; preds = %block_40512f, %block_405116
  %120 = phi i64 [ %.pre6, %block_405116 ], [ %255, %block_40512f ]
  %MEMORY.1 = phi %struct.Memory* [ %MEMORY.0, %block_405116 ], [ %call2_405142, %block_40512f ]
...
block_40512f:                                     ; preds = %block_.L_405123
  ...
  %call2_405142 = tail call %struct.Memory* @sub_412160._ZN19custom_add_variableIsE8do_shiftEss(%struct.State* nonnull %0, i64 %178, %struct.Memory* %MEMORY.1)
...
block_.L_405165:                                  ; preds = %block_.L_405123
  ...
  %call2_405170 = tail call %struct.Memory* @sub_4120e0._Z26check_shifted_variable_sumIs19custom_add_variableIsEEvT_S2_(%struct.State* nonnull %0, i64 %268, %struct.Memory* %MEMORY.1)
...
block_.L_405183:                                  ; preds = %block_.L_405106
  ...
  %call2_405183 = tail call %struct.Memory* @sub_400e70._Z5timerv(%struct.State* nonnull %0, i64 %305, %struct.Memory* %MEMORY.0)
