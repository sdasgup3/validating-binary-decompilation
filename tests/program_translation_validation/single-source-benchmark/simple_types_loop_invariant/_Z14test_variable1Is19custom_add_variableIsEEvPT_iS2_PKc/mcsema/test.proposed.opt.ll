...
block_.L_4050d6:                                  ; preds = %block_.L_405135, %entry
  %77 = phi i64 [ %.pre, %entry ], [ %305, %block_.L_405135 ]
...
block_.L_4050f3:                                  ; preds = %block_4050ff, %block_4050e6
  %120 = phi i64 [ %.pre1, %block_4050e6 ], [ %255, %block_4050ff ]
...
block_.L_405135:                                  ; preds = %block_.L_4050f3
  ...
  %call2_405140 = tail call %struct.Memory* @sub_4120b0._Z26check_shifted_variable_sumIs19custom_add_variableIsEEvT_S2_(%struct.State* %0, i64 %268, %struct.Memory* %MEMORY.1)
...
block_.L_405153:                                  ; preds = %block_.L_4050d6
  ...
  %call2_405153 = tail call %struct.Memory* @sub_400e30._Z5timerv(%struct.State* %0, i64 %306, %struct.Memory* %MEMORY.0)
  ...
  %call2_40515c = tail call %struct.Memory* @sub_4007d0._Z13record_resultdPKc(%struct.State* %0, i64 %317, %struct.Memory* %call2_405153)
