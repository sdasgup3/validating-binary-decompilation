...
define %struct.Memory* @_Z14test_variable1Is19custom_sub_variableIsEEvPT_iS2_PKc(%struct.State* noalias, i64, %struct.Memory* noalias) #1 {
entry:
  ...
  store i64 %91, i64* %94
  store %struct.Memory* %loadMem_40539b, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_4053a6, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem1_4053aa, %struct.Memory** %MEMORY
...
block_.L_4053b6:                                  ; preds = %block_.L_405415, %entry
...
block_4053c6:                                     ; preds = %block_.L_4053b6
...
block_.L_4053d3:                                  ; preds = %block_4053df, %block_4053c6
  ...
  store %struct.Memory* %loadMem_4053d3, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_4053d9, %struct.Memory** %MEMORY
...
block_4053df:                                     ; preds = %block_.L_4053d3
  ...
  store %struct.Memory* %loadMem_4053e7, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_4053eb, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_4053ee, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem1_4053f2, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_4053fa, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_405400, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_405403, %struct.Memory** %MEMORY
...
block_.L_405415:                                  ; preds = %block_.L_4053d3
  ...
  store %struct.Memory* %loadMem_405415, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_405419, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_40541c, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem1_405420, %struct.Memory** %MEMORY
...
block_.L_405433:                                  ; preds = %block_.L_4053b6
  ...
  store %struct.Memory* %loadMem1_40543c, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_405445, %struct.Memory** %MEMORY
  ...
  ret %struct.Memory* %loadMem_405446
}
