...
block_.L_405386:                                  ; preds = %block_.L_4053e5, %entry
  %77 = phi i64 [ %.pre, %entry ], [ %305, %block_.L_4053e5 ]
...
block_.L_4053a3:                                  ; preds = %block_4053af, %block_405396
  %120 = phi i64 [ %.pre1, %block_405396 ], [ %255, %block_4053af ]
...
block_.L_4053e5:                                  ; preds = %block_.L_4053a3
  ...
  %call2_4053f0 = tail call %struct.Memory* @sub_411f10._Z26check_shifted_variable_sumIs19custom_sub_variableIsEEvT_S2_(%struct.State* %0, i64 %268, %struct.Memory* %MEMORY.1)
...
block_.L_405403:                                  ; preds = %block_.L_405386
  ...
  %call2_405403 = tail call %struct.Memory* @sub_400e30._Z5timerv(%struct.State* %0, i64 %306, %struct.Memory* %MEMORY.0)
  ...
  %call2_40540c = tail call %struct.Memory* @sub_4007d0._Z13record_resultdPKc(%struct.State* %0, i64 %317, %struct.Memory* %call2_405403)
