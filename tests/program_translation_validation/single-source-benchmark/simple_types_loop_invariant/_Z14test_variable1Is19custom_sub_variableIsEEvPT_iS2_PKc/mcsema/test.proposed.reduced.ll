; ModuleID = '/tmp/tmplqnh_9vh-query.ll'
...
define %struct.Memory* @_Z14test_variable1Is19custom_sub_variableIsEEvPT_iS2_PKc(%struct.State* noalias nocapture readonly, i64, %struct.Memory* noalias readnone returned) local_unnamed_addr #1 {
entry:
