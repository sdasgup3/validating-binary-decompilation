...
declare %struct.Memory* @sub_411640._Z26check_shifted_variable_sumIs19custom_variable_andIsEEvT_S2_(%struct.State* noalias dereferenceable(3376), i64, %struct.Memory* noalias readnone returned) local_unnamed_addr
...
entry:
  ...
  %call2_405cda = tail call %struct.Memory* @sub_400e10._Z11start_timerv(%struct.State* %0, i64 %67, %struct.Memory* %2)
...
block_.L_405ce6:                                  ; preds = %block_.L_405d45, %entry
  %77 = phi i64 [ %.pre, %entry ], [ %305, %block_.L_405d45 ]
  %MEMORY.0 = phi %struct.Memory* [ %call2_405cda, %entry ], [ %call2_405d50, %block_.L_405d45 ]
  ...
  br i1 %110, label %block_405cf6, label %block_.L_405d63

block_405cf6:                                     ; preds = %block_.L_405ce6
  %112 = add i64 %78, -30
  %113 = add i64 %111, 6
...
block_.L_405d03:                                  ; preds = %block_405d0f, %block_405cf6
  %120 = phi i64 [ %.pre1, %block_405cf6 ], [ %255, %block_405d0f ]
  %MEMORY.1 = phi %struct.Memory* [ %MEMORY.0, %block_405cf6 ], [ %call2_405d22, %block_405d0f ]
  ...
  br i1 %156, label %block_405d0f, label %block_.L_405d45

block_405d0f:                                     ; preds = %block_.L_405d03
  %158 = add i64 %121, -8
  %159 = add i64 %157, 4
  ...
  %call2_405d22 = tail call %struct.Memory* @sub_411610._ZN19custom_variable_andIsE8do_shiftEss(%struct.State* %0, i64 %178, %struct.Memory* %MEMORY.1)
...
block_.L_405d45:                                  ; preds = %block_.L_405d03
  %256 = add i64 %121, -30
  %257 = add i64 %157, 4
  ...
  %call2_405d50 = tail call %struct.Memory* @sub_411640._Z26check_shifted_variable_sumIs19custom_variable_andIsEEvT_S2_(%struct.State* %0, i64 %268, %struct.Memory* %MEMORY.1)
...
block_.L_405d63:                                  ; preds = %block_.L_405ce6
  %306 = add i64 %111, -20275
  %307 = add i64 %111, 5
  ...
  %call2_405d63 = tail call %struct.Memory* @sub_400e30._Z5timerv(%struct.State* %0, i64 %306, %struct.Memory* %MEMORY.0)
  ...
  store i64 %316, i64* %RDI.i91, align 8
  %317 = add i64 %313, -21912
  %318 = add i64 %313, 9
  ...
  %call2_405d6c = tail call %struct.Memory* @sub_4007d0._Z13record_resultdPKc(%struct.State* %0, i64 %317, %struct.Memory* %call2_405d63)
  %322 = load i64, i64* %RSP.i99, align 8
  %323 = load i64, i64* %PC.i, align 8
  %324 = add i64 %322, 48
  store i64 %324, i64* %RSP.i99, align 8
  %325 = icmp ugt i64 %322, -49
  ...
  %348 = add i64 %322, 56
  %349 = inttoptr i64 %324 to i64*
  %350 = load i64, i64* %349, align 8
  store i64 %350, i64* %RBP.i, align 8
  ...
  ret %struct.Memory* %call2_405d6c
}
...
define %struct.Memory* @routine_jge_.L_405d63(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i8* %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
...
define %struct.Memory* @routine_jge_.L_405d45(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i8* %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 2, i32 9
...
define %struct.Memory* @routine_jmpq_.L_405d03(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
...
define %struct.Memory* @routine_callq_._Z26check_shifted_variable_sumIs19custom_variable_andIsEEvT_S2_(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
...
define %struct.Memory* @routine_jmpq_.L_405ce6(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
