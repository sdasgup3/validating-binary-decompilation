...
declare %struct.Memory* @sub_411640._ZN19custom_variable_andIsE8do_shiftEss(%struct.State* dereferenceable(3376), i64, %struct.Memory*) local_unnamed_addr

declare %struct.Memory* @sub_411670._Z26check_shifted_variable_sumIs19custom_variable_andIsEEvT_S2_(%struct.State* dereferenceable(3376), i64, %struct.Memory*) local_unnamed_addr
...
define %struct.Memory* @_Z14test_variable1Is19custom_variable_andIsEEvPT_iS2_PKc(%struct.State* noalias, i64, %struct.Memory* noalias) local_unnamed_addr #1 {
entry:
...
block_.L_405d16:                                  ; preds = %block_.L_405d75, %entry
  %77 = phi i64 [ %.pre, %entry ], [ %304, %block_.L_405d75 ]
  %MEMORY.0 = phi %struct.Memory* [ %call2_405d0a, %entry ], [ %call2_405d80, %block_.L_405d75 ]
...
block_.L_405d33:                                  ; preds = %block_405d3f, %block_405d26
  %120 = phi i64 [ %.pre6, %block_405d26 ], [ %255, %block_405d3f ]
  %MEMORY.1 = phi %struct.Memory* [ %MEMORY.0, %block_405d26 ], [ %call2_405d52, %block_405d3f ]
...
block_405d3f:                                     ; preds = %block_.L_405d33
  ...
  %call2_405d52 = tail call %struct.Memory* @sub_411640._ZN19custom_variable_andIsE8do_shiftEss(%struct.State* nonnull %0, i64 %178, %struct.Memory* %MEMORY.1)
...
block_.L_405d75:                                  ; preds = %block_.L_405d33
  ...
  %call2_405d80 = tail call %struct.Memory* @sub_411670._Z26check_shifted_variable_sumIs19custom_variable_andIsEEvT_S2_(%struct.State* nonnull %0, i64 %268, %struct.Memory* %MEMORY.1)
...
block_.L_405d93:                                  ; preds = %block_.L_405d16
  ...
  %call2_405d93 = tail call %struct.Memory* @sub_400e70._Z5timerv(%struct.State* nonnull %0, i64 %305, %struct.Memory* %MEMORY.0)
