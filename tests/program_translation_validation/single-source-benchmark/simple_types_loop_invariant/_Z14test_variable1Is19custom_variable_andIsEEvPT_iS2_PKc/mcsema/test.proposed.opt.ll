...
block_.L_405ce6:                                  ; preds = %block_.L_405d45, %entry
  %77 = phi i64 [ %.pre, %entry ], [ %303, %block_.L_405d45 ]
...
block_.L_405d03:                                  ; preds = %block_405d0f, %block_405cf6
  %120 = phi i64 [ %.pre1, %block_405cf6 ], [ %254, %block_405d0f ]
...
block_.L_405d45:                                  ; preds = %block_.L_405d03
  ...
  %call2_405d50 = tail call %struct.Memory* @sub_411640._Z26check_shifted_variable_sumIs19custom_variable_andIsEEvT_S2_(%struct.State* %0, i64 %267, %struct.Memory* %MEMORY.1)
...
block_.L_405d63:                                  ; preds = %block_.L_405ce6
  ...
  %call2_405d63 = tail call %struct.Memory* @sub_400e30._Z5timerv(%struct.State* %0, i64 %304, %struct.Memory* %MEMORY.0)
  ...
  %call2_405d6c = tail call %struct.Memory* @sub_4007d0._Z13record_resultdPKc(%struct.State* %0, i64 %315, %struct.Memory* %call2_405d63)
