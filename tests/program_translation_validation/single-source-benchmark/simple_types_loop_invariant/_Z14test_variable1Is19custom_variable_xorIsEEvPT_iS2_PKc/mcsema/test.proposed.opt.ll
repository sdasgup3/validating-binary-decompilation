...
declare %struct.Memory* @sub_4112e0._Z26check_shifted_variable_sumIs19custom_variable_xorIsEEvT_S2_(%struct.State* noalias dereferenceable(3376), i64, %struct.Memory* noalias readnone returned) local_unnamed_addr
...
entry:
  ...
  %call2_4060fa = tail call %struct.Memory* @sub_400e60._Z11start_timerv(%struct.State* %0, i64 %67, %struct.Memory* %2)
...
block_.L_406106:                                  ; preds = %block_.L_406165, %entry
  %77 = phi i64 [ %304, %block_.L_406165 ], [ %.pre, %entry ]
  ...
  br i1 %110, label %block_406116, label %block_.L_406183
...
block_.L_406123:                                  ; preds = %block_40612f, %block_406116
  %120 = phi i64 [ %255, %block_40612f ], [ %.pre6, %block_406116 ]
  ...
  br i1 %156, label %block_40612f, label %block_.L_406165
...
block_40612f:                                     ; preds = %block_.L_406123
  ...
  %call2_406142 = tail call %struct.Memory* @sub_4112b0._ZN19custom_variable_xorIsE8do_shiftEss(%struct.State* nonnull %0, i64 %178, %struct.Memory* %call2_4060fa)
...
block_.L_406165:                                  ; preds = %block_.L_406123
  ...
  %call2_406170 = tail call %struct.Memory* @sub_4112e0._Z26check_shifted_variable_sumIs19custom_variable_xorIsEEvT_S2_(%struct.State* nonnull %0, i64 %268, %struct.Memory* %call2_4060fa)
...
block_.L_406183:                                  ; preds = %block_.L_406106
  ...
  %call2_406183 = tail call %struct.Memory* @sub_400e80._Z5timerv(%struct.State* nonnull %0, i64 %305, %struct.Memory* %call2_4060fa)
  ...
  %call2_40618c = tail call %struct.Memory* @sub_400820._Z13record_resultdPKc(%struct.State* nonnull %0, i64 %316, %struct.Memory* %call2_406183)
