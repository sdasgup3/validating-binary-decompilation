...
declare %struct.Memory* @sub_4112a0._Z26check_shifted_variable_sumIs19custom_variable_xorIsEEvT_S2_(%struct.State* noalias dereferenceable(3376), i64, %struct.Memory* noalias readnone returned) local_unnamed_addr
...
define %struct.Memory* @_Z14test_variable1Is19custom_variable_xorIsEEvPT_iS2_PKc(%struct.State* noalias, i64, %struct.Memory* noalias) local_unnamed_addr #1 {
entry:
  ...
  %call2_4060ba = tail call %struct.Memory* @sub_400e10._Z11start_timerv(%struct.State* %0, i64 %67, %struct.Memory* %2)
...
block_.L_4060c6:                                  ; preds = %block_.L_406125, %entry
  %77 = phi i64 [ %.pre, %entry ], [ %305, %block_.L_406125 ]
  %MEMORY.0 = phi %struct.Memory* [ %call2_4060ba, %entry ], [ %call2_406130, %block_.L_406125 ]
  ...
  br i1 %110, label %block_4060d6, label %block_.L_406143

block_4060d6:                                     ; preds = %block_.L_4060c6
  %112 = add i64 %78, -30
  %113 = add i64 %111, 6
...
block_.L_4060e3:                                  ; preds = %block_4060ef, %block_4060d6
  %120 = phi i64 [ %.pre1, %block_4060d6 ], [ %255, %block_4060ef ]
  %MEMORY.1 = phi %struct.Memory* [ %MEMORY.0, %block_4060d6 ], [ %call2_406102, %block_4060ef ]
  ...
  br i1 %156, label %block_4060ef, label %block_.L_406125

block_4060ef:                                     ; preds = %block_.L_4060e3
  %158 = add i64 %121, -8
  %159 = add i64 %157, 4
  ...
  %call2_406102 = tail call %struct.Memory* @sub_411270._ZN19custom_variable_xorIsE8do_shiftEss(%struct.State* %0, i64 %178, %struct.Memory* %MEMORY.1)
...
block_.L_406125:                                  ; preds = %block_.L_4060e3
  %256 = add i64 %121, -30
  %257 = add i64 %157, 4
  ...
  %call2_406130 = tail call %struct.Memory* @sub_4112a0._Z26check_shifted_variable_sumIs19custom_variable_xorIsEEvT_S2_(%struct.State* %0, i64 %268, %struct.Memory* %MEMORY.1)
...
block_.L_406143:                                  ; preds = %block_.L_4060c6
  %306 = add i64 %111, -21267
  %307 = add i64 %111, 5
  ...
  %call2_406143 = tail call %struct.Memory* @sub_400e30._Z5timerv(%struct.State* %0, i64 %306, %struct.Memory* %MEMORY.0)
  ...
  %call2_40614c = tail call %struct.Memory* @sub_4007d0._Z13record_resultdPKc(%struct.State* %0, i64 %317, %struct.Memory* %call2_406143)
  ...
  ret %struct.Memory* %call2_40614c
}
...
define %struct.Memory* @routine_jge_.L_406143(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i8* %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
...
define %struct.Memory* @routine_jge_.L_406125(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i8* %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 2, i32 9
...
define %struct.Memory* @routine_jmpq_.L_4060e3(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
...
define %struct.Memory* @routine_callq_._Z26check_shifted_variable_sumIs19custom_variable_xorIsEEvT_S2_(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
...
define %struct.Memory* @routine_jmpq_.L_4060c6(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
