...
block_.L_4060c6:                                  ; preds = %block_.L_406125, %entry
  %77 = phi i64 [ %.pre, %entry ], [ %303, %block_.L_406125 ]
...
block_.L_4060e3:                                  ; preds = %block_4060ef, %block_4060d6
  %120 = phi i64 [ %.pre1, %block_4060d6 ], [ %254, %block_4060ef ]
...
block_.L_406125:                                  ; preds = %block_.L_4060e3
  ...
  %call2_406130 = tail call %struct.Memory* @sub_4112a0._Z26check_shifted_variable_sumIs19custom_variable_xorIsEEvT_S2_(%struct.State* %0, i64 %267, %struct.Memory* %MEMORY.1)
...
block_.L_406143:                                  ; preds = %block_.L_4060c6
  ...
  %call2_406143 = tail call %struct.Memory* @sub_400e30._Z5timerv(%struct.State* %0, i64 %304, %struct.Memory* %MEMORY.0)
  ...
  %call2_40614c = tail call %struct.Memory* @sub_4007d0._Z13record_resultdPKc(%struct.State* %0, i64 %315, %struct.Memory* %call2_406143)
