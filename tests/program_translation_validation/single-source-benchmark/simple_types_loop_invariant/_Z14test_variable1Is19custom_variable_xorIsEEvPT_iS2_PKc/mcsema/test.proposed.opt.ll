...
declare %struct.Memory* @sub_4112d0._Z26check_shifted_variable_sumIs19custom_variable_xorIsEEvT_S2_(%struct.State* dereferenceable(3376), i64, %struct.Memory*) local_unnamed_addr
...
entry:
  ...
  %call2_4060ea = tail call %struct.Memory* @sub_400e50._Z11start_timerv(%struct.State* %0, i64 %67, %struct.Memory* %2)
...
block_.L_4060f6:                                  ; preds = %block_.L_406155, %entry
  %77 = phi i64 [ %.pre, %entry ], [ %304, %block_.L_406155 ]
  %MEMORY.0 = phi %struct.Memory* [ %call2_4060ea, %entry ], [ %call2_406160, %block_.L_406155 ]
  ...
  br i1 %110, label %block_406106, label %block_.L_406173

block_406106:                                     ; preds = %block_.L_4060f6
  %112 = add i64 %78, -30
  %113 = add i64 %111, 6
...
block_.L_406113:                                  ; preds = %block_40611f, %block_406106
  %120 = phi i64 [ %.pre6, %block_406106 ], [ %255, %block_40611f ]
  %MEMORY.1 = phi %struct.Memory* [ %MEMORY.0, %block_406106 ], [ %call2_406132, %block_40611f ]
  ...
  br i1 %156, label %block_40611f, label %block_.L_406155

block_40611f:                                     ; preds = %block_.L_406113
  %158 = add i64 %121, -8
  %159 = add i64 %157, 4
  ...
  %call2_406132 = tail call %struct.Memory* @sub_4112a0._ZN19custom_variable_xorIsE8do_shiftEss(%struct.State* nonnull %0, i64 %178, %struct.Memory* %MEMORY.1)
...
block_.L_406155:                                  ; preds = %block_.L_406113
  %256 = add i64 %121, -30
  %257 = add i64 %157, 4
  ...
  %call2_406160 = tail call %struct.Memory* @sub_4112d0._Z26check_shifted_variable_sumIs19custom_variable_xorIsEEvT_S2_(%struct.State* nonnull %0, i64 %268, %struct.Memory* %MEMORY.1)
...
block_.L_406173:                                  ; preds = %block_.L_4060f6
  %305 = add i64 %111, -21251
  %306 = add i64 %111, 5
  ...
  %call2_406173 = tail call %struct.Memory* @sub_400e70._Z5timerv(%struct.State* nonnull %0, i64 %305, %struct.Memory* %MEMORY.0)
  ...
  %call2_40617c = tail call %struct.Memory* @sub_400810._Z13record_resultdPKc(%struct.State* nonnull %0, i64 %316, %struct.Memory* %call2_406173)
  ...
  ret %struct.Memory* %call2_40617c
}
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_jge_.L_406173(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i8* nocapture %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_jge_.L_406155(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i8* nocapture %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 2, i32 9
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_jmpq_.L_406113(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_jmpq_.L_4060f6(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
