...
block_.L_405896:                                  ; preds = %block_.L_4058f5, %entry
  %77 = phi i64 [ %.pre, %entry ], [ %303, %block_.L_4058f5 ]
...
block_.L_4058b3:                                  ; preds = %block_4058bf, %block_4058a6
  %120 = phi i64 [ %.pre1, %block_4058a6 ], [ %254, %block_4058bf ]
...
block_.L_4058f5:                                  ; preds = %block_.L_4058b3
  ...
  %call2_405900 = tail call %struct.Memory* @sub_411a50._Z26check_shifted_variable_sumIs22custom_divide_variableIsEEvT_S2_(%struct.State* %0, i64 %267, %struct.Memory* %MEMORY.1)
...
block_.L_405913:                                  ; preds = %block_.L_405896
  ...
  %call2_405913 = tail call %struct.Memory* @sub_400e30._Z5timerv(%struct.State* %0, i64 %304, %struct.Memory* %MEMORY.0)
  ...
  %call2_40591c = tail call %struct.Memory* @sub_4007d0._Z13record_resultdPKc(%struct.State* %0, i64 %315, %struct.Memory* %call2_405913)
