...
declare %struct.Memory* @sub_411a50._ZN22custom_divide_variableIsE8do_shiftEss(%struct.State* noalias dereferenceable(3376), i64, %struct.Memory* noalias readnone returned) local_unnamed_addr

declare %struct.Memory* @sub_411a80._Z26check_shifted_variable_sumIs22custom_divide_variableIsEEvT_S2_(%struct.State* noalias dereferenceable(3376), i64, %struct.Memory* noalias readnone returned) local_unnamed_addr
...
block_.L_4058c6:                                  ; preds = %block_.L_405925, %entry
  %77 = phi i64 [ %304, %block_.L_405925 ], [ %.pre, %entry ]
...
block_.L_4058e3:                                  ; preds = %block_4058ef, %block_4058d6
  %120 = phi i64 [ %255, %block_4058ef ], [ %.pre6, %block_4058d6 ]
...
block_4058ef:                                     ; preds = %block_.L_4058e3
  ...
  %call2_405902 = tail call %struct.Memory* @sub_411a50._ZN22custom_divide_variableIsE8do_shiftEss(%struct.State* nonnull %0, i64 %178, %struct.Memory* %call2_4058ba)
...
block_.L_405925:                                  ; preds = %block_.L_4058e3
  ...
  %call2_405930 = tail call %struct.Memory* @sub_411a80._Z26check_shifted_variable_sumIs22custom_divide_variableIsEEvT_S2_(%struct.State* nonnull %0, i64 %268, %struct.Memory* %call2_4058ba)
...
block_.L_405943:                                  ; preds = %block_.L_4058c6
  ...
  %call2_405943 = tail call %struct.Memory* @sub_400e70._Z5timerv(%struct.State* nonnull %0, i64 %305, %struct.Memory* %call2_4058ba)
