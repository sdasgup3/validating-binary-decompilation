; ModuleID = '/tmp/tmpmmdagha7-query.ll'
...
define %struct.Memory* @_Z14test_variable1Is22custom_divide_variableIsEEvPT_iS2_PKc(%struct.State* noalias, i64, %struct.Memory* noalias readnone returned) local_unnamed_addr #1 {
entry:
  %var_2_3 = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %RBP.i = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 15, i32 0, i32 0
  %var_2_66 = load i64, i64* %var_2_3, align 8
  %var_2_67 = add i64 %var_2_66, -19050
  %call2_4058ca = tail call %struct.Memory* @sub_400e60._Z11start_timerv(%struct.State* %0, i64 %var_2_67, %struct.Memory* %2)
  ...
  br i1 %var_2_11015, label %block_4058e6.preheader, label %block_.L_405953

block_4058e6.preheader:                           ; preds = %entry
  ...
  br i1 %var_2_156, label %block_.L_4058f3.preheader, label %block_4058e6.preheader5

block_4058e6.preheader5:                          ; preds = %block_4058e6.preheader
  br label %block_4058e6

block_.L_4058f3.preheader:                        ; preds = %block_4058e6.preheader
  br label %block_.L_4058f3

block_4058e6:                                     ; preds = %block_4058e6.preheader5, %block_4058e6
  br label %block_4058e6

block_.L_4058f3:                                  ; preds = %block_.L_4058f3.preheader, %block_.L_4058f3
  br label %block_.L_4058f3

block_.L_405953:                                  ; preds = %entry
  %.pre = load i64, i64* %var_2_3, align 8
  %var_2_305 = add i64 %.pre, -19030
  %call2_405953 = tail call %struct.Memory* @sub_400e80._Z5timerv(%struct.State* nonnull %0, i64 %var_2_305, %struct.Memory* %call2_4058ca)
  %var_2_312 = load i64, i64* %var_2_3, align 8
  %var_2_316 = add i64 %var_2_312, -20792
  %call2_40595c = tail call %struct.Memory* @sub_400820._Z13record_resultdPKc(%struct.State* nonnull %0, i64 %var_2_316, %struct.Memory* %call2_405953)
