; ModuleID = '/tmp/tmpmngqr3sl-query.ll'
...
define %struct.Memory* @_Z14test_variable1Is22custom_divide_variableIsEEvPT_iS2_PKc(%struct.State* noalias nocapture readonly, i64, %struct.Memory* noalias readnone returned) local_unnamed_addr #1 {
entry:
