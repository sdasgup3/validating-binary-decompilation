...
declare %struct.Memory* @sub_411d40._ZN24custom_multiply_variableIsE8do_shiftEss(%struct.State* noalias dereferenceable(3376), i64, %struct.Memory* noalias readnone returned) local_unnamed_addr

declare %struct.Memory* @sub_411d70._Z26check_shifted_variable_sumIs24custom_multiply_variableIsEEvT_S2_(%struct.State* noalias dereferenceable(3376), i64, %struct.Memory* noalias readnone returned) local_unnamed_addr
...
define %struct.Memory* @_Z14test_variable1Is24custom_multiply_variableIsEEvPT_iS2_PKc(%struct.State* noalias, i64, %struct.Memory* noalias readnone) local_unnamed_addr #1 {
entry:
...
block_.L_4055a6:                                  ; preds = %block_.L_405605, %entry
  %77 = phi i64 [ %304, %block_.L_405605 ], [ %.pre, %entry ]
...
block_.L_4055c3:                                  ; preds = %block_4055cf, %block_4055b6
  %120 = phi i64 [ %255, %block_4055cf ], [ %.pre6, %block_4055b6 ]
...
block_4055cf:                                     ; preds = %block_.L_4055c3
  ...
  %call2_4055e2 = tail call %struct.Memory* @sub_411d40._ZN24custom_multiply_variableIsE8do_shiftEss(%struct.State* nonnull %0, i64 %178, %struct.Memory* %call2_40559a)
...
block_.L_405605:                                  ; preds = %block_.L_4055c3
  ...
  %call2_405610 = tail call %struct.Memory* @sub_411d70._Z26check_shifted_variable_sumIs24custom_multiply_variableIsEEvT_S2_(%struct.State* nonnull %0, i64 %268, %struct.Memory* %call2_40559a)
...
block_.L_405623:                                  ; preds = %block_.L_4055a6
  ...
  %call2_405623 = tail call %struct.Memory* @sub_400e70._Z5timerv(%struct.State* nonnull %0, i64 %305, %struct.Memory* %call2_40559a)
