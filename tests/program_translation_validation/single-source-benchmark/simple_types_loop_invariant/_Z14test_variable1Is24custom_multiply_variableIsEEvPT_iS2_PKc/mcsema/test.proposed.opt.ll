...
declare %struct.Memory* @sub_411d80._Z26check_shifted_variable_sumIs24custom_multiply_variableIsEEvT_S2_(%struct.State* noalias dereferenceable(3376), i64, %struct.Memory* noalias readnone returned) local_unnamed_addr
...
entry:
  ...
  %call2_4055aa = tail call %struct.Memory* @sub_400e60._Z11start_timerv(%struct.State* %0, i64 %67, %struct.Memory* %2)
...
block_.L_4055b6:                                  ; preds = %block_.L_405615, %entry
  %77 = phi i64 [ %304, %block_.L_405615 ], [ %.pre, %entry ]
  ...
  br i1 %110, label %block_4055c6, label %block_.L_405633
...
block_.L_4055d3:                                  ; preds = %block_4055df, %block_4055c6
  %120 = phi i64 [ %255, %block_4055df ], [ %.pre6, %block_4055c6 ]
  ...
  br i1 %156, label %block_4055df, label %block_.L_405615
...
block_4055df:                                     ; preds = %block_.L_4055d3
  ...
  %call2_4055f2 = tail call %struct.Memory* @sub_411d50._ZN24custom_multiply_variableIsE8do_shiftEss(%struct.State* nonnull %0, i64 %178, %struct.Memory* %call2_4055aa)
...
block_.L_405615:                                  ; preds = %block_.L_4055d3
  ...
  %call2_405620 = tail call %struct.Memory* @sub_411d80._Z26check_shifted_variable_sumIs24custom_multiply_variableIsEEvT_S2_(%struct.State* nonnull %0, i64 %268, %struct.Memory* %call2_4055aa)
...
block_.L_405633:                                  ; preds = %block_.L_4055b6
  ...
  %call2_405633 = tail call %struct.Memory* @sub_400e80._Z5timerv(%struct.State* nonnull %0, i64 %305, %struct.Memory* %call2_4055aa)
  ...
  %call2_40563c = tail call %struct.Memory* @sub_400820._Z13record_resultdPKc(%struct.State* nonnull %0, i64 %316, %struct.Memory* %call2_405633)
