...
block_.L_4070f6:                                  ; preds = %block_.L_407155, %entry
  %77 = phi i64 [ %.pre, %entry ], [ %286, %block_.L_407155 ]
...
block_.L_407113:                                  ; preds = %block_40711f, %block_407106
  %120 = phi i64 [ %.pre1, %block_407106 ], [ %239, %block_40711f ]
...
block_.L_407155:                                  ; preds = %block_.L_407113
  ...
  %call2_407160 = tail call %struct.Memory* @sub_410480._Z26check_shifted_variable_sumIt18custom_variable_orItEEvT_S2_(%struct.State* %0, i64 %250, %struct.Memory* %MEMORY.1)
...
block_.L_407173:                                  ; preds = %block_.L_4070f6
  ...
  %call2_407173 = tail call %struct.Memory* @sub_400e30._Z5timerv(%struct.State* %0, i64 %287, %struct.Memory* %MEMORY.0)
  ...
  %call2_40717c = tail call %struct.Memory* @sub_4007d0._Z13record_resultdPKc(%struct.State* %0, i64 %298, %struct.Memory* %call2_407173)
