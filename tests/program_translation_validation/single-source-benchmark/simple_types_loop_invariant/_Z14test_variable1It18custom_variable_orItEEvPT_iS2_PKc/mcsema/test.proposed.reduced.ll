; ModuleID = '/tmp/tmpk7g9sq2_-query.ll'
...
define %struct.Memory* @_Z14test_variable1It18custom_variable_orItEEvPT_iS2_PKc(%struct.State* noalias nocapture readonly, i64, %struct.Memory* noalias readnone returned) local_unnamed_addr #1 {
entry:
