...
block_.L_4062f6:                                  ; preds = %block_.L_406355, %entry
  %77 = phi i64 [ %.pre, %entry ], [ %286, %block_.L_406355 ]
...
block_.L_406313:                                  ; preds = %block_40631f, %block_406306
  %120 = phi i64 [ %.pre1, %block_406306 ], [ %239, %block_40631f ]
...
block_.L_406355:                                  ; preds = %block_.L_406313
  ...
  %call2_406360 = tail call %struct.Memory* @sub_411040._Z26check_shifted_variable_sumIt19custom_add_variableItEEvT_S2_(%struct.State* %0, i64 %250, %struct.Memory* %MEMORY.1)
...
block_.L_406373:                                  ; preds = %block_.L_4062f6
  ...
  %call2_406373 = tail call %struct.Memory* @sub_400e30._Z5timerv(%struct.State* %0, i64 %287, %struct.Memory* %MEMORY.0)
  ...
  %call2_40637c = tail call %struct.Memory* @sub_4007d0._Z13record_resultdPKc(%struct.State* %0, i64 %298, %struct.Memory* %call2_406373)
