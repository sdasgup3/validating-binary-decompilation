...
declare %struct.Memory* @sub_4110f0._ZN19custom_add_variableItE8do_shiftEtt(%struct.State* noalias dereferenceable(3376), i64, %struct.Memory* noalias readnone returned) local_unnamed_addr
...
block_.L_406326:                                  ; preds = %block_.L_406385, %entry
  %77 = phi i64 [ %286, %block_.L_406385 ], [ %.pre, %entry ]
...
block_.L_406343:                                  ; preds = %block_40634f, %block_406336
  %120 = phi i64 [ %239, %block_40634f ], [ %.pre6, %block_406336 ]
...
block_40634f:                                     ; preds = %block_.L_406343
  ...
  %call2_406362 = tail call %struct.Memory* @sub_4110f0._ZN19custom_add_variableItE8do_shiftEtt(%struct.State* nonnull %0, i64 %176, %struct.Memory* %call2_40631a)
...
block_.L_406385:                                  ; preds = %block_.L_406343
  ...
  %call2_406390 = tail call %struct.Memory* @sub_411070._Z26check_shifted_variable_sumIt19custom_add_variableItEEvT_S2_(%struct.State* nonnull %0, i64 %250, %struct.Memory* %call2_40631a)
...
block_.L_4063a3:                                  ; preds = %block_.L_406326
  ...
  %call2_4063a3 = tail call %struct.Memory* @sub_400e70._Z5timerv(%struct.State* nonnull %0, i64 %287, %struct.Memory* %call2_40631a)
