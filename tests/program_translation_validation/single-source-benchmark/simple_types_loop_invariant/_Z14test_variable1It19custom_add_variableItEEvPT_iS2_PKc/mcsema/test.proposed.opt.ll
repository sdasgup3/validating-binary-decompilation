...
declare %struct.Memory* @sub_4110c0._ZN19custom_add_variableItE8do_shiftEtt(%struct.State* noalias dereferenceable(3376), i64, %struct.Memory* noalias readnone returned) local_unnamed_addr
...
entry:
  ...
  %call2_4062ea = tail call %struct.Memory* @sub_400e10._Z11start_timerv(%struct.State* %0, i64 %67, %struct.Memory* %2)
...
block_.L_4062f6:                                  ; preds = %block_.L_406355, %entry
  %77 = phi i64 [ %.pre, %entry ], [ %288, %block_.L_406355 ]
  %MEMORY.0 = phi %struct.Memory* [ %call2_4062ea, %entry ], [ %call2_406360, %block_.L_406355 ]
  ...
  br i1 %110, label %block_406306, label %block_.L_406373
...
block_.L_406313:                                  ; preds = %block_40631f, %block_406306
  %120 = phi i64 [ %.pre1, %block_406306 ], [ %240, %block_40631f ]
  %MEMORY.1 = phi %struct.Memory* [ %MEMORY.0, %block_406306 ], [ %call2_406332, %block_40631f ]
  ...
  br i1 %156, label %block_40631f, label %block_.L_406355
...
block_40631f:                                     ; preds = %block_.L_406313
  ...
  %call2_406332 = tail call %struct.Memory* @sub_4110c0._ZN19custom_add_variableItE8do_shiftEtt(%struct.State* %0, i64 %176, %struct.Memory* %MEMORY.1)
...
block_.L_406355:                                  ; preds = %block_.L_406313
  ...
  %call2_406360 = tail call %struct.Memory* @sub_411040._Z26check_shifted_variable_sumIt19custom_add_variableItEEvT_S2_(%struct.State* %0, i64 %251, %struct.Memory* %MEMORY.1)
...
block_.L_406373:                                  ; preds = %block_.L_4062f6
  ...
  %call2_406373 = tail call %struct.Memory* @sub_400e30._Z5timerv(%struct.State* %0, i64 %289, %struct.Memory* %MEMORY.0)
  ...
  %call2_40637c = tail call %struct.Memory* @sub_4007d0._Z13record_resultdPKc(%struct.State* %0, i64 %300, %struct.Memory* %call2_406373)
  ...
  ret %struct.Memory* %call2_40637c
}
...
define %struct.Memory* @routine_jge_.L_406373(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i8* %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
...
define %struct.Memory* @routine_jge_.L_406355(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i8* %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 2, i32 9
...
define %struct.Memory* @routine_callq_._ZN19custom_add_variableItE8do_shiftEtt(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
...
define %struct.Memory* @routine_jmpq_.L_406313(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
...
define %struct.Memory* @routine_jmpq_.L_4062f6(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
