...
declare %struct.Memory* @sub_410ec0._ZN19custom_sub_variableItE8do_shiftEtt(%struct.State* noalias dereferenceable(3376), i64, %struct.Memory* noalias readnone returned) local_unnamed_addr

declare %struct.Memory* @sub_410ef0._Z26check_shifted_variable_sumIt19custom_sub_variableItEEvT_S2_(%struct.State* noalias dereferenceable(3376), i64, %struct.Memory* noalias readnone returned) local_unnamed_addr
...
entry:
  ...
  %call2_4065da = tail call %struct.Memory* @sub_400e60._Z11start_timerv(%struct.State* %0, i64 %67, %struct.Memory* %2)
...
block_.L_4065e6:                                  ; preds = %block_.L_406645, %entry
  %77 = phi i64 [ %286, %block_.L_406645 ], [ %.pre, %entry ]
  ...
  br i1 %110, label %block_4065f6, label %block_.L_406663

block_4065f6:                                     ; preds = %block_.L_4065e6
  %112 = add i64 %78, -30
  %113 = add i64 %111, 6
...
block_.L_406603:                                  ; preds = %block_40660f, %block_4065f6
  %120 = phi i64 [ %239, %block_40660f ], [ %.pre6, %block_4065f6 ]
  ...
  br i1 %156, label %block_40660f, label %block_.L_406645

block_40660f:                                     ; preds = %block_.L_406603
  %158 = add i64 %121, -8
  %159 = add i64 %157, 4
  ...
  %call2_406622 = tail call %struct.Memory* @sub_410ec0._ZN19custom_sub_variableItE8do_shiftEtt(%struct.State* nonnull %0, i64 %176, %struct.Memory* %call2_4065da)
...
block_.L_406645:                                  ; preds = %block_.L_406603
  %240 = add i64 %121, -30
  %241 = add i64 %157, 4
  ...
  %call2_406650 = tail call %struct.Memory* @sub_410ef0._Z26check_shifted_variable_sumIt19custom_sub_variableItEEvT_S2_(%struct.State* nonnull %0, i64 %250, %struct.Memory* %call2_4065da)
...
block_.L_406663:                                  ; preds = %block_.L_4065e6
  ...
  %call2_406663 = tail call %struct.Memory* @sub_400e80._Z5timerv(%struct.State* nonnull %0, i64 %287, %struct.Memory* %call2_4065da)
  ...
  %call2_40666c = tail call %struct.Memory* @sub_400820._Z13record_resultdPKc(%struct.State* nonnull %0, i64 %298, %struct.Memory* %call2_406663)
