...
block_.L_4065a6:                                  ; preds = %block_.L_406605, %entry
  %77 = phi i64 [ %.pre, %entry ], [ %286, %block_.L_406605 ]
...
block_.L_4065c3:                                  ; preds = %block_4065cf, %block_4065b6
  %120 = phi i64 [ %.pre1, %block_4065b6 ], [ %239, %block_4065cf ]
...
block_.L_406605:                                  ; preds = %block_.L_4065c3
  ...
  %call2_406610 = tail call %struct.Memory* @sub_410eb0._Z26check_shifted_variable_sumIt19custom_sub_variableItEEvT_S2_(%struct.State* %0, i64 %250, %struct.Memory* %MEMORY.1)
...
block_.L_406623:                                  ; preds = %block_.L_4065a6
  ...
  %call2_406623 = tail call %struct.Memory* @sub_400e30._Z5timerv(%struct.State* %0, i64 %287, %struct.Memory* %MEMORY.0)
  ...
  %call2_40662c = tail call %struct.Memory* @sub_4007d0._Z13record_resultdPKc(%struct.State* %0, i64 %298, %struct.Memory* %call2_406623)
