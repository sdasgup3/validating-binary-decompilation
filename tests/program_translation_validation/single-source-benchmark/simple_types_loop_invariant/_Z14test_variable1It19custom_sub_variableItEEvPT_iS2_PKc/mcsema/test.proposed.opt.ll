...
declare %struct.Memory* @sub_410eb0._ZN19custom_sub_variableItE8do_shiftEtt(%struct.State* noalias dereferenceable(3376), i64, %struct.Memory* noalias readnone returned) local_unnamed_addr

declare %struct.Memory* @sub_410ee0._Z26check_shifted_variable_sumIt19custom_sub_variableItEEvT_S2_(%struct.State* noalias dereferenceable(3376), i64, %struct.Memory* noalias readnone returned) local_unnamed_addr
...
define %struct.Memory* @_Z14test_variable1It19custom_sub_variableItEEvPT_iS2_PKc(%struct.State* noalias, i64, %struct.Memory* noalias readnone) local_unnamed_addr #1 {
entry:
...
block_.L_4065d6:                                  ; preds = %block_.L_406635, %entry
  %77 = phi i64 [ %286, %block_.L_406635 ], [ %.pre, %entry ]
...
block_.L_4065f3:                                  ; preds = %block_4065ff, %block_4065e6
  %120 = phi i64 [ %239, %block_4065ff ], [ %.pre6, %block_4065e6 ]
...
block_4065ff:                                     ; preds = %block_.L_4065f3
  ...
  %call2_406612 = tail call %struct.Memory* @sub_410eb0._ZN19custom_sub_variableItE8do_shiftEtt(%struct.State* nonnull %0, i64 %176, %struct.Memory* %call2_4065ca)
...
block_.L_406635:                                  ; preds = %block_.L_4065f3
  ...
  %call2_406640 = tail call %struct.Memory* @sub_410ee0._Z26check_shifted_variable_sumIt19custom_sub_variableItEEvT_S2_(%struct.State* nonnull %0, i64 %250, %struct.Memory* %call2_4065ca)
...
block_.L_406653:                                  ; preds = %block_.L_4065d6
  ...
  %call2_406653 = tail call %struct.Memory* @sub_400e70._Z5timerv(%struct.State* nonnull %0, i64 %287, %struct.Memory* %call2_4065ca)
