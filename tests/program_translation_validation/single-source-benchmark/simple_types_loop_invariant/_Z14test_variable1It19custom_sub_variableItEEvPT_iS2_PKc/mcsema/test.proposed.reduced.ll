; ModuleID = '/tmp/tmpy1bzgord-query.ll'
...
define %struct.Memory* @_Z14test_variable1It19custom_sub_variableItEEvPT_iS2_PKc(%struct.State* noalias, i64, %struct.Memory* noalias readnone returned) local_unnamed_addr #1 {
entry:
  %var_2_3 = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %RBP.i = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 15, i32 0, i32 0
  %var_2_66 = load i64, i64* %var_2_3, align 8
  %var_2_67 = add i64 %var_2_66, -22394
  %call2_4065da = tail call %struct.Memory* @sub_400e60._Z11start_timerv(%struct.State* %0, i64 %var_2_67, %struct.Memory* %2)
  %var_2_7818 = load i64, i64* %RBP.i, align 8
  %var_2_7919 = add i64 %var_2_7818, -28
  %var_2_8120 = inttoptr i64 %var_2_7919 to i32*
  %var_2_8221 = load i32, i32* %var_2_8120, align 4
  %var_2_8422 = load i32, i32* bitcast (%G_0x61a080_type* @G_0x61a080 to i32*), align 8
  %var_2_8523 = sub i32 %var_2_8221, %var_2_8422
  %var_2_10024 = lshr i32 %var_2_8523, 31
  %var_2_10225 = lshr i32 %var_2_8221, 31
  %var_2_10326 = lshr i32 %var_2_8422, 31
  %var_2_10427 = xor i32 %var_2_10326, %var_2_10225
  %var_2_10528 = xor i32 %var_2_10024, %var_2_10225
  %var_2_10629 = add nuw nsw i32 %var_2_10528, %var_2_10427
  %var_2_10730 = icmp eq i32 %var_2_10629, 2
  %var_2_10931 = icmp ne i32 %var_2_10024, 0
  %var_2_11032 = xor i1 %var_2_10931, %var_2_10730
  br i1 %var_2_11032, label %block_4065f6.preheader, label %block_.L_406663

block_4065f6.preheader:                           ; preds = %entry
  %var_2_1222 = add i64 %var_2_7818, -36
  %var_2_1243 = inttoptr i64 %var_2_1222 to i32*
  %var_2_1254 = load i32, i32* %var_2_1243, align 4
  %var_2_1275 = add i64 %var_2_7818, -12
  %var_2_1296 = inttoptr i64 %var_2_1275 to i32*
  %var_2_1307 = load i32, i32* %var_2_1296, align 4
  %var_2_1318 = sub i32 %var_2_1254, %var_2_1307
  %var_2_1469 = lshr i32 %var_2_1318, 31
  %var_2_14810 = lshr i32 %var_2_1254, 31
  %var_2_14911 = lshr i32 %var_2_1307, 31
  %var_2_15012 = xor i32 %var_2_14911, %var_2_14810
  %var_2_15113 = xor i32 %var_2_1469, %var_2_14810
  %var_2_15214 = add nuw nsw i32 %var_2_15113, %var_2_15012
  %var_2_15315 = icmp eq i32 %var_2_15214, 2
  %var_2_15516 = icmp ne i32 %var_2_1469, 0
  %var_2_15617 = xor i1 %var_2_15516, %var_2_15315
  br i1 %var_2_15617, label %block_40660f.us.preheader, label %block_4065f6.preheader6

block_4065f6.preheader6:                          ; preds = %block_4065f6.preheader
  br label %block_4065f6

block_40660f.us.preheader:                        ; preds = %block_4065f6.preheader
  br label %block_40660f.us

block_40660f.us:                                  ; preds = %block_40660f.us.preheader, %block_40660f.us
  br label %block_40660f.us

block_4065f6:                                     ; preds = %block_4065f6.preheader6, %block_4065f6
  br label %block_4065f6

block_.L_406663:                                  ; preds = %entry
  %.pre = load i64, i64* %var_2_3, align 8
  %var_2_287 = add i64 %.pre, -22374
  %call2_406663 = tail call %struct.Memory* @sub_400e80._Z5timerv(%struct.State* nonnull %0, i64 %var_2_287, %struct.Memory* %call2_4065da)
  %var_2_294 = load i64, i64* %var_2_3, align 8
  %var_2_298 = add i64 %var_2_294, -24136
  %call2_40666c = tail call %struct.Memory* @sub_400820._Z13record_resultdPKc(%struct.State* nonnull %0, i64 %var_2_298, %struct.Memory* %call2_406663)
  ret %struct.Memory* %call2_40666c
}
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_jge_.L_406663(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i8* nocapture %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_jge_.L_406645(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i8* nocapture %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 2, i32 9
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_callq_._ZN19custom_sub_variableItE8do_shiftEtt(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_jmpq_.L_406603(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_callq_._Z26check_shifted_variable_sumIt19custom_sub_variableItEEvT_S2_(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_jmpq_.L_4065e6(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
