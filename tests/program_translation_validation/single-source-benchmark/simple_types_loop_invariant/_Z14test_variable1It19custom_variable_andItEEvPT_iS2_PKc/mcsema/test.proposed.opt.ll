...
block_.L_406f06:                                  ; preds = %block_.L_406f65, %entry
  %77 = phi i64 [ %.pre, %entry ], [ %286, %block_.L_406f65 ]
...
block_.L_406f23:                                  ; preds = %block_406f2f, %block_406f16
  %120 = phi i64 [ %.pre1, %block_406f16 ], [ %239, %block_406f2f ]
...
block_.L_406f65:                                  ; preds = %block_.L_406f23
  ...
  %call2_406f70 = tail call %struct.Memory* @sub_410640._Z26check_shifted_variable_sumIt19custom_variable_andItEEvT_S2_(%struct.State* %0, i64 %250, %struct.Memory* %MEMORY.1)
...
block_.L_406f83:                                  ; preds = %block_.L_406f06
  ...
  %call2_406f83 = tail call %struct.Memory* @sub_400e30._Z5timerv(%struct.State* %0, i64 %287, %struct.Memory* %MEMORY.0)
  ...
  %call2_406f8c = tail call %struct.Memory* @sub_4007d0._Z13record_resultdPKc(%struct.State* %0, i64 %298, %struct.Memory* %call2_406f83)
