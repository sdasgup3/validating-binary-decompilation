; ModuleID = '/tmp/tmprow8mush-query.ll'
...
define %struct.Memory* @_Z14test_variable1It19custom_variable_xorItEEvPT_iS2_PKc(%struct.State* noalias, i64, %struct.Memory* noalias readnone returned) local_unnamed_addr #1 {
entry:
  %var_2_3 = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %RBP.i = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 15, i32 0, i32 0
  %var_2_66 = load i64, i64* %var_2_3, align 8
  %var_2_67 = add i64 %var_2_66, -25786
  %call2_40731a = tail call %struct.Memory* @sub_400e60._Z11start_timerv(%struct.State* %0, i64 %var_2_67, %struct.Memory* %2)
  ...
  br i1 %var_2_11032, label %block_407336.preheader, label %block_.L_4073a3

block_407336.preheader:                           ; preds = %entry
  ...
  br i1 %var_2_15617, label %block_40734f.us.preheader, label %block_407336.preheader6

block_407336.preheader6:                          ; preds = %block_407336.preheader
  br label %block_407336

block_40734f.us.preheader:                        ; preds = %block_407336.preheader
  br label %block_40734f.us

block_40734f.us:                                  ; preds = %block_40734f.us.preheader, %block_40734f.us
  br label %block_40734f.us

block_407336:                                     ; preds = %block_407336.preheader6, %block_407336
  br label %block_407336

block_.L_4073a3:                                  ; preds = %entry
  %.pre = load i64, i64* %var_2_3, align 8
  %var_2_287 = add i64 %.pre, -25766
  %call2_4073a3 = tail call %struct.Memory* @sub_400e80._Z5timerv(%struct.State* nonnull %0, i64 %var_2_287, %struct.Memory* %call2_40731a)
  %var_2_294 = load i64, i64* %var_2_3, align 8
  %var_2_298 = add i64 %var_2_294, -27528
  %call2_4073ac = tail call %struct.Memory* @sub_400820._Z13record_resultdPKc(%struct.State* nonnull %0, i64 %var_2_298, %struct.Memory* %call2_4073a3)
