...
block_.L_406ab6:                                  ; preds = %block_.L_406b15, %entry
  %77 = phi i64 [ %.pre, %entry ], [ %286, %block_.L_406b15 ]
...
block_.L_406ad3:                                  ; preds = %block_406adf, %block_406ac6
  %120 = phi i64 [ %.pre1, %block_406ac6 ], [ %239, %block_406adf ]
...
block_.L_406b15:                                  ; preds = %block_.L_406ad3
  ...
  %call2_406b20 = tail call %struct.Memory* @sub_410a20._Z26check_shifted_variable_sumIt22custom_divide_variableItEEvT_S2_(%struct.State* %0, i64 %250, %struct.Memory* %MEMORY.1)
...
block_.L_406b33:                                  ; preds = %block_.L_406ab6
  ...
  %call2_406b33 = tail call %struct.Memory* @sub_400e30._Z5timerv(%struct.State* %0, i64 %287, %struct.Memory* %MEMORY.0)
  ...
  %call2_406b3c = tail call %struct.Memory* @sub_4007d0._Z13record_resultdPKc(%struct.State* %0, i64 %298, %struct.Memory* %call2_406b33)
