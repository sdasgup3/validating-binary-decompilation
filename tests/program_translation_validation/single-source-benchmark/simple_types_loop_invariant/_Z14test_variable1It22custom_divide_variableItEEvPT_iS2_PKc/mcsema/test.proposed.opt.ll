...
declare %struct.Memory* @sub_410a50._Z26check_shifted_variable_sumIt22custom_divide_variableItEEvT_S2_(%struct.State* noalias dereferenceable(3376), i64, %struct.Memory* noalias readnone returned) local_unnamed_addr
...
define %struct.Memory* @_Z14test_variable1It22custom_divide_variableItEEvPT_iS2_PKc(%struct.State* noalias, i64, %struct.Memory* noalias readnone) local_unnamed_addr #1 {
entry:
...
block_.L_406ae6:                                  ; preds = %block_.L_406b45, %entry
  %77 = phi i64 [ %286, %block_.L_406b45 ], [ %.pre, %entry ]
...
block_.L_406b03:                                  ; preds = %block_406b0f, %block_406af6
  %120 = phi i64 [ %239, %block_406b0f ], [ %.pre6, %block_406af6 ]
...
block_406b0f:                                     ; preds = %block_.L_406b03
  ...
  %call2_406b22 = tail call %struct.Memory* @sub_410a20._ZN22custom_divide_variableItE8do_shiftEtt(%struct.State* nonnull %0, i64 %176, %struct.Memory* %call2_406ada)
...
block_.L_406b45:                                  ; preds = %block_.L_406b03
  ...
  %call2_406b50 = tail call %struct.Memory* @sub_410a50._Z26check_shifted_variable_sumIt22custom_divide_variableItEEvT_S2_(%struct.State* nonnull %0, i64 %250, %struct.Memory* %call2_406ada)
...
block_.L_406b63:                                  ; preds = %block_.L_406ae6
  ...
  %call2_406b63 = tail call %struct.Memory* @sub_400e70._Z5timerv(%struct.State* nonnull %0, i64 %287, %struct.Memory* %call2_406ada)
