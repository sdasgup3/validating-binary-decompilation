...
declare %struct.Memory* @sub_410a60._Z26check_shifted_variable_sumIt22custom_divide_variableItEEvT_S2_(%struct.State* noalias dereferenceable(3376), i64, %struct.Memory* noalias readnone returned) local_unnamed_addr
...
entry:
  ...
  %call2_406aea = tail call %struct.Memory* @sub_400e60._Z11start_timerv(%struct.State* %0, i64 %67, %struct.Memory* %2)
...
block_.L_406af6:                                  ; preds = %block_.L_406b55, %entry
  %77 = phi i64 [ %286, %block_.L_406b55 ], [ %.pre, %entry ]
  ...
  br i1 %110, label %block_406b06, label %block_.L_406b73
...
block_.L_406b13:                                  ; preds = %block_406b1f, %block_406b06
  %120 = phi i64 [ %239, %block_406b1f ], [ %.pre6, %block_406b06 ]
  ...
  br i1 %156, label %block_406b1f, label %block_.L_406b55
...
block_406b1f:                                     ; preds = %block_.L_406b13
  ...
  %call2_406b32 = tail call %struct.Memory* @sub_410a30._ZN22custom_divide_variableItE8do_shiftEtt(%struct.State* nonnull %0, i64 %176, %struct.Memory* %call2_406aea)
...
block_.L_406b55:                                  ; preds = %block_.L_406b13
  ...
  %call2_406b60 = tail call %struct.Memory* @sub_410a60._Z26check_shifted_variable_sumIt22custom_divide_variableItEEvT_S2_(%struct.State* nonnull %0, i64 %250, %struct.Memory* %call2_406aea)
...
block_.L_406b73:                                  ; preds = %block_.L_406af6
  ...
  %call2_406b73 = tail call %struct.Memory* @sub_400e80._Z5timerv(%struct.State* nonnull %0, i64 %287, %struct.Memory* %call2_406aea)
  ...
  %call2_406b7c = tail call %struct.Memory* @sub_400820._Z13record_resultdPKc(%struct.State* nonnull %0, i64 %298, %struct.Memory* %call2_406b73)
