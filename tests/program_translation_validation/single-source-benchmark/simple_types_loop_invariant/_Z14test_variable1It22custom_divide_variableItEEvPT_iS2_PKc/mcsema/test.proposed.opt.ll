...
declare %struct.Memory* @sub_410a50._Z26check_shifted_variable_sumIt22custom_divide_variableItEEvT_S2_(%struct.State* dereferenceable(3376), i64, %struct.Memory*) local_unnamed_addr
