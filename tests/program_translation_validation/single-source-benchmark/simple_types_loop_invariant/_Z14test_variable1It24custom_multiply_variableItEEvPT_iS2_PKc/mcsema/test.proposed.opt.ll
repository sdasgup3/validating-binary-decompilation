...
block_.L_406796:                                  ; preds = %block_.L_4067f5, %entry
  %77 = phi i64 [ %.pre, %entry ], [ %286, %block_.L_4067f5 ]
...
block_.L_4067b3:                                  ; preds = %block_4067bf, %block_4067a6
  %120 = phi i64 [ %.pre1, %block_4067a6 ], [ %239, %block_4067bf ]
...
block_.L_4067f5:                                  ; preds = %block_.L_4067b3
  ...
  %call2_406800 = tail call %struct.Memory* @sub_410cf0._Z26check_shifted_variable_sumIt24custom_multiply_variableItEEvT_S2_(%struct.State* %0, i64 %250, %struct.Memory* %MEMORY.1)
...
block_.L_406813:                                  ; preds = %block_.L_406796
  ...
  %call2_406813 = tail call %struct.Memory* @sub_400e30._Z5timerv(%struct.State* %0, i64 %287, %struct.Memory* %MEMORY.0)
  ...
  %call2_40681c = tail call %struct.Memory* @sub_4007d0._Z13record_resultdPKc(%struct.State* %0, i64 %298, %struct.Memory* %call2_406813)
