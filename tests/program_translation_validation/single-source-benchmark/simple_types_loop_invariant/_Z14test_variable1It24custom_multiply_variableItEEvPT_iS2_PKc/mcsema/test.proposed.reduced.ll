; ModuleID = '/tmp/tmplugsi7an-query.ll'
...
define %struct.Memory* @_Z14test_variable1It24custom_multiply_variableItEEvPT_iS2_PKc(%struct.State* noalias nocapture readonly, i64, %struct.Memory* noalias readnone returned) local_unnamed_addr #1 {
entry:
