...
declare %struct.Memory* @sub_4131e0._Z26check_shifted_variable_sumIa27custom_multiple_variable_orIaEEvT_S2_S2_S2_S2_(%struct.State* noalias dereferenceable(3376), i64, %struct.Memory* noalias readnone returned) local_unnamed_addr
...
block_.L_403d9f:                                  ; preds = %block_.L_403e1c, %entry
  %122 = phi i64 [ %409, %block_.L_403e1c ], [ %.pre, %entry ]
...
block_.L_403dba:                                  ; preds = %block_403dc6, %block_403daf
  %165 = phi i64 [ %330, %block_403dc6 ], [ %.pre6, %block_403daf ]
...
block_403dc6:                                     ; preds = %block_.L_403dba
  ...
  %call2_403dfb = tail call %struct.Memory* @sub_413190._ZN27custom_multiple_variable_orIaE8do_shiftEaaaaa(%struct.State* nonnull %0, i64 %253, %struct.Memory* %call2_403d93)
...
block_.L_403e1c:                                  ; preds = %block_.L_403dba
  ...
  %call2_403e45 = tail call %struct.Memory* @sub_4131e0._Z26check_shifted_variable_sumIa27custom_multiple_variable_orIaEEvT_S2_S2_S2_S2_(%struct.State* nonnull %0, i64 %373, %struct.Memory* %call2_403d93)
...
block_.L_403e58:                                  ; preds = %block_.L_403d9f
  ...
  %call2_403e58 = tail call %struct.Memory* @sub_400e70._Z5timerv(%struct.State* nonnull %0, i64 %410, %struct.Memory* %call2_403d93)
