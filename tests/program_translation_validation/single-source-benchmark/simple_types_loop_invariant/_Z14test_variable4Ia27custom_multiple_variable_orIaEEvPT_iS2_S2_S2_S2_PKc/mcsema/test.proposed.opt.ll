...
block_.L_403d6f:                                  ; preds = %block_.L_403dec, %entry
  %122 = phi i64 [ %.pre, %entry ], [ %410, %block_.L_403dec ]
...
block_.L_403d8a:                                  ; preds = %block_403d96, %block_403d7f
  %165 = phi i64 [ %.pre1, %block_403d7f ], [ %330, %block_403d96 ]
...
block_.L_403dec:                                  ; preds = %block_.L_403d8a
  ...
  %call2_403e15 = tail call %struct.Memory* @sub_4131b0._Z26check_shifted_variable_sumIa27custom_multiple_variable_orIaEEvT_S2_S2_S2_S2_(%struct.State* %0, i64 %373, %struct.Memory* %MEMORY.1)
...
block_.L_403e28:                                  ; preds = %block_.L_403d6f
  ...
  %call2_403e28 = tail call %struct.Memory* @sub_400e30._Z5timerv(%struct.State* %0, i64 %411, %struct.Memory* %MEMORY.0)
  ...
  %call2_403e31 = tail call %struct.Memory* @sub_4007d0._Z13record_resultdPKc(%struct.State* %0, i64 %422, %struct.Memory* %call2_403e28)
