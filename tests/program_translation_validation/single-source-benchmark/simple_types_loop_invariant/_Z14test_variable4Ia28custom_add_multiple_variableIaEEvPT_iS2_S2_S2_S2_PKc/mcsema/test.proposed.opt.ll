...
declare %struct.Memory* @sub_413c60._Z26check_shifted_variable_sumIa28custom_add_multiple_variableIaEEvT_S2_S2_S2_S2_(%struct.State* noalias dereferenceable(3376), i64, %struct.Memory* noalias readnone returned) local_unnamed_addr
...
entry:
  ...
  %call2_403173 = tail call %struct.Memory* @sub_400e10._Z11start_timerv(%struct.State* %0, i64 %110, %struct.Memory* %2)
...
block_.L_40317f:                                  ; preds = %block_.L_4031fc, %entry
  %122 = phi i64 [ %.pre, %entry ], [ %410, %block_.L_4031fc ]
  %MEMORY.0 = phi %struct.Memory* [ %call2_403173, %entry ], [ %call2_403225, %block_.L_4031fc ]
  ...
  br i1 %155, label %block_40318f, label %block_.L_403238
...
block_.L_40319a:                                  ; preds = %block_4031a6, %block_40318f
  %165 = phi i64 [ %.pre1, %block_40318f ], [ %330, %block_4031a6 ]
  %MEMORY.1 = phi %struct.Memory* [ %MEMORY.0, %block_40318f ], [ %call2_4031db, %block_4031a6 ]
  ...
  br i1 %201, label %block_4031a6, label %block_.L_4031fc
...
block_4031a6:                                     ; preds = %block_.L_40319a
  ...
  %call2_4031db = tail call %struct.Memory* @sub_413c10._ZN28custom_add_multiple_variableIaE8do_shiftEaaaaa(%struct.State* %0, i64 %253, %struct.Memory* %MEMORY.1)
...
block_.L_4031fc:                                  ; preds = %block_.L_40319a
  ...
  %call2_403225 = tail call %struct.Memory* @sub_413c60._Z26check_shifted_variable_sumIa28custom_add_multiple_variableIaEEvT_S2_S2_S2_S2_(%struct.State* %0, i64 %373, %struct.Memory* %MEMORY.1)
...
block_.L_403238:                                  ; preds = %block_.L_40317f
  ...
  %call2_403238 = tail call %struct.Memory* @sub_400e30._Z5timerv(%struct.State* %0, i64 %411, %struct.Memory* %MEMORY.0)
  ...
  %call2_403241 = tail call %struct.Memory* @sub_4007d0._Z13record_resultdPKc(%struct.State* %0, i64 %422, %struct.Memory* %call2_403238)
  ...
  ret %struct.Memory* %call2_403241
}
...
define %struct.Memory* @routine_jge_.L_403238(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i8* %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
...
define %struct.Memory* @routine_jge_.L_4031fc(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i8* %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 2, i32 9
...
define %struct.Memory* @routine_jmpq_.L_40319a(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
...
define %struct.Memory* @routine_callq_._Z26check_shifted_variable_sumIa28custom_add_multiple_variableIaEEvT_S2_S2_S2_S2_(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
...
define %struct.Memory* @routine_jmpq_.L_40317f(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
