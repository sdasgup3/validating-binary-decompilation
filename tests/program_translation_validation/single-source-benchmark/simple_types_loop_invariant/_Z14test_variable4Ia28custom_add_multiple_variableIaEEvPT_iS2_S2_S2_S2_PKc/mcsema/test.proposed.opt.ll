...
block_.L_40317f:                                  ; preds = %block_.L_4031fc, %entry
  %122 = phi i64 [ %.pre, %entry ], [ %408, %block_.L_4031fc ]
...
block_.L_40319a:                                  ; preds = %block_4031a6, %block_40318f
  %165 = phi i64 [ %.pre1, %block_40318f ], [ %329, %block_4031a6 ]
...
block_.L_4031fc:                                  ; preds = %block_.L_40319a
  ...
  %call2_403225 = tail call %struct.Memory* @sub_413c60._Z26check_shifted_variable_sumIa28custom_add_multiple_variableIaEEvT_S2_S2_S2_S2_(%struct.State* %0, i64 %372, %struct.Memory* %MEMORY.1)
...
block_.L_403238:                                  ; preds = %block_.L_40317f
  ...
  %call2_403238 = tail call %struct.Memory* @sub_400e30._Z5timerv(%struct.State* %0, i64 %409, %struct.Memory* %MEMORY.0)
  ...
  %call2_403241 = tail call %struct.Memory* @sub_4007d0._Z13record_resultdPKc(%struct.State* %0, i64 %420, %struct.Memory* %call2_403238)
