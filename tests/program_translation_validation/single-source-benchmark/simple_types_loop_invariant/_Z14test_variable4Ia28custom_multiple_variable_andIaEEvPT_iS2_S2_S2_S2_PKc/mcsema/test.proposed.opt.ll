...
block_.L_403baf:                                  ; preds = %block_.L_403c2c, %entry
  %122 = phi i64 [ %.pre, %entry ], [ %410, %block_.L_403c2c ]
...
block_.L_403bca:                                  ; preds = %block_403bd6, %block_403bbf
  %165 = phi i64 [ %.pre1, %block_403bbf ], [ %330, %block_403bd6 ]
...
block_.L_403c2c:                                  ; preds = %block_.L_403bca
  ...
  %call2_403c55 = tail call %struct.Memory* @sub_413340._Z26check_shifted_variable_sumIa28custom_multiple_variable_andIaEEvT_S2_S2_S2_S2_(%struct.State* %0, i64 %373, %struct.Memory* %MEMORY.1)
...
block_.L_403c68:                                  ; preds = %block_.L_403baf
  ...
  %call2_403c68 = tail call %struct.Memory* @sub_400e30._Z5timerv(%struct.State* %0, i64 %411, %struct.Memory* %MEMORY.0)
  ...
  %call2_403c71 = tail call %struct.Memory* @sub_4007d0._Z13record_resultdPKc(%struct.State* %0, i64 %422, %struct.Memory* %call2_403c68)
