...
declare %struct.Memory* @sub_412f80._ZN28custom_multiple_variable_xorIaE8do_shiftEaaaaa(%struct.State* noalias dereferenceable(3376), i64, %struct.Memory* noalias readnone returned) local_unnamed_addr

declare %struct.Memory* @sub_412fd0._Z26check_shifted_variable_sumIa28custom_multiple_variable_xorIaEEvT_S2_S2_S2_S2_(%struct.State* noalias dereferenceable(3376), i64, %struct.Memory* noalias readnone returned) local_unnamed_addr
...
define %struct.Memory* @_Z14test_variable4Ia28custom_multiple_variable_xorIaEEvPT_iS2_S2_S2_S2_PKc(%struct.State* noalias, i64, %struct.Memory* noalias) local_unnamed_addr #1 {
entry:
  ...
  %86 = add i64 %85, -30
  %87 = load i8, i8* %R11B.i156, align 1
  ...
  %92 = add i64 %91, -31
  %93 = load i8, i8* %R10B.i159, align 1
  ...
  %call2_403f23 = tail call %struct.Memory* @sub_400e10._Z11start_timerv(%struct.State* %0, i64 %110, %struct.Memory* %2)
  ...
  %SIL.i99 = bitcast %union.anon* %72 to i8*
  %DIL.i96 = bitcast %union.anon* %67 to i8*
  ...
  %R8D.i72 = bitcast %union.anon* %54 to i32*
  %121 = getelementptr inbounds %union.anon, %union.anon* %54, i64 0, i32 0
  %.pre = load i64, i64* %3, align 8
  br label %block_.L_403f2f

block_.L_403f2f:                                  ; preds = %block_.L_403fac, %entry
  %122 = phi i64 [ %.pre, %entry ], [ %408, %block_.L_403fac ]
  %MEMORY.0 = phi %struct.Memory* [ %call2_403f23, %entry ], [ %call2_403fd5, %block_.L_403fac ]
  ...
  %129 = load i32, i32* bitcast (%G_0x61a080_type* @G_0x61a080 to i32*), align 8
  %130 = sub i32 %127, %129
  ...
  %155 = xor i1 %154, %152
  %.v = select i1 %155, i64 16, i64 185
  %156 = add i64 %122, %.v
  store i64 %156, i64* %3, align 8
  br i1 %155, label %block_403f3f, label %block_.L_403fe8

block_403f3f:                                     ; preds = %block_.L_403f2f
  %157 = add i64 %123, -37
  %158 = add i64 %156, 4
...
block_.L_403f4a:                                  ; preds = %block_403f56, %block_403f3f
  %165 = phi i64 [ %.pre1, %block_403f3f ], [ %329, %block_403f56 ]
  %MEMORY.1 = phi %struct.Memory* [ %MEMORY.0, %block_403f3f ], [ %call2_403f8b, %block_403f56 ]
  ...
  %201 = xor i1 %200, %198
  %.v2 = select i1 %201, i64 12, i64 98
  %202 = add i64 %165, %.v2
  store i64 %202, i64* %3, align 8
  br i1 %201, label %block_403f56, label %block_.L_403fac

block_403f56:                                     ; preds = %block_.L_403f4a
  %203 = add i64 %166, -24
  %204 = add i64 %202, 4
  ...
  %234 = load i8, i8* %SIL.i99, align 1
  %235 = sext i8 %234 to i64
  %236 = and i64 %235, 4294967295
  store i64 %236, i64* %RSI.i84, align 8
  ...
  store i64 %243, i64* %RDX.i78, align 8
  %244 = load i8, i8* %R8B.i158, align 1
  %245 = sext i8 %244 to i64
  %246 = and i64 %245, 4294967295
  store i64 %246, i64* %RCX.i106, align 8
  %247 = add i64 %237, -32
  %248 = add i64 %233, 22
  ...
  store i64 %252, i64* %121, align 8
  %253 = add i64 %233, 61451
  %254 = add i64 %233, 27
  ...
  %call2_403f8b = tail call %struct.Memory* @sub_412f80._ZN28custom_multiple_variable_xorIaE8do_shiftEaaaaa(%struct.State* %0, i64 %253, %struct.Memory* %MEMORY.1)
  %258 = load i8, i8* %AL.i161, align 1
  %259 = load i64, i64* %3, align 8
  %260 = sext i8 %258 to i32
  %261 = zext i32 %260 to i64
  store i64 %261, i64* %RCX.i106, align 8
  ...
  store i64 %269, i64* %RDX.i78, align 8
  %270 = icmp ult i32 %268, %267
  %271 = icmp ult i32 %268, %260
  %272 = or i1 %270, %271
  %273 = zext i1 %272 to i8
  store i8 %273, i8* %25, align 1
  %274 = and i32 %268, 255
  ...
  %285 = icmp eq i32 %268, 0
  %286 = zext i1 %285 to i8
  store i8 %286, i8* %41, align 1
  %287 = lshr i32 %268, 31
  ...
  store i8 %295, i8* %50, align 1
  %296 = trunc i32 %268 to i8
  store i8 %296, i8* %AL.i161, align 1
  %297 = add i64 %259, 14
  store i64 %297, i64* %3, align 8
  store i8 %296, i8* %265, align 1
  ...
  store i64 %305, i64* %RAX.i126, align 8
  %306 = icmp eq i32 %303, -1
  %307 = icmp eq i32 %304, 0
  %308 = or i1 %306, %307
  %309 = zext i1 %308 to i8
  store i8 %309, i8* %25, align 1
  %310 = and i32 %304, 255
...
block_.L_403fac:                                  ; preds = %block_.L_403f4a
  %330 = add i64 %166, -37
  %331 = add i64 %202, 3
  store i64 %331, i64* %3, align 8
  %332 = inttoptr i64 %330 to i8*
  %333 = load i8, i8* %332, align 1
  store i8 %333, i8* %AL.i161, align 1
  %334 = add i64 %166, -29
  %335 = add i64 %202, 6
  store i64 %335, i64* %3, align 8
  %336 = inttoptr i64 %334 to i8*
  %337 = load i8, i8* %336, align 1
  store i8 %337, i8* %CL.i155, align 1
  %338 = add i64 %166, -30
  %339 = add i64 %202, 9
  store i64 %339, i64* %3, align 8
  %340 = inttoptr i64 %338 to i8*
  %341 = load i8, i8* %340, align 1
  store i8 %341, i8* %DL.i153, align 1
  %342 = add i64 %166, -31
  %343 = add i64 %202, 13
  store i64 %343, i64* %3, align 8
  %344 = inttoptr i64 %342 to i8*
  %345 = load i8, i8* %344, align 1
  %346 = sext i8 %333 to i64
  %347 = and i64 %346, 4294967295
  store i64 %347, i64* %RDI.i146, align 8
  %348 = sext i8 %337 to i64
  %349 = and i64 %348, 4294967295
  store i64 %349, i64* %121, align 8
  %350 = add i64 %166, -58
  %351 = add i64 %202, 24
  store i64 %351, i64* %3, align 8
  %352 = inttoptr i64 %350 to i8*
  store i8 %345, i8* %352, align 1
  %353 = load i32, i32* %R8D.i72, align 4
  %354 = zext i32 %353 to i64
  %355 = load i64, i64* %3, align 8
  store i64 %354, i64* %RSI.i84, align 8
  %356 = load i8, i8* %DL.i153, align 1
  %357 = sext i8 %356 to i64
  %358 = and i64 %357, 4294967295
  store i64 %358, i64* %RDX.i78, align 8
  ...
  store i8 %363, i8* %AL.i161, align 1
  %364 = sext i8 %363 to i64
  %365 = and i64 %364, 4294967295
  store i64 %365, i64* %RCX.i106, align 8
  %366 = add i64 %359, -32
  %367 = add i64 %355, 17
  ...
  store i64 %371, i64* %121, align 8
  %372 = add i64 %355, 61452
  %373 = add i64 %355, 22
  ...
  %call2_403fd5 = tail call %struct.Memory* @sub_412fd0._Z26check_shifted_variable_sumIa28custom_multiple_variable_xorIaEEvT_S2_S2_S2_S2_(%struct.State* %0, i64 %372, %struct.Memory* %MEMORY.1)
  ...
  store i64 %384, i64* %RAX.i126, align 8
  ...
  store i8 %398, i8* %41, align 1
  %399 = lshr i32 %383, 31
  %400 = trunc i32 %399 to i8
  store i8 %400, i8* %44, align 1
  %401 = lshr i32 %382, 31
  %402 = xor i32 %399, %401
  %403 = add nuw nsw i32 %402, %399
  %404 = icmp eq i32 %403, 2
  %405 = zext i1 %404 to i8
  store i8 %405, i8* %50, align 1
  %406 = add i64 %379, 9
...
block_.L_403fe8:                                  ; preds = %block_.L_403f2f
  %409 = add i64 %156, -12728
  %410 = add i64 %156, 5
  ...
  %call2_403fe8 = tail call %struct.Memory* @sub_400e30._Z5timerv(%struct.State* %0, i64 %409, %struct.Memory* %MEMORY.0)
  ...
  store i64 %419, i64* %RDI.i146, align 8
  %420 = add i64 %416, -14365
  %421 = add i64 %416, 9
  ...
  %call2_403ff1 = tail call %struct.Memory* @sub_4007d0._Z13record_resultdPKc(%struct.State* %0, i64 %420, %struct.Memory* %call2_403fe8)
  %425 = load i64, i64* %6, align 8
  %426 = load i64, i64* %3, align 8
  %427 = add i64 %425, 48
  store i64 %427, i64* %6, align 8
  %428 = icmp ugt i64 %425, -49
  %429 = zext i1 %428 to i8
  store i8 %429, i8* %25, align 1
  ...
  store i8 %449, i8* %50, align 1
  %450 = add i64 %426, 5
  store i64 %450, i64* %3, align 8
  %451 = add i64 %425, 56
  %452 = inttoptr i64 %427 to i64*
  %453 = load i64, i64* %452, align 8
  store i64 %453, i64* %RBX.i165, align 8
  ...
  store i64 %457, i64* %R14.i167, align 8
  store i64 %455, i64* %6, align 8
  %458 = add i64 %426, 8
  store i64 %458, i64* %3, align 8
  %459 = add i64 %425, 72
  %460 = inttoptr i64 %455 to i64*
  %461 = load i64, i64* %460, align 8
  store i64 %461, i64* %RBP.i, align 8
  ...
  ret %struct.Memory* %call2_403ff1
}
...
define %struct.Memory* @routine_movb__r9b___al(%struct.State* dereferenceable(3376), i64, %struct.Memory*) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
...
define %struct.Memory* @routine_movb__r8b___r10b(%struct.State* dereferenceable(3376), i64, %struct.Memory*) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
...
define %struct.Memory* @routine_movb__cl___r11b(%struct.State* dereferenceable(3376), i64, %struct.Memory*) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
...
define %struct.Memory* @routine_movb__dl___bl(%struct.State* dereferenceable(3376), i64, %struct.Memory*) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
...
define %struct.Memory* @routine_movl__esi__MINUS0x1c__rbp_(%struct.State* dereferenceable(3376), i64, %struct.Memory*) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
...
define %struct.Memory* @routine_movb__bl__MINUS0x1d__rbp_(%struct.State* dereferenceable(3376), i64, %struct.Memory*) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 3, i32 0
  %BL = bitcast %union.anon* %3 to i8*
...
define %struct.Memory* @routine_movb__r11b__MINUS0x1e__rbp_(%struct.State* dereferenceable(3376), i64, %struct.Memory*) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
...
define %struct.Memory* @routine_movb__r10b__MINUS0x1f__rbp_(%struct.State* dereferenceable(3376), i64, %struct.Memory*) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
...
define %struct.Memory* @routine_movb__al__MINUS0x20__rbp_(%struct.State* dereferenceable(3376), i64, %struct.Memory*) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 1, i32 0
  %AL = bitcast %union.anon* %3 to i8*
...
define %struct.Memory* @routine_movq__r14__MINUS0x38__rbp_(%struct.State* dereferenceable(3376), i64, %struct.Memory*) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %RBP = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 15, i32 0, i32 0
  %R14 = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 29, i32 0, i32 0
...
define %struct.Memory* @routine_jge_.L_403fe8(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i8* %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
...
define %struct.Memory* @routine_movb__0x0__MINUS0x25__rbp_(%struct.State* dereferenceable(3376), i64, %struct.Memory*) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %RBP = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 15, i32 0, i32 0
  %3 = load i64, i64* %RBP, align 8
...
define %struct.Memory* @routine_jge_.L_403fac(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i8* %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 2, i32 9
...
define %struct.Memory* @routine_movb___rax__rcx_1____dl(%struct.State* dereferenceable(3376), i64, %struct.Memory*) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
...
define %struct.Memory* @routine_movb_MINUS0x1d__rbp____sil(%struct.State* dereferenceable(3376), i64, %struct.Memory*) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 9, i32 0
...
define %struct.Memory* @routine_movb_MINUS0x1e__rbp____dil(%struct.State* dereferenceable(3376), i64, %struct.Memory*) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
...
define %struct.Memory* @routine_movb_MINUS0x1f__rbp____r8b(%struct.State* dereferenceable(3376), i64, %struct.Memory*) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 17, i32 0
  %R8B = bitcast %union.anon* %3 to i8*
...
define %struct.Memory* @routine_movsbl__dl___r9d(%struct.State* dereferenceable(3376), i64, %struct.Memory*) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 7, i32 0
  %DL = bitcast %union.anon* %3 to i8*
...
define %struct.Memory* @routine_movb__dil__MINUS0x39__rbp_(%struct.State* dereferenceable(3376), i64, %struct.Memory*) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 11, i32 0
  %DIL = bitcast %union.anon* %3 to i8*
...
define %struct.Memory* @routine_movl__r9d___edi(%struct.State* dereferenceable(3376), i64, %struct.Memory*) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
...
define %struct.Memory* @routine_movsbl__sil___esi(%struct.State* dereferenceable(3376), i64, %struct.Memory*) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 9, i32 0
  %SIL = bitcast %union.anon* %3 to i8*
...
define %struct.Memory* @routine_movb_MINUS0x39__rbp____dl(%struct.State* dereferenceable(3376), i64, %struct.Memory*) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 7, i32 0
  %DL = bitcast %union.anon* %3 to i8*
...
define %struct.Memory* @routine_movsbl__dl___edx(%struct.State* dereferenceable(3376), i64, %struct.Memory*) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 7, i32 0
  %DL = bitcast %union.anon* %3 to i8*
...
define %struct.Memory* @routine_movsbl__r8b___ecx(%struct.State* dereferenceable(3376), i64, %struct.Memory*) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 17, i32 0
  %R8B = bitcast %union.anon* %3 to i8*
...
define %struct.Memory* @routine_movsbl_MINUS0x20__rbp____r8d(%struct.State* dereferenceable(3376), i64, %struct.Memory*) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %RBP = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 15, i32 0, i32 0
...
define %struct.Memory* @routine_callq_._ZN28custom_multiple_variable_xorIaE8do_shiftEaaaaa(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
...
define %struct.Memory* @routine_movsbl__al___ecx(%struct.State* dereferenceable(3376), i64, %struct.Memory*) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 1, i32 0
  %AL = bitcast %union.anon* %3 to i8*
...
define %struct.Memory* @routine_movsbl_MINUS0x25__rbp____edx(%struct.State* dereferenceable(3376), i64, %struct.Memory*) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
...
define %struct.Memory* @routine_addl__ecx___edx(%struct.State* dereferenceable(3376), i64, %struct.Memory*) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 5, i32 0
...
define %struct.Memory* @routine_movb__al__MINUS0x25__rbp_(%struct.State* dereferenceable(3376), i64, %struct.Memory*) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 1, i32 0
  %AL = bitcast %union.anon* %3 to i8*
...
define %struct.Memory* @routine_jmpq_.L_403f4a(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
...
define %struct.Memory* @routine_movb_MINUS0x25__rbp____al(%struct.State* dereferenceable(3376), i64, %struct.Memory*) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 1, i32 0
  %AL = bitcast %union.anon* %3 to i8*
...
define %struct.Memory* @routine_movb_MINUS0x1d__rbp____cl(%struct.State* dereferenceable(3376), i64, %struct.Memory*) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 5, i32 0
  %CL = bitcast %union.anon* %3 to i8*
...
define %struct.Memory* @routine_movb_MINUS0x1e__rbp____dl(%struct.State* dereferenceable(3376), i64, %struct.Memory*) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 7, i32 0
  %DL = bitcast %union.anon* %3 to i8*
...
define %struct.Memory* @routine_movb_MINUS0x1f__rbp____sil(%struct.State* dereferenceable(3376), i64, %struct.Memory*) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 9, i32 0
  %SIL = bitcast %union.anon* %3 to i8*
...
define %struct.Memory* @routine_movsbl__al___edi(%struct.State* dereferenceable(3376), i64, %struct.Memory*) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 1, i32 0
  %AL = bitcast %union.anon* %3 to i8*
...
define %struct.Memory* @routine_movsbl__cl___r8d(%struct.State* dereferenceable(3376), i64, %struct.Memory*) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 5, i32 0
  %CL = bitcast %union.anon* %3 to i8*
...
define %struct.Memory* @routine_movb__sil__MINUS0x3a__rbp_(%struct.State* dereferenceable(3376), i64, %struct.Memory*) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 9, i32 0
  %SIL = bitcast %union.anon* %3 to i8*
...
define %struct.Memory* @routine_movb_MINUS0x3a__rbp____al(%struct.State* dereferenceable(3376), i64, %struct.Memory*) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 1, i32 0
  %AL = bitcast %union.anon* %3 to i8*
...
define %struct.Memory* @routine_callq_._Z26check_shifted_variable_sumIa28custom_multiple_variable_xorIaEEvT_S2_S2_S2_S2_(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
...
define %struct.Memory* @routine_jmpq_.L_403f2f(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
...
define %struct.Memory* @routine_movq_0x10__rbp____rdi(%struct.State* dereferenceable(3376), i64, %struct.Memory*) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %RDI = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 11, i32 0, i32 0
  %RBP = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 15, i32 0, i32 0
