...
declare %struct.Memory* @sub_413b10._Z26check_shifted_variable_sumIa28custom_sub_multiple_variableIaEEvT_S2_S2_S2_S2_(%struct.State* noalias dereferenceable(3376), i64, %struct.Memory* noalias readnone returned) local_unnamed_addr
...
entry:
  ...
  %call2_403373 = tail call %struct.Memory* @sub_400e60._Z11start_timerv(%struct.State* %0, i64 %110, %struct.Memory* %2)
...
block_.L_40337f:                                  ; preds = %block_.L_4033fc, %entry
  %122 = phi i64 [ %409, %block_.L_4033fc ], [ %.pre, %entry ]
  ...
  br i1 %155, label %block_40338f, label %block_.L_403438
...
block_.L_40339a:                                  ; preds = %block_4033a6, %block_40338f
  %165 = phi i64 [ %330, %block_4033a6 ], [ %.pre6, %block_40338f ]
  ...
  br i1 %201, label %block_4033a6, label %block_.L_4033fc
...
block_4033a6:                                     ; preds = %block_.L_40339a
  ...
  %call2_4033db = tail call %struct.Memory* @sub_413ac0._ZN28custom_sub_multiple_variableIaE8do_shiftEaaaaa(%struct.State* nonnull %0, i64 %253, %struct.Memory* %call2_403373)
...
block_.L_4033fc:                                  ; preds = %block_.L_40339a
  ...
  %call2_403425 = tail call %struct.Memory* @sub_413b10._Z26check_shifted_variable_sumIa28custom_sub_multiple_variableIaEEvT_S2_S2_S2_S2_(%struct.State* nonnull %0, i64 %373, %struct.Memory* %call2_403373)
...
block_.L_403438:                                  ; preds = %block_.L_40337f
  ...
  %call2_403438 = tail call %struct.Memory* @sub_400e80._Z5timerv(%struct.State* nonnull %0, i64 %410, %struct.Memory* %call2_403373)
  ...
  %call2_403441 = tail call %struct.Memory* @sub_400820._Z13record_resultdPKc(%struct.State* nonnull %0, i64 %421, %struct.Memory* %call2_403438)
