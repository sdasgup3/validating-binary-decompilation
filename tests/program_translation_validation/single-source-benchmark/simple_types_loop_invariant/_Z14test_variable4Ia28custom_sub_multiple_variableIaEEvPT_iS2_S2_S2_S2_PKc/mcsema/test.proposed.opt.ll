...
declare %struct.Memory* @sub_413b00._Z26check_shifted_variable_sumIa28custom_sub_multiple_variableIaEEvT_S2_S2_S2_S2_(%struct.State* noalias dereferenceable(3376), i64, %struct.Memory* noalias readnone returned) local_unnamed_addr
...
define %struct.Memory* @_Z14test_variable4Ia28custom_sub_multiple_variableIaEEvPT_iS2_S2_S2_S2_PKc(%struct.State* noalias, i64, %struct.Memory* noalias readnone) local_unnamed_addr #1 {
entry:
  ...
  %call2_403363 = tail call %struct.Memory* @sub_400e50._Z11start_timerv(%struct.State* %0, i64 %110, %struct.Memory* %2)
...
block_.L_40336f:                                  ; preds = %block_.L_4033ec, %entry
  %122 = phi i64 [ %409, %block_.L_4033ec ], [ %.pre, %entry ]
  ...
  br i1 %155, label %block_40337f, label %block_.L_403428
...
block_.L_40338a:                                  ; preds = %block_403396, %block_40337f
  %165 = phi i64 [ %330, %block_403396 ], [ %.pre6, %block_40337f ]
  ...
  br i1 %201, label %block_403396, label %block_.L_4033ec
...
block_403396:                                     ; preds = %block_.L_40338a
  ...
  %call2_4033cb = tail call %struct.Memory* @sub_413ab0._ZN28custom_sub_multiple_variableIaE8do_shiftEaaaaa(%struct.State* nonnull %0, i64 %253, %struct.Memory* %call2_403363)
...
block_.L_4033ec:                                  ; preds = %block_.L_40338a
  ...
  %call2_403415 = tail call %struct.Memory* @sub_413b00._Z26check_shifted_variable_sumIa28custom_sub_multiple_variableIaEEvT_S2_S2_S2_S2_(%struct.State* nonnull %0, i64 %373, %struct.Memory* %call2_403363)
...
block_.L_403428:                                  ; preds = %block_.L_40336f
  ...
  %call2_403428 = tail call %struct.Memory* @sub_400e70._Z5timerv(%struct.State* nonnull %0, i64 %410, %struct.Memory* %call2_403363)
  ...
  %call2_403431 = tail call %struct.Memory* @sub_400810._Z13record_resultdPKc(%struct.State* nonnull %0, i64 %421, %struct.Memory* %call2_403428)
  ...
  ret %struct.Memory* %call2_403431
}
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_jge_.L_4033ec(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i8* nocapture %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 2, i32 9
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_jmpq_.L_40338a(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
