...
declare %struct.Memory* @sub_413b00._Z26check_shifted_variable_sumIa28custom_sub_multiple_variableIaEEvT_S2_S2_S2_S2_(%struct.State* dereferenceable(3376), i64, %struct.Memory*) local_unnamed_addr
...
block_.L_40336f:                                  ; preds = %block_.L_4033ec, %entry
  %122 = phi i64 [ %.pre, %entry ], [ %409, %block_.L_4033ec ]
  %MEMORY.0 = phi %struct.Memory* [ %call2_403363, %entry ], [ %call2_403415, %block_.L_4033ec ]
...
block_.L_40338a:                                  ; preds = %block_403396, %block_40337f
  %165 = phi i64 [ %.pre6, %block_40337f ], [ %330, %block_403396 ]
  %MEMORY.1 = phi %struct.Memory* [ %MEMORY.0, %block_40337f ], [ %call2_4033cb, %block_403396 ]
...
block_403396:                                     ; preds = %block_.L_40338a
  ...
  %call2_4033cb = tail call %struct.Memory* @sub_413ab0._ZN28custom_sub_multiple_variableIaE8do_shiftEaaaaa(%struct.State* nonnull %0, i64 %253, %struct.Memory* %MEMORY.1)
...
block_.L_4033ec:                                  ; preds = %block_.L_40338a
  ...
  %call2_403415 = tail call %struct.Memory* @sub_413b00._Z26check_shifted_variable_sumIa28custom_sub_multiple_variableIaEEvT_S2_S2_S2_S2_(%struct.State* nonnull %0, i64 %373, %struct.Memory* %MEMORY.1)
...
block_.L_403428:                                  ; preds = %block_.L_40336f
  ...
  %call2_403428 = tail call %struct.Memory* @sub_400e70._Z5timerv(%struct.State* nonnull %0, i64 %410, %struct.Memory* %MEMORY.0)
