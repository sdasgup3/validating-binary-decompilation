...
block_.L_40333f:                                  ; preds = %block_.L_4033bc, %entry
  %122 = phi i64 [ %.pre, %entry ], [ %410, %block_.L_4033bc ]
...
block_.L_40335a:                                  ; preds = %block_403366, %block_40334f
  %165 = phi i64 [ %.pre1, %block_40334f ], [ %330, %block_403366 ]
...
block_.L_4033bc:                                  ; preds = %block_.L_40335a
  ...
  %call2_4033e5 = tail call %struct.Memory* @sub_413ad0._Z26check_shifted_variable_sumIa28custom_sub_multiple_variableIaEEvT_S2_S2_S2_S2_(%struct.State* %0, i64 %373, %struct.Memory* %MEMORY.1)
...
block_.L_4033f8:                                  ; preds = %block_.L_40333f
  ...
  %call2_4033f8 = tail call %struct.Memory* @sub_400e30._Z5timerv(%struct.State* %0, i64 %411, %struct.Memory* %MEMORY.0)
  ...
  %call2_403401 = tail call %struct.Memory* @sub_4007d0._Z13record_resultdPKc(%struct.State* %0, i64 %422, %struct.Memory* %call2_4033f8)
