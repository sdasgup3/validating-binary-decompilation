...
declare %struct.Memory* @sub_413510._Z26check_shifted_variable_sumIa30custom_mixed_multiple_variableIaEEvT_S2_S2_S2_S2_(%struct.State* noalias dereferenceable(3376), i64, %struct.Memory* noalias readnone returned) local_unnamed_addr
...
entry:
  ...
  %call2_403a23 = tail call %struct.Memory* @sub_400e60._Z11start_timerv(%struct.State* %0, i64 %110, %struct.Memory* %2)
...
block_.L_403a2f:                                  ; preds = %block_.L_403aac, %entry
  %122 = phi i64 [ %409, %block_.L_403aac ], [ %.pre, %entry ]
  ...
  br i1 %155, label %block_403a3f, label %block_.L_403ae8
...
block_.L_403a4a:                                  ; preds = %block_403a56, %block_403a3f
  %165 = phi i64 [ %330, %block_403a56 ], [ %.pre6, %block_403a3f ]
  ...
  br i1 %201, label %block_403a56, label %block_.L_403aac
...
block_403a56:                                     ; preds = %block_.L_403a4a
  ...
  %call2_403a8b = tail call %struct.Memory* @sub_4134c0._ZN30custom_mixed_multiple_variableIaE8do_shiftEaaaaa(%struct.State* nonnull %0, i64 %253, %struct.Memory* %call2_403a23)
...
block_.L_403aac:                                  ; preds = %block_.L_403a4a
  %331 = add i64 %166, -45
  %332 = add i64 %202, 3
  ...
  %call2_403ad5 = tail call %struct.Memory* @sub_413510._Z26check_shifted_variable_sumIa30custom_mixed_multiple_variableIaEEvT_S2_S2_S2_S2_(%struct.State* nonnull %0, i64 %373, %struct.Memory* %call2_403a23)
...
block_.L_403ae8:                                  ; preds = %block_.L_403a2f
  ...
  %call2_403ae8 = tail call %struct.Memory* @sub_400e80._Z5timerv(%struct.State* nonnull %0, i64 %410, %struct.Memory* %call2_403a23)
  ...
  %call2_403af1 = tail call %struct.Memory* @sub_400820._Z13record_resultdPKc(%struct.State* nonnull %0, i64 %421, %struct.Memory* %call2_403ae8)
