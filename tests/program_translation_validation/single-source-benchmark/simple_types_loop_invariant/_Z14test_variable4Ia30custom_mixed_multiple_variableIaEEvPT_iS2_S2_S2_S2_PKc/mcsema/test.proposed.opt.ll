...
declare %struct.Memory* @sub_4134b0._ZN30custom_mixed_multiple_variableIaE8do_shiftEaaaaa(%struct.State* noalias dereferenceable(3376), i64, %struct.Memory* noalias readnone returned) local_unnamed_addr

declare %struct.Memory* @sub_413500._Z26check_shifted_variable_sumIa30custom_mixed_multiple_variableIaEEvT_S2_S2_S2_S2_(%struct.State* noalias dereferenceable(3376), i64, %struct.Memory* noalias readnone returned) local_unnamed_addr
...
define %struct.Memory* @_Z14test_variable4Ia30custom_mixed_multiple_variableIaEEvPT_iS2_S2_S2_S2_PKc(%struct.State* noalias, i64, %struct.Memory* noalias readnone) local_unnamed_addr #1 {
entry:
...
block_.L_403a1f:                                  ; preds = %block_.L_403a9c, %entry
  %122 = phi i64 [ %409, %block_.L_403a9c ], [ %.pre, %entry ]
...
block_.L_403a3a:                                  ; preds = %block_403a46, %block_403a2f
  %165 = phi i64 [ %330, %block_403a46 ], [ %.pre6, %block_403a2f ]
...
block_403a46:                                     ; preds = %block_.L_403a3a
  ...
  %call2_403a7b = tail call %struct.Memory* @sub_4134b0._ZN30custom_mixed_multiple_variableIaE8do_shiftEaaaaa(%struct.State* nonnull %0, i64 %253, %struct.Memory* %call2_403a13)
...
block_.L_403a9c:                                  ; preds = %block_.L_403a3a
  ...
  %call2_403ac5 = tail call %struct.Memory* @sub_413500._Z26check_shifted_variable_sumIa30custom_mixed_multiple_variableIaEEvT_S2_S2_S2_S2_(%struct.State* nonnull %0, i64 %373, %struct.Memory* %call2_403a13)
...
block_.L_403ad8:                                  ; preds = %block_.L_403a1f
  ...
  %call2_403ad8 = tail call %struct.Memory* @sub_400e70._Z5timerv(%struct.State* nonnull %0, i64 %410, %struct.Memory* %call2_403a13)
