...
block_.L_4039ef:                                  ; preds = %block_.L_403a6c, %entry
  %122 = phi i64 [ %.pre, %entry ], [ %410, %block_.L_403a6c ]
...
block_.L_403a0a:                                  ; preds = %block_403a16, %block_4039ff
  %165 = phi i64 [ %.pre1, %block_4039ff ], [ %330, %block_403a16 ]
...
block_.L_403a6c:                                  ; preds = %block_.L_403a0a
  ...
  %call2_403a95 = tail call %struct.Memory* @sub_4134d0._Z26check_shifted_variable_sumIa30custom_mixed_multiple_variableIaEEvT_S2_S2_S2_S2_(%struct.State* %0, i64 %373, %struct.Memory* %MEMORY.1)
...
block_.L_403aa8:                                  ; preds = %block_.L_4039ef
  ...
  %call2_403aa8 = tail call %struct.Memory* @sub_400e30._Z5timerv(%struct.State* %0, i64 %411, %struct.Memory* %MEMORY.0)
  ...
  %call2_403ab1 = tail call %struct.Memory* @sub_4007d0._Z13record_resultdPKc(%struct.State* %0, i64 %422, %struct.Memory* %call2_403aa8)
