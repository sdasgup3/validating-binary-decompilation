...
block_.L_4037cf:                                  ; preds = %block_.L_40384c, %entry
  %122 = phi i64 [ %.pre, %entry ], [ %408, %block_.L_40384c ]
...
block_.L_4037ea:                                  ; preds = %block_4037f6, %block_4037df
  %165 = phi i64 [ %.pre1, %block_4037df ], [ %329, %block_4037f6 ]
...
block_.L_40384c:                                  ; preds = %block_.L_4037ea
  ...
  %call2_403875 = tail call %struct.Memory* @sub_4136c0._Z26check_shifted_variable_sumIa31custom_divide_multiple_variableIaEEvT_S2_S2_S2_S2_(%struct.State* %0, i64 %372, %struct.Memory* %MEMORY.1)
...
block_.L_403888:                                  ; preds = %block_.L_4037cf
  ...
  %call2_403888 = tail call %struct.Memory* @sub_400e30._Z5timerv(%struct.State* %0, i64 %409, %struct.Memory* %MEMORY.0)
  ...
  %call2_403891 = tail call %struct.Memory* @sub_4007d0._Z13record_resultdPKc(%struct.State* %0, i64 %420, %struct.Memory* %call2_403888)
