...
declare %struct.Memory* @sub_4135d0._Z26check_shifted_variable_sumIa32custom_divide_multiple_variable2IaEEvT_S2_S2_S2_S2_(%struct.State* noalias dereferenceable(3376), i64, %struct.Memory* noalias readnone returned) local_unnamed_addr
...
entry:
  ...
  %call2_4038d3 = tail call %struct.Memory* @sub_400e10._Z11start_timerv(%struct.State* %0, i64 %110, %struct.Memory* %2)
...
block_.L_4038df:                                  ; preds = %block_.L_40395c, %entry
  %122 = phi i64 [ %.pre, %entry ], [ %408, %block_.L_40395c ]
  %MEMORY.0 = phi %struct.Memory* [ %call2_4038d3, %entry ], [ %call2_403985, %block_.L_40395c ]
  ...
  br i1 %155, label %block_4038ef, label %block_.L_403998
...
block_.L_4038fa:                                  ; preds = %block_403906, %block_4038ef
  %165 = phi i64 [ %.pre1, %block_4038ef ], [ %329, %block_403906 ]
  %MEMORY.1 = phi %struct.Memory* [ %MEMORY.0, %block_4038ef ], [ %call2_40393b, %block_403906 ]
  ...
  br i1 %201, label %block_403906, label %block_.L_40395c
...
block_403906:                                     ; preds = %block_.L_4038fa
  ...
  %call2_40393b = tail call %struct.Memory* @sub_413570._ZN32custom_divide_multiple_variable2IaE8do_shiftEaaaaa(%struct.State* %0, i64 %253, %struct.Memory* %MEMORY.1)
...
block_.L_40395c:                                  ; preds = %block_.L_4038fa
  %330 = add i64 %166, -37
  %331 = add i64 %202, 3
  ...
  %call2_403985 = tail call %struct.Memory* @sub_4135d0._Z26check_shifted_variable_sumIa32custom_divide_multiple_variable2IaEEvT_S2_S2_S2_S2_(%struct.State* %0, i64 %372, %struct.Memory* %MEMORY.1)
...
block_.L_403998:                                  ; preds = %block_.L_4038df
  %409 = add i64 %156, -11112
  %410 = add i64 %156, 5
  ...
  %call2_403998 = tail call %struct.Memory* @sub_400e30._Z5timerv(%struct.State* %0, i64 %409, %struct.Memory* %MEMORY.0)
  ...
  %call2_4039a1 = tail call %struct.Memory* @sub_4007d0._Z13record_resultdPKc(%struct.State* %0, i64 %420, %struct.Memory* %call2_403998)
  ...
  ret %struct.Memory* %call2_4039a1
}
...
define %struct.Memory* @routine_jge_.L_403998(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i8* %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
...
define %struct.Memory* @routine_jge_.L_40395c(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i8* %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 2, i32 9
...
define %struct.Memory* @routine_jmpq_.L_4038fa(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
...
define %struct.Memory* @routine_callq_._Z26check_shifted_variable_sumIa32custom_divide_multiple_variable2IaEEvT_S2_S2_S2_S2_(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
...
define %struct.Memory* @routine_jmpq_.L_4038df(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
