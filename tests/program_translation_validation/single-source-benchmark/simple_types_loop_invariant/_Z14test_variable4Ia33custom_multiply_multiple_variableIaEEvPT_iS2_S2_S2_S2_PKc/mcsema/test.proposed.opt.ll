...
declare %struct.Memory* @sub_413970._Z26check_shifted_variable_sumIa33custom_multiply_multiple_variableIaEEvT_S2_S2_S2_S2_(%struct.State* noalias dereferenceable(3376), i64, %struct.Memory* noalias readnone returned) local_unnamed_addr
...
block_.L_40352f:                                  ; preds = %block_.L_4035ac, %entry
  %122 = phi i64 [ %409, %block_.L_4035ac ], [ %.pre, %entry ]
...
block_.L_40354a:                                  ; preds = %block_403556, %block_40353f
  %165 = phi i64 [ %330, %block_403556 ], [ %.pre6, %block_40353f ]
...
block_403556:                                     ; preds = %block_.L_40354a
  ...
  %call2_40358b = tail call %struct.Memory* @sub_413920._ZN33custom_multiply_multiple_variableIaE8do_shiftEaaaaa(%struct.State* nonnull %0, i64 %253, %struct.Memory* %call2_403523)
...
block_.L_4035ac:                                  ; preds = %block_.L_40354a
  ...
  %call2_4035d5 = tail call %struct.Memory* @sub_413970._Z26check_shifted_variable_sumIa33custom_multiply_multiple_variableIaEEvT_S2_S2_S2_S2_(%struct.State* nonnull %0, i64 %373, %struct.Memory* %call2_403523)
...
block_.L_4035e8:                                  ; preds = %block_.L_40352f
  ...
  %call2_4035e8 = tail call %struct.Memory* @sub_400e70._Z5timerv(%struct.State* nonnull %0, i64 %410, %struct.Memory* %call2_403523)
