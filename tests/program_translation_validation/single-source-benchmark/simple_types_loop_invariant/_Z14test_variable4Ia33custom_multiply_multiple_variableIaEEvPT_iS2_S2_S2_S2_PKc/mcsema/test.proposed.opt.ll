...
declare %struct.Memory* @sub_413970._Z26check_shifted_variable_sumIa33custom_multiply_multiple_variableIaEEvT_S2_S2_S2_S2_(%struct.State* dereferenceable(3376), i64, %struct.Memory*) local_unnamed_addr
...
entry:
  ...
  %call2_403523 = tail call %struct.Memory* @sub_400e50._Z11start_timerv(%struct.State* %0, i64 %110, %struct.Memory* %2)
...
block_.L_40352f:                                  ; preds = %block_.L_4035ac, %entry
  %122 = phi i64 [ %.pre, %entry ], [ %409, %block_.L_4035ac ]
  %MEMORY.0 = phi %struct.Memory* [ %call2_403523, %entry ], [ %call2_4035d5, %block_.L_4035ac ]
  ...
  br i1 %155, label %block_40353f, label %block_.L_4035e8
...
block_.L_40354a:                                  ; preds = %block_403556, %block_40353f
  %165 = phi i64 [ %.pre6, %block_40353f ], [ %330, %block_403556 ]
  %MEMORY.1 = phi %struct.Memory* [ %MEMORY.0, %block_40353f ], [ %call2_40358b, %block_403556 ]
  ...
  br i1 %201, label %block_403556, label %block_.L_4035ac
...
block_403556:                                     ; preds = %block_.L_40354a
  ...
  %call2_40358b = tail call %struct.Memory* @sub_413920._ZN33custom_multiply_multiple_variableIaE8do_shiftEaaaaa(%struct.State* nonnull %0, i64 %253, %struct.Memory* %MEMORY.1)
...
block_.L_4035ac:                                  ; preds = %block_.L_40354a
  ...
  %call2_4035d5 = tail call %struct.Memory* @sub_413970._Z26check_shifted_variable_sumIa33custom_multiply_multiple_variableIaEEvT_S2_S2_S2_S2_(%struct.State* nonnull %0, i64 %373, %struct.Memory* %MEMORY.1)
...
block_.L_4035e8:                                  ; preds = %block_.L_40352f
  ...
  %call2_4035e8 = tail call %struct.Memory* @sub_400e70._Z5timerv(%struct.State* nonnull %0, i64 %410, %struct.Memory* %MEMORY.0)
  ...
  %call2_4035f1 = tail call %struct.Memory* @sub_400810._Z13record_resultdPKc(%struct.State* nonnull %0, i64 %421, %struct.Memory* %call2_4035e8)
  ...
  ret %struct.Memory* %call2_4035f1
}
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_jge_.L_4035e8(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i8* nocapture %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_jge_.L_4035ac(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i8* nocapture %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 2, i32 9
