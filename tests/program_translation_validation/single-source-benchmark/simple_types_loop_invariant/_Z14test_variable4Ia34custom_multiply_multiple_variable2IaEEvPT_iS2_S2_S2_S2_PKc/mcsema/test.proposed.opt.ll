...
block_.L_40360f:                                  ; preds = %block_.L_40368c, %entry
  %122 = phi i64 [ %.pre, %entry ], [ %410, %block_.L_40368c ]
...
block_.L_40362a:                                  ; preds = %block_403636, %block_40361f
  %165 = phi i64 [ %.pre1, %block_40361f ], [ %330, %block_403636 ]
...
block_.L_40368c:                                  ; preds = %block_.L_40362a
  ...
  %call2_4036b5 = tail call %struct.Memory* @sub_413850._Z26check_shifted_variable_sumIa34custom_multiply_multiple_variable2IaEEvT_S2_S2_S2_S2_(%struct.State* %0, i64 %373, %struct.Memory* %MEMORY.1)
...
block_.L_4036c8:                                  ; preds = %block_.L_40360f
  ...
  %call2_4036c8 = tail call %struct.Memory* @sub_400e30._Z5timerv(%struct.State* %0, i64 %411, %struct.Memory* %MEMORY.0)
  ...
  %call2_4036d1 = tail call %struct.Memory* @sub_4007d0._Z13record_resultdPKc(%struct.State* %0, i64 %422, %struct.Memory* %call2_4036c8)
