...
declare %struct.Memory* @sub_413830._ZN34custom_multiply_multiple_variable2IaE8do_shiftEaaaaa(%struct.State* noalias dereferenceable(3376), i64, %struct.Memory* noalias readnone returned) local_unnamed_addr

declare %struct.Memory* @sub_413880._Z26check_shifted_variable_sumIa34custom_multiply_multiple_variable2IaEEvT_S2_S2_S2_S2_(%struct.State* noalias dereferenceable(3376), i64, %struct.Memory* noalias readnone returned) local_unnamed_addr
...
define %struct.Memory* @_Z14test_variable4Ia34custom_multiply_multiple_variable2IaEEvPT_iS2_S2_S2_S2_PKc(%struct.State* noalias, i64, %struct.Memory* noalias readnone) local_unnamed_addr #1 {
entry:
...
block_.L_40363f:                                  ; preds = %block_.L_4036bc, %entry
  %122 = phi i64 [ %409, %block_.L_4036bc ], [ %.pre, %entry ]
...
block_.L_40365a:                                  ; preds = %block_403666, %block_40364f
  %165 = phi i64 [ %330, %block_403666 ], [ %.pre6, %block_40364f ]
...
block_403666:                                     ; preds = %block_.L_40365a
  ...
  %call2_40369b = tail call %struct.Memory* @sub_413830._ZN34custom_multiply_multiple_variable2IaE8do_shiftEaaaaa(%struct.State* nonnull %0, i64 %253, %struct.Memory* %call2_403633)
...
block_.L_4036bc:                                  ; preds = %block_.L_40365a
  ...
  %call2_4036e5 = tail call %struct.Memory* @sub_413880._Z26check_shifted_variable_sumIa34custom_multiply_multiple_variable2IaEEvT_S2_S2_S2_S2_(%struct.State* nonnull %0, i64 %373, %struct.Memory* %call2_403633)
...
block_.L_4036f8:                                  ; preds = %block_.L_40363f
  ...
  %call2_4036f8 = tail call %struct.Memory* @sub_400e70._Z5timerv(%struct.State* nonnull %0, i64 %410, %struct.Memory* %call2_403633)
