...
declare %struct.Memory* @sub_413830._ZN34custom_multiply_multiple_variable2IaE8do_shiftEaaaaa(%struct.State* dereferenceable(3376), i64, %struct.Memory*) local_unnamed_addr

declare %struct.Memory* @sub_413880._Z26check_shifted_variable_sumIa34custom_multiply_multiple_variable2IaEEvT_S2_S2_S2_S2_(%struct.State* dereferenceable(3376), i64, %struct.Memory*) local_unnamed_addr
...
entry:
  ...
  %call2_403633 = tail call %struct.Memory* @sub_400e50._Z11start_timerv(%struct.State* %0, i64 %110, %struct.Memory* %2)
...
block_.L_40363f:                                  ; preds = %block_.L_4036bc, %entry
  %122 = phi i64 [ %.pre, %entry ], [ %409, %block_.L_4036bc ]
  %MEMORY.0 = phi %struct.Memory* [ %call2_403633, %entry ], [ %call2_4036e5, %block_.L_4036bc ]
  ...
  br i1 %155, label %block_40364f, label %block_.L_4036f8
...
block_.L_40365a:                                  ; preds = %block_403666, %block_40364f
  %165 = phi i64 [ %.pre6, %block_40364f ], [ %330, %block_403666 ]
  %MEMORY.1 = phi %struct.Memory* [ %MEMORY.0, %block_40364f ], [ %call2_40369b, %block_403666 ]
  ...
  br i1 %201, label %block_403666, label %block_.L_4036bc
...
block_403666:                                     ; preds = %block_.L_40365a
  ...
  %call2_40369b = tail call %struct.Memory* @sub_413830._ZN34custom_multiply_multiple_variable2IaE8do_shiftEaaaaa(%struct.State* nonnull %0, i64 %253, %struct.Memory* %MEMORY.1)
...
block_.L_4036bc:                                  ; preds = %block_.L_40365a
  ...
  %call2_4036e5 = tail call %struct.Memory* @sub_413880._Z26check_shifted_variable_sumIa34custom_multiply_multiple_variable2IaEEvT_S2_S2_S2_S2_(%struct.State* nonnull %0, i64 %373, %struct.Memory* %MEMORY.1)
...
block_.L_4036f8:                                  ; preds = %block_.L_40363f
  ...
  %call2_4036f8 = tail call %struct.Memory* @sub_400e70._Z5timerv(%struct.State* nonnull %0, i64 %410, %struct.Memory* %MEMORY.0)
  ...
  %call2_403701 = tail call %struct.Memory* @sub_400810._Z13record_resultdPKc(%struct.State* nonnull %0, i64 %421, %struct.Memory* %call2_4036f8)
  ...
  ret %struct.Memory* %call2_403701
}
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_jge_.L_4036f8(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i8* nocapture %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_jge_.L_4036bc(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i8* nocapture %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 2, i32 9
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_jmpq_.L_40365a(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_jmpq_.L_40363f(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
