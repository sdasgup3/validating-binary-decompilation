...
declare %struct.Memory* @sub_413840._ZN34custom_multiply_multiple_variable2IaE8do_shiftEaaaaa(%struct.State* noalias dereferenceable(3376), i64, %struct.Memory* noalias readnone returned) local_unnamed_addr

declare %struct.Memory* @sub_413890._Z26check_shifted_variable_sumIa34custom_multiply_multiple_variable2IaEEvT_S2_S2_S2_S2_(%struct.State* noalias dereferenceable(3376), i64, %struct.Memory* noalias readnone returned) local_unnamed_addr
...
entry:
  ...
  %call2_403643 = tail call %struct.Memory* @sub_400e60._Z11start_timerv(%struct.State* %0, i64 %110, %struct.Memory* %2)
...
block_.L_40364f:                                  ; preds = %block_.L_4036cc, %entry
  %122 = phi i64 [ %409, %block_.L_4036cc ], [ %.pre, %entry ]
  ...
  br i1 %155, label %block_40365f, label %block_.L_403708
...
block_.L_40366a:                                  ; preds = %block_403676, %block_40365f
  %165 = phi i64 [ %330, %block_403676 ], [ %.pre6, %block_40365f ]
  ...
  br i1 %201, label %block_403676, label %block_.L_4036cc
...
block_403676:                                     ; preds = %block_.L_40366a
  ...
  %call2_4036ab = tail call %struct.Memory* @sub_413840._ZN34custom_multiply_multiple_variable2IaE8do_shiftEaaaaa(%struct.State* nonnull %0, i64 %253, %struct.Memory* %call2_403643)
...
block_.L_4036cc:                                  ; preds = %block_.L_40366a
  ...
  %call2_4036f5 = tail call %struct.Memory* @sub_413890._Z26check_shifted_variable_sumIa34custom_multiply_multiple_variable2IaEEvT_S2_S2_S2_S2_(%struct.State* nonnull %0, i64 %373, %struct.Memory* %call2_403643)
...
block_.L_403708:                                  ; preds = %block_.L_40364f
  ...
  %call2_403708 = tail call %struct.Memory* @sub_400e80._Z5timerv(%struct.State* nonnull %0, i64 %410, %struct.Memory* %call2_403643)
  ...
  %call2_403711 = tail call %struct.Memory* @sub_400820._Z13record_resultdPKc(%struct.State* nonnull %0, i64 %421, %struct.Memory* %call2_403708)
