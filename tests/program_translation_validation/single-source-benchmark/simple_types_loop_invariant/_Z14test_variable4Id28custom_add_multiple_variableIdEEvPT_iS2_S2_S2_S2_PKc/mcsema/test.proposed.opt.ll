...
declare %struct.Memory* @sub_40c660._ZN28custom_add_multiple_variableIdE8do_shiftEddddd(%struct.State* dereferenceable(3376), i64, %struct.Memory*) local_unnamed_addr

declare %struct.Memory* @sub_40c6a0._Z26check_shifted_variable_sumId28custom_add_multiple_variableIdEEvT_S2_S2_S2_S2_(%struct.State* dereferenceable(3376), i64, %struct.Memory*) local_unnamed_addr
...
block_.L_40b743:                                  ; preds = %block_.L_40b7ac, %entry
  %110 = phi i64 [ %.pre, %entry ], [ %323, %block_.L_40b7ac ]
  %MEMORY.0 = phi %struct.Memory* [ %call2_40b737, %entry ], [ %call2_40b7c5, %block_.L_40b7ac ]
...
block_.L_40b762:                                  ; preds = %block_40b76e, %block_40b753
  %154 = phi i64 [ %.pre6, %block_40b753 ], [ %266, %block_40b76e ]
  %MEMORY.1 = phi %struct.Memory* [ %MEMORY.0, %block_40b753 ], [ %call2_40b78f, %block_40b76e ]
...
block_40b76e:                                     ; preds = %block_.L_40b762
  ...
  %call2_40b78f = tail call %struct.Memory* @sub_40c660._ZN28custom_add_multiple_variableIdE8do_shiftEddddd(%struct.State* nonnull %0, i64 %220, %struct.Memory* %MEMORY.1)
...
block_.L_40b7ac:                                  ; preds = %block_.L_40b762
  ...
  %call2_40b7c5 = tail call %struct.Memory* @sub_40c6a0._Z26check_shifted_variable_sumId28custom_add_multiple_variableIdEEvT_S2_S2_S2_S2_(%struct.State* nonnull %0, i64 %287, %struct.Memory* %MEMORY.1)
...
block_.L_40b7d8:                                  ; preds = %block_.L_40b743
  ...
  %call2_40b7d8 = tail call %struct.Memory* @sub_400e70._Z5timerv(%struct.State* nonnull %0, i64 %324, %struct.Memory* %MEMORY.0)
