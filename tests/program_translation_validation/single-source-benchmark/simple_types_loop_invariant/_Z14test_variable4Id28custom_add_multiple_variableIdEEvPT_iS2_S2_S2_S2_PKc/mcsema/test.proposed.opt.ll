...
declare %struct.Memory* @sub_40c630._ZN28custom_add_multiple_variableIdE8do_shiftEddddd(%struct.State* noalias dereferenceable(3376), i64, %struct.Memory* noalias readnone returned) local_unnamed_addr

declare %struct.Memory* @sub_40c670._Z26check_shifted_variable_sumId28custom_add_multiple_variableIdEEvT_S2_S2_S2_S2_(%struct.State* noalias dereferenceable(3376), i64, %struct.Memory* noalias readnone returned) local_unnamed_addr
...
define %struct.Memory* @_Z14test_variable4Id28custom_add_multiple_variableIdEEvPT_iS2_S2_S2_S2_PKc(%struct.State* noalias, i64, %struct.Memory* noalias) local_unnamed_addr #1 {
entry:
  ...
  %40 = add i64 %7, -16
  %41 = load i64, i64* %RDI.i101, align 8
  %42 = add i64 %10, 11
  ...
  %56 = getelementptr inbounds [32 x %union.VectorReg], [32 x %union.VectorReg]* %51, i64 0, i64 0, i32 0, i32 0, i32 0, i64 0
  ...
  %64 = getelementptr inbounds %union.VectorReg, %union.VectorReg* %59, i64 0, i32 0, i32 0, i32 0, i64 0
  %65 = load i64, i64* %64, align 1
  %66 = inttoptr i64 %61 to i64*
  store i64 %65, i64* %66, align 8
  %67 = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 1, i64 2
  %68 = load i64, i64* %RBP.i, align 8
  %69 = add i64 %68, -40
  %70 = load i64, i64* %PC.i, align 8
  %71 = add i64 %70, 5
  store i64 %71, i64* %PC.i, align 8
  %72 = getelementptr inbounds %union.VectorReg, %union.VectorReg* %67, i64 0, i32 0, i32 0, i32 0, i64 0
  %73 = load i64, i64* %72, align 1
  %74 = inttoptr i64 %69 to i64*
  store i64 %73, i64* %74, align 8
  %75 = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 1, i64 3
  %76 = load i64, i64* %RBP.i, align 8
  %77 = add i64 %76, -48
  %78 = load i64, i64* %PC.i, align 8
  %79 = add i64 %78, 5
  store i64 %79, i64* %PC.i, align 8
  %80 = getelementptr inbounds %union.VectorReg, %union.VectorReg* %75, i64 0, i32 0, i32 0, i32 0, i64 0
  ...
  %call2_40b707 = tail call %struct.Memory* @sub_400e10._Z11start_timerv(%struct.State* %0, i64 %90, %struct.Memory* %2)
  ...
  %108 = bitcast [32 x %union.VectorReg]* %51 to double*
  %109 = bitcast i64* %101 to double*
  ...
  %114 = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 1, i64 3, i32 0, i32 0, i32 0, i64 1
  %115 = bitcast i64* %114 to double*
  %116 = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 1, i64 4
  %117 = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 1, i64 4, i32 0, i32 0, i32 0, i64 1
  %118 = bitcast i64* %117 to double*
  %.pre = load i64, i64* %PC.i, align 8
  br label %block_.L_40b713

block_.L_40b713:                                  ; preds = %block_.L_40b77c, %entry
  %119 = phi i64 [ %.pre, %entry ], [ %344, %block_.L_40b77c ]
  %MEMORY.0 = phi %struct.Memory* [ %call2_40b707, %entry ], [ %call2_40b795, %block_.L_40b77c ]
  ...
  store i64 %125, i64* %RAX.i82, align 8
  %126 = load i32, i32* bitcast (%G_0x61a080_type* @G_0x61a080 to i32*), align 8
  %127 = sub i32 %124, %126
  ...
  %152 = xor i1 %151, %149
  %.v = select i1 %152, i64 16, i64 149
  %153 = add i64 %119, %.v
  store i64 %153, i64* %3, align 8
  br i1 %152, label %block_40b723, label %block_.L_40b7a8

block_40b723:                                     ; preds = %block_.L_40b713
  ...
  %156 = getelementptr inbounds [32 x %union.VectorReg], [32 x %union.VectorReg]* %51, i64 0, i64 0, i32 0, i32 0, i32 0, i64 0
  ...
  br label %block_.L_40b732

block_.L_40b732:                                  ; preds = %block_40b73e, %block_40b723
  %164 = phi i64 [ %.pre1, %block_40b723 ], [ %281, %block_40b73e ]
  %MEMORY.1 = phi %struct.Memory* [ %MEMORY.0, %block_40b723 ], [ %call2_40b75f, %block_40b73e ]
  ...
  store i64 %170, i64* %RAX.i82, align 8
  %171 = add i64 %165, -12
  %172 = add i64 %164, 6
  ...
  %200 = xor i1 %199, %197
  %.v2 = select i1 %200, i64 12, i64 74
  %201 = add i64 %164, %.v2
  store i64 %201, i64* %3, align 8
  br i1 %200, label %block_40b73e, label %block_.L_40b77c

block_40b73e:                                     ; preds = %block_.L_40b732
  %202 = add i64 %165, -8
  %203 = add i64 %201, 4
  store i64 %203, i64* %PC.i, align 8
  %204 = inttoptr i64 %202 to i64*
  %205 = load i64, i64* %204, align 8
  store i64 %205, i64* %RAX.i82, align 8
  %206 = add i64 %201, 8
  store i64 %206, i64* %PC.i, align 8
  %207 = load i32, i32* %168, align 4
  %208 = sext i32 %207 to i64
  store i64 %208, i64* %RCX.i58, align 8
  ...
  %214 = getelementptr inbounds [32 x %union.VectorReg], [32 x %union.VectorReg]* %51, i64 0, i64 0, i32 0, i32 0, i32 0, i64 0
  ...
  %219 = getelementptr inbounds %union.VectorReg, %union.VectorReg* %59, i64 0, i32 0, i32 0, i32 0, i64 0
  ...
  %224 = getelementptr inbounds %union.VectorReg, %union.VectorReg* %67, i64 0, i32 0, i32 0, i32 0, i64 0
  ...
  %229 = getelementptr inbounds %union.VectorReg, %union.VectorReg* %75, i64 0, i32 0, i32 0, i32 0, i64 0
  ...
  %234 = getelementptr inbounds %union.VectorReg, %union.VectorReg* %116, i64 0, i32 0, i32 0, i32 0, i64 0
  store i64 %233, i64* %234, align 1
  store double 0.000000e+00, double* %118, align 1
  %235 = add i64 %201, 3826
  %236 = add i64 %201, 38
  ...
  %call2_40b75f = tail call %struct.Memory* @sub_40c630._ZN28custom_add_multiple_variableIdE8do_shiftEddddd(%struct.State* %0, i64 %235, %struct.Memory* %MEMORY.1)
  %240 = load i64, i64* %RBP.i, align 8
  %241 = add i64 %240, -72
  %242 = load i64, i64* %PC.i, align 8
  %243 = add i64 %242, 5
  store i64 %243, i64* %PC.i, align 8
  %244 = load double, double* %108, align 1
  %245 = inttoptr i64 %241 to double*
  %246 = load double, double* %245, align 8
  %247 = fadd double %244, %246
  store double %247, double* %108, align 1
  %248 = add i64 %242, 10
  ...
  store i64 %256, i64* %RAX.i82, align 8
...
block_.L_40b77c:                                  ; preds = %block_.L_40b732
  %282 = add i64 %165, -72
  %283 = add i64 %201, 5
  store i64 %283, i64* %PC.i, align 8
  %284 = inttoptr i64 %282 to i64*
  %285 = load i64, i64* %284, align 8
  %286 = getelementptr inbounds [32 x %union.VectorReg], [32 x %union.VectorReg]* %51, i64 0, i64 0, i32 0, i32 0, i32 0, i64 0
  ...
  %291 = getelementptr inbounds %union.VectorReg, %union.VectorReg* %59, i64 0, i32 0, i32 0, i32 0, i64 0
  ...
  %296 = getelementptr inbounds %union.VectorReg, %union.VectorReg* %67, i64 0, i32 0, i32 0, i32 0, i64 0
  ...
  %301 = getelementptr inbounds %union.VectorReg, %union.VectorReg* %75, i64 0, i32 0, i32 0, i32 0, i64 0
  ...
  %306 = getelementptr inbounds %union.VectorReg, %union.VectorReg* %116, i64 0, i32 0, i32 0, i32 0, i64 0
  store i64 %305, i64* %306, align 1
  store double 0.000000e+00, double* %118, align 1
  %307 = add i64 %201, 3828
  %308 = add i64 %201, 30
  ...
  %call2_40b795 = tail call %struct.Memory* @sub_40c670._Z26check_shifted_variable_sumId28custom_add_multiple_variableIdEEvT_S2_S2_S2_S2_(%struct.State* %0, i64 %307, %struct.Memory* %MEMORY.1)
...
block_.L_40b7a8:                                  ; preds = %block_.L_40b713
  %345 = add i64 %153, -43384
  %346 = add i64 %153, 5
  ...
  %call2_40b7a8 = tail call %struct.Memory* @sub_400e30._Z5timerv(%struct.State* %0, i64 %345, %struct.Memory* %MEMORY.0)
  ...
  store i64 %355, i64* %RDI.i101, align 8
  %356 = add i64 %352, -45021
  %357 = add i64 %352, 9
  ...
  %call2_40b7b1 = tail call %struct.Memory* @sub_4007d0._Z13record_resultdPKc(%struct.State* %0, i64 %356, %struct.Memory* %call2_40b7a8)
  %361 = load i64, i64* %RSP.i106, align 8
  %362 = load i64, i64* %PC.i, align 8
  %363 = add i64 %361, 80
  store i64 %363, i64* %RSP.i106, align 8
  %364 = icmp ugt i64 %361, -81
  ...
  %387 = add i64 %361, 88
  %388 = inttoptr i64 %363 to i64*
  %389 = load i64, i64* %388, align 8
  store i64 %389, i64* %RBP.i, align 8
  ...
  ret %struct.Memory* %call2_40b7b1
}
...
define %struct.Memory* @routine_movsd__xmm3__MINUS0x30__rbp_(%struct.State* dereferenceable(3376), i64, %struct.Memory*) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %RBP = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 15, i32 0, i32 0
  %3 = load i64, i64* %RBP, align 8
...
define %struct.Memory* @routine_jge_.L_40b7a8(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i8* %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
...
define %struct.Memory* @routine_jge_.L_40b77c(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i8* %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 2, i32 9
...
define %struct.Memory* @routine_movsd_MINUS0x20__rbp____xmm2(%struct.State* dereferenceable(3376), i64, %struct.Memory*) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %RBP = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 15, i32 0, i32 0
  %3 = load i64, i64* %RBP, align 8
...
define %struct.Memory* @routine_movsd_MINUS0x30__rbp____xmm4(%struct.State* dereferenceable(3376), i64, %struct.Memory*) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %RBP = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 15, i32 0, i32 0
  %3 = load i64, i64* %RBP, align 8
...
define %struct.Memory* @routine_callq_._ZN28custom_add_multiple_variableIdE8do_shiftEddddd(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
...
define %struct.Memory* @routine_jmpq_.L_40b732(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
...
define %struct.Memory* @routine_callq_._Z26check_shifted_variable_sumId28custom_add_multiple_variableIdEEvT_S2_S2_S2_S2_(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
...
define %struct.Memory* @routine_jmpq_.L_40b713(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
