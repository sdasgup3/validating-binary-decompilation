...
block_.L_40b713:                                  ; preds = %block_.L_40b77c, %entry
  %119 = phi i64 [ %.pre, %entry ], [ %333, %block_.L_40b77c ]
...
block_.L_40b732:                                  ; preds = %block_40b73e, %block_40b723
  %163 = phi i64 [ %.pre1, %block_40b723 ], [ %275, %block_40b73e ]
  ...
  br i1 %199, label %block_40b73e, label %block_.L_40b77c
...
block_40b73e:                                     ; preds = %block_.L_40b732
  ...
  %call2_40b75f = tail call %struct.Memory* @sub_40c630._ZN28custom_add_multiple_variableIdE8do_shiftEddddd(%struct.State* %0, i64 %230, %struct.Memory* %MEMORY.1)
...
block_.L_40b77c:                                  ; preds = %block_.L_40b732
  ...
  %call2_40b795 = tail call %struct.Memory* @sub_40c670._Z26check_shifted_variable_sumId28custom_add_multiple_variableIdEEvT_S2_S2_S2_S2_(%struct.State* %0, i64 %297, %struct.Memory* %MEMORY.1)
...
block_.L_40b7a8:                                  ; preds = %block_.L_40b713
  ...
  %call2_40b7a8 = tail call %struct.Memory* @sub_400e30._Z5timerv(%struct.State* %0, i64 %334, %struct.Memory* %MEMORY.0)
  ...
  %call2_40b7b1 = tail call %struct.Memory* @sub_4007d0._Z13record_resultdPKc(%struct.State* %0, i64 %345, %struct.Memory* %call2_40b7a8)
