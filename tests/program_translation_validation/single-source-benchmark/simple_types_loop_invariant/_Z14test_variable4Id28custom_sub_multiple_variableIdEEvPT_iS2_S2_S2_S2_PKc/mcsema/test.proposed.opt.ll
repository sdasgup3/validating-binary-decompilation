...
declare %struct.Memory* @sub_40c550._Z26check_shifted_variable_sumId28custom_sub_multiple_variableIdEEvT_S2_S2_S2_S2_(%struct.State* noalias dereferenceable(3376), i64, %struct.Memory* noalias readnone returned) local_unnamed_addr
...
entry:
  ...
  %call2_40b8d7 = tail call %struct.Memory* @sub_400e60._Z11start_timerv(%struct.State* %0, i64 %87, %struct.Memory* %2)
...
block_.L_40b8e3:                                  ; preds = %block_.L_40b94c, %entry
  %110 = phi i64 [ %323, %block_.L_40b94c ], [ %.pre, %entry ]
  ...
  br i1 %143, label %block_40b8f3, label %block_.L_40b978
...
block_.L_40b902:                                  ; preds = %block_40b90e, %block_40b8f3
  %154 = phi i64 [ %266, %block_40b90e ], [ %.pre6, %block_40b8f3 ]
  ...
  br i1 %190, label %block_40b90e, label %block_.L_40b94c
...
block_40b90e:                                     ; preds = %block_.L_40b902
  ...
  %call2_40b92f = tail call %struct.Memory* @sub_40c510._ZN28custom_sub_multiple_variableIdE8do_shiftEddddd(%struct.State* nonnull %0, i64 %220, %struct.Memory* %call2_40b8d7)
...
block_.L_40b94c:                                  ; preds = %block_.L_40b902
  ...
  %call2_40b965 = tail call %struct.Memory* @sub_40c550._Z26check_shifted_variable_sumId28custom_sub_multiple_variableIdEEvT_S2_S2_S2_S2_(%struct.State* nonnull %0, i64 %287, %struct.Memory* %call2_40b8d7)
...
block_.L_40b978:                                  ; preds = %block_.L_40b8e3
  ...
  %call2_40b978 = tail call %struct.Memory* @sub_400e80._Z5timerv(%struct.State* nonnull %0, i64 %324, %struct.Memory* %call2_40b8d7)
  ...
  %call2_40b981 = tail call %struct.Memory* @sub_400820._Z13record_resultdPKc(%struct.State* nonnull %0, i64 %335, %struct.Memory* %call2_40b978)
