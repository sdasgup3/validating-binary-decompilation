...
block_.L_40b8a3:                                  ; preds = %block_.L_40b90c, %entry
  %119 = phi i64 [ %.pre, %entry ], [ %344, %block_.L_40b90c ]
...
block_.L_40b8c2:                                  ; preds = %block_40b8ce, %block_40b8b3
  %164 = phi i64 [ %.pre1, %block_40b8b3 ], [ %281, %block_40b8ce ]
  ...
  br i1 %200, label %block_40b8ce, label %block_.L_40b90c
...
block_40b8ce:                                     ; preds = %block_.L_40b8c2
  ...
  %call2_40b8ef = tail call %struct.Memory* @sub_40c4d0._ZN28custom_sub_multiple_variableIdE8do_shiftEddddd(%struct.State* %0, i64 %235, %struct.Memory* %MEMORY.1)
...
block_.L_40b90c:                                  ; preds = %block_.L_40b8c2
  ...
  %call2_40b925 = tail call %struct.Memory* @sub_40c510._Z26check_shifted_variable_sumId28custom_sub_multiple_variableIdEEvT_S2_S2_S2_S2_(%struct.State* %0, i64 %307, %struct.Memory* %MEMORY.1)
...
block_.L_40b938:                                  ; preds = %block_.L_40b8a3
  ...
  %call2_40b938 = tail call %struct.Memory* @sub_400e30._Z5timerv(%struct.State* %0, i64 %345, %struct.Memory* %MEMORY.0)
  ...
  %call2_40b941 = tail call %struct.Memory* @sub_4007d0._Z13record_resultdPKc(%struct.State* %0, i64 %356, %struct.Memory* %call2_40b938)
