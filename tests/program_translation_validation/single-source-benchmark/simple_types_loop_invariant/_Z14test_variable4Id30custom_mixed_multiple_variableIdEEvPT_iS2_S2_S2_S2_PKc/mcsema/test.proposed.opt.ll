...
block_.L_40be63:                                  ; preds = %block_.L_40becc, %entry
  %119 = phi i64 [ %.pre, %entry ], [ %333, %block_.L_40becc ]
...
block_.L_40be82:                                  ; preds = %block_40be8e, %block_40be73
  %163 = phi i64 [ %.pre1, %block_40be73 ], [ %275, %block_40be8e ]
  ...
  br i1 %199, label %block_40be8e, label %block_.L_40becc
...
block_40be8e:                                     ; preds = %block_.L_40be82
  ...
  %call2_40beaf = tail call %struct.Memory* @sub_40bf10._ZN30custom_mixed_multiple_variableIdE8do_shiftEddddd(%struct.State* %0, i64 %230, %struct.Memory* %MEMORY.1)
...
block_.L_40becc:                                  ; preds = %block_.L_40be82
  ...
  %call2_40bee5 = tail call %struct.Memory* @sub_40bf50._Z26check_shifted_variable_sumId30custom_mixed_multiple_variableIdEEvT_S2_S2_S2_S2_(%struct.State* %0, i64 %297, %struct.Memory* %MEMORY.1)
...
block_.L_40bef8:                                  ; preds = %block_.L_40be63
  ...
  %call2_40bef8 = tail call %struct.Memory* @sub_400e30._Z5timerv(%struct.State* %0, i64 %334, %struct.Memory* %MEMORY.0)
  ...
  %call2_40bf01 = tail call %struct.Memory* @sub_4007d0._Z13record_resultdPKc(%struct.State* %0, i64 %345, %struct.Memory* %call2_40bef8)
