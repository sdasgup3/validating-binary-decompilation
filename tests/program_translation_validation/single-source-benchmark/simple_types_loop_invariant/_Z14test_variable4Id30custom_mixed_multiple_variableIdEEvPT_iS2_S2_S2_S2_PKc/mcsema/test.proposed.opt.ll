...
declare %struct.Memory* @sub_40bf40._ZN30custom_mixed_multiple_variableIdE8do_shiftEddddd(%struct.State* dereferenceable(3376), i64, %struct.Memory*) local_unnamed_addr

declare %struct.Memory* @sub_40bf80._Z26check_shifted_variable_sumId30custom_mixed_multiple_variableIdEEvT_S2_S2_S2_S2_(%struct.State* dereferenceable(3376), i64, %struct.Memory*) local_unnamed_addr
...
block_.L_40be93:                                  ; preds = %block_.L_40befc, %entry
  %110 = phi i64 [ %.pre, %entry ], [ %323, %block_.L_40befc ]
  %MEMORY.0 = phi %struct.Memory* [ %call2_40be87, %entry ], [ %call2_40bf15, %block_.L_40befc ]
...
block_.L_40beb2:                                  ; preds = %block_40bebe, %block_40bea3
  %154 = phi i64 [ %.pre6, %block_40bea3 ], [ %266, %block_40bebe ]
  %MEMORY.1 = phi %struct.Memory* [ %MEMORY.0, %block_40bea3 ], [ %call2_40bedf, %block_40bebe ]
...
block_40bebe:                                     ; preds = %block_.L_40beb2
  ...
  %call2_40bedf = tail call %struct.Memory* @sub_40bf40._ZN30custom_mixed_multiple_variableIdE8do_shiftEddddd(%struct.State* nonnull %0, i64 %220, %struct.Memory* %MEMORY.1)
...
block_.L_40befc:                                  ; preds = %block_.L_40beb2
  ...
  %call2_40bf15 = tail call %struct.Memory* @sub_40bf80._Z26check_shifted_variable_sumId30custom_mixed_multiple_variableIdEEvT_S2_S2_S2_S2_(%struct.State* nonnull %0, i64 %287, %struct.Memory* %MEMORY.1)
...
block_.L_40bf28:                                  ; preds = %block_.L_40be93
  ...
  %call2_40bf28 = tail call %struct.Memory* @sub_400e70._Z5timerv(%struct.State* nonnull %0, i64 %324, %struct.Memory* %MEMORY.0)
