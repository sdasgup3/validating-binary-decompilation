...
declare %struct.Memory* @sub_40c180._Z26check_shifted_variable_sumId31custom_divide_multiple_variableIdEEvT_S2_S2_S2_S2_(%struct.State* noalias dereferenceable(3376), i64, %struct.Memory* noalias readnone returned)
...
entry:
  ...
  %loadMem_40bc84 = load %struct.Memory*, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_40bc84, %struct.Memory** %MEMORY
  ...
  %loadMem_40bc8e = load %struct.Memory*, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_40bc8e, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem1_40bc97, %struct.Memory** %MEMORY
  %loadMem2_40bc97 = load %struct.Memory*, %struct.Memory** %MEMORY
  %loadPC_40bc97 = load i64, i64* %3
  %call2_40bc97 = call %struct.Memory* @sub_400e10._Z11start_timerv(%struct.State* %0, i64 %loadPC_40bc97, %struct.Memory* %loadMem2_40bc97)
  store %struct.Memory* %call2_40bc97, %struct.Memory** %MEMORY
  ...
  br label %block_.L_40bca3

block_.L_40bca3:                                  ; preds = %block_.L_40bd0c, %entry
  ...
  store %struct.Memory* %loadMem_40bca6, %struct.Memory** %MEMORY
  ...
  %loadBr_40bcad = load i8, i8* %BRANCH_TAKEN
  %cmpBr_40bcad = icmp eq i8 %loadBr_40bcad, 1
  br i1 %cmpBr_40bcad, label %block_.L_40bd38, label %block_40bcb3

block_40bcb3:                                     ; preds = %block_.L_40bca3
  ...
  %loadMem_40bcbb = load %struct.Memory*, %struct.Memory** %MEMORY
  ...
  store i32 0, i32* %342
  store %struct.Memory* %loadMem_40bcbb, %struct.Memory** %MEMORY
  br label %block_.L_40bcc2

block_.L_40bcc2:                                  ; preds = %block_40bcce, %block_40bcb3
  ...
  %loadBr_40bcc8 = load i8, i8* %BRANCH_TAKEN
  %cmpBr_40bcc8 = icmp eq i8 %loadBr_40bcc8, 1
  br i1 %cmpBr_40bcc8, label %block_.L_40bd0c, label %block_40bcce

block_40bcce:                                     ; preds = %block_.L_40bcc2
  ...
  %loadMem_40bcdb = load %struct.Memory*, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_40bcdb, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_40bcea, %struct.Memory** %MEMORY
  %loadMem1_40bcef = load %struct.Memory*, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem1_40bcef, %struct.Memory** %MEMORY
  %loadMem2_40bcef = load %struct.Memory*, %struct.Memory** %MEMORY
  %loadPC_40bcef = load i64, i64* %3
  %call2_40bcef = call %struct.Memory* @sub_40c140._ZN31custom_divide_multiple_variableIdE8do_shiftEddddd(%struct.State* %0, i64 %loadPC_40bcef, %struct.Memory* %loadMem2_40bcef)
  store %struct.Memory* %call2_40bcef, %struct.Memory** %MEMORY
  %loadMem_40bcf4 = load %struct.Memory*, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_40bcf4, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_40bcf9, %struct.Memory** %MEMORY
  ...
  %loadMem_40bd01 = load %struct.Memory*, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_40bd01, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_40bd07, %struct.Memory** %MEMORY
  br label %block_.L_40bcc2

block_.L_40bd0c:                                  ; preds = %block_.L_40bcc2
  %loadMem_40bd0c = load %struct.Memory*, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_40bd0c, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_40bd11, %struct.Memory** %MEMORY
  ...
  %loadMem1_40bd25 = load %struct.Memory*, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem1_40bd25, %struct.Memory** %MEMORY
  %loadMem2_40bd25 = load %struct.Memory*, %struct.Memory** %MEMORY
  %loadPC_40bd25 = load i64, i64* %3
  %call2_40bd25 = call %struct.Memory* @sub_40c180._Z26check_shifted_variable_sumId31custom_divide_multiple_variableIdEEvT_S2_S2_S2_S2_(%struct.State* %0, i64 %loadPC_40bd25, %struct.Memory* %loadMem2_40bd25)
  store %struct.Memory* %call2_40bd25, %struct.Memory** %MEMORY
  ...
  %loadMem_40bd30 = load %struct.Memory*, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_40bd30, %struct.Memory** %MEMORY
...
block_.L_40bd38:                                  ; preds = %block_.L_40bca3
  %loadMem1_40bd38 = load %struct.Memory*, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem1_40bd38, %struct.Memory** %MEMORY
  %loadMem2_40bd38 = load %struct.Memory*, %struct.Memory** %MEMORY
  %loadPC_40bd38 = load i64, i64* %3
  %call2_40bd38 = call %struct.Memory* @sub_400e30._Z5timerv(%struct.State* %0, i64 %loadPC_40bd38, %struct.Memory* %loadMem2_40bd38)
  store %struct.Memory* %call2_40bd38, %struct.Memory** %MEMORY
  ...
  %loadMem1_40bd41 = load %struct.Memory*, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem1_40bd41, %struct.Memory** %MEMORY
  %loadMem2_40bd41 = load %struct.Memory*, %struct.Memory** %MEMORY
  %loadPC_40bd41 = load i64, i64* %3
  %call2_40bd41 = call %struct.Memory* @sub_4007d0._Z13record_resultdPKc(%struct.State* %0, i64 %loadPC_40bd41, %struct.Memory* %loadMem2_40bd41)
  store %struct.Memory* %call2_40bd41, %struct.Memory** %MEMORY
  ...
  ret %struct.Memory* %loadMem_40bd4b
}
...
define %struct.Memory* @routine_jge_.L_40bd38(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i8* %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) {
block_400478:
  %3 = getelementptr inbounds %struct.State, %struct.State* %0, i32 0, i32 6
  %4 = getelementptr inbounds %struct.GPR, %struct.GPR* %3, i32 0, i32 33
  %5 = getelementptr inbounds %struct.Reg, %struct.Reg* %4, i32 0, i32 0
...
define %struct.Memory* @routine_jge_.L_40bd0c(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i8* %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) {
block_400478:
  %3 = getelementptr inbounds %struct.State, %struct.State* %0, i32 0, i32 6
  %4 = getelementptr inbounds %struct.GPR, %struct.GPR* %3, i32 0, i32 33
  %5 = getelementptr inbounds %struct.Reg, %struct.Reg* %4, i32 0, i32 0
...
define %struct.Memory* @routine_jmpq_.L_40bcc2(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i64 %rel_off1, i64 %rel_off2) {
block_400478:
  %3 = getelementptr inbounds %struct.State, %struct.State* %0, i32 0, i32 6
  %4 = getelementptr inbounds %struct.GPR, %struct.GPR* %3, i32 0, i32 33
  %5 = getelementptr inbounds %struct.Reg, %struct.Reg* %4, i32 0, i32 0
...
define %struct.Memory* @routine_jmpq_.L_40bca3(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i64 %rel_off1, i64 %rel_off2) {
block_400478:
  %3 = getelementptr inbounds %struct.State, %struct.State* %0, i32 0, i32 6
  %4 = getelementptr inbounds %struct.GPR, %struct.GPR* %3, i32 0, i32 33
  %5 = getelementptr inbounds %struct.Reg, %struct.Reg* %4, i32 0, i32 0
