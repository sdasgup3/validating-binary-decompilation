...
declare %struct.Memory* @sub_40c1b0._Z26check_shifted_variable_sumId31custom_divide_multiple_variableIdEEvT_S2_S2_S2_S2_(%struct.State* noalias dereferenceable(3376), i64, %struct.Memory* noalias readnone returned) local_unnamed_addr
...
define %struct.Memory* @_Z14test_variable4Id31custom_divide_multiple_variableIdEEvPT_iS2_S2_S2_S2_PKc(%struct.State* noalias, i64, %struct.Memory* noalias readnone) local_unnamed_addr #1 {
entry:
...
block_.L_40bcd3:                                  ; preds = %block_.L_40bd3c, %entry
  %110 = phi i64 [ %323, %block_.L_40bd3c ], [ %.pre, %entry ]
...
block_.L_40bcf2:                                  ; preds = %block_40bcfe, %block_40bce3
  %154 = phi i64 [ %266, %block_40bcfe ], [ %.pre6, %block_40bce3 ]
...
block_40bcfe:                                     ; preds = %block_.L_40bcf2
  ...
  %call2_40bd1f = tail call %struct.Memory* @sub_40c170._ZN31custom_divide_multiple_variableIdE8do_shiftEddddd(%struct.State* nonnull %0, i64 %220, %struct.Memory* %call2_40bcc7)
...
block_.L_40bd3c:                                  ; preds = %block_.L_40bcf2
  ...
  %call2_40bd55 = tail call %struct.Memory* @sub_40c1b0._Z26check_shifted_variable_sumId31custom_divide_multiple_variableIdEEvT_S2_S2_S2_S2_(%struct.State* nonnull %0, i64 %287, %struct.Memory* %call2_40bcc7)
...
block_.L_40bd68:                                  ; preds = %block_.L_40bcd3
  ...
  %call2_40bd68 = tail call %struct.Memory* @sub_400e70._Z5timerv(%struct.State* nonnull %0, i64 %324, %struct.Memory* %call2_40bcc7)
