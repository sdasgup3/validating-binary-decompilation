...
declare %struct.Memory* @sub_40c180._Z26check_shifted_variable_sumId31custom_divide_multiple_variableIdEEvT_S2_S2_S2_S2_(%struct.State* noalias dereferenceable(3376), i64, %struct.Memory* noalias readnone returned) local_unnamed_addr
...
entry:
  ...
  %call2_40bc97 = tail call %struct.Memory* @sub_400e10._Z11start_timerv(%struct.State* %0, i64 %90, %struct.Memory* %2)
...
block_.L_40bca3:                                  ; preds = %block_.L_40bd0c, %entry
  %119 = phi i64 [ %.pre, %entry ], [ %333, %block_.L_40bd0c ]
  %MEMORY.0 = phi %struct.Memory* [ %call2_40bc97, %entry ], [ %call2_40bd25, %block_.L_40bd0c ]
  ...
  br i1 %152, label %block_40bcb3, label %block_.L_40bd38
...
block_.L_40bcc2:                                  ; preds = %block_40bcce, %block_40bcb3
  %163 = phi i64 [ %.pre1, %block_40bcb3 ], [ %275, %block_40bcce ]
  %MEMORY.1 = phi %struct.Memory* [ %MEMORY.0, %block_40bcb3 ], [ %call2_40bcef, %block_40bcce ]
  ...
  br i1 %199, label %block_40bcce, label %block_.L_40bd0c
...
block_40bcce:                                     ; preds = %block_.L_40bcc2
  ...
  %call2_40bcef = tail call %struct.Memory* @sub_40c140._ZN31custom_divide_multiple_variableIdE8do_shiftEddddd(%struct.State* %0, i64 %230, %struct.Memory* %MEMORY.1)
...
block_.L_40bd0c:                                  ; preds = %block_.L_40bcc2
  ...
  %call2_40bd25 = tail call %struct.Memory* @sub_40c180._Z26check_shifted_variable_sumId31custom_divide_multiple_variableIdEEvT_S2_S2_S2_S2_(%struct.State* %0, i64 %297, %struct.Memory* %MEMORY.1)
...
block_.L_40bd38:                                  ; preds = %block_.L_40bca3
  ...
  %call2_40bd38 = tail call %struct.Memory* @sub_400e30._Z5timerv(%struct.State* %0, i64 %334, %struct.Memory* %MEMORY.0)
  ...
  %call2_40bd41 = tail call %struct.Memory* @sub_4007d0._Z13record_resultdPKc(%struct.State* %0, i64 %345, %struct.Memory* %call2_40bd38)
  ...
  ret %struct.Memory* %call2_40bd41
}
...
define %struct.Memory* @routine_jge_.L_40bd38(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i8* %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
...
define %struct.Memory* @routine_jge_.L_40bd0c(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i8* %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 2, i32 9
...
define %struct.Memory* @routine_jmpq_.L_40bcc2(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
...
define %struct.Memory* @routine_callq_._Z26check_shifted_variable_sumId31custom_divide_multiple_variableIdEEvT_S2_S2_S2_S2_(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
...
define %struct.Memory* @routine_jmpq_.L_40bca3(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
