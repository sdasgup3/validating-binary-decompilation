...
define %struct.Memory* @_Z14test_variable4Id32custom_divide_multiple_variable2IdEEvPT_iS2_S2_S2_S2_PKc(%struct.State* noalias, i64, %struct.Memory* noalias) #1 {
entry:
  ...
  store %struct.Memory* %loadMem_40bd9e, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem1_40bda7, %struct.Memory** %MEMORY
...
block_40bdc3:                                     ; preds = %block_.L_40bdb3
  ...
  store i32 0, i32* %342
  store %struct.Memory* %loadMem_40bdcb, %struct.Memory** %MEMORY
...
block_40bdde:                                     ; preds = %block_.L_40bdd2
  ...
  store %struct.Memory* %loadMem_40bdfa, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem1_40bdff, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_40be17, %struct.Memory** %MEMORY
  br label %block_.L_40bdd2
