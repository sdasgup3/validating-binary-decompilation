...
block_.L_40bd83:                                  ; preds = %block_.L_40bdec, %entry
  %119 = phi i64 [ %.pre, %entry ], [ %344, %block_.L_40bdec ]
...
block_.L_40bda2:                                  ; preds = %block_40bdae, %block_40bd93
  %164 = phi i64 [ %.pre1, %block_40bd93 ], [ %281, %block_40bdae ]
  ...
  br i1 %200, label %block_40bdae, label %block_.L_40bdec
...
block_40bdae:                                     ; preds = %block_.L_40bda2
  ...
  %call2_40bdcf = tail call %struct.Memory* @sub_40c070._ZN32custom_divide_multiple_variable2IdE8do_shiftEddddd(%struct.State* %0, i64 %235, %struct.Memory* %MEMORY.1)
...
block_.L_40bdec:                                  ; preds = %block_.L_40bda2
  ...
  %call2_40be05 = tail call %struct.Memory* @sub_40c0b0._Z26check_shifted_variable_sumId32custom_divide_multiple_variable2IdEEvT_S2_S2_S2_S2_(%struct.State* %0, i64 %307, %struct.Memory* %MEMORY.1)
...
block_.L_40be18:                                  ; preds = %block_.L_40bd83
  ...
  %call2_40be18 = tail call %struct.Memory* @sub_400e30._Z5timerv(%struct.State* %0, i64 %345, %struct.Memory* %MEMORY.0)
  ...
  %call2_40be21 = tail call %struct.Memory* @sub_4007d0._Z13record_resultdPKc(%struct.State* %0, i64 %356, %struct.Memory* %call2_40be18)
