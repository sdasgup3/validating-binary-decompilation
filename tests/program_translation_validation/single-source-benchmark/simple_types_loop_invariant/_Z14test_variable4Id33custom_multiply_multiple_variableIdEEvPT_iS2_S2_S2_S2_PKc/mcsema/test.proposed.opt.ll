...
block_.L_40ba33:                                  ; preds = %block_.L_40ba9c, %entry
  %119 = phi i64 [ %.pre, %entry ], [ %344, %block_.L_40ba9c ]
...
block_.L_40ba52:                                  ; preds = %block_40ba5e, %block_40ba43
  %164 = phi i64 [ %.pre1, %block_40ba43 ], [ %281, %block_40ba5e ]
  ...
  br i1 %200, label %block_40ba5e, label %block_.L_40ba9c
...
block_40ba5e:                                     ; preds = %block_.L_40ba52
  ...
  %call2_40ba7f = tail call %struct.Memory* @sub_40c370._ZN33custom_multiply_multiple_variableIdE8do_shiftEddddd(%struct.State* %0, i64 %235, %struct.Memory* %MEMORY.1)
...
block_.L_40ba9c:                                  ; preds = %block_.L_40ba52
  ...
  %call2_40bab5 = tail call %struct.Memory* @sub_40c3b0._Z26check_shifted_variable_sumId33custom_multiply_multiple_variableIdEEvT_S2_S2_S2_S2_(%struct.State* %0, i64 %307, %struct.Memory* %MEMORY.1)
...
block_.L_40bac8:                                  ; preds = %block_.L_40ba33
  ...
  %call2_40bac8 = tail call %struct.Memory* @sub_400e30._Z5timerv(%struct.State* %0, i64 %345, %struct.Memory* %MEMORY.0)
  ...
  %call2_40bad1 = tail call %struct.Memory* @sub_4007d0._Z13record_resultdPKc(%struct.State* %0, i64 %356, %struct.Memory* %call2_40bac8)
