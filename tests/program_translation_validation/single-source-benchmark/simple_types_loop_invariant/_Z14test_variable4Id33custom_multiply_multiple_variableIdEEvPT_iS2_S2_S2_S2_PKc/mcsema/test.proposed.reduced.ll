; ModuleID = '/tmp/tmppjg9sxy3-query.ll'
...
define %struct.Memory* @_Z14test_variable4Id33custom_multiply_multiple_variableIdEEvPT_iS2_S2_S2_S2_PKc(%struct.State* noalias, i64, %struct.Memory* noalias readnone returned) local_unnamed_addr #1 {
entry:
...
; %var_2_51 = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 1
  ...
  %var_2_87 = add i64 %var_2_86, -44039
  %call2_40ba67 = tail call %struct.Memory* @sub_400e60._Z11start_timerv(%struct.State* %0, i64 %var_2_87, %struct.Memory* %2)
...
; store i32 0, i32* %var_2_96, align 4
  ...
  br i1 %var_2_14315, label %block_40ba83.preheader, label %block_.L_40bb08

block_40ba83.preheader:                           ; preds = %entry
  br label %block_40ba83

block_40ba83:                                     ; preds = %block_40ba83.preheader, %block_.L_40badc.split
; Matched:  %var_2_371 = phi i64 [ %var_2_221, %block_40ba83.block_40badc.split_crit_edge ], [ %var_2_1861, %block_40ba83.preheader ]
; %var_2_149 = phi i64 [ %var_2_155, %block_.L_40badc.split ], [ %var_2_1111, %block_40ba83.preheader ]
...
; store i32 0, i32* %var_2_153, align 4
  ...
  br i1 %var_2_190, label %block_.L_40ba92.preheader, label %block_.L_40badc.split

block_.L_40ba92.preheader:                        ; preds = %block_40ba83
  br label %block_.L_40ba92

block_.L_40ba92:                                  ; preds = %block_.L_40ba92.preheader, %block_.L_40ba92
  br label %block_.L_40ba92

block_.L_40badc.split:                            ; preds = %block_40ba83
  ...
  br i1 %var_2_143, label %block_40ba83, label %block_.L_40ba73.block_.L_40bb08_crit_edge

block_.L_40ba73.block_.L_40bb08_crit_edge:        ; preds = %block_.L_40badc.split
  %var_2_322 = load i64, i64* %var_2_3, align 8
  %var_2_323.le = add i64 %var_2_322, -144
  br label %block_.L_40bb08

block_.L_40bb08:                                  ; preds = %block_.L_40ba73.block_.L_40bb08_crit_edge, %entry
  %var_2_110.lcssa = phi i64 [ %var_2_323.le, %block_.L_40ba73.block_.L_40bb08_crit_edge ], [ %.pre, %entry ]
  %var_2_324 = add i64 %var_2_110.lcssa, -44019
  %call2_40bb08 = tail call %struct.Memory* @sub_400e80._Z5timerv(%struct.State* nonnull %0, i64 %var_2_324, %struct.Memory* %call2_40ba67)
  %var_2_331 = load i64, i64* %var_2_3, align 8
  %var_2_335 = add i64 %var_2_331, -45805
  %call2_40bb11 = tail call %struct.Memory* @sub_400820._Z13record_resultdPKc(%struct.State* nonnull %0, i64 %var_2_335, %struct.Memory* %call2_40bb08)
