...
declare %struct.Memory* @sub_40c320._Z26check_shifted_variable_sumId34custom_multiply_multiple_variable2IdEEvT_S2_S2_S2_S2_(%struct.State* noalias dereferenceable(3376), i64, %struct.Memory* noalias readnone returned) local_unnamed_addr
...
define %struct.Memory* @_Z14test_variable4Id34custom_multiply_multiple_variable2IdEEvPT_iS2_S2_S2_S2_PKc(%struct.State* noalias, i64, %struct.Memory* noalias readnone) local_unnamed_addr #1 {
entry:
  ...
  %call2_40bb47 = tail call %struct.Memory* @sub_400e60._Z11start_timerv(%struct.State* %0, i64 %87, %struct.Memory* %2)
...
block_.L_40bb53:                                  ; preds = %block_.L_40bbbc, %entry
  %110 = phi i64 [ %323, %block_.L_40bbbc ], [ %.pre, %entry ]
  ...
  br i1 %143, label %block_40bb63, label %block_.L_40bbe8
...
block_.L_40bb72:                                  ; preds = %block_40bb7e, %block_40bb63
  %154 = phi i64 [ %266, %block_40bb7e ], [ %.pre6, %block_40bb63 ]
  ...
  br i1 %190, label %block_40bb7e, label %block_.L_40bbbc
...
block_40bb7e:                                     ; preds = %block_.L_40bb72
  ...
  %call2_40bb9f = tail call %struct.Memory* @sub_40c2e0._ZN34custom_multiply_multiple_variable2IdE8do_shiftEddddd(%struct.State* nonnull %0, i64 %220, %struct.Memory* %call2_40bb47)
...
block_.L_40bbbc:                                  ; preds = %block_.L_40bb72
  ...
  %call2_40bbd5 = tail call %struct.Memory* @sub_40c320._Z26check_shifted_variable_sumId34custom_multiply_multiple_variable2IdEEvT_S2_S2_S2_S2_(%struct.State* nonnull %0, i64 %287, %struct.Memory* %call2_40bb47)
...
block_.L_40bbe8:                                  ; preds = %block_.L_40bb53
  ...
  %call2_40bbe8 = tail call %struct.Memory* @sub_400e80._Z5timerv(%struct.State* nonnull %0, i64 %324, %struct.Memory* %call2_40bb47)
  ...
  %call2_40bbf1 = tail call %struct.Memory* @sub_400820._Z13record_resultdPKc(%struct.State* nonnull %0, i64 %335, %struct.Memory* %call2_40bbe8)
