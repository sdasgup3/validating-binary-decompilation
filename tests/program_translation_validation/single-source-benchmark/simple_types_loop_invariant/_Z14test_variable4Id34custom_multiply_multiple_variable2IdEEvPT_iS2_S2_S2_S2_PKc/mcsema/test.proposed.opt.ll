...
block_.L_40bb13:                                  ; preds = %block_.L_40bb7c, %entry
  %119 = phi i64 [ %.pre, %entry ], [ %344, %block_.L_40bb7c ]
...
block_.L_40bb32:                                  ; preds = %block_40bb3e, %block_40bb23
  %164 = phi i64 [ %.pre1, %block_40bb23 ], [ %281, %block_40bb3e ]
  ...
  br i1 %200, label %block_40bb3e, label %block_.L_40bb7c
...
block_40bb3e:                                     ; preds = %block_.L_40bb32
  ...
  %call2_40bb5f = tail call %struct.Memory* @sub_40c2a0._ZN34custom_multiply_multiple_variable2IdE8do_shiftEddddd(%struct.State* %0, i64 %235, %struct.Memory* %MEMORY.1)
...
block_.L_40bb7c:                                  ; preds = %block_.L_40bb32
  ...
  %call2_40bb95 = tail call %struct.Memory* @sub_40c2e0._Z26check_shifted_variable_sumId34custom_multiply_multiple_variable2IdEEvT_S2_S2_S2_S2_(%struct.State* %0, i64 %307, %struct.Memory* %MEMORY.1)
...
block_.L_40bba8:                                  ; preds = %block_.L_40bb13
  ...
  %call2_40bba8 = tail call %struct.Memory* @sub_400e30._Z5timerv(%struct.State* %0, i64 %345, %struct.Memory* %MEMORY.0)
  ...
  %call2_40bbb1 = tail call %struct.Memory* @sub_4007d0._Z13record_resultdPKc(%struct.State* %0, i64 %356, %struct.Memory* %call2_40bba8)
