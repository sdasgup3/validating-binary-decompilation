...
declare %struct.Memory* @sub_40c310._Z26check_shifted_variable_sumId34custom_multiply_multiple_variable2IdEEvT_S2_S2_S2_S2_(%struct.State* noalias dereferenceable(3376), i64, %struct.Memory* noalias readnone returned) local_unnamed_addr
...
block_.L_40bb43:                                  ; preds = %block_.L_40bbac, %entry
  %110 = phi i64 [ %323, %block_.L_40bbac ], [ %.pre, %entry ]
...
block_.L_40bb62:                                  ; preds = %block_40bb6e, %block_40bb53
  %154 = phi i64 [ %266, %block_40bb6e ], [ %.pre6, %block_40bb53 ]
...
block_40bb6e:                                     ; preds = %block_.L_40bb62
  ...
  %call2_40bb8f = tail call %struct.Memory* @sub_40c2d0._ZN34custom_multiply_multiple_variable2IdE8do_shiftEddddd(%struct.State* nonnull %0, i64 %220, %struct.Memory* %call2_40bb37)
...
block_.L_40bbac:                                  ; preds = %block_.L_40bb62
  ...
  %call2_40bbc5 = tail call %struct.Memory* @sub_40c310._Z26check_shifted_variable_sumId34custom_multiply_multiple_variable2IdEEvT_S2_S2_S2_S2_(%struct.State* nonnull %0, i64 %287, %struct.Memory* %call2_40bb37)
...
block_.L_40bbd8:                                  ; preds = %block_.L_40bb43
  ...
  %call2_40bbd8 = tail call %struct.Memory* @sub_400e70._Z5timerv(%struct.State* nonnull %0, i64 %324, %struct.Memory* %call2_40bb37)
