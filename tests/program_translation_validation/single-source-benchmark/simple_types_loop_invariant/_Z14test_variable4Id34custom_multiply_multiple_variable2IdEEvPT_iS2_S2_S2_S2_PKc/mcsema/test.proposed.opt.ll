...
declare %struct.Memory* @sub_40c310._Z26check_shifted_variable_sumId34custom_multiply_multiple_variable2IdEEvT_S2_S2_S2_S2_(%struct.State* dereferenceable(3376), i64, %struct.Memory*) local_unnamed_addr
...
define %struct.Memory* @_Z14test_variable4Id34custom_multiply_multiple_variable2IdEEvPT_iS2_S2_S2_S2_PKc(%struct.State* noalias, i64, %struct.Memory* noalias) local_unnamed_addr #1 {
entry:
  ...
  %call2_40bb37 = tail call %struct.Memory* @sub_400e50._Z11start_timerv(%struct.State* %0, i64 %87, %struct.Memory* %2)
...
block_.L_40bb43:                                  ; preds = %block_.L_40bbac, %entry
  %110 = phi i64 [ %.pre, %entry ], [ %323, %block_.L_40bbac ]
  %MEMORY.0 = phi %struct.Memory* [ %call2_40bb37, %entry ], [ %call2_40bbc5, %block_.L_40bbac ]
  ...
  br i1 %143, label %block_40bb53, label %block_.L_40bbd8
...
block_.L_40bb62:                                  ; preds = %block_40bb6e, %block_40bb53
  %154 = phi i64 [ %.pre6, %block_40bb53 ], [ %266, %block_40bb6e ]
  %MEMORY.1 = phi %struct.Memory* [ %MEMORY.0, %block_40bb53 ], [ %call2_40bb8f, %block_40bb6e ]
  ...
  br i1 %190, label %block_40bb6e, label %block_.L_40bbac
...
block_40bb6e:                                     ; preds = %block_.L_40bb62
  ...
  %call2_40bb8f = tail call %struct.Memory* @sub_40c2d0._ZN34custom_multiply_multiple_variable2IdE8do_shiftEddddd(%struct.State* nonnull %0, i64 %220, %struct.Memory* %MEMORY.1)
...
block_.L_40bbac:                                  ; preds = %block_.L_40bb62
  ...
  %call2_40bbc5 = tail call %struct.Memory* @sub_40c310._Z26check_shifted_variable_sumId34custom_multiply_multiple_variable2IdEEvT_S2_S2_S2_S2_(%struct.State* nonnull %0, i64 %287, %struct.Memory* %MEMORY.1)
...
block_.L_40bbd8:                                  ; preds = %block_.L_40bb43
  ...
  %call2_40bbd8 = tail call %struct.Memory* @sub_400e70._Z5timerv(%struct.State* nonnull %0, i64 %324, %struct.Memory* %MEMORY.0)
  ...
  %call2_40bbe1 = tail call %struct.Memory* @sub_400810._Z13record_resultdPKc(%struct.State* nonnull %0, i64 %335, %struct.Memory* %call2_40bbd8)
  ...
  ret %struct.Memory* %call2_40bbe1
}
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_jge_.L_40bbac(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i8* nocapture %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 2, i32 9
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_jmpq_.L_40bb62(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_jmpq_.L_40bb43(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
