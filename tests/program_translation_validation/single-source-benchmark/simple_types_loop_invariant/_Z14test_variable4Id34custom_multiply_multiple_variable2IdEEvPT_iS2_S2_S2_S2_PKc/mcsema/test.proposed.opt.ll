...
declare %struct.Memory* @sub_40c2e0._Z26check_shifted_variable_sumId34custom_multiply_multiple_variable2IdEEvT_S2_S2_S2_S2_(%struct.State* noalias dereferenceable(3376), i64, %struct.Memory* noalias readnone returned) local_unnamed_addr
...
entry:
  ...
  %call2_40bb07 = tail call %struct.Memory* @sub_400e10._Z11start_timerv(%struct.State* %0, i64 %90, %struct.Memory* %2)
...
block_.L_40bb13:                                  ; preds = %block_.L_40bb7c, %entry
  %119 = phi i64 [ %.pre, %entry ], [ %333, %block_.L_40bb7c ]
  %MEMORY.0 = phi %struct.Memory* [ %call2_40bb07, %entry ], [ %call2_40bb95, %block_.L_40bb7c ]
  ...
  br i1 %152, label %block_40bb23, label %block_.L_40bba8
...
block_.L_40bb32:                                  ; preds = %block_40bb3e, %block_40bb23
  %163 = phi i64 [ %.pre1, %block_40bb23 ], [ %275, %block_40bb3e ]
  %MEMORY.1 = phi %struct.Memory* [ %MEMORY.0, %block_40bb23 ], [ %call2_40bb5f, %block_40bb3e ]
  ...
  br i1 %199, label %block_40bb3e, label %block_.L_40bb7c
...
block_40bb3e:                                     ; preds = %block_.L_40bb32
  ...
  %call2_40bb5f = tail call %struct.Memory* @sub_40c2a0._ZN34custom_multiply_multiple_variable2IdE8do_shiftEddddd(%struct.State* %0, i64 %230, %struct.Memory* %MEMORY.1)
...
block_.L_40bb7c:                                  ; preds = %block_.L_40bb32
  ...
  %call2_40bb95 = tail call %struct.Memory* @sub_40c2e0._Z26check_shifted_variable_sumId34custom_multiply_multiple_variable2IdEEvT_S2_S2_S2_S2_(%struct.State* %0, i64 %297, %struct.Memory* %MEMORY.1)
...
block_.L_40bba8:                                  ; preds = %block_.L_40bb13
  ...
  %call2_40bba8 = tail call %struct.Memory* @sub_400e30._Z5timerv(%struct.State* %0, i64 %334, %struct.Memory* %MEMORY.0)
  ...
  %call2_40bbb1 = tail call %struct.Memory* @sub_4007d0._Z13record_resultdPKc(%struct.State* %0, i64 %345, %struct.Memory* %call2_40bba8)
  ...
  ret %struct.Memory* %call2_40bbb1
}
...
define %struct.Memory* @routine_jge_.L_40bb7c(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i8* %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 2, i32 9
...
define %struct.Memory* @routine_jmpq_.L_40bb32(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
...
define %struct.Memory* @routine_callq_._Z26check_shifted_variable_sumId34custom_multiply_multiple_variable2IdEEvT_S2_S2_S2_S2_(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
...
define %struct.Memory* @routine_jmpq_.L_40bb13(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
