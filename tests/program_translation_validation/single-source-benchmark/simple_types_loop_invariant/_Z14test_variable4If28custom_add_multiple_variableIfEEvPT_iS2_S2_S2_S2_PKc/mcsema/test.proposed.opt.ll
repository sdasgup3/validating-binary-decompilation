...
declare %struct.Memory* @sub_40cf10._ZN28custom_add_multiple_variableIfE8do_shiftEfffff(%struct.State* dereferenceable(3376), i64, %struct.Memory*) local_unnamed_addr

declare %struct.Memory* @sub_40cf50._Z26check_shifted_variable_sumIf28custom_add_multiple_variableIfEEvT_S2_S2_S2_S2_(%struct.State* dereferenceable(3376), i64, %struct.Memory*) local_unnamed_addr
...
block_.L_40ad63:                                  ; preds = %block_.L_40adcc, %entry
  %150 = phi i64 [ %.pre, %entry ], [ %371, %block_.L_40adcc ]
  %MEMORY.0 = phi %struct.Memory* [ %call2_40ad57, %entry ], [ %call2_40ade5, %block_.L_40adcc ]
...
block_.L_40ad82:                                  ; preds = %block_40ad8e, %block_40ad73
  %195 = phi i64 [ %.pre6, %block_40ad73 ], [ %314, %block_40ad8e ]
  %MEMORY.1 = phi %struct.Memory* [ %MEMORY.0, %block_40ad73 ], [ %call2_40adaf, %block_40ad8e ]
...
block_40ad8e:                                     ; preds = %block_.L_40ad82
  ...
  %call2_40adaf = tail call %struct.Memory* @sub_40cf10._ZN28custom_add_multiple_variableIfE8do_shiftEfffff(%struct.State* nonnull %0, i64 %261, %struct.Memory* %MEMORY.1)
...
block_.L_40adcc:                                  ; preds = %block_.L_40ad82
  ...
  %call2_40ade5 = tail call %struct.Memory* @sub_40cf50._Z26check_shifted_variable_sumIf28custom_add_multiple_variableIfEEvT_S2_S2_S2_S2_(%struct.State* nonnull %0, i64 %335, %struct.Memory* %MEMORY.1)
...
block_.L_40adf8:                                  ; preds = %block_.L_40ad63
  ...
  %call2_40adf8 = tail call %struct.Memory* @sub_400e70._Z5timerv(%struct.State* nonnull %0, i64 %372, %struct.Memory* %MEMORY.0)
