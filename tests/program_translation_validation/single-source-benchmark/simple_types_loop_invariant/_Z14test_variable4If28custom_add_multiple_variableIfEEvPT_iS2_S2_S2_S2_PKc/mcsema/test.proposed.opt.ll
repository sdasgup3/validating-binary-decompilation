...
block_.L_40ad33:                                  ; preds = %block_.L_40ad9c, %entry
  %146 = phi i64 [ %.pre, %entry ], [ %379, %block_.L_40ad9c ]
  ...
  br i1 %179, label %block_40ad43, label %block_.L_40adc8
...
block_.L_40ad52:                                  ; preds = %block_40ad5e, %block_40ad43
  %191 = phi i64 [ %.pre1, %block_40ad43 ], [ %316, %block_40ad5e ]
  ...
  br i1 %227, label %block_40ad5e, label %block_.L_40ad9c
...
block_40ad5e:                                     ; preds = %block_.L_40ad52
  ...
  %call2_40ad7f = tail call %struct.Memory* @sub_40cee0._ZN28custom_add_multiple_variableIfE8do_shiftEfffff(%struct.State* %0, i64 %262, %struct.Memory* %MEMORY.1)
...
block_.L_40ad9c:                                  ; preds = %block_.L_40ad52
  ...
  %call2_40adb5 = tail call %struct.Memory* @sub_40cf20._Z26check_shifted_variable_sumIf28custom_add_multiple_variableIfEEvT_S2_S2_S2_S2_(%struct.State* %0, i64 %342, %struct.Memory* %MEMORY.1)
...
block_.L_40adc8:                                  ; preds = %block_.L_40ad33
  ...
  %call2_40adc8 = tail call %struct.Memory* @sub_400e30._Z5timerv(%struct.State* %0, i64 %380, %struct.Memory* %MEMORY.0)
  ...
  %call2_40add1 = tail call %struct.Memory* @sub_4007d0._Z13record_resultdPKc(%struct.State* %0, i64 %391, %struct.Memory* %call2_40adc8)
