; ModuleID = '/tmp/tmp5dnloyi1-query.ll'
...
%var_2_93 = add i64 %var_2_92, -40711
...
%call2_40ad67 = tail call %struct.Memory* @sub_400e60._Z11start_timerv(%struct.State* %0, i64 %var_2_93, %struct.Memory* %2)
...
%var_2_150 = phi i64 [ %var_2_371, %block_.L_40addc ], [ %.pre, %entry ]
...
br i1 %var_2_183, label %block_40ad83, label %block_.L_40ae08
...
; Matched:%var_2_267:  %var_2_267 = phi i64 [ %.pre6, %block_40ad83 ], [ %var_2_231, %block_40ad9e ]
; %var_2_195 = phi i64 [ %var_2_314, %block_40ad9e ], [ %.pre6, %block_40ad83 ]
...
br i1 %var_2_231, label %block_40ad9e, label %block_.L_40addc
...
; Matched:%var_2_177:  %var_2_177 = add i64 %var_2_304, 8578
; %var_2_261 = add i64 %var_2_232, 8578
...
; Matched:%var_2_182:  %var_2_182 = tail call %struct.Memory* @sub_40cf20__ZN28custom_add_multiple_variableIfE8do_shiftEfffff_renamed_(%struct.State* nonnull %0, i64 %var_2_177, %struct.Memory* %var_2_97)
; %call2_40adbf = tail call %struct.Memory* @sub_40cf20._ZN28custom_add_multiple_variableIfE8do_shiftEfffff(%struct.State* nonnull %0, i64 %var_2_261, %struct.Memory* %call2_40ad67)
...
; Matched:\<badref\>:  store float 0.000000e+00, float* %var_2_146, align 1, !tbaa !1284
; store float 0.000000e+00, float* %var_2_147, align 1
; Matched:%var_2_325:  %var_2_325 = add i64 %var_2_304, 8580
; %var_2_335 = add i64 %var_2_232, 8580
...
; Matched:%var_2_330:  %var_2_330 = tail call %struct.Memory* @sub_40cf60__Z26check_shifted_variable_sumIf28custom_add_multiple_variableIfEEvT_S2_S2_S2_S2__renamed_(%struct.State* nonnull %0, i64 %var_2_325, %struct.Memory* %var_2_97)
; %call2_40adf5 = tail call %struct.Memory* @sub_40cf60._Z26check_shifted_variable_sumIf28custom_add_multiple_variableIfEEvT_S2_S2_S2_S2_(%struct.State* nonnull %0, i64 %var_2_335, %struct.Memory* %call2_40ad67)
...
%var_2_372 = add i64 %var_2_184, -40840
...
%call2_40ae08 = tail call %struct.Memory* @sub_400e80._Z5timerv(%struct.State* nonnull %0, i64 %var_2_372, %struct.Memory* %call2_40ad67)
...
%var_2_383 = add i64 %var_2_379, -42477
...
%call2_40ae11 = tail call %struct.Memory* @sub_400820._Z13record_resultdPKc(%struct.State* nonnull %0, i64 %var_2_383, %struct.Memory* %call2_40ae08)
