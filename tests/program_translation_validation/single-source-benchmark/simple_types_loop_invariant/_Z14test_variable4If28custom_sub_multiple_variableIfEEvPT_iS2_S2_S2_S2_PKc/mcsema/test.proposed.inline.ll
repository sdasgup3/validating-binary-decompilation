...
entry:
  ...
  store %struct.Memory* %loadMem_40ae94, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_40aea4, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem1_40aeb7, %struct.Memory** %MEMORY
  ...
  store i32 0, i32* %205
  store %struct.Memory* %loadMem_40aebc, %struct.Memory** %MEMORY
...
block_40aeee:                                     ; preds = %block_.L_40aee2
  ...
  store %struct.Memory* %loadMem_40aefb, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_40af05, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem1_40af0f, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_40af27, %struct.Memory** %MEMORY
  br label %block_.L_40aee2
