...
block_.L_40aec3:                                  ; preds = %block_.L_40af2c, %entry
  %145 = phi i64 [ %.pre, %entry ], [ %374, %block_.L_40af2c ]
  ...
  br i1 %178, label %block_40aed3, label %block_.L_40af58
...
block_.L_40aee2:                                  ; preds = %block_40aeee, %block_40aed3
  %190 = phi i64 [ %.pre1, %block_40aed3 ], [ %313, %block_40aeee ]
  ...
  br i1 %226, label %block_40aeee, label %block_.L_40af2c
...
block_40aeee:                                     ; preds = %block_.L_40aee2
  ...
  %call2_40af0f = tail call %struct.Memory* @sub_40cd80._ZN28custom_sub_multiple_variableIfE8do_shiftEfffff(%struct.State* %0, i64 %260, %struct.Memory* %MEMORY.1)
...
block_.L_40af2c:                                  ; preds = %block_.L_40aee2
  ...
  %call2_40af45 = tail call %struct.Memory* @sub_40cdc0._Z26check_shifted_variable_sumIf28custom_sub_multiple_variableIfEEvT_S2_S2_S2_S2_(%struct.State* %0, i64 %338, %struct.Memory* %MEMORY.1)
...
block_.L_40af58:                                  ; preds = %block_.L_40aec3
  ...
  %call2_40af58 = tail call %struct.Memory* @sub_400e30._Z5timerv(%struct.State* %0, i64 %375, %struct.Memory* %MEMORY.0)
  ...
  %call2_40af61 = tail call %struct.Memory* @sub_4007d0._Z13record_resultdPKc(%struct.State* %0, i64 %386, %struct.Memory* %call2_40af58)
