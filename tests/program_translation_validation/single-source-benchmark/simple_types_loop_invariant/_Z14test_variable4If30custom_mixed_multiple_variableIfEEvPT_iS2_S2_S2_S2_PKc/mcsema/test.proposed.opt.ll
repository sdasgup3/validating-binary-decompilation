...
entry:
  ...
  %call2_40b4b7 = tail call %struct.Memory* @sub_400e60._Z11start_timerv(%struct.State* %0, i64 %93, %struct.Memory* %2)
...
block_.L_40b4c3:                                  ; preds = %block_.L_40b52c, %entry
  %150 = phi i64 [ %371, %block_.L_40b52c ], [ %.pre, %entry ]
  ...
  br i1 %183, label %block_40b4d3, label %block_.L_40b558
...
block_.L_40b4e2:                                  ; preds = %block_40b4ee, %block_40b4d3
  %195 = phi i64 [ %314, %block_40b4ee ], [ %.pre6, %block_40b4d3 ]
  ...
  br i1 %231, label %block_40b4ee, label %block_.L_40b52c
...
block_40b4ee:                                     ; preds = %block_.L_40b4e2
  ...
  %call2_40b50f = tail call %struct.Memory* @sub_40c7d0._ZN30custom_mixed_multiple_variableIfE8do_shiftEfffff(%struct.State* nonnull %0, i64 %261, %struct.Memory* %call2_40b4b7)
...
block_.L_40b52c:                                  ; preds = %block_.L_40b4e2
  ...
  %call2_40b545 = tail call %struct.Memory* @sub_40c810._Z26check_shifted_variable_sumIf30custom_mixed_multiple_variableIfEEvT_S2_S2_S2_S2_(%struct.State* nonnull %0, i64 %335, %struct.Memory* %call2_40b4b7)
...
block_.L_40b558:                                  ; preds = %block_.L_40b4c3
  ...
  %call2_40b558 = tail call %struct.Memory* @sub_400e80._Z5timerv(%struct.State* nonnull %0, i64 %372, %struct.Memory* %call2_40b4b7)
  ...
  %call2_40b561 = tail call %struct.Memory* @sub_400820._Z13record_resultdPKc(%struct.State* nonnull %0, i64 %383, %struct.Memory* %call2_40b558)
