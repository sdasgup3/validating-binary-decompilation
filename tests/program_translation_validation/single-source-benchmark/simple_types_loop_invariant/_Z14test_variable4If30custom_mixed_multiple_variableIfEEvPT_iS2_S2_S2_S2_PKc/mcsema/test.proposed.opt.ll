...
block_.L_40b483:                                  ; preds = %block_.L_40b4ec, %entry
  %146 = phi i64 [ %.pre, %entry ], [ %379, %block_.L_40b4ec ]
  ...
  br i1 %179, label %block_40b493, label %block_.L_40b518
...
block_.L_40b4a2:                                  ; preds = %block_40b4ae, %block_40b493
  %191 = phi i64 [ %.pre1, %block_40b493 ], [ %316, %block_40b4ae ]
  ...
  br i1 %227, label %block_40b4ae, label %block_.L_40b4ec
...
block_40b4ae:                                     ; preds = %block_.L_40b4a2
  ...
  %call2_40b4cf = tail call %struct.Memory* @sub_40c790._ZN30custom_mixed_multiple_variableIfE8do_shiftEfffff(%struct.State* %0, i64 %262, %struct.Memory* %MEMORY.1)
...
block_.L_40b4ec:                                  ; preds = %block_.L_40b4a2
  ...
  %call2_40b505 = tail call %struct.Memory* @sub_40c7d0._Z26check_shifted_variable_sumIf30custom_mixed_multiple_variableIfEEvT_S2_S2_S2_S2_(%struct.State* %0, i64 %342, %struct.Memory* %MEMORY.1)
...
block_.L_40b518:                                  ; preds = %block_.L_40b483
  ...
  %call2_40b518 = tail call %struct.Memory* @sub_400e30._Z5timerv(%struct.State* %0, i64 %380, %struct.Memory* %MEMORY.0)
  ...
  %call2_40b521 = tail call %struct.Memory* @sub_4007d0._Z13record_resultdPKc(%struct.State* %0, i64 %391, %struct.Memory* %call2_40b518)
