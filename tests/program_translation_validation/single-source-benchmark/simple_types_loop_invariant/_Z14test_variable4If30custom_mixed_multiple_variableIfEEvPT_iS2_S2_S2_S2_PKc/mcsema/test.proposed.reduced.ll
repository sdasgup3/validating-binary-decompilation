; ModuleID = '/tmp/tmpw_xgvwux-query.ll'
...
declare %struct.Memory* @sub_40c7d0._ZN30custom_mixed_multiple_variableIfE8do_shiftEfffff(%struct.State* noalias dereferenceable(3376), i64, %struct.Memory* noalias readnone returned) local_unnamed_addr

declare %struct.Memory* @sub_40c810._Z26check_shifted_variable_sumIf30custom_mixed_multiple_variableIfEEvT_S2_S2_S2_S2_(%struct.State* noalias dereferenceable(3376), i64, %struct.Memory* noalias readnone returned) local_unnamed_addr
...
define %struct.Memory* @_Z14test_variable4If30custom_mixed_multiple_variableIfEEvPT_iS2_S2_S2_S2_PKc(%struct.State* noalias, i64, %struct.Memory* noalias readnone) local_unnamed_addr #1 {
entry:
...
%var_2_93 = add i64 %var_2_92, -42583
...
%call2_40b4b7 = tail call %struct.Memory* @sub_400e60._Z11start_timerv(%struct.State* %0, i64 %var_2_93, %struct.Memory* %2)
...
%var_2_149 = bitcast [32 x %union.VectorReg]* %var_2_50 to <4 x i32>*
  br label %block_.L_40b4c3

block_.L_40b4c3:                                  ; preds = %block_.L_40b52c, %entry
%var_2_150 = phi i64 [ %var_2_371, %block_.L_40b52c ], [ %.pre, %entry ]
...
br i1 %var_2_183, label %block_40b4d3, label %block_.L_40b558

block_40b4d3:                                     ; preds = %block_.L_40b4c3
...
; %.pre6 = load i64, i64* %var_2_3, align 8
  br label %block_.L_40b4e2

block_.L_40b4e2:                                  ; preds = %block_40b4ee, %block_40b4d3
; Matched:%var_2_385:  %var_2_385 = phi i64 [ %var_2_241, %block_40b4ee ], [ %.pre6, %block_40b4d3 ]
; %var_2_195 = phi i64 [ %var_2_314, %block_40b4ee ], [ %.pre6, %block_40b4d3 ]
...
br i1 %var_2_231, label %block_40b4ee, label %block_.L_40b52c

block_40b4ee:                                     ; preds = %block_.L_40b4e2
...
; Matched:%var_2_187:  %var_2_187 = add i64 %var_2_422, 4834
; %var_2_261 = add i64 %var_2_232, 4834
...
; Matched:%var_2_192:  %var_2_192 = tail call %struct.Memory* @sub_40c7d0__ZN30custom_mixed_multiple_variableIfE8do_shiftEfffff_renamed_(%struct.State* nonnull %0, i64 %var_2_187, %struct.Memory* %var_2_97)
; %call2_40b50f = tail call %struct.Memory* @sub_40c7d0._ZN30custom_mixed_multiple_variableIfE8do_shiftEfffff(%struct.State* nonnull %0, i64 %var_2_261, %struct.Memory* %call2_40b4b7)
...
block_.L_40b52c:                                  ; preds = %block_.L_40b4e2
...
; Matched:\<badref\>:  store float 0.000000e+00, float* %var_2_146, align 1, !tbaa !1285
; store float 0.000000e+00, float* %var_2_147, align 1
; Matched:%var_2_312:  %var_2_312 = add i64 %var_2_422, 4836
; %var_2_335 = add i64 %var_2_232, 4836
...
; Matched:%var_2_317:  %var_2_317 = tail call %struct.Memory* @sub_40c810__Z26check_shifted_variable_sumIf30custom_mixed_multiple_variableIfEEvT_S2_S2_S2_S2__renamed_(%struct.State* nonnull %0, i64 %var_2_312, %struct.Memory* %var_2_97)
; %call2_40b545 = tail call %struct.Memory* @sub_40c810._Z26check_shifted_variable_sumIf30custom_mixed_multiple_variableIfEEvT_S2_S2_S2_S2_(%struct.State* nonnull %0, i64 %var_2_335, %struct.Memory* %call2_40b4b7)
...
block_.L_40b558:                                  ; preds = %block_.L_40b4c3
%var_2_372 = add i64 %var_2_184, -42712
...
%call2_40b558 = tail call %struct.Memory* @sub_400e80._Z5timerv(%struct.State* nonnull %0, i64 %var_2_372, %struct.Memory* %call2_40b4b7)
...
%var_2_383 = add i64 %var_2_379, -44349
...
%call2_40b561 = tail call %struct.Memory* @sub_400820._Z13record_resultdPKc(%struct.State* nonnull %0, i64 %var_2_383, %struct.Memory* %call2_40b558)
...
; store i64 %var_2_419, i64* %var_2_6, align 8
  ret %struct.Memory* %call2_40b561
}
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_jge_.L_40b558(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i8* nocapture %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_jge_.L_40b52c(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i8* nocapture %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 2, i32 9
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_callq_._ZN30custom_mixed_multiple_variableIfE8do_shiftEfffff(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_jmpq_.L_40b4e2(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_callq_._Z26check_shifted_variable_sumIf30custom_mixed_multiple_variableIfEEvT_S2_S2_S2_S2_(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_jmpq_.L_40b4c3(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
