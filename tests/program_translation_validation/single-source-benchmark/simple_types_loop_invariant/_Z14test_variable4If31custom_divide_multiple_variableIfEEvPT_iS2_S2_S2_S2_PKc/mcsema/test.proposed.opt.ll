...
block_.L_40b2c3:                                  ; preds = %block_.L_40b32c, %entry
  %145 = phi i64 [ %.pre, %entry ], [ %374, %block_.L_40b32c ]
  ...
  br i1 %178, label %block_40b2d3, label %block_.L_40b358
...
block_.L_40b2e2:                                  ; preds = %block_40b2ee, %block_40b2d3
  %190 = phi i64 [ %.pre1, %block_40b2d3 ], [ %313, %block_40b2ee ]
  ...
  br i1 %226, label %block_40b2ee, label %block_.L_40b32c
...
block_40b2ee:                                     ; preds = %block_.L_40b2e2
  ...
  %call2_40b30f = tail call %struct.Memory* @sub_40c9f0._ZN31custom_divide_multiple_variableIfE8do_shiftEfffff(%struct.State* %0, i64 %260, %struct.Memory* %MEMORY.1)
...
block_.L_40b32c:                                  ; preds = %block_.L_40b2e2
  ...
  %call2_40b345 = tail call %struct.Memory* @sub_40ca30._Z26check_shifted_variable_sumIf31custom_divide_multiple_variableIfEEvT_S2_S2_S2_S2_(%struct.State* %0, i64 %338, %struct.Memory* %MEMORY.1)
...
block_.L_40b358:                                  ; preds = %block_.L_40b2c3
  ...
  %call2_40b358 = tail call %struct.Memory* @sub_400e30._Z5timerv(%struct.State* %0, i64 %375, %struct.Memory* %MEMORY.0)
  ...
  %call2_40b361 = tail call %struct.Memory* @sub_4007d0._Z13record_resultdPKc(%struct.State* %0, i64 %386, %struct.Memory* %call2_40b358)
