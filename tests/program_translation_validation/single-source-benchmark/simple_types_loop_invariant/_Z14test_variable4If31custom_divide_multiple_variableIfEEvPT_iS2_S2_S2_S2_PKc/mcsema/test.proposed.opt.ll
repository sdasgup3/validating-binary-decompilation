...
entry:
  ...
  %call2_40b2f7 = tail call %struct.Memory* @sub_400e60._Z11start_timerv(%struct.State* %0, i64 %93, %struct.Memory* %2)
...
block_.L_40b303:                                  ; preds = %block_.L_40b36c, %entry
  %150 = phi i64 [ %371, %block_.L_40b36c ], [ %.pre, %entry ]
  ...
  br i1 %183, label %block_40b313, label %block_.L_40b398
...
block_.L_40b322:                                  ; preds = %block_40b32e, %block_40b313
  %195 = phi i64 [ %314, %block_40b32e ], [ %.pre6, %block_40b313 ]
  ...
  br i1 %231, label %block_40b32e, label %block_.L_40b36c
...
block_40b32e:                                     ; preds = %block_.L_40b322
  ...
  %call2_40b34f = tail call %struct.Memory* @sub_40ca30._ZN31custom_divide_multiple_variableIfE8do_shiftEfffff(%struct.State* nonnull %0, i64 %261, %struct.Memory* %call2_40b2f7)
...
block_.L_40b36c:                                  ; preds = %block_.L_40b322
  ...
  %call2_40b385 = tail call %struct.Memory* @sub_40ca70._Z26check_shifted_variable_sumIf31custom_divide_multiple_variableIfEEvT_S2_S2_S2_S2_(%struct.State* nonnull %0, i64 %335, %struct.Memory* %call2_40b2f7)
...
block_.L_40b398:                                  ; preds = %block_.L_40b303
  ...
  %call2_40b398 = tail call %struct.Memory* @sub_400e80._Z5timerv(%struct.State* nonnull %0, i64 %372, %struct.Memory* %call2_40b2f7)
  ...
  %call2_40b3a1 = tail call %struct.Memory* @sub_400820._Z13record_resultdPKc(%struct.State* nonnull %0, i64 %383, %struct.Memory* %call2_40b398)
