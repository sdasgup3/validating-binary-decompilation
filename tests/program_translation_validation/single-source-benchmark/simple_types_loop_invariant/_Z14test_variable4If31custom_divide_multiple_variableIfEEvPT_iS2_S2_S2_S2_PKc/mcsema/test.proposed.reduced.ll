; ModuleID = '/tmp/tmpqx2wapwk-query.ll'
...
declare %struct.Memory* @sub_40ca30._ZN31custom_divide_multiple_variableIfE8do_shiftEfffff(%struct.State* noalias dereferenceable(3376), i64, %struct.Memory* noalias readnone returned) local_unnamed_addr

declare %struct.Memory* @sub_40ca70._Z26check_shifted_variable_sumIf31custom_divide_multiple_variableIfEEvT_S2_S2_S2_S2_(%struct.State* noalias dereferenceable(3376), i64, %struct.Memory* noalias readnone returned) local_unnamed_addr
...
define %struct.Memory* @_Z14test_variable4If31custom_divide_multiple_variableIfEEvPT_iS2_S2_S2_S2_PKc(%struct.State* noalias, i64, %struct.Memory* noalias readnone) local_unnamed_addr #1 {
entry:
...
%var_2_93 = add i64 %var_2_92, -42135
...
%call2_40b2f7 = tail call %struct.Memory* @sub_400e60._Z11start_timerv(%struct.State* %0, i64 %var_2_93, %struct.Memory* %2)
...
%var_2_150 = phi i64 [ %var_2_371, %block_.L_40b36c ], [ %.pre, %entry ]
...
br i1 %var_2_183, label %block_40b313, label %block_.L_40b398
...
; Matched:%var_2_385:  %var_2_385 = phi i64 [ %var_2_241, %block_40b32e ], [ %.pre6, %block_40b313 ]
; %var_2_195 = phi i64 [ %var_2_314, %block_40b32e ], [ %.pre6, %block_40b313 ]
...
br i1 %var_2_231, label %block_40b32e, label %block_.L_40b36c
...
; Matched:%var_2_187:  %var_2_187 = add i64 %var_2_422, 5890
; %var_2_261 = add i64 %var_2_232, 5890
...
; Matched:%var_2_192:  %var_2_192 = tail call %struct.Memory* @sub_40ca30__ZN31custom_divide_multiple_variableIfE8do_shiftEfffff_renamed_(%struct.State* nonnull %0, i64 %var_2_187, %struct.Memory* %var_2_97)
; %call2_40b34f = tail call %struct.Memory* @sub_40ca30._ZN31custom_divide_multiple_variableIfE8do_shiftEfffff(%struct.State* nonnull %0, i64 %var_2_261, %struct.Memory* %call2_40b2f7)
...
; Matched:\<badref\>:  store float 0.000000e+00, float* %var_2_146, align 1, !tbaa !1285
; store float 0.000000e+00, float* %var_2_147, align 1
; Matched:%var_2_312:  %var_2_312 = add i64 %var_2_422, 5892
; %var_2_335 = add i64 %var_2_232, 5892
...
; Matched:%var_2_317:  %var_2_317 = tail call %struct.Memory* @sub_40ca70__Z26check_shifted_variable_sumIf31custom_divide_multiple_variableIfEEvT_S2_S2_S2_S2__renamed_(%struct.State* nonnull %0, i64 %var_2_312, %struct.Memory* %var_2_97)
; %call2_40b385 = tail call %struct.Memory* @sub_40ca70._Z26check_shifted_variable_sumIf31custom_divide_multiple_variableIfEEvT_S2_S2_S2_S2_(%struct.State* nonnull %0, i64 %var_2_335, %struct.Memory* %call2_40b2f7)
...
%var_2_372 = add i64 %var_2_184, -42264
...
%call2_40b398 = tail call %struct.Memory* @sub_400e80._Z5timerv(%struct.State* nonnull %0, i64 %var_2_372, %struct.Memory* %call2_40b2f7)
...
%var_2_383 = add i64 %var_2_379, -43901
...
%call2_40b3a1 = tail call %struct.Memory* @sub_400820._Z13record_resultdPKc(%struct.State* nonnull %0, i64 %var_2_383, %struct.Memory* %call2_40b398)
...
; store i64 %var_2_419, i64* %var_2_6, align 8
  ret %struct.Memory* %call2_40b3a1
}
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_jge_.L_40b36c(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i8* nocapture %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 2, i32 9
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_callq_._ZN31custom_divide_multiple_variableIfE8do_shiftEfffff(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_jmpq_.L_40b322(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_callq_._Z26check_shifted_variable_sumIf31custom_divide_multiple_variableIfEEvT_S2_S2_S2_S2_(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_jmpq_.L_40b303(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
