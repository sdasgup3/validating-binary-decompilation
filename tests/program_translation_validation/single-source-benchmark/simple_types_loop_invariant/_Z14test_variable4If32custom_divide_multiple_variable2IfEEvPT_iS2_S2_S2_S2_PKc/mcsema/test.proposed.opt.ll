...
declare %struct.Memory* @sub_40c950._ZN32custom_divide_multiple_variable2IfE8do_shiftEfffff(%struct.State* noalias dereferenceable(3376), i64, %struct.Memory* noalias readnone returned) local_unnamed_addr

declare %struct.Memory* @sub_40c990._Z26check_shifted_variable_sumIf32custom_divide_multiple_variable2IfEEvT_S2_S2_S2_S2_(%struct.State* noalias dereferenceable(3376), i64, %struct.Memory* noalias readnone returned) local_unnamed_addr
...
define %struct.Memory* @_Z14test_variable4If32custom_divide_multiple_variable2IfEEvPT_iS2_S2_S2_S2_PKc(%struct.State* noalias, i64, %struct.Memory* noalias readnone) local_unnamed_addr #1 {
entry:
...
block_.L_40b3d3:                                  ; preds = %block_.L_40b43c, %entry
  %150 = phi i64 [ %371, %block_.L_40b43c ], [ %.pre, %entry ]
...
block_.L_40b3f2:                                  ; preds = %block_40b3fe, %block_40b3e3
  %195 = phi i64 [ %314, %block_40b3fe ], [ %.pre6, %block_40b3e3 ]
...
block_40b3fe:                                     ; preds = %block_.L_40b3f2
  ...
  %call2_40b41f = tail call %struct.Memory* @sub_40c950._ZN32custom_divide_multiple_variable2IfE8do_shiftEfffff(%struct.State* nonnull %0, i64 %261, %struct.Memory* %call2_40b3c7)
...
block_.L_40b43c:                                  ; preds = %block_.L_40b3f2
  ...
  %call2_40b455 = tail call %struct.Memory* @sub_40c990._Z26check_shifted_variable_sumIf32custom_divide_multiple_variable2IfEEvT_S2_S2_S2_S2_(%struct.State* nonnull %0, i64 %335, %struct.Memory* %call2_40b3c7)
...
block_.L_40b468:                                  ; preds = %block_.L_40b3d3
  ...
  %call2_40b468 = tail call %struct.Memory* @sub_400e70._Z5timerv(%struct.State* nonnull %0, i64 %372, %struct.Memory* %call2_40b3c7)
