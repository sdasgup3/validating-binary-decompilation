...
block_.L_40b3a3:                                  ; preds = %block_.L_40b40c, %entry
  %146 = phi i64 [ %.pre, %entry ], [ %379, %block_.L_40b40c ]
  ...
  br i1 %179, label %block_40b3b3, label %block_.L_40b438
...
block_.L_40b3c2:                                  ; preds = %block_40b3ce, %block_40b3b3
  %191 = phi i64 [ %.pre1, %block_40b3b3 ], [ %316, %block_40b3ce ]
  ...
  br i1 %227, label %block_40b3ce, label %block_.L_40b40c
...
block_40b3ce:                                     ; preds = %block_.L_40b3c2
  ...
  %call2_40b3ef = tail call %struct.Memory* @sub_40c920._ZN32custom_divide_multiple_variable2IfE8do_shiftEfffff(%struct.State* %0, i64 %262, %struct.Memory* %MEMORY.1)
...
block_.L_40b40c:                                  ; preds = %block_.L_40b3c2
  ...
  %call2_40b425 = tail call %struct.Memory* @sub_40c960._Z26check_shifted_variable_sumIf32custom_divide_multiple_variable2IfEEvT_S2_S2_S2_S2_(%struct.State* %0, i64 %342, %struct.Memory* %MEMORY.1)
...
block_.L_40b438:                                  ; preds = %block_.L_40b3a3
  ...
  %call2_40b438 = tail call %struct.Memory* @sub_400e30._Z5timerv(%struct.State* %0, i64 %380, %struct.Memory* %MEMORY.0)
  ...
  %call2_40b441 = tail call %struct.Memory* @sub_4007d0._Z13record_resultdPKc(%struct.State* %0, i64 %391, %struct.Memory* %call2_40b438)
