; ModuleID = '/tmp/tmp1h_d3ny2-query.ll'
...
%var_2_93 = add i64 %var_2_92, -42359
...
%call2_40b3d7 = tail call %struct.Memory* @sub_400e60._Z11start_timerv(%struct.State* %0, i64 %var_2_93, %struct.Memory* %2)
...
%var_2_150 = phi i64 [ %var_2_371, %block_.L_40b44c ], [ %.pre, %entry ]
...
br i1 %var_2_183, label %block_40b3f3, label %block_.L_40b478
...
; Matched:%var_2_385:  %var_2_385 = phi i64 [ %var_2_241, %block_40b40e ], [ %.pre6, %block_40b3f3 ]
; %var_2_195 = phi i64 [ %var_2_314, %block_40b40e ], [ %.pre6, %block_40b3f3 ]
...
br i1 %var_2_231, label %block_40b40e, label %block_.L_40b44c
...
; Matched:%var_2_187:  %var_2_187 = add i64 %var_2_422, 5458
; %var_2_261 = add i64 %var_2_232, 5458
...
; Matched:%var_2_192:  %var_2_192 = tail call %struct.Memory* @sub_40c960__ZN32custom_divide_multiple_variable2IfE8do_shiftEfffff_renamed_(%struct.State* nonnull %0, i64 %var_2_187, %struct.Memory* %var_2_97)
; %call2_40b42f = tail call %struct.Memory* @sub_40c960._ZN32custom_divide_multiple_variable2IfE8do_shiftEfffff(%struct.State* nonnull %0, i64 %var_2_261, %struct.Memory* %call2_40b3d7)
...
; Matched:\<badref\>:  store float 0.000000e+00, float* %var_2_146, align 1, !tbaa !1285
; store float 0.000000e+00, float* %var_2_147, align 1
; Matched:%var_2_312:  %var_2_312 = add i64 %var_2_422, 5460
; %var_2_335 = add i64 %var_2_232, 5460
...
; Matched:%var_2_317:  %var_2_317 = tail call %struct.Memory* @sub_40c9a0__Z26check_shifted_variable_sumIf32custom_divide_multiple_variable2IfEEvT_S2_S2_S2_S2__renamed_(%struct.State* nonnull %0, i64 %var_2_312, %struct.Memory* %var_2_97)
; %call2_40b465 = tail call %struct.Memory* @sub_40c9a0._Z26check_shifted_variable_sumIf32custom_divide_multiple_variable2IfEEvT_S2_S2_S2_S2_(%struct.State* nonnull %0, i64 %var_2_335, %struct.Memory* %call2_40b3d7)
...
%var_2_372 = add i64 %var_2_184, -42488
...
%call2_40b478 = tail call %struct.Memory* @sub_400e80._Z5timerv(%struct.State* nonnull %0, i64 %var_2_372, %struct.Memory* %call2_40b3d7)
...
%var_2_383 = add i64 %var_2_379, -44125
...
%call2_40b481 = tail call %struct.Memory* @sub_400820._Z13record_resultdPKc(%struct.State* nonnull %0, i64 %var_2_383, %struct.Memory* %call2_40b478)
