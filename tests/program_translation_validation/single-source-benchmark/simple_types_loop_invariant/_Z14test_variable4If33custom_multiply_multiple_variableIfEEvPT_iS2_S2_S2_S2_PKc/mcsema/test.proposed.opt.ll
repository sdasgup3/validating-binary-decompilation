...
block_.L_40b053:                                  ; preds = %block_.L_40b0bc, %entry
  %145 = phi i64 [ %.pre, %entry ], [ %374, %block_.L_40b0bc ]
  ...
  br i1 %178, label %block_40b063, label %block_.L_40b0e8
...
block_.L_40b072:                                  ; preds = %block_40b07e, %block_40b063
  %190 = phi i64 [ %.pre1, %block_40b063 ], [ %313, %block_40b07e ]
  ...
  br i1 %226, label %block_40b07e, label %block_.L_40b0bc
...
block_40b07e:                                     ; preds = %block_.L_40b072
  ...
  %call2_40b09f = tail call %struct.Memory* @sub_40cc20._ZN33custom_multiply_multiple_variableIfE8do_shiftEfffff(%struct.State* %0, i64 %260, %struct.Memory* %MEMORY.1)
...
block_.L_40b0bc:                                  ; preds = %block_.L_40b072
  ...
  %call2_40b0d5 = tail call %struct.Memory* @sub_40cc60._Z26check_shifted_variable_sumIf33custom_multiply_multiple_variableIfEEvT_S2_S2_S2_S2_(%struct.State* %0, i64 %338, %struct.Memory* %MEMORY.1)
...
block_.L_40b0e8:                                  ; preds = %block_.L_40b053
  ...
  %call2_40b0e8 = tail call %struct.Memory* @sub_400e30._Z5timerv(%struct.State* %0, i64 %375, %struct.Memory* %MEMORY.0)
  ...
  %call2_40b0f1 = tail call %struct.Memory* @sub_4007d0._Z13record_resultdPKc(%struct.State* %0, i64 %386, %struct.Memory* %call2_40b0e8)
