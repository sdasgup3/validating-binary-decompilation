...
entry:
  ...
  store %struct.Memory* %loadMem_40b114, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem1_40b127, %struct.Memory** %MEMORY
  ...
  store i32 0, i32* %205
  store %struct.Memory* %loadMem_40b12c, %struct.Memory** %MEMORY
...
block_40b15e:                                     ; preds = %block_.L_40b152
  ...
  store %struct.Memory* %loadMem_40b175, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem1_40b17f, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_40b189, %struct.Memory** %MEMORY
