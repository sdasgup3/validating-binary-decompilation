...
declare %struct.Memory* @sub_40cb80._ZN34custom_multiply_multiple_variable2IfE8do_shiftEfffff(%struct.State* dereferenceable(3376), i64, %struct.Memory*) local_unnamed_addr

declare %struct.Memory* @sub_40cbc0._Z26check_shifted_variable_sumIf34custom_multiply_multiple_variable2IfEEvT_S2_S2_S2_S2_(%struct.State* dereferenceable(3376), i64, %struct.Memory*) local_unnamed_addr
...
block_.L_40b163:                                  ; preds = %block_.L_40b1cc, %entry
  %150 = phi i64 [ %.pre, %entry ], [ %371, %block_.L_40b1cc ]
  %MEMORY.0 = phi %struct.Memory* [ %call2_40b157, %entry ], [ %call2_40b1e5, %block_.L_40b1cc ]
...
block_.L_40b182:                                  ; preds = %block_40b18e, %block_40b173
  %195 = phi i64 [ %.pre6, %block_40b173 ], [ %314, %block_40b18e ]
  %MEMORY.1 = phi %struct.Memory* [ %MEMORY.0, %block_40b173 ], [ %call2_40b1af, %block_40b18e ]
...
block_40b18e:                                     ; preds = %block_.L_40b182
  ...
  %call2_40b1af = tail call %struct.Memory* @sub_40cb80._ZN34custom_multiply_multiple_variable2IfE8do_shiftEfffff(%struct.State* nonnull %0, i64 %261, %struct.Memory* %MEMORY.1)
...
block_.L_40b1cc:                                  ; preds = %block_.L_40b182
  ...
  %call2_40b1e5 = tail call %struct.Memory* @sub_40cbc0._Z26check_shifted_variable_sumIf34custom_multiply_multiple_variable2IfEEvT_S2_S2_S2_S2_(%struct.State* nonnull %0, i64 %335, %struct.Memory* %MEMORY.1)
...
block_.L_40b1f8:                                  ; preds = %block_.L_40b163
  ...
  %call2_40b1f8 = tail call %struct.Memory* @sub_400e70._Z5timerv(%struct.State* nonnull %0, i64 %372, %struct.Memory* %MEMORY.0)
