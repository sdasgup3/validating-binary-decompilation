; ModuleID = '/tmp/tmp2kudlw43-query.ll'
...
%var_2_93 = add i64 %var_2_92, -41735
...
%call2_40b167 = tail call %struct.Memory* @sub_400e60._Z11start_timerv(%struct.State* %0, i64 %var_2_93, %struct.Memory* %2)
...
%var_2_150 = phi i64 [ %var_2_371, %block_.L_40b1dc ], [ %.pre, %entry ]
...
br i1 %var_2_183, label %block_40b183, label %block_.L_40b208
...
; Matched:%var_2_267:  %var_2_267 = phi i64 [ %.pre6, %block_40b183 ], [ %var_2_231, %block_40b19e ]
; %var_2_195 = phi i64 [ %var_2_314, %block_40b19e ], [ %.pre6, %block_40b183 ]
...
br i1 %var_2_231, label %block_40b19e, label %block_.L_40b1dc
...
; Matched:%var_2_177:  %var_2_177 = add i64 %var_2_304, 6642
; %var_2_261 = add i64 %var_2_232, 6642
...
; Matched:%var_2_182:  %var_2_182 = tail call %struct.Memory* @sub_40cb90__ZN34custom_multiply_multiple_variable2IfE8do_shiftEfffff_renamed_(%struct.State* nonnull %0, i64 %var_2_177, %struct.Memory* %var_2_97)
; %call2_40b1bf = tail call %struct.Memory* @sub_40cb90._ZN34custom_multiply_multiple_variable2IfE8do_shiftEfffff(%struct.State* nonnull %0, i64 %var_2_261, %struct.Memory* %call2_40b167)
...
; Matched:\<badref\>:  store float 0.000000e+00, float* %var_2_146, align 1, !tbaa !1284
; store float 0.000000e+00, float* %var_2_147, align 1
; Matched:%var_2_325:  %var_2_325 = add i64 %var_2_304, 6644
; %var_2_335 = add i64 %var_2_232, 6644
...
; Matched:%var_2_330:  %var_2_330 = tail call %struct.Memory* @sub_40cbd0__Z26check_shifted_variable_sumIf34custom_multiply_multiple_variable2IfEEvT_S2_S2_S2_S2__renamed_(%struct.State* nonnull %0, i64 %var_2_325, %struct.Memory* %var_2_97)
; %call2_40b1f5 = tail call %struct.Memory* @sub_40cbd0._Z26check_shifted_variable_sumIf34custom_multiply_multiple_variable2IfEEvT_S2_S2_S2_S2_(%struct.State* nonnull %0, i64 %var_2_335, %struct.Memory* %call2_40b167)
...
%var_2_372 = add i64 %var_2_184, -41864
...
%call2_40b208 = tail call %struct.Memory* @sub_400e80._Z5timerv(%struct.State* nonnull %0, i64 %var_2_372, %struct.Memory* %call2_40b167)
...
%var_2_383 = add i64 %var_2_379, -43501
...
%call2_40b211 = tail call %struct.Memory* @sub_400820._Z13record_resultdPKc(%struct.State* nonnull %0, i64 %var_2_383, %struct.Memory* %call2_40b208)
