...
block_.L_404ddf:                                  ; preds = %block_.L_404e5c, %entry
  %122 = phi i64 [ %.pre, %entry ], [ %387, %block_.L_404e5c ]
...
block_.L_404dfa:                                  ; preds = %block_404e06, %block_404def
  %165 = phi i64 [ %.pre1, %block_404def ], [ %312, %block_404e06 ]
...
block_.L_404e5c:                                  ; preds = %block_.L_404dfa
  ...
  %call2_404e85 = tail call %struct.Memory* @sub_412390._Z26check_shifted_variable_sumIh27custom_multiple_variable_orIhEEvT_S2_S2_S2_S2_(%struct.State* %0, i64 %350, %struct.Memory* %MEMORY.1)
...
block_.L_404e98:                                  ; preds = %block_.L_404ddf
  ...
  %call2_404e98 = tail call %struct.Memory* @sub_400e30._Z5timerv(%struct.State* %0, i64 %388, %struct.Memory* %MEMORY.0)
  ...
  %call2_404ea1 = tail call %struct.Memory* @sub_4007d0._Z13record_resultdPKc(%struct.State* %0, i64 %399, %struct.Memory* %call2_404e98)
