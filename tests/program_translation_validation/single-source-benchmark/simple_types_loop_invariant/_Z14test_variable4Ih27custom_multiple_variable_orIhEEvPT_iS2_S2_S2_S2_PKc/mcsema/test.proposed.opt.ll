...
declare %struct.Memory* @sub_412370._ZN27custom_multiple_variable_orIhE8do_shiftEhhhhh(%struct.State* noalias dereferenceable(3376), i64, %struct.Memory* noalias readnone returned) local_unnamed_addr

declare %struct.Memory* @sub_4123c0._Z26check_shifted_variable_sumIh27custom_multiple_variable_orIhEEvT_S2_S2_S2_S2_(%struct.State* noalias dereferenceable(3376), i64, %struct.Memory* noalias readnone returned) local_unnamed_addr
...
define %struct.Memory* @_Z14test_variable4Ih27custom_multiple_variable_orIhEEvPT_iS2_S2_S2_S2_PKc(%struct.State* noalias, i64, %struct.Memory* noalias readnone) local_unnamed_addr #1 {
entry:
...
block_.L_404e0f:                                  ; preds = %block_.L_404e8c, %entry
  %122 = phi i64 [ %385, %block_.L_404e8c ], [ %.pre, %entry ]
...
block_.L_404e2a:                                  ; preds = %block_404e36, %block_404e1f
  %165 = phi i64 [ %311, %block_404e36 ], [ %.pre6, %block_404e1f ]
...
block_404e36:                                     ; preds = %block_.L_404e2a
  ...
  %call2_404e6b = tail call %struct.Memory* @sub_412370._ZN27custom_multiple_variable_orIhE8do_shiftEhhhhh(%struct.State* nonnull %0, i64 %248, %struct.Memory* %call2_404e03)
...
block_.L_404e8c:                                  ; preds = %block_.L_404e2a
  ...
  %call2_404eb5 = tail call %struct.Memory* @sub_4123c0._Z26check_shifted_variable_sumIh27custom_multiple_variable_orIhEEvT_S2_S2_S2_S2_(%struct.State* nonnull %0, i64 %349, %struct.Memory* %call2_404e03)
...
block_.L_404ec8:                                  ; preds = %block_.L_404e0f
  ...
  %call2_404ec8 = tail call %struct.Memory* @sub_400e70._Z5timerv(%struct.State* nonnull %0, i64 %386, %struct.Memory* %call2_404e03)
