...
declare %struct.Memory* @sub_412e80._Z26check_shifted_variable_sumIh28custom_add_multiple_variableIhEEvT_S2_S2_S2_S2_(%struct.State* noalias dereferenceable(3376), i64, %struct.Memory* noalias readnone returned) local_unnamed_addr
...
entry:
  ...
  %call2_404223 = tail call %struct.Memory* @sub_400e60._Z11start_timerv(%struct.State* %0, i64 %110, %struct.Memory* %2)
...
block_.L_40422f:                                  ; preds = %block_.L_4042ac, %entry
  %122 = phi i64 [ %385, %block_.L_4042ac ], [ %.pre, %entry ]
  ...
  br i1 %155, label %block_40423f, label %block_.L_4042e8
...
block_.L_40424a:                                  ; preds = %block_404256, %block_40423f
  %165 = phi i64 [ %311, %block_404256 ], [ %.pre6, %block_40423f ]
  ...
  br i1 %201, label %block_404256, label %block_.L_4042ac
...
block_404256:                                     ; preds = %block_.L_40424a
  ...
  %call2_40428b = tail call %struct.Memory* @sub_412e30._ZN28custom_add_multiple_variableIhE8do_shiftEhhhhh(%struct.State* nonnull %0, i64 %248, %struct.Memory* %call2_404223)
...
block_.L_4042ac:                                  ; preds = %block_.L_40424a
  ...
  %call2_4042d5 = tail call %struct.Memory* @sub_412e80._Z26check_shifted_variable_sumIh28custom_add_multiple_variableIhEEvT_S2_S2_S2_S2_(%struct.State* nonnull %0, i64 %349, %struct.Memory* %call2_404223)
...
block_.L_4042e8:                                  ; preds = %block_.L_40422f
  ...
  %call2_4042e8 = tail call %struct.Memory* @sub_400e80._Z5timerv(%struct.State* nonnull %0, i64 %386, %struct.Memory* %call2_404223)
  ...
  %call2_4042f1 = tail call %struct.Memory* @sub_400820._Z13record_resultdPKc(%struct.State* nonnull %0, i64 %397, %struct.Memory* %call2_4042e8)
