...
declare %struct.Memory* @sub_412e70._Z26check_shifted_variable_sumIh28custom_add_multiple_variableIhEEvT_S2_S2_S2_S2_(%struct.State* noalias dereferenceable(3376), i64, %struct.Memory* noalias readnone returned) local_unnamed_addr
...
define %struct.Memory* @_Z14test_variable4Ih28custom_add_multiple_variableIhEEvPT_iS2_S2_S2_S2_PKc(%struct.State* noalias, i64, %struct.Memory* noalias readnone) local_unnamed_addr #1 {
entry:
...
block_.L_40421f:                                  ; preds = %block_.L_40429c, %entry
  %122 = phi i64 [ %385, %block_.L_40429c ], [ %.pre, %entry ]
...
block_.L_40423a:                                  ; preds = %block_404246, %block_40422f
  %165 = phi i64 [ %311, %block_404246 ], [ %.pre6, %block_40422f ]
...
block_404246:                                     ; preds = %block_.L_40423a
  ...
  %call2_40427b = tail call %struct.Memory* @sub_412e20._ZN28custom_add_multiple_variableIhE8do_shiftEhhhhh(%struct.State* nonnull %0, i64 %248, %struct.Memory* %call2_404213)
...
block_.L_40429c:                                  ; preds = %block_.L_40423a
  ...
  %call2_4042c5 = tail call %struct.Memory* @sub_412e70._Z26check_shifted_variable_sumIh28custom_add_multiple_variableIhEEvT_S2_S2_S2_S2_(%struct.State* nonnull %0, i64 %349, %struct.Memory* %call2_404213)
...
block_.L_4042d8:                                  ; preds = %block_.L_40421f
  ...
  %call2_4042d8 = tail call %struct.Memory* @sub_400e70._Z5timerv(%struct.State* nonnull %0, i64 %386, %struct.Memory* %call2_404213)
