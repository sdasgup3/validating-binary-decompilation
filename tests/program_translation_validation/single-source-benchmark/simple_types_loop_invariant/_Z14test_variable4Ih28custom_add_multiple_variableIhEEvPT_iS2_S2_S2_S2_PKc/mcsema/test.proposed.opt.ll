...
block_.L_4041ef:                                  ; preds = %block_.L_40426c, %entry
  %122 = phi i64 [ %.pre, %entry ], [ %387, %block_.L_40426c ]
...
block_.L_40420a:                                  ; preds = %block_404216, %block_4041ff
  %165 = phi i64 [ %.pre1, %block_4041ff ], [ %312, %block_404216 ]
...
block_.L_40426c:                                  ; preds = %block_.L_40420a
  ...
  %call2_404295 = tail call %struct.Memory* @sub_412e40._Z26check_shifted_variable_sumIh28custom_add_multiple_variableIhEEvT_S2_S2_S2_S2_(%struct.State* %0, i64 %350, %struct.Memory* %MEMORY.1)
...
block_.L_4042a8:                                  ; preds = %block_.L_4041ef
  ...
  %call2_4042a8 = tail call %struct.Memory* @sub_400e30._Z5timerv(%struct.State* %0, i64 %388, %struct.Memory* %MEMORY.0)
  ...
  %call2_4042b1 = tail call %struct.Memory* @sub_4007d0._Z13record_resultdPKc(%struct.State* %0, i64 %399, %struct.Memory* %call2_4042a8)
