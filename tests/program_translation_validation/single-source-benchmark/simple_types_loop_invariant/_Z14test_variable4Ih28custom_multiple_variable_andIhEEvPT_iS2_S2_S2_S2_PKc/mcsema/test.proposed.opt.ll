...
block_.L_404c1f:                                  ; preds = %block_.L_404c9c, %entry
  %122 = phi i64 [ %.pre, %entry ], [ %385, %block_.L_404c9c ]
...
block_.L_404c3a:                                  ; preds = %block_404c46, %block_404c2f
  %165 = phi i64 [ %.pre1, %block_404c2f ], [ %311, %block_404c46 ]
...
block_.L_404c9c:                                  ; preds = %block_.L_404c3a
  ...
  %call2_404cc5 = tail call %struct.Memory* @sub_412520._Z26check_shifted_variable_sumIh28custom_multiple_variable_andIhEEvT_S2_S2_S2_S2_(%struct.State* %0, i64 %349, %struct.Memory* %MEMORY.1)
...
block_.L_404cd8:                                  ; preds = %block_.L_404c1f
  ...
  %call2_404cd8 = tail call %struct.Memory* @sub_400e30._Z5timerv(%struct.State* %0, i64 %386, %struct.Memory* %MEMORY.0)
  ...
  %call2_404ce1 = tail call %struct.Memory* @sub_4007d0._Z13record_resultdPKc(%struct.State* %0, i64 %397, %struct.Memory* %call2_404cd8)
