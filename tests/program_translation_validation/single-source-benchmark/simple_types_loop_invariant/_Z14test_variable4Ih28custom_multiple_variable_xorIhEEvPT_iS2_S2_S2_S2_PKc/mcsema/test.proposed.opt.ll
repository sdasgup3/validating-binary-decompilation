...
block_.L_404f9f:                                  ; preds = %block_.L_40501c, %entry
  %122 = phi i64 [ %.pre, %entry ], [ %387, %block_.L_40501c ]
...
block_.L_404fba:                                  ; preds = %block_404fc6, %block_404faf
  %165 = phi i64 [ %.pre1, %block_404faf ], [ %312, %block_404fc6 ]
...
block_.L_40501c:                                  ; preds = %block_.L_404fba
  ...
  %call2_405045 = tail call %struct.Memory* @sub_4121b0._Z26check_shifted_variable_sumIh28custom_multiple_variable_xorIhEEvT_S2_S2_S2_S2_(%struct.State* %0, i64 %350, %struct.Memory* %MEMORY.1)
...
block_.L_405058:                                  ; preds = %block_.L_404f9f
  ...
  %call2_405058 = tail call %struct.Memory* @sub_400e30._Z5timerv(%struct.State* %0, i64 %388, %struct.Memory* %MEMORY.0)
  ...
  %call2_405061 = tail call %struct.Memory* @sub_4007d0._Z13record_resultdPKc(%struct.State* %0, i64 %399, %struct.Memory* %call2_405058)
