...
declare %struct.Memory* @sub_412c90._ZN28custom_sub_multiple_variableIhE8do_shiftEhhhhh(%struct.State* noalias dereferenceable(3376), i64, %struct.Memory* noalias readnone returned) local_unnamed_addr

declare %struct.Memory* @sub_412ce0._Z26check_shifted_variable_sumIh28custom_sub_multiple_variableIhEEvT_S2_S2_S2_S2_(%struct.State* noalias dereferenceable(3376), i64, %struct.Memory* noalias readnone returned) local_unnamed_addr
...
define %struct.Memory* @_Z14test_variable4Ih28custom_sub_multiple_variableIhEEvPT_iS2_S2_S2_S2_PKc(%struct.State* noalias, i64, %struct.Memory* noalias readnone) local_unnamed_addr #1 {
entry:
...
block_.L_4043df:                                  ; preds = %block_.L_40445c, %entry
  %122 = phi i64 [ %385, %block_.L_40445c ], [ %.pre, %entry ]
...
block_.L_4043fa:                                  ; preds = %block_404406, %block_4043ef
  %165 = phi i64 [ %311, %block_404406 ], [ %.pre6, %block_4043ef ]
...
block_404406:                                     ; preds = %block_.L_4043fa
  ...
  %call2_40443b = tail call %struct.Memory* @sub_412c90._ZN28custom_sub_multiple_variableIhE8do_shiftEhhhhh(%struct.State* nonnull %0, i64 %248, %struct.Memory* %call2_4043d3)
...
block_.L_40445c:                                  ; preds = %block_.L_4043fa
  ...
  %call2_404485 = tail call %struct.Memory* @sub_412ce0._Z26check_shifted_variable_sumIh28custom_sub_multiple_variableIhEEvT_S2_S2_S2_S2_(%struct.State* nonnull %0, i64 %349, %struct.Memory* %call2_4043d3)
...
block_.L_404498:                                  ; preds = %block_.L_4043df
  ...
  %call2_404498 = tail call %struct.Memory* @sub_400e70._Z5timerv(%struct.State* nonnull %0, i64 %386, %struct.Memory* %call2_4043d3)
