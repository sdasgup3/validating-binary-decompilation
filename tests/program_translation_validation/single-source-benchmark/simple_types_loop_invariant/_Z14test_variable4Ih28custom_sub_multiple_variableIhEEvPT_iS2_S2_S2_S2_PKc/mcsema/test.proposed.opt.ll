...
block_.L_4043af:                                  ; preds = %block_.L_40442c, %entry
  %122 = phi i64 [ %.pre, %entry ], [ %385, %block_.L_40442c ]
...
block_.L_4043ca:                                  ; preds = %block_4043d6, %block_4043bf
  %165 = phi i64 [ %.pre1, %block_4043bf ], [ %311, %block_4043d6 ]
...
block_.L_40442c:                                  ; preds = %block_.L_4043ca
  ...
  %call2_404455 = tail call %struct.Memory* @sub_412cb0._Z26check_shifted_variable_sumIh28custom_sub_multiple_variableIhEEvT_S2_S2_S2_S2_(%struct.State* %0, i64 %349, %struct.Memory* %MEMORY.1)
...
block_.L_404468:                                  ; preds = %block_.L_4043af
  ...
  %call2_404468 = tail call %struct.Memory* @sub_400e30._Z5timerv(%struct.State* %0, i64 %386, %struct.Memory* %MEMORY.0)
  ...
  %call2_404471 = tail call %struct.Memory* @sub_4007d0._Z13record_resultdPKc(%struct.State* %0, i64 %397, %struct.Memory* %call2_404468)
