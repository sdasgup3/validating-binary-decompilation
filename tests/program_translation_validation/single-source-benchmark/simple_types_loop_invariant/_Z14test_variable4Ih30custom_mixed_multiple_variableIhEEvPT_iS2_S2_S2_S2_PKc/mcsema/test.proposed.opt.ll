...
block_.L_404a5f:                                  ; preds = %block_.L_404adc, %entry
  %122 = phi i64 [ %.pre, %entry ], [ %387, %block_.L_404adc ]
...
block_.L_404a7a:                                  ; preds = %block_404a86, %block_404a6f
  %165 = phi i64 [ %.pre1, %block_404a6f ], [ %312, %block_404a86 ]
...
block_.L_404adc:                                  ; preds = %block_.L_404a7a
  ...
  %call2_404b05 = tail call %struct.Memory* @sub_4126b0._Z26check_shifted_variable_sumIh30custom_mixed_multiple_variableIhEEvT_S2_S2_S2_S2_(%struct.State* %0, i64 %350, %struct.Memory* %MEMORY.1)
...
block_.L_404b18:                                  ; preds = %block_.L_404a5f
  ...
  %call2_404b18 = tail call %struct.Memory* @sub_400e30._Z5timerv(%struct.State* %0, i64 %388, %struct.Memory* %MEMORY.0)
  ...
  %call2_404b21 = tail call %struct.Memory* @sub_4007d0._Z13record_resultdPKc(%struct.State* %0, i64 %399, %struct.Memory* %call2_404b18)
