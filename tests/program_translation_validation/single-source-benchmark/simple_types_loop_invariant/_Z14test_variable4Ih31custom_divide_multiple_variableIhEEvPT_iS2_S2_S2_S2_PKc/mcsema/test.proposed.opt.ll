...
block_.L_40483f:                                  ; preds = %block_.L_4048bc, %entry
  %122 = phi i64 [ %.pre, %entry ], [ %387, %block_.L_4048bc ]
...
block_.L_40485a:                                  ; preds = %block_404866, %block_40484f
  %165 = phi i64 [ %.pre1, %block_40484f ], [ %312, %block_404866 ]
...
block_.L_4048bc:                                  ; preds = %block_.L_40485a
  ...
  %call2_4048e5 = tail call %struct.Memory* @sub_4128a0._Z26check_shifted_variable_sumIh31custom_divide_multiple_variableIhEEvT_S2_S2_S2_S2_(%struct.State* %0, i64 %350, %struct.Memory* %MEMORY.1)
...
block_.L_4048f8:                                  ; preds = %block_.L_40483f
  ...
  %call2_4048f8 = tail call %struct.Memory* @sub_400e30._Z5timerv(%struct.State* %0, i64 %388, %struct.Memory* %MEMORY.0)
  ...
  %call2_404901 = tail call %struct.Memory* @sub_4007d0._Z13record_resultdPKc(%struct.State* %0, i64 %399, %struct.Memory* %call2_4048f8)
