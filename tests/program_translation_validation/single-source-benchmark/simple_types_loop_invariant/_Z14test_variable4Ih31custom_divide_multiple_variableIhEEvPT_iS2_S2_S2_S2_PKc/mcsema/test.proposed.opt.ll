...
declare %struct.Memory* @sub_4128e0._Z26check_shifted_variable_sumIh31custom_divide_multiple_variableIhEEvT_S2_S2_S2_S2_(%struct.State* noalias dereferenceable(3376), i64, %struct.Memory* noalias readnone returned) local_unnamed_addr
...
entry:
  ...
  %call2_404873 = tail call %struct.Memory* @sub_400e60._Z11start_timerv(%struct.State* %0, i64 %110, %struct.Memory* %2)
...
block_.L_40487f:                                  ; preds = %block_.L_4048fc, %entry
  %122 = phi i64 [ %385, %block_.L_4048fc ], [ %.pre, %entry ]
  ...
  br i1 %155, label %block_40488f, label %block_.L_404938
...
block_.L_40489a:                                  ; preds = %block_4048a6, %block_40488f
  %165 = phi i64 [ %311, %block_4048a6 ], [ %.pre6, %block_40488f ]
  ...
  br i1 %201, label %block_4048a6, label %block_.L_4048fc
...
block_4048a6:                                     ; preds = %block_.L_40489a
  ...
  %call2_4048db = tail call %struct.Memory* @sub_412890._ZN31custom_divide_multiple_variableIhE8do_shiftEhhhhh(%struct.State* nonnull %0, i64 %248, %struct.Memory* %call2_404873)
...
block_.L_4048fc:                                  ; preds = %block_.L_40489a
  ...
  %call2_404925 = tail call %struct.Memory* @sub_4128e0._Z26check_shifted_variable_sumIh31custom_divide_multiple_variableIhEEvT_S2_S2_S2_S2_(%struct.State* nonnull %0, i64 %349, %struct.Memory* %call2_404873)
...
block_.L_404938:                                  ; preds = %block_.L_40487f
  ...
  %call2_404938 = tail call %struct.Memory* @sub_400e80._Z5timerv(%struct.State* nonnull %0, i64 %386, %struct.Memory* %call2_404873)
  ...
  %call2_404941 = tail call %struct.Memory* @sub_400820._Z13record_resultdPKc(%struct.State* nonnull %0, i64 %397, %struct.Memory* %call2_404938)
