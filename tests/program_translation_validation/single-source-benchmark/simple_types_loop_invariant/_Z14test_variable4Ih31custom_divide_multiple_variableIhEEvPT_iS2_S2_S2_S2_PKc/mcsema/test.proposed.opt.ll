...
declare %struct.Memory* @sub_4128d0._Z26check_shifted_variable_sumIh31custom_divide_multiple_variableIhEEvT_S2_S2_S2_S2_(%struct.State* noalias dereferenceable(3376), i64, %struct.Memory* noalias readnone returned) local_unnamed_addr
...
define %struct.Memory* @_Z14test_variable4Ih31custom_divide_multiple_variableIhEEvPT_iS2_S2_S2_S2_PKc(%struct.State* noalias, i64, %struct.Memory* noalias readnone) local_unnamed_addr #1 {
entry:
...
block_.L_40486f:                                  ; preds = %block_.L_4048ec, %entry
  %122 = phi i64 [ %385, %block_.L_4048ec ], [ %.pre, %entry ]
...
block_.L_40488a:                                  ; preds = %block_404896, %block_40487f
  %165 = phi i64 [ %311, %block_404896 ], [ %.pre6, %block_40487f ]
...
block_404896:                                     ; preds = %block_.L_40488a
  ...
  %call2_4048cb = tail call %struct.Memory* @sub_412880._ZN31custom_divide_multiple_variableIhE8do_shiftEhhhhh(%struct.State* nonnull %0, i64 %248, %struct.Memory* %call2_404863)
...
block_.L_4048ec:                                  ; preds = %block_.L_40488a
  ...
  %call2_404915 = tail call %struct.Memory* @sub_4128d0._Z26check_shifted_variable_sumIh31custom_divide_multiple_variableIhEEvT_S2_S2_S2_S2_(%struct.State* nonnull %0, i64 %349, %struct.Memory* %call2_404863)
...
block_.L_404928:                                  ; preds = %block_.L_40486f
  ...
  %call2_404928 = tail call %struct.Memory* @sub_400e70._Z5timerv(%struct.State* nonnull %0, i64 %386, %struct.Memory* %call2_404863)
