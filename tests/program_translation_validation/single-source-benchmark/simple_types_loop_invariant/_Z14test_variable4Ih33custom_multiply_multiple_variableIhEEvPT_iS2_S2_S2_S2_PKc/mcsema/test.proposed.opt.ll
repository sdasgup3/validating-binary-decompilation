...
block_.L_40456f:                                  ; preds = %block_.L_4045ec, %entry
  %122 = phi i64 [ %.pre, %entry ], [ %387, %block_.L_4045ec ]
...
block_.L_40458a:                                  ; preds = %block_404596, %block_40457f
  %165 = phi i64 [ %.pre1, %block_40457f ], [ %312, %block_404596 ]
...
block_.L_4045ec:                                  ; preds = %block_.L_40458a
  ...
  %call2_404615 = tail call %struct.Memory* @sub_412b20._Z26check_shifted_variable_sumIh33custom_multiply_multiple_variableIhEEvT_S2_S2_S2_S2_(%struct.State* %0, i64 %350, %struct.Memory* %MEMORY.1)
...
block_.L_404628:                                  ; preds = %block_.L_40456f
  ...
  %call2_404628 = tail call %struct.Memory* @sub_400e30._Z5timerv(%struct.State* %0, i64 %388, %struct.Memory* %MEMORY.0)
  ...
  %call2_404631 = tail call %struct.Memory* @sub_4007d0._Z13record_resultdPKc(%struct.State* %0, i64 %399, %struct.Memory* %call2_404628)
