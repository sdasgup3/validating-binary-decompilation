...
declare %struct.Memory* @sub_412a70._Z26check_shifted_variable_sumIh34custom_multiply_multiple_variable2IhEEvT_S2_S2_S2_S2_(%struct.State* noalias dereferenceable(3376), i64, %struct.Memory* noalias readnone returned) local_unnamed_addr
...
entry:
  ...
  %call2_4046b3 = tail call %struct.Memory* @sub_400e60._Z11start_timerv(%struct.State* %0, i64 %110, %struct.Memory* %2)
...
block_.L_4046bf:                                  ; preds = %block_.L_40473c, %entry
  %122 = phi i64 [ %385, %block_.L_40473c ], [ %.pre, %entry ]
  ...
  br i1 %155, label %block_4046cf, label %block_.L_404778
...
block_.L_4046da:                                  ; preds = %block_4046e6, %block_4046cf
  %165 = phi i64 [ %311, %block_4046e6 ], [ %.pre6, %block_4046cf ]
  ...
  br i1 %201, label %block_4046e6, label %block_.L_40473c
...
block_4046e6:                                     ; preds = %block_.L_4046da
  ...
  %call2_40471b = tail call %struct.Memory* @sub_412a20._ZN34custom_multiply_multiple_variable2IhE8do_shiftEhhhhh(%struct.State* nonnull %0, i64 %248, %struct.Memory* %call2_4046b3)
...
block_.L_40473c:                                  ; preds = %block_.L_4046da
  ...
  %call2_404765 = tail call %struct.Memory* @sub_412a70._Z26check_shifted_variable_sumIh34custom_multiply_multiple_variable2IhEEvT_S2_S2_S2_S2_(%struct.State* nonnull %0, i64 %349, %struct.Memory* %call2_4046b3)
...
block_.L_404778:                                  ; preds = %block_.L_4046bf
  ...
  %call2_404778 = tail call %struct.Memory* @sub_400e80._Z5timerv(%struct.State* nonnull %0, i64 %386, %struct.Memory* %call2_4046b3)
  ...
  %call2_404781 = tail call %struct.Memory* @sub_400820._Z13record_resultdPKc(%struct.State* nonnull %0, i64 %397, %struct.Memory* %call2_404778)
