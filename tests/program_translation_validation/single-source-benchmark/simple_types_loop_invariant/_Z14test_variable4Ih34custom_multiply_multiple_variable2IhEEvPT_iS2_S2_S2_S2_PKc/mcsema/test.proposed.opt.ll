...
block_.L_40467f:                                  ; preds = %block_.L_4046fc, %entry
  %122 = phi i64 [ %.pre, %entry ], [ %387, %block_.L_4046fc ]
...
block_.L_40469a:                                  ; preds = %block_4046a6, %block_40468f
  %165 = phi i64 [ %.pre1, %block_40468f ], [ %312, %block_4046a6 ]
...
block_.L_4046fc:                                  ; preds = %block_.L_40469a
  ...
  %call2_404725 = tail call %struct.Memory* @sub_412a30._Z26check_shifted_variable_sumIh34custom_multiply_multiple_variable2IhEEvT_S2_S2_S2_S2_(%struct.State* %0, i64 %350, %struct.Memory* %MEMORY.1)
...
block_.L_404738:                                  ; preds = %block_.L_40467f
  ...
  %call2_404738 = tail call %struct.Memory* @sub_400e30._Z5timerv(%struct.State* %0, i64 %388, %struct.Memory* %MEMORY.0)
  ...
  %call2_404741 = tail call %struct.Memory* @sub_4007d0._Z13record_resultdPKc(%struct.State* %0, i64 %399, %struct.Memory* %call2_404738)
