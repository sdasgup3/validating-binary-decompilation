...
declare %struct.Memory* @sub_412a60._Z26check_shifted_variable_sumIh34custom_multiply_multiple_variable2IhEEvT_S2_S2_S2_S2_(%struct.State* noalias dereferenceable(3376), i64, %struct.Memory* noalias readnone returned) local_unnamed_addr
...
define %struct.Memory* @_Z14test_variable4Ih34custom_multiply_multiple_variable2IhEEvPT_iS2_S2_S2_S2_PKc(%struct.State* noalias, i64, %struct.Memory* noalias readnone) local_unnamed_addr #1 {
entry:
...
block_.L_4046af:                                  ; preds = %block_.L_40472c, %entry
  %122 = phi i64 [ %385, %block_.L_40472c ], [ %.pre, %entry ]
...
block_.L_4046ca:                                  ; preds = %block_4046d6, %block_4046bf
  %165 = phi i64 [ %311, %block_4046d6 ], [ %.pre6, %block_4046bf ]
...
block_4046d6:                                     ; preds = %block_.L_4046ca
  ...
  %call2_40470b = tail call %struct.Memory* @sub_412a10._ZN34custom_multiply_multiple_variable2IhE8do_shiftEhhhhh(%struct.State* nonnull %0, i64 %248, %struct.Memory* %call2_4046a3)
...
block_.L_40472c:                                  ; preds = %block_.L_4046ca
  ...
  %call2_404755 = tail call %struct.Memory* @sub_412a60._Z26check_shifted_variable_sumIh34custom_multiply_multiple_variable2IhEEvT_S2_S2_S2_S2_(%struct.State* nonnull %0, i64 %349, %struct.Memory* %call2_4046a3)
...
block_.L_404768:                                  ; preds = %block_.L_4046af
  ...
  %call2_404768 = tail call %struct.Memory* @sub_400e70._Z5timerv(%struct.State* nonnull %0, i64 %386, %struct.Memory* %call2_4046a3)
