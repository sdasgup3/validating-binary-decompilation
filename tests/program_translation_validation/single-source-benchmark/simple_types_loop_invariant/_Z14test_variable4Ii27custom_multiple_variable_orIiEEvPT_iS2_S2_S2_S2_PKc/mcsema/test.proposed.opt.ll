...
block_.L_408011:                                  ; preds = %block_.L_40806c, %entry
  %101 = phi i64 [ %.pre, %entry ], [ %349, %block_.L_40806c ]
...
block_.L_40802f:                                  ; preds = %block_40803b, %block_408021
  %144 = phi i64 [ %.pre1, %block_408021 ], [ %287, %block_40803b ]
...
block_.L_40806c:                                  ; preds = %block_.L_40802f
  ...
  %call2_40807c = tail call %struct.Memory* @sub_40f820._Z26check_shifted_variable_sumIi27custom_multiple_variable_orIiEEvT_S2_S2_S2_S2_(%struct.State* %0, i64 %313, %struct.Memory* %MEMORY.1)
...
block_.L_40808f:                                  ; preds = %block_.L_408011
  ...
  %call2_40808f = tail call %struct.Memory* @sub_400e30._Z5timerv(%struct.State* %0, i64 %350, %struct.Memory* %MEMORY.0)
  ...
  %call2_408098 = tail call %struct.Memory* @sub_4007d0._Z13record_resultdPKc(%struct.State* %0, i64 %361, %struct.Memory* %call2_40808f)
