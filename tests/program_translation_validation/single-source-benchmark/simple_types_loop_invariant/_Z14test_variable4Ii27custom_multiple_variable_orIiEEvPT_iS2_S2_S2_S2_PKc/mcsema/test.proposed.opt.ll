...
declare %struct.Memory* @sub_40f7f0._ZN27custom_multiple_variable_orIiE8do_shiftEiiiii(%struct.State* noalias dereferenceable(3376), i64, %struct.Memory* noalias readnone returned) local_unnamed_addr

declare %struct.Memory* @sub_40f820._Z26check_shifted_variable_sumIi27custom_multiple_variable_orIiEEvT_S2_S2_S2_S2_(%struct.State* noalias dereferenceable(3376), i64, %struct.Memory* noalias readnone returned) local_unnamed_addr
...
entry:
  ...
  %call2_408005 = tail call %struct.Memory* @sub_400e10._Z11start_timerv(%struct.State* %0, i64 %90, %struct.Memory* %2)
...
block_.L_408011:                                  ; preds = %block_.L_40806c, %entry
  %101 = phi i64 [ %.pre, %entry ], [ %351, %block_.L_40806c ]
  %MEMORY.0 = phi %struct.Memory* [ %call2_408005, %entry ], [ %call2_40807c, %block_.L_40806c ]
  ...
  br i1 %134, label %block_408021, label %block_.L_40808f

block_408021:                                     ; preds = %block_.L_408011
  %136 = add i64 %102, -36
  %137 = add i64 %135, 7
...
block_.L_40802f:                                  ; preds = %block_40803b, %block_408021
  %144 = phi i64 [ %.pre1, %block_408021 ], [ %288, %block_40803b ]
  %MEMORY.1 = phi %struct.Memory* [ %MEMORY.0, %block_408021 ], [ %call2_408053, %block_40803b ]
  ...
  br i1 %180, label %block_40803b, label %block_.L_40806c

block_40803b:                                     ; preds = %block_.L_40802f
  %182 = add i64 %145, -8
  %183 = add i64 %181, 4
  ...
  %call2_408053 = tail call %struct.Memory* @sub_40f7f0._ZN27custom_multiple_variable_orIiE8do_shiftEiiiii(%struct.State* %0, i64 %215, %struct.Memory* %MEMORY.1)
...
block_.L_40806c:                                  ; preds = %block_.L_40802f
  %289 = add i64 %145, -36
  %290 = add i64 %181, 3
  ...
  %call2_40807c = tail call %struct.Memory* @sub_40f820._Z26check_shifted_variable_sumIi27custom_multiple_variable_orIiEEvT_S2_S2_S2_S2_(%struct.State* %0, i64 %314, %struct.Memory* %MEMORY.1)
...
block_.L_40808f:                                  ; preds = %block_.L_408011
  %352 = add i64 %135, -29279
  %353 = add i64 %135, 5
  ...
  %call2_40808f = tail call %struct.Memory* @sub_400e30._Z5timerv(%struct.State* %0, i64 %352, %struct.Memory* %MEMORY.0)
  ...
  %call2_408098 = tail call %struct.Memory* @sub_4007d0._Z13record_resultdPKc(%struct.State* %0, i64 %363, %struct.Memory* %call2_40808f)
  ...
  ret %struct.Memory* %call2_408098
}
...
define %struct.Memory* @routine_jge_.L_40808f(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i8* %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
...
define %struct.Memory* @routine_jge_.L_40806c(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i8* %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 2, i32 9
...
define %struct.Memory* @routine_callq_._ZN27custom_multiple_variable_orIiE8do_shiftEiiiii(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
...
define %struct.Memory* @routine_callq_._Z26check_shifted_variable_sumIi27custom_multiple_variable_orIiEEvT_S2_S2_S2_S2_(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
...
define %struct.Memory* @routine_jmpq_.L_408011(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
