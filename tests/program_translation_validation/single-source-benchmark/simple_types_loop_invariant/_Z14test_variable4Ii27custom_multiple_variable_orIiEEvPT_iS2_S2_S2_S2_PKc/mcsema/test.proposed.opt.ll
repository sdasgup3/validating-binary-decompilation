...
declare %struct.Memory* @sub_40f830._ZN27custom_multiple_variable_orIiE8do_shiftEiiiii(%struct.State* noalias dereferenceable(3376), i64, %struct.Memory* noalias readnone returned) local_unnamed_addr

declare %struct.Memory* @sub_40f860._Z26check_shifted_variable_sumIi27custom_multiple_variable_orIiEEvT_S2_S2_S2_S2_(%struct.State* noalias dereferenceable(3376), i64, %struct.Memory* noalias readnone returned) local_unnamed_addr
...
entry:
  ...
  %call2_408045 = tail call %struct.Memory* @sub_400e60._Z11start_timerv(%struct.State* %0, i64 %89, %struct.Memory* %2)
...
block_.L_408051:                                  ; preds = %block_.L_4080ac, %entry
  %100 = phi i64 [ %348, %block_.L_4080ac ], [ %.pre, %entry ]
  ...
  br i1 %133, label %block_408061, label %block_.L_4080cf

block_408061:                                     ; preds = %block_.L_408051
  %135 = add i64 %101, -48
  %136 = add i64 %134, 7
...
block_.L_40806f:                                  ; preds = %block_40807b, %block_408061
  %143 = phi i64 [ %286, %block_40807b ], [ %.pre6, %block_408061 ]
  ...
  br i1 %179, label %block_40807b, label %block_.L_4080ac

block_40807b:                                     ; preds = %block_.L_40806f
  %181 = add i64 %144, -8
  %182 = add i64 %180, 4
  ...
  %call2_408093 = tail call %struct.Memory* @sub_40f830._ZN27custom_multiple_variable_orIiE8do_shiftEiiiii(%struct.State* nonnull %0, i64 %214, %struct.Memory* %call2_408045)
...
block_.L_4080ac:                                  ; preds = %block_.L_40806f
  %287 = add i64 %144, -48
  %288 = add i64 %180, 3
  ...
  %call2_4080bc = tail call %struct.Memory* @sub_40f860._Z26check_shifted_variable_sumIi27custom_multiple_variable_orIiEEvT_S2_S2_S2_S2_(%struct.State* nonnull %0, i64 %312, %struct.Memory* %call2_408045)
...
block_.L_4080cf:                                  ; preds = %block_.L_408051
  ...
  %call2_4080cf = tail call %struct.Memory* @sub_400e80._Z5timerv(%struct.State* nonnull %0, i64 %349, %struct.Memory* %call2_408045)
  ...
  %call2_4080d8 = tail call %struct.Memory* @sub_400820._Z13record_resultdPKc(%struct.State* nonnull %0, i64 %360, %struct.Memory* %call2_4080cf)
  ...
  ret %struct.Memory* %call2_4080d8
}
...
; Function Attrs: alwaysinline norecurse nounwind
define %struct.Memory* @routine_jge_.L_4080cf(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i8* nocapture %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
...
; Function Attrs: alwaysinline norecurse nounwind
define %struct.Memory* @routine_jge_.L_4080ac(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i8* nocapture %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 2, i32 9
...
; Function Attrs: alwaysinline norecurse nounwind
define %struct.Memory* @routine_jmpq_.L_408051(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
