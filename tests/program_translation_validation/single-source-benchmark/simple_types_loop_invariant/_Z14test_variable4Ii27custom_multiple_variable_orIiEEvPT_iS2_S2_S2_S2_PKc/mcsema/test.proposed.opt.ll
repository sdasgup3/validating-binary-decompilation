...
declare %struct.Memory* @sub_40f820._ZN27custom_multiple_variable_orIiE8do_shiftEiiiii(%struct.State* noalias dereferenceable(3376), i64, %struct.Memory* noalias readnone returned) local_unnamed_addr

declare %struct.Memory* @sub_40f850._Z26check_shifted_variable_sumIi27custom_multiple_variable_orIiEEvT_S2_S2_S2_S2_(%struct.State* noalias dereferenceable(3376), i64, %struct.Memory* noalias readnone returned) local_unnamed_addr
...
define %struct.Memory* @_Z14test_variable4Ii27custom_multiple_variable_orIiEEvPT_iS2_S2_S2_S2_PKc(%struct.State* noalias, i64, %struct.Memory* noalias readnone) local_unnamed_addr #1 {
entry:
...
block_.L_408041:                                  ; preds = %block_.L_40809c, %entry
  %100 = phi i64 [ %348, %block_.L_40809c ], [ %.pre, %entry ]
...
block_.L_40805f:                                  ; preds = %block_40806b, %block_408051
  %143 = phi i64 [ %286, %block_40806b ], [ %.pre6, %block_408051 ]
...
block_40806b:                                     ; preds = %block_.L_40805f
  ...
  %call2_408083 = tail call %struct.Memory* @sub_40f820._ZN27custom_multiple_variable_orIiE8do_shiftEiiiii(%struct.State* nonnull %0, i64 %214, %struct.Memory* %call2_408035)
...
block_.L_40809c:                                  ; preds = %block_.L_40805f
  ...
  %call2_4080ac = tail call %struct.Memory* @sub_40f850._Z26check_shifted_variable_sumIi27custom_multiple_variable_orIiEEvT_S2_S2_S2_S2_(%struct.State* nonnull %0, i64 %312, %struct.Memory* %call2_408035)
...
block_.L_4080bf:                                  ; preds = %block_.L_408041
  ...
  %call2_4080bf = tail call %struct.Memory* @sub_400e70._Z5timerv(%struct.State* nonnull %0, i64 %349, %struct.Memory* %call2_408035)
