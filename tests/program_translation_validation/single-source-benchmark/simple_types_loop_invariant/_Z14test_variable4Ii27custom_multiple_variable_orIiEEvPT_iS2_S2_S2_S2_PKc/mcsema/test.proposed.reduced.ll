; ModuleID = '/tmp/tmp6mwyogz3-query.ll'
...
define %struct.Memory* @_Z14test_variable4Ii27custom_multiple_variable_orIiEEvPT_iS2_S2_S2_S2_PKc(%struct.State* noalias, i64, %struct.Memory* noalias readnone returned) local_unnamed_addr #1 {
entry:
  %var_2_3 = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %RBP.i = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 15, i32 0, i32 0
  %var_2_88 = load i64, i64* %var_2_3, align 8
  %var_2_89 = add i64 %var_2_88, -29157
  %call2_408045 = tail call %struct.Memory* @sub_400e60._Z11start_timerv(%struct.State* %0, i64 %var_2_89, %struct.Memory* %2)
  ...
  br i1 %var_2_13315, label %block_408061.preheader, label %block_.L_4080cf

block_408061.preheader:                           ; preds = %entry
  ...
  br i1 %var_2_179, label %block_.L_40806f.preheader, label %block_408061.preheader5

block_408061.preheader5:                          ; preds = %block_408061.preheader
  br label %block_408061

block_.L_40806f.preheader:                        ; preds = %block_408061.preheader
  br label %block_.L_40806f

block_408061:                                     ; preds = %block_408061.preheader5, %block_408061
  br label %block_408061

block_.L_40806f:                                  ; preds = %block_.L_40806f.preheader, %block_.L_40806f
  br label %block_.L_40806f

block_.L_4080cf:                                  ; preds = %entry
  %.pre = load i64, i64* %var_2_3, align 8
  %var_2_349 = add i64 %.pre, -29137
  %call2_4080cf = tail call %struct.Memory* @sub_400e80._Z5timerv(%struct.State* nonnull %0, i64 %var_2_349, %struct.Memory* %call2_408045)
  %var_2_356 = load i64, i64* %var_2_3, align 8
  %var_2_360 = add i64 %var_2_356, -30900
  %call2_4080d8 = tail call %struct.Memory* @sub_400820._Z13record_resultdPKc(%struct.State* nonnull %0, i64 %var_2_360, %struct.Memory* %call2_4080cf)
