...
block_.L_407671:                                  ; preds = %block_.L_4076cc, %entry
  %101 = phi i64 [ %.pre, %entry ], [ %349, %block_.L_4076cc ]
...
block_.L_40768f:                                  ; preds = %block_40769b, %block_407681
  %144 = phi i64 [ %.pre1, %block_407681 ], [ %287, %block_40769b ]
...
block_.L_4076cc:                                  ; preds = %block_.L_40768f
  ...
  %call2_4076dc = tail call %struct.Memory* @sub_410020._Z26check_shifted_variable_sumIi28custom_add_multiple_variableIiEEvT_S2_S2_S2_S2_(%struct.State* %0, i64 %313, %struct.Memory* %MEMORY.1)
...
block_.L_4076ef:                                  ; preds = %block_.L_407671
  ...
  %call2_4076ef = tail call %struct.Memory* @sub_400e30._Z5timerv(%struct.State* %0, i64 %350, %struct.Memory* %MEMORY.0)
  ...
  %call2_4076f8 = tail call %struct.Memory* @sub_4007d0._Z13record_resultdPKc(%struct.State* %0, i64 %361, %struct.Memory* %call2_4076ef)
