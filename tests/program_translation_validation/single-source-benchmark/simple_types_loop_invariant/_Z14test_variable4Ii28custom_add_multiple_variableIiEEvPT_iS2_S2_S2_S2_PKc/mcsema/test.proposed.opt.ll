...
declare %struct.Memory* @sub_410050._Z26check_shifted_variable_sumIi28custom_add_multiple_variableIiEEvT_S2_S2_S2_S2_(%struct.State* noalias dereferenceable(3376), i64, %struct.Memory* noalias readnone returned) local_unnamed_addr
...
define %struct.Memory* @_Z14test_variable4Ii28custom_add_multiple_variableIiEEvPT_iS2_S2_S2_S2_PKc(%struct.State* noalias, i64, %struct.Memory* noalias readnone) local_unnamed_addr #1 {
entry:
...
block_.L_4076a1:                                  ; preds = %block_.L_4076fc, %entry
  %100 = phi i64 [ %348, %block_.L_4076fc ], [ %.pre, %entry ]
...
block_.L_4076bf:                                  ; preds = %block_4076cb, %block_4076b1
  %143 = phi i64 [ %286, %block_4076cb ], [ %.pre6, %block_4076b1 ]
...
block_4076cb:                                     ; preds = %block_.L_4076bf
  ...
  %call2_4076e3 = tail call %struct.Memory* @sub_410020._ZN28custom_add_multiple_variableIiE8do_shiftEiiiii(%struct.State* nonnull %0, i64 %214, %struct.Memory* %call2_407695)
...
block_.L_4076fc:                                  ; preds = %block_.L_4076bf
  ...
  %call2_40770c = tail call %struct.Memory* @sub_410050._Z26check_shifted_variable_sumIi28custom_add_multiple_variableIiEEvT_S2_S2_S2_S2_(%struct.State* nonnull %0, i64 %312, %struct.Memory* %call2_407695)
...
block_.L_40771f:                                  ; preds = %block_.L_4076a1
  ...
  %call2_40771f = tail call %struct.Memory* @sub_400e70._Z5timerv(%struct.State* nonnull %0, i64 %349, %struct.Memory* %call2_407695)
