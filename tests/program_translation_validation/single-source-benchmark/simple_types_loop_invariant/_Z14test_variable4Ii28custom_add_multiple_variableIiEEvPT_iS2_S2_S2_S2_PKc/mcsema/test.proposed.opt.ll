...
declare %struct.Memory* @sub_410060._Z26check_shifted_variable_sumIi28custom_add_multiple_variableIiEEvT_S2_S2_S2_S2_(%struct.State* noalias dereferenceable(3376), i64, %struct.Memory* noalias readnone returned) local_unnamed_addr
...
entry:
  ...
  %call2_4076a5 = tail call %struct.Memory* @sub_400e60._Z11start_timerv(%struct.State* %0, i64 %89, %struct.Memory* %2)
...
block_.L_4076b1:                                  ; preds = %block_.L_40770c, %entry
  %100 = phi i64 [ %348, %block_.L_40770c ], [ %.pre, %entry ]
  ...
  br i1 %133, label %block_4076c1, label %block_.L_40772f
...
block_.L_4076cf:                                  ; preds = %block_4076db, %block_4076c1
  %143 = phi i64 [ %286, %block_4076db ], [ %.pre6, %block_4076c1 ]
  ...
  br i1 %179, label %block_4076db, label %block_.L_40770c
...
block_4076db:                                     ; preds = %block_.L_4076cf
  ...
  %call2_4076f3 = tail call %struct.Memory* @sub_410030._ZN28custom_add_multiple_variableIiE8do_shiftEiiiii(%struct.State* nonnull %0, i64 %214, %struct.Memory* %call2_4076a5)
...
block_.L_40770c:                                  ; preds = %block_.L_4076cf
  ...
  %call2_40771c = tail call %struct.Memory* @sub_410060._Z26check_shifted_variable_sumIi28custom_add_multiple_variableIiEEvT_S2_S2_S2_S2_(%struct.State* nonnull %0, i64 %312, %struct.Memory* %call2_4076a5)
...
block_.L_40772f:                                  ; preds = %block_.L_4076b1
  ...
  %call2_40772f = tail call %struct.Memory* @sub_400e80._Z5timerv(%struct.State* nonnull %0, i64 %349, %struct.Memory* %call2_4076a5)
  ...
  %call2_407738 = tail call %struct.Memory* @sub_400820._Z13record_resultdPKc(%struct.State* nonnull %0, i64 %360, %struct.Memory* %call2_40772f)
