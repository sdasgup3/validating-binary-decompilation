...
block_.L_407ea1:                                  ; preds = %block_.L_407efc, %entry
  %101 = phi i64 [ %.pre, %entry ], [ %349, %block_.L_407efc ]
...
block_.L_407ebf:                                  ; preds = %block_407ecb, %block_407eb1
  %144 = phi i64 [ %.pre1, %block_407eb1 ], [ %287, %block_407ecb ]
...
block_.L_407efc:                                  ; preds = %block_.L_407ebf
  ...
  %call2_407f0c = tail call %struct.Memory* @sub_40f950._Z26check_shifted_variable_sumIi28custom_multiple_variable_andIiEEvT_S2_S2_S2_S2_(%struct.State* %0, i64 %313, %struct.Memory* %MEMORY.1)
...
block_.L_407f1f:                                  ; preds = %block_.L_407ea1
  ...
  %call2_407f1f = tail call %struct.Memory* @sub_400e30._Z5timerv(%struct.State* %0, i64 %350, %struct.Memory* %MEMORY.0)
  ...
  %call2_407f28 = tail call %struct.Memory* @sub_4007d0._Z13record_resultdPKc(%struct.State* %0, i64 %361, %struct.Memory* %call2_407f1f)
