...
declare %struct.Memory* @sub_40f950._ZN28custom_multiple_variable_andIiE8do_shiftEiiiii(%struct.State* dereferenceable(3376), i64, %struct.Memory*) local_unnamed_addr

declare %struct.Memory* @sub_40f980._Z26check_shifted_variable_sumIi28custom_multiple_variable_andIiEEvT_S2_S2_S2_S2_(%struct.State* dereferenceable(3376), i64, %struct.Memory*) local_unnamed_addr
...
block_.L_407ed1:                                  ; preds = %block_.L_407f2c, %entry
  %100 = phi i64 [ %.pre, %entry ], [ %348, %block_.L_407f2c ]
  %MEMORY.0 = phi %struct.Memory* [ %call2_407ec5, %entry ], [ %call2_407f3c, %block_.L_407f2c ]
...
block_.L_407eef:                                  ; preds = %block_407efb, %block_407ee1
  %143 = phi i64 [ %.pre6, %block_407ee1 ], [ %286, %block_407efb ]
  %MEMORY.1 = phi %struct.Memory* [ %MEMORY.0, %block_407ee1 ], [ %call2_407f13, %block_407efb ]
...
block_407efb:                                     ; preds = %block_.L_407eef
  ...
  %call2_407f13 = tail call %struct.Memory* @sub_40f950._ZN28custom_multiple_variable_andIiE8do_shiftEiiiii(%struct.State* nonnull %0, i64 %214, %struct.Memory* %MEMORY.1)
...
block_.L_407f2c:                                  ; preds = %block_.L_407eef
  ...
  %call2_407f3c = tail call %struct.Memory* @sub_40f980._Z26check_shifted_variable_sumIi28custom_multiple_variable_andIiEEvT_S2_S2_S2_S2_(%struct.State* nonnull %0, i64 %312, %struct.Memory* %MEMORY.1)
...
block_.L_407f4f:                                  ; preds = %block_.L_407ed1
  ...
  %call2_407f4f = tail call %struct.Memory* @sub_400e70._Z5timerv(%struct.State* nonnull %0, i64 %349, %struct.Memory* %MEMORY.0)
