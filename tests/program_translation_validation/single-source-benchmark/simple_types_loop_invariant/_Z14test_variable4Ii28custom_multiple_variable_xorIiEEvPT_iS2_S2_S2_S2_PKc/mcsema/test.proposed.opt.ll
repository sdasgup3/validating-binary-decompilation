...
block_.L_408181:                                  ; preds = %block_.L_4081dc, %entry
  %101 = phi i64 [ %.pre, %entry ], [ %351, %block_.L_4081dc ]
...
block_.L_40819f:                                  ; preds = %block_4081ab, %block_408191
  %144 = phi i64 [ %.pre1, %block_408191 ], [ %288, %block_4081ab ]
...
block_.L_4081dc:                                  ; preds = %block_.L_40819f
  ...
  %call2_4081ec = tail call %struct.Memory* @sub_40f6c0._Z26check_shifted_variable_sumIi28custom_multiple_variable_xorIiEEvT_S2_S2_S2_S2_(%struct.State* %0, i64 %314, %struct.Memory* %MEMORY.1)
...
block_.L_4081ff:                                  ; preds = %block_.L_408181
  ...
  %call2_4081ff = tail call %struct.Memory* @sub_400e30._Z5timerv(%struct.State* %0, i64 %352, %struct.Memory* %MEMORY.0)
  ...
  %call2_408208 = tail call %struct.Memory* @sub_4007d0._Z13record_resultdPKc(%struct.State* %0, i64 %363, %struct.Memory* %call2_4081ff)
