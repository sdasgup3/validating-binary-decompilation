...
declare %struct.Memory* @sub_40f6c0._ZN28custom_multiple_variable_xorIiE8do_shiftEiiiii(%struct.State* noalias dereferenceable(3376), i64, %struct.Memory* noalias readnone returned) local_unnamed_addr

declare %struct.Memory* @sub_40f6f0._Z26check_shifted_variable_sumIi28custom_multiple_variable_xorIiEEvT_S2_S2_S2_S2_(%struct.State* noalias dereferenceable(3376), i64, %struct.Memory* noalias readnone returned) local_unnamed_addr
...
define %struct.Memory* @_Z14test_variable4Ii28custom_multiple_variable_xorIiEEvPT_iS2_S2_S2_S2_PKc(%struct.State* noalias, i64, %struct.Memory* noalias readnone) local_unnamed_addr #1 {
entry:
...
block_.L_4081b1:                                  ; preds = %block_.L_40820c, %entry
  %100 = phi i64 [ %348, %block_.L_40820c ], [ %.pre, %entry ]
...
block_.L_4081cf:                                  ; preds = %block_4081db, %block_4081c1
  %143 = phi i64 [ %286, %block_4081db ], [ %.pre6, %block_4081c1 ]
...
block_4081db:                                     ; preds = %block_.L_4081cf
  ...
  %call2_4081f3 = tail call %struct.Memory* @sub_40f6c0._ZN28custom_multiple_variable_xorIiE8do_shiftEiiiii(%struct.State* nonnull %0, i64 %214, %struct.Memory* %call2_4081a5)
...
block_.L_40820c:                                  ; preds = %block_.L_4081cf
  ...
  %call2_40821c = tail call %struct.Memory* @sub_40f6f0._Z26check_shifted_variable_sumIi28custom_multiple_variable_xorIiEEvT_S2_S2_S2_S2_(%struct.State* nonnull %0, i64 %312, %struct.Memory* %call2_4081a5)
...
block_.L_40822f:                                  ; preds = %block_.L_4081b1
  ...
  %call2_40822f = tail call %struct.Memory* @sub_400e70._Z5timerv(%struct.State* nonnull %0, i64 %349, %struct.Memory* %call2_4081a5)
