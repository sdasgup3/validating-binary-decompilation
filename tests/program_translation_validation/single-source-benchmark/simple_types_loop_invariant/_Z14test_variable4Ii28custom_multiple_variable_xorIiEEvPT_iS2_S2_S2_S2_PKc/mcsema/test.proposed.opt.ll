...
declare %struct.Memory* @sub_40f6d0._ZN28custom_multiple_variable_xorIiE8do_shiftEiiiii(%struct.State* noalias dereferenceable(3376), i64, %struct.Memory* noalias readnone returned) local_unnamed_addr

declare %struct.Memory* @sub_40f700._Z26check_shifted_variable_sumIi28custom_multiple_variable_xorIiEEvT_S2_S2_S2_S2_(%struct.State* noalias dereferenceable(3376), i64, %struct.Memory* noalias readnone returned) local_unnamed_addr
...
entry:
  ...
  %call2_4081b5 = tail call %struct.Memory* @sub_400e60._Z11start_timerv(%struct.State* %0, i64 %89, %struct.Memory* %2)
...
block_.L_4081c1:                                  ; preds = %block_.L_40821c, %entry
  %100 = phi i64 [ %348, %block_.L_40821c ], [ %.pre, %entry ]
  ...
  br i1 %133, label %block_4081d1, label %block_.L_40823f
...
block_.L_4081df:                                  ; preds = %block_4081eb, %block_4081d1
  %143 = phi i64 [ %286, %block_4081eb ], [ %.pre6, %block_4081d1 ]
  ...
  br i1 %179, label %block_4081eb, label %block_.L_40821c
...
block_4081eb:                                     ; preds = %block_.L_4081df
  ...
  %call2_408203 = tail call %struct.Memory* @sub_40f6d0._ZN28custom_multiple_variable_xorIiE8do_shiftEiiiii(%struct.State* nonnull %0, i64 %214, %struct.Memory* %call2_4081b5)
...
block_.L_40821c:                                  ; preds = %block_.L_4081df
  ...
  %call2_40822c = tail call %struct.Memory* @sub_40f700._Z26check_shifted_variable_sumIi28custom_multiple_variable_xorIiEEvT_S2_S2_S2_S2_(%struct.State* nonnull %0, i64 %312, %struct.Memory* %call2_4081b5)
...
block_.L_40823f:                                  ; preds = %block_.L_4081c1
  ...
  %call2_40823f = tail call %struct.Memory* @sub_400e80._Z5timerv(%struct.State* nonnull %0, i64 %349, %struct.Memory* %call2_4081b5)
  ...
  %call2_408248 = tail call %struct.Memory* @sub_400820._Z13record_resultdPKc(%struct.State* nonnull %0, i64 %360, %struct.Memory* %call2_40823f)
