...
declare %struct.Memory* @sub_40fef0._ZN28custom_sub_multiple_variableIiE8do_shiftEiiiii(%struct.State* noalias dereferenceable(3376), i64, %struct.Memory* noalias readnone returned) local_unnamed_addr

declare %struct.Memory* @sub_40ff20._Z26check_shifted_variable_sumIi28custom_sub_multiple_variableIiEEvT_S2_S2_S2_S2_(%struct.State* noalias dereferenceable(3376), i64, %struct.Memory* noalias readnone returned) local_unnamed_addr
...
define %struct.Memory* @_Z14test_variable4Ii28custom_sub_multiple_variableIiEEvPT_iS2_S2_S2_S2_PKc(%struct.State* noalias, i64, %struct.Memory* noalias readnone) local_unnamed_addr #1 {
entry:
...
block_.L_407811:                                  ; preds = %block_.L_40786c, %entry
  %100 = phi i64 [ %348, %block_.L_40786c ], [ %.pre, %entry ]
...
block_.L_40782f:                                  ; preds = %block_40783b, %block_407821
  %143 = phi i64 [ %286, %block_40783b ], [ %.pre6, %block_407821 ]
...
block_40783b:                                     ; preds = %block_.L_40782f
  ...
  %call2_407853 = tail call %struct.Memory* @sub_40fef0._ZN28custom_sub_multiple_variableIiE8do_shiftEiiiii(%struct.State* nonnull %0, i64 %214, %struct.Memory* %call2_407805)
...
block_.L_40786c:                                  ; preds = %block_.L_40782f
  ...
  %call2_40787c = tail call %struct.Memory* @sub_40ff20._Z26check_shifted_variable_sumIi28custom_sub_multiple_variableIiEEvT_S2_S2_S2_S2_(%struct.State* nonnull %0, i64 %312, %struct.Memory* %call2_407805)
...
block_.L_40788f:                                  ; preds = %block_.L_407811
  ...
  %call2_40788f = tail call %struct.Memory* @sub_400e70._Z5timerv(%struct.State* nonnull %0, i64 %349, %struct.Memory* %call2_407805)
