...
block_.L_4077e1:                                  ; preds = %block_.L_40783c, %entry
  %101 = phi i64 [ %.pre, %entry ], [ %351, %block_.L_40783c ]
...
block_.L_4077ff:                                  ; preds = %block_40780b, %block_4077f1
  %144 = phi i64 [ %.pre1, %block_4077f1 ], [ %288, %block_40780b ]
...
block_.L_40783c:                                  ; preds = %block_.L_4077ff
  ...
  %call2_40784c = tail call %struct.Memory* @sub_40fef0._Z26check_shifted_variable_sumIi28custom_sub_multiple_variableIiEEvT_S2_S2_S2_S2_(%struct.State* %0, i64 %314, %struct.Memory* %MEMORY.1)
...
block_.L_40785f:                                  ; preds = %block_.L_4077e1
  ...
  %call2_40785f = tail call %struct.Memory* @sub_400e30._Z5timerv(%struct.State* %0, i64 %352, %struct.Memory* %MEMORY.0)
  ...
  %call2_407868 = tail call %struct.Memory* @sub_4007d0._Z13record_resultdPKc(%struct.State* %0, i64 %363, %struct.Memory* %call2_40785f)
