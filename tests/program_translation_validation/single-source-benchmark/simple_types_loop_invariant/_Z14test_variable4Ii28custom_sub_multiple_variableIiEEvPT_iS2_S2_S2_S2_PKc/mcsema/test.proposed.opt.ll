...
declare %struct.Memory* @sub_40ff00._ZN28custom_sub_multiple_variableIiE8do_shiftEiiiii(%struct.State* noalias dereferenceable(3376), i64, %struct.Memory* noalias readnone returned) local_unnamed_addr

declare %struct.Memory* @sub_40ff30._Z26check_shifted_variable_sumIi28custom_sub_multiple_variableIiEEvT_S2_S2_S2_S2_(%struct.State* noalias dereferenceable(3376), i64, %struct.Memory* noalias readnone returned) local_unnamed_addr
...
entry:
  ...
  %call2_407815 = tail call %struct.Memory* @sub_400e60._Z11start_timerv(%struct.State* %0, i64 %89, %struct.Memory* %2)
...
block_.L_407821:                                  ; preds = %block_.L_40787c, %entry
  %100 = phi i64 [ %348, %block_.L_40787c ], [ %.pre, %entry ]
  ...
  br i1 %133, label %block_407831, label %block_.L_40789f
...
block_.L_40783f:                                  ; preds = %block_40784b, %block_407831
  %143 = phi i64 [ %286, %block_40784b ], [ %.pre6, %block_407831 ]
  ...
  br i1 %179, label %block_40784b, label %block_.L_40787c
...
block_40784b:                                     ; preds = %block_.L_40783f
  ...
  %call2_407863 = tail call %struct.Memory* @sub_40ff00._ZN28custom_sub_multiple_variableIiE8do_shiftEiiiii(%struct.State* nonnull %0, i64 %214, %struct.Memory* %call2_407815)
...
block_.L_40787c:                                  ; preds = %block_.L_40783f
  ...
  %call2_40788c = tail call %struct.Memory* @sub_40ff30._Z26check_shifted_variable_sumIi28custom_sub_multiple_variableIiEEvT_S2_S2_S2_S2_(%struct.State* nonnull %0, i64 %312, %struct.Memory* %call2_407815)
...
block_.L_40789f:                                  ; preds = %block_.L_407821
  ...
  %call2_40789f = tail call %struct.Memory* @sub_400e80._Z5timerv(%struct.State* nonnull %0, i64 %349, %struct.Memory* %call2_407815)
  ...
  %call2_4078a8 = tail call %struct.Memory* @sub_400820._Z13record_resultdPKc(%struct.State* nonnull %0, i64 %360, %struct.Memory* %call2_40789f)
