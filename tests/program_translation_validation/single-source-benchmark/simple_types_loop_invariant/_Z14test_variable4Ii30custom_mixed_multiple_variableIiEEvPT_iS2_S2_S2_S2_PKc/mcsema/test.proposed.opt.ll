...
declare %struct.Memory* @sub_40fa80._Z26check_shifted_variable_sumIi30custom_mixed_multiple_variableIiEEvT_S2_S2_S2_S2_(%struct.State* noalias dereferenceable(3376), i64, %struct.Memory* noalias readnone returned) local_unnamed_addr
...
entry:
  ...
  %call2_407d25 = tail call %struct.Memory* @sub_400e10._Z11start_timerv(%struct.State* %0, i64 %90, %struct.Memory* %2)
...
block_.L_407d31:                                  ; preds = %block_.L_407d8c, %entry
  %101 = phi i64 [ %.pre, %entry ], [ %351, %block_.L_407d8c ]
  %MEMORY.0 = phi %struct.Memory* [ %call2_407d25, %entry ], [ %call2_407d9c, %block_.L_407d8c ]
  ...
  br i1 %134, label %block_407d41, label %block_.L_407daf

block_407d41:                                     ; preds = %block_.L_407d31
  %136 = add i64 %102, -36
  %137 = add i64 %135, 7
...
block_.L_407d4f:                                  ; preds = %block_407d5b, %block_407d41
  %144 = phi i64 [ %.pre1, %block_407d41 ], [ %288, %block_407d5b ]
  %MEMORY.1 = phi %struct.Memory* [ %MEMORY.0, %block_407d41 ], [ %call2_407d73, %block_407d5b ]
  ...
  br i1 %180, label %block_407d5b, label %block_.L_407d8c

block_407d5b:                                     ; preds = %block_.L_407d4f
  %182 = add i64 %145, -8
  %183 = add i64 %181, 4
  ...
  %call2_407d73 = tail call %struct.Memory* @sub_40fa50._ZN30custom_mixed_multiple_variableIiE8do_shiftEiiiii(%struct.State* %0, i64 %215, %struct.Memory* %MEMORY.1)
...
block_.L_407d8c:                                  ; preds = %block_.L_407d4f
  %289 = add i64 %145, -36
  %290 = add i64 %181, 3
  ...
  %call2_407d9c = tail call %struct.Memory* @sub_40fa80._Z26check_shifted_variable_sumIi30custom_mixed_multiple_variableIiEEvT_S2_S2_S2_S2_(%struct.State* %0, i64 %314, %struct.Memory* %MEMORY.1)
...
block_.L_407daf:                                  ; preds = %block_.L_407d31
  %352 = add i64 %135, -28543
  %353 = add i64 %135, 5
  ...
  %call2_407daf = tail call %struct.Memory* @sub_400e30._Z5timerv(%struct.State* %0, i64 %352, %struct.Memory* %MEMORY.0)
  ...
  %call2_407db8 = tail call %struct.Memory* @sub_4007d0._Z13record_resultdPKc(%struct.State* %0, i64 %363, %struct.Memory* %call2_407daf)
  ...
  ret %struct.Memory* %call2_407db8
}
...
define %struct.Memory* @routine_jge_.L_407daf(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i8* %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
...
define %struct.Memory* @routine_jge_.L_407d8c(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i8* %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 2, i32 9
...
define %struct.Memory* @routine_jmpq_.L_407d4f(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
...
define %struct.Memory* @routine_callq_._Z26check_shifted_variable_sumIi30custom_mixed_multiple_variableIiEEvT_S2_S2_S2_S2_(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
...
define %struct.Memory* @routine_jmpq_.L_407d31(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
