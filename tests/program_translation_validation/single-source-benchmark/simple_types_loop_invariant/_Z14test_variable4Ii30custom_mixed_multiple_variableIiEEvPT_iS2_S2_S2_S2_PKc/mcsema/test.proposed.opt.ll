...
declare %struct.Memory* @sub_40fab0._Z26check_shifted_variable_sumIi30custom_mixed_multiple_variableIiEEvT_S2_S2_S2_S2_(%struct.State* noalias dereferenceable(3376), i64, %struct.Memory* noalias readnone returned) local_unnamed_addr
...
define %struct.Memory* @_Z14test_variable4Ii30custom_mixed_multiple_variableIiEEvPT_iS2_S2_S2_S2_PKc(%struct.State* noalias, i64, %struct.Memory* noalias readnone) local_unnamed_addr #1 {
entry:
...
block_.L_407d61:                                  ; preds = %block_.L_407dbc, %entry
  %100 = phi i64 [ %348, %block_.L_407dbc ], [ %.pre, %entry ]
...
block_.L_407d7f:                                  ; preds = %block_407d8b, %block_407d71
  %143 = phi i64 [ %286, %block_407d8b ], [ %.pre6, %block_407d71 ]
...
block_407d8b:                                     ; preds = %block_.L_407d7f
  ...
  %call2_407da3 = tail call %struct.Memory* @sub_40fa80._ZN30custom_mixed_multiple_variableIiE8do_shiftEiiiii(%struct.State* nonnull %0, i64 %214, %struct.Memory* %call2_407d55)
...
block_.L_407dbc:                                  ; preds = %block_.L_407d7f
  ...
  %call2_407dcc = tail call %struct.Memory* @sub_40fab0._Z26check_shifted_variable_sumIi30custom_mixed_multiple_variableIiEEvT_S2_S2_S2_S2_(%struct.State* nonnull %0, i64 %312, %struct.Memory* %call2_407d55)
...
block_.L_407ddf:                                  ; preds = %block_.L_407d61
  ...
  %call2_407ddf = tail call %struct.Memory* @sub_400e70._Z5timerv(%struct.State* nonnull %0, i64 %349, %struct.Memory* %call2_407d55)
