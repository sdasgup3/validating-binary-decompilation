...
block_.L_407b91:                                  ; preds = %block_.L_407bec, %entry
  %101 = phi i64 [ %.pre, %entry ], [ %349, %block_.L_407bec ]
...
block_.L_407baf:                                  ; preds = %block_407bbb, %block_407ba1
  %144 = phi i64 [ %.pre1, %block_407ba1 ], [ %287, %block_407bbb ]
...
block_.L_407bec:                                  ; preds = %block_.L_407baf
  ...
  %call2_407bfc = tail call %struct.Memory* @sub_40fbe0._Z26check_shifted_variable_sumIi31custom_divide_multiple_variableIiEEvT_S2_S2_S2_S2_(%struct.State* %0, i64 %313, %struct.Memory* %MEMORY.1)
...
block_.L_407c0f:                                  ; preds = %block_.L_407b91
  ...
  %call2_407c0f = tail call %struct.Memory* @sub_400e30._Z5timerv(%struct.State* %0, i64 %350, %struct.Memory* %MEMORY.0)
  ...
  %call2_407c18 = tail call %struct.Memory* @sub_4007d0._Z13record_resultdPKc(%struct.State* %0, i64 %361, %struct.Memory* %call2_407c0f)
