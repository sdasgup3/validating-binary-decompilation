...
declare %struct.Memory* @sub_40fbe0._ZN31custom_divide_multiple_variableIiE8do_shiftEiiiii(%struct.State* noalias dereferenceable(3376), i64, %struct.Memory* noalias readnone returned) local_unnamed_addr

declare %struct.Memory* @sub_40fc10._Z26check_shifted_variable_sumIi31custom_divide_multiple_variableIiEEvT_S2_S2_S2_S2_(%struct.State* noalias dereferenceable(3376), i64, %struct.Memory* noalias readnone returned) local_unnamed_addr
...
define %struct.Memory* @_Z14test_variable4Ii31custom_divide_multiple_variableIiEEvPT_iS2_S2_S2_S2_PKc(%struct.State* noalias, i64, %struct.Memory* noalias readnone) local_unnamed_addr #1 {
entry:
...
block_.L_407bc1:                                  ; preds = %block_.L_407c1c, %entry
  %100 = phi i64 [ %348, %block_.L_407c1c ], [ %.pre, %entry ]
...
block_.L_407bdf:                                  ; preds = %block_407beb, %block_407bd1
  %143 = phi i64 [ %286, %block_407beb ], [ %.pre6, %block_407bd1 ]
...
block_407beb:                                     ; preds = %block_.L_407bdf
  ...
  %call2_407c03 = tail call %struct.Memory* @sub_40fbe0._ZN31custom_divide_multiple_variableIiE8do_shiftEiiiii(%struct.State* nonnull %0, i64 %214, %struct.Memory* %call2_407bb5)
...
block_.L_407c1c:                                  ; preds = %block_.L_407bdf
  ...
  %call2_407c2c = tail call %struct.Memory* @sub_40fc10._Z26check_shifted_variable_sumIi31custom_divide_multiple_variableIiEEvT_S2_S2_S2_S2_(%struct.State* nonnull %0, i64 %312, %struct.Memory* %call2_407bb5)
...
block_.L_407c3f:                                  ; preds = %block_.L_407bc1
  ...
  %call2_407c3f = tail call %struct.Memory* @sub_400e70._Z5timerv(%struct.State* nonnull %0, i64 %349, %struct.Memory* %call2_407bb5)
