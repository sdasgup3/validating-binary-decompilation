; ModuleID = '/tmp/tmp5md6k8l7-query.ll'
...
define %struct.Memory* @_Z14test_variable4Ii31custom_divide_multiple_variableIiEEvPT_iS2_S2_S2_S2_PKc(%struct.State* noalias, i64, %struct.Memory* noalias readnone returned) local_unnamed_addr #1 {
entry:
  %var_2_3 = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %RBP.i = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 15, i32 0, i32 0
  %var_2_88 = load i64, i64* %var_2_3, align 8
  %var_2_89 = add i64 %var_2_88, -28005
  %call2_407bc5 = tail call %struct.Memory* @sub_400e60._Z11start_timerv(%struct.State* %0, i64 %var_2_89, %struct.Memory* %2)
  ...
  br i1 %var_2_13315, label %block_407be1.preheader, label %block_.L_407c4f

block_407be1.preheader:                           ; preds = %entry
  ...
  br i1 %var_2_179, label %block_.L_407bef.preheader, label %block_407be1.preheader5

block_407be1.preheader5:                          ; preds = %block_407be1.preheader
  br label %block_407be1

block_.L_407bef.preheader:                        ; preds = %block_407be1.preheader
  br label %block_.L_407bef

block_407be1:                                     ; preds = %block_407be1.preheader5, %block_407be1
  br label %block_407be1

block_.L_407bef:                                  ; preds = %block_.L_407bef.preheader, %block_.L_407bef
  br label %block_.L_407bef

block_.L_407c4f:                                  ; preds = %entry
  %.pre = load i64, i64* %var_2_3, align 8
  %var_2_349 = add i64 %.pre, -27985
  %call2_407c4f = tail call %struct.Memory* @sub_400e80._Z5timerv(%struct.State* nonnull %0, i64 %var_2_349, %struct.Memory* %call2_407bc5)
  %var_2_356 = load i64, i64* %var_2_3, align 8
  %var_2_360 = add i64 %var_2_356, -29748
  %call2_407c58 = tail call %struct.Memory* @sub_400820._Z13record_resultdPKc(%struct.State* nonnull %0, i64 %var_2_360, %struct.Memory* %call2_407c4f)
