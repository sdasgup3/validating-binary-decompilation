...
block_.L_407c61:                                  ; preds = %block_.L_407cbc, %entry
  %101 = phi i64 [ %.pre, %entry ], [ %349, %block_.L_407cbc ]
...
block_.L_407c7f:                                  ; preds = %block_407c8b, %block_407c71
  %144 = phi i64 [ %.pre1, %block_407c71 ], [ %287, %block_407c8b ]
...
block_.L_407cbc:                                  ; preds = %block_.L_407c7f
  ...
  %call2_407ccc = tail call %struct.Memory* @sub_40fb30._Z26check_shifted_variable_sumIi32custom_divide_multiple_variable2IiEEvT_S2_S2_S2_S2_(%struct.State* %0, i64 %313, %struct.Memory* %MEMORY.1)
...
block_.L_407cdf:                                  ; preds = %block_.L_407c61
  ...
  %call2_407cdf = tail call %struct.Memory* @sub_400e30._Z5timerv(%struct.State* %0, i64 %350, %struct.Memory* %MEMORY.0)
  ...
  %call2_407ce8 = tail call %struct.Memory* @sub_4007d0._Z13record_resultdPKc(%struct.State* %0, i64 %361, %struct.Memory* %call2_407cdf)
