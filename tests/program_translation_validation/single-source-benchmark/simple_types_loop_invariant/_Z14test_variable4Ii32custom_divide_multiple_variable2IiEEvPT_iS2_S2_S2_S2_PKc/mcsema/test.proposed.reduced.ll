; ModuleID = '/tmp/tmpdiv2ysg8-query.ll'
...
define %struct.Memory* @_Z14test_variable4Ii32custom_divide_multiple_variable2IiEEvPT_iS2_S2_S2_S2_PKc(%struct.State* noalias, i64, %struct.Memory* noalias readnone returned) local_unnamed_addr #1 {
entry:
  %var_2_3 = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %RBP.i = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 15, i32 0, i32 0
  %var_2_88 = load i64, i64* %var_2_3, align 8
  %var_2_89 = add i64 %var_2_88, -28213
  %call2_407c95 = tail call %struct.Memory* @sub_400e60._Z11start_timerv(%struct.State* %0, i64 %var_2_89, %struct.Memory* %2)
  ...
  br i1 %var_2_13315, label %block_407cb1.preheader, label %block_.L_407d1f

block_407cb1.preheader:                           ; preds = %entry
  ...
  br i1 %var_2_179, label %block_.L_407cbf.preheader, label %block_407cb1.preheader5

block_407cb1.preheader5:                          ; preds = %block_407cb1.preheader
  br label %block_407cb1

block_.L_407cbf.preheader:                        ; preds = %block_407cb1.preheader
  br label %block_.L_407cbf

block_407cb1:                                     ; preds = %block_407cb1.preheader5, %block_407cb1
  br label %block_407cb1

block_.L_407cbf:                                  ; preds = %block_.L_407cbf.preheader, %block_.L_407cbf
  br label %block_.L_407cbf

block_.L_407d1f:                                  ; preds = %entry
  %.pre = load i64, i64* %var_2_3, align 8
  %var_2_349 = add i64 %.pre, -28193
  %call2_407d1f = tail call %struct.Memory* @sub_400e80._Z5timerv(%struct.State* nonnull %0, i64 %var_2_349, %struct.Memory* %call2_407c95)
  %var_2_356 = load i64, i64* %var_2_3, align 8
  %var_2_360 = add i64 %var_2_356, -29956
  %call2_407d28 = tail call %struct.Memory* @sub_400820._Z13record_resultdPKc(%struct.State* nonnull %0, i64 %var_2_360, %struct.Memory* %call2_407d1f)
