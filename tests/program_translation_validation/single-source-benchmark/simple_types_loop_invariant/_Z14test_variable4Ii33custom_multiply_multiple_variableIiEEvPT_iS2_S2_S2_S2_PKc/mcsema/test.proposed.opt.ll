...
declare %struct.Memory* @sub_40fdc0._ZN33custom_multiply_multiple_variableIiE8do_shiftEiiiii(%struct.State* dereferenceable(3376), i64, %struct.Memory*) local_unnamed_addr

declare %struct.Memory* @sub_40fdf0._Z26check_shifted_variable_sumIi33custom_multiply_multiple_variableIiEEvT_S2_S2_S2_S2_(%struct.State* dereferenceable(3376), i64, %struct.Memory*) local_unnamed_addr
...
block_.L_407981:                                  ; preds = %block_.L_4079dc, %entry
  %100 = phi i64 [ %.pre, %entry ], [ %348, %block_.L_4079dc ]
  %MEMORY.0 = phi %struct.Memory* [ %call2_407975, %entry ], [ %call2_4079ec, %block_.L_4079dc ]
...
block_.L_40799f:                                  ; preds = %block_4079ab, %block_407991
  %143 = phi i64 [ %.pre6, %block_407991 ], [ %286, %block_4079ab ]
  %MEMORY.1 = phi %struct.Memory* [ %MEMORY.0, %block_407991 ], [ %call2_4079c3, %block_4079ab ]
...
block_4079ab:                                     ; preds = %block_.L_40799f
  ...
  %call2_4079c3 = tail call %struct.Memory* @sub_40fdc0._ZN33custom_multiply_multiple_variableIiE8do_shiftEiiiii(%struct.State* nonnull %0, i64 %214, %struct.Memory* %MEMORY.1)
...
block_.L_4079dc:                                  ; preds = %block_.L_40799f
  ...
  %call2_4079ec = tail call %struct.Memory* @sub_40fdf0._Z26check_shifted_variable_sumIi33custom_multiply_multiple_variableIiEEvT_S2_S2_S2_S2_(%struct.State* nonnull %0, i64 %312, %struct.Memory* %MEMORY.1)
...
block_.L_4079ff:                                  ; preds = %block_.L_407981
  ...
  %call2_4079ff = tail call %struct.Memory* @sub_400e70._Z5timerv(%struct.State* nonnull %0, i64 %349, %struct.Memory* %MEMORY.0)
