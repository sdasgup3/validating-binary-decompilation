...
block_.L_407951:                                  ; preds = %block_.L_4079ac, %entry
  %101 = phi i64 [ %.pre, %entry ], [ %349, %block_.L_4079ac ]
...
block_.L_40796f:                                  ; preds = %block_40797b, %block_407961
  %144 = phi i64 [ %.pre1, %block_407961 ], [ %287, %block_40797b ]
...
block_.L_4079ac:                                  ; preds = %block_.L_40796f
  ...
  %call2_4079bc = tail call %struct.Memory* @sub_40fdc0._Z26check_shifted_variable_sumIi33custom_multiply_multiple_variableIiEEvT_S2_S2_S2_S2_(%struct.State* %0, i64 %313, %struct.Memory* %MEMORY.1)
...
block_.L_4079cf:                                  ; preds = %block_.L_407951
  ...
  %call2_4079cf = tail call %struct.Memory* @sub_400e30._Z5timerv(%struct.State* %0, i64 %350, %struct.Memory* %MEMORY.0)
  ...
  %call2_4079d8 = tail call %struct.Memory* @sub_4007d0._Z13record_resultdPKc(%struct.State* %0, i64 %361, %struct.Memory* %call2_4079cf)
