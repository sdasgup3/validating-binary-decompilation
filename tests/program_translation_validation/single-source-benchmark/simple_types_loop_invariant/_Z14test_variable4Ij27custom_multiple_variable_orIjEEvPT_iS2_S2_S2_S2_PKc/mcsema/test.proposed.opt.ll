...
block_.L_408d81:                                  ; preds = %block_.L_408ddc, %entry
  %101 = phi i64 [ %.pre, %entry ], [ %351, %block_.L_408ddc ]
...
block_.L_408d9f:                                  ; preds = %block_408dab, %block_408d91
  %144 = phi i64 [ %.pre1, %block_408d91 ], [ %288, %block_408dab ]
...
block_.L_408ddc:                                  ; preds = %block_.L_408d9f
  ...
  %call2_408dec = tail call %struct.Memory* @sub_40ed10._Z26check_shifted_variable_sumIj27custom_multiple_variable_orIjEEvT_S2_S2_S2_S2_(%struct.State* %0, i64 %314, %struct.Memory* %MEMORY.1)
...
block_.L_408dff:                                  ; preds = %block_.L_408d81
  ...
  %call2_408dff = tail call %struct.Memory* @sub_400e30._Z5timerv(%struct.State* %0, i64 %352, %struct.Memory* %MEMORY.0)
  ...
  %call2_408e08 = tail call %struct.Memory* @sub_4007d0._Z13record_resultdPKc(%struct.State* %0, i64 %363, %struct.Memory* %call2_408dff)
