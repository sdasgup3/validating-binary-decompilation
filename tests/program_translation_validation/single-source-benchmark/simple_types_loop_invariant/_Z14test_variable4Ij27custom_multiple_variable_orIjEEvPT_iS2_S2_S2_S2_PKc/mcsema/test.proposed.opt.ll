...
declare %struct.Memory* @sub_40ed50._Z26check_shifted_variable_sumIj27custom_multiple_variable_orIjEEvT_S2_S2_S2_S2_(%struct.State* noalias dereferenceable(3376), i64, %struct.Memory* noalias readnone returned) local_unnamed_addr
...
entry:
  ...
  %call2_408db5 = tail call %struct.Memory* @sub_400e60._Z11start_timerv(%struct.State* %0, i64 %89, %struct.Memory* %2)
...
block_.L_408dc1:                                  ; preds = %block_.L_408e1c, %entry
  %100 = phi i64 [ %348, %block_.L_408e1c ], [ %.pre, %entry ]
  ...
  br i1 %133, label %block_408dd1, label %block_.L_408e3f
...
block_.L_408ddf:                                  ; preds = %block_408deb, %block_408dd1
  %143 = phi i64 [ %286, %block_408deb ], [ %.pre6, %block_408dd1 ]
  ...
  br i1 %179, label %block_408deb, label %block_.L_408e1c
...
block_408deb:                                     ; preds = %block_.L_408ddf
  ...
  %call2_408e03 = tail call %struct.Memory* @sub_40ed20._ZN27custom_multiple_variable_orIjE8do_shiftEjjjjj(%struct.State* nonnull %0, i64 %214, %struct.Memory* %call2_408db5)
...
block_.L_408e1c:                                  ; preds = %block_.L_408ddf
  ...
  %call2_408e2c = tail call %struct.Memory* @sub_40ed50._Z26check_shifted_variable_sumIj27custom_multiple_variable_orIjEEvT_S2_S2_S2_S2_(%struct.State* nonnull %0, i64 %312, %struct.Memory* %call2_408db5)
...
block_.L_408e3f:                                  ; preds = %block_.L_408dc1
  ...
  %call2_408e3f = tail call %struct.Memory* @sub_400e80._Z5timerv(%struct.State* nonnull %0, i64 %349, %struct.Memory* %call2_408db5)
  ...
  %call2_408e48 = tail call %struct.Memory* @sub_400820._Z13record_resultdPKc(%struct.State* nonnull %0, i64 %360, %struct.Memory* %call2_408e3f)
