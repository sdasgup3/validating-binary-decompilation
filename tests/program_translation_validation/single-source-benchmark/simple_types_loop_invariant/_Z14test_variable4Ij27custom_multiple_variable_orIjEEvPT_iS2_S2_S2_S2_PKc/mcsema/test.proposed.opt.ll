...
declare %struct.Memory* @sub_40ed10._Z26check_shifted_variable_sumIj27custom_multiple_variable_orIjEEvT_S2_S2_S2_S2_(%struct.State* noalias dereferenceable(3376), i64, %struct.Memory* noalias readnone returned) local_unnamed_addr
...
entry:
  ...
  %call2_408d75 = tail call %struct.Memory* @sub_400e10._Z11start_timerv(%struct.State* %0, i64 %90, %struct.Memory* %2)
...
block_.L_408d81:                                  ; preds = %block_.L_408ddc, %entry
  %101 = phi i64 [ %.pre, %entry ], [ %349, %block_.L_408ddc ]
  %MEMORY.0 = phi %struct.Memory* [ %call2_408d75, %entry ], [ %call2_408dec, %block_.L_408ddc ]
  ...
  br i1 %134, label %block_408d91, label %block_.L_408dff

block_408d91:                                     ; preds = %block_.L_408d81
  %136 = add i64 %102, -36
  %137 = add i64 %135, 7
...
block_.L_408d9f:                                  ; preds = %block_408dab, %block_408d91
  %144 = phi i64 [ %.pre1, %block_408d91 ], [ %287, %block_408dab ]
  %MEMORY.1 = phi %struct.Memory* [ %MEMORY.0, %block_408d91 ], [ %call2_408dc3, %block_408dab ]
  ...
  br i1 %180, label %block_408dab, label %block_.L_408ddc

block_408dab:                                     ; preds = %block_.L_408d9f
  %182 = add i64 %145, -8
  %183 = add i64 %181, 4
  ...
  %call2_408dc3 = tail call %struct.Memory* @sub_40ece0._ZN27custom_multiple_variable_orIjE8do_shiftEjjjjj(%struct.State* %0, i64 %215, %struct.Memory* %MEMORY.1)
...
block_.L_408ddc:                                  ; preds = %block_.L_408d9f
  %288 = add i64 %145, -36
  %289 = add i64 %181, 3
  ...
  %call2_408dec = tail call %struct.Memory* @sub_40ed10._Z26check_shifted_variable_sumIj27custom_multiple_variable_orIjEEvT_S2_S2_S2_S2_(%struct.State* %0, i64 %313, %struct.Memory* %MEMORY.1)
...
block_.L_408dff:                                  ; preds = %block_.L_408d81
  %350 = add i64 %135, -32719
  %351 = add i64 %135, 5
  ...
  %call2_408dff = tail call %struct.Memory* @sub_400e30._Z5timerv(%struct.State* %0, i64 %350, %struct.Memory* %MEMORY.0)
  ...
  %call2_408e08 = tail call %struct.Memory* @sub_4007d0._Z13record_resultdPKc(%struct.State* %0, i64 %361, %struct.Memory* %call2_408dff)
  ...
  ret %struct.Memory* %call2_408e08
}
...
define %struct.Memory* @routine_jge_.L_408dff(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i8* %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
...
define %struct.Memory* @routine_jge_.L_408ddc(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i8* %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 2, i32 9
...
define %struct.Memory* @routine_callq_._Z26check_shifted_variable_sumIj27custom_multiple_variable_orIjEEvT_S2_S2_S2_S2_(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
...
define %struct.Memory* @routine_jmpq_.L_408d81(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
