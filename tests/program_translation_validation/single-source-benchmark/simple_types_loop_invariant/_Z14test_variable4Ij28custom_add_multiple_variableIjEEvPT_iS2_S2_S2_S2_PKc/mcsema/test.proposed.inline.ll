...
define %struct.Memory* @_Z14test_variable4Ij28custom_add_multiple_variableIjEEvPT_iS2_S2_S2_S2_PKc(%struct.State* noalias, i64, %struct.Memory* noalias) #2 {
entry:
  ...
  store %struct.Memory* %loadMem_4083f0, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_4083f3, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_4083fd, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem1_408405, %struct.Memory** %MEMORY
  ...
  store i32 0, i32* %216
  store %struct.Memory* %loadMem_40840a, %struct.Memory** %MEMORY
  br label %block_.L_408411

block_.L_408411:                                  ; preds = %block_.L_40846c, %entry
  ...
  store %struct.Memory* %loadMem_40841b, %struct.Memory** %MEMORY
...
block_408421:                                     ; preds = %block_.L_408411
...
block_.L_40842f:                                  ; preds = %block_40843b, %block_408421
...
block_40843b:                                     ; preds = %block_.L_40842f
  ...
  store %struct.Memory* %loadMem_40844c, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem1_408453, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_40845b, %struct.Memory** %MEMORY
...
block_.L_40846c:                                  ; preds = %block_.L_40842f
  ...
  store %struct.Memory* %loadMem1_40847c, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_408484, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_40848a, %struct.Memory** %MEMORY
  br label %block_.L_408411

block_.L_40848f:                                  ; preds = %block_.L_408411
  ...
  store %struct.Memory* %loadMem1_40848f, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem1_408498, %struct.Memory** %MEMORY
  ...
  ret %struct.Memory* %loadMem_4084a2
}
