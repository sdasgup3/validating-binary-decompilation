...
declare %struct.Memory* @sub_40f580._Z26check_shifted_variable_sumIj28custom_add_multiple_variableIjEEvT_S2_S2_S2_S2_(%struct.State* noalias dereferenceable(3376), i64, %struct.Memory* noalias readnone returned) local_unnamed_addr
...
define %struct.Memory* @_Z14test_variable4Ij28custom_add_multiple_variableIjEEvPT_iS2_S2_S2_S2_PKc(%struct.State* noalias, i64, %struct.Memory* noalias) local_unnamed_addr #1 {
entry:
  ...
  %call2_4083d5 = tail call %struct.Memory* @sub_400e10._Z11start_timerv(%struct.State* %0, i64 %90, %struct.Memory* %2)
...
block_.L_4083e1:                                  ; preds = %block_.L_40843c, %entry
  %101 = phi i64 [ %.pre, %entry ], [ %349, %block_.L_40843c ]
  %MEMORY.0 = phi %struct.Memory* [ %call2_4083d5, %entry ], [ %call2_40844c, %block_.L_40843c ]
  ...
  br i1 %134, label %block_4083f1, label %block_.L_40845f
...
block_.L_4083ff:                                  ; preds = %block_40840b, %block_4083f1
  %144 = phi i64 [ %.pre1, %block_4083f1 ], [ %287, %block_40840b ]
  %MEMORY.1 = phi %struct.Memory* [ %MEMORY.0, %block_4083f1 ], [ %call2_408423, %block_40840b ]
  ...
  br i1 %180, label %block_40840b, label %block_.L_40843c
...
block_40840b:                                     ; preds = %block_.L_4083ff
  ...
  %call2_408423 = tail call %struct.Memory* @sub_40f550._ZN28custom_add_multiple_variableIjE8do_shiftEjjjjj(%struct.State* %0, i64 %215, %struct.Memory* %MEMORY.1)
...
block_.L_40843c:                                  ; preds = %block_.L_4083ff
  ...
  %call2_40844c = tail call %struct.Memory* @sub_40f580._Z26check_shifted_variable_sumIj28custom_add_multiple_variableIjEEvT_S2_S2_S2_S2_(%struct.State* %0, i64 %313, %struct.Memory* %MEMORY.1)
...
block_.L_40845f:                                  ; preds = %block_.L_4083e1
  ...
  %call2_40845f = tail call %struct.Memory* @sub_400e30._Z5timerv(%struct.State* %0, i64 %350, %struct.Memory* %MEMORY.0)
  ...
  %call2_408468 = tail call %struct.Memory* @sub_4007d0._Z13record_resultdPKc(%struct.State* %0, i64 %361, %struct.Memory* %call2_40845f)
  ...
  ret %struct.Memory* %call2_408468
}
...
define %struct.Memory* @routine_jge_.L_40845f(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i8* %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
...
define %struct.Memory* @routine_jge_.L_40843c(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i8* %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 2, i32 9
...
define %struct.Memory* @routine_jmpq_.L_4083ff(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
...
define %struct.Memory* @routine_callq_._Z26check_shifted_variable_sumIj28custom_add_multiple_variableIjEEvT_S2_S2_S2_S2_(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
...
define %struct.Memory* @routine_jmpq_.L_4083e1(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
