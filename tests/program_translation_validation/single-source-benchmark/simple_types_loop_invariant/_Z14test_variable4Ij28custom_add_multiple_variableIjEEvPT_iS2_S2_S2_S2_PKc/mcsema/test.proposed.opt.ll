...
block_.L_4083e1:                                  ; preds = %block_.L_40843c, %entry
  %101 = phi i64 [ %.pre, %entry ], [ %351, %block_.L_40843c ]
...
block_.L_4083ff:                                  ; preds = %block_40840b, %block_4083f1
  %144 = phi i64 [ %.pre1, %block_4083f1 ], [ %288, %block_40840b ]
...
block_.L_40843c:                                  ; preds = %block_.L_4083ff
  ...
  %call2_40844c = tail call %struct.Memory* @sub_40f580._Z26check_shifted_variable_sumIj28custom_add_multiple_variableIjEEvT_S2_S2_S2_S2_(%struct.State* %0, i64 %314, %struct.Memory* %MEMORY.1)
...
block_.L_40845f:                                  ; preds = %block_.L_4083e1
  ...
  %call2_40845f = tail call %struct.Memory* @sub_400e30._Z5timerv(%struct.State* %0, i64 %352, %struct.Memory* %MEMORY.0)
  ...
  %call2_408468 = tail call %struct.Memory* @sub_4007d0._Z13record_resultdPKc(%struct.State* %0, i64 %363, %struct.Memory* %call2_40845f)
