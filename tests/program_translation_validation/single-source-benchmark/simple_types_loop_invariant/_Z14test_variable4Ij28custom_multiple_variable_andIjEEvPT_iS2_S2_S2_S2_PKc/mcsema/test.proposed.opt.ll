...
block_.L_408c11:                                  ; preds = %block_.L_408c6c, %entry
  %101 = phi i64 [ %.pre, %entry ], [ %349, %block_.L_408c6c ]
...
block_.L_408c2f:                                  ; preds = %block_408c3b, %block_408c21
  %144 = phi i64 [ %.pre1, %block_408c21 ], [ %287, %block_408c3b ]
...
block_.L_408c6c:                                  ; preds = %block_.L_408c2f
  ...
  %call2_408c7c = tail call %struct.Memory* @sub_40ee50._Z26check_shifted_variable_sumIj28custom_multiple_variable_andIjEEvT_S2_S2_S2_S2_(%struct.State* %0, i64 %313, %struct.Memory* %MEMORY.1)
...
block_.L_408c8f:                                  ; preds = %block_.L_408c11
  ...
  %call2_408c8f = tail call %struct.Memory* @sub_400e30._Z5timerv(%struct.State* %0, i64 %350, %struct.Memory* %MEMORY.0)
  ...
  %call2_408c98 = tail call %struct.Memory* @sub_4007d0._Z13record_resultdPKc(%struct.State* %0, i64 %361, %struct.Memory* %call2_408c8f)
