...
define %struct.Memory* @_Z14test_variable4Ij28custom_multiple_variable_xorIjEEvPT_iS2_S2_S2_S2_PKc(%struct.State* noalias, i64, %struct.Memory* noalias) #2 {
entry:
  ...
  store %struct.Memory* %loadMem_408ef4, %struct.Memory** %MEMORY
  ...
  store i64 %93, i64* %96
  store %struct.Memory* %loadMem_408efc, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_408f09, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem1_408f15, %struct.Memory** %MEMORY
  ...
  store i32 0, i32* %216
  store %struct.Memory* %loadMem_408f1a, %struct.Memory** %MEMORY
...
block_.L_408f21:                                  ; preds = %block_.L_408f7c, %entry
  ...
  store %struct.Memory* %loadMem_408f21, %struct.Memory** %MEMORY
...
block_408f31:                                     ; preds = %block_.L_408f21
  ...
  store i32 0, i32* %304
  store %struct.Memory* %loadMem_408f31, %struct.Memory** %MEMORY
  ...
  store i32 0, i32* %315
  store %struct.Memory* %loadMem_408f38, %struct.Memory** %MEMORY
...
block_.L_408f3f:                                  ; preds = %block_408f4b, %block_408f31
  ...
  store %struct.Memory* %loadMem_408f45, %struct.Memory** %MEMORY
...
block_408f4b:                                     ; preds = %block_.L_408f3f
  ...
  store %struct.Memory* %loadMem_408f4f, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_408f56, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_408f5f, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem1_408f63, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_408f6b, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_408f6e, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_408f71, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_408f74, %struct.Memory** %MEMORY
...
block_.L_408f7c:                                  ; preds = %block_.L_408f3f
  ...
  store %struct.Memory* %loadMem_408f85, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem1_408f8c, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_408f9a, %struct.Memory** %MEMORY
  br label %block_.L_408f21
...
block_.L_408f9f:                                  ; preds = %block_.L_408f21
  ...
  store %struct.Memory* %loadMem1_408f9f, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem1_408fa8, %struct.Memory** %MEMORY
  ...
  ret %struct.Memory* %loadMem_408fb2
}
