...
block_.L_408ef1:                                  ; preds = %block_.L_408f4c, %entry
  %101 = phi i64 [ %.pre, %entry ], [ %349, %block_.L_408f4c ]
...
block_.L_408f0f:                                  ; preds = %block_408f1b, %block_408f01
  %144 = phi i64 [ %.pre1, %block_408f01 ], [ %287, %block_408f1b ]
...
block_.L_408f4c:                                  ; preds = %block_.L_408f0f
  ...
  %call2_408f5c = tail call %struct.Memory* @sub_40eba0._Z26check_shifted_variable_sumIj28custom_multiple_variable_xorIjEEvT_S2_S2_S2_S2_(%struct.State* %0, i64 %313, %struct.Memory* %MEMORY.1)
...
block_.L_408f6f:                                  ; preds = %block_.L_408ef1
  ...
  %call2_408f6f = tail call %struct.Memory* @sub_400e30._Z5timerv(%struct.State* %0, i64 %350, %struct.Memory* %MEMORY.0)
  ...
  %call2_408f78 = tail call %struct.Memory* @sub_4007d0._Z13record_resultdPKc(%struct.State* %0, i64 %361, %struct.Memory* %call2_408f6f)
