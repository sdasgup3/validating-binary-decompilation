...
declare %struct.Memory* @sub_40eba0._ZN28custom_multiple_variable_xorIjE8do_shiftEjjjjj(%struct.State* noalias dereferenceable(3376), i64, %struct.Memory* noalias readnone returned) local_unnamed_addr

declare %struct.Memory* @sub_40ebd0._Z26check_shifted_variable_sumIj28custom_multiple_variable_xorIjEEvT_S2_S2_S2_S2_(%struct.State* noalias dereferenceable(3376), i64, %struct.Memory* noalias readnone returned) local_unnamed_addr
...
define %struct.Memory* @_Z14test_variable4Ij28custom_multiple_variable_xorIjEEvPT_iS2_S2_S2_S2_PKc(%struct.State* noalias, i64, %struct.Memory* noalias readnone) local_unnamed_addr #1 {
entry:
...
block_.L_408f21:                                  ; preds = %block_.L_408f7c, %entry
  %100 = phi i64 [ %348, %block_.L_408f7c ], [ %.pre, %entry ]
...
block_.L_408f3f:                                  ; preds = %block_408f4b, %block_408f31
  %143 = phi i64 [ %286, %block_408f4b ], [ %.pre6, %block_408f31 ]
...
block_408f4b:                                     ; preds = %block_.L_408f3f
  ...
  %call2_408f63 = tail call %struct.Memory* @sub_40eba0._ZN28custom_multiple_variable_xorIjE8do_shiftEjjjjj(%struct.State* nonnull %0, i64 %214, %struct.Memory* %call2_408f15)
...
block_.L_408f7c:                                  ; preds = %block_.L_408f3f
  ...
  %call2_408f8c = tail call %struct.Memory* @sub_40ebd0._Z26check_shifted_variable_sumIj28custom_multiple_variable_xorIjEEvT_S2_S2_S2_S2_(%struct.State* nonnull %0, i64 %312, %struct.Memory* %call2_408f15)
...
block_.L_408f9f:                                  ; preds = %block_.L_408f21
  ...
  %call2_408f9f = tail call %struct.Memory* @sub_400e70._Z5timerv(%struct.State* nonnull %0, i64 %349, %struct.Memory* %call2_408f15)
