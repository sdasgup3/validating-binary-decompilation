...
declare %struct.Memory* @sub_40ebb0._ZN28custom_multiple_variable_xorIjE8do_shiftEjjjjj(%struct.State* noalias dereferenceable(3376), i64, %struct.Memory* noalias readnone returned) local_unnamed_addr

declare %struct.Memory* @sub_40ebe0._Z26check_shifted_variable_sumIj28custom_multiple_variable_xorIjEEvT_S2_S2_S2_S2_(%struct.State* noalias dereferenceable(3376), i64, %struct.Memory* noalias readnone returned) local_unnamed_addr
...
entry:
  ...
  %call2_408f25 = tail call %struct.Memory* @sub_400e60._Z11start_timerv(%struct.State* %0, i64 %89, %struct.Memory* %2)
  ...
  br label %block_.L_408f31

block_.L_408f31:                                  ; preds = %block_.L_408f8c, %entry
  %100 = phi i64 [ %348, %block_.L_408f8c ], [ %.pre, %entry ]
  ...
  br i1 %133, label %block_408f41, label %block_.L_408faf

block_408f41:                                     ; preds = %block_.L_408f31
  %135 = add i64 %101, -48
  %136 = add i64 %134, 7
...
block_.L_408f4f:                                  ; preds = %block_408f5b, %block_408f41
  %143 = phi i64 [ %286, %block_408f5b ], [ %.pre6, %block_408f41 ]
  ...
  br i1 %179, label %block_408f5b, label %block_.L_408f8c

block_408f5b:                                     ; preds = %block_.L_408f4f
  %181 = add i64 %144, -8
  %182 = add i64 %180, 4
  ...
  %call2_408f73 = tail call %struct.Memory* @sub_40ebb0._ZN28custom_multiple_variable_xorIjE8do_shiftEjjjjj(%struct.State* nonnull %0, i64 %214, %struct.Memory* %call2_408f25)
...
block_.L_408f8c:                                  ; preds = %block_.L_408f4f
  %287 = add i64 %144, -48
  %288 = add i64 %180, 3
  ...
  %call2_408f9c = tail call %struct.Memory* @sub_40ebe0._Z26check_shifted_variable_sumIj28custom_multiple_variable_xorIjEEvT_S2_S2_S2_S2_(%struct.State* nonnull %0, i64 %312, %struct.Memory* %call2_408f25)
...
block_.L_408faf:                                  ; preds = %block_.L_408f31
  ...
  %call2_408faf = tail call %struct.Memory* @sub_400e80._Z5timerv(%struct.State* nonnull %0, i64 %349, %struct.Memory* %call2_408f25)
  ...
  %call2_408fb8 = tail call %struct.Memory* @sub_400820._Z13record_resultdPKc(%struct.State* nonnull %0, i64 %360, %struct.Memory* %call2_408faf)
