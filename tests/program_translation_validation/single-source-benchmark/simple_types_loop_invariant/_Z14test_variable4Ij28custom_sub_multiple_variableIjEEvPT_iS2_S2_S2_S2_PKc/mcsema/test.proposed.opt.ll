...
declare %struct.Memory* @sub_40f470._Z26check_shifted_variable_sumIj28custom_sub_multiple_variableIjEEvT_S2_S2_S2_S2_(%struct.State* noalias dereferenceable(3376), i64, %struct.Memory* noalias readnone returned) local_unnamed_addr
...
define %struct.Memory* @_Z14test_variable4Ij28custom_sub_multiple_variableIjEEvPT_iS2_S2_S2_S2_PKc(%struct.State* noalias, i64, %struct.Memory* noalias readnone) local_unnamed_addr #1 {
entry:
...
block_.L_408581:                                  ; preds = %block_.L_4085dc, %entry
  %100 = phi i64 [ %348, %block_.L_4085dc ], [ %.pre, %entry ]
...
block_.L_40859f:                                  ; preds = %block_4085ab, %block_408591
  %143 = phi i64 [ %286, %block_4085ab ], [ %.pre6, %block_408591 ]
...
block_4085ab:                                     ; preds = %block_.L_40859f
  ...
  %call2_4085c3 = tail call %struct.Memory* @sub_40f440._ZN28custom_sub_multiple_variableIjE8do_shiftEjjjjj(%struct.State* nonnull %0, i64 %214, %struct.Memory* %call2_408575)
...
block_.L_4085dc:                                  ; preds = %block_.L_40859f
  ...
  %call2_4085ec = tail call %struct.Memory* @sub_40f470._Z26check_shifted_variable_sumIj28custom_sub_multiple_variableIjEEvT_S2_S2_S2_S2_(%struct.State* nonnull %0, i64 %312, %struct.Memory* %call2_408575)
...
block_.L_4085ff:                                  ; preds = %block_.L_408581
  ...
  %call2_4085ff = tail call %struct.Memory* @sub_400e70._Z5timerv(%struct.State* nonnull %0, i64 %349, %struct.Memory* %call2_408575)
