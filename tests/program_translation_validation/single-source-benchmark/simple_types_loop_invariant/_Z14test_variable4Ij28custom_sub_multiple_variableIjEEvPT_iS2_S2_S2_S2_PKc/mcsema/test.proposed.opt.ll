...
block_.L_408551:                                  ; preds = %block_.L_4085ac, %entry
  %101 = phi i64 [ %.pre, %entry ], [ %349, %block_.L_4085ac ]
...
block_.L_40856f:                                  ; preds = %block_40857b, %block_408561
  %144 = phi i64 [ %.pre1, %block_408561 ], [ %287, %block_40857b ]
...
block_.L_4085ac:                                  ; preds = %block_.L_40856f
  ...
  %call2_4085bc = tail call %struct.Memory* @sub_40f440._Z26check_shifted_variable_sumIj28custom_sub_multiple_variableIjEEvT_S2_S2_S2_S2_(%struct.State* %0, i64 %313, %struct.Memory* %MEMORY.1)
...
block_.L_4085cf:                                  ; preds = %block_.L_408551
  ...
  %call2_4085cf = tail call %struct.Memory* @sub_400e30._Z5timerv(%struct.State* %0, i64 %350, %struct.Memory* %MEMORY.0)
  ...
  %call2_4085d8 = tail call %struct.Memory* @sub_4007d0._Z13record_resultdPKc(%struct.State* %0, i64 %361, %struct.Memory* %call2_4085cf)
