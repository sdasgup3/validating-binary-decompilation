...
block_.L_408aa1:                                  ; preds = %block_.L_408afc, %entry
  %101 = phi i64 [ %.pre, %entry ], [ %349, %block_.L_408afc ]
...
block_.L_408abf:                                  ; preds = %block_408acb, %block_408ab1
  %144 = phi i64 [ %.pre1, %block_408ab1 ], [ %287, %block_408acb ]
...
block_.L_408afc:                                  ; preds = %block_.L_408abf
  ...
  %call2_408b0c = tail call %struct.Memory* @sub_40ef90._Z26check_shifted_variable_sumIj30custom_mixed_multiple_variableIjEEvT_S2_S2_S2_S2_(%struct.State* %0, i64 %313, %struct.Memory* %MEMORY.1)
...
block_.L_408b1f:                                  ; preds = %block_.L_408aa1
  ...
  %call2_408b1f = tail call %struct.Memory* @sub_400e30._Z5timerv(%struct.State* %0, i64 %350, %struct.Memory* %MEMORY.0)
  ...
  %call2_408b28 = tail call %struct.Memory* @sub_4007d0._Z13record_resultdPKc(%struct.State* %0, i64 %361, %struct.Memory* %call2_408b1f)
