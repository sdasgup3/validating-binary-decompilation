...
declare %struct.Memory* @sub_40efc0._Z26check_shifted_variable_sumIj30custom_mixed_multiple_variableIjEEvT_S2_S2_S2_S2_(%struct.State* noalias dereferenceable(3376), i64, %struct.Memory* noalias readnone returned) local_unnamed_addr
...
block_.L_408ad1:                                  ; preds = %block_.L_408b2c, %entry
  %100 = phi i64 [ %348, %block_.L_408b2c ], [ %.pre, %entry ]
...
block_.L_408aef:                                  ; preds = %block_408afb, %block_408ae1
  %143 = phi i64 [ %286, %block_408afb ], [ %.pre6, %block_408ae1 ]
...
block_408afb:                                     ; preds = %block_.L_408aef
  ...
  %call2_408b13 = tail call %struct.Memory* @sub_40ef90._ZN30custom_mixed_multiple_variableIjE8do_shiftEjjjjj(%struct.State* nonnull %0, i64 %214, %struct.Memory* %call2_408ac5)
...
block_.L_408b2c:                                  ; preds = %block_.L_408aef
  ...
  %call2_408b3c = tail call %struct.Memory* @sub_40efc0._Z26check_shifted_variable_sumIj30custom_mixed_multiple_variableIjEEvT_S2_S2_S2_S2_(%struct.State* nonnull %0, i64 %312, %struct.Memory* %call2_408ac5)
...
block_.L_408b4f:                                  ; preds = %block_.L_408ad1
  ...
  %call2_408b4f = tail call %struct.Memory* @sub_400e70._Z5timerv(%struct.State* nonnull %0, i64 %349, %struct.Memory* %call2_408ac5)
