...
declare %struct.Memory* @sub_40ef90._Z26check_shifted_variable_sumIj30custom_mixed_multiple_variableIjEEvT_S2_S2_S2_S2_(%struct.State* noalias dereferenceable(3376), i64, %struct.Memory* noalias readnone returned) local_unnamed_addr
...
entry:
  ...
  %call2_408a95 = tail call %struct.Memory* @sub_400e10._Z11start_timerv(%struct.State* %0, i64 %90, %struct.Memory* %2)
...
block_.L_408aa1:                                  ; preds = %block_.L_408afc, %entry
  %101 = phi i64 [ %.pre, %entry ], [ %351, %block_.L_408afc ]
  %MEMORY.0 = phi %struct.Memory* [ %call2_408a95, %entry ], [ %call2_408b0c, %block_.L_408afc ]
  ...
  br i1 %134, label %block_408ab1, label %block_.L_408b1f
...
block_.L_408abf:                                  ; preds = %block_408acb, %block_408ab1
  %144 = phi i64 [ %.pre1, %block_408ab1 ], [ %288, %block_408acb ]
  %MEMORY.1 = phi %struct.Memory* [ %MEMORY.0, %block_408ab1 ], [ %call2_408ae3, %block_408acb ]
  ...
  br i1 %180, label %block_408acb, label %block_.L_408afc
...
block_408acb:                                     ; preds = %block_.L_408abf
  ...
  %call2_408ae3 = tail call %struct.Memory* @sub_40ef60._ZN30custom_mixed_multiple_variableIjE8do_shiftEjjjjj(%struct.State* %0, i64 %215, %struct.Memory* %MEMORY.1)
...
block_.L_408afc:                                  ; preds = %block_.L_408abf
  ...
  %call2_408b0c = tail call %struct.Memory* @sub_40ef90._Z26check_shifted_variable_sumIj30custom_mixed_multiple_variableIjEEvT_S2_S2_S2_S2_(%struct.State* %0, i64 %314, %struct.Memory* %MEMORY.1)
...
block_.L_408b1f:                                  ; preds = %block_.L_408aa1
  ...
  %call2_408b1f = tail call %struct.Memory* @sub_400e30._Z5timerv(%struct.State* %0, i64 %352, %struct.Memory* %MEMORY.0)
  ...
  %call2_408b28 = tail call %struct.Memory* @sub_4007d0._Z13record_resultdPKc(%struct.State* %0, i64 %363, %struct.Memory* %call2_408b1f)
  ...
  ret %struct.Memory* %call2_408b28
}
...
define %struct.Memory* @routine_jge_.L_408b1f(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i8* %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
...
define %struct.Memory* @routine_jge_.L_408afc(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i8* %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 2, i32 9
...
define %struct.Memory* @routine_callq_._Z26check_shifted_variable_sumIj30custom_mixed_multiple_variableIjEEvT_S2_S2_S2_S2_(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
...
define %struct.Memory* @routine_jmpq_.L_408aa1(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
