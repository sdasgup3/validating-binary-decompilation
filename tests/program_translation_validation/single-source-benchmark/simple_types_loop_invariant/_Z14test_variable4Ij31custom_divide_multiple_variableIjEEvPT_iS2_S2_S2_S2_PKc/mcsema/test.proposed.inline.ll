...
define %struct.Memory* @_Z14test_variable4Ij31custom_divide_multiple_variableIjEEvPT_iS2_S2_S2_S2_PKc(%struct.State* noalias, i64, %struct.Memory* noalias) #1 {
entry:
  ...
  store %struct.Memory* %loadMem_408904, %struct.Memory** %MEMORY
  ...
  store i64 %93, i64* %96
  store %struct.Memory* %loadMem_40890c, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem1_408925, %struct.Memory** %MEMORY
...
block_40895b:                                     ; preds = %block_.L_40894f
  ...
  store %struct.Memory* %loadMem_408969, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem1_408973, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_40897b, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_40897e, %struct.Memory** %MEMORY
...
block_.L_40898c:                                  ; preds = %block_.L_40894f
  ...
  store %struct.Memory* %loadMem_408995, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_408998, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem1_40899c, %struct.Memory** %MEMORY
...
block_.L_4089af:                                  ; preds = %block_.L_408931
  ...
  store %struct.Memory* %loadMem1_4089af, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem1_4089b8, %struct.Memory** %MEMORY
  ...
  ret %struct.Memory* %loadMem_4089c2
}
