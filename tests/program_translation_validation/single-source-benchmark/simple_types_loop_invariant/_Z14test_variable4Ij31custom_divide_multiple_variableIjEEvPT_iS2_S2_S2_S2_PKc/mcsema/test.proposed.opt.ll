...
block_.L_408901:                                  ; preds = %block_.L_40895c, %entry
  %101 = phi i64 [ %.pre, %entry ], [ %349, %block_.L_40895c ]
...
block_.L_40891f:                                  ; preds = %block_40892b, %block_408911
  %144 = phi i64 [ %.pre1, %block_408911 ], [ %287, %block_40892b ]
...
block_.L_40895c:                                  ; preds = %block_.L_40891f
  ...
  %call2_40896c = tail call %struct.Memory* @sub_40f110._Z26check_shifted_variable_sumIj31custom_divide_multiple_variableIjEEvT_S2_S2_S2_S2_(%struct.State* %0, i64 %313, %struct.Memory* %MEMORY.1)
...
block_.L_40897f:                                  ; preds = %block_.L_408901
  ...
  %call2_40897f = tail call %struct.Memory* @sub_400e30._Z5timerv(%struct.State* %0, i64 %350, %struct.Memory* %MEMORY.0)
  ...
  %call2_408988 = tail call %struct.Memory* @sub_4007d0._Z13record_resultdPKc(%struct.State* %0, i64 %361, %struct.Memory* %call2_40897f)
