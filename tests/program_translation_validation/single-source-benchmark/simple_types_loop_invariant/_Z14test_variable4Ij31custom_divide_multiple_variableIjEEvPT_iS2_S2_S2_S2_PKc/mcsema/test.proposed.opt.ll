...
declare %struct.Memory* @sub_40f110._ZN31custom_divide_multiple_variableIjE8do_shiftEjjjjj(%struct.State* noalias dereferenceable(3376), i64, %struct.Memory* noalias readnone returned) local_unnamed_addr

declare %struct.Memory* @sub_40f150._Z26check_shifted_variable_sumIj31custom_divide_multiple_variableIjEEvT_S2_S2_S2_S2_(%struct.State* noalias dereferenceable(3376), i64, %struct.Memory* noalias readnone returned) local_unnamed_addr
...
entry:
  ...
  %call2_408935 = tail call %struct.Memory* @sub_400e60._Z11start_timerv(%struct.State* %0, i64 %89, %struct.Memory* %2)
...
block_.L_408941:                                  ; preds = %block_.L_40899c, %entry
  %100 = phi i64 [ %348, %block_.L_40899c ], [ %.pre, %entry ]
  ...
  br i1 %133, label %block_408951, label %block_.L_4089bf

block_408951:                                     ; preds = %block_.L_408941
  %135 = add i64 %101, -48
  %136 = add i64 %134, 7
...
block_.L_40895f:                                  ; preds = %block_40896b, %block_408951
  %143 = phi i64 [ %286, %block_40896b ], [ %.pre6, %block_408951 ]
  ...
  br i1 %179, label %block_40896b, label %block_.L_40899c

block_40896b:                                     ; preds = %block_.L_40895f
  %181 = add i64 %144, -8
  %182 = add i64 %180, 4
  ...
  %call2_408983 = tail call %struct.Memory* @sub_40f110._ZN31custom_divide_multiple_variableIjE8do_shiftEjjjjj(%struct.State* nonnull %0, i64 %214, %struct.Memory* %call2_408935)
...
block_.L_40899c:                                  ; preds = %block_.L_40895f
  %287 = add i64 %144, -48
  %288 = add i64 %180, 3
  ...
  %call2_4089ac = tail call %struct.Memory* @sub_40f150._Z26check_shifted_variable_sumIj31custom_divide_multiple_variableIjEEvT_S2_S2_S2_S2_(%struct.State* nonnull %0, i64 %312, %struct.Memory* %call2_408935)
...
block_.L_4089bf:                                  ; preds = %block_.L_408941
  ...
  %call2_4089bf = tail call %struct.Memory* @sub_400e80._Z5timerv(%struct.State* nonnull %0, i64 %349, %struct.Memory* %call2_408935)
  ...
  %call2_4089c8 = tail call %struct.Memory* @sub_400820._Z13record_resultdPKc(%struct.State* nonnull %0, i64 %360, %struct.Memory* %call2_4089bf)
