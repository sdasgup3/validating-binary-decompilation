...
declare %struct.Memory* @sub_40f100._ZN31custom_divide_multiple_variableIjE8do_shiftEjjjjj(%struct.State* noalias dereferenceable(3376), i64, %struct.Memory* noalias readnone returned) local_unnamed_addr

declare %struct.Memory* @sub_40f140._Z26check_shifted_variable_sumIj31custom_divide_multiple_variableIjEEvT_S2_S2_S2_S2_(%struct.State* noalias dereferenceable(3376), i64, %struct.Memory* noalias readnone returned) local_unnamed_addr
...
define %struct.Memory* @_Z14test_variable4Ij31custom_divide_multiple_variableIjEEvPT_iS2_S2_S2_S2_PKc(%struct.State* noalias, i64, %struct.Memory* noalias readnone) local_unnamed_addr #1 {
entry:
...
block_.L_408931:                                  ; preds = %block_.L_40898c, %entry
  %100 = phi i64 [ %348, %block_.L_40898c ], [ %.pre, %entry ]
...
block_.L_40894f:                                  ; preds = %block_40895b, %block_408941
  %143 = phi i64 [ %286, %block_40895b ], [ %.pre6, %block_408941 ]
...
block_40895b:                                     ; preds = %block_.L_40894f
  ...
  %call2_408973 = tail call %struct.Memory* @sub_40f100._ZN31custom_divide_multiple_variableIjE8do_shiftEjjjjj(%struct.State* nonnull %0, i64 %214, %struct.Memory* %call2_408925)
...
block_.L_40898c:                                  ; preds = %block_.L_40894f
  ...
  %call2_40899c = tail call %struct.Memory* @sub_40f140._Z26check_shifted_variable_sumIj31custom_divide_multiple_variableIjEEvT_S2_S2_S2_S2_(%struct.State* nonnull %0, i64 %312, %struct.Memory* %call2_408925)
...
block_.L_4089af:                                  ; preds = %block_.L_408931
  ...
  %call2_4089af = tail call %struct.Memory* @sub_400e70._Z5timerv(%struct.State* nonnull %0, i64 %349, %struct.Memory* %call2_408925)
