; ModuleID = '/tmp/tmpjdlieymb-query.ll'
...
define %struct.Memory* @_Z14test_variable4Ij31custom_divide_multiple_variableIjEEvPT_iS2_S2_S2_S2_PKc(%struct.State* noalias, i64, %struct.Memory* noalias readnone returned) local_unnamed_addr #1 {
entry:
  %var_2_3 = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %RBP.i = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 15, i32 0, i32 0
  %var_2_88 = load i64, i64* %var_2_3, align 8
  %var_2_89 = add i64 %var_2_88, -31445
  %call2_408935 = tail call %struct.Memory* @sub_400e60._Z11start_timerv(%struct.State* %0, i64 %var_2_89, %struct.Memory* %2)
  %var_2_1011 = load i64, i64* %RBP.i, align 8
  %var_2_1022 = add i64 %var_2_1011, -44
  %var_2_1043 = inttoptr i64 %var_2_1022 to i32*
  %var_2_1054 = load i32, i32* %var_2_1043, align 4
  %var_2_1075 = load i32, i32* bitcast (%G_0x61a080_type* @G_0x61a080 to i32*), align 8
  %var_2_1086 = sub i32 %var_2_1054, %var_2_1075
  %var_2_1237 = lshr i32 %var_2_1086, 31
  %var_2_1258 = lshr i32 %var_2_1054, 31
  %var_2_1269 = lshr i32 %var_2_1075, 31
  %var_2_12710 = xor i32 %var_2_1269, %var_2_1258
  %var_2_12811 = xor i32 %var_2_1237, %var_2_1258
  %var_2_12912 = add nuw nsw i32 %var_2_12811, %var_2_12710
  %var_2_13013 = icmp eq i32 %var_2_12912, 2
  %var_2_13214 = icmp ne i32 %var_2_1237, 0
  %var_2_13315 = xor i1 %var_2_13214, %var_2_13013
  br i1 %var_2_13315, label %block_408951.preheader, label %block_.L_4089bf

block_408951.preheader:                           ; preds = %entry
  %var_2_145 = add i64 %var_2_1011, -52
  %var_2_147 = inttoptr i64 %var_2_145 to i32*
  %var_2_148 = load i32, i32* %var_2_147, align 4
  %var_2_150 = add i64 %var_2_1011, -12
  ...
  br i1 %var_2_179, label %block_.L_40895f.preheader, label %block_408951.preheader5

block_408951.preheader5:                          ; preds = %block_408951.preheader
  br label %block_408951

block_.L_40895f.preheader:                        ; preds = %block_408951.preheader
  br label %block_.L_40895f

block_408951:                                     ; preds = %block_408951.preheader5, %block_408951
  br label %block_408951

block_.L_40895f:                                  ; preds = %block_.L_40895f.preheader, %block_.L_40895f
  br label %block_.L_40895f

block_.L_4089bf:                                  ; preds = %entry
  %.pre = load i64, i64* %var_2_3, align 8
  %var_2_349 = add i64 %.pre, -31425
  %call2_4089bf = tail call %struct.Memory* @sub_400e80._Z5timerv(%struct.State* nonnull %0, i64 %var_2_349, %struct.Memory* %call2_408935)
  %var_2_356 = load i64, i64* %var_2_3, align 8
  %var_2_360 = add i64 %var_2_356, -33188
  %call2_4089c8 = tail call %struct.Memory* @sub_400820._Z13record_resultdPKc(%struct.State* nonnull %0, i64 %var_2_360, %struct.Memory* %call2_4089bf)
  ret %struct.Memory* %call2_4089c8
}
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_jge_.L_4089bf(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i8* nocapture %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_jge_.L_40899c(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i8* nocapture %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 2, i32 9
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_callq_._ZN31custom_divide_multiple_variableIjE8do_shiftEjjjjj(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_jmpq_.L_40895f(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_callq_._Z26check_shifted_variable_sumIj31custom_divide_multiple_variableIjEEvT_S2_S2_S2_S2_(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_jmpq_.L_408941(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
