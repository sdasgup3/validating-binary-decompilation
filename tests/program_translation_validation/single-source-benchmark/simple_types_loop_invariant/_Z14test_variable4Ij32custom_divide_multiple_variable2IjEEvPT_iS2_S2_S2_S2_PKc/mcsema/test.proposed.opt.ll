...
block_.L_4089d1:                                  ; preds = %block_.L_408a2c, %entry
  %101 = phi i64 [ %.pre, %entry ], [ %351, %block_.L_408a2c ]
...
block_.L_4089ef:                                  ; preds = %block_4089fb, %block_4089e1
  %144 = phi i64 [ %.pre1, %block_4089e1 ], [ %288, %block_4089fb ]
...
block_.L_408a2c:                                  ; preds = %block_.L_4089ef
  ...
  %call2_408a3c = tail call %struct.Memory* @sub_40f050._Z26check_shifted_variable_sumIj32custom_divide_multiple_variable2IjEEvT_S2_S2_S2_S2_(%struct.State* %0, i64 %314, %struct.Memory* %MEMORY.1)
...
block_.L_408a4f:                                  ; preds = %block_.L_4089d1
  ...
  %call2_408a4f = tail call %struct.Memory* @sub_400e30._Z5timerv(%struct.State* %0, i64 %352, %struct.Memory* %MEMORY.0)
  ...
  %call2_408a58 = tail call %struct.Memory* @sub_4007d0._Z13record_resultdPKc(%struct.State* %0, i64 %363, %struct.Memory* %call2_408a4f)
