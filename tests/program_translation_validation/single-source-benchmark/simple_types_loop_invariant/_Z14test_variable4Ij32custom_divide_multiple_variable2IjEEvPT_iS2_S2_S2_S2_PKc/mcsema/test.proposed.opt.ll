...
declare %struct.Memory* @sub_40f090._Z26check_shifted_variable_sumIj32custom_divide_multiple_variable2IjEEvT_S2_S2_S2_S2_(%struct.State* noalias dereferenceable(3376), i64, %struct.Memory* noalias readnone returned) local_unnamed_addr
...
entry:
  ...
  %call2_408a05 = tail call %struct.Memory* @sub_400e60._Z11start_timerv(%struct.State* %0, i64 %89, %struct.Memory* %2)
...
block_.L_408a11:                                  ; preds = %block_.L_408a6c, %entry
  %100 = phi i64 [ %348, %block_.L_408a6c ], [ %.pre, %entry ]
  ...
  br i1 %133, label %block_408a21, label %block_.L_408a8f
...
block_.L_408a2f:                                  ; preds = %block_408a3b, %block_408a21
  %143 = phi i64 [ %286, %block_408a3b ], [ %.pre6, %block_408a21 ]
  ...
  br i1 %179, label %block_408a3b, label %block_.L_408a6c
...
block_408a3b:                                     ; preds = %block_.L_408a2f
  ...
  %call2_408a53 = tail call %struct.Memory* @sub_40f050._ZN32custom_divide_multiple_variable2IjE8do_shiftEjjjjj(%struct.State* nonnull %0, i64 %214, %struct.Memory* %call2_408a05)
...
block_.L_408a6c:                                  ; preds = %block_.L_408a2f
  ...
  %call2_408a7c = tail call %struct.Memory* @sub_40f090._Z26check_shifted_variable_sumIj32custom_divide_multiple_variable2IjEEvT_S2_S2_S2_S2_(%struct.State* nonnull %0, i64 %312, %struct.Memory* %call2_408a05)
...
block_.L_408a8f:                                  ; preds = %block_.L_408a11
  ...
  %call2_408a8f = tail call %struct.Memory* @sub_400e80._Z5timerv(%struct.State* nonnull %0, i64 %349, %struct.Memory* %call2_408a05)
  ...
  %call2_408a98 = tail call %struct.Memory* @sub_400820._Z13record_resultdPKc(%struct.State* nonnull %0, i64 %360, %struct.Memory* %call2_408a8f)
