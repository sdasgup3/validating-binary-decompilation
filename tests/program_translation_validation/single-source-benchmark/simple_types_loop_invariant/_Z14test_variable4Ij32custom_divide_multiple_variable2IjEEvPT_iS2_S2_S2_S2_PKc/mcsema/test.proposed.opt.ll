...
declare %struct.Memory* @sub_40f080._Z26check_shifted_variable_sumIj32custom_divide_multiple_variable2IjEEvT_S2_S2_S2_S2_(%struct.State* noalias dereferenceable(3376), i64, %struct.Memory* noalias readnone returned) local_unnamed_addr
...
define %struct.Memory* @_Z14test_variable4Ij32custom_divide_multiple_variable2IjEEvPT_iS2_S2_S2_S2_PKc(%struct.State* noalias, i64, %struct.Memory* noalias readnone) local_unnamed_addr #1 {
entry:
...
block_.L_408a01:                                  ; preds = %block_.L_408a5c, %entry
  %100 = phi i64 [ %348, %block_.L_408a5c ], [ %.pre, %entry ]
...
block_.L_408a1f:                                  ; preds = %block_408a2b, %block_408a11
  %143 = phi i64 [ %286, %block_408a2b ], [ %.pre6, %block_408a11 ]
...
block_408a2b:                                     ; preds = %block_.L_408a1f
  ...
  %call2_408a43 = tail call %struct.Memory* @sub_40f040._ZN32custom_divide_multiple_variable2IjE8do_shiftEjjjjj(%struct.State* nonnull %0, i64 %214, %struct.Memory* %call2_4089f5)
...
block_.L_408a5c:                                  ; preds = %block_.L_408a1f
  ...
  %call2_408a6c = tail call %struct.Memory* @sub_40f080._Z26check_shifted_variable_sumIj32custom_divide_multiple_variable2IjEEvT_S2_S2_S2_S2_(%struct.State* nonnull %0, i64 %312, %struct.Memory* %call2_4089f5)
...
block_.L_408a7f:                                  ; preds = %block_.L_408a01
  ...
  %call2_408a7f = tail call %struct.Memory* @sub_400e70._Z5timerv(%struct.State* nonnull %0, i64 %349, %struct.Memory* %call2_4089f5)
