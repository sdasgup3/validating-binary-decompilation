...
declare %struct.Memory* @sub_40f330._Z26check_shifted_variable_sumIj33custom_multiply_multiple_variableIjEEvT_S2_S2_S2_S2_(%struct.State* noalias dereferenceable(3376), i64, %struct.Memory* noalias readnone returned) local_unnamed_addr
...
define %struct.Memory* @_Z14test_variable4Ij33custom_multiply_multiple_variableIjEEvPT_iS2_S2_S2_S2_PKc(%struct.State* noalias, i64, %struct.Memory* noalias readnone) local_unnamed_addr #1 {
entry:
...
block_.L_4086f1:                                  ; preds = %block_.L_40874c, %entry
  %100 = phi i64 [ %348, %block_.L_40874c ], [ %.pre, %entry ]
...
block_.L_40870f:                                  ; preds = %block_40871b, %block_408701
  %143 = phi i64 [ %286, %block_40871b ], [ %.pre6, %block_408701 ]
...
block_40871b:                                     ; preds = %block_.L_40870f
  ...
  %call2_408733 = tail call %struct.Memory* @sub_40f300._ZN33custom_multiply_multiple_variableIjE8do_shiftEjjjjj(%struct.State* nonnull %0, i64 %214, %struct.Memory* %call2_4086e5)
...
block_.L_40874c:                                  ; preds = %block_.L_40870f
  ...
  %call2_40875c = tail call %struct.Memory* @sub_40f330._Z26check_shifted_variable_sumIj33custom_multiply_multiple_variableIjEEvT_S2_S2_S2_S2_(%struct.State* nonnull %0, i64 %312, %struct.Memory* %call2_4086e5)
...
block_.L_40876f:                                  ; preds = %block_.L_4086f1
  ...
  %call2_40876f = tail call %struct.Memory* @sub_400e70._Z5timerv(%struct.State* nonnull %0, i64 %349, %struct.Memory* %call2_4086e5)
