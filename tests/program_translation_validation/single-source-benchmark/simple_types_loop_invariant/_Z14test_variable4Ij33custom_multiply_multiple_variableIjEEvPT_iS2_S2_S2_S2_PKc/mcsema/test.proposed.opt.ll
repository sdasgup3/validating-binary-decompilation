...
declare %struct.Memory* @sub_40f340._Z26check_shifted_variable_sumIj33custom_multiply_multiple_variableIjEEvT_S2_S2_S2_S2_(%struct.State* noalias dereferenceable(3376), i64, %struct.Memory* noalias readnone returned) local_unnamed_addr
...
entry:
  ...
  %call2_4086f5 = tail call %struct.Memory* @sub_400e60._Z11start_timerv(%struct.State* %0, i64 %89, %struct.Memory* %2)
...
block_.L_408701:                                  ; preds = %block_.L_40875c, %entry
  %100 = phi i64 [ %348, %block_.L_40875c ], [ %.pre, %entry ]
  ...
  br i1 %133, label %block_408711, label %block_.L_40877f
...
block_.L_40871f:                                  ; preds = %block_40872b, %block_408711
  %143 = phi i64 [ %286, %block_40872b ], [ %.pre6, %block_408711 ]
  ...
  br i1 %179, label %block_40872b, label %block_.L_40875c
...
block_40872b:                                     ; preds = %block_.L_40871f
  ...
  %call2_408743 = tail call %struct.Memory* @sub_40f310._ZN33custom_multiply_multiple_variableIjE8do_shiftEjjjjj(%struct.State* nonnull %0, i64 %214, %struct.Memory* %call2_4086f5)
...
block_.L_40875c:                                  ; preds = %block_.L_40871f
  ...
  %call2_40876c = tail call %struct.Memory* @sub_40f340._Z26check_shifted_variable_sumIj33custom_multiply_multiple_variableIjEEvT_S2_S2_S2_S2_(%struct.State* nonnull %0, i64 %312, %struct.Memory* %call2_4086f5)
...
block_.L_40877f:                                  ; preds = %block_.L_408701
  ...
  %call2_40877f = tail call %struct.Memory* @sub_400e80._Z5timerv(%struct.State* nonnull %0, i64 %349, %struct.Memory* %call2_4086f5)
  ...
  %call2_408788 = tail call %struct.Memory* @sub_400820._Z13record_resultdPKc(%struct.State* nonnull %0, i64 %360, %struct.Memory* %call2_40877f)
