...
block_.L_4086c1:                                  ; preds = %block_.L_40871c, %entry
  %101 = phi i64 [ %.pre, %entry ], [ %349, %block_.L_40871c ]
...
block_.L_4086df:                                  ; preds = %block_4086eb, %block_4086d1
  %144 = phi i64 [ %.pre1, %block_4086d1 ], [ %287, %block_4086eb ]
...
block_.L_40871c:                                  ; preds = %block_.L_4086df
  ...
  %call2_40872c = tail call %struct.Memory* @sub_40f300._Z26check_shifted_variable_sumIj33custom_multiply_multiple_variableIjEEvT_S2_S2_S2_S2_(%struct.State* %0, i64 %313, %struct.Memory* %MEMORY.1)
...
block_.L_40873f:                                  ; preds = %block_.L_4086c1
  ...
  %call2_40873f = tail call %struct.Memory* @sub_400e30._Z5timerv(%struct.State* %0, i64 %350, %struct.Memory* %MEMORY.0)
  ...
  %call2_408748 = tail call %struct.Memory* @sub_4007d0._Z13record_resultdPKc(%struct.State* %0, i64 %361, %struct.Memory* %call2_40873f)
