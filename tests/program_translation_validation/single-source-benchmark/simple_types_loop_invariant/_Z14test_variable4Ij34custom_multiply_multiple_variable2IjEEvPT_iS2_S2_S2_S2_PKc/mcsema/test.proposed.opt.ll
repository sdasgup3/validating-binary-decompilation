...
declare %struct.Memory* @sub_40f250._ZN34custom_multiply_multiple_variable2IjE8do_shiftEjjjjj(%struct.State* dereferenceable(3376), i64, %struct.Memory*) local_unnamed_addr

declare %struct.Memory* @sub_40f280._Z26check_shifted_variable_sumIj34custom_multiply_multiple_variable2IjEEvT_S2_S2_S2_S2_(%struct.State* dereferenceable(3376), i64, %struct.Memory*) local_unnamed_addr
...
block_.L_4087c1:                                  ; preds = %block_.L_40881c, %entry
  %100 = phi i64 [ %.pre, %entry ], [ %348, %block_.L_40881c ]
  %MEMORY.0 = phi %struct.Memory* [ %call2_4087b5, %entry ], [ %call2_40882c, %block_.L_40881c ]
...
block_.L_4087df:                                  ; preds = %block_4087eb, %block_4087d1
  %143 = phi i64 [ %.pre6, %block_4087d1 ], [ %286, %block_4087eb ]
  %MEMORY.1 = phi %struct.Memory* [ %MEMORY.0, %block_4087d1 ], [ %call2_408803, %block_4087eb ]
...
block_4087eb:                                     ; preds = %block_.L_4087df
  ...
  %call2_408803 = tail call %struct.Memory* @sub_40f250._ZN34custom_multiply_multiple_variable2IjE8do_shiftEjjjjj(%struct.State* nonnull %0, i64 %214, %struct.Memory* %MEMORY.1)
...
block_.L_40881c:                                  ; preds = %block_.L_4087df
  ...
  %call2_40882c = tail call %struct.Memory* @sub_40f280._Z26check_shifted_variable_sumIj34custom_multiply_multiple_variable2IjEEvT_S2_S2_S2_S2_(%struct.State* nonnull %0, i64 %312, %struct.Memory* %MEMORY.1)
...
block_.L_40883f:                                  ; preds = %block_.L_4087c1
  ...
  %call2_40883f = tail call %struct.Memory* @sub_400e70._Z5timerv(%struct.State* nonnull %0, i64 %349, %struct.Memory* %MEMORY.0)
