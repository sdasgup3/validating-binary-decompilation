...
block_.L_408791:                                  ; preds = %block_.L_4087ec, %entry
  %101 = phi i64 [ %.pre, %entry ], [ %349, %block_.L_4087ec ]
...
block_.L_4087af:                                  ; preds = %block_4087bb, %block_4087a1
  %144 = phi i64 [ %.pre1, %block_4087a1 ], [ %287, %block_4087bb ]
...
block_.L_4087ec:                                  ; preds = %block_.L_4087af
  ...
  %call2_4087fc = tail call %struct.Memory* @sub_40f250._Z26check_shifted_variable_sumIj34custom_multiply_multiple_variable2IjEEvT_S2_S2_S2_S2_(%struct.State* %0, i64 %313, %struct.Memory* %MEMORY.1)
...
block_.L_40880f:                                  ; preds = %block_.L_408791
  ...
  %call2_40880f = tail call %struct.Memory* @sub_400e30._Z5timerv(%struct.State* %0, i64 %350, %struct.Memory* %MEMORY.0)
  ...
  %call2_408818 = tail call %struct.Memory* @sub_4007d0._Z13record_resultdPKc(%struct.State* %0, i64 %361, %struct.Memory* %call2_40880f)
