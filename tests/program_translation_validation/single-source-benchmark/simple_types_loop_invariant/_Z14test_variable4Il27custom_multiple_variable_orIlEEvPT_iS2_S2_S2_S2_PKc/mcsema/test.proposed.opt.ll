...
declare %struct.Memory* @sub_40e190._ZN27custom_multiple_variable_orIlE8do_shiftElllll(%struct.State* noalias dereferenceable(3376), i64, %struct.Memory* noalias readnone returned) local_unnamed_addr

declare %struct.Memory* @sub_40e1d0._Z26check_shifted_variable_sumIl27custom_multiple_variable_orIlEEvT_S2_S2_S2_S2_(%struct.State* noalias dereferenceable(3376), i64, %struct.Memory* noalias readnone returned) local_unnamed_addr
...
entry:
  ...
  %call2_409b87 = tail call %struct.Memory* @sub_400e60._Z11start_timerv(%struct.State* %0, i64 %86, %struct.Memory* %2)
...
block_.L_409b93:                                  ; preds = %block_.L_409bf5, %entry
  %96 = phi i64 [ %333, %block_.L_409bf5 ], [ %.pre, %entry ]
  ...
  br i1 %129, label %block_409ba3, label %block_.L_409c1c
...
block_.L_409bb2:                                  ; preds = %block_409bbe, %block_409ba3
  %139 = phi i64 [ %276, %block_409bbe ], [ %.pre6, %block_409ba3 ]
  ...
  br i1 %175, label %block_409bbe, label %block_.L_409bf5
...
block_409bbe:                                     ; preds = %block_.L_409bb2
  ...
  %call2_409bda = tail call %struct.Memory* @sub_40e190._ZN27custom_multiple_variable_orIlE8do_shiftElllll(%struct.State* nonnull %0, i64 %205, %struct.Memory* %call2_409b87)
...
block_.L_409bf5:                                  ; preds = %block_.L_409bb2
  ...
  %call2_409c09 = tail call %struct.Memory* @sub_40e1d0._Z26check_shifted_variable_sumIl27custom_multiple_variable_orIlEEvT_S2_S2_S2_S2_(%struct.State* nonnull %0, i64 %297, %struct.Memory* %call2_409b87)
...
block_.L_409c1c:                                  ; preds = %block_.L_409b93
  ...
  %call2_409c1c = tail call %struct.Memory* @sub_400e80._Z5timerv(%struct.State* nonnull %0, i64 %334, %struct.Memory* %call2_409b87)
  ...
  %call2_409c25 = tail call %struct.Memory* @sub_400820._Z13record_resultdPKc(%struct.State* nonnull %0, i64 %345, %struct.Memory* %call2_409c1c)
