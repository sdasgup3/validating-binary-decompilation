...
block_.L_409b53:                                  ; preds = %block_.L_409bb5, %entry
  %96 = phi i64 [ %.pre, %entry ], [ %333, %block_.L_409bb5 ]
...
block_.L_409b72:                                  ; preds = %block_409b7e, %block_409b63
  %139 = phi i64 [ %.pre1, %block_409b63 ], [ %276, %block_409b7e ]
...
block_.L_409bb5:                                  ; preds = %block_.L_409b72
  ...
  %call2_409bc9 = tail call %struct.Memory* @sub_40e190._Z26check_shifted_variable_sumIl27custom_multiple_variable_orIlEEvT_S2_S2_S2_S2_(%struct.State* %0, i64 %297, %struct.Memory* %MEMORY.1)
...
block_.L_409bdc:                                  ; preds = %block_.L_409b53
  ...
  %call2_409bdc = tail call %struct.Memory* @sub_400e30._Z5timerv(%struct.State* %0, i64 %334, %struct.Memory* %MEMORY.0)
  ...
  %call2_409be5 = tail call %struct.Memory* @sub_4007d0._Z13record_resultdPKc(%struct.State* %0, i64 %345, %struct.Memory* %call2_409bdc)
