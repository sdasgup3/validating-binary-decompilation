...
declare %struct.Memory* @sub_40e180._ZN27custom_multiple_variable_orIlE8do_shiftElllll(%struct.State* noalias dereferenceable(3376), i64, %struct.Memory* noalias readnone returned) local_unnamed_addr

declare %struct.Memory* @sub_40e1c0._Z26check_shifted_variable_sumIl27custom_multiple_variable_orIlEEvT_S2_S2_S2_S2_(%struct.State* noalias dereferenceable(3376), i64, %struct.Memory* noalias readnone returned) local_unnamed_addr
...
define %struct.Memory* @_Z14test_variable4Il27custom_multiple_variable_orIlEEvPT_iS2_S2_S2_S2_PKc(%struct.State* noalias, i64, %struct.Memory* noalias readnone) local_unnamed_addr #1 {
entry:
...
block_.L_409b83:                                  ; preds = %block_.L_409be5, %entry
  %96 = phi i64 [ %333, %block_.L_409be5 ], [ %.pre, %entry ]
...
block_.L_409ba2:                                  ; preds = %block_409bae, %block_409b93
  %139 = phi i64 [ %276, %block_409bae ], [ %.pre6, %block_409b93 ]
...
block_409bae:                                     ; preds = %block_.L_409ba2
  ...
  %call2_409bca = tail call %struct.Memory* @sub_40e180._ZN27custom_multiple_variable_orIlE8do_shiftElllll(%struct.State* nonnull %0, i64 %205, %struct.Memory* %call2_409b77)
...
block_.L_409be5:                                  ; preds = %block_.L_409ba2
  ...
  %call2_409bf9 = tail call %struct.Memory* @sub_40e1c0._Z26check_shifted_variable_sumIl27custom_multiple_variable_orIlEEvT_S2_S2_S2_S2_(%struct.State* nonnull %0, i64 %297, %struct.Memory* %call2_409b77)
...
block_.L_409c0c:                                  ; preds = %block_.L_409b83
  ...
  %call2_409c0c = tail call %struct.Memory* @sub_400e70._Z5timerv(%struct.State* nonnull %0, i64 %334, %struct.Memory* %call2_409b77)
