...
declare %struct.Memory* @sub_40e180._ZN27custom_multiple_variable_orIlE8do_shiftElllll(%struct.State* dereferenceable(3376), i64, %struct.Memory*) local_unnamed_addr

declare %struct.Memory* @sub_40e1c0._Z26check_shifted_variable_sumIl27custom_multiple_variable_orIlEEvT_S2_S2_S2_S2_(%struct.State* dereferenceable(3376), i64, %struct.Memory*) local_unnamed_addr
...
entry:
  ...
  %call2_409b77 = tail call %struct.Memory* @sub_400e50._Z11start_timerv(%struct.State* %0, i64 %86, %struct.Memory* %2)
...
block_.L_409b83:                                  ; preds = %block_.L_409be5, %entry
  %96 = phi i64 [ %.pre, %entry ], [ %333, %block_.L_409be5 ]
  %MEMORY.0 = phi %struct.Memory* [ %call2_409b77, %entry ], [ %call2_409bf9, %block_.L_409be5 ]
  ...
  br i1 %129, label %block_409b93, label %block_.L_409c0c
...
block_.L_409ba2:                                  ; preds = %block_409bae, %block_409b93
  %139 = phi i64 [ %.pre6, %block_409b93 ], [ %276, %block_409bae ]
  %MEMORY.1 = phi %struct.Memory* [ %MEMORY.0, %block_409b93 ], [ %call2_409bca, %block_409bae ]
  ...
  br i1 %175, label %block_409bae, label %block_.L_409be5
...
block_409bae:                                     ; preds = %block_.L_409ba2
  ...
  %call2_409bca = tail call %struct.Memory* @sub_40e180._ZN27custom_multiple_variable_orIlE8do_shiftElllll(%struct.State* nonnull %0, i64 %205, %struct.Memory* %MEMORY.1)
...
block_.L_409be5:                                  ; preds = %block_.L_409ba2
  ...
  %call2_409bf9 = tail call %struct.Memory* @sub_40e1c0._Z26check_shifted_variable_sumIl27custom_multiple_variable_orIlEEvT_S2_S2_S2_S2_(%struct.State* nonnull %0, i64 %297, %struct.Memory* %MEMORY.1)
...
block_.L_409c0c:                                  ; preds = %block_.L_409b83
  ...
  %call2_409c0c = tail call %struct.Memory* @sub_400e70._Z5timerv(%struct.State* nonnull %0, i64 %334, %struct.Memory* %MEMORY.0)
  ...
  %call2_409c15 = tail call %struct.Memory* @sub_400810._Z13record_resultdPKc(%struct.State* nonnull %0, i64 %345, %struct.Memory* %call2_409c0c)
  ...
  ret %struct.Memory* %call2_409c15
}
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_jge_.L_409c0c(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i8* nocapture %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_jge_.L_409be5(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i8* nocapture %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 2, i32 9
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_jmpq_.L_409b83(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
