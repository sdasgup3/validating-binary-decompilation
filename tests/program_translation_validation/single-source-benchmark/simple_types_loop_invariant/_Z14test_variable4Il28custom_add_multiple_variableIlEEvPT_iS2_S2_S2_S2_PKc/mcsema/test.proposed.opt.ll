...
declare %struct.Memory* @sub_40ea50._ZN28custom_add_multiple_variableIlE8do_shiftElllll(%struct.State* noalias dereferenceable(3376), i64, %struct.Memory* noalias readnone returned) local_unnamed_addr

declare %struct.Memory* @sub_40ea90._Z26check_shifted_variable_sumIl28custom_add_multiple_variableIlEEvT_S2_S2_S2_S2_(%struct.State* noalias dereferenceable(3376), i64, %struct.Memory* noalias readnone returned) local_unnamed_addr
...
define %struct.Memory* @_Z14test_variable4Il28custom_add_multiple_variableIlEEvPT_iS2_S2_S2_S2_PKc(%struct.State* noalias, i64, %struct.Memory* noalias readnone) local_unnamed_addr #1 {
entry:
...
block_.L_409193:                                  ; preds = %block_.L_4091f5, %entry
  %96 = phi i64 [ %333, %block_.L_4091f5 ], [ %.pre, %entry ]
...
block_.L_4091b2:                                  ; preds = %block_4091be, %block_4091a3
  %139 = phi i64 [ %276, %block_4091be ], [ %.pre6, %block_4091a3 ]
...
block_4091be:                                     ; preds = %block_.L_4091b2
  ...
  %call2_4091da = tail call %struct.Memory* @sub_40ea50._ZN28custom_add_multiple_variableIlE8do_shiftElllll(%struct.State* nonnull %0, i64 %205, %struct.Memory* %call2_409187)
...
block_.L_4091f5:                                  ; preds = %block_.L_4091b2
  ...
  %call2_409209 = tail call %struct.Memory* @sub_40ea90._Z26check_shifted_variable_sumIl28custom_add_multiple_variableIlEEvT_S2_S2_S2_S2_(%struct.State* nonnull %0, i64 %297, %struct.Memory* %call2_409187)
...
block_.L_40921c:                                  ; preds = %block_.L_409193
  ...
  %call2_40921c = tail call %struct.Memory* @sub_400e70._Z5timerv(%struct.State* nonnull %0, i64 %334, %struct.Memory* %call2_409187)
