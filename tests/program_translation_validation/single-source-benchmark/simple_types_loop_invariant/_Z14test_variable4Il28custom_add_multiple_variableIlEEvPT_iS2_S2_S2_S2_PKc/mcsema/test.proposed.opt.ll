...
block_.L_409163:                                  ; preds = %block_.L_4091c5, %entry
  %96 = phi i64 [ %.pre, %entry ], [ %333, %block_.L_4091c5 ]
...
block_.L_409182:                                  ; preds = %block_40918e, %block_409173
  %139 = phi i64 [ %.pre1, %block_409173 ], [ %276, %block_40918e ]
...
block_.L_4091c5:                                  ; preds = %block_.L_409182
  ...
  %call2_4091d9 = tail call %struct.Memory* @sub_40ea60._Z26check_shifted_variable_sumIl28custom_add_multiple_variableIlEEvT_S2_S2_S2_S2_(%struct.State* %0, i64 %297, %struct.Memory* %MEMORY.1)
...
block_.L_4091ec:                                  ; preds = %block_.L_409163
  ...
  %call2_4091ec = tail call %struct.Memory* @sub_400e30._Z5timerv(%struct.State* %0, i64 %334, %struct.Memory* %MEMORY.0)
  ...
  %call2_4091f5 = tail call %struct.Memory* @sub_4007d0._Z13record_resultdPKc(%struct.State* %0, i64 %345, %struct.Memory* %call2_4091ec)
