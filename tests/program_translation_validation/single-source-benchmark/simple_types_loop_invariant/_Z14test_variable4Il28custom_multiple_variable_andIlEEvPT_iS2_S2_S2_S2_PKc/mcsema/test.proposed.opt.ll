...
block_.L_4099d3:                                  ; preds = %block_.L_409a35, %entry
  %96 = phi i64 [ %.pre, %entry ], [ %335, %block_.L_409a35 ]
...
block_.L_4099f2:                                  ; preds = %block_4099fe, %block_4099e3
  %139 = phi i64 [ %.pre1, %block_4099e3 ], [ %277, %block_4099fe ]
...
block_.L_409a35:                                  ; preds = %block_.L_4099f2
  ...
  %call2_409a49 = tail call %struct.Memory* @sub_40e2e0._Z26check_shifted_variable_sumIl28custom_multiple_variable_andIlEEvT_S2_S2_S2_S2_(%struct.State* %0, i64 %298, %struct.Memory* %MEMORY.1)
...
block_.L_409a5c:                                  ; preds = %block_.L_4099d3
  ...
  %call2_409a5c = tail call %struct.Memory* @sub_400e30._Z5timerv(%struct.State* %0, i64 %336, %struct.Memory* %MEMORY.0)
  ...
  %call2_409a65 = tail call %struct.Memory* @sub_4007d0._Z13record_resultdPKc(%struct.State* %0, i64 %347, %struct.Memory* %call2_409a5c)
