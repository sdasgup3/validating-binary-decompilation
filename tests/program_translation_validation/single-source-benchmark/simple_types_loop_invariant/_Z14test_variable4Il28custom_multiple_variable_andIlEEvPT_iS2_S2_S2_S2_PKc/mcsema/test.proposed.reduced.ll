; ModuleID = '/tmp/tmpb4lzlq36-query.ll'
...
define %struct.Memory* @_Z14test_variable4Il28custom_multiple_variable_andIlEEvPT_iS2_S2_S2_S2_PKc(%struct.State* noalias, i64, %struct.Memory* noalias readnone returned) local_unnamed_addr #1 {
entry:
  %var_2_3 = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %RBP.i = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 15, i32 0, i32 0
  %var_2_85 = load i64, i64* %var_2_3, align 8
  %var_2_86 = add i64 %var_2_85, -35751
  %call2_409a07 = tail call %struct.Memory* @sub_400e60._Z11start_timerv(%struct.State* %0, i64 %var_2_86, %struct.Memory* %2)
  ...
  br i1 %var_2_12915, label %block_409a23.preheader, label %block_.L_409a9c

block_409a23.preheader:                           ; preds = %entry
  ...
  br i1 %var_2_175, label %block_.L_409a32.preheader, label %block_409a23.preheader5

block_409a23.preheader5:                          ; preds = %block_409a23.preheader
  br label %block_409a23

block_.L_409a32.preheader:                        ; preds = %block_409a23.preheader
  br label %block_.L_409a32

block_409a23:                                     ; preds = %block_409a23.preheader5, %block_409a23
  br label %block_409a23

block_.L_409a32:                                  ; preds = %block_.L_409a32.preheader, %block_.L_409a32
  br label %block_.L_409a32

block_.L_409a9c:                                  ; preds = %entry
  %.pre = load i64, i64* %var_2_3, align 8
  %var_2_334 = add i64 %.pre, -35731
  %call2_409a9c = tail call %struct.Memory* @sub_400e80._Z5timerv(%struct.State* nonnull %0, i64 %var_2_334, %struct.Memory* %call2_409a07)
  %var_2_341 = load i64, i64* %var_2_3, align 8
  %var_2_345 = add i64 %var_2_341, -37505
  %call2_409aa5 = tail call %struct.Memory* @sub_400820._Z13record_resultdPKc(%struct.State* nonnull %0, i64 %var_2_345, %struct.Memory* %call2_409a9c)
