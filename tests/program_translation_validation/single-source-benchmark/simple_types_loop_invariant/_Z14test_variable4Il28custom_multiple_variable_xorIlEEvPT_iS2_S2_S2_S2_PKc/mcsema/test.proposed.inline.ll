...
define %struct.Memory* @_Z14test_variable4Il28custom_multiple_variable_xorIlEEvPT_iS2_S2_S2_S2_PKc(%struct.State* noalias, i64, %struct.Memory* noalias) #1 {
entry:
  ...
  store %struct.Memory* %loadMem_409cd0, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_409cd4, %struct.Memory** %MEMORY
  ...
  store i64 %93, i64* %96
  store %struct.Memory* %loadMem_409cdc, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem1_409cf7, %struct.Memory** %MEMORY
...
block_409d2e:                                     ; preds = %block_.L_409d22
  ...
  store %struct.Memory* %loadMem_409d3a, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem1_409d4a, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_409d4f, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_409d5a, %struct.Memory** %MEMORY
...
block_.L_409d65:                                  ; preds = %block_.L_409d22
  ...
  store %struct.Memory* %loadMem1_409d79, %struct.Memory** %MEMORY
...
block_.L_409d8c:                                  ; preds = %block_.L_409d03
  ...
  store %struct.Memory* %loadMem1_409d95, %struct.Memory** %MEMORY
  ...
  ret %struct.Memory* %loadMem_409d9f
}
