...
declare %struct.Memory* @sub_40e000._ZN28custom_multiple_variable_xorIlE8do_shiftElllll(%struct.State* dereferenceable(3376), i64, %struct.Memory*) local_unnamed_addr

declare %struct.Memory* @sub_40e040._Z26check_shifted_variable_sumIl28custom_multiple_variable_xorIlEEvT_S2_S2_S2_S2_(%struct.State* dereferenceable(3376), i64, %struct.Memory*) local_unnamed_addr
...
block_.L_409d03:                                  ; preds = %block_.L_409d65, %entry
  %96 = phi i64 [ %.pre, %entry ], [ %333, %block_.L_409d65 ]
  %MEMORY.0 = phi %struct.Memory* [ %call2_409cf7, %entry ], [ %call2_409d79, %block_.L_409d65 ]
...
block_.L_409d22:                                  ; preds = %block_409d2e, %block_409d13
  %139 = phi i64 [ %.pre6, %block_409d13 ], [ %276, %block_409d2e ]
  %MEMORY.1 = phi %struct.Memory* [ %MEMORY.0, %block_409d13 ], [ %call2_409d4a, %block_409d2e ]
...
block_409d2e:                                     ; preds = %block_.L_409d22
  ...
  %call2_409d4a = tail call %struct.Memory* @sub_40e000._ZN28custom_multiple_variable_xorIlE8do_shiftElllll(%struct.State* nonnull %0, i64 %205, %struct.Memory* %MEMORY.1)
...
block_.L_409d65:                                  ; preds = %block_.L_409d22
  ...
  %call2_409d79 = tail call %struct.Memory* @sub_40e040._Z26check_shifted_variable_sumIl28custom_multiple_variable_xorIlEEvT_S2_S2_S2_S2_(%struct.State* nonnull %0, i64 %297, %struct.Memory* %MEMORY.1)
...
block_.L_409d8c:                                  ; preds = %block_.L_409d03
  ...
  %call2_409d8c = tail call %struct.Memory* @sub_400e70._Z5timerv(%struct.State* nonnull %0, i64 %334, %struct.Memory* %MEMORY.0)
