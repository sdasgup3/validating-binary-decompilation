...
block_.L_409cd3:                                  ; preds = %block_.L_409d35, %entry
  %96 = phi i64 [ %.pre, %entry ], [ %333, %block_.L_409d35 ]
...
block_.L_409cf2:                                  ; preds = %block_409cfe, %block_409ce3
  %139 = phi i64 [ %.pre1, %block_409ce3 ], [ %276, %block_409cfe ]
...
block_.L_409d35:                                  ; preds = %block_.L_409cf2
  ...
  %call2_409d49 = tail call %struct.Memory* @sub_40e010._Z26check_shifted_variable_sumIl28custom_multiple_variable_xorIlEEvT_S2_S2_S2_S2_(%struct.State* %0, i64 %297, %struct.Memory* %MEMORY.1)
...
block_.L_409d5c:                                  ; preds = %block_.L_409cd3
  ...
  %call2_409d5c = tail call %struct.Memory* @sub_400e30._Z5timerv(%struct.State* %0, i64 %334, %struct.Memory* %MEMORY.0)
  ...
  %call2_409d65 = tail call %struct.Memory* @sub_4007d0._Z13record_resultdPKc(%struct.State* %0, i64 %345, %struct.Memory* %call2_409d5c)
