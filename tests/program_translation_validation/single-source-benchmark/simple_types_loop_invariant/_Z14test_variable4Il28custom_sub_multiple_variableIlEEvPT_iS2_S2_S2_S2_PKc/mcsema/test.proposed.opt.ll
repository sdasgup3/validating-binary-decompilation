...
block_.L_4092e3:                                  ; preds = %block_.L_409345, %entry
  %96 = phi i64 [ %.pre, %entry ], [ %333, %block_.L_409345 ]
...
block_.L_409302:                                  ; preds = %block_40930e, %block_4092f3
  %139 = phi i64 [ %.pre1, %block_4092f3 ], [ %276, %block_40930e ]
...
block_.L_409345:                                  ; preds = %block_.L_409302
  ...
  %call2_409359 = tail call %struct.Memory* @sub_40e910._Z26check_shifted_variable_sumIl28custom_sub_multiple_variableIlEEvT_S2_S2_S2_S2_(%struct.State* %0, i64 %297, %struct.Memory* %MEMORY.1)
...
block_.L_40936c:                                  ; preds = %block_.L_4092e3
  ...
  %call2_40936c = tail call %struct.Memory* @sub_400e30._Z5timerv(%struct.State* %0, i64 %334, %struct.Memory* %MEMORY.0)
  ...
  %call2_409375 = tail call %struct.Memory* @sub_4007d0._Z13record_resultdPKc(%struct.State* %0, i64 %345, %struct.Memory* %call2_40936c)
