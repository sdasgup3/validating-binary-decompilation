...
declare %struct.Memory* @sub_40e470._Z26check_shifted_variable_sumIl30custom_mixed_multiple_variableIlEEvT_S2_S2_S2_S2_(%struct.State* noalias dereferenceable(3376), i64, %struct.Memory* noalias readnone returned) local_unnamed_addr
...
entry:
  ...
  %call2_409887 = tail call %struct.Memory* @sub_400e60._Z11start_timerv(%struct.State* %0, i64 %86, %struct.Memory* %2)
...
block_.L_409893:                                  ; preds = %block_.L_4098f5, %entry
  %96 = phi i64 [ %333, %block_.L_4098f5 ], [ %.pre, %entry ]
  ...
  br i1 %129, label %block_4098a3, label %block_.L_40991c
...
block_.L_4098b2:                                  ; preds = %block_4098be, %block_4098a3
  %139 = phi i64 [ %276, %block_4098be ], [ %.pre6, %block_4098a3 ]
  ...
  br i1 %175, label %block_4098be, label %block_.L_4098f5
...
block_4098be:                                     ; preds = %block_.L_4098b2
  ...
  %call2_4098da = tail call %struct.Memory* @sub_40e430._ZN30custom_mixed_multiple_variableIlE8do_shiftElllll(%struct.State* nonnull %0, i64 %205, %struct.Memory* %call2_409887)
...
block_.L_4098f5:                                  ; preds = %block_.L_4098b2
  ...
  %call2_409909 = tail call %struct.Memory* @sub_40e470._Z26check_shifted_variable_sumIl30custom_mixed_multiple_variableIlEEvT_S2_S2_S2_S2_(%struct.State* nonnull %0, i64 %297, %struct.Memory* %call2_409887)
...
block_.L_40991c:                                  ; preds = %block_.L_409893
  ...
  %call2_40991c = tail call %struct.Memory* @sub_400e80._Z5timerv(%struct.State* nonnull %0, i64 %334, %struct.Memory* %call2_409887)
  ...
  %call2_409925 = tail call %struct.Memory* @sub_400820._Z13record_resultdPKc(%struct.State* nonnull %0, i64 %345, %struct.Memory* %call2_40991c)
