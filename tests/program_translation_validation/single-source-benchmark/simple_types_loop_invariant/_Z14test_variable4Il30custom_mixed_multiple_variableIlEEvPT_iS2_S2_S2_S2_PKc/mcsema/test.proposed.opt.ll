...
block_.L_409853:                                  ; preds = %block_.L_4098b5, %entry
  %96 = phi i64 [ %.pre, %entry ], [ %335, %block_.L_4098b5 ]
...
block_.L_409872:                                  ; preds = %block_40987e, %block_409863
  %139 = phi i64 [ %.pre1, %block_409863 ], [ %277, %block_40987e ]
...
block_.L_4098b5:                                  ; preds = %block_.L_409872
  ...
  %call2_4098c9 = tail call %struct.Memory* @sub_40e430._Z26check_shifted_variable_sumIl30custom_mixed_multiple_variableIlEEvT_S2_S2_S2_S2_(%struct.State* %0, i64 %298, %struct.Memory* %MEMORY.1)
...
block_.L_4098dc:                                  ; preds = %block_.L_409853
  ...
  %call2_4098dc = tail call %struct.Memory* @sub_400e30._Z5timerv(%struct.State* %0, i64 %336, %struct.Memory* %MEMORY.0)
  ...
  %call2_4098e5 = tail call %struct.Memory* @sub_4007d0._Z13record_resultdPKc(%struct.State* %0, i64 %347, %struct.Memory* %call2_4098dc)
