...
declare %struct.Memory* @sub_40e430._Z26check_shifted_variable_sumIl30custom_mixed_multiple_variableIlEEvT_S2_S2_S2_S2_(%struct.State* noalias dereferenceable(3376), i64, %struct.Memory* noalias readnone returned) local_unnamed_addr
...
entry:
  ...
  %call2_409847 = tail call %struct.Memory* @sub_400e10._Z11start_timerv(%struct.State* %0, i64 %86, %struct.Memory* %2)
...
block_.L_409853:                                  ; preds = %block_.L_4098b5, %entry
  %96 = phi i64 [ %.pre, %entry ], [ %333, %block_.L_4098b5 ]
  %MEMORY.0 = phi %struct.Memory* [ %call2_409847, %entry ], [ %call2_4098c9, %block_.L_4098b5 ]
  ...
  br i1 %129, label %block_409863, label %block_.L_4098dc
...
block_.L_409872:                                  ; preds = %block_40987e, %block_409863
  %139 = phi i64 [ %.pre1, %block_409863 ], [ %276, %block_40987e ]
  %MEMORY.1 = phi %struct.Memory* [ %MEMORY.0, %block_409863 ], [ %call2_40989a, %block_40987e ]
  ...
  br i1 %175, label %block_40987e, label %block_.L_4098b5
...
block_40987e:                                     ; preds = %block_.L_409872
  ...
  %call2_40989a = tail call %struct.Memory* @sub_40e3f0._ZN30custom_mixed_multiple_variableIlE8do_shiftElllll(%struct.State* %0, i64 %205, %struct.Memory* %MEMORY.1)
...
block_.L_4098b5:                                  ; preds = %block_.L_409872
  ...
  %call2_4098c9 = tail call %struct.Memory* @sub_40e430._Z26check_shifted_variable_sumIl30custom_mixed_multiple_variableIlEEvT_S2_S2_S2_S2_(%struct.State* %0, i64 %297, %struct.Memory* %MEMORY.1)
...
block_.L_4098dc:                                  ; preds = %block_.L_409853
  ...
  %call2_4098dc = tail call %struct.Memory* @sub_400e30._Z5timerv(%struct.State* %0, i64 %334, %struct.Memory* %MEMORY.0)
  ...
  %call2_4098e5 = tail call %struct.Memory* @sub_4007d0._Z13record_resultdPKc(%struct.State* %0, i64 %345, %struct.Memory* %call2_4098dc)
  ...
  ret %struct.Memory* %call2_4098e5
}
...
define %struct.Memory* @routine_jge_.L_4098dc(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i8* %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
...
define %struct.Memory* @routine_jge_.L_4098b5(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i8* %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 2, i32 9
...
define %struct.Memory* @routine_jmpq_.L_409872(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
...
define %struct.Memory* @routine_callq_._Z26check_shifted_variable_sumIl30custom_mixed_multiple_variableIlEEvT_S2_S2_S2_S2_(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
...
define %struct.Memory* @routine_jmpq_.L_409853(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
