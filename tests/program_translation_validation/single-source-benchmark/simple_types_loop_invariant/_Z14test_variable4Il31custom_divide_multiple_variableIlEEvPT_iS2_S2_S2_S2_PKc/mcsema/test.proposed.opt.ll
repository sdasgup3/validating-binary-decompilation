...
declare %struct.Memory* @sub_40e5e0._Z26check_shifted_variable_sumIl31custom_divide_multiple_variableIlEEvT_S2_S2_S2_S2_(%struct.State* noalias dereferenceable(3376), i64, %struct.Memory* noalias readnone returned) local_unnamed_addr
...
define %struct.Memory* @_Z14test_variable4Il31custom_divide_multiple_variableIlEEvPT_iS2_S2_S2_S2_PKc(%struct.State* noalias, i64, %struct.Memory* noalias readnone) local_unnamed_addr #1 {
entry:
...
block_.L_4096e3:                                  ; preds = %block_.L_409745, %entry
  %96 = phi i64 [ %333, %block_.L_409745 ], [ %.pre, %entry ]
...
block_.L_409702:                                  ; preds = %block_40970e, %block_4096f3
  %139 = phi i64 [ %276, %block_40970e ], [ %.pre6, %block_4096f3 ]
...
block_40970e:                                     ; preds = %block_.L_409702
  ...
  %call2_40972a = tail call %struct.Memory* @sub_40e5a0._ZN31custom_divide_multiple_variableIlE8do_shiftElllll(%struct.State* nonnull %0, i64 %205, %struct.Memory* %call2_4096d7)
...
block_.L_409745:                                  ; preds = %block_.L_409702
  ...
  %call2_409759 = tail call %struct.Memory* @sub_40e5e0._Z26check_shifted_variable_sumIl31custom_divide_multiple_variableIlEEvT_S2_S2_S2_S2_(%struct.State* nonnull %0, i64 %297, %struct.Memory* %call2_4096d7)
...
block_.L_40976c:                                  ; preds = %block_.L_4096e3
  ...
  %call2_40976c = tail call %struct.Memory* @sub_400e70._Z5timerv(%struct.State* nonnull %0, i64 %334, %struct.Memory* %call2_4096d7)
