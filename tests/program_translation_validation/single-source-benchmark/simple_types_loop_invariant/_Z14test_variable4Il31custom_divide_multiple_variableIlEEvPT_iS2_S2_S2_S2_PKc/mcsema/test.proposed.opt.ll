...
block_.L_4096b3:                                  ; preds = %block_.L_409715, %entry
  %96 = phi i64 [ %.pre, %entry ], [ %333, %block_.L_409715 ]
...
block_.L_4096d2:                                  ; preds = %block_4096de, %block_4096c3
  %139 = phi i64 [ %.pre1, %block_4096c3 ], [ %276, %block_4096de ]
...
block_.L_409715:                                  ; preds = %block_.L_4096d2
  ...
  %call2_409729 = tail call %struct.Memory* @sub_40e5b0._Z26check_shifted_variable_sumIl31custom_divide_multiple_variableIlEEvT_S2_S2_S2_S2_(%struct.State* %0, i64 %297, %struct.Memory* %MEMORY.1)
...
block_.L_40973c:                                  ; preds = %block_.L_4096b3
  ...
  %call2_40973c = tail call %struct.Memory* @sub_400e30._Z5timerv(%struct.State* %0, i64 %334, %struct.Memory* %MEMORY.0)
  ...
  %call2_409745 = tail call %struct.Memory* @sub_4007d0._Z13record_resultdPKc(%struct.State* %0, i64 %345, %struct.Memory* %call2_40973c)
