...
declare %struct.Memory* @sub_40e5f0._Z26check_shifted_variable_sumIl31custom_divide_multiple_variableIlEEvT_S2_S2_S2_S2_(%struct.State* noalias dereferenceable(3376), i64, %struct.Memory* noalias readnone returned) local_unnamed_addr
...
entry:
  ...
  %call2_4096e7 = tail call %struct.Memory* @sub_400e60._Z11start_timerv(%struct.State* %0, i64 %86, %struct.Memory* %2)
...
block_.L_4096f3:                                  ; preds = %block_.L_409755, %entry
  %96 = phi i64 [ %333, %block_.L_409755 ], [ %.pre, %entry ]
  ...
  br i1 %129, label %block_409703, label %block_.L_40977c
...
block_.L_409712:                                  ; preds = %block_40971e, %block_409703
  %139 = phi i64 [ %276, %block_40971e ], [ %.pre6, %block_409703 ]
  ...
  br i1 %175, label %block_40971e, label %block_.L_409755
...
block_40971e:                                     ; preds = %block_.L_409712
  ...
  %call2_40973a = tail call %struct.Memory* @sub_40e5b0._ZN31custom_divide_multiple_variableIlE8do_shiftElllll(%struct.State* nonnull %0, i64 %205, %struct.Memory* %call2_4096e7)
...
block_.L_409755:                                  ; preds = %block_.L_409712
  ...
  %call2_409769 = tail call %struct.Memory* @sub_40e5f0._Z26check_shifted_variable_sumIl31custom_divide_multiple_variableIlEEvT_S2_S2_S2_S2_(%struct.State* nonnull %0, i64 %297, %struct.Memory* %call2_4096e7)
...
block_.L_40977c:                                  ; preds = %block_.L_4096f3
  ...
  %call2_40977c = tail call %struct.Memory* @sub_400e80._Z5timerv(%struct.State* nonnull %0, i64 %334, %struct.Memory* %call2_4096e7)
  ...
  %call2_409785 = tail call %struct.Memory* @sub_400820._Z13record_resultdPKc(%struct.State* nonnull %0, i64 %345, %struct.Memory* %call2_40977c)
