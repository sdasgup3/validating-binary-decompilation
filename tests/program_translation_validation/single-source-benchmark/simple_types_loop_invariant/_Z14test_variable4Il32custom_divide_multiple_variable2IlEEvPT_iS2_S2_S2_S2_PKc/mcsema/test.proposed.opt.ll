...
declare %struct.Memory* @sub_40e520._Z26check_shifted_variable_sumIl32custom_divide_multiple_variable2IlEEvT_S2_S2_S2_S2_(%struct.State* noalias dereferenceable(3376), i64, %struct.Memory* noalias readnone returned) local_unnamed_addr
...
define %struct.Memory* @_Z14test_variable4Il32custom_divide_multiple_variable2IlEEvPT_iS2_S2_S2_S2_PKc(%struct.State* noalias, i64, %struct.Memory* noalias readnone) local_unnamed_addr #1 {
entry:
...
block_.L_4097b3:                                  ; preds = %block_.L_409815, %entry
  %96 = phi i64 [ %333, %block_.L_409815 ], [ %.pre, %entry ]
...
block_.L_4097d2:                                  ; preds = %block_4097de, %block_4097c3
  %139 = phi i64 [ %276, %block_4097de ], [ %.pre6, %block_4097c3 ]
...
block_4097de:                                     ; preds = %block_.L_4097d2
  ...
  %call2_4097fa = tail call %struct.Memory* @sub_40e4e0._ZN32custom_divide_multiple_variable2IlE8do_shiftElllll(%struct.State* nonnull %0, i64 %205, %struct.Memory* %call2_4097a7)
...
block_.L_409815:                                  ; preds = %block_.L_4097d2
  ...
  %call2_409829 = tail call %struct.Memory* @sub_40e520._Z26check_shifted_variable_sumIl32custom_divide_multiple_variable2IlEEvT_S2_S2_S2_S2_(%struct.State* nonnull %0, i64 %297, %struct.Memory* %call2_4097a7)
...
block_.L_40983c:                                  ; preds = %block_.L_4097b3
  ...
  %call2_40983c = tail call %struct.Memory* @sub_400e70._Z5timerv(%struct.State* nonnull %0, i64 %334, %struct.Memory* %call2_4097a7)
