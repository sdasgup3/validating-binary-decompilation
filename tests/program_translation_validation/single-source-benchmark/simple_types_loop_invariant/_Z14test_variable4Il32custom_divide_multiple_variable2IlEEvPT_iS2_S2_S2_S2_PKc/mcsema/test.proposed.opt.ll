...
block_.L_409783:                                  ; preds = %block_.L_4097e5, %entry
  %96 = phi i64 [ %.pre, %entry ], [ %333, %block_.L_4097e5 ]
...
block_.L_4097a2:                                  ; preds = %block_4097ae, %block_409793
  %139 = phi i64 [ %.pre1, %block_409793 ], [ %276, %block_4097ae ]
...
block_.L_4097e5:                                  ; preds = %block_.L_4097a2
  ...
  %call2_4097f9 = tail call %struct.Memory* @sub_40e4f0._Z26check_shifted_variable_sumIl32custom_divide_multiple_variable2IlEEvT_S2_S2_S2_S2_(%struct.State* %0, i64 %297, %struct.Memory* %MEMORY.1)
...
block_.L_40980c:                                  ; preds = %block_.L_409783
  ...
  %call2_40980c = tail call %struct.Memory* @sub_400e30._Z5timerv(%struct.State* %0, i64 %334, %struct.Memory* %MEMORY.0)
  ...
  %call2_409815 = tail call %struct.Memory* @sub_4007d0._Z13record_resultdPKc(%struct.State* %0, i64 %345, %struct.Memory* %call2_40980c)
