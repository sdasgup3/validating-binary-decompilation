...
declare %struct.Memory* @sub_40e530._Z26check_shifted_variable_sumIl32custom_divide_multiple_variable2IlEEvT_S2_S2_S2_S2_(%struct.State* noalias dereferenceable(3376), i64, %struct.Memory* noalias readnone returned) local_unnamed_addr
...
entry:
  ...
  %call2_4097b7 = tail call %struct.Memory* @sub_400e60._Z11start_timerv(%struct.State* %0, i64 %86, %struct.Memory* %2)
...
block_.L_4097c3:                                  ; preds = %block_.L_409825, %entry
  %96 = phi i64 [ %333, %block_.L_409825 ], [ %.pre, %entry ]
  ...
  br i1 %129, label %block_4097d3, label %block_.L_40984c
...
block_.L_4097e2:                                  ; preds = %block_4097ee, %block_4097d3
  %139 = phi i64 [ %276, %block_4097ee ], [ %.pre6, %block_4097d3 ]
  ...
  br i1 %175, label %block_4097ee, label %block_.L_409825
...
block_4097ee:                                     ; preds = %block_.L_4097e2
  ...
  %call2_40980a = tail call %struct.Memory* @sub_40e4f0._ZN32custom_divide_multiple_variable2IlE8do_shiftElllll(%struct.State* nonnull %0, i64 %205, %struct.Memory* %call2_4097b7)
...
block_.L_409825:                                  ; preds = %block_.L_4097e2
  ...
  %call2_409839 = tail call %struct.Memory* @sub_40e530._Z26check_shifted_variable_sumIl32custom_divide_multiple_variable2IlEEvT_S2_S2_S2_S2_(%struct.State* nonnull %0, i64 %297, %struct.Memory* %call2_4097b7)
...
block_.L_40984c:                                  ; preds = %block_.L_4097c3
  ...
  %call2_40984c = tail call %struct.Memory* @sub_400e80._Z5timerv(%struct.State* nonnull %0, i64 %334, %struct.Memory* %call2_4097b7)
  ...
  %call2_409855 = tail call %struct.Memory* @sub_400820._Z13record_resultdPKc(%struct.State* nonnull %0, i64 %345, %struct.Memory* %call2_40984c)
