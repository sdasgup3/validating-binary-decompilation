...
block_.L_409463:                                  ; preds = %block_.L_4094c5, %entry
  %96 = phi i64 [ %.pre, %entry ], [ %335, %block_.L_4094c5 ]
...
block_.L_409482:                                  ; preds = %block_40948e, %block_409473
  %139 = phi i64 [ %.pre1, %block_409473 ], [ %277, %block_40948e ]
...
block_.L_4094c5:                                  ; preds = %block_.L_409482
  ...
  %call2_4094d9 = tail call %struct.Memory* @sub_40e7c0._Z26check_shifted_variable_sumIl33custom_multiply_multiple_variableIlEEvT_S2_S2_S2_S2_(%struct.State* %0, i64 %298, %struct.Memory* %MEMORY.1)
...
block_.L_4094ec:                                  ; preds = %block_.L_409463
  ...
  %call2_4094ec = tail call %struct.Memory* @sub_400e30._Z5timerv(%struct.State* %0, i64 %336, %struct.Memory* %MEMORY.0)
  ...
  %call2_4094f5 = tail call %struct.Memory* @sub_4007d0._Z13record_resultdPKc(%struct.State* %0, i64 %347, %struct.Memory* %call2_4094ec)
