...
declare %struct.Memory* @sub_40e7b0._ZN33custom_multiply_multiple_variableIlE8do_shiftElllll(%struct.State* noalias dereferenceable(3376), i64, %struct.Memory* noalias readnone returned) local_unnamed_addr

declare %struct.Memory* @sub_40e7f0._Z26check_shifted_variable_sumIl33custom_multiply_multiple_variableIlEEvT_S2_S2_S2_S2_(%struct.State* noalias dereferenceable(3376), i64, %struct.Memory* noalias readnone returned) local_unnamed_addr
...
define %struct.Memory* @_Z14test_variable4Il33custom_multiply_multiple_variableIlEEvPT_iS2_S2_S2_S2_PKc(%struct.State* noalias, i64, %struct.Memory* noalias readnone) local_unnamed_addr #1 {
entry:
...
block_.L_409493:                                  ; preds = %block_.L_4094f5, %entry
  %96 = phi i64 [ %333, %block_.L_4094f5 ], [ %.pre, %entry ]
...
block_.L_4094b2:                                  ; preds = %block_4094be, %block_4094a3
  %139 = phi i64 [ %276, %block_4094be ], [ %.pre6, %block_4094a3 ]
...
block_4094be:                                     ; preds = %block_.L_4094b2
  ...
  %call2_4094da = tail call %struct.Memory* @sub_40e7b0._ZN33custom_multiply_multiple_variableIlE8do_shiftElllll(%struct.State* nonnull %0, i64 %205, %struct.Memory* %call2_409487)
...
block_.L_4094f5:                                  ; preds = %block_.L_4094b2
  ...
  %call2_409509 = tail call %struct.Memory* @sub_40e7f0._Z26check_shifted_variable_sumIl33custom_multiply_multiple_variableIlEEvT_S2_S2_S2_S2_(%struct.State* nonnull %0, i64 %297, %struct.Memory* %call2_409487)
...
block_.L_40951c:                                  ; preds = %block_.L_409493
  ...
  %call2_40951c = tail call %struct.Memory* @sub_400e70._Z5timerv(%struct.State* nonnull %0, i64 %334, %struct.Memory* %call2_409487)
