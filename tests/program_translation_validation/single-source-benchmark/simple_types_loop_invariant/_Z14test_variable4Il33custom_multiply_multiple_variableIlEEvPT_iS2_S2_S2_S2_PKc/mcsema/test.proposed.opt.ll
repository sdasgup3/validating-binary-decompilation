...
declare %struct.Memory* @sub_40e7c0._ZN33custom_multiply_multiple_variableIlE8do_shiftElllll(%struct.State* noalias dereferenceable(3376), i64, %struct.Memory* noalias readnone returned) local_unnamed_addr

declare %struct.Memory* @sub_40e800._Z26check_shifted_variable_sumIl33custom_multiply_multiple_variableIlEEvT_S2_S2_S2_S2_(%struct.State* noalias dereferenceable(3376), i64, %struct.Memory* noalias readnone returned) local_unnamed_addr
...
entry:
  ...
  %call2_409497 = tail call %struct.Memory* @sub_400e60._Z11start_timerv(%struct.State* %0, i64 %86, %struct.Memory* %2)
...
block_.L_4094a3:                                  ; preds = %block_.L_409505, %entry
  %96 = phi i64 [ %333, %block_.L_409505 ], [ %.pre, %entry ]
  ...
  br i1 %129, label %block_4094b3, label %block_.L_40952c

block_4094b3:                                     ; preds = %block_.L_4094a3
  %131 = add i64 %97, -72
  %132 = add i64 %130, 8
...
block_.L_4094c2:                                  ; preds = %block_4094ce, %block_4094b3
  %139 = phi i64 [ %276, %block_4094ce ], [ %.pre6, %block_4094b3 ]
  ...
  br i1 %175, label %block_4094ce, label %block_.L_409505
...
block_4094ce:                                     ; preds = %block_.L_4094c2
  ...
  %call2_4094ea = tail call %struct.Memory* @sub_40e7c0._ZN33custom_multiply_multiple_variableIlE8do_shiftElllll(%struct.State* nonnull %0, i64 %205, %struct.Memory* %call2_409497)
...
block_.L_409505:                                  ; preds = %block_.L_4094c2
  %277 = add i64 %140, -72
  %278 = add i64 %176, 4
  ...
  %call2_409519 = tail call %struct.Memory* @sub_40e800._Z26check_shifted_variable_sumIl33custom_multiply_multiple_variableIlEEvT_S2_S2_S2_S2_(%struct.State* nonnull %0, i64 %297, %struct.Memory* %call2_409497)
...
block_.L_40952c:                                  ; preds = %block_.L_4094a3
  ...
  %call2_40952c = tail call %struct.Memory* @sub_400e80._Z5timerv(%struct.State* nonnull %0, i64 %334, %struct.Memory* %call2_409497)
  ...
  %call2_409535 = tail call %struct.Memory* @sub_400820._Z13record_resultdPKc(%struct.State* nonnull %0, i64 %345, %struct.Memory* %call2_40952c)
  ...
  ret %struct.Memory* %call2_409535
}
...
; Function Attrs: alwaysinline norecurse nounwind
define %struct.Memory* @routine_jge_.L_40952c(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i8* nocapture %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
...
; Function Attrs: alwaysinline norecurse nounwind
define %struct.Memory* @routine_jge_.L_409505(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i8* nocapture %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 2, i32 9
...
; Function Attrs: alwaysinline norecurse nounwind
define %struct.Memory* @routine_jmpq_.L_4094a3(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
