; ModuleID = '/tmp/tmpre0232tx-query.ll'
...
define %struct.Memory* @_Z14test_variable4Il33custom_multiply_multiple_variableIlEEvPT_iS2_S2_S2_S2_PKc(%struct.State* noalias, i64, %struct.Memory* noalias readnone returned) local_unnamed_addr #1 {
entry:
  %var_2_3 = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %RBP.i = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 15, i32 0, i32 0
  %var_2_85 = load i64, i64* %var_2_3, align 8
  %var_2_86 = add i64 %var_2_85, -34359
  %call2_409497 = tail call %struct.Memory* @sub_400e60._Z11start_timerv(%struct.State* %0, i64 %var_2_86, %struct.Memory* %2)
  ...
  br i1 %var_2_12915, label %block_4094b3.preheader, label %block_.L_40952c

block_4094b3.preheader:                           ; preds = %entry
  ...
  br i1 %var_2_175, label %block_.L_4094c2.preheader, label %block_4094b3.preheader5

block_4094b3.preheader5:                          ; preds = %block_4094b3.preheader
  br label %block_4094b3

block_.L_4094c2.preheader:                        ; preds = %block_4094b3.preheader
  br label %block_.L_4094c2

block_4094b3:                                     ; preds = %block_4094b3.preheader5, %block_4094b3
  br label %block_4094b3

block_.L_4094c2:                                  ; preds = %block_.L_4094c2.preheader, %block_.L_4094c2
  br label %block_.L_4094c2

block_.L_40952c:                                  ; preds = %entry
  %.pre = load i64, i64* %var_2_3, align 8
  %var_2_334 = add i64 %.pre, -34339
  %call2_40952c = tail call %struct.Memory* @sub_400e80._Z5timerv(%struct.State* nonnull %0, i64 %var_2_334, %struct.Memory* %call2_409497)
  %var_2_341 = load i64, i64* %var_2_3, align 8
  %var_2_345 = add i64 %var_2_341, -36113
  %call2_409535 = tail call %struct.Memory* @sub_400820._Z13record_resultdPKc(%struct.State* nonnull %0, i64 %var_2_345, %struct.Memory* %call2_40952c)
