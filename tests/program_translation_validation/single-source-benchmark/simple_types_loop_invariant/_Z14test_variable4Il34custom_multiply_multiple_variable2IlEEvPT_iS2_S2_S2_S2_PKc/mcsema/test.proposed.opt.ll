...
declare %struct.Memory* @sub_40e6c0._ZN34custom_multiply_multiple_variable2IlE8do_shiftElllll(%struct.State* noalias dereferenceable(3376), i64, %struct.Memory* noalias readnone returned) local_unnamed_addr

declare %struct.Memory* @sub_40e700._Z26check_shifted_variable_sumIl34custom_multiply_multiple_variable2IlEEvT_S2_S2_S2_S2_(%struct.State* noalias dereferenceable(3376), i64, %struct.Memory* noalias readnone returned) local_unnamed_addr
...
define %struct.Memory* @_Z14test_variable4Il34custom_multiply_multiple_variable2IlEEvPT_iS2_S2_S2_S2_PKc(%struct.State* noalias, i64, %struct.Memory* noalias) local_unnamed_addr #1 {
entry:
  ...
  %RSP.i111 = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 13, i32 0, i32 0
  %10 = load i64, i64* %PC.i, align 8
  store i64 %8, i64* %RBP.i, align 8
  %11 = add i64 %7, -88
  store i64 %11, i64* %RSP.i111, align 8
  ...
  %call2_409527 = tail call %struct.Memory* @sub_400e10._Z11start_timerv(%struct.State* %0, i64 %86, %struct.Memory* %2)
  ...
  br label %block_.L_409533

block_.L_409533:                                  ; preds = %block_.L_409595, %entry
  %96 = phi i64 [ %.pre, %entry ], [ %335, %block_.L_409595 ]
  %MEMORY.0 = phi %struct.Memory* [ %call2_409527, %entry ], [ %call2_4095a9, %block_.L_409595 ]
  ...
  %103 = load i32, i32* bitcast (%G_0x61a080_type* @G_0x61a080 to i32*), align 8
  %104 = sub i32 %101, %103
  ...
  br i1 %129, label %block_409543, label %block_.L_4095bc

block_409543:                                     ; preds = %block_.L_409533
  %131 = add i64 %97, -64
  %132 = add i64 %130, 8
  ...
  br label %block_.L_409552

block_.L_409552:                                  ; preds = %block_40955e, %block_409543
  %139 = phi i64 [ %.pre1, %block_409543 ], [ %277, %block_40955e ]
  %MEMORY.1 = phi %struct.Memory* [ %MEMORY.0, %block_409543 ], [ %call2_40957a, %block_40955e ]
  ...
  %175 = xor i1 %174, %172
  %.v2 = select i1 %175, i64 12, i64 67
  %176 = add i64 %139, %.v2
  store i64 %176, i64* %3, align 8
  br i1 %175, label %block_40955e, label %block_.L_409595

block_40955e:                                     ; preds = %block_.L_409552
  %177 = add i64 %140, -8
  %178 = add i64 %176, 4
  ...
  %call2_40957a = tail call %struct.Memory* @sub_40e6c0._ZN34custom_multiply_multiple_variable2IlE8do_shiftElllll(%struct.State* %0, i64 %205, %struct.Memory* %MEMORY.1)
...
block_.L_409595:                                  ; preds = %block_.L_409552
  ...
  %call2_4095a9 = tail call %struct.Memory* @sub_40e700._Z26check_shifted_variable_sumIl34custom_multiply_multiple_variable2IlEEvT_S2_S2_S2_S2_(%struct.State* %0, i64 %298, %struct.Memory* %MEMORY.1)
  ...
  store i64 %310, i64* %RAX.i106, align 8
...
block_.L_4095bc:                                  ; preds = %block_.L_409533
  %336 = add i64 %130, -34700
  %337 = add i64 %130, 5
  ...
  %call2_4095bc = tail call %struct.Memory* @sub_400e30._Z5timerv(%struct.State* %0, i64 %336, %struct.Memory* %MEMORY.0)
  ...
  store i64 %346, i64* %RDI.i103, align 8
  %347 = add i64 %343, -36337
  %348 = add i64 %343, 9
  ...
  %call2_4095c5 = tail call %struct.Memory* @sub_4007d0._Z13record_resultdPKc(%struct.State* %0, i64 %347, %struct.Memory* %call2_4095bc)
  %352 = load i64, i64* %RSP.i111, align 8
  %353 = load i64, i64* %PC.i, align 8
  %354 = add i64 %352, 80
  store i64 %354, i64* %RSP.i111, align 8
  %355 = icmp ugt i64 %352, -81
  ...
  ret %struct.Memory* %call2_4095c5
}
...
define %struct.Memory* @routine_jge_.L_4095bc(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i8* %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
...
define %struct.Memory* @routine_movq__0x0__MINUS0x40__rbp_(%struct.State* dereferenceable(3376), i64, %struct.Memory*) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %RBP = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 15, i32 0, i32 0
  %3 = load i64, i64* %RBP, align 8
...
define %struct.Memory* @routine_jge_.L_409595(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i8* %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 2, i32 9
...
define %struct.Memory* @routine_callq_._ZN34custom_multiply_multiple_variable2IlE8do_shiftElllll(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
...
define %struct.Memory* @routine_addq_MINUS0x40__rbp____rax(%struct.State* dereferenceable(3376), i64, %struct.Memory*) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %RAX = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 1, i32 0, i32 0
  %RBP = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 15, i32 0, i32 0
...
define %struct.Memory* @routine_jmpq_.L_409552(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
...
define %struct.Memory* @routine_callq_._Z26check_shifted_variable_sumIl34custom_multiply_multiple_variable2IlEEvT_S2_S2_S2_S2_(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
...
define %struct.Memory* @routine_jmpq_.L_409533(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
