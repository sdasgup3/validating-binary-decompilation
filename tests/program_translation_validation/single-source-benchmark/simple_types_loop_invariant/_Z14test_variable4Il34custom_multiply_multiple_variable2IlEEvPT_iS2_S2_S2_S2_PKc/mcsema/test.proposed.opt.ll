...
block_.L_409533:                                  ; preds = %block_.L_409595, %entry
  %96 = phi i64 [ %.pre, %entry ], [ %333, %block_.L_409595 ]
...
block_.L_409552:                                  ; preds = %block_40955e, %block_409543
  %139 = phi i64 [ %.pre1, %block_409543 ], [ %276, %block_40955e ]
...
block_.L_409595:                                  ; preds = %block_.L_409552
  ...
  %call2_4095a9 = tail call %struct.Memory* @sub_40e700._Z26check_shifted_variable_sumIl34custom_multiply_multiple_variable2IlEEvT_S2_S2_S2_S2_(%struct.State* %0, i64 %297, %struct.Memory* %MEMORY.1)
...
block_.L_4095bc:                                  ; preds = %block_.L_409533
  ...
  %call2_4095bc = tail call %struct.Memory* @sub_400e30._Z5timerv(%struct.State* %0, i64 %334, %struct.Memory* %MEMORY.0)
  ...
  %call2_4095c5 = tail call %struct.Memory* @sub_4007d0._Z13record_resultdPKc(%struct.State* %0, i64 %345, %struct.Memory* %call2_4095bc)
