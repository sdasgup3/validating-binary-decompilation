...
declare %struct.Memory* @sub_40e6f0._ZN34custom_multiply_multiple_variable2IlE8do_shiftElllll(%struct.State* dereferenceable(3376), i64, %struct.Memory*) local_unnamed_addr

declare %struct.Memory* @sub_40e730._Z26check_shifted_variable_sumIl34custom_multiply_multiple_variable2IlEEvT_S2_S2_S2_S2_(%struct.State* dereferenceable(3376), i64, %struct.Memory*) local_unnamed_addr
...
block_.L_409563:                                  ; preds = %block_.L_4095c5, %entry
  %96 = phi i64 [ %.pre, %entry ], [ %333, %block_.L_4095c5 ]
  %MEMORY.0 = phi %struct.Memory* [ %call2_409557, %entry ], [ %call2_4095d9, %block_.L_4095c5 ]
...
block_.L_409582:                                  ; preds = %block_40958e, %block_409573
  %139 = phi i64 [ %.pre6, %block_409573 ], [ %276, %block_40958e ]
  %MEMORY.1 = phi %struct.Memory* [ %MEMORY.0, %block_409573 ], [ %call2_4095aa, %block_40958e ]
...
block_40958e:                                     ; preds = %block_.L_409582
  ...
  %call2_4095aa = tail call %struct.Memory* @sub_40e6f0._ZN34custom_multiply_multiple_variable2IlE8do_shiftElllll(%struct.State* nonnull %0, i64 %205, %struct.Memory* %MEMORY.1)
...
block_.L_4095c5:                                  ; preds = %block_.L_409582
  ...
  %call2_4095d9 = tail call %struct.Memory* @sub_40e730._Z26check_shifted_variable_sumIl34custom_multiply_multiple_variable2IlEEvT_S2_S2_S2_S2_(%struct.State* nonnull %0, i64 %297, %struct.Memory* %MEMORY.1)
...
block_.L_4095ec:                                  ; preds = %block_.L_409563
  ...
  %call2_4095ec = tail call %struct.Memory* @sub_400e70._Z5timerv(%struct.State* nonnull %0, i64 %334, %struct.Memory* %MEMORY.0)
