...
block_.L_40a933:                                  ; preds = %block_.L_40a995, %entry
  %96 = phi i64 [ %.pre, %entry ], [ %333, %block_.L_40a995 ]
...
block_.L_40a952:                                  ; preds = %block_40a95e, %block_40a943
  %139 = phi i64 [ %.pre1, %block_40a943 ], [ %276, %block_40a95e ]
...
block_.L_40a995:                                  ; preds = %block_.L_40a952
  ...
  %call2_40a9a9 = tail call %struct.Memory* @sub_40d270._Z26check_shifted_variable_sumIm27custom_multiple_variable_orImEEvT_S2_S2_S2_S2_(%struct.State* %0, i64 %297, %struct.Memory* %MEMORY.1)
...
block_.L_40a9bc:                                  ; preds = %block_.L_40a933
  ...
  %call2_40a9bc = tail call %struct.Memory* @sub_400e30._Z5timerv(%struct.State* %0, i64 %334, %struct.Memory* %MEMORY.0)
  ...
  %call2_40a9c5 = tail call %struct.Memory* @sub_4007d0._Z13record_resultdPKc(%struct.State* %0, i64 %345, %struct.Memory* %call2_40a9bc)
