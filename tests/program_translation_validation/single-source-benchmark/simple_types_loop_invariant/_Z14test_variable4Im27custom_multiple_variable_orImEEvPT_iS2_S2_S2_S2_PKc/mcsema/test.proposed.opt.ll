...
declare %struct.Memory* @sub_40d2b0._Z26check_shifted_variable_sumIm27custom_multiple_variable_orImEEvT_S2_S2_S2_S2_(%struct.State* noalias dereferenceable(3376), i64, %struct.Memory* noalias readnone returned) local_unnamed_addr
...
entry:
  ...
  %call2_40a967 = tail call %struct.Memory* @sub_400e60._Z11start_timerv(%struct.State* %0, i64 %86, %struct.Memory* %2)
...
block_.L_40a973:                                  ; preds = %block_.L_40a9d5, %entry
  %96 = phi i64 [ %333, %block_.L_40a9d5 ], [ %.pre, %entry ]
  ...
  br i1 %129, label %block_40a983, label %block_.L_40a9fc
...
block_.L_40a992:                                  ; preds = %block_40a99e, %block_40a983
  %139 = phi i64 [ %276, %block_40a99e ], [ %.pre6, %block_40a983 ]
  ...
  br i1 %175, label %block_40a99e, label %block_.L_40a9d5
...
block_40a99e:                                     ; preds = %block_.L_40a992
  ...
  %call2_40a9ba = tail call %struct.Memory* @sub_40d270._ZN27custom_multiple_variable_orImE8do_shiftEmmmmm(%struct.State* nonnull %0, i64 %205, %struct.Memory* %call2_40a967)
...
block_.L_40a9d5:                                  ; preds = %block_.L_40a992
  ...
  %call2_40a9e9 = tail call %struct.Memory* @sub_40d2b0._Z26check_shifted_variable_sumIm27custom_multiple_variable_orImEEvT_S2_S2_S2_S2_(%struct.State* nonnull %0, i64 %297, %struct.Memory* %call2_40a967)
...
block_.L_40a9fc:                                  ; preds = %block_.L_40a973
  ...
  %call2_40a9fc = tail call %struct.Memory* @sub_400e80._Z5timerv(%struct.State* nonnull %0, i64 %334, %struct.Memory* %call2_40a967)
  ...
  %call2_40aa05 = tail call %struct.Memory* @sub_400820._Z13record_resultdPKc(%struct.State* nonnull %0, i64 %345, %struct.Memory* %call2_40a9fc)
