...
block_.L_409f43:                                  ; preds = %block_.L_409fa5, %entry
  %96 = phi i64 [ %.pre, %entry ], [ %333, %block_.L_409fa5 ]
...
block_.L_409f62:                                  ; preds = %block_409f6e, %block_409f53
  %139 = phi i64 [ %.pre1, %block_409f53 ], [ %276, %block_409f6e ]
...
block_.L_409fa5:                                  ; preds = %block_.L_409f62
  ...
  %call2_409fb9 = tail call %struct.Memory* @sub_40de50._Z26check_shifted_variable_sumIm28custom_add_multiple_variableImEEvT_S2_S2_S2_S2_(%struct.State* %0, i64 %297, %struct.Memory* %MEMORY.1)
...
block_.L_409fcc:                                  ; preds = %block_.L_409f43
  ...
  %call2_409fcc = tail call %struct.Memory* @sub_400e30._Z5timerv(%struct.State* %0, i64 %334, %struct.Memory* %MEMORY.0)
  ...
  %call2_409fd5 = tail call %struct.Memory* @sub_4007d0._Z13record_resultdPKc(%struct.State* %0, i64 %345, %struct.Memory* %call2_409fcc)
