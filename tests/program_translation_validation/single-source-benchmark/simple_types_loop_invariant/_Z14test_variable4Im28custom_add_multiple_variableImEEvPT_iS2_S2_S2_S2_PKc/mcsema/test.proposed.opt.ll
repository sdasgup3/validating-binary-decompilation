...
declare %struct.Memory* @sub_40de40._ZN28custom_add_multiple_variableImE8do_shiftEmmmmm(%struct.State* dereferenceable(3376), i64, %struct.Memory*) local_unnamed_addr

declare %struct.Memory* @sub_40de80._Z26check_shifted_variable_sumIm28custom_add_multiple_variableImEEvT_S2_S2_S2_S2_(%struct.State* dereferenceable(3376), i64, %struct.Memory*) local_unnamed_addr
...
block_.L_409f73:                                  ; preds = %block_.L_409fd5, %entry
  %96 = phi i64 [ %.pre, %entry ], [ %333, %block_.L_409fd5 ]
  %MEMORY.0 = phi %struct.Memory* [ %call2_409f67, %entry ], [ %call2_409fe9, %block_.L_409fd5 ]
...
block_.L_409f92:                                  ; preds = %block_409f9e, %block_409f83
  %139 = phi i64 [ %.pre6, %block_409f83 ], [ %276, %block_409f9e ]
  %MEMORY.1 = phi %struct.Memory* [ %MEMORY.0, %block_409f83 ], [ %call2_409fba, %block_409f9e ]
...
block_409f9e:                                     ; preds = %block_.L_409f92
  ...
  %call2_409fba = tail call %struct.Memory* @sub_40de40._ZN28custom_add_multiple_variableImE8do_shiftEmmmmm(%struct.State* nonnull %0, i64 %205, %struct.Memory* %MEMORY.1)
...
block_.L_409fd5:                                  ; preds = %block_.L_409f92
  ...
  %call2_409fe9 = tail call %struct.Memory* @sub_40de80._Z26check_shifted_variable_sumIm28custom_add_multiple_variableImEEvT_S2_S2_S2_S2_(%struct.State* nonnull %0, i64 %297, %struct.Memory* %MEMORY.1)
...
block_.L_409ffc:                                  ; preds = %block_.L_409f73
  ...
  %call2_409ffc = tail call %struct.Memory* @sub_400e70._Z5timerv(%struct.State* nonnull %0, i64 %334, %struct.Memory* %MEMORY.0)
