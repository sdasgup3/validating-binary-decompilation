...
declare %struct.Memory* @sub_40d470._Z26check_shifted_variable_sumIm28custom_multiple_variable_andImEEvT_S2_S2_S2_S2_(%struct.State* noalias dereferenceable(3376), i64, %struct.Memory* noalias readnone returned) local_unnamed_addr
...
entry:
  ...
  %call2_40a7e7 = tail call %struct.Memory* @sub_400e60._Z11start_timerv(%struct.State* %0, i64 %86, %struct.Memory* %2)
...
block_.L_40a7f3:                                  ; preds = %block_.L_40a855, %entry
  %96 = phi i64 [ %333, %block_.L_40a855 ], [ %.pre, %entry ]
  ...
  br i1 %129, label %block_40a803, label %block_.L_40a87c
...
block_.L_40a812:                                  ; preds = %block_40a81e, %block_40a803
  %139 = phi i64 [ %276, %block_40a81e ], [ %.pre6, %block_40a803 ]
  ...
  br i1 %175, label %block_40a81e, label %block_.L_40a855
...
block_40a81e:                                     ; preds = %block_.L_40a812
  ...
  %call2_40a83a = tail call %struct.Memory* @sub_40d430._ZN28custom_multiple_variable_andImE8do_shiftEmmmmm(%struct.State* nonnull %0, i64 %205, %struct.Memory* %call2_40a7e7)
...
block_.L_40a855:                                  ; preds = %block_.L_40a812
  ...
  %call2_40a869 = tail call %struct.Memory* @sub_40d470._Z26check_shifted_variable_sumIm28custom_multiple_variable_andImEEvT_S2_S2_S2_S2_(%struct.State* nonnull %0, i64 %297, %struct.Memory* %call2_40a7e7)
...
block_.L_40a87c:                                  ; preds = %block_.L_40a7f3
  ...
  %call2_40a87c = tail call %struct.Memory* @sub_400e80._Z5timerv(%struct.State* nonnull %0, i64 %334, %struct.Memory* %call2_40a7e7)
  ...
  %call2_40a885 = tail call %struct.Memory* @sub_400820._Z13record_resultdPKc(%struct.State* nonnull %0, i64 %345, %struct.Memory* %call2_40a87c)
