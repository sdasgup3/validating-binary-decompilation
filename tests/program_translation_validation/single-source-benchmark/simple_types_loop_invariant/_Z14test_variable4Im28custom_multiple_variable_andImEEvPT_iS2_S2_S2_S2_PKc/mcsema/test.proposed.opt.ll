...
block_.L_40a7b3:                                  ; preds = %block_.L_40a815, %entry
  %96 = phi i64 [ %.pre, %entry ], [ %335, %block_.L_40a815 ]
...
block_.L_40a7d2:                                  ; preds = %block_40a7de, %block_40a7c3
  %139 = phi i64 [ %.pre1, %block_40a7c3 ], [ %277, %block_40a7de ]
...
block_.L_40a815:                                  ; preds = %block_.L_40a7d2
  ...
  %call2_40a829 = tail call %struct.Memory* @sub_40d430._Z26check_shifted_variable_sumIm28custom_multiple_variable_andImEEvT_S2_S2_S2_S2_(%struct.State* %0, i64 %298, %struct.Memory* %MEMORY.1)
...
block_.L_40a83c:                                  ; preds = %block_.L_40a7b3
  ...
  %call2_40a83c = tail call %struct.Memory* @sub_400e30._Z5timerv(%struct.State* %0, i64 %336, %struct.Memory* %MEMORY.0)
  ...
  %call2_40a845 = tail call %struct.Memory* @sub_4007d0._Z13record_resultdPKc(%struct.State* %0, i64 %347, %struct.Memory* %call2_40a83c)
