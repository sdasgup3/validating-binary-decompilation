...
block_.L_40aab3:                                  ; preds = %block_.L_40ab15, %entry
  %96 = phi i64 [ %.pre, %entry ], [ %335, %block_.L_40ab15 ]
...
block_.L_40aad2:                                  ; preds = %block_40aade, %block_40aac3
  %139 = phi i64 [ %.pre1, %block_40aac3 ], [ %277, %block_40aade ]
...
block_.L_40ab15:                                  ; preds = %block_.L_40aad2
  ...
  %call2_40ab29 = tail call %struct.Memory* @sub_40d080._Z26check_shifted_variable_sumIm28custom_multiple_variable_xorImEEvT_S2_S2_S2_S2_(%struct.State* %0, i64 %298, %struct.Memory* %MEMORY.1)
...
block_.L_40ab3c:                                  ; preds = %block_.L_40aab3
  ...
  %call2_40ab3c = tail call %struct.Memory* @sub_400e30._Z5timerv(%struct.State* %0, i64 %336, %struct.Memory* %MEMORY.0)
  ...
  %call2_40ab45 = tail call %struct.Memory* @sub_4007d0._Z13record_resultdPKc(%struct.State* %0, i64 %347, %struct.Memory* %call2_40ab3c)
