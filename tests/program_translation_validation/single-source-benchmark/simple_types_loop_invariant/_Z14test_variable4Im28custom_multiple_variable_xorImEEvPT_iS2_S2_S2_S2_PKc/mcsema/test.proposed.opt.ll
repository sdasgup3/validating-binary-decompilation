...
declare %struct.Memory* @sub_40d0b0._Z26check_shifted_variable_sumIm28custom_multiple_variable_xorImEEvT_S2_S2_S2_S2_(%struct.State* dereferenceable(3376), i64, %struct.Memory*) local_unnamed_addr
...
entry:
  ...
  %call2_40aad7 = tail call %struct.Memory* @sub_400e50._Z11start_timerv(%struct.State* %0, i64 %86, %struct.Memory* %2)
...
block_.L_40aae3:                                  ; preds = %block_.L_40ab45, %entry
  %96 = phi i64 [ %.pre, %entry ], [ %333, %block_.L_40ab45 ]
  %MEMORY.0 = phi %struct.Memory* [ %call2_40aad7, %entry ], [ %call2_40ab59, %block_.L_40ab45 ]
  ...
  br i1 %129, label %block_40aaf3, label %block_.L_40ab6c
...
block_.L_40ab02:                                  ; preds = %block_40ab0e, %block_40aaf3
  %139 = phi i64 [ %.pre6, %block_40aaf3 ], [ %276, %block_40ab0e ]
  %MEMORY.1 = phi %struct.Memory* [ %MEMORY.0, %block_40aaf3 ], [ %call2_40ab2a, %block_40ab0e ]
  ...
  br i1 %175, label %block_40ab0e, label %block_.L_40ab45
...
block_40ab0e:                                     ; preds = %block_.L_40ab02
  ...
  %call2_40ab2a = tail call %struct.Memory* @sub_40d070._ZN28custom_multiple_variable_xorImE8do_shiftEmmmmm(%struct.State* nonnull %0, i64 %205, %struct.Memory* %MEMORY.1)
...
block_.L_40ab45:                                  ; preds = %block_.L_40ab02
  ...
  %call2_40ab59 = tail call %struct.Memory* @sub_40d0b0._Z26check_shifted_variable_sumIm28custom_multiple_variable_xorImEEvT_S2_S2_S2_S2_(%struct.State* nonnull %0, i64 %297, %struct.Memory* %MEMORY.1)
...
block_.L_40ab6c:                                  ; preds = %block_.L_40aae3
  ...
  %call2_40ab6c = tail call %struct.Memory* @sub_400e70._Z5timerv(%struct.State* nonnull %0, i64 %334, %struct.Memory* %MEMORY.0)
  ...
  %call2_40ab75 = tail call %struct.Memory* @sub_400810._Z13record_resultdPKc(%struct.State* nonnull %0, i64 %345, %struct.Memory* %call2_40ab6c)
  ...
  ret %struct.Memory* %call2_40ab75
}
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_jge_.L_40ab6c(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i8* nocapture %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_jge_.L_40ab45(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i8* nocapture %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 2, i32 9
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_jmpq_.L_40aae3(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
