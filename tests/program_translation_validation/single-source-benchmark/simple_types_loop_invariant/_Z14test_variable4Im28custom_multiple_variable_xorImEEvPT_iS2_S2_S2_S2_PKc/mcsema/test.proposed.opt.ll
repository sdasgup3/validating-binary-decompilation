...
declare %struct.Memory* @sub_40d0c0._Z26check_shifted_variable_sumIm28custom_multiple_variable_xorImEEvT_S2_S2_S2_S2_(%struct.State* noalias dereferenceable(3376), i64, %struct.Memory* noalias readnone returned) local_unnamed_addr
...
entry:
  ...
  %call2_40aae7 = tail call %struct.Memory* @sub_400e60._Z11start_timerv(%struct.State* %0, i64 %86, %struct.Memory* %2)
...
block_.L_40aaf3:                                  ; preds = %block_.L_40ab55, %entry
  %96 = phi i64 [ %333, %block_.L_40ab55 ], [ %.pre, %entry ]
  ...
  br i1 %129, label %block_40ab03, label %block_.L_40ab7c
...
block_.L_40ab12:                                  ; preds = %block_40ab1e, %block_40ab03
  %139 = phi i64 [ %276, %block_40ab1e ], [ %.pre6, %block_40ab03 ]
  ...
  br i1 %175, label %block_40ab1e, label %block_.L_40ab55
...
block_40ab1e:                                     ; preds = %block_.L_40ab12
  ...
  %call2_40ab3a = tail call %struct.Memory* @sub_40d080._ZN28custom_multiple_variable_xorImE8do_shiftEmmmmm(%struct.State* nonnull %0, i64 %205, %struct.Memory* %call2_40aae7)
...
block_.L_40ab55:                                  ; preds = %block_.L_40ab12
  ...
  %call2_40ab69 = tail call %struct.Memory* @sub_40d0c0._Z26check_shifted_variable_sumIm28custom_multiple_variable_xorImEEvT_S2_S2_S2_S2_(%struct.State* nonnull %0, i64 %297, %struct.Memory* %call2_40aae7)
...
block_.L_40ab7c:                                  ; preds = %block_.L_40aaf3
  ...
  %call2_40ab7c = tail call %struct.Memory* @sub_400e80._Z5timerv(%struct.State* nonnull %0, i64 %334, %struct.Memory* %call2_40aae7)
  ...
  %call2_40ab85 = tail call %struct.Memory* @sub_400820._Z13record_resultdPKc(%struct.State* nonnull %0, i64 %345, %struct.Memory* %call2_40ab7c)
