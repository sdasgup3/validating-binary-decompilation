...
declare %struct.Memory* @sub_40d0b0._Z26check_shifted_variable_sumIm28custom_multiple_variable_xorImEEvT_S2_S2_S2_S2_(%struct.State* noalias dereferenceable(3376), i64, %struct.Memory* noalias readnone returned) local_unnamed_addr
...
define %struct.Memory* @_Z14test_variable4Im28custom_multiple_variable_xorImEEvPT_iS2_S2_S2_S2_PKc(%struct.State* noalias, i64, %struct.Memory* noalias readnone) local_unnamed_addr #1 {
entry:
...
block_.L_40aae3:                                  ; preds = %block_.L_40ab45, %entry
  %96 = phi i64 [ %333, %block_.L_40ab45 ], [ %.pre, %entry ]
...
block_.L_40ab02:                                  ; preds = %block_40ab0e, %block_40aaf3
  %139 = phi i64 [ %276, %block_40ab0e ], [ %.pre6, %block_40aaf3 ]
...
block_40ab0e:                                     ; preds = %block_.L_40ab02
  ...
  %call2_40ab2a = tail call %struct.Memory* @sub_40d070._ZN28custom_multiple_variable_xorImE8do_shiftEmmmmm(%struct.State* nonnull %0, i64 %205, %struct.Memory* %call2_40aad7)
...
block_.L_40ab45:                                  ; preds = %block_.L_40ab02
  ...
  %call2_40ab59 = tail call %struct.Memory* @sub_40d0b0._Z26check_shifted_variable_sumIm28custom_multiple_variable_xorImEEvT_S2_S2_S2_S2_(%struct.State* nonnull %0, i64 %297, %struct.Memory* %call2_40aad7)
...
block_.L_40ab6c:                                  ; preds = %block_.L_40aae3
  ...
  %call2_40ab6c = tail call %struct.Memory* @sub_400e70._Z5timerv(%struct.State* nonnull %0, i64 %334, %struct.Memory* %call2_40aad7)
