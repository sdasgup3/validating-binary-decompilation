...
declare %struct.Memory* @sub_40d080._Z26check_shifted_variable_sumIm28custom_multiple_variable_xorImEEvT_S2_S2_S2_S2_(%struct.State* noalias dereferenceable(3376), i64, %struct.Memory* noalias readnone returned) local_unnamed_addr
...
define %struct.Memory* @_Z14test_variable4Im28custom_multiple_variable_xorImEEvPT_iS2_S2_S2_S2_PKc(%struct.State* noalias, i64, %struct.Memory* noalias) local_unnamed_addr #1 {
entry:
  ...
  %call2_40aaa7 = tail call %struct.Memory* @sub_400e10._Z11start_timerv(%struct.State* %0, i64 %86, %struct.Memory* %2)
...
block_.L_40aab3:                                  ; preds = %block_.L_40ab15, %entry
  %96 = phi i64 [ %.pre, %entry ], [ %333, %block_.L_40ab15 ]
  %MEMORY.0 = phi %struct.Memory* [ %call2_40aaa7, %entry ], [ %call2_40ab29, %block_.L_40ab15 ]
  ...
  br i1 %129, label %block_40aac3, label %block_.L_40ab3c
...
block_.L_40aad2:                                  ; preds = %block_40aade, %block_40aac3
  %139 = phi i64 [ %.pre1, %block_40aac3 ], [ %276, %block_40aade ]
  %MEMORY.1 = phi %struct.Memory* [ %MEMORY.0, %block_40aac3 ], [ %call2_40aafa, %block_40aade ]
  ...
  br i1 %175, label %block_40aade, label %block_.L_40ab15
...
block_40aade:                                     ; preds = %block_.L_40aad2
  ...
  %call2_40aafa = tail call %struct.Memory* @sub_40d040._ZN28custom_multiple_variable_xorImE8do_shiftEmmmmm(%struct.State* %0, i64 %205, %struct.Memory* %MEMORY.1)
...
block_.L_40ab15:                                  ; preds = %block_.L_40aad2
  ...
  %call2_40ab29 = tail call %struct.Memory* @sub_40d080._Z26check_shifted_variable_sumIm28custom_multiple_variable_xorImEEvT_S2_S2_S2_S2_(%struct.State* %0, i64 %297, %struct.Memory* %MEMORY.1)
...
block_.L_40ab3c:                                  ; preds = %block_.L_40aab3
  ...
  %call2_40ab3c = tail call %struct.Memory* @sub_400e30._Z5timerv(%struct.State* %0, i64 %334, %struct.Memory* %MEMORY.0)
  ...
  %call2_40ab45 = tail call %struct.Memory* @sub_4007d0._Z13record_resultdPKc(%struct.State* %0, i64 %345, %struct.Memory* %call2_40ab3c)
  ...
  ret %struct.Memory* %call2_40ab45
}
...
define %struct.Memory* @routine_jge_.L_40ab3c(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i8* %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
...
define %struct.Memory* @routine_jge_.L_40ab15(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i8* %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 2, i32 9
...
define %struct.Memory* @routine_callq_._Z26check_shifted_variable_sumIm28custom_multiple_variable_xorImEEvT_S2_S2_S2_S2_(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
...
define %struct.Memory* @routine_jmpq_.L_40aab3(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
