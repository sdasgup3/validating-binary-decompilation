; ModuleID = '/tmp/tmpshfukfk1-query.ll'
...
define %struct.Memory* @_Z14test_variable4Im28custom_multiple_variable_xorImEEvPT_iS2_S2_S2_S2_PKc(%struct.State* noalias, i64, %struct.Memory* noalias readnone returned) local_unnamed_addr #1 {
entry:
  %var_2_3 = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %RBP.i = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 15, i32 0, i32 0
  %var_2_85 = load i64, i64* %var_2_3, align 8
  %var_2_86 = add i64 %var_2_85, -40071
  %call2_40aae7 = tail call %struct.Memory* @sub_400e60._Z11start_timerv(%struct.State* %0, i64 %var_2_86, %struct.Memory* %2)
...
block_.L_40ab7c:                                  ; preds = %entry
  ...
  %var_2_334 = add i64 %.pre, -40051
  %call2_40ab7c = tail call %struct.Memory* @sub_400e80._Z5timerv(%struct.State* nonnull %0, i64 %var_2_334, %struct.Memory* %call2_40aae7)
  %var_2_341 = load i64, i64* %var_2_3, align 8
  %var_2_345 = add i64 %var_2_341, -41825
  %call2_40ab85 = tail call %struct.Memory* @sub_400820._Z13record_resultdPKc(%struct.State* nonnull %0, i64 %var_2_345, %struct.Memory* %call2_40ab7c)
  ret %struct.Memory* %call2_40ab85
}
