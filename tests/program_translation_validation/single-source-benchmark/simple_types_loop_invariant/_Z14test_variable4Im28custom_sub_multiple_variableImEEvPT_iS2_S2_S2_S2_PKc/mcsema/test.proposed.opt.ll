...
block_.L_40a0c3:                                  ; preds = %block_.L_40a125, %entry
  %96 = phi i64 [ %.pre, %entry ], [ %335, %block_.L_40a125 ]
...
block_.L_40a0e2:                                  ; preds = %block_40a0ee, %block_40a0d3
  %139 = phi i64 [ %.pre1, %block_40a0d3 ], [ %277, %block_40a0ee ]
...
block_.L_40a125:                                  ; preds = %block_.L_40a0e2
  ...
  %call2_40a139 = tail call %struct.Memory* @sub_40dc90._Z26check_shifted_variable_sumIm28custom_sub_multiple_variableImEEvT_S2_S2_S2_S2_(%struct.State* %0, i64 %298, %struct.Memory* %MEMORY.1)
...
block_.L_40a14c:                                  ; preds = %block_.L_40a0c3
  ...
  %call2_40a14c = tail call %struct.Memory* @sub_400e30._Z5timerv(%struct.State* %0, i64 %336, %struct.Memory* %MEMORY.0)
  ...
  %call2_40a155 = tail call %struct.Memory* @sub_4007d0._Z13record_resultdPKc(%struct.State* %0, i64 %347, %struct.Memory* %call2_40a14c)
