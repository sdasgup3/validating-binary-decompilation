...
block_.L_40a633:                                  ; preds = %block_.L_40a695, %entry
  %96 = phi i64 [ %.pre, %entry ], [ %335, %block_.L_40a695 ]
...
block_.L_40a652:                                  ; preds = %block_40a65e, %block_40a643
  %139 = phi i64 [ %.pre1, %block_40a643 ], [ %277, %block_40a65e ]
...
block_.L_40a695:                                  ; preds = %block_.L_40a652
  ...
  %call2_40a6a9 = tail call %struct.Memory* @sub_40d5f0._Z26check_shifted_variable_sumIm30custom_mixed_multiple_variableImEEvT_S2_S2_S2_S2_(%struct.State* %0, i64 %298, %struct.Memory* %MEMORY.1)
...
block_.L_40a6bc:                                  ; preds = %block_.L_40a633
  ...
  %call2_40a6bc = tail call %struct.Memory* @sub_400e30._Z5timerv(%struct.State* %0, i64 %336, %struct.Memory* %MEMORY.0)
  ...
  %call2_40a6c5 = tail call %struct.Memory* @sub_4007d0._Z13record_resultdPKc(%struct.State* %0, i64 %347, %struct.Memory* %call2_40a6bc)
