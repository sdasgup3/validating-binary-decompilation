...
declare %struct.Memory* @sub_40d7f0._ZN31custom_divide_multiple_variableImE8do_shiftEmmmmm(%struct.State* noalias dereferenceable(3376), i64, %struct.Memory* noalias readnone returned) local_unnamed_addr

declare %struct.Memory* @sub_40d840._Z26check_shifted_variable_sumIm31custom_divide_multiple_variableImEEvT_S2_S2_S2_S2_(%struct.State* noalias dereferenceable(3376), i64, %struct.Memory* noalias readnone returned) local_unnamed_addr
...
define %struct.Memory* @_Z14test_variable4Im31custom_divide_multiple_variableImEEvPT_iS2_S2_S2_S2_PKc(%struct.State* noalias, i64, %struct.Memory* noalias readnone) local_unnamed_addr #1 {
entry:
...
block_.L_40a4c3:                                  ; preds = %block_.L_40a525, %entry
  %96 = phi i64 [ %333, %block_.L_40a525 ], [ %.pre, %entry ]
...
block_.L_40a4e2:                                  ; preds = %block_40a4ee, %block_40a4d3
  %139 = phi i64 [ %276, %block_40a4ee ], [ %.pre6, %block_40a4d3 ]
...
block_40a4ee:                                     ; preds = %block_.L_40a4e2
  ...
  %call2_40a50a = tail call %struct.Memory* @sub_40d7f0._ZN31custom_divide_multiple_variableImE8do_shiftEmmmmm(%struct.State* nonnull %0, i64 %205, %struct.Memory* %call2_40a4b7)
...
block_.L_40a525:                                  ; preds = %block_.L_40a4e2
  ...
  %call2_40a539 = tail call %struct.Memory* @sub_40d840._Z26check_shifted_variable_sumIm31custom_divide_multiple_variableImEEvT_S2_S2_S2_S2_(%struct.State* nonnull %0, i64 %297, %struct.Memory* %call2_40a4b7)
...
block_.L_40a54c:                                  ; preds = %block_.L_40a4c3
  ...
  %call2_40a54c = tail call %struct.Memory* @sub_400e70._Z5timerv(%struct.State* nonnull %0, i64 %334, %struct.Memory* %call2_40a4b7)
