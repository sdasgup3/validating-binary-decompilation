...
block_.L_40a493:                                  ; preds = %block_.L_40a4f5, %entry
  %96 = phi i64 [ %.pre, %entry ], [ %333, %block_.L_40a4f5 ]
...
block_.L_40a4b2:                                  ; preds = %block_40a4be, %block_40a4a3
  %139 = phi i64 [ %.pre1, %block_40a4a3 ], [ %276, %block_40a4be ]
...
block_.L_40a4f5:                                  ; preds = %block_.L_40a4b2
  ...
  %call2_40a509 = tail call %struct.Memory* @sub_40d810._Z26check_shifted_variable_sumIm31custom_divide_multiple_variableImEEvT_S2_S2_S2_S2_(%struct.State* %0, i64 %297, %struct.Memory* %MEMORY.1)
...
block_.L_40a51c:                                  ; preds = %block_.L_40a493
  ...
  %call2_40a51c = tail call %struct.Memory* @sub_400e30._Z5timerv(%struct.State* %0, i64 %334, %struct.Memory* %MEMORY.0)
  ...
  %call2_40a525 = tail call %struct.Memory* @sub_4007d0._Z13record_resultdPKc(%struct.State* %0, i64 %345, %struct.Memory* %call2_40a51c)
