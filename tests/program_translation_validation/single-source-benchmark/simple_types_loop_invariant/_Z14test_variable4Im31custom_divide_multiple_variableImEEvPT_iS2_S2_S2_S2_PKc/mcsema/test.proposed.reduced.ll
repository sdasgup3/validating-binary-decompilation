; ModuleID = '/tmp/tmp9ico2p9f-query.ll'
...
define %struct.Memory* @_Z14test_variable4Im31custom_divide_multiple_variableImEEvPT_iS2_S2_S2_S2_PKc(%struct.State* noalias, i64, %struct.Memory* noalias readnone returned) local_unnamed_addr #1 {
entry:
  %var_2_3 = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %RBP.i = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 15, i32 0, i32 0
  %var_2_85 = load i64, i64* %var_2_3, align 8
  %var_2_86 = add i64 %var_2_85, -38503
  %call2_40a4c7 = tail call %struct.Memory* @sub_400e60._Z11start_timerv(%struct.State* %0, i64 %var_2_86, %struct.Memory* %2)
  %var_2_971 = load i64, i64* %RBP.i, align 8
  %var_2_982 = add i64 %var_2_971, -60
  %var_2_1003 = inttoptr i64 %var_2_982 to i32*
  %var_2_1014 = load i32, i32* %var_2_1003, align 4
  %var_2_1035 = load i32, i32* bitcast (%G_0x61a080_type* @G_0x61a080 to i32*), align 8
  %var_2_1046 = sub i32 %var_2_1014, %var_2_1035
  %var_2_1197 = lshr i32 %var_2_1046, 31
  %var_2_1218 = lshr i32 %var_2_1014, 31
  %var_2_1229 = lshr i32 %var_2_1035, 31
  %var_2_12310 = xor i32 %var_2_1229, %var_2_1218
  %var_2_12411 = xor i32 %var_2_1197, %var_2_1218
  %var_2_12512 = add nuw nsw i32 %var_2_12411, %var_2_12310
  %var_2_12613 = icmp eq i32 %var_2_12512, 2
  %var_2_12814 = icmp ne i32 %var_2_1197, 0
  %var_2_12915 = xor i1 %var_2_12814, %var_2_12613
  br i1 %var_2_12915, label %block_40a4e3.preheader, label %block_.L_40a55c

block_40a4e3.preheader:                           ; preds = %entry
  %var_2_141 = add i64 %var_2_971, -76
  %var_2_143 = inttoptr i64 %var_2_141 to i32*
  %var_2_144 = load i32, i32* %var_2_143, align 4
  %var_2_146 = add i64 %var_2_971, -12
  %var_2_148 = inttoptr i64 %var_2_146 to i32*
  %var_2_149 = load i32, i32* %var_2_148, align 4
  %var_2_150 = sub i32 %var_2_144, %var_2_149
  %var_2_165 = lshr i32 %var_2_150, 31
  %var_2_167 = lshr i32 %var_2_144, 31
  %var_2_168 = lshr i32 %var_2_149, 31
  %var_2_169 = xor i32 %var_2_168, %var_2_167
  %var_2_170 = xor i32 %var_2_165, %var_2_167
  %var_2_171 = add nuw nsw i32 %var_2_170, %var_2_169
  %var_2_172 = icmp eq i32 %var_2_171, 2
  %var_2_174 = icmp ne i32 %var_2_165, 0
  %var_2_175 = xor i1 %var_2_174, %var_2_172
  br i1 %var_2_175, label %block_.L_40a4f2.preheader, label %block_40a4e3.preheader5

block_40a4e3.preheader5:                          ; preds = %block_40a4e3.preheader
  br label %block_40a4e3

block_.L_40a4f2.preheader:                        ; preds = %block_40a4e3.preheader
  br label %block_.L_40a4f2

block_40a4e3:                                     ; preds = %block_40a4e3.preheader5, %block_40a4e3
  br label %block_40a4e3

block_.L_40a4f2:                                  ; preds = %block_.L_40a4f2.preheader, %block_.L_40a4f2
  br label %block_.L_40a4f2

block_.L_40a55c:                                  ; preds = %entry
  %.pre = load i64, i64* %var_2_3, align 8
  %var_2_334 = add i64 %.pre, -38483
  %call2_40a55c = tail call %struct.Memory* @sub_400e80._Z5timerv(%struct.State* nonnull %0, i64 %var_2_334, %struct.Memory* %call2_40a4c7)
  %var_2_341 = load i64, i64* %var_2_3, align 8
  %var_2_345 = add i64 %var_2_341, -40257
  %call2_40a565 = tail call %struct.Memory* @sub_400820._Z13record_resultdPKc(%struct.State* nonnull %0, i64 %var_2_345, %struct.Memory* %call2_40a55c)
