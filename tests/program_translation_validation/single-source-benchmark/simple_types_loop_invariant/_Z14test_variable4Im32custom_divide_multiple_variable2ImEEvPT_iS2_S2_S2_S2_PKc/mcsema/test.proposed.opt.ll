...
block_.L_40a563:                                  ; preds = %block_.L_40a5c5, %entry
  %96 = phi i64 [ %.pre, %entry ], [ %335, %block_.L_40a5c5 ]
...
block_.L_40a582:                                  ; preds = %block_40a58e, %block_40a573
  %139 = phi i64 [ %.pre1, %block_40a573 ], [ %277, %block_40a58e ]
...
block_.L_40a5c5:                                  ; preds = %block_.L_40a582
  ...
  %call2_40a5d9 = tail call %struct.Memory* @sub_40d700._Z26check_shifted_variable_sumIm32custom_divide_multiple_variable2ImEEvT_S2_S2_S2_S2_(%struct.State* %0, i64 %298, %struct.Memory* %MEMORY.1)
...
block_.L_40a5ec:                                  ; preds = %block_.L_40a563
  ...
  %call2_40a5ec = tail call %struct.Memory* @sub_400e30._Z5timerv(%struct.State* %0, i64 %336, %struct.Memory* %MEMORY.0)
  ...
  %call2_40a5f5 = tail call %struct.Memory* @sub_4007d0._Z13record_resultdPKc(%struct.State* %0, i64 %347, %struct.Memory* %call2_40a5ec)
