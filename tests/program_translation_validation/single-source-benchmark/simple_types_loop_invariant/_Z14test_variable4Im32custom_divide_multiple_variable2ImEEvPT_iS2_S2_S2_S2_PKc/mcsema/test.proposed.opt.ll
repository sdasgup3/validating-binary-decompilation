...
declare %struct.Memory* @sub_40d6e0._ZN32custom_divide_multiple_variable2ImE8do_shiftEmmmmm(%struct.State* noalias dereferenceable(3376), i64, %struct.Memory* noalias readnone returned) local_unnamed_addr

declare %struct.Memory* @sub_40d730._Z26check_shifted_variable_sumIm32custom_divide_multiple_variable2ImEEvT_S2_S2_S2_S2_(%struct.State* noalias dereferenceable(3376), i64, %struct.Memory* noalias readnone returned) local_unnamed_addr
...
define %struct.Memory* @_Z14test_variable4Im32custom_divide_multiple_variable2ImEEvPT_iS2_S2_S2_S2_PKc(%struct.State* noalias, i64, %struct.Memory* noalias readnone) local_unnamed_addr #1 {
entry:
...
block_.L_40a593:                                  ; preds = %block_.L_40a5f5, %entry
  %96 = phi i64 [ %333, %block_.L_40a5f5 ], [ %.pre, %entry ]
...
block_.L_40a5b2:                                  ; preds = %block_40a5be, %block_40a5a3
  %139 = phi i64 [ %276, %block_40a5be ], [ %.pre6, %block_40a5a3 ]
...
block_40a5be:                                     ; preds = %block_.L_40a5b2
  ...
  %call2_40a5da = tail call %struct.Memory* @sub_40d6e0._ZN32custom_divide_multiple_variable2ImE8do_shiftEmmmmm(%struct.State* nonnull %0, i64 %205, %struct.Memory* %call2_40a587)
...
block_.L_40a5f5:                                  ; preds = %block_.L_40a5b2
  ...
  %call2_40a609 = tail call %struct.Memory* @sub_40d730._Z26check_shifted_variable_sumIm32custom_divide_multiple_variable2ImEEvT_S2_S2_S2_S2_(%struct.State* nonnull %0, i64 %297, %struct.Memory* %call2_40a587)
...
block_.L_40a61c:                                  ; preds = %block_.L_40a593
  ...
  %call2_40a61c = tail call %struct.Memory* @sub_400e70._Z5timerv(%struct.State* nonnull %0, i64 %334, %struct.Memory* %call2_40a587)
