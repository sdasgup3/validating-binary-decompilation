...
declare %struct.Memory* @sub_40d740._Z26check_shifted_variable_sumIm32custom_divide_multiple_variable2ImEEvT_S2_S2_S2_S2_(%struct.State* noalias dereferenceable(3376), i64, %struct.Memory* noalias readnone returned) local_unnamed_addr
...
entry:
  ...
  %call2_40a597 = tail call %struct.Memory* @sub_400e60._Z11start_timerv(%struct.State* %0, i64 %86, %struct.Memory* %2)
...
block_.L_40a5a3:                                  ; preds = %block_.L_40a605, %entry
  %96 = phi i64 [ %333, %block_.L_40a605 ], [ %.pre, %entry ]
  ...
  br i1 %129, label %block_40a5b3, label %block_.L_40a62c

block_40a5b3:                                     ; preds = %block_.L_40a5a3
  %131 = add i64 %97, -72
  %132 = add i64 %130, 8
...
block_.L_40a5c2:                                  ; preds = %block_40a5ce, %block_40a5b3
  %139 = phi i64 [ %276, %block_40a5ce ], [ %.pre6, %block_40a5b3 ]
  ...
  br i1 %175, label %block_40a5ce, label %block_.L_40a605

block_40a5ce:                                     ; preds = %block_.L_40a5c2
  %177 = add i64 %140, -8
  %178 = add i64 %176, 4
  ...
  %call2_40a5ea = tail call %struct.Memory* @sub_40d6f0._ZN32custom_divide_multiple_variable2ImE8do_shiftEmmmmm(%struct.State* nonnull %0, i64 %205, %struct.Memory* %call2_40a597)
...
block_.L_40a605:                                  ; preds = %block_.L_40a5c2
  %277 = add i64 %140, -72
  %278 = add i64 %176, 4
  ...
  %call2_40a619 = tail call %struct.Memory* @sub_40d740._Z26check_shifted_variable_sumIm32custom_divide_multiple_variable2ImEEvT_S2_S2_S2_S2_(%struct.State* nonnull %0, i64 %297, %struct.Memory* %call2_40a597)
...
block_.L_40a62c:                                  ; preds = %block_.L_40a5a3
  ...
  %call2_40a62c = tail call %struct.Memory* @sub_400e80._Z5timerv(%struct.State* nonnull %0, i64 %334, %struct.Memory* %call2_40a597)
  ...
  %call2_40a635 = tail call %struct.Memory* @sub_400820._Z13record_resultdPKc(%struct.State* nonnull %0, i64 %345, %struct.Memory* %call2_40a62c)
