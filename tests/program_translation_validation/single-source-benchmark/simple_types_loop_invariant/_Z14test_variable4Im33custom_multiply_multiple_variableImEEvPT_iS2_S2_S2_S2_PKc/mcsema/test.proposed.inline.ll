...
define %struct.Memory* @_Z14test_variable4Im33custom_multiply_multiple_variableImEEvPT_iS2_S2_S2_S2_PKc(%struct.State* noalias, i64, %struct.Memory* noalias) #1 {
entry:
  ...
  store %struct.Memory* %loadMem_40a25b, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem1_40a267, %struct.Memory** %MEMORY
...
block_40a29e:                                     ; preds = %block_.L_40a292
  ...
  store %struct.Memory* %loadMem_40a29e, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem1_40a2ba, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_40a2c7, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_40a2ca, %struct.Memory** %MEMORY
...
block_.L_40a2d5:                                  ; preds = %block_.L_40a292
  ...
  store %struct.Memory* %loadMem1_40a2e9, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_40a2ee, %struct.Memory** %MEMORY
...
block_.L_40a2fc:                                  ; preds = %block_.L_40a273
  ...
  store %struct.Memory* %loadMem1_40a2fc, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem1_40a305, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_40a30a, %struct.Memory** %MEMORY
  ...
  ret %struct.Memory* %loadMem_40a30f
}
