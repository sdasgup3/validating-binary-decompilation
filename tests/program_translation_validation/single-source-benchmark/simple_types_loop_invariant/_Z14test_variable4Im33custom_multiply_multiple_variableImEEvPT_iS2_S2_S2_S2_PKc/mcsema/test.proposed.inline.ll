...
entry:
  ...
  store %struct.Memory* %loadMem_40a220, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem1_40a237, %struct.Memory** %MEMORY
...
block_40a26e:                                     ; preds = %block_.L_40a262
  ...
  store %struct.Memory* %loadMem_40a27a, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem1_40a28a, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_40a29a, %struct.Memory** %MEMORY
...
block_.L_40a2a5:                                  ; preds = %block_.L_40a262
  ...
  store %struct.Memory* %loadMem1_40a2b9, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_40a2c1, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_40a2c4, %struct.Memory** %MEMORY
...
block_.L_40a2cc:                                  ; preds = %block_.L_40a243
  ...
  store %struct.Memory* %loadMem1_40a2cc, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem1_40a2d5, %struct.Memory** %MEMORY
  ...
  ret %struct.Memory* %loadMem_40a2df
}
