...
block_.L_40a243:                                  ; preds = %block_.L_40a2a5, %entry
  %96 = phi i64 [ %.pre, %entry ], [ %335, %block_.L_40a2a5 ]
...
block_.L_40a262:                                  ; preds = %block_40a26e, %block_40a253
  %139 = phi i64 [ %.pre1, %block_40a253 ], [ %277, %block_40a26e ]
...
block_.L_40a2a5:                                  ; preds = %block_.L_40a262
  ...
  %call2_40a2b9 = tail call %struct.Memory* @sub_40dad0._Z26check_shifted_variable_sumIm33custom_multiply_multiple_variableImEEvT_S2_S2_S2_S2_(%struct.State* %0, i64 %298, %struct.Memory* %MEMORY.1)
...
block_.L_40a2cc:                                  ; preds = %block_.L_40a243
  ...
  %call2_40a2cc = tail call %struct.Memory* @sub_400e30._Z5timerv(%struct.State* %0, i64 %336, %struct.Memory* %MEMORY.0)
  ...
  %call2_40a2d5 = tail call %struct.Memory* @sub_4007d0._Z13record_resultdPKc(%struct.State* %0, i64 %347, %struct.Memory* %call2_40a2cc)
