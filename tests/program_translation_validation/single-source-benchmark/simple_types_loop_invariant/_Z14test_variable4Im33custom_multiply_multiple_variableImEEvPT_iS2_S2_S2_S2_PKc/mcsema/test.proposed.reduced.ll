; ModuleID = '/tmp/tmp4opzzzjl-query.ll'
...
define %struct.Memory* @_Z14test_variable4Im33custom_multiply_multiple_variableImEEvPT_iS2_S2_S2_S2_PKc(%struct.State* noalias, i64, %struct.Memory* noalias readnone returned) local_unnamed_addr #1 {
entry:
  %var_2_3 = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %RBP.i = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 15, i32 0, i32 0
  %var_2_85 = load i64, i64* %var_2_3, align 8
  %var_2_86 = add i64 %var_2_85, -37911
  %call2_40a277 = tail call %struct.Memory* @sub_400e60._Z11start_timerv(%struct.State* %0, i64 %var_2_86, %struct.Memory* %2)
  ...
  br i1 %var_2_12915, label %block_40a293.preheader, label %block_.L_40a30c

block_40a293.preheader:                           ; preds = %entry
  ...
  br i1 %var_2_175, label %block_.L_40a2a2.preheader, label %block_40a293.preheader5

block_40a293.preheader5:                          ; preds = %block_40a293.preheader
  br label %block_40a293

block_.L_40a2a2.preheader:                        ; preds = %block_40a293.preheader
  br label %block_.L_40a2a2

block_40a293:                                     ; preds = %block_40a293.preheader5, %block_40a293
  br label %block_40a293

block_.L_40a2a2:                                  ; preds = %block_.L_40a2a2.preheader, %block_.L_40a2a2
  br label %block_.L_40a2a2

block_.L_40a30c:                                  ; preds = %entry
  %.pre = load i64, i64* %var_2_3, align 8
  %var_2_334 = add i64 %.pre, -37891
  %call2_40a30c = tail call %struct.Memory* @sub_400e80._Z5timerv(%struct.State* nonnull %0, i64 %var_2_334, %struct.Memory* %call2_40a277)
  %var_2_341 = load i64, i64* %var_2_3, align 8
  %var_2_345 = add i64 %var_2_341, -39665
  %call2_40a315 = tail call %struct.Memory* @sub_400820._Z13record_resultdPKc(%struct.State* nonnull %0, i64 %var_2_345, %struct.Memory* %call2_40a30c)
