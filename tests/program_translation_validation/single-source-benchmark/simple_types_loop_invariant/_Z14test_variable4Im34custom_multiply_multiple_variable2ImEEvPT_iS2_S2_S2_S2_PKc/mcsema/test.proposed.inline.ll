...
define %struct.Memory* @_Z14test_variable4Im34custom_multiply_multiple_variable2ImEEvPT_iS2_S2_S2_S2_PKc(%struct.State* noalias, i64, %struct.Memory* noalias) #1 {
entry:
  ...
  store %struct.Memory* %loadMem_40a310, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_40a314, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_40a32f, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem1_40a337, %struct.Memory** %MEMORY
...
block_.L_40a362:                                  ; preds = %block_40a36e, %block_40a353
  ...
  store %struct.Memory* %loadMem_40a365, %struct.Memory** %MEMORY
...
block_40a36e:                                     ; preds = %block_.L_40a362
  ...
  store %struct.Memory* %loadMem_40a376, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_40a37a, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem1_40a38a, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_40a39a, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_40a3a0, %struct.Memory** %MEMORY
  br label %block_.L_40a362
...
block_.L_40a3a5:                                  ; preds = %block_.L_40a362
  ...
  store %struct.Memory* %loadMem1_40a3b9, %struct.Memory** %MEMORY
...
block_.L_40a3cc:                                  ; preds = %block_.L_40a343
  ...
  store %struct.Memory* %loadMem1_40a3cc, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem1_40a3d5, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_40a3de, %struct.Memory** %MEMORY
  ...
  ret %struct.Memory* %loadMem_40a3df
}
