...
block_.L_40a313:                                  ; preds = %block_.L_40a375, %entry
  %96 = phi i64 [ %.pre, %entry ], [ %333, %block_.L_40a375 ]
...
block_.L_40a332:                                  ; preds = %block_40a33e, %block_40a323
  %139 = phi i64 [ %.pre1, %block_40a323 ], [ %276, %block_40a33e ]
...
block_.L_40a375:                                  ; preds = %block_.L_40a332
  ...
  %call2_40a389 = tail call %struct.Memory* @sub_40d9d0._Z26check_shifted_variable_sumIm34custom_multiply_multiple_variable2ImEEvT_S2_S2_S2_S2_(%struct.State* %0, i64 %297, %struct.Memory* %MEMORY.1)
...
block_.L_40a39c:                                  ; preds = %block_.L_40a313
  ...
  %call2_40a39c = tail call %struct.Memory* @sub_400e30._Z5timerv(%struct.State* %0, i64 %334, %struct.Memory* %MEMORY.0)
  ...
  %call2_40a3a5 = tail call %struct.Memory* @sub_4007d0._Z13record_resultdPKc(%struct.State* %0, i64 %345, %struct.Memory* %call2_40a39c)
