...
declare %struct.Memory* @sub_40d9c0._ZN34custom_multiply_multiple_variable2ImE8do_shiftEmmmmm(%struct.State* dereferenceable(3376), i64, %struct.Memory*) local_unnamed_addr

declare %struct.Memory* @sub_40da00._Z26check_shifted_variable_sumIm34custom_multiply_multiple_variable2ImEEvT_S2_S2_S2_S2_(%struct.State* dereferenceable(3376), i64, %struct.Memory*) local_unnamed_addr
...
block_.L_40a343:                                  ; preds = %block_.L_40a3a5, %entry
  %96 = phi i64 [ %.pre, %entry ], [ %333, %block_.L_40a3a5 ]
  %MEMORY.0 = phi %struct.Memory* [ %call2_40a337, %entry ], [ %call2_40a3b9, %block_.L_40a3a5 ]
...
block_.L_40a362:                                  ; preds = %block_40a36e, %block_40a353
  %139 = phi i64 [ %.pre6, %block_40a353 ], [ %276, %block_40a36e ]
  %MEMORY.1 = phi %struct.Memory* [ %MEMORY.0, %block_40a353 ], [ %call2_40a38a, %block_40a36e ]
...
block_40a36e:                                     ; preds = %block_.L_40a362
  ...
  %call2_40a38a = tail call %struct.Memory* @sub_40d9c0._ZN34custom_multiply_multiple_variable2ImE8do_shiftEmmmmm(%struct.State* nonnull %0, i64 %205, %struct.Memory* %MEMORY.1)
...
block_.L_40a3a5:                                  ; preds = %block_.L_40a362
  ...
  %call2_40a3b9 = tail call %struct.Memory* @sub_40da00._Z26check_shifted_variable_sumIm34custom_multiply_multiple_variable2ImEEvT_S2_S2_S2_S2_(%struct.State* nonnull %0, i64 %297, %struct.Memory* %MEMORY.1)
...
block_.L_40a3cc:                                  ; preds = %block_.L_40a343
  ...
  %call2_40a3cc = tail call %struct.Memory* @sub_400e70._Z5timerv(%struct.State* nonnull %0, i64 %334, %struct.Memory* %MEMORY.0)
