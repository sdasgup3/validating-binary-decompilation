; ModuleID = '/tmp/tmpr66aosmo-query.ll'
...
define %struct.Memory* @_Z14test_variable4Im34custom_multiply_multiple_variable2ImEEvPT_iS2_S2_S2_S2_PKc(%struct.State* noalias, i64, %struct.Memory* noalias readnone returned) local_unnamed_addr #1 {
entry:
  %var_2_3 = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %RBP.i = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 15, i32 0, i32 0
  %var_2_85 = load i64, i64* %var_2_3, align 8
  %var_2_86 = add i64 %var_2_85, -38119
  %call2_40a347 = tail call %struct.Memory* @sub_400e60._Z11start_timerv(%struct.State* %0, i64 %var_2_86, %struct.Memory* %2)
  ...
  br i1 %var_2_12915, label %block_40a363.preheader, label %block_.L_40a3dc

block_40a363.preheader:                           ; preds = %entry
  ...
  br i1 %var_2_175, label %block_.L_40a372.preheader, label %block_40a363.preheader5

block_40a363.preheader5:                          ; preds = %block_40a363.preheader
  br label %block_40a363

block_.L_40a372.preheader:                        ; preds = %block_40a363.preheader
  br label %block_.L_40a372

block_40a363:                                     ; preds = %block_40a363.preheader5, %block_40a363
  br label %block_40a363

block_.L_40a372:                                  ; preds = %block_.L_40a372.preheader, %block_.L_40a372
  br label %block_.L_40a372

block_.L_40a3dc:                                  ; preds = %entry
  %.pre = load i64, i64* %var_2_3, align 8
  %var_2_334 = add i64 %.pre, -38099
  %call2_40a3dc = tail call %struct.Memory* @sub_400e80._Z5timerv(%struct.State* nonnull %0, i64 %var_2_334, %struct.Memory* %call2_40a347)
  %var_2_341 = load i64, i64* %var_2_3, align 8
  %var_2_345 = add i64 %var_2_341, -39873
  %call2_40a3e5 = tail call %struct.Memory* @sub_400820._Z13record_resultdPKc(%struct.State* nonnull %0, i64 %var_2_345, %struct.Memory* %call2_40a3dc)
