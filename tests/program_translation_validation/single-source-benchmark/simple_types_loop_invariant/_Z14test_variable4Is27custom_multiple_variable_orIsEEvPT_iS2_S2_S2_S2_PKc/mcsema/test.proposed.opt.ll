...
block_.L_405fb7:                                  ; preds = %block_.L_40603a, %entry
  %122 = phi i64 [ %.pre, %entry ], [ %409, %block_.L_40603a ]
...
block_.L_405fd4:                                  ; preds = %block_405fe0, %block_405fc7
  %165 = phi i64 [ %.pre1, %block_405fc7 ], [ %330, %block_405fe0 ]
...
block_.L_40603a:                                  ; preds = %block_.L_405fd4
  ...
  %call2_406067 = tail call %struct.Memory* @sub_411380._Z26check_shifted_variable_sumIs27custom_multiple_variable_orIsEEvT_S2_S2_S2_S2_(%struct.State* %0, i64 %373, %struct.Memory* %MEMORY.1)
...
block_.L_40607a:                                  ; preds = %block_.L_405fb7
  ...
  %call2_40607a = tail call %struct.Memory* @sub_400e30._Z5timerv(%struct.State* %0, i64 %410, %struct.Memory* %MEMORY.0)
  ...
  %call2_406083 = tail call %struct.Memory* @sub_4007d0._Z13record_resultdPKc(%struct.State* %0, i64 %421, %struct.Memory* %call2_40607a)
