...
declare %struct.Memory* @sub_4113c0._Z26check_shifted_variable_sumIs27custom_multiple_variable_orIsEEvT_S2_S2_S2_S2_(%struct.State* noalias dereferenceable(3376), i64, %struct.Memory* noalias readnone returned) local_unnamed_addr
...
entry:
  ...
  %call2_405feb = tail call %struct.Memory* @sub_400e60._Z11start_timerv(%struct.State* %0, i64 %110, %struct.Memory* %2)
...
block_.L_405ff7:                                  ; preds = %block_.L_40607a, %entry
  %122 = phi i64 [ %410, %block_.L_40607a ], [ %.pre, %entry ]
  ...
  br i1 %155, label %block_406007, label %block_.L_4060ba
...
block_.L_406014:                                  ; preds = %block_406020, %block_406007
  %165 = phi i64 [ %331, %block_406020 ], [ %.pre6, %block_406007 ]
  ...
  br i1 %201, label %block_406020, label %block_.L_40607a
...
block_406020:                                     ; preds = %block_.L_406014
  ...
  %call2_406057 = tail call %struct.Memory* @sub_411360._ZN27custom_multiple_variable_orIsE8do_shiftEsssss(%struct.State* nonnull %0, i64 %254, %struct.Memory* %call2_405feb)
...
block_.L_40607a:                                  ; preds = %block_.L_406014
  ...
  %call2_4060a7 = tail call %struct.Memory* @sub_4113c0._Z26check_shifted_variable_sumIs27custom_multiple_variable_orIsEEvT_S2_S2_S2_S2_(%struct.State* nonnull %0, i64 %374, %struct.Memory* %call2_405feb)
...
block_.L_4060ba:                                  ; preds = %block_.L_405ff7
  ...
  %call2_4060ba = tail call %struct.Memory* @sub_400e80._Z5timerv(%struct.State* nonnull %0, i64 %411, %struct.Memory* %call2_405feb)
  ...
  %call2_4060c3 = tail call %struct.Memory* @sub_400820._Z13record_resultdPKc(%struct.State* nonnull %0, i64 %422, %struct.Memory* %call2_4060ba)
