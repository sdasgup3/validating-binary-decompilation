...
declare %struct.Memory* @sub_411350._ZN27custom_multiple_variable_orIsE8do_shiftEsssss(%struct.State* noalias dereferenceable(3376), i64, %struct.Memory* noalias readnone returned) local_unnamed_addr

declare %struct.Memory* @sub_4113b0._Z26check_shifted_variable_sumIs27custom_multiple_variable_orIsEEvT_S2_S2_S2_S2_(%struct.State* noalias dereferenceable(3376), i64, %struct.Memory* noalias readnone returned) local_unnamed_addr
...
define %struct.Memory* @_Z14test_variable4Is27custom_multiple_variable_orIsEEvPT_iS2_S2_S2_S2_PKc(%struct.State* noalias, i64, %struct.Memory* noalias readnone) local_unnamed_addr #1 {
entry:
...
block_.L_405fe7:                                  ; preds = %block_.L_40606a, %entry
  %122 = phi i64 [ %410, %block_.L_40606a ], [ %.pre, %entry ]
...
block_.L_406004:                                  ; preds = %block_406010, %block_405ff7
  %165 = phi i64 [ %331, %block_406010 ], [ %.pre6, %block_405ff7 ]
...
block_406010:                                     ; preds = %block_.L_406004
  ...
  %call2_406047 = tail call %struct.Memory* @sub_411350._ZN27custom_multiple_variable_orIsE8do_shiftEsssss(%struct.State* nonnull %0, i64 %254, %struct.Memory* %call2_405fdb)
...
block_.L_40606a:                                  ; preds = %block_.L_406004
  ...
  %call2_406097 = tail call %struct.Memory* @sub_4113b0._Z26check_shifted_variable_sumIs27custom_multiple_variable_orIsEEvT_S2_S2_S2_S2_(%struct.State* nonnull %0, i64 %374, %struct.Memory* %call2_405fdb)
...
block_.L_4060aa:                                  ; preds = %block_.L_405fe7
  ...
  %call2_4060aa = tail call %struct.Memory* @sub_400e70._Z5timerv(%struct.State* nonnull %0, i64 %411, %struct.Memory* %call2_405fdb)
