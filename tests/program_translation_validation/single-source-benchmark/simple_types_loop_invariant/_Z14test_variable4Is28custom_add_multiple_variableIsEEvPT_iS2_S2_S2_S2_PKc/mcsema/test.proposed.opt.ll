...
declare %struct.Memory* @sub_412020._Z26check_shifted_variable_sumIs28custom_add_multiple_variableIsEEvT_S2_S2_S2_S2_(%struct.State* noalias dereferenceable(3376), i64, %struct.Memory* noalias readnone returned) local_unnamed_addr
...
define %struct.Memory* @_Z14test_variable4Is28custom_add_multiple_variableIsEEvPT_iS2_S2_S2_S2_PKc(%struct.State* noalias, i64, %struct.Memory* noalias readnone) local_unnamed_addr #1 {
entry:
...
block_.L_4052a7:                                  ; preds = %block_.L_40532a, %entry
  %122 = phi i64 [ %410, %block_.L_40532a ], [ %.pre, %entry ]
...
block_.L_4052c4:                                  ; preds = %block_4052d0, %block_4052b7
  %165 = phi i64 [ %331, %block_4052d0 ], [ %.pre6, %block_4052b7 ]
...
block_4052d0:                                     ; preds = %block_.L_4052c4
  ...
  %call2_405307 = tail call %struct.Memory* @sub_411fc0._ZN28custom_add_multiple_variableIsE8do_shiftEsssss(%struct.State* nonnull %0, i64 %254, %struct.Memory* %call2_40529b)
...
block_.L_40532a:                                  ; preds = %block_.L_4052c4
  ...
  %call2_405357 = tail call %struct.Memory* @sub_412020._Z26check_shifted_variable_sumIs28custom_add_multiple_variableIsEEvT_S2_S2_S2_S2_(%struct.State* nonnull %0, i64 %374, %struct.Memory* %call2_40529b)
...
block_.L_40536a:                                  ; preds = %block_.L_4052a7
  ...
  %call2_40536a = tail call %struct.Memory* @sub_400e70._Z5timerv(%struct.State* nonnull %0, i64 %411, %struct.Memory* %call2_40529b)
