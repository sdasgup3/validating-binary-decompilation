...
block_.L_405277:                                  ; preds = %block_.L_4052fa, %entry
  %122 = phi i64 [ %.pre, %entry ], [ %411, %block_.L_4052fa ]
...
block_.L_405294:                                  ; preds = %block_4052a0, %block_405287
  %165 = phi i64 [ %.pre1, %block_405287 ], [ %331, %block_4052a0 ]
...
block_.L_4052fa:                                  ; preds = %block_.L_405294
  ...
  %call2_405327 = tail call %struct.Memory* @sub_411ff0._Z26check_shifted_variable_sumIs28custom_add_multiple_variableIsEEvT_S2_S2_S2_S2_(%struct.State* %0, i64 %374, %struct.Memory* %MEMORY.1)
...
block_.L_40533a:                                  ; preds = %block_.L_405277
  ...
  %call2_40533a = tail call %struct.Memory* @sub_400e30._Z5timerv(%struct.State* %0, i64 %412, %struct.Memory* %MEMORY.0)
  ...
  %call2_405343 = tail call %struct.Memory* @sub_4007d0._Z13record_resultdPKc(%struct.State* %0, i64 %423, %struct.Memory* %call2_40533a)
