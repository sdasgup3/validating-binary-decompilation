...
declare %struct.Memory* @sub_412030._Z26check_shifted_variable_sumIs28custom_add_multiple_variableIsEEvT_S2_S2_S2_S2_(%struct.State* noalias dereferenceable(3376), i64, %struct.Memory* noalias readnone returned) local_unnamed_addr
...
entry:
  ...
  %call2_4052ab = tail call %struct.Memory* @sub_400e60._Z11start_timerv(%struct.State* %0, i64 %110, %struct.Memory* %2)
...
block_.L_4052b7:                                  ; preds = %block_.L_40533a, %entry
  %122 = phi i64 [ %410, %block_.L_40533a ], [ %.pre, %entry ]
  ...
  br i1 %155, label %block_4052c7, label %block_.L_40537a
...
block_.L_4052d4:                                  ; preds = %block_4052e0, %block_4052c7
  %165 = phi i64 [ %331, %block_4052e0 ], [ %.pre6, %block_4052c7 ]
  ...
  br i1 %201, label %block_4052e0, label %block_.L_40533a
...
block_4052e0:                                     ; preds = %block_.L_4052d4
  ...
  %call2_405317 = tail call %struct.Memory* @sub_411fd0._ZN28custom_add_multiple_variableIsE8do_shiftEsssss(%struct.State* nonnull %0, i64 %254, %struct.Memory* %call2_4052ab)
...
block_.L_40533a:                                  ; preds = %block_.L_4052d4
  ...
  %call2_405367 = tail call %struct.Memory* @sub_412030._Z26check_shifted_variable_sumIs28custom_add_multiple_variableIsEEvT_S2_S2_S2_S2_(%struct.State* nonnull %0, i64 %374, %struct.Memory* %call2_4052ab)
...
block_.L_40537a:                                  ; preds = %block_.L_4052b7
  ...
  %call2_40537a = tail call %struct.Memory* @sub_400e80._Z5timerv(%struct.State* nonnull %0, i64 %411, %struct.Memory* %call2_4052ab)
  ...
  %call2_405383 = tail call %struct.Memory* @sub_400820._Z13record_resultdPKc(%struct.State* nonnull %0, i64 %422, %struct.Memory* %call2_40537a)
