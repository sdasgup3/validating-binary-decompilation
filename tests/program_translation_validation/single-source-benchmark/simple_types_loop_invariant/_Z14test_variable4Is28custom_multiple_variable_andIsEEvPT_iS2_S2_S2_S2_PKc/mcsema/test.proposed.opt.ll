...
block_.L_405dc7:                                  ; preds = %block_.L_405e4a, %entry
  %122 = phi i64 [ %.pre, %entry ], [ %411, %block_.L_405e4a ]
...
block_.L_405de4:                                  ; preds = %block_405df0, %block_405dd7
  %165 = phi i64 [ %.pre1, %block_405dd7 ], [ %331, %block_405df0 ]
...
block_.L_405e4a:                                  ; preds = %block_.L_405de4
  ...
  %call2_405e77 = tail call %struct.Memory* @sub_411550._Z26check_shifted_variable_sumIs28custom_multiple_variable_andIsEEvT_S2_S2_S2_S2_(%struct.State* %0, i64 %374, %struct.Memory* %MEMORY.1)
...
block_.L_405e8a:                                  ; preds = %block_.L_405dc7
  ...
  %call2_405e8a = tail call %struct.Memory* @sub_400e30._Z5timerv(%struct.State* %0, i64 %412, %struct.Memory* %MEMORY.0)
  ...
  %call2_405e93 = tail call %struct.Memory* @sub_4007d0._Z13record_resultdPKc(%struct.State* %0, i64 %423, %struct.Memory* %call2_405e8a)
