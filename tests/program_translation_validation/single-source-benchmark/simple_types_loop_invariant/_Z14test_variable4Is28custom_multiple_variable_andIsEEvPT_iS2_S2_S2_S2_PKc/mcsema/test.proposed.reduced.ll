; ModuleID = '/tmp/tmpj1u854b9-query.ll'
...
define %struct.Memory* @_Z14test_variable4Is28custom_multiple_variable_andIsEEvPT_iS2_S2_S2_S2_PKc(%struct.State* noalias, i64, %struct.Memory* noalias readnone returned) local_unnamed_addr #1 {
entry:
  %var_2_3 = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %RBP.i = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 15, i32 0, i32 0
  %var_2_110 = add i64 %1, -20378
  %call2_405dfb = tail call %struct.Memory* @sub_400e60._Z11start_timerv(%struct.State* %0, i64 %var_2_110, %struct.Memory* %2)
  ...
  br i1 %var_2_15515, label %block_405e17.preheader, label %block_.L_405eca

block_405e17.preheader:                           ; preds = %entry
  ...
  br i1 %var_2_201, label %block_.L_405e24.preheader, label %block_405e17.preheader5

block_405e17.preheader5:                          ; preds = %block_405e17.preheader
  br label %block_405e17

block_.L_405e24.preheader:                        ; preds = %block_405e17.preheader
  br label %block_.L_405e24

block_405e17:                                     ; preds = %block_405e17.preheader5, %block_405e17
  br label %block_405e17

block_.L_405e24:                                  ; preds = %block_.L_405e24.preheader, %block_.L_405e24
  br label %block_.L_405e24

block_.L_405eca:                                  ; preds = %entry
  %.pre = load i64, i64* %var_2_3, align 8
  %var_2_411 = add i64 %.pre, -20359
  %call2_405eca = tail call %struct.Memory* @sub_400e80._Z5timerv(%struct.State* nonnull %0, i64 %var_2_411, %struct.Memory* %call2_405dfb)
  %var_2_418 = load i64, i64* %var_2_3, align 8
  %var_2_422 = add i64 %var_2_418, -22191
  %call2_405ed3 = tail call %struct.Memory* @sub_400820._Z13record_resultdPKc(%struct.State* nonnull %0, i64 %var_2_422, %struct.Memory* %call2_405eca)
