...
declare %struct.Memory* @sub_411120._ZN28custom_multiple_variable_xorIsE8do_shiftEsssss(%struct.State* dereferenceable(3376), i64, %struct.Memory*) local_unnamed_addr

declare %struct.Memory* @sub_411180._Z26check_shifted_variable_sumIs28custom_multiple_variable_xorIsEEvT_S2_S2_S2_S2_(%struct.State* dereferenceable(3376), i64, %struct.Memory*) local_unnamed_addr
...
block_.L_4061d7:                                  ; preds = %block_.L_40625a, %entry
  %122 = phi i64 [ %.pre, %entry ], [ %410, %block_.L_40625a ]
  %MEMORY.0 = phi %struct.Memory* [ %call2_4061cb, %entry ], [ %call2_406287, %block_.L_40625a ]
...
block_.L_4061f4:                                  ; preds = %block_406200, %block_4061e7
  %165 = phi i64 [ %.pre6, %block_4061e7 ], [ %331, %block_406200 ]
  %MEMORY.1 = phi %struct.Memory* [ %MEMORY.0, %block_4061e7 ], [ %call2_406237, %block_406200 ]
...
block_406200:                                     ; preds = %block_.L_4061f4
  ...
  %call2_406237 = tail call %struct.Memory* @sub_411120._ZN28custom_multiple_variable_xorIsE8do_shiftEsssss(%struct.State* nonnull %0, i64 %254, %struct.Memory* %MEMORY.1)
...
block_.L_40625a:                                  ; preds = %block_.L_4061f4
  ...
  %call2_406287 = tail call %struct.Memory* @sub_411180._Z26check_shifted_variable_sumIs28custom_multiple_variable_xorIsEEvT_S2_S2_S2_S2_(%struct.State* nonnull %0, i64 %374, %struct.Memory* %MEMORY.1)
...
block_.L_40629a:                                  ; preds = %block_.L_4061d7
  ...
  %call2_40629a = tail call %struct.Memory* @sub_400e70._Z5timerv(%struct.State* nonnull %0, i64 %411, %struct.Memory* %MEMORY.0)
