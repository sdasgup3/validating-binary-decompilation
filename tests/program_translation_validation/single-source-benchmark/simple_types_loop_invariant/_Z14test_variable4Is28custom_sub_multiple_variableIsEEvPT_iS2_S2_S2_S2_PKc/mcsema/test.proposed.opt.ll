...
block_.L_405467:                                  ; preds = %block_.L_4054ea, %entry
  %122 = phi i64 [ %.pre, %entry ], [ %409, %block_.L_4054ea ]
...
block_.L_405484:                                  ; preds = %block_405490, %block_405477
  %165 = phi i64 [ %.pre1, %block_405477 ], [ %330, %block_405490 ]
...
block_.L_4054ea:                                  ; preds = %block_.L_405484
  ...
  %call2_405517 = tail call %struct.Memory* @sub_411e20._Z26check_shifted_variable_sumIs28custom_sub_multiple_variableIsEEvT_S2_S2_S2_S2_(%struct.State* %0, i64 %373, %struct.Memory* %MEMORY.1)
...
block_.L_40552a:                                  ; preds = %block_.L_405467
  ...
  %call2_40552a = tail call %struct.Memory* @sub_400e30._Z5timerv(%struct.State* %0, i64 %410, %struct.Memory* %MEMORY.0)
  ...
  %call2_405533 = tail call %struct.Memory* @sub_4007d0._Z13record_resultdPKc(%struct.State* %0, i64 %421, %struct.Memory* %call2_40552a)
