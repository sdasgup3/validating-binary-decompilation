; ModuleID = '/tmp/tmp1lpv6tke-query.ll'
...
define %struct.Memory* @_Z14test_variable4Is28custom_sub_multiple_variableIsEEvPT_iS2_S2_S2_S2_PKc(%struct.State* noalias, i64, %struct.Memory* noalias readnone returned) local_unnamed_addr #1 {
entry:
  %var_2_3 = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %RBP.i = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 15, i32 0, i32 0
  %var_2_110 = add i64 %1, -17978
  %call2_40549b = tail call %struct.Memory* @sub_400e60._Z11start_timerv(%struct.State* %0, i64 %var_2_110, %struct.Memory* %2)
  ...
  br i1 %var_2_15515, label %block_4054b7.preheader, label %block_.L_40556a

block_4054b7.preheader:                           ; preds = %entry
  ...
  br i1 %var_2_201, label %block_.L_4054c4.preheader, label %block_4054b7.preheader5

block_4054b7.preheader5:                          ; preds = %block_4054b7.preheader
  br label %block_4054b7

block_.L_4054c4.preheader:                        ; preds = %block_4054b7.preheader
  br label %block_.L_4054c4

block_4054b7:                                     ; preds = %block_4054b7.preheader5, %block_4054b7
  br label %block_4054b7

block_.L_4054c4:                                  ; preds = %block_.L_4054c4.preheader, %block_.L_4054c4
  br label %block_.L_4054c4

block_.L_40556a:                                  ; preds = %entry
  %.pre = load i64, i64* %var_2_3, align 8
  %var_2_411 = add i64 %.pre, -17959
  %call2_40556a = tail call %struct.Memory* @sub_400e80._Z5timerv(%struct.State* nonnull %0, i64 %var_2_411, %struct.Memory* %call2_40549b)
  %var_2_418 = load i64, i64* %var_2_3, align 8
  %var_2_422 = add i64 %var_2_418, -19791
  %call2_405573 = tail call %struct.Memory* @sub_400820._Z13record_resultdPKc(%struct.State* nonnull %0, i64 %var_2_422, %struct.Memory* %call2_40556a)
