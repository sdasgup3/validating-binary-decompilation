...
declare %struct.Memory* @sub_411760._Z26check_shifted_variable_sumIs30custom_mixed_multiple_variableIsEEvT_S2_S2_S2_S2_(%struct.State* noalias dereferenceable(3376), i64, %struct.Memory* noalias readnone returned) local_unnamed_addr
...
entry:
  ...
  %call2_405c0b = tail call %struct.Memory* @sub_400e60._Z11start_timerv(%struct.State* %0, i64 %110, %struct.Memory* %2)
...
block_.L_405c17:                                  ; preds = %block_.L_405c9a, %entry
  %122 = phi i64 [ %410, %block_.L_405c9a ], [ %.pre, %entry ]
  ...
  br i1 %155, label %block_405c27, label %block_.L_405cda
...
block_.L_405c34:                                  ; preds = %block_405c40, %block_405c27
  %165 = phi i64 [ %331, %block_405c40 ], [ %.pre6, %block_405c27 ]
  ...
  br i1 %201, label %block_405c40, label %block_.L_405c9a
...
block_405c40:                                     ; preds = %block_.L_405c34
  ...
  %call2_405c77 = tail call %struct.Memory* @sub_411700._ZN30custom_mixed_multiple_variableIsE8do_shiftEsssss(%struct.State* nonnull %0, i64 %254, %struct.Memory* %call2_405c0b)
...
block_.L_405c9a:                                  ; preds = %block_.L_405c34
  ...
  %call2_405cc7 = tail call %struct.Memory* @sub_411760._Z26check_shifted_variable_sumIs30custom_mixed_multiple_variableIsEEvT_S2_S2_S2_S2_(%struct.State* nonnull %0, i64 %374, %struct.Memory* %call2_405c0b)
...
block_.L_405cda:                                  ; preds = %block_.L_405c17
  ...
  %call2_405cda = tail call %struct.Memory* @sub_400e80._Z5timerv(%struct.State* nonnull %0, i64 %411, %struct.Memory* %call2_405c0b)
  ...
  %call2_405ce3 = tail call %struct.Memory* @sub_400820._Z13record_resultdPKc(%struct.State* nonnull %0, i64 %422, %struct.Memory* %call2_405cda)
