...
declare %struct.Memory* @sub_4116f0._ZN30custom_mixed_multiple_variableIsE8do_shiftEsssss(%struct.State* noalias dereferenceable(3376), i64, %struct.Memory* noalias) local_unnamed_addr

declare %struct.Memory* @sub_411750._Z26check_shifted_variable_sumIs30custom_mixed_multiple_variableIsEEvT_S2_S2_S2_S2_(%struct.State* noalias dereferenceable(3376), i64, %struct.Memory* noalias) local_unnamed_addr
...
define %struct.Memory* @_Z14test_variable4Is30custom_mixed_multiple_variableIsEEvPT_iS2_S2_S2_S2_PKc(%struct.State* noalias, i64, %struct.Memory* noalias) local_unnamed_addr #1 {
entry:
  ...
  %call2_405bfb = tail call %struct.Memory* @sub_400e50._Z11start_timerv(%struct.State* %0, i64 %110, %struct.Memory* %2)
...
block_.L_405c07:                                  ; preds = %block_.L_405c8a, %entry
  %122 = phi i64 [ %.pre, %entry ], [ %410, %block_.L_405c8a ]
  %MEMORY.0 = phi %struct.Memory* [ %call2_405bfb, %entry ], [ %call2_405cb7, %block_.L_405c8a ]
  ...
  br i1 %155, label %block_405c17, label %block_.L_405cca

block_405c17:                                     ; preds = %block_.L_405c07
  %157 = add i64 %123, -54
  %158 = add i64 %156, 6
...
block_.L_405c24:                                  ; preds = %block_405c30, %block_405c17
  %165 = phi i64 [ %.pre6, %block_405c17 ], [ %331, %block_405c30 ]
  %MEMORY.1 = phi %struct.Memory* [ %MEMORY.0, %block_405c17 ], [ %call2_405c67, %block_405c30 ]
  ...
  br i1 %201, label %block_405c30, label %block_.L_405c8a

block_405c30:                                     ; preds = %block_.L_405c24
  %203 = add i64 %166, -24
  %204 = add i64 %202, 4
  ...
  %call2_405c67 = tail call %struct.Memory* @sub_4116f0._ZN30custom_mixed_multiple_variableIsE8do_shiftEsssss(%struct.State* nonnull %0, i64 %254, %struct.Memory* %MEMORY.1)
...
block_.L_405c8a:                                  ; preds = %block_.L_405c24
  %332 = add i64 %166, -54
  %333 = add i64 %202, 4
  ...
  %call2_405cb7 = tail call %struct.Memory* @sub_411750._Z26check_shifted_variable_sumIs30custom_mixed_multiple_variableIsEEvT_S2_S2_S2_S2_(%struct.State* nonnull %0, i64 %374, %struct.Memory* %MEMORY.1)
...
block_.L_405cca:                                  ; preds = %block_.L_405c07
  %411 = add i64 %156, -20058
  %412 = add i64 %156, 5
  ...
  %call2_405cca = tail call %struct.Memory* @sub_400e70._Z5timerv(%struct.State* nonnull %0, i64 %411, %struct.Memory* %MEMORY.0)
  ...
  %call2_405cd3 = tail call %struct.Memory* @sub_400810._Z13record_resultdPKc(%struct.State* nonnull %0, i64 %422, %struct.Memory* %call2_405cca)
  ...
  ret %struct.Memory* %call2_405cd3
}
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_jge_.L_405cca(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i8* nocapture %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_jge_.L_405c8a(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i8* nocapture %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 2, i32 9
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_jmpq_.L_405c24(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_jmpq_.L_405c07(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
