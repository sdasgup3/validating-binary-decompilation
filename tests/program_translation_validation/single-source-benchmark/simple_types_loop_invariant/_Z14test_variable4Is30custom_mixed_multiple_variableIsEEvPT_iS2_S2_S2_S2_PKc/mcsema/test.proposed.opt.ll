...
block_.L_405bd7:                                  ; preds = %block_.L_405c5a, %entry
  %122 = phi i64 [ %.pre, %entry ], [ %409, %block_.L_405c5a ]
...
block_.L_405bf4:                                  ; preds = %block_405c00, %block_405be7
  %165 = phi i64 [ %.pre1, %block_405be7 ], [ %330, %block_405c00 ]
...
block_.L_405c5a:                                  ; preds = %block_.L_405bf4
  ...
  %call2_405c87 = tail call %struct.Memory* @sub_411720._Z26check_shifted_variable_sumIs30custom_mixed_multiple_variableIsEEvT_S2_S2_S2_S2_(%struct.State* %0, i64 %373, %struct.Memory* %MEMORY.1)
...
block_.L_405c9a:                                  ; preds = %block_.L_405bd7
  ...
  %call2_405c9a = tail call %struct.Memory* @sub_400e30._Z5timerv(%struct.State* %0, i64 %410, %struct.Memory* %MEMORY.0)
  ...
  %call2_405ca3 = tail call %struct.Memory* @sub_4007d0._Z13record_resultdPKc(%struct.State* %0, i64 %421, %struct.Memory* %call2_405c9a)
