; ModuleID = '/tmp/tmp2mogopka-query.ll'
...
define %struct.Memory* @_Z14test_variable4Is31custom_divide_multiple_variableIsEEvPT_iS2_S2_S2_S2_PKc(%struct.State* noalias, i64, %struct.Memory* noalias readnone returned) local_unnamed_addr #1 {
entry:
  %var_2_3 = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %RBP.i = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 15, i32 0, i32 0
  %var_2_110 = add i64 %1, -19274
  %call2_4059ab = tail call %struct.Memory* @sub_400e60._Z11start_timerv(%struct.State* %0, i64 %var_2_110, %struct.Memory* %2)
  ...
  br i1 %var_2_15515, label %block_4059c7.preheader, label %block_.L_405a7a

block_4059c7.preheader:                           ; preds = %entry
  ...
  br i1 %var_2_201, label %block_.L_4059d4.preheader, label %block_4059c7.preheader5

block_4059c7.preheader5:                          ; preds = %block_4059c7.preheader
  br label %block_4059c7

block_.L_4059d4.preheader:                        ; preds = %block_4059c7.preheader
  br label %block_.L_4059d4

block_4059c7:                                     ; preds = %block_4059c7.preheader5, %block_4059c7
  br label %block_4059c7

block_.L_4059d4:                                  ; preds = %block_.L_4059d4.preheader, %block_.L_4059d4
  br label %block_.L_4059d4

block_.L_405a7a:                                  ; preds = %entry
  %.pre = load i64, i64* %var_2_3, align 8
  %var_2_411 = add i64 %.pre, -19255
  %call2_405a7a = tail call %struct.Memory* @sub_400e80._Z5timerv(%struct.State* nonnull %0, i64 %var_2_411, %struct.Memory* %call2_4059ab)
  %var_2_418 = load i64, i64* %var_2_3, align 8
  %var_2_422 = add i64 %var_2_418, -21087
  %call2_405a83 = tail call %struct.Memory* @sub_400820._Z13record_resultdPKc(%struct.State* nonnull %0, i64 %var_2_422, %struct.Memory* %call2_405a7a)
