...
block_.L_405aa7:                                  ; preds = %block_.L_405b2a, %entry
  %122 = phi i64 [ %.pre, %entry ], [ %411, %block_.L_405b2a ]
...
block_.L_405ac4:                                  ; preds = %block_405ad0, %block_405ab7
  %165 = phi i64 [ %.pre1, %block_405ab7 ], [ %331, %block_405ad0 ]
...
block_.L_405b2a:                                  ; preds = %block_.L_405ac4
  ...
  %call2_405b57 = tail call %struct.Memory* @sub_411840._Z26check_shifted_variable_sumIs32custom_divide_multiple_variable2IsEEvT_S2_S2_S2_S2_(%struct.State* %0, i64 %374, %struct.Memory* %MEMORY.1)
...
block_.L_405b6a:                                  ; preds = %block_.L_405aa7
  ...
  %call2_405b6a = tail call %struct.Memory* @sub_400e30._Z5timerv(%struct.State* %0, i64 %412, %struct.Memory* %MEMORY.0)
  ...
  %call2_405b73 = tail call %struct.Memory* @sub_4007d0._Z13record_resultdPKc(%struct.State* %0, i64 %423, %struct.Memory* %call2_405b6a)
