...
block_.L_405657:                                  ; preds = %block_.L_4056da, %entry
  %122 = phi i64 [ %.pre, %entry ], [ %409, %block_.L_4056da ]
...
block_.L_405674:                                  ; preds = %block_405680, %block_405667
  %165 = phi i64 [ %.pre1, %block_405667 ], [ %330, %block_405680 ]
...
block_.L_4056da:                                  ; preds = %block_.L_405674
  ...
  %call2_405707 = tail call %struct.Memory* @sub_411c50._Z26check_shifted_variable_sumIs33custom_multiply_multiple_variableIsEEvT_S2_S2_S2_S2_(%struct.State* %0, i64 %373, %struct.Memory* %MEMORY.1)
...
block_.L_40571a:                                  ; preds = %block_.L_405657
  ...
  %call2_40571a = tail call %struct.Memory* @sub_400e30._Z5timerv(%struct.State* %0, i64 %410, %struct.Memory* %MEMORY.0)
  ...
  %call2_405723 = tail call %struct.Memory* @sub_4007d0._Z13record_resultdPKc(%struct.State* %0, i64 %421, %struct.Memory* %call2_40571a)
