...
declare %struct.Memory* @sub_411c80._Z26check_shifted_variable_sumIs33custom_multiply_multiple_variableIsEEvT_S2_S2_S2_S2_(%struct.State* noalias dereferenceable(3376), i64, %struct.Memory* noalias readnone returned) local_unnamed_addr
...
block_.L_405687:                                  ; preds = %block_.L_40570a, %entry
  %122 = phi i64 [ %410, %block_.L_40570a ], [ %.pre, %entry ]
...
block_.L_4056a4:                                  ; preds = %block_4056b0, %block_405697
  %165 = phi i64 [ %331, %block_4056b0 ], [ %.pre6, %block_405697 ]
...
block_4056b0:                                     ; preds = %block_.L_4056a4
  ...
  %call2_4056e7 = tail call %struct.Memory* @sub_411c20._ZN33custom_multiply_multiple_variableIsE8do_shiftEsssss(%struct.State* nonnull %0, i64 %254, %struct.Memory* %call2_40567b)
...
block_.L_40570a:                                  ; preds = %block_.L_4056a4
  ...
  %call2_405737 = tail call %struct.Memory* @sub_411c80._Z26check_shifted_variable_sumIs33custom_multiply_multiple_variableIsEEvT_S2_S2_S2_S2_(%struct.State* nonnull %0, i64 %374, %struct.Memory* %call2_40567b)
...
block_.L_40574a:                                  ; preds = %block_.L_405687
  ...
  %call2_40574a = tail call %struct.Memory* @sub_400e70._Z5timerv(%struct.State* nonnull %0, i64 %411, %struct.Memory* %call2_40567b)
