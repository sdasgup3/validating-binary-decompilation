...
declare %struct.Memory* @sub_411c50._Z26check_shifted_variable_sumIs33custom_multiply_multiple_variableIsEEvT_S2_S2_S2_S2_(%struct.State* noalias dereferenceable(3376), i64, %struct.Memory* noalias readnone returned) local_unnamed_addr
...
entry:
  ...
  %call2_40564b = tail call %struct.Memory* @sub_400e10._Z11start_timerv(%struct.State* %0, i64 %110, %struct.Memory* %2)
  ...
  br label %block_.L_405657

block_.L_405657:                                  ; preds = %block_.L_4056da, %entry
  %122 = phi i64 [ %.pre, %entry ], [ %411, %block_.L_4056da ]
  %MEMORY.0 = phi %struct.Memory* [ %call2_40564b, %entry ], [ %call2_405707, %block_.L_4056da ]
  ...
  br i1 %155, label %block_405667, label %block_.L_40571a

block_405667:                                     ; preds = %block_.L_405657
  %157 = add i64 %123, -42
  %158 = add i64 %156, 6
  ...
  br label %block_.L_405674

block_.L_405674:                                  ; preds = %block_405680, %block_405667
  %165 = phi i64 [ %.pre1, %block_405667 ], [ %331, %block_405680 ]
  %MEMORY.1 = phi %struct.Memory* [ %MEMORY.0, %block_405667 ], [ %call2_4056b7, %block_405680 ]
  ...
  br i1 %201, label %block_405680, label %block_.L_4056da

block_405680:                                     ; preds = %block_.L_405674
  %203 = add i64 %166, -24
  %204 = add i64 %202, 4
  ...
  %call2_4056b7 = tail call %struct.Memory* @sub_411bf0._ZN33custom_multiply_multiple_variableIsE8do_shiftEsssss(%struct.State* %0, i64 %254, %struct.Memory* %MEMORY.1)
...
block_.L_4056da:                                  ; preds = %block_.L_405674
  %332 = add i64 %166, -42
  %333 = add i64 %202, 4
  ...
  %call2_405707 = tail call %struct.Memory* @sub_411c50._Z26check_shifted_variable_sumIs33custom_multiply_multiple_variableIsEEvT_S2_S2_S2_S2_(%struct.State* %0, i64 %374, %struct.Memory* %MEMORY.1)
...
block_.L_40571a:                                  ; preds = %block_.L_405657
  %412 = add i64 %156, -18666
  %413 = add i64 %156, 5
  ...
  %call2_40571a = tail call %struct.Memory* @sub_400e30._Z5timerv(%struct.State* %0, i64 %412, %struct.Memory* %MEMORY.0)
  ...
  %call2_405723 = tail call %struct.Memory* @sub_4007d0._Z13record_resultdPKc(%struct.State* %0, i64 %423, %struct.Memory* %call2_40571a)
  ...
  ret %struct.Memory* %call2_405723
}
...
define %struct.Memory* @routine_jge_.L_40571a(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i8* %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
...
define %struct.Memory* @routine_jge_.L_4056da(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i8* %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 2, i32 9
...
define %struct.Memory* @routine_jmpq_.L_405674(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
...
define %struct.Memory* @routine_callq_._Z26check_shifted_variable_sumIs33custom_multiply_multiple_variableIsEEvT_S2_S2_S2_S2_(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
...
define %struct.Memory* @routine_jmpq_.L_405657(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
