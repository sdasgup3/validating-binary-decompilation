...
declare %struct.Memory* @sub_411b00._ZN34custom_multiply_multiple_variable2IsE8do_shiftEsssss(%struct.State* dereferenceable(3376), i64, %struct.Memory*)

declare %struct.Memory* @sub_411b60._Z26check_shifted_variable_sumIs34custom_multiply_multiple_variable2IsEEvT_S2_S2_S2_S2_(%struct.State* dereferenceable(3376), i64, %struct.Memory*)
...
define %struct.Memory* @_Z14test_variable4Is34custom_multiply_multiple_variable2IsEEvPT_iS2_S2_S2_S2_PKc(%struct.State* noalias, i64, %struct.Memory* noalias) #1 {
entry:
