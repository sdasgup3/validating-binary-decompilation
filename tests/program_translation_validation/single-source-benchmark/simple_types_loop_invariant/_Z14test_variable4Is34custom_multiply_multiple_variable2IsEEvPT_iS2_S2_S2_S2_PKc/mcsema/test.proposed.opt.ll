...
declare %struct.Memory* @sub_411b00._ZN34custom_multiply_multiple_variable2IsE8do_shiftEsssss(%struct.State* noalias dereferenceable(3376), i64, %struct.Memory* noalias readnone returned) local_unnamed_addr

declare %struct.Memory* @sub_411b60._Z26check_shifted_variable_sumIs34custom_multiply_multiple_variable2IsEEvT_S2_S2_S2_S2_(%struct.State* noalias dereferenceable(3376), i64, %struct.Memory* noalias readnone returned) local_unnamed_addr
...
block_.L_4057b7:                                  ; preds = %block_.L_40583a, %entry
  %122 = phi i64 [ %410, %block_.L_40583a ], [ %.pre, %entry ]
...
block_.L_4057d4:                                  ; preds = %block_4057e0, %block_4057c7
  %165 = phi i64 [ %331, %block_4057e0 ], [ %.pre6, %block_4057c7 ]
...
block_4057e0:                                     ; preds = %block_.L_4057d4
  ...
  %call2_405817 = tail call %struct.Memory* @sub_411b00._ZN34custom_multiply_multiple_variable2IsE8do_shiftEsssss(%struct.State* nonnull %0, i64 %254, %struct.Memory* %call2_4057ab)
...
block_.L_40583a:                                  ; preds = %block_.L_4057d4
  ...
  %call2_405867 = tail call %struct.Memory* @sub_411b60._Z26check_shifted_variable_sumIs34custom_multiply_multiple_variable2IsEEvT_S2_S2_S2_S2_(%struct.State* nonnull %0, i64 %374, %struct.Memory* %call2_4057ab)
...
block_.L_40587a:                                  ; preds = %block_.L_4057b7
  ...
  %call2_40587a = tail call %struct.Memory* @sub_400e70._Z5timerv(%struct.State* nonnull %0, i64 %411, %struct.Memory* %call2_4057ab)
