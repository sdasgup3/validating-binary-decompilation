...
block_.L_405787:                                  ; preds = %block_.L_40580a, %entry
  %122 = phi i64 [ %.pre, %entry ], [ %411, %block_.L_40580a ]
...
block_.L_4057a4:                                  ; preds = %block_4057b0, %block_405797
  %165 = phi i64 [ %.pre1, %block_405797 ], [ %331, %block_4057b0 ]
...
block_.L_40580a:                                  ; preds = %block_.L_4057a4
  ...
  %call2_405837 = tail call %struct.Memory* @sub_411b30._Z26check_shifted_variable_sumIs34custom_multiply_multiple_variable2IsEEvT_S2_S2_S2_S2_(%struct.State* %0, i64 %374, %struct.Memory* %MEMORY.1)
...
block_.L_40584a:                                  ; preds = %block_.L_405787
  ...
  %call2_40584a = tail call %struct.Memory* @sub_400e30._Z5timerv(%struct.State* %0, i64 %412, %struct.Memory* %MEMORY.0)
  ...
  %call2_405853 = tail call %struct.Memory* @sub_4007d0._Z13record_resultdPKc(%struct.State* %0, i64 %423, %struct.Memory* %call2_40584a)
