...
declare %struct.Memory* @sub_410380._ZN27custom_multiple_variable_orItE8do_shiftEttttt(%struct.State* noalias dereferenceable(3376), i64, %struct.Memory* noalias readnone returned) local_unnamed_addr

declare %struct.Memory* @sub_4103e0._Z26check_shifted_variable_sumIt27custom_multiple_variable_orItEEvT_S2_S2_S2_S2_(%struct.State* noalias dereferenceable(3376), i64, %struct.Memory* noalias readnone returned) local_unnamed_addr
...
entry:
  ...
  %call2_40720b = tail call %struct.Memory* @sub_400e60._Z11start_timerv(%struct.State* %0, i64 %110, %struct.Memory* %2)
...
block_.L_407217:                                  ; preds = %block_.L_40729a, %entry
  %122 = phi i64 [ %386, %block_.L_40729a ], [ %.pre, %entry ]
  ...
  br i1 %155, label %block_407227, label %block_.L_4072da
...
block_.L_407234:                                  ; preds = %block_407240, %block_407227
  %165 = phi i64 [ %312, %block_407240 ], [ %.pre6, %block_407227 ]
  ...
  br i1 %201, label %block_407240, label %block_.L_40729a
...
block_407240:                                     ; preds = %block_.L_407234
  ...
  %call2_407277 = tail call %struct.Memory* @sub_410380._ZN27custom_multiple_variable_orItE8do_shiftEttttt(%struct.State* nonnull %0, i64 %249, %struct.Memory* %call2_40720b)
...
block_.L_40729a:                                  ; preds = %block_.L_407234
  ...
  %call2_4072c7 = tail call %struct.Memory* @sub_4103e0._Z26check_shifted_variable_sumIt27custom_multiple_variable_orItEEvT_S2_S2_S2_S2_(%struct.State* nonnull %0, i64 %350, %struct.Memory* %call2_40720b)
...
block_.L_4072da:                                  ; preds = %block_.L_407217
  ...
  %call2_4072da = tail call %struct.Memory* @sub_400e80._Z5timerv(%struct.State* nonnull %0, i64 %387, %struct.Memory* %call2_40720b)
  ...
  %call2_4072e3 = tail call %struct.Memory* @sub_400820._Z13record_resultdPKc(%struct.State* nonnull %0, i64 %398, %struct.Memory* %call2_4072da)
