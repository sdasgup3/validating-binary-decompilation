...
declare %struct.Memory* @sub_410370._ZN27custom_multiple_variable_orItE8do_shiftEttttt(%struct.State* dereferenceable(3376), i64, %struct.Memory*) local_unnamed_addr

declare %struct.Memory* @sub_4103d0._Z26check_shifted_variable_sumIt27custom_multiple_variable_orItEEvT_S2_S2_S2_S2_(%struct.State* dereferenceable(3376), i64, %struct.Memory*) local_unnamed_addr
...
block_.L_407207:                                  ; preds = %block_.L_40728a, %entry
  %122 = phi i64 [ %.pre, %entry ], [ %386, %block_.L_40728a ]
  %MEMORY.0 = phi %struct.Memory* [ %call2_4071fb, %entry ], [ %call2_4072b7, %block_.L_40728a ]
...
block_.L_407224:                                  ; preds = %block_407230, %block_407217
  %165 = phi i64 [ %.pre6, %block_407217 ], [ %312, %block_407230 ]
  %MEMORY.1 = phi %struct.Memory* [ %MEMORY.0, %block_407217 ], [ %call2_407267, %block_407230 ]
...
block_407230:                                     ; preds = %block_.L_407224
  ...
  %call2_407267 = tail call %struct.Memory* @sub_410370._ZN27custom_multiple_variable_orItE8do_shiftEttttt(%struct.State* nonnull %0, i64 %249, %struct.Memory* %MEMORY.1)
...
block_.L_40728a:                                  ; preds = %block_.L_407224
  ...
  %call2_4072b7 = tail call %struct.Memory* @sub_4103d0._Z26check_shifted_variable_sumIt27custom_multiple_variable_orItEEvT_S2_S2_S2_S2_(%struct.State* nonnull %0, i64 %350, %struct.Memory* %MEMORY.1)
...
block_.L_4072ca:                                  ; preds = %block_.L_407207
  ...
  %call2_4072ca = tail call %struct.Memory* @sub_400e70._Z5timerv(%struct.State* nonnull %0, i64 %387, %struct.Memory* %MEMORY.0)
