...
block_.L_4071d7:                                  ; preds = %block_.L_40725a, %entry
  %122 = phi i64 [ %.pre, %entry ], [ %386, %block_.L_40725a ]
...
block_.L_4071f4:                                  ; preds = %block_407200, %block_4071e7
  %165 = phi i64 [ %.pre1, %block_4071e7 ], [ %312, %block_407200 ]
...
block_.L_40725a:                                  ; preds = %block_.L_4071f4
  ...
  %call2_407287 = tail call %struct.Memory* @sub_4103a0._Z26check_shifted_variable_sumIt27custom_multiple_variable_orItEEvT_S2_S2_S2_S2_(%struct.State* %0, i64 %350, %struct.Memory* %MEMORY.1)
...
block_.L_40729a:                                  ; preds = %block_.L_4071d7
  ...
  %call2_40729a = tail call %struct.Memory* @sub_400e30._Z5timerv(%struct.State* %0, i64 %387, %struct.Memory* %MEMORY.0)
  ...
  %call2_4072a3 = tail call %struct.Memory* @sub_4007d0._Z13record_resultdPKc(%struct.State* %0, i64 %398, %struct.Memory* %call2_40729a)
