...
block_.L_406497:                                  ; preds = %block_.L_40651a, %entry
  %122 = phi i64 [ %.pre, %entry ], [ %386, %block_.L_40651a ]
...
block_.L_4064b4:                                  ; preds = %block_4064c0, %block_4064a7
  %165 = phi i64 [ %.pre1, %block_4064a7 ], [ %312, %block_4064c0 ]
...
block_.L_40651a:                                  ; preds = %block_.L_4064b4
  ...
  %call2_406547 = tail call %struct.Memory* @sub_410f90._Z26check_shifted_variable_sumIt28custom_add_multiple_variableItEEvT_S2_S2_S2_S2_(%struct.State* %0, i64 %350, %struct.Memory* %MEMORY.1)
...
block_.L_40655a:                                  ; preds = %block_.L_406497
  ...
  %call2_40655a = tail call %struct.Memory* @sub_400e30._Z5timerv(%struct.State* %0, i64 %387, %struct.Memory* %MEMORY.0)
  ...
  %call2_406563 = tail call %struct.Memory* @sub_4007d0._Z13record_resultdPKc(%struct.State* %0, i64 %398, %struct.Memory* %call2_40655a)
