...
declare %struct.Memory* @sub_410f90._Z26check_shifted_variable_sumIt28custom_add_multiple_variableItEEvT_S2_S2_S2_S2_(%struct.State* noalias dereferenceable(3376), i64, %struct.Memory* noalias readnone returned) local_unnamed_addr
...
entry:
  ...
  %call2_40648b = tail call %struct.Memory* @sub_400e10._Z11start_timerv(%struct.State* %0, i64 %110, %struct.Memory* %2)
...
block_.L_406497:                                  ; preds = %block_.L_40651a, %entry
  %122 = phi i64 [ %.pre, %entry ], [ %388, %block_.L_40651a ]
  %MEMORY.0 = phi %struct.Memory* [ %call2_40648b, %entry ], [ %call2_406547, %block_.L_40651a ]
  ...
  br i1 %155, label %block_4064a7, label %block_.L_40655a
...
block_.L_4064b4:                                  ; preds = %block_4064c0, %block_4064a7
  %165 = phi i64 [ %.pre1, %block_4064a7 ], [ %313, %block_4064c0 ]
  %MEMORY.1 = phi %struct.Memory* [ %MEMORY.0, %block_4064a7 ], [ %call2_4064f7, %block_4064c0 ]
  ...
  br i1 %201, label %block_4064c0, label %block_.L_40651a
...
block_4064c0:                                     ; preds = %block_.L_4064b4
  ...
  %call2_4064f7 = tail call %struct.Memory* @sub_410f30._ZN28custom_add_multiple_variableItE8do_shiftEttttt(%struct.State* %0, i64 %249, %struct.Memory* %MEMORY.1)
...
block_.L_40651a:                                  ; preds = %block_.L_4064b4
  ...
  %call2_406547 = tail call %struct.Memory* @sub_410f90._Z26check_shifted_variable_sumIt28custom_add_multiple_variableItEEvT_S2_S2_S2_S2_(%struct.State* %0, i64 %351, %struct.Memory* %MEMORY.1)
...
block_.L_40655a:                                  ; preds = %block_.L_406497
  ...
  %call2_40655a = tail call %struct.Memory* @sub_400e30._Z5timerv(%struct.State* %0, i64 %389, %struct.Memory* %MEMORY.0)
  ...
  %call2_406563 = tail call %struct.Memory* @sub_4007d0._Z13record_resultdPKc(%struct.State* %0, i64 %400, %struct.Memory* %call2_40655a)
  ...
  ret %struct.Memory* %call2_406563
}
...
define %struct.Memory* @routine_jge_.L_40655a(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i8* %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
...
define %struct.Memory* @routine_jge_.L_40651a(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i8* %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 2, i32 9
...
define %struct.Memory* @routine_jmpq_.L_4064b4(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
...
define %struct.Memory* @routine_callq_._Z26check_shifted_variable_sumIt28custom_add_multiple_variableItEEvT_S2_S2_S2_S2_(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
...
define %struct.Memory* @routine_jmpq_.L_406497(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
