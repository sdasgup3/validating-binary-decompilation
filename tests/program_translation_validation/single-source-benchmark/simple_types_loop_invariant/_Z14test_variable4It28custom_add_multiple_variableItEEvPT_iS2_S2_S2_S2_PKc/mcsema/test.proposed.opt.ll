...
declare %struct.Memory* @sub_410f60._ZN28custom_add_multiple_variableItE8do_shiftEttttt(%struct.State* noalias dereferenceable(3376), i64, %struct.Memory* noalias readnone returned) local_unnamed_addr

declare %struct.Memory* @sub_410fc0._Z26check_shifted_variable_sumIt28custom_add_multiple_variableItEEvT_S2_S2_S2_S2_(%struct.State* noalias dereferenceable(3376), i64, %struct.Memory* noalias readnone returned) local_unnamed_addr
...
block_.L_4064c7:                                  ; preds = %block_.L_40654a, %entry
  %122 = phi i64 [ %386, %block_.L_40654a ], [ %.pre, %entry ]
...
block_.L_4064e4:                                  ; preds = %block_4064f0, %block_4064d7
  %165 = phi i64 [ %312, %block_4064f0 ], [ %.pre6, %block_4064d7 ]
...
block_4064f0:                                     ; preds = %block_.L_4064e4
  ...
  %call2_406527 = tail call %struct.Memory* @sub_410f60._ZN28custom_add_multiple_variableItE8do_shiftEttttt(%struct.State* nonnull %0, i64 %249, %struct.Memory* %call2_4064bb)
...
block_.L_40654a:                                  ; preds = %block_.L_4064e4
  ...
  %call2_406577 = tail call %struct.Memory* @sub_410fc0._Z26check_shifted_variable_sumIt28custom_add_multiple_variableItEEvT_S2_S2_S2_S2_(%struct.State* nonnull %0, i64 %350, %struct.Memory* %call2_4064bb)
...
block_.L_40658a:                                  ; preds = %block_.L_4064c7
  ...
  %call2_40658a = tail call %struct.Memory* @sub_400e70._Z5timerv(%struct.State* nonnull %0, i64 %387, %struct.Memory* %call2_4064bb)
