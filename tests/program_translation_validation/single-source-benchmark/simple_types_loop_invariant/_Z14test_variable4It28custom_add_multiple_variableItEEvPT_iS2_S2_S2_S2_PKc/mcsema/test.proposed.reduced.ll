; ModuleID = '/tmp/tmp24r3z48e-query.ll'
...
define %struct.Memory* @_Z14test_variable4It28custom_add_multiple_variableItEEvPT_iS2_S2_S2_S2_PKc(%struct.State* noalias, i64, %struct.Memory* noalias readnone returned) local_unnamed_addr #1 {
entry:
  %var_2_3 = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %RBP.i = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 15, i32 0, i32 0
  %var_2_110 = add i64 %1, -22122
  %call2_4064cb = tail call %struct.Memory* @sub_400e60._Z11start_timerv(%struct.State* %0, i64 %var_2_110, %struct.Memory* %2)
  ...
  br i1 %var_2_15532, label %block_4064e7.preheader, label %block_.L_40659a

block_4064e7.preheader:                           ; preds = %entry
  ...
  br i1 %var_2_20117, label %block_406500.us.preheader, label %block_4064e7.preheader6

block_4064e7.preheader6:                          ; preds = %block_4064e7.preheader
  br label %block_4064e7

block_406500.us.preheader:                        ; preds = %block_4064e7.preheader
  br label %block_406500.us

block_406500.us:                                  ; preds = %block_406500.us.preheader, %block_406500.us
  br label %block_406500.us

block_4064e7:                                     ; preds = %block_4064e7.preheader6, %block_4064e7
  br label %block_4064e7

block_.L_40659a:                                  ; preds = %entry
  %.pre = load i64, i64* %var_2_3, align 8
  %var_2_387 = add i64 %.pre, -22103
  %call2_40659a = tail call %struct.Memory* @sub_400e80._Z5timerv(%struct.State* nonnull %0, i64 %var_2_387, %struct.Memory* %call2_4064cb)
  %var_2_394 = load i64, i64* %var_2_3, align 8
  %var_2_398 = add i64 %var_2_394, -23935
  %call2_4065a3 = tail call %struct.Memory* @sub_400820._Z13record_resultdPKc(%struct.State* nonnull %0, i64 %var_2_398, %struct.Memory* %call2_40659a)
