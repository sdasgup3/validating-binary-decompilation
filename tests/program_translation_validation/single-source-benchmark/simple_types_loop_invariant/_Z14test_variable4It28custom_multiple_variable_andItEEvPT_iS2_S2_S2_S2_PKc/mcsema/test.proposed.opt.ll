...
declare %struct.Memory* @sub_4105a0._Z26check_shifted_variable_sumIt28custom_multiple_variable_andItEEvT_S2_S2_S2_S2_(%struct.State* noalias dereferenceable(3376), i64, %struct.Memory* noalias readnone returned) local_unnamed_addr
...
define %struct.Memory* @_Z14test_variable4It28custom_multiple_variable_andItEEvPT_iS2_S2_S2_S2_PKc(%struct.State* noalias, i64, %struct.Memory* noalias readnone) local_unnamed_addr #1 {
entry:
  ...
  %call2_40701b = tail call %struct.Memory* @sub_400e60._Z11start_timerv(%struct.State* %0, i64 %110, %struct.Memory* %2)
...
block_.L_407027:                                  ; preds = %block_.L_4070aa, %entry
  %122 = phi i64 [ %386, %block_.L_4070aa ], [ %.pre, %entry ]
  ...
  br i1 %155, label %block_407037, label %block_.L_4070ea
...
block_.L_407044:                                  ; preds = %block_407050, %block_407037
  %165 = phi i64 [ %312, %block_407050 ], [ %.pre6, %block_407037 ]
  ...
  br i1 %201, label %block_407050, label %block_.L_4070aa
...
block_407050:                                     ; preds = %block_.L_407044
  ...
  %call2_407087 = tail call %struct.Memory* @sub_410540._ZN28custom_multiple_variable_andItE8do_shiftEttttt(%struct.State* nonnull %0, i64 %249, %struct.Memory* %call2_40701b)
...
block_.L_4070aa:                                  ; preds = %block_.L_407044
  ...
  %call2_4070d7 = tail call %struct.Memory* @sub_4105a0._Z26check_shifted_variable_sumIt28custom_multiple_variable_andItEEvT_S2_S2_S2_S2_(%struct.State* nonnull %0, i64 %350, %struct.Memory* %call2_40701b)
...
block_.L_4070ea:                                  ; preds = %block_.L_407027
  ...
  %call2_4070ea = tail call %struct.Memory* @sub_400e80._Z5timerv(%struct.State* nonnull %0, i64 %387, %struct.Memory* %call2_40701b)
  ...
  %call2_4070f3 = tail call %struct.Memory* @sub_400820._Z13record_resultdPKc(%struct.State* nonnull %0, i64 %398, %struct.Memory* %call2_4070ea)
