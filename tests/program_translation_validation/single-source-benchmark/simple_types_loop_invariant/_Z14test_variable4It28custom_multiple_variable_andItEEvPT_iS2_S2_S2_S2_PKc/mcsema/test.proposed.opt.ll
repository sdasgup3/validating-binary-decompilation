...
block_.L_406fe7:                                  ; preds = %block_.L_40706a, %entry
  %122 = phi i64 [ %.pre, %entry ], [ %386, %block_.L_40706a ]
...
block_.L_407004:                                  ; preds = %block_407010, %block_406ff7
  %165 = phi i64 [ %.pre1, %block_406ff7 ], [ %312, %block_407010 ]
...
block_.L_40706a:                                  ; preds = %block_.L_407004
  ...
  %call2_407097 = tail call %struct.Memory* @sub_410560._Z26check_shifted_variable_sumIt28custom_multiple_variable_andItEEvT_S2_S2_S2_S2_(%struct.State* %0, i64 %350, %struct.Memory* %MEMORY.1)
...
block_.L_4070aa:                                  ; preds = %block_.L_406fe7
  ...
  %call2_4070aa = tail call %struct.Memory* @sub_400e30._Z5timerv(%struct.State* %0, i64 %387, %struct.Memory* %MEMORY.0)
  ...
  %call2_4070b3 = tail call %struct.Memory* @sub_4007d0._Z13record_resultdPKc(%struct.State* %0, i64 %398, %struct.Memory* %call2_4070aa)
