...
declare %struct.Memory* @sub_410180._Z26check_shifted_variable_sumIt28custom_multiple_variable_xorItEEvT_S2_S2_S2_S2_(%struct.State* noalias dereferenceable(3376), i64, %struct.Memory* noalias readnone returned) local_unnamed_addr
...
define %struct.Memory* @_Z14test_variable4It28custom_multiple_variable_xorItEEvPT_iS2_S2_S2_S2_PKc(%struct.State* noalias, i64, %struct.Memory* noalias) local_unnamed_addr #1 {
entry:
  ...
  %call2_4073bb = tail call %struct.Memory* @sub_400e10._Z11start_timerv(%struct.State* %0, i64 %110, %struct.Memory* %2)
...
block_.L_4073c7:                                  ; preds = %block_.L_40744a, %entry
  %122 = phi i64 [ %.pre, %entry ], [ %388, %block_.L_40744a ]
  %MEMORY.0 = phi %struct.Memory* [ %call2_4073bb, %entry ], [ %call2_407477, %block_.L_40744a ]
  ...
  br i1 %155, label %block_4073d7, label %block_.L_40748a
...
block_.L_4073e4:                                  ; preds = %block_4073f0, %block_4073d7
  %165 = phi i64 [ %.pre1, %block_4073d7 ], [ %313, %block_4073f0 ]
  %MEMORY.1 = phi %struct.Memory* [ %MEMORY.0, %block_4073d7 ], [ %call2_407427, %block_4073f0 ]
  ...
  br i1 %201, label %block_4073f0, label %block_.L_40744a
...
block_4073f0:                                     ; preds = %block_.L_4073e4
  ...
  %call2_407427 = tail call %struct.Memory* @sub_410120._ZN28custom_multiple_variable_xorItE8do_shiftEttttt(%struct.State* %0, i64 %249, %struct.Memory* %MEMORY.1)
...
block_.L_40744a:                                  ; preds = %block_.L_4073e4
  ...
  %call2_407477 = tail call %struct.Memory* @sub_410180._Z26check_shifted_variable_sumIt28custom_multiple_variable_xorItEEvT_S2_S2_S2_S2_(%struct.State* %0, i64 %351, %struct.Memory* %MEMORY.1)
...
block_.L_40748a:                                  ; preds = %block_.L_4073c7
  ...
  %call2_40748a = tail call %struct.Memory* @sub_400e30._Z5timerv(%struct.State* %0, i64 %389, %struct.Memory* %MEMORY.0)
  ...
  %call2_407493 = tail call %struct.Memory* @sub_4007d0._Z13record_resultdPKc(%struct.State* %0, i64 %400, %struct.Memory* %call2_40748a)
  ...
  ret %struct.Memory* %call2_407493
}
...
define %struct.Memory* @routine_jge_.L_40748a(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i8* %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
...
define %struct.Memory* @routine_jge_.L_40744a(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i8* %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 2, i32 9
...
define %struct.Memory* @routine_jmpq_.L_4073e4(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
...
define %struct.Memory* @routine_callq_._Z26check_shifted_variable_sumIt28custom_multiple_variable_xorItEEvT_S2_S2_S2_S2_(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
...
define %struct.Memory* @routine_jmpq_.L_4073c7(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
