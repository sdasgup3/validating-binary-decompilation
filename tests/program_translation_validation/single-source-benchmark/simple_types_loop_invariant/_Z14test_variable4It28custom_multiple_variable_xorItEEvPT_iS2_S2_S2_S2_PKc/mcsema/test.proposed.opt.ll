...
declare %struct.Memory* @sub_4101c0._Z26check_shifted_variable_sumIt28custom_multiple_variable_xorItEEvT_S2_S2_S2_S2_(%struct.State* noalias dereferenceable(3376), i64, %struct.Memory* noalias readnone returned) local_unnamed_addr
...
entry:
  ...
  %call2_4073fb = tail call %struct.Memory* @sub_400e60._Z11start_timerv(%struct.State* %0, i64 %110, %struct.Memory* %2)
...
block_.L_407407:                                  ; preds = %block_.L_40748a, %entry
  %122 = phi i64 [ %386, %block_.L_40748a ], [ %.pre, %entry ]
  ...
  br i1 %155, label %block_407417, label %block_.L_4074ca
...
block_.L_407424:                                  ; preds = %block_407430, %block_407417
  %165 = phi i64 [ %312, %block_407430 ], [ %.pre6, %block_407417 ]
  ...
  br i1 %201, label %block_407430, label %block_.L_40748a
...
block_407430:                                     ; preds = %block_.L_407424
  ...
  %call2_407467 = tail call %struct.Memory* @sub_410160._ZN28custom_multiple_variable_xorItE8do_shiftEttttt(%struct.State* nonnull %0, i64 %249, %struct.Memory* %call2_4073fb)
...
block_.L_40748a:                                  ; preds = %block_.L_407424
  ...
  %call2_4074b7 = tail call %struct.Memory* @sub_4101c0._Z26check_shifted_variable_sumIt28custom_multiple_variable_xorItEEvT_S2_S2_S2_S2_(%struct.State* nonnull %0, i64 %350, %struct.Memory* %call2_4073fb)
...
block_.L_4074ca:                                  ; preds = %block_.L_407407
  ...
  %call2_4074ca = tail call %struct.Memory* @sub_400e80._Z5timerv(%struct.State* nonnull %0, i64 %387, %struct.Memory* %call2_4073fb)
  ...
  %call2_4074d3 = tail call %struct.Memory* @sub_400820._Z13record_resultdPKc(%struct.State* nonnull %0, i64 %398, %struct.Memory* %call2_4074ca)
