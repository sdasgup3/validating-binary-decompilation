...
block_.L_4073c7:                                  ; preds = %block_.L_40744a, %entry
  %122 = phi i64 [ %.pre, %entry ], [ %386, %block_.L_40744a ]
...
block_.L_4073e4:                                  ; preds = %block_4073f0, %block_4073d7
  %165 = phi i64 [ %.pre1, %block_4073d7 ], [ %312, %block_4073f0 ]
...
block_.L_40744a:                                  ; preds = %block_.L_4073e4
  ...
  %call2_407477 = tail call %struct.Memory* @sub_410180._Z26check_shifted_variable_sumIt28custom_multiple_variable_xorItEEvT_S2_S2_S2_S2_(%struct.State* %0, i64 %350, %struct.Memory* %MEMORY.1)
...
block_.L_40748a:                                  ; preds = %block_.L_4073c7
  ...
  %call2_40748a = tail call %struct.Memory* @sub_400e30._Z5timerv(%struct.State* %0, i64 %387, %struct.Memory* %MEMORY.0)
  ...
  %call2_407493 = tail call %struct.Memory* @sub_4007d0._Z13record_resultdPKc(%struct.State* %0, i64 %398, %struct.Memory* %call2_40748a)
