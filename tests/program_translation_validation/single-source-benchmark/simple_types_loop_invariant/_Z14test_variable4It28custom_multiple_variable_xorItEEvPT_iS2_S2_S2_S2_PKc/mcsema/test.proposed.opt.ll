...
declare %struct.Memory* @sub_4101b0._Z26check_shifted_variable_sumIt28custom_multiple_variable_xorItEEvT_S2_S2_S2_S2_(%struct.State* noalias dereferenceable(3376), i64, %struct.Memory* noalias readnone returned) local_unnamed_addr
...
define %struct.Memory* @_Z14test_variable4It28custom_multiple_variable_xorItEEvPT_iS2_S2_S2_S2_PKc(%struct.State* noalias, i64, %struct.Memory* noalias readnone) local_unnamed_addr #1 {
entry:
...
block_.L_4073f7:                                  ; preds = %block_.L_40747a, %entry
  %122 = phi i64 [ %386, %block_.L_40747a ], [ %.pre, %entry ]
...
block_.L_407414:                                  ; preds = %block_407420, %block_407407
  %165 = phi i64 [ %312, %block_407420 ], [ %.pre6, %block_407407 ]
...
block_407420:                                     ; preds = %block_.L_407414
  ...
  %call2_407457 = tail call %struct.Memory* @sub_410150._ZN28custom_multiple_variable_xorItE8do_shiftEttttt(%struct.State* nonnull %0, i64 %249, %struct.Memory* %call2_4073eb)
...
block_.L_40747a:                                  ; preds = %block_.L_407414
  ...
  %call2_4074a7 = tail call %struct.Memory* @sub_4101b0._Z26check_shifted_variable_sumIt28custom_multiple_variable_xorItEEvT_S2_S2_S2_S2_(%struct.State* nonnull %0, i64 %350, %struct.Memory* %call2_4073eb)
...
block_.L_4074ba:                                  ; preds = %block_.L_4073f7
  ...
  %call2_4074ba = tail call %struct.Memory* @sub_400e70._Z5timerv(%struct.State* nonnull %0, i64 %387, %struct.Memory* %call2_4073eb)
