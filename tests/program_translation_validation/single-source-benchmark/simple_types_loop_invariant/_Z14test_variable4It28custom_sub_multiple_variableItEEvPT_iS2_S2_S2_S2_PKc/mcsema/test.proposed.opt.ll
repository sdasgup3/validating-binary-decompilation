...
block_.L_406687:                                  ; preds = %block_.L_40670a, %entry
  %122 = phi i64 [ %.pre, %entry ], [ %386, %block_.L_40670a ]
...
block_.L_4066a4:                                  ; preds = %block_4066b0, %block_406697
  %165 = phi i64 [ %.pre1, %block_406697 ], [ %312, %block_4066b0 ]
...
block_.L_40670a:                                  ; preds = %block_.L_4066a4
  ...
  %call2_406737 = tail call %struct.Memory* @sub_410dd0._Z26check_shifted_variable_sumIt28custom_sub_multiple_variableItEEvT_S2_S2_S2_S2_(%struct.State* %0, i64 %350, %struct.Memory* %MEMORY.1)
...
block_.L_40674a:                                  ; preds = %block_.L_406687
  ...
  %call2_40674a = tail call %struct.Memory* @sub_400e30._Z5timerv(%struct.State* %0, i64 %387, %struct.Memory* %MEMORY.0)
  ...
  %call2_406753 = tail call %struct.Memory* @sub_4007d0._Z13record_resultdPKc(%struct.State* %0, i64 %398, %struct.Memory* %call2_40674a)
