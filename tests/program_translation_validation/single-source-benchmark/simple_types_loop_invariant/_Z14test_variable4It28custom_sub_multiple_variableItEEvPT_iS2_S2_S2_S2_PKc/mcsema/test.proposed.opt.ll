...
declare %struct.Memory* @sub_410e00._Z26check_shifted_variable_sumIt28custom_sub_multiple_variableItEEvT_S2_S2_S2_S2_(%struct.State* noalias dereferenceable(3376), i64, %struct.Memory* noalias readnone returned) local_unnamed_addr
...
define %struct.Memory* @_Z14test_variable4It28custom_sub_multiple_variableItEEvPT_iS2_S2_S2_S2_PKc(%struct.State* noalias, i64, %struct.Memory* noalias readnone) local_unnamed_addr #1 {
entry:
...
block_.L_4066b7:                                  ; preds = %block_.L_40673a, %entry
  %122 = phi i64 [ %386, %block_.L_40673a ], [ %.pre, %entry ]
...
block_.L_4066d4:                                  ; preds = %block_4066e0, %block_4066c7
  %165 = phi i64 [ %312, %block_4066e0 ], [ %.pre6, %block_4066c7 ]
...
block_4066e0:                                     ; preds = %block_.L_4066d4
  ...
  %call2_406717 = tail call %struct.Memory* @sub_410da0._ZN28custom_sub_multiple_variableItE8do_shiftEttttt(%struct.State* nonnull %0, i64 %249, %struct.Memory* %call2_4066ab)
...
block_.L_40673a:                                  ; preds = %block_.L_4066d4
  ...
  %call2_406767 = tail call %struct.Memory* @sub_410e00._Z26check_shifted_variable_sumIt28custom_sub_multiple_variableItEEvT_S2_S2_S2_S2_(%struct.State* nonnull %0, i64 %350, %struct.Memory* %call2_4066ab)
...
block_.L_40677a:                                  ; preds = %block_.L_4066b7
  ...
  %call2_40677a = tail call %struct.Memory* @sub_400e70._Z5timerv(%struct.State* nonnull %0, i64 %387, %struct.Memory* %call2_4066ab)
