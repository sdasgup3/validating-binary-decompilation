...
declare %struct.Memory* @sub_410e10._Z26check_shifted_variable_sumIt28custom_sub_multiple_variableItEEvT_S2_S2_S2_S2_(%struct.State* noalias dereferenceable(3376), i64, %struct.Memory* noalias readnone returned) local_unnamed_addr
...
entry:
  ...
  %call2_4066bb = tail call %struct.Memory* @sub_400e60._Z11start_timerv(%struct.State* %0, i64 %110, %struct.Memory* %2)
...
block_.L_4066c7:                                  ; preds = %block_.L_40674a, %entry
  %122 = phi i64 [ %386, %block_.L_40674a ], [ %.pre, %entry ]
  ...
  br i1 %155, label %block_4066d7, label %block_.L_40678a
...
block_.L_4066e4:                                  ; preds = %block_4066f0, %block_4066d7
  %165 = phi i64 [ %312, %block_4066f0 ], [ %.pre6, %block_4066d7 ]
  ...
  br i1 %201, label %block_4066f0, label %block_.L_40674a
...
block_4066f0:                                     ; preds = %block_.L_4066e4
  ...
  %call2_406727 = tail call %struct.Memory* @sub_410db0._ZN28custom_sub_multiple_variableItE8do_shiftEttttt(%struct.State* nonnull %0, i64 %249, %struct.Memory* %call2_4066bb)
...
block_.L_40674a:                                  ; preds = %block_.L_4066e4
  ...
  %call2_406777 = tail call %struct.Memory* @sub_410e10._Z26check_shifted_variable_sumIt28custom_sub_multiple_variableItEEvT_S2_S2_S2_S2_(%struct.State* nonnull %0, i64 %350, %struct.Memory* %call2_4066bb)
...
block_.L_40678a:                                  ; preds = %block_.L_4066c7
  ...
  %call2_40678a = tail call %struct.Memory* @sub_400e80._Z5timerv(%struct.State* nonnull %0, i64 %387, %struct.Memory* %call2_4066bb)
  ...
  %call2_406793 = tail call %struct.Memory* @sub_400820._Z13record_resultdPKc(%struct.State* nonnull %0, i64 %398, %struct.Memory* %call2_40678a)
