...
declare %struct.Memory* @sub_410760._Z26check_shifted_variable_sumIt30custom_mixed_multiple_variableItEEvT_S2_S2_S2_S2_(%struct.State* noalias dereferenceable(3376), i64, %struct.Memory* noalias readnone returned) local_unnamed_addr
...
entry:
  ...
  %call2_406e2b = tail call %struct.Memory* @sub_400e60._Z11start_timerv(%struct.State* %0, i64 %110, %struct.Memory* %2)
  ...
  br label %block_.L_406e37

block_.L_406e37:                                  ; preds = %block_.L_406eba, %entry
  %122 = phi i64 [ %386, %block_.L_406eba ], [ %.pre, %entry ]
  ...
  br i1 %155, label %block_406e47, label %block_.L_406efa

block_406e47:                                     ; preds = %block_.L_406e37
  %157 = add i64 %123, -54
  %158 = add i64 %156, 6
  ...
  br label %block_.L_406e54

block_.L_406e54:                                  ; preds = %block_406e60, %block_406e47
  %165 = phi i64 [ %312, %block_406e60 ], [ %.pre6, %block_406e47 ]
  ...
  br i1 %201, label %block_406e60, label %block_.L_406eba

block_406e60:                                     ; preds = %block_.L_406e54
  %203 = add i64 %166, -24
  %204 = add i64 %202, 4
  ...
  %call2_406e97 = tail call %struct.Memory* @sub_410700._ZN30custom_mixed_multiple_variableItE8do_shiftEttttt(%struct.State* nonnull %0, i64 %249, %struct.Memory* %call2_406e2b)
...
block_.L_406eba:                                  ; preds = %block_.L_406e54
  %313 = add i64 %166, -54
  %314 = add i64 %202, 4
  ...
  %call2_406ee7 = tail call %struct.Memory* @sub_410760._Z26check_shifted_variable_sumIt30custom_mixed_multiple_variableItEEvT_S2_S2_S2_S2_(%struct.State* nonnull %0, i64 %350, %struct.Memory* %call2_406e2b)
...
block_.L_406efa:                                  ; preds = %block_.L_406e37
  ...
  %call2_406efa = tail call %struct.Memory* @sub_400e80._Z5timerv(%struct.State* nonnull %0, i64 %387, %struct.Memory* %call2_406e2b)
  ...
  %call2_406f03 = tail call %struct.Memory* @sub_400820._Z13record_resultdPKc(%struct.State* nonnull %0, i64 %398, %struct.Memory* %call2_406efa)
