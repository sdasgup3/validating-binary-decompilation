...
block_.L_406df7:                                  ; preds = %block_.L_406e7a, %entry
  %122 = phi i64 [ %.pre, %entry ], [ %386, %block_.L_406e7a ]
...
block_.L_406e14:                                  ; preds = %block_406e20, %block_406e07
  %165 = phi i64 [ %.pre1, %block_406e07 ], [ %312, %block_406e20 ]
...
block_.L_406e7a:                                  ; preds = %block_.L_406e14
  ...
  %call2_406ea7 = tail call %struct.Memory* @sub_410720._Z26check_shifted_variable_sumIt30custom_mixed_multiple_variableItEEvT_S2_S2_S2_S2_(%struct.State* %0, i64 %350, %struct.Memory* %MEMORY.1)
...
block_.L_406eba:                                  ; preds = %block_.L_406df7
  ...
  %call2_406eba = tail call %struct.Memory* @sub_400e30._Z5timerv(%struct.State* %0, i64 %387, %struct.Memory* %MEMORY.0)
  ...
  %call2_406ec3 = tail call %struct.Memory* @sub_4007d0._Z13record_resultdPKc(%struct.State* %0, i64 %398, %struct.Memory* %call2_406eba)
