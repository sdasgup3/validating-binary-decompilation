...
block_.L_406b97:                                  ; preds = %block_.L_406c1a, %entry
  %122 = phi i64 [ %.pre, %entry ], [ %388, %block_.L_406c1a ]
...
block_.L_406bb4:                                  ; preds = %block_406bc0, %block_406ba7
  %165 = phi i64 [ %.pre1, %block_406ba7 ], [ %313, %block_406bc0 ]
...
block_.L_406c1a:                                  ; preds = %block_.L_406bb4
  ...
  %call2_406c47 = tail call %struct.Memory* @sub_410940._Z26check_shifted_variable_sumIt31custom_divide_multiple_variableItEEvT_S2_S2_S2_S2_(%struct.State* %0, i64 %351, %struct.Memory* %MEMORY.1)
...
block_.L_406c5a:                                  ; preds = %block_.L_406b97
  ...
  %call2_406c5a = tail call %struct.Memory* @sub_400e30._Z5timerv(%struct.State* %0, i64 %389, %struct.Memory* %MEMORY.0)
  ...
  %call2_406c63 = tail call %struct.Memory* @sub_4007d0._Z13record_resultdPKc(%struct.State* %0, i64 %400, %struct.Memory* %call2_406c5a)
