; ModuleID = '/tmp/tmppefokbwq-query.ll'
...
define %struct.Memory* @_Z14test_variable4It31custom_divide_multiple_variableItEEvPT_iS2_S2_S2_S2_PKc(%struct.State* noalias, i64, %struct.Memory* noalias readnone returned) local_unnamed_addr #1 {
entry:
  %var_2_3 = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %RBP.i = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 15, i32 0, i32 0
  %var_2_110 = add i64 %1, -23914
  %call2_406bcb = tail call %struct.Memory* @sub_400e60._Z11start_timerv(%struct.State* %0, i64 %var_2_110, %struct.Memory* %2)
  ...
  br i1 %var_2_15532, label %block_406be7.preheader, label %block_.L_406c9a

block_406be7.preheader:                           ; preds = %entry
  ...
  br i1 %var_2_20117, label %block_406c00.us.preheader, label %block_406be7.preheader6

block_406be7.preheader6:                          ; preds = %block_406be7.preheader
  br label %block_406be7

block_406c00.us.preheader:                        ; preds = %block_406be7.preheader
  br label %block_406c00.us

block_406c00.us:                                  ; preds = %block_406c00.us.preheader, %block_406c00.us
  br label %block_406c00.us

block_406be7:                                     ; preds = %block_406be7.preheader6, %block_406be7
  br label %block_406be7

block_.L_406c9a:                                  ; preds = %entry
  %.pre = load i64, i64* %var_2_3, align 8
  %var_2_387 = add i64 %.pre, -23895
  %call2_406c9a = tail call %struct.Memory* @sub_400e80._Z5timerv(%struct.State* nonnull %0, i64 %var_2_387, %struct.Memory* %call2_406bcb)
  %var_2_394 = load i64, i64* %var_2_3, align 8
  %var_2_398 = add i64 %var_2_394, -25727
  %call2_406ca3 = tail call %struct.Memory* @sub_400820._Z13record_resultdPKc(%struct.State* nonnull %0, i64 %var_2_398, %struct.Memory* %call2_406c9a)
