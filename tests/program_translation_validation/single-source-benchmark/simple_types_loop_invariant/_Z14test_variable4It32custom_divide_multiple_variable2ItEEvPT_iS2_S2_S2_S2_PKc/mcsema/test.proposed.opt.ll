...
declare %struct.Memory* @sub_410870._Z26check_shifted_variable_sumIt32custom_divide_multiple_variable2ItEEvT_S2_S2_S2_S2_(%struct.State* noalias dereferenceable(3376), i64, %struct.Memory* noalias readnone returned) local_unnamed_addr
...
entry:
  ...
  %call2_406cfb = tail call %struct.Memory* @sub_400e60._Z11start_timerv(%struct.State* %0, i64 %110, %struct.Memory* %2)
...
block_.L_406d07:                                  ; preds = %block_.L_406d8a, %entry
  %122 = phi i64 [ %386, %block_.L_406d8a ], [ %.pre, %entry ]
  ...
  br i1 %155, label %block_406d17, label %block_.L_406dca
...
block_.L_406d24:                                  ; preds = %block_406d30, %block_406d17
  %165 = phi i64 [ %312, %block_406d30 ], [ %.pre6, %block_406d17 ]
  ...
  br i1 %201, label %block_406d30, label %block_.L_406d8a
...
block_406d30:                                     ; preds = %block_.L_406d24
  ...
  %call2_406d67 = tail call %struct.Memory* @sub_410810._ZN32custom_divide_multiple_variable2ItE8do_shiftEttttt(%struct.State* nonnull %0, i64 %249, %struct.Memory* %call2_406cfb)
...
block_.L_406d8a:                                  ; preds = %block_.L_406d24
  ...
  %call2_406db7 = tail call %struct.Memory* @sub_410870._Z26check_shifted_variable_sumIt32custom_divide_multiple_variable2ItEEvT_S2_S2_S2_S2_(%struct.State* nonnull %0, i64 %350, %struct.Memory* %call2_406cfb)
...
block_.L_406dca:                                  ; preds = %block_.L_406d07
  ...
  %call2_406dca = tail call %struct.Memory* @sub_400e80._Z5timerv(%struct.State* nonnull %0, i64 %387, %struct.Memory* %call2_406cfb)
  ...
  %call2_406dd3 = tail call %struct.Memory* @sub_400820._Z13record_resultdPKc(%struct.State* nonnull %0, i64 %398, %struct.Memory* %call2_406dca)
