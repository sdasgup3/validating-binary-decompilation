...
declare %struct.Memory* @sub_410860._Z26check_shifted_variable_sumIt32custom_divide_multiple_variable2ItEEvT_S2_S2_S2_S2_(%struct.State* noalias dereferenceable(3376), i64, %struct.Memory* noalias readnone returned) local_unnamed_addr
...
define %struct.Memory* @_Z14test_variable4It32custom_divide_multiple_variable2ItEEvPT_iS2_S2_S2_S2_PKc(%struct.State* noalias, i64, %struct.Memory* noalias readnone) local_unnamed_addr #1 {
entry:
...
block_.L_406cf7:                                  ; preds = %block_.L_406d7a, %entry
  %122 = phi i64 [ %386, %block_.L_406d7a ], [ %.pre, %entry ]
...
block_.L_406d14:                                  ; preds = %block_406d20, %block_406d07
  %165 = phi i64 [ %312, %block_406d20 ], [ %.pre6, %block_406d07 ]
...
block_406d20:                                     ; preds = %block_.L_406d14
  ...
  %call2_406d57 = tail call %struct.Memory* @sub_410800._ZN32custom_divide_multiple_variable2ItE8do_shiftEttttt(%struct.State* nonnull %0, i64 %249, %struct.Memory* %call2_406ceb)
...
block_.L_406d7a:                                  ; preds = %block_.L_406d14
  ...
  %call2_406da7 = tail call %struct.Memory* @sub_410860._Z26check_shifted_variable_sumIt32custom_divide_multiple_variable2ItEEvT_S2_S2_S2_S2_(%struct.State* nonnull %0, i64 %350, %struct.Memory* %call2_406ceb)
...
block_.L_406dba:                                  ; preds = %block_.L_406cf7
  ...
  %call2_406dba = tail call %struct.Memory* @sub_400e70._Z5timerv(%struct.State* nonnull %0, i64 %387, %struct.Memory* %call2_406ceb)
