...
block_.L_406cc7:                                  ; preds = %block_.L_406d4a, %entry
  %122 = phi i64 [ %.pre, %entry ], [ %386, %block_.L_406d4a ]
...
block_.L_406ce4:                                  ; preds = %block_406cf0, %block_406cd7
  %165 = phi i64 [ %.pre1, %block_406cd7 ], [ %312, %block_406cf0 ]
...
block_.L_406d4a:                                  ; preds = %block_.L_406ce4
  ...
  %call2_406d77 = tail call %struct.Memory* @sub_410830._Z26check_shifted_variable_sumIt32custom_divide_multiple_variable2ItEEvT_S2_S2_S2_S2_(%struct.State* %0, i64 %350, %struct.Memory* %MEMORY.1)
...
block_.L_406d8a:                                  ; preds = %block_.L_406cc7
  ...
  %call2_406d8a = tail call %struct.Memory* @sub_400e30._Z5timerv(%struct.State* %0, i64 %387, %struct.Memory* %MEMORY.0)
  ...
  %call2_406d93 = tail call %struct.Memory* @sub_4007d0._Z13record_resultdPKc(%struct.State* %0, i64 %398, %struct.Memory* %call2_406d8a)
