...
block_.L_406877:                                  ; preds = %block_.L_4068fa, %entry
  %122 = phi i64 [ %.pre, %entry ], [ %386, %block_.L_4068fa ]
...
block_.L_406894:                                  ; preds = %block_4068a0, %block_406887
  %165 = phi i64 [ %.pre1, %block_406887 ], [ %312, %block_4068a0 ]
...
block_.L_4068fa:                                  ; preds = %block_.L_406894
  ...
  %call2_406927 = tail call %struct.Memory* @sub_410c10._Z26check_shifted_variable_sumIt33custom_multiply_multiple_variableItEEvT_S2_S2_S2_S2_(%struct.State* %0, i64 %350, %struct.Memory* %MEMORY.1)
...
block_.L_40693a:                                  ; preds = %block_.L_406877
  ...
  %call2_40693a = tail call %struct.Memory* @sub_400e30._Z5timerv(%struct.State* %0, i64 %387, %struct.Memory* %MEMORY.0)
  ...
  %call2_406943 = tail call %struct.Memory* @sub_4007d0._Z13record_resultdPKc(%struct.State* %0, i64 %398, %struct.Memory* %call2_40693a)
