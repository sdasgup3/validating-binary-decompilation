...
declare %struct.Memory* @sub_410c40._Z26check_shifted_variable_sumIt33custom_multiply_multiple_variableItEEvT_S2_S2_S2_S2_(%struct.State* dereferenceable(3376), i64, %struct.Memory*) local_unnamed_addr
...
block_.L_4068a7:                                  ; preds = %block_.L_40692a, %entry
  %122 = phi i64 [ %.pre, %entry ], [ %386, %block_.L_40692a ]
  %MEMORY.0 = phi %struct.Memory* [ %call2_40689b, %entry ], [ %call2_406957, %block_.L_40692a ]
...
block_.L_4068c4:                                  ; preds = %block_4068d0, %block_4068b7
  %165 = phi i64 [ %.pre6, %block_4068b7 ], [ %312, %block_4068d0 ]
  %MEMORY.1 = phi %struct.Memory* [ %MEMORY.0, %block_4068b7 ], [ %call2_406907, %block_4068d0 ]
...
block_4068d0:                                     ; preds = %block_.L_4068c4
  ...
  %call2_406907 = tail call %struct.Memory* @sub_410be0._ZN33custom_multiply_multiple_variableItE8do_shiftEttttt(%struct.State* nonnull %0, i64 %249, %struct.Memory* %MEMORY.1)
...
block_.L_40692a:                                  ; preds = %block_.L_4068c4
  ...
  %call2_406957 = tail call %struct.Memory* @sub_410c40._Z26check_shifted_variable_sumIt33custom_multiply_multiple_variableItEEvT_S2_S2_S2_S2_(%struct.State* nonnull %0, i64 %350, %struct.Memory* %MEMORY.1)
...
block_.L_40696a:                                  ; preds = %block_.L_4068a7
  ...
  %call2_40696a = tail call %struct.Memory* @sub_400e70._Z5timerv(%struct.State* nonnull %0, i64 %387, %struct.Memory* %MEMORY.0)
