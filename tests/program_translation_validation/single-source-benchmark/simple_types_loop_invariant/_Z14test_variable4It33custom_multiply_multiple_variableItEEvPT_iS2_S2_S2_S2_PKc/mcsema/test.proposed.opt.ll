...
declare %struct.Memory* @sub_410c50._Z26check_shifted_variable_sumIt33custom_multiply_multiple_variableItEEvT_S2_S2_S2_S2_(%struct.State* noalias dereferenceable(3376), i64, %struct.Memory* noalias readnone returned) local_unnamed_addr
...
entry:
  ...
  %call2_4068ab = tail call %struct.Memory* @sub_400e60._Z11start_timerv(%struct.State* %0, i64 %110, %struct.Memory* %2)
...
block_.L_4068b7:                                  ; preds = %block_.L_40693a, %entry
  %122 = phi i64 [ %386, %block_.L_40693a ], [ %.pre, %entry ]
  ...
  br i1 %155, label %block_4068c7, label %block_.L_40697a
...
block_.L_4068d4:                                  ; preds = %block_4068e0, %block_4068c7
  %165 = phi i64 [ %312, %block_4068e0 ], [ %.pre6, %block_4068c7 ]
  ...
  br i1 %201, label %block_4068e0, label %block_.L_40693a
...
block_4068e0:                                     ; preds = %block_.L_4068d4
  ...
  %call2_406917 = tail call %struct.Memory* @sub_410bf0._ZN33custom_multiply_multiple_variableItE8do_shiftEttttt(%struct.State* nonnull %0, i64 %249, %struct.Memory* %call2_4068ab)
...
block_.L_40693a:                                  ; preds = %block_.L_4068d4
  ...
  %call2_406967 = tail call %struct.Memory* @sub_410c50._Z26check_shifted_variable_sumIt33custom_multiply_multiple_variableItEEvT_S2_S2_S2_S2_(%struct.State* nonnull %0, i64 %350, %struct.Memory* %call2_4068ab)
...
block_.L_40697a:                                  ; preds = %block_.L_4068b7
  ...
  %call2_40697a = tail call %struct.Memory* @sub_400e80._Z5timerv(%struct.State* nonnull %0, i64 %387, %struct.Memory* %call2_4068ab)
  ...
  %call2_406983 = tail call %struct.Memory* @sub_400820._Z13record_resultdPKc(%struct.State* nonnull %0, i64 %398, %struct.Memory* %call2_40697a)
