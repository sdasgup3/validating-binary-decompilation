...
block_.L_4069a7:                                  ; preds = %block_.L_406a2a, %entry
  %122 = phi i64 [ %.pre, %entry ], [ %386, %block_.L_406a2a ]
...
block_.L_4069c4:                                  ; preds = %block_4069d0, %block_4069b7
  %165 = phi i64 [ %.pre1, %block_4069b7 ], [ %312, %block_4069d0 ]
...
block_.L_406a2a:                                  ; preds = %block_.L_4069c4
  ...
  %call2_406a57 = tail call %struct.Memory* @sub_410b00._Z26check_shifted_variable_sumIt34custom_multiply_multiple_variable2ItEEvT_S2_S2_S2_S2_(%struct.State* %0, i64 %350, %struct.Memory* %MEMORY.1)
...
block_.L_406a6a:                                  ; preds = %block_.L_4069a7
  ...
  %call2_406a6a = tail call %struct.Memory* @sub_400e30._Z5timerv(%struct.State* %0, i64 %387, %struct.Memory* %MEMORY.0)
  ...
  %call2_406a73 = tail call %struct.Memory* @sub_4007d0._Z13record_resultdPKc(%struct.State* %0, i64 %398, %struct.Memory* %call2_406a6a)
