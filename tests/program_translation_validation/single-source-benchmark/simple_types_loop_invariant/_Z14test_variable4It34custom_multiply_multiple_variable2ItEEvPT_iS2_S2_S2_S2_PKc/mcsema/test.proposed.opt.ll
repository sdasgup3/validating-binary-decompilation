...
declare %struct.Memory* @sub_410b40._Z26check_shifted_variable_sumIt34custom_multiply_multiple_variable2ItEEvT_S2_S2_S2_S2_(%struct.State* noalias dereferenceable(3376), i64, %struct.Memory* noalias readnone returned) local_unnamed_addr
...
entry:
  ...
  %call2_4069db = tail call %struct.Memory* @sub_400e60._Z11start_timerv(%struct.State* %0, i64 %110, %struct.Memory* %2)
...
block_.L_4069e7:                                  ; preds = %block_.L_406a6a, %entry
  %122 = phi i64 [ %386, %block_.L_406a6a ], [ %.pre, %entry ]
  ...
  br i1 %155, label %block_4069f7, label %block_.L_406aaa

block_4069f7:                                     ; preds = %block_.L_4069e7
  %157 = add i64 %123, -54
  %158 = add i64 %156, 6
...
block_.L_406a04:                                  ; preds = %block_406a10, %block_4069f7
  %165 = phi i64 [ %312, %block_406a10 ], [ %.pre6, %block_4069f7 ]
  ...
  br i1 %201, label %block_406a10, label %block_.L_406a6a

block_406a10:                                     ; preds = %block_.L_406a04
  %203 = add i64 %166, -24
  %204 = add i64 %202, 4
  ...
  %call2_406a47 = tail call %struct.Memory* @sub_410ae0._ZN34custom_multiply_multiple_variable2ItE8do_shiftEttttt(%struct.State* nonnull %0, i64 %249, %struct.Memory* %call2_4069db)
...
block_.L_406a6a:                                  ; preds = %block_.L_406a04
  %313 = add i64 %166, -54
  %314 = add i64 %202, 4
  ...
  %call2_406a97 = tail call %struct.Memory* @sub_410b40._Z26check_shifted_variable_sumIt34custom_multiply_multiple_variable2ItEEvT_S2_S2_S2_S2_(%struct.State* nonnull %0, i64 %350, %struct.Memory* %call2_4069db)
...
block_.L_406aaa:                                  ; preds = %block_.L_4069e7
  ...
  %call2_406aaa = tail call %struct.Memory* @sub_400e80._Z5timerv(%struct.State* nonnull %0, i64 %387, %struct.Memory* %call2_4069db)
  ...
  %call2_406ab3 = tail call %struct.Memory* @sub_400820._Z13record_resultdPKc(%struct.State* nonnull %0, i64 %398, %struct.Memory* %call2_406aaa)
