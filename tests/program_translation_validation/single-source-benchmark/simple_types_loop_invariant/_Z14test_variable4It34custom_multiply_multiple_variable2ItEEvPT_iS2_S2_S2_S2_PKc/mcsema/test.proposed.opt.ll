...
declare %struct.Memory* @sub_410b30._Z26check_shifted_variable_sumIt34custom_multiply_multiple_variable2ItEEvT_S2_S2_S2_S2_(%struct.State* noalias dereferenceable(3376), i64, %struct.Memory* noalias readnone returned) local_unnamed_addr
...
define %struct.Memory* @_Z14test_variable4It34custom_multiply_multiple_variable2ItEEvPT_iS2_S2_S2_S2_PKc(%struct.State* noalias, i64, %struct.Memory* noalias readnone) local_unnamed_addr #1 {
entry:
...
block_.L_4069d7:                                  ; preds = %block_.L_406a5a, %entry
  %122 = phi i64 [ %386, %block_.L_406a5a ], [ %.pre, %entry ]
...
block_.L_4069f4:                                  ; preds = %block_406a00, %block_4069e7
  %165 = phi i64 [ %312, %block_406a00 ], [ %.pre6, %block_4069e7 ]
...
block_406a00:                                     ; preds = %block_.L_4069f4
  ...
  %call2_406a37 = tail call %struct.Memory* @sub_410ad0._ZN34custom_multiply_multiple_variable2ItE8do_shiftEttttt(%struct.State* nonnull %0, i64 %249, %struct.Memory* %call2_4069cb)
...
block_.L_406a5a:                                  ; preds = %block_.L_4069f4
  ...
  %call2_406a87 = tail call %struct.Memory* @sub_410b30._Z26check_shifted_variable_sumIt34custom_multiply_multiple_variable2ItEEvT_S2_S2_S2_S2_(%struct.State* nonnull %0, i64 %350, %struct.Memory* %call2_4069cb)
...
block_.L_406a9a:                                  ; preds = %block_.L_4069d7
  ...
  %call2_406a9a = tail call %struct.Memory* @sub_400e70._Z5timerv(%struct.State* nonnull %0, i64 %387, %struct.Memory* %call2_4069cb)
