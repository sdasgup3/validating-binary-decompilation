...
@G_0x7e0e__rip__4243530_ = global %G_0x7e0e__rip__4243530__type zeroinitializer
...
@G_0x7e64__rip__4243436_ = global %G_0x7e64__rip__4243436__type zeroinitializer
...
entry:
  ...
  %38 = load double, double* bitcast (%G_0x7e64__rip__4243436__type* @G_0x7e64__rip__4243436_ to double*)
  ...
  %234 = load float, float* bitcast (%G_0x7e5e__rip__4243490__type* @G_0x7e5e__rip__4243490_ to float*)
  %235 = load float, float* inttoptr (i64 add (i64 ptrtoint (%G_0x7e5e__rip__4243490__type* @G_0x7e5e__rip__4243490_ to i64), i64 4) to float*)
  %236 = load float, float* inttoptr (i64 add (i64 ptrtoint (%G_0x7e5e__rip__4243490__type* @G_0x7e5e__rip__4243490_ to i64), i64 8) to float*)
  %237 = load float, float* inttoptr (i64 add (i64 ptrtoint (%G_0x7e5e__rip__4243490__type* @G_0x7e5e__rip__4243490_ to i64), i64 12) to float*)
...
; <label>:306:                                    ; preds = %298
  ...
  %309 = call %struct.Memory* @__remill_error(%struct.State* nonnull dereferenceable(3376) %0, i64 %308, %struct.Memory* %loadMem_40c026)
...
routine_ucomisd__xmm0___xmm1.exit:                ; preds = %306, %323
  %327 = phi %struct.Memory* [ %309, %306 ], [ %loadMem_40c026, %323 ]
...
block_.L_40c042:                                  ; preds = %block_40c030, %routine_ucomisd__xmm0___xmm1.exit
  ...
  %428 = load double, double* bitcast (%G_0x7e0e__rip__4243530__type* @G_0x7e0e__rip__4243530_ to double*)
  ...
  %459 = load float, float* bitcast (%G_0x7e2a__rip__4243542__type* @G_0x7e2a__rip__4243542_ to float*)
  %460 = load float, float* inttoptr (i64 add (i64 ptrtoint (%G_0x7e2a__rip__4243542__type* @G_0x7e2a__rip__4243542_ to i64), i64 4) to float*)
  %461 = load float, float* inttoptr (i64 add (i64 ptrtoint (%G_0x7e2a__rip__4243542__type* @G_0x7e2a__rip__4243542_ to i64), i64 8) to float*)
  %462 = load float, float* inttoptr (i64 add (i64 ptrtoint (%G_0x7e2a__rip__4243542__type* @G_0x7e2a__rip__4243542_ to i64), i64 12) to float*)
...
; <label>:523:                                    ; preds = %block_.L_40c042
...
; <label>:531:                                    ; preds = %523
  ...
  %534 = call %struct.Memory* @__remill_error(%struct.State* nonnull dereferenceable(3376) %0, i64 %533, %struct.Memory* %loadMem_40c05a)
  br label %routine_ucomisd__xmm1___xmm0.exit

; <label>:535:                                    ; preds = %block_.L_40c042
...
routine_ucomisd__xmm1___xmm0.exit:                ; preds = %531, %548
  %552 = phi %struct.Memory* [ %534, %531 ], [ %loadMem_40c05a, %548 ]
  ...
  store %struct.Memory* %loadMem_40c05e, %struct.Memory** %MEMORY
...
define %struct.Memory* @routine_movsd_0x7e64__rip____xmm0(%struct.State* dereferenceable(3376), i64, %struct.Memory*) {
block_400478:
  %3 = getelementptr inbounds %struct.State, %struct.State* %0, i32 0, i32 6
  %4 = getelementptr inbounds %struct.GPR, %struct.GPR* %3, i32 0, i32 33
  %5 = getelementptr inbounds %struct.Reg, %struct.Reg* %4, i32 0, i32 0
  ...
  %9 = load i64, i64* %PC
  %10 = ptrtoint %G_0x7e64__rip__4243436__type* @G_0x7e64__rip__4243436_ to i64
  %11 = load i64, i64* %PC
  %12 = add i64 %11, 8
  store i64 %12, i64* %PC
...
define %struct.Memory* @routine_movaps_0x7e5e__rip____xmm2(%struct.State* dereferenceable(3376), i64, %struct.Memory*) {
block_400478:
  %3 = getelementptr inbounds %struct.State, %struct.State* %0, i32 0, i32 6
  %4 = getelementptr inbounds %struct.GPR, %struct.GPR* %3, i32 0, i32 33
  %5 = getelementptr inbounds %struct.Reg, %struct.Reg* %4, i32 0, i32 0
  ...
  %9 = load i64, i64* %PC
  %10 = ptrtoint %G_0x7e5e__rip__4243490__type* @G_0x7e5e__rip__4243490_ to i64
  %11 = load i64, i64* %PC
  %12 = add i64 %11, 7
  store i64 %12, i64* %PC
...
define %struct.Memory* @routine_movsd_0x7e0e__rip____xmm0(%struct.State* dereferenceable(3376), i64, %struct.Memory*) {
block_400478:
  %3 = getelementptr inbounds %struct.State, %struct.State* %0, i32 0, i32 6
  %4 = getelementptr inbounds %struct.GPR, %struct.GPR* %3, i32 0, i32 33
  %5 = getelementptr inbounds %struct.Reg, %struct.Reg* %4, i32 0, i32 0
  ...
  %8 = bitcast %"class.std::bitset"* %YMM0 to i8*
  %9 = load i64, i64* %PC
  %10 = ptrtoint %G_0x7e0e__rip__4243530__type* @G_0x7e0e__rip__4243530_ to i64
  %11 = load i64, i64* %PC
  %12 = add i64 %11, 8
  store i64 %12, i64* %PC
  %13 = inttoptr i64 %10 to double*
...
define %struct.Memory* @routine_movaps_0x7e2a__rip____xmm2(%struct.State* dereferenceable(3376), i64, %struct.Memory*) {
block_400478:
  %3 = getelementptr inbounds %struct.State, %struct.State* %0, i32 0, i32 6
  %4 = getelementptr inbounds %struct.GPR, %struct.GPR* %3, i32 0, i32 33
  %5 = getelementptr inbounds %struct.Reg, %struct.Reg* %4, i32 0, i32 0
  ...
  %8 = bitcast %"class.std::bitset"* %YMM2 to i8*
  %9 = load i64, i64* %PC
  %10 = ptrtoint %G_0x7e2a__rip__4243542__type* @G_0x7e2a__rip__4243542_ to i64
  %11 = load i64, i64* %PC
  %12 = add i64 %11, 7
  store i64 %12, i64* %PC
  %13 = inttoptr i64 %10 to float*
