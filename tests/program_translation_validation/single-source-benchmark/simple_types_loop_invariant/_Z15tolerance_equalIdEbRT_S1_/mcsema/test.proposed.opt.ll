...
routine_ucomisd__xmm0___xmm1.exit:                ; preds = %136, %121
  ...
  br i1 %149, label %block_.L_40c072, label %block_40c060

block_40c060:                                     ; preds = %routine_ucomisd__xmm0___xmm1.exit
...
block_.L_40c072:                                  ; preds = %block_40c060, %routine_ucomisd__xmm0___xmm1.exit
  %168 = phi i64 [ %.pre1, %block_40c060 ], [ %142, %routine_ucomisd__xmm0___xmm1.exit ]
  %169 = add i64 %168, 32278
  %170 = add i64 %168, 8
...
; <label>:200:                                    ; preds = %block_.L_40c072
...
; <label>:210:                                    ; preds = %block_.L_40c072
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_jbe_.L_40c072(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i8* nocapture %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
