...
@G_0x7594__rip_ = local_unnamed_addr global %G_0x7594__rip__type zeroinitializer
@G_0x75a0__rip_ = global %G_0x75a0__rip__type zeroinitializer
@G_0x75b8__rip_ = local_unnamed_addr global %G_0x75b8__rip__type zeroinitializer
...
entry:
  ...
  %call2_40c89b = tail call %struct.Memory* @sub_40c900._ZSt4fabsf(%struct.State* %0, i64 %118, %struct.Memory* %2)
  ...
  %126 = load double, double* bitcast (%G_0x75b8__rip__type* @G_0x75b8__rip_ to double*), align 8
...
; <label>:144:                                    ; preds = %136
  %145 = tail call %struct.Memory* @__remill_error(%struct.State* nonnull dereferenceable(3376) %0, i64 %133, %struct.Memory* %call2_40c89b)
...
routine_ucomisd__xmm1___xmm0.exit39:              ; preds = %156, %144
  ...
  %158 = phi %struct.Memory* [ %145, %144 ], [ %call2_40c89b, %156 ]
  ...
  br i1 %162, label %block_.L_40c8cc, label %block_40c8b6
...
block_.L_40c8cc:                                  ; preds = %block_40c8b6, %routine_ucomisd__xmm1___xmm0.exit39
  %191 = phi i64 [ %.pre1, %block_40c8b6 ], [ %163, %routine_ucomisd__xmm1___xmm0.exit39 ]
  %192 = load double, double* bitcast (%G_0x7594__rip__type* @G_0x7594__rip_ to double*), align 8
  ...
  %201 = load i32, i32* bitcast (%G_0x75a0__rip__type* @G_0x75a0__rip_ to i32*), align 8
  %202 = load i32, i32* inttoptr (i64 add (i64 ptrtoint (%G_0x75a0__rip__type* @G_0x75a0__rip_ to i64), i64 4) to i32*), align 4
  %203 = load i32, i32* inttoptr (i64 add (i64 ptrtoint (%G_0x75a0__rip__type* @G_0x75a0__rip_ to i64), i64 8) to i32*), align 8
  %204 = load i32, i32* inttoptr (i64 add (i64 ptrtoint (%G_0x75a0__rip__type* @G_0x75a0__rip_ to i64), i64 12) to i32*), align 4
...
; <label>:227:                                    ; preds = %block_.L_40c8cc
...
; <label>:237:                                    ; preds = %block_.L_40c8cc
...
block_400478:
  ...
  %5 = load i64, i64* bitcast (%G_0x75b8__rip__type* @G_0x75b8__rip_ to i64*), align 8
...
block_400478:
  ...
  %4 = add i64 %3, 8
  store i64 %4, i64* %PC, align 8
  %5 = load i64, i64* bitcast (%G_0x7594__rip__type* @G_0x7594__rip_ to i64*), align 8
...
block_400478:
  ...
  %6 = add i64 %5, 7
  store i64 %6, i64* %PC, align 8
  %7 = load i32, i32* bitcast (%G_0x75a0__rip__type* @G_0x75a0__rip_ to i32*), align 8
  %8 = load i32, i32* inttoptr (i64 add (i64 ptrtoint (%G_0x75a0__rip__type* @G_0x75a0__rip_ to i64), i64 4) to i32*), align 4
  %9 = load i32, i32* inttoptr (i64 add (i64 ptrtoint (%G_0x75a0__rip__type* @G_0x75a0__rip_ to i64), i64 8) to i32*), align 8
  %10 = load i32, i32* inttoptr (i64 add (i64 ptrtoint (%G_0x75a0__rip__type* @G_0x75a0__rip_ to i64), i64 12) to i32*), align 4
  %11 = bitcast %union.VectorReg* %3 to i32*
