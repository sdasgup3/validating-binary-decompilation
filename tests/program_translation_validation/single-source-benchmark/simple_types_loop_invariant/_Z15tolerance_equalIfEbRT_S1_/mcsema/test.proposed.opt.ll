...
%G_0x7594__rip__4245716__type = type <{ [16 x i8] }>
%G_0x75a0__rip__4245728__type = type <{ [16 x i8] }>
%G_0x75b8__rip__4245672__type = type <{ [16 x i8] }>
...
@G_0x7594__rip__4245716_ = local_unnamed_addr global %G_0x7594__rip__4245716__type zeroinitializer
@G_0x75a0__rip__4245728_ = global %G_0x75a0__rip__4245728__type zeroinitializer
@G_0x75b8__rip__4245672_ = local_unnamed_addr global %G_0x75b8__rip__4245672__type zeroinitializer
...
declare %struct.Memory* @sub_40c900._ZSt4fabsf(%struct.State* noalias dereferenceable(3376), i64, %struct.Memory* noalias readnone returned) local_unnamed_addr
...
entry:
  ...
  %call2_40c89b = tail call %struct.Memory* @sub_40c900._ZSt4fabsf(%struct.State* %0, i64 %115, %struct.Memory* %2)
  %120 = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 1, i64 1
  %121 = bitcast %union.VectorReg* %120 to i8*
  %122 = load i64, i64* %3, align 8
  %123 = load double, double* bitcast (%G_0x75b8__rip__4245672__type* @G_0x75b8__rip__4245672_ to double*), align 8
...
; <label>:140:                                    ; preds = %132
  %141 = tail call %struct.Memory* @__remill_error(%struct.State* nonnull dereferenceable(3376) %0, i64 %130, %struct.Memory* %call2_40c89b)
...
routine_ucomisd__xmm1___xmm0.exit39:              ; preds = %152, %140
  ...
  %154 = phi %struct.Memory* [ %141, %140 ], [ %call2_40c89b, %152 ]
  ...
  br i1 %158, label %block_.L_40c8cc, label %block_40c8b6
...
block_.L_40c8cc:                                  ; preds = %block_40c8b6, %routine_ucomisd__xmm1___xmm0.exit39
  %186 = phi i64 [ %.pre1, %block_40c8b6 ], [ %159, %routine_ucomisd__xmm1___xmm0.exit39 ]
  %187 = load double, double* bitcast (%G_0x7594__rip__4245716__type* @G_0x7594__rip__4245716_ to double*), align 8
  ...
  %196 = load i32, i32* bitcast (%G_0x75a0__rip__4245728__type* @G_0x75a0__rip__4245728_ to i32*), align 8
  %197 = load i32, i32* inttoptr (i64 add (i64 ptrtoint (%G_0x75a0__rip__4245728__type* @G_0x75a0__rip__4245728_ to i64), i64 4) to i32*), align 4
  %198 = load i32, i32* inttoptr (i64 add (i64 ptrtoint (%G_0x75a0__rip__4245728__type* @G_0x75a0__rip__4245728_ to i64), i64 8) to i32*), align 8
  %199 = load i32, i32* inttoptr (i64 add (i64 ptrtoint (%G_0x75a0__rip__4245728__type* @G_0x75a0__rip__4245728_ to i64), i64 12) to i32*), align 4
...
; <label>:222:                                    ; preds = %block_.L_40c8cc
...
; <label>:232:                                    ; preds = %block_.L_40c8cc
...
define %struct.Memory* @routine_movsd_0x75b8__rip____xmm1(%struct.State* dereferenceable(3376), i64, %struct.Memory*) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, 8
  store i64 %4, i64* %PC, align 8
  %5 = load i64, i64* bitcast (%G_0x75b8__rip__4245672__type* @G_0x75b8__rip__4245672_ to i64*), align 8
...
define %struct.Memory* @routine_jbe_.L_40c8cc(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i8* %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
...
define %struct.Memory* @routine_movsd_0x7594__rip____xmm0(%struct.State* dereferenceable(3376), i64, %struct.Memory*) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, 8
  store i64 %4, i64* %PC, align 8
  %5 = load i64, i64* bitcast (%G_0x7594__rip__4245716__type* @G_0x7594__rip__4245716_ to i64*), align 8
...
define %struct.Memory* @routine_movaps_0x75a0__rip____xmm2(%struct.State* dereferenceable(3376), i64, %struct.Memory*) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  ...
  %6 = add i64 %5, 7
  store i64 %6, i64* %PC, align 8
  %7 = load i32, i32* bitcast (%G_0x75a0__rip__4245728__type* @G_0x75a0__rip__4245728_ to i32*), align 8
  %8 = load i32, i32* inttoptr (i64 add (i64 ptrtoint (%G_0x75a0__rip__4245728__type* @G_0x75a0__rip__4245728_ to i64), i64 4) to i32*), align 4
  %9 = load i32, i32* inttoptr (i64 add (i64 ptrtoint (%G_0x75a0__rip__4245728__type* @G_0x75a0__rip__4245728_ to i64), i64 8) to i32*), align 8
  %10 = load i32, i32* inttoptr (i64 add (i64 ptrtoint (%G_0x75a0__rip__4245728__type* @G_0x75a0__rip__4245728_ to i64), i64 12) to i32*), align 4
  %11 = bitcast %union.VectorReg* %3 to i32*
