...
declare %struct.Memory* @sub_40c930._ZSt4fabsf(%struct.State* noalias dereferenceable(3376), i64, %struct.Memory* noalias readnone returned) local_unnamed_addr
...
entry:
  ...
  %call2_40c8c7 = tail call %struct.Memory* @sub_40c930._ZSt4fabsf(%struct.State* %0, i64 %114, %struct.Memory* %2)
  %119 = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 1, i64 1
  %120 = bitcast %union.VectorReg* %119 to i8*
  %121 = load i64, i64* %3, align 8
  %122 = add i64 %121, 30148
  %123 = add i64 %121, 8
...
; <label>:144:                                    ; preds = %136
  %145 = tail call %struct.Memory* @__remill_error(%struct.State* nonnull dereferenceable(3376) %0, i64 %132, %struct.Memory* %call2_40c8c7)
...
routine_ucomisd__xmm1___xmm0.exit39:              ; preds = %156, %144
  ...
  %158 = phi %struct.Memory* [ %145, %144 ], [ %call2_40c8c7, %156 ]
  %159 = add i64 %157, 28
  %160 = add i64 %157, 6
  ...
  br i1 %164, label %block_.L_40c8f8, label %block_40c8e2

block_40c8e2:                                     ; preds = %routine_ucomisd__xmm1___xmm0.exit39
  ...
  br label %block_.L_40c8f8

block_.L_40c8f8:                                  ; preds = %block_40c8e2, %routine_ucomisd__xmm1___xmm0.exit39
  %192 = phi i64 [ %.pre1, %block_40c8e2 ], [ %159, %routine_ucomisd__xmm1___xmm0.exit39 ]
  %193 = add i64 %192, 30112
  %194 = add i64 %192, 8
...
; <label>:241:                                    ; preds = %block_.L_40c8f8
...
; <label>:251:                                    ; preds = %block_.L_40c8f8
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_jbe_.L_40c8f8(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i8* nocapture %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
