...
; <label>:320:                                    ; preds = %312
  ...
  %323 = call %struct.Memory* @__remill_error(%struct.State* nonnull dereferenceable(3376) %0, i64 %322, %struct.Memory* %loadMem_4122ba)
...
routine_ucomisd__xmm1___xmm0.exit:                ; preds = %320, %337
  %341 = phi %struct.Memory* [ %323, %320 ], [ %loadMem_4122ba, %337 ]
