...
@G_0x1bd2__rip__4268678_ = global %G_0x1bd2__rip__4268678__type zeroinitializer
...
entry:
  ...
  store %struct.Memory* %loadMem_412260, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_412270, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_412275, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem1_412279, %struct.Memory** %MEMORY
  %loadMem2_412279 = load %struct.Memory*, %struct.Memory** %MEMORY
  %loadPC_412279 = load i64, i64* %3
  %266 = call %struct.Memory* @__remill_function_call(%struct.State* %0, i64 ptrtoint (i64 (i64)* @abs to i64), %struct.Memory* %loadMem2_412279)
  ...
  %276 = load double, double* bitcast (%G_0x1bd2__rip__4268678__type* @G_0x1bd2__rip__4268678_ to double*)
...
; <label>:319:                                    ; preds = %311
  ...
  %322 = call %struct.Memory* @__remill_error(%struct.State* nonnull dereferenceable(3376) %0, i64 %321, %struct.Memory* %loadMem_41228a)
...
routine_ucomisd__xmm1___xmm0.exit:                ; preds = %319, %336
  %340 = phi %struct.Memory* [ %322, %319 ], [ %loadMem_41228a, %336 ]
  ...
  store %struct.Memory* %loadMem_41228e, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_41229b, %struct.Memory** %MEMORY
  ...
  ret %struct.Memory* %loadMem_41229c
}
...
define %struct.Memory* @routine_movsd_0x1bd2__rip____xmm0(%struct.State* dereferenceable(3376), i64, %struct.Memory*) {
block_400478:
  %3 = getelementptr inbounds %struct.State, %struct.State* %0, i32 0, i32 6
  %4 = getelementptr inbounds %struct.GPR, %struct.GPR* %3, i32 0, i32 33
  %5 = getelementptr inbounds %struct.Reg, %struct.Reg* %4, i32 0, i32 0
