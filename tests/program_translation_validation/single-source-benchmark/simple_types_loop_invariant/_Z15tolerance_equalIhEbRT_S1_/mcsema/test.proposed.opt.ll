...
@G_0x1bd2__rip__4268678_ = local_unnamed_addr global %G_0x1bd2__rip__4268678__type zeroinitializer
...
entry:
  ...
  %109 = load double, double* bitcast (%G_0x1bd2__rip__4268678__type* @G_0x1bd2__rip__4268678_ to double*), align 8
...
define %struct.Memory* @routine_movsd_0x1bd2__rip____xmm0(%struct.State* dereferenceable(3376), i64, %struct.Memory*) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, 8
  store i64 %4, i64* %PC, align 8
  %5 = load i64, i64* bitcast (%G_0x1bd2__rip__4268678__type* @G_0x1bd2__rip__4268678_ to i64*), align 8
