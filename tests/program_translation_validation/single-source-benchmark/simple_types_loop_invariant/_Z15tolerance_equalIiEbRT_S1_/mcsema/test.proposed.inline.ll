...
entry:
  ...
  store %struct.Memory* %loadMem_40f740, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_40f750, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_40f758, %struct.Memory** %MEMORY
  ...
  %loadMem_40f75e = load %struct.Memory*, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_40f75e, %struct.Memory** %MEMORY
  ...
  ret %struct.Memory* %loadMem_40f762
}
