...
define %struct.Memory* @_Z15tolerance_equalIlEbRT_S1_(%struct.State* noalias, i64, %struct.Memory* noalias) #1 {
entry:
  ...
  store %struct.Memory* %loadMem_40e0d3, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_40e0dd, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_40e0e2, %struct.Memory** %MEMORY
  ...
  ret %struct.Memory* %loadMem_40e0e3
}
