...
define %struct.Memory* @_Z15tolerance_equalIlEbRT_S1_(%struct.State* noalias, i64, %struct.Memory* noalias) #2 {
entry:
  ...
  store %struct.Memory* %loadMem_40e090, %struct.Memory** %MEMORY
  ...
  store i64 %55, i64* %58
  store %struct.Memory* %loadMem_40e098, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_40e0a0, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_40e0a7, %struct.Memory** %MEMORY
  %loadMem_40e0aa = load %struct.Memory*, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_40e0aa, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_40e0ad, %struct.Memory** %MEMORY
  ...
  %loadMem_40e0b2 = load %struct.Memory*, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_40e0b2, %struct.Memory** %MEMORY
  ...
  ret %struct.Memory* %loadMem_40e0b3
}
