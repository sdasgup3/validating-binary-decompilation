...
define %struct.Memory* @_Z15tolerance_equalImEbRT_S1_(%struct.State* noalias, i64, %struct.Memory* noalias) #2 {
entry:
  ...
  store %struct.Memory* %loadMem_40d19a, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_40d1a2, %struct.Memory** %MEMORY
  ...
  ret %struct.Memory* %loadMem_40d1a3
}
