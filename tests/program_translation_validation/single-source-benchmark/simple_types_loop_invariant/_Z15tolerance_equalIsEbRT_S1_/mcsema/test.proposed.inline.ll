...
declare %struct.Memory* @sub_400670.abs_plt(%struct.State* dereferenceable(3376), i64, %struct.Memory*)

; Function Attrs: alwaysinline
define %struct.Memory* @_Z15tolerance_equalIsEbRT_S1_(%struct.State* noalias, i64, %struct.Memory* noalias) #1 {
entry:
