...
entry:
  ...
  store %struct.Memory* %loadMem_410277, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_41027b, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem1_41028b, %struct.Memory** %MEMORY
  %loadMem2_41028b = load %struct.Memory*, %struct.Memory** %MEMORY
  %loadPC_41028b = load i64, i64* %3
  %263 = call %struct.Memory* @__remill_function_call(%struct.State* %0, i64 ptrtoint (i64 (i64)* @abs to i64), %struct.Memory* %loadMem2_41028b)
...
; <label>:318:                                    ; preds = %310
  ...
  %321 = call %struct.Memory* @__remill_error(%struct.State* nonnull dereferenceable(3376) %0, i64 %320, %struct.Memory* %loadMem_41029c)
...
routine_ucomisd__xmm1___xmm0.exit:                ; preds = %318, %335
  %339 = phi %struct.Memory* [ %321, %318 ], [ %loadMem_41029c, %335 ]
  ...
  ret %struct.Memory* %loadMem_4102b1
}
