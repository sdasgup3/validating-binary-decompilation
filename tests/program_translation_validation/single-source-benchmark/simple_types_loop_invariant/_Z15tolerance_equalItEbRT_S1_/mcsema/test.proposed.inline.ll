...
; <label>:317:                                    ; preds = %309
  ...
  %320 = call %struct.Memory* @__remill_error(%struct.State* nonnull dereferenceable(3376) %0, i64 %319, %struct.Memory* %loadMem_41029c)
...
routine_ucomisd__xmm1___xmm0.exit:                ; preds = %317, %334
  %338 = phi %struct.Memory* [ %320, %317 ], [ %loadMem_41029c, %334 ]
