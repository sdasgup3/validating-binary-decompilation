...
block_.L_400cc2:                                  ; preds = %block_400cd2, %block_.L_400c6c
  %310 = phi i64 [ %.pre3, %block_.L_400c6c ], [ %611, %block_400cd2 ]
  %MEMORY.2 = phi %struct.Memory* [ %294, %block_.L_400c6c ], [ %573, %block_400cd2 ]
...
block_.L_400d92:                                  ; preds = %block_400da2, %block_.L_400d8b
  %613 = phi i64 [ %721, %block_400da2 ], [ %.pre4, %block_.L_400d8b ]
  ...
  %620 = load i32, i32* bitcast (%G_0x61a0a8_type* @G_0x61a0a8 to i32*), align 8
  %621 = sub i32 %618, %620
  ...
  br i1 %646, label %block_400da2, label %block_.L_400dd1

block_400da2:                                     ; preds = %block_.L_400d92
  %648 = load i64, i64* bitcast (%G_0x61a0a0_type* @G_0x61a0a0 to i64*), align 8
