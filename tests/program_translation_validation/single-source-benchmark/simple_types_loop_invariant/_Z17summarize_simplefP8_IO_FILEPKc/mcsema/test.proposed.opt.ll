...
block_.L_400c16:                                  ; preds = %block_.L_400c59, %entry
  %77 = phi i64 [ %.pre, %entry ], [ %237, %block_.L_400c59 ]
...
block_.L_400cc2:                                  ; preds = %block_400cd2, %block_.L_400c6c
  %311 = phi i64 [ %.pre3, %block_.L_400c6c ], [ %614, %block_400cd2 ]
  %MEMORY.2 = phi %struct.Memory* [ %295, %block_.L_400c6c ], [ %575, %block_400cd2 ]
  ...
  %318 = load i32, i32* bitcast (%G_0x61a0a8_type* @G_0x61a0a8 to i32*), align 8
  %319 = sub i32 %316, %318
  ...
  br i1 %344, label %block_400cd2, label %block_.L_400d8b
...
block_400cd2:                                     ; preds = %block_.L_400cc2
  ...
  %358 = load i64, i64* bitcast (%G_0x61a0a0_type* @G_0x61a0a0 to i64*), align 8
  ...
  %463 = load i64, i64* bitcast (%G_0x61a0a0_type* @G_0x61a0a0 to i64*), align 8
...
block_.L_400d92:                                  ; preds = %block_400da2, %block_.L_400d8b
  %616 = phi i64 [ %725, %block_400da2 ], [ %.pre4, %block_.L_400d8b ]
  ...
  %623 = load i32, i32* bitcast (%G_0x61a0a8_type* @G_0x61a0a8 to i32*), align 8
  %624 = sub i32 %621, %623
  ...
  br i1 %649, label %block_400da2, label %block_.L_400dd1

block_400da2:                                     ; preds = %block_.L_400d92
  %651 = load i64, i64* bitcast (%G_0x61a0a0_type* @G_0x61a0a0 to i64*), align 8
