...
block_.L_400c56:                                  ; preds = %block_.L_400c99, %entry
  %71 = phi i64 [ %229, %block_.L_400c99 ], [ %.pre, %entry ]
...
block_400c66:                                     ; preds = %block_.L_400c56
  ...
  %call2_400c7d = tail call %struct.Memory* @sub_4006b0.strlen_plt(%struct.State* nonnull %0, i64 %143, %struct.Memory* %2)
...
block_.L_400cac:                                  ; preds = %block_.L_400c56
  ...
  %call2_400cce = tail call %struct.Memory* @sub_4006e0.fprintf_plt(%struct.State* nonnull %0, i64 %260, %struct.Memory* %2)
...
block_.L_400d02:                                  ; preds = %block_400d12, %block_.L_400cac
  %300 = phi i64 [ %599, %block_400d12 ], [ %.pre13, %block_.L_400cac ]
...
block_400d12:                                     ; preds = %block_.L_400d02
  ...
  %call2_400d5e = tail call %struct.Memory* @sub_4006b0.strlen_plt(%struct.State* nonnull %0, i64 %413, %struct.Memory* %call2_400cf3)
  ...
  %call2_400db5 = tail call %struct.Memory* @sub_4006e0.fprintf_plt(%struct.State* nonnull %0, i64 %557, %struct.Memory* %call2_400cf3)
...
block_.L_400e11:                                  ; preds = %block_.L_400dd2
  ...
  %call2_400e2a = tail call %struct.Memory* @sub_4006e0.fprintf_plt(%struct.State* nonnull %0, i64 %724, %struct.Memory* %call2_400cf3)
