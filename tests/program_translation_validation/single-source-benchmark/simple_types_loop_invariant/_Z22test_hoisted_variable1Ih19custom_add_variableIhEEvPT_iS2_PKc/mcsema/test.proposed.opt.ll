...
declare %struct.Memory* @sub_412f10._Z26check_shifted_variable_sumIh19custom_add_variableIhEEvT_S2_(%struct.State* noalias dereferenceable(3376), i64, %struct.Memory* noalias) local_unnamed_addr
...
define %struct.Memory* @_Z22test_hoisted_variable1Ih19custom_add_variableIhEEvPT_iS2_PKc(%struct.State* noalias, i64, %struct.Memory* noalias) local_unnamed_addr #1 {
entry:
...
block_.L_404144:                                  ; preds = %block_.L_404192, %entry
  %78 = phi i64 [ %.pre, %entry ], [ %333, %block_.L_404192 ]
  %MEMORY.0 = phi %struct.Memory* [ %call2_404138, %entry ], [ %call2_4041b1, %block_.L_404192 ]
...
block_.L_404192:                                  ; preds = %block_.L_40415f
  ...
  %call2_4041b1 = tail call %struct.Memory* @sub_412f10._Z26check_shifted_variable_sumIh19custom_add_variableIhEEvT_S2_(%struct.State* nonnull %0, i64 %297, %struct.Memory* %MEMORY.0)
...
block_.L_4041c4:                                  ; preds = %block_.L_404144
  ...
  %call2_4041c4 = tail call %struct.Memory* @sub_400e70._Z5timerv(%struct.State* nonnull %0, i64 %334, %struct.Memory* %MEMORY.0)
