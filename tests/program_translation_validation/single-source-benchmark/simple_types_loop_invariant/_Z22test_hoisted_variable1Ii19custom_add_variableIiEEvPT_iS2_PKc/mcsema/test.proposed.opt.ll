...
declare %struct.Memory* @sub_4100e0._Z26check_shifted_variable_sumIi19custom_add_variableIiEEvT_S2_(%struct.State* noalias dereferenceable(3376), i64, %struct.Memory* noalias readnone returned) local_unnamed_addr
...
entry:
  ...
  %call2_4075e6 = tail call %struct.Memory* @sub_400e60._Z11start_timerv(%struct.State* %0, i64 %65, %struct.Memory* %2)
...
block_.L_4075f2:                                  ; preds = %block_.L_40763b, %entry
  %75 = phi i64 [ %337, %block_.L_40763b ], [ %.pre, %entry ]
  ...
  br i1 %108, label %block_407602, label %block_.L_407661

block_407602:                                     ; preds = %block_.L_4075f2
  %110 = add i64 %76, -32
  %111 = add i64 %109, 7
...
block_.L_407610:                                  ; preds = %block_40761c, %block_407602
  %118 = phi i64 [ %232, %block_40761c ], [ %.pre6, %block_407602 ]
  ...
  br i1 %154, label %block_40761c, label %block_.L_40763b

block_40761c:                                     ; preds = %block_.L_407610
  %156 = add i64 %119, -8
  %157 = add i64 %155, 4
...
block_.L_40763b:                                  ; preds = %block_.L_407610
  %233 = add i64 %155, 3
  ...
  %call2_40764e = tail call %struct.Memory* @sub_4100e0._Z26check_shifted_variable_sumIi19custom_add_variableIiEEvT_S2_(%struct.State* nonnull %0, i64 %301, %struct.Memory* %call2_4075e6)
...
block_.L_407661:                                  ; preds = %block_.L_4075f2
  ...
  %call2_407661 = tail call %struct.Memory* @sub_400e80._Z5timerv(%struct.State* nonnull %0, i64 %338, %struct.Memory* %call2_4075e6)
  ...
  %call2_40766a = tail call %struct.Memory* @sub_400820._Z13record_resultdPKc(%struct.State* nonnull %0, i64 %349, %struct.Memory* %call2_407661)
