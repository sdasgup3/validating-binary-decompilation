...
declare %struct.Memory* @sub_40eb10._Z26check_shifted_variable_sumIl19custom_add_variableIlEEvT_S2_(%struct.State* noalias dereferenceable(3376), i64, %struct.Memory* noalias) local_unnamed_addr
...
define %struct.Memory* @_Z22test_hoisted_variable1Il19custom_add_variableIlEEvPT_iS2_PKc(%struct.State* noalias, i64, %struct.Memory* noalias) local_unnamed_addr #1 {
entry:
...
block_.L_4090d3:                                  ; preds = %block_.L_409120, %entry
  %73 = phi i64 [ %.pre, %entry ], [ %335, %block_.L_409120 ]
  %MEMORY.0 = phi %struct.Memory* [ %call2_4090c7, %entry ], [ %call2_409139, %block_.L_409120 ]
...
block_.L_409120:                                  ; preds = %block_.L_4090f2
  ...
  %call2_409139 = tail call %struct.Memory* @sub_40eb10._Z26check_shifted_variable_sumIl19custom_add_variableIlEEvT_S2_(%struct.State* nonnull %0, i64 %299, %struct.Memory* %MEMORY.0)
...
block_.L_40914c:                                  ; preds = %block_.L_4090d3
  ...
  %call2_40914c = tail call %struct.Memory* @sub_400e70._Z5timerv(%struct.State* nonnull %0, i64 %336, %struct.Memory* %MEMORY.0)
