...
block_.L_4090a3:                                  ; preds = %block_.L_4090f0, %entry
  %73 = phi i64 [ %.pre, %entry ], [ %335, %block_.L_4090f0 ]
...
block_.L_4090c2:                                  ; preds = %block_4090ce, %block_4090b3
  %116 = phi i64 [ %229, %block_4090ce ], [ %.pre1, %block_4090b3 ]
...
block_.L_4090f0:                                  ; preds = %block_.L_4090c2
  ...
  %call2_409109 = tail call %struct.Memory* @sub_40eae0._Z26check_shifted_variable_sumIl19custom_add_variableIlEEvT_S2_(%struct.State* %0, i64 %299, %struct.Memory* %MEMORY.0)
...
block_.L_40911c:                                  ; preds = %block_.L_4090a3
  ...
  %call2_40911c = tail call %struct.Memory* @sub_400e30._Z5timerv(%struct.State* %0, i64 %336, %struct.Memory* %MEMORY.0)
  ...
  %call2_409125 = tail call %struct.Memory* @sub_4007d0._Z13record_resultdPKc(%struct.State* %0, i64 %347, %struct.Memory* %call2_40911c)
