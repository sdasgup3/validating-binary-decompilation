; ModuleID = '/tmp/tmpayb0iw4l-query.ll'
...
define %struct.Memory* @_Z22test_hoisted_variable1Il19custom_add_variableIlEEvPT_iS2_PKc(%struct.State* noalias, i64, %struct.Memory* noalias readnone returned) local_unnamed_addr #1 {
entry:
  %var_2_3 = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %RBP.i = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 15, i32 0, i32 0
  %var_2_62 = load i64, i64* %var_2_3, align 8
  %var_2_63 = add i64 %var_2_62, -33399
  %call2_4090d7 = tail call %struct.Memory* @sub_400e60._Z11start_timerv(%struct.State* %0, i64 %var_2_63, %struct.Memory* %2)
  ...
  br i1 %var_2_10615, label %block_4090f3.preheader, label %block_.L_40915c

block_4090f3.preheader:                           ; preds = %entry
  ...
  br i1 %var_2_152, label %block_.L_409102.preheader, label %block_4090f3.preheader5

block_4090f3.preheader5:                          ; preds = %block_4090f3.preheader
  br label %block_4090f3

block_.L_409102.preheader:                        ; preds = %block_4090f3.preheader
  br label %block_.L_409102

block_4090f3:                                     ; preds = %block_4090f3.preheader5, %block_4090f3
  br label %block_4090f3

block_.L_409102:                                  ; preds = %block_.L_409102.preheader, %block_.L_409102
  br label %block_.L_409102

block_.L_40915c:                                  ; preds = %entry
  %.pre = load i64, i64* %var_2_3, align 8
  %var_2_336 = add i64 %.pre, -33379
  %call2_40915c = tail call %struct.Memory* @sub_400e80._Z5timerv(%struct.State* nonnull %0, i64 %var_2_336, %struct.Memory* %call2_4090d7)
  %var_2_343 = load i64, i64* %var_2_3, align 8
  %var_2_347 = add i64 %var_2_343, -35137
  %call2_409165 = tail call %struct.Memory* @sub_400820._Z13record_resultdPKc(%struct.State* nonnull %0, i64 %var_2_347, %struct.Memory* %call2_40915c)
