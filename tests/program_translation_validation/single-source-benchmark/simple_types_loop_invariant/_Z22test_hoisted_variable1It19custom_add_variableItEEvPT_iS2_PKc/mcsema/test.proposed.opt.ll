...
declare %struct.Memory* @sub_411080._Z26check_shifted_variable_sumIt19custom_add_variableItEEvT_S2_(%struct.State* noalias dereferenceable(3376), i64, %struct.Memory* noalias readnone returned) local_unnamed_addr
...
define %struct.Memory* @_Z22test_hoisted_variable1It19custom_add_variableItEEvPT_iS2_PKc(%struct.State* noalias, i64, %struct.Memory* noalias readnone) local_unnamed_addr #1 {
entry:
  ...
  %call2_4063ea = tail call %struct.Memory* @sub_400e60._Z11start_timerv(%struct.State* %0, i64 %68, %struct.Memory* %2)
...
block_.L_4063f6:                                  ; preds = %block_.L_406446, %entry
  %78 = phi i64 [ %334, %block_.L_406446 ], [ %.pre, %entry ]
  ...
  br i1 %111, label %block_406406, label %block_.L_40647b
...
block_.L_406413:                                  ; preds = %block_40641f, %block_406406
  %121 = phi i64 [ %226, %block_40641f ], [ %.pre6, %block_406406 ]
  ...
  br i1 %157, label %block_40641f, label %block_.L_406446
...
block_.L_406446:                                  ; preds = %block_.L_406413
  ...
  %call2_406468 = tail call %struct.Memory* @sub_411080._Z26check_shifted_variable_sumIt19custom_add_variableItEEvT_S2_(%struct.State* nonnull %0, i64 %298, %struct.Memory* %call2_4063ea)
...
block_.L_40647b:                                  ; preds = %block_.L_4063f6
  ...
  %call2_40647b = tail call %struct.Memory* @sub_400e80._Z5timerv(%struct.State* nonnull %0, i64 %335, %struct.Memory* %call2_4063ea)
  ...
  %call2_406484 = tail call %struct.Memory* @sub_400820._Z13record_resultdPKc(%struct.State* nonnull %0, i64 %346, %struct.Memory* %call2_40647b)
