; ModuleID = '/tmp/tmpxpgpvtx4-query.ll'
...
define %struct.Memory* @_Z22test_hoisted_variable1It19custom_add_variableItEEvPT_iS2_PKc(%struct.State* noalias, i64, %struct.Memory* noalias readnone returned) local_unnamed_addr #1 {
entry:
  %var_2_3 = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %RBP.i = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 15, i32 0, i32 0
  %var_2_67 = load i64, i64* %var_2_3, align 8
  %var_2_68 = add i64 %var_2_67, -21898
  %call2_4063ea = tail call %struct.Memory* @sub_400e60._Z11start_timerv(%struct.State* %0, i64 %var_2_68, %struct.Memory* %2)
  %var_2_7918 = load i64, i64* %RBP.i, align 8
  %var_2_8019 = add i64 %var_2_7918, -28
  %var_2_8220 = inttoptr i64 %var_2_8019 to i32*
  %var_2_8321 = load i32, i32* %var_2_8220, align 4
  %var_2_8522 = load i32, i32* bitcast (%G_0x61a080_type* @G_0x61a080 to i32*), align 8
  %var_2_8623 = sub i32 %var_2_8321, %var_2_8522
  %var_2_10124 = lshr i32 %var_2_8623, 31
  %var_2_10325 = lshr i32 %var_2_8321, 31
  %var_2_10426 = lshr i32 %var_2_8522, 31
  %var_2_10527 = xor i32 %var_2_10426, %var_2_10325
  %var_2_10628 = xor i32 %var_2_10124, %var_2_10325
  %var_2_10729 = add nuw nsw i32 %var_2_10628, %var_2_10527
  %var_2_10830 = icmp eq i32 %var_2_10729, 2
  %var_2_11031 = icmp ne i32 %var_2_10124, 0
  %var_2_11132 = xor i1 %var_2_11031, %var_2_10830
  br i1 %var_2_11132, label %block_406406.preheader, label %block_.L_40647b

block_406406.preheader:                           ; preds = %entry
  %var_2_1232 = add i64 %var_2_7918, -36
  %var_2_1253 = inttoptr i64 %var_2_1232 to i32*
  %var_2_1264 = load i32, i32* %var_2_1253, align 4
  %var_2_1285 = add i64 %var_2_7918, -12
  %var_2_1306 = inttoptr i64 %var_2_1285 to i32*
  %var_2_1317 = load i32, i32* %var_2_1306, align 4
  %var_2_1328 = sub i32 %var_2_1264, %var_2_1317
  %var_2_1479 = lshr i32 %var_2_1328, 31
  %var_2_14910 = lshr i32 %var_2_1264, 31
  %var_2_15011 = lshr i32 %var_2_1317, 31
  %var_2_15112 = xor i32 %var_2_15011, %var_2_14910
  %var_2_15213 = xor i32 %var_2_1479, %var_2_14910
  %var_2_15314 = add nuw nsw i32 %var_2_15213, %var_2_15112
  %var_2_15415 = icmp eq i32 %var_2_15314, 2
  %var_2_15616 = icmp ne i32 %var_2_1479, 0
  %var_2_15717 = xor i1 %var_2_15616, %var_2_15415
  br i1 %var_2_15717, label %block_40641f.us.preheader, label %block_406406.preheader6

block_406406.preheader6:                          ; preds = %block_406406.preheader
  br label %block_406406

block_40641f.us.preheader:                        ; preds = %block_406406.preheader
  br label %block_40641f.us

block_40641f.us:                                  ; preds = %block_40641f.us.preheader, %block_40641f.us
  br label %block_40641f.us

block_406406:                                     ; preds = %block_406406.preheader6, %block_406406
  br label %block_406406

block_.L_40647b:                                  ; preds = %entry
  %.pre = load i64, i64* %var_2_3, align 8
  %var_2_335 = add i64 %.pre, -21878
  %call2_40647b = tail call %struct.Memory* @sub_400e80._Z5timerv(%struct.State* nonnull %0, i64 %var_2_335, %struct.Memory* %call2_4063ea)
  %var_2_342 = load i64, i64* %var_2_3, align 8
  %var_2_346 = add i64 %var_2_342, -23648
  %call2_406484 = tail call %struct.Memory* @sub_400820._Z13record_resultdPKc(%struct.State* nonnull %0, i64 %var_2_346, %struct.Memory* %call2_40647b)
  ret %struct.Memory* %call2_406484
}
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_jge_.L_40647b(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i8* nocapture %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_jge_.L_406446(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i8* nocapture %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 2, i32 9
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_movzwl_MINUS0x1e__rbp____esi(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_movw__di__MINUS0x1e__rbp_(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_jmpq_.L_406413(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_movzwl_MINUS0xe__rbp____ecx(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %RCX = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 5, i32 0, i32 0
  %RBP = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 15, i32 0, i32 0
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_movzwl_MINUS0x1e__rbp____ecx(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %RCX = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 5, i32 0, i32 0
  %RBP = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 15, i32 0, i32 0
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_movw__dx__MINUS0x1e__rbp_(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 7, i32 0
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_movw_MINUS0x1e__rbp____dx(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 7, i32 0
  %DX = bitcast %union.anon* %3 to i16*
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_callq_._Z26check_shifted_variable_sumIt19custom_add_variableItEEvT_S2_(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_jmpq_.L_4063f6(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
