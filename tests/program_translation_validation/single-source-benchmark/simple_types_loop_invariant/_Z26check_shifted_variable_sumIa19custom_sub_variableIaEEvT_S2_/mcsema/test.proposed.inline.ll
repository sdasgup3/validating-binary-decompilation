...
%G_0x20648c__rip__type = type <{ [8 x i8] }>
...
@G_0x20648c__rip_ = global %G_0x20648c__rip__type zeroinitializer
...
declare %struct.Memory* @sub_413bb0._ZN19custom_sub_variableIaE8do_shiftEaa(%struct.State* noalias dereferenceable(3376), i64, %struct.Memory* noalias readnone returned)
...
define %struct.Memory* @_Z26check_shifted_variable_sumIa19custom_sub_variableIaEEvT_S2_(%struct.State* noalias, i64, %struct.Memory* noalias) #2 {
entry:
  ...
  %loadMem_413be1 = load %struct.Memory*, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_413be1, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_413be8, %struct.Memory** %MEMORY
  %loadMem_413beb = load %struct.Memory*, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_413beb, %struct.Memory** %MEMORY
  %loadMem_413bee = load %struct.Memory*, %struct.Memory** %MEMORY
  ...
  store i8 %109, i8* %113
  store %struct.Memory* %loadMem_413bee, %struct.Memory** %MEMORY
  ...
  store i8 %126, i8* %130
  store %struct.Memory* %loadMem_413bf1, %struct.Memory** %MEMORY
  ...
  %138 = add i64 %137, ptrtoint (%G_0x20648c__rip__type* @G_0x20648c__rip_ to i64)
  ...
  store %struct.Memory* %loadMem_413bf4, %struct.Memory** %MEMORY
  %loadMem_413bfc = load %struct.Memory*, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_413bfc, %struct.Memory** %MEMORY
  ...
  %loadMem_413c06 = load %struct.Memory*, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_413c06, %struct.Memory** %MEMORY
  %loadMem1_413c0a = load %struct.Memory*, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem1_413c0a, %struct.Memory** %MEMORY
  %loadMem2_413c0a = load %struct.Memory*, %struct.Memory** %MEMORY
  %loadPC_413c0a = load i64, i64* %3
  %call2_413c0a = call %struct.Memory* @sub_413bb0._ZN19custom_sub_variableIaE8do_shiftEaa(%struct.State* %0, i64 %loadPC_413c0a, %struct.Memory* %loadMem2_413c0a)
  store %struct.Memory* %call2_413c0a, %struct.Memory** %MEMORY
  ...
  %loadMem_413c17 = load %struct.Memory*, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_413c17, %struct.Memory** %MEMORY
  ...
  %loadMem_413c1d = load %struct.Memory*, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_413c1d, %struct.Memory** %MEMORY
  %loadMem_413c1f = load %struct.Memory*, %struct.Memory** %MEMORY
  ...
  store i8 %331, i8* %335
  store %struct.Memory* %loadMem_413c1f, %struct.Memory** %MEMORY
  %loadMem1_413c22 = load %struct.Memory*, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem1_413c22, %struct.Memory** %MEMORY
  %loadMem2_413c22 = load %struct.Memory*, %struct.Memory** %MEMORY
  %loadPC_413c22 = load i64, i64* %3
  %call2_413c22 = call %struct.Memory* @sub_4130b0._Z15tolerance_equalIaEbRT_S1_(%struct.State* %0, i64 %loadPC_413c22, %struct.Memory* %loadMem2_413c22)
  store %struct.Memory* %call2_413c22, %struct.Memory** %MEMORY
  ...
  br i1 %cmpBr_413c29, label %block_.L_413c4a, label %block_413c2f

block_413c2f:                                     ; preds = %entry
  ...
  %loadMem_413c39 = load %struct.Memory*, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_413c39, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem1_413c42, %struct.Memory** %MEMORY
  %loadMem2_413c42 = load %struct.Memory*, %struct.Memory** %MEMORY
  %loadPC_413c42 = load i64, i64* %3
  %433 = call %struct.Memory* @__remill_function_call(%struct.State* %0, i64 ptrtoint (i64 (i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64)* @printf to i64), %struct.Memory* %loadMem2_413c42)
  ...
  br label %block_.L_413c4a

block_.L_413c4a:                                  ; preds = %block_413c2f, %entry
  %loadMem_413c4a = load %struct.Memory*, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_413c4a, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_413c4e, %struct.Memory** %MEMORY
  ...
  ret %struct.Memory* %loadMem_413c4f
}
...
; Function Attrs: alwaysinline
define %struct.Memory* @routine_movsd_0x20648c__rip____xmm0(%struct.State* dereferenceable(3376), i64, %struct.Memory*) #2 {
block_400488:
  %3 = getelementptr inbounds %struct.State, %struct.State* %0, i32 0, i32 6
  %4 = getelementptr inbounds %struct.GPR, %struct.GPR* %3, i32 0, i32 33
  %5 = getelementptr inbounds %struct.Reg, %struct.Reg* %4, i32 0, i32 0
  ...
  %9 = load i64, i64* %PC
  %10 = add i64 %9, ptrtoint (%G_0x20648c__rip__type* @G_0x20648c__rip_ to i64)
  %11 = load i64, i64* %PC
  %12 = add i64 %11, 8
  store i64 %12, i64* %PC
...
; Function Attrs: alwaysinline
define %struct.Memory* @routine_callq_._ZN19custom_sub_variableIaE8do_shiftEaa(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) #2 {
block_400488:
  %3 = getelementptr inbounds %struct.State, %struct.State* %0, i32 0, i32 6
  %4 = getelementptr inbounds %struct.GPR, %struct.GPR* %3, i32 0, i32 33
  %5 = getelementptr inbounds %struct.Reg, %struct.Reg* %4, i32 0, i32 0
...
; Function Attrs: alwaysinline
define %struct.Memory* @routine_jne_.L_413c4a(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i8* %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) #2 {
block_400488:
  %3 = getelementptr inbounds %struct.State, %struct.State* %0, i32 0, i32 6
  %4 = getelementptr inbounds %struct.GPR, %struct.GPR* %3, i32 0, i32 33
  %5 = getelementptr inbounds %struct.Reg, %struct.Reg* %4, i32 0, i32 0
