...
@G_0x206c5c__rip__4273196_ = global %G_0x206c5c__rip__4273196__type zeroinitializer
...
entry:
  ...
  %140 = load double, double* bitcast (%G_0x206c5c__rip__4273196__type* @G_0x206c5c__rip__4273196_ to double*)
  ...
  store %struct.Memory* %loadMem_413443, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem1_413452, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_413457, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_413459, %struct.Memory** %MEMORY
...
block_41345f:                                     ; preds = %entry
  ...
  %431 = call %struct.Memory* @__remill_function_call(%struct.State* %0, i64 ptrtoint (i64 (i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64)* @printf to i64), %struct.Memory* %loadMem2_413472)
...
block_.L_41347a:                                  ; preds = %block_41345f, %entry
  ...
  ret %struct.Memory* %loadMem_41347f
}
...
define %struct.Memory* @routine_movsd_0x206c5c__rip____xmm0(%struct.State* dereferenceable(3376), i64, %struct.Memory*) {
block_400478:
  %3 = getelementptr inbounds %struct.State, %struct.State* %0, i32 0, i32 6
  %4 = getelementptr inbounds %struct.GPR, %struct.GPR* %3, i32 0, i32 33
  %5 = getelementptr inbounds %struct.Reg, %struct.Reg* %4, i32 0, i32 0
