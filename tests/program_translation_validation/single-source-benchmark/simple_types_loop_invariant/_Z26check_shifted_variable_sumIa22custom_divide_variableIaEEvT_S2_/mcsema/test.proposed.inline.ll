...
block_41380f:                                     ; preds = %entry
  ...
  %call2_413822 = call %struct.Memory* @sub_4006c0.printf_plt(%struct.State* %0, i64 %loadPC_413822, %struct.Memory* %loadMem2_413822)
  store %struct.Memory* %call2_413822, %struct.Memory** %MEMORY
