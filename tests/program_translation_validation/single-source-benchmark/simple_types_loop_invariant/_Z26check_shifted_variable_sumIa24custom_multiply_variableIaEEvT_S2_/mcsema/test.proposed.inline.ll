...
@G_0x20665c__rip__4274732_ = global %G_0x20665c__rip__4274732__type zeroinitializer
...
entry:
  ...
  %140 = load double, double* bitcast (%G_0x20665c__rip__4274732__type* @G_0x20665c__rip__4274732_ to double*)
  ...
  store %struct.Memory* %loadMem_413a43, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_413a4d, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem1_413a52, %struct.Memory** %MEMORY
...
block_413a5f:                                     ; preds = %entry
  ...
  store %struct.Memory* %loadMem1_413a72, %struct.Memory** %MEMORY
  %loadMem2_413a72 = load %struct.Memory*, %struct.Memory** %MEMORY
  %loadPC_413a72 = load i64, i64* %3
  %431 = call %struct.Memory* @__remill_function_call(%struct.State* %0, i64 ptrtoint (i64 (i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64)* @printf to i64), %struct.Memory* %loadMem2_413a72)
...
block_.L_413a7a:                                  ; preds = %block_413a5f, %entry
  ...
  ret %struct.Memory* %loadMem_413a7f
}
...
define %struct.Memory* @routine_movsd_0x20665c__rip____xmm0(%struct.State* dereferenceable(3376), i64, %struct.Memory*) {
block_400478:
  %3 = getelementptr inbounds %struct.State, %struct.State* %0, i32 0, i32 6
  %4 = getelementptr inbounds %struct.GPR, %struct.GPR* %3, i32 0, i32 33
  %5 = getelementptr inbounds %struct.Reg, %struct.Reg* %4, i32 0, i32 0
