...
@G_0x2063f6__rip__4275346_ = local_unnamed_addr global %G_0x2063f6__rip__4275346__type zeroinitializer
...
declare %struct.Memory* @sub_413c10._ZN28custom_add_multiple_variableIaE8do_shiftEaaaaa(%struct.State* noalias dereferenceable(3376), i64, %struct.Memory* noalias readnone returned) local_unnamed_addr
...
define %struct.Memory* @_Z26check_shifted_variable_sumIa28custom_add_multiple_variableIaEEvT_S2_S2_S2_S2_(%struct.State* noalias, i64, %struct.Memory* noalias) local_unnamed_addr #1 {
entry:
  ...
  %90 = load double, double* bitcast (%G_0x2063f6__rip__4275346__type* @G_0x2063f6__rip__4275346_ to double*), align 8
  ...
  %call2_413cb8 = tail call %struct.Memory* @sub_413c10._ZN28custom_add_multiple_variableIaE8do_shiftEaaaaa(%struct.State* %0, i64 %131, %struct.Memory* %2)
  ...
  %call2_413cd0 = tail call %struct.Memory* @sub_413070._Z15tolerance_equalIaEbRT_S1_(%struct.State* %0, i64 %161, %struct.Memory* %call2_413cb8)
  ...
  br i1 %174, label %block_.L_413cf8, label %block_413cdd
...
block_413cdd:                                     ; preds = %entry
  ...
  %183 = tail call %struct.Memory* @__remill_function_call(%struct.State* %0, i64 ptrtoint (i64 (i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64)* @printf to i64), %struct.Memory* %call2_413cd0)
...
block_.L_413cf8:                                  ; preds = %block_413cdd, %entry
  %190 = phi i64 [ %175, %entry ], [ %.pre, %block_413cdd ]
  %MEMORY.0 = phi %struct.Memory* [ %call2_413cd0, %entry ], [ %183, %block_413cdd ]
...
define %struct.Memory* @routine_movsd_0x2063f6__rip____xmm0(%struct.State* dereferenceable(3376), i64, %struct.Memory*) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, 8
  store i64 %4, i64* %PC, align 8
  %5 = load i64, i64* bitcast (%G_0x2063f6__rip__4275346__type* @G_0x2063f6__rip__4275346_ to i64*), align 8
...
define %struct.Memory* @routine_callq_._ZN28custom_add_multiple_variableIaE8do_shiftEaaaaa(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
...
define %struct.Memory* @routine_jne_.L_413cf8(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i8* %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
