...
block_4133ed:                                     ; preds = %entry
  ...
  %call2_413400 = call %struct.Memory* @sub_4006c0.printf_plt(%struct.State* %0, i64 %loadPC_413400, %struct.Memory* %loadMem2_413400)
  store %struct.Memory* %call2_413400, %struct.Memory** %MEMORY
