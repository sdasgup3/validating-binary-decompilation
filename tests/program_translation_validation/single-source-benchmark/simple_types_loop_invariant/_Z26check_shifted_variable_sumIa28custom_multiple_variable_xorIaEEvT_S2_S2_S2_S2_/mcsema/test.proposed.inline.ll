...
entry:
  ...
  store %struct.Memory* %loadMem_413005, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem1_413070, %struct.Memory** %MEMORY
...
block_41307d:                                     ; preds = %entry
  ...
  %645 = call %struct.Memory* @__remill_function_call(%struct.State* %0, i64 ptrtoint (i64 (i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64)* @printf to i64), %struct.Memory* %loadMem2_413090)
...
block_.L_413098:                                  ; preds = %block_41307d, %entry
  ...
  store %struct.Memory* %loadMem_413098, %struct.Memory** %MEMORY
  ...
  ret %struct.Memory* %loadMem_41309e
}
...
define %struct.Memory* @routine_movsd_0x207056__rip____xmm0(%struct.State* dereferenceable(3376), i64, %struct.Memory*) {
block_400488:
  %3 = getelementptr inbounds %struct.State, %struct.State* %0, i32 0, i32 6
  %4 = getelementptr inbounds %struct.GPR, %struct.GPR* %3, i32 0, i32 33
  %5 = getelementptr inbounds %struct.Reg, %struct.Reg* %4, i32 0, i32 0
