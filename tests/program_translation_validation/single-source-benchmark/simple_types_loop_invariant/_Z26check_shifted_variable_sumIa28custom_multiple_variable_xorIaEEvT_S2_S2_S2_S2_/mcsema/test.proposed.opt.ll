...
@G_0x207086__rip__4272130_ = local_unnamed_addr global %G_0x207086__rip__4272130__type zeroinitializer
...
entry:
  ...
  %90 = load double, double* bitcast (%G_0x207086__rip__4272130__type* @G_0x207086__rip__4272130_ to double*), align 8
  ...
  %call2_413028 = tail call %struct.Memory* @sub_412f80._ZN28custom_multiple_variable_xorIaE8do_shiftEaaaaa(%struct.State* %0, i64 %131, %struct.Memory* %2)
  ...
  %call2_413040 = tail call %struct.Memory* @sub_413070._Z15tolerance_equalIaEbRT_S1_(%struct.State* %0, i64 %161, %struct.Memory* %call2_413028)
  ...
  br i1 %174, label %block_.L_413068, label %block_41304d

block_41304d:                                     ; preds = %entry
  ...
  %183 = tail call %struct.Memory* @__remill_function_call(%struct.State* %0, i64 ptrtoint (i64 (i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64)* @printf to i64), %struct.Memory* %call2_413040)
...
block_.L_413068:                                  ; preds = %block_41304d, %entry
  %190 = phi i64 [ %175, %entry ], [ %.pre, %block_41304d ]
  %MEMORY.0 = phi %struct.Memory* [ %call2_413040, %entry ], [ %183, %block_41304d ]
...
define %struct.Memory* @routine_movsd_0x207086__rip____xmm0(%struct.State* dereferenceable(3376), i64, %struct.Memory*) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, 8
  store i64 %4, i64* %PC, align 8
  %5 = load i64, i64* bitcast (%G_0x207086__rip__4272130__type* @G_0x207086__rip__4272130_ to i64*), align 8
...
define %struct.Memory* @routine_jne_.L_413068(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i8* %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
