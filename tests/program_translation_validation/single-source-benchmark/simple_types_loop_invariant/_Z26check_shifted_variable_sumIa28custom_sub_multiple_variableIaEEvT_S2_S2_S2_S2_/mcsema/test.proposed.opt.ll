...
@G_0x206586__rip__4274946_ = local_unnamed_addr global %G_0x206586__rip__4274946__type zeroinitializer
...
declare %struct.Memory* @sub_413a80._ZN28custom_sub_multiple_variableIaE8do_shiftEaaaaa(%struct.State* noalias dereferenceable(3376), i64, %struct.Memory* noalias readnone returned) local_unnamed_addr
...
entry:
  ...
  %90 = load double, double* bitcast (%G_0x206586__rip__4274946__type* @G_0x206586__rip__4274946_ to double*), align 8
  ...
  %call2_413b28 = tail call %struct.Memory* @sub_413a80._ZN28custom_sub_multiple_variableIaE8do_shiftEaaaaa(%struct.State* %0, i64 %131, %struct.Memory* %2)
  ...
  %call2_413b40 = tail call %struct.Memory* @sub_413070._Z15tolerance_equalIaEbRT_S1_(%struct.State* %0, i64 %161, %struct.Memory* %call2_413b28)
  ...
  br i1 %174, label %block_.L_413b68, label %block_413b4d
...
block_413b4d:                                     ; preds = %entry
  ...
  %183 = tail call %struct.Memory* @__remill_function_call(%struct.State* %0, i64 ptrtoint (i64 (i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64)* @printf to i64), %struct.Memory* %call2_413b40)
...
block_.L_413b68:                                  ; preds = %block_413b4d, %entry
  %190 = phi i64 [ %175, %entry ], [ %.pre, %block_413b4d ]
  %MEMORY.0 = phi %struct.Memory* [ %call2_413b40, %entry ], [ %183, %block_413b4d ]
...
define %struct.Memory* @routine_movsd_0x206586__rip____xmm0(%struct.State* dereferenceable(3376), i64, %struct.Memory*) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, 8
  store i64 %4, i64* %PC, align 8
  %5 = load i64, i64* bitcast (%G_0x206586__rip__4274946__type* @G_0x206586__rip__4274946_ to i64*), align 8
...
define %struct.Memory* @routine_callq_._ZN28custom_sub_multiple_variableIaE8do_shiftEaaaaa(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
...
define %struct.Memory* @routine_jne_.L_413b68(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i8* %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
