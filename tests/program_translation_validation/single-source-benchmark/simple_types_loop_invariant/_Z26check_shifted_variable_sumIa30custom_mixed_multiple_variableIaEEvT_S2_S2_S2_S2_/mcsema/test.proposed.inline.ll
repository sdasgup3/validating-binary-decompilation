...
%G_0x206b86__rip__4273410__type = type <{ [16 x i8] }>
...
@G_0x206b86__rip__4273410_ = global %G_0x206b86__rip__4273410__type zeroinitializer
...
declare %struct.Memory* @sub_413480._ZN30custom_mixed_multiple_variableIaE8do_shiftEaaaaa(%struct.State* noalias dereferenceable(3376), i64, %struct.Memory* noalias readnone returned)
...
entry:
  ...
  store %struct.Memory* %loadMem_4134d1, %struct.Memory** %MEMORY
  %loadMem_4134d4 = load %struct.Memory*, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_4134d4, %struct.Memory** %MEMORY
  ...
  %loadMem_4134dc = load %struct.Memory*, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_4134dc, %struct.Memory** %MEMORY
  ...
  store i8 %235, i8* %239
  store %struct.Memory* %loadMem_4134f7, %struct.Memory** %MEMORY
  ...
  %249 = load double, double* bitcast (%G_0x206b86__rip__4273410__type* @G_0x206b86__rip__4273410_ to double*)
  ...
  %loadMem_413502 = load %struct.Memory*, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_413502, %struct.Memory** %MEMORY
  %loadMem_413506 = load %struct.Memory*, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_413506, %struct.Memory** %MEMORY
  %loadMem_413508 = load %struct.Memory*, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_413508, %struct.Memory** %MEMORY
  %loadMem_41350c = load %struct.Memory*, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_41350c, %struct.Memory** %MEMORY
  ...
  %loadMem_41351b = load %struct.Memory*, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_41351b, %struct.Memory** %MEMORY
  ...
  %loadMem1_413528 = load %struct.Memory*, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem1_413528, %struct.Memory** %MEMORY
  %loadMem2_413528 = load %struct.Memory*, %struct.Memory** %MEMORY
  %loadPC_413528 = load i64, i64* %3
  %call2_413528 = call %struct.Memory* @sub_413480._ZN30custom_mixed_multiple_variableIaE8do_shiftEaaaaa(%struct.State* %0, i64 %loadPC_413528, %struct.Memory* %loadMem2_413528)
  store %struct.Memory* %call2_413528, %struct.Memory** %MEMORY
  %loadMem_41352d = load %struct.Memory*, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_41352d, %struct.Memory** %MEMORY
  %loadMem_413531 = load %struct.Memory*, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_413531, %struct.Memory** %MEMORY
  ...
  %loadMem_413538 = load %struct.Memory*, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_413538, %struct.Memory** %MEMORY
  %loadMem_41353b = load %struct.Memory*, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_41353b, %struct.Memory** %MEMORY
  %loadMem_41353d = load %struct.Memory*, %struct.Memory** %MEMORY
  ...
  store i8 %541, i8* %545
  store %struct.Memory* %loadMem_41353d, %struct.Memory** %MEMORY
  %loadMem1_413540 = load %struct.Memory*, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem1_413540, %struct.Memory** %MEMORY
  %loadMem2_413540 = load %struct.Memory*, %struct.Memory** %MEMORY
  %loadPC_413540 = load i64, i64* %3
  %call2_413540 = call %struct.Memory* @sub_413070._Z15tolerance_equalIaEbRT_S1_(%struct.State* %0, i64 %loadPC_413540, %struct.Memory* %loadMem2_413540)
  store %struct.Memory* %call2_413540, %struct.Memory** %MEMORY
  ...
  %loadMem_413547 = load %struct.Memory*, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_413547, %struct.Memory** %MEMORY
  %loadBr_413547 = load i8, i8* %BRANCH_TAKEN
  %cmpBr_413547 = icmp eq i8 %loadBr_413547, 1
  br i1 %cmpBr_413547, label %block_.L_413568, label %block_41354d

block_41354d:                                     ; preds = %entry
  %loadMem_41354d = load %struct.Memory*, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_41354d, %struct.Memory** %MEMORY
  ...
  %loadMem1_413560 = load %struct.Memory*, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem1_413560, %struct.Memory** %MEMORY
  %loadMem2_413560 = load %struct.Memory*, %struct.Memory** %MEMORY
  %loadPC_413560 = load i64, i64* %3
  %643 = call %struct.Memory* @__remill_function_call(%struct.State* %0, i64 ptrtoint (i64 (i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64)* @printf to i64), %struct.Memory* %loadMem2_413560)
  store %struct.Memory* %643, %struct.Memory** %MEMORY
  %loadMem_413565 = load %struct.Memory*, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_413565, %struct.Memory** %MEMORY
  br label %block_.L_413568

block_.L_413568:                                  ; preds = %block_41354d, %entry
  %loadMem_413568 = load %struct.Memory*, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_413568, %struct.Memory** %MEMORY
  %loadMem_41356c = load %struct.Memory*, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_41356c, %struct.Memory** %MEMORY
  ...
  ret %struct.Memory* %loadMem_41356e
}
...
define %struct.Memory* @routine_movsd_0x206b86__rip____xmm0(%struct.State* dereferenceable(3376), i64, %struct.Memory*) {
block_400478:
  %3 = getelementptr inbounds %struct.State, %struct.State* %0, i32 0, i32 6
  %4 = getelementptr inbounds %struct.GPR, %struct.GPR* %3, i32 0, i32 33
  %5 = getelementptr inbounds %struct.Reg, %struct.Reg* %4, i32 0, i32 0
  ...
  %9 = load i64, i64* %PC
  %10 = ptrtoint %G_0x206b86__rip__4273410__type* @G_0x206b86__rip__4273410_ to i64
  %11 = load i64, i64* %PC
  %12 = add i64 %11, 8
  store i64 %12, i64* %PC
...
define %struct.Memory* @routine_callq_._ZN30custom_mixed_multiple_variableIaE8do_shiftEaaaaa(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) {
block_400478:
  %3 = getelementptr inbounds %struct.State, %struct.State* %0, i32 0, i32 6
  %4 = getelementptr inbounds %struct.GPR, %struct.GPR* %3, i32 0, i32 33
  %5 = getelementptr inbounds %struct.Reg, %struct.Reg* %4, i32 0, i32 0
...
define %struct.Memory* @routine_jne_.L_413568(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i8* %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) {
block_400478:
  %3 = getelementptr inbounds %struct.State, %struct.State* %0, i32 0, i32 6
  %4 = getelementptr inbounds %struct.GPR, %struct.GPR* %3, i32 0, i32 33
  %5 = getelementptr inbounds %struct.Reg, %struct.Reg* %4, i32 0, i32 0
