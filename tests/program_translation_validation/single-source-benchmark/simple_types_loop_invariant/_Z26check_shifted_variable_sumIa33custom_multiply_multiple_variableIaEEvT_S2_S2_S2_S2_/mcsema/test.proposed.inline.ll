...
@G_0x206716__rip__4274546_ = global %G_0x206716__rip__4274546__type zeroinitializer
...
define %struct.Memory* @_Z26check_shifted_variable_sumIa33custom_multiply_multiple_variableIaEEvT_S2_S2_S2_S2_(%struct.State* noalias, i64, %struct.Memory* noalias) #2 {
entry:
  ...
  %loadMem_413940 = load %struct.Memory*, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_413940, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_413944, %struct.Memory** %MEMORY
  %loadMem_413945 = load %struct.Memory*, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_413945, %struct.Memory** %MEMORY
  ...
  %loadMem_41394c = load %struct.Memory*, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_41394c, %struct.Memory** %MEMORY
  ...
  %loadMem_413952 = load %struct.Memory*, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_413952, %struct.Memory** %MEMORY
  ...
  store i8 %167, i8* %171
  store %struct.Memory* %loadMem_413958, %struct.Memory** %MEMORY
  %loadMem_41395b = load %struct.Memory*, %struct.Memory** %MEMORY
  ...
  store i8 %184, i8* %188
  store %struct.Memory* %loadMem_41395b, %struct.Memory** %MEMORY
  ...
  store i8 %201, i8* %205
  store %struct.Memory* %loadMem_41395f, %struct.Memory** %MEMORY
  ...
  store i8 %235, i8* %239
  store %struct.Memory* %loadMem_413967, %struct.Memory** %MEMORY
  ...
  %249 = load double, double* bitcast (%G_0x206716__rip__4274546__type* @G_0x206716__rip__4274546_ to double*)
  ...
  %loadMem_413972 = load %struct.Memory*, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_413972, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_413976, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_413978, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_413980, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_413984, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_413987, %struct.Memory** %MEMORY
  ...
  %loadMem_41398f = load %struct.Memory*, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_41398f, %struct.Memory** %MEMORY
  %loadMem_413993 = load %struct.Memory*, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_413993, %struct.Memory** %MEMORY
  %loadMem1_413998 = load %struct.Memory*, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem1_413998, %struct.Memory** %MEMORY
  %loadMem2_413998 = load %struct.Memory*, %struct.Memory** %MEMORY
  %loadPC_413998 = load i64, i64* %3
  %call2_413998 = call %struct.Memory* @sub_4138f0._ZN33custom_multiply_multiple_variableIaE8do_shiftEaaaaa(%struct.State* %0, i64 %loadPC_413998, %struct.Memory* %loadMem2_413998)
  store %struct.Memory* %call2_413998, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_41399d, %struct.Memory** %MEMORY
  ...
  %loadMem_4139ad = load %struct.Memory*, %struct.Memory** %MEMORY
  ...
  store i8 %541, i8* %545
  store %struct.Memory* %loadMem_4139ad, %struct.Memory** %MEMORY
  %loadMem1_4139b0 = load %struct.Memory*, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem1_4139b0, %struct.Memory** %MEMORY
  %loadMem2_4139b0 = load %struct.Memory*, %struct.Memory** %MEMORY
  %loadPC_4139b0 = load i64, i64* %3
  %call2_4139b0 = call %struct.Memory* @sub_413070._Z15tolerance_equalIaEbRT_S1_(%struct.State* %0, i64 %loadPC_4139b0, %struct.Memory* %loadMem2_4139b0)
  store %struct.Memory* %call2_4139b0, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_4139b7, %struct.Memory** %MEMORY
  %loadBr_4139b7 = load i8, i8* %BRANCH_TAKEN
  %cmpBr_4139b7 = icmp eq i8 %loadBr_4139b7, 1
  br i1 %cmpBr_4139b7, label %block_.L_4139d8, label %block_4139bd
...
block_4139bd:                                     ; preds = %entry
  ...
  %loadMem_4139ce = load %struct.Memory*, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_4139ce, %struct.Memory** %MEMORY
  %loadMem1_4139d0 = load %struct.Memory*, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem1_4139d0, %struct.Memory** %MEMORY
  %loadMem2_4139d0 = load %struct.Memory*, %struct.Memory** %MEMORY
  %loadPC_4139d0 = load i64, i64* %3
  %643 = call %struct.Memory* @__remill_function_call(%struct.State* %0, i64 ptrtoint (i64 (i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64)* @printf to i64), %struct.Memory* %loadMem2_4139d0)
...
block_.L_4139d8:                                  ; preds = %block_4139bd, %entry
  ...
  %loadMem_4139dd = load %struct.Memory*, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_4139dd, %struct.Memory** %MEMORY
  ...
  ret %struct.Memory* %loadMem_4139de
}
...
define %struct.Memory* @routine_movsd_0x206716__rip____xmm0(%struct.State* dereferenceable(3376), i64, %struct.Memory*) {
block_400478:
  %3 = getelementptr inbounds %struct.State, %struct.State* %0, i32 0, i32 6
  %4 = getelementptr inbounds %struct.GPR, %struct.GPR* %3, i32 0, i32 33
  %5 = getelementptr inbounds %struct.Reg, %struct.Reg* %4, i32 0, i32 0
  ...
  %9 = load i64, i64* %PC
  %10 = ptrtoint %G_0x206716__rip__4274546__type* @G_0x206716__rip__4274546_ to i64
  %11 = load i64, i64* %PC
  %12 = add i64 %11, 8
  store i64 %12, i64* %PC
...
define %struct.Memory* @routine_jne_.L_4139d8(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i8* %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) {
block_400478:
  %3 = getelementptr inbounds %struct.State, %struct.State* %0, i32 0, i32 6
  %4 = getelementptr inbounds %struct.GPR, %struct.GPR* %3, i32 0, i32 33
  %5 = getelementptr inbounds %struct.Reg, %struct.Reg* %4, i32 0, i32 0
