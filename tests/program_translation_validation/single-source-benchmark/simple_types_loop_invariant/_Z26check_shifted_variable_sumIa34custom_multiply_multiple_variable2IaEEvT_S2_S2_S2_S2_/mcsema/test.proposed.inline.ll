...
block_4138fd:                                     ; preds = %entry
  ...
  %call2_413910 = call %struct.Memory* @sub_4006c0.printf_plt(%struct.State* %0, i64 %loadPC_413910, %struct.Memory* %loadMem2_413910)
  store %struct.Memory* %call2_413910, %struct.Memory** %MEMORY
