...
define %struct.Memory* @_Z26check_shifted_variable_sumId19custom_add_variableIdEEvT_S2_(%struct.State* noalias, i64, %struct.Memory* noalias readnone) local_unnamed_addr #1 {
entry:
...
block_40c77b:                                     ; preds = %entry
  ...
  %call2_40c78e = tail call %struct.Memory* @sub_4006c0.printf_plt(%struct.State* nonnull %0, i64 %102, %struct.Memory* %call2_40c76e)
...
block_.L_40c796:                                  ; preds = %block_40c77b, %entry
  %113 = phi i64 [ %99, %entry ], [ %.pre, %block_40c77b ]
  %MEMORY.0 = phi %struct.Memory* [ %call2_40c76e, %entry ], [ %call2_40c78e, %block_40c77b ]
