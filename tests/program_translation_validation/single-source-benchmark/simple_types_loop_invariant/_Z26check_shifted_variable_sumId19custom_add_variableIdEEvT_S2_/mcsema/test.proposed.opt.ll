...
declare %struct.Memory* @sub_40c7a0._ZN19custom_add_variableIdE8do_shiftEdd(%struct.State* noalias dereferenceable(3376), i64, %struct.Memory* noalias readnone returned) local_unnamed_addr
...
entry:
  ...
  %call2_40c750 = tail call %struct.Memory* @sub_40c7a0._ZN19custom_add_variableIdE8do_shiftEdd(%struct.State* %0, i64 %66, %struct.Memory* %2)
  ...
  %call2_40c76e = tail call %struct.Memory* @sub_40c010._Z15tolerance_equalIdEbRT_S1_(%struct.State* %0, i64 %84, %struct.Memory* %call2_40c750)
  ...
  br i1 %98, label %block_.L_40c796, label %block_40c77b

block_40c77b:                                     ; preds = %entry
  ...
  %107 = tail call %struct.Memory* @__remill_function_call(%struct.State* nonnull %0, i64 ptrtoint (i64 (i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64)* @printf to i64), %struct.Memory* %call2_40c76e)
...
block_.L_40c796:                                  ; preds = %block_40c77b, %entry
  %114 = phi i64 [ %99, %entry ], [ %.pre, %block_40c77b ]
  %MEMORY.0 = phi %struct.Memory* [ %call2_40c76e, %entry ], [ %107, %block_40c77b ]
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_jne_.L_40c796(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i8* nocapture %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
