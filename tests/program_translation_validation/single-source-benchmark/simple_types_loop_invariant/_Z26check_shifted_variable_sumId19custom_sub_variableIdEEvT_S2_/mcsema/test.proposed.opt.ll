...
define %struct.Memory* @_Z26check_shifted_variable_sumId19custom_sub_variableIdEEvT_S2_(%struct.State* noalias, i64, %struct.Memory* noalias readnone) local_unnamed_addr #1 {
entry:
...
block_40c63b:                                     ; preds = %entry
  ...
  %call2_40c64e = tail call %struct.Memory* @sub_4006c0.printf_plt(%struct.State* nonnull %0, i64 %102, %struct.Memory* %call2_40c62e)
...
block_.L_40c656:                                  ; preds = %block_40c63b, %entry
  %113 = phi i64 [ %99, %entry ], [ %.pre, %block_40c63b ]
  %MEMORY.0 = phi %struct.Memory* [ %call2_40c62e, %entry ], [ %call2_40c64e, %block_40c63b ]
