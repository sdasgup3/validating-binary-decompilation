...
@G_0x7853__rip__4244981_ = local_unnamed_addr global %G_0x7853__rip__4244981__type zeroinitializer
...
declare %struct.Memory* @sub_40c5a0._ZN19custom_sub_variableIdE8do_shiftEdd(%struct.State* noalias dereferenceable(3376), i64, %struct.Memory* noalias readnone returned) local_unnamed_addr
...
define %struct.Memory* @_Z26check_shifted_variable_sumId19custom_sub_variableIdEEvT_S2_(%struct.State* noalias, i64, %struct.Memory* noalias) local_unnamed_addr #1 {
entry:
  ...
  %call2_40c5e0 = tail call %struct.Memory* @sub_40c5a0._ZN19custom_sub_variableIdE8do_shiftEdd(%struct.State* %0, i64 %66, %struct.Memory* %2)
  ...
  %75 = load double, double* bitcast (%G_0x7853__rip__4244981__type* @G_0x7853__rip__4244981_ to double*), align 8
  ...
  %call2_40c5fe = tail call %struct.Memory* @sub_40bfe0._Z15tolerance_equalIdEbRT_S1_(%struct.State* %0, i64 %81, %struct.Memory* %call2_40c5e0)
  ...
  br i1 %95, label %block_.L_40c626, label %block_40c60b
...
block_40c60b:                                     ; preds = %entry
  ...
  %104 = tail call %struct.Memory* @__remill_function_call(%struct.State* %0, i64 ptrtoint (i64 (i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64)* @printf to i64), %struct.Memory* %call2_40c5fe)
...
block_.L_40c626:                                  ; preds = %block_40c60b, %entry
  %111 = phi i64 [ %96, %entry ], [ %.pre, %block_40c60b ]
  %MEMORY.0 = phi %struct.Memory* [ %call2_40c5fe, %entry ], [ %104, %block_40c60b ]
...
define %struct.Memory* @routine_callq_._ZN19custom_sub_variableIdE8do_shiftEdd(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
...
define %struct.Memory* @routine_movsd_0x7853__rip____xmm1(%struct.State* dereferenceable(3376), i64, %struct.Memory*) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, 8
  store i64 %4, i64* %PC, align 8
  %5 = load i64, i64* bitcast (%G_0x7853__rip__4244981__type* @G_0x7853__rip__4244981_ to i64*), align 8
...
define %struct.Memory* @routine_jne_.L_40c626(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i8* %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
