...
@G_0x7be3__rip__4244069_ = global %G_0x7be3__rip__4244069__type zeroinitializer
...
entry:
  ...
  store %struct.Memory* %loadMem_40c230, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_40c24b, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem1_40c250, %struct.Memory** %MEMORY
  ...
  %178 = load double, double* bitcast (%G_0x7be3__rip__4244069__type* @G_0x7be3__rip__4244069_ to double*)
...
block_40c27b:                                     ; preds = %entry
  ...
  store %struct.Memory* %loadMem_40c285, %struct.Memory** %MEMORY
  ...
  %318 = call %struct.Memory* @__remill_function_call(%struct.State* %0, i64 ptrtoint (i64 (i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64)* @printf to i64), %struct.Memory* %loadMem2_40c28e)
...
block_.L_40c296:                                  ; preds = %block_40c27b, %entry
  ...
  ret %struct.Memory* %loadMem_40c29b
}
...
define %struct.Memory* @routine_movsd_0x7be3__rip____xmm1(%struct.State* dereferenceable(3376), i64, %struct.Memory*) {
block_400478:
  %3 = getelementptr inbounds %struct.State, %struct.State* %0, i32 0, i32 6
  %4 = getelementptr inbounds %struct.GPR, %struct.GPR* %3, i32 0, i32 33
  %5 = getelementptr inbounds %struct.Reg, %struct.Reg* %4, i32 0, i32 0
