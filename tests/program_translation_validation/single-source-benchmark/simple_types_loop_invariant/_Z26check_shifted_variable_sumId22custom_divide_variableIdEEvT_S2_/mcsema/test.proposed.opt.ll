...
@G_0x7be3__rip__4244069_ = local_unnamed_addr global %G_0x7be3__rip__4244069__type zeroinitializer
...
entry:
  ...
  %call2_40c250 = tail call %struct.Memory* @sub_40c210._ZN22custom_divide_variableIdE8do_shiftEdd(%struct.State* %0, i64 %66, %struct.Memory* %2)
  ...
  %74 = add i64 %71, -24
  store i64 %74, i64* %RSI.i24, align 8
  %75 = load double, double* bitcast (%G_0x7be3__rip__4244069__type* @G_0x7be3__rip__4244069_ to double*), align 8
  %76 = load double, double* %42, align 1
  %77 = fmul double %75, %76
  store double %77, double* %63, align 1
  store i64 0, i64* %64, align 1
  %78 = add i64 %73, 25
  store i64 %78, i64* %3, align 8
  %79 = inttoptr i64 %74 to double*
  ...
  %call2_40c26e = tail call %struct.Memory* @sub_40bfe0._Z15tolerance_equalIdEbRT_S1_(%struct.State* %0, i64 %81, %struct.Memory* %call2_40c250)
  %86 = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 1, i32 0
  %AL.i16 = bitcast %union.anon* %86 to i8*
  ...
  br i1 %95, label %block_.L_40c296, label %block_40c27b

block_40c27b:                                     ; preds = %entry
  store i64 ptrtoint (%G__0x414aee_type* @G__0x414aee to i64), i64* %RDI.i27, align 8
  %97 = load i32, i32* bitcast (%G_0x61a0a8_type* @G_0x61a0a8 to i32*), align 8
  ...
  %104 = tail call %struct.Memory* @__remill_function_call(%struct.State* %0, i64 ptrtoint (i64 (i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64)* @printf to i64), %struct.Memory* %call2_40c26e)
  %EAX.i = bitcast %union.anon* %86 to i32*
...
block_.L_40c296:                                  ; preds = %block_40c27b, %entry
  %111 = phi i64 [ %96, %entry ], [ %.pre, %block_40c27b ]
  %MEMORY.0 = phi %struct.Memory* [ %call2_40c26e, %entry ], [ %104, %block_40c27b ]
  %112 = load i64, i64* %6, align 8
  %113 = add i64 %112, 32
  store i64 %113, i64* %6, align 8
  %114 = icmp ugt i64 %112, -33
...
block_400478:
  ...
  %4 = add i64 %3, 8
  store i64 %4, i64* %PC, align 8
  %5 = load i64, i64* bitcast (%G_0x7be3__rip__4244069__type* @G_0x7be3__rip__4244069_ to i64*), align 8
