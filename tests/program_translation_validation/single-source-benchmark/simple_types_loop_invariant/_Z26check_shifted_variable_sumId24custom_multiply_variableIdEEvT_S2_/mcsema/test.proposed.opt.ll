...
entry:
  ...
  %call2_40c4c0 = tail call %struct.Memory* @sub_40c480._ZN24custom_multiply_variableIdE8do_shiftEdd(%struct.State* %0, i64 %66, %struct.Memory* %2)
  ...
  %75 = add i64 %73, add (i64 ptrtoint (%G_0x79b3__rip__type* @G_0x79b3__rip_ to i64), i64 8)
  %76 = add i64 %73, 16
  ...
  %call2_40c4de = tail call %struct.Memory* @sub_40c020._Z15tolerance_equalIdEbRT_S1_(%struct.State* %0, i64 %84, %struct.Memory* %call2_40c4c0)
  ...
  br i1 %98, label %block_.L_40c506, label %block_40c4eb
...
block_40c4eb:                                     ; preds = %entry
  ...
  %107 = tail call %struct.Memory* @__remill_function_call(%struct.State* nonnull %0, i64 ptrtoint (i64 (i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64)* @printf to i64), %struct.Memory* %call2_40c4de)
...
block_.L_40c506:                                  ; preds = %block_40c4eb, %entry
  %114 = phi i64 [ %99, %entry ], [ %.pre, %block_40c4eb ]
  %MEMORY.0 = phi %struct.Memory* [ %call2_40c4de, %entry ], [ %107, %block_40c4eb ]
