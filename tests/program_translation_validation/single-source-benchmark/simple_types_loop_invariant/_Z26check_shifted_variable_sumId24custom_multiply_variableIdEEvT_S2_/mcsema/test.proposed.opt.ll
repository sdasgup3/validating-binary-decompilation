...
@G_0x79b3__rip_ = local_unnamed_addr global %G_0x79b3__rip__type zeroinitializer
...
entry:
  ...
  %call2_40c480 = tail call %struct.Memory* @sub_40c440._ZN24custom_multiply_variableIdE8do_shiftEdd(%struct.State* %0, i64 %68, %struct.Memory* %2)
  ...
  %77 = load double, double* bitcast (%G_0x79b3__rip__type* @G_0x79b3__rip_ to double*), align 8
  ...
  %call2_40c49e = tail call %struct.Memory* @sub_40bfe0._Z15tolerance_equalIdEbRT_S1_(%struct.State* %0, i64 %83, %struct.Memory* %call2_40c480)
  ...
  br i1 %97, label %block_.L_40c4c6, label %block_40c4ab
...
block_40c4ab:                                     ; preds = %entry
  ...
  %106 = tail call %struct.Memory* @__remill_function_call(%struct.State* %0, i64 ptrtoint (i64 (i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64)* @printf to i64), %struct.Memory* %call2_40c49e)
...
block_.L_40c4c6:                                  ; preds = %block_40c4ab, %entry
  %113 = phi i64 [ %98, %entry ], [ %.pre, %block_40c4ab ]
  %MEMORY.0 = phi %struct.Memory* [ %call2_40c49e, %entry ], [ %106, %block_40c4ab ]
...
block_400478:
  ...
  %4 = add i64 %3, 8
  store i64 %4, i64* %PC, align 8
  %5 = load i64, i64* bitcast (%G_0x79b3__rip__type* @G_0x79b3__rip_ to i64*), align 8
