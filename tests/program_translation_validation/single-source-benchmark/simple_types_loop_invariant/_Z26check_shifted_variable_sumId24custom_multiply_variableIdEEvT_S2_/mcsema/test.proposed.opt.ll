...
block_40c4db:                                     ; preds = %entry
  ...
  %107 = tail call %struct.Memory* @__remill_function_call(%struct.State* nonnull %0, i64 ptrtoint (i64 (i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64)* @printf to i64), %struct.Memory* %call2_40c4ce)
...
block_.L_40c4f6:                                  ; preds = %block_40c4db, %entry
  %114 = phi i64 [ %99, %entry ], [ %.pre, %block_40c4db ]
  %MEMORY.0 = phi %struct.Memory* [ %call2_40c4ce, %entry ], [ %107, %block_40c4db ]
