...
define %struct.Memory* @_Z26check_shifted_variable_sumId24custom_multiply_variableIdEEvT_S2_(%struct.State* noalias, i64, %struct.Memory* noalias readnone) local_unnamed_addr #1 {
entry:
  ...
  %call2_40c4b0 = tail call %struct.Memory* @sub_40c470._ZN24custom_multiply_variableIdE8do_shiftEdd(%struct.State* %0, i64 %66, %struct.Memory* %2)
  ...
  %call2_40c4ce = tail call %struct.Memory* @sub_40c010._Z15tolerance_equalIdEbRT_S1_(%struct.State* %0, i64 %84, %struct.Memory* %call2_40c4b0)
  ...
  br i1 %98, label %block_.L_40c4f6, label %block_40c4db
...
block_40c4db:                                     ; preds = %entry
  ...
  %call2_40c4ee = tail call %struct.Memory* @sub_4006c0.printf_plt(%struct.State* nonnull %0, i64 %102, %struct.Memory* %call2_40c4ce)
...
block_.L_40c4f6:                                  ; preds = %block_40c4db, %entry
  %113 = phi i64 [ %99, %entry ], [ %.pre, %block_40c4db ]
  %MEMORY.0 = phi %struct.Memory* [ %call2_40c4ce, %entry ], [ %call2_40c4ee, %block_40c4db ]
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_jne_.L_40c4f6(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i8* nocapture %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
