...
entry:
  ...
  %loadMem1_40c6de = load %struct.Memory*, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem1_40c6de, %struct.Memory** %MEMORY
  %loadMem2_40c6de = load %struct.Memory*, %struct.Memory** %MEMORY
  %loadPC_40c6de = load i64, i64* %3
  %call2_40c6de = call %struct.Memory* @sub_40c660._ZN28custom_add_multiple_variableIdE8do_shiftEddddd(%struct.State* %0, i64 %loadPC_40c6de, %struct.Memory* %loadMem2_40c6de)
  store %struct.Memory* %call2_40c6de, %struct.Memory** %MEMORY
  ...
  %loadMem1_40c6fc = load %struct.Memory*, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem1_40c6fc, %struct.Memory** %MEMORY
  %loadMem2_40c6fc = load %struct.Memory*, %struct.Memory** %MEMORY
  %loadPC_40c6fc = load i64, i64* %3
  %call2_40c6fc = call %struct.Memory* @sub_40c010._Z15tolerance_equalIdEbRT_S1_(%struct.State* %0, i64 %loadPC_40c6fc, %struct.Memory* %loadMem2_40c6fc)
  store %struct.Memory* %call2_40c6fc, %struct.Memory** %MEMORY
  ...
  %loadBr_40c703 = load i8, i8* %BRANCH_TAKEN
  %cmpBr_40c703 = icmp eq i8 %loadBr_40c703, 1
  br i1 %cmpBr_40c703, label %block_.L_40c724, label %block_40c709

block_40c709:                                     ; preds = %entry
  %loadMem_40c709 = load %struct.Memory*, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_40c709, %struct.Memory** %MEMORY
  ...
  %loadMem1_40c71c = load %struct.Memory*, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem1_40c71c, %struct.Memory** %MEMORY
  %loadMem2_40c71c = load %struct.Memory*, %struct.Memory** %MEMORY
  %loadPC_40c71c = load i64, i64* %3
  %422 = call %struct.Memory* @__remill_function_call(%struct.State* %0, i64 ptrtoint (i64 (i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64)* @printf to i64), %struct.Memory* %loadMem2_40c71c)
  ...
  br label %block_.L_40c724

block_.L_40c724:                                  ; preds = %block_40c709, %entry
  ...
  store %struct.Memory* %loadMem_40c729, %struct.Memory** %MEMORY
  ret %struct.Memory* %loadMem_40c729
}
...
define %struct.Memory* @routine_jne_.L_40c724(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i8* %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) {
block_400488:
  %3 = getelementptr inbounds %struct.State, %struct.State* %0, i32 0, i32 6
  %4 = getelementptr inbounds %struct.GPR, %struct.GPR* %3, i32 0, i32 33
  %5 = getelementptr inbounds %struct.Reg, %struct.Reg* %4, i32 0, i32 0
