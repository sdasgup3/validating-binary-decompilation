...
define %struct.Memory* @_Z26check_shifted_variable_sumId28custom_add_multiple_variableIdEEvT_S2_S2_S2_S2_(%struct.State* noalias, i64, %struct.Memory* noalias) #1 {
entry:
...
block_40c709:                                     ; preds = %entry
  ...
  %call2_40c71c = call %struct.Memory* @sub_4006c0.printf_plt(%struct.State* %0, i64 %loadPC_40c71c, %struct.Memory* %loadMem2_40c71c)
  store %struct.Memory* %call2_40c71c, %struct.Memory** %MEMORY
