...
define %struct.Memory* @_Z26check_shifted_variable_sumId28custom_add_multiple_variableIdEEvT_S2_S2_S2_S2_(%struct.State* noalias, i64, %struct.Memory* noalias readnone) local_unnamed_addr #1 {
entry:
  ...
  %call2_40c6de = tail call %struct.Memory* @sub_40c660._ZN28custom_add_multiple_variableIdE8do_shiftEddddd(%struct.State* %0, i64 %105, %struct.Memory* %2)
  ...
  %call2_40c6fc = tail call %struct.Memory* @sub_40c010._Z15tolerance_equalIdEbRT_S1_(%struct.State* %0, i64 %123, %struct.Memory* %call2_40c6de)
  ...
  br i1 %137, label %block_.L_40c724, label %block_40c709
...
block_40c709:                                     ; preds = %entry
  ...
  %call2_40c71c = tail call %struct.Memory* @sub_4006c0.printf_plt(%struct.State* nonnull %0, i64 %141, %struct.Memory* %call2_40c6fc)
...
block_.L_40c724:                                  ; preds = %block_40c709, %entry
  %152 = phi i64 [ %138, %entry ], [ %.pre, %block_40c709 ]
  %MEMORY.0 = phi %struct.Memory* [ %call2_40c6fc, %entry ], [ %call2_40c71c, %block_40c709 ]
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_jne_.L_40c724(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i8* nocapture %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
