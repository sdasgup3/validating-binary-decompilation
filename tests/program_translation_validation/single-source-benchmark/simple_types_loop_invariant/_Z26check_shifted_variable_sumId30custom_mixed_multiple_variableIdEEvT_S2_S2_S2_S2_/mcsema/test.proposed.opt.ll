...
@G_0x7ea5__rip_ = local_unnamed_addr global %G_0x7ea5__rip__type zeroinitializer
...
entry:
  ...
  %call2_40bf8e = tail call %struct.Memory* @sub_40bf10._ZN30custom_mixed_multiple_variableIdE8do_shiftEddddd(%struct.State* %0, i64 %113, %struct.Memory* %2)
  ...
  %122 = load double, double* bitcast (%G_0x7ea5__rip__type* @G_0x7ea5__rip_ to double*), align 8
  ...
  %call2_40bfac = tail call %struct.Memory* @sub_40bfe0._Z15tolerance_equalIdEbRT_S1_(%struct.State* %0, i64 %128, %struct.Memory* %call2_40bf8e)
  ...
  br i1 %142, label %block_.L_40bfd4, label %block_40bfb9
...
block_40bfb9:                                     ; preds = %entry
  ...
  %151 = tail call %struct.Memory* @__remill_function_call(%struct.State* %0, i64 ptrtoint (i64 (i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64)* @printf to i64), %struct.Memory* %call2_40bfac)
...
block_.L_40bfd4:                                  ; preds = %block_40bfb9, %entry
  %158 = phi i64 [ %143, %entry ], [ %.pre, %block_40bfb9 ]
  %MEMORY.0 = phi %struct.Memory* [ %call2_40bfac, %entry ], [ %151, %block_40bfb9 ]
...
block_400478:
  ...
  %4 = add i64 %3, 8
  store i64 %4, i64* %PC, align 8
  %5 = load i64, i64* bitcast (%G_0x7ea5__rip__type* @G_0x7ea5__rip_ to i64*), align 8
