...
entry:
  ...
  %call2_40bfbe = tail call %struct.Memory* @sub_40bf40._ZN30custom_mixed_multiple_variableIdE8do_shiftEddddd(%struct.State* %0, i64 %105, %struct.Memory* %2)
  ...
  %call2_40bfdc = tail call %struct.Memory* @sub_40c010._Z15tolerance_equalIdEbRT_S1_(%struct.State* %0, i64 %123, %struct.Memory* %call2_40bfbe)
  ...
  br i1 %137, label %block_.L_40c004, label %block_40bfe9
...
block_40bfe9:                                     ; preds = %entry
  ...
  %146 = tail call %struct.Memory* @__remill_function_call(%struct.State* nonnull %0, i64 ptrtoint (i64 (i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64)* @printf to i64), %struct.Memory* %call2_40bfdc)
...
block_.L_40c004:                                  ; preds = %block_40bfe9, %entry
  %153 = phi i64 [ %138, %entry ], [ %.pre, %block_40bfe9 ]
  %MEMORY.0 = phi %struct.Memory* [ %call2_40bfdc, %entry ], [ %146, %block_40bfe9 ]
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_jne_.L_40c004(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i8* nocapture %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
