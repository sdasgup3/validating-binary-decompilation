...
define %struct.Memory* @_Z26check_shifted_variable_sumId30custom_mixed_multiple_variableIdEEvT_S2_S2_S2_S2_(%struct.State* noalias, i64, %struct.Memory* noalias readnone) local_unnamed_addr #1 {
entry:
...
block_40bfe9:                                     ; preds = %entry
  ...
  %call2_40bffc = tail call %struct.Memory* @sub_4006c0.printf_plt(%struct.State* nonnull %0, i64 %141, %struct.Memory* %call2_40bfdc)
...
block_.L_40c004:                                  ; preds = %block_40bfe9, %entry
  %152 = phi i64 [ %138, %entry ], [ %.pre, %block_40bfe9 ]
  %MEMORY.0 = phi %struct.Memory* [ %call2_40bfdc, %entry ], [ %call2_40bffc, %block_40bfe9 ]
