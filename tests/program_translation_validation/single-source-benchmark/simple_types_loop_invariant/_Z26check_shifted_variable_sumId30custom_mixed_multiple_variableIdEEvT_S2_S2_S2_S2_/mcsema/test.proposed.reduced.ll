; ModuleID = '/tmp/tmpx9sxkum6-query.ll'
...
entry:
  ...
  %call2_40bfce = tail call %struct.Memory* @sub_40bf50._ZN30custom_mixed_multiple_variableIdE8do_shiftEddddd(%struct.State* %0, i64 %var_2_105, %struct.Memory* %2)
  %var_2_110 = load i64, i64* %RBP.i, align 8
  %var_2_112 = load i64, i64* %var_2_3, align 8
  %var_2_113 = add i64 %var_2_110, -48
  %var_2_114 = add i64 %var_2_112, add (i64 ptrtoint (%G_0x7ea5__rip__type* @G_0x7ea5__rip_ to i64), i64 8)
  ...
  %var_2_123 = add i64 %var_2_122, 52
  %call2_40bfec = tail call %struct.Memory* @sub_40c020._Z15tolerance_equalIdEbRT_S1_(%struct.State* %0, i64 %var_2_123, %struct.Memory* %call2_40bfce)
  ...
  br i1 %var_2_137, label %block_40bff9, label %block_.L_40c014

block_40bff9:                                     ; preds = %entry
  %var_2_146 = tail call %struct.Memory* @__remill_function_call(%struct.State* nonnull %0, i64 ptrtoint (i64 (i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64)* @printf to i64), %struct.Memory* %call2_40bfec)
  br label %block_.L_40c014

block_.L_40c014:                                  ; preds = %block_40bff9, %entry
  %MEMORY.0 = phi %struct.Memory* [ %call2_40bfec, %entry ], [ %var_2_146, %block_40bff9 ]
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_movsd_0x7ea5__rip____xmm1(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, ptrtoint (%G_0x7ea5__rip__type* @G_0x7ea5__rip_ to i64)
  %5 = add i64 %3, 8
  store i64 %5, i64* %PC, align 8
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_jne_.L_40c014(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i8* nocapture %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
