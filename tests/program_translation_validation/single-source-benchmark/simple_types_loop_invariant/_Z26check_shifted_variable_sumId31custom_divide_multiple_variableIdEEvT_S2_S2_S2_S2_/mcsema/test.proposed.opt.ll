...
declare %struct.Memory* @sub_40c170._ZN31custom_divide_multiple_variableIdE8do_shiftEddddd(%struct.State* noalias dereferenceable(3376), i64, %struct.Memory* noalias readnone returned) local_unnamed_addr
...
entry:
  ...
  %call2_40c1ee = tail call %struct.Memory* @sub_40c170._ZN31custom_divide_multiple_variableIdE8do_shiftEddddd(%struct.State* %0, i64 %105, %struct.Memory* %2)
  ...
  %call2_40c20c = tail call %struct.Memory* @sub_40c010._Z15tolerance_equalIdEbRT_S1_(%struct.State* %0, i64 %123, %struct.Memory* %call2_40c1ee)
  ...
  br i1 %137, label %block_.L_40c234, label %block_40c219

block_40c219:                                     ; preds = %entry
  ...
  %146 = tail call %struct.Memory* @__remill_function_call(%struct.State* nonnull %0, i64 ptrtoint (i64 (i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64)* @printf to i64), %struct.Memory* %call2_40c20c)
...
block_.L_40c234:                                  ; preds = %block_40c219, %entry
  %153 = phi i64 [ %138, %entry ], [ %.pre, %block_40c219 ]
  %MEMORY.0 = phi %struct.Memory* [ %call2_40c20c, %entry ], [ %146, %block_40c219 ]
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_jne_.L_40c234(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i8* nocapture %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
