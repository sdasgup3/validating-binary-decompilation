...
entry:
  ...
  %call2_40c1fe = tail call %struct.Memory* @sub_40c180._ZN31custom_divide_multiple_variableIdE8do_shiftEddddd(%struct.State* %0, i64 %105, %struct.Memory* %2)
  ...
  %114 = add i64 %112, add (i64 ptrtoint (%G_0x7c75__rip__type* @G_0x7c75__rip_ to i64), i64 8)
  %115 = add i64 %112, 16
  ...
  %call2_40c21c = tail call %struct.Memory* @sub_40c020._Z15tolerance_equalIdEbRT_S1_(%struct.State* %0, i64 %123, %struct.Memory* %call2_40c1fe)
  ...
  br i1 %137, label %block_.L_40c244, label %block_40c229
...
block_40c229:                                     ; preds = %entry
  ...
  %146 = tail call %struct.Memory* @__remill_function_call(%struct.State* nonnull %0, i64 ptrtoint (i64 (i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64)* @printf to i64), %struct.Memory* %call2_40c21c)
...
block_.L_40c244:                                  ; preds = %block_40c229, %entry
  %153 = phi i64 [ %138, %entry ], [ %.pre, %block_40c229 ]
  %MEMORY.0 = phi %struct.Memory* [ %call2_40c21c, %entry ], [ %146, %block_40c229 ]
