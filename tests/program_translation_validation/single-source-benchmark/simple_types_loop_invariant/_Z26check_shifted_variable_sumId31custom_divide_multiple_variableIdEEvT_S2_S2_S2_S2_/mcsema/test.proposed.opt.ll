...
define %struct.Memory* @_Z26check_shifted_variable_sumId31custom_divide_multiple_variableIdEEvT_S2_S2_S2_S2_(%struct.State* noalias, i64, %struct.Memory* noalias readnone) local_unnamed_addr #1 {
entry:
...
block_40c219:                                     ; preds = %entry
  ...
  %call2_40c22c = tail call %struct.Memory* @sub_4006c0.printf_plt(%struct.State* nonnull %0, i64 %141, %struct.Memory* %call2_40c20c)
...
block_.L_40c234:                                  ; preds = %block_40c219, %entry
  %152 = phi i64 [ %138, %entry ], [ %.pre, %block_40c219 ]
  %MEMORY.0 = phi %struct.Memory* [ %call2_40c20c, %entry ], [ %call2_40c22c, %block_40c219 ]
