...
block_40c149:                                     ; preds = %entry
  ...
  %146 = tail call %struct.Memory* @__remill_function_call(%struct.State* nonnull %0, i64 ptrtoint (i64 (i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64)* @printf to i64), %struct.Memory* %call2_40c13c)
...
block_.L_40c164:                                  ; preds = %block_40c149, %entry
  %153 = phi i64 [ %138, %entry ], [ %.pre, %block_40c149 ]
  %MEMORY.0 = phi %struct.Memory* [ %call2_40c13c, %entry ], [ %146, %block_40c149 ]
