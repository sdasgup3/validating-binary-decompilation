...
define %struct.Memory* @_Z26check_shifted_variable_sumId32custom_divide_multiple_variable2IdEEvT_S2_S2_S2_S2_(%struct.State* noalias, i64, %struct.Memory* noalias readnone) local_unnamed_addr #1 {
entry:
  ...
  %call2_40c11e = tail call %struct.Memory* @sub_40c0a0._ZN32custom_divide_multiple_variable2IdE8do_shiftEddddd(%struct.State* %0, i64 %105, %struct.Memory* %2)
  ...
  %call2_40c13c = tail call %struct.Memory* @sub_40c010._Z15tolerance_equalIdEbRT_S1_(%struct.State* %0, i64 %123, %struct.Memory* %call2_40c11e)
  ...
  br i1 %137, label %block_.L_40c164, label %block_40c149
...
block_40c149:                                     ; preds = %entry
  ...
  %call2_40c15c = tail call %struct.Memory* @sub_4006c0.printf_plt(%struct.State* nonnull %0, i64 %141, %struct.Memory* %call2_40c13c)
...
block_.L_40c164:                                  ; preds = %block_40c149, %entry
  %152 = phi i64 [ %138, %entry ], [ %.pre, %block_40c149 ]
  %MEMORY.0 = phi %struct.Memory* [ %call2_40c13c, %entry ], [ %call2_40c15c, %block_40c149 ]
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_jne_.L_40c164(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i8* nocapture %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
