; ModuleID = '/tmp/tmphfugd2ce-query.ll'
...
declare %struct.Memory* @sub_40c0b0._ZN32custom_divide_multiple_variable2IdE8do_shiftEddddd(%struct.State* noalias dereferenceable(3376), i64, %struct.Memory* noalias readnone returned) local_unnamed_addr
...
define %struct.Memory* @_Z26check_shifted_variable_sumId32custom_divide_multiple_variable2IdEEvT_S2_S2_S2_S2_(%struct.State* noalias, i64, %struct.Memory* noalias) local_unnamed_addr #1 {
entry:
  ...
  %call2_40c12e = tail call %struct.Memory* @sub_40c0b0._ZN32custom_divide_multiple_variable2IdE8do_shiftEddddd(%struct.State* %0, i64 %var_2_105, %struct.Memory* %2)
  %var_2_110 = load i64, i64* %RBP.i, align 8
  %var_2_112 = load i64, i64* %var_2_3, align 8
  %var_2_113 = add i64 %var_2_110, -48
  %var_2_114 = add i64 %var_2_112, add (i64 ptrtoint (%G_0x7d45__rip__type* @G_0x7d45__rip_ to i64), i64 8)
  ...
  %var_2_123 = add i64 %var_2_122, -300
  %call2_40c14c = tail call %struct.Memory* @sub_40c020._Z15tolerance_equalIdEbRT_S1_(%struct.State* %0, i64 %var_2_123, %struct.Memory* %call2_40c12e)
  ...
  br i1 %var_2_137, label %block_40c159, label %block_.L_40c174

block_40c159:                                     ; preds = %entry
  %var_2_146 = tail call %struct.Memory* @__remill_function_call(%struct.State* nonnull %0, i64 ptrtoint (i64 (i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64)* @printf to i64), %struct.Memory* %call2_40c14c)
  br label %block_.L_40c174

block_.L_40c174:                                  ; preds = %block_40c159, %entry
  %MEMORY.0 = phi %struct.Memory* [ %call2_40c14c, %entry ], [ %var_2_146, %block_40c159 ]
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_callq_._ZN32custom_divide_multiple_variable2IdE8do_shiftEddddd(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_movsd_0x7d45__rip____xmm1(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, ptrtoint (%G_0x7d45__rip__type* @G_0x7d45__rip_ to i64)
  %5 = add i64 %3, 8
  store i64 %5, i64* %PC, align 8
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_jne_.L_40c174(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i8* nocapture %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
