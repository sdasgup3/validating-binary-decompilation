...
@G_0x7a45__rip__4244483_ = local_unnamed_addr global %G_0x7a45__rip__4244483__type zeroinitializer
...
entry:
  ...
  %call2_40c3ee = tail call %struct.Memory* @sub_40c370._ZN33custom_multiply_multiple_variableIdE8do_shiftEddddd(%struct.State* %0, i64 %108, %struct.Memory* %2)
  ...
  %117 = load double, double* bitcast (%G_0x7a45__rip__4244483__type* @G_0x7a45__rip__4244483_ to double*), align 8
  ...
  %call2_40c40c = tail call %struct.Memory* @sub_40bfe0._Z15tolerance_equalIdEbRT_S1_(%struct.State* %0, i64 %123, %struct.Memory* %call2_40c3ee)
  ...
  br i1 %137, label %block_.L_40c434, label %block_40c419

block_40c419:                                     ; preds = %entry
  ...
  %146 = tail call %struct.Memory* @__remill_function_call(%struct.State* %0, i64 ptrtoint (i64 (i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64)* @printf to i64), %struct.Memory* %call2_40c40c)
...
block_.L_40c434:                                  ; preds = %block_40c419, %entry
  %153 = phi i64 [ %138, %entry ], [ %.pre, %block_40c419 ]
  %MEMORY.0 = phi %struct.Memory* [ %call2_40c40c, %entry ], [ %146, %block_40c419 ]
...
define %struct.Memory* @routine_movsd_0x7a45__rip____xmm1(%struct.State* dereferenceable(3376), i64, %struct.Memory*) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, 8
  store i64 %4, i64* %PC, align 8
  %5 = load i64, i64* bitcast (%G_0x7a45__rip__4244483__type* @G_0x7a45__rip__4244483_ to i64*), align 8
...
define %struct.Memory* @routine_jne_.L_40c434(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i8* %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
