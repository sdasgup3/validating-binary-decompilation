...
@G_0x7b15__rip__4244275_ = global %G_0x7b15__rip__4244275__type zeroinitializer
...
entry:
  ...
  store %struct.Memory* %loadMem_40c319, %struct.Memory** %MEMORY
  ...
  %280 = load double, double* bitcast (%G_0x7b15__rip__4244275__type* @G_0x7b15__rip__4244275_ to double*)
  ...
  store %struct.Memory* %loadMem1_40c33c, %struct.Memory** %MEMORY
...
block_40c349:                                     ; preds = %entry
  ...
  store %struct.Memory* %loadMem1_40c35c, %struct.Memory** %MEMORY
  %loadMem2_40c35c = load %struct.Memory*, %struct.Memory** %MEMORY
  %loadPC_40c35c = load i64, i64* %3
  %420 = call %struct.Memory* @__remill_function_call(%struct.State* %0, i64 ptrtoint (i64 (i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64)* @printf to i64), %struct.Memory* %loadMem2_40c35c)
...
block_.L_40c364:                                  ; preds = %block_40c349, %entry
  ...
  ret %struct.Memory* %loadMem_40c369
}
