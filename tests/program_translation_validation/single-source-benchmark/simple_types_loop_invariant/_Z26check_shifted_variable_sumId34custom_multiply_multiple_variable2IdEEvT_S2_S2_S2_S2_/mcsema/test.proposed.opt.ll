...
declare %struct.Memory* @sub_40c2d0._ZN34custom_multiply_multiple_variable2IdE8do_shiftEddddd(%struct.State* dereferenceable(3376), i64, %struct.Memory*) local_unnamed_addr
