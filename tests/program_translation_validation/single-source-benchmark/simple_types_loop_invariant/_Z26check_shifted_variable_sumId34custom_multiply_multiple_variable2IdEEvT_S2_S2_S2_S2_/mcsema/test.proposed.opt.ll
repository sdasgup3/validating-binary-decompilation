...
%G_0x7b15__rip__4244275__type = type <{ [16 x i8] }>
...
@G_0x7b15__rip__4244275_ = local_unnamed_addr global %G_0x7b15__rip__4244275__type zeroinitializer
...
entry:
  ...
  %87 = bitcast %union.VectorReg* %46 to double*
  store i64 %86, i64* %51, align 1
  ...
  store i64 %99, i64* %67, align 1
  %100 = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 1, i64 3, i32 0, i32 0, i32 0, i64 1
  ...
  %call2_40c31e = tail call %struct.Memory* @sub_40c2a0._ZN34custom_multiply_multiple_variable2IdE8do_shiftEddddd(%struct.State* %0, i64 %108, %struct.Memory* %2)
  ...
  %116 = add i64 %113, -48
  store i64 %116, i64* %RSI.i24, align 8
  %117 = load double, double* bitcast (%G_0x7b15__rip__4244275__type* @G_0x7b15__rip__4244275_ to double*), align 8
  %118 = load double, double* %42, align 1
  %119 = fmul double %117, %118
  store double %119, double* %87, align 1
  store i64 0, i64* %88, align 1
  %120 = add i64 %115, 25
  store i64 %120, i64* %3, align 8
  %121 = inttoptr i64 %116 to double*
  ...
  %call2_40c33c = tail call %struct.Memory* @sub_40bfe0._Z15tolerance_equalIdEbRT_S1_(%struct.State* %0, i64 %123, %struct.Memory* %call2_40c31e)
  ...
  br i1 %137, label %block_.L_40c364, label %block_40c349
...
block_40c349:                                     ; preds = %entry
  ...
  %146 = tail call %struct.Memory* @__remill_function_call(%struct.State* %0, i64 ptrtoint (i64 (i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64)* @printf to i64), %struct.Memory* %call2_40c33c)
...
block_.L_40c364:                                  ; preds = %block_40c349, %entry
  %153 = phi i64 [ %138, %entry ], [ %.pre, %block_40c349 ]
  %MEMORY.0 = phi %struct.Memory* [ %call2_40c33c, %entry ], [ %146, %block_40c349 ]
...
block_400478:
  ...
  %4 = add i64 %3, 8
  store i64 %4, i64* %PC, align 8
  %5 = load i64, i64* bitcast (%G_0x7b15__rip__4244275__type* @G_0x7b15__rip__4244275_ to i64*), align 8
