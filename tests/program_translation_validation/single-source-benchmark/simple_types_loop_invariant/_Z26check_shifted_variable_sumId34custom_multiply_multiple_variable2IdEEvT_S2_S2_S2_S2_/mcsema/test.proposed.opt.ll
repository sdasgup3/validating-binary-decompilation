...
%G_0x7b15__rip__type = type <{ [8 x i8] }>
...
@G_0x7b15__rip_ = local_unnamed_addr global %G_0x7b15__rip__type zeroinitializer
...
declare %struct.Memory* @sub_40c2a0._ZN34custom_multiply_multiple_variable2IdE8do_shiftEddddd(%struct.State* noalias dereferenceable(3376), i64, %struct.Memory* noalias readnone returned) local_unnamed_addr
...
define %struct.Memory* @_Z26check_shifted_variable_sumId34custom_multiply_multiple_variable2IdEEvT_S2_S2_S2_S2_(%struct.State* noalias, i64, %struct.Memory* noalias) local_unnamed_addr #1 {
entry:
  ...
  %59 = getelementptr inbounds %union.VectorReg, %union.VectorReg* %54, i64 0, i32 0, i32 0, i32 0, i64 0
  ...
  %79 = load i64, i64* bitcast (%G_0x61a088_type* @G_0x61a088 to i64*), align 8
  %80 = getelementptr inbounds [32 x %union.VectorReg], [32 x %union.VectorReg]* %39, i64 0, i64 0, i32 0, i32 0, i32 0, i64 0
  ...
  %88 = bitcast %union.VectorReg* %46 to double*
  %89 = getelementptr inbounds %union.VectorReg, %union.VectorReg* %46, i64 0, i32 0, i32 0, i32 0, i64 0
  store i64 %87, i64* %89, align 1
  %90 = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 1, i64 1, i32 0, i32 0, i32 0, i64 1
  ...
  %96 = getelementptr inbounds %union.VectorReg, %union.VectorReg* %54, i64 0, i32 0, i32 0, i32 0, i64 0
  ...
  %103 = getelementptr inbounds %union.VectorReg, %union.VectorReg* %62, i64 0, i32 0, i32 0, i32 0, i64 0
  ...
  %110 = getelementptr inbounds %union.VectorReg, %union.VectorReg* %70, i64 0, i32 0, i32 0, i32 0, i64 0
  store i64 %109, i64* %110, align 1
  %111 = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 1, i64 4, i32 0, i32 0, i32 0, i64 1
  ...
  %call2_40c31e = tail call %struct.Memory* @sub_40c2a0._ZN34custom_multiply_multiple_variable2IdE8do_shiftEddddd(%struct.State* %0, i64 %113, %struct.Memory* %2)
  ...
  %121 = add i64 %118, -48
  store i64 %121, i64* %RSI.i24, align 8
  %122 = load double, double* bitcast (%G_0x7b15__rip__type* @G_0x7b15__rip_ to double*), align 8
  %123 = load double, double* %42, align 1
  %124 = fmul double %122, %123
  store double %124, double* %88, align 1
  store i64 0, i64* %90, align 1
  %125 = add i64 %120, 25
  store i64 %125, i64* %PC.i, align 8
  %126 = inttoptr i64 %121 to double*
  ...
  %call2_40c33c = tail call %struct.Memory* @sub_40bfe0._Z15tolerance_equalIdEbRT_S1_(%struct.State* %0, i64 %128, %struct.Memory* %call2_40c31e)
  %133 = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 1, i32 0
  %AL.i16 = bitcast %union.anon* %133 to i8*
  %134 = load i8, i8* %AL.i16, align 1
  ...
  %.v = select i1 %142, i64 35, i64 8
  %143 = add i64 %135, %.v
  store i64 %143, i64* %3, align 8
  br i1 %142, label %block_.L_40c364, label %block_40c349

block_40c349:                                     ; preds = %entry
  store i64 ptrtoint (%G__0x414aee_type* @G__0x414aee to i64), i64* %RDI.i27, align 8
  %144 = load i32, i32* bitcast (%G_0x61a0a8_type* @G_0x61a0a8 to i32*), align 8
  %145 = zext i32 %144 to i64
  store i64 %145, i64* %RSI.i24, align 8
  store i8 0, i8* %AL.i16, align 1
  %146 = add i64 %143, -48329
  %147 = add i64 %143, 24
  ...
  %151 = tail call %struct.Memory* @__remill_function_call(%struct.State* %0, i64 ptrtoint (i64 (i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64)* @printf to i64), %struct.Memory* %call2_40c33c)
  %EAX.i = bitcast %union.anon* %133 to i32*
  %152 = load i64, i64* %RBP.i, align 8
  %153 = add i64 %152, -52
  %154 = load i32, i32* %EAX.i, align 4
  ...
  br label %block_.L_40c364

block_.L_40c364:                                  ; preds = %block_40c349, %entry
  %158 = phi i64 [ %143, %entry ], [ %.pre, %block_40c349 ]
  %MEMORY.0 = phi %struct.Memory* [ %call2_40c33c, %entry ], [ %151, %block_40c349 ]
  %159 = load i64, i64* %RSP.i8, align 8
  %160 = add i64 %159, 64
  store i64 %160, i64* %RSP.i8, align 8
  %161 = icmp ugt i64 %159, -65
...
define %struct.Memory* @routine_movsd_MINUS0x20__rbp____xmm3(%struct.State* dereferenceable(3376), i64, %struct.Memory*) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %RBP = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 15, i32 0, i32 0
  %3 = load i64, i64* %RBP, align 8
...
define %struct.Memory* @routine_callq_._ZN34custom_multiply_multiple_variable2IdE8do_shiftEddddd(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
...
define %struct.Memory* @routine_movsd_0x7b15__rip____xmm1(%struct.State* dereferenceable(3376), i64, %struct.Memory*) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, 8
  store i64 %4, i64* %PC, align 8
  %5 = load i64, i64* bitcast (%G_0x7b15__rip__type* @G_0x7b15__rip_ to i64*), align 8
...
define %struct.Memory* @routine_jne_.L_40c364(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i8* %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
