; ModuleID = '/tmp/tmp0ts4b8b2-query.ll'
...
entry:
  ...
  %call2_40c35e = tail call %struct.Memory* @sub_40c2e0._ZN34custom_multiply_multiple_variable2IdE8do_shiftEddddd(%struct.State* %0, i64 %var_2_105, %struct.Memory* %2)
  ...
  %var_2_123 = add i64 %var_2_122, -860
  %call2_40c37c = tail call %struct.Memory* @sub_40c020._Z15tolerance_equalIdEbRT_S1_(%struct.State* %0, i64 %var_2_123, %struct.Memory* %call2_40c35e)
  ...
  br i1 %var_2_137, label %block_40c389, label %block_.L_40c3a4

block_40c389:                                     ; preds = %entry
  %var_2_146 = tail call %struct.Memory* @__remill_function_call(%struct.State* nonnull %0, i64 ptrtoint (i64 (i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64)* @printf to i64), %struct.Memory* %call2_40c37c)
  br label %block_.L_40c3a4

block_.L_40c3a4:                                  ; preds = %block_40c389, %entry
  %MEMORY.0 = phi %struct.Memory* [ %call2_40c37c, %entry ], [ %var_2_146, %block_40c389 ]
