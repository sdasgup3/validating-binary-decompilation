; ModuleID = '/tmp/tmpg_l1bb2t-query.ll'
...
%call2_40d010 = tail call %struct.Memory* @sub_40d060._ZN19custom_add_variableIfE8do_shiftEff(%struct.State* %0, i64 %var_2_88, %struct.Memory* %2)
...
%var_2_97 = add i64 %var_2_95, add (i64 ptrtoint (%G_0x6e8f__rip__type* @G_0x6e8f__rip_ to i64), i64 8)
...
%var_2_120 = add i64 %var_2_119, -1934
...
%call2_40d02e = tail call %struct.Memory* @sub_40c8a0._Z15tolerance_equalIfEbRT_S1_(%struct.State* %0, i64 %var_2_120, %struct.Memory* %call2_40d010)
...
br i1 %var_2_134, label %block_.L_40d056, label %block_40d03b
...
; Matched:%var_2_168:  %var_2_168 = add i64 %var_2_132, -51563
; %var_2_138 = add i64 %var_2_135, -51563
...
%var_2_143 = tail call %struct.Memory* @__remill_function_call(%struct.State* nonnull %0, i64 ptrtoint (i64 (i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64)* @printf to i64), %struct.Memory* %call2_40d02e)
...
; Matched:%var_2_133:  %var_2_133 = phi i64 [ %var_2_132, %block_40cff0 ], [ %.pre, %block_40d03b ]
; %var_2_150 = phi i64 [ %var_2_135, %entry ], [ %.pre, %block_40d03b ]
%MEMORY.0 = phi %struct.Memory* [ %call2_40d02e, %entry ], [ %var_2_143, %block_40d03b ]
