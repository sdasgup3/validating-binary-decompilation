...
@G_0x6fcb__rip__4247209_ = global %G_0x6fcb__rip__4247209__type zeroinitializer
...
entry:
  ...
  store %struct.Memory* %loadMem1_40ce94, %struct.Memory** %MEMORY
  ...
  %212 = load float, float* bitcast (%G_0x6fcb__rip__4247209__type* @G_0x6fcb__rip__4247209_ to float*)
  ...
  store %struct.Memory* %loadMem1_40ceb2, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_40ceb7, %struct.Memory** %MEMORY
...
block_40cebf:                                     ; preds = %entry
  ...
  store %struct.Memory* %loadMem1_40ced2, %struct.Memory** %MEMORY
  %loadMem2_40ced2 = load %struct.Memory*, %struct.Memory** %MEMORY
  %loadPC_40ced2 = load i64, i64* %3
  %367 = call %struct.Memory* @__remill_function_call(%struct.State* %0, i64 ptrtoint (i64 (i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64)* @printf to i64), %struct.Memory* %loadMem2_40ced2)
...
block_.L_40ceda:                                  ; preds = %block_40cebf, %entry
  ...
  ret %struct.Memory* %loadMem_40cedf
}
...
define %struct.Memory* @routine_movss_0x6fcb__rip____xmm1(%struct.State* dereferenceable(3376), i64, %struct.Memory*) {
block_400478:
  %3 = getelementptr inbounds %struct.State, %struct.State* %0, i32 0, i32 6
  %4 = getelementptr inbounds %struct.GPR, %struct.GPR* %3, i32 0, i32 33
  %5 = getelementptr inbounds %struct.Reg, %struct.Reg* %4, i32 0, i32 0
