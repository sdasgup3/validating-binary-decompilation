...
block_40ceeb:                                     ; preds = %entry
  ...
  %143 = tail call %struct.Memory* @__remill_function_call(%struct.State* nonnull %0, i64 ptrtoint (i64 (i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64)* @printf to i64), %struct.Memory* %call2_40cede)
...
block_.L_40cf06:                                  ; preds = %block_40ceeb, %entry
  %150 = phi i64 [ %135, %entry ], [ %.pre, %block_40ceeb ]
  %MEMORY.0 = phi %struct.Memory* [ %call2_40cede, %entry ], [ %143, %block_40ceeb ]
