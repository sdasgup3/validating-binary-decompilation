...
@G_0x6fcb__rip__4247209_ = local_unnamed_addr global %G_0x6fcb__rip__4247209__type zeroinitializer
...
entry:
  ...
  %call2_40ce94 = tail call %struct.Memory* @sub_40ce50._ZN19custom_sub_variableIfE8do_shiftEff(%struct.State* %0, i64 %83, %struct.Memory* %2)
  ...
  %92 = load i32, i32* bitcast (%G_0x6fcb__rip__4247209__type* @G_0x6fcb__rip__4247209_ to i32*), align 8
  store i32 %92, i32* %76, align 1
  store float 0.000000e+00, float* %78, align 1
  store float 0.000000e+00, float* %80, align 1
  store float 0.000000e+00, float* %82, align 1
  %93 = load <2 x float>, <2 x float>* %52, align 1
  %94 = bitcast i64* %79 to <2 x i32>*
  %95 = load <2 x i32>, <2 x i32>* %94, align 1
  %96 = load <2 x float>, <2 x float>* %43, align 1
  %97 = extractelement <2 x float> %93, i32 0
  %98 = extractelement <2 x float> %96, i32 0
  %99 = fmul float %97, %98
  store float %99, float* %75, align 1
  %100 = bitcast <2 x float> %93 to <2 x i32>
  %101 = extractelement <2 x i32> %100, i32 1
  %102 = bitcast i8* %77 to i32*
  store i32 %101, i32* %102, align 1
  %103 = extractelement <2 x i32> %95, i32 0
  %104 = bitcast i64* %79 to i32*
  store i32 %103, i32* %104, align 1
  %105 = extractelement <2 x i32> %95, i32 1
  %106 = bitcast i8* %81 to i32*
  store i32 %105, i32* %106, align 1
  %107 = add i64 %90, 25
  store i64 %107, i64* %3, align 8
  %108 = load <2 x float>, <2 x float>* %52, align 1
  %109 = extractelement <2 x float> %108, i32 0
  %110 = inttoptr i64 %91 to float*
  store float %109, float* %110, align 4
  %111 = load i64, i64* %3, align 8
  %112 = add i64 %111, -1618
  %113 = add i64 %111, 5
  ...
  %call2_40ceb2 = tail call %struct.Memory* @sub_40c860._Z15tolerance_equalIfEbRT_S1_(%struct.State* %0, i64 %112, %struct.Memory* %call2_40ce94)
  %117 = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 1, i32 0
  %AL.i16 = bitcast %union.anon* %117 to i8*
  %118 = load i8, i8* %AL.i16, align 1
  ...
  %.v = select i1 %126, i64 35, i64 8
  %127 = add i64 %119, %.v
  store i64 %127, i64* %3, align 8
  br i1 %126, label %block_.L_40ceda, label %block_40cebf

block_40cebf:                                     ; preds = %entry
  store i64 ptrtoint (%G__0x414aee_type* @G__0x414aee to i64), i64* %RDI.i27, align 8
  %128 = load i32, i32* bitcast (%G_0x61a0a8_type* @G_0x61a0a8 to i32*), align 8
  %129 = zext i32 %128 to i64
  store i64 %129, i64* %RSI.i24, align 8
  store i8 0, i8* %AL.i16, align 1
  %130 = add i64 %127, -51263
  %131 = add i64 %127, 24
  ...
  %135 = tail call %struct.Memory* @__remill_function_call(%struct.State* %0, i64 ptrtoint (i64 (i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64)* @printf to i64), %struct.Memory* %call2_40ceb2)
  %EAX.i = bitcast %union.anon* %117 to i32*
  %136 = load i64, i64* %RBP.i, align 8
  %137 = add i64 %136, -16
  %138 = load i32, i32* %EAX.i, align 4
...
block_.L_40ceda:                                  ; preds = %block_40cebf, %entry
  %142 = phi i64 [ %127, %entry ], [ %.pre, %block_40cebf ]
  %MEMORY.0 = phi %struct.Memory* [ %call2_40ceb2, %entry ], [ %135, %block_40cebf ]
  %143 = load i64, i64* %6, align 8
  %144 = add i64 %143, 16
  store i64 %144, i64* %6, align 8
  %145 = icmp ugt i64 %143, -17
...
define %struct.Memory* @routine_movss_0x6fcb__rip____xmm1(%struct.State* dereferenceable(3376), i64, %struct.Memory*) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 1, i64 1
  %4 = bitcast %union.VectorReg* %3 to i8*
  ...
  %6 = add i64 %5, 8
  store i64 %6, i64* %PC, align 8
  %7 = load i32, i32* bitcast (%G_0x6fcb__rip__4247209__type* @G_0x6fcb__rip__4247209_ to i32*), align 8
...
define %struct.Memory* @routine_jne_.L_40ceda(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i8* %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
