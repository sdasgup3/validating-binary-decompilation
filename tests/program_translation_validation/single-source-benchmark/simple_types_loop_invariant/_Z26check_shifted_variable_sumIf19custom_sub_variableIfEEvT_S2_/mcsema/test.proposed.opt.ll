...
@G_0x6fcb__rip_ = local_unnamed_addr global %G_0x6fcb__rip__type zeroinitializer
...
entry:
  ...
  %92 = load i32, i32* bitcast (%G_0x6fcb__rip__type* @G_0x6fcb__rip_ to i32*), align 8
  ...
  %call2_40ceb2 = tail call %struct.Memory* @sub_40c860._Z15tolerance_equalIfEbRT_S1_(%struct.State* %0, i64 %114, %struct.Memory* %call2_40ce94)
  ...
  br i1 %128, label %block_.L_40ceda, label %block_40cebf
...
block_40cebf:                                     ; preds = %entry
  ...
  %137 = tail call %struct.Memory* @__remill_function_call(%struct.State* %0, i64 ptrtoint (i64 (i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64)* @printf to i64), %struct.Memory* %call2_40ceb2)
...
block_.L_40ceda:                                  ; preds = %block_40cebf, %entry
  %144 = phi i64 [ %129, %entry ], [ %.pre, %block_40cebf ]
  %MEMORY.0 = phi %struct.Memory* [ %call2_40ceb2, %entry ], [ %137, %block_40cebf ]
...
block_400478:
  ...
  %6 = add i64 %5, 8
  store i64 %6, i64* %PC, align 8
  %7 = load i32, i32* bitcast (%G_0x6fcb__rip__type* @G_0x6fcb__rip_ to i32*), align 8
