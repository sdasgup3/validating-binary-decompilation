...
entry:
  ...
  %call2_40ced0 = tail call %struct.Memory* @sub_40ce90._ZN19custom_sub_variableIfE8do_shiftEff(%struct.State* %0, i64 %88, %struct.Memory* %2)
  ...
  %97 = add i64 %95, add (i64 ptrtoint (%G_0x6fcf__rip__type* @G_0x6fcf__rip_ to i64), i64 8)
  %98 = add i64 %95, 16
  ...
  %call2_40ceee = tail call %struct.Memory* @sub_40c8a0._Z15tolerance_equalIfEbRT_S1_(%struct.State* %0, i64 %120, %struct.Memory* %call2_40ced0)
  ...
  br i1 %134, label %block_.L_40cf16, label %block_40cefb
...
block_40cefb:                                     ; preds = %entry
  ...
  %143 = tail call %struct.Memory* @__remill_function_call(%struct.State* nonnull %0, i64 ptrtoint (i64 (i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64)* @printf to i64), %struct.Memory* %call2_40ceee)
...
block_.L_40cf16:                                  ; preds = %block_40cefb, %entry
  %150 = phi i64 [ %135, %entry ], [ %.pre, %block_40cefb ]
  %MEMORY.0 = phi %struct.Memory* [ %call2_40ceee, %entry ], [ %143, %block_40cefb ]
