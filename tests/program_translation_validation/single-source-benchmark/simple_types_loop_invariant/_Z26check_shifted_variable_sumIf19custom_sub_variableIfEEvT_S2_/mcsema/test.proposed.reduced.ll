; ModuleID = '/tmp/tmpetfk5yno-query.ll'
...
%G_0x6fcf__rip__type = type <{ [4 x i8] }>
...
@G_0x6fcf__rip_ = global %G_0x6fcf__rip__type zeroinitializer
...
declare %struct.Memory* @sub_40ce90._ZN19custom_sub_variableIfE8do_shiftEff(%struct.State* noalias dereferenceable(3376), i64, %struct.Memory* noalias readnone returned) local_unnamed_addr
...
define %struct.Memory* @_Z26check_shifted_variable_sumIf19custom_sub_variableIfEEvT_S2_(%struct.State* noalias, i64, %struct.Memory* noalias) local_unnamed_addr #1 {
entry:
...
; %var_2_49 = add i64 %var_2_48, -8
; Matched:%var_2_49:  %var_2_49 = load i64, i64* %PC, align 8
; %var_2_50 = load i64, i64* %var_2_3, align 8
; Matched:%var_2_50:  %var_2_50 = add i64 %var_2_49, 5
; %var_2_51 = add i64 %var_2_50, 5
; Matched:\<badref\>:  store i64 %var_2_50, i64* %PC, align 8
; store i64 %var_2_51, i64* %var_2_3, align 8
%var_2_52 = bitcast %union.VectorReg* %var_2_47 to <2 x float>*
%var_2_53 = load <2 x float>, <2 x float>* %var_2_52, align 1
%var_2_54 = extractelement <2 x float> %var_2_53, i32 0
; Matched:%var_2_54:  %var_2_54 = inttoptr i64 %var_2_48 to float*
; %var_2_55 = inttoptr i64 %var_2_49 to float*
; Matched:\<badref\>:  store float %var_2_53, float* %var_2_54, align 4
; store float %var_2_54, float* %var_2_55, align 4
; Matched:%var_2_55:  %var_2_55 = bitcast [32 x %union.VectorReg]* %var_2_4 to i8*
; %var_2_56 = bitcast [32 x %union.VectorReg]* %var_2_40 to i8*
%var_2_57 = load i64, i64* %var_2_3, align 8
%var_2_58 = bitcast [32 x %union.VectorReg]* %var_2_40 to <2 x i32>*
%var_2_59 = load <2 x i32>, <2 x i32>* %var_2_58, align 1
; Matched:%var_2_59:  %var_2_59 = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 1, i64 0, i32 0, i32 0, i32 0, i64 1
; %var_2_60 = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 1, i64 0, i32 0, i32 0, i32 0, i64 1
%var_2_61 = bitcast i64* %var_2_60 to <2 x i32>*
%var_2_62 = load <2 x i32>, <2 x i32>* %var_2_61, align 1
; Matched:%var_2_62:  %var_2_62 = load double, double* bitcast (%init_value_type* @init_value to double*), align 8
; %var_2_63 = load double, double* bitcast (%G_0x61a088_type* @G_0x61a088 to double*), align 8
; Matched:%var_2_63:  %var_2_63 = fptrunc double %var_2_62 to float
; %var_2_64 = fptrunc double %var_2_63 to float
; Matched:%var_2_64:  %var_2_64 = bitcast [32 x %union.VectorReg]* %var_2_4 to float*
; %var_2_65 = bitcast [32 x %union.VectorReg]* %var_2_40 to float*
; Matched:\<badref\>:  store float %var_2_63, float* %var_2_64, align 1, !tbaa !1284
; store float %var_2_64, float* %var_2_65, align 1
%var_2_66 = extractelement <2 x i32> %var_2_59, i32 1
; Matched:%var_2_66:  %var_2_66 = getelementptr inbounds i8, i8* %var_2_55, i64 4
; %var_2_67 = getelementptr inbounds i8, i8* %var_2_56, i64 4
; Matched:%var_2_67:  %var_2_67 = bitcast i8* %var_2_66 to i32*
; %var_2_68 = bitcast i8* %var_2_67 to i32*
; Matched:\<badref\>:  store i32 %var_2_65, i32* %var_2_67, align 1, !tbaa !1284
; store i32 %var_2_66, i32* %var_2_68, align 1
%var_2_69 = extractelement <2 x i32> %var_2_62, i32 0
; Matched:%var_2_69:  %var_2_69 = bitcast i64* %var_2_59 to i32*
; %var_2_70 = bitcast i64* %var_2_60 to i32*
; Matched:\<badref\>:  store i32 %var_2_68, i32* %var_2_69, align 1, !tbaa !1284
; store i32 %var_2_69, i32* %var_2_70, align 1
%var_2_71 = extractelement <2 x i32> %var_2_62, i32 1
; Matched:%var_2_71:  %var_2_71 = getelementptr inbounds i8, i8* %var_2_55, i64 12
; %var_2_72 = getelementptr inbounds i8, i8* %var_2_56, i64 12
; Matched:%var_2_72:  %var_2_72 = bitcast i8* %var_2_71 to i32*
; %var_2_73 = bitcast i8* %var_2_72 to i32*
; Matched:\<badref\>:  store i32 %var_2_70, i32* %var_2_72, align 1, !tbaa !1284
; store i32 %var_2_71, i32* %var_2_73, align 1
%var_2_74 = bitcast %union.VectorReg* %var_2_47 to i8*
; Matched:%var_2_74:  %var_2_74 = load i64, i64* %RBP, align 8
; %var_2_75 = load i64, i64* %RBP.i, align 8
; Matched:%var_2_75:  %var_2_75 = add i64 %var_2_74, -8
; %var_2_76 = add i64 %var_2_75, -8
; Matched:%var_2_76:  %var_2_76 = add i64 %var_2_56, 14
; %var_2_77 = add i64 %var_2_57, 14
; Matched:\<badref\>:  store i64 %var_2_76, i64* %PC, align 8
; store i64 %var_2_77, i64* %var_2_3, align 8
; Matched:%var_2_77:  %var_2_77 = inttoptr i64 %var_2_75 to i32*
; %var_2_78 = inttoptr i64 %var_2_76 to i32*
; Matched:%var_2_78:  %var_2_78 = load i32, i32* %var_2_77, align 4
; %var_2_79 = load i32, i32* %var_2_78, align 4
; Matched:%var_2_79:  %var_2_79 = bitcast %union.VectorReg* %var_2_5 to float*
; %var_2_80 = bitcast %union.VectorReg* %var_2_47 to float*
%var_2_81 = bitcast %union.VectorReg* %var_2_47 to i32*
; Matched:\<badref\>:  store i32 %var_2_78, i32* %var_2_80, align 1, !tbaa !1284
; store i32 %var_2_79, i32* %var_2_81, align 1
%var_2_82 = getelementptr inbounds i8, i8* %var_2_74, i64 4
...
%var_2_86 = getelementptr inbounds i8, i8* %var_2_74, i64 12
%var_2_87 = bitcast i8* %var_2_86 to float*
store float 0.000000e+00, float* %var_2_87, align 1
%var_2_88 = add i64 %var_2_57, -50
; Matched:%var_2_88:  %var_2_88 = add i64 %var_2_56, 19
; %var_2_89 = add i64 %var_2_57, 19
; Matched:%var_2_89:  %var_2_89 = load i64, i64* %RSP, align 8, !tbaa !1261
; %var_2_90 = load i64, i64* %var_2_6, align 8
; Matched:%var_2_120:  %var_2_120 = add i64 %var_2_119, -8
; %var_2_91 = add i64 %var_2_90, -8
; Matched:%var_2_91:  %var_2_91 = inttoptr i64 %var_2_90 to i64*
; %var_2_92 = inttoptr i64 %var_2_91 to i64*
; Matched:\<badref\>:  store i64 %var_2_88, i64* %var_2_91, align 8
; store i64 %var_2_89, i64* %var_2_92, align 8
; Matched:\<badref\>:  store i64 %var_2_171, i64* %RSP, align 8, !tbaa !1261
; store i64 %var_2_91, i64* %var_2_6, align 8
; Matched:\<badref\>:  store i64 %var_2_87, i64* %PC, align 8, !tbaa !1261
; store i64 %var_2_88, i64* %var_2_3, align 8
%call2_40ced0 = tail call %struct.Memory* @sub_40ce90._ZN19custom_sub_variableIfE8do_shiftEff(%struct.State* %0, i64 %var_2_88, %struct.Memory* %2)
...
; Matched:%var_2_96:  %var_2_96 = add i64 %var_2_93, -12
; %var_2_96 = add i64 %var_2_93, -12
; Matched:\<badref\>:  store i64 %var_2_96, i64* %RSI, align 8, !tbaa !1261
; store i64 %var_2_96, i64* %RSI.i24, align 8
%var_2_97 = add i64 %var_2_95, add (i64 ptrtoint (%G_0x6fcf__rip__type* @G_0x6fcf__rip_ to i64), i64 8)
%var_2_98 = add i64 %var_2_95, 16
store i64 %var_2_98, i64* %var_2_3, align 8
%var_2_99 = inttoptr i64 %var_2_97 to i32*
%var_2_100 = load i32, i32* %var_2_99, align 4
store i32 %var_2_100, i32* %var_2_81, align 1
store float 0.000000e+00, float* %var_2_83, align 1
store float 0.000000e+00, float* %var_2_85, align 1
store float 0.000000e+00, float* %var_2_87, align 1
%var_2_101 = load <2 x float>, <2 x float>* %var_2_52, align 1
%var_2_102 = bitcast i64* %var_2_84 to <2 x i32>*
%var_2_103 = load <2 x i32>, <2 x i32>* %var_2_102, align 1
%var_2_104 = load <2 x float>, <2 x float>* %var_2_43, align 1
%var_2_105 = extractelement <2 x float> %var_2_101, i32 0
%var_2_106 = extractelement <2 x float> %var_2_104, i32 0
; Matched:%var_2_104:  %var_2_104 = fmul float %var_2_102, %var_2_103
; %var_2_107 = fmul float %var_2_105, %var_2_106
; Matched:\<badref\>:  store float %var_2_104, float* %var_2_79, align 1, !tbaa !1284
; store float %var_2_107, float* %var_2_80, align 1
%var_2_108 = bitcast <2 x float> %var_2_101 to <2 x i32>
%var_2_109 = extractelement <2 x i32> %var_2_108, i32 1
; Matched:%var_2_107:  %var_2_107 = bitcast i8* %var_2_81 to i32*
; %var_2_110 = bitcast i8* %var_2_82 to i32*
; Matched:\<badref\>:  store i32 %var_2_106, i32* %var_2_107, align 1, !tbaa !1284
; store i32 %var_2_109, i32* %var_2_110, align 1
%var_2_111 = extractelement <2 x i32> %var_2_103, i32 0
; Matched:%var_2_109:  %var_2_109 = bitcast i64* %var_2_83 to i32*
; %var_2_112 = bitcast i64* %var_2_84 to i32*
; Matched:\<badref\>:  store i32 %var_2_108, i32* %var_2_109, align 1, !tbaa !1284
; store i32 %var_2_111, i32* %var_2_112, align 1
%var_2_113 = extractelement <2 x i32> %var_2_103, i32 1
; Matched:%var_2_111:  %var_2_111 = bitcast i8* %var_2_85 to i32*
; %var_2_114 = bitcast i8* %var_2_86 to i32*
; Matched:\<badref\>:  store i32 %var_2_110, i32* %var_2_111, align 1, !tbaa !1284
; store i32 %var_2_113, i32* %var_2_114, align 1
; Matched:%var_2_112:  %var_2_112 = add i64 %var_2_95, 25
; %var_2_115 = add i64 %var_2_95, 25
; Matched:\<badref\>:  store i64 %var_2_112, i64* %PC, align 8
; store i64 %var_2_115, i64* %var_2_3, align 8
%var_2_116 = load <2 x float>, <2 x float>* %var_2_52, align 1
%var_2_117 = extractelement <2 x float> %var_2_116, i32 0
; Matched:%var_2_115:  %var_2_115 = inttoptr i64 %var_2_96 to float*
; %var_2_118 = inttoptr i64 %var_2_96 to float*
; Matched:\<badref\>:  store float %var_2_114, float* %var_2_115, align 4
; store float %var_2_117, float* %var_2_118, align 4
%var_2_119 = load i64, i64* %var_2_3, align 8
%var_2_120 = add i64 %var_2_119, -1614
; Matched:%var_2_118:  %var_2_118 = add i64 %var_2_116, 5
; %var_2_121 = add i64 %var_2_119, 5
; Matched:%var_2_119:  %var_2_119 = load i64, i64* %RSP, align 8, !tbaa !1261
; %var_2_122 = load i64, i64* %var_2_6, align 8
; Matched:%var_2_171:  %var_2_171 = add i64 %var_2_170, -8
; %var_2_123 = add i64 %var_2_122, -8
; Matched:%var_2_121:  %var_2_121 = inttoptr i64 %var_2_120 to i64*
; %var_2_124 = inttoptr i64 %var_2_123 to i64*
; Matched:\<badref\>:  store i64 %var_2_118, i64* %var_2_121, align 8
; store i64 %var_2_121, i64* %var_2_124, align 8
; Matched:\<badref\>:  store i64 %var_2_90, i64* %RSP, align 8, !tbaa !1261
...
%call2_40ceee = tail call %struct.Memory* @sub_40c8a0._Z15tolerance_equalIfEbRT_S1_(%struct.State* %0, i64 %var_2_120, %struct.Memory* %call2_40ced0)
%var_2_125 = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 1, i32 0
%AL.i16 = bitcast %union.anon* %var_2_125 to i8*
%var_2_126 = load i8, i8* %AL.i16, align 1
; Matched:%var_2_124:  %var_2_124 = load i64, i64* %PC, align 8
; %var_2_127 = load i64, i64* %var_2_3, align 8
%var_2_128 = and i8 %var_2_126, 1
store i8 0, i8* %var_2_14, align 1
; Matched:%var_2_126:  %var_2_126 = zext i8 %var_2_125 to i32
; %var_2_129 = zext i8 %var_2_128 to i32
; Matched:%var_2_127:  %var_2_127 = tail call i32 @llvm.ctpop.i32(i32 %var_2_126) #12
; %var_2_130 = tail call i32 @llvm.ctpop.i32(i32 %var_2_129)
; Matched:%var_2_128:  %var_2_128 = trunc i32 %var_2_127 to i8
; %var_2_131 = trunc i32 %var_2_130 to i8
; Matched:%var_2_129:  %var_2_129 = xor i8 %var_2_128, 1
; %var_2_132 = xor i8 %var_2_131, 1
; Matched:\<badref\>:  store i8 %var_2_129, i8* %var_2_22, align 1, !tbaa !1279
; store i8 %var_2_132, i8* %var_2_21, align 1
%var_2_133 = xor i8 %var_2_128, 1
; Matched:\<badref\>:  store i8 %var_2_130, i8* %var_2_31, align 1, !tbaa !1281
; store i8 %var_2_133, i8* %var_2_30, align 1
store i8 0, i8* %var_2_33, align 1
store i8 0, i8* %var_2_39, align 1
store i8 0, i8* %var_2_27, align 1
%var_2_134 = icmp eq i8 %var_2_133, 0
; Matched:  %.v = select i1 %var_2_131, i64 35, i64 8
; %.v = select i1 %var_2_134, i64 35, i64 8
; Matched:%var_2_132:  %var_2_132 = add i64 %var_2_124, %.v
; %var_2_135 = add i64 %var_2_127, %.v
; Matched:\<badref\>:  store i64 %var_2_132, i64* %PC, align 8, !tbaa !1261
; store i64 %var_2_135, i64* %var_2_3, align 8
br i1 %var_2_134, label %block_.L_40cf16, label %block_40cefb

block_40cefb:                                     ; preds = %entry
  store i64 ptrtoint (%G__0x414b2e_type* @G__0x414b2e to i64), i64* %RDI.i27, align 8
; Matched:%var_2_166:  %var_2_166 = load i32, i32* bitcast (%current_test_type* @current_test to i32*), align 8
; %var_2_136 = load i32, i32* bitcast (%G_0x61a0a8_type* @G_0x61a0a8 to i32*), align 8
; Matched:%var_2_167:  %var_2_167 = zext i32 %var_2_166 to i64
; %var_2_137 = zext i32 %var_2_136 to i64
; Matched:\<badref\>:  store i64 %var_2_167, i64* %RSI, align 8, !tbaa !1261
; store i64 %var_2_137, i64* %RSI.i24, align 8
; Matched:\<badref\>:  store i8 0, i8* %AL, align 1, !tbaa !1286
; store i8 0, i8* %AL.i16, align 1
; Matched:%var_2_168:  %var_2_168 = add i64 %var_2_132, -51243
; %var_2_138 = add i64 %var_2_135, -51243
; Matched:%var_2_169:  %var_2_169 = add i64 %var_2_132, 24
; %var_2_139 = add i64 %var_2_135, 24
; Matched:%var_2_170:  %var_2_170 = load i64, i64* %RSP, align 8, !tbaa !1261
; %var_2_140 = load i64, i64* %var_2_6, align 8
...
%var_2_143 = tail call %struct.Memory* @__remill_function_call(%struct.State* nonnull %0, i64 ptrtoint (i64 (i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64)* @printf to i64), %struct.Memory* %call2_40ceee)
; Matched:  %EAX = bitcast %union.anon* %var_2_3 to i32*
; %EAX.i = bitcast %union.anon* %var_2_125 to i32*
; Matched:%var_2_174:  %var_2_174 = load i64, i64* %RBP, align 8
; %var_2_144 = load i64, i64* %RBP.i, align 8
; Matched:%var_2_175:  %var_2_175 = add i64 %var_2_174, -16
; %var_2_145 = add i64 %var_2_144, -16
; Matched:%var_2_176:  %var_2_176 = load i32, i32* %EAX, align 4
; %var_2_146 = load i32, i32* %EAX.i, align 4
; Matched:%var_2_177:  %var_2_177 = load i64, i64* %PC, align 8
; %var_2_147 = load i64, i64* %var_2_3, align 8
; Matched:%var_2_178:  %var_2_178 = add i64 %var_2_177, 3
; %var_2_148 = add i64 %var_2_147, 3
; Matched:\<badref\>:  store i64 %var_2_178, i64* %PC, align 8
; store i64 %var_2_148, i64* %var_2_3, align 8
; Matched:%var_2_179:  %var_2_179 = inttoptr i64 %var_2_175 to i32*
; %var_2_149 = inttoptr i64 %var_2_145 to i32*
; Matched:\<badref\>:  store i32 %var_2_176, i32* %var_2_179, align 4
; store i32 %var_2_146, i32* %var_2_149, align 4
; Matched:  %.pre = load i64, i64* %PC, align 8
; %.pre = load i64, i64* %var_2_3, align 8
  br label %block_.L_40cf16

block_.L_40cf16:                                  ; preds = %block_40cefb, %entry
; Matched:%var_2_133:  %var_2_133 = phi i64 [ %var_2_132, %block_40ceb0 ], [ %.pre, %block_40cefb ]
; %var_2_150 = phi i64 [ %var_2_135, %entry ], [ %.pre, %block_40cefb ]
%MEMORY.0 = phi %struct.Memory* [ %call2_40ceee, %entry ], [ %var_2_143, %block_40cefb ]
; Matched:%var_2_134:  %var_2_134 = load i64, i64* %RSP, align 8
; %var_2_151 = load i64, i64* %var_2_6, align 8
; Matched:%var_2_135:  %var_2_135 = add i64 %var_2_134, 16
; %var_2_152 = add i64 %var_2_151, 16
; Matched:\<badref\>:  store i64 %var_2_135, i64* %RSP, align 8, !tbaa !1261
; store i64 %var_2_152, i64* %var_2_6, align 8
; Matched:%var_2_136:  %var_2_136 = icmp ugt i64 %var_2_134, -17
; %var_2_153 = icmp ugt i64 %var_2_151, -17
; Matched:%var_2_137:  %var_2_137 = zext i1 %var_2_136 to i8
; %var_2_154 = zext i1 %var_2_153 to i8
; Matched:\<badref\>:  store i8 %var_2_137, i8* %var_2_15, align 1, !tbaa !1265
; store i8 %var_2_154, i8* %var_2_14, align 1
; Matched:%var_2_138:  %var_2_138 = trunc i64 %var_2_135 to i32
; %var_2_155 = trunc i64 %var_2_152 to i32
; Matched:%var_2_139:  %var_2_139 = and i32 %var_2_138, 255
; %var_2_156 = and i32 %var_2_155, 255
; Matched:%var_2_140:  %var_2_140 = tail call i32 @llvm.ctpop.i32(i32 %var_2_139) #12
; %var_2_157 = tail call i32 @llvm.ctpop.i32(i32 %var_2_156)
; Matched:%var_2_141:  %var_2_141 = trunc i32 %var_2_140 to i8
; %var_2_158 = trunc i32 %var_2_157 to i8
; Matched:%var_2_142:  %var_2_142 = and i8 %var_2_141, 1
; %var_2_159 = and i8 %var_2_158, 1
; Matched:%var_2_143:  %var_2_143 = xor i8 %var_2_142, 1
; %var_2_160 = xor i8 %var_2_159, 1
; Matched:\<badref\>:  store i8 %var_2_143, i8* %var_2_22, align 1, !tbaa !1279
; store i8 %var_2_160, i8* %var_2_21, align 1
; Matched:%var_2_144:  %var_2_144 = xor i64 %var_2_134, 16
; %var_2_161 = xor i64 %var_2_151, 16
; Matched:%var_2_145:  %var_2_145 = xor i64 %var_2_144, %var_2_135
; %var_2_162 = xor i64 %var_2_161, %var_2_152
; Matched:%var_2_146:  %var_2_146 = lshr i64 %var_2_145, 4
; %var_2_163 = lshr i64 %var_2_162, 4
; Matched:%var_2_147:  %var_2_147 = trunc i64 %var_2_146 to i8
; %var_2_164 = trunc i64 %var_2_163 to i8
; Matched:%var_2_148:  %var_2_148 = and i8 %var_2_147, 1
; %var_2_165 = and i8 %var_2_164, 1
; Matched:\<badref\>:  store i8 %var_2_148, i8* %var_2_28, align 1, !tbaa !1280
; store i8 %var_2_165, i8* %var_2_27, align 1
; Matched:%var_2_149:  %var_2_149 = icmp eq i64 %var_2_135, 0
; %var_2_166 = icmp eq i64 %var_2_152, 0
; Matched:%var_2_150:  %var_2_150 = zext i1 %var_2_149 to i8
; %var_2_167 = zext i1 %var_2_166 to i8
; Matched:\<badref\>:  store i8 %var_2_150, i8* %var_2_31, align 1, !tbaa !1281
; store i8 %var_2_167, i8* %var_2_30, align 1
; Matched:%var_2_151:  %var_2_151 = lshr i64 %var_2_135, 63
; %var_2_168 = lshr i64 %var_2_152, 63
; Matched:%var_2_152:  %var_2_152 = trunc i64 %var_2_151 to i8
; %var_2_169 = trunc i64 %var_2_168 to i8
; Matched:\<badref\>:  store i8 %var_2_152, i8* %var_2_34, align 1, !tbaa !1282
; store i8 %var_2_169, i8* %var_2_33, align 1
; Matched:%var_2_153:  %var_2_153 = lshr i64 %var_2_134, 63
; %var_2_170 = lshr i64 %var_2_151, 63
; Matched:%var_2_154:  %var_2_154 = xor i64 %var_2_151, %var_2_153
; %var_2_171 = xor i64 %var_2_168, %var_2_170
; Matched:%var_2_155:  %var_2_155 = add nuw nsw i64 %var_2_154, %var_2_151
; %var_2_172 = add nuw nsw i64 %var_2_171, %var_2_168
; Matched:%var_2_156:  %var_2_156 = icmp eq i64 %var_2_155, 2
; %var_2_173 = icmp eq i64 %var_2_172, 2
; Matched:%var_2_157:  %var_2_157 = zext i1 %var_2_156 to i8
; %var_2_174 = zext i1 %var_2_173 to i8
; Matched:\<badref\>:  store i8 %var_2_157, i8* %var_2_40, align 1, !tbaa !1283
; store i8 %var_2_174, i8* %var_2_39, align 1
; Matched:%var_2_158:  %var_2_158 = add i64 %var_2_133, 5
; %var_2_175 = add i64 %var_2_150, 5
; Matched:\<badref\>:  store i64 %var_2_158, i64* %PC, align 8
; store i64 %var_2_175, i64* %var_2_3, align 8
; Matched:%var_2_159:  %var_2_159 = add i64 %var_2_134, 24
; %var_2_176 = add i64 %var_2_151, 24
; Matched:%var_2_160:  %var_2_160 = inttoptr i64 %var_2_135 to i64*
; %var_2_177 = inttoptr i64 %var_2_152 to i64*
; Matched:%var_2_161:  %var_2_161 = load i64, i64* %var_2_160, align 8
; %var_2_178 = load i64, i64* %var_2_177, align 8
; Matched:\<badref\>:  store i64 %var_2_161, i64* %RBP, align 8, !tbaa !1261
; store i64 %var_2_178, i64* %RBP.i, align 8
; Matched:\<badref\>:  store i64 %var_2_159, i64* %RSP, align 8, !tbaa !1261
; store i64 %var_2_176, i64* %var_2_6, align 8
; Matched:%var_2_162:  %var_2_162 = add i64 %var_2_133, 6
; %var_2_179 = add i64 %var_2_150, 6
; Matched:\<badref\>:  store i64 %var_2_162, i64* %PC, align 8
; store i64 %var_2_179, i64* %var_2_3, align 8
; Matched:%var_2_163:  %var_2_163 = inttoptr i64 %var_2_159 to i64*
; %var_2_180 = inttoptr i64 %var_2_176 to i64*
; Matched:%var_2_164:  %var_2_164 = load i64, i64* %var_2_163, align 8
...
; Matched:%var_2_165:  %var_2_165 = add i64 %var_2_134, 32
; %var_2_182 = add i64 %var_2_151, 32
; Matched:\<badref\>:  store i64 %var_2_165, i64* %RSP, align 8, !tbaa !1261
; store i64 %var_2_182, i64* %var_2_6, align 8
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_callq_._ZN19custom_sub_variableIfE8do_shiftEff(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_movss_0x6fcf__rip____xmm1(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 1, i64 1
  %4 = bitcast %union.VectorReg* %3 to i8*
  %5 = load i64, i64* %PC, align 8
  %6 = add i64 %5, ptrtoint (%G_0x6fcf__rip__type* @G_0x6fcf__rip_ to i64)
  %7 = add i64 %5, 8
  store i64 %7, i64* %PC, align 8
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_jne_.L_40cf16(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i8* nocapture %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
