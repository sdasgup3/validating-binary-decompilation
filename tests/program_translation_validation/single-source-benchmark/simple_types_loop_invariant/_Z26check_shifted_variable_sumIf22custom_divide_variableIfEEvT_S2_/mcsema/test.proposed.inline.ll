...
declare %struct.Memory* @sub_40caf0._ZN22custom_divide_variableIfE8do_shiftEff(%struct.State* dereferenceable(3376), i64, %struct.Memory*)
...
define %struct.Memory* @_Z26check_shifted_variable_sumIf22custom_divide_variableIfEEvT_S2_(%struct.State* noalias, i64, %struct.Memory* noalias) #1 {
entry:
