...
define %struct.Memory* @_Z26check_shifted_variable_sumIf22custom_divide_variableIfEEvT_S2_(%struct.State* noalias, i64, %struct.Memory* noalias readnone) local_unnamed_addr #1 {
entry:
  ...
  %AL.i13 = bitcast %union.anon* %125 to i8*
  %126 = load i8, i8* %AL.i13, align 1
...
block_40cb5b:                                     ; preds = %entry
  ...
  store i64 %137, i64* %RSI.i21, align 8
  ...
  %call2_40cb6e = tail call %struct.Memory* @sub_4006c0.printf_plt(%struct.State* nonnull %0, i64 %138, %struct.Memory* %call2_40cb4e)
  %EAX.i = bitcast %union.anon* %125 to i32*
  %143 = load i64, i64* %RBP.i, align 8
  %144 = add i64 %143, -16
  %145 = load i32, i32* %EAX.i, align 4
...
block_.L_40cb76:                                  ; preds = %block_40cb5b, %entry
  %149 = phi i64 [ %135, %entry ], [ %.pre, %block_40cb5b ]
  %MEMORY.0 = phi %struct.Memory* [ %call2_40cb4e, %entry ], [ %call2_40cb6e, %block_40cb5b ]
  %150 = load i64, i64* %6, align 8
  %151 = add i64 %150, 16
  store i64 %151, i64* %6, align 8
  %152 = icmp ugt i64 %150, -17
