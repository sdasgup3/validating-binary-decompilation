; ModuleID = '/tmp/tmphudwu0w8-query.ll'
...
%call2_40cb40 = tail call %struct.Memory* @sub_40cb00._ZN22custom_divide_variableIfE8do_shiftEff(%struct.State* %0, i64 %var_2_88, %struct.Memory* %2)
...
%var_2_97 = add i64 %var_2_95, add (i64 ptrtoint (%G_0x735f__rip__type* @G_0x735f__rip_ to i64), i64 8)
...
%var_2_120 = add i64 %var_2_119, -702
...
%call2_40cb5e = tail call %struct.Memory* @sub_40c8a0._Z15tolerance_equalIfEbRT_S1_(%struct.State* %0, i64 %var_2_120, %struct.Memory* %call2_40cb40)
...
br i1 %var_2_134, label %block_.L_40cb86, label %block_40cb6b
...
; Matched:%var_2_168:  %var_2_168 = add i64 %var_2_132, -50331
; %var_2_138 = add i64 %var_2_135, -50331
...
%var_2_143 = tail call %struct.Memory* @__remill_function_call(%struct.State* nonnull %0, i64 ptrtoint (i64 (i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64)* @printf to i64), %struct.Memory* %call2_40cb5e)
...
; Matched:%var_2_133:  %var_2_133 = phi i64 [ %var_2_132, %block_40cb20 ], [ %.pre, %block_40cb6b ]
; %var_2_150 = phi i64 [ %var_2_135, %entry ], [ %.pre, %block_40cb6b ]
%MEMORY.0 = phi %struct.Memory* [ %call2_40cb5e, %entry ], [ %var_2_143, %block_40cb6b ]
