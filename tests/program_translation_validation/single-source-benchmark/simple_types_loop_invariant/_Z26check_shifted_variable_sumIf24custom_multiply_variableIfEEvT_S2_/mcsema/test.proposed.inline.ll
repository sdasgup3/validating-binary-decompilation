...
@G_0x712b__rip_ = global %G_0x712b__rip__type zeroinitializer
...
entry:
  ...
  %loadMem_40cd2b = load %struct.Memory*, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_40cd2b, %struct.Memory** %MEMORY
  ...
  %loadMem1_40cd34 = load %struct.Memory*, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem1_40cd34, %struct.Memory** %MEMORY
  %loadMem2_40cd34 = load %struct.Memory*, %struct.Memory** %MEMORY
  %loadPC_40cd34 = load i64, i64* %3
  %call2_40cd34 = call %struct.Memory* @sub_40ccf0._ZN24custom_multiply_variableIfE8do_shiftEff(%struct.State* %0, i64 %loadPC_40cd34, %struct.Memory* %loadMem2_40cd34)
  store %struct.Memory* %call2_40cd34, %struct.Memory** %MEMORY
  ...
  %212 = load float, float* bitcast (%G_0x712b__rip__type* @G_0x712b__rip_ to float*)
  ...
  %loadMem1_40cd52 = load %struct.Memory*, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem1_40cd52, %struct.Memory** %MEMORY
  %loadMem2_40cd52 = load %struct.Memory*, %struct.Memory** %MEMORY
  %loadPC_40cd52 = load i64, i64* %3
  %call2_40cd52 = call %struct.Memory* @sub_40c860._Z15tolerance_equalIfEbRT_S1_(%struct.State* %0, i64 %loadPC_40cd52, %struct.Memory* %loadMem2_40cd52)
  store %struct.Memory* %call2_40cd52, %struct.Memory** %MEMORY
  ...
  %loadBr_40cd59 = load i8, i8* %BRANCH_TAKEN
  %cmpBr_40cd59 = icmp eq i8 %loadBr_40cd59, 1
  br i1 %cmpBr_40cd59, label %block_.L_40cd7a, label %block_40cd5f
...
block_40cd5f:                                     ; preds = %entry
  ...
  %loadMem1_40cd72 = load %struct.Memory*, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem1_40cd72, %struct.Memory** %MEMORY
  %loadMem2_40cd72 = load %struct.Memory*, %struct.Memory** %MEMORY
  %loadPC_40cd72 = load i64, i64* %3
  %367 = call %struct.Memory* @__remill_function_call(%struct.State* %0, i64 ptrtoint (i64 (i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64)* @printf to i64), %struct.Memory* %loadMem2_40cd72)
  store %struct.Memory* %367, %struct.Memory** %MEMORY
  %loadMem_40cd77 = load %struct.Memory*, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_40cd77, %struct.Memory** %MEMORY
...
block_.L_40cd7a:                                  ; preds = %block_40cd5f, %entry
  ...
  store %struct.Memory* %loadMem_40cd7e, %struct.Memory** %MEMORY
  ...
  ret %struct.Memory* %loadMem_40cd7f
}
...
define %struct.Memory* @routine_movss_0x712b__rip____xmm1(%struct.State* dereferenceable(3376), i64, %struct.Memory*) {
block_400478:
  %3 = getelementptr inbounds %struct.State, %struct.State* %0, i32 0, i32 6
  %4 = getelementptr inbounds %struct.GPR, %struct.GPR* %3, i32 0, i32 33
  %5 = getelementptr inbounds %struct.Reg, %struct.Reg* %4, i32 0, i32 0
  ...
  %9 = load i64, i64* %PC
  %10 = ptrtoint %G_0x712b__rip__type* @G_0x712b__rip_ to i64
  %11 = load i64, i64* %PC
  %12 = add i64 %11, 8
  store i64 %12, i64* %PC
...
define %struct.Memory* @routine_jne_.L_40cd7a(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i8* %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) {
block_400478:
  %3 = getelementptr inbounds %struct.State, %struct.State* %0, i32 0, i32 6
  %4 = getelementptr inbounds %struct.GPR, %struct.GPR* %3, i32 0, i32 33
  %5 = getelementptr inbounds %struct.Reg, %struct.Reg* %4, i32 0, i32 0
