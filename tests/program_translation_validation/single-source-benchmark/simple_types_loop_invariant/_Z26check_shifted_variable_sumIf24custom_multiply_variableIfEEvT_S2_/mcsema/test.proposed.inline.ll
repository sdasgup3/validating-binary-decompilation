...
block_40cd8b:                                     ; preds = %entry
  ...
  %call2_40cd9e = call %struct.Memory* @sub_4006c0.printf_plt(%struct.State* %0, i64 %loadPC_40cd9e, %struct.Memory* %loadMem2_40cd9e)
  store %struct.Memory* %call2_40cd9e, %struct.Memory** %MEMORY
