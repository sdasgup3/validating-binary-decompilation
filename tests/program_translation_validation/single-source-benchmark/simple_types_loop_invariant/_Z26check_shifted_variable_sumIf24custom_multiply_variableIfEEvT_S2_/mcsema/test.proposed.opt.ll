...
define %struct.Memory* @_Z26check_shifted_variable_sumIf24custom_multiply_variableIfEEvT_S2_(%struct.State* noalias, i64, %struct.Memory* noalias readnone) local_unnamed_addr #1 {
entry:
...
block_40cd8b:                                     ; preds = %entry
  ...
  %call2_40cd9e = tail call %struct.Memory* @sub_4006c0.printf_plt(%struct.State* nonnull %0, i64 %138, %struct.Memory* %call2_40cd7e)
...
block_.L_40cda6:                                  ; preds = %block_40cd8b, %entry
  %149 = phi i64 [ %135, %entry ], [ %.pre, %block_40cd8b ]
  %MEMORY.0 = phi %struct.Memory* [ %call2_40cd7e, %entry ], [ %call2_40cd9e, %block_40cd8b ]
