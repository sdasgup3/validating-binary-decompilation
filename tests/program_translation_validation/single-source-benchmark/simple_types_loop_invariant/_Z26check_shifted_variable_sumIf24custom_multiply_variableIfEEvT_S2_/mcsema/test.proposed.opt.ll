...
%G_0x712f__rip__type = type <{ [4 x i8] }>
...
@G_0x712f__rip_ = global %G_0x712f__rip__type zeroinitializer
...
entry:
  ...
  %call2_40cd70 = tail call %struct.Memory* @sub_40cd30._ZN24custom_multiply_variableIfE8do_shiftEff(%struct.State* %0, i64 %88, %struct.Memory* %2)
  ...
  %97 = add i64 %95, add (i64 ptrtoint (%G_0x712f__rip__type* @G_0x712f__rip_ to i64), i64 8)
  %98 = add i64 %95, 16
  ...
  %call2_40cd8e = tail call %struct.Memory* @sub_40c8a0._Z15tolerance_equalIfEbRT_S1_(%struct.State* %0, i64 %120, %struct.Memory* %call2_40cd70)
  ...
  br i1 %134, label %block_.L_40cdb6, label %block_40cd9b

block_40cd9b:                                     ; preds = %entry
  ...
  %143 = tail call %struct.Memory* @__remill_function_call(%struct.State* nonnull %0, i64 ptrtoint (i64 (i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64)* @printf to i64), %struct.Memory* %call2_40cd8e)
  ...
  br label %block_.L_40cdb6

block_.L_40cdb6:                                  ; preds = %block_40cd9b, %entry
  %150 = phi i64 [ %135, %entry ], [ %.pre, %block_40cd9b ]
  %MEMORY.0 = phi %struct.Memory* [ %call2_40cd8e, %entry ], [ %143, %block_40cd9b ]
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_movss_0x712f__rip____xmm1(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 1, i64 1
  %4 = bitcast %union.VectorReg* %3 to i8*
  %5 = load i64, i64* %PC, align 8
  %6 = add i64 %5, ptrtoint (%G_0x712f__rip__type* @G_0x712f__rip_ to i64)
  %7 = add i64 %5, 8
  store i64 %7, i64* %PC, align 8
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_jne_.L_40cdb6(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i8* nocapture %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
