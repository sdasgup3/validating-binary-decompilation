...
%G_0x712b__rip__type = type <{ [4 x i8] }>
...
@G_0x712b__rip_ = local_unnamed_addr global %G_0x712b__rip__type zeroinitializer
...
entry:
  ...
  %92 = load i32, i32* bitcast (%G_0x712b__rip__type* @G_0x712b__rip_ to i32*), align 8
  ...
  %call2_40cd52 = tail call %struct.Memory* @sub_40c860._Z15tolerance_equalIfEbRT_S1_(%struct.State* %0, i64 %114, %struct.Memory* %call2_40cd34)
  ...
  br i1 %128, label %block_.L_40cd7a, label %block_40cd5f
...
block_40cd5f:                                     ; preds = %entry
  ...
  %137 = tail call %struct.Memory* @__remill_function_call(%struct.State* %0, i64 ptrtoint (i64 (i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64)* @printf to i64), %struct.Memory* %call2_40cd52)
...
block_.L_40cd7a:                                  ; preds = %block_40cd5f, %entry
  %144 = phi i64 [ %129, %entry ], [ %.pre, %block_40cd5f ]
  %MEMORY.0 = phi %struct.Memory* [ %call2_40cd52, %entry ], [ %137, %block_40cd5f ]
...
block_400478:
  ...
  %6 = add i64 %5, 8
  store i64 %6, i64* %PC, align 8
  %7 = load i32, i32* bitcast (%G_0x712b__rip__type* @G_0x712b__rip_ to i32*), align 8
