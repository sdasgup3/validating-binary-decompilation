...
%G_0x712b__rip__4246857__type = type <{ [16 x i8] }>
...
@G_0x712b__rip__4246857_ = local_unnamed_addr global %G_0x712b__rip__4246857__type zeroinitializer
...
define %struct.Memory* @_Z26check_shifted_variable_sumIf24custom_multiply_variableIfEEvT_S2_(%struct.State* noalias, i64, %struct.Memory* noalias) local_unnamed_addr #1 {
entry:
  ...
  %call2_40cd34 = tail call %struct.Memory* @sub_40ccf0._ZN24custom_multiply_variableIfE8do_shiftEff(%struct.State* %0, i64 %83, %struct.Memory* %2)
  ...
  %92 = load i32, i32* bitcast (%G_0x712b__rip__4246857__type* @G_0x712b__rip__4246857_ to i32*), align 8
  ...
  %call2_40cd52 = tail call %struct.Memory* @sub_40c860._Z15tolerance_equalIfEbRT_S1_(%struct.State* %0, i64 %112, %struct.Memory* %call2_40cd34)
  ...
  br i1 %126, label %block_.L_40cd7a, label %block_40cd5f

block_40cd5f:                                     ; preds = %entry
  ...
  %135 = tail call %struct.Memory* @__remill_function_call(%struct.State* %0, i64 ptrtoint (i64 (i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64)* @printf to i64), %struct.Memory* %call2_40cd52)
  ...
  br label %block_.L_40cd7a

block_.L_40cd7a:                                  ; preds = %block_40cd5f, %entry
  %142 = phi i64 [ %127, %entry ], [ %.pre, %block_40cd5f ]
  %MEMORY.0 = phi %struct.Memory* [ %call2_40cd52, %entry ], [ %135, %block_40cd5f ]
...
define %struct.Memory* @routine_movss_0x712b__rip____xmm1(%struct.State* dereferenceable(3376), i64, %struct.Memory*) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 1, i64 1
  %4 = bitcast %union.VectorReg* %3 to i8*
  ...
  %6 = add i64 %5, 8
  store i64 %6, i64* %PC, align 8
  %7 = load i32, i32* bitcast (%G_0x712b__rip__4246857__type* @G_0x712b__rip__4246857_ to i32*), align 8
...
define %struct.Memory* @routine_jne_.L_40cd7a(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i8* %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
