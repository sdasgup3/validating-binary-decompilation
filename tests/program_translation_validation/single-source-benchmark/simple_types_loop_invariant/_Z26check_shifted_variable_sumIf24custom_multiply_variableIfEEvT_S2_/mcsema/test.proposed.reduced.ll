; ModuleID = '/tmp/tmpsckhues6-query.ll'
...
%call2_40cd70 = tail call %struct.Memory* @sub_40cd30._ZN24custom_multiply_variableIfE8do_shiftEff(%struct.State* %0, i64 %var_2_88, %struct.Memory* %2)
...
%var_2_97 = add i64 %var_2_95, add (i64 ptrtoint (%G_0x712f__rip__type* @G_0x712f__rip_ to i64), i64 8)
...
%var_2_120 = add i64 %var_2_119, -1262
...
%call2_40cd8e = tail call %struct.Memory* @sub_40c8a0._Z15tolerance_equalIfEbRT_S1_(%struct.State* %0, i64 %var_2_120, %struct.Memory* %call2_40cd70)
...
br i1 %var_2_134, label %block_.L_40cdb6, label %block_40cd9b
...
; Matched:%var_2_168:  %var_2_168 = add i64 %var_2_132, -50891
; %var_2_138 = add i64 %var_2_135, -50891
...
%var_2_143 = tail call %struct.Memory* @__remill_function_call(%struct.State* nonnull %0, i64 ptrtoint (i64 (i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64)* @printf to i64), %struct.Memory* %call2_40cd8e)
...
; Matched:%var_2_133:  %var_2_133 = phi i64 [ %var_2_132, %block_40cd50 ], [ %.pre, %block_40cd9b ]
; %var_2_150 = phi i64 [ %var_2_135, %entry ], [ %.pre, %block_40cd9b ]
%MEMORY.0 = phi %struct.Memory* [ %call2_40cd8e, %entry ], [ %var_2_143, %block_40cd9b ]
