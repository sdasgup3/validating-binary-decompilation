...
@G_0x6f01__rip_ = global %G_0x6f01__rip__type zeroinitializer
...
entry:
  ...
  store %struct.Memory* %loadMem_40cf60, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_40cf64, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_40cf72, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_40cf8f, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem1_40cf9e, %struct.Memory** %MEMORY
  ...
  %311 = add i64 %310, ptrtoint (%G_0x6f01__rip__type* @G_0x6f01__rip_ to i64)
  ...
  store %struct.Memory* %loadMem1_40cfbc, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_40cfc1, %struct.Memory** %MEMORY
...
block_40cfc9:                                     ; preds = %entry
  ...
  store %struct.Memory* %loadMem1_40cfdc, %struct.Memory** %MEMORY
  %loadMem2_40cfdc = load %struct.Memory*, %struct.Memory** %MEMORY
  %loadPC_40cfdc = load i64, i64* %3
  %470 = call %struct.Memory* @__remill_function_call(%struct.State* %0, i64 ptrtoint (i64 (i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64)* @printf to i64), %struct.Memory* %loadMem2_40cfdc)
...
block_.L_40cfe4:                                  ; preds = %block_40cfc9, %entry
  ...
  store %struct.Memory* %loadMem_40cfe9, %struct.Memory** %MEMORY
  ret %struct.Memory* %loadMem_40cfe9
}
