...
entry:
  ...
  store %struct.Memory* %loadMem_40cf51, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_40cf6c, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_40cf7a, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_40cf89, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem1_40cf8e, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_40cf9b, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_40cfa7, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem1_40cfac, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_40cfb1, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_40cfb3, %struct.Memory** %MEMORY
...
block_40cfb9:                                     ; preds = %entry
  ...
  store %struct.Memory* %loadMem_40cfb9, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_40cfc3, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem1_40cfcc, %struct.Memory** %MEMORY
  %loadMem2_40cfcc = load %struct.Memory*, %struct.Memory** %MEMORY
  %loadPC_40cfcc = load i64, i64* %3
  %470 = call %struct.Memory* @__remill_function_call(%struct.State* %0, i64 ptrtoint (i64 (i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64)* @printf to i64), %struct.Memory* %loadMem2_40cfcc)
  ...
  store %struct.Memory* %loadMem_40cfd1, %struct.Memory** %MEMORY
  br label %block_.L_40cfd4

block_.L_40cfd4:                                  ; preds = %block_40cfb9, %entry
  ...
  store %struct.Memory* %loadMem_40cfd9, %struct.Memory** %MEMORY
  ret %struct.Memory* %loadMem_40cfd9
}
...
define %struct.Memory* @routine_movss_0x6f01__rip____xmm1(%struct.State* dereferenceable(3376), i64, %struct.Memory*) {
block_400488:
  %3 = getelementptr inbounds %struct.State, %struct.State* %0, i32 0, i32 6
  %4 = getelementptr inbounds %struct.GPR, %struct.GPR* %3, i32 0, i32 33
  %5 = getelementptr inbounds %struct.Reg, %struct.Reg* %4, i32 0, i32 0
