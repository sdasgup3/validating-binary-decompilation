...
define %struct.Memory* @_Z26check_shifted_variable_sumIf28custom_add_multiple_variableIfEEvT_S2_S2_S2_S2_(%struct.State* noalias, i64, %struct.Memory* noalias readnone) local_unnamed_addr #1 {
entry:
...
block_40cfb9:                                     ; preds = %entry
  ...
  %call2_40cfcc = tail call %struct.Memory* @sub_4006c0.printf_plt(%struct.State* nonnull %0, i64 %200, %struct.Memory* %call2_40cfac)
...
block_.L_40cfd4:                                  ; preds = %block_40cfb9, %entry
  %211 = phi i64 [ %197, %entry ], [ %.pre, %block_40cfb9 ]
  %MEMORY.0 = phi %struct.Memory* [ %call2_40cfac, %entry ], [ %call2_40cfcc, %block_40cfb9 ]
