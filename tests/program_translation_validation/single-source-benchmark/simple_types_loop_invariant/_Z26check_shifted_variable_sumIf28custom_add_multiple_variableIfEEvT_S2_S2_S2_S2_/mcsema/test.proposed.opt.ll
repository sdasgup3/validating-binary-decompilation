...
@G_0x6efd__rip_ = local_unnamed_addr global %G_0x6efd__rip__type zeroinitializer
...
entry:
  ...
  %154 = load i32, i32* bitcast (%G_0x6efd__rip__type* @G_0x6efd__rip_ to i32*), align 8
  ...
  %call2_40cf80 = tail call %struct.Memory* @sub_40c860._Z15tolerance_equalIfEbRT_S1_(%struct.State* %0, i64 %176, %struct.Memory* %call2_40cf62)
  ...
  br i1 %190, label %block_.L_40cfa8, label %block_40cf8d
...
block_40cf8d:                                     ; preds = %entry
  ...
  %199 = tail call %struct.Memory* @__remill_function_call(%struct.State* %0, i64 ptrtoint (i64 (i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64)* @printf to i64), %struct.Memory* %call2_40cf80)
...
block_.L_40cfa8:                                  ; preds = %block_40cf8d, %entry
  %206 = phi i64 [ %191, %entry ], [ %.pre, %block_40cf8d ]
  %MEMORY.0 = phi %struct.Memory* [ %call2_40cf80, %entry ], [ %199, %block_40cf8d ]
...
block_400478:
  ...
  %6 = add i64 %5, 8
  store i64 %6, i64* %PC, align 8
  %7 = load i32, i32* bitcast (%G_0x6efd__rip__type* @G_0x6efd__rip_ to i32*), align 8
