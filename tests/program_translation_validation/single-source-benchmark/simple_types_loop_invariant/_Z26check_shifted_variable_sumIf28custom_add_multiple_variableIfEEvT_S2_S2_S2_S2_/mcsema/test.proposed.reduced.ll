; ModuleID = '/tmp/tmpuf18hz6m-query.ll'
...
%call2_40cf9e = tail call %struct.Memory* @sub_40cf20._ZN28custom_add_multiple_variableIfE8do_shiftEfffff(%struct.State* %0, i64 %var_2_150, %struct.Memory* %2)
...
%var_2_159 = add i64 %var_2_157, add (i64 ptrtoint (%G_0x6f01__rip__type* @G_0x6f01__rip_ to i64), i64 8)
...
%var_2_182 = add i64 %var_2_181, -1820
...
%call2_40cfbc = tail call %struct.Memory* @sub_40c8a0._Z15tolerance_equalIfEbRT_S1_(%struct.State* %0, i64 %var_2_182, %struct.Memory* %call2_40cf9e)
...
br i1 %var_2_196, label %block_.L_40cfe4, label %block_40cfc9
...
; Matched:%var_2_229:  %var_2_229 = add i64 %var_2_194, -51449
; %var_2_200 = add i64 %var_2_197, -51449
...
%var_2_205 = tail call %struct.Memory* @__remill_function_call(%struct.State* nonnull %0, i64 ptrtoint (i64 (i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64)* @printf to i64), %struct.Memory* %call2_40cfbc)
...
; Matched:%var_2_195:  %var_2_195 = phi i64 [ %var_2_194, %block_40cf60 ], [ %.pre, %block_40cfc9 ]
; %var_2_212 = phi i64 [ %var_2_197, %entry ], [ %.pre, %block_40cfc9 ]
%MEMORY.0 = phi %struct.Memory* [ %call2_40cfbc, %entry ], [ %var_2_205, %block_40cfc9 ]
