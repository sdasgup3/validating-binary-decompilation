...
@G_0x705d__rip__4247063_ = global %G_0x705d__rip__4247063__type zeroinitializer
...
define %struct.Memory* @_Z26check_shifted_variable_sumIf28custom_sub_multiple_variableIfEEvT_S2_S2_S2_S2_(%struct.State* noalias, i64, %struct.Memory* noalias) #2 {
entry:
  ...
  store %struct.Memory* %loadMem1_40ce02, %struct.Memory** %MEMORY
  ...
  %329 = load float, float* bitcast (%G_0x705d__rip__4247063__type* @G_0x705d__rip__4247063_ to float*)
  ...
  store %struct.Memory* %loadMem_40ce17, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_40ce1b, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem1_40ce20, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_40ce25, %struct.Memory** %MEMORY
...
block_40ce2d:                                     ; preds = %entry
  ...
  store %struct.Memory* %loadMem1_40ce40, %struct.Memory** %MEMORY
  %loadMem2_40ce40 = load %struct.Memory*, %struct.Memory** %MEMORY
  %loadPC_40ce40 = load i64, i64* %3
  %484 = call %struct.Memory* @__remill_function_call(%struct.State* %0, i64 ptrtoint (i64 (i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64)* @printf to i64), %struct.Memory* %loadMem2_40ce40)
...
block_.L_40ce48:                                  ; preds = %block_40ce2d, %entry
  ...
  ret %struct.Memory* %loadMem_40ce4d
}
...
define %struct.Memory* @routine_movss_0x705d__rip____xmm1(%struct.State* dereferenceable(3376), i64, %struct.Memory*) {
block_400478:
  %3 = getelementptr inbounds %struct.State, %struct.State* %0, i32 0, i32 6
  %4 = getelementptr inbounds %struct.GPR, %struct.GPR* %3, i32 0, i32 33
  %5 = getelementptr inbounds %struct.Reg, %struct.Reg* %4, i32 0, i32 0
