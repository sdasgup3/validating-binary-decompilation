...
block_40ce59:                                     ; preds = %entry
  ...
  %205 = tail call %struct.Memory* @__remill_function_call(%struct.State* nonnull %0, i64 ptrtoint (i64 (i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64)* @printf to i64), %struct.Memory* %call2_40ce4c)
...
block_.L_40ce74:                                  ; preds = %block_40ce59, %entry
  %212 = phi i64 [ %197, %entry ], [ %.pre, %block_40ce59 ]
  %MEMORY.0 = phi %struct.Memory* [ %call2_40ce4c, %entry ], [ %205, %block_40ce59 ]
