...
declare %struct.Memory* @sub_40cdb0._ZN28custom_sub_multiple_variableIfE8do_shiftEfffff(%struct.State* dereferenceable(3376), i64, %struct.Memory*) local_unnamed_addr
