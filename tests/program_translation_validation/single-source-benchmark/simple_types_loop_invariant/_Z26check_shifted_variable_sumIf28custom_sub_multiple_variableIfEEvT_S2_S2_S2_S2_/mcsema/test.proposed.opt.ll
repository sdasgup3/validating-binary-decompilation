...
entry:
  ...
  %call2_40ce3e = tail call %struct.Memory* @sub_40cdc0._ZN28custom_sub_multiple_variableIfE8do_shiftEfffff(%struct.State* %0, i64 %150, %struct.Memory* %2)
  ...
  %159 = add i64 %157, add (i64 ptrtoint (%G_0x7061__rip__type* @G_0x7061__rip_ to i64), i64 8)
  %160 = add i64 %157, 16
  ...
  %call2_40ce5c = tail call %struct.Memory* @sub_40c8a0._Z15tolerance_equalIfEbRT_S1_(%struct.State* %0, i64 %182, %struct.Memory* %call2_40ce3e)
  ...
  br i1 %196, label %block_.L_40ce84, label %block_40ce69
...
block_40ce69:                                     ; preds = %entry
  ...
  %205 = tail call %struct.Memory* @__remill_function_call(%struct.State* nonnull %0, i64 ptrtoint (i64 (i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64)* @printf to i64), %struct.Memory* %call2_40ce5c)
...
block_.L_40ce84:                                  ; preds = %block_40ce69, %entry
  %212 = phi i64 [ %197, %entry ], [ %.pre, %block_40ce69 ]
  %MEMORY.0 = phi %struct.Memory* [ %call2_40ce5c, %entry ], [ %205, %block_40ce69 ]
