...
@G_0x764d__rip__4245543_ = local_unnamed_addr global %G_0x764d__rip__4245543__type zeroinitializer
...
entry:
  ...
  %154 = load i32, i32* bitcast (%G_0x764d__rip__4245543__type* @G_0x764d__rip__4245543_ to i32*), align 8
  ...
  %call2_40c830 = tail call %struct.Memory* @sub_40c860._Z15tolerance_equalIfEbRT_S1_(%struct.State* %0, i64 %174, %struct.Memory* %call2_40c812)
  ...
  br i1 %188, label %block_.L_40c858, label %block_40c83d
...
block_40c83d:                                     ; preds = %entry
  ...
  %197 = tail call %struct.Memory* @__remill_function_call(%struct.State* %0, i64 ptrtoint (i64 (i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64)* @printf to i64), %struct.Memory* %call2_40c830)
...
block_.L_40c858:                                  ; preds = %block_40c83d, %entry
  %204 = phi i64 [ %189, %entry ], [ %.pre, %block_40c83d ]
  %MEMORY.0 = phi %struct.Memory* [ %call2_40c830, %entry ], [ %197, %block_40c83d ]
...
block_400478:
  ...
  %6 = add i64 %5, 8
  store i64 %6, i64* %PC, align 8
  %7 = load i32, i32* bitcast (%G_0x764d__rip__4245543__type* @G_0x764d__rip__4245543_ to i32*), align 8
