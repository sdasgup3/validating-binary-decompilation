...
entry:
  ...
  %call2_40c84e = tail call %struct.Memory* @sub_40c7d0._ZN30custom_mixed_multiple_variableIfE8do_shiftEfffff(%struct.State* %0, i64 %150, %struct.Memory* %2)
  ...
  %159 = add i64 %157, add (i64 ptrtoint (%G_0x7651__rip__type* @G_0x7651__rip_ to i64), i64 8)
  %160 = add i64 %157, 16
  ...
  %call2_40c86c = tail call %struct.Memory* @sub_40c8a0._Z15tolerance_equalIfEbRT_S1_(%struct.State* %0, i64 %182, %struct.Memory* %call2_40c84e)
  ...
  br i1 %196, label %block_.L_40c894, label %block_40c879
...
block_40c879:                                     ; preds = %entry
  ...
  %205 = tail call %struct.Memory* @__remill_function_call(%struct.State* nonnull %0, i64 ptrtoint (i64 (i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64)* @printf to i64), %struct.Memory* %call2_40c86c)
...
block_.L_40c894:                                  ; preds = %block_40c879, %entry
  %212 = phi i64 [ %197, %entry ], [ %.pre, %block_40c879 ]
  %MEMORY.0 = phi %struct.Memory* [ %call2_40c86c, %entry ], [ %205, %block_40c879 ]
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_movss_0x7651__rip____xmm1(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 1, i64 1
  %4 = bitcast %union.VectorReg* %3 to i8*
  %5 = load i64, i64* %PC, align 8
  %6 = add i64 %5, ptrtoint (%G_0x7651__rip__type* @G_0x7651__rip_ to i64)
  %7 = add i64 %5, 8
  store i64 %7, i64* %PC, align 8
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_jne_.L_40c894(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i8* nocapture %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
