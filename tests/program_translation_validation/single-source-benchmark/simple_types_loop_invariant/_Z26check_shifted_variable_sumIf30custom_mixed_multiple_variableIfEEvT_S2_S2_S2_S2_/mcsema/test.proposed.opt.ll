...
@G_0x764d__rip_ = local_unnamed_addr global %G_0x764d__rip__type zeroinitializer
...
define %struct.Memory* @_Z26check_shifted_variable_sumIf30custom_mixed_multiple_variableIfEEvT_S2_S2_S2_S2_(%struct.State* noalias, i64, %struct.Memory* noalias) local_unnamed_addr #1 {
entry:
  ...
  %call2_40c812 = tail call %struct.Memory* @sub_40c790._ZN30custom_mixed_multiple_variableIfE8do_shiftEfffff(%struct.State* %0, i64 %145, %struct.Memory* %2)
  ...
  %154 = load i32, i32* bitcast (%G_0x764d__rip__type* @G_0x764d__rip_ to i32*), align 8
  ...
  %call2_40c830 = tail call %struct.Memory* @sub_40c860._Z15tolerance_equalIfEbRT_S1_(%struct.State* %0, i64 %176, %struct.Memory* %call2_40c812)
  ...
  br i1 %190, label %block_.L_40c858, label %block_40c83d
...
block_40c83d:                                     ; preds = %entry
  ...
  %199 = tail call %struct.Memory* @__remill_function_call(%struct.State* %0, i64 ptrtoint (i64 (i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64)* @printf to i64), %struct.Memory* %call2_40c830)
...
block_.L_40c858:                                  ; preds = %block_40c83d, %entry
  %206 = phi i64 [ %191, %entry ], [ %.pre, %block_40c83d ]
  %MEMORY.0 = phi %struct.Memory* [ %call2_40c830, %entry ], [ %199, %block_40c83d ]
...
define %struct.Memory* @routine_movss_0x764d__rip____xmm1(%struct.State* dereferenceable(3376), i64, %struct.Memory*) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 1, i64 1
  %4 = bitcast %union.VectorReg* %3 to i8*
  ...
  %6 = add i64 %5, 8
  store i64 %6, i64* %PC, align 8
  %7 = load i32, i32* bitcast (%G_0x764d__rip__type* @G_0x764d__rip_ to i32*), align 8
...
define %struct.Memory* @routine_jne_.L_40c858(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i8* %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
