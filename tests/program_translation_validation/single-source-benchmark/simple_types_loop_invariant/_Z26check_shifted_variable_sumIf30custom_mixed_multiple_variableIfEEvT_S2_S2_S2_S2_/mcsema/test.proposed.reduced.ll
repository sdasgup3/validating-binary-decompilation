; ModuleID = '/tmp/tmp4f7c4plg-query.ll'
...
%call2_40c84e = tail call %struct.Memory* @sub_40c7d0._ZN30custom_mixed_multiple_variableIfE8do_shiftEfffff(%struct.State* %0, i64 %var_2_150, %struct.Memory* %2)
...
%var_2_159 = add i64 %var_2_157, add (i64 ptrtoint (%G_0x7651__rip__type* @G_0x7651__rip_ to i64), i64 8)
...
%var_2_182 = add i64 %var_2_181, 52
...
%call2_40c86c = tail call %struct.Memory* @sub_40c8a0._Z15tolerance_equalIfEbRT_S1_(%struct.State* %0, i64 %var_2_182, %struct.Memory* %call2_40c84e)
...
br i1 %var_2_196, label %block_.L_40c894, label %block_40c879
...
; Matched:%var_2_229:  %var_2_229 = add i64 %var_2_194, -49577
; %var_2_200 = add i64 %var_2_197, -49577
...
%var_2_205 = tail call %struct.Memory* @__remill_function_call(%struct.State* nonnull %0, i64 ptrtoint (i64 (i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64)* @printf to i64), %struct.Memory* %call2_40c86c)
...
; Matched:%var_2_195:  %var_2_195 = phi i64 [ %var_2_194, %block_40c810 ], [ %.pre, %block_40c879 ]
; %var_2_212 = phi i64 [ %var_2_197, %entry ], [ %.pre, %block_40c879 ]
%MEMORY.0 = phi %struct.Memory* [ %call2_40c86c, %entry ], [ %var_2_205, %block_40c879 ]
