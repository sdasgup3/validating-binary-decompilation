...
%G_0x73ed__rip__4246151__type = type <{ [16 x i8] }>
...
@G_0x73ed__rip__4246151_ = global %G_0x73ed__rip__4246151__type zeroinitializer
...
entry:
  ...
  store %struct.Memory* %loadMem_40ca34, %struct.Memory** %MEMORY
  ...
  %loadMem_40ca3d = load %struct.Memory*, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_40ca3d, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_40ca42, %struct.Memory** %MEMORY
  %loadMem_40ca47 = load %struct.Memory*, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_40ca47, %struct.Memory** %MEMORY
  ...
  %loadMem_40ca51 = load %struct.Memory*, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_40ca51, %struct.Memory** %MEMORY
  ...
  %loadMem_40ca5e = load %struct.Memory*, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_40ca5e, %struct.Memory** %MEMORY
  ...
  %loadMem1_40ca72 = load %struct.Memory*, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem1_40ca72, %struct.Memory** %MEMORY
  %loadMem2_40ca72 = load %struct.Memory*, %struct.Memory** %MEMORY
  %loadPC_40ca72 = load i64, i64* %3
  %call2_40ca72 = call %struct.Memory* @sub_40c9f0._ZN31custom_divide_multiple_variableIfE8do_shiftEfffff(%struct.State* %0, i64 %loadPC_40ca72, %struct.Memory* %loadMem2_40ca72)
  store %struct.Memory* %call2_40ca72, %struct.Memory** %MEMORY
  ...
  %329 = load float, float* bitcast (%G_0x73ed__rip__4246151__type* @G_0x73ed__rip__4246151_ to float*)
  ...
  %loadMem1_40ca90 = load %struct.Memory*, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem1_40ca90, %struct.Memory** %MEMORY
  %loadMem2_40ca90 = load %struct.Memory*, %struct.Memory** %MEMORY
  %loadPC_40ca90 = load i64, i64* %3
  %call2_40ca90 = call %struct.Memory* @sub_40c860._Z15tolerance_equalIfEbRT_S1_(%struct.State* %0, i64 %loadPC_40ca90, %struct.Memory* %loadMem2_40ca90)
  store %struct.Memory* %call2_40ca90, %struct.Memory** %MEMORY
  %loadMem_40ca95 = load %struct.Memory*, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_40ca95, %struct.Memory** %MEMORY
  ...
  %loadBr_40ca97 = load i8, i8* %BRANCH_TAKEN
  %cmpBr_40ca97 = icmp eq i8 %loadBr_40ca97, 1
  br i1 %cmpBr_40ca97, label %block_.L_40cab8, label %block_40ca9d
...
block_40ca9d:                                     ; preds = %entry
  ...
  store %struct.Memory* %loadMem_40ca9d, %struct.Memory** %MEMORY
  ...
  %loadMem_40caae = load %struct.Memory*, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_40caae, %struct.Memory** %MEMORY
  %loadMem1_40cab0 = load %struct.Memory*, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem1_40cab0, %struct.Memory** %MEMORY
  %loadMem2_40cab0 = load %struct.Memory*, %struct.Memory** %MEMORY
  %loadPC_40cab0 = load i64, i64* %3
  %484 = call %struct.Memory* @__remill_function_call(%struct.State* %0, i64 ptrtoint (i64 (i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64)* @printf to i64), %struct.Memory* %loadMem2_40cab0)
...
block_.L_40cab8:                                  ; preds = %block_40ca9d, %entry
  ...
  %loadMem_40cabc = load %struct.Memory*, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_40cabc, %struct.Memory** %MEMORY
  %loadMem_40cabd = load %struct.Memory*, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_40cabd, %struct.Memory** %MEMORY
  ret %struct.Memory* %loadMem_40cabd
}
...
define %struct.Memory* @routine_movss_0x73ed__rip____xmm1(%struct.State* dereferenceable(3376), i64, %struct.Memory*) {
block_400478:
  %3 = getelementptr inbounds %struct.State, %struct.State* %0, i32 0, i32 6
  %4 = getelementptr inbounds %struct.GPR, %struct.GPR* %3, i32 0, i32 33
  %5 = getelementptr inbounds %struct.Reg, %struct.Reg* %4, i32 0, i32 0
  ...
  %9 = load i64, i64* %PC
  %10 = ptrtoint %G_0x73ed__rip__4246151__type* @G_0x73ed__rip__4246151_ to i64
  %11 = load i64, i64* %PC
  %12 = add i64 %11, 8
  store i64 %12, i64* %PC
