...
declare %struct.Memory* @sub_40ca20._ZN31custom_divide_multiple_variableIfE8do_shiftEfffff(%struct.State* noalias dereferenceable(3376), i64, %struct.Memory* noalias readnone returned) local_unnamed_addr
...
define %struct.Memory* @_Z26check_shifted_variable_sumIf31custom_divide_multiple_variableIfEEvT_S2_S2_S2_S2_(%struct.State* noalias, i64, %struct.Memory* noalias readnone) local_unnamed_addr #1 {
entry:
  ...
  %call2_40ca9e = tail call %struct.Memory* @sub_40ca20._ZN31custom_divide_multiple_variableIfE8do_shiftEfffff(%struct.State* %0, i64 %150, %struct.Memory* %2)
  ...
  %call2_40cabc = tail call %struct.Memory* @sub_40c890._Z15tolerance_equalIfEbRT_S1_(%struct.State* %0, i64 %182, %struct.Memory* %call2_40ca9e)
  ...
  br i1 %196, label %block_.L_40cae4, label %block_40cac9
...
block_40cac9:                                     ; preds = %entry
  ...
  %call2_40cadc = tail call %struct.Memory* @sub_4006c0.printf_plt(%struct.State* nonnull %0, i64 %200, %struct.Memory* %call2_40cabc)
...
block_.L_40cae4:                                  ; preds = %block_40cac9, %entry
  %211 = phi i64 [ %197, %entry ], [ %.pre, %block_40cac9 ]
  %MEMORY.0 = phi %struct.Memory* [ %call2_40cabc, %entry ], [ %call2_40cadc, %block_40cac9 ]
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_movss_0x73f1__rip____xmm1(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 1, i64 1
  %4 = bitcast %union.VectorReg* %3 to i8*
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_jne_.L_40cae4(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i8* nocapture %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
