...
declare %struct.Memory* @sub_40ca20._ZN31custom_divide_multiple_variableIfE8do_shiftEfffff(%struct.State* dereferenceable(3376), i64, %struct.Memory*) local_unnamed_addr
