...
@G_0x73ed__rip__4246151_ = local_unnamed_addr global %G_0x73ed__rip__4246151__type zeroinitializer
...
entry:
  ...
  %154 = load i32, i32* bitcast (%G_0x73ed__rip__4246151__type* @G_0x73ed__rip__4246151_ to i32*), align 8
  ...
  %call2_40ca90 = tail call %struct.Memory* @sub_40c860._Z15tolerance_equalIfEbRT_S1_(%struct.State* %0, i64 %174, %struct.Memory* %call2_40ca72)
  ...
  br i1 %188, label %block_.L_40cab8, label %block_40ca9d
...
block_40ca9d:                                     ; preds = %entry
  ...
  %197 = tail call %struct.Memory* @__remill_function_call(%struct.State* %0, i64 ptrtoint (i64 (i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64)* @printf to i64), %struct.Memory* %call2_40ca90)
...
block_.L_40cab8:                                  ; preds = %block_40ca9d, %entry
  %204 = phi i64 [ %189, %entry ], [ %.pre, %block_40ca9d ]
  %MEMORY.0 = phi %struct.Memory* [ %call2_40ca90, %entry ], [ %197, %block_40ca9d ]
...
block_400478:
  ...
  %6 = add i64 %5, 8
  store i64 %6, i64* %PC, align 8
  %7 = load i32, i32* bitcast (%G_0x73ed__rip__4246151__type* @G_0x73ed__rip__4246151_ to i32*), align 8
