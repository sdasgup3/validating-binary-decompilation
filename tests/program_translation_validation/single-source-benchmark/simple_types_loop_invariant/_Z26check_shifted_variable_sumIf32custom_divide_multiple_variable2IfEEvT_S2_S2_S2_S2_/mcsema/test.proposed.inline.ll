...
@G_0x74bd__rip__4245943_ = global %G_0x74bd__rip__4245943__type zeroinitializer
...
define %struct.Memory* @_Z26check_shifted_variable_sumIf32custom_divide_multiple_variable2IfEEvT_S2_S2_S2_S2_(%struct.State* noalias, i64, %struct.Memory* noalias) #2 {
entry:
  ...
  store %struct.Memory* %loadMem1_40c9a2, %struct.Memory** %MEMORY
  ...
  %329 = load float, float* bitcast (%G_0x74bd__rip__4245943__type* @G_0x74bd__rip__4245943_ to float*)
  ...
  store %struct.Memory* %loadMem_40c9bb, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem1_40c9c0, %struct.Memory** %MEMORY
...
block_40c9cd:                                     ; preds = %entry
  ...
  store %struct.Memory* %loadMem1_40c9e0, %struct.Memory** %MEMORY
  %loadMem2_40c9e0 = load %struct.Memory*, %struct.Memory** %MEMORY
  %loadPC_40c9e0 = load i64, i64* %3
  %484 = call %struct.Memory* @__remill_function_call(%struct.State* %0, i64 ptrtoint (i64 (i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64)* @printf to i64), %struct.Memory* %loadMem2_40c9e0)
...
block_.L_40c9e8:                                  ; preds = %block_40c9cd, %entry
  ...
  ret %struct.Memory* %loadMem_40c9ed
}
...
define %struct.Memory* @routine_movss_0x74bd__rip____xmm1(%struct.State* dereferenceable(3376), i64, %struct.Memory*) {
block_400478:
  %3 = getelementptr inbounds %struct.State, %struct.State* %0, i32 0, i32 6
  %4 = getelementptr inbounds %struct.GPR, %struct.GPR* %3, i32 0, i32 33
  %5 = getelementptr inbounds %struct.Reg, %struct.Reg* %4, i32 0, i32 0
