...
entry:
  ...
  %call2_40c9de = tail call %struct.Memory* @sub_40c960._ZN32custom_divide_multiple_variable2IfE8do_shiftEfffff(%struct.State* %0, i64 %150, %struct.Memory* %2)
  ...
  %159 = add i64 %157, add (i64 ptrtoint (%G_0x74c1__rip__type* @G_0x74c1__rip_ to i64), i64 8)
  %160 = add i64 %157, 16
  ...
  %call2_40c9fc = tail call %struct.Memory* @sub_40c8a0._Z15tolerance_equalIfEbRT_S1_(%struct.State* %0, i64 %182, %struct.Memory* %call2_40c9de)
  ...
  br i1 %196, label %block_.L_40ca24, label %block_40ca09
...
block_40ca09:                                     ; preds = %entry
  ...
  %205 = tail call %struct.Memory* @__remill_function_call(%struct.State* nonnull %0, i64 ptrtoint (i64 (i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64)* @printf to i64), %struct.Memory* %call2_40c9fc)
...
block_.L_40ca24:                                  ; preds = %block_40ca09, %entry
  %212 = phi i64 [ %197, %entry ], [ %.pre, %block_40ca09 ]
  %MEMORY.0 = phi %struct.Memory* [ %call2_40c9fc, %entry ], [ %205, %block_40ca09 ]
