...
entry:
  ...
  %call2_40c9ce = tail call %struct.Memory* @sub_40c950._ZN32custom_divide_multiple_variable2IfE8do_shiftEfffff(%struct.State* %0, i64 %150, %struct.Memory* %2)
  ...
  %call2_40c9ec = tail call %struct.Memory* @sub_40c890._Z15tolerance_equalIfEbRT_S1_(%struct.State* %0, i64 %182, %struct.Memory* %call2_40c9ce)
  ...
  br i1 %196, label %block_.L_40ca14, label %block_40c9f9
...
block_40c9f9:                                     ; preds = %entry
  ...
  %205 = tail call %struct.Memory* @__remill_function_call(%struct.State* nonnull %0, i64 ptrtoint (i64 (i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64)* @printf to i64), %struct.Memory* %call2_40c9ec)
...
block_.L_40ca14:                                  ; preds = %block_40c9f9, %entry
  %212 = phi i64 [ %197, %entry ], [ %.pre, %block_40c9f9 ]
  %MEMORY.0 = phi %struct.Memory* [ %call2_40c9ec, %entry ], [ %205, %block_40c9f9 ]
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_jne_.L_40ca14(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i8* nocapture %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
