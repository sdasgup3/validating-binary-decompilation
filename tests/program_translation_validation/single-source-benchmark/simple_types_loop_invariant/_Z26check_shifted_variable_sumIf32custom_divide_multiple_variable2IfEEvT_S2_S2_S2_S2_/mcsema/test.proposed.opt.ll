...
define %struct.Memory* @_Z26check_shifted_variable_sumIf32custom_divide_multiple_variable2IfEEvT_S2_S2_S2_S2_(%struct.State* noalias, i64, %struct.Memory* noalias readnone) local_unnamed_addr #1 {
entry:
...
block_40c9f9:                                     ; preds = %entry
  ...
  %call2_40ca0c = tail call %struct.Memory* @sub_4006c0.printf_plt(%struct.State* nonnull %0, i64 %200, %struct.Memory* %call2_40c9ec)
...
block_.L_40ca14:                                  ; preds = %block_40c9f9, %entry
  %211 = phi i64 [ %197, %entry ], [ %.pre, %block_40c9f9 ]
  %MEMORY.0 = phi %struct.Memory* [ %call2_40c9ec, %entry ], [ %call2_40ca0c, %block_40c9f9 ]
