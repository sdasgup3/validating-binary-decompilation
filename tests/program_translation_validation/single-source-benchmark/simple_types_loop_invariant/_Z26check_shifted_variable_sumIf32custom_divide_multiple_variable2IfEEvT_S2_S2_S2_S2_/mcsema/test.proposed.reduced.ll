; ModuleID = '/tmp/tmpdsxxpf2v-query.ll'
...
define %struct.Memory* @_Z26check_shifted_variable_sumIf32custom_divide_multiple_variable2IfEEvT_S2_S2_S2_S2_(%struct.State* noalias, i64, %struct.Memory* noalias) local_unnamed_addr #1 {
entry:
...
%call2_40c9de = tail call %struct.Memory* @sub_40c960._ZN32custom_divide_multiple_variable2IfE8do_shiftEfffff(%struct.State* %0, i64 %var_2_150, %struct.Memory* %2)
...
%var_2_159 = add i64 %var_2_157, add (i64 ptrtoint (%G_0x74c1__rip__type* @G_0x74c1__rip_ to i64), i64 8)
...
%var_2_182 = add i64 %var_2_181, -348
...
%call2_40c9fc = tail call %struct.Memory* @sub_40c8a0._Z15tolerance_equalIfEbRT_S1_(%struct.State* %0, i64 %var_2_182, %struct.Memory* %call2_40c9de)
...
br i1 %var_2_196, label %block_.L_40ca24, label %block_40ca09
...
; Matched:%var_2_229:  %var_2_229 = add i64 %var_2_194, -49977
; %var_2_200 = add i64 %var_2_197, -49977
...
%var_2_205 = tail call %struct.Memory* @__remill_function_call(%struct.State* nonnull %0, i64 ptrtoint (i64 (i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64)* @printf to i64), %struct.Memory* %call2_40c9fc)
...
; Matched:%var_2_195:  %var_2_195 = phi i64 [ %var_2_194, %block_40c9a0 ], [ %.pre, %block_40ca09 ]
; %var_2_212 = phi i64 [ %var_2_197, %entry ], [ %.pre, %block_40ca09 ]
%MEMORY.0 = phi %struct.Memory* [ %call2_40c9fc, %entry ], [ %var_2_205, %block_40ca09 ]
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_movss_0x74c1__rip____xmm1(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 1, i64 1
  %4 = bitcast %union.VectorReg* %3 to i8*
  %5 = load i64, i64* %PC, align 8
  %6 = add i64 %5, ptrtoint (%G_0x74c1__rip__type* @G_0x74c1__rip_ to i64)
  %7 = add i64 %5, 8
  store i64 %7, i64* %PC, align 8
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_jne_.L_40ca24(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i8* nocapture %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
