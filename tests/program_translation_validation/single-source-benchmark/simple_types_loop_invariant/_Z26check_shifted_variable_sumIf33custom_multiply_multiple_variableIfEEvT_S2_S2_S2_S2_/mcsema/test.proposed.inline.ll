...
@G_0x71bd__rip__4246711_ = global %G_0x71bd__rip__4246711__type zeroinitializer
...
define %struct.Memory* @_Z26check_shifted_variable_sumIf33custom_multiply_multiple_variableIfEEvT_S2_S2_S2_S2_(%struct.State* noalias, i64, %struct.Memory* noalias) #2 {
entry:
  ...
  store %struct.Memory* %loadMem_40cc8e, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem1_40cca2, %struct.Memory** %MEMORY
  ...
  %329 = load float, float* bitcast (%G_0x71bd__rip__4246711__type* @G_0x71bd__rip__4246711_ to float*)
  ...
  store %struct.Memory* %loadMem1_40ccc0, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_40ccc7, %struct.Memory** %MEMORY
...
block_40cccd:                                     ; preds = %entry
  ...
  store %struct.Memory* %loadMem_40ccde, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem1_40cce0, %struct.Memory** %MEMORY
  %loadMem2_40cce0 = load %struct.Memory*, %struct.Memory** %MEMORY
  %loadPC_40cce0 = load i64, i64* %3
  %484 = call %struct.Memory* @__remill_function_call(%struct.State* %0, i64 ptrtoint (i64 (i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64)* @printf to i64), %struct.Memory* %loadMem2_40cce0)
...
block_.L_40cce8:                                  ; preds = %block_40cccd, %entry
  ...
  ret %struct.Memory* %loadMem_40cced
}
...
define %struct.Memory* @routine_movss_0x71bd__rip____xmm1(%struct.State* dereferenceable(3376), i64, %struct.Memory*) {
block_400478:
  %3 = getelementptr inbounds %struct.State, %struct.State* %0, i32 0, i32 6
  %4 = getelementptr inbounds %struct.GPR, %struct.GPR* %3, i32 0, i32 33
  %5 = getelementptr inbounds %struct.Reg, %struct.Reg* %4, i32 0, i32 0
