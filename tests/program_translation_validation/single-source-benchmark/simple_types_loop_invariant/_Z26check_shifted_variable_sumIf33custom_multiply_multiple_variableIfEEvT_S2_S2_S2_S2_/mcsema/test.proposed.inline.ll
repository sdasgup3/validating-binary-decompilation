...
entry:
  ...
  store %struct.Memory* %loadMem_40ccca, %struct.Memory** %MEMORY
  ...
  %311 = add i64 %310, ptrtoint (%G_0x71c1__rip__type* @G_0x71c1__rip_ to i64)
  ...
  store %struct.Memory* %loadMem1_40ccfc, %struct.Memory** %MEMORY
...
block_40cd09:                                     ; preds = %entry
  ...
  store %struct.Memory* %loadMem1_40cd1c, %struct.Memory** %MEMORY
  %loadMem2_40cd1c = load %struct.Memory*, %struct.Memory** %MEMORY
  %loadPC_40cd1c = load i64, i64* %3
  %470 = call %struct.Memory* @__remill_function_call(%struct.State* %0, i64 ptrtoint (i64 (i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64)* @printf to i64), %struct.Memory* %loadMem2_40cd1c)
...
block_.L_40cd24:                                  ; preds = %block_40cd09, %entry
  ...
  ret %struct.Memory* %loadMem_40cd29
}
