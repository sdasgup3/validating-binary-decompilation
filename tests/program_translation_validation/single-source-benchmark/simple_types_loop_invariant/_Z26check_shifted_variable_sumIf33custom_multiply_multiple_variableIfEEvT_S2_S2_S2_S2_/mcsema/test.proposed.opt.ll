...
block_40ccf9:                                     ; preds = %entry
  ...
  %205 = tail call %struct.Memory* @__remill_function_call(%struct.State* nonnull %0, i64 ptrtoint (i64 (i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64)* @printf to i64), %struct.Memory* %call2_40ccec)
...
block_.L_40cd14:                                  ; preds = %block_40ccf9, %entry
  %212 = phi i64 [ %197, %entry ], [ %.pre, %block_40ccf9 ]
  %MEMORY.0 = phi %struct.Memory* [ %call2_40ccec, %entry ], [ %205, %block_40ccf9 ]
