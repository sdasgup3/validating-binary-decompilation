...
define %struct.Memory* @_Z26check_shifted_variable_sumIf33custom_multiply_multiple_variableIfEEvT_S2_S2_S2_S2_(%struct.State* noalias, i64, %struct.Memory* noalias readnone) local_unnamed_addr #1 {
entry:
  ...
  %call2_40ccce = tail call %struct.Memory* @sub_40cc50._ZN33custom_multiply_multiple_variableIfE8do_shiftEfffff(%struct.State* %0, i64 %150, %struct.Memory* %2)
  ...
  %call2_40ccec = tail call %struct.Memory* @sub_40c890._Z15tolerance_equalIfEbRT_S1_(%struct.State* %0, i64 %182, %struct.Memory* %call2_40ccce)
  ...
  br i1 %196, label %block_.L_40cd14, label %block_40ccf9

block_40ccf9:                                     ; preds = %entry
  ...
  %call2_40cd0c = tail call %struct.Memory* @sub_4006c0.printf_plt(%struct.State* nonnull %0, i64 %200, %struct.Memory* %call2_40ccec)
...
block_.L_40cd14:                                  ; preds = %block_40ccf9, %entry
  %211 = phi i64 [ %197, %entry ], [ %.pre, %block_40ccf9 ]
  %MEMORY.0 = phi %struct.Memory* [ %call2_40ccec, %entry ], [ %call2_40cd0c, %block_40ccf9 ]
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_jne_.L_40cd14(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i8* nocapture %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
