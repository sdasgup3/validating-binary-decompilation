...
entry:
  ...
  %call2_40ccde = tail call %struct.Memory* @sub_40cc60._ZN33custom_multiply_multiple_variableIfE8do_shiftEfffff(%struct.State* %0, i64 %150, %struct.Memory* %2)
  ...
  %159 = add i64 %157, add (i64 ptrtoint (%G_0x71c1__rip__type* @G_0x71c1__rip_ to i64), i64 8)
  %160 = add i64 %157, 16
  ...
  %call2_40ccfc = tail call %struct.Memory* @sub_40c8a0._Z15tolerance_equalIfEbRT_S1_(%struct.State* %0, i64 %182, %struct.Memory* %call2_40ccde)
  ...
  br i1 %196, label %block_.L_40cd24, label %block_40cd09
...
block_40cd09:                                     ; preds = %entry
  ...
  %205 = tail call %struct.Memory* @__remill_function_call(%struct.State* nonnull %0, i64 ptrtoint (i64 (i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64)* @printf to i64), %struct.Memory* %call2_40ccfc)
...
block_.L_40cd24:                                  ; preds = %block_40cd09, %entry
  %212 = phi i64 [ %197, %entry ], [ %.pre, %block_40cd09 ]
  %MEMORY.0 = phi %struct.Memory* [ %call2_40ccfc, %entry ], [ %205, %block_40cd09 ]
