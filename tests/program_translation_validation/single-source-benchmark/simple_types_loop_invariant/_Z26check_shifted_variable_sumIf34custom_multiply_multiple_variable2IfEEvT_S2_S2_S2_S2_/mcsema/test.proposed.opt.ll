...
@G_0x728d__rip__4246503_ = local_unnamed_addr global %G_0x728d__rip__4246503__type zeroinitializer
...
entry:
  ...
  %call2_40cbd2 = tail call %struct.Memory* @sub_40cb50._ZN34custom_multiply_multiple_variable2IfE8do_shiftEfffff(%struct.State* %0, i64 %145, %struct.Memory* %2)
  ...
  %154 = load i32, i32* bitcast (%G_0x728d__rip__4246503__type* @G_0x728d__rip__4246503_ to i32*), align 8
  store i32 %154, i32* %102, align 1
  store float 0.000000e+00, float* %104, align 1
  store float 0.000000e+00, float* %106, align 1
  store float 0.000000e+00, float* %108, align 1
  %155 = load <2 x float>, <2 x float>* %51, align 1
  %156 = bitcast i64* %105 to <2 x i32>*
  %157 = load <2 x i32>, <2 x i32>* %156, align 1
  %158 = load <2 x float>, <2 x float>* %42, align 1
  %159 = extractelement <2 x float> %155, i32 0
  %160 = extractelement <2 x float> %158, i32 0
  %161 = fmul float %159, %160
  store float %161, float* %101, align 1
  %162 = bitcast <2 x float> %155 to <2 x i32>
  %163 = extractelement <2 x i32> %162, i32 1
  %164 = bitcast i8* %103 to i32*
  store i32 %163, i32* %164, align 1
  %165 = extractelement <2 x i32> %157, i32 0
  %166 = bitcast i64* %105 to i32*
  store i32 %165, i32* %166, align 1
  %167 = extractelement <2 x i32> %157, i32 1
  %168 = bitcast i8* %107 to i32*
  store i32 %167, i32* %168, align 1
  %169 = add i64 %152, 25
  store i64 %169, i64* %3, align 8
  %170 = load <2 x float>, <2 x float>* %51, align 1
  %171 = extractelement <2 x float> %170, i32 0
  %172 = inttoptr i64 %153 to float*
  ...
  %call2_40cbf0 = tail call %struct.Memory* @sub_40c860._Z15tolerance_equalIfEbRT_S1_(%struct.State* %0, i64 %174, %struct.Memory* %call2_40cbd2)
  %179 = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 1, i32 0
  %AL.i16 = bitcast %union.anon* %179 to i8*
  %180 = load i8, i8* %AL.i16, align 1
  ...
  %.v = select i1 %188, i64 35, i64 8
  %189 = add i64 %181, %.v
  store i64 %189, i64* %3, align 8
  br i1 %188, label %block_.L_40cc18, label %block_40cbfd

block_40cbfd:                                     ; preds = %entry
  store i64 ptrtoint (%G__0x414aee_type* @G__0x414aee to i64), i64* %RDI.i27, align 8
  %190 = load i32, i32* bitcast (%G_0x61a0a8_type* @G_0x61a0a8 to i32*), align 8
  %191 = zext i32 %190 to i64
  store i64 %191, i64* %RSI.i24, align 8
  store i8 0, i8* %AL.i16, align 1
  %192 = add i64 %189, -50557
  %193 = add i64 %189, 24
  ...
  %197 = tail call %struct.Memory* @__remill_function_call(%struct.State* %0, i64 ptrtoint (i64 (i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64)* @printf to i64), %struct.Memory* %call2_40cbf0)
  %EAX.i = bitcast %union.anon* %179 to i32*
  %198 = load i64, i64* %RBP.i, align 8
  %199 = add i64 %198, -28
  %200 = load i32, i32* %EAX.i, align 4
...
block_.L_40cc18:                                  ; preds = %block_40cbfd, %entry
  %204 = phi i64 [ %189, %entry ], [ %.pre, %block_40cbfd ]
  %MEMORY.0 = phi %struct.Memory* [ %call2_40cbf0, %entry ], [ %197, %block_40cbfd ]
  ...
  store i64 %231, i64* %RBP.i, align 8
...
define %struct.Memory* @routine_movss_0x728d__rip____xmm1(%struct.State* dereferenceable(3376), i64, %struct.Memory*) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 1, i64 1
  %4 = bitcast %union.VectorReg* %3 to i8*
  ...
  %6 = add i64 %5, 8
  store i64 %6, i64* %PC, align 8
  %7 = load i32, i32* bitcast (%G_0x728d__rip__4246503__type* @G_0x728d__rip__4246503_ to i32*), align 8
...
define %struct.Memory* @routine_jne_.L_40cc18(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i8* %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
