; ModuleID = '/tmp/tmp7et3e5yh-query.ll'
...
%call2_40cc0e = tail call %struct.Memory* @sub_40cb90._ZN34custom_multiply_multiple_variable2IfE8do_shiftEfffff(%struct.State* %0, i64 %var_2_150, %struct.Memory* %2)
...
%var_2_159 = add i64 %var_2_157, add (i64 ptrtoint (%G_0x7291__rip__type* @G_0x7291__rip_ to i64), i64 8)
...
%var_2_182 = add i64 %var_2_181, -908
...
%call2_40cc2c = tail call %struct.Memory* @sub_40c8a0._Z15tolerance_equalIfEbRT_S1_(%struct.State* %0, i64 %var_2_182, %struct.Memory* %call2_40cc0e)
...
br i1 %var_2_196, label %block_.L_40cc54, label %block_40cc39
...
; Matched:%var_2_229:  %var_2_229 = add i64 %var_2_194, -50537
; %var_2_200 = add i64 %var_2_197, -50537
...
%var_2_205 = tail call %struct.Memory* @__remill_function_call(%struct.State* nonnull %0, i64 ptrtoint (i64 (i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64)* @printf to i64), %struct.Memory* %call2_40cc2c)
...
; Matched:%var_2_195:  %var_2_195 = phi i64 [ %var_2_194, %block_40cbd0 ], [ %.pre, %block_40cc39 ]
; %var_2_212 = phi i64 [ %var_2_197, %entry ], [ %.pre, %block_40cc39 ]
%MEMORY.0 = phi %struct.Memory* [ %call2_40cc2c, %entry ], [ %var_2_205, %block_40cc39 ]
