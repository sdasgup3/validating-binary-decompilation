...
entry:
  ...
  store %struct.Memory* %loadMem1_4124b6, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem1_4124ce, %struct.Memory** %MEMORY
...
block_4124db:                                     ; preds = %entry
  ...
  store %struct.Memory* %loadMem1_4124ee, %struct.Memory** %MEMORY
  %loadMem2_4124ee = load %struct.Memory*, %struct.Memory** %MEMORY
  %loadPC_4124ee = load i64, i64* %3
  %410 = call %struct.Memory* @__remill_function_call(%struct.State* %0, i64 ptrtoint (i64 (i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64)* @printf to i64), %struct.Memory* %loadMem2_4124ee)
...
block_.L_4124f6:                                  ; preds = %block_4124db, %entry
  ...
  store %struct.Memory* %loadMem_4124fb, %struct.Memory** %MEMORY
  ret %struct.Memory* %loadMem_4124fb
}
...
define %struct.Memory* @routine_cvttsd2si_0x207bdc__rip____esi(%struct.State* dereferenceable(3376), i64, %struct.Memory*) {
block_400488:
  %3 = getelementptr inbounds %struct.State, %struct.State* %0, i32 0, i32 6
  %4 = getelementptr inbounds %struct.GPR, %struct.GPR* %3, i32 0, i32 33
  %5 = getelementptr inbounds %struct.Reg, %struct.Reg* %4, i32 0, i32 0
