...
block_412dfb:                                     ; preds = %entry
  ...
  %call2_412e0e = call %struct.Memory* @sub_4006c0.printf_plt(%struct.State* %0, i64 %loadPC_412e0e, %struct.Memory* %loadMem2_412e0e)
  store %struct.Memory* %call2_412e0e, %struct.Memory** %MEMORY
