...
block_4129eb:                                     ; preds = %entry
  ...
  %call2_4129fe = call %struct.Memory* @sub_4006c0.printf_plt(%struct.State* %0, i64 %loadPC_4129fe, %struct.Memory* %loadMem2_4129fe)
  store %struct.Memory* %call2_4129fe, %struct.Memory** %MEMORY
