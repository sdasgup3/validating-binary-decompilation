...
block_412c6b:                                     ; preds = %entry
  ...
  %call2_412c7e = call %struct.Memory* @sub_4006c0.printf_plt(%struct.State* %0, i64 %loadPC_412c7e, %struct.Memory* %loadMem2_412c7e)
  store %struct.Memory* %call2_412c7e, %struct.Memory** %MEMORY
