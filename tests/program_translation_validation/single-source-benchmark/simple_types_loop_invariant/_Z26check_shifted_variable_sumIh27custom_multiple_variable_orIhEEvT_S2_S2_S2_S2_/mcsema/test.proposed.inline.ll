...
entry:
  ...
  store %struct.Memory* %loadMem_4123c5, %struct.Memory** %MEMORY
...
block_412439:                                     ; preds = %entry
  ...
  %613 = call %struct.Memory* @__remill_function_call(%struct.State* %0, i64 ptrtoint (i64 (i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64)* @printf to i64), %struct.Memory* %loadMem2_41244c)
...
block_.L_412454:                                  ; preds = %block_412439, %entry
  ...
  ret %struct.Memory* %loadMem_41245a
}
...
define %struct.Memory* @routine_cvttsd2si_0x207c96__rip____ecx(%struct.State* dereferenceable(3376), i64, %struct.Memory*) {
block_400488:
  %3 = getelementptr inbounds %struct.State, %struct.State* %0, i32 0, i32 6
  %4 = getelementptr inbounds %struct.GPR, %struct.GPR* %3, i32 0, i32 33
  %5 = getelementptr inbounds %struct.Reg, %struct.Reg* %4, i32 0, i32 0
