...
block_412ee9:                                     ; preds = %entry
  ...
  %call2_412efc = call %struct.Memory* @sub_4006c0.printf_plt(%struct.State* %0, i64 %loadPC_412efc, %struct.Memory* %loadMem2_412efc)
  store %struct.Memory* %call2_412efc, %struct.Memory** %MEMORY
