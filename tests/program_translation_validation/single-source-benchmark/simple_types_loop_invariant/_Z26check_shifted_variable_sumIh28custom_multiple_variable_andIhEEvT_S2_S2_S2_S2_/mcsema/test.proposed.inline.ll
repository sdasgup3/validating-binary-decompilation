...
@G_0x207b36__rip__4269394_ = global %G_0x207b36__rip__4269394__type zeroinitializer
...
entry:
  ...
  store %struct.Memory* %loadMem_412525, %struct.Memory** %MEMORY
  ...
  %249 = load double, double* bitcast (%G_0x207b36__rip__4269394__type* @G_0x207b36__rip__4269394_ to double*)
  ...
  store %struct.Memory* %loadMem_41256b, %struct.Memory** %MEMORY
...
block_412599:                                     ; preds = %entry
  ...
  store %struct.Memory* %loadMem_4125aa, %struct.Memory** %MEMORY
  ...
  %611 = call %struct.Memory* @__remill_function_call(%struct.State* %0, i64 ptrtoint (i64 (i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64)* @printf to i64), %struct.Memory* %loadMem2_4125ac)
...
block_.L_4125b4:                                  ; preds = %block_412599, %entry
  ...
  store %struct.Memory* %loadMem_4125ba, %struct.Memory** %MEMORY
  ret %struct.Memory* %loadMem_4125ba
}
...
define %struct.Memory* @routine_cvttsd2si_0x207b36__rip____ecx(%struct.State* dereferenceable(3376), i64, %struct.Memory*) {
block_400478:
  %3 = getelementptr inbounds %struct.State, %struct.State* %0, i32 0, i32 6
  %4 = getelementptr inbounds %struct.GPR, %struct.GPR* %3, i32 0, i32 33
  %5 = getelementptr inbounds %struct.Reg, %struct.Reg* %4, i32 0, i32 0
