...
@G_0x207ea6__rip__4268514_ = local_unnamed_addr global %G_0x207ea6__rip__4268514__type zeroinitializer
...
entry:
  ...
  %89 = load double, double* bitcast (%G_0x207ea6__rip__4268514__type* @G_0x207ea6__rip__4268514_ to double*), align 8
  ...
  %call2_412204 = tail call %struct.Memory* @sub_412160._ZN28custom_multiple_variable_xorIhE8do_shiftEhhhhh(%struct.State* %0, i64 %120, %struct.Memory* %2)
  ...
  %call2_41221c = tail call %struct.Memory* @sub_412250._Z15tolerance_equalIhEbRT_S1_(%struct.State* %0, i64 %144, %struct.Memory* %call2_412204)
  ...
  br i1 %157, label %block_.L_412244, label %block_412229
...
block_412229:                                     ; preds = %entry
  ...
  %166 = tail call %struct.Memory* @__remill_function_call(%struct.State* %0, i64 ptrtoint (i64 (i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64)* @printf to i64), %struct.Memory* %call2_41221c)
...
block_.L_412244:                                  ; preds = %block_412229, %entry
  %173 = phi i64 [ %158, %entry ], [ %.pre, %block_412229 ]
  %MEMORY.0 = phi %struct.Memory* [ %call2_41221c, %entry ], [ %166, %block_412229 ]
...
define %struct.Memory* @routine_cvttsd2si_0x207ea6__rip____ecx(%struct.State* dereferenceable(3376), i64, %struct.Memory*) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  ...
  %5 = load double, double* bitcast (%G_0x207ea6__rip__4268514__type* @G_0x207ea6__rip__4268514_ to double*), align 8
...
define %struct.Memory* @routine_jne_.L_412244(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i8* %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
