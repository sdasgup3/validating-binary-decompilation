...
%G_0x2073a6__rip__4271330__type = type <{ [4 x i8] }>
...
@G_0x2073a6__rip__4271330_ = local_unnamed_addr global %G_0x2073a6__rip__4271330__type zeroinitializer
...
entry:
  ...
  %89 = load double, double* bitcast (%G_0x2073a6__rip__4271330__type* @G_0x2073a6__rip__4271330_ to double*), align 8
  ...
  %call2_412d04 = tail call %struct.Memory* @sub_412c60._ZN28custom_sub_multiple_variableIhE8do_shiftEhhhhh(%struct.State* %0, i64 %120, %struct.Memory* %2)
  ...
  %call2_412d1c = tail call %struct.Memory* @sub_412250._Z15tolerance_equalIhEbRT_S1_(%struct.State* %0, i64 %144, %struct.Memory* %call2_412d04)
  ...
  br i1 %157, label %block_.L_412d44, label %block_412d29
...
block_412d29:                                     ; preds = %entry
  ...
  %166 = tail call %struct.Memory* @__remill_function_call(%struct.State* %0, i64 ptrtoint (i64 (i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64)* @printf to i64), %struct.Memory* %call2_412d1c)
...
block_.L_412d44:                                  ; preds = %block_412d29, %entry
  %173 = phi i64 [ %158, %entry ], [ %.pre, %block_412d29 ]
  %MEMORY.0 = phi %struct.Memory* [ %call2_412d1c, %entry ], [ %166, %block_412d29 ]
...
define %struct.Memory* @routine_cvttsd2si_0x2073a6__rip____ecx(%struct.State* dereferenceable(3376), i64, %struct.Memory*) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  ...
  %5 = load double, double* bitcast (%G_0x2073a6__rip__4271330__type* @G_0x2073a6__rip__4271330_ to double*), align 8
