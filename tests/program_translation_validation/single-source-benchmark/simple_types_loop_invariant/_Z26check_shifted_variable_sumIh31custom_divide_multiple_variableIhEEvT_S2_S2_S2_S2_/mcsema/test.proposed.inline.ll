...
@G_0x2077b6__rip__4270290_ = global %G_0x2077b6__rip__4270290__type zeroinitializer
...
entry:
  ...
  store %struct.Memory* %loadMem_4128a0, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_4128af, %struct.Memory** %MEMORY
  ...
  store i8 %201, i8* %205
  store %struct.Memory* %loadMem_4128bf, %struct.Memory** %MEMORY
  ...
  store i8 %235, i8* %239
  store %struct.Memory* %loadMem_4128c7, %struct.Memory** %MEMORY
  ...
  %249 = load double, double* bitcast (%G_0x2077b6__rip__4270290__type* @G_0x2077b6__rip__4270290_ to double*)
  ...
  store %struct.Memory* %loadMem_4128ca, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_4128d8, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_4128e3, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_4128e7, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem1_4128f4, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_4128fd, %struct.Memory** %MEMORY
  ...
  store i8 %509, i8* %513
  store %struct.Memory* %loadMem_412909, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem1_41290c, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_412911, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_412913, %struct.Memory** %MEMORY
...
block_412919:                                     ; preds = %entry
  ...
  store %struct.Memory* %loadMem_412919, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_41292a, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem1_41292c, %struct.Memory** %MEMORY
  %loadMem2_41292c = load %struct.Memory*, %struct.Memory** %MEMORY
  %loadPC_41292c = load i64, i64* %3
  %611 = call %struct.Memory* @__remill_function_call(%struct.State* %0, i64 ptrtoint (i64 (i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64)* @printf to i64), %struct.Memory* %loadMem2_41292c)
...
block_.L_412934:                                  ; preds = %block_412919, %entry
  ...
  store %struct.Memory* %loadMem_41293a, %struct.Memory** %MEMORY
  ret %struct.Memory* %loadMem_41293a
}
...
define %struct.Memory* @routine_cvttsd2si_0x2077b6__rip____ecx(%struct.State* dereferenceable(3376), i64, %struct.Memory*) {
block_400478:
  %3 = getelementptr inbounds %struct.State, %struct.State* %0, i32 0, i32 6
  %4 = getelementptr inbounds %struct.GPR, %struct.GPR* %3, i32 0, i32 33
  %5 = getelementptr inbounds %struct.Reg, %struct.Reg* %4, i32 0, i32 0
