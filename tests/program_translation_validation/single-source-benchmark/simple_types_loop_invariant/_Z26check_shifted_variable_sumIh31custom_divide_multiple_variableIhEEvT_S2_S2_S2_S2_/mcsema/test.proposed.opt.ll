...
@G_0x2077b6__rip__4270290_ = local_unnamed_addr global %G_0x2077b6__rip__4270290__type zeroinitializer
...
declare %struct.Memory* @sub_412850._ZN31custom_divide_multiple_variableIhE8do_shiftEhhhhh(%struct.State* noalias dereferenceable(3376), i64, %struct.Memory* noalias readnone returned) local_unnamed_addr
...
define %struct.Memory* @_Z26check_shifted_variable_sumIh31custom_divide_multiple_variableIhEEvT_S2_S2_S2_S2_(%struct.State* noalias, i64, %struct.Memory* noalias) local_unnamed_addr #1 {
entry:
  ...
  %89 = load double, double* bitcast (%G_0x2077b6__rip__4270290__type* @G_0x2077b6__rip__4270290_ to double*), align 8
  ...
  %call2_4128f4 = tail call %struct.Memory* @sub_412850._ZN31custom_divide_multiple_variableIhE8do_shiftEhhhhh(%struct.State* %0, i64 %120, %struct.Memory* %2)
  ...
  %call2_41290c = tail call %struct.Memory* @sub_412250._Z15tolerance_equalIhEbRT_S1_(%struct.State* %0, i64 %144, %struct.Memory* %call2_4128f4)
  ...
  br i1 %157, label %block_.L_412934, label %block_412919
...
block_412919:                                     ; preds = %entry
  ...
  %166 = tail call %struct.Memory* @__remill_function_call(%struct.State* %0, i64 ptrtoint (i64 (i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64)* @printf to i64), %struct.Memory* %call2_41290c)
...
block_.L_412934:                                  ; preds = %block_412919, %entry
  %173 = phi i64 [ %158, %entry ], [ %.pre, %block_412919 ]
  %MEMORY.0 = phi %struct.Memory* [ %call2_41290c, %entry ], [ %166, %block_412919 ]
...
define %struct.Memory* @routine_cvttsd2si_0x2077b6__rip____ecx(%struct.State* dereferenceable(3376), i64, %struct.Memory*) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  ...
  %5 = load double, double* bitcast (%G_0x2077b6__rip__4270290__type* @G_0x2077b6__rip__4270290_ to double*), align 8
...
define %struct.Memory* @routine_callq_._ZN31custom_divide_multiple_variableIhE8do_shiftEhhhhh(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
...
define %struct.Memory* @routine_jne_.L_412934(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i8* %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
