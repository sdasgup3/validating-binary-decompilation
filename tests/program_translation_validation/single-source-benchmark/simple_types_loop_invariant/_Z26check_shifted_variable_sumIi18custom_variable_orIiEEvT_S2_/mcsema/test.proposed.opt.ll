...
define %struct.Memory* @_Z26check_shifted_variable_sumIi18custom_variable_orIiEEvT_S2_(%struct.State* noalias, i64, %struct.Memory* noalias) local_unnamed_addr #1 {
entry:
  ...
  %call2_40f8da = tail call %struct.Memory* @sub_40f8a0._ZN18custom_variable_orIiE8do_shiftEii(%struct.State* %0, i64 %66, %struct.Memory* %2)
  ...
  %call2_40f8f0 = tail call %struct.Memory* @sub_40f740._Z15tolerance_equalIiEbRT_S1_(%struct.State* %0, i64 %95, %struct.Memory* %call2_40f8da)
  ...
  br i1 %108, label %block_.L_40f918, label %block_40f8fd
...
block_40f8fd:                                     ; preds = %entry
  ...
  %117 = tail call %struct.Memory* @__remill_function_call(%struct.State* %0, i64 ptrtoint (i64 (i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64)* @printf to i64), %struct.Memory* %call2_40f8f0)
...
block_.L_40f918:                                  ; preds = %block_40f8fd, %entry
  %124 = phi i64 [ %109, %entry ], [ %.pre, %block_40f8fd ]
  %MEMORY.0 = phi %struct.Memory* [ %call2_40f8f0, %entry ], [ %117, %block_40f8fd ]
...
define %struct.Memory* @routine_jne_.L_40f918(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i8* %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
