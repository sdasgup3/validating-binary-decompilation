...
define %struct.Memory* @_Z26check_shifted_variable_sumIi19custom_add_variableIiEEvT_S2_(%struct.State* noalias, i64, %struct.Memory* noalias) #2 {
entry:
  ...
  store i32 %94, i32* %98
  store %struct.Memory* %loadMem_4100eb, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_4100ee, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem1_410110, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_410117, %struct.Memory** %MEMORY
...
block_41011d:                                     ; preds = %entry
  ...
  store %struct.Memory* %loadMem_41011d, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_41012e, %struct.Memory** %MEMORY
  ...
  %318 = call %struct.Memory* @__remill_function_call(%struct.State* %0, i64 ptrtoint (i64 (i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64)* @printf to i64), %struct.Memory* %loadMem2_410130)
...
block_.L_410138:                                  ; preds = %block_41011d, %entry
  ...
  ret %struct.Memory* %loadMem_41013d
}
