...
entry:
  ...
  %call2_4100d0 = tail call %struct.Memory* @sub_40f740._Z15tolerance_equalIiEbRT_S1_(%struct.State* %0, i64 %96, %struct.Memory* %call2_4100ba)
  ...
  br i1 %109, label %block_.L_4100f8, label %block_4100dd
...
block_4100dd:                                     ; preds = %entry
  ...
  %118 = tail call %struct.Memory* @__remill_function_call(%struct.State* %0, i64 ptrtoint (i64 (i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64)* @printf to i64), %struct.Memory* %call2_4100d0)
...
block_.L_4100f8:                                  ; preds = %block_4100dd, %entry
  %125 = phi i64 [ %110, %entry ], [ %.pre, %block_4100dd ]
  %MEMORY.0 = phi %struct.Memory* [ %call2_4100d0, %entry ], [ %118, %block_4100dd ]
