...
entry:
  ...
  store %struct.Memory* %loadMem1_40ffaa, %struct.Memory** %MEMORY
...
block_40ffcd:                                     ; preds = %entry
  ...
  store %struct.Memory* %loadMem1_40ffe0, %struct.Memory** %MEMORY
  %loadMem2_40ffe0 = load %struct.Memory*, %struct.Memory** %MEMORY
  %loadPC_40ffe0 = load i64, i64* %3
  %318 = call %struct.Memory* @__remill_function_call(%struct.State* %0, i64 ptrtoint (i64 (i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64)* @printf to i64), %struct.Memory* %loadMem2_40ffe0)
...
block_.L_40ffe8:                                  ; preds = %block_40ffcd, %entry
  ...
  store %struct.Memory* %loadMem_40ffe8, %struct.Memory** %MEMORY
  ...
  ret %struct.Memory* %loadMem_40ffed
}
