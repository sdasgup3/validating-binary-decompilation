...
entry:
  ...
  store i32 %94, i32* %98
  store %struct.Memory* %loadMem_40ffdb, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem1_40ffea, %struct.Memory** %MEMORY
...
block_41000d:                                     ; preds = %entry
  ...
  store %struct.Memory* %loadMem_41001e, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem1_410020, %struct.Memory** %MEMORY
  %loadMem2_410020 = load %struct.Memory*, %struct.Memory** %MEMORY
  %loadPC_410020 = load i64, i64* %3
  %318 = call %struct.Memory* @__remill_function_call(%struct.State* %0, i64 ptrtoint (i64 (i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64)* @printf to i64), %struct.Memory* %loadMem2_410020)
...
block_.L_410028:                                  ; preds = %block_41000d, %entry
  ...
  ret %struct.Memory* %loadMem_41002d
}
