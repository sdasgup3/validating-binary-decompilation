...
entry:
  ...
  %call2_40fa20 = tail call %struct.Memory* @sub_40f740._Z15tolerance_equalIiEbRT_S1_(%struct.State* %0, i64 %95, %struct.Memory* %call2_40fa0a)
  ...
  br i1 %108, label %block_.L_40fa48, label %block_40fa2d
...
block_40fa2d:                                     ; preds = %entry
  ...
  %117 = tail call %struct.Memory* @__remill_function_call(%struct.State* %0, i64 ptrtoint (i64 (i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64)* @printf to i64), %struct.Memory* %call2_40fa20)
...
block_.L_40fa48:                                  ; preds = %block_40fa2d, %entry
  %124 = phi i64 [ %109, %entry ], [ %.pre, %block_40fa2d ]
  %MEMORY.0 = phi %struct.Memory* [ %call2_40fa20, %entry ], [ %117, %block_40fa2d ]
