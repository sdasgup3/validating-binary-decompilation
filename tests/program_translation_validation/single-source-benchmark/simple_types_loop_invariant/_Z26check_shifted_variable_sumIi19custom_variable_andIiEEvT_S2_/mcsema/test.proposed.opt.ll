...
declare %struct.Memory* @sub_40f9d0._ZN19custom_variable_andIiE8do_shiftEii(%struct.State* noalias dereferenceable(3376), i64, %struct.Memory* noalias readnone returned) local_unnamed_addr
...
entry:
  ...
  %call2_40fa0a = tail call %struct.Memory* @sub_40f9d0._ZN19custom_variable_andIiE8do_shiftEii(%struct.State* %0, i64 %66, %struct.Memory* %2)
  ...
  %call2_40fa20 = tail call %struct.Memory* @sub_40f740._Z15tolerance_equalIiEbRT_S1_(%struct.State* %0, i64 %96, %struct.Memory* %call2_40fa0a)
  ...
  br i1 %109, label %block_.L_40fa48, label %block_40fa2d

block_40fa2d:                                     ; preds = %entry
  ...
  %118 = tail call %struct.Memory* @__remill_function_call(%struct.State* %0, i64 ptrtoint (i64 (i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64)* @printf to i64), %struct.Memory* %call2_40fa20)
  ...
  br label %block_.L_40fa48

block_.L_40fa48:                                  ; preds = %block_40fa2d, %entry
  %125 = phi i64 [ %110, %entry ], [ %.pre, %block_40fa2d ]
  %MEMORY.0 = phi %struct.Memory* [ %call2_40fa20, %entry ], [ %118, %block_40fa2d ]
...
define %struct.Memory* @routine_callq_._ZN19custom_variable_andIiE8do_shiftEii(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
...
define %struct.Memory* @routine_jne_.L_40fa48(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i8* %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
