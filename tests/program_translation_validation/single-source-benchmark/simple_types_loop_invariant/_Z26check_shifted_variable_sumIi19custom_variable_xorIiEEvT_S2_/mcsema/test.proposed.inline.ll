...
define %struct.Memory* @_Z26check_shifted_variable_sumIi19custom_variable_xorIiEEvT_S2_(%struct.State* noalias, i64, %struct.Memory* noalias) #2 {
entry:
  ...
  store i32 %78, i32* %82
  store %struct.Memory* %loadMem_40f7d8, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_40f7de, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_40f7e7, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem1_40f7ea, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_40f7f3, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_40f7f7, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem1_40f800, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_40f805, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_40f807, %struct.Memory** %MEMORY
...
block_40f80d:                                     ; preds = %entry
  ...
  store %struct.Memory* %loadMem_40f80d, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_40f817, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_40f81e, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem1_40f820, %struct.Memory** %MEMORY
  %loadMem2_40f820 = load %struct.Memory*, %struct.Memory** %MEMORY
  %loadPC_40f820 = load i64, i64* %3
  %318 = call %struct.Memory* @__remill_function_call(%struct.State* %0, i64 ptrtoint (i64 (i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64)* @printf to i64), %struct.Memory* %loadMem2_40f820)
...
block_.L_40f828:                                  ; preds = %block_40f80d, %entry
  ...
  store %struct.Memory* %loadMem_40f82d, %struct.Memory** %MEMORY
  ret %struct.Memory* %loadMem_40f82d
}
