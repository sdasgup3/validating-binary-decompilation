...
entry:
  ...
  store %struct.Memory* %loadMem_40f794, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem1_40f7aa, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem1_40f7c0, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_40f7c7, %struct.Memory** %MEMORY
...
block_40f7cd:                                     ; preds = %entry
  ...
  store %struct.Memory* %loadMem_40f7cd, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem1_40f7e0, %struct.Memory** %MEMORY
  %loadMem2_40f7e0 = load %struct.Memory*, %struct.Memory** %MEMORY
  %loadPC_40f7e0 = load i64, i64* %3
  %318 = call %struct.Memory* @__remill_function_call(%struct.State* %0, i64 ptrtoint (i64 (i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64)* @printf to i64), %struct.Memory* %loadMem2_40f7e0)
...
block_.L_40f7e8:                                  ; preds = %block_40f7cd, %entry
  ...
  store %struct.Memory* %loadMem_40f7ec, %struct.Memory** %MEMORY
  ...
  ret %struct.Memory* %loadMem_40f7ed
}
