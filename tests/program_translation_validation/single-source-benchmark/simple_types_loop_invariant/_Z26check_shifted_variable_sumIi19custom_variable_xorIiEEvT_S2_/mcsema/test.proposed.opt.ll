...
entry:
  ...
  %call2_40f7ea = tail call %struct.Memory* @sub_40f7b0._ZN19custom_variable_xorIiE8do_shiftEii(%struct.State* %0, i64 %66, %struct.Memory* %2)
  ...
  %call2_40f800 = tail call %struct.Memory* @sub_40f780._Z15tolerance_equalIiEbRT_S1_(%struct.State* %0, i64 %96, %struct.Memory* %call2_40f7ea)
  ...
  br i1 %109, label %block_.L_40f828, label %block_40f80d

block_40f80d:                                     ; preds = %entry
  ...
  %118 = tail call %struct.Memory* @__remill_function_call(%struct.State* nonnull %0, i64 ptrtoint (i64 (i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64)* @printf to i64), %struct.Memory* %call2_40f800)
...
block_.L_40f828:                                  ; preds = %block_40f80d, %entry
  %125 = phi i64 [ %110, %entry ], [ %.pre, %block_40f80d ]
  %MEMORY.0 = phi %struct.Memory* [ %call2_40f800, %entry ], [ %118, %block_40f80d ]
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_jne_.L_40f828(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i8* nocapture %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
