...
entry:
  ...
  store %struct.Memory* %loadMem_40fc84, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem1_40fcb0, %struct.Memory** %MEMORY
...
block_40fcbd:                                     ; preds = %entry
  ...
  store %struct.Memory* %loadMem1_40fcd0, %struct.Memory** %MEMORY
  %loadMem2_40fcd0 = load %struct.Memory*, %struct.Memory** %MEMORY
  %loadPC_40fcd0 = load i64, i64* %3
  %318 = call %struct.Memory* @__remill_function_call(%struct.State* %0, i64 ptrtoint (i64 (i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64)* @printf to i64), %struct.Memory* %loadMem2_40fcd0)
...
block_.L_40fcd8:                                  ; preds = %block_40fcbd, %entry
  ...
  ret %struct.Memory* %loadMem_40fcdd
}
