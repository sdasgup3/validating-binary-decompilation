...
entry:
  ...
  %call2_40fcb0 = tail call %struct.Memory* @sub_40f740._Z15tolerance_equalIiEbRT_S1_(%struct.State* %0, i64 %96, %struct.Memory* %call2_40fc9a)
  ...
  br i1 %109, label %block_.L_40fcd8, label %block_40fcbd
...
block_40fcbd:                                     ; preds = %entry
  ...
  %118 = tail call %struct.Memory* @__remill_function_call(%struct.State* %0, i64 ptrtoint (i64 (i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64)* @printf to i64), %struct.Memory* %call2_40fcb0)
...
block_.L_40fcd8:                                  ; preds = %block_40fcbd, %entry
  %125 = phi i64 [ %110, %entry ], [ %.pre, %block_40fcbd ]
  %MEMORY.0 = phi %struct.Memory* [ %call2_40fcb0, %entry ], [ %118, %block_40fcbd ]
