...
entry:
  ...
  %call2_40fe90 = tail call %struct.Memory* @sub_40f740._Z15tolerance_equalIiEbRT_S1_(%struct.State* %0, i64 %95, %struct.Memory* %call2_40fe7a)
  %AL.i16 = bitcast %union.anon* %75 to i8*
  %100 = load i8, i8* %AL.i16, align 1
  ...
  br i1 %108, label %block_.L_40feb8, label %block_40fe9d
...
block_40fe9d:                                     ; preds = %entry
  ...
  store i64 %111, i64* %RSI.i31, align 8
  store i8 0, i8* %AL.i16, align 1
  %112 = add i64 %109, -63517
  %113 = add i64 %109, 24
  ...
  %117 = tail call %struct.Memory* @__remill_function_call(%struct.State* %0, i64 ptrtoint (i64 (i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64)* @printf to i64), %struct.Memory* %call2_40fe90)
  %118 = load i64, i64* %RBP.i, align 8
  %119 = add i64 %118, -16
  %120 = load i32, i32* %EAX.i22, align 4
...
block_.L_40feb8:                                  ; preds = %block_40fe9d, %entry
  %124 = phi i64 [ %109, %entry ], [ %.pre, %block_40fe9d ]
  %MEMORY.0 = phi %struct.Memory* [ %call2_40fe90, %entry ], [ %117, %block_40fe9d ]
