...
declare %struct.Memory* @sub_40fe80._ZN24custom_multiply_variableIiE8do_shiftEii(%struct.State* noalias dereferenceable(3376), i64, %struct.Memory* noalias readnone returned) local_unnamed_addr
...
entry:
  ...
  %call2_40feba = tail call %struct.Memory* @sub_40fe80._ZN24custom_multiply_variableIiE8do_shiftEii(%struct.State* %0, i64 %66, %struct.Memory* %2)
  ...
  %call2_40fed0 = tail call %struct.Memory* @sub_40f780._Z15tolerance_equalIiEbRT_S1_(%struct.State* %0, i64 %96, %struct.Memory* %call2_40feba)
  ...
  br i1 %109, label %block_.L_40fef8, label %block_40fedd

block_40fedd:                                     ; preds = %entry
  ...
  %118 = tail call %struct.Memory* @__remill_function_call(%struct.State* nonnull %0, i64 ptrtoint (i64 (i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64)* @printf to i64), %struct.Memory* %call2_40fed0)
  ...
  br label %block_.L_40fef8

block_.L_40fef8:                                  ; preds = %block_40fedd, %entry
  %125 = phi i64 [ %110, %entry ], [ %.pre, %block_40fedd ]
  %MEMORY.0 = phi %struct.Memory* [ %call2_40fed0, %entry ], [ %118, %block_40fedd ]
