...
declare %struct.Memory* @sub_40fe40._ZN24custom_multiply_variableIiE8do_shiftEii(%struct.State* noalias dereferenceable(3376), i64, %struct.Memory* noalias readnone returned) local_unnamed_addr
...
entry:
  ...
  %53 = load double, double* bitcast (%G_0x61a088_type* @G_0x61a088 to double*), align 8
  ...
  %call2_40fe7a = tail call %struct.Memory* @sub_40fe40._ZN24custom_multiply_variableIiE8do_shiftEii(%struct.State* %0, i64 %66, %struct.Memory* %2)
  ...
  %call2_40fe90 = tail call %struct.Memory* @sub_40f740._Z15tolerance_equalIiEbRT_S1_(%struct.State* %0, i64 %96, %struct.Memory* %call2_40fe7a)
  ...
  br i1 %109, label %block_.L_40feb8, label %block_40fe9d

block_40fe9d:                                     ; preds = %entry
  store i64 ptrtoint (%G__0x414aee_type* @G__0x414aee to i64), i64* %RDI.i34, align 8
  %111 = load i32, i32* bitcast (%G_0x61a0a8_type* @G_0x61a0a8 to i32*), align 8
  %112 = zext i32 %111 to i64
  store i64 %112, i64* %RSI.i31, align 8
  store i8 0, i8* %AL.i16, align 1
  %113 = add i64 %110, -63517
  %114 = add i64 %110, 24
  ...
  %118 = tail call %struct.Memory* @__remill_function_call(%struct.State* %0, i64 ptrtoint (i64 (i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64)* @printf to i64), %struct.Memory* %call2_40fe90)
  ...
  br label %block_.L_40feb8

block_.L_40feb8:                                  ; preds = %block_40fe9d, %entry
  %125 = phi i64 [ %110, %entry ], [ %.pre, %block_40fe9d ]
  %MEMORY.0 = phi %struct.Memory* [ %call2_40fe90, %entry ], [ %118, %block_40fe9d ]
  %126 = load i64, i64* %RSP.i8, align 8
  %127 = add i64 %126, 16
  store i64 %127, i64* %RSP.i8, align 8
...
define %struct.Memory* @routine_callq_._ZN24custom_multiply_variableIiE8do_shiftEii(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
...
define %struct.Memory* @routine_jne_.L_40feb8(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i8* %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
