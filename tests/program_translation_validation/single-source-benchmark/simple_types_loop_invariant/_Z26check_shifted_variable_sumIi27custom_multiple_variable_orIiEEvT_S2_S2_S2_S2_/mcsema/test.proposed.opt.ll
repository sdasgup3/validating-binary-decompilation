...
entry:
  ...
  %call2_40f87e = tail call %struct.Memory* @sub_40f820._ZN27custom_multiple_variable_orIiE8do_shiftEiiiii(%struct.State* %0, i64 %102, %struct.Memory* %2)
  ...
  %call2_40f894 = tail call %struct.Memory* @sub_40f770._Z15tolerance_equalIiEbRT_S1_(%struct.State* %0, i64 %132, %struct.Memory* %call2_40f87e)
  ...
  br i1 %145, label %block_.L_40f8bc, label %block_40f8a1
...
block_40f8a1:                                     ; preds = %entry
  ...
  %154 = tail call %struct.Memory* @__remill_function_call(%struct.State* nonnull %0, i64 ptrtoint (i64 (i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64)* @printf to i64), %struct.Memory* %call2_40f894)
...
block_.L_40f8bc:                                  ; preds = %block_40f8a1, %entry
  %161 = phi i64 [ %146, %entry ], [ %.pre, %block_40f8a1 ]
  %MEMORY.0 = phi %struct.Memory* [ %call2_40f894, %entry ], [ %154, %block_40f8a1 ]
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_jne_.L_40f8bc(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i8* nocapture %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
