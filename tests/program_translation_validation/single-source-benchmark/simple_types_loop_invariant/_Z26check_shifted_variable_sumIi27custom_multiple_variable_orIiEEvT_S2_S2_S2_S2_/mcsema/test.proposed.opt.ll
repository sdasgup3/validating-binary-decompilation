...
define %struct.Memory* @_Z26check_shifted_variable_sumIi27custom_multiple_variable_orIiEEvT_S2_S2_S2_S2_(%struct.State* noalias, i64, %struct.Memory* noalias readnone) local_unnamed_addr #1 {
entry:
...
block_40f8a1:                                     ; preds = %entry
  ...
  %call2_40f8b4 = tail call %struct.Memory* @sub_4006c0.printf_plt(%struct.State* nonnull %0, i64 %149, %struct.Memory* %call2_40f894)
...
block_.L_40f8bc:                                  ; preds = %block_40f8a1, %entry
  %160 = phi i64 [ %146, %entry ], [ %.pre, %block_40f8a1 ]
  %MEMORY.0 = phi %struct.Memory* [ %call2_40f894, %entry ], [ %call2_40f8b4, %block_40f8a1 ]
