...
entry:
  ...
  %loadMem_41002e = load %struct.Memory*, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_41002e, %struct.Memory** %MEMORY
  ...
  %loadMem1_41004e = load %struct.Memory*, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem1_41004e, %struct.Memory** %MEMORY
  %loadMem2_41004e = load %struct.Memory*, %struct.Memory** %MEMORY
  %loadPC_41004e = load i64, i64* %3
  %call2_41004e = call %struct.Memory* @sub_40fff0._ZN28custom_add_multiple_variableIiE8do_shiftEiiiii(%struct.State* %0, i64 %loadPC_41004e, %struct.Memory* %loadMem2_41004e)
  store %struct.Memory* %call2_41004e, %struct.Memory** %MEMORY
  ...
  %loadMem1_410064 = load %struct.Memory*, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem1_410064, %struct.Memory** %MEMORY
  %loadMem2_410064 = load %struct.Memory*, %struct.Memory** %MEMORY
  %loadPC_410064 = load i64, i64* %3
  %call2_410064 = call %struct.Memory* @sub_40f740._Z15tolerance_equalIiEbRT_S1_(%struct.State* %0, i64 %loadPC_410064, %struct.Memory* %loadMem2_410064)
  store %struct.Memory* %call2_410064, %struct.Memory** %MEMORY
  ...
  %loadBr_41006b = load i8, i8* %BRANCH_TAKEN
  %cmpBr_41006b = icmp eq i8 %loadBr_41006b, 1
  br i1 %cmpBr_41006b, label %block_.L_41008c, label %block_410071

block_410071:                                     ; preds = %entry
  ...
  %loadMem1_410084 = load %struct.Memory*, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem1_410084, %struct.Memory** %MEMORY
  %loadMem2_410084 = load %struct.Memory*, %struct.Memory** %MEMORY
  %loadPC_410084 = load i64, i64* %3
  %415 = call %struct.Memory* @__remill_function_call(%struct.State* %0, i64 ptrtoint (i64 (i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64)* @printf to i64), %struct.Memory* %loadMem2_410084)
  ...
  br label %block_.L_41008c

block_.L_41008c:                                  ; preds = %block_410071, %entry
  ...
  ret %struct.Memory* %loadMem_410091
}
...
define %struct.Memory* @routine_jne_.L_41008c(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i8* %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) {
block_400478:
  %3 = getelementptr inbounds %struct.State, %struct.State* %0, i32 0, i32 6
  %4 = getelementptr inbounds %struct.GPR, %struct.GPR* %3, i32 0, i32 33
  %5 = getelementptr inbounds %struct.Reg, %struct.Reg* %4, i32 0, i32 0
