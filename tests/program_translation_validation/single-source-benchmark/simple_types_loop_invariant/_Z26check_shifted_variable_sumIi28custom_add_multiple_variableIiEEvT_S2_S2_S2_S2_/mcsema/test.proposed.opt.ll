...
declare %struct.Memory* @sub_410020._ZN28custom_add_multiple_variableIiE8do_shiftEiiiii(%struct.State* dereferenceable(3376), i64, %struct.Memory*) local_unnamed_addr
