...
define %struct.Memory* @_Z26check_shifted_variable_sumIi28custom_add_multiple_variableIiEEvT_S2_S2_S2_S2_(%struct.State* noalias, i64, %struct.Memory* noalias readnone) local_unnamed_addr #1 {
entry:
...
block_4100a1:                                     ; preds = %entry
  ...
  %call2_4100b4 = tail call %struct.Memory* @sub_4006c0.printf_plt(%struct.State* nonnull %0, i64 %149, %struct.Memory* %call2_410094)
...
block_.L_4100bc:                                  ; preds = %block_4100a1, %entry
  %160 = phi i64 [ %146, %entry ], [ %.pre, %block_4100a1 ]
  %MEMORY.0 = phi %struct.Memory* [ %call2_410094, %entry ], [ %call2_4100b4, %block_4100a1 ]
