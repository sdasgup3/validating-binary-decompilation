...
define %struct.Memory* @_Z26check_shifted_variable_sumIi28custom_multiple_variable_andIiEEvT_S2_S2_S2_S2_(%struct.State* noalias, i64, %struct.Memory* noalias) #2 {
entry:
  ...
  store %struct.Memory* %loadMem_40f981, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_40f984, %struct.Memory** %MEMORY
  ...
  store i32 %78, i32* %82
  store %struct.Memory* %loadMem_40f988, %struct.Memory** %MEMORY
  ...
  store i32 %94, i32* %98
  store %struct.Memory* %loadMem_40f98b, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_40f998, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem1_40f9ae, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_40f9b3, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_40f9b7, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_40f9bb, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_40f9c1, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem1_40f9c4, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_40f9c9, %struct.Memory** %MEMORY
...
block_40f9d1:                                     ; preds = %entry
  ...
  store %struct.Memory* %loadMem_40f9db, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem1_40f9e4, %struct.Memory** %MEMORY
  %loadMem2_40f9e4 = load %struct.Memory*, %struct.Memory** %MEMORY
  %loadPC_40f9e4 = load i64, i64* %3
  %415 = call %struct.Memory* @__remill_function_call(%struct.State* %0, i64 ptrtoint (i64 (i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64)* @printf to i64), %struct.Memory* %loadMem2_40f9e4)
  ...
  store %struct.Memory* %loadMem_40f9e9, %struct.Memory** %MEMORY
...
block_.L_40f9ec:                                  ; preds = %block_40f9d1, %entry
  ...
  store %struct.Memory* %loadMem_40f9f0, %struct.Memory** %MEMORY
  ...
  ret %struct.Memory* %loadMem_40f9f1
}
