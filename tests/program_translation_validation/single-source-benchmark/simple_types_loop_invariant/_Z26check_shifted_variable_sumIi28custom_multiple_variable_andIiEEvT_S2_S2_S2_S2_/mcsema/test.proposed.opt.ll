...
define %struct.Memory* @_Z26check_shifted_variable_sumIi28custom_multiple_variable_andIiEEvT_S2_S2_S2_S2_(%struct.State* noalias, i64, %struct.Memory* noalias readnone) local_unnamed_addr #1 {
entry:
...
block_40f9d1:                                     ; preds = %entry
  ...
  %call2_40f9e4 = tail call %struct.Memory* @sub_4006c0.printf_plt(%struct.State* nonnull %0, i64 %149, %struct.Memory* %call2_40f9c4)
...
block_.L_40f9ec:                                  ; preds = %block_40f9d1, %entry
  %160 = phi i64 [ %146, %entry ], [ %.pre, %block_40f9d1 ]
  %MEMORY.0 = phi %struct.Memory* [ %call2_40f9c4, %entry ], [ %call2_40f9e4, %block_40f9d1 ]
