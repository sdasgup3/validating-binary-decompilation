...
define %struct.Memory* @_Z26check_shifted_variable_sumIi28custom_multiple_variable_xorIiEEvT_S2_S2_S2_S2_(%struct.State* noalias, i64, %struct.Memory* noalias readnone) local_unnamed_addr #1 {
entry:
...
block_40f741:                                     ; preds = %entry
  ...
  %call2_40f754 = tail call %struct.Memory* @sub_4006c0.printf_plt(%struct.State* nonnull %0, i64 %149, %struct.Memory* %call2_40f734)
...
block_.L_40f75c:                                  ; preds = %block_40f741, %entry
  %160 = phi i64 [ %146, %entry ], [ %.pre, %block_40f741 ]
  %MEMORY.0 = phi %struct.Memory* [ %call2_40f734, %entry ], [ %call2_40f754, %block_40f741 ]
