...
entry:
  ...
  %call2_40ff5e = tail call %struct.Memory* @sub_40ff00._ZN28custom_sub_multiple_variableIiE8do_shiftEiiiii(%struct.State* %0, i64 %102, %struct.Memory* %2)
  ...
  %call2_40ff74 = tail call %struct.Memory* @sub_40f780._Z15tolerance_equalIiEbRT_S1_(%struct.State* %0, i64 %132, %struct.Memory* %call2_40ff5e)
  ...
  br i1 %145, label %block_.L_40ff9c, label %block_40ff81
...
block_40ff81:                                     ; preds = %entry
  ...
  %154 = tail call %struct.Memory* @__remill_function_call(%struct.State* nonnull %0, i64 ptrtoint (i64 (i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64)* @printf to i64), %struct.Memory* %call2_40ff74)
...
block_.L_40ff9c:                                  ; preds = %block_40ff81, %entry
  %161 = phi i64 [ %146, %entry ], [ %.pre, %block_40ff81 ]
  %MEMORY.0 = phi %struct.Memory* [ %call2_40ff74, %entry ], [ %154, %block_40ff81 ]
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_jne_.L_40ff9c(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i8* nocapture %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
