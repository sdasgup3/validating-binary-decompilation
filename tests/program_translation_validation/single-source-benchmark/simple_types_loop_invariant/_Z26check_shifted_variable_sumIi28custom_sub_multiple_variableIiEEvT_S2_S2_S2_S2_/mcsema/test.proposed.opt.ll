...
entry:
  ...
  %call2_40ff1e = tail call %struct.Memory* @sub_40fec0._ZN28custom_sub_multiple_variableIiE8do_shiftEiiiii(%struct.State* %0, i64 %102, %struct.Memory* %2)
  ...
  %call2_40ff34 = tail call %struct.Memory* @sub_40f740._Z15tolerance_equalIiEbRT_S1_(%struct.State* %0, i64 %131, %struct.Memory* %call2_40ff1e)
  ...
  br i1 %144, label %block_.L_40ff5c, label %block_40ff41
...
block_40ff41:                                     ; preds = %entry
  ...
  %153 = tail call %struct.Memory* @__remill_function_call(%struct.State* %0, i64 ptrtoint (i64 (i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64)* @printf to i64), %struct.Memory* %call2_40ff34)
...
block_.L_40ff5c:                                  ; preds = %block_40ff41, %entry
  %160 = phi i64 [ %145, %entry ], [ %.pre, %block_40ff41 ]
  %MEMORY.0 = phi %struct.Memory* [ %call2_40ff34, %entry ], [ %153, %block_40ff41 ]
...
define %struct.Memory* @routine_jne_.L_40ff5c(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i8* %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
