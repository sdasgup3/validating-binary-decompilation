...
define %struct.Memory* @_Z26check_shifted_variable_sumIi28custom_sub_multiple_variableIiEEvT_S2_S2_S2_S2_(%struct.State* noalias, i64, %struct.Memory* noalias readnone) local_unnamed_addr #1 {
entry:
...
block_40ff71:                                     ; preds = %entry
  ...
  %call2_40ff84 = tail call %struct.Memory* @sub_4006c0.printf_plt(%struct.State* nonnull %0, i64 %149, %struct.Memory* %call2_40ff64)
...
block_.L_40ff8c:                                  ; preds = %block_40ff71, %entry
  %160 = phi i64 [ %146, %entry ], [ %.pre, %block_40ff71 ]
  %MEMORY.0 = phi %struct.Memory* [ %call2_40ff64, %entry ], [ %call2_40ff84, %block_40ff71 ]
