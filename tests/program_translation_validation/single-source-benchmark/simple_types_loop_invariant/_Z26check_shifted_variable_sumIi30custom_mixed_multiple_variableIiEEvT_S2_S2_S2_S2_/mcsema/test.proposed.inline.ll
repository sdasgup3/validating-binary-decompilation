...
entry:
  ...
  store %struct.Memory* %loadMem_40fa8e, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem1_40faae, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem1_40fac4, %struct.Memory** %MEMORY
...
block_40fad1:                                     ; preds = %entry
  ...
  %415 = call %struct.Memory* @__remill_function_call(%struct.State* %0, i64 ptrtoint (i64 (i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64)* @printf to i64), %struct.Memory* %loadMem2_40fae4)
...
block_.L_40faec:                                  ; preds = %block_40fad1, %entry
  ...
  store %struct.Memory* %loadMem_40faf0, %struct.Memory** %MEMORY
  ...
  ret %struct.Memory* %loadMem_40faf1
}
