...
declare %struct.Memory* @sub_40fa80._ZN30custom_mixed_multiple_variableIiE8do_shiftEiiiii(%struct.State* dereferenceable(3376), i64, %struct.Memory*) local_unnamed_addr
