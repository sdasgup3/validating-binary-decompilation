...
define %struct.Memory* @_Z26check_shifted_variable_sumIi30custom_mixed_multiple_variableIiEEvT_S2_S2_S2_S2_(%struct.State* noalias, i64, %struct.Memory* noalias readnone) local_unnamed_addr #1 {
entry:
...
block_40fb01:                                     ; preds = %entry
  ...
  %call2_40fb14 = tail call %struct.Memory* @sub_4006c0.printf_plt(%struct.State* nonnull %0, i64 %149, %struct.Memory* %call2_40faf4)
...
block_.L_40fb1c:                                  ; preds = %block_40fb01, %entry
  %160 = phi i64 [ %146, %entry ], [ %.pre, %block_40fb01 ]
  %MEMORY.0 = phi %struct.Memory* [ %call2_40faf4, %entry ], [ %call2_40fb14, %block_40fb01 ]
