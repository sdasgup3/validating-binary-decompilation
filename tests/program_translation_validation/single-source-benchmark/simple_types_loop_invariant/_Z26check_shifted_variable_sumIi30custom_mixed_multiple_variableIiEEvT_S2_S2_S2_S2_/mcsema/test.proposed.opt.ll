...
declare %struct.Memory* @sub_40fa50._ZN30custom_mixed_multiple_variableIiE8do_shiftEiiiii(%struct.State* noalias dereferenceable(3376), i64, %struct.Memory* noalias readnone returned) local_unnamed_addr
...
entry:
  ...
  %call2_40faae = tail call %struct.Memory* @sub_40fa50._ZN30custom_mixed_multiple_variableIiE8do_shiftEiiiii(%struct.State* %0, i64 %102, %struct.Memory* %2)
  ...
  %call2_40fac4 = tail call %struct.Memory* @sub_40f740._Z15tolerance_equalIiEbRT_S1_(%struct.State* %0, i64 %132, %struct.Memory* %call2_40faae)
  ...
  br i1 %145, label %block_.L_40faec, label %block_40fad1

block_40fad1:                                     ; preds = %entry
  ...
  %154 = tail call %struct.Memory* @__remill_function_call(%struct.State* %0, i64 ptrtoint (i64 (i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64)* @printf to i64), %struct.Memory* %call2_40fac4)
  ...
  br label %block_.L_40faec

block_.L_40faec:                                  ; preds = %block_40fad1, %entry
  %161 = phi i64 [ %146, %entry ], [ %.pre, %block_40fad1 ]
  %MEMORY.0 = phi %struct.Memory* [ %call2_40fac4, %entry ], [ %154, %block_40fad1 ]
...
define %struct.Memory* @routine_callq_._ZN30custom_mixed_multiple_variableIiE8do_shiftEiiiii(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
...
define %struct.Memory* @routine_jne_.L_40faec(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i8* %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
