...
define %struct.Memory* @_Z26check_shifted_variable_sumIi31custom_divide_multiple_variableIiEEvT_S2_S2_S2_S2_(%struct.State* noalias, i64, %struct.Memory* noalias) local_unnamed_addr #1 {
entry:
...
block_40fc61:                                     ; preds = %entry
  ...
  %154 = tail call %struct.Memory* @__remill_function_call(%struct.State* nonnull %0, i64 ptrtoint (i64 (i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64)* @printf to i64), %struct.Memory* %call2_40fc54)
...
block_.L_40fc7c:                                  ; preds = %block_40fc61, %entry
  %161 = phi i64 [ %146, %entry ], [ %.pre, %block_40fc61 ]
  %MEMORY.0 = phi %struct.Memory* [ %call2_40fc54, %entry ], [ %154, %block_40fc61 ]
