...
define %struct.Memory* @_Z26check_shifted_variable_sumIi31custom_divide_multiple_variableIiEEvT_S2_S2_S2_S2_(%struct.State* noalias, i64, %struct.Memory* noalias readnone) local_unnamed_addr #1 {
entry:
  ...
  %call2_40fc3e = tail call %struct.Memory* @sub_40fbe0._ZN31custom_divide_multiple_variableIiE8do_shiftEiiiii(%struct.State* %0, i64 %102, %struct.Memory* %2)
  ...
  %call2_40fc54 = tail call %struct.Memory* @sub_40f770._Z15tolerance_equalIiEbRT_S1_(%struct.State* %0, i64 %132, %struct.Memory* %call2_40fc3e)
  ...
  br i1 %145, label %block_.L_40fc7c, label %block_40fc61

block_40fc61:                                     ; preds = %entry
  ...
  %call2_40fc74 = tail call %struct.Memory* @sub_4006c0.printf_plt(%struct.State* nonnull %0, i64 %149, %struct.Memory* %call2_40fc54)
  ...
  br label %block_.L_40fc7c

block_.L_40fc7c:                                  ; preds = %block_40fc61, %entry
  %160 = phi i64 [ %146, %entry ], [ %.pre, %block_40fc61 ]
  %MEMORY.0 = phi %struct.Memory* [ %call2_40fc54, %entry ], [ %call2_40fc74, %block_40fc61 ]
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_jne_.L_40fc7c(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i8* nocapture %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
