...
entry:
  ...
  %call2_40fc0e = tail call %struct.Memory* @sub_40fbb0._ZN31custom_divide_multiple_variableIiE8do_shiftEiiiii(%struct.State* %0, i64 %102, %struct.Memory* %2)
  ...
  %call2_40fc24 = tail call %struct.Memory* @sub_40f740._Z15tolerance_equalIiEbRT_S1_(%struct.State* %0, i64 %132, %struct.Memory* %call2_40fc0e)
  ...
  br i1 %145, label %block_.L_40fc4c, label %block_40fc31

block_40fc31:                                     ; preds = %entry
  ...
  %154 = tail call %struct.Memory* @__remill_function_call(%struct.State* %0, i64 ptrtoint (i64 (i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64)* @printf to i64), %struct.Memory* %call2_40fc24)
  ...
  br label %block_.L_40fc4c

block_.L_40fc4c:                                  ; preds = %block_40fc31, %entry
  %161 = phi i64 [ %146, %entry ], [ %.pre, %block_40fc31 ]
  %MEMORY.0 = phi %struct.Memory* [ %call2_40fc24, %entry ], [ %154, %block_40fc31 ]
...
define %struct.Memory* @routine_jne_.L_40fc4c(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i8* %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
