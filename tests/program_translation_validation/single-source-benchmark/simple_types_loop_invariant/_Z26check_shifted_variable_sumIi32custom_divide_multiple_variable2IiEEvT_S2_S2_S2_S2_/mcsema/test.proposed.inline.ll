...
entry:
  ...
  %loadMem_40fb7e = load %struct.Memory*, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_40fb7e, %struct.Memory** %MEMORY
  ...
  %loadMem1_40fb9e = load %struct.Memory*, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem1_40fb9e, %struct.Memory** %MEMORY
  %loadMem2_40fb9e = load %struct.Memory*, %struct.Memory** %MEMORY
  %loadPC_40fb9e = load i64, i64* %3
  %call2_40fb9e = call %struct.Memory* @sub_40fb40._ZN32custom_divide_multiple_variable2IiE8do_shiftEiiiii(%struct.State* %0, i64 %loadPC_40fb9e, %struct.Memory* %loadMem2_40fb9e)
  store %struct.Memory* %call2_40fb9e, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_40fbb1, %struct.Memory** %MEMORY
  %loadMem1_40fbb4 = load %struct.Memory*, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem1_40fbb4, %struct.Memory** %MEMORY
  %loadMem2_40fbb4 = load %struct.Memory*, %struct.Memory** %MEMORY
  %loadPC_40fbb4 = load i64, i64* %3
  %call2_40fbb4 = call %struct.Memory* @sub_40f780._Z15tolerance_equalIiEbRT_S1_(%struct.State* %0, i64 %loadPC_40fbb4, %struct.Memory* %loadMem2_40fbb4)
  store %struct.Memory* %call2_40fbb4, %struct.Memory** %MEMORY
  ...
  %loadBr_40fbbb = load i8, i8* %BRANCH_TAKEN
  %cmpBr_40fbbb = icmp eq i8 %loadBr_40fbbb, 1
  br i1 %cmpBr_40fbbb, label %block_.L_40fbdc, label %block_40fbc1
...
block_40fbc1:                                     ; preds = %entry
  ...
  %loadMem_40fbcb = load %struct.Memory*, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_40fbcb, %struct.Memory** %MEMORY
  %loadMem_40fbd2 = load %struct.Memory*, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_40fbd2, %struct.Memory** %MEMORY
  %loadMem1_40fbd4 = load %struct.Memory*, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem1_40fbd4, %struct.Memory** %MEMORY
  %loadMem2_40fbd4 = load %struct.Memory*, %struct.Memory** %MEMORY
  %loadPC_40fbd4 = load i64, i64* %3
  %415 = call %struct.Memory* @__remill_function_call(%struct.State* %0, i64 ptrtoint (i64 (i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64)* @printf to i64), %struct.Memory* %loadMem2_40fbd4)
...
block_.L_40fbdc:                                  ; preds = %block_40fbc1, %entry
  ...
  %loadMem_40fbe0 = load %struct.Memory*, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_40fbe0, %struct.Memory** %MEMORY
  ...
  ret %struct.Memory* %loadMem_40fbe1
}
...
define %struct.Memory* @routine_jne_.L_40fbdc(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i8* %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) {
block_400488:
  %3 = getelementptr inbounds %struct.State, %struct.State* %0, i32 0, i32 6
  %4 = getelementptr inbounds %struct.GPR, %struct.GPR* %3, i32 0, i32 33
  %5 = getelementptr inbounds %struct.Reg, %struct.Reg* %4, i32 0, i32 0
