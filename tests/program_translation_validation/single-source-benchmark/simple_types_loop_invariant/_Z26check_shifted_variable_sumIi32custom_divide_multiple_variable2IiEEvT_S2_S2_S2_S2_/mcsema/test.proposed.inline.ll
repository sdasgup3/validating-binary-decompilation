...
entry:
  ...
  %loadMem1_40fb8e = load %struct.Memory*, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem1_40fb8e, %struct.Memory** %MEMORY
  %loadMem2_40fb8e = load %struct.Memory*, %struct.Memory** %MEMORY
  %loadPC_40fb8e = load i64, i64* %3
  %call2_40fb8e = call %struct.Memory* @sub_40fb30._ZN32custom_divide_multiple_variable2IiE8do_shiftEiiiii(%struct.State* %0, i64 %loadPC_40fb8e, %struct.Memory* %loadMem2_40fb8e)
  store %struct.Memory* %call2_40fb8e, %struct.Memory** %MEMORY
  ...
  %loadMem1_40fba4 = load %struct.Memory*, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem1_40fba4, %struct.Memory** %MEMORY
  %loadMem2_40fba4 = load %struct.Memory*, %struct.Memory** %MEMORY
  %loadPC_40fba4 = load i64, i64* %3
  %call2_40fba4 = call %struct.Memory* @sub_40f770._Z15tolerance_equalIiEbRT_S1_(%struct.State* %0, i64 %loadPC_40fba4, %struct.Memory* %loadMem2_40fba4)
  store %struct.Memory* %call2_40fba4, %struct.Memory** %MEMORY
  ...
  %loadBr_40fbab = load i8, i8* %BRANCH_TAKEN
  %cmpBr_40fbab = icmp eq i8 %loadBr_40fbab, 1
  br i1 %cmpBr_40fbab, label %block_.L_40fbcc, label %block_40fbb1
...
block_40fbb1:                                     ; preds = %entry
  ...
  %loadMem_40fbc2 = load %struct.Memory*, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_40fbc2, %struct.Memory** %MEMORY
  %loadMem1_40fbc4 = load %struct.Memory*, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem1_40fbc4, %struct.Memory** %MEMORY
  %loadMem2_40fbc4 = load %struct.Memory*, %struct.Memory** %MEMORY
  %loadPC_40fbc4 = load i64, i64* %3
  %415 = call %struct.Memory* @__remill_function_call(%struct.State* %0, i64 ptrtoint (i64 (i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64)* @printf to i64), %struct.Memory* %loadMem2_40fbc4)
...
block_.L_40fbcc:                                  ; preds = %block_40fbb1, %entry
  ...
  store %struct.Memory* %loadMem_40fbcc, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_40fbd0, %struct.Memory** %MEMORY
  ...
  ret %struct.Memory* %loadMem_40fbd1
}
...
define %struct.Memory* @routine_jne_.L_40fbcc(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i8* %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) {
block_400488:
  %3 = getelementptr inbounds %struct.State, %struct.State* %0, i32 0, i32 6
  %4 = getelementptr inbounds %struct.GPR, %struct.GPR* %3, i32 0, i32 33
  %5 = getelementptr inbounds %struct.Reg, %struct.Reg* %4, i32 0, i32 0
