...
block_40fbb1:                                     ; preds = %entry
  ...
  %call2_40fbc4 = call %struct.Memory* @sub_4006c0.printf_plt(%struct.State* %0, i64 %loadPC_40fbc4, %struct.Memory* %loadMem2_40fbc4)
  store %struct.Memory* %call2_40fbc4, %struct.Memory** %MEMORY
