...
declare %struct.Memory* @sub_40fb40._ZN32custom_divide_multiple_variable2IiE8do_shiftEiiiii(%struct.State* noalias dereferenceable(3376), i64, %struct.Memory* noalias readnone returned) local_unnamed_addr

declare %struct.Memory* @sub_40f780._Z15tolerance_equalIiEbRT_S1_(%struct.State* noalias dereferenceable(3376), i64, %struct.Memory* noalias readnone returned) local_unnamed_addr
...
entry:
  ...
  %73 = load double, double* bitcast (%G_0x61a088_type* @G_0x61a088 to double*), align 8
  ...
  %call2_40fb9e = tail call %struct.Memory* @sub_40fb40._ZN32custom_divide_multiple_variable2IiE8do_shiftEiiiii(%struct.State* %0, i64 %102, %struct.Memory* %2)
  ...
  %call2_40fbb4 = tail call %struct.Memory* @sub_40f780._Z15tolerance_equalIiEbRT_S1_(%struct.State* %0, i64 %132, %struct.Memory* %call2_40fb9e)
  ...
  br i1 %145, label %block_.L_40fbdc, label %block_40fbc1

block_40fbc1:                                     ; preds = %entry
  store i64 ptrtoint (%G__0x414b2e_type* @G__0x414b2e to i64), i64* %RDI.i40, align 8
  %147 = load i32, i32* bitcast (%G_0x61a0a8_type* @G_0x61a0a8 to i32*), align 8
  ...
  %154 = tail call %struct.Memory* @__remill_function_call(%struct.State* nonnull %0, i64 ptrtoint (i64 (i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64)* @printf to i64), %struct.Memory* %call2_40fbb4)
  ...
  br label %block_.L_40fbdc

block_.L_40fbdc:                                  ; preds = %block_40fbc1, %entry
  %161 = phi i64 [ %146, %entry ], [ %.pre, %block_40fbc1 ]
  %MEMORY.0 = phi %struct.Memory* [ %call2_40fbb4, %entry ], [ %154, %block_40fbc1 ]
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_jne_.L_40fbdc(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i8* nocapture %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
