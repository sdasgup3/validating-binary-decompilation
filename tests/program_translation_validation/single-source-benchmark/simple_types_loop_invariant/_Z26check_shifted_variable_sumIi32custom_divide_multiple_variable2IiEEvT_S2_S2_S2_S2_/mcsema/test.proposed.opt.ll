...
entry:
  ...
  %129 = inttoptr i64 %110 to i32*
  store i32 %115, i32* %129, align 4
  %130 = load i64, i64* %3, align 8
  %131 = add i64 %130, -1076
  %132 = add i64 %130, 5
  ...
  %call2_40fb74 = tail call %struct.Memory* @sub_40f740._Z15tolerance_equalIiEbRT_S1_(%struct.State* %0, i64 %131, %struct.Memory* %call2_40fb5e)
  %AL.i16 = bitcast %union.anon* %111 to i8*
  %136 = load i8, i8* %AL.i16, align 1
  ...
  %.v = select i1 %144, i64 35, i64 8
  %145 = add i64 %137, %.v
  store i64 %145, i64* %3, align 8
  br i1 %144, label %block_.L_40fb9c, label %block_40fb81

block_40fb81:                                     ; preds = %entry
  store i64 ptrtoint (%G__0x414aee_type* @G__0x414aee to i64), i64* %RDI.i40, align 8
  %146 = load i32, i32* bitcast (%G_0x61a0a8_type* @G_0x61a0a8 to i32*), align 8
  %147 = zext i32 %146 to i64
  store i64 %147, i64* %RSI.i37, align 8
  store i8 0, i8* %AL.i16, align 1
  %148 = add i64 %145, -62721
  %149 = add i64 %145, 24
  ...
  %153 = tail call %struct.Memory* @__remill_function_call(%struct.State* %0, i64 ptrtoint (i64 (i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64)* @printf to i64), %struct.Memory* %call2_40fb74)
  %154 = load i64, i64* %RBP.i, align 8
  %155 = add i64 %154, -28
  %156 = load i32, i32* %EAX.i22, align 4
...
block_.L_40fb9c:                                  ; preds = %block_40fb81, %entry
  %160 = phi i64 [ %145, %entry ], [ %.pre, %block_40fb81 ]
  %MEMORY.0 = phi %struct.Memory* [ %call2_40fb74, %entry ], [ %153, %block_40fb81 ]
