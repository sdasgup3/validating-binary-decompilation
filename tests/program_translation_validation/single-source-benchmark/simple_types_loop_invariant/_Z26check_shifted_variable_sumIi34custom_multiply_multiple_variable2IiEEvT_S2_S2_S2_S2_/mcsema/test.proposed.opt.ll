...
define %struct.Memory* @_Z26check_shifted_variable_sumIi34custom_multiply_multiple_variable2IiEEvT_S2_S2_S2_S2_(%struct.State* noalias, i64, %struct.Memory* noalias readnone) local_unnamed_addr #1 {
entry:
...
block_40fd91:                                     ; preds = %entry
  ...
  %call2_40fda4 = tail call %struct.Memory* @sub_4006c0.printf_plt(%struct.State* nonnull %0, i64 %149, %struct.Memory* %call2_40fd84)
...
block_.L_40fdac:                                  ; preds = %block_40fd91, %entry
  %160 = phi i64 [ %146, %entry ], [ %.pre, %block_40fd91 ]
  %MEMORY.0 = phi %struct.Memory* [ %call2_40fd84, %entry ], [ %call2_40fda4, %block_40fd91 ]
