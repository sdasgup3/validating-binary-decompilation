...
entry:
  ...
  %53 = add i64 %52, ptrtoint (%G_0x20b281__rip__type* @G_0x20b281__rip_ to i64)
  %54 = add i64 %52, 9
  ...
  %call2_40ee14 = tail call %struct.Memory* @sub_40edd0._ZN18custom_variable_orIjE8do_shiftEjj(%struct.State* %0, i64 %80, %struct.Memory* %2)
  ...
  %call2_40ee2a = tail call %struct.Memory* @sub_40ec60._Z15tolerance_equalIjEbRT_S1_(%struct.State* %0, i64 %109, %struct.Memory* %call2_40ee14)
  ...
  br i1 %122, label %block_.L_40ee52, label %block_40ee37
...
block_40ee37:                                     ; preds = %entry
  ...
  %131 = tail call %struct.Memory* @__remill_function_call(%struct.State* nonnull %0, i64 ptrtoint (i64 (i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64)* @printf to i64), %struct.Memory* %call2_40ee2a)
...
block_.L_40ee52:                                  ; preds = %block_40ee37, %entry
  %138 = phi i64 [ %123, %entry ], [ %.pre, %block_40ee37 ]
  %MEMORY.0 = phi %struct.Memory* [ %call2_40ee2a, %entry ], [ %131, %block_40ee37 ]
