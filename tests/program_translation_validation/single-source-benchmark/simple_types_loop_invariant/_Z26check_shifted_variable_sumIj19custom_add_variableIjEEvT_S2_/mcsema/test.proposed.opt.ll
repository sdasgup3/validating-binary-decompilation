...
entry:
  ...
  %53 = add i64 %52, ptrtoint (%G_0x20aa31__rip__type* @G_0x20aa31__rip_ to i64)
  %54 = add i64 %52, 9
  ...
  %call2_40f664 = tail call %struct.Memory* @sub_40f6b0._ZN19custom_add_variableIjE8do_shiftEjj(%struct.State* %0, i64 %80, %struct.Memory* %2)
  ...
  %call2_40f67a = tail call %struct.Memory* @sub_40ec60._Z15tolerance_equalIjEbRT_S1_(%struct.State* %0, i64 %109, %struct.Memory* %call2_40f664)
  ...
  br i1 %122, label %block_.L_40f6a2, label %block_40f687
...
block_40f687:                                     ; preds = %entry
  ...
  %131 = tail call %struct.Memory* @__remill_function_call(%struct.State* nonnull %0, i64 ptrtoint (i64 (i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64)* @printf to i64), %struct.Memory* %call2_40f67a)
...
block_.L_40f6a2:                                  ; preds = %block_40f687, %entry
  %138 = phi i64 [ %123, %entry ], [ %.pre, %block_40f687 ]
  %MEMORY.0 = phi %struct.Memory* [ %call2_40f67a, %entry ], [ %131, %block_40f687 ]
