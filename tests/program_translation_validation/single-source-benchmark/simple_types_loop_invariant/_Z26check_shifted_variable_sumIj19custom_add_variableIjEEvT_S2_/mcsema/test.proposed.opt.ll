...
@G_0x20aa71__rip_ = local_unnamed_addr global %G_0x20aa71__rip__type zeroinitializer
...
entry:
  ...
  %53 = load double, double* bitcast (%G_0x20aa71__rip__type* @G_0x20aa71__rip_ to double*), align 8
  ...
  %call2_40f63a = tail call %struct.Memory* @sub_40ec20._Z15tolerance_equalIjEbRT_S1_(%struct.State* %0, i64 %106, %struct.Memory* %call2_40f624)
  ...
  br i1 %119, label %block_.L_40f662, label %block_40f647
...
block_40f647:                                     ; preds = %entry
  ...
  %128 = tail call %struct.Memory* @__remill_function_call(%struct.State* %0, i64 ptrtoint (i64 (i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64)* @printf to i64), %struct.Memory* %call2_40f63a)
...
block_.L_40f662:                                  ; preds = %block_40f647, %entry
  %135 = phi i64 [ %120, %entry ], [ %.pre, %block_40f647 ]
  %MEMORY.0 = phi %struct.Memory* [ %call2_40f63a, %entry ], [ %128, %block_40f647 ]
...
block_400478:
  ...
  %5 = load double, double* bitcast (%G_0x20aa71__rip__type* @G_0x20aa71__rip_ to double*), align 8
