...
@G_0x20b401__rip_ = global %G_0x20b401__rip__type zeroinitializer
...
define %struct.Memory* @_Z26check_shifted_variable_sumIj19custom_variable_xorIjEEvT_S2_(%struct.State* noalias, i64, %struct.Memory* noalias) #2 {
entry:
  ...
  store %struct.Memory* %loadMem_40ec74, %struct.Memory** %MEMORY
  ...
  %108 = load double, double* bitcast (%G_0x20b401__rip__type* @G_0x20b401__rip_ to double*)
  ...
  store %struct.Memory* %loadMem_40ec8f, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_40eca7, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem1_40ecaa, %struct.Memory** %MEMORY
...
block_40ecb7:                                     ; preds = %entry
  ...
  store %struct.Memory* %loadMem_40ecb7, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem1_40ecca, %struct.Memory** %MEMORY
  %loadMem2_40ecca = load %struct.Memory*, %struct.Memory** %MEMORY
  %loadPC_40ecca = load i64, i64* %3
  %378 = call %struct.Memory* @__remill_function_call(%struct.State* %0, i64 ptrtoint (i64 (i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64)* @printf to i64), %struct.Memory* %loadMem2_40ecca)
...
block_.L_40ecd2:                                  ; preds = %block_40ecb7, %entry
  ...
  store %struct.Memory* %loadMem_40ecd7, %struct.Memory** %MEMORY
  ret %struct.Memory* %loadMem_40ecd7
}
...
define %struct.Memory* @routine_cvttsd2si_0x20b401__rip____rax(%struct.State* dereferenceable(3376), i64, %struct.Memory*) {
block_400478:
  %3 = getelementptr inbounds %struct.State, %struct.State* %0, i32 0, i32 6
  %4 = getelementptr inbounds %struct.GPR, %struct.GPR* %3, i32 0, i32 33
  %5 = getelementptr inbounds %struct.Reg, %struct.Reg* %4, i32 0, i32 0
