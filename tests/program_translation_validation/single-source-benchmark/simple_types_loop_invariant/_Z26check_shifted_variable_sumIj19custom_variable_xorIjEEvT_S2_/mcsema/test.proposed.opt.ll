...
%G_0x20b401__rip__type = type <{ [8 x i8] }>
...
@G_0x20b401__rip_ = local_unnamed_addr global %G_0x20b401__rip__type zeroinitializer
...
entry:
  ...
  %53 = load double, double* bitcast (%G_0x20b401__rip__type* @G_0x20b401__rip_ to double*), align 8
  ...
  %call2_40ec94 = tail call %struct.Memory* @sub_40ec50._ZN19custom_variable_xorIjE8do_shiftEjj(%struct.State* %0, i64 %77, %struct.Memory* %2)
  ...
  %call2_40ecaa = tail call %struct.Memory* @sub_40ec20._Z15tolerance_equalIjEbRT_S1_(%struct.State* %0, i64 %106, %struct.Memory* %call2_40ec94)
  ...
  br i1 %119, label %block_.L_40ecd2, label %block_40ecb7

block_40ecb7:                                     ; preds = %entry
  ...
  %128 = tail call %struct.Memory* @__remill_function_call(%struct.State* %0, i64 ptrtoint (i64 (i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64)* @printf to i64), %struct.Memory* %call2_40ecaa)
  ...
  br label %block_.L_40ecd2

block_.L_40ecd2:                                  ; preds = %block_40ecb7, %entry
  %135 = phi i64 [ %120, %entry ], [ %.pre, %block_40ecb7 ]
  %MEMORY.0 = phi %struct.Memory* [ %call2_40ecaa, %entry ], [ %128, %block_40ecb7 ]
...
define %struct.Memory* @routine_cvttsd2si_0x20b401__rip____rax(%struct.State* dereferenceable(3376), i64, %struct.Memory*) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  ...
  %5 = load double, double* bitcast (%G_0x20b401__rip__type* @G_0x20b401__rip_ to double*), align 8
...
define %struct.Memory* @routine_jne_.L_40ecd2(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i8* %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
