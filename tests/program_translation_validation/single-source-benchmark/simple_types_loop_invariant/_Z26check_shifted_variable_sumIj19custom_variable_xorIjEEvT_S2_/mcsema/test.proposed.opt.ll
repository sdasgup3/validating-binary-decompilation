...
entry:
  ...
  %53 = add i64 %52, ptrtoint (%G_0x20b3c1__rip__type* @G_0x20b3c1__rip_ to i64)
  %54 = add i64 %52, 9
  ...
  %call2_40ecd4 = tail call %struct.Memory* @sub_40ec90._ZN19custom_variable_xorIjE8do_shiftEjj(%struct.State* %0, i64 %80, %struct.Memory* %2)
  ...
  %call2_40ecea = tail call %struct.Memory* @sub_40ec60._Z15tolerance_equalIjEbRT_S1_(%struct.State* %0, i64 %109, %struct.Memory* %call2_40ecd4)
  ...
  br i1 %122, label %block_.L_40ed12, label %block_40ecf7
...
block_40ecf7:                                     ; preds = %entry
  ...
  %131 = tail call %struct.Memory* @__remill_function_call(%struct.State* nonnull %0, i64 ptrtoint (i64 (i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64)* @printf to i64), %struct.Memory* %call2_40ecea)
...
block_.L_40ed12:                                  ; preds = %block_40ecf7, %entry
  %138 = phi i64 [ %123, %entry ], [ %.pre, %block_40ecf7 ]
  %MEMORY.0 = phi %struct.Memory* [ %call2_40ecea, %entry ], [ %131, %block_40ecf7 ]
