...
block_40f417:                                     ; preds = %entry
  ...
  %call2_40f42a = call %struct.Memory* @sub_4006c0.printf_plt(%struct.State* %0, i64 %loadPC_40f42a, %struct.Memory* %loadMem2_40f42a)
  store %struct.Memory* %call2_40f42a, %struct.Memory** %MEMORY
