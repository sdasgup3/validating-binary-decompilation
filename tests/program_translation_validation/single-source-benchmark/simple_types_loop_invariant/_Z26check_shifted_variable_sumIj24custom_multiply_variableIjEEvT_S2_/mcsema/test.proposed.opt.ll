...
@G_0x20acd1__rip_ = local_unnamed_addr global %G_0x20acd1__rip__type zeroinitializer
...
entry:
  ...
  %53 = load double, double* bitcast (%G_0x20acd1__rip__type* @G_0x20acd1__rip_ to double*), align 8
  ...
  %call2_40f3da = tail call %struct.Memory* @sub_40ec20._Z15tolerance_equalIjEbRT_S1_(%struct.State* %0, i64 %106, %struct.Memory* %call2_40f3c4)
  ...
  br i1 %119, label %block_.L_40f402, label %block_40f3e7
...
block_40f3e7:                                     ; preds = %entry
  ...
  %128 = tail call %struct.Memory* @__remill_function_call(%struct.State* %0, i64 ptrtoint (i64 (i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64)* @printf to i64), %struct.Memory* %call2_40f3da)
...
block_.L_40f402:                                  ; preds = %block_40f3e7, %entry
  %135 = phi i64 [ %120, %entry ], [ %.pre, %block_40f3e7 ]
  %MEMORY.0 = phi %struct.Memory* [ %call2_40f3da, %entry ], [ %128, %block_40f3e7 ]
...
block_400478:
  ...
  %5 = load double, double* bitcast (%G_0x20acd1__rip__type* @G_0x20acd1__rip_ to double*), align 8
