...
entry:
  ...
  %74 = add i64 %73, ptrtoint (%G_0x20b317__rip__type* @G_0x20b317__rip_ to i64)
  %75 = add i64 %73, 9
  ...
  %call2_40ed88 = tail call %struct.Memory* @sub_40ed20._ZN27custom_multiple_variable_orIjE8do_shiftEjjjjj(%struct.State* %0, i64 %118, %struct.Memory* %2)
  ...
  %call2_40ed9e = tail call %struct.Memory* @sub_40ec60._Z15tolerance_equalIjEbRT_S1_(%struct.State* %0, i64 %147, %struct.Memory* %call2_40ed88)
  ...
  br i1 %160, label %block_.L_40edc6, label %block_40edab
...
block_40edab:                                     ; preds = %entry
  ...
  %169 = tail call %struct.Memory* @__remill_function_call(%struct.State* nonnull %0, i64 ptrtoint (i64 (i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64)* @printf to i64), %struct.Memory* %call2_40ed9e)
...
block_.L_40edc6:                                  ; preds = %block_40edab, %entry
  %176 = phi i64 [ %161, %entry ], [ %.pre, %block_40edab ]
  %MEMORY.0 = phi %struct.Memory* [ %call2_40ed9e, %entry ], [ %169, %block_40edab ]
