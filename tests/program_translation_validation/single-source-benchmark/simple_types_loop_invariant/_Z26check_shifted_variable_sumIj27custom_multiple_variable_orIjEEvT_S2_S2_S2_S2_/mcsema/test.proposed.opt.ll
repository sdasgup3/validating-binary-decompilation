...
declare %struct.Memory* @sub_40ed10._ZN27custom_multiple_variable_orIjE8do_shiftEjjjjj(%struct.State* dereferenceable(3376), i64, %struct.Memory*) local_unnamed_addr
