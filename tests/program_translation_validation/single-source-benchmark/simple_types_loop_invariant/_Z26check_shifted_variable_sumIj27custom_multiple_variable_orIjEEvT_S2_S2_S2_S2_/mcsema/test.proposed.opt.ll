...
@G_0x20b357__rip__4255025_ = local_unnamed_addr global %G_0x20b357__rip__4255025__type zeroinitializer
...
declare %struct.Memory* @sub_40ece0._ZN27custom_multiple_variable_orIjE8do_shiftEjjjjj(%struct.State* noalias dereferenceable(3376), i64, %struct.Memory* noalias readnone returned) local_unnamed_addr
...
entry:
  ...
  %74 = load double, double* bitcast (%G_0x20b357__rip__4255025__type* @G_0x20b357__rip__4255025_ to double*), align 8
  ...
  %call2_40ed48 = tail call %struct.Memory* @sub_40ece0._ZN27custom_multiple_variable_orIjE8do_shiftEjjjjj(%struct.State* %0, i64 %115, %struct.Memory* %2)
  ...
  %call2_40ed5e = tail call %struct.Memory* @sub_40ec20._Z15tolerance_equalIjEbRT_S1_(%struct.State* %0, i64 %143, %struct.Memory* %call2_40ed48)
  ...
  br i1 %156, label %block_.L_40ed86, label %block_40ed6b
...
block_40ed6b:                                     ; preds = %entry
  ...
  %165 = tail call %struct.Memory* @__remill_function_call(%struct.State* %0, i64 ptrtoint (i64 (i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64)* @printf to i64), %struct.Memory* %call2_40ed5e)
...
block_.L_40ed86:                                  ; preds = %block_40ed6b, %entry
  %172 = phi i64 [ %157, %entry ], [ %.pre, %block_40ed6b ]
  %MEMORY.0 = phi %struct.Memory* [ %call2_40ed5e, %entry ], [ %165, %block_40ed6b ]
...
define %struct.Memory* @routine_cvttsd2si_0x20b357__rip____rax(%struct.State* dereferenceable(3376), i64, %struct.Memory*) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  ...
  %5 = load double, double* bitcast (%G_0x20b357__rip__4255025__type* @G_0x20b357__rip__4255025_ to double*), align 8
...
define %struct.Memory* @routine_callq_._ZN27custom_multiple_variable_orIjE8do_shiftEjjjjj(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
...
define %struct.Memory* @routine_jne_.L_40ed86(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i8* %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
