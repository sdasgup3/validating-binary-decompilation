...
@G_0x20b357__rip_ = local_unnamed_addr global %G_0x20b357__rip__type zeroinitializer
...
entry:
  ...
  %74 = load double, double* bitcast (%G_0x20b357__rip__type* @G_0x20b357__rip_ to double*), align 8
  ...
  %call2_40ed5e = tail call %struct.Memory* @sub_40ec20._Z15tolerance_equalIjEbRT_S1_(%struct.State* %0, i64 %144, %struct.Memory* %call2_40ed48)
  ...
  br i1 %157, label %block_.L_40ed86, label %block_40ed6b
...
block_40ed6b:                                     ; preds = %entry
  ...
  %166 = tail call %struct.Memory* @__remill_function_call(%struct.State* %0, i64 ptrtoint (i64 (i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64)* @printf to i64), %struct.Memory* %call2_40ed5e)
...
block_.L_40ed86:                                  ; preds = %block_40ed6b, %entry
  %173 = phi i64 [ %158, %entry ], [ %.pre, %block_40ed6b ]
  %MEMORY.0 = phi %struct.Memory* [ %call2_40ed5e, %entry ], [ %166, %block_40ed6b ]
...
block_400478:
  ...
  %5 = load double, double* bitcast (%G_0x20b357__rip__type* @G_0x20b357__rip_ to double*), align 8
