...
@G_0x20aae7__rip__4257185_ = global %G_0x20aae7__rip__4257185__type zeroinitializer
...
entry:
  ...
  store %struct.Memory* %loadMem_40f58e, %struct.Memory** %MEMORY
  ...
  %156 = load double, double* bitcast (%G_0x20aae7__rip__4257185__type* @G_0x20aae7__rip__4257185_ to double*)
  ...
  store %struct.Memory* %loadMem1_40f5b8, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_40f5bd, %struct.Memory** %MEMORY
...
block_40f5db:                                     ; preds = %entry
  ...
  store %struct.Memory* %loadMem1_40f5ee, %struct.Memory** %MEMORY
  %loadMem2_40f5ee = load %struct.Memory*, %struct.Memory** %MEMORY
  %loadPC_40f5ee = load i64, i64* %3
  %475 = call %struct.Memory* @__remill_function_call(%struct.State* %0, i64 ptrtoint (i64 (i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64)* @printf to i64), %struct.Memory* %loadMem2_40f5ee)
...
block_.L_40f5f6:                                  ; preds = %block_40f5db, %entry
  ...
  ret %struct.Memory* %loadMem_40f5fb
}
...
define %struct.Memory* @routine_cvttsd2si_0x20aae7__rip____rax(%struct.State* dereferenceable(3376), i64, %struct.Memory*) {
block_400478:
  %3 = getelementptr inbounds %struct.State, %struct.State* %0, i32 0, i32 6
  %4 = getelementptr inbounds %struct.GPR, %struct.GPR* %3, i32 0, i32 33
  %5 = getelementptr inbounds %struct.Reg, %struct.Reg* %4, i32 0, i32 0
