...
@G_0x20aae7__rip_ = local_unnamed_addr global %G_0x20aae7__rip__type zeroinitializer
...
declare %struct.Memory* @sub_40f550._ZN28custom_add_multiple_variableIjE8do_shiftEjjjjj(%struct.State* noalias dereferenceable(3376), i64, %struct.Memory* noalias readnone returned) local_unnamed_addr
...
define %struct.Memory* @_Z26check_shifted_variable_sumIj28custom_add_multiple_variableIjEEvT_S2_S2_S2_S2_(%struct.State* noalias, i64, %struct.Memory* noalias) local_unnamed_addr #1 {
entry:
  ...
  %74 = load double, double* bitcast (%G_0x20aae7__rip__type* @G_0x20aae7__rip_ to double*), align 8
  ...
  %call2_40f5b8 = tail call %struct.Memory* @sub_40f550._ZN28custom_add_multiple_variableIjE8do_shiftEjjjjj(%struct.State* %0, i64 %115, %struct.Memory* %2)
  ...
  %call2_40f5ce = tail call %struct.Memory* @sub_40ec20._Z15tolerance_equalIjEbRT_S1_(%struct.State* %0, i64 %144, %struct.Memory* %call2_40f5b8)
  ...
  br i1 %157, label %block_.L_40f5f6, label %block_40f5db

block_40f5db:                                     ; preds = %entry
  ...
  %166 = tail call %struct.Memory* @__remill_function_call(%struct.State* %0, i64 ptrtoint (i64 (i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64)* @printf to i64), %struct.Memory* %call2_40f5ce)
...
block_.L_40f5f6:                                  ; preds = %block_40f5db, %entry
  %173 = phi i64 [ %158, %entry ], [ %.pre, %block_40f5db ]
  %MEMORY.0 = phi %struct.Memory* [ %call2_40f5ce, %entry ], [ %166, %block_40f5db ]
...
define %struct.Memory* @routine_cvttsd2si_0x20aae7__rip____rax(%struct.State* dereferenceable(3376), i64, %struct.Memory*) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  ...
  %5 = load double, double* bitcast (%G_0x20aae7__rip__type* @G_0x20aae7__rip_ to double*), align 8
...
define %struct.Memory* @routine_callq_._ZN28custom_add_multiple_variableIjE8do_shiftEjjjjj(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
...
define %struct.Memory* @routine_jne_.L_40f5f6(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i8* %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
