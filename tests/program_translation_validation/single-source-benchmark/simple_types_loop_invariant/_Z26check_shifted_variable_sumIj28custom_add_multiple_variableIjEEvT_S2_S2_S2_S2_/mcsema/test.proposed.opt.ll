...
@G_0x20aae7__rip__4257185_ = local_unnamed_addr global %G_0x20aae7__rip__4257185__type zeroinitializer
...
entry:
  ...
  %74 = load double, double* bitcast (%G_0x20aae7__rip__4257185__type* @G_0x20aae7__rip__4257185_ to double*), align 8
  ...
  %call2_40f5ce = tail call %struct.Memory* @sub_40ec20._Z15tolerance_equalIjEbRT_S1_(%struct.State* %0, i64 %143, %struct.Memory* %call2_40f5b8)
  ...
  br i1 %156, label %block_.L_40f5f6, label %block_40f5db
...
block_40f5db:                                     ; preds = %entry
  ...
  %165 = tail call %struct.Memory* @__remill_function_call(%struct.State* %0, i64 ptrtoint (i64 (i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64)* @printf to i64), %struct.Memory* %call2_40f5ce)
...
block_.L_40f5f6:                                  ; preds = %block_40f5db, %entry
  %172 = phi i64 [ %157, %entry ], [ %.pre, %block_40f5db ]
  %MEMORY.0 = phi %struct.Memory* [ %call2_40f5ce, %entry ], [ %165, %block_40f5db ]
...
block_400478:
  ...
  %5 = load double, double* bitcast (%G_0x20aae7__rip__4257185__type* @G_0x20aae7__rip__4257185_ to double*), align 8
