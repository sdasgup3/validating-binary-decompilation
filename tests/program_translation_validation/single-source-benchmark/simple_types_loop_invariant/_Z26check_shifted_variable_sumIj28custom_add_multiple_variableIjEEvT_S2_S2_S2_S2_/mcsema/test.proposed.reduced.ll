; ModuleID = '/tmp/tmpjztv8dir-query.ll'
...
entry:
  ...
  %var_2_74 = add i64 %var_2_73, ptrtoint (%G_0x20aaa7__rip__type* @G_0x20aaa7__rip_ to i64)
  ...
  %call2_40f5f8 = tail call %struct.Memory* @sub_40f590._ZN28custom_add_multiple_variableIjE8do_shiftEjjjjj(%struct.State* %0, i64 %var_2_118, %struct.Memory* %2)
  %var_2_146 = load i64, i64* %var_2_3, align 8
  %var_2_147 = add i64 %var_2_146, -2478
  %call2_40f60e = tail call %struct.Memory* @sub_40ec60._Z15tolerance_equalIjEbRT_S1_(%struct.State* %0, i64 %var_2_147, %struct.Memory* %call2_40f5f8)
  ...
  br i1 %var_2_160, label %block_40f61b, label %block_.L_40f636

block_40f61b:                                     ; preds = %entry
  %var_2_169 = tail call %struct.Memory* @__remill_function_call(%struct.State* nonnull %0, i64 ptrtoint (i64 (i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64)* @printf to i64), %struct.Memory* %call2_40f60e)
  br label %block_.L_40f636

block_.L_40f636:                                  ; preds = %block_40f61b, %entry
  %MEMORY.0 = phi %struct.Memory* [ %call2_40f60e, %entry ], [ %var_2_169, %block_40f61b ]
