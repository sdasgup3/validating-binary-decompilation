...
@G_0x20b217__rip__4255345_ = local_unnamed_addr global %G_0x20b217__rip__4255345__type zeroinitializer
...
entry:
  ...
  %74 = load double, double* bitcast (%G_0x20b217__rip__4255345__type* @G_0x20b217__rip__4255345_ to double*), align 8
  ...
  %call2_40ee9e = tail call %struct.Memory* @sub_40ec20._Z15tolerance_equalIjEbRT_S1_(%struct.State* %0, i64 %143, %struct.Memory* %call2_40ee88)
  ...
  br i1 %156, label %block_.L_40eec6, label %block_40eeab
...
block_40eeab:                                     ; preds = %entry
  ...
  %165 = tail call %struct.Memory* @__remill_function_call(%struct.State* %0, i64 ptrtoint (i64 (i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64)* @printf to i64), %struct.Memory* %call2_40ee9e)
...
block_.L_40eec6:                                  ; preds = %block_40eeab, %entry
  %172 = phi i64 [ %157, %entry ], [ %.pre, %block_40eeab ]
  %MEMORY.0 = phi %struct.Memory* [ %call2_40ee9e, %entry ], [ %165, %block_40eeab ]
...
block_400478:
  ...
  %5 = load double, double* bitcast (%G_0x20b217__rip__4255345__type* @G_0x20b217__rip__4255345_ to double*), align 8
