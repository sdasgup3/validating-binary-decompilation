...
block_40eedb:                                     ; preds = %entry
  ...
  %169 = tail call %struct.Memory* @__remill_function_call(%struct.State* nonnull %0, i64 ptrtoint (i64 (i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64)* @printf to i64), %struct.Memory* %call2_40eece)
...
block_.L_40eef6:                                  ; preds = %block_40eedb, %entry
  %176 = phi i64 [ %161, %entry ], [ %.pre, %block_40eedb ]
  %MEMORY.0 = phi %struct.Memory* [ %call2_40eece, %entry ], [ %169, %block_40eedb ]
