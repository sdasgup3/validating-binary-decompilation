...
declare %struct.Memory* @sub_40ee50._ZN28custom_multiple_variable_andIjE8do_shiftEjjjjj(%struct.State* dereferenceable(3376), i64, %struct.Memory*) local_unnamed_addr
