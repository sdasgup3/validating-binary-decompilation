; ModuleID = '/tmp/tmp5azz4_a6-query.ll'
...
entry:
  ...
  %var_2_74 = add i64 %var_2_73, ptrtoint (%G_0x20b1d7__rip__type* @G_0x20b1d7__rip_ to i64)
  ...
  %call2_40eec8 = tail call %struct.Memory* @sub_40ee60._ZN28custom_multiple_variable_andIjE8do_shiftEjjjjj(%struct.State* %0, i64 %var_2_118, %struct.Memory* %2)
  %var_2_146 = load i64, i64* %var_2_3, align 8
  %var_2_147 = add i64 %var_2_146, -638
  %call2_40eede = tail call %struct.Memory* @sub_40ec60._Z15tolerance_equalIjEbRT_S1_(%struct.State* %0, i64 %var_2_147, %struct.Memory* %call2_40eec8)
  ...
  br i1 %var_2_160, label %block_40eeeb, label %block_.L_40ef06

block_40eeeb:                                     ; preds = %entry
  %var_2_169 = tail call %struct.Memory* @__remill_function_call(%struct.State* nonnull %0, i64 ptrtoint (i64 (i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64)* @printf to i64), %struct.Memory* %call2_40eede)
  br label %block_.L_40ef06

block_.L_40ef06:                                  ; preds = %block_40eeeb, %entry
  %MEMORY.0 = phi %struct.Memory* [ %call2_40eede, %entry ], [ %var_2_169, %block_40eeeb ]
