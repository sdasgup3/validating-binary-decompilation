...
%G_0x20b4c7__rip__4254657__type = type <{ [8 x i8] }>
...
@G_0x20b4c7__rip__4254657_ = local_unnamed_addr global %G_0x20b4c7__rip__4254657__type zeroinitializer
...
define %struct.Memory* @_Z26check_shifted_variable_sumIj28custom_multiple_variable_xorIjEEvT_S2_S2_S2_S2_(%struct.State* noalias, i64, %struct.Memory* noalias) local_unnamed_addr #1 {
entry:
  ...
  %74 = load double, double* bitcast (%G_0x20b4c7__rip__4254657__type* @G_0x20b4c7__rip__4254657_ to double*), align 8
  ...
  %call2_40ebd8 = tail call %struct.Memory* @sub_40eb70._ZN28custom_multiple_variable_xorIjE8do_shiftEjjjjj(%struct.State* %0, i64 %115, %struct.Memory* %2)
  ...
  %call2_40ebee = tail call %struct.Memory* @sub_40ec20._Z15tolerance_equalIjEbRT_S1_(%struct.State* %0, i64 %143, %struct.Memory* %call2_40ebd8)
  ...
  br i1 %156, label %block_.L_40ec16, label %block_40ebfb

block_40ebfb:                                     ; preds = %entry
  ...
  %165 = tail call %struct.Memory* @__remill_function_call(%struct.State* %0, i64 ptrtoint (i64 (i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64)* @printf to i64), %struct.Memory* %call2_40ebee)
  ...
  br label %block_.L_40ec16

block_.L_40ec16:                                  ; preds = %block_40ebfb, %entry
  %172 = phi i64 [ %157, %entry ], [ %.pre, %block_40ebfb ]
  %MEMORY.0 = phi %struct.Memory* [ %call2_40ebee, %entry ], [ %165, %block_40ebfb ]
...
define %struct.Memory* @routine_cvttsd2si_0x20b4c7__rip____rax(%struct.State* dereferenceable(3376), i64, %struct.Memory*) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  ...
  %5 = load double, double* bitcast (%G_0x20b4c7__rip__4254657__type* @G_0x20b4c7__rip__4254657_ to double*), align 8
...
define %struct.Memory* @routine_jne_.L_40ec16(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i8* %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
