; ModuleID = '/tmp/tmp9eerhbhn-query.ll'
...
entry:
  ...
  %var_2_74 = add i64 %var_2_73, ptrtoint (%G_0x20b487__rip__type* @G_0x20b487__rip_ to i64)
  ...
  %call2_40ec18 = tail call %struct.Memory* @sub_40ebb0._ZN28custom_multiple_variable_xorIjE8do_shiftEjjjjj(%struct.State* %0, i64 %var_2_118, %struct.Memory* %2)
  %var_2_146 = load i64, i64* %var_2_3, align 8
  %var_2_147 = add i64 %var_2_146, 50
  %call2_40ec2e = tail call %struct.Memory* @sub_40ec60._Z15tolerance_equalIjEbRT_S1_(%struct.State* %0, i64 %var_2_147, %struct.Memory* %call2_40ec18)
  ...
  br i1 %var_2_160, label %block_40ec3b, label %block_.L_40ec56

block_40ec3b:                                     ; preds = %entry
  %var_2_169 = tail call %struct.Memory* @__remill_function_call(%struct.State* nonnull %0, i64 ptrtoint (i64 (i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64)* @printf to i64), %struct.Memory* %call2_40ec2e)
  br label %block_.L_40ec56

block_.L_40ec56:                                  ; preds = %block_40ec3b, %entry
  %MEMORY.0 = phi %struct.Memory* [ %call2_40ec2e, %entry ], [ %var_2_169, %block_40ec3b ]
