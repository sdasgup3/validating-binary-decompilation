...
declare %struct.Memory* @sub_40f440._ZN28custom_sub_multiple_variableIjE8do_shiftEjjjjj(%struct.State* dereferenceable(3376), i64, %struct.Memory*) local_unnamed_addr
