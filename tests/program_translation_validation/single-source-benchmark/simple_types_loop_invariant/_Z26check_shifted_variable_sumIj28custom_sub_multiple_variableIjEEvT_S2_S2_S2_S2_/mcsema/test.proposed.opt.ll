...
define %struct.Memory* @_Z26check_shifted_variable_sumIj28custom_sub_multiple_variableIjEEvT_S2_S2_S2_S2_(%struct.State* noalias, i64, %struct.Memory* noalias readnone) local_unnamed_addr #1 {
entry:
...
block_40f4cb:                                     ; preds = %entry
  ...
  %call2_40f4de = tail call %struct.Memory* @sub_4006c0.printf_plt(%struct.State* nonnull %0, i64 %164, %struct.Memory* %call2_40f4be)
...
block_.L_40f4e6:                                  ; preds = %block_40f4cb, %entry
  %175 = phi i64 [ %161, %entry ], [ %.pre, %block_40f4cb ]
  %MEMORY.0 = phi %struct.Memory* [ %call2_40f4be, %entry ], [ %call2_40f4de, %block_40f4cb ]
