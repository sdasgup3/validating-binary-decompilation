...
@G_0x20ac27__rip__4256865_ = local_unnamed_addr global %G_0x20ac27__rip__4256865__type zeroinitializer
...
declare %struct.Memory* @sub_40f410._ZN28custom_sub_multiple_variableIjE8do_shiftEjjjjj(%struct.State* noalias dereferenceable(3376), i64, %struct.Memory* noalias readnone returned) local_unnamed_addr
...
entry:
  ...
  %74 = load double, double* bitcast (%G_0x20ac27__rip__4256865__type* @G_0x20ac27__rip__4256865_ to double*), align 8
  ...
  %call2_40f478 = tail call %struct.Memory* @sub_40f410._ZN28custom_sub_multiple_variableIjE8do_shiftEjjjjj(%struct.State* %0, i64 %115, %struct.Memory* %2)
  ...
  %call2_40f48e = tail call %struct.Memory* @sub_40ec20._Z15tolerance_equalIjEbRT_S1_(%struct.State* %0, i64 %143, %struct.Memory* %call2_40f478)
  ...
  br i1 %156, label %block_.L_40f4b6, label %block_40f49b
...
block_40f49b:                                     ; preds = %entry
  ...
  %165 = tail call %struct.Memory* @__remill_function_call(%struct.State* %0, i64 ptrtoint (i64 (i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64)* @printf to i64), %struct.Memory* %call2_40f48e)
...
block_.L_40f4b6:                                  ; preds = %block_40f49b, %entry
  %172 = phi i64 [ %157, %entry ], [ %.pre, %block_40f49b ]
  %MEMORY.0 = phi %struct.Memory* [ %call2_40f48e, %entry ], [ %165, %block_40f49b ]
...
define %struct.Memory* @routine_cvttsd2si_0x20ac27__rip____rax(%struct.State* dereferenceable(3376), i64, %struct.Memory*) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  ...
  %5 = load double, double* bitcast (%G_0x20ac27__rip__4256865__type* @G_0x20ac27__rip__4256865_ to double*), align 8
...
define %struct.Memory* @routine_callq_._ZN28custom_sub_multiple_variableIjE8do_shiftEjjjjj(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
...
define %struct.Memory* @routine_jne_.L_40f4b6(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i8* %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
