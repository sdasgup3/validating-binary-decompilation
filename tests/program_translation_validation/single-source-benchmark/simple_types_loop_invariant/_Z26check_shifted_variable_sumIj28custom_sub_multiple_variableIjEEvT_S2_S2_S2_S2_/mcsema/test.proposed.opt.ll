...
declare %struct.Memory* @sub_40f440._ZN28custom_sub_multiple_variableIjE8do_shiftEjjjjj(%struct.State* noalias dereferenceable(3376), i64, %struct.Memory* noalias readnone returned) local_unnamed_addr
...
entry:
  ...
  %call2_40f4a8 = tail call %struct.Memory* @sub_40f440._ZN28custom_sub_multiple_variableIjE8do_shiftEjjjjj(%struct.State* %0, i64 %118, %struct.Memory* %2)
  ...
  %call2_40f4be = tail call %struct.Memory* @sub_40ec50._Z15tolerance_equalIjEbRT_S1_(%struct.State* %0, i64 %147, %struct.Memory* %call2_40f4a8)
  ...
  br i1 %160, label %block_.L_40f4e6, label %block_40f4cb
...
block_40f4cb:                                     ; preds = %entry
  ...
  %169 = tail call %struct.Memory* @__remill_function_call(%struct.State* nonnull %0, i64 ptrtoint (i64 (i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64)* @printf to i64), %struct.Memory* %call2_40f4be)
...
block_.L_40f4e6:                                  ; preds = %block_40f4cb, %entry
  %176 = phi i64 [ %161, %entry ], [ %.pre, %block_40f4cb ]
  %MEMORY.0 = phi %struct.Memory* [ %call2_40f4be, %entry ], [ %169, %block_40f4cb ]
...
; Function Attrs: nounwind
define %struct.Memory* @routine_cvttsd2si_0x20abf7__rip____rax(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned) local_unnamed_addr #3 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_jne_.L_40f4e6(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i8* nocapture %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
