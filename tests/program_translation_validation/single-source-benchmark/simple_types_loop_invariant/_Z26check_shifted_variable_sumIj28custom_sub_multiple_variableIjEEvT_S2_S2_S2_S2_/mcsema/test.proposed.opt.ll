...
entry:
  ...
  %74 = add i64 %73, ptrtoint (%G_0x20abe7__rip__type* @G_0x20abe7__rip_ to i64)
  %75 = add i64 %73, 9
  ...
  %call2_40f4b8 = tail call %struct.Memory* @sub_40f450._ZN28custom_sub_multiple_variableIjE8do_shiftEjjjjj(%struct.State* %0, i64 %118, %struct.Memory* %2)
  ...
  %call2_40f4ce = tail call %struct.Memory* @sub_40ec60._Z15tolerance_equalIjEbRT_S1_(%struct.State* %0, i64 %147, %struct.Memory* %call2_40f4b8)
  ...
  br i1 %160, label %block_.L_40f4f6, label %block_40f4db
...
block_40f4db:                                     ; preds = %entry
  ...
  %169 = tail call %struct.Memory* @__remill_function_call(%struct.State* nonnull %0, i64 ptrtoint (i64 (i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64)* @printf to i64), %struct.Memory* %call2_40f4ce)
...
block_.L_40f4f6:                                  ; preds = %block_40f4db, %entry
  %176 = phi i64 [ %161, %entry ], [ %.pre, %block_40f4db ]
  %MEMORY.0 = phi %struct.Memory* [ %call2_40f4ce, %entry ], [ %169, %block_40f4db ]
