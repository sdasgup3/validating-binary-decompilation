...
@G_0x20b0d7__rip__4255665_ = local_unnamed_addr global %G_0x20b0d7__rip__4255665__type zeroinitializer
...
entry:
  ...
  %74 = load double, double* bitcast (%G_0x20b0d7__rip__4255665__type* @G_0x20b0d7__rip__4255665_ to double*), align 8
  ...
  %call2_40efde = tail call %struct.Memory* @sub_40ec20._Z15tolerance_equalIjEbRT_S1_(%struct.State* %0, i64 %143, %struct.Memory* %call2_40efc8)
  ...
  br i1 %156, label %block_.L_40f006, label %block_40efeb
...
block_40efeb:                                     ; preds = %entry
  ...
  %165 = tail call %struct.Memory* @__remill_function_call(%struct.State* %0, i64 ptrtoint (i64 (i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64)* @printf to i64), %struct.Memory* %call2_40efde)
...
block_.L_40f006:                                  ; preds = %block_40efeb, %entry
  %172 = phi i64 [ %157, %entry ], [ %.pre, %block_40efeb ]
  %MEMORY.0 = phi %struct.Memory* [ %call2_40efde, %entry ], [ %165, %block_40efeb ]
...
block_400478:
  ...
  %5 = load double, double* bitcast (%G_0x20b0d7__rip__4255665__type* @G_0x20b0d7__rip__4255665_ to double*), align 8
