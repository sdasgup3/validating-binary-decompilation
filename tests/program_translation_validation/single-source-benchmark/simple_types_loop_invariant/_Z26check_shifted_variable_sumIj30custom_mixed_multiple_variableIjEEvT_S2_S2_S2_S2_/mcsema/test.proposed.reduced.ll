; ModuleID = '/tmp/tmpoq3t5ysw-query.ll'
...
entry:
  ...
  %var_2_74 = add i64 %var_2_73, ptrtoint (%G_0x20b097__rip__type* @G_0x20b097__rip_ to i64)
  ...
  %call2_40f008 = tail call %struct.Memory* @sub_40efa0._ZN30custom_mixed_multiple_variableIjE8do_shiftEjjjjj(%struct.State* %0, i64 %var_2_118, %struct.Memory* %2)
  %var_2_146 = load i64, i64* %var_2_3, align 8
  %var_2_147 = add i64 %var_2_146, -958
  %call2_40f01e = tail call %struct.Memory* @sub_40ec60._Z15tolerance_equalIjEbRT_S1_(%struct.State* %0, i64 %var_2_147, %struct.Memory* %call2_40f008)
  ...
  br i1 %var_2_160, label %block_40f02b, label %block_.L_40f046

block_40f02b:                                     ; preds = %entry
  %var_2_169 = tail call %struct.Memory* @__remill_function_call(%struct.State* nonnull %0, i64 ptrtoint (i64 (i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64)* @printf to i64), %struct.Memory* %call2_40f01e)
  br label %block_.L_40f046

block_.L_40f046:                                  ; preds = %block_40f02b, %entry
  %MEMORY.0 = phi %struct.Memory* [ %call2_40f01e, %entry ], [ %var_2_169, %block_40f02b ]
