...
block_40f19b:                                     ; preds = %entry
  ...
  %call2_40f1ae = call %struct.Memory* @sub_4006c0.printf_plt(%struct.State* %0, i64 %loadPC_40f1ae, %struct.Memory* %loadMem2_40f1ae)
  store %struct.Memory* %call2_40f1ae, %struct.Memory** %MEMORY
