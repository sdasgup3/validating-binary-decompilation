...
@G_0x20af57__rip__4256049_ = local_unnamed_addr global %G_0x20af57__rip__4256049__type zeroinitializer
...
entry:
  ...
  %74 = load double, double* bitcast (%G_0x20af57__rip__4256049__type* @G_0x20af57__rip__4256049_ to double*), align 8
  ...
  %call2_40f148 = tail call %struct.Memory* @sub_40f0d0._ZN31custom_divide_multiple_variableIjE8do_shiftEjjjjj(%struct.State* %0, i64 %115, %struct.Memory* %2)
  ...
  %call2_40f15e = tail call %struct.Memory* @sub_40ec20._Z15tolerance_equalIjEbRT_S1_(%struct.State* %0, i64 %143, %struct.Memory* %call2_40f148)
  ...
  br i1 %156, label %block_.L_40f186, label %block_40f16b
...
block_40f16b:                                     ; preds = %entry
  ...
  %165 = tail call %struct.Memory* @__remill_function_call(%struct.State* %0, i64 ptrtoint (i64 (i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64)* @printf to i64), %struct.Memory* %call2_40f15e)
...
block_.L_40f186:                                  ; preds = %block_40f16b, %entry
  %172 = phi i64 [ %157, %entry ], [ %.pre, %block_40f16b ]
  %MEMORY.0 = phi %struct.Memory* [ %call2_40f15e, %entry ], [ %165, %block_40f16b ]
...
define %struct.Memory* @routine_cvttsd2si_0x20af57__rip____rax(%struct.State* dereferenceable(3376), i64, %struct.Memory*) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  ...
  %5 = load double, double* bitcast (%G_0x20af57__rip__4256049__type* @G_0x20af57__rip__4256049_ to double*), align 8
...
define %struct.Memory* @routine_jne_.L_40f186(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i8* %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
