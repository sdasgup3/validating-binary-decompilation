...
entry:
  ...
  %74 = add i64 %73, ptrtoint (%G_0x20af17__rip__type* @G_0x20af17__rip_ to i64)
  %75 = add i64 %73, 9
  ...
  %call2_40f188 = tail call %struct.Memory* @sub_40f110._ZN31custom_divide_multiple_variableIjE8do_shiftEjjjjj(%struct.State* %0, i64 %118, %struct.Memory* %2)
  ...
  %call2_40f19e = tail call %struct.Memory* @sub_40ec60._Z15tolerance_equalIjEbRT_S1_(%struct.State* %0, i64 %147, %struct.Memory* %call2_40f188)
  ...
  br i1 %160, label %block_.L_40f1c6, label %block_40f1ab
...
block_40f1ab:                                     ; preds = %entry
  ...
  %169 = tail call %struct.Memory* @__remill_function_call(%struct.State* nonnull %0, i64 ptrtoint (i64 (i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64)* @printf to i64), %struct.Memory* %call2_40f19e)
...
block_.L_40f1c6:                                  ; preds = %block_40f1ab, %entry
  %176 = phi i64 [ %161, %entry ], [ %.pre, %block_40f1ab ]
  %MEMORY.0 = phi %struct.Memory* [ %call2_40f19e, %entry ], [ %169, %block_40f1ab ]
