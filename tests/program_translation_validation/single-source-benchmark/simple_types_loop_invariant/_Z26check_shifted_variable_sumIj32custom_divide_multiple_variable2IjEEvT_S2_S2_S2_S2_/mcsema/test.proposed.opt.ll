...
@G_0x20b017__rip__4255857_ = local_unnamed_addr global %G_0x20b017__rip__4255857__type zeroinitializer
...
entry:
  ...
  %74 = load double, double* bitcast (%G_0x20b017__rip__4255857__type* @G_0x20b017__rip__4255857_ to double*), align 8
  ...
  %141 = inttoptr i64 %123 to i32*
  store i32 %127, i32* %141, align 4
  %142 = load i64, i64* %3, align 8
  %143 = add i64 %142, -1150
  %144 = add i64 %142, 5
  ...
  %call2_40f09e = tail call %struct.Memory* @sub_40ec20._Z15tolerance_equalIjEbRT_S1_(%struct.State* %0, i64 %143, %struct.Memory* %call2_40f088)
  %AL.i16 = bitcast %union.anon* %72 to i8*
  %148 = load i8, i8* %AL.i16, align 1
  ...
  %.v = select i1 %156, i64 35, i64 8
  %157 = add i64 %149, %.v
  store i64 %157, i64* %3, align 8
  br i1 %156, label %block_.L_40f0c6, label %block_40f0ab

block_40f0ab:                                     ; preds = %entry
  store i64 ptrtoint (%G__0x414aee_type* @G__0x414aee to i64), i64* %RDI.i39, align 8
  %158 = load i32, i32* bitcast (%G_0x61a0a8_type* @G_0x61a0a8 to i32*), align 8
  %159 = zext i32 %158 to i64
  store i64 %159, i64* %RSI.i44, align 8
  store i8 0, i8* %AL.i16, align 1
  %160 = add i64 %157, -59947
  %161 = add i64 %157, 24
  ...
  %165 = tail call %struct.Memory* @__remill_function_call(%struct.State* %0, i64 ptrtoint (i64 (i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64)* @printf to i64), %struct.Memory* %call2_40f09e)
  %166 = load i64, i64* %RBP.i, align 8
  %167 = add i64 %166, -32
  %168 = load i32, i32* %EAX.i47, align 4
...
block_.L_40f0c6:                                  ; preds = %block_40f0ab, %entry
  %172 = phi i64 [ %157, %entry ], [ %.pre, %block_40f0ab ]
  %MEMORY.0 = phi %struct.Memory* [ %call2_40f09e, %entry ], [ %165, %block_40f0ab ]
  %173 = load i64, i64* %6, align 8
  %174 = add i64 %173, 32
  store i64 %174, i64* %6, align 8
  %175 = icmp ugt i64 %173, -33
  ...
  store i64 %199, i64* %RBP.i, align 8
...
block_400478:
  ...
  %5 = load double, double* bitcast (%G_0x20b017__rip__4255857__type* @G_0x20b017__rip__4255857_ to double*), align 8
