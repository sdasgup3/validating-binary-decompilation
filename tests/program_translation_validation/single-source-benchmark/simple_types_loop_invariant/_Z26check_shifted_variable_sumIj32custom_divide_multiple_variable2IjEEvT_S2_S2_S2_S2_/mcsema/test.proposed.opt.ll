...
declare %struct.Memory* @sub_40f040._ZN32custom_divide_multiple_variable2IjE8do_shiftEjjjjj(%struct.State* dereferenceable(3376), i64, %struct.Memory*) local_unnamed_addr

declare %struct.Memory* @sub_40ec50._Z15tolerance_equalIjEbRT_S1_(%struct.State* dereferenceable(3376), i64, %struct.Memory*) local_unnamed_addr
