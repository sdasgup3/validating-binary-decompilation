...
block_40f0db:                                     ; preds = %entry
  ...
  %169 = tail call %struct.Memory* @__remill_function_call(%struct.State* nonnull %0, i64 ptrtoint (i64 (i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64)* @printf to i64), %struct.Memory* %call2_40f0ce)
...
block_.L_40f0f6:                                  ; preds = %block_40f0db, %entry
  %176 = phi i64 [ %161, %entry ], [ %.pre, %block_40f0db ]
  %MEMORY.0 = phi %struct.Memory* [ %call2_40f0ce, %entry ], [ %169, %block_40f0db ]
