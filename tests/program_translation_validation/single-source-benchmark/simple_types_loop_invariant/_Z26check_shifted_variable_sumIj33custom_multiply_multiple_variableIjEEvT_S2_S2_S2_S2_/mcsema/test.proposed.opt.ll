...
@G_0x20ad67__rip__4256545_ = local_unnamed_addr global %G_0x20ad67__rip__4256545__type zeroinitializer
...
entry:
  ...
  %74 = load double, double* bitcast (%G_0x20ad67__rip__4256545__type* @G_0x20ad67__rip__4256545_ to double*), align 8
  ...
  %call2_40f34e = tail call %struct.Memory* @sub_40ec20._Z15tolerance_equalIjEbRT_S1_(%struct.State* %0, i64 %143, %struct.Memory* %call2_40f338)
  ...
  br i1 %156, label %block_.L_40f376, label %block_40f35b
...
block_40f35b:                                     ; preds = %entry
  ...
  %165 = tail call %struct.Memory* @__remill_function_call(%struct.State* %0, i64 ptrtoint (i64 (i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64)* @printf to i64), %struct.Memory* %call2_40f34e)
...
block_.L_40f376:                                  ; preds = %block_40f35b, %entry
  %172 = phi i64 [ %157, %entry ], [ %.pre, %block_40f35b ]
  %MEMORY.0 = phi %struct.Memory* [ %call2_40f34e, %entry ], [ %165, %block_40f35b ]
...
block_400478:
  ...
  %5 = load double, double* bitcast (%G_0x20ad67__rip__4256545__type* @G_0x20ad67__rip__4256545_ to double*), align 8
