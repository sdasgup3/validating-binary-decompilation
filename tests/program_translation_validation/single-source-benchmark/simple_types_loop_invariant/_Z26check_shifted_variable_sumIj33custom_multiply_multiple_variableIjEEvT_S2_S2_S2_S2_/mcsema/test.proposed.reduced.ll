; ModuleID = '/tmp/tmplt01z38h-query.ll'
...
entry:
  ...
  %var_2_74 = add i64 %var_2_73, ptrtoint (%G_0x20ad27__rip__type* @G_0x20ad27__rip_ to i64)
  ...
  %call2_40f378 = tail call %struct.Memory* @sub_40f310._ZN33custom_multiply_multiple_variableIjE8do_shiftEjjjjj(%struct.State* %0, i64 %var_2_118, %struct.Memory* %2)
  %var_2_146 = load i64, i64* %var_2_3, align 8
  %var_2_147 = add i64 %var_2_146, -1838
  %call2_40f38e = tail call %struct.Memory* @sub_40ec60._Z15tolerance_equalIjEbRT_S1_(%struct.State* %0, i64 %var_2_147, %struct.Memory* %call2_40f378)
  ...
  br i1 %var_2_160, label %block_40f39b, label %block_.L_40f3b6

block_40f39b:                                     ; preds = %entry
  %var_2_169 = tail call %struct.Memory* @__remill_function_call(%struct.State* nonnull %0, i64 ptrtoint (i64 (i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64)* @printf to i64), %struct.Memory* %call2_40f38e)
  br label %block_.L_40f3b6

block_.L_40f3b6:                                  ; preds = %block_40f39b, %entry
  %MEMORY.0 = phi %struct.Memory* [ %call2_40f38e, %entry ], [ %var_2_169, %block_40f39b ]
