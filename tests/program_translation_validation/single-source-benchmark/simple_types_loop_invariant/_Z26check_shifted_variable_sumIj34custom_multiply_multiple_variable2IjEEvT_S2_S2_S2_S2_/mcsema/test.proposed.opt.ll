...
define %struct.Memory* @_Z26check_shifted_variable_sumIj34custom_multiply_multiple_variable2IjEEvT_S2_S2_S2_S2_(%struct.State* noalias, i64, %struct.Memory* noalias readnone) local_unnamed_addr #1 {
entry:
  ...
  %call2_40f2b8 = tail call %struct.Memory* @sub_40f250._ZN34custom_multiply_multiple_variable2IjE8do_shiftEjjjjj(%struct.State* %0, i64 %118, %struct.Memory* %2)
  ...
  %call2_40f2ce = tail call %struct.Memory* @sub_40ec50._Z15tolerance_equalIjEbRT_S1_(%struct.State* %0, i64 %147, %struct.Memory* %call2_40f2b8)
  ...
  br i1 %160, label %block_.L_40f2f6, label %block_40f2db
...
block_40f2db:                                     ; preds = %entry
  ...
  %call2_40f2ee = tail call %struct.Memory* @sub_4006c0.printf_plt(%struct.State* nonnull %0, i64 %164, %struct.Memory* %call2_40f2ce)
...
block_.L_40f2f6:                                  ; preds = %block_40f2db, %entry
  %175 = phi i64 [ %161, %entry ], [ %.pre, %block_40f2db ]
  %MEMORY.0 = phi %struct.Memory* [ %call2_40f2ce, %entry ], [ %call2_40f2ee, %block_40f2db ]
...
; Function Attrs: nounwind
define %struct.Memory* @routine_cvttsd2si_0x20ade7__rip____rax(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned) local_unnamed_addr #3 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_jne_.L_40f2f6(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i8* nocapture %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
