...
@G_0x20ae17__rip__4256369_ = local_unnamed_addr global %G_0x20ae17__rip__4256369__type zeroinitializer
...
entry:
  ...
  %74 = load double, double* bitcast (%G_0x20ae17__rip__4256369__type* @G_0x20ae17__rip__4256369_ to double*), align 8
  ...
  %call2_40f288 = tail call %struct.Memory* @sub_40f220._ZN34custom_multiply_multiple_variable2IjE8do_shiftEjjjjj(%struct.State* %0, i64 %115, %struct.Memory* %2)
  ...
  %call2_40f29e = tail call %struct.Memory* @sub_40ec20._Z15tolerance_equalIjEbRT_S1_(%struct.State* %0, i64 %143, %struct.Memory* %call2_40f288)
  ...
  br i1 %156, label %block_.L_40f2c6, label %block_40f2ab
...
block_40f2ab:                                     ; preds = %entry
  ...
  %165 = tail call %struct.Memory* @__remill_function_call(%struct.State* %0, i64 ptrtoint (i64 (i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64)* @printf to i64), %struct.Memory* %call2_40f29e)
...
block_.L_40f2c6:                                  ; preds = %block_40f2ab, %entry
  %172 = phi i64 [ %157, %entry ], [ %.pre, %block_40f2ab ]
  %MEMORY.0 = phi %struct.Memory* [ %call2_40f29e, %entry ], [ %165, %block_40f2ab ]
...
define %struct.Memory* @routine_cvttsd2si_0x20ae17__rip____rax(%struct.State* dereferenceable(3376), i64, %struct.Memory*) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  ...
  %5 = load double, double* bitcast (%G_0x20ae17__rip__4256369__type* @G_0x20ae17__rip__4256369_ to double*), align 8
...
define %struct.Memory* @routine_jne_.L_40f2c6(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i8* %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
