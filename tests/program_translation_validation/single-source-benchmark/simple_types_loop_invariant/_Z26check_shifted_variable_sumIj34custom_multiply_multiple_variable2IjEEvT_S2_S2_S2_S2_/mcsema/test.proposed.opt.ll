...
entry:
  ...
  %74 = add i64 %73, ptrtoint (%G_0x20add7__rip__type* @G_0x20add7__rip_ to i64)
  %75 = add i64 %73, 9
  ...
  %call2_40f2c8 = tail call %struct.Memory* @sub_40f260._ZN34custom_multiply_multiple_variable2IjE8do_shiftEjjjjj(%struct.State* %0, i64 %118, %struct.Memory* %2)
  ...
  %call2_40f2de = tail call %struct.Memory* @sub_40ec60._Z15tolerance_equalIjEbRT_S1_(%struct.State* %0, i64 %147, %struct.Memory* %call2_40f2c8)
  ...
  br i1 %160, label %block_.L_40f306, label %block_40f2eb
...
block_40f2eb:                                     ; preds = %entry
  ...
  %169 = tail call %struct.Memory* @__remill_function_call(%struct.State* nonnull %0, i64 ptrtoint (i64 (i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64)* @printf to i64), %struct.Memory* %call2_40f2de)
...
block_.L_40f306:                                  ; preds = %block_40f2eb, %entry
  %176 = phi i64 [ %161, %entry ], [ %.pre, %block_40f2eb ]
  %MEMORY.0 = phi %struct.Memory* [ %call2_40f2de, %entry ], [ %169, %block_40f2eb ]
