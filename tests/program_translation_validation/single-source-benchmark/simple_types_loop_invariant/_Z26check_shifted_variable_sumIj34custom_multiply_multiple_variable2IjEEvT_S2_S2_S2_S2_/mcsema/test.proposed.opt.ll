...
@G_0x20ae17__rip_ = local_unnamed_addr global %G_0x20ae17__rip__type zeroinitializer
...
entry:
  ...
  %74 = load double, double* bitcast (%G_0x20ae17__rip__type* @G_0x20ae17__rip_ to double*), align 8
  ...
  %call2_40f29e = tail call %struct.Memory* @sub_40ec20._Z15tolerance_equalIjEbRT_S1_(%struct.State* %0, i64 %144, %struct.Memory* %call2_40f288)
  ...
  br i1 %157, label %block_.L_40f2c6, label %block_40f2ab
...
block_40f2ab:                                     ; preds = %entry
  ...
  %166 = tail call %struct.Memory* @__remill_function_call(%struct.State* %0, i64 ptrtoint (i64 (i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64)* @printf to i64), %struct.Memory* %call2_40f29e)
...
block_.L_40f2c6:                                  ; preds = %block_40f2ab, %entry
  %173 = phi i64 [ %158, %entry ], [ %.pre, %block_40f2ab ]
  %MEMORY.0 = phi %struct.Memory* [ %call2_40f29e, %entry ], [ %166, %block_40f2ab ]
...
block_400478:
  ...
  %5 = load double, double* bitcast (%G_0x20ae17__rip__type* @G_0x20ae17__rip_ to double*), align 8
