; ModuleID = '/tmp/tmp9lme4ycj-query.ll'
source_filename = "llvm-link"
target datalayout = "e-m:e-i64:64-f80:128-n8:16:32:64-S128"
target triple = "x86_64-pc-linux-gnu-elf"

%__bss_start_type = type <{ [8 x i8] }>
%G_0x20add7__rip__type = type <{ [8 x i8] }>
...
@G_0x20add7__rip_ = global %G_0x20add7__rip__type zeroinitializer
...
define %struct.Memory* @_Z26check_shifted_variable_sumIj34custom_multiply_multiple_variable2IjEEvT_S2_S2_S2_S2_(%struct.State* noalias, i64, %struct.Memory* noalias) local_unnamed_addr #1 {
entry:
  %var_2_3 = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %var_2_72 = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 1, i32 0
  %RAX.i50 = getelementptr inbounds %union.anon, %union.anon* %var_2_72, i64 0, i32 0
  %var_2_73 = load i64, i64* %var_2_3, align 8
  %var_2_74 = add i64 %var_2_73, ptrtoint (%G_0x20add7__rip__type* @G_0x20add7__rip_ to i64)
  %var_2_75 = add i64 %var_2_73, 9
  store i64 %var_2_75, i64* %var_2_3, align 8
  %var_2_76 = inttoptr i64 %var_2_74 to double*
  %var_2_77 = load double, double* %var_2_76, align 8
  %var_2_78 = tail call double @llvm.trunc.f64(double %var_2_77)
  %var_2_79 = tail call double @llvm.fabs.f64(double %var_2_78)
  %var_2_80 = fcmp ogt double %var_2_79, 0x43E0000000000000
  %var_2_81 = fptosi double %var_2_78 to i64
  %var_2_82 = select i1 %var_2_80, i64 -9223372036854775808, i64 %var_2_81
  store i64 %var_2_82, i64* %RAX.i50, align 8
  %RCX.i48 = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 5, i32 0, i32 0
  %var_2_83 = and i64 %var_2_82, 4294967295
  store i64 %var_2_83, i64* %RCX.i48, align 8
  %var_2_118 = add i64 %var_2_73, -90
  %call2_40f2c8 = tail call %struct.Memory* @sub_40f260._ZN34custom_multiply_multiple_variable2IjE8do_shiftEjjjjj(%struct.State* %0, i64 %var_2_118, %struct.Memory* %2)
  %var_2_146 = load i64, i64* %var_2_3, align 8
  %var_2_147 = add i64 %var_2_146, -1662
  %call2_40f2de = tail call %struct.Memory* @sub_40ec60._Z15tolerance_equalIjEbRT_S1_(%struct.State* %0, i64 %var_2_147, %struct.Memory* %call2_40f2c8)
  %AL.i16 = bitcast %union.anon* %var_2_72 to i8*
  %var_2_152 = load i8, i8* %AL.i16, align 1
  %var_2_154 = and i8 %var_2_152, 1
  %var_2_160 = icmp eq i8 %var_2_154, 0
  br i1 %var_2_160, label %block_40f2eb, label %block_.L_40f306

block_40f2eb:                                     ; preds = %entry
  %var_2_169 = tail call %struct.Memory* @__remill_function_call(%struct.State* nonnull %0, i64 ptrtoint (i64 (i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64)* @printf to i64), %struct.Memory* %call2_40f2de)
  br label %block_.L_40f306

block_.L_40f306:                                  ; preds = %block_40f2eb, %entry
  %MEMORY.0 = phi %struct.Memory* [ %call2_40f2de, %entry ], [ %var_2_169, %block_40f2eb ]
...
; Function Attrs: nounwind
define %struct.Memory* @routine_cvttsd2si_0x20add7__rip____rax(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned) local_unnamed_addr #3 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %RAX = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 1, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, ptrtoint (%G_0x20add7__rip__type* @G_0x20add7__rip_ to i64)
  %5 = add i64 %3, 9
  store i64 %5, i64* %PC, align 8
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_jne_.L_40f306(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i8* nocapture %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
