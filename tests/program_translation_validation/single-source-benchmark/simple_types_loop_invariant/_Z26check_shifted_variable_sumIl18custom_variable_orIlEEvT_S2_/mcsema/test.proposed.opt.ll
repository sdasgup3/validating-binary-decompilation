...
entry:
  ...
  %call2_40e24e = tail call %struct.Memory* @sub_40e210._ZN18custom_variable_orIlE8do_shiftEll(%struct.State* %0, i64 %61, %struct.Memory* %2)
  ...
  %call2_40e266 = tail call %struct.Memory* @sub_40e090._Z15tolerance_equalIlEbRT_S1_(%struct.State* %0, i64 %92, %struct.Memory* %call2_40e24e)
  ...
  br i1 %105, label %block_.L_40e28e, label %block_40e273
...
block_40e273:                                     ; preds = %entry
  ...
  %114 = tail call %struct.Memory* @__remill_function_call(%struct.State* %0, i64 ptrtoint (i64 (i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64)* @printf to i64), %struct.Memory* %call2_40e266)
...
block_.L_40e28e:                                  ; preds = %block_40e273, %entry
  %121 = phi i64 [ %106, %entry ], [ %.pre, %block_40e273 ]
  %MEMORY.0 = phi %struct.Memory* [ %call2_40e266, %entry ], [ %114, %block_40e273 ]
...
define %struct.Memory* @routine_jne_.L_40e28e(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i8* %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
