...
declare %struct.Memory* @sub_40eb50._ZN19custom_add_variableIlE8do_shiftEll(%struct.State* noalias dereferenceable(3376), i64, %struct.Memory* noalias readnone returned) local_unnamed_addr
...
define %struct.Memory* @_Z26check_shifted_variable_sumIl19custom_add_variableIlEEvT_S2_(%struct.State* noalias, i64, %struct.Memory* noalias) local_unnamed_addr #1 {
entry:
  ...
  %call2_40eafe = tail call %struct.Memory* @sub_40eb50._ZN19custom_add_variableIlE8do_shiftEll(%struct.State* %0, i64 %61, %struct.Memory* %2)
  ...
  %call2_40eb16 = tail call %struct.Memory* @sub_40e090._Z15tolerance_equalIlEbRT_S1_(%struct.State* %0, i64 %92, %struct.Memory* %call2_40eafe)
  ...
  br i1 %105, label %block_.L_40eb3e, label %block_40eb23
...
block_40eb23:                                     ; preds = %entry
  ...
  %114 = tail call %struct.Memory* @__remill_function_call(%struct.State* %0, i64 ptrtoint (i64 (i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64)* @printf to i64), %struct.Memory* %call2_40eb16)
...
block_.L_40eb3e:                                  ; preds = %block_40eb23, %entry
  %121 = phi i64 [ %106, %entry ], [ %.pre, %block_40eb23 ]
  %MEMORY.0 = phi %struct.Memory* [ %call2_40eb16, %entry ], [ %114, %block_40eb23 ]
...
define %struct.Memory* @routine_callq_._ZN19custom_add_variableIlE8do_shiftEll(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
...
define %struct.Memory* @routine_jne_.L_40eb3e(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i8* %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
