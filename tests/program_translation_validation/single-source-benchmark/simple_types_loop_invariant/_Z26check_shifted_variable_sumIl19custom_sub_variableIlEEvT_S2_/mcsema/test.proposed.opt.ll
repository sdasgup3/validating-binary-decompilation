...
entry:
  ...
  %call2_40e9ce = tail call %struct.Memory* @sub_40e990._ZN19custom_sub_variableIlE8do_shiftEll(%struct.State* %0, i64 %61, %struct.Memory* %2)
  ...
  %call2_40e9e6 = tail call %struct.Memory* @sub_40e090._Z15tolerance_equalIlEbRT_S1_(%struct.State* %0, i64 %92, %struct.Memory* %call2_40e9ce)
  ...
  br i1 %105, label %block_.L_40ea0e, label %block_40e9f3

block_40e9f3:                                     ; preds = %entry
  ...
  %114 = tail call %struct.Memory* @__remill_function_call(%struct.State* %0, i64 ptrtoint (i64 (i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64)* @printf to i64), %struct.Memory* %call2_40e9e6)
  ...
  br label %block_.L_40ea0e

block_.L_40ea0e:                                  ; preds = %block_40e9f3, %entry
  %121 = phi i64 [ %106, %entry ], [ %.pre, %block_40e9f3 ]
  %MEMORY.0 = phi %struct.Memory* [ %call2_40e9e6, %entry ], [ %114, %block_40e9f3 ]
...
define %struct.Memory* @routine_jne_.L_40ea0e(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i8* %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
