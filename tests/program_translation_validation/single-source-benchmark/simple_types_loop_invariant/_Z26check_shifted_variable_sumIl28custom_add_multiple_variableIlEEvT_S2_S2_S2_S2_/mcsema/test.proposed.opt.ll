...
entry:
  ...
  %call2_40ea96 = tail call %struct.Memory* @sub_40ea20._ZN28custom_add_multiple_variableIlE8do_shiftElllll(%struct.State* %0, i64 %91, %struct.Memory* %2)
  ...
  %call2_40eaae = tail call %struct.Memory* @sub_40e090._Z15tolerance_equalIlEbRT_S1_(%struct.State* %0, i64 %122, %struct.Memory* %call2_40ea96)
  ...
  br i1 %135, label %block_.L_40ead6, label %block_40eabb
...
block_40eabb:                                     ; preds = %entry
  ...
  %144 = tail call %struct.Memory* @__remill_function_call(%struct.State* %0, i64 ptrtoint (i64 (i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64)* @printf to i64), %struct.Memory* %call2_40eaae)
...
block_.L_40ead6:                                  ; preds = %block_40eabb, %entry
  %151 = phi i64 [ %136, %entry ], [ %.pre, %block_40eabb ]
  %MEMORY.0 = phi %struct.Memory* [ %call2_40eaae, %entry ], [ %144, %block_40eabb ]
...
define %struct.Memory* @routine_jne_.L_40ead6(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i8* %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
