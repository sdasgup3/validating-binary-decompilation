...
define %struct.Memory* @_Z26check_shifted_variable_sumIl28custom_add_multiple_variableIlEEvT_S2_S2_S2_S2_(%struct.State* noalias, i64, %struct.Memory* noalias) local_unnamed_addr #1 {
entry:
  ...
  %call2_40ead6 = tail call %struct.Memory* @sub_40ea60._ZN28custom_add_multiple_variableIlE8do_shiftElllll(%struct.State* %0, i64 %91, %struct.Memory* %2)
  ...
  %call2_40eaee = tail call %struct.Memory* @sub_40e0d0._Z15tolerance_equalIlEbRT_S1_(%struct.State* %0, i64 %122, %struct.Memory* %call2_40ead6)
  ...
  br i1 %135, label %block_.L_40eb16, label %block_40eafb
...
block_40eafb:                                     ; preds = %entry
  ...
  %144 = tail call %struct.Memory* @__remill_function_call(%struct.State* nonnull %0, i64 ptrtoint (i64 (i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64)* @printf to i64), %struct.Memory* %call2_40eaee)
...
block_.L_40eb16:                                  ; preds = %block_40eafb, %entry
  %151 = phi i64 [ %136, %entry ], [ %.pre, %block_40eafb ]
  %MEMORY.0 = phi %struct.Memory* [ %call2_40eaee, %entry ], [ %144, %block_40eafb ]
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_jne_.L_40eb16(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i8* nocapture %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
