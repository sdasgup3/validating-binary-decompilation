...
declare %struct.Memory* @sub_40e5b0._ZN31custom_divide_multiple_variableIlE8do_shiftElllll(%struct.State* noalias dereferenceable(3376), i64, %struct.Memory* noalias readnone returned) local_unnamed_addr

declare %struct.Memory* @sub_40e0d0._Z15tolerance_equalIlEbRT_S1_(%struct.State* noalias dereferenceable(3376), i64, %struct.Memory* noalias readnone returned) local_unnamed_addr
...
entry:
  ...
  %call2_40e626 = tail call %struct.Memory* @sub_40e5b0._ZN31custom_divide_multiple_variableIlE8do_shiftElllll(%struct.State* %0, i64 %91, %struct.Memory* %2)
  ...
  %call2_40e63e = tail call %struct.Memory* @sub_40e0d0._Z15tolerance_equalIlEbRT_S1_(%struct.State* %0, i64 %122, %struct.Memory* %call2_40e626)
  ...
  br i1 %135, label %block_.L_40e666, label %block_40e64b

block_40e64b:                                     ; preds = %entry
  store i64 ptrtoint (%G__0x414b2e_type* @G__0x414b2e to i64), i64* %RDI.i53, align 8
  ...
  %144 = tail call %struct.Memory* @__remill_function_call(%struct.State* nonnull %0, i64 ptrtoint (i64 (i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64)* @printf to i64), %struct.Memory* %call2_40e63e)
  ...
  br label %block_.L_40e666

block_.L_40e666:                                  ; preds = %block_40e64b, %entry
  %151 = phi i64 [ %136, %entry ], [ %.pre, %block_40e64b ]
  %MEMORY.0 = phi %struct.Memory* [ %call2_40e63e, %entry ], [ %144, %block_40e64b ]
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_jne_.L_40e666(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i8* nocapture %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
