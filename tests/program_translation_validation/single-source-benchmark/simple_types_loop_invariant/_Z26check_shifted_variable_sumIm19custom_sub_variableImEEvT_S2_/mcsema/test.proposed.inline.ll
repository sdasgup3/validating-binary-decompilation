...
block_40de1a:                                     ; preds = %routine_ucomisd__xmm0___xmm1.exit
  ...
  %call2_40de2d = call %struct.Memory* @sub_4006c0.printf_plt(%struct.State* %0, i64 %loadPC_40de2d, %struct.Memory* %loadMem2_40de2d)
  store %struct.Memory* %call2_40de2d, %struct.Memory** %MEMORY
