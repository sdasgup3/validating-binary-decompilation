...
%G_0x20c300__rip__4251016__type = type <{ [16 x i8] }>
%G_0x60b0__rip__4251024__type = type <{ [16 x i8] }>
...
@G_0x20c300__rip__4251016_ = global %G_0x20c300__rip__4251016__type zeroinitializer
@G_0x60b0__rip__4251024_ = global %G_0x60b0__rip__4251024__type zeroinitializer
...
entry:
  ...
  %loadMem_40dd70 = load %struct.Memory*, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_40dd70, %struct.Memory** %MEMORY
  ...
  store i64 %78, i64* %81
  store %struct.Memory* %loadMem_40dd78, %struct.Memory** %MEMORY
  ...
  %106 = load double, double* bitcast (%G_0x20c300__rip__4251016__type* @G_0x20c300__rip__4251016_ to double*)
  ...
  %119 = load double, double* bitcast (%G_0x60b0__rip__4251024__type* @G_0x60b0__rip__4251024_ to double*)
  ...
  store %struct.Memory* %loadMem_40dd90, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_40dd93, %struct.Memory** %MEMORY
  %loadMem_40dd97 = load %struct.Memory*, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_40dd97, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_40dda6, %struct.Memory** %MEMORY
...
; <label>:271:                                    ; preds = %263
  ...
  %274 = call %struct.Memory* @__remill_error(%struct.State* nonnull dereferenceable(3376) %0, i64 %273, %struct.Memory* %loadMem_40ddae)
...
routine_ucomisd__xmm0___xmm1.exit:                ; preds = %271, %288
  %292 = phi %struct.Memory* [ %274, %271 ], [ %loadMem_40ddae, %288 ]
  ...
  %call2_40ddc5 = call %struct.Memory* @sub_40dd50._ZN19custom_sub_variableImE8do_shiftEmm(%struct.State* %0, i64 %loadPC_40ddc5, %struct.Memory* %loadMem2_40ddc5)
  ...
  %loadMem1_40dddd = load %struct.Memory*, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem1_40dddd, %struct.Memory** %MEMORY
  %loadMem2_40dddd = load %struct.Memory*, %struct.Memory** %MEMORY
  %loadPC_40dddd = load i64, i64* %3
  %call2_40dddd = call %struct.Memory* @sub_40d140._Z15tolerance_equalImEbRT_S1_(%struct.State* %0, i64 %loadPC_40dddd, %struct.Memory* %loadMem2_40dddd)
  store %struct.Memory* %call2_40dddd, %struct.Memory** %MEMORY
  ...
  %loadBr_40dde4 = load i8, i8* %BRANCH_TAKEN
  %cmpBr_40dde4 = icmp eq i8 %loadBr_40dde4, 1
  br i1 %cmpBr_40dde4, label %block_.L_40de05, label %block_40ddea

block_40ddea:                                     ; preds = %routine_ucomisd__xmm0___xmm1.exit
  ...
  %loadMem1_40ddfd = load %struct.Memory*, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem1_40ddfd, %struct.Memory** %MEMORY
  %loadMem2_40ddfd = load %struct.Memory*, %struct.Memory** %MEMORY
  %loadPC_40ddfd = load i64, i64* %3
  %554 = call %struct.Memory* @__remill_function_call(%struct.State* %0, i64 ptrtoint (i64 (i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64)* @printf to i64), %struct.Memory* %loadMem2_40ddfd)
...
block_.L_40de05:                                  ; preds = %block_40ddea, %routine_ucomisd__xmm0___xmm1.exit
  ...
  ret %struct.Memory* %loadMem_40de0a
}
...
define %struct.Memory* @routine_movsd_0x20c300__rip____xmm0(%struct.State* dereferenceable(3376), i64, %struct.Memory*) {
block_400478:
  %3 = getelementptr inbounds %struct.State, %struct.State* %0, i32 0, i32 6
  %4 = getelementptr inbounds %struct.GPR, %struct.GPR* %3, i32 0, i32 33
  %5 = getelementptr inbounds %struct.Reg, %struct.Reg* %4, i32 0, i32 0
  ...
  %9 = load i64, i64* %PC
  %10 = ptrtoint %G_0x20c300__rip__4251016__type* @G_0x20c300__rip__4251016_ to i64
  %11 = load i64, i64* %PC
  %12 = add i64 %11, 8
  store i64 %12, i64* %PC
...
block_400478:
  ...
  %9 = load i64, i64* %PC
  %10 = ptrtoint %G_0x60b0__rip__4251024__type* @G_0x60b0__rip__4251024_ to i64
  %11 = load i64, i64* %PC
  %12 = add i64 %11, 8
  store i64 %12, i64* %PC
  %13 = inttoptr i64 %10 to double*
...
define %struct.Memory* @routine_jne_.L_40de05(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i8* %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) {
block_400478:
  %3 = getelementptr inbounds %struct.State, %struct.State* %0, i32 0, i32 6
  %4 = getelementptr inbounds %struct.GPR, %struct.GPR* %3, i32 0, i32 33
  %5 = getelementptr inbounds %struct.Reg, %struct.Reg* %4, i32 0, i32 0
