...
@G_0x20c300__rip_ = local_unnamed_addr global %G_0x20c300__rip__type zeroinitializer
@G_0x60b0__rip_ = local_unnamed_addr global %G_0x60b0__rip__type zeroinitializer
...
entry:
  ...
  %30 = load double, double* bitcast (%G_0x20c300__rip__type* @G_0x20c300__rip_ to double*), align 8
  ...
  %35 = load double, double* bitcast (%G_0x60b0__rip__type* @G_0x60b0__rip_ to double*), align 8
...
routine_ucomisd__xmm0___xmm1.exit:                ; preds = %96, %84
  ...
  %call2_40ddc5 = tail call %struct.Memory* @sub_40dd50._ZN19custom_sub_variableImE8do_shiftEmm(%struct.State* %0, i64 %123, %struct.Memory* %104)
  ...
  %call2_40dddd = tail call %struct.Memory* @sub_40d140._Z15tolerance_equalImEbRT_S1_(%struct.State* %0, i64 %154, %struct.Memory* %call2_40ddc5)
  ...
  br i1 %167, label %block_.L_40de05, label %block_40ddea
...
block_40ddea:                                     ; preds = %routine_ucomisd__xmm0___xmm1.exit
  ...
  %176 = tail call %struct.Memory* @__remill_function_call(%struct.State* %0, i64 ptrtoint (i64 (i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64)* @printf to i64), %struct.Memory* %call2_40dddd)
...
block_.L_40de05:                                  ; preds = %block_40ddea, %routine_ucomisd__xmm0___xmm1.exit
  %183 = phi i64 [ %168, %routine_ucomisd__xmm0___xmm1.exit ], [ %.pre5, %block_40ddea ]
  %MEMORY.0 = phi %struct.Memory* [ %call2_40dddd, %routine_ucomisd__xmm0___xmm1.exit ], [ %176, %block_40ddea ]
...
define %struct.Memory* @routine_movsd_0x20c300__rip____xmm0(%struct.State* dereferenceable(3376), i64, %struct.Memory*) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, 8
  store i64 %4, i64* %PC, align 8
  %5 = load i64, i64* bitcast (%G_0x20c300__rip__type* @G_0x20c300__rip_ to i64*), align 8
...
define %struct.Memory* @routine_movsd_0x60b0__rip____xmm1(%struct.State* dereferenceable(3376), i64, %struct.Memory*) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, 8
  store i64 %4, i64* %PC, align 8
  %5 = load i64, i64* bitcast (%G_0x60b0__rip__type* @G_0x60b0__rip_ to i64*), align 8
...
define %struct.Memory* @routine_jne_.L_40de05(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i8* %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
