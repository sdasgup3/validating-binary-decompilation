...
%G_0x20cb60__rip__4248872__type = type <{ [16 x i8] }>
%G_0x61a0a8_type = type <{ [4 x i8] }>
%G_0x6910__rip__4248880__type = type <{ [16 x i8] }>
...
@G_0x20cb60__rip__4248872_ = local_unnamed_addr global %G_0x20cb60__rip__4248872__type zeroinitializer
@G_0x61a0a8 = local_unnamed_addr global %G_0x61a0a8_type zeroinitializer
@G_0x6910__rip__4248880_ = local_unnamed_addr global %G_0x6910__rip__4248880__type zeroinitializer
...
declare %struct.Memory* @sub_40d4f0._ZN19custom_variable_andImE8do_shiftEmm(%struct.State* noalias dereferenceable(3376), i64, %struct.Memory* noalias readnone returned) local_unnamed_addr
...
entry:
  ...
  %18 = add i64 %7, -16
  %19 = load i64, i64* %RDI.i68, align 8
  %20 = add i64 %10, 11
  ...
  %23 = add i64 %22, -16
  %24 = load i64, i64* %RSI.i65, align 8
  ...
  %30 = load double, double* bitcast (%G_0x20cb60__rip__4248872__type* @G_0x20cb60__rip__4248872_ to double*), align 8
  %31 = bitcast [32 x %union.VectorReg]* %28 to double*
  ...
  %35 = load double, double* bitcast (%G_0x6910__rip__4248880__type* @G_0x6910__rip__4248880_ to double*), align 8
  %36 = bitcast %union.VectorReg* %34 to double*
  store double %35, double* %36, align 1
  ...
  %39 = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 1, i64 2
  %40 = bitcast %union.VectorReg* %39 to i8*
  %41 = bitcast double %30 to <2 x i32>
  %42 = extractelement <2 x i32> %41, i32 0
  %43 = bitcast %union.VectorReg* %39 to i32*
  store i32 %42, i32* %43, align 1
  %44 = extractelement <2 x i32> %41, i32 1
  ...
  %51 = bitcast %union.VectorReg* %39 to double*
  %52 = load double, double* %51, align 1
  %53 = fsub double %52, %35
  store double %53, double* %51, align 1
  %54 = tail call double @llvm.trunc.f64(double %53)
  %55 = tail call double @llvm.fabs.f64(double %54)
  %56 = fcmp ogt double %55, 0x43E0000000000000
  %57 = fptosi double %54 to i64
  %.op = xor i64 %57, -9223372036854775808
  %58 = select i1 %56, i64 0, i64 %.op
  store i64 %58, i64* %RSI.i65, align 8
  ...
  %69 = tail call double @llvm.trunc.f64(double %30)
  %70 = tail call double @llvm.fabs.f64(double %69)
  %71 = fcmp ogt double %70, 0x43E0000000000000
  %72 = fptosi double %69 to i64
  %73 = select i1 %71, i64 -9223372036854775808, i64 %72
  store i64 %73, i64* %RDI.i68, align 8
  %74 = add i64 %29, 50
  store i64 %74, i64* %3, align 8
  %75 = fcmp uno double %35, %30
  br i1 %75, label %76, label %86

; <label>:76:                                     ; preds = %entry
  %77 = fadd double %35, %30
...
; <label>:84:                                     ; preds = %76
  %85 = tail call %struct.Memory* @__remill_error(%struct.State* nonnull dereferenceable(3376) %0, i64 %74, %struct.Memory* %2)
...
; <label>:86:                                     ; preds = %entry
  %87 = fcmp ogt double %35, %30
  br i1 %87, label %92, label %88

; <label>:88:                                     ; preds = %86
  %89 = fcmp olt double %35, %30
  br i1 %89, label %92, label %90

; <label>:90:                                     ; preds = %88
  %91 = fcmp oeq double %35, %30
...
; <label>:96:                                     ; preds = %92, %90
  %97 = phi i8 [ %93, %92 ], [ %66, %90 ]
  %98 = phi i8 [ %95, %92 ], [ 0, %90 ]
  store i8 0, i8* %17, align 1
  store i8 0, i8* %16, align 1
  store i8 0, i8* %14, align 1
  br label %routine_ucomisd__xmm0___xmm1.exit

routine_ucomisd__xmm0___xmm1.exit:                ; preds = %96, %84
  %99 = phi i64 [ %.pre4, %84 ], [ %58, %96 ]
  %100 = phi i8 [ %.pre3, %84 ], [ %97, %96 ]
  %101 = phi i8 [ %.pre2, %84 ], [ %98, %96 ]
  %102 = phi i64 [ %.pre1, %84 ], [ %74, %96 ]
  %103 = phi i64 [ %.pre, %84 ], [ %73, %96 ]
  %104 = phi %struct.Memory* [ %85, %84 ], [ %2, %96 ]
  %105 = or i8 %100, %101
  %106 = icmp eq i8 %105, 0
  %107 = select i1 %106, i64 %103, i64 %99
  store i64 %107, i64* %RSI.i65, align 8
  ...
  %116 = load i64, i64* %RSI.i65, align 8
  %117 = load i64, i64* %3, align 8
  store i64 %116, i64* %RDI.i68, align 8
  ...
  store i64 %122, i64* %RSI.i65, align 8
  %123 = add i64 %117, -110
  %124 = add i64 %117, 12
  ...
  %call2_40d565 = tail call %struct.Memory* @sub_40d4f0._ZN19custom_variable_andImE8do_shiftEmm(%struct.State* %0, i64 %123, %struct.Memory* %104)
  %128 = load i64, i64* %RBP.i, align 8
  %129 = add i64 %128, -8
  %130 = load i64, i64* %3, align 8
  store i64 %129, i64* %RDI.i68, align 8
  %131 = add i64 %128, -24
  store i64 %131, i64* %RSI.i65, align 8
  %132 = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 1, i32 0
  %RAX.i21 = getelementptr inbounds %union.anon, %union.anon* %132, i64 0, i32 0
  %133 = load i64, i64* %RAX.i21, align 8
  %134 = sext i64 %133 to i128
  %135 = and i128 %134, -18446744073709551616
  %136 = zext i64 %133 to i128
  %137 = or i128 %135, %136
  %138 = mul nsw i128 %137, 8000
  %139 = trunc i128 %138 to i64
  store i64 %139, i64* %RAX.i21, align 8
  ...
  %152 = inttoptr i64 %131 to i64*
  store i64 %139, i64* %152, align 8
  %153 = load i64, i64* %3, align 8
  %154 = add i64 %153, -1085
  %155 = add i64 %153, 5
  ...
  %call2_40d57d = tail call %struct.Memory* @sub_40d140._Z15tolerance_equalImEbRT_S1_(%struct.State* %0, i64 %154, %struct.Memory* %call2_40d565)
  %AL.i16 = bitcast %union.anon* %132 to i8*
  %159 = load i8, i8* %AL.i16, align 1
  ...
  %.v = select i1 %167, i64 35, i64 8
  %168 = add i64 %160, %.v
  store i64 %168, i64* %3, align 8
  br i1 %167, label %block_.L_40d5a5, label %block_40d58a

block_40d58a:                                     ; preds = %routine_ucomisd__xmm0___xmm1.exit
  store i64 ptrtoint (%G__0x414aee_type* @G__0x414aee to i64), i64* %RDI.i68, align 8
  %169 = load i32, i32* bitcast (%G_0x61a0a8_type* @G_0x61a0a8 to i32*), align 8
  %170 = zext i32 %169 to i64
  store i64 %170, i64* %RSI.i65, align 8
  store i8 0, i8* %AL.i16, align 1
  %171 = add i64 %168, -53002
  %172 = add i64 %168, 24
  ...
  %176 = tail call %struct.Memory* @__remill_function_call(%struct.State* %0, i64 ptrtoint (i64 (i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64)* @printf to i64), %struct.Memory* %call2_40d57d)
  ...
  br label %block_.L_40d5a5

block_.L_40d5a5:                                  ; preds = %block_40d58a, %routine_ucomisd__xmm0___xmm1.exit
  %183 = phi i64 [ %168, %routine_ucomisd__xmm0___xmm1.exit ], [ %.pre5, %block_40d58a ]
  %MEMORY.0 = phi %struct.Memory* [ %call2_40d57d, %routine_ucomisd__xmm0___xmm1.exit ], [ %176, %block_40d58a ]
  %184 = load i64, i64* %6, align 8
  %185 = add i64 %184, 48
  store i64 %185, i64* %6, align 8
  %186 = icmp ugt i64 %184, -49
  ...
  store i64 %211, i64* %RBP.i, align 8
...
define %struct.Memory* @routine_movsd_0x20cb60__rip____xmm0(%struct.State* dereferenceable(3376), i64, %struct.Memory*) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, 8
  store i64 %4, i64* %PC, align 8
  %5 = load i64, i64* bitcast (%G_0x20cb60__rip__4248872__type* @G_0x20cb60__rip__4248872_ to i64*), align 8
...
define %struct.Memory* @routine_movsd_0x6910__rip____xmm1(%struct.State* dereferenceable(3376), i64, %struct.Memory*) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, 8
  store i64 %4, i64* %PC, align 8
  %5 = load i64, i64* bitcast (%G_0x6910__rip__4248880__type* @G_0x6910__rip__4248880_ to i64*), align 8
...
define %struct.Memory* @routine_cvttsd2si__xmm2___rsi(%struct.State* dereferenceable(3376), i64, %struct.Memory*) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %RSI = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 9, i32 0, i32 0
  %3 = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 1, i64 2
...
define %struct.Memory* @routine_xorq__rdi___rsi(%struct.State* dereferenceable(3376), i64, %struct.Memory*) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %RSI = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 9, i32 0, i32 0
  %RDI = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 11, i32 0, i32 0
...
define %struct.Memory* @routine_cvttsd2si__xmm0___rdi(%struct.State* dereferenceable(3376), i64, %struct.Memory*) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %RDI = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 11, i32 0, i32 0
...
define %struct.Memory* @routine_cmovaq__rdi___rsi(%struct.State* dereferenceable(3376), i64, %struct.Memory*) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %RSI = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 9, i32 0, i32 0
  %RDI = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 11, i32 0, i32 0
...
define %struct.Memory* @routine_movq__rdi__MINUS0x20__rbp_(%struct.State* dereferenceable(3376), i64, %struct.Memory*) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %RDI = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 11, i32 0, i32 0
  %RBP = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 15, i32 0, i32 0
...
define %struct.Memory* @routine_callq_._ZN19custom_variable_andImE8do_shiftEmm(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
...
define %struct.Memory* @routine_jne_.L_40d5a5(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i8* %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
