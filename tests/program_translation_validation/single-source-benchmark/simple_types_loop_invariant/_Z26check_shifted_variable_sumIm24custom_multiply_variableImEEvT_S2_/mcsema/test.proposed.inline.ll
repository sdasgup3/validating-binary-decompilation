...
entry:
  ...
  store %struct.Memory* %loadMem_40dbe0, %struct.Memory** %MEMORY
  ...
  store i64 %78, i64* %81
  store %struct.Memory* %loadMem_40dbe8, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_40dc07, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_40dc0c, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_40dc16, %struct.Memory** %MEMORY
...
; <label>:275:                                    ; preds = %267
  ...
  %278 = call %struct.Memory* @__remill_error(%struct.State* nonnull dereferenceable(3376) %0, i64 %277, %struct.Memory* %loadMem_40dc1e)
...
routine_ucomisd__xmm0___xmm1.exit:                ; preds = %275, %292
  %296 = phi %struct.Memory* [ %278, %275 ], [ %loadMem_40dc1e, %292 ]
  ...
  store %struct.Memory* %loadMem_40dc2e, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem1_40dc35, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem1_40dc4d, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_40dc54, %struct.Memory** %MEMORY
...
block_40dc5a:                                     ; preds = %routine_ucomisd__xmm0___xmm1.exit
  ...
  store %struct.Memory* %loadMem_40dc6b, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem1_40dc6d, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_40dc72, %struct.Memory** %MEMORY
  br label %block_.L_40dc75

block_.L_40dc75:                                  ; preds = %block_40dc5a, %routine_ucomisd__xmm0___xmm1.exit
  ...
  store %struct.Memory* %loadMem_40dc75, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_40dc79, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_40dc7a, %struct.Memory** %MEMORY
  ret %struct.Memory* %loadMem_40dc7a
}
...
define %struct.Memory* @routine_movsd_0x20c490__rip____xmm0(%struct.State* dereferenceable(3376), i64, %struct.Memory*) {
block_400488:
  %3 = getelementptr inbounds %struct.State, %struct.State* %0, i32 0, i32 6
  %4 = getelementptr inbounds %struct.GPR, %struct.GPR* %3, i32 0, i32 33
  %5 = getelementptr inbounds %struct.Reg, %struct.Reg* %4, i32 0, i32 0
