...
declare %struct.Memory* @sub_40d260._ZN27custom_multiple_variable_orImE8do_shiftEmmmmm(%struct.State* dereferenceable(3376), i64, %struct.Memory*) local_unnamed_addr
