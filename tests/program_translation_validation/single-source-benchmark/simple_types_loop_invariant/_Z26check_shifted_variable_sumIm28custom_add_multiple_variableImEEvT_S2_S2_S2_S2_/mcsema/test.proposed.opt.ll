...
block_40df12:                                     ; preds = %routine_ucomisd__xmm0___xmm1.exit
  ...
  %call2_40df25 = tail call %struct.Memory* @sub_4006c0.printf_plt(%struct.State* nonnull %0, i64 %229, %struct.Memory* %call2_40df05)
...
block_.L_40df2d:                                  ; preds = %block_40df12, %routine_ucomisd__xmm0___xmm1.exit
  %240 = phi i64 [ %226, %routine_ucomisd__xmm0___xmm1.exit ], [ %.pre5, %block_40df12 ]
  %MEMORY.0 = phi %struct.Memory* [ %call2_40df05, %routine_ucomisd__xmm0___xmm1.exit ], [ %call2_40df25, %block_40df12 ]
