...
@G_0x20c214__rip__4251252_ = local_unnamed_addr global %G_0x20c214__rip__4251252__type zeroinitializer
@G_0x5fc4__rip__4251260_ = local_unnamed_addr global %G_0x5fc4__rip__4251260__type zeroinitializer
...
define %struct.Memory* @_Z26check_shifted_variable_sumIm28custom_add_multiple_variableImEEvT_S2_S2_S2_S2_(%struct.State* noalias, i64, %struct.Memory* noalias) local_unnamed_addr #1 {
entry:
  ...
  %48 = load double, double* bitcast (%G_0x20c214__rip__4251252__type* @G_0x20c214__rip__4251252_ to double*), align 8
  ...
  %53 = load double, double* bitcast (%G_0x5fc4__rip__4251260__type* @G_0x5fc4__rip__4251260_ to double*), align 8
...
routine_ucomisd__xmm0___xmm1.exit:                ; preds = %114, %102
  ...
  %call2_40debd = tail call %struct.Memory* @sub_40de10._ZN28custom_add_multiple_variableImE8do_shiftEmmmmm(%struct.State* %0, i64 %153, %struct.Memory* %122)
  ...
  %call2_40ded5 = tail call %struct.Memory* @sub_40d140._Z15tolerance_equalImEbRT_S1_(%struct.State* %0, i64 %184, %struct.Memory* %call2_40debd)
  ...
  br i1 %197, label %block_.L_40defd, label %block_40dee2
...
block_40dee2:                                     ; preds = %routine_ucomisd__xmm0___xmm1.exit
  ...
  %206 = tail call %struct.Memory* @__remill_function_call(%struct.State* %0, i64 ptrtoint (i64 (i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64)* @printf to i64), %struct.Memory* %call2_40ded5)
...
block_.L_40defd:                                  ; preds = %block_40dee2, %routine_ucomisd__xmm0___xmm1.exit
  %213 = phi i64 [ %198, %routine_ucomisd__xmm0___xmm1.exit ], [ %.pre5, %block_40dee2 ]
  %MEMORY.0 = phi %struct.Memory* [ %call2_40ded5, %routine_ucomisd__xmm0___xmm1.exit ], [ %206, %block_40dee2 ]
...
define %struct.Memory* @routine_movsd_0x20c214__rip____xmm0(%struct.State* dereferenceable(3376), i64, %struct.Memory*) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, 8
  store i64 %4, i64* %PC, align 8
  %5 = load i64, i64* bitcast (%G_0x20c214__rip__4251252__type* @G_0x20c214__rip__4251252_ to i64*), align 8
...
define %struct.Memory* @routine_movsd_0x5fc4__rip____xmm1(%struct.State* dereferenceable(3376), i64, %struct.Memory*) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, 8
  store i64 %4, i64* %PC, align 8
  %5 = load i64, i64* bitcast (%G_0x5fc4__rip__4251260__type* @G_0x5fc4__rip__4251260_ to i64*), align 8
...
define %struct.Memory* @routine_jne_.L_40defd(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i8* %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
