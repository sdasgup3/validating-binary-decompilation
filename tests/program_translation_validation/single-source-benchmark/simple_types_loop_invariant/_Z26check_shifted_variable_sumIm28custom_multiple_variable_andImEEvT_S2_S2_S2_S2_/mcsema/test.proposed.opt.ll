...
declare %struct.Memory* @sub_40d420._ZN28custom_multiple_variable_andImE8do_shiftEmmmmm(%struct.State* dereferenceable(3376), i64, %struct.Memory*) local_unnamed_addr
