...
declare %struct.Memory* @sub_40d070._ZN28custom_multiple_variable_xorImE8do_shiftEmmmmm(%struct.State* dereferenceable(3376), i64, %struct.Memory*) local_unnamed_addr
