...
block_40dd52:                                     ; preds = %routine_ucomisd__xmm0___xmm1.exit
  ...
  %call2_40dd65 = tail call %struct.Memory* @sub_4006c0.printf_plt(%struct.State* nonnull %0, i64 %229, %struct.Memory* %call2_40dd45)
...
block_.L_40dd6d:                                  ; preds = %block_40dd52, %routine_ucomisd__xmm0___xmm1.exit
  %240 = phi i64 [ %226, %routine_ucomisd__xmm0___xmm1.exit ], [ %.pre5, %block_40dd52 ]
  %MEMORY.0 = phi %struct.Memory* [ %call2_40dd45, %routine_ucomisd__xmm0___xmm1.exit ], [ %call2_40dd65, %block_40dd52 ]
