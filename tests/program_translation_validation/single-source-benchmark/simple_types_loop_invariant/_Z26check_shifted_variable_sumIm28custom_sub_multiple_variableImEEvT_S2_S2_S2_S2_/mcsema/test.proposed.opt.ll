...
declare %struct.Memory* @sub_40dc80._ZN28custom_sub_multiple_variableImE8do_shiftEmmmmm(%struct.State* dereferenceable(3376), i64, %struct.Memory*) local_unnamed_addr
