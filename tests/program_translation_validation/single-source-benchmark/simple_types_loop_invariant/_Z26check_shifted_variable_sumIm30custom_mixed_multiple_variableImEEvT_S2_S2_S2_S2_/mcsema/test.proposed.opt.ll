...
declare %struct.Memory* @sub_40d5e0._ZN30custom_mixed_multiple_variableImE8do_shiftEmmmmm(%struct.State* dereferenceable(3376), i64, %struct.Memory*) local_unnamed_addr

declare %struct.Memory* @sub_40d170._Z15tolerance_equalImEbRT_S1_(%struct.State* dereferenceable(3376), i64, %struct.Memory*) local_unnamed_addr
