...
block_40d8d2:                                     ; preds = %routine_ucomisd__xmm0___xmm1.exit
  ...
  %call2_40d8e5 = tail call %struct.Memory* @sub_4006c0.printf_plt(%struct.State* nonnull %0, i64 %229, %struct.Memory* %call2_40d8c5)
...
block_.L_40d8ed:                                  ; preds = %block_40d8d2, %routine_ucomisd__xmm0___xmm1.exit
  %240 = phi i64 [ %226, %routine_ucomisd__xmm0___xmm1.exit ], [ %.pre5, %block_40d8d2 ]
  %MEMORY.0 = phi %struct.Memory* [ %call2_40d8c5, %routine_ucomisd__xmm0___xmm1.exit ], [ %call2_40d8e5, %block_40d8d2 ]
