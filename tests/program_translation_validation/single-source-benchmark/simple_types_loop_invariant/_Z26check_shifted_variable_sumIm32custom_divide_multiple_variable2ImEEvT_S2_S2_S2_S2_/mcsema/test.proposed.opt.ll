...
@G_0x20c964__rip__4249380_ = local_unnamed_addr global %G_0x20c964__rip__4249380__type zeroinitializer
@G_0x61a0a8 = local_unnamed_addr global %G_0x61a0a8_type zeroinitializer
@G_0x6714__rip__4249388_ = local_unnamed_addr global %G_0x6714__rip__4249388__type zeroinitializer
...
define %struct.Memory* @_Z26check_shifted_variable_sumIm32custom_divide_multiple_variable2ImEEvT_S2_S2_S2_S2_(%struct.State* noalias, i64, %struct.Memory* noalias) local_unnamed_addr #1 {
entry:
  ...
  %48 = load double, double* bitcast (%G_0x20c964__rip__4249380__type* @G_0x20c964__rip__4249380_ to double*), align 8
  ...
  %53 = load double, double* bitcast (%G_0x6714__rip__4249388__type* @G_0x6714__rip__4249388_ to double*), align 8
...
routine_ucomisd__xmm0___xmm1.exit:                ; preds = %114, %102
  ...
  %call2_40d76d = tail call %struct.Memory* @sub_40d6b0._ZN32custom_divide_multiple_variable2ImE8do_shiftEmmmmm(%struct.State* %0, i64 %153, %struct.Memory* %122)
  ...
  %call2_40d785 = tail call %struct.Memory* @sub_40d140._Z15tolerance_equalImEbRT_S1_(%struct.State* %0, i64 %184, %struct.Memory* %call2_40d76d)
  ...
  br i1 %197, label %block_.L_40d7ad, label %block_40d792
...
block_40d792:                                     ; preds = %routine_ucomisd__xmm0___xmm1.exit
  ...
  %206 = tail call %struct.Memory* @__remill_function_call(%struct.State* %0, i64 ptrtoint (i64 (i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64)* @printf to i64), %struct.Memory* %call2_40d785)
...
block_.L_40d7ad:                                  ; preds = %block_40d792, %routine_ucomisd__xmm0___xmm1.exit
  %213 = phi i64 [ %198, %routine_ucomisd__xmm0___xmm1.exit ], [ %.pre5, %block_40d792 ]
  %MEMORY.0 = phi %struct.Memory* [ %call2_40d785, %routine_ucomisd__xmm0___xmm1.exit ], [ %206, %block_40d792 ]
...
define %struct.Memory* @routine_movsd_0x20c964__rip____xmm0(%struct.State* dereferenceable(3376), i64, %struct.Memory*) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, 8
  store i64 %4, i64* %PC, align 8
  %5 = load i64, i64* bitcast (%G_0x20c964__rip__4249380__type* @G_0x20c964__rip__4249380_ to i64*), align 8
...
define %struct.Memory* @routine_movsd_0x6714__rip____xmm1(%struct.State* dereferenceable(3376), i64, %struct.Memory*) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, 8
  store i64 %4, i64* %PC, align 8
  %5 = load i64, i64* bitcast (%G_0x6714__rip__4249388__type* @G_0x6714__rip__4249388_ to i64*), align 8
...
define %struct.Memory* @routine_jne_.L_40d7ad(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i8* %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
