...
block_40db92:                                     ; preds = %routine_ucomisd__xmm0___xmm1.exit
  ...
  %call2_40dba5 = tail call %struct.Memory* @sub_4006c0.printf_plt(%struct.State* nonnull %0, i64 %229, %struct.Memory* %call2_40db85)
...
block_.L_40dbad:                                  ; preds = %block_40db92, %routine_ucomisd__xmm0___xmm1.exit
  %240 = phi i64 [ %226, %routine_ucomisd__xmm0___xmm1.exit ], [ %.pre5, %block_40db92 ]
  %MEMORY.0 = phi %struct.Memory* [ %call2_40db85, %routine_ucomisd__xmm0___xmm1.exit ], [ %call2_40dba5, %block_40db92 ]
