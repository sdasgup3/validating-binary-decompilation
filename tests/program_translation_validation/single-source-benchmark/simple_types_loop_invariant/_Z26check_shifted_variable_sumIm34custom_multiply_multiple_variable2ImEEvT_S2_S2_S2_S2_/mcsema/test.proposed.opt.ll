...
block_40da92:                                     ; preds = %routine_ucomisd__xmm0___xmm1.exit
  ...
  %call2_40daa5 = tail call %struct.Memory* @sub_4006c0.printf_plt(%struct.State* nonnull %0, i64 %229, %struct.Memory* %call2_40da85)
...
block_.L_40daad:                                  ; preds = %block_40da92, %routine_ucomisd__xmm0___xmm1.exit
  %240 = phi i64 [ %226, %routine_ucomisd__xmm0___xmm1.exit ], [ %.pre5, %block_40da92 ]
  %MEMORY.0 = phi %struct.Memory* [ %call2_40da85, %routine_ucomisd__xmm0___xmm1.exit ], [ %call2_40daa5, %block_40da92 ]
