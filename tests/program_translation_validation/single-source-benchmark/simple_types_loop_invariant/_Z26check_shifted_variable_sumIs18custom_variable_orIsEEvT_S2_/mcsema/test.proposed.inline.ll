...
%G_0x208bfa__rip__4265102__type = type <{ [16 x i8] }>
...
@G_0x208bfa__rip__4265102_ = global %G_0x208bfa__rip__4265102__type zeroinitializer
...
declare %struct.Memory* @sub_411440._ZN18custom_variable_orIsE8do_shiftEss(%struct.State* noalias dereferenceable(3376), i64, %struct.Memory* noalias readnone returned)
...
define %struct.Memory* @_Z26check_shifted_variable_sumIs18custom_variable_orIsEEvT_S2_(%struct.State* noalias, i64, %struct.Memory* noalias) #2 {
entry:
  ...
  store %struct.Memory* %loadMem_411470, %struct.Memory** %MEMORY
  ...
  %loadMem_411474 = load %struct.Memory*, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_411474, %struct.Memory** %MEMORY
  %loadMem_411478 = load %struct.Memory*, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_411478, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_41147b, %struct.Memory** %MEMORY
  %loadMem_41147e = load %struct.Memory*, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_41147e, %struct.Memory** %MEMORY
  ...
  %loadMem_411486 = load %struct.Memory*, %struct.Memory** %MEMORY
  ...
  %134 = load double, double* bitcast (%G_0x208bfa__rip__4265102__type* @G_0x208bfa__rip__4265102_ to double*)
  ...
  store %struct.Memory* %loadMem_411486, %struct.Memory** %MEMORY
  %loadMem_41148e = load %struct.Memory*, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_41148e, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_411492, %struct.Memory** %MEMORY
  ...
  %loadMem_411498 = load %struct.Memory*, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_411498, %struct.Memory** %MEMORY
  %loadMem1_41149c = load %struct.Memory*, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem1_41149c, %struct.Memory** %MEMORY
  %loadMem2_41149c = load %struct.Memory*, %struct.Memory** %MEMORY
  %loadPC_41149c = load i64, i64* %3
  %call2_41149c = call %struct.Memory* @sub_411440._ZN18custom_variable_orIsE8do_shiftEss(%struct.State* %0, i64 %loadPC_41149c, %struct.Memory* %loadMem2_41149c)
  store %struct.Memory* %call2_41149c, %struct.Memory** %MEMORY
  %loadMem_4114a1 = load %struct.Memory*, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_4114a1, %struct.Memory** %MEMORY
  %loadMem_4114a5 = load %struct.Memory*, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_4114a5, %struct.Memory** %MEMORY
  ...
  %loadMem1_4114b9 = load %struct.Memory*, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem1_4114b9, %struct.Memory** %MEMORY
  %loadMem2_4114b9 = load %struct.Memory*, %struct.Memory** %MEMORY
  %loadPC_4114b9 = load i64, i64* %3
  %call2_4114b9 = call %struct.Memory* @sub_411210._Z15tolerance_equalIsEbRT_S1_(%struct.State* %0, i64 %loadPC_4114b9, %struct.Memory* %loadMem2_4114b9)
  store %struct.Memory* %call2_4114b9, %struct.Memory** %MEMORY
  %loadMem_4114be = load %struct.Memory*, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_4114be, %struct.Memory** %MEMORY
  ...
  %loadBr_4114c0 = load i8, i8* %BRANCH_TAKEN
  %cmpBr_4114c0 = icmp eq i8 %loadBr_4114c0, 1
  br i1 %cmpBr_4114c0, label %block_.L_4114e1, label %block_4114c6

block_4114c6:                                     ; preds = %entry
  %loadMem_4114c6 = load %struct.Memory*, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_4114c6, %struct.Memory** %MEMORY
  %loadMem_4114d0 = load %struct.Memory*, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_4114d0, %struct.Memory** %MEMORY
  %loadMem_4114d7 = load %struct.Memory*, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_4114d7, %struct.Memory** %MEMORY
  %loadMem1_4114d9 = load %struct.Memory*, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem1_4114d9, %struct.Memory** %MEMORY
  %loadMem2_4114d9 = load %struct.Memory*, %struct.Memory** %MEMORY
  %loadPC_4114d9 = load i64, i64* %3
  %422 = call %struct.Memory* @__remill_function_call(%struct.State* %0, i64 ptrtoint (i64 (i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64)* @printf to i64), %struct.Memory* %loadMem2_4114d9)
  store %struct.Memory* %422, %struct.Memory** %MEMORY
  %loadMem_4114de = load %struct.Memory*, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_4114de, %struct.Memory** %MEMORY
  br label %block_.L_4114e1

block_.L_4114e1:                                  ; preds = %block_4114c6, %entry
  ...
  %loadMem_4114e5 = load %struct.Memory*, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_4114e5, %struct.Memory** %MEMORY
  ...
  ret %struct.Memory* %loadMem_4114e6
}
...
define %struct.Memory* @routine_movsd_0x208bfa__rip____xmm0(%struct.State* dereferenceable(3376), i64, %struct.Memory*) {
block_400478:
  %3 = getelementptr inbounds %struct.State, %struct.State* %0, i32 0, i32 6
  %4 = getelementptr inbounds %struct.GPR, %struct.GPR* %3, i32 0, i32 33
  %5 = getelementptr inbounds %struct.Reg, %struct.Reg* %4, i32 0, i32 0
  ...
  %9 = load i64, i64* %PC
  %10 = ptrtoint %G_0x208bfa__rip__4265102__type* @G_0x208bfa__rip__4265102_ to i64
  %11 = load i64, i64* %PC
  %12 = add i64 %11, 8
  store i64 %12, i64* %PC
...
define %struct.Memory* @routine_callq_._ZN18custom_variable_orIsE8do_shiftEss(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) {
block_400478:
  %3 = getelementptr inbounds %struct.State, %struct.State* %0, i32 0, i32 6
  %4 = getelementptr inbounds %struct.GPR, %struct.GPR* %3, i32 0, i32 33
  %5 = getelementptr inbounds %struct.Reg, %struct.Reg* %4, i32 0, i32 0
...
define %struct.Memory* @routine_jne_.L_4114e1(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i8* %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) {
block_400478:
  %3 = getelementptr inbounds %struct.State, %struct.State* %0, i32 0, i32 6
  %4 = getelementptr inbounds %struct.GPR, %struct.GPR* %3, i32 0, i32 33
  %5 = getelementptr inbounds %struct.Reg, %struct.Reg* %4, i32 0, i32 0
