...
block_4114f6:                                     ; preds = %entry
  ...
  %call2_411509 = call %struct.Memory* @sub_4006c0.printf_plt(%struct.State* %0, i64 %loadPC_411509, %struct.Memory* %loadMem2_411509)
  store %struct.Memory* %call2_411509, %struct.Memory** %MEMORY
