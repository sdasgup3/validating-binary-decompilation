...
entry:
  ...
  %56 = add i64 %55, ptrtoint (%G_0x208bba__rip__type* @G_0x208bba__rip_ to i64)
  %57 = add i64 %55, 8
  ...
  %call2_4114dc = tail call %struct.Memory* @sub_411480._ZN18custom_variable_orIsE8do_shiftEss(%struct.State* %0, i64 %80, %struct.Memory* %2)
  ...
  %call2_4114f9 = tail call %struct.Memory* @sub_411250._Z15tolerance_equalIsEbRT_S1_(%struct.State* %0, i64 %109, %struct.Memory* %call2_4114dc)
  ...
  br i1 %122, label %block_.L_411521, label %block_411506
...
block_411506:                                     ; preds = %entry
  ...
  %131 = tail call %struct.Memory* @__remill_function_call(%struct.State* nonnull %0, i64 ptrtoint (i64 (i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64)* @printf to i64), %struct.Memory* %call2_4114f9)
...
block_.L_411521:                                  ; preds = %block_411506, %entry
  %138 = phi i64 [ %123, %entry ], [ %.pre, %block_411506 ]
  %MEMORY.0 = phi %struct.Memory* [ %call2_4114f9, %entry ], [ %131, %block_411506 ]
