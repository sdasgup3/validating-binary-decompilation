...
block_4114f6:                                     ; preds = %entry
  ...
  %131 = tail call %struct.Memory* @__remill_function_call(%struct.State* nonnull %0, i64 ptrtoint (i64 (i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64)* @printf to i64), %struct.Memory* %call2_4114e9)
...
block_.L_411511:                                  ; preds = %block_4114f6, %entry
  %138 = phi i64 [ %123, %entry ], [ %.pre, %block_4114f6 ]
  %MEMORY.0 = phi %struct.Memory* [ %call2_4114e9, %entry ], [ %131, %block_4114f6 ]
