; ModuleID = '/tmp/tmpxllaww0o-query.ll'
source_filename = "llvm-link"
target datalayout = "e-m:e-i64:64-f80:128-n8:16:32:64-S128"
target triple = "x86_64-pc-linux-gnu-elf"

%__bss_start_type = type <{ [8 x i8] }>
%G_0x208bba__rip__type = type <{ [8 x i8] }>
...
@G_0x208bba__rip_ = global %G_0x208bba__rip__type zeroinitializer
...
define %struct.Memory* @_Z26check_shifted_variable_sumIs18custom_variable_orIsEEvT_S2_(%struct.State* noalias, i64, %struct.Memory* noalias) local_unnamed_addr #1 {
entry:
  %var_2_3 = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %var_2_40 = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 1, i32 0
  %AX.i52 = bitcast %union.anon* %var_2_40 to i16*
  %var_2_55 = load i64, i64* %var_2_3, align 8
  %var_2_56 = add i64 %var_2_55, ptrtoint (%G_0x208bba__rip__type* @G_0x208bba__rip_ to i64)
  ...
  store i64 %var_2_69, i64* %RSI.i42, align 8
  %var_2_70 = trunc i64 %var_2_69 to i16
  store i16 %var_2_70, i16* %AX.i52, align 2
  %RDI.i38 = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 11, i32 0, i32 0
  %sext = shl i64 %var_2_69, 48
  %var_2_71 = ashr exact i64 %sext, 48
  %var_2_72 = and i64 %var_2_71, 4294967295
  store i64 %var_2_72, i64* %RDI.i38, align 8
  %var_2_80 = add i64 %var_2_55, -70
  %call2_4114dc = tail call %struct.Memory* @sub_411480._ZN18custom_variable_orIsE8do_shiftEss(%struct.State* %0, i64 %var_2_80, %struct.Memory* %2)
  %var_2_108 = load i64, i64* %var_2_3, align 8
  %var_2_109 = add i64 %var_2_108, -681
  %call2_4114f9 = tail call %struct.Memory* @sub_411250._Z15tolerance_equalIsEbRT_S1_(%struct.State* %0, i64 %var_2_109, %struct.Memory* %call2_4114dc)
  ...
  br i1 %var_2_122, label %block_411506, label %block_.L_411521

block_411506:                                     ; preds = %entry
  %var_2_131 = tail call %struct.Memory* @__remill_function_call(%struct.State* nonnull %0, i64 ptrtoint (i64 (i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64)* @printf to i64), %struct.Memory* %call2_4114f9)
  br label %block_.L_411521

block_.L_411521:                                  ; preds = %block_411506, %entry
  %MEMORY.0 = phi %struct.Memory* [ %call2_4114f9, %entry ], [ %var_2_131, %block_411506 ]
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_movsd_0x208bba__rip____xmm0(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, ptrtoint (%G_0x208bba__rip__type* @G_0x208bba__rip_ to i64)
  %5 = add i64 %3, 8
  store i64 %5, i64* %PC, align 8
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_jne_.L_411521(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i8* nocapture %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
