...
define %struct.Memory* @_Z26check_shifted_variable_sumIs19custom_add_variableIsEEvT_S2_(%struct.State* noalias, i64, %struct.Memory* noalias readnone) local_unnamed_addr #1 {
entry:
...
block_412136:                                     ; preds = %entry
  ...
  %call2_412149 = tail call %struct.Memory* @sub_4006c0.printf_plt(%struct.State* nonnull %0, i64 %126, %struct.Memory* %call2_412129)
...
block_.L_412151:                                  ; preds = %block_412136, %entry
  %137 = phi i64 [ %123, %entry ], [ %.pre, %block_412136 ]
  %MEMORY.0 = phi %struct.Memory* [ %call2_412129, %entry ], [ %call2_412149, %block_412136 ]
