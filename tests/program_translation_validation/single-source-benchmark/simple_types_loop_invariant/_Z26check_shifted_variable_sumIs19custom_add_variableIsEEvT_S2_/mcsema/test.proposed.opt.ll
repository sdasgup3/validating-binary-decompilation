...
@G_0x207fba__rip__4268238_ = local_unnamed_addr global %G_0x207fba__rip__4268238__type zeroinitializer
...
define %struct.Memory* @_Z26check_shifted_variable_sumIs19custom_add_variableIsEEvT_S2_(%struct.State* noalias, i64, %struct.Memory* noalias) local_unnamed_addr #1 {
entry:
  ...
  %57 = load double, double* bitcast (%G_0x207fba__rip__4268238__type* @G_0x207fba__rip__4268238_ to double*), align 8
  ...
  %call2_4120dc = tail call %struct.Memory* @sub_412130._ZN19custom_add_variableIsE8do_shiftEss(%struct.State* %0, i64 %79, %struct.Memory* %2)
  ...
  %call2_4120f9 = tail call %struct.Memory* @sub_411210._Z15tolerance_equalIsEbRT_S1_(%struct.State* %0, i64 %108, %struct.Memory* %call2_4120dc)
  ...
  br i1 %121, label %block_.L_412121, label %block_412106
...
block_412106:                                     ; preds = %entry
  ...
  %130 = tail call %struct.Memory* @__remill_function_call(%struct.State* %0, i64 ptrtoint (i64 (i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64)* @printf to i64), %struct.Memory* %call2_4120f9)
...
block_.L_412121:                                  ; preds = %block_412106, %entry
  %137 = phi i64 [ %122, %entry ], [ %.pre, %block_412106 ]
  %MEMORY.0 = phi %struct.Memory* [ %call2_4120f9, %entry ], [ %130, %block_412106 ]
...
define %struct.Memory* @routine_movsd_0x207fba__rip____xmm0(%struct.State* dereferenceable(3376), i64, %struct.Memory*) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, 8
  store i64 %4, i64* %PC, align 8
  %5 = load i64, i64* bitcast (%G_0x207fba__rip__4268238__type* @G_0x207fba__rip__4268238_ to i64*), align 8
...
define %struct.Memory* @routine_jne_.L_412121(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i8* %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
