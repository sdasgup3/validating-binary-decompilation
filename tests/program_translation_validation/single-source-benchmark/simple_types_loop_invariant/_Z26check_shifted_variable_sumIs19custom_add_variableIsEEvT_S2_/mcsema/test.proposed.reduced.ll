; ModuleID = '/tmp/tmpoa9_388j-query.ll'
...
entry:
  ...
  %var_2_56 = add i64 %var_2_55, ptrtoint (%G_0x207f7a__rip__type* @G_0x207f7a__rip_ to i64)
  ...
  %var_2_80 = add i64 %var_2_55, 106
  %call2_41211c = tail call %struct.Memory* @sub_412170._ZN19custom_add_variableIsE8do_shiftEss(%struct.State* %0, i64 %var_2_80, %struct.Memory* %2)
  %var_2_108 = load i64, i64* %var_2_3, align 8
  %var_2_109 = add i64 %var_2_108, -3817
  %call2_412139 = tail call %struct.Memory* @sub_411250._Z15tolerance_equalIsEbRT_S1_(%struct.State* %0, i64 %var_2_109, %struct.Memory* %call2_41211c)
  ...
  br i1 %var_2_122, label %block_412146, label %block_.L_412161

block_412146:                                     ; preds = %entry
  %var_2_131 = tail call %struct.Memory* @__remill_function_call(%struct.State* nonnull %0, i64 ptrtoint (i64 (i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64)* @printf to i64), %struct.Memory* %call2_412139)
  br label %block_.L_412161

block_.L_412161:                                  ; preds = %block_412146, %entry
  %MEMORY.0 = phi %struct.Memory* [ %call2_412139, %entry ], [ %var_2_131, %block_412146 ]
