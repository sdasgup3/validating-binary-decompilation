...
define %struct.Memory* @_Z26check_shifted_variable_sumIs19custom_sub_variableIsEEvT_S2_(%struct.State* noalias, i64, %struct.Memory* noalias readnone) local_unnamed_addr #1 {
entry:
...
block_411f96:                                     ; preds = %entry
  ...
  %call2_411fa9 = tail call %struct.Memory* @sub_4006c0.printf_plt(%struct.State* nonnull %0, i64 %126, %struct.Memory* %call2_411f89)
...
block_.L_411fb1:                                  ; preds = %block_411f96, %entry
  %137 = phi i64 [ %123, %entry ], [ %.pre, %block_411f96 ]
  %MEMORY.0 = phi %struct.Memory* [ %call2_411f89, %entry ], [ %call2_411fa9, %block_411f96 ]
