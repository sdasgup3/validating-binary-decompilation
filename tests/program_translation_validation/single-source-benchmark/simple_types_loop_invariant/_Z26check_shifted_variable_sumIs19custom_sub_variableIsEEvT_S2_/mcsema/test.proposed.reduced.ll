; ModuleID = '/tmp/tmpswlr0csr-query.ll'
...
entry:
  ...
  %var_2_56 = add i64 %var_2_55, ptrtoint (%G_0x20811a__rip__type* @G_0x20811a__rip_ to i64)
  ...
  %call2_411f7c = tail call %struct.Memory* @sub_411f20._ZN19custom_sub_variableIsE8do_shiftEss(%struct.State* %0, i64 %var_2_80, %struct.Memory* %2)
  %var_2_108 = load i64, i64* %var_2_3, align 8
  %var_2_109 = add i64 %var_2_108, -3401
  %call2_411f99 = tail call %struct.Memory* @sub_411250._Z15tolerance_equalIsEbRT_S1_(%struct.State* %0, i64 %var_2_109, %struct.Memory* %call2_411f7c)
  ...
  br i1 %var_2_122, label %block_411fa6, label %block_.L_411fc1

block_411fa6:                                     ; preds = %entry
  %var_2_131 = tail call %struct.Memory* @__remill_function_call(%struct.State* nonnull %0, i64 ptrtoint (i64 (i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64)* @printf to i64), %struct.Memory* %call2_411f99)
  br label %block_.L_411fc1

block_.L_411fc1:                                  ; preds = %block_411fa6, %entry
  %MEMORY.0 = phi %struct.Memory* [ %call2_411f99, %entry ], [ %var_2_131, %block_411fa6 ]
