...
@G_0x208a2a__rip_ = global %G_0x208a2a__rip__type zeroinitializer
...
define %struct.Memory* @_Z26check_shifted_variable_sumIs19custom_variable_andIsEEvT_S2_(%struct.State* noalias, i64, %struct.Memory* noalias) #2 {
entry:
  ...
  store %struct.Memory* %loadMem_411652, %struct.Memory** %MEMORY
  ...
  %134 = load double, double* bitcast (%G_0x208a2a__rip__type* @G_0x208a2a__rip_ to double*)
  ...
  store %struct.Memory* %loadMem_41165e, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem1_41166c, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem1_411689, %struct.Memory** %MEMORY
...
block_411696:                                     ; preds = %entry
  ...
  store %struct.Memory* %loadMem_411696, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_4116a7, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem1_4116a9, %struct.Memory** %MEMORY
  %loadMem2_4116a9 = load %struct.Memory*, %struct.Memory** %MEMORY
  %loadPC_4116a9 = load i64, i64* %3
  %422 = call %struct.Memory* @__remill_function_call(%struct.State* %0, i64 ptrtoint (i64 (i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64)* @printf to i64), %struct.Memory* %loadMem2_4116a9)
  ...
  store %struct.Memory* %loadMem_4116ae, %struct.Memory** %MEMORY
...
block_.L_4116b1:                                  ; preds = %block_411696, %entry
  ...
  store %struct.Memory* %loadMem_4116b5, %struct.Memory** %MEMORY
  ...
  ret %struct.Memory* %loadMem_4116b6
}
...
define %struct.Memory* @routine_movsd_0x208a2a__rip____xmm0(%struct.State* dereferenceable(3376), i64, %struct.Memory*) {
block_400478:
  %3 = getelementptr inbounds %struct.State, %struct.State* %0, i32 0, i32 6
  %4 = getelementptr inbounds %struct.GPR, %struct.GPR* %3, i32 0, i32 33
  %5 = getelementptr inbounds %struct.Reg, %struct.Reg* %4, i32 0, i32 0
