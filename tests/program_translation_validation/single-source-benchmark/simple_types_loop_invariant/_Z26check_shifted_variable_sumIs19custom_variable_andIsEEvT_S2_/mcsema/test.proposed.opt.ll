...
block_4116c6:                                     ; preds = %entry
  ...
  %131 = tail call %struct.Memory* @__remill_function_call(%struct.State* nonnull %0, i64 ptrtoint (i64 (i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64)* @printf to i64), %struct.Memory* %call2_4116b9)
...
block_.L_4116e1:                                  ; preds = %block_4116c6, %entry
  %138 = phi i64 [ %123, %entry ], [ %.pre, %block_4116c6 ]
  %MEMORY.0 = phi %struct.Memory* [ %call2_4116b9, %entry ], [ %131, %block_4116c6 ]
