; ModuleID = '/tmp/tmpa9olhjq6-query.ll'
...
entry:
  ...
  %var_2_56 = add i64 %var_2_55, ptrtoint (%G_0x2089ea__rip__type* @G_0x2089ea__rip_ to i64)
  ...
  %call2_4116ac = tail call %struct.Memory* @sub_411650._ZN19custom_variable_andIsE8do_shiftEss(%struct.State* %0, i64 %var_2_80, %struct.Memory* %2)
  %var_2_108 = load i64, i64* %var_2_3, align 8
  %var_2_109 = add i64 %var_2_108, -1145
  %call2_4116c9 = tail call %struct.Memory* @sub_411250._Z15tolerance_equalIsEbRT_S1_(%struct.State* %0, i64 %var_2_109, %struct.Memory* %call2_4116ac)
  ...
  br i1 %var_2_122, label %block_4116d6, label %block_.L_4116f1

block_4116d6:                                     ; preds = %entry
  %var_2_131 = tail call %struct.Memory* @__remill_function_call(%struct.State* nonnull %0, i64 ptrtoint (i64 (i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64)* @printf to i64), %struct.Memory* %call2_4116c9)
  br label %block_.L_4116f1

block_.L_4116f1:                                  ; preds = %block_4116d6, %entry
  %MEMORY.0 = phi %struct.Memory* [ %call2_4116c9, %entry ], [ %var_2_131, %block_4116d6 ]
