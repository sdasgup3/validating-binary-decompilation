...
@G_0x208dca__rip__4264638_ = global %G_0x208dca__rip__4264638__type zeroinitializer
...
define %struct.Memory* @_Z26check_shifted_variable_sumIs19custom_variable_xorIsEEvT_S2_(%struct.State* noalias, i64, %struct.Memory* noalias) #2 {
entry:
  ...
  store %struct.Memory* %loadMem_4112a8, %struct.Memory** %MEMORY
  ...
  %134 = load double, double* bitcast (%G_0x208dca__rip__4264638__type* @G_0x208dca__rip__4264638_ to double*)
  ...
  store %struct.Memory* %loadMem_4112b6, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_4112be, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_4112c2, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem1_4112cc, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_4112d5, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_4112d9, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem1_4112e9, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_4112ee, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_4112f0, %struct.Memory** %MEMORY
...
block_4112f6:                                     ; preds = %entry
  ...
  store %struct.Memory* %loadMem_4112f6, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_411300, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem1_411309, %struct.Memory** %MEMORY
  %loadMem2_411309 = load %struct.Memory*, %struct.Memory** %MEMORY
  %loadPC_411309 = load i64, i64* %3
  %422 = call %struct.Memory* @__remill_function_call(%struct.State* %0, i64 ptrtoint (i64 (i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64)* @printf to i64), %struct.Memory* %loadMem2_411309)
...
block_.L_411311:                                  ; preds = %block_4112f6, %entry
  ...
  store %struct.Memory* %loadMem_411315, %struct.Memory** %MEMORY
  ...
  ret %struct.Memory* %loadMem_411316
}
...
define %struct.Memory* @routine_movsd_0x208dca__rip____xmm0(%struct.State* dereferenceable(3376), i64, %struct.Memory*) {
block_400478:
  %3 = getelementptr inbounds %struct.State, %struct.State* %0, i32 0, i32 6
  %4 = getelementptr inbounds %struct.GPR, %struct.GPR* %3, i32 0, i32 33
  %5 = getelementptr inbounds %struct.Reg, %struct.Reg* %4, i32 0, i32 0
