...
entry:
  ...
  %56 = add i64 %55, ptrtoint (%G_0x208d8a__rip__type* @G_0x208d8a__rip_ to i64)
  %57 = add i64 %55, 8
  ...
  %call2_41130c = tail call %struct.Memory* @sub_4112b0._ZN19custom_variable_xorIsE8do_shiftEss(%struct.State* %0, i64 %80, %struct.Memory* %2)
  ...
  %call2_411329 = tail call %struct.Memory* @sub_411250._Z15tolerance_equalIsEbRT_S1_(%struct.State* %0, i64 %109, %struct.Memory* %call2_41130c)
  ...
  br i1 %122, label %block_.L_411351, label %block_411336
...
block_411336:                                     ; preds = %entry
  ...
  %131 = tail call %struct.Memory* @__remill_function_call(%struct.State* nonnull %0, i64 ptrtoint (i64 (i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64)* @printf to i64), %struct.Memory* %call2_411329)
...
block_.L_411351:                                  ; preds = %block_411336, %entry
  %138 = phi i64 [ %123, %entry ], [ %.pre, %block_411336 ]
  %MEMORY.0 = phi %struct.Memory* [ %call2_411329, %entry ], [ %131, %block_411336 ]
