...
block_411326:                                     ; preds = %entry
  ...
  %131 = tail call %struct.Memory* @__remill_function_call(%struct.State* nonnull %0, i64 ptrtoint (i64 (i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64)* @printf to i64), %struct.Memory* %call2_411319)
...
block_.L_411341:                                  ; preds = %block_411326, %entry
  %138 = phi i64 [ %123, %entry ], [ %.pre, %block_411326 ]
  %MEMORY.0 = phi %struct.Memory* [ %call2_411319, %entry ], [ %131, %block_411326 ]
