...
declare %struct.Memory* @sub_4112a0._ZN19custom_variable_xorIsE8do_shiftEss(%struct.State* noalias dereferenceable(3376), i64, %struct.Memory* noalias readnone returned) local_unnamed_addr
...
define %struct.Memory* @_Z26check_shifted_variable_sumIs19custom_variable_xorIsEEvT_S2_(%struct.State* noalias, i64, %struct.Memory* noalias readnone) local_unnamed_addr #1 {
entry:
  ...
  %call2_4112fc = tail call %struct.Memory* @sub_4112a0._ZN19custom_variable_xorIsE8do_shiftEss(%struct.State* %0, i64 %80, %struct.Memory* %2)
  ...
  %call2_411319 = tail call %struct.Memory* @sub_411240._Z15tolerance_equalIsEbRT_S1_(%struct.State* %0, i64 %109, %struct.Memory* %call2_4112fc)
  ...
  br i1 %122, label %block_.L_411341, label %block_411326
...
block_411326:                                     ; preds = %entry
  ...
  %call2_411339 = tail call %struct.Memory* @sub_4006c0.printf_plt(%struct.State* nonnull %0, i64 %126, %struct.Memory* %call2_411319)
...
block_.L_411341:                                  ; preds = %block_411326, %entry
  %137 = phi i64 [ %123, %entry ], [ %.pre, %block_411326 ]
  %MEMORY.0 = phi %struct.Memory* [ %call2_411319, %entry ], [ %call2_411339, %block_411326 ]
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_movsd_0x208d9a__rip____xmm0(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_jne_.L_411341(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i8* nocapture %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
