...
block_411ad6:                                     ; preds = %entry
  ...
  %call2_411ae9 = call %struct.Memory* @sub_4006c0.printf_plt(%struct.State* %0, i64 %loadPC_411ae9, %struct.Memory* %loadMem2_411ae9)
  store %struct.Memory* %call2_411ae9, %struct.Memory** %MEMORY
