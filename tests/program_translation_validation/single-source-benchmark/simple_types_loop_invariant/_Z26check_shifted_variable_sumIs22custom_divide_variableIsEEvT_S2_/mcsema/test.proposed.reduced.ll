; ModuleID = '/tmp/tmp5drmqsch-query.ll'
...
define %struct.Memory* @_Z26check_shifted_variable_sumIs22custom_divide_variableIsEEvT_S2_(%struct.State* noalias, i64, %struct.Memory* noalias) local_unnamed_addr #1 {
entry:
  ...
  %var_2_56 = add i64 %var_2_55, ptrtoint (%G_0x2085da__rip__type* @G_0x2085da__rip_ to i64)
  ...
  %call2_411abc = tail call %struct.Memory* @sub_411a60._ZN22custom_divide_variableIsE8do_shiftEss(%struct.State* %0, i64 %var_2_80, %struct.Memory* %2)
  %var_2_108 = load i64, i64* %var_2_3, align 8
  %var_2_109 = add i64 %var_2_108, -2185
  %call2_411ad9 = tail call %struct.Memory* @sub_411250._Z15tolerance_equalIsEbRT_S1_(%struct.State* %0, i64 %var_2_109, %struct.Memory* %call2_411abc)
  ...
  br i1 %var_2_122, label %block_411ae6, label %block_.L_411b01

block_411ae6:                                     ; preds = %entry
  %var_2_131 = tail call %struct.Memory* @__remill_function_call(%struct.State* nonnull %0, i64 ptrtoint (i64 (i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64)* @printf to i64), %struct.Memory* %call2_411ad9)
  br label %block_.L_411b01

block_.L_411b01:                                  ; preds = %block_411ae6, %entry
  %MEMORY.0 = phi %struct.Memory* [ %call2_411ad9, %entry ], [ %var_2_131, %block_411ae6 ]
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_movsd_0x2085da__rip____xmm0(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, ptrtoint (%G_0x2085da__rip__type* @G_0x2085da__rip_ to i64)
  %5 = add i64 %3, 8
  store i64 %5, i64* %PC, align 8
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_jne_.L_411b01(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i8* nocapture %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
