; ModuleID = '/tmp/tmp5z5dkpfs-query.ll'
...
define %struct.Memory* @_Z26check_shifted_variable_sumIs22custom_divide_variableIsEEvT_S2_(%struct.State* noalias nocapture, i64, %struct.Memory* noalias readnone returned) local_unnamed_addr #1 {
entry:
