; ModuleID = '/tmp/tmpmzrxsxbj-query.ll'
...
entry:
  ...
  %var_2_56 = add i64 %var_2_55, ptrtoint (%G_0x2082ea__rip__type* @G_0x2082ea__rip_ to i64)
  ...
  %call2_411dac = tail call %struct.Memory* @sub_411d50._ZN24custom_multiply_variableIsE8do_shiftEss(%struct.State* %0, i64 %var_2_80, %struct.Memory* %2)
  %var_2_108 = load i64, i64* %var_2_3, align 8
  %var_2_109 = add i64 %var_2_108, -2937
  %call2_411dc9 = tail call %struct.Memory* @sub_411250._Z15tolerance_equalIsEbRT_S1_(%struct.State* %0, i64 %var_2_109, %struct.Memory* %call2_411dac)
  ...
  br i1 %var_2_122, label %block_411dd6, label %block_.L_411df1

block_411dd6:                                     ; preds = %entry
  %var_2_131 = tail call %struct.Memory* @__remill_function_call(%struct.State* nonnull %0, i64 ptrtoint (i64 (i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64)* @printf to i64), %struct.Memory* %call2_411dc9)
  br label %block_.L_411df1

block_.L_411df1:                                  ; preds = %block_411dd6, %entry
  %MEMORY.0 = phi %struct.Memory* [ %call2_411dc9, %entry ], [ %var_2_131, %block_411dd6 ]
...
block_400488:
  ...
  %4 = add i64 %3, ptrtoint (%G_0x2082ea__rip__type* @G_0x2082ea__rip_ to i64)
  %5 = add i64 %3, 8
  store i64 %5, i64* %PC, align 8
