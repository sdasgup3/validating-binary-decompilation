; ModuleID = '/tmp/tmpohb45w9c-query.ll'
...
define %struct.Memory* @_Z26check_shifted_variable_sumIs24custom_multiply_variableIsEEvT_S2_(%struct.State* noalias nocapture, i64, %struct.Memory* noalias readnone returned) local_unnamed_addr #1 {
entry:
