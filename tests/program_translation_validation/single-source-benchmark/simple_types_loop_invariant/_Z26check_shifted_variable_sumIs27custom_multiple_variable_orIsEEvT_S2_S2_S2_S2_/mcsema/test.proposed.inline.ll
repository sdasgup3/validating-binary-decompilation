...
@G_0x208ccd__rip__4264891_ = global %G_0x208ccd__rip__4264891__type zeroinitializer
...
entry:
  ...
  store %struct.Memory* %loadMem_411399, %struct.Memory** %MEMORY
  ...
  %234 = load double, double* bitcast (%G_0x208ccd__rip__4264891__type* @G_0x208ccd__rip__4264891_ to double*)
  ...
  store %struct.Memory* %loadMem_4113bf, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem1_4113e5, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_4113ee, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_4113fe, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem1_411402, %struct.Memory** %MEMORY
...
block_41140f:                                     ; preds = %entry
  ...
  store %struct.Memory* %loadMem1_411422, %struct.Memory** %MEMORY
  %loadMem2_411422 = load %struct.Memory*, %struct.Memory** %MEMORY
  %loadPC_411422 = load i64, i64* %3
  %619 = call %struct.Memory* @__remill_function_call(%struct.State* %0, i64 ptrtoint (i64 (i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64)* @printf to i64), %struct.Memory* %loadMem2_411422)
...
block_.L_41142a:                                  ; preds = %block_41140f, %entry
  ...
  store %struct.Memory* %loadMem_411430, %struct.Memory** %MEMORY
  ret %struct.Memory* %loadMem_411430
}
...
define %struct.Memory* @routine_movsd_0x208ccd__rip____xmm0(%struct.State* dereferenceable(3376), i64, %struct.Memory*) {
block_400478:
  %3 = getelementptr inbounds %struct.State, %struct.State* %0, i32 0, i32 6
  %4 = getelementptr inbounds %struct.GPR, %struct.GPR* %3, i32 0, i32 33
  %5 = getelementptr inbounds %struct.Reg, %struct.Reg* %4, i32 0, i32 0
