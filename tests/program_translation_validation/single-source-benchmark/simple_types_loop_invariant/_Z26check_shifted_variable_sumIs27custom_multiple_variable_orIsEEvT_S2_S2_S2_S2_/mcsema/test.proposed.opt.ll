...
block_41143f:                                     ; preds = %entry
  ...
  %183 = tail call %struct.Memory* @__remill_function_call(%struct.State* nonnull %0, i64 ptrtoint (i64 (i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64)* @printf to i64), %struct.Memory* %call2_411432)
...
block_.L_41145a:                                  ; preds = %block_41143f, %entry
  %190 = phi i64 [ %175, %entry ], [ %.pre, %block_41143f ]
  %MEMORY.0 = phi %struct.Memory* [ %call2_411432, %entry ], [ %183, %block_41143f ]
