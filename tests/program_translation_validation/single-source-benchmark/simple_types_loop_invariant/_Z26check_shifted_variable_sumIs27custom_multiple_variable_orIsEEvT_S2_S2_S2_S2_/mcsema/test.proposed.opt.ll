...
define %struct.Memory* @_Z26check_shifted_variable_sumIs27custom_multiple_variable_orIsEEvT_S2_S2_S2_S2_(%struct.State* noalias, i64, %struct.Memory* noalias readnone) local_unnamed_addr #1 {
entry:
  ...
  %call2_411415 = tail call %struct.Memory* @sub_411350._ZN27custom_multiple_variable_orIsE8do_shiftEsssss(%struct.State* %0, i64 %132, %struct.Memory* %2)
  ...
  %call2_411432 = tail call %struct.Memory* @sub_411240._Z15tolerance_equalIsEbRT_S1_(%struct.State* %0, i64 %161, %struct.Memory* %call2_411415)
  ...
  br i1 %174, label %block_.L_41145a, label %block_41143f
...
block_41143f:                                     ; preds = %entry
  ...
  %call2_411452 = tail call %struct.Memory* @sub_4006c0.printf_plt(%struct.State* nonnull %0, i64 %178, %struct.Memory* %call2_411432)
...
block_.L_41145a:                                  ; preds = %block_41143f, %entry
  %189 = phi i64 [ %175, %entry ], [ %.pre, %block_41143f ]
  %MEMORY.0 = phi %struct.Memory* [ %call2_411432, %entry ], [ %call2_411452, %block_41143f ]
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_movsd_0x208c9d__rip____xmm0(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_jne_.L_41145a(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i8* nocapture %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
