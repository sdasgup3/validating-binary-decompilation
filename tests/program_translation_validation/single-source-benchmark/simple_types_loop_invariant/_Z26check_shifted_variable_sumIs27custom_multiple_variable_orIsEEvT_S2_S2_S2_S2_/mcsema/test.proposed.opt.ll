...
entry:
  ...
  %89 = add i64 %88, ptrtoint (%G_0x208c8d__rip__type* @G_0x208c8d__rip_ to i64)
  %90 = add i64 %88, 8
  ...
  %call2_411425 = tail call %struct.Memory* @sub_411360._ZN27custom_multiple_variable_orIsE8do_shiftEsssss(%struct.State* %0, i64 %132, %struct.Memory* %2)
  ...
  %call2_411442 = tail call %struct.Memory* @sub_411250._Z15tolerance_equalIsEbRT_S1_(%struct.State* %0, i64 %161, %struct.Memory* %call2_411425)
  ...
  br i1 %174, label %block_.L_41146a, label %block_41144f
...
block_41144f:                                     ; preds = %entry
  ...
  %183 = tail call %struct.Memory* @__remill_function_call(%struct.State* nonnull %0, i64 ptrtoint (i64 (i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64)* @printf to i64), %struct.Memory* %call2_411442)
...
block_.L_41146a:                                  ; preds = %block_41144f, %entry
  %190 = phi i64 [ %175, %entry ], [ %.pre, %block_41144f ]
  %MEMORY.0 = phi %struct.Memory* [ %call2_411442, %entry ], [ %183, %block_41144f ]
