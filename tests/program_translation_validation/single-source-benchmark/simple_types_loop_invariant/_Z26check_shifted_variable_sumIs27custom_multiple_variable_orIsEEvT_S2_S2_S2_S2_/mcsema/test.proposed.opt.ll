...
@G_0x208ccd__rip__4264891_ = local_unnamed_addr global %G_0x208ccd__rip__4264891__type zeroinitializer
...
entry:
  ...
  %90 = load double, double* bitcast (%G_0x208ccd__rip__4264891__type* @G_0x208ccd__rip__4264891_ to double*), align 8
  ...
  %call2_4113e5 = tail call %struct.Memory* @sub_411320._ZN27custom_multiple_variable_orIsE8do_shiftEsssss(%struct.State* %0, i64 %131, %struct.Memory* %2)
  ...
  %call2_411402 = tail call %struct.Memory* @sub_411210._Z15tolerance_equalIsEbRT_S1_(%struct.State* %0, i64 %160, %struct.Memory* %call2_4113e5)
  ...
  br i1 %173, label %block_.L_41142a, label %block_41140f
...
block_41140f:                                     ; preds = %entry
  ...
  %182 = tail call %struct.Memory* @__remill_function_call(%struct.State* %0, i64 ptrtoint (i64 (i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64)* @printf to i64), %struct.Memory* %call2_411402)
...
block_.L_41142a:                                  ; preds = %block_41140f, %entry
  %189 = phi i64 [ %174, %entry ], [ %.pre, %block_41140f ]
  %MEMORY.0 = phi %struct.Memory* [ %call2_411402, %entry ], [ %182, %block_41140f ]
...
define %struct.Memory* @routine_movsd_0x208ccd__rip____xmm0(%struct.State* dereferenceable(3376), i64, %struct.Memory*) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, 8
  store i64 %4, i64* %PC, align 8
  %5 = load i64, i64* bitcast (%G_0x208ccd__rip__4264891__type* @G_0x208ccd__rip__4264891_ to i64*), align 8
...
define %struct.Memory* @routine_jne_.L_41142a(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i8* %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
