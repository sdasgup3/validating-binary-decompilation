...
@G_0x20805d__rip_ = global %G_0x20805d__rip__type zeroinitializer
...
entry:
  ...
  %234 = load double, double* bitcast (%G_0x20805d__rip__type* @G_0x20805d__rip_ to double*)
  ...
  store %struct.Memory* %loadMem1_412055, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_412065, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem1_412072, %struct.Memory** %MEMORY
...
block_41207f:                                     ; preds = %entry
  ...
  store %struct.Memory* %loadMem1_412092, %struct.Memory** %MEMORY
  %loadMem2_412092 = load %struct.Memory*, %struct.Memory** %MEMORY
  %loadPC_412092 = load i64, i64* %3
  %619 = call %struct.Memory* @__remill_function_call(%struct.State* %0, i64 ptrtoint (i64 (i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64)* @printf to i64), %struct.Memory* %loadMem2_412092)
...
block_.L_41209a:                                  ; preds = %block_41207f, %entry
  ...
  ret %struct.Memory* %loadMem_4120a0
}
...
define %struct.Memory* @routine_movsd_0x20805d__rip____xmm0(%struct.State* dereferenceable(3376), i64, %struct.Memory*) {
block_400478:
  %3 = getelementptr inbounds %struct.State, %struct.State* %0, i32 0, i32 6
  %4 = getelementptr inbounds %struct.GPR, %struct.GPR* %3, i32 0, i32 33
  %5 = getelementptr inbounds %struct.Reg, %struct.Reg* %4, i32 0, i32 0
