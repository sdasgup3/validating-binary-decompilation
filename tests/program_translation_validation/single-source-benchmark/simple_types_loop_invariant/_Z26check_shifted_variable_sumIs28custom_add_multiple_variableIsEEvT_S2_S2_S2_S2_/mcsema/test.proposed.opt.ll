...
entry:
  ...
  %89 = add i64 %88, ptrtoint (%G_0x20801d__rip__type* @G_0x20801d__rip_ to i64)
  %90 = add i64 %88, 8
  ...
  %call2_412095 = tail call %struct.Memory* @sub_411fd0._ZN28custom_add_multiple_variableIsE8do_shiftEsssss(%struct.State* %0, i64 %132, %struct.Memory* %2)
  ...
  %call2_4120b2 = tail call %struct.Memory* @sub_411250._Z15tolerance_equalIsEbRT_S1_(%struct.State* %0, i64 %161, %struct.Memory* %call2_412095)
  ...
  br i1 %174, label %block_.L_4120da, label %block_4120bf
...
block_4120bf:                                     ; preds = %entry
  ...
  %183 = tail call %struct.Memory* @__remill_function_call(%struct.State* nonnull %0, i64 ptrtoint (i64 (i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64)* @printf to i64), %struct.Memory* %call2_4120b2)
...
block_.L_4120da:                                  ; preds = %block_4120bf, %entry
  %190 = phi i64 [ %175, %entry ], [ %.pre, %block_4120bf ]
  %MEMORY.0 = phi %struct.Memory* [ %call2_4120b2, %entry ], [ %183, %block_4120bf ]
