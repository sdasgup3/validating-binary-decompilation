...
block_4120af:                                     ; preds = %entry
  ...
  %183 = tail call %struct.Memory* @__remill_function_call(%struct.State* nonnull %0, i64 ptrtoint (i64 (i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64)* @printf to i64), %struct.Memory* %call2_4120a2)
...
block_.L_4120ca:                                  ; preds = %block_4120af, %entry
  %190 = phi i64 [ %175, %entry ], [ %.pre, %block_4120af ]
  %MEMORY.0 = phi %struct.Memory* [ %call2_4120a2, %entry ], [ %183, %block_4120af ]
