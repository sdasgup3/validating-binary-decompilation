...
block_41160f:                                     ; preds = %entry
  ...
  %183 = tail call %struct.Memory* @__remill_function_call(%struct.State* nonnull %0, i64 ptrtoint (i64 (i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64)* @printf to i64), %struct.Memory* %call2_411602)
...
block_.L_41162a:                                  ; preds = %block_41160f, %entry
  %190 = phi i64 [ %175, %entry ], [ %.pre, %block_41160f ]
  %MEMORY.0 = phi %struct.Memory* [ %call2_411602, %entry ], [ %183, %block_41160f ]
