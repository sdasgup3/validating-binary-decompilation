...
define %struct.Memory* @_Z26check_shifted_variable_sumIs28custom_multiple_variable_andIsEEvT_S2_S2_S2_S2_(%struct.State* noalias, i64, %struct.Memory* noalias readnone) local_unnamed_addr #1 {
entry:
  ...
  %call2_4115e5 = tail call %struct.Memory* @sub_411520._ZN28custom_multiple_variable_andIsE8do_shiftEsssss(%struct.State* %0, i64 %132, %struct.Memory* %2)
  ...
  %call2_411602 = tail call %struct.Memory* @sub_411240._Z15tolerance_equalIsEbRT_S1_(%struct.State* %0, i64 %161, %struct.Memory* %call2_4115e5)
  ...
  br i1 %174, label %block_.L_41162a, label %block_41160f

block_41160f:                                     ; preds = %entry
  ...
  %call2_411622 = tail call %struct.Memory* @sub_4006c0.printf_plt(%struct.State* nonnull %0, i64 %178, %struct.Memory* %call2_411602)
  ...
  br label %block_.L_41162a

block_.L_41162a:                                  ; preds = %block_41160f, %entry
  %189 = phi i64 [ %175, %entry ], [ %.pre, %block_41160f ]
  %MEMORY.0 = phi %struct.Memory* [ %call2_411602, %entry ], [ %call2_411622, %block_41160f ]
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_movsd_0x208acd__rip____xmm0(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_jne_.L_41162a(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i8* nocapture %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
