; ModuleID = '/tmp/tmpb8s1yjgo-query.ll'
...
entry:
  ...
  %var_2_89 = add i64 %var_2_88, ptrtoint (%G_0x208abd__rip__type* @G_0x208abd__rip_ to i64)
  ...
  %call2_4115f5 = tail call %struct.Memory* @sub_411530._ZN28custom_multiple_variable_andIsE8do_shiftEsssss(%struct.State* %0, i64 %var_2_132, %struct.Memory* %2)
  %var_2_160 = load i64, i64* %var_2_3, align 8
  %var_2_161 = add i64 %var_2_160, -962
  %call2_411612 = tail call %struct.Memory* @sub_411250._Z15tolerance_equalIsEbRT_S1_(%struct.State* %0, i64 %var_2_161, %struct.Memory* %call2_4115f5)
  ...
  br i1 %var_2_174, label %block_41161f, label %block_.L_41163a

block_41161f:                                     ; preds = %entry
  %var_2_183 = tail call %struct.Memory* @__remill_function_call(%struct.State* nonnull %0, i64 ptrtoint (i64 (i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64)* @printf to i64), %struct.Memory* %call2_411612)
  br label %block_.L_41163a

block_.L_41163a:                                  ; preds = %block_41161f, %entry
  %MEMORY.0 = phi %struct.Memory* [ %call2_411612, %entry ], [ %var_2_183, %block_41161f ]
