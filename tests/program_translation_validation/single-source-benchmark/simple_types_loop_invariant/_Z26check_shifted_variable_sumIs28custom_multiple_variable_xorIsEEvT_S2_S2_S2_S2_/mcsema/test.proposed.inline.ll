...
%G_0x208efd__rip__4264331__type = type <{ [16 x i8] }>
...
@G_0x208efd__rip__4264331_ = global %G_0x208efd__rip__4264331__type zeroinitializer
...
entry:
  ...
  %loadMem_411155 = load %struct.Memory*, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_411155, %struct.Memory** %MEMORY
  ...
  %234 = load double, double* bitcast (%G_0x208efd__rip__4264331__type* @G_0x208efd__rip__4264331_ to double*)
  ...
  %loadMem_41118f = load %struct.Memory*, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_41118f, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_4111a8, %struct.Memory** %MEMORY
  ...
  %loadMem1_4111b5 = load %struct.Memory*, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem1_4111b5, %struct.Memory** %MEMORY
  %loadMem2_4111b5 = load %struct.Memory*, %struct.Memory** %MEMORY
  %loadPC_4111b5 = load i64, i64* %3
  %call2_4111b5 = call %struct.Memory* @sub_4110f0._ZN28custom_multiple_variable_xorIsE8do_shiftEsssss(%struct.State* %0, i64 %loadPC_4111b5, %struct.Memory* %loadMem2_4111b5)
  store %struct.Memory* %call2_4111b5, %struct.Memory** %MEMORY
  ...
  %loadMem_4111c5 = load %struct.Memory*, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_4111c5, %struct.Memory** %MEMORY
  ...
  %call2_4111d2 = call %struct.Memory* @sub_411210._Z15tolerance_equalIsEbRT_S1_(%struct.State* %0, i64 %loadPC_4111d2, %struct.Memory* %loadMem2_4111d2)
  ...
  %loadMem_4111d9 = load %struct.Memory*, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_4111d9, %struct.Memory** %MEMORY
  %loadBr_4111d9 = load i8, i8* %BRANCH_TAKEN
  %cmpBr_4111d9 = icmp eq i8 %loadBr_4111d9, 1
  br i1 %cmpBr_4111d9, label %block_.L_4111fa, label %block_4111df

block_4111df:                                     ; preds = %entry
  %loadMem_4111df = load %struct.Memory*, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_4111df, %struct.Memory** %MEMORY
  ...
  %loadMem1_4111f2 = load %struct.Memory*, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem1_4111f2, %struct.Memory** %MEMORY
  %loadMem2_4111f2 = load %struct.Memory*, %struct.Memory** %MEMORY
  %loadPC_4111f2 = load i64, i64* %3
  %619 = call %struct.Memory* @__remill_function_call(%struct.State* %0, i64 ptrtoint (i64 (i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64)* @printf to i64), %struct.Memory* %loadMem2_4111f2)
  store %struct.Memory* %619, %struct.Memory** %MEMORY
  %loadMem_4111f7 = load %struct.Memory*, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_4111f7, %struct.Memory** %MEMORY
  br label %block_.L_4111fa

block_.L_4111fa:                                  ; preds = %block_4111df, %entry
  ...
  store %struct.Memory* %loadMem_4111ff, %struct.Memory** %MEMORY
  ...
  ret %struct.Memory* %loadMem_411200
}
...
define %struct.Memory* @routine_movsd_0x208efd__rip____xmm0(%struct.State* dereferenceable(3376), i64, %struct.Memory*) {
block_400478:
  %3 = getelementptr inbounds %struct.State, %struct.State* %0, i32 0, i32 6
  %4 = getelementptr inbounds %struct.GPR, %struct.GPR* %3, i32 0, i32 33
  %5 = getelementptr inbounds %struct.Reg, %struct.Reg* %4, i32 0, i32 0
  ...
  %9 = load i64, i64* %PC
  %10 = ptrtoint %G_0x208efd__rip__4264331__type* @G_0x208efd__rip__4264331_ to i64
  %11 = load i64, i64* %PC
  %12 = add i64 %11, 8
  store i64 %12, i64* %PC
...
define %struct.Memory* @routine_jne_.L_4111fa(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i8* %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) {
block_400478:
  %3 = getelementptr inbounds %struct.State, %struct.State* %0, i32 0, i32 6
  %4 = getelementptr inbounds %struct.GPR, %struct.GPR* %3, i32 0, i32 33
  %5 = getelementptr inbounds %struct.Reg, %struct.Reg* %4, i32 0, i32 0
