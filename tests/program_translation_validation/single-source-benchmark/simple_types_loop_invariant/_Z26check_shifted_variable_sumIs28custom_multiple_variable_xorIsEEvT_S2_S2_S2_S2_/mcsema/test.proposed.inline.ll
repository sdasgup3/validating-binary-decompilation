...
block_41120f:                                     ; preds = %entry
  ...
  %call2_411222 = call %struct.Memory* @sub_4006c0.printf_plt(%struct.State* %0, i64 %loadPC_411222, %struct.Memory* %loadMem2_411222)
  store %struct.Memory* %call2_411222, %struct.Memory** %MEMORY
