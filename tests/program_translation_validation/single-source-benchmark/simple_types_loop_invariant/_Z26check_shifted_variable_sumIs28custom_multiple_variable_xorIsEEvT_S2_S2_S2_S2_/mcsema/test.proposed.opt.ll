...
block_41120f:                                     ; preds = %entry
  ...
  %183 = tail call %struct.Memory* @__remill_function_call(%struct.State* nonnull %0, i64 ptrtoint (i64 (i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64)* @printf to i64), %struct.Memory* %call2_411202)
...
block_.L_41122a:                                  ; preds = %block_41120f, %entry
  %190 = phi i64 [ %175, %entry ], [ %.pre, %block_41120f ]
  %MEMORY.0 = phi %struct.Memory* [ %call2_411202, %entry ], [ %183, %block_41120f ]
