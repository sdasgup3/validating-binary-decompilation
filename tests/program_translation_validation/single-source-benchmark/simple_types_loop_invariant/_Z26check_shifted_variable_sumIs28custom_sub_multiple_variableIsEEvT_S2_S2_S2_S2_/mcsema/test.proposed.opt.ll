...
entry:
  ...
  %89 = add i64 %88, ptrtoint (%G_0x2081ed__rip__type* @G_0x2081ed__rip_ to i64)
  %90 = add i64 %88, 8
  ...
  %call2_411ec5 = tail call %struct.Memory* @sub_411e00._ZN28custom_sub_multiple_variableIsE8do_shiftEsssss(%struct.State* %0, i64 %132, %struct.Memory* %2)
  ...
  %call2_411ee2 = tail call %struct.Memory* @sub_411250._Z15tolerance_equalIsEbRT_S1_(%struct.State* %0, i64 %161, %struct.Memory* %call2_411ec5)
  ...
  br i1 %174, label %block_.L_411f0a, label %block_411eef
...
block_411eef:                                     ; preds = %entry
  ...
  %183 = tail call %struct.Memory* @__remill_function_call(%struct.State* nonnull %0, i64 ptrtoint (i64 (i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64)* @printf to i64), %struct.Memory* %call2_411ee2)
...
block_.L_411f0a:                                  ; preds = %block_411eef, %entry
  %190 = phi i64 [ %175, %entry ], [ %.pre, %block_411eef ]
  %MEMORY.0 = phi %struct.Memory* [ %call2_411ee2, %entry ], [ %183, %block_411eef ]
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_movsd_0x2081ed__rip____xmm0(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, ptrtoint (%G_0x2081ed__rip__type* @G_0x2081ed__rip_ to i64)
  %5 = add i64 %3, 8
  store i64 %5, i64* %PC, align 8
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_jne_.L_411f0a(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i8* nocapture %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
