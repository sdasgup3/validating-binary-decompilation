...
define %struct.Memory* @_Z26check_shifted_variable_sumIs28custom_sub_multiple_variableIsEEvT_S2_S2_S2_S2_(%struct.State* noalias, i64, %struct.Memory* noalias readnone) local_unnamed_addr #1 {
entry:
...
block_411edf:                                     ; preds = %entry
  ...
  %call2_411ef2 = tail call %struct.Memory* @sub_4006c0.printf_plt(%struct.State* nonnull %0, i64 %178, %struct.Memory* %call2_411ed2)
...
block_.L_411efa:                                  ; preds = %block_411edf, %entry
  %189 = phi i64 [ %175, %entry ], [ %.pre, %block_411edf ]
  %MEMORY.0 = phi %struct.Memory* [ %call2_411ed2, %entry ], [ %call2_411ef2, %block_411edf ]
