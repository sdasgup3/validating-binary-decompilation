...
define %struct.Memory* @_Z26check_shifted_variable_sumIs31custom_divide_multiple_variableIsEEvT_S2_S2_S2_S2_(%struct.State* noalias, i64, %struct.Memory* noalias readnone) local_unnamed_addr #1 {
entry:
...
block_411a1f:                                     ; preds = %entry
  ...
  %call2_411a32 = tail call %struct.Memory* @sub_4006c0.printf_plt(%struct.State* nonnull %0, i64 %178, %struct.Memory* %call2_411a12)
...
block_.L_411a3a:                                  ; preds = %block_411a1f, %entry
  %189 = phi i64 [ %175, %entry ], [ %.pre, %block_411a1f ]
  %MEMORY.0 = phi %struct.Memory* [ %call2_411a12, %entry ], [ %call2_411a32, %block_411a1f ]
