...
@G_0x2086ed__rip__4266395_ = local_unnamed_addr global %G_0x2086ed__rip__4266395__type zeroinitializer
...
define %struct.Memory* @_Z26check_shifted_variable_sumIs31custom_divide_multiple_variableIsEEvT_S2_S2_S2_S2_(%struct.State* noalias, i64, %struct.Memory* noalias) local_unnamed_addr #1 {
entry:
  ...
  %90 = load double, double* bitcast (%G_0x2086ed__rip__4266395__type* @G_0x2086ed__rip__4266395_ to double*), align 8
  ...
  %call2_4119c5 = tail call %struct.Memory* @sub_411900._ZN31custom_divide_multiple_variableIsE8do_shiftEsssss(%struct.State* %0, i64 %131, %struct.Memory* %2)
  ...
  %call2_4119e2 = tail call %struct.Memory* @sub_411210._Z15tolerance_equalIsEbRT_S1_(%struct.State* %0, i64 %160, %struct.Memory* %call2_4119c5)
  ...
  br i1 %173, label %block_.L_411a0a, label %block_4119ef
...
block_4119ef:                                     ; preds = %entry
  ...
  %182 = tail call %struct.Memory* @__remill_function_call(%struct.State* %0, i64 ptrtoint (i64 (i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64)* @printf to i64), %struct.Memory* %call2_4119e2)
...
block_.L_411a0a:                                  ; preds = %block_4119ef, %entry
  %189 = phi i64 [ %174, %entry ], [ %.pre, %block_4119ef ]
  %MEMORY.0 = phi %struct.Memory* [ %call2_4119e2, %entry ], [ %182, %block_4119ef ]
...
define %struct.Memory* @routine_movsd_0x2086ed__rip____xmm0(%struct.State* dereferenceable(3376), i64, %struct.Memory*) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, 8
  store i64 %4, i64* %PC, align 8
  %5 = load i64, i64* bitcast (%G_0x2086ed__rip__4266395__type* @G_0x2086ed__rip__4266395_ to i64*), align 8
...
define %struct.Memory* @routine_jne_.L_411a0a(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i8* %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
