...
entry:
  ...
  %89 = add i64 %88, ptrtoint (%G_0x2086ad__rip__type* @G_0x2086ad__rip_ to i64)
  %90 = add i64 %88, 8
  ...
  %call2_411a05 = tail call %struct.Memory* @sub_411940._ZN31custom_divide_multiple_variableIsE8do_shiftEsssss(%struct.State* %0, i64 %132, %struct.Memory* %2)
  ...
  %call2_411a22 = tail call %struct.Memory* @sub_411250._Z15tolerance_equalIsEbRT_S1_(%struct.State* %0, i64 %161, %struct.Memory* %call2_411a05)
  ...
  br i1 %174, label %block_.L_411a4a, label %block_411a2f
...
block_411a2f:                                     ; preds = %entry
  ...
  %183 = tail call %struct.Memory* @__remill_function_call(%struct.State* nonnull %0, i64 ptrtoint (i64 (i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64)* @printf to i64), %struct.Memory* %call2_411a22)
...
block_.L_411a4a:                                  ; preds = %block_411a2f, %entry
  %190 = phi i64 [ %175, %entry ], [ %.pre, %block_411a2f ]
  %MEMORY.0 = phi %struct.Memory* [ %call2_411a22, %entry ], [ %183, %block_411a2f ]
