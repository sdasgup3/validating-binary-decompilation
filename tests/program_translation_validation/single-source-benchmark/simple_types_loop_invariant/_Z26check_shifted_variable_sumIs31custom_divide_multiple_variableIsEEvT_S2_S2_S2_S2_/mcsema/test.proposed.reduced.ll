; ModuleID = '/tmp/tmp5abovs88-query.ll'
...
entry:
  ...
  %var_2_89 = add i64 %var_2_88, ptrtoint (%G_0x2086ad__rip__type* @G_0x2086ad__rip_ to i64)
  ...
  %call2_411a05 = tail call %struct.Memory* @sub_411940._ZN31custom_divide_multiple_variableIsE8do_shiftEsssss(%struct.State* %0, i64 %var_2_132, %struct.Memory* %2)
  %var_2_160 = load i64, i64* %var_2_3, align 8
  %var_2_161 = add i64 %var_2_160, -2002
  %call2_411a22 = tail call %struct.Memory* @sub_411250._Z15tolerance_equalIsEbRT_S1_(%struct.State* %0, i64 %var_2_161, %struct.Memory* %call2_411a05)
  ...
  br i1 %var_2_174, label %block_411a2f, label %block_.L_411a4a

block_411a2f:                                     ; preds = %entry
  %var_2_183 = tail call %struct.Memory* @__remill_function_call(%struct.State* nonnull %0, i64 ptrtoint (i64 (i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64)* @printf to i64), %struct.Memory* %call2_411a22)
  br label %block_.L_411a4a

block_.L_411a4a:                                  ; preds = %block_411a2f, %entry
  %MEMORY.0 = phi %struct.Memory* [ %call2_411a22, %entry ], [ %var_2_183, %block_411a2f ]
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_movsd_0x2086ad__rip____xmm0(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, ptrtoint (%G_0x2086ad__rip__type* @G_0x2086ad__rip_ to i64)
  %5 = add i64 %3, 8
  store i64 %5, i64* %PC, align 8
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_jne_.L_411a4a(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i8* nocapture %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
