...
block_4118ff:                                     ; preds = %entry
  ...
  %call2_411912 = call %struct.Memory* @sub_4006c0.printf_plt(%struct.State* %0, i64 %loadPC_411912, %struct.Memory* %loadMem2_411912)
  store %struct.Memory* %call2_411912, %struct.Memory** %MEMORY
