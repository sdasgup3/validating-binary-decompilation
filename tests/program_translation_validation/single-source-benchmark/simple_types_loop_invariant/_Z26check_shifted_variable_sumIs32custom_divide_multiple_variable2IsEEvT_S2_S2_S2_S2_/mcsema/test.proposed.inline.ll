...
%G_0x20880d__rip__4266107__type = type <{ [16 x i8] }>
...
@G_0x20880d__rip__4266107_ = global %G_0x20880d__rip__4266107__type zeroinitializer
...
declare %struct.Memory* @sub_4117e0._ZN32custom_divide_multiple_variable2IsE8do_shiftEsssss(%struct.State* noalias dereferenceable(3376), i64, %struct.Memory* noalias readnone returned)
...
define %struct.Memory* @_Z26check_shifted_variable_sumIs32custom_divide_multiple_variable2IsEEvT_S2_S2_S2_S2_(%struct.State* noalias, i64, %struct.Memory* noalias) #2 {
entry:
  ...
  %loadMem_411845 = load %struct.Memory*, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_411845, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_411859, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_41186f, %struct.Memory** %MEMORY
  %loadMem_411873 = load %struct.Memory*, %struct.Memory** %MEMORY
  ...
  %234 = load double, double* bitcast (%G_0x20880d__rip__4266107__type* @G_0x20880d__rip__4266107_ to double*)
  ...
  store %struct.Memory* %loadMem_411873, %struct.Memory** %MEMORY
  %loadMem_41187b = load %struct.Memory*, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_41187b, %struct.Memory** %MEMORY
  %loadMem_41187f = load %struct.Memory*, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_41187f, %struct.Memory** %MEMORY
  %loadMem_411882 = load %struct.Memory*, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_411882, %struct.Memory** %MEMORY
  ...
  %loadMem_411891 = load %struct.Memory*, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_411891, %struct.Memory** %MEMORY
  %loadMem_411894 = load %struct.Memory*, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_411894, %struct.Memory** %MEMORY
  ...
  %loadMem1_4118a5 = load %struct.Memory*, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem1_4118a5, %struct.Memory** %MEMORY
  %loadMem2_4118a5 = load %struct.Memory*, %struct.Memory** %MEMORY
  %loadPC_4118a5 = load i64, i64* %3
  %call2_4118a5 = call %struct.Memory* @sub_4117e0._ZN32custom_divide_multiple_variable2IsE8do_shiftEsssss(%struct.State* %0, i64 %loadPC_4118a5, %struct.Memory* %loadMem2_4118a5)
  store %struct.Memory* %call2_4118a5, %struct.Memory** %MEMORY
  %loadMem_4118aa = load %struct.Memory*, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_4118aa, %struct.Memory** %MEMORY
  %loadMem_4118ae = load %struct.Memory*, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_4118ae, %struct.Memory** %MEMORY
  ...
  %loadMem_4118bb = load %struct.Memory*, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_4118bb, %struct.Memory** %MEMORY
  %loadMem_4118be = load %struct.Memory*, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_4118be, %struct.Memory** %MEMORY
  %loadMem1_4118c2 = load %struct.Memory*, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem1_4118c2, %struct.Memory** %MEMORY
  %loadMem2_4118c2 = load %struct.Memory*, %struct.Memory** %MEMORY
  %loadPC_4118c2 = load i64, i64* %3
  %call2_4118c2 = call %struct.Memory* @sub_411210._Z15tolerance_equalIsEbRT_S1_(%struct.State* %0, i64 %loadPC_4118c2, %struct.Memory* %loadMem2_4118c2)
  store %struct.Memory* %call2_4118c2, %struct.Memory** %MEMORY
  ...
  %loadBr_4118c9 = load i8, i8* %BRANCH_TAKEN
  %cmpBr_4118c9 = icmp eq i8 %loadBr_4118c9, 1
  br i1 %cmpBr_4118c9, label %block_.L_4118ea, label %block_4118cf

block_4118cf:                                     ; preds = %entry
  ...
  %loadMem1_4118e2 = load %struct.Memory*, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem1_4118e2, %struct.Memory** %MEMORY
  %loadMem2_4118e2 = load %struct.Memory*, %struct.Memory** %MEMORY
  %loadPC_4118e2 = load i64, i64* %3
  %619 = call %struct.Memory* @__remill_function_call(%struct.State* %0, i64 ptrtoint (i64 (i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64)* @printf to i64), %struct.Memory* %loadMem2_4118e2)
  store %struct.Memory* %619, %struct.Memory** %MEMORY
  %loadMem_4118e7 = load %struct.Memory*, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_4118e7, %struct.Memory** %MEMORY
  br label %block_.L_4118ea

block_.L_4118ea:                                  ; preds = %block_4118cf, %entry
  %loadMem_4118ea = load %struct.Memory*, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_4118ea, %struct.Memory** %MEMORY
  %loadMem_4118ee = load %struct.Memory*, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_4118ee, %struct.Memory** %MEMORY
  ...
  %loadMem_4118f0 = load %struct.Memory*, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_4118f0, %struct.Memory** %MEMORY
  ret %struct.Memory* %loadMem_4118f0
}
...
define %struct.Memory* @routine_movsd_0x20880d__rip____xmm0(%struct.State* dereferenceable(3376), i64, %struct.Memory*) {
block_400478:
  %3 = getelementptr inbounds %struct.State, %struct.State* %0, i32 0, i32 6
  %4 = getelementptr inbounds %struct.GPR, %struct.GPR* %3, i32 0, i32 33
  %5 = getelementptr inbounds %struct.Reg, %struct.Reg* %4, i32 0, i32 0
  ...
  %9 = load i64, i64* %PC
  %10 = ptrtoint %G_0x20880d__rip__4266107__type* @G_0x20880d__rip__4266107_ to i64
  %11 = load i64, i64* %PC
  %12 = add i64 %11, 8
  store i64 %12, i64* %PC
...
define %struct.Memory* @routine_callq_._ZN32custom_divide_multiple_variable2IsE8do_shiftEsssss(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) {
block_400478:
  %3 = getelementptr inbounds %struct.State, %struct.State* %0, i32 0, i32 6
  %4 = getelementptr inbounds %struct.GPR, %struct.GPR* %3, i32 0, i32 33
  %5 = getelementptr inbounds %struct.Reg, %struct.Reg* %4, i32 0, i32 0
...
define %struct.Memory* @routine_jne_.L_4118ea(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i8* %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) {
block_400478:
  %3 = getelementptr inbounds %struct.State, %struct.State* %0, i32 0, i32 6
  %4 = getelementptr inbounds %struct.GPR, %struct.GPR* %3, i32 0, i32 33
  %5 = getelementptr inbounds %struct.Reg, %struct.Reg* %4, i32 0, i32 0
