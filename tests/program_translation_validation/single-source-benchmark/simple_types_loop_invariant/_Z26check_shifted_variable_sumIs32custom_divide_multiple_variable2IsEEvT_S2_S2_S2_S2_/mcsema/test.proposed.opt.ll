...
entry:
  ...
  %89 = add i64 %88, ptrtoint (%G_0x2087cd__rip__type* @G_0x2087cd__rip_ to i64)
  %90 = add i64 %88, 8
  ...
  %call2_4118e5 = tail call %struct.Memory* @sub_411820._ZN32custom_divide_multiple_variable2IsE8do_shiftEsssss(%struct.State* %0, i64 %132, %struct.Memory* %2)
  ...
  %call2_411902 = tail call %struct.Memory* @sub_411250._Z15tolerance_equalIsEbRT_S1_(%struct.State* %0, i64 %161, %struct.Memory* %call2_4118e5)
  ...
  br i1 %174, label %block_.L_41192a, label %block_41190f
...
block_41190f:                                     ; preds = %entry
  ...
  %183 = tail call %struct.Memory* @__remill_function_call(%struct.State* nonnull %0, i64 ptrtoint (i64 (i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64)* @printf to i64), %struct.Memory* %call2_411902)
...
block_.L_41192a:                                  ; preds = %block_41190f, %entry
  %190 = phi i64 [ %175, %entry ], [ %.pre, %block_41190f ]
  %MEMORY.0 = phi %struct.Memory* [ %call2_411902, %entry ], [ %183, %block_41190f ]
