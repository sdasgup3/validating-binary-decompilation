...
declare %struct.Memory* @sub_411810._ZN32custom_divide_multiple_variable2IsE8do_shiftEsssss(%struct.State* noalias dereferenceable(3376), i64, %struct.Memory* noalias readnone returned) local_unnamed_addr
...
define %struct.Memory* @_Z26check_shifted_variable_sumIs32custom_divide_multiple_variable2IsEEvT_S2_S2_S2_S2_(%struct.State* noalias, i64, %struct.Memory* noalias readnone) local_unnamed_addr #1 {
entry:
  ...
  %call2_4118d5 = tail call %struct.Memory* @sub_411810._ZN32custom_divide_multiple_variable2IsE8do_shiftEsssss(%struct.State* %0, i64 %132, %struct.Memory* %2)
  ...
  %call2_4118f2 = tail call %struct.Memory* @sub_411240._Z15tolerance_equalIsEbRT_S1_(%struct.State* %0, i64 %161, %struct.Memory* %call2_4118d5)
  ...
  br i1 %174, label %block_.L_41191a, label %block_4118ff
...
block_4118ff:                                     ; preds = %entry
  ...
  %call2_411912 = tail call %struct.Memory* @sub_4006c0.printf_plt(%struct.State* nonnull %0, i64 %178, %struct.Memory* %call2_4118f2)
...
block_.L_41191a:                                  ; preds = %block_4118ff, %entry
  %189 = phi i64 [ %175, %entry ], [ %.pre, %block_4118ff ]
  %MEMORY.0 = phi %struct.Memory* [ %call2_4118f2, %entry ], [ %call2_411912, %block_4118ff ]
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_movsd_0x2087dd__rip____xmm0(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_jne_.L_41191a(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i8* nocapture %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
