...
block_4118ff:                                     ; preds = %entry
  ...
  %183 = tail call %struct.Memory* @__remill_function_call(%struct.State* nonnull %0, i64 ptrtoint (i64 (i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64)* @printf to i64), %struct.Memory* %call2_4118f2)
...
block_.L_41191a:                                  ; preds = %block_4118ff, %entry
  %190 = phi i64 [ %175, %entry ], [ %.pre, %block_4118ff ]
  %MEMORY.0 = phi %struct.Memory* [ %call2_4118f2, %entry ], [ %183, %block_4118ff ]
