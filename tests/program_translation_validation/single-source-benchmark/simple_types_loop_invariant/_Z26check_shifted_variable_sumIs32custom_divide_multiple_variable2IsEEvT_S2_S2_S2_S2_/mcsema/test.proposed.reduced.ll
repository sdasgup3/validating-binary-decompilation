; ModuleID = '/tmp/tmptzeuem28-query.ll'
source_filename = "llvm-link"
target datalayout = "e-m:e-i64:64-f80:128-n8:16:32:64-S128"
target triple = "x86_64-pc-linux-gnu-elf"

%__bss_start_type = type <{ [8 x i8] }>
%G_0x2087cd__rip__type = type <{ [8 x i8] }>
...
@G_0x2087cd__rip_ = global %G_0x2087cd__rip__type zeroinitializer
...
declare %struct.Memory* @sub_411820._ZN32custom_divide_multiple_variable2IsE8do_shiftEsssss(%struct.State* noalias dereferenceable(3376), i64, %struct.Memory* noalias readnone returned) local_unnamed_addr
...
define %struct.Memory* @_Z26check_shifted_variable_sumIs32custom_divide_multiple_variable2IsEEvT_S2_S2_S2_S2_(%struct.State* noalias, i64, %struct.Memory* noalias) local_unnamed_addr #1 {
entry:
  %var_2_3 = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %var_2_46 = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 1, i32 0
  %AX.i83 = bitcast %union.anon* %var_2_46 to i16*
  %var_2_88 = load i64, i64* %var_2_3, align 8
  %var_2_89 = add i64 %var_2_88, ptrtoint (%G_0x2087cd__rip__type* @G_0x2087cd__rip_ to i64)
  ...
  store i64 %var_2_102, i64* %RCX.i57, align 8
  %var_2_103 = trunc i64 %var_2_102 to i16
  store i16 %var_2_103, i16* %AX.i83, align 2
  %RDI.i43 = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 11, i32 0, i32 0
  %sext = shl i64 %var_2_102, 48
  %var_2_117 = ashr exact i64 %sext, 48
  %var_2_118 = and i64 %var_2_117, 4294967295
  store i64 %var_2_118, i64* %RDI.i43, align 8
  %var_2_132 = add i64 %var_2_88, -147
  %call2_4118e5 = tail call %struct.Memory* @sub_411820._ZN32custom_divide_multiple_variable2IsE8do_shiftEsssss(%struct.State* %0, i64 %var_2_132, %struct.Memory* %2)
  %var_2_160 = load i64, i64* %var_2_3, align 8
  %var_2_161 = add i64 %var_2_160, -1714
  %call2_411902 = tail call %struct.Memory* @sub_411250._Z15tolerance_equalIsEbRT_S1_(%struct.State* %0, i64 %var_2_161, %struct.Memory* %call2_4118e5)
  %AL.i17 = bitcast %union.anon* %var_2_46 to i8*
  %var_2_166 = load i8, i8* %AL.i17, align 1
  %var_2_168 = and i8 %var_2_166, 1
  %var_2_174 = icmp eq i8 %var_2_168, 0
  br i1 %var_2_174, label %block_41190f, label %block_.L_41192a

block_41190f:                                     ; preds = %entry
  %var_2_183 = tail call %struct.Memory* @__remill_function_call(%struct.State* nonnull %0, i64 ptrtoint (i64 (i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64)* @printf to i64), %struct.Memory* %call2_411902)
  br label %block_.L_41192a

block_.L_41192a:                                  ; preds = %block_41190f, %entry
  %MEMORY.0 = phi %struct.Memory* [ %call2_411902, %entry ], [ %var_2_183, %block_41190f ]
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_movsd_0x2087cd__rip____xmm0(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, ptrtoint (%G_0x2087cd__rip__type* @G_0x2087cd__rip_ to i64)
  %5 = add i64 %3, 8
  store i64 %5, i64* %PC, align 8
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_callq_._ZN32custom_divide_multiple_variable2IsE8do_shiftEsssss(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_jne_.L_41192a(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i8* nocapture %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
