; ModuleID = '/tmp/tmpmeed7idc-query.ll'
...
entry:
  ...
  %var_2_89 = add i64 %var_2_88, ptrtoint (%G_0x2083bd__rip__type* @G_0x2083bd__rip_ to i64)
  ...
  %call2_411cf5 = tail call %struct.Memory* @sub_411c30._ZN33custom_multiply_multiple_variableIsE8do_shiftEsssss(%struct.State* %0, i64 %var_2_132, %struct.Memory* %2)
  %var_2_160 = load i64, i64* %var_2_3, align 8
  %var_2_161 = add i64 %var_2_160, -2754
  %call2_411d12 = tail call %struct.Memory* @sub_411250._Z15tolerance_equalIsEbRT_S1_(%struct.State* %0, i64 %var_2_161, %struct.Memory* %call2_411cf5)
  ...
  br i1 %var_2_174, label %block_411d1f, label %block_.L_411d3a

block_411d1f:                                     ; preds = %entry
  %var_2_183 = tail call %struct.Memory* @__remill_function_call(%struct.State* nonnull %0, i64 ptrtoint (i64 (i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64)* @printf to i64), %struct.Memory* %call2_411d12)
  br label %block_.L_411d3a

block_.L_411d3a:                                  ; preds = %block_411d1f, %entry
  %MEMORY.0 = phi %struct.Memory* [ %call2_411d12, %entry ], [ %var_2_183, %block_411d1f ]
