...
define %struct.Memory* @_Z26check_shifted_variable_sumIs34custom_multiply_multiple_variable2IsEEvT_S2_S2_S2_S2_(%struct.State* noalias, i64, %struct.Memory* noalias) #2 {
entry:
  ...
  store %struct.Memory* %loadMem_411b65, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_411b8f, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_411ba7, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_411bb1, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_411bb4, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_411bb8, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem1_411bc5, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_411bce, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem1_411be2, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_411be7, %struct.Memory** %MEMORY
...
block_411bef:                                     ; preds = %entry
  ...
  store %struct.Memory* %loadMem1_411c02, %struct.Memory** %MEMORY
  %loadMem2_411c02 = load %struct.Memory*, %struct.Memory** %MEMORY
  %loadPC_411c02 = load i64, i64* %3
  %621 = call %struct.Memory* @__remill_function_call(%struct.State* %0, i64 ptrtoint (i64 (i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64)* @printf to i64), %struct.Memory* %loadMem2_411c02)
  ...
  store %struct.Memory* %loadMem_411c07, %struct.Memory** %MEMORY
  br label %block_.L_411c0a

block_.L_411c0a:                                  ; preds = %block_411bef, %entry
  ...
  store %struct.Memory* %loadMem_411c0a, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_411c0e, %struct.Memory** %MEMORY
  ...
  ret %struct.Memory* %loadMem_411c10
}
...
define %struct.Memory* @routine_movsd_0x2084ed__rip____xmm0(%struct.State* dereferenceable(3376), i64, %struct.Memory*) {
block_400488:
  %3 = getelementptr inbounds %struct.State, %struct.State* %0, i32 0, i32 6
  %4 = getelementptr inbounds %struct.GPR, %struct.GPR* %3, i32 0, i32 33
  %5 = getelementptr inbounds %struct.Reg, %struct.Reg* %4, i32 0, i32 0
