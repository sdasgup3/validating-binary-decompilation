...
@G_0x20851d__rip__4266859_ = global %G_0x20851d__rip__4266859__type zeroinitializer
...
entry:
  ...
  store %struct.Memory* %loadMem_411b30, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_411b5a, %struct.Memory** %MEMORY
  ...
  %234 = load double, double* bitcast (%G_0x20851d__rip__4266859__type* @G_0x20851d__rip__4266859_ to double*)
  ...
  store %struct.Memory* %loadMem_411b77, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem1_411b95, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_411b9a, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_411b9e, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_411bae, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem1_411bb2, %struct.Memory** %MEMORY
...
block_411bbf:                                     ; preds = %entry
  ...
  store %struct.Memory* %loadMem1_411bd2, %struct.Memory** %MEMORY
  %loadMem2_411bd2 = load %struct.Memory*, %struct.Memory** %MEMORY
  %loadPC_411bd2 = load i64, i64* %3
  %619 = call %struct.Memory* @__remill_function_call(%struct.State* %0, i64 ptrtoint (i64 (i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64)* @printf to i64), %struct.Memory* %loadMem2_411bd2)
  ...
  store %struct.Memory* %loadMem_411bd7, %struct.Memory** %MEMORY
  br label %block_.L_411bda

block_.L_411bda:                                  ; preds = %block_411bbf, %entry
  ...
  ret %struct.Memory* %loadMem_411be0
}
...
define %struct.Memory* @routine_movsd_0x20851d__rip____xmm0(%struct.State* dereferenceable(3376), i64, %struct.Memory*) {
block_400478:
  %3 = getelementptr inbounds %struct.State, %struct.State* %0, i32 0, i32 6
  %4 = getelementptr inbounds %struct.GPR, %struct.GPR* %3, i32 0, i32 33
  %5 = getelementptr inbounds %struct.Reg, %struct.Reg* %4, i32 0, i32 0
