...
entry:
  ...
  %89 = add i64 %88, ptrtoint (%G_0x2084dd__rip__type* @G_0x2084dd__rip_ to i64)
  %90 = add i64 %88, 8
  ...
  %call2_411bd5 = tail call %struct.Memory* @sub_411b10._ZN34custom_multiply_multiple_variable2IsE8do_shiftEsssss(%struct.State* %0, i64 %132, %struct.Memory* %2)
  ...
  %call2_411bf2 = tail call %struct.Memory* @sub_411250._Z15tolerance_equalIsEbRT_S1_(%struct.State* %0, i64 %161, %struct.Memory* %call2_411bd5)
  ...
  br i1 %174, label %block_.L_411c1a, label %block_411bff
...
block_411bff:                                     ; preds = %entry
  ...
  %183 = tail call %struct.Memory* @__remill_function_call(%struct.State* nonnull %0, i64 ptrtoint (i64 (i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64)* @printf to i64), %struct.Memory* %call2_411bf2)
...
block_.L_411c1a:                                  ; preds = %block_411bff, %entry
  %190 = phi i64 [ %175, %entry ], [ %.pre, %block_411bff ]
  %MEMORY.0 = phi %struct.Memory* [ %call2_411bf2, %entry ], [ %183, %block_411bff ]
