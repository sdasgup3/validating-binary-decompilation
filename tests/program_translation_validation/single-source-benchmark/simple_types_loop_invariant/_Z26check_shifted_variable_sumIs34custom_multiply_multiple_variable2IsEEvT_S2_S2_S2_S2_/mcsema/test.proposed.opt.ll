...
block_411bef:                                     ; preds = %entry
  ...
  %183 = tail call %struct.Memory* @__remill_function_call(%struct.State* nonnull %0, i64 ptrtoint (i64 (i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64)* @printf to i64), %struct.Memory* %call2_411be2)
...
block_.L_411c0a:                                  ; preds = %block_411bef, %entry
  %190 = phi i64 [ %175, %entry ], [ %.pre, %block_411bef ]
  %MEMORY.0 = phi %struct.Memory* [ %call2_411be2, %entry ], [ %183, %block_411bef ]
