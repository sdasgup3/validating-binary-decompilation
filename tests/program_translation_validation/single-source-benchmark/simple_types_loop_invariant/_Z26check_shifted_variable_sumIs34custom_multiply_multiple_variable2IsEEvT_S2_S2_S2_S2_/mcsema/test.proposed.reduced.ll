; ModuleID = '/tmp/tmpdxc_k2jj-query.ll'
...
@G_0x2084dd__rip_ = global %G_0x2084dd__rip__type zeroinitializer
...
define %struct.Memory* @_Z26check_shifted_variable_sumIs34custom_multiply_multiple_variable2IsEEvT_S2_S2_S2_S2_(%struct.State* noalias, i64, %struct.Memory* noalias) local_unnamed_addr #1 {
entry:
  ...
  %var_2_89 = add i64 %var_2_88, ptrtoint (%G_0x2084dd__rip__type* @G_0x2084dd__rip_ to i64)
  ...
  %call2_411bd5 = tail call %struct.Memory* @sub_411b10._ZN34custom_multiply_multiple_variable2IsE8do_shiftEsssss(%struct.State* %0, i64 %var_2_132, %struct.Memory* %2)
  %var_2_160 = load i64, i64* %var_2_3, align 8
  %var_2_161 = add i64 %var_2_160, -2466
  %call2_411bf2 = tail call %struct.Memory* @sub_411250._Z15tolerance_equalIsEbRT_S1_(%struct.State* %0, i64 %var_2_161, %struct.Memory* %call2_411bd5)
  ...
  br i1 %var_2_174, label %block_411bff, label %block_.L_411c1a

block_411bff:                                     ; preds = %entry
  %var_2_183 = tail call %struct.Memory* @__remill_function_call(%struct.State* nonnull %0, i64 ptrtoint (i64 (i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64)* @printf to i64), %struct.Memory* %call2_411bf2)
  br label %block_.L_411c1a

block_.L_411c1a:                                  ; preds = %block_411bff, %entry
  %MEMORY.0 = phi %struct.Memory* [ %call2_411bf2, %entry ], [ %var_2_183, %block_411bff ]
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_movsd_0x2084dd__rip____xmm0(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, ptrtoint (%G_0x2084dd__rip__type* @G_0x2084dd__rip_ to i64)
  %5 = add i64 %3, 8
  store i64 %5, i64* %PC, align 8
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_jne_.L_411c1a(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i8* nocapture %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
