...
entry:
  ...
  %56 = add i64 %55, ptrtoint (%G_0x209baa__rip__type* @G_0x209baa__rip_ to i64)
  %57 = add i64 %55, 8
  ...
  %call2_4104e8 = tail call %struct.Memory* @sub_410490._ZN18custom_variable_orItE8do_shiftEtt(%struct.State* %0, i64 %74, %struct.Memory* %2)
  ...
  %call2_410505 = tail call %struct.Memory* @sub_410270._Z15tolerance_equalItEbRT_S1_(%struct.State* %0, i64 %100, %struct.Memory* %call2_4104e8)
  ...
  br i1 %113, label %block_.L_41052d, label %block_410512
...
block_410512:                                     ; preds = %entry
  ...
  %122 = tail call %struct.Memory* @__remill_function_call(%struct.State* nonnull %0, i64 ptrtoint (i64 (i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64)* @printf to i64), %struct.Memory* %call2_410505)
...
block_.L_41052d:                                  ; preds = %block_410512, %entry
  %129 = phi i64 [ %114, %entry ], [ %.pre, %block_410512 ]
  %MEMORY.0 = phi %struct.Memory* [ %call2_410505, %entry ], [ %122, %block_410512 ]
