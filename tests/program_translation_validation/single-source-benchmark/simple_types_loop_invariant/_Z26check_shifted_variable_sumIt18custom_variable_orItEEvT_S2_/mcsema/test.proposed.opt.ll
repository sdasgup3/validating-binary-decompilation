...
define %struct.Memory* @_Z26check_shifted_variable_sumIt18custom_variable_orItEEvT_S2_(%struct.State* noalias, i64, %struct.Memory* noalias readnone) local_unnamed_addr #1 {
entry:
  ...
  %call2_4104d8 = tail call %struct.Memory* @sub_410480._ZN18custom_variable_orItE8do_shiftEtt(%struct.State* %0, i64 %74, %struct.Memory* %2)
  ...
  %call2_4104f5 = tail call %struct.Memory* @sub_410260._Z15tolerance_equalItEbRT_S1_(%struct.State* %0, i64 %100, %struct.Memory* %call2_4104d8)
  ...
  br i1 %113, label %block_.L_41051d, label %block_410502
...
block_410502:                                     ; preds = %entry
  ...
  %call2_410515 = tail call %struct.Memory* @sub_4006c0.printf_plt(%struct.State* nonnull %0, i64 %117, %struct.Memory* %call2_4104f5)
...
block_.L_41051d:                                  ; preds = %block_410502, %entry
  %128 = phi i64 [ %114, %entry ], [ %.pre, %block_410502 ]
  %MEMORY.0 = phi %struct.Memory* [ %call2_4104f5, %entry ], [ %call2_410515, %block_410502 ]
...
; Function Attrs: nounwind
define %struct.Memory* @routine_cvttsd2si_0x209bba__rip____esi(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned) local_unnamed_addr #3 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_jne_.L_41051d(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i8* nocapture %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
