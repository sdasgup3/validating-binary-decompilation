...
block_410502:                                     ; preds = %entry
  ...
  %122 = tail call %struct.Memory* @__remill_function_call(%struct.State* nonnull %0, i64 ptrtoint (i64 (i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64)* @printf to i64), %struct.Memory* %call2_4104f5)
...
block_.L_41051d:                                  ; preds = %block_410502, %entry
  %129 = phi i64 [ %114, %entry ], [ %.pre, %block_410502 ]
  %MEMORY.0 = phi %struct.Memory* [ %call2_4104f5, %entry ], [ %122, %block_410502 ]
