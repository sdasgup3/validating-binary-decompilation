; ModuleID = '/tmp/tmpjujslqlk-query.ll'
...
define %struct.Memory* @_Z26check_shifted_variable_sumIt18custom_variable_orItEEvT_S2_(%struct.State* noalias, i64, %struct.Memory* noalias) local_unnamed_addr #1 {
entry:
  ...
  %var_2_56 = add i64 %var_2_55, ptrtoint (%G_0x209baa__rip__type* @G_0x209baa__rip_ to i64)
  ...
  %call2_4104e8 = tail call %struct.Memory* @sub_410490._ZN18custom_variable_orItE8do_shiftEtt(%struct.State* %0, i64 %var_2_74, %struct.Memory* %2)
  %var_2_99 = load i64, i64* %var_2_3, align 8
  %var_2_100 = add i64 %var_2_99, -661
  %call2_410505 = tail call %struct.Memory* @sub_410270._Z15tolerance_equalItEbRT_S1_(%struct.State* %0, i64 %var_2_100, %struct.Memory* %call2_4104e8)
  ...
  br i1 %var_2_113, label %block_410512, label %block_.L_41052d

block_410512:                                     ; preds = %entry
  %var_2_122 = tail call %struct.Memory* @__remill_function_call(%struct.State* nonnull %0, i64 ptrtoint (i64 (i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64)* @printf to i64), %struct.Memory* %call2_410505)
  br label %block_.L_41052d

block_.L_41052d:                                  ; preds = %block_410512, %entry
  %MEMORY.0 = phi %struct.Memory* [ %call2_410505, %entry ], [ %var_2_122, %block_410512 ]
...
; Function Attrs: nounwind
define %struct.Memory* @routine_cvttsd2si_0x209baa__rip____esi(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned) local_unnamed_addr #3 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %RSI = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 9, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, ptrtoint (%G_0x209baa__rip__type* @G_0x209baa__rip_ to i64)
  %5 = add i64 %3, 8
  store i64 %5, i64* %PC, align 8
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_jne_.L_41052d(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i8* nocapture %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
