...
entry:
  ...
  %56 = add i64 %55, ptrtoint (%G_0x208fea__rip__type* @G_0x208fea__rip_ to i64)
  %57 = add i64 %55, 8
  ...
  %call2_4110a8 = tail call %struct.Memory* @sub_411100._ZN19custom_add_variableItE8do_shiftEtt(%struct.State* %0, i64 %74, %struct.Memory* %2)
  ...
  %call2_4110c5 = tail call %struct.Memory* @sub_410270._Z15tolerance_equalItEbRT_S1_(%struct.State* %0, i64 %100, %struct.Memory* %call2_4110a8)
  ...
  br i1 %113, label %block_.L_4110ed, label %block_4110d2
...
block_4110d2:                                     ; preds = %entry
  ...
  %122 = tail call %struct.Memory* @__remill_function_call(%struct.State* nonnull %0, i64 ptrtoint (i64 (i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64)* @printf to i64), %struct.Memory* %call2_4110c5)
...
block_.L_4110ed:                                  ; preds = %block_4110d2, %entry
  %129 = phi i64 [ %114, %entry ], [ %.pre, %block_4110d2 ]
  %MEMORY.0 = phi %struct.Memory* [ %call2_4110c5, %entry ], [ %122, %block_4110d2 ]
