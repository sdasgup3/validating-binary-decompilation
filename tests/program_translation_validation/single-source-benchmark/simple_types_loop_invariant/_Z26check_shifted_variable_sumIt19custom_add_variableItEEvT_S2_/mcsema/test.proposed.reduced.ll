; ModuleID = '/tmp/tmp677x6tjr-query.ll'
...
define %struct.Memory* @_Z26check_shifted_variable_sumIt19custom_add_variableItEEvT_S2_(%struct.State* noalias, i64, %struct.Memory* noalias) local_unnamed_addr #1 {
entry:
  %var_2_3 = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %var_2_40 = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 1, i32 0
  %AX.i51 = bitcast %union.anon* %var_2_40 to i16*
  ...
  %var_2_56 = add i64 %var_2_55, ptrtoint (%G_0x208fea__rip__type* @G_0x208fea__rip_ to i64)
  ...
  store i64 %var_2_65, i64* %RSI.i42, align 8
  %var_2_66 = trunc i64 %var_2_65 to i16
  store i16 %var_2_66, i16* %AX.i51, align 2
  %RDI.i38 = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 11, i32 0, i32 0
  %var_2_67 = and i64 %var_2_65, 65535
  store i64 %var_2_67, i64* %RDI.i38, align 8
  %var_2_74 = add i64 %var_2_55, 106
  %call2_4110a8 = tail call %struct.Memory* @sub_411100._ZN19custom_add_variableItE8do_shiftEtt(%struct.State* %0, i64 %var_2_74, %struct.Memory* %2)
  %var_2_99 = load i64, i64* %var_2_3, align 8
  %var_2_100 = add i64 %var_2_99, -3669
  %call2_4110c5 = tail call %struct.Memory* @sub_410270._Z15tolerance_equalItEbRT_S1_(%struct.State* %0, i64 %var_2_100, %struct.Memory* %call2_4110a8)
  %AL.i16 = bitcast %union.anon* %var_2_40 to i8*
  %var_2_105 = load i8, i8* %AL.i16, align 1
  %var_2_107 = and i8 %var_2_105, 1
  %var_2_113 = icmp eq i8 %var_2_107, 0
  br i1 %var_2_113, label %block_4110d2, label %block_.L_4110ed

block_4110d2:                                     ; preds = %entry
  %var_2_122 = tail call %struct.Memory* @__remill_function_call(%struct.State* nonnull %0, i64 ptrtoint (i64 (i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64)* @printf to i64), %struct.Memory* %call2_4110c5)
  br label %block_.L_4110ed

block_.L_4110ed:                                  ; preds = %block_4110d2, %entry
  %MEMORY.0 = phi %struct.Memory* [ %call2_4110c5, %entry ], [ %var_2_122, %block_4110d2 ]
...
; Function Attrs: nounwind
define %struct.Memory* @routine_cvttsd2si_0x208fea__rip____esi(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned) local_unnamed_addr #3 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %RSI = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 9, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, ptrtoint (%G_0x208fea__rip__type* @G_0x208fea__rip_ to i64)
  %5 = add i64 %3, 8
  store i64 %5, i64* %PC, align 8
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_jne_.L_4110ed(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i8* nocapture %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
