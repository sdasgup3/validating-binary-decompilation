...
@G_0x20917a__rip_ = global %G_0x20917a__rip__type zeroinitializer
...
entry:
  ...
  %56 = add i64 %55, ptrtoint (%G_0x20917a__rip__type* @G_0x20917a__rip_ to i64)
  %57 = add i64 %55, 8
  ...
  %call2_410f18 = tail call %struct.Memory* @sub_410ec0._ZN19custom_sub_variableItE8do_shiftEtt(%struct.State* %0, i64 %74, %struct.Memory* %2)
  ...
  %call2_410f35 = tail call %struct.Memory* @sub_410270._Z15tolerance_equalItEbRT_S1_(%struct.State* %0, i64 %100, %struct.Memory* %call2_410f18)
  ...
  br i1 %113, label %block_.L_410f5d, label %block_410f42

block_410f42:                                     ; preds = %entry
  ...
  %122 = tail call %struct.Memory* @__remill_function_call(%struct.State* nonnull %0, i64 ptrtoint (i64 (i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64)* @printf to i64), %struct.Memory* %call2_410f35)
...
block_.L_410f5d:                                  ; preds = %block_410f42, %entry
  %129 = phi i64 [ %114, %entry ], [ %.pre, %block_410f42 ]
  %MEMORY.0 = phi %struct.Memory* [ %call2_410f35, %entry ], [ %122, %block_410f42 ]
...
; Function Attrs: alwaysinline nounwind
define %struct.Memory* @routine_cvttsd2si_0x20917a__rip____esi(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned) local_unnamed_addr #3 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %RSI = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 9, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, ptrtoint (%G_0x20917a__rip__type* @G_0x20917a__rip_ to i64)
  %5 = add i64 %3, 8
  store i64 %5, i64* %PC, align 8
...
; Function Attrs: alwaysinline norecurse nounwind
define %struct.Memory* @routine_jne_.L_410f5d(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i8* nocapture %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
