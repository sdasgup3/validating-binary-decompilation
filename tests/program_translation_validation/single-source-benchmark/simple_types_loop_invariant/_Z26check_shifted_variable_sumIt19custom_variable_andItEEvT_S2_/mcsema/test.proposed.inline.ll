...
@G_0x209a2a__rip__4261470_ = global %G_0x209a2a__rip__4261470__type zeroinitializer
...
entry:
  ...
  %134 = load double, double* bitcast (%G_0x209a2a__rip__4261470__type* @G_0x209a2a__rip__4261470_ to double*)
  ...
  store %struct.Memory* %loadMem1_410685, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_41068a, %struct.Memory** %MEMORY
...
block_410692:                                     ; preds = %entry
  ...
  store %struct.Memory* %loadMem1_4106a5, %struct.Memory** %MEMORY
  %loadMem2_4106a5 = load %struct.Memory*, %struct.Memory** %MEMORY
  %loadPC_4106a5 = load i64, i64* %3
  %399 = call %struct.Memory* @__remill_function_call(%struct.State* %0, i64 ptrtoint (i64 (i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64)* @printf to i64), %struct.Memory* %loadMem2_4106a5)
  ...
  store %struct.Memory* %loadMem_4106aa, %struct.Memory** %MEMORY
...
block_.L_4106ad:                                  ; preds = %block_410692, %entry
  ...
  ret %struct.Memory* %loadMem_4106b2
}
...
define %struct.Memory* @routine_cvttsd2si_0x209a2a__rip____esi(%struct.State* dereferenceable(3376), i64, %struct.Memory*) {
block_400478:
  %3 = getelementptr inbounds %struct.State, %struct.State* %0, i32 0, i32 6
  %4 = getelementptr inbounds %struct.GPR, %struct.GPR* %3, i32 0, i32 33
  %5 = getelementptr inbounds %struct.Reg, %struct.Reg* %4, i32 0, i32 0
