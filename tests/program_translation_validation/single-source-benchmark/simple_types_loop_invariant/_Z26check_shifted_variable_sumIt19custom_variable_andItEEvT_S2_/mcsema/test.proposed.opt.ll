...
%G_0x2099ea__rip__type = type <{ [8 x i8] }>
...
@G_0x2099ea__rip_ = global %G_0x2099ea__rip__type zeroinitializer
...
declare %struct.Memory* @sub_410650._ZN19custom_variable_andItE8do_shiftEtt(%struct.State* noalias dereferenceable(3376), i64, %struct.Memory* noalias readnone returned) local_unnamed_addr
...
entry:
  ...
  %56 = add i64 %55, ptrtoint (%G_0x2099ea__rip__type* @G_0x2099ea__rip_ to i64)
  %57 = add i64 %55, 8
  ...
  store i64 %65, i64* %RSI.i42, align 8
  %66 = trunc i64 %65 to i16
  store i16 %66, i16* %AX.i51, align 2
  ...
  %call2_4106a8 = tail call %struct.Memory* @sub_410650._ZN19custom_variable_andItE8do_shiftEtt(%struct.State* %0, i64 %74, %struct.Memory* %2)
  %79 = load i64, i64* %RBP.i, align 8
  %80 = add i64 %79, -2
  %81 = load i64, i64* %3, align 8
  store i64 %80, i64* %RDI.i38, align 8
  %82 = add i64 %79, -6
  store i64 %82, i64* %RSI.i42, align 8
  %RDX.i25 = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 7, i32 0, i32 0
  %83 = load i16, i16* %AX.i51, align 2
  %84 = zext i16 %83 to i64
  %85 = mul nuw nsw i64 %84, 8000
  %86 = trunc i64 %85 to i32
  store i64 %85, i64* %RDX.i25, align 8
  ...
  store i16 %96, i16* %AX.i51, align 2
  %97 = add i64 %81, 24
  ...
  %call2_4106c5 = tail call %struct.Memory* @sub_410270._Z15tolerance_equalItEbRT_S1_(%struct.State* %0, i64 %100, %struct.Memory* %call2_4106a8)
  %AL.i16 = bitcast %union.anon* %40 to i8*
  %105 = load i8, i8* %AL.i16, align 1
  ...
  br i1 %113, label %block_.L_4106ed, label %block_4106d2

block_4106d2:                                     ; preds = %entry
  store i64 ptrtoint (%G__0x414b2e_type* @G__0x414b2e to i64), i64* %RDI.i38, align 8
  %115 = load i32, i32* bitcast (%G_0x61a0a8_type* @G_0x61a0a8 to i32*), align 8
  %116 = zext i32 %115 to i64
  store i64 %116, i64* %RSI.i42, align 8
  ...
  %122 = tail call %struct.Memory* @__remill_function_call(%struct.State* nonnull %0, i64 ptrtoint (i64 (i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64)* @printf to i64), %struct.Memory* %call2_4106c5)
  %EAX.i = bitcast %union.anon* %40 to i32*
  %123 = load i64, i64* %RBP.i, align 8
  %124 = add i64 %123, -12
  %125 = load i32, i32* %EAX.i, align 4
  ...
  br label %block_.L_4106ed

block_.L_4106ed:                                  ; preds = %block_4106d2, %entry
  %129 = phi i64 [ %114, %entry ], [ %.pre, %block_4106d2 ]
  %MEMORY.0 = phi %struct.Memory* [ %call2_4106c5, %entry ], [ %122, %block_4106d2 ]
  %130 = load i64, i64* %6, align 8
  %131 = add i64 %130, 16
  store i64 %131, i64* %6, align 8
  %132 = icmp ugt i64 %130, -17
  ...
  store i64 %157, i64* %RBP.i, align 8
...
; Function Attrs: alwaysinline nounwind
define %struct.Memory* @routine_cvttsd2si_0x2099ea__rip____esi(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned) local_unnamed_addr #3 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %RSI = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 9, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, ptrtoint (%G_0x2099ea__rip__type* @G_0x2099ea__rip_ to i64)
  %5 = add i64 %3, 8
  store i64 %5, i64* %PC, align 8
...
; Function Attrs: alwaysinline norecurse nounwind
define %struct.Memory* @routine_jne_.L_4106ed(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i8* nocapture %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
