...
block_4106c2:                                     ; preds = %entry
  ...
  %122 = tail call %struct.Memory* @__remill_function_call(%struct.State* nonnull %0, i64 ptrtoint (i64 (i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64)* @printf to i64), %struct.Memory* %call2_4106b5)
...
block_.L_4106dd:                                  ; preds = %block_4106c2, %entry
  %129 = phi i64 [ %114, %entry ], [ %.pre, %block_4106c2 ]
  %MEMORY.0 = phi %struct.Memory* [ %call2_4106b5, %entry ], [ %122, %block_4106c2 ]
