; ModuleID = '/tmp/tmpc4715u_1-query.ll'
...
entry:
  ...
  %var_2_56 = add i64 %var_2_55, ptrtoint (%G_0x2099ea__rip__type* @G_0x2099ea__rip_ to i64)
  ...
  %call2_4106a8 = tail call %struct.Memory* @sub_410650._ZN19custom_variable_andItE8do_shiftEtt(%struct.State* %0, i64 %var_2_74, %struct.Memory* %2)
  %var_2_99 = load i64, i64* %var_2_3, align 8
  %var_2_100 = add i64 %var_2_99, -1109
  %call2_4106c5 = tail call %struct.Memory* @sub_410270._Z15tolerance_equalItEbRT_S1_(%struct.State* %0, i64 %var_2_100, %struct.Memory* %call2_4106a8)
  ...
  br i1 %var_2_113, label %block_4106d2, label %block_.L_4106ed

block_4106d2:                                     ; preds = %entry
  %var_2_122 = tail call %struct.Memory* @__remill_function_call(%struct.State* nonnull %0, i64 ptrtoint (i64 (i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64)* @printf to i64), %struct.Memory* %call2_4106c5)
  br label %block_.L_4106ed

block_.L_4106ed:                                  ; preds = %block_4106d2, %entry
  %MEMORY.0 = phi %struct.Memory* [ %call2_4106c5, %entry ], [ %var_2_122, %block_4106d2 ]
