...
define %struct.Memory* @_Z26check_shifted_variable_sumIt19custom_variable_xorItEEvT_S2_(%struct.State* noalias, i64, %struct.Memory* noalias readnone) local_unnamed_addr #1 {
entry:
  ...
  %call2_410318 = tail call %struct.Memory* @sub_4102c0._ZN19custom_variable_xorItE8do_shiftEtt(%struct.State* %0, i64 %74, %struct.Memory* %2)
  ...
  %call2_410335 = tail call %struct.Memory* @sub_410260._Z15tolerance_equalItEbRT_S1_(%struct.State* %0, i64 %100, %struct.Memory* %call2_410318)
  ...
  br i1 %113, label %block_.L_41035d, label %block_410342
...
block_410342:                                     ; preds = %entry
  ...
  %call2_410355 = tail call %struct.Memory* @sub_4006c0.printf_plt(%struct.State* nonnull %0, i64 %117, %struct.Memory* %call2_410335)
...
block_.L_41035d:                                  ; preds = %block_410342, %entry
  %128 = phi i64 [ %114, %entry ], [ %.pre, %block_410342 ]
  %MEMORY.0 = phi %struct.Memory* [ %call2_410335, %entry ], [ %call2_410355, %block_410342 ]
...
; Function Attrs: nounwind
define %struct.Memory* @routine_cvttsd2si_0x209d7a__rip____esi(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned) local_unnamed_addr #3 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
