...
entry:
  ...
  %56 = add i64 %55, ptrtoint (%G_0x209d6a__rip__type* @G_0x209d6a__rip_ to i64)
  %57 = add i64 %55, 8
  ...
  %call2_410328 = tail call %struct.Memory* @sub_4102d0._ZN19custom_variable_xorItE8do_shiftEtt(%struct.State* %0, i64 %74, %struct.Memory* %2)
  ...
  %call2_410345 = tail call %struct.Memory* @sub_410270._Z15tolerance_equalItEbRT_S1_(%struct.State* %0, i64 %100, %struct.Memory* %call2_410328)
  ...
  br i1 %113, label %block_.L_41036d, label %block_410352
...
block_410352:                                     ; preds = %entry
  ...
  %122 = tail call %struct.Memory* @__remill_function_call(%struct.State* nonnull %0, i64 ptrtoint (i64 (i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64)* @printf to i64), %struct.Memory* %call2_410345)
...
block_.L_41036d:                                  ; preds = %block_410352, %entry
  %129 = phi i64 [ %114, %entry ], [ %.pre, %block_410352 ]
  %MEMORY.0 = phi %struct.Memory* [ %call2_410345, %entry ], [ %122, %block_410352 ]
