...
block_410342:                                     ; preds = %entry
  ...
  %122 = tail call %struct.Memory* @__remill_function_call(%struct.State* nonnull %0, i64 ptrtoint (i64 (i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64)* @printf to i64), %struct.Memory* %call2_410335)
...
block_.L_41035d:                                  ; preds = %block_410342, %entry
  %129 = phi i64 [ %114, %entry ], [ %.pre, %block_410342 ]
  %MEMORY.0 = phi %struct.Memory* [ %call2_410335, %entry ], [ %122, %block_410342 ]
