; ModuleID = '/tmp/tmpgosmlp5w-query.ll'
...
@G_0x209d6a__rip_ = global %G_0x209d6a__rip__type zeroinitializer
...
define %struct.Memory* @_Z26check_shifted_variable_sumIt19custom_variable_xorItEEvT_S2_(%struct.State* noalias, i64, %struct.Memory* noalias) local_unnamed_addr #1 {
entry:
  ...
  %var_2_56 = add i64 %var_2_55, ptrtoint (%G_0x209d6a__rip__type* @G_0x209d6a__rip_ to i64)
  ...
  %var_2_74 = add i64 %var_2_55, -70
  %call2_410328 = tail call %struct.Memory* @sub_4102d0._ZN19custom_variable_xorItE8do_shiftEtt(%struct.State* %0, i64 %var_2_74, %struct.Memory* %2)
  %var_2_99 = load i64, i64* %var_2_3, align 8
  %var_2_100 = add i64 %var_2_99, -213
  %call2_410345 = tail call %struct.Memory* @sub_410270._Z15tolerance_equalItEbRT_S1_(%struct.State* %0, i64 %var_2_100, %struct.Memory* %call2_410328)
  ...
  br i1 %var_2_113, label %block_410352, label %block_.L_41036d

block_410352:                                     ; preds = %entry
  %var_2_122 = tail call %struct.Memory* @__remill_function_call(%struct.State* nonnull %0, i64 ptrtoint (i64 (i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64)* @printf to i64), %struct.Memory* %call2_410345)
  br label %block_.L_41036d

block_.L_41036d:                                  ; preds = %block_410352, %entry
  %MEMORY.0 = phi %struct.Memory* [ %call2_410345, %entry ], [ %var_2_122, %block_410352 ]
...
; Function Attrs: nounwind
define %struct.Memory* @routine_cvttsd2si_0x209d6a__rip____esi(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned) local_unnamed_addr #3 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %RSI = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 9, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, ptrtoint (%G_0x209d6a__rip__type* @G_0x209d6a__rip_ to i64)
  %5 = add i64 %3, 8
  store i64 %5, i64* %PC, align 8
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_jne_.L_41036d(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i8* nocapture %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
