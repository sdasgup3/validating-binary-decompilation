...
define %struct.Memory* @_Z26check_shifted_variable_sumIt22custom_divide_variableItEEvT_S2_(%struct.State* noalias, i64, %struct.Memory* noalias readnone) local_unnamed_addr #1 {
entry:
...
block_410aa2:                                     ; preds = %entry
  ...
  %call2_410ab5 = tail call %struct.Memory* @sub_4006c0.printf_plt(%struct.State* nonnull %0, i64 %117, %struct.Memory* %call2_410a95)
...
block_.L_410abd:                                  ; preds = %block_410aa2, %entry
  %128 = phi i64 [ %114, %entry ], [ %.pre, %block_410aa2 ]
  %MEMORY.0 = phi %struct.Memory* [ %call2_410a95, %entry ], [ %call2_410ab5, %block_410aa2 ]
