...
define %struct.Memory* @_Z26check_shifted_variable_sumIt24custom_multiply_variableItEEvT_S2_(%struct.State* noalias, i64, %struct.Memory* noalias readnone) local_unnamed_addr #1 {
entry:
...
block_410d72:                                     ; preds = %entry
  ...
  %call2_410d85 = tail call %struct.Memory* @sub_4006c0.printf_plt(%struct.State* nonnull %0, i64 %117, %struct.Memory* %call2_410d65)
...
block_.L_410d8d:                                  ; preds = %block_410d72, %entry
  %128 = phi i64 [ %114, %entry ], [ %.pre, %block_410d72 ]
  %MEMORY.0 = phi %struct.Memory* [ %call2_410d65, %entry ], [ %call2_410d85, %block_410d72 ]
