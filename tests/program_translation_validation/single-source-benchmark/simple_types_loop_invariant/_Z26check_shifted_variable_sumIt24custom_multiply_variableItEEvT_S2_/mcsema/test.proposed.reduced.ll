; ModuleID = '/tmp/tmp1tsdgtw2-query.ll'
...
entry:
  ...
  %var_2_56 = add i64 %var_2_55, ptrtoint (%G_0x20933a__rip__type* @G_0x20933a__rip_ to i64)
  ...
  %call2_410d58 = tail call %struct.Memory* @sub_410d00._ZN24custom_multiply_variableItE8do_shiftEtt(%struct.State* %0, i64 %var_2_74, %struct.Memory* %2)
  %var_2_99 = load i64, i64* %var_2_3, align 8
  %var_2_100 = add i64 %var_2_99, -2821
  %call2_410d75 = tail call %struct.Memory* @sub_410270._Z15tolerance_equalItEbRT_S1_(%struct.State* %0, i64 %var_2_100, %struct.Memory* %call2_410d58)
  ...
  br i1 %var_2_113, label %block_410d82, label %block_.L_410d9d

block_410d82:                                     ; preds = %entry
  %var_2_122 = tail call %struct.Memory* @__remill_function_call(%struct.State* nonnull %0, i64 ptrtoint (i64 (i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64)* @printf to i64), %struct.Memory* %call2_410d75)
  br label %block_.L_410d9d

block_.L_410d9d:                                  ; preds = %block_410d82, %entry
  %MEMORY.0 = phi %struct.Memory* [ %call2_410d75, %entry ], [ %var_2_122, %block_410d82 ]
