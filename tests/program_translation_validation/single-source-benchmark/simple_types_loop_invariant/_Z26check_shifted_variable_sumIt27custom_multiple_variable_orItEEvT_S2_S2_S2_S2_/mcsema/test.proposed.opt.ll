...
define %struct.Memory* @_Z26check_shifted_variable_sumIt27custom_multiple_variable_orItEEvT_S2_S2_S2_S2_(%struct.State* noalias, i64, %struct.Memory* noalias readnone) local_unnamed_addr #1 {
entry:
...
block_41045b:                                     ; preds = %entry
  ...
  %call2_41046e = tail call %struct.Memory* @sub_4006c0.printf_plt(%struct.State* nonnull %0, i64 %166, %struct.Memory* %call2_41044e)
...
block_.L_410476:                                  ; preds = %block_41045b, %entry
  %177 = phi i64 [ %163, %entry ], [ %.pre, %block_41045b ]
  %MEMORY.0 = phi %struct.Memory* [ %call2_41044e, %entry ], [ %call2_41046e, %block_41045b ]
