...
@G_0x209c6d__rip_ = global %G_0x209c6d__rip__type zeroinitializer
...
entry:
  ...
  %89 = add i64 %88, ptrtoint (%G_0x209c6d__rip__type* @G_0x209c6d__rip_ to i64)
  %90 = add i64 %88, 8
  ...
  %call2_410441 = tail call %struct.Memory* @sub_410380._ZN27custom_multiple_variable_orItE8do_shiftEttttt(%struct.State* %0, i64 %123, %struct.Memory* %2)
  ...
  %call2_41045e = tail call %struct.Memory* @sub_410270._Z15tolerance_equalItEbRT_S1_(%struct.State* %0, i64 %149, %struct.Memory* %call2_410441)
  ...
  br i1 %162, label %block_.L_410486, label %block_41046b

block_41046b:                                     ; preds = %entry
  ...
  %171 = tail call %struct.Memory* @__remill_function_call(%struct.State* nonnull %0, i64 ptrtoint (i64 (i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64)* @printf to i64), %struct.Memory* %call2_41045e)
...
block_.L_410486:                                  ; preds = %block_41046b, %entry
  %178 = phi i64 [ %163, %entry ], [ %.pre, %block_41046b ]
  %MEMORY.0 = phi %struct.Memory* [ %call2_41045e, %entry ], [ %171, %block_41046b ]
...
; Function Attrs: alwaysinline nounwind
define %struct.Memory* @routine_cvttsd2si_0x209c6d__rip____ecx(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned) local_unnamed_addr #3 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %RCX = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 5, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, ptrtoint (%G_0x209c6d__rip__type* @G_0x209c6d__rip_ to i64)
  %5 = add i64 %3, 8
  store i64 %5, i64* %PC, align 8
...
; Function Attrs: alwaysinline norecurse nounwind
define %struct.Memory* @routine_jne_.L_410486(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i8* nocapture %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
