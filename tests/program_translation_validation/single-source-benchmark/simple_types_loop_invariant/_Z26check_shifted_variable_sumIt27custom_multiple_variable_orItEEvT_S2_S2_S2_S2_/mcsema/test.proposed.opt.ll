...
@G_0x209cad__rip__4260827_ = local_unnamed_addr global %G_0x209cad__rip__4260827__type zeroinitializer
...
define %struct.Memory* @_Z26check_shifted_variable_sumIt27custom_multiple_variable_orItEEvT_S2_S2_S2_S2_(%struct.State* noalias, i64, %struct.Memory* noalias) local_unnamed_addr #1 {
entry:
  ...
  %89 = load double, double* bitcast (%G_0x209cad__rip__4260827__type* @G_0x209cad__rip__4260827_ to double*), align 8
  ...
  %call2_410401 = tail call %struct.Memory* @sub_410340._ZN27custom_multiple_variable_orItE8do_shiftEttttt(%struct.State* %0, i64 %120, %struct.Memory* %2)
  ...
  %call2_41041e = tail call %struct.Memory* @sub_410230._Z15tolerance_equalItEbRT_S1_(%struct.State* %0, i64 %146, %struct.Memory* %call2_410401)
  ...
  br i1 %159, label %block_.L_410446, label %block_41042b

block_41042b:                                     ; preds = %entry
  ...
  %168 = tail call %struct.Memory* @__remill_function_call(%struct.State* %0, i64 ptrtoint (i64 (i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64)* @printf to i64), %struct.Memory* %call2_41041e)
...
block_.L_410446:                                  ; preds = %block_41042b, %entry
  %175 = phi i64 [ %160, %entry ], [ %.pre, %block_41042b ]
  %MEMORY.0 = phi %struct.Memory* [ %call2_41041e, %entry ], [ %168, %block_41042b ]
...
define %struct.Memory* @routine_cvttsd2si_0x209cad__rip____ecx(%struct.State* dereferenceable(3376), i64, %struct.Memory*) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  ...
  %5 = load double, double* bitcast (%G_0x209cad__rip__4260827__type* @G_0x209cad__rip__4260827_ to double*), align 8
...
define %struct.Memory* @routine_jne_.L_410446(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i8* %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
