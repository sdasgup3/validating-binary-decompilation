...
entry:
  ...
  %call2_410431 = tail call %struct.Memory* @sub_410370._ZN27custom_multiple_variable_orItE8do_shiftEttttt(%struct.State* %0, i64 %123, %struct.Memory* %2)
  ...
  %call2_41044e = tail call %struct.Memory* @sub_410260._Z15tolerance_equalItEbRT_S1_(%struct.State* %0, i64 %149, %struct.Memory* %call2_410431)
  ...
  br i1 %162, label %block_.L_410476, label %block_41045b

block_41045b:                                     ; preds = %entry
  ...
  %171 = tail call %struct.Memory* @__remill_function_call(%struct.State* nonnull %0, i64 ptrtoint (i64 (i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64)* @printf to i64), %struct.Memory* %call2_41044e)
...
block_.L_410476:                                  ; preds = %block_41045b, %entry
  %178 = phi i64 [ %163, %entry ], [ %.pre, %block_41045b ]
  %MEMORY.0 = phi %struct.Memory* [ %call2_41044e, %entry ], [ %171, %block_41045b ]
...
; Function Attrs: nounwind
define %struct.Memory* @routine_cvttsd2si_0x209c7d__rip____ecx(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned) local_unnamed_addr #3 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_jne_.L_410476(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i8* nocapture %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
