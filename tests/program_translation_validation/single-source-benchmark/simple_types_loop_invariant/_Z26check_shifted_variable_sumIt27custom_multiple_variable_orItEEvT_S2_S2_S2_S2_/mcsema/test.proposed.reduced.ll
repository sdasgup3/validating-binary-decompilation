; ModuleID = '/tmp/tmp_mcowssk-query.ll'
...
entry:
  ...
  %var_2_89 = add i64 %var_2_88, ptrtoint (%G_0x209c6d__rip__type* @G_0x209c6d__rip_ to i64)
  ...
  %call2_410441 = tail call %struct.Memory* @sub_410380._ZN27custom_multiple_variable_orItE8do_shiftEttttt(%struct.State* %0, i64 %var_2_123, %struct.Memory* %2)
  %var_2_148 = load i64, i64* %var_2_3, align 8
  %var_2_149 = add i64 %var_2_148, -494
  %call2_41045e = tail call %struct.Memory* @sub_410270._Z15tolerance_equalItEbRT_S1_(%struct.State* %0, i64 %var_2_149, %struct.Memory* %call2_410441)
  ...
  br i1 %var_2_162, label %block_41046b, label %block_.L_410486

block_41046b:                                     ; preds = %entry
  %var_2_171 = tail call %struct.Memory* @__remill_function_call(%struct.State* nonnull %0, i64 ptrtoint (i64 (i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64)* @printf to i64), %struct.Memory* %call2_41045e)
  br label %block_.L_410486

block_.L_410486:                                  ; preds = %block_41046b, %entry
  %MEMORY.0 = phi %struct.Memory* [ %call2_41045e, %entry ], [ %var_2_171, %block_41046b ]
