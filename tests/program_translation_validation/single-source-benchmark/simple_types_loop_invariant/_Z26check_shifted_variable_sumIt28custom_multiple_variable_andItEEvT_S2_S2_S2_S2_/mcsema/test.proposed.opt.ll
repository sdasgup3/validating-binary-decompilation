...
block_41061b:                                     ; preds = %entry
  ...
  %171 = tail call %struct.Memory* @__remill_function_call(%struct.State* nonnull %0, i64 ptrtoint (i64 (i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64)* @printf to i64), %struct.Memory* %call2_41060e)
...
block_.L_410636:                                  ; preds = %block_41061b, %entry
  %178 = phi i64 [ %163, %entry ], [ %.pre, %block_41061b ]
  %MEMORY.0 = phi %struct.Memory* [ %call2_41060e, %entry ], [ %171, %block_41061b ]
