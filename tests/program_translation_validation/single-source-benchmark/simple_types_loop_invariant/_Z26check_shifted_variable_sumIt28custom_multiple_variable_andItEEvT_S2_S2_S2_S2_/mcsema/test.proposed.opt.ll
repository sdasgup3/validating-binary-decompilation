...
@G_0x209aed__rip_ = local_unnamed_addr global %G_0x209aed__rip__type zeroinitializer
...
declare %struct.Memory* @sub_410500._ZN28custom_multiple_variable_andItE8do_shiftEttttt(%struct.State* noalias dereferenceable(3376), i64, %struct.Memory* noalias readnone returned) local_unnamed_addr
...
entry:
  ...
  %89 = load double, double* bitcast (%G_0x209aed__rip__type* @G_0x209aed__rip_ to double*), align 8
  ...
  %call2_4105c1 = tail call %struct.Memory* @sub_410500._ZN28custom_multiple_variable_andItE8do_shiftEttttt(%struct.State* %0, i64 %120, %struct.Memory* %2)
  ...
  %call2_4105de = tail call %struct.Memory* @sub_410230._Z15tolerance_equalItEbRT_S1_(%struct.State* %0, i64 %146, %struct.Memory* %call2_4105c1)
  ...
  br i1 %159, label %block_.L_410606, label %block_4105eb

block_4105eb:                                     ; preds = %entry
  ...
  %168 = tail call %struct.Memory* @__remill_function_call(%struct.State* %0, i64 ptrtoint (i64 (i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64)* @printf to i64), %struct.Memory* %call2_4105de)
...
block_.L_410606:                                  ; preds = %block_4105eb, %entry
  %175 = phi i64 [ %160, %entry ], [ %.pre, %block_4105eb ]
  %MEMORY.0 = phi %struct.Memory* [ %call2_4105de, %entry ], [ %168, %block_4105eb ]
...
define %struct.Memory* @routine_cvttsd2si_0x209aed__rip____ecx(%struct.State* dereferenceable(3376), i64, %struct.Memory*) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  ...
  %5 = load double, double* bitcast (%G_0x209aed__rip__type* @G_0x209aed__rip_ to double*), align 8
...
define %struct.Memory* @routine_callq_._ZN28custom_multiple_variable_andItE8do_shiftEttttt(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
...
define %struct.Memory* @routine_jne_.L_410606(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i8* %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
