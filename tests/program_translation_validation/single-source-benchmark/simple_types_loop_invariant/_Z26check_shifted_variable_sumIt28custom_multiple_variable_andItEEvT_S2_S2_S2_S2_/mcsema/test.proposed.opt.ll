...
declare %struct.Memory* @sub_410530._ZN28custom_multiple_variable_andItE8do_shiftEttttt(%struct.State* noalias dereferenceable(3376), i64, %struct.Memory* noalias readnone returned) local_unnamed_addr
...
define %struct.Memory* @_Z26check_shifted_variable_sumIt28custom_multiple_variable_andItEEvT_S2_S2_S2_S2_(%struct.State* noalias, i64, %struct.Memory* noalias readnone) local_unnamed_addr #1 {
entry:
  ...
  %call2_4105f1 = tail call %struct.Memory* @sub_410530._ZN28custom_multiple_variable_andItE8do_shiftEttttt(%struct.State* %0, i64 %123, %struct.Memory* %2)
  ...
  %call2_41060e = tail call %struct.Memory* @sub_410260._Z15tolerance_equalItEbRT_S1_(%struct.State* %0, i64 %149, %struct.Memory* %call2_4105f1)
  ...
  br i1 %162, label %block_.L_410636, label %block_41061b

block_41061b:                                     ; preds = %entry
  ...
  %call2_41062e = tail call %struct.Memory* @sub_4006c0.printf_plt(%struct.State* nonnull %0, i64 %166, %struct.Memory* %call2_41060e)
...
block_.L_410636:                                  ; preds = %block_41061b, %entry
  %177 = phi i64 [ %163, %entry ], [ %.pre, %block_41061b ]
  %MEMORY.0 = phi %struct.Memory* [ %call2_41060e, %entry ], [ %call2_41062e, %block_41061b ]
...
; Function Attrs: nounwind
define %struct.Memory* @routine_cvttsd2si_0x209abd__rip____ecx(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned) local_unnamed_addr #3 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_jne_.L_410636(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i8* nocapture %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
