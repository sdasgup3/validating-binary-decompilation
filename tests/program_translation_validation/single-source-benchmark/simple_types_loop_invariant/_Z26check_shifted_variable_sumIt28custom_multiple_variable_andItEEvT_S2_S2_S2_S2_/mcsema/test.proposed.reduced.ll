; ModuleID = '/tmp/tmpxxr5astv-query.ll'
...
entry:
  ...
  %var_2_89 = add i64 %var_2_88, ptrtoint (%G_0x209aad__rip__type* @G_0x209aad__rip_ to i64)
  ...
  %call2_410601 = tail call %struct.Memory* @sub_410540._ZN28custom_multiple_variable_andItE8do_shiftEttttt(%struct.State* %0, i64 %var_2_123, %struct.Memory* %2)
  %var_2_148 = load i64, i64* %var_2_3, align 8
  %var_2_149 = add i64 %var_2_148, -942
  %call2_41061e = tail call %struct.Memory* @sub_410270._Z15tolerance_equalItEbRT_S1_(%struct.State* %0, i64 %var_2_149, %struct.Memory* %call2_410601)
  ...
  br i1 %var_2_162, label %block_41062b, label %block_.L_410646

block_41062b:                                     ; preds = %entry
  %var_2_171 = tail call %struct.Memory* @__remill_function_call(%struct.State* nonnull %0, i64 ptrtoint (i64 (i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64)* @printf to i64), %struct.Memory* %call2_41061e)
  br label %block_.L_410646

block_.L_410646:                                  ; preds = %block_41062b, %entry
  %MEMORY.0 = phi %struct.Memory* [ %call2_41061e, %entry ], [ %var_2_171, %block_41062b ]
