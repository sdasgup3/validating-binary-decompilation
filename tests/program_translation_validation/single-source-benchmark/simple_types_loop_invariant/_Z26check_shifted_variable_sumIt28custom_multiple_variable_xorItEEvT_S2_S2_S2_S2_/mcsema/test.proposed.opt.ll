...
declare %struct.Memory* @sub_410150._ZN28custom_multiple_variable_xorItE8do_shiftEttttt(%struct.State* dereferenceable(3376), i64, %struct.Memory*) local_unnamed_addr
