...
entry:
  ...
  %89 = add i64 %88, ptrtoint (%G_0x209e8d__rip__type* @G_0x209e8d__rip_ to i64)
  %90 = add i64 %88, 8
  ...
  %call2_410221 = tail call %struct.Memory* @sub_410160._ZN28custom_multiple_variable_xorItE8do_shiftEttttt(%struct.State* %0, i64 %123, %struct.Memory* %2)
  ...
  %call2_41023e = tail call %struct.Memory* @sub_410270._Z15tolerance_equalItEbRT_S1_(%struct.State* %0, i64 %149, %struct.Memory* %call2_410221)
  ...
  br i1 %162, label %block_.L_410266, label %block_41024b
...
block_41024b:                                     ; preds = %entry
  ...
  %171 = tail call %struct.Memory* @__remill_function_call(%struct.State* nonnull %0, i64 ptrtoint (i64 (i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64)* @printf to i64), %struct.Memory* %call2_41023e)
...
block_.L_410266:                                  ; preds = %block_41024b, %entry
  %178 = phi i64 [ %163, %entry ], [ %.pre, %block_41024b ]
  %MEMORY.0 = phi %struct.Memory* [ %call2_41023e, %entry ], [ %171, %block_41024b ]
