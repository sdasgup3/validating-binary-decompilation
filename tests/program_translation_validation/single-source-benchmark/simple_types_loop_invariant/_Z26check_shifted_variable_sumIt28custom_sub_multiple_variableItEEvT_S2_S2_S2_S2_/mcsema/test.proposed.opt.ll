...
entry:
  ...
  %89 = add i64 %88, ptrtoint (%G_0x20923d__rip__type* @G_0x20923d__rip_ to i64)
  %90 = add i64 %88, 8
  ...
  %call2_410e71 = tail call %struct.Memory* @sub_410db0._ZN28custom_sub_multiple_variableItE8do_shiftEttttt(%struct.State* %0, i64 %123, %struct.Memory* %2)
  ...
  %call2_410e8e = tail call %struct.Memory* @sub_410270._Z15tolerance_equalItEbRT_S1_(%struct.State* %0, i64 %149, %struct.Memory* %call2_410e71)
  ...
  br i1 %162, label %block_.L_410eb6, label %block_410e9b
...
block_410e9b:                                     ; preds = %entry
  ...
  %171 = tail call %struct.Memory* @__remill_function_call(%struct.State* nonnull %0, i64 ptrtoint (i64 (i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64)* @printf to i64), %struct.Memory* %call2_410e8e)
...
block_.L_410eb6:                                  ; preds = %block_410e9b, %entry
  %178 = phi i64 [ %163, %entry ], [ %.pre, %block_410e9b ]
  %MEMORY.0 = phi %struct.Memory* [ %call2_410e8e, %entry ], [ %171, %block_410e9b ]
