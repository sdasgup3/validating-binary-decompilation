...
block_410e8b:                                     ; preds = %entry
  ...
  %171 = tail call %struct.Memory* @__remill_function_call(%struct.State* nonnull %0, i64 ptrtoint (i64 (i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64)* @printf to i64), %struct.Memory* %call2_410e7e)
...
block_.L_410ea6:                                  ; preds = %block_410e8b, %entry
  %178 = phi i64 [ %163, %entry ], [ %.pre, %block_410e8b ]
  %MEMORY.0 = phi %struct.Memory* [ %call2_410e7e, %entry ], [ %171, %block_410e8b ]
