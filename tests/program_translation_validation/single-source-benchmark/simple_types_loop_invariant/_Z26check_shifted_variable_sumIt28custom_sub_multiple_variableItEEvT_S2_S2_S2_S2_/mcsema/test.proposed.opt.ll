...
@G_0x20927d__rip__4263435_ = local_unnamed_addr global %G_0x20927d__rip__4263435__type zeroinitializer
...
declare %struct.Memory* @sub_410d70._ZN28custom_sub_multiple_variableItE8do_shiftEttttt(%struct.State* noalias dereferenceable(3376), i64, %struct.Memory* noalias readnone returned) local_unnamed_addr
...
entry:
  ...
  %89 = load double, double* bitcast (%G_0x20927d__rip__4263435__type* @G_0x20927d__rip__4263435_ to double*), align 8
  ...
  %call2_410e31 = tail call %struct.Memory* @sub_410d70._ZN28custom_sub_multiple_variableItE8do_shiftEttttt(%struct.State* %0, i64 %120, %struct.Memory* %2)
  ...
  %call2_410e4e = tail call %struct.Memory* @sub_410230._Z15tolerance_equalItEbRT_S1_(%struct.State* %0, i64 %146, %struct.Memory* %call2_410e31)
  ...
  br i1 %159, label %block_.L_410e76, label %block_410e5b
...
block_410e5b:                                     ; preds = %entry
  ...
  %168 = tail call %struct.Memory* @__remill_function_call(%struct.State* %0, i64 ptrtoint (i64 (i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64)* @printf to i64), %struct.Memory* %call2_410e4e)
...
block_.L_410e76:                                  ; preds = %block_410e5b, %entry
  %175 = phi i64 [ %160, %entry ], [ %.pre, %block_410e5b ]
  %MEMORY.0 = phi %struct.Memory* [ %call2_410e4e, %entry ], [ %168, %block_410e5b ]
...
define %struct.Memory* @routine_cvttsd2si_0x20927d__rip____ecx(%struct.State* dereferenceable(3376), i64, %struct.Memory*) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  ...
  %5 = load double, double* bitcast (%G_0x20927d__rip__4263435__type* @G_0x20927d__rip__4263435_ to double*), align 8
...
define %struct.Memory* @routine_callq_._ZN28custom_sub_multiple_variableItE8do_shiftEttttt(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
...
define %struct.Memory* @routine_jne_.L_410e76(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i8* %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
