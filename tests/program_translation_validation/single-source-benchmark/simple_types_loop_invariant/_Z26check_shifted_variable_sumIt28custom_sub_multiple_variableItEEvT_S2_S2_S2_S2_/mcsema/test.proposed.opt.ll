...
declare %struct.Memory* @sub_410da0._ZN28custom_sub_multiple_variableItE8do_shiftEttttt(%struct.State* dereferenceable(3376), i64, %struct.Memory*) local_unnamed_addr
