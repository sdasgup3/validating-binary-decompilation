; ModuleID = '/tmp/tmp3uqoq86t-query.ll'
...
@G_0x20923d__rip_ = global %G_0x20923d__rip__type zeroinitializer
...
declare %struct.Memory* @sub_410db0._ZN28custom_sub_multiple_variableItE8do_shiftEttttt(%struct.State* noalias dereferenceable(3376), i64, %struct.Memory* noalias readnone returned) local_unnamed_addr
...
define %struct.Memory* @_Z26check_shifted_variable_sumIt28custom_sub_multiple_variableItEEvT_S2_S2_S2_S2_(%struct.State* noalias, i64, %struct.Memory* noalias) local_unnamed_addr #1 {
entry:
  ...
  %var_2_89 = add i64 %var_2_88, ptrtoint (%G_0x20923d__rip__type* @G_0x20923d__rip_ to i64)
  ...
  %call2_410e71 = tail call %struct.Memory* @sub_410db0._ZN28custom_sub_multiple_variableItE8do_shiftEttttt(%struct.State* %0, i64 %var_2_123, %struct.Memory* %2)
  %var_2_148 = load i64, i64* %var_2_3, align 8
  %var_2_149 = add i64 %var_2_148, -3102
  %call2_410e8e = tail call %struct.Memory* @sub_410270._Z15tolerance_equalItEbRT_S1_(%struct.State* %0, i64 %var_2_149, %struct.Memory* %call2_410e71)
  ...
  br i1 %var_2_162, label %block_410e9b, label %block_.L_410eb6

block_410e9b:                                     ; preds = %entry
  %var_2_171 = tail call %struct.Memory* @__remill_function_call(%struct.State* nonnull %0, i64 ptrtoint (i64 (i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64)* @printf to i64), %struct.Memory* %call2_410e8e)
  br label %block_.L_410eb6

block_.L_410eb6:                                  ; preds = %block_410e9b, %entry
  %MEMORY.0 = phi %struct.Memory* [ %call2_410e8e, %entry ], [ %var_2_171, %block_410e9b ]
...
; Function Attrs: nounwind
define %struct.Memory* @routine_cvttsd2si_0x20923d__rip____ecx(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned) local_unnamed_addr #3 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %RCX = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 5, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, ptrtoint (%G_0x20923d__rip__type* @G_0x20923d__rip_ to i64)
  %5 = add i64 %3, 8
  store i64 %5, i64* %PC, align 8
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_jne_.L_410eb6(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i8* nocapture %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
