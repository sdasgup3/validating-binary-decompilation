...
block_4107db:                                     ; preds = %entry
  ...
  %call2_4107ee = call %struct.Memory* @sub_4006c0.printf_plt(%struct.State* %0, i64 %loadPC_4107ee, %struct.Memory* %loadMem2_4107ee)
  store %struct.Memory* %call2_4107ee, %struct.Memory** %MEMORY
