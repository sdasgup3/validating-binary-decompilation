...
define %struct.Memory* @_Z26check_shifted_variable_sumIt30custom_mixed_multiple_variableItEEvT_S2_S2_S2_S2_(%struct.State* noalias, i64, %struct.Memory* noalias readnone) local_unnamed_addr #1 {
entry:
  ...
  %call2_4107b1 = tail call %struct.Memory* @sub_4106f0._ZN30custom_mixed_multiple_variableItE8do_shiftEttttt(%struct.State* %0, i64 %123, %struct.Memory* %2)
  ...
  %call2_4107ce = tail call %struct.Memory* @sub_410260._Z15tolerance_equalItEbRT_S1_(%struct.State* %0, i64 %149, %struct.Memory* %call2_4107b1)
  ...
  br i1 %162, label %block_.L_4107f6, label %block_4107db

block_4107db:                                     ; preds = %entry
  ...
  %call2_4107ee = tail call %struct.Memory* @sub_4006c0.printf_plt(%struct.State* nonnull %0, i64 %166, %struct.Memory* %call2_4107ce)
  ...
  br label %block_.L_4107f6

block_.L_4107f6:                                  ; preds = %block_4107db, %entry
  %177 = phi i64 [ %163, %entry ], [ %.pre, %block_4107db ]
  %MEMORY.0 = phi %struct.Memory* [ %call2_4107ce, %entry ], [ %call2_4107ee, %block_4107db ]
...
; Function Attrs: nounwind
define %struct.Memory* @routine_cvttsd2si_0x2098fd__rip____ecx(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned) local_unnamed_addr #3 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_jne_.L_4107f6(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i8* nocapture %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
