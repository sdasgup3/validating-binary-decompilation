...
entry:
  ...
  %89 = add i64 %88, ptrtoint (%G_0x2098ed__rip__type* @G_0x2098ed__rip_ to i64)
  %90 = add i64 %88, 8
  ...
  %call2_4107c1 = tail call %struct.Memory* @sub_410700._ZN30custom_mixed_multiple_variableItE8do_shiftEttttt(%struct.State* %0, i64 %123, %struct.Memory* %2)
  ...
  %call2_4107de = tail call %struct.Memory* @sub_410270._Z15tolerance_equalItEbRT_S1_(%struct.State* %0, i64 %149, %struct.Memory* %call2_4107c1)
  ...
  br i1 %162, label %block_.L_410806, label %block_4107eb
...
block_4107eb:                                     ; preds = %entry
  ...
  %171 = tail call %struct.Memory* @__remill_function_call(%struct.State* nonnull %0, i64 ptrtoint (i64 (i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64)* @printf to i64), %struct.Memory* %call2_4107de)
...
block_.L_410806:                                  ; preds = %block_4107eb, %entry
  %178 = phi i64 [ %163, %entry ], [ %.pre, %block_4107eb ]
  %MEMORY.0 = phi %struct.Memory* [ %call2_4107de, %entry ], [ %171, %block_4107eb ]
