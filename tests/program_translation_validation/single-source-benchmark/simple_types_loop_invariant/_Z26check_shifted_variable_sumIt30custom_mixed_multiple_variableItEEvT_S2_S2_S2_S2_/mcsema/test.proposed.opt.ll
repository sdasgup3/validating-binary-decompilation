...
%G_0x20992d__rip__4261723__type = type <{ [4 x i8] }>
...
@G_0x20992d__rip__4261723_ = local_unnamed_addr global %G_0x20992d__rip__4261723__type zeroinitializer
...
entry:
  ...
  %89 = load double, double* bitcast (%G_0x20992d__rip__4261723__type* @G_0x20992d__rip__4261723_ to double*), align 8
  ...
  %call2_410781 = tail call %struct.Memory* @sub_4106c0._ZN30custom_mixed_multiple_variableItE8do_shiftEttttt(%struct.State* %0, i64 %120, %struct.Memory* %2)
  ...
  %call2_41079e = tail call %struct.Memory* @sub_410230._Z15tolerance_equalItEbRT_S1_(%struct.State* %0, i64 %146, %struct.Memory* %call2_410781)
  ...
  br i1 %159, label %block_.L_4107c6, label %block_4107ab

block_4107ab:                                     ; preds = %entry
  ...
  %168 = tail call %struct.Memory* @__remill_function_call(%struct.State* %0, i64 ptrtoint (i64 (i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64)* @printf to i64), %struct.Memory* %call2_41079e)
  ...
  br label %block_.L_4107c6

block_.L_4107c6:                                  ; preds = %block_4107ab, %entry
  %175 = phi i64 [ %160, %entry ], [ %.pre, %block_4107ab ]
  %MEMORY.0 = phi %struct.Memory* [ %call2_41079e, %entry ], [ %168, %block_4107ab ]
...
define %struct.Memory* @routine_cvttsd2si_0x20992d__rip____ecx(%struct.State* dereferenceable(3376), i64, %struct.Memory*) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  ...
  %5 = load double, double* bitcast (%G_0x20992d__rip__4261723__type* @G_0x20992d__rip__4261723_ to double*), align 8
...
define %struct.Memory* @routine_jne_.L_4107c6(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i8* %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
