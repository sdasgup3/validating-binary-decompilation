...
block_4107db:                                     ; preds = %entry
  ...
  %171 = tail call %struct.Memory* @__remill_function_call(%struct.State* nonnull %0, i64 ptrtoint (i64 (i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64)* @printf to i64), %struct.Memory* %call2_4107ce)
...
block_.L_4107f6:                                  ; preds = %block_4107db, %entry
  %178 = phi i64 [ %163, %entry ], [ %.pre, %block_4107db ]
  %MEMORY.0 = phi %struct.Memory* [ %call2_4107ce, %entry ], [ %171, %block_4107db ]
