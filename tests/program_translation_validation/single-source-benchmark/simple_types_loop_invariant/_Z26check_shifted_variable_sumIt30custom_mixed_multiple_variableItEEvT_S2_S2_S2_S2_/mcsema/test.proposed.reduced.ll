; ModuleID = '/tmp/tmpoojy_ivn-query.ll'
source_filename = "llvm-link"
target datalayout = "e-m:e-i64:64-f80:128-n8:16:32:64-S128"
target triple = "x86_64-pc-linux-gnu-elf"

%__bss_start_type = type <{ [8 x i8] }>
%G_0x2098ed__rip__type = type <{ [8 x i8] }>
...
@G_0x2098ed__rip_ = global %G_0x2098ed__rip__type zeroinitializer
...
declare %struct.Memory* @sub_410700._ZN30custom_mixed_multiple_variableItE8do_shiftEttttt(%struct.State* noalias dereferenceable(3376), i64, %struct.Memory* noalias readnone returned) local_unnamed_addr
...
define %struct.Memory* @_Z26check_shifted_variable_sumIt30custom_mixed_multiple_variableItEEvT_S2_S2_S2_S2_(%struct.State* noalias, i64, %struct.Memory* noalias) local_unnamed_addr #1 {
entry:
  %var_2_3 = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %var_2_46 = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 1, i32 0
  %AX.i82 = bitcast %union.anon* %var_2_46 to i16*
  ...
  %var_2_89 = add i64 %var_2_88, ptrtoint (%G_0x2098ed__rip__type* @G_0x2098ed__rip_ to i64)
  %var_2_90 = add i64 %var_2_88, 8
  store i64 %var_2_90, i64* %var_2_3, align 8
  %var_2_91 = inttoptr i64 %var_2_89 to double*
  %var_2_92 = load double, double* %var_2_91, align 8
  %var_2_93 = tail call double @llvm.trunc.f64(double %var_2_92)
  %var_2_94 = tail call double @llvm.fabs.f64(double %var_2_93)
  %var_2_95 = fcmp ogt double %var_2_94, 0x41DFFFFFFFC00000
  %var_2_96 = fptosi double %var_2_93 to i32
  %var_2_97 = zext i32 %var_2_96 to i64
  %var_2_98 = select i1 %var_2_95, i64 2147483648, i64 %var_2_97
  store i64 %var_2_98, i64* %RCX.i57, align 8
  %var_2_99 = trunc i64 %var_2_98 to i16
  store i16 %var_2_99, i16* %AX.i82, align 2
  %RDI.i43 = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 11, i32 0, i32 0
  %var_2_113 = and i64 %var_2_98, 65535
  store i64 %var_2_113, i64* %RDI.i43, align 8
  %var_2_123 = add i64 %var_2_88, -147
  %call2_4107c1 = tail call %struct.Memory* @sub_410700._ZN30custom_mixed_multiple_variableItE8do_shiftEttttt(%struct.State* %0, i64 %var_2_123, %struct.Memory* %2)
  %var_2_148 = load i64, i64* %var_2_3, align 8
  %var_2_149 = add i64 %var_2_148, -1390
  %call2_4107de = tail call %struct.Memory* @sub_410270._Z15tolerance_equalItEbRT_S1_(%struct.State* %0, i64 %var_2_149, %struct.Memory* %call2_4107c1)
  %AL.i17 = bitcast %union.anon* %var_2_46 to i8*
  %var_2_154 = load i8, i8* %AL.i17, align 1
  %var_2_156 = and i8 %var_2_154, 1
  %var_2_162 = icmp eq i8 %var_2_156, 0
  br i1 %var_2_162, label %block_4107eb, label %block_.L_410806

block_4107eb:                                     ; preds = %entry
  %var_2_171 = tail call %struct.Memory* @__remill_function_call(%struct.State* nonnull %0, i64 ptrtoint (i64 (i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64)* @printf to i64), %struct.Memory* %call2_4107de)
  br label %block_.L_410806

block_.L_410806:                                  ; preds = %block_4107eb, %entry
  %MEMORY.0 = phi %struct.Memory* [ %call2_4107de, %entry ], [ %var_2_171, %block_4107eb ]
...
; Function Attrs: nounwind
define %struct.Memory* @routine_cvttsd2si_0x2098ed__rip____ecx(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned) local_unnamed_addr #3 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %RCX = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 5, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, ptrtoint (%G_0x2098ed__rip__type* @G_0x2098ed__rip_ to i64)
  %5 = add i64 %3, 8
  store i64 %5, i64* %PC, align 8
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_callq_._ZN30custom_mixed_multiple_variableItE8do_shiftEttttt(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_jne_.L_410806(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i8* nocapture %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
