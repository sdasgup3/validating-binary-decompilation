...
entry:
  ...
  %89 = add i64 %88, ptrtoint (%G_0x2096cd__rip__type* @G_0x2096cd__rip_ to i64)
  %90 = add i64 %88, 8
  ...
  %call2_4109e1 = tail call %struct.Memory* @sub_410920._ZN31custom_divide_multiple_variableItE8do_shiftEttttt(%struct.State* %0, i64 %123, %struct.Memory* %2)
  ...
  %call2_4109fe = tail call %struct.Memory* @sub_410270._Z15tolerance_equalItEbRT_S1_(%struct.State* %0, i64 %149, %struct.Memory* %call2_4109e1)
  ...
  br i1 %162, label %block_.L_410a26, label %block_410a0b
...
block_410a0b:                                     ; preds = %entry
  ...
  %171 = tail call %struct.Memory* @__remill_function_call(%struct.State* nonnull %0, i64 ptrtoint (i64 (i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64)* @printf to i64), %struct.Memory* %call2_4109fe)
...
block_.L_410a26:                                  ; preds = %block_410a0b, %entry
  %178 = phi i64 [ %163, %entry ], [ %.pre, %block_410a0b ]
  %MEMORY.0 = phi %struct.Memory* [ %call2_4109fe, %entry ], [ %171, %block_410a0b ]
