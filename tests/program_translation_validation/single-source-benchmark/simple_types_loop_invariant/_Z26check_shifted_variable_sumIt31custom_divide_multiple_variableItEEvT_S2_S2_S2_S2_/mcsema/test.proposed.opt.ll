...
define %struct.Memory* @_Z26check_shifted_variable_sumIt31custom_divide_multiple_variableItEEvT_S2_S2_S2_S2_(%struct.State* noalias, i64, %struct.Memory* noalias readnone) local_unnamed_addr #1 {
entry:
...
block_4109fb:                                     ; preds = %entry
  ...
  %call2_410a0e = tail call %struct.Memory* @sub_4006c0.printf_plt(%struct.State* nonnull %0, i64 %166, %struct.Memory* %call2_4109ee)
...
block_.L_410a16:                                  ; preds = %block_4109fb, %entry
  %177 = phi i64 [ %163, %entry ], [ %.pre, %block_4109fb ]
  %MEMORY.0 = phi %struct.Memory* [ %call2_4109ee, %entry ], [ %call2_410a0e, %block_4109fb ]
