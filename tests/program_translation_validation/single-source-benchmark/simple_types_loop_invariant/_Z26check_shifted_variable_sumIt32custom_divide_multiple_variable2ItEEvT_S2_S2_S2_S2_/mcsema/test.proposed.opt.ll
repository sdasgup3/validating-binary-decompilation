...
entry:
  ...
  %89 = add i64 %88, ptrtoint (%G_0x2097dd__rip__type* @G_0x2097dd__rip_ to i64)
  %90 = add i64 %88, 8
  ...
  %call2_4108d1 = tail call %struct.Memory* @sub_410810._ZN32custom_divide_multiple_variable2ItE8do_shiftEttttt(%struct.State* %0, i64 %123, %struct.Memory* %2)
  ...
  %call2_4108ee = tail call %struct.Memory* @sub_410270._Z15tolerance_equalItEbRT_S1_(%struct.State* %0, i64 %149, %struct.Memory* %call2_4108d1)
  ...
  br i1 %162, label %block_.L_410916, label %block_4108fb
...
block_4108fb:                                     ; preds = %entry
  ...
  %171 = tail call %struct.Memory* @__remill_function_call(%struct.State* nonnull %0, i64 ptrtoint (i64 (i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64)* @printf to i64), %struct.Memory* %call2_4108ee)
...
block_.L_410916:                                  ; preds = %block_4108fb, %entry
  %178 = phi i64 [ %163, %entry ], [ %.pre, %block_4108fb ]
  %MEMORY.0 = phi %struct.Memory* [ %call2_4108ee, %entry ], [ %171, %block_4108fb ]
