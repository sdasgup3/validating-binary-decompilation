...
declare %struct.Memory* @sub_410800._ZN32custom_divide_multiple_variable2ItE8do_shiftEttttt(%struct.State* dereferenceable(3376), i64, %struct.Memory*) local_unnamed_addr
