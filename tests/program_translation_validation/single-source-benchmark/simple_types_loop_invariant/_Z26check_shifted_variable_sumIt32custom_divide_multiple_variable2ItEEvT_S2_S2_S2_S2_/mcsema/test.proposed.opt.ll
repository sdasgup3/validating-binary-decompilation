...
define %struct.Memory* @_Z26check_shifted_variable_sumIt32custom_divide_multiple_variable2ItEEvT_S2_S2_S2_S2_(%struct.State* noalias, i64, %struct.Memory* noalias readnone) local_unnamed_addr #1 {
entry:
...
block_4108eb:                                     ; preds = %entry
  ...
  %call2_4108fe = tail call %struct.Memory* @sub_4006c0.printf_plt(%struct.State* nonnull %0, i64 %166, %struct.Memory* %call2_4108de)
...
block_.L_410906:                                  ; preds = %block_4108eb, %entry
  %177 = phi i64 [ %163, %entry ], [ %.pre, %block_4108eb ]
  %MEMORY.0 = phi %struct.Memory* [ %call2_4108de, %entry ], [ %call2_4108fe, %block_4108eb ]
