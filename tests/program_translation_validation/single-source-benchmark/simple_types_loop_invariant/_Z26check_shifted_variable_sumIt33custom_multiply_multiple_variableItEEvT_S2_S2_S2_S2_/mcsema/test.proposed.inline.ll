...
@G_0x20943d__rip__4262987_ = global %G_0x20943d__rip__4262987__type zeroinitializer
...
entry:
  ...
  store %struct.Memory* %loadMem_410c10, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_410c14, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_410c19, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_410c1d, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_410c29, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_410c30, %struct.Memory** %MEMORY
  ...
  %234 = load double, double* bitcast (%G_0x20943d__rip__4262987__type* @G_0x20943d__rip__4262987_ to double*)
  ...
  store %struct.Memory* %loadMem_410c43, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_410c4e, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_410c53, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_410c58, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_410c64, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_410c68, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem1_410c71, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_410c81, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_410c8a, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem1_410c8e, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_410c95, %struct.Memory** %MEMORY
...
block_410c9b:                                     ; preds = %entry
  ...
  store %struct.Memory* %loadMem_410c9b, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_410ca5, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem1_410cae, %struct.Memory** %MEMORY
  %loadMem2_410cae = load %struct.Memory*, %struct.Memory** %MEMORY
  %loadPC_410cae = load i64, i64* %3
  %587 = call %struct.Memory* @__remill_function_call(%struct.State* %0, i64 ptrtoint (i64 (i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64)* @printf to i64), %struct.Memory* %loadMem2_410cae)
  ...
  store %struct.Memory* %loadMem_410cb3, %struct.Memory** %MEMORY
...
block_.L_410cb6:                                  ; preds = %block_410c9b, %entry
  ...
  store %struct.Memory* %loadMem_410cbc, %struct.Memory** %MEMORY
  ret %struct.Memory* %loadMem_410cbc
}
...
define %struct.Memory* @routine_cvttsd2si_0x20943d__rip____ecx(%struct.State* dereferenceable(3376), i64, %struct.Memory*) {
block_400478:
  %3 = getelementptr inbounds %struct.State, %struct.State* %0, i32 0, i32 6
  %4 = getelementptr inbounds %struct.GPR, %struct.GPR* %3, i32 0, i32 33
  %5 = getelementptr inbounds %struct.Reg, %struct.Reg* %4, i32 0, i32 0
