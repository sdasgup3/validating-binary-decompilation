...
%G_0x20943d__rip__type = type <{ [8 x i8] }>
...
@G_0x20943d__rip_ = local_unnamed_addr global %G_0x20943d__rip__type zeroinitializer
...
entry:
  ...
  %89 = load double, double* bitcast (%G_0x20943d__rip__type* @G_0x20943d__rip_ to double*), align 8
  ...
  %call2_410c71 = tail call %struct.Memory* @sub_410bb0._ZN33custom_multiply_multiple_variableItE8do_shiftEttttt(%struct.State* %0, i64 %120, %struct.Memory* %2)
  ...
  %call2_410c8e = tail call %struct.Memory* @sub_410230._Z15tolerance_equalItEbRT_S1_(%struct.State* %0, i64 %146, %struct.Memory* %call2_410c71)
  ...
  br i1 %159, label %block_.L_410cb6, label %block_410c9b

block_410c9b:                                     ; preds = %entry
  ...
  %168 = tail call %struct.Memory* @__remill_function_call(%struct.State* %0, i64 ptrtoint (i64 (i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64)* @printf to i64), %struct.Memory* %call2_410c8e)
  ...
  br label %block_.L_410cb6

block_.L_410cb6:                                  ; preds = %block_410c9b, %entry
  %175 = phi i64 [ %160, %entry ], [ %.pre, %block_410c9b ]
  %MEMORY.0 = phi %struct.Memory* [ %call2_410c8e, %entry ], [ %168, %block_410c9b ]
  %176 = load i64, i64* %RSP.i9, align 8
  %177 = add i64 %176, 24
  store i64 %177, i64* %RSP.i9, align 8
...
define %struct.Memory* @routine_cvttsd2si_0x20943d__rip____ecx(%struct.State* dereferenceable(3376), i64, %struct.Memory*) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  ...
  %5 = load double, double* bitcast (%G_0x20943d__rip__type* @G_0x20943d__rip_ to double*), align 8
...
define %struct.Memory* @routine_jne_.L_410cb6(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i8* %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
