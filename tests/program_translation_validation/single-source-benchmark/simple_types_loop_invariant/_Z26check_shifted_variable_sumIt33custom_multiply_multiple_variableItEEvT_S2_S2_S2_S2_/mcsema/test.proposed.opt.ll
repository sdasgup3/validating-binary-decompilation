...
block_410ccb:                                     ; preds = %entry
  ...
  %171 = tail call %struct.Memory* @__remill_function_call(%struct.State* nonnull %0, i64 ptrtoint (i64 (i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64)* @printf to i64), %struct.Memory* %call2_410cbe)
...
block_.L_410ce6:                                  ; preds = %block_410ccb, %entry
  %178 = phi i64 [ %163, %entry ], [ %.pre, %block_410ccb ]
  %MEMORY.0 = phi %struct.Memory* [ %call2_410cbe, %entry ], [ %171, %block_410ccb ]
