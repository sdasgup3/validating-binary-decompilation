; ModuleID = '/tmp/tmptaf1zr46-query.ll'
...
entry:
  ...
  %var_2_89 = add i64 %var_2_88, ptrtoint (%G_0x2093fd__rip__type* @G_0x2093fd__rip_ to i64)
  ...
  %call2_410cb1 = tail call %struct.Memory* @sub_410bf0._ZN33custom_multiply_multiple_variableItE8do_shiftEttttt(%struct.State* %0, i64 %var_2_123, %struct.Memory* %2)
  %var_2_148 = load i64, i64* %var_2_3, align 8
  %var_2_149 = add i64 %var_2_148, -2654
  %call2_410cce = tail call %struct.Memory* @sub_410270._Z15tolerance_equalItEbRT_S1_(%struct.State* %0, i64 %var_2_149, %struct.Memory* %call2_410cb1)
  ...
  br i1 %var_2_162, label %block_410cdb, label %block_.L_410cf6

block_410cdb:                                     ; preds = %entry
  %var_2_171 = tail call %struct.Memory* @__remill_function_call(%struct.State* nonnull %0, i64 ptrtoint (i64 (i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64)* @printf to i64), %struct.Memory* %call2_410cce)
  br label %block_.L_410cf6

block_.L_410cf6:                                  ; preds = %block_410cdb, %entry
  %MEMORY.0 = phi %struct.Memory* [ %call2_410cce, %entry ], [ %var_2_171, %block_410cdb ]
