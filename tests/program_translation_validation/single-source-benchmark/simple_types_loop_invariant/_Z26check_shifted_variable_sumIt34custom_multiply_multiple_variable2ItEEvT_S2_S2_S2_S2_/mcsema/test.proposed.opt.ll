...
@G_0x20954d__rip__4262715_ = local_unnamed_addr global %G_0x20954d__rip__4262715__type zeroinitializer
...
declare %struct.Memory* @sub_410aa0._ZN34custom_multiply_multiple_variable2ItE8do_shiftEttttt(%struct.State* noalias dereferenceable(3376), i64, %struct.Memory* noalias readnone returned) local_unnamed_addr
...
define %struct.Memory* @_Z26check_shifted_variable_sumIt34custom_multiply_multiple_variable2ItEEvT_S2_S2_S2_S2_(%struct.State* noalias, i64, %struct.Memory* noalias) local_unnamed_addr #1 {
entry:
  ...
  %89 = load double, double* bitcast (%G_0x20954d__rip__4262715__type* @G_0x20954d__rip__4262715_ to double*), align 8
  ...
  %call2_410b61 = tail call %struct.Memory* @sub_410aa0._ZN34custom_multiply_multiple_variable2ItE8do_shiftEttttt(%struct.State* %0, i64 %120, %struct.Memory* %2)
  ...
  %call2_410b7e = tail call %struct.Memory* @sub_410230._Z15tolerance_equalItEbRT_S1_(%struct.State* %0, i64 %146, %struct.Memory* %call2_410b61)
  ...
  br i1 %159, label %block_.L_410ba6, label %block_410b8b

block_410b8b:                                     ; preds = %entry
  ...
  %168 = tail call %struct.Memory* @__remill_function_call(%struct.State* %0, i64 ptrtoint (i64 (i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64)* @printf to i64), %struct.Memory* %call2_410b7e)
...
block_.L_410ba6:                                  ; preds = %block_410b8b, %entry
  %175 = phi i64 [ %160, %entry ], [ %.pre, %block_410b8b ]
  %MEMORY.0 = phi %struct.Memory* [ %call2_410b7e, %entry ], [ %168, %block_410b8b ]
...
define %struct.Memory* @routine_cvttsd2si_0x20954d__rip____ecx(%struct.State* dereferenceable(3376), i64, %struct.Memory*) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  ...
  %5 = load double, double* bitcast (%G_0x20954d__rip__4262715__type* @G_0x20954d__rip__4262715_ to double*), align 8
...
define %struct.Memory* @routine_callq_._ZN34custom_multiply_multiple_variable2ItE8do_shiftEttttt(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
...
define %struct.Memory* @routine_jne_.L_410ba6(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i8* %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
