...
@G_0x20950d__rip_ = global %G_0x20950d__rip__type zeroinitializer
...
declare %struct.Memory* @sub_410ae0._ZN34custom_multiply_multiple_variable2ItE8do_shiftEttttt(%struct.State* noalias dereferenceable(3376), i64, %struct.Memory* noalias readnone returned) local_unnamed_addr
...
entry:
  ...
  %89 = add i64 %88, ptrtoint (%G_0x20950d__rip__type* @G_0x20950d__rip_ to i64)
  %90 = add i64 %88, 8
  ...
  %call2_410ba1 = tail call %struct.Memory* @sub_410ae0._ZN34custom_multiply_multiple_variable2ItE8do_shiftEttttt(%struct.State* %0, i64 %123, %struct.Memory* %2)
  ...
  %call2_410bbe = tail call %struct.Memory* @sub_410270._Z15tolerance_equalItEbRT_S1_(%struct.State* %0, i64 %149, %struct.Memory* %call2_410ba1)
  ...
  br i1 %162, label %block_.L_410be6, label %block_410bcb

block_410bcb:                                     ; preds = %entry
  ...
  %171 = tail call %struct.Memory* @__remill_function_call(%struct.State* nonnull %0, i64 ptrtoint (i64 (i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64)* @printf to i64), %struct.Memory* %call2_410bbe)
...
block_.L_410be6:                                  ; preds = %block_410bcb, %entry
  %178 = phi i64 [ %163, %entry ], [ %.pre, %block_410bcb ]
  %MEMORY.0 = phi %struct.Memory* [ %call2_410bbe, %entry ], [ %171, %block_410bcb ]
...
; Function Attrs: alwaysinline nounwind
define %struct.Memory* @routine_cvttsd2si_0x20950d__rip____ecx(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned) local_unnamed_addr #3 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %RCX = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 5, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, ptrtoint (%G_0x20950d__rip__type* @G_0x20950d__rip_ to i64)
  %5 = add i64 %3, 8
  store i64 %5, i64* %PC, align 8
