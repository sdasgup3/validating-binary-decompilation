...
block_410bbb:                                     ; preds = %entry
  ...
  %171 = tail call %struct.Memory* @__remill_function_call(%struct.State* nonnull %0, i64 ptrtoint (i64 (i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64)* @printf to i64), %struct.Memory* %call2_410bae)
...
block_.L_410bd6:                                  ; preds = %block_410bbb, %entry
  %178 = phi i64 [ %163, %entry ], [ %.pre, %block_410bbb ]
  %MEMORY.0 = phi %struct.Memory* [ %call2_410bae, %entry ], [ %171, %block_410bbb ]
