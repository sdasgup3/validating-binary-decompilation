...
declare %struct.Memory* @sub_410ad0._ZN34custom_multiply_multiple_variable2ItE8do_shiftEttttt(%struct.State* dereferenceable(3376), i64, %struct.Memory*) local_unnamed_addr
