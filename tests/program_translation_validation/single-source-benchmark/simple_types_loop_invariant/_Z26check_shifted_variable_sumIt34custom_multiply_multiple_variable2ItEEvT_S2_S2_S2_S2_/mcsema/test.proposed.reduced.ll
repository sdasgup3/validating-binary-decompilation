; ModuleID = '/tmp/tmp8wcvhreh-query.ll'
...
entry:
  ...
  %var_2_89 = add i64 %var_2_88, ptrtoint (%G_0x20950d__rip__type* @G_0x20950d__rip_ to i64)
  ...
  %call2_410ba1 = tail call %struct.Memory* @sub_410ae0._ZN34custom_multiply_multiple_variable2ItE8do_shiftEttttt(%struct.State* %0, i64 %var_2_123, %struct.Memory* %2)
  %var_2_148 = load i64, i64* %var_2_3, align 8
  %var_2_149 = add i64 %var_2_148, -2382
  %call2_410bbe = tail call %struct.Memory* @sub_410270._Z15tolerance_equalItEbRT_S1_(%struct.State* %0, i64 %var_2_149, %struct.Memory* %call2_410ba1)
  ...
  br i1 %var_2_162, label %block_410bcb, label %block_.L_410be6

block_410bcb:                                     ; preds = %entry
  %var_2_171 = tail call %struct.Memory* @__remill_function_call(%struct.State* nonnull %0, i64 ptrtoint (i64 (i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64)* @printf to i64), %struct.Memory* %call2_410bbe)
  br label %block_.L_410be6

block_.L_410be6:                                  ; preds = %block_410bcb, %entry
  %MEMORY.0 = phi %struct.Memory* [ %call2_410bbe, %entry ], [ %var_2_171, %block_410bcb ]
