...
define %struct.Memory* @_Z4fillIPffEvT_S1_T0_(%struct.State* noalias, i64, %struct.Memory* noalias) local_unnamed_addr #1 {
entry:
  ...
  %26 = bitcast %union.VectorReg* %21 to <2 x float>*
  ...
  %36 = bitcast %union.VectorReg* %21 to i8*
...
block_.L_40ab61:                                  ; preds = %block_40ab6f, %entry
  %43 = phi i64 [ %115, %block_40ab6f ], [ %.pre, %entry ]
  ...
  store i64 %48, i64* %RAX.i23, align 8
  %49 = add i64 %44, -16
  %50 = add i64 %43, 8
  ...
  %.v = select i1 %67, i64 43, i64 14
  %78 = add i64 %43, %.v
  store i64 %78, i64* %3, align 8
  br i1 %67, label %block_.L_40ab8c, label %block_40ab6f
...
block_40ab6f:                                     ; preds = %block_.L_40ab61
  ...
  %83 = bitcast %union.VectorReg* %21 to i32*
  ...
  store i64 %85, i64* %RAX.i23, align 8
  %86 = add i64 %85, 4
  store i64 %86, i64* %RCX.i12, align 8
  %87 = icmp ugt i64 %85, -5
  %88 = zext i1 %87 to i8
...
define %struct.Memory* @routine_je_.L_40ab8c(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i8* %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
...
define %struct.Memory* @routine_addq__0x4___rcx(%struct.State* dereferenceable(3376), i64, %struct.Memory*) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %RCX = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 5, i32 0, i32 0
...
define %struct.Memory* @routine_jmpq_.L_40ab61(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
