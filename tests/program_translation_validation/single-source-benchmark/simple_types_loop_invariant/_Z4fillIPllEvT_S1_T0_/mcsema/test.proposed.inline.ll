...
define %struct.Memory* @_Z4fillIPllEvT_S1_T0_(%struct.State* noalias, i64, %struct.Memory* noalias) #1 {
entry:
  ...
  store %struct.Memory* %loadMem_408fc0, %struct.Memory** %MEMORY
  ...
  store i64 %70, i64* %73
  store %struct.Memory* %loadMem_408fcc, %struct.Memory** %MEMORY
...
block_.L_408ff9:                                  ; preds = %block_.L_408fd0
  ...
  ret %struct.Memory* %loadMem_408ffa
}
