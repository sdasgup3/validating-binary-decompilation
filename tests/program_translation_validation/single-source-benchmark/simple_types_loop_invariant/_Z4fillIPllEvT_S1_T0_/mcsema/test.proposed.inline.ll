...
define %struct.Memory* @_Z4fillIPllEvT_S1_T0_(%struct.State* noalias, i64, %struct.Memory* noalias) #2 {
entry:
...
block_408fae:                                     ; preds = %block_.L_408fa0
  ...
  store %struct.Memory* %loadMem_408fae, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_408fb6, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_408fc4, %struct.Memory** %MEMORY
  br label %block_.L_408fa0
...
block_.L_408fc9:                                  ; preds = %block_.L_408fa0
  ...
  store %struct.Memory* %loadMem_408fca, %struct.Memory** %MEMORY
  ret %struct.Memory* %loadMem_408fca
}
