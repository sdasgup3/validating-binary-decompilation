...
block_.L_408fa0:                                  ; preds = %block_408fae, %entry
  %33 = phi i64 [ %103, %block_408fae ], [ %.pre, %entry ]
  ...
  br i1 %57, label %block_.L_408fc9, label %block_408fae

block_408fae:                                     ; preds = %block_.L_408fa0
  %69 = add i64 %34, -24
  %70 = add i64 %68, 4
...
block_.L_408fc9:                                  ; preds = %block_.L_408fa0
  %104 = add i64 %68, 1
...
define %struct.Memory* @routine_je_.L_408fc9(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i8* %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
...
define %struct.Memory* @routine_jmpq_.L_408fa0(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
