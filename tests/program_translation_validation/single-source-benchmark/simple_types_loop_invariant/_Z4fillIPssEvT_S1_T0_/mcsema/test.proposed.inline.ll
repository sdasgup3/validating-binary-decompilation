...
define %struct.Memory* @_Z4fillIPssEvT_S1_T0_(%struct.State* noalias, i64, %struct.Memory* noalias) #2 {
entry:
  ...
  store i64 %53, i64* %56
  store %struct.Memory* %loadMem_4050b7, %struct.Memory** %MEMORY
...
block_.L_4050c3:                                  ; preds = %block_4050d1, %entry
  ...
  store %struct.Memory* %loadMem_4050c7, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_4050cb, %struct.Memory** %MEMORY
...
block_4050d1:                                     ; preds = %block_.L_4050c3
  ...
  store %struct.Memory* %loadMem_4050d5, %struct.Memory** %MEMORY
...
block_.L_4050ec:                                  ; preds = %block_.L_4050c3
  ...
  ret %struct.Memory* %loadMem_4050ed
}
