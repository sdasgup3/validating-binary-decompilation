...
entry:
  ...
  br label %block_.L_405083

block_.L_405083:                                  ; preds = %block_405091, %entry
  %36 = phi i64 [ %106, %block_405091 ], [ %.pre, %entry ]
  ...
  br i1 %60, label %block_.L_4050ac, label %block_405091

block_405091:                                     ; preds = %block_.L_405083
  %72 = add i64 %37, -18
  %73 = add i64 %71, 4
...
block_.L_4050ac:                                  ; preds = %block_.L_405083
  %107 = add i64 %71, 1
...
define %struct.Memory* @routine_je_.L_4050ac(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i8* %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
...
define %struct.Memory* @routine_jmpq_.L_405083(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
