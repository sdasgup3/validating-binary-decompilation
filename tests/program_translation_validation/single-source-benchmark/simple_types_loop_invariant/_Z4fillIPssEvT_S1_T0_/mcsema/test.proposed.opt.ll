...
entry:
  ...
  br label %block_.L_4050b3

block_.L_4050b3:                                  ; preds = %block_4050c1, %entry
  %37 = phi i64 [ %107, %block_4050c1 ], [ %.pre, %entry ]
  ...
  br i1 %61, label %block_.L_4050dc, label %block_4050c1

block_4050c1:                                     ; preds = %block_.L_4050b3
  %73 = add i64 %38, -18
  %74 = add i64 %72, 4
...
block_.L_4050dc:                                  ; preds = %block_.L_4050b3
  %108 = add i64 %72, 1
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_je_.L_4050dc(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i8* nocapture %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_jmpq_.L_4050b3(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
