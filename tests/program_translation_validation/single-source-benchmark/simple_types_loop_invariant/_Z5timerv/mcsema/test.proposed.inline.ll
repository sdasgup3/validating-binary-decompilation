...
entry:
  ...
  %51 = add i64 %50, ptrtoint (%G_0x12fd7__rip__type* @G_0x12fd7__rip_ to i64)
  ...
  store i64 %65, i64* bitcast (%G_0x61a0b8_type* @G_0x61a0b8 to i64*)
  ...
  %76 = load i64, i64* bitcast (%G_0x61a0b8_type* @G_0x61a0b8 to i64*)
  ...
  %86 = load i64, i64* bitcast (%G_0x61a0b0_type* @G_0x61a0b0 to i64*)
  %87 = sub i64 %83, %86
  ...
  ret %struct.Memory* %loadMem_400eb6
}
...
define %struct.Memory* @routine_movsd_0x12fd7__rip____xmm0(%struct.State* dereferenceable(3376), i64, %struct.Memory*) {
block_400488:
  %3 = getelementptr inbounds %struct.State, %struct.State* %0, i32 0, i32 6
  %4 = getelementptr inbounds %struct.GPR, %struct.GPR* %3, i32 0, i32 33
  %5 = getelementptr inbounds %struct.Reg, %struct.Reg* %4, i32 0, i32 0
  ...
  %9 = load i64, i64* %PC
  %10 = add i64 %9, ptrtoint (%G_0x12fd7__rip__type* @G_0x12fd7__rip_ to i64)
  %11 = load i64, i64* %PC
  %12 = add i64 %11, 8
  store i64 %12, i64* %PC
