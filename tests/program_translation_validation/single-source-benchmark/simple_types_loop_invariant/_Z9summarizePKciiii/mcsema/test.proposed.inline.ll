...
%G_0x13542__rip__type = type <{ [8 x i8] }>
...
@G_0x13542__rip_ = global %G_0x13542__rip__type zeroinitializer
...
entry:
  ...
  %113 = load double, double* bitcast (%G_0x13542__rip__type* @G_0x13542__rip_ to double*)
...
block_400478:
  ...
  %9 = load i64, i64* %PC
  %10 = ptrtoint %G_0x13542__rip__type* @G_0x13542__rip_ to i64
  %11 = load i64, i64* %PC
  %12 = add i64 %11, 8
  store i64 %12, i64* %PC
