...
block_.L_4009ce:                                  ; preds = %block_4009de, %block_.L_400980
  %361 = phi i64 [ %.pre3, %block_.L_400980 ], [ %728, %block_4009de ]
  %MEMORY.2 = phi %struct.Memory* [ %344, %block_.L_400980 ], [ %690, %block_4009de ]
...
block_4009de:                                     ; preds = %block_.L_4009ce
  ...
  store double 0.000000e+00, double* %53, align 1
  %580 = load i64, i64* bitcast (%G_0x61a0a0_type* @G_0x61a0a0 to i64*), align 8
  ...
  %654 = load i64, i64* bitcast (%G_0x61a0a0_type* @G_0x61a0a0 to i64*), align 8
...
block_.L_400ad1:                                  ; preds = %block_400ae1, %block_.L_400aca
  %730 = phi i64 [ %838, %block_400ae1 ], [ %.pre4, %block_.L_400aca ]
  ...
  %737 = load i32, i32* bitcast (%G_0x61a0a8_type* @G_0x61a0a8 to i32*), align 8
  %738 = sub i32 %735, %737
  ...
  br i1 %763, label %block_400ae1, label %block_.L_400b10

block_400ae1:                                     ; preds = %block_.L_400ad1
  %765 = load i64, i64* bitcast (%G_0x61a0a0_type* @G_0x61a0a0 to i64*), align 8
...
block_.L_400b10:                                  ; preds = %block_.L_400ad1
  ...
  %854 = load i32, i32* bitcast (%G_0x61a0a8_type* @G_0x61a0a8 to i32*), align 8
  %855 = add i32 %854, -1
  ...
  br i1 %889, label %block_.L_400bd8, label %block_400b3b
...
block_400b3b:                                     ; preds = %block_.L_400b10
  ...
  br i1 %901, label %block_.L_400bd8, label %block_400b45
...
block_.L_400b4c:                                  ; preds = %block_400b5c, %block_400b45
  %909 = phi i64 [ %.pre5, %block_400b45 ], [ %1030, %block_400b5c ]
  %MEMORY.4 = phi %struct.Memory* [ %852, %block_400b45 ], [ %989, %block_400b5c ]
  ...
  %916 = load i32, i32* bitcast (%G_0x61a0a8_type* @G_0x61a0a8 to i32*), align 8
  %917 = sub i32 %914, %916
  ...
  br i1 %942, label %block_400b5c, label %block_.L_400b9c

block_400b5c:                                     ; preds = %block_.L_400b4c
  %944 = load i64, i64* bitcast (%G_0x61a0a0_type* @G_0x61a0a0 to i64*), align 8
...
block_.L_400bd8:                                  ; preds = %block_.L_400b9c, %block_400b3b, %block_.L_400b10
  %1090 = phi i64 [ %890, %block_.L_400b10 ], [ %905, %block_400b3b ], [ %.pre6, %block_.L_400b9c ]
  %MEMORY.5 = phi %struct.Memory* [ %852, %block_.L_400b10 ], [ %852, %block_400b3b ], [ %1083, %block_.L_400b9c ]
