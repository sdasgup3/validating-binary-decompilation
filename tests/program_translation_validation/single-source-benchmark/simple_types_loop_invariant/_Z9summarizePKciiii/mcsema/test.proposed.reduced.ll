; ModuleID = '/tmp/tmpw4cjlguq-query.ll'
...
; %var_2_39 = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 1
  ...
  %var_2_43 = add i64 %var_2_10, add (i64 ptrtoint (%G_0x13532__rip__type* @G_0x13532__rip_ to i64), i64 13)
...
; Matched:  %var_2_508 = load i64, i64* %RBP, align 8
...
; %RCX.i359 = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 5, i32 0, i32 0
  ...
  %var_2_13840 = load i32, i32* bitcast (%G_0x61a0a8_type* @G_0x61a0a8 to i32*), align 8
  ...
  br i1 %var_2_16450, label %block_400986.preheader, label %block_.L_4009cc

block_400986.preheader:                           ; preds = %entry
  br label %block_400986

block_400986:                                     ; preds = %block_400986.preheader, %block_400986
  %MEMORY.051 = phi %struct.Memory* [ %var_2_208, %block_400986 ], [ %2, %block_400986.preheader ]
  ...
  %var_2_138 = load i32, i32* bitcast (%G_0x61a0a8_type* @G_0x61a0a8 to i32*), align 8
  ...
  br i1 %var_2_164, label %block_400986, label %block_.L_4009cc.loopexit

block_.L_4009cc.loopexit:                         ; preds = %block_400986
  br label %block_.L_4009cc

block_.L_4009cc:                                  ; preds = %block_.L_4009cc.loopexit, %entry
  %MEMORY.0.lcssa = phi %struct.Memory* [ %2, %entry ], [ %var_2_208, %block_.L_4009cc.loopexit ]
; Matched:\<badref\>:  store i64 add (i64 ptrtoint (%seg_413e60__rodata_type* @seg_413e60__rodata to i64), i64 346), i64* %RDI, align 8, !tbaa !1261
...
; Matched:\<badref\>:  store i64 add (i64 ptrtoint (%seg_413e60__rodata_type* @seg_413e60__rodata to i64), i64 264), i64* %RDI, align 8, !tbaa !1261
...
; Matched:  %var_2_122 = load i64, i64* %RBP, align 8
; %var_2_341 = load i64, i64* %RBP.i, align 8
; Matched:  %var_2_522 = add i64 %var_2_703, -28
; %var_2_342 = add i64 %var_2_341, -28
; Matched:  %var_2_512 = inttoptr i64 %var_2_509 to i32*
; %var_2_345 = inttoptr i64 %var_2_342 to i32*
; Matched:\<badref\>:  store i32 1, i32* %var_2_524, align 4
; store i32 0, i32* %var_2_345, align 4
  ...
  %var_2_36322 = load i32, i32* bitcast (%G_0x61a0a8_type* @G_0x61a0a8 to i32*), align 8
  ...
  br i1 %var_2_38932, label %block_400a2a.preheader, label %block_.L_400b16

block_400a2a.preheader:                           ; preds = %block_.L_4009cc
  br label %block_400a2a

block_400a2a:                                     ; preds = %block_400a2a.preheader, %block_400a2a
  %MEMORY.233 = phi %struct.Memory* [ %var_2_690, %block_400a2a ], [ %var_2_340, %block_400a2a.preheader ]
; Matched:\<badref\>:  store i64 add (i64 ptrtoint (%seg_413e60__rodata_type* @seg_413e60__rodata to i64), i64 221), i64* %RDI, align 8, !tbaa !1261
; store i64 ptrtoint (%G__0x413f68_type* @G__0x413f68 to i64), i64* %RDI.i147, align 8
; Matched:\<badref\>:  store i64 add (i64 ptrtoint (%seg_413e60__rodata_type* @seg_413e60__rodata to i64), i64 263), i64* %RCX, align 8, !tbaa !1261
; store i64 ptrtoint (%G__0x413f67_type* @G__0x413f67 to i64), i64* %RCX.i359, align 8
; Matched:  %var_2_761 = load i64, i64* bitcast (%results_type* @results to i64*), align 8
; %var_2_399 = load i64, i64* bitcast (%G_0x61a0a0_type* @G_0x61a0a0 to i64*), align 8
; Matched:\<badref\>:  store i64 %var_2_761, i64* %RDX, align 8
; store i64 %var_2_399, i64* %RDX.i346, align 8
  ...
  %var_2_363 = load i32, i32* bitcast (%G_0x61a0a8_type* @G_0x61a0a8 to i32*), align 8
  ...
  br i1 %var_2_389, label %block_400a2a, label %block_.L_400b16.loopexit

block_.L_400b16.loopexit:                         ; preds = %block_400a2a
  br label %block_.L_400b16

block_.L_400b16:                                  ; preds = %block_.L_400b16.loopexit, %block_.L_4009cc
  %MEMORY.2.lcssa = phi %struct.Memory* [ %var_2_340, %block_.L_4009cc ], [ %var_2_690, %block_.L_400b16.loopexit ]
; Matched:  %var_2_220.lcssa = phi i32* [ %var_2_22020, %block_4009cc ], [ %var_2_220, %block_400b16.loopexit ]
; %var_2_360.lcssa = phi i32* [ %var_2_36020, %block_.L_4009cc ], [ %var_2_360, %block_.L_400b16.loopexit ]
; Matched:\<badref\>:  store i32 0, i32* %var_2_220.lcssa, align 4
; store i32 0, i32* %var_2_360.lcssa, align 4
  ...
  %var_2_738 = load i32, i32* bitcast (%G_0x61a0a8_type* @G_0x61a0a8 to i32*), align 8
  ...
  br i1 %var_2_764, label %block_.L_400b1d.preheader, label %block_.L_400b5c.split

block_.L_400b1d.preheader:                        ; preds = %block_.L_400b16
  br label %block_.L_400b1d

block_.L_400b1d:                                  ; preds = %block_.L_400b1d.preheader, %block_.L_400b1d
  br label %block_.L_400b1d

block_.L_400b5c.split:                            ; preds = %block_.L_400b16
; Matched:\<badref\>:  store i64 add (i64 ptrtoint (%seg_413e60__rodata_type* @seg_413e60__rodata to i64), i64 307), i64* %RDI, align 8, !tbaa !1261
...
; Matched:  %var_2_177 = load i32, i32* bitcast (%current_test_type* @current_test to i32*), align 8
; %var_2_856 = load i32, i32* bitcast (%G_0x61a0a8_type* @G_0x61a0a8 to i32*), align 8
; Matched:  %var_2_179 = icmp eq i32 %var_2_177, 0
; %var_2_858 = icmp eq i32 %var_2_856, 0
; Matched:  %var_2_180 = zext i1 %var_2_179 to i8
; %var_2_859 = zext i1 %var_2_858 to i8
; Matched:\<badref\>:  store i8 %var_2_180, i8* %var_2_22, align 1
; store i8 %var_2_859, i8* %var_2_14, align 1
  ...
  br i1 %var_2_893, label %block_.L_400c24, label %block_400b87

block_400b87:                                     ; preds = %block_.L_400b5c.split
...
; store i8 0, i8* %var_2_38, align 1
  br i1 %var_2_905, label %block_.L_400c24, label %block_400b91

block_400b91:                                     ; preds = %block_400b87
; Matched:  %var_2_509 = add i64 %var_2_508, -28
; %var_2_910 = add i64 %var_2_895, -28
; Matched:  %var_2_524 = inttoptr i64 %var_2_522 to i32*
...
; store i32 1, i32* %var_2_912, align 4
  ...
  %var_2_9205 = load i32, i32* bitcast (%G_0x61a0a8_type* @G_0x61a0a8 to i32*), align 8
  ...
  br i1 %var_2_94615, label %block_400ba8.preheader, label %block_.L_400be8

block_400ba8.preheader:                           ; preds = %block_400b91
  br label %block_400ba8

block_400ba8:                                     ; preds = %block_400ba8.preheader, %block_400ba8
  %MEMORY.416 = phi %struct.Memory* [ %var_2_994, %block_400ba8 ], [ %var_2_854, %block_400ba8.preheader ]
  ...
  %var_2_920 = load i32, i32* bitcast (%G_0x61a0a8_type* @G_0x61a0a8 to i32*), align 8
  ...
  br i1 %var_2_946, label %block_400ba8, label %block_.L_400be8.loopexit

block_.L_400be8.loopexit:                         ; preds = %block_400ba8
  br label %block_.L_400be8

block_.L_400be8:                                  ; preds = %block_.L_400be8.loopexit, %block_400b91
  %MEMORY.4.lcssa = phi %struct.Memory* [ %var_2_854, %block_400b91 ], [ %var_2_994, %block_.L_400be8.loopexit ]
; Matched:  %var_2_430.lcssa = phi i32 [ %var_2_4305, %block_400b91 ], [ %var_2_430, %block_400be8.loopexit ]
; %var_2_920.lcssa = phi i32 [ %var_2_9205, %block_400b91 ], [ %var_2_920, %block_.L_400be8.loopexit ]
; Matched:  %var_2_293 = icmp eq i32 %var_2_430.lcssa, 0
; %var_2_1047 = icmp eq i32 %var_2_920.lcssa, 0
; Matched:  %var_2_294 = zext i1 %var_2_293 to i8
; %var_2_1048 = zext i1 %var_2_1047 to i8
; Matched:\<badref\>:  store i8 %var_2_294, i8* %var_2_22, align 1
...
; Matched:\<badref\>:  store i64 add (i64 ptrtoint (%seg_413e60__rodata_type* @seg_413e60__rodata to i64), i64 159), i64* %RDI, align 8, !tbaa !1261
...
block_.L_400c24:                                  ; preds = %block_.L_400be8, %block_400b87, %block_.L_400b5c.split
  %MEMORY.5 = phi %struct.Memory* [ %var_2_854, %block_.L_400b5c.split ], [ %var_2_854, %block_400b87 ], [ %var_2_1089, %block_.L_400be8 ]
