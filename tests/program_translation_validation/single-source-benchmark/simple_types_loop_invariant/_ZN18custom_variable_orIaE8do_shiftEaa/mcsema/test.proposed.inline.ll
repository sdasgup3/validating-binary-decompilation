...
define %struct.Memory* @_ZN18custom_variable_orIaE8do_shiftEaa(%struct.State* noalias, i64, %struct.Memory* noalias) #2 {
entry:
  ...
  store %struct.Memory* %loadMem_41326a, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_413270, %struct.Memory** %MEMORY
  ...
  ret %struct.Memory* %loadMem_413271
}
