...
define %struct.Memory* @_ZN18custom_variable_orIaE8do_shiftEaa(%struct.State* noalias, i64, %struct.Memory* noalias) #1 {
entry:
  ...
  store i8 %71, i8* %75
  store %struct.Memory* %loadMem_41328a, %struct.Memory** %MEMORY
  ...
  ret %struct.Memory* %loadMem_4132a1
}
