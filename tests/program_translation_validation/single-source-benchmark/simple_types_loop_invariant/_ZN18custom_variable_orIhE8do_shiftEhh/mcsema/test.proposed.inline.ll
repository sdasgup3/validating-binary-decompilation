...
define %struct.Memory* @_ZN18custom_variable_orIhE8do_shiftEhh(%struct.State* noalias, i64, %struct.Memory* noalias) #1 {
entry:
  ...
  store i8 %88, i8* %92
  store %struct.Memory* %loadMem_41246d, %struct.Memory** %MEMORY
  ...
  ret %struct.Memory* %loadMem_412481
}
