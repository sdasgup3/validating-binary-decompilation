...
define %struct.Memory* @_ZN18custom_variable_orIiE8do_shiftEii(%struct.State* noalias, i64, %struct.Memory* noalias) #1 {
entry:
  ...
  store %struct.Memory* %loadMem_40f8e2, %struct.Memory** %MEMORY
  ...
  ret %struct.Memory* %loadMem_40f8e3
}
