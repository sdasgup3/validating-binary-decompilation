...
define %struct.Memory* @_ZN18custom_variable_orIjE8do_shiftEjj(%struct.State* noalias, i64, %struct.Memory* noalias) #2 {
entry:
  ...
  store %struct.Memory* %loadMem_40ed90, %struct.Memory** %MEMORY
  ...
  store i32 %56, i32* %60
  store %struct.Memory* %loadMem_40ed97, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_40ed9a, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_40ed9d, %struct.Memory** %MEMORY
  ...
  ret %struct.Memory* %loadMem_40eda3
}
...
define %struct.Memory* @routine_orl_MINUS0x8__rbp____esi(%struct.State* dereferenceable(3376), i64, %struct.Memory*) {
block_400478:
  %3 = getelementptr inbounds %struct.State, %struct.State* %0, i32 0, i32 6
  %4 = getelementptr inbounds %struct.GPR, %struct.GPR* %3, i32 0, i32 33
  %5 = getelementptr inbounds %struct.Reg, %struct.Reg* %4, i32 0, i32 0
