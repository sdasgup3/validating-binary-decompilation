...
define %struct.Memory* @_ZN18custom_variable_orIlE8do_shiftEll(%struct.State* noalias, i64, %struct.Memory* noalias) #2 {
entry:
  ...
  store %struct.Memory* %loadMem_40e210, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_40e211, %struct.Memory** %MEMORY
  %loadMem_40e214 = load %struct.Memory*, %struct.Memory** %MEMORY
  ...
  store i64 %40, i64* %43
  store %struct.Memory* %loadMem_40e214, %struct.Memory** %MEMORY
  ...
  store i64 %55, i64* %58
  store %struct.Memory* %loadMem_40e218, %struct.Memory** %MEMORY
  %loadMem_40e21c = load %struct.Memory*, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_40e21c, %struct.Memory** %MEMORY
  %loadMem_40e220 = load %struct.Memory*, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_40e220, %struct.Memory** %MEMORY
  %loadMem_40e224 = load %struct.Memory*, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_40e224, %struct.Memory** %MEMORY
  %loadMem_40e227 = load %struct.Memory*, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_40e227, %struct.Memory** %MEMORY
  %loadMem_40e228 = load %struct.Memory*, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_40e228, %struct.Memory** %MEMORY
  ret %struct.Memory* %loadMem_40e228
}
...
define %struct.Memory* @routine_orq_MINUS0x10__rbp____rsi(%struct.State* dereferenceable(3376), i64, %struct.Memory*) {
block_400478:
  %3 = getelementptr inbounds %struct.State, %struct.State* %0, i32 0, i32 6
  %4 = getelementptr inbounds %struct.GPR, %struct.GPR* %3, i32 0, i32 33
  %5 = getelementptr inbounds %struct.Reg, %struct.Reg* %4, i32 0, i32 0
