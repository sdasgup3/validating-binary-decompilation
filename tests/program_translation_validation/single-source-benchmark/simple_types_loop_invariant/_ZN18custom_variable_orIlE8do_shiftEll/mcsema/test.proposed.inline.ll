...
entry:
  ...
  %loadMem_40e251 = load %struct.Memory*, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_40e251, %struct.Memory** %MEMORY
  ...
  %loadMem_40e25c = load %struct.Memory*, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_40e25c, %struct.Memory** %MEMORY
  %loadMem_40e260 = load %struct.Memory*, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_40e260, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_40e264, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_40e267, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_40e268, %struct.Memory** %MEMORY
  ret %struct.Memory* %loadMem_40e268
}
