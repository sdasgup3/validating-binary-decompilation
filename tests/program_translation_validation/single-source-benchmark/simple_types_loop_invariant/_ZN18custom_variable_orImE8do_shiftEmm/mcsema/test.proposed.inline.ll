...
define %struct.Memory* @_ZN18custom_variable_orImE8do_shiftEmm(%struct.State* noalias, i64, %struct.Memory* noalias) #1 {
entry:
  ...
  store %struct.Memory* %loadMem_40d36c, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_40d378, %struct.Memory** %MEMORY
  ret %struct.Memory* %loadMem_40d378
}
