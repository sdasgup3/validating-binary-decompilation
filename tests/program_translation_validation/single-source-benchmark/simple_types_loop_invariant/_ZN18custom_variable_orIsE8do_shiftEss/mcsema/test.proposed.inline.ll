...
define %struct.Memory* @_ZN18custom_variable_orIsE8do_shiftEss(%struct.State* noalias, i64, %struct.Memory* noalias) #1 {
entry:
  ...
  store %struct.Memory* %loadMem_41148f, %struct.Memory** %MEMORY
  ...
  ret %struct.Memory* %loadMem_411491
}
