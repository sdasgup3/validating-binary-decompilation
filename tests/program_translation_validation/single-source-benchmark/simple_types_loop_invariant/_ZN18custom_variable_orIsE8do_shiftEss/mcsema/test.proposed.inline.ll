...
define %struct.Memory* @_ZN18custom_variable_orIsE8do_shiftEss(%struct.State* noalias, i64, %struct.Memory* noalias) #2 {
entry:
  ...
  store %struct.Memory* %loadMem_411480, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_41149a, %struct.Memory** %MEMORY
  ...
  %AX.i = bitcast %union.anon* %158 to i16*
  %159 = getelementptr inbounds %struct.State, %struct.State* %0, i32 0, i32 6
  %160 = getelementptr inbounds %struct.GPR, %struct.GPR* %159, i32 0, i32 9
  %161 = getelementptr inbounds %struct.Reg, %struct.Reg* %160, i32 0, i32 0
  %SI.i = bitcast %union.anon* %161 to i16*
  %162 = load i16, i16* %SI.i
  %163 = zext i16 %162 to i64
  %164 = load i64, i64* %PC.i5
  %165 = add i64 %164, 3
  store i64 %165, i64* %PC.i5
  store i16 %162, i16* %AX.i, align 2
  ...
  %169 = load i64, i64* %PC.i4
  %170 = add i64 %169, 1
  store i64 %170, i64* %PC.i4
  ...
  store i64 %189, i64* %RBP.i3, align 8
  ...
  %PC.i1 = bitcast %union.anon* %192 to i64*
  %193 = load i64, i64* %PC.i1
  %194 = add i64 %193, 1
  store i64 %194, i64* %PC.i1
  ...
  ret %struct.Memory* %loadMem_4114a1
}
...
define %struct.Memory* @routine_orl__edi___esi(%struct.State* dereferenceable(3376), i64, %struct.Memory*) {
block_400488:
  %3 = getelementptr inbounds %struct.State, %struct.State* %0, i32 0, i32 6
  %4 = getelementptr inbounds %struct.GPR, %struct.GPR* %3, i32 0, i32 33
  %5 = getelementptr inbounds %struct.Reg, %struct.Reg* %4, i32 0, i32 0
