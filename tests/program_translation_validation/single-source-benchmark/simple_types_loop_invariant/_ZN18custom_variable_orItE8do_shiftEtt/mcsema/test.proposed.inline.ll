...
define %struct.Memory* @_ZN18custom_variable_orItE8do_shiftEtt(%struct.State* noalias, i64, %struct.Memory* noalias) #2 {
entry:
  ...
  store i16 %66, i16* %70
  store %struct.Memory* %loadMem_41049a, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_4104a2, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_4104aa, %struct.Memory** %MEMORY
  ...
  ret %struct.Memory* %loadMem_4104b3
}
