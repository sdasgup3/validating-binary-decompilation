...
entry:
  ...
  %loadMem_413da1 = load %struct.Memory*, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_413da1, %struct.Memory** %MEMORY
  %loadMem_413da4 = load %struct.Memory*, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_413da4, %struct.Memory** %MEMORY
  ...
  %loadMem_413dc1 = load %struct.Memory*, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_413dc1, %struct.Memory** %MEMORY
  ret %struct.Memory* %loadMem_413dc1
}
