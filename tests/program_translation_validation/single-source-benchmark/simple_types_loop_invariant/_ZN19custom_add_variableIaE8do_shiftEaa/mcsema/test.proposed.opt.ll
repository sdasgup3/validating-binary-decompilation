...
define %struct.Memory* @_ZN19custom_add_variableIaE8do_shiftEaa(%struct.State* noalias, i64, %struct.Memory* noalias) local_unnamed_addr #1 {
entry:
  ...
  store i64 %44, i64* %RSI.i11, align 8
  %45 = icmp ult i32 %43, %42
  %46 = icmp ult i32 %43, %40
  %47 = or i1 %45, %46
  %48 = zext i1 %47 to i8
...
define %struct.Memory* @routine_movsbl_MINUS0x2__rbp____edi(%struct.State* dereferenceable(3376), i64, %struct.Memory*) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
...
define %struct.Memory* @routine_addl__edi___esi(%struct.State* dereferenceable(3376), i64, %struct.Memory*) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
