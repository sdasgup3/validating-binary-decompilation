...
define %struct.Memory* @_ZN19custom_add_variableIdE8do_shiftEdd(%struct.State* noalias, i64, %struct.Memory* noalias) #2 {
entry:
  ...
  store %struct.Memory* %loadMem_40c779, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_40c77e, %struct.Memory** %MEMORY
  ...
  ret %struct.Memory* %loadMem_40c789
}
