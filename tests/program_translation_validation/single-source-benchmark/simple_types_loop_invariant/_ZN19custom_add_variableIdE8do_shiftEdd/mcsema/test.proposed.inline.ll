...
define %struct.Memory* @_ZN19custom_add_variableIdE8do_shiftEdd(%struct.State* noalias, i64, %struct.Memory* noalias) #1 {
entry:
  ...
  store %struct.Memory* %loadMem_40c7b3, %struct.Memory** %MEMORY
  ...
  ret %struct.Memory* %loadMem_40c7b9
}
