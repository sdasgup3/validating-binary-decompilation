...
define %struct.Memory* @_ZN19custom_add_variableIfE8do_shiftEff(%struct.State* noalias, i64, %struct.Memory* noalias) #2 {
entry:
  ...
  %loadMem_40d069 = load %struct.Memory*, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_40d069, %struct.Memory** %MEMORY
  ...
  %loadMem_40d079 = load %struct.Memory*, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_40d079, %struct.Memory** %MEMORY
  ret %struct.Memory* %loadMem_40d079
}
