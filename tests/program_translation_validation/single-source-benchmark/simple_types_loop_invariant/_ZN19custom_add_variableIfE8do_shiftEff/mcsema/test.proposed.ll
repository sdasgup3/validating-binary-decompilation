...
define %struct.Memory* @_ZN19custom_add_variableIfE8do_shiftEff(%struct.State* noalias , i64, %struct.Memory* noalias) alwaysinline  {
entry:
  ...
  ; Code: ._ZN19custom_add_variableIfE8do_shiftEff:	 RIP: 40d060	 Bytes: 0
  ...
  ; Code: movss %xmm0, -0x4(%rbp)	 RIP: 40d064	 Bytes: 5
  %loadMem_40d064 = load %struct.Memory*, %struct.Memory** %MEMORY
  %call_40d064 = call %struct.Memory* @routine_movss__xmm0__MINUS0x4__rbp_(%struct.State* %0, i64  0, %struct.Memory* %loadMem_40d064)
  store %struct.Memory* %call_40d064, %struct.Memory** %MEMORY

  ; Code: movss %xmm1, -0x8(%rbp)	 RIP: 40d069	 Bytes: 5
  %loadMem_40d069 = load %struct.Memory*, %struct.Memory** %MEMORY
  %call_40d069 = call %struct.Memory* @routine_movss__xmm1__MINUS0x8__rbp_(%struct.State* %0, i64  0, %struct.Memory* %loadMem_40d069)
  store %struct.Memory* %call_40d069, %struct.Memory** %MEMORY

  ; Code: movss -0x4(%rbp), %xmm0	 RIP: 40d06e	 Bytes: 5
  %loadMem_40d06e = load %struct.Memory*, %struct.Memory** %MEMORY
  %call_40d06e = call %struct.Memory* @routine_movss_MINUS0x4__rbp____xmm0(%struct.State* %0, i64  0, %struct.Memory* %loadMem_40d06e)
  store %struct.Memory* %call_40d06e, %struct.Memory** %MEMORY

  ; Code: addss -0x8(%rbp), %xmm0	 RIP: 40d073	 Bytes: 5
  %loadMem_40d073 = load %struct.Memory*, %struct.Memory** %MEMORY
  %call_40d073 = call %struct.Memory* @routine_addss_MINUS0x8__rbp____xmm0(%struct.State* %0, i64  0, %struct.Memory* %loadMem_40d073)
  store %struct.Memory* %call_40d073, %struct.Memory** %MEMORY

  ; Code: popq %rbp	 RIP: 40d078	 Bytes: 1
  %loadMem_40d078 = load %struct.Memory*, %struct.Memory** %MEMORY
  %call_40d078 = call %struct.Memory* @routine_popq__rbp(%struct.State* %0, i64  0, %struct.Memory* %loadMem_40d078)
  store %struct.Memory* %call_40d078, %struct.Memory** %MEMORY

  ; Code: retq	 RIP: 40d079	 Bytes: 1
  %loadMem_40d079 = load %struct.Memory*, %struct.Memory** %MEMORY
  %call_40d079 = call %struct.Memory* @routine_retq(%struct.State* %0, i64  0, %struct.Memory* %loadMem_40d079)
  store %struct.Memory* %call_40d079, %struct.Memory** %MEMORY

  ret %struct.Memory* %call_40d079
}
