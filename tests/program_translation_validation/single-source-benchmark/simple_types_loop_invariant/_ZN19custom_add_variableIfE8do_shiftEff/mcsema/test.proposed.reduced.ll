; ModuleID = '/tmp/tmpkq34024y-query.ll'
...
define %struct.Memory* @_ZN19custom_add_variableIfE8do_shiftEff(%struct.State* noalias nocapture, i64, %struct.Memory* noalias readnone returned) local_unnamed_addr #0 {
entry:
...
; Matched:%var_2_49:  %var_2_49 = fadd float %var_2_48, %var_2_47
; %var_2_50 = fadd float %var_2_49, %var_2_48
