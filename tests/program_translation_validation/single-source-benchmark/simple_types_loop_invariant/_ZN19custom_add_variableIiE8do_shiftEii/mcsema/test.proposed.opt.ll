...
define %struct.Memory* @_ZN19custom_add_variableIiE8do_shiftEii(%struct.State* noalias nocapture, i64, %struct.Memory* noalias readnone returned) local_unnamed_addr #1 {
entry:
