...
define %struct.Memory* @_ZN19custom_add_variableIjE8do_shiftEjj(%struct.State* noalias, i64, %struct.Memory* noalias) #1 {
entry:
  ...
  %loadMem_40f6a1 = load %struct.Memory*, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_40f6a1, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_40f6aa, %struct.Memory** %MEMORY
  %loadMem_40f6ad = load %struct.Memory*, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_40f6ad, %struct.Memory** %MEMORY
  ...
  %RAX.i = bitcast %union.anon* %135 to i64*
  ...
  store i64 %140, i64* %RAX.i, align 8
  store %struct.Memory* %loadMem_40f6b0, %struct.Memory** %MEMORY
  %loadMem_40f6b2 = load %struct.Memory*, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_40f6b2, %struct.Memory** %MEMORY
  ...
  ret %struct.Memory* %loadMem_40f6b3
}
