...
entry:
  ...
  %loadMem_40f6ba = load %struct.Memory*, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_40f6ba, %struct.Memory** %MEMORY
  ...
  %loadMem_40f6c3 = load %struct.Memory*, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_40f6c3, %struct.Memory** %MEMORY
  ret %struct.Memory* %loadMem_40f6c3
}
