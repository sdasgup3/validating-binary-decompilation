...
define %struct.Memory* @_ZN19custom_add_variableIlE8do_shiftEll(%struct.State* noalias, i64, %struct.Memory* noalias) #1 {
entry:
  ...
  store %struct.Memory* %loadMem_40eb8c, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_40eb97, %struct.Memory** %MEMORY
  ...
  ret %struct.Memory* %loadMem_40eb98
}
