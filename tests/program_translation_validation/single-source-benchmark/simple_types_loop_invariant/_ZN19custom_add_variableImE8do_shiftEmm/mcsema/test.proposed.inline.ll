...
entry:
  ...
  store %struct.Memory* %loadMem_40dfc0, %struct.Memory** %MEMORY
  %loadMem_40dfc4 = load %struct.Memory*, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_40dfc4, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_40dfc7, %struct.Memory** %MEMORY
  ...
  ret %struct.Memory* %loadMem_40dfc8
}
