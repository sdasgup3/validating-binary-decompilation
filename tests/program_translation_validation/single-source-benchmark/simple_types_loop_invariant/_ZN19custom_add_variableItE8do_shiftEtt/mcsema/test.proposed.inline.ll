...
entry:
  ...
  store %struct.Memory* %loadMem_4110c0, %struct.Memory** %MEMORY
  ...
  %loadMem_4110ce = load %struct.Memory*, %struct.Memory** %MEMORY
  ...
  store i16 %82, i16* %86
  store %struct.Memory* %loadMem_4110ce, %struct.Memory** %MEMORY
  ...
  ret %struct.Memory* %loadMem_4110e3
}
