...
define %struct.Memory* @_ZN19custom_sub_variableIaE8do_shiftEaa(%struct.State* noalias, i64, %struct.Memory* noalias) #2 {
entry:
  ...
  store %struct.Memory* %loadMem_413b70, %struct.Memory** %MEMORY
  ...
  store i8 %71, i8* %75
  store %struct.Memory* %loadMem_413b7a, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_413b8a, %struct.Memory** %MEMORY
  ...
  ret %struct.Memory* %loadMem_413b91
}
