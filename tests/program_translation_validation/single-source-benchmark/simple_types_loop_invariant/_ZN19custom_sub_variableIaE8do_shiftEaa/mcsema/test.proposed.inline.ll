...
define %struct.Memory* @_ZN19custom_sub_variableIaE8do_shiftEaa(%struct.State* noalias, i64, %struct.Memory* noalias) #1 {
entry:
  ...
  store i8 %71, i8* %75
  store %struct.Memory* %loadMem_413baa, %struct.Memory** %MEMORY
  ...
  ret %struct.Memory* %loadMem_413bc1
}
