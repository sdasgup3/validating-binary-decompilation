...
define %struct.Memory* @_ZN19custom_sub_variableIaE8do_shiftEaa(%struct.State* noalias, i64, %struct.Memory* noalias readnone returned) local_unnamed_addr #1 {
entry:
