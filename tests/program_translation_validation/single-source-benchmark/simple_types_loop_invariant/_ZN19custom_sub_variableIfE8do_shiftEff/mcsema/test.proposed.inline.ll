...
define %struct.Memory* @_ZN19custom_sub_variableIfE8do_shiftEff(%struct.State* noalias, i64, %struct.Memory* noalias) #1 {
entry:
  ...
  %loadMem_40ce80 = load %struct.Memory*, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_40ce80, %struct.Memory** %MEMORY
  ...
  %RBP.i12 = bitcast %union.anon* %34 to i64*
  ...
  %37 = load i64, i64* %RBP.i12
  %38 = sub i64 %37, 4
  %39 = bitcast %union.vec128_t* %XMM0.i to i8*
  %40 = load i64, i64* %PC.i11
  %41 = add i64 %40, 5
  store i64 %41, i64* %PC.i11
  ...
  %loadMem_40ce89 = load %struct.Memory*, %struct.Memory** %MEMORY
  ...
  %PC.i9 = bitcast %union.anon* %48 to i64*
  ...
  %RBP.i10 = bitcast %union.anon* %51 to i64*
  ...
  %XMM1.i = bitcast %union.VectorReg* %53 to %union.vec128_t*
  %54 = load i64, i64* %RBP.i10
  %55 = sub i64 %54, 8
  %56 = bitcast %union.vec128_t* %XMM1.i to i8*
  %57 = load i64, i64* %PC.i9
  %58 = add i64 %57, 5
  store i64 %58, i64* %PC.i9
  ...
  store %struct.Memory* %loadMem_40ce89, %struct.Memory** %MEMORY
  %loadMem_40ce8e = load %struct.Memory*, %struct.Memory** %MEMORY
  ...
  %PC.i6 = bitcast %union.anon* %65 to i64*
  ...
  %RBP.i7 = bitcast %union.anon* %68 to i64*
  ...
  %YMM0.i8 = bitcast %union.VectorReg* %70 to %"class.std::bitset"*
  %71 = bitcast %"class.std::bitset"* %YMM0.i8 to i8*
  %72 = load i64, i64* %RBP.i7
  %73 = sub i64 %72, 4
  %74 = load i64, i64* %PC.i6
  %75 = add i64 %74, 5
  store i64 %75, i64* %PC.i6
  ...
  store %struct.Memory* %loadMem_40ce8e, %struct.Memory** %MEMORY
  ...
  %RBP.i5 = bitcast %union.anon* %90 to i64*
  ...
  %104 = inttoptr i64 %96 to float*
  %105 = load float, float* %104
  %106 = extractelement <2 x float> %100, i32 0
  %107 = fsub float %106, %105
  %108 = bitcast i8* %93 to float*
  store float %107, float* %108, align 1
  %109 = bitcast <2 x float> %100 to <2 x i32>
  %110 = extractelement <2 x i32> %109, i32 1
  %111 = getelementptr inbounds i8, i8* %93, i64 4
  %112 = bitcast i8* %111 to i32*
  store i32 %110, i32* %112, align 1
  %113 = extractelement <2 x i32> %103, i32 0
  %114 = getelementptr inbounds i8, i8* %93, i64 8
  %115 = bitcast i8* %114 to i32*
  store i32 %113, i32* %115, align 1
  %116 = extractelement <2 x i32> %103, i32 1
  %117 = getelementptr inbounds i8, i8* %93, i64 12
  %118 = bitcast i8* %117 to i32*
  store i32 %116, i32* %118, align 1
  store %struct.Memory* %loadMem_40ce93, %struct.Memory** %MEMORY
  %loadMem_40ce98 = load %struct.Memory*, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_40ce98, %struct.Memory** %MEMORY
  ...
  ret %struct.Memory* %loadMem_40ce99
}
...
define %struct.Memory* @routine_subss_MINUS0x8__rbp____xmm0(%struct.State* dereferenceable(3376), i64, %struct.Memory*) {
block_400488:
  %3 = getelementptr inbounds %struct.State, %struct.State* %0, i32 0, i32 6
  %4 = getelementptr inbounds %struct.GPR, %struct.GPR* %3, i32 0, i32 33
  %5 = getelementptr inbounds %struct.Reg, %struct.Reg* %4, i32 0, i32 0
