...
entry:
  ...
  ; Code: ._ZN19custom_sub_variableIfE8do_shiftEff:	 RIP: 40ce50	 Bytes: 0
  ...
  ; Code: movss %xmm0, -0x4(%rbp)	 RIP: 40ce54	 Bytes: 5
  %loadMem_40ce54 = load %struct.Memory*, %struct.Memory** %MEMORY
  %call_40ce54 = call %struct.Memory* @routine_movss__xmm0__MINUS0x4__rbp_(%struct.State* %0, i64  0, %struct.Memory* %loadMem_40ce54)
  store %struct.Memory* %call_40ce54, %struct.Memory** %MEMORY

  ; Code: movss %xmm1, -0x8(%rbp)	 RIP: 40ce59	 Bytes: 5
  %loadMem_40ce59 = load %struct.Memory*, %struct.Memory** %MEMORY
  %call_40ce59 = call %struct.Memory* @routine_movss__xmm1__MINUS0x8__rbp_(%struct.State* %0, i64  0, %struct.Memory* %loadMem_40ce59)
  store %struct.Memory* %call_40ce59, %struct.Memory** %MEMORY

  ; Code: movss -0x4(%rbp), %xmm0	 RIP: 40ce5e	 Bytes: 5
  %loadMem_40ce5e = load %struct.Memory*, %struct.Memory** %MEMORY
  %call_40ce5e = call %struct.Memory* @routine_movss_MINUS0x4__rbp____xmm0(%struct.State* %0, i64  0, %struct.Memory* %loadMem_40ce5e)
  store %struct.Memory* %call_40ce5e, %struct.Memory** %MEMORY

  ; Code: subss -0x8(%rbp), %xmm0	 RIP: 40ce63	 Bytes: 5
  %loadMem_40ce63 = load %struct.Memory*, %struct.Memory** %MEMORY
  %call_40ce63 = call %struct.Memory* @routine_subss_MINUS0x8__rbp____xmm0(%struct.State* %0, i64  0, %struct.Memory* %loadMem_40ce63)
  store %struct.Memory* %call_40ce63, %struct.Memory** %MEMORY

  ; Code: popq %rbp	 RIP: 40ce68	 Bytes: 1
  %loadMem_40ce68 = load %struct.Memory*, %struct.Memory** %MEMORY
  %call_40ce68 = call %struct.Memory* @routine_popq__rbp(%struct.State* %0, i64  0, %struct.Memory* %loadMem_40ce68)
  store %struct.Memory* %call_40ce68, %struct.Memory** %MEMORY

  ; Code: retq	 RIP: 40ce69	 Bytes: 1
  %loadMem_40ce69 = load %struct.Memory*, %struct.Memory** %MEMORY
  %call_40ce69 = call %struct.Memory* @routine_retq(%struct.State* %0, i64  0, %struct.Memory* %loadMem_40ce69)
  store %struct.Memory* %call_40ce69, %struct.Memory** %MEMORY

  ret %struct.Memory* %call_40ce69
}
