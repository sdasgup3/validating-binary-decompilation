...
entry:
  ...
  %loadMem_412d87 = load %struct.Memory*, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_412d87, %struct.Memory** %MEMORY
  ...
  %loadMem_412d8d = load %struct.Memory*, %struct.Memory** %MEMORY
  ...
  store i8 %88, i8* %92
  store %struct.Memory* %loadMem_412d8d, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_412d90, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_412da0, %struct.Memory** %MEMORY
  ...
  ret %struct.Memory* %loadMem_412da1
}
