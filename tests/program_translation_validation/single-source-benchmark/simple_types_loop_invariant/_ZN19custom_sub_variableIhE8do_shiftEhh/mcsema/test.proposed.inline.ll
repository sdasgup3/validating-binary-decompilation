...
define %struct.Memory* @_ZN19custom_sub_variableIhE8do_shiftEhh(%struct.State* noalias, i64, %struct.Memory* noalias) #2 {
entry:
  ...
  store %struct.Memory* %loadMem_412d54, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_412d64, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_412d68, %struct.Memory** %MEMORY
  %loadMem_412d6a = load %struct.Memory*, %struct.Memory** %MEMORY
  ...
  %AL.i6 = getelementptr inbounds %struct.anon.2, %struct.anon.2* %178, i32 0, i32 0
  ...
  %SIL.i = getelementptr inbounds %struct.anon.2, %struct.anon.2* %182, i32 0, i32 0
  %183 = load i8, i8* %SIL.i
  %184 = zext i8 %183 to i64
  %185 = load i64, i64* %PC.i5
  %186 = add i64 %185, 3
  store i64 %186, i64* %PC.i5
  store i8 %183, i8* %AL.i6, align 1
  store %struct.Memory* %loadMem_412d6a, %struct.Memory** %MEMORY
  %loadMem_412d6d = load %struct.Memory*, %struct.Memory** %MEMORY
  ...
  %AL.i = getelementptr inbounds %struct.anon.2, %struct.anon.2* %193, i32 0, i32 0
  ...
  %201 = and i64 %198, 255
  store i64 %201, i64* %RAX.i, align 8
  store %struct.Memory* %loadMem_412d6d, %struct.Memory** %MEMORY
  %loadMem_412d70 = load %struct.Memory*, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_412d70, %struct.Memory** %MEMORY
  ...
  ret %struct.Memory* %loadMem_412d71
}
