...
define %struct.Memory* @_ZN19custom_sub_variableIiE8do_shiftEii(%struct.State* noalias, i64, %struct.Memory* noalias) #1 {
entry:
  ...
  store i32 %56, i32* %60
  store %struct.Memory* %loadMem_40ffa7, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_40ffad, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_40ffb3, %struct.Memory** %MEMORY
  ret %struct.Memory* %loadMem_40ffb3
}
