...
entry:
  ...
  %loadMem_40f4c0 = load %struct.Memory*, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_40f4c0, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_40f4ca, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_40f4d2, %struct.Memory** %MEMORY
  ...
  ret %struct.Memory* %loadMem_40f4d3
}
