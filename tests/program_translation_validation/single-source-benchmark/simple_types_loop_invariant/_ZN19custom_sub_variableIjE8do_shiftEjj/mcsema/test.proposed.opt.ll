...
define %struct.Memory* @_ZN19custom_sub_variableIjE8do_shiftEjj(%struct.State* noalias nocapture, i64, %struct.Memory* noalias readnone returned) local_unnamed_addr #1 {
entry:
