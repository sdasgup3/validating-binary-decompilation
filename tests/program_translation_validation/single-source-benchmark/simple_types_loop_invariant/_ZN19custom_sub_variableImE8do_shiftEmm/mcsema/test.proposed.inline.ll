...
define %struct.Memory* @_ZN19custom_sub_variableImE8do_shiftEmm(%struct.State* noalias, i64, %struct.Memory* noalias) #2 {
entry:
  ...
  store %struct.Memory* %loadMem_40dd50, %struct.Memory** %MEMORY
  ...
  store i64 %55, i64* %58
  store %struct.Memory* %loadMem_40dd58, %struct.Memory** %MEMORY
  ...
  ret %struct.Memory* %loadMem_40dd68
}
