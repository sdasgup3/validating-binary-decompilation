...
entry:
  ...
  %loadMem_411eee = load %struct.Memory*, %struct.Memory** %MEMORY
  ...
  store i16 %82, i16* %86
  store %struct.Memory* %loadMem_411eee, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_411f01, %struct.Memory** %MEMORY
  ret %struct.Memory* %loadMem_411f01
}
