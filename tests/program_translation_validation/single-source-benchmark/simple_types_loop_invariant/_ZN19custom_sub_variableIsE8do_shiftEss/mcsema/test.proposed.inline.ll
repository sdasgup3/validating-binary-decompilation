...
define %struct.Memory* @_ZN19custom_sub_variableIsE8do_shiftEss(%struct.State* noalias, i64, %struct.Memory* noalias) #2 {
entry:
  ...
  %AX.i = bitcast %union.anon* %173 to i16*
  ...
  store i16 %177, i16* %AX.i, align 2
  ...
  %187 = getelementptr inbounds %union.anon, %union.anon* %186, i64 0, i32 0
  %188 = bitcast %union.anon* %186 to i16*
  ...
  ret %struct.Memory* %loadMem_411f41
}
