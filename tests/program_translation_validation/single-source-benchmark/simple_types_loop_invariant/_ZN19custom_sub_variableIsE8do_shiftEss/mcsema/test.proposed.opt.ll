...
define %struct.Memory* @_ZN19custom_sub_variableIsE8do_shiftEss(%struct.State* noalias, i64, %struct.Memory* noalias readnone returned) local_unnamed_addr #1 {
entry:
  ...
  %76 = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 1, i32 0, i32 0
  %sext = shl i64 %75, 48
  %77 = ashr exact i64 %sext, 48
