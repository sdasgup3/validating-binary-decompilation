...
entry:
  ...
  %loadMem_410ec2 = load %struct.Memory*, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_410ec2, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_410ecf, %struct.Memory** %MEMORY
  ...
  ret %struct.Memory* %loadMem_410ed3
}
