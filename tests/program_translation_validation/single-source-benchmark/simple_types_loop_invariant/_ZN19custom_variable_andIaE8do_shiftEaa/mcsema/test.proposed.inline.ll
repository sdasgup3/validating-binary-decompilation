...
define %struct.Memory* @_ZN19custom_variable_andIaE8do_shiftEaa(%struct.State* noalias, i64, %struct.Memory* noalias) #1 {
entry:
  ...
  store %struct.Memory* %loadMem_413411, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_413417, %struct.Memory** %MEMORY
  ...
  ret %struct.Memory* %loadMem_413431
}
