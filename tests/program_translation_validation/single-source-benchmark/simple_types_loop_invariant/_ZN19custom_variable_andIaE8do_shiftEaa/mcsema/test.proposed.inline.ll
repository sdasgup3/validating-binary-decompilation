...
entry:
  ...
  store %struct.Memory* %loadMem_4133e0, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_4133e4, %struct.Memory** %MEMORY
  ...
  %loadMem_4133ea = load %struct.Memory*, %struct.Memory** %MEMORY
  ...
  store i8 %71, i8* %75
  store %struct.Memory* %loadMem_4133ea, %struct.Memory** %MEMORY
  ...
  %loadMem_4133f0 = load %struct.Memory*, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_4133f0, %struct.Memory** %MEMORY
  ...
  %loadMem_4133f8 = load %struct.Memory*, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_4133f8, %struct.Memory** %MEMORY
  ...
  ret %struct.Memory* %loadMem_413401
}
