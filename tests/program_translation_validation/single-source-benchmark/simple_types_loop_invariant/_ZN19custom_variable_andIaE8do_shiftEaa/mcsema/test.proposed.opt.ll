...
define %struct.Memory* @_ZN19custom_variable_andIaE8do_shiftEaa(%struct.State* noalias, i64, %struct.Memory* noalias readnone returned) local_unnamed_addr #1 {
entry:
