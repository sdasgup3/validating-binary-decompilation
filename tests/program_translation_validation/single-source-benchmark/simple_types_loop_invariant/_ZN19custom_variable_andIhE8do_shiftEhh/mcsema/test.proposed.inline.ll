...
define %struct.Memory* @_ZN19custom_variable_andIhE8do_shiftEhh(%struct.State* noalias, i64, %struct.Memory* noalias) #2 {
entry:
  ...
  store %struct.Memory* %loadMem_4125c0, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_4125dd, %struct.Memory** %MEMORY
  ...
  ret %struct.Memory* %loadMem_4125e1
}
