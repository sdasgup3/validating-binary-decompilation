...
define %struct.Memory* @_ZN19custom_variable_andIiE8do_shiftEii(%struct.State* noalias, i64, %struct.Memory* noalias) #1 {
entry:
  ...
  store %struct.Memory* %loadMem_40fa00, %struct.Memory** %MEMORY
  ...
  store i32 %40, i32* %44
  store %struct.Memory* %loadMem_40fa04, %struct.Memory** %MEMORY
  ...
  ret %struct.Memory* %loadMem_40fa13
}
