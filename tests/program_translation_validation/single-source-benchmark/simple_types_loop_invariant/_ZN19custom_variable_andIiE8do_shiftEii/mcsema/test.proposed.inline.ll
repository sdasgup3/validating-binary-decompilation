...
define %struct.Memory* @_ZN19custom_variable_andIiE8do_shiftEii(%struct.State* noalias, i64, %struct.Memory* noalias) #2 {
entry:
  ...
  store %struct.Memory* %loadMem_40f9d0, %struct.Memory** %MEMORY
  ...
  store i32 %40, i32* %44
  store %struct.Memory* %loadMem_40f9d4, %struct.Memory** %MEMORY
  ...
  store i32 %56, i32* %60
  store %struct.Memory* %loadMem_40f9d7, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_40f9da, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_40f9e2, %struct.Memory** %MEMORY
  ...
  ret %struct.Memory* %loadMem_40f9e3
}
...
define %struct.Memory* @routine_andl_MINUS0x8__rbp____esi(%struct.State* dereferenceable(3376), i64, %struct.Memory*) {
block_400478:
  %3 = getelementptr inbounds %struct.State, %struct.State* %0, i32 0, i32 6
  %4 = getelementptr inbounds %struct.GPR, %struct.GPR* %3, i32 0, i32 33
  %5 = getelementptr inbounds %struct.Reg, %struct.Reg* %4, i32 0, i32 0
