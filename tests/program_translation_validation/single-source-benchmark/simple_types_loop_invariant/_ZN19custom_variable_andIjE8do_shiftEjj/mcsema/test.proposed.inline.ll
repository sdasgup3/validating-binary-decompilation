...
define %struct.Memory* @_ZN19custom_variable_andIjE8do_shiftEjj(%struct.State* noalias, i64, %struct.Memory* noalias) #1 {
entry:
  ...
  store i32 %56, i32* %60
  store %struct.Memory* %loadMem_40ef07, %struct.Memory** %MEMORY
  ...
  ret %struct.Memory* %loadMem_40ef13
}
