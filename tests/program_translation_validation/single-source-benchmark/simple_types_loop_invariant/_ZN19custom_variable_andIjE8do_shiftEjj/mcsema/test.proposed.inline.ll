...
define %struct.Memory* @_ZN19custom_variable_andIjE8do_shiftEjj(%struct.State* noalias, i64, %struct.Memory* noalias) #2 {
entry:
  ...
  store i32 %56, i32* %60
  store %struct.Memory* %loadMem_40ef17, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_40ef1a, %struct.Memory** %MEMORY
  ...
  ret %struct.Memory* %loadMem_40ef23
}
