...
define %struct.Memory* @_ZN19custom_variable_andIlE8do_shiftEll(%struct.State* noalias, i64, %struct.Memory* noalias) #1 {
entry:
  ...
  store %struct.Memory* %loadMem_40e391, %struct.Memory** %MEMORY
  ...
  store i64 %40, i64* %43
  store %struct.Memory* %loadMem_40e394, %struct.Memory** %MEMORY
  ...
  store i64 %55, i64* %58
  store %struct.Memory* %loadMem_40e398, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_40e39c, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_40e3a7, %struct.Memory** %MEMORY
  ...
  ret %struct.Memory* %loadMem_40e3a8
}
