...
define %struct.Memory* @_ZN19custom_variable_andIlE8do_shiftEll(%struct.State* noalias, i64, %struct.Memory* noalias) #2 {
entry:
  ...
  store %struct.Memory* %loadMem_40e3a0, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_40e3a1, %struct.Memory** %MEMORY
  ...
  store i64 %40, i64* %43
  store %struct.Memory* %loadMem_40e3a4, %struct.Memory** %MEMORY
  ...
  store i64 %55, i64* %58
  store %struct.Memory* %loadMem_40e3a8, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_40e3ac, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_40e3b0, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_40e3b4, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_40e3b7, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_40e3b8, %struct.Memory** %MEMORY
  ret %struct.Memory* %loadMem_40e3b8
}
