...
define %struct.Memory* @_ZN19custom_variable_andImE8do_shiftEmm(%struct.State* noalias nocapture, i64, %struct.Memory* noalias readnone returned) local_unnamed_addr #1 {
entry:
