...
define %struct.Memory* @_ZN19custom_variable_andIsE8do_shiftEss(%struct.State* noalias, i64, %struct.Memory* noalias) #2 {
entry:
  ...
  store %struct.Memory* %loadMem_411666, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_41166a, %struct.Memory** %MEMORY
  ...
  ret %struct.Memory* %loadMem_411671
}
