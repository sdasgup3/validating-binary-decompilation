...
define %struct.Memory* @_ZN19custom_variable_xorIaE8do_shiftEaa(%struct.State* noalias, i64, %struct.Memory* noalias) #2 {
entry:
  ...
  store %struct.Memory* %loadMem_413118, %struct.Memory** %MEMORY
  ...
  ret %struct.Memory* %loadMem_413121
}
