...
define %struct.Memory* @_ZN19custom_variable_xorIhE8do_shiftEhh(%struct.State* noalias, i64, %struct.Memory* noalias) #1 {
entry:
  ...
  store %struct.Memory* %loadMem_4122e8, %struct.Memory** %MEMORY
  ...
  ret %struct.Memory* %loadMem_4122f1
}
