...
entry:
  ...
  store %struct.Memory* %loadMem_4122f4, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_4122fa, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_412300, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_412301, %struct.Memory** %MEMORY
  ret %struct.Memory* %loadMem_412301
}
