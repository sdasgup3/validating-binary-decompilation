...
define %struct.Memory* @_ZN19custom_variable_xorIjE8do_shiftEjj(%struct.State* noalias, i64, %struct.Memory* noalias) #1 {
entry:
  ...
  store %struct.Memory* %loadMem_40ec92, %struct.Memory** %MEMORY
  ...
  ret %struct.Memory* %loadMem_40ec93
}
