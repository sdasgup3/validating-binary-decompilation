...
entry:
  ...
  store %struct.Memory* %loadMem_40e0c0, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_40e0c1, %struct.Memory** %MEMORY
  ...
  store i64 %40, i64* %43
  store %struct.Memory* %loadMem_40e0c4, %struct.Memory** %MEMORY
  ...
  store i64 %55, i64* %58
  store %struct.Memory* %loadMem_40e0c8, %struct.Memory** %MEMORY
  %loadMem_40e0cc = load %struct.Memory*, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_40e0cc, %struct.Memory** %MEMORY
  %loadMem_40e0d0 = load %struct.Memory*, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_40e0d0, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_40e0d4, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_40e0d7, %struct.Memory** %MEMORY
  %loadMem_40e0d8 = load %struct.Memory*, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_40e0d8, %struct.Memory** %MEMORY
  ret %struct.Memory* %loadMem_40e0d8
}
