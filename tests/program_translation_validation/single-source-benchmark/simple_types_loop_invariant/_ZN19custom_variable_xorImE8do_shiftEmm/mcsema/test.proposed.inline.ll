...
define %struct.Memory* @_ZN19custom_variable_xorImE8do_shiftEmm(%struct.State* noalias, i64, %struct.Memory* noalias) #1 {
entry:
  ...
  store %struct.Memory* %loadMem_40d1a1, %struct.Memory** %MEMORY
  ...
  store i64 %40, i64* %43
  store %struct.Memory* %loadMem_40d1a4, %struct.Memory** %MEMORY
  ...
  ret %struct.Memory* %loadMem_40d1b8
}
