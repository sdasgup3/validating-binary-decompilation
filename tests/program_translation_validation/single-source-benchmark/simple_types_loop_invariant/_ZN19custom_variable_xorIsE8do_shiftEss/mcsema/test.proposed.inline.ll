...
entry:
  ...
  %loadMem_41127e = load %struct.Memory*, %struct.Memory** %MEMORY
  ...
  store i16 %82, i16* %86
  store %struct.Memory* %loadMem_41127e, %struct.Memory** %MEMORY
  %loadMem_411282 = load %struct.Memory*, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_411282, %struct.Memory** %MEMORY
