...
define %struct.Memory* @_ZN19custom_variable_xorItE8do_shiftEtt(%struct.State* noalias, i64, %struct.Memory* noalias) #1 {
entry:
  ...
  store i16 %66, i16* %70
  store %struct.Memory* %loadMem_4102ca, %struct.Memory** %MEMORY
  ...
  %loadMem_4102da = load %struct.Memory*, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_4102da, %struct.Memory** %MEMORY
  ...
  %loadMem_4102e2 = load %struct.Memory*, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_4102e2, %struct.Memory** %MEMORY
  ...
  ret %struct.Memory* %loadMem_4102e3
}
