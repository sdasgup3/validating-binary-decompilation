...
; <label>:164:                                    ; preds = %entry
  ...
  %167 = call %struct.Memory* @__remill_error(%struct.State* nonnull dereferenceable(3376) %0, i64 %166, %struct.Memory* %loadMem_4137a9)
...
routine_idivl__esi.exit:                          ; preds = %164, %168
  %180 = phi %struct.Memory* [ %167, %164 ], [ %loadMem_4137a9, %168 ]
  ...
  ret %struct.Memory* %loadMem_4137b1
}
