...
entry:
  ...
  store i8 %71, i8* %75
  store %struct.Memory* %loadMem_4137aa, %struct.Memory** %MEMORY
...
; <label>:164:                                    ; preds = %entry
  ...
  %167 = call %struct.Memory* @__remill_error(%struct.State* nonnull dereferenceable(3376) %0, i64 %166, %struct.Memory* %loadMem_4137b9)
...
routine_idivl__esi.exit:                          ; preds = %164, %168
  %180 = phi %struct.Memory* [ %167, %164 ], [ %loadMem_4137b9, %168 ]
  ...
  ret %struct.Memory* %loadMem_4137c1
}
