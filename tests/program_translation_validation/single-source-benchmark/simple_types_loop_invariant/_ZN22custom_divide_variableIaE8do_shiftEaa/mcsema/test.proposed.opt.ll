...
routine_idivl__esi.exit:                          ; preds = %55, %53
  ...
  %68 = phi i8 [ %.pre, %53 ], [ %66, %55 ]
  %69 = phi %struct.Memory* [ %54, %53 ], [ %2, %55 ]
  store i8 %68, i8* %CL.i23, align 1
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_movsbl_MINUS0x2__rbp____esi(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned) local_unnamed_addr #1 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
