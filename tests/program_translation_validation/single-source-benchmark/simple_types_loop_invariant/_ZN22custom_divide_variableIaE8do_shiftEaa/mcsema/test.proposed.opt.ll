...
define %struct.Memory* @_ZN22custom_divide_variableIaE8do_shiftEaa(%struct.State* noalias, i64, %struct.Memory* noalias) local_unnamed_addr #0 {
entry:
