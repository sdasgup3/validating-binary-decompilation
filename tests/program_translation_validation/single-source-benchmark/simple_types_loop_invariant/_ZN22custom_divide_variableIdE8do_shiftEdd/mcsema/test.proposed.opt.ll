...
define %struct.Memory* @_ZN22custom_divide_variableIdE8do_shiftEdd(%struct.State* noalias nocapture, i64, %struct.Memory* noalias readnone returned) local_unnamed_addr #0 {
entry:
