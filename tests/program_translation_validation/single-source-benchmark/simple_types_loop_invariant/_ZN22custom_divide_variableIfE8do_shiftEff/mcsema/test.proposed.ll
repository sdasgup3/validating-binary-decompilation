...
entry:
  ...
  ; Code: ._ZN22custom_divide_variableIfE8do_shiftEff:	 RIP: 40cac0	 Bytes: 0
  ; Code: pushq %rbp	 RIP: 40cac0	 Bytes: 1
  %loadMem_40cac0 = load %struct.Memory*, %struct.Memory** %MEMORY
  %call_40cac0 = call %struct.Memory* @routine_pushq__rbp(%struct.State* %0, i64  0, %struct.Memory* %loadMem_40cac0)
  store %struct.Memory* %call_40cac0, %struct.Memory** %MEMORY

  ; Code: movq %rsp, %rbp	 RIP: 40cac1	 Bytes: 3
  %loadMem_40cac1 = load %struct.Memory*, %struct.Memory** %MEMORY
  %call_40cac1 = call %struct.Memory* @routine_movq__rsp___rbp(%struct.State* %0, i64  0, %struct.Memory* %loadMem_40cac1)
  store %struct.Memory* %call_40cac1, %struct.Memory** %MEMORY

  ; Code: movss %xmm0, -0x4(%rbp)	 RIP: 40cac4	 Bytes: 5
  %loadMem_40cac4 = load %struct.Memory*, %struct.Memory** %MEMORY
  %call_40cac4 = call %struct.Memory* @routine_movss__xmm0__MINUS0x4__rbp_(%struct.State* %0, i64  0, %struct.Memory* %loadMem_40cac4)
  store %struct.Memory* %call_40cac4, %struct.Memory** %MEMORY

  ; Code: movss %xmm1, -0x8(%rbp)	 RIP: 40cac9	 Bytes: 5
  %loadMem_40cac9 = load %struct.Memory*, %struct.Memory** %MEMORY
  %call_40cac9 = call %struct.Memory* @routine_movss__xmm1__MINUS0x8__rbp_(%struct.State* %0, i64  0, %struct.Memory* %loadMem_40cac9)
  store %struct.Memory* %call_40cac9, %struct.Memory** %MEMORY

  ; Code: movss -0x4(%rbp), %xmm0	 RIP: 40cace	 Bytes: 5
  %loadMem_40cace = load %struct.Memory*, %struct.Memory** %MEMORY
  %call_40cace = call %struct.Memory* @routine_movss_MINUS0x4__rbp____xmm0(%struct.State* %0, i64  0, %struct.Memory* %loadMem_40cace)
  store %struct.Memory* %call_40cace, %struct.Memory** %MEMORY

  ; Code: divss -0x8(%rbp), %xmm0	 RIP: 40cad3	 Bytes: 5
  %loadMem_40cad3 = load %struct.Memory*, %struct.Memory** %MEMORY
  %call_40cad3 = call %struct.Memory* @routine_divss_MINUS0x8__rbp____xmm0(%struct.State* %0, i64  0, %struct.Memory* %loadMem_40cad3)
  store %struct.Memory* %call_40cad3, %struct.Memory** %MEMORY

  ; Code: popq %rbp	 RIP: 40cad8	 Bytes: 1
  %loadMem_40cad8 = load %struct.Memory*, %struct.Memory** %MEMORY
  %call_40cad8 = call %struct.Memory* @routine_popq__rbp(%struct.State* %0, i64  0, %struct.Memory* %loadMem_40cad8)
  store %struct.Memory* %call_40cad8, %struct.Memory** %MEMORY

  ; Code: retq	 RIP: 40cad9	 Bytes: 1
  %loadMem_40cad9 = load %struct.Memory*, %struct.Memory** %MEMORY
  %call_40cad9 = call %struct.Memory* @routine_retq(%struct.State* %0, i64  0, %struct.Memory* %loadMem_40cad9)
  store %struct.Memory* %call_40cad9, %struct.Memory** %MEMORY

  ret %struct.Memory* %call_40cad9
}
