; ModuleID = '/tmp/tmppwitoymp-query.ll'
...
define %struct.Memory* @_ZN22custom_divide_variableIfE8do_shiftEff(%struct.State* noalias nocapture, i64, %struct.Memory* noalias readnone returned) local_unnamed_addr #0 {
entry:
...
; Matched:%var_2_49:  %var_2_49 = fdiv float %var_2_48, %var_2_47
; %var_2_50 = fdiv float %var_2_49, %var_2_48
