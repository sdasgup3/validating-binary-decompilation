...
define %struct.Memory* @_ZN22custom_divide_variableIjE8do_shiftEjj(%struct.State* noalias, i64, %struct.Memory* noalias) #2 {
entry:
  ...
  store %struct.Memory* %loadMem_40f190, %struct.Memory** %MEMORY
  ...
  store i64 %93, i64* %RDX.i, align 8
  ...
  %PC.i4 = bitcast %union.anon* %111 to i64*
  %112 = getelementptr inbounds %struct.State, %struct.State* %0, i32 0, i32 6
  %113 = getelementptr inbounds %struct.GPR, %struct.GPR* %112, i32 0, i32 15
  %114 = getelementptr inbounds %struct.Reg, %struct.Reg* %113, i32 0, i32 0
  %RBP.i5 = bitcast %union.anon* %114 to i64*
  %115 = load i64, i64* %RBP.i5
  %116 = sub i64 %115, 8
...
; <label>:135:                                    ; preds = %entry
  ...
  %138 = call %struct.Memory* @__remill_error(%struct.State* nonnull dereferenceable(3376) %0, i64 %137, %struct.Memory* %loadMem_40f19f)
  br label %routine_divl_MINUS0x8__rbp_.exit

; <label>:139:                                    ; preds = %entry
  %140 = urem i64 %131, %129
  %141 = getelementptr inbounds %union.anon, %union.anon* %119, i64 0, i32 0
  store i64 %132, i64* %141, align 8
  %142 = getelementptr inbounds %union.anon, %union.anon* %123, i64 0, i32 0
...
routine_divl_MINUS0x8__rbp_.exit:                 ; preds = %135, %139
  %149 = phi %struct.Memory* [ %138, %135 ], [ %loadMem_40f19f, %139 ]
  ...
  store %struct.Memory* %loadMem_40f1a2, %struct.Memory** %MEMORY
  ...
  ret %struct.Memory* %loadMem_40f1a3
}
