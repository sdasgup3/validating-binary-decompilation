...
define %struct.Memory* @_ZN22custom_divide_variableImE8do_shiftEmm(%struct.State* noalias, i64, %struct.Memory* noalias) local_unnamed_addr #0 {
routine_divq_MINUS0x10__rbp_.exit:
  ...
  store i64 %37, i64* %RDX.i, align 8
  store i8 0, i8* %27, align 1
