...
entry:
  ...
  %loadMem_4109f0 = load %struct.Memory*, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_4109f0, %struct.Memory** %MEMORY
...
; <label>:156:                                    ; preds = %entry
  ...
  %159 = call %struct.Memory* @__remill_error(%struct.State* nonnull dereferenceable(3376) %0, i64 %158, %struct.Memory* %loadMem_410a0b)
...
routine_idivl__esi.exit:                          ; preds = %156, %160
  %172 = phi %struct.Memory* [ %159, %156 ], [ %loadMem_410a0b, %160 ]
  ...
  store %struct.Memory* %loadMem_410a0d, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_410a10, %struct.Memory** %MEMORY
  ...
  ret %struct.Memory* %loadMem_410a14
}
