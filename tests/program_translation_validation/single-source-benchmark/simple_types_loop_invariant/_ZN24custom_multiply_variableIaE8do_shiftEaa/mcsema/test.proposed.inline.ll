...
define %struct.Memory* @_ZN24custom_multiply_variableIaE8do_shiftEaa(%struct.State* noalias, i64, %struct.Memory* noalias) #2 {
entry:
  ...
  %loadMem_413a2a = load %struct.Memory*, %struct.Memory** %MEMORY
  ...
  store i8 %71, i8* %75
  store %struct.Memory* %loadMem_413a2a, %struct.Memory** %MEMORY
  ...
  %AL.i6 = getelementptr inbounds %struct.anon.2, %struct.anon.2* %171, i32 0, i32 0
  ...
  %AL.i = getelementptr inbounds %struct.anon.2, %struct.anon.2* %186, i32 0, i32 0
  ...
  ret %struct.Memory* %loadMem_413a42
}
