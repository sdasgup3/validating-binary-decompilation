...
entry:
  ...
  %loadMem_40cd30 = load %struct.Memory*, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_40cd30, %struct.Memory** %MEMORY
  ...
  %loadMem_40cd49 = load %struct.Memory*, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_40cd49, %struct.Memory** %MEMORY
  ret %struct.Memory* %loadMem_40cd49
}
