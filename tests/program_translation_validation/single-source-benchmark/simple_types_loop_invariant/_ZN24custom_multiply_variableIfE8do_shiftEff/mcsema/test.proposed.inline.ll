...
define %struct.Memory* @_ZN24custom_multiply_variableIfE8do_shiftEff(%struct.State* noalias, i64, %struct.Memory* noalias) #1 {
entry:
  ...
  store %struct.Memory* %loadMem_40cd38, %struct.Memory** %MEMORY
  ...
  ret %struct.Memory* %loadMem_40cd39
}
