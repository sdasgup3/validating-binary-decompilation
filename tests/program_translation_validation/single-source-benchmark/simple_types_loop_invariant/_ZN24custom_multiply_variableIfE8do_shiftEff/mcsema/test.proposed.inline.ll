...
define %struct.Memory* @_ZN24custom_multiply_variableIfE8do_shiftEff(%struct.State* noalias, i64, %struct.Memory* noalias) #2 {
entry:
  ...
  %loadMem_40ccf1 = load %struct.Memory*, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_40ccf1, %struct.Memory** %MEMORY
  %loadMem_40ccf4 = load %struct.Memory*, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_40ccf4, %struct.Memory** %MEMORY
  %loadMem_40ccf9 = load %struct.Memory*, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_40ccf9, %struct.Memory** %MEMORY
  ...
  ret %struct.Memory* %loadMem_40cd09
}
...
define %struct.Memory* @routine_mulss_MINUS0x8__rbp____xmm0(%struct.State* dereferenceable(3376), i64, %struct.Memory*) {
block_400478:
  %3 = getelementptr inbounds %struct.State, %struct.State* %0, i32 0, i32 6
  %4 = getelementptr inbounds %struct.GPR, %struct.GPR* %3, i32 0, i32 33
  %5 = getelementptr inbounds %struct.Reg, %struct.Reg* %4, i32 0, i32 0
