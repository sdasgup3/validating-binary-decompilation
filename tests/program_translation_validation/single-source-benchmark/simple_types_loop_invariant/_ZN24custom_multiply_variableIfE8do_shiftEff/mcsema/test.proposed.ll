...
define %struct.Memory* @_ZN24custom_multiply_variableIfE8do_shiftEff(%struct.State* noalias , i64, %struct.Memory* noalias) alwaysinline  {
entry:
  ...
  ; Code: ._ZN24custom_multiply_variableIfE8do_shiftEff:	 RIP: 40ccf0	 Bytes: 0
  ; Code: pushq %rbp	 RIP: 40ccf0	 Bytes: 1
  %loadMem_40ccf0 = load %struct.Memory*, %struct.Memory** %MEMORY
  %call_40ccf0 = call %struct.Memory* @routine_pushq__rbp(%struct.State* %0, i64  0, %struct.Memory* %loadMem_40ccf0)
  store %struct.Memory* %call_40ccf0, %struct.Memory** %MEMORY

  ; Code: movq %rsp, %rbp	 RIP: 40ccf1	 Bytes: 3
  %loadMem_40ccf1 = load %struct.Memory*, %struct.Memory** %MEMORY
  %call_40ccf1 = call %struct.Memory* @routine_movq__rsp___rbp(%struct.State* %0, i64  0, %struct.Memory* %loadMem_40ccf1)
  store %struct.Memory* %call_40ccf1, %struct.Memory** %MEMORY

  ; Code: movss %xmm0, -0x4(%rbp)	 RIP: 40ccf4	 Bytes: 5
  %loadMem_40ccf4 = load %struct.Memory*, %struct.Memory** %MEMORY
  %call_40ccf4 = call %struct.Memory* @routine_movss__xmm0__MINUS0x4__rbp_(%struct.State* %0, i64  0, %struct.Memory* %loadMem_40ccf4)
  store %struct.Memory* %call_40ccf4, %struct.Memory** %MEMORY

  ; Code: movss %xmm1, -0x8(%rbp)	 RIP: 40ccf9	 Bytes: 5
  %loadMem_40ccf9 = load %struct.Memory*, %struct.Memory** %MEMORY
  %call_40ccf9 = call %struct.Memory* @routine_movss__xmm1__MINUS0x8__rbp_(%struct.State* %0, i64  0, %struct.Memory* %loadMem_40ccf9)
  store %struct.Memory* %call_40ccf9, %struct.Memory** %MEMORY

  ; Code: movss -0x4(%rbp), %xmm0	 RIP: 40ccfe	 Bytes: 5
  %loadMem_40ccfe = load %struct.Memory*, %struct.Memory** %MEMORY
  %call_40ccfe = call %struct.Memory* @routine_movss_MINUS0x4__rbp____xmm0(%struct.State* %0, i64  0, %struct.Memory* %loadMem_40ccfe)
  store %struct.Memory* %call_40ccfe, %struct.Memory** %MEMORY

  ; Code: mulss -0x8(%rbp), %xmm0	 RIP: 40cd03	 Bytes: 5
  %loadMem_40cd03 = load %struct.Memory*, %struct.Memory** %MEMORY
  %call_40cd03 = call %struct.Memory* @routine_mulss_MINUS0x8__rbp____xmm0(%struct.State* %0, i64  0, %struct.Memory* %loadMem_40cd03)
  store %struct.Memory* %call_40cd03, %struct.Memory** %MEMORY

  ; Code: popq %rbp	 RIP: 40cd08	 Bytes: 1
  %loadMem_40cd08 = load %struct.Memory*, %struct.Memory** %MEMORY
  %call_40cd08 = call %struct.Memory* @routine_popq__rbp(%struct.State* %0, i64  0, %struct.Memory* %loadMem_40cd08)
  store %struct.Memory* %call_40cd08, %struct.Memory** %MEMORY

  ; Code: retq	 RIP: 40cd09	 Bytes: 1
  %loadMem_40cd09 = load %struct.Memory*, %struct.Memory** %MEMORY
  %call_40cd09 = call %struct.Memory* @routine_retq(%struct.State* %0, i64  0, %struct.Memory* %loadMem_40cd09)
  store %struct.Memory* %call_40cd09, %struct.Memory** %MEMORY

  ret %struct.Memory* %call_40cd09
}
