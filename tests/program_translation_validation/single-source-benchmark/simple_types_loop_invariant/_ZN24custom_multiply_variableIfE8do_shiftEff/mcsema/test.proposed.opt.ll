...
define %struct.Memory* @_ZN24custom_multiply_variableIfE8do_shiftEff(%struct.State* noalias nocapture, i64, %struct.Memory* noalias readnone returned) local_unnamed_addr #0 {
entry:
  ...
  %27 = bitcast [32 x %union.VectorReg]* %11 to i8*
  ...
  %34 = bitcast [32 x %union.VectorReg]* %11 to float*
  %35 = bitcast [32 x %union.VectorReg]* %11 to i32*
  store i32 %33, i32* %35, align 1
  %36 = getelementptr inbounds i8, i8* %27, i64 4
  %37 = bitcast i8* %36 to float*
  store float 0.000000e+00, float* %37, align 1
  %38 = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 1, i64 0, i32 0, i32 0, i32 0, i64 1
  %39 = bitcast i64* %38 to float*
  store float 0.000000e+00, float* %39, align 1
  %40 = getelementptr inbounds i8, i8* %27, i64 12
  %41 = bitcast i8* %40 to float*
  store float 0.000000e+00, float* %41, align 1
  %42 = add i64 %28, -8
  %43 = add i64 %30, 10
  store i64 %43, i64* %3, align 8
  %44 = load <2 x float>, <2 x float>* %14, align 1
  %45 = bitcast i64* %38 to <2 x i32>*
  %46 = load <2 x i32>, <2 x i32>* %45, align 1
  %47 = inttoptr i64 %42 to float*
  %48 = load float, float* %47, align 4
  %49 = extractelement <2 x float> %44, i32 0
  %50 = fmul float %49, %48
  store float %50, float* %34, align 1
  %51 = bitcast <2 x float> %44 to <2 x i32>
  %52 = extractelement <2 x i32> %51, i32 1
  %53 = bitcast i8* %36 to i32*
  store i32 %52, i32* %53, align 1
  %54 = extractelement <2 x i32> %46, i32 0
  %55 = bitcast i64* %38 to i32*
  store i32 %54, i32* %55, align 1
  %56 = extractelement <2 x i32> %46, i32 1
  %57 = bitcast i8* %40 to i32*
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_mulss_MINUS0x8__rbp____xmm0(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned) local_unnamed_addr #1 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %RBP = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 15, i32 0, i32 0
  %3 = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 1, i64 0
