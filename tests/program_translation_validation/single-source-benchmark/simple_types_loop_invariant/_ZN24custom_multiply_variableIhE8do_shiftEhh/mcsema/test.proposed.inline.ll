...
entry:
  ...
  store i8 %88, i8* %92
  store %struct.Memory* %loadMem_412c0d, %struct.Memory** %MEMORY
  ...
  %loadMem_412c22 = load %struct.Memory*, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_412c22, %struct.Memory** %MEMORY
  ret %struct.Memory* %loadMem_412c22
}
