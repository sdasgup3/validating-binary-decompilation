...
entry:
  ...
  store %struct.Memory* %loadMem_412bd4, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_412bd8, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_412be2, %struct.Memory** %MEMORY
  ret %struct.Memory* %loadMem_412be2
}
