...
define %struct.Memory* @_ZN24custom_multiply_variableIhE8do_shiftEhh(%struct.State* noalias, i64, %struct.Memory* noalias readnone returned) local_unnamed_addr #1 {
entry:
