...
entry:
  ...
  store %struct.Memory* %loadMem_40fe8a, %struct.Memory** %MEMORY
  ...
  %loadMem_40fe93 = load %struct.Memory*, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_40fe93, %struct.Memory** %MEMORY
  ...
  ret %struct.Memory* %loadMem_40fe94
}
