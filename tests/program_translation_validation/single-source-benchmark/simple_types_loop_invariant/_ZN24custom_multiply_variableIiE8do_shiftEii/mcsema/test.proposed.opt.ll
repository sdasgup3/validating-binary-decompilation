...
define %struct.Memory* @_ZN24custom_multiply_variableIiE8do_shiftEii(%struct.State* noalias nocapture, i64, %struct.Memory* noalias readnone returned) local_unnamed_addr #1 {
entry:
