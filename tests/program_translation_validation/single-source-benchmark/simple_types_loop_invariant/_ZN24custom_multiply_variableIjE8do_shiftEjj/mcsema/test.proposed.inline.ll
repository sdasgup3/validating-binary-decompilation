...
define %struct.Memory* @_ZN24custom_multiply_variableIjE8do_shiftEjj(%struct.State* noalias, i64, %struct.Memory* noalias) #2 {
entry:
  ...
  store i32 %56, i32* %60
  store %struct.Memory* %loadMem_40f387, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_40f38a, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_40f38d, %struct.Memory** %MEMORY
  ...
  ret %struct.Memory* %loadMem_40f394
}
