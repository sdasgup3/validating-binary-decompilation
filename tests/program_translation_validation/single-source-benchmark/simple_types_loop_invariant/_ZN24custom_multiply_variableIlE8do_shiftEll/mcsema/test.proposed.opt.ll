...
define %struct.Memory* @_ZN24custom_multiply_variableIlE8do_shiftEll(%struct.State* noalias, i64, %struct.Memory* noalias) local_unnamed_addr #1 {
entry:
  ...
  %31 = sext i64 %26 to i128
  %32 = and i128 %31, -18446744073709551616
  %33 = sext i64 %30 to i128
  %34 = and i128 %33, -18446744073709551616
  %35 = zext i64 %26 to i128
  %36 = or i128 %32, %35
  %37 = zext i64 %30 to i128
  %38 = or i128 %34, %37
  %39 = mul i128 %38, %36
  %40 = trunc i128 %39 to i64
  store i64 %40, i64* %RSI.i12, align 8
  %41 = sext i64 %40 to i128
  %42 = icmp ne i128 %41, %39
  %43 = zext i1 %42 to i8
  %44 = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 2, i32 1
  store i8 %43, i8* %44, align 1
  %45 = trunc i128 %39 to i32
  %46 = and i32 %45, 255
  ...
  store i64 %40, i64* %RAX.i, align 8
  %58 = add i64 %23, 13
...
define %struct.Memory* @routine_imulq_MINUS0x10__rbp____rsi(%struct.State* dereferenceable(3376), i64, %struct.Memory*) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %RSI = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 9, i32 0, i32 0
  %RBP = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 15, i32 0, i32 0
