...
define %struct.Memory* @_ZN24custom_multiply_variableImE8do_shiftEmm(%struct.State* noalias, i64, %struct.Memory* noalias) #1 {
entry:
  ...
  store %struct.Memory* %loadMem_40dbd9, %struct.Memory** %MEMORY
  ret %struct.Memory* %loadMem_40dbd9
}
