...
define %struct.Memory* @_ZN24custom_multiply_variableIsE8do_shiftEss(%struct.State* noalias, i64, %struct.Memory* noalias) #2 {
entry:
  ...
  %loadMem_411d1a = load %struct.Memory*, %struct.Memory** %MEMORY
  ...
  store i16 %66, i16* %70
  store %struct.Memory* %loadMem_411d1a, %struct.Memory** %MEMORY
  %loadMem_411d1e = load %struct.Memory*, %struct.Memory** %MEMORY
  ...
  store i16 %82, i16* %86
  store %struct.Memory* %loadMem_411d1e, %struct.Memory** %MEMORY
  %loadMem_411d22 = load %struct.Memory*, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_411d22, %struct.Memory** %MEMORY
  ...
  ret %struct.Memory* %loadMem_411d32
}
