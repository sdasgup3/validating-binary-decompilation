...
define %struct.Memory* @_ZN24custom_multiply_variableItE8do_shiftEtt(%struct.State* noalias, i64, %struct.Memory* noalias) #1 {
entry:
  ...
  store %struct.Memory* %loadMem_410cf7, %struct.Memory** %MEMORY
  ...
  ret %struct.Memory* %loadMem_410d14
}
