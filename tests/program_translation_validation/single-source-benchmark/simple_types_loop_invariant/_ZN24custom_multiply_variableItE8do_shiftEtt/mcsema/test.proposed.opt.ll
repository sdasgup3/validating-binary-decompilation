...
define %struct.Memory* @_ZN24custom_multiply_variableItE8do_shiftEtt(%struct.State* noalias, i64, %struct.Memory* noalias readnone returned) local_unnamed_addr #1 {
entry:
