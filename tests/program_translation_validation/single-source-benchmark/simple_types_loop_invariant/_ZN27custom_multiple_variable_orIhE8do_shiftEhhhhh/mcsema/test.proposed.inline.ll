...
entry:
  ...
  store %struct.Memory* %loadMem_41237e, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_41239a, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_4123b2, %struct.Memory** %MEMORY
  ...
  ret %struct.Memory* %loadMem_4123b9
}
