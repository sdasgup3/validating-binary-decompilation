...
define %struct.Memory* @_ZN27custom_multiple_variable_orIhE8do_shiftEhhhhh(%struct.State* noalias, i64, %struct.Memory* noalias) #2 {
entry:
  ...
  store %struct.Memory* %loadMem_412385, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_412391, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_4123ae, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_4123c0, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_4123c7, %struct.Memory** %MEMORY
