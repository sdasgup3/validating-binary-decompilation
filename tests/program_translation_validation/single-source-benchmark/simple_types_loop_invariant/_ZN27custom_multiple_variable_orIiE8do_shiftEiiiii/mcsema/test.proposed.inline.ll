...
define %struct.Memory* @_ZN27custom_multiple_variable_orIiE8do_shiftEiiiii(%struct.State* noalias, i64, %struct.Memory* noalias) #2 {
entry:
  ...
  ret %struct.Memory* %loadMem_40f816
}
