...
define %struct.Memory* @_ZN27custom_multiple_variable_orIiE8do_shiftEiiiii(%struct.State* noalias, i64, %struct.Memory* noalias) #1 {
entry:
  ...
  store i32 %72, i32* %76
  store %struct.Memory* %loadMem_40f82a, %struct.Memory** %MEMORY
  ...
  ret %struct.Memory* %loadMem_40f846
}
