...
define %struct.Memory* @_ZN27custom_multiple_variable_orIiE8do_shiftEiiiii(%struct.State* noalias, i64, %struct.Memory* noalias readnone returned) local_unnamed_addr #1 {
entry:
