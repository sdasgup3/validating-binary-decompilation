...
define %struct.Memory* @_ZN27custom_multiple_variable_orIjE8do_shiftEjjjjj(%struct.State* noalias, i64, %struct.Memory* noalias) #1 {
entry:
  ...
  store i32 %56, i32* %60
  store %struct.Memory* %loadMem_40ed17, %struct.Memory** %MEMORY
  ...
  store i32 %72, i32* %76
  store %struct.Memory* %loadMem_40ed1a, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_40ed20, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_40ed27, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_40ed2a, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_40ed2d, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_40ed30, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_40ed35, %struct.Memory** %MEMORY
  ...
  ret %struct.Memory* %loadMem_40ed36
}
