...
define %struct.Memory* @_ZN27custom_multiple_variable_orImE8do_shiftEmmmmm(%struct.State* noalias, i64, %struct.Memory* noalias) #1 {
entry:
  ...
  store %struct.Memory* %loadMem_40d261, %struct.Memory** %MEMORY
  ...
  store i64 %70, i64* %73
  store %struct.Memory* %loadMem_40d26c, %struct.Memory** %MEMORY
  ...
  ret %struct.Memory* %loadMem_40d290
}
