...
define %struct.Memory* @_ZN27custom_multiple_variable_orImE8do_shiftEmmmmm(%struct.State* noalias, i64, %struct.Memory* noalias) #2 {
entry:
  ...
  store %struct.Memory* %loadMem_40d248, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_40d24c, %struct.Memory** %MEMORY
  ...
  ret %struct.Memory* %loadMem_40d260
}
