...
entry:
  ...
  store %struct.Memory* %loadMem_411329, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_41132d, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_411357, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_41136f, %struct.Memory** %MEMORY
  ...
  ret %struct.Memory* %loadMem_411371
}
