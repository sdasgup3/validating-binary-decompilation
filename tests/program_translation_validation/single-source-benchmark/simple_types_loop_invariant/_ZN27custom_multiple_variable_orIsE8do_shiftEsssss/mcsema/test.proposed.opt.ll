...
entry:
  ...
  store i64 %129, i64* %RDX.i26, align 8
  %130 = or i64 %129, %113
  ...
  store i8 0, i8* %88, align 1
  store i8 0, i8* %89, align 1
  %141 = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 1, i32 0, i32 0
  %sext = shl i64 %130, 48
  %142 = ashr exact i64 %sext, 48
  ...
  store i64 %148, i64* %RBX.i54, align 8
