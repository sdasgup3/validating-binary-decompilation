...
define %struct.Memory* @_ZN28custom_add_multiple_variableIaE8do_shiftEaaaaa(%struct.State* noalias, i64, %struct.Memory* noalias readnone returned) local_unnamed_addr #1 {
entry:
