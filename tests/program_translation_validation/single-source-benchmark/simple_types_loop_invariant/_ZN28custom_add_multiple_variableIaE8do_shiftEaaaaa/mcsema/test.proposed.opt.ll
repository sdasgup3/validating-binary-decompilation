...
define %struct.Memory* @_ZN28custom_add_multiple_variableIaE8do_shiftEaaaaa(%struct.State* noalias, i64, %struct.Memory* noalias) local_unnamed_addr #1 {
entry:
  ...
  store i64 %115, i64* %RDX.i27, align 8
  ...
  store i64 %149, i64* %RDX.i27, align 8
  %150 = sext i8 %147 to i32
  %151 = add nsw i32 %150, %117
  %152 = zext i32 %151 to i64
  store i64 %152, i64* %RCX.i30, align 8
  ...
  store i64 %182, i64* %RDX.i27, align 8
  %183 = sext i8 %180 to i32
  %184 = add nsw i32 %183, %151
  %185 = zext i32 %184 to i64
  store i64 %185, i64* %RCX.i30, align 8
  ...
  store i64 %217, i64* %RBX.i55, align 8
