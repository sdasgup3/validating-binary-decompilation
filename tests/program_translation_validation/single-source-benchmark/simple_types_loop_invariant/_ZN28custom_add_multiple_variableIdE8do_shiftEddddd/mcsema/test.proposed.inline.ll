...
define %struct.Memory* @_ZN28custom_add_multiple_variableIdE8do_shiftEddddd(%struct.State* noalias, i64, %struct.Memory* noalias) #1 {
entry:
  ...
  ret %struct.Memory* %loadMem_40c697
}
