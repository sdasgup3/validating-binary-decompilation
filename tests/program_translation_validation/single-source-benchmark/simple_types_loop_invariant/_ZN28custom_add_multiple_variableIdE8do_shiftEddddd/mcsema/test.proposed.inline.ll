...
define %struct.Memory* @_ZN28custom_add_multiple_variableIdE8do_shiftEddddd(%struct.State* noalias, i64, %struct.Memory* noalias) #2 {
entry:
  ...
  store %struct.Memory* %loadMem_40c679, %struct.Memory** %MEMORY
  ...
  ret %struct.Memory* %loadMem_40c6a7
}
