...
define %struct.Memory* @_ZN28custom_add_multiple_variableIhE8do_shiftEhhhhh(%struct.State* noalias, i64, %struct.Memory* noalias readnone returned) local_unnamed_addr #1 {
entry:
  ...
  %.mask = and i32 %144, 255
  %158 = zext i32 %.mask to i64
  store i64 %158, i64* %RAX.i, align 8
  %159 = add i64 %61, 34
  ...
  store i64 %163, i64* %RBX.i55, align 8
