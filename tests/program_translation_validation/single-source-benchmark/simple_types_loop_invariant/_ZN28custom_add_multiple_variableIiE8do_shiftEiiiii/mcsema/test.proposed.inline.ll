...
define %struct.Memory* @_ZN28custom_add_multiple_variableIiE8do_shiftEiiiii(%struct.State* noalias, i64, %struct.Memory* noalias) #2 {
entry:
  ...
  store i32 %56, i32* %60
  store %struct.Memory* %loadMem_40fff7, %struct.Memory** %MEMORY
  ...
  store i32 %88, i32* %92
  store %struct.Memory* %loadMem_40fffd, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_410016, %struct.Memory** %MEMORY
  ret %struct.Memory* %loadMem_410016
}
