...
define %struct.Memory* @_ZN28custom_add_multiple_variableIiE8do_shiftEiiiii(%struct.State* noalias, i64, %struct.Memory* noalias) #1 {
entry:
  ...
  store i32 %56, i32* %60
  store %struct.Memory* %loadMem_410027, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_41003a, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_41003d, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_410045, %struct.Memory** %MEMORY
  ...
  ret %struct.Memory* %loadMem_410046
}
