...
define %struct.Memory* @_ZN28custom_add_multiple_variableIiE8do_shiftEiiiii(%struct.State* noalias, i64, %struct.Memory* noalias readnone returned) local_unnamed_addr #1 {
entry:
