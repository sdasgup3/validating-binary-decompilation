...
define %struct.Memory* @_ZN28custom_add_multiple_variableIlE8do_shiftElllll(%struct.State* noalias, i64, %struct.Memory* noalias) #2 {
entry:
  ...
  store i64 %55, i64* %58
  store %struct.Memory* %loadMem_40ea28, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_40ea4c, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_40ea4f, %struct.Memory** %MEMORY
  ...
  ret %struct.Memory* %loadMem_40ea50
}
