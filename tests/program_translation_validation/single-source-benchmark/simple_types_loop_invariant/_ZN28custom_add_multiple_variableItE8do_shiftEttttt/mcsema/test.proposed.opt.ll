...
define %struct.Memory* @_ZN28custom_add_multiple_variableItE8do_shiftEttttt(%struct.State* noalias, i64, %struct.Memory* noalias) local_unnamed_addr #1 {
entry:
