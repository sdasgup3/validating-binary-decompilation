...
entry:
  ...
  store %struct.Memory* %loadMem_4132fe, %struct.Memory** %MEMORY
  ...
  store i8 %129, i8* %133
  store %struct.Memory* %loadMem_413304, %struct.Memory** %MEMORY
  ...
  store i8 %163, i8* %167
  store %struct.Memory* %loadMem_41330b, %struct.Memory** %MEMORY
  ...
  ret %struct.Memory* %loadMem_413339
}
