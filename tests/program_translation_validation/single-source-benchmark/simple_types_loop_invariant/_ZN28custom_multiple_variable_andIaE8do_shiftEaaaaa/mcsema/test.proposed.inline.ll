...
define %struct.Memory* @_ZN28custom_multiple_variable_andIaE8do_shiftEaaaaa(%struct.State* noalias, i64, %struct.Memory* noalias) #2 {
entry:
  ...
  store %struct.Memory* %loadMem_413325, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_413356, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_41335a, %struct.Memory** %MEMORY
  ...
  ret %struct.Memory* %loadMem_413369
}
