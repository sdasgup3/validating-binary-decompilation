...
define %struct.Memory* @_ZN28custom_multiple_variable_andIhE8do_shiftEhhhhh(%struct.State* noalias, i64, %struct.Memory* noalias) #1 {
entry:
  ...
  store %struct.Memory* %loadMem_412505, %struct.Memory** %MEMORY
  ...
  store i8 %146, i8* %150
  store %struct.Memory* %loadMem_412517, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_41253a, %struct.Memory** %MEMORY
  ...
  ret %struct.Memory* %loadMem_412549
}
