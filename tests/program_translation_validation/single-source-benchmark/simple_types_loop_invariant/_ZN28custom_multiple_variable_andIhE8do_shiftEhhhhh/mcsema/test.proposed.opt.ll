...
define %struct.Memory* @_ZN28custom_multiple_variable_andIhE8do_shiftEhhhhh(%struct.State* noalias, i64, %struct.Memory* noalias readnone returned) local_unnamed_addr #1 {
entry:
  ...
  store i64 %128, i64* %RAX.i, align 8
  %129 = add i64 %61, 34
