...
define %struct.Memory* @_ZN28custom_multiple_variable_andIlE8do_shiftElllll(%struct.State* noalias, i64, %struct.Memory* noalias) #1 {
entry:
  ...
  store %struct.Memory* %loadMem_40e2d1, %struct.Memory** %MEMORY
  ...
  store i64 %40, i64* %43
  store %struct.Memory* %loadMem_40e2d4, %struct.Memory** %MEMORY
  ...
  store i64 %55, i64* %58
  store %struct.Memory* %loadMem_40e2d8, %struct.Memory** %MEMORY
  ...
  store i64 %70, i64* %73
  store %struct.Memory* %loadMem_40e2dc, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_40e2ff, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_40e300, %struct.Memory** %MEMORY
  ret %struct.Memory* %loadMem_40e300
}
