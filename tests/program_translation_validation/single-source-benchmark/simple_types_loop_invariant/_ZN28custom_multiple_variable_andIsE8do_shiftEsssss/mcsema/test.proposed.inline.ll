...
define %struct.Memory* @_ZN28custom_multiple_variable_andIsE8do_shiftEsssss(%struct.State* noalias, i64, %struct.Memory* noalias) #1 {
entry:
  ...
  store %struct.Memory* %loadMem_411546, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_411557, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_41155d, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_41156e, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_411571, %struct.Memory** %MEMORY
  ret %struct.Memory* %loadMem_411571
}
