...
define %struct.Memory* @_ZN28custom_multiple_variable_xorIaE8do_shiftEaaaaa(%struct.State* noalias, i64, %struct.Memory* noalias) #2 {
entry:
  ...
  store %struct.Memory* %loadMem_412fc5, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_412ffa, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_412ffc, %struct.Memory** %MEMORY
  ...
  ret %struct.Memory* %loadMem_413009
}
