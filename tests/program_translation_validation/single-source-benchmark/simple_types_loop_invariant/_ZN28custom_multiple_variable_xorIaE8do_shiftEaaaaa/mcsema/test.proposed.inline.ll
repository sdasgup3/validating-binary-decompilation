...
entry:
  ...
  store %struct.Memory* %loadMem_412f85, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_412fba, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_412fbc, %struct.Memory** %MEMORY
  ...
  ret %struct.Memory* %loadMem_412fc9
}
