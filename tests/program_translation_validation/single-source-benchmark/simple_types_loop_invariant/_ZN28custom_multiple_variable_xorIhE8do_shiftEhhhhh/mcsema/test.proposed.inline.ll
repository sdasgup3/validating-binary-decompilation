...
entry:
  ...
  store %struct.Memory* %loadMem_4121a0, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_4121ae, %struct.Memory** %MEMORY
  ...
  store i8 %146, i8* %150
  store %struct.Memory* %loadMem_4121b7, %struct.Memory** %MEMORY
  ...
  store i8 %197, i8* %201
  store %struct.Memory* %loadMem_4121c3, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_4121ce, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_4121dc, %struct.Memory** %MEMORY
  ...
  ret %struct.Memory* %loadMem_4121e9
}
