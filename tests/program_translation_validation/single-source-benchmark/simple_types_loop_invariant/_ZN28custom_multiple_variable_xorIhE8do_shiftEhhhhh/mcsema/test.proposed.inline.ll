...
entry:
  ...
  store %struct.Memory* %loadMem_412168, %struct.Memory** %MEMORY
  ...
  store i8 %197, i8* %201
  store %struct.Memory* %loadMem_412183, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_41218e, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_412196, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_41219a, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_4121a9, %struct.Memory** %MEMORY
  ret %struct.Memory* %loadMem_4121a9
}
