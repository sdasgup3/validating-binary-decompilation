...
define %struct.Memory* @_ZN28custom_multiple_variable_xorIiE8do_shiftEiiiii(%struct.State* noalias, i64, %struct.Memory* noalias) #2 {
entry:
  ...
  store i32 %72, i32* %76
  store %struct.Memory* %loadMem_40f69a, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_40f6b6, %struct.Memory** %MEMORY
  ret %struct.Memory* %loadMem_40f6b6
}
