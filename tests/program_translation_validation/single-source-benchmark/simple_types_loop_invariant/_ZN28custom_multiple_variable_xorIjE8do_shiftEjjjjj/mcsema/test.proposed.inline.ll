...
entry:
  ...
  store i32 %56, i32* %60
  store %struct.Memory* %loadMem_40eb77, %struct.Memory** %MEMORY
  ...
  store i32 %88, i32* %92
  store %struct.Memory* %loadMem_40eb7d, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_40eb87, %struct.Memory** %MEMORY
  ...
  ret %struct.Memory* %loadMem_40eb96
}
