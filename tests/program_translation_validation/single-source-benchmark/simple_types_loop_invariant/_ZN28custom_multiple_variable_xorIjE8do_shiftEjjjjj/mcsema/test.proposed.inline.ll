...
define %struct.Memory* @_ZN28custom_multiple_variable_xorIjE8do_shiftEjjjjj(%struct.State* noalias, i64, %struct.Memory* noalias) #1 {
entry:
  ...
  store %struct.Memory* %loadMem_40ebc5, %struct.Memory** %MEMORY
  ...
  ret %struct.Memory* %loadMem_40ebc6
}
