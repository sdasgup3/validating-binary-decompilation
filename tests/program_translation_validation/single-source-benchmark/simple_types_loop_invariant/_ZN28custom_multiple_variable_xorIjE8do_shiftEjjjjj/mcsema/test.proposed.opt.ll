...
define %struct.Memory* @_ZN28custom_multiple_variable_xorIjE8do_shiftEjjjjj(%struct.State* noalias, i64, %struct.Memory* noalias readnone returned) local_unnamed_addr #1 {
entry:
