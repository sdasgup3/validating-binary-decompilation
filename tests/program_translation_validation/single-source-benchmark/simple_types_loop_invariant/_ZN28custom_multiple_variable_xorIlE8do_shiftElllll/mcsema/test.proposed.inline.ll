...
define %struct.Memory* @_ZN28custom_multiple_variable_xorIlE8do_shiftElllll(%struct.State* noalias, i64, %struct.Memory* noalias) #1 {
entry:
  ...
  ret %struct.Memory* %loadMem_40e030
}
