...
define %struct.Memory* @_ZN28custom_multiple_variable_xorIlE8do_shiftElllll(%struct.State* noalias, i64, %struct.Memory* noalias readnone returned) local_unnamed_addr #1 {
entry:
