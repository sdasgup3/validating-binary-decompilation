...
define %struct.Memory* @_ZN28custom_multiple_variable_xorIsE8do_shiftEsssss(%struct.State* noalias, i64, %struct.Memory* noalias) #2 {
entry:
  ...
  store %struct.Memory* %loadMem_4110f0, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_41110c, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_41111f, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_411127, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_41113b, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_41113e, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_41113f, %struct.Memory** %MEMORY
  ...
  ret %struct.Memory* %loadMem_411141
}
