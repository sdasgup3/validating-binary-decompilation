...
define %struct.Memory* @_ZN28custom_sub_multiple_variableIdE8do_shiftEddddd(%struct.State* noalias, i64, %struct.Memory* noalias) #2 {
entry:
  ...
  ret %struct.Memory* %loadMem_40c507
}
