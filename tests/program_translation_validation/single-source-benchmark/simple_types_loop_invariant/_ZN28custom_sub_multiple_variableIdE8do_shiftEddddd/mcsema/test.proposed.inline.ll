...
define %struct.Memory* @_ZN28custom_sub_multiple_variableIdE8do_shiftEddddd(%struct.State* noalias, i64, %struct.Memory* noalias) #1 {
entry:
  ...
  store %struct.Memory* %loadMem_40c50e, %struct.Memory** %MEMORY
  ...
  ret %struct.Memory* %loadMem_40c537
}
...
define %struct.Memory* @routine_subsd_MINUS0x20__rbp____xmm0(%struct.State* dereferenceable(3376), i64, %struct.Memory*) {
block_400488:
  %3 = getelementptr inbounds %struct.State, %struct.State* %0, i32 0, i32 6
  %4 = getelementptr inbounds %struct.GPR, %struct.GPR* %3, i32 0, i32 33
  %5 = getelementptr inbounds %struct.Reg, %struct.Reg* %4, i32 0, i32 0
