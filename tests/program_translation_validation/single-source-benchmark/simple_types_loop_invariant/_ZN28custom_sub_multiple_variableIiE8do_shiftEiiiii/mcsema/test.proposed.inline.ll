...
define %struct.Memory* @_ZN28custom_sub_multiple_variableIiE8do_shiftEiiiii(%struct.State* noalias, i64, %struct.Memory* noalias) #2 {
entry:
  ...
  store i32 %72, i32* %76
  store %struct.Memory* %loadMem_40fefa, %struct.Memory** %MEMORY
  ...
  %RCX.i11 = bitcast %union.anon* %178 to i64*
  %179 = getelementptr inbounds %struct.State, %struct.State* %0, i32 0, i32 6
  %180 = getelementptr inbounds %struct.GPR, %struct.GPR* %179, i32 0, i32 15
  %181 = getelementptr inbounds %struct.Reg, %struct.Reg* %180, i32 0, i32 0
  %RBP.i12 = bitcast %union.anon* %181 to i64*
  %182 = load i64, i64* %RCX.i11
  %183 = load i64, i64* %RBP.i12
  %184 = sub i64 %183, 12
  ...
  store i64 %191, i64* %RCX.i11, align 8
  ...
  %RCX.i8 = bitcast %union.anon* %226 to i64*
  ...
  %230 = load i64, i64* %RCX.i8
  %231 = load i64, i64* %RBP.i9
  %232 = sub i64 %231, 16
  ...
  store i64 %239, i64* %RCX.i8, align 8
  %240 = icmp ult i32 %235, %237
  ...
  store %struct.Memory* %loadMem_40ff0d, %struct.Memory** %MEMORY
  ...
  %PC.i5 = bitcast %union.anon* %271 to i64*
  ...
  %RBP.i6 = bitcast %union.anon* %277 to i64*
  %278 = load i64, i64* %RCX.i
  %279 = load i64, i64* %RBP.i6
  %280 = sub i64 %279, 20
  ...
  %ECX.i = bitcast %union.anon* %322 to i32*
  ...
  ret %struct.Memory* %loadMem_40ff16
}
