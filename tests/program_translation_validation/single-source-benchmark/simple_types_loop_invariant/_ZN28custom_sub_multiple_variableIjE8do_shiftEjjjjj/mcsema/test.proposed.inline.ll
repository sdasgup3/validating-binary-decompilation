...
define %struct.Memory* @_ZN28custom_sub_multiple_variableIjE8do_shiftEjjjjj(%struct.State* noalias, i64, %struct.Memory* noalias) #2 {
entry:
  ...
  store %struct.Memory* %loadMem_40f476, %struct.Memory** %MEMORY
  ret %struct.Memory* %loadMem_40f476
}
