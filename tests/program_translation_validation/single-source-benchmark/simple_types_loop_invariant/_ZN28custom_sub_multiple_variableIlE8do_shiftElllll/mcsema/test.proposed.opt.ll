...
define %struct.Memory* @_ZN28custom_sub_multiple_variableIlE8do_shiftElllll(%struct.State* noalias, i64, %struct.Memory* noalias readnone returned) local_unnamed_addr #1 {
entry:
