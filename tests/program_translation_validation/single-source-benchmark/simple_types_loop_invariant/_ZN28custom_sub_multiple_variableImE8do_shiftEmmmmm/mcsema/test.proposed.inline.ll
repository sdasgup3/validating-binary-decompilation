...
define %struct.Memory* @_ZN28custom_sub_multiple_variableImE8do_shiftEmmmmm(%struct.State* noalias, i64, %struct.Memory* noalias) #2 {
entry:
  ...
  ret %struct.Memory* %loadMem_40dcb0
}
