...
entry:
  ...
  store %struct.Memory* %loadMem_411dd1, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_411dd5, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_411dd8, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_411def, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_411dff, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_411e0f, %struct.Memory** %MEMORY
  ...
  ret %struct.Memory* %loadMem_411e11
}
