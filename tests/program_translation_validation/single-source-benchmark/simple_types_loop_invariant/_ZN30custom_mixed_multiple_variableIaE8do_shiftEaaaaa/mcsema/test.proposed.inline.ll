...
define %struct.Memory* @_ZN30custom_mixed_multiple_variableIaE8do_shiftEaaaaa(%struct.State* noalias, i64, %struct.Memory* noalias) #2 {
entry:
  ...
  store %struct.Memory* %loadMem_413485, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_41348e, %struct.Memory** %MEMORY
  ...
  store i8 %197, i8* %201
  store %struct.Memory* %loadMem_4134a3, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_4134aa, %struct.Memory** %MEMORY
...
; <label>:425:                                    ; preds = %entry
  ...
  %428 = call %struct.Memory* @__remill_error(%struct.State* nonnull dereferenceable(3376) %0, i64 %427, %struct.Memory* %loadMem_4134c2)
...
routine_idivl__esi.exit:                          ; preds = %425, %429
  %441 = phi %struct.Memory* [ %428, %425 ], [ %loadMem_4134c2, %429 ]
  ...
  store %struct.Memory* %loadMem_4134c9, %struct.Memory** %MEMORY
  ...
  ret %struct.Memory* %loadMem_4134cf
}
