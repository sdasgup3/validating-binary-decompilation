...
define %struct.Memory* @_ZN30custom_mixed_multiple_variableIdE8do_shiftEddddd(%struct.State* noalias, i64, %struct.Memory* noalias) #2 {
entry:
  ...
  %loadMem_40bf14 = load %struct.Memory*, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_40bf14, %struct.Memory** %MEMORY
  ...
  %loadMem_40bf1e = load %struct.Memory*, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_40bf1e, %struct.Memory** %MEMORY
  ...
  %YMM0.i15 = bitcast %union.VectorReg* %134 to %"class.std::bitset"*
  %135 = bitcast %"class.std::bitset"* %YMM0.i15 to i8*
  %136 = bitcast %"class.std::bitset"* %YMM0.i15 to i8*
  %137 = load i64, i64* %RBP.i14
  %138 = sub i64 %137, 16
  ...
  %YMM1.i12 = bitcast %union.VectorReg* %159 to %"class.std::bitset"*
  %160 = bitcast %"class.std::bitset"* %YMM1.i12 to i8*
  %161 = load i64, i64* %RBP.i11
  %162 = sub i64 %161, 24
  %163 = load i64, i64* %PC.i10
  %164 = add i64 %163, 5
  store i64 %164, i64* %PC.i10
  %165 = inttoptr i64 %162 to double*
  %166 = load double, double* %165
  %167 = bitcast i8* %160 to double*
  store double %166, double* %167, align 1
  %168 = getelementptr inbounds i8, i8* %160, i64 8
  ...
  %loadMem_40bf3c = load %struct.Memory*, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_40bf3c, %struct.Memory** %MEMORY
