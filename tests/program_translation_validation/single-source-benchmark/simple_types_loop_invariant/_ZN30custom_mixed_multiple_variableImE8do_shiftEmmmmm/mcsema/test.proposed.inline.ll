...
entry:
  ...
  store i64 %55, i64* %58
  store %struct.Memory* %loadMem_40d5b8, %struct.Memory** %MEMORY
  ...
  store i64 %85, i64* %88
  store %struct.Memory* %loadMem_40d5c0, %struct.Memory** %MEMORY
...
; <label>:307:                                    ; preds = %entry
  ...
  %310 = call %struct.Memory* @__remill_error(%struct.State* nonnull dereferenceable(3376) %0, i64 %309, %struct.Memory* %loadMem_40d5e2)
...
routine_divq_MINUS0x28__rbp_.exit:                ; preds = %307, %311
  %321 = phi %struct.Memory* [ %310, %307 ], [ %loadMem_40d5e2, %311 ]
  ...
  store %struct.Memory* %loadMem_40d5e6, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_40d5ed, %struct.Memory** %MEMORY
  ret %struct.Memory* %loadMem_40d5ed
}
