...
entry:
  ...
  %76 = sext i8 %64 to i64
  %77 = sext i8 %64 to i64
  %78 = lshr i64 %77, 32
  store i64 %78, i64* %73, align 8
  %79 = sext i8 %70 to i64
  %80 = add i64 %61, 11
...
routine_idivl__ecx.exit:                          ; preds = %199, %197
  ...
  %213 = phi i8 [ %.pre9, %197 ], [ %211, %199 ]
  %214 = phi %struct.Memory* [ %198, %197 ], [ %179, %199 ]
  store i8 %213, i8* %R9B.i36, align 1
