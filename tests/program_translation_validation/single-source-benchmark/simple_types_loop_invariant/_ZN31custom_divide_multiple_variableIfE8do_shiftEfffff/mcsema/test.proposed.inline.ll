...
entry:
  ...
  store %struct.Memory* %loadMem_40ca3e, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_40ca4d, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_40ca66, %struct.Memory** %MEMORY
  ...
  ret %struct.Memory* %loadMem_40ca67
}
