...
entry:
  ...
  store %struct.Memory* %loadMem_40fbb0, %struct.Memory** %MEMORY
...
; <label>:163:                                    ; preds = %entry
  ...
  %166 = call %struct.Memory* @__remill_error(%struct.State* nonnull dereferenceable(3376) %0, i64 %165, %struct.Memory* %loadMem_40fbc8)
...
routine_idivl_MINUS0x8__rbp_.exit:                ; preds = %163, %167
  %179 = phi %struct.Memory* [ %166, %163 ], [ %loadMem_40fbc8, %167 ]
...
; <label>:218:                                    ; preds = %routine_idivl_MINUS0x8__rbp_.exit
  ...
  %221 = call %struct.Memory* @__remill_error(%struct.State* nonnull dereferenceable(3376) %0, i64 %220, %struct.Memory* %loadMem_40fbcc)
...
routine_idivl_MINUS0xc__rbp_.exit:                ; preds = %218, %222
  %234 = phi %struct.Memory* [ %221, %218 ], [ %loadMem_40fbcc, %222 ]
...
; <label>:273:                                    ; preds = %routine_idivl_MINUS0xc__rbp_.exit
  ...
  %276 = call %struct.Memory* @__remill_error(%struct.State* nonnull dereferenceable(3376) %0, i64 %275, %struct.Memory* %loadMem_40fbd0)
...
routine_idivl_MINUS0x10__rbp_.exit:               ; preds = %273, %277
  %289 = phi %struct.Memory* [ %276, %273 ], [ %loadMem_40fbd0, %277 ]
...
; <label>:328:                                    ; preds = %routine_idivl_MINUS0x10__rbp_.exit
  ...
  %331 = call %struct.Memory* @__remill_error(%struct.State* nonnull dereferenceable(3376) %0, i64 %330, %struct.Memory* %loadMem_40fbd4)
...
routine_idivl_MINUS0x14__rbp_.exit:               ; preds = %328, %332
  %344 = phi %struct.Memory* [ %331, %328 ], [ %loadMem_40fbd4, %332 ]
  ...
  ret %struct.Memory* %loadMem_40fbd8
}
