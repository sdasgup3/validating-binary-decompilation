...
define %struct.Memory* @_ZN31custom_divide_multiple_variableIlE8do_shiftElllll(%struct.State* noalias, i64, %struct.Memory* noalias) #2 {
entry:
  ...
  store %struct.Memory* %loadMem_40e570, %struct.Memory** %MEMORY
  ...
  store i64 %85, i64* %88
  store %struct.Memory* %loadMem_40e580, %struct.Memory** %MEMORY
...
; <label>:159:                                    ; preds = %entry
  ...
  %162 = call %struct.Memory* @__remill_error(%struct.State* nonnull dereferenceable(3376) %0, i64 %161, %struct.Memory* %loadMem_40e58e)
...
routine_idivq_MINUS0x10__rbp_.exit:               ; preds = %159, %163
  %172 = phi %struct.Memory* [ %162, %159 ], [ %loadMem_40e58e, %163 ]
...
; <label>:213:                                    ; preds = %routine_idivq_MINUS0x10__rbp_.exit
  ...
  %216 = call %struct.Memory* @__remill_error(%struct.State* nonnull dereferenceable(3376) %0, i64 %215, %struct.Memory* %loadMem_40e594)
...
routine_idivq_MINUS0x18__rbp_.exit:               ; preds = %213, %217
  %226 = phi %struct.Memory* [ %216, %213 ], [ %loadMem_40e594, %217 ]
...
; <label>:267:                                    ; preds = %routine_idivq_MINUS0x18__rbp_.exit
  ...
  %270 = call %struct.Memory* @__remill_error(%struct.State* nonnull dereferenceable(3376) %0, i64 %269, %struct.Memory* %loadMem_40e59a)
...
routine_idivq_MINUS0x20__rbp_.exit:               ; preds = %267, %271
  %280 = phi %struct.Memory* [ %270, %267 ], [ %loadMem_40e59a, %271 ]
...
; <label>:321:                                    ; preds = %routine_idivq_MINUS0x20__rbp_.exit
  ...
  %324 = call %struct.Memory* @__remill_error(%struct.State* nonnull dereferenceable(3376) %0, i64 %323, %struct.Memory* %loadMem_40e5a0)
...
routine_idivq_MINUS0x28__rbp_.exit:               ; preds = %321, %325
  %334 = phi %struct.Memory* [ %324, %321 ], [ %loadMem_40e5a0, %325 ]
  ...
  store %struct.Memory* %loadMem_40e5a5, %struct.Memory** %MEMORY
  ret %struct.Memory* %loadMem_40e5a5
}
