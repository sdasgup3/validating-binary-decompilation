...
entry:
  ...
  store %struct.Memory* %loadMem_40e4c4, %struct.Memory** %MEMORY
...
; <label>:174:                                    ; preds = %entry
  ...
  %177 = call %struct.Memory* @__remill_error(%struct.State* nonnull dereferenceable(3376) %0, i64 %176, %struct.Memory* %loadMem_40e4d2)
...
routine_idivq_MINUS0x18__rbp_.exit:               ; preds = %174, %178
  %187 = phi %struct.Memory* [ %177, %174 ], [ %loadMem_40e4d2, %178 ]
...
; <label>:228:                                    ; preds = %routine_idivq_MINUS0x18__rbp_.exit
  ...
  %231 = call %struct.Memory* @__remill_error(%struct.State* nonnull dereferenceable(3376) %0, i64 %230, %struct.Memory* %loadMem_40e4d8)
...
routine_idivq_MINUS0x20__rbp_.exit:               ; preds = %228, %232
  %241 = phi %struct.Memory* [ %231, %228 ], [ %loadMem_40e4d8, %232 ]
  ...
  store %struct.Memory* %loadMem_40e4dc, %struct.Memory** %MEMORY
...
; <label>:282:                                    ; preds = %routine_idivq_MINUS0x20__rbp_.exit
  ...
  %285 = call %struct.Memory* @__remill_error(%struct.State* nonnull dereferenceable(3376) %0, i64 %284, %struct.Memory* %loadMem_40e4de)
...
routine_idivq_MINUS0x28__rbp_.exit:               ; preds = %282, %286
  %295 = phi %struct.Memory* [ %285, %282 ], [ %loadMem_40e4de, %286 ]
  ...
  store %struct.Memory* %loadMem_40e4e5, %struct.Memory** %MEMORY
  ...
  ret %struct.Memory* %loadMem_40e4e9
}
