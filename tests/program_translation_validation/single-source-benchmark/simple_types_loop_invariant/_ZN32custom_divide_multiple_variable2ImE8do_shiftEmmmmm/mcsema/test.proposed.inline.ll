...
; <label>:203:                                    ; preds = %entry
  ...
  %206 = call %struct.Memory* @__remill_error(%struct.State* nonnull dereferenceable(3376) %0, i64 %205, %struct.Memory* %loadMem_40d716)
...
routine_divq_MINUS0x18__rbp_.exit:                ; preds = %203, %207
  %217 = phi %struct.Memory* [ %206, %203 ], [ %loadMem_40d716, %207 ]
  ...
  store %struct.Memory* %loadMem_40d71a, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_40d71d, %struct.Memory** %MEMORY
...
; <label>:287:                                    ; preds = %routine_divq_MINUS0x18__rbp_.exit
  ...
  %290 = call %struct.Memory* @__remill_error(%struct.State* nonnull dereferenceable(3376) %0, i64 %289, %struct.Memory* %loadMem_40d720)
...
routine_divq_MINUS0x20__rbp_.exit:                ; preds = %287, %291
  %301 = phi %struct.Memory* [ %290, %287 ], [ %loadMem_40d720, %291 ]
...
; <label>:371:                                    ; preds = %routine_divq_MINUS0x20__rbp_.exit
  ...
  %374 = call %struct.Memory* @__remill_error(%struct.State* nonnull dereferenceable(3376) %0, i64 %373, %struct.Memory* %loadMem_40d72a)
...
routine_divq_MINUS0x28__rbp_.exit:                ; preds = %371, %375
  %385 = phi %struct.Memory* [ %374, %371 ], [ %loadMem_40d72a, %375 ]
  ...
  ret %struct.Memory* %loadMem_40d735
}
