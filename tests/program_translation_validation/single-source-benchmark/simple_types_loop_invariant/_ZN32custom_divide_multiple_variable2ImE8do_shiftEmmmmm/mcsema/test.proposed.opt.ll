...
routine_divq_MINUS0x28__rbp_.exit:
  ...
  %div8 = udiv i64 %div, %63
  store i64 %div8, i64* %RAX.i34, align 8
  store i64 0, i64* %49, align 8
  store i8 0, i8* %50, align 1
  store i8 1, i8* %51, align 1
  store i8 1, i8* %52, align 1
  ...
  %div9 = udiv i64 %div8, %67
  %68 = urem i64 %div8, %67
  store i64 %68, i64* %RDX.i45, align 8
  %69 = load i64, i64* %RCX.i42, align 8
  %70 = add i64 %div9, %69
  store i64 %70, i64* %RCX.i42, align 8
  %71 = icmp ult i64 %70, %69
  %72 = icmp ult i64 %70, %div9
  %73 = or i1 %71, %72
  %74 = zext i1 %73 to i8
