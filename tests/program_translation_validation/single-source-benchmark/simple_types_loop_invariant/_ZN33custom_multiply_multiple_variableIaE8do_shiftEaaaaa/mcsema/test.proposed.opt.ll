...
define %struct.Memory* @_ZN33custom_multiply_multiple_variableIaE8do_shiftEaaaaa(%struct.State* noalias, i64, %struct.Memory* noalias readnone returned) local_unnamed_addr #1 {
entry:
  ...
  store i64 %76, i64* %RCX.i30, align 8
  %77 = shl i64 %74, 32
  ...
  store i64 %99, i64* %RDX.i27, align 8
  %100 = shl i64 %74, 32
  ...
  store i64 %146, i64* %RDX.i27, align 8
  %147 = shl i64 %126, 32
  %148 = ashr exact i64 %147, 32
  %149 = sext i8 %144 to i64
  ...
  store i64 %170, i64* %RBX.i55, align 8
