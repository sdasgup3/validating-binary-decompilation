...
entry:
  ...
  store %struct.Memory* %loadMem_412b15, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_412b1e, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_412b56, %struct.Memory** %MEMORY
  ...
  ret %struct.Memory* %loadMem_412b5d
}
