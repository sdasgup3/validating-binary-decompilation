...
entry:
  ...
  %loadMem_40f2d7 = load %struct.Memory*, %struct.Memory** %MEMORY
  ...
  store i32 %56, i32* %60
  store %struct.Memory* %loadMem_40f2d7, %struct.Memory** %MEMORY
  %loadMem_40f2da = load %struct.Memory*, %struct.Memory** %MEMORY
  ...
  store i32 %72, i32* %76
  store %struct.Memory* %loadMem_40f2da, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_40f2e7, %struct.Memory** %MEMORY
  ...
  ret %struct.Memory* %loadMem_40f2fa
}
