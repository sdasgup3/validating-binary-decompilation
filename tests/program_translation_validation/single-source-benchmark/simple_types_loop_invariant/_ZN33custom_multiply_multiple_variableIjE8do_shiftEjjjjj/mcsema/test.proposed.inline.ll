...
entry:
  ...
  store i32 %88, i32* %92
  store %struct.Memory* %loadMem_40f30d, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_40f31f, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_40f32a, %struct.Memory** %MEMORY
  ret %struct.Memory* %loadMem_40f32a
}
