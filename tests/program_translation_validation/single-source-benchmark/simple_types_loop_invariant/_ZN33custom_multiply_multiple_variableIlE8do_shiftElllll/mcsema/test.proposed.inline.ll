...
define %struct.Memory* @_ZN33custom_multiply_multiple_variableIlE8do_shiftElllll(%struct.State* noalias, i64, %struct.Memory* noalias) #1 {
entry:
  ...
  store %struct.Memory* %loadMem_40e7d1, %struct.Memory** %MEMORY
