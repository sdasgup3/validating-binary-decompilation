...
define %struct.Memory* @_ZN33custom_multiply_multiple_variableIlE8do_shiftElllll(%struct.State* noalias, i64, %struct.Memory* noalias) #2 {
entry:
  ...
  store %struct.Memory* %loadMem_40e780, %struct.Memory** %MEMORY
  ...
  store i64 %40, i64* %43
  store %struct.Memory* %loadMem_40e784, %struct.Memory** %MEMORY
  ...
  store i64 %55, i64* %58
  store %struct.Memory* %loadMem_40e788, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_40e794, %struct.Memory** %MEMORY
  ...
  ret %struct.Memory* %loadMem_40e7b4
}
