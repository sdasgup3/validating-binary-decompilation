...
define %struct.Memory* @_ZN33custom_multiply_multiple_variableIlE8do_shiftElllll(%struct.State* noalias, i64, %struct.Memory* noalias) local_unnamed_addr #1 {
entry:
  ...
  %80 = and i128 %59, -18446744073709551616
  %81 = sext i64 %79 to i128
  %82 = and i128 %81, -18446744073709551616
  %83 = and i128 %57, 18446744073709551615
  %84 = or i128 %80, %83
  %85 = zext i64 %79 to i128
  %86 = or i128 %82, %85
  %87 = mul i128 %86, %84
  %88 = trunc i128 %87 to i64
  store i64 %88, i64* %RCX.i23, align 8
  %89 = sext i64 %88 to i128
  %90 = icmp ne i128 %89, %87
  %91 = zext i1 %90 to i8
  store i8 %91, i8* %62, align 1
  %92 = trunc i128 %87 to i32
  %93 = and i32 %92, 255
  ...
  %104 = and i128 %89, -18446744073709551616
  %105 = sext i64 %103 to i128
  %106 = and i128 %105, -18446744073709551616
  %107 = and i128 %87, 18446744073709551615
  %108 = or i128 %104, %107
  %109 = zext i64 %103 to i128
  %110 = or i128 %106, %109
  %111 = mul i128 %110, %108
  %112 = trunc i128 %111 to i64
  store i64 %112, i64* %RCX.i23, align 8
  %113 = sext i64 %112 to i128
  %114 = icmp ne i128 %113, %111
  %115 = zext i1 %114 to i8
  store i8 %115, i8* %62, align 1
  %116 = trunc i128 %111 to i32
  %117 = and i32 %116, 255
  %118 = tail call i32 @llvm.ctpop.i32(i32 %117)
  %119 = trunc i32 %118 to i8
  %120 = and i8 %119, 1
  %121 = xor i8 %120, 1
  store i8 %121, i8* %69, align 1
  store i8 0, i8* %70, align 1
  store i8 0, i8* %71, align 1
  %122 = lshr i64 %112, 63
  %123 = trunc i64 %122 to i8
  store i8 %123, i8* %74, align 1
  ...
  %129 = and i128 %113, -18446744073709551616
  %130 = sext i64 %128 to i128
  %131 = and i128 %130, -18446744073709551616
  %132 = and i128 %111, 18446744073709551615
  %133 = or i128 %129, %132
  %134 = zext i64 %128 to i128
  %135 = or i128 %131, %134
  %136 = mul i128 %135, %133
  %137 = trunc i128 %136 to i64
  store i64 %137, i64* %RCX.i23, align 8
  %138 = sext i64 %137 to i128
  %139 = icmp ne i128 %138, %136
  %140 = zext i1 %139 to i8
  store i8 %140, i8* %62, align 1
...
define %struct.Memory* @routine_imulq_MINUS0x10__rbp____rcx(%struct.State* dereferenceable(3376), i64, %struct.Memory*) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %RCX = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 5, i32 0, i32 0
  %RBP = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 15, i32 0, i32 0
...
define %struct.Memory* @routine_imulq_MINUS0x18__rbp____rcx(%struct.State* dereferenceable(3376), i64, %struct.Memory*) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %RCX = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 5, i32 0, i32 0
  %RBP = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 15, i32 0, i32 0
...
define %struct.Memory* @routine_imulq_MINUS0x20__rbp____rcx(%struct.State* dereferenceable(3376), i64, %struct.Memory*) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %RCX = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 5, i32 0, i32 0
  %RBP = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 15, i32 0, i32 0
...
define %struct.Memory* @routine_imulq_MINUS0x28__rbp____rcx(%struct.State* dereferenceable(3376), i64, %struct.Memory*) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %RCX = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 5, i32 0, i32 0
  %RBP = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 15, i32 0, i32 0
