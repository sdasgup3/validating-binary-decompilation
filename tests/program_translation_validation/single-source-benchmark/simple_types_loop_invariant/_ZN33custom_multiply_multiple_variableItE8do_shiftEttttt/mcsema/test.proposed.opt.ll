...
define %struct.Memory* @_ZN33custom_multiply_multiple_variableItE8do_shiftEttttt(%struct.State* noalias, i64, %struct.Memory* noalias readnone returned) local_unnamed_addr #1 {
entry:
