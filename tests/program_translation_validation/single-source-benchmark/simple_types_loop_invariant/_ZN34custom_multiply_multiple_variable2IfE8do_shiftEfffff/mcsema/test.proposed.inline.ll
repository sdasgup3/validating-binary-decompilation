...
entry:
  ...
  %loadMem_40cb77 = load %struct.Memory*, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_40cb77, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_40cb8a, %struct.Memory** %MEMORY
  ...
  ret %struct.Memory* %loadMem_40cb8b
}
