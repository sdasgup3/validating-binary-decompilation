; ModuleID = '/tmp/tmp2wu37gnb-query.ll'
...
define %struct.Memory* @_ZN34custom_multiply_multiple_variable2IfE8do_shiftEfffff(%struct.State* noalias, i64, %struct.Memory* noalias readnone returned) local_unnamed_addr #0 {
entry:
...
%var_2_69 = bitcast %union.VectorReg* %var_2_18 to i8*
; Matched:%var_2_69:  %var_2_69 = add i64 %var_2_54, -8
; %var_2_70 = add i64 %var_2_55, -8
; Matched:%var_2_70:  %var_2_70 = add i64 %var_2_56, 10
; %var_2_71 = add i64 %var_2_57, 10
; Matched:\<badref\>:  store i64 %var_2_70, i64* %PC, align 8
; store i64 %var_2_71, i64* %var_2_3, align 8
; Matched:%var_2_71:  %var_2_71 = inttoptr i64 %var_2_69 to i32*
; %var_2_72 = inttoptr i64 %var_2_70 to i32*
; Matched:%var_2_72:  %var_2_72 = load i32, i32* %var_2_71, align 4
; %var_2_73 = load i32, i32* %var_2_72, align 4
; Matched:%var_2_73:  %var_2_73 = bitcast %union.VectorReg* %var_2_4 to float*
; %var_2_74 = bitcast %union.VectorReg* %var_2_18 to float*
; Matched:%var_2_74:  %var_2_74 = bitcast %union.VectorReg* %var_2_4 to i32*
; %var_2_75 = bitcast %union.VectorReg* %var_2_18 to i32*
; Matched:\<badref\>:  store i32 %var_2_72, i32* %var_2_74, align 1, !tbaa !1265
; store i32 %var_2_73, i32* %var_2_75, align 1
%var_2_76 = getelementptr inbounds i8, i8* %var_2_69, i64 4
%var_2_77 = bitcast i8* %var_2_76 to float*
store float 0.000000e+00, float* %var_2_77, align 1
%var_2_78 = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 1, i64 1, i32 0, i32 0, i32 0, i64 1
%var_2_79 = bitcast i64* %var_2_78 to float*
store float 0.000000e+00, float* %var_2_79, align 1
%var_2_80 = getelementptr inbounds i8, i8* %var_2_69, i64 12
%var_2_81 = bitcast i8* %var_2_80 to float*
store float 0.000000e+00, float* %var_2_81, align 1
; Matched:%var_2_81:  %var_2_81 = add i64 %var_2_54, -12
; %var_2_82 = add i64 %var_2_55, -12
; Matched:%var_2_82:  %var_2_82 = add i64 %var_2_56, 15
; %var_2_83 = add i64 %var_2_57, 15
; Matched:\<badref\>:  store i64 %var_2_82, i64* %PC, align 8
; store i64 %var_2_83, i64* %var_2_3, align 8
%var_2_84 = load <2 x float>, <2 x float>* %var_2_23, align 1
%var_2_85 = bitcast i64* %var_2_78 to <2 x i32>*
%var_2_86 = load <2 x i32>, <2 x i32>* %var_2_85, align 1
; Matched:%var_2_86:  %var_2_86 = inttoptr i64 %var_2_81 to float*
; %var_2_87 = inttoptr i64 %var_2_82 to float*
; Matched:%var_2_87:  %var_2_87 = load float, float* %var_2_86, align 4
; %var_2_88 = load float, float* %var_2_87, align 4
%var_2_89 = extractelement <2 x float> %var_2_84, i32 0
; Matched:%var_2_89:  %var_2_89 = fmul float %var_2_88, %var_2_87
; %var_2_90 = fmul float %var_2_89, %var_2_88
; Matched:\<badref\>:  store float %var_2_89, float* %var_2_73, align 1, !tbaa !1265
; store float %var_2_90, float* %var_2_74, align 1
%var_2_91 = bitcast <2 x float> %var_2_84 to <2 x i32>
%var_2_92 = extractelement <2 x i32> %var_2_91, i32 1
; Matched:%var_2_92:  %var_2_92 = bitcast i8* %var_2_75 to i32*
; %var_2_93 = bitcast i8* %var_2_76 to i32*
; Matched:\<badref\>:  store i32 %var_2_91, i32* %var_2_92, align 1, !tbaa !1265
; store i32 %var_2_92, i32* %var_2_93, align 1
%var_2_94 = extractelement <2 x i32> %var_2_86, i32 0
; Matched:%var_2_94:  %var_2_94 = bitcast i64* %var_2_77 to i32*
; %var_2_95 = bitcast i64* %var_2_78 to i32*
; Matched:\<badref\>:  store i32 %var_2_93, i32* %var_2_94, align 1, !tbaa !1265
; store i32 %var_2_94, i32* %var_2_95, align 1
%var_2_96 = extractelement <2 x i32> %var_2_86, i32 1
; Matched:%var_2_96:  %var_2_96 = bitcast i8* %var_2_79 to i32*
; %var_2_97 = bitcast i8* %var_2_80 to i32*
...
%var_2_101 = load <2 x i32>, <2 x i32>* %var_2_85, align 1
; Matched:%var_2_101:  %var_2_101 = inttoptr i64 %var_2_97 to float*
; %var_2_102 = inttoptr i64 %var_2_98 to float*
; Matched:%var_2_102:  %var_2_102 = load float, float* %var_2_101, align 4
; %var_2_103 = load float, float* %var_2_102, align 4
%var_2_104 = extractelement <2 x float> %var_2_100, i32 0
; Matched:%var_2_104:  %var_2_104 = fmul float %var_2_103, %var_2_102
; %var_2_105 = fmul float %var_2_104, %var_2_103
; Matched:\<badref\>:  store float %var_2_104, float* %var_2_73, align 1, !tbaa !1265
; store float %var_2_105, float* %var_2_74, align 1
%var_2_106 = bitcast <2 x float> %var_2_100 to <2 x i32>
%var_2_107 = extractelement <2 x i32> %var_2_106, i32 1
; Matched:\<badref\>:  store i32 %var_2_106, i32* %var_2_92, align 1, !tbaa !1265
; store i32 %var_2_107, i32* %var_2_93, align 1
%var_2_108 = extractelement <2 x i32> %var_2_101, i32 0
; Matched:\<badref\>:  store i32 %var_2_107, i32* %var_2_94, align 1, !tbaa !1265
; store i32 %var_2_108, i32* %var_2_95, align 1
%var_2_109 = extractelement <2 x i32> %var_2_101, i32 1
; Matched:\<badref\>:  store i32 %var_2_108, i32* %var_2_96, align 1, !tbaa !1265
; store i32 %var_2_109, i32* %var_2_97, align 1
; Matched:%var_2_109:  %var_2_109 = add i64 %var_2_54, -20
; %var_2_110 = add i64 %var_2_55, -20
; Matched:%var_2_110:  %var_2_110 = add i64 %var_2_56, 25
; %var_2_111 = add i64 %var_2_57, 25
; Matched:\<badref\>:  store i64 %var_2_110, i64* %PC, align 8
; store i64 %var_2_111, i64* %var_2_3, align 8
%var_2_112 = load <2 x float>, <2 x float>* %var_2_23, align 1
%var_2_113 = load <2 x i32>, <2 x i32>* %var_2_85, align 1
; Matched:%var_2_113:  %var_2_113 = inttoptr i64 %var_2_109 to float*
; %var_2_114 = inttoptr i64 %var_2_110 to float*
; Matched:%var_2_114:  %var_2_114 = load float, float* %var_2_113, align 4
; %var_2_115 = load float, float* %var_2_114, align 4
%var_2_116 = extractelement <2 x float> %var_2_112, i32 0
; Matched:%var_2_116:  %var_2_116 = fmul float %var_2_115, %var_2_114
; %var_2_117 = fmul float %var_2_116, %var_2_115
; Matched:\<badref\>:  store float %var_2_116, float* %var_2_73, align 1, !tbaa !1265
; store float %var_2_117, float* %var_2_74, align 1
%var_2_118 = bitcast <2 x float> %var_2_112 to <2 x i32>
%var_2_119 = extractelement <2 x i32> %var_2_118, i32 1
; Matched:\<badref\>:  store i32 %var_2_118, i32* %var_2_92, align 1, !tbaa !1265
; store i32 %var_2_119, i32* %var_2_93, align 1
%var_2_120 = extractelement <2 x i32> %var_2_113, i32 0
; Matched:\<badref\>:  store i32 %var_2_119, i32* %var_2_94, align 1, !tbaa !1265
; store i32 %var_2_120, i32* %var_2_95, align 1
%var_2_121 = extractelement <2 x i32> %var_2_113, i32 1
; Matched:\<badref\>:  store i32 %var_2_120, i32* %var_2_96, align 1, !tbaa !1265
; store i32 %var_2_121, i32* %var_2_97, align 1
%var_2_122 = load <2 x float>, <2 x float>* %var_2_14, align 1
%var_2_123 = bitcast i64* %var_2_65 to <2 x i32>*
%var_2_124 = load <2 x i32>, <2 x i32>* %var_2_123, align 1
%var_2_125 = load <2 x float>, <2 x float>* %var_2_23, align 1
%var_2_126 = extractelement <2 x float> %var_2_122, i32 0
%var_2_127 = extractelement <2 x float> %var_2_125, i32 0
; Matched:%var_2_127:  %var_2_127 = fadd float %var_2_125, %var_2_126
; %var_2_128 = fadd float %var_2_126, %var_2_127
; Matched:\<badref\>:  store float %var_2_127, float* %var_2_60, align 1, !tbaa !1265
; store float %var_2_128, float* %var_2_61, align 1
%var_2_129 = bitcast <2 x float> %var_2_122 to <2 x i32>
%var_2_130 = extractelement <2 x i32> %var_2_129, i32 1
; Matched:%var_2_130:  %var_2_130 = bitcast i8* %var_2_62 to i32*
; %var_2_131 = bitcast i8* %var_2_63 to i32*
; Matched:\<badref\>:  store i32 %var_2_129, i32* %var_2_130, align 1, !tbaa !1265
; store i32 %var_2_130, i32* %var_2_131, align 1
%var_2_132 = extractelement <2 x i32> %var_2_124, i32 0
; Matched:%var_2_132:  %var_2_132 = bitcast i64* %var_2_64 to i32*
; %var_2_133 = bitcast i64* %var_2_65 to i32*
; Matched:\<badref\>:  store i32 %var_2_131, i32* %var_2_132, align 1, !tbaa !1265
; store i32 %var_2_132, i32* %var_2_133, align 1
%var_2_134 = extractelement <2 x i32> %var_2_124, i32 1
; Matched:%var_2_134:  %var_2_134 = bitcast i8* %var_2_66 to i32*
; %var_2_135 = bitcast i8* %var_2_67 to i32*
; Matched:\<badref\>:  store i32 %var_2_133, i32* %var_2_134, align 1, !tbaa !1265
; store i32 %var_2_134, i32* %var_2_135, align 1
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_movss_MINUS0x8__rbp____xmm1(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned) local_unnamed_addr #1 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %RBP = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 15, i32 0, i32 0
  %3 = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 1, i64 1
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_mulss_MINUS0xc__rbp____xmm1(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned) local_unnamed_addr #1 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %RBP = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 15, i32 0, i32 0
  %3 = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 1, i64 1
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_mulss_MINUS0x14__rbp____xmm1(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned) local_unnamed_addr #1 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %RBP = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 15, i32 0, i32 0
  %3 = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 1, i64 1
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_addss__xmm1___xmm0(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned) local_unnamed_addr #1 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
