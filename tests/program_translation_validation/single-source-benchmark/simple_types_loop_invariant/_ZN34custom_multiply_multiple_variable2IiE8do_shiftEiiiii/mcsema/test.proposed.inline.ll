...
define %struct.Memory* @_ZN34custom_multiply_multiple_variable2IiE8do_shiftEiiiii(%struct.State* noalias, i64, %struct.Memory* noalias) #2 {
entry:
  ...
  store i32 %72, i32* %76
  store %struct.Memory* %loadMem_40fcea, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_40fcf0, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_40fd06, %struct.Memory** %MEMORY
  ...
  ret %struct.Memory* %loadMem_40fd0b
}
