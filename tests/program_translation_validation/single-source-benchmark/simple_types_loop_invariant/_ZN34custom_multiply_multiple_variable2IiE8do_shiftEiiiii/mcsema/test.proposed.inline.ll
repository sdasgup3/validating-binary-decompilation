...
define %struct.Memory* @_ZN34custom_multiply_multiple_variable2IiE8do_shiftEiiiii(%struct.State* noalias, i64, %struct.Memory* noalias) #1 {
entry:
  ...
  store %struct.Memory* %loadMem_40fd2e, %struct.Memory** %MEMORY
  ...
  ret %struct.Memory* %loadMem_40fd3b
}
