...
entry:
  ...
  store %struct.Memory* %loadMem_40f220, %struct.Memory** %MEMORY
  ...
  store i32 %88, i32* %92
  store %struct.Memory* %loadMem_40f22d, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_40f24a, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_40f24b, %struct.Memory** %MEMORY
  ret %struct.Memory* %loadMem_40f24b
}
