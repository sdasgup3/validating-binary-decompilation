...
define %struct.Memory* @_ZSt4fabsf(%struct.State* noalias, i64, %struct.Memory* noalias) #2 {
entry:
  ...
  %RBP.i10 = bitcast %union.anon* %34 to i64*
  ...
  %PC.i6 = bitcast %union.anon* %48 to i64*
  ...
  %RBP.i7 = bitcast %union.anon* %51 to i64*
  ...
  %YMM0.i8 = bitcast %union.VectorReg* %53 to %"class.std::bitset"*
  %54 = bitcast %"class.std::bitset"* %YMM0.i8 to i8*
  %55 = load i64, i64* %RBP.i7
  %56 = sub i64 %55, 4
  %57 = load i64, i64* %PC.i6
  %58 = add i64 %57, 5
  store i64 %58, i64* %PC.i6
  %59 = inttoptr i64 %56 to float*
  %60 = load float, float* %59
  %61 = bitcast i8* %54 to float*
  store float %60, float* %61, align 1
  ...
  %PC.i5 = bitcast %union.anon* %70 to i64*
  ...
  %75 = add i64 %74, ptrtoint (%G_0x757b__rip__type* @G_0x757b__rip_ to i64)
  ...
  %89 = bitcast i8* %73 to float*
  store float %79, float* %89, align 1
  %90 = getelementptr inbounds i8, i8* %73, i64 4
  %91 = bitcast i8* %90 to float*
  store float %82, float* %91, align 1
  %92 = getelementptr inbounds i8, i8* %73, i64 8
  %93 = bitcast i8* %92 to float*
  store float %85, float* %93, align 1
  %94 = getelementptr inbounds i8, i8* %73, i64 12
  %95 = bitcast i8* %94 to float*
  store float %88, float* %95, align 1
  ...
  %XMM1.i = bitcast %union.VectorReg* %102 to %union.vec128_t*
  ...
  %123 = bitcast i8* %103 to i32*
  store i32 %120, i32* %123, align 1
  %124 = getelementptr inbounds i8, i8* %103, i64 4
  %125 = bitcast i8* %124 to i32*
  store i32 %122, i32* %125, align 1
  %126 = trunc i64 %119 to i32
  %127 = getelementptr inbounds i8, i8* %103, i64 8
  %128 = bitcast i8* %127 to i32*
  store i32 %126, i32* %128, align 1
  %129 = lshr i64 %119, 32
  %130 = trunc i64 %129 to i32
  %131 = getelementptr inbounds i8, i8* %103, i64 12
  %132 = bitcast i8* %131 to i32*
  store i32 %130, i32* %132, align 1
  store %struct.Memory* %loadMem_40c955, %struct.Memory** %MEMORY
  ...
  ret %struct.Memory* %loadMem_40c95a
}
...
; Function Attrs: alwaysinline
define %struct.Memory* @routine_movaps_0x757b__rip____xmm1(%struct.State* dereferenceable(3376), i64, %struct.Memory*) #2 {
block_400488:
  %3 = getelementptr inbounds %struct.State, %struct.State* %0, i32 0, i32 6
  %4 = getelementptr inbounds %struct.GPR, %struct.GPR* %3, i32 0, i32 33
  %5 = getelementptr inbounds %struct.Reg, %struct.Reg* %4, i32 0, i32 0
