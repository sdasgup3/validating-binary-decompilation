...
@G_0x757b__rip__4245781_= global %G_0x757b__rip__4245781__type <{ [16 x i8] c"\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00" }>
...
entry:
  ...
  ; Code: ._ZSt4fabsf:	 RIP: 40c900	 Bytes: 0
  ; Code: pushq %rbp	 RIP: 40c900	 Bytes: 1
  %loadMem_40c900 = load %struct.Memory*, %struct.Memory** %MEMORY
  %call_40c900 = call %struct.Memory* @routine_pushq__rbp(%struct.State* %0, i64  0, %struct.Memory* %loadMem_40c900)
  store %struct.Memory* %call_40c900, %struct.Memory** %MEMORY

  ; Code: movq %rsp, %rbp	 RIP: 40c901	 Bytes: 3
  %loadMem_40c901 = load %struct.Memory*, %struct.Memory** %MEMORY
  %call_40c901 = call %struct.Memory* @routine_movq__rsp___rbp(%struct.State* %0, i64  0, %struct.Memory* %loadMem_40c901)
  store %struct.Memory* %call_40c901, %struct.Memory** %MEMORY

  ; Code: movss %xmm0, -0x4(%rbp)	 RIP: 40c904	 Bytes: 5
  %loadMem_40c904 = load %struct.Memory*, %struct.Memory** %MEMORY
  %call_40c904 = call %struct.Memory* @routine_movss__xmm0__MINUS0x4__rbp_(%struct.State* %0, i64  0, %struct.Memory* %loadMem_40c904)
  store %struct.Memory* %call_40c904, %struct.Memory** %MEMORY

  ; Code: movss -0x4(%rbp), %xmm0	 RIP: 40c909	 Bytes: 5
  %loadMem_40c909 = load %struct.Memory*, %struct.Memory** %MEMORY
  %call_40c909 = call %struct.Memory* @routine_movss_MINUS0x4__rbp____xmm0(%struct.State* %0, i64  0, %struct.Memory* %loadMem_40c909)
  store %struct.Memory* %call_40c909, %struct.Memory** %MEMORY

  ; Code: movaps 0x757b(%rip), %xmm1	 RIP: 40c90e	 Bytes: 7
  %loadMem_40c90e = load %struct.Memory*, %struct.Memory** %MEMORY
  %call_40c90e = call %struct.Memory* @routine_movaps_0x757b__rip____xmm1(%struct.State* %0, i64  0, %struct.Memory* %loadMem_40c90e)
  store %struct.Memory* %call_40c90e, %struct.Memory** %MEMORY

  ; Code: pand %xmm1, %xmm0	 RIP: 40c915	 Bytes: 4
  %loadMem_40c915 = load %struct.Memory*, %struct.Memory** %MEMORY
  %call_40c915 = call %struct.Memory* @routine_pand__xmm1___xmm0(%struct.State* %0, i64  0, %struct.Memory* %loadMem_40c915)
  store %struct.Memory* %call_40c915, %struct.Memory** %MEMORY

  ; Code: popq %rbp	 RIP: 40c919	 Bytes: 1
  %loadMem_40c919 = load %struct.Memory*, %struct.Memory** %MEMORY
  %call_40c919 = call %struct.Memory* @routine_popq__rbp(%struct.State* %0, i64  0, %struct.Memory* %loadMem_40c919)
  store %struct.Memory* %call_40c919, %struct.Memory** %MEMORY

  ; Code: retq	 RIP: 40c91a	 Bytes: 1
  %loadMem_40c91a = load %struct.Memory*, %struct.Memory** %MEMORY
  %call_40c91a = call %struct.Memory* @routine_retq(%struct.State* %0, i64  0, %struct.Memory* %loadMem_40c91a)
  store %struct.Memory* %call_40c91a, %struct.Memory** %MEMORY

  ret %struct.Memory* %call_40c91a
}
