...
block_.L_40060a:                                  ; preds = %block_.L_400671, %entry
  %71 = phi i64 [ %.pre, %entry ], [ %274, %block_.L_400671 ]
  %MEMORY.0 = phi %struct.Memory* [ %2, %entry ], [ %MEMORY.1, %block_.L_400671 ]
  ...
  br i1 %107, label %block_400616, label %block_.L_400684
...
block_.L_40062d:                                  ; preds = %block_400639, %block_400616
  %127 = phi i64 [ %.pre1, %block_400616 ], [ %244, %block_400639 ]
  %MEMORY.1 = phi %struct.Memory* [ %MEMORY.0, %block_400616 ], [ %call2_40063f, %block_400639 ]
  ...
  %165 = add i64 %128, -28
  br i1 %163, label %block_400639, label %block_.L_400671
...
block_400639:                                     ; preds = %block_.L_40062d
  ...
  %call2_40063f = tail call %struct.Memory* @sub_4005a0.eval_A(%struct.State* %0, i64 %173, %struct.Memory* %MEMORY.1)
...
block_.L_400684:                                  ; preds = %block_.L_40060a
  %275 = load i64, i64* %RSP.i89, align 8
  %276 = add i64 %275, 32
  store i64 %276, i64* %RSP.i89, align 8
...
define %struct.Memory* @routine_jge_.L_400684(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i8* %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
...
define %struct.Memory* @routine_jmpq_.L_400676(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
...
define %struct.Memory* @routine_jmpq_.L_40060a(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
