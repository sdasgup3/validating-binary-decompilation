...
declare %struct.Memory* @sub_400610.eval_A_times_u(%struct.State* dereferenceable(3376), i64, %struct.Memory*) local_unnamed_addr

declare %struct.Memory* @sub_4006b0.eval_At_times_u(%struct.State* dereferenceable(3376), i64, %struct.Memory*) local_unnamed_addr
