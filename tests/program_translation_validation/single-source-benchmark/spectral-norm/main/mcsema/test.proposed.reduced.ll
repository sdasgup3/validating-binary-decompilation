; ModuleID = '/tmp/tmpizovbr50-query.ll'
...
; Matched:  %var_2_47 = load i64, i64* %PC, align 8
; %var_2_46 = load i64, i64* %var_2_3, align 8
  %var_2_55 = load i64, i64* %RBP.i, align 8
  %var_2_56 = add i64 %var_2_55, -8
; Matched:  %var_2_59 = add i64 %var_2_47, 11
; %var_2_58 = add i64 %var_2_46, 11
...
; store i64 %var_2_58, i64* %var_2_3, align 8
  ...
  br i1 %var_2_73, label %block_4007f0, label %block_.L_400805
...
block_4007f0:                                     ; preds = %entry
  ...
  %EAX.i239 = bitcast %union.anon* %var_2_83 to i32*
; Matched:  %.sink7.in.pre = load i64, i64* %RBP, align 8
; %var_2_98 = load i64, i64* %RBP.i, align 8
; Matched:  %.sink.pre = load i32, i32* %EAX, align 4
; %var_2_100 = load i32, i32* %EAX.i239, align 4
...
; %RAX.i236 = getelementptr inbounds %union.anon, %union.anon* %var_2_83, i64 0, i32 0
; Matched:\<badref\>:  store i64 2000, i64* %RAX, align 8, !tbaa !1261
; store i64 2000, i64* %RAX.i236, align 8
  %EAX.i233 = bitcast %union.anon* %var_2_83 to i32*
  br label %block_.L_400812

block_.L_400812:                                  ; preds = %block_.L_400805, %block_4007f0
; Matched:  %.sink7.in = phi i64 [ %var_2_56, %block_400805 ], [ %.sink7.in.pre, %block_4007f0 ]
; %var_2_106.sink.in = phi i64 [ %var_2_55, %block_.L_400805 ], [ %var_2_98, %block_4007f0 ]
; Matched:  %.sink = phi i32 [ 2000, %block_400805 ], [ %.sink.pre, %block_4007f0 ]
; %.sink1 = phi i32 [ 2000, %block_.L_400805 ], [ %var_2_100, %block_4007f0 ]
; Matched:  %.sink5 = phi i64 [ 14, %block_400805 ], [ 27, %block_4007f0 ]
; %.sink = phi i64 [ 14, %block_.L_400805 ], [ 27, %block_4007f0 ]
  %EAX.i226.pre-phi = phi i32* [ %EAX.i233, %block_.L_400805 ], [ %EAX.i239, %block_4007f0 ]
  %MEMORY.0 = phi %struct.Memory* [ %2, %block_.L_400805 ], [ %var_2_97, %block_4007f0 ]
; Matched:  %.sink7 = add i64 %.sink7.in, -52
; %var_2_106.sink = add i64 %var_2_106.sink.in, -52
; Matched:  %var_2_315 = inttoptr i64 %.sink7 to i32*
; %var_2_108 = inttoptr i64 %var_2_106.sink to i32*
; Matched:\<badref\>:  store i32 %.sink, i32* %var_2_315, align 4
; store i32 %.sink1, i32* %var_2_108, align 4
; Matched:  %var_2_316 = load i64, i64* %PC, align 8
; %var_2_109 = load i64, i64* %var_2_3, align 8
; Matched:  %var_2_330 = add i64 %.sink5, %var_2_316
; %var_2_123 = add i64 %.sink, %var_2_109
...
; Matched:\<badref\>:  store i64 68719476720, i64* %RDX, align 8, !tbaa !1261
; store i64 68719476720, i64* %RDX.i217, align 8
  %var_2_161 = load i64, i64* %RBP.i, align 8
  %var_2_192 = add i64 %var_2_161, -20
  %var_2_194 = inttoptr i64 %var_2_192 to i32*
; Matched:\<badref\>:  store i32 0, i32* %var_2_57520, align 4
; store i32 0, i32* %var_2_194, align 4
  %var_2_198 = load i64, i64* %var_2_3, align 8
  %var_2_205 = add i64 %var_2_198, 8
; Matched:\<badref\>:  store i64 %var_2_411, i64* %PC, align 8
; store i64 %var_2_205, i64* %var_2_3, align 8
  %var_2_207 = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 1, i64 0, i32 0, i32 0, i32 0, i64 0
  br label %block_.L_40086a

block_.L_40086a:                                  ; preds = %block_400876, %block_.L_400812
  %var_2_210 = phi i64 [ %var_2_294, %block_400876 ], [ %var_2_205, %block_.L_400812 ]
  %var_2_211 = load i64, i64* %RBP.i, align 8
  %var_2_212 = add i64 %var_2_211, -20
  %var_2_214 = inttoptr i64 %var_2_212 to i32*
  %var_2_215 = load i32, i32* %var_2_214, align 4
  %var_2_217 = add i64 %var_2_211, -24
  ...
  %.v10 = select i1 %var_2_246, i64 12, i64 47
  %var_2_247 = add i64 %.v10, %var_2_210
  br i1 %var_2_246, label %block_400876, label %block_.L_400899

block_400876:                                     ; preds = %block_.L_40086a
  %var_2_248 = add i64 %var_2_247, ptrtoint (%G_0x19a__rip__type* @G_0x19a__rip_ to i64)
  %var_2_249 = add i64 %var_2_247, 8
  store i64 %var_2_249, i64* %var_2_3, align 8
  %var_2_250 = inttoptr i64 %var_2_248 to i64*
  %var_2_251 = load i64, i64* %var_2_250, align 8
  store i64 %var_2_251, i64* %var_2_207, align 1
  %var_2_253 = load i32, i32* %var_2_214, align 4
  %var_2_254 = sext i32 %var_2_253 to i64
  %var_2_255 = add i64 %var_2_211, -72
  %var_2_257 = inttoptr i64 %var_2_255 to i64*
  %var_2_258 = load i64, i64* %var_2_257, align 8
  %var_2_259 = shl nsw i64 %var_2_254, 3
  %var_2_260 = add i64 %var_2_259, %var_2_258
  %var_2_262 = inttoptr i64 %var_2_260 to i64*
  store i64 %var_2_251, i64* %var_2_262, align 8
  %var_2_265 = load i64, i64* %var_2_3, align 8
  %var_2_266 = add i64 %var_2_265, 3
  store i64 %var_2_266, i64* %var_2_3, align 8
  %var_2_294 = add i64 %var_2_265, -39
  br label %block_.L_40086a

block_.L_400899:                                  ; preds = %block_.L_40086a
; Matched:\<badref\>:  store i32 0, i32* %var_2_400, align 4
; store i32 0, i32* %var_2_214, align 4
...
; %RDI.i134 = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 11, i32 0, i32 0
  %var_2_29719 = load i64, i64* %RBP.i, align 8
  %var_2_29820 = add i64 %var_2_29719, -20
  %var_2_30021 = inttoptr i64 %var_2_29820 to i32*
  %var_2_30122 = load i32, i32* %var_2_30021, align 4
  %var_2_30223 = add i32 %var_2_30122, -10
  %var_2_31624 = lshr i32 %var_2_30223, 31
  %var_2_31825 = lshr i32 %var_2_30122, 31
  %var_2_31926 = xor i32 %var_2_31624, %var_2_31825
  %var_2_32027 = add nuw nsw i32 %var_2_31926, %var_2_31825
  %var_2_32128 = icmp eq i32 %var_2_32027, 2
  %var_2_32329 = icmp ne i32 %var_2_31624, 0
  %var_2_32430 = xor i1 %var_2_32329, %var_2_32128
  br i1 %var_2_32430, label %block_4008aa.preheader, label %block_.L_4008d8

block_4008aa.preheader:                           ; preds = %block_.L_400899
  %var_2_346.pre = load i64, i64* %var_2_3, align 8
  br label %block_4008aa

block_4008aa:                                     ; preds = %block_4008aa.preheader, %block_4008aa
  %var_2_346 = phi i64 [ %var_2_346.pre, %block_4008aa.preheader ], [ %var_2_367, %block_4008aa ]
  %var_2_367 = add i64 %var_2_346, 6
; Matched:\<badref\>:  store i64 %var_2_127, i64* %PC, align 8
; store i64 %var_2_367, i64* %var_2_3, align 8
  %var_2_301 = load i32, i32* %var_2_30021, align 4
  %var_2_302 = add i32 %var_2_301, -10
  %var_2_316 = lshr i32 %var_2_302, 31
  %var_2_318 = lshr i32 %var_2_301, 31
  %var_2_319 = xor i32 %var_2_316, %var_2_318
  %var_2_320 = add nuw nsw i32 %var_2_319, %var_2_318
  %var_2_321 = icmp eq i32 %var_2_320, 2
  %var_2_323 = icmp ne i32 %var_2_316, 0
  %var_2_324 = xor i1 %var_2_323, %var_2_321
  br i1 %var_2_324, label %block_4008aa, label %block_.L_4008d8.loopexit

block_.L_4008d8.loopexit:                         ; preds = %block_4008aa
  br label %block_.L_4008d8

block_.L_4008d8:                                  ; preds = %block_.L_4008d8.loopexit, %block_.L_400899
; Matched:  %var_2_6 = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 1, i64 0
; %var_2_396 = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 1, i64 0
  %var_2_397 = bitcast %union.VectorReg* %var_2_396 to <4 x i32>*
  store <4 x i32> zeroinitializer, <4 x i32>* %var_2_397, align 1
; Matched:\<badref\>:  store i32 0, i32* %var_2_47232, align 4
; store i32 0, i32* %var_2_30021, align 4
  %var_2_4162 = load i64, i64* %RBP.i, align 8
  %var_2_4173 = add i64 %var_2_4162, -20
  %var_2_4194 = inttoptr i64 %var_2_4173 to i32*
  %var_2_4205 = load i32, i32* %var_2_4194, align 4
  %var_2_4226 = add i64 %var_2_4162, -24
  %var_2_4247 = inttoptr i64 %var_2_4226 to i32*
  %var_2_4258 = load i32, i32* %var_2_4247, align 4
  %var_2_4269 = sub i32 %var_2_4205, %var_2_4258
  %var_2_44110 = lshr i32 %var_2_4269, 31
  %var_2_44311 = lshr i32 %var_2_4205, 31
  %var_2_44412 = lshr i32 %var_2_4258, 31
  %var_2_44513 = xor i32 %var_2_44412, %var_2_44311
  %var_2_44614 = xor i32 %var_2_44110, %var_2_44311
  %var_2_44715 = add nuw nsw i32 %var_2_44614, %var_2_44513
  %var_2_44816 = icmp eq i32 %var_2_44715, 2
  %var_2_45017 = icmp ne i32 %var_2_44110, 0
  %var_2_45118 = xor i1 %var_2_45017, %var_2_44816
  %var_2_488.pre = load i64, i64* %var_2_3, align 8
  br i1 %var_2_45118, label %block_4008f8.preheader, label %block_.L_400946

block_4008f8.preheader:                           ; preds = %block_.L_4008d8
  br label %block_4008f8

block_4008f8:                                     ; preds = %block_4008f8.preheader, %block_4008f8
  %var_2_488 = phi i64 [ %var_2_519, %block_4008f8 ], [ %var_2_488.pre, %block_4008f8.preheader ]
  %var_2_519 = add i64 %var_2_488, 7
; Matched:\<badref\>:  store i64 %var_2_223, i64* %PC, align 8
; store i64 %var_2_519, i64* %var_2_3, align 8
  %var_2_420 = load i32, i32* %var_2_4194, align 4
  %var_2_425 = load i32, i32* %var_2_4247, align 4
  %var_2_426 = sub i32 %var_2_420, %var_2_425
  %var_2_441 = lshr i32 %var_2_426, 31
  %var_2_443 = lshr i32 %var_2_420, 31
  %var_2_444 = lshr i32 %var_2_425, 31
  %var_2_445 = xor i32 %var_2_444, %var_2_443
  ...
  br i1 %var_2_451, label %block_4008f8, label %block_.L_400946.loopexit

block_.L_400946.loopexit:                         ; preds = %block_4008f8
  br label %block_.L_400946

block_.L_400946:                                  ; preds = %block_.L_400946.loopexit, %block_.L_4008d8
  %var_2_561 = phi i64 [ %var_2_488.pre, %block_.L_4008d8 ], [ %var_2_519, %block_.L_400946.loopexit ]
; Matched:\<badref\>:  store i64 add (i64 ptrtoint (%seg_400a10__rodata_type* @seg_400a10__rodata to i64), i64 16), i64* %RDI, align 8, !tbaa !1261
; store i64 ptrtoint (%G__0x400a20_type* @G__0x400a20 to i64), i64* %RDI.i134, align 8
  %var_2_562 = add i64 %var_2_561, -1166
  %call2_40095e = tail call %struct.Memory* @ext_sqrt(%struct.State* nonnull %0, i64 %var_2_562, %struct.Memory* %MEMORY.0)
  %var_2_569 = load i64, i64* %var_2_3, align 8
  %var_2_573 = add i64 %var_2_569, -1203
  %var_2_574 = add i64 %var_2_569, 11
  %var_2_575 = load i64, i64* %var_2_6, align 8
  %var_2_576 = add i64 %var_2_575, -8
  %var_2_577 = inttoptr i64 %var_2_576 to i64*
  store i64 %var_2_574, i64* %var_2_577, align 8
  store i64 %var_2_573, i64* %var_2_3, align 8
  %var_2_578 = tail call %struct.Memory* @__remill_function_call(%struct.State* nonnull %0, i64 ptrtoint (i64 (i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64)* @printf to i64), %struct.Memory* %call2_40095e)
  %var_2_584 = load i64, i64* %RBP.i, align 8
; Matched:  %var_2_546 = load i64, i64* %PC, align 8
; %var_2_586 = load i64, i64* %var_2_3, align 8
; Matched:  %var_2_547 = add i64 %var_2_546, 4
; %var_2_587 = add i64 %var_2_586, 4
; Matched:\<badref\>:  store i64 %var_2_547, i64* %PC, align 8
; store i64 %var_2_587, i64* %var_2_3, align 8
  %var_2_595 = add i64 %var_2_584, -84
  %var_2_596 = load i32, i32* %EAX.i226.pre-phi, align 4
  %var_2_598 = inttoptr i64 %var_2_595 to i32*
  store i32 %var_2_596, i32* %var_2_598, align 4
  ret %struct.Memory* %var_2_578
}
...
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, ptrtoint (%G_0x19a__rip__type* @G_0x19a__rip_ to i64)
  %5 = add i64 %3, 8
  store i64 %5, i64* %PC, align 8
