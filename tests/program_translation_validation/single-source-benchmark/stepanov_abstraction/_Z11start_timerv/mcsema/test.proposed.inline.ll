...
entry:
  ...
  store %struct.Memory* %loadMem1_401214, %struct.Memory** %MEMORY
  %loadMem2_401214 = load %struct.Memory*, %struct.Memory** %MEMORY
  %loadPC_401214 = load i64, i64* %3
  %43 = call %struct.Memory* @__remill_function_call(%struct.State* %0, i64 ptrtoint (i64 ()* @clock to i64), %struct.Memory* %loadMem2_401214)
  ...
  store i64 %50, i64* bitcast (%G_0x609120_type* @G_0x609120 to i64*)
  ...
  ret %struct.Memory* %loadMem_401222
}
...
define %struct.Memory* @routine_movq__rax__0x609120(%struct.State* dereferenceable(3376), i64, %struct.Memory*) {
block_400488:
  %3 = getelementptr inbounds %struct.State, %struct.State* %0, i32 0, i32 6
  %4 = getelementptr inbounds %struct.GPR, %struct.GPR* %3, i32 0, i32 33
  %5 = getelementptr inbounds %struct.Reg, %struct.Reg* %4, i32 0, i32 0
  ...
  %11 = add i64 %10, 8
  store i64 %11, i64* %PC
  store i64 %9, i64* bitcast (%G_0x609120_type* @G_0x609120 to i64*)
  ret %struct.Memory* %2
}
