...
entry:
  ...
  store %struct.Memory* %loadMem1_4011c4, %struct.Memory** %MEMORY
  %loadMem2_4011c4 = load %struct.Memory*, %struct.Memory** %MEMORY
  %loadPC_4011c4 = load i64, i64* %3
  %43 = call %struct.Memory* @__remill_function_call(%struct.State* %0, i64 ptrtoint (i64 ()* @clock to i64), %struct.Memory* %loadMem2_4011c4)
  ...
  ret %struct.Memory* %loadMem_4011d2
}
