...
declare %struct.Memory* @sub_4006d0.clock_plt(%struct.State* dereferenceable(3376), i64, %struct.Memory*) local_unnamed_addr
...
block_400488:
  ...
  %5 = add i64 %4, 8
  store i64 %5, i64* %PC, align 8
  store i64 %3, i64* inttoptr (i64 6328608 to i64*), align 32
  ret %struct.Memory* %2
}
