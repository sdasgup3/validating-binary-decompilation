...
define %struct.Memory* @_Z13verify_sortedI14PointerWrapperI12ValueWrapperIdEEEvT_S4_(%struct.State* noalias, i64, %struct.Memory* noalias) #2 {
entry:
  ...
  store %struct.Memory* %loadMem1_403b68, %struct.Memory** %MEMORY
...
block_403b75:                                     ; preds = %entry
  ...
  store %struct.Memory* %loadMem1_403b88, %struct.Memory** %MEMORY
  %loadMem2_403b88 = load %struct.Memory*, %struct.Memory** %MEMORY
  %loadPC_403b88 = load i64, i64* %3
  %284 = call %struct.Memory* @__remill_function_call(%struct.State* %0, i64 ptrtoint (i64 (i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64)* @printf to i64), %struct.Memory* %loadMem2_403b88)
...
block_.L_403b90:                                  ; preds = %block_403b75, %entry
  ...
  ret %struct.Memory* %loadMem_403b95
}
