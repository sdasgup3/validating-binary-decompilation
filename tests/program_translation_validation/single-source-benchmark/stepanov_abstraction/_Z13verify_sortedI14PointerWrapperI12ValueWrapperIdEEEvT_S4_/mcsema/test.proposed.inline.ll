...
entry:
  ...
  store %struct.Memory* %loadMem1_403b78, %struct.Memory** %MEMORY
...
block_403b85:                                     ; preds = %entry
  ...
  store %struct.Memory* %loadMem1_403b98, %struct.Memory** %MEMORY
  %loadMem2_403b98 = load %struct.Memory*, %struct.Memory** %MEMORY
  %loadPC_403b98 = load i64, i64* %3
  %284 = call %struct.Memory* @__remill_function_call(%struct.State* %0, i64 ptrtoint (i64 (i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64)* @printf to i64), %struct.Memory* %loadMem2_403b98)
...
block_.L_403ba0:                                  ; preds = %block_403b85, %entry
  ...
  ret %struct.Memory* %loadMem_403ba5
}
