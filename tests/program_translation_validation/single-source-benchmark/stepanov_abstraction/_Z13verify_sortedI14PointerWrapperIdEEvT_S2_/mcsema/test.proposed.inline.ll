...
declare %struct.Memory* @sub_404600._ZN9benchmark9is_sortedI14PointerWrapperIdEEEbT_S3_(%struct.State* dereferenceable(3376), i64, %struct.Memory*)

declare %struct.Memory* @sub_4006f0.printf_plt(%struct.State* dereferenceable(3376), i64, %struct.Memory*)

; Function Attrs: alwaysinline
define %struct.Memory* @_Z13verify_sortedI14PointerWrapperIdEEvT_S2_(%struct.State* noalias, i64, %struct.Memory* noalias) #1 {
entry:
