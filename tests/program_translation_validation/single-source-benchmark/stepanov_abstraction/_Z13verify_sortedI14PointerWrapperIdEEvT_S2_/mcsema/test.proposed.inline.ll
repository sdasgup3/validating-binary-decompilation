...
block_4045d5:                                     ; preds = %entry
  ...
  %call2_4045e8 = call %struct.Memory* @sub_4006f0.printf_plt(%struct.State* %0, i64 %loadPC_4045e8, %struct.Memory* %loadMem2_4045e8)
  store %struct.Memory* %call2_4045e8, %struct.Memory** %MEMORY
