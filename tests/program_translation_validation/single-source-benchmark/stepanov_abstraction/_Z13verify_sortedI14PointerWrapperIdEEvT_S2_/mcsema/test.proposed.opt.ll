...
declare %struct.Memory* @sub_4045c0._ZN9benchmark9is_sortedI14PointerWrapperIdEEEbT_S3_(%struct.State* noalias dereferenceable(3376), i64, %struct.Memory* noalias readnone returned) local_unnamed_addr
...
entry:
  ...
  %call2_404588 = tail call %struct.Memory* @sub_4045c0._ZN9benchmark9is_sortedI14PointerWrapperIdEEEbT_S3_(%struct.State* %0, i64 %78, %struct.Memory* %2)
  ...
  br i1 %92, label %block_.L_4045b0, label %block_404595
...
block_404595:                                     ; preds = %entry
  ...
  %101 = tail call %struct.Memory* @__remill_function_call(%struct.State* %0, i64 ptrtoint (i64 (i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64)* @printf to i64), %struct.Memory* %call2_404588)
...
block_.L_4045b0:                                  ; preds = %block_404595, %entry
  %108 = phi i64 [ %93, %entry ], [ %.pre, %block_404595 ]
  %MEMORY.0 = phi %struct.Memory* [ %call2_404588, %entry ], [ %101, %block_404595 ]
...
define %struct.Memory* @routine_callq_._ZN9benchmark9is_sortedI14PointerWrapperIdEEEbT_S3_(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
...
define %struct.Memory* @routine_jne_.L_4045b0(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i8* %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
