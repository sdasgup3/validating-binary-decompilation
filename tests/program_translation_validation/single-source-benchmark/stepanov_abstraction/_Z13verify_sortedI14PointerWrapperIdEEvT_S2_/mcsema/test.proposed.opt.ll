...
declare %struct.Memory* @sub_404600._ZN9benchmark9is_sortedI14PointerWrapperIdEEEbT_S3_(%struct.State* noalias dereferenceable(3376), i64, %struct.Memory* noalias readnone returned) local_unnamed_addr
...
entry:
  ...
  %call2_4045c8 = tail call %struct.Memory* @sub_404600._ZN9benchmark9is_sortedI14PointerWrapperIdEEEbT_S3_(%struct.State* %0, i64 %78, %struct.Memory* %2)
  ...
  br i1 %92, label %block_.L_4045f0, label %block_4045d5
...
block_4045d5:                                     ; preds = %entry
  ...
  %101 = tail call %struct.Memory* @__remill_function_call(%struct.State* nonnull %0, i64 ptrtoint (i64 (i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64)* @printf to i64), %struct.Memory* %call2_4045c8)
...
block_.L_4045f0:                                  ; preds = %block_4045d5, %entry
  %108 = phi i64 [ %93, %entry ], [ %.pre, %block_4045d5 ]
  %MEMORY.0 = phi %struct.Memory* [ %call2_4045c8, %entry ], [ %101, %block_4045d5 ]
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_jne_.L_4045f0(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i8* nocapture %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
