...
declare %struct.Memory* @sub_404610._ZN9benchmark9is_sortedI14PointerWrapperIdEEEbT_S3_(%struct.State* noalias dereferenceable(3376), i64, %struct.Memory* noalias readnone returned) local_unnamed_addr

; Function Attrs: alwaysinline
define %struct.Memory* @_Z13verify_sortedI14PointerWrapperIdEEvT_S2_(%struct.State* noalias, i64, %struct.Memory* noalias) local_unnamed_addr #1 {
entry:
  ...
  %call2_4045d8 = tail call %struct.Memory* @sub_404610._ZN9benchmark9is_sortedI14PointerWrapperIdEEEbT_S3_(%struct.State* %0, i64 %78, %struct.Memory* %2)
  ...
  br i1 %92, label %block_.L_404600, label %block_4045e5
...
block_4045e5:                                     ; preds = %entry
  ...
  %101 = tail call %struct.Memory* @__remill_function_call(%struct.State* nonnull %0, i64 ptrtoint (i64 (i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64)* @printf to i64), %struct.Memory* %call2_4045d8)
...
block_.L_404600:                                  ; preds = %block_4045e5, %entry
  %108 = phi i64 [ %93, %entry ], [ %.pre, %block_4045e5 ]
  %MEMORY.0 = phi %struct.Memory* [ %call2_4045d8, %entry ], [ %101, %block_4045e5 ]
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_callq_._ZN9benchmark9is_sortedI14PointerWrapperIdEEEbT_S3_(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_jne_.L_404600(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i8* nocapture %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
