...
define %struct.Memory* @_Z13verify_sortedIP12ValueWrapperIS0_IS0_IS0_IS0_IS0_IS0_IS0_IS0_IS0_IdEEEEEEEEEEEvT_SC_(%struct.State* noalias, i64, %struct.Memory* noalias) #2 {
entry:
  ...
  store %struct.Memory* %loadMem1_4036b8, %struct.Memory** %MEMORY
...
block_4036c5:                                     ; preds = %entry
  ...
  store %struct.Memory* %loadMem1_4036d8, %struct.Memory** %MEMORY
  %loadMem2_4036d8 = load %struct.Memory*, %struct.Memory** %MEMORY
  %loadPC_4036d8 = load i64, i64* %3
  %224 = call %struct.Memory* @__remill_function_call(%struct.State* %0, i64 ptrtoint (i64 (i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64)* @printf to i64), %struct.Memory* %loadMem2_4036d8)
...
block_.L_4036e0:                                  ; preds = %block_4036c5, %entry
  ...
  store %struct.Memory* %loadMem_4036e5, %struct.Memory** %MEMORY
  ret %struct.Memory* %loadMem_4036e5
}
