...
block_403705:                                     ; preds = %entry
  ...
  store %struct.Memory* %loadMem1_403718, %struct.Memory** %MEMORY
  %loadMem2_403718 = load %struct.Memory*, %struct.Memory** %MEMORY
  %loadPC_403718 = load i64, i64* %3
  %224 = call %struct.Memory* @__remill_function_call(%struct.State* %0, i64 ptrtoint (i64 (i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64)* @printf to i64), %struct.Memory* %loadMem2_403718)
...
block_.L_403720:                                  ; preds = %block_403705, %entry
  ...
  ret %struct.Memory* %loadMem_403725
}
