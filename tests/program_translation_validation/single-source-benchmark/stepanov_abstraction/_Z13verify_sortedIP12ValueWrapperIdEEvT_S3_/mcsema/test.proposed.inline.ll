...
@G__0x406b04 = global %G__0x406b04_type zeroinitializer
...
entry:
  ...
  store %struct.Memory* %loadMem_404111, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem1_404128, %struct.Memory** %MEMORY
...
block_404135:                                     ; preds = %entry
  ...
  store i64 ptrtoint (%G__0x406b04_type* @G__0x406b04 to i64), i64* %RDI.i, align 8
  ...
  store %struct.Memory* %loadMem_404146, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem1_404148, %struct.Memory** %MEMORY
  %loadMem2_404148 = load %struct.Memory*, %struct.Memory** %MEMORY
  %loadPC_404148 = load i64, i64* %3
  %224 = call %struct.Memory* @__remill_function_call(%struct.State* %0, i64 ptrtoint (i64 (i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64)* @printf to i64), %struct.Memory* %loadMem2_404148)
  ...
  store %struct.Memory* %loadMem_40414d, %struct.Memory** %MEMORY
  br label %block_.L_404150

block_.L_404150:                                  ; preds = %block_404135, %entry
  ...
  ret %struct.Memory* %loadMem_404155
}
...
define %struct.Memory* @routine_movq__0x406b04___rdi(%struct.State* dereferenceable(3376), i64, %struct.Memory*) {
block_400478:
  %3 = getelementptr inbounds %struct.State, %struct.State* %0, i32 0, i32 6
  %4 = getelementptr inbounds %struct.GPR, %struct.GPR* %3, i32 0, i32 33
  %5 = getelementptr inbounds %struct.Reg, %struct.Reg* %4, i32 0, i32 0
  ...
  %10 = add i64 %9, 10
  store i64 %10, i64* %PC
  store i64 ptrtoint (%G__0x406b04_type* @G__0x406b04 to i64), i64* %RDI, align 8
  ret %struct.Memory* %2
}
