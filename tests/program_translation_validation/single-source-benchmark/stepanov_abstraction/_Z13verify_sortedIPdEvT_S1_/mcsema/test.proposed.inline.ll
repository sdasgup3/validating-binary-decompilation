...
entry:
  ...
  store %struct.Memory* %loadMem1_404b98, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_404b9d, %struct.Memory** %MEMORY
...
block_404ba5:                                     ; preds = %entry
  ...
  %224 = call %struct.Memory* @__remill_function_call(%struct.State* %0, i64 ptrtoint (i64 (i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64)* @printf to i64), %struct.Memory* %loadMem2_404bb8)
...
block_.L_404bc0:                                  ; preds = %block_404ba5, %entry
  ...
  ret %struct.Memory* %loadMem_404bc5
}
