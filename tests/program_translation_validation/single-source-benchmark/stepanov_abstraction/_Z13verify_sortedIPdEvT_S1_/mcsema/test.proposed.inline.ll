...
entry:
  ...
  store %struct.Memory* %loadMem1_404be8, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_404bed, %struct.Memory** %MEMORY
...
block_404bf5:                                     ; preds = %entry
  ...
  store %struct.Memory* %loadMem1_404c08, %struct.Memory** %MEMORY
  %loadMem2_404c08 = load %struct.Memory*, %struct.Memory** %MEMORY
  %loadPC_404c08 = load i64, i64* %3
  %224 = call %struct.Memory* @__remill_function_call(%struct.State* %0, i64 ptrtoint (i64 (i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64)* @printf to i64), %struct.Memory* %loadMem2_404c08)
...
block_.L_404c10:                                  ; preds = %block_404bf5, %entry
  ...
  ret %struct.Memory* %loadMem_404c15
}
