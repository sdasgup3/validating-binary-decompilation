...
define %struct.Memory* @_Z13verify_sortedIPdEvT_S1_(%struct.State* noalias, i64, %struct.Memory* noalias) #1 {
entry:
  ...
  store %struct.Memory* %loadMem1_404bd8, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_404bdd, %struct.Memory** %MEMORY
