...
entry:
  ...
  store i32 0, i32* %168
  store %struct.Memory* %loadMem_402c51, %struct.Memory** %MEMORY
  br label %block_.L_402c58

block_.L_402c58:                                  ; preds = %block_402c68, %entry
...
block_402c68:                                     ; preds = %block_.L_402c58
  ...
  store %struct.Memory* %loadMem1_402c8c, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_402c99, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem1_402ca9, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_402cc2, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem1_402cc6, %struct.Memory** %MEMORY
...
block_.L_402cd9:                                  ; preds = %block_.L_402c58
  ...
  ret %struct.Memory* %loadMem_402cde
}
