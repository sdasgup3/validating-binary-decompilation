...
declare %struct.Memory* @sub_402da0._ZN9benchmark8heapsortI14PointerWrapperI12ValueWrapperIS2_IS2_IS2_IS2_IS2_IS2_IS2_IS2_IS2_IdEEEEEEEEEEESC_EEvT_SE_(%struct.State* noalias dereferenceable(3376), i64, %struct.Memory* noalias) local_unnamed_addr
...
block_.L_402c98:                                  ; preds = %block_402ca8, %entry
  %80 = phi i64 [ %.pre, %entry ], [ %256, %block_402ca8 ]
  %MEMORY.0 = phi %struct.Memory* [ %2, %entry ], [ %call2_402d06, %block_402ca8 ]
  ...
  br i1 %113, label %block_402ca8, label %block_.L_402d19
...
block_402ca8:                                     ; preds = %block_.L_402c98
  ...
  %call2_402ccc = tail call %struct.Memory* @sub_402d20._ZN9benchmark4copyI14PointerWrapperI12ValueWrapperIS2_IS2_IS2_IS2_IS2_IS2_IS2_IS2_IS2_IdEEEEEEEEEEESD_EEvT_SE_T0_(%struct.State* nonnull %0, i64 %154, %struct.Memory* %MEMORY.0)
  ...
  %call2_402ce9 = tail call %struct.Memory* @sub_402da0._ZN9benchmark8heapsortI14PointerWrapperI12ValueWrapperIS2_IS2_IS2_IS2_IS2_IS2_IS2_IS2_IS2_IdEEEEEEEEEEESC_EEvT_SE_(%struct.State* nonnull %0, i64 %187, %struct.Memory* %call2_402ccc)
  ...
  %call2_402d06 = tail call %struct.Memory* @sub_402ef0._Z13verify_sortedI14PointerWrapperI12ValueWrapperIS1_IS1_IS1_IS1_IS1_IS1_IS1_IS1_IS1_IdEEEEEEEEEEEEvT_SD_(%struct.State* nonnull %0, i64 %220, %struct.Memory* %call2_402ce9)
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_jge_.L_402d19(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i8* nocapture %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_jmpq_.L_402c98(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
