...
declare %struct.Memory* @sub_4039f0._ZN9benchmark8heapsortI14PointerWrapperI12ValueWrapperIdEES3_EEvT_S5_(%struct.State* noalias dereferenceable(3376), i64, %struct.Memory* noalias) local_unnamed_addr
...
entry:
  ...
  br label %block_.L_402b68

block_.L_402b68:                                  ; preds = %block_402b78, %entry
  %80 = phi i64 [ %.pre, %entry ], [ %256, %block_402b78 ]
  %MEMORY.0 = phi %struct.Memory* [ %2, %entry ], [ %call2_402bd6, %block_402b78 ]
  ...
  br i1 %113, label %block_402b78, label %block_.L_402be9

block_402b78:                                     ; preds = %block_.L_402b68
  %115 = add i64 %81, -8
  %116 = add i64 %114, 4
  ...
  %call2_402b9c = tail call %struct.Memory* @sub_403970._ZN9benchmark4copyI14PointerWrapperI12ValueWrapperIdEES4_EEvT_S5_T0_(%struct.State* nonnull %0, i64 %154, %struct.Memory* %MEMORY.0)
  ...
  %call2_402bb9 = tail call %struct.Memory* @sub_4039f0._ZN9benchmark8heapsortI14PointerWrapperI12ValueWrapperIdEES3_EEvT_S5_(%struct.State* nonnull %0, i64 %187, %struct.Memory* %call2_402b9c)
  ...
  %call2_402bd6 = tail call %struct.Memory* @sub_403b40._Z13verify_sortedI14PointerWrapperI12ValueWrapperIdEEEvT_S4_(%struct.State* nonnull %0, i64 %220, %struct.Memory* %call2_402bb9)
...
block_.L_402be9:                                  ; preds = %block_.L_402b68
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_jge_.L_402be9(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i8* nocapture %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_jmpq_.L_402b68(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
