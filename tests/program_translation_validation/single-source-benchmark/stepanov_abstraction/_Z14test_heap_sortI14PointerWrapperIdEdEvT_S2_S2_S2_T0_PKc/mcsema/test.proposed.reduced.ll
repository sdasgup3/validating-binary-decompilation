; ModuleID = '/tmp/tmpb9b0s6oc-query.ll'
...
define %struct.Memory* @_Z14test_heap_sortI14PointerWrapperIdEdEvT_S2_S2_S2_T0_PKc(%struct.State* noalias nocapture readonly, i64, %struct.Memory* noalias readnone returned) local_unnamed_addr #1 {
entry:
  ...
  br i1 %var_2_113, label %block_.L_402a48.preheader, label %block_.L_402ac9.split

block_.L_402a48.preheader:                        ; preds = %entry
  br label %block_.L_402a48

block_.L_402a48:                                  ; preds = %block_.L_402a48.preheader, %block_.L_402a48
  br label %block_.L_402a48

block_.L_402ac9.split:                            ; preds = %entry
