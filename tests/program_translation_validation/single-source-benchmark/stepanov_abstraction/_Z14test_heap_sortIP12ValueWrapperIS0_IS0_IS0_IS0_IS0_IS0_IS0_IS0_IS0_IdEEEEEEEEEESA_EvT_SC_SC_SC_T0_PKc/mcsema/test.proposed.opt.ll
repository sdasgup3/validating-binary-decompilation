...
declare %struct.Memory* @sub_4035e0._ZN9benchmark8heapsortIP12ValueWrapperIS1_IS1_IS1_IS1_IS1_IS1_IS1_IS1_IS1_IdEEEEEEEEEESB_EEvT_SD_(%struct.State* dereferenceable(3376), i64, %struct.Memory*) local_unnamed_addr
...
define %struct.Memory* @_Z14test_heap_sortIP12ValueWrapperIS0_IS0_IS0_IS0_IS0_IS0_IS0_IS0_IS0_IdEEEEEEEEEESA_EvT_SC_SC_SC_T0_PKc(%struct.State* noalias, i64, %struct.Memory* noalias) local_unnamed_addr #1 {
entry:
...
block_.L_402c18:                                  ; preds = %block_402c28, %entry
  %79 = phi i64 [ %.pre, %entry ], [ %192, %block_402c28 ]
  %MEMORY.0 = phi %struct.Memory* [ %2, %entry ], [ %call2_402c4e, %block_402c28 ]
...
block_402c28:                                     ; preds = %block_.L_402c18
  ...
  %call2_402c34 = tail call %struct.Memory* @sub_403590._ZN9benchmark4copyIP12ValueWrapperIS1_IS1_IS1_IS1_IS1_IS1_IS1_IS1_IS1_IdEEEEEEEEEESC_EEvT_SD_T0_(%struct.State* nonnull %0, i64 %126, %struct.Memory* %MEMORY.0)
  ...
  %call2_402c41 = tail call %struct.Memory* @sub_4035e0._ZN9benchmark8heapsortIP12ValueWrapperIS1_IS1_IS1_IS1_IS1_IS1_IS1_IS1_IS1_IdEEEEEEEEEESB_EEvT_SD_(%struct.State* nonnull %0, i64 %141, %struct.Memory* %call2_402c34)
  ...
  %call2_402c4e = tail call %struct.Memory* @sub_4036e0._Z13verify_sortedIP12ValueWrapperIS0_IS0_IS0_IS0_IS0_IS0_IS0_IS0_IS0_IdEEEEEEEEEEEvT_SC_(%struct.State* nonnull %0, i64 %156, %struct.Memory* %call2_402c41)
