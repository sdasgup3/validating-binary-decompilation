; ModuleID = '/tmp/tmpsom8yslv-query.ll'
...
define %struct.Memory* @_Z14test_heap_sortIP12ValueWrapperIS0_IS0_IS0_IS0_IS0_IS0_IS0_IS0_IS0_IdEEEEEEEEEESA_EvT_SC_SC_SC_T0_PKc(%struct.State* noalias nocapture readonly, i64, %struct.Memory* noalias readnone returned) local_unnamed_addr #1 {
entry:
  %RBP.i = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 15, i32 0, i32 0
  %var_2_80 = load i64, i64* %RBP.i, align 8
  %var_2_81 = add i64 %var_2_80, -52
  %var_2_83 = inttoptr i64 %var_2_81 to i32*
  %var_2_84 = load i32, i32* %var_2_83, align 4
  %var_2_86 = load i32, i32* bitcast (%G_0x609088_type* @G_0x609088 to i32*), align 8
  %var_2_87 = sub i32 %var_2_84, %var_2_86
  %var_2_102 = lshr i32 %var_2_87, 31
  %var_2_104 = lshr i32 %var_2_84, 31
  %var_2_105 = lshr i32 %var_2_86, 31
  %var_2_106 = xor i32 %var_2_105, %var_2_104
  %var_2_107 = xor i32 %var_2_102, %var_2_104
  %var_2_108 = add nuw nsw i32 %var_2_107, %var_2_106
  %var_2_109 = icmp eq i32 %var_2_108, 2
  %var_2_111 = icmp ne i32 %var_2_102, 0
  %var_2_112 = xor i1 %var_2_111, %var_2_109
  br i1 %var_2_112, label %block_.L_402c28.preheader, label %block_.L_402c71.split

block_.L_402c28.preheader:                        ; preds = %entry
  br label %block_.L_402c28

block_.L_402c28:                                  ; preds = %block_.L_402c28.preheader, %block_.L_402c28
  br label %block_.L_402c28

block_.L_402c71.split:                            ; preds = %entry
