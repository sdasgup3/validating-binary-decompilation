...
declare %struct.Memory* @sub_404010._ZN9benchmark8heapsortIP12ValueWrapperIdES2_EEvT_S4_(%struct.State* noalias dereferenceable(3376), i64, %struct.Memory* noalias readnone returned) local_unnamed_addr
...
block_.L_402aa8:                                  ; preds = %block_402ab8, %entry
  %79 = phi i64 [ %.pre, %entry ], [ %192, %block_402ab8 ]
  %MEMORY.0 = phi %struct.Memory* [ %2, %entry ], [ %call2_402ade, %block_402ab8 ]
  ...
  br i1 %112, label %block_402ab8, label %block_.L_402af1

block_402ab8:                                     ; preds = %block_.L_402aa8
  %114 = add i64 %80, -16
  %115 = add i64 %113, 4
  ...
  %call2_402ac4 = tail call %struct.Memory* @sub_403fc0._ZN9benchmark4copyIP12ValueWrapperIdES3_EEvT_S4_T0_(%struct.State* %0, i64 %126, %struct.Memory* %MEMORY.0)
  ...
  %call2_402ad1 = tail call %struct.Memory* @sub_404010._ZN9benchmark8heapsortIP12ValueWrapperIdES2_EEvT_S4_(%struct.State* %0, i64 %141, %struct.Memory* %call2_402ac4)
  ...
  %call2_402ade = tail call %struct.Memory* @sub_404110._Z13verify_sortedIP12ValueWrapperIdEEvT_S3_(%struct.State* %0, i64 %156, %struct.Memory* %call2_402ad1)
...
block_.L_402af1:                                  ; preds = %block_.L_402aa8
...
define %struct.Memory* @routine_jge_.L_402af1(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i8* %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
...
define %struct.Memory* @routine_callq_._ZN9benchmark8heapsortIP12ValueWrapperIdES2_EEvT_S4_(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
...
define %struct.Memory* @routine_jmpq_.L_402aa8(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
