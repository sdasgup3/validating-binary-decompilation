...
declare %struct.Memory* @sub_404060._ZN9benchmark8heapsortIP12ValueWrapperIdES2_EEvT_S4_(%struct.State* noalias dereferenceable(3376), i64, %struct.Memory* noalias readnone returned) local_unnamed_addr
...
block_.L_402af8:                                  ; preds = %block_402b08, %entry
  %79 = phi i64 [ %192, %block_402b08 ], [ %.pre, %entry ]
  ...
  br i1 %112, label %block_402b08, label %block_.L_402b41
...
block_402b08:                                     ; preds = %block_.L_402af8
  ...
  %call2_402b14 = tail call %struct.Memory* @sub_404010._ZN9benchmark4copyIP12ValueWrapperIdES3_EEvT_S4_T0_(%struct.State* nonnull %0, i64 %126, %struct.Memory* %2)
  ...
  %call2_402b21 = tail call %struct.Memory* @sub_404060._ZN9benchmark8heapsortIP12ValueWrapperIdES2_EEvT_S4_(%struct.State* nonnull %0, i64 %141, %struct.Memory* %2)
  ...
  %call2_402b2e = tail call %struct.Memory* @sub_404160._Z13verify_sortedIP12ValueWrapperIdEEvT_S3_(%struct.State* nonnull %0, i64 %156, %struct.Memory* %2)
