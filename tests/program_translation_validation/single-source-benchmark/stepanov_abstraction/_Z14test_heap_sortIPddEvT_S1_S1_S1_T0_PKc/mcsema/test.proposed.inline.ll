...
define %struct.Memory* @_Z14test_heap_sortIPddEvT_S1_S1_S1_T0_PKc(%struct.State* noalias, i64, %struct.Memory* noalias) #1 {
entry:
...
block_4029c8:                                     ; preds = %block_.L_4029b8
  ...
  store %struct.Memory* %loadMem1_4029d4, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem1_4029e1, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_4029e6, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem1_4029ee, %struct.Memory** %MEMORY
...
block_.L_402a01:                                  ; preds = %block_.L_4029b8
  ...
  ret %struct.Memory* %loadMem_402a06
}
