...
declare %struct.Memory* @sub_404a90._ZN9benchmark8heapsortIPddEEvT_S2_(%struct.State* noalias dereferenceable(3376), i64, %struct.Memory* noalias readnone returned) local_unnamed_addr
...
define %struct.Memory* @_Z14test_heap_sortIPddEvT_S1_S1_S1_T0_PKc(%struct.State* noalias, i64, %struct.Memory* noalias) local_unnamed_addr #1 {
entry:
  ...
  br label %block_.L_402978

block_.L_402978:                                  ; preds = %block_402988, %entry
  %79 = phi i64 [ %.pre, %entry ], [ %192, %block_402988 ]
  %MEMORY.0 = phi %struct.Memory* [ %2, %entry ], [ %call2_4029ae, %block_402988 ]
  ...
  br i1 %112, label %block_402988, label %block_.L_4029c1

block_402988:                                     ; preds = %block_.L_402978
  %114 = add i64 %80, -8
  %115 = add i64 %113, 4
  ...
  %call2_402994 = tail call %struct.Memory* @sub_404a40._ZN9benchmark4copyIPdS1_EEvT_S2_T0_(%struct.State* %0, i64 %126, %struct.Memory* %MEMORY.0)
  ...
  %call2_4029a1 = tail call %struct.Memory* @sub_404a90._ZN9benchmark8heapsortIPddEEvT_S2_(%struct.State* %0, i64 %141, %struct.Memory* %call2_402994)
  ...
  %call2_4029ae = tail call %struct.Memory* @sub_404b80._Z13verify_sortedIPdEvT_S1_(%struct.State* %0, i64 %156, %struct.Memory* %call2_4029a1)
...
block_.L_4029c1:                                  ; preds = %block_.L_402978
...
define %struct.Memory* @routine_jge_.L_4029c1(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i8* %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
...
define %struct.Memory* @routine_callq_._ZN9benchmark8heapsortIPddEEvT_S2_(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
...
define %struct.Memory* @routine_jmpq_.L_402978(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
