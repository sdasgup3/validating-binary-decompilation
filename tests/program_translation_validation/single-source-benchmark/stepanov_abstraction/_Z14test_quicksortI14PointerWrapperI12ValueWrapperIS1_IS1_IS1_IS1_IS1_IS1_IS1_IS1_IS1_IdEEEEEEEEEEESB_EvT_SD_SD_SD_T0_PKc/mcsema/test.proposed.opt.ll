...
define %struct.Memory* @_Z14test_quicksortI14PointerWrapperI12ValueWrapperIS1_IS1_IS1_IS1_IS1_IS1_IS1_IS1_IS1_IdEEEEEEEEEEESB_EvT_SD_SD_SD_T0_PKc(%struct.State* noalias, i64, %struct.Memory* noalias) local_unnamed_addr #1 {
entry:
...
block_.L_4028c8:                                  ; preds = %block_4028d8, %entry
  %80 = phi i64 [ %.pre, %entry ], [ %257, %block_4028d8 ]
  %MEMORY.0 = phi %struct.Memory* [ %2, %entry ], [ %call2_402936, %block_4028d8 ]
  ...
  br i1 %113, label %block_4028d8, label %block_.L_402949
...
block_4028d8:                                     ; preds = %block_.L_4028c8
  ...
  %call2_4028fc = tail call %struct.Memory* @sub_402ce0._ZN9benchmark4copyI14PointerWrapperI12ValueWrapperIS2_IS2_IS2_IS2_IS2_IS2_IS2_IS2_IS2_IdEEEEEEEEEEESD_EEvT_SE_T0_(%struct.State* %0, i64 %154, %struct.Memory* %MEMORY.0)
  ...
  %call2_402919 = tail call %struct.Memory* @sub_404df0._ZN9benchmark9quicksortI14PointerWrapperI12ValueWrapperIS2_IS2_IS2_IS2_IS2_IS2_IS2_IS2_IS2_IdEEEEEEEEEEESC_EEvT_SE_(%struct.State* %0, i64 %187, %struct.Memory* %call2_4028fc)
  ...
  %call2_402936 = tail call %struct.Memory* @sub_402eb0._Z13verify_sortedI14PointerWrapperI12ValueWrapperIS1_IS1_IS1_IS1_IS1_IS1_IS1_IS1_IS1_IdEEEEEEEEEEEEvT_SD_(%struct.State* %0, i64 %220, %struct.Memory* %call2_402919)
...
define %struct.Memory* @routine_jge_.L_402949(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i8* %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
...
define %struct.Memory* @routine_jmpq_.L_4028c8(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
