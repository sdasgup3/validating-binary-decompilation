; ModuleID = '/tmp/tmpeim93k2p-query.ll'
...
define %struct.Memory* @_Z14test_quicksortI14PointerWrapperI12ValueWrapperIdEES2_EvT_S4_S4_S4_T0_PKc(%struct.State* noalias nocapture readonly, i64, %struct.Memory* noalias readnone returned) local_unnamed_addr #1 {
entry:
  %RBP.i = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 15, i32 0, i32 0
  %var_2_81 = load i64, i64* %RBP.i, align 8
  %var_2_82 = add i64 %var_2_81, -52
  %var_2_84 = inttoptr i64 %var_2_82 to i32*
  %var_2_85 = load i32, i32* %var_2_84, align 4
  %var_2_87 = load i32, i32* bitcast (%G_0x609088_type* @G_0x609088 to i32*), align 8
  %var_2_88 = sub i32 %var_2_85, %var_2_87
  %var_2_103 = lshr i32 %var_2_88, 31
  %var_2_105 = lshr i32 %var_2_85, 31
  %var_2_106 = lshr i32 %var_2_87, 31
  %var_2_107 = xor i32 %var_2_106, %var_2_105
  %var_2_108 = xor i32 %var_2_103, %var_2_105
  %var_2_109 = add nuw nsw i32 %var_2_108, %var_2_107
  %var_2_110 = icmp eq i32 %var_2_109, 2
  %var_2_112 = icmp ne i32 %var_2_103, 0
  %var_2_113 = xor i1 %var_2_112, %var_2_110
  br i1 %var_2_113, label %block_.L_4027e8.preheader, label %block_.L_402869.split

block_.L_4027e8.preheader:                        ; preds = %entry
  br label %block_.L_4027e8

block_.L_4027e8:                                  ; preds = %block_.L_4027e8.preheader, %block_.L_4027e8
  br label %block_.L_4027e8

block_.L_402869.split:                            ; preds = %entry
