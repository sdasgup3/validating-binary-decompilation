...
block_.L_4026b8:                                  ; preds = %block_4026c8, %entry
  %80 = phi i64 [ %256, %block_4026c8 ], [ %.pre, %entry ]
  ...
  br i1 %113, label %block_4026c8, label %block_.L_402739
...
block_4026c8:                                     ; preds = %block_.L_4026b8
  ...
  %call2_4026ec = tail call %struct.Memory* @sub_4043f0._ZN9benchmark4copyI14PointerWrapperIdES2_EEvT_S3_T0_(%struct.State* nonnull %0, i64 %154, %struct.Memory* %2)
  ...
  %call2_402709 = tail call %struct.Memory* @sub_405440._ZN9benchmark9quicksortI14PointerWrapperIdEdEEvT_S3_(%struct.State* nonnull %0, i64 %187, %struct.Memory* %2)
  ...
  %call2_402726 = tail call %struct.Memory* @sub_4045b0._Z13verify_sortedI14PointerWrapperIdEEvT_S2_(%struct.State* nonnull %0, i64 %220, %struct.Memory* %2)
