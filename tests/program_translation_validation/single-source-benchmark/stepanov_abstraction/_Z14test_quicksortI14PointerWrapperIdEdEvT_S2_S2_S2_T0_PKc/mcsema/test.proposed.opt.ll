...
block_.L_402668:                                  ; preds = %block_402678, %entry
  %80 = phi i64 [ %.pre, %entry ], [ %257, %block_402678 ]
  %MEMORY.0 = phi %struct.Memory* [ %2, %entry ], [ %call2_4026d6, %block_402678 ]
  ...
  br i1 %113, label %block_402678, label %block_.L_4026e9

block_402678:                                     ; preds = %block_.L_402668
  %115 = add i64 %81, -8
  %116 = add i64 %114, 4
  ...
  %call2_40269c = tail call %struct.Memory* @sub_4043a0._ZN9benchmark4copyI14PointerWrapperIdES2_EEvT_S3_T0_(%struct.State* %0, i64 %154, %struct.Memory* %MEMORY.0)
  ...
  %call2_4026b9 = tail call %struct.Memory* @sub_4053f0._ZN9benchmark9quicksortI14PointerWrapperIdEdEEvT_S3_(%struct.State* %0, i64 %187, %struct.Memory* %call2_40269c)
  ...
  %call2_4026d6 = tail call %struct.Memory* @sub_404560._Z13verify_sortedI14PointerWrapperIdEEvT_S2_(%struct.State* %0, i64 %220, %struct.Memory* %call2_4026b9)
...
block_.L_4026e9:                                  ; preds = %block_.L_402668
...
define %struct.Memory* @routine_jge_.L_4026e9(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i8* %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
...
define %struct.Memory* @routine_jmpq_.L_402668(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
