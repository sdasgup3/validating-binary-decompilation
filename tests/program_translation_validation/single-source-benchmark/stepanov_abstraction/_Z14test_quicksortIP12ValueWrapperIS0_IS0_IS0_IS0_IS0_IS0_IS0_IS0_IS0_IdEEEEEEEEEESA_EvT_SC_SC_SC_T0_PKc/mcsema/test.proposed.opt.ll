...
declare %struct.Memory* @sub_405020._ZN9benchmark9quicksortIP12ValueWrapperIS1_IS1_IS1_IS1_IS1_IS1_IS1_IS1_IS1_IdEEEEEEEEEESB_EEvT_SD_(%struct.State* noalias dereferenceable(3376), i64, %struct.Memory* noalias readnone returned) local_unnamed_addr
...
block_.L_402898:                                  ; preds = %block_4028a8, %entry
  %79 = phi i64 [ %192, %block_4028a8 ], [ %.pre, %entry ]
  ...
  br i1 %112, label %block_4028a8, label %block_.L_4028e1
...
block_4028a8:                                     ; preds = %block_.L_402898
  ...
  %call2_4028b4 = tail call %struct.Memory* @sub_4035a0._ZN9benchmark4copyIP12ValueWrapperIS1_IS1_IS1_IS1_IS1_IS1_IS1_IS1_IS1_IdEEEEEEEEEESC_EEvT_SD_T0_(%struct.State* nonnull %0, i64 %126, %struct.Memory* %2)
  ...
  %call2_4028c1 = tail call %struct.Memory* @sub_405020._ZN9benchmark9quicksortIP12ValueWrapperIS1_IS1_IS1_IS1_IS1_IS1_IS1_IS1_IS1_IdEEEEEEEEEESB_EEvT_SD_(%struct.State* nonnull %0, i64 %141, %struct.Memory* %2)
  ...
  %call2_4028ce = tail call %struct.Memory* @sub_4036f0._Z13verify_sortedIP12ValueWrapperIS0_IS0_IS0_IS0_IS0_IS0_IS0_IS0_IS0_IdEEEEEEEEEEEvT_SC_(%struct.State* nonnull %0, i64 %156, %struct.Memory* %2)
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_jge_.L_4028e1(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i8* nocapture %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_jmpq_.L_402898(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
