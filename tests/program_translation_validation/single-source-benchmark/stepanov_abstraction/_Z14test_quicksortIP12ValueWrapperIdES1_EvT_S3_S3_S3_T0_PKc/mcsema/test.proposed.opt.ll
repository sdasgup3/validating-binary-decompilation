...
declare %struct.Memory* @sub_405310._ZN9benchmark9quicksortIP12ValueWrapperIdES2_EEvT_S4_(%struct.State* dereferenceable(3376), i64, %struct.Memory*) local_unnamed_addr
...
block_.L_402758:                                  ; preds = %block_402768, %entry
  %79 = phi i64 [ %.pre, %entry ], [ %192, %block_402768 ]
  %MEMORY.0 = phi %struct.Memory* [ %2, %entry ], [ %call2_40278e, %block_402768 ]
  ...
  br i1 %112, label %block_402768, label %block_.L_4027a1
...
block_402768:                                     ; preds = %block_.L_402758
  ...
  %call2_402774 = tail call %struct.Memory* @sub_404000._ZN9benchmark4copyIP12ValueWrapperIdES3_EEvT_S4_T0_(%struct.State* nonnull %0, i64 %126, %struct.Memory* %MEMORY.0)
  ...
  %call2_402781 = tail call %struct.Memory* @sub_405310._ZN9benchmark9quicksortIP12ValueWrapperIdES2_EEvT_S4_(%struct.State* nonnull %0, i64 %141, %struct.Memory* %call2_402774)
  ...
  %call2_40278e = tail call %struct.Memory* @sub_404150._Z13verify_sortedIP12ValueWrapperIdEEvT_S3_(%struct.State* nonnull %0, i64 %156, %struct.Memory* %call2_402781)
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_jge_.L_4027a1(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i8* nocapture %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_jmpq_.L_402758(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
