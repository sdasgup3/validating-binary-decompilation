...
declare %struct.Memory* @sub_405310._ZN9benchmark9quicksortIP12ValueWrapperIdES2_EEvT_S4_(%struct.State* noalias dereferenceable(3376), i64, %struct.Memory* noalias readnone returned) local_unnamed_addr
...
define %struct.Memory* @_Z14test_quicksortIP12ValueWrapperIdES1_EvT_S3_S3_S3_T0_PKc(%struct.State* noalias, i64, %struct.Memory* noalias readnone) local_unnamed_addr #1 {
entry:
...
block_.L_402758:                                  ; preds = %block_402768, %entry
  %79 = phi i64 [ %192, %block_402768 ], [ %.pre, %entry ]
...
block_402768:                                     ; preds = %block_.L_402758
  ...
  %call2_402774 = tail call %struct.Memory* @sub_404000._ZN9benchmark4copyIP12ValueWrapperIdES3_EEvT_S4_T0_(%struct.State* nonnull %0, i64 %126, %struct.Memory* %2)
  ...
  %call2_402781 = tail call %struct.Memory* @sub_405310._ZN9benchmark9quicksortIP12ValueWrapperIdES2_EEvT_S4_(%struct.State* nonnull %0, i64 %141, %struct.Memory* %2)
  ...
  %call2_40278e = tail call %struct.Memory* @sub_404150._Z13verify_sortedIP12ValueWrapperIdEEvT_S3_(%struct.State* nonnull %0, i64 %156, %struct.Memory* %2)
