...
declare %struct.Memory* @sub_4055e0._ZN9benchmark9quicksortIPddEEvT_S2_(%struct.State* noalias dereferenceable(3376), i64, %struct.Memory* noalias readnone returned) local_unnamed_addr
...
block_.L_4025e8:                                  ; preds = %block_4025f8, %entry
  %79 = phi i64 [ %.pre, %entry ], [ %193, %block_4025f8 ]
  %MEMORY.0 = phi %struct.Memory* [ %2, %entry ], [ %call2_40261e, %block_4025f8 ]
  ...
  br i1 %112, label %block_4025f8, label %block_.L_402631

block_4025f8:                                     ; preds = %block_.L_4025e8
  %114 = add i64 %80, -8
  %115 = add i64 %113, 4
  ...
  %call2_402604 = tail call %struct.Memory* @sub_404a40._ZN9benchmark4copyIPdS1_EEvT_S2_T0_(%struct.State* %0, i64 %126, %struct.Memory* %MEMORY.0)
  ...
  %call2_402611 = tail call %struct.Memory* @sub_4055e0._ZN9benchmark9quicksortIPddEEvT_S2_(%struct.State* %0, i64 %141, %struct.Memory* %call2_402604)
  ...
  %call2_40261e = tail call %struct.Memory* @sub_404b80._Z13verify_sortedIPdEvT_S1_(%struct.State* %0, i64 %156, %struct.Memory* %call2_402611)
...
block_.L_402631:                                  ; preds = %block_.L_4025e8
...
define %struct.Memory* @routine_jge_.L_402631(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i8* %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
...
define %struct.Memory* @routine_callq_._ZN9benchmark9quicksortIPddEEvT_S2_(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
...
define %struct.Memory* @routine_jmpq_.L_4025e8(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
