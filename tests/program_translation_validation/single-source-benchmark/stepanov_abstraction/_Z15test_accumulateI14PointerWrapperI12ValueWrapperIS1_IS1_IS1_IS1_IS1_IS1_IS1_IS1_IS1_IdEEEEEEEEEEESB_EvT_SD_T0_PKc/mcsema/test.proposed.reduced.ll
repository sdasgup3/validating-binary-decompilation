; ModuleID = '/tmp/tmpcrd8wy6q-query.ll'
...
define %struct.Memory* @_Z15test_accumulateI14PointerWrapperI12ValueWrapperIS1_IS1_IS1_IS1_IS1_IS1_IS1_IS1_IS1_IdEEEEEEEEEEESB_EvT_SD_T0_PKc(%struct.State* noalias nocapture readonly, i64, %struct.Memory* noalias readnone returned) local_unnamed_addr #1 {
entry:
  ...
  br i1 %var_2_103, label %block_.L_402100.preheader, label %block_.L_40215b.split

block_.L_402100.preheader:                        ; preds = %entry
  br label %block_.L_402100

block_.L_402100:                                  ; preds = %block_.L_402100.preheader, %block_.L_402100
  br label %block_.L_402100

block_.L_40215b.split:                            ; preds = %entry
