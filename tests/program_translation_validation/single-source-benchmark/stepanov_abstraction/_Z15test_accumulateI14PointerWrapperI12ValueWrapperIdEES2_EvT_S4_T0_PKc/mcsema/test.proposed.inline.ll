...
define %struct.Memory* @_Z15test_accumulateI14PointerWrapperI12ValueWrapperIdEES2_EvT_S4_T0_PKc(%struct.State* noalias, i64, %struct.Memory* noalias) #1 {
entry:
...
block_401ff0:                                     ; preds = %block_.L_401fe0
  ...
  store %struct.Memory* %loadMem1_402015, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_40201e, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem1_402023, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem1_402028, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_40202d, %struct.Memory** %MEMORY
...
block_.L_40203b:                                  ; preds = %block_.L_401fe0
  ...
  store %struct.Memory* %loadMem_40203b, %struct.Memory** %MEMORY
  ...
  ret %struct.Memory* %loadMem_402040
}
