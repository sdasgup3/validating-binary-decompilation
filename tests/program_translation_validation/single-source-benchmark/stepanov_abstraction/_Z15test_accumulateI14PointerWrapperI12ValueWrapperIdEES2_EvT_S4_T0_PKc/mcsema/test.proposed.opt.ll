...
declare %struct.Memory* @sub_406390._ZN9benchmark10accumulateI14PointerWrapperI12ValueWrapperIdEES3_EET0_T_S6_S5_(%struct.State* noalias dereferenceable(3376), i64, %struct.Memory* noalias) local_unnamed_addr
...
block_.L_401fe0:                                  ; preds = %block_401ff0, %entry
  %70 = phi i64 [ %.pre, %entry ], [ %198, %block_401ff0 ]
  %MEMORY.0 = phi %struct.Memory* [ %2, %entry ], [ %call2_402028, %block_401ff0 ]
  ...
  br i1 %103, label %block_401ff0, label %block_.L_40203b

block_401ff0:                                     ; preds = %block_.L_401fe0
  %105 = add i64 %71, -8
  %106 = add i64 %104, 4
  ...
  %call2_402015 = tail call %struct.Memory* @sub_406390._ZN9benchmark10accumulateI14PointerWrapperI12ValueWrapperIdEES3_EET0_T_S6_S5_(%struct.State* nonnull %0, i64 %144, %struct.Memory* %MEMORY.0)
  ...
  %call2_402023 = tail call %struct.Memory* @sub_405f50._ZNK12ValueWrapperIdEcvT_IdEEv(%struct.State* nonnull %0, i64 %156, %struct.Memory* %call2_402015)
  %161 = load i64, i64* %3, align 8
  %162 = add i64 %161, 15816
  %163 = add i64 %161, 5
  ...
  %call2_402028 = tail call %struct.Memory* @sub_405df0._Z9check_sumd(%struct.State* nonnull %0, i64 %162, %struct.Memory* %call2_402023)
...
block_.L_40203b:                                  ; preds = %block_.L_401fe0
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_jge_.L_40203b(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i8* nocapture %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_jmpq_.L_401fe0(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
