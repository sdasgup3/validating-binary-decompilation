...
declare %struct.Memory* @sub_406350._ZN9benchmark10accumulateI14PointerWrapperI12ValueWrapperIdEES3_EET0_T_S6_S5_(%struct.State* noalias dereferenceable(3376), i64, %struct.Memory* noalias readnone returned) local_unnamed_addr
...
define %struct.Memory* @_Z15test_accumulateI14PointerWrapperI12ValueWrapperIdEES2_EvT_S4_T0_PKc(%struct.State* noalias, i64, %struct.Memory* noalias) local_unnamed_addr #1 {
entry:
...
block_.L_401fa0:                                  ; preds = %block_401fb0, %entry
  %71 = phi i64 [ %.pre, %entry ], [ %199, %block_401fb0 ]
  %MEMORY.0 = phi %struct.Memory* [ %2, %entry ], [ %call2_401fe8, %block_401fb0 ]
  ...
  br i1 %104, label %block_401fb0, label %block_.L_401ffb

block_401fb0:                                     ; preds = %block_.L_401fa0
  %106 = add i64 %72, -8
  %107 = add i64 %105, 4
  ...
  %call2_401fd5 = tail call %struct.Memory* @sub_406350._ZN9benchmark10accumulateI14PointerWrapperI12ValueWrapperIdEES3_EET0_T_S6_S5_(%struct.State* %0, i64 %145, %struct.Memory* %MEMORY.0)
  ...
  %call2_401fe3 = tail call %struct.Memory* @sub_405f10._ZNK12ValueWrapperIdEcvT_IdEEv(%struct.State* %0, i64 %157, %struct.Memory* %call2_401fd5)
  %162 = load i64, i64* %3, align 8
  %163 = add i64 %162, 15816
  %164 = add i64 %162, 5
  ...
  %call2_401fe8 = tail call %struct.Memory* @sub_405db0._Z9check_sumd(%struct.State* %0, i64 %163, %struct.Memory* %call2_401fe3)
...
block_.L_401ffb:                                  ; preds = %block_.L_401fa0
...
define %struct.Memory* @routine_jge_.L_401ffb(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i8* %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
...
define %struct.Memory* @routine_callq_._ZN9benchmark10accumulateI14PointerWrapperI12ValueWrapperIdEES3_EET0_T_S6_S5_(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
...
define %struct.Memory* @routine_jmpq_.L_401fa0(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
