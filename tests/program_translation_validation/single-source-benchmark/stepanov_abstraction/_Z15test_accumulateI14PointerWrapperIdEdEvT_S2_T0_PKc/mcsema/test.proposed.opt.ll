...
declare %struct.Memory* @sub_406480._ZN9benchmark10accumulateI14PointerWrapperIdEdEET0_T_S4_S3_(%struct.State* noalias dereferenceable(3376), i64, %struct.Memory* noalias) local_unnamed_addr
...
block_.L_401ef0:                                  ; preds = %block_401f00, %entry
  ...
  %101 = icmp ne i8 %93, 0
  %102 = xor i1 %101, %99
  %.v = select i1 %102, i64 16, i64 69
  %103 = add i64 %69, %.v
  store i64 %103, i64* %3, align 8
  br i1 %102, label %block_401f00, label %block_.L_401f35
...
block_401f00:                                     ; preds = %block_.L_401ef0
  ...
  store i64 %133, i64* %RSI.i45, align 8
  %134 = add i64 %122, 17776
  %135 = add i64 %122, 18
  ...
  store i64 %152, i64* %RAX.i36, align 8
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_jge_.L_401f35(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i8* nocapture %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_jmpq_.L_401ef0(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
