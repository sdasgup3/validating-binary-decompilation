; ModuleID = '/tmp/tmpslzapmpq-query.ll'
...
define %struct.Memory* @_Z15test_accumulateIP12ValueWrapperIdES1_EvT_S3_T0_PKc(%struct.State* noalias nocapture readonly, i64, %struct.Memory* noalias readnone returned) local_unnamed_addr #1 {
entry:
  ...
  %var_2_76 = load i32, i32* bitcast (%G_0x609088_type* @G_0x609088 to i32*), align 8
  ...
  br i1 %var_2_102, label %block_.L_401f70.preheader, label %block_.L_401fbb.split

block_.L_401f70.preheader:                        ; preds = %entry
  br label %block_.L_401f70

block_.L_401f70:                                  ; preds = %block_.L_401f70.preheader, %block_.L_401f70
  br label %block_.L_401f70

block_.L_401fbb.split:                            ; preds = %entry
