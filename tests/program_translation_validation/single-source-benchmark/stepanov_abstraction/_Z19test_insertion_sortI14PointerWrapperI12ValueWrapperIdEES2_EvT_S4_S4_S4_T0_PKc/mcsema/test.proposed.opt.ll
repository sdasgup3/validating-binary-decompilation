...
declare %struct.Memory* @sub_405940._ZN9benchmark13insertionSortI14PointerWrapperI12ValueWrapperIdEES3_EEvT_S5_(%struct.State* noalias dereferenceable(3376), i64, %struct.Memory* noalias readnone returned) local_unnamed_addr
...
define %struct.Memory* @_Z19test_insertion_sortI14PointerWrapperI12ValueWrapperIdEES2_EvT_S4_S4_S4_T0_PKc(%struct.State* noalias, i64, %struct.Memory* noalias readnone) local_unnamed_addr #1 {
entry:
...
block_.L_402448:                                  ; preds = %block_402458, %entry
  %80 = phi i64 [ %256, %block_402458 ], [ %.pre, %entry ]
...
block_402458:                                     ; preds = %block_.L_402448
  ...
  %call2_40247c = tail call %struct.Memory* @sub_403970._ZN9benchmark4copyI14PointerWrapperI12ValueWrapperIdEES4_EEvT_S5_T0_(%struct.State* nonnull %0, i64 %154, %struct.Memory* %2)
  ...
  %call2_402499 = tail call %struct.Memory* @sub_405940._ZN9benchmark13insertionSortI14PointerWrapperI12ValueWrapperIdEES3_EEvT_S5_(%struct.State* nonnull %0, i64 %187, %struct.Memory* %2)
  ...
  %call2_4024b6 = tail call %struct.Memory* @sub_403b40._Z13verify_sortedI14PointerWrapperI12ValueWrapperIdEEEvT_S4_(%struct.State* nonnull %0, i64 %220, %struct.Memory* %2)
