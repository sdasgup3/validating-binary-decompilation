...
declare %struct.Memory* @sub_405900._ZN9benchmark13insertionSortI14PointerWrapperI12ValueWrapperIdEES3_EEvT_S5_(%struct.State* noalias dereferenceable(3376), i64, %struct.Memory* noalias readnone returned) local_unnamed_addr
...
block_.L_402408:                                  ; preds = %block_402418, %entry
  %80 = phi i64 [ %.pre, %entry ], [ %256, %block_402418 ]
  %MEMORY.0 = phi %struct.Memory* [ %2, %entry ], [ %call2_402476, %block_402418 ]
  ...
  br i1 %113, label %block_402418, label %block_.L_402489

block_402418:                                     ; preds = %block_.L_402408
  %115 = add i64 %81, -8
  %116 = add i64 %114, 4
  ...
  %call2_40243c = tail call %struct.Memory* @sub_403930._ZN9benchmark4copyI14PointerWrapperI12ValueWrapperIdEES4_EEvT_S5_T0_(%struct.State* %0, i64 %154, %struct.Memory* %MEMORY.0)
  ...
  %call2_402459 = tail call %struct.Memory* @sub_405900._ZN9benchmark13insertionSortI14PointerWrapperI12ValueWrapperIdEES3_EEvT_S5_(%struct.State* %0, i64 %187, %struct.Memory* %call2_40243c)
  ...
  %call2_402476 = tail call %struct.Memory* @sub_403b00._Z13verify_sortedI14PointerWrapperI12ValueWrapperIdEEEvT_S4_(%struct.State* %0, i64 %220, %struct.Memory* %call2_402459)
...
block_.L_402489:                                  ; preds = %block_.L_402408
...
define %struct.Memory* @routine_jge_.L_402489(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i8* %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
...
define %struct.Memory* @routine_callq_._ZN9benchmark13insertionSortI14PointerWrapperI12ValueWrapperIdEES3_EEvT_S5_(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
...
define %struct.Memory* @routine_jmpq_.L_402408(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
