; ModuleID = '/tmp/tmpiyh281r9-query.ll'
...
define %struct.Memory* @_Z19test_insertion_sortI14PointerWrapperI12ValueWrapperIdEES2_EvT_S4_S4_S4_T0_PKc(%struct.State* noalias nocapture readonly, i64, %struct.Memory* noalias readnone returned) local_unnamed_addr #1 {
entry:
  ...
  br i1 %var_2_113, label %block_.L_402458.preheader, label %block_.L_4024d9.split

block_.L_402458.preheader:                        ; preds = %entry
  br label %block_.L_402458

block_.L_402458:                                  ; preds = %block_.L_402458.preheader, %block_.L_402458
  br label %block_.L_402458

block_.L_4024d9.split:                            ; preds = %entry
  ret %struct.Memory* %2
}
