...
declare %struct.Memory* @sub_405b30._ZN9benchmark13insertionSortI14PointerWrapperIdEdEEvT_S3_(%struct.State* dereferenceable(3376), i64, %struct.Memory*) local_unnamed_addr
