...
block_.L_402318:                                  ; preds = %block_402328, %entry
  ...
  br i1 %113, label %block_402328, label %block_.L_402399

block_402328:                                     ; preds = %block_.L_402318
  %115 = add i64 %81, -8
  %116 = add i64 %114, 4
...
block_.L_402399:                                  ; preds = %block_.L_402318
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_jge_.L_402399(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i8* nocapture %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_jmpq_.L_402318(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
