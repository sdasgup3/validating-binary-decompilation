; ModuleID = '/tmp/tmpkd13tmvw-query.ll'
...
define %struct.Memory* @_Z19test_insertion_sortI14PointerWrapperIdEdEvT_S2_S2_S2_T0_PKc(%struct.State* noalias nocapture readonly, i64, %struct.Memory* noalias readnone returned) local_unnamed_addr #1 {
entry:
  ...
  br i1 %var_2_113, label %block_.L_402328.preheader, label %block_.L_4023a9.split

block_.L_402328.preheader:                        ; preds = %entry
  br label %block_.L_402328

block_.L_402328:                                  ; preds = %block_.L_402328.preheader, %block_.L_402328
  br label %block_.L_402328

block_.L_4023a9.split:                            ; preds = %entry
  ret %struct.Memory* %2
}
