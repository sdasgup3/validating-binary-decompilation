; ModuleID = '/tmp/tmph92bq7db-query.ll'
...
define %struct.Memory* @_Z19test_insertion_sortIP12ValueWrapperIS0_IS0_IS0_IS0_IS0_IS0_IS0_IS0_IS0_IdEEEEEEEEEESA_EvT_SC_SC_SC_T0_PKc(%struct.State* noalias nocapture readonly, i64, %struct.Memory* noalias readnone returned) local_unnamed_addr #1 {
entry:
  ...
  br i1 %var_2_112, label %block_.L_402508.preheader, label %block_.L_402551.split

block_.L_402508.preheader:                        ; preds = %entry
  br label %block_.L_402508

block_.L_402508:                                  ; preds = %block_.L_402508.preheader, %block_.L_402508
  br label %block_.L_402508

block_.L_402551.split:                            ; preds = %entry
