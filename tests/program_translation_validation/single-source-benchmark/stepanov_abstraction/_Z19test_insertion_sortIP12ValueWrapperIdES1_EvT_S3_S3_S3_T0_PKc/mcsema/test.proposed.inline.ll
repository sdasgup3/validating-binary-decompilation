...
define %struct.Memory* @_Z19test_insertion_sortIP12ValueWrapperIdES1_EvT_S3_S3_S3_T0_PKc(%struct.State* noalias, i64, %struct.Memory* noalias) #1 {
entry:
...
block_4023d8:                                     ; preds = %block_.L_4023c8
  ...
  store %struct.Memory* %loadMem1_4023e4, %struct.Memory** %MEMORY
...
block_.L_402411:                                  ; preds = %block_.L_4023c8
  ...
  ret %struct.Memory* %loadMem_402416
}
