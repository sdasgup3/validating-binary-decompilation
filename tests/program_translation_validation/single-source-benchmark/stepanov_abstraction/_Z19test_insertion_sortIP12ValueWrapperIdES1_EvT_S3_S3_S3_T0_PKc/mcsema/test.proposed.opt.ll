...
declare %struct.Memory* @sub_405a60._ZN9benchmark13insertionSortIP12ValueWrapperIdES2_EEvT_S4_(%struct.State* noalias dereferenceable(3376), i64, %struct.Memory* noalias readnone returned) local_unnamed_addr
...
block_.L_4023c8:                                  ; preds = %block_4023d8, %entry
  %79 = phi i64 [ %192, %block_4023d8 ], [ %.pre, %entry ]
...
block_4023d8:                                     ; preds = %block_.L_4023c8
  ...
  %call2_4023e4 = tail call %struct.Memory* @sub_404000._ZN9benchmark4copyIP12ValueWrapperIdES3_EEvT_S4_T0_(%struct.State* nonnull %0, i64 %126, %struct.Memory* %2)
  ...
  %call2_4023f1 = tail call %struct.Memory* @sub_405a60._ZN9benchmark13insertionSortIP12ValueWrapperIdES2_EEvT_S4_(%struct.State* nonnull %0, i64 %141, %struct.Memory* %2)
  ...
  %call2_4023fe = tail call %struct.Memory* @sub_404150._Z13verify_sortedIP12ValueWrapperIdEEvT_S3_(%struct.State* nonnull %0, i64 %156, %struct.Memory* %2)
