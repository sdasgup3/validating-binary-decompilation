; ModuleID = '/tmp/tmp3ild_ahs-query.ll'
...
define %struct.Memory* @_Z19test_insertion_sortIP12ValueWrapperIdES1_EvT_S3_S3_S3_T0_PKc(%struct.State* noalias nocapture readonly, i64, %struct.Memory* noalias readnone returned) local_unnamed_addr #1 {
entry:
  ...
  br i1 %var_2_112, label %block_.L_4023d8.preheader, label %block_.L_402421.split

block_.L_4023d8.preheader:                        ; preds = %entry
  br label %block_.L_4023d8

block_.L_4023d8:                                  ; preds = %block_.L_4023d8.preheader, %block_.L_4023d8
  br label %block_.L_4023d8

block_.L_402421.split:                            ; preds = %entry
  ret %struct.Memory* %2
}
