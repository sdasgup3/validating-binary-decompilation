...
declare %struct.Memory* @sub_404a80._ZN9benchmark4copyIPdS1_EEvT_S2_T0_(%struct.State* dereferenceable(3376), i64, %struct.Memory*)

declare %struct.Memory* @sub_405c70._ZN9benchmark13insertionSortIPddEEvT_S2_(%struct.State* dereferenceable(3376), i64, %struct.Memory*)

declare %struct.Memory* @sub_404bc0._Z13verify_sortedIPdEvT_S1_(%struct.State* dereferenceable(3376), i64, %struct.Memory*)

; Function Attrs: alwaysinline
define %struct.Memory* @_Z19test_insertion_sortIPddEvT_S1_S1_S1_T0_PKc(%struct.State* noalias, i64, %struct.Memory* noalias) #1 {
entry:
