...
declare %struct.Memory* @sub_405c70._ZN9benchmark13insertionSortIPddEEvT_S2_(%struct.State* dereferenceable(3376), i64, %struct.Memory*) local_unnamed_addr
...
block_.L_402298:                                  ; preds = %block_4022a8, %entry
  %79 = phi i64 [ %.pre, %entry ], [ %192, %block_4022a8 ]
  %MEMORY.0 = phi %struct.Memory* [ %2, %entry ], [ %call2_4022ce, %block_4022a8 ]
...
block_4022a8:                                     ; preds = %block_.L_402298
  ...
  %call2_4022b4 = tail call %struct.Memory* @sub_404a80._ZN9benchmark4copyIPdS1_EEvT_S2_T0_(%struct.State* nonnull %0, i64 %126, %struct.Memory* %MEMORY.0)
  ...
  %call2_4022c1 = tail call %struct.Memory* @sub_405c70._ZN9benchmark13insertionSortIPddEEvT_S2_(%struct.State* nonnull %0, i64 %141, %struct.Memory* %call2_4022b4)
  ...
  %call2_4022ce = tail call %struct.Memory* @sub_404bc0._Z13verify_sortedIPdEvT_S1_(%struct.State* nonnull %0, i64 %156, %struct.Memory* %call2_4022c1)
