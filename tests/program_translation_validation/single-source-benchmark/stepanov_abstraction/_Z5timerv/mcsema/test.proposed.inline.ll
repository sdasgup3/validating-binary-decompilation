...
%G_0x5517__rip__4198897__type = type <{ [16 x i8] }>
...
@G_0x5517__rip__4198897_ = global %G_0x5517__rip__4198897__type zeroinitializer
...
entry:
  ...
  %43 = call %struct.Memory* @__remill_function_call(%struct.State* %0, i64 ptrtoint (i64 ()* @clock to i64), %struct.Memory* %loadMem2_4011e4)
  ...
  %53 = load double, double* bitcast (%G_0x5517__rip__4198897__type* @G_0x5517__rip__4198897_ to double*)
  ...
  store i64 %63, i64* bitcast (%G_0x609128_type* @G_0x609128 to i64*)
  ...
  %74 = load i64, i64* bitcast (%G_0x609128_type* @G_0x609128 to i64*)
  ...
  %84 = load i64, i64* bitcast (%G_0x609120_type* @G_0x609120 to i64*)
  %85 = sub i64 %81, %84
  ...
  ret %struct.Memory* %loadMem_401216
}
...
block_400478:
  ...
  %9 = load i64, i64* %PC
  %10 = ptrtoint %G_0x5517__rip__4198897__type* @G_0x5517__rip__4198897_ to i64
  %11 = load i64, i64* %PC
  %12 = add i64 %11, 8
  store i64 %12, i64* %PC
