...
@G_0x5517__rip__4198897_= global %G_0x5517__rip__4198897__type <{ [16 x i8] c"\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00" }>
...
entry:
  ...
  ; Code: ._Z5timerv:	 RIP: 4011e0	 Bytes: 0
  ...
  ; Code: callq .clock_plt	 RIP: 4011e4	 Bytes: 5
  %loadMem1_4011e4 = load %struct.Memory*, %struct.Memory** %MEMORY
  %call1_4011e4 = call %struct.Memory* @routine_callq_.clock_plt(%struct.State* %0, i64  0, %struct.Memory* %loadMem1_4011e4, i64 -2900, i64 5, i64 5)
  ...
  %call2_4011e4 = call %struct.Memory* @ext_clock(%struct.State* %0, i64  %loadPC_4011e4, %struct.Memory* %loadMem2_4011e4)
  store %struct.Memory* %call2_4011e4, %struct.Memory** %MEMORY

  ; Code: movsd 0x5517(%rip), %xmm0	 RIP: 4011e9	 Bytes: 8
  %loadMem_4011e9 = load %struct.Memory*, %struct.Memory** %MEMORY
  %call_4011e9 = call %struct.Memory* @routine_movsd_0x5517__rip____xmm0(%struct.State* %0, i64  0, %struct.Memory* %loadMem_4011e9)
  store %struct.Memory* %call_4011e9, %struct.Memory** %MEMORY

  ; Code: movq %rax, 0x609128	 RIP: 4011f1	 Bytes: 8
  %loadMem_4011f1 = load %struct.Memory*, %struct.Memory** %MEMORY
  %call_4011f1 = call %struct.Memory* @routine_movq__rax__0x609128(%struct.State* %0, i64  0, %struct.Memory* %loadMem_4011f1)
  store %struct.Memory* %call_4011f1, %struct.Memory** %MEMORY

  ; Code: movq 0x609128, %rax	 RIP: 4011f9	 Bytes: 8
  %loadMem_4011f9 = load %struct.Memory*, %struct.Memory** %MEMORY
  %call_4011f9 = call %struct.Memory* @routine_movq_0x609128___rax(%struct.State* %0, i64  0, %struct.Memory* %loadMem_4011f9)
  store %struct.Memory* %call_4011f9, %struct.Memory** %MEMORY

  ; Code: subq 0x609120, %rax	 RIP: 401201	 Bytes: 8
  %loadMem_401201 = load %struct.Memory*, %struct.Memory** %MEMORY
  %call_401201 = call %struct.Memory* @routine_subq_0x609120___rax(%struct.State* %0, i64  0, %struct.Memory* %loadMem_401201)
  store %struct.Memory* %call_401201, %struct.Memory** %MEMORY

  ; Code: cvtsi2sdq %rax, %xmm1	 RIP: 401209	 Bytes: 5
  %loadMem_401209 = load %struct.Memory*, %struct.Memory** %MEMORY
  %call_401209 = call %struct.Memory* @routine_cvtsi2sdq__rax___xmm1(%struct.State* %0, i64  0, %struct.Memory* %loadMem_401209)
  store %struct.Memory* %call_401209, %struct.Memory** %MEMORY

  ; Code: divsd %xmm0, %xmm1	 RIP: 40120e	 Bytes: 4
  %loadMem_40120e = load %struct.Memory*, %struct.Memory** %MEMORY
  %call_40120e = call %struct.Memory* @routine_divsd__xmm0___xmm1(%struct.State* %0, i64  0, %struct.Memory* %loadMem_40120e)
  store %struct.Memory* %call_40120e, %struct.Memory** %MEMORY

  ; Code: movaps %xmm1, %xmm0	 RIP: 401212	 Bytes: 3
  %loadMem_401212 = load %struct.Memory*, %struct.Memory** %MEMORY
  %call_401212 = call %struct.Memory* @routine_movaps__xmm1___xmm0(%struct.State* %0, i64  0, %struct.Memory* %loadMem_401212)
  store %struct.Memory* %call_401212, %struct.Memory** %MEMORY

  ; Code: popq %rbp	 RIP: 401215	 Bytes: 1
  %loadMem_401215 = load %struct.Memory*, %struct.Memory** %MEMORY
  %call_401215 = call %struct.Memory* @routine_popq__rbp(%struct.State* %0, i64  0, %struct.Memory* %loadMem_401215)
  store %struct.Memory* %call_401215, %struct.Memory** %MEMORY

  ; Code: retq	 RIP: 401216	 Bytes: 1
  %loadMem_401216 = load %struct.Memory*, %struct.Memory** %MEMORY
  %call_401216 = call %struct.Memory* @routine_retq(%struct.State* %0, i64  0, %struct.Memory* %loadMem_401216)
  store %struct.Memory* %call_401216, %struct.Memory** %MEMORY

  ret %struct.Memory* %call_401216
}
