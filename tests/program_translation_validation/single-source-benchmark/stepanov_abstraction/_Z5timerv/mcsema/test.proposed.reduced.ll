; ModuleID = '/tmp/tmp_xl843jq-query.ll'
...
; Matched:%var_2_12:  %var_2_12 = add i64 %var_2_11, -2897
; %var_2_11 = add i64 %var_2_10, -2897
...
%var_2_19 = add i64 %var_2_18, ptrtoint (%G_0x5517__rip__type* @G_0x5517__rip_ to i64)
...
; store i64 %var_2_24, i64* bitcast (%G_0x609128_type* @G_0x609128 to i64*), align 8
%var_2_25 = load i64, i64* bitcast (%G_0x609120_type* @G_0x609120 to i64*), align 8
