...
@G_0x5a72__rip_ = local_unnamed_addr global %G_0x5a72__rip__type zeroinitializer
...
entry:
  ...
  %49 = load i64, i64* bitcast (%G_0x5a72__rip__type* @G_0x5a72__rip_ to i64*), align 8
...
block_.L_400cda:                                  ; preds = %block_.L_400d1d, %entry
  %137 = phi i64 [ %.pre, %entry ], [ %297, %block_.L_400d1d ]
  %MEMORY.0 = phi %struct.Memory* [ %2, %entry ], [ %214, %block_.L_400d1d ]
  ...
  %144 = load i32, i32* bitcast (%G_0x609118_type* @G_0x609118 to i32*), align 8
  %145 = sub i32 %142, %144
  ...
  br i1 %170, label %block_400cea, label %block_.L_400d30

block_400cea:                                     ; preds = %block_.L_400cda
  %172 = load i64, i64* bitcast (%G_0x609110_type* @G_0x609110 to i64*), align 8
  ...
  br i1 %259, label %block_.L_400d1d, label %block_400d17
...
block_.L_400d1d:                                  ; preds = %block_400d17, %block_400cea
  %265 = phi i64 [ %.pre2, %block_400d17 ], [ %222, %block_400cea ]
  %266 = phi i64 [ %.pre1, %block_400d17 ], [ %260, %block_400cea ]
  %267 = add i64 %265, -28
  %268 = add i64 %266, 8
...
block_.L_400d7e:                                  ; preds = %block_400d8e, %block_.L_400d30
  %364 = phi i64 [ %.pre3, %block_.L_400d30 ], [ %736, %block_400d8e ]
  %MEMORY.2 = phi %struct.Memory* [ %347, %block_.L_400d30 ], [ %697, %block_400d8e ]
  ...
  %371 = load i32, i32* bitcast (%G_0x609118_type* @G_0x609118 to i32*), align 8
  %372 = sub i32 %369, %371
  ...
  br i1 %397, label %block_400d8e, label %block_.L_400e7a
...
block_400d8e:                                     ; preds = %block_.L_400d7e
  ...
  %407 = load i64, i64* bitcast (%G_0x609110_type* @G_0x609110 to i64*), align 8
  ...
  store i64 ptrtoint (%G__0x4067a0_type* @G__0x4067a0 to i64), i64* %446, align 8
  ...
  %506 = load i64, i64* bitcast (%G_0x609110_type* @G_0x609110 to i64*), align 8
  ...
  store double 0.000000e+00, double* %53, align 1
  %587 = load i64, i64* bitcast (%G_0x609110_type* @G_0x609110 to i64*), align 8
  ...
  %661 = load i64, i64* bitcast (%G_0x609110_type* @G_0x609110 to i64*), align 8
...
block_.L_400e81:                                  ; preds = %block_400e91, %block_.L_400e7a
  %738 = phi i64 [ %847, %block_400e91 ], [ %.pre4, %block_.L_400e7a ]
  ...
  %745 = load i32, i32* bitcast (%G_0x609118_type* @G_0x609118 to i32*), align 8
  %746 = sub i32 %743, %745
  ...
  br i1 %771, label %block_400e91, label %block_.L_400ec0

block_400e91:                                     ; preds = %block_.L_400e81
  %773 = load i64, i64* bitcast (%G_0x609110_type* @G_0x609110 to i64*), align 8
...
block_.L_400ec0:                                  ; preds = %block_.L_400e81
  ...
  %864 = load i32, i32* bitcast (%G_0x609118_type* @G_0x609118 to i32*), align 8
  %865 = add i32 %864, -1
  ...
  br i1 %899, label %block_.L_400f88, label %block_400eeb
...
block_400eeb:                                     ; preds = %block_.L_400ec0
  ...
  br i1 %911, label %block_.L_400f88, label %block_400ef5
...
block_.L_400efc:                                  ; preds = %block_400f0c, %block_400ef5
  %919 = phi i64 [ %.pre5, %block_400ef5 ], [ %1041, %block_400f0c ]
  %MEMORY.4 = phi %struct.Memory* [ %862, %block_400ef5 ], [ %999, %block_400f0c ]
  ...
  %926 = load i32, i32* bitcast (%G_0x609118_type* @G_0x609118 to i32*), align 8
  %927 = sub i32 %924, %926
  ...
  br i1 %952, label %block_400f0c, label %block_.L_400f4c

block_400f0c:                                     ; preds = %block_.L_400efc
  %954 = load i64, i64* bitcast (%G_0x609110_type* @G_0x609110 to i64*), align 8
...
block_.L_400f88:                                  ; preds = %block_.L_400f4c, %block_400eeb, %block_.L_400ec0
  %1101 = phi i64 [ %900, %block_.L_400ec0 ], [ %915, %block_400eeb ], [ %.pre6, %block_.L_400f4c ]
  %MEMORY.5 = phi %struct.Memory* [ %862, %block_.L_400ec0 ], [ %862, %block_400eeb ], [ %1094, %block_.L_400f4c ]
...
block_400478:
  ...
  %5 = load i64, i64* bitcast (%G_0x5a72__rip__type* @G_0x5a72__rip_ to i64*), align 8
