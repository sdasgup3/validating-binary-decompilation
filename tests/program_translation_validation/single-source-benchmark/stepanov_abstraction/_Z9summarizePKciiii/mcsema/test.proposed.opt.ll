...
block_.L_400d7e:                                  ; preds = %block_400d8e, %block_.L_400d30
  %361 = phi i64 [ %.pre3, %block_.L_400d30 ], [ %731, %block_400d8e ]
  %MEMORY.2 = phi %struct.Memory* [ %344, %block_.L_400d30 ], [ %693, %block_400d8e ]
...
block_400d8e:                                     ; preds = %block_.L_400d7e
  ...
  store double 0.000000e+00, double* %53, align 1
  %583 = load i64, i64* bitcast (%G_0x609110_type* @G_0x609110 to i64*), align 8
  ...
  %657 = load i64, i64* bitcast (%G_0x609110_type* @G_0x609110 to i64*), align 8
...
block_.L_400e81:                                  ; preds = %block_400e91, %block_.L_400e7a
  %733 = phi i64 [ %841, %block_400e91 ], [ %.pre4, %block_.L_400e7a ]
  ...
  %740 = load i32, i32* bitcast (%G_0x609118_type* @G_0x609118 to i32*), align 8
  %741 = sub i32 %738, %740
  ...
  br i1 %766, label %block_400e91, label %block_.L_400ec0

block_400e91:                                     ; preds = %block_.L_400e81
  %768 = load i64, i64* bitcast (%G_0x609110_type* @G_0x609110 to i64*), align 8
...
block_.L_400ec0:                                  ; preds = %block_.L_400e81
  ...
  %857 = load i32, i32* bitcast (%G_0x609118_type* @G_0x609118 to i32*), align 8
  %858 = add i32 %857, -1
  ...
  br i1 %892, label %block_.L_400f88, label %block_400eeb
...
block_400eeb:                                     ; preds = %block_.L_400ec0
  ...
  br i1 %904, label %block_.L_400f88, label %block_400ef5
...
block_.L_400efc:                                  ; preds = %block_400f0c, %block_400ef5
  %912 = phi i64 [ %.pre5, %block_400ef5 ], [ %1033, %block_400f0c ]
  %MEMORY.4 = phi %struct.Memory* [ %855, %block_400ef5 ], [ %992, %block_400f0c ]
  ...
  %919 = load i32, i32* bitcast (%G_0x609118_type* @G_0x609118 to i32*), align 8
  %920 = sub i32 %917, %919
  ...
  br i1 %945, label %block_400f0c, label %block_.L_400f4c

block_400f0c:                                     ; preds = %block_.L_400efc
  %947 = load i64, i64* bitcast (%G_0x609110_type* @G_0x609110 to i64*), align 8
...
block_.L_400f88:                                  ; preds = %block_.L_400f4c, %block_400eeb, %block_.L_400ec0
  %1093 = phi i64 [ %893, %block_.L_400ec0 ], [ %908, %block_400eeb ], [ %.pre6, %block_.L_400f4c ]
  %MEMORY.5 = phi %struct.Memory* [ %855, %block_.L_400ec0 ], [ %855, %block_400eeb ], [ %1086, %block_.L_400f4c ]
