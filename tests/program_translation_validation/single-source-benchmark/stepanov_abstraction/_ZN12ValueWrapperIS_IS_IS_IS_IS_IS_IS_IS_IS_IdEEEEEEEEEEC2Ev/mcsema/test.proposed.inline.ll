...
define %struct.Memory* @_ZN12ValueWrapperIS_IS_IS_IS_IS_IS_IS_IS_IS_IdEEEEEEEEEEC2Ev(%struct.State* noalias, i64, %struct.Memory* noalias) #1 {
entry:
  ...
  store %struct.Memory* %loadMem1_401c40, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_401c45, %struct.Memory** %MEMORY
  ...
  ret %struct.Memory* %loadMem_401c4a
}
