...
define %struct.Memory* @_ZN12ValueWrapperIS_IS_IS_IS_IS_IS_IS_IS_IS_IdEEEEEEEEEEC2IS8_EERKT_(%struct.State* noalias, i64, %struct.Memory* noalias) #1 {
entry:
  ...
  %loadMem_405ff1 = load %struct.Memory*, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_405ff1, %struct.Memory** %MEMORY
  ...
  %loadMem_406000 = load %struct.Memory*, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_406000, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_40600a, %struct.Memory** %MEMORY
  ...
  ret %struct.Memory* %loadMem_40600b
}
