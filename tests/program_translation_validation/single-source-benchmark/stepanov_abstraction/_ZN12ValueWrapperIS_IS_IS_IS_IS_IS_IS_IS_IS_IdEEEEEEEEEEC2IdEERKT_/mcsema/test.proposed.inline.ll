...
declare %struct.Memory* @sub_406500._ZN12ValueWrapperIS_IS_IS_IS_IS_IS_IS_IS_IdEEEEEEEEEC2IdEERKT_(%struct.State* noalias dereferenceable(3376), i64, %struct.Memory* noalias readnone returned)
...
entry:
  ...
  %loadMem1_401d58 = load %struct.Memory*, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem1_401d58, %struct.Memory** %MEMORY
  %loadMem2_401d58 = load %struct.Memory*, %struct.Memory** %MEMORY
  %loadPC_401d58 = load i64, i64* %3
  %call2_401d58 = call %struct.Memory* @sub_406500._ZN12ValueWrapperIS_IS_IS_IS_IS_IS_IS_IS_IdEEEEEEEEEC2IdEERKT_(%struct.State* %0, i64 %loadPC_401d58, %struct.Memory* %loadMem2_401d58)
  store %struct.Memory* %call2_401d58, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_401d5d, %struct.Memory** %MEMORY
  ...
  ret %struct.Memory* %loadMem_401d62
}
