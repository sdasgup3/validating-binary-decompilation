...
define %struct.Memory* @_ZN12ValueWrapperIS_IS_IS_IS_IS_IS_IS_IS_IdEEEEEEEEEC2IS7_EERKT_(%struct.State* noalias, i64, %struct.Memory* noalias) #1 {
entry:
  ...
  %loadMem_40605c = load %struct.Memory*, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_40605c, %struct.Memory** %MEMORY
  ...
  %loadMem_406067 = load %struct.Memory*, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_406067, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_40606a, %struct.Memory** %MEMORY
  ...
  ret %struct.Memory* %loadMem_40606b
}
