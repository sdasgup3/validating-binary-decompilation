...
define %struct.Memory* @_ZN12ValueWrapperIS_IS_IS_IS_IS_IS_IS_IS_IdEEEEEEEEEC2IS7_EERKT_(%struct.State* noalias, i64, %struct.Memory* noalias) #2 {
entry:
  ...
  %loadMem_406077 = load %struct.Memory*, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_406077, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_40607a, %struct.Memory** %MEMORY
  ...
  ret %struct.Memory* %loadMem_40607b
}
