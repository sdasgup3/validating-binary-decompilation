...
define %struct.Memory* @_ZN12ValueWrapperIS_IS_IS_IS_IS_IS_IS_IdEEEEEEEEC2IS6_EERKT_(%struct.State* noalias, i64, %struct.Memory* noalias) #1 {
entry:
  ...
  store %struct.Memory* %loadMem_4060b1, %struct.Memory** %MEMORY
  ...
  %loadMem_4060b8 = load %struct.Memory*, %struct.Memory** %MEMORY
  ...
  store i64 %55, i64* %58
  store %struct.Memory* %loadMem_4060b8, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_4060c4, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_4060ca, %struct.Memory** %MEMORY
  ...
  ret %struct.Memory* %loadMem_4060cb
}
