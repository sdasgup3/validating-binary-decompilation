...
entry:
  ...
  store %struct.Memory* %loadMem_4060c1, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_4060d4, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_4060da, %struct.Memory** %MEMORY
  ...
  ret %struct.Memory* %loadMem_4060db
}
