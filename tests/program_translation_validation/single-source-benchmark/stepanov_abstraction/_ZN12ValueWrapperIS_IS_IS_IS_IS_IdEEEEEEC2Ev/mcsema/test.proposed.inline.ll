...
declare %struct.Memory* @sub_401c90._ZN12ValueWrapperIS_IS_IS_IS_IdEEEEEC2Ev(%struct.State* noalias dereferenceable(3376), i64, %struct.Memory* noalias readnone returned)
...
entry:
  ...
  store %struct.Memory* %loadMem1_401c80, %struct.Memory** %MEMORY
  %loadMem2_401c80 = load %struct.Memory*, %struct.Memory** %MEMORY
  %loadPC_401c80 = load i64, i64* %3
  %call2_401c80 = call %struct.Memory* @sub_401c90._ZN12ValueWrapperIS_IS_IS_IS_IdEEEEEC2Ev(%struct.State* %0, i64 %loadPC_401c80, %struct.Memory* %loadMem2_401c80)
  ...
  ret %struct.Memory* %loadMem_401c8a
}
