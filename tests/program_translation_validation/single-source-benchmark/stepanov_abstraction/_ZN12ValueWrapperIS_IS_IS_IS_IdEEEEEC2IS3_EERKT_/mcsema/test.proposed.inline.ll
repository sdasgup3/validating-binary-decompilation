...
entry:
  ...
  store %struct.Memory* %loadMem_4061f7, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_4061fa, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_4061fb, %struct.Memory** %MEMORY
  ret %struct.Memory* %loadMem_4061fb
}
