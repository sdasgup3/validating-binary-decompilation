...
declare %struct.Memory* @sub_406640._ZN12ValueWrapperIS_IS_IS_IdEEEEC2IdEERKT_(%struct.State* noalias dereferenceable(3376), i64, %struct.Memory* noalias readnone returned)

; Function Attrs: alwaysinline
define %struct.Memory* @_ZN12ValueWrapperIS_IS_IS_IS_IdEEEEEC2IdEERKT_(%struct.State* noalias, i64, %struct.Memory* noalias) #2 {
entry:
  ...
  store %struct.Memory* %loadMem_406624, %struct.Memory** %MEMORY
  %loadMem1_406628 = load %struct.Memory*, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem1_406628, %struct.Memory** %MEMORY
  %loadMem2_406628 = load %struct.Memory*, %struct.Memory** %MEMORY
  %loadPC_406628 = load i64, i64* %3
  %call2_406628 = call %struct.Memory* @sub_406640._ZN12ValueWrapperIS_IS_IS_IdEEEEC2IdEERKT_(%struct.State* %0, i64 %loadPC_406628, %struct.Memory* %loadMem2_406628)
  store %struct.Memory* %call2_406628, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_40662d, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_406631, %struct.Memory** %MEMORY
  ...
  ret %struct.Memory* %loadMem_406632
}
...
define %struct.Memory* @routine_callq_._ZN12ValueWrapperIS_IS_IS_IdEEEEC2IdEERKT_(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) {
block_400488:
  %3 = getelementptr inbounds %struct.State, %struct.State* %0, i32 0, i32 6
  %4 = getelementptr inbounds %struct.GPR, %struct.GPR* %3, i32 0, i32 33
  %5 = getelementptr inbounds %struct.Reg, %struct.Reg* %4, i32 0, i32 0
