...
declare %struct.Memory* @sub_401cd0._ZN12ValueWrapperIS_IS_IdEEEC2Ev(%struct.State* noalias dereferenceable(3376), i64, %struct.Memory* noalias readnone returned)
...
entry:
  ...
  %call2_401cc0 = call %struct.Memory* @sub_401cd0._ZN12ValueWrapperIS_IS_IdEEEC2Ev(%struct.State* %0, i64 %loadPC_401cc0, %struct.Memory* %loadMem2_401cc0)
