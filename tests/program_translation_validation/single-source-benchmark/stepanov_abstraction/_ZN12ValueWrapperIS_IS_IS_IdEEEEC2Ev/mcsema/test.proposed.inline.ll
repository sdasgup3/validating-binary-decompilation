...
declare %struct.Memory* @sub_401d10._ZN12ValueWrapperIS_IS_IdEEEC2Ev(%struct.State* dereferenceable(3376), i64, %struct.Memory*)

; Function Attrs: alwaysinline
define %struct.Memory* @_ZN12ValueWrapperIS_IS_IS_IdEEEEC2Ev(%struct.State* noalias, i64, %struct.Memory* noalias) #1 {
entry:
