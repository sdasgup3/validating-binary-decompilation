...
define %struct.Memory* @_ZN12ValueWrapperIS_IS_IdEEEC2Ev(%struct.State* noalias, i64, %struct.Memory* noalias) #2 {
entry:
  ...
  store %struct.Memory* %loadMem1_401d30, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_401d3a, %struct.Memory** %MEMORY
  ret %struct.Memory* %loadMem_401d3a
}
