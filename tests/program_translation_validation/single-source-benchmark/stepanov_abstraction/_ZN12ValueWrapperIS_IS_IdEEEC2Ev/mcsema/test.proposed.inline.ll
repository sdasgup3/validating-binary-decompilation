...
define %struct.Memory* @_ZN12ValueWrapperIS_IS_IdEEEC2Ev(%struct.State* noalias, i64, %struct.Memory* noalias) #1 {
entry:
  ...
  store %struct.Memory* %loadMem1_401d20, %struct.Memory** %MEMORY
  ...
  ret %struct.Memory* %loadMem_401d2a
}
