...
define %struct.Memory* @_ZN12ValueWrapperIS_IS_IdEEEC2IS1_EERKT_(%struct.State* noalias, i64, %struct.Memory* noalias) #2 {
entry:
  ...
  store %struct.Memory* %loadMem_4062bb, %struct.Memory** %MEMORY
  ret %struct.Memory* %loadMem_4062bb
}
