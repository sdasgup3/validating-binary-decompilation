...
define %struct.Memory* @_ZN12ValueWrapperIS_IS_IdEEEC2IdEERKT_(%struct.State* noalias, i64, %struct.Memory* noalias) #2 {
entry:
  ...
  store %struct.Memory* %loadMem1_406688, %struct.Memory** %MEMORY
  ...
  ret %struct.Memory* %loadMem_406692
}
