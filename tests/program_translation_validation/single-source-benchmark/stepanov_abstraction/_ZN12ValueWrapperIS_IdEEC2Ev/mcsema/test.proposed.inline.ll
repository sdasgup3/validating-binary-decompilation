...
define %struct.Memory* @_ZN12ValueWrapperIS_IdEEC2Ev(%struct.State* noalias, i64, %struct.Memory* noalias) #2 {
entry:
  ...
  store %struct.Memory* %loadMem1_401d50, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_401d5a, %struct.Memory** %MEMORY
  ret %struct.Memory* %loadMem_401d5a
}
