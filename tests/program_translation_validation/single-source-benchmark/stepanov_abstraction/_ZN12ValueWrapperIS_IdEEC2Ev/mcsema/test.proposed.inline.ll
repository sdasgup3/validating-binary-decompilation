...
define %struct.Memory* @_ZN12ValueWrapperIS_IdEEC2Ev(%struct.State* noalias, i64, %struct.Memory* noalias) #1 {
entry:
  ...
  store %struct.Memory* %loadMem1_401d40, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_401d49, %struct.Memory** %MEMORY
  ...
  ret %struct.Memory* %loadMem_401d4a
}
