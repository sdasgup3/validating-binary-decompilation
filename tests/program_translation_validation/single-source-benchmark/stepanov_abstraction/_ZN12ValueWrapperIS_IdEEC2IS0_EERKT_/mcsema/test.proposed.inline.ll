...
define %struct.Memory* @_ZN12ValueWrapperIS_IdEEC2IS0_EERKT_(%struct.State* noalias, i64, %struct.Memory* noalias) #1 {
entry:
  ...
  store %struct.Memory* %loadMem_406317, %struct.Memory** %MEMORY
  ...
  ret %struct.Memory* %loadMem_40631b
}
