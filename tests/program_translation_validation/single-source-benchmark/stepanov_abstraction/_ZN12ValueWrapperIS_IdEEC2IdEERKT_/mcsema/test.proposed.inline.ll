...
define %struct.Memory* @_ZN12ValueWrapperIS_IdEEC2IdEERKT_(%struct.State* noalias, i64, %struct.Memory* noalias) #1 {
entry:
  ...
  store %struct.Memory* %loadMem1_4066a8, %struct.Memory** %MEMORY
  ...
  ret %struct.Memory* %loadMem_4066b2
}
