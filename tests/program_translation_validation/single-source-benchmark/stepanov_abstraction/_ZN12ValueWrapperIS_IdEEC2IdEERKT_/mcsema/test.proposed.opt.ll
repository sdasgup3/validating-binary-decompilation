...
define %struct.Memory* @_ZN12ValueWrapperIS_IdEEC2IdEERKT_(%struct.State* noalias, i64, %struct.Memory* noalias) local_unnamed_addr #1 {
entry:
  ...
  %call2_406668 = tail call %struct.Memory* @sub_401d20._ZN12ValueWrapperIdEC2IdEERKT_(%struct.State* %0, i64 %60, %struct.Memory* %2)
  ...
  ret %struct.Memory* %call2_406668
}
