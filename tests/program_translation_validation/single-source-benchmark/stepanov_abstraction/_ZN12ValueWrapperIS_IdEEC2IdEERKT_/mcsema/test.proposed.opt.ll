...
declare %struct.Memory* @sub_401d60._ZN12ValueWrapperIdEC2IdEERKT_(%struct.State* dereferenceable(3376), i64, %struct.Memory*) local_unnamed_addr
...
entry:
  ...
  %call2_4066a8 = tail call %struct.Memory* @sub_401d60._ZN12ValueWrapperIdEC2IdEERKT_(%struct.State* %0, i64 %60, %struct.Memory* %2)
  ...
  ret %struct.Memory* %call2_4066a8
}
