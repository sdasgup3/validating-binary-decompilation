...
define %struct.Memory* @_ZN12ValueWrapperIdEC2Ev(%struct.State* noalias, i64, %struct.Memory* noalias) #2 {
entry:
  ...
  store %struct.Memory* %loadMem_401d11, %struct.Memory** %MEMORY
  ...
  ret %struct.Memory* %loadMem_401d19
}
