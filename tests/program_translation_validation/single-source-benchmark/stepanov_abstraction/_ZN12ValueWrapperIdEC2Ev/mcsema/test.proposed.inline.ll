...
define %struct.Memory* @_ZN12ValueWrapperIdEC2Ev(%struct.State* noalias, i64, %struct.Memory* noalias) #1 {
entry:
  ...
  %PC.i1 = bitcast %union.anon* %59 to i64*
  %60 = load i64, i64* %PC.i1
  %61 = add i64 %60, 1
  store i64 %61, i64* %PC.i1
  ...
  ret %struct.Memory* %loadMem_401d59
}
