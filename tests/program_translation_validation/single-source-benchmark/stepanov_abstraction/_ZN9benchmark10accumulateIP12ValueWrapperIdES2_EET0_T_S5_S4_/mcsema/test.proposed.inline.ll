...
define %struct.Memory* @_ZN9benchmark10accumulateIP12ValueWrapperIdES2_EET0_T_S5_S4_(%struct.State* noalias, i64, %struct.Memory* noalias) #1 {
entry:
...
block_.L_406425:                                  ; preds = %block_406433, %entry
...
block_406433:                                     ; preds = %block_.L_406425
  ...
  store %struct.Memory* %loadMem1_406449, %struct.Memory** %MEMORY
...
block_.L_406460:                                  ; preds = %block_.L_406425
  ...
  store %struct.Memory* %loadMem_406468, %struct.Memory** %MEMORY
  ...
  ret %struct.Memory* %loadMem_406472
}
