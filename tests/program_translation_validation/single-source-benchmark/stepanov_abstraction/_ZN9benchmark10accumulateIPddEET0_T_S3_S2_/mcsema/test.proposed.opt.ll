...
block_.L_4064c1:                                  ; preds = %block_4064cf, %entry
  %38 = phi i64 [ %116, %block_4064cf ], [ %.pre, %entry ]
  ...
  %78 = getelementptr inbounds %union.VectorReg, %union.VectorReg* %21, i64 0, i32 0, i32 0, i32 0, i64 0
