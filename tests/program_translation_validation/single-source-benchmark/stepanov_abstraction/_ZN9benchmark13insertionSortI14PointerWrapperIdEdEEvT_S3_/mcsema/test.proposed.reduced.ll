; ModuleID = '/tmp/tmpt40jg59n-query.ll'
...
define %struct.Memory* @_ZN9benchmark13insertionSortI14PointerWrapperIdEdEEvT_S3_(%struct.State* noalias, i64, %struct.Memory* noalias returned) local_unnamed_addr #1 {
entry:
  ...
  %var_2_44 = add i64 %var_2_41, -5262
  %call2_405b63 = tail call %struct.Memory* @sub_4046d0._ZppIdE14PointerWrapperIT_ERS2_i(%struct.State* %0, i64 %var_2_44, %struct.Memory* %2)
  %AL.i130 = bitcast %union.anon* %var_2_18 to i8*
  %var_2_725 = load i8, i8* %AL.i130, align 1
  %var_2_746 = and i8 %var_2_725, 1
  store i8 0, i8* %var_2_12, align 1
  store i8 0, i8* %var_2_16, align 1
  store i8 0, i8* %var_2_17, align 1
  store i8 0, i8* %var_2_14, align 1
  %var_2_807 = icmp eq i8 %var_2_746, 0
  br i1 %var_2_807, label %block_405b81, label %block_.L_405ba8.preheader.lr.ph

block_.L_405ba8.preheader.lr.ph:                  ; preds = %entry
  %var_4_3 = bitcast %union.anon* %var_2_18 to double**
  br label %block_.L_405ba8.preheader

block_.L_405ba8.preheader:                        ; preds = %block_405c02, %block_.L_405ba8.preheader.lr.ph
  %MEMORY.08 = phi %struct.Memory* [ %call2_405b63, %block_.L_405ba8.preheader.lr.ph ], [ %call2_405c5f, %block_405c02 ]
  br label %block_.L_405ba8

block_405b81.loopexit:                            ; preds = %block_405c02
  br label %block_405b81

block_405b81:                                     ; preds = %block_405b81.loopexit, %entry
; Matched:\<badref\>:  ret %struct.Memory* %2
; ret %struct.Memory* %2
ret %struct.Memory* %2


block_.L_405ba8:                                  ; preds = %block_.L_405c07, %block_.L_405ba8.preheader
  %MEMORY.1 = phi %struct.Memory* [ %call2_405c2f, %block_.L_405c07 ], [ %MEMORY.08, %block_.L_405ba8.preheader ]
  store i8 0, i8* %var_2_12, align 1
  store i8 0, i8* %var_2_16, align 1
  store i8 0, i8* %var_2_17, align 1
  store i8 0, i8* %var_2_14, align 1
  %var_2_168 = load i64, i64* %var_2_3, align 8
  %var_2_169 = load i8, i8* %var_2_15, align 1
  %var_2_170 = icmp eq i8 %var_2_169, 0
  br i1 %var_2_170, label %block_.L_405bc9, label %block_405bc4

block_405bc4:                                     ; preds = %block_.L_405ba8
  %var_2_172 = add i64 %var_2_168, 57
  br label %block_.L_405bf7

block_.L_405bc9:                                  ; preds = %block_.L_405ba8
  %var_2_1953 = load double*, double** %var_4_3, align 8
  %var_2_1982 = load double, double* %var_2_1953, align 8
  %var_2_199 = load i64, i64* %RBP.i, align 8
  %var_2_200 = add i64 %var_2_199, -80
  %var_4_4 = inttoptr i64 %var_2_200 to double*
  %var_2_2034 = load double, double* %var_4_4, align 8
  %var_2_204 = add i64 %var_2_168, 13
  %var_2_206 = fcmp uno double %var_2_1982, %var_2_2034
  br i1 %var_2_206, label %var_2_207, label %var_2_227

var_2_207:                                        ; preds = %block_.L_405bc9
  %var_2_208 = fadd double %var_2_1982, %var_2_2034
  %var_2_209 = bitcast double %var_2_208 to i64
  %var_2_210 = and i64 %var_2_209, 9221120237041090560
  %var_2_211 = icmp eq i64 %var_2_210, 9218868437227405312
  %var_2_212 = and i64 %var_2_209, 2251799813685247
  %var_2_213 = icmp ne i64 %var_2_212, 0
  %var_2_214 = and i1 %var_2_211, %var_2_213
  br i1 %var_2_214, label %var_2_215, label %var_2_227

var_2_215:                                        ; preds = %var_2_207
  %var_2_216 = tail call %struct.Memory* @__remill_error(%struct.State* nonnull dereferenceable(3376) %0, i64 %var_2_204, %struct.Memory* %MEMORY.1)
  %.pre8.pre = load i64, i64* %var_2_3, align 8
  br label %block_.L_405bf7

var_2_227:                                        ; preds = %var_2_207, %block_.L_405bc9
  store i8 0, i8* %var_2_17, align 1
  store i8 0, i8* %var_2_16, align 1
  store i8 0, i8* %var_2_14, align 1
  br label %block_.L_405bf7

block_.L_405bf7:                                  ; preds = %var_2_227, %var_2_215, %block_405bc4
  %var_2_261 = phi i64 [ %var_2_168, %block_405bc4 ], [ %.pre8.pre, %var_2_215 ], [ %var_2_168, %var_2_227 ]
  %var_2_239 = phi i64 [ %var_2_172, %block_405bc4 ], [ %.pre8.pre, %var_2_215 ], [ %var_2_168, %var_2_227 ]
  %MEMORY.2 = phi %struct.Memory* [ %MEMORY.1, %block_405bc4 ], [ %var_2_216, %var_2_215 ], [ %MEMORY.1, %var_2_227 ]
  %var_2_240 = load i64, i64* %RBP.i, align 8
  %var_2_241 = add i64 %var_2_240, -65
  %var_2_243 = inttoptr i64 %var_2_241 to i8*
  %var_2_244 = load i8, i8* %var_2_243, align 1
  %var_2_245 = and i8 %var_2_244, 1
  store i8 0, i8* %var_2_12, align 1
  store i8 0, i8* %var_2_16, align 1
  store i8 0, i8* %var_2_17, align 1
  store i8 0, i8* %var_2_14, align 1
  %var_2_251 = icmp eq i8 %var_2_245, 0
  br i1 %var_2_251, label %block_405c02, label %block_.L_405c07

block_405c02:                                     ; preds = %block_.L_405bf7
  %var_2_262 = add i64 %var_2_261, -5387
  %call2_405c4b = tail call %struct.Memory* @sub_404740._ZNK14PointerWrapperIdEdeEv(%struct.State* nonnull %0, i64 %var_2_262, %struct.Memory* %MEMORY.2)
  store i8 0, i8* %var_2_12, align 1
  store i8 0, i8* %var_2_16, align 1
  store i8 0, i8* %var_2_17, align 1
  store i8 0, i8* %var_2_14, align 1
  %var_2_276 = load i64, i64* %var_2_3, align 8
  %var_2_277 = add i64 %var_2_276, -5519
  %call2_405c5f = tail call %struct.Memory* @sub_4046d0._ZppIdE14PointerWrapperIT_ERS2_i(%struct.State* nonnull %0, i64 %var_2_277, %struct.Memory* %call2_405c4b)
  %var_2_72 = load i8, i8* %AL.i130, align 1
  %var_2_74 = and i8 %var_2_72, 1
  store i8 0, i8* %var_2_12, align 1
  store i8 0, i8* %var_2_16, align 1
  store i8 0, i8* %var_2_17, align 1
  store i8 0, i8* %var_2_14, align 1
  %var_2_80 = icmp eq i8 %var_2_74, 0
  br i1 %var_2_80, label %block_405b81.loopexit, label %block_.L_405ba8.preheader

block_.L_405c07:                                  ; preds = %block_.L_405bf7
  %var_2_291 = add i64 %var_2_239, -5303
  %call2_405c0b = tail call %struct.Memory* @sub_404740._ZNK14PointerWrapperIdEdeEv(%struct.State* nonnull %0, i64 %var_2_291, %struct.Memory* %MEMORY.2)
  %var_2_305 = load i64, i64* %var_2_3, align 8
  %var_2_306 = add i64 %var_2_305, -5341
  %call2_405c1d = tail call %struct.Memory* @sub_404740._ZNK14PointerWrapperIdEdeEv(%struct.State* nonnull %0, i64 %var_2_306, %struct.Memory* %call2_405c0b)
  %var_2_321 = load i64, i64* %var_2_3, align 8
  %var_2_322 = add i64 %var_2_321, -1611
  %call2_405c2f = tail call %struct.Memory* @sub_4055e0._ZmmIdER14PointerWrapperIT_ES3_(%struct.State* nonnull %0, i64 %var_2_322, %struct.Memory* %call2_405c1d)
  br label %block_.L_405ba8
}
