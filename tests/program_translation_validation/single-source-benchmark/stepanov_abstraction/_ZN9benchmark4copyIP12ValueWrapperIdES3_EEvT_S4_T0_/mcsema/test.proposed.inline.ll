...
entry:
  ...
  %loadMem_403fc1 = load %struct.Memory*, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_403fc1, %struct.Memory** %MEMORY
  ...
  store i64 %55, i64* %58
  store %struct.Memory* %loadMem_403fc8, %struct.Memory** %MEMORY
  %loadMem_403fcc = load %struct.Memory*, %struct.Memory** %MEMORY
  ...
  store i64 %70, i64* %73
  store %struct.Memory* %loadMem_403fcc, %struct.Memory** %MEMORY
  br label %block_.L_403fd0

block_.L_403fd0:                                  ; preds = %block_403fde, %entry
  ...
  %loadMem_403fd4 = load %struct.Memory*, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_403fd4, %struct.Memory** %MEMORY
  ...
  %loadBr_403fd8 = load i8, i8* %BRANCH_TAKEN
  %cmpBr_403fd8 = icmp eq i8 %loadBr_403fd8, 1
  br i1 %cmpBr_403fd8, label %block_.L_404007, label %block_403fde

block_403fde:                                     ; preds = %block_.L_403fd0
  ...
  store %struct.Memory* %loadMem_403fe2, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_403fed, %struct.Memory** %MEMORY
...
block_.L_404007:                                  ; preds = %block_.L_403fd0
  %loadMem_404007 = load %struct.Memory*, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_404007, %struct.Memory** %MEMORY
  ...
  ret %struct.Memory* %loadMem_404008
}
...
define %struct.Memory* @routine_je_.L_404007(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i8* %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) {
block_400478:
  %3 = getelementptr inbounds %struct.State, %struct.State* %0, i32 0, i32 6
  %4 = getelementptr inbounds %struct.GPR, %struct.GPR* %3, i32 0, i32 33
  %5 = getelementptr inbounds %struct.Reg, %struct.Reg* %4, i32 0, i32 0
