...
define %struct.Memory* @_ZN9benchmark4copyIPdP12ValueWrapperIS2_IS2_IS2_IS2_IS2_IS2_IS2_IS2_IS2_IdEEEEEEEEEEEEvT_SE_T0_(%struct.State* noalias, i64, %struct.Memory* noalias) local_unnamed_addr #1 {
entry:
...
block_.L_4021e4:                                  ; preds = %block_4021f2, %entry
  %55 = phi i64 [ %.pre, %entry ], [ %163, %block_4021f2 ]
  %MEMORY.0 = phi %struct.Memory* [ %2, %entry ], [ %call2_402208, %block_4021f2 ]
  ...
  store i64 %60, i64* %RAX.i42, align 8
  %61 = add i64 %56, -16
  %62 = add i64 %55, 8
  ...
  %.v = select i1 %79, i64 68, i64 14
  %90 = add i64 %55, %.v
  store i64 %90, i64* %3, align 8
  br i1 %79, label %block_.L_402228, label %block_4021f2

block_4021f2:                                     ; preds = %block_.L_4021e4
  %91 = add i64 %56, -32
  store i64 %91, i64* %RDI.i50, align 8
  %92 = add i64 %90, 8
  store i64 %92, i64* %PC.i, align 8
  %93 = load i64, i64* %59, align 8
  store i64 %93, i64* %RAX.i42, align 8
  %94 = add i64 %93, 8
  store i64 %94, i64* %RCX.i31, align 8
  ...
  %117 = load i64, i64* %RAX.i42, align 8
  %118 = load i64, i64* %PC.i, align 8
  store i64 %117, i64* %RSI.i47, align 8
  %119 = add i64 %118, -1221
  %120 = add i64 %118, 8
  ...
  %call2_402208 = tail call %struct.Memory* @sub_401d40._ZN12ValueWrapperIS_IS_IS_IS_IS_IS_IS_IS_IS_IdEEEEEEEEEEC2IdEERKT_(%struct.State* %0, i64 %119, %struct.Memory* %MEMORY.0)
  ...
  store i64 %129, i64* %RAX.i42, align 8
  %130 = add i64 %129, 8
  store i64 %130, i64* %RCX.i31, align 8
  ...
  store i64 %158, i64* %RCX.i31, align 8
  %159 = bitcast i64* %RAX.i42 to i64**
...
block_.L_402228:                                  ; preds = %block_.L_4021e4
  %164 = load i64, i64* %RSP.i55, align 8
  %165 = add i64 %164, 32
  store i64 %165, i64* %RSP.i55, align 8
...
define %struct.Memory* @routine_je_.L_402228(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i8* %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
...
define %struct.Memory* @routine_jmpq_.L_4021e4(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
