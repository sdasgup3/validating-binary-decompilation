...
define %struct.Memory* @_ZN9benchmark4copyIPdP12ValueWrapperIdEEEvT_S5_T0_(%struct.State* noalias, i64, %struct.Memory* noalias) local_unnamed_addr #1 {
entry:
  ...
  br label %block_.L_402184

block_.L_402184:                                  ; preds = %block_402192, %entry
  %55 = phi i64 [ %.pre, %entry ], [ %163, %block_402192 ]
  %MEMORY.0 = phi %struct.Memory* [ %2, %entry ], [ %call2_4021a8, %block_402192 ]
  ...
  br i1 %79, label %block_.L_4021c8, label %block_402192

block_402192:                                     ; preds = %block_.L_402184
  %91 = add i64 %56, -32
  ...
  %call2_4021a8 = tail call %struct.Memory* @sub_401d20._ZN12ValueWrapperIdEC2IdEERKT_(%struct.State* %0, i64 %119, %struct.Memory* %MEMORY.0)
...
block_.L_4021c8:                                  ; preds = %block_.L_402184
...
define %struct.Memory* @routine_je_.L_4021c8(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i8* %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
...
define %struct.Memory* @routine_jmpq_.L_402184(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
