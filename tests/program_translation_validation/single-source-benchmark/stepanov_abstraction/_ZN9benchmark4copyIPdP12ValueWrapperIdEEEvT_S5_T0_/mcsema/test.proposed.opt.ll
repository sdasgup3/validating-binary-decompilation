...
block_.L_4021c4:                                  ; preds = %block_4021d2, %entry
  %56 = phi i64 [ %.pre, %entry ], [ %163, %block_4021d2 ]
  %MEMORY.0 = phi %struct.Memory* [ %2, %entry ], [ %call2_4021e8, %block_4021d2 ]
...
block_4021d2:                                     ; preds = %block_.L_4021c4
  ...
  %call2_4021e8 = tail call %struct.Memory* @sub_401d60._ZN12ValueWrapperIdEC2IdEERKT_(%struct.State* nonnull %0, i64 %120, %struct.Memory* %MEMORY.0)
