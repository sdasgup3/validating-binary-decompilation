...
define %struct.Memory* @_ZN9benchmark4copyIPdS1_EEvT_S2_T0_(%struct.State* noalias, i64, %struct.Memory* noalias) #1 {
entry:
...
block_404a9e:                                     ; preds = %block_.L_404a90
  ...
  %RAX.i17 = bitcast %union.anon* %237 to i64*
  ...
  %240 = bitcast %"class.std::bitset"* %YMM0.i to i8*
  %241 = load i64, i64* %RAX.i17
  ...
  %RAX.i11 = bitcast %union.anon* %269 to i64*
  %270 = getelementptr inbounds %struct.State, %struct.State* %0, i32 0, i32 6
  %271 = getelementptr inbounds %struct.GPR, %struct.GPR* %270, i32 0, i32 5
  %272 = getelementptr inbounds %struct.Reg, %struct.Reg* %271, i32 0, i32 0
  %RCX.i12 = bitcast %union.anon* %272 to i64*
  %273 = load i64, i64* %RAX.i11
  %274 = load i64, i64* %PC.i10
  %275 = add i64 %274, 3
  store i64 %275, i64* %PC.i10
  store i64 %273, i64* %RCX.i12, align 8
  store %struct.Memory* %loadMem_404ab5, %struct.Memory** %MEMORY
  ...
  %282 = load i64, i64* %RCX.i9
  %283 = load i64, i64* %PC.i8
  %284 = add i64 %283, 4
  store i64 %284, i64* %PC.i8
  %285 = add i64 8, %282
  store i64 %285, i64* %RCX.i9, align 8
  ...
  %328 = load i64, i64* %PC.i6
  %329 = add i64 %328, 4
  store i64 %329, i64* %PC.i6
  ...
  %RAX.i = bitcast %union.anon* %336 to i64*
  ...
  %XMM0.i = bitcast %union.VectorReg* %338 to %union.vec128_t*
  ...
  store %struct.Memory* %loadMem_404ac4, %struct.Memory** %MEMORY
  br label %block_.L_404a90
...
block_.L_404ac9:                                  ; preds = %block_.L_404a90
  ...
  ret %struct.Memory* %loadMem_404aca
}
