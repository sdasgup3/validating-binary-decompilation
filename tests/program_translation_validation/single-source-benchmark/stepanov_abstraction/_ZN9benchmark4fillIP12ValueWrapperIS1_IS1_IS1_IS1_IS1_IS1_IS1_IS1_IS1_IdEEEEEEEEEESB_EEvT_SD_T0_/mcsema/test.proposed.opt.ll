...
define %struct.Memory* @_ZN9benchmark4fillIP12ValueWrapperIS1_IS1_IS1_IS1_IS1_IS1_IS1_IS1_IS1_IdEEEEEEEEEESB_EEvT_SD_T0_(%struct.State* noalias, i64, %struct.Memory* noalias) local_unnamed_addr #1 {
entry:
...
block_.L_401e01:                                  ; preds = %block_401e0f, %entry
  %34 = phi i64 [ %95, %block_401e0f ], [ %.pre1, %entry ]
  %35 = phi i64 [ %103, %block_401e0f ], [ %.pre, %entry ]
  %36 = add i64 %34, -16
  %37 = add i64 %35, 4
  ...
  br i1 %58, label %block_.L_401e2a, label %block_401e0f
...
define %struct.Memory* @routine_je_.L_401e2a(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i8* %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
...
define %struct.Memory* @routine_jmpq_.L_401e01(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
