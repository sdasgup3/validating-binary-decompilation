...
entry:
  ...
  ; Code: ._ZN9benchmark4fillIP12ValueWrapperIdES2_EEvT_S4_T0_:	 RIP: 401db0	 Bytes: 0
  ; Code: pushq %rbp	 RIP: 401db0	 Bytes: 1
  %loadMem_401db0 = load %struct.Memory*, %struct.Memory** %MEMORY
  %call_401db0 = call %struct.Memory* @routine_pushq__rbp(%struct.State* %0, i64  0, %struct.Memory* %loadMem_401db0)
  store %struct.Memory* %call_401db0, %struct.Memory** %MEMORY

  ; Code: movq %rsp, %rbp	 RIP: 401db1	 Bytes: 3
  %loadMem_401db1 = load %struct.Memory*, %struct.Memory** %MEMORY
  %call_401db1 = call %struct.Memory* @routine_movq__rsp___rbp(%struct.State* %0, i64  0, %struct.Memory* %loadMem_401db1)
  store %struct.Memory* %call_401db1, %struct.Memory** %MEMORY

  ; Code: movsd %xmm0, -0x8(%rbp)	 RIP: 401db4	 Bytes: 5
  %loadMem_401db4 = load %struct.Memory*, %struct.Memory** %MEMORY
  %call_401db4 = call %struct.Memory* @routine_movsd__xmm0__MINUS0x8__rbp_(%struct.State* %0, i64  0, %struct.Memory* %loadMem_401db4)
  store %struct.Memory* %call_401db4, %struct.Memory** %MEMORY

  ; Code: movq %rdi, -0x10(%rbp)	 RIP: 401db9	 Bytes: 4
  %loadMem_401db9 = load %struct.Memory*, %struct.Memory** %MEMORY
  %call_401db9 = call %struct.Memory* @routine_movq__rdi__MINUS0x10__rbp_(%struct.State* %0, i64  0, %struct.Memory* %loadMem_401db9)
  store %struct.Memory* %call_401db9, %struct.Memory** %MEMORY

  ; Code: movq %rsi, -0x18(%rbp)	 RIP: 401dbd	 Bytes: 4
  %loadMem_401dbd = load %struct.Memory*, %struct.Memory** %MEMORY
  %call_401dbd = call %struct.Memory* @routine_movq__rsi__MINUS0x18__rbp_(%struct.State* %0, i64  0, %struct.Memory* %loadMem_401dbd)
  store %struct.Memory* %call_401dbd, %struct.Memory** %MEMORY

  ; Code: .L_401dc1:	 RIP: 401dc1	 Bytes: 0
  br label %block_.L_401dc1
block_.L_401dc1:

  ; Code: movq -0x10(%rbp), %rax	 RIP: 401dc1	 Bytes: 4
  %loadMem_401dc1 = load %struct.Memory*, %struct.Memory** %MEMORY
  %call_401dc1 = call %struct.Memory* @routine_movq_MINUS0x10__rbp____rax(%struct.State* %0, i64  0, %struct.Memory* %loadMem_401dc1)
  store %struct.Memory* %call_401dc1, %struct.Memory** %MEMORY

  ; Code: cmpq -0x18(%rbp), %rax	 RIP: 401dc5	 Bytes: 4
  %loadMem_401dc5 = load %struct.Memory*, %struct.Memory** %MEMORY
  %call_401dc5 = call %struct.Memory* @routine_cmpq_MINUS0x18__rbp____rax(%struct.State* %0, i64  0, %struct.Memory* %loadMem_401dc5)
  store %struct.Memory* %call_401dc5, %struct.Memory** %MEMORY

  ; Code: je .L_401dea	 RIP: 401dc9	 Bytes: 6
  %loadMem_401dc9 = load %struct.Memory*, %struct.Memory** %MEMORY
  %call_401dc9 = call %struct.Memory* @routine_je_.L_401dea(%struct.State* %0, i64  0, %struct.Memory* %loadMem_401dc9, i8* %BRANCH_TAKEN, i64 33, i64 6, i64 6)
  store %struct.Memory* %call_401dc9, %struct.Memory** %MEMORY

  %loadBr_401dc9 = load i8, i8* %BRANCH_TAKEN
  %cmpBr_401dc9 = icmp eq i8 %loadBr_401dc9, 1
  br i1 %cmpBr_401dc9, label %block_.L_401dea, label %block_401dcf

block_401dcf:
  ; Code: movq -0x10(%rbp), %rax	 RIP: 401dcf	 Bytes: 4
  %loadMem_401dcf = load %struct.Memory*, %struct.Memory** %MEMORY
  %call_401dcf = call %struct.Memory* @routine_movq_MINUS0x10__rbp____rax(%struct.State* %0, i64  0, %struct.Memory* %loadMem_401dcf)
  store %struct.Memory* %call_401dcf, %struct.Memory** %MEMORY

  ; Code: movq %rax, %rcx	 RIP: 401dd3	 Bytes: 3
  %loadMem_401dd3 = load %struct.Memory*, %struct.Memory** %MEMORY
  %call_401dd3 = call %struct.Memory* @routine_movq__rax___rcx(%struct.State* %0, i64  0, %struct.Memory* %loadMem_401dd3)
  store %struct.Memory* %call_401dd3, %struct.Memory** %MEMORY

  ; Code: addq $0x8, %rcx	 RIP: 401dd6	 Bytes: 4
  %loadMem_401dd6 = load %struct.Memory*, %struct.Memory** %MEMORY
  %call_401dd6 = call %struct.Memory* @routine_addq__0x8___rcx(%struct.State* %0, i64  0, %struct.Memory* %loadMem_401dd6)
  store %struct.Memory* %call_401dd6, %struct.Memory** %MEMORY

  ; Code: movq %rcx, -0x10(%rbp)	 RIP: 401dda	 Bytes: 4
  %loadMem_401dda = load %struct.Memory*, %struct.Memory** %MEMORY
  %call_401dda = call %struct.Memory* @routine_movq__rcx__MINUS0x10__rbp_(%struct.State* %0, i64  0, %struct.Memory* %loadMem_401dda)
  store %struct.Memory* %call_401dda, %struct.Memory** %MEMORY

  ; Code: movq -0x8(%rbp), %rcx	 RIP: 401dde	 Bytes: 4
  %loadMem_401dde = load %struct.Memory*, %struct.Memory** %MEMORY
  %call_401dde = call %struct.Memory* @routine_movq_MINUS0x8__rbp____rcx(%struct.State* %0, i64  0, %struct.Memory* %loadMem_401dde)
  store %struct.Memory* %call_401dde, %struct.Memory** %MEMORY

  ; Code: movq %rcx, (%rax)	 RIP: 401de2	 Bytes: 3
  %loadMem_401de2 = load %struct.Memory*, %struct.Memory** %MEMORY
  %call_401de2 = call %struct.Memory* @routine_movq__rcx____rax_(%struct.State* %0, i64  0, %struct.Memory* %loadMem_401de2)
  store %struct.Memory* %call_401de2, %struct.Memory** %MEMORY

  ; Code: jmpq .L_401dc1	 RIP: 401de5	 Bytes: 5
  %loadMem_401de5 = load %struct.Memory*, %struct.Memory** %MEMORY
  %call_401de5 = call %struct.Memory* @routine_jmpq_.L_401dc1(%struct.State* %0, i64  0, %struct.Memory* %loadMem_401de5, i64 -36, i64 5)
  store %struct.Memory* %call_401de5, %struct.Memory** %MEMORY

  br label %block_.L_401dc1

  ; Code: .L_401dea:	 RIP: 401dea	 Bytes: 0
block_.L_401dea:

  ; Code: popq %rbp	 RIP: 401dea	 Bytes: 1
  %loadMem_401dea = load %struct.Memory*, %struct.Memory** %MEMORY
  %call_401dea = call %struct.Memory* @routine_popq__rbp(%struct.State* %0, i64  0, %struct.Memory* %loadMem_401dea)
  store %struct.Memory* %call_401dea, %struct.Memory** %MEMORY

  ; Code: retq	 RIP: 401deb	 Bytes: 1
  %loadMem_401deb = load %struct.Memory*, %struct.Memory** %MEMORY
  %call_401deb = call %struct.Memory* @routine_retq(%struct.State* %0, i64  0, %struct.Memory* %loadMem_401deb)
  store %struct.Memory* %call_401deb, %struct.Memory** %MEMORY

  ret %struct.Memory* %call_401deb
}
...
define %struct.Memory* @routine_je_.L_401dea(%struct.State*  dereferenceable(3376), i64, %struct.Memory*, i8* %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) {
block_400478:
  %3 = getelementptr inbounds %struct.State, %struct.State* %0, i32 0, i32 6
  %4 = getelementptr inbounds %struct.GPR, %struct.GPR* %3, i32 0, i32 33
  %5 = getelementptr inbounds %struct.Reg, %struct.Reg* %4, i32 0, i32 0
...
define %struct.Memory* @routine_jmpq_.L_401dc1(%struct.State*  dereferenceable(3376), i64, %struct.Memory*, i64 %rel_off1, i64 %rel_off2) {
block_400478:
  %3 = getelementptr inbounds %struct.State, %struct.State* %0, i32 0, i32 6
  %4 = getelementptr inbounds %struct.GPR, %struct.GPR* %3, i32 0, i32 33
  %5 = getelementptr inbounds %struct.Reg, %struct.Reg* %4, i32 0, i32 0
