...
define %struct.Memory* @_ZN9benchmark4fillIPddEEvT_S2_T0_(%struct.State* noalias, i64, %struct.Memory* noalias) #1 {
entry:
...
block_.L_401dc1:                                  ; preds = %block_401dcf, %entry
  ...
  br i1 %cmpBr_401dc9, label %block_.L_401dec, label %block_401dcf
...
block_.L_401dec:                                  ; preds = %block_.L_401dc1
  ...
  ret %struct.Memory* %loadMem_401ded
}
...
define %struct.Memory* @routine_je_.L_401dec(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i8* %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) {
block_400488:
  %3 = getelementptr inbounds %struct.State, %struct.State* %0, i32 0, i32 6
  %4 = getelementptr inbounds %struct.GPR, %struct.GPR* %3, i32 0, i32 33
  %5 = getelementptr inbounds %struct.Reg, %struct.Reg* %4, i32 0, i32 0
