...
define %struct.Memory* @_ZN9benchmark4fillIPddEEvT_S2_T0_(%struct.State* noalias, i64, %struct.Memory* noalias) local_unnamed_addr #1 {
entry:
  ...
  br label %block_.L_401d81

block_.L_401d81:                                  ; preds = %block_401d8f, %entry
  %37 = phi i64 [ %106, %block_401d8f ], [ %.pre, %entry ]
  ...
  br i1 %61, label %block_.L_401dac, label %block_401d8f

block_401d8f:                                     ; preds = %block_.L_401d81
  %73 = add i64 %38, -24
  %74 = add i64 %72, 5
...
block_.L_401dac:                                  ; preds = %block_.L_401d81
  %107 = add i64 %72, 1
...
define %struct.Memory* @routine_je_.L_401dac(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i8* %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
...
define %struct.Memory* @routine_jmpq_.L_401d81(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
