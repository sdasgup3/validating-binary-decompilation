; ModuleID = '/tmp/tmpxcc64_ny-query.ll'
...
block_.L_403f01:                                  ; preds = %block_403ea6, %block_.L_403e98
  ...
  br i1 %var_2_603, label %block_.L_403f1c.outer, label %var_2_604

var_2_604:                                        ; preds = %block_.L_403f01
  %var_2_592 = add i64 %var_2_562, 23
  br label %block_.L_403f1c.outer.sink.split

block_.L_403f1c.outer.sink.split:                 ; preds = %var_2_897, %var_2_604
  %MEMORY.2.sink = phi %struct.Memory* [ %MEMORY.2, %var_2_604 ], [ %MEMORY.3.ph28, %var_2_897 ]
  %var_2_592.sink = phi i64 [ %var_2_592, %var_2_604 ], [ %var_2_881, %var_2_897 ]
  %var_2_605 = tail call %struct.Memory* @__remill_error(%struct.State* nonnull dereferenceable(3376) %0, i64 %var_2_592.sink, %struct.Memory* %MEMORY.2.sink)
  %var_2_705.pre.pre = load i64, i64* %RBP.i, align 8
  br label %block_.L_403f1c.outer

block_.L_403f1c.outer:                            ; preds = %block_.L_403f1c.outer.sink.split, %block_.L_403f01
  %var_2_705.pre = phi i64 [ %var_2_561, %block_.L_403f01 ], [ %var_2_705.pre.pre, %block_.L_403f1c.outer.sink.split ]
  %MEMORY.3.ph28 = phi %struct.Memory* [ %MEMORY.2, %block_.L_403f01 ], [ %var_2_605, %block_.L_403f1c.outer.sink.split ]
  br label %block_.L_403f1c

block_.L_403f1c:                                  ; preds = %block_.L_403f73, %block_.L_403f1c.outer
  %var_2_705 = phi i64 [ %var_2_705.pre, %block_.L_403f1c.outer ], [ %var_2_842, %block_.L_403f73 ]
  %var_2_654 = load i64, i64* %var_2_3, align 8
  %var_2_655 = add i64 %var_2_654, 50
  %var_2_657 = load i8, i8* %var_2_30, align 1
  %var_2_658 = icmp ne i8 %var_2_657, 0
  %var_2_659 = load i8, i8* %var_2_33, align 1
  %var_2_660 = icmp ne i8 %var_2_659, 0
  %var_2_661 = load i8, i8* %var_2_39, align 1
  %var_2_662 = icmp ne i8 %var_2_661, 0
  %var_2_663 = xor i1 %var_2_660, %var_2_662
  %var_2_664 = or i1 %var_2_658, %var_2_663
  %var_2_655.var_2_654 = select i1 %var_2_664, i64 %var_2_655, i64 %var_2_654
  %var_2_706 = add i64 %var_2_705, -153
  %var_2_708 = inttoptr i64 %var_2_706 to i8*
  %var_2_709 = load i8, i8* %var_2_708, align 1
  %var_2_710 = and i8 %var_2_709, 1
  %var_2_716 = icmp ne i8 %var_2_710, 0
  %.v = select i1 %var_2_716, i64 19, i64 14
  %var_2_717 = add i64 %.v, %var_2_655.var_2_654
  br i1 %var_2_716, label %block_.L_403f73, label %block_403f6e

block_403f6e:                                     ; preds = %block_.L_403f1c
  %var_2_723 = add i64 %var_2_717, -542
  %call2_403fe8 = tail call %struct.Memory* @sub_403d50._ZplI12ValueWrapperIdEE14PointerWrapperIT_ERS4_l(%struct.State* nonnull %0, i64 %var_2_723, %struct.Memory* %MEMORY.3.ph28)
  %var_2_734 = load i64, i64* %var_2_3, align 8
  %var_2_735 = add i64 %var_2_734, -789
  %call2_403ff5 = tail call %struct.Memory* @sub_403ce0._ZNK14PointerWrapperI12ValueWrapperIdEEdeEv(%struct.State* nonnull %0, i64 %var_2_735, %struct.Memory* %call2_403fe8)
  ret %struct.Memory* %call2_403ff5

block_.L_403f73:                                  ; preds = %block_.L_403f1c
  %var_2_785 = add i64 %var_2_717, -547
  %call2_403f7b = tail call %struct.Memory* @sub_403d50._ZplI12ValueWrapperIdEE14PointerWrapperIT_ERS4_l(%struct.State* nonnull %0, i64 %var_2_785, %struct.Memory* %MEMORY.3.ph28)
  %var_2_796 = load i64, i64* %var_2_3, align 8
  %var_2_797 = add i64 %var_2_796, -680
  %call2_403f88 = tail call %struct.Memory* @sub_403ce0._ZNK14PointerWrapperI12ValueWrapperIdEEdeEv(%struct.State* nonnull %0, i64 %var_2_797, %struct.Memory* %MEMORY.3.ph28)
  ...
  %call2_403f9c = tail call %struct.Memory* @sub_403d50._ZplI12ValueWrapperIdEE14PointerWrapperIT_ERS4_l(%struct.State* nonnull %0, i64 %var_2_814, %struct.Memory* %MEMORY.3.ph28)
  %var_2_825 = load i64, i64* %var_2_3, align 8
  %var_2_826 = add i64 %var_2_825, -713
  %call2_403fa9 = tail call %struct.Memory* @sub_403ce0._ZNK14PointerWrapperI12ValueWrapperIdEEdeEv(%struct.State* nonnull %0, i64 %var_2_826, %struct.Memory* %MEMORY.3.ph28)
  ...
  br i1 %var_2_896, label %block_.L_403f1c, label %var_2_897

var_2_897:                                        ; preds = %block_.L_403f73
  %var_2_853 = load i64, i64* %var_2_3, align 8
  %var_2_881 = add i64 %var_2_853, 13
  br label %block_.L_403f1c.outer.sink.split
}
