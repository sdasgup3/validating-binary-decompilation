...
define %struct.Memory* @_ZN9benchmark7sift_inIP12ValueWrapperIS1_IS1_IS1_IS1_IS1_IS1_IS1_IS1_IS1_IdEEEEEEEEEESB_EEvlT_lT0_(%struct.State* noalias, i64, %struct.Memory* noalias) local_unnamed_addr #1 {
entry:
  ...
  br label %block_.L_4037f1

block_.L_4037f1:                                  ; preds = %block_.L_403845, %entry
  %100 = phi i64 [ %.pre, %entry ], [ %373, %block_.L_403845 ]
  %MEMORY.0 = phi %struct.Memory* [ %2, %entry ], [ %call2_403827, %block_.L_403845 ]
  ...
  br i1 %136, label %block_4037ff, label %block_.L_40387e

block_4037ff:                                     ; preds = %block_.L_4037f1
  %138 = add i64 %101, -24
  %139 = add i64 %137, 4
  ...
  %call2_403827 = tail call %struct.Memory* @sub_4030a0._ZltI12ValueWrapperIS0_IS0_IS0_IS0_IS0_IS0_IS0_IS0_IdEEEEEEEEEEbRKS0_IT_ESD_(%struct.State* nonnull %0, i64 %213, %struct.Memory* %MEMORY.0)
  ...
  br i1 %226, label %block_.L_403839, label %block_403834

block_403834:                                     ; preds = %block_4037ff
  %228 = add i64 %227, 17
  store i64 %228, i64* %3, align 8
  br label %block_.L_403845

block_.L_403839:                                  ; preds = %block_4037ff
...
block_.L_403845:                                  ; preds = %block_.L_403839, %block_403834
  %258 = phi i64 [ %.pre23, %block_.L_403839 ], [ %228, %block_403834 ]
...
block_.L_40387e:                                  ; preds = %block_.L_4037f1
  %374 = add i64 %137, 4
  ...
  br i1 %392, label %block_40388c, label %block_.L_4038b4

block_40388c:                                     ; preds = %block_.L_40387e
  %404 = add i64 %101, -24
  %405 = add i64 %403, 4
  ...
  br label %block_.L_4038b4

block_.L_4038b4:                                  ; preds = %block_.L_40387e, %block_40388c
  %478 = phi i64 [ %.pre14, %block_40388c ], [ %101, %block_.L_40387e ]
  %479 = phi i64 [ %.pre13, %block_40388c ], [ %403, %block_.L_40387e ]
...
; <label>:521:                                    ; preds = %block_.L_4038b4
...
; <label>:523:                                    ; preds = %block_.L_4038b4
  %524 = srem i128 %513, 2
...
routine_idivq__rcx.exit106:                       ; preds = %523, %521
  ...
  br label %block_.L_4038cf

block_.L_4038cf:                                  ; preds = %routine_idivq__rcx.exit, %routine_idivq__rcx.exit106
  ...
  br i1 %581, label %block_.L_403902, label %block_4038e4

block_4038e4:                                     ; preds = %block_.L_4038cf
  ...
  %call2_4038fa = tail call %struct.Memory* @sub_4030a0._ZltI12ValueWrapperIS0_IS0_IS0_IS0_IS0_IS0_IS0_IS0_IdEEEEEEEEEEbRKS0_IT_ESD_(%struct.State* nonnull %0, i64 %622, %struct.Memory* %MEMORY.3)
  ...
  br label %block_.L_403902

block_.L_403902:                                  ; preds = %block_4038e4, %block_.L_4038cf
  %633 = phi i64 [ %572, %block_.L_4038cf ], [ %.pre19, %block_4038e4 ]
  %MEMORY.4 = phi %struct.Memory* [ %MEMORY.3, %block_.L_4038cf ], [ %call2_4038fa, %block_4038e4 ]
  ...
  br i1 %645, label %block_.L_403912, label %block_40390d

block_40390d:                                     ; preds = %block_.L_403902
  %647 = add i64 %634, -24
  %648 = add i64 %646, 73
...
block_.L_403912:                                  ; preds = %block_.L_403902
  store i64 2, i64* %RAX.i246, align 8
  store i64 2, i64* %RCX.i120, align 8
  %695 = add i64 %634, -24
  %696 = add i64 %646, 11
...
; <label>:773:                                    ; preds = %block_.L_403912
...
; <label>:775:                                    ; preds = %block_.L_403912
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_jge_.L_40387e(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i8* nocapture %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_jne_.L_403839(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i8* nocapture %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_jmpq_.L_403845(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_jmpq_.L_4037f1(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_jne_.L_4038b4(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i8* nocapture %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 2, i32 7
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_jle_.L_403902(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i8* nocapture %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 2, i32 7
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_jne_.L_403912(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i8* nocapture %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 2, i32 7
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_jmpq_.L_4038cf(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
