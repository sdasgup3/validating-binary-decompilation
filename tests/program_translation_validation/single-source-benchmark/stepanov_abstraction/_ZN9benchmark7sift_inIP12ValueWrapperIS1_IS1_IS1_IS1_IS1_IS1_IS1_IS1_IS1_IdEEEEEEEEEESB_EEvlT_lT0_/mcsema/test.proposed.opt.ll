...
block_.L_4037f1:                                  ; preds = %block_.L_403845, %entry
  %100 = phi i64 [ %373, %block_.L_403845 ], [ %.pre, %entry ]
...
block_4037ff:                                     ; preds = %block_.L_4037f1
  ...
  %call2_403827 = tail call %struct.Memory* @sub_4030a0._ZltI12ValueWrapperIS0_IS0_IS0_IS0_IS0_IS0_IS0_IS0_IdEEEEEEEEEEbRKS0_IT_ESD_(%struct.State* nonnull %0, i64 %213, %struct.Memory* %2)
...
block_.L_403902:                                  ; preds = %block_4038e4, %block_.L_4038cf
  %633 = phi i64 [ %.pre19, %block_4038e4 ], [ %572, %block_.L_4038cf ]
