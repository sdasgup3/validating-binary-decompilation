...
entry:
  ...
  br label %block_.L_4037b1

block_.L_4037b1:                                  ; preds = %block_.L_403805, %entry
  %100 = phi i64 [ %.pre, %entry ], [ %373, %block_.L_403805 ]
  %MEMORY.0 = phi %struct.Memory* [ %2, %entry ], [ %call2_4037e7, %block_.L_403805 ]
  ...
  br i1 %136, label %block_4037bf, label %block_.L_40383e

block_4037bf:                                     ; preds = %block_.L_4037b1
  %138 = add i64 %101, -24
  %139 = add i64 %137, 4
  ...
  %call2_4037e7 = tail call %struct.Memory* @sub_403060._ZltI12ValueWrapperIS0_IS0_IS0_IS0_IS0_IS0_IS0_IS0_IdEEEEEEEEEEbRKS0_IT_ESD_(%struct.State* %0, i64 %212, %struct.Memory* %MEMORY.0)
  ...
  br i1 %225, label %block_.L_4037f9, label %block_4037f4

block_4037f4:                                     ; preds = %block_4037bf
  %227 = add i64 %226, 17
  store i64 %227, i64* %3, align 8
  br label %block_.L_403805

block_.L_4037f9:                                  ; preds = %block_4037bf
...
block_.L_403805:                                  ; preds = %block_.L_4037f9, %block_4037f4
  %258 = phi i64 [ %.pre1, %block_.L_4037f9 ], [ %227, %block_4037f4 ]
...
block_.L_40383e:                                  ; preds = %block_.L_4037b1
  %374 = add i64 %137, 4
  ...
  br i1 %392, label %block_40384c, label %block_.L_403874

block_40384c:                                     ; preds = %block_.L_40383e
  %404 = add i64 %101, -24
  %405 = add i64 %403, 4
  ...
  br label %block_.L_403874

block_.L_403874:                                  ; preds = %block_.L_40383e, %block_40384c
  %478 = phi i64 [ %.pre3, %block_40384c ], [ %101, %block_.L_40383e ]
  %479 = phi i64 [ %.pre2, %block_40384c ], [ %403, %block_.L_40383e ]
...
; <label>:521:                                    ; preds = %block_.L_403874
...
; <label>:523:                                    ; preds = %block_.L_403874
  %524 = srem i128 %513, 2
...
routine_idivq__rcx.exit106:                       ; preds = %523, %521
  ...
  br label %block_.L_40388f

block_.L_40388f:                                  ; preds = %routine_idivq__rcx.exit, %routine_idivq__rcx.exit106
  ...
  br i1 %579, label %block_.L_4038c2, label %block_4038a4

block_4038a4:                                     ; preds = %block_.L_40388f
  ...
  %call2_4038ba = tail call %struct.Memory* @sub_403060._ZltI12ValueWrapperIS0_IS0_IS0_IS0_IS0_IS0_IS0_IS0_IdEEEEEEEEEEbRKS0_IT_ESD_(%struct.State* %0, i64 %620, %struct.Memory* %MEMORY.3)
  ...
  br label %block_.L_4038c2

block_.L_4038c2:                                  ; preds = %block_4038a4, %block_.L_40388f
  %631 = phi i64 [ %580, %block_.L_40388f ], [ %.pre8, %block_4038a4 ]
  %MEMORY.4 = phi %struct.Memory* [ %MEMORY.3, %block_.L_40388f ], [ %call2_4038ba, %block_4038a4 ]
  ...
  br i1 %643, label %block_.L_4038d2, label %block_4038cd

block_4038cd:                                     ; preds = %block_.L_4038c2
  %645 = add i64 %632, -24
  %646 = add i64 %644, 73
...
block_.L_4038d2:                                  ; preds = %block_.L_4038c2
  store i64 2, i64* %RAX.i246, align 8
  store i64 2, i64* %RCX.i236, align 8
  %693 = add i64 %632, -24
  %694 = add i64 %644, 11
...
; <label>:771:                                    ; preds = %block_.L_4038d2
...
; <label>:773:                                    ; preds = %block_.L_4038d2
...
define %struct.Memory* @routine_jge_.L_40383e(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i8* %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
...
define %struct.Memory* @routine_jne_.L_4037f9(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i8* %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
...
define %struct.Memory* @routine_jmpq_.L_403805(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
...
define %struct.Memory* @routine_jmpq_.L_4037b1(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
...
define %struct.Memory* @routine_jne_.L_403874(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i8* %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 2, i32 7
...
define %struct.Memory* @routine_jle_.L_4038c2(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i8* %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 2, i32 7
...
define %struct.Memory* @routine_jne_.L_4038d2(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i8* %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 2, i32 7
...
define %struct.Memory* @routine_jmpq_.L_403912(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
...
define %struct.Memory* @routine_jmpq_.L_40388f(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
