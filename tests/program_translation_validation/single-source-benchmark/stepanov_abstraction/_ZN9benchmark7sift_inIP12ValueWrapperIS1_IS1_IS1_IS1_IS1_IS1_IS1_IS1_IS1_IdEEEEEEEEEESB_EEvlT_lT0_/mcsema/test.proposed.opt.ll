...
entry:
  ...
  br label %block_.L_403801

block_.L_403801:                                  ; preds = %block_.L_403855, %entry
  %100 = phi i64 [ %373, %block_.L_403855 ], [ %.pre, %entry ]
  ...
  br i1 %136, label %block_40380f, label %block_.L_40388e

block_40380f:                                     ; preds = %block_.L_403801
  %138 = add i64 %101, -24
  %139 = add i64 %137, 4
  ...
  %call2_403837 = tail call %struct.Memory* @sub_4030b0._ZltI12ValueWrapperIS0_IS0_IS0_IS0_IS0_IS0_IS0_IS0_IdEEEEEEEEEEbRKS0_IT_ESD_(%struct.State* nonnull %0, i64 %213, %struct.Memory* %2)
  ...
  br i1 %226, label %block_.L_403849, label %block_403844

block_403844:                                     ; preds = %block_40380f
  %228 = add i64 %227, 17
  store i64 %228, i64* %3, align 8
  br label %block_.L_403855

block_.L_403849:                                  ; preds = %block_40380f
...
block_.L_403855:                                  ; preds = %block_.L_403849, %block_403844
  %258 = phi i64 [ %.pre23, %block_.L_403849 ], [ %228, %block_403844 ]
...
block_.L_40388e:                                  ; preds = %block_.L_403801
  %374 = add i64 %137, 4
  ...
  br i1 %392, label %block_40389c, label %block_.L_4038c4

block_40389c:                                     ; preds = %block_.L_40388e
  %404 = add i64 %101, -24
  %405 = add i64 %403, 4
  ...
  br label %block_.L_4038c4

block_.L_4038c4:                                  ; preds = %block_.L_40388e, %block_40389c
  %478 = phi i64 [ %.pre14, %block_40389c ], [ %101, %block_.L_40388e ]
  %479 = phi i64 [ %.pre13, %block_40389c ], [ %403, %block_.L_40388e ]
...
; <label>:521:                                    ; preds = %block_.L_4038c4
...
; <label>:523:                                    ; preds = %block_.L_4038c4
  %524 = srem i128 %513, 2
...
block_.L_4038df:                                  ; preds = %routine_idivq__rcx.exit, %routine_idivq__rcx.exit106
  ...
  br i1 %581, label %block_.L_403912, label %block_4038f4

block_4038f4:                                     ; preds = %block_.L_4038df
  ...
  %call2_40390a = tail call %struct.Memory* @sub_4030b0._ZltI12ValueWrapperIS0_IS0_IS0_IS0_IS0_IS0_IS0_IS0_IdEEEEEEEEEEbRKS0_IT_ESD_(%struct.State* nonnull %0, i64 %622, %struct.Memory* %MEMORY.3)
  ...
  br label %block_.L_403912

block_.L_403912:                                  ; preds = %block_4038f4, %block_.L_4038df
  %633 = phi i64 [ %.pre19, %block_4038f4 ], [ %572, %block_.L_4038df ]
  ...
  br i1 %645, label %block_.L_403922, label %block_40391d

block_40391d:                                     ; preds = %block_.L_403912
  %647 = add i64 %634, -24
  %648 = add i64 %646, 73
...
block_.L_403922:                                  ; preds = %block_.L_403912
  store i64 2, i64* %RAX.i246, align 8
  store i64 2, i64* %RCX.i120, align 8
  %695 = add i64 %634, -24
  %696 = add i64 %646, 11
...
; <label>:773:                                    ; preds = %block_.L_403922
...
; <label>:775:                                    ; preds = %block_.L_403922
...
; Function Attrs: alwaysinline norecurse nounwind
define %struct.Memory* @routine_jge_.L_40388e(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i8* nocapture %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
...
; Function Attrs: alwaysinline norecurse nounwind
define %struct.Memory* @routine_jne_.L_403849(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i8* nocapture %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
...
; Function Attrs: alwaysinline norecurse nounwind
define %struct.Memory* @routine_jmpq_.L_403855(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
...
; Function Attrs: alwaysinline norecurse nounwind
define %struct.Memory* @routine_jmpq_.L_403801(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
...
; Function Attrs: alwaysinline norecurse nounwind
define %struct.Memory* @routine_jne_.L_4038c4(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i8* nocapture %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 2, i32 7
...
; Function Attrs: alwaysinline norecurse nounwind
define %struct.Memory* @routine_jle_.L_403912(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i8* nocapture %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 2, i32 7
...
; Function Attrs: alwaysinline norecurse nounwind
define %struct.Memory* @routine_jne_.L_403922(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i8* nocapture %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 2, i32 7
...
; Function Attrs: alwaysinline norecurse nounwind
define %struct.Memory* @routine_jmpq_.L_4038df(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
