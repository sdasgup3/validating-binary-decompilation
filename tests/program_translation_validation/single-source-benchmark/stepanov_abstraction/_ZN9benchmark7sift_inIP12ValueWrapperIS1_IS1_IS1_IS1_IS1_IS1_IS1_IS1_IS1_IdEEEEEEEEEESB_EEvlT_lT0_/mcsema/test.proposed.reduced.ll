; ModuleID = '/tmp/tmp76k16ks5-query.ll'
...
define %struct.Memory* @_ZN9benchmark7sift_inIP12ValueWrapperIS1_IS1_IS1_IS1_IS1_IS1_IS1_IS1_IS1_IdEEEEEEEEEESB_EEvlT_lT0_(%struct.State* noalias, i64, %struct.Memory* noalias returned) local_unnamed_addr #1 {
entry:
...
block_.L_4038df.outer.preheader:                  ; preds = %block_.L_40388e, %var_2_521
  %var_2_63429 = phi i64 [ %var_2_63429.pre, %var_2_521 ], [ %var_2_1013, %block_.L_40388e ]
  ...
  br i1 %var_2_645714, label %block_40391d, label %block_.L_403922.lr.ph.preheader
...
block_.L_403922.lr.ph:                            ; preds = %block_.L_403922.lr.ph.preheader, %var_2_773
  %var_2_634216 = phi i64 [ %var_2_6342, %var_2_773 ], [ %var_2_63429, %block_.L_403922.lr.ph.preheader ]
  %MEMORY.3.ph215 = phi %struct.Memory* [ %var_2_774, %var_2_773 ], [ %MEMORY.3.ph2.ph, %block_.L_403922.lr.ph.preheader ]
...
block_40391d.loopexit10:                          ; preds = %var_2_773
  br label %block_40391d

block_40391d:                                     ; preds = %block_40391d.loopexit10, %block_40391d.loopexit, %block_.L_4038df.outer.preheader
...
var_2_773:                                        ; preds = %block_.L_403922
  ...
  br i1 %var_2_6457, label %block_40391d.loopexit10, label %block_.L_403922.lr.ph
