; ModuleID = '/tmp/tmpdheh6i7u-query.ll'
...
entry:
  ...
  br i1 %var_2_13619, label %block_40380f.us.preheader, label %block_.L_40388e

block_40380f.us.preheader:                        ; preds = %entry
  br label %block_40380f.us

block_40380f.us:                                  ; preds = %block_40380f.us.preheader, %block_40380f.us
  br label %block_40380f.us

block_.L_40388e:                                  ; preds = %entry
  ...
  br i1 %var_2_520, label %block_.L_4038df.outer.preheader, label %var_2_521

var_2_521:                                        ; preds = %block_.L_40388e
  ...
  br label %block_.L_4038df.outer.preheader

block_.L_4038df.outer.preheader:                  ; preds = %block_.L_40388e, %var_2_521
  %var_2_634210 = phi i64 [ %var_2_634210.pre, %var_2_521 ], [ %var_2_1013, %block_.L_40388e ]
  %MEMORY.3.ph2.ph = phi %struct.Memory* [ %var_2_522, %var_2_521 ], [ %2, %block_.L_40388e ]
  ...
  br i1 %var_2_645715, label %block_40391d, label %block_.L_403922.lr.ph.preheader

block_.L_403922.lr.ph.preheader:                  ; preds = %block_.L_4038df.outer.preheader
  br label %block_.L_403922.lr.ph

block_.L_403922.lr.ph:                            ; preds = %block_.L_403922.lr.ph.preheader, %var_2_773
  %var_2_634217 = phi i64 [ %var_2_6342, %var_2_773 ], [ %var_2_634210, %block_.L_403922.lr.ph.preheader ]
  %MEMORY.3.ph216 = phi %struct.Memory* [ %var_2_774, %var_2_773 ], [ %MEMORY.3.ph2.ph, %block_.L_403922.lr.ph.preheader ]
...
block_40391d.loopexit:                            ; preds = %var_2_775
  br label %block_40391d

block_40391d.loopexit14:                          ; preds = %var_2_773
  br label %block_40391d

block_40391d:                                     ; preds = %block_40391d.loopexit14, %block_40391d.loopexit, %block_.L_4038df.outer.preheader
  %MEMORY.3.ph2.lcssa = phi %struct.Memory* [ %MEMORY.3.ph2.ph, %block_.L_4038df.outer.preheader ], [ %MEMORY.3.ph216, %block_40391d.loopexit ], [ %var_2_774, %block_40391d.loopexit14 ]
  ret %struct.Memory* %MEMORY.3.ph2.lcssa

block_.L_403922:                                  ; preds = %var_2_775, %block_.L_403922.lr.ph
  %var_2_729 = phi i64 [ %var_2_729.pre, %block_.L_403922.lr.ph ], [ %var_2_757, %var_2_775 ]
...
var_2_773:                                        ; preds = %block_.L_403922
  ...
  br i1 %var_2_6457, label %block_40391d.loopexit14, label %block_.L_403922.lr.ph

var_2_775:                                        ; preds = %block_.L_403922
  %var_2_638 = load i8, i8* %var_2_637, align 1
  %var_2_639 = and i8 %var_2_638, 1
  %var_2_645 = icmp eq i8 %var_2_639, 0
  br i1 %var_2_645, label %block_40391d.loopexit, label %block_.L_403922
}
