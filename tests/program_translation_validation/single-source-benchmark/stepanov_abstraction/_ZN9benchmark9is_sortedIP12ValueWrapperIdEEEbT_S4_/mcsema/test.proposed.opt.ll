...
block_.L_404184:                                  ; preds = %block_4041c3, %entry
  %88 = phi i64 [ %.pre, %entry ], [ %196, %block_4041c3 ]
  %MEMORY.0 = phi %struct.Memory* [ %2, %entry ], [ %call2_4041b6, %block_4041c3 ]
  ...
  br i1 %112, label %block_.L_4041d6, label %block_404192
...
block_404192:                                     ; preds = %block_.L_404184
  ...
  %call2_4041b6 = tail call %struct.Memory* @sub_403210._ZltIdEbRK12ValueWrapperIT_ES4_(%struct.State* %0, i64 %181, %struct.Memory* %MEMORY.0)
  ...
  br i1 %194, label %block_.L_4041c8, label %block_4041c3
...
block_.L_4041da:                                  ; preds = %block_.L_4041d6, %block_.L_4041c8
  %206 = phi i64 [ %.pre2, %block_.L_4041d6 ], [ %202, %block_.L_4041c8 ]
  %MEMORY.1 = phi %struct.Memory* [ %MEMORY.0, %block_.L_4041d6 ], [ %call2_4041b6, %block_.L_4041c8 ]
...
define %struct.Memory* @routine_je_.L_4041d6(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i8* %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
...
define %struct.Memory* @routine_jne_.L_4041c8(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i8* %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 2, i32 7
...
define %struct.Memory* @routine_jmpq_.L_4041d1(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
...
define %struct.Memory* @routine_jmpq_.L_4041da(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
...
define %struct.Memory* @routine_jmpq_.L_404184(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
