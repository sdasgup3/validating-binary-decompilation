...
define %struct.Memory* @_ZNK12ValueWrapperIS_IS_IS_IS_IS_IS_IS_IS_IdEEEEEEEEEcvT_IdEEv(%struct.State* noalias, i64, %struct.Memory* noalias) #2 {
entry:
  ...
  store %struct.Memory* %loadMem_405e64, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem1_405e70, %struct.Memory** %MEMORY
  ...
  ret %struct.Memory* %loadMem_405e7a
}
