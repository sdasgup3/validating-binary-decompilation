...
define %struct.Memory* @_ZNK12ValueWrapperIS_IS_IS_IS_IS_IS_IdEEEEEEEcvT_IdEEv(%struct.State* noalias, i64, %struct.Memory* noalias) #1 {
entry:
  ...
  store %struct.Memory* %loadMem1_405ea0, %struct.Memory** %MEMORY
  ...
  ret %struct.Memory* %loadMem_405eaa
}
