...
define %struct.Memory* @_ZNK12ValueWrapperIS_IS_IS_IdEEEEcvT_IdEEv(%struct.State* noalias, i64, %struct.Memory* noalias) #2 {
entry:
  ...
  store %struct.Memory* %loadMem1_405f10, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_405f19, %struct.Memory** %MEMORY
  ...
  ret %struct.Memory* %loadMem_405f1a
}
