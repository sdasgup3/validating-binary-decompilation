...
define %struct.Memory* @_ZNK12ValueWrapperIS_IdEEcvT_IdEEv(%struct.State* noalias, i64, %struct.Memory* noalias) #1 {
entry:
  ...
  store %struct.Memory* %loadMem_405f30, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_405f34, %struct.Memory** %MEMORY
  ...
  store i64 %78, i64* %81
  store %struct.Memory* %loadMem_405f38, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem1_405f40, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_405f45, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_405f49, %struct.Memory** %MEMORY
  ...
  ret %struct.Memory* %loadMem_405f4a
}
