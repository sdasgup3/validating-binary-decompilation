...
define %struct.Memory* @_ZNK12ValueWrapperIdEcvT_IdEEv(%struct.State* noalias, i64, %struct.Memory* noalias) #1 {
entry:
  ...
  %YMM0.i = bitcast %union.VectorReg* %66 to %"class.std::bitset"*
  ...
  ret %struct.Memory* %loadMem_405f61
}
