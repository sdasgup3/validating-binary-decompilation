...
define %struct.Memory* @_ZNK14PointerWrapperI12ValueWrapperIS0_IS0_IS0_IS0_IS0_IS0_IS0_IS0_IS0_IdEEEEEEEEEEEdeEv(%struct.State* noalias, i64, %struct.Memory* noalias) #2 {
entry:
  ...
  store i64 %40, i64* %43
  store %struct.Memory* %loadMem_403044, %struct.Memory** %MEMORY
  ...
  ret %struct.Memory* %loadMem_403050
}
