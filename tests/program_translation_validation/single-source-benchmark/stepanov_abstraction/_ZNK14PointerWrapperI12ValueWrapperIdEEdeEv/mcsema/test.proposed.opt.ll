...
define %struct.Memory* @_ZNK14PointerWrapperI12ValueWrapperIdEEdeEv(%struct.State* noalias nocapture, i64, %struct.Memory* noalias readnone returned) local_unnamed_addr #0 {
entry:
