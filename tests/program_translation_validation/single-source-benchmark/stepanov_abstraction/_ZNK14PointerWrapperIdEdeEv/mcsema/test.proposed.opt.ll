...
define %struct.Memory* @_ZNK14PointerWrapperIdEdeEv(%struct.State* noalias nocapture, i64, %struct.Memory* noalias readnone returned) local_unnamed_addr #0 {
entry:
  ...
  %11 = add i64 %7, -16
  %12 = load i64, i64* %RDI.i9, align 8
  %13 = add i64 %10, 7
  ...
  store i64 %20, i64* %RDI.i9, align 8
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_movq___rdi____rax(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned) local_unnamed_addr #1 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
