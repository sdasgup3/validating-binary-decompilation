...
declare %struct.Memory* @sub_403090._ZltI12ValueWrapperIS0_IS0_IS0_IS0_IS0_IS0_IS0_IdEEEEEEEEEbRKS0_IT_ESC_(%struct.State* noalias dereferenceable(3376), i64, %struct.Memory* noalias readnone returned)
...
entry:
  ...
  store i64 %93, i64* %96
  store %struct.Memory* %loadMem_40306c, %struct.Memory** %MEMORY
  ...
  %loadMem1_403078 = load %struct.Memory*, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem1_403078, %struct.Memory** %MEMORY
  %loadMem2_403078 = load %struct.Memory*, %struct.Memory** %MEMORY
  %loadPC_403078 = load i64, i64* %3
  %call2_403078 = call %struct.Memory* @sub_403090._ZltI12ValueWrapperIS0_IS0_IS0_IS0_IS0_IS0_IS0_IdEEEEEEEEEbRKS0_IT_ESC_(%struct.State* %0, i64 %loadPC_403078, %struct.Memory* %loadMem2_403078)
  store %struct.Memory* %call2_403078, %struct.Memory** %MEMORY
  %loadMem_40307d = load %struct.Memory*, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_40307d, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_403087, %struct.Memory** %MEMORY
  ret %struct.Memory* %loadMem_403087
}
