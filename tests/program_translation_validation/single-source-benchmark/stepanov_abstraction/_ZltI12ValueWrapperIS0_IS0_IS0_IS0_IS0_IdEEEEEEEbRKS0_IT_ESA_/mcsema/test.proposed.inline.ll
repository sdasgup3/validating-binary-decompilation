...
declare %struct.Memory* @sub_403120._ZltI12ValueWrapperIS0_IS0_IS0_IS0_IdEEEEEEbRKS0_IT_ES9_(%struct.State* noalias dereferenceable(3376), i64, %struct.Memory* noalias readnone returned)
...
entry:
  ...
  store %struct.Memory* %loadMem_4030f0, %struct.Memory** %MEMORY
  %loadMem_4030f1 = load %struct.Memory*, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_4030f1, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_403100, %struct.Memory** %MEMORY
  ...
  %loadMem1_403108 = load %struct.Memory*, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem1_403108, %struct.Memory** %MEMORY
  %loadMem2_403108 = load %struct.Memory*, %struct.Memory** %MEMORY
  %loadPC_403108 = load i64, i64* %3
  %call2_403108 = call %struct.Memory* @sub_403120._ZltI12ValueWrapperIS0_IS0_IS0_IS0_IdEEEEEEbRKS0_IT_ES9_(%struct.State* %0, i64 %loadPC_403108, %struct.Memory* %loadMem2_403108)
  store %struct.Memory* %call2_403108, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_40310f, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_403112, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_403117, %struct.Memory** %MEMORY
  ret %struct.Memory* %loadMem_403117
}
