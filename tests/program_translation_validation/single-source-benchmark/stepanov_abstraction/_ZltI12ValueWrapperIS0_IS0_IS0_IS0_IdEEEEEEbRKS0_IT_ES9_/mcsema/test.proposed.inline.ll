...
define %struct.Memory* @_ZltI12ValueWrapperIS0_IS0_IS0_IS0_IdEEEEEEbRKS0_IT_ES9_(%struct.State* noalias, i64, %struct.Memory* noalias) #2 {
entry:
  ...
  store i64 %78, i64* %81
  store %struct.Memory* %loadMem_403128, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem1_403138, %struct.Memory** %MEMORY
  ...
  ret %struct.Memory* %loadMem_403147
}
