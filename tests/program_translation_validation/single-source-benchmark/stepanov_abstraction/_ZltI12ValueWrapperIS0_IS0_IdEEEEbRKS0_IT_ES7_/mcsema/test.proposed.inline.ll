...
define %struct.Memory* @_ZltI12ValueWrapperIS0_IS0_IdEEEEbRKS0_IT_ES7_(%struct.State* noalias, i64, %struct.Memory* noalias) #1 {
entry:
  ...
  store %struct.Memory* %loadMem_4031c1, %struct.Memory** %MEMORY
  ...
  store i64 %93, i64* %96
  store %struct.Memory* %loadMem_4031cc, %struct.Memory** %MEMORY
  ...
  %loadMem1_4031d8 = load %struct.Memory*, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem1_4031d8, %struct.Memory** %MEMORY
  %loadMem2_4031d8 = load %struct.Memory*, %struct.Memory** %MEMORY
  %loadPC_4031d8 = load i64, i64* %3
  %call2_4031d8 = call %struct.Memory* @sub_4031f0._ZltI12ValueWrapperIS0_IdEEEbRKS0_IT_ES6_(%struct.State* %0, i64 %loadPC_4031d8, %struct.Memory* %loadMem2_4031d8)
  store %struct.Memory* %call2_4031d8, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_4031e6, %struct.Memory** %MEMORY
  %loadMem_4031e7 = load %struct.Memory*, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_4031e7, %struct.Memory** %MEMORY
  ret %struct.Memory* %loadMem_4031e7
}
