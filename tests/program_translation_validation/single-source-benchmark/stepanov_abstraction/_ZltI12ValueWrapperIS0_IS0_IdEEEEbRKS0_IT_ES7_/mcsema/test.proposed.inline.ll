...
declare %struct.Memory* @sub_403200._ZltI12ValueWrapperIS0_IdEEEbRKS0_IT_ES6_(%struct.State* noalias dereferenceable(3376), i64, %struct.Memory* noalias readnone returned)
...
entry:
  ...
  store %struct.Memory* %loadMem_4031d0, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_4031d4, %struct.Memory** %MEMORY
  ...
  store i64 %78, i64* %81
  store %struct.Memory* %loadMem_4031d8, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_4031e0, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_4031e4, %struct.Memory** %MEMORY
  %loadMem1_4031e8 = load %struct.Memory*, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem1_4031e8, %struct.Memory** %MEMORY
  %loadMem2_4031e8 = load %struct.Memory*, %struct.Memory** %MEMORY
  %loadPC_4031e8 = load i64, i64* %3
  %call2_4031e8 = call %struct.Memory* @sub_403200._ZltI12ValueWrapperIS0_IdEEEbRKS0_IT_ES6_(%struct.State* %0, i64 %loadPC_4031e8, %struct.Memory* %loadMem2_4031e8)
  store %struct.Memory* %call2_4031e8, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_4031ed, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_4031f6, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_4031f7, %struct.Memory** %MEMORY
  ret %struct.Memory* %loadMem_4031f7
}
