...
declare %struct.Memory* @sub_4031b0._ZltI12ValueWrapperIS0_IdEEEbRKS0_IT_ES6_(%struct.State* noalias dereferenceable(3376), i64, %struct.Memory* noalias readnone returned)
...
entry:
  ...
  store %struct.Memory* %loadMem_403180, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_403181, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_403184, %struct.Memory** %MEMORY
  %loadMem_403188 = load %struct.Memory*, %struct.Memory** %MEMORY
  ...
  store i64 %78, i64* %81
  store %struct.Memory* %loadMem_403188, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_403190, %struct.Memory** %MEMORY
  ...
  %loadMem1_403198 = load %struct.Memory*, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem1_403198, %struct.Memory** %MEMORY
  %loadMem2_403198 = load %struct.Memory*, %struct.Memory** %MEMORY
  %loadPC_403198 = load i64, i64* %3
  %call2_403198 = call %struct.Memory* @sub_4031b0._ZltI12ValueWrapperIS0_IdEEEbRKS0_IT_ES6_(%struct.State* %0, i64 %loadPC_403198, %struct.Memory* %loadMem2_403198)
  store %struct.Memory* %call2_403198, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_4031a2, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_4031a6, %struct.Memory** %MEMORY
  ...
  ret %struct.Memory* %loadMem_4031a7
}
...
define %struct.Memory* @routine_callq_._ZltI12ValueWrapperIS0_IdEEEbRKS0_IT_ES6_(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) {
block_400478:
  %3 = getelementptr inbounds %struct.State, %struct.State* %0, i32 0, i32 6
  %4 = getelementptr inbounds %struct.GPR, %struct.GPR* %3, i32 0, i32 33
  %5 = getelementptr inbounds %struct.Reg, %struct.Reg* %4, i32 0, i32 0
