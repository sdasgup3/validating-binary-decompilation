...
define %struct.Memory* @_ZltI12ValueWrapperIS0_IdEEEbRKS0_IT_ES6_(%struct.State* noalias, i64, %struct.Memory* noalias) #1 {
entry:
  ...
  store %struct.Memory* %loadMem1_403208, %struct.Memory** %MEMORY
  ...
  ret %struct.Memory* %loadMem_403217
}
