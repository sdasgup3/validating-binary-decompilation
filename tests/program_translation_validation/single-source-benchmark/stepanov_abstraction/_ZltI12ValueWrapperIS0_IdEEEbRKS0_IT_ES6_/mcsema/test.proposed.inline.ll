...
define %struct.Memory* @_ZltI12ValueWrapperIS0_IdEEEbRKS0_IT_ES6_(%struct.State* noalias, i64, %struct.Memory* noalias) #2 {
entry:
  ...
  store %struct.Memory* %loadMem1_403218, %struct.Memory** %MEMORY
  ...
  ret %struct.Memory* %loadMem_403227
}
