...
define %struct.Memory* @_ZltI12ValueWrapperIdEEbRK14PointerWrapperIT_ES6_(%struct.State* noalias, i64, %struct.Memory* noalias) #1 {
entry:
  ...
  %loadMem_4052f3 = load %struct.Memory*, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_4052f3, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_4052ff, %struct.Memory** %MEMORY
  ...
  ret %struct.Memory* %loadMem_405303
}
