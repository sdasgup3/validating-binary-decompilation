...
entry:
  ...
  store %struct.Memory* %loadMem_4052b3, %struct.Memory** %MEMORY
  ...
  %loadMem_4052c3 = load %struct.Memory*, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_4052c3, %struct.Memory** %MEMORY
  ret %struct.Memory* %loadMem_4052c3
}
