...
define %struct.Memory* @_ZltI12ValueWrapperIdEEbRKS0_IT_ES5_(%struct.State* noalias, i64, %struct.Memory* noalias) #2 {
entry:
  ...
  store %struct.Memory* %loadMem1_403248, %struct.Memory** %MEMORY
  ...
  ret %struct.Memory* %loadMem_403257
}
