...
define %struct.Memory* @_ZltIdEbRK12ValueWrapperIT_ES4_(%struct.State* noalias, i64, %struct.Memory* noalias) #2 {
entry:
  ...
  %loadMem_403211 = load %struct.Memory*, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_403211, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_40321c, %struct.Memory** %MEMORY
...
; <label>:147:                                    ; preds = %139
  ...
  %150 = call %struct.Memory* @__remill_error(%struct.State* nonnull dereferenceable(3376) %0, i64 %149, %struct.Memory* %loadMem_40322c)
...
routine_ucomisd__xmm0___xmm1.exit:                ; preds = %147, %164
  %168 = phi %struct.Memory* [ %150, %147 ], [ %loadMem_40322c, %164 ]
  ...
  ret %struct.Memory* %loadMem_403239
}
