...
define %struct.Memory* @_ZmiI12ValueWrapperIdEElR14PointerWrapperIT_ES5_(%struct.State* noalias, i64, %struct.Memory* noalias) #1 {
entry:
  ...
  store %struct.Memory* %loadMem_403d10, %struct.Memory** %MEMORY
  ...
  store i64 %40, i64* %43
  store %struct.Memory* %loadMem_403d14, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_403d2a, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_403d35, %struct.Memory** %MEMORY
  ret %struct.Memory* %loadMem_403d35
}
