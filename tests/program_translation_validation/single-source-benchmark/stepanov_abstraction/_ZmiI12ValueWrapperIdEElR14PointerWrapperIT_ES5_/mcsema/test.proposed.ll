...
entry:
  ...
  ; Code: ._ZmiI12ValueWrapperIdEElR14PointerWrapperIT_ES5_:	 RIP: 403cd0	 Bytes: 0
  ...
  ; Code: movq %rsi, -0x10(%rbp)	 RIP: 403cd8	 Bytes: 4
  %loadMem_403cd8 = load %struct.Memory*, %struct.Memory** %MEMORY
  %call_403cd8 = call %struct.Memory* @routine_movq__rsi__MINUS0x10__rbp_(%struct.State* %0, i64  0, %struct.Memory* %loadMem_403cd8)
  store %struct.Memory* %call_403cd8, %struct.Memory** %MEMORY

  ; Code: movq -0x8(%rbp), %rsi	 RIP: 403cdc	 Bytes: 4
  %loadMem_403cdc = load %struct.Memory*, %struct.Memory** %MEMORY
  %call_403cdc = call %struct.Memory* @routine_movq_MINUS0x8__rbp____rsi(%struct.State* %0, i64  0, %struct.Memory* %loadMem_403cdc)
  store %struct.Memory* %call_403cdc, %struct.Memory** %MEMORY

  ; Code: movq (%rsi), %rsi	 RIP: 403ce0	 Bytes: 3
  %loadMem_403ce0 = load %struct.Memory*, %struct.Memory** %MEMORY
  %call_403ce0 = call %struct.Memory* @routine_movq___rsi____rsi(%struct.State* %0, i64  0, %struct.Memory* %loadMem_403ce0)
  store %struct.Memory* %call_403ce0, %struct.Memory** %MEMORY

  ; Code: movq -0x10(%rbp), %rdi	 RIP: 403ce3	 Bytes: 4
  %loadMem_403ce3 = load %struct.Memory*, %struct.Memory** %MEMORY
  %call_403ce3 = call %struct.Memory* @routine_movq_MINUS0x10__rbp____rdi(%struct.State* %0, i64  0, %struct.Memory* %loadMem_403ce3)
  store %struct.Memory* %call_403ce3, %struct.Memory** %MEMORY

  ; Code: movq (%rdi), %rdi	 RIP: 403ce7	 Bytes: 3
  %loadMem_403ce7 = load %struct.Memory*, %struct.Memory** %MEMORY
  %call_403ce7 = call %struct.Memory* @routine_movq___rdi____rdi(%struct.State* %0, i64  0, %struct.Memory* %loadMem_403ce7)
  store %struct.Memory* %call_403ce7, %struct.Memory** %MEMORY

  ; Code: subq %rdi, %rsi	 RIP: 403cea	 Bytes: 3
  %loadMem_403cea = load %struct.Memory*, %struct.Memory** %MEMORY
  %call_403cea = call %struct.Memory* @routine_subq__rdi___rsi(%struct.State* %0, i64  0, %struct.Memory* %loadMem_403cea)
  store %struct.Memory* %call_403cea, %struct.Memory** %MEMORY

  ; Code: sarq $0x3, %rsi	 RIP: 403ced	 Bytes: 4
  %loadMem_403ced = load %struct.Memory*, %struct.Memory** %MEMORY
  %call_403ced = call %struct.Memory* @routine_sarq__0x3___rsi(%struct.State* %0, i64  0, %struct.Memory* %loadMem_403ced)
  store %struct.Memory* %call_403ced, %struct.Memory** %MEMORY

  ; Code: movq %rsi, %rax	 RIP: 403cf1	 Bytes: 3
  %loadMem_403cf1 = load %struct.Memory*, %struct.Memory** %MEMORY
  %call_403cf1 = call %struct.Memory* @routine_movq__rsi___rax(%struct.State* %0, i64  0, %struct.Memory* %loadMem_403cf1)
  store %struct.Memory* %call_403cf1, %struct.Memory** %MEMORY

  ; Code: popq %rbp	 RIP: 403cf4	 Bytes: 1
  %loadMem_403cf4 = load %struct.Memory*, %struct.Memory** %MEMORY
  %call_403cf4 = call %struct.Memory* @routine_popq__rbp(%struct.State* %0, i64  0, %struct.Memory* %loadMem_403cf4)
  store %struct.Memory* %call_403cf4, %struct.Memory** %MEMORY

  ; Code: retq	 RIP: 403cf5	 Bytes: 1
  %loadMem_403cf5 = load %struct.Memory*, %struct.Memory** %MEMORY
  %call_403cf5 = call %struct.Memory* @routine_retq(%struct.State* %0, i64  0, %struct.Memory* %loadMem_403cf5)
  store %struct.Memory* %call_403cf5, %struct.Memory** %MEMORY

  ret %struct.Memory* %call_403cf5
}
