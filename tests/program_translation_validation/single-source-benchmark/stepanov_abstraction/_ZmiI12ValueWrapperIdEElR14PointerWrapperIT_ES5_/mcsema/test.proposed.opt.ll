...
define %struct.Memory* @_ZmiI12ValueWrapperIdEElR14PointerWrapperIT_ES5_(%struct.State* noalias nocapture, i64, %struct.Memory* noalias readnone returned) local_unnamed_addr #1 {
entry:
