...
define %struct.Memory* @_ZmiIdElR14PointerWrapperIT_ES3_(%struct.State* noalias, i64, %struct.Memory* noalias) #1 {
entry:
  ...
  store %struct.Memory* %loadMem_404795, %struct.Memory** %MEMORY
  ret %struct.Memory* %loadMem_404795
}
