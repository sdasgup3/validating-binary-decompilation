...
define %struct.Memory* @_ZneI12ValueWrapperIS0_IS0_IS0_IS0_IS0_IS0_IS0_IS0_IS0_IdEEEEEEEEEEEbRK14PointerWrapperIT_ESF_(%struct.State* noalias, i64, %struct.Memory* noalias) #1 {
entry:
  ...
  store %struct.Memory* %loadMem_403063, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_40306f, %struct.Memory** %MEMORY
  ...
  ret %struct.Memory* %loadMem_403073
}
