...
entry:
  ...
  ; Code: ._ZneI12ValueWrapperIS0_IS0_IS0_IS0_IS0_IS0_IS0_IS0_IS0_IdEEEEEEEEEEEbRK14PointerWrapperIT_ESF_:	 RIP: 403010	 Bytes: 0
  ...
  ; Code: movq %rdi, -0x8(%rbp)	 RIP: 403014	 Bytes: 4
  %loadMem_403014 = load %struct.Memory*, %struct.Memory** %MEMORY
  %call_403014 = call %struct.Memory* @routine_movq__rdi__MINUS0x8__rbp_(%struct.State* %0, i64  0, %struct.Memory* %loadMem_403014)
  store %struct.Memory* %call_403014, %struct.Memory** %MEMORY

  ; Code: movq %rsi, -0x10(%rbp)	 RIP: 403018	 Bytes: 4
  %loadMem_403018 = load %struct.Memory*, %struct.Memory** %MEMORY
  %call_403018 = call %struct.Memory* @routine_movq__rsi__MINUS0x10__rbp_(%struct.State* %0, i64  0, %struct.Memory* %loadMem_403018)
  store %struct.Memory* %call_403018, %struct.Memory** %MEMORY

  ; Code: movq -0x8(%rbp), %rsi	 RIP: 40301c	 Bytes: 4
  %loadMem_40301c = load %struct.Memory*, %struct.Memory** %MEMORY
  %call_40301c = call %struct.Memory* @routine_movq_MINUS0x8__rbp____rsi(%struct.State* %0, i64  0, %struct.Memory* %loadMem_40301c)
  store %struct.Memory* %call_40301c, %struct.Memory** %MEMORY

  ; Code: movq (%rsi), %rsi	 RIP: 403020	 Bytes: 3
  %loadMem_403020 = load %struct.Memory*, %struct.Memory** %MEMORY
  %call_403020 = call %struct.Memory* @routine_movq___rsi____rsi(%struct.State* %0, i64  0, %struct.Memory* %loadMem_403020)
  store %struct.Memory* %call_403020, %struct.Memory** %MEMORY

  ; Code: movq -0x10(%rbp), %rdi	 RIP: 403023	 Bytes: 4
  %loadMem_403023 = load %struct.Memory*, %struct.Memory** %MEMORY
  %call_403023 = call %struct.Memory* @routine_movq_MINUS0x10__rbp____rdi(%struct.State* %0, i64  0, %struct.Memory* %loadMem_403023)
  store %struct.Memory* %call_403023, %struct.Memory** %MEMORY

  ; Code: cmpq (%rdi), %rsi	 RIP: 403027	 Bytes: 3
  %loadMem_403027 = load %struct.Memory*, %struct.Memory** %MEMORY
  %call_403027 = call %struct.Memory* @routine_cmpq___rdi____rsi(%struct.State* %0, i64  0, %struct.Memory* %loadMem_403027)
  store %struct.Memory* %call_403027, %struct.Memory** %MEMORY

  ; Code: setne %al	 RIP: 40302a	 Bytes: 3
  %loadMem_40302a = load %struct.Memory*, %struct.Memory** %MEMORY
  %call_40302a = call %struct.Memory* @routine_setne__al(%struct.State* %0, i64  0, %struct.Memory* %loadMem_40302a)
  store %struct.Memory* %call_40302a, %struct.Memory** %MEMORY

  ; Code: andb $0x1, %al	 RIP: 40302d	 Bytes: 2
  %loadMem_40302d = load %struct.Memory*, %struct.Memory** %MEMORY
  %call_40302d = call %struct.Memory* @routine_andb__0x1___al(%struct.State* %0, i64  0, %struct.Memory* %loadMem_40302d)
  store %struct.Memory* %call_40302d, %struct.Memory** %MEMORY

  ; Code: movzbl %al, %eax	 RIP: 40302f	 Bytes: 3
  %loadMem_40302f = load %struct.Memory*, %struct.Memory** %MEMORY
  %call_40302f = call %struct.Memory* @routine_movzbl__al___eax(%struct.State* %0, i64  0, %struct.Memory* %loadMem_40302f)
  store %struct.Memory* %call_40302f, %struct.Memory** %MEMORY

  ; Code: popq %rbp	 RIP: 403032	 Bytes: 1
  %loadMem_403032 = load %struct.Memory*, %struct.Memory** %MEMORY
  %call_403032 = call %struct.Memory* @routine_popq__rbp(%struct.State* %0, i64  0, %struct.Memory* %loadMem_403032)
  store %struct.Memory* %call_403032, %struct.Memory** %MEMORY

  ; Code: retq	 RIP: 403033	 Bytes: 1
  %loadMem_403033 = load %struct.Memory*, %struct.Memory** %MEMORY
  %call_403033 = call %struct.Memory* @routine_retq(%struct.State* %0, i64  0, %struct.Memory* %loadMem_403033)
  store %struct.Memory* %call_403033, %struct.Memory** %MEMORY

  ret %struct.Memory* %call_403033
}
