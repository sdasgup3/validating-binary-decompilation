...
define %struct.Memory* @_ZneI12ValueWrapperIdEEbRK14PointerWrapperIT_ES6_(%struct.State* noalias, i64, %struct.Memory* noalias) #2 {
entry:
  ...
  store %struct.Memory* %loadMem_403cd2, %struct.Memory** %MEMORY
  ...
  ret %struct.Memory* %loadMem_403cd3
}
