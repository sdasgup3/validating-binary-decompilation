...
define %struct.Memory* @_ZneI12ValueWrapperIdEEbRK14PointerWrapperIT_ES6_(%struct.State* noalias nocapture, i64, %struct.Memory* noalias readnone returned) local_unnamed_addr #1 {
entry:
