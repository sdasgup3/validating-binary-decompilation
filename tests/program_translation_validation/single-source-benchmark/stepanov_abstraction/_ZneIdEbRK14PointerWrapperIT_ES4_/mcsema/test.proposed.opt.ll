...
define %struct.Memory* @_ZneIdEbRK14PointerWrapperIT_ES4_(%struct.State* noalias nocapture, i64, %struct.Memory* noalias readnone returned) local_unnamed_addr #1 {
entry:
