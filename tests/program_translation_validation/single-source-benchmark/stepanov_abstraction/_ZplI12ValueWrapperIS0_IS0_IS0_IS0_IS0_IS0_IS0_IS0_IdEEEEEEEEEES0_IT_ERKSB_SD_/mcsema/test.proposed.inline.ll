...
define %struct.Memory* @_ZplI12ValueWrapperIS0_IS0_IS0_IS0_IS0_IS0_IS0_IS0_IdEEEEEEEEEES0_IT_ERKSB_SD_(%struct.State* noalias, i64, %struct.Memory* noalias) #2 {
entry:
  ...
  store %struct.Memory* %loadMem1_405f98, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_405f9d, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem1_405faa, %struct.Memory** %MEMORY
  ...
  ret %struct.Memory* %loadMem_405fb9
}
