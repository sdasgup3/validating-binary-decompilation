...
define %struct.Memory* @_ZplI12ValueWrapperIS0_IS0_IS0_IS0_IS0_IS0_IdEEEEEEEES0_IT_ERKS9_SB_(%struct.State* noalias, i64, %struct.Memory* noalias) #2 {
entry:
  ...
  store %struct.Memory* %loadMem1_406038, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem1_40604a, %struct.Memory** %MEMORY
  ...
  ret %struct.Memory* %loadMem_406059
}
