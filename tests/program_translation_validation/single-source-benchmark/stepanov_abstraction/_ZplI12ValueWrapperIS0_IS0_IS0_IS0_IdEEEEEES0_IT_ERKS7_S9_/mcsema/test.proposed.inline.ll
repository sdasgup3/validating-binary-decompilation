...
define %struct.Memory* @_ZplI12ValueWrapperIS0_IS0_IS0_IS0_IdEEEEEES0_IT_ERKS7_S9_(%struct.State* noalias, i64, %struct.Memory* noalias) #2 {
entry:
  ...
  store %struct.Memory* %loadMem_4060e4, %struct.Memory** %MEMORY
  ...
  store i64 %78, i64* %81
  store %struct.Memory* %loadMem_4060e8, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem1_4060f8, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_4060fd, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_406101, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_406105, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem1_40610a, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_40610f, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_406114, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_406118, %struct.Memory** %MEMORY
  ...
  ret %struct.Memory* %loadMem_406119
}
