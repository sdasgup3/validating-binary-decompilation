...
define %struct.Memory* @_ZplI12ValueWrapperIS0_IS0_IS0_IS0_IdEEEEEES0_IT_ERKS7_S9_(%struct.State* noalias, i64, %struct.Memory* noalias) #1 {
entry:
  ...
  store %struct.Memory* %loadMem_4060d1, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem1_4060e8, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_4060ed, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem1_4060fa, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_406108, %struct.Memory** %MEMORY
  ...
  ret %struct.Memory* %loadMem_406109
}
