...
define %struct.Memory* @_ZplI12ValueWrapperIS0_IS0_IdEEEES0_IT_ERKS5_S7_(%struct.State* noalias, i64, %struct.Memory* noalias) #2 {
entry:
  ...
  store i64 %78, i64* %81
  store %struct.Memory* %loadMem_406158, %struct.Memory** %MEMORY
  ...
  store i64 %93, i64* %96
  store %struct.Memory* %loadMem_40615c, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem1_406168, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_40616d, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_406171, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem1_40617a, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_40617f, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_406184, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_406189, %struct.Memory** %MEMORY
  ret %struct.Memory* %loadMem_406189
}
