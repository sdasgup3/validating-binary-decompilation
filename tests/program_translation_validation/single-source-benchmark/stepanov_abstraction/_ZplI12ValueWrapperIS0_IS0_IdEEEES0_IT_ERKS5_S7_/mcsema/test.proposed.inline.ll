...
entry:
  ...
  store %struct.Memory* %loadMem1_4061b8, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_4061c1, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem1_4061ca, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_4061d9, %struct.Memory** %MEMORY
  ret %struct.Memory* %loadMem_4061d9
}
