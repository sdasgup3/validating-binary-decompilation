...
declare %struct.Memory* @sub_406200._ZplI12ValueWrapperIS0_IdEEES0_IT_ERKS4_S6_(%struct.State* noalias dereferenceable(3376), i64, %struct.Memory* noalias readnone returned) local_unnamed_addr

declare %struct.Memory* @sub_406240._ZN12ValueWrapperIS_IS_IS_IdEEEEC2IS2_EERKT_(%struct.State* noalias dereferenceable(3376), i64, %struct.Memory* noalias readnone returned) local_unnamed_addr
...
entry:
  ...
  %call2_4061b8 = tail call %struct.Memory* @sub_406200._ZplI12ValueWrapperIS0_IdEEES0_IT_ERKS4_S6_(%struct.State* %0, i64 %59, %struct.Memory* %2)
  ...
  %call2_4061ca = tail call %struct.Memory* @sub_406240._ZN12ValueWrapperIS_IS_IS_IdEEEEC2IS2_EERKT_(%struct.State* %0, i64 %73, %struct.Memory* %call2_4061b8)
  ...
  ret %struct.Memory* %call2_4061ca
}
