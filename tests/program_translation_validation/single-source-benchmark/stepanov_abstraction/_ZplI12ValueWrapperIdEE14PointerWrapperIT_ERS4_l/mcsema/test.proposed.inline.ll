...
define %struct.Memory* @_ZplI12ValueWrapperIdEE14PointerWrapperIT_ERS4_l(%struct.State* noalias, i64, %struct.Memory* noalias) #1 {
entry:
  ...
  store %struct.Memory* %loadMem_403d5b, %struct.Memory** %MEMORY
  ...
  ret %struct.Memory* %loadMem_403d6c
}
