...
declare %struct.Memory* @sub_4062c0._ZN12ValueWrapperIS_IdEEC2IS0_EERKT_(%struct.State* noalias dereferenceable(3376), i64, %struct.Memory* noalias readnone returned)
...
entry:
  ...
  %loadMem1_406228 = load %struct.Memory*, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem1_406228, %struct.Memory** %MEMORY
  %loadMem2_406228 = load %struct.Memory*, %struct.Memory** %MEMORY
  %loadPC_406228 = load i64, i64* %3
  %call2_406228 = call %struct.Memory* @sub_406270._ZplIdE12ValueWrapperIT_ERKS2_S4_(%struct.State* %0, i64 %loadPC_406228, %struct.Memory* %loadMem2_406228)
  store %struct.Memory* %call2_406228, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_406235, %struct.Memory** %MEMORY
  %loadMem1_40623a = load %struct.Memory*, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem1_40623a, %struct.Memory** %MEMORY
  %loadMem2_40623a = load %struct.Memory*, %struct.Memory** %MEMORY
  %loadPC_40623a = load i64, i64* %3
  %call2_40623a = call %struct.Memory* @sub_4062c0._ZN12ValueWrapperIS_IdEEC2IS0_EERKT_(%struct.State* %0, i64 %loadPC_40623a, %struct.Memory* %loadMem2_40623a)
  store %struct.Memory* %call2_40623a, %struct.Memory** %MEMORY
  ...
  ret %struct.Memory* %loadMem_406249
}
