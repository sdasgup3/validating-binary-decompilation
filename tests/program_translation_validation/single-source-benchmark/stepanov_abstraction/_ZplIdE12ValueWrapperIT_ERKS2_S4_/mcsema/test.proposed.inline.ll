...
entry:
  ...
  store %struct.Memory* %loadMem_406288, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_40629d, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem1_4062a3, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_4062ad, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_4062b2, %struct.Memory** %MEMORY
  ret %struct.Memory* %loadMem_4062b2
}
