...
define %struct.Memory* @_ZplIdE12ValueWrapperIT_ERKS2_S4_(%struct.State* noalias, i64, %struct.Memory* noalias) local_unnamed_addr #1 {
entry:
  ...
  %call2_4062a3 = tail call %struct.Memory* @sub_401d20._ZN12ValueWrapperIdEC2IdEERKT_(%struct.State* %0, i64 %77, %struct.Memory* %2)
