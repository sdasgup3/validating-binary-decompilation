...
entry:
  ...
  %loadMem_402fea = load %struct.Memory*, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_402fea, %struct.Memory** %MEMORY
  %loadMem1_402fee = load %struct.Memory*, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem1_402fee, %struct.Memory** %MEMORY
  %loadMem2_402fee = load %struct.Memory*, %struct.Memory** %MEMORY
  %loadPC_402fee = load i64, i64* %3
  %call2_402fee = call %struct.Memory* @sub_403240._ZppI12ValueWrapperIS0_IS0_IS0_IS0_IS0_IS0_IS0_IS0_IS0_IdEEEEEEEEEEER14PointerWrapperIT_ESE_(%struct.State* %0, i64 %loadPC_402fee, %struct.Memory* %loadMem2_402fee)
  store %struct.Memory* %call2_402fee, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_402ff3, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_402ffe, %struct.Memory** %MEMORY
  ...
  ret %struct.Memory* %loadMem_403003
}
