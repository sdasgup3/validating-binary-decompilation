...
define %struct.Memory* @_ZppIdE14PointerWrapperIT_ERS2_i(%struct.State* noalias, i64, %struct.Memory* noalias) #1 {
entry:
  ...
  store %struct.Memory* %loadMem1_4046de, %struct.Memory** %MEMORY
  ...
  ret %struct.Memory* %loadMem_4046f3
}
