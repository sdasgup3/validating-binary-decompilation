...
define %struct.Memory* @_ZppIdER14PointerWrapperIT_ES3_(%struct.State* noalias, i64, %struct.Memory* noalias) #2 {
entry:
  ...
  %loadMem_404726 = load %struct.Memory*, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_404726, %struct.Memory** %MEMORY
  ...
  ret %struct.Memory* %loadMem_40472b
}
