...
entry:
  ...
  store i64 6392624, i64* %RAX.i34, align 8
  %40 = add i64 %7, -16
  %41 = add i64 %10, 21
  store i64 %41, i64* %3, align 8
  %42 = inttoptr i64 %40 to i64*
  store i64 6392624, i64* %42, align 8
...
block_.L_4008ab:                                  ; preds = %block_.L_4008ab, %entry
  %45 = phi i64 [ %94, %block_.L_4008ab ], [ %44, %entry ]
  ...
  %call2_4008b6 = tail call %struct.Memory* @sub_401d50._ZN12ValueWrapperIdEC2Ev(%struct.State* nonnull %0, i64 %55, %struct.Memory* %2)
  %60 = load i64, i64* %3, align 8
  store i64 6408624, i64* %RAX.i34, align 8
  ...
  %67 = lshr i64 %66, 63
  %68 = add i64 %65, -6408616
  %69 = icmp ult i64 %66, 6408624
  %70 = zext i1 %69 to i8
  ...
  br i1 %97, label %block_.L_4008ab, label %block_4008e0

block_4008e0:                                     ; preds = %block_.L_4008ab
...
block_400488:
  ...
  store i64 6392624, i64* %RAX, align 8
  ret %struct.Memory* %2
}
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_jmpq_.L_4008ab(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_jne_.L_4008ab(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i8* nocapture %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
