...
block_.L_4008cb:                                  ; preds = %block_.L_4008cb, %entry
  ...
  store i64 ptrtoint (%G__0x61c9b0_type* @G__0x61c9b0 to i64), i64* %RAX.i18, align 8
...
block_400900:                                     ; preds = %block_.L_4008cb
  ...
  ret %struct.Memory* %loadMem_400905
}
...
define %struct.Memory* @routine_movq__0x61c9b0___rax(%struct.State* dereferenceable(3376), i64, %struct.Memory*) {
block_400478:
  %3 = getelementptr inbounds %struct.State, %struct.State* %0, i32 0, i32 6
  %4 = getelementptr inbounds %struct.GPR, %struct.GPR* %3, i32 0, i32 33
  %5 = getelementptr inbounds %struct.Reg, %struct.Reg* %4, i32 0, i32 0
