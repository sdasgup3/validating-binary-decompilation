...
entry:
  ...
  store i64 6424648, i64* %RDI.i, align 8
  ...
  %45 = load i64, i64* inttoptr (i64 6328496 to i64*)
  ...
  %call2_4009c6 = call %struct.Memory* @sub_401c10._ZN14PointerWrapperIdEC2EPd(%struct.State* %0, i64 %loadPC_4009c6, %struct.Memory* %loadMem2_4009c6)
  ...
  ret %struct.Memory* %loadMem_4009cc
}
...
block_400488:
  ...
  %10 = add i64 %9, 10
  store i64 %10, i64* %PC
  store i64 6424648, i64* %RDI, align 8
  ret %struct.Memory* %2
}
