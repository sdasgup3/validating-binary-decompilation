...
block_.L_4007ab:                                  ; preds = %block_.L_4007ab, %entry
  ...
  %loadMem1_4007b6 = load %struct.Memory*, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem1_4007b6, %struct.Memory** %MEMORY
  %loadMem2_4007b6 = load %struct.Memory*, %struct.Memory** %MEMORY
  %loadPC_4007b6 = load i64, i64* %3
  %call2_4007b6 = call %struct.Memory* @sub_401d10._ZN12ValueWrapperIdEC2Ev(%struct.State* %0, i64 %loadPC_4007b6, %struct.Memory* %loadMem2_4007b6)
  store %struct.Memory* %call2_4007b6, %struct.Memory** %MEMORY
  ...
  br i1 %cmpBr_4007da, label %block_.L_4007ab, label %block_4007e0

block_4007e0:                                     ; preds = %block_.L_4007ab
  ...
  ret %struct.Memory* %loadMem_4007e5
}
...
define %struct.Memory* @routine_jne_.L_4007ab(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i8* %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) {
block_400478:
  %3 = getelementptr inbounds %struct.State, %struct.State* %0, i32 0, i32 6
  %4 = getelementptr inbounds %struct.GPR, %struct.GPR* %3, i32 0, i32 33
  %5 = getelementptr inbounds %struct.Reg, %struct.Reg* %4, i32 0, i32 0
