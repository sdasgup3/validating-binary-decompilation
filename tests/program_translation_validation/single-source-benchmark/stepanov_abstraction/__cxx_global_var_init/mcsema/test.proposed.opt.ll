...
entry:
  ...
  store i64 6344624, i64* %42, align 8
...
block_.L_4007eb:                                  ; preds = %block_.L_4007eb, %entry
  ...
  %67 = lshr i64 %66, 63
  %68 = add i64 %65, -6360616
  %69 = icmp ult i64 %66, 6360624
  %70 = zext i1 %69 to i8
  ...
  br i1 %97, label %block_.L_4007eb, label %block_400820
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_jne_.L_4007eb(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i8* nocapture %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
