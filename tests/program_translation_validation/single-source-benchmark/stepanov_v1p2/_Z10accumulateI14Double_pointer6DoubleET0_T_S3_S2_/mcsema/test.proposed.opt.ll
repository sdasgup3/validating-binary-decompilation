...
block_.L_402a15:                                  ; preds = %block_402a2b, %entry
  %58 = phi i64 [ %123, %block_402a2b ], [ %.pre, %entry ]
  ...
  %call2_402a1d = tail call %struct.Memory* @sub_402a80._ZneI14Double_pointerEiRKT_S3_(%struct.State* nonnull %0, i64 %62, %struct.Memory* %2)
  ...
  br i1 %74, label %block_.L_402a6b, label %block_402a2b
...
block_402a2b:                                     ; preds = %block_.L_402a15
  ...
  %call2_402a31 = tail call %struct.Memory* @sub_402ac0._ZN14Double_pointerppEi(%struct.State* nonnull %0, i64 %81, %struct.Memory* %2)
  ...
  %call2_402a3e = tail call %struct.Memory* @sub_401e00._ZNK14Double_pointerdeEv(%struct.State* nonnull %0, i64 %93, %struct.Memory* %2)
  ...
  %call2_402a54 = tail call %struct.Memory* @"sub_401160._ZN3$_0clERK6DoubleS2_"(%struct.State* nonnull %0, i64 %102, %struct.Memory* %2)
