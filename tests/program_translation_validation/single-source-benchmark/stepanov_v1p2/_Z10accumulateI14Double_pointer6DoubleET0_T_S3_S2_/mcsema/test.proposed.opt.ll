...
declare %struct.Memory* @sub_402a60._ZneI14Double_pointerEiRKT_S3_(%struct.State* noalias dereferenceable(3376), i64, %struct.Memory* noalias readnone returned) local_unnamed_addr

declare %struct.Memory* @sub_402aa0._ZN14Double_pointerppEi(%struct.State* noalias dereferenceable(3376), i64, %struct.Memory* noalias readnone returned) local_unnamed_addr

declare %struct.Memory* @sub_401de0._ZNK14Double_pointerdeEv(%struct.State* noalias dereferenceable(3376), i64, %struct.Memory* noalias readnone returned) local_unnamed_addr
...
block_.L_4029f5:                                  ; preds = %block_402a0b, %entry
  %59 = phi i64 [ %.pre, %entry ], [ %124, %block_402a0b ]
  %MEMORY.0 = phi %struct.Memory* [ %2, %entry ], [ %call2_402a34, %block_402a0b ]
  ...
  %call2_4029fd = tail call %struct.Memory* @sub_402a60._ZneI14Double_pointerEiRKT_S3_(%struct.State* %0, i64 %63, %struct.Memory* %MEMORY.0)
  ...
  br i1 %75, label %block_.L_402a4b, label %block_402a0b
...
block_402a0b:                                     ; preds = %block_.L_4029f5
  ...
  %call2_402a11 = tail call %struct.Memory* @sub_402aa0._ZN14Double_pointerppEi(%struct.State* %0, i64 %82, %struct.Memory* %call2_4029fd)
  ...
  %call2_402a1e = tail call %struct.Memory* @sub_401de0._ZNK14Double_pointerdeEv(%struct.State* %0, i64 %94, %struct.Memory* %call2_402a11)
  ...
  %call2_402a34 = tail call %struct.Memory* @"sub_401140._ZN3$_0clERK6DoubleS2_"(%struct.State* %0, i64 %103, %struct.Memory* %call2_402a1e)
...
block_.L_402a4b:                                  ; preds = %block_.L_4029f5
  ...
  ret %struct.Memory* %call2_4029fd
}
...
define %struct.Memory* @routine_je_.L_402a4b(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i8* %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
...
define %struct.Memory* @routine_jmpq_.L_4029f5(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
