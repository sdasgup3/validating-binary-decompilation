...
define %struct.Memory* @_Z10accumulateI16reverse_iteratorI14double_pointerdEdET0_T_S4_S3_(%struct.State* noalias, i64, %struct.Memory* noalias) #2 {
entry:
...
block_.L_4026d5:                                  ; preds = %block_4026eb, %entry
  ...
  store %struct.Memory* %loadMem1_4026dd, %struct.Memory** %MEMORY
...
block_4026eb:                                     ; preds = %block_.L_4026d5
  ...
  store %struct.Memory* %loadMem1_4026f1, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem1_4026fe, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_402703, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem1_402714, %struct.Memory** %MEMORY
