...
declare %struct.Memory* @sub_402750._ZneI16reverse_iteratorI14double_pointerdEEiRKT_S5_(%struct.State* noalias dereferenceable(3376), i64, %struct.Memory* noalias readnone returned) local_unnamed_addr

declare %struct.Memory* @sub_402790._ZN16reverse_iteratorI14double_pointerdEppEi(%struct.State* noalias dereferenceable(3376), i64, %struct.Memory* noalias readnone returned) local_unnamed_addr
...
block_.L_4026f5:                                  ; preds = %block_40270b, %entry
  %57 = phi i64 [ %113, %block_40270b ], [ %.pre, %entry ]
  ...
  %call2_4026fd = tail call %struct.Memory* @sub_402750._ZneI16reverse_iteratorI14double_pointerdEEiRKT_S5_(%struct.State* nonnull %0, i64 %61, %struct.Memory* %2)
  ...
  br i1 %73, label %block_.L_402743, label %block_40270b

block_40270b:                                     ; preds = %block_.L_4026f5
  %79 = add i64 %78, -8
  ...
  %call2_402711 = tail call %struct.Memory* @sub_402790._ZN16reverse_iteratorI14double_pointerdEppEi(%struct.State* nonnull %0, i64 %80, %struct.Memory* %2)
  ...
  %call2_40271e = tail call %struct.Memory* @sub_402050._ZNK16reverse_iteratorI14double_pointerdEdeEv(%struct.State* nonnull %0, i64 %92, %struct.Memory* %2)
  ...
  %call2_402734 = tail call %struct.Memory* @"sub_4011a0._ZN3$_0clERKdS1_"(%struct.State* nonnull %0, i64 %101, %struct.Memory* %2)
...
block_.L_402743:                                  ; preds = %block_.L_4026f5
  %114 = add i64 %78, -24
  %115 = add i64 %77, 5
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_je_.L_402743(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i8* nocapture %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_jmpq_.L_4026f5(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
