...
declare %struct.Memory* @sub_402860._ZneI16reverse_iteratorIP6DoubleS1_EEiRKT_S6_(%struct.State* dereferenceable(3376), i64, %struct.Memory*) local_unnamed_addr

declare %struct.Memory* @sub_4028a0._ZN16reverse_iteratorIP6DoubleS0_EppEi(%struct.State* dereferenceable(3376), i64, %struct.Memory*) local_unnamed_addr

declare %struct.Memory* @sub_4022f0._ZNK16reverse_iteratorIP6DoubleS0_EdeEv(%struct.State* dereferenceable(3376), i64, %struct.Memory*) local_unnamed_addr
...
block_.L_4027f5:                                  ; preds = %block_40280b, %entry
  %58 = phi i64 [ %.pre, %entry ], [ %123, %block_40280b ]
  %MEMORY.0 = phi %struct.Memory* [ %2, %entry ], [ %call2_402834, %block_40280b ]
  ...
  %call2_4027fd = tail call %struct.Memory* @sub_402860._ZneI16reverse_iteratorIP6DoubleS1_EEiRKT_S6_(%struct.State* nonnull %0, i64 %62, %struct.Memory* %MEMORY.0)
  ...
  br i1 %74, label %block_.L_40284b, label %block_40280b
...
block_40280b:                                     ; preds = %block_.L_4027f5
  ...
  %call2_402811 = tail call %struct.Memory* @sub_4028a0._ZN16reverse_iteratorIP6DoubleS0_EppEi(%struct.State* nonnull %0, i64 %81, %struct.Memory* %call2_4027fd)
  ...
  %call2_40281e = tail call %struct.Memory* @sub_4022f0._ZNK16reverse_iteratorIP6DoubleS0_EdeEv(%struct.State* nonnull %0, i64 %93, %struct.Memory* %call2_402811)
  ...
  %call2_402834 = tail call %struct.Memory* @"sub_401150._ZN3$_0clERK6DoubleS2_"(%struct.State* nonnull %0, i64 %102, %struct.Memory* %call2_40281e)
...
block_.L_40284b:                                  ; preds = %block_.L_4027f5
  ...
  ret %struct.Memory* %call2_4027fd
}
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_je_.L_40284b(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i8* nocapture %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_jmpq_.L_4027f5(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
