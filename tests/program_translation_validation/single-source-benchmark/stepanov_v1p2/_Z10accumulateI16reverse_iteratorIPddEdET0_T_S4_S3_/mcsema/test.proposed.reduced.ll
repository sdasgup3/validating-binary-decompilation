; ModuleID = '/tmp/tmpi994y2_v-query.ll'
...
declare %struct.Memory* @sub_402970._ZneI16reverse_iteratorIPddEEiRKT_S5_(%struct.State* noalias dereferenceable(3376), i64, %struct.Memory* noalias readnone returned) local_unnamed_addr

declare %struct.Memory* @sub_4029b0._ZN16reverse_iteratorIPddEppEi(%struct.State* noalias dereferenceable(3376), i64, %struct.Memory* noalias readnone returned) local_unnamed_addr

declare %struct.Memory* @sub_402500._ZNK16reverse_iteratorIPddEdeEv(%struct.State* noalias dereferenceable(3376), i64, %struct.Memory* noalias readnone returned) local_unnamed_addr
...
define %struct.Memory* @_Z10accumulateI16reverse_iteratorIPddEdET0_T_S4_S3_(%struct.State* noalias, i64, %struct.Memory* noalias readnone) local_unnamed_addr #1 {
entry:
...
; Matched:%var_2_55:  %var_2_55 = phi i64 [ %var_2_152, %block_40292b ], [ %.pre, %block_402900 ]
; %var_2_57 = phi i64 [ %var_2_113, %block_40292b ], [ %.pre, %entry ]
...
; Matched:\<badref\>:  store i64 %var_2_57, i64* %RDI, align 8, !tbaa !1261
; store i64 %var_2_59, i64* %RDI.i44, align 8
; Matched:%var_2_58:  %var_2_58 = add i64 %var_2_56, -16
...
; Matched:%var_2_59:  %var_2_59 = add i64 %var_2_55, 91
; %var_2_61 = add i64 %var_2_57, 91
; Matched:%var_2_60:  %var_2_60 = add i64 %var_2_55, 13
...
; Matched:%var_2_63:  %var_2_63 = inttoptr i64 %var_2_62 to i64*
...
; Matched:\<badref\>:  store i64 %var_2_59, i64* %PC, align 8, !tbaa !1261
; store i64 %var_2_61, i64* %var_2_3, align 8
; Matched:%var_2_64:  %var_2_64 = tail call %struct.Memory* @sub_402970__ZneI16reverse_iteratorIPddEEiRKT_S5__renamed_(%struct.State* nonnull %0, i64 %var_2_59, %struct.Memory* %2)
; %call2_40291d = tail call %struct.Memory* @sub_402970._ZneI16reverse_iteratorIPddEEiRKT_S5_(%struct.State* nonnull %0, i64 %var_2_61, %struct.Memory* %2)
%var_2_66 = load i32, i32* %EAX.i, align 4
; Matched:%var_2_66:  %var_2_66 = load i64, i64* %PC, align 8
; %var_2_67 = load i64, i64* %var_2_3, align 8
store i8 0, i8* %var_2_14, align 1
; Matched:%var_2_67:  %var_2_67 = and i32 %var_2_65, 255
; %var_2_68 = and i32 %var_2_66, 255
; Matched:%var_2_68:  %var_2_68 = tail call i32 @llvm.ctpop.i32(i32 %var_2_67) #12
; %var_2_69 = tail call i32 @llvm.ctpop.i32(i32 %var_2_68)
; Matched:%var_2_69:  %var_2_69 = trunc i32 %var_2_68 to i8
; %var_2_70 = trunc i32 %var_2_69 to i8
; Matched:%var_2_70:  %var_2_70 = and i8 %var_2_69, 1
; %var_2_71 = and i8 %var_2_70, 1
; Matched:%var_2_71:  %var_2_71 = xor i8 %var_2_70, 1
; %var_2_72 = xor i8 %var_2_71, 1
; Matched:\<badref\>:  store i8 %var_2_71, i8* %var_2_20, align 1, !tbaa !1279
; store i8 %var_2_72, i8* %var_2_21, align 1
store i8 0, i8* %var_2_26, align 1
%var_2_73 = icmp eq i32 %var_2_66, 0
; Matched:%var_2_73:  %var_2_73 = zext i1 %var_2_72 to i8
; %var_2_74 = zext i1 %var_2_73 to i8
; Matched:\<badref\>:  store i8 %var_2_73, i8* %var_2_28, align 1, !tbaa !1281
; store i8 %var_2_74, i8* %var_2_29, align 1
; Matched:%var_2_74:  %var_2_74 = lshr i32 %var_2_65, 31
; %var_2_75 = lshr i32 %var_2_66, 31
; Matched:%var_2_75:  %var_2_75 = trunc i32 %var_2_74 to i8
; %var_2_76 = trunc i32 %var_2_75 to i8
; Matched:\<badref\>:  store i8 %var_2_75, i8* %var_2_31, align 1, !tbaa !1282
; store i8 %var_2_76, i8* %var_2_32, align 1
store i8 0, i8* %var_2_38, align 1
; Matched:  %.v = select i1 %var_2_72, i64 65, i64 9
; %.v = select i1 %var_2_73, i64 65, i64 9
; Matched:%var_2_76:  %var_2_76 = add i64 %var_2_66, %.v
; %var_2_77 = add i64 %var_2_67, %.v
; Matched:\<badref\>:  store i64 %var_2_76, i64* %PC, align 8, !tbaa !1261
...
br i1 %var_2_73, label %block_.L_402963, label %block_40292b

block_40292b:                                     ; preds = %block_.L_402915
; Matched:%var_2_115:  %var_2_115 = add i64 %var_2_77, -8
...
store i8 0, i8* %var_2_38, align 1
store i8 0, i8* %var_2_26, align 1
; Matched:%var_2_116:  %var_2_116 = add i64 %var_2_76, 133
; %var_2_80 = add i64 %var_2_77, 133
; Matched:%var_2_117:  %var_2_117 = add i64 %var_2_76, 11
...
; Matched:%var_2_121:  %var_2_121 = tail call %struct.Memory* @sub_4029b0__ZN16reverse_iteratorIPddEppEi_renamed_(%struct.State* nonnull %0, i64 %var_2_116, %struct.Memory* %2)
; %call2_402931 = tail call %struct.Memory* @sub_4029b0._ZN16reverse_iteratorIPddEppEi(%struct.State* nonnull %0, i64 %var_2_80, %struct.Memory* %2)
...
; Matched:%var_2_129:  %var_2_129 = add i64 %var_2_128, -1086
; %var_2_92 = add i64 %var_2_91, -1086
...
; Matched:%var_2_134:  %var_2_134 = tail call %struct.Memory* @sub_402500__ZNK16reverse_iteratorIPddEdeEv_renamed_(%struct.State* nonnull %0, i64 %var_2_129, %struct.Memory* %2)
; %call2_40293e = tail call %struct.Memory* @sub_402500._ZNK16reverse_iteratorIPddEdeEv(%struct.State* nonnull %0, i64 %var_2_92, %struct.Memory* %2)
...
; Matched:%var_2_139:  %var_2_139 = add i64 %var_2_135, -6051
; %var_2_101 = add i64 %var_2_97, -6051
; Matched:%var_2_140:  %var_2_140 = add i64 %var_2_135, 22
; %var_2_102 = add i64 %var_2_97, 22
; Matched:%var_2_61:  %var_2_61 = load i64, i64* %RSP, align 8, !tbaa !1261
...
%call2_402954 = tail call %struct.Memory* @"sub_4011a0._ZN3$_0clERKdS1_"(%struct.State* nonnull %0, i64 %var_2_101, %struct.Memory* %2)
...
; Matched:%var_2_78:  %var_2_78 = add i64 %var_2_77, -24
; %var_2_114 = add i64 %var_2_78, -24
; Matched:%var_2_79:  %var_2_79 = add i64 %var_2_76, 5
; %var_2_115 = add i64 %var_2_77, 5
; Matched:\<badref\>:  store i64 %var_2_79, i64* %PC, align 8
; store i64 %var_2_115, i64* %var_2_3, align 8
; Matched:%var_2_80:  %var_2_80 = inttoptr i64 %var_2_78 to i64*
; %var_2_116 = inttoptr i64 %var_2_114 to i64*
; Matched:%var_2_81:  %var_2_81 = load i64, i64* %var_2_80, align 8
; %var_2_117 = load i64, i64* %var_2_116, align 8
; Matched:\<badref\>:  store i64 %var_2_81, i64* %var_2_52, align 1, !tbaa !1284
; store i64 %var_2_117, i64* %var_2_53, align 1
; Matched:%var_2_82:  %var_2_82 = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 1, i64 0, i32 0, i32 0, i32 0, i64 1
; %var_2_118 = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 1, i64 0, i32 0, i32 0, i32 0, i64 1
; Matched:%var_2_83:  %var_2_83 = bitcast i64* %var_2_82 to double*
; %var_2_119 = bitcast i64* %var_2_118 to double*
; Matched:\<badref\>:  store double 0.000000e+00, double* %var_2_83, align 1, !tbaa !1284
; store double 0.000000e+00, double* %var_2_119, align 1
; Matched:%var_2_84:  %var_2_84 = load i64, i64* %RSP, align 8
; %var_2_120 = load i64, i64* %var_2_6, align 8
; Matched:%var_2_85:  %var_2_85 = add i64 %var_2_84, 32
...
; Matched:%var_2_86:  %var_2_86 = icmp ugt i64 %var_2_84, -33
; %var_2_122 = icmp ugt i64 %var_2_120, -33
; Matched:%var_2_87:  %var_2_87 = zext i1 %var_2_86 to i8
; %var_2_123 = zext i1 %var_2_122 to i8
; Matched:\<badref\>:  store i8 %var_2_87, i8* %var_2_13, align 1, !tbaa !1265
; store i8 %var_2_123, i8* %var_2_14, align 1
; Matched:%var_2_88:  %var_2_88 = trunc i64 %var_2_85 to i32
; %var_2_124 = trunc i64 %var_2_121 to i32
; Matched:%var_2_89:  %var_2_89 = and i32 %var_2_88, 255
...
; Matched:\<badref\>:  store i8 %var_2_93, i8* %var_2_20, align 1, !tbaa !1279
; store i8 %var_2_129, i8* %var_2_21, align 1
; Matched:%var_2_94:  %var_2_94 = xor i64 %var_2_85, %var_2_84
; %var_2_130 = xor i64 %var_2_121, %var_2_120
; Matched:%var_2_95:  %var_2_95 = lshr i64 %var_2_94, 4
; %var_2_131 = lshr i64 %var_2_130, 4
; Matched:%var_2_96:  %var_2_96 = trunc i64 %var_2_95 to i8
; %var_2_132 = trunc i64 %var_2_131 to i8
; Matched:%var_2_97:  %var_2_97 = and i8 %var_2_96, 1
; %var_2_133 = and i8 %var_2_132, 1
; Matched:\<badref\>:  store i8 %var_2_97, i8* %var_2_25, align 1, !tbaa !1280
; store i8 %var_2_133, i8* %var_2_26, align 1
; Matched:%var_2_98:  %var_2_98 = icmp eq i64 %var_2_85, 0
; %var_2_134 = icmp eq i64 %var_2_121, 0
; Matched:%var_2_99:  %var_2_99 = zext i1 %var_2_98 to i8
; %var_2_135 = zext i1 %var_2_134 to i8
; Matched:\<badref\>:  store i8 %var_2_99, i8* %var_2_28, align 1, !tbaa !1281
; store i8 %var_2_135, i8* %var_2_29, align 1
; Matched:%var_2_100:  %var_2_100 = lshr i64 %var_2_85, 63
; %var_2_136 = lshr i64 %var_2_121, 63
; Matched:%var_2_101:  %var_2_101 = trunc i64 %var_2_100 to i8
; %var_2_137 = trunc i64 %var_2_136 to i8
; Matched:\<badref\>:  store i8 %var_2_101, i8* %var_2_31, align 1, !tbaa !1282
; store i8 %var_2_137, i8* %var_2_32, align 1
; Matched:%var_2_102:  %var_2_102 = lshr i64 %var_2_84, 63
; %var_2_138 = lshr i64 %var_2_120, 63
; Matched:%var_2_103:  %var_2_103 = xor i64 %var_2_100, %var_2_102
; %var_2_139 = xor i64 %var_2_136, %var_2_138
; Matched:%var_2_104:  %var_2_104 = add nuw nsw i64 %var_2_103, %var_2_100
; %var_2_140 = add nuw nsw i64 %var_2_139, %var_2_136
; Matched:%var_2_105:  %var_2_105 = icmp eq i64 %var_2_104, 2
; %var_2_141 = icmp eq i64 %var_2_140, 2
; Matched:%var_2_106:  %var_2_106 = zext i1 %var_2_105 to i8
; %var_2_142 = zext i1 %var_2_141 to i8
; Matched:\<badref\>:  store i8 %var_2_106, i8* %var_2_37, align 1, !tbaa !1283
; store i8 %var_2_142, i8* %var_2_38, align 1
; Matched:%var_2_107:  %var_2_107 = add i64 %var_2_76, 10
; %var_2_143 = add i64 %var_2_77, 10
; Matched:\<badref\>:  store i64 %var_2_107, i64* %PC, align 8
; store i64 %var_2_143, i64* %var_2_3, align 8
; Matched:%var_2_108:  %var_2_108 = add i64 %var_2_84, 40
; %var_2_144 = add i64 %var_2_120, 40
; Matched:%var_2_109:  %var_2_109 = inttoptr i64 %var_2_85 to i64*
; %var_2_145 = inttoptr i64 %var_2_121 to i64*
; Matched:%var_2_110:  %var_2_110 = load i64, i64* %var_2_109, align 8
; %var_2_146 = load i64, i64* %var_2_145, align 8
; Matched:\<badref\>:  store i64 %var_2_110, i64* %RBP, align 8, !tbaa !1261
...
; Matched:%var_2_114:  %var_2_114 = add i64 %var_2_84, 48
; %var_2_150 = add i64 %var_2_120, 48
; Matched:\<badref\>:  store i64 %var_2_114, i64* %RSP, align 8, !tbaa !1261
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_callq_._ZneI16reverse_iteratorIPddEEiRKT_S5_(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_je_.L_402963(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i8* nocapture %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_callq_._ZN16reverse_iteratorIPddEppEi(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_callq_._ZNK16reverse_iteratorIPddEdeEv(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_jmpq_.L_402915(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
