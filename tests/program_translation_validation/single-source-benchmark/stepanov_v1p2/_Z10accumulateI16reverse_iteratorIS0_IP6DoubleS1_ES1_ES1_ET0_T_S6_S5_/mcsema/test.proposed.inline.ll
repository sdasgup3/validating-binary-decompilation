...
define %struct.Memory* @_Z10accumulateI16reverse_iteratorIS0_IP6DoubleS1_ES1_ES1_ET0_T_S6_S5_(%struct.State* noalias, i64, %struct.Memory* noalias) #2 {
entry:
  ...
  store i64 %78, i64* %81
  store %struct.Memory* %loadMem_4021a8, %struct.Memory** %MEMORY
  ...
  store i64 %93, i64* %96
  store %struct.Memory* %loadMem_4021ac, %struct.Memory** %MEMORY
...
block_.L_4021b5:                                  ; preds = %block_4021cb, %entry
  ...
  store %struct.Memory* %loadMem_4021b5, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem1_4021bd, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_4021c5, %struct.Memory** %MEMORY
...
block_4021cb:                                     ; preds = %block_.L_4021b5
  ...
  store %struct.Memory* %loadMem_4021cb, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem1_4021d1, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_4021d6, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_4021da, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem1_4021de, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_4021ed, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem1_4021f4, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_4021f9, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_4021fe, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_402206, %struct.Memory** %MEMORY
  br label %block_.L_4021b5
...
block_.L_40220b:                                  ; preds = %block_.L_4021b5
  ...
  store %struct.Memory* %loadMem_40220b, %struct.Memory** %MEMORY
  ...
  ret %struct.Memory* %loadMem_40221d
}
