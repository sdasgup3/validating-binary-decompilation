...
declare %struct.Memory* @sub_402420._ZneI16reverse_iteratorIS0_IPddEdEEiRKT_S6_(%struct.State* dereferenceable(3376), i64, %struct.Memory*)

declare %struct.Memory* @sub_402460._ZN16reverse_iteratorIS_IPddEdEppEi(%struct.State* dereferenceable(3376), i64, %struct.Memory*)

declare %struct.Memory* @sub_402490._ZNK16reverse_iteratorIS_IPddEdEdeEv(%struct.State* dereferenceable(3376), i64, %struct.Memory*)

declare %struct.Memory* @"sub_401190._ZN3$_0clERKdS1_"(%struct.State* dereferenceable(3376), i64, %struct.Memory*)

; Function Attrs: alwaysinline
define %struct.Memory* @_Z10accumulateI16reverse_iteratorIS0_IPddEdEdET0_T_S5_S4_(%struct.State* noalias, i64, %struct.Memory* noalias) #1 {
entry:
