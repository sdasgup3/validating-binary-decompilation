...
block_.L_402c45:                                  ; preds = %block_402c53, %entry
  %56 = phi i64 [ %.pre, %entry ], [ %132, %block_402c53 ]
  %MEMORY.0 = phi %struct.Memory* [ %2, %entry ], [ %call2_402c73, %block_402c53 ]
...
block_402c53:                                     ; preds = %block_.L_402c45
  ...
  %call2_402c73 = tail call %struct.Memory* @"sub_401190._ZN3$_0clERKdS1_"(%struct.State* nonnull %0, i64 %120, %struct.Memory* %MEMORY.0)
