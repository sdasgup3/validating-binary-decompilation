...
declare %struct.Memory* @sub_400520.clock_plt(%struct.State* dereferenceable(3376), i64, %struct.Memory*)

; Function Attrs: alwaysinline
define %struct.Memory* @_Z11start_timerv(%struct.State* noalias, i64, %struct.Memory* noalias) #1 {
entry:
