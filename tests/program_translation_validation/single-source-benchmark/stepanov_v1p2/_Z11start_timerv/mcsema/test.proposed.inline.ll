...
@G_0x605140 = global %G_0x605140_type zeroinitializer
...
entry:
  ...
  %loadMem1_401324 = load %struct.Memory*, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem1_401324, %struct.Memory** %MEMORY
  %loadMem2_401324 = load %struct.Memory*, %struct.Memory** %MEMORY
  %loadPC_401324 = load i64, i64* %3
  %43 = call %struct.Memory* @__remill_function_call(%struct.State* %0, i64 ptrtoint (i64 ()* @clock to i64), %struct.Memory* %loadMem2_401324)
  ...
  store i64 %50, i64* bitcast (%G_0x605140_type* @G_0x605140 to i64*)
  ...
  ret %struct.Memory* %loadMem_401332
}
...
block_400478:
  ...
  %11 = add i64 %10, 8
  store i64 %11, i64* %PC
  store i64 %9, i64* bitcast (%G_0x605140_type* @G_0x605140 to i64*)
  ret %struct.Memory* %2
}
