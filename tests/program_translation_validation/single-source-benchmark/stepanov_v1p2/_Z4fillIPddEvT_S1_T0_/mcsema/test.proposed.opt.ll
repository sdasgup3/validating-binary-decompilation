...
define %struct.Memory* @_Z4fillIPddEvT_S1_T0_(%struct.State* noalias, i64, %struct.Memory* noalias) local_unnamed_addr #1 {
entry:
  ...
  %26 = getelementptr inbounds %union.VectorReg, %union.VectorReg* %21, i64 0, i32 0, i32 0, i32 0, i64 0
...
block_.L_4013e1:                                  ; preds = %block_4013ef, %entry
  %37 = phi i64 [ %109, %block_4013ef ], [ %.pre, %entry ]
  ...
  %.v = select i1 %61, i64 43, i64 14
  %72 = add i64 %37, %.v
  store i64 %72, i64* %3, align 8
  br i1 %61, label %block_.L_40140c, label %block_4013ef

block_4013ef:                                     ; preds = %block_.L_4013e1
  %73 = add i64 %38, -24
  %74 = add i64 %72, 5
  store i64 %74, i64* %PC.i, align 8
  %75 = inttoptr i64 %73 to i64*
  %76 = load i64, i64* %75, align 8
  %77 = getelementptr inbounds %union.VectorReg, %union.VectorReg* %21, i64 0, i32 0, i32 0, i32 0, i64 0
  ...
  store i64 %79, i64* %RAX.i23, align 8
  %80 = add i64 %79, 8
  store i64 %80, i64* %RCX.i12, align 8
  %81 = icmp ugt i64 %79, -9
  %82 = zext i1 %81 to i8
  ...
  %103 = bitcast i64* %RAX.i23 to i64**
  %104 = load i64*, i64** %103, align 8
  %105 = load i64, i64* %PC.i, align 8
  %106 = add i64 %105, 4
  store i64 %106, i64* %PC.i, align 8
  %107 = getelementptr inbounds %union.VectorReg, %union.VectorReg* %21, i64 0, i32 0, i32 0, i32 0, i64 0
...
block_.L_40140c:                                  ; preds = %block_.L_4013e1
  %110 = add i64 %72, 1
...
define %struct.Memory* @routine_je_.L_40140c(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i8* %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
...
define %struct.Memory* @routine_jmpq_.L_4013e1(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
