...
declare %struct.Memory* @sub_4029f0._Z10accumulateI14Double_pointer6DoubleET0_T_S3_S2_(%struct.State* dereferenceable(3376), i64, %struct.Memory*) local_unnamed_addr
...
block_.L_401631:                                  ; preds = %block_401641, %entry
  %69 = phi i64 [ %.pre, %entry ], [ %197, %block_401641 ]
  %MEMORY.0 = phi %struct.Memory* [ %call2_401625, %entry ], [ %call2_401679, %block_401641 ]
...
block_401641:                                     ; preds = %block_.L_401631
  ...
  %call2_401666 = tail call %struct.Memory* @sub_4029f0._Z10accumulateI14Double_pointer6DoubleET0_T_S3_S2_(%struct.State* nonnull %0, i64 %143, %struct.Memory* %MEMORY.0)
  ...
  %call2_401674 = tail call %struct.Memory* @sub_401c40._ZN6DoublecvdEv(%struct.State* nonnull %0, i64 %155, %struct.Memory* %call2_401666)
  ...
  %call2_401679 = tail call %struct.Memory* @sub_401350._Z5checkd(%struct.State* nonnull %0, i64 %161, %struct.Memory* %call2_401674)
...
block_.L_40168c:                                  ; preds = %block_.L_401631
  ...
  %call2_40168c = tail call %struct.Memory* @sub_4013a0._Z5timerv(%struct.State* nonnull %0, i64 %198, %struct.Memory* %MEMORY.0)
