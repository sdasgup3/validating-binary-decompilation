; ModuleID = '/tmp/tmpsjd2gilm-query.ll'
...
define %struct.Memory* @_Z4testI14Double_pointer6DoubleEvT_S2_T0_(%struct.State* noalias nocapture readonly, i64, %struct.Memory* noalias readnone returned) local_unnamed_addr #1 {
entry:
  ...
  br i1 %var_2_102, label %block_.L_401641.preheader, label %block_.L_40169c.split

block_.L_401641.preheader:                        ; preds = %entry
  br label %block_.L_401641

block_.L_401641:                                  ; preds = %block_.L_401641.preheader, %block_.L_401641
  br label %block_.L_401641

block_.L_40169c.split:                            ; preds = %entry
