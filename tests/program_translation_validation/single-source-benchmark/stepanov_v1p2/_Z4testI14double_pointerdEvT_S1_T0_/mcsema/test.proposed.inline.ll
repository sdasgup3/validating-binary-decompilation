...
declare %struct.Memory* @sub_402ae0._Z10accumulateI14double_pointerdET0_T_S2_S1_(%struct.State* dereferenceable(3376), i64, %struct.Memory*)
...
define %struct.Memory* @_Z4testI14double_pointerdEvT_S1_T0_(%struct.State* noalias, i64, %struct.Memory* noalias) #1 {
entry:
