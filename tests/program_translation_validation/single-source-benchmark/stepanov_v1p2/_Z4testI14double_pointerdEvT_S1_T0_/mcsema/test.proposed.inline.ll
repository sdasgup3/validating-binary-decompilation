...
declare %struct.Memory* @sub_402ad0._Z10accumulateI14double_pointerdET0_T_S2_S1_(%struct.State* noalias dereferenceable(3376), i64, %struct.Memory* noalias readnone returned)
...
entry:
  ...
  %loadMem1_401585 = load %struct.Memory*, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem1_401585, %struct.Memory** %MEMORY
  %loadMem2_401585 = load %struct.Memory*, %struct.Memory** %MEMORY
  %loadPC_401585 = load i64, i64* %3
  %call2_401585 = call %struct.Memory* @sub_401320._Z11start_timerv(%struct.State* %0, i64 %loadPC_401585, %struct.Memory* %loadMem2_401585)
  store %struct.Memory* %call2_401585, %struct.Memory** %MEMORY
  ...
  store i32 0, i32* %137
  store %struct.Memory* %loadMem_40158a, %struct.Memory** %MEMORY
  br label %block_.L_401591

block_.L_401591:                                  ; preds = %block_4015a1, %entry
  ...
  %loadBr_40159b = load i8, i8* %BRANCH_TAKEN
  %cmpBr_40159b = icmp eq i8 %loadBr_40159b, 1
  br i1 %cmpBr_40159b, label %block_.L_4015d6, label %block_4015a1

block_4015a1:                                     ; preds = %block_.L_401591
  ...
  store %struct.Memory* %loadMem1_4015be, %struct.Memory** %MEMORY
  %loadMem2_4015be = load %struct.Memory*, %struct.Memory** %MEMORY
  %loadPC_4015be = load i64, i64* %3
  %call2_4015be = call %struct.Memory* @sub_402ad0._Z10accumulateI14double_pointerdET0_T_S2_S1_(%struct.State* %0, i64 %loadPC_4015be, %struct.Memory* %loadMem2_4015be)
  store %struct.Memory* %call2_4015be, %struct.Memory** %MEMORY
  %loadMem1_4015c3 = load %struct.Memory*, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem1_4015c3, %struct.Memory** %MEMORY
  %loadMem2_4015c3 = load %struct.Memory*, %struct.Memory** %MEMORY
  %loadPC_4015c3 = load i64, i64* %3
  %call2_4015c3 = call %struct.Memory* @sub_401340._Z5checkd(%struct.State* %0, i64 %loadPC_4015c3, %struct.Memory* %loadMem2_4015c3)
  store %struct.Memory* %call2_4015c3, %struct.Memory** %MEMORY
...
block_.L_4015d6:                                  ; preds = %block_.L_401591
  ...
  %call2_4015d6 = call %struct.Memory* @sub_401390._Z5timerv(%struct.State* %0, i64 %loadPC_4015d6, %struct.Memory* %loadMem2_4015d6)
  ...
  store %struct.Memory* %loadMem_4015e4, %struct.Memory** %MEMORY
  ...
  ret %struct.Memory* %loadMem_4015ff
}
...
define %struct.Memory* @routine_jge_.L_4015d6(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i8* %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) {
block_400478:
  %3 = getelementptr inbounds %struct.State, %struct.State* %0, i32 0, i32 6
  %4 = getelementptr inbounds %struct.GPR, %struct.GPR* %3, i32 0, i32 33
  %5 = getelementptr inbounds %struct.Reg, %struct.Reg* %4, i32 0, i32 0
