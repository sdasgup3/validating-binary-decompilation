...
block_.L_401591:                                  ; preds = %block_4015a1, %entry
  %71 = phi i64 [ %.pre, %entry ], [ %178, %block_4015a1 ]
...
block_4015a1:                                     ; preds = %block_.L_401591
  ...
  %call2_4015be = tail call %struct.Memory* @sub_402ad0._Z10accumulateI14double_pointerdET0_T_S2_S1_(%struct.State* %0, i64 %136, %struct.Memory* %MEMORY.0)
  ...
  %call2_4015c3 = tail call %struct.Memory* @sub_401340._Z5checkd(%struct.State* %0, i64 %142, %struct.Memory* %call2_4015be)
...
block_.L_4015d6:                                  ; preds = %block_.L_401591
  ...
  %call2_4015d6 = tail call %struct.Memory* @sub_401390._Z5timerv(%struct.State* %0, i64 %179, %struct.Memory* %MEMORY.0)
