...
declare %struct.Memory* @sub_402ae0._Z10accumulateI14double_pointerdET0_T_S2_S1_(%struct.State* noalias dereferenceable(3376), i64, %struct.Memory* noalias readnone returned) local_unnamed_addr
...
block_.L_4015a1:                                  ; preds = %block_4015b1, %entry
  %70 = phi i64 [ %177, %block_4015b1 ], [ %.pre, %entry ]
...
block_4015b1:                                     ; preds = %block_.L_4015a1
  ...
  %call2_4015ce = tail call %struct.Memory* @sub_402ae0._Z10accumulateI14double_pointerdET0_T_S2_S1_(%struct.State* nonnull %0, i64 %135, %struct.Memory* %call2_401595)
  ...
  %call2_4015d3 = tail call %struct.Memory* @sub_401350._Z5checkd(%struct.State* nonnull %0, i64 %141, %struct.Memory* %call2_401595)
...
block_.L_4015e6:                                  ; preds = %block_.L_4015a1
  ...
  %call2_4015e6 = tail call %struct.Memory* @sub_4013a0._Z5timerv(%struct.State* nonnull %0, i64 %178, %struct.Memory* %call2_401595)
