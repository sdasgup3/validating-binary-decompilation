...
define %struct.Memory* @_Z4testI16reverse_iteratorI14Double_pointer6DoubleES2_EvT_S4_T0_(%struct.State* noalias, i64, %struct.Memory* noalias) #1 {
entry:
  ...
  store %struct.Memory* %loadMem1_4018a5, %struct.Memory** %MEMORY
...
block_4018c1:                                     ; preds = %block_.L_4018b1
  ...
  store %struct.Memory* %loadMem1_4018e6, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem1_4018f4, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem1_4018f9, %struct.Memory** %MEMORY
...
block_.L_40190c:                                  ; preds = %block_.L_4018b1
  ...
  store %struct.Memory* %loadMem1_40190c, %struct.Memory** %MEMORY
  ...
  ret %struct.Memory* %loadMem_401935
}
