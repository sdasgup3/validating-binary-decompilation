...
declare %struct.Memory* @sub_4025b0._Z10accumulateI16reverse_iteratorI14Double_pointer6DoubleES2_ET0_T_S5_S4_(%struct.State* noalias dereferenceable(3376), i64, %struct.Memory* noalias readnone returned) local_unnamed_addr

declare %struct.Memory* @sub_401c40._ZN6DoublecvdEv(%struct.State* noalias dereferenceable(3376), i64, %struct.Memory* noalias readnone returned) local_unnamed_addr
...
entry:
  ...
  %call2_4018a5 = tail call %struct.Memory* @sub_401330._Z11start_timerv(%struct.State* %0, i64 %57, %struct.Memory* %2)
  ...
  br label %block_.L_4018b1

block_.L_4018b1:                                  ; preds = %block_4018c1, %entry
  %69 = phi i64 [ %197, %block_4018c1 ], [ %.pre, %entry ]
  ...
  %76 = load i32, i32* inttoptr (i64 6312016 to i32*), align 16
  %77 = sub i32 %74, %76
  ...
  br i1 %102, label %block_4018c1, label %block_.L_40190c

block_4018c1:                                     ; preds = %block_.L_4018b1
  %104 = add i64 %70, -8
  %105 = add i64 %103, 4
  ...
  %call2_4018e6 = tail call %struct.Memory* @sub_4025b0._Z10accumulateI16reverse_iteratorI14Double_pointer6DoubleES2_ET0_T_S5_S4_(%struct.State* nonnull %0, i64 %143, %struct.Memory* %call2_4018a5)
  ...
  %call2_4018f4 = tail call %struct.Memory* @sub_401c40._ZN6DoublecvdEv(%struct.State* nonnull %0, i64 %155, %struct.Memory* %call2_4018a5)
  ...
  %call2_4018f9 = tail call %struct.Memory* @sub_401350._Z5checkd(%struct.State* nonnull %0, i64 %161, %struct.Memory* %call2_4018a5)
...
block_.L_40190c:                                  ; preds = %block_.L_4018b1
  ...
  %call2_40190c = tail call %struct.Memory* @sub_4013a0._Z5timerv(%struct.State* nonnull %0, i64 %198, %struct.Memory* %call2_4018a5)
  %203 = load i64, i64* %3, align 8
  %204 = load i32, i32* inttoptr (i64 6312080 to i32*), align 16
  ...
  store i32 %206, i32* inttoptr (i64 6312080 to i32*), align 16
  ...
  ret %struct.Memory* %call2_40190c
}
...
block_400488:
  ...
  %6 = add i64 %5, 7
  store i64 %6, i64* %PC, align 8
  %7 = load i32, i32* inttoptr (i64 6312016 to i32*), align 16
  %8 = sub i32 %4, %7
  %9 = icmp ult i32 %4, %7
  %10 = zext i1 %9 to i8
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_jge_.L_40190c(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i8* nocapture %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_jmpq_.L_4018b1(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
...
block_400488:
  ...
  %4 = add i64 %3, 7
  store i64 %4, i64* %PC, align 8
  %5 = load i32, i32* inttoptr (i64 6312080 to i32*), align 16
  %6 = zext i32 %5 to i64
...
block_400488:
  ...
  %6 = add i64 %5, 7
  store i64 %6, i64* %PC, align 8
  store i32 %4, i32* inttoptr (i64 6312080 to i32*), align 16
  ret %struct.Memory* %2
}
