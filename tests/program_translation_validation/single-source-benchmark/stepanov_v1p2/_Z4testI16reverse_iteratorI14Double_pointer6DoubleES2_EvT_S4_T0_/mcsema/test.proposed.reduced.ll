; ModuleID = '/tmp/tmpke8_eq8z-query.ll'
...
define %struct.Memory* @_Z4testI16reverse_iteratorI14Double_pointer6DoubleES2_EvT_S4_T0_(%struct.State* noalias nocapture readonly, i64, %struct.Memory* noalias readnone returned) local_unnamed_addr #1 {
entry:
  ...
  br i1 %var_2_102, label %block_.L_4018c1.preheader, label %block_.L_40191c.split

block_.L_4018c1.preheader:                        ; preds = %entry
  br label %block_.L_4018c1

block_.L_4018c1:                                  ; preds = %block_.L_4018c1.preheader, %block_.L_4018c1
  br label %block_.L_4018c1

block_.L_40191c.split:                            ; preds = %entry
