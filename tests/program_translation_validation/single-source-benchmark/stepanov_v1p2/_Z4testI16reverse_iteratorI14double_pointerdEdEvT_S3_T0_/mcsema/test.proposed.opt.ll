...
declare %struct.Memory* @sub_4026d0._Z10accumulateI16reverse_iteratorI14double_pointerdEdET0_T_S4_S3_(%struct.State* dereferenceable(3376), i64, %struct.Memory*) local_unnamed_addr
...
entry:
  ...
  %call2_401815 = tail call %struct.Memory* @sub_401330._Z11start_timerv(%struct.State* %0, i64 %58, %struct.Memory* %2)
  ...
  br label %block_.L_401821

block_.L_401821:                                  ; preds = %block_401831, %entry
  %70 = phi i64 [ %.pre, %entry ], [ %177, %block_401831 ]
  %MEMORY.0 = phi %struct.Memory* [ %call2_401815, %entry ], [ %call2_401853, %block_401831 ]
  ...
  %77 = load i32, i32* inttoptr (i64 6312016 to i32*), align 16
  %78 = sub i32 %75, %77
  ...
  br i1 %103, label %block_401831, label %block_.L_401866

block_401831:                                     ; preds = %block_.L_401821
  %105 = add i64 %71, -8
  %106 = add i64 %104, 4
  ...
  %call2_40184e = tail call %struct.Memory* @sub_4026d0._Z10accumulateI16reverse_iteratorI14double_pointerdEdET0_T_S4_S3_(%struct.State* nonnull %0, i64 %135, %struct.Memory* %MEMORY.0)
  ...
  %call2_401853 = tail call %struct.Memory* @sub_401350._Z5checkd(%struct.State* nonnull %0, i64 %141, %struct.Memory* %call2_40184e)
...
block_.L_401866:                                  ; preds = %block_.L_401821
  ...
  %call2_401866 = tail call %struct.Memory* @sub_4013a0._Z5timerv(%struct.State* nonnull %0, i64 %178, %struct.Memory* %MEMORY.0)
  ...
  store i32 %186, i32* inttoptr (i64 6312080 to i32*), align 16
  ...
  ret %struct.Memory* %call2_401866
}
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_jge_.L_401866(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i8* nocapture %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_jmpq_.L_401821(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
