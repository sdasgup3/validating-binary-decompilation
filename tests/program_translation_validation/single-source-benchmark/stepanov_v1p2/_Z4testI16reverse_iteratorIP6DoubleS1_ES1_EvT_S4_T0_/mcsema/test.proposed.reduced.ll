; ModuleID = '/tmp/tmpeomz2f4r-query.ll'
...
define %struct.Memory* @_Z4testI16reverse_iteratorIP6DoubleS1_ES1_EvT_S4_T0_(%struct.State* noalias nocapture readonly, i64, %struct.Memory* noalias readnone returned) local_unnamed_addr #1 {
entry:
  %RBP.i = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 15, i32 0, i32 0
  %var_2_70 = load i64, i64* %RBP.i, align 8
  %var_2_71 = add i64 %var_2_70, -28
  %var_2_73 = inttoptr i64 %var_2_71 to i32*
  %var_2_74 = load i32, i32* %var_2_73, align 4
  %var_2_76 = load i32, i32* bitcast (%G_0x605050_type* @G_0x605050 to i32*), align 8
  %var_2_77 = sub i32 %var_2_74, %var_2_76
  %var_2_92 = lshr i32 %var_2_77, 31
  %var_2_94 = lshr i32 %var_2_74, 31
  %var_2_95 = lshr i32 %var_2_76, 31
  %var_2_96 = xor i32 %var_2_95, %var_2_94
  %var_2_97 = xor i32 %var_2_92, %var_2_94
  %var_2_98 = add nuw nsw i32 %var_2_97, %var_2_96
  %var_2_99 = icmp eq i32 %var_2_98, 2
  %var_2_101 = icmp ne i32 %var_2_92, 0
  %var_2_102 = xor i1 %var_2_101, %var_2_99
  br i1 %var_2_102, label %block_.L_401781.preheader, label %block_.L_4017dc.split

block_.L_401781.preheader:                        ; preds = %entry
  br label %block_.L_401781

block_.L_401781:                                  ; preds = %block_.L_401781.preheader, %block_.L_401781
  br label %block_.L_401781

block_.L_4017dc.split:                            ; preds = %entry
...
; Function Attrs: alwaysinline norecurse nounwind
define %struct.Memory* @routine_jge_.L_4017dc(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i8* nocapture %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
...
; Function Attrs: alwaysinline norecurse nounwind
define %struct.Memory* @routine_callq_._Z10accumulateI16reverse_iteratorIP6DoubleS1_ES1_ET0_T_S5_S4_(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
...
; Function Attrs: alwaysinline norecurse nounwind
define %struct.Memory* @routine_callq_._ZN6DoublecvdEv(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
...
; Function Attrs: alwaysinline norecurse nounwind
define %struct.Memory* @routine_jmpq_.L_401781(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
...
block_400488:
  ...
  %4 = shl i64 %3, 3
  %5 = add i64 %4, ptrtoint (%G_0x6050a0___rdx_8__type* @G_0x6050a0___rdx_8_ to i64)
  %6 = load i64, i64* %PC, align 8
  %7 = add i64 %6, 9
  store i64 %7, i64* %PC, align 8
