...
declare %struct.Memory* @sub_4028f0._Z10accumulateI16reverse_iteratorIPddEdET0_T_S4_S3_(%struct.State* dereferenceable(3376), i64, %struct.Memory*)
...
define %struct.Memory* @_Z4testI16reverse_iteratorIPddEdEvT_S3_T0_(%struct.State* noalias, i64, %struct.Memory* noalias) #1 {
entry:
