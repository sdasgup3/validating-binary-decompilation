...
declare %struct.Memory* @sub_402900._Z10accumulateI16reverse_iteratorIPddEdET0_T_S4_S3_(%struct.State* noalias dereferenceable(3376), i64, %struct.Memory* noalias readnone returned) local_unnamed_addr
...
entry:
  ...
  %call2_4016e5 = tail call %struct.Memory* @sub_401340._Z11start_timerv(%struct.State* %0, i64 %58, %struct.Memory* %2)
...
block_.L_4016f1:                                  ; preds = %block_401701, %entry
  %70 = phi i64 [ %177, %block_401701 ], [ %.pre, %entry ]
  ...
  br i1 %103, label %block_401701, label %block_.L_401736
...
block_401701:                                     ; preds = %block_.L_4016f1
  ...
  %call2_40171e = tail call %struct.Memory* @sub_402900._Z10accumulateI16reverse_iteratorIPddEdET0_T_S4_S3_(%struct.State* nonnull %0, i64 %135, %struct.Memory* %call2_4016e5)
  ...
  %call2_401723 = tail call %struct.Memory* @sub_401360._Z5checkd(%struct.State* nonnull %0, i64 %141, %struct.Memory* %call2_4016e5)
...
block_.L_401736:                                  ; preds = %block_.L_4016f1
  ...
  %call2_401736 = tail call %struct.Memory* @sub_4013b0._Z5timerv(%struct.State* nonnull %0, i64 %178, %struct.Memory* %call2_4016e5)
