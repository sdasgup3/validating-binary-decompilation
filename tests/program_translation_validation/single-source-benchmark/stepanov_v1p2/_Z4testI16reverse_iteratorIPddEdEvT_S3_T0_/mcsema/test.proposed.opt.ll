...
block_.L_4016d1:                                  ; preds = %block_4016e1, %entry
  %71 = phi i64 [ %.pre, %entry ], [ %178, %block_4016e1 ]
...
block_4016e1:                                     ; preds = %block_.L_4016d1
  ...
  %call2_4016fe = tail call %struct.Memory* @sub_4028e0._Z10accumulateI16reverse_iteratorIPddEdET0_T_S4_S3_(%struct.State* %0, i64 %136, %struct.Memory* %MEMORY.0)
  ...
  %call2_401703 = tail call %struct.Memory* @sub_401340._Z5checkd(%struct.State* %0, i64 %142, %struct.Memory* %call2_4016fe)
...
block_.L_401716:                                  ; preds = %block_.L_4016d1
  ...
  %call2_401716 = tail call %struct.Memory* @sub_401390._Z5timerv(%struct.State* %0, i64 %179, %struct.Memory* %MEMORY.0)
