...
declare %struct.Memory* @sub_4028e0._Z10accumulateI16reverse_iteratorIPddEdET0_T_S4_S3_(%struct.State* noalias dereferenceable(3376), i64, %struct.Memory* noalias readnone returned) local_unnamed_addr
...
define %struct.Memory* @_Z4testI16reverse_iteratorIPddEdEvT_S3_T0_(%struct.State* noalias, i64, %struct.Memory* noalias) local_unnamed_addr #1 {
entry:
  ...
  %call2_4016c5 = tail call %struct.Memory* @sub_401320._Z11start_timerv(%struct.State* %0, i64 %59, %struct.Memory* %2)
...
block_.L_4016d1:                                  ; preds = %block_4016e1, %entry
  %71 = phi i64 [ %.pre, %entry ], [ %180, %block_4016e1 ]
  %MEMORY.0 = phi %struct.Memory* [ %call2_4016c5, %entry ], [ %call2_401703, %block_4016e1 ]
  ...
  br i1 %104, label %block_4016e1, label %block_.L_401716
...
block_4016e1:                                     ; preds = %block_.L_4016d1
  ...
  %call2_4016fe = tail call %struct.Memory* @sub_4028e0._Z10accumulateI16reverse_iteratorIPddEdET0_T_S4_S3_(%struct.State* %0, i64 %137, %struct.Memory* %MEMORY.0)
  ...
  %call2_401703 = tail call %struct.Memory* @sub_401340._Z5checkd(%struct.State* %0, i64 %143, %struct.Memory* %call2_4016fe)
...
block_.L_401716:                                  ; preds = %block_.L_4016d1
  ...
  %call2_401716 = tail call %struct.Memory* @sub_401390._Z5timerv(%struct.State* %0, i64 %181, %struct.Memory* %MEMORY.0)
  ...
  ret %struct.Memory* %call2_401716
}
...
define %struct.Memory* @routine_jge_.L_401716(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i8* %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
...
define %struct.Memory* @routine_callq_._Z10accumulateI16reverse_iteratorIPddEdET0_T_S4_S3_(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
...
define %struct.Memory* @routine_jmpq_.L_4016d1(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
