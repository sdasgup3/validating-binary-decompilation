; ModuleID = '/tmp/tmpjzi79896-query.ll'
...
define %struct.Memory* @_Z4testI16reverse_iteratorIS0_I14Double_pointer6DoubleES2_ES2_EvT_S5_T0_(%struct.State* noalias nocapture readonly, i64, %struct.Memory* noalias readnone returned) local_unnamed_addr #1 {
entry:
  ...
  br i1 %var_2_102, label %block_.L_401b41.preheader, label %block_.L_401b9c.split

block_.L_401b41.preheader:                        ; preds = %entry
  br label %block_.L_401b41

block_.L_401b41:                                  ; preds = %block_.L_401b41.preheader, %block_.L_401b41
  br label %block_.L_401b41

block_.L_401b9c.split:                            ; preds = %entry
