...
declare %struct.Memory* @sub_401ef0._Z10accumulateI16reverse_iteratorIS0_I14double_pointerdEdEdET0_T_S5_S4_(%struct.State* dereferenceable(3376), i64, %struct.Memory*) local_unnamed_addr
...
entry:
  ...
  %call2_401a95 = tail call %struct.Memory* @sub_401330._Z11start_timerv(%struct.State* %0, i64 %58, %struct.Memory* %2)
...
block_.L_401aa1:                                  ; preds = %block_401ab1, %entry
  %70 = phi i64 [ %.pre, %entry ], [ %177, %block_401ab1 ]
  %MEMORY.0 = phi %struct.Memory* [ %call2_401a95, %entry ], [ %call2_401ad3, %block_401ab1 ]
  ...
  br i1 %103, label %block_401ab1, label %block_.L_401ae6
...
block_401ab1:                                     ; preds = %block_.L_401aa1
  ...
  %call2_401ace = tail call %struct.Memory* @sub_401ef0._Z10accumulateI16reverse_iteratorIS0_I14double_pointerdEdEdET0_T_S5_S4_(%struct.State* nonnull %0, i64 %135, %struct.Memory* %MEMORY.0)
  ...
  %call2_401ad3 = tail call %struct.Memory* @sub_401350._Z5checkd(%struct.State* nonnull %0, i64 %141, %struct.Memory* %call2_401ace)
...
block_.L_401ae6:                                  ; preds = %block_.L_401aa1
  ...
  %call2_401ae6 = tail call %struct.Memory* @sub_4013a0._Z5timerv(%struct.State* nonnull %0, i64 %178, %struct.Memory* %MEMORY.0)
  ...
  ret %struct.Memory* %call2_401ae6
}
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_jge_.L_401ae6(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i8* nocapture %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_jmpq_.L_401aa1(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
