...
define %struct.Memory* @_Z4testI16reverse_iteratorIS0_IPddEdEdEvT_S4_T0_(%struct.State* noalias, i64, %struct.Memory* noalias) #2 {
entry:
...
block_401971:                                     ; preds = %block_.L_401961
  ...
  store %struct.Memory* %loadMem1_40198e, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem1_401993, %struct.Memory** %MEMORY
...
block_.L_4019a6:                                  ; preds = %block_.L_401961
  ...
  store %struct.Memory* %loadMem1_4019a6, %struct.Memory** %MEMORY
  ...
  ret %struct.Memory* %loadMem_4019cf
}
