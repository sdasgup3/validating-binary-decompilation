...
entry:
  ...
  %call2_401955 = tail call %struct.Memory* @sub_401330._Z11start_timerv(%struct.State* %0, i64 %58, %struct.Memory* %2)
...
block_.L_401961:                                  ; preds = %block_401971, %entry
  ...
  br i1 %103, label %block_401971, label %block_.L_4019a6

block_401971:                                     ; preds = %block_.L_401961
  %105 = add i64 %71, -8
  %106 = add i64 %104, 4
...
block_.L_4019a6:                                  ; preds = %block_.L_401961
  ...
  ret %struct.Memory* %call2_4019a6
}
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_jge_.L_4019a6(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i8* nocapture %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_jmpq_.L_401961(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
