...
declare %struct.Memory* @sub_4023a0._Z10accumulateI16reverse_iteratorIS0_IPddEdEdET0_T_S5_S4_(%struct.State* noalias dereferenceable(3376), i64, %struct.Memory* noalias readnone returned) local_unnamed_addr
...
entry:
  ...
  %call2_401945 = tail call %struct.Memory* @sub_401320._Z11start_timerv(%struct.State* %0, i64 %59, %struct.Memory* %2)
  ...
  br label %block_.L_401951

block_.L_401951:                                  ; preds = %block_401961, %entry
  %71 = phi i64 [ %.pre, %entry ], [ %178, %block_401961 ]
  %MEMORY.0 = phi %struct.Memory* [ %call2_401945, %entry ], [ %call2_401983, %block_401961 ]
  ...
  br i1 %104, label %block_401961, label %block_.L_401996

block_401961:                                     ; preds = %block_.L_401951
  %106 = add i64 %72, -8
  %107 = add i64 %105, 4
  ...
  %call2_40197e = tail call %struct.Memory* @sub_4023a0._Z10accumulateI16reverse_iteratorIS0_IPddEdEdET0_T_S5_S4_(%struct.State* %0, i64 %136, %struct.Memory* %MEMORY.0)
  %141 = load i64, i64* %3, align 8
  %142 = add i64 %141, -1603
  %143 = add i64 %141, 5
  ...
  %call2_401983 = tail call %struct.Memory* @sub_401340._Z5checkd(%struct.State* %0, i64 %142, %struct.Memory* %call2_40197e)
...
block_.L_401996:                                  ; preds = %block_.L_401951
  %179 = add i64 %105, -1542
  %180 = add i64 %105, 5
  ...
  %call2_401996 = tail call %struct.Memory* @sub_401390._Z5timerv(%struct.State* %0, i64 %179, %struct.Memory* %MEMORY.0)
  ...
  ret %struct.Memory* %call2_401996
}
...
define %struct.Memory* @routine_jge_.L_401996(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i8* %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
...
define %struct.Memory* @routine_callq_._Z10accumulateI16reverse_iteratorIS0_IPddEdEdET0_T_S5_S4_(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
...
define %struct.Memory* @routine_jmpq_.L_401951(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
