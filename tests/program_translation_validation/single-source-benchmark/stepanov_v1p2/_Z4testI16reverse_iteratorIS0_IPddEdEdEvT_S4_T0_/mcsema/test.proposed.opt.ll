...
declare %struct.Memory* @sub_4023c0._Z10accumulateI16reverse_iteratorIS0_IPddEdEdET0_T_S5_S4_(%struct.State* noalias dereferenceable(3376), i64, %struct.Memory* noalias readnone returned) local_unnamed_addr
...
entry:
  ...
  %call2_401965 = tail call %struct.Memory* @sub_401340._Z11start_timerv(%struct.State* %0, i64 %58, %struct.Memory* %2)
...
block_.L_401971:                                  ; preds = %block_401981, %entry
  %70 = phi i64 [ %177, %block_401981 ], [ %.pre, %entry ]
  ...
  br i1 %103, label %block_401981, label %block_.L_4019b6

block_401981:                                     ; preds = %block_.L_401971
  %105 = add i64 %71, -8
  %106 = add i64 %104, 4
  ...
  %call2_40199e = tail call %struct.Memory* @sub_4023c0._Z10accumulateI16reverse_iteratorIS0_IPddEdEdET0_T_S5_S4_(%struct.State* nonnull %0, i64 %135, %struct.Memory* %call2_401965)
  ...
  %call2_4019a3 = tail call %struct.Memory* @sub_401360._Z5checkd(%struct.State* nonnull %0, i64 %141, %struct.Memory* %call2_401965)
...
block_.L_4019b6:                                  ; preds = %block_.L_401971
  %178 = add i64 %104, -1542
  %179 = add i64 %104, 5
  ...
  %call2_4019b6 = tail call %struct.Memory* @sub_4013b0._Z5timerv(%struct.State* nonnull %0, i64 %178, %struct.Memory* %call2_401965)
