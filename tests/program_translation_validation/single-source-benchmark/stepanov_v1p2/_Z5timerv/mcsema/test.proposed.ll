...
entry:
  ...
  ; Code: ._Z5timerv:	 RIP: 401390	 Bytes: 0
  ...
  ; Code: callq .clock_plt	 RIP: 401394	 Bytes: 5
  %loadMem1_401394 = load %struct.Memory*, %struct.Memory** %MEMORY
  %call1_401394 = call %struct.Memory* @routine_callq_.clock_plt(%struct.State* %0, i64  0, %struct.Memory* %loadMem1_401394, i64 -3732, i64 5, i64 5)
  store %struct.Memory* %call1_401394, %struct.Memory** %MEMORY

  %loadMem2_401394 = load %struct.Memory*, %struct.Memory** %MEMORY
  %loadPC_401394 = load i64, i64* %3
  %call2_401394 = call %struct.Memory* @ext_clock(%struct.State* %0, i64  %loadPC_401394, %struct.Memory* %loadMem2_401394)
  store %struct.Memory* %call2_401394, %struct.Memory** %MEMORY

  ; Code: movsd 0x1987(%rip), %xmm0	 RIP: 401399	 Bytes: 8
  %loadMem_401399 = load %struct.Memory*, %struct.Memory** %MEMORY
  %call_401399 = call %struct.Memory* @routine_movsd_0x1987__rip____xmm0(%struct.State* %0, i64  0, %struct.Memory* %loadMem_401399)
  store %struct.Memory* %call_401399, %struct.Memory** %MEMORY

  ; Code: movsd 0x195f(%rip), %xmm1	 RIP: 4013a1	 Bytes: 8
  %loadMem_4013a1 = load %struct.Memory*, %struct.Memory** %MEMORY
  %call_4013a1 = call %struct.Memory* @routine_movsd_0x195f__rip____xmm1(%struct.State* %0, i64  0, %struct.Memory* %loadMem_4013a1)
  store %struct.Memory* %call_4013a1, %struct.Memory** %MEMORY

  ; Code: movq %rax, 0x605148	 RIP: 4013a9	 Bytes: 8
  %loadMem_4013a9 = load %struct.Memory*, %struct.Memory** %MEMORY
  %call_4013a9 = call %struct.Memory* @routine_movq__rax__0x605148(%struct.State* %0, i64  0, %struct.Memory* %loadMem_4013a9)
  store %struct.Memory* %call_4013a9, %struct.Memory** %MEMORY

  ; Code: movq 0x605148, %rax	 RIP: 4013b1	 Bytes: 8
  %loadMem_4013b1 = load %struct.Memory*, %struct.Memory** %MEMORY
  %call_4013b1 = call %struct.Memory* @routine_movq_0x605148___rax(%struct.State* %0, i64  0, %struct.Memory* %loadMem_4013b1)
  store %struct.Memory* %call_4013b1, %struct.Memory** %MEMORY

  ; Code: subq 0x605140, %rax	 RIP: 4013b9	 Bytes: 8
  %loadMem_4013b9 = load %struct.Memory*, %struct.Memory** %MEMORY
  %call_4013b9 = call %struct.Memory* @routine_subq_0x605140___rax(%struct.State* %0, i64  0, %struct.Memory* %loadMem_4013b9)
  store %struct.Memory* %call_4013b9, %struct.Memory** %MEMORY

  ; Code: cvtsi2sdq %rax, %xmm2	 RIP: 4013c1	 Bytes: 5
  %loadMem_4013c1 = load %struct.Memory*, %struct.Memory** %MEMORY
  %call_4013c1 = call %struct.Memory* @routine_cvtsi2sdq__rax___xmm2(%struct.State* %0, i64  0, %struct.Memory* %loadMem_4013c1)
  store %struct.Memory* %call_4013c1, %struct.Memory** %MEMORY

  ; Code: divsd %xmm1, %xmm2	 RIP: 4013c6	 Bytes: 4
  %loadMem_4013c6 = load %struct.Memory*, %struct.Memory** %MEMORY
  %call_4013c6 = call %struct.Memory* @routine_divsd__xmm1___xmm2(%struct.State* %0, i64  0, %struct.Memory* %loadMem_4013c6)
  store %struct.Memory* %call_4013c6, %struct.Memory** %MEMORY

  ; Code: addsd %xmm2, %xmm0	 RIP: 4013ca	 Bytes: 4
  %loadMem_4013ca = load %struct.Memory*, %struct.Memory** %MEMORY
  %call_4013ca = call %struct.Memory* @routine_addsd__xmm2___xmm0(%struct.State* %0, i64  0, %struct.Memory* %loadMem_4013ca)
  store %struct.Memory* %call_4013ca, %struct.Memory** %MEMORY

  ; Code: popq %rbp	 RIP: 4013ce	 Bytes: 1
  %loadMem_4013ce = load %struct.Memory*, %struct.Memory** %MEMORY
  %call_4013ce = call %struct.Memory* @routine_popq__rbp(%struct.State* %0, i64  0, %struct.Memory* %loadMem_4013ce)
  store %struct.Memory* %call_4013ce, %struct.Memory** %MEMORY

  ; Code: retq	 RIP: 4013cf	 Bytes: 1
  %loadMem_4013cf = load %struct.Memory*, %struct.Memory** %MEMORY
  %call_4013cf = call %struct.Memory* @routine_retq(%struct.State* %0, i64  0, %struct.Memory* %loadMem_4013cf)
  store %struct.Memory* %call_4013cf, %struct.Memory** %MEMORY

  ret %struct.Memory* %call_4013cf
}
...
define %struct.Memory* @routine_movq_0x605148___rax(%struct.State*  dereferenceable(3376), i64, %struct.Memory* ) #19 {
block_400478:
  %3 = getelementptr inbounds %struct.State, %struct.State* %0, i32 0, i32 6
  %4 = getelementptr inbounds %struct.GPR, %struct.GPR* %3, i32 0, i32 33
  %5 = getelementptr inbounds %struct.Reg, %struct.Reg* %4, i32 0, i32 0
