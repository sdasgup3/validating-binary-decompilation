...
entry:
  ...
  store %struct.Memory* %loadMem1_402ada, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_402aea, %struct.Memory** %MEMORY
  ...
  ret %struct.Memory* %loadMem_402aef
}
