...
declare %struct.Memory* @sub_401e20._ZN14Double_pointerppEv(%struct.State* noalias dereferenceable(3376), i64, %struct.Memory* noalias readnone returned) local_unnamed_addr
...
entry:
  ...
  %call2_402ada = tail call %struct.Memory* @sub_401e20._ZN14Double_pointerppEv(%struct.State* %0, i64 %63, %struct.Memory* %2)
  ...
  ret %struct.Memory* %call2_402ada
}
