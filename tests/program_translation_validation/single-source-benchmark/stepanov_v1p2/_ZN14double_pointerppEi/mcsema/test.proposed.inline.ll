...
define %struct.Memory* @_ZN14double_pointerppEi(%struct.State* noalias, i64, %struct.Memory* noalias) #1 {
entry:
  ...
  store %struct.Memory* %loadMem1_402baa, %struct.Memory** %MEMORY
  ...
  ret %struct.Memory* %loadMem_402bbf
}
