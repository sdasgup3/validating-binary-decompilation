...
entry:
  ...
  ; Code: ._ZN14double_pointerppEv:	 RIP: 4020b0	 Bytes: 0
  ...
  ; Code: addq $0x8, %rax	 RIP: 4020bf	 Bytes: 4
  %loadMem_4020bf = load %struct.Memory*, %struct.Memory** %MEMORY
  %call_4020bf = call %struct.Memory* @routine_addq__0x8___rax(%struct.State* %0, i64  0, %struct.Memory* %loadMem_4020bf)
  store %struct.Memory* %call_4020bf, %struct.Memory** %MEMORY

  ; Code: movq %rax, (%rdi)	 RIP: 4020c3	 Bytes: 3
  %loadMem_4020c3 = load %struct.Memory*, %struct.Memory** %MEMORY
  %call_4020c3 = call %struct.Memory* @routine_movq__rax____rdi_(%struct.State* %0, i64  0, %struct.Memory* %loadMem_4020c3)
  store %struct.Memory* %call_4020c3, %struct.Memory** %MEMORY

  ; Code: movq %rdi, %rax	 RIP: 4020c6	 Bytes: 3
  %loadMem_4020c6 = load %struct.Memory*, %struct.Memory** %MEMORY
  %call_4020c6 = call %struct.Memory* @routine_movq__rdi___rax(%struct.State* %0, i64  0, %struct.Memory* %loadMem_4020c6)
  store %struct.Memory* %call_4020c6, %struct.Memory** %MEMORY

  ; Code: popq %rbp	 RIP: 4020c9	 Bytes: 1
  %loadMem_4020c9 = load %struct.Memory*, %struct.Memory** %MEMORY
  %call_4020c9 = call %struct.Memory* @routine_popq__rbp(%struct.State* %0, i64  0, %struct.Memory* %loadMem_4020c9)
  store %struct.Memory* %call_4020c9, %struct.Memory** %MEMORY

  ; Code: retq	 RIP: 4020ca	 Bytes: 1
  %loadMem_4020ca = load %struct.Memory*, %struct.Memory** %MEMORY
  %call_4020ca = call %struct.Memory* @routine_retq(%struct.State* %0, i64  0, %struct.Memory* %loadMem_4020ca)
  store %struct.Memory* %call_4020ca, %struct.Memory** %MEMORY

  ret %struct.Memory* %call_4020ca
}
