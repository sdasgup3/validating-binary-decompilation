...
define %struct.Memory* @_ZN16reverse_iteratorI14Double_pointer6DoubleEC2ES0_(%struct.State* noalias, i64, %struct.Memory* noalias) #2 {
entry:
  ...
  ret %struct.Memory* %loadMem_401268
}
