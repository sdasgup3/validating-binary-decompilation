...
define %struct.Memory* @_ZN16reverse_iteratorI14Double_pointer6DoubleEC2ES0_(%struct.State* noalias, i64, %struct.Memory* noalias) #1 {
entry:
  ...
  %RSI.i15 = bitcast %union.anon* %34 to i64*
  ...
  ret %struct.Memory* %loadMem_401258
}
