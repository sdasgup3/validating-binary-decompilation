...
define %struct.Memory* @_ZN16reverse_iteratorI14Double_pointer6DoubleEmmEv(%struct.State* noalias, i64, %struct.Memory* noalias readnone returned) local_unnamed_addr #1 {
entry:
  ...
  %call2_401d84 = tail call %struct.Memory* @sub_401e20._ZN14Double_pointerppEv(%struct.State* %0, i64 %53, %struct.Memory* %2)
  ...
  ret %struct.Memory* %call2_401d84
}
