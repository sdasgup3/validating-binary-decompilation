...
define %struct.Memory* @_ZN16reverse_iteratorI14Double_pointer6DoubleEppEi(%struct.State* noalias, i64, %struct.Memory* noalias) #2 {
entry:
  ...
  store %struct.Memory* %loadMem1_40268a, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_40269a, %struct.Memory** %MEMORY
  ...
  ret %struct.Memory* %loadMem_40269f
}
