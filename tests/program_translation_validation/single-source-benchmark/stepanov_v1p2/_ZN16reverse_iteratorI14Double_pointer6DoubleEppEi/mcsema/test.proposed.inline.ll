...
entry:
  ...
  store %struct.Memory* %loadMem1_40269a, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_4026a7, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_4026aa, %struct.Memory** %MEMORY
  ...
  ret %struct.Memory* %loadMem_4026af
}
