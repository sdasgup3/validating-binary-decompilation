...
declare %struct.Memory* @sub_4026a0._ZN16reverse_iteratorI14Double_pointer6DoubleEppEv(%struct.State* noalias dereferenceable(3376), i64, %struct.Memory* noalias readnone returned) local_unnamed_addr
...
entry:
  ...
  %call2_40268a = tail call %struct.Memory* @sub_4026a0._ZN16reverse_iteratorI14Double_pointer6DoubleEppEv(%struct.State* %0, i64 %63, %struct.Memory* %2)
  ...
  ret %struct.Memory* %call2_40268a
}
