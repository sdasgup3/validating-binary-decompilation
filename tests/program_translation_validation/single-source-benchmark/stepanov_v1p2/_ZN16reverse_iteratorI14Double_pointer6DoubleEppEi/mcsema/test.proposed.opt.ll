...
declare %struct.Memory* @sub_4026a0._ZN16reverse_iteratorI14Double_pointer6DoubleEppEv(%struct.State* dereferenceable(3376), i64, %struct.Memory*) local_unnamed_addr
