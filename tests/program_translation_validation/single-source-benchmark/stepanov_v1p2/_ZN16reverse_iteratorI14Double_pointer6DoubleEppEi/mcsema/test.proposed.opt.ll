...
declare %struct.Memory* @sub_402690._ZN16reverse_iteratorI14Double_pointer6DoubleEppEv(%struct.State* noalias dereferenceable(3376), i64, %struct.Memory* noalias readnone returned) local_unnamed_addr
...
entry:
  ...
  %call2_40267a = tail call %struct.Memory* @sub_402690._ZN16reverse_iteratorI14Double_pointer6DoubleEppEv(%struct.State* %0, i64 %63, %struct.Memory* %2)
  ...
  ret %struct.Memory* %call2_40267a
}
...
define %struct.Memory* @routine_callq_._ZN16reverse_iteratorI14Double_pointer6DoubleEppEv(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
