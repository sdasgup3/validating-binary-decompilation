...
define %struct.Memory* @_ZN16reverse_iteratorI14Double_pointer6DoubleEppEv(%struct.State* noalias, i64, %struct.Memory* noalias) #1 {
entry:
  ...
  store %struct.Memory* %loadMem1_4026b4, %struct.Memory** %MEMORY
  ...
  ret %struct.Memory* %loadMem_4026c9
}
