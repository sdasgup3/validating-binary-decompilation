...
define %struct.Memory* @_ZN16reverse_iteratorI14Double_pointer6DoubleEppEv(%struct.State* noalias, i64, %struct.Memory* noalias) local_unnamed_addr #1 {
entry:
  ...
  %call2_4026a4 = tail call %struct.Memory* @sub_401dc0._ZN14Double_pointermmEv(%struct.State* %0, i64 %53, %struct.Memory* %2)
  ...
  ret %struct.Memory* %call2_4026a4
}
