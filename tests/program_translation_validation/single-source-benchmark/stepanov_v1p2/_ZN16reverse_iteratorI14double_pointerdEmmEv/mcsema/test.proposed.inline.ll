...
define %struct.Memory* @_ZN16reverse_iteratorI14double_pointerdEmmEv(%struct.State* noalias, i64, %struct.Memory* noalias) #1 {
entry:
  ...
  store %struct.Memory* %loadMem1_402024, %struct.Memory** %MEMORY
  ...
  ret %struct.Memory* %loadMem_402039
}
