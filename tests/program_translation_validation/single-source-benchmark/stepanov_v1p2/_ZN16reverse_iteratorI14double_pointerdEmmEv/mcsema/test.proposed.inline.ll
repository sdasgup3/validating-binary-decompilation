...
define %struct.Memory* @_ZN16reverse_iteratorI14double_pointerdEmmEv(%struct.State* noalias, i64, %struct.Memory* noalias) #2 {
entry:
  ...
  store %struct.Memory* %loadMem_402001, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem1_402014, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_402019, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_402028, %struct.Memory** %MEMORY
  ...
  ret %struct.Memory* %loadMem_402029
}
