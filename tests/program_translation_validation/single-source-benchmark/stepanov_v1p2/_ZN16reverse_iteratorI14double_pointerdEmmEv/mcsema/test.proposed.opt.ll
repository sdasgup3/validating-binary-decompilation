...
declare %struct.Memory* @sub_4020c0._ZN14double_pointerppEv(%struct.State* noalias dereferenceable(3376), i64, %struct.Memory* noalias readnone returned) local_unnamed_addr
...
entry:
  ...
  %call2_402024 = tail call %struct.Memory* @sub_4020c0._ZN14double_pointerppEv(%struct.State* %0, i64 %53, %struct.Memory* %2)
  ...
  ret %struct.Memory* %call2_402024
}
