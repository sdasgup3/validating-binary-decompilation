...
define %struct.Memory* @_ZN16reverse_iteratorI14double_pointerdEppEi(%struct.State* noalias, i64, %struct.Memory* noalias) #2 {
entry:
  ...
  store %struct.Memory* %loadMem_402794, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem1_4027aa, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_4027ba, %struct.Memory** %MEMORY
  ...
  ret %struct.Memory* %loadMem_4027bf
}
