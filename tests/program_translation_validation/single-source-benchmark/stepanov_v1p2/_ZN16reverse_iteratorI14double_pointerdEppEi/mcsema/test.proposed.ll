...
declare %struct.Memory* @sub_4027a0._ZN16reverse_iteratorI14double_pointerdEppEv(%struct.State* noalias dereferenceable(3376), i64, %struct.Memory* noalias readnone returned)
...
entry:
  ...
  ; Code: ._ZN16reverse_iteratorI14double_pointerdEppEi:	 RIP: 402770	 Bytes: 0
  ...
  ; Code: subq $0x20, %rsp	 RIP: 402774	 Bytes: 4
  %loadMem_402774 = load %struct.Memory*, %struct.Memory** %MEMORY
  %call_402774 = call %struct.Memory* @routine_subq__0x20___rsp(%struct.State* %0, i64  0, %struct.Memory* %loadMem_402774)
  store %struct.Memory* %call_402774, %struct.Memory** %MEMORY

  ; Code: movq %rdi, -0x10(%rbp)	 RIP: 402778	 Bytes: 4
  %loadMem_402778 = load %struct.Memory*, %struct.Memory** %MEMORY
  %call_402778 = call %struct.Memory* @routine_movq__rdi__MINUS0x10__rbp_(%struct.State* %0, i64  0, %struct.Memory* %loadMem_402778)
  store %struct.Memory* %call_402778, %struct.Memory** %MEMORY

  ; Code: movl %esi, -0x14(%rbp)	 RIP: 40277c	 Bytes: 3
  %loadMem_40277c = load %struct.Memory*, %struct.Memory** %MEMORY
  %call_40277c = call %struct.Memory* @routine_movl__esi__MINUS0x14__rbp_(%struct.State* %0, i64  0, %struct.Memory* %loadMem_40277c)
  store %struct.Memory* %call_40277c, %struct.Memory** %MEMORY

  ; Code: movq -0x10(%rbp), %rdi	 RIP: 40277f	 Bytes: 4
  %loadMem_40277f = load %struct.Memory*, %struct.Memory** %MEMORY
  %call_40277f = call %struct.Memory* @routine_movq_MINUS0x10__rbp____rdi(%struct.State* %0, i64  0, %struct.Memory* %loadMem_40277f)
  store %struct.Memory* %call_40277f, %struct.Memory** %MEMORY

  ; Code: movq (%rdi), %rax	 RIP: 402783	 Bytes: 3
  %loadMem_402783 = load %struct.Memory*, %struct.Memory** %MEMORY
  %call_402783 = call %struct.Memory* @routine_movq___rdi____rax(%struct.State* %0, i64  0, %struct.Memory* %loadMem_402783)
  store %struct.Memory* %call_402783, %struct.Memory** %MEMORY

  ; Code: movq %rax, -0x8(%rbp)	 RIP: 402786	 Bytes: 4
  %loadMem_402786 = load %struct.Memory*, %struct.Memory** %MEMORY
  %call_402786 = call %struct.Memory* @routine_movq__rax__MINUS0x8__rbp_(%struct.State* %0, i64  0, %struct.Memory* %loadMem_402786)
  store %struct.Memory* %call_402786, %struct.Memory** %MEMORY

  ; Code: callq ._ZN16reverse_iteratorI14double_pointerdEppEv	 RIP: 40278a	 Bytes: 5
  %loadMem1_40278a = load %struct.Memory*, %struct.Memory** %MEMORY
  %call1_40278a = call %struct.Memory* @routine_callq_._ZN16reverse_iteratorI14double_pointerdEppEv(%struct.State* %0, i64  0, %struct.Memory* %loadMem1_40278a, i64 22, i64 5, i64 5)
  store %struct.Memory* %call1_40278a, %struct.Memory** %MEMORY

  %loadMem2_40278a = load %struct.Memory*, %struct.Memory** %MEMORY
  %loadPC_40278a = load i64, i64* %3
  %call2_40278a = call %struct.Memory* @sub_4027a0._ZN16reverse_iteratorI14double_pointerdEppEv(%struct.State* %0, i64  %loadPC_40278a, %struct.Memory* %loadMem2_40278a)
  store %struct.Memory* %call2_40278a, %struct.Memory** %MEMORY

  ; Code: movq -0x8(%rbp), %rdi	 RIP: 40278f	 Bytes: 4
  %loadMem_40278f = load %struct.Memory*, %struct.Memory** %MEMORY
  %call_40278f = call %struct.Memory* @routine_movq_MINUS0x8__rbp____rdi(%struct.State* %0, i64  0, %struct.Memory* %loadMem_40278f)
  store %struct.Memory* %call_40278f, %struct.Memory** %MEMORY

  ; Code: movq %rax, -0x20(%rbp)	 RIP: 402793	 Bytes: 4
  %loadMem_402793 = load %struct.Memory*, %struct.Memory** %MEMORY
  %call_402793 = call %struct.Memory* @routine_movq__rax__MINUS0x20__rbp_(%struct.State* %0, i64  0, %struct.Memory* %loadMem_402793)
  store %struct.Memory* %call_402793, %struct.Memory** %MEMORY

  ; Code: movq %rdi, %rax	 RIP: 402797	 Bytes: 3
  %loadMem_402797 = load %struct.Memory*, %struct.Memory** %MEMORY
  %call_402797 = call %struct.Memory* @routine_movq__rdi___rax(%struct.State* %0, i64  0, %struct.Memory* %loadMem_402797)
  store %struct.Memory* %call_402797, %struct.Memory** %MEMORY

  ; Code: addq $0x20, %rsp	 RIP: 40279a	 Bytes: 4
  %loadMem_40279a = load %struct.Memory*, %struct.Memory** %MEMORY
  %call_40279a = call %struct.Memory* @routine_addq__0x20___rsp(%struct.State* %0, i64  0, %struct.Memory* %loadMem_40279a)
  store %struct.Memory* %call_40279a, %struct.Memory** %MEMORY

  ; Code: popq %rbp	 RIP: 40279e	 Bytes: 1
  %loadMem_40279e = load %struct.Memory*, %struct.Memory** %MEMORY
  %call_40279e = call %struct.Memory* @routine_popq__rbp(%struct.State* %0, i64  0, %struct.Memory* %loadMem_40279e)
  store %struct.Memory* %call_40279e, %struct.Memory** %MEMORY

  ; Code: retq	 RIP: 40279f	 Bytes: 1
  %loadMem_40279f = load %struct.Memory*, %struct.Memory** %MEMORY
  %call_40279f = call %struct.Memory* @routine_retq(%struct.State* %0, i64  0, %struct.Memory* %loadMem_40279f)
  store %struct.Memory* %call_40279f, %struct.Memory** %MEMORY

  ret %struct.Memory* %call_40279f
}
