...
declare %struct.Memory* @sub_4027b0._ZN16reverse_iteratorI14double_pointerdEppEv(%struct.State* noalias dereferenceable(3376), i64, %struct.Memory* noalias readnone returned) local_unnamed_addr
...
entry:
  ...
  %call2_40279a = tail call %struct.Memory* @sub_4027b0._ZN16reverse_iteratorI14double_pointerdEppEv(%struct.State* %0, i64 %63, %struct.Memory* %2)
  ...
  ret %struct.Memory* %call2_40279a
}
