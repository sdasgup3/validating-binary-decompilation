...
define %struct.Memory* @_ZN16reverse_iteratorI14double_pointerdEppEv(%struct.State* noalias, i64, %struct.Memory* noalias) #2 {
entry:
  ...
  store %struct.Memory* %loadMem1_4027b4, %struct.Memory** %MEMORY
  %loadMem2_4027b4 = load %struct.Memory*, %struct.Memory** %MEMORY
  %loadPC_4027b4 = load i64, i64* %3
  %call2_4027b4 = call %struct.Memory* @sub_402070._ZN14double_pointermmEv(%struct.State* %0, i64 %loadPC_4027b4, %struct.Memory* %loadMem2_4027b4)
  store %struct.Memory* %call2_4027b4, %struct.Memory** %MEMORY
  ...
  ret %struct.Memory* %loadMem_4027c9
}
