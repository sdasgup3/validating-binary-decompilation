...
declare %struct.Memory* @sub_402090._ZN14double_pointermmEv(%struct.State* noalias dereferenceable(3376), i64, %struct.Memory* noalias readnone returned) local_unnamed_addr
...
entry:
  ...
  %call2_4027d4 = tail call %struct.Memory* @sub_402090._ZN14double_pointermmEv(%struct.State* %0, i64 %53, %struct.Memory* %2)
  ...
  ret %struct.Memory* %call2_4027d4
}
