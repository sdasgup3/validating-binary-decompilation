...
define %struct.Memory* @_ZN16reverse_iteratorIP6DoubleS0_EC2ES1_(%struct.State* noalias nocapture, i64, %struct.Memory* noalias readnone returned) local_unnamed_addr #0 {
entry:
