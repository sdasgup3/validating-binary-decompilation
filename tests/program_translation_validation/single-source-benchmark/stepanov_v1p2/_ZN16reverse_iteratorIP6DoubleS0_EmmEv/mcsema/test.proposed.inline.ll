...
define %struct.Memory* @_ZN16reverse_iteratorIP6DoubleS0_EmmEv(%struct.State* noalias, i64, %struct.Memory* noalias) #2 {
entry:
  ...
  store %struct.Memory* %loadMem_4022e0, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_4022fa, %struct.Memory** %MEMORY
  ret %struct.Memory* %loadMem_4022fa
}
