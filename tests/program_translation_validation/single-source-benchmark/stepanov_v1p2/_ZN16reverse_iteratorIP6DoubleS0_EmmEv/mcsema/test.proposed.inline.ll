...
define %struct.Memory* @_ZN16reverse_iteratorIP6DoubleS0_EmmEv(%struct.State* noalias, i64, %struct.Memory* noalias) #1 {
entry:
  ...
  store i64 %40, i64* %43
  store %struct.Memory* %loadMem_4022d4, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_4022ea, %struct.Memory** %MEMORY
  ret %struct.Memory* %loadMem_4022ea
}
