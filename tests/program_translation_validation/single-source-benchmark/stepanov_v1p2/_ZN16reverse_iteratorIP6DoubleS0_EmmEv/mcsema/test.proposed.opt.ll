...
define %struct.Memory* @_ZN16reverse_iteratorIP6DoubleS0_EmmEv(%struct.State* noalias nocapture, i64, %struct.Memory* noalias readnone returned) local_unnamed_addr #1 {
entry:
  ...
  store i64 %20, i64* %RAX.i11, align 8
  %52 = add i64 %17, 18
