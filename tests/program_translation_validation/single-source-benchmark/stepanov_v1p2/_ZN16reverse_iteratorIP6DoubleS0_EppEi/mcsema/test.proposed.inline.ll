...
define %struct.Memory* @_ZN16reverse_iteratorIP6DoubleS0_EppEi(%struct.State* noalias, i64, %struct.Memory* noalias) #2 {
entry:
  ...
  store %struct.Memory* %loadMem_4028a6, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem1_4028aa, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_4028af, %struct.Memory** %MEMORY
  ...
  ret %struct.Memory* %loadMem_4028bf
}
