...
declare %struct.Memory* @sub_4028c0._ZN16reverse_iteratorIP6DoubleS0_EppEv(%struct.State* noalias dereferenceable(3376), i64, %struct.Memory* noalias readnone returned)
...
entry:
  ...
  ; Code: ._ZN16reverse_iteratorIP6DoubleS0_EppEi:	 RIP: 402890	 Bytes: 0
  ...
  ; Code: subq $0x20, %rsp	 RIP: 402894	 Bytes: 4
  %loadMem_402894 = load %struct.Memory*, %struct.Memory** %MEMORY
  %call_402894 = call %struct.Memory* @routine_subq__0x20___rsp(%struct.State* %0, i64  0, %struct.Memory* %loadMem_402894)
  store %struct.Memory* %call_402894, %struct.Memory** %MEMORY

  ; Code: movq %rdi, -0x10(%rbp)	 RIP: 402898	 Bytes: 4
  %loadMem_402898 = load %struct.Memory*, %struct.Memory** %MEMORY
  %call_402898 = call %struct.Memory* @routine_movq__rdi__MINUS0x10__rbp_(%struct.State* %0, i64  0, %struct.Memory* %loadMem_402898)
  store %struct.Memory* %call_402898, %struct.Memory** %MEMORY

  ; Code: movl %esi, -0x14(%rbp)	 RIP: 40289c	 Bytes: 3
  %loadMem_40289c = load %struct.Memory*, %struct.Memory** %MEMORY
  %call_40289c = call %struct.Memory* @routine_movl__esi__MINUS0x14__rbp_(%struct.State* %0, i64  0, %struct.Memory* %loadMem_40289c)
  store %struct.Memory* %call_40289c, %struct.Memory** %MEMORY

  ; Code: movq -0x10(%rbp), %rdi	 RIP: 40289f	 Bytes: 4
  %loadMem_40289f = load %struct.Memory*, %struct.Memory** %MEMORY
  %call_40289f = call %struct.Memory* @routine_movq_MINUS0x10__rbp____rdi(%struct.State* %0, i64  0, %struct.Memory* %loadMem_40289f)
  store %struct.Memory* %call_40289f, %struct.Memory** %MEMORY

  ; Code: movq (%rdi), %rax	 RIP: 4028a3	 Bytes: 3
  %loadMem_4028a3 = load %struct.Memory*, %struct.Memory** %MEMORY
  %call_4028a3 = call %struct.Memory* @routine_movq___rdi____rax(%struct.State* %0, i64  0, %struct.Memory* %loadMem_4028a3)
  store %struct.Memory* %call_4028a3, %struct.Memory** %MEMORY

  ; Code: movq %rax, -0x8(%rbp)	 RIP: 4028a6	 Bytes: 4
  %loadMem_4028a6 = load %struct.Memory*, %struct.Memory** %MEMORY
  %call_4028a6 = call %struct.Memory* @routine_movq__rax__MINUS0x8__rbp_(%struct.State* %0, i64  0, %struct.Memory* %loadMem_4028a6)
  store %struct.Memory* %call_4028a6, %struct.Memory** %MEMORY

  ; Code: callq ._ZN16reverse_iteratorIP6DoubleS0_EppEv	 RIP: 4028aa	 Bytes: 5
  %loadMem1_4028aa = load %struct.Memory*, %struct.Memory** %MEMORY
  %call1_4028aa = call %struct.Memory* @routine_callq_._ZN16reverse_iteratorIP6DoubleS0_EppEv(%struct.State* %0, i64  0, %struct.Memory* %loadMem1_4028aa, i64 22, i64 5, i64 5)
  store %struct.Memory* %call1_4028aa, %struct.Memory** %MEMORY

  %loadMem2_4028aa = load %struct.Memory*, %struct.Memory** %MEMORY
  %loadPC_4028aa = load i64, i64* %3
  %call2_4028aa = call %struct.Memory* @sub_4028c0._ZN16reverse_iteratorIP6DoubleS0_EppEv(%struct.State* %0, i64  %loadPC_4028aa, %struct.Memory* %loadMem2_4028aa)
  store %struct.Memory* %call2_4028aa, %struct.Memory** %MEMORY

  ; Code: movq -0x8(%rbp), %rdi	 RIP: 4028af	 Bytes: 4
  %loadMem_4028af = load %struct.Memory*, %struct.Memory** %MEMORY
  %call_4028af = call %struct.Memory* @routine_movq_MINUS0x8__rbp____rdi(%struct.State* %0, i64  0, %struct.Memory* %loadMem_4028af)
  store %struct.Memory* %call_4028af, %struct.Memory** %MEMORY

  ; Code: movq %rax, -0x20(%rbp)	 RIP: 4028b3	 Bytes: 4
  %loadMem_4028b3 = load %struct.Memory*, %struct.Memory** %MEMORY
  %call_4028b3 = call %struct.Memory* @routine_movq__rax__MINUS0x20__rbp_(%struct.State* %0, i64  0, %struct.Memory* %loadMem_4028b3)
  store %struct.Memory* %call_4028b3, %struct.Memory** %MEMORY

  ; Code: movq %rdi, %rax	 RIP: 4028b7	 Bytes: 3
  %loadMem_4028b7 = load %struct.Memory*, %struct.Memory** %MEMORY
  %call_4028b7 = call %struct.Memory* @routine_movq__rdi___rax(%struct.State* %0, i64  0, %struct.Memory* %loadMem_4028b7)
  store %struct.Memory* %call_4028b7, %struct.Memory** %MEMORY

  ; Code: addq $0x20, %rsp	 RIP: 4028ba	 Bytes: 4
  %loadMem_4028ba = load %struct.Memory*, %struct.Memory** %MEMORY
  %call_4028ba = call %struct.Memory* @routine_addq__0x20___rsp(%struct.State* %0, i64  0, %struct.Memory* %loadMem_4028ba)
  store %struct.Memory* %call_4028ba, %struct.Memory** %MEMORY

  ; Code: popq %rbp	 RIP: 4028be	 Bytes: 1
  %loadMem_4028be = load %struct.Memory*, %struct.Memory** %MEMORY
  %call_4028be = call %struct.Memory* @routine_popq__rbp(%struct.State* %0, i64  0, %struct.Memory* %loadMem_4028be)
  store %struct.Memory* %call_4028be, %struct.Memory** %MEMORY

  ; Code: retq	 RIP: 4028bf	 Bytes: 1
  %loadMem_4028bf = load %struct.Memory*, %struct.Memory** %MEMORY
  %call_4028bf = call %struct.Memory* @routine_retq(%struct.State* %0, i64  0, %struct.Memory* %loadMem_4028bf)
  store %struct.Memory* %call_4028bf, %struct.Memory** %MEMORY

  ret %struct.Memory* %call_4028bf
}
