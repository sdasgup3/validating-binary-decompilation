...
define %struct.Memory* @_ZN16reverse_iteratorIPddEmmEv(%struct.State* noalias, i64, %struct.Memory* noalias) #1 {
entry:
  ...
  store %struct.Memory* %loadMem_4024e9, %struct.Memory** %MEMORY
  ...
  ret %struct.Memory* %loadMem_4024ea
}
