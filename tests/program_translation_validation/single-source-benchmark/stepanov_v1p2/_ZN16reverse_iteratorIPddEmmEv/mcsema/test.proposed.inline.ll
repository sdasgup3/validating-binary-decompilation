...
define %struct.Memory* @_ZN16reverse_iteratorIPddEmmEv(%struct.State* noalias, i64, %struct.Memory* noalias) #2 {
entry:
  ...
  store %struct.Memory* %loadMem_4024d6, %struct.Memory** %MEMORY
  ...
  ret %struct.Memory* %loadMem_4024da
}
