...
entry:
  ...
  ; Code: ._ZN16reverse_iteratorIPddEmmEv:	 RIP: 4024c0	 Bytes: 0
  ; Code: pushq %rbp	 RIP: 4024c0	 Bytes: 1
  %loadMem_4024c0 = load %struct.Memory*, %struct.Memory** %MEMORY
  %call_4024c0 = call %struct.Memory* @routine_pushq__rbp(%struct.State* %0, i64  0, %struct.Memory* %loadMem_4024c0)
  store %struct.Memory* %call_4024c0, %struct.Memory** %MEMORY

  ; Code: movq %rsp, %rbp	 RIP: 4024c1	 Bytes: 3
  %loadMem_4024c1 = load %struct.Memory*, %struct.Memory** %MEMORY
  %call_4024c1 = call %struct.Memory* @routine_movq__rsp___rbp(%struct.State* %0, i64  0, %struct.Memory* %loadMem_4024c1)
  store %struct.Memory* %call_4024c1, %struct.Memory** %MEMORY

  ; Code: movq %rdi, -0x8(%rbp)	 RIP: 4024c4	 Bytes: 4
  %loadMem_4024c4 = load %struct.Memory*, %struct.Memory** %MEMORY
  %call_4024c4 = call %struct.Memory* @routine_movq__rdi__MINUS0x8__rbp_(%struct.State* %0, i64  0, %struct.Memory* %loadMem_4024c4)
  store %struct.Memory* %call_4024c4, %struct.Memory** %MEMORY

  ; Code: movq -0x8(%rbp), %rdi	 RIP: 4024c8	 Bytes: 4
  %loadMem_4024c8 = load %struct.Memory*, %struct.Memory** %MEMORY
  %call_4024c8 = call %struct.Memory* @routine_movq_MINUS0x8__rbp____rdi(%struct.State* %0, i64  0, %struct.Memory* %loadMem_4024c8)
  store %struct.Memory* %call_4024c8, %struct.Memory** %MEMORY

  ; Code: movq (%rdi), %rax	 RIP: 4024cc	 Bytes: 3
  %loadMem_4024cc = load %struct.Memory*, %struct.Memory** %MEMORY
  %call_4024cc = call %struct.Memory* @routine_movq___rdi____rax(%struct.State* %0, i64  0, %struct.Memory* %loadMem_4024cc)
  store %struct.Memory* %call_4024cc, %struct.Memory** %MEMORY

  ; Code: addq $0x8, %rax	 RIP: 4024cf	 Bytes: 4
  %loadMem_4024cf = load %struct.Memory*, %struct.Memory** %MEMORY
  %call_4024cf = call %struct.Memory* @routine_addq__0x8___rax(%struct.State* %0, i64  0, %struct.Memory* %loadMem_4024cf)
  store %struct.Memory* %call_4024cf, %struct.Memory** %MEMORY

  ; Code: movq %rax, (%rdi)	 RIP: 4024d3	 Bytes: 3
  %loadMem_4024d3 = load %struct.Memory*, %struct.Memory** %MEMORY
  %call_4024d3 = call %struct.Memory* @routine_movq__rax____rdi_(%struct.State* %0, i64  0, %struct.Memory* %loadMem_4024d3)
  store %struct.Memory* %call_4024d3, %struct.Memory** %MEMORY

  ; Code: movq %rdi, %rax	 RIP: 4024d6	 Bytes: 3
  %loadMem_4024d6 = load %struct.Memory*, %struct.Memory** %MEMORY
  %call_4024d6 = call %struct.Memory* @routine_movq__rdi___rax(%struct.State* %0, i64  0, %struct.Memory* %loadMem_4024d6)
  store %struct.Memory* %call_4024d6, %struct.Memory** %MEMORY

  ; Code: popq %rbp	 RIP: 4024d9	 Bytes: 1
  %loadMem_4024d9 = load %struct.Memory*, %struct.Memory** %MEMORY
  %call_4024d9 = call %struct.Memory* @routine_popq__rbp(%struct.State* %0, i64  0, %struct.Memory* %loadMem_4024d9)
  store %struct.Memory* %call_4024d9, %struct.Memory** %MEMORY

  ; Code: retq	 RIP: 4024da	 Bytes: 1
  %loadMem_4024da = load %struct.Memory*, %struct.Memory** %MEMORY
  %call_4024da = call %struct.Memory* @routine_retq(%struct.State* %0, i64  0, %struct.Memory* %loadMem_4024da)
  store %struct.Memory* %call_4024da, %struct.Memory** %MEMORY

  ret %struct.Memory* %call_4024da
}
