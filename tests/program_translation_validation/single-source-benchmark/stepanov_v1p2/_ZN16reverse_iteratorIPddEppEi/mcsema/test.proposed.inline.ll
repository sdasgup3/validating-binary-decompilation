...
declare %struct.Memory* @sub_4029d0._ZN16reverse_iteratorIPddEppEv(%struct.State* dereferenceable(3376), i64, %struct.Memory*)

; Function Attrs: alwaysinline
define %struct.Memory* @_ZN16reverse_iteratorIPddEppEi(%struct.State* noalias, i64, %struct.Memory* noalias) #1 {
entry:
