...
declare %struct.Memory* @sub_4029e0._ZN16reverse_iteratorIPddEppEv(%struct.State* noalias dereferenceable(3376), i64, %struct.Memory* noalias readnone returned)

; Function Attrs: alwaysinline
define %struct.Memory* @_ZN16reverse_iteratorIPddEppEi(%struct.State* noalias, i64, %struct.Memory* noalias) #2 {
entry:
  ...
  store %struct.Memory* %loadMem_4029b0, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_4029b1, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_4029b4, %struct.Memory** %MEMORY
  ...
  store i32 %93, i32* %97
  store %struct.Memory* %loadMem_4029bc, %struct.Memory** %MEMORY
  ...
  %loadMem1_4029ca = load %struct.Memory*, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem1_4029ca, %struct.Memory** %MEMORY
  %loadMem2_4029ca = load %struct.Memory*, %struct.Memory** %MEMORY
  %loadPC_4029ca = load i64, i64* %3
  %call2_4029ca = call %struct.Memory* @sub_4029e0._ZN16reverse_iteratorIPddEppEv(%struct.State* %0, i64 %loadPC_4029ca, %struct.Memory* %loadMem2_4029ca)
  store %struct.Memory* %call2_4029ca, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_4029da, %struct.Memory** %MEMORY
  ...
  ret %struct.Memory* %loadMem_4029df
}
...
define %struct.Memory* @routine_callq_._ZN16reverse_iteratorIPddEppEv(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) {
block_400488:
  %3 = getelementptr inbounds %struct.State, %struct.State* %0, i32 0, i32 6
  %4 = getelementptr inbounds %struct.GPR, %struct.GPR* %3, i32 0, i32 33
  %5 = getelementptr inbounds %struct.Reg, %struct.Reg* %4, i32 0, i32 0
