...
declare %struct.Memory* @sub_4029c0._ZN16reverse_iteratorIPddEppEv(%struct.State* noalias dereferenceable(3376), i64, %struct.Memory* noalias readnone returned)
...
entry:
  ...
  store %struct.Memory* %loadMem_402990, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_40299f, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_4029a3, %struct.Memory** %MEMORY
  ...
  %loadMem1_4029aa = load %struct.Memory*, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem1_4029aa, %struct.Memory** %MEMORY
  %loadMem2_4029aa = load %struct.Memory*, %struct.Memory** %MEMORY
  %loadPC_4029aa = load i64, i64* %3
  %call2_4029aa = call %struct.Memory* @sub_4029c0._ZN16reverse_iteratorIPddEppEv(%struct.State* %0, i64 %loadPC_4029aa, %struct.Memory* %loadMem2_4029aa)
  store %struct.Memory* %call2_4029aa, %struct.Memory** %MEMORY
  ...
  ret %struct.Memory* %loadMem_4029bf
}
