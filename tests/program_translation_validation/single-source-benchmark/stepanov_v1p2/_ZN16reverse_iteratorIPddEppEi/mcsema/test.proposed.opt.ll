...
declare %struct.Memory* @sub_4029e0._ZN16reverse_iteratorIPddEppEv(%struct.State* noalias dereferenceable(3376), i64, %struct.Memory* noalias readnone returned) local_unnamed_addr
...
entry:
  ...
  %call2_4029ca = tail call %struct.Memory* @sub_4029e0._ZN16reverse_iteratorIPddEppEv(%struct.State* %0, i64 %63, %struct.Memory* %2)
  ...
  ret %struct.Memory* %call2_4029ca
}
