...
declare %struct.Memory* @sub_4029d0._ZN16reverse_iteratorIPddEppEv(%struct.State* noalias dereferenceable(3376), i64, %struct.Memory* noalias readnone returned) local_unnamed_addr

; Function Attrs: alwaysinline
define %struct.Memory* @_ZN16reverse_iteratorIPddEppEi(%struct.State* noalias, i64, %struct.Memory* noalias readnone returned) local_unnamed_addr #1 {
entry:
  ...
  %call2_4029ba = tail call %struct.Memory* @sub_4029d0._ZN16reverse_iteratorIPddEppEv(%struct.State* %0, i64 %63, %struct.Memory* %2)
  ...
  ret %struct.Memory* %call2_4029ba
}
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_callq_._ZN16reverse_iteratorIPddEppEv(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
