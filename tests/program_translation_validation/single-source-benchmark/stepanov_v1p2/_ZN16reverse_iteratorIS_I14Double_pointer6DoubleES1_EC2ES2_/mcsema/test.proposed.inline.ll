...
define %struct.Memory* @_ZN16reverse_iteratorIS_I14Double_pointer6DoubleES1_EC2ES2_(%struct.State* noalias, i64, %struct.Memory* noalias) #1 {
entry:
  ...
  ret %struct.Memory* %loadMem_4011d8
}
