...
define %struct.Memory* @_ZN16reverse_iteratorIS_I14Double_pointer6DoubleES1_EppEi(%struct.State* noalias, i64, %struct.Memory* noalias) #1 {
entry:
  ...
  store %struct.Memory* %loadMem1_401cba, %struct.Memory** %MEMORY
  ...
  ret %struct.Memory* %loadMem_401ccf
}
