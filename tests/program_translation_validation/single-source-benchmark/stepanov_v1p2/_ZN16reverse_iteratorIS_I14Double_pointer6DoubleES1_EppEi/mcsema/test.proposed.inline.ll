...
define %struct.Memory* @_ZN16reverse_iteratorIS_I14Double_pointer6DoubleES1_EppEi(%struct.State* noalias, i64, %struct.Memory* noalias) #2 {
entry:
  ...
  store %struct.Memory* %loadMem_401cc6, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem1_401cca, %struct.Memory** %MEMORY
