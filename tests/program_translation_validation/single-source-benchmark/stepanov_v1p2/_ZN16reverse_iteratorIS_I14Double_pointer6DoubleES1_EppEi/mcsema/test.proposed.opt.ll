...
declare %struct.Memory* @sub_401e30._ZN16reverse_iteratorIS_I14Double_pointer6DoubleES1_EppEv(%struct.State* noalias dereferenceable(3376), i64, %struct.Memory* noalias readnone returned) local_unnamed_addr
...
entry:
  ...
  %call2_401cba = tail call %struct.Memory* @sub_401e30._ZN16reverse_iteratorIS_I14Double_pointer6DoubleES1_EppEv(%struct.State* %0, i64 %63, %struct.Memory* %2)
  ...
  ret %struct.Memory* %call2_401cba
}
