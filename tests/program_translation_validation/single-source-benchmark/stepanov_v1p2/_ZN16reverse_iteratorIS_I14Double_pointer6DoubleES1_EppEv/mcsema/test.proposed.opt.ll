...
define %struct.Memory* @_ZN16reverse_iteratorIS_I14Double_pointer6DoubleES1_EppEv(%struct.State* noalias, i64, %struct.Memory* noalias readnone returned) local_unnamed_addr #1 {
entry:
  ...
  %call2_401e54 = tail call %struct.Memory* @sub_401d70._ZN16reverse_iteratorI14Double_pointer6DoubleEmmEv(%struct.State* %0, i64 %53, %struct.Memory* %2)
  ...
  ret %struct.Memory* %call2_401e54
}
