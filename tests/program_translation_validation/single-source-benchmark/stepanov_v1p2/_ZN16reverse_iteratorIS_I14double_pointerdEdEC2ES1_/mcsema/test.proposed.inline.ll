...
define %struct.Memory* @_ZN16reverse_iteratorIS_I14double_pointerdEdEC2ES1_(%struct.State* noalias, i64, %struct.Memory* noalias) #1 {
entry:
  ...
  ret %struct.Memory* %loadMem_4011f8
}
