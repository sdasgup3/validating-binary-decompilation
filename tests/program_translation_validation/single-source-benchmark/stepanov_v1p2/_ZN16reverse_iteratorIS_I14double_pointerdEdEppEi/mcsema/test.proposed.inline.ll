...
define %struct.Memory* @_ZN16reverse_iteratorIS_I14double_pointerdEdEppEi(%struct.State* noalias, i64, %struct.Memory* noalias) #1 {
entry:
  ...
  store %struct.Memory* %loadMem_401fa4, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem1_401fba, %struct.Memory** %MEMORY
  ...
  ret %struct.Memory* %loadMem_401fcf
}
