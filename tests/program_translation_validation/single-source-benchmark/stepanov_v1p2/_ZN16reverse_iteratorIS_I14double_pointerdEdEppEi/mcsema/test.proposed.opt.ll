...
declare %struct.Memory* @sub_4020e0._ZN16reverse_iteratorIS_I14double_pointerdEdEppEv(%struct.State* noalias dereferenceable(3376), i64, %struct.Memory* noalias readnone returned) local_unnamed_addr
...
entry:
  ...
  %call2_401fba = tail call %struct.Memory* @sub_4020e0._ZN16reverse_iteratorIS_I14double_pointerdEdEppEv(%struct.State* %0, i64 %63, %struct.Memory* %2)
  ...
  ret %struct.Memory* %call2_401fba
}
