...
declare %struct.Memory* @sub_4020e0._ZN16reverse_iteratorIS_I14double_pointerdEdEppEv(%struct.State* dereferenceable(3376), i64, %struct.Memory*) local_unnamed_addr
