...
entry:
  ...
  store %struct.Memory* %loadMem1_4020e4, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_4020ed, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_4020f9, %struct.Memory** %MEMORY
  ret %struct.Memory* %loadMem_4020f9
}
