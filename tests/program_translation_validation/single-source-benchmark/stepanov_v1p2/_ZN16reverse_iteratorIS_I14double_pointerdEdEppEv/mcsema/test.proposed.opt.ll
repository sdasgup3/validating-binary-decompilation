...
entry:
  ...
  %call2_402104 = tail call %struct.Memory* @sub_402020._ZN16reverse_iteratorI14double_pointerdEmmEv(%struct.State* %0, i64 %53, %struct.Memory* %2)
  ...
  ret %struct.Memory* %call2_402104
}
