...
declare %struct.Memory* @sub_402010._ZN16reverse_iteratorI14double_pointerdEmmEv(%struct.State* dereferenceable(3376), i64, %struct.Memory*) local_unnamed_addr
...
entry:
  ...
  %call2_4020f4 = tail call %struct.Memory* @sub_402010._ZN16reverse_iteratorI14double_pointerdEmmEv(%struct.State* %0, i64 %53, %struct.Memory* %2)
  ...
  ret %struct.Memory* %call2_4020f4
}
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_callq_._ZN16reverse_iteratorI14double_pointerdEmmEv(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
