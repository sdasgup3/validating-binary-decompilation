...
define %struct.Memory* @_ZN16reverse_iteratorIS_I14double_pointerdEdEppEv(%struct.State* noalias, i64, %struct.Memory* noalias readnone returned) local_unnamed_addr #1 {
entry:
