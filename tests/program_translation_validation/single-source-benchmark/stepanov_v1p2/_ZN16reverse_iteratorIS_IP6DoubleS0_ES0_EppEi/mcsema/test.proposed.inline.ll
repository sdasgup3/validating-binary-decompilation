...
declare %struct.Memory* @sub_402320._ZN16reverse_iteratorIS_IP6DoubleS0_ES0_EppEv(%struct.State* dereferenceable(3376), i64, %struct.Memory*)

; Function Attrs: alwaysinline
define %struct.Memory* @_ZN16reverse_iteratorIS_IP6DoubleS0_ES0_EppEi(%struct.State* noalias, i64, %struct.Memory* noalias) #1 {
entry:
