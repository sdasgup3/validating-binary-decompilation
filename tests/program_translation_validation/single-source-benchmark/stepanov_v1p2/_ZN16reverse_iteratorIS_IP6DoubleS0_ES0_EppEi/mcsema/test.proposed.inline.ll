...
declare %struct.Memory* @sub_402310._ZN16reverse_iteratorIS_IP6DoubleS0_ES0_EppEv(%struct.State* noalias dereferenceable(3376), i64, %struct.Memory* noalias readnone returned)
...
entry:
  ...
  store %struct.Memory* %loadMem_402254, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_40225f, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_402263, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_402266, %struct.Memory** %MEMORY
  ...
  %call2_40226a = call %struct.Memory* @sub_402310._ZN16reverse_iteratorIS_IP6DoubleS0_ES0_EppEv(%struct.State* %0, i64 %loadPC_40226a, %struct.Memory* %loadMem2_40226a)
  ...
  store %struct.Memory* %loadMem_402277, %struct.Memory** %MEMORY
  ...
  ret %struct.Memory* %loadMem_40227f
}
