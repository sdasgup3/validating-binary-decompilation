...
declare %struct.Memory* @sub_402330._ZN16reverse_iteratorIS_IP6DoubleS0_ES0_EppEv(%struct.State* noalias dereferenceable(3376), i64, %struct.Memory* noalias readnone returned) local_unnamed_addr
...
entry:
  ...
  %call2_40228a = tail call %struct.Memory* @sub_402330._ZN16reverse_iteratorIS_IP6DoubleS0_ES0_EppEv(%struct.State* %0, i64 %63, %struct.Memory* %2)
  ...
  ret %struct.Memory* %call2_40228a
}
