...
define %struct.Memory* @_ZN16reverse_iteratorIS_IP6DoubleS0_ES0_EppEv(%struct.State* noalias, i64, %struct.Memory* noalias) #1 {
entry:
  ...
  store %struct.Memory* %loadMem1_402334, %struct.Memory** %MEMORY
  ...
  ret %struct.Memory* %loadMem_402349
}
