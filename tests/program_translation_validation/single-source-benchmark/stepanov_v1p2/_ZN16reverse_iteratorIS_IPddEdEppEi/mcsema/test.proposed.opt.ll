...
declare %struct.Memory* @sub_402520._ZN16reverse_iteratorIS_IPddEdEppEv(%struct.State* noalias dereferenceable(3376), i64, %struct.Memory* noalias readnone returned) local_unnamed_addr
...
entry:
  ...
  %call2_40247a = tail call %struct.Memory* @sub_402520._ZN16reverse_iteratorIS_IPddEdEppEv(%struct.State* %0, i64 %63, %struct.Memory* %2)
  ...
  ret %struct.Memory* %call2_40247a
}
