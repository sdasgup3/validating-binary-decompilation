...
entry:
  ...
  ; Code: ._ZNK14Double_pointerdeEv:	 RIP: 401de0	 Bytes: 0
  ...
  ; Code: movq %rdi, -0x8(%rbp)	 RIP: 401de4	 Bytes: 4
  %loadMem_401de4 = load %struct.Memory*, %struct.Memory** %MEMORY
  %call_401de4 = call %struct.Memory* @routine_movq__rdi__MINUS0x8__rbp_(%struct.State* %0, i64  0, %struct.Memory* %loadMem_401de4)
  store %struct.Memory* %call_401de4, %struct.Memory** %MEMORY

  ; Code: movq -0x8(%rbp), %rdi	 RIP: 401de8	 Bytes: 4
  %loadMem_401de8 = load %struct.Memory*, %struct.Memory** %MEMORY
  %call_401de8 = call %struct.Memory* @routine_movq_MINUS0x8__rbp____rdi(%struct.State* %0, i64  0, %struct.Memory* %loadMem_401de8)
  store %struct.Memory* %call_401de8, %struct.Memory** %MEMORY

  ; Code: movq (%rdi), %rax	 RIP: 401dec	 Bytes: 3
  %loadMem_401dec = load %struct.Memory*, %struct.Memory** %MEMORY
  %call_401dec = call %struct.Memory* @routine_movq___rdi____rax(%struct.State* %0, i64  0, %struct.Memory* %loadMem_401dec)
  store %struct.Memory* %call_401dec, %struct.Memory** %MEMORY

  ; Code: popq %rbp	 RIP: 401def	 Bytes: 1
  %loadMem_401def = load %struct.Memory*, %struct.Memory** %MEMORY
  %call_401def = call %struct.Memory* @routine_popq__rbp(%struct.State* %0, i64  0, %struct.Memory* %loadMem_401def)
  store %struct.Memory* %call_401def, %struct.Memory** %MEMORY

  ; Code: retq	 RIP: 401df0	 Bytes: 1
  %loadMem_401df0 = load %struct.Memory*, %struct.Memory** %MEMORY
  %call_401df0 = call %struct.Memory* @routine_retq(%struct.State* %0, i64  0, %struct.Memory* %loadMem_401df0)
  store %struct.Memory* %call_401df0, %struct.Memory** %MEMORY

  ret %struct.Memory* %call_401df0
}
