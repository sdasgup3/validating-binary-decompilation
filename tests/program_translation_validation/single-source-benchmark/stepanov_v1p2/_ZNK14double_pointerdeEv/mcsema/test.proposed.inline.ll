...
define %struct.Memory* @_ZNK14double_pointerdeEv(%struct.State* noalias, i64, %struct.Memory* noalias) #2 {
entry:
  ...
  store %struct.Memory* %loadMem_402091, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_40209c, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_40209f, %struct.Memory** %MEMORY
  ...
  ret %struct.Memory* %loadMem_4020a0
}
