...
entry:
  ...
  store %struct.Memory* %loadMem_401da0, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem1_401dbe, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem1_401dc6, %struct.Memory** %MEMORY
  ...
  ret %struct.Memory* %loadMem_401dd0
}
