...
define %struct.Memory* @_ZNK16reverse_iteratorIPddEdeEv(%struct.State* noalias , i64, %struct.Memory* noalias) alwaysinline  {
entry:
  ...
  ; Code: ._ZNK16reverse_iteratorIPddEdeEv:	 RIP: 4024f0	 Bytes: 0
  ...
  ; Code: movq %rdi, -0x8(%rbp)	 RIP: 4024f4	 Bytes: 4
  %loadMem_4024f4 = load %struct.Memory*, %struct.Memory** %MEMORY
  %call_4024f4 = call %struct.Memory* @routine_movq__rdi__MINUS0x8__rbp_(%struct.State* %0, i64  0, %struct.Memory* %loadMem_4024f4)
  store %struct.Memory* %call_4024f4, %struct.Memory** %MEMORY

  ; Code: movq -0x8(%rbp), %rdi	 RIP: 4024f8	 Bytes: 4
  %loadMem_4024f8 = load %struct.Memory*, %struct.Memory** %MEMORY
  %call_4024f8 = call %struct.Memory* @routine_movq_MINUS0x8__rbp____rdi(%struct.State* %0, i64  0, %struct.Memory* %loadMem_4024f8)
  store %struct.Memory* %call_4024f8, %struct.Memory** %MEMORY

  ; Code: movq (%rdi), %rdi	 RIP: 4024fc	 Bytes: 3
  %loadMem_4024fc = load %struct.Memory*, %struct.Memory** %MEMORY
  %call_4024fc = call %struct.Memory* @routine_movq___rdi____rdi(%struct.State* %0, i64  0, %struct.Memory* %loadMem_4024fc)
  store %struct.Memory* %call_4024fc, %struct.Memory** %MEMORY

  ; Code: movq %rdi, -0x10(%rbp)	 RIP: 4024ff	 Bytes: 4
  %loadMem_4024ff = load %struct.Memory*, %struct.Memory** %MEMORY
  %call_4024ff = call %struct.Memory* @routine_movq__rdi__MINUS0x10__rbp_(%struct.State* %0, i64  0, %struct.Memory* %loadMem_4024ff)
  store %struct.Memory* %call_4024ff, %struct.Memory** %MEMORY

  ; Code: movq -0x10(%rbp), %rdi	 RIP: 402503	 Bytes: 4
  %loadMem_402503 = load %struct.Memory*, %struct.Memory** %MEMORY
  %call_402503 = call %struct.Memory* @routine_movq_MINUS0x10__rbp____rdi(%struct.State* %0, i64  0, %struct.Memory* %loadMem_402503)
  store %struct.Memory* %call_402503, %struct.Memory** %MEMORY

  ; Code: addq $0xfffffff8, %rdi	 RIP: 402507	 Bytes: 4
  %loadMem_402507 = load %struct.Memory*, %struct.Memory** %MEMORY
  %call_402507 = call %struct.Memory* @routine_addq__0xfffffff8___rdi(%struct.State* %0, i64  0, %struct.Memory* %loadMem_402507)
  store %struct.Memory* %call_402507, %struct.Memory** %MEMORY

  ; Code: movq %rdi, -0x10(%rbp)	 RIP: 40250b	 Bytes: 4
  %loadMem_40250b = load %struct.Memory*, %struct.Memory** %MEMORY
  %call_40250b = call %struct.Memory* @routine_movq__rdi__MINUS0x10__rbp_(%struct.State* %0, i64  0, %struct.Memory* %loadMem_40250b)
  store %struct.Memory* %call_40250b, %struct.Memory** %MEMORY

  ; Code: movq %rdi, %rax	 RIP: 40250f	 Bytes: 3
  %loadMem_40250f = load %struct.Memory*, %struct.Memory** %MEMORY
  %call_40250f = call %struct.Memory* @routine_movq__rdi___rax(%struct.State* %0, i64  0, %struct.Memory* %loadMem_40250f)
  store %struct.Memory* %call_40250f, %struct.Memory** %MEMORY

  ; Code: popq %rbp	 RIP: 402512	 Bytes: 1
  %loadMem_402512 = load %struct.Memory*, %struct.Memory** %MEMORY
  %call_402512 = call %struct.Memory* @routine_popq__rbp(%struct.State* %0, i64  0, %struct.Memory* %loadMem_402512)
  store %struct.Memory* %call_402512, %struct.Memory** %MEMORY

  ; Code: retq	 RIP: 402513	 Bytes: 1
  %loadMem_402513 = load %struct.Memory*, %struct.Memory** %MEMORY
  %call_402513 = call %struct.Memory* @routine_retq(%struct.State* %0, i64  0, %struct.Memory* %loadMem_402513)
  store %struct.Memory* %call_402513, %struct.Memory** %MEMORY

  ret %struct.Memory* %call_402513
}
