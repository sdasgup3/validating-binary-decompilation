...
define %struct.Memory* @_ZNK16reverse_iteratorIS_IP6DoubleS0_ES0_EdeEv(%struct.State* noalias, i64, %struct.Memory* noalias) #1 {
entry:
  ...
  store %struct.Memory* %loadMem_4022a7, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem1_4022ae, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem1_4022b6, %struct.Memory** %MEMORY
  ...
  ret %struct.Memory* %loadMem_4022c0
}
