...
define %struct.Memory* @_ZNK16reverse_iteratorIS_IP6DoubleS0_ES0_EdeEv(%struct.State* noalias, i64, %struct.Memory* noalias) #2 {
entry:
  ...
  store %struct.Memory* %loadMem_4022b7, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_4022bb, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem1_4022be, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem1_4022c6, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_4022d0, %struct.Memory** %MEMORY
  ret %struct.Memory* %loadMem_4022d0
}
