...
define %struct.Memory* @_ZNK16reverse_iteratorIS_IP6DoubleS0_ES0_EdeEv(%struct.State* noalias, i64, %struct.Memory* noalias) local_unnamed_addr #1 {
entry:
  ...
  %call2_40229e = tail call %struct.Memory* @sub_4022c0._ZN16reverse_iteratorIP6DoubleS0_EmmEv(%struct.State* %0, i64 %58, %struct.Memory* %2)
  ...
  %call2_4022a6 = tail call %struct.Memory* @sub_4022e0._ZNK16reverse_iteratorIP6DoubleS0_EdeEv(%struct.State* %0, i64 %65, %struct.Memory* %call2_40229e)
  ...
  ret %struct.Memory* %call2_4022a6
}
