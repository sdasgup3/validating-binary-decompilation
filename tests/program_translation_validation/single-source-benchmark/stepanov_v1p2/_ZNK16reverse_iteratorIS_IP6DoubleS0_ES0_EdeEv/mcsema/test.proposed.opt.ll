...
define %struct.Memory* @_ZNK16reverse_iteratorIS_IP6DoubleS0_ES0_EdeEv(%struct.State* noalias, i64, %struct.Memory* noalias readnone returned) local_unnamed_addr #1 {
entry:
  ...
  %call2_4022be = tail call %struct.Memory* @sub_4022e0._ZN16reverse_iteratorIP6DoubleS0_EmmEv(%struct.State* %0, i64 %59, %struct.Memory* %2)
  ...
  %call2_4022c6 = tail call %struct.Memory* @sub_402300._ZNK16reverse_iteratorIP6DoubleS0_EdeEv(%struct.State* %0, i64 %66, %struct.Memory* %call2_4022be)
  ...
  ret %struct.Memory* %call2_4022c6
}
