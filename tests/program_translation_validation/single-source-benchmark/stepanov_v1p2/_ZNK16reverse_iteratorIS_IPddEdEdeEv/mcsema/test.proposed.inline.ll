...
declare %struct.Memory* @sub_4024c0._ZN16reverse_iteratorIPddEmmEv(%struct.State* noalias dereferenceable(3376), i64, %struct.Memory* noalias readnone returned)
...
define %struct.Memory* @_ZNK16reverse_iteratorIS_IPddEdEdeEv(%struct.State* noalias, i64, %struct.Memory* noalias) #2 {
entry:
  ...
  store i64 %91, i64* %94
  store %struct.Memory* %loadMem_40248c, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_402490, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_402494, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_40249b, %struct.Memory** %MEMORY
  %loadMem1_40249e = load %struct.Memory*, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem1_40249e, %struct.Memory** %MEMORY
  %loadMem2_40249e = load %struct.Memory*, %struct.Memory** %MEMORY
  %loadPC_40249e = load i64, i64* %3
  %call2_40249e = call %struct.Memory* @sub_4024c0._ZN16reverse_iteratorIPddEmmEv(%struct.State* %0, i64 %loadPC_40249e, %struct.Memory* %loadMem2_40249e)
  store %struct.Memory* %call2_40249e, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_4024a3, %struct.Memory** %MEMORY
  %loadMem1_4024a6 = load %struct.Memory*, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem1_4024a6, %struct.Memory** %MEMORY
  %loadMem2_4024a6 = load %struct.Memory*, %struct.Memory** %MEMORY
  %loadPC_4024a6 = load i64, i64* %3
  %call2_4024a6 = call %struct.Memory* @sub_4024e0._ZNK16reverse_iteratorIPddEdeEv(%struct.State* %0, i64 %loadPC_4024a6, %struct.Memory* %loadMem2_4024a6)
  store %struct.Memory* %call2_4024a6, %struct.Memory** %MEMORY
  ...
  ret %struct.Memory* %loadMem_4024b0
}
...
define %struct.Memory* @routine_callq_._ZN16reverse_iteratorIPddEmmEv(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) {
block_400478:
  %3 = getelementptr inbounds %struct.State, %struct.State* %0, i32 0, i32 6
  %4 = getelementptr inbounds %struct.GPR, %struct.GPR* %3, i32 0, i32 33
  %5 = getelementptr inbounds %struct.Reg, %struct.Reg* %4, i32 0, i32 0
