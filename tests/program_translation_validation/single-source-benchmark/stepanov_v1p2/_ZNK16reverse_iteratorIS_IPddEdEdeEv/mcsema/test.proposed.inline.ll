...
declare %struct.Memory* @sub_4024d0._ZN16reverse_iteratorIPddEmmEv(%struct.State* dereferenceable(3376), i64, %struct.Memory*)
...
define %struct.Memory* @_ZNK16reverse_iteratorIS_IPddEdEdeEv(%struct.State* noalias, i64, %struct.Memory* noalias) #1 {
entry:
