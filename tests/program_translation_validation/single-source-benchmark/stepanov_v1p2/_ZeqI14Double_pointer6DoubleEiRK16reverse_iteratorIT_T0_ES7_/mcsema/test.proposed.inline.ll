...
define %struct.Memory* @_ZeqI14Double_pointer6DoubleEiRK16reverse_iteratorIT_T0_ES7_(%struct.State* noalias, i64, %struct.Memory* noalias) #2 {
entry:
  ...
  store %struct.Memory* %loadMem1_401e98, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_401ea1, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_401ea2, %struct.Memory** %MEMORY
  ret %struct.Memory* %loadMem_401ea2
}
