...
declare %struct.Memory* @sub_402160._ZeqRK14double_pointerS1_(%struct.State* noalias dereferenceable(3376), i64, %struct.Memory* noalias readnone returned)
...
entry:
  ...
  store %struct.Memory* %loadMem1_402148, %struct.Memory** %MEMORY
  %loadMem2_402148 = load %struct.Memory*, %struct.Memory** %MEMORY
  %loadPC_402148 = load i64, i64* %3
  %call2_402148 = call %struct.Memory* @sub_402160._ZeqRK14double_pointerS1_(%struct.State* %0, i64 %loadPC_402148, %struct.Memory* %loadMem2_402148)
  ...
  store %struct.Memory* %loadMem_40214d, %struct.Memory** %MEMORY
  ...
  ret %struct.Memory* %loadMem_402152
}
