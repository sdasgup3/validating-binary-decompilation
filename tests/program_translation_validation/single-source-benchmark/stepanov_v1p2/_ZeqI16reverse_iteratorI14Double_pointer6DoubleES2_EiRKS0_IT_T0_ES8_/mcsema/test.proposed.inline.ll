...
define %struct.Memory* @_ZeqI16reverse_iteratorI14Double_pointer6DoubleES2_EiRKS0_IT_T0_ES8_(%struct.State* noalias, i64, %struct.Memory* noalias) #1 {
entry:
  ...
  store %struct.Memory* %loadMem1_401e78, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_401e7d, %struct.Memory** %MEMORY
  ...
  ret %struct.Memory* %loadMem_401e82
}
