...
entry:
  ...
  %loadMem1_402118 = load %struct.Memory*, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem1_402118, %struct.Memory** %MEMORY
  %loadMem2_402118 = load %struct.Memory*, %struct.Memory** %MEMORY
  %loadPC_402118 = load i64, i64* %3
  %call2_402118 = call %struct.Memory* @sub_402130._ZeqI14double_pointerdEiRK16reverse_iteratorIT_T0_ES6_(%struct.State* %0, i64 %loadPC_402118, %struct.Memory* %loadMem2_402118)
  store %struct.Memory* %call2_402118, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_40211d, %struct.Memory** %MEMORY
  ...
  ret %struct.Memory* %loadMem_402122
}
