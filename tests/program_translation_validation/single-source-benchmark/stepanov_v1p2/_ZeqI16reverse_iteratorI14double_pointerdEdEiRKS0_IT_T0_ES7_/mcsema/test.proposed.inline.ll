...
entry:
  ...
  store i64 %78, i64* %81
  store %struct.Memory* %loadMem_402128, %struct.Memory** %MEMORY
  ...
  store i64 %93, i64* %96
  store %struct.Memory* %loadMem_40212c, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem1_402138, %struct.Memory** %MEMORY
  %loadMem2_402138 = load %struct.Memory*, %struct.Memory** %MEMORY
  %loadPC_402138 = load i64, i64* %3
  %call2_402138 = call %struct.Memory* @sub_402150._ZeqI14double_pointerdEiRK16reverse_iteratorIT_T0_ES6_(%struct.State* %0, i64 %loadPC_402138, %struct.Memory* %loadMem2_402138)
  ...
  store %struct.Memory* %loadMem_402141, %struct.Memory** %MEMORY
  ...
  ret %struct.Memory* %loadMem_402142
}
