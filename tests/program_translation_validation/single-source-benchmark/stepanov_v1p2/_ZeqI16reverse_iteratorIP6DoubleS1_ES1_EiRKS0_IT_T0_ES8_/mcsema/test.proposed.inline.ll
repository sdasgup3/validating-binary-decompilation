...
entry:
  ...
  store %struct.Memory* %loadMem_402340, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_402344, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem1_402358, %struct.Memory** %MEMORY
  %loadMem2_402358 = load %struct.Memory*, %struct.Memory** %MEMORY
  %loadPC_402358 = load i64, i64* %3
  %call2_402358 = call %struct.Memory* @sub_402370._ZeqIP6DoubleS0_EiRK16reverse_iteratorIT_T0_ES7_(%struct.State* %0, i64 %loadPC_402358, %struct.Memory* %loadMem2_402358)
  ...
  ret %struct.Memory* %loadMem_402362
}
