...
define %struct.Memory* @_ZeqI16reverse_iteratorIPddEdEiRKS0_IT_T0_ES7_(%struct.State* noalias, i64, %struct.Memory* noalias) #1 {
entry:
  ...
  store %struct.Memory* %loadMem1_402568, %struct.Memory** %MEMORY
  ...
  ret %struct.Memory* %loadMem_402572
}
