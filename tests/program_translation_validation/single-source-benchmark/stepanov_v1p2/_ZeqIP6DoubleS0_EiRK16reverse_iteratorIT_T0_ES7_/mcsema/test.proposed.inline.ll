...
define %struct.Memory* @_ZeqIP6DoubleS0_EiRK16reverse_iteratorIT_T0_ES7_(%struct.State* noalias, i64, %struct.Memory* noalias) #1 {
entry:
  ...
  ret %struct.Memory* %loadMem_4023a3
}
