...
define %struct.Memory* @_ZeqIP6DoubleS0_EiRK16reverse_iteratorIT_T0_ES7_(%struct.State* noalias, i64, %struct.Memory* noalias) #2 {
entry:
  ...
  store %struct.Memory* %loadMem_4023b3, %struct.Memory** %MEMORY
  ret %struct.Memory* %loadMem_4023b3
}
