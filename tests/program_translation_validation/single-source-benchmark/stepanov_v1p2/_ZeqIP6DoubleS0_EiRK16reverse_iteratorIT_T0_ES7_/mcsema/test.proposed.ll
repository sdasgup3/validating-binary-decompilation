...
define %struct.Memory* @_ZeqIP6DoubleS0_EiRK16reverse_iteratorIT_T0_ES7_(%struct.State* noalias , i64, %struct.Memory* noalias) alwaysinline  {
entry:
  ...
  ; Code: ._ZeqIP6DoubleS0_EiRK16reverse_iteratorIT_T0_ES7_:	 RIP: 402370	 Bytes: 0
  ; Code: pushq %rbp	 RIP: 402370	 Bytes: 1
  %loadMem_402370 = load %struct.Memory*, %struct.Memory** %MEMORY
  %call_402370 = call %struct.Memory* @routine_pushq__rbp(%struct.State* %0, i64  0, %struct.Memory* %loadMem_402370)
  store %struct.Memory* %call_402370, %struct.Memory** %MEMORY

  ; Code: movq %rsp, %rbp	 RIP: 402371	 Bytes: 3
  %loadMem_402371 = load %struct.Memory*, %struct.Memory** %MEMORY
  %call_402371 = call %struct.Memory* @routine_movq__rsp___rbp(%struct.State* %0, i64  0, %struct.Memory* %loadMem_402371)
  store %struct.Memory* %call_402371, %struct.Memory** %MEMORY

  ; Code: movq %rdi, -0x8(%rbp)	 RIP: 402374	 Bytes: 4
  %loadMem_402374 = load %struct.Memory*, %struct.Memory** %MEMORY
  %call_402374 = call %struct.Memory* @routine_movq__rdi__MINUS0x8__rbp_(%struct.State* %0, i64  0, %struct.Memory* %loadMem_402374)
  store %struct.Memory* %call_402374, %struct.Memory** %MEMORY

  ; Code: movq %rsi, -0x10(%rbp)	 RIP: 402378	 Bytes: 4
  %loadMem_402378 = load %struct.Memory*, %struct.Memory** %MEMORY
  %call_402378 = call %struct.Memory* @routine_movq__rsi__MINUS0x10__rbp_(%struct.State* %0, i64  0, %struct.Memory* %loadMem_402378)
  store %struct.Memory* %call_402378, %struct.Memory** %MEMORY

  ; Code: movq -0x8(%rbp), %rsi	 RIP: 40237c	 Bytes: 4
  %loadMem_40237c = load %struct.Memory*, %struct.Memory** %MEMORY
  %call_40237c = call %struct.Memory* @routine_movq_MINUS0x8__rbp____rsi(%struct.State* %0, i64  0, %struct.Memory* %loadMem_40237c)
  store %struct.Memory* %call_40237c, %struct.Memory** %MEMORY

  ; Code: movq (%rsi), %rsi	 RIP: 402380	 Bytes: 3
  %loadMem_402380 = load %struct.Memory*, %struct.Memory** %MEMORY
  %call_402380 = call %struct.Memory* @routine_movq___rsi____rsi(%struct.State* %0, i64  0, %struct.Memory* %loadMem_402380)
  store %struct.Memory* %call_402380, %struct.Memory** %MEMORY

  ; Code: movq -0x10(%rbp), %rdi	 RIP: 402383	 Bytes: 4
  %loadMem_402383 = load %struct.Memory*, %struct.Memory** %MEMORY
  %call_402383 = call %struct.Memory* @routine_movq_MINUS0x10__rbp____rdi(%struct.State* %0, i64  0, %struct.Memory* %loadMem_402383)
  store %struct.Memory* %call_402383, %struct.Memory** %MEMORY

  ; Code: cmpq (%rdi), %rsi	 RIP: 402387	 Bytes: 3
  %loadMem_402387 = load %struct.Memory*, %struct.Memory** %MEMORY
  %call_402387 = call %struct.Memory* @routine_cmpq___rdi____rsi(%struct.State* %0, i64  0, %struct.Memory* %loadMem_402387)
  store %struct.Memory* %call_402387, %struct.Memory** %MEMORY

  ; Code: sete %al	 RIP: 40238a	 Bytes: 3
  %loadMem_40238a = load %struct.Memory*, %struct.Memory** %MEMORY
  %call_40238a = call %struct.Memory* @routine_sete__al(%struct.State* %0, i64  0, %struct.Memory* %loadMem_40238a)
  store %struct.Memory* %call_40238a, %struct.Memory** %MEMORY

  ; Code: andb $0x1, %al	 RIP: 40238d	 Bytes: 2
  %loadMem_40238d = load %struct.Memory*, %struct.Memory** %MEMORY
  %call_40238d = call %struct.Memory* @routine_andb__0x1___al(%struct.State* %0, i64  0, %struct.Memory* %loadMem_40238d)
  store %struct.Memory* %call_40238d, %struct.Memory** %MEMORY

  ; Code: movzbl %al, %eax	 RIP: 40238f	 Bytes: 3
  %loadMem_40238f = load %struct.Memory*, %struct.Memory** %MEMORY
  %call_40238f = call %struct.Memory* @routine_movzbl__al___eax(%struct.State* %0, i64  0, %struct.Memory* %loadMem_40238f)
  store %struct.Memory* %call_40238f, %struct.Memory** %MEMORY

  ; Code: popq %rbp	 RIP: 402392	 Bytes: 1
  %loadMem_402392 = load %struct.Memory*, %struct.Memory** %MEMORY
  %call_402392 = call %struct.Memory* @routine_popq__rbp(%struct.State* %0, i64  0, %struct.Memory* %loadMem_402392)
  store %struct.Memory* %call_402392, %struct.Memory** %MEMORY

  ; Code: retq	 RIP: 402393	 Bytes: 1
  %loadMem_402393 = load %struct.Memory*, %struct.Memory** %MEMORY
  %call_402393 = call %struct.Memory* @routine_retq(%struct.State* %0, i64  0, %struct.Memory* %loadMem_402393)
  store %struct.Memory* %call_402393, %struct.Memory** %MEMORY

  ret %struct.Memory* %call_402393
}
