...
entry:
  ...
  ; Code: ._ZeqIPddEiRK16reverse_iteratorIT_T0_ES6_:	 RIP: 402570	 Bytes: 0
  ; Code: pushq %rbp	 RIP: 402570	 Bytes: 1
  %loadMem_402570 = load %struct.Memory*, %struct.Memory** %MEMORY
  %call_402570 = call %struct.Memory* @routine_pushq__rbp(%struct.State* %0, i64  0, %struct.Memory* %loadMem_402570)
  store %struct.Memory* %call_402570, %struct.Memory** %MEMORY

  ; Code: movq %rsp, %rbp	 RIP: 402571	 Bytes: 3
  %loadMem_402571 = load %struct.Memory*, %struct.Memory** %MEMORY
  %call_402571 = call %struct.Memory* @routine_movq__rsp___rbp(%struct.State* %0, i64  0, %struct.Memory* %loadMem_402571)
  store %struct.Memory* %call_402571, %struct.Memory** %MEMORY

  ; Code: movq %rdi, -0x8(%rbp)	 RIP: 402574	 Bytes: 4
  %loadMem_402574 = load %struct.Memory*, %struct.Memory** %MEMORY
  %call_402574 = call %struct.Memory* @routine_movq__rdi__MINUS0x8__rbp_(%struct.State* %0, i64  0, %struct.Memory* %loadMem_402574)
  store %struct.Memory* %call_402574, %struct.Memory** %MEMORY

  ; Code: movq %rsi, -0x10(%rbp)	 RIP: 402578	 Bytes: 4
  %loadMem_402578 = load %struct.Memory*, %struct.Memory** %MEMORY
  %call_402578 = call %struct.Memory* @routine_movq__rsi__MINUS0x10__rbp_(%struct.State* %0, i64  0, %struct.Memory* %loadMem_402578)
  store %struct.Memory* %call_402578, %struct.Memory** %MEMORY

  ; Code: movq -0x8(%rbp), %rsi	 RIP: 40257c	 Bytes: 4
  %loadMem_40257c = load %struct.Memory*, %struct.Memory** %MEMORY
  %call_40257c = call %struct.Memory* @routine_movq_MINUS0x8__rbp____rsi(%struct.State* %0, i64  0, %struct.Memory* %loadMem_40257c)
  store %struct.Memory* %call_40257c, %struct.Memory** %MEMORY

  ; Code: movq (%rsi), %rsi	 RIP: 402580	 Bytes: 3
  %loadMem_402580 = load %struct.Memory*, %struct.Memory** %MEMORY
  %call_402580 = call %struct.Memory* @routine_movq___rsi____rsi(%struct.State* %0, i64  0, %struct.Memory* %loadMem_402580)
  store %struct.Memory* %call_402580, %struct.Memory** %MEMORY

  ; Code: movq -0x10(%rbp), %rdi	 RIP: 402583	 Bytes: 4
  %loadMem_402583 = load %struct.Memory*, %struct.Memory** %MEMORY
  %call_402583 = call %struct.Memory* @routine_movq_MINUS0x10__rbp____rdi(%struct.State* %0, i64  0, %struct.Memory* %loadMem_402583)
  store %struct.Memory* %call_402583, %struct.Memory** %MEMORY

  ; Code: cmpq (%rdi), %rsi	 RIP: 402587	 Bytes: 3
  %loadMem_402587 = load %struct.Memory*, %struct.Memory** %MEMORY
  %call_402587 = call %struct.Memory* @routine_cmpq___rdi____rsi(%struct.State* %0, i64  0, %struct.Memory* %loadMem_402587)
  store %struct.Memory* %call_402587, %struct.Memory** %MEMORY

  ; Code: sete %al	 RIP: 40258a	 Bytes: 3
  %loadMem_40258a = load %struct.Memory*, %struct.Memory** %MEMORY
  %call_40258a = call %struct.Memory* @routine_sete__al(%struct.State* %0, i64  0, %struct.Memory* %loadMem_40258a)
  store %struct.Memory* %call_40258a, %struct.Memory** %MEMORY

  ; Code: andb $0x1, %al	 RIP: 40258d	 Bytes: 2
  %loadMem_40258d = load %struct.Memory*, %struct.Memory** %MEMORY
  %call_40258d = call %struct.Memory* @routine_andb__0x1___al(%struct.State* %0, i64  0, %struct.Memory* %loadMem_40258d)
  store %struct.Memory* %call_40258d, %struct.Memory** %MEMORY

  ; Code: movzbl %al, %eax	 RIP: 40258f	 Bytes: 3
  %loadMem_40258f = load %struct.Memory*, %struct.Memory** %MEMORY
  %call_40258f = call %struct.Memory* @routine_movzbl__al___eax(%struct.State* %0, i64  0, %struct.Memory* %loadMem_40258f)
  store %struct.Memory* %call_40258f, %struct.Memory** %MEMORY

  ; Code: popq %rbp	 RIP: 402592	 Bytes: 1
  %loadMem_402592 = load %struct.Memory*, %struct.Memory** %MEMORY
  %call_402592 = call %struct.Memory* @routine_popq__rbp(%struct.State* %0, i64  0, %struct.Memory* %loadMem_402592)
  store %struct.Memory* %call_402592, %struct.Memory** %MEMORY

  ; Code: retq	 RIP: 402593	 Bytes: 1
  %loadMem_402593 = load %struct.Memory*, %struct.Memory** %MEMORY
  %call_402593 = call %struct.Memory* @routine_retq(%struct.State* %0, i64  0, %struct.Memory* %loadMem_402593)
  store %struct.Memory* %call_402593, %struct.Memory** %MEMORY

  ret %struct.Memory* %call_402593
}
