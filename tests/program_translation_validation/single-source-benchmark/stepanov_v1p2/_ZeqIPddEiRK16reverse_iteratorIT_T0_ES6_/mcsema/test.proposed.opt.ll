...
define %struct.Memory* @_ZeqIPddEiRK16reverse_iteratorIT_T0_ES6_(%struct.State* noalias nocapture, i64, %struct.Memory* noalias readnone returned) local_unnamed_addr #1 {
entry:
