...
define %struct.Memory* @_ZeqRK14Double_pointerS1_(%struct.State* noalias, i64, %struct.Memory* noalias) #2 {
entry:
  ...
  store i64 %55, i64* %58
  store %struct.Memory* %loadMem_401eb8, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_401ec3, %struct.Memory** %MEMORY
  ...
  %loadMem_401ecd = load %struct.Memory*, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_401ecd, %struct.Memory** %MEMORY
  ...
  ret %struct.Memory* %loadMem_401ed3
}
