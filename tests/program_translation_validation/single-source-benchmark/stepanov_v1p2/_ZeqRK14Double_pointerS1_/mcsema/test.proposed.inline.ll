...
define %struct.Memory* @_ZeqRK14Double_pointerS1_(%struct.State* noalias, i64, %struct.Memory* noalias) #1 {
entry:
  ...
  store %struct.Memory* %loadMem_401edd, %struct.Memory** %MEMORY
  ...
  ret %struct.Memory* %loadMem_401ee3
}
