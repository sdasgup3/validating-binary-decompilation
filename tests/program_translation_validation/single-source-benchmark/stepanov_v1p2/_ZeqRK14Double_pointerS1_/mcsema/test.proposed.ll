...
entry:
  ...
  ; Code: ._ZeqRK14Double_pointerS1_:	 RIP: 401eb0	 Bytes: 0
  ...
  ; Code: movq %rdi, -0x8(%rbp)	 RIP: 401eb4	 Bytes: 4
  %loadMem_401eb4 = load %struct.Memory*, %struct.Memory** %MEMORY
  %call_401eb4 = call %struct.Memory* @routine_movq__rdi__MINUS0x8__rbp_(%struct.State* %0, i64  0, %struct.Memory* %loadMem_401eb4)
  store %struct.Memory* %call_401eb4, %struct.Memory** %MEMORY

  ; Code: movq %rsi, -0x10(%rbp)	 RIP: 401eb8	 Bytes: 4
  %loadMem_401eb8 = load %struct.Memory*, %struct.Memory** %MEMORY
  %call_401eb8 = call %struct.Memory* @routine_movq__rsi__MINUS0x10__rbp_(%struct.State* %0, i64  0, %struct.Memory* %loadMem_401eb8)
  store %struct.Memory* %call_401eb8, %struct.Memory** %MEMORY

  ; Code: movq -0x8(%rbp), %rsi	 RIP: 401ebc	 Bytes: 4
  %loadMem_401ebc = load %struct.Memory*, %struct.Memory** %MEMORY
  %call_401ebc = call %struct.Memory* @routine_movq_MINUS0x8__rbp____rsi(%struct.State* %0, i64  0, %struct.Memory* %loadMem_401ebc)
  store %struct.Memory* %call_401ebc, %struct.Memory** %MEMORY

  ; Code: movq (%rsi), %rsi	 RIP: 401ec0	 Bytes: 3
  %loadMem_401ec0 = load %struct.Memory*, %struct.Memory** %MEMORY
  %call_401ec0 = call %struct.Memory* @routine_movq___rsi____rsi(%struct.State* %0, i64  0, %struct.Memory* %loadMem_401ec0)
  store %struct.Memory* %call_401ec0, %struct.Memory** %MEMORY

  ; Code: movq -0x10(%rbp), %rdi	 RIP: 401ec3	 Bytes: 4
  %loadMem_401ec3 = load %struct.Memory*, %struct.Memory** %MEMORY
  %call_401ec3 = call %struct.Memory* @routine_movq_MINUS0x10__rbp____rdi(%struct.State* %0, i64  0, %struct.Memory* %loadMem_401ec3)
  store %struct.Memory* %call_401ec3, %struct.Memory** %MEMORY

  ; Code: cmpq (%rdi), %rsi	 RIP: 401ec7	 Bytes: 3
  %loadMem_401ec7 = load %struct.Memory*, %struct.Memory** %MEMORY
  %call_401ec7 = call %struct.Memory* @routine_cmpq___rdi____rsi(%struct.State* %0, i64  0, %struct.Memory* %loadMem_401ec7)
  store %struct.Memory* %call_401ec7, %struct.Memory** %MEMORY

  ; Code: sete %al	 RIP: 401eca	 Bytes: 3
  %loadMem_401eca = load %struct.Memory*, %struct.Memory** %MEMORY
  %call_401eca = call %struct.Memory* @routine_sete__al(%struct.State* %0, i64  0, %struct.Memory* %loadMem_401eca)
  store %struct.Memory* %call_401eca, %struct.Memory** %MEMORY

  ; Code: andb $0x1, %al	 RIP: 401ecd	 Bytes: 2
  %loadMem_401ecd = load %struct.Memory*, %struct.Memory** %MEMORY
  %call_401ecd = call %struct.Memory* @routine_andb__0x1___al(%struct.State* %0, i64  0, %struct.Memory* %loadMem_401ecd)
  store %struct.Memory* %call_401ecd, %struct.Memory** %MEMORY

  ; Code: movzbl %al, %eax	 RIP: 401ecf	 Bytes: 3
  %loadMem_401ecf = load %struct.Memory*, %struct.Memory** %MEMORY
  %call_401ecf = call %struct.Memory* @routine_movzbl__al___eax(%struct.State* %0, i64  0, %struct.Memory* %loadMem_401ecf)
  store %struct.Memory* %call_401ecf, %struct.Memory** %MEMORY

  ; Code: popq %rbp	 RIP: 401ed2	 Bytes: 1
  %loadMem_401ed2 = load %struct.Memory*, %struct.Memory** %MEMORY
  %call_401ed2 = call %struct.Memory* @routine_popq__rbp(%struct.State* %0, i64  0, %struct.Memory* %loadMem_401ed2)
  store %struct.Memory* %call_401ed2, %struct.Memory** %MEMORY

  ; Code: retq	 RIP: 401ed3	 Bytes: 1
  %loadMem_401ed3 = load %struct.Memory*, %struct.Memory** %MEMORY
  %call_401ed3 = call %struct.Memory* @routine_retq(%struct.State* %0, i64  0, %struct.Memory* %loadMem_401ed3)
  store %struct.Memory* %call_401ed3, %struct.Memory** %MEMORY

  ret %struct.Memory* %call_401ed3
}
