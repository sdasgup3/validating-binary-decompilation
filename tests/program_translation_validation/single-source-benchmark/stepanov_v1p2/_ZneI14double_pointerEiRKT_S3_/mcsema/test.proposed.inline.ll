...
define %struct.Memory* @_ZneI14double_pointerEiRKT_S3_(%struct.State* noalias, i64, %struct.Memory* noalias) #1 {
entry:
  ...
  store %struct.Memory* %loadMem1_402b68, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_402b73, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_402b79, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_402b81, %struct.Memory** %MEMORY
  ret %struct.Memory* %loadMem_402b81
}
