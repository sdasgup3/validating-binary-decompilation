...
declare %struct.Memory* @sub_401e80._ZeqI14Double_pointer6DoubleEiRK16reverse_iteratorIT_T0_ES7_(%struct.State* noalias dereferenceable(3376), i64, %struct.Memory* noalias readnone returned)
...
entry:
  ...
  store %struct.Memory* %loadMem_402621, %struct.Memory** %MEMORY
  ...
  %loadMem1_402638 = load %struct.Memory*, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem1_402638, %struct.Memory** %MEMORY
  %loadMem2_402638 = load %struct.Memory*, %struct.Memory** %MEMORY
  %loadPC_402638 = load i64, i64* %3
  %call2_402638 = call %struct.Memory* @sub_401e80._ZeqI14Double_pointer6DoubleEiRK16reverse_iteratorIT_T0_ES7_(%struct.State* %0, i64 %loadPC_402638, %struct.Memory* %loadMem2_402638)
  store %struct.Memory* %call2_402638, %struct.Memory** %MEMORY
  ...
  ret %struct.Memory* %loadMem_402651
}
