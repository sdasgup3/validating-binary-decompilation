...
define %struct.Memory* @_ZneI16reverse_iteratorI14double_pointerdEEiRKT_S5_(%struct.State* noalias, i64, %struct.Memory* noalias) #1 {
entry:
  ...
  store %struct.Memory* %loadMem1_402758, %struct.Memory** %MEMORY
  ...
  ret %struct.Memory* %loadMem_402771
}
