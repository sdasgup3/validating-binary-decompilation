...
define %struct.Memory* @_ZneI16reverse_iteratorIP6DoubleS1_EEiRKT_S6_(%struct.State* noalias, i64, %struct.Memory* noalias) #1 {
entry:
  ...
  store %struct.Memory* %loadMem1_402878, %struct.Memory** %MEMORY
  ...
  ret %struct.Memory* %loadMem_402891
}
