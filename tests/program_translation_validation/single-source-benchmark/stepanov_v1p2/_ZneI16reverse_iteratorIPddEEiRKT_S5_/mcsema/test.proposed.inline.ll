...
declare %struct.Memory* @sub_402580._ZeqIPddEiRK16reverse_iteratorIT_T0_ES6_(%struct.State* dereferenceable(3376), i64, %struct.Memory*)

; Function Attrs: alwaysinline
define %struct.Memory* @_ZneI16reverse_iteratorIPddEEiRKT_S5_(%struct.State* noalias, i64, %struct.Memory* noalias) #1 {
entry:
