...
entry:
  ...
  ; Code: ._ZneI16reverse_iteratorIPddEEiRKT_S5_:	 RIP: 402950	 Bytes: 0
  ...
  ; Code: subq $0x10, %rsp	 RIP: 402954	 Bytes: 4
  %loadMem_402954 = load %struct.Memory*, %struct.Memory** %MEMORY
  %call_402954 = call %struct.Memory* @routine_subq__0x10___rsp(%struct.State* %0, i64  0, %struct.Memory* %loadMem_402954)
  ...
  ; Code: movq -0x8(%rbp), %rdi	 RIP: 402960	 Bytes: 4
  %loadMem_402960 = load %struct.Memory*, %struct.Memory** %MEMORY
  %call_402960 = call %struct.Memory* @routine_movq_MINUS0x8__rbp____rdi(%struct.State* %0, i64  0, %struct.Memory* %loadMem_402960)
  store %struct.Memory* %call_402960, %struct.Memory** %MEMORY

  ; Code: movq -0x10(%rbp), %rsi	 RIP: 402964	 Bytes: 4
  %loadMem_402964 = load %struct.Memory*, %struct.Memory** %MEMORY
  %call_402964 = call %struct.Memory* @routine_movq_MINUS0x10__rbp____rsi(%struct.State* %0, i64  0, %struct.Memory* %loadMem_402964)
  store %struct.Memory* %call_402964, %struct.Memory** %MEMORY

  ; Code: callq ._ZeqIPddEiRK16reverse_iteratorIT_T0_ES6_	 RIP: 402968	 Bytes: 5
  %loadMem1_402968 = load %struct.Memory*, %struct.Memory** %MEMORY
  %call1_402968 = call %struct.Memory* @routine_callq_._ZeqIPddEiRK16reverse_iteratorIT_T0_ES6_(%struct.State* %0, i64  0, %struct.Memory* %loadMem1_402968, i64 -1016, i64 5, i64 5)
  store %struct.Memory* %call1_402968, %struct.Memory** %MEMORY
  ...
  ; Code: cmpl $0x0, %eax	 RIP: 40296d	 Bytes: 3
  %loadMem_40296d = load %struct.Memory*, %struct.Memory** %MEMORY
  %call_40296d = call %struct.Memory* @routine_cmpl__0x0___eax(%struct.State* %0, i64  0, %struct.Memory* %loadMem_40296d)
  store %struct.Memory* %call_40296d, %struct.Memory** %MEMORY

  ; Code: setne %cl	 RIP: 402970	 Bytes: 3
  %loadMem_402970 = load %struct.Memory*, %struct.Memory** %MEMORY
  %call_402970 = call %struct.Memory* @routine_setne__cl(%struct.State* %0, i64  0, %struct.Memory* %loadMem_402970)
  store %struct.Memory* %call_402970, %struct.Memory** %MEMORY

  ; Code: xorb $0xff, %cl	 RIP: 402973	 Bytes: 3
  %loadMem_402973 = load %struct.Memory*, %struct.Memory** %MEMORY
  %call_402973 = call %struct.Memory* @routine_xorb__0xff___cl(%struct.State* %0, i64  0, %struct.Memory* %loadMem_402973)
  store %struct.Memory* %call_402973, %struct.Memory** %MEMORY

  ; Code: andb $0x1, %cl	 RIP: 402976	 Bytes: 3
  %loadMem_402976 = load %struct.Memory*, %struct.Memory** %MEMORY
  %call_402976 = call %struct.Memory* @routine_andb__0x1___cl(%struct.State* %0, i64  0, %struct.Memory* %loadMem_402976)
  store %struct.Memory* %call_402976, %struct.Memory** %MEMORY

  ; Code: movzbl %cl, %eax	 RIP: 402979	 Bytes: 3
  %loadMem_402979 = load %struct.Memory*, %struct.Memory** %MEMORY
  %call_402979 = call %struct.Memory* @routine_movzbl__cl___eax(%struct.State* %0, i64  0, %struct.Memory* %loadMem_402979)
  store %struct.Memory* %call_402979, %struct.Memory** %MEMORY

  ; Code: addq $0x10, %rsp	 RIP: 40297c	 Bytes: 4
  %loadMem_40297c = load %struct.Memory*, %struct.Memory** %MEMORY
  %call_40297c = call %struct.Memory* @routine_addq__0x10___rsp(%struct.State* %0, i64  0, %struct.Memory* %loadMem_40297c)
  store %struct.Memory* %call_40297c, %struct.Memory** %MEMORY

  ; Code: popq %rbp	 RIP: 402980	 Bytes: 1
  %loadMem_402980 = load %struct.Memory*, %struct.Memory** %MEMORY
  %call_402980 = call %struct.Memory* @routine_popq__rbp(%struct.State* %0, i64  0, %struct.Memory* %loadMem_402980)
  store %struct.Memory* %call_402980, %struct.Memory** %MEMORY

  ; Code: retq	 RIP: 402981	 Bytes: 1
  %loadMem_402981 = load %struct.Memory*, %struct.Memory** %MEMORY
  %call_402981 = call %struct.Memory* @routine_retq(%struct.State* %0, i64  0, %struct.Memory* %loadMem_402981)
  store %struct.Memory* %call_402981, %struct.Memory** %MEMORY

  ret %struct.Memory* %call_402981
}
