...
declare %struct.Memory* @sub_402340._ZeqI16reverse_iteratorIP6DoubleS1_ES1_EiRKS0_IT_T0_ES8_(%struct.State* noalias dereferenceable(3376), i64, %struct.Memory* noalias readnone returned)
...
entry:
  ...
  store i64 %78, i64* %81
  store %struct.Memory* %loadMem_402218, %struct.Memory** %MEMORY
  ...
  store i64 %93, i64* %96
  store %struct.Memory* %loadMem_40221c, %struct.Memory** %MEMORY
  ...
  %loadMem1_402228 = load %struct.Memory*, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem1_402228, %struct.Memory** %MEMORY
  %loadMem2_402228 = load %struct.Memory*, %struct.Memory** %MEMORY
  %loadPC_402228 = load i64, i64* %3
  %call2_402228 = call %struct.Memory* @sub_402340._ZeqI16reverse_iteratorIP6DoubleS1_ES1_EiRKS0_IT_T0_ES8_(%struct.State* %0, i64 %loadPC_402228, %struct.Memory* %loadMem2_402228)
  store %struct.Memory* %call2_402228, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_40222d, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_402236, %struct.Memory** %MEMORY
  %loadMem_402239 = load %struct.Memory*, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_402239, %struct.Memory** %MEMORY
  ...
  ret %struct.Memory* %loadMem_402241
}
