...
entry:
  ...
  ; Code: ._ZneI16reverse_iteratorIS0_IP6DoubleS1_ES1_EEiRKT_S7_:	 RIP: 402210	 Bytes: 0
  ...
  ; Code: subq $0x10, %rsp	 RIP: 402214	 Bytes: 4
  %loadMem_402214 = load %struct.Memory*, %struct.Memory** %MEMORY
  %call_402214 = call %struct.Memory* @routine_subq__0x10___rsp(%struct.State* %0, i64  0, %struct.Memory* %loadMem_402214)
  ...
  ; Code: movq -0x8(%rbp), %rdi	 RIP: 402220	 Bytes: 4
  %loadMem_402220 = load %struct.Memory*, %struct.Memory** %MEMORY
  %call_402220 = call %struct.Memory* @routine_movq_MINUS0x8__rbp____rdi(%struct.State* %0, i64  0, %struct.Memory* %loadMem_402220)
  store %struct.Memory* %call_402220, %struct.Memory** %MEMORY

  ; Code: movq -0x10(%rbp), %rsi	 RIP: 402224	 Bytes: 4
  %loadMem_402224 = load %struct.Memory*, %struct.Memory** %MEMORY
  %call_402224 = call %struct.Memory* @routine_movq_MINUS0x10__rbp____rsi(%struct.State* %0, i64  0, %struct.Memory* %loadMem_402224)
  store %struct.Memory* %call_402224, %struct.Memory** %MEMORY

  ; Code: callq ._ZeqI16reverse_iteratorIP6DoubleS1_ES1_EiRKS0_IT_T0_ES8_	 RIP: 402228	 Bytes: 5
  %loadMem1_402228 = load %struct.Memory*, %struct.Memory** %MEMORY
  %call1_402228 = call %struct.Memory* @routine_callq_._ZeqI16reverse_iteratorIP6DoubleS1_ES1_EiRKS0_IT_T0_ES8_(%struct.State* %0, i64  0, %struct.Memory* %loadMem1_402228, i64 280, i64 5, i64 5)
  store %struct.Memory* %call1_402228, %struct.Memory** %MEMORY
  ...
  ; Code: cmpl $0x0, %eax	 RIP: 40222d	 Bytes: 3
  %loadMem_40222d = load %struct.Memory*, %struct.Memory** %MEMORY
  %call_40222d = call %struct.Memory* @routine_cmpl__0x0___eax(%struct.State* %0, i64  0, %struct.Memory* %loadMem_40222d)
  store %struct.Memory* %call_40222d, %struct.Memory** %MEMORY

  ; Code: setne %cl	 RIP: 402230	 Bytes: 3
  %loadMem_402230 = load %struct.Memory*, %struct.Memory** %MEMORY
  %call_402230 = call %struct.Memory* @routine_setne__cl(%struct.State* %0, i64  0, %struct.Memory* %loadMem_402230)
  store %struct.Memory* %call_402230, %struct.Memory** %MEMORY

  ; Code: xorb $0xff, %cl	 RIP: 402233	 Bytes: 3
  %loadMem_402233 = load %struct.Memory*, %struct.Memory** %MEMORY
  %call_402233 = call %struct.Memory* @routine_xorb__0xff___cl(%struct.State* %0, i64  0, %struct.Memory* %loadMem_402233)
  store %struct.Memory* %call_402233, %struct.Memory** %MEMORY

  ; Code: andb $0x1, %cl	 RIP: 402236	 Bytes: 3
  %loadMem_402236 = load %struct.Memory*, %struct.Memory** %MEMORY
  %call_402236 = call %struct.Memory* @routine_andb__0x1___cl(%struct.State* %0, i64  0, %struct.Memory* %loadMem_402236)
  store %struct.Memory* %call_402236, %struct.Memory** %MEMORY

  ; Code: movzbl %cl, %eax	 RIP: 402239	 Bytes: 3
  %loadMem_402239 = load %struct.Memory*, %struct.Memory** %MEMORY
  %call_402239 = call %struct.Memory* @routine_movzbl__cl___eax(%struct.State* %0, i64  0, %struct.Memory* %loadMem_402239)
  store %struct.Memory* %call_402239, %struct.Memory** %MEMORY

  ; Code: addq $0x10, %rsp	 RIP: 40223c	 Bytes: 4
  %loadMem_40223c = load %struct.Memory*, %struct.Memory** %MEMORY
  %call_40223c = call %struct.Memory* @routine_addq__0x10___rsp(%struct.State* %0, i64  0, %struct.Memory* %loadMem_40223c)
  store %struct.Memory* %call_40223c, %struct.Memory** %MEMORY

  ; Code: popq %rbp	 RIP: 402240	 Bytes: 1
  %loadMem_402240 = load %struct.Memory*, %struct.Memory** %MEMORY
  %call_402240 = call %struct.Memory* @routine_popq__rbp(%struct.State* %0, i64  0, %struct.Memory* %loadMem_402240)
  store %struct.Memory* %call_402240, %struct.Memory** %MEMORY

  ; Code: retq	 RIP: 402241	 Bytes: 1
  %loadMem_402241 = load %struct.Memory*, %struct.Memory** %MEMORY
  %call_402241 = call %struct.Memory* @routine_retq(%struct.State* %0, i64  0, %struct.Memory* %loadMem_402241)
  store %struct.Memory* %call_402241, %struct.Memory** %MEMORY

  ret %struct.Memory* %call_402241
}
