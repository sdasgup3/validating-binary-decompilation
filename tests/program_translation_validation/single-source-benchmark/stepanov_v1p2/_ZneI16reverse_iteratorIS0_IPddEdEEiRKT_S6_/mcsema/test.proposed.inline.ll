...
define %struct.Memory* @_ZneI16reverse_iteratorIS0_IPddEdEEiRKT_S6_(%struct.State* noalias, i64, %struct.Memory* noalias) #1 {
entry:
  ...
  store %struct.Memory* %loadMem1_402438, %struct.Memory** %MEMORY
  ...
  ret %struct.Memory* %loadMem_402451
}
