...
define %struct.Memory* @_ZneI16reverse_iteratorIS0_IPddEdEEiRKT_S6_(%struct.State* noalias, i64, %struct.Memory* noalias) #2 {
entry:
  ...
  store %struct.Memory* %loadMem_402431, %struct.Memory** %MEMORY
  ...
  store i64 %78, i64* %81
  store %struct.Memory* %loadMem_402438, %struct.Memory** %MEMORY
  ...
  store i64 %93, i64* %96
  store %struct.Memory* %loadMem_40243c, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_402444, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem1_402448, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_40244d, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_402459, %struct.Memory** %MEMORY
  ...
  ret %struct.Memory* %loadMem_402461
}
