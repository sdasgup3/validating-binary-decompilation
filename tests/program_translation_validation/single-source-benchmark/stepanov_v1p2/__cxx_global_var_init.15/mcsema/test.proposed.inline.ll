...
entry:
  ...
  %83 = load i64, i64* bitcast (%G_0x60ce68_type* @G_0x60ce68 to i64*)
  ...
  store %struct.Memory* %loadMem1_400772, %struct.Memory** %MEMORY
...
define %struct.Memory* @routine_movq__0x60cea0___rdi(%struct.State* dereferenceable(3376), i64, %struct.Memory*) {
block_400478:
  %3 = getelementptr inbounds %struct.State, %struct.State* %0, i32 0, i32 6
  %4 = getelementptr inbounds %struct.GPR, %struct.GPR* %3, i32 0, i32 33
  %5 = getelementptr inbounds %struct.Reg, %struct.Reg* %4, i32 0, i32 0
