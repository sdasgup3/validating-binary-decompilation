...
@G_0x60ce60 = global %G_0x60ce60_type zeroinitializer
@G__0x60cea8 = global %G__0x60cea8_type zeroinitializer
...
define %struct.Memory* @__cxx_global_var_init.16(%struct.State* noalias, i64, %struct.Memory* noalias) #2 {
entry:
  ...
  store i64 ptrtoint (%G__0x60cea8_type* @G__0x60cea8 to i64), i64* %RDI.i, align 8
  ...
  %83 = load i64, i64* bitcast (%G_0x60ce60_type* @G_0x60ce60 to i64*)
  ...
  store %struct.Memory* %loadMem1_4007a2, %struct.Memory** %MEMORY
  %loadMem2_4007a2 = load %struct.Memory*, %struct.Memory** %MEMORY
  %loadPC_4007a2 = load i64, i64* %3
  %call2_4007a2 = call %struct.Memory* @sub_401250._ZN16reverse_iteratorI14double_pointerdEC2ES0_(%struct.State* %0, i64 %loadPC_4007a2, %struct.Memory* %loadMem2_4007a2)
  ...
  ret %struct.Memory* %loadMem_4007ac
}
...
define %struct.Memory* @routine_movq__0x60cea8___rdi(%struct.State* dereferenceable(3376), i64, %struct.Memory*) {
block_400478:
  %3 = getelementptr inbounds %struct.State, %struct.State* %0, i32 0, i32 6
  %4 = getelementptr inbounds %struct.GPR, %struct.GPR* %3, i32 0, i32 33
  %5 = getelementptr inbounds %struct.Reg, %struct.Reg* %4, i32 0, i32 0
  ...
  %10 = add i64 %9, 10
  store i64 %10, i64* %PC
  store i64 ptrtoint (%G__0x60cea8_type* @G__0x60cea8 to i64), i64* %RDI, align 8
  ret %struct.Memory* %2
}
...
block_400478:
  ...
  %10 = add i64 %9, 8
  store i64 %10, i64* %PC
  %11 = load i64, i64* bitcast (%G_0x60ce60_type* @G_0x60ce60 to i64*)
