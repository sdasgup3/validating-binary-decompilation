...
define %struct.Memory* @__cxx_global_var_init.22(%struct.State* noalias, i64, %struct.Memory* noalias readnone returned) local_unnamed_addr #1 {
entry:
  ...
  %40 = load i64, i64* inttoptr (i64 6344336 to i64*), align 16
  ...
  %call2_4008e2 = tail call %struct.Memory* @sub_401200._ZN16reverse_iteratorIS_IP6DoubleS0_ES0_EC2ES2_(%struct.State* %0, i64 %50, %struct.Memory* %2)
  ...
  ret %struct.Memory* %call2_4008e2
}
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_movq__0x60ced8___rdi(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
