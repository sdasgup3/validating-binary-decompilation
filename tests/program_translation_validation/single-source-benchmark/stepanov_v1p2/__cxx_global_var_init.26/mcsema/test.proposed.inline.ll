...
define %struct.Memory* @__cxx_global_var_init.26(%struct.State* noalias, i64, %struct.Memory* noalias) #2 {
entry:
  ...
  %83 = load i64, i64* bitcast (%G_0x60ceb0_type* @G_0x60ceb0 to i64*)
  ...
  store %struct.Memory* %loadMem1_4009b2, %struct.Memory** %MEMORY
  ...
  ret %struct.Memory* %loadMem_4009bc
}
...
define %struct.Memory* @routine_movq__0x60cef8___rdi(%struct.State* dereferenceable(3376), i64, %struct.Memory*) {
block_400488:
  %3 = getelementptr inbounds %struct.State, %struct.State* %0, i32 0, i32 6
  %4 = getelementptr inbounds %struct.GPR, %struct.GPR* %3, i32 0, i32 33
  %5 = getelementptr inbounds %struct.Reg, %struct.Reg* %4, i32 0, i32 0
