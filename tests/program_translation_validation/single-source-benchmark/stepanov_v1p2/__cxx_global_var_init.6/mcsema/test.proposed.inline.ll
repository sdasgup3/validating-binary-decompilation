...
define %struct.Memory* @__cxx_global_var_init.6(%struct.State* noalias, i64, %struct.Memory* noalias) #2 {
entry:
  ...
  store i64 %85, i64* %RSI.i, align 8
  ...
  %94 = getelementptr inbounds [32 x %union.VectorReg], [32 x %union.VectorReg]* %93, i64 0, i64 0
  %XMM0.i9 = bitcast %union.VectorReg* %94 to %union.vec128_t*
  %95 = bitcast %"class.std::bitset"* %YMM0.i to i8*
  %96 = bitcast %"class.std::bitset"* %YMM0.i to i8*
  %97 = bitcast %union.vec128_t* %XMM0.i9 to i8*
  ...
  %XMM0.i = bitcast %union.VectorReg* %132 to %union.vec128_t*
  %133 = load i64, i64* %RBP.i7
  %134 = sub i64 %133, 8
  %135 = bitcast %union.vec128_t* %XMM0.i to i8*
  ...
  store %struct.Memory* %loadMem1_40065e, %struct.Memory** %MEMORY
  ...
  %RSP.i = bitcast %union.anon* %160 to i64*
  %161 = load i64, i64* %RSP.i
  %162 = load i64, i64* %PC.i4
  %163 = add i64 %162, 4
  store i64 %163, i64* %PC.i4
  %164 = add i64 16, %161
  store i64 %164, i64* %RSP.i, align 8
  ...
  ret %struct.Memory* %loadMem_400668
}
...
define %struct.Memory* @routine_movq__0x60ce58___rdi(%struct.State* dereferenceable(3376), i64, %struct.Memory*) {
block_400488:
  %3 = getelementptr inbounds %struct.State, %struct.State* %0, i32 0, i32 6
  %4 = getelementptr inbounds %struct.GPR, %struct.GPR* %3, i32 0, i32 33
  %5 = getelementptr inbounds %struct.Reg, %struct.Reg* %4, i32 0, i32 0
