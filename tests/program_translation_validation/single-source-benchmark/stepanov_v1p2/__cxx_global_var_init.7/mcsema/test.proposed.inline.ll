...
declare %struct.Memory* @sub_4012d0._ZN14double_pointerC2EPd(%struct.State* noalias dereferenceable(3376), i64, %struct.Memory* noalias readnone returned)
...
entry:
  ...
  %call2_400666 = call %struct.Memory* @sub_4012d0._ZN14double_pointerC2EPd(%struct.State* %0, i64 %loadPC_400666, %struct.Memory* %loadMem2_400666)
  ...
  ret %struct.Memory* %loadMem_40066c
}
