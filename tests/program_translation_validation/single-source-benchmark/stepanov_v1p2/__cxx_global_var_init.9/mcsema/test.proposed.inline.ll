...
define %struct.Memory* @__cxx_global_var_init.9(%struct.State* noalias, i64, %struct.Memory* noalias) #2 {
entry:
...
; Function Attrs: alwaysinline
define %struct.Memory* @routine_movq__0x60ce70___rdi(%struct.State* dereferenceable(3376), i64, %struct.Memory*) #2 {
block_400488:
  %3 = getelementptr inbounds %struct.State, %struct.State* %0, i32 0, i32 6
  %4 = getelementptr inbounds %struct.GPR, %struct.GPR* %3, i32 0, i32 33
  %5 = getelementptr inbounds %struct.Reg, %struct.Reg* %4, i32 0, i32 0
