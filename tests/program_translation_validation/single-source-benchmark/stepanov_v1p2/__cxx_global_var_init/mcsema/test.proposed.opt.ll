...
declare %struct.Memory* @sub_401320._ZN6DoubleC2Ev(%struct.State* noalias dereferenceable(3376), i64, %struct.Memory* noalias readnone returned) local_unnamed_addr
...
block_.L_4005fb:                                  ; preds = %block_.L_4005fb, %entry
  %45 = phi i64 [ %94, %block_.L_4005fb ], [ %44, %entry ]
  ...
  %call2_400606 = tail call %struct.Memory* @sub_401320._ZN6DoubleC2Ev(%struct.State* nonnull %0, i64 %55, %struct.Memory* %2)
