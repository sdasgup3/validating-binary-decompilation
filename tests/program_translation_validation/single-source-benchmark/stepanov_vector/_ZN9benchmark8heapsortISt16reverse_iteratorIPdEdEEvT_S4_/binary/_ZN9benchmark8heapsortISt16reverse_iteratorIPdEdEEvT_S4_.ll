; ModuleID = '_ZN9benchmark8heapsortISt16reverse_iteratorIPdEdEEvT_S4_.bc'
...
define weak_odr void @_ZN9benchmark8heapsortISt16reverse_iteratorIPdEdEEvT_S4_(%"class.std::reverse_iterator"*, %"class.std::reverse_iterator"*) local_unnamed_addr #0 comdat {
  %3 = bitcast %"class.std::reverse_iterator"* %0 to i64*
...
; <label>:29:                                     ; preds = %28, %29
  ...
  store i64 %48, i64* %52, align 8, !tbaa !7
  %53 = shl nsw i64 %42, 1
...
; <label>:78:                                     ; preds = %69
  ...
  store double %76, double* %81, align 8, !tbaa !7
...
; <label>:83:                                     ; preds = %78, %69, %65
  ...
  store double %24, double* %87, align 8, !tbaa !7
...
; <label>:93:                                     ; preds = %90, %163
  ...
  %100 = load i64, i64* %92, align 8, !tbaa !7
...
; <label>:104:                                    ; preds = %103, %104
  ...
  store i64 %123, i64* %127, align 8, !tbaa !7
...
; <label>:134:                                    ; preds = %130
  ...
  store i64 %140, i64* %144, align 8, !tbaa !7
  br label %145
...
; <label>:158:                                    ; preds = %149
  ...
  store double %156, double* %161, align 8, !tbaa !7
...
; <label>:163:                                    ; preds = %149, %158, %145
  ...
  store double %99, double* %167, align 8, !tbaa !7
