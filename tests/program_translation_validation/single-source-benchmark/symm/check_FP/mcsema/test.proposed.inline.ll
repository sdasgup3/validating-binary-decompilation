...
@G_0x438__rip__4198256_ = global %G_0x438__rip__4198256__type zeroinitializer
...
entry:
  ...
  %76 = load double, double* bitcast (%G_0x438__rip__4198256__type* @G_0x438__rip__4198256_ to double*)
...
block_.L_400f8a:                                  ; preds = %block_.L_40106a, %entry
  ...
  %loadBr_400f90 = load i8, i8* %BRANCH_TAKEN
  %cmpBr_400f90 = icmp eq i8 %loadBr_400f90, 1
  br i1 %cmpBr_400f90, label %block_.L_401078, label %block_400f96
...
block_.L_400f9d:                                  ; preds = %block_.L_401057, %block_400f96
  ...
  br i1 %cmpBr_400fa3, label %block_.L_401065, label %block_400fa9
...
block_400fa9:                                     ; preds = %block_.L_400f9d
  ...
  %710 = load float, float* bitcast (%G_0x3bc__rip__4198388__type* @G_0x3bc__rip__4198388_ to float*)
  %711 = load float, float* inttoptr (i64 add (i64 ptrtoint (%G_0x3bc__rip__4198388__type* @G_0x3bc__rip__4198388_ to i64), i64 4) to float*)
  %712 = load float, float* inttoptr (i64 add (i64 ptrtoint (%G_0x3bc__rip__4198388__type* @G_0x3bc__rip__4198388_ to i64), i64 8) to float*)
  %713 = load float, float* inttoptr (i64 add (i64 ptrtoint (%G_0x3bc__rip__4198388__type* @G_0x3bc__rip__4198388_ to i64), i64 12) to float*)
...
; <label>:818:                                    ; preds = %810
  ...
  %821 = call %struct.Memory* @__remill_error(%struct.State* nonnull dereferenceable(3376) %0, i64 %820, %struct.Memory* %loadMem_401002)
  br label %routine_ucomisd_MINUS0x30__rbp____xmm0.exit

; <label>:822:                                    ; preds = %block_400fa9
...
routine_ucomisd_MINUS0x30__rbp____xmm0.exit:      ; preds = %818, %835
  %839 = phi %struct.Memory* [ %821, %818 ], [ %loadMem_401002, %835 ]
  ...
  br i1 %cmpBr_401007, label %block_.L_401052, label %block_40100d
...
block_40100d:                                     ; preds = %routine_ucomisd_MINUS0x30__rbp____xmm0.exit
  ...
  %loadMem1_40103e = load %struct.Memory*, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem1_40103e, %struct.Memory** %MEMORY
  %loadMem2_40103e = load %struct.Memory*, %struct.Memory** %MEMORY
  %loadPC_40103e = load i64, i64* %3
  %1018 = call %struct.Memory* @__remill_function_call(%struct.State* %0, i64 ptrtoint (i64 (i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64)* @fprintf to i64), %struct.Memory* %loadMem2_40103e)
...
block_.L_401057:                                  ; preds = %block_.L_401052
...
block_.L_40106a:                                  ; preds = %block_.L_401065
...
block_.L_40107f:                                  ; preds = %block_.L_401078, %block_40100d
  ...
  ret %struct.Memory* %loadMem_401087
}
...
block_400478:
  ...
  %9 = load i64, i64* %PC
  %10 = ptrtoint %G_0x438__rip__4198256__type* @G_0x438__rip__4198256_ to i64
  %11 = load i64, i64* %PC
  %12 = add i64 %11, 8
  store i64 %12, i64* %PC
...
define %struct.Memory* @routine_jge_.L_401078(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i8* %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) {
block_400478:
  %3 = getelementptr inbounds %struct.State, %struct.State* %0, i32 0, i32 6
  %4 = getelementptr inbounds %struct.GPR, %struct.GPR* %3, i32 0, i32 33
  %5 = getelementptr inbounds %struct.Reg, %struct.Reg* %4, i32 0, i32 0
...
define %struct.Memory* @routine_jge_.L_401065(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i8* %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) {
block_400478:
  %3 = getelementptr inbounds %struct.State, %struct.State* %0, i32 0, i32 6
  %4 = getelementptr inbounds %struct.GPR, %struct.GPR* %3, i32 0, i32 33
  %5 = getelementptr inbounds %struct.Reg, %struct.Reg* %4, i32 0, i32 0
...
block_400478:
  ...
  %9 = load i64, i64* %PC
  %10 = ptrtoint %G_0x3bc__rip__4198388__type* @G_0x3bc__rip__4198388_ to i64
  %11 = load i64, i64* %PC
  %12 = add i64 %11, 7
  store i64 %12, i64* %PC
...
define %struct.Memory* @routine_jbe_.L_401052(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i8* %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) {
block_400478:
  %3 = getelementptr inbounds %struct.State, %struct.State* %0, i32 0, i32 6
  %4 = getelementptr inbounds %struct.GPR, %struct.GPR* %3, i32 0, i32 33
  %5 = getelementptr inbounds %struct.Reg, %struct.Reg* %4, i32 0, i32 0
...
define %struct.Memory* @routine_jmpq_.L_400f9d(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i64 %rel_off1, i64 %rel_off2) {
block_400478:
  %3 = getelementptr inbounds %struct.State, %struct.State* %0, i32 0, i32 6
  %4 = getelementptr inbounds %struct.GPR, %struct.GPR* %3, i32 0, i32 33
  %5 = getelementptr inbounds %struct.Reg, %struct.Reg* %4, i32 0, i32 0
...
define %struct.Memory* @routine_jmpq_.L_40106a(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i64 %rel_off1, i64 %rel_off2) {
block_400478:
  %3 = getelementptr inbounds %struct.State, %struct.State* %0, i32 0, i32 6
  %4 = getelementptr inbounds %struct.GPR, %struct.GPR* %3, i32 0, i32 33
  %5 = getelementptr inbounds %struct.Reg, %struct.Reg* %4, i32 0, i32 0
...
define %struct.Memory* @routine_jmpq_.L_400f8a(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i64 %rel_off1, i64 %rel_off2) {
block_400478:
  %3 = getelementptr inbounds %struct.State, %struct.State* %0, i32 0, i32 6
  %4 = getelementptr inbounds %struct.GPR, %struct.GPR* %3, i32 0, i32 33
  %5 = getelementptr inbounds %struct.Reg, %struct.Reg* %4, i32 0, i32 0
