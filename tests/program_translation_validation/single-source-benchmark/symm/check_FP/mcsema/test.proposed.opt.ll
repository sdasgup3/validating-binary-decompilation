...
entry:
  ...
  %60 = add i64 %59, -24
  %61 = load i64, i64* %RDX.i143, align 8
  ...
  %66 = add i64 %65, -32
  %67 = load i64, i64* %RCX.i140, align 8
  ...
  %75 = getelementptr inbounds [32 x %union.VectorReg], [32 x %union.VectorReg]* %40, i64 0, i64 0, i32 0, i32 0, i32 0, i64 0
  ...
  %RAX.i132 = getelementptr inbounds %union.anon, %union.anon* %83, i64 0, i32 0
  %EAX.i129 = bitcast %union.anon* %83 to i32*
  ...
  %89 = getelementptr inbounds %union.VectorReg, %union.VectorReg* %84, i64 0, i32 0, i32 0, i32 0, i64 0
  %90 = bitcast [32 x %union.VectorReg]* %40 to i32*
  %91 = getelementptr inbounds i8, i8* %41, i64 4
  %92 = bitcast i8* %91 to i32*
  %93 = bitcast i64* %45 to i32*
  %94 = getelementptr inbounds i8, i8* %41, i64 12
  %95 = bitcast i8* %94 to i32*
  %.pre = load i64, i64* %PC.i, align 8
  br label %block_.L_400f8a

block_.L_400f8a:                                  ; preds = %block_.L_401065, %entry
  %96 = phi i64 [ %.pre, %entry ], [ %465, %block_.L_401065 ]
  %MEMORY.0 = phi %struct.Memory* [ %2, %entry ], [ %MEMORY.1, %block_.L_401065 ]
  ...
  store i64 %102, i64* %RAX.i132, align 8
  %103 = add i64 %97, -8
  %104 = add i64 %96, 6
  ...
  br i1 %132, label %block_400f96, label %block_.L_401078

block_400f96:                                     ; preds = %block_.L_400f8a
  %134 = add i64 %97, -40
  %135 = add i64 %133, 7
...
block_.L_400f9d:                                  ; preds = %block_.L_401052, %block_400f96
  %137 = phi i64 [ %.pre3, %block_400f96 ], [ %434, %block_.L_401052 ]
  %MEMORY.1 = phi %struct.Memory* [ %MEMORY.0, %block_400f96 ], [ %340, %block_.L_401052 ]
  ...
  store i64 %143, i64* %RAX.i132, align 8
  %144 = add i64 %138, -12
  %145 = add i64 %137, 6
  ...
  %173 = xor i1 %172, %170
  %.v6 = select i1 %173, i64 12, i64 200
  %174 = add i64 %137, %.v6
  store i64 %174, i64* %3, align 8
  br i1 %173, label %block_400fa9, label %block_.L_401065

block_400fa9:                                     ; preds = %block_.L_400f9d
  %175 = add i64 %138, -24
  %176 = add i64 %174, 4
  ...
  store i64 %184, i64* %RCX.i140, align 8
  %185 = lshr i64 %183, 50
  %186 = and i64 %185, 1
  %187 = add i64 %184, %178
  store i64 %187, i64* %RAX.i132, align 8
  ...
  store i64 %214, i64* %RCX.i140, align 8
  ...
  %220 = getelementptr inbounds [32 x %union.VectorReg], [32 x %union.VectorReg]* %40, i64 0, i64 0, i32 0, i32 0, i32 0, i64 0
  ...
  store i64 %235, i64* %RCX.i140, align 8
  %236 = lshr i64 %234, 50
  %237 = and i64 %236, 1
  %238 = add i64 %235, %229
  store i64 %238, i64* %RAX.i132, align 8
  ...
  store i64 %267, i64* %RCX.i140, align 8
  ...
  %273 = getelementptr inbounds [32 x %union.VectorReg], [32 x %union.VectorReg]* %40, i64 0, i64 0, i32 0, i32 0, i32 0, i64 0
  ...
  store double %282, double* %43, align 1
  store double 0.000000e+00, double* %46, align 1
  %283 = add i64 %277, -64
  %284 = add i64 %279, 10
  ...
  %288 = load i32, i32* bitcast (%G_0x3bc__rip__type* @G_0x3bc__rip_ to i32*), align 8
  %289 = load i32, i32* inttoptr (i64 add (i64 ptrtoint (%G_0x3bc__rip__type* @G_0x3bc__rip_ to i64), i64 4) to i32*), align 4
  %290 = load i32, i32* inttoptr (i64 add (i64 ptrtoint (%G_0x3bc__rip__type* @G_0x3bc__rip_ to i64), i64 8) to i32*), align 8
  %291 = load i32, i32* inttoptr (i64 add (i64 ptrtoint (%G_0x3bc__rip__type* @G_0x3bc__rip_ to i64), i64 12) to i32*), align 4
  %292 = bitcast %union.VectorReg* %84 to i32*
  store i32 %288, i32* %292, align 1
  %293 = bitcast i8* %86 to i32*
  store i32 %289, i32* %293, align 1
  %294 = bitcast i64* %87 to i32*
  store i32 %290, i32* %294, align 1
  %295 = bitcast i8* %88 to i32*
  store i32 %291, i32* %295, align 1
  %296 = bitcast double %287 to i64
  %297 = load i64, i64* %89, align 1
  %298 = and i64 %297, %296
  %299 = trunc i64 %298 to i32
  %300 = lshr i64 %298, 32
  %301 = trunc i64 %300 to i32
  store i32 %299, i32* %90, align 1
  store i32 %301, i32* %92, align 1
  ...
  store double %312, double* %43, align 1
  store double 0.000000e+00, double* %46, align 1
  %313 = add i64 %307, -48
  %314 = add i64 %309, 10
  ...
  %317 = fcmp uno double %312, %316
  br i1 %317, label %318, label %328

; <label>:318:                                    ; preds = %block_400fa9
...
; <label>:326:                                    ; preds = %318
  %327 = tail call %struct.Memory* @__remill_error(%struct.State* nonnull dereferenceable(3376) %0, i64 %314, %struct.Memory* %MEMORY.1)
  %.pre4 = load i64, i64* %PC.i, align 8
  br label %routine_ucomisd_MINUS0x30__rbp____xmm0.exit

; <label>:328:                                    ; preds = %block_400fa9
  %329 = fcmp ogt double %312, %316
  br i1 %329, label %334, label %330

; <label>:330:                                    ; preds = %328
  %331 = fcmp olt double %312, %316
  br i1 %331, label %334, label %332

; <label>:332:                                    ; preds = %330
  %333 = fcmp oeq double %312, %316
...
routine_ucomisd_MINUS0x30__rbp____xmm0.exit:      ; preds = %338, %326
  %339 = phi i64 [ %.pre4, %326 ], [ %314, %338 ]
  %340 = phi %struct.Memory* [ %327, %326 ], [ %MEMORY.1, %338 ]
  %341 = load i8, i8* %14, align 1
  %342 = load i8, i8* %30, align 1
  %343 = or i8 %342, %341
  %344 = icmp ne i8 %343, 0
  %.v7 = select i1 %344, i64 75, i64 6
  %345 = add i64 %339, %.v7
  store i64 %345, i64* %3, align 8
  br i1 %344, label %block_.L_401052, label %block_40100d

block_40100d:                                     ; preds = %routine_ucomisd_MINUS0x30__rbp____xmm0.exit
  %RSI.i = getelementptr inbounds %union.anon, %union.anon* %52, i64 0, i32 0
  store i64 ptrtoint (%G__0x4013fa_type* @G__0x4013fa to i64), i64* %RSI.i, align 8
  %RDI.i = getelementptr inbounds %union.anon, %union.anon* %47, i64 0, i32 0
  %346 = load i64, i64* bitcast (%G_0x602080_type* @G_0x602080 to i64*), align 8
  store i64 %346, i64* %RDI.i, align 8
  ...
  store i64 %352, i64* %RDX.i143, align 8
  %353 = add i64 %347, -40
  %354 = add i64 %345, 24
  ...
  store i64 %357, i64* %RCX.i140, align 8
  %358 = add i64 %347, -56
  %359 = add i64 %345, 29
  store i64 %359, i64* %PC.i, align 8
  %360 = inttoptr i64 %358 to i64*
  %361 = load i64, i64* %360, align 8
  %362 = getelementptr inbounds [32 x %union.VectorReg], [32 x %union.VectorReg]* %40, i64 0, i64 0, i32 0, i32 0, i32 0, i64 0
  ...
  %375 = getelementptr inbounds %union.VectorReg, %union.VectorReg* %84, i64 0, i32 0, i32 0, i32 0, i64 0
  store i64 %374, i64* %375, align 1
  %376 = bitcast i64* %87 to double*
  ...
  %381 = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 1, i64 2, i32 0, i32 0, i32 0, i64 0
  store i64 %380, i64* %381, align 1
  %382 = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 1, i64 2, i32 0, i32 0, i32 0, i64 1
  ...
  %389 = tail call %struct.Memory* @__remill_function_call(%struct.State* %0, i64 ptrtoint (i64 (i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64)* @fprintf to i64), %struct.Memory* %340)
  ...
  %396 = add i64 %395, -76
  %397 = load i32, i32* %EAX.i129, align 4
...
block_.L_401052:                                  ; preds = %routine_ucomisd_MINUS0x30__rbp____xmm0.exit
...
block_.L_401065:                                  ; preds = %block_.L_400f9d
  %435 = add i64 %138, -36
  %436 = add i64 %174, 8
  ...
  store i64 %440, i64* %RAX.i132, align 8
...
block_.L_401078:                                  ; preds = %block_.L_400f8a
  %466 = add i64 %97, -4
  %467 = add i64 %133, 7
...
block_.L_40107f:                                  ; preds = %block_.L_401078, %block_40100d
  %469 = phi i64 [ %.pre5, %block_.L_401078 ], [ %402, %block_40100d ]
  %MEMORY.2 = phi %struct.Memory* [ %MEMORY.0, %block_.L_401078 ], [ %389, %block_40100d ]
  ...
  store i64 %475, i64* %RAX.i132, align 8
  %476 = load i64, i64* %RSP.i35, align 8
  %477 = add i64 %476, 80
  store i64 %477, i64* %RSP.i35, align 8
...
define %struct.Memory* @routine_jge_.L_401078(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i8* %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
...
define %struct.Memory* @routine_jge_.L_401065(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i8* %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 2, i32 9
...
define %struct.Memory* @routine_movaps_0x3bc__rip____xmm1(%struct.State* dereferenceable(3376), i64, %struct.Memory*) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  ...
  %6 = add i64 %5, 7
  store i64 %6, i64* %PC, align 8
  %7 = load i32, i32* bitcast (%G_0x3bc__rip__type* @G_0x3bc__rip_ to i32*), align 8
  %8 = load i32, i32* inttoptr (i64 add (i64 ptrtoint (%G_0x3bc__rip__type* @G_0x3bc__rip_ to i64), i64 4) to i32*), align 4
  %9 = load i32, i32* inttoptr (i64 add (i64 ptrtoint (%G_0x3bc__rip__type* @G_0x3bc__rip_ to i64), i64 8) to i32*), align 8
  %10 = load i32, i32* inttoptr (i64 add (i64 ptrtoint (%G_0x3bc__rip__type* @G_0x3bc__rip_ to i64), i64 12) to i32*), align 4
...
define %struct.Memory* @routine_jbe_.L_401052(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i8* %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
...
define %struct.Memory* @routine_movq__0x4013fa___rsi(%struct.State* dereferenceable(3376), i64, %struct.Memory*) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
...
define %struct.Memory* @routine_movl_MINUS0x28__rbp____r9d(%struct.State* dereferenceable(3376), i64, %struct.Memory*) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %RBP = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 15, i32 0, i32 0
...
define %struct.Memory* @routine_jmpq_.L_40107f(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
