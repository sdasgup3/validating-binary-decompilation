...
%G_0x3bc__rip__4198388__type = type <{ [16 x i8] }>
%G_0x438__rip__4198256__type = type <{ [16 x i8] }>
...
@G_0x3bc__rip__4198388_ = global %G_0x3bc__rip__4198388__type zeroinitializer
@G_0x438__rip__4198256_ = local_unnamed_addr global %G_0x438__rip__4198256__type zeroinitializer
...
entry:
  ...
  %42 = load i64, i64* bitcast (%G_0x438__rip__4198256__type* @G_0x438__rip__4198256_ to i64*), align 8
  ...
  %RAX.i132 = getelementptr inbounds %union.anon, %union.anon* %82, i64 0, i32 0
  %EAX.i129 = bitcast %union.anon* %82 to i32*
  ...
  %87 = getelementptr inbounds i8, i8* %84, i64 12
  %88 = getelementptr inbounds %union.VectorReg, %union.VectorReg* %83, i64 0, i32 0, i32 0, i32 0, i64 0
  %89 = bitcast [32 x %union.VectorReg]* %40 to i32*
  %90 = getelementptr inbounds i8, i8* %41, i64 4
  %91 = bitcast i8* %90 to i32*
  %92 = bitcast i64* %45 to i32*
...
block_.L_400f8a:                                  ; preds = %block_.L_401065, %entry
  %95 = phi i64 [ %.pre, %entry ], [ %457, %block_.L_401065 ]
  ...
  %131 = xor i1 %130, %128
  %.v = select i1 %131, i64 12, i64 238
  %132 = add i64 %95, %.v
  store i64 %132, i64* %3, align 8
  br i1 %131, label %block_400f96, label %block_.L_401078
...
block_.L_400f9d:                                  ; preds = %block_.L_401052, %block_400f96
  %136 = phi i64 [ %.pre3, %block_400f96 ], [ %427, %block_.L_401052 ]
  %MEMORY.1 = phi %struct.Memory* [ %MEMORY.0, %block_400f96 ], [ %336, %block_.L_401052 ]
  ...
  %172 = xor i1 %171, %169
  %.v6 = select i1 %172, i64 12, i64 200
  %173 = add i64 %136, %.v6
  store i64 %173, i64* %3, align 8
  br i1 %172, label %block_400fa9, label %block_.L_401065
...
block_400fa9:                                     ; preds = %block_.L_400f9d
  ...
  store i64 %183, i64* %RCX.i140, align 8
  %184 = lshr i64 %182, 50
  %185 = and i64 %184, 1
  %186 = add i64 %183, %177
  ...
  store i64 %213, i64* %RCX.i140, align 8
  ...
  store i64 %233, i64* %RCX.i140, align 8
  %234 = lshr i64 %232, 50
  %235 = and i64 %234, 1
  %236 = add i64 %233, %227
  store i64 %236, i64* %RAX.i132, align 8
  ...
  store i64 %265, i64* %RCX.i140, align 8
  ...
  store double %279, double* %43, align 1
  store double 0.000000e+00, double* %46, align 1
  %280 = add i64 %274, -64
  %281 = add i64 %276, 10
  ...
  %285 = load i32, i32* bitcast (%G_0x3bc__rip__4198388__type* @G_0x3bc__rip__4198388_ to i32*), align 8
  %286 = load i32, i32* inttoptr (i64 add (i64 ptrtoint (%G_0x3bc__rip__4198388__type* @G_0x3bc__rip__4198388_ to i64), i64 4) to i32*), align 4
  %287 = load i32, i32* inttoptr (i64 add (i64 ptrtoint (%G_0x3bc__rip__4198388__type* @G_0x3bc__rip__4198388_ to i64), i64 8) to i32*), align 8
  %288 = load i32, i32* inttoptr (i64 add (i64 ptrtoint (%G_0x3bc__rip__4198388__type* @G_0x3bc__rip__4198388_ to i64), i64 12) to i32*), align 4
  %289 = bitcast %union.VectorReg* %83 to i32*
  store i32 %285, i32* %289, align 1
  %290 = bitcast i8* %85 to i32*
  store i32 %286, i32* %290, align 1
  %291 = bitcast i64* %86 to i32*
  store i32 %287, i32* %291, align 1
  %292 = bitcast i8* %87 to i32*
  store i32 %288, i32* %292, align 1
  %293 = bitcast double %284 to i64
  %294 = load i64, i64* %88, align 1
  %295 = and i64 %294, %293
  %296 = trunc i64 %295 to i32
  %297 = lshr i64 %295, 32
  %298 = trunc i64 %297 to i32
  store i32 %296, i32* %89, align 1
  store i32 %298, i32* %91, align 1
  store i32 0, i32* %92, align 1
  store i32 0, i32* %94, align 1
  %299 = add i64 %274, -72
  %300 = add i64 %276, 26
  store i64 %300, i64* %3, align 8
  %301 = load i64, i64* %44, align 1
  ...
  store double %308, double* %43, align 1
  store double 0.000000e+00, double* %46, align 1
  %309 = add i64 %303, -48
  %310 = add i64 %305, 10
  ...
  %313 = fcmp uno double %308, %312
  br i1 %313, label %314, label %324

; <label>:314:                                    ; preds = %block_400fa9
  %315 = fadd double %308, %312
...
; <label>:322:                                    ; preds = %314
  %323 = tail call %struct.Memory* @__remill_error(%struct.State* nonnull dereferenceable(3376) %0, i64 %310, %struct.Memory* %MEMORY.1)
  %.pre4 = load i64, i64* %3, align 8
  br label %routine_ucomisd_MINUS0x30__rbp____xmm0.exit

; <label>:324:                                    ; preds = %block_400fa9
  %325 = fcmp ogt double %308, %312
  br i1 %325, label %330, label %326

; <label>:326:                                    ; preds = %324
  %327 = fcmp olt double %308, %312
  br i1 %327, label %330, label %328

; <label>:328:                                    ; preds = %326
  %329 = fcmp oeq double %308, %312
...
routine_ucomisd_MINUS0x30__rbp____xmm0.exit:      ; preds = %334, %322
  %335 = phi i64 [ %.pre4, %322 ], [ %310, %334 ]
  %336 = phi %struct.Memory* [ %323, %322 ], [ %MEMORY.1, %334 ]
  %337 = load i8, i8* %14, align 1
  %338 = load i8, i8* %30, align 1
  %339 = or i8 %338, %337
  %340 = icmp ne i8 %339, 0
  %.v7 = select i1 %340, i64 75, i64 6
  %341 = add i64 %335, %.v7
  store i64 %341, i64* %3, align 8
  br i1 %340, label %block_.L_401052, label %block_40100d
...
block_40100d:                                     ; preds = %routine_ucomisd_MINUS0x30__rbp____xmm0.exit
  ...
  %342 = load i64, i64* bitcast (%G_0x602080_type* @G_0x602080 to i64*), align 8
  store i64 %342, i64* %RDI.i, align 8
  ...
  store i64 %348, i64* %RDX.i143, align 8
  %349 = add i64 %343, -40
  %350 = add i64 %341, 24
  ...
  store i64 %353, i64* %RCX.i140, align 8
  %354 = add i64 %343, -56
  %355 = add i64 %341, 29
  store i64 %355, i64* %3, align 8
  %356 = inttoptr i64 %354 to i64*
  %357 = load i64, i64* %356, align 8
  store i64 %357, i64* %44, align 1
  store double 0.000000e+00, double* %46, align 1
  ...
  store i64 %369, i64* %88, align 1
  %370 = bitcast i64* %86 to double*
  ...
  %375 = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 1, i64 2, i32 0, i32 0, i32 0, i64 0
  store i64 %374, i64* %375, align 1
  %376 = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 1, i64 2, i32 0, i32 0, i32 0, i64 1
  %377 = bitcast i64* %376 to double*
  store double 0.000000e+00, double* %377, align 1
  %AL.i = bitcast %union.anon* %82 to i8*
  store i8 3, i8* %AL.i, align 1
  %378 = add i64 %341, -2573
  %379 = add i64 %341, 54
  ...
  %383 = tail call %struct.Memory* @__remill_function_call(%struct.State* %0, i64 ptrtoint (i64 (i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64)* @fprintf to i64), %struct.Memory* %336)
  ...
  %390 = add i64 %389, -76
  %391 = load i32, i32* %EAX.i129, align 4
...
block_.L_401052:                                  ; preds = %routine_ucomisd_MINUS0x30__rbp____xmm0.exit
  ...
  store i64 %403, i64* %RAX.i132, align 8
...
block_.L_40107f:                                  ; preds = %block_.L_401078, %block_40100d
  %461 = phi i64 [ %.pre5, %block_.L_401078 ], [ %396, %block_40100d ]
  %MEMORY.2 = phi %struct.Memory* [ %MEMORY.0, %block_.L_401078 ], [ %383, %block_40100d ]
  ...
  store i64 %467, i64* %RAX.i132, align 8
  %468 = load i64, i64* %6, align 8
  %469 = add i64 %468, 80
  store i64 %469, i64* %6, align 8
  %470 = icmp ugt i64 %468, -81
...
block_400478:
  ...
  %5 = load i64, i64* bitcast (%G_0x438__rip__4198256__type* @G_0x438__rip__4198256_ to i64*), align 8
...
block_400478:
  ...
  %6 = add i64 %5, 7
  store i64 %6, i64* %PC, align 8
  %7 = load i32, i32* bitcast (%G_0x3bc__rip__4198388__type* @G_0x3bc__rip__4198388_ to i32*), align 8
  %8 = load i32, i32* inttoptr (i64 add (i64 ptrtoint (%G_0x3bc__rip__4198388__type* @G_0x3bc__rip__4198388_ to i64), i64 4) to i32*), align 4
  %9 = load i32, i32* inttoptr (i64 add (i64 ptrtoint (%G_0x3bc__rip__4198388__type* @G_0x3bc__rip__4198388_ to i64), i64 8) to i32*), align 8
  %10 = load i32, i32* inttoptr (i64 add (i64 ptrtoint (%G_0x3bc__rip__4198388__type* @G_0x3bc__rip__4198388_ to i64), i64 12) to i32*), align 4
