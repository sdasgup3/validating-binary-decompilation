...
block_.L_400f9a:                                  ; preds = %block_.L_401075, %entry
  %102 = phi i64 [ %.pre, %entry ], [ %470, %block_.L_401075 ]
...
block_.L_400fad:                                  ; preds = %block_.L_401062, %block_400fa6
  %143 = phi i64 [ %.pre29, %block_400fa6 ], [ %440, %block_.L_401062 ]
...
block_40101d:                                     ; preds = %routine_ucomisd_MINUS0x30__rbp____xmm0.exit
  ...
  %call2_40104e = tail call %struct.Memory* @sub_400630.fprintf_plt(%struct.State* nonnull %0, i64 %392, %struct.Memory* %350)
...
block_.L_40108f:                                  ; preds = %block_.L_401088, %block_40101d
  %474 = phi i64 [ %.pre31, %block_.L_401088 ], [ %409, %block_40101d ]
  %MEMORY.2 = phi %struct.Memory* [ %MEMORY.0, %block_.L_401088 ], [ %call2_40104e, %block_40101d ]
