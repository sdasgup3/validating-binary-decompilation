...
block_.L_400c47:                                  ; preds = %block_.L_400daf, %entry
  ...
  br i1 %cmpBr_400c4d, label %block_.L_400dbd, label %block_400c53
...
block_.L_400c5a:                                  ; preds = %block_.L_400d20, %block_400c53
  ...
  br i1 %cmpBr_400c60, label %block_.L_400daa, label %block_400c66
...
block_.L_400c75:                                  ; preds = %block_400c86, %block_400c66
  ...
  br i1 %cmpBr_400c80, label %block_.L_400d20, label %block_400c86
...
block_.L_400daf:                                  ; preds = %block_.L_400daa
...
block_.L_400dbd:                                  ; preds = %block_.L_400c47
  ...
  ret %struct.Memory* %loadMem_400dbe
}
...
define %struct.Memory* @routine_jge_.L_400dbd(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i8* %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) {
block_400478:
  %3 = getelementptr inbounds %struct.State, %struct.State* %0, i32 0, i32 6
  %4 = getelementptr inbounds %struct.GPR, %struct.GPR* %3, i32 0, i32 33
  %5 = getelementptr inbounds %struct.Reg, %struct.Reg* %4, i32 0, i32 0
...
define %struct.Memory* @routine_jge_.L_400d20(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i8* %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) {
block_400478:
  %3 = getelementptr inbounds %struct.State, %struct.State* %0, i32 0, i32 6
  %4 = getelementptr inbounds %struct.GPR, %struct.GPR* %3, i32 0, i32 33
  %5 = getelementptr inbounds %struct.Reg, %struct.Reg* %4, i32 0, i32 0
