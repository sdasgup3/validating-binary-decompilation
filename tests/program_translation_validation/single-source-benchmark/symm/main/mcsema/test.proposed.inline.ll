...
declare %struct.Memory* @sub_400ab0.init_array(%struct.State* dereferenceable(3376), i64, %struct.Memory*)

declare %struct.Memory* @sub_400c30.kernel_symm(%struct.State* dereferenceable(3376), i64, %struct.Memory*)

declare %struct.Memory* @sub_400dd0.kernel_symm_StrictFP(%struct.State* dereferenceable(3376), i64, %struct.Memory*)

declare %struct.Memory* @sub_400f70.check_FP(%struct.State* dereferenceable(3376), i64, %struct.Memory*)

declare %struct.Memory* @sub_4010a0.print_array(%struct.State* dereferenceable(3376), i64, %struct.Memory*)
