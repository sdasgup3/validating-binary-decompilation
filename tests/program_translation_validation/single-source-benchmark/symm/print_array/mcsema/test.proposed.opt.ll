...
block_.L_4010df:                                  ; preds = %block_.L_401135, %entry
  %131 = phi i64 [ %361, %block_.L_401135 ], [ %.pre, %entry ]
...
block_.L_4010f2:                                  ; preds = %block_4010fe, %block_4010eb
  %172 = phi i64 [ %313, %block_4010fe ], [ %.pre9, %block_4010eb ]
...
block_4010fe:                                     ; preds = %block_.L_4010f2
  ...
  %call2_401122 = tail call %struct.Memory* @sub_401170.print_element(%struct.State* nonnull %0, i64 %277, %struct.Memory* %call2_4010be)
...
block_.L_401135:                                  ; preds = %block_.L_4010f2
  ...
  %call2_401141 = tail call %struct.Memory* @sub_400610.fputs_plt(%struct.State* nonnull %0, i64 %319, %struct.Memory* %call2_4010be)
...
block_.L_401157:                                  ; preds = %block_.L_4010df
  ...
  %call2_40115b = tail call %struct.Memory* @sub_4005f0.free_plt(%struct.State* nonnull %0, i64 %366, %struct.Memory* %call2_4010be)
