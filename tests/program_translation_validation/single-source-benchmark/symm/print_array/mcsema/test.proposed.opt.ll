...
block_.L_4010df:                                  ; preds = %block_.L_401135, %entry
  %132 = phi i64 [ %.pre, %entry ], [ %363, %block_.L_401135 ]
  %MEMORY.0 = phi %struct.Memory* [ %87, %entry ], [ %325, %block_.L_401135 ]
  ...
  br i1 %168, label %block_4010eb, label %block_.L_401157
...
block_.L_4010f2:                                  ; preds = %block_4010fe, %block_4010eb
  %173 = phi i64 [ %314, %block_4010fe ], [ %.pre9, %block_4010eb ]
  ...
  br i1 %209, label %block_4010fe, label %block_.L_401135
...
block_4010fe:                                     ; preds = %block_.L_4010f2
  ...
  %call2_401122 = tail call %struct.Memory* @sub_401170.print_element(%struct.State* nonnull %0, i64 %278, %struct.Memory* %MEMORY.0)
