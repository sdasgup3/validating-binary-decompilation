...
block_.L_4010cf:                                  ; preds = %block_.L_401125, %entry
  %125 = phi i64 [ %.pre, %entry ], [ %356, %block_.L_401125 ]
  %MEMORY.0 = phi %struct.Memory* [ %81, %entry ], [ %318, %block_.L_401125 ]
  ...
  br i1 %161, label %block_4010db, label %block_.L_401147
...
block_.L_4010e2:                                  ; preds = %block_4010ee, %block_4010db
  %166 = phi i64 [ %.pre1, %block_4010db ], [ %307, %block_4010ee ]
  ...
  br i1 %202, label %block_4010ee, label %block_.L_401125
...
block_4010ee:                                     ; preds = %block_.L_4010e2
  ...
  %call2_401112 = tail call %struct.Memory* @sub_401160.print_element(%struct.State* %0, i64 %271, %struct.Memory* %MEMORY.1)
