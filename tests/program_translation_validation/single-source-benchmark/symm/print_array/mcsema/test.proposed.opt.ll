...
block_.L_4010cf:                                  ; preds = %block_.L_401125, %entry
  %125 = phi i64 [ %.pre, %entry ], [ %357, %block_.L_401125 ]
  %MEMORY.0 = phi %struct.Memory* [ %81, %entry ], [ %319, %block_.L_401125 ]
...
block_.L_4010e2:                                  ; preds = %block_4010ee, %block_4010db
  %166 = phi i64 [ %.pre1, %block_4010db ], [ %308, %block_4010ee ]
...
block_4010ee:                                     ; preds = %block_.L_4010e2
  ...
  %call2_401112 = tail call %struct.Memory* @sub_401160.print_element(%struct.State* %0, i64 %272, %struct.Memory* %MEMORY.1)
