...
block_.L_4010cf:                                  ; preds = %block_.L_401125, %entry
  %131 = phi i64 [ %.pre, %entry ], [ %365, %block_.L_401125 ]
  %MEMORY.0 = phi %struct.Memory* [ %87, %entry ], [ %326, %block_.L_401125 ]
  ...
  br i1 %167, label %block_4010db, label %block_.L_401147
...
block_.L_4010e2:                                  ; preds = %block_4010ee, %block_4010db
  %172 = phi i64 [ %.pre1, %block_4010db ], [ %315, %block_4010ee ]
  %MEMORY.1 = phi %struct.Memory* [ %MEMORY.0, %block_4010db ], [ %call2_401112, %block_4010ee ]
  ...
  br i1 %208, label %block_4010ee, label %block_.L_401125
...
block_4010ee:                                     ; preds = %block_.L_4010e2
  ...
  %call2_401112 = tail call %struct.Memory* @sub_401160.print_element(%struct.State* %0, i64 %278, %struct.Memory* %MEMORY.1)
...
define %struct.Memory* @routine_jge_.L_401147(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i8* %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
...
define %struct.Memory* @routine_jge_.L_401125(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i8* %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 2, i32 9
...
define %struct.Memory* @routine_jmpq_.L_4010e2(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
