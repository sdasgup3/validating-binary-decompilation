...
declare %struct.Memory* @sub_401180.print_element(%struct.State* noalias dereferenceable(3376), i64, %struct.Memory* noalias readnone returned) local_unnamed_addr
...
block_.L_4010ef:                                  ; preds = %block_.L_401145, %entry
  %132 = phi i64 [ %.pre, %entry ], [ %363, %block_.L_401145 ]
  %MEMORY.0 = phi %struct.Memory* [ %87, %entry ], [ %325, %block_.L_401145 ]
  ...
  br i1 %168, label %block_4010fb, label %block_.L_401167
...
block_.L_401102:                                  ; preds = %block_40110e, %block_4010fb
  %173 = phi i64 [ %314, %block_40110e ], [ %.pre9, %block_4010fb ]
  ...
  br i1 %209, label %block_40110e, label %block_.L_401145
...
block_40110e:                                     ; preds = %block_.L_401102
  ...
  %call2_401132 = tail call %struct.Memory* @sub_401180.print_element(%struct.State* nonnull %0, i64 %278, %struct.Memory* %MEMORY.0)
