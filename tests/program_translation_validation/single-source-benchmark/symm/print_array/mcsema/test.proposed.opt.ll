...
declare %struct.Memory* @sub_401170.print_element(%struct.State* dereferenceable(3376), i64, %struct.Memory*) local_unnamed_addr
...
entry:
  ...
  %call2_4010be = tail call %struct.Memory* @sub_400640.malloc_plt(%struct.State* %0, i64 %82, %struct.Memory* %2)
...
block_.L_4010df:                                  ; preds = %block_.L_401135, %entry
  %131 = phi i64 [ %.pre, %entry ], [ %361, %block_.L_401135 ]
  %MEMORY.0 = phi %struct.Memory* [ %call2_4010be, %entry ], [ %call2_401141, %block_.L_401135 ]
  ...
  br i1 %167, label %block_4010eb, label %block_.L_401157
...
block_.L_4010f2:                                  ; preds = %block_4010fe, %block_4010eb
  %172 = phi i64 [ %.pre9, %block_4010eb ], [ %313, %block_4010fe ]
  %MEMORY.1 = phi %struct.Memory* [ %MEMORY.0, %block_4010eb ], [ %call2_401122, %block_4010fe ]
  ...
  br i1 %208, label %block_4010fe, label %block_.L_401135
...
block_4010fe:                                     ; preds = %block_.L_4010f2
  ...
  %call2_401122 = tail call %struct.Memory* @sub_401170.print_element(%struct.State* nonnull %0, i64 %277, %struct.Memory* %MEMORY.1)
...
block_.L_401135:                                  ; preds = %block_.L_4010f2
  ...
  %call2_401141 = tail call %struct.Memory* @sub_400610.fputs_plt(%struct.State* nonnull %0, i64 %319, %struct.Memory* %MEMORY.1)
...
block_.L_401157:                                  ; preds = %block_.L_4010df
  ...
  %call2_40115b = tail call %struct.Memory* @sub_4005f0.free_plt(%struct.State* nonnull %0, i64 %366, %struct.Memory* %MEMORY.0)
  ...
  ret %struct.Memory* %call2_40115b
}
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_jge_.L_401157(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i8* nocapture %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
