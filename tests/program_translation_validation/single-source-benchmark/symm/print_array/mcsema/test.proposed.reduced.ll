; ModuleID = '/tmp/tmp3tvzbh5k-query.ll'
...
entry:
  ...
  %var_2_87 = tail call %struct.Memory* @__remill_function_call(%struct.State* %0, i64 ptrtoint (i64 (i64)* @malloc to i64), %struct.Memory* %2)
  %var_2_13318 = load i64, i64* %RBP.i, align 8
  %var_2_13419 = add i64 %var_2_13318, -20
  %var_2_13620 = inttoptr i64 %var_2_13419 to i32*
  %var_2_13721 = load i32, i32* %var_2_13620, align 4
  %var_2_13922 = add i64 %var_2_13318, -4
  %var_2_14123 = inttoptr i64 %var_2_13922 to i32*
  %var_2_14224 = load i32, i32* %var_2_14123, align 4
  %var_2_14325 = sub i32 %var_2_13721, %var_2_14224
  %var_2_15826 = lshr i32 %var_2_14325, 31
  %var_2_16027 = lshr i32 %var_2_13721, 31
  %var_2_16128 = lshr i32 %var_2_14224, 31
  %var_2_16229 = xor i32 %var_2_16128, %var_2_16027
  %var_2_16330 = xor i32 %var_2_15826, %var_2_16027
  %var_2_16431 = add nuw nsw i32 %var_2_16330, %var_2_16229
  %var_2_16532 = icmp eq i32 %var_2_16431, 2
  %var_2_16733 = icmp ne i32 %var_2_15826, 0
  %var_2_16834 = xor i1 %var_2_16733, %var_2_16532
  br i1 %var_2_16834, label %block_4010fb.preheader, label %block_.L_401167

block_4010fb.preheader:                           ; preds = %entry
  br label %block_4010fb

block_4010fb:                                     ; preds = %block_4010fb.preheader, %block_.L_401145
  %var_2_1741 = phi i64 [ %var_2_133, %block_.L_401145 ], [ %var_2_13318, %block_4010fb.preheader ]
  %MEMORY.035 = phi %struct.Memory* [ %var_2_325, %block_.L_401145 ], [ %var_2_87, %block_4010fb.preheader ]
  %var_2_1752 = add i64 %var_2_1741, -24
  %var_2_1773 = inttoptr i64 %var_2_1752 to i32*
  %var_2_1784 = load i32, i32* %var_2_1773, align 4
  %var_2_1805 = add i64 %var_2_1741, -8
  %var_2_1826 = inttoptr i64 %var_2_1805 to i32*
  %var_2_1837 = load i32, i32* %var_2_1826, align 4
  %var_2_1848 = sub i32 %var_2_1784, %var_2_1837
  %var_2_1999 = lshr i32 %var_2_1848, 31
  %var_2_20110 = lshr i32 %var_2_1784, 31
  %var_2_20211 = lshr i32 %var_2_1837, 31
  %var_2_20312 = xor i32 %var_2_20211, %var_2_20110
  %var_2_20413 = xor i32 %var_2_1999, %var_2_20110
  %var_2_20514 = add nuw nsw i32 %var_2_20413, %var_2_20312
  %var_2_20615 = icmp eq i32 %var_2_20514, 2
  %var_2_20816 = icmp ne i32 %var_2_1999, 0
  %var_2_20917 = xor i1 %var_2_20816, %var_2_20615
  br i1 %var_2_20917, label %block_40110e.preheader, label %block_.L_401145

block_40110e.preheader:                           ; preds = %block_4010fb
  br label %block_40110e

block_40110e:                                     ; preds = %block_40110e.preheader, %block_40110e
  br label %block_40110e

block_.L_401145:                                  ; preds = %block_4010fb
  %var_2_325 = tail call %struct.Memory* @__remill_function_call(%struct.State* nonnull %0, i64 ptrtoint (i64 (i64, i64)* @fputs to i64), %struct.Memory* %MEMORY.035)
  %var_2_133 = load i64, i64* %RBP.i, align 8
  %var_2_134 = add i64 %var_2_133, -20
  %var_2_136 = inttoptr i64 %var_2_134 to i32*
  %var_2_137 = load i32, i32* %var_2_136, align 4
  %var_2_139 = add i64 %var_2_133, -4
  %var_2_141 = inttoptr i64 %var_2_139 to i32*
  %var_2_142 = load i32, i32* %var_2_141, align 4
  %var_2_143 = sub i32 %var_2_137, %var_2_142
  %var_2_158 = lshr i32 %var_2_143, 31
  %var_2_160 = lshr i32 %var_2_137, 31
  %var_2_161 = lshr i32 %var_2_142, 31
  %var_2_162 = xor i32 %var_2_161, %var_2_160
  %var_2_163 = xor i32 %var_2_158, %var_2_160
  %var_2_164 = add nuw nsw i32 %var_2_163, %var_2_162
  %var_2_165 = icmp eq i32 %var_2_164, 2
  %var_2_167 = icmp ne i32 %var_2_158, 0
  %var_2_168 = xor i1 %var_2_167, %var_2_165
  br i1 %var_2_168, label %block_4010fb, label %block_.L_401167.loopexit

block_.L_401167.loopexit:                         ; preds = %block_.L_401145
  br label %block_.L_401167

block_.L_401167:                                  ; preds = %block_.L_401167.loopexit, %entry
  %MEMORY.0.lcssa = phi %struct.Memory* [ %var_2_87, %entry ], [ %var_2_325, %block_.L_401167.loopexit ]
  %var_2_373 = tail call %struct.Memory* @__remill_function_call(%struct.State* nonnull %0, i64 ptrtoint (i64 (i64)* @free to i64), %struct.Memory* %MEMORY.0.lcssa)
  ret %struct.Memory* %var_2_373
}
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_jge_.L_401167(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i8* nocapture %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_jge_.L_401145(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i8* nocapture %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 2, i32 9
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_jmpq_.L_401102(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_jmpq_.L_4010ef(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
