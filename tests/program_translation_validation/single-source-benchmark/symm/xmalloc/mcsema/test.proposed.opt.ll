...
@G__0x4013e7 = global %G__0x4013e7_type zeroinitializer
...
block_.L_400913:                                  ; preds = %block_400909, %entry
  ...
  store i64 ptrtoint (%G__0x4013e7_type* @G__0x4013e7 to i64), i64* %RSI.i45, align 8
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_movq__0x4013e7___rsi(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %RSI = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 9, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, 10
  store i64 %4, i64* %PC, align 8
  store i64 ptrtoint (%G__0x4013e7_type* @G__0x4013e7 to i64), i64* %RSI, align 8
  ret %struct.Memory* %2
}
