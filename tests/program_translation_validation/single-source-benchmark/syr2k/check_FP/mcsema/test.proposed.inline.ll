...
@G_0x3bf__rip__4198369_ = global %G_0x3bf__rip__4198369__type zeroinitializer
@G_0x438__rip__4198240_ = global %G_0x438__rip__4198240__type zeroinitializer
@G_0x602080 = global %G_0x602080_type zeroinitializer
@G__0x4013ea = global %G__0x4013ea_type zeroinitializer
...
entry:
  ...
  %76 = load double, double* bitcast (%G_0x438__rip__4198240__type* @G_0x438__rip__4198240_ to double*)
...
block_.L_400f77:                                  ; preds = %block_.L_401057, %entry
...
block_400f83:                                     ; preds = %block_.L_400f77
...
block_.L_400f8a:                                  ; preds = %block_.L_401044, %block_400f83
...
block_400f96:                                     ; preds = %block_.L_400f8a
  ...
  %694 = load float, float* bitcast (%G_0x3bf__rip__4198369__type* @G_0x3bf__rip__4198369_ to float*)
  %695 = load float, float* inttoptr (i64 add (i64 ptrtoint (%G_0x3bf__rip__4198369__type* @G_0x3bf__rip__4198369_ to i64), i64 4) to float*)
  %696 = load float, float* inttoptr (i64 add (i64 ptrtoint (%G_0x3bf__rip__4198369__type* @G_0x3bf__rip__4198369_ to i64), i64 8) to float*)
  %697 = load float, float* inttoptr (i64 add (i64 ptrtoint (%G_0x3bf__rip__4198369__type* @G_0x3bf__rip__4198369_ to i64), i64 12) to float*)
...
; <label>:802:                                    ; preds = %794
  ...
  %805 = call %struct.Memory* @__remill_error(%struct.State* nonnull dereferenceable(3376) %0, i64 %804, %struct.Memory* %loadMem_400fef)
  br label %routine_ucomisd_MINUS0x28__rbp____xmm0.exit

; <label>:806:                                    ; preds = %block_400f96
...
routine_ucomisd_MINUS0x28__rbp____xmm0.exit:      ; preds = %802, %819
  %823 = phi %struct.Memory* [ %805, %802 ], [ %loadMem_400fef, %819 ]
...
block_400ffa:                                     ; preds = %routine_ucomisd_MINUS0x28__rbp____xmm0.exit
  ...
  store i64 ptrtoint (%G__0x4013ea_type* @G__0x4013ea to i64), i64* %RSI.i, align 8
  ...
  %1002 = call %struct.Memory* @__remill_function_call(%struct.State* %0, i64 ptrtoint (i64 (i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64)* @fprintf to i64), %struct.Memory* %loadMem2_40102b)
...
block_.L_40103f:                                  ; preds = %routine_ucomisd_MINUS0x28__rbp____xmm0.exit
...
block_.L_401044:                                  ; preds = %block_.L_40103f
...
block_.L_401052:                                  ; preds = %block_.L_400f8a
...
block_.L_401065:                                  ; preds = %block_.L_400f77
...
block_.L_40106c:                                  ; preds = %block_.L_401065, %block_400ffa
  ...
  ret %struct.Memory* %loadMem_401074
}
...
define %struct.Memory* @routine_movaps_0x3bf__rip____xmm1(%struct.State* dereferenceable(3376), i64, %struct.Memory*) {
block_400478:
  %3 = getelementptr inbounds %struct.State, %struct.State* %0, i32 0, i32 6
  %4 = getelementptr inbounds %struct.GPR, %struct.GPR* %3, i32 0, i32 33
  %5 = getelementptr inbounds %struct.Reg, %struct.Reg* %4, i32 0, i32 0
...
block_400478:
  ...
  %10 = add i64 %9, 10
  store i64 %10, i64* %PC
  store i64 ptrtoint (%G__0x4013ea_type* @G__0x4013ea to i64), i64* %RSI, align 8
  ret %struct.Memory* %2
}
