...
block_.L_400f87:                                  ; preds = %block_.L_401062, %entry
  %95 = phi i64 [ %.pre, %entry ], [ %464, %block_.L_401062 ]
...
block_.L_400f9a:                                  ; preds = %block_.L_40104f, %block_400f93
  %136 = phi i64 [ %.pre29, %block_400f93 ], [ %434, %block_.L_40104f ]
...
block_40100a:                                     ; preds = %routine_ucomisd_MINUS0x28__rbp____xmm0.exit
  store i64 4199418, i64* %RSI.i143, align 8
...
block_.L_40107c:                                  ; preds = %block_.L_401075, %block_40100a
  %468 = phi i64 [ %.pre31, %block_.L_401075 ], [ %403, %block_40100a ]
  %MEMORY.2 = phi %struct.Memory* [ %MEMORY.0, %block_.L_401075 ], [ %390, %block_40100a ]
