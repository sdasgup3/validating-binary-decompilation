...
block_.L_400f77:                                  ; preds = %block_.L_401052, %entry
  %89 = phi i64 [ %.pre, %entry ], [ %458, %block_.L_401052 ]
  ...
  br i1 %125, label %block_400f83, label %block_.L_401065
...
block_.L_400f8a:                                  ; preds = %block_.L_40103f, %block_400f83
  %130 = phi i64 [ %.pre3, %block_400f83 ], [ %427, %block_.L_40103f ]
  %MEMORY.1 = phi %struct.Memory* [ %MEMORY.0, %block_400f83 ], [ %333, %block_.L_40103f ]
  ...
  br i1 %166, label %block_400f96, label %block_.L_401052
...
routine_ucomisd_MINUS0x28__rbp____xmm0.exit:      ; preds = %331, %319
  ...
  br i1 %337, label %block_.L_40103f, label %block_400ffa
...
block_.L_40106c:                                  ; preds = %block_.L_401065, %block_400ffa
  %462 = phi i64 [ %.pre5, %block_.L_401065 ], [ %395, %block_400ffa ]
  %MEMORY.2 = phi %struct.Memory* [ %MEMORY.0, %block_.L_401065 ], [ %382, %block_400ffa ]
