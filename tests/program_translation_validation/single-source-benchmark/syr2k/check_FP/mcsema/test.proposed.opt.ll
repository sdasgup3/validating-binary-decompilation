...
block_.L_400f87:                                  ; preds = %block_.L_401062, %entry
  %95 = phi i64 [ %.pre, %entry ], [ %463, %block_.L_401062 ]
  %MEMORY.0 = phi %struct.Memory* [ %2, %entry ], [ %MEMORY.1, %block_.L_401062 ]
  ...
  br i1 %131, label %block_400f93, label %block_.L_401075
...
block_.L_400f9a:                                  ; preds = %block_.L_40104f, %block_400f93
  %136 = phi i64 [ %.pre29, %block_400f93 ], [ %433, %block_.L_40104f ]
  %MEMORY.1 = phi %struct.Memory* [ %MEMORY.0, %block_400f93 ], [ %343, %block_.L_40104f ]
  ...
  br i1 %172, label %block_400fa6, label %block_.L_401062
...
routine_ucomisd_MINUS0x28__rbp____xmm0.exit:      ; preds = %341, %329
  ...
  br i1 %347, label %block_.L_40104f, label %block_40100a

block_40100a:                                     ; preds = %routine_ucomisd_MINUS0x28__rbp____xmm0.exit
  store i64 4199418, i64* %RSI.i141, align 8
  ...
  %call2_40103b = tail call %struct.Memory* @sub_400630.fprintf_plt(%struct.State* nonnull %0, i64 %385, %struct.Memory* %343)
...
block_.L_40107c:                                  ; preds = %block_.L_401075, %block_40100a
  %467 = phi i64 [ %.pre31, %block_.L_401075 ], [ %402, %block_40100a ]
  %MEMORY.2 = phi %struct.Memory* [ %MEMORY.0, %block_.L_401075 ], [ %call2_40103b, %block_40100a ]
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_jge_.L_401062(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i8* nocapture %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 2, i32 9
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_jbe_.L_40104f(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i8* nocapture %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_jmpq_.L_401054(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_jmpq_.L_400f87(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
