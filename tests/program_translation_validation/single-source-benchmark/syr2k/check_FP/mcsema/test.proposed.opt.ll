...
block_.L_400f97:                                  ; preds = %block_.L_401072, %entry
  %95 = phi i64 [ %.pre, %entry ], [ %464, %block_.L_401072 ]
  %MEMORY.0 = phi %struct.Memory* [ %2, %entry ], [ %MEMORY.1, %block_.L_401072 ]
  ...
  br i1 %131, label %block_400fa3, label %block_.L_401085
...
block_.L_400faa:                                  ; preds = %block_.L_40105f, %block_400fa3
  %136 = phi i64 [ %.pre29, %block_400fa3 ], [ %434, %block_.L_40105f ]
  %MEMORY.1 = phi %struct.Memory* [ %MEMORY.0, %block_400fa3 ], [ %343, %block_.L_40105f ]
  ...
  br i1 %172, label %block_400fb6, label %block_.L_401072
...
routine_ucomisd_MINUS0x28__rbp____xmm0.exit:      ; preds = %341, %329
  ...
  br i1 %347, label %block_.L_40105f, label %block_40101a

block_40101a:                                     ; preds = %routine_ucomisd_MINUS0x28__rbp____xmm0.exit
  store i64 ptrtoint (%G__0x40140a_type* @G__0x40140a to i64), i64* %RSI.i143, align 8
...
block_.L_40108c:                                  ; preds = %block_.L_401085, %block_40101a
  %468 = phi i64 [ %.pre31, %block_.L_401085 ], [ %403, %block_40101a ]
  %MEMORY.2 = phi %struct.Memory* [ %MEMORY.0, %block_.L_401085 ], [ %390, %block_40101a ]
