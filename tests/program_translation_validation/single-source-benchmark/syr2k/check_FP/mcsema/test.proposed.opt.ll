...
@G_0x438__rip__4198240_ = local_unnamed_addr global %G_0x438__rip__4198240__type zeroinitializer
...
entry:
  ...
  %42 = load i64, i64* bitcast (%G_0x438__rip__4198240__type* @G_0x438__rip__4198240_ to i64*), align 8
...
block_.L_400f77:                                  ; preds = %block_.L_401052, %entry
  %88 = phi i64 [ %.pre, %entry ], [ %450, %block_.L_401052 ]
  %MEMORY.0 = phi %struct.Memory* [ %2, %entry ], [ %MEMORY.1, %block_.L_401052 ]
  ...
  br i1 %124, label %block_400f83, label %block_.L_401065
...
block_.L_400f8a:                                  ; preds = %block_.L_40103f, %block_400f83
  %129 = phi i64 [ %.pre3, %block_400f83 ], [ %420, %block_.L_40103f ]
  %MEMORY.1 = phi %struct.Memory* [ %MEMORY.0, %block_400f83 ], [ %329, %block_.L_40103f ]
  ...
  br i1 %165, label %block_400f96, label %block_.L_401052
...
block_400f96:                                     ; preds = %block_.L_400f8a
  ...
  %278 = load i32, i32* bitcast (%G_0x3bf__rip__4198369__type* @G_0x3bf__rip__4198369_ to i32*), align 8
  %279 = load i32, i32* inttoptr (i64 add (i64 ptrtoint (%G_0x3bf__rip__4198369__type* @G_0x3bf__rip__4198369_ to i64), i64 4) to i32*), align 4
  %280 = load i32, i32* inttoptr (i64 add (i64 ptrtoint (%G_0x3bf__rip__4198369__type* @G_0x3bf__rip__4198369_ to i64), i64 8) to i32*), align 8
  %281 = load i32, i32* inttoptr (i64 add (i64 ptrtoint (%G_0x3bf__rip__4198369__type* @G_0x3bf__rip__4198369_ to i64), i64 12) to i32*), align 4
...
routine_ucomisd_MINUS0x28__rbp____xmm0.exit:      ; preds = %327, %315
  ...
  br i1 %333, label %block_.L_40103f, label %block_400ffa

block_400ffa:                                     ; preds = %routine_ucomisd_MINUS0x28__rbp____xmm0.exit
  store i64 ptrtoint (%G__0x4013ea_type* @G__0x4013ea to i64), i64* %RSI.i143, align 8
...
block_.L_40106c:                                  ; preds = %block_.L_401065, %block_400ffa
  %454 = phi i64 [ %.pre5, %block_.L_401065 ], [ %389, %block_400ffa ]
  %MEMORY.2 = phi %struct.Memory* [ %MEMORY.0, %block_.L_401065 ], [ %376, %block_400ffa ]
...
block_400478:
  ...
  %5 = load i64, i64* bitcast (%G_0x438__rip__4198240__type* @G_0x438__rip__4198240_ to i64*), align 8
...
define %struct.Memory* @routine_jge_.L_401052(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i8* %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 2, i32 9
...
block_400478:
  ...
  %6 = add i64 %5, 7
  store i64 %6, i64* %PC, align 8
  %7 = load i32, i32* bitcast (%G_0x3bf__rip__4198369__type* @G_0x3bf__rip__4198369_ to i32*), align 8
  %8 = load i32, i32* inttoptr (i64 add (i64 ptrtoint (%G_0x3bf__rip__4198369__type* @G_0x3bf__rip__4198369_ to i64), i64 4) to i32*), align 4
  %9 = load i32, i32* inttoptr (i64 add (i64 ptrtoint (%G_0x3bf__rip__4198369__type* @G_0x3bf__rip__4198369_ to i64), i64 8) to i32*), align 8
  %10 = load i32, i32* inttoptr (i64 add (i64 ptrtoint (%G_0x3bf__rip__4198369__type* @G_0x3bf__rip__4198369_ to i64), i64 12) to i32*), align 4
...
define %struct.Memory* @routine_jbe_.L_40103f(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i8* %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
...
define %struct.Memory* @routine_movq__0x4013ea___rsi(%struct.State* dereferenceable(3376), i64, %struct.Memory*) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %RSI = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 9, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
...
define %struct.Memory* @routine_jmpq_.L_40106c(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
...
define %struct.Memory* @routine_jmpq_.L_401044(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
