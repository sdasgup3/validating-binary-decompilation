; ModuleID = '/tmp/tmpmn7kg6kn-query.ll'
...
entry:
  ...
  br i1 %var_2_13122, label %block_400fa3.preheader, label %block_.L_40108c
...
block_.L_400f97.loopexit:                         ; preds = %block_.L_400f97.loopexit.loopexit, %block_400fa3
  %var_2_137.lcssa = phi i64 [ %var_2_1379, %block_400fa3 ], [ %var_2_137.pre, %block_.L_400f97.loopexit.loopexit ]
  %MEMORY.1.lcssa = phi %struct.Memory* [ %MEMORY.023, %block_400fa3 ], [ %var_2_343, %block_.L_400f97.loopexit.loopexit ]
  %var_2_146.lcssa = phi i32 [ %var_2_14624, %block_400fa3 ], [ %var_2_146, %block_.L_400f97.loopexit.loopexit ]
  %var_2_165.lcssa = phi i32 [ %var_2_16528, %block_400fa3 ], [ %var_2_165, %block_.L_400f97.loopexit.loopexit ]
  ...
  br i1 %var_2_131, label %block_400fa3, label %block_.L_40108c.loopexit

block_400fa3:                                     ; preds = %block_400fa3.preheader, %block_.L_400f97.loopexit
  %var_2_1379 = phi i64 [ %var_2_137.lcssa, %block_.L_400f97.loopexit ], [ %var_2_966, %block_400fa3.preheader ]
  %MEMORY.023 = phi %struct.Memory* [ %MEMORY.1.lcssa, %block_.L_400f97.loopexit ], [ %2, %block_400fa3.preheader ]
  ...
  br i1 %var_2_17234, label %block_400fb6.preheader, label %block_.L_400f97.loopexit
...
block_400fb6:                                     ; preds = %block_400fb6.preheader, %routine_ucomisd_MINUS0x28__rbp____xmm0.exit.block_.L_400faa_crit_edge
  %MEMORY.136 = phi %struct.Memory* [ %var_2_343, %routine_ucomisd_MINUS0x28__rbp____xmm0.exit.block_.L_400faa_crit_edge ], [ %MEMORY.023, %block_400fb6.preheader ]
  %var_2_13735 = phi i64 [ %var_2_137.pre, %routine_ucomisd_MINUS0x28__rbp____xmm0.exit.block_.L_400faa_crit_edge ], [ %var_2_1379, %block_400fb6.preheader ]
...
routine_ucomisd_MINUS0x28__rbp____xmm0.exit:      ; preds = %var_2_329, %var_2_321, %block_400fb6
  %var_2_343 = phi %struct.Memory* [ %var_2_330, %var_2_329 ], [ %MEMORY.136, %var_2_321 ], [ %MEMORY.136, %block_400fb6 ]
  ...
  br i1 %var_2_347, label %block_40101a, label %routine_ucomisd_MINUS0x28__rbp____xmm0.exit.block_.L_400faa_crit_edge
...
block_.L_40108c.loopexit:                         ; preds = %block_.L_400f97.loopexit
  br label %block_.L_40108c

block_.L_40108c:                                  ; preds = %block_.L_40108c.loopexit, %block_40101a, %entry
  %MEMORY.2 = phi %struct.Memory* [ %var_2_390, %block_40101a ], [ %2, %entry ], [ %MEMORY.1.lcssa, %block_.L_40108c.loopexit ]
