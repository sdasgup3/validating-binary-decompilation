; ModuleID = '/tmp/tmpr7lk1y_w-query.ll'
...
entry:
  ...
  br i1 %var_2_13121, label %block_400fa3.preheader, label %block_.L_40108c

block_400fa3.preheader:                           ; preds = %entry
  br label %block_400fa3

block_.L_400f97.loopexit.loopexit:                ; preds = %routine_ucomisd_MINUS0x28__rbp____xmm0.exit.block_.L_400faa_crit_edge
  br label %block_.L_400f97.loopexit

block_.L_400f97.loopexit:                         ; preds = %block_.L_400f97.loopexit.loopexit, %block_400fa3
  %var_2_137.lcssa = phi i64 [ %var_2_13711, %block_400fa3 ], [ %var_2_137.pre, %block_.L_400f97.loopexit.loopexit ]
  %MEMORY.1.lcssa = phi %struct.Memory* [ %MEMORY.022, %block_400fa3 ], [ %var_2_343, %block_.L_400f97.loopexit.loopexit ]
  %var_2_146.lcssa = phi i32 [ %var_2_14628, %block_400fa3 ], [ %var_2_146, %block_.L_400f97.loopexit.loopexit ]
  %var_2_165.lcssa = phi i32 [ %var_2_16532, %block_400fa3 ], [ %var_2_165, %block_.L_400f97.loopexit.loopexit ]
  ...
  br i1 %var_2_131, label %block_400fa3, label %block_.L_40108c.loopexit17

block_400fa3:                                     ; preds = %block_400fa3.preheader, %block_.L_400f97.loopexit
  %var_2_13711 = phi i64 [ %var_2_137.lcssa, %block_.L_400f97.loopexit ], [ %var_2_965, %block_400fa3.preheader ]
  %MEMORY.022 = phi %struct.Memory* [ %MEMORY.1.lcssa, %block_.L_400f97.loopexit ], [ %2, %block_400fa3.preheader ]
  ...
  br i1 %var_2_17238, label %block_400fb6.preheader, label %block_.L_400f97.loopexit

block_400fb6.preheader:                           ; preds = %block_400fa3
  br label %block_400fb6

block_400fb6:                                     ; preds = %block_400fb6.preheader, %routine_ucomisd_MINUS0x28__rbp____xmm0.exit.block_.L_400faa_crit_edge
  %MEMORY.140 = phi %struct.Memory* [ %var_2_343, %routine_ucomisd_MINUS0x28__rbp____xmm0.exit.block_.L_400faa_crit_edge ], [ %MEMORY.022, %block_400fb6.preheader ]
  %var_2_13739 = phi i64 [ %var_2_137.pre, %routine_ucomisd_MINUS0x28__rbp____xmm0.exit.block_.L_400faa_crit_edge ], [ %var_2_13711, %block_400fb6.preheader ]
  ...
  %var_2_286 = add i64 %var_2_276, add (i64 ptrtoint (%G_0x3bf__rip__type* @G_0x3bf__rip_ to i64), i64 10)
  ...
  %var_2_290 = add i64 %var_2_276, add (i64 ptrtoint (%G_0x3bf__rip__type* @G_0x3bf__rip_ to i64), i64 14)
  %var_2_291 = inttoptr i64 %var_2_290 to i32*
  %var_2_292 = load i32, i32* %var_2_291, align 4
  %var_2_293 = add i64 %var_2_276, add (i64 ptrtoint (%G_0x3bf__rip__type* @G_0x3bf__rip_ to i64), i64 18)
  %var_2_294 = inttoptr i64 %var_2_293 to i32*
  %var_2_295 = load i32, i32* %var_2_294, align 4
  %var_2_296 = add i64 %var_2_276, add (i64 ptrtoint (%G_0x3bf__rip__type* @G_0x3bf__rip_ to i64), i64 22)
...
routine_ucomisd_MINUS0x28__rbp____xmm0.exit:      ; preds = %var_2_329, %var_2_321, %block_400fb6
  %var_2_343 = phi %struct.Memory* [ %var_2_330, %var_2_329 ], [ %MEMORY.140, %var_2_321 ], [ %MEMORY.140, %block_400fb6 ]
  ...
  br i1 %var_2_347, label %block_.L_40108c.loopexit, label %routine_ucomisd_MINUS0x28__rbp____xmm0.exit.block_.L_400faa_crit_edge

routine_ucomisd_MINUS0x28__rbp____xmm0.exit.block_.L_400faa_crit_edge: ; preds = %routine_ucomisd_MINUS0x28__rbp____xmm0.exit
  ...
  br i1 %var_2_172, label %block_400fb6, label %block_.L_400f97.loopexit.loopexit

block_.L_40108c.loopexit:                         ; preds = %routine_ucomisd_MINUS0x28__rbp____xmm0.exit
  br label %block_.L_40108c

block_.L_40108c.loopexit17:                       ; preds = %block_.L_400f97.loopexit
  br label %block_.L_40108c

block_.L_40108c:                                  ; preds = %block_.L_40108c.loopexit17, %block_.L_40108c.loopexit, %entry
...
; Function Attrs: alwaysinline norecurse nounwind
define %struct.Memory* @routine_jge_.L_401072(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i8* nocapture %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 2, i32 9
...
; Function Attrs: alwaysinline norecurse nounwind
define %struct.Memory* @routine_jbe_.L_40105f(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i8* nocapture %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
...
; Function Attrs: alwaysinline norecurse nounwind
define %struct.Memory* @routine_jmpq_.L_40108c(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
...
; Function Attrs: alwaysinline norecurse nounwind
define %struct.Memory* @routine_jmpq_.L_401064(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
...
; Function Attrs: alwaysinline norecurse nounwind
define %struct.Memory* @routine_jmpq_.L_400f97(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
