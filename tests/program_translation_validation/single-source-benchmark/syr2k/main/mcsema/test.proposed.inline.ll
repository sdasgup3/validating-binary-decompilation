...
declare %struct.Memory* @sub_400aa0.init_array(%struct.State* dereferenceable(3376), i64, %struct.Memory*)

declare %struct.Memory* @sub_400c20.kernel_syr2k(%struct.State* dereferenceable(3376), i64, %struct.Memory*)

declare %struct.Memory* @sub_400dc0.kernel_syr2k_StrictFP(%struct.State* dereferenceable(3376), i64, %struct.Memory*)

declare %struct.Memory* @sub_400f60.check_FP(%struct.State* dereferenceable(3376), i64, %struct.Memory*)

declare %struct.Memory* @sub_401090.print_array(%struct.State* dereferenceable(3376), i64, %struct.Memory*)
