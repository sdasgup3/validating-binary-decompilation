...
block_.L_4010bc:                                  ; preds = %block_.L_401112, %entry
  %117 = phi i64 [ %.pre, %entry ], [ %348, %block_.L_401112 ]
  %MEMORY.0 = phi %struct.Memory* [ %73, %entry ], [ %310, %block_.L_401112 ]
  ...
  br i1 %153, label %block_4010c8, label %block_.L_401134
...
block_.L_4010cf:                                  ; preds = %block_4010db, %block_4010c8
  %158 = phi i64 [ %.pre1, %block_4010c8 ], [ %299, %block_4010db ]
  ...
  br i1 %194, label %block_4010db, label %block_.L_401112
...
block_4010db:                                     ; preds = %block_.L_4010cf
  ...
  %call2_4010ff = tail call %struct.Memory* @sub_401150.print_element(%struct.State* %0, i64 %263, %struct.Memory* %MEMORY.1)
