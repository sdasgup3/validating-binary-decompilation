...
block_.L_4010cc:                                  ; preds = %block_.L_401122, %entry
  %124 = phi i64 [ %.pre, %entry ], [ %355, %block_.L_401122 ]
  %MEMORY.0 = phi %struct.Memory* [ %79, %entry ], [ %317, %block_.L_401122 ]
  ...
  store i64 %130, i64* %RAX.i95, align 8
  %131 = add i64 %125, -4
  %132 = add i64 %124, 6
  ...
  %160 = xor i1 %159, %157
  %.v = select i1 %160, i64 12, i64 120
  %161 = add i64 %124, %.v
  store i64 %161, i64* %3, align 8
  br i1 %160, label %block_4010d8, label %block_.L_401144
...
block_.L_4010df:                                  ; preds = %block_4010eb, %block_4010d8
  %165 = phi i64 [ %306, %block_4010eb ], [ %.pre9, %block_4010d8 ]
  ...
  store i64 %171, i64* %RAX.i95, align 8
  %172 = add i64 %166, -4
  %173 = add i64 %165, 6
  ...
  %201 = xor i1 %200, %198
  %.v10 = select i1 %201, i64 12, i64 67
  %202 = add i64 %165, %.v10
  store i64 %202, i64* %3, align 8
  br i1 %201, label %block_4010eb, label %block_.L_401122
...
block_4010eb:                                     ; preds = %block_.L_4010df
  ...
  store i64 %212, i64* %RCX.i89, align 8
  %213 = add i64 %212, %206
  store i64 %213, i64* %RAX.i95, align 8
  ...
  store i64 %242, i64* %RCX.i89, align 8
  ...
  store i64 %247, i64* %121, align 1
  store double 0.000000e+00, double* %123, align 1
  %248 = add i64 %202, 27
  store i64 %248, i64* %3, align 8
  %249 = load i32, i32* %169, align 4
  %250 = shl i32 %249, 4
  ...
  %call2_40110f = tail call %struct.Memory* @sub_401160.print_element(%struct.State* nonnull %0, i64 %270, %struct.Memory* %MEMORY.0)
...
block_.L_401122:                                  ; preds = %block_.L_4010df
  ...
  store i64 %310, i64* %RDI.i108, align 8
  %311 = load i64, i64* inttoptr (i64 6299776 to i64*), align 128
  store i64 %311, i64* %RSI.i111, align 8
  %312 = add i64 %202, -2834
  %313 = add i64 %202, 17
  ...
  %317 = tail call %struct.Memory* @__remill_function_call(%struct.State* nonnull %0, i64 ptrtoint (i64 (i64, i64)* @fputs to i64), %struct.Memory* %MEMORY.0)
  %318 = load i64, i64* %RBP.i, align 8
  %319 = add i64 %318, -36
  %320 = load i32, i32* %EAX.i74, align 4
  ...
  store i64 %331, i64* %RAX.i95, align 8
...
block_.L_401144:                                  ; preds = %block_.L_4010cc
  ...
  store i64 %359, i64* %RDI.i108, align 8
  %360 = add i64 %161, -2900
  %361 = add i64 %161, 9
  ...
  %365 = tail call %struct.Memory* @__remill_function_call(%struct.State* nonnull %0, i64 ptrtoint (i64 (i64)* @free to i64), %struct.Memory* %MEMORY.0)
