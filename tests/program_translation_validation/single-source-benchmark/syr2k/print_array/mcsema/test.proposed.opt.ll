...
declare %struct.Memory* @sub_401150.print_element(%struct.State* noalias dereferenceable(3376), i64, %struct.Memory* noalias readnone returned) local_unnamed_addr
...
block_.L_4010bc:                                  ; preds = %block_.L_401112, %entry
  %123 = phi i64 [ %.pre, %entry ], [ %357, %block_.L_401112 ]
  %MEMORY.0 = phi %struct.Memory* [ %79, %entry ], [ %318, %block_.L_401112 ]
  ...
  br i1 %159, label %block_4010c8, label %block_.L_401134
...
block_.L_4010cf:                                  ; preds = %block_4010db, %block_4010c8
  %164 = phi i64 [ %.pre1, %block_4010c8 ], [ %307, %block_4010db ]
  %MEMORY.1 = phi %struct.Memory* [ %MEMORY.0, %block_4010c8 ], [ %call2_4010ff, %block_4010db ]
  ...
  br i1 %200, label %block_4010db, label %block_.L_401112
...
block_4010db:                                     ; preds = %block_.L_4010cf
  ...
  %call2_4010ff = tail call %struct.Memory* @sub_401150.print_element(%struct.State* %0, i64 %270, %struct.Memory* %MEMORY.1)
...
define %struct.Memory* @routine_jge_.L_401134(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i8* %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
...
define %struct.Memory* @routine_jge_.L_401112(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i8* %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 2, i32 9
...
define %struct.Memory* @routine_jmpq_.L_4010cf(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
