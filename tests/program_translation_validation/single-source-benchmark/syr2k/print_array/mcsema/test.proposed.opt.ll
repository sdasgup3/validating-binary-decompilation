...
block_.L_4010bc:                                  ; preds = %block_.L_401112, %entry
  %117 = phi i64 [ %.pre, %entry ], [ %349, %block_.L_401112 ]
  %MEMORY.0 = phi %struct.Memory* [ %73, %entry ], [ %311, %block_.L_401112 ]
...
block_.L_4010cf:                                  ; preds = %block_4010db, %block_4010c8
  %158 = phi i64 [ %.pre1, %block_4010c8 ], [ %300, %block_4010db ]
...
block_4010db:                                     ; preds = %block_.L_4010cf
  ...
  %call2_4010ff = tail call %struct.Memory* @sub_401150.print_element(%struct.State* %0, i64 %264, %struct.Memory* %MEMORY.1)
