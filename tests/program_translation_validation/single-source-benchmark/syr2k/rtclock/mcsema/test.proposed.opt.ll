...
define %struct.Memory* @rtclock(%struct.State* noalias nocapture, i64, %struct.Memory* noalias readnone returned) local_unnamed_addr #0 {
entry:
  ...
  %12 = bitcast %union.VectorReg* %11 to <4 x i32>*
  store <4 x i32> zeroinitializer, <4 x i32>* %12, align 1
  %13 = add i64 %10, 7
