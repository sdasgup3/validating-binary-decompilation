; ModuleID = '/home/sdasgup3/Github/validating-binary-decompilation/tests/program_translation_validation/single-source-benchmark/bc-seeds/syr2k/syr2k.bc'
...
entry:
  ...
  call void @kernel_syr2k(i32 %10, i32 %11, double %12, double %13, [1024 x double]* %arraydecay7, [1024 x double]* %arraydecay8, [1024 x double]* %arraydecay9)
  ...
  call void @kernel_syr2k_StrictFP(i32 %17, i32 %18, double %19, double %20, [1024 x double]* %arraydecay10, [1024 x double]* %arraydecay11, [1024 x double]* %arraydecay12)
  %24 = load i32, i32* %ni, align 4
  %25 = load [1024 x [1024 x double]]*, [1024 x [1024 x double]]** %C, align 8
  %arraydecay13 = getelementptr inbounds [1024 x [1024 x double]], [1024 x [1024 x double]]* %25, i32 0, i32 0
  %26 = load [1024 x [1024 x double]]*, [1024 x [1024 x double]]** %C_StrictFP, align 8
  %arraydecay14 = getelementptr inbounds [1024 x [1024 x double]], [1024 x [1024 x double]]* %26, i32 0, i32 0
  %call15 = call i32 @check_FP(i32 %24, [1024 x double]* %arraydecay13, [1024 x double]* %arraydecay14)
...
if.end:                                           ; preds = %entry
  ...
  %28 = load [1024 x [1024 x double]]*, [1024 x [1024 x double]]** %C_StrictFP, align 8
  %arraydecay16 = getelementptr inbounds [1024 x [1024 x double]], [1024 x [1024 x double]]* %28, i32 0, i32 0
  call void @print_array(i32 %27, [1024 x double]* %arraydecay16)
  ...
  %31 = load [1024 x [1024 x double]]*, [1024 x [1024 x double]]** %C_StrictFP, align 8
...
for.body3:                                        ; preds = %for.cond1
  ...
  %arrayidx14 = getelementptr inbounds [1024 x double], [1024 x double]* %15, i64 %idxprom13
...
for.cond20:                                       ; preds = %for.inc44, %for.end19
...
for.cond24:                                       ; preds = %for.inc41, %for.body23
  ...
  br i1 %cmp25, label %for.body27, label %for.end43
...
for.body27:                                       ; preds = %for.cond24
  ...
  %27 = load [1024 x double]*, [1024 x double]** %C.addr, align 8
  %28 = load i32, i32* %i, align 4
  %idxprom33 = sext i32 %28 to i64
  %arrayidx34 = getelementptr inbounds [1024 x double], [1024 x double]* %27, i64 %idxprom33
  ...
  %30 = load [1024 x double]*, [1024 x double]** %C_StrictFP.addr, align 8
  ...
  store double %div32, double* %arrayidx40, align 8
  br label %for.inc41
...
for.cond9:                                        ; preds = %for.inc53, %for.end8
  ...
  br i1 %cmp10, label %for.body11, label %for.end55
...
for.body17:                                       ; preds = %for.cond15
  ...
  %22 = load [1024 x double]*, [1024 x double]** %B.addr, align 8
  ...
  %31 = load [1024 x double]*, [1024 x double]** %B.addr, align 8
  ...
  %arrayidx38 = getelementptr inbounds [1024 x double], [1024 x double]* %35, i64 %idxprom37
  %37 = load i32, i32* %k, align 4
  %idxprom39 = sext i32 %37 to i64
  %arrayidx40 = getelementptr inbounds [1024 x double], [1024 x double]* %arrayidx38, i64 0, i64 %idxprom39
  %38 = load double, double* %arrayidx40, align 8
  %mul41 = fmul double %mul36, %38
  %39 = load [1024 x double]*, [1024 x double]** %C.addr, align 8
  ...
  %arrayidx45 = getelementptr inbounds [1024 x double], [1024 x double]* %arrayidx43, i64 0, i64 %idxprom44
...
; Function Attrs: noinline nounwind uwtable
define internal void @kernel_syr2k_StrictFP(i32 %ni, i32 %nj, double %alpha, double %beta, [1024 x double]* %C, [1024 x double]* %A, [1024 x double]* %B) #0 {
entry:
  %ni.addr = alloca i32, align 4
  %nj.addr = alloca i32, align 4
  %alpha.addr = alloca double, align 8
