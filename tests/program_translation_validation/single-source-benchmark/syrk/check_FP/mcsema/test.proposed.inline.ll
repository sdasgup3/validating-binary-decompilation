...
@G__0x4012da = global %G__0x4012da_type zeroinitializer
...
block_.L_400e67:                                  ; preds = %block_.L_400f47, %entry
  ...
  br i1 %cmpBr_400e6d, label %block_.L_400f55, label %block_400e73
...
block_.L_400e7a:                                  ; preds = %block_.L_400f34, %block_400e73
  ...
  br i1 %cmpBr_400e80, label %block_.L_400f42, label %block_400e86

block_400e86:                                     ; preds = %block_.L_400e7a
...
; <label>:802:                                    ; preds = %794
  ...
  %805 = call %struct.Memory* @__remill_error(%struct.State* nonnull dereferenceable(3376) %0, i64 %804, %struct.Memory* %loadMem_400edf)
  br label %routine_ucomisd_MINUS0x28__rbp____xmm0.exit

; <label>:806:                                    ; preds = %block_400e86
...
routine_ucomisd_MINUS0x28__rbp____xmm0.exit:      ; preds = %802, %819
  %823 = phi %struct.Memory* [ %805, %802 ], [ %loadMem_400edf, %819 ]
  ...
  br i1 %cmpBr_400ee4, label %block_.L_400f2f, label %block_400eea

block_400eea:                                     ; preds = %routine_ucomisd_MINUS0x28__rbp____xmm0.exit
  ...
  store i64 ptrtoint (%G__0x4012da_type* @G__0x4012da to i64), i64* %RSI.i, align 8
  ...
  %loadMem1_400f1b = load %struct.Memory*, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem1_400f1b, %struct.Memory** %MEMORY
  %loadMem2_400f1b = load %struct.Memory*, %struct.Memory** %MEMORY
  %loadPC_400f1b = load i64, i64* %3
  %1002 = call %struct.Memory* @__remill_function_call(%struct.State* %0, i64 ptrtoint (i64 (i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64)* @fprintf to i64), %struct.Memory* %loadMem2_400f1b)
...
block_.L_400f2f:                                  ; preds = %routine_ucomisd_MINUS0x28__rbp____xmm0.exit
  ...
  br label %block_.L_400f34

block_.L_400f34:                                  ; preds = %block_.L_400f2f
...
block_.L_400f42:                                  ; preds = %block_.L_400e7a
...
block_.L_400f47:                                  ; preds = %block_.L_400f42
...
block_.L_400f55:                                  ; preds = %block_.L_400e67
...
block_.L_400f5c:                                  ; preds = %block_.L_400f55, %block_400eea
  ...
  ret %struct.Memory* %loadMem_400f64
}
...
define %struct.Memory* @routine_jge_.L_400f42(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i8* %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) {
block_400478:
  %3 = getelementptr inbounds %struct.State, %struct.State* %0, i32 0, i32 6
  %4 = getelementptr inbounds %struct.GPR, %struct.GPR* %3, i32 0, i32 33
  %5 = getelementptr inbounds %struct.Reg, %struct.Reg* %4, i32 0, i32 0
...
define %struct.Memory* @routine_jbe_.L_400f2f(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i8* %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) {
block_400478:
  %3 = getelementptr inbounds %struct.State, %struct.State* %0, i32 0, i32 6
  %4 = getelementptr inbounds %struct.GPR, %struct.GPR* %3, i32 0, i32 33
  %5 = getelementptr inbounds %struct.Reg, %struct.Reg* %4, i32 0, i32 0
...
define %struct.Memory* @routine_movq__0x4012da___rsi(%struct.State* dereferenceable(3376), i64, %struct.Memory*) {
block_400478:
  %3 = getelementptr inbounds %struct.State, %struct.State* %0, i32 0, i32 6
  %4 = getelementptr inbounds %struct.GPR, %struct.GPR* %3, i32 0, i32 33
  %5 = getelementptr inbounds %struct.Reg, %struct.Reg* %4, i32 0, i32 0
  ...
  %10 = add i64 %9, 10
  store i64 %10, i64* %PC
  store i64 ptrtoint (%G__0x4012da_type* @G__0x4012da to i64), i64* %RSI, align 8
  ret %struct.Memory* %2
}
...
define %struct.Memory* @routine_jmpq_.L_400f34(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i64 %rel_off1, i64 %rel_off2) {
block_400478:
  %3 = getelementptr inbounds %struct.State, %struct.State* %0, i32 0, i32 6
  %4 = getelementptr inbounds %struct.GPR, %struct.GPR* %3, i32 0, i32 33
  %5 = getelementptr inbounds %struct.Reg, %struct.Reg* %4, i32 0, i32 0
