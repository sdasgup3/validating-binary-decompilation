; ModuleID = '/tmp/tmpangzoduv-query.ll'
source_filename = "llvm-link"
target datalayout = "e-m:e-i64:64-f80:128-n8:16:32:64-S128"
target triple = "x86_64-pc-linux-gnu-elf"

%__bss_start_type = type <{ [8 x i8] }>
%G_0x818__rip__type = type <{ [8 x i8] }>
...
@G_0x818__rip_ = global %G_0x818__rip__type zeroinitializer
...
entry:
  ...
  %var_2_16 = add i64 %1, add (i64 ptrtoint (%G_0x818__rip__type* @G_0x818__rip_ to i64), i64 8)
  ...
  %var_2_25 = add i64 %1, add (i64 ptrtoint (%G_0x818__rip__type* @G_0x818__rip_ to i64), i64 16)
  %var_2_26 = add i64 %1, 24
  store i64 %var_2_26, i64* %var_2_3, align 8
  %var_2_27 = inttoptr i64 %var_2_25 to i64*
  %var_2_28 = load i64, i64* %var_2_27, align 8
  %var_2_30 = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 1, i64 1, i32 0, i32 0, i32 0, i64 0
  store i64 %var_2_28, i64* %var_2_30, align 1
  %var_2_10519 = load i64, i64* %RBP.i, align 8
  %var_2_10620 = add i64 %var_2_10519, -52
  %var_2_10821 = inttoptr i64 %var_2_10620 to i32*
  %var_2_10922 = load i32, i32* %var_2_10821, align 4
  %var_2_11123 = add i64 %var_2_10519, -4
  %var_2_11324 = inttoptr i64 %var_2_11123 to i32*
  %var_2_11425 = load i32, i32* %var_2_11324, align 4
  %var_2_11526 = sub i32 %var_2_10922, %var_2_11425
  %var_2_13027 = lshr i32 %var_2_11526, 31
  %var_2_13228 = lshr i32 %var_2_10922, 31
  %var_2_13329 = lshr i32 %var_2_11425, 31
  %var_2_13430 = xor i32 %var_2_13329, %var_2_13228
  %var_2_13531 = xor i32 %var_2_13027, %var_2_13228
  %var_2_13632 = add nuw nsw i32 %var_2_13531, %var_2_13430
  %var_2_13733 = icmp eq i32 %var_2_13632, 2
  %var_2_13934 = icmp ne i32 %var_2_13027, 0
  %var_2_14035 = xor i1 %var_2_13934, %var_2_13733
  br i1 %var_2_14035, label %block_400ad5.preheader, label %block_.L_400bc6

block_400ad5.preheader:                           ; preds = %entry
  %var_2_147 = add i64 %var_2_10519, -56
  %var_2_149 = inttoptr i64 %var_2_147 to i32*
  %var_2_150 = load i32, i32* %var_2_149, align 4
  %var_2_152 = add i64 %var_2_10519, -8
  %var_2_154 = inttoptr i64 %var_2_152 to i32*
  %var_2_155 = load i32, i32* %var_2_154, align 4
  %var_2_156 = sub i32 %var_2_150, %var_2_155
  %var_2_171 = lshr i32 %var_2_156, 31
  %var_2_173 = lshr i32 %var_2_150, 31
  %var_2_174 = lshr i32 %var_2_155, 31
  %var_2_175 = xor i32 %var_2_174, %var_2_173
  %var_2_176 = xor i32 %var_2_171, %var_2_173
  %var_2_177 = add nuw nsw i32 %var_2_176, %var_2_175
  %var_2_178 = icmp eq i32 %var_2_177, 2
  %var_2_180 = icmp ne i32 %var_2_171, 0
  %var_2_181 = xor i1 %var_2_180, %var_2_178
  br i1 %var_2_181, label %block_.L_400adc.preheader, label %block_400ad5.preheader8

block_400ad5.preheader8:                          ; preds = %block_400ad5.preheader
  br label %block_400ad5

block_.L_400adc.preheader:                        ; preds = %block_400ad5.preheader
  br label %block_.L_400adc

block_400ad5:                                     ; preds = %block_400ad5.preheader8, %block_400ad5
  br label %block_400ad5

block_.L_400adc:                                  ; preds = %block_.L_400adc.preheader, %block_.L_400adc
  br label %block_.L_400adc

block_.L_400bc6:                                  ; preds = %entry
  ret %struct.Memory* %2
}
...
block_400488:
  ...
  %4 = add i64 %3, ptrtoint (%G_0x818__rip__type* @G_0x818__rip_ to i64)
  %5 = add i64 %3, 8
  store i64 %5, i64* %PC, align 8
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_jge_.L_400b38(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i8* nocapture %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_jmpq_.L_400adc(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_jge_.L_400bc6(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i8* nocapture %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 2, i32 9
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_jge_.L_400bb3(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i8* nocapture %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 2, i32 9
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_jmpq_.L_400b52(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_jmpq_.L_400bb8(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
