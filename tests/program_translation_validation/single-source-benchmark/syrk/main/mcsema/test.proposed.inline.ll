...
declare %struct.Memory* @sub_400bc0.kernel_syrk(%struct.State* dereferenceable(3376), i64, %struct.Memory*)

declare %struct.Memory* @sub_400d10.kernel_syrk_StrictFP(%struct.State* dereferenceable(3376), i64, %struct.Memory*)

declare %struct.Memory* @sub_400e60.check_FP(%struct.State* dereferenceable(3376), i64, %struct.Memory*)
