...
entry:
  ...
  store %struct.Memory* %loadMem1_400f8b, %struct.Memory** %MEMORY
  %loadMem2_400f8b = load %struct.Memory*, %struct.Memory** %MEMORY
  %loadPC_400f8b = load i64, i64* %3
  %216 = call %struct.Memory* @__remill_function_call(%struct.State* %0, i64 ptrtoint (i64 (i64)* @malloc to i64), %struct.Memory* %loadMem2_400f8b)
...
block_400fcb:                                     ; preds = %block_.L_400fbf
  ...
  store %struct.Memory* %loadMem1_400fef, %struct.Memory** %MEMORY
...
block_.L_401002:                                  ; preds = %block_.L_400fbf
  ...
  %862 = call %struct.Memory* @__remill_function_call(%struct.State* %0, i64 ptrtoint (i64 (i64, i64)* @fputs to i64), %struct.Memory* %loadMem2_40100e)
...
block_.L_401024:                                  ; preds = %block_.L_400fac
  ...
  %990 = call %struct.Memory* @__remill_function_call(%struct.State* %0, i64 ptrtoint (i64 (i64)* @free to i64), %struct.Memory* %loadMem2_401028)
  ...
  ret %struct.Memory* %loadMem_401032
}
