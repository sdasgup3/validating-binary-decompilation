...
block_.L_400fac:                                  ; preds = %block_.L_401002, %entry
  %123 = phi i64 [ %.pre, %entry ], [ %357, %block_.L_401002 ]
  %MEMORY.0 = phi %struct.Memory* [ %79, %entry ], [ %318, %block_.L_401002 ]
  ...
  br i1 %159, label %block_400fb8, label %block_.L_401024
...
block_.L_400fbf:                                  ; preds = %block_400fcb, %block_400fb8
  %164 = phi i64 [ %.pre1, %block_400fb8 ], [ %307, %block_400fcb ]
  ...
  br i1 %200, label %block_400fcb, label %block_.L_401002
...
block_400fcb:                                     ; preds = %block_.L_400fbf
  ...
  %call2_400fef = tail call %struct.Memory* @sub_401040.print_element(%struct.State* %0, i64 %270, %struct.Memory* %MEMORY.1)
