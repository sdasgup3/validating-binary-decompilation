...
declare %struct.Memory* @sub_401040.print_element(%struct.State* noalias dereferenceable(3376), i64, %struct.Memory* noalias readnone returned) local_unnamed_addr
...
block_.L_400fac:                                  ; preds = %block_.L_401002, %entry
  %117 = phi i64 [ %.pre, %entry ], [ %349, %block_.L_401002 ]
  %MEMORY.0 = phi %struct.Memory* [ %73, %entry ], [ %311, %block_.L_401002 ]
  ...
  br i1 %153, label %block_400fb8, label %block_.L_401024

block_400fb8:                                     ; preds = %block_.L_400fac
  %155 = add i64 %118, -24
  %156 = add i64 %154, 7
...
block_.L_400fbf:                                  ; preds = %block_400fcb, %block_400fb8
  %158 = phi i64 [ %.pre1, %block_400fb8 ], [ %300, %block_400fcb ]
  %MEMORY.1 = phi %struct.Memory* [ %MEMORY.0, %block_400fb8 ], [ %call2_400fef, %block_400fcb ]
  ...
  br i1 %194, label %block_400fcb, label %block_.L_401002

block_400fcb:                                     ; preds = %block_.L_400fbf
  %196 = add i64 %159, -16
  %197 = add i64 %195, 4
  ...
  %call2_400fef = tail call %struct.Memory* @sub_401040.print_element(%struct.State* %0, i64 %264, %struct.Memory* %MEMORY.1)
...
block_.L_401002:                                  ; preds = %block_.L_400fbf
  %301 = add i64 %159, -32
  %302 = add i64 %195, 4
...
block_.L_401024:                                  ; preds = %block_.L_400fac
  %350 = add i64 %118, -32
  %351 = add i64 %154, 4
...
define %struct.Memory* @routine_jge_.L_401024(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i8* %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
...
define %struct.Memory* @routine_jge_.L_401002(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i8* %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 2, i32 9
...
define %struct.Memory* @routine_jmpq_.L_400fbf(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
...
define %struct.Memory* @routine_jmpq_.L_400fac(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
