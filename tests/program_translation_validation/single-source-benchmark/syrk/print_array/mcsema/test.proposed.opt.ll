...
declare %struct.Memory* @sub_401070.print_element(%struct.State* noalias dereferenceable(3376), i64, %struct.Memory* noalias readnone returned) local_unnamed_addr
...
block_.L_400fdc:                                  ; preds = %block_.L_401032, %entry
  %124 = phi i64 [ %.pre, %entry ], [ %355, %block_.L_401032 ]
  %MEMORY.0 = phi %struct.Memory* [ %79, %entry ], [ %317, %block_.L_401032 ]
  ...
  br i1 %160, label %block_400fe8, label %block_.L_401054

block_400fe8:                                     ; preds = %block_.L_400fdc
  %162 = add i64 %125, -24
  %163 = add i64 %161, 7
...
block_.L_400fef:                                  ; preds = %block_400ffb, %block_400fe8
  %165 = phi i64 [ %306, %block_400ffb ], [ %.pre9, %block_400fe8 ]
  ...
  br i1 %201, label %block_400ffb, label %block_.L_401032
...
block_400ffb:                                     ; preds = %block_.L_400fef
  ...
  %call2_40101f = tail call %struct.Memory* @sub_401070.print_element(%struct.State* nonnull %0, i64 %270, %struct.Memory* %MEMORY.0)
...
block_.L_401032:                                  ; preds = %block_.L_400fef
  %307 = add i64 %166, -32
  %308 = add i64 %202, 4
...
block_.L_401054:                                  ; preds = %block_.L_400fdc
  %356 = add i64 %125, -32
  %357 = add i64 %161, 4
