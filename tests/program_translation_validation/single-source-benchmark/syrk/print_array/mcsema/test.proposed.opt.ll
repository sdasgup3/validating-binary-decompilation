...
block_.L_400fcc:                                  ; preds = %block_.L_401022, %entry
  %124 = phi i64 [ %.pre, %entry ], [ %355, %block_.L_401022 ]
  %MEMORY.0 = phi %struct.Memory* [ %79, %entry ], [ %317, %block_.L_401022 ]
  ...
  br i1 %160, label %block_400fd8, label %block_.L_401044
...
block_.L_400fdf:                                  ; preds = %block_400feb, %block_400fd8
  %165 = phi i64 [ %306, %block_400feb ], [ %.pre9, %block_400fd8 ]
  ...
  br i1 %201, label %block_400feb, label %block_.L_401022
...
block_400feb:                                     ; preds = %block_.L_400fdf
  ...
  %call2_40100f = tail call %struct.Memory* @sub_401060.print_element(%struct.State* nonnull %0, i64 %270, %struct.Memory* %MEMORY.0)
