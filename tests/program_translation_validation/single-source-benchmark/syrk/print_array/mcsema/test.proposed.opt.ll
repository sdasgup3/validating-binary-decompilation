...
declare %struct.Memory* @sub_401060.print_element(%struct.State* dereferenceable(3376), i64, %struct.Memory*) local_unnamed_addr
...
entry:
  ...
  %call2_400fab = tail call %struct.Memory* @sub_400640.malloc_plt(%struct.State* %0, i64 %74, %struct.Memory* %2)
...
block_.L_400fcc:                                  ; preds = %block_.L_401022, %entry
  %123 = phi i64 [ %.pre, %entry ], [ %353, %block_.L_401022 ]
  %MEMORY.0 = phi %struct.Memory* [ %call2_400fab, %entry ], [ %call2_40102e, %block_.L_401022 ]
  ...
  br i1 %159, label %block_400fd8, label %block_.L_401044

block_400fd8:                                     ; preds = %block_.L_400fcc
  %161 = add i64 %124, -24
  %162 = add i64 %160, 7
...
block_.L_400fdf:                                  ; preds = %block_400feb, %block_400fd8
  %164 = phi i64 [ %.pre9, %block_400fd8 ], [ %305, %block_400feb ]
  %MEMORY.1 = phi %struct.Memory* [ %MEMORY.0, %block_400fd8 ], [ %call2_40100f, %block_400feb ]
  ...
  br i1 %200, label %block_400feb, label %block_.L_401022

block_400feb:                                     ; preds = %block_.L_400fdf
  %202 = add i64 %165, -16
  %203 = add i64 %201, 4
  ...
  %call2_40100f = tail call %struct.Memory* @sub_401060.print_element(%struct.State* nonnull %0, i64 %269, %struct.Memory* %MEMORY.1)
...
block_.L_401022:                                  ; preds = %block_.L_400fdf
  %306 = add i64 %165, -32
  %307 = add i64 %201, 4
  ...
  %call2_40102e = tail call %struct.Memory* @sub_400610.fputs_plt(%struct.State* nonnull %0, i64 %311, %struct.Memory* %MEMORY.1)
...
block_.L_401044:                                  ; preds = %block_.L_400fcc
  %354 = add i64 %124, -32
  %355 = add i64 %160, 4
  ...
  %call2_401048 = tail call %struct.Memory* @sub_4005f0.free_plt(%struct.State* nonnull %0, i64 %358, %struct.Memory* %MEMORY.0)
  ...
  ret %struct.Memory* %call2_401048
}
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_jge_.L_401044(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i8* nocapture %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_jmpq_.L_400fcc(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
