; ModuleID = '/tmp/tmpfz25ktfm-query.ll'
...
entry:
  ...
  br i1 %var_2_16034, label %block_400fe8.preheader, label %block_.L_401054

block_400fe8.preheader:                           ; preds = %entry
  br label %block_400fe8

block_400fe8:                                     ; preds = %block_400fe8.preheader, %block_.L_401032
  %var_2_175 = phi i32 [ %var_2_134, %block_.L_401032 ], [ %var_2_13424, %block_400fe8.preheader ]
  %var_2_1661 = phi i64 [ %var_2_125, %block_.L_401032 ], [ %var_2_12518, %block_400fe8.preheader ]
  %MEMORY.035 = phi %struct.Memory* [ %var_2_317, %block_.L_401032 ], [ %var_2_79, %block_400fe8.preheader ]
  ...
  br i1 %var_2_20117, label %block_400ffb.preheader, label %block_.L_401032

block_400ffb.preheader:                           ; preds = %block_400fe8
  br label %block_400ffb

block_400ffb:                                     ; preds = %block_400ffb.preheader, %block_400ffb
  br label %block_400ffb

block_.L_401032:                                  ; preds = %block_400fe8
  ...
  br i1 %var_2_160, label %block_400fe8, label %block_.L_401054.loopexit

block_.L_401054.loopexit:                         ; preds = %block_.L_401032
  br label %block_.L_401054

block_.L_401054:                                  ; preds = %block_.L_401054.loopexit, %entry
  %MEMORY.0.lcssa = phi %struct.Memory* [ %var_2_79, %entry ], [ %var_2_317, %block_.L_401054.loopexit ]
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_jge_.L_401054(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i8* nocapture %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_jge_.L_401032(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i8* nocapture %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 2, i32 9
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_jmpq_.L_400fef(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
