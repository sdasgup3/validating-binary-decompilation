; ModuleID = '/home/sdasgup3/Github/validating-binary-decompilation/tests/program_translation_validation/single-source-benchmark/bc-seeds/syrk/syrk.bc'
...
entry:
  ...
  %6 = load [1024 x [1024 x double]]*, [1024 x [1024 x double]]** %C_StrictFP, align 8
  ...
  call void @kernel_syrk(i32 %8, i32 %9, double %10, double %11, [1024 x double]* %arraydecay5, [1024 x double]* %arraydecay6)
  %14 = load i32, i32* %ni, align 4
  %15 = load i32, i32* %nj, align 4
  %16 = load double, double* %alpha, align 8
  %17 = load double, double* %beta, align 8
  %18 = load [1024 x [1024 x double]]*, [1024 x [1024 x double]]** %C_StrictFP, align 8
  %arraydecay7 = getelementptr inbounds [1024 x [1024 x double]], [1024 x [1024 x double]]* %18, i32 0, i32 0
  ...
  call void @kernel_syrk_StrictFP(i32 %14, i32 %15, double %16, double %17, [1024 x double]* %arraydecay7, [1024 x double]* %arraydecay8)
  %20 = load i32, i32* %ni, align 4
  %21 = load [1024 x [1024 x double]]*, [1024 x [1024 x double]]** %C, align 8
  %arraydecay9 = getelementptr inbounds [1024 x [1024 x double]], [1024 x [1024 x double]]* %21, i32 0, i32 0
  %22 = load [1024 x [1024 x double]]*, [1024 x [1024 x double]]** %C_StrictFP, align 8
  %arraydecay10 = getelementptr inbounds [1024 x [1024 x double]], [1024 x [1024 x double]]* %22, i32 0, i32 0
  %call11 = call i32 @check_FP(i32 %20, [1024 x double]* %arraydecay9, [1024 x double]* %arraydecay10)
...
if.end:                                           ; preds = %entry
  ...
  %24 = load [1024 x [1024 x double]]*, [1024 x [1024 x double]]** %C_StrictFP, align 8
  %arraydecay12 = getelementptr inbounds [1024 x [1024 x double]], [1024 x [1024 x double]]* %24, i32 0, i32 0
  call void @print_array(i32 %23, [1024 x double]* %arraydecay12)
...
; Function Attrs: noinline nounwind uwtable
define internal void @init_array(i32 %ni, i32 %nj, double* %alpha, double* %beta, [1024 x double]* %C, [1024 x double]* %C_StrictFP, [1024 x double]* %A) #0 {
entry:
...
for.cond11:                                       ; preds = %for.inc35, %for.end10
...
for.body18:                                       ; preds = %for.cond15
  ...
  %21 = load [1024 x double]*, [1024 x double]** %C.addr, align 8
  ...
  %24 = load [1024 x double]*, [1024 x double]** %C_StrictFP.addr, align 8
  %25 = load i32, i32* %i, align 4
  %idxprom28 = sext i32 %25 to i64
  %arrayidx29 = getelementptr inbounds [1024 x double], [1024 x double]* %24, i64 %idxprom28
  ...
  store double %div23, double* %arrayidx31, align 8
  br label %for.inc32
...
for.body3:                                        ; preds = %for.cond1
  ...
  %5 = load [1024 x double]*, [1024 x double]** %C.addr, align 8
  %6 = load i32, i32* %i, align 4
  %idxprom = sext i32 %6 to i64
  %arrayidx = getelementptr inbounds [1024 x double], [1024 x double]* %5, i64 %idxprom
  %7 = load i32, i32* %j, align 4
...
for.body17:                                       ; preds = %for.cond15
  ...
  %18 = load [1024 x double]*, [1024 x double]** %A.addr, align 8
  ...
  %22 = load [1024 x double]*, [1024 x double]** %A.addr, align 8
  %23 = load i32, i32* %j, align 4
  ...
  %26 = load [1024 x double]*, [1024 x double]** %C.addr, align 8
  %27 = load i32, i32* %i, align 4
  %idxprom28 = sext i32 %27 to i64
  %arrayidx29 = getelementptr inbounds [1024 x double], [1024 x double]* %26, i64 %idxprom28
...
; Function Attrs: noinline nounwind uwtable
define internal void @kernel_syrk_StrictFP(i32 %ni, i32 %nj, double %alpha, double %beta, [1024 x double]* %C, [1024 x double]* %A) #0 {
entry:
  %ni.addr = alloca i32, align 4
  %nj.addr = alloca i32, align 4
  %alpha.addr = alloca double, align 8
