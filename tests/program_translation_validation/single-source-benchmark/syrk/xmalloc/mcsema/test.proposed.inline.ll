...
block_.L_400903:                                  ; preds = %block_4008f9, %entry
  ...
  store i64 4199111, i64* %RSI.i, align 8
...
define %struct.Memory* @routine_movq__0x4012c7___rsi(%struct.State* dereferenceable(3376), i64, %struct.Memory*) {
block_400488:
  %3 = getelementptr inbounds %struct.State, %struct.State* %0, i32 0, i32 6
  %4 = getelementptr inbounds %struct.GPR, %struct.GPR* %3, i32 0, i32 33
  %5 = getelementptr inbounds %struct.Reg, %struct.Reg* %4, i32 0, i32 0
  ...
  %10 = add i64 %9, 10
  store i64 %10, i64* %PC
  store i64 4199111, i64* %RSI, align 8
  ret %struct.Memory* %2
}
