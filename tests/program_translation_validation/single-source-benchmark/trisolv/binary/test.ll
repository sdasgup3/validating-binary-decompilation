; ModuleID = '/home/ubuntu/Github/validating-binary-decompilation/tests/program_translation_validation/single-source-benchmark/bc-seeds/trisolv/trisolv.bc'
...
entry:
  ...
  %x_StrictFP = alloca [4000 x double]*, align 8
  ...
  store [4000 x double]* %2, [4000 x double]** %x_StrictFP, align 8
  %call3 = call i8* @polybench_alloc_data(i64 4000, i32 8)
  %3 = bitcast i8* %call3 to [4000 x double]*
  store [4000 x double]* %3, [4000 x double]** %c, align 8
  %4 = load i32, i32* %n, align 4
  %5 = load [4000 x [4000 x double]]*, [4000 x [4000 x double]]** %A, align 8
  %arraydecay = getelementptr inbounds [4000 x [4000 x double]], [4000 x [4000 x double]]* %5, i32 0, i32 0
  %6 = load [4000 x double]*, [4000 x double]** %x, align 8
  %arraydecay4 = getelementptr inbounds [4000 x double], [4000 x double]* %6, i32 0, i32 0
  %7 = load [4000 x double]*, [4000 x double]** %x_StrictFP, align 8
  %arraydecay5 = getelementptr inbounds [4000 x double], [4000 x double]* %7, i32 0, i32 0
  %8 = load [4000 x double]*, [4000 x double]** %c, align 8
  ...
  %arraydecay7 = getelementptr inbounds [4000 x [4000 x double]], [4000 x [4000 x double]]* %10, i32 0, i32 0
  ...
  %12 = load [4000 x double]*, [4000 x double]** %c, align 8
  %arraydecay9 = getelementptr inbounds [4000 x double], [4000 x double]* %12, i32 0, i32 0
  call void @kernel_trisolv(i32 %9, [4000 x double]* %arraydecay7, double* %arraydecay8, double* %arraydecay9)
  %13 = load i32, i32* %n, align 4
  %14 = load [4000 x [4000 x double]]*, [4000 x [4000 x double]]** %A, align 8
  %arraydecay10 = getelementptr inbounds [4000 x [4000 x double]], [4000 x [4000 x double]]* %14, i32 0, i32 0
  %15 = load [4000 x double]*, [4000 x double]** %x_StrictFP, align 8
  %arraydecay11 = getelementptr inbounds [4000 x double], [4000 x double]* %15, i32 0, i32 0
  %16 = load [4000 x double]*, [4000 x double]** %c, align 8
  %arraydecay12 = getelementptr inbounds [4000 x double], [4000 x double]* %16, i32 0, i32 0
  call void @kernel_trisolv(i32 %13, [4000 x double]* %arraydecay10, double* %arraydecay11, double* %arraydecay12)
  %17 = load i32, i32* %n, align 4
  %18 = load [4000 x double]*, [4000 x double]** %x_StrictFP, align 8
  %arraydecay13 = getelementptr inbounds [4000 x double], [4000 x double]* %18, i32 0, i32 0
  call void @print_array(i32 %17, double* %arraydecay13)
  ...
  %23 = load [4000 x double]*, [4000 x double]** %x_StrictFP, align 8
  %24 = bitcast [4000 x double]* %23 to i8*
  call void @free(i8* %24) #4
  %25 = load [4000 x double]*, [4000 x double]** %c, align 8
...
; Function Attrs: noinline nounwind uwtable
define internal void @init_array(i32 %n, [4000 x double]* %A, double* %x, double* %x_StrictFP, double* %c) #0 {
entry:
  %n.addr = alloca i32, align 4
  %A.addr = alloca [4000 x double]*, align 8
  %x.addr = alloca double*, align 8
  %x_StrictFP.addr = alloca double*, align 8
  ...
  store double* %x_StrictFP, double** %x_StrictFP.addr, align 8
...
for.body:                                         ; preds = %for.cond
  ...
  %7 = load double*, double** %x_StrictFP.addr, align 8
  %8 = load i32, i32* %i, align 4
...
for.body10:                                       ; preds = %for.cond7
  ...
  %arrayidx18 = getelementptr inbounds [4000 x double], [4000 x double]* %17, i64 %idxprom17
...
for.body5:                                        ; preds = %for.cond3
  ...
  %12 = load [4000 x double]*, [4000 x double]** %A.addr, align 8
  %13 = load i32, i32* %i, align 4
  %idxprom8 = sext i32 %13 to i64
  %arrayidx9 = getelementptr inbounds [4000 x double], [4000 x double]* %12, i64 %idxprom8
  %14 = load i32, i32* %j, align 4
...
for.end:                                          ; preds = %for.cond3
  ...
  %arrayidx20 = getelementptr inbounds [4000 x double], [4000 x double]* %25, i64 %idxprom19
