...
declare %struct.Memory* @sub_400a40.init_array(%struct.State* dereferenceable(3376), i64, %struct.Memory*) local_unnamed_addr

declare %struct.Memory* @sub_400b20.kernel_trisolv(%struct.State* dereferenceable(3376), i64, %struct.Memory*) local_unnamed_addr

declare %struct.Memory* @sub_400c20.print_array(%struct.State* dereferenceable(3376), i64, %struct.Memory*) local_unnamed_addr
