...
block_.L_400c3c:                                  ; preds = %block_400c48, %entry
  %123 = phi i64 [ %.pre, %entry ], [ %232, %block_400c48 ]
  %MEMORY.0 = phi %struct.Memory* [ %79, %entry ], [ %call2_400c61, %block_400c48 ]
  ...
  br i1 %159, label %block_400c48, label %block_.L_400c74
...
block_400c48:                                     ; preds = %block_.L_400c3c
  ...
  %call2_400c61 = tail call %struct.Memory* @sub_400ca0.print_element(%struct.State* %0, i64 %195, %struct.Memory* %MEMORY.0)
