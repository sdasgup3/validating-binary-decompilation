...
declare %struct.Memory* @sub_400ca0.print_element(%struct.State* noalias dereferenceable(3376), i64, %struct.Memory* noalias readnone returned) local_unnamed_addr
...
block_.L_400c3c:                                  ; preds = %block_400c48, %entry
  %117 = phi i64 [ %.pre, %entry ], [ %225, %block_400c48 ]
  %MEMORY.0 = phi %struct.Memory* [ %73, %entry ], [ %call2_400c61, %block_400c48 ]
  ...
  br i1 %153, label %block_400c48, label %block_.L_400c74
...
block_400c48:                                     ; preds = %block_.L_400c3c
  ...
  %call2_400c61 = tail call %struct.Memory* @sub_400ca0.print_element(%struct.State* %0, i64 %189, %struct.Memory* %MEMORY.0)
...
block_.L_400c74:                                  ; preds = %block_.L_400c3c
  %226 = add i64 %118, -32
  %227 = add i64 %154, 4
...
define %struct.Memory* @routine_jge_.L_400c74(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i8* %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
...
define %struct.Memory* @routine_jmpq_.L_400c3c(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
