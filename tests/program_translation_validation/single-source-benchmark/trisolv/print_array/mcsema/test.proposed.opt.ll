...
declare %struct.Memory* @sub_400cc0.print_element(%struct.State* noalias dereferenceable(3376), i64, %struct.Memory* noalias readnone returned) local_unnamed_addr
...
block_.L_400c5c:                                  ; preds = %block_400c68, %entry
  %123 = phi i64 [ %230, %block_400c68 ], [ %.pre, %entry ]
...
block_400c68:                                     ; preds = %block_.L_400c5c
  ...
  %call2_400c81 = tail call %struct.Memory* @sub_400cc0.print_element(%struct.State* nonnull %0, i64 %194, %struct.Memory* %call2_400c3b)
...
block_.L_400c94:                                  ; preds = %block_.L_400c5c
  ...
  %call2_400ca0 = tail call %struct.Memory* @sub_400610.fputs_plt(%struct.State* nonnull %0, i64 %236, %struct.Memory* %call2_400c3b)
