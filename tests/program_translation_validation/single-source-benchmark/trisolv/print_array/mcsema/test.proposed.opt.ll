...
declare %struct.Memory* @sub_400640.malloc_plt(%struct.State* noalias dereferenceable(3376), i64, %struct.Memory* noalias) local_unnamed_addr

declare %struct.Memory* @sub_400cc0.print_element(%struct.State* noalias dereferenceable(3376), i64, %struct.Memory* noalias) local_unnamed_addr

declare %struct.Memory* @sub_400610.fputs_plt(%struct.State* noalias dereferenceable(3376), i64, %struct.Memory* noalias) local_unnamed_addr

declare %struct.Memory* @sub_4005f0.free_plt(%struct.State* noalias dereferenceable(3376), i64, %struct.Memory* noalias) local_unnamed_addr
...
entry:
  ...
  %call2_400c3b = tail call %struct.Memory* @sub_400640.malloc_plt(%struct.State* %0, i64 %74, %struct.Memory* %2)
...
block_.L_400c5c:                                  ; preds = %block_400c68, %entry
  %123 = phi i64 [ %.pre, %entry ], [ %230, %block_400c68 ]
  %MEMORY.0 = phi %struct.Memory* [ %call2_400c3b, %entry ], [ %call2_400c81, %block_400c68 ]
  ...
  br i1 %159, label %block_400c68, label %block_.L_400c94
...
block_400c68:                                     ; preds = %block_.L_400c5c
  ...
  %call2_400c81 = tail call %struct.Memory* @sub_400cc0.print_element(%struct.State* nonnull %0, i64 %194, %struct.Memory* %MEMORY.0)
...
block_.L_400c94:                                  ; preds = %block_.L_400c5c
  %231 = add i64 %124, -32
  %232 = add i64 %160, 4
  ...
  %call2_400ca0 = tail call %struct.Memory* @sub_400610.fputs_plt(%struct.State* nonnull %0, i64 %236, %struct.Memory* %MEMORY.0)
  ...
  %call2_400cac = tail call %struct.Memory* @sub_4005f0.free_plt(%struct.State* nonnull %0, i64 %252, %struct.Memory* %call2_400ca0)
  ...
  ret %struct.Memory* %call2_400cac
}
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_jge_.L_400c94(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i8* nocapture %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
