; ModuleID = '/home/ubuntu/Github/validating-binary-decompilation/tests/program_translation_validation/single-source-benchmark/bc-seeds/trmm/trmm.bc'
...
entry:
  ...
  %B_StrictFP = alloca [1024 x [1024 x double]]*, align 8
  ...
  store [1024 x [1024 x double]]* %2, [1024 x [1024 x double]]** %B_StrictFP, align 8
  ...
  %5 = load [1024 x [1024 x double]]*, [1024 x [1024 x double]]** %B, align 8
  %arraydecay3 = getelementptr inbounds [1024 x [1024 x double]], [1024 x [1024 x double]]* %5, i32 0, i32 0
  %6 = load [1024 x [1024 x double]]*, [1024 x [1024 x double]]** %B_StrictFP, align 8
  %arraydecay4 = getelementptr inbounds [1024 x [1024 x double]], [1024 x [1024 x double]]* %6, i32 0, i32 0
  call void @init_array(i32 %3, double* %alpha, [1024 x double]* %arraydecay, [1024 x double]* %arraydecay3, [1024 x double]* %arraydecay4)
  ...
  call void @kernel_trmm(i32 %7, double %8, [1024 x double]* %arraydecay5, [1024 x double]* %arraydecay6)
  ...
  %14 = load [1024 x [1024 x double]]*, [1024 x [1024 x double]]** %B_StrictFP, align 8
  %arraydecay8 = getelementptr inbounds [1024 x [1024 x double]], [1024 x [1024 x double]]* %14, i32 0, i32 0
  call void @kernel_trmm_StrictFP(i32 %11, double %12, [1024 x double]* %arraydecay7, [1024 x double]* %arraydecay8)
  ...
  %17 = load [1024 x [1024 x double]]*, [1024 x [1024 x double]]** %B_StrictFP, align 8
  %arraydecay10 = getelementptr inbounds [1024 x [1024 x double]], [1024 x [1024 x double]]* %17, i32 0, i32 0
  %call11 = call i32 @check_FP(i32 %15, [1024 x double]* %arraydecay9, [1024 x double]* %arraydecay10)
...
if.end:                                           ; preds = %entry
  ...
  %19 = load [1024 x [1024 x double]]*, [1024 x [1024 x double]]** %B_StrictFP, align 8
  %arraydecay12 = getelementptr inbounds [1024 x [1024 x double]], [1024 x [1024 x double]]* %19, i32 0, i32 0
  call void @print_array(i32 %18, [1024 x double]* %arraydecay12)
...
; Function Attrs: noinline nounwind uwtable
define internal void @init_array(i32 %ni, double* %alpha, [1024 x double]* %A, [1024 x double]* %B, [1024 x double]* %B_StrictFP) #0 {
entry:
  %ni.addr = alloca i32, align 4
  %alpha.addr = alloca double*, align 8
  %A.addr = alloca [1024 x double]*, align 8
  %B.addr = alloca [1024 x double]*, align 8
  %B_StrictFP.addr = alloca [1024 x double]*, align 8
  %i = alloca i32, align 4
  ...
  store [1024 x double]* %B_StrictFP, [1024 x double]** %B_StrictFP.addr, align 8
...
for.body3:                                        ; preds = %for.cond1
  ...
  %8 = load [1024 x double]*, [1024 x double]** %A.addr, align 8
  %9 = load i32, i32* %i, align 4
  %idxprom = sext i32 %9 to i64
  %arrayidx = getelementptr inbounds [1024 x double], [1024 x double]* %8, i64 %idxprom
  ...
  %17 = load [1024 x double]*, [1024 x double]** %B_StrictFP.addr, align 8
  ...
  store double %div12, double* %arrayidx20, align 8
  br label %for.inc
...
; Function Attrs: noinline nounwind uwtable
define internal void @kernel_trmm_StrictFP(i32 %ni, double %alpha, [1024 x double]* %A, [1024 x double]* %B) #0 {
entry:
  %ni.addr = alloca i32, align 4
  %alpha.addr = alloca double, align 8
  %A.addr = alloca [1024 x double]*, align 8
...
; Function Attrs: noinline nounwind uwtable
define internal i32 @check_FP(i32 %ni, [1024 x double]* %A, [1024 x double]* %B) #0 {
entry:
  %retval = alloca i32, align 4
  %ni.addr = alloca i32, align 4
  %A.addr = alloca [1024 x double]*, align 8
...
for.body6:                                        ; preds = %for.cond3
  %7 = load [1024 x double]*, [1024 x double]** %B.addr, align 8
  %8 = load i32, i32* %i, align 4
