...
@G_0x430__rip__4197600_ = global %G_0x430__rip__4197600__type zeroinitializer
...
entry:
  ...
  %76 = load double, double* bitcast (%G_0x430__rip__4197600__type* @G_0x430__rip__4197600_ to double*)
...
block_.L_400cf7:                                  ; preds = %block_.L_400dd7, %entry
...
block_.L_400d0a:                                  ; preds = %block_.L_400dc4, %block_400d03
...
block_400d16:                                     ; preds = %block_.L_400d0a
  ...
  %694 = load float, float* bitcast (%G_0x3bf__rip__4197729__type* @G_0x3bf__rip__4197729_ to float*)
  %695 = load float, float* inttoptr (i64 add (i64 ptrtoint (%G_0x3bf__rip__4197729__type* @G_0x3bf__rip__4197729_ to i64), i64 4) to float*)
  %696 = load float, float* inttoptr (i64 add (i64 ptrtoint (%G_0x3bf__rip__4197729__type* @G_0x3bf__rip__4197729_ to i64), i64 8) to float*)
  %697 = load float, float* inttoptr (i64 add (i64 ptrtoint (%G_0x3bf__rip__4197729__type* @G_0x3bf__rip__4197729_ to i64), i64 12) to float*)
...
; <label>:802:                                    ; preds = %794
  ...
  %805 = call %struct.Memory* @__remill_error(%struct.State* nonnull dereferenceable(3376) %0, i64 %804, %struct.Memory* %loadMem_400d6f)
  br label %routine_ucomisd_MINUS0x28__rbp____xmm0.exit

; <label>:806:                                    ; preds = %block_400d16
...
routine_ucomisd_MINUS0x28__rbp____xmm0.exit:      ; preds = %802, %819
  %823 = phi %struct.Memory* [ %805, %802 ], [ %loadMem_400d6f, %819 ]
...
block_400d7a:                                     ; preds = %routine_ucomisd_MINUS0x28__rbp____xmm0.exit
  ...
  %1002 = call %struct.Memory* @__remill_function_call(%struct.State* %0, i64 ptrtoint (i64 (i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64)* @fprintf to i64), %struct.Memory* %loadMem2_400dab)
...
block_.L_400dc4:                                  ; preds = %block_.L_400dbf
...
block_.L_400dd7:                                  ; preds = %block_.L_400dd2
...
block_.L_400dec:                                  ; preds = %block_.L_400de5, %block_400d7a
  ...
  ret %struct.Memory* %loadMem_400df4
}
...
define %struct.Memory* @routine_movsd_0x430__rip____xmm0(%struct.State* dereferenceable(3376), i64, %struct.Memory*) {
block_400478:
  %3 = getelementptr inbounds %struct.State, %struct.State* %0, i32 0, i32 6
  %4 = getelementptr inbounds %struct.GPR, %struct.GPR* %3, i32 0, i32 33
  %5 = getelementptr inbounds %struct.Reg, %struct.Reg* %4, i32 0, i32 0
