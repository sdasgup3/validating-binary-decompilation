...
block_.L_400d17:                                  ; preds = %block_.L_400df7, %entry
...
block_.L_400d2a:                                  ; preds = %block_.L_400de4, %block_400d23
...
; <label>:812:                                    ; preds = %804
  ...
  %815 = call %struct.Memory* @__remill_error(%struct.State* nonnull dereferenceable(3376) %0, i64 %814, %struct.Memory* %loadMem_400d8f)
  br label %routine_ucomisd_MINUS0x28__rbp____xmm0.exit

; <label>:816:                                    ; preds = %block_400d36
...
routine_ucomisd_MINUS0x28__rbp____xmm0.exit:      ; preds = %812, %829
  %833 = phi %struct.Memory* [ %815, %812 ], [ %loadMem_400d8f, %829 ]
...
block_400d9a:                                     ; preds = %routine_ucomisd_MINUS0x28__rbp____xmm0.exit
  ...
  store i64 4198794, i64* %RSI.i, align 8
  ...
  store %struct.Memory* %loadMem1_400dcb, %struct.Memory** %MEMORY
  %loadMem2_400dcb = load %struct.Memory*, %struct.Memory** %MEMORY
  %loadPC_400dcb = load i64, i64* %3
  %1012 = call %struct.Memory* @__remill_function_call(%struct.State* %0, i64 ptrtoint (i64 (i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64)* @fprintf to i64), %struct.Memory* %loadMem2_400dcb)
...
block_.L_400de4:                                  ; preds = %block_.L_400ddf
...
block_.L_400df7:                                  ; preds = %block_.L_400df2
