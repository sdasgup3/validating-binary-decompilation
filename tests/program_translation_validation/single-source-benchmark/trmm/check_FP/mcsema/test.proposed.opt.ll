...
%G_0x3bf__rip__4197729__type = type <{ [16 x i8] }>
%G_0x430__rip__4197600__type = type <{ [16 x i8] }>
...
@G_0x3bf__rip__4197729_ = global %G_0x3bf__rip__4197729__type zeroinitializer
@G_0x430__rip__4197600_ = local_unnamed_addr global %G_0x430__rip__4197600__type zeroinitializer
...
entry:
  ...
  %42 = load i64, i64* bitcast (%G_0x430__rip__4197600__type* @G_0x430__rip__4197600_ to i64*), align 8
...
block_.L_400cf7:                                  ; preds = %block_.L_400dd2, %entry
  %88 = phi i64 [ %.pre, %entry ], [ %450, %block_.L_400dd2 ]
  %MEMORY.0 = phi %struct.Memory* [ %2, %entry ], [ %MEMORY.1, %block_.L_400dd2 ]
  ...
  br i1 %124, label %block_400d03, label %block_.L_400de5
...
block_.L_400d0a:                                  ; preds = %block_.L_400dbf, %block_400d03
  %129 = phi i64 [ %.pre3, %block_400d03 ], [ %420, %block_.L_400dbf ]
  %MEMORY.1 = phi %struct.Memory* [ %MEMORY.0, %block_400d03 ], [ %329, %block_.L_400dbf ]
  ...
  br i1 %165, label %block_400d16, label %block_.L_400dd2
...
block_400d16:                                     ; preds = %block_.L_400d0a
  ...
  %278 = load i32, i32* bitcast (%G_0x3bf__rip__4197729__type* @G_0x3bf__rip__4197729_ to i32*), align 8
  %279 = load i32, i32* inttoptr (i64 add (i64 ptrtoint (%G_0x3bf__rip__4197729__type* @G_0x3bf__rip__4197729_ to i64), i64 4) to i32*), align 4
  %280 = load i32, i32* inttoptr (i64 add (i64 ptrtoint (%G_0x3bf__rip__4197729__type* @G_0x3bf__rip__4197729_ to i64), i64 8) to i32*), align 8
  %281 = load i32, i32* inttoptr (i64 add (i64 ptrtoint (%G_0x3bf__rip__4197729__type* @G_0x3bf__rip__4197729_ to i64), i64 12) to i32*), align 4
...
routine_ucomisd_MINUS0x28__rbp____xmm0.exit:      ; preds = %327, %315
  ...
  br i1 %333, label %block_.L_400dbf, label %block_400d7a

block_400d7a:                                     ; preds = %routine_ucomisd_MINUS0x28__rbp____xmm0.exit
  store i64 ptrtoint (%G__0x40116a_type* @G__0x40116a to i64), i64* %RSI.i143, align 8
...
block_.L_400dbf:                                  ; preds = %routine_ucomisd_MINUS0x28__rbp____xmm0.exit
...
block_.L_400dd2:                                  ; preds = %block_.L_400d0a
  %421 = add i64 %130, -28
  %422 = add i64 %166, 8
...
block_.L_400de5:                                  ; preds = %block_.L_400cf7
  %451 = add i64 %89, -4
  %452 = add i64 %125, 7
...
block_.L_400dec:                                  ; preds = %block_.L_400de5, %block_400d7a
  %454 = phi i64 [ %.pre5, %block_.L_400de5 ], [ %389, %block_400d7a ]
  %MEMORY.2 = phi %struct.Memory* [ %MEMORY.0, %block_.L_400de5 ], [ %376, %block_400d7a ]
...
block_400478:
  ...
  %5 = load i64, i64* bitcast (%G_0x430__rip__4197600__type* @G_0x430__rip__4197600_ to i64*), align 8
...
define %struct.Memory* @routine_jge_.L_400de5(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i8* %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
...
define %struct.Memory* @routine_jge_.L_400dd2(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i8* %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 2, i32 9
...
block_400478:
  ...
  %6 = add i64 %5, 7
  store i64 %6, i64* %PC, align 8
  %7 = load i32, i32* bitcast (%G_0x3bf__rip__4197729__type* @G_0x3bf__rip__4197729_ to i32*), align 8
  %8 = load i32, i32* inttoptr (i64 add (i64 ptrtoint (%G_0x3bf__rip__4197729__type* @G_0x3bf__rip__4197729_ to i64), i64 4) to i32*), align 4
  %9 = load i32, i32* inttoptr (i64 add (i64 ptrtoint (%G_0x3bf__rip__4197729__type* @G_0x3bf__rip__4197729_ to i64), i64 8) to i32*), align 8
  %10 = load i32, i32* inttoptr (i64 add (i64 ptrtoint (%G_0x3bf__rip__4197729__type* @G_0x3bf__rip__4197729_ to i64), i64 12) to i32*), align 4
...
define %struct.Memory* @routine_jbe_.L_400dbf(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i8* %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
...
define %struct.Memory* @routine_movq__0x40116a___rsi(%struct.State* dereferenceable(3376), i64, %struct.Memory*) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %RSI = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 9, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
...
define %struct.Memory* @routine_jmpq_.L_400dec(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
...
define %struct.Memory* @routine_jmpq_.L_400dc4(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
