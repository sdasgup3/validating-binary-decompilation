...
block_.L_400d17:                                  ; preds = %block_.L_400df2, %entry
  %95 = phi i64 [ %.pre, %entry ], [ %464, %block_.L_400df2 ]
...
block_.L_400d2a:                                  ; preds = %block_.L_400ddf, %block_400d23
  %136 = phi i64 [ %.pre29, %block_400d23 ], [ %434, %block_.L_400ddf ]
...
block_400d9a:                                     ; preds = %routine_ucomisd_MINUS0x28__rbp____xmm0.exit
  store i64 4198794, i64* %RSI.i143, align 8
...
block_.L_400e0c:                                  ; preds = %block_.L_400e05, %block_400d9a
  %468 = phi i64 [ %.pre31, %block_.L_400e05 ], [ %403, %block_400d9a ]
  %MEMORY.2 = phi %struct.Memory* [ %MEMORY.0, %block_.L_400e05 ], [ %390, %block_400d9a ]
