...
block_.L_400cf7:                                  ; preds = %block_.L_400dd2, %entry
  %89 = phi i64 [ %.pre, %entry ], [ %458, %block_.L_400dd2 ]
  ...
  br i1 %125, label %block_400d03, label %block_.L_400de5
...
block_.L_400d0a:                                  ; preds = %block_.L_400dbf, %block_400d03
  %130 = phi i64 [ %.pre3, %block_400d03 ], [ %427, %block_.L_400dbf ]
  %MEMORY.1 = phi %struct.Memory* [ %MEMORY.0, %block_400d03 ], [ %333, %block_.L_400dbf ]
  ...
  br i1 %166, label %block_400d16, label %block_.L_400dd2
...
routine_ucomisd_MINUS0x28__rbp____xmm0.exit:      ; preds = %331, %319
  ...
  br i1 %337, label %block_.L_400dbf, label %block_400d7a
...
block_.L_400dec:                                  ; preds = %block_.L_400de5, %block_400d7a
  %462 = phi i64 [ %.pre5, %block_.L_400de5 ], [ %395, %block_400d7a ]
  %MEMORY.2 = phi %struct.Memory* [ %MEMORY.0, %block_.L_400de5 ], [ %382, %block_400d7a ]
