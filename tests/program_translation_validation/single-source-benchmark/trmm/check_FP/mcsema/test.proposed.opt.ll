...
block_.L_400d17:                                  ; preds = %block_.L_400df2, %entry
  %95 = phi i64 [ %.pre, %entry ], [ %463, %block_.L_400df2 ]
  %MEMORY.0 = phi %struct.Memory* [ %2, %entry ], [ %MEMORY.1, %block_.L_400df2 ]
  ...
  br i1 %131, label %block_400d23, label %block_.L_400e05

block_400d23:                                     ; preds = %block_.L_400d17
  %133 = add i64 %96, -32
  %134 = add i64 %132, 7
  ...
  br label %block_.L_400d2a

block_.L_400d2a:                                  ; preds = %block_.L_400ddf, %block_400d23
  %136 = phi i64 [ %.pre29, %block_400d23 ], [ %433, %block_.L_400ddf ]
  %MEMORY.1 = phi %struct.Memory* [ %MEMORY.0, %block_400d23 ], [ %343, %block_.L_400ddf ]
  ...
  br i1 %172, label %block_400d36, label %block_.L_400df2

block_400d36:                                     ; preds = %block_.L_400d2a
  %174 = add i64 %137, -16
  %175 = add i64 %173, 4
...
routine_ucomisd_MINUS0x28__rbp____xmm0.exit:      ; preds = %341, %329
  ...
  br i1 %347, label %block_.L_400ddf, label %block_400d9a

block_400d9a:                                     ; preds = %routine_ucomisd_MINUS0x28__rbp____xmm0.exit
  store i64 4198794, i64* %RSI.i141, align 8
  ...
  %call2_400dcb = tail call %struct.Memory* @sub_400630.fprintf_plt(%struct.State* nonnull %0, i64 %385, %struct.Memory* %343)
  ...
  br label %block_.L_400e0c

block_.L_400ddf:                                  ; preds = %routine_ucomisd_MINUS0x28__rbp____xmm0.exit
...
block_.L_400df2:                                  ; preds = %block_.L_400d2a
  %434 = add i64 %137, -28
  %435 = add i64 %173, 8
...
block_.L_400e05:                                  ; preds = %block_.L_400d17
  %464 = add i64 %96, -4
  %465 = add i64 %132, 7
...
block_.L_400e0c:                                  ; preds = %block_.L_400e05, %block_400d9a
  %467 = phi i64 [ %.pre31, %block_.L_400e05 ], [ %402, %block_400d9a ]
  %MEMORY.2 = phi %struct.Memory* [ %MEMORY.0, %block_.L_400e05 ], [ %call2_400dcb, %block_400d9a ]
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_jge_.L_400e05(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i8* nocapture %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_jge_.L_400df2(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i8* nocapture %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 2, i32 9
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_jbe_.L_400ddf(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i8* nocapture %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_movq__0x40118a___rsi(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %RSI = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 9, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  ...
  store i64 4198794, i64* %RSI, align 8
  ret %struct.Memory* %2
}
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_jmpq_.L_400e0c(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_jmpq_.L_400de4(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_jmpq_.L_400d2a(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
