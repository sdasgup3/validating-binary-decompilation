; ModuleID = '/tmp/tmp5wgvxh2b-query.ll'
...
entry:
  ...
  br i1 %var_2_13121, label %block_400d33.preheader, label %block_.L_400e1c

block_400d33.preheader:                           ; preds = %entry
  br label %block_400d33

block_.L_400d27.loopexit.loopexit:                ; preds = %routine_ucomisd_MINUS0x28__rbp____xmm0.exit.block_.L_400d3a_crit_edge
  br label %block_.L_400d27.loopexit

block_.L_400d27.loopexit:                         ; preds = %block_.L_400d27.loopexit.loopexit, %block_400d33
  %var_2_137.lcssa = phi i64 [ %var_2_13711, %block_400d33 ], [ %var_2_137.pre, %block_.L_400d27.loopexit.loopexit ]
  %MEMORY.1.lcssa = phi %struct.Memory* [ %MEMORY.022, %block_400d33 ], [ %var_2_343, %block_.L_400d27.loopexit.loopexit ]
  %var_2_146.lcssa = phi i32 [ %var_2_14628, %block_400d33 ], [ %var_2_146, %block_.L_400d27.loopexit.loopexit ]
  %var_2_165.lcssa = phi i32 [ %var_2_16532, %block_400d33 ], [ %var_2_165, %block_.L_400d27.loopexit.loopexit ]
  ...
  br i1 %var_2_131, label %block_400d33, label %block_.L_400e1c.loopexit17

block_400d33:                                     ; preds = %block_400d33.preheader, %block_.L_400d27.loopexit
  %var_2_13711 = phi i64 [ %var_2_137.lcssa, %block_.L_400d27.loopexit ], [ %var_2_965, %block_400d33.preheader ]
  %MEMORY.022 = phi %struct.Memory* [ %MEMORY.1.lcssa, %block_.L_400d27.loopexit ], [ %2, %block_400d33.preheader ]
  ...
  br i1 %var_2_17238, label %block_400d46.preheader, label %block_.L_400d27.loopexit

block_400d46.preheader:                           ; preds = %block_400d33
  br label %block_400d46

block_400d46:                                     ; preds = %block_400d46.preheader, %routine_ucomisd_MINUS0x28__rbp____xmm0.exit.block_.L_400d3a_crit_edge
  %MEMORY.140 = phi %struct.Memory* [ %var_2_343, %routine_ucomisd_MINUS0x28__rbp____xmm0.exit.block_.L_400d3a_crit_edge ], [ %MEMORY.022, %block_400d46.preheader ]
  %var_2_13739 = phi i64 [ %var_2_137.pre, %routine_ucomisd_MINUS0x28__rbp____xmm0.exit.block_.L_400d3a_crit_edge ], [ %var_2_13711, %block_400d46.preheader ]
...
routine_ucomisd_MINUS0x28__rbp____xmm0.exit:      ; preds = %var_2_329, %var_2_321, %block_400d46
  %var_2_343 = phi %struct.Memory* [ %var_2_330, %var_2_329 ], [ %MEMORY.140, %var_2_321 ], [ %MEMORY.140, %block_400d46 ]
  ...
  br i1 %var_2_347, label %block_.L_400e1c.loopexit, label %routine_ucomisd_MINUS0x28__rbp____xmm0.exit.block_.L_400d3a_crit_edge

routine_ucomisd_MINUS0x28__rbp____xmm0.exit.block_.L_400d3a_crit_edge: ; preds = %routine_ucomisd_MINUS0x28__rbp____xmm0.exit
  ...
  br i1 %var_2_172, label %block_400d46, label %block_.L_400d27.loopexit.loopexit

block_.L_400e1c.loopexit:                         ; preds = %routine_ucomisd_MINUS0x28__rbp____xmm0.exit
  br label %block_.L_400e1c

block_.L_400e1c.loopexit17:                       ; preds = %block_.L_400d27.loopexit
  br label %block_.L_400e1c

block_.L_400e1c:                                  ; preds = %block_.L_400e1c.loopexit17, %block_.L_400e1c.loopexit, %entry
