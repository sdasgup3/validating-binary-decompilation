; ModuleID = '/tmp/tmpskt4bnnh-query.ll'
source_filename = "llvm-link"
target datalayout = "e-m:e-i64:64-f80:128-n8:16:32:64-S128"
target triple = "x86_64-pc-linux-gnu-elf"

%__bss_start_type = type <{ [8 x i8] }>
%G_0x6dc__rip__type = type <{ [8 x i8] }>
...
@G_0x6dc__rip_ = global %G_0x6dc__rip__type zeroinitializer
...
entry:
  ...
  %var_2_12 = add i64 %1, add (i64 ptrtoint (%G_0x6dc__rip__type* @G_0x6dc__rip_ to i64), i64 4)
  ...
  %var_2_721 = load i64, i64* %RBP.i, align 8
  %var_2_732 = add i64 %var_2_721, -44
  %var_2_753 = inttoptr i64 %var_2_732 to i32*
  %var_2_764 = load i32, i32* %var_2_753, align 4
  %var_2_785 = add i64 %var_2_721, -4
  %var_2_806 = inttoptr i64 %var_2_785 to i32*
  %var_2_817 = load i32, i32* %var_2_806, align 4
  %var_2_828 = sub i32 %var_2_764, %var_2_817
  %var_2_979 = lshr i32 %var_2_828, 31
  %var_2_9910 = lshr i32 %var_2_764, 31
  %var_2_10011 = lshr i32 %var_2_817, 31
  %var_2_10112 = xor i32 %var_2_10011, %var_2_9910
  %var_2_10213 = xor i32 %var_2_979, %var_2_9910
  %var_2_10314 = add nuw nsw i32 %var_2_10213, %var_2_10112
  %var_2_10415 = icmp eq i32 %var_2_10314, 2
  %var_2_10616 = icmp ne i32 %var_2_979, 0
  %var_2_10717 = xor i1 %var_2_10616, %var_2_10415
  br i1 %var_2_10717, label %block_400a8a.preheader, label %block_.L_400b34

block_400a8a.preheader:                           ; preds = %entry
  %var_2_114 = add i64 %var_2_721, -48
  %var_2_116 = inttoptr i64 %var_2_114 to i32*
  %var_2_117 = load i32, i32* %var_2_116, align 4
  %var_2_123 = sub i32 %var_2_117, %var_2_817
  %var_2_138 = lshr i32 %var_2_123, 31
  %var_2_140 = lshr i32 %var_2_117, 31
  %var_2_142 = xor i32 %var_2_10011, %var_2_140
  ...
  br i1 %var_2_148, label %block_.L_400a91.preheader, label %block_400a8a.preheader5

block_400a8a.preheader5:                          ; preds = %block_400a8a.preheader
  br label %block_400a8a

block_.L_400a91.preheader:                        ; preds = %block_400a8a.preheader
  br label %block_.L_400a91

block_400a8a:                                     ; preds = %block_400a8a.preheader5, %block_400a8a
  br label %block_400a8a

block_.L_400a91:                                  ; preds = %block_.L_400a91.preheader, %block_.L_400a91
  br label %block_.L_400a91

block_.L_400b34:                                  ; preds = %entry
  ret %struct.Memory* %2
}
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_movsd_0x6dc__rip____xmm0(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, ptrtoint (%G_0x6dc__rip__type* @G_0x6dc__rip_ to i64)
  %5 = add i64 %3, 8
  store i64 %5, i64* %PC, align 8
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_jge_.L_400b34(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i8* nocapture %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_jge_.L_400b21(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i8* nocapture %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 2, i32 9
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_jmpq_.L_400a91(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
