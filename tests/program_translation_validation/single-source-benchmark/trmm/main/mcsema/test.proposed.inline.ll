...
block_.L_400a08:                                  ; preds = %entry
  ...
  %777 = call %struct.Memory* @__remill_function_call(%struct.State* %0, i64 ptrtoint (i64 (i64)* @free to i64), %struct.Memory* %loadMem2_400a1b)
  ...
  %819 = call %struct.Memory* @__remill_function_call(%struct.State* %0, i64 ptrtoint (i64 (i64)* @free to i64), %struct.Memory* %loadMem2_400a27)
...
block_.L_400a33:                                  ; preds = %block_.L_400a08, %block_4009fc
  ...
  ret %struct.Memory* %loadMem_400a3b
}
