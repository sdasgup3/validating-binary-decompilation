...
declare %struct.Memory* @sub_400810.rtclock(%struct.State* dereferenceable(3376), i64, %struct.Memory*) local_unnamed_addr
...
entry:
  ...
  %call2_400824 = tail call %struct.Memory* @sub_400810.rtclock(%struct.State* %0, i64 %11, %struct.Memory* %2)
  ...
  ret %struct.Memory* %call2_400824
}
