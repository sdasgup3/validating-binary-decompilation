...
entry:
  ...
  %216 = call %struct.Memory* @__remill_function_call(%struct.State* %0, i64 ptrtoint (i64 (i64)* @malloc to i64), %struct.Memory* %loadMem2_400e3b)
...
block_.L_400eb2:                                  ; preds = %block_.L_400e6f
  ...
  %862 = call %struct.Memory* @__remill_function_call(%struct.State* %0, i64 ptrtoint (i64 (i64, i64)* @fputs to i64), %struct.Memory* %loadMem2_400ebe)
...
block_.L_400ed4:                                  ; preds = %block_.L_400e5c
  ...
  %990 = call %struct.Memory* @__remill_function_call(%struct.State* %0, i64 ptrtoint (i64 (i64)* @free to i64), %struct.Memory* %loadMem2_400ed8)
  ...
  ret %struct.Memory* %loadMem_400ee2
}
