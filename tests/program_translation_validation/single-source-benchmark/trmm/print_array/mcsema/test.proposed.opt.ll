...
block_.L_400e3c:                                  ; preds = %block_.L_400e92, %entry
  %123 = phi i64 [ %.pre, %entry ], [ %357, %block_.L_400e92 ]
  %MEMORY.0 = phi %struct.Memory* [ %79, %entry ], [ %318, %block_.L_400e92 ]
  ...
  br i1 %159, label %block_400e48, label %block_.L_400eb4
...
block_.L_400e4f:                                  ; preds = %block_400e5b, %block_400e48
  %164 = phi i64 [ %.pre1, %block_400e48 ], [ %307, %block_400e5b ]
  %MEMORY.1 = phi %struct.Memory* [ %MEMORY.0, %block_400e48 ], [ %call2_400e7f, %block_400e5b ]
  ...
  br i1 %200, label %block_400e5b, label %block_.L_400e92
...
block_400e5b:                                     ; preds = %block_.L_400e4f
  ...
  %call2_400e7f = tail call %struct.Memory* @sub_400ed0.print_element(%struct.State* %0, i64 %270, %struct.Memory* %MEMORY.1)
...
block_.L_400e92:                                  ; preds = %block_.L_400e4f
  %308 = add i64 %165, -32
  %309 = add i64 %201, 4
...
block_.L_400eb4:                                  ; preds = %block_.L_400e3c
  %358 = add i64 %124, -32
  %359 = add i64 %160, 4
...
define %struct.Memory* @routine_jge_.L_400e92(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i8* %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 2, i32 9
...
define %struct.Memory* @routine_jmpq_.L_400e3c(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
