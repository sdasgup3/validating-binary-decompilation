...
block_.L_400e5c:                                  ; preds = %block_.L_400eb2, %entry
  %124 = phi i64 [ %.pre, %entry ], [ %355, %block_.L_400eb2 ]
  %MEMORY.0 = phi %struct.Memory* [ %79, %entry ], [ %317, %block_.L_400eb2 ]
  ...
  br i1 %160, label %block_400e68, label %block_.L_400ed4
...
block_.L_400e6f:                                  ; preds = %block_400e7b, %block_400e68
  %165 = phi i64 [ %306, %block_400e7b ], [ %.pre9, %block_400e68 ]
  ...
  br i1 %201, label %block_400e7b, label %block_.L_400eb2
...
block_400e7b:                                     ; preds = %block_.L_400e6f
  ...
  %call2_400e9f = tail call %struct.Memory* @sub_400ef0.print_element(%struct.State* nonnull %0, i64 %270, %struct.Memory* %MEMORY.0)
