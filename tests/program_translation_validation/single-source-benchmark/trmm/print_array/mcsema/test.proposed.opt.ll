...
declare %struct.Memory* @sub_400ef0.print_element(%struct.State* noalias dereferenceable(3376), i64, %struct.Memory* noalias readnone returned) local_unnamed_addr
...
block_.L_400e5c:                                  ; preds = %block_.L_400eb2, %entry
  %123 = phi i64 [ %353, %block_.L_400eb2 ], [ %.pre, %entry ]
...
block_.L_400e6f:                                  ; preds = %block_400e7b, %block_400e68
  %164 = phi i64 [ %305, %block_400e7b ], [ %.pre9, %block_400e68 ]
...
block_400e7b:                                     ; preds = %block_.L_400e6f
  ...
  %call2_400e9f = tail call %struct.Memory* @sub_400ef0.print_element(%struct.State* nonnull %0, i64 %269, %struct.Memory* %call2_400e3b)
...
block_.L_400eb2:                                  ; preds = %block_.L_400e6f
  ...
  %call2_400ebe = tail call %struct.Memory* @sub_400610.fputs_plt(%struct.State* nonnull %0, i64 %311, %struct.Memory* %call2_400e3b)
...
block_.L_400ed4:                                  ; preds = %block_.L_400e5c
  ...
  %call2_400ed8 = tail call %struct.Memory* @sub_4005f0.free_plt(%struct.State* nonnull %0, i64 %358, %struct.Memory* %call2_400e3b)
