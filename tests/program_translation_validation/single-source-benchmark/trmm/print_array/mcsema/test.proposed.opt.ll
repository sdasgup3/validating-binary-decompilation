...
declare %struct.Memory* @sub_400f00.print_element(%struct.State* noalias dereferenceable(3376), i64, %struct.Memory* noalias readnone returned) local_unnamed_addr
...
block_.L_400e6c:                                  ; preds = %block_.L_400ec2, %entry
  %124 = phi i64 [ %.pre, %entry ], [ %355, %block_.L_400ec2 ]
  %MEMORY.0 = phi %struct.Memory* [ %79, %entry ], [ %317, %block_.L_400ec2 ]
  ...
  br i1 %160, label %block_400e78, label %block_.L_400ee4

block_400e78:                                     ; preds = %block_.L_400e6c
  %162 = add i64 %125, -24
  %163 = add i64 %161, 7
...
block_.L_400e7f:                                  ; preds = %block_400e8b, %block_400e78
  %165 = phi i64 [ %306, %block_400e8b ], [ %.pre9, %block_400e78 ]
  ...
  br i1 %201, label %block_400e8b, label %block_.L_400ec2
...
block_400e8b:                                     ; preds = %block_.L_400e7f
  ...
  %call2_400eaf = tail call %struct.Memory* @sub_400f00.print_element(%struct.State* nonnull %0, i64 %270, %struct.Memory* %MEMORY.0)
...
block_.L_400ec2:                                  ; preds = %block_.L_400e7f
  %307 = add i64 %166, -32
  %308 = add i64 %202, 4
...
block_.L_400ee4:                                  ; preds = %block_.L_400e6c
  %356 = add i64 %125, -32
  %357 = add i64 %161, 4
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_jge_.L_400ec2(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i8* nocapture %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 2, i32 9
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_jmpq_.L_400e6c(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
