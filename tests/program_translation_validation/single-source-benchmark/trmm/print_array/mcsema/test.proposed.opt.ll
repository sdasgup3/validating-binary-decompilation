...
declare %struct.Memory* @sub_400ef0.print_element(%struct.State* dereferenceable(3376), i64, %struct.Memory*) local_unnamed_addr
...
entry:
  ...
  %call2_400e3b = tail call %struct.Memory* @sub_400640.malloc_plt(%struct.State* %0, i64 %74, %struct.Memory* %2)
...
block_.L_400e5c:                                  ; preds = %block_.L_400eb2, %entry
  %123 = phi i64 [ %.pre, %entry ], [ %353, %block_.L_400eb2 ]
  %MEMORY.0 = phi %struct.Memory* [ %call2_400e3b, %entry ], [ %call2_400ebe, %block_.L_400eb2 ]
  ...
  br i1 %159, label %block_400e68, label %block_.L_400ed4

block_400e68:                                     ; preds = %block_.L_400e5c
  %161 = add i64 %124, -24
  %162 = add i64 %160, 7
...
block_.L_400e6f:                                  ; preds = %block_400e7b, %block_400e68
  %164 = phi i64 [ %.pre9, %block_400e68 ], [ %305, %block_400e7b ]
  %MEMORY.1 = phi %struct.Memory* [ %MEMORY.0, %block_400e68 ], [ %call2_400e9f, %block_400e7b ]
  ...
  br i1 %200, label %block_400e7b, label %block_.L_400eb2
...
block_400e7b:                                     ; preds = %block_.L_400e6f
  ...
  %call2_400e9f = tail call %struct.Memory* @sub_400ef0.print_element(%struct.State* nonnull %0, i64 %269, %struct.Memory* %MEMORY.1)
...
block_.L_400eb2:                                  ; preds = %block_.L_400e6f
  %306 = add i64 %165, -32
  %307 = add i64 %201, 4
  ...
  %call2_400ebe = tail call %struct.Memory* @sub_400610.fputs_plt(%struct.State* nonnull %0, i64 %311, %struct.Memory* %MEMORY.1)
...
block_.L_400ed4:                                  ; preds = %block_.L_400e5c
  %354 = add i64 %124, -32
  %355 = add i64 %160, 4
  ...
  %call2_400ed8 = tail call %struct.Memory* @sub_4005f0.free_plt(%struct.State* nonnull %0, i64 %358, %struct.Memory* %MEMORY.0)
  ...
  ret %struct.Memory* %call2_400ed8
}
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_jge_.L_400eb2(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i8* nocapture %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 2, i32 9
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_jmpq_.L_400e5c(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
