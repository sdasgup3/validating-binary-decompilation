; ModuleID = '/tmp/tmp_tqnyv1x-query.ll'
...
entry:
  ...
  br i1 %var_2_16034, label %block_400e78.preheader, label %block_.L_400ee4

block_400e78.preheader:                           ; preds = %entry
  br label %block_400e78

block_400e78:                                     ; preds = %block_400e78.preheader, %block_.L_400ec2
  %var_2_175 = phi i32 [ %var_2_134, %block_.L_400ec2 ], [ %var_2_13424, %block_400e78.preheader ]
  %var_2_1661 = phi i64 [ %var_2_125, %block_.L_400ec2 ], [ %var_2_12518, %block_400e78.preheader ]
  %MEMORY.035 = phi %struct.Memory* [ %var_2_317, %block_.L_400ec2 ], [ %var_2_79, %block_400e78.preheader ]
  ...
  br i1 %var_2_20117, label %block_400e8b.preheader, label %block_.L_400ec2

block_400e8b.preheader:                           ; preds = %block_400e78
  br label %block_400e8b

block_400e8b:                                     ; preds = %block_400e8b.preheader, %block_400e8b
  br label %block_400e8b

block_.L_400ec2:                                  ; preds = %block_400e78
  ...
  br i1 %var_2_160, label %block_400e78, label %block_.L_400ee4.loopexit

block_.L_400ee4.loopexit:                         ; preds = %block_.L_400ec2
  br label %block_.L_400ee4

block_.L_400ee4:                                  ; preds = %block_.L_400ee4.loopexit, %entry
  %MEMORY.0.lcssa = phi %struct.Memory* [ %var_2_79, %entry ], [ %var_2_317, %block_.L_400ee4.loopexit ]
