...
entry:
  ...
  %152 = load double, double* inttoptr (i64 6299800 to double*)
  ...
  %246 = load double, double* inttoptr (i64 6299800 to double*)
  ...
  %389 = load double, double* inttoptr (i64 6299824 to double*)
  ...
  ret %struct.Memory* %loadMem_4017fa
}
