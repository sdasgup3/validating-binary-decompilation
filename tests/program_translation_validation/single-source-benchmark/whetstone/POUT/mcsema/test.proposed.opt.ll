...
entry:
  ...
  store i64 %117, i64* %77, align 1
  %118 = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 1, i64 2, i32 0, i32 0, i32 0, i64 1
  ...
  %124 = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 1, i64 3, i32 0, i32 0, i32 0, i64 1
  %125 = bitcast i64* %124 to double*
  store double 0.000000e+00, double* %125, align 1
  %126 = load i64, i64* %RAX.i45, align 8
  store i64 %126, i64* %RDI.i42, align 8
  ...
  %132 = tail call %struct.Memory* @__remill_function_call(%struct.State* %0, i64 ptrtoint (i64 (i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64)* @printf to i64), %struct.Memory* %2)
