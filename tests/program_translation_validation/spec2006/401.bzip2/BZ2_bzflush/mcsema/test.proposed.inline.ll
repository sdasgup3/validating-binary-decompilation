...
define %struct.Memory* @BZ2_bzflush(%struct.State* noalias, i64, %struct.Memory* noalias) #2 {
entry:
  ...
  %loadMem_4097b0 = load %struct.Memory*, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_4097b0, %struct.Memory** %MEMORY
  %loadMem_4097b1 = load %struct.Memory*, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_4097b1, %struct.Memory** %MEMORY
  %loadMem_4097b4 = load %struct.Memory*, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_4097b4, %struct.Memory** %MEMORY
  ...
  %loadMem_4097bb = load %struct.Memory*, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_4097bb, %struct.Memory** %MEMORY
  ret %struct.Memory* %loadMem_4097bb
}
