...
define %struct.Memory* @BZ2_bzopen(%struct.State* noalias, i64, %struct.Memory* noalias) #2 {
entry:
  ...
  store %struct.Memory* %loadMem_409344, %struct.Memory** %MEMORY
  ...
  %RDI.i15 = bitcast %union.anon* %112 to i64*
  %113 = getelementptr inbounds %struct.State, %struct.State* %0, i32 0, i32 6
  %114 = getelementptr inbounds %struct.GPR, %struct.GPR* %113, i32 0, i32 15
  %115 = getelementptr inbounds %struct.Reg, %struct.Reg* %114, i32 0, i32 0
  %RBP.i16 = bitcast %union.anon* %115 to i64*
  %116 = load i64, i64* %RBP.i16
  %117 = sub i64 %116, 8
  %118 = load i64, i64* %RDI.i15
  %119 = load i64, i64* %PC.i14
  %120 = add i64 %119, 4
  store i64 %120, i64* %PC.i14
  ...
  %RBP.i8 = bitcast %union.anon* %160 to i64*
  %161 = load i64, i64* %RBP.i8
  %162 = sub i64 %161, 16
  ...
  store %struct.Memory* %loadMem_40935b, %struct.Memory** %MEMORY
  ...
  %EAX.i = bitcast %union.anon* %172 to i32*
  ...
  store i64 %180, i64* %RSI.i, align 8
  ...
  store %struct.Memory* %loadMem1_409361, %struct.Memory** %MEMORY
  ...
  ret %struct.Memory* %loadMem_40936b
}
