...
define %struct.Memory* @bsPutUChar(%struct.State* noalias, i64, %struct.Memory* noalias readnone returned) local_unnamed_addr #1 {
entry:
  ...
  %AL.i17 = bitcast %union.anon* %40 to i8*
  %41 = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 9, i32 0
  %SIL.i = bitcast %union.anon* %41 to i8*
  %42 = load i8, i8* %SIL.i, align 1
  store i8 %42, i8* %AL.i17, align 1
  %RSI.i = getelementptr inbounds %union.anon, %union.anon* %41, i64 0, i32 0
  store i64 8, i64* %RSI.i, align 8
  %RDI.i13 = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 11, i32 0, i32 0
  %43 = add i64 %7, -16
  %44 = load i64, i64* %RDI.i13, align 8
  %45 = add i64 %10, 19
  ...
  store i64 %58, i64* %RDI.i13, align 8
  ...
  store i64 %63, i64* %RDX.i, align 8
  %64 = add i64 %55, 201
  %65 = add i64 %55, 13
  ...
  %call2_409bdf = tail call %struct.Memory* @sub_409ca0.bsW(%struct.State* %0, i64 %64, %struct.Memory* %2)
  ...
  ret %struct.Memory* %call2_409bdf
}
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_movzbl_MINUS0x9__rbp____edx(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
