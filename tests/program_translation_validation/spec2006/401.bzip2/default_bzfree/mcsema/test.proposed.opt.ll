...
define %struct.Memory* @default_bzfree(%struct.State* noalias, i64, %struct.Memory* noalias) local_unnamed_addr #1 {
entry:
  ...
  %.v = select i1 %62, i64 20, i64 11
  %66 = add i64 %52, %.v
  store i64 %66, i64* %3, align 8
  br i1 %62, label %block_.L_405394, label %block_40538b

block_40538b:                                     ; preds = %entry
  %67 = add i64 %66, 4
  store i64 %67, i64* %3, align 8
  %68 = load i64, i64* %54, align 8
  store i64 %68, i64* %RDI.i17, align 8
  %69 = add i64 %66, -19147
  %70 = add i64 %66, 9
...
block_.L_405394:                                  ; preds = %block_40538b, %entry
  %75 = phi i64 [ %66, %entry ], [ %.pre, %block_40538b ]
  %MEMORY.0 = phi %struct.Memory* [ %2, %entry ], [ %74, %block_40538b ]
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_je_.L_405394(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i8* nocapture %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
