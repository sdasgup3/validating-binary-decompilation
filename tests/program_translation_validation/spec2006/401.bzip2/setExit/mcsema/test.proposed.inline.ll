...
define %struct.Memory* @setExit(%struct.State* noalias, i64, %struct.Memory* noalias) #2 {
entry:
  ...
  %RBP.i6 = bitcast %union.anon* %37 to i64*
  %38 = load i64, i64* %RBP.i6
  %39 = sub i64 %38, 4
  ...
  %48 = load i64, i64* %PC.i4
  %49 = add i64 %48, 11
  store i64 %49, i64* %PC.i4
  store i32 0, i32* bitcast (%G_0x6195d8_type* @G_0x6195d8 to i32*)
  ...
  ret %struct.Memory* %loadMem_404933
}
...
define %struct.Memory* @routine_movl__0x0__0x6195d8(%struct.State* dereferenceable(3376), i64, %struct.Memory*) {
block_400488:
  %3 = getelementptr inbounds %struct.State, %struct.State* %0, i32 0, i32 6
  %4 = getelementptr inbounds %struct.GPR, %struct.GPR* %3, i32 0, i32 33
  %5 = getelementptr inbounds %struct.Reg, %struct.Reg* %4, i32 0, i32 0
