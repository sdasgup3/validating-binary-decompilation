...
define %struct.Memory* @setExit(%struct.State* noalias nocapture, i64, %struct.Memory* noalias readnone returned) local_unnamed_addr #0 {
entry:
  ...
  store i32 0, i32* bitcast (%G_0x6195d8_type* @G_0x6195d8 to i32*), align 8
  %17 = add i64 %16, 12
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_movl__0x0__0x6195d8(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned) local_unnamed_addr #1 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
