...
define %struct.Memory* @spec_rewind(%struct.State* noalias nocapture, i64, %struct.Memory* noalias readnone returned) local_unnamed_addr #1 {
entry:
  ...
  store i64 %29, i64* %RDX.i10, align 8
  %30 = lshr i64 %29, 63
  %31 = load i64, i64* %RCX.i15, align 8
  %32 = add i64 %29, %31
  store i64 %32, i64* %RCX.i15, align 8
