...
define %struct.Memory* @aa_init_moves(%struct.State* noalias, i64, %struct.Memory* noalias) #2 {
entry:
  ...
  store %struct.Memory* %loadMem_41ad61, %struct.Memory** %MEMORY
  ...
  store i64 %40, i64* %43
  store %struct.Memory* %loadMem_41ad64, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_41ad68, %struct.Memory** %MEMORY
  ...
  store i32 0, i32* %68
  store %struct.Memory* %loadMem_41ad6c, %struct.Memory** %MEMORY
  ...
  %PC.i2 = bitcast %union.anon* %71 to i64*
  ...
  %PC.i1 = bitcast %union.anon* %84 to i64*
  %85 = load i64, i64* %PC.i1
  %86 = add i64 %85, 1
  store i64 %86, i64* %PC.i1
  ...
  ret %struct.Memory* %loadMem_41ad73
}
