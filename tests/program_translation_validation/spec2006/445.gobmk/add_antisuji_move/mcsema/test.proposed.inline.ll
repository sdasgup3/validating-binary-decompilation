...
define %struct.Memory* @add_antisuji_move(%struct.State* noalias, i64, %struct.Memory* noalias) #2 {
entry:
  ...
  store %struct.Memory* %loadMem_433300, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_433301, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_433308, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_43330f, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_433312, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem1_433315, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_43331a, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_43331e, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_43331f, %struct.Memory** %MEMORY
  ret %struct.Memory* %loadMem_43331f
}
