...
define %struct.Memory* @add_antisuji_move(%struct.State* noalias, i64, %struct.Memory* noalias readnone returned) local_unnamed_addr #1 {
entry:
  ...
  store i64 70, i64* %RSI.i, align 8
  ...
  %call2_433315 = tail call %struct.Memory* @sub_432240.add_move_reason(%struct.State* %0, i64 %30, %struct.Memory* %2)
  ...
  ret %struct.Memory* %call2_433315
}
