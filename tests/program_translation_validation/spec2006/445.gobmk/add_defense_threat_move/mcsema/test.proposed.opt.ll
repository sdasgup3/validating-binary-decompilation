...
define %struct.Memory* @add_defense_threat_move(%struct.State* noalias, i64, %struct.Memory* noalias) local_unnamed_addr #1 {
entry:
  ...
  br i1 %65, label %block_43298e, label %entry.block_.L_4329a8_crit_edge

entry.block_.L_4329a8_crit_edge:                  ; preds = %entry
  ...
  br label %block_.L_4329a8

block_43298e:                                     ; preds = %entry
  ...
  br i1 %108, label %block_.L_4329a8, label %block_4329a3

block_4329a3:                                     ; preds = %block_43298e
  %113 = add i64 %112, 94
...
block_.L_4329a8:                                  ; preds = %entry.block_.L_4329a8_crit_edge, %block_43298e
  %ECX.i62.pre-phi.in = phi %union.anon* [ %.pre12, %entry.block_.L_4329a8_crit_edge ], [ %89, %block_43298e ]
  %RCX.i68.pre-phi = phi i64* [ %.pre13, %entry.block_.L_4329a8_crit_edge ], [ %RCX.i84, %block_43298e ]
  %114 = phi i64 [ %85, %entry.block_.L_4329a8_crit_edge ], [ %112, %block_43298e ]
...
; <label>:150:                                    ; preds = %block_.L_4329a8
...
; <label>:152:                                    ; preds = %block_.L_4329a8
...
routine_idivl__ecx.exit:                          ; preds = %209, %207
  ...
  %call2_4329fc = tail call %struct.Memory* @sub_452090.abortgo(%struct.State* nonnull %0, i64 %260, %struct.Memory* %215)
...
block_.L_432a01:                                  ; preds = %routine_idivl__ecx.exit, %block_4329a3
  %RDX.i.pre-phi = phi i64* [ %RDX.i73, %routine_idivl__ecx.exit ], [ %.pre11, %block_4329a3 ]
  %RDI.i.pre-phi = phi i64* [ %RDI.i77, %routine_idivl__ecx.exit ], [ %.pre10, %block_4329a3 ]
  %RAX.i17.pre-phi = phi i64* [ %.pre9, %routine_idivl__ecx.exit ], [ %RAX.i86, %block_4329a3 ]
  %RSI.i.pre-phi = phi i64* [ %RSI.i75, %routine_idivl__ecx.exit ], [ %.pre8, %block_4329a3 ]
  %265 = phi i64 [ %.pre7, %routine_idivl__ecx.exit ], [ %58, %block_4329a3 ]
  %266 = phi i64 [ %.pre6, %routine_idivl__ecx.exit ], [ %113, %block_4329a3 ]
  %MEMORY.1 = phi %struct.Memory* [ %call2_4329fc, %routine_idivl__ecx.exit ], [ %2, %block_4329a3 ]
  store i64 9, i64* %RSI.i.pre-phi, align 8
  ...
  %call2_432a24 = tail call %struct.Memory* @sub_432240.add_move_reason(%struct.State* nonnull %0, i64 %309, %struct.Memory* %MEMORY.1)
  ...
  ret %struct.Memory* %call2_432a24
}
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_jae_.L_4329a8(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i8* nocapture %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_je_.L_4329a8(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i8* nocapture %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_jmpq_.L_432a01(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_movl__0x2c8___esi(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
