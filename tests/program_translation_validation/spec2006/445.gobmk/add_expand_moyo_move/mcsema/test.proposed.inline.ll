...
define %struct.Memory* @add_expand_moyo_move(%struct.State* noalias, i64, %struct.Memory* noalias) #2 {
entry:
  ...
  store %struct.Memory* %loadMem_4342e1, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_4342e4, %struct.Memory** %MEMORY
  ...
  store i64 22, i64* %RSI.i, align 8
  ...
  store %struct.Memory* %loadMem_4342ed, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_4342f2, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem1_4342f5, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_4342fa, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_4342fe, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_4342ff, %struct.Memory** %MEMORY
  ret %struct.Memory* %loadMem_4342ff
}
...
define %struct.Memory* @routine_movl__0x16___esi(%struct.State* dereferenceable(3376), i64, %struct.Memory*) {
block_400488:
  %3 = getelementptr inbounds %struct.State, %struct.State* %0, i32 0, i32 6
  %4 = getelementptr inbounds %struct.GPR, %struct.GPR* %3, i32 0, i32 33
  %5 = getelementptr inbounds %struct.Reg, %struct.Reg* %4, i32 0, i32 0
