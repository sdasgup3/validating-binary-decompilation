...
define %struct.Memory* @add_expand_moyo_move(%struct.State* noalias, i64, %struct.Memory* noalias readnone returned) local_unnamed_addr #1 {
entry:
  ...
  %call2_4342f5 = tail call %struct.Memory* @sub_432240.add_move_reason(%struct.State* %0, i64 %30, %struct.Memory* %2)
  ...
  ret %struct.Memory* %call2_4342f5
}
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_movl__0x16___esi(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
