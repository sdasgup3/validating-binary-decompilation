...
define %struct.Memory* @add_expand_territory_move(%struct.State* noalias, i64, %struct.Memory* noalias) #2 {
entry:
  ...
  store %struct.Memory* %loadMem_4342c1, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_4342c8, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_4342cf, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_4342d2, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem1_4342d5, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_4342da, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_4342de, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_4342df, %struct.Memory** %MEMORY
  ret %struct.Memory* %loadMem_4342df
}
