...
define %struct.Memory* @add_expand_territory_move(%struct.State* noalias, i64, %struct.Memory* noalias readnone returned) local_unnamed_addr #1 {
entry:
  ...
  store i64 %29, i64* %RDI.i, align 8
  %30 = add i64 %25, -8338
  %31 = add i64 %25, 8
  ...
  %call2_4342d5 = tail call %struct.Memory* @sub_432240.add_move_reason(%struct.State* %0, i64 %30, %struct.Memory* %2)
  ...
  ret %struct.Memory* %call2_4342d5
}
