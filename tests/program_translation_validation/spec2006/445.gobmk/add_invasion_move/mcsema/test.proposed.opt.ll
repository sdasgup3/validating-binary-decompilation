...
define %struct.Memory* @add_invasion_move(%struct.State* noalias, i64, %struct.Memory* noalias readnone returned) local_unnamed_addr #1 {
entry:
  ...
  %call2_434315 = tail call %struct.Memory* @sub_432240.add_move_reason(%struct.State* %0, i64 %30, %struct.Memory* %2)
  ...
  ret %struct.Memory* %call2_434315
}
