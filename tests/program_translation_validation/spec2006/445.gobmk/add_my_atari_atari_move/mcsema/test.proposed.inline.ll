...
define %struct.Memory* @add_my_atari_atari_move(%struct.State* noalias, i64, %struct.Memory* noalias) #2 {
entry:
  ...
  store %struct.Memory* %loadMem_434c40, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_434c44, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_434c48, %struct.Memory** %MEMORY
  ...
  store i32 %86, i32* %90
  store %struct.Memory* %loadMem_434c4d, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_434c53, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_434c56, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_434c59, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem1_434c5b, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_434c60, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_434c65, %struct.Memory** %MEMORY
  ret %struct.Memory* %loadMem_434c65
}
