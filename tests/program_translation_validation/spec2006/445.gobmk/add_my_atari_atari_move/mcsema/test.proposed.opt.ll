...
define %struct.Memory* @add_my_atari_atari_move(%struct.State* noalias, i64, %struct.Memory* noalias readnone returned) local_unnamed_addr #1 {
entry:
  ...
  %call2_434c5b = tail call %struct.Memory* @sub_432240.add_move_reason(%struct.State* %0, i64 %67, %struct.Memory* %2)
  ...
  ret %struct.Memory* %call2_434c5b
}
