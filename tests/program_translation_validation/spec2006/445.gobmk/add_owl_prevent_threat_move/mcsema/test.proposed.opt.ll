...
define %struct.Memory* @add_owl_prevent_threat_move(%struct.State* noalias, i64, %struct.Memory* noalias) local_unnamed_addr #1 {
entry:
  ...
  br i1 %58, label %block_434cbb, label %entry.block_.L_434cd5_crit_edge

entry.block_.L_434cd5_crit_edge:                  ; preds = %entry
  ...
  br label %block_.L_434cd5

block_434cbb:                                     ; preds = %entry
  ...
  br i1 %101, label %block_.L_434cd5, label %block_434cd0

block_434cd0:                                     ; preds = %block_434cbb
  %106 = add i64 %105, 94
...
block_.L_434cd5:                                  ; preds = %entry.block_.L_434cd5_crit_edge, %block_434cbb
  %ECX.i62.pre-phi.in = phi %union.anon* [ %.pre12, %entry.block_.L_434cd5_crit_edge ], [ %82, %block_434cbb ]
  %RCX.i68.pre-phi = phi i64* [ %.pre13, %entry.block_.L_434cd5_crit_edge ], [ %RCX.i84, %block_434cbb ]
  %107 = phi i64 [ %78, %entry.block_.L_434cd5_crit_edge ], [ %105, %block_434cbb ]
  ...
  store i64 1268, i64* %RSI.i75, align 8
...
; <label>:143:                                    ; preds = %block_.L_434cd5
...
; <label>:145:                                    ; preds = %block_.L_434cd5
...
routine_idivl__ecx.exit:                          ; preds = %202, %200
  ...
  %call2_434d29 = tail call %struct.Memory* @sub_452090.abortgo(%struct.State* nonnull %0, i64 %253, %struct.Memory* %208)
...
block_.L_434d2e:                                  ; preds = %routine_idivl__ecx.exit, %block_434cd0
  %RDX.i.pre-phi = phi i64* [ %124, %routine_idivl__ecx.exit ], [ %.pre11, %block_434cd0 ]
  %RDI.i.pre-phi = phi i64* [ %RDI.i77, %routine_idivl__ecx.exit ], [ %.pre10, %block_434cd0 ]
  %RAX.i17.pre-phi = phi i64* [ %.pre9, %routine_idivl__ecx.exit ], [ %RAX.i86, %block_434cd0 ]
  %RSI.i.pre-phi = phi i64* [ %RSI.i75, %routine_idivl__ecx.exit ], [ %.pre8, %block_434cd0 ]
  %258 = phi i64 [ %.pre7, %routine_idivl__ecx.exit ], [ %51, %block_434cd0 ]
  %259 = phi i64 [ %.pre6, %routine_idivl__ecx.exit ], [ %106, %block_434cd0 ]
  %MEMORY.1 = phi %struct.Memory* [ %call2_434d29, %routine_idivl__ecx.exit ], [ %2, %block_434cd0 ]
  store i64 38, i64* %RSI.i.pre-phi, align 8
  ...
  %call2_434d4e = tail call %struct.Memory* @sub_432240.add_move_reason(%struct.State* nonnull %0, i64 %302, %struct.Memory* %MEMORY.1)
  ...
  ret %struct.Memory* %call2_434d4e
}
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_jae_.L_434cd5(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i8* nocapture %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_je_.L_434cd5(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i8* nocapture %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_jmpq_.L_434d2e(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_movl__0x4f4___esi(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  ...
  %4 = add i64 %3, 5
  store i64 %4, i64* %PC, align 8
  store i64 1268, i64* %RSI, align 8
  ret %struct.Memory* %2
}
