...
define %struct.Memory* @add_your_atari_atari_move(%struct.State* noalias, i64, %struct.Memory* noalias) #2 {
entry:
  ...
  store %struct.Memory* %loadMem_434c70, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_434c74, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_434c78, %struct.Memory** %MEMORY
  ...
  %PC.i11 = bitcast %union.anon* %93 to i64*
  ...
  %RBP.i12 = bitcast %union.anon* %99 to i64*
  %100 = load i64, i64* %RBP.i12
  %101 = sub i64 %100, 8
  ...
  store %struct.Memory* %loadMem_434c80, %struct.Memory** %MEMORY
  ...
  %RBP.i8 = bitcast %union.anon* %131 to i64*
  %132 = load i64, i64* %RBP.i8
  %133 = sub i64 %132, 8
  ...
  store %struct.Memory* %loadMem_434c89, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem1_434c8b, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_434c90, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_434c94, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_434c95, %struct.Memory** %MEMORY
  ret %struct.Memory* %loadMem_434c95
}
...
define %struct.Memory* @routine_movl__0x34___eax(%struct.State* dereferenceable(3376), i64, %struct.Memory*) {
block_400488:
  %3 = getelementptr inbounds %struct.State, %struct.State* %0, i32 0, i32 6
  %4 = getelementptr inbounds %struct.GPR, %struct.GPR* %3, i32 0, i32 33
  %5 = getelementptr inbounds %struct.Reg, %struct.Reg* %4, i32 0, i32 0
