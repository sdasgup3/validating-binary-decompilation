...
define %struct.Memory* @attack_move_known(%struct.State* noalias, i64, %struct.Memory* noalias readnone returned) local_unnamed_addr #1 {
entry:
  ...
  %call2_48998c = tail call %struct.Memory* @sub_437900.movelist_move_known(%struct.State* %0, i64 %125, %struct.Memory* %2)
  ...
  ret %struct.Memory* %call2_48998c
}
...
; Function Attrs: nounwind
define %struct.Memory* @routine_addq__0x3c___r8(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned) local_unnamed_addr #3 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %R8 = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 17, i32 0, i32 0
  %3 = load i64, i64* %R8, align 8
