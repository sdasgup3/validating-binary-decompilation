...
define %struct.Memory* @autohelperaa_attackpat11(%struct.State* noalias, i64, %struct.Memory* noalias readnone) local_unnamed_addr #1 {
entry:
  ...
  %ECX.i54 = bitcast %union.anon* %58 to i32*
  %59 = load i64, i64* %RBP.i, align 8
  %60 = add i64 %59, -16
  %61 = load i32, i32* %ECX.i54, align 4
  ...
  %RAX.i51 = getelementptr inbounds %union.anon, %union.anon* %65, i64 0, i32 0
  ...
  store i64 %72, i64* %RAX.i51, align 8
  %RCX.i49 = getelementptr inbounds %union.anon, %union.anon* %58, i64 0, i32 0
  %73 = shl nsw i64 %72, 2
  ...
  store i64 %119, i64* %RDI.i39, align 8
  %120 = add i64 %115, -569253
  %121 = add i64 %115, 8
  ...
  %call2_49a728 = tail call %struct.Memory* @sub_40f780.countlib(%struct.State* %0, i64 %120, %struct.Memory* %2)
  %125 = load i64, i64* %3, align 8
  store i64 0, i64* %RCX.i49, align 8
  %126 = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 17, i32 0
  %R8B.i34 = bitcast %union.anon* %126 to i8*
  store i8 0, i8* %R8B.i34, align 1
  %EAX.i32 = bitcast %union.anon* %65 to i32*
  %127 = load i32, i32* %EAX.i32, align 4
  %128 = add i32 %127, -2
  ...
  br i1 %157, label %block_.L_49a75e, label %block_49a73f
...
block_49a73f:                                     ; preds = %entry
  ...
  store i64 %164, i64* %RDI.i39, align 8
  ...
  %call2_49a74e = tail call %struct.Memory* @sub_412080.accuratelib(%struct.State* nonnull %0, i64 %170, %struct.Memory* %call2_49a728)
  %175 = load i32, i32* %EAX.i32, align 4
  %176 = load i64, i64* %3, align 8
  %177 = add i32 %175, -3
  %178 = icmp ult i32 %175, 3
  ...
  %198 = icmp ne i8 %192, 0
  %199 = xor i1 %198, %196
  %.demorgan = or i1 %189, %199
  %200 = xor i1 %.demorgan, true
  %201 = zext i1 %200 to i8
  store i8 %201, i8* %R8B.i34, align 1
...
block_.L_49a75e:                                  ; preds = %block_49a73f, %entry
  %206 = phi i64 [ %154, %entry ], [ %.pre, %block_49a73f ]
  %MEMORY.0 = phi %struct.Memory* [ %call2_49a728, %entry ], [ %call2_49a74e, %block_49a73f ]
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_jne_.L_49a75e(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i8* nocapture %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
