...
define %struct.Memory* @autohelperaa_attackpat14(%struct.State* noalias, i64, %struct.Memory* noalias readnone) local_unnamed_addr #1 {
entry:
  ...
  %call2_49a8d9 = tail call %struct.Memory* @sub_40f780.countlib(%struct.State* %0, i64 %167, %struct.Memory* %2)
  %172 = load i64, i64* %3, align 8
  store i64 0, i64* %RCX.i66, align 8
  %173 = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 17, i32 0
  %R8B.i39 = bitcast %union.anon* %173 to i8*
  store i8 0, i8* %R8B.i39, align 1
  ...
  br i1 %204, label %block_.L_49a916, label %block_49a8f0

block_49a8f0:                                     ; preds = %entry
  ...
  store i64 %211, i64* %RDI.i44, align 8
  %212 = add i64 %206, -12
  %213 = add i64 %205, 20
  ...
  store i64 %217, i64* %RAX.i68, align 8
  ...
  store i64 %217, i64* %RSI.i, align 8
  %237 = add i64 %205, -559216
  %238 = add i64 %205, 27
  ...
  %call2_49a906 = tail call %struct.Memory* @sub_412080.accuratelib(%struct.State* nonnull %0, i64 %237, %struct.Memory* %call2_49a8d9)
  %242 = load i32, i32* %EAX.i37, align 4
  ...
  %265 = icmp ne i8 %259, 0
  %266 = xor i1 %265, %263
  %267 = or i1 %256, %266
  %268 = zext i1 %267 to i8
  store i8 %268, i8* %R8B.i39, align 1
  ...
  br label %block_.L_49a916

block_.L_49a916:                                  ; preds = %block_49a8f0, %entry
  %273 = phi i64 [ %201, %entry ], [ %.pre, %block_49a8f0 ]
  %MEMORY.0 = phi %struct.Memory* [ %call2_49a8d9, %entry ], [ %call2_49a906, %block_49a8f0 ]
  ...
  store i64 %280, i64* %RAX.i68, align 8
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_jne_.L_49a916(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i8* nocapture %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
