...
define %struct.Memory* @autohelperaa_attackpat5(%struct.State* noalias, i64, %struct.Memory* noalias readnone returned) local_unnamed_addr #1 {
entry:
  ...
  %call2_49a65a = tail call %struct.Memory* @sub_412080.accuratelib(%struct.State* %0, i64 %62, %struct.Memory* %2)
  ...
  ret %struct.Memory* %call2_49a65a
}
