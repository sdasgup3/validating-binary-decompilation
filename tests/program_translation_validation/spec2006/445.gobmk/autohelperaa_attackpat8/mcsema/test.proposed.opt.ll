...
define %struct.Memory* @autohelperaa_attackpat8(%struct.State* noalias, i64, %struct.Memory* noalias readnone returned) local_unnamed_addr #1 {
entry:
  ...
  %call2_49a69a = tail call %struct.Memory* @sub_46bc30.safe_move(%struct.State* %0, i64 %78, %struct.Memory* %2)
  ...
  ret %struct.Memory* %call2_49a69a
}
