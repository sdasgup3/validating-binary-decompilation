...
define %struct.Memory* @autohelperbarrierspat117(%struct.State* noalias, i64, %struct.Memory* noalias readnone) local_unnamed_addr #1 {
entry:
  ...
  br i1 %171, label %block_49dda0, label %block_.L_49ddb3
...
block_49dda0:                                     ; preds = %entry
  ...
  %call2_49dda6 = tail call %struct.Memory* @sub_46bc30.safe_move(%struct.State* nonnull %0, i64 %186, %struct.Memory* %2)
...
block_.L_49ddb3:                                  ; preds = %entry
  ...
  %call2_49ddd5 = tail call %struct.Memory* @sub_478110.play_attack_defend_n(%struct.State* nonnull %0, i64 %247, %struct.Memory* %2)
...
block_.L_49ddf0:                                  ; preds = %block_.L_49ddb3, %block_49dda0
  %268 = phi i64 [ %.pre, %block_.L_49ddb3 ], [ %198, %block_49dda0 ]
  %MEMORY.0 = phi %struct.Memory* [ %call2_49ddd5, %block_.L_49ddb3 ], [ %call2_49dda6, %block_49dda0 ]
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_jne_.L_49ddb3(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i8* nocapture %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_jmpq_.L_49ddf0(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
