...
define %struct.Memory* @autohelperbarrierspat118(%struct.State* noalias, i64, %struct.Memory* noalias readnone) local_unnamed_addr #1 {
entry:
  ...
  br i1 %171, label %block_49de40, label %block_.L_49de53
...
block_49de40:                                     ; preds = %entry
  ...
  %call2_49de46 = tail call %struct.Memory* @sub_46bc30.safe_move(%struct.State* nonnull %0, i64 %186, %struct.Memory* %2)
...
block_.L_49de53:                                  ; preds = %entry
  ...
  %call2_49de75 = tail call %struct.Memory* @sub_478110.play_attack_defend_n(%struct.State* nonnull %0, i64 %247, %struct.Memory* %2)
...
block_.L_49de90:                                  ; preds = %block_.L_49de53, %block_49de40
  %268 = phi i64 [ %.pre, %block_.L_49de53 ], [ %198, %block_49de40 ]
  %MEMORY.0 = phi %struct.Memory* [ %call2_49de75, %block_.L_49de53 ], [ %call2_49de46, %block_49de40 ]
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_jne_.L_49de53(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i8* nocapture %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_jmpq_.L_49de90(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
