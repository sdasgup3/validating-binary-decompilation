...
define %struct.Memory* @autohelperbarrierspat12(%struct.State* noalias, i64, %struct.Memory* noalias readnone) local_unnamed_addr #1 {
entry:
  ...
  store i64 %166, i64* %RAX.i76, align 8
  ...
  store i64 %172, i64* %RCX.i74, align 8
  %173 = add i64 %160, -8
  %174 = add i64 %162, 14
  ...
  store i64 %178, i64* %RCX.i74, align 8
  ...
  store i64 %218, i64* %RSI.i38, align 8
  %219 = add i64 %209, -192663
  %220 = add i64 %209, 11
  ...
  %call2_49accd = tail call %struct.Memory* @sub_46bc30.safe_move(%struct.State* %0, i64 %219, %struct.Memory* %2)
  %224 = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 17, i32 0
  %R8B.i35 = bitcast %union.anon* %224 to i8*
  ...
  %.v = select i1 %242, i64 45, i64 6
  %243 = add i64 %240, %.v
  store i64 %243, i64* %3, align 8
  %cmpBr_49acdc = icmp eq i8 %241, 1
  br i1 %cmpBr_49acdc, label %entry.block_.L_49ad09_crit_edge, label %block_49ace2

entry.block_.L_49ad09_crit_edge:                  ; preds = %entry
...
block_49ace2:                                     ; preds = %entry
  ...
  store i64 %249, i64* %RDI.i41, align 8
  %250 = add i64 %244, -20
  %251 = add i64 %243, 13
  ...
  %255 = getelementptr inbounds %union.anon, %union.anon* %224, i64 0, i32 0
  %256 = add i64 %244, -24
  %257 = add i64 %243, 17
  ...
  %call2_49acf9 = tail call %struct.Memory* @sub_4784b0.play_attack_defend2_n(%struct.State* nonnull %0, i64 %267, %struct.Memory* %call2_49accd)
  %272 = load i32, i32* %EAX.i33, align 4
  ...
  %R10B.i14 = bitcast %union.anon* %283 to i8*
  %284 = xor i1 %279, true
  %285 = zext i1 %284 to i8
  store i8 %285, i8* %R10B.i14, align 1
...
block_.L_49ad09:                                  ; preds = %entry.block_.L_49ad09_crit_edge, %block_49ace2
  %AL.i9.pre-phi = phi i8* [ %.pre1, %entry.block_.L_49ad09_crit_edge ], [ %AL.i18, %block_49ace2 ]
  %290 = phi i64 [ %243, %entry.block_.L_49ad09_crit_edge ], [ %.pre, %block_49ace2 ]
  %MEMORY.0 = phi %struct.Memory* [ %call2_49accd, %entry.block_.L_49ad09_crit_edge ], [ %call2_49acf9, %block_49ace2 ]
  ...
  %296 = and i8 %295, 1
  store i8 %296, i8* %AL.i9.pre-phi, align 1
  %297 = zext i8 %296 to i64
  store i64 %297, i64* %RAX.i76, align 8
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_je_.L_49ad09(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i8* nocapture %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
