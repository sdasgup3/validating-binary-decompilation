...
define %struct.Memory* @autohelperbarrierspat121(%struct.State* noalias, i64, %struct.Memory* noalias readnone) local_unnamed_addr #1 {
entry:
  ...
  %call2_49e008 = tail call %struct.Memory* @sub_40f780.countlib(%struct.State* %0, i64 %120, %struct.Memory* %2)
  ...
  br i1 %157, label %block_.L_49e06b, label %block_49e01f

block_49e01f:                                     ; preds = %entry
  ...
  br i1 %165, label %block_49e02d, label %block_.L_49e050

block_49e02d:                                     ; preds = %block_49e01f
  ...
  br label %block_.L_49e05f

block_.L_49e050:                                  ; preds = %block_49e01f
  ...
  %call2_49e057 = tail call %struct.Memory* @sub_45db40.attack(%struct.State* nonnull %0, i64 %219, %struct.Memory* %call2_49e008)
...
block_.L_49e05f:                                  ; preds = %block_.L_49e050, %block_49e02d
  %230 = phi i64 [ %.pre, %block_.L_49e050 ], [ %212, %block_49e02d ]
  %MEMORY.0 = phi %struct.Memory* [ %call2_49e057, %block_.L_49e050 ], [ %call2_49e008, %block_49e02d ]
  ...
  store i8 %247, i8* %CL.i52, align 1
  %248 = add i64 %231, -21
  %249 = add i64 %230, 12
  ...
  br label %block_.L_49e06b

block_.L_49e06b:                                  ; preds = %block_.L_49e05f, %entry
  %251 = phi i64 [ %154, %entry ], [ %.pre2, %block_.L_49e05f ]
  %MEMORY.1 = phi %struct.Memory* [ %call2_49e008, %entry ], [ %MEMORY.0, %block_.L_49e05f ]
  ...
  store i64 %258, i64* %RAX.i70, align 8
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_jne_.L_49e06b(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i8* nocapture %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_jne_.L_49e050(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i8* nocapture %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 2, i32 7
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_jmpq_.L_49e05f(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
