...
define %struct.Memory* @autohelperbarrierspat124(%struct.State* noalias, i64, %struct.Memory* noalias readnone) local_unnamed_addr #1 {
entry:
  ...
  %EDI.i151 = bitcast %union.anon* %40 to i32*
  %41 = add i64 %7, -12
  %42 = load i32, i32* %EDI.i151, align 4
  %43 = add i64 %10, 10
  ...
  %RDI.i93 = getelementptr inbounds %union.anon, %union.anon* %40, i64 0, i32 0
  ...
  store i64 %261, i64* %RDI.i93, align 8
  %262 = add i64 %257, -584360
  %263 = add i64 %257, 8
  ...
  %call2_49e22b = tail call %struct.Memory* @sub_40f780.countlib(%struct.State* %0, i64 %262, %struct.Memory* %2)
  %267 = load i64, i64* %3, align 8
  store i64 0, i64* %RCX.i139, align 8
  %CL.i87 = bitcast %union.anon* %59 to i8*
  %268 = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 17, i32 0
  %R8B.i88 = bitcast %union.anon* %268 to i8*
  ...
  br i1 %299, label %block_.L_49e2cf, label %block_49e242

block_49e242:                                     ; preds = %entry
  %301 = load i32, i32* bitcast (%G_0xb54ce4_type* @G_0xb54ce4 to i32*), align 8
  %302 = icmp eq i32 %301, 0
  %.v = select i1 %302, i64 14, i64 60
  %303 = add i64 %300, %.v
  %304 = add i64 %303, 2
  ...
  br i1 %302, label %block_49e250, label %block_.L_49e27e
...
block_49e250:                                     ; preds = %block_49e242
  ...
  store i64 %311, i64* %RSI.i69, align 8
  %312 = lshr i64 %311, 63
  %313 = add i64 %311, ptrtoint (%G__0xb0eff0_type* @G__0xb0eff0 to i64)
  store i64 %313, i64* %RDX.i72, align 8
  ...
  %359 = select i1 %358, i64 %355, i64 %356
  store i64 %359, i64* %3, align 8
  br i1 %358, label %block_.L_49e2cf, label %block_49e279
...
block_.L_49e27e:                                  ; preds = %block_49e242
  ...
  store i64 %366, i64* %RDI.i93, align 8
  %367 = add i64 %303, -263998
  %368 = add i64 %303, 12
  ...
  %call2_49e285 = tail call %struct.Memory* @sub_45db40.attack(%struct.State* nonnull %0, i64 %367, %struct.Memory* %call2_49e22b)
  %372 = load i64, i64* %3, align 8
  store i64 0, i64* %RDI.i93, align 8
  store i8 0, i8* %CL.i87, align 1
  %373 = load i32, i32* %EAX.i85, align 4
  store i8 0, i8* %14, align 1
  %374 = and i32 %373, 255
  ...
  %388 = add i64 %387, 58
  %389 = add i64 %387, 6
  %390 = load i8, i8* %30, align 1
  %391 = icmp eq i8 %390, 0
  %392 = select i1 %391, i64 %388, i64 %389
  store i64 %392, i64* %3, align 8
  br i1 %391, label %block_.L_49e2cf, label %block_.L_49e27e.block_.L_49e29b_crit_edge

block_.L_49e27e.block_.L_49e29b_crit_edge:        ; preds = %block_.L_49e27e
  %.pre4 = getelementptr inbounds %union.anon, %union.anon* %52, i64 0, i32 0
  br label %block_.L_49e29b

block_.L_49e29b:                                  ; preds = %block_.L_49e27e.block_.L_49e29b_crit_edge, %block_49e279
  %RDX.i.pre-phi = phi i64* [ %.pre4, %block_.L_49e27e.block_.L_49e29b_crit_edge ], [ %RDX.i72, %block_49e279 ]
  %RSI.i.pre-phi = phi i64* [ %RSI.i52, %block_.L_49e27e.block_.L_49e29b_crit_edge ], [ %RSI.i69, %block_49e279 ]
  %393 = phi i64 [ %389, %block_.L_49e27e.block_.L_49e29b_crit_edge ], [ %360, %block_49e279 ]
  %MEMORY.0 = phi %struct.Memory* [ %call2_49e285, %block_.L_49e27e.block_.L_49e29b_crit_edge ], [ %call2_49e22b, %block_49e279 ]
  %AL.i20.pre-phi = bitcast %union.anon* %66 to i8*
  ...
  store i64 %399, i64* %RDI.i93, align 8
  %400 = add i64 %394, -20
  %401 = add i64 %393, 16
  ...
  store i64 %404, i64* %RCX.i139, align 8
  %405 = getelementptr inbounds %union.anon, %union.anon* %268, i64 0, i32 0
  %406 = add i64 %394, -24
  %407 = add i64 %393, 20
  ...
  store i64 %419, i64* %RAX.i141, align 8
  ...
  %call2_49e2bb = tail call %struct.Memory* @sub_478110.play_attack_defend_n(%struct.State* nonnull %0, i64 %424, %struct.Memory* %MEMORY.0)
  %429 = load i32, i32* %EAX.i85, align 4
...
block_.L_49e2cf:                                  ; preds = %block_.L_49e29b, %block_.L_49e27e, %block_49e250, %entry
  %445 = phi i64 [ %296, %entry ], [ %388, %block_.L_49e27e ], [ %.pre, %block_.L_49e29b ], [ %355, %block_49e250 ]
  %MEMORY.1 = phi %struct.Memory* [ %call2_49e22b, %entry ], [ %call2_49e285, %block_.L_49e27e ], [ %call2_49e2bb, %block_.L_49e29b ], [ %call2_49e22b, %block_49e250 ]
  ...
  store i64 %452, i64* %RAX.i141, align 8
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_movl_0xb58b30___rax_4____ecx(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %RAX = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 1, i32 0, i32 0
  %RCX = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 5, i32 0, i32 0
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_jne_.L_49e2cf(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i8* nocapture %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_jne_.L_49e27e(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i8* nocapture %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 2, i32 7
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_jmpq_.L_49e29b(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
