...
define %struct.Memory* @autohelperbarrierspat127(%struct.State* noalias, i64, %struct.Memory* noalias readnone) local_unnamed_addr #1 {
entry:
  ...
  %call2_49e6cd = tail call %struct.Memory* @sub_46bc30.safe_move(%struct.State* %0, i64 %219, %struct.Memory* %2)
  ...
  %.v = select i1 %242, i64 48, i64 6
  %243 = add i64 %240, %.v
  store i64 %243, i64* %3, align 8
  %cmpBr_49e6de = icmp eq i8 %241, 1
  br i1 %cmpBr_49e6de, label %entry.block_.L_49e70e_crit_edge, label %block_49e6e4

entry.block_.L_49e70e_crit_edge:                  ; preds = %entry
  %.pre1 = bitcast %union.anon* %65 to i8*
  br label %block_.L_49e70e

block_49e6e4:                                     ; preds = %entry
  ...
  store i64 %249, i64* %RDI.i43, align 8
  %250 = add i64 %244, -20
  %251 = add i64 %243, 16
  ...
  store i64 %254, i64* %RCX.i77, align 8
  %255 = getelementptr inbounds %union.anon, %union.anon* %225, i64 0, i32 0
  %256 = add i64 %244, -24
  %257 = add i64 %243, 20
  ...
  %call2_49e6fe = tail call %struct.Memory* @sub_478110.play_attack_defend_n(%struct.State* nonnull %0, i64 %267, %struct.Memory* %call2_49e6cd)
...
block_.L_49e70e:                                  ; preds = %entry.block_.L_49e70e_crit_edge, %block_49e6e4
  %AL.i9.pre-phi = phi i8* [ %.pre1, %entry.block_.L_49e70e_crit_edge ], [ %AL.i18, %block_49e6e4 ]
  %290 = phi i64 [ %243, %entry.block_.L_49e70e_crit_edge ], [ %.pre, %block_49e6e4 ]
  %MEMORY.0 = phi %struct.Memory* [ %call2_49e6cd, %entry.block_.L_49e70e_crit_edge ], [ %call2_49e6fe, %block_49e6e4 ]
  ...
  store i64 %297, i64* %RAX.i79, align 8
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_je_.L_49e70e(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i8* nocapture %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
