...
define %struct.Memory* @autohelperbarrierspat141(%struct.State* noalias, i64, %struct.Memory* noalias readnone) local_unnamed_addr #1 {
entry:
  ...
  %ECX.i33 = bitcast %union.anon* %58 to i32*
  %59 = load i64, i64* %RBP.i, align 8
  %60 = add i64 %59, -16
  %61 = load i32, i32* %ECX.i33, align 4
  ...
  %RCX.i28 = getelementptr inbounds %union.anon, %union.anon* %58, i64 0, i32 0
  %72 = shl nsw i64 %71, 2
  ...
  store i64 %77, i64* %RCX.i28, align 8
  %78 = add i64 %65, -8
  %79 = add i64 %67, 14
  ...
  store i64 %83, i64* %RCX.i28, align 8
  ...
  store i64 %118, i64* %RAX.i30, align 8
  ...
  %.v = select i1 %129, i64 18, i64 36
  %133 = add i64 %114, %.v
  store i64 %133, i64* %3, align 8
  br i1 %129, label %block_49efb7, label %block_.L_49efc9
...
block_49efb7:                                     ; preds = %entry
  ...
  %call2_49efc4 = tail call %struct.Memory* @sub_428ce0.influence_mark_non_territory(%struct.State* nonnull %0, i64 %162, %struct.Memory* %2)
  %.pre = load i64, i64* %RAX.i30, align 8
  %167 = trunc i64 %.pre to i32
  %.pre1 = load i64, i64* %3, align 8
  br label %block_.L_49efc9

block_.L_49efc9:                                  ; preds = %entry, %block_49efb7
  %168 = phi i64 [ %.pre1, %block_49efb7 ], [ %133, %entry ]
  %169 = phi i32 [ %167, %block_49efb7 ], [ %117, %entry ]
  %170 = phi i64 [ %.pre, %block_49efb7 ], [ %118, %entry ]
  %MEMORY.0 = phi %struct.Memory* [ %call2_49efc4, %block_49efb7 ], [ %2, %entry ]
  %171 = zext i32 %169 to i64
  %.masked = and i64 %170, 4294967295
  %172 = xor i64 %171, %.masked
  store i64 %172, i64* %RAX.i30, align 8
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_jne_.L_49efc9(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i8* nocapture %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
