...
define %struct.Memory* @autohelperbarrierspat149(%struct.State* noalias, i64, %struct.Memory* noalias readnone) local_unnamed_addr #1 {
entry:
  ...
  br i1 %171, label %block_49f450, label %block_.L_49f463

block_49f450:                                     ; preds = %entry
  ...
  store i64 %180, i64* %RDI.i39, align 8
  ...
  store i64 %185, i64* %RSI.i36, align 8
  %186 = add i64 %175, -210976
  %187 = add i64 %175, 11
  ...
  %call2_49f456 = tail call %struct.Memory* @sub_46bc30.safe_move(%struct.State* nonnull %0, i64 %186, %struct.Memory* %2)
  %EAX.i32 = bitcast %union.anon* %65 to i32*
  %191 = load i64, i64* %RBP.i, align 8
  %192 = add i64 %191, -4
  %193 = load i32, i32* %EAX.i32, align 4
...
block_.L_49f463:                                  ; preds = %entry
  store i64 3, i64* %RAX.i64, align 8
  ...
  store i64 %203, i64* %RDI.i26, align 8
  %204 = add i64 %160, -16
  %205 = add i64 %175, 11
  ...
  store i64 %209, i64* %RAX.i64, align 8
  ...
  store i64 %209, i64* %RSI.i21, align 8
  %229 = add i64 %175, -485251
  %230 = add i64 %175, 18
  ...
  %call2_49f470 = tail call %struct.Memory* @sub_428ce0.influence_mark_non_territory(%struct.State* nonnull %0, i64 %229, %struct.Memory* %2)
  ...
  store i64 %246, i64* %RAX.i64, align 8
  %247 = icmp ugt i32 %244, 3
  ...
  store i64 %246, i64* %RSI.i21, align 8
  %266 = add i64 %234, -485269
  %267 = add i64 %234, 18
  ...
  %call2_49f482 = tail call %struct.Memory* @sub_428ce0.influence_mark_non_territory(%struct.State* nonnull %0, i64 %266, %struct.Memory* %call2_49f470)
...
block_.L_49f48e:                                  ; preds = %block_.L_49f463, %block_49f450
  %276 = phi i64 [ %.pre, %block_.L_49f463 ], [ %198, %block_49f450 ]
  %MEMORY.0 = phi %struct.Memory* [ %call2_49f482, %block_.L_49f463 ], [ %call2_49f456, %block_49f450 ]
  ...
  store i64 %282, i64* %RAX.i64, align 8
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_jne_.L_49f463(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i8* nocapture %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_jmpq_.L_49f48e(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
