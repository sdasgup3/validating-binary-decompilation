...
define %struct.Memory* @autohelperbarrierspat15(%struct.State* noalias, i64, %struct.Memory* noalias readnone returned) local_unnamed_addr #1 {
entry:
  ...
  store i64 %229, i64* %R9.i76, align 8
  ...
  %call2_49ad9c = tail call %struct.Memory* @sub_4784b0.play_attack_defend2_n(%struct.State* %0, i64 %263, %struct.Memory* %2)
  ...
  ret %struct.Memory* %call2_49ad9c
}
