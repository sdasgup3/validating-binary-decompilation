...
define %struct.Memory* @autohelperbarrierspat155(%struct.State* noalias, i64, %struct.Memory* noalias readnone returned) local_unnamed_addr #1 {
entry:
  ...
  %call2_49f8cc = tail call %struct.Memory* @sub_428ce0.influence_mark_non_territory(%struct.State* %0, i64 %171, %struct.Memory* %2)
  ...
  %call2_49f8d7 = tail call %struct.Memory* @sub_428ce0.influence_mark_non_territory(%struct.State* %0, i64 %188, %struct.Memory* %call2_49f8cc)
  ...
  ret %struct.Memory* %call2_49f8d7
}
