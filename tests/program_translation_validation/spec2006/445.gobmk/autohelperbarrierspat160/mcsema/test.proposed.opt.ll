...
define %struct.Memory* @autohelperbarrierspat160(%struct.State* noalias, i64, %struct.Memory* noalias readnone) local_unnamed_addr #1 {
entry:
  ...
  %.v = select i1 %218, i64 10, i64 72
  %222 = add i64 %209, %.v
  store i64 %222, i64* %3, align 8
  br i1 %218, label %block_49fcf1, label %block_.L_49fd2f

block_49fcf1:                                     ; preds = %entry
  %RSI.i45 = getelementptr inbounds %union.anon, %union.anon* %44, i64 0, i32 0
  store i64 0, i64* %RSI.i45, align 8
  store i8 0, i8* %14, align 1
  ...
  store i64 3, i64* %RAX.i82, align 8
  %223 = add i64 %207, -16
  %224 = add i64 %222, 15
  ...
  store i64 %228, i64* %RAX.i82, align 8
  ...
  store i64 %252, i64* %RCX.i80, align 8
  %253 = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 17, i32 0, i32 0
  %254 = add i64 %207, -28
  %255 = add i64 %222, 22
  ...
  %EAX.i30 = bitcast %union.anon* %65 to i32*
  %RDI.i31 = getelementptr inbounds %union.anon, %union.anon* %39, i64 0, i32 0
  store i64 %228, i64* %RDI.i31, align 8
  %AL.i = bitcast %union.anon* %65 to i8*
  store i8 0, i8* %AL.i, align 1
  %265 = add i64 %222, -161857
  %266 = add i64 %222, 35
  ...
  %call2_49fd0f = tail call %struct.Memory* @sub_4784b0.play_attack_defend2_n(%struct.State* nonnull %0, i64 %265, %struct.Memory* %2)
  %270 = load i32, i32* %EAX.i30, align 4
  %271 = load i64, i64* %3, align 8
  %272 = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 21, i32 0
  %R10B.i24 = bitcast %union.anon* %272 to i8*
  %273 = icmp eq i32 %270, 0
  %274 = zext i1 %273 to i8
  store i8 %274, i8* %R10B.i24, align 1
  store i8 0, i8* %14, align 1
  %275 = zext i1 %273 to i32
  ...
  store i8 0, i8* %38, align 1
  store i8 0, i8* %26, align 1
  %280 = zext i1 %273 to i64
  store i64 %280, i64* %RAX.i82, align 8
...
block_.L_49fd2f:                                  ; preds = %entry
  ...
  store i64 %297, i64* %RSI.i, align 8
  %298 = add i64 %222, -487503
  %299 = add i64 %222, 11
  ...
  %call2_49fd35 = tail call %struct.Memory* @sub_428ce0.influence_mark_non_territory(%struct.State* nonnull %0, i64 %298, %struct.Memory* %2)
...
block_.L_49fd41:                                  ; preds = %block_.L_49fd2f, %block_49fcf1
  %308 = phi i64 [ %.pre, %block_.L_49fd2f ], [ %287, %block_49fcf1 ]
  %MEMORY.0 = phi %struct.Memory* [ %call2_49fd35, %block_.L_49fd2f ], [ %call2_49fd0f, %block_49fcf1 ]
  ...
  store i64 %314, i64* %RAX.i82, align 8
  %315 = load i64, i64* %6, align 8
  %316 = add i64 %315, 32
  store i64 %316, i64* %6, align 8
  %317 = icmp ugt i64 %315, -33
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_jne_.L_49fd2f(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i8* nocapture %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_jmpq_.L_49fd41(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
