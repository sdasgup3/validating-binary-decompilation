...
define %struct.Memory* @autohelperbarrierspat167(%struct.State* noalias, i64, %struct.Memory* noalias readnone returned) local_unnamed_addr #1 {
entry:
  ...
  %R8.i22 = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 17, i32 0, i32 0
  ...
  store i64 %71, i64* %R8.i22, align 8
  ...
  %119 = load i64, i64* %RAX.i33, align 8
  %120 = add i64 %112, -12
  %121 = add i64 %114, 6
  ...
  %call2_4a0333 = tail call %struct.Memory* @sub_428ce0.influence_mark_non_territory(%struct.State* %0, i64 %150, %struct.Memory* %2)
  %155 = load i64, i64* %3, align 8
  store i64 0, i64* %RAX.i33, align 8
  ...
  ret %struct.Memory* %call2_4a0333
}
