...
define %struct.Memory* @autohelperbarrierspat168(%struct.State* noalias, i64, %struct.Memory* noalias readnone returned) local_unnamed_addr #1 {
entry:
  ...
  %call2_4a036b = tail call %struct.Memory* @sub_428ce0.influence_mark_non_territory(%struct.State* %0, i64 %124, %struct.Memory* %2)
  ...
  ret %struct.Memory* %call2_4a036b
}
