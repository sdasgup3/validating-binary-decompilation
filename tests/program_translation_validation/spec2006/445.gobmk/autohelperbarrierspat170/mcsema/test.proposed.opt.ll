...
define %struct.Memory* @autohelperbarrierspat170(%struct.State* noalias, i64, %struct.Memory* noalias readnone) local_unnamed_addr #1 {
entry:
  ...
  br i1 %171, label %block_4a0480, label %block_.L_4a0493

block_4a0480:                                     ; preds = %entry
  ...
  store i64 %180, i64* %RDI.i27, align 8
  ...
  store i64 %185, i64* %RSI.i24, align 8
  %186 = add i64 %175, -215120
  %187 = add i64 %175, 11
  ...
  %call2_4a0486 = tail call %struct.Memory* @sub_46bc30.safe_move(%struct.State* nonnull %0, i64 %186, %struct.Memory* %2)
  %EAX.i20 = bitcast %union.anon* %65 to i32*
  %191 = load i64, i64* %RBP.i, align 8
  %192 = add i64 %191, -4
  %193 = load i32, i32* %EAX.i20, align 4
...
block_.L_4a0493:                                  ; preds = %entry
  ...
  store i64 %203, i64* %RDI.i, align 8
  %204 = add i64 %160, -16
  %205 = add i64 %175, 11
  ...
  %call2_4a04a0 = tail call %struct.Memory* @sub_428ce0.influence_mark_non_territory(%struct.State* nonnull %0, i64 %229, %struct.Memory* %2)
...
block_.L_4a04ac:                                  ; preds = %block_.L_4a0493, %block_4a0480
  %239 = phi i64 [ %.pre, %block_.L_4a0493 ], [ %198, %block_4a0480 ]
  %MEMORY.0 = phi %struct.Memory* [ %call2_4a04a0, %block_.L_4a0493 ], [ %call2_4a0486, %block_4a0480 ]
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_jne_.L_4a0493(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i8* nocapture %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_jmpq_.L_4a04ac(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
