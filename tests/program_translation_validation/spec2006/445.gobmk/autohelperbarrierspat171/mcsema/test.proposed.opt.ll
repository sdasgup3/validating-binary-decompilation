...
define %struct.Memory* @autohelperbarrierspat171(%struct.State* noalias, i64, %struct.Memory* noalias readnone) local_unnamed_addr #1 {
entry:
  ...
  br i1 %171, label %block_4a0500, label %block_.L_4a0513

block_4a0500:                                     ; preds = %entry
  ...
  %call2_4a0506 = tail call %struct.Memory* @sub_46bc30.safe_move(%struct.State* nonnull %0, i64 %186, %struct.Memory* %2)
  ...
  br label %block_.L_4a052c

block_.L_4a0513:                                  ; preds = %entry
  ...
  %call2_4a0520 = tail call %struct.Memory* @sub_428ce0.influence_mark_non_territory(%struct.State* nonnull %0, i64 %229, %struct.Memory* %2)
...
block_.L_4a052c:                                  ; preds = %block_.L_4a0513, %block_4a0500
  %239 = phi i64 [ %.pre, %block_.L_4a0513 ], [ %198, %block_4a0500 ]
  %MEMORY.0 = phi %struct.Memory* [ %call2_4a0520, %block_.L_4a0513 ], [ %call2_4a0506, %block_4a0500 ]
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_jne_.L_4a0513(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i8* nocapture %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_jmpq_.L_4a052c(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
