...
define %struct.Memory* @autohelperbarrierspat172(%struct.State* noalias, i64, %struct.Memory* noalias readnone) local_unnamed_addr #1 {
entry:
  ...
  br i1 %171, label %block_4a0580, label %block_.L_4a0593

block_4a0580:                                     ; preds = %entry
  ...
  %call2_4a0586 = tail call %struct.Memory* @sub_46bc30.safe_move(%struct.State* nonnull %0, i64 %186, %struct.Memory* %2)
...
block_.L_4a0593:                                  ; preds = %entry
  ...
  %call2_4a05a0 = tail call %struct.Memory* @sub_428ce0.influence_mark_non_territory(%struct.State* nonnull %0, i64 %229, %struct.Memory* %2)
...
block_.L_4a05ac:                                  ; preds = %block_.L_4a0593, %block_4a0580
  %239 = phi i64 [ %.pre, %block_.L_4a0593 ], [ %198, %block_4a0580 ]
  %MEMORY.0 = phi %struct.Memory* [ %call2_4a05a0, %block_.L_4a0593 ], [ %call2_4a0586, %block_4a0580 ]
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_jne_.L_4a0593(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i8* nocapture %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_jmpq_.L_4a05ac(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
