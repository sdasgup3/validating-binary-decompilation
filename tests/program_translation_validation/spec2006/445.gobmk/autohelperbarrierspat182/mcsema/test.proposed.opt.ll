...
define %struct.Memory* @autohelperbarrierspat182(%struct.State* noalias, i64, %struct.Memory* noalias readnone) local_unnamed_addr #1 {
entry:
  ...
  br i1 %218, label %block_4a0fa1, label %block_.L_4a0fdf
...
block_4a0fa1:                                     ; preds = %entry
  ...
  %call2_4a0fbf = tail call %struct.Memory* @sub_4784b0.play_attack_defend2_n(%struct.State* nonnull %0, i64 %265, %struct.Memory* %2)
...
block_.L_4a0fdf:                                  ; preds = %entry
  ...
  %call2_4a0fe5 = tail call %struct.Memory* @sub_428ce0.influence_mark_non_territory(%struct.State* nonnull %0, i64 %298, %struct.Memory* %2)
...
block_.L_4a0ff1:                                  ; preds = %block_.L_4a0fdf, %block_4a0fa1
  %308 = phi i64 [ %.pre, %block_.L_4a0fdf ], [ %287, %block_4a0fa1 ]
  %MEMORY.0 = phi %struct.Memory* [ %call2_4a0fe5, %block_.L_4a0fdf ], [ %call2_4a0fbf, %block_4a0fa1 ]
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_jne_.L_4a0fdf(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i8* nocapture %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_jmpq_.L_4a0ff1(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
