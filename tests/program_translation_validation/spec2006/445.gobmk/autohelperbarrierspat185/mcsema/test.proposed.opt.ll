...
define %struct.Memory* @autohelperbarrierspat185(%struct.State* noalias, i64, %struct.Memory* noalias readnone) local_unnamed_addr #1 {
entry:
  ...
  %.v = select i1 %218, i64 10, i64 49
  %222 = add i64 %209, %.v
  store i64 %222, i64* %3, align 8
  br i1 %218, label %block_4a1211, label %block_.L_4a1238
...
block_4a1211:                                     ; preds = %entry
  ...
  store i64 %227, i64* %RDI.i31, align 8
  %228 = add i64 %207, -24
  %229 = add i64 %222, 16
  ...
  store i64 %232, i64* %RCX.i70, align 8
  %233 = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 17, i32 0, i32 0
  %234 = add i64 %207, -28
  %235 = add i64 %222, 20
  ...
  %call2_4a122b = tail call %struct.Memory* @sub_478110.play_attack_defend_n(%struct.State* nonnull %0, i64 %243, %struct.Memory* %2)
  %EAX.i20 = bitcast %union.anon* %65 to i32*
  %248 = load i64, i64* %RBP.i, align 8
  %249 = add i64 %248, -4
  %250 = load i32, i32* %EAX.i20, align 4
...
block_.L_4a1238:                                  ; preds = %entry
  ...
  store i64 %266, i64* %RAX.i72, align 8
  %267 = icmp ugt i32 %264, 3
  ...
  store i64 %266, i64* %RSI.i, align 8
  %286 = add i64 %222, -492888
  %287 = add i64 %222, 18
  ...
  %call2_4a1245 = tail call %struct.Memory* @sub_428ce0.influence_mark_non_territory(%struct.State* nonnull %0, i64 %286, %struct.Memory* %2)
...
block_.L_4a1251:                                  ; preds = %block_.L_4a1238, %block_4a1211
  %296 = phi i64 [ %.pre, %block_.L_4a1238 ], [ %255, %block_4a1211 ]
  %MEMORY.0 = phi %struct.Memory* [ %call2_4a1245, %block_.L_4a1238 ], [ %call2_4a122b, %block_4a1211 ]
  ...
  store i64 %302, i64* %RAX.i72, align 8
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_jne_.L_4a1238(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i8* nocapture %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_jmpq_.L_4a1251(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
