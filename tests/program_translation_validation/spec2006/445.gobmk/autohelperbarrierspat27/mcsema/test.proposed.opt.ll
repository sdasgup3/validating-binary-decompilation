...
define %struct.Memory* @autohelperbarrierspat27(%struct.State* noalias, i64, %struct.Memory* noalias readnone) local_unnamed_addr #1 {
entry:
  ...
  %RDI.i104 = getelementptr inbounds %union.anon, %union.anon* %48, i64 0, i32 0
  ...
  store i64 %269, i64* %RDI.i104, align 8
  %270 = add i64 %263, -28
  %271 = add i64 %265, 6
  ...
  %RDX.i98 = getelementptr inbounds %union.anon, %union.anon* %61, i64 0, i32 0
  %275 = add i64 %263, -32
  %276 = add i64 %265, 9
  ...
  store i64 %279, i64* %RDX.i98, align 8
  %280 = add i64 %263, -36
  %281 = add i64 %265, 13
  ...
  %RSI.i92 = getelementptr inbounds %union.anon, %union.anon* %54, i64 0, i32 0
  %285 = add i64 %263, -40
  %286 = add i64 %265, 16
  ...
  %R11D.i86 = bitcast %union.anon* %295 to i32*
  ...
  store i64 %304, i64* %RSI.i92, align 8
  ...
  store i64 %312, i64* %RDX.i98, align 8
  ...
  %329 = add i64 %328, 8
  %330 = load i32, i32* %R10D.i89, align 4
  ...
  %335 = add i64 %334, 16
  %336 = load i32, i32* %R11D.i86, align 4
  ...
  %call2_49b731 = tail call %struct.Memory* @sub_4784b0.play_attack_defend2_n(%struct.State* %0, i64 %341, %struct.Memory* %2)
  ...
  br i1 %365, label %block_.L_49b784, label %block_49b744
...
block_49b744:                                     ; preds = %entry
  ...
  store i64 %372, i64* %RDI.i104, align 8
  %373 = add i64 %367, -28
  %374 = add i64 %366, 13
  ...
  store i64 %387, i64* %R9.i151, align 8
  %388 = add i64 %367, -40
  %389 = add i64 %366, 24
  ...
  store i64 %392, i64* %RAX.i166, align 8
  %393 = add i64 %366, 28
  ...
  %402 = add i64 %401, 8
  %403 = load i32, i32* %R10D.i89, align 4
  ...
  %408 = add i64 %407, 16
  %409 = load i32, i32* %R11D.i86, align 4
  ...
  %call2_49b773 = tail call %struct.Memory* @sub_4784b0.play_attack_defend2_n(%struct.State* nonnull %0, i64 %414, %struct.Memory* %call2_49b731)
  %419 = load i32, i32* %EAX.i80, align 4
...
block_.L_49b784:                                  ; preds = %block_49b744, %entry
  %434 = phi i64 [ %362, %entry ], [ %.pre, %block_49b744 ]
  %MEMORY.0 = phi %struct.Memory* [ %call2_49b731, %entry ], [ %call2_49b773, %block_49b744 ]
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_jne_.L_49b784(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i8* nocapture %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
