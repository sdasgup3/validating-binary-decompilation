...
define %struct.Memory* @autohelperbarrierspat30(%struct.State* noalias, i64, %struct.Memory* noalias readnone) local_unnamed_addr #1 {
entry:
  ...
  %call2_49b841 = tail call %struct.Memory* @sub_4784b0.play_attack_defend2_n(%struct.State* %0, i64 %341, %struct.Memory* %2)
  ...
  br i1 %365, label %block_.L_49b899, label %block_49b856

block_49b856:                                     ; preds = %entry
  ...
  %call2_49b888 = tail call %struct.Memory* @sub_4784b0.play_attack_defend2_n(%struct.State* nonnull %0, i64 %414, %struct.Memory* %call2_49b841)
...
block_.L_49b899:                                  ; preds = %block_49b856, %entry
  %434 = phi i64 [ %362, %entry ], [ %.pre, %block_49b856 ]
  %MEMORY.0 = phi %struct.Memory* [ %call2_49b841, %entry ], [ %call2_49b888, %block_49b856 ]
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_jne_.L_49b899(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i8* nocapture %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
