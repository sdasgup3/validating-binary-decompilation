...
define %struct.Memory* @autohelperbarrierspat33(%struct.State* noalias, i64, %struct.Memory* noalias readnone returned) local_unnamed_addr #1 {
entry:
  ...
  store i64 %174, i64* %R8.i48, align 8
  ...
  %181 = load i32, i32* %EAX.i18, align 4
  %182 = zext i32 %181 to i64
  store i64 %182, i64* %RSI.i, align 8
  %RDX.i = getelementptr inbounds %union.anon, %union.anon* %52, i64 0, i32 0
  store i64 %182, i64* %RDX.i, align 8
  %AL.i = bitcast %union.anon* %39 to i8*
  store i8 0, i8* %AL.i, align 1
  %183 = add i64 %162, -144445
  %184 = add i64 %162, 25
  ...
  %call2_49b901 = tail call %struct.Memory* @sub_4784b0.play_attack_defend2_n(%struct.State* %0, i64 %183, %struct.Memory* %2)
  %188 = load i32, i32* %EAX.i18, align 4
  %189 = load i64, i64* %3, align 8
  %190 = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 21, i32 0
  %R10B.i11 = bitcast %union.anon* %190 to i8*
  %191 = icmp eq i32 %188, 0
  %192 = zext i1 %191 to i8
  store i8 %192, i8* %R10B.i11, align 1
  %193 = zext i1 %191 to i64
  store i64 %193, i64* %RAX.i59, align 8
  ...
  ret %struct.Memory* %call2_49b901
}
