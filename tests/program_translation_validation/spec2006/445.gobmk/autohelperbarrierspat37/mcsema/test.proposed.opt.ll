...
define %struct.Memory* @autohelperbarrierspat37(%struct.State* noalias, i64, %struct.Memory* noalias readnone returned) local_unnamed_addr #1 {
entry:
  ...
  %ECX.i39 = bitcast %union.anon* %59 to i32*
  %60 = load i64, i64* %RBP.i, align 8
  %61 = add i64 %60, -16
  %62 = load i32, i32* %ECX.i39, align 4
  %63 = load i64, i64* %3, align 8
  %64 = add i64 %63, 3
  store i64 %64, i64* %3, align 8
  %65 = inttoptr i64 %61 to i32*
  store i32 %62, i32* %65, align 4
  %R8.i37 = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 17, i32 0, i32 0
  ...
  store i64 %72, i64* %R8.i37, align 8
  ...
  store i64 %119, i64* %R8.i37, align 8
  ...
  store i64 %125, i64* %RCX.i33, align 8
  %126 = add i64 %113, -8
  %127 = add i64 %115, 15
  ...
  store i64 %131, i64* %RCX.i33, align 8
  ...
  %call2_49b96d = tail call %struct.Memory* @sub_478110.play_attack_defend_n(%struct.State* %0, i64 %179, %struct.Memory* %2)
  %184 = load i64, i64* %6, align 8
  %185 = load i64, i64* %3, align 8
  %186 = add i64 %184, 32
  store i64 %186, i64* %6, align 8
  %187 = icmp ugt i64 %184, -33
  ...
  ret %struct.Memory* %call2_49b96d
}
