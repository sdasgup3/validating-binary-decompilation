...
define %struct.Memory* @autohelperbarrierspat6(%struct.State* noalias, i64, %struct.Memory* noalias readnone) local_unnamed_addr #1 {
entry:
  ...
  %289 = load i32, i32* %EAX.i64, align 4
  %290 = zext i32 %289 to i64
  %291 = load i64, i64* %3, align 8
  store i64 %290, i64* %RSI.i72, align 8
  %292 = load i64, i64* %RBP.i, align 8
  %293 = add i64 %292, -40
  %294 = load i32, i32* %EDX.i136, align 4
  %295 = add i64 %291, 5
  store i64 %295, i64* %3, align 8
  %296 = inttoptr i64 %293 to i32*
  store i32 %294, i32* %296, align 4
  %297 = load i32, i32* %R8D.i144, align 4
  %298 = zext i32 %297 to i64
  %299 = load i64, i64* %3, align 8
  store i64 %298, i64* %RDX.i78, align 8
  ...
  store i64 %310, i64* %RAX.i146, align 8
  %311 = bitcast i64* %6 to i32**
  ...
  %315 = add i64 %314, 8
  %316 = load i32, i32* %R10D.i69, align 4
  ...
  %call2_49aba7 = tail call %struct.Memory* @sub_4784b0.play_attack_defend2_n(%struct.State* %0, i64 %321, %struct.Memory* %2)
  %326 = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 23, i32 0
  %R11B.i43 = bitcast %union.anon* %326 to i8*
  %327 = load i64, i64* %3, align 8
  store i8 1, i8* %R11B.i43, align 1
  %328 = load i32, i32* %EAX.i64, align 4
  ...
  %343 = add i64 %342, 58
  %344 = add i64 %342, 6
  %345 = load i8, i8* %29, align 1
  %346 = icmp eq i8 %345, 0
  %347 = select i1 %346, i64 %343, i64 %344
  store i64 %347, i64* %3, align 8
  br i1 %346, label %block_.L_49abf0, label %block_49abbc
...
block_49abbc:                                     ; preds = %entry
  ...
  store i64 %353, i64* %RDI.i84, align 8
  %354 = add i64 %348, -20
  %355 = add i64 %347, 16
  ...
  store i64 %358, i64* %RCX.i127, align 8
  %359 = add i64 %348, -24
  %360 = add i64 %347, 20
  ...
  store i64 %366, i64* %R9.i131, align 8
  %367 = add i64 %348, -32
  %368 = add i64 %347, 27
  ...
  store i64 %371, i64* %RAX.i146, align 8
  %372 = load i32*, i32** %311, align 8
  %373 = add i64 %347, 30
  store i64 %373, i64* %3, align 8
  store i32 %370, i32* %372, align 4
  %374 = load i64, i64* %3, align 8
  store i8 0, i8* %AL.i46, align 1
  %375 = add i64 %374, -141098
  %376 = add i64 %374, 7
  ...
  %call2_49abdc = tail call %struct.Memory* @sub_4784b0.play_attack_defend2_n(%struct.State* nonnull %0, i64 %375, %struct.Memory* %call2_49aba7)
  %380 = load i32, i32* %EAX.i64, align 4
  %381 = load i64, i64* %3, align 8
  %R10B.i16 = bitcast %union.anon* %281 to i8*
  %382 = icmp ne i32 %380, 0
  %383 = zext i1 %382 to i64
  %384 = xor i64 %383, 255
  %385 = trunc i64 %384 to i8
  store i8 %385, i8* %R10B.i16, align 1
  store i8 0, i8* %14, align 1
...
block_.L_49abf0:                                  ; preds = %block_49abbc, %entry
  %395 = phi i64 [ %343, %entry ], [ %.pre, %block_49abbc ]
  %MEMORY.0 = phi %struct.Memory* [ %call2_49aba7, %entry ], [ %call2_49abdc, %block_49abbc ]
  ...
  store i64 %402, i64* %RAX.i146, align 8
  %403 = load i64, i64* %6, align 8
  %404 = add i64 %403, 64
  store i64 %404, i64* %6, align 8
  %405 = icmp ugt i64 %403, -65
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_jne_.L_49abf0(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i8* nocapture %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
