...
define %struct.Memory* @autohelperbarrierspat63(%struct.State* noalias, i64, %struct.Memory* noalias readnone returned) local_unnamed_addr #1 {
entry:
  ...
  %call2_49c0cb = tail call %struct.Memory* @sub_46bc30.safe_move(%struct.State* %0, i64 %124, %struct.Memory* %2)
  ...
  ret %struct.Memory* %call2_49c0cb
}
