...
define %struct.Memory* @autohelperbarrierspat65(%struct.State* noalias, i64, %struct.Memory* noalias readnone) local_unnamed_addr #1 {
entry:
  ...
  %call2_49c17a = tail call %struct.Memory* @sub_40f780.countlib(%struct.State* %0, i64 %214, %struct.Memory* %2)
  ...
  br i1 %258, label %block_.L_49c1bb, label %block_49c191

block_49c191:                                     ; preds = %entry
  ...
  %call2_49c194 = tail call %struct.Memory* @sub_40f780.countlib(%struct.State* nonnull %0, i64 %266, %struct.Memory* %call2_49c17a)
  ...
  %303 = load i8, i8* %32, align 1
  %304 = icmp ne i8 %303, 0
  %305 = load i8, i8* %38, align 1
  %306 = icmp ne i8 %305, 0
  %307 = xor i1 %304, %306
  %308 = or i1 %302, %307
  %309 = select i1 %308, i64 %299, i64 %300
  store i64 %309, i64* %3, align 8
  br i1 %308, label %block_.L_49c1bb, label %block_49c1aa

block_49c1aa:                                     ; preds = %block_49c191
  ...
  store i64 %315, i64* %RDI.i44, align 8
  %316 = add i64 %309, -576042
  %317 = add i64 %309, 8
  ...
  %call2_49c1ad = tail call %struct.Memory* @sub_40f780.countlib(%struct.State* nonnull %0, i64 %316, %struct.Memory* %call2_49c194)
  %321 = load i32, i32* %EAX.i37, align 4
  ...
  %344 = icmp ne i8 %338, 0
  %345 = xor i1 %344, %342
  %.demorgan = or i1 %335, %345
  %346 = xor i1 %.demorgan, true
  %347 = zext i1 %346 to i8
  store i8 %347, i8* %CL.i39, align 1
...
block_.L_49c1bb:                                  ; preds = %block_49c1aa, %block_49c191, %entry
  %352 = phi i64 [ %248, %entry ], [ %299, %block_49c191 ], [ %.pre, %block_49c1aa ]
  %MEMORY.0 = phi %struct.Memory* [ %call2_49c17a, %entry ], [ %call2_49c194, %block_49c191 ], [ %call2_49c1ad, %block_49c1aa ]
  ...
  store i64 %359, i64* %RAX.i80, align 8
  %360 = load i64, i64* %6, align 8
  %361 = add i64 %360, 32
  store i64 %361, i64* %6, align 8
  %362 = icmp ugt i64 %360, -33
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_jg_.L_49c1bb(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i8* nocapture %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_jle_.L_49c1bb(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i8* nocapture %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 2, i32 7
