...
define %struct.Memory* @autohelperbarrierspat7(%struct.State* noalias, i64, %struct.Memory* noalias readnone) local_unnamed_addr #1 {
entry:
  ...
  br i1 %95, label %block_49ac33, label %block_.L_49ac59
...
block_.L_49ac59:                                  ; preds = %entry
  ...
  %call2_49ac60 = tail call %struct.Memory* @sub_46a780.find_defense(%struct.State* nonnull %0, i64 %149, %struct.Memory* %2)
...
block_.L_49ac68:                                  ; preds = %block_.L_49ac59, %block_49ac33
  %160 = phi i64 [ %.pre, %block_.L_49ac59 ], [ %142, %block_49ac33 ]
  %MEMORY.0 = phi %struct.Memory* [ %call2_49ac60, %block_.L_49ac59 ], [ %2, %block_49ac33 ]
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_jne_.L_49ac59(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i8* nocapture %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_jmpq_.L_49ac68(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
