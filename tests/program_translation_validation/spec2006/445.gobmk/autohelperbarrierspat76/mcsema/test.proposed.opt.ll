...
define %struct.Memory* @autohelperbarrierspat76(%struct.State* noalias, i64, %struct.Memory* noalias readnone) local_unnamed_addr #1 {
entry:
  ...
  %call2_49c45a = tail call %struct.Memory* @sub_40f780.countlib(%struct.State* %0, i64 %214, %struct.Memory* %2)
  ...
  br i1 %258, label %entry.block_.L_49c4a5_crit_edge, label %block_49c46f

entry.block_.L_49c4a5_crit_edge:                  ; preds = %entry
  %.pre3 = bitcast %union.anon* %65 to i8*
  br label %block_.L_49c4a5

block_49c46f:                                     ; preds = %entry
  ...
  %call2_49c472 = tail call %struct.Memory* @sub_40f780.countlib(%struct.State* nonnull %0, i64 %266, %struct.Memory* %call2_49c45a)
  ...
  br i1 %302, label %block_.L_49c49f, label %block_49c488

block_49c488:                                     ; preds = %block_49c46f
  ...
  %call2_49c491 = tail call %struct.Memory* @sub_4af200.connect_and_cut_helper(%struct.State* nonnull %0, i64 %320, %struct.Memory* %call2_49c472)
  ...
  br label %block_.L_49c49f

block_.L_49c49f:                                  ; preds = %block_49c488, %block_49c46f
  %342 = phi i64 [ %299, %block_49c46f ], [ %.pre, %block_49c488 ]
  %MEMORY.0 = phi %struct.Memory* [ %call2_49c472, %block_49c46f ], [ %call2_49c491, %block_49c488 ]
...
block_.L_49c4a5:                                  ; preds = %entry.block_.L_49c4a5_crit_edge, %block_.L_49c49f
  %AL.i9.pre-phi = phi i8* [ %.pre3, %entry.block_.L_49c4a5_crit_edge ], [ %AL.i15, %block_.L_49c49f ]
  %351 = phi i64 [ %248, %entry.block_.L_49c4a5_crit_edge ], [ %.pre2, %block_.L_49c49f ]
  %MEMORY.1 = phi %struct.Memory* [ %call2_49c45a, %entry.block_.L_49c4a5_crit_edge ], [ %MEMORY.0, %block_.L_49c49f ]
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_jg_.L_49c4a5(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i8* nocapture %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_jne_.L_49c49f(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i8* nocapture %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 2, i32 7
