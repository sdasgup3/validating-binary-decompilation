...
define %struct.Memory* @autohelperbarrierspat89(%struct.State* noalias, i64, %struct.Memory* noalias readnone) local_unnamed_addr #1 {
entry:
  ...
  br i1 %266, label %block_49cf02, label %block_.L_49cf2f

block_49cf02:                                     ; preds = %entry
  ...
  %call2_49cf22 = tail call %struct.Memory* @sub_4784b0.play_attack_defend2_n(%struct.State* nonnull %0, i64 %300, %struct.Memory* %2)
...
block_.L_49cf2f:                                  ; preds = %entry
  ...
  %call2_49cf51 = tail call %struct.Memory* @sub_478110.play_attack_defend_n(%struct.State* nonnull %0, i64 %361, %struct.Memory* %2)
...
block_.L_49cf6c:                                  ; preds = %block_.L_49cf2f, %block_49cf02
  %382 = phi i64 [ %.pre, %block_.L_49cf2f ], [ %312, %block_49cf02 ]
  %MEMORY.0 = phi %struct.Memory* [ %call2_49cf51, %block_.L_49cf2f ], [ %call2_49cf22, %block_49cf02 ]
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_jne_.L_49cf2f(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i8* nocapture %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_jmpq_.L_49cf6c(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
