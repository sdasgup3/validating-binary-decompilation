...
define %struct.Memory* @autohelperbarrierspat93(%struct.State* noalias, i64, %struct.Memory* noalias readnone) local_unnamed_addr #1 {
entry:
  ...
  %call2_49d279 = tail call %struct.Memory* @sub_40f780.countlib(%struct.State* %0, i64 %167, %struct.Memory* %2)
  ...
  br i1 %207, label %block_.L_49d2a1, label %block_49d290
...
block_49d290:                                     ; preds = %entry
  ...
  %call2_49d293 = tail call %struct.Memory* @sub_40f780.countlib(%struct.State* nonnull %0, i64 %215, %struct.Memory* %call2_49d279)
...
block_.L_49d2a1:                                  ; preds = %block_49d290, %entry
  %251 = phi i64 [ %201, %entry ], [ %.pre, %block_49d290 ]
  %MEMORY.0 = phi %struct.Memory* [ %call2_49d279, %entry ], [ %call2_49d293, %block_49d290 ]
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_jl_.L_49d2a1(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i8* nocapture %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
