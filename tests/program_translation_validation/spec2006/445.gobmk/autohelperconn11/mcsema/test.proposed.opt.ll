...
define %struct.Memory* @autohelperconn11(%struct.State* noalias, i64, %struct.Memory* noalias readnone returned) local_unnamed_addr #1 {
entry:
  ...
  %call2_4a161d = tail call %struct.Memory* @sub_4784b0.play_attack_defend2_n(%struct.State* %0, i64 %332, %struct.Memory* %2)
  ...
  ret %struct.Memory* %call2_4a161d
}
