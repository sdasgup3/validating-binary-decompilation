...
define %struct.Memory* @autohelperconn29(%struct.State* noalias, i64, %struct.Memory* noalias readnone returned) local_unnamed_addr #1 {
entry:
  ...
  %call2_4a2021 = tail call %struct.Memory* @sub_4788b0.play_connect_n(%struct.State* %0, i64 %223, %struct.Memory* %2)
  ...
  ret %struct.Memory* %call2_4a2021
}
