...
define %struct.Memory* @autohelperconn30(%struct.State* noalias, i64, %struct.Memory* noalias readnone) local_unnamed_addr #1 {
entry:
  ...
  %call2_4a2079 = tail call %struct.Memory* @sub_40f780.countlib(%struct.State* %0, i64 %167, %struct.Memory* %2)
  ...
  %.v = select i1 %202, i64 23, i64 6
  %203 = add i64 %200, %.v
  store i64 %203, i64* %3, align 8
  %cmpBr_4a2088 = icmp eq i8 %201, 1
...
block_4a208e:                                     ; preds = %entry
  ...
  store i64 %209, i64* %RDI.i28, align 8
  %210 = add i64 %203, -600334
  %211 = add i64 %203, 8
  ...
  %call2_4a2091 = tail call %struct.Memory* @sub_40f780.countlib(%struct.State* nonnull %0, i64 %210, %struct.Memory* %call2_4a2079)
  %215 = load i32, i32* %EAX.i23, align 4
  %216 = load i64, i64* %3, align 8
  %217 = add i32 %215, -2
  %218 = icmp ult i32 %215, 2
...
block_.L_4a209f:                                  ; preds = %block_4a208e, %entry
  %242 = phi i64 [ %203, %entry ], [ %.pre, %block_4a208e ]
  %MEMORY.0 = phi %struct.Memory* [ %call2_4a2079, %entry ], [ %call2_4a2091, %block_4a208e ]
  ...
  store i64 %249, i64* %RAX.i50, align 8
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_je_.L_4a209f(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i8* nocapture %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
