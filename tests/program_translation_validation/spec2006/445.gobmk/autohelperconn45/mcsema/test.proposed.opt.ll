...
define %struct.Memory* @autohelperconn45(%struct.State* noalias, i64, %struct.Memory* noalias readnone) local_unnamed_addr #1 {
entry:
  ...
  %call2_4a2a0e = tail call %struct.Memory* @sub_4784b0.play_attack_defend2_n(%struct.State* %0, i64 %265, %struct.Memory* %2)
  ...
  br i1 %290, label %block_.L_4a2a74, label %block_4a2a25
...
block_4a2a25:                                     ; preds = %entry
  ...
  %call2_4a2a60 = tail call %struct.Memory* @sub_4784b0.play_attack_defend2_n(%struct.State* nonnull %0, i64 %373, %struct.Memory* %call2_4a2a0e)
...
block_.L_4a2a74:                                  ; preds = %block_4a2a25, %entry
  %393 = phi i64 [ %287, %entry ], [ %.pre, %block_4a2a25 ]
  %MEMORY.0 = phi %struct.Memory* [ %call2_4a2a0e, %entry ], [ %call2_4a2a60, %block_4a2a25 ]
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_jne_.L_4a2a74(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i8* nocapture %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
