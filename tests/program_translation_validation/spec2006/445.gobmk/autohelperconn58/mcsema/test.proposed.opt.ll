...
define %struct.Memory* @autohelperconn58(%struct.State* noalias, i64, %struct.Memory* noalias readnone) local_unnamed_addr #1 {
entry:
  ...
  %RAX.i80 = getelementptr inbounds %union.anon, %union.anon* %39, i64 0, i32 0
  ...
  %ECX.i71 = bitcast %union.anon* %59 to i32*
  %60 = load i64, i64* %RBP.i, align 8
  %61 = add i64 %60, -16
  %62 = load i32, i32* %ECX.i71, align 4
  ...
  store i64 %72, i64* %R8.i69, align 8
  %RCX.i65 = getelementptr inbounds %union.anon, %union.anon* %59, i64 0, i32 0
  %73 = shl nsw i64 %72, 2
  ...
  store i64 %78, i64* %RCX.i65, align 8
  %79 = add i64 %66, -8
  %80 = add i64 %68, 15
  ...
  store i64 %84, i64* %RCX.i65, align 8
  ...
  store i64 %119, i64* %R8.i69, align 8
  ...
  store i64 %125, i64* %RCX.i65, align 8
  %126 = add i64 %113, -8
  %127 = add i64 %115, 15
  ...
  store i64 %131, i64* %RCX.i65, align 8
  ...
  %167 = load i64, i64* %RAX.i80, align 8
  %168 = add i64 %160, -12
  %169 = add i64 %162, 6
  ...
  store i64 %174, i64* %RAX.i80, align 8
  ...
  %call2_4a34f5 = tail call %struct.Memory* @sub_4771f0.cut_possible(%struct.State* %0, i64 %198, %struct.Memory* %2)
  %203 = load i64, i64* %3, align 8
  store i64 0, i64* %RCX.i65, align 8
  %204 = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 19, i32 0
  %R9B.i35 = bitcast %union.anon* %204 to i8*
  store i8 0, i8* %R9B.i35, align 1
  %205 = load i32, i32* %EAX.i39, align 4
  ...
  br i1 %223, label %block_.L_4a352a, label %block_4a350c
...
block_4a350c:                                     ; preds = %entry
  ...
  store i64 %230, i64* %RDI.i45, align 8
  %231 = add i64 %225, -12
  %232 = add i64 %224, 11
  ...
  store i64 %236, i64* %RAX.i80, align 8
  %237 = icmp ugt i32 %234, 3
  ...
  store i64 %236, i64* %RSI.i40, align 8
  %256 = add i64 %224, -181020
  %257 = add i64 %224, 18
  ...
  %call2_4a3519 = tail call %struct.Memory* @sub_4771f0.cut_possible(%struct.State* nonnull %0, i64 %256, %struct.Memory* %call2_4a34f5)
  %261 = load i32, i32* %EAX.i39, align 4
  %262 = load i64, i64* %3, align 8
  %263 = icmp ne i32 %261, 0
  %264 = zext i1 %263 to i64
  %265 = xor i64 %264, 255
  %266 = trunc i64 %265 to i8
  store i8 %266, i8* %CL.i34, align 1
  store i8 0, i8* %14, align 1
...
block_.L_4a352a:                                  ; preds = %block_4a350c, %entry
  %276 = phi i64 [ %220, %entry ], [ %.pre, %block_4a350c ]
  %MEMORY.0 = phi %struct.Memory* [ %call2_4a34f5, %entry ], [ %call2_4a3519, %block_4a350c ]
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_jne_.L_4a352a(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i8* nocapture %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
