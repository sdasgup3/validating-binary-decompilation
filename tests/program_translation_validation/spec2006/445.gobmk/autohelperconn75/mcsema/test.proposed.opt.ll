...
define %struct.Memory* @autohelperconn75(%struct.State* noalias, i64, %struct.Memory* noalias readnone returned) local_unnamed_addr #1 {
entry:
  ...
  store i64 %201, i64* %RDX.i26, align 8
  %202 = add i64 %163, -24
  %203 = add i64 %165, 14
  ...
  store i64 %206, i64* %R9.i54, align 8
  ...
  %207 = load i32, i32* %EAX.i20, align 4
  %208 = zext i32 %207 to i64
  store i64 %208, i64* %RSI.i, align 8
  %209 = add i64 %163, -28
  %210 = add i64 %165, 22
  store i64 %210, i64* %3, align 8
  %211 = inttoptr i64 %209 to i32*
  store i32 %200, i32* %211, align 4
  %212 = load i32, i32* %EAX.i20, align 4
  %213 = zext i32 %212 to i64
  %214 = load i64, i64* %3, align 8
  store i64 %213, i64* %RDX.i26, align 8
  ...
  %call2_4a41f1 = tail call %struct.Memory* @sub_4784b0.play_attack_defend2_n(%struct.State* %0, i64 %221, %struct.Memory* %2)
  %226 = load i32, i32* %EAX.i20, align 4
  %227 = load i64, i64* %3, align 8
  %228 = icmp eq i32 %226, 5
  %229 = zext i1 %228 to i8
  %230 = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 21, i32 0
  %R10B.i9 = bitcast %union.anon* %230 to i8*
  store i8 %229, i8* %R10B.i9, align 1
  %231 = zext i1 %228 to i64
  store i64 %231, i64* %RAX.i68, align 8
  ...
  ret %struct.Memory* %call2_4a41f1
}
