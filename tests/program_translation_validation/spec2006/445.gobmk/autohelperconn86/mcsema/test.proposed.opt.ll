...
define %struct.Memory* @autohelperconn86(%struct.State* noalias, i64, %struct.Memory* noalias readnone returned) local_unnamed_addr #1 {
entry:
  ...
  %call2_4a5193 = tail call %struct.Memory* @sub_409590.is_suicide(%struct.State* %0, i64 %150, %struct.Memory* %2)
  ...
  ret %struct.Memory* %call2_4a5193
}
