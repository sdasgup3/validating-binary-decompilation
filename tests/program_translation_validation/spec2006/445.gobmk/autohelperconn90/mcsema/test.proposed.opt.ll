...
define %struct.Memory* @autohelperconn90(%struct.State* noalias, i64, %struct.Memory* noalias readnone) local_unnamed_addr #1 {
entry:
  ...
  %call2_4a54f7 = tail call %struct.Memory* @sub_4771f0.cut_possible(%struct.State* %0, i64 %245, %struct.Memory* %2)
  ...
  br i1 %270, label %entry.block_.L_4a5534_crit_edge, label %block_4a550e

entry.block_.L_4a5534_crit_edge:                  ; preds = %entry
  %.pre1 = bitcast %union.anon* %39 to i8*
  br label %block_.L_4a5534

block_4a550e:                                     ; preds = %entry
  ...
  %call2_4a5520 = tail call %struct.Memory* @sub_4788b0.play_connect_n(%struct.State* nonnull %0, i64 %288, %struct.Memory* %call2_4a54f7)
...
block_.L_4a5534:                                  ; preds = %entry.block_.L_4a5534_crit_edge, %block_4a550e
  %AL.i9.pre-phi = phi i8* [ %.pre1, %entry.block_.L_4a5534_crit_edge ], [ %AL.i20, %block_4a550e ]
  %308 = phi i64 [ %267, %entry.block_.L_4a5534_crit_edge ], [ %.pre, %block_4a550e ]
  %MEMORY.0 = phi %struct.Memory* [ %call2_4a54f7, %entry.block_.L_4a5534_crit_edge ], [ %call2_4a5520, %block_4a550e ]
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_jne_.L_4a5534(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i8* nocapture %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
