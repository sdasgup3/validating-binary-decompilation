...
define %struct.Memory* @autohelperconn98(%struct.State* noalias, i64, %struct.Memory* noalias readnone returned) local_unnamed_addr #1 {
entry:
  ...
  %call2_4a5cec = tail call %struct.Memory* @sub_4aed50.not_lunch_helper(%struct.State* %0, i64 %172, %struct.Memory* %2)
  ...
  ret %struct.Memory* %call2_4a5cec
}
