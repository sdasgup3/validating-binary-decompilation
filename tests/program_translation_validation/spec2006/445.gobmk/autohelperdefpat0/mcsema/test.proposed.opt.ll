...
define %struct.Memory* @autohelperdefpat0(%struct.State* noalias, i64, %struct.Memory* noalias readnone returned) local_unnamed_addr #1 {
entry:
  ...
  %call2_4a9dca = tail call %struct.Memory* @sub_412080.accuratelib(%struct.State* %0, i64 %62, %struct.Memory* %2)
  ...
  ret %struct.Memory* %call2_4a9dca
}
