...
define %struct.Memory* @autohelperendpat13(%struct.State* noalias, i64, %struct.Memory* noalias readnone) local_unnamed_addr #1 {
entry:
  ...
  %EDI.i123 = bitcast %union.anon* %39 to i32*
  %40 = add i64 %7, -12
  %41 = load i32, i32* %EDI.i123, align 4
  %42 = add i64 %10, 10
  ...
  store i64 %260, i64* %RDI.i65, align 8
  %261 = add i64 %256, -452552
  %262 = add i64 %256, 8
  ...
  %.v = select i1 %284, i64 88, i64 6
  %285 = add i64 %282, %.v
  store i64 %285, i64* %3, align 8
  %cmpBr_4aa7cc = icmp eq i8 %283, 1
...
block_4aa7d2:                                     ; preds = %entry
  ...
  store i64 %291, i64* %RDI.i65, align 8
  %292 = add i64 %285, -452578
  %293 = add i64 %285, 8
  ...
  %call2_4aa7d5 = tail call %struct.Memory* @sub_43bff0.is_proper_eye_space(%struct.State* nonnull %0, i64 %292, %struct.Memory* %call2_4aa7bb)
  %297 = load i64, i64* %3, align 8
  store i64 0, i64* %RDI.i65, align 8
  store i8 0, i8* %CL.i59, align 1
  %298 = load i32, i32* %EAX.i57, align 4
  store i8 0, i8* %14, align 1
  %299 = and i32 %298, 255
  ...
  %.v2 = select i1 %314, i64 63, i64 6
  %315 = add i64 %312, %.v2
  store i64 %315, i64* %3, align 8
  %cmpBr_4aa7e5 = icmp eq i8 %313, 1
...
block_4aa7eb:                                     ; preds = %block_4aa7d2
  ...
  store i64 %321, i64* %RDI.i65, align 8
  %322 = add i64 %316, -8
  %323 = add i64 %315, 16
  ...
  store i64 %326, i64* %RCX.i111, align 8
  %327 = getelementptr inbounds %union.anon, %union.anon* %267, i64 0, i32 0
  %328 = add i64 %316, -20
  %329 = add i64 %315, 20
  ...
  %R10D.i25 = bitcast %union.anon* %342 to i32*
  ...
  %353 = add i64 %352, 8
  %354 = load i32, i32* %R10D.i25, align 4
  ...
  %call2_4aa814 = tail call %struct.Memory* @sub_4784b0.play_attack_defend2_n(%struct.State* nonnull %0, i64 %359, %struct.Memory* %call2_4aa7d5)
  %364 = load i32, i32* %EAX.i57, align 4
  ...
  store i8 0, i8* %38, align 1
  %375 = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 23, i32 0
  %R11B.i14 = bitcast %union.anon* %375 to i8*
  %376 = xor i1 %371, true
  %377 = zext i1 %376 to i8
  store i8 %377, i8* %R11B.i14, align 1
...
block_.L_4aa824:                                  ; preds = %block_4aa7eb, %block_4aa7d2, %entry
  %382 = phi i64 [ %285, %entry ], [ %315, %block_4aa7d2 ], [ %.pre, %block_4aa7eb ]
  %MEMORY.0 = phi %struct.Memory* [ %call2_4aa7bb, %entry ], [ %call2_4aa7d5, %block_4aa7d2 ], [ %call2_4aa814, %block_4aa7eb ]
  ...
  store i64 %389, i64* %RAX.i113, align 8
  %390 = load i64, i64* %6, align 8
  %391 = add i64 %390, 64
  store i64 %391, i64* %6, align 8
  %392 = icmp ugt i64 %390, -65
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_je_.L_4aa824(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i8* nocapture %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
