...
define %struct.Memory* @autohelperendpat16(%struct.State* noalias, i64, %struct.Memory* noalias readnone) local_unnamed_addr #1 {
entry:
  ...
  store i64 %119, i64* %RDI.i44, align 8
  %120 = add i64 %115, -452901
  %121 = add i64 %115, 8
  ...
  %call2_4aaa88 = tail call %struct.Memory* @sub_43c160.is_marginal_eye_space(%struct.State* %0, i64 %120, %struct.Memory* %2)
  ...
  %R8B.i40 = bitcast %union.anon* %126 to i8*
  store i8 0, i8* %R8B.i40, align 1
  %EAX.i37 = bitcast %union.anon* %65 to i32*
  %127 = load i32, i32* %EAX.i37, align 4
  ...
  %.v = select i1 %143, i64 48, i64 6
  %144 = add i64 %141, %.v
  store i64 %144, i64* %3, align 8
  %cmpBr_4aaa99 = icmp eq i8 %142, 1
  br i1 %cmpBr_4aaa99, label %block_.L_4aaac9, label %block_4aaa9f

block_4aaa9f:                                     ; preds = %entry
  ...
  store i64 %150, i64* %RDI.i44, align 8
  %151 = add i64 %144, -453295
  %152 = add i64 %144, 8
  ...
  %call2_4aaaa2 = tail call %struct.Memory* @sub_43bff0.is_proper_eye_space(%struct.State* nonnull %0, i64 %151, %struct.Memory* %call2_4aaa88)
  %156 = load i64, i64* %3, align 8
  store i64 0, i64* %RDI.i44, align 8
  store i8 0, i8* %CL.i39, align 1
  %157 = load i32, i32* %EAX.i37, align 4
  store i8 0, i8* %14, align 1
  %158 = and i32 %157, 255
  ...
  %.v2 = select i1 %173, i64 23, i64 6
  %174 = add i64 %171, %.v2
  store i64 %174, i64* %3, align 8
  %cmpBr_4aaab2 = icmp eq i8 %172, 1
  br i1 %cmpBr_4aaab2, label %block_.L_4aaac9, label %block_4aaab8

block_4aaab8:                                     ; preds = %block_4aaa9f
  ...
  store i64 %180, i64* %RDI.i44, align 8
  %181 = add i64 %174, -453160
  %182 = add i64 %174, 8
  ...
  %call2_4aaabb = tail call %struct.Memory* @sub_43c090.max_eye_value(%struct.State* nonnull %0, i64 %181, %struct.Memory* %call2_4aaaa2)
  %186 = load i32, i32* %EAX.i37, align 4
  ...
  store i8 %200, i8* %CL.i39, align 1
...
block_.L_4aaac9:                                  ; preds = %block_4aaab8, %block_4aaa9f, %entry
  %205 = phi i64 [ %144, %entry ], [ %174, %block_4aaa9f ], [ %.pre, %block_4aaab8 ]
  %MEMORY.0 = phi %struct.Memory* [ %call2_4aaa88, %entry ], [ %call2_4aaaa2, %block_4aaa9f ], [ %call2_4aaabb, %block_4aaab8 ]
  ...
  store i64 %212, i64* %RAX.i56, align 8
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_je_.L_4aaac9(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i8* nocapture %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
