...
define %struct.Memory* @autohelperendpat20(%struct.State* noalias, i64, %struct.Memory* noalias readnone) local_unnamed_addr #1 {
entry:
  ...
  %call2_4aad99 = tail call %struct.Memory* @sub_43c160.is_marginal_eye_space(%struct.State* %0, i64 %167, %struct.Memory* %2)
...
block_4aadb0:                                     ; preds = %entry
  ...
  %call2_4aadb3 = tail call %struct.Memory* @sub_43bff0.is_proper_eye_space(%struct.State* nonnull %0, i64 %198, %struct.Memory* %call2_4aad99)
...
block_4aadc9:                                     ; preds = %block_4aadb0
  ...
  %call2_4aadcc = tail call %struct.Memory* @sub_43bff0.is_proper_eye_space(%struct.State* nonnull %0, i64 %228, %struct.Memory* %call2_4aadb3)
...
block_.L_4aadda:                                  ; preds = %block_4aadc9, %block_4aadb0, %entry
  %250 = phi i64 [ %191, %entry ], [ %221, %block_4aadb0 ], [ %.pre, %block_4aadc9 ]
  %MEMORY.0 = phi %struct.Memory* [ %call2_4aad99, %entry ], [ %call2_4aadb3, %block_4aadb0 ], [ %call2_4aadcc, %block_4aadc9 ]
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_je_.L_4aadda(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i8* nocapture %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
