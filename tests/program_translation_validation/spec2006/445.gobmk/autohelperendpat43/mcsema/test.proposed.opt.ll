...
define %struct.Memory* @autohelperendpat43(%struct.State* noalias, i64, %struct.Memory* noalias readnone) local_unnamed_addr #1 {
entry:
  ...
  %RAX.i55 = getelementptr inbounds %union.anon, %union.anon* %65, i64 0, i32 0
  ...
  store i64 %72, i64* %RAX.i55, align 8
  ...
  store i64 %78, i64* %RCX.i53, align 8
  %79 = add i64 %66, -12
  %80 = add i64 %68, 14
  ...
  store i64 %84, i64* %RCX.i53, align 8
  ...
  store i64 %125, i64* %RCX.i53, align 8
  %126 = add i64 %113, -12
  %127 = add i64 %115, 14
  ...
  store i64 %131, i64* %RCX.i53, align 8
  ...
  br i1 %171, label %block_4ab2d0, label %block_.L_4ab2f7
...
block_4ab2d0:                                     ; preds = %entry
  ...
  store i64 %180, i64* %RDI.i26, align 8
  %181 = add i64 %160, -12
  %182 = add i64 %175, 16
  ...
  store i64 %185, i64* %RCX.i53, align 8
  ...
  %call2_4ab2ea = tail call %struct.Memory* @sub_478110.play_attack_defend_n(%struct.State* nonnull %0, i64 %198, %struct.Memory* %2)
...
block_.L_4ab2f7:                                  ; preds = %entry
  ...
  %call2_4ab2fd = tail call %struct.Memory* @sub_4352e0.add_replacement_move(%struct.State* nonnull %0, i64 %221, %struct.Memory* %2)
...
block_.L_4ab309:                                  ; preds = %block_.L_4ab2f7, %block_4ab2d0
  %231 = phi i64 [ %.pre, %block_.L_4ab2f7 ], [ %210, %block_4ab2d0 ]
  %MEMORY.0 = phi %struct.Memory* [ %call2_4ab2fd, %block_.L_4ab2f7 ], [ %call2_4ab2ea, %block_4ab2d0 ]
  ...
  store i64 %237, i64* %RAX.i55, align 8
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_jne_.L_4ab2f7(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i8* nocapture %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_jmpq_.L_4ab309(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
