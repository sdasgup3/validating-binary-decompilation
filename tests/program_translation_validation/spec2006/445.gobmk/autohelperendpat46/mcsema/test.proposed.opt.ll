...
define %struct.Memory* @autohelperendpat46(%struct.State* noalias, i64, %struct.Memory* noalias readnone) local_unnamed_addr #1 {
entry:
  ...
  %call2_4ab3c9 = tail call %struct.Memory* @sub_43bff0.is_proper_eye_space(%struct.State* %0, i64 %167, %struct.Memory* %2)
...
block_4ab3e0:                                     ; preds = %entry
  ...
  %call2_4ab3e3 = tail call %struct.Memory* @sub_43bff0.is_proper_eye_space(%struct.State* nonnull %0, i64 %198, %struct.Memory* %call2_4ab3c9)
...
block_.L_4ab3f1:                                  ; preds = %block_4ab3e0, %entry
  %220 = phi i64 [ %191, %entry ], [ %.pre, %block_4ab3e0 ]
  %MEMORY.0 = phi %struct.Memory* [ %call2_4ab3c9, %entry ], [ %call2_4ab3e3, %block_4ab3e0 ]
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_je_.L_4ab3f1(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i8* nocapture %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
