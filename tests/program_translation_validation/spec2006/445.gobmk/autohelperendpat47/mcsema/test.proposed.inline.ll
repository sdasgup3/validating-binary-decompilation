...
define %struct.Memory* @autohelperendpat47(%struct.State* noalias, i64, %struct.Memory* noalias) #2 {
entry:
  ...
  store %struct.Memory* %loadMem_4ab400, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_4ab401, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_4ab404, %struct.Memory** %MEMORY
  ...
  store i32 %78, i32* %82
  store %struct.Memory* %loadMem_4ab408, %struct.Memory** %MEMORY
  ...
  store i32 %94, i32* %98
  store %struct.Memory* %loadMem_4ab40b, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_4ab411, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_4ab414, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_4ab418, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_4ab41f, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_4ab422, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_4ab425, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem1_4ab428, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_4ab42d, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_4ab432, %struct.Memory** %MEMORY
  ret %struct.Memory* %loadMem_4ab432
}
