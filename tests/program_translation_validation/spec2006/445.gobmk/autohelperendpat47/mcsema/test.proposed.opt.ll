...
define %struct.Memory* @autohelperendpat47(%struct.State* noalias, i64, %struct.Memory* noalias readnone returned) local_unnamed_addr #1 {
entry:
  ...
  %call2_4ab428 = tail call %struct.Memory* @sub_43c160.is_marginal_eye_space(%struct.State* %0, i64 %119, %struct.Memory* %2)
  ...
  ret %struct.Memory* %call2_4ab428
}
