...
define %struct.Memory* @autohelperendpat54(%struct.State* noalias, i64, %struct.Memory* noalias readnone) local_unnamed_addr #1 {
entry:
  ...
  %call2_4ab639 = tail call %struct.Memory* @sub_40f780.countlib(%struct.State* %0, i64 %167, %struct.Memory* %2)
  ...
  br i1 %204, label %block_.L_4ab661, label %block_4ab650
...
block_4ab650:                                     ; preds = %entry
  ...
  %call2_4ab653 = tail call %struct.Memory* @sub_43bff0.is_proper_eye_space(%struct.State* nonnull %0, i64 %212, %struct.Memory* %call2_4ab639)
  ...
  store i8 %229, i8* %CL.i25, align 1
...
block_.L_4ab661:                                  ; preds = %block_4ab650, %entry
  %234 = phi i64 [ %201, %entry ], [ %.pre, %block_4ab650 ]
  %MEMORY.0 = phi %struct.Memory* [ %call2_4ab639, %entry ], [ %call2_4ab653, %block_4ab650 ]
  ...
  store i64 %241, i64* %RAX.i54, align 8
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_jne_.L_4ab661(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i8* nocapture %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
