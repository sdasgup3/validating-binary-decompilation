...
define %struct.Memory* @autohelperendpat55(%struct.State* noalias, i64, %struct.Memory* noalias readnone) local_unnamed_addr #1 {
entry:
  ...
  %EDI.i76 = bitcast %union.anon* %39 to i32*
  %40 = add i64 %7, -12
  %41 = load i32, i32* %EDI.i76, align 4
  %42 = add i64 %10, 10
  ...
  store i64 %119, i64* %RDI.i54, align 8
  %120 = add i64 %115, -455989
  %121 = add i64 %115, 8
  ...
  %.v = select i1 %143, i64 73, i64 6
  %144 = add i64 %141, %.v
  store i64 %144, i64* %3, align 8
  %cmpBr_4ab6a9 = icmp eq i8 %142, 1
...
block_4ab6af:                                     ; preds = %entry
  ...
  store i64 %150, i64* %RDI.i54, align 8
  %151 = add i64 %144, -456383
  %152 = add i64 %144, 8
  ...
  %call2_4ab6b2 = tail call %struct.Memory* @sub_43bff0.is_proper_eye_space(%struct.State* nonnull %0, i64 %151, %struct.Memory* %call2_4ab698)
  %156 = load i64, i64* %3, align 8
  store i64 0, i64* %RDI.i54, align 8
  store i8 0, i8* %CL.i48, align 1
  %157 = load i32, i32* %EAX.i46, align 4
  store i8 0, i8* %14, align 1
  %158 = and i32 %157, 255
  ...
  %.v2 = select i1 %173, i64 48, i64 6
  %174 = add i64 %171, %.v2
  store i64 %174, i64* %3, align 8
  %cmpBr_4ab6c2 = icmp eq i8 %172, 1
...
block_4ab6c8:                                     ; preds = %block_4ab6af
  ...
  store i64 %180, i64* %RDI.i54, align 8
  %181 = add i64 %175, -8
  %182 = add i64 %174, 16
  ...
  %186 = getelementptr inbounds %union.anon, %union.anon* %126, i64 0, i32 0
  %187 = add i64 %175, -20
  %188 = add i64 %174, 20
  ...
  %call2_4ab6e2 = tail call %struct.Memory* @sub_478110.play_attack_defend_n(%struct.State* nonnull %0, i64 %196, %struct.Memory* %call2_4ab6b2)
  %201 = load i32, i32* %EAX.i46, align 4
  ...
  %R10B.i14 = bitcast %union.anon* %212 to i8*
  %213 = xor i1 %208, true
  %214 = zext i1 %213 to i8
  store i8 %214, i8* %R10B.i14, align 1
...
block_.L_4ab6f2:                                  ; preds = %block_4ab6c8, %block_4ab6af, %entry
  %219 = phi i64 [ %144, %entry ], [ %174, %block_4ab6af ], [ %.pre, %block_4ab6c8 ]
  %MEMORY.0 = phi %struct.Memory* [ %call2_4ab698, %entry ], [ %call2_4ab6b2, %block_4ab6af ], [ %call2_4ab6e2, %block_4ab6c8 ]
  ...
  store i64 %226, i64* %RAX.i66, align 8
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_je_.L_4ab6f2(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i8* nocapture %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
