...
define %struct.Memory* @autohelperendpat65(%struct.State* noalias, i64, %struct.Memory* noalias readnone) local_unnamed_addr #1 {
entry:
  ...
  %call2_4abaa9 = tail call %struct.Memory* @sub_43bff0.is_proper_eye_space(%struct.State* %0, i64 %167, %struct.Memory* %2)
  ...
  br i1 %192, label %block_.L_4abacf, label %block_4ababe
...
block_4ababe:                                     ; preds = %entry
  ...
  %call2_4abac1 = tail call %struct.Memory* @sub_43bff0.is_proper_eye_space(%struct.State* nonnull %0, i64 %200, %struct.Memory* %call2_4abaa9)
  %205 = load i32, i32* %EAX.i23, align 4
  ...
  store i8 %217, i8* %CL.i14, align 1
...
block_.L_4abacf:                                  ; preds = %block_4ababe, %entry
  %222 = phi i64 [ %189, %entry ], [ %.pre, %block_4ababe ]
  %MEMORY.0 = phi %struct.Memory* [ %call2_4abaa9, %entry ], [ %call2_4abac1, %block_4ababe ]
  ...
  store i64 %229, i64* %RAX.i50, align 8
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_jne_.L_4abacf(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i8* nocapture %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
