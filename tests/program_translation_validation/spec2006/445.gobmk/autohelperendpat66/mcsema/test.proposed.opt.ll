...
define %struct.Memory* @autohelperendpat66(%struct.State* noalias, i64, %struct.Memory* noalias readnone) local_unnamed_addr #1 {
entry:
  ...
  %call2_4abb19 = tail call %struct.Memory* @sub_43bff0.is_proper_eye_space(%struct.State* %0, i64 %167, %struct.Memory* %2)
  ...
  %.v = select i1 %190, i64 23, i64 6
  %191 = add i64 %188, %.v
  store i64 %191, i64* %3, align 8
  %cmpBr_4abb2a = icmp eq i8 %189, 1
...
block_4abb30:                                     ; preds = %entry
  ...
  %call2_4abb33 = tail call %struct.Memory* @sub_43bff0.is_proper_eye_space(%struct.State* nonnull %0, i64 %198, %struct.Memory* %call2_4abb19)
  %203 = load i32, i32* %EAX.i23, align 4
  ...
  store i8 %215, i8* %CL.i25, align 1
...
block_.L_4abb41:                                  ; preds = %block_4abb30, %entry
  %220 = phi i64 [ %191, %entry ], [ %.pre, %block_4abb30 ]
  %MEMORY.0 = phi %struct.Memory* [ %call2_4abb19, %entry ], [ %call2_4abb33, %block_4abb30 ]
  ...
  store i64 %227, i64* %RAX.i54, align 8
  %228 = load i64, i64* %6, align 8
  %229 = add i64 %228, 32
  store i64 %229, i64* %6, align 8
  %230 = icmp ugt i64 %228, -33
  ...
  %252 = add i64 %228, 40
  %253 = inttoptr i64 %229 to i64*
  %254 = load i64, i64* %253, align 8
  store i64 %254, i64* %RBP.i, align 8
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_je_.L_4abb41(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i8* nocapture %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
