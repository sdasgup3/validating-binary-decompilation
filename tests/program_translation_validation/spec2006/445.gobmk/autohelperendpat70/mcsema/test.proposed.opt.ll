...
define %struct.Memory* @autohelperendpat70(%struct.State* noalias, i64, %struct.Memory* noalias readnone) local_unnamed_addr #1 {
entry:
  ...
  %EDI.i80 = bitcast %union.anon* %39 to i32*
  %40 = add i64 %7, -12
  %41 = load i32, i32* %EDI.i80, align 4
  %42 = add i64 %10, 10
  ...
  %call2_4abcc8 = tail call %struct.Memory* @sub_43c160.is_marginal_eye_space(%struct.State* %0, i64 %120, %struct.Memory* %2)
  ...
  %.v = select i1 %143, i64 69, i64 6
  %144 = add i64 %141, %.v
  store i64 %144, i64* %3, align 8
  %cmpBr_4abcd9 = icmp eq i8 %142, 1
...
block_4abcdf:                                     ; preds = %entry
  ...
  store i64 %150, i64* %RDI.i58, align 8
  %151 = add i64 %144, -457967
  %152 = add i64 %144, 8
  ...
  %call2_4abce2 = tail call %struct.Memory* @sub_43bff0.is_proper_eye_space(%struct.State* nonnull %0, i64 %151, %struct.Memory* %call2_4abcc8)
  %156 = load i64, i64* %3, align 8
  store i64 0, i64* %RDI.i58, align 8
  store i8 0, i8* %CL.i52, align 1
  %157 = load i32, i32* %EAX.i50, align 4
  store i8 0, i8* %14, align 1
  %158 = and i32 %157, 255
  ...
  %.v2 = select i1 %173, i64 44, i64 6
  %174 = add i64 %171, %.v2
  store i64 %174, i64* %3, align 8
  %cmpBr_4abcf2 = icmp eq i8 %172, 1
...
block_4abcf8:                                     ; preds = %block_4abcdf
  ...
  store i64 %180, i64* %RDI.i58, align 8
  %181 = add i64 %175, -12
  %182 = add i64 %174, 20
  ...
  %call2_4abd0e = tail call %struct.Memory* @sub_412080.accuratelib(%struct.State* nonnull %0, i64 %206, %struct.Memory* %call2_4abce2)
  %211 = load i32, i32* %EAX.i50, align 4
  ...
  %235 = xor i1 %234, %232
  %.demorgan = or i1 %225, %235
  %236 = xor i1 %.demorgan, true
  %237 = zext i1 %236 to i8
  store i8 %237, i8* %R8B.i53, align 1
...
block_.L_4abd1e:                                  ; preds = %block_4abcf8, %block_4abcdf, %entry
  %242 = phi i64 [ %144, %entry ], [ %174, %block_4abcdf ], [ %.pre, %block_4abcf8 ]
  %MEMORY.0 = phi %struct.Memory* [ %call2_4abcc8, %entry ], [ %call2_4abce2, %block_4abcdf ], [ %call2_4abd0e, %block_4abcf8 ]
  ...
  store i64 %249, i64* %RAX.i70, align 8
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_je_.L_4abd1e(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i8* nocapture %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
