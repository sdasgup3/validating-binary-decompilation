...
define %struct.Memory* @autohelperendpat71(%struct.State* noalias, i64, %struct.Memory* noalias readnone) local_unnamed_addr #1 {
entry:
  ...
  %call2_4abd58 = tail call %struct.Memory* @sub_43c160.is_marginal_eye_space(%struct.State* %0, i64 %120, %struct.Memory* %2)
  ...
  %.v = select i1 %143, i64 62, i64 6
  %144 = add i64 %141, %.v
  store i64 %144, i64* %3, align 8
  %cmpBr_4abd69 = icmp eq i8 %142, 1
...
block_4abd6f:                                     ; preds = %entry
  ...
  store i64 %150, i64* %RDI.i53, align 8
  %151 = add i64 %144, -458111
  %152 = add i64 %144, 8
  ...
  %call2_4abd72 = tail call %struct.Memory* @sub_43bff0.is_proper_eye_space(%struct.State* nonnull %0, i64 %151, %struct.Memory* %call2_4abd58)
  %156 = load i64, i64* %3, align 8
  store i64 0, i64* %RDI.i53, align 8
  store i8 0, i8* %CL.i47, align 1
  %157 = load i32, i32* %EAX.i45, align 4
  store i8 0, i8* %14, align 1
  %158 = and i32 %157, 255
  ...
  %.v2 = select i1 %173, i64 37, i64 6
  %174 = add i64 %171, %.v2
  store i64 %174, i64* %3, align 8
  %cmpBr_4abd82 = icmp eq i8 %172, 1
...
block_4abd88:                                     ; preds = %block_4abd6f
  ...
  store i64 %180, i64* %RDI.i53, align 8
  ...
  %call2_4abd97 = tail call %struct.Memory* @sub_412080.accuratelib(%struct.State* nonnull %0, i64 %186, %struct.Memory* %call2_4abd72)
  %191 = load i32, i32* %EAX.i45, align 4
  %192 = load i64, i64* %3, align 8
  %193 = add i32 %191, -2
  %194 = icmp ult i32 %191, 2
  ...
  %216 = xor i1 %.demorgan, true
  %217 = zext i1 %216 to i8
  store i8 %217, i8* %R8B.i48, align 1
...
block_.L_4abda7:                                  ; preds = %block_4abd88, %block_4abd6f, %entry
  %222 = phi i64 [ %144, %entry ], [ %174, %block_4abd6f ], [ %.pre, %block_4abd88 ]
  %MEMORY.0 = phi %struct.Memory* [ %call2_4abd58, %entry ], [ %call2_4abd72, %block_4abd6f ], [ %call2_4abd97, %block_4abd88 ]
  ...
  store i64 %229, i64* %RAX.i65, align 8
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_je_.L_4abda7(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i8* nocapture %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
