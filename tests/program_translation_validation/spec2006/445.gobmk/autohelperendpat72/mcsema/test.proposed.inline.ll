...
define %struct.Memory* @autohelperendpat72(%struct.State* noalias, i64, %struct.Memory* noalias) #2 {
entry:
  ...
  store %struct.Memory* %loadMem_4abdc0, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_4abdc4, %struct.Memory** %MEMORY
  ...
  store i32 %94, i32* %98
  store %struct.Memory* %loadMem_4abdcb, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_4abdce, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_4abdd1, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_4abdd4, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_4abdd8, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_4abddf, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_4abde2, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_4abde5, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem1_4abde8, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_4abded, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_4abdef, %struct.Memory** %MEMORY
  ...
  store i8 %349, i8* %353
  store %struct.Memory* %loadMem_4abdf5, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_4abdf9, %struct.Memory** %MEMORY
...
block_4abdff:                                     ; preds = %entry
  ...
  store %struct.Memory* %loadMem_4abdff, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem1_4abe02, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_4abe07, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_4abe0a, %struct.Memory** %MEMORY
  ...
  store i8 %453, i8* %457
  store %struct.Memory* %loadMem_4abe0d, %struct.Memory** %MEMORY
...
block_.L_4abe10:                                  ; preds = %block_4abdff, %entry
  ...
  store %struct.Memory* %loadMem_4abe10, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_4abe13, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_4abe15, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_4abe1c, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_4abe1d, %struct.Memory** %MEMORY
  ret %struct.Memory* %loadMem_4abe1d
}
