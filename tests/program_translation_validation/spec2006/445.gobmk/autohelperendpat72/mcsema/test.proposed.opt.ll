...
define %struct.Memory* @autohelperendpat72(%struct.State* noalias, i64, %struct.Memory* noalias readnone) local_unnamed_addr #1 {
entry:
  ...
  %call2_4abde8 = tail call %struct.Memory* @sub_43c160.is_marginal_eye_space(%struct.State* %0, i64 %120, %struct.Memory* %2)
  ...
  %cmpBr_4abdf9 = icmp eq i8 %142, 1
  br i1 %cmpBr_4abdf9, label %block_.L_4abe10, label %block_4abdff

block_4abdff:                                     ; preds = %entry
  ...
  %call2_4abe02 = tail call %struct.Memory* @sub_43bff0.is_proper_eye_space(%struct.State* nonnull %0, i64 %151, %struct.Memory* %call2_4abde8)
  ...
  br label %block_.L_4abe10

block_.L_4abe10:                                  ; preds = %block_4abdff, %entry
  %173 = phi i64 [ %144, %entry ], [ %.pre, %block_4abdff ]
  %MEMORY.0 = phi %struct.Memory* [ %call2_4abde8, %entry ], [ %call2_4abe02, %block_4abdff ]
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_je_.L_4abe10(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i8* nocapture %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
