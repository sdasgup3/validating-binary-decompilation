...
define %struct.Memory* @autohelperendpat74(%struct.State* noalias, i64, %struct.Memory* noalias readnone) local_unnamed_addr #1 {
entry:
  ...
  %call2_4abef8 = tail call %struct.Memory* @sub_43c160.is_marginal_eye_space(%struct.State* %0, i64 %120, %struct.Memory* %2)
  ...
  %142 = load i8, i8* %29, align 1
  %143 = icmp ne i8 %142, 0
  %.v = select i1 %143, i64 23, i64 6
  %144 = add i64 %141, %.v
  store i64 %144, i64* %3, align 8
  %cmpBr_4abf09 = icmp eq i8 %142, 1
  br i1 %cmpBr_4abf09, label %block_.L_4abf20, label %block_4abf0f

block_4abf0f:                                     ; preds = %entry
  ...
  store i64 %150, i64* %RDI.i30, align 8
  %151 = add i64 %144, -458527
  %152 = add i64 %144, 8
  ...
  %call2_4abf12 = tail call %struct.Memory* @sub_43bff0.is_proper_eye_space(%struct.State* nonnull %0, i64 %151, %struct.Memory* %call2_4abef8)
  %156 = load i32, i32* %EAX.i23, align 4
  ...
  store i8 %168, i8* %CL.i25, align 1
  ...
  br label %block_.L_4abf20

block_.L_4abf20:                                  ; preds = %block_4abf0f, %entry
  %173 = phi i64 [ %144, %entry ], [ %.pre, %block_4abf0f ]
  %MEMORY.0 = phi %struct.Memory* [ %call2_4abef8, %entry ], [ %call2_4abf12, %block_4abf0f ]
  ...
  store i64 %180, i64* %RAX.i42, align 8
  %181 = load i64, i64* %6, align 8
  %182 = add i64 %181, 32
  store i64 %182, i64* %6, align 8
  %183 = icmp ugt i64 %181, -33
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_je_.L_4abf20(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i8* nocapture %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
