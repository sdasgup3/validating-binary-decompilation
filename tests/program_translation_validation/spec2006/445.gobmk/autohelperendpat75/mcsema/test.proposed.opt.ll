...
define %struct.Memory* @autohelperendpat75(%struct.State* noalias, i64, %struct.Memory* noalias readnone) local_unnamed_addr #1 {
entry:
  ...
  %call2_4abf69 = tail call %struct.Memory* @sub_43c160.is_marginal_eye_space(%struct.State* %0, i64 %167, %struct.Memory* %2)
...
block_4abf80:                                     ; preds = %entry
  ...
  %call2_4abf83 = tail call %struct.Memory* @sub_43bff0.is_proper_eye_space(%struct.State* nonnull %0, i64 %198, %struct.Memory* %call2_4abf69)
  ...
  %cmpBr_4abf93 = icmp eq i8 %219, 1
  br i1 %cmpBr_4abf93, label %block_.L_4abfaa, label %block_4abf99

block_4abf99:                                     ; preds = %block_4abf80
  ...
  %call2_4abf9c = tail call %struct.Memory* @sub_43bff0.is_proper_eye_space(%struct.State* nonnull %0, i64 %228, %struct.Memory* %call2_4abf83)
...
block_.L_4abfaa:                                  ; preds = %block_4abf99, %block_4abf80, %entry
  %250 = phi i64 [ %191, %entry ], [ %221, %block_4abf80 ], [ %.pre, %block_4abf99 ]
  %MEMORY.0 = phi %struct.Memory* [ %call2_4abf69, %entry ], [ %call2_4abf83, %block_4abf80 ], [ %call2_4abf9c, %block_4abf99 ]
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_je_.L_4abfaa(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i8* nocapture %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
