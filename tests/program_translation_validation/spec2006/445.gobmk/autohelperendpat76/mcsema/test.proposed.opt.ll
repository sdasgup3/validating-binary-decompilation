...
define %struct.Memory* @autohelperendpat76(%struct.State* noalias, i64, %struct.Memory* noalias readnone) local_unnamed_addr #1 {
entry:
  ...
  store i64 %172, i64* %RCX.i94, align 8
  %173 = add i64 %160, -8
  %174 = add i64 %162, 14
  ...
  store i64 %178, i64* %RCX.i94, align 8
  ...
  store i64 %213, i64* %RDI.i60, align 8
  %214 = add i64 %209, -458407
  %215 = add i64 %209, 8
  ...
  %call2_4ac00a = tail call %struct.Memory* @sub_43c160.is_marginal_eye_space(%struct.State* %0, i64 %214, %struct.Memory* %2)
  ...
  %R8B.i56 = bitcast %union.anon* %220 to i8*
  store i8 0, i8* %R8B.i56, align 1
  %EAX.i53 = bitcast %union.anon* %65 to i32*
  %221 = load i32, i32* %EAX.i53, align 4
  ...
  %.v = select i1 %237, i64 73, i64 6
  %238 = add i64 %235, %.v
  store i64 %238, i64* %3, align 8
  %cmpBr_4ac01b = icmp eq i8 %236, 1
...
block_4ac021:                                     ; preds = %entry
  ...
  store i64 %244, i64* %RDI.i60, align 8
  %245 = add i64 %238, -458801
  %246 = add i64 %238, 8
  ...
  %call2_4ac024 = tail call %struct.Memory* @sub_43bff0.is_proper_eye_space(%struct.State* nonnull %0, i64 %245, %struct.Memory* %call2_4ac00a)
  %250 = load i64, i64* %3, align 8
  store i64 0, i64* %RDI.i60, align 8
  store i8 0, i8* %CL.i55, align 1
  %251 = load i32, i32* %EAX.i53, align 4
  store i8 0, i8* %14, align 1
  %252 = and i32 %251, 255
  ...
  %.v3 = select i1 %267, i64 48, i64 6
  %268 = add i64 %265, %.v3
  store i64 %268, i64* %3, align 8
  %cmpBr_4ac034 = icmp eq i8 %266, 1
...
block_4ac03a:                                     ; preds = %block_4ac021
  ...
  store i64 %274, i64* %RDI.i60, align 8
  %275 = add i64 %268, -458826
  %276 = add i64 %268, 8
  ...
  %call2_4ac03d = tail call %struct.Memory* @sub_43bff0.is_proper_eye_space(%struct.State* nonnull %0, i64 %275, %struct.Memory* %call2_4ac024)
  %280 = load i64, i64* %3, align 8
  store i64 0, i64* %RDI.i60, align 8
  store i8 0, i8* %CL.i55, align 1
  %281 = load i32, i32* %EAX.i53, align 4
  store i8 0, i8* %14, align 1
  %282 = and i32 %281, 255
  ...
  %.v4 = select i1 %297, i64 23, i64 6
  %298 = add i64 %295, %.v4
  store i64 %298, i64* %3, align 8
  %cmpBr_4ac04d = icmp eq i8 %296, 1
...
block_4ac053:                                     ; preds = %block_4ac03a
  ...
  store i64 %304, i64* %RDI.i60, align 8
  %305 = add i64 %298, -458851
  %306 = add i64 %298, 8
  ...
  %call2_4ac056 = tail call %struct.Memory* @sub_43bff0.is_proper_eye_space(%struct.State* nonnull %0, i64 %305, %struct.Memory* %call2_4ac03d)
  %310 = load i32, i32* %EAX.i53, align 4
  ...
  store i8 %322, i8* %CL.i55, align 1
...
block_.L_4ac064:                                  ; preds = %block_4ac053, %block_4ac03a, %block_4ac021, %entry
  %327 = phi i64 [ %238, %entry ], [ %268, %block_4ac021 ], [ %298, %block_4ac03a ], [ %.pre, %block_4ac053 ]
  %MEMORY.0 = phi %struct.Memory* [ %call2_4ac00a, %entry ], [ %call2_4ac024, %block_4ac021 ], [ %call2_4ac03d, %block_4ac03a ], [ %call2_4ac056, %block_4ac053 ]
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_je_.L_4ac064(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i8* nocapture %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
