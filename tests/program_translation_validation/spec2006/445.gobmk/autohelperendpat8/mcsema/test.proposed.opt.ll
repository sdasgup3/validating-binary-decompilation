...
define %struct.Memory* @autohelperendpat8(%struct.State* noalias, i64, %struct.Memory* noalias readnone) local_unnamed_addr #1 {
entry:
  ...
  %call2_4aa5a8 = tail call %struct.Memory* @sub_43bff0.is_proper_eye_space(%struct.State* %0, i64 %120, %struct.Memory* %2)
  ...
  %.v = select i1 %143, i64 26, i64 6
  %144 = add i64 %141, %.v
  store i64 %144, i64* %3, align 8
  %cmpBr_4aa5b9 = icmp eq i8 %142, 1
...
block_4aa5bf:                                     ; preds = %entry
  ...
  store i64 %150, i64* %RDI.i32, align 8
  ...
  %call2_4aa5c5 = tail call %struct.Memory* @sub_46bc30.safe_move(%struct.State* nonnull %0, i64 %156, %struct.Memory* %call2_4aa5a8)
  %161 = load i32, i32* %EAX.i25, align 4
  ...
  store i8 %173, i8* %CL.i27, align 1
...
block_.L_4aa5d3:                                  ; preds = %block_4aa5bf, %entry
  %178 = phi i64 [ %144, %entry ], [ %.pre, %block_4aa5bf ]
  %MEMORY.0 = phi %struct.Memory* [ %call2_4aa5a8, %entry ], [ %call2_4aa5c5, %block_4aa5bf ]
  ...
  store i64 %185, i64* %RAX.i44, align 8
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_je_.L_4aa5d3(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i8* nocapture %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
