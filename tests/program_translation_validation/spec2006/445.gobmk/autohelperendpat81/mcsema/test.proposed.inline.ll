...
define %struct.Memory* @autohelperendpat81(%struct.State* noalias, i64, %struct.Memory* noalias) #2 {
entry:
  ...
  store %struct.Memory* %loadMem_4ac250, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_4ac251, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_4ac254, %struct.Memory** %MEMORY
  ...
  store i32 %78, i32* %82
  store %struct.Memory* %loadMem_4ac258, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_4ac261, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_4ac264, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_4ac268, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_4ac26f, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_4ac275, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem1_4ac278, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_4ac27d, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_4ac284, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_4ac288, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_4ac28c, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_4ac291, %struct.Memory** %MEMORY
  ret %struct.Memory* %loadMem_4ac291
}
