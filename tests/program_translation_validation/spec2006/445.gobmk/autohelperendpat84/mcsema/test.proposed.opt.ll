...
define %struct.Memory* @autohelperendpat84(%struct.State* noalias, i64, %struct.Memory* noalias readnone) local_unnamed_addr #1 {
entry:
  ...
  %ECX.i67 = bitcast %union.anon* %58 to i32*
  %59 = load i64, i64* %RBP.i, align 8
  %60 = add i64 %59, -16
  %61 = load i32, i32* %ECX.i67, align 4
  ...
  %RAX.i64 = getelementptr inbounds %union.anon, %union.anon* %65, i64 0, i32 0
  ...
  store i64 %72, i64* %RAX.i64, align 8
  %RCX.i62 = getelementptr inbounds %union.anon, %union.anon* %58, i64 0, i32 0
  %73 = shl nsw i64 %72, 2
  ...
  store i64 %78, i64* %RCX.i62, align 8
  %79 = add i64 %66, -8
  %80 = add i64 %68, 14
  ...
  store i64 %84, i64* %RCX.i62, align 8
  ...
  store i64 %119, i64* %RAX.i64, align 8
  ...
  store i64 %125, i64* %RCX.i62, align 8
  %126 = add i64 %113, -8
  %127 = add i64 %115, 14
  ...
  store i64 %131, i64* %RCX.i62, align 8
  ...
  store i64 %166, i64* %RDI.i40, align 8
  %167 = add i64 %162, -459702
  %168 = add i64 %162, 8
  ...
  %call2_4ac3a9 = tail call %struct.Memory* @sub_43bff0.is_proper_eye_space(%struct.State* %0, i64 %167, %struct.Memory* %2)
  %172 = load i64, i64* %3, align 8
  store i64 0, i64* %RCX.i62, align 8
  %173 = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 17, i32 0
  %R8B.i35 = bitcast %union.anon* %173 to i8*
  store i8 0, i8* %R8B.i35, align 1
  %EAX.i33 = bitcast %union.anon* %65 to i32*
  %174 = load i32, i32* %EAX.i33, align 4
  ...
  %cmpBr_4ac3ba = icmp eq i8 %189, 1
  br i1 %cmpBr_4ac3ba, label %entry.block_.L_4ac3ea_crit_edge, label %block_4ac3c0

entry.block_.L_4ac3ea_crit_edge:                  ; preds = %entry
  %.pre1 = bitcast %union.anon* %65 to i8*
  br label %block_.L_4ac3ea

block_4ac3c0:                                     ; preds = %entry
  ...
  store i64 %202, i64* %RCX.i62, align 8
  %203 = getelementptr inbounds %union.anon, %union.anon* %173, i64 0, i32 0
  %204 = add i64 %192, -24
  %205 = add i64 %191, 20
  ...
  %209 = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 19, i32 0, i32 0
  %210 = add i64 %191, 24
  ...
  %call2_4ac3da = tail call %struct.Memory* @sub_478110.play_attack_defend_n(%struct.State* nonnull %0, i64 %213, %struct.Memory* %call2_4ac3a9)
  %218 = load i32, i32* %EAX.i33, align 4
  ...
  store i8 0, i8* %38, align 1
  %229 = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 21, i32 0
  %R10B.i14 = bitcast %union.anon* %229 to i8*
  %230 = xor i1 %225, true
  %231 = zext i1 %230 to i8
  store i8 %231, i8* %R10B.i14, align 1
...
block_.L_4ac3ea:                                  ; preds = %entry.block_.L_4ac3ea_crit_edge, %block_4ac3c0
  %AL.i9.pre-phi = phi i8* [ %.pre1, %entry.block_.L_4ac3ea_crit_edge ], [ %AL.i18, %block_4ac3c0 ]
  %236 = phi i64 [ %191, %entry.block_.L_4ac3ea_crit_edge ], [ %.pre, %block_4ac3c0 ]
  %MEMORY.0 = phi %struct.Memory* [ %call2_4ac3a9, %entry.block_.L_4ac3ea_crit_edge ], [ %call2_4ac3da, %block_4ac3c0 ]
  ...
  %242 = and i8 %241, 1
  store i8 %242, i8* %AL.i9.pre-phi, align 1
  %243 = zext i8 %242 to i64
  store i64 %243, i64* %RAX.i64, align 8
  %244 = load i64, i64* %6, align 8
  %245 = add i64 %244, 32
  store i64 %245, i64* %6, align 8
  %246 = icmp ugt i64 %244, -33
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_je_.L_4ac3ea(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i8* nocapture %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
