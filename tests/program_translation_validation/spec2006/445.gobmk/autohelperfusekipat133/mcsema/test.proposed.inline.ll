...
define %struct.Memory* @autohelperfusekipat133(%struct.State* noalias, i64, %struct.Memory* noalias) #2 {
entry:
  ...
  store %struct.Memory* %loadMem_4adec0, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_4adec1, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_4adec4, %struct.Memory** %MEMORY
  ...
  store i32 %78, i32* %82
  store %struct.Memory* %loadMem_4adec8, %struct.Memory** %MEMORY
  ...
  store i32 %94, i32* %98
  store %struct.Memory* %loadMem_4adecb, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_4adece, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_4aded1, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_4aded4, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_4aded8, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_4adedf, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_4adee2, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_4adee5, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem1_4adee8, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_4adeed, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_4adeef, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_4adef3, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_4adef4, %struct.Memory** %MEMORY
  ret %struct.Memory* %loadMem_4adef4
}
