...
define %struct.Memory* @autohelperfusekipat137(%struct.State* noalias, i64, %struct.Memory* noalias readnone returned) local_unnamed_addr #1 {
entry:
  ...
  %call2_4adf9a = tail call %struct.Memory* @sub_477710.somewhere(%struct.State* %0, i64 %192, %struct.Memory* %2)
  ...
  ret %struct.Memory* %call2_4adf9a
}
