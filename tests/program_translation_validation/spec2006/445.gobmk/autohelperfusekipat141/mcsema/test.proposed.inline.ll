...
define %struct.Memory* @autohelperfusekipat141(%struct.State* noalias, i64, %struct.Memory* noalias) #2 {
entry:
  ...
  store %struct.Memory* %loadMem_4adfb0, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_4adfb1, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_4adfb4, %struct.Memory** %MEMORY
  ...
  store i32 %78, i32* %82
  store %struct.Memory* %loadMem_4adfb8, %struct.Memory** %MEMORY
  ...
  store i32 %94, i32* %98
  store %struct.Memory* %loadMem_4adfbb, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_4adfbe, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_4adfc1, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_4adfc4, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_4adfc8, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_4adfcf, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_4adfd2, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_4adfd5, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem1_4adfd8, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_4adfdd, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_4adfdf, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_4adfe3, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_4adfe4, %struct.Memory** %MEMORY
  ret %struct.Memory* %loadMem_4adfe4
}
