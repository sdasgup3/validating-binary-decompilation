...
define %struct.Memory* @autohelperfusekipat3(%struct.State* noalias, i64, %struct.Memory* noalias readnone returned) local_unnamed_addr #1 {
entry:
  ...
  %call2_4aca94 = tail call %struct.Memory* @sub_477710.somewhere(%struct.State* %0, i64 %219, %struct.Memory* %2)
  ...
  ret %struct.Memory* %call2_4aca94
}
