...
define %struct.Memory* @autohelperfusekipat34(%struct.State* noalias, i64, %struct.Memory* noalias readnone returned) local_unnamed_addr #1 {
entry:
  ...
  %R9D.i44 = bitcast %union.anon* %40 to i32*
  ...
  %R10.i33 = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 21, i32 0, i32 0
  ...
  store i64 %74, i64* %R10.i33, align 8
  ...
  %115 = load i32, i32* %R9D.i44, align 4
  ...
  %145 = load i64, i64* %R8.i46, align 8
  %146 = load i64, i64* %RAX.i48, align 8
  %147 = select i1 %137, i64 %145, i64 %146
  store i64 %147, i64* %RAX.i48, align 8
  ...
  %call2_4acc52 = tail call %struct.Memory* @sub_42b3d0.whose_moyo(%struct.State* %0, i64 %153, %struct.Memory* %2)
  ...
  %166 = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 23, i32 0
  %R11B.i11 = bitcast %union.anon* %166 to i8*
  %167 = zext i1 %165 to i8
  store i8 %167, i8* %R11B.i11, align 1
  %168 = zext i1 %165 to i64
  store i64 %168, i64* %RAX.i48, align 8
  ...
  ret %struct.Memory* %call2_4acc52
}
