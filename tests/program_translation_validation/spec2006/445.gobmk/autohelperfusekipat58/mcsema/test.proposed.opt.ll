...
define %struct.Memory* @autohelperfusekipat58(%struct.State* noalias, i64, %struct.Memory* noalias readnone) local_unnamed_addr #1 {
entry:
  ...
  %RAX.i84 = getelementptr inbounds %union.anon, %union.anon* %39, i64 0, i32 0
  ...
  %R8.i82 = getelementptr inbounds %union.anon, %union.anon* %40, i64 0, i32 0
  store i64 ptrtoint (%G__0xb38cb4_type* @G__0xb38cb4 to i64), i64* %R8.i82, align 8
  %41 = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 19, i32 0
  %R9D.i80 = bitcast %union.anon* %41 to i32*
  ...
  %EDX.i73 = bitcast %union.anon* %55 to i32*
  %56 = load i64, i64* %RBP.i, align 8
  %57 = add i64 %56, -12
  %58 = load i32, i32* %EDX.i73, align 4
  ...
  %ECX.i70 = bitcast %union.anon* %62 to i32*
  %63 = load i64, i64* %RBP.i, align 8
  %64 = add i64 %63, -16
  %65 = load i32, i32* %ECX.i70, align 4
  ...
  store i64 %75, i64* %R10.i68, align 8
  ...
  %116 = load i32, i32* %R9D.i80, align 4
  ...
  %142 = xor i32 %140, %127
  %143 = add nuw nsw i32 %142, %127
  %144 = icmp eq i32 %143, 2
  %145 = zext i1 %144 to i8
  store i8 %145, i8* %38, align 1
  %146 = load i64, i64* %R8.i82, align 8
  %147 = load i64, i64* %RAX.i84, align 8
  %148 = select i1 %138, i64 %146, i64 %147
  store i64 %148, i64* %RAX.i84, align 8
  %RSI.i50 = getelementptr inbounds %union.anon, %union.anon* %48, i64 0, i32 0
  %149 = add i64 %117, -8
  %150 = add i64 %119, 15
  ...
  store i64 %153, i64* %RSI.i50, align 8
  %RDI.i48 = getelementptr inbounds %union.anon, %union.anon* %43, i64 0, i32 0
  store i64 %148, i64* %RDI.i48, align 8
  %154 = add i64 %119, -531536
  %155 = add i64 %119, 23
  ...
  %call2_4aceb2 = tail call %struct.Memory* @sub_42b250.whose_territory(%struct.State* %0, i64 %154, %struct.Memory* %2)
  ...
  %160 = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 23, i32 0
  %R11B.i42 = bitcast %union.anon* %160 to i8*
  store i8 0, i8* %R11B.i42, align 1
  %EAX.i39 = bitcast %union.anon* %39 to i32*
  %161 = load i32, i32* %EAX.i39, align 4
  ...
  %.v = select i1 %196, i64 67, i64 6
  %197 = add i64 %194, %.v
  store i64 %197, i64* %3, align 8
  %cmpBr_4acec3 = icmp eq i8 %195, 1
  br i1 %cmpBr_4acec3, label %block_.L_4acf06, label %block_4acec9

block_4acec9:                                     ; preds = %entry
  store i64 ptrtoint (%G__0xb7df8c_type* @G__0xb7df8c to i64), i64* %RAX.i84, align 8
  store i64 ptrtoint (%G__0xb38cb4_type* @G__0xb38cb4 to i64), i64* %RCX.i65, align 8
  %RDX.i30 = getelementptr inbounds %union.anon, %union.anon* %55, i64 0, i32 0
  ...
  store i64 %204, i64* %RDX.i30, align 8
  ...
  %226 = select i1 %218, i64 ptrtoint (%G__0xb38cb4_type* @G__0xb38cb4 to i64), i64 ptrtoint (%G__0xb7df8c_type* @G__0xb7df8c to i64)
  store i64 %226, i64* %RAX.i84, align 8
  %227 = add i64 %198, -20
  %228 = add i64 %197, 38
  ...
  store i64 %231, i64* %RSI.i50, align 8
  store i64 %226, i64* %RDI.i48, align 8
  %232 = add i64 %197, -531577
  %233 = add i64 %197, 46
  ...
  %call2_4acef2 = tail call %struct.Memory* @sub_42b250.whose_territory(%struct.State* nonnull %0, i64 %232, %struct.Memory* %call2_4aceb2)
  %237 = load i32, i32* %EAX.i39, align 4
  ...
  %246 = xor i8 %245, -1
  store i8 %246, i8* %R8B.i16, align 1
  store i8 0, i8* %14, align 1
...
block_.L_4acf06:                                  ; preds = %block_4acec9, %entry
  %255 = phi i64 [ %197, %entry ], [ %.pre, %block_4acec9 ]
  %MEMORY.0 = phi %struct.Memory* [ %call2_4aceb2, %entry ], [ %call2_4acef2, %block_4acec9 ]
  ...
  store i64 %262, i64* %RAX.i84, align 8
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_je_.L_4acf06(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i8* nocapture %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
