...
define %struct.Memory* @autohelperhandipat28(%struct.State* noalias, i64, %struct.Memory* noalias readnone returned) local_unnamed_addr #1 {
entry:
  ...
  %call2_4ae567 = tail call %struct.Memory* @sub_477710.somewhere(%struct.State* %0, i64 %171, %struct.Memory* %2)
  ...
  ret %struct.Memory* %call2_4ae567
}
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_movl_0xb581f0___r9_4____ecx(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
