...
declare %struct.Memory* @sub_428730.free_handicap_remaining_stones(%struct.State* noalias dereferenceable(3376), i64, %struct.Memory* noalias readnone returned) local_unnamed_addr

; Function Attrs: alwaysinline
define %struct.Memory* @autohelperhandipat37(%struct.State* noalias, i64, %struct.Memory* noalias readnone returned) local_unnamed_addr #1 {
entry:
  ...
  %call2_4ae5c4 = tail call %struct.Memory* @sub_428730.free_handicap_remaining_stones(%struct.State* %0, i64 %67, %struct.Memory* %2)
  ...
  %R8B.i9 = bitcast %union.anon* %82 to i8*
  %83 = icmp ne i32 %77, 0
  %84 = xor i1 %83, %81
  %.demorgan = or i1 %76, %84
  %85 = xor i1 %.demorgan, true
  %86 = zext i1 %85 to i8
  store i8 %86, i8* %R8B.i9, align 1
  %RAX.i = getelementptr inbounds %union.anon, %union.anon* %72, i64 0, i32 0
  %87 = zext i1 %85 to i64
  store i64 %87, i64* %RAX.i, align 8
  ...
  ret %struct.Memory* %call2_4ae5c4
}
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_callq_.free_handicap_remaining_stones(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
