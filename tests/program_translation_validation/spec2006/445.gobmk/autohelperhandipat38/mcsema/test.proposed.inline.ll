...
define %struct.Memory* @autohelperhandipat38(%struct.State* noalias, i64, %struct.Memory* noalias) #2 {
entry:
  ...
  store %struct.Memory* %loadMem_4ae5e1, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_4ae5e4, %struct.Memory** %MEMORY
  ...
  store i32 %78, i32* %82
  store %struct.Memory* %loadMem_4ae5e8, %struct.Memory** %MEMORY
  ...
  store i32 %94, i32* %98
  store %struct.Memory* %loadMem_4ae5eb, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_4ae5ee, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem1_4ae5f4, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_4ae5fc, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_4ae60d, %struct.Memory** %MEMORY
  ret %struct.Memory* %loadMem_4ae60d
}
