...
define %struct.Memory* @autohelperhandipat39(%struct.State* noalias, i64, %struct.Memory* noalias readnone returned) local_unnamed_addr #1 {
entry:
  ...
  %call2_4ae624 = tail call %struct.Memory* @sub_428780.free_handicap_total_stones(%struct.State* %0, i64 %67, %struct.Memory* %2)
  ...
  ret %struct.Memory* %call2_4ae624
}
