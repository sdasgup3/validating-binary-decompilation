...
define %struct.Memory* @autohelperhandipat6(%struct.State* noalias, i64, %struct.Memory* noalias readnone returned) local_unnamed_addr #1 {
entry:
  ...
  %call2_4ae2e4 = tail call %struct.Memory* @sub_428730.free_handicap_remaining_stones(%struct.State* %0, i64 %67, %struct.Memory* %2)
  ...
  ret %struct.Memory* %call2_4ae2e4
}
