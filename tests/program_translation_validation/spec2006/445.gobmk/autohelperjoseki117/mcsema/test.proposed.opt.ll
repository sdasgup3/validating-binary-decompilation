...
define %struct.Memory* @autohelperjoseki117(%struct.State* noalias, i64, %struct.Memory* noalias readnone returned) local_unnamed_addr #1 {
entry:
  ...
  %ECX.i47 = bitcast %union.anon* %58 to i32*
  %59 = load i64, i64* %RBP.i, align 8
  %60 = add i64 %59, -16
  %61 = load i32, i32* %ECX.i47, align 4
  ...
  %RAX.i44 = getelementptr inbounds %union.anon, %union.anon* %65, i64 0, i32 0
  ...
  store i64 %72, i64* %RAX.i44, align 8
  ...
  %call2_4b0d08 = tail call %struct.Memory* @sub_4b0070.dragon_weak(%struct.State* %0, i64 %120, %struct.Memory* %2)
  %125 = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 17, i32 0
  %R8B.i31 = bitcast %union.anon* %125 to i8*
  ...
  %.v = select i1 %143, i64 37, i64 6
  %144 = add i64 %141, %.v
  store i64 %144, i64* %3, align 8
  %cmpBr_4b0d17 = icmp eq i8 %142, 1
...
block_4b0d1d:                                     ; preds = %entry
  ...
  %151 = mul nsw i64 %150, 76
  store i64 %151, i64* %RCX.i42, align 8
  %152 = lshr i64 %151, 63
  %153 = add i64 %151, ptrtoint (%G__0xb4bd20_type* @G__0xb4bd20 to i64)
  store i64 %153, i64* %RAX.i44, align 8
  %154 = icmp ult i64 %153, ptrtoint (%G__0xb4bd20_type* @G__0xb4bd20 to i64)
  ...
  %164 = xor i64 %151, ptrtoint (%G__0xb4bd20_type* @G__0xb4bd20 to i64)
  %165 = xor i64 %164, %153
  %166 = lshr i64 %165, 4
  ...
  %173 = xor i64 %171, lshr (i64 ptrtoint (%G__0xb4bd20_type* @G__0xb4bd20 to i64), i64 63)
  %174 = xor i64 %171, %152
  %175 = add nuw nsw i64 %173, %174
  %176 = icmp eq i64 %175, 2
  %177 = zext i1 %176 to i8
  store i8 %177, i8* %38, align 1
  %178 = add i64 %151, add (i64 ptrtoint (%G__0xb4bd20_type* @G__0xb4bd20 to i64), i64 64)
  %179 = add i64 %144, 25
  ...
  store i8 %188, i8* %DL.i14, align 1
  %191 = add i64 %145, -21
  %192 = add i64 %144, 31
...
block_.L_4b0d3c:                                  ; preds = %block_4b0d1d, %entry
  %194 = phi i64 [ %.pre, %block_4b0d1d ], [ %144, %entry ]
  ...
  store i64 %201, i64* %RAX.i44, align 8
  ...
  ret %struct.Memory* %call2_4b0d08
}
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_je_.L_4b0d3c(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i8* nocapture %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
