...
define %struct.Memory* @autohelperjoseki14(%struct.State* noalias, i64, %struct.Memory* noalias) #2 {
entry:
  ...
  store %struct.Memory* %loadMem_4b0791, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_4b0794, %struct.Memory** %MEMORY
  ...
  store i32 %78, i32* %82
  store %struct.Memory* %loadMem_4b0798, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_4b07a1, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_4b07a4, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem1_4b07a7, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_4b07ac, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_4b07ae, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_4b07b2, %struct.Memory** %MEMORY
  ...
  ret %struct.Memory* %loadMem_4b07b3
}
