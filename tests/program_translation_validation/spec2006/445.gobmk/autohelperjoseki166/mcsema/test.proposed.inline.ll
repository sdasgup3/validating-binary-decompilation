...
define %struct.Memory* @autohelperjoseki166(%struct.State* noalias, i64, %struct.Memory* noalias) #2 {
entry:
  ...
  store %struct.Memory* %loadMem_4b0e10, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_4b0e11, %struct.Memory** %MEMORY
  ...
  store i32 %78, i32* %82
  store %struct.Memory* %loadMem_4b0e18, %struct.Memory** %MEMORY
  ...
  store i32 %94, i32* %98
  store %struct.Memory* %loadMem_4b0e1b, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_4b0e1e, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_4b0e21, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_4b0e24, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem1_4b0e27, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_4b0e2e, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_4b0e33, %struct.Memory** %MEMORY
  ret %struct.Memory* %loadMem_4b0e33
}
