...
define %struct.Memory* @autohelperjoseki18(%struct.State* noalias, i64, %struct.Memory* noalias) #2 {
entry:
  ...
  store %struct.Memory* %loadMem_4b07f1, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_4b07f4, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_4b0801, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_4b0804, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem1_4b0807, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_4b080c, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_4b080e, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_4b0812, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_4b0813, %struct.Memory** %MEMORY
  ret %struct.Memory* %loadMem_4b0813
}
