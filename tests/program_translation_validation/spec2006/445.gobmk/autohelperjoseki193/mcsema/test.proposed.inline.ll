...
define %struct.Memory* @autohelperjoseki193(%struct.State* noalias, i64, %struct.Memory* noalias) #2 {
entry:
  ...
  store %struct.Memory* %loadMem_4b0ea0, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_4b0ea4, %struct.Memory** %MEMORY
  ...
  store i32 %94, i32* %98
  store %struct.Memory* %loadMem_4b0eab, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_4b0eae, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_4b0eb1, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem1_4b0eb7, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_4b0ebc, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_4b0ec2, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_4b0ec3, %struct.Memory** %MEMORY
  ret %struct.Memory* %loadMem_4b0ec3
}
