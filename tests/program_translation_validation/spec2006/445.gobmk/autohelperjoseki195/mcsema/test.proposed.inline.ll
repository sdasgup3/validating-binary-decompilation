...
define %struct.Memory* @autohelperjoseki195(%struct.State* noalias, i64, %struct.Memory* noalias) #2 {
entry:
  ...
  store %struct.Memory* %loadMem_4b0ed0, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_4b0ed1, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_4b0ed4, %struct.Memory** %MEMORY
  ...
  store i32 %78, i32* %82
  store %struct.Memory* %loadMem_4b0ed8, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_4b0ee1, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_4b0ee4, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem1_4b0ee7, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_4b0eec, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_4b0eee, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_4b0ef2, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_4b0ef3, %struct.Memory** %MEMORY
  ret %struct.Memory* %loadMem_4b0ef3
}
