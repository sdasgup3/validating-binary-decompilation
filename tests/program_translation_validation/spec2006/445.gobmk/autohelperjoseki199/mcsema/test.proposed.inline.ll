...
define %struct.Memory* @autohelperjoseki199(%struct.State* noalias, i64, %struct.Memory* noalias) #2 {
entry:
  ...
  store %struct.Memory* %loadMem_4b0f31, %struct.Memory** %MEMORY
  ...
  store i32 %94, i32* %98
  store %struct.Memory* %loadMem_4b0f3b, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_4b0f3e, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_4b0f41, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_4b0f44, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem1_4b0f47, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_4b0f4e, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_4b0f52, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_4b0f53, %struct.Memory** %MEMORY
  ret %struct.Memory* %loadMem_4b0f53
}
