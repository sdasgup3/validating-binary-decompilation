...
define %struct.Memory* @autohelperjoseki203(%struct.State* noalias, i64, %struct.Memory* noalias) #2 {
entry:
  ...
  store %struct.Memory* %loadMem_4b0f90, %struct.Memory** %MEMORY
  ...
  store i32 %78, i32* %82
  store %struct.Memory* %loadMem_4b0f98, %struct.Memory** %MEMORY
  ...
  store i32 %94, i32* %98
  store %struct.Memory* %loadMem_4b0f9b, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_4b0f9e, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_4b0fa1, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_4b0fa4, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem1_4b0fa7, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_4b0fae, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_4b0fb2, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_4b0fb3, %struct.Memory** %MEMORY
  ret %struct.Memory* %loadMem_4b0fb3
}
