...
define %struct.Memory* @autohelperjoseki209(%struct.State* noalias, i64, %struct.Memory* noalias) #2 {
entry:
  ...
  store %struct.Memory* %loadMem_4b1020, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_4b1021, %struct.Memory** %MEMORY
  ...
  store i32 %78, i32* %82
  store %struct.Memory* %loadMem_4b1028, %struct.Memory** %MEMORY
  ...
  store i32 %94, i32* %98
  store %struct.Memory* %loadMem_4b102b, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_4b102e, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_4b1031, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem1_4b1037, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_4b103c, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_4b103e, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_4b1043, %struct.Memory** %MEMORY
  ret %struct.Memory* %loadMem_4b1043
}
