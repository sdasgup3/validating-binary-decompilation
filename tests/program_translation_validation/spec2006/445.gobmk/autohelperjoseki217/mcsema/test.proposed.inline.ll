...
define %struct.Memory* @autohelperjoseki217(%struct.State* noalias, i64, %struct.Memory* noalias) #2 {
entry:
  ...
  store %struct.Memory* %loadMem_4b10e0, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_4b10e1, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_4b10e4, %struct.Memory** %MEMORY
  ...
  store i32 %78, i32* %82
  store %struct.Memory* %loadMem_4b10e8, %struct.Memory** %MEMORY
  ...
  store i32 %94, i32* %98
  store %struct.Memory* %loadMem_4b10eb, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_4b10ee, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_4b10f1, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem1_4b10f7, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_4b10fc, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_4b10fe, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_4b1103, %struct.Memory** %MEMORY
  ret %struct.Memory* %loadMem_4b1103
}
