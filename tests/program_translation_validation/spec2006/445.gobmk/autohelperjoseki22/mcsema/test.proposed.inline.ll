...
define %struct.Memory* @autohelperjoseki22(%struct.State* noalias, i64, %struct.Memory* noalias) #2 {
entry:
  ...
  store %struct.Memory* %loadMem_4b0851, %struct.Memory** %MEMORY
  ...
  store i32 %78, i32* %82
  store %struct.Memory* %loadMem_4b0858, %struct.Memory** %MEMORY
  ...
  store i32 %94, i32* %98
  store %struct.Memory* %loadMem_4b085b, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_4b085e, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_4b0861, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_4b0864, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem1_4b0867, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_4b086c, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_4b086e, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_4b0872, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_4b0873, %struct.Memory** %MEMORY
  ret %struct.Memory* %loadMem_4b0873
}
