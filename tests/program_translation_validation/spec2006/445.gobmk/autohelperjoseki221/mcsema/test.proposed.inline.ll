...
define %struct.Memory* @autohelperjoseki221(%struct.State* noalias, i64, %struct.Memory* noalias) #2 {
entry:
  ...
  store %struct.Memory* %loadMem_4b1141, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_4b1144, %struct.Memory** %MEMORY
  ...
  store i32 %78, i32* %82
  store %struct.Memory* %loadMem_4b1148, %struct.Memory** %MEMORY
  ...
  store i32 %94, i32* %98
  store %struct.Memory* %loadMem_4b114b, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_4b114e, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_4b1151, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem1_4b1157, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_4b115c, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_4b115e, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_4b1163, %struct.Memory** %MEMORY
  ret %struct.Memory* %loadMem_4b1163
}
