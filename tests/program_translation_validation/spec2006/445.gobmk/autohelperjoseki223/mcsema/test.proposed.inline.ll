...
define %struct.Memory* @autohelperjoseki223(%struct.State* noalias, i64, %struct.Memory* noalias) #2 {
entry:
  ...
  store %struct.Memory* %loadMem_4b1170, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_4b1171, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_4b1174, %struct.Memory** %MEMORY
  ...
  store i32 %78, i32* %82
  store %struct.Memory* %loadMem_4b1178, %struct.Memory** %MEMORY
  ...
  store i32 %94, i32* %98
  store %struct.Memory* %loadMem_4b117b, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_4b1181, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem1_4b1187, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_4b118c, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_4b118e, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_4b1192, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_4b1193, %struct.Memory** %MEMORY
  ret %struct.Memory* %loadMem_4b1193
}
