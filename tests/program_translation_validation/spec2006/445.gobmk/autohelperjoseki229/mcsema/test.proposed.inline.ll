...
define %struct.Memory* @autohelperjoseki229(%struct.State* noalias, i64, %struct.Memory* noalias) #2 {
entry:
  ...
  store %struct.Memory* %loadMem_4b1200, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_4b1201, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_4b1204, %struct.Memory** %MEMORY
  ...
  store i32 %78, i32* %82
  store %struct.Memory* %loadMem_4b1208, %struct.Memory** %MEMORY
  ...
  store i32 %94, i32* %98
  store %struct.Memory* %loadMem_4b120b, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_4b120e, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem1_4b1217, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_4b121c, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_4b121e, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_4b1222, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_4b1223, %struct.Memory** %MEMORY
  ret %struct.Memory* %loadMem_4b1223
}
