...
define %struct.Memory* @autohelperjoseki233(%struct.State* noalias, i64, %struct.Memory* noalias) #2 {
entry:
  ...
  store %struct.Memory* %loadMem_4b1260, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_4b1264, %struct.Memory** %MEMORY
  ...
  store i32 %94, i32* %98
  store %struct.Memory* %loadMem_4b126b, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_4b126e, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_4b1271, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_4b1274, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem1_4b1277, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_4b127c, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_4b127e, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_4b1282, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_4b1283, %struct.Memory** %MEMORY
  ret %struct.Memory* %loadMem_4b1283
}
