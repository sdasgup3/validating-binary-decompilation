...
define %struct.Memory* @autohelperjoseki24(%struct.State* noalias, i64, %struct.Memory* noalias) #2 {
entry:
  ...
  store %struct.Memory* %loadMem_4b0881, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_4b0884, %struct.Memory** %MEMORY
  ...
  store i32 %78, i32* %82
  store %struct.Memory* %loadMem_4b0888, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_4b088e, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_4b0891, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_4b0894, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem1_4b0897, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_4b089c, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_4b089e, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_4b08a2, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_4b08a3, %struct.Memory** %MEMORY
  ret %struct.Memory* %loadMem_4b08a3
}
