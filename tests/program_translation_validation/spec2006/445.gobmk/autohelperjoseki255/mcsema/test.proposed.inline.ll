...
define %struct.Memory* @autohelperjoseki255(%struct.State* noalias, i64, %struct.Memory* noalias) #2 {
entry:
  ...
  store %struct.Memory* %loadMem_4b1470, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_4b1471, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_4b1474, %struct.Memory** %MEMORY
  ...
  store i32 %78, i32* %82
  store %struct.Memory* %loadMem_4b1478, %struct.Memory** %MEMORY
  ...
  store i32 %94, i32* %98
  store %struct.Memory* %loadMem_4b147b, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_4b147e, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_4b1481, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem1_4b1487, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_4b148e, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_4b1492, %struct.Memory** %MEMORY
  ...
  ret %struct.Memory* %loadMem_4b1493
}
