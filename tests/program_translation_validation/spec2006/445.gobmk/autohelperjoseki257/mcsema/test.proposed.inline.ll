...
define %struct.Memory* @autohelperjoseki257(%struct.State* noalias, i64, %struct.Memory* noalias) #2 {
entry:
  ...
  store %struct.Memory* %loadMem_4b14d0, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_4b14d4, %struct.Memory** %MEMORY
  ...
  store i32 %94, i32* %98
  store %struct.Memory* %loadMem_4b14db, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_4b14de, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_4b14e1, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem1_4b14e7, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_4b14ec, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_4b14ee, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_4b14f3, %struct.Memory** %MEMORY
  ret %struct.Memory* %loadMem_4b14f3
}
