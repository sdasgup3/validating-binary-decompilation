...
define %struct.Memory* @autohelperjoseki259(%struct.State* noalias, i64, %struct.Memory* noalias) #2 {
entry:
  ...
  store %struct.Memory* %loadMem_4b1500, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_4b1504, %struct.Memory** %MEMORY
  ...
  store i32 %78, i32* %82
  store %struct.Memory* %loadMem_4b1508, %struct.Memory** %MEMORY
  ...
  store i32 %94, i32* %98
  store %struct.Memory* %loadMem_4b150b, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_4b150e, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_4b1511, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem1_4b1517, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_4b151c, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_4b151e, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_4b1522, %struct.Memory** %MEMORY
  ...
  ret %struct.Memory* %loadMem_4b1523
}
