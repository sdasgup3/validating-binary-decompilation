...
define %struct.Memory* @autohelperjoseki269(%struct.State* noalias, i64, %struct.Memory* noalias) #2 {
entry:
  ...
  store %struct.Memory* %loadMem_4b15f1, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_4b15f4, %struct.Memory** %MEMORY
  ...
  store i32 %78, i32* %82
  store %struct.Memory* %loadMem_4b15f8, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_4b15fe, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_4b1601, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_4b1604, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem1_4b1607, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_4b160c, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_4b160e, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_4b1613, %struct.Memory** %MEMORY
  ret %struct.Memory* %loadMem_4b1613
}
