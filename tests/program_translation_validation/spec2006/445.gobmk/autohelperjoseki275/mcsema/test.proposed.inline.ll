...
define %struct.Memory* @autohelperjoseki275(%struct.State* noalias, i64, %struct.Memory* noalias) #2 {
entry:
  ...
  store %struct.Memory* %loadMem_4b1680, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_4b1684, %struct.Memory** %MEMORY
  ...
  store i32 %78, i32* %82
  store %struct.Memory* %loadMem_4b1688, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_4b168e, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_4b1694, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem1_4b1697, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_4b169e, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_4b16a3, %struct.Memory** %MEMORY
  ret %struct.Memory* %loadMem_4b16a3
}
