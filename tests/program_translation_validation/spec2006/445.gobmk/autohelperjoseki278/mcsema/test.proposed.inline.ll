...
define %struct.Memory* @autohelperjoseki278(%struct.State* noalias, i64, %struct.Memory* noalias) #2 {
entry:
  ...
  store %struct.Memory* %loadMem_4b16e1, %struct.Memory** %MEMORY
  ...
  store i32 %94, i32* %98
  store %struct.Memory* %loadMem_4b16eb, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_4b16ee, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_4b16f1, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_4b16f4, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem1_4b16f7, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_4b16fc, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_4b16fe, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_4b1702, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_4b1703, %struct.Memory** %MEMORY
  ret %struct.Memory* %loadMem_4b1703
}
