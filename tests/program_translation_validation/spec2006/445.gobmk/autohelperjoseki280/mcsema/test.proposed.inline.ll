...
define %struct.Memory* @autohelperjoseki280(%struct.State* noalias, i64, %struct.Memory* noalias) #2 {
entry:
  ...
  store %struct.Memory* %loadMem_4b1710, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_4b1711, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_4b1714, %struct.Memory** %MEMORY
  ...
  store i32 %78, i32* %82
  store %struct.Memory* %loadMem_4b1718, %struct.Memory** %MEMORY
  ...
  store i32 %94, i32* %98
  store %struct.Memory* %loadMem_4b171b, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_4b1721, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_4b1724, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem1_4b1727, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_4b172c, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_4b172e, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_4b1733, %struct.Memory** %MEMORY
  ret %struct.Memory* %loadMem_4b1733
}
