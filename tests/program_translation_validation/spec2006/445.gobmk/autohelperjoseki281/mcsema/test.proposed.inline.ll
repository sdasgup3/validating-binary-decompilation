...
define %struct.Memory* @autohelperjoseki281(%struct.State* noalias, i64, %struct.Memory* noalias) #2 {
entry:
  ...
  store %struct.Memory* %loadMem_4b1740, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_4b1741, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_4b1744, %struct.Memory** %MEMORY
  ...
  store i32 %78, i32* %82
  store %struct.Memory* %loadMem_4b1748, %struct.Memory** %MEMORY
  ...
  store i32 %94, i32* %98
  store %struct.Memory* %loadMem_4b174b, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_4b174e, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_4b1754, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem1_4b1757, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_4b175e, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_4b1762, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_4b1763, %struct.Memory** %MEMORY
  ret %struct.Memory* %loadMem_4b1763
}
