...
define %struct.Memory* @autohelperjoseki283(%struct.State* noalias, i64, %struct.Memory* noalias) #2 {
entry:
  ...
  store %struct.Memory* %loadMem_4b1770, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_4b1771, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_4b1774, %struct.Memory** %MEMORY
  ...
  store i32 %78, i32* %82
  store %struct.Memory* %loadMem_4b1778, %struct.Memory** %MEMORY
  ...
  store i32 %94, i32* %98
  store %struct.Memory* %loadMem_4b177b, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_4b177e, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_4b1784, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem1_4b1787, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_4b178e, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_4b1792, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_4b1793, %struct.Memory** %MEMORY
  ret %struct.Memory* %loadMem_4b1793
}
