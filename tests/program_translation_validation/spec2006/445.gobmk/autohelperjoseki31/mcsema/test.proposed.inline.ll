...
define %struct.Memory* @autohelperjoseki31(%struct.State* noalias, i64, %struct.Memory* noalias) #2 {
entry:
  ...
  store %struct.Memory* %loadMem_4b0940, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_4b0944, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_4b094e, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_4b0954, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem1_4b0957, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_4b095e, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_4b0962, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_4b0963, %struct.Memory** %MEMORY
  ret %struct.Memory* %loadMem_4b0963
}
