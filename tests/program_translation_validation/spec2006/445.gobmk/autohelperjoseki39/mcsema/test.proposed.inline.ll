...
define %struct.Memory* @autohelperjoseki39(%struct.State* noalias, i64, %struct.Memory* noalias) #2 {
entry:
  ...
  store %struct.Memory* %loadMem_4b0a00, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_4b0a01, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_4b0a04, %struct.Memory** %MEMORY
  ...
  store i32 %78, i32* %82
  store %struct.Memory* %loadMem_4b0a08, %struct.Memory** %MEMORY
  ...
  store i32 %94, i32* %98
  store %struct.Memory* %loadMem_4b0a0b, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_4b0a0e, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_4b0a11, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem1_4b0a17, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_4b0a1c, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_4b0a22, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_4b0a23, %struct.Memory** %MEMORY
  ret %struct.Memory* %loadMem_4b0a23
}
