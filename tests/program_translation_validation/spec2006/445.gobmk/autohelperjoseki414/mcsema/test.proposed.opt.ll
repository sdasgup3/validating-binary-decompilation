...
define %struct.Memory* @autohelperjoseki414(%struct.State* noalias, i64, %struct.Memory* noalias readnone returned) local_unnamed_addr #1 {
entry:
  ...
  store i64 %72, i64* %RDI.i, align 8
  %73 = add i64 %68, -520420
  %74 = add i64 %68, 8
  ...
  %call2_4b23e7 = tail call %struct.Memory* @sub_433300.add_antisuji_move(%struct.State* %0, i64 %73, %struct.Memory* %2)
  ...
  ret %struct.Memory* %call2_4b23e7
}
