...
define %struct.Memory* @autohelperjoseki64(%struct.State* noalias, i64, %struct.Memory* noalias) #2 {
entry:
  ...
  store %struct.Memory* %loadMem_4b0b81, %struct.Memory** %MEMORY
  ...
  store i32 %78, i32* %82
  store %struct.Memory* %loadMem_4b0b88, %struct.Memory** %MEMORY
  ...
  store i32 %94, i32* %98
  store %struct.Memory* %loadMem_4b0b8b, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_4b0b8e, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_4b0b94, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem1_4b0b97, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_4b0b9c, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_4b0b9e, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_4b0ba3, %struct.Memory** %MEMORY
  ret %struct.Memory* %loadMem_4b0ba3
}
