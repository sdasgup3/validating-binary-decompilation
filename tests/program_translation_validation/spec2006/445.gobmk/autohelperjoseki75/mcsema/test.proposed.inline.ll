...
define %struct.Memory* @autohelperjoseki75(%struct.State* noalias, i64, %struct.Memory* noalias) #2 {
entry:
  ...
  store %struct.Memory* %loadMem_4b0bb1, %struct.Memory** %MEMORY
  ...
  store i32 %78, i32* %82
  store %struct.Memory* %loadMem_4b0bb8, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_4b0bbe, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_4b0bc4, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem1_4b0bc7, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_4b0bcc, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_4b0bd3, %struct.Memory** %MEMORY
  ret %struct.Memory* %loadMem_4b0bd3
}
