...
define %struct.Memory* @autohelperjoseki899(%struct.State* noalias, i64, %struct.Memory* noalias readnone returned) local_unnamed_addr #1 {
entry:
  ...
  %call2_4b2a52 = tail call %struct.Memory* @sub_42b500.whose_area(%struct.State* %0, i64 %153, %struct.Memory* %2)
  ...
  ret %struct.Memory* %call2_4b2a52
}
