...
declare %struct.Memory* @sub_44dbb0.owl_eyespace(%struct.State* noalias dereferenceable(3376), i64, %struct.Memory* noalias readnone returned) local_unnamed_addr
...
define %struct.Memory* @autohelperowl_attackpat114(%struct.State* noalias, i64, %struct.Memory* noalias readnone) local_unnamed_addr #1 {
entry:
  ...
  %EDX.i90 = bitcast %union.anon* %51 to i32*
  %52 = load i64, i64* %RBP.i, align 8
  %53 = add i64 %52, -12
  %54 = load i32, i32* %EDX.i90, align 4
  ...
  %ECX.i87 = bitcast %union.anon* %58 to i32*
  %59 = load i64, i64* %RBP.i, align 8
  %60 = add i64 %59, -16
  %61 = load i32, i32* %ECX.i87, align 4
  ...
  %RAX.i84 = getelementptr inbounds %union.anon, %union.anon* %65, i64 0, i32 0
  ...
  store i64 %72, i64* %RAX.i84, align 8
  %RCX.i82 = getelementptr inbounds %union.anon, %union.anon* %58, i64 0, i32 0
  %73 = shl nsw i64 %72, 2
  ...
  store i64 %119, i64* %RAX.i84, align 8
  ...
  %call2_4b5509 = tail call %struct.Memory* @sub_44dbb0.owl_eyespace(%struct.State* %0, i64 %167, %struct.Memory* %2)
  %172 = load i64, i64* %3, align 8
  store i64 0, i64* %RCX.i82, align 8
  %CL.i54 = bitcast %union.anon* %58 to i8*
  %173 = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 17, i32 0
  %R8B.i55 = bitcast %union.anon* %173 to i8*
  store i8 0, i8* %R8B.i55, align 1
  %EAX.i52 = bitcast %union.anon* %65 to i32*
  %174 = load i32, i32* %EAX.i52, align 4
  ...
  %.v3 = select i1 %190, i64 85, i64 6
  %191 = add i64 %188, %.v3
  store i64 %191, i64* %3, align 8
  %cmpBr_4b551a = icmp eq i8 %189, 1
  br i1 %cmpBr_4b551a, label %block_.L_4b556f, label %block_4b5520

block_4b5520:                                     ; preds = %entry
  %192 = load i32, i32* bitcast (%G_0xb54ce4_type* @G_0xb54ce4 to i32*), align 8
  store i8 0, i8* %14, align 1
  %193 = and i32 %192, 255
  ...
  store i8 0, i8* %38, align 1
  %.v = select i1 %198, i64 14, i64 49
  %202 = add i64 %191, %.v
  store i64 %202, i64* %3, align 8
  br i1 %198, label %block_4b552e, label %block_.L_4b5551

block_4b552e:                                     ; preds = %block_4b5520
  ...
  %209 = mul nsw i64 %208, 380
  store i64 %209, i64* %RCX.i82, align 8
  %210 = lshr i64 %209, 63
  %211 = add i64 %209, ptrtoint (%G__0xb0eff0_type* @G__0xb0eff0 to i64)
  store i64 %211, i64* %RAX.i84, align 8
  %212 = icmp ult i64 %211, ptrtoint (%G__0xb0eff0_type* @G__0xb0eff0 to i64)
  ...
  %222 = xor i64 %209, ptrtoint (%G__0xb0eff0_type* @G__0xb0eff0 to i64)
  %223 = xor i64 %222, %211
  %224 = lshr i64 %223, 4
  ...
  %231 = xor i64 %229, lshr (i64 ptrtoint (%G__0xb0eff0_type* @G__0xb0eff0 to i64), i64 63)
  %232 = xor i64 %229, %210
  ...
  %236 = add i64 %209, add (i64 ptrtoint (%G__0xb0eff0_type* @G__0xb0eff0 to i64), i64 100)
  %237 = add i64 %202, 27
...
block_.L_4b5551:                                  ; preds = %block_4b5520
  store i64 0, i64* %RAX.i84, align 8
  store i8 0, i8* %14, align 1
  ...
  store i64 %251, i64* %RDI.i60, align 8
  %252 = add i64 %202, -358929
  %253 = add i64 %202, 12
  ...
  %call2_4b5558 = tail call %struct.Memory* @sub_45db40.attack(%struct.State* nonnull %0, i64 %252, %struct.Memory* %call2_4b5509)
  %257 = load i64, i64* %RBP.i, align 8
  %258 = add i64 %257, -32
  %259 = load i32, i32* %EAX.i52, align 4
...
block_.L_4b5560:                                  ; preds = %block_.L_4b5551, %block_4b552e
  %263 = phi i64 [ %.pre, %block_.L_4b5551 ], [ %245, %block_4b552e ]
  %MEMORY.0 = phi %struct.Memory* [ %call2_4b5558, %block_.L_4b5551 ], [ %call2_4b5509, %block_4b552e ]
  ...
  store i64 %269, i64* %RAX.i84, align 8
  %270 = icmp ne i32 %268, 0
  %271 = zext i1 %270 to i64
  %272 = xor i64 %271, 255
  %273 = trunc i64 %272 to i8
  store i8 %273, i8* %CL.i54, align 1
  store i8 0, i8* %14, align 1
...
block_.L_4b556f:                                  ; preds = %block_.L_4b5560, %entry
  %282 = phi i64 [ %191, %entry ], [ %.pre2, %block_.L_4b5560 ]
  %MEMORY.1 = phi %struct.Memory* [ %call2_4b5509, %entry ], [ %MEMORY.0, %block_.L_4b5560 ]
  ...
  store i64 %289, i64* %RAX.i84, align 8
  %290 = load i64, i64* %6, align 8
  %291 = add i64 %290, 32
  store i64 %291, i64* %6, align 8
  %292 = icmp ugt i64 %290, -33
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_callq_.owl_eyespace(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_je_.L_4b556f(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i8* nocapture %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_jne_.L_4b5551(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i8* nocapture %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 2, i32 7
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_jmpq_.L_4b5560(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
