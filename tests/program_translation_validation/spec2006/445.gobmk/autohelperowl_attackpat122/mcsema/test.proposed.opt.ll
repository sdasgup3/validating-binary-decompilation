...
define %struct.Memory* @autohelperowl_attackpat122(%struct.State* noalias, i64, %struct.Memory* noalias readnone) local_unnamed_addr #1 {
entry:
  ...
  br i1 %95, label %block_4b5873, label %block_.L_4b5896
...
block_.L_4b5896:                                  ; preds = %entry
  ...
  %call2_4b589d = tail call %struct.Memory* @sub_45db40.attack(%struct.State* nonnull %0, i64 %149, %struct.Memory* %2)
...
block_.L_4b58a5:                                  ; preds = %block_.L_4b5896, %block_4b5873
  %160 = phi i64 [ %.pre, %block_.L_4b5896 ], [ %142, %block_4b5873 ]
  %MEMORY.0 = phi %struct.Memory* [ %call2_4b589d, %block_.L_4b5896 ], [ %2, %block_4b5873 ]
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_jne_.L_4b5896(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i8* nocapture %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_jmpq_.L_4b58a5(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
