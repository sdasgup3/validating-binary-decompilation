...
define %struct.Memory* @autohelperowl_attackpat136(%struct.State* noalias, i64, %struct.Memory* noalias readnone) local_unnamed_addr #1 {
entry:
  ...
  %call2_4b5db9 = tail call %struct.Memory* @sub_44dbb0.owl_eyespace(%struct.State* %0, i64 %167, %struct.Memory* %2)
  ...
  %.v = select i1 %190, i64 93, i64 6
  %191 = add i64 %188, %.v
  store i64 %191, i64* %3, align 8
  %cmpBr_4b5dca = icmp eq i8 %189, 1
  br i1 %cmpBr_4b5dca, label %block_.L_4b5e27, label %block_4b5dd0

block_4b5dd0:                                     ; preds = %entry
  ...
  store i64 %197, i64* %RDI.i70, align 8
  %198 = add i64 %192, -12
  %199 = add i64 %191, 20
  ...
  store i64 %203, i64* %RAX.i94, align 8
  %204 = icmp ugt i32 %201, 3
  ...
  store i64 %203, i64* %RSI.i41, align 8
  %223 = add i64 %191, -671056
  %224 = add i64 %191, 27
  ...
  %call2_4b5de6 = tail call %struct.Memory* @sub_412080.accuratelib(%struct.State* nonnull %0, i64 %223, %struct.Memory* %call2_4b5db9)
  %228 = load i64, i64* %3, align 8
  store i64 0, i64* %RDX.i57, align 8
  store i8 0, i8* %R8B.i65, align 1
  %229 = load i32, i32* %EAX.i63, align 4
  %230 = add i32 %229, -2
  ...
  %265 = xor i1 %264, true
  %266 = and i1 %259, %265
  %267 = select i1 %266, i64 %256, i64 %257
  store i64 %267, i64* %3, align 8
  br i1 %266, label %block_.L_4b5e27, label %block_4b5dfd

block_4b5dfd:                                     ; preds = %block_4b5dd0
  ...
  store i64 %273, i64* %RDI.i70, align 8
  %274 = add i64 %268, -8
  %275 = add i64 %267, 16
  ...
  store i64 %278, i64* %RCX.i92, align 8
  %279 = getelementptr inbounds %union.anon, %union.anon* %173, i64 0, i32 0
  %280 = add i64 %268, -24
  %281 = add i64 %267, 20
  ...
  %call2_4b5e17 = tail call %struct.Memory* @sub_478110.play_attack_defend_n(%struct.State* nonnull %0, i64 %289, %struct.Memory* %call2_4b5de6)
  %294 = load i32, i32* %EAX.i63, align 4
  ...
  %R10B.i14 = bitcast %union.anon* %305 to i8*
  %306 = xor i1 %301, true
  %307 = zext i1 %306 to i8
  store i8 %307, i8* %R10B.i14, align 1
...
block_.L_4b5e27:                                  ; preds = %block_4b5dfd, %block_4b5dd0, %entry
  %312 = phi i64 [ %191, %entry ], [ %256, %block_4b5dd0 ], [ %.pre, %block_4b5dfd ]
  %MEMORY.0 = phi %struct.Memory* [ %call2_4b5db9, %entry ], [ %call2_4b5de6, %block_4b5dd0 ], [ %call2_4b5e17, %block_4b5dfd ]
  ...
  store i64 %319, i64* %RAX.i94, align 8
  %320 = load i64, i64* %6, align 8
  %321 = add i64 %320, 32
  store i64 %321, i64* %6, align 8
  %322 = icmp ugt i64 %320, -33
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_je_.L_4b5e27(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i8* nocapture %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_jg_.L_4b5e27(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i8* nocapture %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 2, i32 7
