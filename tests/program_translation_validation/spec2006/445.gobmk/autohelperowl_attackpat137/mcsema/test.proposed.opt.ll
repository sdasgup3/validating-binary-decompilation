...
define %struct.Memory* @autohelperowl_attackpat137(%struct.State* noalias, i64, %struct.Memory* noalias readnone) local_unnamed_addr #1 {
entry:
  ...
  store i64 %223, i64* %RSI.i36, align 8
  %224 = add i64 %209, -427335
  %225 = add i64 %209, 20
  ...
  %267 = xor i1 %266, true
  %268 = and i1 %261, %267
  %269 = select i1 %268, i64 %258, i64 %259
  store i64 %269, i64* %3, align 8
  br i1 %268, label %block_.L_4b5eca, label %block_4b5ead
...
block_4b5ead:                                     ; preds = %entry
  ...
  store i64 %275, i64* %RDI.i41, align 8
  %276 = add i64 %270, -28
  %277 = add i64 %269, 7
  ...
  store i64 %280, i64* %RAX.i77, align 8
  ...
  store i64 %285, i64* %RSI.i36, align 8
  %286 = add i64 %269, -427373
  %287 = add i64 %269, 20
  ...
  %call2_4b5ebc = tail call %struct.Memory* @sub_44d940.owl_topological_eye(%struct.State* nonnull %0, i64 %286, %struct.Memory* %call2_4b5e96)
  %291 = load i32, i32* %EAX.i28, align 4
  %292 = load i64, i64* %3, align 8
  %293 = add i32 %291, -2
  %294 = icmp ult i32 %291, 2
  ...
  store i8 %306, i8* %CL.i30, align 1
...
block_.L_4b5eca:                                  ; preds = %block_4b5ead, %entry
  %318 = phi i64 [ %258, %entry ], [ %.pre, %block_4b5ead ]
  %MEMORY.0 = phi %struct.Memory* [ %call2_4b5e96, %entry ], [ %call2_4b5ebc, %block_4b5ead ]
  ...
  store i64 %325, i64* %RAX.i77, align 8
  %326 = load i64, i64* %6, align 8
  %327 = add i64 %326, 32
  store i64 %327, i64* %6, align 8
  %328 = icmp ugt i64 %326, -33
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_jg_.L_4b5eca(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i8* nocapture %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
