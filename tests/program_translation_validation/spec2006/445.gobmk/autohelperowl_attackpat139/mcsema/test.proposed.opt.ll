...
define %struct.Memory* @autohelperowl_attackpat139(%struct.State* noalias, i64, %struct.Memory* noalias readnone) local_unnamed_addr #1 {
entry:
  ...
  %call2_4b5fe5 = tail call %struct.Memory* @sub_44d940.owl_topological_eye(%struct.State* %0, i64 %177, %struct.Memory* %2)
  ...
  br i1 %214, label %block_.L_4b6010, label %block_4b5ffc
...
block_4b5ffc:                                     ; preds = %entry
  ...
  %call2_4b6002 = tail call %struct.Memory* @sub_4772c0.does_attack(%struct.State* nonnull %0, i64 %227, %struct.Memory* %call2_4b5fe5)
...
block_.L_4b6010:                                  ; preds = %block_4b5ffc, %entry
  %249 = phi i64 [ %211, %entry ], [ %.pre, %block_4b5ffc ]
  %MEMORY.0 = phi %struct.Memory* [ %call2_4b5fe5, %entry ], [ %call2_4b6002, %block_4b5ffc ]
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_jne_.L_4b6010(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i8* nocapture %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
