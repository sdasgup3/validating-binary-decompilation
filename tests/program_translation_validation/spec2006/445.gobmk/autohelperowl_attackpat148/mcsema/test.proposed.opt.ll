...
define %struct.Memory* @autohelperowl_attackpat148(%struct.State* noalias, i64, %struct.Memory* noalias readnone) local_unnamed_addr #1 {
entry:
  ...
  %call2_4b6429 = tail call %struct.Memory* @sub_44dd00.owl_big_eyespace(%struct.State* %0, i64 %167, %struct.Memory* %2)
  ...
  %.v = select i1 %190, i64 43, i64 6
  %191 = add i64 %188, %.v
  store i64 %191, i64* %3, align 8
  %cmpBr_4b643a = icmp eq i8 %189, 1
  br i1 %cmpBr_4b643a, label %entry.block_.L_4b6465_crit_edge, label %block_4b6440

entry.block_.L_4b6465_crit_edge:                  ; preds = %entry
  %.pre1 = bitcast %union.anon* %65 to i8*
  br label %block_.L_4b6465

block_4b6440:                                     ; preds = %entry
  ...
  store i64 %197, i64* %RDI.i42, align 8
  %198 = add i64 %192, -8
  %199 = add i64 %191, 11
  ...
  store i64 %202, i64* %RCX.i64, align 8
  ...
  %call2_4b6455 = tail call %struct.Memory* @sub_478110.play_attack_defend_n(%struct.State* nonnull %0, i64 %209, %struct.Memory* %call2_4b6429)
  %214 = load i32, i32* %EAX.i35, align 4
  ...
  store i8 0, i8* %38, align 1
  %225 = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 19, i32 0
  %R9B.i14 = bitcast %union.anon* %225 to i8*
  %226 = xor i1 %221, true
  %227 = zext i1 %226 to i8
  store i8 %227, i8* %R9B.i14, align 1
...
block_.L_4b6465:                                  ; preds = %entry.block_.L_4b6465_crit_edge, %block_4b6440
  %AL.i9.pre-phi = phi i8* [ %.pre1, %entry.block_.L_4b6465_crit_edge ], [ %AL.i18, %block_4b6440 ]
  %232 = phi i64 [ %191, %entry.block_.L_4b6465_crit_edge ], [ %.pre, %block_4b6440 ]
  %MEMORY.0 = phi %struct.Memory* [ %call2_4b6429, %entry.block_.L_4b6465_crit_edge ], [ %call2_4b6455, %block_4b6440 ]
  ...
  %238 = and i8 %237, 1
  store i8 %238, i8* %AL.i9.pre-phi, align 1
  %239 = zext i8 %238 to i64
  store i64 %239, i64* %RAX.i66, align 8
  %240 = load i64, i64* %6, align 8
  %241 = add i64 %240, 32
  store i64 %241, i64* %6, align 8
  %242 = icmp ugt i64 %240, -33
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_je_.L_4b6465(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i8* nocapture %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
