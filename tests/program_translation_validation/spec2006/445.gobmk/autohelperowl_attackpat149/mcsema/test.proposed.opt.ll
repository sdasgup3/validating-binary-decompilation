...
define %struct.Memory* @autohelperowl_attackpat149(%struct.State* noalias, i64, %struct.Memory* noalias readnone returned) local_unnamed_addr #1 {
entry:
  ...
  %ECX.i14 = bitcast %union.anon* %30 to i32*
  %31 = load i64, i64* %RBP.i, align 8
  %32 = add i64 %31, -16
  %33 = load i32, i32* %ECX.i14, align 4
  ...
  store i64 %43, i64* %R8.i12, align 8
  %RCX.i9 = getelementptr inbounds %union.anon, %union.anon* %30, i64 0, i32 0
  %44 = shl nsw i64 %43, 2
  ...
  store i64 %49, i64* %RCX.i9, align 8
  %50 = add i64 %37, -8
  %51 = add i64 %39, 15
  ...
  store i64 %55, i64* %RCX.i9, align 8
