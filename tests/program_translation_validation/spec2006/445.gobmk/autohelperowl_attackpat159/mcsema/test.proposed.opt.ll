...
define %struct.Memory* @autohelperowl_attackpat159(%struct.State* noalias, i64, %struct.Memory* noalias readnone returned) local_unnamed_addr #1 {
entry:
  ...
  %call2_4b6617 = tail call %struct.Memory* @sub_44dbb0.owl_eyespace(%struct.State* %0, i64 %73, %struct.Memory* %2)
  ...
  ret %struct.Memory* %call2_4b6617
}
