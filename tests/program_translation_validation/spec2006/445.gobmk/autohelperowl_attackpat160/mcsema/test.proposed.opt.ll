...
define %struct.Memory* @autohelperowl_attackpat160(%struct.State* noalias, i64, %struct.Memory* noalias readnone) local_unnamed_addr #1 {
entry:
  ...
  %call2_4b667a = tail call %struct.Memory* @sub_40f780.countlib(%struct.State* %0, i64 %214, %struct.Memory* %2)
  ...
  br i1 %258, label %block_.L_4b66bb, label %block_4b6691
...
block_4b6691:                                     ; preds = %entry
  ...
  %call2_4b6694 = tail call %struct.Memory* @sub_44de50.owl_proper_eye(%struct.State* nonnull %0, i64 %266, %struct.Memory* %call2_4b667a)
  ...
  %.v = select i1 %288, i64 23, i64 6
  %289 = add i64 %286, %.v
  store i64 %289, i64* %3, align 8
  %cmpBr_4b66a4 = icmp eq i8 %287, 1
...
block_4b66aa:                                     ; preds = %block_4b6691
  ...
  store i64 %295, i64* %RDI.i44, align 8
  %296 = add i64 %289, -428122
  %297 = add i64 %289, 8
  ...
  %call2_4b66ad = tail call %struct.Memory* @sub_44de50.owl_proper_eye(%struct.State* nonnull %0, i64 %296, %struct.Memory* %call2_4b6694)
  %301 = load i32, i32* %EAX.i37, align 4
  ...
  store i8 %313, i8* %CL.i39, align 1
...
block_.L_4b66bb:                                  ; preds = %block_4b66aa, %block_4b6691, %entry
  %318 = phi i64 [ %248, %entry ], [ %289, %block_4b6691 ], [ %.pre, %block_4b66aa ]
  %MEMORY.0 = phi %struct.Memory* [ %call2_4b667a, %entry ], [ %call2_4b6694, %block_4b6691 ], [ %call2_4b66ad, %block_4b66aa ]
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_jg_.L_4b66bb(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i8* nocapture %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_je_.L_4b66bb(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i8* nocapture %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 2, i32 7
