...
define %struct.Memory* @autohelperowl_attackpat162(%struct.State* noalias, i64, %struct.Memory* noalias readnone) local_unnamed_addr #1 {
entry:
  ...
  %call2_4b671a = tail call %struct.Memory* @sub_40f780.countlib(%struct.State* %0, i64 %214, %struct.Memory* %2)
  ...
  br i1 %251, label %block_.L_4b675b, label %block_4b6731
...
block_4b6731:                                     ; preds = %entry
  ...
  %call2_4b6734 = tail call %struct.Memory* @sub_40f780.countlib(%struct.State* nonnull %0, i64 %259, %struct.Memory* %call2_4b671a)
  ...
  br i1 %295, label %block_.L_4b675b, label %block_4b674a
...
block_4b674a:                                     ; preds = %block_4b6731
  ...
  %call2_4b674d = tail call %struct.Memory* @sub_40f780.countlib(%struct.State* nonnull %0, i64 %303, %struct.Memory* %call2_4b6734)
  ...
  %331 = icmp ne i8 %325, 0
  %332 = xor i1 %331, %329
  %333 = or i1 %322, %332
  %334 = zext i1 %333 to i8
  store i8 %334, i8* %CL.i39, align 1
...
block_.L_4b675b:                                  ; preds = %block_4b674a, %block_4b6731, %entry
  %339 = phi i64 [ %248, %entry ], [ %292, %block_4b6731 ], [ %.pre, %block_4b674a ]
  %MEMORY.0 = phi %struct.Memory* [ %call2_4b671a, %entry ], [ %call2_4b6734, %block_4b6731 ], [ %call2_4b674d, %block_4b674a ]
  ...
  store i64 %346, i64* %RAX.i80, align 8
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_jne_.L_4b675b(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i8* nocapture %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
