...
define %struct.Memory* @autohelperowl_attackpat163(%struct.State* noalias, i64, %struct.Memory* noalias readnone) local_unnamed_addr #1 {
entry:
  ...
  %call2_4b67ba = tail call %struct.Memory* @sub_40f780.countlib(%struct.State* %0, i64 %214, %struct.Memory* %2)
  ...
  br i1 %258, label %block_.L_4b67fb, label %block_4b67d1
...
block_4b67d1:                                     ; preds = %entry
  ...
  %call2_4b67d4 = tail call %struct.Memory* @sub_40f780.countlib(%struct.State* nonnull %0, i64 %266, %struct.Memory* %call2_4b67ba)
  ...
  br i1 %302, label %block_.L_4b67fb, label %block_4b67ea
...
block_4b67ea:                                     ; preds = %block_4b67d1
  ...
  store i64 %309, i64* %RDI.i44, align 8
  %310 = add i64 %303, -684138
  %311 = add i64 %303, 8
  ...
  %call2_4b67ed = tail call %struct.Memory* @sub_40f780.countlib(%struct.State* nonnull %0, i64 %310, %struct.Memory* %call2_4b67d4)
  %315 = load i32, i32* %EAX.i37, align 4
  ...
  store i8 %341, i8* %CL.i39, align 1
...
block_.L_4b67fb:                                  ; preds = %block_4b67ea, %block_4b67d1, %entry
  %346 = phi i64 [ %248, %entry ], [ %299, %block_4b67d1 ], [ %.pre, %block_4b67ea ]
  %MEMORY.0 = phi %struct.Memory* [ %call2_4b67ba, %entry ], [ %call2_4b67d4, %block_4b67d1 ], [ %call2_4b67ed, %block_4b67ea ]
  ...
  store i64 %353, i64* %RAX.i80, align 8
  %354 = load i64, i64* %6, align 8
  %355 = add i64 %354, 32
  store i64 %355, i64* %6, align 8
  %356 = icmp ugt i64 %354, -33
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_jg_.L_4b67fb(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i8* nocapture %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_jne_.L_4b67fb(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i8* nocapture %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 2, i32 7
