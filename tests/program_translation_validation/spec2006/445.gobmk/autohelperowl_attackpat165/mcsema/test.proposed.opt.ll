...
define %struct.Memory* @autohelperowl_attackpat165(%struct.State* noalias, i64, %struct.Memory* noalias readnone) local_unnamed_addr #1 {
entry:
  ...
  %call2_4b6849 = tail call %struct.Memory* @sub_40f780.countlib(%struct.State* %0, i64 %167, %struct.Memory* %2)
  ...
  br i1 %204, label %block_.L_4b6871, label %block_4b6860
...
block_4b6860:                                     ; preds = %entry
  ...
  %call2_4b6863 = tail call %struct.Memory* @sub_40f780.countlib(%struct.State* nonnull %0, i64 %212, %struct.Memory* %call2_4b6849)
...
block_.L_4b6871:                                  ; preds = %block_4b6860, %entry
  %248 = phi i64 [ %201, %entry ], [ %.pre, %block_4b6860 ]
  %MEMORY.0 = phi %struct.Memory* [ %call2_4b6849, %entry ], [ %call2_4b6863, %block_4b6860 ]
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_jne_.L_4b6871(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i8* nocapture %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
