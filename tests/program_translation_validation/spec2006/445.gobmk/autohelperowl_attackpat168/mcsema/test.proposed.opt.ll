...
define %struct.Memory* @autohelperowl_attackpat168(%struct.State* noalias, i64, %struct.Memory* noalias readnone returned) local_unnamed_addr #1 {
entry:
  ...
  %ESI.i = bitcast %union.anon* %27 to i32*
  %28 = load i64, i64* %RBP.i, align 8
  %29 = add i64 %28, -8
  %30 = load i32, i32* %ESI.i, align 4
  ...
  %EDX.i = bitcast %union.anon* %34 to i32*
  %35 = load i64, i64* %RBP.i, align 8
  %36 = add i64 %35, -12
  %37 = load i32, i32* %EDX.i, align 4
  ...
  %ECX.i32 = bitcast %union.anon* %41 to i32*
  %42 = load i64, i64* %RBP.i, align 8
  %43 = add i64 %42, -16
  %44 = load i32, i32* %ECX.i32, align 4
  ...
  store i64 %54, i64* %R10.i30, align 8
  %RCX.i27 = getelementptr inbounds %union.anon, %union.anon* %41, i64 0, i32 0
  %55 = shl nsw i64 %54, 2
  %56 = add nsw i64 %55, 11904784
  %57 = add i64 %50, 12
  store i64 %57, i64* %3, align 8
  %58 = inttoptr i64 %56 to i32*
  %59 = load i32, i32* %58, align 4
  %60 = zext i32 %59 to i64
  store i64 %60, i64* %RCX.i27, align 8
  %61 = add i64 %48, -8
  %62 = add i64 %50, 15
  ...
  %RDI.i = getelementptr inbounds %union.anon, %union.anon* %22, i64 0, i32 0
  ...
  %102 = load i32, i32* %R8D.i45, align 4
  %103 = add i64 %95, -12
  %104 = add i64 %97, 7
  ...
  %RSI.i = getelementptr inbounds %union.anon, %union.anon* %27, i64 0, i32 0
  store i64 %108, i64* %RSI.i, align 8
  %EAX.i14 = bitcast %union.anon* %18 to i32*
  %RDX.i = getelementptr inbounds %union.anon, %union.anon* %34, i64 0, i32 0
  %132 = load i32, i32* %EAX.i14, align 4
  %133 = zext i32 %132 to i64
  store i64 %133, i64* %RDX.i, align 8
  %134 = load i64, i64* %21, align 8
  store i64 %134, i64* %RCX.i27, align 8
  %135 = add i64 %97, -673975
  %136 = add i64 %97, 20
  ...
  %call2_4b6946 = tail call %struct.Memory* @sub_412080.accuratelib(%struct.State* %0, i64 %135, %struct.Memory* %2)
  %140 = load i32, i32* %EAX.i14, align 4
  %141 = load i64, i64* %3, align 8
  %142 = icmp eq i32 %140, 2
  %143 = zext i1 %142 to i8
  %144 = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 23, i32 0
  %R11B.i9 = bitcast %union.anon* %144 to i8*
  store i8 %143, i8* %R11B.i9, align 1
  ...
  ret %struct.Memory* %call2_4b6946
}
