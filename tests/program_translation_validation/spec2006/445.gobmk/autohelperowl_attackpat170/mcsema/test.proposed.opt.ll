...
define %struct.Memory* @autohelperowl_attackpat170(%struct.State* noalias, i64, %struct.Memory* noalias readnone returned) local_unnamed_addr #1 {
entry:
  ...
  %call2_4b6993 = tail call %struct.Memory* @sub_445d10.obvious_false_eye(%struct.State* %0, i64 %151, %struct.Memory* %2)
  ...
  ret %struct.Memory* %call2_4b6993
}
