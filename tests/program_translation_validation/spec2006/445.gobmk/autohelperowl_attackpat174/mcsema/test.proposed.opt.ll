...
define %struct.Memory* @autohelperowl_attackpat174(%struct.State* noalias, i64, %struct.Memory* noalias readnone returned) local_unnamed_addr #1 {
entry:
  ...
  %ECX.i29 = bitcast %union.anon* %58 to i32*
  %59 = load i64, i64* %RBP.i, align 8
  %60 = add i64 %59, -16
  %61 = load i32, i32* %ECX.i29, align 4
  ...
  %RAX.i26 = getelementptr inbounds %union.anon, %union.anon* %65, i64 0, i32 0
  ...
  store i64 %72, i64* %RAX.i26, align 8
  %RCX.i24 = getelementptr inbounds %union.anon, %union.anon* %58, i64 0, i32 0
  %73 = shl nsw i64 %72, 2
  ...
  store i64 %78, i64* %RCX.i24, align 8
  %79 = add i64 %66, -8
  %80 = add i64 %68, 14
  ...
  store i64 %84, i64* %RCX.i24, align 8
  ...
  %call2_4b6abb = tail call %struct.Memory* @sub_46bc30.safe_move(%struct.State* %0, i64 %125, %struct.Memory* %2)
  %EAX.i = bitcast %union.anon* %65 to i32*
  %130 = load i32, i32* %EAX.i, align 4
  %131 = load i64, i64* %3, align 8
  %132 = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 17, i32 0
  %R8B.i11 = bitcast %union.anon* %132 to i8*
  %133 = icmp eq i32 %130, 0
  %134 = zext i1 %133 to i8
  store i8 %134, i8* %R8B.i11, align 1
  %135 = zext i1 %133 to i64
  store i64 %135, i64* %RAX.i26, align 8
  ...
  ret %struct.Memory* %call2_4b6abb
}
