...
define %struct.Memory* @autohelperowl_attackpat180(%struct.State* noalias, i64, %struct.Memory* noalias readnone returned) local_unnamed_addr #1 {
entry:
  ...
  %ECX.i38 = bitcast %union.anon* %59 to i32*
  %60 = load i64, i64* %RBP.i, align 8
  %61 = add i64 %60, -16
  %62 = load i32, i32* %ECX.i38, align 4
  ...
  store i64 %72, i64* %R8.i36, align 8
  %RCX.i33 = getelementptr inbounds %union.anon, %union.anon* %59, i64 0, i32 0
  %73 = shl nsw i64 %72, 2
  ...
  store i64 %78, i64* %RCX.i33, align 8
  %79 = add i64 %66, -8
  %80 = add i64 %68, 15
  ...
  store i64 %84, i64* %RCX.i33, align 8
  ...
  store i64 %124, i64* %RCX.i33, align 8
  %125 = add i64 %115, 10
  store i64 %125, i64* %3, align 8
  %126 = load i32, i32* %122, align 4
  %127 = zext i32 %126 to i64
  store i64 %127, i64* %R8.i36, align 8
  ...
  %134 = load i32, i32* %EAX.i18, align 4
  ...
  %call2_4b6c3f = tail call %struct.Memory* @sub_4784b0.play_attack_defend2_n(%struct.State* %0, i64 %136, %struct.Memory* %2)
  %141 = load i32, i32* %EAX.i18, align 4
  %142 = load i64, i64* %3, align 8
  %143 = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 21, i32 0
  %R10B.i11 = bitcast %union.anon* %143 to i8*
  %144 = icmp eq i32 %141, 0
  %145 = zext i1 %144 to i8
  store i8 %145, i8* %R10B.i11, align 1
  %146 = zext i1 %144 to i64
  store i64 %146, i64* %RAX.i47, align 8
  %147 = load i64, i64* %6, align 8
  %148 = add i64 %147, 32
  store i64 %148, i64* %6, align 8
  %149 = icmp ugt i64 %147, -33
  ...
  ret %struct.Memory* %call2_4b6c3f
}
