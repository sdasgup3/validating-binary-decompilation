...
define %struct.Memory* @autohelperowl_attackpat181(%struct.State* noalias, i64, %struct.Memory* noalias readnone) local_unnamed_addr #1 {
entry:
  ...
  %ECX.i112 = bitcast %union.anon* %59 to i32*
  %60 = load i64, i64* %RBP.i, align 8
  %61 = add i64 %60, -16
  %62 = load i32, i32* %ECX.i112, align 4
  ...
  %RAX.i109 = getelementptr inbounds %union.anon, %union.anon* %66, i64 0, i32 0
  ...
  store i64 %73, i64* %RAX.i109, align 8
  ...
  store i64 %79, i64* %RCX.i107, align 8
  %80 = add i64 %67, -8
  %81 = add i64 %69, 14
  ...
  store i64 %120, i64* %RAX.i109, align 8
  ...
  store i64 %126, i64* %RCX.i107, align 8
  %127 = add i64 %114, -8
  %128 = add i64 %116, 14
  ...
  store i64 %167, i64* %RDI.i85, align 8
  %RSI.i82 = getelementptr inbounds %union.anon, %union.anon* %45, i64 0, i32 0
  %168 = add i64 %161, -12
  %169 = add i64 %163, 6
  ...
  br i1 %198, label %entry.block_.L_4b6d20_crit_edge, label %block_4b6cb3

entry.block_.L_4b6d20_crit_edge:                  ; preds = %entry
  %.pre2 = bitcast %union.anon* %66 to i8*
  br label %block_.L_4b6d20

block_4b6cb3:                                     ; preds = %entry
  store i64 1, i64* %RSI.i82, align 8
  %RDX.i66 = getelementptr inbounds %union.anon, %union.anon* %52, i64 0, i32 0
  ...
  store i64 %206, i64* %RDI.i85, align 8
  %207 = add i64 %201, -8
  %208 = add i64 %199, 19
  ...
  %R10D.i49 = bitcast %union.anon* %221 to i32*
  ...
  %call2_4b6cdb = tail call %struct.Memory* @sub_4784b0.play_attack_defend2_n(%struct.State* nonnull %0, i64 %238, %struct.Memory* %call2_4b6c9c)
  %243 = load i64, i64* %3, align 8
  store i64 0, i64* %RCX.i107, align 8
  %244 = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 23, i32 0
  %R11B.i37 = bitcast %union.anon* %244 to i8*
  store i8 0, i8* %R11B.i37, align 1
  %245 = load i32, i32* %EAX.i73, align 4
  store i8 0, i8* %14, align 1
  %246 = and i32 %245, 255
  ...
  %264 = select i1 %263, i64 %260, i64 %261
  store i64 %264, i64* %3, align 8
  br i1 %263, label %block_.L_4b6d20, label %block_4b6cf2
...
block_4b6cf2:                                     ; preds = %block_4b6cb3
  ...
  store i64 %270, i64* %RDI.i85, align 8
  %271 = add i64 %265, -8
  %272 = add i64 %264, 16
  ...
  store i64 %275, i64* %RCX.i107, align 8
  %276 = add i64 %265, -20
  %277 = add i64 %264, 20
  ...
  %call2_4b6d0c = tail call %struct.Memory* @sub_478110.play_attack_defend_n(%struct.State* nonnull %0, i64 %284, %struct.Memory* %call2_4b6cdb)
  %289 = load i32, i32* %EAX.i73, align 4
  %290 = load i64, i64* %3, align 8
  %R10B.i16 = bitcast %union.anon* %221 to i8*
...
block_.L_4b6d20:                                  ; preds = %entry.block_.L_4b6d20_crit_edge, %block_4b6cf2, %block_4b6cb3
  %AL.i9.pre-phi = phi i8* [ %.pre2, %entry.block_.L_4b6d20_crit_edge ], [ %AL.i42, %block_4b6cf2 ], [ %AL.i42, %block_4b6cb3 ]
  %304 = phi i64 [ %195, %entry.block_.L_4b6d20_crit_edge ], [ %.pre, %block_4b6cf2 ], [ %260, %block_4b6cb3 ]
  %MEMORY.0 = phi %struct.Memory* [ %call2_4b6c9c, %entry.block_.L_4b6d20_crit_edge ], [ %call2_4b6d0c, %block_4b6cf2 ], [ %call2_4b6cdb, %block_4b6cb3 ]
  ...
  %310 = and i8 %309, 1
  store i8 %310, i8* %AL.i9.pre-phi, align 1
  %311 = zext i8 %310 to i64
  store i64 %311, i64* %RAX.i109, align 8
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_jne_.L_4b6d20(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i8* nocapture %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
