...
define %struct.Memory* @autohelperowl_attackpat184(%struct.State* noalias, i64, %struct.Memory* noalias readnone) local_unnamed_addr #1 {
entry:
  ...
  %call2_4b6eca = tail call %struct.Memory* @sub_44da20.owl_escape_value(%struct.State* %0, i64 %215, %struct.Memory* %2)
  ...
  br i1 %246, label %entry.block_.L_4b6f1e_crit_edge, label %block_4b6ee1

entry.block_.L_4b6f1e_crit_edge:                  ; preds = %entry
...
block_4b6ee1:                                     ; preds = %entry
  ...
  %call2_4b6f0e = tail call %struct.Memory* @sub_4784b0.play_attack_defend2_n(%struct.State* nonnull %0, i64 %309, %struct.Memory* %call2_4b6eca)
...
block_.L_4b6f1e:                                  ; preds = %entry.block_.L_4b6f1e_crit_edge, %block_4b6ee1
  %AL.i9.pre-phi = phi i8* [ %.pre1, %entry.block_.L_4b6f1e_crit_edge ], [ %AL.i18, %block_4b6ee1 ]
  %332 = phi i64 [ %237, %entry.block_.L_4b6f1e_crit_edge ], [ %.pre, %block_4b6ee1 ]
  %MEMORY.0 = phi %struct.Memory* [ %call2_4b6eca, %entry.block_.L_4b6f1e_crit_edge ], [ %call2_4b6f0e, %block_4b6ee1 ]
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_jle_.L_4b6f1e(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i8* nocapture %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
