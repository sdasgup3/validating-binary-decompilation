...
define %struct.Memory* @autohelperowl_attackpat191(%struct.State* noalias, i64, %struct.Memory* noalias readnone) local_unnamed_addr #1 {
entry:
  ...
  %ECX.i53 = bitcast %union.anon* %58 to i32*
  %59 = load i64, i64* %RBP.i, align 8
  %60 = add i64 %59, -16
  %61 = load i32, i32* %ECX.i53, align 4
  ...
  %RAX.i50 = getelementptr inbounds %union.anon, %union.anon* %65, i64 0, i32 0
  ...
  store i64 %72, i64* %RAX.i50, align 8
  ...
  store i64 %78, i64* %RCX.i48, align 8
  %79 = add i64 %66, -8
  %80 = add i64 %68, 14
  ...
  store i64 %84, i64* %RCX.i48, align 8
  ...
  store i64 %119, i64* %RAX.i50, align 8
  ...
  store i64 %125, i64* %RCX.i48, align 8
  %126 = add i64 %113, -8
  %127 = add i64 %115, 14
  ...
  store i64 %131, i64* %RCX.i48, align 8
  ...
  %RDI.i28 = getelementptr inbounds %union.anon, %union.anon* %39, i64 0, i32 0
  ...
  %call2_4b71b9 = tail call %struct.Memory* @sub_44da20.owl_escape_value(%struct.State* %0, i64 %167, %struct.Memory* %2)
  %172 = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 17, i32 0
  %R8B.i25 = bitcast %union.anon* %172 to i8*
  ...
  %193 = load i8, i8* %32, align 1
  %194 = icmp ne i8 %193, 0
  %195 = load i8, i8* %38, align 1
  %196 = icmp ne i8 %195, 0
  %197 = xor i1 %194, %196
  %198 = xor i1 %197, true
  %199 = and i1 %192, %198
  %200 = select i1 %199, i64 %189, i64 %190
  store i64 %200, i64* %3, align 8
  br i1 %199, label %block_.L_4b71df, label %block_4b71ce

block_4b71ce:                                     ; preds = %entry
  ...
  store i64 %206, i64* %RDI.i28, align 8
  %207 = add i64 %200, -432046
  %208 = add i64 %200, 8
  ...
  %call2_4b71d1 = tail call %struct.Memory* @sub_44da20.owl_escape_value(%struct.State* nonnull %0, i64 %207, %struct.Memory* %call2_4b71b9)
  %212 = load i32, i32* %EAX.i23, align 4
  ...
  store i8 0, i8* %38, align 1
  %CL.i14 = bitcast %union.anon* %58 to i8*
  %223 = xor i1 %219, true
  %224 = icmp eq i8 %222, 0
  %225 = and i1 %224, %223
  %226 = zext i1 %225 to i8
  store i8 %226, i8* %CL.i14, align 1
  ...
  br label %block_.L_4b71df

block_.L_4b71df:                                  ; preds = %block_4b71ce, %entry
  %231 = phi i64 [ %189, %entry ], [ %.pre, %block_4b71ce ]
  %MEMORY.0 = phi %struct.Memory* [ %call2_4b71b9, %entry ], [ %call2_4b71d1, %block_4b71ce ]
  ...
  store i64 %238, i64* %RAX.i50, align 8
  ...
  store i64 %265, i64* %RBP.i, align 8
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_jg_.L_4b71df(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i8* nocapture %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
