...
define %struct.Memory* @autohelperowl_attackpat192(%struct.State* noalias, i64, %struct.Memory* noalias readnone) local_unnamed_addr #1 {
entry:
  ...
  %ECX.i59 = bitcast %union.anon* %58 to i32*
  %59 = load i64, i64* %RBP.i, align 8
  %60 = add i64 %59, -16
  %61 = load i32, i32* %ECX.i59, align 4
  ...
  %RAX.i56 = getelementptr inbounds %union.anon, %union.anon* %65, i64 0, i32 0
  ...
  store i64 %72, i64* %RAX.i56, align 8
  %RCX.i54 = getelementptr inbounds %union.anon, %union.anon* %58, i64 0, i32 0
  %73 = shl nsw i64 %72, 2
  ...
  store i64 %78, i64* %RCX.i54, align 8
  %79 = add i64 %66, -8
  %80 = add i64 %68, 14
  ...
  store i64 %84, i64* %RCX.i54, align 8
  ...
  store i64 %125, i64* %RCX.i54, align 8
  %126 = add i64 %113, -8
  %127 = add i64 %115, 14
  ...
  store i64 %131, i64* %RCX.i54, align 8
  ...
  store i64 %166, i64* %RDI.i32, align 8
  ...
  %call2_4b722c = tail call %struct.Memory* @sub_46bc30.safe_move(%struct.State* %0, i64 %172, %struct.Memory* %2)
  %177 = load i64, i64* %3, align 8
  store i64 0, i64* %RCX.i54, align 8
  %178 = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 17, i32 0
  %R8B.i26 = bitcast %union.anon* %178 to i8*
  store i8 0, i8* %R8B.i26, align 1
  %EAX.i23 = bitcast %union.anon* %65 to i32*
  %179 = load i32, i32* %EAX.i23, align 4
  ...
  br i1 %197, label %block_.L_4b7254, label %block_4b7243

block_4b7243:                                     ; preds = %entry
  ...
  store i64 %204, i64* %RDI.i32, align 8
  %205 = add i64 %198, -686787
  %206 = add i64 %198, 8
  ...
  %call2_4b7246 = tail call %struct.Memory* @sub_40f780.countlib(%struct.State* nonnull %0, i64 %205, %struct.Memory* %call2_4b722c)
  %210 = load i32, i32* %EAX.i23, align 4
  ...
  %235 = xor i1 %.demorgan, true
  %236 = zext i1 %235 to i8
  store i8 %236, i8* %CL.i25, align 1
...
block_.L_4b7254:                                  ; preds = %block_4b7243, %entry
  %241 = phi i64 [ %194, %entry ], [ %.pre, %block_4b7243 ]
  %MEMORY.0 = phi %struct.Memory* [ %call2_4b722c, %entry ], [ %call2_4b7246, %block_4b7243 ]
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_jne_.L_4b7254(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i8* nocapture %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
