...
define %struct.Memory* @autohelperowl_attackpat196(%struct.State* noalias, i64, %struct.Memory* noalias readnone) local_unnamed_addr #1 {
entry:
  ...
  %call2_4b755d = tail call %struct.Memory* @sub_44da20.owl_escape_value(%struct.State* %0, i64 %315, %struct.Memory* %2)
  ...
  br i1 %333, label %block_.L_4b7584, label %block_4b756b
...
block_4b756b:                                     ; preds = %entry
  ...
  %call2_4b756e = tail call %struct.Memory* @sub_44da20.owl_escape_value(%struct.State* nonnull %0, i64 %341, %struct.Memory* %call2_4b755d)
  ...
  br i1 %371, label %block_4b756b.block_.L_4b75c1_crit_edge, label %block_.L_4b7584

block_4b756b.block_.L_4b75c1_crit_edge:           ; preds = %block_4b756b
  %.pre2 = bitcast %union.anon* %72 to i8*
  br label %block_.L_4b75c1

block_.L_4b7584:                                  ; preds = %block_4b756b, %entry
  %373 = phi i64 [ %334, %entry ], [ %363, %block_4b756b ]
  %MEMORY.0 = phi %struct.Memory* [ %call2_4b755d, %entry ], [ %call2_4b756e, %block_4b756b ]
  ...
  %call2_4b75b3 = tail call %struct.Memory* @sub_4784b0.play_attack_defend2_n(%struct.State* nonnull %0, i64 %428, %struct.Memory* %MEMORY.0)
...
block_.L_4b75c1:                                  ; preds = %block_4b756b.block_.L_4b75c1_crit_edge, %block_.L_4b7584
  %AL.i10.pre-phi = phi i8* [ %.pre2, %block_4b756b.block_.L_4b75c1_crit_edge ], [ %AL.i19, %block_.L_4b7584 ]
  %450 = phi i64 [ %362, %block_4b756b.block_.L_4b75c1_crit_edge ], [ %.pre, %block_.L_4b7584 ]
  %MEMORY.1 = phi %struct.Memory* [ %call2_4b756e, %block_4b756b.block_.L_4b75c1_crit_edge ], [ %call2_4b75b3, %block_.L_4b7584 ]
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_jg_.L_4b7584(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i8* nocapture %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_jle_.L_4b75c1(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i8* nocapture %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 2, i32 7
