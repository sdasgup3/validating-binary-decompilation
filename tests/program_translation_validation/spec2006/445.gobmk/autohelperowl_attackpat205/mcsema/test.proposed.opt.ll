...
define %struct.Memory* @autohelperowl_attackpat205(%struct.State* noalias, i64, %struct.Memory* noalias readnone) local_unnamed_addr #1 {
entry:
  ...
  %RDI.i72 = getelementptr inbounds %union.anon, %union.anon* %40, i64 0, i32 0
  ...
  store i64 %214, i64* %RDI.i72, align 8
  %215 = add i64 %210, -689991
  %216 = add i64 %210, 8
  ...
  br i1 %259, label %block_.L_4b7f35, label %block_4b7ee1

block_4b7ee1:                                     ; preds = %entry
  %CL.i66 = bitcast %union.anon* %59 to i8*
  ...
  %call2_4b7ee4 = tail call %struct.Memory* @sub_40f780.countlib(%struct.State* nonnull %0, i64 %267, %struct.Memory* %call2_4b7eca)
  %272 = load i64, i64* %3, align 8
  store i64 0, i64* %RDI.i72, align 8
  store i8 0, i8* %CL.i66, align 1
  %273 = load i32, i32* %EAX.i64, align 4
  %274 = add i32 %273, -4
  %275 = icmp ult i32 %273, 4
  ...
  %309 = xor i1 %308, true
  %310 = and i1 %303, %309
  %311 = select i1 %310, i64 %300, i64 %301
  store i64 %311, i64* %3, align 8
  br i1 %310, label %block_.L_4b7f35, label %block_4b7efa
...
block_4b7efa:                                     ; preds = %block_4b7ee1
  ...
  store i64 3, i64* %RAX.i108, align 8
  ...
  store i64 %318, i64* %RAX.i108, align 8
  ...
  store i64 %347, i64* %RCX.i106, align 8
  %348 = getelementptr inbounds %union.anon, %union.anon* %221, i64 0, i32 0
  %349 = add i64 %312, -24
  %350 = add i64 %311, 23
  ...
  %365 = load i32, i32* %EAX.i64, align 4
  %366 = zext i32 %365 to i64
  %367 = load i64, i64* %3, align 8
  store i64 %366, i64* %RDI.i72, align 8
  ...
  %call2_4b7f25 = tail call %struct.Memory* @sub_477ce0.play_break_through_n(%struct.State* nonnull %0, i64 %378, %struct.Memory* %call2_4b7ee4)
  %383 = load i32, i32* %EAX.i64, align 4
  %384 = load i64, i64* %3, align 8
  %385 = add i32 %383, -5
  %386 = icmp ult i32 %383, 5
  ...
  %406 = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 21, i32 0
  %R10B.i14 = bitcast %union.anon* %406 to i8*
  store i8 %398, i8* %R10B.i14, align 1
...
block_.L_4b7f35:                                  ; preds = %block_4b7efa, %block_4b7ee1, %entry
  %411 = phi i64 [ %249, %entry ], [ %300, %block_4b7ee1 ], [ %.pre, %block_4b7efa ]
  %MEMORY.0 = phi %struct.Memory* [ %call2_4b7eca, %entry ], [ %call2_4b7ee4, %block_4b7ee1 ], [ %call2_4b7f25, %block_4b7efa ]
  ...
  store i64 %418, i64* %RAX.i108, align 8
  %419 = load i64, i64* %6, align 8
  %420 = add i64 %419, 48
  store i64 %420, i64* %6, align 8
  %421 = icmp ugt i64 %419, -49
  ...
  %444 = add i64 %419, 56
  %445 = inttoptr i64 %420 to i64*
  %446 = load i64, i64* %445, align 8
  store i64 %446, i64* %RBP.i, align 8
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_jg_.L_4b7f35(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i8* nocapture %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
