...
define %struct.Memory* @autohelperowl_attackpat213(%struct.State* noalias, i64, %struct.Memory* noalias readnone) local_unnamed_addr #1 {
entry:
  ...
  %call2_4b859a = tail call %struct.Memory* @sub_40f780.countlib(%struct.State* %0, i64 %214, %struct.Memory* %2)
  ...
  br i1 %257, label %block_.L_4b8646, label %block_4b85b1
...
block_4b85b1:                                     ; preds = %entry
  ...
  %call2_4b85b4 = tail call %struct.Memory* @sub_44d9f0.vital_chain(%struct.State* nonnull %0, i64 %265, %struct.Memory* %call2_4b859a)
...
block_4b85ca:                                     ; preds = %block_4b85b1
  ...
  %call2_4b85cd = tail call %struct.Memory* @sub_44d9f0.vital_chain(%struct.State* nonnull %0, i64 %295, %struct.Memory* %call2_4b85b4)
...
block_4b85e3:                                     ; preds = %block_4b85ca
  ...
  %call2_4b85fd = tail call %struct.Memory* @sub_478110.play_attack_defend_n(%struct.State* nonnull %0, i64 %340, %struct.Memory* %call2_4b85cd)
...
block_4b8614:                                     ; preds = %block_4b85e3
  ...
  %call2_4b8632 = tail call %struct.Memory* @sub_4784b0.play_attack_defend2_n(%struct.State* nonnull %0, i64 %406, %struct.Memory* %call2_4b85fd)
...
block_.L_4b8646:                                  ; preds = %block_4b8614, %block_4b85e3, %block_4b85ca, %block_4b85b1, %entry
  %426 = phi i64 [ %248, %entry ], [ %288, %block_4b85b1 ], [ %318, %block_4b85ca ], [ %364, %block_4b85e3 ], [ %.pre, %block_4b8614 ]
  %MEMORY.0 = phi %struct.Memory* [ %call2_4b859a, %entry ], [ %call2_4b85b4, %block_4b85b1 ], [ %call2_4b85cd, %block_4b85ca ], [ %call2_4b85fd, %block_4b85e3 ], [ %call2_4b8632, %block_4b8614 ]
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_jle_.L_4b8646(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i8* nocapture %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_je_.L_4b8646(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i8* nocapture %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 2, i32 7
