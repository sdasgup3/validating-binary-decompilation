...
define %struct.Memory* @autohelperowl_attackpat214(%struct.State* noalias, i64, %struct.Memory* noalias readnone) local_unnamed_addr #1 {
entry:
  ...
  %call2_4b8699 = tail call %struct.Memory* @sub_44da20.owl_escape_value(%struct.State* %0, i64 %167, %struct.Memory* %2)
  %172 = load i64, i64* %3, align 8
  store i64 0, i64* %RCX.i54, align 8
  %173 = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 17, i32 0
  %R8B.i28 = bitcast %union.anon* %173 to i8*
  ...
  br i1 %198, label %block_.L_4b86c4, label %block_4b86b0

block_4b86b0:                                     ; preds = %entry
  ...
  store i64 %205, i64* %RDI.i32, align 8
  ...
  %call2_4b86b6 = tail call %struct.Memory* @sub_477550.does_defend(%struct.State* nonnull %0, i64 %211, %struct.Memory* %call2_4b8699)
  %216 = load i32, i32* %EAX.i25, align 4
  ...
  store i8 %228, i8* %CL.i27, align 1
...
block_.L_4b86c4:                                  ; preds = %block_4b86b0, %entry
  %233 = phi i64 [ %189, %entry ], [ %.pre, %block_4b86b0 ]
  %MEMORY.0 = phi %struct.Memory* [ %call2_4b8699, %entry ], [ %call2_4b86b6, %block_4b86b0 ]
  ...
  store i64 %240, i64* %RAX.i56, align 8
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_jle_.L_4b86c4(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i8* nocapture %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
