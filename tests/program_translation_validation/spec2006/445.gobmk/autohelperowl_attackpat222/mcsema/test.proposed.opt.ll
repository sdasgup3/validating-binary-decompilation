...
define %struct.Memory* @autohelperowl_attackpat222(%struct.State* noalias, i64, %struct.Memory* noalias readnone) local_unnamed_addr #1 {
entry:
  ...
  %ESI.i117 = bitcast %union.anon* %45 to i32*
  %46 = load i64, i64* %RBP.i, align 8
  %47 = add i64 %46, -8
  %48 = load i32, i32* %ESI.i117, align 4
  ...
  store i64 %167, i64* %RAX.i109, align 8
  ...
  store i64 %214, i64* %RAX.i109, align 8
  ...
  store i64 %220, i64* %RCX.i107, align 8
  %221 = add i64 %208, -8
  %222 = add i64 %210, 14
  ...
  store i64 %261, i64* %RDI.i61, align 8
  %262 = add i64 %257, -438088
  %263 = add i64 %257, 8
  ...
  %call2_4b896b = tail call %struct.Memory* @sub_44da20.owl_escape_value(%struct.State* %0, i64 %262, %struct.Memory* %2)
  ...
  br i1 %293, label %block_.L_4b89cd, label %block_4b8982
...
block_4b8982:                                     ; preds = %entry
  ...
  %call2_4b8985 = tail call %struct.Memory* @sub_44db80.owl_goal_dragon(%struct.State* nonnull %0, i64 %301, %struct.Memory* %call2_4b896b)
  %306 = load i64, i64* %3, align 8
  store i64 0, i64* %RDI.i61, align 8
  store i8 0, i8* %CL.i55, align 1
  %307 = load i32, i32* %EAX.i53, align 4
  store i8 0, i8* %14, align 1
  %308 = and i32 %307, 255
  ...
  %.v = select i1 %323, i64 56, i64 6
  %324 = add i64 %321, %.v
  store i64 %324, i64* %3, align 8
  %cmpBr_4b8995 = icmp eq i8 %322, 1
...
block_4b899b:                                     ; preds = %block_4b8982
  ...
  store i64 %331, i64* %RAX.i109, align 8
  ...
  store i64 %355, i64* %RCX.i107, align 8
  %356 = getelementptr inbounds %union.anon, %union.anon* %268, i64 0, i32 0
  %357 = add i64 %325, -20
  %358 = add i64 %324, 22
  ...
  %call2_4b89b9 = tail call %struct.Memory* @sub_4784b0.play_attack_defend2_n(%struct.State* nonnull %0, i64 %368, %struct.Memory* %call2_4b8985)
  %373 = load i32, i32* %EAX.i53, align 4
  %374 = load i64, i64* %3, align 8
  %375 = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 21, i32 0
  %R10B.i16 = bitcast %union.anon* %375 to i8*
  %376 = icmp ne i32 %373, 0
  %377 = zext i1 %376 to i64
  %378 = xor i64 %377, 255
  %379 = trunc i64 %378 to i8
  store i8 %379, i8* %R10B.i16, align 1
  store i8 0, i8* %14, align 1
...
block_.L_4b89cd:                                  ; preds = %block_4b899b, %block_4b8982, %entry
  %389 = phi i64 [ %284, %entry ], [ %324, %block_4b8982 ], [ %.pre, %block_4b899b ]
  %MEMORY.0 = phi %struct.Memory* [ %call2_4b896b, %entry ], [ %call2_4b8985, %block_4b8982 ], [ %call2_4b89b9, %block_4b899b ]
  ...
  store i64 %396, i64* %RAX.i109, align 8
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_jle_.L_4b89cd(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i8* nocapture %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_je_.L_4b89cd(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i8* nocapture %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 2, i32 7
