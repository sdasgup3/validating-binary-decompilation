...
define %struct.Memory* @autohelperowl_attackpat227(%struct.State* noalias, i64, %struct.Memory* noalias readnone) local_unnamed_addr #1 {
entry:
  ...
  %call2_4b8d4d = tail call %struct.Memory* @sub_4153e0.same_string(%struct.State* %0, i64 %219, %struct.Memory* %2)
  ...
  br i1 %244, label %entry.block_.L_4b8da7_crit_edge, label %block_4b8d64

entry.block_.L_4b8da7_crit_edge:                  ; preds = %entry
...
block_4b8d64:                                     ; preds = %entry
  ...
  %call2_4b8d67 = tail call %struct.Memory* @sub_40f780.countlib(%struct.State* nonnull %0, i64 %252, %struct.Memory* %call2_4b8d4d)
  ...
  br i1 %294, label %block_.L_4b8da1, label %block_4b8d7a
...
block_4b8d7a:                                     ; preds = %block_4b8d64
  ...
  %call2_4b8d7d = tail call %struct.Memory* @sub_40f780.countlib(%struct.State* nonnull %0, i64 %302, %struct.Memory* %call2_4b8d67)
  ...
  br i1 %344, label %block_.L_4b8da1, label %block_4b8d90
...
block_4b8d90:                                     ; preds = %block_4b8d7a
  ...
  %call2_4b8d93 = tail call %struct.Memory* @sub_40f780.countlib(%struct.State* nonnull %0, i64 %352, %struct.Memory* %call2_4b8d7d)
...
block_.L_4b8da1:                                  ; preds = %block_4b8d90, %block_4b8d7a, %block_4b8d64
  %388 = phi i64 [ %285, %block_4b8d64 ], [ %335, %block_4b8d7a ], [ %.pre, %block_4b8d90 ]
  %MEMORY.0 = phi %struct.Memory* [ %call2_4b8d67, %block_4b8d64 ], [ %call2_4b8d7d, %block_4b8d7a ], [ %call2_4b8d93, %block_4b8d90 ]
...
block_.L_4b8da7:                                  ; preds = %entry.block_.L_4b8da7_crit_edge, %block_.L_4b8da1
  %AL.i9.pre-phi = phi i8* [ %.pre4, %entry.block_.L_4b8da7_crit_edge ], [ %AL.i15, %block_.L_4b8da1 ]
  %397 = phi i64 [ %241, %entry.block_.L_4b8da7_crit_edge ], [ %.pre3, %block_.L_4b8da1 ]
  %MEMORY.1 = phi %struct.Memory* [ %call2_4b8d4d, %entry.block_.L_4b8da7_crit_edge ], [ %MEMORY.0, %block_.L_4b8da1 ]
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_jne_.L_4b8da7(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i8* nocapture %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_jle_.L_4b8da1(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i8* nocapture %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 2, i32 7
