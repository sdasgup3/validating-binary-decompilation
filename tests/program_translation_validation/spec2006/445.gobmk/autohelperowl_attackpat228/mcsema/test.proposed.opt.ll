...
define %struct.Memory* @autohelperowl_attackpat228(%struct.State* noalias, i64, %struct.Memory* noalias readnone) local_unnamed_addr #1 {
entry:
  ...
  %call2_4b8dfc = tail call %struct.Memory* @sub_41fc30.is_same_dragon(%struct.State* %0, i64 %172, %struct.Memory* %2)
  ...
  br i1 %197, label %entry.block_.L_4b8e40_crit_edge, label %block_4b8e13

entry.block_.L_4b8e40_crit_edge:                  ; preds = %entry
...
block_4b8e13:                                     ; preds = %entry
  ...
  %call2_4b8e2c = tail call %struct.Memory* @sub_4788b0.play_connect_n(%struct.State* nonnull %0, i64 %222, %struct.Memory* %call2_4b8dfc)
...
block_.L_4b8e40:                                  ; preds = %entry.block_.L_4b8e40_crit_edge, %block_4b8e13
  %AL.i9.pre-phi = phi i8* [ %.pre1, %entry.block_.L_4b8e40_crit_edge ], [ %AL.i20, %block_4b8e13 ]
  %243 = phi i64 [ %194, %entry.block_.L_4b8e40_crit_edge ], [ %.pre, %block_4b8e13 ]
  %MEMORY.0 = phi %struct.Memory* [ %call2_4b8dfc, %entry.block_.L_4b8e40_crit_edge ], [ %call2_4b8e2c, %block_4b8e13 ]
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_jne_.L_4b8e40(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i8* nocapture %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
