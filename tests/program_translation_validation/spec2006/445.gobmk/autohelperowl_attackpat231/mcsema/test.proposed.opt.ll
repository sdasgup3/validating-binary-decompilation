...
define %struct.Memory* @autohelperowl_attackpat231(%struct.State* noalias, i64, %struct.Memory* noalias readnone) local_unnamed_addr #1 {
entry:
  ...
  %call2_4b903c = tail call %struct.Memory* @sub_44da20.owl_escape_value(%struct.State* %0, i64 %308, %struct.Memory* %2)
  ...
  br i1 %326, label %block_.L_4b9063, label %block_4b904a
...
block_4b904a:                                     ; preds = %entry
  ...
  %call2_4b904d = tail call %struct.Memory* @sub_44da20.owl_escape_value(%struct.State* nonnull %0, i64 %334, %struct.Memory* %call2_4b903c)
  ...
  br i1 %364, label %block_4b904a.block_.L_4b90ae_crit_edge, label %block_.L_4b9063

block_4b904a.block_.L_4b90ae_crit_edge:           ; preds = %block_4b904a
  %.pre2 = bitcast %union.anon* %65 to i8*
  br label %block_.L_4b90ae

block_.L_4b9063:                                  ; preds = %block_4b904a, %entry
  %366 = phi i64 [ %327, %entry ], [ %356, %block_4b904a ]
  %MEMORY.0 = phi %struct.Memory* [ %call2_4b903c, %entry ], [ %call2_4b904d, %block_4b904a ]
  ...
  %call2_4b909e = tail call %struct.Memory* @sub_4784b0.play_attack_defend2_n(%struct.State* nonnull %0, i64 %455, %struct.Memory* %MEMORY.0)
...
block_.L_4b90ae:                                  ; preds = %block_4b904a.block_.L_4b90ae_crit_edge, %block_.L_4b9063
  %AL.i9.pre-phi = phi i8* [ %.pre2, %block_4b904a.block_.L_4b90ae_crit_edge ], [ %AL.i18, %block_.L_4b9063 ]
  %478 = phi i64 [ %355, %block_4b904a.block_.L_4b90ae_crit_edge ], [ %.pre, %block_.L_4b9063 ]
  %MEMORY.1 = phi %struct.Memory* [ %call2_4b904d, %block_4b904a.block_.L_4b90ae_crit_edge ], [ %call2_4b909e, %block_.L_4b9063 ]
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_jg_.L_4b9063(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i8* nocapture %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_jle_.L_4b90ae(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i8* nocapture %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 2, i32 7
