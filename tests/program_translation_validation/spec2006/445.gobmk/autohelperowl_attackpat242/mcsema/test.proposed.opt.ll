...
define %struct.Memory* @autohelperowl_attackpat242(%struct.State* noalias, i64, %struct.Memory* noalias readnone) local_unnamed_addr #1 {
entry:
  ...
  %call2_4b9738 = tail call %struct.Memory* @sub_4137f0.countstones(%struct.State* %0, i64 %120, %struct.Memory* %2)
  ...
  br i1 %163, label %block_.L_4b9760, label %block_4b974f

block_4b974f:                                     ; preds = %entry
  ...
  store i64 %170, i64* %RDI.i30, align 8
  %171 = add i64 %164, -696271
  %172 = add i64 %164, 8
  ...
  %call2_4b9752 = tail call %struct.Memory* @sub_40f780.countlib(%struct.State* nonnull %0, i64 %171, %struct.Memory* %call2_4b9738)
  %176 = load i32, i32* %EAX.i23, align 4
  ...
  store i8 %191, i8* %CL.i25, align 1
  %199 = load i64, i64* %RBP.i, align 8
  %200 = add i64 %199, -21
  %201 = add i64 %177, 9
  store i64 %201, i64* %3, align 8
  %202 = inttoptr i64 %200 to i8*
  store i8 %191, i8* %202, align 1
  %.pre = load i64, i64* %3, align 8
  br label %block_.L_4b9760

block_.L_4b9760:                                  ; preds = %block_4b974f, %entry
  %203 = phi i64 [ %154, %entry ], [ %.pre, %block_4b974f ]
  %MEMORY.0 = phi %struct.Memory* [ %call2_4b9738, %entry ], [ %call2_4b9752, %block_4b974f ]
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_jle_.L_4b9760(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i8* nocapture %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
