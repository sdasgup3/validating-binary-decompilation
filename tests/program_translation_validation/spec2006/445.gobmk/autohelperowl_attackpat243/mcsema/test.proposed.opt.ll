...
define %struct.Memory* @autohelperowl_attackpat243(%struct.State* noalias, i64, %struct.Memory* noalias readnone) local_unnamed_addr #1 {
entry:
  ...
  %call2_4b9798 = tail call %struct.Memory* @sub_4137f0.countstones(%struct.State* %0, i64 %120, %struct.Memory* %2)
  ...
  br i1 %164, label %block_.L_4b97e7, label %block_4b97af
...
block_4b97af:                                     ; preds = %entry
  ...
  store i64 %171, i64* %RDI.i53, align 8
  %172 = add i64 %165, -696367
  %173 = add i64 %165, 8
  ...
  %call2_4b97b2 = tail call %struct.Memory* @sub_40f780.countlib(%struct.State* nonnull %0, i64 %172, %struct.Memory* %call2_4b9798)
  %177 = load i64, i64* %3, align 8
  store i64 0, i64* %RDI.i53, align 8
  store i8 0, i8* %CL.i47, align 1
  %178 = load i32, i32* %EAX.i45, align 4
  %179 = add i32 %178, -1
  ...
  %209 = select i1 %208, i64 %205, i64 %206
  store i64 %209, i64* %3, align 8
  br i1 %208, label %block_.L_4b97e7, label %block_4b97c8
...
block_4b97c8:                                     ; preds = %block_4b97af
  ...
  store i64 %215, i64* %RDI.i53, align 8
  ...
  store i64 %220, i64* %RSI.i, align 8
  %221 = add i64 %209, -685896
  %222 = add i64 %209, 20
  ...
  %call2_4b97d7 = tail call %struct.Memory* @sub_412080.accuratelib(%struct.State* nonnull %0, i64 %221, %struct.Memory* %call2_4b97b2)
  %226 = load i32, i32* %EAX.i45, align 4
  ...
  %251 = xor i1 %.demorgan, true
  %252 = zext i1 %251 to i8
  store i8 %252, i8* %R8B.i48, align 1
...
block_.L_4b97e7:                                  ; preds = %block_4b97c8, %block_4b97af, %entry
  %257 = phi i64 [ %154, %entry ], [ %205, %block_4b97af ], [ %.pre, %block_4b97c8 ]
  %MEMORY.0 = phi %struct.Memory* [ %call2_4b9798, %entry ], [ %call2_4b97b2, %block_4b97af ], [ %call2_4b97d7, %block_4b97c8 ]
  ...
  store i64 %264, i64* %RAX.i65, align 8
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_jg_.L_4b97e7(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i8* nocapture %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_jne_.L_4b97e7(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i8* nocapture %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 2, i32 7
