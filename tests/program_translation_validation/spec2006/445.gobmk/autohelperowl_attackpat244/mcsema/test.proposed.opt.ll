...
define %struct.Memory* @autohelperowl_attackpat244(%struct.State* noalias, i64, %struct.Memory* noalias readnone) local_unnamed_addr #1 {
entry:
  ...
  %RDI.i32 = getelementptr inbounds %union.anon, %union.anon* %39, i64 0, i32 0
  ...
  store i64 %119, i64* %RDI.i32, align 8
  %120 = add i64 %115, -679989
  %121 = add i64 %115, 8
  ...
  %call2_4b9828 = tail call %struct.Memory* @sub_4137f0.countstones(%struct.State* %0, i64 %120, %struct.Memory* %2)
  %125 = load i64, i64* %3, align 8
  store i64 0, i64* %RCX.i42, align 8
  %126 = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 17, i32 0
  %R8B.i28 = bitcast %union.anon* %126 to i8*
  store i8 0, i8* %R8B.i28, align 1
  %EAX.i25 = bitcast %union.anon* %65 to i32*
  %127 = load i32, i32* %EAX.i25, align 4
  %128 = add i32 %127, -3
  ...
  br i1 %163, label %block_.L_4b9853, label %block_4b983f

block_4b983f:                                     ; preds = %entry
  %CL.i27 = bitcast %union.anon* %58 to i8*
  ...
  store i64 %170, i64* %RDI.i32, align 8
  ...
  %call2_4b9845 = tail call %struct.Memory* @sub_4772c0.does_attack(%struct.State* nonnull %0, i64 %176, %struct.Memory* %call2_4b9828)
  %181 = load i32, i32* %EAX.i25, align 4
  ...
  store i8 %193, i8* %CL.i27, align 1
  ...
  br label %block_.L_4b9853

block_.L_4b9853:                                  ; preds = %block_4b983f, %entry
  %198 = phi i64 [ %154, %entry ], [ %.pre, %block_4b983f ]
  %MEMORY.0 = phi %struct.Memory* [ %call2_4b9828, %entry ], [ %call2_4b9845, %block_4b983f ]
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_jle_.L_4b9853(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i8* nocapture %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
