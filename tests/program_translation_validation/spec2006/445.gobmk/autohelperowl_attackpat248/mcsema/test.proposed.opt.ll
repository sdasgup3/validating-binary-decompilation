...
define %struct.Memory* @autohelperowl_attackpat248(%struct.State* noalias, i64, %struct.Memory* noalias readnone returned) local_unnamed_addr #1 {
entry:
  ...
  %call2_4b9977 = tail call %struct.Memory* @sub_44de50.owl_proper_eye(%struct.State* %0, i64 %73, %struct.Memory* %2)
  ...
  ret %struct.Memory* %call2_4b9977
}
