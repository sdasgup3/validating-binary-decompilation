...
define %struct.Memory* @autohelperowl_attackpat253(%struct.State* noalias, i64, %struct.Memory* noalias readnone) local_unnamed_addr #1 {
entry:
  ...
  %call2_4b9a39 = tail call %struct.Memory* @sub_40f780.countlib(%struct.State* %0, i64 %167, %struct.Memory* %2)
  ...
  br i1 %204, label %block_.L_4b9a6e, label %block_4b9a50
...
block_4b9a50:                                     ; preds = %entry
  ...
  store i64 %211, i64* %RDI.i39, align 8
  %212 = add i64 %206, -12
  %213 = add i64 %205, 11
  ...
  store i64 %217, i64* %RAX.i63, align 8
  ...
  %call2_4b9a5d = tail call %struct.Memory* @sub_445d10.obvious_false_eye(%struct.State* nonnull %0, i64 %237, %struct.Memory* %call2_4b9a39)
  %242 = load i32, i32* %EAX.i32, align 4
...
block_.L_4b9a6e:                                  ; preds = %block_4b9a50, %entry
  %257 = phi i64 [ %201, %entry ], [ %.pre, %block_4b9a50 ]
  %MEMORY.0 = phi %struct.Memory* [ %call2_4b9a39, %entry ], [ %call2_4b9a5d, %block_4b9a50 ]
  ...
  store i64 %264, i64* %RAX.i63, align 8
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_jne_.L_4b9a6e(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i8* nocapture %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
