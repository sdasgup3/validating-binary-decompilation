...
define %struct.Memory* @autohelperowl_attackpat259(%struct.State* noalias, i64, %struct.Memory* noalias readnone) local_unnamed_addr #1 {
entry:
  ...
  %call2_4b9ab9 = tail call %struct.Memory* @sub_40f780.countlib(%struct.State* %0, i64 %167, %struct.Memory* %2)
  ...
  br i1 %210, label %block_.L_4b9aee, label %block_4b9ad0

block_4b9ad0:                                     ; preds = %entry
  ...
  %call2_4b9add = tail call %struct.Memory* @sub_445d10.obvious_false_eye(%struct.State* nonnull %0, i64 %243, %struct.Memory* %call2_4b9ab9)
  %248 = load i32, i32* %EAX.i32, align 4
  %249 = load i64, i64* %3, align 8
  %250 = icmp ne i32 %248, 0
  %251 = zext i1 %250 to i64
  %252 = xor i64 %251, 255
  %253 = trunc i64 %252 to i8
  store i8 %253, i8* %CL.i34, align 1
  ...
  br label %block_.L_4b9aee

block_.L_4b9aee:                                  ; preds = %block_4b9ad0, %entry
  %263 = phi i64 [ %201, %entry ], [ %.pre, %block_4b9ad0 ]
  %MEMORY.0 = phi %struct.Memory* [ %call2_4b9ab9, %entry ], [ %call2_4b9add, %block_4b9ad0 ]
  ...
  store i64 %270, i64* %RAX.i63, align 8
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_jle_.L_4b9aee(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i8* nocapture %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
