...
define %struct.Memory* @autohelperowl_attackpat270(%struct.State* noalias, i64, %struct.Memory* noalias readnone) local_unnamed_addr #1 {
entry:
  ...
  %call2_4b9bc8 = tail call %struct.Memory* @sub_40f780.countlib(%struct.State* %0, i64 %120, %struct.Memory* %2)
  ...
  br i1 %157, label %block_.L_4b9c2b, label %block_4b9bdf

block_4b9bdf:                                     ; preds = %entry
  ...
  br i1 %165, label %block_4b9bed, label %block_.L_4b9c10

block_4b9bed:                                     ; preds = %block_4b9bdf
  ...
  br label %block_.L_4b9c1f

block_.L_4b9c10:                                  ; preds = %block_4b9bdf
  ...
  %call2_4b9c17 = tail call %struct.Memory* @sub_45db40.attack(%struct.State* nonnull %0, i64 %219, %struct.Memory* %call2_4b9bc8)
...
block_.L_4b9c1f:                                  ; preds = %block_.L_4b9c10, %block_4b9bed
  %230 = phi i64 [ %.pre, %block_.L_4b9c10 ], [ %212, %block_4b9bed ]
  %MEMORY.0 = phi %struct.Memory* [ %call2_4b9c17, %block_.L_4b9c10 ], [ %call2_4b9bc8, %block_4b9bed ]
  ...
  br label %block_.L_4b9c2b

block_.L_4b9c2b:                                  ; preds = %block_.L_4b9c1f, %entry
  %263 = phi i64 [ %154, %entry ], [ %.pre2, %block_.L_4b9c1f ]
  %MEMORY.1 = phi %struct.Memory* [ %call2_4b9bc8, %entry ], [ %MEMORY.0, %block_.L_4b9c1f ]
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_jne_.L_4b9c2b(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i8* nocapture %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_jne_.L_4b9c10(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i8* nocapture %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 2, i32 7
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_jmpq_.L_4b9c1f(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
