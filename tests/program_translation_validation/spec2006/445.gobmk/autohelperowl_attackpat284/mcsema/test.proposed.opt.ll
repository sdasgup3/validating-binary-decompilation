...
define %struct.Memory* @autohelperowl_attackpat284(%struct.State* noalias, i64, %struct.Memory* noalias readnone) local_unnamed_addr #1 {
entry:
  ...
  %EDX.i88 = bitcast %union.anon* %51 to i32*
  %52 = load i64, i64* %RBP.i, align 8
  %53 = add i64 %52, -12
  %54 = load i32, i32* %EDX.i88, align 4
  ...
  store i64 %166, i64* %RDI.i58, align 8
  %167 = add i64 %162, -697846
  %168 = add i64 %162, 8
  ...
  %call2_4b9d79 = tail call %struct.Memory* @sub_40f780.countlib(%struct.State* %0, i64 %167, %struct.Memory* %2)
  ...
  %R8B.i53 = bitcast %union.anon* %173 to i8*
  store i8 0, i8* %R8B.i53, align 1
  %EAX.i50 = bitcast %union.anon* %65 to i32*
  %174 = load i32, i32* %EAX.i50, align 4
  %175 = add i32 %174, -3
  ...
  br i1 %211, label %block_.L_4b9ddf, label %block_4b9d90

block_4b9d90:                                     ; preds = %entry
  %213 = load i32, i32* bitcast (%G_0xb54ce4_type* @G_0xb54ce4 to i32*), align 8
  ...
  %.v = select i1 %219, i64 14, i64 52
  %223 = add i64 %212, %.v
  store i64 %223, i64* %3, align 8
  br i1 %219, label %block_4b9d9e, label %block_.L_4b9dc4
...
block_4b9d9e:                                     ; preds = %block_4b9d90
  ...
  %230 = mul nsw i64 %229, 380
  store i64 %230, i64* %RCX.i80, align 8
  %231 = lshr i64 %230, 63
  %232 = add i64 %230, ptrtoint (%G__0xb0eff0_type* @G__0xb0eff0 to i64)
  store i64 %232, i64* %RAX.i82, align 8
  %233 = icmp ult i64 %232, ptrtoint (%G__0xb0eff0_type* @G__0xb0eff0 to i64)
  ...
  %243 = xor i64 %230, ptrtoint (%G__0xb0eff0_type* @G__0xb0eff0 to i64)
  %244 = xor i64 %243, %232
  %245 = lshr i64 %244, 4
  ...
  %252 = xor i64 %250, lshr (i64 ptrtoint (%G__0xb0eff0_type* @G__0xb0eff0 to i64), i64 63)
  %253 = xor i64 %250, %231
  ...
  %257 = add i64 %230, add (i64 ptrtoint (%G__0xb0eff0_type* @G__0xb0eff0 to i64), i64 180)
  %258 = add i64 %223, 30
...
block_.L_4b9dc4:                                  ; preds = %block_4b9d90
  ...
  store i64 %272, i64* %RDI.i58, align 8
  %273 = add i64 %223, -325188
  %274 = add i64 %223, 12
  ...
  %call2_4b9dcb = tail call %struct.Memory* @sub_46a780.find_defense(%struct.State* nonnull %0, i64 %273, %struct.Memory* %call2_4b9d79)
  %278 = load i64, i64* %RBP.i, align 8
  %279 = add i64 %278, -32
  %280 = load i32, i32* %EAX.i50, align 4
...
block_.L_4b9dd3:                                  ; preds = %block_.L_4b9dc4, %block_4b9d9e
  %284 = phi i64 [ %.pre, %block_.L_4b9dc4 ], [ %266, %block_4b9d9e ]
  %MEMORY.0 = phi %struct.Memory* [ %call2_4b9dcb, %block_.L_4b9dc4 ], [ %call2_4b9d79, %block_4b9d9e ]
  ...
  store i8 %313, i8* %CL.i52, align 1
  %314 = add i64 %285, -25
  %315 = add i64 %284, 12
...
block_.L_4b9ddf:                                  ; preds = %block_.L_4b9dd3, %entry
  %317 = phi i64 [ %201, %entry ], [ %.pre2, %block_.L_4b9dd3 ]
  %MEMORY.1 = phi %struct.Memory* [ %call2_4b9d79, %entry ], [ %MEMORY.0, %block_.L_4b9dd3 ]
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_jg_.L_4b9ddf(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i8* nocapture %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_jne_.L_4b9dc4(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i8* nocapture %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 2, i32 7
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_jmpq_.L_4b9dd3(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
