...
define %struct.Memory* @autohelperowl_attackpat290(%struct.State* noalias, i64, %struct.Memory* noalias readnone) local_unnamed_addr #1 {
entry:
  ...
  %call2_4ba01d = tail call %struct.Memory* @sub_478110.play_attack_defend_n(%struct.State* %0, i64 %179, %struct.Memory* %2)
  ...
  br i1 %204, label %block_.L_4ba057, label %block_4ba032

block_4ba032:                                     ; preds = %entry
  store i64 1, i64* %RAX.i89, align 8
  ...
  %call2_4ba047 = tail call %struct.Memory* @sub_478110.play_attack_defend_n(%struct.State* nonnull %0, i64 %220, %struct.Memory* %call2_4ba01d)
  %225 = load i32, i32* %EAX.i46, align 4
...
block_.L_4ba057:                                  ; preds = %block_4ba032, %entry
  %242 = phi i64 [ %201, %entry ], [ %.pre, %block_4ba032 ]
  %MEMORY.0 = phi %struct.Memory* [ %call2_4ba01d, %entry ], [ %call2_4ba047, %block_4ba032 ]
  ...
  store i64 %249, i64* %RAX.i89, align 8
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_movl_0xb5abd0___r8_4____ecx(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_jne_.L_4ba057(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i8* nocapture %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
