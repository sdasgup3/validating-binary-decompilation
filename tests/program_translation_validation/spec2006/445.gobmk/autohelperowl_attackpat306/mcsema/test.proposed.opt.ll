...
define %struct.Memory* @autohelperowl_attackpat306(%struct.State* noalias, i64, %struct.Memory* noalias readnone) local_unnamed_addr #1 {
entry:
  ...
  %call2_4ba248 = tail call %struct.Memory* @sub_40f780.countlib(%struct.State* %0, i64 %120, %struct.Memory* %2)
  ...
  br i1 %157, label %block_.L_4ba296, label %block_4ba25f
...
block_4ba25f:                                     ; preds = %entry
  ...
  %call2_4ba26e = tail call %struct.Memory* @sub_412080.accuratelib(%struct.State* nonnull %0, i64 %170, %struct.Memory* %call2_4ba248)
  ...
  br i1 %212, label %block_.L_4ba296, label %block_4ba285
...
block_4ba285:                                     ; preds = %block_4ba25f
  ...
  %call2_4ba288 = tail call %struct.Memory* @sub_4afa30.finish_ko_helper(%struct.State* nonnull %0, i64 %220, %struct.Memory* %call2_4ba26e)
...
block_.L_4ba296:                                  ; preds = %block_4ba285, %block_4ba25f, %entry
  %242 = phi i64 [ %154, %entry ], [ %203, %block_4ba25f ], [ %.pre, %block_4ba285 ]
  %MEMORY.0 = phi %struct.Memory* [ %call2_4ba248, %entry ], [ %call2_4ba26e, %block_4ba25f ], [ %call2_4ba288, %block_4ba285 ]
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_jne_.L_4ba296(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i8* nocapture %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_jle_.L_4ba296(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i8* nocapture %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 2, i32 7
