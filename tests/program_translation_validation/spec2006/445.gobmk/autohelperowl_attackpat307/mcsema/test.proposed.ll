...
define %struct.Memory* @autohelperowl_attackpat307(%struct.State* noalias , i64, %struct.Memory* noalias) alwaysinline  {
entry:
  ...
  ; Code: .autohelperowl_attackpat307:	 RIP: 4ba2b0	 Bytes: 0
  ; Code: pushq %rbp	 RIP: 4ba2b0	 Bytes: 1
  %loadMem_4ba2b0 = load %struct.Memory*, %struct.Memory** %MEMORY
  %call_4ba2b0 = call %struct.Memory* @routine_pushq__rbp(%struct.State* %0, i64  0, %struct.Memory* %loadMem_4ba2b0)
  store %struct.Memory* %call_4ba2b0, %struct.Memory** %MEMORY

  ; Code: movq %rsp, %rbp	 RIP: 4ba2b1	 Bytes: 3
  %loadMem_4ba2b1 = load %struct.Memory*, %struct.Memory** %MEMORY
  %call_4ba2b1 = call %struct.Memory* @routine_movq__rsp___rbp(%struct.State* %0, i64  0, %struct.Memory* %loadMem_4ba2b1)
  store %struct.Memory* %call_4ba2b1, %struct.Memory** %MEMORY

  ; Code: subq $0x20, %rsp	 RIP: 4ba2b4	 Bytes: 4
  %loadMem_4ba2b4 = load %struct.Memory*, %struct.Memory** %MEMORY
  %call_4ba2b4 = call %struct.Memory* @routine_subq__0x20___rsp(%struct.State* %0, i64  0, %struct.Memory* %loadMem_4ba2b4)
  store %struct.Memory* %call_4ba2b4, %struct.Memory** %MEMORY

  ; Code: movl %edi, -0x4(%rbp)	 RIP: 4ba2b8	 Bytes: 3
  %loadMem_4ba2b8 = load %struct.Memory*, %struct.Memory** %MEMORY
  %call_4ba2b8 = call %struct.Memory* @routine_movl__edi__MINUS0x4__rbp_(%struct.State* %0, i64  0, %struct.Memory* %loadMem_4ba2b8)
  store %struct.Memory* %call_4ba2b8, %struct.Memory** %MEMORY

  ; Code: movl %esi, -0x8(%rbp)	 RIP: 4ba2bb	 Bytes: 3
  %loadMem_4ba2bb = load %struct.Memory*, %struct.Memory** %MEMORY
  %call_4ba2bb = call %struct.Memory* @routine_movl__esi__MINUS0x8__rbp_(%struct.State* %0, i64  0, %struct.Memory* %loadMem_4ba2bb)
  store %struct.Memory* %call_4ba2bb, %struct.Memory** %MEMORY

  ; Code: movl %edx, -0xc(%rbp)	 RIP: 4ba2be	 Bytes: 3
  %loadMem_4ba2be = load %struct.Memory*, %struct.Memory** %MEMORY
  %call_4ba2be = call %struct.Memory* @routine_movl__edx__MINUS0xc__rbp_(%struct.State* %0, i64  0, %struct.Memory* %loadMem_4ba2be)
  store %struct.Memory* %call_4ba2be, %struct.Memory** %MEMORY

  ; Code: movl %ecx, -0x10(%rbp)	 RIP: 4ba2c1	 Bytes: 3
  %loadMem_4ba2c1 = load %struct.Memory*, %struct.Memory** %MEMORY
  %call_4ba2c1 = call %struct.Memory* @routine_movl__ecx__MINUS0x10__rbp_(%struct.State* %0, i64  0, %struct.Memory* %loadMem_4ba2c1)
  store %struct.Memory* %call_4ba2c1, %struct.Memory** %MEMORY

  ; Code: movslq -0x4(%rbp), %rax	 RIP: 4ba2c4	 Bytes: 4
  %loadMem_4ba2c4 = load %struct.Memory*, %struct.Memory** %MEMORY
  %call_4ba2c4 = call %struct.Memory* @routine_movslq_MINUS0x4__rbp____rax(%struct.State* %0, i64  0, %struct.Memory* %loadMem_4ba2c4)
  store %struct.Memory* %call_4ba2c4, %struct.Memory** %MEMORY

  ; Code: movl 0xb59dd0(,%rax,4), %ecx	 RIP: 4ba2c8	 Bytes: 7
  %loadMem_4ba2c8 = load %struct.Memory*, %struct.Memory** %MEMORY
  %call_4ba2c8 = call %struct.Memory* @routine_movl_0xb59dd0___rax_4____ecx(%struct.State* %0, i64  0, %struct.Memory* %loadMem_4ba2c8)
  store %struct.Memory* %call_4ba2c8, %struct.Memory** %MEMORY

  ; Code: addl -0x8(%rbp), %ecx	 RIP: 4ba2cf	 Bytes: 3
  %loadMem_4ba2cf = load %struct.Memory*, %struct.Memory** %MEMORY
  %call_4ba2cf = call %struct.Memory* @routine_addl_MINUS0x8__rbp____ecx(%struct.State* %0, i64  0, %struct.Memory* %loadMem_4ba2cf)
  store %struct.Memory* %call_4ba2cf, %struct.Memory** %MEMORY

  ; Code: movl %ecx, -0x14(%rbp)	 RIP: 4ba2d2	 Bytes: 3
  %loadMem_4ba2d2 = load %struct.Memory*, %struct.Memory** %MEMORY
  %call_4ba2d2 = call %struct.Memory* @routine_movl__ecx__MINUS0x14__rbp_(%struct.State* %0, i64  0, %struct.Memory* %loadMem_4ba2d2)
  store %struct.Memory* %call_4ba2d2, %struct.Memory** %MEMORY

  ; Code: movl -0x14(%rbp), %edi	 RIP: 4ba2d5	 Bytes: 3
  %loadMem_4ba2d5 = load %struct.Memory*, %struct.Memory** %MEMORY
  %call_4ba2d5 = call %struct.Memory* @routine_movl_MINUS0x14__rbp____edi(%struct.State* %0, i64  0, %struct.Memory* %loadMem_4ba2d5)
  store %struct.Memory* %call_4ba2d5, %struct.Memory** %MEMORY

  ; Code: callq .countlib	 RIP: 4ba2d8	 Bytes: 5
  %loadMem1_4ba2d8 = load %struct.Memory*, %struct.Memory** %MEMORY
  %call1_4ba2d8 = call %struct.Memory* @routine_callq_.countlib(%struct.State* %0, i64  0, %struct.Memory* %loadMem1_4ba2d8, i64 -699224, i64 5, i64 5)
  store %struct.Memory* %call1_4ba2d8, %struct.Memory** %MEMORY
  ...
  ; Code: xorl %ecx, %ecx	 RIP: 4ba2dd	 Bytes: 2
  %loadMem_4ba2dd = load %struct.Memory*, %struct.Memory** %MEMORY
  %call_4ba2dd = call %struct.Memory* @routine_xorl__ecx___ecx(%struct.State* %0, i64  0, %struct.Memory* %loadMem_4ba2dd)
  store %struct.Memory* %call_4ba2dd, %struct.Memory** %MEMORY

  ; Code: movb %cl, %r8b	 RIP: 4ba2df	 Bytes: 3
  %loadMem_4ba2df = load %struct.Memory*, %struct.Memory** %MEMORY
  %call_4ba2df = call %struct.Memory* @routine_movb__cl___r8b(%struct.State* %0, i64  0, %struct.Memory* %loadMem_4ba2df)
  store %struct.Memory* %call_4ba2df, %struct.Memory** %MEMORY

  ; Code: cmpl $0x2, %eax	 RIP: 4ba2e2	 Bytes: 3
  %loadMem_4ba2e2 = load %struct.Memory*, %struct.Memory** %MEMORY
  %call_4ba2e2 = call %struct.Memory* @routine_cmpl__0x2___eax(%struct.State* %0, i64  0, %struct.Memory* %loadMem_4ba2e2)
  store %struct.Memory* %call_4ba2e2, %struct.Memory** %MEMORY

  ; Code: movb %r8b, -0x15(%rbp)	 RIP: 4ba2e5	 Bytes: 4
  %loadMem_4ba2e5 = load %struct.Memory*, %struct.Memory** %MEMORY
  %call_4ba2e5 = call %struct.Memory* @routine_movb__r8b__MINUS0x15__rbp_(%struct.State* %0, i64  0, %struct.Memory* %loadMem_4ba2e5)
  store %struct.Memory* %call_4ba2e5, %struct.Memory** %MEMORY

  ; Code: jne .L_4ba326	 RIP: 4ba2e9	 Bytes: 6
  %loadMem_4ba2e9 = load %struct.Memory*, %struct.Memory** %MEMORY
  %call_4ba2e9 = call %struct.Memory* @routine_jne_.L_4ba326(%struct.State* %0, i64  0, %struct.Memory* %loadMem_4ba2e9, i8* %BRANCH_TAKEN, i64 61, i64 6, i64 6)
  store %struct.Memory* %call_4ba2e9, %struct.Memory** %MEMORY
...
block_4ba2ef:
  ; Code: movl $0x14, %edx	 RIP: 4ba2ef	 Bytes: 5
  %loadMem_4ba2ef = load %struct.Memory*, %struct.Memory** %MEMORY
  %call_4ba2ef = call %struct.Memory* @routine_movl__0x14___edx(%struct.State* %0, i64  0, %struct.Memory* %loadMem_4ba2ef)
  store %struct.Memory* %call_4ba2ef, %struct.Memory** %MEMORY

  ; Code: xorl %eax, %eax	 RIP: 4ba2f4	 Bytes: 2
  %loadMem_4ba2f4 = load %struct.Memory*, %struct.Memory** %MEMORY
  %call_4ba2f4 = call %struct.Memory* @routine_xorl__eax___eax(%struct.State* %0, i64  0, %struct.Memory* %loadMem_4ba2f4)
  store %struct.Memory* %call_4ba2f4, %struct.Memory** %MEMORY

  ; Code: movl %eax, %ecx	 RIP: 4ba2f6	 Bytes: 2
  %loadMem_4ba2f6 = load %struct.Memory*, %struct.Memory** %MEMORY
  %call_4ba2f6 = call %struct.Memory* @routine_movl__eax___ecx(%struct.State* %0, i64  0, %struct.Memory* %loadMem_4ba2f6)
  store %struct.Memory* %call_4ba2f6, %struct.Memory** %MEMORY

  ; Code: movl -0x8(%rbp), %edi	 RIP: 4ba2f8	 Bytes: 3
  %loadMem_4ba2f8 = load %struct.Memory*, %struct.Memory** %MEMORY
  %call_4ba2f8 = call %struct.Memory* @routine_movl_MINUS0x8__rbp____edi(%struct.State* %0, i64  0, %struct.Memory* %loadMem_4ba2f8)
  store %struct.Memory* %call_4ba2f8, %struct.Memory** %MEMORY

  ; Code: movl -0xc(%rbp), %esi	 RIP: 4ba2fb	 Bytes: 3
  %loadMem_4ba2fb = load %struct.Memory*, %struct.Memory** %MEMORY
  %call_4ba2fb = call %struct.Memory* @routine_movl_MINUS0xc__rbp____esi(%struct.State* %0, i64  0, %struct.Memory* %loadMem_4ba2fb)
  store %struct.Memory* %call_4ba2fb, %struct.Memory** %MEMORY

  ; Code: callq .accuratelib	 RIP: 4ba2fe	 Bytes: 5
  %loadMem1_4ba2fe = load %struct.Memory*, %struct.Memory** %MEMORY
  %call1_4ba2fe = call %struct.Memory* @routine_callq_.accuratelib(%struct.State* %0, i64  0, %struct.Memory* %loadMem1_4ba2fe, i64 -688766, i64 5, i64 5)
  store %struct.Memory* %call1_4ba2fe, %struct.Memory** %MEMORY
  ...
  ; Code: xorl %edx, %edx	 RIP: 4ba303	 Bytes: 2
  %loadMem_4ba303 = load %struct.Memory*, %struct.Memory** %MEMORY
  %call_4ba303 = call %struct.Memory* @routine_xorl__edx___edx(%struct.State* %0, i64  0, %struct.Memory* %loadMem_4ba303)
  store %struct.Memory* %call_4ba303, %struct.Memory** %MEMORY

  ; Code: movb %dl, %r8b	 RIP: 4ba305	 Bytes: 3
  %loadMem_4ba305 = load %struct.Memory*, %struct.Memory** %MEMORY
  %call_4ba305 = call %struct.Memory* @routine_movb__dl___r8b(%struct.State* %0, i64  0, %struct.Memory* %loadMem_4ba305)
  store %struct.Memory* %call_4ba305, %struct.Memory** %MEMORY

  ; Code: cmpl $0x1, %eax	 RIP: 4ba308	 Bytes: 3
  %loadMem_4ba308 = load %struct.Memory*, %struct.Memory** %MEMORY
  %call_4ba308 = call %struct.Memory* @routine_cmpl__0x1___eax(%struct.State* %0, i64  0, %struct.Memory* %loadMem_4ba308)
  store %struct.Memory* %call_4ba308, %struct.Memory** %MEMORY

  ; Code: movb %r8b, -0x15(%rbp)	 RIP: 4ba30b	 Bytes: 4
  %loadMem_4ba30b = load %struct.Memory*, %struct.Memory** %MEMORY
  %call_4ba30b = call %struct.Memory* @routine_movb__r8b__MINUS0x15__rbp_(%struct.State* %0, i64  0, %struct.Memory* %loadMem_4ba30b)
  store %struct.Memory* %call_4ba30b, %struct.Memory** %MEMORY

  ; Code: jle .L_4ba326	 RIP: 4ba30f	 Bytes: 6
  %loadMem_4ba30f = load %struct.Memory*, %struct.Memory** %MEMORY
  %call_4ba30f = call %struct.Memory* @routine_jle_.L_4ba326(%struct.State* %0, i64  0, %struct.Memory* %loadMem_4ba30f, i8* %BRANCH_TAKEN, i64 23, i64 6, i64 6)
  store %struct.Memory* %call_4ba30f, %struct.Memory** %MEMORY
...
block_4ba315:
  ; Code: movl -0x14(%rbp), %edi	 RIP: 4ba315	 Bytes: 3
  %loadMem_4ba315 = load %struct.Memory*, %struct.Memory** %MEMORY
  %call_4ba315 = call %struct.Memory* @routine_movl_MINUS0x14__rbp____edi(%struct.State* %0, i64  0, %struct.Memory* %loadMem_4ba315)
  store %struct.Memory* %call_4ba315, %struct.Memory** %MEMORY

  ; Code: callq .finish_ko_helper	 RIP: 4ba318	 Bytes: 5
  %loadMem1_4ba318 = load %struct.Memory*, %struct.Memory** %MEMORY
  %call1_4ba318 = call %struct.Memory* @routine_callq_.finish_ko_helper(%struct.State* %0, i64  0, %struct.Memory* %loadMem1_4ba318, i64 -43240, i64 5, i64 5)
  store %struct.Memory* %call1_4ba318, %struct.Memory** %MEMORY
  ...
  ; Code: cmpl $0x0, %eax	 RIP: 4ba31d	 Bytes: 3
  %loadMem_4ba31d = load %struct.Memory*, %struct.Memory** %MEMORY
  %call_4ba31d = call %struct.Memory* @routine_cmpl__0x0___eax(%struct.State* %0, i64  0, %struct.Memory* %loadMem_4ba31d)
  store %struct.Memory* %call_4ba31d, %struct.Memory** %MEMORY

  ; Code: setne %cl	 RIP: 4ba320	 Bytes: 3
  %loadMem_4ba320 = load %struct.Memory*, %struct.Memory** %MEMORY
  %call_4ba320 = call %struct.Memory* @routine_setne__cl(%struct.State* %0, i64  0, %struct.Memory* %loadMem_4ba320)
  store %struct.Memory* %call_4ba320, %struct.Memory** %MEMORY

  ; Code: movb %cl, -0x15(%rbp)	 RIP: 4ba323	 Bytes: 3
  %loadMem_4ba323 = load %struct.Memory*, %struct.Memory** %MEMORY
  %call_4ba323 = call %struct.Memory* @routine_movb__cl__MINUS0x15__rbp_(%struct.State* %0, i64  0, %struct.Memory* %loadMem_4ba323)
  store %struct.Memory* %call_4ba323, %struct.Memory** %MEMORY

  ; Code: .L_4ba326:	 RIP: 4ba326	 Bytes: 0
  br label %block_.L_4ba326
block_.L_4ba326:

  ; Code: movb -0x15(%rbp), %al	 RIP: 4ba326	 Bytes: 3
  %loadMem_4ba326 = load %struct.Memory*, %struct.Memory** %MEMORY
  %call_4ba326 = call %struct.Memory* @routine_movb_MINUS0x15__rbp____al(%struct.State* %0, i64  0, %struct.Memory* %loadMem_4ba326)
  store %struct.Memory* %call_4ba326, %struct.Memory** %MEMORY

  ; Code: andb $0x1, %al	 RIP: 4ba329	 Bytes: 2
  %loadMem_4ba329 = load %struct.Memory*, %struct.Memory** %MEMORY
  %call_4ba329 = call %struct.Memory* @routine_andb__0x1___al(%struct.State* %0, i64  0, %struct.Memory* %loadMem_4ba329)
  store %struct.Memory* %call_4ba329, %struct.Memory** %MEMORY

  ; Code: movzbl %al, %eax	 RIP: 4ba32b	 Bytes: 3
  %loadMem_4ba32b = load %struct.Memory*, %struct.Memory** %MEMORY
  %call_4ba32b = call %struct.Memory* @routine_movzbl__al___eax(%struct.State* %0, i64  0, %struct.Memory* %loadMem_4ba32b)
  store %struct.Memory* %call_4ba32b, %struct.Memory** %MEMORY

  ; Code: addq $0x20, %rsp	 RIP: 4ba32e	 Bytes: 4
  %loadMem_4ba32e = load %struct.Memory*, %struct.Memory** %MEMORY
  %call_4ba32e = call %struct.Memory* @routine_addq__0x20___rsp(%struct.State* %0, i64  0, %struct.Memory* %loadMem_4ba32e)
  store %struct.Memory* %call_4ba32e, %struct.Memory** %MEMORY

  ; Code: popq %rbp	 RIP: 4ba332	 Bytes: 1
  %loadMem_4ba332 = load %struct.Memory*, %struct.Memory** %MEMORY
  %call_4ba332 = call %struct.Memory* @routine_popq__rbp(%struct.State* %0, i64  0, %struct.Memory* %loadMem_4ba332)
  store %struct.Memory* %call_4ba332, %struct.Memory** %MEMORY

  ; Code: retq	 RIP: 4ba333	 Bytes: 1
  %loadMem_4ba333 = load %struct.Memory*, %struct.Memory** %MEMORY
  %call_4ba333 = call %struct.Memory* @routine_retq(%struct.State* %0, i64  0, %struct.Memory* %loadMem_4ba333)
  store %struct.Memory* %call_4ba333, %struct.Memory** %MEMORY

  ret %struct.Memory* %call_4ba333
}
