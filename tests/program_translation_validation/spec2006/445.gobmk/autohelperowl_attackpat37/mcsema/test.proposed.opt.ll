...
define %struct.Memory* @autohelperowl_attackpat37(%struct.State* noalias, i64, %struct.Memory* noalias readnone returned) local_unnamed_addr #1 {
entry:
  ...
  %R8D.i53 = bitcast %union.anon* %40 to i32*
  ...
  %EDX.i46 = bitcast %union.anon* %54 to i32*
  %55 = load i64, i64* %RBP.i, align 8
  %56 = add i64 %55, -12
  %57 = load i32, i32* %EDX.i46, align 4
  ...
  %ECX.i43 = bitcast %union.anon* %61 to i32*
  %62 = load i64, i64* %RBP.i, align 8
  %63 = add i64 %62, -16
  %64 = load i32, i32* %ECX.i43, align 4
  ...
  store i64 %74, i64* %R9.i41, align 8
  ...
  store i64 %126, i64* %RCX.i38, align 8
  ...
  %140 = load i32, i32* %R8D.i53, align 4
  %141 = zext i32 %140 to i64
  %142 = load i64, i64* %3, align 8
  store i64 %141, i64* %RDX.i26, align 8
  ...
  %call2_4b307c = tail call %struct.Memory* @sub_478110.play_attack_defend_n(%struct.State* %0, i64 %149, %struct.Memory* %2)
  %154 = load i32, i32* %EAX.i22, align 4
  %155 = load i64, i64* %3, align 8
  %156 = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 21, i32 0
  %R10B.i11 = bitcast %union.anon* %156 to i8*
  %157 = icmp eq i32 %154, 0
  %158 = zext i1 %157 to i8
  store i8 %158, i8* %R10B.i11, align 1
  %159 = zext i1 %157 to i64
  store i64 %159, i64* %RAX.i55, align 8
  ...
  ret %struct.Memory* %call2_4b307c
}
