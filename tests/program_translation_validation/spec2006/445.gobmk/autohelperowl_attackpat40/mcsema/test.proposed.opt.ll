...
define %struct.Memory* @autohelperowl_attackpat40(%struct.State* noalias, i64, %struct.Memory* noalias readnone returned) local_unnamed_addr #1 {
entry:
  ...
  store i64 %239, i64* %RDI.i42, align 8
  %240 = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 21, i32 0
  %R10D.i39 = bitcast %union.anon* %240 to i32*
  %241 = getelementptr inbounds %union.anon, %union.anon* %240, i64 0, i32 0
  %242 = add i64 %189, 23
  ...
  %call2_4b317d = tail call %struct.Memory* @sub_4784b0.play_attack_defend2_n(%struct.State* %0, i64 %293, %struct.Memory* %2)
  ...
  ret %struct.Memory* %call2_4b317d
}
