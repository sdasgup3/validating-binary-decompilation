...
define %struct.Memory* @autohelperowl_attackpat43(%struct.State* noalias, i64, %struct.Memory* noalias readnone) local_unnamed_addr #1 {
entry:
  ...
  %call2_4b33bb = tail call %struct.Memory* @sub_44da20.owl_escape_value(%struct.State* %0, i64 %262, %struct.Memory* %2)
  ...
  %280 = and i1 %279, %278
  %.v = select i1 %280, i64 31, i64 9
  %281 = add i64 %268, %.v
  store i64 %281, i64* %3, align 8
  br i1 %280, label %block_.L_4b33df, label %block_4b33c9
...
block_4b33c9:                                     ; preds = %entry
  ...
  %call2_4b33cc = tail call %struct.Memory* @sub_44da20.owl_escape_value(%struct.State* nonnull %0, i64 %288, %struct.Memory* %call2_4b33bb)
  ...
  br i1 %318, label %block_4b33c9.block_.L_4b340d_crit_edge, label %block_.L_4b33df

block_4b33c9.block_.L_4b340d_crit_edge:           ; preds = %block_4b33c9
  %.pre2 = bitcast %union.anon* %66 to i8*
  br label %block_.L_4b340d

block_.L_4b33df:                                  ; preds = %block_4b33c9, %entry
  %320 = phi i64 [ %281, %entry ], [ %310, %block_4b33c9 ]
  %MEMORY.0 = phi %struct.Memory* [ %call2_4b33bb, %entry ], [ %call2_4b33cc, %block_4b33c9 ]
  ...
  %call2_4b33f9 = tail call %struct.Memory* @sub_478110.play_attack_defend_n(%struct.State* nonnull %0, i64 %344, %struct.Memory* %MEMORY.0)
  ...
  %R10B.i16 = bitcast %union.anon* %351 to i8*
  %352 = icmp ne i32 %349, 0
  %353 = zext i1 %352 to i64
  %354 = xor i64 %353, 255
  %355 = trunc i64 %354 to i8
  store i8 %355, i8* %R10B.i16, align 1
  store i8 0, i8* %14, align 1
  ...
  store i8 %355, i8* %364, align 1
  %.pre = load i64, i64* %3, align 8
  br label %block_.L_4b340d

block_.L_4b340d:                                  ; preds = %block_4b33c9.block_.L_4b340d_crit_edge, %block_.L_4b33df
  %AL.i9.pre-phi = phi i8* [ %.pre2, %block_4b33c9.block_.L_4b340d_crit_edge ], [ %AL.i20, %block_.L_4b33df ]
  %365 = phi i64 [ %309, %block_4b33c9.block_.L_4b340d_crit_edge ], [ %.pre, %block_.L_4b33df ]
  %MEMORY.1 = phi %struct.Memory* [ %call2_4b33cc, %block_4b33c9.block_.L_4b340d_crit_edge ], [ %call2_4b33f9, %block_.L_4b33df ]
  ...
  %371 = and i8 %370, 1
  store i8 %371, i8* %AL.i9.pre-phi, align 1
  %372 = zext i8 %371 to i64
  store i64 %372, i64* %RAX.i94, align 8
  %373 = load i64, i64* %6, align 8
  %374 = add i64 %373, 48
  store i64 %374, i64* %6, align 8
  %375 = icmp ugt i64 %373, -49
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_jg_.L_4b33df(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i8* nocapture %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_jle_.L_4b340d(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i8* nocapture %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 2, i32 7
