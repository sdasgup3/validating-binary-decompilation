...
define %struct.Memory* @autohelperowl_attackpat44(%struct.State* noalias, i64, %struct.Memory* noalias readnone returned) local_unnamed_addr #1 {
entry:
  ...
  %call2_4b3448 = tail call %struct.Memory* @sub_44da20.owl_escape_value(%struct.State* %0, i64 %120, %struct.Memory* %2)
  ...
  store i8 %136, i8* %R8B.i9, align 1
  %137 = zext i1 %135 to i64
  store i64 %137, i64* %RAX.i22, align 8
  ...
  ret %struct.Memory* %call2_4b3448
}
