...
define %struct.Memory* @autohelperowl_attackpat46(%struct.State* noalias, i64, %struct.Memory* noalias readnone) local_unnamed_addr #1 {
entry:
  ...
  %call2_4b34a9 = tail call %struct.Memory* @sub_40f780.countlib(%struct.State* %0, i64 %167, %struct.Memory* %2)
  ...
  br i1 %211, label %entry.block_.L_4b34ea_crit_edge, label %block_4b34c0

entry.block_.L_4b34ea_crit_edge:                  ; preds = %entry
...
block_4b34c0:                                     ; preds = %entry
  ...
  store i64 %218, i64* %RDI.i40, align 8
  %219 = add i64 %213, -8
  %220 = add i64 %212, 16
  ...
  %call2_4b34da = tail call %struct.Memory* @sub_478110.play_attack_defend_n(%struct.State* nonnull %0, i64 %236, %struct.Memory* %call2_4b34a9)
  %241 = load i32, i32* %EAX.i33, align 4
  ...
  %R10B.i14 = bitcast %union.anon* %252 to i8*
  %253 = xor i1 %248, true
  %254 = zext i1 %253 to i8
  store i8 %254, i8* %R10B.i14, align 1
...
block_.L_4b34ea:                                  ; preds = %entry.block_.L_4b34ea_crit_edge, %block_4b34c0
  %AL.i9.pre-phi = phi i8* [ %.pre1, %entry.block_.L_4b34ea_crit_edge ], [ %AL.i18, %block_4b34c0 ]
  %259 = phi i64 [ %201, %entry.block_.L_4b34ea_crit_edge ], [ %.pre, %block_4b34c0 ]
  %MEMORY.0 = phi %struct.Memory* [ %call2_4b34a9, %entry.block_.L_4b34ea_crit_edge ], [ %call2_4b34da, %block_4b34c0 ]
  ...
  store i64 %266, i64* %RAX.i64, align 8
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_jg_.L_4b34ea(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i8* nocapture %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
