...
define %struct.Memory* @autohelperowl_attackpat51(%struct.State* noalias, i64, %struct.Memory* noalias readnone) local_unnamed_addr #1 {
entry:
  ...
  store i64 %167, i64* %RDI.i48, align 8
  %168 = add i64 %163, -416950
  %169 = add i64 %163, 8
  ...
  %call2_4b36d9 = tail call %struct.Memory* @sub_44da20.owl_escape_value(%struct.State* %0, i64 %168, %struct.Memory* %2)
  %173 = load i64, i64* %3, align 8
  store i64 0, i64* %RCX.i70, align 8
  %174 = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 17, i32 0
  %R8B.i43 = bitcast %union.anon* %174 to i8*
  store i8 0, i8* %R8B.i43, align 1
  %EAX.i41 = bitcast %union.anon* %66 to i32*
  %175 = load i32, i32* %EAX.i41, align 4
  ...
  %194 = load i8, i8* %33, align 1
  %195 = icmp ne i8 %194, 0
  %196 = load i8, i8* %39, align 1
  %197 = icmp ne i8 %196, 0
  %198 = xor i1 %195, %197
  %199 = or i1 %193, %198
  %200 = select i1 %199, i64 %190, i64 %191
  store i64 %200, i64* %3, align 8
  br i1 %199, label %entry.block_.L_4b3724_crit_edge, label %block_4b36f0

entry.block_.L_4b3724_crit_edge:                  ; preds = %entry
...
block_4b36f0:                                     ; preds = %entry
  ...
  store i64 %206, i64* %RDI.i48, align 8
  %207 = add i64 %201, -8
  %208 = add i64 %200, 16
  ...
  store i64 %211, i64* %RCX.i70, align 8
  %212 = getelementptr inbounds %union.anon, %union.anon* %174, i64 0, i32 0
  %213 = add i64 %201, -20
  %214 = add i64 %200, 20
  ...
  %225 = load i32, i32* %209, align 4
  %226 = zext i32 %225 to i64
  store i64 %226, i64* %RAX.i72, align 8
  %227 = bitcast i64* %6 to i32**
  ...
  %call2_4b3710 = tail call %struct.Memory* @sub_478110.play_attack_defend_n(%struct.State* nonnull %0, i64 %231, %struct.Memory* %call2_4b36d9)
  %236 = load i32, i32* %EAX.i41, align 4
  %237 = load i64, i64* %3, align 8
  %238 = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 21, i32 0
  %R10B.i16 = bitcast %union.anon* %238 to i8*
  %239 = icmp ne i32 %236, 0
  %240 = zext i1 %239 to i64
  %241 = xor i64 %240, 255
  %242 = trunc i64 %241 to i8
  store i8 %242, i8* %R10B.i16, align 1
  store i8 0, i8* %14, align 1
...
block_.L_4b3724:                                  ; preds = %entry.block_.L_4b3724_crit_edge, %block_4b36f0
  %AL.i9.pre-phi = phi i8* [ %.pre1, %entry.block_.L_4b3724_crit_edge ], [ %AL.i20, %block_4b36f0 ]
  %252 = phi i64 [ %190, %entry.block_.L_4b3724_crit_edge ], [ %.pre, %block_4b36f0 ]
  %MEMORY.0 = phi %struct.Memory* [ %call2_4b36d9, %entry.block_.L_4b3724_crit_edge ], [ %call2_4b3710, %block_4b36f0 ]
  ...
  %258 = and i8 %257, 1
  store i8 %258, i8* %AL.i9.pre-phi, align 1
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_jle_.L_4b3724(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i8* nocapture %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
