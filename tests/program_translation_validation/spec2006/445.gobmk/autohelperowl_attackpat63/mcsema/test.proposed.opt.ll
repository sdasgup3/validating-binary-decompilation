...
define %struct.Memory* @autohelperowl_attackpat63(%struct.State* noalias, i64, %struct.Memory* noalias readnone returned) local_unnamed_addr #1 {
entry:
  ...
  %RAX.i34 = getelementptr inbounds %union.anon, %union.anon* %40, i64 0, i32 0
  ...
  %ECX.i = bitcast %union.anon* %60 to i32*
  %61 = load i64, i64* %RBP.i, align 8
  %62 = add i64 %61, -16
  %63 = load i32, i32* %ECX.i, align 4
  ...
  %83 = load i32, i32* %EAX.i18, align 4
  ...
  %call2_4b3a89 = tail call %struct.Memory* @sub_478110.play_attack_defend_n(%struct.State* %0, i64 %85, %struct.Memory* %2)
  %90 = load i32, i32* %EAX.i18, align 4
  %91 = load i64, i64* %3, align 8
  %92 = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 19, i32 0
  %R9B.i11 = bitcast %union.anon* %92 to i8*
  %93 = icmp eq i32 %90, 0
  %94 = zext i1 %93 to i8
  store i8 %94, i8* %R9B.i11, align 1
  %95 = zext i1 %93 to i64
  store i64 %95, i64* %RAX.i34, align 8
  ...
  store i64 %123, i64* %RBP.i, align 8
  ...
  ret %struct.Memory* %call2_4b3a89
}
