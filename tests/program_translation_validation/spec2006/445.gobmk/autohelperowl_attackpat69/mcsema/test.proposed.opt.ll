...
define %struct.Memory* @autohelperowl_attackpat69(%struct.State* noalias, i64, %struct.Memory* noalias readnone) local_unnamed_addr #1 {
entry:
  ...
  %ECX.i56 = bitcast %union.anon* %58 to i32*
  %59 = load i64, i64* %RBP.i, align 8
  %60 = add i64 %59, -16
  %61 = load i32, i32* %ECX.i56, align 4
  ...
  %RAX.i53 = getelementptr inbounds %union.anon, %union.anon* %65, i64 0, i32 0
  ...
  store i64 %72, i64* %RAX.i53, align 8
  %RCX.i51 = getelementptr inbounds %union.anon, %union.anon* %58, i64 0, i32 0
  %73 = shl nsw i64 %72, 2
  ...
  store i64 %78, i64* %RCX.i51, align 8
  %79 = add i64 %66, -8
  %80 = add i64 %68, 14
  ...
  store i64 %84, i64* %RCX.i51, align 8
  ...
  %call2_4b3c68 = tail call %struct.Memory* @sub_40f780.countlib(%struct.State* %0, i64 %120, %struct.Memory* %2)
  %125 = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 17, i32 0
  %R8B.i39 = bitcast %union.anon* %125 to i8*
  ...
  br i1 %163, label %block_.L_4b3ca3, label %block_4b3c7d
...
block_4b3c7d:                                     ; preds = %entry
  ...
  store i64 0, i64* %RCX.i51, align 8
  ...
  store i64 %176, i64* %RAX.i53, align 8
  %177 = icmp ugt i32 %174, 3
  ...
  %call2_4b3c93 = tail call %struct.Memory* @sub_412080.accuratelib(%struct.State* nonnull %0, i64 %196, %struct.Memory* %call2_4b3c68)
  %201 = load i32, i32* %EAX.i37, align 4
  ...
  %225 = xor i1 %224, %222
  %.demorgan = or i1 %215, %225
  %226 = xor i1 %.demorgan, true
  %227 = zext i1 %226 to i8
  store i8 %227, i8* %R8B.i39, align 1
...
block_.L_4b3ca3:                                  ; preds = %block_4b3c7d, %entry
  %232 = phi i64 [ %154, %entry ], [ %.pre, %block_4b3c7d ]
  %MEMORY.0 = phi %struct.Memory* [ %call2_4b3c68, %entry ], [ %call2_4b3c93, %block_4b3c7d ]
  ...
  store i64 %239, i64* %RAX.i53, align 8
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_jle_.L_4b3ca3(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i8* nocapture %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
