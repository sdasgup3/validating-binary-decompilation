...
define %struct.Memory* @autohelperowl_attackpat93(%struct.State* noalias, i64, %struct.Memory* noalias readnone) local_unnamed_addr #1 {
entry:
  ...
  %ESI.i79 = bitcast %union.anon* %44 to i32*
  %45 = load i64, i64* %RBP.i, align 8
  %46 = add i64 %45, -8
  %47 = load i32, i32* %ESI.i79, align 4
  ...
  store i64 %166, i64* %RDI.i47, align 8
  %167 = add i64 %162, -422886
  %168 = add i64 %162, 8
  ...
  br i1 %192, label %entry.block_.L_4b4fb2_crit_edge, label %block_4b4f80

entry.block_.L_4b4fb2_crit_edge:                  ; preds = %entry
  %.pre1 = bitcast %union.anon* %65 to i8*
  br label %block_.L_4b4fb2

block_4b4f80:                                     ; preds = %entry
  ...
  store i64 %200, i64* %RAX.i71, align 8
  %201 = icmp ugt i32 %198, 3
  ...
  store i64 %224, i64* %RCX.i69, align 8
  %225 = getelementptr inbounds %union.anon, %union.anon* %173, i64 0, i32 0
  %226 = add i64 %194, -20
  %227 = add i64 %193, 22
  ...
  %call2_4b4f9e = tail call %struct.Memory* @sub_4788b0.play_connect_n(%struct.State* nonnull %0, i64 %237, %struct.Memory* %call2_4b4f69)
  %242 = load i32, i32* %EAX.i40, align 4
  %243 = load i64, i64* %3, align 8
  %244 = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 21, i32 0
  %R10B.i16 = bitcast %union.anon* %244 to i8*
  %245 = icmp ne i32 %242, 0
  %246 = zext i1 %245 to i64
  %247 = xor i64 %246, 255
  %248 = trunc i64 %247 to i8
  store i8 %248, i8* %R10B.i16, align 1
  store i8 0, i8* %14, align 1
...
block_.L_4b4fb2:                                  ; preds = %entry.block_.L_4b4fb2_crit_edge, %block_4b4f80
  %AL.i9.pre-phi = phi i8* [ %.pre1, %entry.block_.L_4b4fb2_crit_edge ], [ %AL.i20, %block_4b4f80 ]
  %258 = phi i64 [ %189, %entry.block_.L_4b4fb2_crit_edge ], [ %.pre, %block_4b4f80 ]
  %MEMORY.0 = phi %struct.Memory* [ %call2_4b4f69, %entry.block_.L_4b4fb2_crit_edge ], [ %call2_4b4f9e, %block_4b4f80 ]
  ...
  %264 = and i8 %263, 1
  store i8 %264, i8* %AL.i9.pre-phi, align 1
  %265 = zext i8 %264 to i64
  store i64 %265, i64* %RAX.i71, align 8
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_jne_.L_4b4fb2(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i8* nocapture %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
