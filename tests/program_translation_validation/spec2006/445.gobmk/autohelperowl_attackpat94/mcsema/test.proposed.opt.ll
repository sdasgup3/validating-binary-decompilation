...
define %struct.Memory* @autohelperowl_attackpat94(%struct.State* noalias, i64, %struct.Memory* noalias readnone) local_unnamed_addr #1 {
entry:
  ...
  %call2_4b4ff9 = tail call %struct.Memory* @sub_44db80.owl_goal_dragon(%struct.State* %0, i64 %167, %struct.Memory* %2)
  ...
  br i1 %192, label %entry.block_.L_4b5042_crit_edge, label %block_4b5010

entry.block_.L_4b5042_crit_edge:                  ; preds = %entry
...
block_4b5010:                                     ; preds = %entry
  ...
  %call2_4b502e = tail call %struct.Memory* @sub_4788b0.play_connect_n(%struct.State* nonnull %0, i64 %237, %struct.Memory* %call2_4b4ff9)
...
block_.L_4b5042:                                  ; preds = %entry.block_.L_4b5042_crit_edge, %block_4b5010
  %AL.i9.pre-phi = phi i8* [ %.pre1, %entry.block_.L_4b5042_crit_edge ], [ %AL.i20, %block_4b5010 ]
  %258 = phi i64 [ %189, %entry.block_.L_4b5042_crit_edge ], [ %.pre, %block_4b5010 ]
  %MEMORY.0 = phi %struct.Memory* [ %call2_4b4ff9, %entry.block_.L_4b5042_crit_edge ], [ %call2_4b502e, %block_4b5010 ]
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_jne_.L_4b5042(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i8* nocapture %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
