...
define %struct.Memory* @autohelperowl_defendpat110(%struct.State* noalias, i64, %struct.Memory* noalias readnone returned) local_unnamed_addr #1 {
entry:
  ...
  %call2_4bc93b = tail call %struct.Memory* @sub_477550.does_defend(%struct.State* %0, i64 %124, %struct.Memory* %2)
  ...
  ret %struct.Memory* %call2_4bc93b
}
