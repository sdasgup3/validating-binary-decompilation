...
define %struct.Memory* @autohelperowl_defendpat114(%struct.State* noalias, i64, %struct.Memory* noalias readnone) local_unnamed_addr #1 {
entry:
  ...
  %call2_4bc9fa = tail call %struct.Memory* @sub_40f780.countlib(%struct.State* %0, i64 %214, %struct.Memory* %2)
  ...
  br i1 %257, label %block_.L_4bca3b, label %block_4bca11
...
block_4bca11:                                     ; preds = %entry
  ...
  %call2_4bca14 = tail call %struct.Memory* @sub_40f780.countlib(%struct.State* nonnull %0, i64 %265, %struct.Memory* %call2_4bc9fa)
  ...
  br i1 %307, label %block_.L_4bca3b, label %block_4bca2a
...
block_4bca2a:                                     ; preds = %block_4bca11
  ...
  %call2_4bca2d = tail call %struct.Memory* @sub_40f780.countlib(%struct.State* nonnull %0, i64 %315, %struct.Memory* %call2_4bca14)
  ...
  store i8 %335, i8* %CL.i39, align 1
...
block_.L_4bca3b:                                  ; preds = %block_4bca2a, %block_4bca11, %entry
  %347 = phi i64 [ %248, %entry ], [ %298, %block_4bca11 ], [ %.pre, %block_4bca2a ]
  %MEMORY.0 = phi %struct.Memory* [ %call2_4bc9fa, %entry ], [ %call2_4bca14, %block_4bca11 ], [ %call2_4bca2d, %block_4bca2a ]
  ...
  store i64 %354, i64* %RAX.i80, align 8
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_jle_.L_4bca3b(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i8* nocapture %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
