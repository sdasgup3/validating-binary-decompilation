...
define %struct.Memory* @autohelperowl_defendpat117(%struct.State* noalias, i64, %struct.Memory* noalias readnone) local_unnamed_addr #1 {
entry:
  ...
  %call2_4bcaae = tail call %struct.Memory* @sub_478110.play_attack_defend_n(%struct.State* %0, i64 %196, %struct.Memory* %2)
...
block_4bcac5:                                     ; preds = %entry
  ...
  %call2_4bcadf = tail call %struct.Memory* @sub_478110.play_attack_defend_n(%struct.State* nonnull %0, i64 %240, %struct.Memory* %call2_4bcaae)
...
block_.L_4bcaef:                                  ; preds = %block_4bcac5, %entry
  %262 = phi i64 [ %220, %entry ], [ %.pre, %block_4bcac5 ]
  %MEMORY.0 = phi %struct.Memory* [ %call2_4bcaae, %entry ], [ %call2_4bcadf, %block_4bcac5 ]
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_je_.L_4bcaef(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i8* nocapture %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
