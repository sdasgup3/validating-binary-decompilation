...
define %struct.Memory* @autohelperowl_defendpat119(%struct.State* noalias, i64, %struct.Memory* noalias readnone) local_unnamed_addr #1 {
entry:
  ...
  %EDX.i111 = bitcast %union.anon* %51 to i32*
  %52 = load i64, i64* %RBP.i, align 8
  %53 = add i64 %52, -12
  %54 = load i32, i32* %EDX.i111, align 4
  ...
  %call2_4bcc2c = tail call %struct.Memory* @sub_445d10.obvious_false_eye(%struct.State* %0, i64 %172, %struct.Memory* %2)
  %EAX.i75 = bitcast %union.anon* %65 to i32*
  %177 = load i32, i32* %EAX.i75, align 4
  ...
  %.v = select i1 %184, i64 53, i64 9
  %188 = add i64 %178, %.v
  store i64 %188, i64* %3, align 8
  br i1 %184, label %entry.block_.L_4bcc66_crit_edge, label %block_4bcc3a

entry.block_.L_4bcc66_crit_edge:                  ; preds = %entry
  %.pre2 = getelementptr inbounds %union.anon, %union.anon* %51, i64 0, i32 0
  %.pre3 = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 17, i32 0, i32 0
  %.pre4 = bitcast %union.anon* %65 to i8*
  %.pre5 = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 19, i32 0
  %.pre7 = bitcast %union.anon* %.pre5 to i8*
  br label %block_.L_4bcc66
...
block_4bcc3a:                                     ; preds = %entry
  ...
  store i64 %199, i64* %RCX.i103, align 8
  %200 = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 17, i32 0, i32 0
  %201 = add i64 %189, -24
  %202 = add i64 %188, 15
  ...
  %AL.i55 = bitcast %union.anon* %65 to i8*
  store i8 0, i8* %AL.i55, align 1
  %206 = add i64 %188, -281386
  %207 = add i64 %188, 26
  ...
  %call2_4bcc4f = tail call %struct.Memory* @sub_478110.play_attack_defend_n(%struct.State* nonnull %0, i64 %206, %struct.Memory* %call2_4bcc2c)
  %211 = load i64, i64* %3, align 8
  store i64 0, i64* %RCX.i103, align 8
  %212 = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 19, i32 0
  %R9B.i49 = bitcast %union.anon* %212 to i8*
  store i8 0, i8* %R9B.i49, align 1
  %213 = load i32, i32* %EAX.i75, align 4
  store i8 0, i8* %14, align 1
  %214 = and i32 %213, 255
  ...
  %.v8 = select i1 %229, i64 60, i64 6
  %230 = add i64 %227, %.v8
  store i64 %230, i64* %3, align 8
  %cmpBr_4bcc60 = icmp eq i8 %228, 1
  br i1 %cmpBr_4bcc60, label %block_.L_4bcc9c, label %block_.L_4bcc66

block_.L_4bcc66:                                  ; preds = %entry.block_.L_4bcc66_crit_edge, %block_4bcc3a
  %R9B.i16.pre-phi = phi i8* [ %.pre7, %entry.block_.L_4bcc66_crit_edge ], [ %R9B.i49, %block_4bcc3a ]
  %AL.i20.pre-phi = phi i8* [ %.pre4, %entry.block_.L_4bcc66_crit_edge ], [ %AL.i55, %block_4bcc3a ]
  %.pre-phi = phi i64* [ %.pre3, %entry.block_.L_4bcc66_crit_edge ], [ %200, %block_4bcc3a ]
  %RDX.i33.pre-phi = phi i64* [ %.pre2, %entry.block_.L_4bcc66_crit_edge ], [ %RDX.i58, %block_4bcc3a ]
  %231 = phi i64 [ %188, %entry.block_.L_4bcc66_crit_edge ], [ %230, %block_4bcc3a ]
  %MEMORY.0 = phi %struct.Memory* [ %call2_4bcc2c, %entry.block_.L_4bcc66_crit_edge ], [ %call2_4bcc4f, %block_4bcc3a ]
  store i64 1, i64* %RAX.i105, align 8
  store i64 3, i64* %RCX.i103, align 8
  ...
  store i64 %238, i64* %RCX.i103, align 8
  %239 = icmp ugt i32 %236, 3
  ...
  store i64 %262, i64* %RDX.i33.pre-phi, align 8
  %263 = add i64 %232, -24
  %264 = add i64 %231, 20
  ...
  store i64 %267, i64* %.pre-phi, align 8
  store i64 %238, i64* %RDI.i81, align 8
  store i64 1, i64* %RSI.i78, align 8
  %268 = add i64 %232, -32
  %269 = add i64 %231, 27
  ...
  %271 = load i32, i32* %EAX.i75, align 4
  %272 = zext i32 %271 to i64
  %273 = load i64, i64* %3, align 8
  store i64 %272, i64* %RDX.i33.pre-phi, align 8
  ...
  %call2_4bcc88 = tail call %struct.Memory* @sub_478110.play_attack_defend_n(%struct.State* nonnull %0, i64 %280, %struct.Memory* %MEMORY.0)
  %285 = load i32, i32* %EAX.i75, align 4
  %286 = load i64, i64* %3, align 8
  %287 = icmp ne i32 %285, 0
  %288 = zext i1 %287 to i64
  %289 = xor i64 %288, 255
  %290 = trunc i64 %289 to i8
  store i8 %290, i8* %R9B.i16.pre-phi, align 1
  store i8 0, i8* %14, align 1
  ...
  store i8 %290, i8* %299, align 1
  %.pre = load i64, i64* %3, align 8
  br label %block_.L_4bcc9c

block_.L_4bcc9c:                                  ; preds = %block_.L_4bcc66, %block_4bcc3a
  %AL.i9.pre-phi = phi i8* [ %AL.i20.pre-phi, %block_.L_4bcc66 ], [ %AL.i55, %block_4bcc3a ]
  %300 = phi i64 [ %.pre, %block_.L_4bcc66 ], [ %230, %block_4bcc3a ]
  %MEMORY.1 = phi %struct.Memory* [ %call2_4bcc88, %block_.L_4bcc66 ], [ %call2_4bcc4f, %block_4bcc3a ]
  ...
  %306 = and i8 %305, 1
  store i8 %306, i8* %AL.i9.pre-phi, align 1
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_je_.L_4bcc66(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i8* nocapture %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_je_.L_4bcc9c(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i8* nocapture %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 2, i32 7
