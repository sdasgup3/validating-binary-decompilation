...
define %struct.Memory* @autohelperowl_defendpat123(%struct.State* noalias, i64, %struct.Memory* noalias readnone) local_unnamed_addr #1 {
entry:
  ...
  %call2_4bce4a = tail call %struct.Memory* @sub_40f780.countlib(%struct.State* %0, i64 %214, %struct.Memory* %2)
  ...
  br i1 %251, label %block_.L_4bce8b, label %block_4bce61

block_4bce61:                                     ; preds = %entry
  ...
  %call2_4bce64 = tail call %struct.Memory* @sub_40f780.countlib(%struct.State* nonnull %0, i64 %259, %struct.Memory* %call2_4bce4a)
  ...
  br i1 %295, label %block_.L_4bce8b, label %block_4bce7a

block_4bce7a:                                     ; preds = %block_4bce61
  ...
  store i64 %302, i64* %RDI.i44, align 8
  %303 = add i64 %296, -710394
  %304 = add i64 %296, 8
  ...
  %call2_4bce7d = tail call %struct.Memory* @sub_40f780.countlib(%struct.State* nonnull %0, i64 %303, %struct.Memory* %call2_4bce64)
  %308 = load i32, i32* %EAX.i37, align 4
  %309 = load i64, i64* %3, align 8
  %310 = add i32 %308, -2
  %311 = icmp ult i32 %308, 2
  ...
  store i8 %323, i8* %CL.i39, align 1
  %331 = load i64, i64* %RBP.i, align 8
  %332 = add i64 %331, -29
  %333 = add i64 %309, 9
  store i64 %333, i64* %3, align 8
  %334 = inttoptr i64 %332 to i8*
  store i8 %323, i8* %334, align 1
  %.pre = load i64, i64* %3, align 8
  br label %block_.L_4bce8b

block_.L_4bce8b:                                  ; preds = %block_4bce7a, %block_4bce61, %entry
  %335 = phi i64 [ %248, %entry ], [ %292, %block_4bce61 ], [ %.pre, %block_4bce7a ]
  %MEMORY.0 = phi %struct.Memory* [ %call2_4bce4a, %entry ], [ %call2_4bce64, %block_4bce61 ], [ %call2_4bce7d, %block_4bce7a ]
  ...
  store i64 %342, i64* %RAX.i80, align 8
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_jne_.L_4bce8b(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i8* nocapture %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
