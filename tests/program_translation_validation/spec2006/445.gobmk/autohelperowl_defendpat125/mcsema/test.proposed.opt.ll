...
define %struct.Memory* @autohelperowl_defendpat125(%struct.State* noalias, i64, %struct.Memory* noalias readnone) local_unnamed_addr #1 {
entry:
  ...
  %call2_4bcf19 = tail call %struct.Memory* @sub_44dbb0.owl_eyespace(%struct.State* %0, i64 %167, %struct.Memory* %2)
...
block_4bcf30:                                     ; preds = %entry
  ...
  store i64 %197, i64* %RDI.i32, align 8
  ...
  %call2_4bcf36 = tail call %struct.Memory* @sub_4772c0.does_attack(%struct.State* nonnull %0, i64 %203, %struct.Memory* %call2_4bcf19)
  %208 = load i32, i32* %EAX.i25, align 4
  ...
  store i8 %220, i8* %CL.i27, align 1
...
block_.L_4bcf44:                                  ; preds = %block_4bcf30, %entry
  %225 = phi i64 [ %191, %entry ], [ %.pre, %block_4bcf30 ]
  %MEMORY.0 = phi %struct.Memory* [ %call2_4bcf19, %entry ], [ %call2_4bcf36, %block_4bcf30 ]
  ...
  store i64 %232, i64* %RAX.i56, align 8
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_je_.L_4bcf44(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i8* nocapture %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
