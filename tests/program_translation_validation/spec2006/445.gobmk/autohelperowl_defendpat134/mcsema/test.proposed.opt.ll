...
define %struct.Memory* @autohelperowl_defendpat134(%struct.State* noalias, i64, %struct.Memory* noalias readnone returned) local_unnamed_addr #1 {
entry:
  ...
  %RAX.i36 = getelementptr inbounds %union.anon, %union.anon* %18, i64 0, i32 0
  store i64 20, i64* %RAX.i36, align 8
  %19 = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 17, i32 0
  %R8D.i34 = bitcast %union.anon* %19 to i32*
  ...
  %55 = load i32, i32* %R8D.i34, align 4
  %56 = add i64 %48, -12
  %57 = add i64 %50, 7
  ...
  %85 = load i32, i32* %EAX.i14, align 4
  %86 = zext i32 %85 to i64
  store i64 %86, i64* %RDX.i, align 8
  %RCX.i = getelementptr inbounds %union.anon, %union.anon* %41, i64 0, i32 0
  %87 = load i64, i64* %21, align 8
  store i64 %87, i64* %RCX.i, align 8
  %88 = add i64 %50, -700581
  %89 = add i64 %50, 20
  ...
  %call2_4bd134 = tail call %struct.Memory* @sub_412080.accuratelib(%struct.State* %0, i64 %88, %struct.Memory* %2)
  %93 = load i32, i32* %EAX.i14, align 4
  ...
  %R10B.i9 = bitcast %union.anon* %102 to i8*
  %103 = icmp ne i32 %97, 0
  %104 = xor i1 %103, %101
  %.demorgan = or i1 %96, %104
  %105 = xor i1 %.demorgan, true
  %106 = zext i1 %105 to i8
  store i8 %106, i8* %R10B.i9, align 1
  ...
  ret %struct.Memory* %call2_4bd134
}
