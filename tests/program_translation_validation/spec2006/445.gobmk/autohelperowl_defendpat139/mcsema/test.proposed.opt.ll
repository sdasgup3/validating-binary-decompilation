...
define %struct.Memory* @autohelperowl_defendpat139(%struct.State* noalias, i64, %struct.Memory* noalias readnone) local_unnamed_addr #1 {
entry:
  ...
  %call2_4bd279 = tail call %struct.Memory* @sub_40f780.countlib(%struct.State* %0, i64 %167, %struct.Memory* %2)
  ...
  br i1 %204, label %block_.L_4bd2a1, label %block_4bd290

block_4bd290:                                     ; preds = %entry
  ...
  store i64 %211, i64* %RDI.i30, align 8
  %212 = add i64 %205, -711440
  %213 = add i64 %205, 8
  ...
  %call2_4bd293 = tail call %struct.Memory* @sub_40f780.countlib(%struct.State* nonnull %0, i64 %212, %struct.Memory* %call2_4bd279)
  %217 = load i32, i32* %EAX.i23, align 4
  %218 = load i64, i64* %3, align 8
  %219 = add i32 %217, -3
  %220 = icmp ult i32 %217, 3
  ...
  store i8 %232, i8* %CL.i25, align 1
...
block_.L_4bd2a1:                                  ; preds = %block_4bd290, %entry
  %244 = phi i64 [ %201, %entry ], [ %.pre, %block_4bd290 ]
  %MEMORY.0 = phi %struct.Memory* [ %call2_4bd279, %entry ], [ %call2_4bd293, %block_4bd290 ]
  ...
  store i64 %251, i64* %RAX.i54, align 8
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_jne_.L_4bd2a1(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i8* nocapture %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
