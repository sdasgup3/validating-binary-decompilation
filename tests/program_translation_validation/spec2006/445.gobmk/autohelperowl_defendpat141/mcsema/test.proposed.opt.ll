...
define %struct.Memory* @autohelperowl_defendpat141(%struct.State* noalias, i64, %struct.Memory* noalias readnone) local_unnamed_addr #1 {
entry:
  ...
  br i1 %137, label %block_4bd2f4, label %block_.L_4bd322

block_4bd2f4:                                     ; preds = %entry
  ...
  br i1 %193, label %block_.L_4bd369, label %block_4bd31d

block_4bd31d:                                     ; preds = %block_4bd2f4
  %195 = add i64 %194, 34
  store i64 %195, i64* %3, align 8
  %.pre3 = getelementptr inbounds %union.anon, %union.anon* %39, i64 0, i32 0
  br label %block_.L_4bd33f

block_.L_4bd322:                                  ; preds = %entry
  ...
  %call2_4bd329 = tail call %struct.Memory* @sub_45db40.attack(%struct.State* nonnull %0, i64 %202, %struct.Memory* %2)
  ...
  br i1 %226, label %block_.L_4bd322.block_.L_4bd369_crit_edge, label %block_.L_4bd322.block_.L_4bd33f_crit_edge

block_.L_4bd322.block_.L_4bd369_crit_edge:        ; preds = %block_.L_4bd322
  %.pre4 = bitcast %union.anon* %65 to i8*
  br label %block_.L_4bd369

block_.L_4bd322.block_.L_4bd33f_crit_edge:        ; preds = %block_.L_4bd322
  %.pre5 = getelementptr inbounds %union.anon, %union.anon* %51, i64 0, i32 0
  %.pre6 = bitcast %union.anon* %65 to i8*
  br label %block_.L_4bd33f

block_.L_4bd33f:                                  ; preds = %block_.L_4bd322.block_.L_4bd33f_crit_edge, %block_4bd31d
  %AL.i18.pre-phi = phi i8* [ %.pre6, %block_.L_4bd322.block_.L_4bd33f_crit_edge ], [ %AL.i66, %block_4bd31d ]
  %RDX.i.pre-phi = phi i64* [ %.pre5, %block_.L_4bd322.block_.L_4bd33f_crit_edge ], [ %RDX.i64, %block_4bd31d ]
  %RDI.i.pre-phi = phi i64* [ %RDI.i40, %block_.L_4bd322.block_.L_4bd33f_crit_edge ], [ %.pre3, %block_4bd31d ]
  %RSI.i.pre-phi = phi i64* [ %RSI.i44, %block_.L_4bd322.block_.L_4bd33f_crit_edge ], [ %RSI.i61, %block_4bd31d ]
  %228 = phi i64 [ %224, %block_.L_4bd322.block_.L_4bd33f_crit_edge ], [ %195, %block_4bd31d ]
  %MEMORY.0 = phi %struct.Memory* [ %call2_4bd329, %block_.L_4bd322.block_.L_4bd33f_crit_edge ], [ %2, %block_4bd31d ]
  ...
  %call2_4bd359 = tail call %struct.Memory* @sub_478110.play_attack_defend_n(%struct.State* nonnull %0, i64 %250, %struct.Memory* %MEMORY.0)
...
block_.L_4bd369:                                  ; preds = %block_.L_4bd322.block_.L_4bd369_crit_edge, %block_.L_4bd33f, %block_4bd2f4
  %AL.i9.pre-phi = phi i8* [ %.pre4, %block_.L_4bd322.block_.L_4bd369_crit_edge ], [ %AL.i18.pre-phi, %block_.L_4bd33f ], [ %AL.i66, %block_4bd2f4 ]
  %273 = phi i64 [ %223, %block_.L_4bd322.block_.L_4bd369_crit_edge ], [ %.pre, %block_.L_4bd33f ], [ %190, %block_4bd2f4 ]
  %MEMORY.1 = phi %struct.Memory* [ %call2_4bd329, %block_.L_4bd322.block_.L_4bd369_crit_edge ], [ %call2_4bd359, %block_.L_4bd33f ], [ %2, %block_4bd2f4 ]
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_jne_.L_4bd322(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i8* nocapture %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_jne_.L_4bd369(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i8* nocapture %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 2, i32 7
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_jmpq_.L_4bd33f(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
