...
define %struct.Memory* @autohelperowl_defendpat149(%struct.State* noalias, i64, %struct.Memory* noalias readnone) local_unnamed_addr #1 {
entry:
  ...
  %EDI.i94 = bitcast %union.anon* %39 to i32*
  %40 = add i64 %7, -12
  %41 = load i32, i32* %EDI.i94, align 4
  %42 = add i64 %10, 10
  ...
  br i1 %90, label %block_4bd633, label %block_.L_4bd664

block_4bd633:                                     ; preds = %entry
  %AL.i68 = bitcast %union.anon* %65 to i8*
  %CL.i69 = bitcast %union.anon* %58 to i8*
  store i8 0, i8* %CL.i69, align 1
  %RDX.i66 = getelementptr inbounds %union.anon, %union.anon* %51, i64 0, i32 0
  ...
  store i64 %99, i64* %RSI.i63, align 8
  %100 = lshr i64 %99, 63
  %101 = add i64 %99, ptrtoint (%G__0xb0eff0_type* @G__0xb0eff0 to i64)
  store i64 %101, i64* %RDX.i66, align 8
  ...
  %126 = add i64 %99, add (i64 ptrtoint (%G__0xb0eff0_type* @G__0xb0eff0 to i64), i64 180)
  %127 = add i64 %91, 35
  ...
  br i1 %146, label %block_4bd633.block_.L_4bd681_crit_edge, label %block_4bd65f

block_4bd633.block_.L_4bd681_crit_edge:           ; preds = %block_4bd633
  %.pre4 = getelementptr inbounds %union.anon, %union.anon* %39, i64 0, i32 0
  br label %block_.L_4bd681
...
block_.L_4bd664:                                  ; preds = %entry
  ...
  store i64 %154, i64* %RDI.i42, align 8
  %155 = add i64 %91, -339684
  %156 = add i64 %91, 12
  ...
  %call2_4bd66b = tail call %struct.Memory* @sub_46a780.find_defense(%struct.State* nonnull %0, i64 %155, %struct.Memory* %2)
  %160 = load i64, i64* %3, align 8
  store i64 0, i64* %RDI.i42, align 8
  %CL.i37 = bitcast %union.anon* %58 to i8*
  store i8 0, i8* %CL.i37, align 1
  %161 = load i32, i32* %EAX.i48, align 4
  store i8 0, i8* %14, align 1
  %162 = and i32 %161, 255
  ...
  %.v7 = select i1 %177, i64 43, i64 6
  %178 = add i64 %175, %.v7
  store i64 %178, i64* %3, align 8
  %cmpBr_4bd67b = icmp eq i8 %176, 1
  br i1 %cmpBr_4bd67b, label %block_.L_4bd664.block_.L_4bd6a6_crit_edge, label %block_.L_4bd664.block_.L_4bd681_crit_edge

block_.L_4bd664.block_.L_4bd6a6_crit_edge:        ; preds = %block_.L_4bd664
  %.pre3 = bitcast %union.anon* %65 to i8*
  br label %block_.L_4bd6a6

block_.L_4bd664.block_.L_4bd681_crit_edge:        ; preds = %block_.L_4bd664
  %.pre5 = getelementptr inbounds %union.anon, %union.anon* %51, i64 0, i32 0
  %.pre6 = bitcast %union.anon* %65 to i8*
  br label %block_.L_4bd681

block_.L_4bd681:                                  ; preds = %block_4bd633.block_.L_4bd681_crit_edge, %block_.L_4bd664.block_.L_4bd681_crit_edge
  %AL.i18.pre-phi = phi i8* [ %AL.i68, %block_4bd633.block_.L_4bd681_crit_edge ], [ %.pre6, %block_.L_4bd664.block_.L_4bd681_crit_edge ]
  %RDX.i.pre-phi = phi i64* [ %RDX.i66, %block_4bd633.block_.L_4bd681_crit_edge ], [ %.pre5, %block_.L_4bd664.block_.L_4bd681_crit_edge ]
  %RDI.i.pre-phi = phi i64* [ %.pre4, %block_4bd633.block_.L_4bd681_crit_edge ], [ %RDI.i42, %block_.L_4bd664.block_.L_4bd681_crit_edge ]
  %RSI.i.pre-phi = phi i64* [ %RSI.i63, %block_4bd633.block_.L_4bd681_crit_edge ], [ %RSI.i46, %block_.L_4bd664.block_.L_4bd681_crit_edge ]
  %179 = phi i64 [ %143, %block_4bd633.block_.L_4bd681_crit_edge ], [ %178, %block_.L_4bd664.block_.L_4bd681_crit_edge ]
  %MEMORY.0 = phi %struct.Memory* [ %2, %block_4bd633.block_.L_4bd681_crit_edge ], [ %call2_4bd66b, %block_.L_4bd664.block_.L_4bd681_crit_edge ]
  ...
  store i64 %190, i64* %RCX.i82, align 8
  ...
  %call2_4bd696 = tail call %struct.Memory* @sub_478110.play_attack_defend_n(%struct.State* nonnull %0, i64 %197, %struct.Memory* %MEMORY.0)
  %202 = load i32, i32* %EAX.i48, align 4
  ...
  store i8 0, i8* %38, align 1
  %213 = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 19, i32 0
  %R9B.i14 = bitcast %union.anon* %213 to i8*
  %214 = xor i1 %209, true
  %215 = zext i1 %214 to i8
  store i8 %215, i8* %R9B.i14, align 1
...
block_.L_4bd6a6:                                  ; preds = %block_.L_4bd664.block_.L_4bd6a6_crit_edge, %block_.L_4bd681, %block_4bd65f
  %AL.i9.pre-phi = phi i8* [ %.pre3, %block_.L_4bd664.block_.L_4bd6a6_crit_edge ], [ %AL.i18.pre-phi, %block_.L_4bd681 ], [ %AL.i68, %block_4bd65f ]
  %220 = phi i64 [ %178, %block_.L_4bd664.block_.L_4bd6a6_crit_edge ], [ %.pre, %block_.L_4bd681 ], [ %148, %block_4bd65f ]
  %MEMORY.1 = phi %struct.Memory* [ %call2_4bd66b, %block_.L_4bd664.block_.L_4bd6a6_crit_edge ], [ %call2_4bd696, %block_.L_4bd681 ], [ %2, %block_4bd65f ]
  ...
  %226 = and i8 %225, 1
  store i8 %226, i8* %AL.i9.pre-phi, align 1
  %227 = zext i8 %226 to i64
  store i64 %227, i64* %RAX.i84, align 8
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_jne_.L_4bd664(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i8* nocapture %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
...
; Function Attrs: nounwind
define %struct.Memory* @routine_cmpl__0x0__0xb4__rdx_(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned) local_unnamed_addr #3 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %RDX = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 7, i32 0, i32 0
  %3 = load i64, i64* %RDX, align 8
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_jne_.L_4bd681(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i8* nocapture %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 2, i32 7
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_jmpq_.L_4bd6a6(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_je_.L_4bd6a6(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i8* nocapture %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 2, i32 7
