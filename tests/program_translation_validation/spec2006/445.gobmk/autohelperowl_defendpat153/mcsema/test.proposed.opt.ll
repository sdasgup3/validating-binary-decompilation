...
define %struct.Memory* @autohelperowl_defendpat153(%struct.State* noalias, i64, %struct.Memory* noalias readnone) local_unnamed_addr #1 {
entry:
  ...
  %call2_4bd829 = tail call %struct.Memory* @sub_40f780.countlib(%struct.State* %0, i64 %167, %struct.Memory* %2)
  ...
  %207 = xor i1 %204, %206
  %208 = select i1 %207, i64 %202, i64 %201
  store i64 %208, i64* %3, align 8
  br i1 %207, label %block_4bd840, label %entry.block_.L_4bd865_crit_edge

entry.block_.L_4bd865_crit_edge:                  ; preds = %entry
  %.pre1 = bitcast %union.anon* %65 to i8*
  br label %block_.L_4bd865

block_4bd840:                                     ; preds = %entry
  ...
  store i64 %214, i64* %RDI.i42, align 8
  %215 = add i64 %209, -8
  %216 = add i64 %208, 11
  ...
  store i64 %219, i64* %RCX.i64, align 8
  ...
  %call2_4bd855 = tail call %struct.Memory* @sub_478110.play_attack_defend_n(%struct.State* nonnull %0, i64 %226, %struct.Memory* %call2_4bd829)
  %231 = load i32, i32* %EAX.i35, align 4
  ...
  %242 = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 19, i32 0
  %R9B.i14 = bitcast %union.anon* %242 to i8*
  %243 = xor i1 %238, true
  %244 = zext i1 %243 to i8
  store i8 %244, i8* %R9B.i14, align 1
...
block_.L_4bd865:                                  ; preds = %entry.block_.L_4bd865_crit_edge, %block_4bd840
  %AL.i9.pre-phi = phi i8* [ %.pre1, %entry.block_.L_4bd865_crit_edge ], [ %AL.i18, %block_4bd840 ]
  %249 = phi i64 [ %201, %entry.block_.L_4bd865_crit_edge ], [ %.pre, %block_4bd840 ]
  %MEMORY.0 = phi %struct.Memory* [ %call2_4bd829, %entry.block_.L_4bd865_crit_edge ], [ %call2_4bd855, %block_4bd840 ]
  ...
  %255 = and i8 %254, 1
  store i8 %255, i8* %AL.i9.pre-phi, align 1
  %256 = zext i8 %255 to i64
  store i64 %256, i64* %RAX.i66, align 8
  %257 = load i64, i64* %6, align 8
  %258 = add i64 %257, 32
  store i64 %258, i64* %6, align 8
  %259 = icmp ugt i64 %257, -33
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_jge_.L_4bd865(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i8* nocapture %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
