...
define %struct.Memory* @autohelperowl_defendpat159(%struct.State* noalias, i64, %struct.Memory* noalias readnone) local_unnamed_addr #1 {
entry:
  ...
  %call2_4bdb06 = tail call %struct.Memory* @sub_44d940.owl_topological_eye(%struct.State* %0, i64 %224, %struct.Memory* %2)
  ...
  %264 = xor i1 %261, %263
  %265 = select i1 %264, i64 %258, i64 %259
  store i64 %265, i64* %3, align 8
  br i1 %264, label %block_.L_4bdb3a, label %block_4bdb1d

block_4bdb1d:                                     ; preds = %entry
  ...
  store i64 %271, i64* %RDI.i41, align 8
  %272 = add i64 %266, -28
  %273 = add i64 %265, 7
  ...
  store i64 %276, i64* %RAX.i77, align 8
  ...
  store i64 %281, i64* %RSI.i36, align 8
  %282 = add i64 %265, -459229
  %283 = add i64 %265, 20
  ...
  %call2_4bdb2c = tail call %struct.Memory* @sub_44d940.owl_topological_eye(%struct.State* nonnull %0, i64 %282, %struct.Memory* %call2_4bdb06)
  %287 = load i32, i32* %EAX.i28, align 4
  ...
  store i8 %302, i8* %CL.i30, align 1
  %310 = load i64, i64* %RBP.i, align 8
  %311 = add i64 %310, -29
  %312 = add i64 %288, 9
  store i64 %312, i64* %3, align 8
  %313 = inttoptr i64 %311 to i8*
  store i8 %302, i8* %313, align 1
  %.pre = load i64, i64* %3, align 8
  br label %block_.L_4bdb3a

block_.L_4bdb3a:                                  ; preds = %block_4bdb1d, %entry
  %314 = phi i64 [ %258, %entry ], [ %.pre, %block_4bdb1d ]
  %MEMORY.0 = phi %struct.Memory* [ %call2_4bdb06, %entry ], [ %call2_4bdb2c, %block_4bdb1d ]
  ...
  store i64 %321, i64* %RAX.i77, align 8
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_jl_.L_4bdb3a(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i8* nocapture %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
