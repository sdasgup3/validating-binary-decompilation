...
define %struct.Memory* @autohelperowl_defendpat160(%struct.State* noalias, i64, %struct.Memory* noalias readnone) local_unnamed_addr #1 {
entry:
  ...
  %call2_4bdba6 = tail call %struct.Memory* @sub_44d940.owl_topological_eye(%struct.State* %0, i64 %224, %struct.Memory* %2)
  ...
  br i1 %261, label %entry.block_.L_4bdc02_crit_edge, label %block_4bdbbd

entry.block_.L_4bdc02_crit_edge:                  ; preds = %entry
...
block_4bdbbd:                                     ; preds = %entry
  ...
  %call2_4bdbcc = tail call %struct.Memory* @sub_44d940.owl_topological_eye(%struct.State* nonnull %0, i64 %279, %struct.Memory* %call2_4bdba6)
...
block_4bdbdf:                                     ; preds = %block_4bdbbd
  ...
  %call2_4bdbee = tail call %struct.Memory* @sub_44d940.owl_topological_eye(%struct.State* nonnull %0, i64 %331, %struct.Memory* %call2_4bdbcc)
...
block_.L_4bdbfc:                                  ; preds = %block_4bdbdf, %block_4bdbbd
  %363 = phi i64 [ %314, %block_4bdbbd ], [ %.pre, %block_4bdbdf ]
  %MEMORY.0 = phi %struct.Memory* [ %call2_4bdbcc, %block_4bdbbd ], [ %call2_4bdbee, %block_4bdbdf ]
...
block_.L_4bdc02:                                  ; preds = %entry.block_.L_4bdc02_crit_edge, %block_.L_4bdbfc
  %AL.i9.pre-phi = phi i8* [ %.pre3, %entry.block_.L_4bdc02_crit_edge ], [ %AL.i15, %block_.L_4bdbfc ]
  %372 = phi i64 [ %258, %entry.block_.L_4bdc02_crit_edge ], [ %.pre2, %block_.L_4bdbfc ]
  %MEMORY.1 = phi %struct.Memory* [ %call2_4bdba6, %entry.block_.L_4bdc02_crit_edge ], [ %MEMORY.0, %block_.L_4bdbfc ]
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_jne_.L_4bdc02(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i8* nocapture %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_je_.L_4bdbfc(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i8* nocapture %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 2, i32 7
