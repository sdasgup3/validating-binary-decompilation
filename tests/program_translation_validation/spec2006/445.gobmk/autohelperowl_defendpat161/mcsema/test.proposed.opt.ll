...
define %struct.Memory* @autohelperowl_defendpat161(%struct.State* noalias, i64, %struct.Memory* noalias readnone) local_unnamed_addr #1 {
entry:
  ...
  %ECX.i65 = bitcast %union.anon* %58 to i32*
  %59 = load i64, i64* %RBP.i, align 8
  %60 = add i64 %59, -16
  %61 = load i32, i32* %ECX.i65, align 4
  ...
  %RAX.i62 = getelementptr inbounds %union.anon, %union.anon* %65, i64 0, i32 0
  ...
  store i64 %72, i64* %RAX.i62, align 8
  %RCX.i60 = getelementptr inbounds %union.anon, %union.anon* %58, i64 0, i32 0
  %73 = shl nsw i64 %72, 2
  ...
  store i64 %78, i64* %RCX.i60, align 8
  %79 = add i64 %66, -8
  %80 = add i64 %68, 14
  ...
  store i64 %84, i64* %RCX.i60, align 8
  ...
  store i64 %125, i64* %RCX.i60, align 8
  %126 = add i64 %113, -8
  %127 = add i64 %115, 14
  ...
  store i64 %131, i64* %RCX.i60, align 8
  ...
  store i64 %166, i64* %RDI.i38, align 8
  %167 = add i64 %160, -24
  %168 = add i64 %162, 7
  ...
  store i64 %171, i64* %RAX.i62, align 8
  ...
  store i64 %176, i64* %RSI.i33, align 8
  %177 = add i64 %162, -459526
  %178 = add i64 %162, 20
  ...
  %call2_4bdc55 = tail call %struct.Memory* @sub_44d940.owl_topological_eye(%struct.State* %0, i64 %177, %struct.Memory* %2)
  %182 = load i64, i64* %3, align 8
  store i64 0, i64* %RCX.i60, align 8
  %183 = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 17, i32 0
  %R8B.i28 = bitcast %union.anon* %183 to i8*
  store i8 0, i8* %R8B.i28, align 1
  %EAX.i25 = bitcast %union.anon* %65 to i32*
  %184 = load i32, i32* %EAX.i25, align 4
  %185 = add i32 %184, -3
  ...
  br i1 %214, label %block_.L_4bdc80, label %block_4bdc6c
...
block_4bdc6c:                                     ; preds = %entry
  ...
  store i64 %221, i64* %RDI.i38, align 8
  %222 = add i64 %216, -24
  %223 = add i64 %215, 6
  ...
  store i64 %226, i64* %RSI.i33, align 8
  %227 = add i64 %215, -289196
  %228 = add i64 %215, 11
  ...
  %call2_4bdc72 = tail call %struct.Memory* @sub_4772c0.does_attack(%struct.State* nonnull %0, i64 %227, %struct.Memory* %call2_4bdc55)
  %232 = load i32, i32* %EAX.i25, align 4
  ...
  store i8 %244, i8* %CL.i27, align 1
...
block_.L_4bdc80:                                  ; preds = %block_4bdc6c, %entry
  %249 = phi i64 [ %211, %entry ], [ %.pre, %block_4bdc6c ]
  %MEMORY.0 = phi %struct.Memory* [ %call2_4bdc55, %entry ], [ %call2_4bdc72, %block_4bdc6c ]
  ...
  store i64 %256, i64* %RAX.i62, align 8
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_jne_.L_4bdc80(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i8* nocapture %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
