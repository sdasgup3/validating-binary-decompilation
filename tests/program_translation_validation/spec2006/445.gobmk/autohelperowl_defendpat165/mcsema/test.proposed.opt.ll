...
define %struct.Memory* @autohelperowl_defendpat165(%struct.State* noalias, i64, %struct.Memory* noalias readnone) local_unnamed_addr #1 {
entry:
  ...
  %call2_4bdf0a = tail call %struct.Memory* @sub_40f780.countlib(%struct.State* %0, i64 %214, %struct.Memory* %2)
  ...
  br i1 %251, label %block_.L_4bdf3e, label %block_4bdf21
...
block_4bdf21:                                     ; preds = %entry
  ...
  %call2_4bdf30 = tail call %struct.Memory* @sub_44d940.owl_topological_eye(%struct.State* nonnull %0, i64 %269, %struct.Memory* %call2_4bdf0a)
...
block_.L_4bdf3e:                                  ; preds = %block_4bdf21, %entry
  %301 = phi i64 [ %248, %entry ], [ %.pre, %block_4bdf21 ]
  %MEMORY.0 = phi %struct.Memory* [ %call2_4bdf0a, %entry ], [ %call2_4bdf30, %block_4bdf21 ]
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_jne_.L_4bdf3e(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i8* nocapture %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
