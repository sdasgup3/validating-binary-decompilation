...
define %struct.Memory* @autohelperowl_defendpat169(%struct.State* noalias, i64, %struct.Memory* noalias readnone) local_unnamed_addr #1 {
entry:
  ...
  %call2_4be0a8 = tail call %struct.Memory* @sub_44dd00.owl_big_eyespace(%struct.State* %0, i64 %120, %struct.Memory* %2)
  ...
  br i1 %145, label %block_.L_4be0d6, label %block_4be0bf

block_4be0bf:                                     ; preds = %entry
  ...
  %call2_4be0c5 = tail call %struct.Memory* @sub_445d10.obvious_false_eye(%struct.State* nonnull %0, i64 %158, %struct.Memory* %call2_4be0a8)
...
block_.L_4be0d6:                                  ; preds = %block_4be0bf, %entry
  %178 = phi i64 [ %142, %entry ], [ %.pre, %block_4be0bf ]
  %MEMORY.0 = phi %struct.Memory* [ %call2_4be0a8, %entry ], [ %call2_4be0c5, %block_4be0bf ]
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_jne_.L_4be0d6(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i8* nocapture %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
