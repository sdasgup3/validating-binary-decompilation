...
define %struct.Memory* @autohelperowl_defendpat171(%struct.State* noalias, i64, %struct.Memory* noalias readnone) local_unnamed_addr #1 {
entry:
  ...
  %call2_4be178 = tail call %struct.Memory* @sub_40f780.countlib(%struct.State* %0, i64 %120, %struct.Memory* %2)
  ...
  br i1 %157, label %block_.L_4be1a0, label %block_4be18f

block_4be18f:                                     ; preds = %entry
  ...
  %call2_4be192 = tail call %struct.Memory* @sub_4137f0.countstones(%struct.State* nonnull %0, i64 %165, %struct.Memory* %call2_4be178)
  %170 = load i32, i32* %EAX.i23, align 4
  %171 = load i64, i64* %3, align 8
  %172 = add i32 %170, -3
  %173 = icmp ult i32 %170, 3
  ...
  store i8 %196, i8* %CL.i25, align 1
  ...
  br label %block_.L_4be1a0

block_.L_4be1a0:                                  ; preds = %block_4be18f, %entry
  %201 = phi i64 [ %154, %entry ], [ %.pre, %block_4be18f ]
  %MEMORY.0 = phi %struct.Memory* [ %call2_4be178, %entry ], [ %call2_4be192, %block_4be18f ]
  ...
  store i64 %208, i64* %RAX.i42, align 8
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_jne_.L_4be1a0(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i8* nocapture %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
