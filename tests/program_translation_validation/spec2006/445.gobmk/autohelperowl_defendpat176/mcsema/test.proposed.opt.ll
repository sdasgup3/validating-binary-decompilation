...
define %struct.Memory* @autohelperowl_defendpat176(%struct.State* noalias, i64, %struct.Memory* noalias readnone) local_unnamed_addr #1 {
entry:
  ...
  %call2_4be378 = tail call %struct.Memory* @sub_44dbb0.owl_eyespace(%struct.State* %0, i64 %120, %struct.Memory* %2)
...
block_4be38f:                                     ; preds = %entry
  ...
  %call2_4be392 = tail call %struct.Memory* @sub_44dd00.owl_big_eyespace(%struct.State* nonnull %0, i64 %151, %struct.Memory* %call2_4be378)
  ...
  store i8 %161, i8* %CL.i27, align 1
  store i8 0, i8* %14, align 1
...
block_.L_4be3a3:                                  ; preds = %block_4be38f, %entry
  %171 = phi i64 [ %144, %entry ], [ %.pre, %block_4be38f ]
  %MEMORY.0 = phi %struct.Memory* [ %call2_4be378, %entry ], [ %call2_4be392, %block_4be38f ]
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_je_.L_4be3a3(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i8* nocapture %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
