...
define %struct.Memory* @autohelperowl_defendpat179(%struct.State* noalias, i64, %struct.Memory* noalias readnone returned) local_unnamed_addr #1 {
entry:
  ...
  %call2_4be458 = tail call %struct.Memory* @sub_44de50.owl_proper_eye(%struct.State* %0, i64 %119, %struct.Memory* %2)
  ...
  ret %struct.Memory* %call2_4be458
}
