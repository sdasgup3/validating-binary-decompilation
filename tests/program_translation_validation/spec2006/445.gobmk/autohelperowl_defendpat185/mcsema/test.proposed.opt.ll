...
define %struct.Memory* @autohelperowl_defendpat185(%struct.State* noalias, i64, %struct.Memory* noalias readnone returned) local_unnamed_addr #1 {
entry:
  ...
  %call2_4be49b = tail call %struct.Memory* @sub_445d10.obvious_false_eye(%struct.State* %0, i64 %125, %struct.Memory* %2)
  ...
  ret %struct.Memory* %call2_4be49b
}
