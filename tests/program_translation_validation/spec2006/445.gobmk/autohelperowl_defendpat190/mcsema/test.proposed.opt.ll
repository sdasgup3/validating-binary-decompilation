...
define %struct.Memory* @autohelperowl_defendpat190(%struct.State* noalias, i64, %struct.Memory* noalias readnone) local_unnamed_addr #1 {
entry:
  ...
  br i1 %185, label %block_4be515, label %block_.L_4be543
...
block_4be515:                                     ; preds = %entry
  ...
  br i1 %241, label %block_4be515.block_.L_4be560_crit_edge, label %block_4be53e

block_4be515.block_.L_4be560_crit_edge:           ; preds = %block_4be515
  %.pre5 = getelementptr inbounds %union.anon, %union.anon* %40, i64 0, i32 0
  br label %block_.L_4be560
...
block_.L_4be543:                                  ; preds = %entry
  ...
  %call2_4be54a = tail call %struct.Memory* @sub_45db40.attack(%struct.State* nonnull %0, i64 %250, %struct.Memory* %2)
  ...
  %.v7 = select i1 %272, i64 55, i64 6
  %273 = add i64 %270, %.v7
  store i64 %273, i64* %3, align 8
  %cmpBr_4be55a = icmp eq i8 %271, 1
  br i1 %cmpBr_4be55a, label %block_.L_4be543.block_.L_4be591_crit_edge, label %block_.L_4be543.block_.L_4be560_crit_edge

block_.L_4be543.block_.L_4be591_crit_edge:        ; preds = %block_.L_4be543
  %.pre3 = bitcast %union.anon* %66 to i8*
  br label %block_.L_4be591

block_.L_4be543.block_.L_4be560_crit_edge:        ; preds = %block_.L_4be543
  %.pre4 = getelementptr inbounds %union.anon, %union.anon* %52, i64 0, i32 0
  %.pre6 = bitcast %union.anon* %66 to i8*
  br label %block_.L_4be560

block_.L_4be560:                                  ; preds = %block_4be515.block_.L_4be560_crit_edge, %block_.L_4be543.block_.L_4be560_crit_edge
  %AL.i20.pre-phi = phi i8* [ %AL.i74, %block_4be515.block_.L_4be560_crit_edge ], [ %.pre6, %block_.L_4be543.block_.L_4be560_crit_edge ]
  %RDI.i.pre-phi = phi i64* [ %.pre5, %block_4be515.block_.L_4be560_crit_edge ], [ %RDI.i48, %block_.L_4be543.block_.L_4be560_crit_edge ]
  %RDX.i.pre-phi = phi i64* [ %RDX.i72, %block_4be515.block_.L_4be560_crit_edge ], [ %.pre4, %block_.L_4be543.block_.L_4be560_crit_edge ]
  %RSI.i.pre-phi = phi i64* [ %RSI.i69, %block_4be515.block_.L_4be560_crit_edge ], [ %RSI.i52, %block_.L_4be543.block_.L_4be560_crit_edge ]
  %274 = phi i64 [ %238, %block_4be515.block_.L_4be560_crit_edge ], [ %273, %block_.L_4be543.block_.L_4be560_crit_edge ]
  %MEMORY.0 = phi %struct.Memory* [ %2, %block_4be515.block_.L_4be560_crit_edge ], [ %call2_4be54a, %block_.L_4be543.block_.L_4be560_crit_edge ]
  ...
  store i64 %285, i64* %RCX.i112, align 8
  ...
  %call2_4be57d = tail call %struct.Memory* @sub_478110.play_attack_defend_n(%struct.State* nonnull %0, i64 %307, %struct.Memory* %MEMORY.0)
...
block_.L_4be591:                                  ; preds = %block_.L_4be543.block_.L_4be591_crit_edge, %block_.L_4be560, %block_4be53e
  %AL.i9.pre-phi = phi i8* [ %.pre3, %block_.L_4be543.block_.L_4be591_crit_edge ], [ %AL.i20.pre-phi, %block_.L_4be560 ], [ %AL.i74, %block_4be53e ]
  %328 = phi i64 [ %273, %block_.L_4be543.block_.L_4be591_crit_edge ], [ %.pre, %block_.L_4be560 ], [ %243, %block_4be53e ]
  %MEMORY.1 = phi %struct.Memory* [ %call2_4be54a, %block_.L_4be543.block_.L_4be591_crit_edge ], [ %call2_4be57d, %block_.L_4be560 ], [ %2, %block_4be53e ]
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_jne_.L_4be543(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i8* nocapture %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_jne_.L_4be560(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i8* nocapture %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 2, i32 7
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_jmpq_.L_4be591(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_je_.L_4be591(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i8* nocapture %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 2, i32 7
