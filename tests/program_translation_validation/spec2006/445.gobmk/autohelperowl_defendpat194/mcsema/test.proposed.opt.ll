...
define %struct.Memory* @autohelperowl_defendpat194(%struct.State* noalias, i64, %struct.Memory* noalias readnone returned) local_unnamed_addr #1 {
entry:
  ...
  store i64 %110, i64* %RDX.i26, align 8
  %111 = add i64 %96, 13
  ...
  %call2_4be759 = tail call %struct.Memory* @sub_478110.play_attack_defend_n(%struct.State* %0, i64 %128, %struct.Memory* %2)
  ...
  ret %struct.Memory* %call2_4be759
}
