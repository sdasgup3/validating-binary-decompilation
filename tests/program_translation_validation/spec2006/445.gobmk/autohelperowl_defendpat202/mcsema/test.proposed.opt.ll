...
define %struct.Memory* @autohelperowl_defendpat202(%struct.State* noalias, i64, %struct.Memory* noalias readnone) local_unnamed_addr #1 {
entry:
  ...
  br i1 %90, label %block_4be7b3, label %block_.L_4be7e1
...
block_4be7b3:                                     ; preds = %entry
  ...
  br i1 %146, label %block_4be7b3.block_.L_4be7fe_crit_edge, label %block_4be7dc

block_4be7b3.block_.L_4be7fe_crit_edge:           ; preds = %block_4be7b3
  %.pre4 = getelementptr inbounds %union.anon, %union.anon* %39, i64 0, i32 0
  br label %block_.L_4be7fe
...
block_.L_4be7e1:                                  ; preds = %entry
  ...
  %call2_4be7e8 = tail call %struct.Memory* @sub_45db40.attack(%struct.State* nonnull %0, i64 %155, %struct.Memory* %2)
  ...
  %cmpBr_4be7f8 = icmp eq i8 %176, 1
  br i1 %cmpBr_4be7f8, label %block_.L_4be7e1.block_.L_4be827_crit_edge, label %block_.L_4be7e1.block_.L_4be7fe_crit_edge

block_.L_4be7e1.block_.L_4be827_crit_edge:        ; preds = %block_.L_4be7e1
  %.pre3 = bitcast %union.anon* %65 to i8*
  br label %block_.L_4be827

block_.L_4be7e1.block_.L_4be7fe_crit_edge:        ; preds = %block_.L_4be7e1
  %.pre5 = getelementptr inbounds %union.anon, %union.anon* %51, i64 0, i32 0
  %.pre6 = bitcast %union.anon* %65 to i8*
  br label %block_.L_4be7fe

block_.L_4be7fe:                                  ; preds = %block_4be7b3.block_.L_4be7fe_crit_edge, %block_.L_4be7e1.block_.L_4be7fe_crit_edge
  %AL.i20.pre-phi = phi i8* [ %AL.i70, %block_4be7b3.block_.L_4be7fe_crit_edge ], [ %.pre6, %block_.L_4be7e1.block_.L_4be7fe_crit_edge ]
  %RDX.i.pre-phi = phi i64* [ %RDX.i68, %block_4be7b3.block_.L_4be7fe_crit_edge ], [ %.pre5, %block_.L_4be7e1.block_.L_4be7fe_crit_edge ]
  %RDI.i.pre-phi = phi i64* [ %.pre4, %block_4be7b3.block_.L_4be7fe_crit_edge ], [ %RDI.i44, %block_.L_4be7e1.block_.L_4be7fe_crit_edge ]
  %RSI.i.pre-phi = phi i64* [ %RSI.i65, %block_4be7b3.block_.L_4be7fe_crit_edge ], [ %RSI.i48, %block_.L_4be7e1.block_.L_4be7fe_crit_edge ]
  %179 = phi i64 [ %143, %block_4be7b3.block_.L_4be7fe_crit_edge ], [ %178, %block_.L_4be7e1.block_.L_4be7fe_crit_edge ]
  %MEMORY.0 = phi %struct.Memory* [ %2, %block_4be7b3.block_.L_4be7fe_crit_edge ], [ %call2_4be7e8, %block_.L_4be7e1.block_.L_4be7fe_crit_edge ]
  ...
  %call2_4be813 = tail call %struct.Memory* @sub_478110.play_attack_defend_n(%struct.State* nonnull %0, i64 %197, %struct.Memory* %MEMORY.0)
...
block_.L_4be827:                                  ; preds = %block_.L_4be7e1.block_.L_4be827_crit_edge, %block_.L_4be7fe, %block_4be7dc
  %AL.i9.pre-phi = phi i8* [ %.pre3, %block_.L_4be7e1.block_.L_4be827_crit_edge ], [ %AL.i20.pre-phi, %block_.L_4be7fe ], [ %AL.i70, %block_4be7dc ]
  %218 = phi i64 [ %178, %block_.L_4be7e1.block_.L_4be827_crit_edge ], [ %.pre, %block_.L_4be7fe ], [ %148, %block_4be7dc ]
  %MEMORY.1 = phi %struct.Memory* [ %call2_4be7e8, %block_.L_4be7e1.block_.L_4be827_crit_edge ], [ %call2_4be813, %block_.L_4be7fe ], [ %2, %block_4be7dc ]
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_jne_.L_4be7e1(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i8* nocapture %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_jne_.L_4be7fe(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i8* nocapture %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 2, i32 7
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_jmpq_.L_4be827(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_je_.L_4be827(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i8* nocapture %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 2, i32 7
