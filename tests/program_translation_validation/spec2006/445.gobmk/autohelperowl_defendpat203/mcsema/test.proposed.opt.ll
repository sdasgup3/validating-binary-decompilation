...
define %struct.Memory* @autohelperowl_defendpat203(%struct.State* noalias, i64, %struct.Memory* noalias readnone returned) local_unnamed_addr #1 {
entry:
  ...
  %call2_4be885 = tail call %struct.Memory* @sub_478110.play_attack_defend_n(%struct.State* %0, i64 %124, %struct.Memory* %2)
  ...
  ret %struct.Memory* %call2_4be885
}
