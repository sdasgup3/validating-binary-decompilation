...
define %struct.Memory* @autohelperowl_defendpat218(%struct.State* noalias, i64, %struct.Memory* noalias readnone returned) local_unnamed_addr #1 {
entry:
  ...
  %call2_4beb28 = tail call %struct.Memory* @sub_40f780.countlib(%struct.State* %0, i64 %120, %struct.Memory* %2)
  %EAX.i = bitcast %union.anon* %65 to i32*
  %125 = load i32, i32* %EAX.i, align 4
  %126 = load i64, i64* %3, align 8
  %127 = icmp eq i32 %125, 2
  %128 = zext i1 %127 to i8
  %129 = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 17, i32 0
  %R8B.i9 = bitcast %union.anon* %129 to i8*
  store i8 %128, i8* %R8B.i9, align 1
  %130 = zext i1 %127 to i64
  store i64 %130, i64* %RAX.i22, align 8
  ...
  ret %struct.Memory* %call2_4beb28
}
