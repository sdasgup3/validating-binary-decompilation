...
define %struct.Memory* @autohelperowl_defendpat239(%struct.State* noalias, i64, %struct.Memory* noalias readnone returned) local_unnamed_addr #1 {
entry:
  ...
  %call2_4beffb = tail call %struct.Memory* @sub_477710.somewhere(%struct.State* %0, i64 %290, %struct.Memory* %2)
  ...
  ret %struct.Memory* %call2_4beffb
}
