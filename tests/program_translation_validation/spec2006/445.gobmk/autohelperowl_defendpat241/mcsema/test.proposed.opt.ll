...
define %struct.Memory* @autohelperowl_defendpat241(%struct.State* noalias, i64, %struct.Memory* noalias readnone) local_unnamed_addr #1 {
entry:
  ...
  %call2_4bf128 = tail call %struct.Memory* @sub_40f780.countlib(%struct.State* %0, i64 %120, %struct.Memory* %2)
  ...
  br i1 %157, label %block_.L_4bf150, label %block_4bf13f
...
block_4bf13f:                                     ; preds = %entry
  ...
  %call2_4bf142 = tail call %struct.Memory* @sub_4137f0.countstones(%struct.State* nonnull %0, i64 %165, %struct.Memory* %call2_4bf128)
  %170 = load i32, i32* %EAX.i23, align 4
  %171 = load i64, i64* %3, align 8
  %172 = add i32 %170, -2
  %173 = icmp ult i32 %170, 2
  ...
  %194 = xor i1 %193, %191
  %.demorgan = or i1 %184, %194
  %195 = xor i1 %.demorgan, true
...
block_.L_4bf150:                                  ; preds = %block_4bf13f, %entry
  %201 = phi i64 [ %154, %entry ], [ %.pre, %block_4bf13f ]
  %MEMORY.0 = phi %struct.Memory* [ %call2_4bf128, %entry ], [ %call2_4bf142, %block_4bf13f ]
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_jne_.L_4bf150(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i8* nocapture %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
