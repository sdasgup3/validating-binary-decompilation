...
define %struct.Memory* @autohelperowl_defendpat244(%struct.State* noalias, i64, %struct.Memory* noalias readnone) local_unnamed_addr #1 {
entry:
  ...
  store i64 0, i64* %RAX.i85, align 8
  ...
  br i1 %90, label %block_4bf253, label %block_.L_4bf281

block_4bf253:                                     ; preds = %entry
  %CL.i70 = bitcast %union.anon* %58 to i8*
  store i8 0, i8* %CL.i70, align 1
  ...
  store i64 %99, i64* %RSI.i64, align 8
  %100 = lshr i64 %99, 63
  %101 = add i64 %99, ptrtoint (%G__0xb0eff0_type* @G__0xb0eff0 to i64)
  store i64 %101, i64* %RDX.i67, align 8
  ...
  br i1 %146, label %block_.L_4bf2c4, label %block_4bf27c

block_4bf27c:                                     ; preds = %block_4bf253
  %148 = add i64 %147, 34
  store i64 %148, i64* %3, align 8
  %.pre3 = getelementptr inbounds %union.anon, %union.anon* %39, i64 0, i32 0
  br label %block_.L_4bf29e

block_.L_4bf281:                                  ; preds = %entry
  %RSI.i47 = getelementptr inbounds %union.anon, %union.anon* %44, i64 0, i32 0
  ...
  store i64 %154, i64* %RDI.i43, align 8
  %155 = add i64 %91, -399169
  %156 = add i64 %91, 12
  ...
  %call2_4bf288 = tail call %struct.Memory* @sub_45db40.attack(%struct.State* nonnull %0, i64 %155, %struct.Memory* %2)
  %160 = load i64, i64* %3, align 8
  store i64 0, i64* %RDI.i43, align 8
  %CL.i38 = bitcast %union.anon* %58 to i8*
  store i8 0, i8* %CL.i38, align 1
  %161 = load i32, i32* %EAX.i49, align 4
  store i8 0, i8* %14, align 1
  %162 = and i32 %161, 255
  ...
  br i1 %179, label %block_.L_4bf2c4, label %block_.L_4bf281.block_.L_4bf29e_crit_edge

block_.L_4bf281.block_.L_4bf29e_crit_edge:        ; preds = %block_.L_4bf281
  %.pre4 = getelementptr inbounds %union.anon, %union.anon* %51, i64 0, i32 0
  br label %block_.L_4bf29e

block_.L_4bf29e:                                  ; preds = %block_.L_4bf281.block_.L_4bf29e_crit_edge, %block_4bf27c
  %RDX.i.pre-phi = phi i64* [ %.pre4, %block_.L_4bf281.block_.L_4bf29e_crit_edge ], [ %RDX.i67, %block_4bf27c ]
  %RSI.i.pre-phi = phi i64* [ %RSI.i47, %block_.L_4bf281.block_.L_4bf29e_crit_edge ], [ %RSI.i64, %block_4bf27c ]
  %RDI.i.pre-phi = phi i64* [ %RDI.i43, %block_.L_4bf281.block_.L_4bf29e_crit_edge ], [ %.pre3, %block_4bf27c ]
  %181 = phi i64 [ %177, %block_.L_4bf281.block_.L_4bf29e_crit_edge ], [ %148, %block_4bf27c ]
  %MEMORY.0 = phi %struct.Memory* [ %call2_4bf288, %block_.L_4bf281.block_.L_4bf29e_crit_edge ], [ %2, %block_4bf27c ]
  store i64 20, i64* %RDX.i.pre-phi, align 8
  store i8 0, i8* %14, align 1
  store i8 1, i8* %21, align 1
  store i8 1, i8* %29, align 1
  store i8 0, i8* %32, align 1
  ...
  store i64 %193, i64* %RAX.i85, align 8
  ...
  store i64 %193, i64* %RSI.i.pre-phi, align 8
  %213 = add i64 %181, -709150
  %214 = add i64 %181, 27
  ...
  %call2_4bf2b4 = tail call %struct.Memory* @sub_412080.accuratelib(%struct.State* nonnull %0, i64 %213, %struct.Memory* %MEMORY.0)
  ...
  %R8B.i14 = bitcast %union.anon* %241 to i8*
  %242 = icmp ne i8 %235, 0
  %243 = xor i1 %242, %239
  %.demorgan = or i1 %232, %243
  %244 = xor i1 %.demorgan, true
  %245 = zext i1 %244 to i8
  store i8 %245, i8* %R8B.i14, align 1
...
block_.L_4bf2c4:                                  ; preds = %block_.L_4bf29e, %block_.L_4bf281, %block_4bf253
  %250 = phi i64 [ %176, %block_.L_4bf281 ], [ %.pre, %block_.L_4bf29e ], [ %143, %block_4bf253 ]
  %MEMORY.1 = phi %struct.Memory* [ %call2_4bf288, %block_.L_4bf281 ], [ %call2_4bf2b4, %block_.L_4bf29e ], [ %2, %block_4bf253 ]
  ...
  store i64 %257, i64* %RAX.i85, align 8
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_jne_.L_4bf281(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i8* nocapture %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_jne_.L_4bf2c4(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i8* nocapture %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 2, i32 7
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_jmpq_.L_4bf29e(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
