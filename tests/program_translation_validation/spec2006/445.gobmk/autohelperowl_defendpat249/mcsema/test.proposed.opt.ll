...
define %struct.Memory* @autohelperowl_defendpat249(%struct.State* noalias, i64, %struct.Memory* noalias readnone) local_unnamed_addr #1 {
entry:
  ...
  %EDI.i121 = bitcast %union.anon* %40 to i32*
  %41 = add i64 %7, -12
  %42 = load i32, i32* %EDI.i121, align 4
  %43 = add i64 %10, 10
  ...
  %EDX.i116 = bitcast %union.anon* %52 to i32*
  %53 = load i64, i64* %RBP.i, align 8
  %54 = add i64 %53, -12
  %55 = load i32, i32* %EDX.i116, align 4
  ...
  store i64 %214, i64* %RDI.i74, align 8
  %215 = add i64 %210, -720455
  %216 = add i64 %210, 8
  ...
  %call2_4bf5ca = tail call %struct.Memory* @sub_40f780.countlib(%struct.State* %0, i64 %215, %struct.Memory* %2)
  ...
  %R8B.i69 = bitcast %union.anon* %221 to i8*
  store i8 0, i8* %R8B.i69, align 1
  %EAX.i66 = bitcast %union.anon* %66 to i32*
  %222 = load i32, i32* %EAX.i66, align 4
  %223 = add i32 %222, -1
  ...
  br i1 %258, label %block_.L_4bf649, label %block_4bf5e1

block_4bf5e1:                                     ; preds = %entry
  ...
  store i64 %265, i64* %RDI.i74, align 8
  %266 = add i64 %259, -720481
  %267 = add i64 %259, 8
  ...
  %call2_4bf5e4 = tail call %struct.Memory* @sub_40f780.countlib(%struct.State* nonnull %0, i64 %266, %struct.Memory* %call2_4bf5ca)
  %271 = load i64, i64* %3, align 8
  store i64 0, i64* %RDI.i74, align 8
  store i8 0, i8* %CL.i68, align 1
  %272 = load i32, i32* %EAX.i66, align 4
  %273 = add i32 %272, -1
  ...
  %303 = load i8, i8* %33, align 1
  %304 = icmp ne i8 %303, 0
  %305 = load i8, i8* %39, align 1
  %306 = icmp ne i8 %305, 0
  %307 = xor i1 %304, %306
  %308 = or i1 %302, %307
  %309 = select i1 %308, i64 %299, i64 %300
  store i64 %309, i64* %3, align 8
  br i1 %308, label %block_.L_4bf649, label %block_4bf5fa

block_4bf5fa:                                     ; preds = %block_4bf5e1
  ...
  %.v = select i1 %316, i64 14, i64 49
  %320 = add i64 %309, %.v
  store i64 %320, i64* %3, align 8
  br i1 %316, label %block_4bf608, label %block_.L_4bf62b

block_4bf608:                                     ; preds = %block_4bf5fa
  store i64 ptrtoint (%G__0xb0eff0_type* @G__0xb0eff0 to i64), i64* %RAX.i110, align 8
  ...
  store i64 %327, i64* %RCX.i108, align 8
  %328 = lshr i64 %327, 63
  %329 = add i64 %327, ptrtoint (%G__0xb0eff0_type* @G__0xb0eff0 to i64)
  store i64 %329, i64* %RAX.i110, align 8
  ...
  %354 = add i64 %327, add (i64 ptrtoint (%G__0xb0eff0_type* @G__0xb0eff0 to i64), i64 100)
  %355 = add i64 %320, 27
  ...
  br label %block_.L_4bf63a

block_.L_4bf62b:                                  ; preds = %block_4bf5fa
  ...
  store i64 %369, i64* %RDI.i74, align 8
  %370 = add i64 %320, -400107
  %371 = add i64 %320, 12
  ...
  %call2_4bf632 = tail call %struct.Memory* @sub_45db40.attack(%struct.State* nonnull %0, i64 %370, %struct.Memory* %call2_4bf5e4)
  %375 = load i64, i64* %RBP.i, align 8
  %376 = add i64 %375, -36
  %377 = load i32, i32* %EAX.i66, align 4
...
block_.L_4bf63a:                                  ; preds = %block_.L_4bf62b, %block_4bf608
  %381 = phi i64 [ %.pre, %block_.L_4bf62b ], [ %363, %block_4bf608 ]
  %MEMORY.0 = phi %struct.Memory* [ %call2_4bf632, %block_.L_4bf62b ], [ %call2_4bf5e4, %block_4bf608 ]
  ...
  store i64 %387, i64* %RAX.i110, align 8
  %388 = icmp ne i32 %386, 0
  %389 = zext i1 %388 to i64
  %390 = xor i64 %389, 255
  %391 = trunc i64 %390 to i8
  store i8 %391, i8* %CL.i68, align 1
  store i8 0, i8* %14, align 1
  ...
  br label %block_.L_4bf649

block_.L_4bf649:                                  ; preds = %block_.L_4bf63a, %block_4bf5e1, %entry
  %400 = phi i64 [ %249, %entry ], [ %299, %block_4bf5e1 ], [ %.pre3, %block_.L_4bf63a ]
  %MEMORY.1 = phi %struct.Memory* [ %call2_4bf5ca, %entry ], [ %call2_4bf5e4, %block_4bf5e1 ], [ %MEMORY.0, %block_.L_4bf63a ]
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_jle_.L_4bf649(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i8* nocapture %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_jne_.L_4bf62b(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i8* nocapture %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 2, i32 7
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_jmpq_.L_4bf63a(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
