...
define %struct.Memory* @autohelperowl_defendpat250(%struct.State* noalias, i64, %struct.Memory* noalias readnone) local_unnamed_addr #1 {
entry:
  ...
  %EDI.i86 = bitcast %union.anon* %39 to i32*
  %40 = add i64 %7, -12
  %41 = load i32, i32* %EDI.i86, align 4
  %42 = add i64 %10, 10
  ...
  %call2_4bf699 = tail call %struct.Memory* @sub_44da20.owl_escape_value(%struct.State* %0, i64 %167, %struct.Memory* %2)
  %EAX.i51 = bitcast %union.anon* %65 to i32*
  %172 = load i32, i32* %EAX.i51, align 4
  ...
  %185 = and i1 %184, %183
  %.v = select i1 %185, i64 34, i64 9
  %186 = add i64 %173, %.v
  store i64 %186, i64* %3, align 8
  br i1 %185, label %entry.block_.L_4bf6c0_crit_edge, label %block_4bf6a7

entry.block_.L_4bf6c0_crit_edge:                  ; preds = %entry
  %.pre3 = bitcast %union.anon* %58 to i8*
  br label %block_.L_4bf6c0
...
block_4bf6a7:                                     ; preds = %entry
  ...
  store i64 %192, i64* %RDI.i54, align 8
  %193 = add i64 %186, -466055
  %194 = add i64 %186, 8
  ...
  %call2_4bf6aa = tail call %struct.Memory* @sub_44da20.owl_escape_value(%struct.State* nonnull %0, i64 %193, %struct.Memory* %call2_4bf699)
  %198 = load i64, i64* %3, align 8
  store i64 0, i64* %RDI.i54, align 8
  %CL.i40 = bitcast %union.anon* %58 to i8*
  store i8 0, i8* %CL.i40, align 1
  %199 = load i32, i32* %EAX.i51, align 4
  store i8 0, i8* %14, align 1
  %200 = and i32 %199, 255
  ...
  %218 = load i8, i8* %32, align 1
  %219 = icmp ne i8 %218, 0
  %220 = load i8, i8* %38, align 1
  %221 = icmp ne i8 %220, 0
  %222 = xor i1 %219, %221
  %223 = or i1 %217, %222
  %224 = select i1 %223, i64 %214, i64 %215
  store i64 %224, i64* %3, align 8
  br i1 %223, label %block_.L_4bf6ea, label %block_.L_4bf6c0

block_.L_4bf6c0:                                  ; preds = %entry.block_.L_4bf6c0_crit_edge, %block_4bf6a7
  %CL.i26.pre-phi = phi i8* [ %.pre3, %entry.block_.L_4bf6c0_crit_edge ], [ %CL.i40, %block_4bf6a7 ]
  %225 = phi i64 [ %186, %entry.block_.L_4bf6c0_crit_edge ], [ %215, %block_4bf6a7 ]
  %MEMORY.0 = phi %struct.Memory* [ %call2_4bf699, %entry.block_.L_4bf6c0_crit_edge ], [ %call2_4bf6aa, %block_4bf6a7 ]
  ...
  store i64 %231, i64* %RDI.i54, align 8
  %232 = add i64 %225, -720704
  %233 = add i64 %225, 8
  ...
  %call2_4bf6c3 = tail call %struct.Memory* @sub_40f780.countlib(%struct.State* nonnull %0, i64 %232, %struct.Memory* %MEMORY.0)
  %237 = load i64, i64* %3, align 8
  store i64 0, i64* %RDI.i54, align 8
  store i8 0, i8* %CL.i26.pre-phi, align 1
  %238 = load i32, i32* %EAX.i51, align 4
  %239 = add i32 %238, -1
  ...
  %269 = load i8, i8* %32, align 1
  %270 = icmp ne i8 %269, 0
  %271 = load i8, i8* %38, align 1
  %272 = icmp ne i8 %271, 0
  %273 = xor i1 %270, %272
  %274 = or i1 %268, %273
  %275 = select i1 %274, i64 %265, i64 %266
  store i64 %275, i64* %3, align 8
  br i1 %274, label %block_.L_4bf6ea, label %block_4bf6d9
...
block_4bf6d9:                                     ; preds = %block_.L_4bf6c0
  ...
  store i64 %281, i64* %RDI.i54, align 8
  %282 = add i64 %275, -720729
  %283 = add i64 %275, 8
  ...
  %call2_4bf6dc = tail call %struct.Memory* @sub_40f780.countlib(%struct.State* nonnull %0, i64 %282, %struct.Memory* %call2_4bf6c3)
  %287 = load i32, i32* %EAX.i51, align 4
  ...
  %311 = xor i1 %310, %308
  %.demorgan = or i1 %301, %311
  %312 = xor i1 %.demorgan, true
  %313 = zext i1 %312 to i8
  store i8 %313, i8* %CL.i26.pre-phi, align 1
...
block_.L_4bf6ea:                                  ; preds = %block_4bf6d9, %block_.L_4bf6c0, %block_4bf6a7
  %318 = phi i64 [ %265, %block_.L_4bf6c0 ], [ %.pre, %block_4bf6d9 ], [ %214, %block_4bf6a7 ]
  %MEMORY.1 = phi %struct.Memory* [ %call2_4bf6c3, %block_.L_4bf6c0 ], [ %call2_4bf6dc, %block_4bf6d9 ], [ %call2_4bf6aa, %block_4bf6a7 ]
  ...
  store i64 %325, i64* %RAX.i76, align 8
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_jg_.L_4bf6c0(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i8* nocapture %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_jle_.L_4bf6ea(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i8* nocapture %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 2, i32 7
