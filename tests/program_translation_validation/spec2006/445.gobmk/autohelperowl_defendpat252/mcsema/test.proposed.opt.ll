...
define %struct.Memory* @autohelperowl_defendpat252(%struct.State* noalias, i64, %struct.Memory* noalias readnone) local_unnamed_addr #1 {
entry:
  ...
  %EDI.i91 = bitcast %union.anon* %39 to i32*
  %40 = add i64 %7, -12
  %41 = load i32, i32* %EDI.i91, align 4
  %42 = add i64 %10, 10
  store i64 %42, i64* %3, align 8
  %43 = inttoptr i64 %40 to i32*
  store i32 %41, i32* %43, align 4
  %44 = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 9, i32 0
  %ESI.i88 = bitcast %union.anon* %44 to i32*
  %45 = load i64, i64* %RBP.i, align 8
  %46 = add i64 %45, -8
  %47 = load i32, i32* %ESI.i88, align 4
  ...
  store i64 %166, i64* %RDI.i56, align 8
  %167 = add i64 %162, -466486
  %168 = add i64 %162, 8
...
block_4bf840:                                     ; preds = %entry
  ...
  store i64 %197, i64* %RDI.i56, align 8
  %198 = add i64 %191, -466512
  %199 = add i64 %191, 8
  ...
  %call2_4bf843 = tail call %struct.Memory* @sub_44d9f0.vital_chain(%struct.State* nonnull %0, i64 %198, %struct.Memory* %call2_4bf829)
  %203 = load i64, i64* %3, align 8
  store i64 0, i64* %RDI.i56, align 8
  store i8 0, i8* %CL.i50, align 1
  %204 = load i32, i32* %EAX.i48, align 4
  store i8 0, i8* %14, align 1
  %205 = and i32 %204, 255
  ...
  %.v2 = select i1 %220, i64 49, i64 6
  %221 = add i64 %218, %.v2
  store i64 %221, i64* %3, align 8
  %cmpBr_4bf853 = icmp eq i8 %219, 1
...
block_4bf859:                                     ; preds = %block_4bf840
  ...
  store i64 %227, i64* %RDI.i56, align 8
  %228 = add i64 %222, -8
  %229 = add i64 %221, 13
  ...
  store i64 %232, i64* %RCX.i78, align 8
  ...
  %call2_4bf870 = tail call %struct.Memory* @sub_4784b0.play_attack_defend2_n(%struct.State* nonnull %0, i64 %245, %struct.Memory* %call2_4bf843)
  %250 = load i32, i32* %EAX.i48, align 4
  %251 = load i64, i64* %3, align 8
  %252 = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 21, i32 0
  %R10B.i16 = bitcast %union.anon* %252 to i8*
  %253 = icmp ne i32 %250, 0
  %254 = zext i1 %253 to i64
  %255 = xor i64 %254, 255
  %256 = trunc i64 %255 to i8
  store i8 %256, i8* %R10B.i16, align 1
  store i8 0, i8* %14, align 1
...
block_.L_4bf884:                                  ; preds = %block_4bf859, %block_4bf840, %entry
  %266 = phi i64 [ %191, %entry ], [ %221, %block_4bf840 ], [ %.pre, %block_4bf859 ]
  %MEMORY.0 = phi %struct.Memory* [ %call2_4bf829, %entry ], [ %call2_4bf843, %block_4bf840 ], [ %call2_4bf870, %block_4bf859 ]
  ...
  store i64 %273, i64* %RAX.i80, align 8
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_je_.L_4bf884(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i8* nocapture %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
