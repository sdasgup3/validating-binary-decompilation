...
define %struct.Memory* @autohelperowl_defendpat254(%struct.State* noalias, i64, %struct.Memory* noalias readnone) local_unnamed_addr #1 {
entry:
  ...
  %call2_4bf969 = tail call %struct.Memory* @sub_40f780.countlib(%struct.State* %0, i64 %167, %struct.Memory* %2)
  ...
  br i1 %210, label %block_.L_4bf98f, label %block_4bf97e

block_4bf97e:                                     ; preds = %entry
  ...
  store i64 %217, i64* %RDI.i28, align 8
  %218 = add i64 %211, -721406
  %219 = add i64 %211, 8
  ...
  %call2_4bf981 = tail call %struct.Memory* @sub_40f780.countlib(%struct.State* nonnull %0, i64 %218, %struct.Memory* %call2_4bf969)
  %223 = load i32, i32* %EAX.i23, align 4
  %224 = load i64, i64* %3, align 8
  %225 = add i32 %223, -3
  %226 = icmp ult i32 %223, 3
  ...
  store i8 %249, i8* %CL.i14, align 1
...
block_.L_4bf98f:                                  ; preds = %block_4bf97e, %entry
  %254 = phi i64 [ %201, %entry ], [ %.pre, %block_4bf97e ]
  %MEMORY.0 = phi %struct.Memory* [ %call2_4bf969, %entry ], [ %call2_4bf981, %block_4bf97e ]
  ...
  store i64 %261, i64* %RAX.i50, align 8
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_jle_.L_4bf98f(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i8* nocapture %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
