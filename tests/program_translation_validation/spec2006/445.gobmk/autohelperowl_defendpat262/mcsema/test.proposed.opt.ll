...
define %struct.Memory* @autohelperowl_defendpat262(%struct.State* noalias, i64, %struct.Memory* noalias readnone) local_unnamed_addr #1 {
entry:
  ...
  %ESI.i86 = bitcast %union.anon* %44 to i32*
  %45 = load i64, i64* %RBP.i, align 8
  %46 = add i64 %45, -8
  %47 = load i32, i32* %ESI.i86, align 4
  ...
  store i64 %172, i64* %RCX.i76, align 8
  %173 = add i64 %160, -8
  %174 = add i64 %162, 14
  ...
  store i64 %178, i64* %RCX.i76, align 8
  ...
  store i64 %213, i64* %RDI.i42, align 8
  %214 = add i64 %209, -467143
  %215 = add i64 %209, 8
  ...
  %call2_4bfc4a = tail call %struct.Memory* @sub_44db80.owl_goal_dragon(%struct.State* %0, i64 %214, %struct.Memory* %2)
  ...
  %221 = load i32, i32* %EAX.i35, align 4
  ...
  %.v = select i1 %237, i64 49, i64 6
  %238 = add i64 %235, %.v
  store i64 %238, i64* %3, align 8
  %cmpBr_4bfc5b = icmp eq i8 %236, 1
  br i1 %cmpBr_4bfc5b, label %entry.block_.L_4bfc8c_crit_edge, label %block_4bfc61

entry.block_.L_4bfc8c_crit_edge:                  ; preds = %entry
  %.pre1 = bitcast %union.anon* %65 to i8*
  br label %block_.L_4bfc8c

block_4bfc61:                                     ; preds = %entry
  ...
  store i64 %244, i64* %RDI.i42, align 8
  %245 = add i64 %239, -8
  %246 = add i64 %238, 13
  ...
  store i64 %249, i64* %RCX.i76, align 8
  %250 = getelementptr inbounds %union.anon, %union.anon* %220, i64 0, i32 0
  %251 = add i64 %239, -24
  %252 = add i64 %238, 17
  ...
  %256 = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 19, i32 0, i32 0
  %257 = add i64 %239, -28
  %258 = add i64 %238, 21
  ...
  %call2_4bfc78 = tail call %struct.Memory* @sub_4784b0.play_attack_defend2_n(%struct.State* nonnull %0, i64 %262, %struct.Memory* %call2_4bfc4a)
  %267 = load i32, i32* %EAX.i35, align 4
  %268 = load i64, i64* %3, align 8
  %269 = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 21, i32 0
  %R10B.i16 = bitcast %union.anon* %269 to i8*
  %270 = icmp ne i32 %267, 0
  %271 = zext i1 %270 to i64
  %272 = xor i64 %271, 255
  %273 = trunc i64 %272 to i8
  store i8 %273, i8* %R10B.i16, align 1
  store i8 0, i8* %14, align 1
...
block_.L_4bfc8c:                                  ; preds = %entry.block_.L_4bfc8c_crit_edge, %block_4bfc61
  %AL.i9.pre-phi = phi i8* [ %.pre1, %entry.block_.L_4bfc8c_crit_edge ], [ %AL.i20, %block_4bfc61 ]
  %283 = phi i64 [ %238, %entry.block_.L_4bfc8c_crit_edge ], [ %.pre, %block_4bfc61 ]
  %MEMORY.0 = phi %struct.Memory* [ %call2_4bfc4a, %entry.block_.L_4bfc8c_crit_edge ], [ %call2_4bfc78, %block_4bfc61 ]
  ...
  %289 = and i8 %288, 1
  store i8 %289, i8* %AL.i9.pre-phi, align 1
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_je_.L_4bfc8c(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i8* nocapture %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
