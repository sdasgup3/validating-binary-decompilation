...
define %struct.Memory* @autohelperowl_defendpat263(%struct.State* noalias, i64, %struct.Memory* noalias readnone) local_unnamed_addr #1 {
entry:
  ...
  %call2_4bfced = tail call %struct.Memory* @sub_478110.play_attack_defend_n(%struct.State* %0, i64 %179, %struct.Memory* %2)
  ...
  %.v = select i1 %202, i64 43, i64 6
  %203 = add i64 %200, %.v
  store i64 %203, i64* %3, align 8
  %cmpBr_4bfcfe = icmp eq i8 %201, 1
  br i1 %cmpBr_4bfcfe, label %block_.L_4bfd29, label %block_4bfd04

block_4bfd04:                                     ; preds = %entry
  store i64 1, i64* %RAX.i92, align 8
  ...
  store i64 %209, i64* %RDI.i57, align 8
  %210 = add i64 %204, -8
  %211 = add i64 %203, 11
  ...
  store i64 %214, i64* %RCX.i77, align 8
  %215 = add i64 %204, -24
  %216 = add i64 %203, 15
  ...
  %call2_4bfd19 = tail call %struct.Memory* @sub_478110.play_attack_defend_n(%struct.State* nonnull %0, i64 %220, %struct.Memory* %call2_4bfced)
  %225 = load i32, i32* %EAX.i48, align 4
  ...
  store i8 %237, i8* %R9B.i38, align 1
...
block_.L_4bfd29:                                  ; preds = %block_4bfd04, %entry
  %242 = phi i64 [ %203, %entry ], [ %.pre, %block_4bfd04 ]
  %MEMORY.0 = phi %struct.Memory* [ %call2_4bfced, %entry ], [ %call2_4bfd19, %block_4bfd04 ]
  ...
  store i64 %249, i64* %RAX.i92, align 8
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_je_.L_4bfd29(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i8* nocapture %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
