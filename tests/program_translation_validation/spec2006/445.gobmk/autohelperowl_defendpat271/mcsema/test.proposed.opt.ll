...
define %struct.Memory* @autohelperowl_defendpat271(%struct.State* noalias, i64, %struct.Memory* noalias readnone returned) local_unnamed_addr #1 {
entry:
  ...
  %call2_4c02ae = tail call %struct.Memory* @sub_478110.play_attack_defend_n(%struct.State* %0, i64 %198, %struct.Memory* %2)
  ...
  ret %struct.Memory* %call2_4c02ae
}
