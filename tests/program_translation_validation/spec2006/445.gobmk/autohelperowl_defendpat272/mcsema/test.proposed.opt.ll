...
define %struct.Memory* @autohelperowl_defendpat272(%struct.State* noalias, i64, %struct.Memory* noalias readnone) local_unnamed_addr #1 {
entry:
  ...
  %call2_4c031e = tail call %struct.Memory* @sub_478110.play_attack_defend_n(%struct.State* %0, i64 %198, %struct.Memory* %2)
  ...
  %.v = select i1 %221, i64 23, i64 6
  %222 = add i64 %219, %.v
  store i64 %222, i64* %3, align 8
  %cmpBr_4c032f = icmp eq i8 %220, 1
  br i1 %cmpBr_4c032f, label %block_.L_4c0346, label %block_4c0335

block_4c0335:                                     ; preds = %entry
  ...
  store i64 %228, i64* %RDI.i48, align 8
  %229 = add i64 %222, -707397
  %230 = add i64 %222, 8
  ...
  %call2_4c0338 = tail call %struct.Memory* @sub_4137f0.countstones(%struct.State* nonnull %0, i64 %229, %struct.Memory* %call2_4c031e)
  %234 = load i32, i32* %EAX.i38, align 4
  %235 = load i64, i64* %3, align 8
  %236 = add i32 %234, -2
  %237 = icmp ult i32 %234, 2
  ...
  %258 = xor i1 %257, %255
  %.demorgan = or i1 %248, %258
  %259 = xor i1 %.demorgan, true
  %260 = zext i1 %259 to i8
  store i8 %260, i8* %CL.i25, align 1
  ...
  br label %block_.L_4c0346

block_.L_4c0346:                                  ; preds = %block_4c0335, %entry
  %265 = phi i64 [ %222, %entry ], [ %.pre, %block_4c0335 ]
  %MEMORY.0 = phi %struct.Memory* [ %call2_4c031e, %entry ], [ %call2_4c0338, %block_4c0335 ]
  ...
  store i64 %272, i64* %RAX.i86, align 8
  ...
  store i64 %299, i64* %RBP.i, align 8
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_movl_0xb5abf0___r9_4____ecx(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %RCX = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 5, i32 0, i32 0
  %R9 = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 19, i32 0, i32 0
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_je_.L_4c0346(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i8* nocapture %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
