...
define %struct.Memory* @autohelperowl_defendpat275(%struct.State* noalias, i64, %struct.Memory* noalias readnone) local_unnamed_addr #1 {
entry:
  ...
  %call2_4c0409 = tail call %struct.Memory* @sub_44da20.owl_escape_value(%struct.State* %0, i64 %167, %struct.Memory* %2)
  ...
  br i1 %199, label %block_.L_4c042f, label %block_4c041e
...
block_4c041e:                                     ; preds = %entry
  ...
  %call2_4c0421 = tail call %struct.Memory* @sub_44da20.owl_escape_value(%struct.State* nonnull %0, i64 %207, %struct.Memory* %call2_4c0409)
...
block_.L_4c042f:                                  ; preds = %block_4c041e, %entry
  %231 = phi i64 [ %189, %entry ], [ %.pre, %block_4c041e ]
  %MEMORY.0 = phi %struct.Memory* [ %call2_4c0409, %entry ], [ %call2_4c0421, %block_4c041e ]
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_jg_.L_4c042f(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i8* nocapture %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
