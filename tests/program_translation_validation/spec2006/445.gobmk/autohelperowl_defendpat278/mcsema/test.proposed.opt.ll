...
define %struct.Memory* @autohelperowl_defendpat278(%struct.State* noalias, i64, %struct.Memory* noalias readnone) local_unnamed_addr #1 {
entry:
  ...
  %RDI.i55 = getelementptr inbounds %union.anon, %union.anon* %40, i64 0, i32 0
  ...
  store i64 %166, i64* %RDI.i55, align 8
  %167 = add i64 %160, -8
  %168 = add i64 %162, 6
  ...
  %EAX.i46 = bitcast %union.anon* %39 to i32*
  %RSI.i47 = getelementptr inbounds %union.anon, %union.anon* %45, i64 0, i32 0
  %177 = load i32, i32* %EAX.i46, align 4
  %178 = zext i32 %177 to i64
  store i64 %178, i64* %RSI.i47, align 8
  %RDX.i44 = getelementptr inbounds %union.anon, %union.anon* %52, i64 0, i32 0
  store i64 %178, i64* %RDX.i44, align 8
  %AL.i41 = bitcast %union.anon* %39 to i8*
  store i8 0, i8* %AL.i41, align 1
  %179 = add i64 %162, -295789
  %180 = add i64 %162, 21
  ...
  %call2_4c048d = tail call %struct.Memory* @sub_478110.play_attack_defend_n(%struct.State* %0, i64 %179, %struct.Memory* %2)
  %184 = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 19, i32 0
  %R9B.i38 = bitcast %union.anon* %184 to i8*
  %185 = load i64, i64* %3, align 8
  store i8 1, i8* %R9B.i38, align 1
  %186 = load i32, i32* %EAX.i46, align 4
  ...
  br i1 %204, label %block_.L_4c04c7, label %block_4c04a2

block_4c04a2:                                     ; preds = %entry
  store i64 1, i64* %RAX.i89, align 8
  ...
  store i64 %211, i64* %RDI.i55, align 8
  %212 = add i64 %206, -8
  %213 = add i64 %205, 11
  ...
  store i64 %216, i64* %RCX.i74, align 8
  %217 = add i64 %206, -24
  %218 = add i64 %205, 15
  ...
  store i64 %221, i64* %R8.i78, align 8
  store i64 1, i64* %RSI.i47, align 8
  store i64 1, i64* %RDX.i44, align 8
  store i8 0, i8* %AL.i41, align 1
  %222 = add i64 %205, -295826
  %223 = add i64 %205, 26
  ...
  %call2_4c04b7 = tail call %struct.Memory* @sub_478110.play_attack_defend_n(%struct.State* nonnull %0, i64 %222, %struct.Memory* %call2_4c048d)
  %227 = load i32, i32* %EAX.i46, align 4
...
block_.L_4c04c7:                                  ; preds = %block_4c04a2, %entry
  %244 = phi i64 [ %201, %entry ], [ %.pre, %block_4c04a2 ]
  %MEMORY.0 = phi %struct.Memory* [ %call2_4c048d, %entry ], [ %call2_4c04b7, %block_4c04a2 ]
  ...
  store i64 %251, i64* %RAX.i89, align 8
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_jne_.L_4c04c7(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i8* nocapture %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
