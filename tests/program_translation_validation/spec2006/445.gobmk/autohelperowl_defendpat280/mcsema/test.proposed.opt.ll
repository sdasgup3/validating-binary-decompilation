...
define %struct.Memory* @autohelperowl_defendpat280(%struct.State* noalias, i64, %struct.Memory* noalias readnone) local_unnamed_addr #1 {
entry:
  ...
  %call2_4c059a = tail call %struct.Memory* @sub_40f780.countlib(%struct.State* %0, i64 %214, %struct.Memory* %2)
  ...
  br i1 %251, label %block_.L_4c05f5, label %block_4c05b1
...
block_4c05b1:                                     ; preds = %entry
  ...
  %call2_4c05b4 = tail call %struct.Memory* @sub_44da20.owl_escape_value(%struct.State* nonnull %0, i64 %259, %struct.Memory* %call2_4c059a)
  ...
  %284 = load i8, i8* %32, align 1
  %285 = icmp ne i8 %284, 0
  %286 = load i8, i8* %38, align 1
  %287 = icmp ne i8 %286, 0
  %288 = xor i1 %285, %287
  %289 = or i1 %283, %288
  %290 = select i1 %289, i64 %280, i64 %281
  store i64 %290, i64* %3, align 8
  br i1 %289, label %block_.L_4c05f5, label %block_4c05ca
...
block_4c05ca:                                     ; preds = %block_4c05b1
  ...
  store i64 %296, i64* %RDI.i56, align 8
  %297 = add i64 %291, -8
  %298 = add i64 %290, 13
  ...
  store i64 %301, i64* %RCX.i90, align 8
  %302 = getelementptr inbounds %union.anon, %union.anon* %220, i64 0, i32 0
  %303 = add i64 %291, -24
  %304 = add i64 %290, 17
  ...
  %308 = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 19, i32 0, i32 0
  %309 = add i64 %291, -28
  %310 = add i64 %290, 21
  ...
  %call2_4c05e1 = tail call %struct.Memory* @sub_4784b0.play_attack_defend2_n(%struct.State* nonnull %0, i64 %314, %struct.Memory* %call2_4c05b4)
  %319 = load i32, i32* %EAX.i48, align 4
  %320 = load i64, i64* %3, align 8
  %321 = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 21, i32 0
  %R10B.i16 = bitcast %union.anon* %321 to i8*
  %322 = icmp ne i32 %319, 0
  %323 = zext i1 %322 to i64
  %324 = xor i64 %323, 255
  %325 = trunc i64 %324 to i8
  store i8 %325, i8* %R10B.i16, align 1
  store i8 0, i8* %14, align 1
...
block_.L_4c05f5:                                  ; preds = %block_4c05ca, %block_4c05b1, %entry
  %335 = phi i64 [ %248, %entry ], [ %280, %block_4c05b1 ], [ %.pre, %block_4c05ca ]
  %MEMORY.0 = phi %struct.Memory* [ %call2_4c059a, %entry ], [ %call2_4c05b4, %block_4c05b1 ], [ %call2_4c05e1, %block_4c05ca ]
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_jne_.L_4c05f5(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i8* nocapture %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_jle_.L_4c05f5(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i8* nocapture %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 2, i32 7
