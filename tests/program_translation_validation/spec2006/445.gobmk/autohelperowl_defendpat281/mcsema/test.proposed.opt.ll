...
define %struct.Memory* @autohelperowl_defendpat281(%struct.State* noalias, i64, %struct.Memory* noalias readnone returned) local_unnamed_addr #1 {
entry:
  ...
  %call2_4c065a = tail call %struct.Memory* @sub_44da20.owl_escape_value(%struct.State* %0, i64 %215, %struct.Memory* %2)
  ...
  %call2_4c0665 = tail call %struct.Memory* @sub_44da20.owl_escape_value(%struct.State* %0, i64 %232, %struct.Memory* %call2_4c065a)
  ...
  %call2_4c0675 = tail call %struct.Memory* @sub_44da20.owl_escape_value(%struct.State* %0, i64 %280, %struct.Memory* %call2_4c0665)
  ...
  ret %struct.Memory* %call2_4c0675
}
