...
define %struct.Memory* @autohelperowl_defendpat291(%struct.State* noalias, i64, %struct.Memory* noalias readnone) local_unnamed_addr #1 {
entry:
  ...
  %call2_4c0a29 = tail call %struct.Memory* @sub_44da20.owl_escape_value(%struct.State* %0, i64 %167, %struct.Memory* %2)
  ...
  br i1 %198, label %entry.block_.L_4c0a6a_crit_edge, label %block_4c0a40

entry.block_.L_4c0a6a_crit_edge:                  ; preds = %entry
...
block_4c0a40:                                     ; preds = %entry
  ...
  store i64 %205, i64* %RDI.i40, align 8
  %206 = add i64 %200, -8
  %207 = add i64 %199, 16
  ...
  store i64 %210, i64* %RCX.i62, align 8
  %211 = getelementptr inbounds %union.anon, %union.anon* %173, i64 0, i32 0
  %212 = add i64 %200, -20
  %213 = add i64 %199, 20
  ...
  %call2_4c0a5a = tail call %struct.Memory* @sub_478110.play_attack_defend_n(%struct.State* nonnull %0, i64 %223, %struct.Memory* %call2_4c0a29)
  %228 = load i32, i32* %EAX.i33, align 4
  ...
  store i8 0, i8* %38, align 1
  %239 = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 21, i32 0
  %R10B.i14 = bitcast %union.anon* %239 to i8*
  %240 = xor i1 %235, true
  %241 = zext i1 %240 to i8
  store i8 %241, i8* %R10B.i14, align 1
...
block_.L_4c0a6a:                                  ; preds = %entry.block_.L_4c0a6a_crit_edge, %block_4c0a40
  %AL.i9.pre-phi = phi i8* [ %.pre1, %entry.block_.L_4c0a6a_crit_edge ], [ %AL.i18, %block_4c0a40 ]
  %246 = phi i64 [ %189, %entry.block_.L_4c0a6a_crit_edge ], [ %.pre, %block_4c0a40 ]
  %MEMORY.0 = phi %struct.Memory* [ %call2_4c0a29, %entry.block_.L_4c0a6a_crit_edge ], [ %call2_4c0a5a, %block_4c0a40 ]
  ...
  %252 = and i8 %251, 1
  store i8 %252, i8* %AL.i9.pre-phi, align 1
  %253 = zext i8 %252 to i64
  store i64 %253, i64* %RAX.i64, align 8
  %254 = load i64, i64* %6, align 8
  %255 = add i64 %254, 32
  store i64 %255, i64* %6, align 8
  %256 = icmp ugt i64 %254, -33
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_jle_.L_4c0a6a(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i8* nocapture %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
