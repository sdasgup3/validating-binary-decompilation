...
define %struct.Memory* @autohelperowl_defendpat295(%struct.State* noalias, i64, %struct.Memory* noalias readnone) local_unnamed_addr #1 {
entry:
  ...
  %call2_4c0ce9 = tail call %struct.Memory* @sub_44da20.owl_escape_value(%struct.State* %0, i64 %167, %struct.Memory* %2)
  ...
  br i1 %198, label %entry.block_.L_4c0d2b_crit_edge, label %block_4c0d00

entry.block_.L_4c0d2b_crit_edge:                  ; preds = %entry
...
block_4c0d00:                                     ; preds = %entry
  ...
  store i64 %210, i64* %RCX.i64, align 8
  ...
  %call2_4c0d17 = tail call %struct.Memory* @sub_4784b0.play_attack_defend2_n(%struct.State* nonnull %0, i64 %223, %struct.Memory* %call2_4c0ce9)
  %228 = load i32, i32* %EAX.i35, align 4
  %229 = load i64, i64* %3, align 8
  %230 = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 21, i32 0
  %R10B.i16 = bitcast %union.anon* %230 to i8*
  %231 = icmp ne i32 %228, 0
  %232 = zext i1 %231 to i64
  %233 = xor i64 %232, 255
  %234 = trunc i64 %233 to i8
  store i8 %234, i8* %R10B.i16, align 1
  store i8 0, i8* %14, align 1
...
block_.L_4c0d2b:                                  ; preds = %entry.block_.L_4c0d2b_crit_edge, %block_4c0d00
  %AL.i9.pre-phi = phi i8* [ %.pre1, %entry.block_.L_4c0d2b_crit_edge ], [ %AL.i20, %block_4c0d00 ]
  %244 = phi i64 [ %189, %entry.block_.L_4c0d2b_crit_edge ], [ %.pre, %block_4c0d00 ]
  %MEMORY.0 = phi %struct.Memory* [ %call2_4c0ce9, %entry.block_.L_4c0d2b_crit_edge ], [ %call2_4c0d17, %block_4c0d00 ]
  ...
  %250 = and i8 %249, 1
  store i8 %250, i8* %AL.i9.pre-phi, align 1
  %251 = zext i8 %250 to i64
  store i64 %251, i64* %RAX.i66, align 8
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_jle_.L_4c0d2b(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i8* nocapture %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
