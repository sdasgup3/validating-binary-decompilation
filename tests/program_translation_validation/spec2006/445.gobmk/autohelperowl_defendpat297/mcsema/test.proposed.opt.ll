...
define %struct.Memory* @autohelperowl_defendpat297(%struct.State* noalias, i64, %struct.Memory* noalias readnone) local_unnamed_addr #1 {
entry:
  ...
  %call2_4c0e38 = tail call %struct.Memory* @sub_40f780.countlib(%struct.State* %0, i64 %120, %struct.Memory* %2)
  %125 = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 17, i32 0
  %R8B.i37 = bitcast %union.anon* %125 to i8*
  %126 = load i64, i64* %3, align 8
  store i8 1, i8* %R8B.i37, align 1
  %EAX.i35 = bitcast %union.anon* %65 to i32*
  %127 = load i32, i32* %EAX.i35, align 4
  %128 = add i32 %127, -2
  ...
  %.v = select i1 %155, i64 43, i64 6
  %156 = add i64 %153, %.v
  store i64 %156, i64* %3, align 8
  %cmpBr_4c0e47 = icmp eq i8 %154, 1
  br i1 %cmpBr_4c0e47, label %entry.block_.L_4c0e72_crit_edge, label %block_4c0e4d

entry.block_.L_4c0e72_crit_edge:                  ; preds = %entry
  %.pre1 = bitcast %union.anon* %65 to i8*
  br label %block_.L_4c0e72

block_4c0e4d:                                     ; preds = %entry
  store i64 1, i64* %RAX.i51, align 8
  ...
  store i64 %162, i64* %RDI.i40, align 8
  %163 = add i64 %157, -8
  %164 = add i64 %156, 11
  ...
  store i64 %167, i64* %RCX.i49, align 8
  %168 = getelementptr inbounds %union.anon, %union.anon* %125, i64 0, i32 0
  %169 = add i64 %157, -20
  %170 = add i64 %156, 15
  ...
  %call2_4c0e62 = tail call %struct.Memory* @sub_478110.play_attack_defend_n(%struct.State* nonnull %0, i64 %174, %struct.Memory* %call2_4c0e38)
  %179 = load i32, i32* %EAX.i35, align 4
  ...
  %R9B.i14 = bitcast %union.anon* %190 to i8*
  %191 = xor i1 %186, true
  %192 = zext i1 %191 to i8
  store i8 %192, i8* %R9B.i14, align 1
...
block_.L_4c0e72:                                  ; preds = %entry.block_.L_4c0e72_crit_edge, %block_4c0e4d
  %AL.i9.pre-phi = phi i8* [ %.pre1, %entry.block_.L_4c0e72_crit_edge ], [ %AL.i18, %block_4c0e4d ]
  %197 = phi i64 [ %156, %entry.block_.L_4c0e72_crit_edge ], [ %.pre, %block_4c0e4d ]
  %MEMORY.0 = phi %struct.Memory* [ %call2_4c0e38, %entry.block_.L_4c0e72_crit_edge ], [ %call2_4c0e62, %block_4c0e4d ]
  ...
  %203 = and i8 %202, 1
  store i8 %203, i8* %AL.i9.pre-phi, align 1
  %204 = zext i8 %203 to i64
  store i64 %204, i64* %RAX.i51, align 8
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_je_.L_4c0e72(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i8* nocapture %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
