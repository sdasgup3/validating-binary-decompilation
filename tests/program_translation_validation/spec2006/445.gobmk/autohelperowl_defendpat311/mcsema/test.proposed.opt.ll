...
define %struct.Memory* @autohelperowl_defendpat311(%struct.State* noalias, i64, %struct.Memory* noalias readnone returned) local_unnamed_addr #1 {
entry:
  ...
  %call2_4c17ca = tail call %struct.Memory* @sub_44da20.owl_escape_value(%struct.State* %0, i64 %215, %struct.Memory* %2)
  ...
  %call2_4c17d5 = tail call %struct.Memory* @sub_44da20.owl_escape_value(%struct.State* %0, i64 %232, %struct.Memory* %call2_4c17ca)
  ...
  %call2_4c17e5 = tail call %struct.Memory* @sub_44da20.owl_escape_value(%struct.State* %0, i64 %280, %struct.Memory* %call2_4c17d5)
  ...
  ret %struct.Memory* %call2_4c17e5
}
