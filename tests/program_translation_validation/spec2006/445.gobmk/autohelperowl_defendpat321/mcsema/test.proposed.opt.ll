...
define %struct.Memory* @autohelperowl_defendpat321(%struct.State* noalias, i64, %struct.Memory* noalias readnone returned) local_unnamed_addr #1 {
entry:
  ...
  %call2_4c1d19 = tail call %struct.Memory* @sub_44da20.owl_escape_value(%struct.State* %0, i64 %167, %struct.Memory* %2)
  ...
  %call2_4c1d24 = tail call %struct.Memory* @sub_44da20.owl_escape_value(%struct.State* %0, i64 %184, %struct.Memory* %call2_4c1d19)
  ...
  ret %struct.Memory* %call2_4c1d24
}
