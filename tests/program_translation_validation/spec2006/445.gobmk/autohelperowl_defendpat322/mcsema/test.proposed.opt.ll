...
define %struct.Memory* @autohelperowl_defendpat322(%struct.State* noalias, i64, %struct.Memory* noalias readnone returned) local_unnamed_addr #1 {
entry:
  ...
  %call2_4c1d67 = tail call %struct.Memory* @sub_44da20.owl_escape_value(%struct.State* %0, i64 %73, %struct.Memory* %2)
  %78 = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 1, i32 0
  %EAX.i = bitcast %union.anon* %78 to i32*
  %79 = load i32, i32* %EAX.i, align 4
  ...
  %83 = zext i1 %82 to i8
  store i8 %83, i8* %R8B.i9, align 1
  %RAX.i = getelementptr inbounds %union.anon, %union.anon* %78, i64 0, i32 0
  ...
  ret %struct.Memory* %call2_4c1d67
}
