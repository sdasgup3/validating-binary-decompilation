...
define %struct.Memory* @autohelperowl_defendpat327(%struct.State* noalias, i64, %struct.Memory* noalias readnone) local_unnamed_addr #1 {
entry:
  ...
  store i64 %119, i64* %RAX.i52, align 8
  ...
  store i64 %125, i64* %RCX.i50, align 8
  %126 = add i64 %113, -8
  %127 = add i64 %115, 14
  ...
  store i64 %131, i64* %RCX.i50, align 8
  ...
  %call2_4c1ed9 = tail call %struct.Memory* @sub_44db80.owl_goal_dragon(%struct.State* %0, i64 %167, %struct.Memory* %2)
  %172 = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 17, i32 0
  %R8B.i27 = bitcast %union.anon* %172 to i8*
  %173 = load i64, i64* %3, align 8
  store i8 1, i8* %R8B.i27, align 1
  %EAX.i25 = bitcast %union.anon* %65 to i32*
  %174 = load i32, i32* %EAX.i25, align 4
  ...
  %.v = select i1 %190, i64 26, i64 6
  %191 = add i64 %188, %.v
  store i64 %191, i64* %3, align 8
  %cmpBr_4c1ee8 = icmp eq i8 %189, 1
  br i1 %cmpBr_4c1ee8, label %block_.L_4c1f02, label %block_4c1eee

block_4c1eee:                                     ; preds = %entry
  ...
  store i64 %197, i64* %RDI.i30, align 8
  %198 = add i64 %191, -476014
  %199 = add i64 %191, 8
  ...
  %call2_4c1ef1 = tail call %struct.Memory* @sub_44db80.owl_goal_dragon(%struct.State* nonnull %0, i64 %198, %struct.Memory* %call2_4c1ed9)
  %203 = load i32, i32* %EAX.i25, align 4
  ...
  store i8 %208, i8* %CL.i16, align 1
  store i8 0, i8* %14, align 1
...
block_.L_4c1f02:                                  ; preds = %block_4c1eee, %entry
  %218 = phi i64 [ %191, %entry ], [ %.pre, %block_4c1eee ]
  %MEMORY.0 = phi %struct.Memory* [ %call2_4c1ed9, %entry ], [ %call2_4c1ef1, %block_4c1eee ]
  ...
  store i64 %225, i64* %RAX.i52, align 8
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_je_.L_4c1f02(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i8* nocapture %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
