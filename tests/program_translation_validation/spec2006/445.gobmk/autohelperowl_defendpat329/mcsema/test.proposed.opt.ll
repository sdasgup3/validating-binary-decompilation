...
define %struct.Memory* @autohelperowl_defendpat329(%struct.State* noalias, i64, %struct.Memory* noalias readnone) local_unnamed_addr #1 {
entry:
  ...
  %call2_4c2029 = tail call %struct.Memory* @sub_44db80.owl_goal_dragon(%struct.State* %0, i64 %167, %struct.Memory* %2)
  ...
  %cmpBr_4c2038 = icmp eq i8 %189, 1
  br i1 %cmpBr_4c2038, label %block_.L_4c2052, label %block_4c203e

block_4c203e:                                     ; preds = %entry
  ...
  %call2_4c2041 = tail call %struct.Memory* @sub_44db80.owl_goal_dragon(%struct.State* nonnull %0, i64 %198, %struct.Memory* %call2_4c2029)
  ...
  br label %block_.L_4c2052

block_.L_4c2052:                                  ; preds = %block_4c203e, %entry
  %218 = phi i64 [ %191, %entry ], [ %.pre, %block_4c203e ]
  %MEMORY.0 = phi %struct.Memory* [ %call2_4c2029, %entry ], [ %call2_4c2041, %block_4c203e ]
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_je_.L_4c2052(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i8* nocapture %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
