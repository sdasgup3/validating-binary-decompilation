...
define %struct.Memory* @autohelperowl_defendpat330(%struct.State* noalias, i64, %struct.Memory* noalias readnone) local_unnamed_addr #1 {
entry:
  ...
  %call2_4c20aa = tail call %struct.Memory* @sub_44db80.owl_goal_dragon(%struct.State* %0, i64 %214, %struct.Memory* %2)
  ...
  %.v = select i1 %226, i64 34, i64 9
  %230 = add i64 %220, %.v
  store i64 %230, i64* %3, align 8
  br i1 %226, label %entry.block_.L_4c20d1_crit_edge, label %block_4c20b8

entry.block_.L_4c20d1_crit_edge:                  ; preds = %entry
  %.pre2 = bitcast %union.anon* %58 to i8*
  br label %block_.L_4c20d1
...
block_4c20b8:                                     ; preds = %entry
  ...
  store i64 %236, i64* %RDI.i38, align 8
  %237 = add i64 %230, -476472
  %238 = add i64 %230, 8
  ...
  %call2_4c20bb = tail call %struct.Memory* @sub_44db80.owl_goal_dragon(%struct.State* nonnull %0, i64 %237, %struct.Memory* %call2_4c20aa)
  %242 = load i64, i64* %3, align 8
  store i64 0, i64* %RDI.i38, align 8
  %CL.i26 = bitcast %union.anon* %58 to i8*
  store i8 0, i8* %CL.i26, align 1
  %243 = load i32, i32* %EAX.i35, align 4
  store i8 0, i8* %14, align 1
  %244 = and i32 %243, 255
  ...
  br i1 %261, label %block_.L_4c20e2, label %block_.L_4c20d1

block_.L_4c20d1:                                  ; preds = %entry.block_.L_4c20d1_crit_edge, %block_4c20b8
  %CL.i14.pre-phi = phi i8* [ %.pre2, %entry.block_.L_4c20d1_crit_edge ], [ %CL.i26, %block_4c20b8 ]
  %263 = phi i64 [ %230, %entry.block_.L_4c20d1_crit_edge ], [ %259, %block_4c20b8 ]
  %MEMORY.0 = phi %struct.Memory* [ %call2_4c20aa, %entry.block_.L_4c20d1_crit_edge ], [ %call2_4c20bb, %block_4c20b8 ]
  ...
  store i64 %269, i64* %RDI.i38, align 8
  %270 = add i64 %263, -731473
  %271 = add i64 %263, 8
  ...
  %call2_4c20d4 = tail call %struct.Memory* @sub_40f780.countlib(%struct.State* nonnull %0, i64 %270, %struct.Memory* %MEMORY.0)
  %275 = load i32, i32* %EAX.i35, align 4
  ...
  store i8 %301, i8* %CL.i14.pre-phi, align 1
...
block_.L_4c20e2:                                  ; preds = %block_.L_4c20d1, %block_4c20b8
  %306 = phi i64 [ %.pre, %block_.L_4c20d1 ], [ %258, %block_4c20b8 ]
  %MEMORY.1 = phi %struct.Memory* [ %call2_4c20d4, %block_.L_4c20d1 ], [ %call2_4c20bb, %block_4c20b8 ]
  ...
  store i64 %313, i64* %RAX.i72, align 8
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_je_.L_4c20d1(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i8* nocapture %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_jne_.L_4c20e2(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i8* nocapture %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 2, i32 7
