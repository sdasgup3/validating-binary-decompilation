...
define %struct.Memory* @autohelperowl_defendpat332(%struct.State* noalias, i64, %struct.Memory* noalias readnone) local_unnamed_addr #1 {
entry:
  ...
  %call2_4c21bb = tail call %struct.Memory* @sub_44da20.owl_escape_value(%struct.State* %0, i64 %262, %struct.Memory* %2)
  ...
  br i1 %280, label %block_.L_4c21f3, label %block_4c21c9
...
block_4c21c9:                                     ; preds = %entry
  ...
  %call2_4c21cc = tail call %struct.Memory* @sub_44da20.owl_escape_value(%struct.State* nonnull %0, i64 %288, %struct.Memory* %call2_4c21bb)
  ...
  br i1 %306, label %block_.L_4c21f3, label %block_4c21da
...
block_4c21da:                                     ; preds = %block_4c21c9
  ...
  %call2_4c21dd = tail call %struct.Memory* @sub_44da20.owl_escape_value(%struct.State* nonnull %0, i64 %314, %struct.Memory* %call2_4c21cc)
  ...
  br i1 %344, label %block_4c21da.block_.L_4c2218_crit_edge, label %block_.L_4c21f3

block_4c21da.block_.L_4c2218_crit_edge:           ; preds = %block_4c21da
  %.pre3 = bitcast %union.anon* %66 to i8*
  br label %block_.L_4c2218

block_.L_4c21f3:                                  ; preds = %block_4c21da, %block_4c21c9, %entry
  %346 = phi i64 [ %281, %entry ], [ %307, %block_4c21c9 ], [ %336, %block_4c21da ]
  %MEMORY.0 = phi %struct.Memory* [ %call2_4c21bb, %entry ], [ %call2_4c21cc, %block_4c21c9 ], [ %call2_4c21dd, %block_4c21da ]
  ...
  %call2_4c2208 = tail call %struct.Memory* @sub_478110.play_attack_defend_n(%struct.State* nonnull %0, i64 %364, %struct.Memory* %MEMORY.0)
...
block_.L_4c2218:                                  ; preds = %block_4c21da.block_.L_4c2218_crit_edge, %block_.L_4c21f3
  %AL.i9.pre-phi = phi i8* [ %.pre3, %block_4c21da.block_.L_4c2218_crit_edge ], [ %AL.i18, %block_.L_4c21f3 ]
  %387 = phi i64 [ %335, %block_4c21da.block_.L_4c2218_crit_edge ], [ %.pre, %block_.L_4c21f3 ]
  %MEMORY.1 = phi %struct.Memory* [ %call2_4c21dd, %block_4c21da.block_.L_4c2218_crit_edge ], [ %call2_4c2208, %block_.L_4c21f3 ]
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_jg_.L_4c21f3(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i8* nocapture %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_jle_.L_4c2218(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i8* nocapture %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 2, i32 7
