...
define %struct.Memory* @autohelperowl_defendpat334(%struct.State* noalias, i64, %struct.Memory* noalias readnone) local_unnamed_addr #1 {
entry:
  ...
  %call2_4c22ea = tail call %struct.Memory* @sub_44da20.owl_escape_value(%struct.State* %0, i64 %214, %struct.Memory* %2)
  ...
  br i1 %232, label %entry.block_.L_4c2311_crit_edge, label %block_4c22f8

entry.block_.L_4c2311_crit_edge:                  ; preds = %entry
  %.pre2 = bitcast %union.anon* %58 to i8*
  br label %block_.L_4c2311
...
block_4c22f8:                                     ; preds = %entry
  ...
  %call2_4c22fb = tail call %struct.Memory* @sub_44da20.owl_escape_value(%struct.State* nonnull %0, i64 %240, %struct.Memory* %call2_4c22ea)
  ...
  br i1 %270, label %block_.L_4c2322, label %block_.L_4c2311

block_.L_4c2311:                                  ; preds = %entry.block_.L_4c2311_crit_edge, %block_4c22f8
  %CL.i14.pre-phi = phi i8* [ %.pre2, %entry.block_.L_4c2311_crit_edge ], [ %CL.i26, %block_4c22f8 ]
  %272 = phi i64 [ %233, %entry.block_.L_4c2311_crit_edge ], [ %262, %block_4c22f8 ]
  %MEMORY.0 = phi %struct.Memory* [ %call2_4c22ea, %entry.block_.L_4c2311_crit_edge ], [ %call2_4c22fb, %block_4c22f8 ]
  ...
  %call2_4c2314 = tail call %struct.Memory* @sub_40f780.countlib(%struct.State* nonnull %0, i64 %279, %struct.Memory* %MEMORY.0)
...
block_.L_4c2322:                                  ; preds = %block_.L_4c2311, %block_4c22f8
  %315 = phi i64 [ %.pre, %block_.L_4c2311 ], [ %261, %block_4c22f8 ]
  %MEMORY.1 = phi %struct.Memory* [ %call2_4c2314, %block_.L_4c2311 ], [ %call2_4c22fb, %block_4c22f8 ]
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_jg_.L_4c2311(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i8* nocapture %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_jle_.L_4c2322(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i8* nocapture %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 2, i32 7
