...
define %struct.Memory* @autohelperowl_defendpat336(%struct.State* noalias, i64, %struct.Memory* noalias readnone) local_unnamed_addr #1 {
entry:
  ...
  %call2_4c23d9 = tail call %struct.Memory* @sub_44da20.owl_escape_value(%struct.State* %0, i64 %167, %struct.Memory* %2)
  ...
  br i1 %199, label %block_.L_4c23ff, label %block_4c23ee

block_4c23ee:                                     ; preds = %entry
  ...
  %call2_4c23f1 = tail call %struct.Memory* @sub_44da20.owl_escape_value(%struct.State* nonnull %0, i64 %207, %struct.Memory* %call2_4c23d9)
...
block_.L_4c23ff:                                  ; preds = %block_4c23ee, %entry
  %231 = phi i64 [ %189, %entry ], [ %.pre, %block_4c23ee ]
  %MEMORY.0 = phi %struct.Memory* [ %call2_4c23d9, %entry ], [ %call2_4c23f1, %block_4c23ee ]
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_jg_.L_4c23ff(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i8* nocapture %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
