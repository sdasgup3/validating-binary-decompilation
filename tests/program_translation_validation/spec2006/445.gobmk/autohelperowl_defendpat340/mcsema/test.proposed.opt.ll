...
define %struct.Memory* @autohelperowl_defendpat340(%struct.State* noalias, i64, %struct.Memory* noalias readnone) local_unnamed_addr #1 {
entry:
  ...
  %ESI.i121 = bitcast %union.anon* %44 to i32*
  %45 = load i64, i64* %RBP.i, align 8
  %46 = add i64 %45, -8
  %47 = load i32, i32* %ESI.i121, align 4
  ...
  %ECX.i116 = bitcast %union.anon* %58 to i32*
  %59 = load i64, i64* %RBP.i, align 8
  %60 = add i64 %59, -16
  %61 = load i32, i32* %ECX.i116, align 4
  ...
  %RAX.i113 = getelementptr inbounds %union.anon, %union.anon* %65, i64 0, i32 0
  ...
  store i64 %72, i64* %RAX.i113, align 8
  %RCX.i111 = getelementptr inbounds %union.anon, %union.anon* %58, i64 0, i32 0
  %73 = shl nsw i64 %72, 2
  ...
  store i64 %119, i64* %RAX.i113, align 8
  ...
  store i64 %166, i64* %RAX.i113, align 8
  ...
  store i64 %213, i64* %RAX.i113, align 8
  ...
  store i64 %272, i64* %RCX.i111, align 8
  ...
  store i64 %307, i64* %RDI.i53, align 8
  %308 = add i64 %303, -478185
  %309 = add i64 %303, 8
  ...
  %call2_4c260c = tail call %struct.Memory* @sub_44da20.owl_escape_value(%struct.State* %0, i64 %308, %struct.Memory* %2)
  ...
  %R8B.i48 = bitcast %union.anon* %314 to i8*
  store i8 0, i8* %R8B.i48, align 1
  %EAX.i46 = bitcast %union.anon* %65 to i32*
  %315 = load i32, i32* %EAX.i46, align 4
  ...
  br i1 %339, label %entry.block_.L_4c265d_crit_edge, label %block_4c2623

entry.block_.L_4c265d_crit_edge:                  ; preds = %entry
...
block_4c2623:                                     ; preds = %entry
  ...
  store i64 %351, i64* %RCX.i111, align 8
  %352 = getelementptr inbounds %union.anon, %union.anon* %314, i64 0, i32 0
  %353 = add i64 %341, -20
  %354 = add i64 %340, 17
  ...
  %380 = add i64 %379, 8
  %381 = load i32, i32* %R10D.i27, align 4
  ...
  %call2_4c2649 = tail call %struct.Memory* @sub_4784b0.play_attack_defend2_n(%struct.State* nonnull %0, i64 %386, %struct.Memory* %call2_4c260c)
  %391 = load i32, i32* %EAX.i46, align 4
  %392 = load i64, i64* %3, align 8
  %393 = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 23, i32 0
  %R11B.i16 = bitcast %union.anon* %393 to i8*
  %394 = icmp ne i32 %391, 0
  %395 = zext i1 %394 to i64
  %396 = xor i64 %395, 255
  %397 = trunc i64 %396 to i8
  store i8 %397, i8* %R11B.i16, align 1
  store i8 0, i8* %14, align 1
  ...
  store i8 %397, i8* %406, align 1
  %.pre = load i64, i64* %3, align 8
  br label %block_.L_4c265d

block_.L_4c265d:                                  ; preds = %entry.block_.L_4c265d_crit_edge, %block_4c2623
  %AL.i9.pre-phi = phi i8* [ %.pre1, %entry.block_.L_4c265d_crit_edge ], [ %AL.i20, %block_4c2623 ]
  %407 = phi i64 [ %330, %entry.block_.L_4c265d_crit_edge ], [ %.pre, %block_4c2623 ]
  %MEMORY.0 = phi %struct.Memory* [ %call2_4c260c, %entry.block_.L_4c265d_crit_edge ], [ %call2_4c2649, %block_4c2623 ]
  ...
  %413 = and i8 %412, 1
  store i8 %413, i8* %AL.i9.pre-phi, align 1
  %414 = zext i8 %413 to i64
  store i64 %414, i64* %RAX.i113, align 8
  %415 = load i64, i64* %6, align 8
  %416 = add i64 %415, 64
  store i64 %416, i64* %6, align 8
  %417 = icmp ugt i64 %415, -65
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_jle_.L_4c265d(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i8* nocapture %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
