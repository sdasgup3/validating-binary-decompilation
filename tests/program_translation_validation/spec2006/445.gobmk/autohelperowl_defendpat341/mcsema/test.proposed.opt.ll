...
define %struct.Memory* @autohelperowl_defendpat341(%struct.State* noalias, i64, %struct.Memory* noalias readnone returned) local_unnamed_addr #1 {
entry:
  ...
  %call2_4c2698 = tail call %struct.Memory* @sub_44da20.owl_escape_value(%struct.State* %0, i64 %120, %struct.Memory* %2)
  ...
  %R8B.i9 = bitcast %union.anon* %127 to i8*
  %128 = icmp sgt i32 %125, 0
  %129 = zext i1 %128 to i8
  store i8 %129, i8* %R8B.i9, align 1
  ...
  ret %struct.Memory* %call2_4c2698
}
