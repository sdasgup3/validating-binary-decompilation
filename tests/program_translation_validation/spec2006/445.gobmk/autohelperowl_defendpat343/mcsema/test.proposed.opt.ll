...
define %struct.Memory* @autohelperowl_defendpat343(%struct.State* noalias, i64, %struct.Memory* noalias readnone) local_unnamed_addr #1 {
entry:
  ...
  %call2_4c27c9 = tail call %struct.Memory* @sub_44da20.owl_escape_value(%struct.State* %0, i64 %167, %struct.Memory* %2)
  ...
  %197 = xor i1 %194, %196
  %198 = or i1 %192, %197
  %199 = select i1 %198, i64 %189, i64 %190
  store i64 %199, i64* %3, align 8
  br i1 %198, label %block_.L_4c27f1, label %block_4c27e0

block_4c27e0:                                     ; preds = %entry
  ...
  store i64 %205, i64* %RDI.i30, align 8
  %206 = add i64 %199, -478304
  %207 = add i64 %199, 8
  ...
  %call2_4c27e3 = tail call %struct.Memory* @sub_44db80.owl_goal_dragon(%struct.State* nonnull %0, i64 %206, %struct.Memory* %call2_4c27c9)
  %211 = load i32, i32* %EAX.i23, align 4
  ...
  store i8 %223, i8* %CL.i25, align 1
  ...
  br label %block_.L_4c27f1

block_.L_4c27f1:                                  ; preds = %block_4c27e0, %entry
  %228 = phi i64 [ %189, %entry ], [ %.pre, %block_4c27e0 ]
  %MEMORY.0 = phi %struct.Memory* [ %call2_4c27c9, %entry ], [ %call2_4c27e3, %block_4c27e0 ]
  ...
  store i64 %235, i64* %RAX.i54, align 8
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_jle_.L_4c27f1(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i8* nocapture %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
