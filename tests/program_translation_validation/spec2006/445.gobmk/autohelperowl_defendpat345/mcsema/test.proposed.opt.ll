...
define %struct.Memory* @autohelperowl_defendpat345(%struct.State* noalias, i64, %struct.Memory* noalias readnone) local_unnamed_addr #1 {
entry:
  ...
  %call2_4c2879 = tail call %struct.Memory* @sub_44da20.owl_escape_value(%struct.State* %0, i64 %167, %struct.Memory* %2)
  ...
  br i1 %198, label %block_.L_4c28ba, label %block_4c2890

block_4c2890:                                     ; preds = %entry
  ...
  store i64 %205, i64* %RDI.i44, align 8
  %206 = add i64 %199, -478480
  %207 = add i64 %199, 8
  ...
  %call2_4c2893 = tail call %struct.Memory* @sub_44db80.owl_goal_dragon(%struct.State* nonnull %0, i64 %206, %struct.Memory* %call2_4c2879)
  %211 = load i64, i64* %3, align 8
  store i64 0, i64* %RDI.i44, align 8
  store i8 0, i8* %CL.i39, align 1
  %212 = load i32, i32* %EAX.i37, align 4
  store i8 0, i8* %14, align 1
  %213 = and i32 %212, 255
  ...
  %.v = select i1 %228, i64 23, i64 6
  %229 = add i64 %226, %.v
  store i64 %229, i64* %3, align 8
  %cmpBr_4c28a3 = icmp eq i8 %227, 1
  br i1 %cmpBr_4c28a3, label %block_.L_4c28ba, label %block_4c28a9

block_4c28a9:                                     ; preds = %block_4c2890
  ...
  store i64 %235, i64* %RDI.i44, align 8
  %236 = add i64 %229, -733481
  %237 = add i64 %229, 8
  ...
  %call2_4c28ac = tail call %struct.Memory* @sub_40f780.countlib(%struct.State* nonnull %0, i64 %236, %struct.Memory* %call2_4c2893)
  %241 = load i32, i32* %EAX.i37, align 4
  ...
  %266 = xor i1 %.demorgan, true
  %267 = zext i1 %266 to i8
  store i8 %267, i8* %CL.i39, align 1
...
block_.L_4c28ba:                                  ; preds = %block_4c28a9, %block_4c2890, %entry
  %272 = phi i64 [ %189, %entry ], [ %229, %block_4c2890 ], [ %.pre, %block_4c28a9 ]
  %MEMORY.0 = phi %struct.Memory* [ %call2_4c2879, %entry ], [ %call2_4c2893, %block_4c2890 ], [ %call2_4c28ac, %block_4c28a9 ]
  ...
  store i64 %279, i64* %RAX.i68, align 8
  %280 = load i64, i64* %6, align 8
  %281 = add i64 %280, 32
  store i64 %281, i64* %6, align 8
  %282 = icmp ugt i64 %280, -33
  ...
  %304 = add i64 %280, 40
  %305 = inttoptr i64 %281 to i64*
  %306 = load i64, i64* %305, align 8
  store i64 %306, i64* %RBP.i, align 8
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_jle_.L_4c28ba(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i8* nocapture %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_je_.L_4c28ba(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i8* nocapture %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 2, i32 7
