...
define %struct.Memory* @autohelperowl_defendpat356(%struct.State* noalias, i64, %struct.Memory* noalias readnone returned) local_unnamed_addr #1 {
entry:
  ...
  %call2_4c2ea9 = tail call %struct.Memory* @sub_44da20.owl_escape_value(%struct.State* %0, i64 %167, %struct.Memory* %2)
  ...
  %call2_4c2eb4 = tail call %struct.Memory* @sub_44da20.owl_escape_value(%struct.State* %0, i64 %184, %struct.Memory* %call2_4c2ea9)
  ...
  ret %struct.Memory* %call2_4c2eb4
}
