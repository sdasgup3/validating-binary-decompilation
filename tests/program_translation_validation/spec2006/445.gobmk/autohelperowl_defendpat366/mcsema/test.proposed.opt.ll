...
define %struct.Memory* @autohelperowl_defendpat366(%struct.State* noalias, i64, %struct.Memory* noalias readnone returned) local_unnamed_addr #1 {
entry:
  ...
  %call2_4c33fa = tail call %struct.Memory* @sub_44da20.owl_escape_value(%struct.State* %0, i64 %215, %struct.Memory* %2)
  ...
  %call2_4c3405 = tail call %struct.Memory* @sub_44da20.owl_escape_value(%struct.State* %0, i64 %232, %struct.Memory* %call2_4c33fa)
  ...
  %call2_4c3415 = tail call %struct.Memory* @sub_44da20.owl_escape_value(%struct.State* %0, i64 %280, %struct.Memory* %call2_4c3405)
  ...
  ret %struct.Memory* %call2_4c3415
}
