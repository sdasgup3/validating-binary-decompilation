...
define %struct.Memory* @autohelperowl_defendpat367(%struct.State* noalias, i64, %struct.Memory* noalias readnone) local_unnamed_addr #1 {
entry:
  ...
  %ECX.i57 = bitcast %union.anon* %58 to i32*
  %59 = load i64, i64* %RBP.i, align 8
  %60 = add i64 %59, -16
  %61 = load i32, i32* %ECX.i57, align 4
  ...
  %RAX.i54 = getelementptr inbounds %union.anon, %union.anon* %65, i64 0, i32 0
  ...
  store i64 %72, i64* %RAX.i54, align 8
  %RCX.i52 = getelementptr inbounds %union.anon, %union.anon* %58, i64 0, i32 0
  %73 = shl nsw i64 %72, 2
  ...
  store i64 %78, i64* %RCX.i52, align 8
  %79 = add i64 %66, -8
  %80 = add i64 %68, 14
  ...
  store i64 %84, i64* %RCX.i52, align 8
  ...
  store i64 %119, i64* %RAX.i54, align 8
  ...
  store i64 %125, i64* %RCX.i52, align 8
  %126 = add i64 %113, -8
  %127 = add i64 %115, 14
  ...
  store i64 %131, i64* %RCX.i52, align 8
  ...
  store i64 %166, i64* %RDI.i30, align 8
  %167 = add i64 %162, -736502
  %168 = add i64 %162, 8
  ...
  br i1 %210, label %block_.L_4c34a1, label %block_4c3490

block_4c3490:                                     ; preds = %entry
  ...
  store i64 %217, i64* %RDI.i30, align 8
  %218 = add i64 %211, -736528
  %219 = add i64 %211, 8
  ...
  %call2_4c3493 = tail call %struct.Memory* @sub_40f780.countlib(%struct.State* nonnull %0, i64 %218, %struct.Memory* %call2_4c3479)
  %223 = load i32, i32* %EAX.i23, align 4
  ...
  %247 = xor i1 %246, %244
  %.demorgan = or i1 %237, %247
  %248 = xor i1 %.demorgan, true
  %249 = zext i1 %248 to i8
  store i8 %249, i8* %CL.i25, align 1
  ...
  br label %block_.L_4c34a1

block_.L_4c34a1:                                  ; preds = %block_4c3490, %entry
  %254 = phi i64 [ %201, %entry ], [ %.pre, %block_4c3490 ]
  %MEMORY.0 = phi %struct.Memory* [ %call2_4c3479, %entry ], [ %call2_4c3493, %block_4c3490 ]
  ...
  store i64 %261, i64* %RAX.i54, align 8
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_jle_.L_4c34a1(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i8* nocapture %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
