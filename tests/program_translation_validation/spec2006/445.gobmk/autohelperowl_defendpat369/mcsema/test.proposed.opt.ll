...
define %struct.Memory* @autohelperowl_defendpat369(%struct.State* noalias, i64, %struct.Memory* noalias readnone) local_unnamed_addr #1 {
entry:
  ...
  %RDI.i66 = getelementptr inbounds %union.anon, %union.anon* %40, i64 0, i32 0
  ...
  store i64 %261, i64* %RDI.i66, align 8
  %262 = add i64 %257, -482232
  %263 = add i64 %257, 8
  ...
  %call2_4c35db = tail call %struct.Memory* @sub_44da20.owl_escape_value(%struct.State* %0, i64 %262, %struct.Memory* %2)
  ...
  %call2_4c35e6 = tail call %struct.Memory* @sub_44da20.owl_escape_value(%struct.State* %0, i64 %279, %struct.Memory* %call2_4c35db)
  ...
  %290 = load i32, i32* %EAX.i59, align 4
  %291 = add i32 %290, %289
  %292 = zext i32 %291 to i64
  store i64 %292, i64* %RCX.i112, align 8
  ...
  store i64 %322, i64* %RDI.i66, align 8
  %323 = add i64 %284, -40
  %324 = add i64 %286, 11
  ...
  %call2_4c35f6 = tail call %struct.Memory* @sub_44da20.owl_escape_value(%struct.State* %0, i64 %327, %struct.Memory* %call2_4c35e6)
  ...
  %R8B.i40 = bitcast %union.anon* %333 to i8*
  ...
  %339 = load i32, i32* %EAX.i59, align 4
  %340 = add i32 %339, %338
  %341 = zext i32 %340 to i64
  store i64 %341, i64* %RCX.i112, align 8
  %342 = and i32 %340, 255
  ...
  br i1 %364, label %entry.block_.L_4c3639_crit_edge, label %block_4c3612

entry.block_.L_4c3639_crit_edge:                  ; preds = %entry
...
block_4c3612:                                     ; preds = %entry
  ...
  store i64 %371, i64* %RDI.i66, align 8
  %372 = add i64 %366, -8
  %373 = add i64 %365, 13
  ...
  store i64 %376, i64* %RCX.i112, align 8
  ...
  %call2_4c3629 = tail call %struct.Memory* @sub_4788b0.play_connect_n(%struct.State* nonnull %0, i64 %387, %struct.Memory* %call2_4c35f6)
  %392 = load i32, i32* %EAX.i59, align 4
  ...
  store i8 0, i8* %39, align 1
  %403 = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 21, i32 0
  %R10B.i14 = bitcast %union.anon* %403 to i8*
  %404 = xor i1 %399, true
  %405 = zext i1 %404 to i8
  store i8 %405, i8* %R10B.i14, align 1
...
block_.L_4c3639:                                  ; preds = %entry.block_.L_4c3639_crit_edge, %block_4c3612
  %AL.i9.pre-phi = phi i8* [ %.pre1, %entry.block_.L_4c3639_crit_edge ], [ %AL.i18, %block_4c3612 ]
  %410 = phi i64 [ %355, %entry.block_.L_4c3639_crit_edge ], [ %.pre, %block_4c3612 ]
  %MEMORY.0 = phi %struct.Memory* [ %call2_4c35f6, %entry.block_.L_4c3639_crit_edge ], [ %call2_4c3629, %block_4c3612 ]
  ...
  %416 = and i8 %415, 1
  store i8 %416, i8* %AL.i9.pre-phi, align 1
  %417 = zext i8 %416 to i64
  store i64 %417, i64* %RAX.i114, align 8
  %418 = load i64, i64* %6, align 8
  %419 = add i64 %418, 48
  store i64 %419, i64* %6, align 8
  %420 = icmp ugt i64 %418, -49
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_jle_.L_4c3639(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i8* nocapture %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
