...
define %struct.Memory* @autohelperowl_defendpat371(%struct.State* noalias, i64, %struct.Memory* noalias readnone) local_unnamed_addr #1 {
entry:
  ...
  %RBX.i138 = getelementptr inbounds %union.anon, %union.anon* %11, i64 0, i32 0
  %12 = load i64, i64* %RBX.i138, align 8
  %13 = add i64 %10, 4
  ...
  %EDI.i133 = bitcast %union.anon* %45 to i32*
  %46 = load i64, i64* %RBP.i, align 8
  %47 = add i64 %46, -12
  %48 = load i32, i32* %EDI.i133, align 4
  %49 = add i64 %16, 7
  ...
  %call2_4c374d = tail call %struct.Memory* @sub_44da20.owl_escape_value(%struct.State* %0, i64 %315, %struct.Memory* %2)
  ...
  br i1 %333, label %block_.L_4c3774, label %block_4c375b
...
block_4c375b:                                     ; preds = %entry
  ...
  %call2_4c375e = tail call %struct.Memory* @sub_44da20.owl_escape_value(%struct.State* nonnull %0, i64 %341, %struct.Memory* %call2_4c374d)
  ...
  br i1 %371, label %block_4c375b.block_.L_4c37b4_crit_edge, label %block_.L_4c3774

block_4c375b.block_.L_4c37b4_crit_edge:           ; preds = %block_4c375b
  %.pre2 = bitcast %union.anon* %72 to i8*
  br label %block_.L_4c37b4

block_.L_4c3774:                                  ; preds = %block_4c375b, %entry
  %373 = phi i64 [ %334, %entry ], [ %363, %block_4c375b ]
  %MEMORY.0 = phi %struct.Memory* [ %call2_4c374d, %entry ], [ %call2_4c375e, %block_4c375b ]
  ...
  %call2_4c37a6 = tail call %struct.Memory* @sub_4784b0.play_attack_defend2_n(%struct.State* nonnull %0, i64 %428, %struct.Memory* %MEMORY.0)
...
block_.L_4c37b4:                                  ; preds = %block_4c375b.block_.L_4c37b4_crit_edge, %block_.L_4c3774
  %AL.i10.pre-phi = phi i8* [ %.pre2, %block_4c375b.block_.L_4c37b4_crit_edge ], [ %AL.i19, %block_.L_4c3774 ]
  %450 = phi i64 [ %362, %block_4c375b.block_.L_4c37b4_crit_edge ], [ %.pre, %block_.L_4c3774 ]
  %MEMORY.1 = phi %struct.Memory* [ %call2_4c375e, %block_4c375b.block_.L_4c37b4_crit_edge ], [ %call2_4c37a6, %block_.L_4c3774 ]
  ...
  store i64 %484, i64* %RBX.i138, align 8
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_jg_.L_4c3774(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i8* nocapture %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_jle_.L_4c37b4(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i8* nocapture %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 2, i32 7
