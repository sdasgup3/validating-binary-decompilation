...
define %struct.Memory* @autohelperowl_defendpat374(%struct.State* noalias, i64, %struct.Memory* noalias readnone) local_unnamed_addr #1 {
entry:
  ...
  store i64 %166, i64* %RAX.i98, align 8
  %167 = shl nsw i64 %166, 2
  %168 = add nsw i64 %167, 11903632
  %169 = add i64 %162, 11
  ...
  store i64 %178, i64* %RCX.i96, align 8
  ...
  %RDI.i62 = getelementptr inbounds %union.anon, %union.anon* %39, i64 0, i32 0
  ...
  store i64 %213, i64* %RDI.i62, align 8
  ...
  store i64 %218, i64* %RSI.i, align 8
  %219 = add i64 %209, -714071
  %220 = add i64 %209, 11
  ...
  %call2_4c393d = tail call %struct.Memory* @sub_4153e0.same_string(%struct.State* %0, i64 %219, %struct.Memory* %2)
  ...
  %R8B.i56 = bitcast %union.anon* %225 to i8*
  store i8 0, i8* %R8B.i56, align 1
  %EAX.i53 = bitcast %union.anon* %65 to i32*
  %226 = load i32, i32* %EAX.i53, align 4
  ...
  %241 = add i64 %240, 73
  %242 = add i64 %240, 6
  %243 = load i8, i8* %29, align 1
  %244 = icmp eq i8 %243, 0
  %245 = select i1 %244, i64 %241, i64 %242
  store i64 %245, i64* %3, align 8
  br i1 %244, label %entry.block_.L_4c3997_crit_edge, label %block_4c3954

entry.block_.L_4c3997_crit_edge:                  ; preds = %entry
  %.pre4 = bitcast %union.anon* %65 to i8*
  br label %block_.L_4c3997

block_4c3954:                                     ; preds = %entry
  ...
  store i64 %251, i64* %RDI.i62, align 8
  %252 = add i64 %245, -737748
  %253 = add i64 %245, 8
  ...
  %call2_4c3957 = tail call %struct.Memory* @sub_40f780.countlib(%struct.State* nonnull %0, i64 %252, %struct.Memory* %call2_4c393d)
  %257 = load i64, i64* %3, align 8
  store i8 1, i8* %CL.i55, align 1
  %258 = load i32, i32* %EAX.i53, align 4
  %259 = add i32 %258, -4
  %260 = icmp ult i32 %258, 4
  ...
  %291 = load i8, i8* %38, align 1
  %292 = icmp ne i8 %291, 0
  %293 = xor i1 %290, %292
  %294 = or i1 %288, %293
  %295 = select i1 %294, i64 %285, i64 %286
  store i64 %295, i64* %3, align 8
  br i1 %294, label %block_.L_4c3991, label %block_4c396a

block_4c396a:                                     ; preds = %block_4c3954
  ...
  store i64 %301, i64* %RDI.i62, align 8
  %302 = add i64 %295, -737770
  %303 = add i64 %295, 8
  ...
  %call2_4c396d = tail call %struct.Memory* @sub_40f780.countlib(%struct.State* nonnull %0, i64 %302, %struct.Memory* %call2_4c3957)
  %307 = load i64, i64* %3, align 8
  store i8 1, i8* %CL.i55, align 1
  %308 = load i32, i32* %EAX.i53, align 4
  %309 = add i32 %308, -4
  ...
  %339 = load i8, i8* %32, align 1
  %340 = icmp ne i8 %339, 0
  %341 = load i8, i8* %38, align 1
  %342 = icmp ne i8 %341, 0
  %343 = xor i1 %340, %342
  %344 = or i1 %338, %343
  %345 = select i1 %344, i64 %335, i64 %336
  store i64 %345, i64* %3, align 8
  br i1 %344, label %block_.L_4c3991, label %block_4c3980

block_4c3980:                                     ; preds = %block_4c396a
  ...
  store i64 %351, i64* %RDI.i62, align 8
  %352 = add i64 %345, -737792
  %353 = add i64 %345, 8
  ...
  %call2_4c3983 = tail call %struct.Memory* @sub_40f780.countlib(%struct.State* nonnull %0, i64 %352, %struct.Memory* %call2_4c396d)
  %357 = load i32, i32* %EAX.i53, align 4
  ...
  store i8 %383, i8* %CL.i55, align 1
  ...
  br label %block_.L_4c3991

block_.L_4c3991:                                  ; preds = %block_4c3980, %block_4c396a, %block_4c3954
  %388 = phi i64 [ %285, %block_4c3954 ], [ %335, %block_4c396a ], [ %.pre, %block_4c3980 ]
  %MEMORY.0 = phi %struct.Memory* [ %call2_4c3957, %block_4c3954 ], [ %call2_4c396d, %block_4c396a ], [ %call2_4c3983, %block_4c3980 ]
  ...
  store i8 %393, i8* %AL.i15, align 1
  %394 = add i64 %389, -29
  %395 = add i64 %388, 6
...
block_.L_4c3997:                                  ; preds = %entry.block_.L_4c3997_crit_edge, %block_.L_4c3991
  %AL.i9.pre-phi = phi i8* [ %.pre4, %entry.block_.L_4c3997_crit_edge ], [ %AL.i15, %block_.L_4c3991 ]
  %397 = phi i64 [ %241, %entry.block_.L_4c3997_crit_edge ], [ %.pre3, %block_.L_4c3991 ]
  %MEMORY.1 = phi %struct.Memory* [ %call2_4c393d, %entry.block_.L_4c3997_crit_edge ], [ %MEMORY.0, %block_.L_4c3991 ]
  ...
  %403 = and i8 %402, 1
  store i8 %403, i8* %AL.i9.pre-phi, align 1
  %404 = zext i8 %403 to i64
  store i64 %404, i64* %RAX.i98, align 8
  ...
  %429 = add i64 %405, 40
  %430 = inttoptr i64 %406 to i64*
  %431 = load i64, i64* %430, align 8
  store i64 %431, i64* %RBP.i, align 8
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_jne_.L_4c3997(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i8* nocapture %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_jle_.L_4c3991(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i8* nocapture %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 2, i32 7
