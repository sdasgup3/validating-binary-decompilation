...
define %struct.Memory* @autohelperowl_defendpat379(%struct.State* noalias, i64, %struct.Memory* noalias readnone returned) local_unnamed_addr #1 {
entry:
  ...
  %call2_4c39d8 = tail call %struct.Memory* @sub_44db80.owl_goal_dragon(%struct.State* %0, i64 %119, %struct.Memory* %2)
  ...
  ret %struct.Memory* %call2_4c39d8
}
