...
define %struct.Memory* @autohelperowl_defendpat381(%struct.State* noalias, i64, %struct.Memory* noalias readnone) local_unnamed_addr #1 {
entry:
  ...
  %call2_4c3a29 = tail call %struct.Memory* @sub_40f780.countlib(%struct.State* %0, i64 %167, %struct.Memory* %2)
  ...
  br i1 %210, label %block_.L_4c3a51, label %block_4c3a40
...
block_4c3a40:                                     ; preds = %entry
  ...
  %call2_4c3a43 = tail call %struct.Memory* @sub_44da20.owl_escape_value(%struct.State* nonnull %0, i64 %218, %struct.Memory* %call2_4c3a29)
  ...
  store i8 %237, i8* %CL.i25, align 1
...
block_.L_4c3a51:                                  ; preds = %block_4c3a40, %entry
  %242 = phi i64 [ %201, %entry ], [ %.pre, %block_4c3a40 ]
  %MEMORY.0 = phi %struct.Memory* [ %call2_4c3a29, %entry ], [ %call2_4c3a43, %block_4c3a40 ]
  ...
  store i64 %249, i64* %RAX.i54, align 8
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_jle_.L_4c3a51(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i8* nocapture %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
