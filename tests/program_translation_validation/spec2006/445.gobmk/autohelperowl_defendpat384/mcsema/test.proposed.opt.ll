...
define %struct.Memory* @autohelperowl_defendpat384(%struct.State* noalias, i64, %struct.Memory* noalias readnone) local_unnamed_addr #1 {
entry:
  ...
  %call2_4c3b59 = tail call %struct.Memory* @sub_44da20.owl_escape_value(%struct.State* %0, i64 %167, %struct.Memory* %2)
  ...
  br i1 %198, label %block_.L_4c3bbf, label %block_4c3b70

block_4c3b70:                                     ; preds = %entry
  %200 = load i32, i32* bitcast (%G_0xb54ce4_type* @G_0xb54ce4 to i32*), align 8
  store i8 0, i8* %14, align 1
  %201 = and i32 %200, 255
  ...
  store i8 0, i8* %38, align 1
  %.v = select i1 %206, i64 14, i64 49
  %210 = add i64 %199, %.v
  store i64 %210, i64* %3, align 8
  br i1 %206, label %block_4c3b7e, label %block_.L_4c3ba1

block_4c3b7e:                                     ; preds = %block_4c3b70
  ...
  %217 = mul nsw i64 %216, 380
  store i64 %217, i64* %RCX.i82, align 8
  %218 = lshr i64 %217, 63
  %219 = add i64 %217, ptrtoint (%G__0xb0eff0_type* @G__0xb0eff0 to i64)
  store i64 %219, i64* %RAX.i84, align 8
  %220 = icmp ult i64 %219, ptrtoint (%G__0xb0eff0_type* @G__0xb0eff0 to i64)
  ...
  %230 = xor i64 %217, ptrtoint (%G__0xb0eff0_type* @G__0xb0eff0 to i64)
  %231 = xor i64 %230, %219
  %232 = lshr i64 %231, 4
  ...
  %239 = xor i64 %237, lshr (i64 ptrtoint (%G__0xb0eff0_type* @G__0xb0eff0 to i64), i64 63)
  %240 = xor i64 %237, %218
  ...
  %244 = add i64 %217, add (i64 ptrtoint (%G__0xb0eff0_type* @G__0xb0eff0 to i64), i64 100)
  %245 = add i64 %210, 27
  store i64 %245, i64* %3, align 8
  %246 = inttoptr i64 %244 to i32*
  %247 = load i32, i32* %246, align 4
  %248 = zext i32 %247 to i64
  store i64 %248, i64* %RDX.i, align 8
  %249 = add i64 %211, -32
  %250 = add i64 %210, 30
  ...
  br label %block_.L_4c3bb0

block_.L_4c3ba1:                                  ; preds = %block_4c3b70
  ...
  %call2_4c3ba8 = tail call %struct.Memory* @sub_45db40.attack(%struct.State* nonnull %0, i64 %260, %struct.Memory* %call2_4c3b59)
  %265 = load i64, i64* %RBP.i, align 8
  %266 = add i64 %265, -32
  %267 = load i32, i32* %EAX.i52, align 4
...
block_.L_4c3bb0:                                  ; preds = %block_.L_4c3ba1, %block_4c3b7e
  %271 = phi i64 [ %.pre, %block_.L_4c3ba1 ], [ %253, %block_4c3b7e ]
  %MEMORY.0 = phi %struct.Memory* [ %call2_4c3ba8, %block_.L_4c3ba1 ], [ %call2_4c3b59, %block_4c3b7e ]
  ...
  store i64 %277, i64* %RAX.i84, align 8
  %278 = icmp ne i32 %276, 0
  %279 = zext i1 %278 to i64
  %280 = xor i64 %279, 255
  %281 = trunc i64 %280 to i8
  store i8 %281, i8* %CL.i54, align 1
  store i8 0, i8* %14, align 1
  ...
  br label %block_.L_4c3bbf

block_.L_4c3bbf:                                  ; preds = %block_.L_4c3bb0, %entry
  %290 = phi i64 [ %189, %entry ], [ %.pre2, %block_.L_4c3bb0 ]
  %MEMORY.1 = phi %struct.Memory* [ %call2_4c3b59, %entry ], [ %MEMORY.0, %block_.L_4c3bb0 ]
  ...
  store i64 %297, i64* %RAX.i84, align 8
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_jle_.L_4c3bbf(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i8* nocapture %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_jne_.L_4c3ba1(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i8* nocapture %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 2, i32 7
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_jmpq_.L_4c3bb0(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
