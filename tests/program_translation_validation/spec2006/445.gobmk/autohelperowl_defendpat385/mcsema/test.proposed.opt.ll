...
define %struct.Memory* @autohelperowl_defendpat385(%struct.State* noalias, i64, %struct.Memory* noalias readnone) local_unnamed_addr #1 {
entry:
  ...
  %call2_4c3c09 = tail call %struct.Memory* @sub_44da20.owl_escape_value(%struct.State* %0, i64 %167, %struct.Memory* %2)
  ...
  br i1 %198, label %block_.L_4c3c34, label %block_4c3c20
...
block_4c3c20:                                     ; preds = %entry
  ...
  %call2_4c3c26 = tail call %struct.Memory* @sub_4772c0.does_attack(%struct.State* nonnull %0, i64 %211, %struct.Memory* %call2_4c3c09)
...
block_.L_4c3c34:                                  ; preds = %block_4c3c20, %entry
  %233 = phi i64 [ %189, %entry ], [ %.pre, %block_4c3c20 ]
  %MEMORY.0 = phi %struct.Memory* [ %call2_4c3c09, %entry ], [ %call2_4c3c26, %block_4c3c20 ]
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_jle_.L_4c3c34(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i8* nocapture %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
