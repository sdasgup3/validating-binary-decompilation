...
define %struct.Memory* @autohelperowl_defendpat387(%struct.State* noalias, i64, %struct.Memory* noalias readnone) local_unnamed_addr #1 {
entry:
  ...
  %EDX.i48 = bitcast %union.anon* %51 to i32*
  %52 = load i64, i64* %RBP.i, align 8
  %53 = add i64 %52, -12
  %54 = load i32, i32* %EDX.i48, align 4
  ...
  %.v = select i1 %95, i64 14, i64 52
  %99 = add i64 %88, %.v
  store i64 %99, i64* %3, align 8
  br i1 %95, label %block_4c3d23, label %block_.L_4c3d49

block_4c3d23:                                     ; preds = %entry
  ...
  store i64 %106, i64* %RCX.i40, align 8
  %107 = lshr i64 %106, 63
  %108 = add i64 %106, ptrtoint (%G__0xb0eff0_type* @G__0xb0eff0 to i64)
  store i64 %108, i64* %RAX.i42, align 8
  ...
  %133 = add i64 %106, add (i64 ptrtoint (%G__0xb0eff0_type* @G__0xb0eff0 to i64), i64 180)
  %134 = add i64 %99, 30
  ...
  br label %block_.L_4c3d58

block_.L_4c3d49:                                  ; preds = %entry
  %EAX.i15 = bitcast %union.anon* %65 to i32*
  store i64 0, i64* %RAX.i42, align 8
  store i8 0, i8* %14, align 1
  ...
  %call2_4c3d50 = tail call %struct.Memory* @sub_46a780.find_defense(%struct.State* nonnull %0, i64 %149, %struct.Memory* %2)
  %154 = load i64, i64* %RBP.i, align 8
  %155 = add i64 %154, -24
  %156 = load i32, i32* %EAX.i15, align 4
...
block_.L_4c3d58:                                  ; preds = %block_.L_4c3d49, %block_4c3d23
  %160 = phi i64 [ %.pre, %block_.L_4c3d49 ], [ %142, %block_4c3d23 ]
  %MEMORY.0 = phi %struct.Memory* [ %call2_4c3d50, %block_.L_4c3d49 ], [ %2, %block_4c3d23 ]
  ...
  store i64 %166, i64* %RAX.i42, align 8
  ...
  store i64 %193, i64* %RBP.i, align 8
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_jne_.L_4c3d49(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i8* nocapture %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_jmpq_.L_4c3d58(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
