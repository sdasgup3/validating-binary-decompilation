...
define %struct.Memory* @autohelperowl_defendpat390(%struct.State* noalias, i64, %struct.Memory* noalias readnone) local_unnamed_addr #1 {
entry:
  ...
  %call2_4c3f89 = tail call %struct.Memory* @sub_44d9f0.vital_chain(%struct.State* %0, i64 %167, %struct.Memory* %2)
  ...
  %.v = select i1 %190, i64 72, i64 6
  %191 = add i64 %188, %.v
  store i64 %191, i64* %3, align 8
  %cmpBr_4c3f9a = icmp eq i8 %189, 1
...
block_4c3fa0:                                     ; preds = %entry
  ...
  store i64 %197, i64* %RDI.i58, align 8
  %198 = add i64 %191, -484784
  %199 = add i64 %191, 8
  ...
  %call2_4c3fa3 = tail call %struct.Memory* @sub_44d9f0.vital_chain(%struct.State* nonnull %0, i64 %198, %struct.Memory* %call2_4c3f89)
  %203 = load i64, i64* %3, align 8
  store i64 0, i64* %RDI.i58, align 8
  store i8 0, i8* %CL.i52, align 1
  %204 = load i32, i32* %EAX.i50, align 4
  store i8 0, i8* %14, align 1
  %205 = and i32 %204, 255
  ...
  %.v2 = select i1 %220, i64 47, i64 6
  %221 = add i64 %218, %.v2
  store i64 %221, i64* %3, align 8
  %cmpBr_4c3fb3 = icmp eq i8 %219, 1
...
block_4c3fb9:                                     ; preds = %block_4c3fa0
  ...
  store i64 %227, i64* %RDI.i58, align 8
  %228 = add i64 %222, -8
  %229 = add i64 %221, 11
  ...
  store i64 %232, i64* %RCX.i80, align 8
  ...
  %call2_4c3fd2 = tail call %struct.Memory* @sub_4784b0.play_attack_defend2_n(%struct.State* nonnull %0, i64 %245, %struct.Memory* %call2_4c3fa3)
  %250 = load i32, i32* %EAX.i50, align 4
  ...
  store i8 0, i8* %38, align 1
  %261 = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 21, i32 0
  %R10B.i14 = bitcast %union.anon* %261 to i8*
  %262 = xor i1 %257, true
  %263 = zext i1 %262 to i8
  store i8 %263, i8* %R10B.i14, align 1
...
block_.L_4c3fe2:                                  ; preds = %block_4c3fb9, %block_4c3fa0, %entry
  %268 = phi i64 [ %191, %entry ], [ %221, %block_4c3fa0 ], [ %.pre, %block_4c3fb9 ]
  %MEMORY.0 = phi %struct.Memory* [ %call2_4c3f89, %entry ], [ %call2_4c3fa3, %block_4c3fa0 ], [ %call2_4c3fd2, %block_4c3fb9 ]
  ...
  store i64 %275, i64* %RAX.i82, align 8
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_je_.L_4c3fe2(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i8* nocapture %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
