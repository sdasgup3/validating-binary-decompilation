...
define %struct.Memory* @autohelperowl_defendpat392(%struct.State* noalias, i64, %struct.Memory* noalias readnone returned) local_unnamed_addr #1 {
entry:
  ...
  %call2_4c41aa = tail call %struct.Memory* @sub_44da20.owl_escape_value(%struct.State* %0, i64 %215, %struct.Memory* %2)
  ...
  %call2_4c41b5 = tail call %struct.Memory* @sub_44da20.owl_escape_value(%struct.State* %0, i64 %232, %struct.Memory* %call2_4c41aa)
  ...
  %call2_4c41c5 = tail call %struct.Memory* @sub_44da20.owl_escape_value(%struct.State* %0, i64 %280, %struct.Memory* %call2_4c41b5)
  ...
  %301 = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 17, i32 0
  %R8B.i9 = bitcast %union.anon* %301 to i8*
  %302 = icmp ne i32 %297, 0
  %303 = xor i1 %302, %300
  %.demorgan = or i1 %296, %303
  %304 = xor i1 %.demorgan, true
  %305 = zext i1 %304 to i8
  store i8 %305, i8* %R8B.i9, align 1
  %306 = zext i1 %304 to i64
  store i64 %306, i64* %RAX.i72, align 8
  ...
  ret %struct.Memory* %call2_4c41c5
}
