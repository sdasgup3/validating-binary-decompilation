...
define %struct.Memory* @autohelperowl_defendpat394(%struct.State* noalias, i64, %struct.Memory* noalias readnone) local_unnamed_addr #1 {
entry:
  ...
  store i64 %214, i64* %RAX.i94, align 8
  ...
  store i64 %220, i64* %RCX.i92, align 8
  %221 = add i64 %208, -8
  %222 = add i64 %210, 14
  ...
  store i64 %226, i64* %RCX.i92, align 8
  ...
  store i64 %261, i64* %RDI.i47, align 8
  %262 = add i64 %257, -485592
  %263 = add i64 %257, 8
  ...
  %call2_4c42fb = tail call %struct.Memory* @sub_44da20.owl_escape_value(%struct.State* %0, i64 %262, %struct.Memory* %2)
  %EAX.i44 = bitcast %union.anon* %66 to i32*
  %267 = load i32, i32* %EAX.i44, align 4
  ...
  br i1 %280, label %block_.L_4c4322, label %block_4c4309

block_4c4309:                                     ; preds = %entry
  ...
  store i64 %287, i64* %RDI.i47, align 8
  %288 = add i64 %281, -485609
  %289 = add i64 %281, 8
  ...
  %call2_4c430c = tail call %struct.Memory* @sub_44da20.owl_escape_value(%struct.State* nonnull %0, i64 %288, %struct.Memory* %call2_4c42fb)
  %293 = load i64, i64* %3, align 8
  store i64 0, i64* %RDI.i47, align 8
  %CL.i35 = bitcast %union.anon* %59 to i8*
  ...
  br i1 %318, label %block_4c4309.block_.L_4c434c_crit_edge, label %block_.L_4c4322

block_4c4309.block_.L_4c434c_crit_edge:           ; preds = %block_4c4309
  %.pre2 = bitcast %union.anon* %66 to i8*
  br label %block_.L_4c434c

block_.L_4c4322:                                  ; preds = %block_4c4309, %entry
  %320 = phi i64 [ %281, %entry ], [ %310, %block_4c4309 ]
  %MEMORY.0 = phi %struct.Memory* [ %call2_4c42fb, %entry ], [ %call2_4c430c, %block_4c4309 ]
  ...
  store i64 %326, i64* %RDI.i47, align 8
  %327 = add i64 %321, -8
  %328 = add i64 %320, 16
  ...
  store i64 %331, i64* %RCX.i92, align 8
  ...
  %call2_4c433c = tail call %struct.Memory* @sub_478110.play_attack_defend_n(%struct.State* nonnull %0, i64 %344, %struct.Memory* %MEMORY.0)
  %349 = load i32, i32* %EAX.i44, align 4
  ...
  store i8 0, i8* %39, align 1
  %360 = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 21, i32 0
  %R10B.i14 = bitcast %union.anon* %360 to i8*
  %361 = xor i1 %356, true
  %362 = zext i1 %361 to i8
  store i8 %362, i8* %R10B.i14, align 1
...
block_.L_4c434c:                                  ; preds = %block_4c4309.block_.L_4c434c_crit_edge, %block_.L_4c4322
  %AL.i9.pre-phi = phi i8* [ %.pre2, %block_4c4309.block_.L_4c434c_crit_edge ], [ %AL.i18, %block_.L_4c4322 ]
  %367 = phi i64 [ %309, %block_4c4309.block_.L_4c434c_crit_edge ], [ %.pre, %block_.L_4c4322 ]
  %MEMORY.1 = phi %struct.Memory* [ %call2_4c430c, %block_4c4309.block_.L_4c434c_crit_edge ], [ %call2_4c433c, %block_.L_4c4322 ]
  ...
  %373 = and i8 %372, 1
  store i8 %373, i8* %AL.i9.pre-phi, align 1
  %374 = zext i8 %373 to i64
  store i64 %374, i64* %RAX.i94, align 8
  %375 = load i64, i64* %6, align 8
  %376 = add i64 %375, 48
  store i64 %376, i64* %6, align 8
  %377 = icmp ugt i64 %375, -49
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_jg_.L_4c4322(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i8* nocapture %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_jle_.L_4c434c(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i8* nocapture %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 2, i32 7
