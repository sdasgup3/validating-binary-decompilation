...
define %struct.Memory* @autohelperowl_defendpat395(%struct.State* noalias, i64, %struct.Memory* noalias readnone) local_unnamed_addr #1 {
entry:
  ...
  %call2_4c4399 = tail call %struct.Memory* @sub_44da20.owl_escape_value(%struct.State* %0, i64 %167, %struct.Memory* %2)
  ...
  br i1 %198, label %entry.block_.L_4c43db_crit_edge, label %block_4c43b0

entry.block_.L_4c43db_crit_edge:                  ; preds = %entry
...
block_4c43b0:                                     ; preds = %entry
  ...
  %215 = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 19, i32 0, i32 0
  %216 = add i64 %200, -24
  %217 = add i64 %199, 21
  ...
  %call2_4c43c7 = tail call %struct.Memory* @sub_4788b0.play_connect_n(%struct.State* nonnull %0, i64 %221, %struct.Memory* %call2_4c4399)
  %226 = load i32, i32* %EAX.i35, align 4
  %227 = load i64, i64* %3, align 8
  %228 = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 21, i32 0
  %R10B.i16 = bitcast %union.anon* %228 to i8*
  %229 = icmp ne i32 %226, 0
  %230 = zext i1 %229 to i64
  %231 = xor i64 %230, 255
  %232 = trunc i64 %231 to i8
  store i8 %232, i8* %R10B.i16, align 1
  store i8 0, i8* %14, align 1
...
block_.L_4c43db:                                  ; preds = %entry.block_.L_4c43db_crit_edge, %block_4c43b0
  %AL.i9.pre-phi = phi i8* [ %.pre1, %entry.block_.L_4c43db_crit_edge ], [ %AL.i20, %block_4c43b0 ]
  %242 = phi i64 [ %189, %entry.block_.L_4c43db_crit_edge ], [ %.pre, %block_4c43b0 ]
  %MEMORY.0 = phi %struct.Memory* [ %call2_4c4399, %entry.block_.L_4c43db_crit_edge ], [ %call2_4c43c7, %block_4c43b0 ]
  ...
  %248 = and i8 %247, 1
  store i8 %248, i8* %AL.i9.pre-phi, align 1
  %249 = zext i8 %248 to i64
  store i64 %249, i64* %RAX.i66, align 8
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_jle_.L_4c43db(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i8* nocapture %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
