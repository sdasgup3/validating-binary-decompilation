...
define %struct.Memory* @autohelperowl_defendpat398(%struct.State* noalias, i64, %struct.Memory* noalias readnone) local_unnamed_addr #1 {
entry:
  ...
  %call2_4c467a = tail call %struct.Memory* @sub_40f780.countlib(%struct.State* %0, i64 %214, %struct.Memory* %2)
  ...
  br i1 %257, label %block_.L_4c46bb, label %block_4c4691
...
block_4c4691:                                     ; preds = %entry
  ...
  store i64 %264, i64* %RDI.i44, align 8
  %265 = add i64 %258, -741137
  %266 = add i64 %258, 8
  ...
  %call2_4c4694 = tail call %struct.Memory* @sub_40f780.countlib(%struct.State* nonnull %0, i64 %265, %struct.Memory* %call2_4c467a)
  %270 = load i64, i64* %3, align 8
  store i64 0, i64* %RDI.i44, align 8
  store i8 0, i8* %CL.i39, align 1
  %271 = load i32, i32* %EAX.i37, align 4
  %272 = add i32 %271, -1
  ...
  br i1 %307, label %block_.L_4c46bb, label %block_4c46aa
...
block_4c46aa:                                     ; preds = %block_4c4691
  ...
  store i64 %314, i64* %RDI.i44, align 8
  %315 = add i64 %308, -741162
  %316 = add i64 %308, 8
  ...
  %call2_4c46ad = tail call %struct.Memory* @sub_40f780.countlib(%struct.State* nonnull %0, i64 %315, %struct.Memory* %call2_4c4694)
  %320 = load i32, i32* %EAX.i37, align 4
  ...
  %344 = xor i1 %343, %341
  %.demorgan = or i1 %334, %344
  %345 = xor i1 %.demorgan, true
  %346 = zext i1 %345 to i8
  store i8 %346, i8* %CL.i39, align 1
...
block_.L_4c46bb:                                  ; preds = %block_4c46aa, %block_4c4691, %entry
  %351 = phi i64 [ %248, %entry ], [ %298, %block_4c4691 ], [ %.pre, %block_4c46aa ]
  %MEMORY.0 = phi %struct.Memory* [ %call2_4c467a, %entry ], [ %call2_4c4694, %block_4c4691 ], [ %call2_4c46ad, %block_4c46aa ]
  ...
  store i64 %358, i64* %RAX.i80, align 8
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_jle_.L_4c46bb(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i8* nocapture %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
