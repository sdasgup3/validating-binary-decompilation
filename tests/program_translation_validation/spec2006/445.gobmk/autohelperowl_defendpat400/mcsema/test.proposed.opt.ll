...
define %struct.Memory* @autohelperowl_defendpat400(%struct.State* noalias, i64, %struct.Memory* noalias readnone) local_unnamed_addr #1 {
entry:
  ...
  %call2_4c4759 = tail call %struct.Memory* @sub_40f780.countlib(%struct.State* %0, i64 %167, %struct.Memory* %2)
  ...
  br i1 %210, label %block_.L_4c4781, label %block_4c4770

block_4c4770:                                     ; preds = %entry
  ...
  %call2_4c4773 = tail call %struct.Memory* @sub_40f780.countlib(%struct.State* nonnull %0, i64 %218, %struct.Memory* %call2_4c4759)
  ...
  br label %block_.L_4c4781

block_.L_4c4781:                                  ; preds = %block_4c4770, %entry
  %254 = phi i64 [ %201, %entry ], [ %.pre, %block_4c4770 ]
  %MEMORY.0 = phi %struct.Memory* [ %call2_4c4759, %entry ], [ %call2_4c4773, %block_4c4770 ]
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_jle_.L_4c4781(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i8* nocapture %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
