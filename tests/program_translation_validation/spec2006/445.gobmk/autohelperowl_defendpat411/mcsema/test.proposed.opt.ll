...
define %struct.Memory* @autohelperowl_defendpat411(%struct.State* noalias, i64, %struct.Memory* noalias readnone) local_unnamed_addr #1 {
entry:
  ...
  %EDX.i56 = bitcast %union.anon* %51 to i32*
  %52 = load i64, i64* %RBP.i, align 8
  %53 = add i64 %52, -12
  %54 = load i32, i32* %EDX.i56, align 4
  ...
  br i1 %95, label %block_4c49a3, label %block_.L_4c49c6

block_4c49a3:                                     ; preds = %entry
  store i64 ptrtoint (%G__0xb0eff0_type* @G__0xb0eff0 to i64), i64* %RAX.i50, align 8
  ...
  store i64 %106, i64* %RCX.i48, align 8
  %107 = lshr i64 %106, 63
...
block_.L_4c49c6:                                  ; preds = %entry
  ...
  %call2_4c49cd = tail call %struct.Memory* @sub_45db40.attack(%struct.State* nonnull %0, i64 %149, %struct.Memory* %2)
...
block_.L_4c49d5:                                  ; preds = %block_.L_4c49c6, %block_4c49a3
  %160 = phi i64 [ %.pre, %block_.L_4c49c6 ], [ %142, %block_4c49a3 ]
  %MEMORY.0 = phi %struct.Memory* [ %call2_4c49cd, %block_.L_4c49c6 ], [ %2, %block_4c49a3 ]
  ...
  %CL.i9 = bitcast %union.anon* %58 to i8*
  %166 = icmp ne i32 %165, 0
  %167 = zext i1 %166 to i8
  store i8 %167, i8* %CL.i9, align 1
  %168 = zext i1 %166 to i64
  store i64 %168, i64* %RAX.i50, align 8
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_jne_.L_4c49c6(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i8* nocapture %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_jmpq_.L_4c49d5(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
