...
define %struct.Memory* @autohelperowl_defendpat61(%struct.State* noalias, i64, %struct.Memory* noalias readnone) local_unnamed_addr #1 {
entry:
  ...
  %call2_4bb5e9 = tail call %struct.Memory* @sub_44db80.owl_goal_dragon(%struct.State* %0, i64 %167, %struct.Memory* %2)
  ...
  %cmpBr_4bb5fa = icmp eq i8 %189, 1
  br i1 %cmpBr_4bb5fa, label %block_.L_4bb611, label %block_4bb600

block_4bb600:                                     ; preds = %entry
  ...
  %call2_4bb603 = tail call %struct.Memory* @sub_44da20.owl_escape_value(%struct.State* nonnull %0, i64 %198, %struct.Memory* %call2_4bb5e9)
  ...
  store i8 %217, i8* %CL.i25, align 1
  ...
  br label %block_.L_4bb611

block_.L_4bb611:                                  ; preds = %block_4bb600, %entry
  %222 = phi i64 [ %191, %entry ], [ %.pre, %block_4bb600 ]
  %MEMORY.0 = phi %struct.Memory* [ %call2_4bb5e9, %entry ], [ %call2_4bb603, %block_4bb600 ]
  ...
  store i64 %229, i64* %RAX.i54, align 8
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_je_.L_4bb611(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i8* nocapture %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
