...
define %struct.Memory* @autohelperowl_defendpat62(%struct.State* noalias, i64, %struct.Memory* noalias readnone) local_unnamed_addr #1 {
entry:
  ...
  %call2_4bb648 = tail call %struct.Memory* @sub_44db80.owl_goal_dragon(%struct.State* %0, i64 %120, %struct.Memory* %2)
  ...
  %cmpBr_4bb659 = icmp eq i8 %142, 1
  br i1 %cmpBr_4bb659, label %entry.block_.L_4bb688_crit_edge, label %block_4bb65f

entry.block_.L_4bb688_crit_edge:                  ; preds = %entry
...
block_4bb65f:                                     ; preds = %entry
  ...
  %call2_4bb674 = tail call %struct.Memory* @sub_478110.play_attack_defend_n(%struct.State* nonnull %0, i64 %162, %struct.Memory* %call2_4bb648)
...
block_.L_4bb688:                                  ; preds = %entry.block_.L_4bb688_crit_edge, %block_4bb65f
  %AL.i9.pre-phi = phi i8* [ %.pre1, %entry.block_.L_4bb688_crit_edge ], [ %AL.i20, %block_4bb65f ]
  %183 = phi i64 [ %144, %entry.block_.L_4bb688_crit_edge ], [ %.pre, %block_4bb65f ]
  %MEMORY.0 = phi %struct.Memory* [ %call2_4bb648, %entry.block_.L_4bb688_crit_edge ], [ %call2_4bb674, %block_4bb65f ]
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_je_.L_4bb688(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i8* nocapture %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
