...
define %struct.Memory* @autohelperowl_defendpat63(%struct.State* noalias, i64, %struct.Memory* noalias readnone) local_unnamed_addr #1 {
entry:
  ...
  %call2_4bb6c8 = tail call %struct.Memory* @sub_44db80.owl_goal_dragon(%struct.State* %0, i64 %120, %struct.Memory* %2)
  %125 = load i64, i64* %3, align 8
  store i64 0, i64* %RCX.i54, align 8
  %126 = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 17, i32 0
  %R8B.i39 = bitcast %union.anon* %126 to i8*
  ...
  %.v = select i1 %143, i64 47, i64 6
  %144 = add i64 %141, %.v
  store i64 %144, i64* %3, align 8
  %cmpBr_4bb6d9 = icmp eq i8 %142, 1
  br i1 %cmpBr_4bb6d9, label %entry.block_.L_4bb708_crit_edge, label %block_4bb6df

entry.block_.L_4bb708_crit_edge:                  ; preds = %entry
...
block_4bb6df:                                     ; preds = %entry
  ...
  store i64 %155, i64* %RCX.i54, align 8
  ...
  %call2_4bb6f4 = tail call %struct.Memory* @sub_478110.play_attack_defend_n(%struct.State* nonnull %0, i64 %162, %struct.Memory* %call2_4bb6c8)
  %167 = load i32, i32* %EAX.i37, align 4
...
block_.L_4bb708:                                  ; preds = %entry.block_.L_4bb708_crit_edge, %block_4bb6df
  %AL.i9.pre-phi = phi i8* [ %.pre1, %entry.block_.L_4bb708_crit_edge ], [ %AL.i20, %block_4bb6df ]
  %183 = phi i64 [ %144, %entry.block_.L_4bb708_crit_edge ], [ %.pre, %block_4bb6df ]
  %MEMORY.0 = phi %struct.Memory* [ %call2_4bb6c8, %entry.block_.L_4bb708_crit_edge ], [ %call2_4bb6f4, %block_4bb6df ]
  ...
  store i64 %190, i64* %RAX.i56, align 8
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_je_.L_4bb708(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i8* nocapture %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
