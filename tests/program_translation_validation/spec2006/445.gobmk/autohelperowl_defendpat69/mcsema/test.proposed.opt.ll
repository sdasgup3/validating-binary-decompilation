...
define %struct.Memory* @autohelperowl_defendpat69(%struct.State* noalias, i64, %struct.Memory* noalias readnone returned) local_unnamed_addr #1 {
entry:
  ...
  %call2_4bb9f8 = tail call %struct.Memory* @sub_44da20.owl_escape_value(%struct.State* %0, i64 %120, %struct.Memory* %2)
  ...
  ret %struct.Memory* %call2_4bb9f8
}
