...
define %struct.Memory* @autohelperowl_defendpat77(%struct.State* noalias, i64, %struct.Memory* noalias readnone) local_unnamed_addr #1 {
entry:
  ...
  %RAX.i89 = getelementptr inbounds %union.anon, %union.anon* %39, i64 0, i32 0
  store i64 1, i64* %RAX.i89, align 8
  ...
  %ECX.i80 = bitcast %union.anon* %59 to i32*
  %60 = load i64, i64* %RBP.i, align 8
  %61 = add i64 %60, -16
  %62 = load i32, i32* %ECX.i80, align 4
  ...
  store i64 %72, i64* %R8.i78, align 8
  %RCX.i74 = getelementptr inbounds %union.anon, %union.anon* %59, i64 0, i32 0
  %73 = shl nsw i64 %72, 2
  ...
  store i64 %119, i64* %R8.i78, align 8
  ...
  store i64 %131, i64* %RCX.i74, align 8
  ...
  %RDI.i54 = getelementptr inbounds %union.anon, %union.anon* %40, i64 0, i32 0
  ...
  store i64 %171, i64* %RCX.i74, align 8
  %172 = add i64 %160, -24
  %173 = add i64 %162, 10
  ...
  store i64 %176, i64* %R8.i78, align 8
  %EAX.i45 = bitcast %union.anon* %39 to i32*
  %RSI.i46 = getelementptr inbounds %union.anon, %union.anon* %45, i64 0, i32 0
  %177 = load i32, i32* %EAX.i45, align 4
  %178 = zext i32 %177 to i64
  store i64 %178, i64* %RSI.i46, align 8
  %RDX.i43 = getelementptr inbounds %union.anon, %union.anon* %52, i64 0, i32 0
  store i64 %178, i64* %RDX.i43, align 8
  %AL.i40 = bitcast %union.anon* %39 to i8*
  store i8 0, i8* %AL.i40, align 1
  %179 = add i64 %162, -277517
  %180 = add i64 %162, 21
  ...
  %call2_4bbd2d = tail call %struct.Memory* @sub_478110.play_attack_defend_n(%struct.State* %0, i64 %179, %struct.Memory* %2)
  ...
  %186 = load i32, i32* %EAX.i45, align 4
  ...
  %201 = load i8, i8* %29, align 1
  %202 = icmp ne i8 %201, 0
  %.v = select i1 %202, i64 48, i64 6
  %203 = add i64 %200, %.v
  store i64 %203, i64* %3, align 8
  %cmpBr_4bbd3e = icmp eq i8 %201, 1
  br i1 %cmpBr_4bbd3e, label %block_.L_4bbd6e, label %block_4bbd44

block_4bbd44:                                     ; preds = %entry
  store i64 1, i64* %RSI.i46, align 8
  store i64 2, i64* %RDX.i43, align 8
  ...
  store i64 %209, i64* %RDI.i54, align 8
  %210 = add i64 %204, -8
  %211 = add i64 %203, 16
  ...
  store i64 %214, i64* %RCX.i74, align 8
  %215 = add i64 %204, -20
  %216 = add i64 %203, 20
  ...
  store i64 %219, i64* %R8.i78, align 8
  %220 = getelementptr inbounds %union.anon, %union.anon* %185, i64 0, i32 0
  %221 = add i64 %203, 24
  ...
  %call2_4bbd5e = tail call %struct.Memory* @sub_478110.play_attack_defend_n(%struct.State* nonnull %0, i64 %224, %struct.Memory* %call2_4bbd2d)
  %229 = load i32, i32* %EAX.i45, align 4
  ...
  store i8 0, i8* %38, align 1
  %240 = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 21, i32 0
  %R10B.i14 = bitcast %union.anon* %240 to i8*
  %241 = xor i1 %236, true
  %242 = zext i1 %241 to i8
  store i8 %242, i8* %R10B.i14, align 1
  ...
  br label %block_.L_4bbd6e

block_.L_4bbd6e:                                  ; preds = %block_4bbd44, %entry
  %247 = phi i64 [ %203, %entry ], [ %.pre, %block_4bbd44 ]
  %MEMORY.0 = phi %struct.Memory* [ %call2_4bbd2d, %entry ], [ %call2_4bbd5e, %block_4bbd44 ]
  ...
  store i64 %254, i64* %RAX.i89, align 8
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_je_.L_4bbd6e(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i8* nocapture %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
