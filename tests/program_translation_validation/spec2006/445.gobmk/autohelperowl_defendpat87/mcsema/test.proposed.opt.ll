...
define %struct.Memory* @autohelperowl_defendpat87(%struct.State* noalias, i64, %struct.Memory* noalias readnone) local_unnamed_addr #1 {
entry:
  ...
  %.v = select i1 %195, i64 26, i64 6
  %196 = add i64 %193, %.v
  store i64 %196, i64* %3, align 8
  %cmpBr_4bc1bd = icmp eq i8 %194, 1
...
block_4bc1c3:                                     ; preds = %entry
  ...
  store i64 %202, i64* %RDI.i35, align 8
  %203 = add i64 %197, -20
  %204 = add i64 %196, 6
  ...
  store i64 %207, i64* %RSI.i32, align 8
  %208 = add i64 %196, -281715
  %209 = add i64 %196, 11
  ...
  %call2_4bc1c9 = tail call %struct.Memory* @sub_477550.does_defend(%struct.State* nonnull %0, i64 %208, %struct.Memory* %call2_4bc1ac)
  %213 = load i32, i32* %EAX.i25, align 4
  ...
  store i8 %225, i8* %CL.i27, align 1
...
block_.L_4bc1d7:                                  ; preds = %block_4bc1c3, %entry
  %230 = phi i64 [ %196, %entry ], [ %.pre, %block_4bc1c3 ]
  %MEMORY.0 = phi %struct.Memory* [ %call2_4bc1ac, %entry ], [ %call2_4bc1c9, %block_4bc1c3 ]
  ...
  store i64 %237, i64* %RAX.i59, align 8
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_je_.L_4bc1d7(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i8* nocapture %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
