...
define %struct.Memory* @autohelperowl_vital_apat1(%struct.State* noalias, i64, %struct.Memory* noalias readnone) local_unnamed_addr #1 {
entry:
  ...
  %call2_4c4f79 = tail call %struct.Memory* @sub_40f780.countlib(%struct.State* %0, i64 %167, %struct.Memory* %2)
  ...
  br i1 %204, label %block_.L_4c4fa1, label %block_4c4f90
...
block_4c4f90:                                     ; preds = %entry
  ...
  %call2_4c4f93 = tail call %struct.Memory* @sub_40f780.countlib(%struct.State* nonnull %0, i64 %212, %struct.Memory* %call2_4c4f79)
  %217 = load i32, i32* %EAX.i23, align 4
  %218 = load i64, i64* %3, align 8
  %219 = add i32 %217, -2
  %220 = icmp ult i32 %217, 2
...
block_.L_4c4fa1:                                  ; preds = %block_4c4f90, %entry
  %244 = phi i64 [ %201, %entry ], [ %.pre, %block_4c4f90 ]
  %MEMORY.0 = phi %struct.Memory* [ %call2_4c4f79, %entry ], [ %call2_4c4f93, %block_4c4f90 ]
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_jne_.L_4c4fa1(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i8* nocapture %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
