...
define %struct.Memory* @autohelperowl_vital_apat12(%struct.State* noalias, i64, %struct.Memory* noalias readnone) local_unnamed_addr #1 {
entry:
  ...
  %call2_4c5329 = tail call %struct.Memory* @sub_40f780.countlib(%struct.State* %0, i64 %167, %struct.Memory* %2)
  ...
  br i1 %211, label %entry.block_.L_4c5365_crit_edge, label %block_4c5340

entry.block_.L_4c5365_crit_edge:                  ; preds = %entry
  %.pre1 = bitcast %union.anon* %65 to i8*
  br label %block_.L_4c5365

block_4c5340:                                     ; preds = %entry
  ...
  store i64 %218, i64* %RDI.i42, align 8
  %219 = add i64 %213, -20
  %220 = add i64 %212, 11
  ...
  store i64 %223, i64* %RCX.i64, align 8
  %224 = getelementptr inbounds %union.anon, %union.anon* %173, i64 0, i32 0
  %225 = add i64 %212, 15
  store i64 %225, i64* %3, align 8
  %226 = load i32, i32* %221, align 4
  ...
  %call2_4c5355 = tail call %struct.Memory* @sub_478110.play_attack_defend_n(%struct.State* nonnull %0, i64 %228, %struct.Memory* %call2_4c5329)
  %233 = load i32, i32* %EAX.i35, align 4
  ...
  %244 = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 19, i32 0
  %R9B.i14 = bitcast %union.anon* %244 to i8*
  %245 = xor i1 %240, true
  %246 = zext i1 %245 to i8
  store i8 %246, i8* %R9B.i14, align 1
...
block_.L_4c5365:                                  ; preds = %entry.block_.L_4c5365_crit_edge, %block_4c5340
  %AL.i9.pre-phi = phi i8* [ %.pre1, %entry.block_.L_4c5365_crit_edge ], [ %AL.i18, %block_4c5340 ]
  %251 = phi i64 [ %201, %entry.block_.L_4c5365_crit_edge ], [ %.pre, %block_4c5340 ]
  %MEMORY.0 = phi %struct.Memory* [ %call2_4c5329, %entry.block_.L_4c5365_crit_edge ], [ %call2_4c5355, %block_4c5340 ]
  ...
  %257 = and i8 %256, 1
  store i8 %257, i8* %AL.i9.pre-phi, align 1
  %258 = zext i8 %257 to i64
  store i64 %258, i64* %RAX.i66, align 8
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_jg_.L_4c5365(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i8* nocapture %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
