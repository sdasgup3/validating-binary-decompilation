...
define %struct.Memory* @autohelperowl_vital_apat19(%struct.State* noalias, i64, %struct.Memory* noalias readnone) local_unnamed_addr #1 {
entry:
  ...
  %call2_4c5706 = tail call %struct.Memory* @sub_44d940.owl_topological_eye(%struct.State* %0, i64 %224, %struct.Memory* %2)
  ...
  br i1 %261, label %block_.L_4c573a, label %block_4c571d

block_4c571d:                                     ; preds = %entry
  ...
  store i64 %268, i64* %RDI.i41, align 8
  %269 = add i64 %263, -28
  %270 = add i64 %262, 7
  ...
  store i64 %273, i64* %RAX.i77, align 8
  ...
  store i64 %278, i64* %RSI.i36, align 8
  %279 = add i64 %262, -490973
  %280 = add i64 %262, 20
  ...
  %call2_4c572c = tail call %struct.Memory* @sub_44d940.owl_topological_eye(%struct.State* nonnull %0, i64 %279, %struct.Memory* %call2_4c5706)
  %284 = load i32, i32* %EAX.i28, align 4
  ...
  store i8 %299, i8* %CL.i30, align 1
  %307 = load i64, i64* %RBP.i, align 8
  %308 = add i64 %307, -29
  %309 = add i64 %285, 9
  store i64 %309, i64* %3, align 8
  %310 = inttoptr i64 %308 to i8*
  store i8 %299, i8* %310, align 1
  %.pre = load i64, i64* %3, align 8
  br label %block_.L_4c573a

block_.L_4c573a:                                  ; preds = %block_4c571d, %entry
  %311 = phi i64 [ %258, %entry ], [ %.pre, %block_4c571d ]
  %MEMORY.0 = phi %struct.Memory* [ %call2_4c5706, %entry ], [ %call2_4c572c, %block_4c571d ]
  ...
  store i64 %318, i64* %RAX.i77, align 8
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_jne_.L_4c573a(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i8* nocapture %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
