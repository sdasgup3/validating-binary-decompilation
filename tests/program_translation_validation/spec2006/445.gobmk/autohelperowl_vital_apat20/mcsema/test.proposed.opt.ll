...
define %struct.Memory* @autohelperowl_vital_apat20(%struct.State* noalias, i64, %struct.Memory* noalias readnone returned) local_unnamed_addr #1 {
entry:
  ...
  %call2_4c5778 = tail call %struct.Memory* @sub_44dd00.owl_big_eyespace(%struct.State* %0, i64 %119, %struct.Memory* %2)
  ...
  ret %struct.Memory* %call2_4c5778
}
