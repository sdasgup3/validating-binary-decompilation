...
define %struct.Memory* @autohelperowl_vital_apat21(%struct.State* noalias, i64, %struct.Memory* noalias readnone) local_unnamed_addr #1 {
entry:
  ...
  %call2_4c57c9 = tail call %struct.Memory* @sub_44dd00.owl_big_eyespace(%struct.State* %0, i64 %167, %struct.Memory* %2)
  ...
  %cmpBr_4c57da = icmp eq i8 %189, 1
  br i1 %cmpBr_4c57da, label %entry.block_.L_4c580a_crit_edge, label %block_4c57e0

entry.block_.L_4c580a_crit_edge:                  ; preds = %entry
...
block_4c57e0:                                     ; preds = %entry
  ...
  %call2_4c57fa = tail call %struct.Memory* @sub_478110.play_attack_defend_n(%struct.State* nonnull %0, i64 %215, %struct.Memory* %call2_4c57c9)
  %220 = load i32, i32* %EAX.i33, align 4
  ...
  %R10B.i14 = bitcast %union.anon* %231 to i8*
  %232 = xor i1 %227, true
  %233 = zext i1 %232 to i8
  store i8 %233, i8* %R10B.i14, align 1
...
block_.L_4c580a:                                  ; preds = %entry.block_.L_4c580a_crit_edge, %block_4c57e0
  %AL.i9.pre-phi = phi i8* [ %.pre1, %entry.block_.L_4c580a_crit_edge ], [ %AL.i18, %block_4c57e0 ]
  %238 = phi i64 [ %191, %entry.block_.L_4c580a_crit_edge ], [ %.pre, %block_4c57e0 ]
  %MEMORY.0 = phi %struct.Memory* [ %call2_4c57c9, %entry.block_.L_4c580a_crit_edge ], [ %call2_4c57fa, %block_4c57e0 ]
  ...
  %244 = and i8 %243, 1
  store i8 %244, i8* %AL.i9.pre-phi, align 1
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_je_.L_4c580a(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i8* nocapture %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
