...
define %struct.Memory* @autohelperowl_vital_apat22(%struct.State* noalias, i64, %struct.Memory* noalias readnone) local_unnamed_addr #1 {
entry:
  ...
  %RAX.i87 = getelementptr inbounds %union.anon, %union.anon* %66, i64 0, i32 0
  ...
  %RCX.i85 = getelementptr inbounds %union.anon, %union.anon* %59, i64 0, i32 0
  %74 = shl nsw i64 %73, 2
  ...
  store i64 %79, i64* %RCX.i85, align 8
  %80 = add i64 %67, -8
  %81 = add i64 %69, 14
  ...
  store i64 %85, i64* %RCX.i85, align 8
  ...
  store i64 %126, i64* %RCX.i85, align 8
  %127 = add i64 %114, -8
  %128 = add i64 %116, 14
  ...
  store i64 %132, i64* %RCX.i85, align 8
  ...
  store i64 %167, i64* %RAX.i87, align 8
  ...
  store i64 %179, i64* %RCX.i85, align 8
  ...
  %call2_4c586a = tail call %struct.Memory* @sub_44dd00.owl_big_eyespace(%struct.State* %0, i64 %215, %struct.Memory* %2)
  %220 = load i64, i64* %3, align 8
  store i64 0, i64* %RCX.i85, align 8
  %221 = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 17, i32 0
  %R8B.i46 = bitcast %union.anon* %221 to i8*
  store i8 0, i8* %R8B.i46, align 1
  %EAX.i44 = bitcast %union.anon* %66 to i32*
  %222 = load i32, i32* %EAX.i44, align 4
  ...
  %.v = select i1 %238, i64 63, i64 6
  %239 = add i64 %236, %.v
  store i64 %239, i64* %3, align 8
  %cmpBr_4c587b = icmp eq i8 %237, 1
  br i1 %cmpBr_4c587b, label %entry.block_.L_4c58ba_crit_edge, label %block_4c5881

entry.block_.L_4c58ba_crit_edge:                  ; preds = %entry
...
block_4c5881:                                     ; preds = %entry
  ...
  store i64 %245, i64* %RDI.i51, align 8
  %246 = add i64 %240, -8
  %247 = add i64 %239, 16
  ...
  store i64 %250, i64* %RCX.i85, align 8
  %251 = getelementptr inbounds %union.anon, %union.anon* %221, i64 0, i32 0
  %252 = add i64 %240, -20
  %253 = add i64 %239, 20
  ...
  store i64 %267, i64* %RAX.i87, align 8
  %268 = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 21, i32 0
  %R10D.i25 = bitcast %union.anon* %268 to i32*
  %269 = getelementptr inbounds %union.anon, %union.anon* %268, i64 0, i32 0
  %270 = add i64 %239, 31
  store i64 %270, i64* %3, align 8
  %271 = load i32, i32* %254, align 4
  %272 = zext i32 %271 to i64
  store i64 %272, i64* %269, align 8
  %273 = bitcast i64* %6 to i32**
  ...
  %277 = add i64 %276, 8
  %278 = load i32, i32* %R10D.i25, align 4
  ...
  %call2_4c58aa = tail call %struct.Memory* @sub_478110.play_attack_defend_n(%struct.State* nonnull %0, i64 %283, %struct.Memory* %call2_4c586a)
  %288 = load i32, i32* %EAX.i44, align 4
  ...
  store i8 0, i8* %39, align 1
  %299 = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 23, i32 0
  %R11B.i14 = bitcast %union.anon* %299 to i8*
  %300 = xor i1 %295, true
  %301 = zext i1 %300 to i8
  store i8 %301, i8* %R11B.i14, align 1
...
block_.L_4c58ba:                                  ; preds = %entry.block_.L_4c58ba_crit_edge, %block_4c5881
  %AL.i9.pre-phi = phi i8* [ %.pre1, %entry.block_.L_4c58ba_crit_edge ], [ %AL.i18, %block_4c5881 ]
  %306 = phi i64 [ %239, %entry.block_.L_4c58ba_crit_edge ], [ %.pre, %block_4c5881 ]
  %MEMORY.0 = phi %struct.Memory* [ %call2_4c586a, %entry.block_.L_4c58ba_crit_edge ], [ %call2_4c58aa, %block_4c5881 ]
  ...
  %312 = and i8 %311, 1
  store i8 %312, i8* %AL.i9.pre-phi, align 1
  %313 = zext i8 %312 to i64
  store i64 %313, i64* %RAX.i87, align 8
  %314 = load i64, i64* %6, align 8
  %315 = add i64 %314, 48
  store i64 %315, i64* %6, align 8
  %316 = icmp ugt i64 %314, -49
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_je_.L_4c58ba(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i8* nocapture %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
