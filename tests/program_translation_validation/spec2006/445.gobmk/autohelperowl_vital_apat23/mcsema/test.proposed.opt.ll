...
define %struct.Memory* @autohelperowl_vital_apat23(%struct.State* noalias, i64, %struct.Memory* noalias readnone) local_unnamed_addr #1 {
entry:
  ...
  %call2_4c58f8 = tail call %struct.Memory* @sub_40f780.countlib(%struct.State* %0, i64 %120, %struct.Memory* %2)
  ...
  br i1 %157, label %block_.L_4c5947, label %block_4c590f

block_4c590f:                                     ; preds = %entry
  ...
  %call2_4c5912 = tail call %struct.Memory* @sub_44dbb0.owl_eyespace(%struct.State* nonnull %0, i64 %165, %struct.Memory* %call2_4c58f8)
  ...
  %cmpBr_4c5922 = icmp eq i8 %186, 1
  br i1 %cmpBr_4c5922, label %block_.L_4c5947, label %block_4c5928

block_4c5928:                                     ; preds = %block_4c590f
  ...
  %call2_4c5937 = tail call %struct.Memory* @sub_412080.accuratelib(%struct.State* nonnull %0, i64 %200, %struct.Memory* %call2_4c5912)
...
block_.L_4c5947:                                  ; preds = %block_4c5928, %block_4c590f, %entry
  %224 = phi i64 [ %154, %entry ], [ %188, %block_4c590f ], [ %.pre, %block_4c5928 ]
  %MEMORY.0 = phi %struct.Memory* [ %call2_4c58f8, %entry ], [ %call2_4c5912, %block_4c590f ], [ %call2_4c5937, %block_4c5928 ]
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_jne_.L_4c5947(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i8* nocapture %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_je_.L_4c5947(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i8* nocapture %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 2, i32 7
