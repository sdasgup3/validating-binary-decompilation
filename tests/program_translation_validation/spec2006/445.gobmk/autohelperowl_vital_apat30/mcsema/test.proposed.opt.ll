...
define %struct.Memory* @autohelperowl_vital_apat30(%struct.State* noalias, i64, %struct.Memory* noalias readnone) local_unnamed_addr #1 {
entry:
  ...
  %RAX.i96 = getelementptr inbounds %union.anon, %union.anon* %66, i64 0, i32 0
  ...
  store i64 %73, i64* %RAX.i96, align 8
  %RCX.i94 = getelementptr inbounds %union.anon, %union.anon* %59, i64 0, i32 0
  %74 = shl nsw i64 %73, 2
  ...
  store i64 %167, i64* %RAX.i96, align 8
  ...
  br i1 %252, label %block_.L_4c5aea, label %block_4c5aa1
...
block_4c5aa1:                                     ; preds = %entry
  ...
  %call2_4c5aa4 = tail call %struct.Memory* @sub_44dbb0.owl_eyespace(%struct.State* nonnull %0, i64 %260, %struct.Memory* %call2_4c5a8a)
  %265 = load i64, i64* %3, align 8
  store i64 0, i64* %RDI.i60, align 8
  store i8 0, i8* %CL.i54, align 1
  %266 = load i32, i32* %EAX.i52, align 4
  ...
  %.v = select i1 %282, i64 54, i64 6
  %283 = add i64 %280, %.v
  store i64 %283, i64* %3, align 8
  %cmpBr_4c5ab4 = icmp eq i8 %281, 1
...
block_4c5aba:                                     ; preds = %block_4c5aa1
  ...
  store i64 %289, i64* %RDI.i60, align 8
  %290 = add i64 %284, -8
  %291 = add i64 %283, 16
  ...
  store i64 %294, i64* %RCX.i94, align 8
  %295 = getelementptr inbounds %union.anon, %union.anon* %221, i64 0, i32 0
  %296 = add i64 %284, -20
  %297 = add i64 %283, 20
  ...
  %301 = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 19, i32 0, i32 0
  %302 = add i64 %284, -24
  %303 = add i64 %283, 24
  ...
  store i64 %309, i64* %RAX.i96, align 8
  %310 = bitcast i64* %6 to i32**
  ...
  %call2_4c5ada = tail call %struct.Memory* @sub_478110.play_attack_defend_n(%struct.State* nonnull %0, i64 %314, %struct.Memory* %call2_4c5aa4)
  %319 = load i32, i32* %EAX.i52, align 4
  %320 = load i64, i64* %3, align 8
  %321 = add i32 %319, -5
  %322 = icmp ult i32 %319, 5
  ...
  %R10B.i14 = bitcast %union.anon* %342 to i8*
  %343 = xor i1 %333, true
  %344 = zext i1 %343 to i8
  store i8 %344, i8* %R10B.i14, align 1
...
block_.L_4c5aea:                                  ; preds = %block_4c5aba, %block_4c5aa1, %entry
  %349 = phi i64 [ %249, %entry ], [ %283, %block_4c5aa1 ], [ %.pre, %block_4c5aba ]
  %MEMORY.0 = phi %struct.Memory* [ %call2_4c5a8a, %entry ], [ %call2_4c5aa4, %block_4c5aa1 ], [ %call2_4c5ada, %block_4c5aba ]
  ...
  store i64 %356, i64* %RAX.i96, align 8
  %357 = load i64, i64* %6, align 8
  %358 = add i64 %357, 48
  store i64 %358, i64* %6, align 8
  %359 = icmp ugt i64 %357, -49
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_jne_.L_4c5aea(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i8* nocapture %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_je_.L_4c5aea(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i8* nocapture %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 2, i32 7
