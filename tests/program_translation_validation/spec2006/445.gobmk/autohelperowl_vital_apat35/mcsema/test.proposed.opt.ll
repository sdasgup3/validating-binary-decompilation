...
define %struct.Memory* @autohelperowl_vital_apat35(%struct.State* noalias, i64, %struct.Memory* noalias readnone returned) local_unnamed_addr #1 {
entry:
  ...
  %call2_4c5ba6 = tail call %struct.Memory* @sub_412080.accuratelib(%struct.State* %0, i64 %135, %struct.Memory* %2)
  ...
  ret %struct.Memory* %call2_4c5ba6
}
