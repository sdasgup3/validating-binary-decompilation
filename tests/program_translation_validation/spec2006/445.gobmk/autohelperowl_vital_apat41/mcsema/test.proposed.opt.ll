...
define %struct.Memory* @autohelperowl_vital_apat41(%struct.State* noalias, i64, %struct.Memory* noalias readnone) local_unnamed_addr #1 {
entry:
  ...
  %call2_4c5d59 = tail call %struct.Memory* @sub_40f780.countlib(%struct.State* %0, i64 %167, %struct.Memory* %2)
...
block_4c5d6e:                                     ; preds = %entry
  ...
  %call2_4c5d71 = tail call %struct.Memory* @sub_40f780.countlib(%struct.State* nonnull %0, i64 %210, %struct.Memory* %call2_4c5d59)
...
block_.L_4c5d7f:                                  ; preds = %block_4c5d6e, %entry
  %242 = phi i64 [ %203, %entry ], [ %.pre, %block_4c5d6e ]
  %MEMORY.0 = phi %struct.Memory* [ %call2_4c5d59, %entry ], [ %call2_4c5d71, %block_4c5d6e ]
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_je_.L_4c5d7f(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i8* nocapture %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
