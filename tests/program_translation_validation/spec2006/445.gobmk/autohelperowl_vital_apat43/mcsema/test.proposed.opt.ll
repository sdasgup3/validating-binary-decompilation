...
define %struct.Memory* @autohelperowl_vital_apat43(%struct.State* noalias, i64, %struct.Memory* noalias readnone) local_unnamed_addr #1 {
entry:
  ...
  %call2_4c5efa = tail call %struct.Memory* @sub_478110.play_attack_defend_n(%struct.State* %0, i64 %216, %struct.Memory* %2)
  ...
  br i1 %241, label %block_.L_4c5f45, label %block_4c5f11

block_4c5f11:                                     ; preds = %entry
  ...
  %call2_4c5f31 = tail call %struct.Memory* @sub_478110.play_attack_defend_n(%struct.State* nonnull %0, i64 %270, %struct.Memory* %call2_4c5efa)
  ...
  br label %block_.L_4c5f45

block_.L_4c5f45:                                  ; preds = %block_4c5f11, %entry
  %290 = phi i64 [ %238, %entry ], [ %.pre, %block_4c5f11 ]
  %MEMORY.0 = phi %struct.Memory* [ %call2_4c5efa, %entry ], [ %call2_4c5f31, %block_4c5f11 ]
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_jne_.L_4c5f45(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i8* nocapture %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
