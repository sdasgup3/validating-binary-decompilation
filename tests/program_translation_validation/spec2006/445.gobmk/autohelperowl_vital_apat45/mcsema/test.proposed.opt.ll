...
define %struct.Memory* @autohelperowl_vital_apat45(%struct.State* noalias, i64, %struct.Memory* noalias readnone returned) local_unnamed_addr #1 {
entry:
  ...
  %call2_4c6097 = tail call %struct.Memory* @sub_415900.is_ko_point(%struct.State* %0, i64 %73, %struct.Memory* %2)
  ...
  ret %struct.Memory* %call2_4c6097
}
