...
define %struct.Memory* @autohelperowl_vital_apat47(%struct.State* noalias, i64, %struct.Memory* noalias readnone) local_unnamed_addr #1 {
entry:
  ...
  %call2_4c61f9 = tail call %struct.Memory* @sub_44d9f0.vital_chain(%struct.State* %0, i64 %167, %struct.Memory* %2)
...
block_4c6210:                                     ; preds = %entry
  ...
  %call2_4c6213 = tail call %struct.Memory* @sub_44d9f0.vital_chain(%struct.State* nonnull %0, i64 %198, %struct.Memory* %call2_4c61f9)
...
block_4c6229:                                     ; preds = %block_4c6210
  ...
  %call2_4c6247 = tail call %struct.Memory* @sub_4784b0.play_attack_defend2_n(%struct.State* nonnull %0, i64 %265, %struct.Memory* %call2_4c6213)
...
block_.L_4c625b:                                  ; preds = %block_4c6229, %block_4c6210, %entry
  %286 = phi i64 [ %191, %entry ], [ %221, %block_4c6210 ], [ %.pre, %block_4c6229 ]
  %MEMORY.0 = phi %struct.Memory* [ %call2_4c61f9, %entry ], [ %call2_4c6213, %block_4c6210 ], [ %call2_4c6247, %block_4c6229 ]
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_je_.L_4c625b(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i8* nocapture %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
