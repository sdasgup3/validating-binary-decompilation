...
define %struct.Memory* @autohelperowl_vital_apat49(%struct.State* noalias, i64, %struct.Memory* noalias readnone) local_unnamed_addr #1 {
entry:
  ...
  %call2_4c62a9 = tail call %struct.Memory* @sub_40f780.countlib(%struct.State* %0, i64 %167, %struct.Memory* %2)
  ...
  br i1 %211, label %block_.L_4c62d1, label %block_4c62c0
...
block_4c62c0:                                     ; preds = %entry
  ...
  store i64 %218, i64* %RDI.i30, align 8
  %219 = add i64 %212, -493328
  %220 = add i64 %212, 8
  ...
  %call2_4c62c3 = tail call %struct.Memory* @sub_44dbb0.owl_eyespace(%struct.State* nonnull %0, i64 %219, %struct.Memory* %call2_4c62a9)
  %224 = load i32, i32* %EAX.i23, align 4
...
block_.L_4c62d1:                                  ; preds = %block_4c62c0, %entry
  %241 = phi i64 [ %201, %entry ], [ %.pre, %block_4c62c0 ]
  %MEMORY.0 = phi %struct.Memory* [ %call2_4c62a9, %entry ], [ %call2_4c62c3, %block_4c62c0 ]
  ...
  store i64 %248, i64* %RAX.i54, align 8
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_jg_.L_4c62d1(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i8* nocapture %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
