...
define %struct.Memory* @autohelperowl_vital_apat7(%struct.State* noalias, i64, %struct.Memory* noalias readnone) local_unnamed_addr #1 {
entry:
  ...
  %call2_4c5028 = tail call %struct.Memory* @sub_40f780.countlib(%struct.State* %0, i64 %120, %struct.Memory* %2)
  ...
  br i1 %157, label %block_.L_4c505e, label %block_4c503f
...
block_4c503f:                                     ; preds = %entry
  ...
  %call2_4c504e = tail call %struct.Memory* @sub_412080.accuratelib(%struct.State* nonnull %0, i64 %170, %struct.Memory* %call2_4c5028)
...
block_.L_4c505e:                                  ; preds = %block_4c503f, %entry
  %206 = phi i64 [ %154, %entry ], [ %.pre, %block_4c503f ]
  %MEMORY.0 = phi %struct.Memory* [ %call2_4c5028, %entry ], [ %call2_4c504e, %block_4c503f ]
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_jne_.L_4c505e(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i8* nocapture %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
