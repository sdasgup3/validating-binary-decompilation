...
define %struct.Memory* @autohelperpat1006(%struct.State* noalias, i64, %struct.Memory* noalias readnone) local_unnamed_addr #1 {
entry:
  ...
  store i64 %219, i64* %RCX.i93, align 8
  %220 = add i64 %207, -12
  %221 = add i64 %209, 14
  ...
  store i64 %225, i64* %RCX.i93, align 8
  ...
  %.v = select i1 %265, i64 10, i64 73
  %269 = add i64 %256, %.v
  store i64 %269, i64* %3, align 8
  br i1 %265, label %block_4dc372, label %block_.L_4dc3b1
...
block_4dc372:                                     ; preds = %entry
  ...
  store i64 %274, i64* %RDI.i42, align 8
  %275 = add i64 %254, -24
  %276 = add i64 %269, 16
  ...
  store i64 %279, i64* %RCX.i93, align 8
  ...
  %286 = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 19, i32 0, i32 0
  %287 = add i64 %254, -28
  %288 = add i64 %269, 24
  ...
  %R10D.i30 = bitcast %union.anon* %297 to i32*
  ...
  %304 = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 23, i32 0
  %R11D.i27 = bitcast %union.anon* %304 to i32*
  %305 = getelementptr inbounds %union.anon, %union.anon* %304, i64 0, i32 0
  %306 = add i64 %269, 35
  store i64 %306, i64* %3, align 8
  %307 = load i32, i32* %277, align 4
  %308 = zext i32 %307 to i64
  store i64 %308, i64* %305, align 8
  %EAX.i24 = bitcast %union.anon* %65 to i32*
  %309 = bitcast i64* %6 to i32**
  ...
  %313 = add i64 %312, 8
  %314 = load i32, i32* %R10D.i30, align 4
  ...
  %319 = add i64 %318, 16
  %320 = load i32, i32* %R11D.i27, align 4
  ...
  %call2_4dc3a4 = tail call %struct.Memory* @sub_478110.play_attack_defend_n(%struct.State* nonnull %0, i64 %325, %struct.Memory* %2)
  %330 = load i64, i64* %RBP.i, align 8
  %331 = add i64 %330, -4
  %332 = load i32, i32* %EAX.i24, align 4
...
block_.L_4dc3b1:                                  ; preds = %entry
  ...
  %call2_4dc3b7 = tail call %struct.Memory* @sub_4352e0.add_replacement_move(%struct.State* nonnull %0, i64 %348, %struct.Memory* %2)
...
block_.L_4dc3c3:                                  ; preds = %block_.L_4dc3b1, %block_4dc372
  %358 = phi i64 [ %.pre, %block_.L_4dc3b1 ], [ %337, %block_4dc372 ]
  %MEMORY.0 = phi %struct.Memory* [ %call2_4dc3b7, %block_.L_4dc3b1 ], [ %call2_4dc3a4, %block_4dc372 ]
  ...
  store i64 %364, i64* %RAX.i95, align 8
  %365 = load i64, i64* %6, align 8
  %366 = add i64 %365, 64
  store i64 %366, i64* %6, align 8
  %367 = icmp ugt i64 %365, -65
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_jne_.L_4dc3b1(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i8* nocapture %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_jmpq_.L_4dc3c3(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
