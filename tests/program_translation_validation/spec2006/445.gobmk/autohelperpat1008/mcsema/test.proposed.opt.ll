...
define %struct.Memory* @autohelperpat1008(%struct.State* noalias, i64, %struct.Memory* noalias readnone) local_unnamed_addr #1 {
entry:
  ...
  %call2_4dc4d8 = tail call %struct.Memory* @sub_43bff0.is_proper_eye_space(%struct.State* %0, i64 %120, %struct.Memory* %2)
  ...
  %142 = add i64 %141, 64
  %143 = add i64 %141, 6
  %144 = load i8, i8* %29, align 1
  %145 = icmp eq i8 %144, 0
  %146 = select i1 %145, i64 %142, i64 %143
  store i64 %146, i64* %3, align 8
  br i1 %145, label %block_.L_4dc529, label %block_4dc4ef

block_4dc4ef:                                     ; preds = %entry
  ...
  store i64 %152, i64* %RDI.i56, align 8
  ...
  store i64 %157, i64* %RSI.i40, align 8
  %158 = add i64 %146, -813615
  %159 = add i64 %146, 11
  ...
  %call2_4dc4f5 = tail call %struct.Memory* @sub_415ac0.does_capture_something(%struct.State* nonnull %0, i64 %158, %struct.Memory* %call2_4dc4d8)
  %163 = load i64, i64* %3, align 8
  store i64 0, i64* %RSI.i40, align 8
  store i8 0, i8* %CL.i51, align 1
  %164 = load i32, i32* %EAX.i49, align 4
  store i8 0, i8* %14, align 1
  %165 = and i32 %164, 255
  ...
  %179 = add i64 %178, 36
  %180 = add i64 %178, 6
  %181 = load i8, i8* %29, align 1
  %182 = icmp eq i8 %181, 0
  %183 = select i1 %182, i64 %179, i64 %180
  store i64 %183, i64* %3, align 8
  br i1 %182, label %block_.L_4dc529, label %block_4dc50b

block_4dc50b:                                     ; preds = %block_4dc4ef
  ...
  store i64 %189, i64* %RDI.i56, align 8
  %190 = add i64 %184, -12
  %191 = add i64 %183, 11
  ...
  store i64 %195, i64* %RAX.i68, align 8
  %196 = icmp ugt i32 %193, 3
  ...
  store i64 %195, i64* %RSI.i40, align 8
  %215 = add i64 %183, -813643
  %216 = add i64 %183, 18
  ...
  %call2_4dc518 = tail call %struct.Memory* @sub_415ac0.does_capture_something(%struct.State* nonnull %0, i64 %215, %struct.Memory* %call2_4dc4f5)
  %220 = load i32, i32* %EAX.i49, align 4
  %221 = load i64, i64* %3, align 8
  %222 = icmp ne i32 %220, 0
  %223 = zext i1 %222 to i64
  %224 = xor i64 %223, 255
  %225 = trunc i64 %224 to i8
  store i8 %225, i8* %CL.i51, align 1
  store i8 0, i8* %14, align 1
...
block_.L_4dc529:                                  ; preds = %block_4dc50b, %block_4dc4ef, %entry
  %235 = phi i64 [ %142, %entry ], [ %179, %block_4dc4ef ], [ %.pre, %block_4dc50b ]
  %MEMORY.0 = phi %struct.Memory* [ %call2_4dc4d8, %entry ], [ %call2_4dc4f5, %block_4dc4ef ], [ %call2_4dc518, %block_4dc50b ]
  ...
  store i64 %242, i64* %RAX.i68, align 8
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_jne_.L_4dc529(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i8* nocapture %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
