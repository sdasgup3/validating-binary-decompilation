...
define %struct.Memory* @autohelperpat1009(%struct.State* noalias, i64, %struct.Memory* noalias readnone) local_unnamed_addr #1 {
entry:
  ...
  store i64 %119, i64* %RDI.i34, align 8
  %120 = add i64 %115, -656853
  %121 = add i64 %115, 8
  ...
  br i1 %145, label %block_.L_4dc596, label %block_4dc57f
...
block_4dc57f:                                     ; preds = %entry
  ...
  store i64 %152, i64* %RDI.i34, align 8
  ...
  %call2_4dc585 = tail call %struct.Memory* @sub_415ac0.does_capture_something(%struct.State* nonnull %0, i64 %158, %struct.Memory* %call2_4dc568)
  %163 = load i32, i32* %EAX.i27, align 4
  %164 = load i64, i64* %3, align 8
  %165 = icmp ne i32 %163, 0
  %166 = zext i1 %165 to i64
  %167 = xor i64 %166, 255
  %168 = trunc i64 %167 to i8
  store i8 %168, i8* %CL.i29, align 1
  store i8 0, i8* %14, align 1
...
block_.L_4dc596:                                  ; preds = %block_4dc57f, %entry
  %178 = phi i64 [ %142, %entry ], [ %.pre, %block_4dc57f ]
  %MEMORY.0 = phi %struct.Memory* [ %call2_4dc568, %entry ], [ %call2_4dc585, %block_4dc57f ]
  ...
  store i64 %185, i64* %RAX.i46, align 8
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_jne_.L_4dc596(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i8* nocapture %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
