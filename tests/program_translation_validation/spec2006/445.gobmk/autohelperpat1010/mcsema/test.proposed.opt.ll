...
define %struct.Memory* @autohelperpat1010(%struct.State* noalias, i64, %struct.Memory* noalias readnone returned) local_unnamed_addr #1 {
entry:
  ...
  %call2_4dc5c7 = tail call %struct.Memory* @sub_415900.is_ko_point(%struct.State* %0, i64 %73, %struct.Memory* %2)
  ...
  %R8B.i11 = bitcast %union.anon* %81 to i8*
  %82 = icmp eq i32 %79, 0
  %83 = zext i1 %82 to i8
  store i8 %83, i8* %R8B.i11, align 1
  ...
  ret %struct.Memory* %call2_4dc5c7
}
