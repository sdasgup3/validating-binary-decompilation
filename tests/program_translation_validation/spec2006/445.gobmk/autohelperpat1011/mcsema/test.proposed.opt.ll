...
define %struct.Memory* @autohelperpat1011(%struct.State* noalias, i64, %struct.Memory* noalias readnone returned) local_unnamed_addr #1 {
entry:
  ...
  %call2_4dc61e = tail call %struct.Memory* @sub_477170.defend_against(%struct.State* %0, i64 %130, %struct.Memory* %2)
  ...
  ret %struct.Memory* %call2_4dc61e
}
