...
define %struct.Memory* @autohelperpat1024(%struct.State* noalias, i64, %struct.Memory* noalias readnone returned) local_unnamed_addr #1 {
entry:
  ...
  %call2_4dcd59 = tail call %struct.Memory* @sub_40f780.countlib(%struct.State* %0, i64 %167, %struct.Memory* %2)
  %172 = load i64, i64* %3, align 8
  store i64 0, i64* %RCX.i59, align 8
  %173 = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 17, i32 0
  %R8B.i33 = bitcast %union.anon* %173 to i8*
  ...
  br i1 %210, label %block_.L_4dcd92, label %block_4dcd70
...
block_4dcd70:                                     ; preds = %entry
  ...
  store i64 %218, i64* %RCX.i59, align 8
  %219 = lshr i64 %218, 63
  %220 = add i64 %218, ptrtoint (%G__0xb4bd20_type* @G__0xb4bd20 to i64)
  store i64 %220, i64* %RAX.i61, align 8
  ...
  %251 = xor i8 %250, -1
  store i8 %251, i8* %DL.i16, align 1
...
block_.L_4dcd92:                                  ; preds = %block_4dcd70, %entry
  %261 = phi i64 [ %.pre, %block_4dcd70 ], [ %201, %entry ]
  ...
  store i64 %268, i64* %RAX.i61, align 8
  ...
  ret %struct.Memory* %call2_4dcd59
}
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_jle_.L_4dcd92(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i8* nocapture %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
