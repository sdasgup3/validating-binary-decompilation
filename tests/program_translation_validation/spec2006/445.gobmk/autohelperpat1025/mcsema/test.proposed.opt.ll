...
define %struct.Memory* @autohelperpat1025(%struct.State* noalias, i64, %struct.Memory* noalias readnone returned) local_unnamed_addr #1 {
entry:
  ...
  %call2_4dcdc8 = tail call %struct.Memory* @sub_40f780.countlib(%struct.State* %0, i64 %120, %struct.Memory* %2)
  ...
  %134 = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 17, i32 0
  %R8B.i9 = bitcast %union.anon* %134 to i8*
  %135 = icmp ne i32 %129, 0
  %136 = xor i1 %135, %133
  %.demorgan = or i1 %128, %136
  %137 = xor i1 %.demorgan, true
  %138 = zext i1 %137 to i8
  store i8 %138, i8* %R8B.i9, align 1
  %139 = zext i1 %137 to i64
  store i64 %139, i64* %RAX.i22, align 8
  ...
  ret %struct.Memory* %call2_4dcdc8
}
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_movl_0xb5a2d0___rax_4____ecx(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %RAX = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 1, i32 0, i32 0
