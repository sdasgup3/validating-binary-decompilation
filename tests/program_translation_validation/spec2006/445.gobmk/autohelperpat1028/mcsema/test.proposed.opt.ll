...
define %struct.Memory* @autohelperpat1028(%struct.State* noalias, i64, %struct.Memory* noalias readnone) local_unnamed_addr #1 {
entry:
  ...
  %call2_4dd070 = tail call %struct.Memory* @sub_478110.play_attack_defend_n(%struct.State* %0, i64 %246, %struct.Memory* %2)
  ...
  br i1 %271, label %block_.L_4dd0e6, label %block_4dd087

block_4dd087:                                     ; preds = %entry
  ...
  %call2_4dd0a1 = tail call %struct.Memory* @sub_478110.play_attack_defend_n(%struct.State* nonnull %0, i64 %294, %struct.Memory* %call2_4dd070)
  ...
  br i1 %318, label %block_.L_4dd0e6, label %block_4dd0b8

block_4dd0b8:                                     ; preds = %block_4dd087
  store i64 1, i64* %RSI.i85, align 8
  store i64 2, i64* %RDX.i90, align 8
  ...
  %call2_4dd0d2 = tail call %struct.Memory* @sub_478110.play_attack_defend_n(%struct.State* nonnull %0, i64 %339, %struct.Memory* %call2_4dd0a1)
  ...
  br label %block_.L_4dd0e6

block_.L_4dd0e6:                                  ; preds = %block_4dd0b8, %block_4dd087, %entry
  %359 = phi i64 [ %268, %entry ], [ %315, %block_4dd087 ], [ %.pre, %block_4dd0b8 ]
  %MEMORY.0 = phi %struct.Memory* [ %call2_4dd070, %entry ], [ %call2_4dd0a1, %block_4dd087 ], [ %call2_4dd0d2, %block_4dd0b8 ]
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_jne_.L_4dd0e6(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i8* nocapture %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
