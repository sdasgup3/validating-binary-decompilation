...
define %struct.Memory* @autohelperpat1030(%struct.State* noalias, i64, %struct.Memory* noalias readnone) local_unnamed_addr #1 {
entry:
  ...
  %call2_4dd239 = tail call %struct.Memory* @sub_40f780.countlib(%struct.State* %0, i64 %167, %struct.Memory* %2)
  ...
  br i1 %210, label %block_.L_4dd261, label %block_4dd250

block_4dd250:                                     ; preds = %entry
  ...
  %call2_4dd253 = tail call %struct.Memory* @sub_40f780.countlib(%struct.State* nonnull %0, i64 %218, %struct.Memory* %call2_4dd239)
  %223 = load i32, i32* %EAX.i23, align 4
  %224 = load i64, i64* %3, align 8
  %225 = add i32 %223, -2
  %226 = icmp ult i32 %223, 2
  ...
  br label %block_.L_4dd261

block_.L_4dd261:                                  ; preds = %block_4dd250, %entry
  %254 = phi i64 [ %201, %entry ], [ %.pre, %block_4dd250 ]
  %MEMORY.0 = phi %struct.Memory* [ %call2_4dd239, %entry ], [ %call2_4dd253, %block_4dd250 ]
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_jle_.L_4dd261(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i8* nocapture %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
