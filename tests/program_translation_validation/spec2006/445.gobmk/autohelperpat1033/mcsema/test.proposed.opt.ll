...
define %struct.Memory* @autohelperpat1033(%struct.State* noalias, i64, %struct.Memory* noalias readnone) local_unnamed_addr #1 {
entry:
  ...
  %EDI.i102 = bitcast %union.anon* %39 to i32*
  %40 = add i64 %7, -12
  %41 = load i32, i32* %EDI.i102, align 4
  %42 = add i64 %10, 10
  ...
  store i64 %166, i64* %RAX.i92, align 8
  ...
  store i64 %172, i64* %RCX.i90, align 8
  %173 = add i64 %160, -8
  %174 = add i64 %162, 14
  ...
  store i64 %178, i64* %RCX.i90, align 8
  ...
  store i64 %213, i64* %RDI.i56, align 8
  %214 = add i64 %209, -843063
  %215 = add i64 %209, 8
  ...
  %call2_4dd4ba = tail call %struct.Memory* @sub_40f780.countlib(%struct.State* %0, i64 %214, %struct.Memory* %2)
  %219 = load i64, i64* %3, align 8
  store i64 0, i64* %RCX.i90, align 8
  %220 = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 17, i32 0
  %R8B.i51 = bitcast %union.anon* %220 to i8*
  store i8 0, i8* %R8B.i51, align 1
  %EAX.i48 = bitcast %union.anon* %65 to i32*
  %221 = load i32, i32* %EAX.i48, align 4
  %222 = add i32 %221, -2
  ...
  br i1 %251, label %block_.L_4dd518, label %block_4dd4d1

block_4dd4d1:                                     ; preds = %entry
  %CL.i50 = bitcast %union.anon* %58 to i8*
  ...
  store i64 %258, i64* %RDI.i56, align 8
  %259 = add i64 %252, -843089
  %260 = add i64 %252, 8
  ...
  %call2_4dd4d4 = tail call %struct.Memory* @sub_40f780.countlib(%struct.State* nonnull %0, i64 %259, %struct.Memory* %call2_4dd4ba)
  %264 = load i64, i64* %3, align 8
  store i64 0, i64* %RDI.i56, align 8
  store i8 0, i8* %CL.i50, align 1
  %265 = load i32, i32* %EAX.i48, align 4
  %266 = add i32 %265, -3
  ...
  br i1 %301, label %block_.L_4dd518, label %block_4dd4ea

block_4dd4ea:                                     ; preds = %block_4dd4d1
  ...
  store i64 %308, i64* %RDI.i56, align 8
  %309 = add i64 %303, -8
  %310 = add i64 %302, 16
  ...
  store i64 %313, i64* %RCX.i90, align 8
  ...
  %320 = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 19, i32 0, i32 0
  %321 = add i64 %302, 24
  ...
  %call2_4dd504 = tail call %struct.Memory* @sub_478110.play_attack_defend_n(%struct.State* nonnull %0, i64 %324, %struct.Memory* %call2_4dd4d4)
  %329 = load i32, i32* %EAX.i48, align 4
  %330 = load i64, i64* %3, align 8
  %331 = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 21, i32 0
  %R10B.i16 = bitcast %union.anon* %331 to i8*
  %332 = icmp ne i32 %329, 0
  %333 = zext i1 %332 to i64
  %334 = xor i64 %333, 255
  %335 = trunc i64 %334 to i8
  store i8 %335, i8* %R10B.i16, align 1
...
block_.L_4dd518:                                  ; preds = %block_4dd4ea, %block_4dd4d1, %entry
  %345 = phi i64 [ %248, %entry ], [ %292, %block_4dd4d1 ], [ %.pre, %block_4dd4ea ]
  %MEMORY.0 = phi %struct.Memory* [ %call2_4dd4ba, %entry ], [ %call2_4dd4d4, %block_4dd4d1 ], [ %call2_4dd504, %block_4dd4ea ]
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_jne_.L_4dd518(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i8* nocapture %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_jle_.L_4dd518(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i8* nocapture %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 2, i32 7
