...
define %struct.Memory* @autohelperpat1035(%struct.State* noalias, i64, %struct.Memory* noalias readnone) local_unnamed_addr #1 {
entry:
  ...
  %ECX.i66 = bitcast %union.anon* %58 to i32*
  %59 = load i64, i64* %RBP.i, align 8
  %60 = add i64 %59, -16
  %61 = load i32, i32* %ECX.i66, align 4
  ...
  %RAX.i63 = getelementptr inbounds %union.anon, %union.anon* %65, i64 0, i32 0
  ...
  store i64 %72, i64* %RAX.i63, align 8
  %RCX.i61 = getelementptr inbounds %union.anon, %union.anon* %58, i64 0, i32 0
  %73 = shl nsw i64 %72, 2
  ...
  store i64 %78, i64* %RCX.i61, align 8
  %79 = add i64 %66, -8
  %80 = add i64 %68, 14
  ...
  store i64 %84, i64* %RCX.i61, align 8
  ...
  store i64 %119, i64* %RAX.i63, align 8
  ...
  store i64 %125, i64* %RCX.i61, align 8
  %126 = add i64 %113, -8
  %127 = add i64 %115, 14
  ...
  store i64 %131, i64* %RCX.i61, align 8
  ...
  store i64 %166, i64* %RDI.i39, align 8
  %167 = add i64 %162, -843478
  %168 = add i64 %162, 8
  ...
  %call2_4dd659 = tail call %struct.Memory* @sub_40f780.countlib(%struct.State* %0, i64 %167, %struct.Memory* %2)
  %172 = load i64, i64* %3, align 8
  store i64 0, i64* %RCX.i61, align 8
  ...
  %EAX.i32 = bitcast %union.anon* %65 to i32*
  %174 = load i32, i32* %EAX.i32, align 4
  %175 = add i32 %174, -1
  ...
  br i1 %210, label %block_.L_4dd68e, label %block_4dd670

block_4dd670:                                     ; preds = %entry
  %CL.i34 = bitcast %union.anon* %58 to i8*
  store i64 3, i64* %RAX.i63, align 8
  ...
  store i64 %217, i64* %RDI.i39, align 8
  %218 = add i64 %212, -12
  %219 = add i64 %211, 11
  ...
  store i64 %223, i64* %RAX.i63, align 8
  %224 = icmp ugt i32 %221, 3
  ...
  store i64 %223, i64* %RSI.i, align 8
  %248 = add i64 %211, -419072
  %249 = add i64 %211, 21
  ...
  %call2_4dd680 = tail call %struct.Memory* @sub_477170.defend_against(%struct.State* nonnull %0, i64 %248, %struct.Memory* %call2_4dd659)
  %253 = load i32, i32* %EAX.i32, align 4
  ...
  store i8 %265, i8* %CL.i34, align 1
  ...
  br label %block_.L_4dd68e

block_.L_4dd68e:                                  ; preds = %block_4dd670, %entry
  %270 = phi i64 [ %201, %entry ], [ %.pre, %block_4dd670 ]
  %MEMORY.0 = phi %struct.Memory* [ %call2_4dd659, %entry ], [ %call2_4dd680, %block_4dd670 ]
  ...
  store i64 %277, i64* %RAX.i63, align 8
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_jle_.L_4dd68e(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i8* nocapture %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
