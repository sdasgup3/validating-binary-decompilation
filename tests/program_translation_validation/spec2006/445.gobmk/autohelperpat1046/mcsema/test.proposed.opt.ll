...
define %struct.Memory* @autohelperpat1046(%struct.State* noalias, i64, %struct.Memory* noalias readnone) local_unnamed_addr #1 {
entry:
  ...
  br i1 %95, label %block_4dd9e3, label %block_.L_4dda06
...
block_.L_4dda06:                                  ; preds = %entry
  ...
  %call2_4dda0d = tail call %struct.Memory* @sub_45db40.attack(%struct.State* nonnull %0, i64 %149, %struct.Memory* %2)
...
block_.L_4dda15:                                  ; preds = %block_.L_4dda06, %block_4dd9e3
  %160 = phi i64 [ %.pre, %block_.L_4dda06 ], [ %142, %block_4dd9e3 ]
  %MEMORY.0 = phi %struct.Memory* [ %call2_4dda0d, %block_.L_4dda06 ], [ %2, %block_4dd9e3 ]
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_jne_.L_4dda06(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i8* nocapture %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_jmpq_.L_4dda15(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
