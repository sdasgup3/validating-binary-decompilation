...
define %struct.Memory* @autohelperpat105(%struct.State* noalias, i64, %struct.Memory* noalias readnone returned) local_unnamed_addr #1 {
entry:
  ...
  %call2_4c9af2 = tail call %struct.Memory* @sub_477ce0.play_break_through_n(%struct.State* %0, i64 %224, %struct.Memory* %2)
  ...
  ret %struct.Memory* %call2_4c9af2
}
