...
define %struct.Memory* @autohelperpat1050(%struct.State* noalias, i64, %struct.Memory* noalias readnone) local_unnamed_addr #1 {
entry:
  ...
  %call2_4ddaa9 = tail call %struct.Memory* @sub_40f780.countlib(%struct.State* %0, i64 %167, %struct.Memory* %2)
  ...
  br i1 %204, label %entry.block_.L_4ddaee_crit_edge, label %block_4ddac0

entry.block_.L_4ddaee_crit_edge:                  ; preds = %entry
...
block_4ddac0:                                     ; preds = %entry
  ...
  %call2_4ddada = tail call %struct.Memory* @sub_478110.play_attack_defend_n(%struct.State* nonnull %0, i64 %227, %struct.Memory* %call2_4ddaa9)
...
block_.L_4ddaee:                                  ; preds = %entry.block_.L_4ddaee_crit_edge, %block_4ddac0
  %AL.i9.pre-phi = phi i8* [ %.pre1, %entry.block_.L_4ddaee_crit_edge ], [ %AL.i20, %block_4ddac0 ]
  %248 = phi i64 [ %201, %entry.block_.L_4ddaee_crit_edge ], [ %.pre, %block_4ddac0 ]
  %MEMORY.0 = phi %struct.Memory* [ %call2_4ddaa9, %entry.block_.L_4ddaee_crit_edge ], [ %call2_4ddada, %block_4ddac0 ]
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_jne_.L_4ddaee(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i8* nocapture %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
