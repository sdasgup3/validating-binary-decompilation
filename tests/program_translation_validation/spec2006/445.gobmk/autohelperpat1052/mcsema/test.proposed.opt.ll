...
define %struct.Memory* @autohelperpat1052(%struct.State* noalias, i64, %struct.Memory* noalias readnone) local_unnamed_addr #1 {
entry:
  ...
  %call2_4ddb57 = tail call %struct.Memory* @sub_478110.play_attack_defend_n(%struct.State* %0, i64 %171, %struct.Memory* %2)
...
block_4ddb6e:                                     ; preds = %entry
  ...
  store i64 %214, i64* %R9.i84, align 8
  store i8 0, i8* %AL.i41, align 1
  %215 = add i64 %195, -416350
  %216 = add i64 %195, 31
  ...
  %call2_4ddb88 = tail call %struct.Memory* @sub_478110.play_attack_defend_n(%struct.State* nonnull %0, i64 %215, %struct.Memory* %call2_4ddb57)
  %220 = load i32, i32* %EAX.i98, align 4
  ...
  store i8 %232, i8* %R10B.i36, align 1
...
block_.L_4ddb98:                                  ; preds = %block_4ddb6e, %entry
  %237 = phi i64 [ %195, %entry ], [ %.pre, %block_4ddb6e ]
  %MEMORY.0 = phi %struct.Memory* [ %call2_4ddb57, %entry ], [ %call2_4ddb88, %block_4ddb6e ]
  ...
  store i64 %244, i64* %RAX.i99, align 8
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_je_.L_4ddb98(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i8* nocapture %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
