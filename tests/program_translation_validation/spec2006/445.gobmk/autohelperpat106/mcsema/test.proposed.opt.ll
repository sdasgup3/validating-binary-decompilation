...
define %struct.Memory* @autohelperpat106(%struct.State* noalias, i64, %struct.Memory* noalias readnone returned) local_unnamed_addr #1 {
entry:
  ...
  %ESI.i63 = bitcast %union.anon* %47 to i32*
  %48 = load i64, i64* %RBP.i, align 8
  %49 = add i64 %48, -8
  %50 = load i32, i32* %ESI.i63, align 4
  ...
  store i64 %203, i64* %RCX.i52, align 8
  %RSI.i26 = getelementptr inbounds %union.anon, %union.anon* %47, i64 0, i32 0
  %204 = add i64 %165, 13
  store i64 %204, i64* %3, align 8
  %205 = load i32, i32* %196, align 4
  %206 = zext i32 %205 to i64
  store i64 %206, i64* %RSI.i26, align 8
  %207 = add i64 %163, -24
  %208 = add i64 %165, 17
  ...
  store i64 %211, i64* %R9.i56, align 8
  ...
  %EAX.i18 = bitcast %union.anon* %39 to i32*
  %215 = load i32, i32* %EAX.i18, align 4
  %216 = zext i32 %215 to i64
  %217 = load i64, i64* %3, align 8
  store i64 %216, i64* %RSI.i26, align 8
  ...
  %call2_4c9b72 = tail call %struct.Memory* @sub_477ce0.play_break_through_n(%struct.State* %0, i64 %224, %struct.Memory* %2)
  %229 = load i32, i32* %EAX.i18, align 4
  %230 = load i64, i64* %3, align 8
  %231 = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 21, i32 0
  %R10B.i11 = bitcast %union.anon* %231 to i8*
  %232 = icmp eq i32 %229, 0
  %233 = zext i1 %232 to i8
  store i8 %233, i8* %R10B.i11, align 1
  %234 = zext i1 %232 to i64
  store i64 %234, i64* %RAX.i70, align 8
  ...
  store i64 %261, i64* %RBP.i, align 8
  ...
  ret %struct.Memory* %call2_4c9b72
}
