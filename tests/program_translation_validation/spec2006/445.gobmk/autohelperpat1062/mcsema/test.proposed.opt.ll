...
define %struct.Memory* @autohelperpat1062(%struct.State* noalias, i64, %struct.Memory* noalias readnone) local_unnamed_addr #1 {
entry:
  ...
  %call2_4ddda9 = tail call %struct.Memory* @sub_40f780.countlib(%struct.State* %0, i64 %167, %struct.Memory* %2)
  ...
  br i1 %207, label %entry.block_.L_4dddea_crit_edge, label %block_4dddc0

entry.block_.L_4dddea_crit_edge:                  ; preds = %entry
...
block_4dddc0:                                     ; preds = %entry
  ...
  store i64 %214, i64* %RDI.i40, align 8
  %215 = add i64 %209, -20
  %216 = add i64 %208, 16
  ...
  store i64 %219, i64* %RCX.i62, align 8
  %220 = getelementptr inbounds %union.anon, %union.anon* %173, i64 0, i32 0
  %221 = add i64 %209, -8
  %222 = add i64 %208, 20
  ...
  %226 = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 19, i32 0, i32 0
  %227 = add i64 %208, 24
  ...
  %call2_4dddda = tail call %struct.Memory* @sub_478110.play_attack_defend_n(%struct.State* nonnull %0, i64 %230, %struct.Memory* %call2_4ddda9)
  %235 = load i32, i32* %EAX.i33, align 4
  ...
  %246 = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 21, i32 0
  %R10B.i14 = bitcast %union.anon* %246 to i8*
  %247 = xor i1 %242, true
  %248 = zext i1 %247 to i8
  store i8 %248, i8* %R10B.i14, align 1
...
block_.L_4dddea:                                  ; preds = %entry.block_.L_4dddea_crit_edge, %block_4dddc0
  %AL.i9.pre-phi = phi i8* [ %.pre1, %entry.block_.L_4dddea_crit_edge ], [ %AL.i18, %block_4dddc0 ]
  %253 = phi i64 [ %201, %entry.block_.L_4dddea_crit_edge ], [ %.pre, %block_4dddc0 ]
  %MEMORY.0 = phi %struct.Memory* [ %call2_4ddda9, %entry.block_.L_4dddea_crit_edge ], [ %call2_4dddda, %block_4dddc0 ]
  ...
  %259 = and i8 %258, 1
  store i8 %259, i8* %AL.i9.pre-phi, align 1
  %260 = zext i8 %259 to i64
  store i64 %260, i64* %RAX.i64, align 8
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_jl_.L_4dddea(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i8* nocapture %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
