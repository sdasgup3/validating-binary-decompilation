...
define %struct.Memory* @autohelperpat1068(%struct.State* noalias, i64, %struct.Memory* noalias readnone) local_unnamed_addr #1 {
entry:
  ...
  %call2_4ddeea = tail call %struct.Memory* @sub_40f780.countlib(%struct.State* %0, i64 %214, %struct.Memory* %2)
  ...
  br i1 %257, label %block_.L_4ddf2b, label %block_4ddf01
...
block_4ddf01:                                     ; preds = %entry
  ...
  %call2_4ddf04 = tail call %struct.Memory* @sub_40f780.countlib(%struct.State* nonnull %0, i64 %265, %struct.Memory* %call2_4ddeea)
  ...
  br i1 %307, label %block_.L_4ddf2b, label %block_4ddf1a
...
block_4ddf1a:                                     ; preds = %block_4ddf01
  ...
  %call2_4ddf1d = tail call %struct.Memory* @sub_40f780.countlib(%struct.State* nonnull %0, i64 %315, %struct.Memory* %call2_4ddf04)
...
block_.L_4ddf2b:                                  ; preds = %block_4ddf1a, %block_4ddf01, %entry
  %351 = phi i64 [ %248, %entry ], [ %298, %block_4ddf01 ], [ %.pre, %block_4ddf1a ]
  %MEMORY.0 = phi %struct.Memory* [ %call2_4ddeea, %entry ], [ %call2_4ddf04, %block_4ddf01 ], [ %call2_4ddf1d, %block_4ddf1a ]
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_jle_.L_4ddf2b(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i8* nocapture %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
