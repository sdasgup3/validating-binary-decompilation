...
define %struct.Memory* @autohelperpat1071(%struct.State* noalias, i64, %struct.Memory* noalias readnone returned) local_unnamed_addr #1 {
entry:
  ...
  %call2_4ddf68 = tail call %struct.Memory* @sub_4b0070.dragon_weak(%struct.State* %0, i64 %119, %struct.Memory* %2)
  ...
  ret %struct.Memory* %call2_4ddf68
}
