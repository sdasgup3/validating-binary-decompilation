...
define %struct.Memory* @autohelperpat1085(%struct.State* noalias, i64, %struct.Memory* noalias readnone returned) local_unnamed_addr #1 {
entry:
  ...
  %EAX.i9 = bitcast %union.anon* %40 to i32*
  %RSI.i = getelementptr inbounds %union.anon, %union.anon* %46, i64 0, i32 0
  %83 = load i32, i32* %EAX.i9, align 4
  ...
  %call2_4de069 = tail call %struct.Memory* @sub_478110.play_attack_defend_n(%struct.State* %0, i64 %85, %struct.Memory* %2)
  ...
  ret %struct.Memory* %call2_4de069
}
