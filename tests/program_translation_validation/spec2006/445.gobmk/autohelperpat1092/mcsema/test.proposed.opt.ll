...
define %struct.Memory* @autohelperpat1092(%struct.State* noalias, i64, %struct.Memory* noalias readnone) local_unnamed_addr #1 {
entry:
  ...
  %call2_4de268 = tail call %struct.Memory* @sub_40f780.countlib(%struct.State* %0, i64 %120, %struct.Memory* %2)
  ...
  br i1 %157, label %block_.L_4de2a5, label %block_4de27f
...
block_4de27f:                                     ; preds = %entry
  ...
  store i64 %164, i64* %RDI.i44, align 8
  %165 = add i64 %159, -12
  %166 = add i64 %158, 20
  ...
  store i64 %170, i64* %RAX.i56, align 8
  ...
  %call2_4de295 = tail call %struct.Memory* @sub_412080.accuratelib(%struct.State* nonnull %0, i64 %190, %struct.Memory* %call2_4de268)
  %195 = load i32, i32* %EAX.i37, align 4
  ...
  %220 = xor i1 %.demorgan, true
  %221 = zext i1 %220 to i8
  store i8 %221, i8* %R8B.i39, align 1
...
block_.L_4de2a5:                                  ; preds = %block_4de27f, %entry
  %226 = phi i64 [ %154, %entry ], [ %.pre, %block_4de27f ]
  %MEMORY.0 = phi %struct.Memory* [ %call2_4de268, %entry ], [ %call2_4de295, %block_4de27f ]
  ...
  store i64 %233, i64* %RAX.i56, align 8
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_jne_.L_4de2a5(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i8* nocapture %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
