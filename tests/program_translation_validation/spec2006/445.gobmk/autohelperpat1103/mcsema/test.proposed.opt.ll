...
define %struct.Memory* @autohelperpat1103(%struct.State* noalias, i64, %struct.Memory* noalias readnone) local_unnamed_addr #1 {
entry:
  ...
  %EDX.i100 = bitcast %union.anon* %51 to i32*
  %52 = load i64, i64* %RBP.i, align 8
  %53 = add i64 %52, -12
  %54 = load i32, i32* %EDX.i100, align 4
  ...
  %RDI.i70 = getelementptr inbounds %union.anon, %union.anon* %39, i64 0, i32 0
  ...
  store i64 %166, i64* %RDI.i70, align 8
  %167 = add i64 %162, -847798
  %168 = add i64 %162, 8
  ...
  %call2_4de739 = tail call %struct.Memory* @sub_40f780.countlib(%struct.State* %0, i64 %167, %struct.Memory* %2)
  %172 = load i64, i64* %3, align 8
  store i64 0, i64* %RCX.i92, align 8
  %173 = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 17, i32 0
  %R8B.i65 = bitcast %union.anon* %173 to i8*
  store i8 0, i8* %R8B.i65, align 1
  %EAX.i63 = bitcast %union.anon* %65 to i32*
  %174 = load i32, i32* %EAX.i63, align 4
  %175 = add i32 %174, -1
  ...
  br i1 %210, label %block_.L_4de7a7, label %block_4de750

block_4de750:                                     ; preds = %entry
  %RDX.i57 = getelementptr inbounds %union.anon, %union.anon* %51, i64 0, i32 0
  store i64 20, i64* %RDX.i57, align 8
  ...
  store i64 %217, i64* %RDI.i70, align 8
  %218 = add i64 %212, -12
  %219 = add i64 %211, 20
  ...
  store i64 %223, i64* %RAX.i94, align 8
  ...
  store i64 %223, i64* %RSI.i41, align 8
  %243 = add i64 %211, -837328
  %244 = add i64 %211, 27
  ...
  %call2_4de766 = tail call %struct.Memory* @sub_412080.accuratelib(%struct.State* nonnull %0, i64 %243, %struct.Memory* %call2_4de739)
  %248 = load i64, i64* %3, align 8
  store i64 0, i64* %RDX.i57, align 8
  store i8 0, i8* %R8B.i65, align 1
  %249 = load i32, i32* %EAX.i63, align 4
  %250 = add i32 %249, -1
  ...
  %282 = load i8, i8* %38, align 1
  %283 = icmp ne i8 %282, 0
  %284 = xor i1 %281, %283
  %285 = or i1 %279, %284
  %286 = select i1 %285, i64 %276, i64 %277
  store i64 %286, i64* %3, align 8
  br i1 %285, label %block_.L_4de7a7, label %block_4de77d

block_4de77d:                                     ; preds = %block_4de750
  store i64 1, i64* %RSI.i41, align 8
  ...
  store i64 %292, i64* %RDI.i70, align 8
  %293 = add i64 %287, -8
  %294 = add i64 %286, 16
  ...
  store i64 %297, i64* %RCX.i92, align 8
  %298 = getelementptr inbounds %union.anon, %union.anon* %173, i64 0, i32 0
  %299 = add i64 %287, -24
  %300 = add i64 %286, 20
  ...
  %304 = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 19, i32 0, i32 0
  %305 = add i64 %286, 24
  ...
  %call2_4de797 = tail call %struct.Memory* @sub_478110.play_attack_defend_n(%struct.State* nonnull %0, i64 %308, %struct.Memory* %call2_4de766)
  %313 = load i32, i32* %EAX.i63, align 4
  ...
  store i8 0, i8* %38, align 1
  %324 = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 21, i32 0
  %R10B.i14 = bitcast %union.anon* %324 to i8*
  %325 = xor i1 %320, true
  %326 = zext i1 %325 to i8
  store i8 %326, i8* %R10B.i14, align 1
...
block_.L_4de7a7:                                  ; preds = %block_4de77d, %block_4de750, %entry
  %331 = phi i64 [ %201, %entry ], [ %276, %block_4de750 ], [ %.pre, %block_4de77d ]
  %MEMORY.0 = phi %struct.Memory* [ %call2_4de739, %entry ], [ %call2_4de766, %block_4de750 ], [ %call2_4de797, %block_4de77d ]
  ...
  store i64 %338, i64* %RAX.i94, align 8
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_jle_.L_4de7a7(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i8* nocapture %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
