...
define %struct.Memory* @autohelperpat1105(%struct.State* noalias, i64, %struct.Memory* noalias readnone) local_unnamed_addr #1 {
entry:
  ...
  %call2_4de919 = tail call %struct.Memory* @sub_40f780.countlib(%struct.State* %0, i64 %167, %struct.Memory* %2)
  ...
  br i1 %210, label %entry.block_.L_4de962_crit_edge, label %block_4de930

entry.block_.L_4de962_crit_edge:                  ; preds = %entry
  %.pre1 = bitcast %union.anon* %65 to i8*
  br label %block_.L_4de962

block_4de930:                                     ; preds = %entry
  ...
  %252 = load i32, i32* %EAX.i44, align 4
  %253 = zext i32 %252 to i64
  %254 = load i64, i64* %3, align 8
  store i64 %253, i64* %RDX.i31, align 8
  ...
  %call2_4de952 = tail call %struct.Memory* @sub_478110.play_attack_defend_n(%struct.State* nonnull %0, i64 %261, %struct.Memory* %call2_4de919)
  %266 = load i32, i32* %EAX.i44, align 4
  ...
  %277 = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 19, i32 0
  %R9B.i14 = bitcast %union.anon* %277 to i8*
  %278 = xor i1 %273, true
...
block_.L_4de962:                                  ; preds = %entry.block_.L_4de962_crit_edge, %block_4de930
  %AL.i9.pre-phi = phi i8* [ %.pre1, %entry.block_.L_4de962_crit_edge ], [ %AL.i18, %block_4de930 ]
  %284 = phi i64 [ %201, %entry.block_.L_4de962_crit_edge ], [ %.pre, %block_4de930 ]
  %MEMORY.0 = phi %struct.Memory* [ %call2_4de919, %entry.block_.L_4de962_crit_edge ], [ %call2_4de952, %block_4de930 ]
  ...
  %290 = and i8 %289, 1
  store i8 %290, i8* %AL.i9.pre-phi, align 1
  %291 = zext i8 %290 to i64
  store i64 %291, i64* %RAX.i76, align 8
  %292 = load i64, i64* %6, align 8
  %293 = add i64 %292, 32
  store i64 %293, i64* %6, align 8
  %294 = icmp ugt i64 %292, -33
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_jle_.L_4de962(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i8* nocapture %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
