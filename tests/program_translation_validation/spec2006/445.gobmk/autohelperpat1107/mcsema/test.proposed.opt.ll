...
define %struct.Memory* @autohelperpat1107(%struct.State* noalias, i64, %struct.Memory* noalias readnone) local_unnamed_addr #1 {
entry:
  ...
  %call2_4dea9a = tail call %struct.Memory* @sub_40f780.countlib(%struct.State* %0, i64 %215, %struct.Memory* %2)
  ...
  br i1 %252, label %entry.block_.L_4deb14_crit_edge, label %block_4deab1

entry.block_.L_4deb14_crit_edge:                  ; preds = %entry
...
block_4deab1:                                     ; preds = %entry
  ...
  %call2_4dead3 = tail call %struct.Memory* @sub_478110.play_attack_defend_n(%struct.State* nonnull %0, i64 %303, %struct.Memory* %call2_4dea9a)
...
block_4deaea:                                     ; preds = %block_4deab1
  ...
  %call2_4deb04 = tail call %struct.Memory* @sub_478110.play_attack_defend_n(%struct.State* nonnull %0, i64 %348, %struct.Memory* %call2_4dead3)
...
block_.L_4deb14:                                  ; preds = %entry.block_.L_4deb14_crit_edge, %block_4deaea, %block_4deab1
  %AL.i9.pre-phi = phi i8* [ %.pre2, %entry.block_.L_4deb14_crit_edge ], [ %AL.i40, %block_4deaea ], [ %AL.i40, %block_4deab1 ]
  %371 = phi i64 [ %249, %entry.block_.L_4deb14_crit_edge ], [ %.pre, %block_4deaea ], [ %327, %block_4deab1 ]
  %MEMORY.0 = phi %struct.Memory* [ %call2_4dea9a, %entry.block_.L_4deb14_crit_edge ], [ %call2_4deb04, %block_4deaea ], [ %call2_4dead3, %block_4deab1 ]
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_jne_.L_4deb14(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i8* nocapture %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_je_.L_4deb14(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i8* nocapture %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 2, i32 7
