...
define %struct.Memory* @autohelperpat1113(%struct.State* noalias, i64, %struct.Memory* noalias readnone) local_unnamed_addr #1 {
entry:
  ...
  %call2_4dedd9 = tail call %struct.Memory* @sub_40f780.countlib(%struct.State* %0, i64 %167, %struct.Memory* %2)
  ...
  br i1 %204, label %block_.L_4dee01, label %block_4dedf0
...
block_4dedf0:                                     ; preds = %entry
  ...
  %call2_4dedf3 = tail call %struct.Memory* @sub_40f780.countlib(%struct.State* nonnull %0, i64 %212, %struct.Memory* %call2_4dedd9)
  ...
  %241 = xor i1 %240, %238
  %.demorgan = or i1 %231, %241
  %242 = xor i1 %.demorgan, true
  %243 = zext i1 %242 to i8
  store i8 %243, i8* %CL.i25, align 1
...
block_.L_4dee01:                                  ; preds = %block_4dedf0, %entry
  %248 = phi i64 [ %201, %entry ], [ %.pre, %block_4dedf0 ]
  %MEMORY.0 = phi %struct.Memory* [ %call2_4dedd9, %entry ], [ %call2_4dedf3, %block_4dedf0 ]
  ...
  store i64 %255, i64* %RAX.i54, align 8
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_jne_.L_4dee01(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i8* nocapture %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
