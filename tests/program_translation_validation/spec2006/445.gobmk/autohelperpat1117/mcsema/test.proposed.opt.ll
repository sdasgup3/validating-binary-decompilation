...
define %struct.Memory* @autohelperpat1117(%struct.State* noalias, i64, %struct.Memory* noalias readnone) local_unnamed_addr #1 {
entry:
  ...
  %call2_4def18 = tail call %struct.Memory* @sub_40f780.countlib(%struct.State* %0, i64 %120, %struct.Memory* %2)
  %125 = load i64, i64* %3, align 8
  store i64 0, i64* %RCX.i52, align 8
  %126 = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 17, i32 0
  %R8B.i37 = bitcast %union.anon* %126 to i8*
  ...
  br i1 %157, label %entry.block_.L_4def54_crit_edge, label %block_4def2f

entry.block_.L_4def54_crit_edge:                  ; preds = %entry
...
block_4def2f:                                     ; preds = %entry
  ...
  store i64 %164, i64* %RDI.i42, align 8
  %165 = add i64 %159, -8
  %166 = add i64 %158, 11
  ...
  store i64 %169, i64* %RCX.i52, align 8
  %170 = getelementptr inbounds %union.anon, %union.anon* %126, i64 0, i32 0
  %171 = add i64 %159, -20
  %172 = add i64 %158, 15
  ...
  %call2_4def44 = tail call %struct.Memory* @sub_478110.play_attack_defend_n(%struct.State* nonnull %0, i64 %176, %struct.Memory* %call2_4def18)
  %181 = load i32, i32* %EAX.i35, align 4
  ...
  %192 = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 19, i32 0
  %R9B.i14 = bitcast %union.anon* %192 to i8*
  %193 = xor i1 %188, true
  %194 = zext i1 %193 to i8
  store i8 %194, i8* %R9B.i14, align 1
...
block_.L_4def54:                                  ; preds = %entry.block_.L_4def54_crit_edge, %block_4def2f
  %AL.i9.pre-phi = phi i8* [ %.pre1, %entry.block_.L_4def54_crit_edge ], [ %AL.i18, %block_4def2f ]
  %199 = phi i64 [ %154, %entry.block_.L_4def54_crit_edge ], [ %.pre, %block_4def2f ]
  %MEMORY.0 = phi %struct.Memory* [ %call2_4def18, %entry.block_.L_4def54_crit_edge ], [ %call2_4def44, %block_4def2f ]
  ...
  %205 = and i8 %204, 1
  store i8 %205, i8* %AL.i9.pre-phi, align 1
  %206 = zext i8 %205 to i64
  store i64 %206, i64* %RAX.i54, align 8
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_jne_.L_4def54(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i8* nocapture %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
