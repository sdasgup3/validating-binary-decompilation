...
define %struct.Memory* @autohelperpat1127(%struct.State* noalias, i64, %struct.Memory* noalias readnone returned) local_unnamed_addr #1 {
entry:
  ...
  %call2_4df962 = tail call %struct.Memory* @sub_4b01a0.test_attack_either_move(%struct.State* %0, i64 %181, %struct.Memory* %2)
  ...
  ret %struct.Memory* %call2_4df962
}
