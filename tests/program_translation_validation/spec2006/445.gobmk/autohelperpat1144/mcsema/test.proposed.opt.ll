...
define %struct.Memory* @autohelperpat1144(%struct.State* noalias, i64, %struct.Memory* noalias readnone) local_unnamed_addr #1 {
entry:
  ...
  %call2_4e09ab = tail call %struct.Memory* @sub_40f780.countlib(%struct.State* %0, i64 %262, %struct.Memory* %2)
  ...
  %296 = add i64 %295, 73
  %297 = add i64 %295, 6
  %298 = load i8, i8* %33, align 1
  %299 = icmp ne i8 %298, 0
  %300 = load i8, i8* %39, align 1
  %301 = icmp ne i8 %300, 0
  %302 = xor i1 %299, %301
  %303 = select i1 %302, i64 %296, i64 %297
  store i64 %303, i64* %3, align 8
  br i1 %302, label %block_.L_4e0a05, label %block_4e09c2
...
block_4e09c2:                                     ; preds = %entry
  ...
  store i64 %309, i64* %RDI.i60, align 8
  %310 = add i64 %303, -856642
  %311 = add i64 %303, 8
  ...
  %call2_4e09c5 = tail call %struct.Memory* @sub_40f780.countlib(%struct.State* nonnull %0, i64 %310, %struct.Memory* %call2_4e09ab)
  %315 = load i64, i64* %3, align 8
  store i64 0, i64* %RDI.i60, align 8
  store i8 0, i8* %CL.i55, align 1
  %316 = load i32, i32* %EAX.i53, align 4
  %317 = add i32 %316, -4
  ...
  %347 = load i8, i8* %39, align 1
  %348 = icmp ne i8 %347, 0
  %349 = xor i1 %346, %348
  %350 = select i1 %349, i64 %343, i64 %344
  store i64 %350, i64* %3, align 8
  br i1 %349, label %block_.L_4e0a05, label %block_4e09db
...
block_4e09db:                                     ; preds = %block_4e09c2
  ...
  %call2_4e09de = tail call %struct.Memory* @sub_40f780.countlib(%struct.State* nonnull %0, i64 %357, %struct.Memory* %call2_4e09c5)
  ...
  %394 = load i8, i8* %39, align 1
  %395 = icmp ne i8 %394, 0
  %396 = xor i1 %393, %395
  %397 = select i1 %396, i64 %390, i64 %391
  store i64 %397, i64* %3, align 8
  br i1 %396, label %block_.L_4e0a05, label %block_4e09f4
...
block_4e09f4:                                     ; preds = %block_4e09db
  ...
  store i64 %403, i64* %RDI.i60, align 8
  %404 = add i64 %397, -856692
  %405 = add i64 %397, 8
  ...
  %call2_4e09f7 = tail call %struct.Memory* @sub_40f780.countlib(%struct.State* nonnull %0, i64 %404, %struct.Memory* %call2_4e09de)
  %409 = load i32, i32* %EAX.i53, align 4
  %410 = load i64, i64* %3, align 8
  %411 = add i32 %409, -3
  %412 = icmp ult i32 %409, 3
  ...
  store i8 %435, i8* %CL.i55, align 1
...
block_.L_4e0a05:                                  ; preds = %block_4e09f4, %block_4e09db, %block_4e09c2, %entry
  %440 = phi i64 [ %296, %entry ], [ %343, %block_4e09c2 ], [ %390, %block_4e09db ], [ %.pre, %block_4e09f4 ]
  %MEMORY.0 = phi %struct.Memory* [ %call2_4e09ab, %entry ], [ %call2_4e09c5, %block_4e09c2 ], [ %call2_4e09de, %block_4e09db ], [ %call2_4e09f7, %block_4e09f4 ]
  ...
  store i64 %447, i64* %RAX.i108, align 8
  %448 = load i64, i64* %6, align 8
  %449 = add i64 %448, 48
  store i64 %449, i64* %6, align 8
  %450 = icmp ugt i64 %448, -49
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_jl_.L_4e0a05(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i8* nocapture %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
