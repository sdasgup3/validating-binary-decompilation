...
define %struct.Memory* @autohelperpat1149(%struct.State* noalias, i64, %struct.Memory* noalias readnone returned) local_unnamed_addr #1 {
entry:
  ...
  %call2_4e0be7 = tail call %struct.Memory* @sub_433300.add_antisuji_move(%struct.State* %0, i64 %73, %struct.Memory* %2)
  ...
  ret %struct.Memory* %call2_4e0be7
}
