...
define %struct.Memory* @autohelperpat118(%struct.State* noalias, i64, %struct.Memory* noalias readnone returned) local_unnamed_addr #1 {
entry:
  ...
  %call2_4ca328 = tail call %struct.Memory* @sub_415900.is_ko_point(%struct.State* %0, i64 %119, %struct.Memory* %2)
  ...
  ret %struct.Memory* %call2_4ca328
}
