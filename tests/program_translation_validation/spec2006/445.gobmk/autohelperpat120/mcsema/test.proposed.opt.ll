...
define %struct.Memory* @autohelperpat120(%struct.State* noalias, i64, %struct.Memory* noalias readnone returned) local_unnamed_addr #1 {
entry:
  ...
  %call2_4ca3b9 = tail call %struct.Memory* @sub_415900.is_ko_point(%struct.State* %0, i64 %167, %struct.Memory* %2)
  ...
  %cmpBr_4ca3ca = icmp eq i8 %189, 1
  br i1 %cmpBr_4ca3ca, label %block_.L_4ca3ef, label %block_4ca3d0

block_4ca3d0:                                     ; preds = %entry
  ...
  br label %block_.L_4ca3ef

block_.L_4ca3ef:                                  ; preds = %block_4ca3d0, %entry
  %254 = phi i64 [ %.pre, %block_4ca3d0 ], [ %191, %entry ]
  ...
  ret %struct.Memory* %call2_4ca3b9
}
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_je_.L_4ca3ef(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i8* nocapture %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
