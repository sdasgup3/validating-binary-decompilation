...
define %struct.Memory* @autohelperpat153(%struct.State* noalias, i64, %struct.Memory* noalias readnone) local_unnamed_addr #1 {
entry:
  ...
  %call2_4caea9 = tail call %struct.Memory* @sub_40f780.countlib(%struct.State* %0, i64 %167, %struct.Memory* %2)
  ...
  br i1 %207, label %block_4caec0, label %block_.L_4caf28

block_4caec0:                                     ; preds = %entry
  ...
  %call2_4caec3 = tail call %struct.Memory* @sub_40f780.countlib(%struct.State* nonnull %0, i64 %215, %struct.Memory* %call2_4caea9)
  %220 = load i64, i64* %3, align 8
  store i64 0, i64* %RDI.i74, align 8
  store i8 0, i8* %CL.i68, align 1
  %221 = load i32, i32* %EAX.i66, align 4
  %222 = add i32 %221, -2
  ...
  br i1 %257, label %block_.L_4caf28, label %block_4caed9

block_4caed9:                                     ; preds = %block_4caec0
  %259 = load i32, i32* bitcast (%G_0xb54ce4_type* @G_0xb54ce4 to i32*), align 8
  ...
  %.v = select i1 %265, i64 14, i64 49
  %269 = add i64 %258, %.v
  store i64 %269, i64* %3, align 8
  br i1 %265, label %block_4caee7, label %block_.L_4caf0a

block_4caee7:                                     ; preds = %block_4caed9
  ...
  %276 = mul nsw i64 %275, 380
  store i64 %276, i64* %RCX.i96, align 8
  %277 = lshr i64 %276, 63
  %278 = add i64 %276, ptrtoint (%G__0xb0eff0_type* @G__0xb0eff0 to i64)
  store i64 %278, i64* %RAX.i98, align 8
  %279 = icmp ult i64 %278, ptrtoint (%G__0xb0eff0_type* @G__0xb0eff0 to i64)
  ...
  %289 = xor i64 %276, ptrtoint (%G__0xb0eff0_type* @G__0xb0eff0 to i64)
  %290 = xor i64 %289, %278
  %291 = lshr i64 %290, 4
  ...
  %298 = xor i64 %296, lshr (i64 ptrtoint (%G__0xb0eff0_type* @G__0xb0eff0 to i64), i64 63)
  %299 = xor i64 %296, %277
  ...
  %303 = add i64 %276, add (i64 ptrtoint (%G__0xb0eff0_type* @G__0xb0eff0 to i64), i64 100)
  %304 = add i64 %269, 27
...
block_.L_4caf0a:                                  ; preds = %block_4caed9
  ...
  store i64 %318, i64* %RDI.i74, align 8
  %319 = add i64 %269, -447434
  %320 = add i64 %269, 12
  ...
  %call2_4caf11 = tail call %struct.Memory* @sub_45db40.attack(%struct.State* nonnull %0, i64 %319, %struct.Memory* %call2_4caec3)
  %324 = load i64, i64* %RBP.i, align 8
  %325 = add i64 %324, -32
  %326 = load i32, i32* %EAX.i66, align 4
...
block_.L_4caf19:                                  ; preds = %block_.L_4caf0a, %block_4caee7
  %330 = phi i64 [ %.pre, %block_.L_4caf0a ], [ %312, %block_4caee7 ]
  %MEMORY.0 = phi %struct.Memory* [ %call2_4caf11, %block_.L_4caf0a ], [ %call2_4caec3, %block_4caee7 ]
  ...
  store i64 %336, i64* %RAX.i98, align 8
  %337 = icmp ne i32 %335, 0
  %338 = zext i1 %337 to i64
  %339 = xor i64 %338, 255
  %340 = trunc i64 %339 to i8
  store i8 %340, i8* %CL.i68, align 1
  store i8 0, i8* %14, align 1
  ...
  store i8 %340, i8* %348, align 1
  %.pre3 = load i64, i64* %3, align 8
  br label %block_.L_4caf28

block_.L_4caf28:                                  ; preds = %entry, %block_.L_4caf19, %block_4caec0
  %349 = phi i64 [ %201, %entry ], [ %248, %block_4caec0 ], [ %.pre3, %block_.L_4caf19 ]
  %MEMORY.1 = phi %struct.Memory* [ %call2_4caea9, %entry ], [ %call2_4caec3, %block_4caec0 ], [ %MEMORY.0, %block_.L_4caf19 ]
  ...
  store i64 %356, i64* %RAX.i98, align 8
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_jge_.L_4caf28(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i8* nocapture %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_jle_.L_4caf28(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i8* nocapture %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_jne_.L_4caf0a(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i8* nocapture %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 2, i32 7
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_jmpq_.L_4caf19(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
