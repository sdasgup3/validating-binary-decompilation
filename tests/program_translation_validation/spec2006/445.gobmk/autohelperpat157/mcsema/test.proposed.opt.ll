...
define %struct.Memory* @autohelperpat157(%struct.State* noalias, i64, %struct.Memory* noalias readnone returned) local_unnamed_addr #1 {
entry:
  ...
  store i64 %72, i64* %RAX.i49, align 8
  %RCX.i47 = getelementptr inbounds %union.anon, %union.anon* %58, i64 0, i32 0
  %73 = shl nsw i64 %72, 2
  %74 = add nsw i64 %73, 11900016
  %75 = add i64 %68, 11
  store i64 %75, i64* %3, align 8
  %76 = inttoptr i64 %74 to i32*
  %77 = load i32, i32* %76, align 4
  %78 = zext i32 %77 to i64
  store i64 %78, i64* %RCX.i47, align 8
  %79 = add i64 %66, -8
  %80 = add i64 %68, 14
  ...
  store i64 %84, i64* %RCX.i47, align 8
  ...
  %call2_4cb158 = tail call %struct.Memory* @sub_40f780.countlib(%struct.State* %0, i64 %120, %struct.Memory* %2)
  %125 = load i64, i64* %3, align 8
  store i64 0, i64* %RCX.i47, align 8
  %126 = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 17, i32 0
  %R8B.i33 = bitcast %union.anon* %126 to i8*
  store i8 0, i8* %R8B.i33, align 1
  ...
  br i1 %157, label %block_.L_4cb191, label %block_4cb16f

block_4cb16f:                                     ; preds = %entry
  store i64 ptrtoint (%G__0xb4bd20_type* @G__0xb4bd20 to i64), i64* %RAX.i49, align 8
  ...
  %165 = mul nsw i64 %164, 76
  store i64 %165, i64* %RCX.i47, align 8
  %166 = lshr i64 %165, 63
  %167 = add i64 %165, ptrtoint (%G__0xb4bd20_type* @G__0xb4bd20 to i64)
  store i64 %167, i64* %RAX.i49, align 8
  %168 = icmp ult i64 %167, ptrtoint (%G__0xb4bd20_type* @G__0xb4bd20 to i64)
  ...
  %178 = xor i64 %165, ptrtoint (%G__0xb4bd20_type* @G__0xb4bd20 to i64)
  %179 = xor i64 %178, %167
  %180 = lshr i64 %179, 4
  ...
  %187 = xor i64 %185, lshr (i64 ptrtoint (%G__0xb4bd20_type* @G__0xb4bd20 to i64), i64 63)
  %188 = xor i64 %185, %166
  %189 = add nuw nsw i64 %187, %188
  %190 = icmp eq i64 %189, 2
  %191 = zext i1 %190 to i8
  store i8 %191, i8* %38, align 1
  %192 = add i64 %165, add (i64 ptrtoint (%G__0xb4bd20_type* @G__0xb4bd20 to i64), i64 64)
  %193 = add i64 %158, 25
  ...
  %DL.i16 = bitcast %union.anon* %51 to i8*
  %198 = xor i8 %197, -1
  store i8 %198, i8* %DL.i16, align 1
  ...
  br label %block_.L_4cb191

block_.L_4cb191:                                  ; preds = %block_4cb16f, %entry
  %208 = phi i64 [ %.pre, %block_4cb16f ], [ %154, %entry ]
  ...
  store i64 %215, i64* %RAX.i49, align 8
  %216 = load i64, i64* %6, align 8
  %217 = add i64 %216, 32
  store i64 %217, i64* %6, align 8
  %218 = icmp ugt i64 %216, -33
  ...
  ret %struct.Memory* %call2_4cb158
}
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_jne_.L_4cb191(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i8* nocapture %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
