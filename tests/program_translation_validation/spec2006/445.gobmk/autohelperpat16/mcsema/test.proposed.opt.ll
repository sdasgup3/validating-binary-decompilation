...
define %struct.Memory* @autohelperpat16(%struct.State* noalias, i64, %struct.Memory* noalias readnone) local_unnamed_addr #1 {
entry:
  ...
  br i1 %306, label %entry.block_.L_4c6a91_crit_edge, label %block_4c6a6b

entry.block_.L_4c6a91_crit_edge:                  ; preds = %entry
...
block_4c6a6b:                                     ; preds = %entry
  ...
  br i1 %383, label %block_.L_4c6b12, label %block_.L_4c6a91

block_.L_4c6a91:                                  ; preds = %entry.block_.L_4c6a91_crit_edge, %block_4c6a6b
  %AL.i58.pre-phi = phi i8* [ %.pre7, %entry.block_.L_4c6a91_crit_edge ], [ %AL.i103, %block_4c6a6b ]
  %RDX.i84.pre-phi = phi i64* [ %.pre5, %entry.block_.L_4c6a91_crit_edge ], [ %RDX.i101, %block_4c6a6b ]
  %RSI.i86.pre-phi = phi i64* [ %.pre4, %entry.block_.L_4c6a91_crit_edge ], [ %RSI.i98, %block_4c6a6b ]
  %385 = phi i64 [ %315, %entry.block_.L_4c6a91_crit_edge ], [ %381, %block_4c6a6b ]
  ...
  %call2_4c6aba = tail call %struct.Memory* @sub_4784b0.play_attack_defend2_n(%struct.State* nonnull %0, i64 %428, %struct.Memory* %2)
...
block_4c6acf:                                     ; preds = %block_.L_4c6a91
  ...
  %call2_4c6af8 = tail call %struct.Memory* @sub_4784b0.play_attack_defend2_n(%struct.State* nonnull %0, i64 %489, %struct.Memory* %call2_4c6aba)
...
block_.L_4c6b0c:                                  ; preds = %block_4c6acf, %block_.L_4c6a91
  %509 = phi i64 [ %452, %block_.L_4c6a91 ], [ %.pre, %block_4c6acf ]
  %MEMORY.1 = phi %struct.Memory* [ %call2_4c6aba, %block_.L_4c6a91 ], [ %call2_4c6af8, %block_4c6acf ]
...
block_.L_4c6b12:                                  ; preds = %block_.L_4c6b0c, %block_4c6a6b
  %AL.i9.pre-phi = phi i8* [ %AL.i58.pre-phi, %block_.L_4c6b0c ], [ %AL.i103, %block_4c6a6b ]
  %518 = phi i64 [ %.pre3, %block_.L_4c6b0c ], [ %380, %block_4c6a6b ]
  %MEMORY.2 = phi %struct.Memory* [ %MEMORY.1, %block_.L_4c6b0c ], [ %2, %block_4c6a6b ]
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_je_.L_4c6a91(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i8* nocapture %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_jne_.L_4c6b12(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i8* nocapture %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 2, i32 7
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_je_.L_4c6b0c(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i8* nocapture %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 2, i32 7
