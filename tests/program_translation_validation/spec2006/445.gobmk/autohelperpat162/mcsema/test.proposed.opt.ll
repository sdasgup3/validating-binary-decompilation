...
define %struct.Memory* @autohelperpat162(%struct.State* noalias, i64, %struct.Memory* noalias readnone) local_unnamed_addr #1 {
entry:
  ...
  %RDI.i49 = getelementptr inbounds %union.anon, %union.anon* %40, i64 0, i32 0
  ...
  store i64 %167, i64* %RDI.i49, align 8
  ...
  store i64 %172, i64* %RSI.i46, align 8
  %173 = add i64 %163, -390822
  %174 = add i64 %163, 11
  ...
  %call2_4cb2dc = tail call %struct.Memory* @sub_46bc30.safe_move(%struct.State* %0, i64 %173, %struct.Memory* %2)
  %178 = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 17, i32 0
  %R8B.i43 = bitcast %union.anon* %178 to i8*
  %179 = load i64, i64* %3, align 8
  store i8 1, i8* %R8B.i43, align 1
  %EAX.i41 = bitcast %union.anon* %66 to i32*
  %180 = load i32, i32* %EAX.i41, align 4
  ...
  br i1 %198, label %entry.block_.L_4cb325_crit_edge, label %block_4cb2f1

entry.block_.L_4cb325_crit_edge:                  ; preds = %entry
...
block_4cb2f1:                                     ; preds = %entry
  ...
  store i64 %205, i64* %RDI.i49, align 8
  %206 = add i64 %200, -8
  %207 = add i64 %199, 16
  ...
  store i64 %210, i64* %RCX.i70, align 8
  %211 = getelementptr inbounds %union.anon, %union.anon* %178, i64 0, i32 0
  %212 = add i64 %200, -20
  %213 = add i64 %199, 20
  ...
  store i64 %225, i64* %RAX.i72, align 8
  %226 = bitcast i64* %6 to i32**
  ...
  %call2_4cb311 = tail call %struct.Memory* @sub_478110.play_attack_defend_n(%struct.State* nonnull %0, i64 %230, %struct.Memory* %call2_4cb2dc)
  %235 = load i32, i32* %EAX.i41, align 4
  %236 = load i64, i64* %3, align 8
  %237 = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 21, i32 0
  %R10B.i16 = bitcast %union.anon* %237 to i8*
  %238 = icmp ne i32 %235, 0
  %239 = zext i1 %238 to i64
  %240 = xor i64 %239, 255
  %241 = trunc i64 %240 to i8
  store i8 %241, i8* %R10B.i16, align 1
  store i8 0, i8* %14, align 1
...
block_.L_4cb325:                                  ; preds = %entry.block_.L_4cb325_crit_edge, %block_4cb2f1
  %AL.i9.pre-phi = phi i8* [ %.pre1, %entry.block_.L_4cb325_crit_edge ], [ %AL.i20, %block_4cb2f1 ]
  %251 = phi i64 [ %195, %entry.block_.L_4cb325_crit_edge ], [ %.pre, %block_4cb2f1 ]
  %MEMORY.0 = phi %struct.Memory* [ %call2_4cb2dc, %entry.block_.L_4cb325_crit_edge ], [ %call2_4cb311, %block_4cb2f1 ]
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_jne_.L_4cb325(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i8* nocapture %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
