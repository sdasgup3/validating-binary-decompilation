...
define %struct.Memory* @autohelperpat164(%struct.State* noalias, i64, %struct.Memory* noalias readnone) local_unnamed_addr #1 {
entry:
  ...
  %RAX.i83 = getelementptr inbounds %union.anon, %union.anon* %39, i64 0, i32 0
  ...
  %ECX.i74 = bitcast %union.anon* %59 to i32*
  %60 = load i64, i64* %RBP.i, align 8
  %61 = add i64 %60, -16
  %62 = load i32, i32* %ECX.i74, align 4
  ...
  store i64 %72, i64* %R8.i72, align 8
  %RCX.i68 = getelementptr inbounds %union.anon, %union.anon* %59, i64 0, i32 0
  %73 = shl nsw i64 %72, 2
  ...
  store i64 %119, i64* %R8.i72, align 8
  ...
  store i64 %166, i64* %RDI.i48, align 8
  %167 = load i64, i64* %RAX.i83, align 8
  %168 = add i64 %160, -12
  %169 = add i64 %162, 6
  ...
  store i64 %174, i64* %RAX.i83, align 8
  %175 = icmp ult i32 %170, %172
  ...
  %RDX.i42 = getelementptr inbounds %union.anon, %union.anon* %52, i64 0, i32 0
  %198 = add i64 %160, -20
  %199 = add i64 %162, 9
  ...
  store i64 %202, i64* %RDX.i42, align 8
  %EAX.i39 = bitcast %union.anon* %39 to i32*
  %RSI.i40 = getelementptr inbounds %union.anon, %union.anon* %45, i64 0, i32 0
  store i64 %174, i64* %RSI.i40, align 8
  %203 = add i64 %162, -344589
  %204 = add i64 %162, 16
  ...
  %call2_4cb388 = tail call %struct.Memory* @sub_477170.defend_against(%struct.State* %0, i64 %203, %struct.Memory* %2)
  %208 = load i64, i64* %3, align 8
  store i64 0, i64* %RCX.i68, align 8
  %209 = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 19, i32 0
  %R9B.i35 = bitcast %union.anon* %209 to i8*
  store i8 0, i8* %R9B.i35, align 1
  %210 = load i32, i32* %EAX.i39, align 4
  ...
  %.v = select i1 %226, i64 36, i64 6
  %227 = add i64 %224, %.v
  store i64 %227, i64* %3, align 8
  %cmpBr_4cb399 = icmp eq i8 %225, 1
...
block_4cb39f:                                     ; preds = %entry
  ...
  store i64 %233, i64* %RDI.i48, align 8
  %234 = add i64 %228, -12
  %235 = add i64 %227, 11
  ...
  store i64 %239, i64* %RAX.i83, align 8
  ...
  store i64 %263, i64* %RDX.i42, align 8
  store i64 %239, i64* %RSI.i40, align 8
  %264 = add i64 %227, -344623
  %265 = add i64 %227, 21
  ...
  %call2_4cb3af = tail call %struct.Memory* @sub_477170.defend_against(%struct.State* nonnull %0, i64 %264, %struct.Memory* %call2_4cb388)
  %269 = load i32, i32* %EAX.i39, align 4
  ...
  store i8 %281, i8* %CL.i34, align 1
...
block_.L_4cb3bd:                                  ; preds = %block_4cb39f, %entry
  %286 = phi i64 [ %227, %entry ], [ %.pre, %block_4cb39f ]
  %MEMORY.0 = phi %struct.Memory* [ %call2_4cb388, %entry ], [ %call2_4cb3af, %block_4cb39f ]
  ...
  store i64 %293, i64* %RAX.i83, align 8
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_je_.L_4cb3bd(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i8* nocapture %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
