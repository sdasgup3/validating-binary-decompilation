...
define %struct.Memory* @autohelperpat165(%struct.State* noalias, i64, %struct.Memory* noalias readnone) local_unnamed_addr #1 {
entry:
  ...
  store i64 3, i64* %RAX.i127, align 8
  ...
  store i64 %213, i64* %RDI.i79, align 8
  %214 = load i64, i64* %RAX.i127, align 8
  %215 = add i64 %207, -12
  %216 = add i64 %209, 6
  ...
  store i64 %221, i64* %RAX.i127, align 8
  ...
  store i64 %249, i64* %RDX.i73, align 8
  %EAX.i70 = bitcast %union.anon* %39 to i32*
  %RSI.i71 = getelementptr inbounds %union.anon, %union.anon* %45, i64 0, i32 0
  store i64 %221, i64* %RSI.i71, align 8
  %250 = add i64 %209, -344751
  %251 = add i64 %209, 16
  ...
  %call2_4cb42a = tail call %struct.Memory* @sub_477170.defend_against(%struct.State* %0, i64 %250, %struct.Memory* %2)
  %255 = load i64, i64* %3, align 8
  store i64 0, i64* %RCX.i111, align 8
  %256 = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 19, i32 0
  %R9B.i65 = bitcast %union.anon* %256 to i8*
  store i8 0, i8* %R9B.i65, align 1
  %257 = load i32, i32* %EAX.i70, align 4
  ...
  %.v = select i1 %273, i64 84, i64 6
  %274 = add i64 %271, %.v
  store i64 %274, i64* %3, align 8
  %cmpBr_4cb43b = icmp eq i8 %272, 1
  br i1 %cmpBr_4cb43b, label %block_.L_4cb48f, label %block_4cb441

block_4cb441:                                     ; preds = %entry
  %CL.i64 = bitcast %union.anon* %59 to i8*
  store i64 3, i64* %RAX.i127, align 8
  ...
  store i64 %280, i64* %RDI.i79, align 8
  %281 = add i64 %275, -12
  %282 = add i64 %274, 11
  ...
  store i64 %286, i64* %RAX.i127, align 8
  %287 = icmp ugt i32 %284, 3
  ...
  store i64 %310, i64* %RDX.i73, align 8
  store i64 %286, i64* %RSI.i71, align 8
  %311 = add i64 %274, -344785
  %312 = add i64 %274, 21
  ...
  %call2_4cb451 = tail call %struct.Memory* @sub_477170.defend_against(%struct.State* nonnull %0, i64 %311, %struct.Memory* %call2_4cb42a)
  %316 = load i64, i64* %3, align 8
  store i64 0, i64* %RDX.i73, align 8
  store i8 0, i8* %CL.i64, align 1
  %317 = load i32, i32* %EAX.i70, align 4
  store i8 0, i8* %14, align 1
  %318 = and i32 %317, 255
  ...
  %.v2 = select i1 %333, i64 47, i64 6
  %334 = add i64 %331, %.v2
  store i64 %334, i64* %3, align 8
  %cmpBr_4cb460 = icmp eq i8 %332, 1
  br i1 %cmpBr_4cb460, label %block_.L_4cb48f, label %block_4cb466

block_4cb466:                                     ; preds = %block_4cb441
  ...
  store i64 %340, i64* %RDI.i79, align 8
  %341 = add i64 %335, -8
  %342 = add i64 %334, 11
  ...
  store i64 %345, i64* %RCX.i111, align 8
  %346 = add i64 %335, -28
  %347 = add i64 %334, 15
  ...
  %call2_4cb47b = tail call %struct.Memory* @sub_478110.play_attack_defend_n(%struct.State* nonnull %0, i64 %351, %struct.Memory* %call2_4cb451)
  %356 = load i32, i32* %EAX.i70, align 4
  %357 = load i64, i64* %3, align 8
  %358 = icmp ne i32 %356, 0
  %359 = zext i1 %358 to i64
  %360 = xor i64 %359, 255
  %361 = trunc i64 %360 to i8
  store i8 %361, i8* %R9B.i65, align 1
  store i8 0, i8* %14, align 1
...
block_.L_4cb48f:                                  ; preds = %block_4cb466, %block_4cb441, %entry
  %371 = phi i64 [ %274, %entry ], [ %334, %block_4cb441 ], [ %.pre, %block_4cb466 ]
  %MEMORY.0 = phi %struct.Memory* [ %call2_4cb42a, %entry ], [ %call2_4cb451, %block_4cb441 ], [ %call2_4cb47b, %block_4cb466 ]
  ...
  store i64 %378, i64* %RAX.i127, align 8
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_je_.L_4cb48f(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i8* nocapture %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
