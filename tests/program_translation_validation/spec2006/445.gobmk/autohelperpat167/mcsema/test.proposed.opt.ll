...
define %struct.Memory* @autohelperpat167(%struct.State* noalias, i64, %struct.Memory* noalias readnone) local_unnamed_addr #1 {
entry:
  ...
  %RDX.i34 = getelementptr inbounds %union.anon, %union.anon* %51, i64 0, i32 0
  %172 = add i64 %160, -20
  %173 = add i64 %162, 9
  ...
  store i64 %176, i64* %RDX.i34, align 8
  %177 = add i64 %162, -345014
  %178 = add i64 %162, 14
  ...
  %.v = select i1 %200, i64 29, i64 6
  %201 = add i64 %198, %.v
  store i64 %201, i64* %3, align 8
  %cmpBr_4cb540 = icmp eq i8 %199, 1
...
block_4cb546:                                     ; preds = %entry
  ...
  store i64 %207, i64* %RDI.i40, align 8
  %208 = add i64 %202, -12
  %209 = add i64 %201, 6
  ...
  store i64 %217, i64* %RDX.i34, align 8
  %218 = add i64 %201, -345046
  %219 = add i64 %201, 14
  ...
  %call2_4cb54f = tail call %struct.Memory* @sub_477170.defend_against(%struct.State* nonnull %0, i64 %218, %struct.Memory* %call2_4cb52f)
  %223 = load i32, i32* %EAX.i27, align 4
  ...
  store i8 %235, i8* %CL.i29, align 1
...
block_.L_4cb55d:                                  ; preds = %block_4cb546, %entry
  %240 = phi i64 [ %201, %entry ], [ %.pre, %block_4cb546 ]
  %MEMORY.0 = phi %struct.Memory* [ %call2_4cb52f, %entry ], [ %call2_4cb54f, %block_4cb546 ]
  ...
  store i64 %247, i64* %RAX.i64, align 8
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_je_.L_4cb55d(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i8* nocapture %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
