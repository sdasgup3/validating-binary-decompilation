...
define %struct.Memory* @autohelperpat177(%struct.State* noalias, i64, %struct.Memory* noalias readnone returned) local_unnamed_addr #1 {
entry:
  ...
  %call2_4cb8a3 = tail call %struct.Memory* @sub_46bc30.safe_move(%struct.State* %0, i64 %150, %struct.Memory* %2)
  ...
  ret %struct.Memory* %call2_4cb8a3
}
