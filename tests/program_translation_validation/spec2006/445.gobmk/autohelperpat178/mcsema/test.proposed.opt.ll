...
define %struct.Memory* @autohelperpat178(%struct.State* noalias, i64, %struct.Memory* noalias readnone) local_unnamed_addr #1 {
entry:
  ...
  %ESI.i78 = bitcast %union.anon* %44 to i32*
  %45 = load i64, i64* %RBP.i, align 8
  %46 = add i64 %45, -8
  %47 = load i32, i32* %ESI.i78, align 4
  ...
  %RSI.i43 = getelementptr inbounds %union.anon, %union.anon* %44, i64 0, i32 0
  %167 = add i64 %160, -12
  %168 = add i64 %162, 6
  ...
  store i64 %171, i64* %RSI.i43, align 8
  %RDX.i40 = getelementptr inbounds %union.anon, %union.anon* %51, i64 0, i32 0
  %172 = add i64 %160, -20
  %173 = add i64 %162, 9
  ...
  store i64 %176, i64* %RDX.i40, align 8
  %177 = add i64 %162, -345974
  %178 = add i64 %162, 14
  ...
  %.v = select i1 %200, i64 45, i64 6
  %201 = add i64 %198, %.v
  store i64 %201, i64* %3, align 8
  %cmpBr_4cb900 = icmp eq i8 %199, 1
  br i1 %cmpBr_4cb900, label %entry.block_.L_4cb92d_crit_edge, label %block_4cb906

entry.block_.L_4cb92d_crit_edge:                  ; preds = %entry
  %.pre1 = bitcast %union.anon* %65 to i8*
  br label %block_.L_4cb92d

block_4cb906:                                     ; preds = %entry
  store i64 0, i64* %RSI.i43, align 8
  store i8 0, i8* %14, align 1
  ...
  store i8 0, i8* %38, align 1
  store i8 0, i8* %26, align 1
  store i64 2, i64* %RDX.i40, align 8
  ...
  store i64 %207, i64* %RDI.i46, align 8
  %208 = add i64 %202, -8
  %209 = add i64 %201, 13
  ...
  store i64 %212, i64* %RCX.i68, align 8
  ...
  %call2_4cb91d = tail call %struct.Memory* @sub_478110.play_attack_defend_n(%struct.State* nonnull %0, i64 %223, %struct.Memory* %call2_4cb8ef)
...
block_.L_4cb92d:                                  ; preds = %entry.block_.L_4cb92d_crit_edge, %block_4cb906
  %AL.i9.pre-phi = phi i8* [ %.pre1, %entry.block_.L_4cb92d_crit_edge ], [ %AL.i18, %block_4cb906 ]
  %246 = phi i64 [ %201, %entry.block_.L_4cb92d_crit_edge ], [ %.pre, %block_4cb906 ]
  %MEMORY.0 = phi %struct.Memory* [ %call2_4cb8ef, %entry.block_.L_4cb92d_crit_edge ], [ %call2_4cb91d, %block_4cb906 ]
  ...
  store i64 %253, i64* %RAX.i70, align 8
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_je_.L_4cb92d(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i8* nocapture %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
