...
define %struct.Memory* @autohelperpat197(%struct.State* noalias, i64, %struct.Memory* noalias readnone returned) local_unnamed_addr #1 {
entry:
  ...
  %call2_4cbf33 = tail call %struct.Memory* @sub_46bc30.safe_move(%struct.State* %0, i64 %151, %struct.Memory* %2)
  ...
  ret %struct.Memory* %call2_4cbf33
}
