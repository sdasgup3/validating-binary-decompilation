...
define %struct.Memory* @autohelperpat202(%struct.State* noalias, i64, %struct.Memory* noalias readnone) local_unnamed_addr #1 {
entry:
  ...
  %EDX.i79 = bitcast %union.anon* %51 to i32*
  %52 = load i64, i64* %RBP.i, align 8
  %53 = add i64 %52, -12
  %54 = load i32, i32* %EDX.i79, align 4
  ...
  store i64 %166, i64* %RDI.i50, align 8
  %167 = add i64 %162, -114470
  %168 = add i64 %162, 8
  ...
  %call2_4cbf99 = tail call %struct.Memory* @sub_4b0070.dragon_weak(%struct.State* %0, i64 %167, %struct.Memory* %2)
  %172 = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 17, i32 0
  %R8B.i47 = bitcast %union.anon* %172 to i8*
  ...
  %.v = select i1 %190, i64 74, i64 6
  %191 = add i64 %188, %.v
  store i64 %191, i64* %3, align 8
  %cmpBr_4cbfa8 = icmp eq i8 %189, 1
  br i1 %cmpBr_4cbfa8, label %block_.L_4cbff2, label %block_4cbfae

block_4cbfae:                                     ; preds = %entry
  store i64 ptrtoint (%G__0xb7df8c_type* @G__0xb7df8c to i64), i64* %RAX.i73, align 8
  store i64 ptrtoint (%G__0xb38cb4_type* @G__0xb38cb4 to i64), i64* %RCX.i71, align 8
  ...
  store i64 %198, i64* %RDX.i35, align 8
  ...
  %216 = xor i32 %214, %201
  %217 = add nuw nsw i32 %216, %201
  %218 = icmp eq i32 %217, 2
  %219 = zext i1 %218 to i8
  store i8 %219, i8* %38, align 1
  %220 = select i1 %212, i64 ptrtoint (%G__0xb38cb4_type* @G__0xb38cb4 to i64), i64 ptrtoint (%G__0xb7df8c_type* @G__0xb7df8c to i64)
  store i64 %220, i64* %RAX.i73, align 8
  ...
  store i64 %220, i64* %RDI.i50, align 8
  %226 = add i64 %191, -658398
  %227 = add i64 %191, 46
  ...
  %call2_4cbfd7 = tail call %struct.Memory* @sub_42b3d0.whose_moyo(%struct.State* nonnull %0, i64 %226, %struct.Memory* %call2_4cbf99)
  ...
  store i64 %238, i64* %RDX.i35, align 8
  %239 = load i32, i32* %EAX.i45, align 4
  %240 = icmp eq i32 %239, %237
  %241 = zext i1 %240 to i8
  %242 = xor i8 %241, -1
  store i8 %242, i8* %R8B.i47, align 1
  store i8 0, i8* %14, align 1
  ...
  br label %block_.L_4cbff2

block_.L_4cbff2:                                  ; preds = %block_4cbfae, %entry
  %251 = phi i64 [ %191, %entry ], [ %.pre, %block_4cbfae ]
  %MEMORY.0 = phi %struct.Memory* [ %call2_4cbf99, %entry ], [ %call2_4cbfd7, %block_4cbfae ]
  ...
  store i64 %258, i64* %RAX.i73, align 8
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_je_.L_4cbff2(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i8* nocapture %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
