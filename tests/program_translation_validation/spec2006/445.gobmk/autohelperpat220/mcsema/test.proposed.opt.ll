...
define %struct.Memory* @autohelperpat220(%struct.State* noalias, i64, %struct.Memory* noalias readnone returned) local_unnamed_addr #1 {
entry:
  ...
  %239 = load i32, i32* %EAX.i28, align 4
  %240 = zext i32 %239 to i64
  %241 = load i64, i64* %3, align 8
  store i64 %240, i64* %RSI.i32, align 8
  %242 = load i64, i64* %RBP.i, align 8
  %243 = add i64 %242, -36
  %244 = load i32, i32* %EDX.i81, align 4
  %245 = add i64 %241, 5
  store i64 %245, i64* %3, align 8
  %246 = inttoptr i64 %243 to i32*
  store i32 %244, i32* %246, align 4
  %247 = load i32, i32* %R8D.i89, align 4
  %248 = zext i32 %247 to i64
  %249 = load i64, i64* %3, align 8
  store i64 %248, i64* %RDX.i37, align 8
  ...
  store i64 %260, i64* %RAX.i91, align 8
  %261 = bitcast i64* %6 to i32**
  ...
  %call2_4cc20c = tail call %struct.Memory* @sub_478110.play_attack_defend_n(%struct.State* %0, i64 %265, %struct.Memory* %2)
  %270 = load i32, i32* %EAX.i28, align 4
  %271 = load i64, i64* %3, align 8
  %272 = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 21, i32 0
  %R10B.i11 = bitcast %union.anon* %272 to i8*
  %273 = icmp eq i32 %270, 0
  %274 = zext i1 %273 to i8
  store i8 %274, i8* %R10B.i11, align 1
  %275 = zext i1 %273 to i64
  store i64 %275, i64* %RAX.i91, align 8
  %276 = load i64, i64* %6, align 8
  %277 = add i64 %276, 48
  store i64 %277, i64* %6, align 8
  %278 = icmp ugt i64 %276, -49
  ...
  ret %struct.Memory* %call2_4cc20c
}
