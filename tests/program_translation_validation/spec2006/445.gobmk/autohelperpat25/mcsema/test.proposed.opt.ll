...
define %struct.Memory* @autohelperpat25(%struct.State* noalias, i64, %struct.Memory* noalias readnone returned) local_unnamed_addr #1 {
entry:
  ...
  %call2_4c6e09 = tail call %struct.Memory* @sub_40f780.countlib(%struct.State* %0, i64 %167, %struct.Memory* %2)
  ...
  br i1 %210, label %block_.L_4c6e3f, label %block_4c6e20
...
block_4c6e20:                                     ; preds = %entry
  ...
  store i64 %218, i64* %RCX.i57, align 8
  %219 = lshr i64 %218, 63
  %220 = add i64 %218, ptrtoint (%G__0xb4bd20_type* @G__0xb4bd20 to i64)
  store i64 %220, i64* %RAX.i59, align 8
  ...
  store i8 %262, i8* %DL.i14, align 1
...
block_.L_4c6e3f:                                  ; preds = %block_4c6e20, %entry
  %274 = phi i64 [ %.pre, %block_4c6e20 ], [ %201, %entry ]
  ...
  store i64 %281, i64* %RAX.i59, align 8
  %282 = load i64, i64* %6, align 8
  %283 = add i64 %282, 32
  store i64 %283, i64* %6, align 8
  %284 = icmp ugt i64 %282, -33
  ...
  ret %struct.Memory* %call2_4c6e09
}
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_jle_.L_4c6e3f(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i8* nocapture %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
