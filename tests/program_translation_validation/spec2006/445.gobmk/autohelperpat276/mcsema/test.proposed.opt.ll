...
define %struct.Memory* @autohelperpat276(%struct.State* noalias, i64, %struct.Memory* noalias readnone returned) local_unnamed_addr #1 {
entry:
  ...
  %RAX.i36 = getelementptr inbounds %union.anon, %union.anon* %40, i64 0, i32 0
  store i64 ptrtoint (%G__0xb7df8c_type* @G__0xb7df8c to i64), i64* %RAX.i36, align 8
  %R8.i34 = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 17, i32 0, i32 0
  store i64 ptrtoint (%G__0xb38cb4_type* @G__0xb38cb4 to i64), i64* %R8.i34, align 8
  %41 = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 19, i32 0
  %R9D.i32 = bitcast %union.anon* %41 to i32*
  ...
  %69 = load i32, i32* %R9D.i32, align 4
  ...
  %99 = load i64, i64* %R8.i34, align 8
  %100 = load i64, i64* %RAX.i36, align 8
  %101 = select i1 %91, i64 %99, i64 %100
  store i64 %101, i64* %RAX.i36, align 8
  ...
  %call2_4cc540 = tail call %struct.Memory* @sub_42b500.whose_area(%struct.State* %0, i64 %107, %struct.Memory* %2)
  ...
  %121 = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 21, i32 0
  %R10B.i9 = bitcast %union.anon* %121 to i8*
  store i8 %120, i8* %R10B.i9, align 1
  %122 = zext i1 %119 to i64
  store i64 %122, i64* %RAX.i36, align 8
  ...
  ret %struct.Memory* %call2_4cc540
}
