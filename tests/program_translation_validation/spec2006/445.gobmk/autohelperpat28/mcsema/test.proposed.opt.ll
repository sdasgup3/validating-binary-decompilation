...
define %struct.Memory* @autohelperpat28(%struct.State* noalias, i64, %struct.Memory* noalias readnone) local_unnamed_addr #1 {
entry:
  ...
  %call2_4c6ef9 = tail call %struct.Memory* @sub_40f780.countlib(%struct.State* %0, i64 %167, %struct.Memory* %2)
  ...
  br i1 %210, label %block_.L_4c6f21, label %block_4c6f10

block_4c6f10:                                     ; preds = %entry
  ...
  %call2_4c6f13 = tail call %struct.Memory* @sub_40f780.countlib(%struct.State* nonnull %0, i64 %218, %struct.Memory* %call2_4c6ef9)
  ...
  store i8 %238, i8* %CL.i25, align 1
  %246 = load i64, i64* %RBP.i, align 8
  %247 = add i64 %246, -25
  %248 = add i64 %224, 9
  store i64 %248, i64* %3, align 8
  %249 = inttoptr i64 %247 to i8*
  store i8 %238, i8* %249, align 1
  %.pre = load i64, i64* %3, align 8
  br label %block_.L_4c6f21

block_.L_4c6f21:                                  ; preds = %block_4c6f10, %entry
  %250 = phi i64 [ %201, %entry ], [ %.pre, %block_4c6f10 ]
  %MEMORY.0 = phi %struct.Memory* [ %call2_4c6ef9, %entry ], [ %call2_4c6f13, %block_4c6f10 ]
  ...
  store i64 %257, i64* %RAX.i54, align 8
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_jle_.L_4c6f21(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i8* nocapture %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
