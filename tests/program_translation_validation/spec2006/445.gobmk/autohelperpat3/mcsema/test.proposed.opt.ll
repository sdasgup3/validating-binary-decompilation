...
define %struct.Memory* @autohelperpat3(%struct.State* noalias, i64, %struct.Memory* noalias readnone returned) local_unnamed_addr #1 {
entry:
  ...
  %call2_4c6489 = tail call %struct.Memory* @sub_40f780.countlib(%struct.State* %0, i64 %167, %struct.Memory* %2)
  %172 = load i64, i64* %3, align 8
  store i64 0, i64* %RCX.i80, align 8
  %173 = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 17, i32 0
  %R8B.i54 = bitcast %union.anon* %173 to i8*
  ...
  br i1 %210, label %block_.L_4c64e9, label %block_4c64a0

block_4c64a0:                                     ; preds = %entry
  store i8 1, i8* %.pre3, align 1
  store i64 ptrtoint (%G__0xb4bd20_type* @G__0xb4bd20 to i64), i64* %RCX.i80, align 8
  ...
  store i64 %218, i64* %RDX.i43, align 8
  %219 = lshr i64 %218, 63
  %220 = add i64 %218, ptrtoint (%G__0xb4bd20_type* @G__0xb4bd20 to i64)
  store i64 %220, i64* %RCX.i80, align 8
  ...
  %.v = select i1 %277, i64 37, i64 6
  %278 = add i64 %275, %.v
  store i64 %278, i64* %3, align 8
  %cmpBr_4c64be = icmp eq i8 %276, 1
...
block_4c64c4:                                     ; preds = %block_4c64a0
  ...
  store i64 %285, i64* %RCX.i80, align 8
  %286 = lshr i64 %285, 63
  %287 = add i64 %285, ptrtoint (%G__0xb4bd20_type* @G__0xb4bd20 to i64)
  store i64 %287, i64* %RAX.i82, align 8
  ...
  store i8 %329, i8* %DL.i20, align 1
...
block_.L_4c64e3:                                  ; preds = %block_4c64c4, %block_4c64a0
  %341 = phi i64 [ %.pre, %block_4c64c4 ], [ %278, %block_4c64a0 ]
...
block_.L_4c64e9:                                  ; preds = %entry, %block_.L_4c64e3
  %350 = phi i64 [ %.pre2, %block_.L_4c64e3 ], [ %201, %entry ]
  ...
  %356 = and i8 %355, 1
  store i8 %356, i8* %.pre3, align 1
  %357 = zext i8 %356 to i64
  store i64 %357, i64* %RAX.i82, align 8
  %358 = load i64, i64* %6, align 8
  %359 = add i64 %358, 32
  store i64 %359, i64* %6, align 8
  %360 = icmp ugt i64 %358, -33
  ...
  ret %struct.Memory* %call2_4c6489
}
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_jle_.L_4c64e9(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i8* nocapture %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_je_.L_4c64e3(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i8* nocapture %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 2, i32 7
