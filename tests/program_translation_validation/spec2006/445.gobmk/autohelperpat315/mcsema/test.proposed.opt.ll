...
define %struct.Memory* @autohelperpat315(%struct.State* noalias, i64, %struct.Memory* noalias readnone returned) local_unnamed_addr #1 {
entry:
  ...
  %R9.i29 = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 19, i32 0, i32 0
  ...
  store i64 %72, i64* %R9.i29, align 8
  ...
  %140 = load i64, i64* %R8.i40, align 8
  %141 = load i64, i64* %RAX.i42, align 8
  %142 = select i1 %131, i64 %140, i64 %141
  store i64 %142, i64* %RAX.i42, align 8
  ...
  %call2_4cca68 = tail call %struct.Memory* @sub_42b3d0.whose_moyo(%struct.State* %0, i64 %148, %struct.Memory* %2)
  %EAX.i = bitcast %union.anon* %39 to i32*
  %153 = load i32, i32* %EAX.i, align 4
  ...
  %R10B.i9 = bitcast %union.anon* %162 to i8*
  store i8 %161, i8* %R10B.i9, align 1
  %163 = zext i1 %160 to i64
  store i64 %163, i64* %RAX.i42, align 8
  ...
  ret %struct.Memory* %call2_4cca68
}
