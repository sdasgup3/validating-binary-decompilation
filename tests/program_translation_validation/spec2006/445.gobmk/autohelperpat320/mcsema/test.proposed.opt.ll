...
define %struct.Memory* @autohelperpat320(%struct.State* noalias, i64, %struct.Memory* noalias readnone) local_unnamed_addr #1 {
entry:
  ...
  %ESI.i74 = bitcast %union.anon* %44 to i32*
  %45 = load i64, i64* %RBP.i, align 8
  %46 = add i64 %45, -8
  %47 = load i32, i32* %ESI.i74, align 4
  ...
  %call2_4ccb29 = tail call %struct.Memory* @sub_40f780.countlib(%struct.State* %0, i64 %167, %struct.Memory* %2)
  ...
  br i1 %210, label %entry.block_.L_4ccb6b_crit_edge, label %block_4ccb40

entry.block_.L_4ccb6b_crit_edge:                  ; preds = %entry
...
block_4ccb40:                                     ; preds = %entry
  ...
  store i64 %217, i64* %RDI.i42, align 8
  %218 = add i64 %212, -8
  %219 = add i64 %211, 13
  ...
  %223 = getelementptr inbounds %union.anon, %union.anon* %173, i64 0, i32 0
  %224 = add i64 %211, 17
  ...
  %call2_4ccb57 = tail call %struct.Memory* @sub_4788b0.play_connect_n(%struct.State* nonnull %0, i64 %233, %struct.Memory* %call2_4ccb29)
  %238 = load i32, i32* %EAX.i35, align 4
  %239 = load i64, i64* %3, align 8
  %240 = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 21, i32 0
  %R10B.i16 = bitcast %union.anon* %240 to i8*
  %241 = icmp ne i32 %238, 0
  %242 = zext i1 %241 to i64
  %243 = xor i64 %242, 255
  %244 = trunc i64 %243 to i8
  store i8 %244, i8* %R10B.i16, align 1
  store i8 0, i8* %14, align 1
...
block_.L_4ccb6b:                                  ; preds = %entry.block_.L_4ccb6b_crit_edge, %block_4ccb40
  %AL.i9.pre-phi = phi i8* [ %.pre1, %entry.block_.L_4ccb6b_crit_edge ], [ %AL.i20, %block_4ccb40 ]
  %254 = phi i64 [ %201, %entry.block_.L_4ccb6b_crit_edge ], [ %.pre, %block_4ccb40 ]
  %MEMORY.0 = phi %struct.Memory* [ %call2_4ccb29, %entry.block_.L_4ccb6b_crit_edge ], [ %call2_4ccb57, %block_4ccb40 ]
  ...
  %260 = and i8 %259, 1
  store i8 %260, i8* %AL.i9.pre-phi, align 1
  %261 = zext i8 %260 to i64
  store i64 %261, i64* %RAX.i66, align 8
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_jle_.L_4ccb6b(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i8* nocapture %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
