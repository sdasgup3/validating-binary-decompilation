...
define %struct.Memory* @autohelperpat353(%struct.State* noalias, i64, %struct.Memory* noalias readnone) local_unnamed_addr #1 {
entry:
  ...
  %call2_4cd32d = tail call %struct.Memory* @sub_478110.play_attack_defend_n(%struct.State* %0, i64 %179, %struct.Memory* %2)
  %184 = load i64, i64* %3, align 8
  store i64 0, i64* %RCX.i79, align 8
  %185 = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 19, i32 0
  %R9B.i40 = bitcast %union.anon* %185 to i8*
  store i8 0, i8* %R9B.i40, align 1
  %186 = load i32, i32* %EAX.i50, align 4
  ...
  %.v = select i1 %202, i64 47, i64 6
  %203 = add i64 %200, %.v
  store i64 %203, i64* %3, align 8
  %cmpBr_4cd33e = icmp eq i8 %201, 1
  br i1 %cmpBr_4cd33e, label %block_.L_4cd36d, label %block_4cd344

block_4cd344:                                     ; preds = %entry
  store i64 1, i64* %RAX.i94, align 8
  ...
  store i64 %209, i64* %RDI.i59, align 8
  %210 = add i64 %204, -8
  %211 = add i64 %203, 11
  ...
  %call2_4cd359 = tail call %struct.Memory* @sub_478110.play_attack_defend_n(%struct.State* nonnull %0, i64 %220, %struct.Memory* %call2_4cd32d)
  %225 = load i32, i32* %EAX.i50, align 4
  %226 = load i64, i64* %3, align 8
  %227 = icmp ne i32 %225, 0
  %228 = zext i1 %227 to i64
  %229 = xor i64 %228, 255
  %230 = trunc i64 %229 to i8
  store i8 %230, i8* %R9B.i40, align 1
  store i8 0, i8* %14, align 1
  ...
  br label %block_.L_4cd36d

block_.L_4cd36d:                                  ; preds = %block_4cd344, %entry
  %240 = phi i64 [ %203, %entry ], [ %.pre, %block_4cd344 ]
  %MEMORY.0 = phi %struct.Memory* [ %call2_4cd32d, %entry ], [ %call2_4cd359, %block_4cd344 ]
  ...
  store i64 %247, i64* %RAX.i94, align 8
  ...
  store i64 %274, i64* %RBP.i, align 8
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_je_.L_4cd36d(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i8* nocapture %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
