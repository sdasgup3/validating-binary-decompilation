...
define %struct.Memory* @autohelperpat359(%struct.State* noalias, i64, %struct.Memory* noalias readnone) local_unnamed_addr #1 {
entry:
  ...
  store i64 %119, i64* %RAX.i70, align 8
  ...
  store i64 %125, i64* %RCX.i68, align 8
  %126 = add i64 %113, -8
  %127 = add i64 %115, 14
  ...
  %RDI.i46 = getelementptr inbounds %union.anon, %union.anon* %39, i64 0, i32 0
  ...
  store i64 %166, i64* %RDI.i46, align 8
  %167 = add i64 %162, -778166
  %168 = add i64 %162, 8
  ...
  br i1 %204, label %entry.block_.L_4cd77d_crit_edge, label %block_4cd750

entry.block_.L_4cd77d_crit_edge:                  ; preds = %entry
...
block_4cd750:                                     ; preds = %entry
  ...
  store i64 %211, i64* %RDI.i46, align 8
  %212 = add i64 %206, -8
  %213 = add i64 %205, 11
  ...
  %call2_4cd769 = tail call %struct.Memory* @sub_4784b0.play_attack_defend2_n(%struct.State* nonnull %0, i64 %227, %struct.Memory* %call2_4cd739)
  %232 = load i32, i32* %EAX.i39, align 4
...
block_.L_4cd77d:                                  ; preds = %entry.block_.L_4cd77d_crit_edge, %block_4cd750
  %AL.i9.pre-phi = phi i8* [ %.pre1, %entry.block_.L_4cd77d_crit_edge ], [ %AL.i20, %block_4cd750 ]
  %248 = phi i64 [ %201, %entry.block_.L_4cd77d_crit_edge ], [ %.pre, %block_4cd750 ]
  %MEMORY.0 = phi %struct.Memory* [ %call2_4cd739, %entry.block_.L_4cd77d_crit_edge ], [ %call2_4cd769, %block_4cd750 ]
  ...
  store i64 %255, i64* %RAX.i70, align 8
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_jne_.L_4cd77d(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i8* nocapture %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
