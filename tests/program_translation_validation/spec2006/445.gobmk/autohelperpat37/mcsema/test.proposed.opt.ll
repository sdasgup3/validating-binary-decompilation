...
define %struct.Memory* @autohelperpat37(%struct.State* noalias, i64, %struct.Memory* noalias readnone) local_unnamed_addr #1 {
entry:
  ...
  %call2_4c763b = tail call %struct.Memory* @sub_40f780.countlib(%struct.State* %0, i64 %261, %struct.Memory* %2)
  ...
  br i1 %304, label %entry.block_.L_4c768b_crit_edge, label %block_4c7652

entry.block_.L_4c768b_crit_edge:                  ; preds = %entry
...
block_4c7652:                                     ; preds = %entry
  ...
  %call2_4c767b = tail call %struct.Memory* @sub_478110.play_attack_defend_n(%struct.State* nonnull %0, i64 %349, %struct.Memory* %call2_4c763b)
...
block_.L_4c768b:                                  ; preds = %entry.block_.L_4c768b_crit_edge, %block_4c7652
  %AL.i9.pre-phi = phi i8* [ %.pre1, %entry.block_.L_4c768b_crit_edge ], [ %AL.i18, %block_4c7652 ]
  %372 = phi i64 [ %295, %entry.block_.L_4c768b_crit_edge ], [ %.pre, %block_4c7652 ]
  %MEMORY.0 = phi %struct.Memory* [ %call2_4c763b, %entry.block_.L_4c768b_crit_edge ], [ %call2_4c767b, %block_4c7652 ]
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_jle_.L_4c768b(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i8* nocapture %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
