...
define %struct.Memory* @autohelperpat374(%struct.State* noalias, i64, %struct.Memory* noalias readnone) local_unnamed_addr #1 {
entry:
  ...
  br i1 %171, label %block_4cdab0, label %block_.L_4cdaff
...
block_4cdab0:                                     ; preds = %entry
  ...
  %call2_4cdab6 = tail call %struct.Memory* @sub_4772c0.does_attack(%struct.State* nonnull %0, i64 %186, %struct.Memory* %2)
  ...
  %cmpBr_4cdac6 = icmp eq i8 %207, 1
  br i1 %cmpBr_4cdac6, label %block_4cdab0.block_.L_4cdaef_crit_edge, label %block_4cdacc

block_4cdab0.block_.L_4cdaef_crit_edge:           ; preds = %block_4cdab0
...
block_4cdacc:                                     ; preds = %block_4cdab0
  ...
  %call2_4cdadf = tail call %struct.Memory* @sub_478110.play_attack_defend_n(%struct.State* nonnull %0, i64 %227, %struct.Memory* %call2_4cdab6)
...
block_.L_4cdaef:                                  ; preds = %block_4cdab0.block_.L_4cdaef_crit_edge, %block_4cdacc
  %AL.i19.pre-phi = phi i8* [ %.pre3, %block_4cdab0.block_.L_4cdaef_crit_edge ], [ %AL.i28, %block_4cdacc ]
  %250 = phi i64 [ %209, %block_4cdab0.block_.L_4cdaef_crit_edge ], [ %.pre, %block_4cdacc ]
  %MEMORY.0 = phi %struct.Memory* [ %call2_4cdab6, %block_4cdab0.block_.L_4cdaef_crit_edge ], [ %call2_4cdadf, %block_4cdacc ]
...
block_.L_4cdaff:                                  ; preds = %entry
  ...
  %call2_4cdb02 = tail call %struct.Memory* @sub_433300.add_antisuji_move(%struct.State* nonnull %0, i64 %274, %struct.Memory* %2)
...
block_.L_4cdb0e:                                  ; preds = %block_.L_4cdaff, %block_.L_4cdaef
  %284 = phi i64 [ %.pre2, %block_.L_4cdaff ], [ %268, %block_.L_4cdaef ]
  %MEMORY.1 = phi %struct.Memory* [ %call2_4cdb02, %block_.L_4cdaff ], [ %MEMORY.0, %block_.L_4cdaef ]
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_jne_.L_4cdaff(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i8* nocapture %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_je_.L_4cdaef(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i8* nocapture %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 2, i32 7
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_jmpq_.L_4cdb0e(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
