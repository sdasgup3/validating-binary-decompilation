...
define %struct.Memory* @autohelperpat44(%struct.State* noalias, i64, %struct.Memory* noalias readnone) local_unnamed_addr #1 {
entry:
  ...
  %EDI.i95 = bitcast %union.anon* %39 to i32*
  %40 = add i64 %7, -12
  %41 = load i32, i32* %EDI.i95, align 4
  %42 = add i64 %10, 10
  ...
  store i64 %166, i64* %RAX.i85, align 8
  ...
  store i64 %172, i64* %RCX.i83, align 8
  %173 = add i64 %160, -8
  %174 = add i64 %162, 14
  ...
  store i64 %178, i64* %RCX.i83, align 8
  ...
  store i64 %213, i64* %RDI.i49, align 8
  %214 = add i64 %209, -754327
  %215 = add i64 %209, 8
  ...
  %call2_4c7a1a = tail call %struct.Memory* @sub_40f780.countlib(%struct.State* %0, i64 %214, %struct.Memory* %2)
  %219 = load i64, i64* %3, align 8
  store i64 0, i64* %RCX.i83, align 8
  %220 = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 17, i32 0
  %R8B.i44 = bitcast %union.anon* %220 to i8*
  store i8 0, i8* %R8B.i44, align 1
  %EAX.i41 = bitcast %union.anon* %65 to i32*
  %221 = load i32, i32* %EAX.i41, align 4
  %222 = add i32 %221, -1
  ...
  br i1 %257, label %block_.L_4c7a69, label %block_4c7a31

block_4c7a31:                                     ; preds = %entry
  %CL.i43 = bitcast %union.anon* %58 to i8*
  ...
  store i64 %264, i64* %RDI.i49, align 8
  %265 = add i64 %258, -754353
  %266 = add i64 %258, 8
  ...
  %call2_4c7a34 = tail call %struct.Memory* @sub_40f780.countlib(%struct.State* nonnull %0, i64 %265, %struct.Memory* %call2_4c7a1a)
  %270 = load i64, i64* %3, align 8
  store i64 0, i64* %RDI.i49, align 8
  store i8 0, i8* %CL.i43, align 1
  %271 = load i32, i32* %EAX.i41, align 4
  %272 = add i32 %271, -1
  ...
  br i1 %307, label %block_.L_4c7a69, label %block_4c7a4a

block_4c7a4a:                                     ; preds = %block_4c7a31
  store i64 ptrtoint (%G__0xb4bd20_type* @G__0xb4bd20 to i64), i64* %RAX.i85, align 8
  ...
  %315 = mul nsw i64 %314, 76
  store i64 %315, i64* %RCX.i83, align 8
  %316 = lshr i64 %315, 63
  %317 = add i64 %315, ptrtoint (%G__0xb4bd20_type* @G__0xb4bd20 to i64)
  store i64 %317, i64* %RAX.i85, align 8
  %318 = icmp ult i64 %317, ptrtoint (%G__0xb4bd20_type* @G__0xb4bd20 to i64)
  %319 = icmp ult i64 %317, %315
  %320 = or i1 %318, %319
  ...
  %328 = xor i64 %315, ptrtoint (%G__0xb4bd20_type* @G__0xb4bd20 to i64)
  %329 = xor i64 %328, %317
  %330 = lshr i64 %329, 4
  %331 = trunc i64 %330 to i8
  %332 = and i8 %331, 1
  store i8 %332, i8* %26, align 1
  %333 = icmp eq i64 %317, 0
  %334 = zext i1 %333 to i8
  store i8 %334, i8* %29, align 1
  %335 = lshr i64 %317, 63
  %336 = trunc i64 %335 to i8
  store i8 %336, i8* %32, align 1
  %337 = xor i64 %335, lshr (i64 ptrtoint (%G__0xb4bd20_type* @G__0xb4bd20 to i64), i64 63)
  %338 = xor i64 %335, %316
  %339 = add nuw nsw i64 %337, %338
  %340 = icmp eq i64 %339, 2
  %341 = zext i1 %340 to i8
  store i8 %341, i8* %38, align 1
  %342 = add i64 %315, add (i64 ptrtoint (%G__0xb4bd20_type* @G__0xb4bd20 to i64), i64 64)
  %343 = add i64 %308, 25
  ...
  store i8 %359, i8* %DL.i14, align 1
  %367 = load i64, i64* %RBP.i, align 8
  %368 = add i64 %367, -29
  %369 = add i64 %308, 31
  store i64 %369, i64* %3, align 8
  %370 = inttoptr i64 %368 to i8*
  store i8 %359, i8* %370, align 1
  %.pre = load i64, i64* %3, align 8
  br label %block_.L_4c7a69

block_.L_4c7a69:                                  ; preds = %block_4c7a4a, %block_4c7a31, %entry
  %371 = phi i64 [ %248, %entry ], [ %298, %block_4c7a31 ], [ %.pre, %block_4c7a4a ]
  %MEMORY.0 = phi %struct.Memory* [ %call2_4c7a1a, %entry ], [ %call2_4c7a34, %block_4c7a31 ], [ %call2_4c7a34, %block_4c7a4a ]
  ...
  store i64 %378, i64* %RAX.i85, align 8
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_jle_.L_4c7a69(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i8* nocapture %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
