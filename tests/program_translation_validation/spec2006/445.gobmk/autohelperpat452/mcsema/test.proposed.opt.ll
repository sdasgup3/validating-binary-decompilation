...
define %struct.Memory* @autohelperpat452(%struct.State* noalias, i64, %struct.Memory* noalias readnone) local_unnamed_addr #1 {
entry:
  ...
  store i64 %166, i64* %R8.i84, align 8
  ...
  %214 = load i64, i64* %RAX.i95, align 8
  %215 = add i64 %207, -12
  %216 = add i64 %209, 6
  ...
  store i64 %221, i64* %RSI.i44, align 8
  %245 = add i64 %209, -358431
  %246 = add i64 %209, 13
  ...
  %call2_4cea17 = tail call %struct.Memory* @sub_4771f0.cut_possible(%struct.State* %0, i64 %245, %struct.Memory* %2)
  %250 = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 19, i32 0
  %R9B.i40 = bitcast %union.anon* %250 to i8*
  %251 = load i64, i64* %3, align 8
  store i8 1, i8* %R9B.i40, align 1
  %252 = load i32, i32* %EAX.i43, align 4
  ...
  br i1 %270, label %entry.block_.L_4cea5d_crit_edge, label %block_4cea2c

entry.block_.L_4cea5d_crit_edge:                  ; preds = %entry
...
block_4cea2c:                                     ; preds = %entry
  ...
  store i64 %278, i64* %RAX.i95, align 8
  %279 = icmp ugt i32 %276, 3
  ...
  store i64 %302, i64* %RCX.i80, align 8
  %303 = add i64 %272, -24
  %304 = add i64 %271, 25
  ...
  store i64 %307, i64* %R8.i84, align 8
  %308 = getelementptr inbounds %union.anon, %union.anon* %250, i64 0, i32 0
  %309 = add i64 %272, -28
  %310 = add i64 %271, 29
  ...
  %call2_4cea4d = tail call %struct.Memory* @sub_478110.play_attack_defend_n(%struct.State* nonnull %0, i64 %314, %struct.Memory* %call2_4cea17)
  %319 = load i32, i32* %EAX.i43, align 4
  ...
  store i8 %332, i8* %R10B.i14, align 1
...
block_.L_4cea5d:                                  ; preds = %entry.block_.L_4cea5d_crit_edge, %block_4cea2c
  %AL.i9.pre-phi = phi i8* [ %.pre1, %entry.block_.L_4cea5d_crit_edge ], [ %AL.i18, %block_4cea2c ]
  %337 = phi i64 [ %267, %entry.block_.L_4cea5d_crit_edge ], [ %.pre, %block_4cea2c ]
  %MEMORY.0 = phi %struct.Memory* [ %call2_4cea17, %entry.block_.L_4cea5d_crit_edge ], [ %call2_4cea4d, %block_4cea2c ]
  ...
  %343 = and i8 %342, 1
  store i8 %343, i8* %AL.i9.pre-phi, align 1
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_jne_.L_4cea5d(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i8* nocapture %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
