...
define %struct.Memory* @autohelperpat47(%struct.State* noalias, i64, %struct.Memory* noalias readnone returned) local_unnamed_addr #1 {
entry:
  ...
  %call2_4c7cba = tail call %struct.Memory* @sub_4784b0.play_attack_defend2_n(%struct.State* %0, i64 %216, %struct.Memory* %2)
  ...
  ret %struct.Memory* %call2_4c7cba
}
