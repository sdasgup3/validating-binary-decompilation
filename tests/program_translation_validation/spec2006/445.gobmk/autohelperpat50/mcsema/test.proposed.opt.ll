...
define %struct.Memory* @autohelperpat50(%struct.State* noalias, i64, %struct.Memory* noalias readnone returned) local_unnamed_addr #1 {
entry:
  ...
  %call2_4c805e = tail call %struct.Memory* @sub_477170.defend_against(%struct.State* %0, i64 %129, %struct.Memory* %2)
  ...
  ret %struct.Memory* %call2_4c805e
}
