...
define %struct.Memory* @autohelperpat508(%struct.State* noalias, i64, %struct.Memory* noalias readnone returned) local_unnamed_addr #1 {
entry:
  ...
  %call2_4cf73a = tail call %struct.Memory* @sub_4784b0.play_attack_defend2_n(%struct.State* %0, i64 %216, %struct.Memory* %2)
  ...
  ret %struct.Memory* %call2_4cf73a
}
