...
define %struct.Memory* @autohelperpat509(%struct.State* noalias, i64, %struct.Memory* noalias readnone) local_unnamed_addr #1 {
entry:
  ...
  %call2_4cf789 = tail call %struct.Memory* @sub_40f780.countlib(%struct.State* %0, i64 %167, %struct.Memory* %2)
  ...
  %201 = add i64 %200, 23
  %202 = add i64 %200, 6
  %203 = load i8, i8* %32, align 1
  %204 = icmp ne i8 %203, 0
  %205 = load i8, i8* %38, align 1
  %206 = icmp ne i8 %205, 0
  %207 = xor i1 %204, %206
  %208 = select i1 %207, i64 %201, i64 %202
  store i64 %208, i64* %3, align 8
  br i1 %207, label %block_.L_4cf7b1, label %block_4cf7a0

block_4cf7a0:                                     ; preds = %entry
  ...
  store i64 %214, i64* %RDI.i30, align 8
  %215 = add i64 %208, -786464
  %216 = add i64 %208, 8
  ...
  %call2_4cf7a3 = tail call %struct.Memory* @sub_40f780.countlib(%struct.State* nonnull %0, i64 %215, %struct.Memory* %call2_4cf789)
  %220 = load i32, i32* %EAX.i23, align 4
  ...
  store i8 %246, i8* %CL.i25, align 1
  ...
  br label %block_.L_4cf7b1

block_.L_4cf7b1:                                  ; preds = %block_4cf7a0, %entry
  %251 = phi i64 [ %201, %entry ], [ %.pre, %block_4cf7a0 ]
  %MEMORY.0 = phi %struct.Memory* [ %call2_4cf789, %entry ], [ %call2_4cf7a3, %block_4cf7a0 ]
  ...
  store i64 %258, i64* %RAX.i54, align 8
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_jl_.L_4cf7b1(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i8* nocapture %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
