...
define %struct.Memory* @autohelperpat519(%struct.State* noalias, i64, %struct.Memory* noalias readnone returned) local_unnamed_addr #1 {
entry:
  ...
  store i64 %128, i64* %RDX.i, align 8
  %129 = add i64 %114, -362549
  %130 = add i64 %114, 14
  ...
  %call2_4cf9ae = tail call %struct.Memory* @sub_477170.defend_against(%struct.State* %0, i64 %129, %struct.Memory* %2)
  ...
  ret %struct.Memory* %call2_4cf9ae
}
