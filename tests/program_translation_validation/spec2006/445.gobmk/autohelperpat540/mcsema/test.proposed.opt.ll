...
define %struct.Memory* @autohelperpat540(%struct.State* noalias, i64, %struct.Memory* noalias readnone) local_unnamed_addr #1 {
entry:
  ...
  %call2_4cfdc4 = tail call %struct.Memory* @sub_42b500.whose_area(%struct.State* %0, i64 %201, %struct.Memory* %2)
  %206 = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 23, i32 0
  %R11B.i49 = bitcast %union.anon* %206 to i8*
  ...
  store i64 %214, i64* %RCX.i81, align 8
  %215 = lshr i32 %213, 31
  %EAX.i42 = bitcast %union.anon* %39 to i32*
  %216 = load i32, i32* %EAX.i42, align 4
  %217 = sub i32 %216, %213
  ...
  %.v = select i1 %245, i64 70, i64 6
  %246 = add i64 %243, %.v
  store i64 %246, i64* %3, align 8
  %cmpBr_4cfdda = icmp eq i8 %244, 1
  br i1 %cmpBr_4cfdda, label %block_.L_4cfe20, label %block_4cfde0

block_4cfde0:                                     ; preds = %entry
  store i64 ptrtoint (%G__0xb7df8c_type* @G__0xb7df8c to i64), i64* %RAX.i101, align 8
  store i64 ptrtoint (%G__0xb38cb4_type* @G__0xb38cb4 to i64), i64* %RCX.i81, align 8
  %RDX.i33 = getelementptr inbounds %union.anon, %union.anon* %55, i64 0, i32 0
  ...
  store i64 %253, i64* %RDX.i33, align 8
  ...
  store i64 %275, i64* %RAX.i101, align 8
  %276 = add i64 %247, -24
  %277 = add i64 %246, 38
  ...
  store i64 %280, i64* %RSI.i55, align 8
  store i64 %275, i64* %RDI.i53, align 8
  %281 = add i64 %246, -674016
  %282 = add i64 %246, 46
  ...
  %call2_4cfe09 = tail call %struct.Memory* @sub_42b500.whose_area(%struct.State* nonnull %0, i64 %281, %struct.Memory* %call2_4cfdc4)
  ...
  store i64 %293, i64* %RDX.i33, align 8
  %294 = lshr i32 %292, 31
  %295 = load i32, i32* %EAX.i42, align 4
  %296 = sub i32 %295, %292
  ...
  store i8 %310, i8* %R8B.i14, align 1
  %319 = add i64 %287, -25
  %320 = add i64 %286, 18
  store i64 %320, i64* %3, align 8
  %321 = inttoptr i64 %319 to i8*
  store i8 %310, i8* %321, align 1
  %.pre = load i64, i64* %3, align 8
  br label %block_.L_4cfe20

block_.L_4cfe20:                                  ; preds = %block_4cfde0, %entry
  %322 = phi i64 [ %246, %entry ], [ %.pre, %block_4cfde0 ]
  %MEMORY.0 = phi %struct.Memory* [ %call2_4cfdc4, %entry ], [ %call2_4cfe09, %block_4cfde0 ]
  ...
  store i64 %329, i64* %RAX.i101, align 8
  %330 = load i64, i64* %6, align 8
  %331 = add i64 %330, 32
  store i64 %331, i64* %6, align 8
  %332 = icmp ugt i64 %330, -33
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_je_.L_4cfe20(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i8* nocapture %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
