...
define %struct.Memory* @autohelperpat554(%struct.State* noalias, i64, %struct.Memory* noalias readnone) local_unnamed_addr #1 {
entry:
  ...
  %ECX.i70 = bitcast %union.anon* %58 to i32*
  %59 = load i64, i64* %RBP.i, align 8
  %60 = add i64 %59, -16
  %61 = load i32, i32* %ECX.i70, align 4
  ...
  %RAX.i67 = getelementptr inbounds %union.anon, %union.anon* %65, i64 0, i32 0
  ...
  br i1 %95, label %block_4d0293, label %block_.L_4d02bf

block_4d0293:                                     ; preds = %entry
  %AL.i55 = bitcast %union.anon* %65 to i8*
  store i8 1, i8* %AL.i55, align 1
  store i64 ptrtoint (%G__0xb0eff0_type* @G__0xb0eff0 to i64), i64* %RCX.i65, align 8
  ...
  store i64 %106, i64* %RDX.i50, align 8
  %107 = lshr i64 %106, 63
  %108 = add i64 %106, ptrtoint (%G__0xb0eff0_type* @G__0xb0eff0 to i64)
  store i64 %108, i64* %RCX.i65, align 8
  ...
  br i1 %153, label %block_4d0293.block_.L_4d02d9_crit_edge, label %block_4d02ba

block_4d0293.block_.L_4d02d9_crit_edge:           ; preds = %block_4d0293
  ...
  %.pre5 = bitcast %union.anon* %65 to i32*
  %.pre6 = bitcast %union.anon* %58 to i8*
  br label %block_.L_4d02d9
...
block_.L_4d02bf:                                  ; preds = %entry
  ...
  store i8 0, i8* %38, align 1
  store i8 0, i8* %26, align 1
  %RSI.i35 = getelementptr inbounds %union.anon, %union.anon* %44, i64 0, i32 0
  store i64 0, i64* %RSI.i35, align 8
  ...
  store i64 %161, i64* %RDI.i31, align 8
  %162 = add i64 %99, -468863
  %163 = add i64 %99, 12
  ...
  %call2_4d02c6 = tail call %struct.Memory* @sub_45db40.attack(%struct.State* nonnull %0, i64 %162, %struct.Memory* %2)
  %CL.i28 = bitcast %union.anon* %58 to i8*
  %167 = load i64, i64* %3, align 8
  store i8 1, i8* %CL.i28, align 1
  %168 = load i32, i32* %EAX.i37, align 4
  store i8 0, i8* %14, align 1
  %169 = and i32 %168, 255
  ...
  %.v7 = select i1 %184, i64 26, i64 6
  %185 = add i64 %182, %.v7
  store i64 %185, i64* %3, align 8
  %cmpBr_4d02d3 = icmp eq i8 %183, 1
  br i1 %cmpBr_4d02d3, label %block_.L_4d02ed, label %block_.L_4d02d9

block_.L_4d02d9:                                  ; preds = %block_4d0293.block_.L_4d02d9_crit_edge, %block_.L_4d02bf
  %CL.i14.pre-phi = phi i8* [ %.pre6, %block_4d0293.block_.L_4d02d9_crit_edge ], [ %CL.i28, %block_.L_4d02bf ]
  %EAX.i.pre-phi = phi i32* [ %.pre5, %block_4d0293.block_.L_4d02d9_crit_edge ], [ %EAX.i37, %block_.L_4d02bf ]
  %RSI.i.pre-phi = phi i64* [ %.pre4, %block_4d0293.block_.L_4d02d9_crit_edge ], [ %RSI.i35, %block_.L_4d02bf ]
  %RDI.i.pre-phi = phi i64* [ %.pre3, %block_4d0293.block_.L_4d02d9_crit_edge ], [ %RDI.i31, %block_.L_4d02bf ]
  %186 = phi i64 [ %150, %block_4d0293.block_.L_4d02d9_crit_edge ], [ %185, %block_.L_4d02bf ]
  %MEMORY.0 = phi %struct.Memory* [ %2, %block_4d0293.block_.L_4d02d9_crit_edge ], [ %call2_4d02c6, %block_.L_4d02bf ]
  ...
  store i64 %197, i64* %RSI.i.pre-phi, align 8
  %198 = add i64 %186, -364569
  %199 = add i64 %186, 11
  ...
  %call2_4d02df = tail call %struct.Memory* @sub_4772c0.does_attack(%struct.State* nonnull %0, i64 %198, %struct.Memory* %MEMORY.0)
  %203 = load i32, i32* %EAX.i.pre-phi, align 4
  ...
  store i8 %215, i8* %CL.i14.pre-phi, align 1
...
block_.L_4d02ed:                                  ; preds = %block_.L_4d02d9, %block_.L_4d02bf, %block_4d02ba
  %220 = phi i64 [ %185, %block_.L_4d02bf ], [ %.pre, %block_.L_4d02d9 ], [ %155, %block_4d02ba ]
  %MEMORY.1 = phi %struct.Memory* [ %call2_4d02c6, %block_.L_4d02bf ], [ %call2_4d02df, %block_.L_4d02d9 ], [ %2, %block_4d02ba ]
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_jne_.L_4d02bf(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i8* nocapture %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_jne_.L_4d02d9(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i8* nocapture %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 2, i32 7
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_jmpq_.L_4d02ed(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_je_.L_4d02ed(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i8* nocapture %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 2, i32 7
