...
define %struct.Memory* @autohelperpat558(%struct.State* noalias, i64, %struct.Memory* noalias readnone returned) local_unnamed_addr #1 {
entry:
  ...
  %call2_4d04dc = tail call %struct.Memory* @sub_4772c0.does_attack(%struct.State* %0, i64 %172, %struct.Memory* %2)
  ...
  ret %struct.Memory* %call2_4d04dc
}
