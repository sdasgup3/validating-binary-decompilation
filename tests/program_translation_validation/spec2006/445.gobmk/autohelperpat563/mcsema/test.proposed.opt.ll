...
define %struct.Memory* @autohelperpat563(%struct.State* noalias, i64, %struct.Memory* noalias readnone returned) local_unnamed_addr #1 {
entry:
  ...
  %call2_4d0699 = tail call %struct.Memory* @sub_4788b0.play_connect_n(%struct.State* %0, i64 %128, %struct.Memory* %2)
  ...
  ret %struct.Memory* %call2_4d0699
}
