...
define %struct.Memory* @autohelperpat565(%struct.State* noalias, i64, %struct.Memory* noalias readnone returned) local_unnamed_addr #1 {
entry:
  ...
  %call2_4d06fc = tail call %struct.Memory* @sub_41fc30.is_same_dragon(%struct.State* %0, i64 %172, %struct.Memory* %2)
  ...
  ret %struct.Memory* %call2_4d06fc
}
