...
define %struct.Memory* @autohelperpat6(%struct.State* noalias, i64, %struct.Memory* noalias readnone returned) local_unnamed_addr #1 {
entry:
  ...
  %call2_4c6598 = tail call %struct.Memory* @sub_40f780.countlib(%struct.State* %0, i64 %120, %struct.Memory* %2)
  %125 = load i64, i64* %3, align 8
  store i64 0, i64* %RCX.i45, align 8
  %126 = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 17, i32 0
  %R8B.i31 = bitcast %union.anon* %126 to i8*
  ...
  %162 = xor i1 %159, %161
  %163 = or i1 %157, %162
  %164 = select i1 %163, i64 %154, i64 %155
  store i64 %164, i64* %3, align 8
  br i1 %163, label %block_.L_4c65d1, label %block_4c65af

block_4c65af:                                     ; preds = %entry
  ...
  %171 = mul nsw i64 %170, 380
  store i64 %171, i64* %RCX.i45, align 8
  %172 = lshr i64 %171, 63
  %173 = add i64 %171, ptrtoint (%G__0xb0eff0_type* @G__0xb0eff0 to i64)
  store i64 %173, i64* %RAX.i47, align 8
  %174 = icmp ult i64 %173, ptrtoint (%G__0xb0eff0_type* @G__0xb0eff0 to i64)
  ...
  %184 = xor i64 %171, ptrtoint (%G__0xb0eff0_type* @G__0xb0eff0 to i64)
  %185 = xor i64 %184, %173
  %186 = lshr i64 %185, 4
  ...
  %193 = xor i64 %191, lshr (i64 ptrtoint (%G__0xb0eff0_type* @G__0xb0eff0 to i64), i64 63)
  %194 = xor i64 %191, %172
  %195 = add nuw nsw i64 %193, %194
  %196 = icmp eq i64 %195, 2
  %197 = zext i1 %196 to i8
  store i8 %197, i8* %38, align 1
  %198 = add i64 %171, add (i64 ptrtoint (%G__0xb0eff0_type* @G__0xb0eff0 to i64), i64 20)
  %199 = add i64 %164, 28
  ...
  %224 = xor i1 %223, %221
  %.demorgan = or i1 %214, %224
  %225 = xor i1 %.demorgan, true
  %226 = zext i1 %225 to i8
  store i8 %226, i8* %DL.i14, align 1
  ...
  br label %block_.L_4c65d1

block_.L_4c65d1:                                  ; preds = %block_4c65af, %entry
  %231 = phi i64 [ %.pre, %block_4c65af ], [ %154, %entry ]
  ...
  store i64 %238, i64* %RAX.i47, align 8
  ...
  ret %struct.Memory* %call2_4c6598
}
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_jle_.L_4c65d1(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i8* nocapture %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_movb__dl__MINUS0x15__rbp_(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 7, i32 0
  %DL = bitcast %union.anon* %3 to i8*
