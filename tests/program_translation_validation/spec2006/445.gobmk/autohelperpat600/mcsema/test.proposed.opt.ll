...
define %struct.Memory* @autohelperpat600(%struct.State* noalias, i64, %struct.Memory* noalias readnone returned) local_unnamed_addr #1 {
entry:
  ...
  %call2_4d0df9 = tail call %struct.Memory* @sub_4788b0.play_connect_n(%struct.State* %0, i64 %128, %struct.Memory* %2)
  ...
  ret %struct.Memory* %call2_4d0df9
}
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_movl_0xb59d70___r9_4____ecx(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
