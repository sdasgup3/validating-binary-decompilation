...
define %struct.Memory* @autohelperpat607(%struct.State* noalias, i64, %struct.Memory* noalias readnone returned) local_unnamed_addr #1 {
entry:
  ...
  %RCX.i39 = getelementptr inbounds %union.anon, %union.anon* %61, i64 0, i32 0
  %75 = shl nsw i64 %74, 2
  ...
  store i64 %80, i64* %RCX.i39, align 8
  %81 = add i64 %68, -8
  %82 = add i64 %70, 15
  ...
  %115 = load i32, i32* %R8D.i54, align 4
  ...
  store i64 %151, i64* %RCX.i39, align 8
  ...
  %161 = load i32, i32* %EAX.i22, align 4
  %162 = zext i32 %161 to i64
  %163 = load i64, i64* %3, align 8
  store i64 %162, i64* %RDX.i26, align 8
  ...
  %call2_4d0e6b = tail call %struct.Memory* @sub_478110.play_attack_defend_n(%struct.State* %0, i64 %170, %struct.Memory* %2)
  %175 = load i32, i32* %EAX.i22, align 4
  %176 = load i64, i64* %3, align 8
  %177 = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 21, i32 0
  %R10B.i11 = bitcast %union.anon* %177 to i8*
  %178 = icmp eq i32 %175, 0
  %179 = zext i1 %178 to i8
  store i8 %179, i8* %R10B.i11, align 1
  ...
  ret %struct.Memory* %call2_4d0e6b
}
