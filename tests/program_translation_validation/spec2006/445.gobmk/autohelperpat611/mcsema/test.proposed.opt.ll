...
define %struct.Memory* @autohelperpat611(%struct.State* noalias, i64, %struct.Memory* noalias readnone) local_unnamed_addr #1 {
entry:
  ...
  store i64 %166, i64* %RAX.i77, align 8
  ...
  store i64 %172, i64* %RCX.i75, align 8
  %173 = add i64 %160, -8
  %174 = add i64 %162, 14
  ...
  store i64 %178, i64* %RCX.i75, align 8
  ...
  store i64 %213, i64* %RDI.i41, align 8
  %214 = add i64 %209, -792407
  %215 = add i64 %209, 8
  ...
  %call2_4d0eda = tail call %struct.Memory* @sub_40f780.countlib(%struct.State* %0, i64 %214, %struct.Memory* %2)
  %219 = load i64, i64* %3, align 8
  store i64 0, i64* %RCX.i75, align 8
  %220 = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 17, i32 0
  %R8B.i37 = bitcast %union.anon* %220 to i8*
  store i8 0, i8* %R8B.i37, align 1
  %EAX.i34 = bitcast %union.anon* %65 to i32*
  %221 = load i32, i32* %EAX.i34, align 4
  %222 = add i32 %221, -3
  ...
  br i1 %251, label %block_.L_4d0f12, label %block_4d0ef1

block_4d0ef1:                                     ; preds = %entry
  %CL.i36 = bitcast %union.anon* %58 to i8*
  store i64 3, i64* %RAX.i77, align 8
  ...
  store i64 %258, i64* %RDI.i41, align 8
  %259 = add i64 %253, -12
  %260 = add i64 %252, 11
  ...
  store i64 %264, i64* %RAX.i77, align 8
  %265 = icmp ugt i32 %262, 3
  ...
  %call2_4d0f01 = tail call %struct.Memory* @sub_477170.defend_against(%struct.State* nonnull %0, i64 %289, %struct.Memory* %call2_4d0eda)
  %294 = load i32, i32* %EAX.i34, align 4
  %295 = load i64, i64* %3, align 8
  %296 = icmp ne i32 %294, 0
  %297 = zext i1 %296 to i64
  %298 = xor i64 %297, 255
  %299 = trunc i64 %298 to i8
  store i8 %299, i8* %CL.i36, align 1
...
block_.L_4d0f12:                                  ; preds = %block_4d0ef1, %entry
  %309 = phi i64 [ %248, %entry ], [ %.pre, %block_4d0ef1 ]
  %MEMORY.0 = phi %struct.Memory* [ %call2_4d0eda, %entry ], [ %call2_4d0f01, %block_4d0ef1 ]
  ...
  store i64 %316, i64* %RAX.i77, align 8
  %317 = load i64, i64* %6, align 8
  %318 = add i64 %317, 32
  store i64 %318, i64* %6, align 8
  %319 = icmp ugt i64 %317, -33
  ...
  %341 = add i64 %317, 40
  %342 = inttoptr i64 %318 to i64*
  %343 = load i64, i64* %342, align 8
  store i64 %343, i64* %RBP.i, align 8
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_jne_.L_4d0f12(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i8* nocapture %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
