...
define %struct.Memory* @autohelperpat621(%struct.State* noalias, i64, %struct.Memory* noalias readnone) local_unnamed_addr #1 {
entry:
  ...
  %RCX.i75 = getelementptr inbounds %union.anon, %union.anon* %62, i64 0, i32 0
  %76 = shl nsw i64 %75, 2
  ...
  store i64 %81, i64* %RCX.i75, align 8
  %82 = add i64 %69, -8
  %83 = add i64 %71, 15
  ...
  %116 = load i32, i32* %R9D.i90, align 4
  ...
  %146 = load i64, i64* %R8.i92, align 8
  %147 = load i64, i64* %RAX.i94, align 8
  %148 = select i1 %138, i64 %146, i64 %147
  store i64 %148, i64* %RAX.i94, align 8
  ...
  store i64 %153, i64* %RSI.i60, align 8
  %RDI.i58 = getelementptr inbounds %union.anon, %union.anon* %43, i64 0, i32 0
  store i64 %148, i64* %RDI.i58, align 8
  %154 = add i64 %119, -679200
  %155 = add i64 %119, 23
  ...
  %call2_4d1102 = tail call %struct.Memory* @sub_42b3d0.whose_moyo(%struct.State* %0, i64 %154, %struct.Memory* %2)
  ...
  %R11B.i51 = bitcast %union.anon* %160 to i8*
  ...
  store i64 %167, i64* %RCX.i75, align 8
  %168 = lshr i32 %166, 31
  %EAX.i44 = bitcast %union.anon* %39 to i32*
  %169 = load i32, i32* %EAX.i44, align 4
  %170 = sub i32 %169, %166
  ...
  %.v = select i1 %198, i64 74, i64 6
  %199 = add i64 %196, %.v
  store i64 %199, i64* %3, align 8
  %cmpBr_4d111a = icmp eq i8 %197, 1
  br i1 %cmpBr_4d111a, label %block_.L_4d1164, label %block_4d1120

block_4d1120:                                     ; preds = %entry
  store i64 ptrtoint (%G__0xb7df8c_type* @G__0xb7df8c to i64), i64* %RAX.i94, align 8
  store i64 ptrtoint (%G__0xb38cb4_type* @G__0xb38cb4 to i64), i64* %RCX.i75, align 8
  ...
  store i64 %206, i64* %RDX.i35, align 8
  ...
  store i64 %228, i64* %RAX.i94, align 8
  %229 = add i64 %200, -20
  %230 = add i64 %199, 38
  ...
  store i64 %233, i64* %RSI.i60, align 8
  store i64 %228, i64* %RDI.i58, align 8
  %234 = add i64 %199, -678944
  %235 = add i64 %199, 46
  ...
  %call2_4d1149 = tail call %struct.Memory* @sub_42b500.whose_area(%struct.State* nonnull %0, i64 %234, %struct.Memory* %call2_4d1102)
  ...
  store i64 %246, i64* %RDX.i35, align 8
  %247 = load i32, i32* %EAX.i44, align 4
  %248 = icmp eq i32 %247, %245
  %249 = zext i1 %248 to i8
  %R8B.i16 = bitcast %union.anon* %40 to i8*
  %250 = xor i8 %249, -1
  store i8 %250, i8* %R8B.i16, align 1
  store i8 0, i8* %14, align 1
...
block_.L_4d1164:                                  ; preds = %block_4d1120, %entry
  %259 = phi i64 [ %199, %entry ], [ %.pre, %block_4d1120 ]
  %MEMORY.0 = phi %struct.Memory* [ %call2_4d1102, %entry ], [ %call2_4d1149, %block_4d1120 ]
  ...
  store i64 %266, i64* %RAX.i94, align 8
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_je_.L_4d1164(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i8* nocapture %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
