...
define %struct.Memory* @autohelperpat622(%struct.State* noalias, i64, %struct.Memory* noalias readnone) local_unnamed_addr #1 {
entry:
  ...
  %R9D.i67 = bitcast %union.anon* %40 to i32*
  ...
  store i64 %74, i64* %R10.i56, align 8
  %RCX.i53 = getelementptr inbounds %union.anon, %union.anon* %61, i64 0, i32 0
  %75 = shl nsw i64 %74, 2
  ...
  store i64 %80, i64* %RCX.i53, align 8
  %81 = add i64 %68, -8
  %82 = add i64 %70, 15
  ...
  store i64 %86, i64* %RCX.i53, align 8
  ...
  %115 = load i32, i32* %R9D.i67, align 4
  ...
  %145 = load i64, i64* %R8.i69, align 8
  %146 = load i64, i64* %RAX.i71, align 8
  ...
  %RDI.i37 = getelementptr inbounds %union.anon, %union.anon* %42, i64 0, i32 0
  store i64 %147, i64* %RDI.i37, align 8
  %153 = add i64 %118, -679792
  %154 = add i64 %118, 23
  ...
  %call2_4d11d2 = tail call %struct.Memory* @sub_42b250.whose_territory(%struct.State* %0, i64 %153, %struct.Memory* %2)
  ...
  %R11B.i30 = bitcast %union.anon* %159 to i8*
  store i8 0, i8* %R11B.i30, align 1
  store i64 3, i64* %RCX.i53, align 8
  ...
  store i64 %166, i64* %RCX.i53, align 8
  %167 = lshr i32 %165, 31
  ...
  %.v = select i1 %197, i64 23, i64 6
  %198 = add i64 %195, %.v
  store i64 %198, i64* %3, align 8
  %cmpBr_4d11ea = icmp eq i8 %196, 1
...
block_4d11f0:                                     ; preds = %entry
  ...
  store i64 %204, i64* %RDI.i37, align 8
  %205 = add i64 %198, -135552
  %206 = add i64 %198, 8
  ...
  %call2_4d11f3 = tail call %struct.Memory* @sub_4b0070.dragon_weak(%struct.State* nonnull %0, i64 %205, %struct.Memory* %call2_4d11d2)
  ...
  store i8 %222, i8* %CL.i29, align 1
...
block_.L_4d1201:                                  ; preds = %block_4d11f0, %entry
  %227 = phi i64 [ %198, %entry ], [ %.pre, %block_4d11f0 ]
  %MEMORY.0 = phi %struct.Memory* [ %call2_4d11d2, %entry ], [ %call2_4d11f3, %block_4d11f0 ]
  ...
  store i64 %234, i64* %RAX.i71, align 8
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_je_.L_4d1201(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i8* nocapture %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
