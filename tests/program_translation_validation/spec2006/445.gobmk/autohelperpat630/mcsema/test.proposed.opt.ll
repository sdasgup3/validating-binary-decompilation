...
define %struct.Memory* @autohelperpat630(%struct.State* noalias, i64, %struct.Memory* noalias readnone) local_unnamed_addr #1 {
entry:
  ...
  store i64 %213, i64* %RDI.i46, align 8
  ...
  %call2_4d151d = tail call %struct.Memory* @sub_46bc30.safe_move(%struct.State* %0, i64 %219, %struct.Memory* %2)
  ...
  %R8B.i40 = bitcast %union.anon* %225 to i8*
  store i8 0, i8* %R8B.i40, align 1
  %EAX.i37 = bitcast %union.anon* %65 to i32*
  %226 = load i32, i32* %EAX.i37, align 4
  ...
  br i1 %244, label %block_.L_4d155e, label %block_4d1534
...
block_4d1534:                                     ; preds = %entry
  ...
  store i64 %251, i64* %RDI.i46, align 8
  %252 = add i64 %245, -794036
  %253 = add i64 %245, 8
  ...
  %call2_4d1537 = tail call %struct.Memory* @sub_40f780.countlib(%struct.State* nonnull %0, i64 %252, %struct.Memory* %call2_4d151d)
  %257 = load i64, i64* %3, align 8
  store i64 0, i64* %RDI.i46, align 8
  store i8 0, i8* %CL.i39, align 1
  %258 = load i32, i32* %EAX.i37, align 4
  %259 = add i32 %258, -1
  ...
  br i1 %294, label %block_.L_4d155e, label %block_4d154d
...
block_4d154d:                                     ; preds = %block_4d1534
  ...
  store i64 %301, i64* %RDI.i46, align 8
  %302 = add i64 %295, -794061
  %303 = add i64 %295, 8
  ...
  %call2_4d1550 = tail call %struct.Memory* @sub_40f780.countlib(%struct.State* nonnull %0, i64 %302, %struct.Memory* %call2_4d1537)
  %307 = load i32, i32* %EAX.i37, align 4
  ...
  %330 = icmp ne i8 %324, 0
  %331 = xor i1 %330, %328
  %.demorgan = or i1 %321, %331
  %332 = xor i1 %.demorgan, true
  %333 = zext i1 %332 to i8
  store i8 %333, i8* %CL.i39, align 1
...
block_.L_4d155e:                                  ; preds = %block_4d154d, %block_4d1534, %entry
  %338 = phi i64 [ %241, %entry ], [ %285, %block_4d1534 ], [ %.pre, %block_4d154d ]
  %MEMORY.0 = phi %struct.Memory* [ %call2_4d151d, %entry ], [ %call2_4d1537, %block_4d1534 ], [ %call2_4d1550, %block_4d154d ]
  ...
  store i64 %345, i64* %RAX.i82, align 8
  %346 = load i64, i64* %6, align 8
  %347 = add i64 %346, 32
  store i64 %347, i64* %6, align 8
  %348 = icmp ugt i64 %346, -33
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_jne_.L_4d155e(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i8* nocapture %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_jle_.L_4d155e(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i8* nocapture %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 2, i32 7
