...
define %struct.Memory* @autohelperpat643(%struct.State* noalias, i64, %struct.Memory* noalias readnone returned) local_unnamed_addr #1 {
entry:
  ...
  %RAX.i45 = getelementptr inbounds %union.anon, %union.anon* %39, i64 0, i32 0
  ...
  %ECX.i36 = bitcast %union.anon* %59 to i32*
  %60 = load i64, i64* %RBP.i, align 8
  %61 = add i64 %60, -16
  %62 = load i32, i32* %ECX.i36, align 4
  ...
  store i64 %72, i64* %R8.i34, align 8
  %RCX.i31 = getelementptr inbounds %union.anon, %union.anon* %59, i64 0, i32 0
  %73 = shl nsw i64 %72, 2
  ...
  store i64 %78, i64* %RCX.i31, align 8
  %79 = add i64 %66, -8
  %80 = add i64 %68, 15
  ...
  store i64 %84, i64* %RCX.i31, align 8
  ...
  store i64 %124, i64* %RCX.i31, align 8
  %125 = add i64 %113, -20
  %126 = add i64 %115, 10
  ...
  %call2_4d193b = tail call %struct.Memory* @sub_478110.play_attack_defend_n(%struct.State* %0, i64 %132, %struct.Memory* %2)
  %137 = load i32, i32* %EAX.i18, align 4
  %138 = load i64, i64* %3, align 8
  %139 = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 19, i32 0
  %R9B.i11 = bitcast %union.anon* %139 to i8*
  %140 = icmp eq i32 %137, 0
  %141 = zext i1 %140 to i8
  store i8 %141, i8* %R9B.i11, align 1
  %142 = zext i1 %140 to i64
  store i64 %142, i64* %RAX.i45, align 8
  ...
  ret %struct.Memory* %call2_4d193b
}
