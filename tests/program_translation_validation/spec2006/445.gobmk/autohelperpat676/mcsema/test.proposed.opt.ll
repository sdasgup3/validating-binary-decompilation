...
define %struct.Memory* @autohelperpat676(%struct.State* noalias, i64, %struct.Memory* noalias readnone) local_unnamed_addr #1 {
entry:
  ...
  %.v = select i1 %266, i64 10, i64 117
  %270 = add i64 %257, %.v
  store i64 %270, i64* %3, align 8
  br i1 %266, label %block_4d2142, label %block_.L_4d21ad

block_4d2142:                                     ; preds = %entry
  ...
  %AL.i63 = bitcast %union.anon* %66 to i8*
  store i8 0, i8* %AL.i63, align 1
  %293 = add i64 %270, -368690
  %294 = add i64 %270, 31
  ...
  %call2_4d215c = tail call %struct.Memory* @sub_478110.play_attack_defend_n(%struct.State* nonnull %0, i64 %293, %struct.Memory* %2)
  %298 = load i64, i64* %3, align 8
  store i64 0, i64* %RCX.i127, align 8
  %299 = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 21, i32 0
  %R10B.i57 = bitcast %union.anon* %299 to i8*
  store i8 0, i8* %R10B.i57, align 1
  %EAX.i55 = bitcast %union.anon* %66 to i32*
  %300 = load i32, i32* %EAX.i55, align 4
  store i8 0, i8* %14, align 1
  %301 = and i32 %300, 255
  ...
  %.v3 = select i1 %316, i64 48, i64 6
  %317 = add i64 %314, %.v3
  store i64 %317, i64* %3, align 8
  %cmpBr_4d216d = icmp eq i8 %315, 1
  br i1 %cmpBr_4d216d, label %block_.L_4d219d, label %block_4d2173

block_4d2173:                                     ; preds = %block_4d2142
  store i64 1, i64* %RSI.i79, align 8
  store i64 2, i64* %RDX.i77, align 8
  ...
  store i64 %323, i64* %RDI.i74, align 8
  %324 = add i64 %318, -24
  %325 = add i64 %317, 16
  ...
  store i64 %328, i64* %RCX.i127, align 8
  %329 = add i64 %318, -28
  %330 = add i64 %317, 20
  ...
  %call2_4d218d = tail call %struct.Memory* @sub_478110.play_attack_defend_n(%struct.State* nonnull %0, i64 %339, %struct.Memory* %call2_4d215c)
  %344 = load i32, i32* %EAX.i55, align 4
  ...
  store i8 %356, i8* %R10B.i57, align 1
...
block_.L_4d219d:                                  ; preds = %block_4d2173, %block_4d2142
  %361 = phi i64 [ %317, %block_4d2142 ], [ %.pre, %block_4d2173 ]
  %MEMORY.0 = phi %struct.Memory* [ %call2_4d215c, %block_4d2142 ], [ %call2_4d218d, %block_4d2173 ]
  ...
  %367 = and i8 %366, 1
  store i8 %367, i8* %AL.i63, align 1
  store i8 0, i8* %14, align 1
  ...
  store i64 %373, i64* %RCX.i127, align 8
  %374 = add i64 %362, -4
...
block_.L_4d21ad:                                  ; preds = %entry
  ...
  store i64 %389, i64* %RSI.i, align 8
  ...
  store i64 %394, i64* %RDX.i, align 8
  %395 = add i64 %255, -36
  %396 = add i64 %270, 12
  ...
  store i64 %399, i64* %RCX.i127, align 8
  %400 = add i64 %270, -139277
  %401 = add i64 %270, 17
  ...
  %call2_4d21b9 = tail call %struct.Memory* @sub_4b01a0.test_attack_either_move(%struct.State* nonnull %0, i64 %400, %struct.Memory* %2)
...
block_.L_4d21c5:                                  ; preds = %block_.L_4d21ad, %block_.L_4d219d
  %410 = phi i64 [ %.pre2, %block_.L_4d21ad ], [ %379, %block_.L_4d219d ]
  %MEMORY.1 = phi %struct.Memory* [ %call2_4d21b9, %block_.L_4d21ad ], [ %MEMORY.0, %block_.L_4d219d ]
  ...
  store i64 %416, i64* %RAX.i129, align 8
  %417 = load i64, i64* %6, align 8
  %418 = add i64 %417, 48
  store i64 %418, i64* %6, align 8
  %419 = icmp ugt i64 %417, -49
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_jne_.L_4d21ad(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i8* nocapture %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_je_.L_4d219d(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i8* nocapture %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 2, i32 7
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_jmpq_.L_4d21c5(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
