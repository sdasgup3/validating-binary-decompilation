...
define %struct.Memory* @autohelperpat677(%struct.State* noalias, i64, %struct.Memory* noalias readnone) local_unnamed_addr #1 {
entry:
  ...
  %EDI.i122 = bitcast %union.anon* %40 to i32*
  %41 = add i64 %7, -12
  %42 = load i32, i32* %EDI.i122, align 4
  %43 = add i64 %10, 10
  ...
  store i64 %214, i64* %RAX.i112, align 8
  ...
  store i64 %220, i64* %RCX.i110, align 8
  %221 = add i64 %208, -8
  %222 = add i64 %210, 14
  ...
  store i64 %226, i64* %RCX.i110, align 8
  ...
  store i64 %261, i64* %RDI.i64, align 8
  %262 = add i64 %257, -797352
  %263 = add i64 %257, 8
  ...
  %call2_4d222b = tail call %struct.Memory* @sub_40f780.countlib(%struct.State* %0, i64 %262, %struct.Memory* %2)
  %267 = load i64, i64* %3, align 8
  store i64 0, i64* %RCX.i110, align 8
  %CL.i59 = bitcast %union.anon* %59 to i8*
  %268 = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 17, i32 0
  %R8B.i60 = bitcast %union.anon* %268 to i8*
  store i8 0, i8* %R8B.i60, align 1
  %EAX.i57 = bitcast %union.anon* %66 to i32*
  ...
  br i1 %299, label %block_.L_4d2292, label %block_4d2242

block_4d2242:                                     ; preds = %entry
  ...
  store i64 %306, i64* %RDI.i64, align 8
  %307 = add i64 %300, -797378
  %308 = add i64 %300, 8
  ...
  %call2_4d2245 = tail call %struct.Memory* @sub_40f780.countlib(%struct.State* nonnull %0, i64 %307, %struct.Memory* %call2_4d222b)
  %312 = load i64, i64* %3, align 8
  store i64 0, i64* %RDI.i64, align 8
  store i8 0, i8* %CL.i59, align 1
  %313 = load i32, i32* %EAX.i57, align 4
  %314 = add i32 %313, -1
  ...
  br i1 %349, label %block_.L_4d2292, label %block_4d225b

block_4d225b:                                     ; preds = %block_4d2242
  ...
  store i8 0, i8* %CL.i59, align 1
  %RDX.i32 = getelementptr inbounds %union.anon, %union.anon* %52, i64 0, i32 0
  store i64 ptrtoint (%G__0xb4bd20_type* @G__0xb4bd20 to i64), i64* %RDX.i32, align 8
  %RSI.i29 = getelementptr inbounds %union.anon, %union.anon* %45, i64 0, i32 0
  ...
  %357 = mul nsw i64 %356, 76
  store i64 %357, i64* %RSI.i29, align 8
  %358 = lshr i64 %357, 63
  %359 = add i64 %357, ptrtoint (%G__0xb4bd20_type* @G__0xb4bd20 to i64)
  store i64 %359, i64* %RDX.i32, align 8
  %360 = icmp ult i64 %359, ptrtoint (%G__0xb4bd20_type* @G__0xb4bd20 to i64)
  ...
  %370 = xor i64 %357, ptrtoint (%G__0xb4bd20_type* @G__0xb4bd20 to i64)
  %371 = xor i64 %370, %359
  %372 = lshr i64 %371, 4
  ...
  %379 = xor i64 %377, lshr (i64 ptrtoint (%G__0xb4bd20_type* @G__0xb4bd20 to i64), i64 63)
  %380 = xor i64 %377, %358
  %381 = add nuw nsw i64 %379, %380
  %382 = icmp eq i64 %381, 2
  %383 = zext i1 %382 to i8
  store i8 %383, i8* %39, align 1
  %384 = add i64 %357, add (i64 ptrtoint (%G__0xb4bd20_type* @G__0xb4bd20 to i64), i64 64)
  %385 = add i64 %350, 29
  ...
  %.v = select i1 %416, i64 23, i64 6
  %417 = add i64 %414, %.v
  store i64 %417, i64* %3, align 8
  %cmpBr_4d227b = icmp eq i8 %415, 1
  br i1 %cmpBr_4d227b, label %block_.L_4d2292, label %block_4d2281

block_4d2281:                                     ; preds = %block_4d225b
  ...
  store i64 %423, i64* %RDI.i64, align 8
  %424 = add i64 %417, -615057
  %425 = add i64 %417, 8
  ...
  %call2_4d2284 = tail call %struct.Memory* @sub_43bff0.is_proper_eye_space(%struct.State* nonnull %0, i64 %424, %struct.Memory* %call2_4d2245)
  %429 = load i32, i32* %EAX.i57, align 4
  ...
  store i8 %441, i8* %CL.i59, align 1
...
block_.L_4d2292:                                  ; preds = %block_4d2281, %block_4d225b, %block_4d2242, %entry
  %446 = phi i64 [ %296, %entry ], [ %340, %block_4d2242 ], [ %417, %block_4d225b ], [ %.pre, %block_4d2281 ]
  %MEMORY.0 = phi %struct.Memory* [ %call2_4d222b, %entry ], [ %call2_4d2245, %block_4d2242 ], [ %call2_4d2245, %block_4d225b ], [ %call2_4d2284, %block_4d2281 ]
  ...
  store i64 %453, i64* %RAX.i112, align 8
  %454 = load i64, i64* %6, align 8
  %455 = add i64 %454, 48
  store i64 %455, i64* %6, align 8
  %456 = icmp ugt i64 %454, -49
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_jne_.L_4d2292(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i8* nocapture %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_jle_.L_4d2292(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i8* nocapture %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 2, i32 7
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_je_.L_4d2292(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i8* nocapture %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 2, i32 7
