...
define %struct.Memory* @autohelperpat678(%struct.State* noalias, i64, %struct.Memory* noalias readnone) local_unnamed_addr #1 {
entry:
  ...
  %call2_4d22ea = tail call %struct.Memory* @sub_40f780.countlib(%struct.State* %0, i64 %214, %struct.Memory* %2)
  ...
  br i1 %251, label %block_.L_4d232b, label %block_4d2301
...
block_4d2301:                                     ; preds = %entry
  ...
  store i64 %258, i64* %RDI.i44, align 8
  %259 = add i64 %252, -797569
  %260 = add i64 %252, 8
  ...
  %call2_4d2304 = tail call %struct.Memory* @sub_40f780.countlib(%struct.State* nonnull %0, i64 %259, %struct.Memory* %call2_4d22ea)
  %264 = load i64, i64* %3, align 8
  store i64 0, i64* %RDI.i44, align 8
  store i8 0, i8* %CL.i39, align 1
  %265 = load i32, i32* %EAX.i37, align 4
  %266 = add i32 %265, -1
  ...
  br i1 %301, label %block_.L_4d232b, label %block_4d231a
...
block_4d231a:                                     ; preds = %block_4d2301
  ...
  store i64 %308, i64* %RDI.i44, align 8
  %309 = add i64 %302, -797594
  %310 = add i64 %302, 8
  ...
  %call2_4d231d = tail call %struct.Memory* @sub_40f780.countlib(%struct.State* nonnull %0, i64 %309, %struct.Memory* %call2_4d2304)
  %314 = load i32, i32* %EAX.i37, align 4
  ...
  %338 = xor i1 %337, %335
  %.demorgan = or i1 %328, %338
  %339 = xor i1 %.demorgan, true
  %340 = zext i1 %339 to i8
  store i8 %340, i8* %CL.i39, align 1
...
block_.L_4d232b:                                  ; preds = %block_4d231a, %block_4d2301, %entry
  %345 = phi i64 [ %248, %entry ], [ %292, %block_4d2301 ], [ %.pre, %block_4d231a ]
  %MEMORY.0 = phi %struct.Memory* [ %call2_4d22ea, %entry ], [ %call2_4d2304, %block_4d2301 ], [ %call2_4d231d, %block_4d231a ]
  ...
  store i64 %352, i64* %RAX.i80, align 8
  %353 = load i64, i64* %6, align 8
  %354 = add i64 %353, 32
  store i64 %354, i64* %6, align 8
  %355 = icmp ugt i64 %353, -33
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_jne_.L_4d232b(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i8* nocapture %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_jle_.L_4d232b(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i8* nocapture %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 2, i32 7
