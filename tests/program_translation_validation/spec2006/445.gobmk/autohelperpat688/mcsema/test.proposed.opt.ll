...
define %struct.Memory* @autohelperpat688(%struct.State* noalias, i64, %struct.Memory* noalias readnone) local_unnamed_addr #1 {
entry:
  ...
  store i64 %261, i64* %RAX.i106, align 8
  %262 = shl nsw i64 %261, 2
  %263 = add nsw i64 %262, 11900048
  %264 = add i64 %257, 11
  store i64 %264, i64* %3, align 8
  %265 = inttoptr i64 %263 to i32*
  %266 = load i32, i32* %265, align 4
  %267 = zext i32 %266 to i64
  store i64 %267, i64* %RCX.i104, align 8
  %268 = add i64 %255, -8
  %269 = add i64 %257, 14
  ...
  store i64 %273, i64* %RCX.i104, align 8
  ...
  store i64 %308, i64* %RDI.i46, align 8
  %309 = add i64 %304, -141129
  %310 = add i64 %304, 8
  ...
  %call2_4d27bc = tail call %struct.Memory* @sub_4b0070.dragon_weak(%struct.State* %0, i64 %309, %struct.Memory* %2)
  %314 = load i64, i64* %3, align 8
  store i64 0, i64* %RCX.i104, align 8
  %315 = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 17, i32 0
  %R8B.i41 = bitcast %union.anon* %315 to i8*
  store i8 0, i8* %R8B.i41, align 1
  %EAX.i39 = bitcast %union.anon* %66 to i32*
  %316 = load i32, i32* %EAX.i39, align 4
  ...
  %.v = select i1 %332, i64 54, i64 6
  %333 = add i64 %330, %.v
  store i64 %333, i64* %3, align 8
  %cmpBr_4d27cd = icmp eq i8 %331, 1
  br i1 %cmpBr_4d27cd, label %entry.block_.L_4d2803_crit_edge, label %block_4d27d3

entry.block_.L_4d2803_crit_edge:                  ; preds = %entry
...
block_4d27d3:                                     ; preds = %entry
  ...
  store i64 %339, i64* %RDI.i46, align 8
  %340 = add i64 %334, -24
  %341 = add i64 %333, 16
  ...
  store i64 %344, i64* %RCX.i104, align 8
  %345 = getelementptr inbounds %union.anon, %union.anon* %315, i64 0, i32 0
  %346 = add i64 %334, -28
  %347 = add i64 %333, 20
  ...
  store i64 %361, i64* %RAX.i106, align 8
  ...
  %call2_4d27f3 = tail call %struct.Memory* @sub_477710.somewhere(%struct.State* nonnull %0, i64 %366, %struct.Memory* %call2_4d27bc)
  %371 = load i32, i32* %EAX.i39, align 4
  ...
  %R10B.i14 = bitcast %union.anon* %382 to i8*
  %383 = xor i1 %378, true
  %384 = zext i1 %383 to i8
  store i8 %384, i8* %R10B.i14, align 1
...
block_.L_4d2803:                                  ; preds = %entry.block_.L_4d2803_crit_edge, %block_4d27d3
  %AL.i9.pre-phi = phi i8* [ %.pre1, %entry.block_.L_4d2803_crit_edge ], [ %AL.i18, %block_4d27d3 ]
  %389 = phi i64 [ %333, %entry.block_.L_4d2803_crit_edge ], [ %.pre, %block_4d27d3 ]
  %MEMORY.0 = phi %struct.Memory* [ %call2_4d27bc, %entry.block_.L_4d2803_crit_edge ], [ %call2_4d27f3, %block_4d27d3 ]
  ...
  %395 = and i8 %394, 1
  store i8 %395, i8* %AL.i9.pre-phi, align 1
  %396 = zext i8 %395 to i64
  store i64 %396, i64* %RAX.i106, align 8
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_je_.L_4d2803(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i8* nocapture %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
