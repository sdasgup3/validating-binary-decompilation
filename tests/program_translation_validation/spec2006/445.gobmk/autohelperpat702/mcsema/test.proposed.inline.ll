...
define %struct.Memory* @autohelperpat702(%struct.State* noalias, i64, %struct.Memory* noalias) #2 {
entry:
  ...
  store %struct.Memory* %loadMem_4d2de0, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_4d2de1, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_4d2de4, %struct.Memory** %MEMORY
  ...
  store i32 %78, i32* %82
  store %struct.Memory* %loadMem_4d2de8, %struct.Memory** %MEMORY
  ...
  store i32 %94, i32* %98
  store %struct.Memory* %loadMem_4d2deb, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_4d2dee, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_4d2df1, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_4d2df4, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_4d2df8, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_4d2dff, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_4d2e02, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_4d2e05, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem1_4d2e08, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_4d2e0d, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_4d2e0f, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_4d2e13, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_4d2e14, %struct.Memory** %MEMORY
  ret %struct.Memory* %loadMem_4d2e14
}
