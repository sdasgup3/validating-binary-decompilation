...
define %struct.Memory* @autohelperpat703(%struct.State* noalias, i64, %struct.Memory* noalias) #2 {
entry:
  ...
  store %struct.Memory* %loadMem_4d2e20, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_4d2e21, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_4d2e24, %struct.Memory** %MEMORY
  ...
  store i32 %78, i32* %82
  store %struct.Memory* %loadMem_4d2e28, %struct.Memory** %MEMORY
  ...
  store i32 %94, i32* %98
  store %struct.Memory* %loadMem_4d2e2b, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_4d2e2e, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_4d2e31, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_4d2e34, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_4d2e38, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_4d2e3f, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_4d2e42, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_4d2e45, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem1_4d2e48, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_4d2e4d, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_4d2e4f, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_4d2e53, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_4d2e54, %struct.Memory** %MEMORY
  ret %struct.Memory* %loadMem_4d2e54
}
