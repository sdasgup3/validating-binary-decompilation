...
define %struct.Memory* @autohelperpat705(%struct.State* noalias, i64, %struct.Memory* noalias readnone) local_unnamed_addr #1 {
entry:
  ...
  %call2_4d2ecb = tail call %struct.Memory* @sub_478110.play_attack_defend_n(%struct.State* %0, i64 %213, %struct.Memory* %2)
...
block_4d2ee2:                                     ; preds = %entry
  ...
  %call2_4d2f03 = tail call %struct.Memory* @sub_478110.play_attack_defend_n(%struct.State* nonnull %0, i64 %279, %struct.Memory* %call2_4d2ecb)
...
block_.L_4d2f17:                                  ; preds = %block_4d2ee2, %entry
  %299 = phi i64 [ %237, %entry ], [ %.pre, %block_4d2ee2 ]
  %MEMORY.0 = phi %struct.Memory* [ %call2_4d2ecb, %entry ], [ %call2_4d2f03, %block_4d2ee2 ]
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_je_.L_4d2f17(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i8* nocapture %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
