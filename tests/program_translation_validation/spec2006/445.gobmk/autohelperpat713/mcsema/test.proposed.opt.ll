...
define %struct.Memory* @autohelperpat713(%struct.State* noalias, i64, %struct.Memory* noalias readnone) local_unnamed_addr #1 {
entry:
  ...
  %EDI.i106 = bitcast %union.anon* %39 to i32*
  %40 = add i64 %7, -12
  %41 = load i32, i32* %EDI.i106, align 4
  %42 = add i64 %10, 10
  ...
  br i1 %137, label %block_4d34b4, label %block_.L_4d34e2
...
block_4d34b4:                                     ; preds = %entry
  ...
  store i64 %146, i64* %RSI.i63, align 8
  %147 = lshr i64 %146, 63
  %148 = add i64 %146, ptrtoint (%G__0xb0eff0_type* @G__0xb0eff0 to i64)
  store i64 %148, i64* %RDX.i66, align 8
  ...
  br i1 %193, label %block_.L_4d352d, label %block_4d34dd
...
block_.L_4d34e2:                                  ; preds = %entry
  ...
  store i64 %201, i64* %RDI.i42, align 8
  %202 = add i64 %138, -481698
  %203 = add i64 %138, 12
  ...
  %call2_4d34e9 = tail call %struct.Memory* @sub_45db40.attack(%struct.State* nonnull %0, i64 %202, %struct.Memory* %2)
  %207 = load i64, i64* %3, align 8
  store i64 0, i64* %RDI.i42, align 8
  %CL.i37 = bitcast %union.anon* %58 to i8*
  store i8 0, i8* %CL.i37, align 1
  %208 = load i32, i32* %EAX.i48, align 4
  store i8 0, i8* %14, align 1
  %209 = and i32 %208, 255
  ...
  br i1 %226, label %block_.L_4d34e2.block_.L_4d352d_crit_edge, label %block_.L_4d34e2.block_.L_4d34ff_crit_edge

block_.L_4d34e2.block_.L_4d352d_crit_edge:        ; preds = %block_.L_4d34e2
  %.pre4 = bitcast %union.anon* %65 to i8*
  br label %block_.L_4d352d

block_.L_4d34e2.block_.L_4d34ff_crit_edge:        ; preds = %block_.L_4d34e2
  %.pre5 = getelementptr inbounds %union.anon, %union.anon* %51, i64 0, i32 0
  %.pre6 = bitcast %union.anon* %65 to i8*
  br label %block_.L_4d34ff

block_.L_4d34ff:                                  ; preds = %block_.L_4d34e2.block_.L_4d34ff_crit_edge, %block_4d34dd
  %AL.i20.pre-phi = phi i8* [ %.pre6, %block_.L_4d34e2.block_.L_4d34ff_crit_edge ], [ %AL.i68, %block_4d34dd ]
  %RDX.i.pre-phi = phi i64* [ %.pre5, %block_.L_4d34e2.block_.L_4d34ff_crit_edge ], [ %RDX.i66, %block_4d34dd ]
  %RDI.i.pre-phi = phi i64* [ %RDI.i42, %block_.L_4d34e2.block_.L_4d34ff_crit_edge ], [ %.pre3, %block_4d34dd ]
  %RSI.i.pre-phi = phi i64* [ %RSI.i46, %block_.L_4d34e2.block_.L_4d34ff_crit_edge ], [ %RSI.i63, %block_4d34dd ]
  %228 = phi i64 [ %224, %block_.L_4d34e2.block_.L_4d34ff_crit_edge ], [ %195, %block_4d34dd ]
  %MEMORY.0 = phi %struct.Memory* [ %call2_4d34e9, %block_.L_4d34e2.block_.L_4d34ff_crit_edge ], [ %2, %block_4d34dd ]
  ...
  store i64 %239, i64* %RCX.i94, align 8
  ...
  %call2_4d3519 = tail call %struct.Memory* @sub_478110.play_attack_defend_n(%struct.State* nonnull %0, i64 %250, %struct.Memory* %MEMORY.0)
  %255 = load i32, i32* %EAX.i48, align 4
  %256 = load i64, i64* %3, align 8
  %257 = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 21, i32 0
  %R10B.i16 = bitcast %union.anon* %257 to i8*
  %258 = icmp ne i32 %255, 0
  %259 = zext i1 %258 to i64
  %260 = xor i64 %259, 255
  %261 = trunc i64 %260 to i8
  store i8 %261, i8* %R10B.i16, align 1
  store i8 0, i8* %14, align 1
...
block_.L_4d352d:                                  ; preds = %block_.L_4d34e2.block_.L_4d352d_crit_edge, %block_.L_4d34ff, %block_4d34b4
  %AL.i9.pre-phi = phi i8* [ %.pre4, %block_.L_4d34e2.block_.L_4d352d_crit_edge ], [ %AL.i20.pre-phi, %block_.L_4d34ff ], [ %AL.i68, %block_4d34b4 ]
  %271 = phi i64 [ %223, %block_.L_4d34e2.block_.L_4d352d_crit_edge ], [ %.pre, %block_.L_4d34ff ], [ %190, %block_4d34b4 ]
  %MEMORY.1 = phi %struct.Memory* [ %call2_4d34e9, %block_.L_4d34e2.block_.L_4d352d_crit_edge ], [ %call2_4d3519, %block_.L_4d34ff ], [ %2, %block_4d34b4 ]
  ...
  %277 = and i8 %276, 1
  store i8 %277, i8* %AL.i9.pre-phi, align 1
  %278 = zext i8 %277 to i64
  store i64 %278, i64* %RAX.i96, align 8
  %279 = load i64, i64* %6, align 8
  %280 = add i64 %279, 32
  store i64 %280, i64* %6, align 8
  %281 = icmp ugt i64 %279, -33
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_jne_.L_4d34e2(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i8* nocapture %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_jne_.L_4d352d(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i8* nocapture %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 2, i32 7
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_jmpq_.L_4d34ff(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
