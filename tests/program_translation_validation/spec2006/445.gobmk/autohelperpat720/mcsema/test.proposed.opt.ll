...
define %struct.Memory* @autohelperpat720(%struct.State* noalias, i64, %struct.Memory* noalias readnone) local_unnamed_addr #1 {
entry:
  ...
  %ESI.i100 = bitcast %union.anon* %44 to i32*
  %45 = load i64, i64* %RBP.i, align 8
  %46 = add i64 %45, -12
  %47 = load i32, i32* %ESI.i100, align 4
  ...
  store i64 %213, i64* %RAX.i92, align 8
  ...
  store i64 %219, i64* %RCX.i90, align 8
  %220 = add i64 %207, -12
  %221 = add i64 %209, 14
  ...
  store i64 %225, i64* %RCX.i90, align 8
  ...
  %.v = select i1 %265, i64 10, i64 70
  %269 = add i64 %256, %.v
  store i64 %269, i64* %3, align 8
  br i1 %265, label %block_4d39a2, label %block_.L_4d39de
...
block_4d39a2:                                     ; preds = %entry
  ...
  store i64 %274, i64* %RDI.i40, align 8
  %275 = add i64 %254, -24
  %276 = add i64 %269, 13
  ...
  store i64 %279, i64* %RCX.i90, align 8
  ...
  %R11D.i25 = bitcast %union.anon* %304 to i32*
  ...
  %EAX.i22 = bitcast %union.anon* %65 to i32*
  ...
  %313 = add i64 %312, 8
  %314 = load i32, i32* %R10D.i28, align 4
  ...
  %319 = add i64 %318, 16
  %320 = load i32, i32* %R11D.i25, align 4
  ...
  %call2_4d39d1 = tail call %struct.Memory* @sub_478110.play_attack_defend_n(%struct.State* nonnull %0, i64 %325, %struct.Memory* %2)
  %330 = load i64, i64* %RBP.i, align 8
  %331 = add i64 %330, -4
  %332 = load i32, i32* %EAX.i22, align 4
...
block_.L_4d39de:                                  ; preds = %entry
  ...
  %call2_4d39e1 = tail call %struct.Memory* @sub_433300.add_antisuji_move(%struct.State* nonnull %0, i64 %343, %struct.Memory* %2)
...
block_.L_4d39ed:                                  ; preds = %block_.L_4d39de, %block_4d39a2
  %353 = phi i64 [ %.pre, %block_.L_4d39de ], [ %337, %block_4d39a2 ]
  %MEMORY.0 = phi %struct.Memory* [ %call2_4d39e1, %block_.L_4d39de ], [ %call2_4d39d1, %block_4d39a2 ]
  ...
  store i64 %359, i64* %RAX.i92, align 8
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_jne_.L_4d39de(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i8* nocapture %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_jmpq_.L_4d39ed(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
