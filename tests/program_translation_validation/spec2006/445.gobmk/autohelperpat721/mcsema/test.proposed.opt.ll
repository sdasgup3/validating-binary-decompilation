...
define %struct.Memory* @autohelperpat721(%struct.State* noalias, i64, %struct.Memory* noalias readnone returned) local_unnamed_addr #1 {
entry:
  ...
  %RAX.i38 = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 1, i32 0, i32 0
  ...
  %ECX.i29 = bitcast %union.anon* %30 to i32*
  %31 = load i64, i64* %RBP.i, align 8
  %32 = add i64 %31, -16
  %33 = load i32, i32* %ECX.i29, align 4
  %34 = load i64, i64* %3, align 8
  %35 = add i64 %34, 3
  store i64 %35, i64* %3, align 8
  %36 = inttoptr i64 %32 to i32*
  store i32 %33, i32* %36, align 4
  %R8.i27 = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 17, i32 0, i32 0
  ...
  store i64 %43, i64* %R8.i27, align 8
  %RCX.i23 = getelementptr inbounds %union.anon, %union.anon* %30, i64 0, i32 0
  %44 = shl nsw i64 %43, 2
  %45 = add nsw i64 %44, 11903696
  %46 = add i64 %39, 12
  ...
  store i64 %55, i64* %RCX.i23, align 8
  ...
  store i64 %97, i64* %R8.i27, align 8
  %98 = lshr i64 %97, 63
  %99 = load i64, i64* %RAX.i38, align 8
  %100 = add i64 %97, %99
  store i64 %100, i64* %RAX.i38, align 8
  %101 = icmp ult i64 %100, %99
  %102 = icmp ult i64 %100, %97
  %103 = or i1 %101, %102
  %104 = zext i1 %103 to i8
  store i8 %104, i8* %60, align 1
  ...
  %132 = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 19, i32 0
  %R9B.i8 = bitcast %union.anon* %132 to i8*
  store i8 %131, i8* %R9B.i8, align 1
  store i8 0, i8* %60, align 1
  %133 = zext i1 %130 to i32
  %134 = tail call i32 @llvm.ctpop.i32(i32 %133)
  %135 = trunc i32 %134 to i8
  %136 = xor i8 %135, 1
  store i8 %136, i8* %66, align 1
  %137 = xor i8 %131, 1
  store i8 %137, i8* %75, align 1
  store i8 0, i8* %78, align 1
  store i8 0, i8* %86, align 1
  store i8 0, i8* %72, align 1
  %138 = zext i1 %130 to i64
  store i64 %138, i64* %RAX.i38, align 8
  %139 = add i64 %92, 28
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_movl_0xb5a2d0___r8_4____ecx(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
