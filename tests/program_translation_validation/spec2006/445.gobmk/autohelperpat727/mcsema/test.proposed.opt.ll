...
define %struct.Memory* @autohelperpat727(%struct.State* noalias, i64, %struct.Memory* noalias readnone returned) local_unnamed_addr #1 {
entry:
  ...
  %call2_4d3b6c = tail call %struct.Memory* @sub_4352e0.add_replacement_move(%struct.State* %0, i64 %171, %struct.Memory* %2)
  ...
  %call2_4d3b77 = tail call %struct.Memory* @sub_4352e0.add_replacement_move(%struct.State* %0, i64 %188, %struct.Memory* %call2_4d3b6c)
  ...
  ret %struct.Memory* %call2_4d3b77
}
