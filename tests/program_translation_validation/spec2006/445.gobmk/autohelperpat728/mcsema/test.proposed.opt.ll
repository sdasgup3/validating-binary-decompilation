...
define %struct.Memory* @autohelperpat728(%struct.State* noalias, i64, %struct.Memory* noalias readnone) local_unnamed_addr #1 {
entry:
  ...
  br i1 %171, label %block_4d3bd0, label %block_.L_4d3bec

block_4d3bd0:                                     ; preds = %entry
  %176 = add i64 %160, -24
  %177 = add i64 %175, 3
  ...
  %call2_4d3bd3 = tail call %struct.Memory* @sub_40f780.countlib(%struct.State* nonnull %0, i64 %181, %struct.Memory* %2)
  ...
  %196 = xor i1 %195, %194
  %.demorgan = or i1 %189, %196
  %197 = xor i1 %.demorgan, true
  %198 = zext i1 %197 to i8
  store i8 %198, i8* %CL.i22, align 1
  store i8 0, i8* %14, align 1
  %199 = zext i1 %197 to i32
  ...
  store i8 0, i8* %38, align 1
  store i8 0, i8* %26, align 1
  %205 = zext i1 %197 to i64
  store i64 %205, i64* %RAX.i52, align 8
...
block_.L_4d3bec:                                  ; preds = %entry
  ...
  store i64 %217, i64* %RDI.i, align 8
  ...
  store i64 %222, i64* %RSI.i, align 8
  %223 = add i64 %175, -649484
  %224 = add i64 %175, 11
  ...
  %call2_4d3bf2 = tail call %struct.Memory* @sub_4352e0.add_replacement_move(%struct.State* nonnull %0, i64 %223, %struct.Memory* %2)
...
block_.L_4d3bfe:                                  ; preds = %block_.L_4d3bec, %block_4d3bd0
  %233 = phi i64 [ %.pre, %block_.L_4d3bec ], [ %212, %block_4d3bd0 ]
  %MEMORY.0 = phi %struct.Memory* [ %call2_4d3bf2, %block_.L_4d3bec ], [ %call2_4d3bd3, %block_4d3bd0 ]
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_jne_.L_4d3bec(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i8* nocapture %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_jmpq_.L_4d3bfe(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
