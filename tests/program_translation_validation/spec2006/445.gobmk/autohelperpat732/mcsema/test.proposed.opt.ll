...
define %struct.Memory* @autohelperpat732(%struct.State* noalias, i64, %struct.Memory* noalias readnone returned) local_unnamed_addr #1 {
entry:
  ...
  %call2_4d3f88 = tail call %struct.Memory* @sub_40f780.countlib(%struct.State* %0, i64 %120, %struct.Memory* %2)
  ...
  ret %struct.Memory* %call2_4d3f88
}
