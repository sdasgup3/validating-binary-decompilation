...
define %struct.Memory* @autohelperpat738(%struct.State* noalias, i64, %struct.Memory* noalias readnone) local_unnamed_addr #1 {
entry:
  ...
  %RDI.i61 = getelementptr inbounds %union.anon, %union.anon* %39, i64 0, i32 0
  ...
  store i64 %166, i64* %RDI.i61, align 8
  %167 = add i64 %162, -147734
  %168 = add i64 %162, 8
  ...
  %call2_4d4189 = tail call %struct.Memory* @sub_4b0070.dragon_weak(%struct.State* %0, i64 %167, %struct.Memory* %2)
  %172 = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 17, i32 0
  %R8B.i58 = bitcast %union.anon* %172 to i8*
  ...
  br i1 %192, label %block_.L_4d41f8, label %block_4d419e
...
block_4d419e:                                     ; preds = %entry
  ...
  store i64 %199, i64* %RDI.i61, align 8
  %200 = add i64 %193, -147758
  %201 = add i64 %193, 8
  ...
  %call2_4d41a1 = tail call %struct.Memory* @sub_4b0070.dragon_weak(%struct.State* nonnull %0, i64 %200, %struct.Memory* %call2_4d4189)
  ...
  br i1 %224, label %block_.L_4d41f8, label %block_4d41b4

block_4d41b4:                                     ; preds = %block_4d419e
  store i64 ptrtoint (%G__0xb7df8c_type* @G__0xb7df8c to i64), i64* %RAX.i84, align 8
  store i64 ptrtoint (%G__0xb38cb4_type* @G__0xb38cb4 to i64), i64* %RCX.i82, align 8
  %RDX.i35 = getelementptr inbounds %union.anon, %union.anon* %51, i64 0, i32 0
  ...
  %250 = xor i32 %248, %235
  %251 = add nuw nsw i32 %250, %235
  %252 = icmp eq i32 %251, 2
  %253 = zext i1 %252 to i8
  store i8 %253, i8* %38, align 1
  %254 = select i1 %246, i64 ptrtoint (%G__0xb38cb4_type* @G__0xb38cb4 to i64), i64 ptrtoint (%G__0xb7df8c_type* @G__0xb7df8c to i64)
  store i64 %254, i64* %RAX.i84, align 8
  ...
  store i64 %254, i64* %RDI.i61, align 8
  %260 = add i64 %225, -692068
  %261 = add i64 %225, 46
  ...
  %call2_4d41dd = tail call %struct.Memory* @sub_42b250.whose_territory(%struct.State* nonnull %0, i64 %260, %struct.Memory* %call2_4d41a1)
  ...
  store i64 %272, i64* %RDX.i35, align 8
  %273 = load i32, i32* %EAX.i56, align 4
  %274 = icmp eq i32 %273, %271
  %275 = zext i1 %274 to i8
  %276 = xor i8 %275, -1
  store i8 %276, i8* %R8B.i58, align 1
  store i8 0, i8* %14, align 1
...
block_.L_4d41f8:                                  ; preds = %block_4d41b4, %block_4d419e, %entry
  %285 = phi i64 [ %189, %entry ], [ %221, %block_4d419e ], [ %.pre, %block_4d41b4 ]
  %MEMORY.0 = phi %struct.Memory* [ %call2_4d4189, %entry ], [ %call2_4d41a1, %block_4d419e ], [ %call2_4d41dd, %block_4d41b4 ]
  ...
  store i64 %292, i64* %RAX.i84, align 8
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_jne_.L_4d41f8(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i8* nocapture %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
