...
define %struct.Memory* @autohelperpat754(%struct.State* noalias, i64, %struct.Memory* noalias readnone returned) local_unnamed_addr #1 {
entry:
  ...
  store i64 %172, i64* %RCX.i68, align 8
  %173 = add i64 %160, -8
  %174 = add i64 %162, 14
  ...
  %call2_4d4add = tail call %struct.Memory* @sub_41fc30.is_same_dragon(%struct.State* %0, i64 %219, %struct.Memory* %2)
  %224 = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 17, i32 0
  %R8B.i31 = bitcast %union.anon* %224 to i8*
  %225 = load i64, i64* %3, align 8
  store i8 1, i8* %R8B.i31, align 1
  %EAX.i = bitcast %union.anon* %65 to i32*
  %226 = load i32, i32* %EAX.i, align 4
  ...
  %.v = select i1 %242, i64 40, i64 6
  %243 = add i64 %240, %.v
  store i64 %243, i64* %3, align 8
  %cmpBr_4d4aec = icmp eq i8 %241, 1
  br i1 %cmpBr_4d4aec, label %block_.L_4d4b14, label %block_4d4af2

block_4d4af2:                                     ; preds = %entry
  ...
  %250 = mul nsw i64 %249, 380
  store i64 %250, i64* %RCX.i68, align 8
  %251 = lshr i64 %250, 63
  %252 = add i64 %250, ptrtoint (%G__0xb0eff0_type* @G__0xb0eff0 to i64)
  store i64 %252, i64* %RAX.i70, align 8
  %253 = icmp ult i64 %252, ptrtoint (%G__0xb0eff0_type* @G__0xb0eff0 to i64)
  ...
  %263 = xor i64 %250, ptrtoint (%G__0xb0eff0_type* @G__0xb0eff0 to i64)
  %264 = xor i64 %263, %252
  %265 = lshr i64 %264, 4
  ...
  %272 = xor i64 %270, lshr (i64 ptrtoint (%G__0xb0eff0_type* @G__0xb0eff0 to i64), i64 63)
  %273 = xor i64 %270, %251
  %274 = add nuw nsw i64 %272, %273
  %275 = icmp eq i64 %274, 2
  %276 = zext i1 %275 to i8
  store i8 %276, i8* %38, align 1
  %277 = add i64 %250, add (i64 ptrtoint (%G__0xb0eff0_type* @G__0xb0eff0 to i64), i64 40)
  %278 = add i64 %243, 28
  ...
  %303 = xor i1 %302, %300
  %.demorgan = or i1 %293, %303
  %304 = xor i1 %.demorgan, true
  %305 = zext i1 %304 to i8
  store i8 %305, i8* %DL.i14, align 1
...
block_.L_4d4b14:                                  ; preds = %block_4d4af2, %entry
  %310 = phi i64 [ %.pre, %block_4d4af2 ], [ %243, %entry ]
  ...
  store i64 %317, i64* %RAX.i70, align 8
  %318 = load i64, i64* %6, align 8
  %319 = add i64 %318, 32
  store i64 %319, i64* %6, align 8
  %320 = icmp ugt i64 %318, -33
  ...
  ret %struct.Memory* %call2_4d4add
}
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_je_.L_4d4b14(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i8* nocapture %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
...
; Function Attrs: nounwind
define %struct.Memory* @routine_cmpl__0x1__0x28__rax_(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned) local_unnamed_addr #3 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %RAX = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 1, i32 0, i32 0
  %3 = load i64, i64* %RAX, align 8
