...
define %struct.Memory* @autohelperpat757(%struct.State* noalias, i64, %struct.Memory* noalias readnone returned) local_unnamed_addr #1 {
entry:
  ...
  %call2_4d4dab = tail call %struct.Memory* @sub_4772c0.does_attack(%struct.State* %0, i64 %124, %struct.Memory* %2)
  ...
  ret %struct.Memory* %call2_4d4dab
}
