...
define %struct.Memory* @autohelperpat758(%struct.State* noalias, i64, %struct.Memory* noalias readnone) local_unnamed_addr #1 {
entry:
  ...
  %ESI.i57 = bitcast %union.anon* %44 to i32*
  %45 = load i64, i64* %RBP.i, align 8
  %46 = add i64 %45, -8
  %47 = load i32, i32* %ESI.i57, align 4
  ...
  store i64 %119, i64* %RDI.i38, align 8
  %120 = add i64 %115, -808549
  %121 = add i64 %115, 8
  ...
  %call2_4d4de8 = tail call %struct.Memory* @sub_40f780.countlib(%struct.State* %0, i64 %120, %struct.Memory* %2)
  %125 = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 17, i32 0
  %R8B.i35 = bitcast %union.anon* %125 to i8*
  %126 = load i64, i64* %3, align 8
  store i8 1, i8* %R8B.i35, align 1
  ...
  br i1 %164, label %entry.block_.L_4d4e24_crit_edge, label %block_4d4dfd

entry.block_.L_4d4e24_crit_edge:                  ; preds = %entry
  %.pre1 = bitcast %union.anon* %65 to i8*
  br label %block_.L_4d4e24

block_4d4dfd:                                     ; preds = %entry
  ...
  store i64 %171, i64* %RDI.i38, align 8
  %172 = add i64 %166, -8
  %173 = add i64 %165, 13
  ...
  store i64 %176, i64* %RCX.i47, align 8
  %177 = getelementptr inbounds %union.anon, %union.anon* %125, i64 0, i32 0
  %178 = add i64 %166, -20
  %179 = add i64 %165, 17
  ...
  %call2_4d4e10 = tail call %struct.Memory* @sub_478110.play_attack_defend_n(%struct.State* nonnull %0, i64 %183, %struct.Memory* %call2_4d4de8)
  %188 = load i32, i32* %EAX.i33, align 4
  %189 = load i64, i64* %3, align 8
  %190 = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 19, i32 0
  %R9B.i16 = bitcast %union.anon* %190 to i8*
  %191 = icmp ne i32 %188, 0
  %192 = zext i1 %191 to i64
  %193 = xor i64 %192, 255
  %194 = trunc i64 %193 to i8
  store i8 %194, i8* %R9B.i16, align 1
  store i8 0, i8* %14, align 1
...
block_.L_4d4e24:                                  ; preds = %entry.block_.L_4d4e24_crit_edge, %block_4d4dfd
  %AL.i9.pre-phi = phi i8* [ %.pre1, %entry.block_.L_4d4e24_crit_edge ], [ %AL.i20, %block_4d4dfd ]
  %204 = phi i64 [ %154, %entry.block_.L_4d4e24_crit_edge ], [ %.pre, %block_4d4dfd ]
  %MEMORY.0 = phi %struct.Memory* [ %call2_4d4de8, %entry.block_.L_4d4e24_crit_edge ], [ %call2_4d4e10, %block_4d4dfd ]
  ...
  %210 = and i8 %209, 1
  store i8 %210, i8* %AL.i9.pre-phi, align 1
  %211 = zext i8 %210 to i64
  store i64 %211, i64* %RAX.i49, align 8
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_jg_.L_4d4e24(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i8* nocapture %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
