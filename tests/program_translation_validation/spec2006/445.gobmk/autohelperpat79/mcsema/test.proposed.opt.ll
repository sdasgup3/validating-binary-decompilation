...
define %struct.Memory* @autohelperpat79(%struct.State* noalias, i64, %struct.Memory* noalias readnone) local_unnamed_addr #1 {
entry:
  ...
  %EDX.i65 = bitcast %union.anon* %51 to i32*
  %52 = load i64, i64* %RBP.i, align 8
  %53 = add i64 %52, -12
  %54 = load i32, i32* %EDX.i65, align 4
  ...
  store i64 %119, i64* %RDI.i47, align 8
  %120 = add i64 %115, -759541
  %121 = add i64 %115, 8
  ...
  %call2_4c8e78 = tail call %struct.Memory* @sub_40f780.countlib(%struct.State* %0, i64 %120, %struct.Memory* %2)
  %125 = load i64, i64* %3, align 8
  store i64 0, i64* %RCX.i57, align 8
  %126 = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 17, i32 0
  %R8B.i42 = bitcast %union.anon* %126 to i8*
  store i8 0, i8* %R8B.i42, align 1
  %EAX.i40 = bitcast %union.anon* %65 to i32*
  %127 = load i32, i32* %EAX.i40, align 4
  %128 = add i32 %127, -3
  ...
  %158 = load i8, i8* %38, align 1
  %159 = icmp ne i8 %158, 0
  %160 = xor i1 %157, %159
  %161 = select i1 %160, i64 %154, i64 %155
  store i64 %161, i64* %3, align 8
  br i1 %160, label %block_.L_4c8ecc, label %block_4c8e8f

block_4c8e8f:                                     ; preds = %entry
  store i64 ptrtoint (%G__0xb7df8c_type* @G__0xb7df8c to i64), i64* %RAX.i59, align 8
  store i64 ptrtoint (%G__0xb38cb4_type* @G__0xb38cb4 to i64), i64* %RCX.i57, align 8
  ...
  store i64 %168, i64* %RDX.i30, align 8
  ...
  %186 = xor i32 %184, %171
  %187 = add nuw nsw i32 %186, %171
  %188 = icmp eq i32 %187, 2
  %189 = zext i1 %188 to i8
  store i8 %189, i8* %38, align 1
  %190 = select i1 %182, i64 ptrtoint (%G__0xb38cb4_type* @G__0xb38cb4 to i64), i64 ptrtoint (%G__0xb7df8c_type* @G__0xb7df8c to i64)
  ...
  store i64 %190, i64* %RDI.i47, align 8
  %196 = add i64 %161, -645823
  %197 = add i64 %161, 46
  ...
  %call2_4c8eb8 = tail call %struct.Memory* @sub_42b3d0.whose_moyo(%struct.State* nonnull %0, i64 %196, %struct.Memory* %call2_4c8e78)
  %201 = load i32, i32* %EAX.i40, align 4
  ...
  %210 = xor i8 %209, -1
  store i8 %210, i8* %R8B.i42, align 1
  ...
  br label %block_.L_4c8ecc

block_.L_4c8ecc:                                  ; preds = %block_4c8e8f, %entry
  %219 = phi i64 [ %154, %entry ], [ %.pre, %block_4c8e8f ]
  %MEMORY.0 = phi %struct.Memory* [ %call2_4c8e78, %entry ], [ %call2_4c8eb8, %block_4c8e8f ]
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_jl_.L_4c8ecc(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i8* nocapture %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
