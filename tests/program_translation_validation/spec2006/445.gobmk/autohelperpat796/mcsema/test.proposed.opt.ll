...
define %struct.Memory* @autohelperpat796(%struct.State* noalias, i64, %struct.Memory* noalias readnone returned) local_unnamed_addr #1 {
entry:
  ...
  %call2_4d637a = tail call %struct.Memory* @sub_433300.add_antisuji_move(%struct.State* %0, i64 %213, %struct.Memory* %2)
  ...
  %call2_4d6382 = tail call %struct.Memory* @sub_433300.add_antisuji_move(%struct.State* %0, i64 %225, %struct.Memory* %call2_4d637a)
  ...
  %call2_4d638a = tail call %struct.Memory* @sub_433300.add_antisuji_move(%struct.State* %0, i64 %237, %struct.Memory* %call2_4d6382)
  ...
  ret %struct.Memory* %call2_4d638a
}
