...
define %struct.Memory* @autohelperpat81(%struct.State* noalias, i64, %struct.Memory* noalias readnone returned) local_unnamed_addr #1 {
entry:
  ...
  %call2_4c8f4b = tail call %struct.Memory* @sub_4772c0.does_attack(%struct.State* %0, i64 %124, %struct.Memory* %2)
  ...
  ret %struct.Memory* %call2_4c8f4b
}
