...
define %struct.Memory* @autohelperpat823(%struct.State* noalias, i64, %struct.Memory* noalias readnone returned) local_unnamed_addr #1 {
entry:
  ...
  %call2_4d67be = tail call %struct.Memory* @sub_477710.somewhere(%struct.State* %0, i64 %351, %struct.Memory* %2)
  ...
  ret %struct.Memory* %call2_4d67be
}
