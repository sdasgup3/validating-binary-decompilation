...
define %struct.Memory* @autohelperpat825(%struct.State* noalias, i64, %struct.Memory* noalias readnone returned) local_unnamed_addr #1 {
entry:
  ...
  %call2_4d68b9 = tail call %struct.Memory* @sub_433300.add_antisuji_move(%struct.State* %0, i64 %166, %struct.Memory* %2)
  ...
  %call2_4d68c1 = tail call %struct.Memory* @sub_433300.add_antisuji_move(%struct.State* %0, i64 %178, %struct.Memory* %call2_4d68b9)
  ...
  ret %struct.Memory* %call2_4d68c1
}
