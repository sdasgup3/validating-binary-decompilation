...
define %struct.Memory* @autohelperpat838(%struct.State* noalias, i64, %struct.Memory* noalias readnone returned) local_unnamed_addr #1 {
entry:
  ...
  %call2_4d6bab = tail call %struct.Memory* @sub_4afd30.owl_threatens_attack(%struct.State* %0, i64 %125, %struct.Memory* %2)
  ...
  br i1 %150, label %block_.L_4d6bdf, label %block_4d6bc0

block_4d6bc0:                                     ; preds = %entry
...
block_.L_4d6bdf:                                  ; preds = %block_4d6bc0, %entry
  %214 = phi i64 [ %.pre, %block_4d6bc0 ], [ %147, %entry ]
  ...
  ret %struct.Memory* %call2_4d6bab
}
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_jne_.L_4d6bdf(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i8* nocapture %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
