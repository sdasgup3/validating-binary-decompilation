...
define %struct.Memory* @autohelperpat839(%struct.State* noalias, i64, %struct.Memory* noalias readnone returned) local_unnamed_addr #1 {
entry:
  ...
  %ECX.i49 = bitcast %union.anon* %58 to i32*
  %59 = load i64, i64* %RBP.i, align 8
  %60 = add i64 %59, -16
  %61 = load i32, i32* %ECX.i49, align 4
  ...
  %RAX.i46 = getelementptr inbounds %union.anon, %union.anon* %65, i64 0, i32 0
  ...
  store i64 %72, i64* %RAX.i46, align 8
  %RCX.i44 = getelementptr inbounds %union.anon, %union.anon* %58, i64 0, i32 0
  %73 = shl nsw i64 %72, 2
  ...
  %call2_4d6c1b = tail call %struct.Memory* @sub_4afd30.owl_threatens_attack(%struct.State* %0, i64 %125, %struct.Memory* %2)
  %130 = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 17, i32 0
  %R8B.i31 = bitcast %union.anon* %130 to i8*
  %131 = load i64, i64* %3, align 8
  store i8 1, i8* %R8B.i31, align 1
  %EAX.i = bitcast %union.anon* %65 to i32*
  %132 = load i32, i32* %EAX.i, align 4
  ...
  %151 = select i1 %150, i64 %147, i64 %148
  store i64 %151, i64* %3, align 8
  br i1 %150, label %block_.L_4d6c4f, label %block_4d6c30

block_4d6c30:                                     ; preds = %entry
  store i64 ptrtoint (%G__0xb4bd20_type* @G__0xb4bd20 to i64), i64* %RAX.i46, align 8
  ...
  store i64 %158, i64* %RCX.i44, align 8
  %159 = lshr i64 %158, 63
  %160 = add i64 %158, ptrtoint (%G__0xb4bd20_type* @G__0xb4bd20 to i64)
  store i64 %160, i64* %RAX.i46, align 8
  %161 = icmp ult i64 %160, ptrtoint (%G__0xb4bd20_type* @G__0xb4bd20 to i64)
  ...
  %171 = xor i64 %158, ptrtoint (%G__0xb4bd20_type* @G__0xb4bd20 to i64)
  %172 = xor i64 %171, %160
  %173 = lshr i64 %172, 4
  ...
  %180 = xor i64 %178, lshr (i64 ptrtoint (%G__0xb4bd20_type* @G__0xb4bd20 to i64), i64 63)
  %181 = xor i64 %178, %159
  %182 = add nuw nsw i64 %180, %181
  %183 = icmp eq i64 %182, 2
  %184 = zext i1 %183 to i8
  store i8 %184, i8* %38, align 1
  %185 = add i64 %158, add (i64 ptrtoint (%G__0xb4bd20_type* @G__0xb4bd20 to i64), i64 64)
  %186 = add i64 %151, 25
  ...
  store i8 %202, i8* %DL.i14, align 1
...
block_.L_4d6c4f:                                  ; preds = %block_4d6c30, %entry
  %214 = phi i64 [ %.pre, %block_4d6c30 ], [ %147, %entry ]
  ...
  store i64 %221, i64* %RAX.i46, align 8
  ...
  ret %struct.Memory* %call2_4d6c1b
}
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_jne_.L_4d6c4f(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i8* nocapture %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
