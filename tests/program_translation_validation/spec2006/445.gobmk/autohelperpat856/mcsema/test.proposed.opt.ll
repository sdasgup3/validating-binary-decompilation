...
define %struct.Memory* @autohelperpat856(%struct.State* noalias, i64, %struct.Memory* noalias readnone returned) local_unnamed_addr #1 {
entry:
  ...
  %ECX.i35 = bitcast %union.anon* %58 to i32*
  %59 = load i64, i64* %RBP.i, align 8
  %60 = add i64 %59, -16
  %61 = load i32, i32* %ECX.i35, align 4
  %62 = load i64, i64* %3, align 8
  %63 = add i64 %62, 3
  store i64 %63, i64* %3, align 8
  %64 = inttoptr i64 %60 to i32*
  store i32 %61, i32* %64, align 4
  %R8.i33 = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 17, i32 0, i32 0
  ...
  store i64 %118, i64* %R8.i33, align 8
  ...
  %159 = load i64, i64* %RAX.i44, align 8
  ...
  %call2_4d7068 = tail call %struct.Memory* @sub_477990.visible_along_edge(%struct.State* %0, i64 %202, %struct.Memory* %2)
  %207 = load i64, i64* %6, align 8
  %208 = load i64, i64* %3, align 8
  %209 = add i64 %207, 32
  store i64 %209, i64* %6, align 8
  %210 = icmp ugt i64 %207, -33
  ...
  ret %struct.Memory* %call2_4d7068
}
