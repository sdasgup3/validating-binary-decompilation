...
define %struct.Memory* @autohelperpat86(%struct.State* noalias, i64, %struct.Memory* noalias readnone) local_unnamed_addr #1 {
entry:
  ...
  store i64 %166, i64* %RAX.i104, align 8
  ...
  store i64 %172, i64* %RCX.i102, align 8
  %173 = add i64 %160, -8
  %174 = add i64 %162, 14
  ...
  store i64 %178, i64* %RCX.i102, align 8
  ...
  store i64 %213, i64* %RAX.i104, align 8
  ...
  store i64 %219, i64* %RCX.i102, align 8
  %220 = add i64 %207, -8
  %221 = add i64 %209, 14
  ...
  store i64 %225, i64* %RCX.i102, align 8
  ...
  store i64 %260, i64* %RDI.i57, align 8
  ...
  store i64 %265, i64* %RSI.i54, align 8
  %RDX.i51 = getelementptr inbounds %union.anon, %union.anon* %51, i64 0, i32 0
  %266 = add i64 %254, -20
  %267 = add i64 %256, 9
  ...
  store i64 %270, i64* %RDX.i51, align 8
  %271 = add i64 %256, -336552
  %272 = add i64 %256, 14
  ...
  %call2_4c9421 = tail call %struct.Memory* @sub_477170.defend_against(%struct.State* %0, i64 %271, %struct.Memory* %2)
  %276 = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 17, i32 0
  %R8B.i48 = bitcast %union.anon* %276 to i8*
  %277 = load i64, i64* %3, align 8
  store i8 1, i8* %R8B.i48, align 1
  %EAX.i46 = bitcast %union.anon* %65 to i32*
  %278 = load i32, i32* %EAX.i46, align 4
  ...
  %297 = select i1 %296, i64 %293, i64 %294
  store i64 %297, i64* %3, align 8
  br i1 %296, label %entry.block_.L_4c9473_crit_edge, label %block_4c9436

entry.block_.L_4c9473_crit_edge:                  ; preds = %entry
...
block_4c9436:                                     ; preds = %entry
  ...
  store i64 %303, i64* %RDI.i57, align 8
  %304 = add i64 %298, -8
  %305 = add i64 %297, 16
  ...
  %309 = getelementptr inbounds %union.anon, %union.anon* %276, i64 0, i32 0
  %310 = add i64 %298, -20
  %311 = add i64 %297, 20
  ...
  %315 = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 19, i32 0, i32 0
  %316 = add i64 %298, -24
  %317 = add i64 %297, 24
  ...
  %326 = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 21, i32 0
  %R10D.i27 = bitcast %union.anon* %326 to i32*
  %327 = getelementptr inbounds %union.anon, %union.anon* %326, i64 0, i32 0
  %328 = add i64 %298, -32
  %329 = add i64 %297, 31
  ...
  %337 = add i64 %336, 8
  %338 = load i32, i32* %R10D.i27, align 4
  ...
  %call2_4c945f = tail call %struct.Memory* @sub_4784b0.play_attack_defend2_n(%struct.State* nonnull %0, i64 %343, %struct.Memory* %call2_4c9421)
  %348 = load i32, i32* %EAX.i46, align 4
  %349 = load i64, i64* %3, align 8
  %350 = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 23, i32 0
  %R11B.i16 = bitcast %union.anon* %350 to i8*
  %351 = icmp ne i32 %348, 0
  %352 = zext i1 %351 to i64
  %353 = xor i64 %352, 255
  %354 = trunc i64 %353 to i8
  store i8 %354, i8* %R11B.i16, align 1
  store i8 0, i8* %14, align 1
  ...
  store i8 %354, i8* %363, align 1
  %.pre = load i64, i64* %3, align 8
  br label %block_.L_4c9473

block_.L_4c9473:                                  ; preds = %entry.block_.L_4c9473_crit_edge, %block_4c9436
  %AL.i9.pre-phi = phi i8* [ %.pre1, %entry.block_.L_4c9473_crit_edge ], [ %AL.i20, %block_4c9436 ]
  %364 = phi i64 [ %293, %entry.block_.L_4c9473_crit_edge ], [ %.pre, %block_4c9436 ]
  %MEMORY.0 = phi %struct.Memory* [ %call2_4c9421, %entry.block_.L_4c9473_crit_edge ], [ %call2_4c945f, %block_4c9436 ]
  ...
  %370 = and i8 %369, 1
  store i8 %370, i8* %AL.i9.pre-phi, align 1
  %371 = zext i8 %370 to i64
  store i64 %371, i64* %RAX.i104, align 8
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_jne_.L_4c9473(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i8* nocapture %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
