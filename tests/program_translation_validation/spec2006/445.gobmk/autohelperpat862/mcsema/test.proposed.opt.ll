...
define %struct.Memory* @autohelperpat862(%struct.State* noalias, i64, %struct.Memory* noalias readnone returned) local_unnamed_addr #1 {
entry:
  ...
  %call2_4d734e = tail call %struct.Memory* @sub_477710.somewhere(%struct.State* %0, i64 %312, %struct.Memory* %2)
  ...
  ret %struct.Memory* %call2_4d734e
}
