...
define %struct.Memory* @autohelperpat878(%struct.State* noalias, i64, %struct.Memory* noalias readnone) local_unnamed_addr #1 {
entry:
  ...
  %call2_4d77b8 = tail call %struct.Memory* @sub_40f780.countlib(%struct.State* %0, i64 %120, %struct.Memory* %2)
  ...
  br i1 %164, label %block_.L_4d77e0, label %block_4d77cf
...
block_4d77cf:                                     ; preds = %entry
  ...
  store i64 %171, i64* %RDI.i30, align 8
  %172 = add i64 %165, -166335
  %173 = add i64 %165, 8
  ...
  %call2_4d77d2 = tail call %struct.Memory* @sub_4aee10.seki_helper(%struct.State* nonnull %0, i64 %172, %struct.Memory* %call2_4d77b8)
  %177 = load i32, i32* %EAX.i23, align 4
  ...
  store i8 %189, i8* %CL.i25, align 1
...
block_.L_4d77e0:                                  ; preds = %block_4d77cf, %entry
  %194 = phi i64 [ %154, %entry ], [ %.pre, %block_4d77cf ]
  %MEMORY.0 = phi %struct.Memory* [ %call2_4d77b8, %entry ], [ %call2_4d77d2, %block_4d77cf ]
  ...
  store i64 %201, i64* %RAX.i42, align 8
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_jg_.L_4d77e0(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i8* nocapture %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
