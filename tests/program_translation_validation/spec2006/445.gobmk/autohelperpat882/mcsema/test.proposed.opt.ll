...
define %struct.Memory* @autohelperpat882(%struct.State* noalias, i64, %struct.Memory* noalias readnone) local_unnamed_addr #1 {
entry:
  ...
  %call2_4d7938 = tail call %struct.Memory* @sub_40f780.countlib(%struct.State* %0, i64 %120, %struct.Memory* %2)
  ...
  br i1 %157, label %block_.L_4d7960, label %block_4d794f
...
block_4d794f:                                     ; preds = %entry
  ...
  %call2_4d7952 = tail call %struct.Memory* @sub_4aee10.seki_helper(%struct.State* nonnull %0, i64 %165, %struct.Memory* %call2_4d7938)
...
block_.L_4d7960:                                  ; preds = %block_4d794f, %entry
  %187 = phi i64 [ %154, %entry ], [ %.pre, %block_4d794f ]
  %MEMORY.0 = phi %struct.Memory* [ %call2_4d7938, %entry ], [ %call2_4d7952, %block_4d794f ]
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_jne_.L_4d7960(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i8* nocapture %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
