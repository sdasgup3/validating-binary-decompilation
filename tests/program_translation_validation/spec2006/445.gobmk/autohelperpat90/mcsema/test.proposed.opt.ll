...
define %struct.Memory* @autohelperpat90(%struct.State* noalias, i64, %struct.Memory* noalias readnone) local_unnamed_addr #1 {
entry:
  ...
  %call2_4c9805 = tail call %struct.Memory* @sub_4784b0.play_attack_defend2_n(%struct.State* %0, i64 %309, %struct.Memory* %2)
  ...
  br i1 %334, label %block_.L_4c985c, label %block_4c981c
...
block_4c981c:                                     ; preds = %entry
  ...
  %call2_4c984e = tail call %struct.Memory* @sub_4784b0.play_attack_defend2_n(%struct.State* nonnull %0, i64 %384, %struct.Memory* %call2_4c9805)
...
block_.L_4c985c:                                  ; preds = %block_4c981c, %entry
  %406 = phi i64 [ %331, %entry ], [ %.pre, %block_4c981c ]
  %MEMORY.0 = phi %struct.Memory* [ %call2_4c9805, %entry ], [ %call2_4c984e, %block_4c981c ]
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_jne_.L_4c985c(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i8* nocapture %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
