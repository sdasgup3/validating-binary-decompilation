...
define %struct.Memory* @autohelperpat915(%struct.State* noalias, i64, %struct.Memory* noalias readnone returned) local_unnamed_addr #1 {
entry:
  ...
  %call2_4d7d42 = tail call %struct.Memory* @sub_42b3d0.whose_moyo(%struct.State* %0, i64 %153, %struct.Memory* %2)
  ...
  ret %struct.Memory* %call2_4d7d42
}
