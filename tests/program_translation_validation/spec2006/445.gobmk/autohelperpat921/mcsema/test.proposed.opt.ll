...
define %struct.Memory* @autohelperpat921(%struct.State* noalias, i64, %struct.Memory* noalias readnone returned) local_unnamed_addr #1 {
entry:
  ...
  %RAX.i38 = getelementptr inbounds %union.anon, %union.anon* %40, i64 0, i32 0
  store i64 ptrtoint (%G__0xb7df8c_type* @G__0xb7df8c to i64), i64* %RAX.i38, align 8
  %R8.i36 = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 17, i32 0, i32 0
  ...
  %R9D.i34 = bitcast %union.anon* %41 to i32*
  ...
  %69 = load i32, i32* %R9D.i34, align 4
  ...
  %99 = load i64, i64* %R8.i36, align 8
  %100 = load i64, i64* %RAX.i38, align 8
  %101 = select i1 %91, i64 %99, i64 %100
  store i64 %101, i64* %RAX.i38, align 8
  %RSI.i = getelementptr inbounds %union.anon, %union.anon* %48, i64 0, i32 0
  %102 = add i64 %70, -8
  %103 = add i64 %72, 15
  ...
  store i64 %106, i64* %RSI.i, align 8
  %RDI.i = getelementptr inbounds %union.anon, %union.anon* %43, i64 0, i32 0
  store i64 %101, i64* %RDI.i, align 8
  %107 = add i64 %72, -707998
  %108 = add i64 %72, 23
  ...
  %call2_4d8000 = tail call %struct.Memory* @sub_42b250.whose_territory(%struct.State* %0, i64 %107, %struct.Memory* %2)
  %EAX.i = bitcast %union.anon* %40 to i32*
  %112 = load i32, i32* %EAX.i, align 4
  ...
  %120 = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 21, i32 0
  %R10B.i11 = bitcast %union.anon* %120 to i8*
  %121 = zext i1 %119 to i8
  store i8 %121, i8* %R10B.i11, align 1
  %122 = zext i1 %119 to i64
  store i64 %122, i64* %RAX.i38, align 8
  ...
  ret %struct.Memory* %call2_4d8000
}
