...
define %struct.Memory* @autohelperpat923(%struct.State* noalias, i64, %struct.Memory* noalias readnone) local_unnamed_addr #1 {
entry:
  ...
  br i1 %171, label %block_4d80a0, label %block_.L_4d80bc

block_4d80a0:                                     ; preds = %entry
  %176 = add i64 %160, -28
  %177 = add i64 %175, 3
  ...
  %call2_4d80a3 = tail call %struct.Memory* @sub_40f780.countlib(%struct.State* nonnull %0, i64 %181, %struct.Memory* %2)
...
block_.L_4d80bc:                                  ; preds = %entry
  ...
  %call2_4d80c2 = tail call %struct.Memory* @sub_4352e0.add_replacement_move(%struct.State* nonnull %0, i64 %213, %struct.Memory* %2)
...
block_.L_4d80ce:                                  ; preds = %block_.L_4d80bc, %block_4d80a0
  %223 = phi i64 [ %.pre, %block_.L_4d80bc ], [ %202, %block_4d80a0 ]
  %MEMORY.0 = phi %struct.Memory* [ %call2_4d80c2, %block_.L_4d80bc ], [ %call2_4d80a3, %block_4d80a0 ]
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_jne_.L_4d80bc(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i8* nocapture %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_jmpq_.L_4d80ce(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
