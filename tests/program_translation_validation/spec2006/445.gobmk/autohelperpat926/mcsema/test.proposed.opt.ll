...
define %struct.Memory* @autohelperpat926(%struct.State* noalias, i64, %struct.Memory* noalias readnone) local_unnamed_addr #1 {
entry:
  ...
  br i1 %171, label %block_4d81a0, label %block_.L_4d81c7
...
block_4d81a0:                                     ; preds = %entry
  ...
  %call2_4d81ba = tail call %struct.Memory* @sub_478110.play_attack_defend_n(%struct.State* nonnull %0, i64 %198, %struct.Memory* %2)
...
block_.L_4d81c7:                                  ; preds = %entry
  ...
  %call2_4d81cd = tail call %struct.Memory* @sub_4352e0.add_replacement_move(%struct.State* nonnull %0, i64 %221, %struct.Memory* %2)
...
block_.L_4d81d9:                                  ; preds = %block_.L_4d81c7, %block_4d81a0
  %231 = phi i64 [ %.pre, %block_.L_4d81c7 ], [ %210, %block_4d81a0 ]
  %MEMORY.0 = phi %struct.Memory* [ %call2_4d81cd, %block_.L_4d81c7 ], [ %call2_4d81ba, %block_4d81a0 ]
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_jne_.L_4d81c7(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i8* nocapture %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_jmpq_.L_4d81d9(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
