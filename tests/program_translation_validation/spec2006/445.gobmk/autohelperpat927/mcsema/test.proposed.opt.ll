...
define %struct.Memory* @autohelperpat927(%struct.State* noalias, i64, %struct.Memory* noalias readnone) local_unnamed_addr #1 {
entry:
  ...
  %.v = select i1 %171, i64 10, i64 38
  %175 = add i64 %162, %.v
  store i64 %175, i64* %3, align 8
  %RDI.i = getelementptr inbounds %union.anon, %union.anon* %39, i64 0, i32 0
  br i1 %171, label %block_4d8230, label %block_.L_4d824c

block_4d8230:                                     ; preds = %entry
  %176 = add i64 %160, -28
  %177 = add i64 %175, 3
  ...
  %call2_4d8233 = tail call %struct.Memory* @sub_40f780.countlib(%struct.State* nonnull %0, i64 %181, %struct.Memory* %2)
  %EAX.i24 = bitcast %union.anon* %65 to i32*
  %186 = load i32, i32* %EAX.i24, align 4
  %187 = load i64, i64* %3, align 8
  %188 = icmp eq i32 %186, 2
  %189 = zext i1 %188 to i8
  %CL.i22 = bitcast %union.anon* %58 to i8*
  store i8 %189, i8* %CL.i22, align 1
  store i8 0, i8* %14, align 1
  ...
  store i8 0, i8* %38, align 1
  store i8 0, i8* %26, align 1
  %195 = zext i1 %188 to i64
  store i64 %195, i64* %RAX.i52, align 8
  ...
  br label %block_.L_4d825e

block_.L_4d824c:                                  ; preds = %entry
  %203 = add i64 %160, -24
  %204 = add i64 %175, 3
  ...
  store i64 %207, i64* %RDI.i, align 8
  ...
  %call2_4d8252 = tail call %struct.Memory* @sub_4352e0.add_replacement_move(%struct.State* nonnull %0, i64 %213, %struct.Memory* %2)
...
block_.L_4d825e:                                  ; preds = %block_.L_4d824c, %block_4d8230
  %223 = phi i64 [ %.pre, %block_.L_4d824c ], [ %202, %block_4d8230 ]
  %MEMORY.0 = phi %struct.Memory* [ %call2_4d8252, %block_.L_4d824c ], [ %call2_4d8233, %block_4d8230 ]
  ...
  store i64 %229, i64* %RAX.i52, align 8
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_jne_.L_4d824c(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i8* nocapture %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_jmpq_.L_4d825e(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
