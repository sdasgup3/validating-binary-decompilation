...
define %struct.Memory* @autohelperpat930(%struct.State* noalias, i64, %struct.Memory* noalias readnone returned) local_unnamed_addr #1 {
entry:
  ...
  %call2_4d840b = tail call %struct.Memory* @sub_4352e0.add_replacement_move(%struct.State* %0, i64 %124, %struct.Memory* %2)
  ...
  ret %struct.Memory* %call2_4d840b
}
