...
define %struct.Memory* @autohelperpat935(%struct.State* noalias, i64, %struct.Memory* noalias readnone) local_unnamed_addr #1 {
entry:
  ...
  %call2_4d8620 = tail call %struct.Memory* @sub_477170.defend_against(%struct.State* %0, i64 %224, %struct.Memory* %2)
  ...
  %cmpBr_4d8631 = icmp eq i8 %246, 1
  br i1 %cmpBr_4d8631, label %entry.block_.L_4d868c_crit_edge, label %block_4d8637

entry.block_.L_4d868c_crit_edge:                  ; preds = %entry
  %.pre2 = bitcast %union.anon* %65 to i8*
  br label %block_.L_4d868c

block_4d8637:                                     ; preds = %entry
  ...
  %call2_4d864c = tail call %struct.Memory* @sub_478110.play_attack_defend_n(%struct.State* nonnull %0, i64 %266, %struct.Memory* %call2_4d8620)
  ...
  br i1 %291, label %block_.L_4d868c, label %block_4d8663

block_4d8663:                                     ; preds = %block_4d8637
  store i64 1, i64* %RAX.i118, align 8
  ...
  %call2_4d8678 = tail call %struct.Memory* @sub_478110.play_attack_defend_n(%struct.State* nonnull %0, i64 %309, %struct.Memory* %call2_4d864c)
...
block_.L_4d868c:                                  ; preds = %entry.block_.L_4d868c_crit_edge, %block_4d8663, %block_4d8637
  %AL.i9.pre-phi = phi i8* [ %.pre2, %entry.block_.L_4d868c_crit_edge ], [ %AL.i45, %block_4d8663 ], [ %AL.i45, %block_4d8637 ]
  %329 = phi i64 [ %248, %entry.block_.L_4d868c_crit_edge ], [ %.pre, %block_4d8663 ], [ %288, %block_4d8637 ]
  %MEMORY.0 = phi %struct.Memory* [ %call2_4d8620, %entry.block_.L_4d868c_crit_edge ], [ %call2_4d8678, %block_4d8663 ], [ %call2_4d864c, %block_4d8637 ]
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_je_.L_4d868c(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i8* nocapture %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_jne_.L_4d868c(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i8* nocapture %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 2, i32 7
