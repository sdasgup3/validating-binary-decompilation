...
define %struct.Memory* @autohelperpat950(%struct.State* noalias, i64, %struct.Memory* noalias readnone) local_unnamed_addr #1 {
entry:
  ...
  %call2_4d8fe1 = tail call %struct.Memory* @sub_4784b0.play_attack_defend2_n(%struct.State* %0, i64 %341, %struct.Memory* %2)
...
block_4d8ff6:                                     ; preds = %entry
  ...
  %call2_4d9028 = tail call %struct.Memory* @sub_4784b0.play_attack_defend2_n(%struct.State* nonnull %0, i64 %412, %struct.Memory* %call2_4d8fe1)
...
block_.L_4d9036:                                  ; preds = %block_4d8ff6, %entry
  %434 = phi i64 [ %364, %entry ], [ %.pre, %block_4d8ff6 ]
  %MEMORY.0 = phi %struct.Memory* [ %call2_4d8fe1, %entry ], [ %call2_4d9028, %block_4d8ff6 ]
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_je_.L_4d9036(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i8* nocapture %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
