...
define %struct.Memory* @autohelperpat953(%struct.State* noalias, i64, %struct.Memory* noalias readnone returned) local_unnamed_addr #1 {
entry:
  ...
  %call2_4d92de = tail call %struct.Memory* @sub_4784b0.play_attack_defend2_n(%struct.State* %0, i64 %287, %struct.Memory* %2)
  ...
  ret %struct.Memory* %call2_4d92de
}
