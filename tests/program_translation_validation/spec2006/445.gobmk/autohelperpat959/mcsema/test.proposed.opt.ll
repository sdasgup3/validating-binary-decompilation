...
define %struct.Memory* @autohelperpat959(%struct.State* noalias, i64, %struct.Memory* noalias readnone returned) local_unnamed_addr #1 {
entry:
  ...
  store i64 %238, i64* %RSI.i31, align 8
  %239 = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 21, i32 0
  %R10D.i28 = bitcast %union.anon* %239 to i32*
  %240 = getelementptr inbounds %union.anon, %union.anon* %239, i64 0, i32 0
  %241 = add i64 %210, 24
  ...
  %call2_4d96d9 = tail call %struct.Memory* @sub_477ce0.play_break_through_n(%struct.State* %0, i64 %266, %struct.Memory* %2)
  ...
  ret %struct.Memory* %call2_4d96d9
}
