...
define %struct.Memory* @autohelperpat96(%struct.State* noalias, i64, %struct.Memory* noalias readnone) local_unnamed_addr #1 {
entry:
  ...
  %R8B.i66 = bitcast %union.anon* %19 to i8*
  ...
  %R10.i53 = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 21, i32 0, i32 0
  ...
  store i64 %52, i64* %R10.i53, align 8
  %53 = shl nsw i64 %52, 2
  %54 = add nsw i64 %53, 11903568
  %55 = add i64 %48, 12
  store i64 %55, i64* %3, align 8
  %56 = inttoptr i64 %54 to i32*
  %57 = load i32, i32* %56, align 4
  %58 = zext i32 %57 to i64
  store i64 %58, i64* %RAX.i69, align 8
  %59 = add i64 %46, -8
  %60 = add i64 %48, 15
  ...
  store i64 %64, i64* %RAX.i69, align 8
  ...
  store i64 %99, i64* %R10.i53, align 8
  %100 = shl nsw i64 %99, 2
  %101 = add nsw i64 %100, 11904784
  %102 = add i64 %95, 12
  store i64 %102, i64* %3, align 8
  %103 = inttoptr i64 %101 to i32*
  %104 = load i32, i32* %103, align 4
  %105 = zext i32 %104 to i64
  store i64 %105, i64* %RAX.i69, align 8
  %106 = add i64 %93, -8
  %107 = add i64 %95, 15
  ...
  store i64 %111, i64* %RAX.i69, align 8
  %112 = icmp ult i32 %110, %104
  ...
  %147 = mul nsw i64 %146, 76
  store i64 %147, i64* %R10.i53, align 8
  %148 = lshr i64 %147, 63
  %149 = load i64, i64* %R9.i63, align 8
  %150 = add i64 %147, %149
  store i64 %150, i64* %R9.i63, align 8
  ...
  store i8 0, i8* %17, align 1
  %189 = add i64 %140, -25
  %190 = load i8, i8* %R8B.i66, align 1
  %191 = add i64 %142, 20
  ...
  %.v = select i1 %195, i64 23, i64 6
  %196 = add i64 %193, %.v
  store i64 %196, i64* %3, align 8
  %cmpBr_4c997b = icmp eq i8 %194, 1
...
block_4c9981:                                     ; preds = %entry
  ...
  store i64 %202, i64* %RDI.i, align 8
  %203 = add i64 %196, -762369
  %204 = add i64 %196, 8
  ...
  %call2_4c9984 = tail call %struct.Memory* @sub_40f780.countlib(%struct.State* nonnull %0, i64 %203, %struct.Memory* %2)
  %208 = load i32, i32* %EAX.i68, align 4
  %209 = load i64, i64* %3, align 8
  %210 = add i32 %208, -2
  %211 = icmp ult i32 %208, 2
  ...
  %CL.i14 = bitcast %union.anon* %39 to i8*
  %231 = icmp ne i8 %225, 0
  %232 = xor i1 %231, %229
  %.demorgan = or i1 %222, %232
  %233 = xor i1 %.demorgan, true
  %234 = zext i1 %233 to i8
  store i8 %234, i8* %CL.i14, align 1
...
block_.L_4c9992:                                  ; preds = %block_4c9981, %entry
  %239 = phi i64 [ %196, %entry ], [ %.pre, %block_4c9981 ]
  %MEMORY.0 = phi %struct.Memory* [ %2, %entry ], [ %call2_4c9984, %block_4c9981 ]
  ...
  store i64 %246, i64* %RAX.i69, align 8
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_je_.L_4c9992(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i8* nocapture %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
