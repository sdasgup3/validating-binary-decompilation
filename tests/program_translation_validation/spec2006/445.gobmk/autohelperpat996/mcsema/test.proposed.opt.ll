...
define %struct.Memory* @autohelperpat996(%struct.State* noalias, i64, %struct.Memory* noalias readnone) local_unnamed_addr #1 {
entry:
  ...
  %call2_4db9fb = tail call %struct.Memory* @sub_40f780.countlib(%struct.State* %0, i64 %262, %struct.Memory* %2)
  ...
  %R8B.i58 = bitcast %union.anon* %268 to i8*
  store i8 0, i8* %R8B.i58, align 1
  %EAX.i55 = bitcast %union.anon* %66 to i32*
  %269 = load i32, i32* %EAX.i55, align 4
  %270 = add i32 %269, -1
  ...
  br i1 %305, label %block_.L_4dba58, label %block_4dba12

block_4dba12:                                     ; preds = %entry
  ...
  store i64 %312, i64* %RDI.i62, align 8
  %313 = add i64 %306, -836242
  %314 = add i64 %306, 8
  ...
  %call2_4dba15 = tail call %struct.Memory* @sub_40f780.countlib(%struct.State* nonnull %0, i64 %313, %struct.Memory* %call2_4db9fb)
  %318 = load i64, i64* %3, align 8
  store i64 0, i64* %RDI.i62, align 8
  store i8 0, i8* %CL.i57, align 1
  %319 = load i32, i32* %EAX.i55, align 4
  %320 = add i32 %319, -1
  ...
  %346 = add i64 %345, 51
  %347 = add i64 %345, 6
  %348 = load i8, i8* %30, align 1
  %349 = icmp ne i8 %348, 0
  %350 = load i8, i8* %33, align 1
  %351 = icmp ne i8 %350, 0
  %352 = load i8, i8* %39, align 1
  %353 = icmp ne i8 %352, 0
  %354 = xor i1 %351, %353
  %355 = or i1 %349, %354
  %356 = select i1 %355, i64 %346, i64 %347
  store i64 %356, i64* %3, align 8
  br i1 %355, label %block_.L_4dba58, label %block_4dba2b

block_4dba2b:                                     ; preds = %block_4dba12
  ...
  store i64 %362, i64* %RDI.i62, align 8
  %363 = add i64 %356, -836267
  %364 = add i64 %356, 8
  ...
  %call2_4dba2e = tail call %struct.Memory* @sub_40f780.countlib(%struct.State* nonnull %0, i64 %363, %struct.Memory* %call2_4dba15)
  %368 = load i64, i64* %3, align 8
  store i8 1, i8* %CL.i57, align 1
  %369 = load i32, i32* %EAX.i55, align 4
  %370 = add i32 %369, -2
  %371 = icmp ult i32 %369, 2
  ...
  %.v = select i1 %397, i64 23, i64 6
  %398 = add i64 %395, %.v
  store i64 %398, i64* %3, align 8
  %cmpBr_4dba3b = icmp eq i8 %396, 1
  br i1 %cmpBr_4dba3b, label %block_.L_4dba52, label %block_4dba41

block_4dba41:                                     ; preds = %block_4dba2b
  ...
  store i64 %404, i64* %RDI.i62, align 8
  %405 = add i64 %398, -836289
  %406 = add i64 %398, 8
  ...
  %call2_4dba44 = tail call %struct.Memory* @sub_40f780.countlib(%struct.State* nonnull %0, i64 %405, %struct.Memory* %call2_4dba2e)
  %410 = load i32, i32* %EAX.i55, align 4
  %411 = load i64, i64* %3, align 8
  %412 = add i32 %410, -2
  %413 = icmp ult i32 %410, 2
  ...
  store i8 %425, i8* %CL.i57, align 1
  %433 = load i64, i64* %RBP.i, align 8
  %434 = add i64 %433, -34
  %435 = add i64 %411, 9
  store i64 %435, i64* %3, align 8
  %436 = inttoptr i64 %434 to i8*
  store i8 %425, i8* %436, align 1
  %.pre = load i64, i64* %3, align 8
  br label %block_.L_4dba52

block_.L_4dba52:                                  ; preds = %block_4dba41, %block_4dba2b
  %437 = phi i64 [ %398, %block_4dba2b ], [ %.pre, %block_4dba41 ]
  %MEMORY.0 = phi %struct.Memory* [ %call2_4dba2e, %block_4dba2b ], [ %call2_4dba44, %block_4dba41 ]
  ...
  store i8 %442, i8* %AL.i15, align 1
  %443 = add i64 %438, -33
  %444 = add i64 %437, 6
...
block_.L_4dba58:                                  ; preds = %block_.L_4dba52, %block_4dba12, %entry
  %446 = phi i64 [ %296, %entry ], [ %346, %block_4dba12 ], [ %.pre3, %block_.L_4dba52 ]
  %MEMORY.1 = phi %struct.Memory* [ %call2_4db9fb, %entry ], [ %call2_4dba15, %block_4dba12 ], [ %MEMORY.0, %block_.L_4dba52 ]
  ...
  store i64 %453, i64* %RAX.i110, align 8
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_jle_.L_4dba58(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i8* nocapture %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_je_.L_4dba52(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i8* nocapture %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 2, i32 7
