...
define %struct.Memory* @change_attack_threat(%struct.State* noalias, i64, %struct.Memory* noalias readnone returned) local_unnamed_addr #1 {
entry:
  ...
  %153 = mul nsw i64 %152, 380
  %154 = load i64, i64* %RAX.i62, align 8
  %155 = add i64 %153, %154
  %156 = lshr i64 %155, 63
  %157 = add i64 %155, 260
  store i64 %157, i64* %RAX.i62, align 8
  %158 = icmp ugt i64 %155, -261
  ...
  store i64 %157, i64* %R8.i48, align 8
  %179 = add i64 %103, -4963
  %180 = add i64 %103, 64
  ...
  %call2_48a6be = tail call %struct.Memory* @sub_489320.change_tactical_point(%struct.State* %0, i64 %179, %struct.Memory* %2)
  ...
  ret %struct.Memory* %call2_48a6be
}
...
; Function Attrs: nounwind
define %struct.Memory* @routine_addq__0x104___rax(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned) local_unnamed_addr #3 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %RAX = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 1, i32 0, i32 0
  %3 = load i64, i64* %RAX, align 8
