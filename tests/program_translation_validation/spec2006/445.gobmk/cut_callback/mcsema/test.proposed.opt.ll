...
define %struct.Memory* @cut_callback(%struct.State* noalias, i64, %struct.Memory* noalias readnone) local_unnamed_addr #1 {
entry:
  ...
  br i1 %82, label %block_.L_4a5ee5, label %block_4a5ecf
...
block_4a5ecf:                                     ; preds = %entry
  ...
  %call2_4a5ee0 = tail call %struct.Memory* @sub_4a5ef0.cut_connect_callback(%struct.State* nonnull %0, i64 %107, %struct.Memory* %2)
  %.pre = load i64, i64* %3, align 8
  br label %block_.L_4a5ee5

block_.L_4a5ee5:                                  ; preds = %block_4a5ecf, %entry
  %112 = phi i64 [ %85, %entry ], [ %.pre, %block_4a5ecf ]
  %MEMORY.0 = phi %struct.Memory* [ %2, %entry ], [ %call2_4a5ee0, %block_4a5ecf ]
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_je_.L_4a5ee5(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i8* nocapture %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
