...
define %struct.Memory* @decrease_depth_values(%struct.State* noalias, i64, %struct.Memory* noalias readnone returned) local_unnamed_addr #0 {
entry:
  ...
  %call2_4774c9 = tail call %struct.Memory* @sub_4774d0.modify_depth_values(%struct.State* %0, i64 %11, %struct.Memory* %2)
  ...
  ret %struct.Memory* %call2_4774c9
}
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_movl__0xffffffff___edi(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned) local_unnamed_addr #1 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
