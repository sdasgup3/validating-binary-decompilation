...
define %struct.Memory* @defense_move_known(%struct.State* noalias, i64, %struct.Memory* noalias) #2 {
entry:
  ...
  store %struct.Memory* %loadMem_4899a0, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_4899a1, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_4899a4, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_4899a8, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_4899ad, %struct.Memory** %MEMORY
  ...
  store i32 %94, i32* %98
  store %struct.Memory* %loadMem_4899b7, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_4899ba, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_4899bd, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_4899c4, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_4899cb, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_4899d1, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_4899d8, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_4899dc, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_4899e3, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_4899e6, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_4899ed, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_4899ef, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem1_4899f2, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_4899f7, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_4899fc, %struct.Memory** %MEMORY
  ret %struct.Memory* %loadMem_4899fc
}
...
define %struct.Memory* @routine_addq__0xb4___rcx(%struct.State* dereferenceable(3376), i64, %struct.Memory*) {
block_400488:
  %3 = getelementptr inbounds %struct.State, %struct.State* %0, i32 0, i32 6
  %4 = getelementptr inbounds %struct.GPR, %struct.GPR* %3, i32 0, i32 33
  %5 = getelementptr inbounds %struct.Reg, %struct.Reg* %4, i32 0, i32 0
