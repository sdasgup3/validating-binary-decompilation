...
define %struct.Memory* @defense_threat_move_known(%struct.State* noalias, i64, %struct.Memory* noalias) #2 {
entry:
  ...
  store %struct.Memory* %loadMem_48a730, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_48a731, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_48a734, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_48a738, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_48a73d, %struct.Memory** %MEMORY
  ...
  store i32 %94, i32* %98
  store %struct.Memory* %loadMem_48a747, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_48a74a, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_48a74d, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_48a750, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_48a754, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_48a75b, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_48a75e, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_48a761, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_48a768, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_48a76c, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_48a773, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_48a776, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_48a77d, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_48a77f, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem1_48a782, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_48a787, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_48a78b, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_48a78c, %struct.Memory** %MEMORY
  ret %struct.Memory* %loadMem_48a78c
}
...
define %struct.Memory* @routine_addq__0x154___rcx(%struct.State* dereferenceable(3376), i64, %struct.Memory*) {
block_400488:
  %3 = getelementptr inbounds %struct.State, %struct.State* %0, i32 0, i32 6
  %4 = getelementptr inbounds %struct.GPR, %struct.GPR* %3, i32 0, i32 33
  %5 = getelementptr inbounds %struct.Reg, %struct.Reg* %4, i32 0, i32 0
