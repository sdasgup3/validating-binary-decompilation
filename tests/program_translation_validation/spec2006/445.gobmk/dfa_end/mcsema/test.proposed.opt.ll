...
@G_0xaf345c = local_unnamed_addr global %G_0xaf345c_type zeroinitializer
...
declare %struct.Memory* @sub_4a7430.kill_dfa(%struct.State* noalias dereferenceable(3376), i64, %struct.Memory* noalias readnone returned) local_unnamed_addr

; Function Attrs: alwaysinline
define %struct.Memory* @dfa_end(%struct.State* noalias, i64, %struct.Memory* noalias) local_unnamed_addr #1 {
entry:
  ...
  %18 = load i32, i32* bitcast (%G_0xaf3458_type* @G_0xaf3458 to i32*), align 8
  %19 = add i32 %18, -1
  %20 = icmp eq i32 %18, 0
  %21 = zext i1 %20 to i8
  ...
  %41 = xor i1 %40, %38
  %42 = or i1 %31, %41
  %.v = select i1 %42, i64 49, i64 21
  %43 = add i64 %10, %.v
  store i64 %43, i64* %3, align 8
  br i1 %42, label %entry.block_.L_4a7c22_crit_edge, label %block_4a7c06

entry.block_.L_4a7c22_crit_edge:                  ; preds = %entry
  %.pre5 = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 11, i32 0, i32 0
...
block_4a7c06:                                     ; preds = %entry
  ...
  %50 = tail call %struct.Memory* @__remill_function_call(%struct.State* nonnull %0, i64 ptrtoint (i64 (i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64)* @fprintf to i64), %struct.Memory* %2)
  %EAX.i39 = bitcast %union.anon* %45 to i32*
  %51 = load i64, i64* %RBP.i, align 8
  %52 = add i64 %51, -8
  %53 = load i32, i32* %EAX.i39, align 4
...
block_.L_4a7c22:                                  ; preds = %entry.block_.L_4a7c22_crit_edge, %block_4a7c06
  %RDI.i23.pre-phi = phi i64* [ %.pre5, %entry.block_.L_4a7c22_crit_edge ], [ %RDI.i47, %block_4a7c06 ]
  %57 = phi i64 [ %43, %entry.block_.L_4a7c22_crit_edge ], [ %.pre2, %block_4a7c06 ]
  %58 = phi i64 [ %8, %entry.block_.L_4a7c22_crit_edge ], [ %.pre, %block_4a7c06 ]
  %MEMORY.0 = phi %struct.Memory* [ %2, %entry.block_.L_4a7c22_crit_edge ], [ %50, %block_4a7c06 ]
  %59 = add i64 %58, -4
  %60 = add i64 %57, 7
...
block_.L_4a7c29:                                  ; preds = %block_4a7c33, %block_.L_4a7c22
  %62 = phi i64 [ %158, %block_4a7c33 ], [ %.pre3, %block_.L_4a7c22 ]
  ...
  %89 = icmp ne i8 %83, 0
  %90 = xor i1 %89, %87
  %.v7 = select i1 %90, i64 10, i64 53
  %91 = add i64 %62, %.v7
  store i64 %91, i64* %3, align 8
  br i1 %90, label %block_4a7c33, label %block_.L_4a7c5e
...
block_4a7c33:                                     ; preds = %block_.L_4a7c29
  ...
  %95 = mul nsw i64 %94, 120
  store i64 %95, i64* %RCX.i29, align 8
  %96 = lshr i64 %95, 63
  %97 = add i64 %95, ptrtoint (%G__0xaf3460_type* @G__0xaf3460 to i64)
  store i64 %97, i64* %RAX.i32, align 8
  %98 = icmp ult i64 %97, ptrtoint (%G__0xaf3460_type* @G__0xaf3460 to i64)
  ...
  %108 = xor i64 %95, ptrtoint (%G__0xaf3460_type* @G__0xaf3460 to i64)
  %109 = xor i64 %108, %97
  %110 = lshr i64 %109, 4
  ...
  %117 = xor i64 %115, lshr (i64 ptrtoint (%G__0xaf3460_type* @G__0xaf3460 to i64), i64 63)
  %118 = xor i64 %115, %96
  %119 = add nuw nsw i64 %117, %118
  %120 = icmp eq i64 %119, 2
  %121 = zext i1 %120 to i8
  store i8 %121, i8* %17, align 1
  store i64 %97, i64* %RDI.i23.pre-phi, align 8
  %122 = add i64 %91, -2051
  %123 = add i64 %91, 29
  ...
  %call2_4a7c4b = tail call %struct.Memory* @sub_4a7430.kill_dfa(%struct.State* nonnull %0, i64 %122, %struct.Memory* %MEMORY.0)
  ...
  store i64 %134, i64* %RAX.i32, align 8
...
block_.L_4a7c5e:                                  ; preds = %block_.L_4a7c29
  store i64 ptrtoint (%G__0xaf43d8_type* @G__0xaf43d8 to i64), i64* %RDI.i23.pre-phi, align 8
  %159 = add i64 %91, -2094
  %160 = add i64 %91, 15
  ...
  %call2_4a7c68 = tail call %struct.Memory* @sub_4a7430.kill_dfa(%struct.State* nonnull %0, i64 %159, %struct.Memory* %MEMORY.0)
  %164 = load i64, i64* %3, align 8
  %165 = load i32, i32* bitcast (%G_0xaf345c_type* @G_0xaf345c to i32*), align 8
  %166 = add i32 %165, -1
  %167 = zext i32 %166 to i64
  store i64 %167, i64* %RAX.i32, align 8
  store i32 %166, i32* bitcast (%G_0xaf345c_type* @G_0xaf345c to i32*), align 8
  %168 = load i64, i64* %6, align 8
  %169 = add i64 %168, 16
  store i64 %169, i64* %6, align 8
  %170 = icmp ugt i64 %168, -17
  ...
  ret %struct.Memory* %call2_4a7c68
}
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_jle_.L_4a7c22(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i8* nocapture %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_movq__0x588a25___rsi(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_jge_.L_4a7c5e(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i8* nocapture %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_callq_.kill_dfa(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_jmpq_.L_4a7c29(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_movq__0xaf43d8___rdi(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %RDI = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 11, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_movl_0xaf345c___eax(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %RAX = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 1, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, 7
  store i64 %4, i64* %PC, align 8
  %5 = load i32, i32* bitcast (%G_0xaf345c_type* @G_0xaf345c to i32*), align 8
  %6 = zext i32 %5 to i64
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_movl__eax__0xaf345c(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 1, i32 0
  %EAX = bitcast %union.anon* %3 to i32*
  ...
  %6 = add i64 %5, 7
  store i64 %6, i64* %PC, align 8
  store i32 %4, i32* bitcast (%G_0xaf345c_type* @G_0xaf345c to i32*), align 8
  ret %struct.Memory* %2
}
