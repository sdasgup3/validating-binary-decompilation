...
define %struct.Memory* @does_secure(%struct.State* noalias, i64, %struct.Memory* noalias readnone) local_unnamed_addr #1 {
entry:
  ...
  %call2_45d7af = tail call %struct.Memory* @sub_408e30.trymove(%struct.State* %0, i64 %60, %struct.Memory* %2)
  ...
  br i1 %72, label %block_.L_45d7e4, label %block_45d7bd
...
block_45d7bd:                                     ; preds = %entry
  ...
  %call2_45d7ca = tail call %struct.Memory* @sub_4142a0.is_self_atari(%struct.State* nonnull %0, i64 %108, %struct.Memory* %call2_45d7af)
  ...
  br i1 %120, label %block_.L_45d7df, label %block_45d7d8
...
block_.L_45d7df:                                  ; preds = %block_45d7d8, %block_45d7bd
  %129 = phi i64 [ %.pre, %block_45d7d8 ], [ %124, %block_45d7bd ]
  %130 = add i64 %129, -326271
  %131 = add i64 %129, 5
  ...
  %call2_45d7df = tail call %struct.Memory* @sub_40dd60.popgo(%struct.State* nonnull %0, i64 %130, %struct.Memory* %call2_45d7ca)
  %.pre2 = load i64, i64* %3, align 8
  br label %block_.L_45d7e4

block_.L_45d7e4:                                  ; preds = %block_.L_45d7df, %entry
  %135 = phi i64 [ %76, %entry ], [ %.pre2, %block_.L_45d7df ]
  %MEMORY.1 = phi %struct.Memory* [ %call2_45d7af, %entry ], [ %call2_45d7df, %block_.L_45d7df ]
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_je_.L_45d7e4(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i8* nocapture %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_je_.L_45d7df(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i8* nocapture %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 2, i32 7
