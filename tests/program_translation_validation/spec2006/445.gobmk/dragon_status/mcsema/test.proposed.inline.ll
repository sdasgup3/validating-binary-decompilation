...
define %struct.Memory* @dragon_status(%struct.State* noalias, i64, %struct.Memory* noalias) #2 {
entry:
  ...
  store %struct.Memory* %loadMem_4232e0, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_4232e4, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_4232f1, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_4232f9, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_4232fc, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_423300, %struct.Memory** %MEMORY
  ret %struct.Memory* %loadMem_423300
}
...
define %struct.Memory* @routine_movl_0x40__rax____eax(%struct.State* dereferenceable(3376), i64, %struct.Memory*) {
block_400488:
  %3 = getelementptr inbounds %struct.State, %struct.State* %0, i32 0, i32 6
  %4 = getelementptr inbounds %struct.GPR, %struct.GPR* %3, i32 0, i32 33
  %5 = getelementptr inbounds %struct.Reg, %struct.Reg* %4, i32 0, i32 0
