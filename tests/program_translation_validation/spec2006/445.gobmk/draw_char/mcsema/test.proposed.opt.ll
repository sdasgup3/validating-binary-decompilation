...
define %struct.Memory* @draw_char(%struct.State* noalias, i64, %struct.Memory* noalias readnone returned) local_unnamed_addr #1 {
entry:
  ...
  store i64 %43, i64* %RDI.i, align 8
  ...
  store i64 %48, i64* %RSI.i, align 8
  %RDX.i = getelementptr inbounds %union.anon, %union.anon* %30, i64 0, i32 0
  %49 = add i64 %37, -12
  %50 = add i64 %39, 9
  ...
  %call2_474d8c = tail call %struct.Memory* @sub_474a20.draw_color_char(%struct.State* %0, i64 %54, %struct.Memory* %2)
  ...
  ret %struct.Memory* %call2_474d8c
}
