...
@G__0x4a6960 = global %G__0x4a6960_type zeroinitializer
...
define %struct.Memory* @find_connections(%struct.State* noalias, i64, %struct.Memory* noalias) #2 {
entry:
  ...
  store %struct.Memory* %loadMem_4a6920, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_4a6921, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_4a6924, %struct.Memory** %MEMORY
  ...
  store i64 ptrtoint (%G__0x4a6960_type* @G__0x4a6960 to i64), i64* %RDI.i, align 8
  store %struct.Memory* %loadMem_4a6928, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_4a6932, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_4a6937, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_4a6941, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_4a6943, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_4a6945, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_4a6949, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem1_4a694d, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_4a6952, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_4a6956, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_4a6957, %struct.Memory** %MEMORY
  ret %struct.Memory* %loadMem_4a6957
}
...
define %struct.Memory* @routine_movq__0x4a6960___rdi(%struct.State* dereferenceable(3376), i64, %struct.Memory*) {
block_400488:
  %3 = getelementptr inbounds %struct.State, %struct.State* %0, i32 0, i32 6
  %4 = getelementptr inbounds %struct.GPR, %struct.GPR* %3, i32 0, i32 33
  %5 = getelementptr inbounds %struct.Reg, %struct.Reg* %4, i32 0, i32 0
  ...
  %10 = add i64 %9, 10
  store i64 %10, i64* %PC
  store i64 ptrtoint (%G__0x4a6960_type* @G__0x4a6960 to i64), i64* %RDI, align 8
  ret %struct.Memory* %2
}
