...
define %struct.Memory* @find_connections(%struct.State* noalias, i64, %struct.Memory* noalias readnone returned) local_unnamed_addr #1 {
entry:
  ...
  %call2_4a694d = tail call %struct.Memory* @sub_42fb50.matchpat(%struct.State* %0, i64 %27, %struct.Memory* %2)
  ...
  ret %struct.Memory* %call2_4a694d
}
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_movq__0x4a6960___rdi(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
