...
define %struct.Memory* @first_worm_in_dragon(%struct.State* noalias, i64, %struct.Memory* noalias) #2 {
entry:
  ...
  store %struct.Memory* %loadMem_420150, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_420151, %struct.Memory** %MEMORY
  %loadMem_420154 = load %struct.Memory*, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_420154, %struct.Memory** %MEMORY
  %loadMem_42015e = load %struct.Memory*, %struct.Memory** %MEMORY
  ...
  store i32 %48, i32* %52
  store %struct.Memory* %loadMem_42015e, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_420161, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_420165, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_420169, %struct.Memory** %MEMORY
  %loadMem_42016c = load %struct.Memory*, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_42016c, %struct.Memory** %MEMORY
  %loadMem_42016f = load %struct.Memory*, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_42016f, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_420170, %struct.Memory** %MEMORY
  ret %struct.Memory* %loadMem_420170
}
...
define %struct.Memory* @routine_movl_0x8__rax____eax(%struct.State* dereferenceable(3376), i64, %struct.Memory*) {
block_400488:
  %3 = getelementptr inbounds %struct.State, %struct.State* %0, i32 0, i32 6
  %4 = getelementptr inbounds %struct.GPR, %struct.GPR* %3, i32 0, i32 33
  %5 = getelementptr inbounds %struct.Reg, %struct.Reg* %4, i32 0, i32 0
