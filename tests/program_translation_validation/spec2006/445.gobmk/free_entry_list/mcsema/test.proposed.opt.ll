...
define %struct.Memory* @free_entry_list(%struct.State* noalias, i64, %struct.Memory* noalias) local_unnamed_addr #1 {
entry:
...
block_.L_4a882c:                                  ; preds = %block_4a8837, %entry
  %44 = phi i64 [ %.pre, %entry ], [ %90, %block_4a8837 ]
  %MEMORY.0 = phi %struct.Memory* [ %2, %entry ], [ %88, %block_4a8837 ]
  ...
  br i1 %56, label %block_.L_4a885c, label %block_4a8837
...
block_4a8837:                                     ; preds = %block_.L_4a882c
  ...
  store i64 %71, i64* %RAX.i26, align 8
  %72 = add i64 %71, 16
  %73 = add i64 %68, 8
  ...
  store i64 %82, i64* %RAX.i26, align 8
  store i64 %82, i64* %RDI.i32, align 8
  %83 = add i64 %79, -686267
  %84 = add i64 %79, 12
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_je_.L_4a885c(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i8* nocapture %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_jmpq_.L_4a882c(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
