...
define %struct.Memory* @gameinfo_clear(%struct.State* noalias, i64, %struct.Memory* noalias readnone returned) local_unnamed_addr #1 {
entry:
  ...
  %40 = add i64 %7, -16
  %41 = load i64, i64* %RDI.i39, align 8
  %42 = add i64 %10, 11
  ...
  store i64 %74, i64* %RDI.i39, align 8
  %75 = add i64 %70, -2270
  %76 = add i64 %70, 8
  ...
  %call2_42ed11 = tail call %struct.Memory* @sub_42e430.gnugo_clear_board(%struct.State* %0, i64 %75, %struct.Memory* %2)
  %80 = bitcast %union.VectorReg* %51 to i8*
  ...
  %87 = bitcast %union.VectorReg* %51 to i32*
  ...
  %call2_42ed1b = tail call %struct.Memory* @sub_42e4a0.gnugo_set_komi(%struct.State* %0, i64 %94, %struct.Memory* %call2_42ed11)
  ...
  store i64 %104, i64* %RAX.i20, align 8
  %105 = add i64 %104, 4
  %106 = add i64 %101, 11
  ...
  %114 = add i64 %113, 8
  store i64 %114, i64* %RAX.i20, align 8
  ...
  store i64 %114, i64* %RDI.i39, align 8
  %136 = add i64 %110, -174507
  %137 = add i64 %110, 16
  ...
  %call2_42ed36 = tail call %struct.Memory* @sub_404380.sgftree_clear(%struct.State* %0, i64 %136, %struct.Memory* %call2_42ed1b)
  ...
  store i64 %146, i64* %RAX.i20, align 8
  %147 = add i64 %146, 24
  %148 = add i64 %143, 11
  ...
  ret %struct.Memory* %call2_42ed36
}
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_movl__0x2__0x4__rax_(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %RAX = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 1, i32 0, i32 0
