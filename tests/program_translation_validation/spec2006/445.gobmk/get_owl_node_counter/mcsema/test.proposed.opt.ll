...
define %struct.Memory* @get_owl_node_counter(%struct.State* noalias nocapture, i64, %struct.Memory* noalias readnone returned) local_unnamed_addr #0 {
entry:
  ...
  %11 = load i32, i32* bitcast (%G_0xac22d4_type* @G_0xac22d4 to i32*), align 8
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_movl_0xac22d4___eax(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned) local_unnamed_addr #1 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
