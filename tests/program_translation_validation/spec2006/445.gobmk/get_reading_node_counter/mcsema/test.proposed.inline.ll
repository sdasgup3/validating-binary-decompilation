...
define %struct.Memory* @get_reading_node_counter(%struct.State* noalias, i64, %struct.Memory* noalias) #2 {
entry:
  ...
  store %struct.Memory* %loadMem_46c940, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_46c941, %struct.Memory** %MEMORY
  ...
  %37 = load i32, i32* bitcast (%G_0xae23a4_type* @G_0xae23a4 to i32*)
  %38 = zext i32 %37 to i64
  store i64 %38, i64* %RAX.i, align 8
  store %struct.Memory* %loadMem_46c944, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_46c94b, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_46c94c, %struct.Memory** %MEMORY
  ret %struct.Memory* %loadMem_46c94c
}
