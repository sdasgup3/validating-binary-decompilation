...
define %struct.Memory* @gfprintf(%struct.State* noalias, i64, %struct.Memory* noalias readnone returned) local_unnamed_addr #1 {
entry:
  ...
  %195 = add i64 %194, -360
  %196 = load i64, i64* %RDI.i109, align 8
  ...
  %R8.i105 = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 17, i32 0, i32 0
  %206 = load i64, i64* %RBP.i, align 8
  %207 = add i64 %206, -376
  %208 = load i64, i64* %R8.i105, align 8
  ...
  %213 = add i64 %212, -384
  %214 = load i64, i64* %RCX.i101, align 8
  ...
  %219 = add i64 %218, -392
  %220 = load i64, i64* %RDX.i98, align 8
  ...
  %225 = add i64 %224, -400
  %226 = load i64, i64* %RSI.i95, align 8
...
block_.L_4512e6:                                  ; preds = %block_451285, %entry
  %529 = phi i64 [ %.pre, %block_451285 ], [ %233, %entry ]
  %RAX.i59 = getelementptr inbounds %union.anon, %union.anon* %18, i64 0, i32 0
  ...
  store i64 %534, i64* %RAX.i59, align 8
  %535 = add i64 %530, -184
  %536 = add i64 %529, 14
  ...
  store i64 %543, i64* %RCX.i101, align 8
  %544 = add i64 %538, -192
  %545 = add i64 %540, 14
  ...
  store i64 %552, i64* %RDX.i98, align 8
  %553 = add i64 %547, -200
  %554 = add i64 %549, 14
  ...
  store i64 %561, i64* %RSI.i95, align 8
  %562 = add i64 %556, -208
  %563 = add i64 %558, 14
  ...
  store i64 %570, i64* %RDI.i109, align 8
  %571 = add i64 %565, -360
  %572 = add i64 %567, 14
  store i64 %572, i64* %3, align 8
  %573 = inttoptr i64 %571 to i64*
  %574 = load i64, i64* %573, align 8
  store i64 %574, i64* %R8.i105, align 8
  %575 = add i64 %565, -8
  %576 = add i64 %567, 18
  ...
  %579 = add i64 %578, -16
  %580 = load i64, i64* %RDI.i109, align 8
  ...
  store i64 %591, i64* %RDI.i109, align 8
  %593 = add i64 %590, -40
  %594 = add i64 %592, 8
  ...
  store i64 %615, i64* %RSI.i95, align 8
  %616 = add i64 %606, -48
  store i64 %616, i64* %RDX.i98, align 8
  %617 = add i64 %608, 27
  %618 = add i64 %608, 17
  ...
  %call2_451361 = tail call %struct.Memory* @sub_451370.vgprintf(%struct.State* nonnull %0, i64 %617, %struct.Memory* %2)
  %622 = load i64, i64* %6, align 8
  %623 = load i64, i64* %3, align 8
  %624 = add i64 %622, 400
  store i64 %624, i64* %6, align 8
  %625 = icmp ugt i64 %622, -401
  ...
  store i64 %650, i64* %RBP.i, align 8
  ...
  ret %struct.Memory* %call2_451361
}
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_je_.L_4512e6(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i8* nocapture %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_leaq_MINUS0xe0__rbp____rdi(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %RDI = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 11, i32 0, i32 0
  %RBP = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 15, i32 0, i32 0
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_leaq_0x10__rbp____rdi(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %RDI = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 11, i32 0, i32 0
  %RBP = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 15, i32 0, i32 0
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_movl__0x10__MINUS0x30__rbp_(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %RBP = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 15, i32 0, i32 0
  %3 = load i64, i64* %RBP, align 8
