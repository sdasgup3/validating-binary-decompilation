...
define %struct.Memory* @gg_gettimeofday(%struct.State* noalias, i64, %struct.Memory* noalias) #2 {
entry:
  ...
  store %struct.Memory* %loadMem_4e2660, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_4e2661, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_4e2664, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_4e2667, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_4e2668, %struct.Memory** %MEMORY
  ret %struct.Memory* %loadMem_4e2668
}
