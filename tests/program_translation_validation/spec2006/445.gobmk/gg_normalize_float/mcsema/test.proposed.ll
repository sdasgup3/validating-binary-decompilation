...
@G_0x8ec__rip_= global %G_0x8ec__rip__type <{ [8 x i8] c"\00\00\00\00\00\00\00\00" }>


define %struct.Memory* @gg_normalize_float(%struct.State* noalias , i64, %struct.Memory* noalias) alwaysinline  {
entry:
  ...
  ; Code: .gg_normalize_float:	 RIP: 4e2690	 Bytes: 0
  ; Code: pushq %rbp	 RIP: 4e2690	 Bytes: 1
  %loadMem_4e2690 = load %struct.Memory*, %struct.Memory** %MEMORY
  %call_4e2690 = call %struct.Memory* @routine_pushq__rbp(%struct.State* %0, i64  0, %struct.Memory* %loadMem_4e2690)
  store %struct.Memory* %call_4e2690, %struct.Memory** %MEMORY

  ; Code: movq %rsp, %rbp	 RIP: 4e2691	 Bytes: 3
  %loadMem_4e2691 = load %struct.Memory*, %struct.Memory** %MEMORY
  %call_4e2691 = call %struct.Memory* @routine_movq__rsp___rbp(%struct.State* %0, i64  0, %struct.Memory* %loadMem_4e2691)
  store %struct.Memory* %call_4e2691, %struct.Memory** %MEMORY

  ; Code: movsd 0x8ec(%rip), %xmm2	 RIP: 4e2694	 Bytes: 8
  %loadMem_4e2694 = load %struct.Memory*, %struct.Memory** %MEMORY
  %call_4e2694 = call %struct.Memory* @routine_movsd_0x8ec__rip____xmm2(%struct.State* %0, i64  0, %struct.Memory* %loadMem_4e2694)
  store %struct.Memory* %call_4e2694, %struct.Memory** %MEMORY

  ; Code: movss %xmm0, -0x4(%rbp)	 RIP: 4e269c	 Bytes: 5
  %loadMem_4e269c = load %struct.Memory*, %struct.Memory** %MEMORY
  %call_4e269c = call %struct.Memory* @routine_movss__xmm0__MINUS0x4__rbp_(%struct.State* %0, i64  0, %struct.Memory* %loadMem_4e269c)
  store %struct.Memory* %call_4e269c, %struct.Memory** %MEMORY

  ; Code: movss %xmm1, -0x8(%rbp)	 RIP: 4e26a1	 Bytes: 5
  %loadMem_4e26a1 = load %struct.Memory*, %struct.Memory** %MEMORY
  %call_4e26a1 = call %struct.Memory* @routine_movss__xmm1__MINUS0x8__rbp_(%struct.State* %0, i64  0, %struct.Memory* %loadMem_4e26a1)
  store %struct.Memory* %call_4e26a1, %struct.Memory** %MEMORY

  ; Code: movss -0x8(%rbp), %xmm0	 RIP: 4e26a6	 Bytes: 5
  %loadMem_4e26a6 = load %struct.Memory*, %struct.Memory** %MEMORY
  %call_4e26a6 = call %struct.Memory* @routine_movss_MINUS0x8__rbp____xmm0(%struct.State* %0, i64  0, %struct.Memory* %loadMem_4e26a6)
  store %struct.Memory* %call_4e26a6, %struct.Memory** %MEMORY

  ; Code: movss -0x4(%rbp), %xmm1	 RIP: 4e26ab	 Bytes: 5
  %loadMem_4e26ab = load %struct.Memory*, %struct.Memory** %MEMORY
  %call_4e26ab = call %struct.Memory* @routine_movss_MINUS0x4__rbp____xmm1(%struct.State* %0, i64  0, %struct.Memory* %loadMem_4e26ab)
  store %struct.Memory* %call_4e26ab, %struct.Memory** %MEMORY

  ; Code: divss -0x8(%rbp), %xmm1	 RIP: 4e26b0	 Bytes: 5
  %loadMem_4e26b0 = load %struct.Memory*, %struct.Memory** %MEMORY
  %call_4e26b0 = call %struct.Memory* @routine_divss_MINUS0x8__rbp____xmm1(%struct.State* %0, i64  0, %struct.Memory* %loadMem_4e26b0)
  store %struct.Memory* %call_4e26b0, %struct.Memory** %MEMORY

  ; Code: cvtss2sd %xmm1, %xmm1	 RIP: 4e26b5	 Bytes: 4
  %loadMem_4e26b5 = load %struct.Memory*, %struct.Memory** %MEMORY
  %call_4e26b5 = call %struct.Memory* @routine_cvtss2sd__xmm1___xmm1(%struct.State* %0, i64  0, %struct.Memory* %loadMem_4e26b5)
  store %struct.Memory* %call_4e26b5, %struct.Memory** %MEMORY

  ; Code: addsd %xmm1, %xmm2	 RIP: 4e26b9	 Bytes: 4
  %loadMem_4e26b9 = load %struct.Memory*, %struct.Memory** %MEMORY
  %call_4e26b9 = call %struct.Memory* @routine_addsd__xmm1___xmm2(%struct.State* %0, i64  0, %struct.Memory* %loadMem_4e26b9)
  store %struct.Memory* %call_4e26b9, %struct.Memory** %MEMORY

  ; Code: cvttsd2si %xmm2, %eax	 RIP: 4e26bd	 Bytes: 4
  %loadMem_4e26bd = load %struct.Memory*, %struct.Memory** %MEMORY
  %call_4e26bd = call %struct.Memory* @routine_cvttsd2si__xmm2___eax(%struct.State* %0, i64  0, %struct.Memory* %loadMem_4e26bd)
  store %struct.Memory* %call_4e26bd, %struct.Memory** %MEMORY

  ; Code: cvtsi2ssl %eax, %xmm1	 RIP: 4e26c1	 Bytes: 4
  %loadMem_4e26c1 = load %struct.Memory*, %struct.Memory** %MEMORY
  %call_4e26c1 = call %struct.Memory* @routine_cvtsi2ssl__eax___xmm1(%struct.State* %0, i64  0, %struct.Memory* %loadMem_4e26c1)
  store %struct.Memory* %call_4e26c1, %struct.Memory** %MEMORY

  ; Code: mulss %xmm1, %xmm0	 RIP: 4e26c5	 Bytes: 4
  %loadMem_4e26c5 = load %struct.Memory*, %struct.Memory** %MEMORY
  %call_4e26c5 = call %struct.Memory* @routine_mulss__xmm1___xmm0(%struct.State* %0, i64  0, %struct.Memory* %loadMem_4e26c5)
  store %struct.Memory* %call_4e26c5, %struct.Memory** %MEMORY

  ; Code: popq %rbp	 RIP: 4e26c9	 Bytes: 1
  %loadMem_4e26c9 = load %struct.Memory*, %struct.Memory** %MEMORY
  %call_4e26c9 = call %struct.Memory* @routine_popq__rbp(%struct.State* %0, i64  0, %struct.Memory* %loadMem_4e26c9)
  store %struct.Memory* %call_4e26c9, %struct.Memory** %MEMORY

  ; Code: retq	 RIP: 4e26ca	 Bytes: 1
  %loadMem_4e26ca = load %struct.Memory*, %struct.Memory** %MEMORY
  %call_4e26ca = call %struct.Memory* @routine_retq(%struct.State* %0, i64  0, %struct.Memory* %loadMem_4e26ca)
  store %struct.Memory* %call_4e26ca, %struct.Memory** %MEMORY

  ret %struct.Memory* %call_4e26ca
}
...
define %struct.Memory* @routine_movsd_0x8ec__rip____xmm2(%struct.State*  dereferenceable(3376), i64, %struct.Memory* ) #19 {
block_400488:
  %3 = getelementptr inbounds %struct.State, %struct.State* %0, i32 0, i32 6
  %4 = getelementptr inbounds %struct.GPR, %struct.GPR* %3, i32 0, i32 33
  %5 = getelementptr inbounds %struct.Reg, %struct.Reg* %4, i32 0, i32 0
  ...
  %9 = load i64, i64* %PC
  %10 = add i64 %9, ptrtoint( %G_0x8ec__rip__type* @G_0x8ec__rip_ to i64)
  %11 = load i64, i64* %PC
  %12 = add i64 %11, 8
  store i64 %12, i64* %PC
...
define %struct.Memory* @routine_movss_MINUS0x4__rbp____xmm1(%struct.State*  dereferenceable(3376), i64, %struct.Memory* ) #19 {
block_400488:
  %3 = getelementptr inbounds %struct.State, %struct.State* %0, i32 0, i32 6
  %4 = getelementptr inbounds %struct.GPR, %struct.GPR* %3, i32 0, i32 33
  %5 = getelementptr inbounds %struct.Reg, %struct.Reg* %4, i32 0, i32 0
...
define %struct.Memory* @routine_divss_MINUS0x8__rbp____xmm1(%struct.State*  dereferenceable(3376), i64, %struct.Memory* ) #19 {
block_400488:
  %3 = getelementptr inbounds %struct.State, %struct.State* %0, i32 0, i32 6
  %4 = getelementptr inbounds %struct.GPR, %struct.GPR* %3, i32 0, i32 33
  %5 = getelementptr inbounds %struct.Reg, %struct.Reg* %4, i32 0, i32 0
