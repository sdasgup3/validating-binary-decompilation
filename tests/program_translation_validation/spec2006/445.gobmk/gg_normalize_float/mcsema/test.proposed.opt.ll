...
%G_0x8ec__rip__type = type <{ [8 x i8] }>
...
@G_0x8ec__rip_ = global %G_0x8ec__rip__type zeroinitializer
...
define %struct.Memory* @gg_normalize_float(%struct.State* noalias, i64, %struct.Memory* noalias readnone returned) local_unnamed_addr #1 {
entry:
  ...
  %13 = add i64 %10, add (i64 ptrtoint (%G_0x8ec__rip__type* @G_0x8ec__rip_ to i64), i64 3)
  %14 = add i64 %10, 11
  ...
  %23 = bitcast [32 x %union.VectorReg]* %11 to <2 x float>*
  %24 = load <2 x float>, <2 x float>* %23, align 1
  %25 = extractelement <2 x float> %24, i32 0
  %26 = inttoptr i64 %21 to float*
  ...
  %36 = bitcast [32 x %union.VectorReg]* %11 to i8*
  ...
  %43 = bitcast [32 x %union.VectorReg]* %11 to float*
  %44 = bitcast [32 x %union.VectorReg]* %11 to i32*
  ...
  %49 = getelementptr inbounds i8, i8* %36, i64 12
  %50 = bitcast i8* %49 to float*
  store float 0.000000e+00, float* %50, align 1
  %51 = bitcast %union.VectorReg* %27 to i8*
  %52 = add i64 %37, -4
  %53 = add i64 %39, 10
  store i64 %53, i64* %3, align 8
  %54 = inttoptr i64 %52 to i32*
  %55 = load i32, i32* %54, align 4
  %56 = bitcast %union.VectorReg* %27 to float*
  %57 = bitcast %union.VectorReg* %27 to i32*
  ...
  %65 = load <2 x float>, <2 x float>* %32, align 1
  %66 = bitcast i64* %60 to <2 x i32>*
  %67 = load <2 x i32>, <2 x i32>* %66, align 1
  %68 = inttoptr i64 %38 to float*
  %69 = load float, float* %68, align 4
  %70 = extractelement <2 x float> %65, i32 0
  %71 = fdiv float %70, %69
  store float %71, float* %56, align 1
  %72 = bitcast <2 x float> %65 to <2 x i32>
  %73 = extractelement <2 x i32> %72, i32 1
  %74 = bitcast i8* %58 to i32*
  store i32 %73, i32* %74, align 1
  %75 = extractelement <2 x i32> %67, i32 0
  %76 = bitcast i64* %60 to i32*
  store i32 %75, i32* %76, align 1
  %77 = extractelement <2 x i32> %67, i32 1
  %78 = bitcast i8* %62 to i32*
  store i32 %77, i32* %78, align 1
  %79 = load <2 x float>, <2 x float>* %32, align 1
  %80 = extractelement <2 x float> %79, i32 0
  %81 = fpext float %80 to double
  %82 = load double, double* %17, align 1
  %83 = fadd double %81, %82
  store double %83, double* %17, align 1
  %RAX.i = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 1, i32 0, i32 0
  %84 = tail call double @llvm.trunc.f64(double %83)
  %85 = tail call double @llvm.fabs.f64(double %84)
  %86 = fcmp ogt double %85, 0x41DFFFFFFFC00000
  %87 = fptosi double %84 to i32
  %88 = zext i32 %87 to i64
  %89 = select i1 %86, i64 2147483648, i64 %88
  store i64 %89, i64* %RAX.i, align 8
  %90 = trunc i64 %89 to i32
  %91 = bitcast double %81 to <2 x i32>
  %92 = load <2 x i32>, <2 x i32>* %66, align 1
  %93 = sitofp i32 %90 to float
  store float %93, float* %56, align 1
  %94 = extractelement <2 x i32> %91, i32 1
  store i32 %94, i32* %74, align 1
  %95 = extractelement <2 x i32> %92, i32 0
  store i32 %95, i32* %76, align 1
  %96 = extractelement <2 x i32> %92, i32 1
  store i32 %96, i32* %78, align 1
  %97 = load <2 x float>, <2 x float>* %23, align 1
  %98 = bitcast i64* %47 to <2 x i32>*
  %99 = load <2 x i32>, <2 x i32>* %98, align 1
  %100 = load <2 x float>, <2 x float>* %32, align 1
  %101 = extractelement <2 x float> %97, i32 0
  %102 = extractelement <2 x float> %100, i32 0
  %103 = fmul float %101, %102
  store float %103, float* %43, align 1
  %104 = bitcast <2 x float> %97 to <2 x i32>
  %105 = extractelement <2 x i32> %104, i32 1
  %106 = bitcast i8* %45 to i32*
  store i32 %105, i32* %106, align 1
  %107 = extractelement <2 x i32> %99, i32 0
  %108 = bitcast i64* %47 to i32*
  store i32 %107, i32* %108, align 1
  %109 = extractelement <2 x i32> %99, i32 1
  ...
  store i64 %115, i64* %RBP.i, align 8
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_movsd_0x8ec__rip____xmm2(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, ptrtoint (%G_0x8ec__rip__type* @G_0x8ec__rip_ to i64)
  %5 = add i64 %3, 8
  store i64 %5, i64* %PC, align 8
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_movss_MINUS0x4__rbp____xmm1(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %RBP = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 15, i32 0, i32 0
  %3 = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 1, i64 1
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_divss_MINUS0x8__rbp____xmm1(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %RBP = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 15, i32 0, i32 0
  %3 = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 1, i64 1
