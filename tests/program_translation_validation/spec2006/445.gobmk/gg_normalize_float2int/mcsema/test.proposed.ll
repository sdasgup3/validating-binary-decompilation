...
; Data Access Globals
%G_0x8ac__rip__type = type <{ [8 x i8] }>
@G_0x8ac__rip_= global %G_0x8ac__rip__type <{ [8 x i8] c"\00\00\00\00\00\00\00\00" }>


define %struct.Memory* @gg_normalize_float2int(%struct.State* noalias , i64, %struct.Memory* noalias) alwaysinline  {
entry:
  ...
  ; Code: .gg_normalize_float2int:	 RIP: 4e26d0	 Bytes: 0
  ; Code: pushq %rbp	 RIP: 4e26d0	 Bytes: 1
  %loadMem_4e26d0 = load %struct.Memory*, %struct.Memory** %MEMORY
  %call_4e26d0 = call %struct.Memory* @routine_pushq__rbp(%struct.State* %0, i64  0, %struct.Memory* %loadMem_4e26d0)
  store %struct.Memory* %call_4e26d0, %struct.Memory** %MEMORY

  ; Code: movq %rsp, %rbp	 RIP: 4e26d1	 Bytes: 3
  %loadMem_4e26d1 = load %struct.Memory*, %struct.Memory** %MEMORY
  %call_4e26d1 = call %struct.Memory* @routine_movq__rsp___rbp(%struct.State* %0, i64  0, %struct.Memory* %loadMem_4e26d1)
  store %struct.Memory* %call_4e26d1, %struct.Memory** %MEMORY

  ; Code: movsd 0x8ac(%rip), %xmm2	 RIP: 4e26d4	 Bytes: 8
  %loadMem_4e26d4 = load %struct.Memory*, %struct.Memory** %MEMORY
  %call_4e26d4 = call %struct.Memory* @routine_movsd_0x8ac__rip____xmm2(%struct.State* %0, i64  0, %struct.Memory* %loadMem_4e26d4)
  store %struct.Memory* %call_4e26d4, %struct.Memory** %MEMORY

  ; Code: movss %xmm0, -0x4(%rbp)	 RIP: 4e26dc	 Bytes: 5
  %loadMem_4e26dc = load %struct.Memory*, %struct.Memory** %MEMORY
  %call_4e26dc = call %struct.Memory* @routine_movss__xmm0__MINUS0x4__rbp_(%struct.State* %0, i64  0, %struct.Memory* %loadMem_4e26dc)
  store %struct.Memory* %call_4e26dc, %struct.Memory** %MEMORY

  ; Code: movss %xmm1, -0x8(%rbp)	 RIP: 4e26e1	 Bytes: 5
  %loadMem_4e26e1 = load %struct.Memory*, %struct.Memory** %MEMORY
  %call_4e26e1 = call %struct.Memory* @routine_movss__xmm1__MINUS0x8__rbp_(%struct.State* %0, i64  0, %struct.Memory* %loadMem_4e26e1)
  store %struct.Memory* %call_4e26e1, %struct.Memory** %MEMORY

  ; Code: movss -0x4(%rbp), %xmm0	 RIP: 4e26e6	 Bytes: 5
  %loadMem_4e26e6 = load %struct.Memory*, %struct.Memory** %MEMORY
  %call_4e26e6 = call %struct.Memory* @routine_movss_MINUS0x4__rbp____xmm0(%struct.State* %0, i64  0, %struct.Memory* %loadMem_4e26e6)
  store %struct.Memory* %call_4e26e6, %struct.Memory** %MEMORY

  ; Code: divss -0x8(%rbp), %xmm0	 RIP: 4e26eb	 Bytes: 5
  %loadMem_4e26eb = load %struct.Memory*, %struct.Memory** %MEMORY
  %call_4e26eb = call %struct.Memory* @routine_divss_MINUS0x8__rbp____xmm0(%struct.State* %0, i64  0, %struct.Memory* %loadMem_4e26eb)
  store %struct.Memory* %call_4e26eb, %struct.Memory** %MEMORY

  ; Code: cvtss2sd %xmm0, %xmm0	 RIP: 4e26f0	 Bytes: 4
  %loadMem_4e26f0 = load %struct.Memory*, %struct.Memory** %MEMORY
  %call_4e26f0 = call %struct.Memory* @routine_cvtss2sd__xmm0___xmm0(%struct.State* %0, i64  0, %struct.Memory* %loadMem_4e26f0)
  store %struct.Memory* %call_4e26f0, %struct.Memory** %MEMORY

  ; Code: addsd %xmm0, %xmm2	 RIP: 4e26f4	 Bytes: 4
  %loadMem_4e26f4 = load %struct.Memory*, %struct.Memory** %MEMORY
  %call_4e26f4 = call %struct.Memory* @routine_addsd__xmm0___xmm2(%struct.State* %0, i64  0, %struct.Memory* %loadMem_4e26f4)
  store %struct.Memory* %call_4e26f4, %struct.Memory** %MEMORY

  ; Code: cvttsd2si %xmm2, %eax	 RIP: 4e26f8	 Bytes: 4
  %loadMem_4e26f8 = load %struct.Memory*, %struct.Memory** %MEMORY
  %call_4e26f8 = call %struct.Memory* @routine_cvttsd2si__xmm2___eax(%struct.State* %0, i64  0, %struct.Memory* %loadMem_4e26f8)
  store %struct.Memory* %call_4e26f8, %struct.Memory** %MEMORY

  ; Code: popq %rbp	 RIP: 4e26fc	 Bytes: 1
  %loadMem_4e26fc = load %struct.Memory*, %struct.Memory** %MEMORY
  %call_4e26fc = call %struct.Memory* @routine_popq__rbp(%struct.State* %0, i64  0, %struct.Memory* %loadMem_4e26fc)
  store %struct.Memory* %call_4e26fc, %struct.Memory** %MEMORY

  ; Code: retq	 RIP: 4e26fd	 Bytes: 1
  %loadMem_4e26fd = load %struct.Memory*, %struct.Memory** %MEMORY
  %call_4e26fd = call %struct.Memory* @routine_retq(%struct.State* %0, i64  0, %struct.Memory* %loadMem_4e26fd)
  store %struct.Memory* %call_4e26fd, %struct.Memory** %MEMORY

  ret %struct.Memory* %call_4e26fd
}
...
define %struct.Memory* @routine_movsd_0x8ac__rip____xmm2(%struct.State*  dereferenceable(3376), i64, %struct.Memory* ) #19 {
block_400488:
  %3 = getelementptr inbounds %struct.State, %struct.State* %0, i32 0, i32 6
  %4 = getelementptr inbounds %struct.GPR, %struct.GPR* %3, i32 0, i32 33
  %5 = getelementptr inbounds %struct.Reg, %struct.Reg* %4, i32 0, i32 0
  ...
  %9 = load i64, i64* %PC
  %10 = add i64 %9, ptrtoint( %G_0x8ac__rip__type* @G_0x8ac__rip_ to i64)
  %11 = load i64, i64* %PC
  %12 = add i64 %11, 8
  store i64 %12, i64* %PC
