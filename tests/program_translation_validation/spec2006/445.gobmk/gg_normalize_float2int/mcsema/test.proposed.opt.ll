...
@G_0x8ac__rip_ = global %G_0x8ac__rip__type zeroinitializer
...
define %struct.Memory* @gg_normalize_float2int(%struct.State* noalias, i64, %struct.Memory* noalias readnone returned) local_unnamed_addr #1 {
entry:
  ...
  %13 = add i64 %10, add (i64 ptrtoint (%G_0x8ac__rip__type* @G_0x8ac__rip_ to i64), i64 3)
  %14 = add i64 %10, 11
  ...
  %53 = load <2 x float>, <2 x float>* %23, align 1
  %54 = bitcast i64* %47 to <2 x i32>*
  %55 = load <2 x i32>, <2 x i32>* %54, align 1
  %56 = inttoptr i64 %51 to float*
  %57 = load float, float* %56, align 4
  %58 = extractelement <2 x float> %53, i32 0
  %59 = fdiv float %58, %57
  store float %59, float* %43, align 1
  %60 = bitcast <2 x float> %53 to <2 x i32>
  %61 = extractelement <2 x i32> %60, i32 1
  %62 = bitcast i8* %45 to i32*
  store i32 %61, i32* %62, align 1
  %63 = extractelement <2 x i32> %55, i32 0
  %64 = bitcast i64* %47 to i32*
  store i32 %63, i32* %64, align 1
  %65 = extractelement <2 x i32> %55, i32 1
  %66 = bitcast i8* %49 to i32*
  store i32 %65, i32* %66, align 1
  %67 = load <2 x float>, <2 x float>* %23, align 1
  %68 = extractelement <2 x float> %67, i32 0
  %69 = fpext float %68 to double
  %70 = bitcast [32 x %union.VectorReg]* %11 to double*
  store double %69, double* %70, align 1
  %71 = load double, double* %17, align 1
  %72 = fadd double %69, %71
  store double %72, double* %17, align 1
  %RAX.i = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 1, i32 0, i32 0
  %73 = tail call double @llvm.trunc.f64(double %72)
  %74 = tail call double @llvm.fabs.f64(double %73)
  %75 = fcmp ogt double %74, 0x41DFFFFFFFC00000
  %76 = fptosi double %73 to i32
  %77 = zext i32 %76 to i64
  %78 = select i1 %75, i64 2147483648, i64 %77
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_movsd_0x8ac__rip____xmm2(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, ptrtoint (%G_0x8ac__rip__type* @G_0x8ac__rip_ to i64)
  %5 = add i64 %3, 8
  store i64 %5, i64* %PC, align 8
