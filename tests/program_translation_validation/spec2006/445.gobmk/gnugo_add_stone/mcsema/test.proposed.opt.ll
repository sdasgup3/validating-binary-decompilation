...
define %struct.Memory* @gnugo_add_stone(%struct.State* noalias, i64, %struct.Memory* noalias readnone returned) local_unnamed_addr #1 {
entry:
  ...
  %call2_42e4e0 = tail call %struct.Memory* @sub_40df40.add_stone(%struct.State* %0, i64 %122, %struct.Memory* %2)
  ...
  ret %struct.Memory* %call2_42e4e0
}
