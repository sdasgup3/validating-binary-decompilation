...
define %struct.Memory* @gnugo_estimate_score(%struct.State* noalias, i64, %struct.Memory* noalias) #2 {
entry:
  ...
  %loadMem_42ebe1 = load %struct.Memory*, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_42ebe1, %struct.Memory** %MEMORY
  ...
  %loadMem_42ebe8 = load %struct.Memory*, %struct.Memory** %MEMORY
  ...
  store i64 %78, i64* %81
  store %struct.Memory* %loadMem_42ebe8, %struct.Memory** %MEMORY
  ...
  %loadMem_42ebf4 = load %struct.Memory*, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_42ebf4, %struct.Memory** %MEMORY
  %loadMem1_42ebf8 = load %struct.Memory*, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem1_42ebf8, %struct.Memory** %MEMORY
  %loadMem2_42ebf8 = load %struct.Memory*, %struct.Memory** %MEMORY
  %loadPC_42ebf8 = load i64, i64* %3
  %call2_42ebf8 = call %struct.Memory* @sub_46e0c0.estimate_score(%struct.State* %0, i64 %loadPC_42ebf8, %struct.Memory* %loadMem2_42ebf8)
  store %struct.Memory* %call2_42ebf8, %struct.Memory** %MEMORY
  %loadMem_42ebfd = load %struct.Memory*, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_42ebfd, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_42ec01, %struct.Memory** %MEMORY
  %loadMem_42ec02 = load %struct.Memory*, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_42ec02, %struct.Memory** %MEMORY
  ret %struct.Memory* %loadMem_42ec02
}
