...
define %struct.Memory* @gnugo_estimate_score(%struct.State* noalias, i64, %struct.Memory* noalias readnone returned) local_unnamed_addr #1 {
entry:
  ...
  %call2_42ebf8 = tail call %struct.Memory* @sub_46e0c0.estimate_score(%struct.State* %0, i64 %60, %struct.Memory* %2)
  ...
  ret %struct.Memory* %call2_42ebf8
}
