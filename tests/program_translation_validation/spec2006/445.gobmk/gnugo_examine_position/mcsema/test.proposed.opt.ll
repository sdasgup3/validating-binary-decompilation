...
define %struct.Memory* @gnugo_examine_position(%struct.State* noalias, i64, %struct.Memory* noalias readnone returned) local_unnamed_addr #1 {
entry:
  ...
  %call2_42ec24 = tail call %struct.Memory* @sub_425c60.examine_position(%struct.State* %0, i64 %64, %struct.Memory* %2)
  ...
  ret %struct.Memory* %call2_42ec24
}
