...
define %struct.Memory* @gnugo_genmove(%struct.State* noalias, i64, %struct.Memory* noalias) #2 {
entry:
  ...
  store %struct.Memory* %loadMem_42ea60, %struct.Memory** %MEMORY
  ...
  store i64 %93, i64* %96
  store %struct.Memory* %loadMem_42ea6c, %struct.Memory** %MEMORY
  ...
  %RBP.i11 = bitcast %union.anon* %121 to i64*
  %122 = load i64, i64* %RBP.i11
  %123 = sub i64 %122, 8
  ...
  store %struct.Memory* %loadMem_42ea73, %struct.Memory** %MEMORY
  ...
  %RBP.i9 = bitcast %union.anon* %136 to i64*
  %137 = load i64, i64* %RBP.i9
  %138 = sub i64 %137, 16
  ...
  store %struct.Memory* %loadMem_42ea7b, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem1_42ea7e, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_42ea83, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_42ea87, %struct.Memory** %MEMORY
  ...
  ret %struct.Memory* %loadMem_42ea88
}
