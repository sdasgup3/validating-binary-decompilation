...
define %struct.Memory* @gnugo_get_boardsize(%struct.State* noalias, i64, %struct.Memory* noalias) #2 {
entry:
  ...
  store %struct.Memory* %loadMem_42ecd0, %struct.Memory** %MEMORY
  %loadMem_42ecd1 = load %struct.Memory*, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_42ecd1, %struct.Memory** %MEMORY
  %loadMem_42ecd4 = load %struct.Memory*, %struct.Memory** %MEMORY
  ...
  %37 = load i32, i32* bitcast (%G_0x7ae438_type* @G_0x7ae438 to i32*)
  %38 = zext i32 %37 to i64
  store i64 %38, i64* %RAX.i, align 8
  store %struct.Memory* %loadMem_42ecd4, %struct.Memory** %MEMORY
  %loadMem_42ecdb = load %struct.Memory*, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_42ecdb, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_42ecdc, %struct.Memory** %MEMORY
  ret %struct.Memory* %loadMem_42ecdc
}
