...
define %struct.Memory* @gnugo_get_komi(%struct.State* noalias, i64, %struct.Memory* noalias) #2 {
entry:
  ...
  %loadMem_42ec30 = load %struct.Memory*, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_42ec30, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_42ec31, %struct.Memory** %MEMORY
  %loadMem_42ec34 = load %struct.Memory*, %struct.Memory** %MEMORY
  ...
  %37 = load float, float* bitcast (%G_0xb454f8_type* @G_0xb454f8 to float*)
  %38 = bitcast i8* %34 to float*
  store float %37, float* %38, align 1
  ...
  store %struct.Memory* %loadMem_42ec3e, %struct.Memory** %MEMORY
  ret %struct.Memory* %loadMem_42ec3e
}
