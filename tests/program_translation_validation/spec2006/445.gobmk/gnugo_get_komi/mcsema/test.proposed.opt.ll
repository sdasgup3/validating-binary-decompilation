...
define %struct.Memory* @gnugo_get_komi(%struct.State* noalias nocapture, i64, %struct.Memory* noalias readnone returned) local_unnamed_addr #0 {
entry:
  ...
  %13 = load i32, i32* bitcast (%G_0xb454f8_type* @G_0xb454f8 to i32*), align 8
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_movss_0xb454f8___xmm0(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned) local_unnamed_addr #1 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
