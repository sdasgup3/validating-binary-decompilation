...
define %struct.Memory* @gnugo_get_move_number(%struct.State* noalias, i64, %struct.Memory* noalias) #2 {
entry:
  ...
  store %struct.Memory* %loadMem_42ece0, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_42ece1, %struct.Memory** %MEMORY
  ...
  %37 = load i32, i32* bitcast (%G_0xafdfb0_type* @G_0xafdfb0 to i32*)
  %38 = zext i32 %37 to i64
  store i64 %38, i64* %RAX.i, align 8
  store %struct.Memory* %loadMem_42ece4, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_42eceb, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_42ecec, %struct.Memory** %MEMORY
  ret %struct.Memory* %loadMem_42ecec
}
