...
define %struct.Memory* @gnugo_is_pass(%struct.State* noalias, i64, %struct.Memory* noalias readnone returned) local_unnamed_addr #1 {
entry:
  ...
  %call2_42e53a = tail call %struct.Memory* @sub_40eab0.is_pass(%struct.State* %0, i64 %110, %struct.Memory* %2)
  ...
  ret %struct.Memory* %call2_42e53a
}
