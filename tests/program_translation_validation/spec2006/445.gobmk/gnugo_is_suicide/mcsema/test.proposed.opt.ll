...
define %struct.Memory* @gnugo_is_suicide(%struct.State* noalias, i64, %struct.Memory* noalias readnone returned) local_unnamed_addr #1 {
entry:
  ...
  %call2_42e9e0 = tail call %struct.Memory* @sub_409590.is_suicide(%struct.State* %0, i64 %122, %struct.Memory* %2)
  ...
  ret %struct.Memory* %call2_42e9e0
}
