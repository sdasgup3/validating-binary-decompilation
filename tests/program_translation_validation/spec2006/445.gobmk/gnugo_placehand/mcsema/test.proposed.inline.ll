...
define %struct.Memory* @gnugo_placehand(%struct.State* noalias, i64, %struct.Memory* noalias) #2 {
entry:
  ...
  store %struct.Memory* %loadMem_42e9f0, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_42e9f1, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_42e9f4, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_42e9fb, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem1_42e9fe, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_42ea03, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_42ea08, %struct.Memory** %MEMORY
  ret %struct.Memory* %loadMem_42ea08
}
