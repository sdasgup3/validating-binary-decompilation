...
declare %struct.Memory* @sub_427dc0.place_fixed_handicap(%struct.State* noalias dereferenceable(3376), i64, %struct.Memory* noalias readnone returned) local_unnamed_addr

; Function Attrs: alwaysinline
define %struct.Memory* @gnugo_placehand(%struct.State* noalias, i64, %struct.Memory* noalias readnone returned) local_unnamed_addr #1 {
entry:
  ...
  %call2_42e9fe = tail call %struct.Memory* @sub_427dc0.place_fixed_handicap(%struct.State* %0, i64 %52, %struct.Memory* %2)
  ...
  ret %struct.Memory* %call2_42e9fe
}
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_callq_.place_fixed_handicap(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
