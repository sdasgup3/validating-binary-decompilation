...
define %struct.Memory* @gnugo_remove_stone(%struct.State* noalias, i64, %struct.Memory* noalias) #2 {
entry:
  ...
  store %struct.Memory* %loadMem_42e4f1, %struct.Memory** %MEMORY
  ...
  store i32 %78, i32* %82
  store %struct.Memory* %loadMem_42e4f8, %struct.Memory** %MEMORY
  ...
  store i32 %94, i32* %98
  store %struct.Memory* %loadMem_42e4fb, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem1_42e50a, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_42e50f, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_42e513, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_42e514, %struct.Memory** %MEMORY
  ret %struct.Memory* %loadMem_42e514
}
