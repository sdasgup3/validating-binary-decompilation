...
define %struct.Memory* @gnugo_sethand(%struct.State* noalias, i64, %struct.Memory* noalias readnone returned) local_unnamed_addr #1 {
entry:
  ...
  store i64 %56, i64* %RDI.i14, align 8
  %57 = add i64 %52, -27775
  %58 = add i64 %52, 8
  ...
  %call2_42ea42 = tail call %struct.Memory* @sub_427dc0.place_fixed_handicap(%struct.State* %0, i64 %57, %struct.Memory* %2)
  %62 = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 1, i32 0
  %EAX.i = bitcast %union.anon* %62 to i32*
  ...
  %call2_42ea4e = tail call %struct.Memory* @sub_472ef0.sgffile_recordboard(%struct.State* %0, i64 %75, %struct.Memory* %call2_42ea42)
  ...
  ret %struct.Memory* %call2_42ea4e
}
