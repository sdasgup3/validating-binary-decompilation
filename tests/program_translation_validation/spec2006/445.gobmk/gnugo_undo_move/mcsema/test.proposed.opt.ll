...
define %struct.Memory* @gnugo_undo_move(%struct.State* noalias, i64, %struct.Memory* noalias readnone returned) local_unnamed_addr #1 {
entry:
  ...
  %call2_42e58e = tail call %struct.Memory* @sub_40e910.undo_move(%struct.State* %0, i64 %52, %struct.Memory* %2)
  ...
  ret %struct.Memory* %call2_42e58e
}
