...
declare %struct.Memory* @sub_47ad90.who_wins(%struct.State* noalias dereferenceable(3376), i64, %struct.Memory* noalias readnone returned) local_unnamed_addr

; Function Attrs: alwaysinline
define %struct.Memory* @gnugo_who_wins(%struct.State* noalias, i64, %struct.Memory* noalias readnone returned) local_unnamed_addr #1 {
entry:
  ...
  %46 = add i64 %45, -16
  %47 = load i64, i64* %RSI.i11, align 8
  ...
  %call2_42ebc6 = tail call %struct.Memory* @sub_47ad90.who_wins(%struct.State* %0, i64 %62, %struct.Memory* %2)
  ...
  ret %struct.Memory* %call2_42ebc6
}
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_callq_.who_wins(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
