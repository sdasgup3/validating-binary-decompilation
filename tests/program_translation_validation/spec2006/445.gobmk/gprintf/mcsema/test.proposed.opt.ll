...
define %struct.Memory* @gprintf(%struct.State* noalias, i64, %struct.Memory* noalias readnone returned) local_unnamed_addr #1 {
entry:
...
block_.L_451e83:                                  ; preds = %block_451e25, %entry
  %529 = phi i64 [ %.pre, %block_451e25 ], [ %233, %entry ]
  ...
  %606 = add i64 %605, ptrtoint (%G_0x54a1a4__rip__type* @G_0x54a1a4__rip_ to i64)
  %607 = add i64 %605, 7
  ...
  %call2_451f04 = tail call %struct.Memory* @sub_451370.vgprintf(%struct.State* nonnull %0, i64 %616, %struct.Memory* %2)
  %621 = load i64, i64* %3, align 8
  store i64 1, i64* %RAX.i60, align 8
  %622 = load i64, i64* %6, align 8
  %623 = add i64 %622, 384
  store i64 %623, i64* %6, align 8
  %624 = icmp ugt i64 %622, -385
  ...
  ret %struct.Memory* %call2_451f04
}
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_je_.L_451e83(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i8* nocapture %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_movq_0x54a1a4__rip____rdi(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %RDI = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 11, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, ptrtoint (%G_0x54a1a4__rip__type* @G_0x54a1a4__rip_ to i64)
  %5 = add i64 %3, 7
  store i64 %5, i64* %PC, align 8
