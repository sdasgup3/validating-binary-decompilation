...
define %struct.Memory* @gtp_decrease_depths(%struct.State* noalias, i64, %struct.Memory* noalias readnone returned) local_unnamed_addr #1 {
entry:
  ...
  %call2_49349c = tail call %struct.Memory* @sub_4774c0.decrease_depth_values(%struct.State* %0, i64 %45, %struct.Memory* %2)
  ...
  %call2_4934ad = tail call %struct.Memory* @sub_48c5d0.gtp_success(%struct.State* %0, i64 %52, %struct.Memory* %call2_49349c)
  ...
  ret %struct.Memory* %call2_4934ad
}
