...
define %struct.Memory* @gtp_dump_stack(%struct.State* noalias, i64, %struct.Memory* noalias readnone returned) local_unnamed_addr #1 {
entry:
  ...
  %call2_4940bc = tail call %struct.Memory* @sub_409930.dump_stack(%struct.State* %0, i64 %45, %struct.Memory* %2)
  ...
  %call2_4940cd = tail call %struct.Memory* @sub_48c5d0.gtp_success(%struct.State* %0, i64 %52, %struct.Memory* %call2_4940bc)
  ...
  ret %struct.Memory* %call2_4940cd
}
