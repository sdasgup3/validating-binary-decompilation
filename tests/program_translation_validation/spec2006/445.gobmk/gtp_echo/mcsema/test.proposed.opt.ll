...
define %struct.Memory* @gtp_echo(%struct.State* noalias, i64, %struct.Memory* noalias readnone returned) local_unnamed_addr #1 {
entry:
  ...
  %RAX.i14 = getelementptr inbounds %union.anon, %union.anon* %40, i64 0, i32 0
  ...
  %41 = add i64 %7, -16
  %42 = load i64, i64* %RDI.i11, align 8
  %43 = add i64 %10, 21
  ...
  %51 = load i64, i64* %RAX.i14, align 8
  store i64 %51, i64* %RDI.i11, align 8
  ...
  %call2_4940ff = tail call %struct.Memory* @sub_48c5d0.gtp_success(%struct.State* %0, i64 %52, %struct.Memory* %2)
  ...
  ret %struct.Memory* %call2_4940ff
}
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_movq__0x588896___rax(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
