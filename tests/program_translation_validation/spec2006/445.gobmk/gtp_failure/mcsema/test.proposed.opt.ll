...
declare %struct.Memory* @sub_401190.vfprintf_plt(%struct.State* noalias dereferenceable(3376), i64, %struct.Memory* noalias readnone returned) local_unnamed_addr
...
define %struct.Memory* @gtp_failure(%struct.State* noalias, i64, %struct.Memory* noalias readnone returned) local_unnamed_addr #1 {
entry:
  ...
  %RDI.i114 = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 11, i32 0, i32 0
  %194 = load i64, i64* %RBP.i, align 8
  %195 = add i64 %194, -344
  %196 = load i64, i64* %RDI.i114, align 8
  ...
  %207 = add i64 %206, -360
  %208 = load i64, i64* %R8.i110, align 8
  ...
  %213 = add i64 %212, -368
  %214 = load i64, i64* %RCX.i106, align 8
  ...
  %219 = add i64 %218, -376
  %220 = load i64, i64* %RDX.i103, align 8
  ...
  %225 = add i64 %224, -384
  %226 = load i64, i64* %RSI.i100, align 8
...
block_.L_48b973:                                  ; preds = %block_48b915, %entry
  %529 = phi i64 [ %.pre, %block_48b915 ], [ %233, %entry ]
  %RAX.i64 = getelementptr inbounds %union.anon, %union.anon* %18, i64 0, i32 0
  ...
  store i64 %534, i64* %RAX.i64, align 8
  %535 = add i64 %530, -168
  %536 = add i64 %529, 14
  ...
  store i64 %543, i64* %RCX.i106, align 8
  %544 = add i64 %538, -176
  %545 = add i64 %540, 14
  ...
  store i64 %552, i64* %RDX.i103, align 8
  %553 = add i64 %547, -184
  %554 = add i64 %549, 14
  ...
  store i64 %561, i64* %RSI.i100, align 8
  %562 = add i64 %556, -192
  %563 = add i64 %558, 14
  ...
  store i64 %570, i64* %RDI.i114, align 8
  %571 = add i64 %565, -200
  %572 = add i64 %567, 14
  ...
  store i64 %579, i64* %R8.i110, align 8
  %580 = add i64 %574, -8
  %581 = add i64 %576, 11
  ...
  store i64 1, i64* %RDI.i114, align 8
  %584 = add i64 %583, 492
  %585 = add i64 %583, 10
  ...
  %call2_48b9c9 = tail call %struct.Memory* @sub_48bbb0.gtp_start_response(%struct.State* nonnull %0, i64 %584, %struct.Memory* %2)
  ...
  store i64 %596, i64* %RAX.i64, align 8
  %598 = add i64 %595, -24
  %599 = add i64 %597, 8
  ...
  store i32 8, i32* %610, align 4
  %611 = load i64, i64* %3, align 8
  %612 = add i64 %611, ptrtoint (%G_0x51068a__rip__type* @G_0x51068a__rip_ to i64)
  %613 = add i64 %611, 7
  store i64 %613, i64* %3, align 8
  %614 = inttoptr i64 %612 to i64*
  %615 = load i64, i64* %614, align 8
  store i64 %615, i64* %RDI.i114, align 8
  ...
  store i64 %620, i64* %RSI.i100, align 8
  %621 = add i64 %616, -32
  store i64 %621, i64* %RDX.i103, align 8
  %622 = add i64 %611, -567391
  %623 = add i64 %611, 20
  ...
  %call2_48b9fe = tail call %struct.Memory* @sub_401190.vfprintf_plt(%struct.State* nonnull %0, i64 %622, %struct.Memory* %call2_48b9c9)
  %EAX.i = bitcast %union.anon* %18 to i32*
  %627 = load i64, i64* %RBP.i, align 8
  %628 = add i64 %627, -388
  %629 = load i32, i32* %EAX.i, align 4
  %630 = load i64, i64* %3, align 8
  %631 = add i64 %630, 6
  store i64 %631, i64* %3, align 8
  %632 = inttoptr i64 %628 to i32*
  ...
  %call2_48ba09 = tail call %struct.Memory* @sub_48bc30.gtp_finish_response(%struct.State* nonnull %0, i64 %634, %struct.Memory* %call2_48b9fe)
  %639 = load i64, i64* %6, align 8
  %640 = load i64, i64* %3, align 8
  %641 = add i64 %639, 400
  store i64 %641, i64* %6, align 8
  %642 = icmp ugt i64 %639, -401
  %643 = zext i1 %642 to i8
  store i8 %643, i8* %12, align 1
  ...
  ret %struct.Memory* %call2_48ba09
}
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_je_.L_48b973(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i8* nocapture %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_leaq_MINUS0xd0__rbp____rax(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %RAX = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 1, i32 0, i32 0
  %RBP = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 15, i32 0, i32 0
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_movq_0x51068a__rip____rdi(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %RDI = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 11, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, ptrtoint (%G_0x51068a__rip__type* @G_0x51068a__rip_ to i64)
  %5 = add i64 %3, 7
  store i64 %5, i64* %PC, align 8
