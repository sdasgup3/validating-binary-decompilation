...
define %struct.Memory* @gtp_finish_response(%struct.State* noalias, i64, %struct.Memory* noalias readnone returned) local_unnamed_addr #0 {
entry:
  ...
  %call2_48bc40 = tail call %struct.Memory* @sub_48ba40.gtp_printf(%struct.State* %0, i64 %12, %struct.Memory* %2)
  ...
  ret %struct.Memory* %call2_48bc40
}
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_movq__0x586072___rdi(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned) local_unnamed_addr #1 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
