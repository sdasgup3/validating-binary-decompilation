...
define %struct.Memory* @gtp_genmove_white(%struct.State* noalias, i64, %struct.Memory* noalias readnone) local_unnamed_addr #1 {
entry:
  ...
  %18 = add i64 %7, -24
  %19 = load i64, i64* %RDI.i61, align 8
  %20 = add i64 %10, 11
  ...
  %33 = icmp ne i8 %32, 0
  %34 = or i1 %29, %33
  %.v4 = select i1 %34, i64 39, i64 14
  %35 = add i64 %22, %.v4
  store i64 %35, i64* %3, align 8
  br i1 %34, label %block_.L_4951d3, label %block_4951ba

block_4951ba:                                     ; preds = %entry
  store i64 ptrtoint (%G__0x587448_type* @G__0x587448 to i64), i64* %RDI.i61, align 8
  ...
  %call2_4951c6 = tail call %struct.Memory* @sub_48b8a0.gtp_failure(%struct.State* nonnull %0, i64 %37, %struct.Memory* %2)
  %EAX.i52 = bitcast %union.anon* %36 to i32*
  %42 = load i64, i64* %RBP.i, align 8
  %43 = add i64 %42, -4
  %44 = load i32, i32* %EAX.i52, align 4
...
block_.L_4951d3:                                  ; preds = %entry
  ...
  %call2_4951e0 = tail call %struct.Memory* @sub_426200.genmove(%struct.State* nonnull %0, i64 %53, %struct.Memory* %2)
  %58 = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 1, i32 0
  %EAX.i41 = bitcast %union.anon* %58 to i32*
  %59 = load i32, i32* %EAX.i41, align 4
  ...
  store i8 0, i8* %17, align 1
  %71 = icmp ne i8 %70, 0
  %.v = select i1 %71, i64 33, i64 6
  %72 = add i64 %61, %.v
  store i64 %72, i64* %3, align 8
  br i1 %71, label %block_.L_495209, label %block_4951ee

block_4951ee:                                     ; preds = %block_.L_4951d3
  store i64 1, i64* %RSI.i45, align 8
  %RAX.i35 = getelementptr inbounds %union.anon, %union.anon* %58, i64 0, i32 0
  ...
  store i64 %80, i64* %RAX.i35, align 8
  %81 = icmp ugt i32 %78, -22
  %82 = zext i1 %81 to i8
  ...
  store i64 %105, i64* %RAX.i35, align 8
  %106 = icmp ult i32 %104, %79
  ...
  store i64 %105, i64* %RDI.i61, align 8
  %130 = add i64 %72, -552670
  %131 = add i64 %72, 22
  ...
  %call2_4951ff = tail call %struct.Memory* @sub_40e310.play_move(%struct.State* nonnull %0, i64 %130, %struct.Memory* %call2_4951e0)
...
block_.L_495209:                                  ; preds = %block_.L_4951d3
  ...
  %call2_495210 = tail call %struct.Memory* @sub_40e310.play_move(%struct.State* nonnull %0, i64 %137, %struct.Memory* %call2_4951e0)
  %.pre = load i64, i64* %3, align 8
  br label %block_.L_495215

block_.L_495215:                                  ; preds = %block_.L_495209, %block_4951ee
  %142 = phi i64 [ %.pre, %block_.L_495209 ], [ %136, %block_4951ee ]
  %MEMORY.0 = phi %struct.Memory* [ %call2_495210, %block_.L_495209 ], [ %call2_4951ff, %block_4951ee ]
  store i64 0, i64* %RDI.i61, align 8
  store i8 0, i8* %12, align 1
  store i8 1, i8* %13, align 1
  store i8 1, i8* %15, align 1
  ...
  %call2_495217 = tail call %struct.Memory* @sub_48bbb0.gtp_start_response(%struct.State* nonnull %0, i64 %143, %struct.Memory* %MEMORY.0)
  ...
  store i64 %154, i64* %RDI.i61, align 8
  %155 = add i64 %148, -24
  %156 = add i64 %150, 6
  ...
  store i64 %159, i64* %RSI.i45, align 8
  %160 = add i64 %150, -36668
  %161 = add i64 %150, 11
  ...
  %call2_495222 = tail call %struct.Memory* @sub_48c2e0.gtp_print_vertex(%struct.State* nonnull %0, i64 %160, %struct.Memory* %call2_495217)
  %165 = load i64, i64* %3, align 8
  %166 = add i64 %165, -38391
  %167 = add i64 %165, 5
  ...
  %call2_495227 = tail call %struct.Memory* @sub_48bc30.gtp_finish_response(%struct.State* nonnull %0, i64 %166, %struct.Memory* %call2_495222)
  %171 = load i64, i64* %RBP.i, align 8
  %172 = add i64 %171, -4
  %173 = load i32, i32* %EAX.i41, align 4
...
block_.L_49522f:                                  ; preds = %block_.L_495215, %block_4951ba
  %177 = phi i64 [ %.pre2, %block_.L_495215 ], [ %49, %block_4951ba ]
  %MEMORY.1 = phi %struct.Memory* [ %call2_495227, %block_.L_495215 ], [ %call2_4951c6, %block_4951ba ]
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_jle_.L_4951d3(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i8* nocapture %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_jmpq_.L_49522f(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_jl_.L_495209(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i8* nocapture %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_jmpq_.L_495215(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
