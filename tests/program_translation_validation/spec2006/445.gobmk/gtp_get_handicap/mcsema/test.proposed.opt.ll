...
define %struct.Memory* @gtp_get_handicap(%struct.State* noalias, i64, %struct.Memory* noalias readnone returned) local_unnamed_addr #1 {
entry:
  ...
  %46 = load i32, i32* bitcast (%G_0xaf28f0_type* @G_0xaf28f0 to i32*), align 8
  ...
  %call2_494fa2 = tail call %struct.Memory* @sub_48c5d0.gtp_success(%struct.State* %0, i64 %49, %struct.Memory* %2)
  ...
  ret %struct.Memory* %call2_494fa2
}
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_movl_0xaf28f0___esi(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  ...
  %4 = add i64 %3, 7
  store i64 %4, i64* %PC, align 8
  %5 = load i32, i32* bitcast (%G_0xaf28f0_type* @G_0xaf28f0 to i32*), align 8
  %6 = zext i32 %5 to i64
