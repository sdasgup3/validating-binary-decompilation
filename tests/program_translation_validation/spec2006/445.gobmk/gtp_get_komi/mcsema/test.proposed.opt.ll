...
@G__0x58758f = global %G__0x58758f_type zeroinitializer
...
define %struct.Memory* @gtp_get_komi(%struct.State* noalias, i64, %struct.Memory* noalias readnone returned) local_unnamed_addr #1 {
entry:
  ...
  store i64 ptrtoint (%G__0x58758f_type* @G__0x58758f to i64), i64* %RAX.i13, align 8
  ...
  %47 = load float, float* bitcast (%G_0xb454f8_type* @G_0xb454f8 to float*), align 8
  %48 = fpext float %47 to double
  %49 = bitcast %union.VectorReg* %45 to double*
  store double %48, double* %49, align 1
  %50 = load i64, i64* %RAX.i13, align 8
  store i64 %50, i64* %RDI.i10, align 8
  ...
  %call2_495764 = tail call %struct.Memory* @sub_48c5d0.gtp_success(%struct.State* %0, i64 %51, %struct.Memory* %2)
  ...
  ret %struct.Memory* %call2_495764
}
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_movq__0x58758f___rax(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  ...
  store i64 ptrtoint (%G__0x58758f_type* @G__0x58758f to i64), i64* %RAX, align 8
  ret %struct.Memory* %2
}
