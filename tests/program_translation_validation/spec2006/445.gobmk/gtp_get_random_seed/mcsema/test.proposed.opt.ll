...
define %struct.Memory* @gtp_get_random_seed(%struct.State* noalias, i64, %struct.Memory* noalias readnone returned) local_unnamed_addr #1 {
entry:
  ...
  %RAX.i13 = getelementptr inbounds %union.anon, %union.anon* %40, i64 0, i32 0
  store i64 ptrtoint (%G__0x581299_type* @G__0x581299 to i64), i64* %RAX.i13, align 8
  %RDI.i10 = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 11, i32 0, i32 0
  %41 = add i64 %7, -16
  %42 = load i64, i64* %RDI.i10, align 8
  %43 = add i64 %10, 21
  ...
  %46 = load i32, i32* bitcast (%G_0xab0f00_type* @G_0xab0f00 to i32*), align 8
  %47 = zext i32 %46 to i64
  store i64 %47, i64* %RSI.i, align 8
  %48 = load i64, i64* %RAX.i13, align 8
  store i64 %48, i64* %RDI.i10, align 8
  ...
  %call2_494fd2 = tail call %struct.Memory* @sub_48c5d0.gtp_success(%struct.State* %0, i64 %49, %struct.Memory* %2)
  ...
  ret %struct.Memory* %call2_494fd2
}
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_movl_0xab0f00___esi(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
