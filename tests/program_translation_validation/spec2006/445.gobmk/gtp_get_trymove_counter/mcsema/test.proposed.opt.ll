...
declare %struct.Memory* @sub_416000.get_trymove_counter(%struct.State* noalias dereferenceable(3376), i64, %struct.Memory* noalias readnone returned) local_unnamed_addr
...
define %struct.Memory* @gtp_get_trymove_counter(%struct.State* noalias, i64, %struct.Memory* noalias readnone returned) local_unnamed_addr #1 {
entry:
  ...
  %call2_49530c = tail call %struct.Memory* @sub_416000.get_trymove_counter(%struct.State* %0, i64 %45, %struct.Memory* %2)
  ...
  %call2_495323 = tail call %struct.Memory* @sub_48c5d0.gtp_success(%struct.State* %0, i64 %64, %struct.Memory* %call2_49530c)
  ...
  ret %struct.Memory* %call2_495323
}
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_callq_.get_trymove_counter(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
