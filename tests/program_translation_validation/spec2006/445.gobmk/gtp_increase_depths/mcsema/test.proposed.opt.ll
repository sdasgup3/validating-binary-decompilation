...
define %struct.Memory* @gtp_increase_depths(%struct.State* noalias, i64, %struct.Memory* noalias readnone returned) local_unnamed_addr #1 {
entry:
  ...
  %call2_49554c = tail call %struct.Memory* @sub_4774b0.increase_depth_values(%struct.State* %0, i64 %45, %struct.Memory* %2)
  ...
  %call2_49555d = tail call %struct.Memory* @sub_48c5d0.gtp_success(%struct.State* %0, i64 %52, %struct.Memory* %call2_49554c)
  ...
  ret %struct.Memory* %call2_49555d
}
