...
define %struct.Memory* @gtp_program_version(%struct.State* noalias, i64, %struct.Memory* noalias readnone returned) local_unnamed_addr #1 {
entry:
  ...
  %call2_49816b = tail call %struct.Memory* @sub_48c5d0.gtp_success(%struct.State* %0, i64 %47, %struct.Memory* %2)
  ...
  ret %struct.Memory* %call2_49816b
}
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_movq__0x579cb5___rax(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
