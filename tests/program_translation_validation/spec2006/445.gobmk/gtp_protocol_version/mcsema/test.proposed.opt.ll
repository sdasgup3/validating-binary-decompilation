...
define %struct.Memory* @gtp_protocol_version(%struct.State* noalias, i64, %struct.Memory* noalias readnone returned) local_unnamed_addr #1 {
entry:
  ...
  %46 = load i32, i32* bitcast (%G_0x7ae45c_type* @G_0x7ae45c to i32*), align 8
  ...
  %call2_496e92 = tail call %struct.Memory* @sub_48c5d0.gtp_success(%struct.State* %0, i64 %49, %struct.Memory* %2)
  ...
  ret %struct.Memory* %call2_496e92
}
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_movl_0x7ae45c___esi(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
