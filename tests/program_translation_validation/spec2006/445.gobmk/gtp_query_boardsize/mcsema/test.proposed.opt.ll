...
define %struct.Memory* @gtp_query_boardsize(%struct.State* noalias, i64, %struct.Memory* noalias readnone returned) local_unnamed_addr #1 {
entry:
  ...
  %46 = load i32, i32* bitcast (%G_0x7ae438_type* @G_0x7ae438 to i32*), align 8
  ...
  %call2_496ec2 = tail call %struct.Memory* @sub_48c5d0.gtp_success(%struct.State* %0, i64 %49, %struct.Memory* %2)
  ...
  ret %struct.Memory* %call2_496ec2
}
