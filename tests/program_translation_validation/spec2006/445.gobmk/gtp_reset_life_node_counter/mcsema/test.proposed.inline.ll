...
define %struct.Memory* @gtp_reset_life_node_counter(%struct.State* noalias, i64, %struct.Memory* noalias) #2 {
entry:
  ...
  store %struct.Memory* %loadMem_497290, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_497291, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_497294, %struct.Memory** %MEMORY
  ...
  store i64 ptrtoint (%G__0x58898d_type* @G__0x58898d to i64), i64* %RAX.i12, align 8
  store %struct.Memory* %loadMem_497298, %struct.Memory** %MEMORY
  ...
  store i64 %86, i64* %89
  store %struct.Memory* %loadMem_4972a2, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_4972a6, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_4972a9, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem1_4972ab, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_4972b0, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_4972b4, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_4972b5, %struct.Memory** %MEMORY
  ret %struct.Memory* %loadMem_4972b5
}
...
define %struct.Memory* @routine_movq__0x58898d___rax(%struct.State* dereferenceable(3376), i64, %struct.Memory*) {
block_400488:
  %3 = getelementptr inbounds %struct.State, %struct.State* %0, i32 0, i32 6
  %4 = getelementptr inbounds %struct.GPR, %struct.GPR* %3, i32 0, i32 33
  %5 = getelementptr inbounds %struct.Reg, %struct.Reg* %4, i32 0, i32 0
