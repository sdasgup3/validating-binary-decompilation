...
define %struct.Memory* @gtp_reset_life_node_counter(%struct.State* noalias, i64, %struct.Memory* noalias readnone returned) local_unnamed_addr #1 {
entry:
  ...
  %call2_4972ab = tail call %struct.Memory* @sub_48c5d0.gtp_success(%struct.State* %0, i64 %47, %struct.Memory* %2)
  ...
  ret %struct.Memory* %call2_4972ab
}
