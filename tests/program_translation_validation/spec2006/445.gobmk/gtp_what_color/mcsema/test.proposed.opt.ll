...
define %struct.Memory* @gtp_what_color(%struct.State* noalias, i64, %struct.Memory* noalias readnone) local_unnamed_addr #1 {
entry:
  ...
  %41 = add i64 %7, -24
  %42 = load i64, i64* %RDI.i44, align 8
  %43 = add i64 %10, 19
  ...
  store i64 %50, i64* %RDI.i44, align 8
  %51 = add i64 %47, -26724
  %52 = add i64 %47, 9
  ...
  %call2_4930e8 = tail call %struct.Memory* @sub_48c880.gtp_decode_coord(%struct.State* %0, i64 %51, %struct.Memory* %2)
  %56 = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 1, i32 0
  %EAX.i38 = bitcast %union.anon* %56 to i32*
  %57 = load i32, i32* %EAX.i38, align 4
  ...
  br i1 %64, label %block_4930f6, label %block_.L_49310f

block_4930f6:                                     ; preds = %entry
  store i64 ptrtoint (%G__0x58714f_type* @G__0x58714f to i64), i64* %RDI.i44, align 8
  %AL.i33 = bitcast %union.anon* %56 to i8*
  ...
  %call2_493102 = tail call %struct.Memory* @sub_48b8a0.gtp_failure(%struct.State* nonnull %0, i64 %69, %struct.Memory* %call2_4930e8)
  %74 = load i64, i64* %RBP.i, align 8
  %75 = add i64 %74, -4
  %76 = load i32, i32* %EAX.i38, align 4
  ...
  %.pre1 = getelementptr inbounds %union.anon, %union.anon* %56, i64 0, i32 0
  br label %block_.L_493136

block_.L_49310f:                                  ; preds = %entry
  %RAX.i25 = getelementptr inbounds %union.anon, %union.anon* %56, i64 0, i32 0
  ...
  store i64 %114, i64* %RAX.i25, align 8
  ...
  store i64 %139, i64* %RCX.i18, align 8
  ...
  %call2_493124 = tail call %struct.Memory* @sub_451ce0.color_to_string(%struct.State* nonnull %0, i64 %145, %struct.Memory* %call2_4930e8)
  %150 = load i64, i64* %RAX.i25, align 8
  %151 = load i64, i64* %3, align 8
  store i64 %150, i64* %RDI.i44, align 8
  %AL.i = bitcast %union.anon* %56 to i8*
  store i8 0, i8* %AL.i, align 1
  %152 = add i64 %151, -27481
  %153 = add i64 %151, 10
  ...
  %call2_49312e = tail call %struct.Memory* @sub_48c5d0.gtp_success(%struct.State* nonnull %0, i64 %152, %struct.Memory* %call2_493124)
  %157 = load i64, i64* %RBP.i, align 8
  %158 = add i64 %157, -4
  %159 = load i32, i32* %EAX.i38, align 4
...
block_.L_493136:                                  ; preds = %block_.L_49310f, %block_4930f6
  %RAX.i.pre-phi = phi i64* [ %RAX.i25, %block_.L_49310f ], [ %.pre1, %block_4930f6 ]
  %163 = phi i64 [ %.pre, %block_.L_49310f ], [ %81, %block_4930f6 ]
  %MEMORY.0 = phi %struct.Memory* [ %call2_49312e, %block_.L_49310f ], [ %call2_493102, %block_4930f6 ]
  ...
  store i64 %169, i64* %RAX.i.pre-phi, align 8
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_jne_.L_49310f(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i8* nocapture %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_jmpq_.L_493136(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
