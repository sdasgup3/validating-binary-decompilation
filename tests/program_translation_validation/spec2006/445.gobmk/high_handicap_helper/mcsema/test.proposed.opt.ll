...
define %struct.Memory* @high_handicap_helper(%struct.State* noalias, i64, %struct.Memory* noalias readnone) local_unnamed_addr #1 {
entry:
  ...
  %ECX.i = bitcast %union.anon* %38 to i32*
  %39 = load i64, i64* %RBP.i, align 8
  %40 = add i64 %39, -20
  %41 = load i32, i32* %ECX.i, align 4
  ...
  %46 = load i32, i32* bitcast (%G_0xab0fbc_type* @G_0xab0fbc to i32*), align 8
  ...
  %65 = icmp eq i8 %64, 0
  %66 = select i1 %65, i64 %62, i64 %63
  store i64 %66, i64* %3, align 8
  br i1 %65, label %block_.L_4aeae4, label %block_4aeacc

block_4aeacc:                                     ; preds = %entry
  %EAX.i41 = bitcast %union.anon* %18 to i32*
  ...
  store i64 %73, i64* %RDI.i35, align 8
  %93 = add i64 %66, -625756
  %94 = add i64 %66, 15
  ...
  %call2_4aead6 = tail call %struct.Memory* @sub_415e70.stones_on_board(%struct.State* nonnull %0, i64 %93, %struct.Memory* %2)
  %98 = load i32, i32* %EAX.i41, align 4
  ...
  store i8 0, i8* %17, align 1
  %CL.i14 = bitcast %union.anon* %38 to i8*
  store i8 %106, i8* %CL.i14, align 1
...
block_.L_4aeae4:                                  ; preds = %block_4aeacc, %entry
  %113 = phi i64 [ %62, %entry ], [ %.pre, %block_4aeacc ]
  %MEMORY.0 = phi %struct.Memory* [ %2, %entry ], [ %call2_4aead6, %block_4aeacc ]
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_jne_.L_4aeae4(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i8* nocapture %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
