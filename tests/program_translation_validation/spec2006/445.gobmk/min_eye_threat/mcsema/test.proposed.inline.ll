...
define %struct.Memory* @min_eye_threat(%struct.State* noalias, i64, %struct.Memory* noalias) #2 {
entry:
  ...
  store %struct.Memory* %loadMem_43cbd0, %struct.Memory** %MEMORY
  ...
  store i64 %40, i64* %43
  store %struct.Memory* %loadMem_43cbd4, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_43cbdc, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_43cbdf, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_43cbe0, %struct.Memory** %MEMORY
  ret %struct.Memory* %loadMem_43cbe0
}
