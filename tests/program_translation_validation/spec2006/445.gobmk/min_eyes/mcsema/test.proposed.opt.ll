...
define %struct.Memory* @min_eyes(%struct.State* noalias nocapture, i64, %struct.Memory* noalias readnone returned) local_unnamed_addr #0 {
entry:
  ...
  store i64 %25, i64* %RAX.i, align 8
  %26 = add i64 %17, 9
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_movzbl_0x1__rdi____eax(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned) local_unnamed_addr #1 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
