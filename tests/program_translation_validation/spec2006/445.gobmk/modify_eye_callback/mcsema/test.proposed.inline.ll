...
define %struct.Memory* @modify_eye_callback(%struct.State* noalias, i64, %struct.Memory* noalias) #2 {
entry:
  ...
  store %struct.Memory* %loadMem_4a69f0, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_4a69f1, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_4a69f4, %struct.Memory** %MEMORY
  ...
  store i32 %78, i32* %82
  store %struct.Memory* %loadMem_4a69f8, %struct.Memory** %MEMORY
  ...
  store i32 %94, i32* %98
  store %struct.Memory* %loadMem_4a69fb, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_4a69fe, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_4a6a02, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_4a6a05, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_4a6a09, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_4a6a0d, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_4a6a10, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_4a6a16, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_4a6a19, %struct.Memory** %MEMORY
...
block_4a6a1f:                                     ; preds = %entry
  ...
  store %struct.Memory* %loadMem_4a6a1f, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_4a6a22, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_4a6a25, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_4a6a29, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_4a6a2c, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem1_4a6a30, %struct.Memory** %MEMORY
...
block_.L_4a6a35:                                  ; preds = %block_4a6a1f, %entry
  ...
  store %struct.Memory* %loadMem_4a6a35, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_4a6a39, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_4a6a3a, %struct.Memory** %MEMORY
  ret %struct.Memory* %loadMem_4a6a3a
}
...
define %struct.Memory* @routine_andl__0x10000___ecx(%struct.State* dereferenceable(3376), i64, %struct.Memory*) {
block_400488:
  %3 = getelementptr inbounds %struct.State, %struct.State* %0, i32 0, i32 6
  %4 = getelementptr inbounds %struct.GPR, %struct.GPR* %3, i32 0, i32 33
  %5 = getelementptr inbounds %struct.Reg, %struct.Reg* %4, i32 0, i32 0
