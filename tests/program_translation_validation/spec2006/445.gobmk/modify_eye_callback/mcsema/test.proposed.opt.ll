...
define %struct.Memory* @modify_eye_callback(%struct.State* noalias, i64, %struct.Memory* noalias readnone) local_unnamed_addr #1 {
entry:
  ...
  %82 = icmp eq i32 %80, 0
  %.lobit1 = lshr exact i32 %80, 16
  %83 = trunc i32 %.lobit1 to i8
  %84 = xor i8 %83, 1
  store i8 %84, i8* %29, align 1
  store i8 0, i8* %32, align 1
  store i8 0, i8* %38, align 1
  %.v = select i1 %82, i64 44, i64 22
  %85 = add i64 %72, %.v
  store i64 %85, i64* %3, align 8
  br i1 %82, label %block_.L_4a6a35, label %block_4a6a1f

block_4a6a1f:                                     ; preds = %entry
  ...
  store i64 %97, i64* %RDX.i33, align 8
  %98 = add i64 %70, -20
  %99 = add i64 %85, 13
  ...
  store i64 %102, i64* %RCX.i21, align 8
  %103 = add i64 %70, -32
  %104 = add i64 %85, 17
  store i64 %104, i64* %3, align 8
  %105 = inttoptr i64 %103 to i64*
  %106 = load i64, i64* %105, align 8
  store i64 %106, i64* %R8.i28, align 8
  %107 = add i64 %85, -2863
  %108 = add i64 %85, 22
  ...
  %call2_4a6a30 = tail call %struct.Memory* @sub_4a5ef0.cut_connect_callback(%struct.State* nonnull %0, i64 %107, %struct.Memory* %2)
  %.pre = load i64, i64* %3, align 8
  br label %block_.L_4a6a35

block_.L_4a6a35:                                  ; preds = %block_4a6a1f, %entry
  %112 = phi i64 [ %85, %entry ], [ %.pre, %block_4a6a1f ]
  %MEMORY.0 = phi %struct.Memory* [ %2, %entry ], [ %call2_4a6a30, %block_4a6a1f ]
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_andl__0x10000___ecx(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %RCX = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 5, i32 0, i32 0
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_je_.L_4a6a35(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i8* nocapture %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
