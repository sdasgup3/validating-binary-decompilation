...
define %struct.Memory* @move_is_marked_unsafe(%struct.State* noalias, i64, %struct.Memory* noalias readnone returned) local_unnamed_addr #1 {
entry:
  ...
  %30 = mul nsw i64 %29, 564
  store i64 %30, i64* %RCX.i18, align 8
  ...
  %38 = load i64, i64* %RAX.i25, align 8
  %39 = add i64 %30, %38
  ...
  %DL.i10 = bitcast %union.anon* %69 to i8*
  %70 = icmp eq i32 %68, 0
  %71 = zext i1 %70 to i8
  store i8 %71, i8* %DL.i10, align 1
  ...
  store i64 %77, i64* %RAX.i25, align 8
  %78 = add i64 %25, 34
