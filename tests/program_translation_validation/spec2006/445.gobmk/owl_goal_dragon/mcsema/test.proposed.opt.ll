...
define %struct.Memory* @owl_goal_dragon(%struct.State* noalias nocapture, i64, %struct.Memory* noalias readnone returned) local_unnamed_addr #1 {
entry:
  ...
  %EDI.i18 = bitcast %union.anon* %11 to i32*
  %12 = add i64 %7, -12
  %13 = load i32, i32* %EDI.i18, align 4
  %14 = add i64 %10, 6
  ...
  %17 = load i64, i64* bitcast (%G_0xac22d8_type* @G_0xac22d8 to i64*), align 8
  store i64 %17, i64* %RAX.i16, align 8
  ...
  store i64 %23, i64* %RCX.i13, align 8
  ...
  %DL.i8 = bitcast %union.anon* %37 to i8*
  %38 = xor i1 %33, true
  %39 = zext i1 %38 to i8
  store i8 %39, i8* %DL.i8, align 1
  ...
  %45 = zext i1 %38 to i64
  store i64 %45, i64* %RAX.i16, align 8
  %46 = add i64 %16, 29
