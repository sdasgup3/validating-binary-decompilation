...
@G_0xaad730 = local_unnamed_addr global %G_0xaad730_type zeroinitializer
...
define %struct.Memory* @reading_cache_clear(%struct.State* noalias, i64, %struct.Memory* noalias readnone returned) local_unnamed_addr #0 {
entry:
  ...
  %11 = load i64, i64* bitcast (%G_0xaad730_type* @G_0xaad730 to i64*), align 8
  ...
  %call2_41721c = tail call %struct.Memory* @sub_417120.hashtable_clear(%struct.State* %0, i64 %12, %struct.Memory* %2)
  ...
  ret %struct.Memory* %call2_41721c
}
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_movq_0xaad730___rdi(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned) local_unnamed_addr #1 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  ...
  %5 = load i64, i64* bitcast (%G_0xaad730_type* @G_0xaad730 to i64*), align 8
  store i64 %5, i64* %RDI, align 8
  ret %struct.Memory* %2
}

; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_callq_.hashtable_clear(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr #1 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
