...
declare %struct.Memory* @sub_4327c0.remove_move_reason(%struct.State* noalias dereferenceable(3376), i64, %struct.Memory* noalias readnone returned) local_unnamed_addr

; Function Attrs: alwaysinline
define %struct.Memory* @remove_attack_threat_move(%struct.State* noalias, i64, %struct.Memory* noalias) local_unnamed_addr #1 {
entry:
  ...
  br i1 %58, label %block_43271b, label %entry.block_.L_432735_crit_edge

entry.block_.L_432735_crit_edge:                  ; preds = %entry
...
block_43271b:                                     ; preds = %entry
  ...
  br i1 %101, label %block_.L_432735, label %block_432730
...
block_.L_432735:                                  ; preds = %entry.block_.L_432735_crit_edge, %block_43271b
  %ECX.i62.pre-phi.in = phi %union.anon* [ %.pre12, %entry.block_.L_432735_crit_edge ], [ %82, %block_43271b ]
  %RCX.i68.pre-phi = phi i64* [ %.pre13, %entry.block_.L_432735_crit_edge ], [ %RCX.i84, %block_43271b ]
  %107 = phi i64 [ %78, %entry.block_.L_432735_crit_edge ], [ %105, %block_43271b ]
...
; <label>:143:                                    ; preds = %block_.L_432735
...
; <label>:145:                                    ; preds = %block_.L_432735
...
routine_idivl__ecx.exit:                          ; preds = %202, %200
  ...
  %call2_432789 = tail call %struct.Memory* @sub_452090.abortgo(%struct.State* nonnull %0, i64 %253, %struct.Memory* %208)
...
block_.L_43278e:                                  ; preds = %routine_idivl__ecx.exit, %block_432730
  %RDX.i.pre-phi = phi i64* [ %124, %routine_idivl__ecx.exit ], [ %.pre11, %block_432730 ]
  %RDI.i.pre-phi = phi i64* [ %RDI.i77, %routine_idivl__ecx.exit ], [ %.pre10, %block_432730 ]
  %RAX.i17.pre-phi = phi i64* [ %.pre9, %routine_idivl__ecx.exit ], [ %RAX.i86, %block_432730 ]
  %RSI.i.pre-phi = phi i64* [ %RSI.i75, %routine_idivl__ecx.exit ], [ %.pre8, %block_432730 ]
  %258 = phi i64 [ %.pre7, %routine_idivl__ecx.exit ], [ %51, %block_432730 ]
  %259 = phi i64 [ %.pre6, %routine_idivl__ecx.exit ], [ %106, %block_432730 ]
  %MEMORY.1 = phi %struct.Memory* [ %call2_432789, %routine_idivl__ecx.exit ], [ %2, %block_432730 ]
  ...
  %270 = mul nsw i64 %269, 380
  store i64 %270, i64* %RCX.i12, align 8
  %271 = lshr i64 %270, 63
  %272 = add i64 %270, ptrtoint (%G__0xb0eff0_type* @G__0xb0eff0 to i64)
  store i64 %272, i64* %RAX.i17.pre-phi, align 8
  %273 = icmp ult i64 %272, ptrtoint (%G__0xb0eff0_type* @G__0xb0eff0 to i64)
  ...
  %283 = xor i64 %270, ptrtoint (%G__0xb0eff0_type* @G__0xb0eff0 to i64)
  %284 = xor i64 %283, %272
  %285 = lshr i64 %284, 4
  ...
  %292 = xor i64 %290, lshr (i64 ptrtoint (%G__0xb0eff0_type* @G__0xb0eff0 to i64), i64 63)
  %293 = xor i64 %290, %271
  %294 = add nuw nsw i64 %292, %293
  %295 = icmp eq i64 %294, 2
  %296 = zext i1 %295 to i8
  store i8 %296, i8* %38, align 1
  %297 = add i64 %270, add (i64 ptrtoint (%G__0xb0eff0_type* @G__0xb0eff0 to i64), i64 12)
  %298 = add i64 %259, 35
  ...
  %call2_4327b1 = tail call %struct.Memory* @sub_4327c0.remove_move_reason(%struct.State* nonnull %0, i64 %302, %struct.Memory* %MEMORY.1)
  ...
  ret %struct.Memory* %call2_4327b1
}
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_jae_.L_432735(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i8* nocapture %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_je_.L_432735(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i8* nocapture %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_jmpq_.L_43278e(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_movl__0x2bb___esi(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_callq_.remove_move_reason(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
