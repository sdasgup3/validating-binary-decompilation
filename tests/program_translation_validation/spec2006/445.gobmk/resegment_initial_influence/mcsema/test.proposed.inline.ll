...
define %struct.Memory* @resegment_initial_influence(%struct.State* noalias, i64, %struct.Memory* noalias) #2 {
entry:
  ...
  store %struct.Memory* %loadMem_42d361, %struct.Memory** %MEMORY
  ...
  %RDI.i8 = bitcast %union.anon* %34 to i64*
  %35 = load i64, i64* %PC.i7
  %36 = add i64 %35, 10
  store i64 %36, i64* %PC.i7
  store i64 ptrtoint (%G__0xb7df8c_type* @G__0xb7df8c to i64), i64* %RDI.i8, align 8
  ...
  %PC.i5 = bitcast %union.anon* %53 to i64*
  ...
  store i64 ptrtoint (%G__0xb38cb4_type* @G__0xb38cb4 to i64), i64* %RDI.i, align 8
  ...
  %62 = load i64, i64* %PC.i4
  %63 = add i64 %62, -11373
  %64 = load i64, i64* %PC.i4
  %65 = add i64 %64, 5
  ...
  store %struct.Memory* %loadMem1_42d37d, %struct.Memory** %MEMORY
  ...
  ret %struct.Memory* %loadMem_42d383
}
