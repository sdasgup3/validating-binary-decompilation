...
define %struct.Memory* @scale_randomness(%struct.State* noalias, i64, %struct.Memory* noalias) local_unnamed_addr #1 {
entry:
  ...
  %32 = bitcast %union.VectorReg* %16 to i32*
  ...
  %52 = load i64, i64* %RAX.i39, align 8
  %53 = add i64 %44, %52
  store i64 %53, i64* %RAX.i39, align 8
  %54 = icmp ult i64 %53, %52
  %55 = icmp ult i64 %53, %44
  %56 = or i1 %54, %55
  %57 = zext i1 %56 to i8
  ...
  %81 = load <2 x float>, <2 x float>* %21, align 1
  %82 = extractelement <2 x float> %81, i32 0
  %83 = inttoptr i64 %79 to float*
  %84 = load float, float* %83, align 4
  %85 = fcmp uno float %82, %84
  br i1 %85, label %86, label %96

; <label>:86:                                     ; preds = %entry
  %87 = fadd float %82, %84
  %88 = bitcast float %87 to i32
  %89 = and i32 %88, 2143289344
  %90 = icmp eq i32 %89, 2139095040
  %91 = and i32 %88, 4194303
  %92 = icmp ne i32 %91, 0
  %93 = and i1 %90, %92
  br i1 %93, label %94, label %102

; <label>:94:                                     ; preds = %86
  %95 = tail call %struct.Memory* @__remill_error(%struct.State* nonnull dereferenceable(3376) %0, i64 %80, %struct.Memory* %2)
  %.pre = load i64, i64* %3, align 8
  %.pre1 = load i8, i8* %45, align 1
  %.pre2 = load i8, i8* %48, align 1
  br label %routine_ucomiss_0x44__rax____xmm0.exit

; <label>:96:                                     ; preds = %entry
  %97 = fcmp ogt float %82, %84
...
; <label>:100:                                    ; preds = %98
  %101 = fcmp oeq float %82, %84
  br i1 %101, label %102, label %106

; <label>:102:                                    ; preds = %100, %98, %96, %86
  %103 = phi i8 [ 0, %96 ], [ 0, %98 ], [ 1, %100 ], [ 1, %86 ]
  %104 = phi i8 [ 0, %96 ], [ 0, %98 ], [ 0, %100 ], [ 1, %86 ]
  %105 = phi i8 [ 0, %96 ], [ 1, %98 ], [ 0, %100 ], [ 1, %86 ]
...
; <label>:106:                                    ; preds = %102, %100
  %107 = phi i8 [ %103, %102 ], [ %70, %100 ]
  %108 = phi i8 [ %105, %102 ], [ %57, %100 ]
  store i8 0, i8* %51, align 1
  store i8 0, i8* %50, align 1
  store i8 0, i8* %47, align 1
  br label %routine_ucomiss_0x44__rax____xmm0.exit

routine_ucomiss_0x44__rax____xmm0.exit:           ; preds = %106, %94
  %109 = phi i8 [ %.pre2, %94 ], [ %107, %106 ]
  %110 = phi i8 [ %.pre1, %94 ], [ %108, %106 ]
  %111 = phi i64 [ %.pre, %94 ], [ %80, %106 ]
  %112 = phi %struct.Memory* [ %95, %94 ], [ %2, %106 ]
  %113 = or i8 %109, %110
  %114 = icmp ne i8 %113, 0
  %.v = select i1 %114, i64 40, i64 6
  %115 = add i64 %111, %.v
  store i64 %115, i64* %3, align 8
  br i1 %114, label %block_.L_4378f5, label %block_4378d3
...
block_4378d3:                                     ; preds = %routine_ucomiss_0x44__rax____xmm0.exit
  ...
  %137 = and i8 %136, 1
  %138 = xor i8 %137, 1
  store i8 %138, i8* %46, align 1
  %139 = xor i64 %126, ptrtoint (%G__0xb9d8f0_type* @G__0xb9d8f0 to i64)
  %140 = xor i64 %139, %128
  %141 = lshr i64 %140, 4
  %142 = trunc i64 %141 to i8
  %143 = and i8 %142, 1
  store i8 %143, i8* %47, align 1
  %144 = icmp eq i64 %128, 0
  %145 = zext i1 %144 to i8
  store i8 %145, i8* %48, align 1
  %146 = lshr i64 %128, 63
  %147 = trunc i64 %146 to i8
  store i8 %147, i8* %50, align 1
  ...
  %153 = add i64 %126, add (i64 ptrtoint (%G__0xb9d8f0_type* @G__0xb9d8f0 to i64), i64 68)
  %154 = add i64 %115, 34
  store i64 %154, i64* %3, align 8
  %155 = load <2 x float>, <2 x float>* %21, align 1
  %156 = extractelement <2 x float> %155, i32 0
  %157 = inttoptr i64 %153 to float*
...
block_.L_4378f5:                                  ; preds = %block_4378d3, %routine_ucomiss_0x44__rax____xmm0.exit
  %158 = phi i64 [ %.pre3, %block_4378d3 ], [ %115, %routine_ucomiss_0x44__rax____xmm0.exit ]
  %159 = add i64 %158, 1
...
define %struct.Memory* @routine_ucomiss_0x44__rax____xmm0(%struct.State* dereferenceable(3376), i64, %struct.Memory*) local_unnamed_addr {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %RAX = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 1, i32 0, i32 0
  %3 = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 1, i64 0
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_jbe_.L_4378f5(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i8* nocapture %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
