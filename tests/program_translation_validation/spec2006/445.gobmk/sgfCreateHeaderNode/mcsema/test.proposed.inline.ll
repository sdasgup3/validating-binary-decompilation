...
define %struct.Memory* @sgfCreateHeaderNode(%struct.State* noalias, i64, %struct.Memory* noalias) #2 {
entry:
  ...
  %RBP.i26 = bitcast %union.anon* %88 to i64*
  ...
  %XMM0.i = bitcast %union.VectorReg* %90 to %union.vec128_t*
  %91 = load i64, i64* %RBP.i26
  %92 = sub i64 %91, 8
  %93 = bitcast %union.vec128_t* %XMM0.i to i8*
  ...
  %PC.i24 = bitcast %union.anon* %102 to i64*
  %103 = load i64, i64* %PC.i24
  %104 = add i64 %103, -2976
  %105 = load i64, i64* %PC.i24
  %106 = add i64 %105, 5
  %107 = load i64, i64* %PC.i24
  %108 = add i64 %107, 5
  store i64 %108, i64* %PC.i24
  ...
  store %struct.Memory* %loadMem1_4025d0, %struct.Memory** %MEMORY
  ...
  %RSI.i23 = bitcast %union.anon* %119 to i64*
  %120 = load i64, i64* %PC.i22
  %121 = add i64 %120, 10
  store i64 %121, i64* %PC.i22
  store i64 ptrtoint (%G__0x579c47_type* @G__0x579c47 to i64), i64* %RSI.i23, align 8
  ...
  store i64 %151, i64* %RDI.i17, align 8
  ...
  %PC.i14 = bitcast %union.anon* %154 to i64*
  ...
  %RBP.i15 = bitcast %union.anon* %160 to i64*
  %161 = load i64, i64* %RBP.i15
  %162 = sub i64 %161, 4
  %163 = load i64, i64* %PC.i14
  %164 = add i64 %163, 4
  store i64 %164, i64* %PC.i14
  ...
  %PC.i13 = bitcast %union.anon* %170 to i64*
  %171 = load i64, i64* %PC.i13
  %172 = add i64 %171, -2379
  ...
  store %struct.Memory* %loadMem1_4025eb, %struct.Memory** %MEMORY
  ...
  %PC.i12 = bitcast %union.anon* %184 to i64*
  ...
  %PC.i10 = bitcast %union.anon* %192 to i64*
  ...
  %RBP.i11 = bitcast %union.anon* %198 to i64*
  %199 = load i64, i64* %RBP.i11
  %200 = sub i64 %199, 16
  %201 = load i64, i64* %PC.i10
  %202 = add i64 %201, 4
  store i64 %202, i64* %PC.i10
  ...
  %RBP.i9 = bitcast %union.anon* %210 to i64*
  ...
  %YMM0.i = bitcast %union.VectorReg* %212 to %"class.std::bitset"*
  %213 = bitcast %"class.std::bitset"* %YMM0.i to i8*
  %214 = load i64, i64* %RBP.i9
  %215 = sub i64 %214, 8
  %216 = load i64, i64* %PC.i8
  %217 = add i64 %216, 5
  store i64 %217, i64* %PC.i8
  ...
  ret %struct.Memory* %loadMem_402611
}
