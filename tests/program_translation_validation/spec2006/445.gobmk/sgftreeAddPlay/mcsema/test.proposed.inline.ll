...
define %struct.Memory* @sgftreeAddPlay(%struct.State* noalias, i64, %struct.Memory* noalias) #2 {
entry:
  ...
  store %struct.Memory* %loadMem1_4045f9, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem1_40460f, %struct.Memory** %MEMORY
  ...
  ret %struct.Memory* %loadMem_404621
}
