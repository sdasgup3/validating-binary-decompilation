...
declare %struct.Memory* @sub_402320.sgfAddPlay(%struct.State* noalias dereferenceable(3376), i64, %struct.Memory* noalias readnone returned) local_unnamed_addr

; Function Attrs: alwaysinline
define %struct.Memory* @sgftreeAddPlay(%struct.State* noalias, i64, %struct.Memory* noalias readnone returned) local_unnamed_addr #1 {
entry:
  ...
  %call2_4045f9 = tail call %struct.Memory* @sub_404530.sgftreeNodeCheck(%struct.State* %0, i64 %70, %struct.Memory* %2)
  ...
  %call2_40460f = tail call %struct.Memory* @sub_402320.sgfAddPlay(%struct.State* %0, i64 %102, %struct.Memory* %call2_4045f9)
  ...
  ret %struct.Memory* %call2_40460f
}
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_callq_.sgfAddPlay(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
