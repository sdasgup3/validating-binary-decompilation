...
define %struct.Memory* @sgftreeAddStone(%struct.State* noalias, i64, %struct.Memory* noalias readnone returned) local_unnamed_addr #1 {
entry:
  ...
  %call2_4045b9 = tail call %struct.Memory* @sub_404530.sgftreeNodeCheck(%struct.State* %0, i64 %71, %struct.Memory* %2)
  ...
  %call2_4045cf = tail call %struct.Memory* @sub_4022a0.sgfAddStone(%struct.State* %0, i64 %103, %struct.Memory* %call2_4045b9)
  ...
  ret %struct.Memory* %call2_4045cf
}
