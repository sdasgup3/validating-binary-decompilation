...
define %struct.Memory* @sgftreeMark(%struct.State* noalias, i64, %struct.Memory* noalias) #2 {
entry:
  ...
  store %struct.Memory* %loadMem_4048c4, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem1_4048d6, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem1_4048e9, %struct.Memory** %MEMORY
  ...
  ret %struct.Memory* %loadMem_4048f7
}
