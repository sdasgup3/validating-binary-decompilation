...
declare %struct.Memory* @sub_4029e0.sgfMark(%struct.State* noalias dereferenceable(3376), i64, %struct.Memory* noalias readnone returned) local_unnamed_addr

; Function Attrs: alwaysinline
define %struct.Memory* @sgftreeMark(%struct.State* noalias, i64, %struct.Memory* noalias readnone returned) local_unnamed_addr #1 {
entry:
  ...
  %call2_4048d6 = tail call %struct.Memory* @sub_404530.sgftreeNodeCheck(%struct.State* %0, i64 %63, %struct.Memory* %2)
  ...
  %call2_4048e9 = tail call %struct.Memory* @sub_4029e0.sgfMark(%struct.State* %0, i64 %90, %struct.Memory* %call2_4048d6)
  ...
  ret %struct.Memory* %call2_4048e9
}
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_callq_.sgfMark(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
