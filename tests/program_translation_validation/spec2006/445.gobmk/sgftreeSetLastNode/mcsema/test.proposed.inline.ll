...
define %struct.Memory* @sgftreeSetLastNode(%struct.State* noalias, i64, %struct.Memory* noalias) #2 {
entry:
  ...
  %99 = add i64 %98, 8
  %100 = load i64, i64* %RSI.i
  %101 = load i64, i64* %PC.i4
  %102 = add i64 %101, 4
  store i64 %102, i64* %PC.i4
  ...
  ret %struct.Memory* %loadMem_4049a9
}
