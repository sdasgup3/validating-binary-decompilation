...
define %struct.Memory* @sgftreeSquare(%struct.State* noalias, i64, %struct.Memory* noalias) #2 {
entry:
  ...
  store %struct.Memory* %loadMem_404880, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem1_404896, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_40489b, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem1_4048a9, %struct.Memory** %MEMORY
  ...
  ret %struct.Memory* %loadMem_4048b7
}
