...
define %struct.Memory* @sgftreeStartVariantFirst(%struct.State* noalias, i64, %struct.Memory* noalias readnone returned) local_unnamed_addr #1 {
entry:
  ...
  %call2_404940 = tail call %struct.Memory* @sub_404530.sgftreeNodeCheck(%struct.State* %0, i64 %50, %struct.Memory* %2)
  ...
  %call2_40494d = tail call %struct.Memory* @sub_402400.sgfStartVariantFirst(%struct.State* %0, i64 %67, %struct.Memory* %call2_404940)
  ...
  ret %struct.Memory* %call2_40494d
}
