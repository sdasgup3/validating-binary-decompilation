...
define %struct.Memory* @sgftreeTriangle(%struct.State* noalias, i64, %struct.Memory* noalias) #2 {
entry:
  ...
  store %struct.Memory* %loadMem1_404816, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem1_404829, %struct.Memory** %MEMORY
  ...
  ret %struct.Memory* %loadMem_404837
}
