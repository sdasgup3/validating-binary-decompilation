...
define %struct.Memory* @sgftreeWriteResult(%struct.State* noalias, i64, %struct.Memory* noalias) #2 {
entry:
  ...
  %RDI.i12 = bitcast %union.anon* %120 to i64*
  ...
  store i64 %129, i64* %RDI.i12, align 8
  ...
  %PC.i10 = bitcast %union.anon* %132 to i64*
  ...
  store i64 %140, i64* %RDI.i, align 8
  ...
  %RBP.i9 = bitcast %union.anon* %146 to i64*
  ...
  %YMM0.i = bitcast %union.VectorReg* %148 to %"class.std::bitset"*
  %149 = bitcast %"class.std::bitset"* %YMM0.i to i8*
  ...
  %RBP.i7 = bitcast %union.anon* %171 to i64*
  %172 = load i64, i64* %RBP.i7
  %173 = sub i64 %172, 16
  ...
  ret %struct.Memory* %loadMem_40498d
}
