...
define %struct.Memory* @soft_cap(%struct.State* noalias, i64, %struct.Memory* noalias) #2 {
entry:
  ...
  %loadMem_4e2960 = load %struct.Memory*, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_4e2960, %struct.Memory** %MEMORY
  %loadMem_4e2961 = load %struct.Memory*, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_4e2961, %struct.Memory** %MEMORY
  %loadMem_4e2964 = load %struct.Memory*, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_4e2964, %struct.Memory** %MEMORY
  %loadMem_4e2969 = load %struct.Memory*, %struct.Memory** %MEMORY
  ...
  %PC.i16 = bitcast %union.anon* %48 to i64*
  ...
  %RBP.i17 = bitcast %union.anon* %51 to i64*
  ...
  %XMM1.i18 = bitcast %union.VectorReg* %53 to %union.vec128_t*
  %54 = load i64, i64* %RBP.i17
  %55 = sub i64 %54, 8
  %56 = bitcast %union.vec128_t* %XMM1.i18 to i8*
  %57 = load i64, i64* %PC.i16
  %58 = add i64 %57, 5
  store i64 %58, i64* %PC.i16
  ...
  store %struct.Memory* %loadMem_4e2969, %struct.Memory** %MEMORY
  %loadMem_4e296e = load %struct.Memory*, %struct.Memory** %MEMORY
  ...
  %PC.i13 = bitcast %union.anon* %65 to i64*
  ...
  %RBP.i14 = bitcast %union.anon* %68 to i64*
  ...
  %YMM0.i15 = bitcast %union.VectorReg* %70 to %"class.std::bitset"*
  %71 = bitcast %"class.std::bitset"* %YMM0.i15 to i8*
  %72 = load i64, i64* %RBP.i14
  %73 = sub i64 %72, 4
  %74 = load i64, i64* %PC.i13
  %75 = add i64 %74, 5
  store i64 %75, i64* %PC.i13
  ...
  store %struct.Memory* %loadMem_4e296e, %struct.Memory** %MEMORY
  %loadMem_4e2973 = load %struct.Memory*, %struct.Memory** %MEMORY
  ...
  %RBP.i11 = bitcast %union.anon* %90 to i64*
  ...
  %YMM0.i12 = bitcast %union.VectorReg* %92 to %"class.std::bitset"*
  %93 = bitcast %"class.std::bitset"* %YMM0.i12 to i8*
  %94 = bitcast %"class.std::bitset"* %YMM0.i12 to i8*
  %95 = load i64, i64* %RBP.i11
  %96 = sub i64 %95, 8
  %97 = load i64, i64* %PC.i10
  %98 = add i64 %97, 5
  store i64 %98, i64* %PC.i10
  ...
  store %struct.Memory* %loadMem_4e2973, %struct.Memory** %MEMORY
  %loadMem_4e2978 = load %struct.Memory*, %struct.Memory** %MEMORY
  ...
  %RBP.i8 = bitcast %union.anon* %124 to i64*
  ...
  %YMM1.i9 = bitcast %union.VectorReg* %126 to %"class.std::bitset"*
  %127 = bitcast %"class.std::bitset"* %YMM1.i9 to i8*
  %128 = load i64, i64* %RBP.i8
  %129 = sub i64 %128, 4
  %130 = load i64, i64* %PC.i7
  %131 = add i64 %130, 5
  store i64 %131, i64* %PC.i7
  %132 = inttoptr i64 %129 to float*
  %133 = load float, float* %132
  %134 = bitcast i8* %127 to float*
  store float %133, float* %134, align 1
  %135 = getelementptr inbounds i8, i8* %127, i64 4
  %136 = bitcast i8* %135 to float*
  store float 0.000000e+00, float* %136, align 1
  %137 = getelementptr inbounds i8, i8* %127, i64 8
  %138 = bitcast i8* %137 to float*
  store float 0.000000e+00, float* %138, align 1
  %139 = getelementptr inbounds i8, i8* %127, i64 12
  %140 = bitcast i8* %139 to float*
  store float 0.000000e+00, float* %140, align 1
  store %struct.Memory* %loadMem_4e2978, %struct.Memory** %MEMORY
  %loadMem_4e297d = load %struct.Memory*, %struct.Memory** %MEMORY
  ...
  %RBP.i6 = bitcast %union.anon* %146 to i64*
  ...
  %YMM1.i = bitcast %union.VectorReg* %148 to %"class.std::bitset"*
  %149 = bitcast %"class.std::bitset"* %YMM1.i to i8*
  %150 = bitcast %"class.std::bitset"* %YMM1.i to i8*
  %151 = load i64, i64* %RBP.i6
  %152 = sub i64 %151, 8
  %153 = load i64, i64* %PC.i5
  %154 = add i64 %153, 5
  store i64 %154, i64* %PC.i5
  %155 = bitcast i8* %150 to <2 x float>*
  %156 = load <2 x float>, <2 x float>* %155, align 1
  %157 = getelementptr inbounds i8, i8* %150, i64 8
  %158 = bitcast i8* %157 to <2 x i32>*
  %159 = load <2 x i32>, <2 x i32>* %158, align 1
  %160 = inttoptr i64 %152 to float*
  %161 = load float, float* %160
  %162 = extractelement <2 x float> %156, i32 0
  %163 = fadd float %162, %161
  %164 = bitcast i8* %149 to float*
  store float %163, float* %164, align 1
  %165 = bitcast <2 x float> %156 to <2 x i32>
  %166 = extractelement <2 x i32> %165, i32 1
  %167 = getelementptr inbounds i8, i8* %149, i64 4
  %168 = bitcast i8* %167 to i32*
  store i32 %166, i32* %168, align 1
  %169 = extractelement <2 x i32> %159, i32 0
  %170 = getelementptr inbounds i8, i8* %149, i64 8
  %171 = bitcast i8* %170 to i32*
  store i32 %169, i32* %171, align 1
  %172 = extractelement <2 x i32> %159, i32 1
  %173 = getelementptr inbounds i8, i8* %149, i64 12
  %174 = bitcast i8* %173 to i32*
  store i32 %172, i32* %174, align 1
  store %struct.Memory* %loadMem_4e297d, %struct.Memory** %MEMORY
  %loadMem_4e2982 = load %struct.Memory*, %struct.Memory** %MEMORY
  ...
  %187 = bitcast i8* %183 to <2 x float>*
  %188 = load <2 x float>, <2 x float>* %187, align 1
  %189 = getelementptr inbounds i8, i8* %183, i64 8
  %190 = bitcast i8* %189 to <2 x i32>*
  %191 = load <2 x i32>, <2 x i32>* %190, align 1
  %192 = bitcast i8* %184 to <2 x float>*
  %193 = load <2 x float>, <2 x float>* %192, align 1
  %194 = extractelement <2 x float> %188, i32 0
  %195 = extractelement <2 x float> %193, i32 0
  %196 = fdiv float %194, %195
  %197 = bitcast i8* %182 to float*
  store float %196, float* %197, align 1
  %198 = bitcast <2 x float> %188 to <2 x i32>
  %199 = extractelement <2 x i32> %198, i32 1
  %200 = getelementptr inbounds i8, i8* %182, i64 4
  %201 = bitcast i8* %200 to i32*
  store i32 %199, i32* %201, align 1
  %202 = extractelement <2 x i32> %191, i32 0
  %203 = getelementptr inbounds i8, i8* %182, i64 8
  %204 = bitcast i8* %203 to i32*
  store i32 %202, i32* %204, align 1
  %205 = extractelement <2 x i32> %191, i32 1
  %206 = getelementptr inbounds i8, i8* %182, i64 12
  %207 = bitcast i8* %206 to i32*
  store i32 %205, i32* %207, align 1
  store %struct.Memory* %loadMem_4e2982, %struct.Memory** %MEMORY
  %loadMem_4e2986 = load %struct.Memory*, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_4e2986, %struct.Memory** %MEMORY
  %loadMem_4e2987 = load %struct.Memory*, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_4e2987, %struct.Memory** %MEMORY
  ret %struct.Memory* %loadMem_4e2987
}
...
define %struct.Memory* @routine_addss_MINUS0x8__rbp____xmm1(%struct.State* dereferenceable(3376), i64, %struct.Memory*) {
block_400488:
  %3 = getelementptr inbounds %struct.State, %struct.State* %0, i32 0, i32 6
  %4 = getelementptr inbounds %struct.GPR, %struct.GPR* %3, i32 0, i32 33
  %5 = getelementptr inbounds %struct.Reg, %struct.Reg* %4, i32 0, i32 0
