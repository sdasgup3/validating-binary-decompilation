...
define %struct.Memory* @string_connect(%struct.State* noalias, i64, %struct.Memory* noalias readnone returned) local_unnamed_addr #1 {
entry:
  ...
  br i1 %69, label %block_45296d, label %block_.L_452975
...
block_.L_452975:                                  ; preds = %entry, %block_45296d
  %76 = phi i64 [ %.pre2, %block_45296d ], [ %57, %entry ]
  %77 = phi i64 [ %.pre, %block_45296d ], [ %73, %entry ]
  ...
  br i1 %104, label %block_.L_452975.block_.L_4529b3_crit_edge, label %block_4529a2

block_.L_452975.block_.L_4529b3_crit_edge:        ; preds = %block_.L_452975
...
block_.L_4529b3:                                  ; preds = %block_.L_452975.block_.L_4529b3_crit_edge, %block_4529a2
  %129 = phi i64 [ %105, %block_.L_452975.block_.L_4529b3_crit_edge ], [ %128, %block_4529a2 ]
  %130 = phi i32 [ %106, %block_.L_452975.block_.L_4529b3_crit_edge ], [ %107, %block_4529a2 ]
  %131 = phi i64 [ %.pre3, %block_.L_452975.block_.L_4529b3_crit_edge ], [ %108, %block_4529a2 ]
  ...
  %call2_4529c7 = tail call %struct.Memory* @sub_4529f0.recursive_connect2(%struct.State* nonnull %0, i64 %163, %struct.Memory* %2)
  ...
  ret %struct.Memory* %call2_4529c7
}
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_jne_.L_452975(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i8* nocapture %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_jle_.L_4529b3(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i8* nocapture %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 2, i32 7
