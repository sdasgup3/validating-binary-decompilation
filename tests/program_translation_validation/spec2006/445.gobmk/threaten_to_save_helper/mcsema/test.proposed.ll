...
@G_0x33b51__rip_= global %G_0x33b51__rip__type <{ [8 x i8] c"\00\00\00\00\00\00\00\00" }>
%G_0x33bb0__rip__type = type <{ [8 x i8] }>
@G_0x33bb0__rip_= global %G_0x33bb0__rip__type <{ [8 x i8] c"\00\00\00\00\00\00\00\00" }>
...
define %struct.Memory* @threaten_to_save_helper(%struct.State* noalias , i64, %struct.Memory* noalias) alwaysinline  {
entry:
  ...
  ; Code: .threaten_to_save_helper:	 RIP: 4af480	 Bytes: 0
  ; Code: pushq %rbp	 RIP: 4af480	 Bytes: 1
  %loadMem_4af480 = load %struct.Memory*, %struct.Memory** %MEMORY
  %call_4af480 = call %struct.Memory* @routine_pushq__rbp(%struct.State* %0, i64  0, %struct.Memory* %loadMem_4af480)
  store %struct.Memory* %call_4af480, %struct.Memory** %MEMORY

  ; Code: movq %rsp, %rbp	 RIP: 4af481	 Bytes: 3
  %loadMem_4af481 = load %struct.Memory*, %struct.Memory** %MEMORY
  %call_4af481 = call %struct.Memory* @routine_movq__rsp___rbp(%struct.State* %0, i64  0, %struct.Memory* %loadMem_4af481)
  store %struct.Memory* %call_4af481, %struct.Memory** %MEMORY

  ; Code: subq $0x10, %rsp	 RIP: 4af484	 Bytes: 4
  %loadMem_4af484 = load %struct.Memory*, %struct.Memory** %MEMORY
  %call_4af484 = call %struct.Memory* @routine_subq__0x10___rsp(%struct.State* %0, i64  0, %struct.Memory* %loadMem_4af484)
  store %struct.Memory* %call_4af484, %struct.Memory** %MEMORY

  ; Code: movsd 0x33bb0(%rip), %xmm0	 RIP: 4af488	 Bytes: 8
  %loadMem_4af488 = load %struct.Memory*, %struct.Memory** %MEMORY
  %call_4af488 = call %struct.Memory* @routine_movsd_0x33bb0__rip____xmm0(%struct.State* %0, i64  0, %struct.Memory* %loadMem_4af488)
  store %struct.Memory* %call_4af488, %struct.Memory** %MEMORY

  ; Code: movq $0xb0eff0, %rax	 RIP: 4af490	 Bytes: 10
  %loadMem_4af490 = load %struct.Memory*, %struct.Memory** %MEMORY
  %call_4af490 = call %struct.Memory* @routine_movq__0xb0eff0___rax(%struct.State* %0, i64  0, %struct.Memory* %loadMem_4af490)
  store %struct.Memory* %call_4af490, %struct.Memory** %MEMORY

  ; Code: movl %edi, -0x4(%rbp)	 RIP: 4af49a	 Bytes: 3
  %loadMem_4af49a = load %struct.Memory*, %struct.Memory** %MEMORY
  %call_4af49a = call %struct.Memory* @routine_movl__edi__MINUS0x4__rbp_(%struct.State* %0, i64  0, %struct.Memory* %loadMem_4af49a)
  store %struct.Memory* %call_4af49a, %struct.Memory** %MEMORY

  ; Code: movl %esi, -0x8(%rbp)	 RIP: 4af49d	 Bytes: 3
  %loadMem_4af49d = load %struct.Memory*, %struct.Memory** %MEMORY
  %call_4af49d = call %struct.Memory* @routine_movl__esi__MINUS0x8__rbp_(%struct.State* %0, i64  0, %struct.Memory* %loadMem_4af49d)
  store %struct.Memory* %call_4af49d, %struct.Memory** %MEMORY

  ; Code: movl -0x4(%rbp), %edi	 RIP: 4af4a0	 Bytes: 3
  %loadMem_4af4a0 = load %struct.Memory*, %struct.Memory** %MEMORY
  %call_4af4a0 = call %struct.Memory* @routine_movl_MINUS0x4__rbp____edi(%struct.State* %0, i64  0, %struct.Memory* %loadMem_4af4a0)
  store %struct.Memory* %call_4af4a0, %struct.Memory** %MEMORY

  ; Code: movslq -0x8(%rbp), %rcx	 RIP: 4af4a3	 Bytes: 4
  %loadMem_4af4a3 = load %struct.Memory*, %struct.Memory** %MEMORY
  %call_4af4a3 = call %struct.Memory* @routine_movslq_MINUS0x8__rbp____rcx(%struct.State* %0, i64  0, %struct.Memory* %loadMem_4af4a3)
  store %struct.Memory* %call_4af4a3, %struct.Memory** %MEMORY

  ; Code: imulq $0x17c, %rcx, %rcx	 RIP: 4af4a7	 Bytes: 7
  %loadMem_4af4a7 = load %struct.Memory*, %struct.Memory** %MEMORY
  %call_4af4a7 = call %struct.Memory* @routine_imulq__0x17c___rcx___rcx(%struct.State* %0, i64  0, %struct.Memory* %loadMem_4af4a7)
  store %struct.Memory* %call_4af4a7, %struct.Memory** %MEMORY

  ; Code: addq %rcx, %rax	 RIP: 4af4ae	 Bytes: 3
  %loadMem_4af4ae = load %struct.Memory*, %struct.Memory** %MEMORY
  %call_4af4ae = call %struct.Memory* @routine_addq__rcx___rax(%struct.State* %0, i64  0, %struct.Memory* %loadMem_4af4ae)
  store %struct.Memory* %call_4af4ae, %struct.Memory** %MEMORY

  ; Code: cvtss2sd 0x8(%rax), %xmm1	 RIP: 4af4b1	 Bytes: 5
  %loadMem_4af4b1 = load %struct.Memory*, %struct.Memory** %MEMORY
  %call_4af4b1 = call %struct.Memory* @routine_cvtss2sd_0x8__rax____xmm1(%struct.State* %0, i64  0, %struct.Memory* %loadMem_4af4b1)
  store %struct.Memory* %call_4af4b1, %struct.Memory** %MEMORY

  ; Code: movaps %xmm0, %xmm2	 RIP: 4af4b6	 Bytes: 3
  %loadMem_4af4b6 = load %struct.Memory*, %struct.Memory** %MEMORY
  %call_4af4b6 = call %struct.Memory* @routine_movaps__xmm0___xmm2(%struct.State* %0, i64  0, %struct.Memory* %loadMem_4af4b6)
  store %struct.Memory* %call_4af4b6, %struct.Memory** %MEMORY

  ; Code: mulsd %xmm1, %xmm2	 RIP: 4af4b9	 Bytes: 4
  %loadMem_4af4b9 = load %struct.Memory*, %struct.Memory** %MEMORY
  %call_4af4b9 = call %struct.Memory* @routine_mulsd__xmm1___xmm2(%struct.State* %0, i64  0, %struct.Memory* %loadMem_4af4b9)
  store %struct.Memory* %call_4af4b9, %struct.Memory** %MEMORY

  ; Code: addsd %xmm2, %xmm0	 RIP: 4af4bd	 Bytes: 4
  %loadMem_4af4bd = load %struct.Memory*, %struct.Memory** %MEMORY
  %call_4af4bd = call %struct.Memory* @routine_addsd__xmm2___xmm0(%struct.State* %0, i64  0, %struct.Memory* %loadMem_4af4bd)
  store %struct.Memory* %call_4af4bd, %struct.Memory** %MEMORY

  ; Code: cvtsd2ss %xmm0, %xmm0	 RIP: 4af4c1	 Bytes: 4
  %loadMem_4af4c1 = load %struct.Memory*, %struct.Memory** %MEMORY
  %call_4af4c1 = call %struct.Memory* @routine_cvtsd2ss__xmm0___xmm0(%struct.State* %0, i64  0, %struct.Memory* %loadMem_4af4c1)
  store %struct.Memory* %call_4af4c1, %struct.Memory** %MEMORY

  ; Code: callq .add_followup_value	 RIP: 4af4c5	 Bytes: 5
  %loadMem1_4af4c5 = load %struct.Memory*, %struct.Memory** %MEMORY
  %call1_4af4c5 = call %struct.Memory* @routine_callq_.add_followup_value(%struct.State* %0, i64  0, %struct.Memory* %loadMem1_4af4c5, i64 -501605, i64 5, i64 5)
  store %struct.Memory* %call1_4af4c5, %struct.Memory** %MEMORY
  ...
  ; Code: cmpl $0x0, 0xab0f28	 RIP: 4af4ca	 Bytes: 8
  %loadMem_4af4ca = load %struct.Memory*, %struct.Memory** %MEMORY
  %call_4af4ca = call %struct.Memory* @routine_cmpl__0x0__0xab0f28(%struct.State* %0, i64  0, %struct.Memory* %loadMem_4af4ca)
  store %struct.Memory* %call_4af4ca, %struct.Memory** %MEMORY

  ; Code: jne .L_4af4dd	 RIP: 4af4d2	 Bytes: 6
  %loadMem_4af4d2 = load %struct.Memory*, %struct.Memory** %MEMORY
  %call_4af4d2 = call %struct.Memory* @routine_jne_.L_4af4dd(%struct.State* %0, i64  0, %struct.Memory* %loadMem_4af4d2, i8* %BRANCH_TAKEN, i64 11, i64 6, i64 6)
...
block_4af4d8:
  ; Code: jmpq .L_4af521	 RIP: 4af4d8	 Bytes: 5
  %loadMem_4af4d8 = load %struct.Memory*, %struct.Memory** %MEMORY
  %call_4af4d8 = call %struct.Memory* @routine_jmpq_.L_4af521(%struct.State* %0, i64  0, %struct.Memory* %loadMem_4af4d8, i64 73, i64 5)
  store %struct.Memory* %call_4af4d8, %struct.Memory** %MEMORY

  br label %block_.L_4af521

  ; Code: .L_4af4dd:	 RIP: 4af4dd	 Bytes: 0
block_.L_4af4dd:

  ; Code: movq $0x58174d, %rdi	 RIP: 4af4dd	 Bytes: 10
  %loadMem_4af4dd = load %struct.Memory*, %struct.Memory** %MEMORY
  %call_4af4dd = call %struct.Memory* @routine_movq__0x58174d___rdi(%struct.State* %0, i64  0, %struct.Memory* %loadMem_4af4dd)
  store %struct.Memory* %call_4af4dd, %struct.Memory** %MEMORY

  ; Code: movsd 0x33b51(%rip), %xmm0	 RIP: 4af4e7	 Bytes: 8
  %loadMem_4af4e7 = load %struct.Memory*, %struct.Memory** %MEMORY
  %call_4af4e7 = call %struct.Memory* @routine_movsd_0x33b51__rip____xmm0(%struct.State* %0, i64  0, %struct.Memory* %loadMem_4af4e7)
  store %struct.Memory* %call_4af4e7, %struct.Memory** %MEMORY

  ; Code: movq $0xb0eff0, %rax	 RIP: 4af4ef	 Bytes: 10
  %loadMem_4af4ef = load %struct.Memory*, %struct.Memory** %MEMORY
  %call_4af4ef = call %struct.Memory* @routine_movq__0xb0eff0___rax(%struct.State* %0, i64  0, %struct.Memory* %loadMem_4af4ef)
  store %struct.Memory* %call_4af4ef, %struct.Memory** %MEMORY

  ; Code: movslq -0x8(%rbp), %rcx	 RIP: 4af4f9	 Bytes: 4
  %loadMem_4af4f9 = load %struct.Memory*, %struct.Memory** %MEMORY
  %call_4af4f9 = call %struct.Memory* @routine_movslq_MINUS0x8__rbp____rcx(%struct.State* %0, i64  0, %struct.Memory* %loadMem_4af4f9)
  store %struct.Memory* %call_4af4f9, %struct.Memory** %MEMORY

  ; Code: imulq $0x17c, %rcx, %rcx	 RIP: 4af4fd	 Bytes: 7
  %loadMem_4af4fd = load %struct.Memory*, %struct.Memory** %MEMORY
  %call_4af4fd = call %struct.Memory* @routine_imulq__0x17c___rcx___rcx(%struct.State* %0, i64  0, %struct.Memory* %loadMem_4af4fd)
  store %struct.Memory* %call_4af4fd, %struct.Memory** %MEMORY

  ; Code: addq %rcx, %rax	 RIP: 4af504	 Bytes: 3
  %loadMem_4af504 = load %struct.Memory*, %struct.Memory** %MEMORY
  %call_4af504 = call %struct.Memory* @routine_addq__rcx___rax(%struct.State* %0, i64  0, %struct.Memory* %loadMem_4af504)
  store %struct.Memory* %call_4af504, %struct.Memory** %MEMORY

  ; Code: cvtss2sd 0x8(%rax), %xmm1	 RIP: 4af507	 Bytes: 5
  %loadMem_4af507 = load %struct.Memory*, %struct.Memory** %MEMORY
  %call_4af507 = call %struct.Memory* @routine_cvtss2sd_0x8__rax____xmm1(%struct.State* %0, i64  0, %struct.Memory* %loadMem_4af507)
  store %struct.Memory* %call_4af507, %struct.Memory** %MEMORY

  ; Code: movaps %xmm0, %xmm2	 RIP: 4af50c	 Bytes: 3
  %loadMem_4af50c = load %struct.Memory*, %struct.Memory** %MEMORY
  %call_4af50c = call %struct.Memory* @routine_movaps__xmm0___xmm2(%struct.State* %0, i64  0, %struct.Memory* %loadMem_4af50c)
  store %struct.Memory* %call_4af50c, %struct.Memory** %MEMORY

  ; Code: mulsd %xmm1, %xmm2	 RIP: 4af50f	 Bytes: 4
  %loadMem_4af50f = load %struct.Memory*, %struct.Memory** %MEMORY
  %call_4af50f = call %struct.Memory* @routine_mulsd__xmm1___xmm2(%struct.State* %0, i64  0, %struct.Memory* %loadMem_4af50f)
  store %struct.Memory* %call_4af50f, %struct.Memory** %MEMORY

  ; Code: addsd %xmm2, %xmm0	 RIP: 4af513	 Bytes: 4
  %loadMem_4af513 = load %struct.Memory*, %struct.Memory** %MEMORY
  %call_4af513 = call %struct.Memory* @routine_addsd__xmm2___xmm0(%struct.State* %0, i64  0, %struct.Memory* %loadMem_4af513)
  store %struct.Memory* %call_4af513, %struct.Memory** %MEMORY

  ; Code: movb $0x1, %al	 RIP: 4af517	 Bytes: 2
  %loadMem_4af517 = load %struct.Memory*, %struct.Memory** %MEMORY
  %call_4af517 = call %struct.Memory* @routine_movb__0x1___al(%struct.State* %0, i64  0, %struct.Memory* %loadMem_4af517)
  store %struct.Memory* %call_4af517, %struct.Memory** %MEMORY

  ; Code: callq .gprintf	 RIP: 4af519	 Bytes: 5
  %loadMem1_4af519 = load %struct.Memory*, %struct.Memory** %MEMORY
  %call1_4af519 = call %struct.Memory* @routine_callq_.gprintf(%struct.State* %0, i64  0, %struct.Memory* %loadMem1_4af519, i64 -382825, i64 5, i64 5)
  store %struct.Memory* %call1_4af519, %struct.Memory** %MEMORY
  ...
  ; Code: movl %eax, -0xc(%rbp)	 RIP: 4af51e	 Bytes: 3
  %loadMem_4af51e = load %struct.Memory*, %struct.Memory** %MEMORY
  %call_4af51e = call %struct.Memory* @routine_movl__eax__MINUS0xc__rbp_(%struct.State* %0, i64  0, %struct.Memory* %loadMem_4af51e)
  store %struct.Memory* %call_4af51e, %struct.Memory** %MEMORY

  ; Code: .L_4af521:	 RIP: 4af521	 Bytes: 0
  br label %block_.L_4af521
block_.L_4af521:

  ; Code: addq $0x10, %rsp	 RIP: 4af521	 Bytes: 4
  %loadMem_4af521 = load %struct.Memory*, %struct.Memory** %MEMORY
  %call_4af521 = call %struct.Memory* @routine_addq__0x10___rsp(%struct.State* %0, i64  0, %struct.Memory* %loadMem_4af521)
  store %struct.Memory* %call_4af521, %struct.Memory** %MEMORY

  ; Code: popq %rbp	 RIP: 4af525	 Bytes: 1
  %loadMem_4af525 = load %struct.Memory*, %struct.Memory** %MEMORY
  %call_4af525 = call %struct.Memory* @routine_popq__rbp(%struct.State* %0, i64  0, %struct.Memory* %loadMem_4af525)
  store %struct.Memory* %call_4af525, %struct.Memory** %MEMORY

  ; Code: retq	 RIP: 4af526	 Bytes: 1
  %loadMem_4af526 = load %struct.Memory*, %struct.Memory** %MEMORY
  %call_4af526 = call %struct.Memory* @routine_retq(%struct.State* %0, i64  0, %struct.Memory* %loadMem_4af526)
  store %struct.Memory* %call_4af526, %struct.Memory** %MEMORY

  ret %struct.Memory* %call_4af526
}
...
define %struct.Memory* @routine_movsd_0x33bb0__rip____xmm0(%struct.State*  dereferenceable(3376), i64, %struct.Memory* ) #19 {
block_400488:
  %3 = getelementptr inbounds %struct.State, %struct.State* %0, i32 0, i32 6
  %4 = getelementptr inbounds %struct.GPR, %struct.GPR* %3, i32 0, i32 33
  %5 = getelementptr inbounds %struct.Reg, %struct.Reg* %4, i32 0, i32 0
...
define %struct.Memory* @routine_movsd_0x33b51__rip____xmm0(%struct.State*  dereferenceable(3376), i64, %struct.Memory* ) #19 {
block_400488:
  %3 = getelementptr inbounds %struct.State, %struct.State* %0, i32 0, i32 6
  %4 = getelementptr inbounds %struct.GPR, %struct.GPR* %3, i32 0, i32 33
  %5 = getelementptr inbounds %struct.Reg, %struct.Reg* %4, i32 0, i32 0
