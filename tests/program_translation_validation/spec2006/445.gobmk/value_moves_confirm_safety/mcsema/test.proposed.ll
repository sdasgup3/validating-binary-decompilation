...
define %struct.Memory* @value_moves_confirm_safety(%struct.State* noalias , i64, %struct.Memory* noalias) alwaysinline  {
entry:
  ...
  ; Code: .value_moves_confirm_safety:	 RIP: 4850c0	 Bytes: 0
  ; Code: pushq %rbp	 RIP: 4850c0	 Bytes: 1
  %loadMem_4850c0 = load %struct.Memory*, %struct.Memory** %MEMORY
  %call_4850c0 = call %struct.Memory* @routine_pushq__rbp(%struct.State* %0, i64  0, %struct.Memory* %loadMem_4850c0)
  store %struct.Memory* %call_4850c0, %struct.Memory** %MEMORY

  ; Code: movq %rsp, %rbp	 RIP: 4850c1	 Bytes: 3
  %loadMem_4850c1 = load %struct.Memory*, %struct.Memory** %MEMORY
  %call_4850c1 = call %struct.Memory* @routine_movq__rsp___rbp(%struct.State* %0, i64  0, %struct.Memory* %loadMem_4850c1)
  store %struct.Memory* %call_4850c1, %struct.Memory** %MEMORY

  ; Code: subq $0x10, %rsp	 RIP: 4850c4	 Bytes: 4
  %loadMem_4850c4 = load %struct.Memory*, %struct.Memory** %MEMORY
  %call_4850c4 = call %struct.Memory* @routine_subq__0x10___rsp(%struct.State* %0, i64  0, %struct.Memory* %loadMem_4850c4)
  store %struct.Memory* %call_4850c4, %struct.Memory** %MEMORY

  ; Code: movl %edi, -0x4(%rbp)	 RIP: 4850c8	 Bytes: 3
  %loadMem_4850c8 = load %struct.Memory*, %struct.Memory** %MEMORY
  %call_4850c8 = call %struct.Memory* @routine_movl__edi__MINUS0x4__rbp_(%struct.State* %0, i64  0, %struct.Memory* %loadMem_4850c8)
  store %struct.Memory* %call_4850c8, %struct.Memory** %MEMORY

  ; Code: movl %esi, -0x8(%rbp)	 RIP: 4850cb	 Bytes: 3
  %loadMem_4850cb = load %struct.Memory*, %struct.Memory** %MEMORY
  %call_4850cb = call %struct.Memory* @routine_movl__esi__MINUS0x8__rbp_(%struct.State* %0, i64  0, %struct.Memory* %loadMem_4850cb)
  store %struct.Memory* %call_4850cb, %struct.Memory** %MEMORY

  ; Code: movl -0x4(%rbp), %edi	 RIP: 4850ce	 Bytes: 3
  %loadMem_4850ce = load %struct.Memory*, %struct.Memory** %MEMORY
  %call_4850ce = call %struct.Memory* @routine_movl_MINUS0x4__rbp____edi(%struct.State* %0, i64  0, %struct.Memory* %loadMem_4850ce)
  store %struct.Memory* %call_4850ce, %struct.Memory** %MEMORY

  ; Code: movl -0x8(%rbp), %esi	 RIP: 4850d1	 Bytes: 3
  %loadMem_4850d1 = load %struct.Memory*, %struct.Memory** %MEMORY
  %call_4850d1 = call %struct.Memory* @routine_movl_MINUS0x8__rbp____esi(%struct.State* %0, i64  0, %struct.Memory* %loadMem_4850d1)
  store %struct.Memory* %call_4850d1, %struct.Memory** %MEMORY

  ; Code: callq .value_moves_get_blunder_size	 RIP: 4850d4	 Bytes: 5
  %loadMem1_4850d4 = load %struct.Memory*, %struct.Memory** %MEMORY
  %call1_4850d4 = call %struct.Memory* @routine_callq_.value_moves_get_blunder_size(%struct.State* %0, i64  0, %struct.Memory* %loadMem1_4850d4, i64 -20820, i64 5, i64 5)
  store %struct.Memory* %call1_4850d4, %struct.Memory** %MEMORY
  ...
  ; Code: xorps %xmm1, %xmm1	 RIP: 4850d9	 Bytes: 3
  %loadMem_4850d9 = load %struct.Memory*, %struct.Memory** %MEMORY
  %call_4850d9 = call %struct.Memory* @routine_xorps__xmm1___xmm1(%struct.State* %0, i64  0, %struct.Memory* %loadMem_4850d9)
  store %struct.Memory* %call_4850d9, %struct.Memory** %MEMORY

  ; Code: cvtss2sd %xmm0, %xmm0	 RIP: 4850dc	 Bytes: 4
  %loadMem_4850dc = load %struct.Memory*, %struct.Memory** %MEMORY
  %call_4850dc = call %struct.Memory* @routine_cvtss2sd__xmm0___xmm0(%struct.State* %0, i64  0, %struct.Memory* %loadMem_4850dc)
  store %struct.Memory* %call_4850dc, %struct.Memory** %MEMORY

  ; Code: ucomisd %xmm1, %xmm0	 RIP: 4850e0	 Bytes: 4
  %loadMem_4850e0 = load %struct.Memory*, %struct.Memory** %MEMORY
  %call_4850e0 = call %struct.Memory* @routine_ucomisd__xmm1___xmm0(%struct.State* %0, i64  0, %struct.Memory* %loadMem_4850e0)
  store %struct.Memory* %call_4850e0, %struct.Memory** %MEMORY

  ; Code: sete %al	 RIP: 4850e4	 Bytes: 3
  %loadMem_4850e4 = load %struct.Memory*, %struct.Memory** %MEMORY
  %call_4850e4 = call %struct.Memory* @routine_sete__al(%struct.State* %0, i64  0, %struct.Memory* %loadMem_4850e4)
  store %struct.Memory* %call_4850e4, %struct.Memory** %MEMORY

  ; Code: setnp %cl	 RIP: 4850e7	 Bytes: 3
  %loadMem_4850e7 = load %struct.Memory*, %struct.Memory** %MEMORY
  %call_4850e7 = call %struct.Memory* @routine_setnp__cl(%struct.State* %0, i64  0, %struct.Memory* %loadMem_4850e7)
  store %struct.Memory* %call_4850e7, %struct.Memory** %MEMORY

  ; Code: andb %cl, %al	 RIP: 4850ea	 Bytes: 2
  %loadMem_4850ea = load %struct.Memory*, %struct.Memory** %MEMORY
  %call_4850ea = call %struct.Memory* @routine_andb__cl___al(%struct.State* %0, i64  0, %struct.Memory* %loadMem_4850ea)
  store %struct.Memory* %call_4850ea, %struct.Memory** %MEMORY

  ; Code: andb $0x1, %al	 RIP: 4850ec	 Bytes: 2
  %loadMem_4850ec = load %struct.Memory*, %struct.Memory** %MEMORY
  %call_4850ec = call %struct.Memory* @routine_andb__0x1___al(%struct.State* %0, i64  0, %struct.Memory* %loadMem_4850ec)
  store %struct.Memory* %call_4850ec, %struct.Memory** %MEMORY

  ; Code: movzbl %al, %eax	 RIP: 4850ee	 Bytes: 3
  %loadMem_4850ee = load %struct.Memory*, %struct.Memory** %MEMORY
  %call_4850ee = call %struct.Memory* @routine_movzbl__al___eax(%struct.State* %0, i64  0, %struct.Memory* %loadMem_4850ee)
  store %struct.Memory* %call_4850ee, %struct.Memory** %MEMORY

  ; Code: addq $0x10, %rsp	 RIP: 4850f1	 Bytes: 4
  %loadMem_4850f1 = load %struct.Memory*, %struct.Memory** %MEMORY
  %call_4850f1 = call %struct.Memory* @routine_addq__0x10___rsp(%struct.State* %0, i64  0, %struct.Memory* %loadMem_4850f1)
  store %struct.Memory* %call_4850f1, %struct.Memory** %MEMORY

  ; Code: popq %rbp	 RIP: 4850f5	 Bytes: 1
  %loadMem_4850f5 = load %struct.Memory*, %struct.Memory** %MEMORY
  %call_4850f5 = call %struct.Memory* @routine_popq__rbp(%struct.State* %0, i64  0, %struct.Memory* %loadMem_4850f5)
  store %struct.Memory* %call_4850f5, %struct.Memory** %MEMORY

  ; Code: retq	 RIP: 4850f6	 Bytes: 1
  %loadMem_4850f6 = load %struct.Memory*, %struct.Memory** %MEMORY
  %call_4850f6 = call %struct.Memory* @routine_retq(%struct.State* %0, i64  0, %struct.Memory* %loadMem_4850f6)
  store %struct.Memory* %call_4850f6, %struct.Memory** %MEMORY

  ret %struct.Memory* %call_4850f6
}
