...
define %struct.Memory* @vital_chain(%struct.State* noalias, i64, %struct.Memory* noalias readnone returned) local_unnamed_addr #1 {
entry:
  ...
  %42 = add i64 %7, -24
  store i64 %42, i64* %RCX.i, align 8
  ...
  %55 = load i64, i64* bitcast (%G_0xac22d8_type* @G_0xac22d8 to i64*), align 8
  store i64 %55, i64* %R8.i, align 8
  %56 = add i64 %50, -33735
  %57 = add i64 %50, 16
  ...
  %call2_44da12 = tail call %struct.Memory* @sub_445640.sniff_lunch(%struct.State* %0, i64 %56, %struct.Memory* %2)
  ...
  ret %struct.Memory* %call2_44da12
}
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_movq_0xac22d8___r8(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
