...
@G_0xb7af8__rip_ = global %G_0xb7af8__rip__type zeroinitializer
@G_0xb7b52__rip_ = global %G_0xb7b52__rip__type zeroinitializer
@G_0xb7b57__rip_ = global %G_0xb7b57__rip__type zeroinitializer
@G_0xb7b6f__rip_ = global %G_0xb7b6f__rip__type zeroinitializer
@G_0xb7bb1__rip_ = global %G_0xb7bb1__rip__type zeroinitializer
@G_0xb7bc9__rip_ = global %G_0xb7bc9__rip__type zeroinitializer
...
define %struct.Memory* @whose_moyo(%struct.State* noalias, i64, %struct.Memory* noalias) local_unnamed_addr #1 {
entry:
  ...
  %call2_42b412 = tail call %struct.Memory* @sub_42b250.whose_territory(%struct.State* %0, i64 %116, %struct.Memory* %2)
  ...
  br i1 %138, label %block_.L_42b42f, label %block_42b424

block_42b424:                                     ; preds = %entry
  %143 = add i64 %142, 3
...
block_.L_42b42f:                                  ; preds = %entry
  %151 = add i64 %142, ptrtoint (%G_0xb7bc9__rip__type* @G_0xb7bc9__rip_ to i64)
  %152 = add i64 %142, 8
...
; <label>:176:                                    ; preds = %block_.L_42b42f
...
; <label>:184:                                    ; preds = %176
  %185 = tail call %struct.Memory* @__remill_error(%struct.State* nonnull dereferenceable(3376) %0, i64 %174, %struct.Memory* %call2_42b412)
  %.pre = load i64, i64* %3, align 8
  %.pre7 = load i8, i8* %14, align 1
  %.pre8 = load i8, i8* %29, align 1
  br label %routine_ucomisd__xmm0___xmm1.exit79

; <label>:186:                                    ; preds = %block_.L_42b42f
...
routine_ucomisd__xmm0___xmm1.exit79:              ; preds = %196, %184
  ...
  %202 = phi %struct.Memory* [ %185, %184 ], [ %call2_42b412, %196 ]
  %203 = or i8 %199, %200
  %204 = icmp ne i8 %203, 0
  %.v25 = select i1 %204, i64 64, i64 6
  %205 = add i64 %201, %.v25
  store i64 %205, i64* %3, align 8
  br i1 %204, label %block_.L_42b489, label %block_42b44f

block_42b44f:                                     ; preds = %routine_ucomisd__xmm0___xmm1.exit79
  %206 = add i64 %205, ptrtoint (%G_0xb7bb1__rip__type* @G_0xb7bb1__rip_ to i64)
  %207 = add i64 %205, 8
...
routine_ucomisd__xmm0___xmm1.exit66:              ; preds = %239, %227
  ...
  br i1 %247, label %block_.L_42b489, label %block_42b466

block_42b466:                                     ; preds = %routine_ucomisd__xmm0___xmm1.exit66
  %249 = add i64 %248, ptrtoint (%G_0xb7b52__rip__type* @G_0xb7b52__rip_ to i64)
  %250 = add i64 %248, 8
...
routine_ucomisd__xmm1___xmm0.exit54:              ; preds = %282, %270
  ...
  br i1 %290, label %block_.L_42b489, label %block_42b47d

block_42b47d:                                     ; preds = %routine_ucomisd__xmm1___xmm0.exit54
...
block_.L_42b489:                                  ; preds = %routine_ucomisd__xmm1___xmm0.exit54, %routine_ucomisd__xmm0___xmm1.exit66, %routine_ucomisd__xmm0___xmm1.exit79
  ...
  %301 = add i64 %300, ptrtoint (%G_0xb7b6f__rip__type* @G_0xb7b6f__rip_ to i64)
  %302 = add i64 %300, 8
...
; <label>:320:                                    ; preds = %block_.L_42b489
...
; <label>:330:                                    ; preds = %block_.L_42b489
...
routine_ucomisd__xmm0___xmm1.exit35:              ; preds = %340, %328
  ...
  br i1 %348, label %block_.L_42b4e3, label %block_42b4a9

block_42b4a9:                                     ; preds = %routine_ucomisd__xmm0___xmm1.exit35
  %350 = add i64 %349, ptrtoint (%G_0xb7b57__rip__type* @G_0xb7b57__rip_ to i64)
  %351 = add i64 %349, 8
...
routine_ucomisd__xmm0___xmm1.exit:                ; preds = %383, %371
  ...
  br i1 %391, label %block_.L_42b4e3, label %block_42b4c0

block_42b4c0:                                     ; preds = %routine_ucomisd__xmm0___xmm1.exit
  %393 = add i64 %392, ptrtoint (%G_0xb7af8__rip__type* @G_0xb7af8__rip_ to i64)
  %394 = add i64 %392, 8
...
routine_ucomisd__xmm1___xmm0.exit:                ; preds = %426, %414
  ...
  br i1 %434, label %block_.L_42b4e3, label %block_42b4d7

block_42b4d7:                                     ; preds = %routine_ucomisd__xmm1___xmm0.exit
...
block_.L_42b4e3:                                  ; preds = %routine_ucomisd__xmm1___xmm0.exit, %routine_ucomisd__xmm0___xmm1.exit, %routine_ucomisd__xmm0___xmm1.exit35
...
block_.L_42b4ea:                                  ; preds = %block_.L_42b4e3, %block_42b4d7, %block_42b47d, %block_42b424
  %447 = phi i64 [ %.pre24, %block_.L_42b4e3 ], [ %441, %block_42b4d7 ], [ %297, %block_42b47d ], [ %150, %block_42b424 ]
  %MEMORY.2 = phi %struct.Memory* [ %MEMORY.1, %block_.L_42b4e3 ], [ %432, %block_42b4d7 ], [ %288, %block_42b47d ], [ %call2_42b412, %block_42b424 ]
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_je_.L_42b42f(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i8* nocapture %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_jmpq_.L_42b4ea(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_movsd_0xb7bc9__rip____xmm0(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, ptrtoint (%G_0xb7bc9__rip__type* @G_0xb7bc9__rip_ to i64)
  %5 = add i64 %3, 8
  store i64 %5, i64* %PC, align 8
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_jbe_.L_42b489(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i8* nocapture %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_movsd_0xb7bb1__rip____xmm0(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, ptrtoint (%G_0xb7bb1__rip__type* @G_0xb7bb1__rip_ to i64)
  %5 = add i64 %3, 8
  store i64 %5, i64* %PC, align 8
  %6 = inttoptr i64 %4 to i64*
  %7 = load i64, i64* %6, align 8
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_movsd_0xb7b52__rip____xmm0(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, ptrtoint (%G_0xb7b52__rip__type* @G_0xb7b52__rip_ to i64)
  %5 = add i64 %3, 8
  store i64 %5, i64* %PC, align 8
  %6 = inttoptr i64 %4 to i64*
  %7 = load i64, i64* %6, align 8
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_movsd_0xb7b6f__rip____xmm0(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, ptrtoint (%G_0xb7b6f__rip__type* @G_0xb7b6f__rip_ to i64)
  %5 = add i64 %3, 8
  store i64 %5, i64* %PC, align 8
  %6 = inttoptr i64 %4 to i64*
  %7 = load i64, i64* %6, align 8
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_jbe_.L_42b4e3(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i8* nocapture %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 2, i32 1
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_movsd_0xb7b57__rip____xmm0(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, ptrtoint (%G_0xb7b57__rip__type* @G_0xb7b57__rip_ to i64)
  %5 = add i64 %3, 8
  store i64 %5, i64* %PC, align 8
  %6 = inttoptr i64 %4 to i64*
  %7 = load i64, i64* %6, align 8
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_movsd_0xb7af8__rip____xmm0(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, ptrtoint (%G_0xb7af8__rip__type* @G_0xb7af8__rip_ to i64)
  %5 = add i64 %3, 8
  store i64 %5, i64* %PC, align 8
  %6 = inttoptr i64 %4 to i64*
  %7 = load i64, i64* %6, align 8
