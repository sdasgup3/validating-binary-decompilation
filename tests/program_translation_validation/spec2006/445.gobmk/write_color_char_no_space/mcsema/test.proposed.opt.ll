...
define %struct.Memory* @write_color_char_no_space(%struct.State* noalias, i64, %struct.Memory* noalias) local_unnamed_addr #1 {
entry:
  ...
  %RAX.i21 = getelementptr inbounds %union.anon, %union.anon* %40, i64 0, i32 0
  store i64 ptrtoint (%G__0x579d93_type* @G__0x579d93 to i64), i64* %RAX.i21, align 8
  ...
  %54 = load i64, i64* bitcast (%G_0x99c0a0_type* @G_0x99c0a0 to i64*), align 8
  ...
  %61 = load i64, i64* %RAX.i21, align 8
  store i64 %61, i64* %RSI.i, align 8
  %AL.i = bitcast %union.anon* %40 to i8*
  store i8 0, i8* %AL.i, align 1
  %62 = add i64 %53, -922424
  %63 = add i64 %53, 21
  ...
  %67 = tail call %struct.Memory* @__remill_function_call(%struct.State* %0, i64 ptrtoint (i64 (i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64)* @fprintf to i64), %struct.Memory* %2)
  %EAX.i = bitcast %union.anon* %40 to i32*
  %68 = load i64, i64* %RBP.i, align 8
  %69 = add i64 %68, -12
  %70 = load i32, i32* %EAX.i, align 4
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_movq__0x579d93___rax(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  ...
  store i64 ptrtoint (%G__0x579d93_type* @G__0x579d93 to i64), i64* %RAX, align 8
  ret %struct.Memory* %2
}
