...
define %struct.Memory* @DCopy(%struct.State* noalias, i64, %struct.Memory* noalias readnone returned) local_unnamed_addr #1 {
entry:
...
block_.L_4521c6:                                  ; preds = %block_4521d2, %entry
  %42 = phi i64 [ %134, %block_4521d2 ], [ %.pre, %entry ]
  ...
  %77 = icmp ne i8 %69, 0
  %78 = xor i1 %77, %75
  %.v = select i1 %78, i64 12, i64 52
  %79 = add i64 %42, %.v
  store i64 %79, i64* %3, align 8
  br i1 %78, label %block_4521d2, label %block_.L_4521fa
...
block_4521d2:                                     ; preds = %block_.L_4521c6
  ...
  store i64 %83, i64* %RAX.i33, align 8
  %84 = add i64 %79, 8
  ...
  store i64 %98, i64* %RCX.i23, align 8
  %99 = shl nsw i64 %98, 3
  %100 = add i64 %99, %95
  %101 = add i64 %79, 26
  ...
  store i64 %110, i64* %RAX.i33, align 8
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_jge_.L_4521fa(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i8* nocapture %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_jmpq_.L_4521c6(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
