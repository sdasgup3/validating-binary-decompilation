...
define %struct.Memory* @DExp(%struct.State* noalias, i64, %struct.Memory* noalias) local_unnamed_addr #1 {
entry:
...
block_.L_4529b6:                                  ; preds = %block_4529c2, %entry
  %59 = phi i64 [ %.pre, %entry ], [ %162, %block_4529c2 ]
  %MEMORY.0 = phi %struct.Memory* [ %2, %entry ], [ %114, %block_4529c2 ]
  ...
  store i64 %65, i64* %RAX.i38, align 8
  %66 = add i64 %60, -12
  %67 = add i64 %59, 6
  ...
  %94 = icmp ne i8 %86, 0
  %95 = xor i1 %94, %92
  %.v = select i1 %95, i64 12, i64 57
  %96 = add i64 %59, %.v
  store i64 %96, i64* %3, align 8
  br i1 %95, label %block_4529c2, label %block_.L_4529ef

block_4529c2:                                     ; preds = %block_.L_4529b6
  %97 = add i64 %60, -8
  %98 = add i64 %96, 4
  ...
  store i64 %103, i64* %RCX.i28, align 8
  ...
  store i64 %108, i64* %56, align 1
  store double 0.000000e+00, double* %58, align 1
  %109 = add i64 %96, -333218
  %110 = add i64 %96, 18
  ...
  %114 = tail call %struct.Memory* @__remill_function_call(%struct.State* nonnull %0, i64 ptrtoint (i64 (i64)* @exp to i64), %struct.Memory* %MEMORY.0)
  ...
  store i64 %120, i64* %RAX.i38, align 8
  %121 = add i64 %115, -16
  %122 = add i64 %117, 8
...
block_.L_4529ef:                                  ; preds = %block_.L_4529b6
  %163 = load i64, i64* %6, align 8
  %164 = add i64 %163, 16
  store i64 %164, i64* %6, align 8
  %165 = icmp ugt i64 %163, -17
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_jge_.L_4529ef(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i8* nocapture %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_jmpq_.L_4529b6(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
