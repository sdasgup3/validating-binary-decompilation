...
define %struct.Memory* @FSum(%struct.State* noalias , i64, %struct.Memory* noalias) alwaysinline  {
entry:
  ...
  ; Code: .FSum:	 RIP: 452090	 Bytes: 0
  ; Code: pushq %rbp	 RIP: 452090	 Bytes: 1
  %loadMem_452090 = load %struct.Memory*, %struct.Memory** %MEMORY
  %call_452090 = call %struct.Memory* @routine_pushq__rbp(%struct.State* %0, i64  0, %struct.Memory* %loadMem_452090)
  store %struct.Memory* %call_452090, %struct.Memory** %MEMORY

  ; Code: movq %rsp, %rbp	 RIP: 452091	 Bytes: 3
  %loadMem_452091 = load %struct.Memory*, %struct.Memory** %MEMORY
  %call_452091 = call %struct.Memory* @routine_movq__rsp___rbp(%struct.State* %0, i64  0, %struct.Memory* %loadMem_452091)
  store %struct.Memory* %call_452091, %struct.Memory** %MEMORY

  ; Code: xorps %xmm0, %xmm0	 RIP: 452094	 Bytes: 3
  %loadMem_452094 = load %struct.Memory*, %struct.Memory** %MEMORY
  %call_452094 = call %struct.Memory* @routine_xorps__xmm0___xmm0(%struct.State* %0, i64  0, %struct.Memory* %loadMem_452094)
  store %struct.Memory* %call_452094, %struct.Memory** %MEMORY

  ; Code: movq %rdi, -0x8(%rbp)	 RIP: 452097	 Bytes: 4
  %loadMem_452097 = load %struct.Memory*, %struct.Memory** %MEMORY
  %call_452097 = call %struct.Memory* @routine_movq__rdi__MINUS0x8__rbp_(%struct.State* %0, i64  0, %struct.Memory* %loadMem_452097)
  store %struct.Memory* %call_452097, %struct.Memory** %MEMORY

  ; Code: movl %esi, -0xc(%rbp)	 RIP: 45209b	 Bytes: 3
  %loadMem_45209b = load %struct.Memory*, %struct.Memory** %MEMORY
  %call_45209b = call %struct.Memory* @routine_movl__esi__MINUS0xc__rbp_(%struct.State* %0, i64  0, %struct.Memory* %loadMem_45209b)
  store %struct.Memory* %call_45209b, %struct.Memory** %MEMORY

  ; Code: movss %xmm0, -0x10(%rbp)	 RIP: 45209e	 Bytes: 5
  %loadMem_45209e = load %struct.Memory*, %struct.Memory** %MEMORY
  %call_45209e = call %struct.Memory* @routine_movss__xmm0__MINUS0x10__rbp_(%struct.State* %0, i64  0, %struct.Memory* %loadMem_45209e)
  store %struct.Memory* %call_45209e, %struct.Memory** %MEMORY

  ; Code: movl $0x0, -0x14(%rbp)	 RIP: 4520a3	 Bytes: 7
  %loadMem_4520a3 = load %struct.Memory*, %struct.Memory** %MEMORY
  %call_4520a3 = call %struct.Memory* @routine_movl__0x0__MINUS0x14__rbp_(%struct.State* %0, i64  0, %struct.Memory* %loadMem_4520a3)
  store %struct.Memory* %call_4520a3, %struct.Memory** %MEMORY

  ; Code: .L_4520aa:	 RIP: 4520aa	 Bytes: 0
  br label %block_.L_4520aa
block_.L_4520aa:

  ; Code: movl -0x14(%rbp), %eax	 RIP: 4520aa	 Bytes: 3
  %loadMem_4520aa = load %struct.Memory*, %struct.Memory** %MEMORY
  %call_4520aa = call %struct.Memory* @routine_movl_MINUS0x14__rbp____eax(%struct.State* %0, i64  0, %struct.Memory* %loadMem_4520aa)
  store %struct.Memory* %call_4520aa, %struct.Memory** %MEMORY

  ; Code: cmpl -0xc(%rbp), %eax	 RIP: 4520ad	 Bytes: 3
  %loadMem_4520ad = load %struct.Memory*, %struct.Memory** %MEMORY
  %call_4520ad = call %struct.Memory* @routine_cmpl_MINUS0xc__rbp____eax(%struct.State* %0, i64  0, %struct.Memory* %loadMem_4520ad)
  store %struct.Memory* %call_4520ad, %struct.Memory** %MEMORY

  ; Code: jge .L_4520db	 RIP: 4520b0	 Bytes: 6
  %loadMem_4520b0 = load %struct.Memory*, %struct.Memory** %MEMORY
  %call_4520b0 = call %struct.Memory* @routine_jge_.L_4520db(%struct.State* %0, i64  0, %struct.Memory* %loadMem_4520b0, i8* %BRANCH_TAKEN, i64 43, i64 6, i64 6)
  store %struct.Memory* %call_4520b0, %struct.Memory** %MEMORY
...
block_4520b6:
  ; Code: movq -0x8(%rbp), %rax	 RIP: 4520b6	 Bytes: 4
  %loadMem_4520b6 = load %struct.Memory*, %struct.Memory** %MEMORY
  %call_4520b6 = call %struct.Memory* @routine_movq_MINUS0x8__rbp____rax(%struct.State* %0, i64  0, %struct.Memory* %loadMem_4520b6)
  store %struct.Memory* %call_4520b6, %struct.Memory** %MEMORY

  ; Code: movslq -0x14(%rbp), %rcx	 RIP: 4520ba	 Bytes: 4
  %loadMem_4520ba = load %struct.Memory*, %struct.Memory** %MEMORY
  %call_4520ba = call %struct.Memory* @routine_movslq_MINUS0x14__rbp____rcx(%struct.State* %0, i64  0, %struct.Memory* %loadMem_4520ba)
  store %struct.Memory* %call_4520ba, %struct.Memory** %MEMORY

  ; Code: movss (%rax,%rcx,4), %xmm0	 RIP: 4520be	 Bytes: 5
  %loadMem_4520be = load %struct.Memory*, %struct.Memory** %MEMORY
  %call_4520be = call %struct.Memory* @routine_movss___rax__rcx_4____xmm0(%struct.State* %0, i64  0, %struct.Memory* %loadMem_4520be)
  store %struct.Memory* %call_4520be, %struct.Memory** %MEMORY

  ; Code: addss -0x10(%rbp), %xmm0	 RIP: 4520c3	 Bytes: 5
  %loadMem_4520c3 = load %struct.Memory*, %struct.Memory** %MEMORY
  %call_4520c3 = call %struct.Memory* @routine_addss_MINUS0x10__rbp____xmm0(%struct.State* %0, i64  0, %struct.Memory* %loadMem_4520c3)
  store %struct.Memory* %call_4520c3, %struct.Memory** %MEMORY

  ; Code: movss %xmm0, -0x10(%rbp)	 RIP: 4520c8	 Bytes: 5
  %loadMem_4520c8 = load %struct.Memory*, %struct.Memory** %MEMORY
  %call_4520c8 = call %struct.Memory* @routine_movss__xmm0__MINUS0x10__rbp_(%struct.State* %0, i64  0, %struct.Memory* %loadMem_4520c8)
  store %struct.Memory* %call_4520c8, %struct.Memory** %MEMORY

  ; Code: movl -0x14(%rbp), %eax	 RIP: 4520cd	 Bytes: 3
  %loadMem_4520cd = load %struct.Memory*, %struct.Memory** %MEMORY
  %call_4520cd = call %struct.Memory* @routine_movl_MINUS0x14__rbp____eax(%struct.State* %0, i64  0, %struct.Memory* %loadMem_4520cd)
  store %struct.Memory* %call_4520cd, %struct.Memory** %MEMORY

  ; Code: addl $0x1, %eax	 RIP: 4520d0	 Bytes: 3
  %loadMem_4520d0 = load %struct.Memory*, %struct.Memory** %MEMORY
  %call_4520d0 = call %struct.Memory* @routine_addl__0x1___eax(%struct.State* %0, i64  0, %struct.Memory* %loadMem_4520d0)
  store %struct.Memory* %call_4520d0, %struct.Memory** %MEMORY

  ; Code: movl %eax, -0x14(%rbp)	 RIP: 4520d3	 Bytes: 3
  %loadMem_4520d3 = load %struct.Memory*, %struct.Memory** %MEMORY
  %call_4520d3 = call %struct.Memory* @routine_movl__eax__MINUS0x14__rbp_(%struct.State* %0, i64  0, %struct.Memory* %loadMem_4520d3)
  store %struct.Memory* %call_4520d3, %struct.Memory** %MEMORY

  ; Code: jmpq .L_4520aa	 RIP: 4520d6	 Bytes: 5
  %loadMem_4520d6 = load %struct.Memory*, %struct.Memory** %MEMORY
  %call_4520d6 = call %struct.Memory* @routine_jmpq_.L_4520aa(%struct.State* %0, i64  0, %struct.Memory* %loadMem_4520d6, i64 -44, i64 5)
  store %struct.Memory* %call_4520d6, %struct.Memory** %MEMORY

  br label %block_.L_4520aa

  ; Code: .L_4520db:	 RIP: 4520db	 Bytes: 0
block_.L_4520db:

  ; Code: movss -0x10(%rbp), %xmm0	 RIP: 4520db	 Bytes: 5
  %loadMem_4520db = load %struct.Memory*, %struct.Memory** %MEMORY
  %call_4520db = call %struct.Memory* @routine_movss_MINUS0x10__rbp____xmm0(%struct.State* %0, i64  0, %struct.Memory* %loadMem_4520db)
  store %struct.Memory* %call_4520db, %struct.Memory** %MEMORY

  ; Code: popq %rbp	 RIP: 4520e0	 Bytes: 1
  %loadMem_4520e0 = load %struct.Memory*, %struct.Memory** %MEMORY
  %call_4520e0 = call %struct.Memory* @routine_popq__rbp(%struct.State* %0, i64  0, %struct.Memory* %loadMem_4520e0)
  store %struct.Memory* %call_4520e0, %struct.Memory** %MEMORY

  ; Code: retq	 RIP: 4520e1	 Bytes: 1
  %loadMem_4520e1 = load %struct.Memory*, %struct.Memory** %MEMORY
  %call_4520e1 = call %struct.Memory* @routine_retq(%struct.State* %0, i64  0, %struct.Memory* %loadMem_4520e1)
  store %struct.Memory* %call_4520e1, %struct.Memory** %MEMORY

  ret %struct.Memory* %call_4520e1
}
...
define %struct.Memory* @routine_addss_MINUS0x10__rbp____xmm0(%struct.State*  dereferenceable(3376), i64, %struct.Memory* ) #19 {
block_400488:
  %3 = getelementptr inbounds %struct.State, %struct.State* %0, i32 0, i32 6
  %4 = getelementptr inbounds %struct.GPR, %struct.GPR* %3, i32 0, i32 33
  %5 = getelementptr inbounds %struct.Reg, %struct.Reg* %4, i32 0, i32 0
