...
define %struct.Memory* @GSIClose(%struct.State* noalias, i64, %struct.Memory* noalias) local_unnamed_addr #1 {
entry:
  ...
  %call2_417bd3 = tail call %struct.Memory* @sub_401440.fclose_plt(%struct.State* %0, i64 %53, %struct.Memory* %2)
  ...
  %75 = tail call %struct.Memory* @__remill_function_call(%struct.State* %0, i64 ptrtoint (i64 (i64)* @free to i64), %struct.Memory* %call2_417bd3)
