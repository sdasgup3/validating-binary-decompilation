...
define %struct.Memory* @InitIntStack(%struct.State* noalias, i64, %struct.Memory* noalias) local_unnamed_addr #1 {
entry:
  ...
  store i64 16, i64* %RDI.i28, align 8
  %41 = add i64 %10, -298353
  %42 = add i64 %10, 19
  %43 = add i64 %7, -32
  ...
  %45 = tail call %struct.Memory* @__remill_function_call(%struct.State* %0, i64 ptrtoint (i64 (i64)* @malloc to i64), %struct.Memory* %2)
  %46 = load i64, i64* %RBP.i, align 8
  %47 = add i64 %46, -8
  %48 = load i64, i64* %RAX.i30, align 8
  ...
  %.v = select i1 %60, i64 10, i64 42
  %64 = add i64 %53, %.v
  store i64 %64, i64* %3, align 8
  br i1 %60, label %block_44a362, label %block_.L_44a382

block_44a362:                                     ; preds = %entry
  store i64 ptrtoint (%G__0x45ac86_type* @G__0x45ac86 to i64), i64* %RDI.i28, align 8
  ...
  %call2_44a37d = tail call %struct.Memory* @sub_43ea10.Die(%struct.State* nonnull %0, i64 %65, %struct.Memory* %45)
  %.pre = load i64, i64* %3, align 8
  br label %block_.L_44a382

block_.L_44a382:                                  ; preds = %entry, %block_44a362
  %70 = phi i64 [ %64, %entry ], [ %.pre, %block_44a362 ]
  %MEMORY.0 = phi %struct.Memory* [ %45, %entry ], [ %call2_44a37d, %block_44a362 ]
  ...
  store i64 %75, i64* %RAX.i30, align 8
  %76 = add i64 %75, 8
  %77 = add i64 %70, 12
  ...
  store i64 %84, i64* %RAX.i30, align 8
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_jne_.L_44a382(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i8* nocapture %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_movl__0x2a___edx(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
