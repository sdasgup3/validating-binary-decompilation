...
define %struct.Memory* @MSAGetSeqSA(%struct.State* noalias, i64, %struct.Memory* noalias readnone returned) local_unnamed_addr #1 {
entry:
  ...
  br i1 %41, label %block_.L_43060a, label %block_4305da
...
block_4305da:                                     ; preds = %entry
  ...
  br i1 %71, label %block_.L_43060a, label %block_4305f1
...
block_.L_43060a:                                  ; preds = %entry, %block_4305da
  %95 = phi i64 [ %75, %block_4305da ], [ %48, %entry ]
  %96 = add i64 %22, -8
  %97 = add i64 %95, 8
...
block_.L_430612:                                  ; preds = %block_.L_43060a, %block_4305f1
  %99 = phi i64 [ %.pre, %block_.L_43060a ], [ %94, %block_4305f1 ]
...
define %struct.Memory* @routine_cmpq__0x0__0x78__rdi_(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned) local_unnamed_addr #3 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %RDI = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 11, i32 0, i32 0
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_je_.L_43060a(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i8* nocapture %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_jmpq_.L_430612(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
