...
define %struct.Memory* @MSAGetSeqSS(%struct.State* noalias, i64, %struct.Memory* noalias readnone returned) local_unnamed_addr #1 {
entry:
  ...
  br i1 %41, label %block_.L_4305aa, label %block_43057a

block_43057a:                                     ; preds = %entry
  %49 = add i64 %48, 4
  ...
  br i1 %71, label %block_.L_4305aa, label %block_430591

block_430591:                                     ; preds = %block_43057a
  %76 = add i64 %75, 4
  ...
  br label %block_.L_4305b2

block_.L_4305aa:                                  ; preds = %entry, %block_43057a
  %95 = phi i64 [ %75, %block_43057a ], [ %48, %entry ]
  %96 = add i64 %22, -8
  %97 = add i64 %95, 8
...
block_.L_4305b2:                                  ; preds = %block_.L_4305aa, %block_430591
  %99 = phi i64 [ %.pre, %block_.L_4305aa ], [ %94, %block_430591 ]
...
define %struct.Memory* @routine_cmpq__0x0__0x70__rdi_(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned) local_unnamed_addr #3 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %RDI = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 11, i32 0, i32 0
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_je_.L_4305aa(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i8* nocapture %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_jmpq_.L_4305b2(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
