...
define %struct.Memory* @P7FreePrior(%struct.State* noalias, i64, %struct.Memory* noalias) #2 {
entry:
  ...
  store %struct.Memory* %loadMem_437b70, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_437b74, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_437b7c, %struct.Memory** %MEMORY
  ...
  %111 = call %struct.Memory* @__remill_function_call(%struct.State* %0, i64 ptrtoint (i64 (i64)* @free to i64), %struct.Memory* %loadMem2_437b80)
  ...
  store %struct.Memory* %loadMem_437b89, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_437b8a, %struct.Memory** %MEMORY
  ret %struct.Memory* %loadMem_437b8a
}
