...
define %struct.Memory* @P7FreePrior(%struct.State* noalias, i64, %struct.Memory* noalias) local_unnamed_addr #1 {
entry:
  ...
  %40 = add i64 %7, -16
  %41 = load i64, i64* %RDI.i12, align 8
  %42 = add i64 %10, 11
  ...
  store i64 %49, i64* %RDI.i12, align 8
  %50 = add i64 %46, -223228
  %51 = add i64 %46, 9
  ...
  %55 = tail call %struct.Memory* @__remill_function_call(%struct.State* %0, i64 ptrtoint (i64 (i64)* @free to i64), %struct.Memory* %2)
