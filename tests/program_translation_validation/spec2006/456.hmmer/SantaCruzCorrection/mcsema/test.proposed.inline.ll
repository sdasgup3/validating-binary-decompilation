...
define %struct.Memory* @SantaCruzCorrection(%struct.State* noalias, i64, %struct.Memory* noalias) #2 {
entry:
  ...
  store %struct.Memory* %loadMem_427d90, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_427d91, %struct.Memory** %MEMORY
  ...
  %39 = load i64, i64* %PC.i10
  %40 = add i64 %39, 3
  store i64 %40, i64* %PC.i10
  ...
  store %struct.Memory* %loadMem_427d94, %struct.Memory** %MEMORY
  ...
  %78 = load i64, i64* %PC.i8
  %79 = add i64 %78, 4
  store i64 %79, i64* %PC.i8
  %80 = inttoptr i64 %76 to i64*
  store i64 %77, i64* %80
  store %struct.Memory* %loadMem_427d97, %struct.Memory** %MEMORY
  ...
  %PC.i6 = bitcast %union.anon* %83 to i64*
  ...
  store i64 %92, i64* %95
  store %struct.Memory* %loadMem_427d9b, %struct.Memory** %MEMORY
  ...
  %PC.i4 = bitcast %union.anon* %98 to i64*
  ...
  %RBP.i5 = bitcast %union.anon* %104 to i64*
  %105 = load i64, i64* %RBP.i5
  %106 = sub i64 %105, 24
  ...
  store %struct.Memory* %loadMem_427d9f, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_427da3, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_427da4, %struct.Memory** %MEMORY
  ret %struct.Memory* %loadMem_427da4
}
