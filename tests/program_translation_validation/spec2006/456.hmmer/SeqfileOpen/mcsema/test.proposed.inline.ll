...
define %struct.Memory* @SeqfileOpen(%struct.State* noalias, i64, %struct.Memory* noalias) #2 {
entry:
  ...
  store %struct.Memory* %loadMem_43ee00, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_43ee01, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_43ee04, %struct.Memory** %MEMORY
  ...
  store i64 %86, i64* %89
  store %struct.Memory* %loadMem_43ee0d, %struct.Memory** %MEMORY
  ...
  %PC.i15 = bitcast %union.anon* %92 to i64*
  ...
  %103 = load i64, i64* %PC.i15
  %104 = add i64 %103, 3
  store i64 %104, i64* %PC.i15
  ...
  %RDX.i13 = bitcast %union.anon* %111 to i64*
  ...
  %133 = add i64 %132, 4
  store i64 %133, i64* %PC.i10
  %134 = inttoptr i64 %131 to i64*
  %135 = load i64, i64* %134
  store i64 %135, i64* %RDI.i, align 8
  store %struct.Memory* %loadMem_43ee18, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_43ee1c, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_43ee1f, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem1_43ee23, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_43ee28, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_43ee2c, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_43ee2d, %struct.Memory** %MEMORY
  ret %struct.Memory* %loadMem_43ee2d
}
