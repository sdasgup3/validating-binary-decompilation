...
define %struct.Memory* @SeqfileOpen(%struct.State* noalias, i64, %struct.Memory* noalias readnone returned) local_unnamed_addr #1 {
entry:
  ...
  %51 = add i64 %50, -24
  %52 = load i64, i64* %RDX.i13, align 8
  ...
  store i64 %70, i64* %RDX.i13, align 8
  %71 = add i64 %58, 24
  %72 = add i64 %58, 16
  ...
  %call2_43ee23 = tail call %struct.Memory* @sub_43ee30.seqfile_open(%struct.State* %0, i64 %71, %struct.Memory* %2)
  ...
  ret %struct.Memory* %call2_43ee23
}
