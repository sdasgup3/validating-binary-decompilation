...
define %struct.Memory* @SqdClean(%struct.State* noalias, i64, %struct.Memory* noalias) #2 {
entry:
  ...
  store %struct.Memory* %loadMem_4273e0, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_4273e4, %struct.Memory** %MEMORY
  ...
  %RBP.i37 = bitcast %union.anon* %72 to i64*
  %73 = load i64, i64* %RBP.i37
  %74 = sub i64 %73, 4
  %75 = load i64, i64* %PC.i36
  %76 = add i64 %75, 7
  store i64 %76, i64* %PC.i36
  %77 = inttoptr i64 %74 to i32*
  store i32 0, i32* %77
  store %struct.Memory* %loadMem_4273e8, %struct.Memory** %MEMORY
  br label %block_.L_4273ef

block_.L_4273ef:                                  ; preds = %block_.L_427432, %entry
  ...
  %PC.i34 = bitcast %union.anon* %80 to i64*
  ...
  store %struct.Memory* %loadMem_4273ef, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_4273f3, %struct.Memory** %MEMORY
...
block_4273f9:                                     ; preds = %block_.L_4273ef
  ...
  store i64 %157, i64* %RAX.i31, align 8
  store %struct.Memory* %loadMem_4273f9, %struct.Memory** %MEMORY
  ...
  %RAX.i29 = bitcast %union.anon* %163 to i64*
  %164 = load i64, i64* %RAX.i29
  %165 = mul i64 %164, 8
  %166 = add i64 %165, 6778768
  ...
  store %struct.Memory* %loadMem_4273fd, %struct.Memory** %MEMORY
  ...
  %PC.i27 = bitcast %union.anon* %194 to i64*
  %195 = load i64, i64* %PC.i27
  %196 = add i64 %195, 39
  %197 = load i64, i64* %PC.i27
  %198 = add i64 %197, 6
  ...
  store %struct.Memory* %loadMem_427406, %struct.Memory** %MEMORY
...
block_42740c:                                     ; preds = %block_4273f9
  ...
  store %struct.Memory* %loadMem_42740c, %struct.Memory** %MEMORY
  ...
  %RAX.i23 = bitcast %union.anon* %227 to i64*
  ...
  %231 = load i64, i64* %RAX.i23
  %232 = mul i64 %231, 8
  %233 = add i64 %232, 6778768
  ...
  store %struct.Memory* %loadMem1_427418, %struct.Memory** %MEMORY
  %loadMem2_427418 = load %struct.Memory*, %struct.Memory** %MEMORY
  %loadPC_427418 = load i64, i64* %3
  %252 = call %struct.Memory* @__remill_function_call(%struct.State* %0, i64 ptrtoint (i64 (i64)* @free to i64), %struct.Memory* %loadMem2_427418)
  ...
  %RAX.i16 = bitcast %union.anon* %258 to i64*
  ...
  store i64 %268, i64* %RAX.i16, align 8
  ...
  %RAX.i14 = bitcast %union.anon* %274 to i64*
  %275 = load i64, i64* %RAX.i14
  %276 = mul i64 %275, 8
  %277 = add i64 %276, 6778768
  %278 = load i64, i64* %PC.i13
  %279 = add i64 %278, 12
  store i64 %279, i64* %PC.i13
  %280 = inttoptr i64 %277 to i64*
  store i64 0, i64* %280
  store %struct.Memory* %loadMem_427421, %struct.Memory** %MEMORY
  br label %block_.L_42742d

block_.L_42742d:                                  ; preds = %block_42740c, %block_4273f9
  ...
  store %struct.Memory* %loadMem_42742d, %struct.Memory** %MEMORY
  br label %block_.L_427432

block_.L_427432:                                  ; preds = %block_.L_42742d
  ...
  %298 = load i64, i64* %RBP.i11
  %299 = sub i64 %298, 4
  %300 = load i64, i64* %PC.i9
  %301 = add i64 %300, 3
  store i64 %301, i64* %PC.i9
  %302 = inttoptr i64 %299 to i32*
  %303 = load i32, i32* %302
  %304 = zext i32 %303 to i64
  store i64 %304, i64* %RAX.i10, align 8
  ...
  %RAX.i = bitcast %union.anon* %310 to i64*
  %311 = load i64, i64* %RAX.i
  ...
  store %struct.Memory* %loadMem_427435, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_427438, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_42743b, %struct.Memory** %MEMORY
  br label %block_.L_4273ef

block_.L_427440:                                  ; preds = %block_.L_4273ef
  ...
  store %struct.Memory* %loadMem_427440, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_427444, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_427445, %struct.Memory** %MEMORY
  ret %struct.Memory* %loadMem_427445
}
