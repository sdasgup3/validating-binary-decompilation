...
define %struct.Memory* @UnfitHistogram(%struct.State* noalias, i64, %struct.Memory* noalias) local_unnamed_addr #1 {
entry:
  ...
  %.v = select i1 %60, i64 31, i64 15
  %64 = add i64 %46, %.v
  store i64 %64, i64* %3, align 8
  %.pre2 = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 1, i32 0, i32 0
  br i1 %60, label %block_.L_41878b, label %block_41877b

block_41877b:                                     ; preds = %entry
  %65 = add i64 %64, 4
  ...
  store i64 %70, i64* %.pre2, align 8
  store i64 %70, i64* %RDI.i32, align 8
  %71 = add i64 %64, -95227
  %72 = add i64 %64, 16
...
block_.L_41878b:                                  ; preds = %entry, %block_41877b
  %77 = phi i64 [ %.pre1, %block_41877b ], [ %64, %entry ]
  %78 = phi i64 [ %.pre, %block_41877b ], [ %44, %entry ]
  %MEMORY.0 = phi %struct.Memory* [ %76, %block_41877b ], [ %2, %entry ]
  %79 = add i64 %78, -8
  %80 = add i64 %77, 4
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_je_.L_41878b(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i8* nocapture %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
