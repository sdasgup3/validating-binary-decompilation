...
@G__0x45a567 = global %G__0x45a567_type zeroinitializer
...
define %struct.Memory* @endEMBL(%struct.State* noalias, i64, %struct.Memory* noalias) local_unnamed_addr #1 {
entry:
  ...
  %RAX.i33 = getelementptr inbounds %union.anon, %union.anon* %40, i64 0, i32 0
  store i64 ptrtoint (%G__0x45a567_type* @G__0x45a567 to i64), i64* %RAX.i33, align 8
  ...
  %41 = add i64 %7, -16
  %42 = load i64, i64* %RDI.i28, align 8
  %43 = add i64 %10, 28
  ...
  %46 = add i64 %45, -16
  %47 = load i64, i64* %RSI.i25, align 8
  ...
  store i64 %56, i64* %RSI.i25, align 8
  %57 = add i64 %53, 10
  ...
  %65 = load i64, i64* %RAX.i33, align 8
  store i64 %65, i64* %RSI.i25, align 8
  %66 = add i64 %61, -267595
  %67 = add i64 %61, 12
  ...
  %71 = tail call %struct.Memory* @__remill_function_call(%struct.State* %0, i64 ptrtoint (i64 (i64, i64, i64)* @strncmp to i64), %struct.Memory* %2)
  %EAX.i = bitcast %union.anon* %40 to i32*
  %72 = load i32, i32* %EAX.i, align 4
  %73 = load i64, i64* %3, align 8
  %74 = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 17, i32 0
  %R8B.i9 = bitcast %union.anon* %74 to i8*
  %75 = icmp ne i32 %72, 0
  %76 = zext i1 %75 to i8
  store i8 %76, i8* %R8B.i9, align 1
  %77 = zext i1 %75 to i64
  store i64 %77, i64* %RAX.i33, align 8
  %78 = load i64, i64* %6, align 8
  %79 = add i64 %78, 16
  store i64 %79, i64* %6, align 8
  %80 = icmp ugt i64 %78, -17
  %81 = zext i1 %80 to i8
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_movq__0x45a567___rax(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  ...
  store i64 ptrtoint (%G__0x45a567_type* @G__0x45a567 to i64), i64* %RAX, align 8
  ret %struct.Memory* %2
}
