...
define %struct.Memory* @endGB(%struct.State* noalias, i64, %struct.Memory* noalias readnone) local_unnamed_addr #1 {
entry:
  ...
  store i64 ptrtoint (%G__0x45a381_type* @G__0x45a381 to i64), i64* %RAX.i49, align 8
  ...
  %44 = add i64 %43, -16
  %45 = load i64, i64* %RSI.i43, align 8
  ...
  store i64 %54, i64* %RSI.i43, align 8
  %55 = add i64 %51, 10
  ...
  store i64 %62, i64* %RDI.i46, align 8
  %63 = load i64, i64* %RAX.i49, align 8
  store i64 %63, i64* %RSI.i43, align 8
  %64 = add i64 %59, -266900
  %65 = add i64 %59, 12
  ...
  %call2_44299b = tail call %struct.Memory* @sub_401700.strstr_plt(%struct.State* %0, i64 %64, %struct.Memory* %2)
  %69 = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 5, i32 0
  %CL.i29 = bitcast %union.anon* %69 to i8*
  %70 = load i64, i64* %3, align 8
  store i8 1, i8* %CL.i29, align 1
  %71 = load i64, i64* %RAX.i49, align 8
  ...
  %87 = add i64 %86, 35
  %88 = add i64 %86, 6
  %89 = load i8, i8* %29, align 1
  %90 = icmp eq i8 %89, 0
  %91 = select i1 %90, i64 %87, i64 %88
  store i64 %91, i64* %3, align 8
  br i1 %90, label %block_.L_4429cc, label %block_4429af

block_4429af:                                     ; preds = %entry
  store i64 ptrtoint (%G__0x45a2ac_type* @G__0x45a2ac to i64), i64* %RSI.i43, align 8
  ...
  %call2_4429bd = tail call %struct.Memory* @sub_401700.strstr_plt(%struct.State* nonnull %0, i64 %97, %struct.Memory* %call2_44299b)
  %102 = load i64, i64* %RAX.i49, align 8
  ...
  store i8 %124, i8* %CL.i29, align 1
  %134 = add i64 %103, -17
  %135 = add i64 %105, 10
...
block_.L_4429cc:                                  ; preds = %block_4429af, %entry
  %137 = phi i64 [ %87, %entry ], [ %.pre, %block_4429af ]
  %MEMORY.0 = phi %struct.Memory* [ %call2_44299b, %entry ], [ %call2_4429bd, %block_4429af ]
  ...
  store i64 %144, i64* %RAX.i49, align 8
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_jne_.L_4429cc(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i8* nocapture %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
