...
define %struct.Memory* @endPearson(%struct.State* noalias, i64, %struct.Memory* noalias readnone returned) local_unnamed_addr #1 {
entry:
  ...
  %16 = add i64 %15, -16
  %17 = load i64, i64* %RSI.i21, align 8
  ...
  store i64 %26, i64* %RSI.i21, align 8
  %27 = add i64 %23, 10
  ...
  store i64 %34, i64* %RSI.i21, align 8
  ...
  %CL.i8 = bitcast %union.anon* %46 to i8*
  store i8 %42, i8* %CL.i8, align 1
  ...
  %52 = zext i1 %41 to i64
  store i64 %52, i64* %RAX.i11, align 8
  %53 = add i64 %31, 20
...
define %struct.Memory* @routine_cmpl__0x3e___eax(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned) local_unnamed_addr #3 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
