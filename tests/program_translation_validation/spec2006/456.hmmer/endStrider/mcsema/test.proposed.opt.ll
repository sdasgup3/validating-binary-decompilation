...
define %struct.Memory* @endStrider(%struct.State* noalias, i64, %struct.Memory* noalias readnone returned) local_unnamed_addr #1 {
entry:
  ...
  store i64 %63, i64* %RDI.i26, align 8
  %64 = load i64, i64* %RAX.i29, align 8
  store i64 %64, i64* %RSI.i23, align 8
  %65 = add i64 %60, -267012
  %66 = add i64 %60, 12
  ...
  %call2_442a0b = tail call %struct.Memory* @sub_401700.strstr_plt(%struct.State* %0, i64 %65, %struct.Memory* %2)
  %70 = load i64, i64* %RAX.i29, align 8
  %71 = load i64, i64* %3, align 8
  %72 = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 5, i32 0
  %CL.i9 = bitcast %union.anon* %72 to i8*
  %73 = icmp ne i64 %70, 0
  %74 = zext i1 %73 to i8
  store i8 %74, i8* %CL.i9, align 1
  %75 = zext i1 %73 to i64
  store i64 %75, i64* %RAX.i29, align 8
  ...
  ret %struct.Memory* %call2_442a0b
}
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_movq__0x45a381___rax(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
