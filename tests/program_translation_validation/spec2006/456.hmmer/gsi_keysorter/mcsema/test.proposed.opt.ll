...
define %struct.Memory* @gsi_keysorter(%struct.State* noalias, i64, %struct.Memory* noalias) local_unnamed_addr #1 {
entry:
  ...
  %44 = add i64 %43, -16
  %45 = load i64, i64* %RSI.i26, align 8
  ...
  store i64 %54, i64* %RSI.i26, align 8
  %55 = add i64 %49, -24
  %56 = add i64 %51, 8
  ...
  store i64 %72, i64* %RDI.i29, align 8
  %73 = add i64 %67, -32
  %74 = add i64 %69, 8
  ...
  %82 = tail call %struct.Memory* @__remill_function_call(%struct.State* %0, i64 ptrtoint (i64 (i64, i64)* @strcmp to i64), %struct.Memory* %2)
