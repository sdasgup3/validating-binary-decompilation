...
define %struct.Memory* @sre_ntoh16(%struct.State* noalias, i64, %struct.Memory* noalias) #2 {
entry:
  ...
  store %struct.Memory* %loadMem_451760, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_451761, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_451764, %struct.Memory** %MEMORY
  ...
  store i16 %53, i16* %57
  store %struct.Memory* %loadMem_451767, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_45176b, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_45176f, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_451770, %struct.Memory** %MEMORY
  ret %struct.Memory* %loadMem_451770
}
