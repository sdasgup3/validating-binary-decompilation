...
define %struct.Memory* @sre_ntoh16(%struct.State* noalias nocapture, i64, %struct.Memory* noalias readnone returned) local_unnamed_addr #0 {
entry:
  ...
  %AX.i9 = bitcast %union.anon* %11 to i16*
  ...
  store i16 %13, i16* %AX.i9, align 2
  %14 = add i64 %7, -10
  %15 = add i64 %10, 10
