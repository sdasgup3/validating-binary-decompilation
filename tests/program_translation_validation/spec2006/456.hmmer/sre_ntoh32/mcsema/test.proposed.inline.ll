...
define %struct.Memory* @sre_ntoh32(%struct.State* noalias, i64, %struct.Memory* noalias) #2 {
entry:
  ...
  store %struct.Memory* %loadMem_451780, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_451781, %struct.Memory** %MEMORY
  ...
  store i32 %40, i32* %44
  store %struct.Memory* %loadMem_451784, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_451787, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_45178a, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_45178b, %struct.Memory** %MEMORY
  ret %struct.Memory* %loadMem_45178b
}
