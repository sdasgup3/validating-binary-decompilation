...
define %struct.Memory* @BegForPartner(%struct.State* noalias, i64, %struct.Memory* noalias) #2 {
entry:
  ...
  %33 = add i64 %32, 8
  store i64 %33, i64* %PC.i6
  %34 = load i32, i32* bitcast (%G_0x8a2a04_type* @G_0x8a2a04 to i32*)
  ...
  %PC.i5 = bitcast %union.anon* %57 to i64*
  %58 = load i64, i64* %PC.i5
  %59 = add i64 %58, 11
  %60 = load i64, i64* %PC.i5
  %61 = add i64 %60, 6
  %62 = load i64, i64* %PC.i5
  %63 = add i64 %62, 6
  store i64 %63, i64* %PC.i5
...
block_4101a2:                                     ; preds = %entry
  ...
  %PC.i4 = bitcast %union.anon* %71 to i64*
...
block_.L_4101a7:                                  ; preds = %block_4101a2, %entry
  ...
  ret %struct.Memory* %loadMem_4101a8
}
