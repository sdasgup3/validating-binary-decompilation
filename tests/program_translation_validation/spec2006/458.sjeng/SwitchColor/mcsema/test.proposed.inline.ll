...
@G__0x4255d0 = global %G__0x4255d0_type zeroinitializer
...
define %struct.Memory* @SwitchColor(%struct.State* noalias, i64, %struct.Memory* noalias) #2 {
entry:
  ...
  store i64 ptrtoint (%G__0x4255d0_type* @G__0x4255d0 to i64), i64* %RAX.i26, align 8
  ...
  store %struct.Memory* %loadMem_402482, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem1_402496, %struct.Memory** %MEMORY
  %loadMem2_402496 = load %struct.Memory*, %struct.Memory** %MEMORY
  %loadPC_402496 = load i64, i64* %3
  %164 = call %struct.Memory* @__remill_function_call(%struct.State* %0, i64 ptrtoint (i64 (i64, i64, i64)* @memcpy to i64), %struct.Memory* %loadMem2_402496)
  ...
  ret %struct.Memory* %loadMem_4024a8
}
...
define %struct.Memory* @routine_movq__0x4255d0___rax(%struct.State* dereferenceable(3376), i64, %struct.Memory*) {
block_400488:
  %3 = getelementptr inbounds %struct.State, %struct.State* %0, i32 0, i32 6
  %4 = getelementptr inbounds %struct.GPR, %struct.GPR* %3, i32 0, i32 33
  %5 = getelementptr inbounds %struct.Reg, %struct.Reg* %4, i32 0, i32 0
  ...
  %10 = add i64 %9, 10
  store i64 %10, i64* %PC
  store i64 ptrtoint (%G__0x4255d0_type* @G__0x4255d0 to i64), i64* %RAX, align 8
  ret %struct.Memory* %2
}
