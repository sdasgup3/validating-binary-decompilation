...
@G__0x425610= global %G__0x425610_type <{ [8 x i8] c"\00\00\00\00\00\00\00\00" }>


define %struct.Memory* @SwitchPromoted(%struct.State* noalias , i64, %struct.Memory* noalias) alwaysinline  {
entry:
  ...
  ; Code: .SwitchPromoted:	 RIP: 4024b0	 Bytes: 0
  ...
  ; Code: subq $0x40, %rsp	 RIP: 4024b4	 Bytes: 4
  %loadMem_4024b4 = load %struct.Memory*, %struct.Memory** %MEMORY
  %call_4024b4 = call %struct.Memory* @routine_subq__0x40___rsp(%struct.State* %0, i64  0, %struct.Memory* %loadMem_4024b4)
  store %struct.Memory* %call_4024b4, %struct.Memory** %MEMORY

  ; Code: movq $0x425610, %rax	 RIP: 4024b8	 Bytes: 10
  %loadMem_4024b8 = load %struct.Memory*, %struct.Memory** %MEMORY
  %call_4024b8 = call %struct.Memory* @routine_movq__0x425610___rax(%struct.State* %0, i64  0, %struct.Memory* %loadMem_4024b8)
  store %struct.Memory* %call_4024b8, %struct.Memory** %MEMORY

  ; Code: movl $0x34, %ecx	 RIP: 4024c2	 Bytes: 5
  %loadMem_4024c2 = load %struct.Memory*, %struct.Memory** %MEMORY
  %call_4024c2 = call %struct.Memory* @routine_movl__0x34___ecx(%struct.State* %0, i64  0, %struct.Memory* %loadMem_4024c2)
  store %struct.Memory* %call_4024c2, %struct.Memory** %MEMORY

  ; Code: movl %ecx, %edx	 RIP: 4024c7	 Bytes: 2
  %loadMem_4024c7 = load %struct.Memory*, %struct.Memory** %MEMORY
  %call_4024c7 = call %struct.Memory* @routine_movl__ecx___edx(%struct.State* %0, i64  0, %struct.Memory* %loadMem_4024c7)
  store %struct.Memory* %call_4024c7, %struct.Memory** %MEMORY

  ; Code: leaq -0x40(%rbp), %rsi	 RIP: 4024c9	 Bytes: 4
  %loadMem_4024c9 = load %struct.Memory*, %struct.Memory** %MEMORY
  %call_4024c9 = call %struct.Memory* @routine_leaq_MINUS0x40__rbp____rsi(%struct.State* %0, i64  0, %struct.Memory* %loadMem_4024c9)
  store %struct.Memory* %call_4024c9, %struct.Memory** %MEMORY

  ; Code: movl %edi, -0x4(%rbp)	 RIP: 4024cd	 Bytes: 3
  %loadMem_4024cd = load %struct.Memory*, %struct.Memory** %MEMORY
  %call_4024cd = call %struct.Memory* @routine_movl__edi__MINUS0x4__rbp_(%struct.State* %0, i64  0, %struct.Memory* %loadMem_4024cd)
  store %struct.Memory* %call_4024cd, %struct.Memory** %MEMORY

  ; Code: movq %rsi, %rdi	 RIP: 4024d0	 Bytes: 3
  %loadMem_4024d0 = load %struct.Memory*, %struct.Memory** %MEMORY
  %call_4024d0 = call %struct.Memory* @routine_movq__rsi___rdi(%struct.State* %0, i64  0, %struct.Memory* %loadMem_4024d0)
  store %struct.Memory* %call_4024d0, %struct.Memory** %MEMORY

  ; Code: movq %rax, %rsi	 RIP: 4024d3	 Bytes: 3
  %loadMem_4024d3 = load %struct.Memory*, %struct.Memory** %MEMORY
  %call_4024d3 = call %struct.Memory* @routine_movq__rax___rsi(%struct.State* %0, i64  0, %struct.Memory* %loadMem_4024d3)
  store %struct.Memory* %call_4024d3, %struct.Memory** %MEMORY

  ; Code: callq .memcpy_plt	 RIP: 4024d6	 Bytes: 5
  %loadMem1_4024d6 = load %struct.Memory*, %struct.Memory** %MEMORY
  %call1_4024d6 = call %struct.Memory* @routine_callq_.memcpy_plt(%struct.State* %0, i64  0, %struct.Memory* %loadMem1_4024d6, i64 -6038, i64 5, i64 5)
  store %struct.Memory* %call1_4024d6, %struct.Memory** %MEMORY

  %loadMem2_4024d6 = load %struct.Memory*, %struct.Memory** %MEMORY
  %loadPC_4024d6 = load i64, i64* %3
  %call2_4024d6 = call %struct.Memory* @ext_memcpy(%struct.State* %0, i64  %loadPC_4024d6, %struct.Memory* %loadMem2_4024d6)
  store %struct.Memory* %call2_4024d6, %struct.Memory** %MEMORY

  ; Code: movslq -0x4(%rbp), %rax	 RIP: 4024db	 Bytes: 4
  %loadMem_4024db = load %struct.Memory*, %struct.Memory** %MEMORY
  %call_4024db = call %struct.Memory* @routine_movslq_MINUS0x4__rbp____rax(%struct.State* %0, i64  0, %struct.Memory* %loadMem_4024db)
  store %struct.Memory* %call_4024db, %struct.Memory** %MEMORY

  ; Code: movl -0x40(%rbp,%rax,4), %eax	 RIP: 4024df	 Bytes: 4
  %loadMem_4024df = load %struct.Memory*, %struct.Memory** %MEMORY
  %call_4024df = call %struct.Memory* @routine_movl_MINUS0x40__rbp__rax_4____eax(%struct.State* %0, i64  0, %struct.Memory* %loadMem_4024df)
  store %struct.Memory* %call_4024df, %struct.Memory** %MEMORY

  ; Code: addq $0x40, %rsp	 RIP: 4024e3	 Bytes: 4
  %loadMem_4024e3 = load %struct.Memory*, %struct.Memory** %MEMORY
  %call_4024e3 = call %struct.Memory* @routine_addq__0x40___rsp(%struct.State* %0, i64  0, %struct.Memory* %loadMem_4024e3)
  store %struct.Memory* %call_4024e3, %struct.Memory** %MEMORY

  ; Code: popq %rbp	 RIP: 4024e7	 Bytes: 1
  %loadMem_4024e7 = load %struct.Memory*, %struct.Memory** %MEMORY
  %call_4024e7 = call %struct.Memory* @routine_popq__rbp(%struct.State* %0, i64  0, %struct.Memory* %loadMem_4024e7)
  store %struct.Memory* %call_4024e7, %struct.Memory** %MEMORY

  ; Code: retq	 RIP: 4024e8	 Bytes: 1
  %loadMem_4024e8 = load %struct.Memory*, %struct.Memory** %MEMORY
  %call_4024e8 = call %struct.Memory* @routine_retq(%struct.State* %0, i64  0, %struct.Memory* %loadMem_4024e8)
  store %struct.Memory* %call_4024e8, %struct.Memory** %MEMORY

  ret %struct.Memory* %call_4024e8
}
...
define %struct.Memory* @routine_movq__0x425610___rax(%struct.State*  dereferenceable(3376), i64, %struct.Memory* ) #19 {
block_400488:
  %3 = getelementptr inbounds %struct.State, %struct.State* %0, i32 0, i32 6
  %4 = getelementptr inbounds %struct.GPR, %struct.GPR* %3, i32 0, i32 33
  %5 = getelementptr inbounds %struct.Reg, %struct.Reg* %4, i32 0, i32 0
  ...
  %10 = add i64 %9, 10
  store i64 %10, i64* %PC
  %11 = call %struct.Memory* @_ZN12_GLOBAL__N_1L3MOVI3RnWImE2InImEEEP6MemoryS6_R5StateT_T0_(%struct.Memory* %2, %struct.State* %0, i64* %RAX, i64 ptrtoint( %G__0x425610_type* @G__0x425610 to i64))
