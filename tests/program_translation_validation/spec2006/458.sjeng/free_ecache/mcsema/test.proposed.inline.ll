...
define %struct.Memory* @free_ecache(%struct.State* noalias, i64, %struct.Memory* noalias) #2 {
entry:
  ...
  %RAX.i9 = bitcast %union.anon* %34 to i64*
  %35 = load i64, i64* %PC.i8
  %36 = add i64 %35, 8
  store i64 %36, i64* %PC.i8
  %37 = load i64, i64* bitcast (%G_0x62e508_type* @G_0x62e508 to i64*)
  store i64 %37, i64* %RAX.i9, align 8
  ...
  %RDI.i = bitcast %union.anon* %46 to i64*
  %47 = load i64, i64* %RAX.i
  ...
  %PC.i6 = bitcast %union.anon* %52 to i64*
  %53 = load i64, i64* %PC.i6
  %54 = add i64 %53, -8303
  ...
  store %struct.Memory* %loadMem1_402caf, %struct.Memory** %MEMORY
  %loadMem2_402caf = load %struct.Memory*, %struct.Memory** %MEMORY
  %loadPC_402caf = load i64, i64* %3
  %64 = call %struct.Memory* @__remill_function_call(%struct.State* %0, i64 ptrtoint (i64 (i64)* @free to i64), %struct.Memory* %loadMem2_402caf)
  ...
  ret %struct.Memory* %loadMem_402cb5
}
