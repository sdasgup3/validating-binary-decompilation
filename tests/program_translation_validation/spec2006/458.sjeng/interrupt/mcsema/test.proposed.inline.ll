...
define %struct.Memory* @interrupt(%struct.State* noalias, i64, %struct.Memory* noalias) #2 {
entry:
  ...
  store %struct.Memory* %loadMem_4243e0, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_4243e1, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_4243e6, %struct.Memory** %MEMORY
  ...
  ret %struct.Memory* %loadMem_4243e7
}
