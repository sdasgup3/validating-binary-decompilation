...
define %struct.Memory* @l_knight_mobility(%struct.State* noalias, i64, %struct.Memory* noalias) #2 {
entry:
...
block_.L_4065d5:                                  ; preds = %block_.L_40660c, %entry
  ...
  store %struct.Memory* %loadMem_4065d5, %struct.Memory** %MEMORY
...
block_4065fe:                                     ; preds = %block_4065df
  ...
  store %struct.Memory* %loadMem_4065fe, %struct.Memory** %MEMORY
...
block_.L_406607:                                  ; preds = %block_4065fe, %block_4065df
...
block_.L_40660c:                                  ; preds = %block_.L_406607
...
block_.L_40661a:                                  ; preds = %block_.L_4065d5
  ...
  ret %struct.Memory* %loadMem_40661e
}
...
define %struct.Memory* @routine_addl_0x427b70___rcx_4____eax(%struct.State* dereferenceable(3376), i64, %struct.Memory*) {
block_400488:
  %3 = getelementptr inbounds %struct.State, %struct.State* %0, i32 0, i32 6
  %4 = getelementptr inbounds %struct.GPR, %struct.GPR* %3, i32 0, i32 33
  %5 = getelementptr inbounds %struct.Reg, %struct.Reg* %4, i32 0, i32 0
