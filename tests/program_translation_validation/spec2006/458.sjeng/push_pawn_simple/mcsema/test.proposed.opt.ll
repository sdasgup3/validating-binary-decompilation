...
declare %struct.Memory* @sub_4096d0.add_move(%struct.State* noalias dereferenceable(3376), i64, %struct.Memory* noalias readnone returned) local_unnamed_addr

; Function Attrs: alwaysinline
define %struct.Memory* @push_pawn_simple(%struct.State* noalias, i64, %struct.Memory* noalias readnone returned) local_unnamed_addr #1 {
entry:
  ...
  %call2_4092e0 = tail call %struct.Memory* @sub_4096d0.add_move(%struct.State* %0, i64 %30, %struct.Memory* %2)
  ...
  ret %struct.Memory* %call2_4092e0
}
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_callq_.add_move(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
