...
define %struct.Memory* @rdifftime(%struct.State* noalias, i64, %struct.Memory* noalias) #2 {
entry:
  ...
  store %struct.Memory* %loadMem_423770, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_423771, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_423774, %struct.Memory** %MEMORY
  ...
  store i64 %78, i64* %81
  store %struct.Memory* %loadMem_423778, %struct.Memory** %MEMORY
  ...
  store i64 %93, i64* %96
  store %struct.Memory* %loadMem_42377c, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_423780, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_423784, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem1_423788, %struct.Memory** %MEMORY
  ...
  %XMM0.i = bitcast %union.VectorReg* %148 to %union.vec128_t*
  %149 = bitcast %union.vec128_t* %XMM0.i to i8*
  %150 = load i64, i64* %PC.i6
  %151 = add i64 %150, 4
  store i64 %151, i64* %PC.i6
  %152 = bitcast i8* %149 to double*
  %153 = load double, double* %152, align 1
  %154 = call double @llvm.trunc.f64(double %153)
  %155 = call double @llvm.fabs.f64(double %154)
  %156 = fcmp ogt double %155, 0x41DFFFFFFFC00000
  %157 = fptosi double %154 to i32
  %158 = zext i32 %157 to i64
  %159 = select i1 %156, i64 2147483648, i64 %158
  store i64 %159, i64* %RAX.i7, align 8
  ...
  %169 = load i32, i32* %EAX.i
  %170 = zext i32 %169 to i64
  %171 = load i64, i64* %PC.i5
  %172 = add i64 %171, 3
  store i64 %172, i64* %PC.i5
  %173 = shl i64 %170, 32
  ...
  store %struct.Memory* %loadMem_423794, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_423798, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_423799, %struct.Memory** %MEMORY
  ret %struct.Memory* %loadMem_423799
}
