...
define %struct.Memory* @rtime(%struct.State* noalias, i64, %struct.Memory* noalias) #2 {
entry:
  ...
  store %struct.Memory* %loadMem_423761, %struct.Memory** %MEMORY
  ...
  ret %struct.Memory* %loadMem_423767
}
