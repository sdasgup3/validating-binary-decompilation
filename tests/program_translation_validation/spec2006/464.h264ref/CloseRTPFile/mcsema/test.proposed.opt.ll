...
define %struct.Memory* @CloseRTPFile(%struct.State* noalias, i64, %struct.Memory* noalias readnone returned) local_unnamed_addr #1 {
entry:
  ...
  %40 = load i64, i64* bitcast (%G_0x6d1f90_type* @G_0x6d1f90 to i64*), align 8
  store i64 %40, i64* %RDI.i, align 8
  %41 = add i64 %10, -646721
  %42 = add i64 %10, 20
  %43 = add i64 %7, -32
  ...
  %call2_49ee70 = tail call %struct.Memory* @sub_401020.fclose_plt(%struct.State* %0, i64 %41, %struct.Memory* %2)
  ...
  ret %struct.Memory* %call2_49ee70
}
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_movq_0x6d1f90___rdi(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  ...
  %5 = load i64, i64* bitcast (%G_0x6d1f90_type* @G_0x6d1f90 to i64*), align 8
