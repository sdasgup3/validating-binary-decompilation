...
define %struct.Memory* @FastLine16Y_11(%struct.State* noalias, i64, %struct.Memory* noalias readnone returned) local_unnamed_addr #1 {
entry:
  ...
  %11 = add i64 %7, -16
  %12 = load i64, i64* %RDI.i33, align 8
  %13 = add i64 %10, 7
  ...
  %ECX.i26 = bitcast %union.anon* %29 to i32*
  %30 = load i64, i64* %RBP.i, align 8
  %31 = add i64 %30, -20
  %32 = load i32, i32* %ECX.i26, align 4
  ...
  store i64 %48, i64* %RDI.i33, align 8
  %RCX.i18 = getelementptr inbounds %union.anon, %union.anon* %29, i64 0, i32 0
  %49 = add i64 %43, -12
  %50 = add i64 %45, 7
  ...
  store i64 %53, i64* %RCX.i18, align 8
  %54 = add i64 %43, -24
  %55 = add i64 %45, 11
  ...
  store i64 %62, i64* %RCX.i18, align 8
  %63 = shl i64 %60, 32
  ...
  store i64 %86, i64* %RCX.i18, align 8
  %RAX.i11 = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 1, i32 0, i32 0
  %87 = sext i32 %85 to i64
  %88 = shl nsw i64 %87, 1
  %89 = load i64, i64* %RDI.i33, align 8
  %90 = add i64 %88, %89
  store i64 %90, i64* %RDI.i33, align 8
...
define %struct.Memory* @routine_imull_MINUS0x18__rbp____ecx(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned) local_unnamed_addr #3 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %RCX = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 5, i32 0, i32 0
  %RBP = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 15, i32 0, i32 0
