...
define %struct.Memory* @FastPelY_14(%struct.State* noalias, i64, %struct.Memory* noalias readnone returned) local_unnamed_addr #1 {
entry:
  ...
  %ECX.i28 = bitcast %union.anon* %29 to i32*
  %30 = load i64, i64* %RBP.i, align 8
  %31 = add i64 %30, -20
  %32 = load i32, i32* %ECX.i28, align 4
  ...
  %RCX.i20 = getelementptr inbounds %union.anon, %union.anon* %29, i64 0, i32 0
  %49 = add i64 %43, -12
  %50 = add i64 %45, 7
  ...
  store i64 %54, i64* %RCX.i20, align 8
  %55 = icmp ugt i32 %52, -17
  %56 = zext i1 %55 to i8
  ...
  store i64 %82, i64* %RAX.i16, align 8
  %83 = shl nsw i64 %82, 3
  %84 = add i64 %48, %83
  %85 = add i64 %45, 17
  ...
  store i64 %87, i64* %RAX.i16, align 8
  %88 = add i64 %43, -16
  %89 = add i64 %45, 20
  ...
  store i64 %93, i64* %RCX.i20, align 8
  %94 = icmp ugt i32 %91, -17
  %95 = zext i1 %94 to i8
  ...
  store i64 %115, i64* %RDI.i35, align 8
  ...
  store i64 %121, i64* %RAX.i16, align 8
  %122 = add i64 %45, 31
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_movzwl___rax__rdi_2____eax(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %RAX = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 1, i32 0, i32 0
  %RDI = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 11, i32 0, i32 0
