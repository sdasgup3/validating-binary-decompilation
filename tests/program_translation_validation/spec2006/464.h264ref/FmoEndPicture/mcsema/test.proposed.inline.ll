...
define %struct.Memory* @FmoEndPicture(%struct.State* noalias, i64, %struct.Memory* noalias) #2 {
entry:
  ...
  store %struct.Memory* %loadMem_4259f0, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_4259f1, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_4259f4, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_4259f6, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_4259f7, %struct.Memory** %MEMORY
  ret %struct.Memory* %loadMem_4259f7
}
