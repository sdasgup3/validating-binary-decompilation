...
@G__0x4c0082 = global %G__0x4c0082_type zeroinitializer
...
define %struct.Memory* @ReportB(%struct.State* noalias, i64, %struct.Memory* noalias) local_unnamed_addr #1 {
entry:
  ...
  store i64 ptrtoint (%G__0x4c0082_type* @G__0x4c0082 to i64), i64* %RAX.i98, align 8
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_movq__0x4c0082___rax(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  ...
  store i64 ptrtoint (%G__0x4c0082_type* @G__0x4c0082 to i64), i64* %RAX, align 8
  ret %struct.Memory* %2
}
