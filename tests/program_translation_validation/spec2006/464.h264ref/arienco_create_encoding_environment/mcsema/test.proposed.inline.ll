...
define %struct.Memory* @arienco_create_encoding_environment(%struct.State* noalias, i64, %struct.Memory* noalias) #2 {
entry:
  ...
  store i64 104, i64* %RAX.i21, align 8
  ...
  %125 = call %struct.Memory* @__remill_function_call(%struct.State* %0, i64 ptrtoint (i64 (i64, i64)* @calloc to i64), %struct.Memory* %loadMem2_401446)
...
block_401459:                                     ; preds = %entry
  ...
  store i64 ptrtoint (%G__0x4bd8b7_type* @G__0x4bd8b7 to i64), i64* %RDI.i, align 8
  ...
  store %struct.Memory* %loadMem1_401463, %struct.Memory** %MEMORY
...
block_.L_401468:                                  ; preds = %block_401459, %entry
  ...
  ret %struct.Memory* %loadMem_401471
}
...
define %struct.Memory* @routine_movq__0x4bd8b7___rdi(%struct.State* dereferenceable(3376), i64, %struct.Memory*) {
block_400488:
  %3 = getelementptr inbounds %struct.State, %struct.State* %0, i32 0, i32 6
  %4 = getelementptr inbounds %struct.GPR, %struct.GPR* %3, i32 0, i32 33
  %5 = getelementptr inbounds %struct.Reg, %struct.Reg* %4, i32 0, i32 0
