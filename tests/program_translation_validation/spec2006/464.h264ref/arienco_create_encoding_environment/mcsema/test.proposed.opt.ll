...
@G__0x4bd8b7 = global %G__0x4bd8b7_type zeroinitializer
...
define %struct.Memory* @arienco_create_encoding_environment(%struct.State* noalias, i64, %struct.Memory* noalias) local_unnamed_addr #1 {
entry:
  ...
  store i64 104, i64* %RAX.i26, align 8
  ...
  br i1 %59, label %block_401459, label %block_.L_401468

block_401459:                                     ; preds = %entry
  store i64 ptrtoint (%G__0x4bd8b7_type* @G__0x4bd8b7 to i64), i64* %RDI.i24, align 8
  %64 = add i64 %63, 360343
  %65 = add i64 %63, 15
  ...
  %call2_401463 = tail call %struct.Memory* @sub_4593f0.no_mem_exit(%struct.State* nonnull %0, i64 %64, %struct.Memory* %44)
  %.pre = load i64, i64* %3, align 8
  br label %block_.L_401468

block_.L_401468:                                  ; preds = %entry, %block_401459
  %69 = phi i64 [ %63, %entry ], [ %.pre, %block_401459 ]
  %MEMORY.0 = phi %struct.Memory* [ %44, %entry ], [ %call2_401463, %block_401459 ]
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_jne_.L_401468(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i8* nocapture %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_movq__0x4bd8b7___rdi(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %RDI = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 11, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, 10
  store i64 %4, i64* %PC, align 8
  store i64 ptrtoint (%G__0x4bd8b7_type* @G__0x4bd8b7 to i64), i64* %RDI, align 8
  ret %struct.Memory* %2
}
