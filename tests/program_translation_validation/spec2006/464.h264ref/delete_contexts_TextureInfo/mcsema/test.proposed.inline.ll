...
define %struct.Memory* @delete_contexts_TextureInfo(%struct.State* noalias, i64, %struct.Memory* noalias) #2 {
entry:
...
block_.L_41006c:                                  ; preds = %entry
  ...
  %179 = call %struct.Memory* @__remill_function_call(%struct.State* %0, i64 ptrtoint (i64 (i64)* @free to i64), %struct.Memory* %loadMem2_410073)
...
block_.L_410078:                                  ; preds = %block_.L_41006c, %block_410067
  ...
  store %struct.Memory* %loadMem_41007d, %struct.Memory** %MEMORY
  ret %struct.Memory* %loadMem_41007d
}
