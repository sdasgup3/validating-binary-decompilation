...
define %struct.Memory* @dummy_slice_too_big(%struct.State* noalias, i64, %struct.Memory* noalias) #2 {
entry:
  ...
  %loadMem_430090 = load %struct.Memory*, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_430090, %struct.Memory** %MEMORY
  %loadMem_430091 = load %struct.Memory*, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_430091, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_430094, %struct.Memory** %MEMORY
  %loadMem_430096 = load %struct.Memory*, %struct.Memory** %MEMORY
  ...
  store i32 %72, i32* %76
  store %struct.Memory* %loadMem_430096, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_43009a, %struct.Memory** %MEMORY
  ret %struct.Memory* %loadMem_43009a
}
