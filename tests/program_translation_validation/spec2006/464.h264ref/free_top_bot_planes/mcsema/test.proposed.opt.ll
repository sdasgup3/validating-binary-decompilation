...
define %struct.Memory* @free_top_bot_planes(%struct.State* noalias, i64, %struct.Memory* noalias) local_unnamed_addr #1 {
entry:
  ...
  %45 = add i64 %44, -16
  %46 = load i64, i64* %RSI.i23, align 8
  ...
  store i64 %55, i64* %RSI.i23, align 8
  store i64 %55, i64* %RDI.i26, align 8
  %56 = add i64 %52, -361696
  %57 = add i64 %52, 12
  ...
  store i64 %67, i64* %RSI.i23, align 8
  store i64 %67, i64* %RDI.i26, align 8
  %68 = add i64 %64, -361708
  %69 = add i64 %64, 12
  ...
  %73 = tail call %struct.Memory* @__remill_function_call(%struct.State* %0, i64 ptrtoint (i64 (i64)* @free to i64), %struct.Memory* %61)
