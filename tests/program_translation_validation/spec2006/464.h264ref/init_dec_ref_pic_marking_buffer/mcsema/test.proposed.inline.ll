...
define %struct.Memory* @init_dec_ref_pic_marking_buffer(%struct.State* noalias, i64, %struct.Memory* noalias) #2 {
entry:
  ...
  ret %struct.Memory* %loadMem_42dd48
}
...
define %struct.Memory* @routine_movq__0x0__0x11b40__rax_(%struct.State* dereferenceable(3376), i64, %struct.Memory*) {
block_400488:
  %3 = getelementptr inbounds %struct.State, %struct.State* %0, i32 0, i32 6
  %4 = getelementptr inbounds %struct.GPR, %struct.GPR* %3, i32 0, i32 33
  %5 = getelementptr inbounds %struct.Reg, %struct.Reg* %4, i32 0, i32 0
