...
define %struct.Memory* @is_short_ref(%struct.State* noalias, i64, %struct.Memory* noalias readnone returned) local_unnamed_addr #1 {
entry:
  ...
  %CL.i34 = bitcast %union.anon* %17 to i8*
  store i8 0, i8* %CL.i34, align 1
  %RDI.i30 = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 11, i32 0, i32 0
  %18 = add i64 %7, -16
  %19 = load i64, i64* %RDI.i30, align 8
  %20 = add i64 %10, 11
  ...
  store i64 %27, i64* %RDI.i30, align 8
  %28 = add i64 %27, 6380
  %29 = add i64 %24, 11
  ...
  %47 = icmp ne i8 %46, 0
  %.v = select i1 %47, i64 26, i64 6
  %48 = add i64 %45, %.v
  store i64 %48, i64* %3, align 8
  %cmpBr_44c15a = icmp eq i8 %46, 1
...
block_44c160:                                     ; preds = %entry
  ...
  store i64 %53, i64* %RAX.i36, align 8
  %54 = add i64 %53, 6376
  %55 = add i64 %48, 11
...
block_.L_44c174:                                  ; preds = %block_44c160, %entry
  %70 = phi i64 [ %.pre, %block_44c160 ], [ %48, %entry ]
  ...
  store i64 %82, i64* %RAX.i36, align 8
  %83 = add i64 %70, 9
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_je_.L_44c174(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i8* nocapture %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
