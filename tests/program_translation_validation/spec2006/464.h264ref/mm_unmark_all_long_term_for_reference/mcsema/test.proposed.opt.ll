...
declare %struct.Memory* @sub_44eb90.mm_update_max_long_term_frame_idx(%struct.State* noalias dereferenceable(3376), i64, %struct.Memory* noalias readnone returned) local_unnamed_addr

; Function Attrs: alwaysinline
define %struct.Memory* @mm_unmark_all_long_term_for_reference(%struct.State* noalias, i64, %struct.Memory* noalias readnone returned) local_unnamed_addr #0 {
entry:
  ...
  %call2_453ee6 = tail call %struct.Memory* @sub_44eb90.mm_update_max_long_term_frame_idx(%struct.State* %0, i64 %17, %struct.Memory* %2)
  ...
  store i64 %26, i64* %RBP.i, align 8
  ...
  ret %struct.Memory* %call2_453ee6
}
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_callq_.mm_update_max_long_term_frame_idx(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr #1 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
