...
define %struct.Memory* @reset_coding_state_cs_cm(%struct.State* noalias, i64, %struct.Memory* noalias) #2 {
entry:
  ...
  store %struct.Memory* %loadMem_49d6c0, %struct.Memory** %MEMORY
  %loadMem_49d6c1 = load %struct.Memory*, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_49d6c1, %struct.Memory** %MEMORY
  %loadMem_49d6c4 = load %struct.Memory*, %struct.Memory** %MEMORY
  ...
  %37 = load i64, i64* bitcast (%G_0x6cc628_type* @G_0x6cc628 to i64*)
  store i64 %37, i64* %RDI.i, align 8
  store %struct.Memory* %loadMem_49d6c4, %struct.Memory** %MEMORY
  %loadMem1_49d6cc = load %struct.Memory*, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem1_49d6cc, %struct.Memory** %MEMORY
  %loadMem2_49d6cc = load %struct.Memory*, %struct.Memory** %MEMORY
  %loadPC_49d6cc = load i64, i64* %3
  %call2_49d6cc = call %struct.Memory* @sub_49dc00.reset_coding_state(%struct.State* %0, i64 %loadPC_49d6cc, %struct.Memory* %loadMem2_49d6cc)
  store %struct.Memory* %call2_49d6cc, %struct.Memory** %MEMORY
  %loadMem_49d6d1 = load %struct.Memory*, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_49d6d1, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_49d6d2, %struct.Memory** %MEMORY
  ret %struct.Memory* %loadMem_49d6d2
}
