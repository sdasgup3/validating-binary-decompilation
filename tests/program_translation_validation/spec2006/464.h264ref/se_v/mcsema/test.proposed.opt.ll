...
define %struct.Memory* @se_v(%struct.State* noalias, i64, %struct.Memory* noalias readnone returned) local_unnamed_addr #1 {
entry:
  ...
  %call2_4aca14 = tail call %struct.Memory* @sub_4ac7d0.writeSyntaxElement_UVLC(%struct.State* %0, i64 %115, %struct.Memory* %2)
  ...
  ret %struct.Memory* %call2_4aca14
}
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_movq__0x4aca20___rax(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
