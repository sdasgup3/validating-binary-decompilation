...
define %struct.Memory* @setbitscount(%struct.State* noalias nocapture, i64, %struct.Memory* noalias readnone returned) local_unnamed_addr #0 {
entry:
  ...
  store i32 %21, i32* bitcast (%G_0x6cc5e8_type* @G_0x6cc5e8 to i32*), align 8
  %23 = add i64 %18, 11
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_movl__edi__0x6cc5e8(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned) local_unnamed_addr #1 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 11, i32 0
  %EDI = bitcast %union.anon* %3 to i32*
  ...
  %6 = add i64 %5, 7
  store i64 %6, i64* %PC, align 8
  store i32 %4, i32* bitcast (%G_0x6cc5e8_type* @G_0x6cc5e8 to i32*), align 8
  ret %struct.Memory* %2
}
