...
define %struct.Memory* @store_coding_state_cs_cm(%struct.State* noalias, i64, %struct.Memory* noalias) #2 {
entry:
  ...
  store %struct.Memory* %loadMem_49d6a0, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_49d6a1, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_49d6a4, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem1_49d6ac, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_49d6b1, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_49d6b2, %struct.Memory** %MEMORY
  ret %struct.Memory* %loadMem_49d6b2
}
