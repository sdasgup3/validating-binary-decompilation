...
define %struct.Memory* @store_coding_state_cs_cm(%struct.State* noalias, i64, %struct.Memory* noalias readnone returned) local_unnamed_addr #0 {
entry:
  ...
  %call2_49d6ac = tail call %struct.Memory* @sub_49d8c0.store_coding_state(%struct.State* %0, i64 %12, %struct.Memory* %2)
  ...
  ret %struct.Memory* %call2_49d6ac
}
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_callq_.store_coding_state(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr #1 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
