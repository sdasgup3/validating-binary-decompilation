...
define %struct.Memory* @sub_4004b0_add_sub(%struct.State* noalias dereferenceable(3376), i64, %struct.Memory* noalias readnone returned) local_unnamed_addr #1 {
block_4004b0:
  ...
  %125 = and i32 %119, 255
  %126 = tail call i32 @llvm.ctpop.i32(i32 %125) #2
  ...
  store i64 %153, i64* %PC, align 8, !tbaa !1261
  %154 = add i64 %147, 16
  store i64 %154, i64* %7, align 8, !tbaa !1261
  ret %struct.Memory* %2
}
