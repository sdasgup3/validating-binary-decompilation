...
entry:
  ...
  store %struct.Memory* %loadMem_4004a9, %struct.Memory** %MEMORY
  ...
  %loadMem_4004af = load %struct.Memory*, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem_4004af, %struct.Memory** %MEMORY
  ...
  ret %struct.Memory* %loadMem_4004b5
}
