...
entry:
  ...
  %RBP.i7 = bitcast %union.anon* %88 to i64*
  %89 = load i64, i64* %RBP.i7
  %90 = sub i64 %89, 4
  %91 = load i64, i64* %PC.i6
  %92 = add i64 %91, 7
  store i64 %92, i64* %PC.i6
  ...
  %PC.i5 = bitcast %union.anon* %96 to i64*
  %97 = load i64, i64* %PC.i5
  %98 = add i64 %97, -73
  %99 = load i64, i64* %PC.i5
  %100 = add i64 %99, 5
  %101 = load i64, i64* %PC.i5
  %102 = add i64 %101, 5
  store i64 %102, i64* %PC.i5
  ...
  store %struct.Memory* %loadMem1_4004f9, %struct.Memory** %MEMORY
...
; Function Attrs: alwaysinline
define %struct.Memory* @routine_callq_.add_sub(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) #2 {
block_400488:
  %3 = getelementptr inbounds %struct.State, %struct.State* %0, i32 0, i32 6
  %4 = getelementptr inbounds %struct.GPR, %struct.GPR* %3, i32 0, i32 33
  %5 = getelementptr inbounds %struct.Reg, %struct.Reg* %4, i32 0, i32 0
