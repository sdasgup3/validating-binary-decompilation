...
declare %struct.Memory* @sub_400490.add_sub(%struct.State* noalias dereferenceable(3376), i64, %struct.Memory* noalias readnone returned)
...
entry:
  ...
  store i64 20, i64* %RSI.i, align 8
  %40 = add i64 %7, -12
  %41 = add i64 %10, 24
  ...
  %call2_4004d9 = tail call %struct.Memory* @sub_400490.add_sub(%struct.State* %0, i64 %44, %struct.Memory* %2)
  %49 = load i64, i64* %RSP.i13, align 8
  ...
  ret %struct.Memory* %call2_4004d9
}
