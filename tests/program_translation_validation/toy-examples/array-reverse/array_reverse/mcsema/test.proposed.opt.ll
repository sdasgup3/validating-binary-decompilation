...
block_.L_40048b:                                  ; preds = %block_400497, %entry
  %64 = phi i64 [ %228, %block_400497 ], [ %.pre, %entry ]
  ...
  br i1 %100, label %block_400497, label %block_.L_4004e0

block_400497:                                     ; preds = %block_.L_40048b
  %102 = add i64 %65, -8
  %103 = add i64 %101, 4
...
block_.L_4004e0:                                  ; preds = %block_.L_40048b
  %229 = add i64 %101, 1
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_jge_.L_4004e0(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i8* nocapture %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr #2 {
block_400468:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_jmpq_.L_40048b(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr #2 {
block_400468:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
