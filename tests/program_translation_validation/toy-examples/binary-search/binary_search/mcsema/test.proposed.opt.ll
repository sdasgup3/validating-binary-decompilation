...
block_.L_4004ae:                                  ; preds = %block_.L_400523, %entry
  %75 = phi i64 [ %.pre, %entry ], [ %367, %block_.L_400523 ]
  %MEMORY.0 = phi %struct.Memory* [ %2, %entry ], [ %179, %block_.L_400523 ]
  ...
  br i1 %111, label %block_4004ba, label %block_.L_400528
...
routine_idivl__esi.exit:                          ; preds = %171, %169
  ...
  br i1 %248, label %block_4004ed, label %block_.L_4004f8
...
block_.L_4004f8:                                  ; preds = %routine_idivl__esi.exit
  ...
  br i1 %306, label %block_.L_40051a, label %block_40050c
...
block_.L_400523:                                  ; preds = %block_.L_40051a, %block_40050c
  %366 = phi i64 [ %.pre5, %block_.L_40051a ], [ %340, %block_40050c ]
  %367 = add i64 %366, -117
...
block_.L_40052f:                                  ; preds = %block_.L_400528, %block_4004ed
  %371 = phi i64 [ %.pre6, %block_.L_400528 ], [ %267, %block_4004ed ]
  %MEMORY.2 = phi %struct.Memory* [ %MEMORY.0, %block_.L_400528 ], [ %179, %block_4004ed ]
...
define %struct.Memory* @routine_jge_.L_400528(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i8* %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
...
define %struct.Memory* @routine_jne_.L_4004f8(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i8* %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
...
define %struct.Memory* @routine_jmpq_.L_40052f(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
...
define %struct.Memory* @routine_jle_.L_40051a(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i8* %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 2, i32 7
...
define %struct.Memory* @routine_jmpq_.L_400523(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
...
define %struct.Memory* @routine_jmpq_.L_4004ae(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
