...
entry:
  ...
  %115 = load i64, i64* inttoptr (i64 add (i64 ptrtoint (%G_0x400610_type* @G_0x400610 to i64), i64 200) to i64*)
  ...
  %139 = load i64, i64* bitcast (%G_0x400618_type* @G_0x400618 to i64*)
...
block_400478:
  ...
  %10 = add i64 %9, 8
  store i64 %10, i64* %PC
  %11 = load i64, i64* inttoptr (i64 add (i64 ptrtoint (%G_0x400610_type* @G_0x400610 to i64), i64 200) to i64*)
...
block_400478:
  ...
  %10 = add i64 %9, 8
  store i64 %10, i64* %PC
  %11 = load i64, i64* bitcast (%G_0x400618_type* @G_0x400618 to i64*)
  store i64 %11, i64* %RAX, align 8
  ret %struct.Memory* %2
}
