...
declare %struct.Memory.31* @sub_400490.binary_search(%struct.State.0* noalias dereferenceable(3376), i64, %struct.Memory.31* noalias readnone returned) local_unnamed_addr
