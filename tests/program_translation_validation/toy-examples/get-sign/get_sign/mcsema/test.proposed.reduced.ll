; ModuleID = '/tmp/tmpzl0yl_ae-query.ll'
...
define %struct.Memory* @get_sign(%struct.State* noalias nocapture readonly, i64, %struct.Memory* noalias readnone returned) local_unnamed_addr #1 {
entry:
  ...
  %var_2_20 = inttoptr i64 %var_2_17 to i32*
  %var_2_21 = load i32, i32* %var_2_20, align 4
  %var_2_22 = add i32 %var_2_21, -1
  %var_2_40 = lshr i32 %var_2_22, 31
  %var_2_43 = lshr i32 %var_2_21, 31
  %var_2_44 = xor i32 %var_2_40, %var_2_43
  %var_2_45 = add nuw nsw i32 %var_2_44, %var_2_43
  %var_2_46 = icmp eq i32 %var_2_45, 2
  %var_2_49 = icmp ne i32 %var_2_40, 0
  %var_2_50 = xor i1 %var_2_49, %var_2_46
  %var_2_52 = add i64 %var_2_16, -4
  %var_2_54 = inttoptr i64 %var_2_52 to i32*
  %.sink = zext i1 %var_2_50 to i32
  store i32 %.sink, i32* %var_2_54, align 4
...
; Function Attrs: alwaysinline norecurse nounwind
define %struct.Memory* @routine_jge_.L_4004cd(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i8* nocapture %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr #1 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
...
; Function Attrs: alwaysinline norecurse nounwind
define %struct.Memory* @routine_jmpq_.L_4004d4(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr #1 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
