...
define %struct.Memory.31* @get_sign(%struct.State.0* noalias, i64, %struct.Memory.31* noalias) local_unnamed_addr #1 {
entry:
  br i1 undef, label %block_.L_4004ad, label %block_4004a1
