...
declare %struct.Memory* @sub_4004b0.get_sign(%struct.State* noalias dereferenceable(3376), i64, %struct.Memory* noalias readnone returned)
...
entry:
  ...
  ; Code: movl $0x0, -0x4(%rbp)	 RIP: 4004ed	 Bytes: 7
  %loadMem_4004ed = load %struct.Memory*, %struct.Memory** %MEMORY
  %call_4004ed = call %struct.Memory* @routine_movl__0x0__MINUS0x4__rbp_(%struct.State* %0, i64  0, %struct.Memory* %loadMem_4004ed)
  store %struct.Memory* %call_4004ed, %struct.Memory** %MEMORY

  ; Code: callq .get_sign	 RIP: 4004f4	 Bytes: 5
  %loadMem1_4004f4 = load %struct.Memory*, %struct.Memory** %MEMORY
  %call1_4004f4 = call %struct.Memory* @routine_callq_.get_sign(%struct.State* %0, i64  0, %struct.Memory* %loadMem1_4004f4, i64 -68, i64 5, i64 5)
  ...
  %call2_4004f4 = call %struct.Memory* @sub_4004b0.get_sign(%struct.State* %0, i64  %loadPC_4004f4, %struct.Memory* %loadMem2_4004f4)
...
define %struct.Memory* @routine_callq_.get_sign(%struct.State*  dereferenceable(3376), i64, %struct.Memory*, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) alwaysinline {
block_400488:
  %3 = getelementptr inbounds %struct.State, %struct.State* %0, i32 0, i32 6
  %4 = getelementptr inbounds %struct.GPR, %struct.GPR* %3, i32 0, i32 33
  %5 = getelementptr inbounds %struct.Reg, %struct.Reg* %4, i32 0, i32 0
