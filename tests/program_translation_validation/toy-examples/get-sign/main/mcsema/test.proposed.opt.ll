...
declare %struct.Memory* @sub_400490.get_sign(%struct.State* noalias dereferenceable(3376), i64, %struct.Memory* noalias readnone returned) local_unnamed_addr
...
entry:
  ...
  %call2_4004d4 = tail call %struct.Memory* @sub_400490.get_sign(%struct.State* %0, i64 %44, %struct.Memory* %2)
  %49 = load i64, i64* %RSP.i12, align 8
  %50 = load i64, i64* %PC.i, align 8
  %51 = add i64 %49, 16
  store i64 %51, i64* %RSP.i12, align 8
  ...
  ret %struct.Memory* %call2_4004d4
}
...
define %struct.Memory* @routine_callq_.get_sign(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
