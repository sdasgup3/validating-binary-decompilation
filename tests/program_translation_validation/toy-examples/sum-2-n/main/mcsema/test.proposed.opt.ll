...
declare %struct.Memory* @sub_400470.sum_2_n(%struct.State* dereferenceable(3376), i64, %struct.Memory*) local_unnamed_addr
...
entry:
  ...
  %call2_4004c4 = tail call %struct.Memory* @sub_400470.sum_2_n(%struct.State* %0, i64 %44, %struct.Memory* %2)
  ...
  ret %struct.Memory* %call2_4004c4
}
