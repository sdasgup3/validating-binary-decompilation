...
declare %struct.Memory* @sub_400490.sum_2_n(%struct.State* noalias dereferenceable(3376), i64, %struct.Memory* noalias readnone returned) local_unnamed_addr
...
entry:
  ...
  %call2_4004e4 = tail call %struct.Memory* @sub_400490.sum_2_n(%struct.State* %0, i64 %44, %struct.Memory* %2)
