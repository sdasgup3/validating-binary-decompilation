...
entry:
  ...
  store %struct.Memory* %loadMem1_40052f, %struct.Memory** %MEMORY
  %loadMem2_40052f = load %struct.Memory*, %struct.Memory** %MEMORY
  %loadPC_40052f = load i64, i64* %3
  %219 = call %struct.Memory* @__remill_function_call(%struct.State* %0, i64 ptrtoint (i64 (i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64)* @printf to i64), %struct.Memory* %loadMem2_40052f)
