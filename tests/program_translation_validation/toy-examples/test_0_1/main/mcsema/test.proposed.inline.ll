...
@G__0x4005a4 = global %G__0x4005a4_type zeroinitializer
...
entry:
  ...
  store i64 add (i64 ptrtoint (%G__0x4005a4_type* @G__0x4005a4 to i64), i64 92), i64* %RDI.i, align 8
  ...
  %loadMem1_40050b = load %struct.Memory*, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem1_40050b, %struct.Memory** %MEMORY
  %loadMem2_40050b = load %struct.Memory*, %struct.Memory** %MEMORY
  %loadPC_40050b = load i64, i64* %3
  %109 = call %struct.Memory* @__remill_function_call(%struct.State* %0, i64 ptrtoint (i64 (i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64)* @printf to i64), %struct.Memory* %loadMem2_40050b)
...
block_400478:
  ...
  %10 = add i64 %9, 10
  store i64 %10, i64* %PC
  store i64 add (i64 ptrtoint (%G__0x4005a4_type* @G__0x4005a4 to i64), i64 92), i64* %RDI, align 8
  ret %struct.Memory* %2
}
