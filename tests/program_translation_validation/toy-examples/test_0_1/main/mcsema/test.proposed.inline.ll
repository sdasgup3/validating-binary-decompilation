...
entry:
  ...
  store i64 4195700, i64* %RDI.i, align 8
  ...
  %loadMem1_4004db = load %struct.Memory*, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem1_4004db, %struct.Memory** %MEMORY
  %loadMem2_4004db = load %struct.Memory*, %struct.Memory** %MEMORY
  %loadPC_4004db = load i64, i64* %3
  %call2_4004db = call %struct.Memory* @sub_4003d0.printf_plt(%struct.State* %0, i64 %loadPC_4004db, %struct.Memory* %loadMem2_4004db)
  store %struct.Memory* %call2_4004db, %struct.Memory** %MEMORY
  ...
  ret %struct.Memory* %loadMem_4004ec
}
...
define %struct.Memory* @routine_movq__0x400574___rdi(%struct.State* dereferenceable(3376), i64, %struct.Memory*) {
block_400468:
  %3 = getelementptr inbounds %struct.State, %struct.State* %0, i32 0, i32 6
  %4 = getelementptr inbounds %struct.GPR, %struct.GPR* %3, i32 0, i32 33
  %5 = getelementptr inbounds %struct.Reg, %struct.Reg* %4, i32 0, i32 0
  ...
  %10 = add i64 %9, 10
  store i64 %10, i64* %PC
  store i64 4195700, i64* %RDI, align 8
  ret %struct.Memory* %2
}
