...
entry:
  ...
  ; Code: movq $0x400574, %rdi	 RIP: 4004c8	 Bytes: 10
  %loadMem_4004c8 = load %struct.Memory*, %struct.Memory** %MEMORY
  %call_4004c8 = call %struct.Memory* @routine_movq__0x400574___rdi(%struct.State* %0, i64  0, %struct.Memory* %loadMem_4004c8)
  ...
  ; Code: movb $0x0, %al	 RIP: 4004d9	 Bytes: 2
  %loadMem_4004d9 = load %struct.Memory*, %struct.Memory** %MEMORY
  %call_4004d9 = call %struct.Memory* @routine_movb__0x0___al(%struct.State* %0, i64  0, %struct.Memory* %loadMem_4004d9)
  store %struct.Memory* %call_4004d9, %struct.Memory** %MEMORY

  ; Code: callq .printf_plt	 RIP: 4004db	 Bytes: 5
  %loadMem1_4004db = load %struct.Memory*, %struct.Memory** %MEMORY
  %call1_4004db = call %struct.Memory* @routine_callq_.printf_plt(%struct.State* %0, i64  0, %struct.Memory* %loadMem1_4004db, i64 -267, i64 5, i64 5)
  store %struct.Memory* %call1_4004db, %struct.Memory** %MEMORY
  ...
  ; Code: xorl %ecx, %ecx	 RIP: 4004e0	 Bytes: 2
  %loadMem_4004e0 = load %struct.Memory*, %struct.Memory** %MEMORY
  %call_4004e0 = call %struct.Memory* @routine_xorl__ecx___ecx(%struct.State* %0, i64  0, %struct.Memory* %loadMem_4004e0)
  store %struct.Memory* %call_4004e0, %struct.Memory** %MEMORY

  ; Code: movl %eax, -0x8(%rbp)	 RIP: 4004e2	 Bytes: 3
  %loadMem_4004e2 = load %struct.Memory*, %struct.Memory** %MEMORY
  %call_4004e2 = call %struct.Memory* @routine_movl__eax__MINUS0x8__rbp_(%struct.State* %0, i64  0, %struct.Memory* %loadMem_4004e2)
  store %struct.Memory* %call_4004e2, %struct.Memory** %MEMORY

  ; Code: movl %ecx, %eax	 RIP: 4004e5	 Bytes: 2
  %loadMem_4004e5 = load %struct.Memory*, %struct.Memory** %MEMORY
  %call_4004e5 = call %struct.Memory* @routine_movl__ecx___eax(%struct.State* %0, i64  0, %struct.Memory* %loadMem_4004e5)
  store %struct.Memory* %call_4004e5, %struct.Memory** %MEMORY

  ; Code: addq $0x10, %rsp	 RIP: 4004e7	 Bytes: 4
  %loadMem_4004e7 = load %struct.Memory*, %struct.Memory** %MEMORY
  %call_4004e7 = call %struct.Memory* @routine_addq__0x10___rsp(%struct.State* %0, i64  0, %struct.Memory* %loadMem_4004e7)
...
define %struct.Memory* @routine_movq__0x400574___rdi(%struct.State*  dereferenceable(3376), i64, %struct.Memory* ) #19 {
block_400468:
  %3 = getelementptr inbounds %struct.State, %struct.State* %0, i32 0, i32 6
  %4 = getelementptr inbounds %struct.GPR, %struct.GPR* %3, i32 0, i32 33
  %5 = getelementptr inbounds %struct.Reg, %struct.Reg* %4, i32 0, i32 0
  ...
  %10 = add i64 %9, 10
  store i64 %10, i64* %PC
  %11 = call %struct.Memory* @_ZN12_GLOBAL__N_1L3MOVI3RnWImE2InImEEEP6MemoryS6_R5StateT_T0_(%struct.Memory* %2, %struct.State* %0, i64* %RDI, i64 4195700)
