...
entry:
  ...
  ; Code: movq $0x4005d4, %rdi	 RIP: 400528	 Bytes: 10
  %loadMem_400528 = load %struct.Memory*, %struct.Memory** %MEMORY
  %call_400528 = call %struct.Memory* @routine_movq__0x4005d4___rdi(%struct.State* %0, i64  0, %struct.Memory* %loadMem_400528)
  ...
  ; Code: movb $0x0, %al	 RIP: 400539	 Bytes: 2
  %loadMem_400539 = load %struct.Memory*, %struct.Memory** %MEMORY
  %call_400539 = call %struct.Memory* @routine_movb__0x0___al(%struct.State* %0, i64  0, %struct.Memory* %loadMem_400539)
  store %struct.Memory* %call_400539, %struct.Memory** %MEMORY

  ; Code: callq .printf_plt	 RIP: 40053b	 Bytes: 5
  %loadMem1_40053b = load %struct.Memory*, %struct.Memory** %MEMORY
  %call1_40053b = call %struct.Memory* @routine_callq_.printf_plt(%struct.State* %0, i64  0, %struct.Memory* %loadMem1_40053b, i64 -283, i64 5, i64 5)
  store %struct.Memory* %call1_40053b, %struct.Memory** %MEMORY

  %loadMem2_40053b = load %struct.Memory*, %struct.Memory** %MEMORY
  %loadPC_40053b = load i64, i64* %3
  %call2_40053b = call %struct.Memory* @ext_printf(%struct.State* %0, i64  %loadPC_40053b, %struct.Memory* %loadMem2_40053b)
  store %struct.Memory* %call2_40053b, %struct.Memory** %MEMORY
  ...
  ; Code: movl %eax, -0x8(%rbp)	 RIP: 400542	 Bytes: 3
  %loadMem_400542 = load %struct.Memory*, %struct.Memory** %MEMORY
  %call_400542 = call %struct.Memory* @routine_movl__eax__MINUS0x8__rbp_(%struct.State* %0, i64  0, %struct.Memory* %loadMem_400542)
  store %struct.Memory* %call_400542, %struct.Memory** %MEMORY

  ; Code: movl %ecx, %eax	 RIP: 400545	 Bytes: 2
  %loadMem_400545 = load %struct.Memory*, %struct.Memory** %MEMORY
  %call_400545 = call %struct.Memory* @routine_movl__ecx___eax(%struct.State* %0, i64  0, %struct.Memory* %loadMem_400545)
...
define %struct.Memory* @routine_movq__0x4005d4___rdi(%struct.State*  dereferenceable(3376), i64, %struct.Memory* ) #19 alwaysinline {
block_400488:
  %3 = getelementptr inbounds %struct.State, %struct.State* %0, i32 0, i32 6
  %4 = getelementptr inbounds %struct.GPR, %struct.GPR* %3, i32 0, i32 33
  %5 = getelementptr inbounds %struct.Reg, %struct.Reg* %4, i32 0, i32 0
