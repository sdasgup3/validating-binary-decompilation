...
entry:
  ...
  ; Code: movb $0x0, %al	 RIP: 400509	 Bytes: 2
  %loadMem_400509 = load %struct.Memory*, %struct.Memory** %MEMORY
  %call_400509 = call %struct.Memory* @routine_movb__0x0___al(%struct.State* %0, i64  0, %struct.Memory* %loadMem_400509)
  store %struct.Memory* %call_400509, %struct.Memory** %MEMORY

  ; Code: callq .printf_plt	 RIP: 40050b	 Bytes: 5
  %loadMem1_40050b = load %struct.Memory*, %struct.Memory** %MEMORY
  %call1_40050b = call %struct.Memory* @routine_callq_.printf_plt(%struct.State* %0, i64  0, %struct.Memory* %loadMem1_40050b, i64 -283, i64 5, i64 5)
  store %struct.Memory* %call1_40050b, %struct.Memory** %MEMORY

  %loadMem2_40050b = load %struct.Memory*, %struct.Memory** %MEMORY
  %loadPC_40050b = load i64, i64* %3
  %call2_40050b = call %struct.Memory* @ext_printf(%struct.State* %0, i64  %loadPC_40050b, %struct.Memory* %loadMem2_40050b)
  store %struct.Memory* %call2_40050b, %struct.Memory** %MEMORY

  ; Code: xorl %ecx, %ecx	 RIP: 400510	 Bytes: 2
  %loadMem_400510 = load %struct.Memory*, %struct.Memory** %MEMORY
  %call_400510 = call %struct.Memory* @routine_xorl__ecx___ecx(%struct.State* %0, i64  0, %struct.Memory* %loadMem_400510)
  store %struct.Memory* %call_400510, %struct.Memory** %MEMORY

  ; Code: movl %eax, -0x8(%rbp)	 RIP: 400512	 Bytes: 3
  %loadMem_400512 = load %struct.Memory*, %struct.Memory** %MEMORY
  %call_400512 = call %struct.Memory* @routine_movl__eax__MINUS0x8__rbp_(%struct.State* %0, i64  0, %struct.Memory* %loadMem_400512)
  store %struct.Memory* %call_400512, %struct.Memory** %MEMORY

  ; Code: movl %ecx, %eax	 RIP: 400515	 Bytes: 2
  %loadMem_400515 = load %struct.Memory*, %struct.Memory** %MEMORY
  %call_400515 = call %struct.Memory* @routine_movl__ecx___eax(%struct.State* %0, i64  0, %struct.Memory* %loadMem_400515)
  store %struct.Memory* %call_400515, %struct.Memory** %MEMORY

  ; Code: addq $0x10, %rsp	 RIP: 400517	 Bytes: 4
  %loadMem_400517 = load %struct.Memory*, %struct.Memory** %MEMORY
  %call_400517 = call %struct.Memory* @routine_addq__0x10___rsp(%struct.State* %0, i64  0, %struct.Memory* %loadMem_400517)
