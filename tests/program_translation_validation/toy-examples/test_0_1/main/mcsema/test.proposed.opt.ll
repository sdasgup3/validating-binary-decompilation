...
entry:
  ...
  %call2_4004db = tail call %struct.Memory* @sub_4003d0.printf_plt(%struct.State* %0, i64 %45, %struct.Memory* %2)
  %50 = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 5, i32 0
  %ECX.i9 = bitcast %union.anon* %50 to i32*
  %RCX.i = getelementptr inbounds %union.anon, %union.anon* %50, i64 0, i32 0
  ...
  %57 = load i32, i32* %ECX.i9, align 4
  ...
  ret %struct.Memory* %call2_4004db
}
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_movq__0x400574___rdi(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned) local_unnamed_addr #2 {
block_400468:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
