; ModuleID = '/tmp/tmpi4pmu3kz-query.ll'
...
entry:
  ...
  %var_2_46 = add i64 %var_2_44, 7
  %var_2_47 = load i64, i64* %var_2_6, align 8
  %var_2_48 = add i64 %var_2_47, -8
  %var_2_49 = inttoptr i64 %var_2_48 to i64*
  store i64 %var_2_46, i64* %var_2_49, align 8
  store i64 %var_2_48, i64* %var_2_6, align 8
  %EAX.i = bitcast %union.anon* %var_2_43 to i32*
  %var_2_53 = load i64, i64* %RBP.i, align 8
  %var_2_54 = add i64 %var_2_53, -8
  %var_2_55 = load i32, i32* %EAX.i, align 4
  %var_2_56 = add i64 %var_2_44, -276
...
; Function Attrs: alwaysinline norecurse nounwind
define %struct.Memory* @routine_movq__0x4005d4___rdi(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned) local_unnamed_addr #1 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
