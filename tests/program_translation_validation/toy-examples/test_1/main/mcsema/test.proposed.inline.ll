...
entry:
  ...
  store %struct.Memory* %loadMem1_400540, %struct.Memory** %MEMORY
  %loadMem2_400540 = load %struct.Memory*, %struct.Memory** %MEMORY
  %loadPC_400540 = load i64, i64* %3
  %171 = call %struct.Memory* @__remill_function_call(%struct.State* %0, i64 ptrtoint (i64 (i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64)* @printf to i64), %struct.Memory* %loadMem2_400540)
