...
declare %struct.Memory* @sub_4004c0.foo(%struct.State* dereferenceable(3376), i64, %struct.Memory*) local_unnamed_addr
...
entry:
  ...
  %call2_4004f9 = tail call %struct.Memory* @sub_4004c0.foo(%struct.State* %0, i64 %45, %struct.Memory* %2)
  %50 = load i64, i64* %3, align 8
  store i64 4195764, i64* %RDI.i25, align 8
  ...
  %call2_400510 = tail call %struct.Memory* @sub_4003d0.printf_plt(%struct.State* %0, i64 %64, %struct.Memory* %call2_4004f9)
  ...
  ret %struct.Memory* %call2_400510
}
...
block_400468:
  ...
  %4 = add i64 %3, 10
  store i64 %4, i64* %PC, align 8
  store i64 4195764, i64* %RDI, align 8
  ret %struct.Memory* %2
}
