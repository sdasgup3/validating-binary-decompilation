...
@G__0x4005e4 = global %G__0x4005e4_type zeroinitializer
...
entry:
  ...
  %call2_400529 = tail call %struct.Memory* @sub_4004f0.foo(%struct.State* %0, i64 %45, %struct.Memory* %2)
  %50 = load i64, i64* %PC.i, align 8
  store i64 add (i64 ptrtoint (%G__0x4005e4_type* @G__0x4005e4 to i64), i64 156), i64* %RDI.i28, align 8
  ...
  %69 = tail call %struct.Memory* @__remill_function_call(%struct.State* %0, i64 ptrtoint (i64 (i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64)* @printf to i64), %struct.Memory* %call2_400529)
...
define %struct.Memory* @routine_movq__0x4005e4___rdi(%struct.State* dereferenceable(3376), i64, %struct.Memory*) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %RDI = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 11, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, 10
  store i64 %4, i64* %PC, align 8
  store i64 add (i64 ptrtoint (%G__0x4005e4_type* @G__0x4005e4 to i64), i64 156), i64* %RDI, align 8
  ret %struct.Memory* %2
}
