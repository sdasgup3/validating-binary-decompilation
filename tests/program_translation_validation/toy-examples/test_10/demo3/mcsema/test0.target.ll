...
define %struct.Memory.31* @demo3(%struct.State.0* noalias, i64, %struct.Memory.31* noalias) #1 {
entry:
  br label %block_.L_4006d5

block_.L_4006d5:                                  ; preds = %block_.L_400704, %entry
  br i1 undef, label %block_.L_40072a, label %block_4006e2

block_4006e2:                                     ; preds = %block_.L_4006d5
  br i1 undef, label %block_4006ef, label %block_.L_4006fb
