...
%G__0x4007b4_type = type <{ [4 x i8] }>
%G__0x4007c5_type = type <{ [8 x i8] }>
...
@G__0x4007b4 = global %G__0x4007b4_type zeroinitializer
@G__0x4007c5 = global %G__0x4007c5_type zeroinitializer
...
declare %struct.Memory* @sub_4006b0.demo3(%struct.State* noalias dereferenceable(3376), i64, %struct.Memory* noalias readnone returned) local_unnamed_addr
...
entry:
  ...
  store i64 and (i64 ptrtoint (%G__0x4007b4_type* @G__0x4007b4 to i64), i64 4294967295), i64* %RSI.i50, align 8
  %119 = add i64 %115, -375
  %120 = add i64 %115, 14
  ...
  %call2_400671 = tail call %struct.Memory* @sub_4006b0.demo3(%struct.State* %0, i64 %140, %struct.Memory* %124)
  %145 = load i64, i64* %PC.i, align 8
  store i64 ptrtoint (%G__0x4007c5_type* @G__0x4007c5 to i64), i64* %RDI.i74, align 8
  ...
  %160 = tail call %struct.Memory* @__remill_function_call(%struct.State* %0, i64 ptrtoint (i64 (i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64)* @printf to i64), %struct.Memory* %call2_400671)
...
define %struct.Memory* @routine_movl__0x4007b4___esi(%struct.State* dereferenceable(3376), i64, %struct.Memory*) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %RSI = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 9, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, 5
  store i64 %4, i64* %PC, align 8
  store i64 and (i64 ptrtoint (%G__0x4007b4_type* @G__0x4007b4 to i64), i64 4294967295), i64* %RSI, align 8
  ret %struct.Memory* %2
}
...
define %struct.Memory* @routine_movq__0x4007c5___rdi(%struct.State* dereferenceable(3376), i64, %struct.Memory*) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %RDI = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 11, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, 10
  store i64 %4, i64* %PC, align 8
  store i64 ptrtoint (%G__0x4007c5_type* @G__0x4007c5 to i64), i64* %RDI, align 8
  ret %struct.Memory* %2
}
