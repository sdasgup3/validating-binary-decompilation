...
@G__0x4007b4 = external global %G__0x4007b4_type
@G__0x4007c5 = external global %G__0x4007c5_type
...
declare %struct.Memory.31* @sub_4006b0.demo3(%struct.State.0* noalias dereferenceable(3376), i64, %struct.Memory.31* noalias readnone returned) local_unnamed_addr
