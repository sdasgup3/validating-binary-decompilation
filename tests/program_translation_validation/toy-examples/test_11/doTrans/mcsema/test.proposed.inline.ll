...
entry:
  ...
  store %struct.Memory* %loadMem1_400700, %struct.Memory** %MEMORY
  %loadMem2_400700 = load %struct.Memory*, %struct.Memory** %MEMORY
  %loadPC_400700 = load i64, i64* %3
  %111 = call %struct.Memory* @__remill_function_call(%struct.State* %0, i64 ptrtoint (i64 (i64)* @strlen to i64), %struct.Memory* %loadMem2_400700)
  ...
  %196 = call %struct.Memory* @__remill_function_call(%struct.State* %0, i64 ptrtoint (i64 (i64)* @malloc to i64), %struct.Memory* %loadMem2_400711)
...
block_400725:                                     ; preds = %entry
  ...
  %395 = call %struct.Memory* @__remill_function_call(%struct.State* %0, i64 ptrtoint (i64 (i64, i64, i64)* @memset to i64), %struct.Memory* %loadMem2_40073f)
...
block_.L_4007ae:                                  ; preds = %block_.L_4007a6, %block_.L_400799
  ...
  ret %struct.Memory* %loadMem_4007b7
}
