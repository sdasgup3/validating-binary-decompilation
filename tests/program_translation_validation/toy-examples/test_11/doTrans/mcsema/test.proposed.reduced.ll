; ModuleID = '/tmp/tmpd_6ganx8-query.ll'
...
entry:
  ...
  %var_2_55 = tail call %struct.Memory* @__remill_function_call(%struct.State* %0, i64 ptrtoint (i64 (i64)* @strlen to i64), %struct.Memory* %2)
  %var_2_96 = tail call %struct.Memory* @__remill_function_call(%struct.State* %0, i64 ptrtoint (i64 (i64)* @malloc to i64), %struct.Memory* %var_2_55)
...
block_400755:                                     ; preds = %entry
  %var_2_151 = tail call %struct.Memory* @__remill_function_call(%struct.State* nonnull %0, i64 ptrtoint (i64 (i64, i64, i64)* @memset to i64), %struct.Memory* %var_2_96)
  %var_2_1544 = load i64, i64* %RBP.i, align 8
  %var_2_1555 = add i64 %var_2_1544, -40
  %var_4_3 = inttoptr i64 %var_2_1555 to i8**
  %var_2_15816 = load i8*, i8** %var_4_3, align 8
  %var_2_1617 = load i8, i8* %var_2_15816, align 1
  %var_2_1708 = icmp eq i8 %var_2_1617, 0
  br i1 %var_2_1708, label %block_.L_4007de, label %block_400784.preheader
...
block_.L_4007de:                                  ; preds = %entry, %block_400755
  %MEMORY.2 = phi %struct.Memory* [ %var_2_151, %block_400755 ], [ %var_2_96, %entry ]
