...
define %struct.Memory.31* @doTrans(%struct.State.0* noalias, i64, %struct.Memory.31* noalias) local_unnamed_addr #1 {
entry:
  br i1 undef, label %block_.L_4007a6, label %block_400725

block_400725:                                     ; preds = %entry
  br label %block_.L_400744

block_.L_400744:                                  ; preds = %block_.L_40077c, %block_400725
  br i1 undef, label %block_.L_400799, label %block_400754

block_400754:                                     ; preds = %block_.L_400744
  br i1 undef, label %block_400764, label %block_.L_400770
