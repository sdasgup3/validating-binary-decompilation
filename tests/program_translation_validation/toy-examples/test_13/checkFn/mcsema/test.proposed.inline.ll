...
entry:
  ...
  %122 = call %struct.Memory* @__remill_function_call(%struct.State* %0, i64 ptrtoint (i64 (i64)* @strlen to i64), %struct.Memory* %loadMem2_400877)
...
block_.L_4008c3:                                  ; preds = %block_.L_4008be, %entry
  ...
  ret %struct.Memory* %loadMem_4008cb
}
