...
define %struct.Memory.31* @checkFn(%struct.State.0* noalias, i64, %struct.Memory.31* noalias) #1 {
entry:
  br i1 undef, label %block_.L_4008c3, label %block_40088b

block_40088b:                                     ; preds = %entry
  br i1 undef, label %block_4008b7, label %block_.L_4008be
