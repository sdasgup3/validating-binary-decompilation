...
block_.L_4008d5:                                  ; preds = %block_.L_400904, %entry
  ...
  br i1 %cmpBr_4008dc, label %block_.L_40092a, label %block_4008e2

block_4008e2:                                     ; preds = %block_.L_4008d5
  ...
  br i1 %cmpBr_4008e9, label %block_.L_4008fb, label %block_4008ef
...
block_.L_4008fb:                                  ; preds = %block_4008e2
...
block_.L_400904:                                  ; preds = %block_.L_4008fb, %block_4008ef
...
block_.L_40092a:                                  ; preds = %block_.L_4008d5
  ...
  ret %struct.Memory* %loadMem_40092b
}
...
define %struct.Memory* @routine_jne_.L_4008fb(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i8* %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) {
block_400468:
  %3 = getelementptr inbounds %struct.State, %struct.State* %0, i32 0, i32 6
  %4 = getelementptr inbounds %struct.GPR, %struct.GPR* %3, i32 0, i32 33
  %5 = getelementptr inbounds %struct.Reg, %struct.Reg* %4, i32 0, i32 0
