...
block_.L_4008f5:                                  ; preds = %block_.L_400924, %entry
  %59 = phi i64 [ %194, %block_.L_400924 ], [ %.pre, %entry ]
  ...
  br i1 %73, label %block_.L_40094a, label %block_400902
...
block_400902:                                     ; preds = %block_.L_4008f5
  ...
  br i1 %95, label %block_40090f, label %block_.L_40091b
...
block_.L_400924:                                  ; preds = %block_.L_40091b, %block_40090f
  %121 = phi i64 [ %.pre1, %block_.L_40091b ], [ %112, %block_40090f ]
...
define %struct.Memory* @routine_je_.L_40094a(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i8* %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
...
define %struct.Memory* @routine_jne_.L_40091b(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i8* %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 2, i32 7
...
define %struct.Memory* @routine_jmpq_.L_4008f5(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
