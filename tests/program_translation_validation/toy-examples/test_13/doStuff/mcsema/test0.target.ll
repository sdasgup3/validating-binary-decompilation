...
define %struct.Memory.31* @doStuff(%struct.State.0* noalias, i64, %struct.Memory.31* noalias) #1 {
entry:
  br label %block_.L_4008f5

block_.L_4008f5:                                  ; preds = %block_.L_400924, %entry
  br i1 undef, label %block_.L_40094a, label %block_400902

block_400902:                                     ; preds = %block_.L_4008f5
  br i1 undef, label %block_.L_40091b, label %block_40090f
