...
entry:
  ...
  %168 = call %struct.Memory* @__remill_function_call(%struct.State* %0, i64 ptrtoint (i64 (i64)* @malloc to i64), %struct.Memory* %loadMem2_4007ee)
...
block_.L_4007f7:                                  ; preds = %block_.L_400837, %entry
...
block_400803:                                     ; preds = %block_.L_4007f7
  ...
  store %struct.Memory* %loadMem1_400817, %struct.Memory** %MEMORY
...
block_.L_400837:                                  ; preds = %block_.L_400832
...
block_.L_400845:                                  ; preds = %block_.L_4007f7
  ...
  ret %struct.Memory* %loadMem_400852
}
