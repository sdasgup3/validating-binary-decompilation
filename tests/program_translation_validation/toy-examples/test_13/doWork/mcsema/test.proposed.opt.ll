...
declare %struct.Memory* @sub_400860.checkFn(%struct.State* noalias dereferenceable(3376), i64, %struct.Memory* noalias readnone returned) local_unnamed_addr

declare %struct.Memory* @sub_4008d0.doStuff(%struct.State* noalias dereferenceable(3376), i64, %struct.Memory* noalias readnone returned) local_unnamed_addr
...
block_.L_4007f7:                                  ; preds = %block_.L_400832, %entry
  %88 = phi i64 [ %.pre, %entry ], [ %207, %block_.L_400832 ]
...
block_400803:                                     ; preds = %block_.L_4007f7
  ...
  %call2_400817 = tail call %struct.Memory* @sub_400860.checkFn(%struct.State* %0, i64 %147, %struct.Memory* %MEMORY.0)
...
block_400825:                                     ; preds = %block_400803
  ...
  %call2_40082d = tail call %struct.Memory* @sub_4008d0.doStuff(%struct.State* %0, i64 %171, %struct.Memory* %call2_400817)
...
define %struct.Memory* @routine_jge_.L_400845(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i8* %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
...
define %struct.Memory* @routine_jne_.L_400832(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i8* %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
...
define %struct.Memory* @routine_jmpq_.L_4007f7(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
