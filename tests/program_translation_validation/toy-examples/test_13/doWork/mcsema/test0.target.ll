...
declare %struct.Memory.31* @sub_400860.checkFn(%struct.State.0* noalias dereferenceable(3376), i64, %struct.Memory.31* noalias readnone returned)

declare %struct.Memory.31* @sub_4008d0.doStuff(%struct.State.0* noalias dereferenceable(3376), i64, %struct.Memory.31* noalias readnone returned)

; Function Attrs: alwaysinline
define %struct.Memory.31* @doWork(%struct.State.0* noalias, i64, %struct.Memory.31* noalias) #1 {
entry:
  br label %block_.L_4007f7

block_.L_4007f7:                                  ; preds = %block_.L_400832, %entry
  br i1 undef, label %block_400803, label %block_.L_400845

block_400803:                                     ; preds = %block_.L_4007f7
  br i1 undef, label %block_400825, label %block_.L_400832
