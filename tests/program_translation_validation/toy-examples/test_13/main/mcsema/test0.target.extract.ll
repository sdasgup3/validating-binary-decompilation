...
declare %struct.Memory* @sub_4007d0.doWork(%struct.State* noalias dereferenceable(3376), i64, %struct.Memory* noalias readnone returned) local_unnamed_addr
...
entry:
  ...
  %RAX.i35 = getelementptr inbounds %union.anon, %union.anon* %39, i64 0, i32 0
  store i64 4, i64* %RAX.i35, align 8
  %EAX.i54 = bitcast %union.anon* %39 to i32*
  ...
  %51 = add i64 %50, -16
  %52 = load i64, i64* %RSI.i112, align 8
  %53 = load i64, i64* %PC.i, align 8
  %54 = add i64 %53, 4
  store i64 %54, i64* %PC.i, align 8
  %55 = inttoptr i64 %51 to i64*
  store i64 %52, i64* %55, align 8
  %RDI.i128 = getelementptr inbounds %union.anon, %union.anon* %43, i64 0, i32 0
  %56 = load i64, i64* %RCX.i, align 8
  %57 = load i64, i64* %PC.i, align 8
  store i64 %56, i64* %RDI.i128, align 8
  %58 = add i64 %57, -288
  %59 = add i64 %57, 8
  ...
  %63 = call %struct.Memory* @__remill_function_call(%struct.State* %0, i64 ptrtoint (i64 (i64)* @malloc to i64), %struct.Memory* %2)
  %64 = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 7, i32 0
  %RDX.i = getelementptr inbounds %union.anon, %union.anon* %64, i64 0, i32 0
  %65 = load i64, i64* %PC.i, align 8
  store i64 8, i64* %RDX.i, align 8
  %EDX.i = bitcast %union.anon* %64 to i32*
  store i64 8, i64* %RDI.i128, align 8
  %66 = load i64, i64* %RBP.i, align 8
  %67 = add i64 %66, -56
  %68 = load i64, i64* %RAX.i35, align 8
  %69 = add i64 %65, 11
  ...
  %77 = call %struct.Memory* @__remill_function_call(%struct.State* %0, i64 ptrtoint (i64 (i64)* @malloc to i64), %struct.Memory* %63)
  %78 = load i64, i64* %PC.i, align 8
  store i64 4, i64* %RDX.i, align 8
  store i64 4, i64* %RDI.i128, align 8
  %79 = load i64, i64* %RBP.i, align 8
  %80 = add i64 %79, -64
  %81 = load i64, i64* %RAX.i35, align 8
  %82 = add i64 %78, 11
  ...
  %90 = call %struct.Memory* @__remill_function_call(%struct.State* %0, i64 ptrtoint (i64 (i64)* @malloc to i64), %struct.Memory* %77)
  %91 = load i64, i64* %PC.i, align 8
  store i64 ptrtoint (%G__0x4009e4_type* @G__0x4009e4 to i64), i64* %RDI.i128, align 8
  ...
  %92 = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 17, i32 0
  %R8D.i211 = bitcast %union.anon* %92 to i32*
  %93 = getelementptr inbounds %union.anon, %union.anon* %92, i64 0, i32 0
  store i64 4, i64* %RCX.i, align 8
  store i64 8, i64* %93, align 8
  store i64 8, i64* %RSI.i112, align 8
  %94 = load i64, i64* %RBP.i, align 8
  %95 = add i64 %94, -72
  %96 = load i64, i64* %RAX.i35, align 8
  %97 = add i64 %91, 34
  ...
  %123 = load i64, i64* %RCX.i, align 8
  %124 = load i64, i64* %PC.i, align 8
  store i64 %123, i64* %RDX.i, align 8
  ...
  %135 = call %struct.Memory* @__remill_function_call(%struct.State* %0, i64 ptrtoint (i64 (i64, i64, i64)* @memset to i64), %struct.Memory* %90)
  ...
  store i64 %141, i64* %RDI.i128, align 8
  %142 = add i64 %136, -92
  %143 = add i64 %138, 7
  ...
  store i64 %146, i64* %RSI.i112, align 8
  %147 = add i64 %136, -88
  %148 = add i64 %138, 11
  ...
  %156 = call %struct.Memory* @__remill_function_call(%struct.State* %0, i64 ptrtoint (i64 (i64, i64, i64)* @memset to i64), %struct.Memory* %135)
  ...
  store i64 %162, i64* %RDI.i128, align 8
  %163 = add i64 %157, -92
  %164 = add i64 %159, 7
  ...
  store i64 %167, i64* %RSI.i112, align 8
  %168 = add i64 %157, -104
  %169 = add i64 %159, 11
  ...
  %177 = call %struct.Memory* @__remill_function_call(%struct.State* %0, i64 ptrtoint (i64 (i64, i64, i64)* @memset to i64), %struct.Memory* %156)
  ...
  store i64 %183, i64* %RDI.i128, align 8
  store i64 and (i64 ptrtoint (%G__0x4009d4_type* @G__0x4009d4 to i64), i64 4294967295), i64* %RSI.i112, align 8
  %184 = add i64 %180, -490
  %185 = add i64 %180, 14
  ...
  %189 = call %struct.Memory* @__remill_function_call(%struct.State* %0, i64 ptrtoint (i64 (i64, i64)* @strcpy to i64), %struct.Memory* %177)
  ...
  store i64 %195, i64* %RDI.i128, align 8
  store i64 and (i64 ptrtoint (%G__0x4009d8_type* @G__0x4009d8 to i64), i64 4294967295), i64* %93, align 8
  store i64 zext (i32 trunc (i64 and (i64 ptrtoint (%G__0x4009d8_type* @G__0x4009d8 to i64), i64 4294967295) to i32) to i64), i64* %RSI.i112, align 8
  %196 = add i64 %190, -112
  %197 = load i64, i64* %RAX.i35, align 8
  %198 = add i64 %192, 17
  ...
  %206 = call %struct.Memory* @__remill_function_call(%struct.State* %0, i64 ptrtoint (i64 (i64, i64)* @strcpy to i64), %struct.Memory* %189)
  ...
  store i64 %212, i64* %RDI.i128, align 8
  store i64 and (i64 ptrtoint (%G__0x4009e0_type* @G__0x4009e0 to i64), i64 4294967295), i64* %93, align 8
  store i64 zext (i32 trunc (i64 and (i64 ptrtoint (%G__0x4009e0_type* @G__0x4009e0 to i64), i64 4294967295) to i32) to i64), i64* %RSI.i112, align 8
  %213 = add i64 %207, -120
  %214 = load i64, i64* %RAX.i35, align 8
  %215 = add i64 %209, 17
  ...
  %223 = call %struct.Memory* @__remill_function_call(%struct.State* %0, i64 ptrtoint (i64 (i64, i64)* @strcpy to i64), %struct.Memory* %206)
  ...
  store i64 %229, i64* %RCX.i, align 8
  %230 = add i64 %224, -48
  %231 = add i64 %226, 8
  ...
  store i64 %256, i64* %RSI.i112, align 8
  %257 = add i64 %251, -80
  %258 = add i64 %253, 8
  store i64 %258, i64* %PC.i, align 8
  %259 = inttoptr i64 %257 to i64*
  %260 = load i64, i64* %259, align 8
  store i64 %260, i64* %RDI.i128, align 8
  %261 = add i64 %251, -128
  %262 = load i64, i64* %RAX.i35, align 8
  %263 = add i64 %253, 12
  store i64 %263, i64* %PC.i, align 8
  %264 = inttoptr i64 %261 to i64*
  store i64 %262, i64* %264, align 8
  %AL.i83 = bitcast %union.anon* %39 to i8*
  ...
  %271 = call %struct.Memory* @__remill_function_call(%struct.State* %0, i64 ptrtoint (i64 (i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64)* @printf to i64), %struct.Memory* %223)
  %272 = load i64, i64* %PC.i, align 8
  store i64 ptrtoint (%G__0x4009ed_type* @G__0x4009ed to i64), i64* %RDI.i128, align 8
  ...
  store i64 %277, i64* %RSI.i112, align 8
  %278 = add i64 %273, -132
  %279 = load i32, i32* %EAX.i54, align 4
  %280 = add i64 %272, 20
  ...
  %288 = call %struct.Memory* @__remill_function_call(%struct.State* %0, i64 ptrtoint (i64 (i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64)* @printf to i64), %struct.Memory* %271)
  %289 = load i64, i64* %PC.i, align 8
  store i64 ptrtoint (%G__0x4009f6_type* @G__0x4009f6 to i64), i64* %RDI.i128, align 8
  ...
  store i64 %294, i64* %RSI.i112, align 8
  %295 = add i64 %290, -136
  %296 = load i32, i32* %EAX.i54, align 4
  %297 = add i64 %289, 20
  ...
  %305 = call %struct.Memory* @__remill_function_call(%struct.State* %0, i64 ptrtoint (i64 (i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64)* @printf to i64), %struct.Memory* %288)
  %306 = load i64, i64* %PC.i, align 8
  store i64 3, i64* %RSI.i112, align 8
  %307 = load i64, i64* %RBP.i, align 8
  %308 = add i64 %307, -48
  store i64 %308, i64* %RDI.i128, align 8
  %309 = add i64 %307, -140
  %310 = load i32, i32* %EAX.i54, align 4
  %311 = add i64 %306, 15
  ...
  %call2_400764 = call %struct.Memory* @sub_4007d0.doWork(%struct.State* %0, i64 %314, %struct.Memory* %305)
  ...
  store i64 %324, i64* %RSI.i112, align 8
  store i8 0, i8* %AL.i83, align 1
  %325 = add i64 %319, -633
  %326 = add i64 %319, 21
  ...
  %330 = call %struct.Memory* @__remill_function_call(%struct.State* %0, i64 ptrtoint (i64 (i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64)* @printf to i64), %struct.Memory* %call2_400764)
  ...
  store i64 %336, i64* %RSI.i112, align 8
  %337 = add i64 %332, -144
  %338 = load i32, i32* %EAX.i54, align 4
  %339 = add i64 %331, 20
  ...
  %347 = call %struct.Memory* @__remill_function_call(%struct.State* %0, i64 ptrtoint (i64 (i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64)* @printf to i64), %struct.Memory* %330)
  ...
  store i64 %353, i64* %RSI.i112, align 8
  %354 = add i64 %349, -148
  %355 = load i32, i32* %EAX.i54, align 4
  %356 = add i64 %348, 20
  ...
  %364 = call %struct.Memory* @__remill_function_call(%struct.State* %0, i64 ptrtoint (i64 (i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64)* @printf to i64), %struct.Memory* %347)
  %365 = load i64, i64* %PC.i, align 8
  store i64 0, i64* %93, align 8
  %366 = load i64, i64* %RBP.i, align 8
  %367 = add i64 %366, -152
  %368 = load i32, i32* %EAX.i54, align 4
  %369 = add i64 %365, 9
  store i64 %369, i64* %PC.i, align 8
  %370 = inttoptr i64 %367 to i32*
  store i32 %368, i32* %370, align 4
  %371 = load i32, i32* %R8D.i211, align 4
  %372 = zext i32 %371 to i64
  %373 = load i64, i64* %PC.i, align 8
  store i64 %372, i64* %RAX.i35, align 8
  %374 = load i64, i64* %RSP.i11, align 8
  %375 = add i64 %374, 160
  store i64 %375, i64* %RSP.i11, align 8
  %376 = icmp ugt i64 %374, -161
  ...
  store i64 %400, i64* %RBP.i, align 8
