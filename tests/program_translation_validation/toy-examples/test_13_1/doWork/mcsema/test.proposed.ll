...
declare %struct.Memory* @sub_400500.checkFn(%struct.State* dereferenceable(3376), i64, %struct.Memory*)
...
entry:
  ...
  ; Code: .doWork:	 RIP: 400510	 Bytes: 0
  ...
  ; Code: movl $0x2, -0x4(%rbp)	 RIP: 400518	 Bytes: 7
  %loadMem_400518 = load %struct.Memory*, %struct.Memory** %MEMORY
  %call_400518 = call %struct.Memory* @routine_movl__0x2__MINUS0x4__rbp_(%struct.State* %0, i64  0, %struct.Memory* %loadMem_400518)
  store %struct.Memory* %call_400518, %struct.Memory** %MEMORY

  ; Code: callq .checkFn	 RIP: 40051f	 Bytes: 5
  %loadMem1_40051f = load %struct.Memory*, %struct.Memory** %MEMORY
  %call1_40051f = call %struct.Memory* @routine_callq_.checkFn(%struct.State* %0, i64  0, %struct.Memory* %loadMem1_40051f, i64 -31, i64 5, i64 5)
  store %struct.Memory* %call1_40051f, %struct.Memory** %MEMORY

  %loadMem2_40051f = load %struct.Memory*, %struct.Memory** %MEMORY
  %loadPC_40051f = load i64, i64* %3
  %call2_40051f = call %struct.Memory* @sub_400500.checkFn(%struct.State* %0, i64  %loadPC_40051f, %struct.Memory* %loadMem2_40051f)
  store %struct.Memory* %call2_40051f, %struct.Memory** %MEMORY

  ; Code: movl -0x4(%rbp), %eax	 RIP: 400524	 Bytes: 3
  %loadMem_400524 = load %struct.Memory*, %struct.Memory** %MEMORY
  %call_400524 = call %struct.Memory* @routine_movl_MINUS0x4__rbp____eax(%struct.State* %0, i64  0, %struct.Memory* %loadMem_400524)
