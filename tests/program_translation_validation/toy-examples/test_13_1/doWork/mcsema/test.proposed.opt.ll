...
declare %struct.Memory* @sub_400530.checkFn(%struct.State* noalias dereferenceable(3376), i64, %struct.Memory* noalias readnone returned) local_unnamed_addr
...
entry:
  ...
  %call2_40054f = tail call %struct.Memory* @sub_400530.checkFn(%struct.State* %0, i64 %44, %struct.Memory* %2)
  ...
  %56 = load i64, i64* %RSP.i13, align 8
  %57 = add i64 %56, 16
  store i64 %57, i64* %RSP.i13, align 8
  ...
  ret %struct.Memory* %call2_40054f
}
...
define %struct.Memory* @routine_movl__0x2__MINUS0x4__rbp_(%struct.State* dereferenceable(3376), i64, %struct.Memory*) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %RBP = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 15, i32 0, i32 0
  %3 = load i64, i64* %RBP, align 8
