...
declare %struct.Memory* @sub_400500.checkFn(%struct.State* dereferenceable(3376), i64, %struct.Memory*) local_unnamed_addr
...
entry:
  ...
  %call2_40051f = tail call %struct.Memory* @sub_400500.checkFn(%struct.State* %0, i64 %44, %struct.Memory* %2)
  ...
  ret %struct.Memory* %call2_40051f
}
