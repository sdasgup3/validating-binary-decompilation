; ModuleID = '/tmp/tmpz22k_mbv-query.ll'
...
entry:
  ...
  store i32 2, i32* %var_2_42, align 4
  ...
  %var_2_81 = add i64 %var_2_46, 16
  store i64 %var_2_81, i64* %var_2_6, align 8
  %var_2_84 = add i64 %var_2_43, -22
  ...
  %var_2_87 = add i64 %var_2_46, 24
  store i64 %var_2_87, i64* %var_2_6, align 8
...
; Function Attrs: alwaysinline norecurse nounwind
define %struct.Memory* @routine_movl__0x2__MINUS0x4__rbp_(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned) local_unnamed_addr #1 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %RBP = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 15, i32 0, i32 0
  %3 = load i64, i64* %RBP, align 8
