...
entry:
  ...
  %RSI.i23 = bitcast %union.anon* %99 to i64*
  ...
  %104 = sub i64 %103, 16
  %105 = load i64, i64* %RSI.i23
  %106 = load i64, i64* %PC.i22
  %107 = add i64 %106, 4
  store i64 %107, i64* %PC.i22
  ...
  %PC.i20 = bitcast %union.anon* %111 to i64*
  ...
  %AL.i21 = getelementptr inbounds %struct.anon.2, %struct.anon.2* %115, i32 0, i32 0
  ...
  %121 = load i64, i64* %PC.i19
  %122 = add i64 %121, 56
  %123 = load i64, i64* %PC.i19
  %124 = add i64 %123, 5
  %125 = load i64, i64* %PC.i19
  %126 = add i64 %125, 5
  store i64 %126, i64* %PC.i19
  ...
  %149 = load i32, i32* %EAX.i16
  %150 = zext i32 %149 to i64
  %151 = load i64, i64* %PC.i15
  %152 = add i64 %151, 2
  store i64 %152, i64* %PC.i15
  %153 = and i64 %150, 4294967295
  store i64 %153, i64* %RSI.i17, align 8
  ...
  %161 = load i64, i64* %PC.i14
  %162 = add i64 %161, 2
  store i64 %162, i64* %PC.i14
  ...
  %PC.i13 = bitcast %union.anon* %165 to i64*
  %166 = load i64, i64* %PC.i13
  %167 = add i64 %166, -299
  %168 = load i64, i64* %PC.i13
  %169 = add i64 %168, 5
  %170 = load i64, i64* %PC.i13
  %171 = add i64 %170, 5
  store i64 %171, i64* %PC.i13
  ...
  store %struct.Memory* %loadMem1_40054b, %struct.Memory** %MEMORY
  %loadMem2_40054b = load %struct.Memory*, %struct.Memory** %MEMORY
  %loadPC_40054b = load i64, i64* %3
  %177 = call %struct.Memory* @__remill_function_call(%struct.State* %0, i64 ptrtoint (i64 (i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64)* @printf to i64), %struct.Memory* %loadMem2_40054b)
  ...
  store i64 %194, i64* %RSI.i, align 8
  ...
  %219 = load i64, i64* %RBP.i7
  %220 = sub i64 %219, 20
  %221 = load i32, i32* %EAX.i
  ...
  %ESI.i = bitcast %union.anon* %231 to i32*
