; ModuleID = '/tmp/tmpdtevo7au-query.ll'
...
entry:
  ...
  %var_2_52 = load i64, i64* %RSI.i23, align 8
  ...
  %EAX.i16 = bitcast %union.anon* %var_2_56 to i32*
  %var_2_67 = add i64 %var_2_57, 77
  %var_2_69 = add i64 %var_2_60, -16
  %var_2_70 = inttoptr i64 %var_2_69 to i64*
  store i64 %var_2_67, i64* %var_2_70, align 8
  store i64 %var_2_69, i64* %var_2_6, align 8
  %var_2_73 = load i64, i64* %RBP.i, align 8
  %var_2_74 = add i64 %var_2_73, -20
  %var_2_75 = load i32, i32* %EAX.i16, align 4
  %var_2_76 = add i64 %var_2_57, -222
  store i64 %var_2_76, i64* %var_2_3, align 8
  %var_2_77 = inttoptr i64 %var_2_74 to i32*
  store i32 %var_2_75, i32* %var_2_77, align 4
  %var_2_80 = load i64, i64* %var_2_3, align 8
  %var_2_81 = load i64, i64* %var_2_6, align 8
  %var_2_108 = add i64 %var_2_80, 8
  store i64 %var_2_108, i64* %var_2_3, align 8
  %var_2_111 = add i64 %var_2_81, 48
...
; Function Attrs: alwaysinline norecurse nounwind
define %struct.Memory* @routine_callq_.doWork(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr #1 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
...
; Function Attrs: alwaysinline norecurse nounwind
define %struct.Memory* @routine_movq__0x400614___rdi(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned) local_unnamed_addr #1 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
