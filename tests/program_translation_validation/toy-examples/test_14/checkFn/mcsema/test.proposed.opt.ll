...
entry:
  ...
  store i64 ptrtoint (%G__0x400684_type* @G__0x400684 to i64), i64* %RAX.i19, align 8
  %RDI.i16 = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 11, i32 0, i32 0
  %40 = add i64 %7, -16
  %41 = load i64, i64* %RDI.i16, align 8
  %42 = add i64 %10, 21
  ...
  %45 = add i64 %44, -16
  %46 = load i64, i64* %RAX.i19, align 8
  ...
  store i64 %55, i64* %RDI.i16, align 8
  ...
  %65 = tail call %struct.Memory* @__remill_function_call(%struct.State* %0, i64 ptrtoint (i64 (i64, i64)* @strcmp to i64), %struct.Memory* %2)
  %66 = load i64, i64* %RSP.i6, align 8
  %67 = load i64, i64* %PC.i, align 8
  %68 = add i64 %66, 16
  store i64 %68, i64* %RSP.i6, align 8
  %69 = icmp ugt i64 %66, -17
  %70 = zext i1 %69 to i8
...
define %struct.Memory* @routine_movq__0x400684___rax(%struct.State* dereferenceable(3376), i64, %struct.Memory*) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  ...
  store i64 ptrtoint (%G__0x400684_type* @G__0x400684 to i64), i64* %RAX, align 8
  ret %struct.Memory* %2
}
