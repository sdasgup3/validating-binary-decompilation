; ModuleID = '/tmp/tmpoor56fso-query.ll'
...
@G__0x4006a8 = global %G__0x4006a8_type zeroinitializer
@G__0x4006ab = global %G__0x4006ab_type zeroinitializer
@G__0x4006af = global %G__0x4006af_type zeroinitializer
...
entry:
  ...
  %var_2_52 = load i64, i64* %RSI.i43, align 8
  ...
  %EAX.i34 = bitcast %union.anon* %var_2_39 to i32*
  %var_2_64 = load i64, i64* %RBP.i, align 8
  %var_2_65 = add i64 %var_2_64, -20
  %var_2_66 = load i32, i32* %EAX.i34, align 4
  %var_2_67 = add i64 %var_2_57, 125
  store i64 %var_2_67, i64* %var_2_3, align 8
  %var_2_68 = inttoptr i64 %var_2_65 to i32*
  store i32 %var_2_66, i32* %var_2_68, align 4
  %var_2_69 = load i64, i64* %var_2_3, align 8
  %var_2_71 = add i64 %var_2_69, 5
  %var_2_72 = load i64, i64* %var_2_6, align 8
  %var_2_73 = add i64 %var_2_72, -8
  %var_2_74 = inttoptr i64 %var_2_73 to i64*
  store i64 %var_2_71, i64* %var_2_74, align 8
  store i64 %var_2_73, i64* %var_2_6, align 8
  %var_2_76 = load i64, i64* %RBP.i, align 8
  %var_2_77 = add i64 %var_2_76, -24
  %var_2_78 = load i32, i32* %EAX.i34, align 4
  %var_2_79 = add i64 %var_2_69, 104
  store i64 %var_2_79, i64* %var_2_3, align 8
  %var_2_80 = inttoptr i64 %var_2_77 to i32*
  store i32 %var_2_78, i32* %var_2_80, align 4
  %var_2_81 = load i64, i64* %var_2_3, align 8
  %var_2_83 = add i64 %var_2_81, 5
  %var_2_84 = load i64, i64* %var_2_6, align 8
  %var_2_85 = add i64 %var_2_84, -8
  %var_2_86 = inttoptr i64 %var_2_85 to i64*
  store i64 %var_2_83, i64* %var_2_86, align 8
  store i64 %var_2_85, i64* %var_2_6, align 8
  %var_2_88 = load i64, i64* %RBP.i, align 8
  %var_2_89 = add i64 %var_2_88, -28
  %var_2_90 = load i32, i32* %EAX.i34, align 4
  %var_2_91 = add i64 %var_2_81, 86
  store i64 %var_2_91, i64* %var_2_3, align 8
  %var_2_92 = inttoptr i64 %var_2_89 to i32*
  store i32 %var_2_90, i32* %var_2_92, align 4
  %var_2_95 = load i64, i64* %var_2_3, align 8
  %var_2_112 = add i64 %var_2_95, 16
  %var_2_113 = load i64, i64* %var_2_6, align 8
  %var_2_114 = add i64 %var_2_113, -8
  %var_2_115 = inttoptr i64 %var_2_114 to i64*
  store i64 %var_2_112, i64* %var_2_115, align 8
  store i64 %var_2_114, i64* %var_2_6, align 8
  %var_2_118 = load i64, i64* %RBP.i, align 8
  %var_2_119 = add i64 %var_2_118, -32
  %var_2_120 = load i32, i32* %EAX.i34, align 4
  %var_2_121 = add i64 %var_2_95, -356
  store i64 %var_2_121, i64* %var_2_3, align 8
  %var_2_122 = inttoptr i64 %var_2_119 to i32*
  store i32 %var_2_120, i32* %var_2_122, align 4
  %var_2_125 = load i64, i64* %var_2_3, align 8
  %var_2_126 = load i64, i64* %var_2_6, align 8
  %var_2_153 = add i64 %var_2_125, 8
  store i64 %var_2_153, i64* %var_2_3, align 8
  %var_2_156 = add i64 %var_2_126, 48
...
; Function Attrs: alwaysinline norecurse nounwind
define %struct.Memory* @routine_movq__0x4006ab___rax(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned) local_unnamed_addr #1 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  ...
  store i64 ptrtoint (%G__0x4006ab_type* @G__0x4006ab to i64), i64* %RAX, align 8
  ret %struct.Memory* %2
}
...
; Function Attrs: alwaysinline norecurse nounwind
define %struct.Memory* @routine_callq_.checkFn(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr #1 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
...
; Function Attrs: alwaysinline norecurse nounwind
define %struct.Memory* @routine_movq__0x4006a4___rdi(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned) local_unnamed_addr #1 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %RDI = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 11, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
...
; Function Attrs: alwaysinline norecurse nounwind
define %struct.Memory* @routine_movq__0x4006a8___rdi(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned) local_unnamed_addr #1 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %RDI = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 11, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, 10
  store i64 %4, i64* %PC, align 8
  store i64 ptrtoint (%G__0x4006a8_type* @G__0x4006a8 to i64), i64* %RDI, align 8
  ret %struct.Memory* %2
}
...
; Function Attrs: alwaysinline norecurse nounwind
define %struct.Memory* @routine_movq__0x4006af___rdi(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned) local_unnamed_addr #1 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %RDI = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 11, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, 10
  store i64 %4, i64* %PC, align 8
  store i64 ptrtoint (%G__0x4006af_type* @G__0x4006af to i64), i64* %RDI, align 8
  ret %struct.Memory* %2
}
...
; Function Attrs: alwaysinline norecurse nounwind
define %struct.Memory* @routine_movl_MINUS0x14__rbp____esi(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned) local_unnamed_addr #1 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %RSI = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 9, i32 0, i32 0
  %RBP = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 15, i32 0, i32 0
...
; Function Attrs: alwaysinline norecurse nounwind
define %struct.Memory* @routine_movl_MINUS0x18__rbp____edx(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned) local_unnamed_addr #1 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
...
; Function Attrs: alwaysinline norecurse nounwind
define %struct.Memory* @routine_movl_MINUS0x1c__rbp____ecx(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned) local_unnamed_addr #1 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
