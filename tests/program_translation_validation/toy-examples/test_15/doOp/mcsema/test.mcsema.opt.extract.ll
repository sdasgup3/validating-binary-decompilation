...
define %struct.Memory* @sub_400590_doOp(%struct.State* noalias nocapture dereferenceable(3376), i64, %struct.Memory* noalias readnone returned) local_unnamed_addr #1 {
block_400590:
  ...
  %36 = and i32 %29, 255
  %37 = tail call i32 @llvm.ctpop.i32(i32 %36) #2
  ...
  %75 = add i64 %68, 16
  store i64 %75, i64* %6, align 8, !tbaa !1261
  ret %struct.Memory* %2
}
