...
declare %struct.Memory* @sub_400530.doOp(%struct.State* dereferenceable(3376), i64, %struct.Memory*) local_unnamed_addr
...
entry:
  ...
  %call2_4004dd = tail call %struct.Memory* @sub_400530.doOp(%struct.State* %0, i64 %59, %struct.Memory* %2)
  ...
  %call2_4004ea = tail call %struct.Memory* @sub_400530.doOp(%struct.State* %0, i64 %71, %struct.Memory* %call2_4004dd)
  ...
  %call2_4004f4 = tail call %struct.Memory* @sub_400530.doOp(%struct.State* %0, i64 %83, %struct.Memory* %call2_4004ea)
  %88 = load i64, i64* %3, align 8
  store i64 add (i64 ptrtoint (i8* @G__0x4005e4 to i64), i64 180), i64* %RDI.i38, align 8
  ...
  %call2_400511 = tail call %struct.Memory* @sub_4003d0.printf_plt(%struct.State* %0, i64 %112, %struct.Memory* %call2_4004f4)
  ...
  ret %struct.Memory* %call2_400511
}
...
block_400468:
  ...
  %4 = add i64 %3, 10
  store i64 %4, i64* %PC, align 8
  store i64 add (i64 ptrtoint (i8* @G__0x4005e4 to i64), i64 180), i64* %RDI, align 8
  ret %struct.Memory* %2
}
