; ModuleID = '/tmp/tmpjilfbw0r-query.ll'
...
entry:
  ...
  %EDI.i46 = bitcast %union.anon* %var_2_43 to i32*
  %var_2_44 = load i64, i64* %RBP.i, align 8
  %var_2_45 = add i64 %var_2_44, -8
  %var_2_46 = load i32, i32* %EDI.i46, align 4
  ...
  %EAX.i40 = bitcast %union.anon* %var_2_39 to i32*
  %var_2_58 = load i64, i64* %var_2_3, align 8
  %var_2_60 = add i64 %var_2_58, 7
  ...
  %var_2_67 = load i32, i32* %EAX.i40, align 4
  %var_2_68 = add i64 %var_2_58, 93
  ...
  %var_2_73 = load i64, i64* %var_2_6, align 8
  %var_2_74 = add i64 %var_2_73, -8
  %var_2_75 = inttoptr i64 %var_2_74 to i64*
  store i64 %var_2_72, i64* %var_2_75, align 8
  store i64 %var_2_74, i64* %var_2_6, align 8
  %var_2_77 = load i64, i64* %RBP.i, align 8
  %var_2_78 = add i64 %var_2_77, -24
  %var_2_79 = load i32, i32* %EAX.i40, align 4
  %var_2_80 = add i64 %var_2_70, 75
  ...
  %var_2_89 = load i64, i64* %RBP.i, align 8
  %var_2_90 = add i64 %var_2_89, -28
  %var_2_91 = load i32, i32* %EAX.i40, align 4
  %var_2_92 = add i64 %var_2_82, 73
  store i64 %var_2_92, i64* %var_2_3, align 8
  %var_2_93 = inttoptr i64 %var_2_90 to i32*
  store i32 %var_2_91, i32* %var_2_93, align 4
  %var_2_96 = load i64, i64* %var_2_3, align 8
  %var_2_113 = add i64 %var_2_96, 16
  %var_2_114 = load i64, i64* %var_2_6, align 8
  %var_2_115 = add i64 %var_2_114, -8
  %var_2_116 = inttoptr i64 %var_2_115 to i64*
...
; Function Attrs: alwaysinline norecurse nounwind
define %struct.Memory* @routine_callq_.doOp(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr #1 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
...
; Function Attrs: alwaysinline norecurse nounwind
define %struct.Memory* @routine_movl__0x4___edi(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned) local_unnamed_addr #1 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %RDI = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 11, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
