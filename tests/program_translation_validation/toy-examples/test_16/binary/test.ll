; ModuleID = '/home/sdasgup3/Github/validating-binary-decompilation/tests/program_translation_validation/toy-examples/bc-seeds/test_16/test_16.bc'
...
entry:
  ...
  %arraydecay = getelementptr inbounds [4 x i8], [4 x i8]* %str, i32 0, i32 0
  %call = call i32 @printit(i8* %arraydecay)
  ret i32 0
}
