...
define %struct.Memory.31* @printdata(%struct.State.0* noalias, i64, %struct.Memory.31* noalias) #1 {
entry:
  br label %block_.L_4004d2

block_.L_4004d2:                                  ; preds = %block_.L_400507, %entry
  br i1 undef, label %block_4004e0, label %block_.L_40051a

block_4004e0:                                     ; preds = %block_.L_4004d2
  br i1 undef, label %block_.L_400507, label %block_4004f3
