; ModuleID = '/tmp/tmpsu2calao-query.ll'
...
entry:
  ...
  %var_2_52 = load i64, i64* %RSI.i, align 8
  ...
  %var_2_89 = add i64 %var_2_60, 16
  store i64 %var_2_89, i64* %var_2_6, align 8
  %var_2_92 = add i64 %var_2_57, 32
  store i64 %var_2_92, i64* %var_2_3, align 8
  %var_2_93 = inttoptr i64 %var_2_89 to i64*
  %var_2_94 = load i64, i64* %var_2_93, align 8
  store i64 %var_2_94, i64* %var_2_3, align 8
  %var_2_95 = add i64 %var_2_60, 24
...
; Function Attrs: alwaysinline norecurse nounwind
define %struct.Memory* @routine_callq_.printdata(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr #1 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
