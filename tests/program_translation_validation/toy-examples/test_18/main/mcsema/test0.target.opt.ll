...
declare %struct.Memory* @sub_4004c0.printdata(%struct.State* noalias dereferenceable(3376), i64, %struct.Memory* noalias readnone returned) local_unnamed_addr
...
entry:
  ...
  %call2_4004a8 = call %struct.Memory* @sub_4004c0.printdata(%struct.State* %0, i64 %58, %struct.Memory* %2)
  %63 = load i64, i64* %RSP.i16, align 8
  %64 = load i64, i64* %PC.i, align 8
  %65 = add i64 %63, 16
  store i64 %65, i64* %RSP.i16, align 8
...
define %struct.Memory* @routine_callq_.printdata(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
