...
block_.L_4004d2:                                  ; preds = %block_.L_400507, %entry
  %25 = phi i64 [ %149, %block_.L_400507 ], [ %.pre, %entry ]
...
block_.L_400507:                                  ; preds = %block_4004f3, %block_4004e0
  %118 = phi i64 [ %.pre2, %block_4004f3 ], [ %26, %block_4004e0 ]
  %119 = phi i64 [ %.pre1, %block_4004f3 ], [ %73, %block_4004e0 ]
  %120 = add i64 %118, -4
  %121 = add i64 %119, 8
  ...
  store i8 %139, i8* %22, align 1
  %140 = lshr i32 %124, 31
  %141 = trunc i32 %140 to i8
  store i8 %141, i8* %23, align 1
  %142 = lshr i32 %123, 31
  %143 = xor i32 %140, %142
...
block_.L_40051a:                                  ; preds = %block_.L_4004d2
  ...
  store i64 %154, i64* %RAX.i37, align 8
  %155 = add i64 %54, 4
...
define %struct.Memory* @routine_jae_.L_40051a(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i8* %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
...
define %struct.Memory* @routine_je_.L_400507(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i8* %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
...
define %struct.Memory* @routine_jmpq_.L_40050c(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
...
define %struct.Memory* @routine_jmpq_.L_4004d2(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
