...
declare %struct.Memory* @sub_4004d0.switches(%struct.State* dereferenceable(3376), i64, %struct.Memory*) local_unnamed_addr
...
block_.L_400494:                                  ; preds = %block_4004a1, %entry
  %66 = phi i64 [ %.pre, %entry ], [ %142, %block_4004a1 ]
  %MEMORY.0 = phi %struct.Memory* [ %2, %entry ], [ %call2_4004a6, %block_4004a1 ]
  ...
  br i1 %.demorgan, label %block_4004a1, label %block_.L_4004bc
...
block_4004a1:                                     ; preds = %block_.L_400494
  ...
  %call2_4004a6 = tail call %struct.Memory* @sub_4004d0.switches(%struct.State* nonnull %0, i64 %100, %struct.Memory* %MEMORY.0)
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_jg_.L_4004bc(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i8* nocapture %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr #2 {
block_400468:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_callq_.switches(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr #2 {
block_400468:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
