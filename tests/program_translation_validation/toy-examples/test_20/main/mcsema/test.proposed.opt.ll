...
block_.L_4004d4:                                  ; preds = %block_4004e1, %entry
  %66 = phi i64 [ %.pre, %entry ], [ %143, %block_4004e1 ]
  %MEMORY.0 = phi %struct.Memory* [ %2, %entry ], [ %call2_4004e6, %block_4004e1 ]
...
block_4004e1:                                     ; preds = %block_.L_4004d4
  ...
  %call2_4004e6 = tail call %struct.Memory* @sub_400510.switches(%struct.State* %0, i64 %100, %struct.Memory* %MEMORY.0)
...
define %struct.Memory* @routine_jg_.L_4004fc(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i8* %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
...
define %struct.Memory* @routine_callq_.switches(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
