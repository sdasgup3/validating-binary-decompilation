...
block_.L_4004b4:                                  ; preds = %block_4004c1, %entry
  %66 = phi i64 [ %.pre, %entry ], [ %143, %block_4004c1 ]
...
block_4004c1:                                     ; preds = %block_.L_4004b4
  ...
  %call2_4004c6 = tail call %struct.Memory* @sub_4004f0.switches(%struct.State* %0, i64 %100, %struct.Memory* %MEMORY.0)
...
define %struct.Memory* @routine_jg_.L_4004dc(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i8* %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
