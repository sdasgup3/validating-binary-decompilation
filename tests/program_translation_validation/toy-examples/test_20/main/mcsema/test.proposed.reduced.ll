; ModuleID = '/tmp/tmpj0jj0d_y-query.ll'
...
block_4004e1:                                     ; preds = %block_.L_4004d4
  %var_2_101 = add i64 %var_2_96, 10
  %var_2_102 = load i64, i64* %var_2_6, align 8
  %var_2_103 = add i64 %var_2_102, -8
  %var_2_104 = inttoptr i64 %var_2_103 to i64*
  store i64 %var_2_101, i64* %var_2_104, align 8
  store i64 %var_2_103, i64* %var_2_6, align 8
  %var_2_105 = load i64, i64* %RBP.i, align 8
  %var_2_106 = add i64 %var_2_105, -24
  %var_2_107 = load i32, i32* %EAX.i16, align 4
  %var_2_109 = add i64 %var_2_96, 50
  store i64 %var_2_109, i64* %var_2_3, align 8
  %var_2_110 = inttoptr i64 %var_2_106 to i32*
  store i32 %var_2_107, i32* %var_2_110, align 4
  %var_2_111 = load i64, i64* %RBP.i, align 8
  %var_2_112 = add i64 %var_2_111, -20
  %var_2_113 = load i64, i64* %var_2_3, align 8
  %var_2_114 = add i64 %var_2_113, 3
...
; Function Attrs: alwaysinline nounwind
define %struct.Memory* @routine_cmpl__0xff__MINUS0x14__rbp_(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %RBP = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 15, i32 0, i32 0
  %3 = load i64, i64* %RBP, align 8
...
; Function Attrs: alwaysinline norecurse nounwind
define %struct.Memory* @routine_jg_.L_4004fc(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i8* nocapture %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr #1 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
...
; Function Attrs: alwaysinline norecurse nounwind
define %struct.Memory* @routine_callq_.switches(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr #1 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
