...
declare %struct.Memory.31* @sub_4004f0.switches(%struct.State.0* noalias dereferenceable(3376), i64, %struct.Memory.31* noalias readnone returned)
...
block_.L_4004b4:                                  ; preds = %block_4004c1, %entry
  br i1 undef, label %block_4004c1, label %block_.L_4004dc
