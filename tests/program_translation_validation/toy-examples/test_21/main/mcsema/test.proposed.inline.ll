...
@G__0x400614 = global %G__0x400614_type zeroinitializer
...
entry:
  ...
  %loadMem1_400524 = load %struct.Memory*, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem1_400524, %struct.Memory** %MEMORY
  %loadMem2_400524 = load %struct.Memory*, %struct.Memory** %MEMORY
  %loadPC_400524 = load i64, i64* %3
  %call2_400524 = call %struct.Memory* @sub_400550.shiftit(%struct.State* %0, i64 %loadPC_400524, %struct.Memory* %loadMem2_400524)
  store %struct.Memory* %call2_400524, %struct.Memory** %MEMORY
  ...
  store i64 add (i64 ptrtoint (%G__0x400614_type* @G__0x400614 to i64), i64 204), i64* %RDI.i, align 8
  ...
  %264 = call %struct.Memory* @__remill_function_call(%struct.State* %0, i64 ptrtoint (i64 (i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64)* @printf to i64), %struct.Memory* %loadMem2_40053c)
  ...
  ret %struct.Memory* %loadMem_40054f
}
...
define %struct.Memory* @routine_movq__0x400614___rdi(%struct.State* dereferenceable(3376), i64, %struct.Memory*) {
block_400478:
  %3 = getelementptr inbounds %struct.State, %struct.State* %0, i32 0, i32 6
  %4 = getelementptr inbounds %struct.GPR, %struct.GPR* %3, i32 0, i32 33
  %5 = getelementptr inbounds %struct.Reg, %struct.Reg* %4, i32 0, i32 0
  ...
  %10 = add i64 %9, 10
  store i64 %10, i64* %PC
  store i64 add (i64 ptrtoint (%G__0x400614_type* @G__0x400614 to i64), i64 204), i64* %RDI, align 8
  ret %struct.Memory* %2
}
