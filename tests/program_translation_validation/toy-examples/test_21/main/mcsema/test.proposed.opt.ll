...
declare %struct.Memory* @sub_400550.shiftit(%struct.State* noalias dereferenceable(3376), i64, %struct.Memory* noalias readnone returned) local_unnamed_addr
...
entry:
  ...
  %call2_400524 = tail call %struct.Memory* @sub_400550.shiftit(%struct.State* %0, i64 %67, %struct.Memory* %2)
  ...
  %88 = tail call %struct.Memory* @__remill_function_call(%struct.State* %0, i64 ptrtoint (i64 (i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64)* @printf to i64), %struct.Memory* %call2_400524)
