...
entry:
  ...
  ; Code: .shiftit:	 RIP: 400520	 Bytes: 0
  ...
  ; Code: movq %rsi, -0x10(%rbp)	 RIP: 400527	 Bytes: 4
  %loadMem_400527 = load %struct.Memory*, %struct.Memory** %MEMORY
  %call_400527 = call %struct.Memory* @routine_movq__rsi__MINUS0x10__rbp_(%struct.State* %0, i64  0, %struct.Memory* %loadMem_400527)
  store %struct.Memory* %call_400527, %struct.Memory** %MEMORY

  ; Code: movq -0x10(%rbp), %rsi	 RIP: 40052b	 Bytes: 4
  %loadMem_40052b = load %struct.Memory*, %struct.Memory** %MEMORY
  %call_40052b = call %struct.Memory* @routine_movq_MINUS0x10__rbp____rsi(%struct.State* %0, i64  0, %struct.Memory* %loadMem_40052b)
  store %struct.Memory* %call_40052b, %struct.Memory** %MEMORY

  ; Code: movq (%rsi), %rsi	 RIP: 40052f	 Bytes: 3
  %loadMem_40052f = load %struct.Memory*, %struct.Memory** %MEMORY
  %call_40052f = call %struct.Memory* @routine_movq___rsi____rsi(%struct.State* %0, i64  0, %struct.Memory* %loadMem_40052f)
  store %struct.Memory* %call_40052f, %struct.Memory** %MEMORY

  ; Code: movq %rsi, -0x18(%rbp)	 RIP: 400532	 Bytes: 4
  %loadMem_400532 = load %struct.Memory*, %struct.Memory** %MEMORY
  %call_400532 = call %struct.Memory* @routine_movq__rsi__MINUS0x18__rbp_(%struct.State* %0, i64  0, %struct.Memory* %loadMem_400532)
  store %struct.Memory* %call_400532, %struct.Memory** %MEMORY

  ; Code: movl -0x4(%rbp), %edi	 RIP: 400536	 Bytes: 3
  %loadMem_400536 = load %struct.Memory*, %struct.Memory** %MEMORY
  %call_400536 = call %struct.Memory* @routine_movl_MINUS0x4__rbp____edi(%struct.State* %0, i64  0, %struct.Memory* %loadMem_400536)
  store %struct.Memory* %call_400536, %struct.Memory** %MEMORY

  ; Code: movq -0x18(%rbp), %rsi	 RIP: 400539	 Bytes: 4
  %loadMem_400539 = load %struct.Memory*, %struct.Memory** %MEMORY
  %call_400539 = call %struct.Memory* @routine_movq_MINUS0x18__rbp____rsi(%struct.State* %0, i64  0, %struct.Memory* %loadMem_400539)
  store %struct.Memory* %call_400539, %struct.Memory** %MEMORY

  ; Code: movl %edi, %edi	 RIP: 40053d	 Bytes: 2
  %loadMem_40053d = load %struct.Memory*, %struct.Memory** %MEMORY
  %call_40053d = call %struct.Memory* @routine_movl__edi___edi(%struct.State* %0, i64  0, %struct.Memory* %loadMem_40053d)
  store %struct.Memory* %call_40053d, %struct.Memory** %MEMORY

  ; Code: movl %edi, %ecx	 RIP: 40053f	 Bytes: 2
  %loadMem_40053f = load %struct.Memory*, %struct.Memory** %MEMORY
  %call_40053f = call %struct.Memory* @routine_movl__edi___ecx(%struct.State* %0, i64  0, %struct.Memory* %loadMem_40053f)
  store %struct.Memory* %call_40053f, %struct.Memory** %MEMORY

  ; Code: shrq %cl, %rsi	 RIP: 400541	 Bytes: 3
  %loadMem_400541 = load %struct.Memory*, %struct.Memory** %MEMORY
  %call_400541 = call %struct.Memory* @routine_shrq__cl___rsi(%struct.State* %0, i64  0, %struct.Memory* %loadMem_400541)
  store %struct.Memory* %call_400541, %struct.Memory** %MEMORY

  ; Code: movq %rsi, -0x18(%rbp)	 RIP: 400544	 Bytes: 4
  %loadMem_400544 = load %struct.Memory*, %struct.Memory** %MEMORY
  %call_400544 = call %struct.Memory* @routine_movq__rsi__MINUS0x18__rbp_(%struct.State* %0, i64  0, %struct.Memory* %loadMem_400544)
  store %struct.Memory* %call_400544, %struct.Memory** %MEMORY

  ; Code: movq -0x18(%rbp), %rsi	 RIP: 400548	 Bytes: 4
  %loadMem_400548 = load %struct.Memory*, %struct.Memory** %MEMORY
  %call_400548 = call %struct.Memory* @routine_movq_MINUS0x18__rbp____rsi(%struct.State* %0, i64  0, %struct.Memory* %loadMem_400548)
  store %struct.Memory* %call_400548, %struct.Memory** %MEMORY

  ; Code: movq -0x10(%rbp), %rax	 RIP: 40054c	 Bytes: 4
  %loadMem_40054c = load %struct.Memory*, %struct.Memory** %MEMORY
  %call_40054c = call %struct.Memory* @routine_movq_MINUS0x10__rbp____rax(%struct.State* %0, i64  0, %struct.Memory* %loadMem_40054c)
  store %struct.Memory* %call_40054c, %struct.Memory** %MEMORY

  ; Code: movq %rsi, (%rax)	 RIP: 400550	 Bytes: 3
  %loadMem_400550 = load %struct.Memory*, %struct.Memory** %MEMORY
  %call_400550 = call %struct.Memory* @routine_movq__rsi____rax_(%struct.State* %0, i64  0, %struct.Memory* %loadMem_400550)
  store %struct.Memory* %call_400550, %struct.Memory** %MEMORY

  ; Code: popq %rbp	 RIP: 400553	 Bytes: 1
  %loadMem_400553 = load %struct.Memory*, %struct.Memory** %MEMORY
  %call_400553 = call %struct.Memory* @routine_popq__rbp(%struct.State* %0, i64  0, %struct.Memory* %loadMem_400553)
  store %struct.Memory* %call_400553, %struct.Memory** %MEMORY

  ; Code: retq	 RIP: 400554	 Bytes: 1
  %loadMem_400554 = load %struct.Memory*, %struct.Memory** %MEMORY
  %call_400554 = call %struct.Memory* @routine_retq(%struct.State* %0, i64  0, %struct.Memory* %loadMem_400554)
  store %struct.Memory* %call_400554, %struct.Memory** %MEMORY

  ret %struct.Memory* %call_400554
}
