...
define %struct.Memory* @shiftit(%struct.State* noalias, i64, %struct.Memory* noalias readnone returned) local_unnamed_addr #1 {
entry:
...
; <label>:55:                                     ; preds = %50, %47
  %56 = phi i64 [ %54, %50 ], [ %44, %47 ]
  %57 = phi i8 [ 0, %50 ], [ %49, %47 ]
  %58 = trunc i64 %56 to i8
  %59 = and i8 %58, 1
  %60 = lshr i64 %56, 1
  store i64 %60, i64* %RSI.i34, align 8
...
routine_shrq__cl___rsi.exit:                      ; preds = %55, %entry
  %75 = phi i64 [ %60, %55 ], [ %44, %entry ]
  %76 = add i64 %36, 18
  ...
  store i64 %82, i64* %RSI.i34, align 8
  ...
  store i64 %86, i64* %RAX.i6, align 8
  %87 = add i64 %79, 11
...
define %struct.Memory* @routine_shrq__cl___rsi(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned) local_unnamed_addr #3 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_movq__rsi____rax_(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %RAX = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 1, i32 0, i32 0
  %RSI = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 9, i32 0, i32 0
