; ModuleID = '/tmp/tmpga0mmi5s-query.ll'
...
define %struct.Memory* @shiftit(%struct.State* noalias nocapture readonly, i64, %struct.Memory* noalias readnone returned) local_unnamed_addr #1 {
entry:
  ...
  %EDI.i37 = bitcast %union.anon* %var_2_11 to i32*
  %var_2_12 = add i64 %var_2_7, -12
  %var_2_13 = load i32, i32* %EDI.i37, align 4
  ...
  %var_2_18 = load i64, i64* %RSI.i34, align 8
  ...
  %var_4_3 = inttoptr i64 %var_2_23 to i64**
  %var_2_271 = load i64*, i64** %var_4_3, align 8
  %var_2_30 = load i64, i64* %var_2_271, align 8
  %var_2_31 = add i64 %var_2_22, -24
  %var_2_33 = inttoptr i64 %var_2_31 to i64*
  store i64 %var_2_30, i64* %var_2_33, align 8
  %var_2_34 = load i64, i64* %RBP.i, align 8
  %var_2_35 = add i64 %var_2_34, -4
  %var_2_38 = inttoptr i64 %var_2_35 to i32*
  %var_2_39 = load i32, i32* %var_2_38, align 4
  %var_2_41 = add i64 %var_2_34, -24
  %var_2_43 = inttoptr i64 %var_2_41 to i64*
  %var_2_44 = load i64, i64* %var_2_43, align 8
  %var_2_46 = trunc i32 %var_2_39 to i6
  switch i6 %var_2_46, label %var_2_50 [
    i6 0, label %routine_shrq__cl___rsi.exit
    i6 1, label %var_2_55
  ]

var_2_50:                                         ; preds = %entry
  %var_2_51 = and i32 %var_2_39, 63
  %var_2_52 = zext i32 %var_2_51 to i64
  %var_2_53 = add nsw i64 %var_2_52, -1
  %var_2_54 = lshr i64 %var_2_44, %var_2_53
  br label %var_2_55

var_2_55:                                         ; preds = %var_2_50, %entry
  %var_2_56 = phi i64 [ %var_2_54, %var_2_50 ], [ %var_2_44, %entry ]
  %var_2_60 = lshr i64 %var_2_56, 1
  br label %routine_shrq__cl___rsi.exit

routine_shrq__cl___rsi.exit:                      ; preds = %var_2_55, %entry
  %var_2_75 = phi i64 [ %var_2_60, %var_2_55 ], [ %var_2_44, %entry ]
  store i64 %var_2_75, i64* %var_2_43, align 8
  %var_2_77 = load i64, i64* %RBP.i, align 8
  %var_2_78 = add i64 %var_2_77, -24
  %var_2_81 = inttoptr i64 %var_2_78 to i64*
  %var_2_82 = load i64, i64* %var_2_81, align 8
  %var_2_83 = add i64 %var_2_77, -16
  %var_4_4 = inttoptr i64 %var_2_83 to i64**
  %var_2_862 = load i64*, i64** %var_4_4, align 8
  store i64 %var_2_82, i64* %var_2_862, align 8
...
; Function Attrs: alwaysinline norecurse nounwind
define %struct.Memory* @routine_movq___rsi____rsi(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned) local_unnamed_addr #1 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %RSI = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 9, i32 0, i32 0
...
; Function Attrs: alwaysinline norecurse nounwind
define %struct.Memory* @routine_movl__edi___edi(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned) local_unnamed_addr #1 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 11, i32 0
  %EDI = bitcast %union.anon* %3 to i32*
...
; Function Attrs: alwaysinline norecurse nounwind
define %struct.Memory* @routine_movl__edi___ecx(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned) local_unnamed_addr #1 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 11, i32 0
  %EDI = bitcast %union.anon* %3 to i32*
...
define %struct.Memory* @routine_shrq__cl___rsi(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
...
; Function Attrs: alwaysinline norecurse nounwind
define %struct.Memory* @routine_movq__rsi____rax_(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned) local_unnamed_addr #1 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %RAX = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 1, i32 0, i32 0
  %RSI = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 9, i32 0, i32 0
