...
declare %struct.Memory* @sub_4005a0.timespi(%struct.State* dereferenceable(3376), i64, %struct.Memory*)
...
entry:
  ...
  ; Code: .DoDemoFpu1:	 RIP: 400500	 Bytes: 0
  ...
  ; Code: fldt 0x10(%rbp)	 RIP: 400508	 Bytes: 3
  %loadMem_400508 = load %struct.Memory*, %struct.Memory** %MEMORY
  %call_400508 = call %struct.Memory* @routine_fldt_0x10__rbp_(%struct.State* %0, i64  0, %struct.Memory* %loadMem_400508)
  store %struct.Memory* %call_400508, %struct.Memory** %MEMORY

  ; Code: fstpt -0x10(%rbp)	 RIP: 40050b	 Bytes: 3
  %loadMem_40050b = load %struct.Memory*, %struct.Memory** %MEMORY
  %call_40050b = call %struct.Memory* @routine_fstpt_MINUS0x10__rbp_(%struct.State* %0, i64  0, %struct.Memory* %loadMem_40050b)
  store %struct.Memory* %call_40050b, %struct.Memory** %MEMORY

  ; Code: fldt -0x10(%rbp)	 RIP: 40050e	 Bytes: 3
  %loadMem_40050e = load %struct.Memory*, %struct.Memory** %MEMORY
  %call_40050e = call %struct.Memory* @routine_fldt_MINUS0x10__rbp_(%struct.State* %0, i64  0, %struct.Memory* %loadMem_40050e)
  store %struct.Memory* %call_40050e, %struct.Memory** %MEMORY

  ; Code: movq %rsp, %rax	 RIP: 400511	 Bytes: 3
  %loadMem_400511 = load %struct.Memory*, %struct.Memory** %MEMORY
  %call_400511 = call %struct.Memory* @routine_movq__rsp___rax(%struct.State* %0, i64  0, %struct.Memory* %loadMem_400511)
  store %struct.Memory* %call_400511, %struct.Memory** %MEMORY

  ; Code: fstpt (%rax)	 RIP: 400514	 Bytes: 2
  %loadMem_400514 = load %struct.Memory*, %struct.Memory** %MEMORY
  %call_400514 = call %struct.Memory* @routine_fstpt___rax_(%struct.State* %0, i64  0, %struct.Memory* %loadMem_400514)
  store %struct.Memory* %call_400514, %struct.Memory** %MEMORY

  ; Code: xorl %ecx, %ecx	 RIP: 400516	 Bytes: 2
  %loadMem_400516 = load %struct.Memory*, %struct.Memory** %MEMORY
  %call_400516 = call %struct.Memory* @routine_xorl__ecx___ecx(%struct.State* %0, i64  0, %struct.Memory* %loadMem_400516)
  store %struct.Memory* %call_400516, %struct.Memory** %MEMORY

  ; Code: movb %cl, %dl	 RIP: 400518	 Bytes: 2
  %loadMem_400518 = load %struct.Memory*, %struct.Memory** %MEMORY
  %call_400518 = call %struct.Memory* @routine_movb__cl___dl(%struct.State* %0, i64  0, %struct.Memory* %loadMem_400518)
  store %struct.Memory* %call_400518, %struct.Memory** %MEMORY

  ; Code: movb %dl, %al	 RIP: 40051a	 Bytes: 2
  %loadMem_40051a = load %struct.Memory*, %struct.Memory** %MEMORY
  %call_40051a = call %struct.Memory* @routine_movb__dl___al(%struct.State* %0, i64  0, %struct.Memory* %loadMem_40051a)
  store %struct.Memory* %call_40051a, %struct.Memory** %MEMORY

  ; Code: callq .timespi	 RIP: 40051c	 Bytes: 5
  %loadMem1_40051c = load %struct.Memory*, %struct.Memory** %MEMORY
  %call1_40051c = call %struct.Memory* @routine_callq_.timespi(%struct.State* %0, i64  0, %struct.Memory* %loadMem1_40051c, i64 132, i64 5, i64 5)
  store %struct.Memory* %call1_40051c, %struct.Memory** %MEMORY

  %loadMem2_40051c = load %struct.Memory*, %struct.Memory** %MEMORY
  %loadPC_40051c = load i64, i64* %3
  %call2_40051c = call %struct.Memory* @sub_4005a0.timespi(%struct.State* %0, i64  %loadPC_40051c, %struct.Memory* %loadMem2_40051c)
  store %struct.Memory* %call2_40051c, %struct.Memory** %MEMORY

  ; Code: movl %eax, -0x14(%rbp)	 RIP: 400521	 Bytes: 3
  %loadMem_400521 = load %struct.Memory*, %struct.Memory** %MEMORY
  %call_400521 = call %struct.Memory* @routine_movl__eax__MINUS0x14__rbp_(%struct.State* %0, i64  0, %struct.Memory* %loadMem_400521)
  store %struct.Memory* %call_400521, %struct.Memory** %MEMORY

  ; Code: fildl -0x14(%rbp)	 RIP: 400524	 Bytes: 3
  %loadMem_400524 = load %struct.Memory*, %struct.Memory** %MEMORY
  %call_400524 = call %struct.Memory* @routine_fildl_MINUS0x14__rbp_(%struct.State* %0, i64  0, %struct.Memory* %loadMem_400524)
  store %struct.Memory* %call_400524, %struct.Memory** %MEMORY

  ; Code: addq $0x30, %rsp	 RIP: 400527	 Bytes: 4
  %loadMem_400527 = load %struct.Memory*, %struct.Memory** %MEMORY
  %call_400527 = call %struct.Memory* @routine_addq__0x30___rsp(%struct.State* %0, i64  0, %struct.Memory* %loadMem_400527)
  store %struct.Memory* %call_400527, %struct.Memory** %MEMORY

  ; Code: popq %rbp	 RIP: 40052b	 Bytes: 1
  %loadMem_40052b = load %struct.Memory*, %struct.Memory** %MEMORY
  %call_40052b = call %struct.Memory* @routine_popq__rbp(%struct.State* %0, i64  0, %struct.Memory* %loadMem_40052b)
  store %struct.Memory* %call_40052b, %struct.Memory** %MEMORY

  ; Code: retq	 RIP: 40052c	 Bytes: 1
  %loadMem_40052c = load %struct.Memory*, %struct.Memory** %MEMORY
  %call_40052c = call %struct.Memory* @routine_retq(%struct.State* %0, i64  0, %struct.Memory* %loadMem_40052c)
  store %struct.Memory* %call_40052c, %struct.Memory** %MEMORY

  ret %struct.Memory* %call_40052c
}
...
define %struct.Memory* @routine_fldt_MINUS0x10__rbp_(%struct.State*  dereferenceable(3376), i64, %struct.Memory* ) #19 {
block_400488:
  %3 = getelementptr inbounds %struct.State, %struct.State* %0, i32 0, i32 6
  %4 = getelementptr inbounds %struct.GPR, %struct.GPR* %3, i32 0, i32 33
  %5 = getelementptr inbounds %struct.Reg, %struct.Reg* %4, i32 0, i32 0
