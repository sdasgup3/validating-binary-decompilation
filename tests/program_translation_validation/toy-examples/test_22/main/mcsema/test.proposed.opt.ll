...
routine_fldt_MINUS0x20__rbp_.exit58:              ; preds = %144, %141, %routine_flds_0xee__rip_.exit
  ...
  %call2_400555 = tail call %struct.Memory* @sub_4004f0.DoDemoFpu1(%struct.State* %0, i64 %175, %struct.Memory* %167)
  ...
  %185 = tail call fastcc %struct.Memory* @_ZN12_GLOBAL__N_1L7FSTPmemI3MnWI9float80_tEEEP6MemoryS5_R5StateT_2RnIdE2InImESB_ItE(%struct.Memory* %call2_400555, %struct.State* %0, i64 %181, double %182, i64 %183, i64 893)
