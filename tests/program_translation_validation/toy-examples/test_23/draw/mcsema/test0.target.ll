...
define %struct.Memory.31* @draw(%struct.State.0* noalias, i64, %struct.Memory.31* noalias) #1 {
entry:
  br label %block_.L_4005af

block_.L_4005af:                                  ; preds = %block_.L_400609, %entry
  br i1 undef, label %block_4005b9, label %block_.L_40062b

block_4005b9:                                     ; preds = %block_.L_4005af
  br label %block_.L_4005c0

block_.L_4005c0:                                  ; preds = %block_4005ca, %block_4005b9
  br i1 undef, label %block_4005ca, label %block_.L_400609
