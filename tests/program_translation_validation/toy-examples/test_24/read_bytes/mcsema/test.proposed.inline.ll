...
block_.L_400619:                                  ; preds = %block_400625, %entry
  ...
  br i1 %cmpBr_40061f, label %block_.L_400653, label %block_400625
...
block_400625:                                     ; preds = %block_.L_400619
  ...
  %loadMem1_40063a = load %struct.Memory*, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem1_40063a, %struct.Memory** %MEMORY
  %loadMem2_40063a = load %struct.Memory*, %struct.Memory** %MEMORY
  %loadPC_40063a = load i64, i64* %3
  %call2_40063a = call %struct.Memory* @sub_400590.to_byte(%struct.State* %0, i64 %loadPC_40063a, %struct.Memory* %loadMem2_40063a)
  store %struct.Memory* %call2_40063a, %struct.Memory** %MEMORY
...
define %struct.Memory* @routine_jge_.L_400653(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i8* %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) {
block_400468:
  %3 = getelementptr inbounds %struct.State, %struct.State* %0, i32 0, i32 6
  %4 = getelementptr inbounds %struct.GPR, %struct.GPR* %3, i32 0, i32 33
  %5 = getelementptr inbounds %struct.Reg, %struct.Reg* %4, i32 0, i32 0
