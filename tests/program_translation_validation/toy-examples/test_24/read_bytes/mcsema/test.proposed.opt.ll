...
block_.L_400649:                                  ; preds = %block_400655, %entry
  %62 = phi i64 [ %.pre, %entry ], [ %193, %block_400655 ]
  %MEMORY.0 = phi %struct.Memory* [ %2, %entry ], [ %call2_40066a, %block_400655 ]
...
block_400655:                                     ; preds = %block_.L_400649
  ...
  %call2_40066a = tail call %struct.Memory* @sub_4005c0.to_byte(%struct.State* %0, i64 %137, %struct.Memory* %MEMORY.0)
