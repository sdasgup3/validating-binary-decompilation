...
define %struct.Memory.31* @read_bytes(%struct.State.0* noalias, i64, %struct.Memory.31* noalias) local_unnamed_addr #1 {
entry:
  br label %block_.L_400649

block_.L_400649:                                  ; preds = %block_400655, %entry
  br i1 undef, label %block_400655, label %block_.L_400683
