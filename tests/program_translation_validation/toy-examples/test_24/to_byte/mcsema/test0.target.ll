...
define %struct.Memory.31* @to_byte(%struct.State.0* noalias, i64, %struct.Memory.31* noalias) #1 {
entry:
  br i1 undef, label %block_.L_4005e6, label %block_4005d7

block_4005d7:                                     ; preds = %entry
  br label %block_.L_400625

block_.L_4005e6:                                  ; preds = %entry
  br i1 undef, label %block_.L_400602, label %block_4005f3

block_4005f3:                                     ; preds = %block_.L_4005e6
  br label %block_.L_400625

block_.L_400602:                                  ; preds = %block_.L_4005e6
  br i1 undef, label %block_.L_40061e, label %block_40060f
