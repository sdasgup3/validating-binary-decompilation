; ModuleID = '/tmp/tmpesvh_8s9-query.ll'
...
define %struct.Memory* @func(%struct.State* noalias, i64, %struct.Memory* noalias returned) local_unnamed_addr #1 {
entry:
  ...
  %RAX.i26 = getelementptr inbounds %union.anon, %union.anon* %var_2_55, i64 0, i32 0
  %EAX.i23 = bitcast %union.anon* %var_2_55 to i32*
  %.pre = load i64, i64* %var_2_3, align 8
  br label %block_.L_400539

block_.L_400539:                                  ; preds = %block_400545, %entry
  %var_2_56 = phi i64 [ %.pre, %entry ], [ %var_2_137, %block_400545 ]
  %MEMORY.0 = phi %struct.Memory* [ %2, %entry ], [ %var_2_99, %block_400545 ]
  %var_2_57 = load i64, i64* %RBP.i, align 8
  %var_2_58 = add i64 %var_2_57, -8
  %var_2_59 = add i64 %var_2_56, 3
  store i64 %var_2_59, i64* %var_2_3, align 8
  %var_2_60 = inttoptr i64 %var_2_58 to i32*
  %var_2_61 = load i32, i32* %var_2_60, align 4
  %var_2_62 = zext i32 %var_2_61 to i64
  store i64 %var_2_62, i64* %RAX.i26, align 8
  %var_2_63 = add i64 %var_2_57, -4
  %var_2_64 = add i64 %var_2_56, 6
  store i64 %var_2_64, i64* %var_2_3, align 8
  %var_2_65 = inttoptr i64 %var_2_63 to i32*
  %var_2_66 = load i32, i32* %var_2_65, align 4
  %var_2_67 = sub i32 %var_2_61, %var_2_66
  %var_2_82 = lshr i32 %var_2_67, 31
  %var_2_84 = lshr i32 %var_2_61, 31
  %var_2_85 = lshr i32 %var_2_66, 31
  %var_2_86 = xor i32 %var_2_85, %var_2_84
  %var_2_87 = xor i32 %var_2_82, %var_2_84
  %var_2_88 = add nuw nsw i32 %var_2_87, %var_2_86
  %var_2_89 = icmp eq i32 %var_2_88, 2
  %var_2_91 = icmp ne i32 %var_2_82, 0
  %var_2_92 = xor i1 %var_2_91, %var_2_89
  %.v = select i1 %var_2_92, i64 12, i64 46
  %var_2_93 = add i64 %.v, %var_2_56
  store i64 %var_2_93, i64* %var_2_3, align 8
  br i1 %var_2_92, label %block_400545, label %block_.L_400567

block_400545:                                     ; preds = %block_.L_400539
  %var_2_94 = add i64 %var_2_93, -293
  %var_2_95 = add i64 %var_2_93, 17
  ...
  %var_2_99 = tail call %struct.Memory* @__remill_function_call(%struct.State* nonnull %0, i64 ptrtoint (i64 (i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64)* @printf to i64), %struct.Memory* %MEMORY.0)
  %var_2_100 = load i64, i64* %RBP.i, align 8
  %var_2_101 = add i64 %var_2_100, -12
  %var_2_102 = load i32, i32* %EAX.i23, align 4
  %var_2_103 = load i64, i64* %var_2_3, align 8
  %var_2_104 = add i64 %var_2_103, 3
  store i64 %var_2_104, i64* %var_2_3, align 8
  %var_2_105 = inttoptr i64 %var_2_101 to i32*
  store i32 %var_2_102, i32* %var_2_105, align 4
  ...
  store i64 %var_2_113, i64* %RAX.i26, align 8
...
; Function Attrs: alwaysinline norecurse nounwind
define %struct.Memory* @routine_jge_.L_400567(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i8* nocapture %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
