...
entry:
  ...
  ; Code: movl $0x2, %edi	 RIP: 400518	 Bytes: 5
  %loadMem_400518 = load %struct.Memory*, %struct.Memory** %MEMORY
  %call_400518 = call %struct.Memory* @routine_movl__0x2___edi(%struct.State* %0, i64  0, %struct.Memory* %loadMem_400518)
  store %struct.Memory* %call_400518, %struct.Memory** %MEMORY

  ; Code: movl $0x0, -0x4(%rbp)	 RIP: 40051d	 Bytes: 7
  %loadMem_40051d = load %struct.Memory*, %struct.Memory** %MEMORY
  %call_40051d = call %struct.Memory* @routine_movl__0x0__MINUS0x4__rbp_(%struct.State* %0, i64  0, %struct.Memory* %loadMem_40051d)
  store %struct.Memory* %call_40051d, %struct.Memory** %MEMORY

  ; Code: callq .func	 RIP: 400524	 Bytes: 5
  %loadMem1_400524 = load %struct.Memory*, %struct.Memory** %MEMORY
  %call1_400524 = call %struct.Memory* @routine_callq_.func(%struct.State* %0, i64  0, %struct.Memory* %loadMem1_400524, i64 -100, i64 5, i64 5)
  store %struct.Memory* %call1_400524, %struct.Memory** %MEMORY

  %loadMem2_400524 = load %struct.Memory*, %struct.Memory** %MEMORY
  %loadPC_400524 = load i64, i64* %3
  %call2_400524 = call %struct.Memory* @sub_4004c0.func(%struct.State* %0, i64  %loadPC_400524, %struct.Memory* %loadMem2_400524)
  store %struct.Memory* %call2_400524, %struct.Memory** %MEMORY

  ; Code: xorl %eax, %eax	 RIP: 400529	 Bytes: 2
  %loadMem_400529 = load %struct.Memory*, %struct.Memory** %MEMORY
  %call_400529 = call %struct.Memory* @routine_xorl__eax___eax(%struct.State* %0, i64  0, %struct.Memory* %loadMem_400529)
  store %struct.Memory* %call_400529, %struct.Memory** %MEMORY

  ; Code: addq $0x10, %rsp	 RIP: 40052b	 Bytes: 4
  %loadMem_40052b = load %struct.Memory*, %struct.Memory** %MEMORY
  %call_40052b = call %struct.Memory* @routine_addq__0x10___rsp(%struct.State* %0, i64  0, %struct.Memory* %loadMem_40052b)
  store %struct.Memory* %call_40052b, %struct.Memory** %MEMORY

  ; Code: popq %rbp	 RIP: 40052f	 Bytes: 1
  %loadMem_40052f = load %struct.Memory*, %struct.Memory** %MEMORY
  %call_40052f = call %struct.Memory* @routine_popq__rbp(%struct.State* %0, i64  0, %struct.Memory* %loadMem_40052f)
  store %struct.Memory* %call_40052f, %struct.Memory** %MEMORY

  ; Code: retq	 RIP: 400530	 Bytes: 1
  %loadMem_400530 = load %struct.Memory*, %struct.Memory** %MEMORY
  %call_400530 = call %struct.Memory* @routine_retq(%struct.State* %0, i64  0, %struct.Memory* %loadMem_400530)
  store %struct.Memory* %call_400530, %struct.Memory** %MEMORY

  ret %struct.Memory* %call_400530
}
