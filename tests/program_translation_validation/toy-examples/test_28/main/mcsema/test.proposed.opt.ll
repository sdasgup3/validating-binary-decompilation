...
declare %struct.Memory* @sub_4004c0.func(%struct.State* dereferenceable(3376), i64, %struct.Memory*) local_unnamed_addr
...
entry:
  ...
  %call2_400524 = tail call %struct.Memory* @sub_4004c0.func(%struct.State* %0, i64 %44, %struct.Memory* %2)
  ...
  ret %struct.Memory* %call2_400524
}
