...
entry:
  ...
  store i64 4195748, i64* %RAX.i13, align 8
  ...
  store %struct.Memory* %loadMem1_4004da, %struct.Memory** %MEMORY
...
define %struct.Memory* @routine_movq__0x4005a4___rax(%struct.State* dereferenceable(3376), i64, %struct.Memory*) {
block_400468:
  %3 = getelementptr inbounds %struct.State, %struct.State* %0, i32 0, i32 6
  %4 = getelementptr inbounds %struct.GPR, %struct.GPR* %3, i32 0, i32 33
  %5 = getelementptr inbounds %struct.Reg, %struct.Reg* %4, i32 0, i32 0
  ...
  %10 = add i64 %9, 10
  store i64 %10, i64* %PC
  store i64 4195748, i64* %RAX, align 8
  ret %struct.Memory* %2
}
