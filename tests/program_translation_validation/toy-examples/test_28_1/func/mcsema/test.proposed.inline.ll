...
entry:
  ...
  store %struct.Memory* %loadMem1_40050a, %struct.Memory** %MEMORY
  %loadMem2_40050a = load %struct.Memory*, %struct.Memory** %MEMORY
  %loadPC_40050a = load i64, i64* %3
  %126 = call %struct.Memory* @__remill_function_call(%struct.State* %0, i64 ptrtoint (i64 (i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64)* @printf to i64), %struct.Memory* %loadMem2_40050a)
...
define %struct.Memory* @routine_movq__0x4005d4___rax(%struct.State* dereferenceable(3376), i64, %struct.Memory*) {
block_400478:
  %3 = getelementptr inbounds %struct.State, %struct.State* %0, i32 0, i32 6
  %4 = getelementptr inbounds %struct.GPR, %struct.GPR* %3, i32 0, i32 33
  %5 = getelementptr inbounds %struct.Reg, %struct.Reg* %4, i32 0, i32 0
