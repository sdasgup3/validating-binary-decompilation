...
@G__0x400604= global %G__0x400604_type <{ [8 x i8] c"\00\00\00\00\00\00\00\00" }>
...
entry:
  ...
  ; Code: subq $0x10, %rsp	 RIP: 400524	 Bytes: 4
  %loadMem_400524 = load %struct.Memory*, %struct.Memory** %MEMORY
  %call_400524 = call %struct.Memory* @routine_subq__0x10___rsp(%struct.State* %0, i64  0, %struct.Memory* %loadMem_400524)
  store %struct.Memory* %call_400524, %struct.Memory** %MEMORY

  ; Code: movq $0x400604, %rax	 RIP: 400528	 Bytes: 10
  %loadMem_400528 = load %struct.Memory*, %struct.Memory** %MEMORY
  %call_400528 = call %struct.Memory* @routine_movq__0x400604___rax(%struct.State* %0, i64  0, %struct.Memory* %loadMem_400528)
  store %struct.Memory* %call_400528, %struct.Memory** %MEMORY

  ; Code: movl %edi, -0x4(%rbp)	 RIP: 400532	 Bytes: 3
  %loadMem_400532 = load %struct.Memory*, %struct.Memory** %MEMORY
  %call_400532 = call %struct.Memory* @routine_movl__edi__MINUS0x4__rbp_(%struct.State* %0, i64  0, %struct.Memory* %loadMem_400532)
  store %struct.Memory* %call_400532, %struct.Memory** %MEMORY

  ; Code: movq %rax, %rdi	 RIP: 400535	 Bytes: 3
  %loadMem_400535 = load %struct.Memory*, %struct.Memory** %MEMORY
  %call_400535 = call %struct.Memory* @routine_movq__rax___rdi(%struct.State* %0, i64  0, %struct.Memory* %loadMem_400535)
  store %struct.Memory* %call_400535, %struct.Memory** %MEMORY

  ; Code: movb $0x0, %al	 RIP: 400538	 Bytes: 2
  %loadMem_400538 = load %struct.Memory*, %struct.Memory** %MEMORY
  %call_400538 = call %struct.Memory* @routine_movb__0x0___al(%struct.State* %0, i64  0, %struct.Memory* %loadMem_400538)
  store %struct.Memory* %call_400538, %struct.Memory** %MEMORY

  ; Code: callq .printf_plt	 RIP: 40053a	 Bytes: 5
  %loadMem1_40053a = load %struct.Memory*, %struct.Memory** %MEMORY
  %call1_40053a = call %struct.Memory* @routine_callq_.printf_plt(%struct.State* %0, i64  0, %struct.Memory* %loadMem1_40053a, i64 -282, i64 5, i64 5)
  store %struct.Memory* %call1_40053a, %struct.Memory** %MEMORY

  %loadMem2_40053a = load %struct.Memory*, %struct.Memory** %MEMORY
  %loadPC_40053a = load i64, i64* %3
  %call2_40053a = call %struct.Memory* @ext_printf(%struct.State* %0, i64  %loadPC_40053a, %struct.Memory* %loadMem2_40053a)
  store %struct.Memory* %call2_40053a, %struct.Memory** %MEMORY

  ; Code: movl %eax, -0x8(%rbp)	 RIP: 40053f	 Bytes: 3
  %loadMem_40053f = load %struct.Memory*, %struct.Memory** %MEMORY
  %call_40053f = call %struct.Memory* @routine_movl__eax__MINUS0x8__rbp_(%struct.State* %0, i64  0, %struct.Memory* %loadMem_40053f)
  store %struct.Memory* %call_40053f, %struct.Memory** %MEMORY

  ; Code: addq $0x10, %rsp	 RIP: 400542	 Bytes: 4
  %loadMem_400542 = load %struct.Memory*, %struct.Memory** %MEMORY
  %call_400542 = call %struct.Memory* @routine_addq__0x10___rsp(%struct.State* %0, i64  0, %struct.Memory* %loadMem_400542)
  store %struct.Memory* %call_400542, %struct.Memory** %MEMORY

  ; Code: popq %rbp	 RIP: 400546	 Bytes: 1
  %loadMem_400546 = load %struct.Memory*, %struct.Memory** %MEMORY
  %call_400546 = call %struct.Memory* @routine_popq__rbp(%struct.State* %0, i64  0, %struct.Memory* %loadMem_400546)
  store %struct.Memory* %call_400546, %struct.Memory** %MEMORY

  ; Code: retq	 RIP: 400547	 Bytes: 1
  %loadMem_400547 = load %struct.Memory*, %struct.Memory** %MEMORY
  %call_400547 = call %struct.Memory* @routine_retq(%struct.State* %0, i64  0, %struct.Memory* %loadMem_400547)
  store %struct.Memory* %call_400547, %struct.Memory** %MEMORY

  ret %struct.Memory* %call_400547
}
...
define %struct.Memory* @routine_movq__0x400604___rax(%struct.State*  dereferenceable(3376), i64, %struct.Memory* ) #19 alwaysinline {
block_400488:
  %3 = getelementptr inbounds %struct.State, %struct.State* %0, i32 0, i32 6
  %4 = getelementptr inbounds %struct.GPR, %struct.GPR* %3, i32 0, i32 33
  %5 = getelementptr inbounds %struct.Reg, %struct.Reg* %4, i32 0, i32 0
  ...
  %10 = add i64 %9, 10
  store i64 %10, i64* %PC
  %11 = call %struct.Memory* @_ZN12_GLOBAL__N_1L3MOVI3RnWImE2InImEEEP6MemoryS6_R5StateT_T0_(%struct.Memory* %2, %struct.State* %0, i64* %RAX, i64 add (i64 ptrtoint( %G__0x400604_type* @G__0x400604 to i64), i64 172))
