...
entry:
  ...
  %46 = load i64, i64* %RAX.i13, align 8
  ...
  %call2_40051a = tail call %struct.Memory* @sub_400400.printf_plt(%struct.State* %0, i64 %48, %struct.Memory* %2)
  ...
  ret %struct.Memory* %call2_40051a
}
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_movq__0x4005e4___rax(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
