; ModuleID = '/tmp/tmpdssmaso7-query.ll'
...
define %struct.Memory* @func(%struct.State* noalias nocapture, i64, %struct.Memory* noalias readnone returned) local_unnamed_addr #1 {
entry:
  ...
  %EDI.i = bitcast %union.anon* %var_2_41 to i32*
  %var_2_42 = add i64 %var_2_7, -12
  %var_2_43 = load i32, i32* %EDI.i, align 4
  %var_2_44 = add i64 %var_2_10, 20
  ...
  %var_2_49 = add i64 %var_2_47, 10
  %var_2_50 = load i64, i64* %var_2_6, align 8
  ...
  %EAX.i = bitcast %union.anon* %var_2_40 to i32*
  %var_2_54 = load i64, i64* %RBP.i, align 8
  %var_2_55 = add i64 %var_2_54, -8
  %var_2_56 = load i32, i32* %EAX.i, align 4
  %var_2_58 = add i64 %var_2_47, -274
  ...
  %var_2_89 = add i64 %var_2_61, 6
  store i64 %var_2_89, i64* %var_2_3, align 8
  %var_2_92 = add i64 %var_2_60, 32
...
; Function Attrs: alwaysinline norecurse nounwind
define %struct.Memory* @routine_movq__0x400604___rax(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned) local_unnamed_addr #1 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  ...
  store i64 add (i64 ptrtoint (%G__0x400604_type* @G__0x400604 to i64), i64 172), i64* %RAX, align 8
  ret %struct.Memory* %2
}
