...
define %struct.Memory* @routine_movq__0x4005d4___rax(%struct.State* dereferenceable(3376), i64, %struct.Memory*) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  ...
  store i64 add (i64 ptrtoint (%G__0x4005d4_type* @G__0x4005d4 to i64), i64 140), i64* %RAX, align 8
  ret %struct.Memory* %2
}
