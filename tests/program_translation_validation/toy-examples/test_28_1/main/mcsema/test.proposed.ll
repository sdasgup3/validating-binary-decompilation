...
entry:
  ...
  ; Code: movl $0x2, %edi	 RIP: 4004f8	 Bytes: 5
  %loadMem_4004f8 = load %struct.Memory*, %struct.Memory** %MEMORY
  %call_4004f8 = call %struct.Memory* @routine_movl__0x2___edi(%struct.State* %0, i64  0, %struct.Memory* %loadMem_4004f8)
  store %struct.Memory* %call_4004f8, %struct.Memory** %MEMORY

  ; Code: movl $0x0, -0x4(%rbp)	 RIP: 4004fd	 Bytes: 7
  %loadMem_4004fd = load %struct.Memory*, %struct.Memory** %MEMORY
  %call_4004fd = call %struct.Memory* @routine_movl__0x0__MINUS0x4__rbp_(%struct.State* %0, i64  0, %struct.Memory* %loadMem_4004fd)
  store %struct.Memory* %call_4004fd, %struct.Memory** %MEMORY

  ; Code: callq .func	 RIP: 400504	 Bytes: 5
  %loadMem1_400504 = load %struct.Memory*, %struct.Memory** %MEMORY
  %call1_400504 = call %struct.Memory* @routine_callq_.func(%struct.State* %0, i64  0, %struct.Memory* %loadMem1_400504, i64 -68, i64 5, i64 5)
  store %struct.Memory* %call1_400504, %struct.Memory** %MEMORY
  ...
  ; Code: xorl %eax, %eax	 RIP: 400509	 Bytes: 2
  %loadMem_400509 = load %struct.Memory*, %struct.Memory** %MEMORY
  %call_400509 = call %struct.Memory* @routine_xorl__eax___eax(%struct.State* %0, i64  0, %struct.Memory* %loadMem_400509)
  store %struct.Memory* %call_400509, %struct.Memory** %MEMORY

  ; Code: addq $0x10, %rsp	 RIP: 40050b	 Bytes: 4
  %loadMem_40050b = load %struct.Memory*, %struct.Memory** %MEMORY
  %call_40050b = call %struct.Memory* @routine_addq__0x10___rsp(%struct.State* %0, i64  0, %struct.Memory* %loadMem_40050b)
  store %struct.Memory* %call_40050b, %struct.Memory** %MEMORY

  ; Code: popq %rbp	 RIP: 40050f	 Bytes: 1
  %loadMem_40050f = load %struct.Memory*, %struct.Memory** %MEMORY
  %call_40050f = call %struct.Memory* @routine_popq__rbp(%struct.State* %0, i64  0, %struct.Memory* %loadMem_40050f)
  store %struct.Memory* %call_40050f, %struct.Memory** %MEMORY

  ; Code: retq	 RIP: 400510	 Bytes: 1
  %loadMem_400510 = load %struct.Memory*, %struct.Memory** %MEMORY
  %call_400510 = call %struct.Memory* @routine_retq(%struct.State* %0, i64  0, %struct.Memory* %loadMem_400510)
  store %struct.Memory* %call_400510, %struct.Memory** %MEMORY

  ret %struct.Memory* %call_400510
}
