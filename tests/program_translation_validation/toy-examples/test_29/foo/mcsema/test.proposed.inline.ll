...
block_.L_400506:                                  ; preds = %block_400512, %entry
  ...
  %loadBr_40050c = load i8, i8* %BRANCH_TAKEN
  %cmpBr_40050c = icmp eq i8 %loadBr_40050c, 1
  br i1 %cmpBr_40050c, label %block_.L_40053d, label %block_400512
...
block_.L_40053d:                                  ; preds = %block_.L_400506
  ...
  store %struct.Memory* %loadMem1_400569, %struct.Memory** %MEMORY
  %loadMem2_400569 = load %struct.Memory*, %struct.Memory** %MEMORY
  %loadPC_400569 = load i64, i64* %3
  %631 = call %struct.Memory* @__remill_function_call(%struct.State* %0, i64 ptrtoint (i64 (i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64)* @printf to i64), %struct.Memory* %loadMem2_400569)
  ...
  ret %struct.Memory* %loadMem_400576
}
...
define %struct.Memory* @routine_jbe_.L_40053d(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i8* %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) {
block_400478:
  %3 = getelementptr inbounds %struct.State, %struct.State* %0, i32 0, i32 6
  %4 = getelementptr inbounds %struct.GPR, %struct.GPR* %3, i32 0, i32 33
  %5 = getelementptr inbounds %struct.Reg, %struct.Reg* %4, i32 0, i32 0
...
define %struct.Memory* @routine_jmpq_.L_400506(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i64 %rel_off1, i64 %rel_off2) {
block_400478:
  %3 = getelementptr inbounds %struct.State, %struct.State* %0, i32 0, i32 6
  %4 = getelementptr inbounds %struct.GPR, %struct.GPR* %3, i32 0, i32 33
  %5 = getelementptr inbounds %struct.Reg, %struct.Reg* %4, i32 0, i32 0
