...
block_.L_400506:                                  ; preds = %block_400512, %entry
  %56 = phi i64 [ %168, %block_400512 ], [ %.pre, %entry ]
...
block_.L_40053d:                                  ; preds = %block_.L_400506
  ...
  store i64 %186, i64* %RCX.i67, align 8
  %187 = add i64 %92, 30
  ...
  %208 = tail call %struct.Memory* @__remill_function_call(%struct.State* %0, i64 ptrtoint (i64 (i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64)* @printf to i64), %struct.Memory* %2)
