...
entry:
  ...
  ; Code: movl $0x0, -0x24(%rbp)	 RIP: 40059f	 Bytes: 7
  %loadMem_40059f = load %struct.Memory*, %struct.Memory** %MEMORY
  %call_40059f = call %struct.Memory* @routine_movl__0x0__MINUS0x24__rbp_(%struct.State* %0, i64  0, %struct.Memory* %loadMem_40059f)
...
block_.L_4005a6:
  ...
  ; Code: cmpl $0x5, -0x24(%rbp)	 RIP: 4005a6	 Bytes: 4
  %loadMem_4005a6 = load %struct.Memory*, %struct.Memory** %MEMORY
  %call_4005a6 = call %struct.Memory* @routine_cmpl__0x5__MINUS0x24__rbp_(%struct.State* %0, i64  0, %struct.Memory* %loadMem_4005a6)
  store %struct.Memory* %call_4005a6, %struct.Memory** %MEMORY

  ; Code: jge .L_4005e6	 RIP: 4005aa	 Bytes: 6
  %loadMem_4005aa = load %struct.Memory*, %struct.Memory** %MEMORY
  %call_4005aa = call %struct.Memory* @routine_jge_.L_4005e6(%struct.State* %0, i64  0, %struct.Memory* %loadMem_4005aa, i8* %BRANCH_TAKEN, i64 60, i64 6, i64 6)
  ...
  br i1 %cmpBr_4005aa, label %block_.L_4005e6, label %block_4005b0

block_4005b0:
  ; Code: leaq -0x20(%rbp), %rsi	 RIP: 4005b0	 Bytes: 4
  %loadMem_4005b0 = load %struct.Memory*, %struct.Memory** %MEMORY
  %call_4005b0 = call %struct.Memory* @routine_leaq_MINUS0x20__rbp____rsi(%struct.State* %0, i64  0, %struct.Memory* %loadMem_4005b0)
  store %struct.Memory* %call_4005b0, %struct.Memory** %MEMORY

  ; Code: movl $0x5, -0x20(%rbp)	 RIP: 4005b4	 Bytes: 7
  %loadMem_4005b4 = load %struct.Memory*, %struct.Memory** %MEMORY
  %call_4005b4 = call %struct.Memory* @routine_movl__0x5__MINUS0x20__rbp_(%struct.State* %0, i64  0, %struct.Memory* %loadMem_4005b4)
  store %struct.Memory* %call_4005b4, %struct.Memory** %MEMORY

  ; Code: movl $0x6, -0x1c(%rbp)	 RIP: 4005bb	 Bytes: 7
  %loadMem_4005bb = load %struct.Memory*, %struct.Memory** %MEMORY
  %call_4005bb = call %struct.Memory* @routine_movl__0x6__MINUS0x1c__rbp_(%struct.State* %0, i64  0, %struct.Memory* %loadMem_4005bb)
  store %struct.Memory* %call_4005bb, %struct.Memory** %MEMORY

  ; Code: movl $0x7, -0x18(%rbp)	 RIP: 4005c2	 Bytes: 7
  %loadMem_4005c2 = load %struct.Memory*, %struct.Memory** %MEMORY
  %call_4005c2 = call %struct.Memory* @routine_movl__0x7__MINUS0x18__rbp_(%struct.State* %0, i64  0, %struct.Memory* %loadMem_4005c2)
  store %struct.Memory* %call_4005c2, %struct.Memory** %MEMORY

  ; Code: movl $0x8, -0x14(%rbp)	 RIP: 4005c9	 Bytes: 7
  %loadMem_4005c9 = load %struct.Memory*, %struct.Memory** %MEMORY
  %call_4005c9 = call %struct.Memory* @routine_movl__0x8__MINUS0x14__rbp_(%struct.State* %0, i64  0, %struct.Memory* %loadMem_4005c9)
  store %struct.Memory* %call_4005c9, %struct.Memory** %MEMORY

  ; Code: movl -0x24(%rbp), %edi	 RIP: 4005d0	 Bytes: 3
  %loadMem_4005d0 = load %struct.Memory*, %struct.Memory** %MEMORY
  %call_4005d0 = call %struct.Memory* @routine_movl_MINUS0x24__rbp____edi(%struct.State* %0, i64  0, %struct.Memory* %loadMem_4005d0)
  store %struct.Memory* %call_4005d0, %struct.Memory** %MEMORY

  ; Code: callq .foo	 RIP: 4005d3	 Bytes: 5
  %loadMem1_4005d3 = load %struct.Memory*, %struct.Memory** %MEMORY
  %call1_4005d3 = call %struct.Memory* @routine_callq_.foo(%struct.State* %0, i64  0, %struct.Memory* %loadMem1_4005d3, i64 -211, i64 5, i64 5)
  ...
  %call2_4005d3 = call %struct.Memory* @sub_400500.foo(%struct.State* %0, i64  %loadPC_4005d3, %struct.Memory* %loadMem2_4005d3)
  store %struct.Memory* %call2_4005d3, %struct.Memory** %MEMORY

  ; Code: movl -0x24(%rbp), %eax	 RIP: 4005d8	 Bytes: 3
  %loadMem_4005d8 = load %struct.Memory*, %struct.Memory** %MEMORY
  %call_4005d8 = call %struct.Memory* @routine_movl_MINUS0x24__rbp____eax(%struct.State* %0, i64  0, %struct.Memory* %loadMem_4005d8)
  store %struct.Memory* %call_4005d8, %struct.Memory** %MEMORY

  ; Code: addl $0x1, %eax	 RIP: 4005db	 Bytes: 3
  %loadMem_4005db = load %struct.Memory*, %struct.Memory** %MEMORY
  %call_4005db = call %struct.Memory* @routine_addl__0x1___eax(%struct.State* %0, i64  0, %struct.Memory* %loadMem_4005db)
  store %struct.Memory* %call_4005db, %struct.Memory** %MEMORY

  ; Code: movl %eax, -0x24(%rbp)	 RIP: 4005de	 Bytes: 3
  %loadMem_4005de = load %struct.Memory*, %struct.Memory** %MEMORY
  %call_4005de = call %struct.Memory* @routine_movl__eax__MINUS0x24__rbp_(%struct.State* %0, i64  0, %struct.Memory* %loadMem_4005de)
  store %struct.Memory* %call_4005de, %struct.Memory** %MEMORY

  ; Code: jmpq .L_4005a6	 RIP: 4005e1	 Bytes: 5
  %loadMem_4005e1 = load %struct.Memory*, %struct.Memory** %MEMORY
  %call_4005e1 = call %struct.Memory* @routine_jmpq_.L_4005a6(%struct.State* %0, i64  0, %struct.Memory* %loadMem_4005e1, i64 -59, i64 5)
...
block_.L_4005e6:
  ...
  ; Code: xorl %eax, %eax	 RIP: 4005e6	 Bytes: 2
  %loadMem_4005e6 = load %struct.Memory*, %struct.Memory** %MEMORY
  %call_4005e6 = call %struct.Memory* @routine_xorl__eax___eax(%struct.State* %0, i64  0, %struct.Memory* %loadMem_4005e6)
  store %struct.Memory* %call_4005e6, %struct.Memory** %MEMORY

  ; Code: addq $0x30, %rsp	 RIP: 4005e8	 Bytes: 4
  %loadMem_4005e8 = load %struct.Memory*, %struct.Memory** %MEMORY
  %call_4005e8 = call %struct.Memory* @routine_addq__0x30___rsp(%struct.State* %0, i64  0, %struct.Memory* %loadMem_4005e8)
  store %struct.Memory* %call_4005e8, %struct.Memory** %MEMORY

  ; Code: popq %rbp	 RIP: 4005ec	 Bytes: 1
  %loadMem_4005ec = load %struct.Memory*, %struct.Memory** %MEMORY
  %call_4005ec = call %struct.Memory* @routine_popq__rbp(%struct.State* %0, i64  0, %struct.Memory* %loadMem_4005ec)
  store %struct.Memory* %call_4005ec, %struct.Memory** %MEMORY

  ; Code: retq	 RIP: 4005ed	 Bytes: 1
  %loadMem_4005ed = load %struct.Memory*, %struct.Memory** %MEMORY
  %call_4005ed = call %struct.Memory* @routine_retq(%struct.State* %0, i64  0, %struct.Memory* %loadMem_4005ed)
  store %struct.Memory* %call_4005ed, %struct.Memory** %MEMORY

  ret %struct.Memory* %call_4005ed
}
...
define %struct.Memory* @routine_jge_.L_4005e6(%struct.State*  dereferenceable(3376), i64, %struct.Memory*, i8* %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) {
block_400488:
  %3 = getelementptr inbounds %struct.State, %struct.State* %0, i32 0, i32 6
  %4 = getelementptr inbounds %struct.GPR, %struct.GPR* %3, i32 0, i32 33
  %5 = getelementptr inbounds %struct.Reg, %struct.Reg* %4, i32 0, i32 0
