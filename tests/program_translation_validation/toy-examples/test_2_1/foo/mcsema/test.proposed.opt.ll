...
entry:
  ...
  %94 = add i64 %93, -28
  %95 = load i32, i32* %R10D.i45, align 4
  ...
  %100 = add i64 %99, -32
  %101 = load i32, i32* %EAX.i25, align 4
  ...
  store i64 %111, i64* %RAX.i48, align 8
  %112 = add i64 %105, -32
  %113 = add i64 %107, 6
  ...
  %143 = load i64, i64* %R11.i43, align 8
  ...
  %149 = tail call %struct.Memory* @__remill_function_call(%struct.State* %0, i64 ptrtoint (i64 (i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64)* @printf to i64), %struct.Memory* %2)
  ...
  %152 = add i64 %151, -36
  %153 = load i32, i32* %EAX.i25, align 4
  %154 = add i64 %150, 5
  store i64 %154, i64* %PC.i, align 8
  %155 = inttoptr i64 %152 to i32*
  store i32 %153, i32* %155, align 4
  %156 = load i32, i32* %ECX.i34, align 4
  %157 = zext i32 %156 to i64
  %158 = load i64, i64* %PC.i, align 8
  store i64 %157, i64* %RAX.i48, align 8
  %159 = load i64, i64* %RSP.i11, align 8
  %160 = add i64 %159, 48
  store i64 %160, i64* %RSP.i11, align 8
...
define %struct.Memory* @routine_movq__0x400684___r11(%struct.State* dereferenceable(3376), i64, %struct.Memory*) local_unnamed_addr {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
...
define %struct.Memory* @routine_movl__r10d__MINUS0x1c__rbp_(%struct.State* dereferenceable(3376), i64, %struct.Memory*) local_unnamed_addr {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
