...
entry:
  ...
  %call2_4005c6 = call %struct.Memory* @sub_400500.foo(%struct.State* %0, i64 %loadPC_4005c6, %struct.Memory* %loadMem2_4005c6)
  store %struct.Memory* %call2_4005c6, %struct.Memory** %MEMORY
