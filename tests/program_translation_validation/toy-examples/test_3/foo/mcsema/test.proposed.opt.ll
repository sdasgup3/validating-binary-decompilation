...
block_.L_400569:                                  ; preds = %block_400575, %entry
  %38 = phi i64 [ %152, %block_400575 ], [ %.pre, %entry ]
  ...
  br i1 %74, label %block_400575, label %block_.L_400594
...
define %struct.Memory* @routine_jmpq_.L_400569(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
