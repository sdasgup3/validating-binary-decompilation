...
%G__0x4006a0_type = type <{ [8 x i8] }>
%G__0x4006c8_type = type <{ [8 x i8] }>
...
@G__0x4006a0 = external global %G__0x4006a0_type
@G__0x4006c8 = external global %G__0x4006c8_type
...
declare %struct.Memory.31* @sub_400550.foo(%struct.State.0* noalias dereferenceable(3376), i64, %struct.Memory.31* noalias readnone returned) local_unnamed_addr
