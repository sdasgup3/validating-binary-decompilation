...
entry:
  ...
  %RAX.i14 = bitcast %union.anon* %72 to i64*
  %73 = load i64, i64* %PC.i13
  %74 = add i64 %73, 10
  store i64 %74, i64* %PC.i13
  store i64 4195876, i64* %RAX.i14, align 8
  ...
  %RBP.i12 = bitcast %union.anon* %80 to i64*
  %81 = load i64, i64* %RBP.i12
  %82 = sub i64 %81, 4
  %83 = load i64, i64* %PC.i11
  %84 = add i64 %83, 7
  store i64 %84, i64* %PC.i11
  ...
  %PC.i9 = bitcast %union.anon* %88 to i64*
  ...
  %RBP.i10 = bitcast %union.anon* %94 to i64*
  %95 = load i64, i64* %RBP.i10
  %96 = sub i64 %95, 8
  %97 = load i32, i32* %EDI.i
  %98 = zext i32 %97 to i64
  %99 = load i64, i64* %PC.i9
  %100 = add i64 %99, 3
  store i64 %100, i64* %PC.i9
  ...
  %PC.i7 = bitcast %union.anon* %104 to i64*
  ...
  %RBP.i8 = bitcast %union.anon* %110 to i64*
  %111 = load i64, i64* %RBP.i8
  %112 = sub i64 %111, 16
  ...
  ret %struct.Memory* %loadMem_40055d
}
...
define %struct.Memory* @routine_movq__0x400624___rax(%struct.State* dereferenceable(3376), i64, %struct.Memory*) {
block_400468:
  %3 = getelementptr inbounds %struct.State, %struct.State* %0, i32 0, i32 6
  %4 = getelementptr inbounds %struct.GPR, %struct.GPR* %3, i32 0, i32 33
  %5 = getelementptr inbounds %struct.Reg, %struct.Reg* %4, i32 0, i32 0
  ...
  %10 = add i64 %9, 10
  store i64 %10, i64* %PC
  store i64 4195876, i64* %RAX, align 8
  ret %struct.Memory* %2
}
