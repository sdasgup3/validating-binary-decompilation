...
entry:
  ...
  ; Code: movq $0x400654, %rax	 RIP: 400568	 Bytes: 10
  %loadMem_400568 = load %struct.Memory*, %struct.Memory** %MEMORY
  %call_400568 = call %struct.Memory* @routine_movq__0x400654___rax(%struct.State* %0, i64  0, %struct.Memory* %loadMem_400568)
  ...
  ; Code: callq .stderr_driver	 RIP: 400583	 Bytes: 5
  %loadMem1_400583 = load %struct.Memory*, %struct.Memory** %MEMORY
  %call1_400583 = call %struct.Memory* @routine_callq_.stderr_driver(%struct.State* %0, i64  0, %struct.Memory* %loadMem1_400583, i64 -67, i64 5, i64 5)
  ...
  ; Code: addq $0x10, %rsp	 RIP: 400588	 Bytes: 4
  %loadMem_400588 = load %struct.Memory*, %struct.Memory** %MEMORY
  %call_400588 = call %struct.Memory* @routine_addq__0x10___rsp(%struct.State* %0, i64  0, %struct.Memory* %loadMem_400588)
