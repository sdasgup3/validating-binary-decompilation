...
declare %struct.Memory* @sub_400540.stderr_driver(%struct.State* dereferenceable(3376), i64, %struct.Memory*) local_unnamed_addr
...
entry:
  ...
  %call2_400583 = tail call %struct.Memory* @sub_400540.stderr_driver(%struct.State* %0, i64 %58, %struct.Memory* %2)
  ...
  ret %struct.Memory* %call2_400583
}
