...
declare %struct.Memory* @sub_400510.stderr_driver(%struct.State* dereferenceable(3376), i64, %struct.Memory*) local_unnamed_addr
...
entry:
  ...
  %call2_400553 = tail call %struct.Memory* @sub_400510.stderr_driver(%struct.State* %0, i64 %58, %struct.Memory* %2)
  ...
  ret %struct.Memory* %call2_400553
}
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_movq__0x400624___rax(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned) local_unnamed_addr #2 {
block_400468:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
