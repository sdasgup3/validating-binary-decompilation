...
entry:
  ...
  store i64 4195901, i64* %RSI.i, align 8
  ...
  %98 = load i64, i64* inttoptr (i64 6295616 to i64*)
  ...
  store %struct.Memory* %loadMem1_400584, %struct.Memory** %MEMORY
...
define %struct.Memory* @routine_movq__0x40063d___rsi(%struct.State* dereferenceable(3376), i64, %struct.Memory*) {
block_400468:
  %3 = getelementptr inbounds %struct.State, %struct.State* %0, i32 0, i32 6
  %4 = getelementptr inbounds %struct.GPR, %struct.GPR* %3, i32 0, i32 33
  %5 = getelementptr inbounds %struct.Reg, %struct.Reg* %4, i32 0, i32 0
  ...
  %10 = add i64 %9, 10
  store i64 %10, i64* %PC
  store i64 4195901, i64* %RSI, align 8
  ret %struct.Memory* %2
}
...
block_400468:
  ...
  %10 = add i64 %9, 8
  store i64 %10, i64* %PC
  %11 = load i64, i64* inttoptr (i64 6295616 to i64*)
