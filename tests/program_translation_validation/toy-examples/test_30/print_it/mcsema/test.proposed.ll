...
%G__0x40068d_type = type <{ [8 x i8] }>
@G__0x40068d= global %G__0x40068d_type <{ [8 x i8] c"\00\00\00\00\00\00\00\00" }>


define %struct.Memory* @print_it(%struct.State* noalias , i64, %struct.Memory* noalias) alwaysinline  {
entry:
  ...
  ; Code: .print_it:	 RIP: 4005b0	 Bytes: 0
  ...
  ; Code: subq $0x10, %rsp	 RIP: 4005b4	 Bytes: 4
  %loadMem_4005b4 = load %struct.Memory*, %struct.Memory** %MEMORY
  %call_4005b4 = call %struct.Memory* @routine_subq__0x10___rsp(%struct.State* %0, i64  0, %struct.Memory* %loadMem_4005b4)
  store %struct.Memory* %call_4005b4, %struct.Memory** %MEMORY

  ; Code: movq $0x40068d, %rsi	 RIP: 4005b8	 Bytes: 10
  %loadMem_4005b8 = load %struct.Memory*, %struct.Memory** %MEMORY
  %call_4005b8 = call %struct.Memory* @routine_movq__0x40068d___rsi(%struct.State* %0, i64  0, %struct.Memory* %loadMem_4005b8)
  store %struct.Memory* %call_4005b8, %struct.Memory** %MEMORY

  ; Code: movq %rdi, -0x8(%rbp)	 RIP: 4005c2	 Bytes: 4
  %loadMem_4005c2 = load %struct.Memory*, %struct.Memory** %MEMORY
  %call_4005c2 = call %struct.Memory* @routine_movq__rdi__MINUS0x8__rbp_(%struct.State* %0, i64  0, %struct.Memory* %loadMem_4005c2)
  store %struct.Memory* %call_4005c2, %struct.Memory** %MEMORY

  ; Code: movq 0x601040, %rdi	 RIP: 4005c6	 Bytes: 8
  %loadMem_4005c6 = load %struct.Memory*, %struct.Memory** %MEMORY
  %call_4005c6 = call %struct.Memory* @routine_movq_0x601040___rdi(%struct.State* %0, i64  0, %struct.Memory* %loadMem_4005c6)
  store %struct.Memory* %call_4005c6, %struct.Memory** %MEMORY

  ; Code: movq -0x8(%rbp), %rdx	 RIP: 4005ce	 Bytes: 4
  %loadMem_4005ce = load %struct.Memory*, %struct.Memory** %MEMORY
  %call_4005ce = call %struct.Memory* @routine_movq_MINUS0x8__rbp____rdx(%struct.State* %0, i64  0, %struct.Memory* %loadMem_4005ce)
  store %struct.Memory* %call_4005ce, %struct.Memory** %MEMORY

  ; Code: movb $0x0, %al	 RIP: 4005d2	 Bytes: 2
  %loadMem_4005d2 = load %struct.Memory*, %struct.Memory** %MEMORY
  %call_4005d2 = call %struct.Memory* @routine_movb__0x0___al(%struct.State* %0, i64  0, %struct.Memory* %loadMem_4005d2)
  store %struct.Memory* %call_4005d2, %struct.Memory** %MEMORY

  ; Code: callq .fprintf_plt	 RIP: 4005d4	 Bytes: 5
  %loadMem1_4005d4 = load %struct.Memory*, %struct.Memory** %MEMORY
  %call1_4005d4 = call %struct.Memory* @routine_callq_.fprintf_plt(%struct.State* %0, i64  0, %struct.Memory* %loadMem1_4005d4, i64 -372, i64 5, i64 5)
  store %struct.Memory* %call1_4005d4, %struct.Memory** %MEMORY

  %loadMem2_4005d4 = load %struct.Memory*, %struct.Memory** %MEMORY
  %loadPC_4005d4 = load i64, i64* %3
  %call2_4005d4 = call %struct.Memory* @ext_fprintf(%struct.State* %0, i64  %loadPC_4005d4, %struct.Memory* %loadMem2_4005d4)
  store %struct.Memory* %call2_4005d4, %struct.Memory** %MEMORY

  ; Code: xorl %ecx, %ecx	 RIP: 4005d9	 Bytes: 2
  %loadMem_4005d9 = load %struct.Memory*, %struct.Memory** %MEMORY
  %call_4005d9 = call %struct.Memory* @routine_xorl__ecx___ecx(%struct.State* %0, i64  0, %struct.Memory* %loadMem_4005d9)
  store %struct.Memory* %call_4005d9, %struct.Memory** %MEMORY

  ; Code: movl %eax, -0xc(%rbp)	 RIP: 4005db	 Bytes: 3
  %loadMem_4005db = load %struct.Memory*, %struct.Memory** %MEMORY
  %call_4005db = call %struct.Memory* @routine_movl__eax__MINUS0xc__rbp_(%struct.State* %0, i64  0, %struct.Memory* %loadMem_4005db)
  store %struct.Memory* %call_4005db, %struct.Memory** %MEMORY

  ; Code: movl %ecx, %eax	 RIP: 4005de	 Bytes: 2
  %loadMem_4005de = load %struct.Memory*, %struct.Memory** %MEMORY
  %call_4005de = call %struct.Memory* @routine_movl__ecx___eax(%struct.State* %0, i64  0, %struct.Memory* %loadMem_4005de)
  store %struct.Memory* %call_4005de, %struct.Memory** %MEMORY

  ; Code: addq $0x10, %rsp	 RIP: 4005e0	 Bytes: 4
  %loadMem_4005e0 = load %struct.Memory*, %struct.Memory** %MEMORY
  %call_4005e0 = call %struct.Memory* @routine_addq__0x10___rsp(%struct.State* %0, i64  0, %struct.Memory* %loadMem_4005e0)
  store %struct.Memory* %call_4005e0, %struct.Memory** %MEMORY

  ; Code: popq %rbp	 RIP: 4005e4	 Bytes: 1
  %loadMem_4005e4 = load %struct.Memory*, %struct.Memory** %MEMORY
  %call_4005e4 = call %struct.Memory* @routine_popq__rbp(%struct.State* %0, i64  0, %struct.Memory* %loadMem_4005e4)
  store %struct.Memory* %call_4005e4, %struct.Memory** %MEMORY

  ; Code: retq	 RIP: 4005e5	 Bytes: 1
  %loadMem_4005e5 = load %struct.Memory*, %struct.Memory** %MEMORY
  %call_4005e5 = call %struct.Memory* @routine_retq(%struct.State* %0, i64  0, %struct.Memory* %loadMem_4005e5)
  store %struct.Memory* %call_4005e5, %struct.Memory** %MEMORY

  ret %struct.Memory* %call_4005e5
}
...
define %struct.Memory* @routine_movq__0x40068d___rsi(%struct.State*  dereferenceable(3376), i64, %struct.Memory* ) #19 alwaysinline {
block_400488:
  %3 = getelementptr inbounds %struct.State, %struct.State* %0, i32 0, i32 6
  %4 = getelementptr inbounds %struct.GPR, %struct.GPR* %3, i32 0, i32 33
  %5 = getelementptr inbounds %struct.Reg, %struct.Reg* %4, i32 0, i32 0
  ...
  %10 = add i64 %9, 10
  store i64 %10, i64* %PC
  %11 = call %struct.Memory* @_ZN12_GLOBAL__N_1L3MOVI3RnWImE2InImEEEP6MemoryS6_R5StateT_T0_(%struct.Memory* %2, %struct.State* %0, i64* %RSI, i64 ptrtoint( %G__0x40068d_type* @G__0x40068d to i64))
...
define %struct.Memory* @routine_movq_0x601040___rdi(%struct.State*  dereferenceable(3376), i64, %struct.Memory* ) #19 alwaysinline {
block_400488:
  %3 = getelementptr inbounds %struct.State, %struct.State* %0, i32 0, i32 6
  %4 = getelementptr inbounds %struct.GPR, %struct.GPR* %3, i32 0, i32 33
  %5 = getelementptr inbounds %struct.Reg, %struct.Reg* %4, i32 0, i32 0
  ...
  %10 = add i64 %9, 8
  store i64 %10, i64* %PC
  %11 = call %struct.Memory* @_ZN12_GLOBAL__N_1L3MOVI3RnWImE2MnImEEEP6MemoryS6_R5StateT_T0_(%struct.Memory* %2, %struct.State* %0, i64* %RDI, i64 ptrtoint( %G_0x601040_type* @G_0x601040 to i64))
  ret %struct.Memory* %11
}
