...
declare %struct.Memory* @sub_400560.print_it(%struct.State* dereferenceable(3376), i64, %struct.Memory*)
...
entry:
  ...
  ; Code: .stderr_driver:	 RIP: 400510	 Bytes: 0
  ...
  ; Code: movq %rdi, -0x8(%rbp)	 RIP: 400518	 Bytes: 4
  %loadMem_400518 = load %struct.Memory*, %struct.Memory** %MEMORY
  %call_400518 = call %struct.Memory* @routine_movq__rdi__MINUS0x8__rbp_(%struct.State* %0, i64  0, %struct.Memory* %loadMem_400518)
  store %struct.Memory* %call_400518, %struct.Memory** %MEMORY

  ; Code: movq -0x8(%rbp), %rdi	 RIP: 40051c	 Bytes: 4
  %loadMem_40051c = load %struct.Memory*, %struct.Memory** %MEMORY
  %call_40051c = call %struct.Memory* @routine_movq_MINUS0x8__rbp____rdi(%struct.State* %0, i64  0, %struct.Memory* %loadMem_40051c)
  ...
  ; Code: callq .print_it	 RIP: 400522	 Bytes: 5
  %loadMem1_400522 = load %struct.Memory*, %struct.Memory** %MEMORY
  %call1_400522 = call %struct.Memory* @routine_callq_.print_it(%struct.State* %0, i64  0, %struct.Memory* %loadMem1_400522, i64 62, i64 5, i64 5)
  ...
  %call2_400522 = call %struct.Memory* @sub_400560.print_it(%struct.State* %0, i64  %loadPC_400522, %struct.Memory* %loadMem2_400522)
  store %struct.Memory* %call2_400522, %struct.Memory** %MEMORY

  ; Code: addq $0x10, %rsp	 RIP: 400527	 Bytes: 4
  %loadMem_400527 = load %struct.Memory*, %struct.Memory** %MEMORY
  %call_400527 = call %struct.Memory* @routine_addq__0x10___rsp(%struct.State* %0, i64  0, %struct.Memory* %loadMem_400527)
