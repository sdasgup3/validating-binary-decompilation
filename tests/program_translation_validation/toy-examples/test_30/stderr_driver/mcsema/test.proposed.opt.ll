...
declare %struct.Memory* @sub_400560.print_it(%struct.State* dereferenceable(3376), i64, %struct.Memory*) local_unnamed_addr
...
entry:
  ...
  %call2_400522 = tail call %struct.Memory* @sub_400560.print_it(%struct.State* %0, i64 %51, %struct.Memory* %2)
  ...
  ret %struct.Memory* %call2_400522
}
