...
declare %struct.Memory* @sub_400580.print_it(%struct.State* noalias dereferenceable(3376), i64, %struct.Memory* noalias readnone returned) local_unnamed_addr
...
entry:
  ...
  %call2_400542 = tail call %struct.Memory* @sub_400580.print_it(%struct.State* %0, i64 %51, %struct.Memory* %2)
