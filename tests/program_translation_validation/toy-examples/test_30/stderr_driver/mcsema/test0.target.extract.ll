...
define %struct.Memory* @stderr_driver(%struct.State* noalias, i64, %struct.Memory* noalias) #1 {
entry:
  ...
  %11 = add i64 %7, -24
  store i64 %11, i64* %RSP.i15, align 8
  ...
  store i64 %49, i64* %RDI.i10, align 8
  ...
  %call2_400542 = call %struct.Memory* @sub_400580.print_it(%struct.State* %0, i64 %51, %struct.Memory* %2)
  %56 = load i64, i64* %RSP.i15, align 8
  %57 = load i64, i64* %PC.i, align 8
  %58 = add i64 %56, 16
  store i64 %58, i64* %RSP.i15, align 8
  ...
  ret %struct.Memory* %call2_400542
}
