...
declare %struct.Memory.31* @sub_400580.print_it(%struct.State.0* noalias dereferenceable(3376), i64, %struct.Memory.31* noalias readnone returned)

; Function Attrs: alwaysinline
define %struct.Memory.31* @stderr_driver(%struct.State.0* noalias, i64, %struct.Memory.31* noalias) #1 {
entry:
