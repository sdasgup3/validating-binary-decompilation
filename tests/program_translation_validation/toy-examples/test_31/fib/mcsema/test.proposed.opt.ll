...
block_.L_400520:                                  ; preds = %block_400509
  ...
  %call2_400528 = tail call %struct.Memory* @sub_4004f0.fib(%struct.State* %0, i64 %131, %struct.Memory* %2)
  ...
  %call2_400536 = tail call %struct.Memory* @sub_4004f0.fib(%struct.State* %0, i64 %169, %struct.Memory* %call2_400528)
...
block_.L_400543:                                  ; preds = %block_.L_400520, %block_.L_400514
  %211 = phi i64 [ %106, %block_.L_400514 ], [ %.pre, %block_.L_400520 ]
  %MEMORY.1 = phi %struct.Memory* [ %2, %block_.L_400514 ], [ %call2_400536, %block_.L_400520 ]
...
define %struct.Memory* @routine_je_.L_400514(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i8* %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
...
define %struct.Memory* @routine_jne_.L_400520(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i8* %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 2, i32 7
