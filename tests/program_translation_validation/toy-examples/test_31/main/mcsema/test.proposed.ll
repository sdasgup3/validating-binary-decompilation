...
entry:
  ...
  ; Code: movl $0x5, %edi	 RIP: 400528	 Bytes: 5
  %loadMem_400528 = load %struct.Memory*, %struct.Memory** %MEMORY
  %call_400528 = call %struct.Memory* @routine_movl__0x5___edi(%struct.State* %0, i64  0, %struct.Memory* %loadMem_400528)
  ...
  ; Code: callq .fib	 RIP: 400534	 Bytes: 5
  %loadMem1_400534 = load %struct.Memory*, %struct.Memory** %MEMORY
  %call1_400534 = call %struct.Memory* @routine_callq_.fib(%struct.State* %0, i64  0, %struct.Memory* %loadMem1_400534, i64 -116, i64 5, i64 5)
  ...
  %call2_400534 = call %struct.Memory* @sub_4004c0.fib(%struct.State* %0, i64  %loadPC_400534, %struct.Memory* %loadMem2_400534)
  store %struct.Memory* %call2_400534, %struct.Memory** %MEMORY

  ; Code: movq $0x4005e4, %rdi	 RIP: 400539	 Bytes: 10
  %loadMem_400539 = load %struct.Memory*, %struct.Memory** %MEMORY
  %call_400539 = call %struct.Memory* @routine_movq__0x4005e4___rdi(%struct.State* %0, i64  0, %struct.Memory* %loadMem_400539)
  store %struct.Memory* %call_400539, %struct.Memory** %MEMORY

  ; Code: movl %eax, %esi	 RIP: 400543	 Bytes: 2
  %loadMem_400543 = load %struct.Memory*, %struct.Memory** %MEMORY
  %call_400543 = call %struct.Memory* @routine_movl__eax___esi(%struct.State* %0, i64  0, %struct.Memory* %loadMem_400543)
  store %struct.Memory* %call_400543, %struct.Memory** %MEMORY

  ; Code: movb $0x0, %al	 RIP: 400545	 Bytes: 2
  %loadMem_400545 = load %struct.Memory*, %struct.Memory** %MEMORY
  %call_400545 = call %struct.Memory* @routine_movb__0x0___al(%struct.State* %0, i64  0, %struct.Memory* %loadMem_400545)
  store %struct.Memory* %call_400545, %struct.Memory** %MEMORY

  ; Code: callq .printf_plt	 RIP: 400547	 Bytes: 5
  %loadMem1_400547 = load %struct.Memory*, %struct.Memory** %MEMORY
  %call1_400547 = call %struct.Memory* @routine_callq_.printf_plt(%struct.State* %0, i64  0, %struct.Memory* %loadMem1_400547, i64 -375, i64 5, i64 5)
  store %struct.Memory* %call1_400547, %struct.Memory** %MEMORY

  %loadMem2_400547 = load %struct.Memory*, %struct.Memory** %MEMORY
  %loadPC_400547 = load i64, i64* %3
  %call2_400547 = call %struct.Memory* @sub_4003d0.printf_plt(%struct.State* %0, i64  %loadPC_400547, %struct.Memory* %loadMem2_400547)
  store %struct.Memory* %call2_400547, %struct.Memory** %MEMORY

  ; Code: xorl %esi, %esi	 RIP: 40054c	 Bytes: 2
  %loadMem_40054c = load %struct.Memory*, %struct.Memory** %MEMORY
  %call_40054c = call %struct.Memory* @routine_xorl__esi___esi(%struct.State* %0, i64  0, %struct.Memory* %loadMem_40054c)
  store %struct.Memory* %call_40054c, %struct.Memory** %MEMORY

  ; Code: movl %eax, -0x8(%rbp)	 RIP: 40054e	 Bytes: 3
  %loadMem_40054e = load %struct.Memory*, %struct.Memory** %MEMORY
  %call_40054e = call %struct.Memory* @routine_movl__eax__MINUS0x8__rbp_(%struct.State* %0, i64  0, %struct.Memory* %loadMem_40054e)
  store %struct.Memory* %call_40054e, %struct.Memory** %MEMORY

  ; Code: movl %esi, %eax	 RIP: 400551	 Bytes: 2
  %loadMem_400551 = load %struct.Memory*, %struct.Memory** %MEMORY
  %call_400551 = call %struct.Memory* @routine_movl__esi___eax(%struct.State* %0, i64  0, %struct.Memory* %loadMem_400551)
  store %struct.Memory* %call_400551, %struct.Memory** %MEMORY

  ; Code: addq $0x10, %rsp	 RIP: 400553	 Bytes: 4
  %loadMem_400553 = load %struct.Memory*, %struct.Memory** %MEMORY
  %call_400553 = call %struct.Memory* @routine_addq__0x10___rsp(%struct.State* %0, i64  0, %struct.Memory* %loadMem_400553)
  store %struct.Memory* %call_400553, %struct.Memory** %MEMORY

  ; Code: popq %rbp	 RIP: 400557	 Bytes: 1
  %loadMem_400557 = load %struct.Memory*, %struct.Memory** %MEMORY
  %call_400557 = call %struct.Memory* @routine_popq__rbp(%struct.State* %0, i64  0, %struct.Memory* %loadMem_400557)
  store %struct.Memory* %call_400557, %struct.Memory** %MEMORY

  ; Code: retq	 RIP: 400558	 Bytes: 1
  %loadMem_400558 = load %struct.Memory*, %struct.Memory** %MEMORY
  %call_400558 = call %struct.Memory* @routine_retq(%struct.State* %0, i64  0, %struct.Memory* %loadMem_400558)
  store %struct.Memory* %call_400558, %struct.Memory** %MEMORY

  ret %struct.Memory* %call_400558
}
