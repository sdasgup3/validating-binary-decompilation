; ModuleID = '/tmp/tmplfz64isq-query.ll'
...
entry:
  ...
  %var_2_50 = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 1, i32 0
  %EAX.i16 = bitcast %union.anon* %var_2_50 to i32*
  %var_2_55 = add i64 %var_2_43, -97
  %var_2_57 = add i64 %var_2_46, -16
  %var_2_58 = inttoptr i64 %var_2_57 to i64*
  store i64 %var_2_55, i64* %var_2_58, align 8
  store i64 %var_2_57, i64* %var_2_6, align 8
  %var_2_61 = load i64, i64* %RBP.i, align 8
  %var_2_62 = add i64 %var_2_61, -8
  %var_2_63 = load i32, i32* %EAX.i16, align 4
  %var_2_64 = add i64 %var_2_43, -488
  store i64 %var_2_64, i64* %var_2_3, align 8
  %var_2_65 = inttoptr i64 %var_2_62 to i32*
  store i32 %var_2_63, i32* %var_2_65, align 4
  %var_2_68 = load i64, i64* %var_2_3, align 8
  %var_2_69 = load i64, i64* %var_2_6, align 8
  %var_2_97 = add i64 %var_2_68, 8
  store i64 %var_2_97, i64* %var_2_3, align 8
  %var_2_100 = add i64 %var_2_69, 32
