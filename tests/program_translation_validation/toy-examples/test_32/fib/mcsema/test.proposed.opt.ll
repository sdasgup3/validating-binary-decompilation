...
entry:
  ...
  br i1 %50, label %block_400557, label %block_.L_400564

block_400557:                                     ; preds = %entry
  %72 = add i64 %43, -8
  %73 = add i64 %71, 8
...
block_.L_400564:                                  ; preds = %entry
  ...
  %call2_40056f = tail call %struct.Memory* @sub_400540.fib(%struct.State* nonnull %0, i64 %101, %struct.Memory* %2)
  ...
  %call2_400580 = tail call %struct.Memory* @sub_400540.fib(%struct.State* nonnull %0, i64 %139, %struct.Memory* %call2_40056f)
...
block_.L_400590:                                  ; preds = %block_.L_400564, %block_400557
  %RAX.i.pre-phi = phi i64* [ %RAX.i31, %block_.L_400564 ], [ %.pre1, %block_400557 ]
  %181 = phi i64 [ %.pre, %block_.L_400564 ], [ %76, %block_400557 ]
  %MEMORY.0 = phi %struct.Memory* [ %call2_400580, %block_.L_400564 ], [ %2, %block_400557 ]
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_jae_.L_400564(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i8* nocapture %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
