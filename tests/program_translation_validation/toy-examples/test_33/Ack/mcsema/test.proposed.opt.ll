...
block_.L_400586:                                  ; preds = %entry
  ...
  br i1 %110, label %block_400590, label %block_.L_4005aa
...
block_400590:                                     ; preds = %block_.L_400586
  ...
  %call2_40059d = tail call %struct.Memory* @sub_400560.Ack(%struct.State* %0, i64 %140, %struct.Memory* %2)
...
block_.L_4005aa:                                  ; preds = %block_.L_400586
  ...
  %call2_4005be = tail call %struct.Memory* @sub_400560.Ack(%struct.State* %0, i64 %209, %struct.Memory* %2)
  ...
  %call2_4005c8 = tail call %struct.Memory* @sub_400560.Ack(%struct.State* %0, i64 %223, %struct.Memory* %call2_4005be)
...
block_.L_4005d0:                                  ; preds = %block_.L_4005aa, %block_400590, %block_400578
  %RAX.i.pre-phi = phi i64* [ %RAX.i30, %block_.L_4005aa ], [ %RAX.i43, %block_400590 ], [ %RAX.i57, %block_400578 ]
  %234 = phi i64 [ %.pre, %block_.L_4005aa ], [ %152, %block_400590 ], [ %100, %block_400578 ]
...
define %struct.Memory* @routine_jne_.L_400586(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i8* %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
...
define %struct.Memory* @routine_jne_.L_4005aa(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i8* %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 2, i32 7
