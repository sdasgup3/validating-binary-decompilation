...
define %struct.Memory* @Ack(%struct.State* noalias, i64, %struct.Memory* noalias) local_unnamed_addr #1 {
entry:
  ...
  %.v = select i1 %63, i64 10, i64 24
  %67 = add i64 %54, %.v
  store i64 %67, i64* %3, align 8
  br i1 %63, label %block_400548, label %block_.L_400556
...
block_400548:                                     ; preds = %entry
  ...
  store i64 %73, i64* %RAX.i57, align 8
  %74 = icmp eq i32 %71, -1
  %75 = icmp eq i32 %72, 0
  %76 = or i1 %74, %75
  %77 = zext i1 %76 to i8
...
block_.L_400556:                                  ; preds = %entry
  ...
  store i8 0, i8* %39, align 1
  %.v2 = select i1 %109, i64 10, i64 36
  %113 = add i64 %67, %.v2
  store i64 %113, i64* %3, align 8
  br i1 %109, label %block_400560, label %block_.L_40057a
...
block_400560:                                     ; preds = %block_.L_400556
  ...
  store i64 %118, i64* %RAX.i43, align 8
  ...
  %EAX.i38 = bitcast %union.anon* %114 to i32*
  %RDI.i39 = getelementptr inbounds %union.anon, %union.anon* %40, i64 0, i32 0
  store i64 %118, i64* %RDI.i39, align 8
  %139 = add i64 %113, -48
  %140 = add i64 %113, 18
  ...
  %call2_40056d = tail call %struct.Memory* @sub_400530.Ack(%struct.State* %0, i64 %139, %struct.Memory* %2)
  %144 = load i64, i64* %RBP.i, align 8
  %145 = add i64 %144, -4
  %146 = load i32, i32* %EAX.i38, align 4
...
block_.L_40057a:                                  ; preds = %block_.L_400556
  ...
  store i64 %156, i64* %RAX.i30, align 8
  ...
  store i64 %179, i64* %RDI.i25, align 8
  ...
  store i64 %183, i64* %RCX.i22, align 8
  ...
  %RSI.i19 = getelementptr inbounds %union.anon, %union.anon* %45, i64 0, i32 0
  store i64 %183, i64* %RSI.i19, align 8
  %EAX.i16 = bitcast %union.anon* %152 to i32*
  %204 = add i64 %52, -16
  %205 = add i64 %113, 20
  store i64 %205, i64* %3, align 8
  %206 = inttoptr i64 %204 to i32*
  store i32 %155, i32* %206, align 4
  ...
  %call2_40058e = tail call %struct.Memory* @sub_400530.Ack(%struct.State* %0, i64 %208, %struct.Memory* %2)
  ...
  store i64 %219, i64* %RDI.i25, align 8
  %220 = load i32, i32* %EAX.i16, align 4
  %221 = zext i32 %220 to i64
  store i64 %221, i64* %RSI.i19, align 8
  %222 = add i64 %215, -99
  %223 = add i64 %215, 10
  ...
  %call2_400598 = tail call %struct.Memory* @sub_400530.Ack(%struct.State* %0, i64 %222, %struct.Memory* %call2_40058e)
  %227 = load i64, i64* %RBP.i, align 8
  %228 = add i64 %227, -4
  %229 = load i32, i32* %EAX.i16, align 4
...
block_.L_4005a0:                                  ; preds = %block_.L_40057a, %block_400560, %block_400548
  %RAX.i.pre-phi = phi i64* [ %RAX.i30, %block_.L_40057a ], [ %RAX.i43, %block_400560 ], [ %RAX.i57, %block_400548 ]
  %233 = phi i64 [ %.pre, %block_.L_40057a ], [ %151, %block_400560 ], [ %99, %block_400548 ]
  %MEMORY.0 = phi %struct.Memory* [ %call2_400598, %block_.L_40057a ], [ %call2_40056d, %block_400560 ], [ %2, %block_400548 ]
  ...
  store i64 %239, i64* %RAX.i.pre-phi, align 8
  %240 = load i64, i64* %6, align 8
  %241 = add i64 %240, 16
  store i64 %241, i64* %6, align 8
  %242 = icmp ugt i64 %240, -17
...
define %struct.Memory* @routine_callq_.Ack(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr {
block_400478:
