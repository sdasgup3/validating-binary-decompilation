...
declare %struct.Memory* @sub_400420.atoi_plt(%struct.State* dereferenceable(3376), i64, %struct.Memory*) local_unnamed_addr
...
block_4005b0:                                     ; preds = %entry
  ...
  %call2_4005b8 = tail call %struct.Memory* @sub_400420.atoi_plt(%struct.State* nonnull %0, i64 %92, %struct.Memory* %2)
...
block_.L_4005d2:                                  ; preds = %block_.L_4005c5, %block_4005b0
  %EAX.i31.pre-phi = phi i32* [ %EAX.i40, %block_.L_4005c5 ], [ %EAX.i46, %block_4005b0 ]
  %RDI.i34.pre-phi = phi i64* [ %.pre, %block_.L_4005c5 ], [ %RDI.i51, %block_4005b0 ]
  %storemerge = phi i64 [ %109, %block_.L_4005c5 ], [ %104, %block_4005b0 ]
  %MEMORY.0 = phi %struct.Memory* [ %2, %block_.L_4005c5 ], [ %call2_4005b8, %block_4005b0 ]
  ...
  %call2_4005e8 = tail call %struct.Memory* @sub_400510.Ack(%struct.State* nonnull %0, i64 %135, %struct.Memory* %MEMORY.0)
  %140 = load i64, i64* %3, align 8
  store i64 4195988, i64* %RDI.i34.pre-phi, align 8
  ...
  %call2_4005fe = tail call %struct.Memory* @sub_400410.printf_plt(%struct.State* nonnull %0, i64 %150, %struct.Memory* %call2_4005e8)
  ...
  ret %struct.Memory* %call2_4005fe
}
