...
block_4005e0:                                     ; preds = %entry
  ...
  %call2_4005e8 = tail call %struct.Memory* @sub_400440.atoi_plt(%struct.State* nonnull %0, i64 %92, %struct.Memory* %2)
...
block_.L_400602:                                  ; preds = %block_.L_4005f5, %block_4005e0
  %EAX.i31.pre-phi = phi i32* [ %EAX.i40, %block_.L_4005f5 ], [ %EAX.i46, %block_4005e0 ]
  %RDI.i34.pre-phi = phi i64* [ %.pre, %block_.L_4005f5 ], [ %RDI.i51, %block_4005e0 ]
  %storemerge = phi i64 [ %109, %block_.L_4005f5 ], [ %104, %block_4005e0 ]
  %MEMORY.0 = phi %struct.Memory* [ %2, %block_.L_4005f5 ], [ %call2_4005e8, %block_4005e0 ]
  ...
  %call2_400618 = tail call %struct.Memory* @sub_400540.Ack(%struct.State* nonnull %0, i64 %135, %struct.Memory* %MEMORY.0)
  %140 = load i64, i64* %3, align 8
  store i64 4196036, i64* %RDI.i34.pre-phi, align 8
  ...
  %call2_40062e = tail call %struct.Memory* @sub_400430.printf_plt(%struct.State* nonnull %0, i64 %150, %struct.Memory* %call2_400618)
  ...
  ret %struct.Memory* %call2_40062e
}
