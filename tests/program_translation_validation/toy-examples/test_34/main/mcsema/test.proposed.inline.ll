...
entry:
  ...
  store %struct.Memory* %loadMem1_40051d, %struct.Memory** %MEMORY
  %loadMem2_40051d = load %struct.Memory*, %struct.Memory** %MEMORY
  %loadPC_40051d = load i64, i64* %3
  %124 = call %struct.Memory* @__remill_function_call(%struct.State* %0, i64 ptrtoint (i64 (i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64)* @printf to i64), %struct.Memory* %loadMem2_40051d)
  ...
  ret %struct.Memory* %loadMem_40052e
}
...
block_400478:
  ...
  %10 = add i64 %9, 10
  store i64 %10, i64* %PC
  store i64 add (i64 ptrtoint (%G__0x4005b4_type* @G__0x4005b4 to i64), i64 108), i64* %RDI, align 8
  ret %struct.Memory* %2
}
