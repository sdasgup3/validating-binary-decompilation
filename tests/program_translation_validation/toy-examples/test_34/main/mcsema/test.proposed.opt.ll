...
entry:
  ...
  store i64 add (i64 ptrtoint (i8* @G_0x601030 to i64), i64 108), i64* %RDI.i, align 8
  %40 = add i64 %7, -12
  %41 = add i64 %10, 24
  ...
  %call2_40052d = tail call %struct.Memory* @sub_400400.printf_plt(%struct.State* %0, i64 %46, %struct.Memory* %2)
  ...
  ret %struct.Memory* %call2_40052d
}
...
block_400488:
  ...
  store i64 add (i64 ptrtoint (i8* @G_0x601030 to i64), i64 108), i64* %RDI, align 8
  ret %struct.Memory* %2
}
