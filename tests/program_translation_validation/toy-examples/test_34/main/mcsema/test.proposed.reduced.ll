; ModuleID = '/tmp/tmpodg6ikkt-query.ll'
...
entry:
  ...
  %var_2_47 = add i64 %var_2_43, 25
  %var_2_48 = load i64, i64* %var_2_6, align 8
  %var_2_49 = add i64 %var_2_48, -8
  %var_2_50 = inttoptr i64 %var_2_49 to i64*
  store i64 %var_2_47, i64* %var_2_50, align 8
  store i64 %var_2_49, i64* %var_2_6, align 8
  %EAX.i = bitcast %union.anon* %var_2_45 to i32*
  %var_2_53 = load i64, i64* %RBP.i, align 8
  %var_2_54 = add i64 %var_2_53, -8
  %var_2_55 = load i32, i32* %EAX.i, align 4
  %var_2_56 = add i64 %var_2_43, -276
  store i64 %var_2_56, i64* %var_2_3, align 8
  %var_2_57 = inttoptr i64 %var_2_54 to i32*
  store i32 %var_2_55, i32* %var_2_57, align 4
  %var_2_60 = load i64, i64* %var_2_3, align 8
  %var_2_61 = load i64, i64* %var_2_6, align 8
  %var_2_89 = add i64 %var_2_60, 8
  store i64 %var_2_89, i64* %var_2_3, align 8
  %var_2_92 = add i64 %var_2_61, 32
...
; Function Attrs: alwaysinline norecurse nounwind
define %struct.Memory* @routine_movq__0x4005e4___rdi(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned) local_unnamed_addr #1 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  ...
  store i64 add (i64 ptrtoint (%G__0x4005e4_type* @G__0x4005e4 to i64), i64 140), i64* %RDI, align 8
  ret %struct.Memory* %2
}
...
; Function Attrs: alwaysinline norecurse nounwind
define %struct.Memory* @routine_movl__0xa__0x601030(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned) local_unnamed_addr #1 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, 11
...
; Function Attrs: alwaysinline norecurse nounwind
define %struct.Memory* @routine_movl_0x601030___esi(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned) local_unnamed_addr #1 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
