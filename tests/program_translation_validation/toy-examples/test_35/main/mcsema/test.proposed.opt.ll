...
define %struct.Memory* @routine_movq__0x4005f0___rdx(%struct.State* dereferenceable(3376), i64, %struct.Memory*) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  ...
  %4 = add i64 %3, 10
  store i64 %4, i64* %PC, align 8
  store i64 add (i64 ptrtoint (%G__0x4005f0_type* @G__0x4005f0 to i64), i64 168), i64* %RDX, align 8
  ret %struct.Memory* %2
}
