; ModuleID = '/home/ubuntu/Github/validating-binary-decompilation/tests/program_translation_validation/toy-examples/bc-seeds/test_36/test_36.bc'
...
define double @fun(double %a, double %b) #0 {
entry:
...
entry:
  ...
  %call = call double @fun(double 5.000000e+00, double 5.000000e+00)
