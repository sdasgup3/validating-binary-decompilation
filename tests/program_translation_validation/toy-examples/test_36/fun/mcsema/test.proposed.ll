...
entry:
  ...
  ; Code: movsd %xmm0, -0x8(%rbp)	 RIP: 4004c4	 Bytes: 5
  %loadMem_4004c4 = load %struct.Memory*, %struct.Memory** %MEMORY
  %call_4004c4 = call %struct.Memory* @routine_movsd__xmm0__MINUS0x8__rbp_(%struct.State* %0, i64  0, %struct.Memory* %loadMem_4004c4)
  store %struct.Memory* %call_4004c4, %struct.Memory** %MEMORY

  ; Code: movsd %xmm1, -0x10(%rbp)	 RIP: 4004c9	 Bytes: 5
  %loadMem_4004c9 = load %struct.Memory*, %struct.Memory** %MEMORY
  %call_4004c9 = call %struct.Memory* @routine_movsd__xmm1__MINUS0x10__rbp_(%struct.State* %0, i64  0, %struct.Memory* %loadMem_4004c9)
  store %struct.Memory* %call_4004c9, %struct.Memory** %MEMORY

  ; Code: movsd -0x8(%rbp), %xmm0	 RIP: 4004ce	 Bytes: 5
  %loadMem_4004ce = load %struct.Memory*, %struct.Memory** %MEMORY
  %call_4004ce = call %struct.Memory* @routine_movsd_MINUS0x8__rbp____xmm0(%struct.State* %0, i64  0, %struct.Memory* %loadMem_4004ce)
  store %struct.Memory* %call_4004ce, %struct.Memory** %MEMORY

  ; Code: mulsd -0x8(%rbp), %xmm0	 RIP: 4004d3	 Bytes: 5
  %loadMem_4004d3 = load %struct.Memory*, %struct.Memory** %MEMORY
  %call_4004d3 = call %struct.Memory* @routine_mulsd_MINUS0x8__rbp____xmm0(%struct.State* %0, i64  0, %struct.Memory* %loadMem_4004d3)
  store %struct.Memory* %call_4004d3, %struct.Memory** %MEMORY

  ; Code: movsd -0x10(%rbp), %xmm1	 RIP: 4004d8	 Bytes: 5
  %loadMem_4004d8 = load %struct.Memory*, %struct.Memory** %MEMORY
  %call_4004d8 = call %struct.Memory* @routine_movsd_MINUS0x10__rbp____xmm1(%struct.State* %0, i64  0, %struct.Memory* %loadMem_4004d8)
  store %struct.Memory* %call_4004d8, %struct.Memory** %MEMORY

  ; Code: mulsd -0x10(%rbp), %xmm1	 RIP: 4004dd	 Bytes: 5
  %loadMem_4004dd = load %struct.Memory*, %struct.Memory** %MEMORY
  %call_4004dd = call %struct.Memory* @routine_mulsd_MINUS0x10__rbp____xmm1(%struct.State* %0, i64  0, %struct.Memory* %loadMem_4004dd)
  store %struct.Memory* %call_4004dd, %struct.Memory** %MEMORY

  ; Code: addsd %xmm1, %xmm0	 RIP: 4004e2	 Bytes: 4
  %loadMem_4004e2 = load %struct.Memory*, %struct.Memory** %MEMORY
  %call_4004e2 = call %struct.Memory* @routine_addsd__xmm1___xmm0(%struct.State* %0, i64  0, %struct.Memory* %loadMem_4004e2)
