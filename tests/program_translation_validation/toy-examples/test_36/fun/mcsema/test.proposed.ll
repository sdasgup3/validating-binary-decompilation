...
define %struct.Memory* @fun(%struct.State* noalias , i64, %struct.Memory* noalias) alwaysinline  {
entry:
  ...
  ; Code: movsd %xmm0, -0x8(%rbp)	 RIP: 400504	 Bytes: 5
  %loadMem_400504 = load %struct.Memory*, %struct.Memory** %MEMORY
  %call_400504 = call %struct.Memory* @routine_movsd__xmm0__MINUS0x8__rbp_(%struct.State* %0, i64  0, %struct.Memory* %loadMem_400504)
  store %struct.Memory* %call_400504, %struct.Memory** %MEMORY

  ; Code: movsd %xmm1, -0x10(%rbp)	 RIP: 400509	 Bytes: 5
  %loadMem_400509 = load %struct.Memory*, %struct.Memory** %MEMORY
  %call_400509 = call %struct.Memory* @routine_movsd__xmm1__MINUS0x10__rbp_(%struct.State* %0, i64  0, %struct.Memory* %loadMem_400509)
  store %struct.Memory* %call_400509, %struct.Memory** %MEMORY

  ; Code: movsd -0x8(%rbp), %xmm0	 RIP: 40050e	 Bytes: 5
  %loadMem_40050e = load %struct.Memory*, %struct.Memory** %MEMORY
  %call_40050e = call %struct.Memory* @routine_movsd_MINUS0x8__rbp____xmm0(%struct.State* %0, i64  0, %struct.Memory* %loadMem_40050e)
  store %struct.Memory* %call_40050e, %struct.Memory** %MEMORY

  ; Code: mulsd -0x8(%rbp), %xmm0	 RIP: 400513	 Bytes: 5
  %loadMem_400513 = load %struct.Memory*, %struct.Memory** %MEMORY
  %call_400513 = call %struct.Memory* @routine_mulsd_MINUS0x8__rbp____xmm0(%struct.State* %0, i64  0, %struct.Memory* %loadMem_400513)
  store %struct.Memory* %call_400513, %struct.Memory** %MEMORY

  ; Code: movsd -0x10(%rbp), %xmm1	 RIP: 400518	 Bytes: 5
  %loadMem_400518 = load %struct.Memory*, %struct.Memory** %MEMORY
  %call_400518 = call %struct.Memory* @routine_movsd_MINUS0x10__rbp____xmm1(%struct.State* %0, i64  0, %struct.Memory* %loadMem_400518)
  store %struct.Memory* %call_400518, %struct.Memory** %MEMORY

  ; Code: mulsd -0x10(%rbp), %xmm1	 RIP: 40051d	 Bytes: 5
  %loadMem_40051d = load %struct.Memory*, %struct.Memory** %MEMORY
  %call_40051d = call %struct.Memory* @routine_mulsd_MINUS0x10__rbp____xmm1(%struct.State* %0, i64  0, %struct.Memory* %loadMem_40051d)
  store %struct.Memory* %call_40051d, %struct.Memory** %MEMORY

  ; Code: addsd %xmm1, %xmm0	 RIP: 400522	 Bytes: 4
  %loadMem_400522 = load %struct.Memory*, %struct.Memory** %MEMORY
  %call_400522 = call %struct.Memory* @routine_addsd__xmm1___xmm0(%struct.State* %0, i64  0, %struct.Memory* %loadMem_400522)
