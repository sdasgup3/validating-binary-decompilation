...
block_400478:
  ...
  %8 = getelementptr inbounds %struct.State, %struct.State* %0, i32 0, i32 1
  %9 = getelementptr inbounds [32 x %union.VectorReg], [32 x %union.VectorReg]* %8, i64 0, i64 0
  %YMM0 = bitcast %union.VectorReg* %9 to %"class.std::bitset"*
...
block_400478:
  ...
  %14 = add i64 %13, 5
  store i64 %14, i64* %PC
  %15 = bitcast i8* %10 to double*
  %16 = load double, double* %15, align 1
  %17 = inttoptr i64 %12 to double*
  %18 = load double, double* %17
  %19 = fmul double %16, %18
  store double %19, double* %15, align 1
  ret %struct.Memory* %2
}
...
block_400478:
  ...
  %8 = getelementptr inbounds [32 x %union.VectorReg], [32 x %union.VectorReg]* %6, i64 0, i64 1
  ...
  %12 = add i64 %11, 4
  store i64 %12, i64* %PC
  %13 = bitcast i8* %9 to double*
  %14 = load double, double* %13, align 1
  %15 = bitcast i8* %10 to double*
  %16 = load double, double* %15, align 1
  %17 = fadd double %14, %16
  store double %17, double* %13, align 1
  ret %struct.Memory* %2
}
