...
@G__0x400600 = global %G__0x400600_type zeroinitializer
...
entry:
  ...
  %call2_400541 = call %struct.Memory* @sub_4004f0.fun(%struct.State* %0, i64 %loadPC_400541, %struct.Memory* %loadMem2_400541)
  ...
  store i64 add (i64 ptrtoint (%G__0x400600_type* @G__0x400600 to i64), i64 184), i64* %RDI.i, align 8
  ...
  %169 = call %struct.Memory* @__remill_function_call(%struct.State* %0, i64 ptrtoint (i64 (i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64)* @printf to i64), %struct.Memory* %loadMem2_400552)
  ...
  ret %struct.Memory* %loadMem_400563
}
...
define %struct.Memory* @routine_movq__0x400600___rdi(%struct.State* dereferenceable(3376), i64, %struct.Memory*) {
block_400478:
  %3 = getelementptr inbounds %struct.State, %struct.State* %0, i32 0, i32 6
  %4 = getelementptr inbounds %struct.GPR, %struct.GPR* %3, i32 0, i32 33
  %5 = getelementptr inbounds %struct.Reg, %struct.Reg* %4, i32 0, i32 0
  ...
  %10 = add i64 %9, 10
  store i64 %10, i64* %PC
  store i64 add (i64 ptrtoint (%G__0x400600_type* @G__0x400600 to i64), i64 184), i64* %RDI, align 8
  ret %struct.Memory* %2
}
