...
declare %struct.Memory* @sub_4004c0.fun(%struct.State* dereferenceable(3376), i64, %struct.Memory*)
...
entry:
  ...
  %75 = load double, double* inttoptr (i64 add (i64 ptrtoint (%seg_400530__eh_frame_type* @seg_400530__eh_frame to i64), i64 8) to double*)
  ...
  %loadMem1_400511 = load %struct.Memory*, %struct.Memory** %MEMORY
  ...
  store %struct.Memory* %loadMem1_400511, %struct.Memory** %MEMORY
  %loadMem2_400511 = load %struct.Memory*, %struct.Memory** %MEMORY
  %loadPC_400511 = load i64, i64* %3
  %call2_400511 = call %struct.Memory* @sub_4004c0.fun(%struct.State* %0, i64 %loadPC_400511, %struct.Memory* %loadMem2_400511)
  store %struct.Memory* %call2_400511, %struct.Memory** %MEMORY
  ...
  store i64 add (i64 ptrtoint (%seg_400530__eh_frame_type* @seg_400530__eh_frame to i64), i64 160), i64* %RDI.i, align 8
  ...
  %call2_400522 = call %struct.Memory* @sub_4003d0.printf_plt(%struct.State* %0, i64 %loadPC_400522, %struct.Memory* %loadMem2_400522)
...
block_400468:
  ...
  %10 = add i64 %9, 8
  store i64 %10, i64* %PC
  %11 = load double, double* inttoptr (i64 add (i64 ptrtoint (%seg_400530__eh_frame_type* @seg_400530__eh_frame to i64), i64 8) to double*)
...
define %struct.Memory* @routine_movq__0x4005d0___rdi(%struct.State* dereferenceable(3376), i64, %struct.Memory*) {
block_400468:
  %3 = getelementptr inbounds %struct.State, %struct.State* %0, i32 0, i32 6
  %4 = getelementptr inbounds %struct.GPR, %struct.GPR* %3, i32 0, i32 33
  %5 = getelementptr inbounds %struct.Reg, %struct.Reg* %4, i32 0, i32 0
  ...
  %10 = add i64 %9, 10
  store i64 %10, i64* %PC
  store i64 add (i64 ptrtoint (%seg_400530__eh_frame_type* @seg_400530__eh_frame to i64), i64 160), i64* %RDI, align 8
  ret %struct.Memory* %2
}
