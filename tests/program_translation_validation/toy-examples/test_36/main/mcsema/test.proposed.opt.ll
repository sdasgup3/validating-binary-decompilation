...
entry:
  ...
  %40 = load i64, i64* bitcast (%G_0xc8__rip__type* @G_0xc8__rip_ to i64*), align 8
  ...
  %call2_400571 = tail call %struct.Memory* @sub_400520.fun(%struct.State* %0, i64 %63, %struct.Memory* %2)
  ...
  %75 = tail call %struct.Memory* @__remill_function_call(%struct.State* %0, i64 ptrtoint (i64 (i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64)* @printf to i64), %struct.Memory* %call2_400571)
...
define %struct.Memory* @routine_movq__0x400630___rdi(%struct.State* dereferenceable(3376), i64, %struct.Memory*) local_unnamed_addr {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
