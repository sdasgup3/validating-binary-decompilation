...
entry:
  ...
  %call2_400541 = tail call %struct.Memory* @sub_4004f0.fun(%struct.State* %0, i64 %63, %struct.Memory* %2)
  ...
  %75 = tail call %struct.Memory* @__remill_function_call(%struct.State* %0, i64 ptrtoint (i64 (i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64)* @printf to i64), %struct.Memory* %call2_400541)
