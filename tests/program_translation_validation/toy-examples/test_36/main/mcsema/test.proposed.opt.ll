...
entry:
  ...
  %call2_400541 = tail call %struct.Memory* @sub_4004f0.fun(%struct.State* %0, i64 %62, %struct.Memory* %2)
  ...
  %74 = tail call %struct.Memory* @__remill_function_call(%struct.State* %0, i64 ptrtoint (i64 (i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64)* @printf to i64), %struct.Memory* %call2_400541)
  %75 = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 5, i32 0
  %ECX.i9 = bitcast %union.anon* %75 to i32*
  %RCX.i = getelementptr inbounds %union.anon, %union.anon* %75, i64 0, i32 0
  %76 = load i64, i64* %3, align 8
  store i64 0, i64* %RCX.i, align 8
  %EAX.i = bitcast %union.anon* %68 to i32*
  ...
  %RAX.i = getelementptr inbounds %union.anon, %union.anon* %68, i64 0, i32 0
  %82 = load i32, i32* %ECX.i9, align 4
