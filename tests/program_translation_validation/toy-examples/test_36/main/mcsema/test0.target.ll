...
@G_0xc8__rip__4195632_ = external local_unnamed_addr global %G_0xc8__rip__4195632__type
@G__0x400600 = external global %G__0x400600_type
...
declare %struct.Memory.31* @sub_4004f0.fun(%struct.State.0* noalias dereferenceable(3376), i64, %struct.Memory.31* noalias readnone returned) local_unnamed_addr
