; ModuleID = '/home/ubuntu/Github/validating-binary-decompilation/tests/program_translation_validation/toy-examples/bc-seeds/test_5/test_5.bc'
...
for.end:                                          ; preds = %for.cond
  ...
  %call1 = call i32 (i32*, i32, ...) bitcast (i32 (i32*, i32)* @foo to i32 (i32*, i32, ...)*)(i32* %6, i32 10)
