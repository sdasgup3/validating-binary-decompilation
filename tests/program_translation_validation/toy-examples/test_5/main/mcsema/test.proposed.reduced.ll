; ModuleID = '/tmp/tmpdtt_ol82-query.ll'
...
@G__0x4006c4 = global %G__0x4006c4_type zeroinitializer
...
entry:
  ...
  %RAX.i74 = getelementptr inbounds %union.anon, %union.anon* %var_2_39, i64 0, i32 0
  store i64 40, i64* %RAX.i74, align 8
  %var_2_40 = add i64 %var_2_7, -12
  %var_2_41 = add i64 %1, 22
  ...
  %var_2_61 = load i64, i64* %var_2_6, align 8
  %var_2_62 = add i64 %var_2_61, -8
  store i64 %var_2_62, i64* %var_2_6, align 8
  %var_2_71 = load i64, i64* %RBP.i, align 8
  %var_2_72 = add i64 %var_2_71, -28
  %var_2_74 = add i64 %var_2_54, -270
  ...
  br label %block_.L_400590

block_.L_400590:                                  ; preds = %block_40059a, %entry
  %var_2_76 = phi i64 [ %var_2_173, %block_40059a ], [ %.pre, %entry ]
  %var_2_77 = load i64, i64* %RBP.i, align 8
  %var_2_78 = add i64 %var_2_77, -28
  ...
  %.v = select i1 %var_2_104, i64 10, i64 41
  %var_2_105 = add i64 %.v, %var_2_76
  store i64 %var_2_105, i64* %var_2_3, align 8
  br i1 %var_2_104, label %block_40059a, label %block_.L_4005b9

block_40059a:                                     ; preds = %block_.L_400590
  %var_2_106 = add i64 %var_2_105, 3
  store i64 %var_2_106, i64* %var_2_3, align 8
  %var_2_107 = load i32, i32* %var_2_80, align 4
  %var_2_108 = add i32 %var_2_107, 1
  %var_2_131 = add i64 %var_2_77, -24
  %var_2_132 = add i64 %var_2_105, 10
  store i64 %var_2_132, i64* %var_2_3, align 8
  %var_2_133 = inttoptr i64 %var_2_131 to i64*
  %var_2_134 = load i64, i64* %var_2_133, align 8
  %var_2_135 = add i64 %var_2_105, 14
  store i64 %var_2_135, i64* %var_2_3, align 8
  %var_2_136 = load i32, i32* %var_2_80, align 4
  %var_2_137 = sext i32 %var_2_136 to i64
  %var_2_138 = shl nsw i64 %var_2_137, 2
  %var_2_139 = add i64 %var_2_138, %var_2_134
  %var_2_140 = add i64 %var_2_105, 17
  store i64 %var_2_140, i64* %var_2_3, align 8
  %var_2_141 = inttoptr i64 %var_2_139 to i32*
  store i32 %var_2_108, i32* %var_2_141, align 4
  %var_2_142 = load i64, i64* %RBP.i, align 8
  %var_2_143 = add i64 %var_2_142, -28
  %var_2_144 = load i64, i64* %var_2_3, align 8
  %var_2_145 = add i64 %var_2_144, 3
  store i64 %var_2_145, i64* %var_2_3, align 8
  %var_2_146 = inttoptr i64 %var_2_143 to i32*
  %var_2_147 = load i32, i32* %var_2_146, align 4
  %var_2_148 = add i32 %var_2_147, 1
  %var_2_171 = add i64 %var_2_144, 9
  store i64 %var_2_171, i64* %var_2_3, align 8
  store i32 %var_2_148, i32* %var_2_146, align 4
  %var_2_172 = load i64, i64* %var_2_3, align 8
  %var_2_173 = add i64 %var_2_172, -36
  store i64 %var_2_173, i64* %var_2_3, align 8
  br label %block_.L_400590

block_.L_4005b9:                                  ; preds = %block_.L_400590
  %EAX.i71 = bitcast %union.anon* %var_2_39 to i32*
  %var_2_179 = add i64 %var_2_105, 16
  %var_2_180 = load i64, i64* %var_2_6, align 8
  %var_2_181 = add i64 %var_2_180, -8
  %var_2_182 = inttoptr i64 %var_2_181 to i64*
  store i64 %var_2_179, i64* %var_2_182, align 8
  %var_2_187 = add i64 %var_2_105, 74
  %var_2_189 = add i64 %var_2_180, -16
  %var_2_190 = inttoptr i64 %var_2_189 to i64*
  store i64 %var_2_187, i64* %var_2_190, align 8
  store i64 %var_2_189, i64* %var_2_6, align 8
  %var_2_192 = load i64, i64* %RBP.i, align 8
  %var_2_199 = add i64 %var_2_192, -32
  %var_2_200 = load i32, i32* %EAX.i71, align 4
  %var_2_201 = add i64 %var_2_105, -316
  store i64 %var_2_201, i64* %var_2_3, align 8
  %var_2_202 = inttoptr i64 %var_2_199 to i32*
  store i32 %var_2_200, i32* %var_2_202, align 4
  %var_2_205 = load i64, i64* %var_2_3, align 8
  %var_2_206 = load i64, i64* %var_2_6, align 8
  %var_2_233 = add i64 %var_2_205, 8
  store i64 %var_2_233, i64* %var_2_3, align 8
  %var_2_236 = add i64 %var_2_206, 48
...
define %struct.Memory* @routine_subq__0x20___rsp(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %RSP = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 13, i32 0, i32 0
  %3 = load i64, i64* %RSP, align 8
...
; Function Attrs: alwaysinline nounwind
define %struct.Memory* @routine_cmpl__0xa__MINUS0x1c__rbp_(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %RBP = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 15, i32 0, i32 0
  %3 = load i64, i64* %RBP, align 8
...
; Function Attrs: alwaysinline norecurse nounwind
define %struct.Memory* @routine_jge_.L_4005b9(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i8* nocapture %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr #1 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
...
; Function Attrs: alwaysinline norecurse nounwind
define %struct.Memory* @routine_movslq_MINUS0x1c__rbp____rdx(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned) local_unnamed_addr #1 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
...
; Function Attrs: alwaysinline norecurse nounwind
define %struct.Memory* @routine_jmpq_.L_400590(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr #1 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
...
; Function Attrs: alwaysinline norecurse nounwind
define %struct.Memory* @routine_movl__0xa___esi(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned) local_unnamed_addr #1 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %RSI = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 9, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
...
; Function Attrs: alwaysinline norecurse nounwind
define %struct.Memory* @routine_movq_MINUS0x18__rbp____rdi(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned) local_unnamed_addr #1 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %RDI = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 11, i32 0, i32 0
  %RBP = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 15, i32 0, i32 0
...
; Function Attrs: alwaysinline norecurse nounwind
define %struct.Memory* @routine_movq__0x4006c4___rdi(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned) local_unnamed_addr #1 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %RDI = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 11, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, 10
  store i64 %4, i64* %PC, align 8
  store i64 ptrtoint (%G__0x4006c4_type* @G__0x4006c4 to i64), i64* %RDI, align 8
  ret %struct.Memory* %2
}
...
; Function Attrs: alwaysinline norecurse nounwind
define %struct.Memory* @routine_movl_MINUS0x4__rbp____esi(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned) local_unnamed_addr #1 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %RSI = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 9, i32 0, i32 0
  %RBP = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 15, i32 0, i32 0
...
; Function Attrs: alwaysinline nounwind
define %struct.Memory* @routine_addq__0x20___rsp(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned) local_unnamed_addr #2 {
block_400488:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %RSP = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 13, i32 0, i32 0
  %3 = load i64, i64* %RSP, align 8
