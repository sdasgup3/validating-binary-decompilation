...
@G__0x4006a4 = external global %G__0x4006a4_type
...
declare %struct.Memory.31* @__remill_function_call(%struct.State.0* dereferenceable(3376), i64, %struct.Memory.31*)

declare %struct.Memory.31* @sub_4005d0.foo(%struct.State.0* noalias dereferenceable(3376), i64, %struct.Memory.31* noalias readnone returned)

; Function Attrs: alwaysinline
define %struct.Memory.31* @main(%struct.State.0* noalias, i64, %struct.Memory.31* noalias) #1 {
entry:
  br label %block_.L_400570

block_.L_400570:                                  ; preds = %block_40057a, %entry
  br i1 undef, label %block_40057a, label %block_.L_400599
