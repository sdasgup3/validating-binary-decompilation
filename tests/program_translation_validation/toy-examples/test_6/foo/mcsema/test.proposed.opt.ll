...
entry:
  ...
  %95 = add i64 %94, -48
  %96 = load i32, i32* %R10D.i99, align 4
  ...
  %101 = add i64 %100, -56
  %102 = load i64, i64* %R11.i97, align 8
  ...
  %107 = add i64 %106, -64
  %108 = load i64, i64* %RAX.i102, align 8
...
block_.L_400585:                                  ; preds = %block_400591, %entry
  %118 = phi i64 [ %272, %block_400591 ], [ %.pre, %entry ]
  ...
  br i1 %154, label %block_400591, label %block_.L_4005bb
...
define %struct.Memory* @routine_movl__ebx__MINUS0x2c__rbp_(%struct.State* dereferenceable(3376), i64, %struct.Memory*) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
...
define %struct.Memory* @routine_movl__r10d__MINUS0x30__rbp_(%struct.State* dereferenceable(3376), i64, %struct.Memory*) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
...
define %struct.Memory* @routine_cmpl_0x10__rbp____eax(%struct.State* dereferenceable(3376), i64, %struct.Memory*) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
...
define %struct.Memory* @routine_jmpq_.L_400585(%struct.State* dereferenceable(3376), i64, %struct.Memory*, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr {
block_400478:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
