...
@G__0x400774 = global %G__0x400774_type zeroinitializer
...
entry:
  ...
  %157 = call %struct.Memory* @__remill_function_call(%struct.State* %0, i64 ptrtoint (i64 (i64)* @malloc to i64), %struct.Memory* %loadMem2_400600)
  ...
  %209 = call %struct.Memory* @__remill_function_call(%struct.State* %0, i64 ptrtoint (i64 (i64)* @malloc to i64), %struct.Memory* %loadMem2_400610)
...
block_.L_40067c:                                  ; preds = %block_.L_400653
  ...
  store i64 ptrtoint (%G__0x400774_type* @G__0x400774 to i64), i64* %RDI.i, align 8
  ...
  %1025 = call %struct.Memory* @__remill_function_call(%struct.State* %0, i64 ptrtoint (i64 (i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64)* @printf to i64), %struct.Memory* %loadMem2_4006dc)
...
block_400478:
  ...
  %10 = add i64 %9, 10
  store i64 %10, i64* %PC
  store i64 ptrtoint (%G__0x400774_type* @G__0x400774 to i64), i64* %RDI, align 8
  ret %struct.Memory* %2
}
