...
block_.L_400620:                                  ; preds = %block_40062a, %entry
  %90 = phi i64 [ %188, %block_40062a ], [ %.pre, %entry ]
...
block_.L_400653:                                  ; preds = %block_40065d, %block_.L_40064c
  %190 = phi i64 [ %287, %block_40065d ], [ %.pre1, %block_.L_40064c ]
  ...
  %218 = xor i1 %217, %215
  %.v2 = select i1 %218, i64 10, i64 41
  %219 = add i64 %190, %.v2
  store i64 %219, i64* %3, align 8
  br i1 %218, label %block_40065d, label %block_.L_40067c
...
block_.L_40067c:                                  ; preds = %block_.L_400653
  ...
  %call2_4006c5 = tail call %struct.Memory* @sub_400540.foo(%struct.State* %0, i64 %325, %struct.Memory* %78)
  ...
  %348 = tail call %struct.Memory* @__remill_function_call(%struct.State* %0, i64 ptrtoint (i64 (i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64)* @printf to i64), %struct.Memory* %call2_4006c5)
