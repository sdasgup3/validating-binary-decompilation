...
declare %struct.Memory.31* @sub_400540.foo(%struct.State.0* noalias dereferenceable(3376), i64, %struct.Memory.31* noalias readnone returned)
...
block_.L_400620:                                  ; preds = %block_40062a, %entry
  br i1 undef, label %block_40062a, label %block_.L_40064c
...
block_.L_400653:                                  ; preds = %block_40065d, %block_.L_40064c
  br i1 undef, label %block_40065d, label %block_.L_40067c
