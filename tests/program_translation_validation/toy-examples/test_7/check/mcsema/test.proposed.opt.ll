...
block_.L_400568:                                  ; preds = %block_400574, %entry
  %156 = phi i64 [ %270, %block_400574 ], [ %.pre, %entry ]
  ...
  br i1 %192, label %block_400574, label %block_.L_400593

block_400574:                                     ; preds = %block_.L_400568
  %194 = add i64 %157, -24
  %195 = add i64 %193, 4
...
block_.L_400593:                                  ; preds = %block_.L_400568
  %271 = add i64 %157, -32
  %272 = add i64 %193, 4
...
block_.L_4005a6:                                  ; preds = %block_4005b2, %block_.L_400593
  %316 = phi i64 [ %430, %block_4005b2 ], [ %.pre18, %block_.L_400593 ]
  ...
  br i1 %352, label %block_4005b2, label %block_.L_4005d1
...
block_.L_4005d1:                                  ; preds = %block_.L_4005a6
  %431 = add i64 %317, -52
  %432 = add i64 %353, 3
...
block_.L_4005e1:                                  ; preds = %block_4005ed, %block_.L_4005d1
  %473 = phi i64 [ %587, %block_4005ed ], [ %.pre19, %block_.L_4005d1 ]
  ...
  br i1 %509, label %block_4005ed, label %block_.L_40060c

block_4005ed:                                     ; preds = %block_.L_4005e1
  %511 = add i64 %474, -64
  %512 = add i64 %510, 4
...
block_.L_40060c:                                  ; preds = %block_.L_4005e1
  %588 = add i64 %474, -72
  %589 = add i64 %510, 4
...
block_.L_40061f:                                  ; preds = %block_40062b, %block_.L_40060c
  %633 = phi i64 [ %747, %block_40062b ], [ %.pre20, %block_.L_40060c ]
  ...
  br i1 %669, label %block_40062b, label %block_.L_40064a
...
block_.L_40064a:                                  ; preds = %block_.L_40061f
  %748 = add i64 %634, -84
  %749 = add i64 %670, 3
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_jge_.L_400593(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i8* nocapture %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr #2 {
block_400468:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_jmpq_.L_400568(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr #2 {
block_400468:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_jge_.L_4005d1(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i8* nocapture %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr #2 {
block_400468:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 2, i32 9
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_jge_.L_40060c(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i8* nocapture %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr #2 {
block_400468:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 2, i32 9
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_jmpq_.L_4005e1(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr #2 {
block_400468:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_jge_.L_40064a(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i8* nocapture %BRANCH_TAKEN, i64 %rel_off1, i64 %rel_off2, i64 %rel_off3) local_unnamed_addr #2 {
block_400468:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 2, i32 9
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_jmpq_.L_40061f(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i64 %rel_off1, i64 %rel_off2) local_unnamed_addr #2 {
block_400468:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
  %3 = load i64, i64* %PC, align 8
  %4 = add i64 %3, %rel_off1
