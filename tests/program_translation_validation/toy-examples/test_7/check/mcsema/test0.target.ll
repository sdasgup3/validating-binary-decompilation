...
define %struct.Memory.31* @check(%struct.State.0* noalias, i64, %struct.Memory.31* noalias) local_unnamed_addr #1 {
entry:
  br label %block_.L_400598

block_.L_400598:                                  ; preds = %block_4005a4, %entry
  br i1 undef, label %block_4005a4, label %block_.L_4005c3
...
block_.L_4005d6:                                  ; preds = %block_4005e2, %block_.L_4005c3
  br i1 undef, label %block_4005e2, label %block_.L_400601
...
block_.L_400611:                                  ; preds = %block_40061d, %block_.L_400601
  br i1 undef, label %block_40061d, label %block_.L_40063c
...
block_.L_40064f:                                  ; preds = %block_40065b, %block_.L_40063c
  br i1 undef, label %block_40065b, label %block_.L_40067a
