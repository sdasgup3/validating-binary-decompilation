...
declare %struct.Memory.31* @sub_400540.check(%struct.State.0* noalias dereferenceable(3376), i64, %struct.Memory.31* noalias readnone returned)
...
block_.L_4006aa:                                  ; preds = %block_4006b4, %entry
  br i1 undef, label %block_4006b4, label %block_.L_4006d0
...
block_.L_4006ef:                                  ; preds = %block_4006f9, %block_.L_4006d0
  br i1 undef, label %block_4006f9, label %block_.L_400718
