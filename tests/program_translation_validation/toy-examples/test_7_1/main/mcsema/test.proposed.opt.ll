...
block_.L_400571:                                  ; preds = %block_.L_40054d
  ...
  %call2_400594 = tail call %struct.Memory* @sub_4004f0.check(%struct.State* %0, i64 %144, %struct.Memory* %2)
  ...
  %167 = tail call %struct.Memory* @__remill_function_call(%struct.State* %0, i64 ptrtoint (i64 (i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64)* @printf to i64), %struct.Memory* %call2_400594)
