...
declare %struct.Memory.31* @sub_4004f0.check(%struct.State.0* noalias dereferenceable(3376), i64, %struct.Memory.31* noalias readnone returned)
...
block_.L_40054d:                                  ; preds = %block_400557, %entry
  br i1 undef, label %block_400557, label %block_.L_400571
