...
define %struct.Random_struct* @new_Random_seed(i32) #0 {
  %2 = alloca i32, align 4
  %3 = alloca %struct.Random_struct*, align 8
  store i32 %0, i32* %2, align 4
  %4 = call noalias i8* @malloc(i64 112) #2
...
; Function Attrs: noinline nounwind optnone uwtable
declare hidden void @initialize(%struct.Random_struct*, i32) #0
