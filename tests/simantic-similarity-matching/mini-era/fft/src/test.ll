; ModuleID = '/home/sdasgup3/Github/validating-binary-decompilation/tests/simantic-similarity-matching/mini-era/bc-seeds/fft/fft.bc'
...
for.body:                                         ; preds = %for.cond
  ...
  %call6 = call double @sin(double %conv5) #2
  ...
  %call10 = call double @sin(double %mul9) #2
