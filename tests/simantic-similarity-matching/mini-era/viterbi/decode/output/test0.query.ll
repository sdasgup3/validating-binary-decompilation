...
@d_metric0_generic = external global [64 x i8], align 16, !dbg !445
@d_metric1_generic = external global [64 x i8], align 16, !dbg !451
@d_path0_generic = external global [64 x i8], align 16, !dbg !453
@d_path1_generic = external global [64 x i8], align 16, !dbg !455
...
declare i8* @depuncture(i8* readonly) local_unnamed_addr #1

; Function Attrs: nounwind uwtable
declare void @viterbi_butterfly2_generic(i8* nocapture readonly, i8* nocapture, i8* nocapture, i8* nocapture, i8* nocapture) local_unnamed_addr #2

; Function Attrs: norecurse nounwind uwtable
declare zeroext i8 @viterbi_get_output_generic(i8* nocapture, i8* nocapture, i32, i8* nocapture) local_unnamed_addr #1

; Function Attrs: nounwind uwtable
define i8* @decode(%struct.ofdm_param.0* %ofdm, %struct.frame_param.1* %frame, i8* readonly %in, i32* nocapture %n_dec_char) local_unnamed_addr #2 {
entry:
  %c = alloca i8, align 1
...
if.then5:                                         ; preds = %if.then
  call void @llvm.lifetime.start(i64 1, i8* nonnull %c) #3
...
if.end:                                           ; preds = %for.cond.preheader, %if.then5
  call void @llvm.lifetime.end(i64 1, i8* nonnull %c) #3
  br label %if.end19
...
; Function Attrs: norecurse nounwind uwtable
declare void @viterbi_chunks_init_generic() local_unnamed_addr #1
...
!llvm.dbg.cu = !{!2, !457, !463, !467}
!llvm.ident = !{!470, !470, !470, !470, !470, !470, !470}
!llvm.module.flags = !{!471, !472}
...
!446 = distinct !DIGlobalVariable(name: "d_metric0_generic", scope: !2, file: !447, line: 34, type: !448, isLocal: false, isDefinition: true, align: 128)
!447 = !DIFile(filename: "./viterbi/viterbi_decoder_generic.h", directory: "/home/sdasgup3/Github/epochs/mini-era")
!448 = !DICompositeType(tag: DW_TAG_array_type, baseType: !92, size: 512, elements: !449)
!449 = !{!450}
!450 = !DISubrange(count: 64)
!451 = !DIGlobalVariableExpression(var: !452)
!452 = distinct !DIGlobalVariable(name: "d_metric1_generic", scope: !2, file: !447, line: 35, type: !448, isLocal: false, isDefinition: true, align: 128)
!453 = !DIGlobalVariableExpression(var: !454)
!454 = distinct !DIGlobalVariable(name: "d_path0_generic", scope: !2, file: !447, line: 36, type: !448, isLocal: false, isDefinition: true, align: 128)
!455 = !DIGlobalVariableExpression(var: !456)
!456 = distinct !DIGlobalVariable(name: "d_path1_generic", scope: !2, file: !447, line: 37, type: !448, isLocal: false, isDefinition: true, align: 128)
!457 = distinct !DICompileUnit(language: DW_LANG_C99, file: !458, producer: "clang version 4.0.0 (tags/RELEASE_400/final)", isOptimized: true, runtimeVersion: 0, emissionKind: FullDebug, enums: !459, retainedTypes: !460, globals: !462)
!458 = !DIFile(filename: "main.c", directory: "/home/sdasgup3/Github/epochs/mini-era")
!459 = !{!5, !33, !25, !40, !14}
!460 = !{!461, !76, !440, !61}
!461 = !DIDerivedType(tag: DW_TAG_typedef, name: "uint64_t", file: !91, line: 55, baseType: !184)
!462 = !{}
!463 = distinct !DICompileUnit(language: DW_LANG_C99, file: !464, producer: "clang version 4.0.0 (tags/RELEASE_400/final)", isOptimized: true, runtimeVersion: 0, emissionKind: FullDebug, enums: !465, retainedTypes: !466, globals: !462)
!464 = !DIFile(filename: "read_trace.c", directory: "/home/sdasgup3/Github/epochs/mini-era")
!465 = !{!10, !5, !33}
!466 = !{!61}
!467 = distinct !DICompileUnit(language: DW_LANG_C99, file: !468, producer: "clang version 4.0.0 (tags/RELEASE_400/final)", isOptimized: false, runtimeVersion: 0, emissionKind: FullDebug, enums: !462, retainedTypes: !469, globals: !462)
!468 = !DIFile(filename: "calculate_dist_from_fmcw.c", directory: "/home/sdasgup3/Github/epochs/mini-era/radar")
!469 = !{!56}
!470 = !{!"clang version 4.0.0 (tags/RELEASE_400/final)"}
!471 = !{i32 2, !"Dwarf Version", i32 4}
