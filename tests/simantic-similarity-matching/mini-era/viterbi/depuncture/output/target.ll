...
%entry:
;   %0 = load %struct.ofdm_param.0*, %struct.ofdm_param.0** @d_ofdm, align 8, !tbaa !1
;   %n_cbps1 = getelementptr inbounds %struct.ofdm_param.0, %struct.ofdm_param.0* %0, i64 0, i32 3
...
%for.cond.preheader:
;   %3 = load %struct.frame_param.1*, %struct.frame_param.1** @d_frame, align 8, !tbaa !1
;   %n_sym268 = getelementptr inbounds %struct.frame_param.1, %struct.frame_param.1* %3, i64 0, i32 1
