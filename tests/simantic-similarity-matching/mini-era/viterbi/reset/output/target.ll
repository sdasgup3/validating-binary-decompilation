...
;   %arrayidx7.i = getelementptr inbounds [2 x %union.branchtab27_u.2], [2 x %union.branchtab27_u.2]* @d_branchtab27_generic, i64 0, i64 0, i32 0, i64 %indvars.iv.i
...
;   %arrayidx23.i = getelementptr inbounds [2 x %union.branchtab27_u.2], [2 x %union.branchtab27_u.2]* @d_branchtab27_generic, i64 0, i64 1, i32 0, i64 %indvars.iv.i
...
;   %arrayidx7.i.1 = getelementptr inbounds [2 x %union.branchtab27_u.2], [2 x %union.branchtab27_u.2]* @d_branchtab27_generic, i64 0, i64 0, i32 0, i64 %indvars.iv.next.i
...
;   %arrayidx23.i.1 = getelementptr inbounds [2 x %union.branchtab27_u.2], [2 x %union.branchtab27_u.2]* @d_branchtab27_generic, i64 0, i64 1, i32 0, i64 %indvars.iv.next.i
...
;   %6 = load %struct.ofdm_param.0*, %struct.ofdm_param.0** @d_ofdm, align 8, !tbaa !4
;   %encoding = getelementptr inbounds %struct.ofdm_param.0, %struct.ofdm_param.0* %6, i64 0, i32 0
