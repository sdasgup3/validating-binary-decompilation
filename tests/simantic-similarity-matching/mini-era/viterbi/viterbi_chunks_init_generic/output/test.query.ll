...
entry:
  ...
  %call = call i32 @fft(float* %0, i32 %1, i32 %2, i32 -1), !dbg !2544
  call void @llvm.dbg.declare(metadata float* %max_psd, metadata !2545, metadata !700), !dbg !2546
  store float 0.000000e+00, float* %max_psd, align 4, !dbg !2546
  call void @llvm.dbg.declare(metadata i32* %max_index, metadata !2547, metadata !700), !dbg !2548
  store i32 0, i32* %max_index, align 4, !dbg !2548
  call void @llvm.dbg.declare(metadata i32* %i, metadata !2549, metadata !700), !dbg !2550
  call void @llvm.dbg.declare(metadata float* %temp, metadata !2551, metadata !700), !dbg !2552
  store i32 0, i32* %i, align 4, !dbg !2553
  br label %for.cond, !dbg !2555

for.cond:                                         ; preds = %for.inc, %entry
  %3 = load i32, i32* %i, align 4, !dbg !2556
  %4 = load i32, i32* @RADAR_N, align 4, !dbg !2559
  %cmp = icmp ult i32 %3, %4, !dbg !2560
  br i1 %cmp, label %for.body, label %for.end, !dbg !2561

for.body:                                         ; preds = %for.cond
  %5 = load float*, float** %data.addr, align 8, !dbg !2563
  %6 = load i32, i32* %i, align 4, !dbg !2565
  %mul = mul i32 2, %6, !dbg !2566
  %idxprom = zext i32 %mul to i64, !dbg !2563
  %arrayidx = getelementptr inbounds float, float* %5, i64 %idxprom, !dbg !2563
  %7 = load float, float* %arrayidx, align 4, !dbg !2563
  %conv = fpext float %7 to double, !dbg !2563
  %call1 = call double @pow(double %conv, double 2.000000e+00) #6, !dbg !2567
  %8 = load float*, float** %data.addr, align 8, !dbg !2568
  %9 = load i32, i32* %i, align 4, !dbg !2569
  %mul2 = mul i32 2, %9, !dbg !2570
  %add = add i32 %mul2, 1, !dbg !2571
  %idxprom3 = zext i32 %add to i64, !dbg !2568
  %arrayidx4 = getelementptr inbounds float, float* %8, i64 %idxprom3, !dbg !2568
  %10 = load float, float* %arrayidx4, align 4, !dbg !2568
  %conv5 = fpext float %10 to double, !dbg !2568
  %call6 = call double @pow(double %conv5, double 2.000000e+00) #6, !dbg !2572
  %add7 = fadd double %call1, %call6, !dbg !2574
  %div = fdiv double %add7, 1.000000e+02, !dbg !2575
  %conv8 = fptrunc double %div to float, !dbg !2576
  store float %conv8, float* %temp, align 4, !dbg !2577
  %11 = load float, float* %temp, align 4, !dbg !2578
  %12 = load float, float* %max_psd, align 4, !dbg !2580
  %cmp9 = fcmp ogt float %11, %12, !dbg !2581
  br i1 %cmp9, label %if.then, label %if.end, !dbg !2582

if.then:                                          ; preds = %for.body
  %13 = load float, float* %temp, align 4, !dbg !2583
  store float %13, float* %max_psd, align 4, !dbg !2585
  %14 = load i32, i32* %i, align 4, !dbg !2586
  store i32 %14, i32* %max_index, align 4, !dbg !2587
...
for.inc:                                          ; preds = %if.end
  %15 = load i32, i32* %i, align 4, !dbg !2590
  %inc = add i32 %15, 1, !dbg !2590
  store i32 %inc, i32* %i, align 4, !dbg !2590
  br label %for.cond, !dbg !2592, !llvm.loop !2593

for.end:                                          ; preds = %for.cond
  call void @llvm.dbg.declare(metadata float* %distance, metadata !2596, metadata !700), !dbg !2597
  %16 = load i32, i32* %max_index, align 4, !dbg !2598
  %conv11 = uitofp i32 %16 to float, !dbg !2598
  %17 = load float, float* @RADAR_fs, align 4, !dbg !2599
  %mul12 = fmul float %conv11, %17, !dbg !2600
  %18 = load i32, i32* @RADAR_N, align 4, !dbg !2601
  %conv13 = uitofp i32 %18 to float, !dbg !2602
  %div14 = fdiv float %mul12, %conv13, !dbg !2603
  %conv15 = fpext float %div14 to double, !dbg !2604
  %mul16 = fmul double %conv15, 5.000000e-01, !dbg !2605
  %mul17 = fmul double %mul16, 3.000000e+08, !dbg !2606
  %19 = load float, float* @RADAR_alpha, align 4, !dbg !2607
  %conv18 = fpext float %19 to double, !dbg !2608
  %div19 = fdiv double %mul17, %conv18, !dbg !2609
  %conv20 = fptrunc double %div19 to float, !dbg !2604
  store float %conv20, float* %distance, align 4, !dbg !2597
  %20 = load float, float* %max_psd, align 4, !dbg !2610
  %21 = load float, float* @RADAR_psd_threshold, align 4, !dbg !2612
  %cmp21 = fcmp ogt float %20, %21, !dbg !2613
  br i1 %cmp21, label %if.then23, label %if.else, !dbg !2614

if.then23:                                        ; preds = %for.end
  %22 = load float, float* %distance, align 4, !dbg !2615
  store float %22, float* %retval, align 4, !dbg !2617
  br label %return, !dbg !2617

if.else:                                          ; preds = %for.end
  store float 0x7FF0000000000000, float* %retval, align 4, !dbg !2618
  br label %return, !dbg !2618

return:                                           ; preds = %if.else, %if.then23
  %23 = load float, float* %retval, align 4, !dbg !2620
  ret float %23, !dbg !2620
}
...
!2544 = !DILocation(line: 63, column: 3, scope: !2536)
!2545 = !DILocalVariable(name: "max_psd", scope: !2536, file: !659, line: 71, type: !56)
!2546 = !DILocation(line: 71, column: 9, scope: !2536)
!2547 = !DILocalVariable(name: "max_index", scope: !2536, file: !659, line: 72, type: !53)
!2548 = !DILocation(line: 72, column: 16, scope: !2536)
!2549 = !DILocalVariable(name: "i", scope: !2536, file: !659, line: 73, type: !53)
!2550 = !DILocation(line: 73, column: 16, scope: !2536)
!2551 = !DILocalVariable(name: "temp", scope: !2536, file: !659, line: 74, type: !56)
!2552 = !DILocation(line: 74, column: 9, scope: !2536)
!2553 = !DILocation(line: 76, column: 9, scope: !2554)
!2554 = distinct !DILexicalBlock(scope: !2536, file: !659, line: 76, column: 3)
!2555 = !DILocation(line: 76, column: 8, scope: !2554)
!2556 = !DILocation(line: 76, column: 13, scope: !2557)
!2557 = !DILexicalBlockFile(scope: !2558, file: !659, discriminator: 1)
!2558 = distinct !DILexicalBlock(scope: !2554, file: !659, line: 76, column: 3)
!2559 = !DILocation(line: 76, column: 17, scope: !2557)
!2560 = !DILocation(line: 76, column: 15, scope: !2557)
!2561 = !DILocation(line: 76, column: 3, scope: !2562)
!2562 = !DILexicalBlockFile(scope: !2554, file: !659, discriminator: 1)
!2563 = !DILocation(line: 78, column: 17, scope: !2564)
!2564 = distinct !DILexicalBlock(scope: !2558, file: !659, line: 76, column: 31)
!2565 = !DILocation(line: 78, column: 24, scope: !2564)
!2566 = !DILocation(line: 78, column: 23, scope: !2564)
!2567 = !DILocation(line: 78, column: 13, scope: !2564)
!2568 = !DILocation(line: 78, column: 36, scope: !2564)
!2569 = !DILocation(line: 78, column: 43, scope: !2564)
!2570 = !DILocation(line: 78, column: 42, scope: !2564)
!2571 = !DILocation(line: 78, column: 44, scope: !2564)
!2572 = !DILocation(line: 78, column: 32, scope: !2573)
!2573 = !DILexicalBlockFile(scope: !2564, file: !659, discriminator: 1)
!2574 = !DILocation(line: 78, column: 30, scope: !2564)
!2575 = !DILocation(line: 78, column: 51, scope: !2564)
!2576 = !DILocation(line: 78, column: 12, scope: !2564)
!2577 = !DILocation(line: 78, column: 10, scope: !2564)
!2578 = !DILocation(line: 79, column: 9, scope: !2579)
!2579 = distinct !DILexicalBlock(scope: !2564, file: !659, line: 79, column: 9)
!2580 = !DILocation(line: 79, column: 16, scope: !2579)
!2581 = !DILocation(line: 79, column: 14, scope: !2579)
!2582 = !DILocation(line: 79, column: 9, scope: !2564)
!2583 = !DILocation(line: 80, column: 17, scope: !2584)
!2584 = distinct !DILexicalBlock(scope: !2579, file: !659, line: 79, column: 25)
!2585 = !DILocation(line: 80, column: 15, scope: !2584)
!2586 = !DILocation(line: 81, column: 19, scope: !2584)
!2587 = !DILocation(line: 81, column: 17, scope: !2584)
!2588 = !DILocation(line: 82, column: 5, scope: !2584)
!2589 = !DILocation(line: 83, column: 3, scope: !2564)
!2590 = !DILocation(line: 76, column: 27, scope: !2591)
!2591 = !DILexicalBlockFile(scope: !2558, file: !659, discriminator: 2)
!2592 = !DILocation(line: 76, column: 3, scope: !2591)
!2593 = distinct !{!2593, !2594, !2595}
!2594 = !DILocation(line: 76, column: 3, scope: !2554)
!2595 = !DILocation(line: 83, column: 3, scope: !2554)
!2596 = !DILocalVariable(name: "distance", scope: !2536, file: !659, line: 84, type: !56)
!2597 = !DILocation(line: 84, column: 9, scope: !2536)
!2598 = !DILocation(line: 84, column: 29, scope: !2536)
!2599 = !DILocation(line: 84, column: 47, scope: !2536)
!2600 = !DILocation(line: 84, column: 38, scope: !2536)
!2601 = !DILocation(line: 84, column: 66, scope: !2536)
!2602 = !DILocation(line: 84, column: 58, scope: !2536)
!2603 = !DILocation(line: 84, column: 56, scope: !2536)
!2604 = !DILocation(line: 84, column: 20, scope: !2536)
!2605 = !DILocation(line: 84, column: 77, scope: !2536)
!2606 = !DILocation(line: 84, column: 81, scope: !2536)
!2607 = !DILocation(line: 84, column: 99, scope: !2536)
!2608 = !DILocation(line: 84, column: 90, scope: !2536)
!2609 = !DILocation(line: 84, column: 89, scope: !2536)
!2610 = !DILocation(line: 92, column: 7, scope: !2611)
!2611 = distinct !DILexicalBlock(scope: !2536, file: !659, line: 92, column: 7)
!2612 = !DILocation(line: 92, column: 17, scope: !2611)
!2613 = !DILocation(line: 92, column: 15, scope: !2611)
!2614 = !DILocation(line: 92, column: 7, scope: !2536)
!2615 = !DILocation(line: 93, column: 12, scope: !2616)
!2616 = distinct !DILexicalBlock(scope: !2611, file: !659, line: 92, column: 38)
!2617 = !DILocation(line: 93, column: 5, scope: !2616)
!2618 = !DILocation(line: 95, column: 5, scope: !2619)
!2619 = distinct !DILexicalBlock(scope: !2611, file: !659, line: 94, column: 10)
!2620 = !DILocation(line: 97, column: 1, scope: !2536)
