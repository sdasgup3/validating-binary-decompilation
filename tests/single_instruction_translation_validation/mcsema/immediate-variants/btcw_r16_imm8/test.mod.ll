...
define internal %struct.Memory* @_ZN12_GLOBAL__N_1L6BTCregI3RnWItE2RnItE2InItEEEP6MemoryS8_R5StateT_T0_T1_(%struct.Memory* readnone returned, %struct.State* nocapture dereferenceable(3376), i16* nocapture, i64, i64) #2 {
  %6 = and i64 %4, 15
  %7 = shl i64 1, %6
  %8 = xor i64 %7, %3
...
define %struct.Memory* @routine_btcw_r16_imm8(%struct.State*  dereferenceable(3376), i64, %struct.Memory* ) #19 {
block_530:
  ...
  %12 = add i64 %11, 5
  store i64 %12, i64* %PC
  %13 = call %struct.Memory* @_ZN12_GLOBAL__N_1L6BTCregI3RnWItE2RnItE2InItEEEP6MemoryS8_R5StateT_T0_T1_(%struct.Memory* %2, %struct.State* %0, i16* %BX, i64 %10, i64 10)
...
entry:
  ...
  %call = call %struct.Memory* @routine_btcw_r16_imm8(%struct.State* %state, i64 0, %struct.Memory* %mem)
  ret i32 0
}