...
define internal %struct.Memory* @_ZN12_GLOBAL__N_1L5BTregI2RnIjE2InIjEEEP6MemoryS6_R5StateT_T0_(%struct.Memory* readnone returned, %struct.State* nocapture dereferenceable(3376), i64, i64) #2 {
  %5 = and i64 %3, 31
  %6 = shl i64 1, %5
...
define %struct.Memory* @routine_btl_r32_imm8(%struct.State*  dereferenceable(3376), i64, %struct.Memory* ) #19 {
block_530:
  ...
  %12 = add i64 %11, 4
  store i64 %12, i64* %PC
  %13 = call %struct.Memory* @_ZN12_GLOBAL__N_1L5BTregI2RnIjE2InIjEEEP6MemoryS6_R5StateT_T0_(%struct.Memory* %2, %struct.State* %0, i64 %10, i64 10)
...
entry:
  ...
  %call = call %struct.Memory* @routine_btl_r32_imm8(%struct.State* %state, i64 0, %struct.Memory* %mem)
  ret i32 0
}