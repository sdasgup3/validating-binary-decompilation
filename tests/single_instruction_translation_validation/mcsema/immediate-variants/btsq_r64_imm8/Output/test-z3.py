...
xvar = (V_F == z3.Extract(0, 0, z3.LShR(VX_RBX, z3.BitVecVal(10, 64))))
...
lvar = (V_R == z3.Concat(z3.Extract(63, 56, ((z3.BitVecVal(1024, 64) | VL_RBX) & z3.BitVecVal(18446744073709551616 - 1, 64))), z3.Extract(55, 48, ((z3.BitVecVal(1024, 64) | VL_RBX) & z3.BitVecVal(18446744073709551616 - 1, 64))), z3.Extract(47, 40, ((z3.BitVecVal(1024, 64) | VL_RBX) & z3.BitVecVal(18446744073709551616 - 1, 64))), z3.Extract(39, 32, ((z3.BitVecVal(1024, 64) | VL_RBX) & z3.BitVecVal(18446744073709551616 - 1, 64))), z3.Extract(31, 24, ((z3.BitVecVal(1024, 64) | VL_RBX) & z3.BitVecVal(18446744073709551616 - 1, 64))), z3.Extract(23, 16, ((z3.BitVecVal(1024, 64) | VL_RBX) & z3.BitVecVal(18446744073709551616 - 1, 64))), z3.Extract(15, 8, ((z3.BitVecVal(1024, 64) | VL_RBX) & z3.BitVecVal(18446744073709551616 - 1, 64))), z3.Extract(7, 0, ((z3.BitVecVal(1024, 64) | VL_RBX) & z3.BitVecVal(18446744073709551616 - 1, 64)))))

xvar = (V_R == (VX_RBX | z3.BitVecVal(1024, 64)))
