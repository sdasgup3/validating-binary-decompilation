...
define %struct.Memory* @routine_movl_r32_imm32(%struct.State*  dereferenceable(3376), i64, %struct.Memory* ) #19 {
block_530:
  ...
  %10 = add i64 %9, 5
  store i64 %10, i64* %PC
  %11 = call %struct.Memory* @_ZN12_GLOBAL__N_1L3MOVI3RnWImE2InIjEEEP6MemoryS6_R5StateT_T0_(%struct.Memory* %2, %struct.State* %0, i64* %RBX, i64 10)
...
entry:
  ...
  %call = call %struct.Memory* @routine_movl_r32_imm32(%struct.State* %state, i64 0, %struct.Memory* %mem)
  ret i32 0
}