...
define internal %struct.Memory* @_ZN12_GLOBAL__N_1L5PSRLQI3VnWI8vec128_tE2VnIS2_E2InIhEEEP6MemoryS9_R5StateT_T0_T1_(%struct.Memory* readnone returned, %struct.State* nocapture readnone dereferenceable(3376), i8* nocapture, i8* nocapture readonly, i64) #0 {
  %6 = trunc i64 %4 to i8
  %7 = icmp ugt i8 %6, 63
  %8 = and i64 %4, 255
...
define %struct.Memory* @routine_psrlq_xmm_imm8(%struct.State*  dereferenceable(3376), i64, %struct.Memory* ) #19 {
block_530:
  ...
  %11 = add i64 %10, 5
  store i64 %11, i64* %PC
  %12 = call %struct.Memory* @_ZN12_GLOBAL__N_1L5PSRLQI3VnWI8vec128_tE2VnIS2_E2InIhEEEP6MemoryS9_R5StateT_T0_T1_(%struct.Memory* %2, %struct.State* %0, i8* %8, i8* %9, i64 10)
...
entry:
  ...
  %call = call %struct.Memory* @routine_psrlq_xmm_imm8(%struct.State* %state, i64 0, %struct.Memory* %mem)
  ret i32 0
}