...
define internal %struct.Memory* @_ZN12_GLOBAL__N_1L4SHLDI3RnWImE2RnIjES4_2InIjEEEP6MemoryS8_R5StateT_T0_T1_T2_(%struct.Memory* readnone, %struct.State* nocapture dereferenceable(3376), i64* nocapture, i64, i64, i64) #0 {
...
; <label>:10:                                     ; preds = %6
  ...
  %28 = and i32 %20, 255
  %29 = tail call i32 @my.ctpop.i32(i32 %28) #22
...
define %struct.Memory* @routine_shldl_r32_r32_imm8(%struct.State* noalias dereferenceable(3376), i64, %struct.Memory* noalias) #19 {
block_530:
  ...
  %16 = add i64 %15, 4
  store i64 %16, i64* %PC
  %17 = call %struct.Memory* @_ZN12_GLOBAL__N_1L4SHLDI3RnWImE2RnIjES4_2InIjEEEP6MemoryS8_R5StateT_T0_T1_T2_(%struct.Memory* %2, %struct.State* %0, i64* %RBX, i64 %12, i64 %14, i64 10)
...
entry:
  ...
  %call = call %struct.Memory* @routine_shldl_r32_r32_imm8(%struct.State* %state, i64 0, %struct.Memory* %mem)
  ret i32 0
}