...
define %struct.Memory* @routine_shlw_r16_imm8(%struct.State* noalias dereferenceable(3376), i64, %struct.Memory* noalias) #19 {
block_530:
  ...
  %12 = add i64 %11, 4
  store i64 %12, i64* %PC
  %13 = call %struct.Memory* @_ZN12_GLOBAL__N_1L3SHLI3RnWItE2RnItE2InItEEEP6MemoryS8_R5StateT_T0_T1_(%struct.Memory* %2, %struct.State* %0, i16* %BX, i64 %10, i64 10)
...
entry:
  ...
  %call = call %struct.Memory* @routine_shlw_r16_imm8(%struct.State* %state, i64 0, %struct.Memory* %mem)
  ret i32 0
}