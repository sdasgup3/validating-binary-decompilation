...
define internal %struct.Memory* @_ZN12_GLOBAL__N_1L4TESTI2RnImE2InImEEEP6MemoryS6_R5StateT_T0_(%struct.Memory* readnone returned, %struct.State* nocapture dereferenceable(3376), i64, i64) #0 {
  %5 = and i64 %3, %2
...
define %struct.Memory* @routine_testq_r64_imm32(%struct.State*  dereferenceable(3376), i64, %struct.Memory* ) #19 {
block_530:
  ...
  %11 = add i64 %10, 7
  store i64 %11, i64* %PC
  %12 = call %struct.Memory* @_ZN12_GLOBAL__N_1L4TESTI2RnImE2InImEEEP6MemoryS6_R5StateT_T0_(%struct.Memory* %2, %struct.State* %0, i64 %9, i64 10)
...
entry:
  ...
  %call = call %struct.Memory* @routine_testq_r64_imm32(%struct.State* %state, i64 0, %struct.Memory* %mem)
  ret i32 0
}