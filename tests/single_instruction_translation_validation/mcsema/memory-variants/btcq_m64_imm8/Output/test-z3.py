...
lvar = (V_M64 == z3.Concat(z3.Extract(63, 56, ((VL_MEM_64 ^ z3.BitVecVal(1024, 64)) & z3.BitVecVal(18446744073709551616 - 1, 64))), z3.Extract(55, 48, ((VL_MEM_64 ^ z3.BitVecVal(1024, 64)) & z3.BitVecVal(18446744073709551616 - 1, 64))), z3.Extract(47, 40, ((VL_MEM_64 ^ z3.BitVecVal(1024, 64)) & z3.BitVecVal(18446744073709551616 - 1, 64))), z3.Extract(39, 32, ((VL_MEM_64 ^ z3.BitVecVal(1024, 64)) & z3.BitVecVal(18446744073709551616 - 1, 64))), z3.Extract(31, 24, ((VL_MEM_64 ^ z3.BitVecVal(1024, 64)) & z3.BitVecVal(18446744073709551616 - 1, 64))), z3.Extract(23, 16, ((VL_MEM_64 ^ z3.BitVecVal(1024, 64)) & z3.BitVecVal(18446744073709551616 - 1, 64))), z3.Extract(15, 8, ((VL_MEM_64 ^ z3.BitVecVal(1024, 64)) & z3.BitVecVal(18446744073709551616 - 1, 64))), z3.Extract(7, 0, ((VL_MEM_64 ^ z3.BitVecVal(1024, 64)) & z3.BitVecVal(18446744073709551616 - 1, 64)))))

xvar = (V_M64 == z3.Concat(z3.Extract(63, 56, VX_MEM_64), z3.Extract(55, 48, VX_MEM_64), z3.Extract(47, 40, VX_MEM_64), z3.Extract(39, 32, VX_MEM_64), z3.Extract(31, 24, VX_MEM_64), z3.Extract(23, 16, VX_MEM_64), z3.Extract(7, 0, (z3.Extract(15, 8, VX_MEM_64) ^ z3.BitVecVal(4, 8))), z3.Extract(7, 0, VX_MEM_64)))
