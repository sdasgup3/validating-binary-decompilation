...
lvar = (V_F == z3.Extract(0, 0, z3.Extract(7, 0, z3.Concat(z3.BitVecVal(0, 7), z3.Extract(0, 0, z3.If(z3.Not((((z3.Concat(z3.Extract(31, 24, VL_MEM_32),z3.Extract(23, 16, VL_MEM_32),z3.Extract(15, 8, VL_MEM_32),z3.Extract(7, 0, VL_MEM_32),) & z3.BitVecVal(1024, 32)) & z3.BitVecVal(4294967296 - 1, 32)) == z3.BitVecVal(0, 32))), z3.BitVecVal(1, 8), z3.BitVecVal(0, 8)))))))

xvar = (V_F == z3.Extract(0, 0, z3.LShR(z3.Extract(15, 8, VX_MEM_32), z3.BitVecVal(2, 8))))
...
lvar = (V_M32 == z3.Concat(z3.Extract(31, 24, ((z3.Concat(z3.Extract(31, 24, VL_MEM_32),z3.Extract(23, 16, VL_MEM_32),z3.Extract(15, 8, VL_MEM_32),z3.Extract(7, 0, VL_MEM_32),) & z3.BitVecVal(4294966271, 32)) & z3.BitVecVal(4294967296 - 1, 32))), z3.Extract(23, 16, ((z3.Concat(z3.Extract(31, 24, VL_MEM_32),z3.Extract(23, 16, VL_MEM_32),z3.Extract(15, 8, VL_MEM_32),z3.Extract(7, 0, VL_MEM_32),) & z3.BitVecVal(4294966271, 32)) & z3.BitVecVal(4294967296 - 1, 32))), z3.Extract(15, 8, ((z3.Concat(z3.Extract(31, 24, VL_MEM_32),z3.Extract(23, 16, VL_MEM_32),z3.Extract(15, 8, VL_MEM_32),z3.Extract(7, 0, VL_MEM_32),) & z3.BitVecVal(4294966271, 32)) & z3.BitVecVal(4294967296 - 1, 32))), z3.Extract(7, 0, ((z3.Concat(z3.Extract(31, 24, VL_MEM_32),z3.Extract(23, 16, VL_MEM_32),z3.Extract(15, 8, VL_MEM_32),z3.Extract(7, 0, VL_MEM_32),) & z3.BitVecVal(4294966271, 32)) & z3.BitVecVal(4294967296 - 1, 32)))))

xvar = (V_M32 == z3.Concat(z3.Extract(31, 24, VX_MEM_32), z3.Extract(23, 16, VX_MEM_32), z3.Extract(7, 0, (z3.Extract(15, 8, VX_MEM_32) & z3.BitVecVal(-5, 8))), z3.Extract(7, 0, VX_MEM_32)))
