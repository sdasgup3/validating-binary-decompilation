...
lvar = (V_M16 == z3.Concat(z3.Extract(15, 8, ((z3.Concat(z3.Extract(15, 8, VL_MEM_16),z3.Extract(7, 0, VL_MEM_16),) & z3.BitVecVal(64511, 16)) & z3.BitVecVal(65536 - 1, 16))), z3.Extract(7, 0, ((z3.Concat(z3.Extract(15, 8, VL_MEM_16),z3.Extract(7, 0, VL_MEM_16),) & z3.BitVecVal(64511, 16)) & z3.BitVecVal(65536 - 1, 16)))))

xvar = (V_M16 == z3.Concat(z3.Extract(7, 0, (z3.Extract(15, 8, VX_MEM_16) & z3.BitVecVal(-5, 8))), z3.Extract(7, 0, VX_MEM_16)))
