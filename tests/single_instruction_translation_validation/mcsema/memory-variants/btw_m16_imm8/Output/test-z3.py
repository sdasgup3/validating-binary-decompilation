...
lvar = (V_F == z3.Extract(0, 0, z3.Extract(7, 0, z3.Concat(z3.BitVecVal(0, 7), z3.Extract(0, 0, z3.If(z3.Not((((z3.Concat(z3.Extract(15, 8, VL_MEM_16),z3.Extract(7, 0, VL_MEM_16),) & z3.BitVecVal(1024, 16)) & z3.BitVecVal(65536 - 1, 16)) == z3.BitVecVal(0, 16))), z3.BitVecVal(1, 8), z3.BitVecVal(0, 8)))))))

xvar = (V_F == z3.Extract(0, 0, z3.LShR(z3.Extract(15, 8, VX_MEM_16), z3.BitVecVal(2, 8))))
...
lvar = (V_M16 == z3.Concat(z3.Extract(15, 8, z3.Concat(z3.BitVecVal(0, 48), VL_MEM_16)), z3.Extract(7, 0, z3.Concat(z3.BitVecVal(0, 48), VL_MEM_16))))
