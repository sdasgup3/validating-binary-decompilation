...
lvar = z3.And(
	...
	z3.Implies(
		(z3.If(z3.Not((VL_ZF == z3.BitVecVal(0, 8))), z3.BitVecVal(1, 8), z3.BitVecVal(0, 8)) == z3.BitVecVal(0, 8)),
		V_F == z3.Extract(0, 0, z3.Extract(7, 0, VL_AF))
	), 
	z3.Implies(
		((z3.If(z3.Not((VL_ZF == z3.BitVecVal(0, 8))), z3.BitVecVal(1, 8), z3.BitVecVal(0, 8)) == z3.BitVecVal(0, 8)) == False),
		V_F == z3.Extract(0, 0, z3.Extract(7, 0, VL_AF))
	), 
)
...
lvar = z3.And(
(V_M16 == z3.Concat(z3.Extract(15, 8, z3.Concat(z3.BitVecVal(0, 48), VL_MEM_16)), z3.Extract(7, 0, z3.Concat(z3.BitVecVal(0, 48), VL_MEM_16))))
)

xvar = (V_M16 == z3.Concat(z3.Extract(15, 8, VX_MEM_16), z3.Extract(7, 0, VX_MEM_16)))
...
lvar = z3.And(
	...
	z3.Implies(
		((z3.If(z3.Not((VL_ZF == z3.BitVecVal(0, 8))), z3.BitVecVal(1, 8), z3.BitVecVal(0, 8)) == z3.BitVecVal(0, 8)) == False), 
		V_R == z3.Concat(z3.Extract(63, 56, VL_RBX), z3.Extract(55, 48, VL_RBX), z3.Extract(47, 40, VL_RBX), z3.Extract(39, 32, VL_RBX), z3.Extract(31, 24, VL_RBX), z3.Extract(23, 16, VL_RBX), z3.Extract(15, 8, z3.Concat(z3.Extract(15, 8, VL_MEM_16),z3.Extract(7, 0, VL_MEM_16),)), z3.Extract(7, 0, z3.Concat(z3.Extract(15, 8, VL_MEM_16),z3.Extract(7, 0, VL_MEM_16),)))
	), 
)

xvar = (V_R == z3.Concat(z3.Extract(63, 16, VX_RBX), z3.If((VX_ZF == z3.BitVecVal(1, 1)), VX_MEM_16, z3.Extract(15, 0, VX_RBX))))
