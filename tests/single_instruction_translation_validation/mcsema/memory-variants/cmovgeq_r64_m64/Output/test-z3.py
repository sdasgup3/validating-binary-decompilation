...
lvar = z3.And(
(V_M64 == z3.Concat(z3.Extract(63, 56, VL_MEM_64), z3.Extract(55, 48, VL_MEM_64), z3.Extract(47, 40, VL_MEM_64), z3.Extract(39, 32, VL_MEM_64), z3.Extract(31, 24, VL_MEM_64), z3.Extract(23, 16, VL_MEM_64), z3.Extract(15, 8, VL_MEM_64), z3.Extract(7, 0, VL_MEM_64)))
)
...
lvar = z3.And(
	...
	z3.Implies(
		(((z3.If(z3.Not((VL_SF == z3.BitVecVal(0, 8))), z3.BitVecVal(1, 8), z3.BitVecVal(0, 8)) ^ z3.If(z3.Not((VL_OF == z3.BitVecVal(0, 8))), z3.BitVecVal(1, 8), z3.BitVecVal(0, 8))) & z3.BitVecVal(2 - 1, 8)) == z3.BitVecVal(0, 8)), 
		V_R == z3.Concat(z3.Extract(63, 56, VL_MEM_64), z3.Extract(55, 48, VL_MEM_64), z3.Extract(47, 40, VL_MEM_64), z3.Extract(39, 32, VL_MEM_64), z3.Extract(31, 24, VL_MEM_64), z3.Extract(23, 16, VL_MEM_64), z3.Extract(15, 8, VL_MEM_64), z3.Extract(7, 0, VL_MEM_64))
	), 
	z3.Implies(
		((((z3.If(z3.Not((VL_SF == z3.BitVecVal(0, 8))), z3.BitVecVal(1, 8), z3.BitVecVal(0, 8)) ^ z3.If(z3.Not((VL_OF == z3.BitVecVal(0, 8))), z3.BitVecVal(1, 8), z3.BitVecVal(0, 8))) & z3.BitVecVal(2 - 1, 8)) == z3.BitVecVal(0, 8)) == False), 
...
xvar = (V_R == z3.If(((VX_SF == z3.BitVecVal(1, 1)) == (VX_OF == z3.BitVecVal(1, 1))), VX_MEM_64, VX_RBX))
