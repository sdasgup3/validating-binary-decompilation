...
lvar = z3.And(
	...
	z3.Implies(
		(((z3.If(z3.Not((VL_SF == z3.BitVecVal(0, 8))), z3.BitVecVal(1, 8), z3.BitVecVal(0, 8)) ^ z3.If(z3.Not((VL_OF == z3.BitVecVal(0, 8))), z3.BitVecVal(1, 8), z3.BitVecVal(0, 8))) & z3.BitVecVal(2 - 1, 8)) == z3.BitVecVal(0, 8)),
		V_F == z3.Extract(0, 0, z3.Extract(7, 0, VL_AF))
	), 
	z3.Implies(
		((((z3.If(z3.Not((VL_SF == z3.BitVecVal(0, 8))), z3.BitVecVal(1, 8), z3.BitVecVal(0, 8)) ^ z3.If(z3.Not((VL_OF == z3.BitVecVal(0, 8))), z3.BitVecVal(1, 8), z3.BitVecVal(0, 8))) & z3.BitVecVal(2 - 1, 8)) == z3.BitVecVal(0, 8)) == False),
		V_F == z3.Extract(0, 0, z3.Extract(7, 0, VL_AF))
	), 
)
...
lvar = z3.And(
(V_M32 == z3.Concat(z3.Extract(31, 24, z3.Concat(z3.BitVecVal(0, 32), VL_MEM_32)), z3.Extract(23, 16, z3.Concat(z3.BitVecVal(0, 32), VL_MEM_32)), z3.Extract(15, 8, z3.Concat(z3.BitVecVal(0, 32), VL_MEM_32)), z3.Extract(7, 0, z3.Concat(z3.BitVecVal(0, 32), VL_MEM_32))))
)
...
lvar = z3.And(
	...
	z3.Implies(
		(((z3.If(z3.Not((VL_SF == z3.BitVecVal(0, 8))), z3.BitVecVal(1, 8), z3.BitVecVal(0, 8)) ^ z3.If(z3.Not((VL_OF == z3.BitVecVal(0, 8))), z3.BitVecVal(1, 8), z3.BitVecVal(0, 8))) & z3.BitVecVal(2 - 1, 8)) == z3.BitVecVal(0, 8)), 
		V_R == z3.Concat(z3.Extract(63, 56, z3.Concat(z3.BitVecVal(0, 32), z3.Extract(31, 0, (VL_RBX & z3.BitVecVal(4294967296 - 1, 64))))), z3.Extract(55, 48, z3.Concat(z3.BitVecVal(0, 32), z3.Extract(31, 0, (VL_RBX & z3.BitVecVal(4294967296 - 1, 64))))), z3.Extract(47, 40, z3.Concat(z3.BitVecVal(0, 32), z3.Extract(31, 0, (VL_RBX & z3.BitVecVal(4294967296 - 1, 64))))), z3.Extract(39, 32, z3.Concat(z3.BitVecVal(0, 32), z3.Extract(31, 0, (VL_RBX & z3.BitVecVal(4294967296 - 1, 64))))), z3.Extract(31, 24, z3.Concat(z3.BitVecVal(0, 32), z3.Extract(31, 0, (VL_RBX & z3.BitVecVal(4294967296 - 1, 64))))), z3.Extract(23, 16, z3.Concat(z3.BitVecVal(0, 32), z3.Extract(31, 0, (VL_RBX & z3.BitVecVal(4294967296 - 1, 64))))), z3.Extract(15, 8, z3.Concat(z3.BitVecVal(0, 32), z3.Extract(31, 0, (VL_RBX & z3.BitVecVal(4294967296 - 1, 64))))), z3.Extract(7, 0, z3.Concat(z3.BitVecVal(0, 32), z3.Extract(31, 0, (VL_RBX & z3.BitVecVal(4294967296 - 1, 64))))))
	), 
	z3.Implies(
		((((z3.If(z3.Not((VL_SF == z3.BitVecVal(0, 8))), z3.BitVecVal(1, 8), z3.BitVecVal(0, 8)) ^ z3.If(z3.Not((VL_OF == z3.BitVecVal(0, 8))), z3.BitVecVal(1, 8), z3.BitVecVal(0, 8))) & z3.BitVecVal(2 - 1, 8)) == z3.BitVecVal(0, 8)) == False), 
		V_R == z3.Concat(z3.Extract(63, 56, z3.Concat(z3.BitVecVal(0, 32), z3.Concat(z3.Extract(31, 24, VL_MEM_32),z3.Extract(23, 16, VL_MEM_32),z3.Extract(15, 8, VL_MEM_32),z3.Extract(7, 0, VL_MEM_32),))), z3.Extract(55, 48, z3.Concat(z3.BitVecVal(0, 32), z3.Concat(z3.Extract(31, 24, VL_MEM_32),z3.Extract(23, 16, VL_MEM_32),z3.Extract(15, 8, VL_MEM_32),z3.Extract(7, 0, VL_MEM_32),))), z3.Extract(47, 40, z3.Concat(z3.BitVecVal(0, 32), z3.Concat(z3.Extract(31, 24, VL_MEM_32),z3.Extract(23, 16, VL_MEM_32),z3.Extract(15, 8, VL_MEM_32),z3.Extract(7, 0, VL_MEM_32),))), z3.Extract(39, 32, z3.Concat(z3.BitVecVal(0, 32), z3.Concat(z3.Extract(31, 24, VL_MEM_32),z3.Extract(23, 16, VL_MEM_32),z3.Extract(15, 8, VL_MEM_32),z3.Extract(7, 0, VL_MEM_32),))), z3.Extract(31, 24, z3.Concat(z3.BitVecVal(0, 32), z3.Concat(z3.Extract(31, 24, VL_MEM_32),z3.Extract(23, 16, VL_MEM_32),z3.Extract(15, 8, VL_MEM_32),z3.Extract(7, 0, VL_MEM_32),))), z3.Extract(23, 16, z3.Concat(z3.BitVecVal(0, 32), z3.Concat(z3.Extract(31, 24, VL_MEM_32),z3.Extract(23, 16, VL_MEM_32),z3.Extract(15, 8, VL_MEM_32),z3.Extract(7, 0, VL_MEM_32),))), z3.Extract(15, 8, z3.Concat(z3.BitVecVal(0, 32), z3.Concat(z3.Extract(31, 24, VL_MEM_32),z3.Extract(23, 16, VL_MEM_32),z3.Extract(15, 8, VL_MEM_32),z3.Extract(7, 0, VL_MEM_32),))), z3.Extract(7, 0, z3.Concat(z3.BitVecVal(0, 32), z3.Concat(z3.Extract(31, 24, VL_MEM_32),z3.Extract(23, 16, VL_MEM_32),z3.Extract(15, 8, VL_MEM_32),z3.Extract(7, 0, VL_MEM_32),))))
	), 
)

xvar = (V_R == z3.Concat(z3.BitVecVal(0, 32), z3.If(z3.Not(((VX_SF == z3.BitVecVal(1, 1)) == (VX_OF == z3.BitVecVal(1, 1)))), VX_MEM_32, z3.Extract(31, 0, VX_RBX))))
