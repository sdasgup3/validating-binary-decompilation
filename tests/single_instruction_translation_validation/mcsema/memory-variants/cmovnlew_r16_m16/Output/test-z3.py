...
xvar = (V_R == z3.Concat(z3.Extract(63, 16, VX_RBX), z3.If(z3.And(z3.Not((VX_ZF == z3.BitVecVal(1, 1))), ((VX_SF == z3.BitVecVal(1, 1)) == (VX_OF == z3.BitVecVal(1, 1)))), VX_MEM_16, z3.Extract(15, 0, VX_RBX))))
