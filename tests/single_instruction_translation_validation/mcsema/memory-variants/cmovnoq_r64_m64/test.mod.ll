...
define internal %struct.Memory* @_ZN12_GLOBAL__N_1L6CMOVNOI3RnWImE2MnImEEEP6MemoryS6_R5StateT_T0_(%struct.Memory* returned, %struct.State* nocapture readonly dereferenceable(3376), i64* nocapture, i64) #0 {
...
define %struct.Memory* @routine_cmovnoq_r64_m64(%struct.State*  dereferenceable(3376), i64, %struct.Memory* ) #19 {
block_530:
  ...
  %15 = add i64 %14, 5
  store i64 %15, i64* %PC
  %16 = call %struct.Memory* @_ZN12_GLOBAL__N_1L6CMOVNOI3RnWImE2MnImEEEP6MemoryS6_R5StateT_T0_(%struct.Memory* %2, %struct.State* %0, i64* %RBX, i64 %13)
...
entry:
  ...
  %call = call %struct.Memory* @routine_cmovnoq_r64_m64(%struct.State* %state, i64 0, %struct.Memory* %mem)
  ret i32 0
}