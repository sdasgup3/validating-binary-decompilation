...
define %struct.Memory* @routine_cmovzl_r32_m32(%struct.State*  dereferenceable(3376), i64, %struct.Memory* ) #19 {
block_530:
...
entry:
  ...
  %call = call %struct.Memory* @routine_cmovzl_r32_m32(%struct.State* %state, i64 0, %struct.Memory* %mem)
  ret i32 0
}