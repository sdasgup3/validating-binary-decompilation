...
define internal %struct.Memory* @_ZN12_GLOBAL__N_1L10CMPXCHG_ALI3MnWIhE2MnIhE2RnIhEEEP6MemoryS8_R5StateT_T0_T1_(%struct.Memory*, %struct.State* nocapture dereferenceable(3376), i64, i64, i64) #0 {
  %6 = alloca i8, align 1
  %7 = trunc i64 %4 to i8
  call void @my.lifetime.start(i64 1, i8* nonnull %6) #22
  ...
  call void @my.lifetime.end(i64 1, i8* nonnull %6) #22
  ret %struct.Memory* %11
}

define %struct.Memory* @routine_cmpxchgb_m8_rh(%struct.State*  dereferenceable(3376), i64, %struct.Memory* ) #19 {
block_530:
  ...
  %21 = add i64 %20, 4
  store i64 %21, i64* %PC
  %22 = call %struct.Memory* @_ZN12_GLOBAL__N_1L10CMPXCHG_ALI3MnWIhE2MnIhE2RnIhEEEP6MemoryS8_R5StateT_T0_T1_(%struct.Memory* %13, %struct.State* %0, i64 %15, i64 %17, i64 %19)
...
entry:
  ...
  %call = call %struct.Memory* @routine_cmpxchgb_m8_rh(%struct.State* %state, i64 0, %struct.Memory* %mem)
  ret i32 0
}