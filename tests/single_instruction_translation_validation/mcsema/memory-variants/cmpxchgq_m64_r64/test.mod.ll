...
define internal %struct.Memory* @_ZN12_GLOBAL__N_1L11CMPXCHG_RAXI3MnWImE2MnImE2RnImEEEP6MemoryS8_R5StateT_T0_T1_(%struct.Memory*, %struct.State* nocapture dereferenceable(3376), i64, i64, i64) #0 {
  %6 = alloca i64, align 8
  %7 = bitcast i64* %6 to i8*
  call void @my.lifetime.start(i64 8, i8* nonnull %7) #22
  %8 = getelementptr inbounds %struct.State, %struct.State* %1, i64 0, i32 6, i32 1, i32 0, i32 0
  %9 = load i64, i64* %8, align 8
  store i64 %9, i64* %6, align 8
  %10 = call %struct.Memory* @__remill_compare_exchange_memory_64(%struct.Memory* %0, i64 %2, i64* nonnull dereferenceable(8) %6, i64 %4) #24
  ...
  %19 = and i32 %18, 255
  %20 = call i32 @my.ctpop.i32(i32 %19) #22
  ...
  call void @my.lifetime.end(i64 8, i8* nonnull %7) #22
  ret %struct.Memory* %10
}

define %struct.Memory* @routine_cmpxchgq_m64_r64(%struct.State*  dereferenceable(3376), i64, %struct.Memory* ) #19 {
block_530:
  ...
  %12 = call %struct.Memory* @__remill_atomic_begin(%struct.Memory* %2)
  %13 = load i64, i64* %RBP
  %14 = sub i64 %13, 32
  %15 = load i64, i64* %RBP
  %16 = sub i64 %15, 32
  ...
  %19 = add i64 %18, 5
  store i64 %19, i64* %PC
  %20 = call %struct.Memory* @_ZN12_GLOBAL__N_1L11CMPXCHG_RAXI3MnWImE2MnImE2RnImEEEP6MemoryS8_R5StateT_T0_T1_(%struct.Memory* %12, %struct.State* %0, i64 %14, i64 %16, i64 %17)
  %21 = call %struct.Memory* @__remill_atomic_end(%struct.Memory* %20)
...
entry:
  ...
  %call = call %struct.Memory* @routine_cmpxchgq_m64_r64(%struct.State* %state, i64 0, %struct.Memory* %mem)
  ret i32 0
}