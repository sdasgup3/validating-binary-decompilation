...
lvar = (V_R == z3.Concat(z3.Extract(63, 56, VL_RAX), z3.Extract(55, 48, VL_RAX), z3.Extract(47, 40, VL_RAX), z3.Extract(39, 32, VL_RAX), z3.Extract(31, 24, VL_RAX), z3.Extract(23, 16, VL_RAX), z3.Extract(7, 0, z3.Extract(7, 0, VL_MEM_8)), z3.Extract(7, 0, VL_RAX)))

xvar = (V_R == z3.Concat(z3.Concat(z3.Extract(63, 16, VX_RAX), VX_MEM_8), z3.Extract(7, 0, VX_RAX)))
