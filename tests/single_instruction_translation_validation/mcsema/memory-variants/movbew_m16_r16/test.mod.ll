...
define internal %struct.Memory* @_ZN12_GLOBAL__N_1L17HandleUnsupportedEP6MemoryR5State(%struct.Memory*, %struct.State* dereferenceable(3376)) #0 {
  %3 = tail call %struct.Memory* @__remill_sync_hyper_call(%struct.State* nonnull dereferenceable(3376) %1, %struct.Memory* %0, i32 257) #21
  ret %struct.Memory* %3
}

define %struct.Memory* @routine_movbew_m16_r16(%struct.State*  dereferenceable(3376), i64, %struct.Memory* ) #19 {
block_530:
  ...
  %7 = add i64 %6, 6
  store i64 %7, i64* %PC
  %8 = call %struct.Memory* @_ZN12_GLOBAL__N_1L17HandleUnsupportedEP6MemoryR5State(%struct.Memory* %2, %struct.State* %0)
  ret %struct.Memory* %8
}
...
entry:
  ...
  %call = call %struct.Memory* @routine_movbew_m16_r16(%struct.State* %state, i64 0, %struct.Memory* %mem)
  ret i32 0
}