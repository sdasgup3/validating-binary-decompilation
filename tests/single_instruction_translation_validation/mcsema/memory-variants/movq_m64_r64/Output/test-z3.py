...
lvar = (V_M64 == z3.Concat(z3.Extract(63, 56, VL_RCX), z3.Extract(55, 48, VL_RCX), z3.Extract(47, 40, VL_RCX), z3.Extract(39, 32, VL_RCX), z3.Extract(31, 24, VL_RCX), z3.Extract(23, 16, VL_RCX), z3.Extract(15, 8, VL_RCX), z3.Extract(7, 0, VL_RCX)))

xvar = (V_M64 == z3.Concat(z3.Extract(63, 56, VX_RCX), z3.Extract(55, 48, VX_RCX), z3.Extract(47, 40, VX_RCX), z3.Extract(39, 32, VX_RCX), z3.Extract(31, 24, VX_RCX), z3.Extract(23, 16, VX_RCX), z3.Extract(15, 8, VX_RCX), z3.Extract(7, 0, VX_RCX)))
