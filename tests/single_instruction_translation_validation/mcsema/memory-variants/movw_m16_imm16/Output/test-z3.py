...
lvar = (V_M16 == z3.Concat(z3.Extract(15, 8, z3.Concat(z3.BitVecVal(0, 8), z3.BitVecVal(10, 8))), z3.Extract(7, 0, z3.Concat(z3.BitVecVal(0, 8), z3.BitVecVal(10, 8)))))

xvar = (V_M16 == z3.Concat(z3.Extract(15, 8, z3.BitVecVal(10, 16)), z3.Extract(7, 0, z3.BitVecVal(10, 16))))
