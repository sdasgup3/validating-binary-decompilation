...
define %struct.Memory* @routine_mulxq_r64_r64_m64(%struct.State*  dereferenceable(3376), i64, %struct.Memory* ) #19 {
block_530:
  ...
  %18 = add i64 %17, 6
  store i64 %18, i64* %PC
  %19 = call %struct.Memory* @_ZN12_GLOBAL__N_1L4MULXI3RnWImE2MnImEEEP6MemoryS6_R5StateT_S9_T0_(%struct.Memory* %2, %struct.State* %0, i64* %RBX, i64* %RCX, i64 %16)
