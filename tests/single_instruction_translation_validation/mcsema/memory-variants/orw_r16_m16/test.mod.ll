...
define internal %struct.Memory* @_ZN12_GLOBAL__N_1L2ORI3RnWItE2RnItE2MnItEEEP6MemoryS8_R5StateT_T0_T1_(%struct.Memory*, %struct.State* nocapture dereferenceable(3376), i16* nocapture, i64, i64) #0 {
...
define %struct.Memory* @routine_orw_r16_m16(%struct.State*  dereferenceable(3376), i64, %struct.Memory* ) #19 {
block_530:
  ...
  %17 = add i64 %16, 4
  store i64 %17, i64* %PC
  %18 = call %struct.Memory* @_ZN12_GLOBAL__N_1L2ORI3RnWItE2RnItE2MnItEEEP6MemoryS8_R5StateT_T0_T1_(%struct.Memory* %2, %struct.State* %0, i16* %BX, i64 %13, i64 %15)
...
entry:
  ...
  %call = call %struct.Memory* @routine_orw_r16_m16(%struct.State* %state, i64 0, %struct.Memory* %mem)
  ret i32 0
}