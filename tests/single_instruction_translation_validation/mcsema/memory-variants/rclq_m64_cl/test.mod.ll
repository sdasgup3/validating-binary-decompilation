...
define internal %struct.Memory* @_ZN12_GLOBAL__N_1L3RCLI3MnWImE2MnImE2RnImEEEP6MemoryS8_R5StateT_T0_T1_(%struct.Memory*, %struct.State* nocapture dereferenceable(3376), i64, i64, i64) #0 {
...
define %struct.Memory* @routine_rclq_m64_cl(%struct.State*  dereferenceable(3376), i64, %struct.Memory* ) #19 {
block_530:
  ...
  %20 = add i64 %19, 4
  store i64 %20, i64* %PC
  %21 = call %struct.Memory* @_ZN12_GLOBAL__N_1L3RCLI3MnWImE2MnImE2RnImEEEP6MemoryS8_R5StateT_T0_T1_(%struct.Memory* %2, %struct.State* %0, i64 %14, i64 %16, i64 %18)
...
entry:
  ...
  %call = call %struct.Memory* @routine_rclq_m64_cl(%struct.State* %state, i64 0, %struct.Memory* %mem)
  ret i32 0
}