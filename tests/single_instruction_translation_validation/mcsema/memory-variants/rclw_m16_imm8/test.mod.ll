...
define %struct.Memory* @routine_rclw_m16_imm8(%struct.State*  dereferenceable(3376), i64, %struct.Memory* ) #19 {
block_530:
  ...
  %14 = add i64 %13, 5
  store i64 %14, i64* %PC
  %15 = call %struct.Memory* @_ZN12_GLOBAL__N_1L3RCLI3MnWItE2MnItE2InItEEEP6MemoryS8_R5StateT_T0_T1_(%struct.Memory* %2, %struct.State* %0, i64 %10, i64 %12, i64 10)
...
entry:
  ...
  %call = call %struct.Memory* @routine_rclw_m16_imm8(%struct.State* %state, i64 0, %struct.Memory* %mem)
  ret i32 0
}