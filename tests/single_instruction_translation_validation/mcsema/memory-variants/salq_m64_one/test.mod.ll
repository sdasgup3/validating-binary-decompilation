...
define %struct.Memory* @routine_salq_m64_one(%struct.State* noalias dereferenceable(3376), i64, %struct.Memory* noalias) #19 {
block_530:
  ...
  %14 = add i64 %13, 4
  store i64 %14, i64* %PC
  %15 = call %struct.Memory* @_ZN12_GLOBAL__N_1L3SHLI3MnWImE2MnImE2InImEEEP6MemoryS8_R5StateT_T0_T1_(%struct.Memory* %2, %struct.State* %0, i64 %10, i64 %12, i64 1)
...
entry:
  ...
  %call = call %struct.Memory* @routine_salq_m64_one(%struct.State* %state, i64 0, %struct.Memory* %mem)
  ret i32 0
}