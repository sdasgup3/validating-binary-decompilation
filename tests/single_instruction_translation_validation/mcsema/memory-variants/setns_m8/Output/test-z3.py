...
lvar = (V_M8 == z3.Extract(7, 0, z3.Concat(z3.BitVecVal(0, 7), z3.Extract(0, 0, z3.If((VL_SF == z3.BitVecVal(0, 8)), z3.BitVecVal(1, 8), z3.BitVecVal(0, 8))))))

xvar = (V_M8 == z3.Extract(7, 0, z3.If(z3.Not((VX_SF == z3.BitVecVal(1, 1))), z3.BitVecVal(1, 8), z3.BitVecVal(0, 8))))
