...
define internal %struct.Memory* @_ZN12_GLOBAL__N_1L3SHLI3MnWIjE2MnIjE2InIjEEEP6MemoryS8_R5StateT_T0_T1_(%struct.Memory*, %struct.State* nocapture dereferenceable(3376), i64, i64, i64) #0 {
...
; <label>:24:                                     ; preds = %14, %9
  ...
  %32 = and i32 %27, 254
  %33 = tail call i32 @my.ctpop.i32(i32 %32) #22
...
define %struct.Memory* @routine_shll_m32_imm8(%struct.State* noalias dereferenceable(3376), i64, %struct.Memory* noalias) #19 {
block_530:
  ...
  %14 = add i64 %13, 4
  store i64 %14, i64* %PC
  %15 = call %struct.Memory* @_ZN12_GLOBAL__N_1L3SHLI3MnWIjE2MnIjE2InIjEEEP6MemoryS8_R5StateT_T0_T1_(%struct.Memory* %2, %struct.State* %0, i64 %10, i64 %12, i64 10)
...
entry:
  ...
  %call = call %struct.Memory* @routine_shll_m32_imm8(%struct.State* %state, i64 0, %struct.Memory* %mem)
  ret i32 0
}