...
define internal %struct.Memory* @_ZN12_GLOBAL__N_1L4SHRDI3MnWImE2MnImE2RnImE2InImEEEP6MemorySA_R5StateT_T0_T1_T2_(%struct.Memory*, %struct.State* nocapture dereferenceable(3376), i64, i64, i64, i64) #0 {
...
; <label>:11:                                     ; preds = %6
  ...
  %25 = and i32 %24, 255
  %26 = tail call i32 @my.ctpop.i32(i32 %25) #22
...
define %struct.Memory* @routine_shrdq_m64_r64_imm8(%struct.State* noalias dereferenceable(3376), i64, %struct.Memory* noalias) #19 {
block_530:
  ...
  %18 = add i64 %17, 6
  store i64 %18, i64* %PC
  %19 = call %struct.Memory* @_ZN12_GLOBAL__N_1L4SHRDI3MnWImE2MnImE2RnImE2InImEEEP6MemorySA_R5StateT_T0_T1_T2_(%struct.Memory* %2, %struct.State* %0, i64 %13, i64 %15, i64 %16, i64 10)
...
entry:
  ...
  %call = call %struct.Memory* @routine_shrdq_m64_r64_imm8(%struct.State* %state, i64 0, %struct.Memory* %mem)
  ret i32 0
}