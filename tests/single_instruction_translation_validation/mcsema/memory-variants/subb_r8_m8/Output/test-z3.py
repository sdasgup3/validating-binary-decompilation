...
lvar = (V_R == z3.Concat(z3.Extract(63, 56, VL_RBX), z3.Extract(55, 48, VL_RBX), z3.Extract(47, 40, VL_RBX), z3.Extract(39, 32, VL_RBX), z3.Extract(31, 24, VL_RBX), z3.Extract(23, 16, VL_RBX), z3.Extract(15, 8, VL_RBX), z3.Extract(7, 0, (((z3.Concat(z3.BitVecVal(0, 56), z3.Extract(7, 0, VL_RBX)) & z3.BitVecVal(256 - 1, 64)) - z3.Concat(z3.BitVecVal( 0, 56), z3.Extract(7, 0, VL_MEM_8))) & z3.BitVecVal(256 - 1, 64)))))

xvar = (V_R == z3.Concat(z3.Extract(63, 8, VX_RBX), z3.Extract(7, 0, ((z3.Concat(z3.BitVecVal(0, 1), (VX_MEM_8 ^ z3.BitVecVal(-1, 8))) + z3.BitVecVal(1, 9)) + z3.Concat(z3.BitVecVal(0, 1), z3.Extract(7, 0, VX_RBX))))))
