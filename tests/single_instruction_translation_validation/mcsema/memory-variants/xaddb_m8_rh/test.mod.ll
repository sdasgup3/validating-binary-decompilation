...
define %struct.Memory* @routine_xaddb_m8_rh(%struct.State*  dereferenceable(3376), i64, %struct.Memory* ) #19 {
block_530:
  ...
  %21 = add i64 %20, 4
  store i64 %21, i64* %PC
  %22 = call %struct.Memory* @_ZN12_GLOBAL__N_1L4XADDI3MnWIhE2MnIhE3RnWIhE2RnIhEEEP6MemorySA_R5StateT_T0_T1_T2_(%struct.Memory* %13, %struct.State* %0, i64 %15, i64 %17, i8* %AH, i64 %19)
...
entry:
  ...
  %call = call %struct.Memory* @routine_xaddb_m8_rh(%struct.State* %state, i64 0, %struct.Memory* %mem)
  ret i32 0
}