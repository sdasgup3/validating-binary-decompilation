...
define internal %struct.Memory* @_ZN12_GLOBAL__N_1L4XCHGI3MnWIhE2MnIhE3RnWIhE2RnIhEEEP6MemorySA_R5StateT_T0_T1_T2_(%struct.Memory*, %struct.State* nocapture readnone dereferenceable(3376), i64, i64, i8* nocapture, i64) #0 {
...
define %struct.Memory* @routine_xchgb_m8_r8(%struct.State*  dereferenceable(3376), i64, %struct.Memory* ) #19 {
block_530:
  ...
  %21 = add i64 %20, 3
  store i64 %21, i64* %PC
  %22 = call %struct.Memory* @_ZN12_GLOBAL__N_1L4XCHGI3MnWIhE2MnIhE3RnWIhE2RnIhEEEP6MemorySA_R5StateT_T0_T1_T2_(%struct.Memory* %13, %struct.State* %0, i64 %15, i64 %17, i8* %CL, i64 %19)
...
entry:
  ...
  %memaddr = alloca i8
  store i8 800, i8* %memaddr
  %memaddr2int = ptrtoint i8* %memaddr to i64
  ...
  %call = call %struct.Memory* @routine_xchgb_m8_r8(%struct.State* %state, i64 0, %struct.Memory* %mem)
  ret i32 0
}