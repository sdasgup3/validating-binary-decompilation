...
lvar = (V_M32 == z3.Concat(z3.Extract(31, 24, (VL_RCX & z3.BitVecVal(4294967296 - 1, 64))), z3.Extract(23, 16, (VL_RCX & z3.BitVecVal(4294967296 - 1, 64))), z3.Extract(15, 8, (VL_RCX & z3.BitVecVal(4294967296 - 1, 64))), z3.Extract(7, 0, (VL_RCX & z3.BitVecVal(4294967296 - 1, 64)))))

xvar = (V_M32 == z3.Concat(z3.Extract(31, 24, z3.Extract(31, 0, VX_RCX)), z3.Extract(23, 16, z3.Extract(31, 0, VX_RCX)), z3.Extract(15, 8, z3.Extract(31, 0, VX_RCX)), z3.Extract(7, 0, z3.Extract(31, 0, VX_RCX))))
...
lvar = (V_R == z3.Concat(z3.Extract(63, 56, z3.Concat(z3.BitVecVal(0, 32), z3.Concat(z3.Extract(31, 24, VL_MEM_32),z3.Extract(23, 16, VL_MEM_32),z3.Extract(15, 8, VL_MEM_32),z3.Extract(7, 0, VL_MEM_32),))), z3.Extract(55, 48, z3.Concat(z3.BitVecVal(0, 32), z3.Concat(z3.Extract(31, 24, VL_MEM_32),z3.Extract(23, 16, VL_MEM_32),z3.Extract(15, 8, VL_MEM_32),z3.Extract(7, 0, VL_MEM_32),))), z3.Extract(47, 40, z3.Concat(z3.BitVecVal(0, 32), z3.Concat(z3.Extract(31, 24, VL_MEM_32),z3.Extract(23, 16, VL_MEM_32),z3.Extract(15, 8, VL_MEM_32),z3.Extract(7, 0, VL_MEM_32),))), z3.Extract(39, 32, z3.Concat(z3.BitVecVal(0, 32), z3.Concat(z3.Extract(31, 24, VL_MEM_32),z3.Extract(23, 16, VL_MEM_32),z3.Extract(15, 8, VL_MEM_32),z3.Extract(7, 0, VL_MEM_32),))), z3.Extract(31, 24, z3.Concat(z3.BitVecVal(0, 32), z3.Concat(z3.Extract(31, 24, VL_MEM_32),z3.Extract(23, 16, VL_MEM_32),z3.Extract(15, 8, VL_MEM_32),z3.Extract(7, 0, VL_MEM_32),))), z3.Extract(23, 16, z3.Concat(z3.BitVecVal(0, 32), z3.Concat(z3.Extract(31, 24, VL_MEM_32),z3.Extract(23, 16, VL_MEM_32),z3.Extract(15, 8, VL_MEM_32),z3.Extract(7, 0, VL_MEM_32),))), z3.Extract(15, 8, z3.Concat(z3.BitVecVal(0, 32), z3.Concat(z3.Extract(31, 24, VL_MEM_32),z3.Extract(23, 16, VL_MEM_32),z3.Extract(15, 8, VL_MEM_32),z3.Extract(7, 0, VL_MEM_32),))), z3.Extract(7, 0, z3.Concat(z3.BitVecVal(0, 32), z3.Concat(z3.Extract(31, 24, VL_MEM_32),z3.Extract(23, 16, VL_MEM_32),z3.Extract(15, 8, VL_MEM_32),z3.Extract(7, 0, VL_MEM_32),)))))

xvar = (V_R == z3.Concat(z3.BitVecVal(0, 32), VX_MEM_32))
