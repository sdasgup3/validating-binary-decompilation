...
define internal %struct.Memory* @_ZN12_GLOBAL__N_1L4XCHGI3MnWImE2MnImE3RnWImE2RnImEEEP6MemorySA_R5StateT_T0_T1_T2_(%struct.Memory*, %struct.State* nocapture readnone dereferenceable(3376), i64, i64, i64* nocapture, i64) #0 {
...
define %struct.Memory* @routine_xchgq_m64_r64(%struct.State*  dereferenceable(3376), i64, %struct.Memory* ) #19 {
block_530:
  ...
  %19 = add i64 %18, 4
  store i64 %19, i64* %PC
  %20 = call %struct.Memory* @_ZN12_GLOBAL__N_1L4XCHGI3MnWImE2MnImE3RnWImE2RnImEEEP6MemorySA_R5StateT_T0_T1_T2_(%struct.Memory* %12, %struct.State* %0, i64 %14, i64 %16, i64* %RCX, i64 %17)
...
entry:
  ...
  %call = call %struct.Memory* @routine_xchgq_m64_r64(%struct.State* %state, i64 0, %struct.Memory* %mem)
  ret i32 0
}