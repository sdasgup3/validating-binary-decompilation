...
lvar = (V_M64 == z3.Concat(z3.Extract(63, 56, VL_RBX), z3.Extract(55, 48, VL_RBX), z3.Extract(47, 40, VL_RBX), z3.Extract(39, 32, VL_RBX), z3.Extract(31, 24, VL_RBX), z3.Extract(23, 16, VL_RBX), z3.Extract(15, 8, VL_RBX), z3.Extract(7, 0, VL_RBX)))

xvar = (V_M64 == z3.Concat(z3.Extract(63, 56, VX_RBX), z3.Extract(55, 48, VX_RBX), z3.Extract(47, 40, VX_RBX), z3.Extract(39, 32, VX_RBX), z3.Extract(31, 24, VX_RBX), z3.Extract(23, 16, VX_RBX), z3.Extract(15, 8, VX_RBX), z3.Extract(7, 0, VX_RBX)))
