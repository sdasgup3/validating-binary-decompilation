...
lvar = (V_M16 == z3.Concat(z3.Extract(15, 8, (z3.Concat(z3.BitVecVal(0, 48), z3.Concat(z3.Extract(15, 8, VL_RCX),z3.Extract(7, 0, VL_RCX),)) & z3.BitVecVal(65536 - 1, 64))), z3.Extract(7, 0, (z3.Concat(z3.BitVecVal(0, 48), z3.Concat(z3.Extract(15, 8, VL_RCX),z3.Extract(7, 0, VL_RCX),)) & z3.BitVecVal(65536 - 1, 64)))))

xvar = (V_M16 == z3.Concat(z3.Extract(15, 8, z3.Extract(15, 0, VX_RCX)), z3.Extract(7, 0, z3.Extract(15, 0, VX_RCX))))
...
lvar = (V_R == z3.Concat(z3.Extract(63, 56, VL_RCX), z3.Extract(55, 48, VL_RCX), z3.Extract(47, 40, VL_RCX), z3.Extract(39, 32, VL_RCX), z3.Extract(31, 24, VL_RCX), z3.Extract(23, 16, VL_RCX), z3.Extract(15, 8, z3.Concat(z3.Extract(15, 8, VL_MEM_16),z3.Extract(7, 0, VL_MEM_16),)), z3.Extract(7, 0, z3.Concat(z3.Extract(15, 8, VL_MEM_16),z3.Extract(7, 0, VL_MEM_16),))))

xvar = (V_R == z3.Concat(z3.Extract(63, 16, VX_RCX), VX_MEM_16))
