...
define %struct.Memory* @routine_xchgw_m16_r16(%struct.State*  dereferenceable(3376), i64, %struct.Memory* ) #19 {
block_530:
  ...
  %20 = add i64 %19, 4
  store i64 %20, i64* %PC
  %21 = call %struct.Memory* @_ZN12_GLOBAL__N_1L4XCHGI3MnWItE2MnItE3RnWItE2RnItEEEP6MemorySA_R5StateT_T0_T1_T2_(%struct.Memory* %12, %struct.State* %0, i64 %14, i64 %16, i16* %CX, i64 %18)
...
entry:
  ...
  %call = call %struct.Memory* @routine_xchgw_m16_r16(%struct.State* %state, i64 0, %struct.Memory* %mem)
  ret i32 0
}