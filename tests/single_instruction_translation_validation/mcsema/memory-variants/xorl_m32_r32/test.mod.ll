...
define internal %struct.Memory* @_ZN12_GLOBAL__N_1L3XORI3MnWIjE2MnIjE2RnIjEEEP6MemoryS8_R5StateT_T0_T1_(%struct.Memory*, %struct.State* nocapture dereferenceable(3376), i64, i64, i64) #0 {
...
define %struct.Memory* @routine_xorl_m32_r32(%struct.State*  dereferenceable(3376), i64, %struct.Memory* ) #19 {
block_530:
  ...
  %19 = add i64 %18, 3
  store i64 %19, i64* %PC
  %20 = call %struct.Memory* @_ZN12_GLOBAL__N_1L3XORI3MnWIjE2MnIjE2RnIjEEEP6MemoryS8_R5StateT_T0_T1_(%struct.Memory* %2, %struct.State* %0, i64 %13, i64 %15, i64 %17)
...
entry:
  ...
  %call = call %struct.Memory* @routine_xorl_m32_r32(%struct.State* %state, i64 0, %struct.Memory* %mem)
  ret i32 0
}