...
define %struct.Memory* @routine_adcb_rh_rh(%struct.State*  dereferenceable(3376), i64, %struct.Memory* ) #19 {
block_530:
  ...
  %15 = add i64 %14, 2
  store i64 %15, i64* %PC
  %16 = call %struct.Memory* @_ZN12_GLOBAL__N_1L3ADCI3RnWIhE2RnIhES4_EEP6MemoryS6_R5StateT_T0_T1_(%struct.Memory* %2, %struct.State* %0, i8* %AH, i64 %11, i64 %13)
...
entry:
  ...
  %call = call %struct.Memory* @routine_adcb_rh_rh(%struct.State* %state, i64 0, %struct.Memory* %mem)
  ret i32 0
}