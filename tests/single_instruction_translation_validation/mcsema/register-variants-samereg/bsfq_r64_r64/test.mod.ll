...
define internal %struct.Memory* @_ZN12_GLOBAL__N_1L3BSFI3RnWImE2RnImEEEP6MemoryS6_R5StateT_T0_(%struct.Memory* readnone returned, %struct.State* nocapture dereferenceable(3376), i64* nocapture, i64) #0 {
  %5 = getelementptr inbounds %struct.State, %struct.State* %1, i64 0, i32 2, i32 7
  %6 = icmp eq i64 %3, 0
  %7 = zext i1 %6 to i8
  store i8 %7, i8* %5, align 1
  %8 = load i64, i64* %2, align 8
  %9 = tail call i64 @my.cttz.i64(i64 %3, i1 true) #22
...
define %struct.Memory* @routine_bsfq_r64_r64(%struct.State*  dereferenceable(3376), i64, %struct.Memory* ) #19 {
block_530:
  ...
  %11 = add i64 %10, 4
  store i64 %11, i64* %PC
  %12 = call %struct.Memory* @_ZN12_GLOBAL__N_1L3BSFI3RnWImE2RnImEEEP6MemoryS6_R5StateT_T0_(%struct.Memory* %2, %struct.State* %0, i64* %RAX, i64 %9)
...
entry:
  ...
  %call = call %struct.Memory* @routine_bsfq_r64_r64(%struct.State* %state, i64 0, %struct.Memory* %mem)
  ret i32 0
}