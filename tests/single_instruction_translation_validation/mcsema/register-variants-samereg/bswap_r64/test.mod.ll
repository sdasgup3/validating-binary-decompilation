...
define %struct.Memory* @routine_bswap_r64(%struct.State*  dereferenceable(3376), i64, %struct.Memory* ) #19 {
block_530:
  ...
  %11 = add i64 %10, 3
  store i64 %11, i64* %PC
  %12 = call %struct.Memory* @_ZN12_GLOBAL__N_1L8BSWAP_64EP6MemoryR5State3RnWImE2RnImE(%struct.Memory* %2, %struct.State* %0, i64* %RAX, i64 %9)
