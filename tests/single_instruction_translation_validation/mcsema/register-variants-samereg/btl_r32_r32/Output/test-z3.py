...
lvar = (V_F == z3.Extract(0, 0, z3.Extract(7, 0, z3.Concat(z3.BitVecVal(0, 7), z3.Extract(0, 0, z3.If(z3.Not((((((z3.BitVecVal(1, 64) << ((z3.Concat(z3.BitVecVal(0, 32), z3.Concat(z3.Extract(31, 24, VL_RAX),z3.Extract(23, 16, VL_RAX),z3.Extract(15, 8, VL_RAX),z3.Extract(7, 0, VL_RAX),)) & z3.BitVecVal(31, 64)) & z3.BitVecVal(18446744073709551616 - 1, 64))) & z3.BitVecVal(18446744073709551616 - 1, 64)) & z3.Concat(z3.BitVecVal(0, 32), z3.Concat(z3.Extract(31, 24, VL_RAX),z3.Extract(23, 16, VL_RAX),z3.Extract(15, 8, VL_RAX),z3.Extract(7, 0, VL_RAX),))) & z3.BitVecVal(18446744073709551616 - 1, 64)) == z3.BitVecVal(0, 64))), z3.BitVecVal(1, 8), z3.BitVecVal(0, 8)))))))
