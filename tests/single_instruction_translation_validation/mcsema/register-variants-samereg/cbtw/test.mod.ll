...
define internal %struct.Memory* @_ZN12_GLOBAL__N_1L6CBW_ALEP6MemoryR5State(%struct.Memory* readnone returned, %struct.State* nocapture dereferenceable(3376)) #2 {
...
define %struct.Memory* @routine_cbtw(%struct.State*  dereferenceable(3376), i64, %struct.Memory* ) #19 {
block_530:
  ...
  %7 = add i64 %6, 2
  store i64 %7, i64* %PC
  %8 = call %struct.Memory* @_ZN12_GLOBAL__N_1L6CBW_ALEP6MemoryR5State(%struct.Memory* %2, %struct.State* %0)
  ret %struct.Memory* %8
}
...
entry:
  ...
  %call = call %struct.Memory* @routine_cbtw(%struct.State* %state, i64 0, %struct.Memory* %mem)
  ret i32 0
}