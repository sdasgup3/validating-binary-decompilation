...
define %struct.Memory* @routine_cmovgeq_r64_r64(%struct.State*  dereferenceable(3376), i64, %struct.Memory* ) #19 {
block_530:
  ...
  %11 = add i64 %10, 4
  store i64 %11, i64* %PC
  %12 = call %struct.Memory* @_ZN12_GLOBAL__N_1L6CMOVNLI3RnWImE2RnImEEEP6MemoryS6_R5StateT_T0_(%struct.Memory* %2, %struct.State* %0, i64* %RAX, i64 %9)
...
entry:
  ...
  %call = call %struct.Memory* @routine_cmovgeq_r64_r64(%struct.State* %state, i64 0, %struct.Memory* %mem)
  ret i32 0
}