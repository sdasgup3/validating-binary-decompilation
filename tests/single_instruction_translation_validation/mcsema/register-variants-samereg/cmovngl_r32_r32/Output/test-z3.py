...
xvar = (V_R == z3.Concat(z3.BitVecVal(0, 32), z3.If(z3.Or((VX_ZF == z3.BitVecVal(1, 1)), z3.Not(((VX_SF == z3.BitVecVal(1, 1)) == (VX_OF == z3.BitVecVal(1, 1))))), z3.Extract(31, 0, VX_RAX), z3.Extract(31, 0, VX_RAX))))
