...
define %struct.Memory* @routine_cmovpew_r16_r16(%struct.State*  dereferenceable(3376), i64, %struct.Memory* ) #19 {
block_530:
  ...
  %12 = add i64 %11, 4
  store i64 %12, i64* %PC
  %13 = call %struct.Memory* @_ZN12_GLOBAL__N_1L5CMOVPI3RnWItE2RnItEEEP6MemoryS6_R5StateT_T0_(%struct.Memory* %2, %struct.State* %0, i16* %AX, i64 %10)
...
entry:
  ...
  %call = call %struct.Memory* @routine_cmovpew_r16_r16(%struct.State* %state, i64 0, %struct.Memory* %mem)
  ret i32 0
}