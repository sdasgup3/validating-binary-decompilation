...
define %struct.Memory* @routine_cmpxchgb_rh_r8(%struct.State*  dereferenceable(3376), i64, %struct.Memory* ) #19 {
block_530:
  ...
  %AL = getelementptr inbounds %struct.anon.2, %struct.anon.2* %13, i32 0, i32 0
  ...
  %20 = add i64 %19, 3
  store i64 %20, i64* %PC
  %21 = call %struct.Memory* @_ZN12_GLOBAL__N_1L10CMPXCHG_ALI3RnWIhE2RnIhES4_EEP6MemoryS6_R5StateT_T0_T1_(%struct.Memory* %14, %struct.State* %0, i8* %AH, i64 %16, i64 %18)
...
entry:
  ...
  %call = call %struct.Memory* @routine_cmpxchgb_rh_r8(%struct.State* %state, i64 0, %struct.Memory* %mem)
  ret i32 0
}