...
define internal %struct.Memory* @_ZN12_GLOBAL__N_1L11CMPXCHG_RAXI3RnWImE2RnImES4_EEP6MemoryS6_R5StateT_T0_T1_(%struct.Memory*, %struct.State* nocapture dereferenceable(3376), i64* nocapture, i64, i64) #0 {
...
; <label>:11:                                     ; preds = %10, %5
  ...
  %19 = and i32 %18, 255
  %20 = tail call i32 @my.ctpop.i32(i32 %19) #22
...
define %struct.Memory* @routine_cmpxchgq_r64_r64(%struct.State*  dereferenceable(3376), i64, %struct.Memory* ) #19 {
block_530:
  ...
  %13 = add i64 %12, 4
  store i64 %13, i64* %PC
  %14 = call %struct.Memory* @_ZN12_GLOBAL__N_1L11CMPXCHG_RAXI3RnWImE2RnImES4_EEP6MemoryS6_R5StateT_T0_T1_(%struct.Memory* %9, %struct.State* %0, i64* %RAX, i64 %10, i64 %11)
  %15 = call %struct.Memory* @__remill_atomic_end(%struct.Memory* %14)
...
entry:
  ...
  %call = call %struct.Memory* @routine_cmpxchgq_r64_r64(%struct.State* %state, i64 0, %struct.Memory* %mem)
  ret i32 0
}