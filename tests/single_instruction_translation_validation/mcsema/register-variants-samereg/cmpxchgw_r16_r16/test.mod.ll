...
define internal %struct.Memory* @_ZN12_GLOBAL__N_1L10CMPXCHG_AXI3RnWItE2RnItES4_EEP6MemoryS6_R5StateT_T0_T1_(%struct.Memory*, %struct.State* nocapture dereferenceable(3376), i16* nocapture, i64, i64) #0 {
...
define %struct.Memory* @routine_cmpxchgw_r16_r16(%struct.State*  dereferenceable(3376), i64, %struct.Memory* ) #19 {
block_530:
  ...
  %15 = add i64 %14, 4
  store i64 %15, i64* %PC
  %16 = call %struct.Memory* @_ZN12_GLOBAL__N_1L10CMPXCHG_AXI3RnWItE2RnItES4_EEP6MemoryS6_R5StateT_T0_T1_(%struct.Memory* %9, %struct.State* %0, i16* %AX, i64 %11, i64 %13)
...
entry:
  ...
  %call = call %struct.Memory* @routine_cmpxchgw_r16_r16(%struct.State* %state, i64 0, %struct.Memory* %mem)
  ret i32 0
}