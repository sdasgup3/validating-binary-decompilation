...
define internal %struct.Memory* @_ZN12_GLOBAL__N_1L8CVTPS2DQI3VnWI8vec128_tE2VnIS2_ELm4EXadL_ZNS_L17FRoundUsingMode32EfEEEEP6MemoryS7_R5StateT_T0_(%struct.Memory* readnone returned, %struct.State* nocapture readnone dereferenceable(3376), i8* nocapture, i8* nocapture readonly) #0 {
  ...
  %18 = tail call float @my.nearbyint.f32(float %17) #22
  %19 = tail call float @my.fabs.f32(float %18) #22
  ...
  %28 = tail call float @my.nearbyint.f32(float %27) #22
  %29 = tail call float @my.fabs.f32(float %28) #22
  ...
  %37 = tail call float @my.nearbyint.f32(float %36) #22
  %38 = tail call float @my.fabs.f32(float %37) #22
  ...
  %48 = tail call float @my.nearbyint.f32(float %47) #22
  %49 = tail call float @my.fabs.f32(float %48) #22
...
define %struct.Memory* @routine_cvtps2dq_xmm_xmm(%struct.State*  dereferenceable(3376), i64, %struct.Memory* ) #19 {
block_530:
