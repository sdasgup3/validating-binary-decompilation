...
define %struct.Memory* @routine_cvtsd2si_r64_xmm(%struct.State*  dereferenceable(3376), i64, %struct.Memory* ) #19 {
block_530:
  ...
  %13 = add i64 %12, 5
  store i64 %13, i64* %PC
  %14 = call %struct.Memory* @_ZN12_GLOBAL__N_1L11CVTSD2SI_64I2VnI8vec128_tEXadL_ZNS_L17FRoundUsingMode64EdEEEEP6MemoryS5_R5State3RnWImET_(%struct.Memory* %2, %struct.State* %0, i64* %RAX, i8* %11)
...
entry:
  ...
  %call = call %struct.Memory* @routine_cvtsd2si_r64_xmm(%struct.State* %state, i64 0, %struct.Memory* %mem)
  ret i32 0
}