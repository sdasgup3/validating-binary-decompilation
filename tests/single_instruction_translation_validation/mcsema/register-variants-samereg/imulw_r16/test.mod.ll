...
define internal %struct.Memory* @_ZN12_GLOBAL__N_1L6IMULaxI2RnItEEEP6MemoryS4_R5StateT_(%struct.Memory* readnone returned, %struct.State* nocapture dereferenceable(3376), i64) #0 {
...
define %struct.Memory* @routine_imulw_r16(%struct.State*  dereferenceable(3376), i64, %struct.Memory* ) #19 {
block_530:
  ...
  %12 = add i64 %11, 3
  store i64 %12, i64* %PC
  %13 = call %struct.Memory* @_ZN12_GLOBAL__N_1L6IMULaxI2RnItEEEP6MemoryS4_R5StateT_(%struct.Memory* %2, %struct.State* %0, i64 %10)
...
entry:
  ...
  %call = call %struct.Memory* @routine_imulw_r16(%struct.State* %state, i64 0, %struct.Memory* %mem)
  ret i32 0
}