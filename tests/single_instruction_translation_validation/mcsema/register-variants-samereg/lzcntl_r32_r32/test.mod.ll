...
define internal %struct.Memory* @_ZN12_GLOBAL__N_1L5LZCNTI3RnWImE2RnIjEEEP6MemoryS6_R5StateT_T0_(%struct.Memory* readnone returned, %struct.State* nocapture dereferenceable(3376), i64* nocapture, i64) #0 {
  %5 = trunc i64 %3 to i32
  %6 = tail call i32 @my.ctlz.i32(i32 %5, i1 false) #22
...
define %struct.Memory* @routine_lzcntl_r32_r32(%struct.State*  dereferenceable(3376), i64, %struct.Memory* ) #19 {
block_530:
  ...
  %15 = add i64 %14, 4
  store i64 %15, i64* %PC
  %16 = call %struct.Memory* @_ZN12_GLOBAL__N_1L5LZCNTI3RnWImE2RnIjEEEP6MemoryS6_R5StateT_T0_(%struct.Memory* %2, %struct.State* %0, i64* %RAX, i64 %13)
...
entry:
  ...
  %call = call %struct.Memory* @routine_lzcntl_r32_r32(%struct.State* %state, i64 0, %struct.Memory* %mem)
  ret i32 0
}