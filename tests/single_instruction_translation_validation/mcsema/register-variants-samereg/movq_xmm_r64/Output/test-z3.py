...
lvar = (V_Y == z3.Concat(z3.Extract(63, 56, VL_YMM1_3), z3.Extract(55, 48, VL_YMM1_3), z3.Extract(47, 40, VL_YMM1_3), z3.Extract(39, 32, VL_YMM1_3), z3.Extract(31, 24, VL_YMM1_3), z3.Extract(23, 16, VL_YMM1_3), z3.Extract(15, 8, VL_YMM1_3), z3.Extract(7, 0, VL_YMM1_3), z3.Extract(63, 56, VL_YMM1_2), z3.Extract(55, 48, VL_YMM1_2), z3.Extract(47, 40, VL_YMM1_2), z3.Extract(39, 32, VL_YMM1_2), z3.Extract(31, 24, VL_YMM1_2), z3.Extract(23, 16, VL_YMM1_2), z3.Extract(15, 8, VL_YMM1_2), z3.Extract(7, 0, VL_YMM1_2), z3.Extract(63, 56, z3.Concat(z3.BitVecVal(0, 56), z3.BitVecVal(0, 8))), z3.Extract(55, 48, z3.Concat(z3.BitVecVal(0, 56), z3.BitVecVal(0, 8))), z3.Extract(47, 40, z3.Concat(z3.BitVecVal(0, 56), z3.BitVecVal(0, 8))), z3.Extract(39, 32, z3.Concat(z3.BitVecVal(0, 56), z3.BitVecVal(0, 8))), z3.Extract(31, 24, z3.Concat(z3.BitVecVal(0, 56), z3.BitVecVal(0, 8))), z3.Extract(23, 16, z3.Concat(z3.BitVecVal(0, 56), z3.BitVecVal(0, 8))), z3.Extract(15, 8, z3.Concat(z3.BitVecVal(0, 56), z3.BitVecVal(0, 8))), z3.Extract(7, 0, z3.Concat(z3.BitVecVal(0, 56), z3.BitVecVal(0, 8))), z3.Extract(63, 56, VL_RAX), z3.Extract(55, 48, VL_RAX), z3.Extract(47, 40, VL_RAX), z3.Extract(39, 32, VL_RAX), z3.Extract(31, 24, VL_RAX), z3.Extract(23, 16, VL_RAX), z3.Extract(15, 8, VL_RAX), z3.Extract(7, 0, VL_RAX)))

xvar = (V_Y == z3.Concat(z3.Extract(255, 128, VX_YMM1), z3.Concat(z3.BitVecVal(0, 64), VX_RAX)))
