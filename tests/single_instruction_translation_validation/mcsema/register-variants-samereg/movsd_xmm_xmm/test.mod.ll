...
define internal %struct.Memory* @_ZN12_GLOBAL__N_1L5MOVSDEP6MemoryR5State3VnWI8vec128_tE2VnIS5_E(%struct.Memory* readnone returned, %struct.State* nocapture readnone dereferenceable(3376), i8* nocapture, i8* nocapture readonly) #0 {
...
define %struct.Memory* @routine_movsd_xmm_xmm(%struct.State*  dereferenceable(3376), i64, %struct.Memory* ) #19 {
block_530:
  ...
  %13 = add i64 %12, 4
  store i64 %13, i64* %PC
  %14 = call %struct.Memory* @_ZN12_GLOBAL__N_1L5MOVSDEP6MemoryR5State3VnWI8vec128_tE2VnIS5_E(%struct.Memory* %2, %struct.State* %0, i8* %10, i8* %11)
...
entry:
  ...
  %call = call %struct.Memory* @routine_movsd_xmm_xmm(%struct.State* %state, i64 0, %struct.Memory* %mem)
  ret i32 0
}