...
lvar = (V_R == z3.Concat(z3.Extract(63, 56, ((z3.Concat(z3.BitVecVal(0, 56), z3.Extract(7, 0, VL_RAX)) & z3.BitVecVal(255, 64)) & z3.BitVecVal(18446744073709551616 - 1, 64))), z3.Extract(55, 48, ((z3.Concat(z3.BitVecVal(0, 56), z3.Extract(7, 0, VL_RAX)) & z3.BitVecVal(255, 64)) & z3.BitVecVal(18446744073709551616 - 1, 64))), z3.Extract(47, 40, ((z3.Concat(z3.BitVecVal(0, 56), z3.Extract(7, 0, VL_RAX)) & z3.BitVecVal(255, 64)) & z3.BitVecVal(18446744073709551616 - 1, 64))), z3.Extract(39, 32, ((z3.Concat(z3.BitVecVal(0, 56), z3.Extract(7, 0, VL_RAX)) & z3.BitVecVal(255, 64)) & z3.BitVecVal(18446744073709551616 - 1, 64))), z3.Extract(31, 24, ((z3.Concat(z3.BitVecVal(0, 56), z3.Extract(7, 0, VL_RAX)) & z3.BitVecVal(255, 64)) & z3.BitVecVal(18446744073709551616 - 1, 64))), z3.Extract(23, 16, ((z3.Concat(z3.BitVecVal(0, 56), z3.Extract(7, 0, VL_RAX)) & z3.BitVecVal(255, 64)) & z3.BitVecVal(18446744073709551616 - 1, 64))), z3.Extract(15, 8, ((z3.Concat(z3.BitVecVal(0, 56), z3.Extract(7, 0, VL_RAX)) & z3.BitVecVal(255, 64)) & z3.BitVecVal(18446744073709551616 - 1, 64))), z3.Extract(7, 0, ((z3.Concat(z3.BitVecVal(0, 56), z3.Extract(7, 0, VL_RAX)) & z3.BitVecVal(255, 64)) & z3.BitVecVal(18446744073709551616 - 1, 64)))))

xvar = (V_R == z3.Concat(z3.BitVecVal(0, 56), z3.Extract(7, 0, VX_RAX)))
