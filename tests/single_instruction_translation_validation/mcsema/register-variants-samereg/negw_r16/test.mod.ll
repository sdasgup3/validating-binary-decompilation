...
define internal %struct.Memory* @_ZN12_GLOBAL__N_1L3NEGI3RnWItE2RnItEEEP6MemoryS6_R5StateT_T0_(%struct.Memory* readnone returned, %struct.State* nocapture dereferenceable(3376), i16* nocapture, i64) #0 {
...
define %struct.Memory* @routine_negw_r16(%struct.State*  dereferenceable(3376), i64, %struct.Memory* ) #19 {
block_530:
  ...
  %12 = add i64 %11, 3
  store i64 %12, i64* %PC
  %13 = call %struct.Memory* @_ZN12_GLOBAL__N_1L3NEGI3RnWItE2RnItEEEP6MemoryS6_R5StateT_T0_(%struct.Memory* %2, %struct.State* %0, i16* %AX, i64 %10)
...
entry:
  ...
  %call = call %struct.Memory* @routine_negw_r16(%struct.State* %state, i64 0, %struct.Memory* %mem)
  ret i32 0
}