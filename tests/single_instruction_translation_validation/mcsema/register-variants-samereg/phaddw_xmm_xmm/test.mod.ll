...
define internal %struct.Memory* @_ZN12_GLOBAL__N_1L6PHADDWI3VnWI8vec128_tE2VnIS2_ES5_EEP6MemoryS7_R5StateT_T0_T1_(%struct.Memory* readnone returned, %struct.State* nocapture readnone dereferenceable(3376), i8* nocapture, i8* nocapture readonly, i8* nocapture readonly) #0 {
  ...
  %58 = add i16 %57, %55
  call void @my.lifetime.start(i64 16, i8* nonnull %50)
  ...
  call void @my.lifetime.end(i64 16, i8* nonnull %50)
...
define %struct.Memory* @routine_phaddw_xmm_xmm(%struct.State*  dereferenceable(3376), i64, %struct.Memory* ) #19 {
block_530:
