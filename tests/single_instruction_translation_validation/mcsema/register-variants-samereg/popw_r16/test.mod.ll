...
define %struct.Memory* @routine_popw_r16(%struct.State*  dereferenceable(3376), i64, %struct.Memory* ) #19 {
block_530:
  ...
  %10 = add i64 %9, 2
  store i64 %10, i64* %PC
  %11 = call %struct.Memory* @_ZN12_GLOBAL__N_1L3POPI3RnWItEEEP6MemoryS4_R5StateT_(%struct.Memory* %2, %struct.State* %0, i16* %AX)
