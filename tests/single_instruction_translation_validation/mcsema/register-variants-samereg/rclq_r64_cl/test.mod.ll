...
define internal %struct.Memory* @_ZN12_GLOBAL__N_1L3RCLI3RnWImE2RnImES4_EEP6MemoryS6_R5StateT_T0_T1_(%struct.Memory* readnone, %struct.State* nocapture dereferenceable(3376), i64* nocapture, i64, i64) #2 {
  %6 = and i64 %4, 63
...
define %struct.Memory* @routine_rclq_r64_cl(%struct.State*  dereferenceable(3376), i64, %struct.Memory* ) #19 {
block_530:
  ...
  %17 = add i64 %16, 3
  store i64 %17, i64* %PC
  %18 = call %struct.Memory* @_ZN12_GLOBAL__N_1L3RCLI3RnWImE2RnImES4_EEP6MemoryS6_R5StateT_T0_T1_(%struct.Memory* %2, %struct.State* %0, i64* %RAX, i64 %13, i64 %15)
...
entry:
  ...
  %call = call %struct.Memory* @routine_rclq_r64_cl(%struct.State* %state, i64 0, %struct.Memory* %mem)
  ret i32 0
}