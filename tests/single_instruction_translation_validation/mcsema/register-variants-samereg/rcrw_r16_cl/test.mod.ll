...
define internal %struct.Memory* @_ZN12_GLOBAL__N_1L3RCRI3RnWItE2RnItES4_EEP6MemoryS6_R5StateT_T0_T1_(%struct.Memory* readnone, %struct.State* nocapture dereferenceable(3376), i16* nocapture, i64, i64) #2 {
...
define %struct.Memory* @routine_rcrw_r16_cl(%struct.State*  dereferenceable(3376), i64, %struct.Memory* ) #19 {
block_530:
  ...
  %18 = add i64 %17, 3
  store i64 %18, i64* %PC
  %19 = call %struct.Memory* @_ZN12_GLOBAL__N_1L3RCRI3RnWItE2RnItES4_EEP6MemoryS6_R5StateT_T0_T1_(%struct.Memory* %2, %struct.State* %0, i16* %AX, i64 %14, i64 %16)
...
entry:
  ...
  %call = call %struct.Memory* @routine_rcrw_r16_cl(%struct.State* %state, i64 0, %struct.Memory* %mem)
  ret i32 0
}