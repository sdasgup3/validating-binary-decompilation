...
define internal %struct.Memory* @_ZN12_GLOBAL__N_1L4SHRDI3RnWImE2RnIjES4_S4_EEP6MemoryS6_R5StateT_T0_T1_T2_(%struct.Memory* readnone, %struct.State* nocapture dereferenceable(3376), i64* nocapture, i64, i64, i64) #0 {
...
; <label>:10:                                     ; preds = %6
  ...
  %30 = and i32 %20, 255
  %31 = tail call i32 @my.ctpop.i32(i32 %30) #22
...
define %struct.Memory* @routine_shrdl_r32_r32_cl(%struct.State*  dereferenceable(3376), i64, %struct.Memory* ) #19 {
block_530:
  ...
  %22 = add i64 %21, 3
  store i64 %22, i64* %PC
  %23 = call %struct.Memory* @_ZN12_GLOBAL__N_1L4SHRDI3RnWImE2RnIjES4_S4_EEP6MemoryS6_R5StateT_T0_T1_T2_(%struct.Memory* %2, %struct.State* %0, i64* %RBX, i64 %16, i64 %18, i64 %20)
...
entry:
  ...
  %call = call %struct.Memory* @routine_shrdl_r32_r32_cl(%struct.State* %state, i64 0, %struct.Memory* %mem)
  ret i32 0
}