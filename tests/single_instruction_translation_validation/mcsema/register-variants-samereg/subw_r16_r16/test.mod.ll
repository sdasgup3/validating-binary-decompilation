...
define internal %struct.Memory* @_ZN12_GLOBAL__N_1L3SUBI3RnWItE2RnItES4_EEP6MemoryS6_R5StateT_T0_T1_(%struct.Memory* readnone returned, %struct.State* nocapture dereferenceable(3376), i16* nocapture, i64, i64) #0 {
...
define %struct.Memory* @routine_subw_r16_r16(%struct.State*  dereferenceable(3376), i64, %struct.Memory* ) #19 {
block_530:
  ...
  %14 = add i64 %13, 3
  store i64 %14, i64* %PC
  %15 = call %struct.Memory* @_ZN12_GLOBAL__N_1L3SUBI3RnWItE2RnItES4_EEP6MemoryS6_R5StateT_T0_T1_(%struct.Memory* %2, %struct.State* %0, i16* %AX, i64 %10, i64 %12)
...
entry:
  ...
  %call = call %struct.Memory* @routine_subw_r16_r16(%struct.State* %state, i64 0, %struct.Memory* %mem)
  ret i32 0
}