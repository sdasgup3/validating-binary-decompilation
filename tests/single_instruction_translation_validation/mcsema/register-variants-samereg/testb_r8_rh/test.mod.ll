...
define %struct.Memory* @routine_testb_r8_rh(%struct.State*  dereferenceable(3376), i64, %struct.Memory* ) #19 {
block_530:
  ...
  %19 = add i64 %18, 2
  store i64 %19, i64* %PC
  %20 = call %struct.Memory* @_ZN12_GLOBAL__N_1L4TESTI2RnIhES2_EEP6MemoryS4_R5StateT_T0_(%struct.Memory* %2, %struct.State* %0, i64 %15, i64 %17)
...
entry:
  ...
  %call = call %struct.Memory* @routine_testb_r8_rh(%struct.State* %state, i64 0, %struct.Memory* %mem)
  ret i32 0
}