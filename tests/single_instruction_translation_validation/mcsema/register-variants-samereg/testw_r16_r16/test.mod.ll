...
define internal %struct.Memory* @_ZN12_GLOBAL__N_1L4TESTI2RnItES2_EEP6MemoryS4_R5StateT_T0_(%struct.Memory* readnone returned, %struct.State* nocapture dereferenceable(3376), i64, i64) #0 {
  %5 = and i64 %3, %2
...
define %struct.Memory* @routine_testw_r16_r16(%struct.State*  dereferenceable(3376), i64, %struct.Memory* ) #19 {
block_530:
  ...
  %14 = add i64 %13, 3
  store i64 %14, i64* %PC
  %15 = call %struct.Memory* @_ZN12_GLOBAL__N_1L4TESTI2RnItES2_EEP6MemoryS4_R5StateT_T0_(%struct.Memory* %2, %struct.State* %0, i64 %10, i64 %12)
...
entry:
  ...
  %call = call %struct.Memory* @routine_testw_r16_r16(%struct.State* %state, i64 0, %struct.Memory* %mem)
  ret i32 0
}