...
define internal %struct.Memory* @_ZN12_GLOBAL__N_1L8CVTDQ2PSI3VnWI8vec256_tE2VnIS2_ELm8EEEP6MemoryS7_R5StateT_T0_(%struct.Memory* readnone returned, %struct.State* nocapture readnone dereferenceable(3376), i8* nocapture, i8* nocapture readonly) #0 {
  %5 = alloca %struct.int32v8_t, align 16
  %6 = bitcast %struct.int32v8_t* %5 to i8*
  ...
  %7 = bitcast %struct.int32v8_t* %5 to <4 x i32>*
  %8 = load <4 x i32>, <4 x i32>* %7, align 16
  %9 = sitofp <4 x i32> %8 to <4 x float>
  %10 = getelementptr inbounds %struct.int32v8_t, %struct.int32v8_t* %5, i64 0, i32 0, i64 4
  %11 = bitcast i32* %10 to <4 x i32>*
  %12 = load <4 x i32>, <4 x i32>* %11, align 16
  %13 = sitofp <4 x i32> %12 to <4 x float>
  %14 = bitcast i8* %2 to <4 x float>*
  store <4 x float> %9, <4 x float>* %14, align 1
  %15 = getelementptr inbounds i8, i8* %2, i64 16
  %16 = bitcast i8* %15 to <4 x float>*
  store <4 x float> %13, <4 x float>* %16, align 1
  call void @my.lifetime.end(i64 32, i8* nonnull %6) #22
  ret %struct.Memory* %0
}

define %struct.Memory* @routine_vcvtdq2ps_ymm_ymm(%struct.State*  dereferenceable(3376), i64, %struct.Memory* ) #19 {
block_530:
  ...
  %13 = add i64 %12, 4
  store i64 %13, i64* %PC
  %14 = call %struct.Memory* @_ZN12_GLOBAL__N_1L8CVTDQ2PSI3VnWI8vec256_tE2VnIS2_ELm8EEEP6MemoryS7_R5StateT_T0_(%struct.Memory* %2, %struct.State* %0, i8* %10, i8* %11)
...
entry:
  ...
  %call = call %struct.Memory* @routine_vcvtdq2ps_ymm_ymm(%struct.State* %state, i64 0, %struct.Memory* %mem)
  ret i32 0
}