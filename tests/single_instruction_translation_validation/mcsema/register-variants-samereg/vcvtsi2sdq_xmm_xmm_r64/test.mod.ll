...
define internal %struct.Memory* @_ZN12_GLOBAL__N_1L9VCVTSI2SDI2RnImEEEP6MemoryS4_R5State3VnWI8vec256_tE2VnI8vec128_tET_(%struct.Memory* readnone returned, %struct.State* nocapture readnone dereferenceable(3376), i8* nocapture, i8* nocapture readonly, i64) #0 {
...
define %struct.Memory* @routine_vcvtsi2sdq_xmm_xmm_r64(%struct.State*  dereferenceable(3376), i64, %struct.Memory* ) #19 {
block_530:
  ...
  %17 = add i64 %16, 5
  store i64 %17, i64* %PC
  %18 = call %struct.Memory* @_ZN12_GLOBAL__N_1L9VCVTSI2SDI2RnImEEEP6MemoryS4_R5State3VnWI8vec256_tE2VnI8vec128_tET_(%struct.Memory* %2, %struct.State* %0, i8* %13, i8* %14, i64 %15)
...
entry:
  ...
  %call = call %struct.Memory* @routine_vcvtsi2sdq_xmm_xmm_r64(%struct.State* %state, i64 0, %struct.Memory* %mem)
  ret i32 0
}