...
define internal %struct.Memory* @_ZN12_GLOBAL__N_1L8PMOVMSKBI3RnWImE2VnI8vec128_tEEEP6MemoryS7_R5StateT_T0_(%struct.Memory* readnone returned, %struct.State* nocapture readnone dereferenceable(3376), i64* nocapture, i8* nocapture readonly) #0 {
  %5 = alloca { i64, i64 }, align 8
  %6 = bitcast { i64, i64 }* %5 to i8*
  call void @my.lifetime.start(i64 16, i8* nonnull %6) #22
  ...
  call void @my.lifetime.end(i64 16, i8* nonnull %6) #22
  ret %struct.Memory* %0
}

define %struct.Memory* @routine_vpmovmskb_r64_xmm(%struct.State*  dereferenceable(3376), i64, %struct.Memory* ) #19 {
block_530:
  ...
  %13 = add i64 %12, 4
  store i64 %13, i64* %PC
  %14 = call %struct.Memory* @_ZN12_GLOBAL__N_1L8PMOVMSKBI3RnWImE2VnI8vec128_tEEEP6MemoryS7_R5StateT_T0_(%struct.Memory* %2, %struct.State* %0, i64* %RAX, i8* %11)
...
entry:
  ...
  %call = call %struct.Memory* @routine_vpmovmskb_r64_xmm(%struct.State* %state, i64 0, %struct.Memory* %mem)
  ret i32 0
}