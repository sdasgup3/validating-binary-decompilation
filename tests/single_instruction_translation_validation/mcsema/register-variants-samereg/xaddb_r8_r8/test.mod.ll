...
define %struct.Memory* @routine_xaddb_r8_r8(%struct.State*  dereferenceable(3376), i64, %struct.Memory* ) #19 {
block_530:
  ...
  %16 = add i64 %15, 3
  store i64 %16, i64* %PC
  %17 = call %struct.Memory* @_ZN12_GLOBAL__N_1L4XADDI3RnWIhE2RnIhES2_S4_EEP6MemoryS6_R5StateT_T0_T1_T2_(%struct.Memory* %10, %struct.State* %0, i8* %AL, i64 %12, i8* %AL, i64 %14)
...
entry:
  ...
  %call = call %struct.Memory* @routine_xaddb_r8_r8(%struct.State* %state, i64 0, %struct.Memory* %mem)
  ret i32 0
}