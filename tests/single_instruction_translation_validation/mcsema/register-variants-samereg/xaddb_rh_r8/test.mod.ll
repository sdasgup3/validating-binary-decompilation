...
define internal %struct.Memory* @_ZN12_GLOBAL__N_1L4XADDI3RnWIhE2RnIhES2_S4_EEP6MemoryS6_R5StateT_T0_T1_T2_(%struct.Memory*, %struct.State* nocapture dereferenceable(3376), i8* nocapture, i64, i8* nocapture, i64) #0 {
  %7 = trunc i64 %5 to i8
...
define %struct.Memory* @routine_xaddb_rh_r8(%struct.State*  dereferenceable(3376), i64, %struct.Memory* ) #19 {
block_530:
  ...
  %20 = add i64 %19, 3
  store i64 %20, i64* %PC
  %21 = call %struct.Memory* @_ZN12_GLOBAL__N_1L4XADDI3RnWIhE2RnIhES2_S4_EEP6MemoryS6_R5StateT_T0_T1_T2_(%struct.Memory* %14, %struct.State* %0, i8* %AH, i64 %16, i8* %AL, i64 %18)
...
entry:
  ...
  %call = call %struct.Memory* @routine_xaddb_rh_r8(%struct.State* %state, i64 0, %struct.Memory* %mem)
  ret i32 0
}