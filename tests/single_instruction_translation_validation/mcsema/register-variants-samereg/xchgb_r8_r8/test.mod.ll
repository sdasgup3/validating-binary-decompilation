...
block_530:
  ...
  %15 = add i64 %14, 2
  store i64 %15, i64* %PC
  %16 = call %struct.Memory* @_ZN12_GLOBAL__N_1L4XCHGI3RnWIhE2RnIhES2_S4_EEP6MemoryS6_R5StateT_T0_T1_T2_(%struct.Memory* %2, %struct.State* %0, i8* %AL, i64 %11, i8* %AL, i64 %13)
