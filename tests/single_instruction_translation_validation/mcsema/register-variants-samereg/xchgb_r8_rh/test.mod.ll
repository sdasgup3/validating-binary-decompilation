...
define internal %struct.Memory* @_ZN12_GLOBAL__N_1L4XCHGI3RnWIhE2RnIhES2_S4_EEP6MemoryS6_R5StateT_T0_T1_T2_(%struct.Memory* readnone returned, %struct.State* nocapture readnone dereferenceable(3376), i8* nocapture, i64, i8* nocapture, i64) #2 {
  %7 = trunc i64 %3 to i8
  %8 = trunc i64 %5 to i8
...
define %struct.Memory* @routine_xchgb_r8_rh(%struct.State*  dereferenceable(3376), i64, %struct.Memory* ) #19 {
block_530:
  ...
  %19 = add i64 %18, 2
  store i64 %19, i64* %PC
  %20 = call %struct.Memory* @_ZN12_GLOBAL__N_1L4XCHGI3RnWIhE2RnIhES2_S4_EEP6MemoryS6_R5StateT_T0_T1_T2_(%struct.Memory* %2, %struct.State* %0, i8* %AL, i64 %15, i8* %AH, i64 %17)
...
entry:
  ...
  %call = call %struct.Memory* @routine_xchgb_r8_rh(%struct.State* %state, i64 0, %struct.Memory* %mem)
  ret i32 0
}