...
define internal %struct.Memory* @_ZN12_GLOBAL__N_1L3BSRI3RnWImE2RnImEEEP6MemoryS6_R5StateT_T0_(%struct.Memory* readnone returned, %struct.State* nocapture dereferenceable(3376), i64* nocapture, i64) #0 {
  %5 = tail call i64 @my.ctlz.i64(i64 %3, i1 true) #22
  %6 = sub  i64 64, %5
  %7 = add  i64 %6, -1
...
define %struct.Memory* @routine_bsrq_r64_r64(%struct.State*  dereferenceable(3376), i64, %struct.Memory* ) #19 {
block_530:
  ...
  %14 = add i64 %13, 4
  store i64 %14, i64* %PC
  %15 = call %struct.Memory* @_ZN12_GLOBAL__N_1L3BSRI3RnWImE2RnImEEEP6MemoryS6_R5StateT_T0_(%struct.Memory* %2, %struct.State* %0, i64* %RBX, i64 %12)
...
entry:
  ...
  %call = call %struct.Memory* @routine_bsrq_r64_r64(%struct.State* %state, i64 0, %struct.Memory* %mem)
  ret i32 0
}