...
define internal %struct.Memory* @_ZN12_GLOBAL__N_1L3BSRI3RnWItE2RnItEEEP6MemoryS6_R5StateT_T0_(%struct.Memory* readnone returned, %struct.State* nocapture dereferenceable(3376), i16* nocapture, i64) #0 {
  %5 = trunc i64 %3 to i16
  %6 = trunc i64 %3 to i32
  %7 = and i32 %6, 65535
  %8 = tail call i32 @my.ctlz.i32(i32 %7, i1 true) #22
  %9 = add   i32 %8, 65520
  ...
  %23 = tail call i32 @my.ctpop.i32(i32 %22) #22
...
define %struct.Memory* @routine_bsrw_r16_r16(%struct.State*  dereferenceable(3376), i64, %struct.Memory* ) #19 {
block_530:
  ...
  %15 = add i64 %14, 4
  store i64 %15, i64* %PC
  %16 = call %struct.Memory* @_ZN12_GLOBAL__N_1L3BSRI3RnWItE2RnItEEEP6MemoryS6_R5StateT_T0_(%struct.Memory* %2, %struct.State* %0, i16* %BX, i64 %13)
...
entry:
  ...
  %call = call %struct.Memory* @routine_bsrw_r16_r16(%struct.State* %state, i64 0, %struct.Memory* %mem)
  ret i32 0
}