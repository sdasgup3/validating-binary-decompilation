...
define internal %struct.Memory* @_ZN12_GLOBAL__N_1L8BSWAP_32EP6MemoryR5State3RnWImE2RnIjE(%struct.Memory* readnone returned, %struct.State* nocapture readnone dereferenceable(3376), i64* nocapture, i64) #0 {
  ...
  %6 = tail call i32 @my.bswap.i32(i32 %5)
  %7 = zext i32 %6 to i64
  store i64 %7, i64* %2, align 8
  ret %struct.Memory* %0
}

define %struct.Memory* @routine_bswap_r32(%struct.State*  dereferenceable(3376), i64, %struct.Memory* ) #19 {
block_530:
  ...
  %11 = add i64 %10, 2
  store i64 %11, i64* %PC
  %12 = call %struct.Memory* @_ZN12_GLOBAL__N_1L8BSWAP_32EP6MemoryR5State3RnWImE2RnIjE(%struct.Memory* %2, %struct.State* %0, i64* %RBX, i64 %9)
...
entry:
  ...
  %call = call %struct.Memory* @routine_bswap_r32(%struct.State* %state, i64 0, %struct.Memory* %mem)
  ret i32 0
}