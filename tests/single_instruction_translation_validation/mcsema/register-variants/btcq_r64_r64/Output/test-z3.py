...
lvar = (V_F == z3.Extract(0, 0, z3.Extract(7, 0, z3.If(z3.Not((((z3.BitVecVal(1, 64) << (VL_RCX & z3.BitVecVal(63, 64))) & VL_RBX) == z3.BitVecVal(0, 64))), z3.BitVecVal(1, 8), z3.BitVecVal(0, 8)))))
