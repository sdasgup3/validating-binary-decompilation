...
define internal %struct.Memory* @_ZN12_GLOBAL__N_1L6BTCregI3RnWImE2RnImES4_EEP6MemoryS6_R5StateT_T0_T1_(%struct.Memory* readnone returned, %struct.State* nocapture dereferenceable(3376), i64* nocapture, i64, i64) #2 {
  %6 = and i64 %4, 63
  %7 = shl i64 1, %6
  %8 = xor i64 %7, %3
...
define %struct.Memory* @routine_btcq_r64_r64(%struct.State*  dereferenceable(3376), i64, %struct.Memory* ) #19 {
block_530:
  ...
  %15 = add i64 %14, 4
  store i64 %15, i64* %PC
  %16 = call %struct.Memory* @_ZN12_GLOBAL__N_1L6BTCregI3RnWImE2RnImES4_EEP6MemoryS6_R5StateT_T0_T1_(%struct.Memory* %2, %struct.State* %0, i64* %RBX, i64 %12, i64 %13)
...
entry:
  ...
  %call = call %struct.Memory* @routine_btcq_r64_r64(%struct.State* %state, i64 0, %struct.Memory* %mem)
  ret i32 0
}