...
lvar = (V_F == z3.Extract(0, 0, z3.Extract(7, 0, z3.If(z3.Not((((z3.BitVecVal(1, 32) << (z3.Concat(z3.Extract(31, 24, VL_RCX),z3.Extract(23, 16, VL_RCX),z3.Extract(15, 8, VL_RCX),z3.Extract(7, 0, VL_RCX),) & z3.BitVecVal(31, 32))) & z3.Concat(z3.Extract(31, 24, VL_RBX),z3.Extract(23, 16, VL_RBX),z3.Extract(15, 8, VL_RBX),z3.Extract(7, 0, VL_RBX),)) == z3.BitVecVal(0, 32))), z3.BitVecVal(1, 8), z3.BitVecVal(0, 8)))))
