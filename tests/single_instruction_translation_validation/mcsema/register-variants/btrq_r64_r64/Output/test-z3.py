...
lvar = (V_R == z3.Concat(z3.Extract(63, 56, (((z3.BitVecVal(1, 64) << (VL_RCX & z3.BitVecVal(63, 64))) ^ z3.BitVecVal(-1, 64)) & VL_RBX)), z3.Extract(55, 48, (((z3.BitVecVal(1, 64) << (VL_RCX & z3.BitVecVal(63, 64))) ^ z3.BitVecVal(-1, 64)) & VL_RBX)), z3.Extract(47, 40, (((z3.BitVecVal(1, 64) << (VL_RCX & z3.BitVecVal(63, 64))) ^ z3.BitVecVal(-1, 64)) & VL_RBX)), z3.Extract(39, 32, (((z3.BitVecVal(1, 64) << (VL_RCX & z3.BitVecVal(63, 64))) ^ z3.BitVecVal(-1, 64)) & VL_RBX)), z3.Extract(31, 24, (((z3.BitVecVal(1, 64) << (VL_RCX & z3.BitVecVal(63, 64))) ^ z3.BitVecVal(-1, 64)) & VL_RBX)), z3.Extract(23, 16, (((z3.BitVecVal(1, 64) << (VL_RCX & z3.BitVecVal(63, 64))) ^ z3.BitVecVal(-1, 64)) & VL_RBX)), z3.Extract(15, 8, (((z3.BitVecVal(1, 64) << (VL_RCX & z3.BitVecVal(63, 64))) ^ z3.BitVecVal(-1, 64)) & VL_RBX)), z3.Extract(7, 0, (((z3.BitVecVal(1, 64) << (VL_RCX & z3.BitVecVal(63, 64))) ^ z3.BitVecVal(-1, 64)) & VL_RBX))))
