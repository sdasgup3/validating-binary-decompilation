...
lvar = (V_F == z3.Extract(0, 0, z3.Extract(7, 0, z3.Concat(z3.BitVecVal(0, 7), z3.Extract(0, 0, z3.If(z3.Not((((((z3.BitVecVal(1, 64) << ((z3.Concat(z3.BitVecVal(0, 48), z3.Concat(z3.Extract(15, 8, VL_RCX),z3.Extract(7, 0, VL_RCX),)) & z3.BitVecVal(15, 64)) & z3.BitVecVal(18446744073709551616 - 1, 64))) & z3.BitVecVal(18446744073709551616 - 1, 64)) & z3.Concat(z3.BitVecVal(0, 48), z3.Concat(z3.Extract(15, 8, VL_RBX),z3.Extract(7, 0, VL_RBX),))) & z3.BitVecVal(18446744073709551616 - 1, 64)) == z3.BitVecVal(0, 64))), z3.BitVecVal(1, 8), z3.BitVecVal(0, 8)))))))

xvar = (V_F == z3.Extract(0, 0, z3.LShR(z3.Extract(15, 0, VX_RBX), (z3.Extract(15, 0, VX_RCX) & z3.BitVecVal(15, 16)))))
...
lvar = (V_R == z3.Concat(z3.Extract(63, 56, VL_RBX), z3.Extract(55, 48, VL_RBX), z3.Extract(47, 40, VL_RBX), z3.Extract(39, 32, VL_RBX), z3.Extract(31, 24, VL_RBX), z3.Extract(23, 16, VL_RBX), z3.Extract(15, 8, (((((z3.BitVecVal(1, 64) << ((z3.Concat(z3.BitVecVal(0, 48), z3.Concat(z3.Extract(15, 8, VL_RCX),z3.Extract(7, 0, VL_RCX),)) & z3.BitVecVal(15, 64)) & z3.BitVecVal(18446744073709551616 - 1, 64))) & z3.BitVecVal(18446744073709551616 - 1, 64)) | z3.Concat(z3.BitVecVal(0, 48), z3.Concat(z3.Extract(15, 8, VL_RBX),z3.Extract(7, 0, VL_RBX),))) & z3.BitVecVal(18446744073709551616 - 1, 64)) & z3.BitVecVal(65536 - 1, 64))), z3.Extract(7, 0, (((((z3.BitVecVal(1, 64) << ((z3.Concat(z3.BitVecVal(0, 48), z3.Concat(z3.Extract(15, 8, VL_RCX),z3.Extract(7, 0, VL_RCX),)) & z3.BitVecVal(15, 64)) & z3.BitVecVal(18446744073709551616 - 1, 64))) & z3.BitVecVal(18446744073709551616 - 1, 64)) | z3.Concat(z3.BitVecVal(0, 48), z3.Concat(z3.Extract(15, 8, VL_RBX),z3.Extract(7, 0, VL_RBX),))) & z3.BitVecVal(18446744073709551616 - 1, 64)) & z3.BitVecVal(65536 - 1, 64)))))

xvar = (V_R == z3.Concat(z3.Extract(63, 16, VX_RBX), (z3.Extract(15, 0, VX_RBX) | z3.Extract(15, 0, (z3.BitVecVal(1, 16) << (z3.Extract(15, 0, VX_RCX) & z3.BitVecVal(15, 16)))))))
