...
lvar = z3.And(
	...
	z3.Implies(
		((z3.If((VL_ZF == z3.BitVecVal(0, 8)), z3.BitVecVal(1, 8), z3.BitVecVal(0, 8)) & ((z3.If(z3.Not((VL_SF == z3.BitVecVal(0, 8))), z3.BitVecVal(1, 8), z3.BitVecVal(0, 8)) ^ z3.If(z3.Not((VL_OF == z3.BitVecVal(0, 8))), z3.BitVecVal(1, 8), z3.BitVecVal(0, 8))) ^ z3.BitVecVal(1, 8))) == z3.BitVecVal(0, 8)),
		V_F == z3.Extract(0, 0, z3.Extract(7, 0, VL_AF))
	), 
	z3.Implies(
		(((z3.If((VL_ZF == z3.BitVecVal(0, 8)), z3.BitVecVal(1, 8), z3.BitVecVal(0, 8)) & ((z3.If(z3.Not((VL_SF == z3.BitVecVal(0, 8))), z3.BitVecVal(1, 8), z3.BitVecVal(0, 8)) ^ z3.If(z3.Not((VL_OF == z3.BitVecVal(0, 8))), z3.BitVecVal(1, 8), z3.BitVecVal(0, 8))) ^ z3.BitVecVal(1, 8))) == z3.BitVecVal(0, 8)) == False),
		V_F == z3.Extract(0, 0, z3.Extract(7, 0, VL_AF))
	), 
)
