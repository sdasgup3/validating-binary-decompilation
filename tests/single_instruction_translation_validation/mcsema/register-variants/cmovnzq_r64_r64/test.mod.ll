...
define %struct.Memory* @routine_cmovnzq_r64_r64(%struct.State*  dereferenceable(3376), i64, %struct.Memory* ) #19 {
block_530:
  ...
  %14 = add i64 %13, 4
  store i64 %14, i64* %PC
  %15 = call %struct.Memory* @_ZN12_GLOBAL__N_1L6CMOVNZI3RnWImE2RnImEEEP6MemoryS6_R5StateT_T0_(%struct.Memory* %2, %struct.State* %0, i64* %RBX, i64 %12)
...
entry:
  ...
  %call = call %struct.Memory* @routine_cmovnzq_r64_r64(%struct.State* %state, i64 0, %struct.Memory* %mem)
  ret i32 0
}