...
lvar = z3.And(
	...
	z3.Implies(
		(z3.If(z3.Not((VL_OF == z3.BitVecVal(0, 8))), z3.BitVecVal(1, 8), z3.BitVecVal(0, 8)) == z3.BitVecVal(0, 8)),
		V_F == z3.Extract(0, 0, z3.Extract(7, 0, VL_AF))
	), 
	z3.Implies(
		((z3.If(z3.Not((VL_OF == z3.BitVecVal(0, 8))), z3.BitVecVal(1, 8), z3.BitVecVal(0, 8)) == z3.BitVecVal(0, 8)) == False),
		V_F == z3.Extract(0, 0, z3.Extract(7, 0, VL_AF))
	), 
)
...
xvar = (V_R == z3.Concat(z3.Extract(63, 16, VX_RBX), z3.If((VX_OF == z3.BitVecVal(1, 1)), z3.Extract(15, 0, VX_RCX), z3.Extract(15, 0, VX_RBX))))
