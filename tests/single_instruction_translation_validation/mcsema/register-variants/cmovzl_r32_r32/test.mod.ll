...
define %struct.Memory* @routine_cmovzl_r32_r32(%struct.State* noalias dereferenceable(3376), i64, %struct.Memory* noalias) #19 {
block_530:
  ...
  %15 = add i64 %14, 3
  store i64 %15, i64* %PC
  %16 = call %struct.Memory* @_ZN12_GLOBAL__N_1L5CMOVZI3RnWImE2RnIjEEEP6MemoryS6_R5StateT_T0_(%struct.Memory* %2, %struct.State* %0, i64* %RBX, i64 %13)
...
entry:
  ...
  %call = call %struct.Memory* @routine_cmovzl_r32_r32(%struct.State* %state, i64 0, %struct.Memory* %mem)
  ret i32 0
}