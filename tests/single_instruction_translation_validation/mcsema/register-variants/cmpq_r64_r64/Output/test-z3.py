...
lvar = (V_F == z3.Extract(0, 0, z3.Extract(7, 0, ((z3.LShR(((VL_RCX ^ VL_RBX) ^ (VL_RBX - VL_RCX)), z3.BitVecVal(4, 64)) & z3.BitVecVal(256 - 1, 64)) & z3.BitVecVal(1, 64)))))
...
lvar = (V_F == z3.Extract(0, 0, z3.Extract(7, 0, z3.If((((z3.LShR((VL_RBX - VL_RCX), z3.BitVecVal(63, 64)) ^ z3.LShR(VL_RBX, z3.BitVecVal(63, 64))) + (z3.LShR(VL_RCX, z3.BitVecVal(63, 64)) ^ z3.LShR(VL_RBX, z3.BitVecVal(63, 64)))) == z3.BitVecVal(2, 64)), z3.BitVecVal(1, 8), z3.BitVecVal(0, 8)))))
