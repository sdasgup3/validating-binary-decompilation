...
define internal %struct.Memory* @_ZN12_GLOBAL__N_1L8CVTDQ2PSI3VnWI8vec128_tE2VnIS2_ELm4EEEP6MemoryS7_R5StateT_T0_(%struct.Memory* readnone returned, %struct.State* nocapture readnone dereferenceable(3376), i8* nocapture, i8* nocapture readonly) #0 {
  ...
  call void @my.lifetime.start(i64 16, i8* nonnull %11)
  ...
  call void @my.lifetime.end(i64 16, i8* nonnull %11)
  %22 = lshr i64 %7, 32
...
define %struct.Memory* @routine_cvtdq2ps_xmm_xmm(%struct.State*  dereferenceable(3376), i64, %struct.Memory* ) #19 {
block_530:
  ...
  %13 = add i64 %12, 3
  store i64 %13, i64* %PC
  %14 = call %struct.Memory* @_ZN12_GLOBAL__N_1L8CVTDQ2PSI3VnWI8vec128_tE2VnIS2_ELm4EEEP6MemoryS7_R5StateT_T0_(%struct.Memory* %2, %struct.State* %0, i8* %10, i8* %11)
...
entry:
  ...
  %call = call %struct.Memory* @routine_cvtdq2ps_xmm_xmm(%struct.State* %state, i64 0, %struct.Memory* %mem)
  ret i32 0
}