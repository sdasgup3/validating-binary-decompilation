...
define internal %struct.Memory* @_ZN12_GLOBAL__N_1L8CVTPD2DQI3VnWI8vec128_tE2VnIS2_ELm2EXadL_ZNS_L17FRoundUsingMode64EdEEEEP6MemoryS7_R5StateT_T0_(%struct.Memory* readnone returned, %struct.State* nocapture readnone dereferenceable(3376), i8* nocapture, i8* nocapture readonly) #0 {
  ...
  %16 = tail call double @my.nearbyint.f64(double %8) #22
  %17 = tail call double @my.fabs.f64(double %16) #22
  ...
  %23 = tail call double @my.nearbyint.f64(double %11) #22
  %24 = tail call double @my.fabs.f64(double %23) #22
...
define %struct.Memory* @routine_cvtpd2dq_xmm_xmm(%struct.State*  dereferenceable(3376), i64, %struct.Memory* ) #19 {
block_530:
  ...
  %13 = add i64 %12, 4
  store i64 %13, i64* %PC
  %14 = call %struct.Memory* @_ZN12_GLOBAL__N_1L8CVTPD2DQI3VnWI8vec128_tE2VnIS2_ELm2EXadL_ZNS_L17FRoundUsingMode64EdEEEEP6MemoryS7_R5StateT_T0_(%struct.Memory* %2, %struct.State* %0, i8* %10, i8* %11)
...
entry:
  ...
  %call = call %struct.Memory* @routine_cvtpd2dq_xmm_xmm(%struct.State* %state, i64 0, %struct.Memory* %mem)
  ret i32 0
}