...
define internal %struct.Memory* @_ZN12_GLOBAL__N_1L8CVTPD2DQI3VnWI8vec128_tE2VnIS2_ELm2EXadL_ZNS_L18FTruncTowardZero64EdEEEEP6MemoryS7_R5StateT_T0_(%struct.Memory* readnone returned, %struct.State* nocapture readnone dereferenceable(3376), i8* nocapture, i8* nocapture readonly) #0 {
  ...
  %16 = tail call double @my.trunc.f64(double %8) #22
  ...
  %23 = tail call double @my.trunc.f64(double %11) #22
...
define %struct.Memory* @routine_cvttpd2dq_xmm_xmm(%struct.State*  dereferenceable(3376), i64, %struct.Memory* ) #19 {
block_530:
