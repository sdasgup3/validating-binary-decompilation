...
define internal %struct.Memory* @_ZN12_GLOBAL__N_1L8CVTPS2DQI3VnWI8vec128_tE2VnIS2_ELm4EXadL_ZNS_L18FTruncTowardZero32EfEEEEP6MemoryS7_R5StateT_T0_(%struct.Memory* readnone returned, %struct.State* nocapture readnone dereferenceable(3376), i8* nocapture, i8* nocapture readonly) #0 {
  ...
  %18 = tail call float @my.trunc.f32(float %17) #22
  ...
  %28 = tail call float @my.trunc.f32(float %27) #22
  ...
  %37 = tail call float @my.trunc.f32(float %36) #22
  ...
  %48 = tail call float @my.trunc.f32(float %47) #22
...
define %struct.Memory* @routine_cvttps2dq_xmm_xmm(%struct.State*  dereferenceable(3376), i64, %struct.Memory* ) #19 {
block_530:
