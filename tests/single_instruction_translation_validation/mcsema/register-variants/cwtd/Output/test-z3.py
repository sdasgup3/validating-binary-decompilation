...
lvar = (V_R == z3.Concat(z3.Extract(63, 56, VL_RDX), z3.Extract(55, 48, VL_RDX), z3.Extract(47, 40, VL_RDX), z3.Extract(39, 32, VL_RDX), z3.Extract(31, 24, VL_RDX), z3.Extract(23, 16, VL_RDX), z3.Extract(15, 8, (z3.LShR(z3.If(z3.ULE(z3.Concat(z3.Extract(15, 8, VL_RAX),z3.Extract(7, 0, VL_RAX),), z3.BitVecVal(32767, 16)), z3.Concat(z3.Extract(15, 8, VL_RAX),z3.Extract(7, 0, VL_RAX),), ((z3.Concat(z3.Extract(15, 8, VL_RAX),z3.Extract(7, 0, VL_RAX),) + z3.BitVecVal(18446744073709551615, 16)) - z3.BitVecVal(65535, 16))), z3.BitVecVal(16, 16)) & z3.BitVecVal(65536 - 1, 16))), z3.Extract(7, 0, (z3.LShR(z3.If(z3.ULE(z3.Concat(z3.Extract(15, 8, VL_RAX),z3.Extract(7, 0, VL_RAX),), z3.BitVecVal(32767, 16)), z3.Concat(z3.Extract(15, 8, VL_RAX),z3.Extract(7, 0, VL_RAX),), ((z3.Concat(z3.Extract(15, 8, VL_RAX),z3.Extract(7, 0, VL_RAX),) + z3.BitVecVal(18446744073709551615, 16)) - z3.BitVecVal(65535, 16))), z3.BitVecVal(16, 16)) & z3.BitVecVal(65536 - 1, 16)))))

xvar = (V_R == z3.Concat(z3.Extract(63, 16, VX_RDX), z3.Extract(31, 16, z3.SignExt(16, z3.Extract(15, 0, VX_RAX)))))
