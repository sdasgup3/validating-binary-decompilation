...
define internal %struct.Memory* @_ZN12_GLOBAL__N_1L3INCI3RnWIhE2RnIhEEEP6MemoryS6_R5StateT_T0_(%struct.Memory* readnone returned, %struct.State* nocapture dereferenceable(3376), i8* nocapture, i64) #0 {
  %5 = trunc i64 %3 to i8
  %6 = add i8 %5, 1
...
define %struct.Memory* @routine_incb_r8(%struct.State*  dereferenceable(3376), i64, %struct.Memory* ) #19 {
block_530:
  ...
  %13 = add i64 %12, 2
  store i64 %13, i64* %PC
  %14 = call %struct.Memory* @_ZN12_GLOBAL__N_1L3INCI3RnWIhE2RnIhEEEP6MemoryS6_R5StateT_T0_(%struct.Memory* %2, %struct.State* %0, i8* %BL, i64 %11)
...
entry:
  ...
  %call = call %struct.Memory* @routine_incb_r8(%struct.State* %state, i64 0, %struct.Memory* %mem)
  ret i32 0
}