...
define %struct.Memory* @routine_movb_rh_rh(%struct.State*  dereferenceable(3376), i64, %struct.Memory* ) #19 {
block_530:
  ...
  %17 = add i64 %16, 2
  store i64 %17, i64* %PC
  %18 = call %struct.Memory* @_ZN12_GLOBAL__N_1L3MOVI3RnWIhE2RnIhEEEP6MemoryS6_R5StateT_T0_(%struct.Memory* %2, %struct.State* %0, i8* %AH, i64 %15)
...
entry:
  ...
  %call = call %struct.Memory* @routine_movb_rh_rh(%struct.State* %state, i64 0, %struct.Memory* %mem)
  ret i32 0
}