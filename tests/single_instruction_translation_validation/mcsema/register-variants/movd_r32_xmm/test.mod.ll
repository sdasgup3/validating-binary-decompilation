...
define %struct.Memory* @routine_movd_r32_xmm(%struct.State*  dereferenceable(3376), i64, %struct.Memory* ) #19 {
block_530:
  ...
  %13 = add i64 %12, 4
  store i64 %13, i64* %PC
  %14 = call %struct.Memory* @_ZN12_GLOBAL__N_1L4MOVDI4RVnWI7vec64_tE2VnI8vec128_tEEEP6MemoryS8_R5StateT_T0_(%struct.Memory* %2, %struct.State* %0, i64* %RBX, i8* %11)
...
entry:
  ...
  %call = call %struct.Memory* @routine_movd_r32_xmm(%struct.State* %state, i64 0, %struct.Memory* %mem)
  ret i32 0
}