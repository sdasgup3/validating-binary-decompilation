...
define internal %struct.Memory* @_ZN12_GLOBAL__N_1L5MOVSXI3RnWItE2RnIhEsEEP6MemoryS6_R5StateT_T0_(%struct.Memory* readnone returned, %struct.State* nocapture readnone dereferenceable(3376), i16* nocapture, i64) #2 {
...
define %struct.Memory* @routine_movsbw_r16_r8(%struct.State*  dereferenceable(3376), i64, %struct.Memory* ) #19 {
block_530:
  ...
  %16 = add i64 %15, 4
  store i64 %16, i64* %PC
  %17 = call %struct.Memory* @_ZN12_GLOBAL__N_1L5MOVSXI3RnWItE2RnIhEsEEP6MemoryS6_R5StateT_T0_(%struct.Memory* %2, %struct.State* %0, i16* %BX, i64 %14)
...
entry:
  ...
  %call = call %struct.Memory* @routine_movsbw_r16_r8(%struct.State* %state, i64 0, %struct.Memory* %mem)
  ret i32 0
}