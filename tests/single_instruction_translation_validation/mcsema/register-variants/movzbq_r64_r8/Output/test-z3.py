...
lvar = (V_R == z3.Concat(z3.Extract(63, 56, z3.Concat(z3.BitVecVal(0, 56), (z3.Extract(7, 0, VL_RCX) & z3.BitVecVal(255, 8)))), z3.Extract(55, 48, z3.Concat(z3.BitVecVal(0, 56), (z3.Extract(7, 0, VL_RCX) & z3.BitVecVal(255, 8)))), z3.Extract(47, 40, z3.Concat(z3.BitVecVal(0, 56), (z3.Extract(7, 0, VL_RCX) & z3.BitVecVal(255, 8)))), z3.Extract(39, 32, z3.Concat(z3.BitVecVal(0, 56), (z3.Extract(7, 0, VL_RCX) & z3.BitVecVal(255, 8)))), z3.Extract(31, 24, z3.Concat(z3.BitVecVal(0, 56), (z3.Extract(7, 0, VL_RCX) & z3.BitVecVal(255, 8)))), z3.Extract(23, 16, z3.Concat(z3.BitVecVal(0, 56), (z3.Extract(7, 0, VL_RCX) & z3.BitVecVal(255, 8)))), z3.Extract(15, 8, z3.Concat(z3.BitVecVal(0, 56), (z3.Extract(7, 0, VL_RCX) & z3.BitVecVal(255, 8)))), z3.Extract(7, 0, z3.Concat(z3.BitVecVal(0, 56), (z3.Extract(7, 0, VL_RCX) & z3.BitVecVal(255, 8))))))
