...
lvar = (V_R == z3.Concat(z3.Extract(63, 56, VL_RBX), z3.Extract(55, 48, VL_RBX), z3.Extract(47, 40, VL_RBX), z3.Extract(39, 32, VL_RBX), z3.Extract(31, 24, VL_RBX), z3.Extract(23, 16, VL_RBX), z3.Extract(15, 8, (((z3.Concat(z3.BitVecVal(0, 56), z3.Extract(15, 8, VL_RAX)) & z3.BitVecVal(65536 - 1, 64)) & z3.BitVecVal(255, 64)) & z3.BitVecVal(65536 - 1, 64))), z3.Extract(7, 0, (((z3.Concat(z3.BitVecVal(0, 56), z3.Extract(15, 8, VL_RAX)) & z3.BitVecVal(65536 - 1, 64)) & z3.BitVecVal(255, 64)) & z3.BitVecVal(65536 - 1, 64)))))

xvar = (V_R == z3.Concat(z3.Extract(63, 16, VX_RBX), z3.Concat(z3.BitVecVal(0, 8), z3.Extract(15, 8, VX_RAX))))
