...
define internal %struct.Memory* @_ZN12_GLOBAL__N_1L4MULXI3RnWImE2RnIjEEEP6MemoryS6_R5StateT_S9_T0_(%struct.Memory* readnone returned, %struct.State* nocapture readonly dereferenceable(3376), i64* nocapture, i64* nocapture, i64) #2 {
...
define %struct.Memory* @routine_mulxl_r32_r32_r32(%struct.State*  dereferenceable(3376), i64, %struct.Memory* ) #19 {
block_530:
  ...
  %18 = add i64 %17, 5
  store i64 %18, i64* %PC
  %19 = call %struct.Memory* @_ZN12_GLOBAL__N_1L4MULXI3RnWImE2RnIjEEEP6MemoryS6_R5StateT_S9_T0_(%struct.Memory* %2, %struct.State* %0, i64* %RAX, i64* %RBX, i64 %16)
...
entry:
  ...
  %call = call %struct.Memory* @routine_mulxl_r32_r32_r32(%struct.State* %state, i64 0, %struct.Memory* %mem)
  ret i32 0
}