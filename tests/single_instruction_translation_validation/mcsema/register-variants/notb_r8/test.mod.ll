...
define %struct.Memory* @routine_notb_r8(%struct.State*  dereferenceable(3376), i64, %struct.Memory* ) #19 {
block_530:
  ...
  %13 = add i64 %12, 2
  store i64 %13, i64* %PC
  %14 = call %struct.Memory* @_ZN12_GLOBAL__N_1L3NOTI3RnWIhE2RnIhEEEP6MemoryS6_R5StateT_T0_(%struct.Memory* %2, %struct.State* %0, i8* %BL, i64 %11)
...
entry:
  ...
  %call = call %struct.Memory* @routine_notb_r8(%struct.State* %state, i64 0, %struct.Memory* %mem)
  ret i32 0
}