...
define internal %struct.Memory* @_ZN12_GLOBAL__N_1L9PUNPCKLDQI3VnWI8vec128_tE2VnIS2_ES5_EEP6MemoryS7_R5StateT_T0_T1_(%struct.Memory* readnone returned, %struct.State* nocapture readnone dereferenceable(3376), i8* nocapture, i8* nocapture readonly, i8* nocapture readonly) #0 {
  ...
  call void @my.lifetime.start(i64 16, i8* nonnull %16)
  store i64 %22, i64* %17, align 8
  store i64 0, i64* %18, align 8
  %24 = getelementptr inbounds [4 x i32], [4 x i32]* %19, i64 0, i64 1
  store i32 %23, i32* %24, align 4
  %25 = load i64, i64* %17, align 8
  call void @my.lifetime.end(i64 16, i8* nonnull %16)
  %26 = lshr i64 %10, 32
...
define %struct.Memory* @routine_punpckldq_xmm_xmm(%struct.State*  dereferenceable(3376), i64, %struct.Memory* ) #19 {
block_530:
  ...
  %14 = add i64 %13, 4
  store i64 %14, i64* %PC
  %15 = call %struct.Memory* @_ZN12_GLOBAL__N_1L9PUNPCKLDQI3VnWI8vec128_tE2VnIS2_ES5_EEP6MemoryS7_R5StateT_T0_T1_(%struct.Memory* %2, %struct.State* %0, i8* %10, i8* %11, i8* %12)
...
entry:
  ...
  %call = call %struct.Memory* @routine_punpckldq_xmm_xmm(%struct.State* %state, i64 0, %struct.Memory* %mem)
  ret i32 0
}