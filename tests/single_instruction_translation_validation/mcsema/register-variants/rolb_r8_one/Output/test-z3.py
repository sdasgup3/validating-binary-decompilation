...
lvar = (V_F == z3.Extract(0, 0, z3.Extract(7, 0, (((z3.LShR((z3.Extract(7, 0, VL_RBX) & z3.BitVecVal(255, 8)), z3.BitVecVal(7, 8)) | ((z3.Extract(7, 0, VL_RBX) & z3.BitVecVal(255, 8)) << z3.BitVecVal(1, 8))) & z3.BitVecVal(256 - 1, 8)) & z3.BitVecVal(1, 8)))))
...
lvar = (V_F == z3.Extract(0, 0, z3.Extract(7, 0, (z3.If(z3.Or(z3.ULT(((z3.LShR((z3.Extract(7, 0, VL_RBX) & z3.BitVecVal(255, 8)), z3.BitVecVal(7, 8)) | ((z3.Extract(7, 0, VL_RBX) & z3.BitVecVal(255, 8)) << z3.BitVecVal(1, 8))) & z3.BitVecVal(256 - 1, 8)), z3.BitVecVal(0, 8)), z3.And(z3.ULT(z3.BitVecVal(0, 8), ((z3.LShR((z3.Extract(7, 0, VL_RBX) & z3.BitVecVal(255, 8)), z3.BitVecVal(7, 8)) | ((z3.Extract(7, 0, VL_RBX) & z3.BitVecVal(255, 8)) << z3.BitVecVal(1, 8))) & z3.BitVecVal(256 - 1, 8))), z3.UGT(((z3.LShR((z3.Extract(7, 0, VL_RBX) & z3.BitVecVal(255, 8)), z3.BitVecVal(7, 8)) | ((z3.Extract(7, 0, VL_RBX) & z3.BitVecVal(255, 8)) << z3.BitVecVal(1, 8))) & z3.BitVecVal(256 - 1, 8)), z3.BitVecVal(127, 8)))), z3.BitVecVal(1, 8), z3.BitVecVal(0, 8)) ^ z3.If(z3.Not(((((z3.LShR((z3.Extract(7, 0, VL_RBX) & z3.BitVecVal(255, 8)), z3.BitVecVal(7, 8)) | ((z3.Extract(7, 0, VL_RBX) & z3.BitVecVal(255, 8)) << z3.BitVecVal(1, 8))) & z3.BitVecVal(256 - 1, 8)) & z3.BitVecVal(1, 8)) == z3.BitVecVal(0, 8))), z3.BitVecVal(1, 8), z3.BitVecVal(0, 8))))))
