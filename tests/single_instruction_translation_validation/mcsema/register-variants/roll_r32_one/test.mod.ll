...
define %struct.Memory* @routine_roll_r32_one(%struct.State*  dereferenceable(3376), i64, %struct.Memory* ) #19 {
block_530:
  ...
  %11 = add i64 %10, 2
  store i64 %11, i64* %PC
  %12 = call %struct.Memory* @_ZN12_GLOBAL__N_1L3ROLI3RnWImE2RnIjE2InIjEEEP6MemoryS8_R5StateT_T0_T1_(%struct.Memory* %2, %struct.State* %0, i64* %RBX, i64 %9, i64 1)
...
entry:
  ...
  %call = call %struct.Memory* @routine_roll_r32_one(%struct.State* %state, i64 0, %struct.Memory* %mem)
  ret i32 0
}