...
lvar = (V_R == z3.Concat(z3.Extract(63, 56, VL_RAX), z3.Extract(55, 48, VL_RAX), z3.Extract(47, 40, VL_RAX), z3.Extract(39, 32, VL_RAX), z3.Extract(31, 24, VL_RAX), z3.Extract(23, 16, VL_RAX), z3.Extract(7, 0, VL_ZF), z3.Extract(7, 0, VL_RAX)))

xvar = (V_R == z3.Concat(z3.Concat(z3.Extract(63, 16, VX_RAX), z3.If((VX_ZF == z3.BitVecVal(1, 1)), z3.BitVecVal(1, 8), z3.BitVecVal(0, 8))), z3.Extract(7, 0, VX_RAX)))
