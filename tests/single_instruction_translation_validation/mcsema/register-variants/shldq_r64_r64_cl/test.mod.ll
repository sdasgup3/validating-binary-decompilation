...
define internal %struct.Memory* @_ZN12_GLOBAL__N_1L4SHLDI3RnWImE2RnImES4_S4_EEP6MemoryS6_R5StateT_T0_T1_T2_(%struct.Memory* readnone, %struct.State* nocapture dereferenceable(3376), i64* nocapture, i64, i64, i64) #0 {
  %7 = and i64 %5, 63
  %8 = icmp eq i64 %7, 0
...
define %struct.Memory* @routine_shldq_r64_r64_cl(%struct.State*  dereferenceable(3376), i64, %struct.Memory* ) #19 {
block_530:
  ...
  %21 = add i64 %20, 4
  store i64 %21, i64* %PC
  %22 = call %struct.Memory* @_ZN12_GLOBAL__N_1L4SHLDI3RnWImE2RnImES4_S4_EEP6MemoryS6_R5StateT_T0_T1_T2_(%struct.Memory* %2, %struct.State* %0, i64* %RBX, i64 %16, i64 %17, i64 %19)
...
entry:
  ...
  %call = call %struct.Memory* @routine_shldq_r64_r64_cl(%struct.State* %state, i64 0, %struct.Memory* %mem)
  ret i32 0
}