...
define internal %struct.Memory* @_ZN12_GLOBAL__N_1L3SHRI3RnWIhE2RnIhES4_EEP6MemoryS6_R5StateT_T0_T1_(%struct.Memory* readnone, %struct.State* nocapture dereferenceable(3376), i8* nocapture, i64, i64) #0 {
  %6 = trunc i64 %3 to i8
  %7 = trunc i64 %4 to i8
  %8 = and i8 %7, 31
  %9 = trunc i64 %4 to i5
...
define %struct.Memory* @routine_shrb_r8_cl(%struct.State*  dereferenceable(3376), i64, %struct.Memory* ) #19 {
block_530:
  ...
  %19 = add i64 %18, 2
  store i64 %19, i64* %PC
  %20 = call %struct.Memory* @_ZN12_GLOBAL__N_1L3SHRI3RnWIhE2RnIhES4_EEP6MemoryS6_R5StateT_T0_T1_(%struct.Memory* %2, %struct.State* %0, i8* %BL, i64 %15, i64 %17)
...
entry:
  ...
  %call = call %struct.Memory* @routine_shrb_r8_cl(%struct.State* %state, i64 0, %struct.Memory* %mem)
  ret i32 0
}