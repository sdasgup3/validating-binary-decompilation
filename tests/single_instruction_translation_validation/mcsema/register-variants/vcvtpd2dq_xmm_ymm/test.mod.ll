...
define internal %struct.Memory* @_ZN12_GLOBAL__N_1L8CVTPD2DQI3VnWI8vec256_tE2VnIS2_ELm4EXadL_ZNS_L17FRoundUsingMode64EdEEEEP6MemoryS7_R5StateT_T0_(%struct.Memory* readnone returned, %struct.State* nocapture readnone dereferenceable(3376), i8* nocapture, i8* nocapture readonly) #0 {
  ...
  %8 = call <4 x double> @my.nearbyint.v4f64(<4 x double> %7)
...
define %struct.Memory* @routine_vcvtpd2dq_xmm_ymm(%struct.State*  dereferenceable(3376), i64, %struct.Memory* ) #19 {
block_530:
  ...
  %11 = add i64 %10, 4
  store i64 %11, i64* %PC
  %12 = call %struct.Memory* @_ZN12_GLOBAL__N_1L8CVTPD2DQI3VnWI8vec256_tE2VnIS2_ELm4EXadL_ZNS_L17FRoundUsingMode64EdEEEEP6MemoryS7_R5StateT_T0_(%struct.Memory* %2, %struct.State* %0, i8* %8, i8* %9)
...
entry:
  ...
  %call = call %struct.Memory* @routine_vcvtpd2dq_xmm_ymm(%struct.State* %state, i64 0, %struct.Memory* %mem)
  ret i32 0
}