...
define internal %struct.Memory* @_ZN12_GLOBAL__N_1L9VCVTSD2SSI2VnI8vec128_tEEEP6MemoryS5_R5State3VnWI8vec256_tES8_IS2_ET_(%struct.Memory* readnone returned, %struct.State* nocapture readnone dereferenceable(3376), i8* nocapture, i8* nocapture readonly, i8* nocapture readonly) #0 {
...
define %struct.Memory* @routine_vcvtsd2ss_xmm_xmm_xmm(%struct.State*  dereferenceable(3376), i64, %struct.Memory* ) #19 {
block_530:
  ...
  %16 = add i64 %15, 4
  store i64 %16, i64* %PC
  %17 = call %struct.Memory* @_ZN12_GLOBAL__N_1L9VCVTSD2SSI2VnI8vec128_tEEEP6MemoryS5_R5State3VnWI8vec256_tES8_IS2_ET_(%struct.Memory* %2, %struct.State* %0, i8* %12, i8* %13, i8* %14)
...
entry:
  ...
  %call = call %struct.Memory* @routine_vcvtsd2ss_xmm_xmm_xmm(%struct.State* %state, i64 0, %struct.Memory* %mem)
  ret i32 0
}