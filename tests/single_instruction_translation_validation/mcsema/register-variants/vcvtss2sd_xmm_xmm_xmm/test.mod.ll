...
define internal %struct.Memory* @_ZN12_GLOBAL__N_1L9VCVTSS2SDI2VnI8vec128_tEEEP6MemoryS5_R5State3VnWI8vec256_tES3_T_(%struct.Memory* readnone returned, %struct.State* nocapture readnone dereferenceable(3376), i8* nocapture, i8* nocapture readonly, i8* nocapture readonly) #0 {
  %6 = getelementptr inbounds i8, i8* %3, i64 8
  %7 = bitcast i8* %6 to i64*
  %8 = load i64, i64* %7, align 1
  %9 = bitcast i8* %4 to <2 x float>*
  ...
  store i64 %8, i64* %15, align 1
  %16 = getelementptr inbounds i8, i8* %2, i64 16
  %17 = bitcast i8* %16 to <2 x double>*
  store <2 x double> zeroinitializer, <2 x double>* %17, align 1
  ret %struct.Memory* %0
}

define %struct.Memory* @routine_vcvtss2sd_xmm_xmm_xmm(%struct.State*  dereferenceable(3376), i64, %struct.Memory* ) #19 {
block_530:
  ...
  %16 = add i64 %15, 4
  store i64 %16, i64* %PC
  %17 = call %struct.Memory* @_ZN12_GLOBAL__N_1L9VCVTSS2SDI2VnI8vec128_tEEEP6MemoryS5_R5State3VnWI8vec256_tES3_T_(%struct.Memory* %2, %struct.State* %0, i8* %12, i8* %13, i8* %14)
...
entry:
  ...
  %call = call %struct.Memory* @routine_vcvtss2sd_xmm_xmm_xmm(%struct.State* %state, i64 0, %struct.Memory* %mem)
  ret i32 0
}