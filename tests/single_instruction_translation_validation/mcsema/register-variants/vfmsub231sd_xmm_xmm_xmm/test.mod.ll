...
define internal %struct.Memory* @_ZN12_GLOBAL__N_1L11VFMSUB231SDI3VnWI8vec256_tE2VnI8vec128_tES6_S6_EEP6MemoryS8_R5StateT_T0_T1_T2_(%struct.Memory* readnone returned, %struct.State* nocapture readnone dereferenceable(3376), i8* nocapture, i8* nocapture readonly, i8* nocapture readonly, i8* nocapture readonly) #0 {
...
define %struct.Memory* @routine_vfmsub231sd_xmm_xmm_xmm(%struct.State*  dereferenceable(3376), i64, %struct.Memory* ) #19 {
block_530:
  ...
  %17 = add i64 %16, 5
  store i64 %17, i64* %PC
  %18 = call %struct.Memory* @_ZN12_GLOBAL__N_1L11VFMSUB231SDI3VnWI8vec256_tE2VnI8vec128_tES6_S6_EEP6MemoryS8_R5StateT_T0_T1_T2_(%struct.Memory* %2, %struct.State* %0, i8* %12, i8* %13, i8* %14, i8* %15)
...
entry:
  ...
  %call = call %struct.Memory* @routine_vfmsub231sd_xmm_xmm_xmm(%struct.State* %state, i64 0, %struct.Memory* %mem)
  ret i32 0
}