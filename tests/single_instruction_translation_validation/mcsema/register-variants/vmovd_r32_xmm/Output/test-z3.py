...
lvar = (V_R == z3.Concat(z3.Extract(31, 24, z3.Concat(z3.BitVecVal(0, 24), z3.BitVecVal(0, 8))), z3.Extract(23, 16, z3.Concat(z3.BitVecVal(0, 24), z3.BitVecVal(0, 8))), z3.Extract(15, 8, z3.Concat(z3.BitVecVal(0, 24), z3.BitVecVal(0, 8))), z3.Extract(7, 0, z3.Concat(z3.BitVecVal(0, 24), z3.BitVecVal(0, 8))), z3.Extract(31, 24, (VL_YMM1_0 & z3.BitVecVal(4294967296 - 1, 64))), z3.Extract(23, 16, (VL_YMM1_0 & z3.BitVecVal(4294967296 - 1, 64))), z3.Extract(15, 8, (VL_YMM1_0 & z3.BitVecVal(4294967296 - 1, 64))), z3.Extract(7, 0, (VL_YMM1_0 & z3.BitVecVal(4294967296 - 1, 64)))))

xvar = (V_R == z3.Concat(z3.BitVecVal(0, 32), z3.Extract(31, 0, VX_YMM1)))
