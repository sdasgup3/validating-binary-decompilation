...
define internal %struct.Memory* @_ZN12_GLOBAL__N_1L6MOVDQxI3VnWI8vec256_tE2VnIS2_EEEP6MemoryS7_R5StateT_T0_(%struct.Memory* readnone returned, %struct.State* nocapture readnone dereferenceable(3376), i8* nocapture, i8* nocapture readonly) #0 {
  %5 = bitcast i8* %3 to i128*
  %6 = load i128, i128* %5, align 1
  %7 = getelementptr inbounds i8, i8* %3, i64 16
  %8 = bitcast i8* %7 to i128*
  %9 = load i128, i128* %8, align 1
  %10 = bitcast i8* %2 to i128*
  store i128 %6, i128* %10, align 1
  %11 = getelementptr inbounds i8, i8* %2, i64 16
  %12 = bitcast i8* %11 to i128*
  store i128 %9, i128* %12, align 1
  ret %struct.Memory* %0
}

define %struct.Memory* @routine_vmovdqu_ymm_ymm(%struct.State*  dereferenceable(3376), i64, %struct.Memory* ) #19 {
block_530:
  ...
  %13 = add i64 %12, 4
  store i64 %13, i64* %PC
  %14 = call %struct.Memory* @_ZN12_GLOBAL__N_1L6MOVDQxI3VnWI8vec256_tE2VnIS2_EEEP6MemoryS7_R5StateT_T0_(%struct.Memory* %2, %struct.State* %0, i8* %10, i8* %11)
...
entry:
  ...
  %call = call %struct.Memory* @routine_vmovdqu_ymm_ymm(%struct.State* %state, i64 0, %struct.Memory* %mem)
  ret i32 0
}