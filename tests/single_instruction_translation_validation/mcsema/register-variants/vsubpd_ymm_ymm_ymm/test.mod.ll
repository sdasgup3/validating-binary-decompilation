...
define internal %struct.Memory* @_ZN12_GLOBAL__N_1L5SUBPDI3VnWI8vec256_tE2VnIS2_ES5_EEP6MemoryS7_R5StateT_T0_T1_(%struct.Memory* readnone returned, %struct.State* nocapture readnone dereferenceable(3376), i8* nocapture, i8* nocapture readonly, i8* nocapture readonly) #0 {
  ...
  %16 = fsub <2 x double> %7, %12
  %17 = fsub <2 x double> %10, %15
  %18 = bitcast i8* %2 to <2 x double>*
  store <2 x double> %16, <2 x double>* %18, align 1
  %19 = getelementptr inbounds i8, i8* %2, i64 16
  %20 = bitcast i8* %19 to <2 x double>*
  store <2 x double> %17, <2 x double>* %20, align 1
  ret %struct.Memory* %0
}

define %struct.Memory* @routine_vsubpd_ymm_ymm_ymm(%struct.State* noalias dereferenceable(3376), i64, %struct.Memory* noalias) #19 {
block_530:
  ...
  %16 = add i64 %15, 4
  store i64 %16, i64* %PC
  %17 = call %struct.Memory* @_ZN12_GLOBAL__N_1L5SUBPDI3VnWI8vec256_tE2VnIS2_ES5_EEP6MemoryS7_R5StateT_T0_T1_(%struct.Memory* %2, %struct.State* %0, i8* %12, i8* %13, i8* %14)
...
entry:
  ...
  %call = call %struct.Memory* @routine_vsubpd_ymm_ymm_ymm(%struct.State* %state, i64 0, %struct.Memory* %mem)
  ret i32 0
}