...
define %struct.Memory* @routine_xchgl_r32_eax(%struct.State*  dereferenceable(3376), i64, %struct.Memory* ) #19 {
block_530:
...
entry:
  ...
  %call = call %struct.Memory* @routine_xchgl_r32_eax(%struct.State* %state, i64 0, %struct.Memory* %mem)
  ret i32 0
}