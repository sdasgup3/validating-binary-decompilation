...
define %struct.Memory* @routine_xchgl_r32_r32(%struct.State*  dereferenceable(3376), i64, %struct.Memory* ) #19 {
block_530:
  ...
  %15 = add i64 %14, 2
  store i64 %15, i64* %PC
  %16 = call %struct.Memory* @_ZN12_GLOBAL__N_1L4XCHGI3RnWImE2RnIjES2_S4_EEP6MemoryS6_R5StateT_T0_T1_T2_(%struct.Memory* %2, %struct.State* %0, i64* %RBX, i64 %12, i64* %RCX, i64 %13)
...
entry:
  ...
  %call = call %struct.Memory* @routine_xchgl_r32_r32(%struct.State* %state, i64 0, %struct.Memory* %mem)
  ret i32 0
}