; ModuleID = '_Z14test_heap_sortIN9__gnu_cxx17__normal_iteratorIPdSt6vectorIdSaIdEEEEdEvT_S7_S7_S7_T0_PKc.bc'
...
define weak_odr void @_Z14test_heap_sortIN9__gnu_cxx17__normal_iteratorIPdSt6vectorIdSaIdEEEEdEvT_S7_S7_S7_T0_PKc(double*, double*, double*, double*, double, i8*) local_unnamed_addr #1 comdat {
...
; <label>:17:                                     ; preds = %16, %17
  ...
  tail call void @_ZN9benchmark8heapsortIN9__gnu_cxx17__normal_iteratorIPdSt6vectorIdSaIdEEEEdEEvT_S8_(double* %2, double* %3)
...
; <label>:41:                                     ; preds = %10
  ...
  %70 = getelementptr double, double* %0, i64 %56
  %71 = getelementptr double, double* %2, i64 %58
  %72 = and i64 %62, 3
...
; <label>:134:                                    ; preds = %134, %133
  ...
  %137 = getelementptr double, double* %0, i64 %135
  %138 = getelementptr double, double* %2, i64 %135
  %139 = bitcast double* %137 to <2 x i64>*
  %140 = load <2 x i64>, <2 x i64>* %139, align 8, !tbaa !6, !alias.scope !8
  %141 = getelementptr double, double* %137, i64 2
  %142 = bitcast double* %141 to <2 x i64>*
  %143 = load <2 x i64>, <2 x i64>* %142, align 8, !tbaa !6, !alias.scope !8
  %144 = bitcast double* %138 to <2 x i64>*
  store <2 x i64> %140, <2 x i64>* %144, align 8, !tbaa !6, !alias.scope !11, !noalias !8
  %145 = getelementptr double, double* %138, i64 2
...
; <label>:151:                                    ; preds = %77, %150
  %152 = phi double* [ %0, %77 ], [ %70, %150 ]
  %153 = phi double* [ %2, %77 ], [ %71, %150 ]
...
; <label>:161:                                    ; preds = %161, %160
  %162 = phi double* [ %165, %161 ], [ %152, %160 ]
  %163 = phi double* [ %168, %161 ], [ %153, %160 ]
  %164 = phi i64 [ %170, %161 ], [ %158, %160 ]
  %165 = getelementptr inbounds double, double* %162, i64 1
  %166 = bitcast double* %162 to i64*
  %167 = load i64, i64* %166, align 8, !tbaa !6
  %168 = getelementptr inbounds double, double* %163, i64 1
  %169 = bitcast double* %163 to i64*
...
; <label>:172:                                    ; preds = %161, %151
  %173 = phi double* [ %152, %151 ], [ %165, %161 ]
  %174 = phi double* [ %153, %151 ], [ %168, %161 ]
...
declare void @_ZN9benchmark8heapsortIN9__gnu_cxx17__normal_iteratorIPdSt6vectorIdSaIdEEEEdEEvT_S8_(double*, double*) local_unnamed_addr #2
