; ModuleID = '_Z14test_quicksortIPddEvT_S1_S1_S1_T0_PKc.bc'
...
define weak_odr void @_Z14test_quicksortIPddEvT_S1_S1_S1_T0_PKc(double*, double*, double*, double*, double, i8*) local_unnamed_addr #1 comdat {
...
; <label>:17:                                     ; preds = %16, %17
  ...
  tail call void @_ZN9benchmark9quicksortIPddEEvT_S2_(double* %2, double* %3)
...
; Function Attrs: uwtable
declare void @_ZN9benchmark9quicksortIPddEEvT_S2_(double*, double*) local_unnamed_addr #1
