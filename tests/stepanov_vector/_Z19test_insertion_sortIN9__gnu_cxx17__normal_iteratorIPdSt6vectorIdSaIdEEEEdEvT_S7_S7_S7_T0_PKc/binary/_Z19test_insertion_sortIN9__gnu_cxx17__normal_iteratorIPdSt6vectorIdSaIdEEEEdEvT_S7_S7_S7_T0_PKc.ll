; ModuleID = '_Z19test_insertion_sortIN9__gnu_cxx17__normal_iteratorIPdSt6vectorIdSaIdEEEEdEvT_S7_S7_S7_T0_PKc.bc'
...
define weak_odr void @_Z19test_insertion_sortIN9__gnu_cxx17__normal_iteratorIPdSt6vectorIdSaIdEEEEdEvT_S7_S7_S7_T0_PKc(double*, double*, double*, double*, double, i8*) local_unnamed_addr #1 comdat {
...
; <label>:77:                                     ; preds = %11
  ...
  %111 = getelementptr double, double* %0, i64 %92
  %112 = getelementptr double, double* %2, i64 %94
  %113 = and i64 %98, 3
...
; <label>:178:                                    ; preds = %178, %177
  ...
  %181 = getelementptr double, double* %0, i64 %179
  %182 = getelementptr double, double* %2, i64 %179
  %183 = bitcast double* %181 to <2 x i64>*
  %184 = load <2 x i64>, <2 x i64>* %183, align 8, !tbaa !6, !alias.scope !8
  %185 = getelementptr double, double* %181, i64 2
  %186 = bitcast double* %185 to <2 x i64>*
  %187 = load <2 x i64>, <2 x i64>* %186, align 8, !tbaa !6, !alias.scope !8
  %188 = bitcast double* %182 to <2 x i64>*
  store <2 x i64> %184, <2 x i64>* %188, align 8, !tbaa !6, !alias.scope !11, !noalias !8
  %189 = getelementptr double, double* %182, i64 2
...
; <label>:195:                                    ; preds = %120, %194
  %196 = phi double* [ %0, %120 ], [ %111, %194 ]
  %197 = phi double* [ %2, %120 ], [ %112, %194 ]
  %198 = ptrtoint double* %196 to i64
  %199 = sub i64 %107, %198
  %200 = lshr i64 %199, 3
...
; <label>:205:                                    ; preds = %205, %204
  %206 = phi double* [ %209, %205 ], [ %196, %204 ]
  %207 = phi double* [ %212, %205 ], [ %197, %204 ]
  ...
  %212 = getelementptr inbounds double, double* %207, i64 1
  %213 = bitcast double* %207 to i64*
...
; <label>:216:                                    ; preds = %205, %195
  %217 = phi double* [ %196, %195 ], [ %209, %205 ]
  %218 = phi double* [ %197, %195 ], [ %212, %205 ]
...
; <label>:221:                                    ; preds = %221, %220
  %222 = phi double* [ %217, %220 ], [ %259, %221 ]
  %223 = phi double* [ %218, %220 ], [ %262, %221 ]
  %224 = getelementptr inbounds double, double* %222, i64 1
  %225 = bitcast double* %222 to i64*
  ...
  %229 = getelementptr inbounds double, double* %222, i64 2
  %230 = bitcast double* %224 to i64*
  %231 = load i64, i64* %230, align 8, !tbaa !6
  %232 = getelementptr inbounds double, double* %223, i64 2
  %233 = bitcast double* %227 to i64*
  store i64 %231, i64* %233, align 8, !tbaa !6
  %234 = getelementptr inbounds double, double* %222, i64 3
