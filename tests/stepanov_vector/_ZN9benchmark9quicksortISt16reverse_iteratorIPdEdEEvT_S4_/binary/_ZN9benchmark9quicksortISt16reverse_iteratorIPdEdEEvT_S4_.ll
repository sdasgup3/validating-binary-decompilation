; ModuleID = '_ZN9benchmark9quicksortISt16reverse_iteratorIPdEdEEvT_S4_.bc'
...
define weak_odr void @_ZN9benchmark9quicksortISt16reverse_iteratorIPdEdEEvT_S4_(%"class.std::reverse_iterator"*, %"class.std::reverse_iterator"*) local_unnamed_addr #0 comdat {
...
; <label>:21:                                     ; preds = %21, %17
  ...
  %24 = load double, double* %22, align 8, !tbaa !7
...
; <label>:47:                                     ; preds = %42
  ...
  store double %24, double* %45, align 8, !tbaa !7
  br label %17

; <label>:51:                                     ; preds = %42, %26
  %52 = bitcast %"class.std::reverse_iterator"* %3 to i64*
  store i64 %8, i64* %52, align 8, !tbaa !2
  %53 = getelementptr inbounds %"class.std::reverse_iterator", %"class.std::reverse_iterator"* %4, i64 0, i32 0
  store double* %22, double** %53, align 8, !tbaa !2, !alias.scope !9
  call void @_ZN9benchmark9quicksortISt16reverse_iteratorIPdEdEEvT_S4_(%"class.std::reverse_iterator"* nonnull %3, %"class.std::reverse_iterator"* nonnull %4)
  %54 = getelementptr inbounds %"class.std::reverse_iterator", %"class.std::reverse_iterator"* %5, i64 0, i32 0
  store double* %22, double** %54, align 8, !tbaa !2, !alias.scope !12
  %55 = load i64, i64* %9, align 8, !tbaa !2
  %56 = bitcast %"class.std::reverse_iterator"* %6 to i64*
  store i64 %55, i64* %56, align 8, !tbaa !2
  call void @_ZN9benchmark9quicksortISt16reverse_iteratorIPdEdEEvT_S4_(%"class.std::reverse_iterator"* nonnull %5, %"class.std::reverse_iterator"* nonnull %6)
  br label %57
...
!8 = !{!"double", !5, i64 0}
!9 = !{!10}
!10 = distinct !{!10, !11, !"_ZNKSt16reverse_iteratorIPdEplEl: argument 0"}
!11 = distinct !{!11, !"_ZNKSt16reverse_iteratorIPdEplEl"}
!12 = !{!13}
!13 = distinct !{!13, !14, !"_ZNKSt16reverse_iteratorIPdEplEl: argument 0"}
!14 = distinct !{!14, !"_ZNKSt16reverse_iteratorIPdEplEl"}
