; ModuleID = '_ZN9benchmark9quicksortISt16reverse_iteratorIS1_IN9__gnu_cxx17__normal_iteratorIPdSt6vectorIdSaIdEEEEEEdEEvT_SB_.bc'
...
define weak_odr void @_ZN9benchmark9quicksortISt16reverse_iteratorIS1_IN9__gnu_cxx17__normal_iteratorIPdSt6vectorIdSaIdEEEEEEdEEvT_SB_(%"class.std::reverse_iterator.2"*, %"class.std::reverse_iterator.2"*) local_unnamed_addr #0 comdat {
  ...
  %7 = getelementptr inbounds %"class.std::reverse_iterator.2", %"class.std::reverse_iterator.2"* %0, i64 0, i32 1
  %8 = bitcast %"class.std::reverse_iterator.1"* %7 to i64*
  %9 = load i64, i64* %8, align 8, !tbaa !2, !noalias !6
  %10 = getelementptr inbounds %"class.std::reverse_iterator.2", %"class.std::reverse_iterator.2"* %1, i64 0, i32 1
  %11 = bitcast %"class.std::reverse_iterator.1"* %10 to i64*
  %12 = load i64, i64* %11, align 8, !tbaa !2, !noalias !9
  %13 = sub i64 %12, %9
...
; <label>:31:                                     ; preds = %27
  %32 = load double, double* %29, align 8, !tbaa !12
...
; <label>:46:                                     ; preds = %42
  ...
  store double %25, double* %50, align 8, !tbaa !12
  br label %18

; <label>:51:                                     ; preds = %42, %27
  %52 = getelementptr inbounds %"class.std::reverse_iterator.2", %"class.std::reverse_iterator.2"* %3, i64 0, i32 1
  %53 = bitcast %"class.std::reverse_iterator.1"* %52 to i64*
  store i64 %9, i64* %53, align 8, !tbaa !2
  %54 = ptrtoint double* %23 to i64
  %55 = getelementptr inbounds %"class.std::reverse_iterator.2", %"class.std::reverse_iterator.2"* %4, i64 0, i32 1
  %56 = bitcast %"class.std::reverse_iterator.1"* %55 to i64*
  store i64 %54, i64* %56, align 8, !tbaa !2, !alias.scope !14
  call void @_ZN9benchmark9quicksortISt16reverse_iteratorIS1_IN9__gnu_cxx17__normal_iteratorIPdSt6vectorIdSaIdEEEEEEdEEvT_SB_(%"class.std::reverse_iterator.2"* nonnull %3, %"class.std::reverse_iterator.2"* nonnull %4)
  %57 = getelementptr inbounds %"class.std::reverse_iterator.2", %"class.std::reverse_iterator.2"* %5, i64 0, i32 1
  %58 = bitcast %"class.std::reverse_iterator.1"* %57 to i64*
  store i64 %54, i64* %58, align 8, !tbaa !2, !alias.scope !17
  %59 = getelementptr inbounds %"class.std::reverse_iterator.2", %"class.std::reverse_iterator.2"* %6, i64 0, i32 1
  %60 = bitcast %"class.std::reverse_iterator.1"* %59 to i64*
  %61 = load i64, i64* %11, align 8, !tbaa !2
  store i64 %61, i64* %60, align 8, !tbaa !2
  call void @_ZN9benchmark9quicksortISt16reverse_iteratorIS1_IN9__gnu_cxx17__normal_iteratorIPdSt6vectorIdSaIdEEEEEEdEEvT_SB_(%"class.std::reverse_iterator.2"* nonnull %5, %"class.std::reverse_iterator.2"* nonnull %6)
  br label %62
...
!13 = !{!"double", !4, i64 0}
!14 = !{!15}
!15 = distinct !{!15, !16, !"_ZNKSt16reverse_iteratorIS_IN9__gnu_cxx17__normal_iteratorIPdSt6vectorIdSaIdEEEEEEplEl: argument 0"}
!16 = distinct !{!16, !"_ZNKSt16reverse_iteratorIS_IN9__gnu_cxx17__normal_iteratorIPdSt6vectorIdSaIdEEEEEEplEl"}
!17 = !{!18}
!18 = distinct !{!18, !19, !"_ZNKSt16reverse_iteratorIS_IN9__gnu_cxx17__normal_iteratorIPdSt6vectorIdSaIdEEEEEEplEl: argument 0"}
!19 = distinct !{!19, !"_ZNKSt16reverse_iteratorIS_IN9__gnu_cxx17__normal_iteratorIPdSt6vectorIdSaIdEEEEEEplEl"}
