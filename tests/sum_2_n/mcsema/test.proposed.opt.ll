...
define %struct.Memory* @sub_660_sum_2_n(%struct.State* noalias dereferenceable(3376), i64, %struct.Memory* noalias readnone returned) local_unnamed_addr #1 {
entry:
  ...
  %ECX.i25 = bitcast %union.anon* %11 to i32*
  %12 = add i64 %7, -28
  %13 = load i32, i32* %ECX.i25, align 4
  %14 = add i64 %10, 6
  ...
  %RBX.i4 = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 1, i32 0, i32 0
...
block_689:                                        ; preds = %block_681
  ...
  store i64 %38, i64* %RBX.i4, align 8
  %39 = add i64 %146, 4
  ...
  store i64 %43, i64* %RBX.i, align 8
...
block_677:                                        ; preds = %block_681
  ...
  %49 = load i32, i32* %113, align 4
  %50 = zext i32 %49 to i64
  store i64 %50, i64* %RBX.i4, align 8
  %51 = add i64 %110, -8
  %52 = add i64 %146, 6
...
block_681:                                        ; preds = %block_677, %entry
  %109 = phi i64 [ %.pre, %block_677 ], [ %27, %entry ]
  %110 = load i64, i64* %RBX.i, align 8
  %111 = add i64 %110, -4
  %112 = add i64 %109, 3
  ...
  store i64 %115, i64* %RBX.i4, align 8
  %116 = add i64 %110, -20
  %117 = add i64 %109, 6
  ...
  %145 = xor i1 %144, %142
  %.v = select i1 %145, i64 -10, i64 8
  %146 = add i64 %109, %.v
  store i64 %146, i64* %3, align 8
  br i1 %145, label %block_677, label %block_689
}
...
; Function Attrs: norecurse nounwind
define %struct.Memory* @routine_movl_m32_EAX(%struct.State* nocapture dereferenceable(3376), i64, %struct.Memory* readnone returned, i64 %memoff) local_unnamed_addr #2 {
block_530:
  %PC = getelementptr inbounds %struct.State, %struct.State* %0, i64 0, i32 6, i32 33, i32 0, i32 0
